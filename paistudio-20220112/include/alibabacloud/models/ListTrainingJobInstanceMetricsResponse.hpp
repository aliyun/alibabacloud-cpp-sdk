...
namespace Models
{
  ...
  public:
    ...
    inline const ListTrainingJobInstanceMetricsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTrainingJobInstanceMetricsResponseBody) };
    inline ListTrainingJobInstanceMetricsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTrainingJobInstanceMetricsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTrainingJobInstanceMetricsResponseBody> body_ {};
  };
