...
#ifndef ALIBABACLOUD_MODELS_QUOTAJOBVIEWMETRIC_HPP_
#define ALIBABACLOUD_MODELS_QUOTAJOBVIEWMETRIC_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QuotaJobViewMetric& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QuotaJobViewMetric& obj) { 
    ...
    QuotaJobViewMetric() = default ;
    QuotaJobViewMetric(const QuotaJobViewMetric &) = default ;
    QuotaJobViewMetric(QuotaJobViewMetric &&) = default ;
    QuotaJobViewMetric(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QuotaJobViewMetric() = default ;
    QuotaJobViewMetric& operator=(const QuotaJobViewMetric &) = default ;
    QuotaJobViewMetric& operator=(QuotaJobViewMetric &&) = default ;
    ...
    inline QuotaJobViewMetric& setCPUUsageRate(string CPUUsageRate) { DARABONBA_PTR_SET_VALUE(CPUUsageRate_, CPUUsageRate) };
    ...
    inline QuotaJobViewMetric& setDiskReadRate(string diskReadRate) { DARABONBA_PTR_SET_VALUE(diskReadRate_, diskReadRate) };
    ...
    inline QuotaJobViewMetric& setDiskWriteRate(string diskWriteRate) { DARABONBA_PTR_SET_VALUE(diskWriteRate_, diskWriteRate) };
    ...
    inline QuotaJobViewMetric& setGPUUsageRate(string GPUUsageRate) { DARABONBA_PTR_SET_VALUE(GPUUsageRate_, GPUUsageRate) };
    ...
    inline QuotaJobViewMetric& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline QuotaJobViewMetric& setJobType(string jobType) { DARABONBA_PTR_SET_VALUE(jobType_, jobType) };
    ...
    inline QuotaJobViewMetric& setMemoryUsageRate(string memoryUsageRate) { DARABONBA_PTR_SET_VALUE(memoryUsageRate_, memoryUsageRate) };
    ...
    inline QuotaJobViewMetric& setNetworkInputRate(string networkInputRate) { DARABONBA_PTR_SET_VALUE(networkInputRate_, networkInputRate) };
    ...
    inline QuotaJobViewMetric& setNetworkOutputRate(string networkOutputRate) { DARABONBA_PTR_SET_VALUE(networkOutputRate_, networkOutputRate) };
    ...
    inline QuotaJobViewMetric& setNodeNames(const vector<string> & nodeNames) { DARABONBA_PTR_SET_VALUE(nodeNames_, nodeNames) };
    inline QuotaJobViewMetric& setNodeNames(vector<string> && nodeNames) { DARABONBA_PTR_SET_RVALUE(nodeNames_, nodeNames) };
    ...
    inline QuotaJobViewMetric& setRequestCPU(int32_t requestCPU) { DARABONBA_PTR_SET_VALUE(requestCPU_, requestCPU) };
    ...
    inline QuotaJobViewMetric& setRequestGPU(int32_t requestGPU) { DARABONBA_PTR_SET_VALUE(requestGPU_, requestGPU) };
    ...
    inline QuotaJobViewMetric& setRequestMemory(int64_t requestMemory) { DARABONBA_PTR_SET_VALUE(requestMemory_, requestMemory) };
    ...
    inline QuotaJobViewMetric& setTotalCPU(int32_t totalCPU) { DARABONBA_PTR_SET_VALUE(totalCPU_, totalCPU) };
    ...
    inline QuotaJobViewMetric& setTotalGPU(int32_t totalGPU) { DARABONBA_PTR_SET_VALUE(totalGPU_, totalGPU) };
    ...
    inline QuotaJobViewMetric& setTotalMemory(int64_t totalMemory) { DARABONBA_PTR_SET_VALUE(totalMemory_, totalMemory) };
    ...
    inline QuotaJobViewMetric& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
