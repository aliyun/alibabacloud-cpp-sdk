...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->acceleratorType_ != nullptr
        && this->availabilityZone_ != nullptr && this->filterByQuotaId_ != nullptr && this->filterByResourceGroupIds_ != nullptr && this->GPUType_ != nullptr && this->hyperZone_ != nullptr
        ...
        && this->orderStatuses_ != nullptr && this->pageNumber_ != nullptr && this->pageSize_ != nullptr && this->paymentType_ != nullptr && this->quotaId_ != nullptr
        && this->reasonCodes_ != nullptr && this->resourceGroupIds_ != nullptr && this->sortBy_ != nullptr && this->verbose_ != nullptr; };
