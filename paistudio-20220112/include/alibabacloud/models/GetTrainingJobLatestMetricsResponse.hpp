...
namespace Models
{
  ...
  public:
    ...
    inline const GetTrainingJobLatestMetricsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetTrainingJobLatestMetricsResponseBody) };
    inline GetTrainingJobLatestMetricsResponseBody body() { DARABONBA_PTR_GET(body_, GetTrainingJobLatestMetricsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetTrainingJobLatestMetricsResponseBody> body_ = nullptr;
  };
