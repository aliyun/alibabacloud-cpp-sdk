...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->defaultForwardInfo_ == nullptr
        && return this->defaultRoute_ == nullptr && return this->extendedCIDRs_ == nullptr && return this->roleArn_ == nullptr && return this->securityGroupId_ == nullptr && return this->switchId_ == nullptr
    ...
    inline const ForwardInfo & defaultForwardInfo() const { DARABONBA_PTR_GET_CONST(defaultForwardInfo_, ForwardInfo) };
    inline ForwardInfo defaultForwardInfo() { DARABONBA_PTR_GET(defaultForwardInfo_, ForwardInfo) };
  ...
  protected:
    std::shared_ptr<ForwardInfo> defaultForwardInfo_ = nullptr;
