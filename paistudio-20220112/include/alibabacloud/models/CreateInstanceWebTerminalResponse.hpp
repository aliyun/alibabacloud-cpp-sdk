...
namespace Models
{
  ...
  public:
    ...
    inline const CreateInstanceWebTerminalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateInstanceWebTerminalResponseBody) };
    inline CreateInstanceWebTerminalResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateInstanceWebTerminalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateInstanceWebTerminalResponseBody> body_ {};
  };
