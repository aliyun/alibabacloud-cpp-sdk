...
namespace Models
{
  ...
  public:
    ...
    inline string getBeforeWorkloadId() const { DARABONBA_PTR_GET_DEFAULT(beforeWorkloadId_, "") };
    ...
    inline const TimeRangeFilter & getGmtDequeuedTimeRange() const { DARABONBA_PTR_GET_CONST(gmtDequeuedTimeRange_, TimeRangeFilter) };
    inline TimeRangeFilter getGmtDequeuedTimeRange() { DARABONBA_PTR_GET(gmtDequeuedTimeRange_, TimeRangeFilter) };
    ...
    inline const TimeRangeFilter & getGmtEnqueuedTimeRange() const { DARABONBA_PTR_GET_CONST(gmtEnqueuedTimeRange_, TimeRangeFilter) };
    inline TimeRangeFilter getGmtEnqueuedTimeRange() { DARABONBA_PTR_GET(gmtEnqueuedTimeRange_, TimeRangeFilter) };
    ...
    inline const TimeRangeFilter & getGmtPositionModifiedTimeRange() const { DARABONBA_PTR_GET_CONST(gmtPositionModifiedTimeRange_, TimeRangeFilter) };
    inline TimeRangeFilter getGmtPositionModifiedTimeRange() { DARABONBA_PTR_GET(gmtPositionModifiedTimeRange_, TimeRangeFilter) };
    ...
    inline bool getWithHistoricalData() const { DARABONBA_PTR_GET_DEFAULT(withHistoricalData_, false) };
    ...
    inline const TimeRangeFilter & getWorkloadCreatedTimeRange() const { DARABONBA_PTR_GET_CONST(workloadCreatedTimeRange_, TimeRangeFilter) };
    inline TimeRangeFilter getWorkloadCreatedTimeRange() { DARABONBA_PTR_GET(workloadCreatedTimeRange_, TimeRangeFilter) };
    ...
    inline string getWorkloadIds() const { DARABONBA_PTR_GET_DEFAULT(workloadIds_, "") };
    ...
    inline string getWorkloadStatuses() const { DARABONBA_PTR_GET_DEFAULT(workloadStatuses_, "") };
