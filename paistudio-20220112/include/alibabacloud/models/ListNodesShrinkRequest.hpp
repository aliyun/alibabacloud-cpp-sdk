...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceleratorType_ == nullptr
        ...
        && this->GPUType_ == nullptr && this->healthCountShrink_ == nullptr && this->healthRateShrink_ == nullptr && this->hyperNode_ == nullptr && this->hyperZone_ == nullptr
    ...
    inline ListNodesShrinkRequest& setDiskPL(string diskPL) { DARABONBA_PTR_SET_VALUE(diskPL_, diskPL) };
    ...
    inline string getHealthCountShrink() const { DARABONBA_PTR_GET_DEFAULT(healthCountShrink_, "") };
    ...
    inline string getHealthRateShrink() const { DARABONBA_PTR_GET_DEFAULT(healthRateShrink_, "") };
    ...
    inline ListNodesShrinkRequest& setPodNum(int32_t podNum) { DARABONBA_PTR_SET_VALUE(podNum_, podNum) };
    ...
    inline ListNodesShrinkRequest& setResourceGroupName(string resourceGroupName) { DARABONBA_PTR_SET_VALUE(resourceGroupName_, resourceGroupName) };
    ...
    inline ListNodesShrinkRequest& setWorkloadNum(int32_t workloadNum) { DARABONBA_PTR_SET_VALUE(workloadNum_, workloadNum) };
