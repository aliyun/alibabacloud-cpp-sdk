...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTrainingJobLabelsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteTrainingJobLabelsResponseBody) };
    inline DeleteTrainingJobLabelsResponseBody body() { DARABONBA_PTR_GET(body_, DeleteTrainingJobLabelsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteTrainingJobLabelsResponseBody> body_ = nullptr;
  };
