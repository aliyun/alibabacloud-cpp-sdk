...
namespace Models
{
  ...
  public:
    ...
    inline const ListTrainingJobOutputModelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTrainingJobOutputModelsResponseBody) };
    inline ListTrainingJobOutputModelsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTrainingJobOutputModelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTrainingJobOutputModelsResponseBody> body_ {};
  };
