...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceGroupMachineGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetResourceGroupMachineGroupResponseBody) };
    inline GetResourceGroupMachineGroupResponseBody body() { DARABONBA_PTR_GET(body_, GetResourceGroupMachineGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetResourceGroupMachineGroupResponseBody> body_ = nullptr;
  };
