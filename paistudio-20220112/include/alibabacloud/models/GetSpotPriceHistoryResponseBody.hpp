...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && this->spotPriceHistory_ == nullptr && this->totalCount_ == nullptr; };
    ...
    inline const vector<SpotPriceItem> & getSpotPriceHistory() const { DARABONBA_PTR_GET_CONST(spotPriceHistory_, vector<SpotPriceItem>) };
    inline vector<SpotPriceItem> getSpotPriceHistory() { DARABONBA_PTR_GET(spotPriceHistory_, vector<SpotPriceItem>) };
