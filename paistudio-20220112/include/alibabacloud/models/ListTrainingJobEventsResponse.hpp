...
namespace Models
{
  ...
  public:
    ...
    inline const ListTrainingJobEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTrainingJobEventsResponseBody) };
    inline ListTrainingJobEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTrainingJobEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTrainingJobEventsResponseBody> body_ {};
  };
