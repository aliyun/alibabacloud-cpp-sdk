...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->algorithmDescription_ == nullptr
        ...
        && return this->gmtModifiedTime_ == nullptr && return this->requestId_ == nullptr && return this->tenantId_ == nullptr && return this->userId_ == nullptr && return this->workspaceId_ == nullptr; };
