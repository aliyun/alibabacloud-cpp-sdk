...
namespace Models
{
  ...
  public:
    ...
    inline string getCrsReservationId() const { DARABONBA_PTR_GET_DEFAULT(crsReservationId_, "") };
    ...
    inline string getLastReconcileAttemptTime() const { DARABONBA_PTR_GET_DEFAULT(lastReconcileAttemptTime_, "") };
    ...
    inline string getLockProvider() const { DARABONBA_PTR_GET_DEFAULT(lockProvider_, "") };
    ...
    inline int32_t getLockedCount() const { DARABONBA_PTR_GET_DEFAULT(lockedCount_, 0) };
    ...
    inline string getPrivatePoolId() const { DARABONBA_PTR_GET_DEFAULT(privatePoolId_, "") };
    ...
    inline int32_t getRequestedCount() const { DARABONBA_PTR_GET_DEFAULT(requestedCount_, 0) };
  ...
  protected:
    ...
    shared_ptr<string> crsReservationId_ {};
    ...
    shared_ptr<string> lastReconcileAttemptTime_ {};
    shared_ptr<string> lastSyncTime_ {};
    shared_ptr<string> lockProvider_ {};
    shared_ptr<int32_t> lockedCount_ {};
    shared_ptr<string> operator_ {};
    shared_ptr<string> paymentType_ {};
    shared_ptr<string> privatePoolId_ {};
    shared_ptr<int32_t> requestedCount_ {};
