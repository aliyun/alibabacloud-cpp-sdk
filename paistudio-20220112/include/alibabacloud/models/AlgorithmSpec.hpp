...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->codeDir_ == nullptr
        && return this->command_ == nullptr && return this->computeResource_ == nullptr && return this->customization_ == nullptr && return this->hyperParameters_ == nullptr && return this->image_ == nullptr
        && return this->inputChannels_ == nullptr && return this->jobType_ == nullptr && return this->metricDefinitions_ == nullptr && return this->outputChannels_ == nullptr && return this->progressDefinitions_ == nullptr
        && return this->resourceRequirements_ == nullptr && return this->supportedInstanceTypes_ == nullptr && return this->supportsDistributedTraining_ == nullptr; };
