...
namespace Models
{
  ...
  public:
    ...
    inline const ListQuotaWorkloadsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListQuotaWorkloadsResponseBody) };
    inline ListQuotaWorkloadsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListQuotaWorkloadsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListQuotaWorkloadsResponseBody> body_ {};
  };
