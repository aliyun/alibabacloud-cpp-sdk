...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserViewMetricsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserViewMetricsResponseBody) };
    inline GetUserViewMetricsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserViewMetricsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserViewMetricsResponseBody> body_ {};
  };
