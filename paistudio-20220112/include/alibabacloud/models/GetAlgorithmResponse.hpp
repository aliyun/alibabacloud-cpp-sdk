...
namespace Models
{
  ...
  public:
    ...
    inline const GetAlgorithmResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAlgorithmResponseBody) };
    inline GetAlgorithmResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAlgorithmResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAlgorithmResponseBody> body_ {};
  };
