...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteQuotaResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteQuotaResponseBody) };
    inline DeleteQuotaResponseBody body() { DARABONBA_PTR_GET(body_, DeleteQuotaResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteQuotaResponseBody> body_ = nullptr;
  };
