...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAlgorithmVersionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteAlgorithmVersionResponseBody) };
    inline DeleteAlgorithmVersionResponseBody body() { DARABONBA_PTR_GET(body_, DeleteAlgorithmVersionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteAlgorithmVersionResponseBody> body_ = nullptr;
  };
