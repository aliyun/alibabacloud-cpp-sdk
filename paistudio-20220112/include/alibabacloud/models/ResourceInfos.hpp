...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterId_ == nullptr
        && this->ecsSpec_ == nullptr && this->gpuCardType_ == nullptr && this->machineModel_ == nullptr && this->maxQuota_ == nullptr && this->networkPodId_ == nullptr
        && this->regionId_ == nullptr && this->usedQuota_ == nullptr && this->userId_ == nullptr && this->userName_ == nullptr; };
    ...
    inline string getGpuCardType() const { DARABONBA_PTR_GET_DEFAULT(gpuCardType_, "") };
    ...
    inline string getNetworkPodId() const { DARABONBA_PTR_GET_DEFAULT(networkPodId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> gpuCardType_ {};
    shared_ptr<string> machineModel_ {};
    shared_ptr<int64_t> maxQuota_ {};
    shared_ptr<string> networkPodId_ {};
