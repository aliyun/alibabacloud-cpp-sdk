...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueueInfo> & getWorkloads() const { DARABONBA_PTR_GET_CONST(workloads_, vector<QueueInfo>) };
    inline vector<QueueInfo> getWorkloads() { DARABONBA_PTR_GET(workloads_, vector<QueueInfo>) };
