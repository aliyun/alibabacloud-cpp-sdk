...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->resourceGroups_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const vector<ResourceGroup> & resourceGroups() const { DARABONBA_PTR_GET_CONST(resourceGroups_, vector<ResourceGroup>) };
    inline vector<ResourceGroup> resourceGroups() { DARABONBA_PTR_GET(resourceGroups_, vector<ResourceGroup>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ResourceGroup>> resourceGroups_ = nullptr;
