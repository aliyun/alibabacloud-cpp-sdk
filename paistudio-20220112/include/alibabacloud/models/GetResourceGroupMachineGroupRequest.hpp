...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetResourceGroupMachineGroupRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<GetResourceGroupMachineGroupRequest::Tag>) };
    inline vector<GetResourceGroupMachineGroupRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<GetResourceGroupMachineGroupRequest::Tag>) };
    inline GetResourceGroupMachineGroupRequest& setTag(const vector<GetResourceGroupMachineGroupRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline GetResourceGroupMachineGroupRequest& setTag(vector<GetResourceGroupMachineGroupRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
