...
namespace Models
{
  ...
  public:
    ...
    inline string getLocationType() const { DARABONBA_PTR_GET_DEFAULT(locationType_, "") };
    ...
    inline     const Darabonba::Json & getLocationValue() const { DARABONBA_GET(locationValue_) };
    Darabonba::Json & getLocationValue() { DARABONBA_GET(locationValue_) };
