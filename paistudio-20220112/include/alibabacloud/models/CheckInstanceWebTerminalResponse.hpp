...
namespace Models
{
  ...
  public:
    ...
    inline const CheckInstanceWebTerminalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckInstanceWebTerminalResponseBody) };
    inline CheckInstanceWebTerminalResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckInstanceWebTerminalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckInstanceWebTerminalResponseBody> body_ {};
  };
