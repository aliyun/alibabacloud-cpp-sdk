...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->CPUUsageRate_ == nullptr
        && return this->createdTime_ == nullptr && return this->diskReadRate_ == nullptr && return this->diskWriteRate_ == nullptr && return this->GPUType_ == nullptr && return this->machineGroupID_ == nullptr
        && return this->memoryUsageRate_ == nullptr && return this->networkInputRate_ == nullptr && return this->networkOutputRate_ == nullptr && return this->nodeID_ == nullptr && return this->nodeStatus_ == nullptr
        && return this->nodeType_ == nullptr && return this->requestCPU_ == nullptr && return this->requestGPU_ == nullptr && return this->requestMemory_ == nullptr && return this->taskIdMap_ == nullptr
