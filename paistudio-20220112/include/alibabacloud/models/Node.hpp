...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getAncestorQuotaWorkloadNum() const { DARABONBA_PTR_GET_DEFAULT(ancestorQuotaWorkloadNum_, 0L) };
    ...
    inline int64_t getDescendantQuotaWorkloadNum() const { DARABONBA_PTR_GET_DEFAULT(descendantQuotaWorkloadNum_, 0L) };
    ...
    inline int64_t getSelfQuotaWorkloadNum() const { DARABONBA_PTR_GET_DEFAULT(selfQuotaWorkloadNum_, 0L) };
