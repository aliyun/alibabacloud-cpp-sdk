...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceleratorType_ == nullptr
        && this->cpu_ == nullptr && this->ecsImageId_ == nullptr && this->eriQuantity_ == nullptr && this->gpu_ == nullptr && this->gpuGUSpec_ == nullptr
        && this->gpuMemory_ == nullptr && this->gpuType_ == nullptr && this->gpuTypeAlias_ == nullptr && this->instanceType_ == nullptr && this->machineModel_ == nullptr
        && this->memory_ == nullptr && this->networkMode_ == nullptr && this->plannedCpu_ == nullptr && this->plannedMemory_ == nullptr && this->resourceType_ == nullptr
        && this->supportGPUShare_ == nullptr && this->supportRDMA_ == nullptr && this->supportSetNetworkCardIndex_ == nullptr; };
    ...
    inline string getEcsImageId() const { DARABONBA_PTR_GET_DEFAULT(ecsImageId_, "") };
    ...
    inline string getGpuGUSpec() const { DARABONBA_PTR_GET_DEFAULT(gpuGUSpec_, "") };
    ...
    inline string getGpuTypeAlias() const { DARABONBA_PTR_GET_DEFAULT(gpuTypeAlias_, "") };
    ...
    inline string getMachineModel() const { DARABONBA_PTR_GET_DEFAULT(machineModel_, "") };
    ...
    inline int32_t getPlannedCpu() const { DARABONBA_PTR_GET_DEFAULT(plannedCpu_, 0) };
    ...
    inline int32_t getPlannedMemory() const { DARABONBA_PTR_GET_DEFAULT(plannedMemory_, 0) };
    ...
    inline bool getSupportGPUShare() const { DARABONBA_PTR_GET_DEFAULT(supportGPUShare_, false) };
    ...
    inline bool getSupportSetNetworkCardIndex() const { DARABONBA_PTR_GET_DEFAULT(supportSetNetworkCardIndex_, false) };
  ...
  protected:
    ...
    shared_ptr<string> ecsImageId_ {};
    shared_ptr<int32_t> eriQuantity_ {};
    shared_ptr<int32_t> gpu_ {};
    shared_ptr<string> gpuGUSpec_ {};
    shared_ptr<int32_t> gpuMemory_ {};
    shared_ptr<string> gpuType_ {};
    shared_ptr<string> gpuTypeAlias_ {};
    shared_ptr<string> instanceType_ {};
    shared_ptr<string> machineModel_ {};
    shared_ptr<int32_t> memory_ {};
    shared_ptr<string> networkMode_ {};
    shared_ptr<int32_t> plannedCpu_ {};
    shared_ptr<int32_t> plannedMemory_ {};
    shared_ptr<string> resourceType_ {};
    shared_ptr<bool> supportGPUShare_ {};
    shared_ptr<bool> supportRDMA_ {};
    shared_ptr<bool> supportSetNetworkCardIndex_ {};
  };
