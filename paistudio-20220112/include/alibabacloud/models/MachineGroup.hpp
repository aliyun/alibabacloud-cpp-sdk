...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getAllocatableCpu() const { DARABONBA_PTR_GET_DEFAULT(allocatableCpu_, 0L) };
    ...
    inline int64_t getAllocatableMemory() const { DARABONBA_PTR_GET_DEFAULT(allocatableMemory_, 0L) };
    ...
    inline int64_t getSystemReservedCpu() const { DARABONBA_PTR_GET_DEFAULT(systemReservedCpu_, 0L) };
    ...
    inline int64_t getSystemReservedMemory() const { DARABONBA_PTR_GET_DEFAULT(systemReservedMemory_, 0L) };
