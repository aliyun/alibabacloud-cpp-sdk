...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getHyperZones() const { DARABONBA_PTR_GET_CONST(hyperZones_, vector<string>) };
    inline vector<string> getHyperZones() { DARABONBA_PTR_GET(hyperZones_, vector<string>) };
    ...
    inline string getLatestOperationId() const { DARABONBA_PTR_GET_DEFAULT(latestOperationId_, "") };
    ...
    inline const QuotaCluster & getQuotaCluster() const { DARABONBA_PTR_GET_CONST(quotaCluster_, QuotaCluster) };
    inline QuotaCluster getQuotaCluster() { DARABONBA_PTR_GET(quotaCluster_, QuotaCluster) };
    ...
    inline const vector<QuotaIdName> & getSubQuotas() const { DARABONBA_PTR_GET_CONST(subQuotas_, vector<QuotaIdName>) };
    inline vector<QuotaIdName> getSubQuotas() { DARABONBA_PTR_GET(subQuotas_, vector<QuotaIdName>) };
    ...
    inline const vector<WorkspaceIdName> & getWorkspaces() const { DARABONBA_PTR_GET_CONST(workspaces_, vector<WorkspaceIdName>) };
    inline vector<WorkspaceIdName> getWorkspaces() { DARABONBA_PTR_GET(workspaces_, vector<WorkspaceIdName>) };
