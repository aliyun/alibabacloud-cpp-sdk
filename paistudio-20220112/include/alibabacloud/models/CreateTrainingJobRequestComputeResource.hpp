...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ecsCount_ == nullptr
        && return this->ecsSpec_ == nullptr && return this->instanceCount_ == nullptr && return this->instanceSpec_ == nullptr && return this->resourceId_ == nullptr && return this->spotSpec_ == nullptr
