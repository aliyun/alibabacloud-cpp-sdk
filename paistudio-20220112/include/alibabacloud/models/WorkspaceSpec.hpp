...
namespace Models
{
  ...
  public:
    ...
    inline bool getIsGuaranteedValid() const { DARABONBA_PTR_GET_DEFAULT(isGuaranteedValid_, false) };
    ...
    inline bool getIsOverSoldValid() const { DARABONBA_PTR_GET_DEFAULT(isOverSoldValid_, false) };
    ...
    inline const ResourceAmount & getSpec() const { DARABONBA_PTR_GET_CONST(spec_, ResourceAmount) };
    inline ResourceAmount getSpec() { DARABONBA_PTR_GET(spec_, ResourceAmount) };
