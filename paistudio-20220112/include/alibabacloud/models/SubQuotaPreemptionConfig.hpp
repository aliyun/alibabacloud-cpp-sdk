...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getPreemptedPriorityUpperBound() const { DARABONBA_PTR_GET_DEFAULT(preemptedPriorityUpperBound_, 0L) };
  ...
  protected:
    shared_ptr<int64_t> preemptedPriorityUpperBound_ {};
