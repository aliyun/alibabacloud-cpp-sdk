...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetTrainingJobLatestMetricsResponseBody::Metrics> & getMetrics() const { DARABONBA_PTR_GET_CONST(metrics_, vector<GetTrainingJobLatestMetricsResponseBody::Metrics>) };
    inline vector<GetTrainingJobLatestMetricsResponseBody::Metrics> getMetrics() { DARABONBA_PTR_GET(metrics_, vector<GetTrainingJobLatestMetricsResponseBody::Metrics>) };
    inline GetTrainingJobLatestMetricsResponseBody& setMetrics(const vector<GetTrainingJobLatestMetricsResponseBody::Metrics> & metrics) { DARABONBA_PTR_SET_VALUE(metrics_, metrics) };
    inline GetTrainingJobLatestMetricsResponseBody& setMetrics(vector<GetTrainingJobLatestMetricsResponseBody::Metrics> && metrics) { DARABONBA_PTR_SET_RVALUE(metrics_, metrics) };
