...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMonitorDataReportResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateMonitorDataReportResponseBody) };
    inline CreateMonitorDataReportResponseBody body() { DARABONBA_PTR_GET(body_, CreateMonitorDataReportResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateMonitorDataReportResponseBody> body_ = nullptr;
  };
