...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowCancel_ == nullptr
        ...
        && return this->status_ == nullptr && return this->subInsNames_ == nullptr && return this->switchTime_ == nullptr && return this->taskParams_ == nullptr && return this->taskType_ == nullptr
        && return this->taskTypeEn_ == nullptr && return this->taskTypeZh_ == nullptr; };
    ...
    inline DescribeActiveOperationTasksResponseBodyItems& setId(int32_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
