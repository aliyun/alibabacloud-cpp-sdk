...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeActiveOperationMaintainConfResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeActiveOperationMaintainConfResponseBody) };
    inline DescribeActiveOperationMaintainConfResponseBody body() { DARABONBA_PTR_GET(body_, DescribeActiveOperationMaintainConfResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeActiveOperationMaintainConfResponseBody> body_ = nullptr;
  };
