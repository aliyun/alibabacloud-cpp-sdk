...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSynDbsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSynDbsResponseBody) };
    inline DescribeSynDbsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSynDbsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSynDbsResponseBody> body_ = nullptr;
  };
