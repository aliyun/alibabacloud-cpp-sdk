...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ckPassword_ == nullptr
        && this->ckUserName_ == nullptr && this->clickhousePort_ == nullptr && this->dbClusterId_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr
        && this->rdsId_ == nullptr && this->rdsPassword_ == nullptr && this->rdsPort_ == nullptr && this->rdsUserName_ == nullptr && this->rdsVpcId_ == nullptr
        && this->rdsVpcUrl_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr; };
