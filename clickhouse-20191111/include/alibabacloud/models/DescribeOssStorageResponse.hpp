...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOSSStorageResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeOSSStorageResponseBody) };
    inline DescribeOSSStorageResponseBody body() { DARABONBA_PTR_GET(body_, DescribeOSSStorageResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeOSSStorageResponseBody> body_ = nullptr;
  };
