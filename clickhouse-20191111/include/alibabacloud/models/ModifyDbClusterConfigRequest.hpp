...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        ...
        && return this->resourceOwnerId_ == nullptr && return this->userConfig_ == nullptr; };
    ...
    inline ModifyDBClusterConfigRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline ModifyDBClusterConfigRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ModifyDBClusterConfigRequest& setReason(string reason) { DARABONBA_PTR_SET_VALUE(reason_, reason) };
    ...
    inline ModifyDBClusterConfigRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline ModifyDBClusterConfigRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline ModifyDBClusterConfigRequest& setUserConfig(string userConfig) { DARABONBA_PTR_SET_VALUE(userConfig_, userConfig) };
