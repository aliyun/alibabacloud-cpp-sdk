...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ckPassword_ == nullptr
        && this->ckUserName_ == nullptr && this->clickhousePort_ == nullptr && this->dbClusterId_ == nullptr && this->limitUpper_ == nullptr && this->ownerAccount_ == nullptr
        && this->ownerId_ == nullptr && this->rdsId_ == nullptr && this->rdsPassword_ == nullptr && this->rdsPort_ == nullptr && this->rdsSynDb_ == nullptr
        && this->rdsSynTables_ == nullptr && this->rdsUserName_ == nullptr && this->rdsVpcId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr
        && this->skipUnsupported_ == nullptr; };
    ...
    inline string getCkPassword() const { DARABONBA_PTR_GET_DEFAULT(ckPassword_, "") };
    ...
    inline string getCkUserName() const { DARABONBA_PTR_GET_DEFAULT(ckUserName_, "") };
    ...
    inline int64_t getClickhousePort() const { DARABONBA_PTR_GET_DEFAULT(clickhousePort_, 0L) };
    ...
    inline int64_t getLimitUpper() const { DARABONBA_PTR_GET_DEFAULT(limitUpper_, 0L) };
    ...
    inline string getRdsPassword() const { DARABONBA_PTR_GET_DEFAULT(rdsPassword_, "") };
    ...
    inline int64_t getRdsPort() const { DARABONBA_PTR_GET_DEFAULT(rdsPort_, 0L) };
    ...
    inline string getRdsSynDb() const { DARABONBA_PTR_GET_DEFAULT(rdsSynDb_, "") };
    ...
    inline string getRdsSynTables() const { DARABONBA_PTR_GET_DEFAULT(rdsSynTables_, "") };
    ...
    inline string getRdsVpcId() const { DARABONBA_PTR_GET_DEFAULT(rdsVpcId_, "") };
    ...
    inline bool getSkipUnsupported() const { DARABONBA_PTR_GET_DEFAULT(skipUnsupported_, false) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> rdsSynDb_ {};
    // The table in the ApsaraDB RDS for MySQL instance.
    // 
    // This parameter is required.
    shared_ptr<string> rdsSynTables_ {};
