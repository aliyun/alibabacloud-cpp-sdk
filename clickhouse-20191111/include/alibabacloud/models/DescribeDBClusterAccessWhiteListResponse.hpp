...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterAccessWhiteListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterAccessWhiteListResponseBody) };
    inline DescribeDBClusterAccessWhiteListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterAccessWhiteListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterAccessWhiteListResponseBody> body_ {};
  };
