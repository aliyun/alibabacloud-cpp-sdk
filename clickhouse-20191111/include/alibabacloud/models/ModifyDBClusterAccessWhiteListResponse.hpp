...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBClusterAccessWhiteListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBClusterAccessWhiteListResponseBody) };
    inline ModifyDBClusterAccessWhiteListResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBClusterAccessWhiteListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBClusterAccessWhiteListResponseBody> body_ {};
  };
