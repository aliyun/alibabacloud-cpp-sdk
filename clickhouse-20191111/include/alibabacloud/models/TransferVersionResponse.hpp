...
namespace Models
{
  ...
  public:
    ...
    inline const TransferVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TransferVersionResponseBody) };
    inline TransferVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, TransferVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TransferVersionResponseBody> body_ {};
  };
