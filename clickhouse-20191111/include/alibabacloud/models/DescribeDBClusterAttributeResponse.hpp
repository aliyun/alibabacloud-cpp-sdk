...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterAttributeResponseBody) };
    inline DescribeDBClusterAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterAttributeResponseBody> body_ {};
  };
