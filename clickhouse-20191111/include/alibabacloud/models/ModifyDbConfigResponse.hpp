...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBConfigResponseBody) };
    inline ModifyDBConfigResponseBody body() { DARABONBA_PTR_GET(body_, ModifyDBConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyDBConfigResponseBody> body_ = nullptr;
  };
