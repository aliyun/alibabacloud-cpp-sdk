...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterClass_ == nullptr
        && return this->DBClusterId_ == nullptr && return this->DBNodeGroupCount_ == nullptr && return this->DBNodeStorage_ == nullptr && return this->dbNodeStorageType_ == nullptr && return this->disableWriteWindows_ == nullptr
