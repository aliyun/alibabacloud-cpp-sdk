...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->createdTime_ == nullptr
        && return this->cycleTime_ == nullptr && return this->cycleType_ == nullptr && return this->maintainEndTime_ == nullptr && return this->maintainStartTime_ == nullptr && return this->modifiedTime_ == nullptr
    ...
    inline DescribeActiveOperationMaintainConfResponseBodyConfig& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
