...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterConfigInXMLResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterConfigInXMLResponseBody) };
    inline DescribeDBClusterConfigInXMLResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDBClusterConfigInXMLResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBClusterConfigInXMLResponseBody> body_ = nullptr;
  };
