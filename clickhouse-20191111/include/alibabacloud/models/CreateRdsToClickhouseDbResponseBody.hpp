...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorMsg_ == nullptr
        && return this->repeatedDbs_ == nullptr && return this->requestId_ == nullptr && return this->status_ == nullptr; };
    ...
    inline const vector<string> & repeatedDbs() const { DARABONBA_PTR_GET_CONST(repeatedDbs_, vector<string>) };
    inline vector<string> repeatedDbs() { DARABONBA_PTR_GET(repeatedDbs_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> repeatedDbs_ = nullptr;
    // The request ID.
