...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRDSToClickhouseDbResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRDSToClickhouseDbResponseBody) };
    inline CreateRDSToClickhouseDbResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRDSToClickhouseDbResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRDSToClickhouseDbResponseBody> body_ {};
  };
