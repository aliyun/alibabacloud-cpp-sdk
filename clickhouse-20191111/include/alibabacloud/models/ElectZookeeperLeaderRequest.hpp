...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && this->disableWrite_ == nullptr && this->electTime_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->pageNumber_ == nullptr
    ...
    inline bool getDisableWrite() const { DARABONBA_PTR_GET_DEFAULT(disableWrite_, false) };
    ...
    inline string getElectTime() const { DARABONBA_PTR_GET_DEFAULT(electTime_, "") };
  ...
  protected:
    ...
    shared_ptr<bool> disableWrite_ {};
    shared_ptr<string> electTime_ {};
