...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountDescription_ == nullptr
        && this->accountName_ == nullptr && this->accountPassword_ == nullptr && this->allowDatabases_ == nullptr && this->allowDictionaries_ == nullptr && this->DBClusterId_ == nullptr
        && this->ddlAuthority_ == nullptr && this->dmlAuthority_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->regionId_ == nullptr
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->totalDatabases_ == nullptr && this->totalDictionaries_ == nullptr; };
