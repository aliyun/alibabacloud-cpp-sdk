...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ids_ == nullptr
        && return this->immediateStart_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr
        && return this->securityToken_ == nullptr && return this->switchTime_ == nullptr; };
    // ids Field Functions 
