...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSLBResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateSLBResponseBody) };
    inline CreateSLBResponseBody body() { DARABONBA_PTR_GET(body_, CreateSLBResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateSLBResponseBody> body_ = nullptr;
  };
