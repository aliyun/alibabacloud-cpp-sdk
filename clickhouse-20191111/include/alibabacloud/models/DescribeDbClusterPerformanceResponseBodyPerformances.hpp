...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->key_ == nullptr
        && return this->name_ == nullptr && return this->series_ == nullptr && return this->unit_ == nullptr; };
    // key Field Functions 
    ...
    inline DescribeDBClusterPerformanceResponseBodyPerformances& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
