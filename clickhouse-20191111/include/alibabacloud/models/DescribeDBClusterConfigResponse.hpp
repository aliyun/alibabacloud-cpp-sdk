...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterConfigResponseBody) };
    inline DescribeDBClusterConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterConfigResponseBody> body_ {};
  };
