...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeColumnsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeColumnsResponseBody) };
    inline DescribeColumnsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeColumnsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeColumnsResponseBody> body_ {};
  };
