...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && return this->initialQueryId_ == nullptr && return this->initialUser_ == nullptr && return this->keyword_ == nullptr && return this->order_ == nullptr && return this->ownerAccount_ == nullptr
        && return this->ownerId_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->queryDurationMs_ == nullptr && return this->regionId_ == nullptr
    ...
    inline DescribeProcessListRequest& setQueryDurationMs(int32_t queryDurationMs) { DARABONBA_PTR_SET_VALUE(queryDurationMs_, queryDurationMs) };
