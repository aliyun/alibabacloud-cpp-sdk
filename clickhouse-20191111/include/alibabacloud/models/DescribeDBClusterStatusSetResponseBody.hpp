...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getStatusSet() const { DARABONBA_PTR_GET_CONST(statusSet_, vector<string>) };
    inline vector<string> getStatusSet() { DARABONBA_PTR_GET(statusSet_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> statusSet_ {};
  };
