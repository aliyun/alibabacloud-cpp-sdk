...
namespace Models
{
  ...
  public:
    ...
    inline const CheckClickhouseToRDSResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckClickhouseToRDSResponseBody) };
    inline CheckClickhouseToRDSResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckClickhouseToRDSResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckClickhouseToRDSResponseBody> body_ {};
  };
