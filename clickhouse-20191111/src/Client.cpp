 ...
 */
CancelAppointmentElectZookeeperLeaderResponse Client::cancelAppointmentElectZookeeperLeaderWithOptions(const CancelAppointmentElectZookeeperLeaderRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<CancelAppointmentElectZookeeperLeaderResponse>();
}
 ...
 * @return CancelAppointmentElectZookeeperLeaderResponse
 */
CancelAppointmentElectZookeeperLeaderResponse Client::cancelAppointmentElectZookeeperLeader(const CancelAppointmentElectZookeeperLeaderRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
 ...
 */
CancelAppointmentRestartInstanceNodeListResponse Client::cancelAppointmentRestartInstanceNodeListWithOptions(const CancelAppointmentRestartInstanceNodeListRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<CancelAppointmentRestartInstanceNodeListResponse>();
}
 ...
 * @return CancelAppointmentRestartInstanceNodeListResponse
 */
CancelAppointmentRestartInstanceNodeListResponse Client::cancelAppointmentRestartInstanceNodeList(const CancelAppointmentRestartInstanceNodeListRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
...
CancelRestartInstanceResponse Client::cancelRestartInstanceWithOptions(const CancelRestartInstanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasRestartTime()) {
    query["RestartTime"] = request.getRestartTime();
  }
...
CheckClickhouseToRDSResponse Client::checkClickhouseToRDSWithOptions(const CheckClickhouseToRDSRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasCkPassword()) {
    query["CkPassword"] = request.getCkPassword();
  }

  if (!!request.hasCkUserName()) {
    query["CkUserName"] = request.getCkUserName();
  }

  if (!!request.hasClickhousePort()) {
    query["ClickhousePort"] = request.getClickhousePort();
  }
  ...
  if (!!request.hasRdsId()) {
    query["RdsId"] = request.getRdsId();
  }

  if (!!request.hasRdsPassword()) {
    query["RdsPassword"] = request.getRdsPassword();
  }

  if (!!request.hasRdsPort()) {
    query["RdsPort"] = request.getRdsPort();
  }

  if (!!request.hasRdsUserName()) {
    query["RdsUserName"] = request.getRdsUserName();
  }

  if (!!request.hasRdsVpcId()) {
    query["RdsVpcId"] = request.getRdsVpcId();
  }

  if (!!request.hasRdsVpcUrl()) {
    query["RdsVpcUrl"] = request.getRdsVpcUrl();
  }
...
CreateAccountAndAuthorityResponse Client::createAccountAndAuthorityWithOptions(const CreateAccountAndAuthorityRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAllowDatabases()) {
    query["AllowDatabases"] = request.getAllowDatabases();
  }

  if (!!request.hasAllowDictionaries()) {
    query["AllowDictionaries"] = request.getAllowDictionaries();
  }
  ...
  if (!!request.hasDdlAuthority()) {
    query["DdlAuthority"] = request.getDdlAuthority();
  }

  if (!!request.hasDmlAuthority()) {
    query["DmlAuthority"] = request.getDmlAuthority();
  }
  ...
  if (!!request.hasTotalDatabases()) {
    query["TotalDatabases"] = request.getTotalDatabases();
  }

  if (!!request.hasTotalDictionaries()) {
    query["TotalDictionaries"] = request.getTotalDictionaries();
  }
...
CreateDBInstanceResponse Client::createDBInstanceWithOptions(const CreateDBInstanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasDBClusterCategory()) {
    query["DBClusterCategory"] = request.getDBClusterCategory();
  }
  ...
  if (!!request.hasDBNodeGroupCount()) {
    query["DBNodeGroupCount"] = request.getDBNodeGroupCount();
  }

  if (!!request.hasDBNodeStorage()) {
    query["DBNodeStorage"] = request.getDBNodeStorage();
  }

  if (!!request.hasDbNodeStorageType()) {
    query["DbNodeStorageType"] = request.getDbNodeStorageType();
  }
  ...
  if (!!request.hasVSwitchBak()) {
    query["VSwitchBak"] = request.getVSwitchBak();
  }

  if (!!request.hasVSwitchBak2()) {
    query["VSwitchBak2"] = request.getVSwitchBak2();
  }
  ...
  if (!!request.hasZondIdBak2()) {
    query["ZondIdBak2"] = request.getZondIdBak2();
  }
  ...
  if (!!request.hasZoneIdBak()) {
    query["ZoneIdBak"] = request.getZoneIdBak();
  }
...
CreatePortsForClickHouseResponse Client::createPortsForClickHouseWithOptions(const CreatePortsForClickHouseRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasPortType()) {
    query["PortType"] = request.getPortType();
  }
...
CreateRDSToClickhouseDbResponse Client::createRDSToClickhouseDbWithOptions(const CreateRDSToClickhouseDbRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasLimitUpper()) {
    query["LimitUpper"] = request.getLimitUpper();
  }
  ...
  if (!!request.hasSkipUnsupported()) {
    query["SkipUnsupported"] = request.getSkipUnsupported();
  }

  if (!!request.hasSynDbTables()) {
    query["SynDbTables"] = request.getSynDbTables();
  }
 ...
 */
DescribeDBClusterNodeInfosResponse Client::describeDBClusterNodeInfosWithOptions(const DescribeDBClusterNodeInfosRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  return json(callApi(params, req, runtime)).get<DescribeDBClusterNodeInfosResponse>();
}
 ...
 * @return DescribeDBClusterNodeInfosResponse
 */
DescribeDBClusterNodeInfosResponse Client::describeDBClusterNodeInfos(const DescribeDBClusterNodeInfosRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
 ...
 */
DescribeDBClusterStatusSetResponse Client::describeDBClusterStatusSetWithOptions(const DescribeDBClusterStatusSetRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasOwnerAccount()) {
    query["OwnerAccount"] = request.getOwnerAccount();
  ...
  return json(callApi(params, req, runtime)).get<DescribeDBClusterStatusSetResponse>();
}
 ...
 * @return DescribeDBClusterStatusSetResponse
 */
DescribeDBClusterStatusSetResponse Client::describeDBClusterStatusSet(const DescribeDBClusterStatusSetRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
 ...
 */
DescribeEventMetaInfoResponse Client::describeEventMetaInfoWithOptions(const DescribeEventMetaInfoRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasRegionId()) {
    query["RegionId"] = request.getRegionId();
  ...
  return json(callApi(params, req, runtime)).get<DescribeEventMetaInfoResponse>();
}
 ...
 * @return DescribeEventMetaInfoResponse
 */
DescribeEventMetaInfoResponse Client::describeEventMetaInfo(const DescribeEventMetaInfoRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
 ...
 */
ElectZookeeperLeaderResponse Client::electZookeeperLeaderWithOptions(const ElectZookeeperLeaderRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDBClusterId()) {
    query["DBClusterId"] = request.getDBClusterId();
  ...
  if (!!request.hasDisableWrite()) {
    query["DisableWrite"] = request.getDisableWrite();
  }

  if (!!request.hasElectTime()) {
    query["ElectTime"] = request.getElectTime();
  }
  ...
  return json(callApi(params, req, runtime)).get<ElectZookeeperLeaderResponse>();
}
 ...
 * @return ElectZookeeperLeaderResponse
 */
ElectZookeeperLeaderResponse Client::electZookeeperLeader(const ElectZookeeperLeaderRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
...
ModifyDBClusterResponse Client::modifyDBClusterWithOptions(const ModifyDBClusterRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasDisableWriteWindows()) {
    query["DisableWriteWindows"] = request.getDisableWriteWindows();
  }
...
ModifyDBClusterConfigResponse Client::modifyDBClusterConfigWithOptions(const ModifyDBClusterConfigRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasUserConfig()) {
    query["UserConfig"] = request.getUserConfig();
  }
...
ModifyMinorVersionGreadeTypeResponse Client::modifyMinorVersionGreadeTypeWithOptions(const ModifyMinorVersionGreadeTypeRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasMaintainAutoType()) {
    query["MaintainAutoType"] = request.getMaintainAutoType();
  }
...
ModifyRDSToClickhouseDbResponse Client::modifyRDSToClickhouseDbWithOptions(const ModifyRDSToClickhouseDbRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasRdsSynDb()) {
    query["RdsSynDb"] = request.getRdsSynDb();
  }

  if (!!request.hasRdsSynTables()) {
    query["RdsSynTables"] = request.getRdsSynTables();
  }
 ...
 */
RestartInstanceNodeListResponse Client::restartInstanceNodeListWithOptions(const RestartInstanceNodeListRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  tmpReq.validate();
  RestartInstanceNodeListShrinkRequest request = RestartInstanceNodeListShrinkRequest();
  Utils::Utils::convert(tmpReq, request);
  if (!!tmpReq.hasNodeList()) {
    request.setNodeListShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getNodeList(), "NodeList", "json"));
  }
  ...
  if (!!request.hasNodeListShrink()) {
    query["NodeList"] = request.getNodeListShrink();
  }
  ...
  return json(callApi(params, req, runtime)).get<RestartInstanceNodeListResponse>();
}
 ...
 * @return RestartInstanceNodeListResponse
 */
RestartInstanceNodeListResponse Client::restartInstanceNodeList(const RestartInstanceNodeListRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
...
TransferVersionResponse Client::transferVersionWithOptions(const TransferVersionRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasSourceClusterName()) {
    query["SourceClusterName"] = request.getSourceClusterName();
  }
  ...
  if (!!request.hasSourceShards()) {
    query["SourceShards"] = request.getSourceShards();
  }

  if (!!request.hasTargetAccount()) {
    query["TargetAccount"] = request.getTargetAccount();
  }
  ...
  if (!!request.hasTargetPassword()) {
    query["TargetPassword"] = request.getTargetPassword();
  }
...
UpgradeMinorVersionResponse Client::upgradeMinorVersionWithOptions(const UpgradeMinorVersionRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasUpgradeImmediately()) {
    query["UpgradeImmediately"] = request.getUpgradeImmediately();
  }
