...
#ifndef ALIBABACLOUD_MODELS_SAVEAPPORTALCONFIGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SAVEAPPORTALCONFIGREQUEST_HPP_
...
namespace Models
{
  class SaveApPortalConfigRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const SaveApPortalConfigRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SaveApPortalConfigRequest& obj) { 
    ...
    SaveApPortalConfigRequest() = default ;
    SaveApPortalConfigRequest(const SaveApPortalConfigRequest &) = default ;
    SaveApPortalConfigRequest(SaveApPortalConfigRequest &&) = default ;
    SaveApPortalConfigRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SaveApPortalConfigRequest() = default ;
    SaveApPortalConfigRequest& operator=(const SaveApPortalConfigRequest &) = default ;
    SaveApPortalConfigRequest& operator=(SaveApPortalConfigRequest &&) = default ;
    ...
    inline SaveApPortalConfigRequest& setApConfigId(int64_t apConfigId) { DARABONBA_PTR_SET_VALUE(apConfigId_, apConfigId) };
    ...
    inline SaveApPortalConfigRequest& setAppAuthUrl(string appAuthUrl) { DARABONBA_PTR_SET_VALUE(appAuthUrl_, appAuthUrl) };
    ...
    inline SaveApPortalConfigRequest& setAppCode(string appCode) { DARABONBA_PTR_SET_VALUE(appCode_, appCode) };
    ...
    inline SaveApPortalConfigRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline SaveApPortalConfigRequest& setAuthKey(string authKey) { DARABONBA_PTR_SET_VALUE(authKey_, authKey) };
    ...
    inline SaveApPortalConfigRequest& setAuthSecret(string authSecret) { DARABONBA_PTR_SET_VALUE(authSecret_, authSecret) };
    ...
    inline SaveApPortalConfigRequest& setCheckUrl(string checkUrl) { DARABONBA_PTR_SET_VALUE(checkUrl_, checkUrl) };
    ...
    inline SaveApPortalConfigRequest& setClientDownload(int32_t clientDownload) { DARABONBA_PTR_SET_VALUE(clientDownload_, clientDownload) };
    ...
    inline SaveApPortalConfigRequest& setClientUpload(int32_t clientUpload) { DARABONBA_PTR_SET_VALUE(clientUpload_, clientUpload) };
    ...
    inline SaveApPortalConfigRequest& setCountdown(int32_t countdown) { DARABONBA_PTR_SET_VALUE(countdown_, countdown) };
    ...
    inline SaveApPortalConfigRequest& setNetwork(int32_t network) { DARABONBA_PTR_SET_VALUE(network_, network) };
    ...
    inline SaveApPortalConfigRequest& setPortalTypes(const vector<string> & portalTypes) { DARABONBA_PTR_SET_VALUE(portalTypes_, portalTypes) };
    inline SaveApPortalConfigRequest& setPortalTypes(vector<string> && portalTypes) { DARABONBA_PTR_SET_RVALUE(portalTypes_, portalTypes) };
    ...
    inline SaveApPortalConfigRequest& setPortalUrl(string portalUrl) { DARABONBA_PTR_SET_VALUE(portalUrl_, portalUrl) };
    ...
    inline SaveApPortalConfigRequest& setTimeStamp(int64_t timeStamp) { DARABONBA_PTR_SET_VALUE(timeStamp_, timeStamp) };
    ...
    inline SaveApPortalConfigRequest& setTotalDownload(int32_t totalDownload) { DARABONBA_PTR_SET_VALUE(totalDownload_, totalDownload) };
    ...
    inline SaveApPortalConfigRequest& setTotalUpload(int32_t totalUpload) { DARABONBA_PTR_SET_VALUE(totalUpload_, totalUpload) };
    ...
    inline SaveApPortalConfigRequest& setWebAuthUrl(string webAuthUrl) { DARABONBA_PTR_SET_VALUE(webAuthUrl_, webAuthUrl) };
    ...
    inline SaveApPortalConfigRequest& setWhitelist(string whitelist) { DARABONBA_PTR_SET_VALUE(whitelist_, whitelist) };
