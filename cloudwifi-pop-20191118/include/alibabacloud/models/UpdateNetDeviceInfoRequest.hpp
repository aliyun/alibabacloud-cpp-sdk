...
#ifndef ALIBABACLOUD_MODELS_UPDATENETDEVICEINFOREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATENETDEVICEINFOREQUEST_HPP_
...
namespace Models
{
  class UpdateNetDeviceInfoRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateNetDeviceInfoRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AppCode, appCode_);
      DARABONBA_PTR_TO_JSON(AppName, appName_);
      DARABONBA_PTR_TO_JSON(Devices, devices_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateNetDeviceInfoRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AppCode, appCode_);
      DARABONBA_PTR_FROM_JSON(AppName, appName_);
      DARABONBA_PTR_FROM_JSON(Devices, devices_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    UpdateNetDeviceInfoRequest() = default ;
    UpdateNetDeviceInfoRequest(const UpdateNetDeviceInfoRequest &) = default ;
    UpdateNetDeviceInfoRequest(UpdateNetDeviceInfoRequest &&) = default ;
    UpdateNetDeviceInfoRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateNetDeviceInfoRequest() = default ;
    UpdateNetDeviceInfoRequest& operator=(const UpdateNetDeviceInfoRequest &) = default ;
    UpdateNetDeviceInfoRequest& operator=(UpdateNetDeviceInfoRequest &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->hostName_ == nullptr
        && this->id_ == nullptr && this->idc_ == nullptr && this->logicNetPod_ == nullptr && this->manufacturer_ == nullptr && this->mgnIp_ == nullptr
        && this->model_ == nullptr && this->netPod_ == nullptr && this->password_ == nullptr && this->role_ == nullptr && this->serviceTag_ == nullptr
      ...
      inline Devices& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UpdateNetDeviceInfoRequest& setAppCode(string appCode) { DARABONBA_PTR_SET_VALUE(appCode_, appCode) };
    ...
    inline UpdateNetDeviceInfoRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };


    // devices Field Functions 
    bool hasDevices() const { return this->devices_ != nullptr;};
    void deleteDevices() { this->devices_ = nullptr;};
    inline const vector<UpdateNetDeviceInfoRequest::Devices> & getDevices() const { DARABONBA_PTR_GET_CONST(devices_, vector<UpdateNetDeviceInfoRequest::Devices>) };
    inline vector<UpdateNetDeviceInfoRequest::Devices> getDevices() { DARABONBA_PTR_GET(devices_, vector<UpdateNetDeviceInfoRequest::Devices>) };
    inline UpdateNetDeviceInfoRequest& setDevices(const vector<UpdateNetDeviceInfoRequest::Devices> & devices) { DARABONBA_PTR_SET_VALUE(devices_, devices) };
    inline UpdateNetDeviceInfoRequest& setDevices(vector<UpdateNetDeviceInfoRequest::Devices> && devices) { DARABONBA_PTR_SET_RVALUE(devices_, devices) };
    ...
    inline UpdateNetDeviceInfoRequest& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<UpdateNetDeviceInfoRequest::Devices>> devices_ {};
    // This parameter is required.
