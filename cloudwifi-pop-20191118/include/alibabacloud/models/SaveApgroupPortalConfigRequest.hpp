...
#ifndef ALIBABACLOUD_MODELS_SAVEAPGROUPPORTALCONFIGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SAVEAPGROUPPORTALCONFIGREQUEST_HPP_
...
namespace Models
{
  class SaveApgroupPortalConfigRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const SaveApgroupPortalConfigRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(PortalTypes, portalTypes_);
    ...
    friend void from_json(const Darabonba::Json& j, SaveApgroupPortalConfigRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(PortalTypes, portalTypes_);
    ...
    SaveApgroupPortalConfigRequest() = default ;
    SaveApgroupPortalConfigRequest(const SaveApgroupPortalConfigRequest &) = default ;
    SaveApgroupPortalConfigRequest(SaveApgroupPortalConfigRequest &&) = default ;
    SaveApgroupPortalConfigRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SaveApgroupPortalConfigRequest() = default ;
    SaveApgroupPortalConfigRequest& operator=(const SaveApgroupPortalConfigRequest &) = default ;
    SaveApgroupPortalConfigRequest& operator=(SaveApgroupPortalConfigRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->apgroupId_ == nullptr
        ...
        && this->portalTypes_ == nullptr && this->portalUrl_ == nullptr && this->timeStamp_ == nullptr && this->totalDownload_ == nullptr && this->totalUpload_ == nullptr
    ...
    inline SaveApgroupPortalConfigRequest& setApgroupId(int64_t apgroupId) { DARABONBA_PTR_SET_VALUE(apgroupId_, apgroupId) };
    ...
    inline SaveApgroupPortalConfigRequest& setAppAuthUrl(string appAuthUrl) { DARABONBA_PTR_SET_VALUE(appAuthUrl_, appAuthUrl) };
    ...
    inline SaveApgroupPortalConfigRequest& setAppCode(string appCode) { DARABONBA_PTR_SET_VALUE(appCode_, appCode) };
    ...
    inline SaveApgroupPortalConfigRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline SaveApgroupPortalConfigRequest& setAuthKey(string authKey) { DARABONBA_PTR_SET_VALUE(authKey_, authKey) };
    ...
    inline SaveApgroupPortalConfigRequest& setAuthSecret(string authSecret) { DARABONBA_PTR_SET_VALUE(authSecret_, authSecret) };
    ...
    inline SaveApgroupPortalConfigRequest& setCheckUrl(string checkUrl) { DARABONBA_PTR_SET_VALUE(checkUrl_, checkUrl) };
    ...
    inline SaveApgroupPortalConfigRequest& setClientDownload(int32_t clientDownload) { DARABONBA_PTR_SET_VALUE(clientDownload_, clientDownload) };
    ...
    inline SaveApgroupPortalConfigRequest& setClientUpload(int32_t clientUpload) { DARABONBA_PTR_SET_VALUE(clientUpload_, clientUpload) };
    ...
    inline SaveApgroupPortalConfigRequest& setCountdown(int32_t countdown) { DARABONBA_PTR_SET_VALUE(countdown_, countdown) };
    ...
    inline SaveApgroupPortalConfigRequest& setNetwork(int32_t network) { DARABONBA_PTR_SET_VALUE(network_, network) };


    // portalTypes Field Functions 
    bool hasPortalTypes() const { return this->portalTypes_ != nullptr;};
    void deletePortalTypes() { this->portalTypes_ = nullptr;};
    inline const vector<string> & getPortalTypes() const { DARABONBA_PTR_GET_CONST(portalTypes_, vector<string>) };
    inline vector<string> getPortalTypes() { DARABONBA_PTR_GET(portalTypes_, vector<string>) };
    inline SaveApgroupPortalConfigRequest& setPortalTypes(const vector<string> & portalTypes) { DARABONBA_PTR_SET_VALUE(portalTypes_, portalTypes) };
    inline SaveApgroupPortalConfigRequest& setPortalTypes(vector<string> && portalTypes) { DARABONBA_PTR_SET_RVALUE(portalTypes_, portalTypes) };
    ...
    inline SaveApgroupPortalConfigRequest& setPortalUrl(string portalUrl) { DARABONBA_PTR_SET_VALUE(portalUrl_, portalUrl) };
    ...
    inline SaveApgroupPortalConfigRequest& setTimeStamp(int64_t timeStamp) { DARABONBA_PTR_SET_VALUE(timeStamp_, timeStamp) };
    ...
    inline SaveApgroupPortalConfigRequest& setTotalDownload(int32_t totalDownload) { DARABONBA_PTR_SET_VALUE(totalDownload_, totalDownload) };
    ...
    inline SaveApgroupPortalConfigRequest& setTotalUpload(int32_t totalUpload) { DARABONBA_PTR_SET_VALUE(totalUpload_, totalUpload) };
    ...
    inline SaveApgroupPortalConfigRequest& setWebAuthUrl(string webAuthUrl) { DARABONBA_PTR_SET_VALUE(webAuthUrl_, webAuthUrl) };
    ...
    inline SaveApgroupPortalConfigRequest& setWhitelist(string whitelist) { DARABONBA_PTR_SET_VALUE(whitelist_, whitelist) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> portalTypes_ {};
