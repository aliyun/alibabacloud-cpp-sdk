...
#ifndef ALIBABACLOUD_MODELS_SAVEAPGROUPPORTALCONFIGSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SAVEAPGROUPPORTALCONFIGSHRINKREQUEST_HPP_
...
namespace Models
{
  class SaveApgroupPortalConfigShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const SaveApgroupPortalConfigShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SaveApgroupPortalConfigShrinkRequest& obj) { 
    ...
    SaveApgroupPortalConfigShrinkRequest() = default ;
    SaveApgroupPortalConfigShrinkRequest(const SaveApgroupPortalConfigShrinkRequest &) = default ;
    SaveApgroupPortalConfigShrinkRequest(SaveApgroupPortalConfigShrinkRequest &&) = default ;
    SaveApgroupPortalConfigShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SaveApgroupPortalConfigShrinkRequest() = default ;
    SaveApgroupPortalConfigShrinkRequest& operator=(const SaveApgroupPortalConfigShrinkRequest &) = default ;
    SaveApgroupPortalConfigShrinkRequest& operator=(SaveApgroupPortalConfigShrinkRequest &&) = default ;
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setApgroupId(int64_t apgroupId) { DARABONBA_PTR_SET_VALUE(apgroupId_, apgroupId) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setAppAuthUrl(string appAuthUrl) { DARABONBA_PTR_SET_VALUE(appAuthUrl_, appAuthUrl) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setAppCode(string appCode) { DARABONBA_PTR_SET_VALUE(appCode_, appCode) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setAuthKey(string authKey) { DARABONBA_PTR_SET_VALUE(authKey_, authKey) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setAuthSecret(string authSecret) { DARABONBA_PTR_SET_VALUE(authSecret_, authSecret) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setCheckUrl(string checkUrl) { DARABONBA_PTR_SET_VALUE(checkUrl_, checkUrl) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setClientDownload(int32_t clientDownload) { DARABONBA_PTR_SET_VALUE(clientDownload_, clientDownload) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setClientUpload(int32_t clientUpload) { DARABONBA_PTR_SET_VALUE(clientUpload_, clientUpload) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setCountdown(int32_t countdown) { DARABONBA_PTR_SET_VALUE(countdown_, countdown) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setNetwork(int32_t network) { DARABONBA_PTR_SET_VALUE(network_, network) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setPortalTypesShrink(string portalTypesShrink) { DARABONBA_PTR_SET_VALUE(portalTypesShrink_, portalTypesShrink) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setPortalUrl(string portalUrl) { DARABONBA_PTR_SET_VALUE(portalUrl_, portalUrl) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setTimeStamp(int64_t timeStamp) { DARABONBA_PTR_SET_VALUE(timeStamp_, timeStamp) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setTotalDownload(int32_t totalDownload) { DARABONBA_PTR_SET_VALUE(totalDownload_, totalDownload) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setTotalUpload(int32_t totalUpload) { DARABONBA_PTR_SET_VALUE(totalUpload_, totalUpload) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setWebAuthUrl(string webAuthUrl) { DARABONBA_PTR_SET_VALUE(webAuthUrl_, webAuthUrl) };
    ...
    inline SaveApgroupPortalConfigShrinkRequest& setWhitelist(string whitelist) { DARABONBA_PTR_SET_VALUE(whitelist_, whitelist) };
