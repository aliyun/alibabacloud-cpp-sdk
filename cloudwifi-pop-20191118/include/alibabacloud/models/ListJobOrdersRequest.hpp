...
#ifndef ALIBABACLOUD_MODELS_LISTJOBORDERSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTJOBORDERSREQUEST_HPP_
...
namespace Models
{
  class ListJobOrdersRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListJobOrdersRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListJobOrdersRequest& obj) { 
    ...
    ListJobOrdersRequest() = default ;
    ListJobOrdersRequest(const ListJobOrdersRequest &) = default ;
    ListJobOrdersRequest(ListJobOrdersRequest &&) = default ;
    ListJobOrdersRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListJobOrdersRequest() = default ;
    ListJobOrdersRequest& operator=(const ListJobOrdersRequest &) = default ;
    ListJobOrdersRequest& operator=(ListJobOrdersRequest &&) = default ;
    ...
    inline ListJobOrdersRequest& setAppCode(string appCode) { DARABONBA_PTR_SET_VALUE(appCode_, appCode) };
    ...
    inline ListJobOrdersRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ListJobOrdersRequest& setChangingType(string changingType) { DARABONBA_PTR_SET_VALUE(changingType_, changingType) };
    ...
    inline ListJobOrdersRequest& setClientSystem(string clientSystem) { DARABONBA_PTR_SET_VALUE(clientSystem_, clientSystem) };
    ...
    inline ListJobOrdersRequest& setClientUniqueId(string clientUniqueId) { DARABONBA_PTR_SET_VALUE(clientUniqueId_, clientUniqueId) };
    ...
    inline ListJobOrdersRequest& setCursor(int64_t cursor) { DARABONBA_PTR_SET_VALUE(cursor_, cursor) };
    ...
    inline ListJobOrdersRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ListJobOrdersRequest& setHandler(string handler) { DARABONBA_PTR_SET_VALUE(handler_, handler) };
    ...
    inline ListJobOrdersRequest& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListJobOrdersRequest& setOrderStatus(string orderStatus) { DARABONBA_PTR_SET_VALUE(orderStatus_, orderStatus) };
    ...
    inline ListJobOrdersRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListJobOrdersRequest& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListJobOrdersRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ListJobOrdersRequest& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListJobOrdersRequest& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
