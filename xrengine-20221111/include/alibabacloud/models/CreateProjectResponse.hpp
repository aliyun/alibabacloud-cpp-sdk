...
namespace Models
{
  ...
  public:
    ...
    inline const CreateProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateProjectResponseBody) };
    inline CreateProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateProjectResponseBody> body_ {};
  };
