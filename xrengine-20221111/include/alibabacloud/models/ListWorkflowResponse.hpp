...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkflowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWorkflowResponseBody) };
    inline ListWorkflowResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWorkflowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWorkflowResponseBody> body_ {};
  };
