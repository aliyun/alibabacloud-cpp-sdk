...
#ifndef ALIBABACLOUD_MODELS_GETAREDITUGCMATERIALRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETAREDITUGCMATERIALRESPONSEBODY_HPP_
...
namespace Models
{
  class GetArEditUgcMaterialResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetArEditUgcMaterialResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetArEditUgcMaterialResponseBody& obj) { 
    ...
    GetArEditUgcMaterialResponseBody() = default ;
    GetArEditUgcMaterialResponseBody(const GetArEditUgcMaterialResponseBody &) = default ;
    GetArEditUgcMaterialResponseBody(GetArEditUgcMaterialResponseBody &&) = default ;
    GetArEditUgcMaterialResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetArEditUgcMaterialResponseBody() = default ;
    GetArEditUgcMaterialResponseBody& operator=(const GetArEditUgcMaterialResponseBody &) = default ;
    GetArEditUgcMaterialResponseBody& operator=(GetArEditUgcMaterialResponseBody &&) = default ;
    ...
    inline GetArEditUgcMaterialResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetArEditUgcMaterialResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetArEditUgcMaterialResponseBody::Data) };
    inline GetArEditUgcMaterialResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetArEditUgcMaterialResponseBody::Data) };
    inline GetArEditUgcMaterialResponseBody& setData(const GetArEditUgcMaterialResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetArEditUgcMaterialResponseBody& setData(GetArEditUgcMaterialResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetArEditUgcMaterialResponseBody& setErrorName(string errorName) { DARABONBA_PTR_SET_VALUE(errorName_, errorName) };
    ...
    inline GetArEditUgcMaterialResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline GetArEditUgcMaterialResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetArEditUgcMaterialResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetArEditUgcMaterialResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<GetArEditUgcMaterialResponseBody::Data> data_ {};
