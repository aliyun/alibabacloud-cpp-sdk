...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOrderResponseBodyInstanceIds & instanceIds() const { DARABONBA_PTR_GET_CONST(instanceIds_, CreateOrderResponseBodyInstanceIds) };
    inline CreateOrderResponseBodyInstanceIds instanceIds() { DARABONBA_PTR_GET(instanceIds_, CreateOrderResponseBodyInstanceIds) };
    inline CreateOrderResponseBody& setInstanceIds(const CreateOrderResponseBodyInstanceIds & instanceIds) { DARABONBA_PTR_SET_VALUE(instanceIds_, instanceIds) };
    inline CreateOrderResponseBody& setInstanceIds(CreateOrderResponseBodyInstanceIds && instanceIds) { DARABONBA_PTR_SET_RVALUE(instanceIds_, instanceIds) };
  ...
  protected:
    std::shared_ptr<CreateOrderResponseBodyInstanceIds> instanceIds_ = nullptr;
