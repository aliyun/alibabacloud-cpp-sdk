...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeProjectNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeProjectNodesResponseBody) };
    inline DescribeProjectNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeProjectNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeProjectNodesResponseBody> body_ {};
  };
