...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInvoiceForIsvResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyInvoiceForIsvResponseBody) };
    inline ModifyInvoiceForIsvResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyInvoiceForIsvResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyInvoiceForIsvResponseBody> body_ {};
  };
