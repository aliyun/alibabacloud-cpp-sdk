...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECURRENTNODEINFORESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECURRENTNODEINFORESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCurrentNodeInfoResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeCurrentNodeInfoResponseBodyResult& obj) { 
    ...
    DescribeCurrentNodeInfoResponseBodyResult() = default ;
    DescribeCurrentNodeInfoResponseBodyResult(const DescribeCurrentNodeInfoResponseBodyResult &) = default ;
    DescribeCurrentNodeInfoResponseBodyResult(DescribeCurrentNodeInfoResponseBodyResult &&) = default ;
    DescribeCurrentNodeInfoResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCurrentNodeInfoResponseBodyResult() = default ;
    DescribeCurrentNodeInfoResponseBodyResult& operator=(const DescribeCurrentNodeInfoResponseBodyResult &) = default ;
    DescribeCurrentNodeInfoResponseBodyResult& operator=(DescribeCurrentNodeInfoResponseBodyResult &&) = default ;
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setAllowRollbackNode(bool allowRollbackNode) { DARABONBA_PTR_SET_VALUE(allowRollbackNode_, allowRollbackNode) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setAutoFinishNode(bool autoFinishNode) { DARABONBA_PTR_SET_VALUE(autoFinishNode_, autoFinishNode) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setFinalStepNo(int32_t finalStepNo) { DARABONBA_PTR_SET_VALUE(finalStepNo_, finalStepNo) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setGmtExpired(int64_t gmtExpired) { DARABONBA_PTR_SET_VALUE(gmtExpired_, gmtExpired) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setGmtFinished(int64_t gmtFinished) { DARABONBA_PTR_SET_VALUE(gmtFinished_, gmtFinished) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setGmtStart(int64_t gmtStart) { DARABONBA_PTR_SET_VALUE(gmtStart_, gmtStart) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setNeedAttachment(bool needAttachment) { DARABONBA_PTR_SET_VALUE(needAttachment_, needAttachment) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setNextNodeId(int64_t nextNodeId) { DARABONBA_PTR_SET_VALUE(nextNodeId_, nextNodeId) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setNodeId(int64_t nodeId) { DARABONBA_PTR_SET_VALUE(nodeId_, nodeId) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setNodeName(string nodeName) { DARABONBA_PTR_SET_VALUE(nodeName_, nodeName) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setNodeStatus(string nodeStatus) { DARABONBA_PTR_SET_VALUE(nodeStatus_, nodeStatus) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setOperatorRole(string operatorRole) { DARABONBA_PTR_SET_VALUE(operatorRole_, operatorRole) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setParentNodeId(int64_t parentNodeId) { DARABONBA_PTR_SET_VALUE(parentNodeId_, parentNodeId) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setPreviousNodeId(int64_t previousNodeId) { DARABONBA_PTR_SET_VALUE(previousNodeId_, previousNodeId) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setStepNo(int32_t stepNo) { DARABONBA_PTR_SET_VALUE(stepNo_, stepNo) };
    ...
    inline DescribeCurrentNodeInfoResponseBodyResult& setTemplateForm(string templateForm) { DARABONBA_PTR_SET_VALUE(templateForm_, templateForm) };
