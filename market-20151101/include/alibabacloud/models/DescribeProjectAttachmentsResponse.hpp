...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeProjectAttachmentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeProjectAttachmentsResponseBody) };
    inline DescribeProjectAttachmentsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeProjectAttachmentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeProjectAttachmentsResponseBody> body_ {};
  };
