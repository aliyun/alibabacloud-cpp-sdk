...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDistributionProductsLinkResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<DescribeDistributionProductsLinkResponseBodyResult>) };
    inline vector<DescribeDistributionProductsLinkResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<DescribeDistributionProductsLinkResponseBodyResult>) };
    inline DescribeDistributionProductsLinkResponseBody& setResult(const vector<DescribeDistributionProductsLinkResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeDistributionProductsLinkResponseBody& setResult(vector<DescribeDistributionProductsLinkResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDistributionProductsLinkResponseBodyResult>> result_ = nullptr;
