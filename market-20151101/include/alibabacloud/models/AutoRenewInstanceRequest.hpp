...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoRenewCycle_ == nullptr
    ...
    inline string getAutoRenewCycle() const { DARABONBA_PTR_GET_DEFAULT(autoRenewCycle_, "") };
    ...
    inline int64_t getOrderBizId() const { DARABONBA_PTR_GET_DEFAULT(orderBizId_, 0L) };
