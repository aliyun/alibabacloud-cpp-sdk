...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApiMeteringResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApiMeteringResponseBody) };
    inline DescribeApiMeteringResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApiMeteringResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApiMeteringResponseBody> body_ {};
  };
