...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCurrentNodeInfoResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeCurrentNodeInfoResponseBodyResult) };
    inline DescribeCurrentNodeInfoResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeCurrentNodeInfoResponseBodyResult) };
    inline DescribeCurrentNodeInfoResponseBody& setResult(const DescribeCurrentNodeInfoResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeCurrentNodeInfoResponseBody& setResult(DescribeCurrentNodeInfoResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCurrentNodeInfoResponseBodyResult> result_ = nullptr;
