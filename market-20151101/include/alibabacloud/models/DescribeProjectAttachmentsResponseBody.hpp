...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeProjectAttachmentsResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<DescribeProjectAttachmentsResponseBodyResult>) };
    inline vector<DescribeProjectAttachmentsResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<DescribeProjectAttachmentsResponseBodyResult>) };
    inline DescribeProjectAttachmentsResponseBody& setResult(const vector<DescribeProjectAttachmentsResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeProjectAttachmentsResponseBody& setResult(vector<DescribeProjectAttachmentsResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeProjectAttachmentsResponseBodyResult>> result_ = nullptr;
