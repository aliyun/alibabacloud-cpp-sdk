...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeProjectNodesResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<DescribeProjectNodesResponseBody::Result>) };
    inline vector<DescribeProjectNodesResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<DescribeProjectNodesResponseBody::Result>) };
    inline DescribeProjectNodesResponseBody& setResult(const vector<DescribeProjectNodesResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeProjectNodesResponseBody& setResult(vector<DescribeProjectNodesResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
