...
namespace Models
{
  ...
  public:
    ...
    inline const CrossAccountVerifyTokenResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CrossAccountVerifyTokenResponseBodyResult) };
    inline CrossAccountVerifyTokenResponseBodyResult result() { DARABONBA_PTR_GET(result_, CrossAccountVerifyTokenResponseBodyResult) };
    inline CrossAccountVerifyTokenResponseBody& setResult(const CrossAccountVerifyTokenResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CrossAccountVerifyTokenResponseBody& setResult(CrossAccountVerifyTokenResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<CrossAccountVerifyTokenResponseBodyResult> result_ = nullptr;
