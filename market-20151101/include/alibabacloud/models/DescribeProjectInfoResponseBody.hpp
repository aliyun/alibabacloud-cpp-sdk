...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeProjectInfoResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeProjectInfoResponseBodyResult) };
    inline DescribeProjectInfoResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeProjectInfoResponseBodyResult) };
    inline DescribeProjectInfoResponseBody& setResult(const DescribeProjectInfoResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeProjectInfoResponseBody& setResult(DescribeProjectInfoResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeProjectInfoResponseBodyResult> result_ = nullptr;
