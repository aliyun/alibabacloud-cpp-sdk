...
namespace Models
{
  ...
  public:
    ...
    inline ListApiKeysRequest& setApiKeyId(string apiKeyId) { DARABONBA_PTR_SET_VALUE(apiKeyId_, apiKeyId) };
    ...
    inline ListApiKeysRequest& setSkip(int32_t skip) { DARABONBA_PTR_SET_VALUE(skip_, skip) };
    ...
    inline ListApiKeysRequest& setUid(string uid) { DARABONBA_PTR_SET_VALUE(uid_, uid) };
