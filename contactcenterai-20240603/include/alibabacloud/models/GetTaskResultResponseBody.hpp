...
namespace Models
{
  ...
  public:
    ...
    inline const GetTaskResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTaskResultResponseBodyData) };
    inline GetTaskResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTaskResultResponseBodyData) };
    inline GetTaskResultResponseBody& setData(const GetTaskResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTaskResultResponseBody& setData(GetTaskResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetTaskResultResponseBodyData> data_ = nullptr;
