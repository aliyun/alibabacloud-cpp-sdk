...
namespace Models
{
  ...
  public:
    ...
    inline RunCompletionResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunCompletionResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunCompletionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunCompletionResponseBody) };
    inline RunCompletionResponseBody getBody() { DARABONBA_PTR_GET(body_, RunCompletionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunCompletionResponseBody> body_ {};
  };
