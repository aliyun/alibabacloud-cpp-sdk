...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVocabResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateVocabResponseBodyData) };
    inline CreateVocabResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateVocabResponseBodyData) };
    inline CreateVocabResponseBody& setData(const CreateVocabResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateVocabResponseBody& setData(CreateVocabResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<CreateVocabResponseBodyData> data_ = nullptr;
