...
namespace Models
{
  ...
  public:
    ...
    inline const GetVocabResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVocabResponseBody) };
    inline GetVocabResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVocabResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVocabResponseBody> body_ {};
  };
