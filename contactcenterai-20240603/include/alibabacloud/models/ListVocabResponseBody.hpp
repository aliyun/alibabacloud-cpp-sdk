...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListVocabResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListVocabResponseBody::Data>) };
    inline vector<ListVocabResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListVocabResponseBody::Data>) };
    inline ListVocabResponseBody& setData(const vector<ListVocabResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListVocabResponseBody& setData(vector<ListVocabResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    shared_ptr<vector<ListVocabResponseBody::Data>> data_ {};
