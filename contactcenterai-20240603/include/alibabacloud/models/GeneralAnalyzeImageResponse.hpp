...
namespace Models
{
  ...
  public:
    ...
    inline GeneralAnalyzeImageResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GeneralAnalyzeImageResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const GeneralAnalyzeImageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GeneralAnalyzeImageResponseBody) };
    inline GeneralAnalyzeImageResponseBody getBody() { DARABONBA_PTR_GET(body_, GeneralAnalyzeImageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GeneralAnalyzeImageResponseBody> body_ {};
  };
