...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->migrationMode_ == nullptr
        && return this->accountId_ == nullptr && return this->clientToken_ == nullptr && return this->migrationJobId_ == nullptr && return this->ownerId_ == nullptr && return this->pageNum_ == nullptr
