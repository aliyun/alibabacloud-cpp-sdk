...
#ifndef ALIBABACLOUD_MODELS_STOPDTSJOBSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_STOPDTSJOBSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StopDtsJobsRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DtsJobIds, dtsJobIds_);
      DARABONBA_PTR_TO_JSON(RegionId, regionId_);
      DARABONBA_PTR_TO_JSON(ResourceGroupId, resourceGroupId_);
      DARABONBA_PTR_TO_JSON(ZeroEtlJob, zeroEtlJob_);
    };
    friend void from_json(const Darabonba::Json& j, StopDtsJobsRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DtsJobIds, dtsJobIds_);
      DARABONBA_PTR_FROM_JSON(RegionId, regionId_);
      DARABONBA_PTR_FROM_JSON(ResourceGroupId, resourceGroupId_);
      DARABONBA_PTR_FROM_JSON(ZeroEtlJob, zeroEtlJob_);
    };
    StopDtsJobsRequest() = default ;
    StopDtsJobsRequest(const StopDtsJobsRequest &) = default ;
    StopDtsJobsRequest(StopDtsJobsRequest &&) = default ;
    StopDtsJobsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StopDtsJobsRequest() = default ;
    StopDtsJobsRequest& operator=(const StopDtsJobsRequest &) = default ;
    StopDtsJobsRequest& operator=(StopDtsJobsRequest &&) = default ;
