...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePreCheckStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePreCheckStatusResponseBody) };
    inline DescribePreCheckStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePreCheckStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePreCheckStatusResponseBody> body_ {};
  };
