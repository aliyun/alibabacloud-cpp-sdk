...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBSYNCJOBPRECHECKSTATUSDETAIL_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBSYNCJOBPRECHECKSTATUSDETAIL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail& obj) { 
    ...
    DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail() = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail(const DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail &) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail(DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail &&) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail() = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail& operator=(const DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail &) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail& operator=(DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail &&) = default ;
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail& setCheckItem(string checkItem) { DARABONBA_PTR_SET_VALUE(checkItem_, checkItem) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail& setCheckItemDescription(string checkItemDescription) { DARABONBA_PTR_SET_VALUE(checkItemDescription_, checkItemDescription) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail& setCheckResult(string checkResult) { DARABONBA_PTR_SET_VALUE(checkResult_, checkResult) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail& setFailedReason(string failedReason) { DARABONBA_PTR_SET_VALUE(failedReason_, failedReason) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobPrecheckStatusDetail& setRepairMethod(string repairMethod) { DARABONBA_PTR_SET_VALUE(repairMethod_, repairMethod) };
