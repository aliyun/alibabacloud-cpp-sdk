...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDynamicConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDynamicConfigResponseBody) };
    inline ModifyDynamicConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDynamicConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDynamicConfigResponseBody> body_ {};
  };
