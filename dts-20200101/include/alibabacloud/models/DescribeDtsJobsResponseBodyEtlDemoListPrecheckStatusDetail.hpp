...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDTSJOBSRESPONSEBODYETLDEMOLISTPRECHECKSTATUSDETAIL_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDTSJOBSRESPONSEBODYETLDEMOLISTPRECHECKSTATUSDETAIL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail& obj) { 
    ...
    DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail() = default ;
    DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail(const DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail &) = default ;
    DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail(DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail &&) = default ;
    DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail() = default ;
    DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail& operator=(const DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail &) = default ;
    DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail& operator=(DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail &&) = default ;
    ...
    inline DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail& setCheckItem(string checkItem) { DARABONBA_PTR_SET_VALUE(checkItem_, checkItem) };
    ...
    inline DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail& setCheckItemDescription(string checkItemDescription) { DARABONBA_PTR_SET_VALUE(checkItemDescription_, checkItemDescription) };
    ...
    inline DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail& setCheckResult(string checkResult) { DARABONBA_PTR_SET_VALUE(checkResult_, checkResult) };
    ...
    inline DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail& setFailedReason(string failedReason) { DARABONBA_PTR_SET_VALUE(failedReason_, failedReason) };
    ...
    inline DescribeDtsJobsResponseBodyEtlDemoListPrecheckStatusDetail& setRepairMethod(string repairMethod) { DARABONBA_PTR_SET_VALUE(repairMethod_, repairMethod) };
