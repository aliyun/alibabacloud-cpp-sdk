...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTagKeysResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTagKeysResponseBody) };
    inline DescribeTagKeysResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTagKeysResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTagKeysResponseBody> body_ {};
  };
