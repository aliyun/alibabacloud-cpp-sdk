...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyJobStepCheckpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyJobStepCheckpointResponseBody) };
    inline ModifyJobStepCheckpointResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyJobStepCheckpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyJobStepCheckpointResponseBody> body_ {};
  };
