...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dtsInstanceId_ == nullptr
        && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->sid_ == nullptr && this->subMigrationJobIds_ == nullptr && this->topics_ == nullptr; };
    ...
    inline     const Darabonba::Json & getSubMigrationJobIds() const { DARABONBA_GET(subMigrationJobIds_) };
    Darabonba::Json & getSubMigrationJobIds() { DARABONBA_GET(subMigrationJobIds_) };
    ...
    inline     const Darabonba::Json & getTopics() const { DARABONBA_GET(topics_) };
    Darabonba::Json & getTopics() { DARABONBA_GET(topics_) };
