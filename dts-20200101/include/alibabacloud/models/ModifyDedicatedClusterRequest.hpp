...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dedicatedClusterId_ == nullptr
        && return this->dedicatedClusterName_ == nullptr && return this->instanceId_ == nullptr && return this->oversoldRatio_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr
