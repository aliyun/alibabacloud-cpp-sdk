...
namespace Models
{
  ...
  public:
    ...
    inline const StopDedicatedClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopDedicatedClusterResponseBody) };
    inline StopDedicatedClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, StopDedicatedClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopDedicatedClusterResponseBody> body_ {};
  };
