...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSynchronizationJobAlertResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSynchronizationJobAlertResponseBody) };
    inline DescribeSynchronizationJobAlertResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSynchronizationJobAlertResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSynchronizationJobAlertResponseBody> body_ {};
  };
