...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->databaseName_ == nullptr
        && return this->engineName_ == nullptr && return this->IP_ == nullptr && return this->instanceId_ == nullptr && return this->instanceType_ == nullptr && return this->port_ == nullptr
        && return this->userName_ == nullptr && return this->oracleSID_ == nullptr; };
