...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBSYNCJOBREVERSEJOBMIGRATIONMODE_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBSYNCJOBREVERSEJOBMIGRATIONMODE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode& obj) { 
    ...
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode() = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode(const DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode &) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode(DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode &&) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode() = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode& operator=(const DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode &) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode& operator=(DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode &&) = default ;
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode& setDataExtractTransformLoad(bool dataExtractTransformLoad) { DARABONBA_PTR_SET_VALUE(dataExtractTransformLoad_, dataExtractTransformLoad) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode& setDataInitialization(bool dataInitialization) { DARABONBA_PTR_SET_VALUE(dataInitialization_, dataInitialization) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode& setDataSynchronization(bool dataSynchronization) { DARABONBA_PTR_SET_VALUE(dataSynchronization_, dataSynchronization) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobMigrationMode& setStructureInitialization(bool structureInitialization) { DARABONBA_PTR_SET_VALUE(structureInitialization_, structureInitialization) };
