...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->checkpoint_ == nullptr
        ...
        && return this->dtsJobId_ == nullptr && return this->dtsJobName_ == nullptr && return this->errorNotice_ == nullptr && return this->errorPhone_ == nullptr && return this->fileOssUrl_ == nullptr
