...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBSYNCJOBREVERSEJOBPRECHECKSTATUSDETAIL_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBSYNCJOBREVERSEJOBPRECHECKSTATUSDETAIL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail& obj) { 
    ...
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail() = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail(const DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail &) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail(DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail &&) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail() = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail& operator=(const DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail &) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail& operator=(DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail &&) = default ;
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail& setCheckItem(string checkItem) { DARABONBA_PTR_SET_VALUE(checkItem_, checkItem) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail& setCheckItemDescription(string checkItemDescription) { DARABONBA_PTR_SET_VALUE(checkItemDescription_, checkItemDescription) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail& setCheckResult(string checkResult) { DARABONBA_PTR_SET_VALUE(checkResult_, checkResult) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail& setFailedReason(string failedReason) { DARABONBA_PTR_SET_VALUE(failedReason_, failedReason) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobPrecheckStatusDetail& setRepairMethod(string repairMethod) { DARABONBA_PTR_SET_VALUE(repairMethod_, repairMethod) };
