...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSubscriptionInstanceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateSubscriptionInstanceResponseBody) };
    inline CreateSubscriptionInstanceResponseBody body() { DARABONBA_PTR_GET(body_, CreateSubscriptionInstanceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateSubscriptionInstanceResponseBody> body_ = nullptr;
  };
