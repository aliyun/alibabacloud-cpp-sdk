...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountId_ == nullptr
        && return this->consumptionTimestamp_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->subscriptionInstanceId_ == nullptr; };
    ...
    inline string consumptionTimestamp() const { DARABONBA_PTR_GET_DEFAULT(consumptionTimestamp_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> consumptionTimestamp_ = nullptr;
