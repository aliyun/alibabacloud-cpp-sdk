...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMigrationJobAlertResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMigrationJobAlertResponseBody) };
    inline DescribeMigrationJobAlertResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMigrationJobAlertResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMigrationJobAlertResponseBody> body_ {};
  };
