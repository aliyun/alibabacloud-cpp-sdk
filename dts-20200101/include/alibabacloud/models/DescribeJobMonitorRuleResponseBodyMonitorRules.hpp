...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->delayRuleTime_ == nullptr
        && return this->jobId_ == nullptr && return this->jobType_ == nullptr && return this->noticeValue_ == nullptr && return this->period_ == nullptr && return this->phone_ == nullptr
        && return this->state_ == nullptr && return this->times_ == nullptr && return this->type_ == nullptr; };
