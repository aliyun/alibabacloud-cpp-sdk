...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySynchronizationObjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySynchronizationObjectResponseBody) };
    inline ModifySynchronizationObjectResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySynchronizationObjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySynchronizationObjectResponseBody> body_ {};
  };
