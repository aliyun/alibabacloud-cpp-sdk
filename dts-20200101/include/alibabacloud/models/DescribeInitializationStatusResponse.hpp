...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInitializationStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInitializationStatusResponseBody) };
    inline DescribeInitializationStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInitializationStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInitializationStatusResponseBody> body_ {};
  };
