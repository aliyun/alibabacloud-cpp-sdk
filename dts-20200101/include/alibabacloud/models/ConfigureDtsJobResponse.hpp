...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigureDtsJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigureDtsJobResponseBody) };
    inline ConfigureDtsJobResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigureDtsJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigureDtsJobResponseBody> body_ {};
  };
