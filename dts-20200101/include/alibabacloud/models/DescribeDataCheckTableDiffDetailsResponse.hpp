...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataCheckTableDiffDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataCheckTableDiffDetailsResponseBody) };
    inline DescribeDataCheckTableDiffDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDataCheckTableDiffDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDataCheckTableDiffDetailsResponseBody> body_ {};
  };
