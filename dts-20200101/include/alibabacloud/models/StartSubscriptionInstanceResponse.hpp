...
namespace Models
{
  ...
  public:
    ...
    inline const StartSubscriptionInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartSubscriptionInstanceResponseBody) };
    inline StartSubscriptionInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, StartSubscriptionInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartSubscriptionInstanceResponseBody> body_ {};
  };
