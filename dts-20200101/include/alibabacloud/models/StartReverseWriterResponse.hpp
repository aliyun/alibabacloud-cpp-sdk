...
namespace Models
{
  ...
  public:
    ...
    inline const StartReverseWriterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartReverseWriterResponseBody) };
    inline StartReverseWriterResponseBody getBody() { DARABONBA_PTR_GET(body_, StartReverseWriterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartReverseWriterResponseBody> body_ {};
  };
