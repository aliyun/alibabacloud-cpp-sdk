...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->destinationOwnerDBName_ == nullptr
        && return this->errorMessage_ == nullptr && return this->finishRowNum_ == nullptr && return this->sourceOwnerDBName_ == nullptr && return this->status_ == nullptr && return this->tableName_ == nullptr
        && return this->totalRowNum_ == nullptr && return this->usedTime_ == nullptr; };
