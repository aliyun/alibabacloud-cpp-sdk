...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDTSJOBSRESPONSEBODYETLDEMOLISTREVERSEJOBPRECHECKSTATUSDETAIL_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDTSJOBSRESPONSEBODYETLDEMOLISTREVERSEJOBPRECHECKSTATUSDETAIL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail& obj) { 
    ...
    DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail() = default ;
    DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail(const DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail &) = default ;
    DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail(DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail &&) = default ;
    DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail() = default ;
    DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail& operator=(const DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail &) = default ;
    DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail& operator=(DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail &&) = default ;
    ...
    inline DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail& setCheckItem(string checkItem) { DARABONBA_PTR_SET_VALUE(checkItem_, checkItem) };
    ...
    inline DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail& setCheckItemDescription(string checkItemDescription) { DARABONBA_PTR_SET_VALUE(checkItemDescription_, checkItemDescription) };
    ...
    inline DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail& setCheckResult(string checkResult) { DARABONBA_PTR_SET_VALUE(checkResult_, checkResult) };
    ...
    inline DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail& setFailedReason(string failedReason) { DARABONBA_PTR_SET_VALUE(failedReason_, failedReason) };
    ...
    inline DescribeDtsJobsResponseBodyEtlDemoListReverseJobPrecheckStatusDetail& setRepairMethod(string repairMethod) { DARABONBA_PTR_SET_VALUE(repairMethod_, repairMethod) };
