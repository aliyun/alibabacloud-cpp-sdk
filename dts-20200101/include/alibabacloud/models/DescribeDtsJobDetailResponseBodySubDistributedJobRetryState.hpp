...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBDISTRIBUTEDJOBRETRYSTATE_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBDISTRIBUTEDJOBRETRYSTATE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& obj) { 
    ...
    DescribeDtsJobDetailResponseBodySubDistributedJobRetryState() = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobRetryState(const DescribeDtsJobDetailResponseBodySubDistributedJobRetryState &) = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobRetryState(DescribeDtsJobDetailResponseBodySubDistributedJobRetryState &&) = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobRetryState(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDtsJobDetailResponseBodySubDistributedJobRetryState() = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& operator=(const DescribeDtsJobDetailResponseBodySubDistributedJobRetryState &) = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& operator=(DescribeDtsJobDetailResponseBodySubDistributedJobRetryState &&) = default ;
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& setErrMsg(string errMsg) { DARABONBA_PTR_SET_VALUE(errMsg_, errMsg) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& setMaxRetryTime(int32_t maxRetryTime) { DARABONBA_PTR_SET_VALUE(maxRetryTime_, maxRetryTime) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& setModule(string module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& setRetryCount(int32_t retryCount) { DARABONBA_PTR_SET_VALUE(retryCount_, retryCount) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& setRetryTarget(string retryTarget) { DARABONBA_PTR_SET_VALUE(retryTarget_, retryTarget) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& setRetryTime(int32_t retryTime) { DARABONBA_PTR_SET_VALUE(retryTime_, retryTime) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobRetryState& setRetrying(bool retrying) { DARABONBA_PTR_SET_VALUE(retrying_, retrying) };
