...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDtsJobEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDtsJobEndpointResponseBody) };
    inline ModifyDtsJobEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDtsJobEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDtsJobEndpointResponseBody> body_ {};
  };
