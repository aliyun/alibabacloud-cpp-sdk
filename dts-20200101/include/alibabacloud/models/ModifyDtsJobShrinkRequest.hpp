...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && return this->dataInitialization_ == nullptr && return this->dataSynchronization_ == nullptr && return this->dbListShrink_ == nullptr && return this->dtsInstanceId_ == nullptr && return this->dtsJobId_ == nullptr
    ...
    inline string dbListShrink() const { DARABONBA_PTR_GET_DEFAULT(dbListShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> dbListShrink_ = nullptr;
