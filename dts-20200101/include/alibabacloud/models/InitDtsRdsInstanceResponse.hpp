...
namespace Models
{
  ...
  public:
    ...
    inline const InitDtsRdsInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InitDtsRdsInstanceResponseBody) };
    inline InitDtsRdsInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, InitDtsRdsInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InitDtsRdsInstanceResponseBody> body_ {};
  };
