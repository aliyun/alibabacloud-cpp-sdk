...
namespace Models
{
  ...
  public:
    ...
    inline const CreateConsumerGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateConsumerGroupResponseBody) };
    inline CreateConsumerGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateConsumerGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateConsumerGroupResponseBody> body_ {};
  };
