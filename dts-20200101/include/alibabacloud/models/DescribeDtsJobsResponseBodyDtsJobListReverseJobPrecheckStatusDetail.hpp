...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDTSJOBSRESPONSEBODYDTSJOBLISTREVERSEJOBPRECHECKSTATUSDETAIL_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDTSJOBSRESPONSEBODYDTSJOBLISTREVERSEJOBPRECHECKSTATUSDETAIL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail& obj) { 
    ...
    DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail() = default ;
    DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail(const DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail &) = default ;
    DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail(DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail &&) = default ;
    DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail() = default ;
    DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail& operator=(const DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail &) = default ;
    DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail& operator=(DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail &&) = default ;
    ...
    inline DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail& setCheckItem(string checkItem) { DARABONBA_PTR_SET_VALUE(checkItem_, checkItem) };
    ...
    inline DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail& setCheckItemDescription(string checkItemDescription) { DARABONBA_PTR_SET_VALUE(checkItemDescription_, checkItemDescription) };
    ...
    inline DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail& setCheckResult(string checkResult) { DARABONBA_PTR_SET_VALUE(checkResult_, checkResult) };
    ...
    inline DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail& setFailedReason(string failedReason) { DARABONBA_PTR_SET_VALUE(failedReason_, failedReason) };
    ...
    inline DescribeDtsJobsResponseBodyDtsJobListReverseJobPrecheckStatusDetail& setRepairMethod(string repairMethod) { DARABONBA_PTR_SET_VALUE(repairMethod_, repairMethod) };
