...
namespace Models
{
  ...
  public:
    ...
    inline const ListJobStepResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListJobStepResponseBody) };
    inline ListJobStepResponseBody getBody() { DARABONBA_PTR_GET(body_, ListJobStepResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListJobStepResponseBody> body_ {};
  };
