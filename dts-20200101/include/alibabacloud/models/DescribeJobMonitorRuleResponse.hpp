...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeJobMonitorRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeJobMonitorRuleResponseBody) };
    inline DescribeJobMonitorRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeJobMonitorRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeJobMonitorRuleResponseBody> body_ {};
  };
