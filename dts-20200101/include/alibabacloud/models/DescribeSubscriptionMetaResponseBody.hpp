...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errCode_ == nullptr
        && return this->errMessage_ == nullptr && return this->httpStatusCode_ == nullptr && return this->requestId_ == nullptr && return this->subscriptionMetaList_ == nullptr && return this->success_ == nullptr; };
