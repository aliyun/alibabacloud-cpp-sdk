...
namespace Models
{
  ...
  public:
    ...
    inline string getDestAliyunUid() const { DARABONBA_PTR_GET_DEFAULT(destAliyunUid_, "") };
    ...
    inline string getDestRoleName() const { DARABONBA_PTR_GET_DEFAULT(destRoleName_, "") };
    ...
    inline string getSrcAliyunUid() const { DARABONBA_PTR_GET_DEFAULT(srcAliyunUid_, "") };
    ...
    inline string getSrcRoleName() const { DARABONBA_PTR_GET_DEFAULT(srcRoleName_, "") };
