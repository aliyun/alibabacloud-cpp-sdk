...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBSYNCJOBREVERSEJOBRETRYSTATE_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBSYNCJOBREVERSEJOBRETRYSTATE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& obj) { 
    ...
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState() = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState(const DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState &) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState(DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState &&) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState() = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& operator=(const DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState &) = default ;
    DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& operator=(DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState &&) = default ;
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& setErrMsg(string errMsg) { DARABONBA_PTR_SET_VALUE(errMsg_, errMsg) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& setMaxRetryTime(int32_t maxRetryTime) { DARABONBA_PTR_SET_VALUE(maxRetryTime_, maxRetryTime) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& setModule(string module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& setRetryCount(int32_t retryCount) { DARABONBA_PTR_SET_VALUE(retryCount_, retryCount) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& setRetryTarget(string retryTarget) { DARABONBA_PTR_SET_VALUE(retryTarget_, retryTarget) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& setRetryTime(int32_t retryTime) { DARABONBA_PTR_SET_VALUE(retryTime_, retryTime) };
    ...
    inline DescribeDtsJobDetailResponseBodySubSyncJobReverseJobRetryState& setRetrying(bool retrying) { DARABONBA_PTR_SET_VALUE(retrying_, retrying) };
