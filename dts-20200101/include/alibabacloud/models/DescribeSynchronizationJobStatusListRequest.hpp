...
namespace Models
{
  ...
  public:
    ...
    inline string getSynchronizationJobIdListJsonStr() const { DARABONBA_PTR_GET_DEFAULT(synchronizationJobIdListJsonStr_, "") };
  ...
  protected:
    ...
    shared_ptr<string> synchronizationJobIdListJsonStr_ {};
  };
