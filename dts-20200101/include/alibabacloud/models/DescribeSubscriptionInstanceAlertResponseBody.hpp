...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->delayAlertPhone_ == nullptr
        ...
        && return this->errorAlertStatus_ == nullptr && return this->requestId_ == nullptr && return this->subscriptionInstanceID_ == nullptr && return this->subscriptionInstanceName_ == nullptr && return this->success_ == nullptr; };
