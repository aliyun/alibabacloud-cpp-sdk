...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dynamicCode_ == nullptr
        ...
        && return this->pageRecordCount_ == nullptr && return this->requestId_ == nullptr && return this->serviceLogContexts_ == nullptr && return this->success_ == nullptr && return this->totalRecordCount_ == nullptr; };
