...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBSCRIPTIONHOST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBSCRIPTIONHOST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDtsJobDetailResponseBodySubscriptionHost& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDtsJobDetailResponseBodySubscriptionHost& obj) { 
    ...
    DescribeDtsJobDetailResponseBodySubscriptionHost() = default ;
    DescribeDtsJobDetailResponseBodySubscriptionHost(const DescribeDtsJobDetailResponseBodySubscriptionHost &) = default ;
    DescribeDtsJobDetailResponseBodySubscriptionHost(DescribeDtsJobDetailResponseBodySubscriptionHost &&) = default ;
    DescribeDtsJobDetailResponseBodySubscriptionHost(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDtsJobDetailResponseBodySubscriptionHost() = default ;
    DescribeDtsJobDetailResponseBodySubscriptionHost& operator=(const DescribeDtsJobDetailResponseBodySubscriptionHost &) = default ;
    DescribeDtsJobDetailResponseBodySubscriptionHost& operator=(DescribeDtsJobDetailResponseBodySubscriptionHost &&) = default ;
    ...
    inline DescribeDtsJobDetailResponseBodySubscriptionHost& setPrivateHost(string privateHost) { DARABONBA_PTR_SET_VALUE(privateHost_, privateHost) };
    ...
    inline DescribeDtsJobDetailResponseBodySubscriptionHost& setPublicHost(string publicHost) { DARABONBA_PTR_SET_VALUE(publicHost_, publicHost) };
    ...
    inline DescribeDtsJobDetailResponseBodySubscriptionHost& setVpcHost(string vpcHost) { DARABONBA_PTR_SET_VALUE(vpcHost_, vpcHost) };
