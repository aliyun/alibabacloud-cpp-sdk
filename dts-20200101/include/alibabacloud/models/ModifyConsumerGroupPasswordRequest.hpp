...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountId_ == nullptr
        && this->consumerGroupID_ == nullptr && this->consumerGroupName_ == nullptr && this->consumerGroupPassword_ == nullptr && this->consumerGroupUserName_ == nullptr && this->ownerId_ == nullptr
        && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->subscriptionInstanceId_ == nullptr && this->consumerGroupNewPassword_ == nullptr; };
    ...
    inline string getConsumerGroupNewPassword() const { DARABONBA_PTR_GET_DEFAULT(consumerGroupNewPassword_, "") };
