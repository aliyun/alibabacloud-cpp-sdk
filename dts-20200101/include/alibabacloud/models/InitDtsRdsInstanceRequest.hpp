...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dtsInstanceId_ == nullptr
        && this->endpointCenId_ == nullptr && this->endpointInstanceId_ == nullptr && this->endpointInstanceType_ == nullptr && this->endpointRegion_ == nullptr && this->regionId_ == nullptr
    ...
    inline string getEndpointCenId() const { DARABONBA_PTR_GET_DEFAULT(endpointCenId_, "") };
    ...
    inline string getEndpointRegion() const { DARABONBA_PTR_GET_DEFAULT(endpointRegion_, "") };
