...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMigrationJobDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMigrationJobDetailResponseBody) };
    inline DescribeMigrationJobDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMigrationJobDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMigrationJobDetailResponseBody> body_ {};
  };
