...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigureMigrationJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigureMigrationJobResponseBody) };
    inline ConfigureMigrationJobResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigureMigrationJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigureMigrationJobResponseBody> body_ {};
  };
