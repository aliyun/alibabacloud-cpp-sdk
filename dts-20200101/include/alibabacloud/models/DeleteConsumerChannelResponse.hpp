...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteConsumerChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteConsumerChannelResponseBody) };
    inline DeleteConsumerChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteConsumerChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteConsumerChannelResponseBody> body_ {};
  };
