...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDtsJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDtsJobsResponseBody) };
    inline DeleteDtsJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDtsJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDtsJobsResponseBody> body_ {};
  };
