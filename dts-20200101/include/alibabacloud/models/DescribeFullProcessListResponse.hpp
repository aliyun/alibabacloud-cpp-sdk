...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFullProcessListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeFullProcessListResponseBody) };
    inline DescribeFullProcessListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeFullProcessListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeFullProcessListResponseBody> body_ {};
  };
