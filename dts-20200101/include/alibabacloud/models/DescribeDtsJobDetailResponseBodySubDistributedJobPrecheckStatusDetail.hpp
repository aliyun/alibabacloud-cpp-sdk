...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBDISTRIBUTEDJOBPRECHECKSTATUSDETAIL_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBDISTRIBUTEDJOBPRECHECKSTATUSDETAIL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail& obj) { 
    ...
    DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail() = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail(const DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail &) = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail(DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail &&) = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail() = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail& operator=(const DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail &) = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail& operator=(DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail &&) = default ;
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail& setCheckItem(string checkItem) { DARABONBA_PTR_SET_VALUE(checkItem_, checkItem) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail& setCheckItemDescription(string checkItemDescription) { DARABONBA_PTR_SET_VALUE(checkItemDescription_, checkItemDescription) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail& setCheckResult(string checkResult) { DARABONBA_PTR_SET_VALUE(checkResult_, checkResult) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail& setFailedReason(string failedReason) { DARABONBA_PTR_SET_VALUE(failedReason_, failedReason) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobPrecheckStatusDetail& setRepairMethod(string repairMethod) { DARABONBA_PTR_SET_VALUE(repairMethod_, repairMethod) };
