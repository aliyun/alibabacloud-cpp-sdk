...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDtsJobConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDtsJobConfigResponseBody) };
    inline DescribeDtsJobConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDtsJobConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDtsJobConfigResponseBody> body_ {};
  };
