...
namespace Models
{
  ...
  public:
    ...
    inline const SuspendDtsJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SuspendDtsJobResponseBody) };
    inline SuspendDtsJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SuspendDtsJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SuspendDtsJobResponseBody> body_ {};
  };
