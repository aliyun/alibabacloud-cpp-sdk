...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoPay_ == nullptr
        ...
        && this->dtsRegion_ == nullptr && this->du_ == nullptr && this->feeType_ == nullptr && this->insightModule_ == nullptr && this->instanceClass_ == nullptr
        && this->jobId_ == nullptr && this->maxDu_ == nullptr && this->minDu_ == nullptr && this->payType_ == nullptr && this->period_ == nullptr
        && this->quantity_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->sourceEndpointEngineName_ == nullptr && this->sourceRegion_ == nullptr
        && this->syncArchitecture_ == nullptr && this->type_ == nullptr && this->usedTime_ == nullptr; };
    ...
    inline int32_t getComputeUnit() const { DARABONBA_PTR_GET_DEFAULT(computeUnit_, 0) };
    ...
    inline string getDtsRegion() const { DARABONBA_PTR_GET_DEFAULT(dtsRegion_, "") };
    ...
    inline int32_t getDu() const { DARABONBA_PTR_GET_DEFAULT(du_, 0) };
    ...
    inline CreateDtsInstanceRequest& setInsightModule(bool insightModule) { DARABONBA_PTR_SET_VALUE(insightModule_, insightModule) };
    ...
    inline string getSyncArchitecture() const { DARABONBA_PTR_GET_DEFAULT(syncArchitecture_, "") };
  ...
  protected:
    ...
    shared_ptr<int32_t> computeUnit_ {};
    ...
    shared_ptr<string> syncArchitecture_ {};
