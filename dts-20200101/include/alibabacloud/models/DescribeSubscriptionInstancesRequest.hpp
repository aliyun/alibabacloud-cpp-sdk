...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountId_ == nullptr
        ...
        && this->resourceGroupId_ == nullptr && this->subscriptionInstanceName_ == nullptr && this->tag_ == nullptr; };
    ...
    inline const vector<DescribeSubscriptionInstancesRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeSubscriptionInstancesRequest::Tag>) };
    inline vector<DescribeSubscriptionInstancesRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeSubscriptionInstancesRequest::Tag>) };
    inline DescribeSubscriptionInstancesRequest& setTag(const vector<DescribeSubscriptionInstancesRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeSubscriptionInstancesRequest& setTag(vector<DescribeSubscriptionInstancesRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeSubscriptionInstancesRequest::Tag>> tag_ {};
  };
