...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDtsJobConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyDtsJobConfigResponseBody) };
    inline ModifyDtsJobConfigResponseBody body() { DARABONBA_PTR_GET(body_, ModifyDtsJobConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyDtsJobConfigResponseBody> body_ = nullptr;
  };
