...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSynchronizationJobStatusListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSynchronizationJobStatusListResponseBody) };
    inline DescribeSynchronizationJobStatusListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSynchronizationJobStatusListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSynchronizationJobStatusListResponseBody> body_ = nullptr;
  };
