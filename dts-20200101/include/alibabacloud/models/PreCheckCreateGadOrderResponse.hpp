...
namespace Models
{
  ...
  public:
    ...
    inline const PreCheckCreateGadOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PreCheckCreateGadOrderResponseBody) };
    inline PreCheckCreateGadOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, PreCheckCreateGadOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PreCheckCreateGadOrderResponseBody> body_ {};
  };
