...
namespace Models
{
  ...
  public:
    ...
    inline const StartMigrationJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartMigrationJobResponseBody) };
    inline StartMigrationJobResponseBody getBody() { DARABONBA_PTR_GET(body_, StartMigrationJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartMigrationJobResponseBody> body_ {};
  };
