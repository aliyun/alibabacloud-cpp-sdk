...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataInitializationDetails_ == nullptr
        && return this->dataSynchronizationDetails_ == nullptr && return this->errCode_ == nullptr && return this->errMessage_ == nullptr && return this->requestId_ == nullptr && return this->structureInitializationDetails_ == nullptr
