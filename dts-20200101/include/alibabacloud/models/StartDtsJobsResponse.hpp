...
namespace Models
{
  ...
  public:
    ...
    inline const StartDtsJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartDtsJobsResponseBody) };
    inline StartDtsJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, StartDtsJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartDtsJobsResponseBody> body_ {};
  };
