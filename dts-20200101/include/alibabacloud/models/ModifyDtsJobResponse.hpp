...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDtsJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDtsJobResponseBody) };
    inline ModifyDtsJobResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDtsJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDtsJobResponseBody> body_ {};
  };
