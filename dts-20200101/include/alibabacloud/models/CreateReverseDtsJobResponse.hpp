...
namespace Models
{
  ...
  public:
    ...
    inline const CreateReverseDtsJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateReverseDtsJobResponseBody) };
    inline CreateReverseDtsJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateReverseDtsJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateReverseDtsJobResponseBody> body_ {};
  };
