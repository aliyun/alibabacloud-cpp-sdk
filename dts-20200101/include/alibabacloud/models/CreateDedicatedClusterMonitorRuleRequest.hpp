...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getCpuAlarmThreshold() const { DARABONBA_PTR_GET_DEFAULT(cpuAlarmThreshold_, 0L) };
    ...
    inline int64_t getDiskAlarmThreshold() const { DARABONBA_PTR_GET_DEFAULT(diskAlarmThreshold_, 0L) };
    ...
    inline int64_t getDuAlarmThreshold() const { DARABONBA_PTR_GET_DEFAULT(duAlarmThreshold_, 0L) };
    ...
    inline int64_t getMemAlarmThreshold() const { DARABONBA_PTR_GET_DEFAULT(memAlarmThreshold_, 0L) };
    ...
    inline int64_t getNoticeSwitch() const { DARABONBA_PTR_GET_DEFAULT(noticeSwitch_, 0L) };
