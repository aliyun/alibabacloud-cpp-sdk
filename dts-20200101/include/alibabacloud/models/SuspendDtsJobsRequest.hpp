...
#ifndef ALIBABACLOUD_MODELS_SUSPENDDTSJOBSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SUSPENDDTSJOBSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SuspendDtsJobsRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DtsJobIds, dtsJobIds_);
      DARABONBA_PTR_TO_JSON(RegionId, regionId_);
      DARABONBA_PTR_TO_JSON(ResourceGroupId, resourceGroupId_);
      DARABONBA_PTR_TO_JSON(ZeroEtlJob, zeroEtlJob_);
    };
    friend void from_json(const Darabonba::Json& j, SuspendDtsJobsRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DtsJobIds, dtsJobIds_);
      DARABONBA_PTR_FROM_JSON(RegionId, regionId_);
      DARABONBA_PTR_FROM_JSON(ResourceGroupId, resourceGroupId_);
      DARABONBA_PTR_FROM_JSON(ZeroEtlJob, zeroEtlJob_);
    };
    SuspendDtsJobsRequest() = default ;
    SuspendDtsJobsRequest(const SuspendDtsJobsRequest &) = default ;
    SuspendDtsJobsRequest(SuspendDtsJobsRequest &&) = default ;
    SuspendDtsJobsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SuspendDtsJobsRequest() = default ;
    SuspendDtsJobsRequest& operator=(const SuspendDtsJobsRequest &) = default ;
    SuspendDtsJobsRequest& operator=(SuspendDtsJobsRequest &&) = default ;
    ...
    inline SuspendDtsJobsRequest& setDtsJobIds(string dtsJobIds) { DARABONBA_PTR_SET_VALUE(dtsJobIds_, dtsJobIds) };
    ...
    inline SuspendDtsJobsRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline SuspendDtsJobsRequest& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline SuspendDtsJobsRequest& setZeroEtlJob(bool zeroEtlJob) { DARABONBA_PTR_SET_VALUE(zeroEtlJob_, zeroEtlJob) };
