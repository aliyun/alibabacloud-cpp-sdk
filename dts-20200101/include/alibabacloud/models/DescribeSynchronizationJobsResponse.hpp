...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSynchronizationJobsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSynchronizationJobsResponseBody) };
    inline DescribeSynchronizationJobsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSynchronizationJobsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSynchronizationJobsResponseBody> body_ = nullptr;
  };
