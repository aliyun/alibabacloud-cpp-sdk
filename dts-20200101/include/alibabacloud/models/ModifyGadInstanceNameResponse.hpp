...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyGadInstanceNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyGadInstanceNameResponseBody) };
    inline ModifyGadInstanceNameResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyGadInstanceNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyGadInstanceNameResponseBody> body_ {};
  };
