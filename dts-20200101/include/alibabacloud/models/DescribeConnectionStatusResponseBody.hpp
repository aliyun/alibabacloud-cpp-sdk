...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->destinationConnectionStatus_ == nullptr
        && return this->errCode_ == nullptr && return this->errMessage_ == nullptr && return this->requestId_ == nullptr && return this->sourceConnectionStatus_ == nullptr && return this->success_ == nullptr; };
