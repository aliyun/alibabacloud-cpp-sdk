...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dtsJobId_ == nullptr
        && this->ragInstanceId_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr; };
    ...
    inline DescribeDocParserJobStatusRequest& setRagInstanceId(string ragInstanceId) { DARABONBA_PTR_SET_VALUE(ragInstanceId_, ragInstanceId) };
