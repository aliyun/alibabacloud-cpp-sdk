...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBDISTRIBUTEDJOBREVERSEJOBRETRYSTATE_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDTSJOBDETAILRESPONSEBODYSUBDISTRIBUTEDJOBREVERSEJOBRETRYSTATE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& obj) { 
    ...
    DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState() = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState(const DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState &) = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState(DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState &&) = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState() = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& operator=(const DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState &) = default ;
    DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& operator=(DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState &&) = default ;
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& setErrMsg(string errMsg) { DARABONBA_PTR_SET_VALUE(errMsg_, errMsg) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& setMaxRetryTime(int32_t maxRetryTime) { DARABONBA_PTR_SET_VALUE(maxRetryTime_, maxRetryTime) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& setModule(string module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& setRetryCount(int32_t retryCount) { DARABONBA_PTR_SET_VALUE(retryCount_, retryCount) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& setRetryTarget(string retryTarget) { DARABONBA_PTR_SET_VALUE(retryTarget_, retryTarget) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& setRetryTime(int32_t retryTime) { DARABONBA_PTR_SET_VALUE(retryTime_, retryTime) };
    ...
    inline DescribeDtsJobDetailResponseBodySubDistributedJobReverseJobRetryState& setRetrying(bool retrying) { DARABONBA_PTR_SET_VALUE(retrying_, retrying) };
