...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSubscriptionInstanceAlertResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSubscriptionInstanceAlertResponseBody) };
    inline DescribeSubscriptionInstanceAlertResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSubscriptionInstanceAlertResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSubscriptionInstanceAlertResponseBody> body_ {};
  };
