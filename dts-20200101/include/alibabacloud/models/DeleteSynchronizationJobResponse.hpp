...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSynchronizationJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSynchronizationJobResponseBody) };
    inline DeleteSynchronizationJobResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSynchronizationJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSynchronizationJobResponseBody> body_ {};
  };
