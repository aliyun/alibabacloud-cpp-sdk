...
namespace Models
{
  ...
  public:
    ...
    inline const SkipFullJobTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SkipFullJobTableResponseBody) };
    inline SkipFullJobTableResponseBody getBody() { DARABONBA_PTR_GET(body_, SkipFullJobTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SkipFullJobTableResponseBody> body_ {};
  };
