...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMigrationJobsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeMigrationJobsResponseBody) };
    inline DescribeMigrationJobsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeMigrationJobsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeMigrationJobsResponseBody> body_ = nullptr;
  };
