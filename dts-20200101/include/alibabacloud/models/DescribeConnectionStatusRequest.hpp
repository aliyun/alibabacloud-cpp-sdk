...
namespace Models
{
  ...
  public:
    ...
    inline string getDestinationEndpointArchitecture() const { DARABONBA_PTR_GET_DEFAULT(destinationEndpointArchitecture_, "") };
    ...
    inline string getSourceEndpointArchitecture() const { DARABONBA_PTR_GET_DEFAULT(sourceEndpointArchitecture_, "") };
  ...
  protected:
    ...
    shared_ptr<string> destinationEndpointArchitecture_ {};
    ...
    shared_ptr<string> sourceEndpointArchitecture_ {};
