...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataCheckReportUrlResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataCheckReportUrlResponseBody) };
    inline DescribeDataCheckReportUrlResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDataCheckReportUrlResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDataCheckReportUrlResponseBody> body_ = nullptr;
  };
