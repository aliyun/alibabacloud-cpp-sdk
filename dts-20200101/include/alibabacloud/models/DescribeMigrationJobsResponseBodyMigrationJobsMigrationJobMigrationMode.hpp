...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEMIGRATIONJOBSRESPONSEBODYMIGRATIONJOBSMIGRATIONJOBMIGRATIONMODE_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEMIGRATIONJOBSRESPONSEBODYMIGRATIONJOBSMIGRATIONJOBMIGRATIONMODE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode& obj) { 
    ...
    DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode() = default ;
    DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode(const DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode &) = default ;
    DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode(DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode &&) = default ;
    DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode() = default ;
    DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode& operator=(const DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode &) = default ;
    DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode& operator=(DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode &&) = default ;
    ...
    inline DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode& setDataInitialization(bool dataInitialization) { DARABONBA_PTR_SET_VALUE(dataInitialization_, dataInitialization) };
    ...
    inline DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode& setDataSynchronization(bool dataSynchronization) { DARABONBA_PTR_SET_VALUE(dataSynchronization_, dataSynchronization) };
    ...
    inline DescribeMigrationJobsResponseBodyMigrationJobsMigrationJobMigrationMode& setStructureInitialization(bool structureInitialization) { DARABONBA_PTR_SET_VALUE(structureInitialization_, structureInitialization) };
