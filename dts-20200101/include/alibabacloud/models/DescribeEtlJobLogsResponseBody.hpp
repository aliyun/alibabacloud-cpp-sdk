...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dynamicCode_ == nullptr
        && return this->dynamicMessage_ == nullptr && return this->errCode_ == nullptr && return this->errMessage_ == nullptr && return this->etlRunningLogs_ == nullptr && return this->httpStatusCode_ == nullptr
