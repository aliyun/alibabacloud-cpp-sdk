...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dtsInstanceId_ == nullptr
        && return this->dtsJobId_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->synchronizationDirection_ == nullptr && return this->zeroEtlJob_ == nullptr; };
