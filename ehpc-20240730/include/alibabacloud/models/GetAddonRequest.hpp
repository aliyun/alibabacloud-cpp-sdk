...
namespace Models
{
  ...
  public:
    ...
    inline GetAddonRequest& setAddonId(string addonId) { DARABONBA_PTR_SET_VALUE(addonId_, addonId) };
    ...
    inline GetAddonRequest& setClusterId(string clusterId) { DARABONBA_PTR_SET_VALUE(clusterId_, clusterId) };
