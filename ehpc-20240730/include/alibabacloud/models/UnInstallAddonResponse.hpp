...
namespace Models
{
  ...
  public:
    ...
    inline const UnInstallAddonResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnInstallAddonResponseBody) };
    inline UnInstallAddonResponseBody getBody() { DARABONBA_PTR_GET(body_, UnInstallAddonResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnInstallAddonResponseBody> body_ {};
  };
