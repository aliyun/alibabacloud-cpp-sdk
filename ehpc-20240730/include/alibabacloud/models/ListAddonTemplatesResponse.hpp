...
namespace Models
{
  ...
  public:
    ...
    inline const ListAddonTemplatesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAddonTemplatesResponseBody) };
    inline ListAddonTemplatesResponseBody body() { DARABONBA_PTR_GET(body_, ListAddonTemplatesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAddonTemplatesResponseBody> body_ = nullptr;
  };
