...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstalledSoftwaresResponseBodyAdditionalPackages & additionalPackages() const { DARABONBA_PTR_GET_CONST(additionalPackages_, ListInstalledSoftwaresResponseBodyAdditionalPackages) };
    inline ListInstalledSoftwaresResponseBodyAdditionalPackages additionalPackages() { DARABONBA_PTR_GET(additionalPackages_, ListInstalledSoftwaresResponseBodyAdditionalPackages) };
    inline ListInstalledSoftwaresResponseBody& setAdditionalPackages(const ListInstalledSoftwaresResponseBodyAdditionalPackages & additionalPackages) { DARABONBA_PTR_SET_VALUE(additionalPackages_, additionalPackages) };
    inline ListInstalledSoftwaresResponseBody& setAdditionalPackages(ListInstalledSoftwaresResponseBodyAdditionalPackages && additionalPackages) { DARABONBA_PTR_SET_RVALUE(additionalPackages_, additionalPackages) };
  ...
  protected:
    ...
    std::shared_ptr<ListInstalledSoftwaresResponseBodyAdditionalPackages> additionalPackages_ = nullptr;
