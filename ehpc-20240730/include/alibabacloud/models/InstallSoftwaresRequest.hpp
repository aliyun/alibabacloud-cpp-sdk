...
namespace Models
{
  ...
  public:
    ...
    inline const vector<InstallSoftwaresRequest::AdditionalPackages> & getAdditionalPackages() const { DARABONBA_PTR_GET_CONST(additionalPackages_, vector<InstallSoftwaresRequest::AdditionalPackages>) };
    inline vector<InstallSoftwaresRequest::AdditionalPackages> getAdditionalPackages() { DARABONBA_PTR_GET(additionalPackages_, vector<InstallSoftwaresRequest::AdditionalPackages>) };
    inline InstallSoftwaresRequest& setAdditionalPackages(const vector<InstallSoftwaresRequest::AdditionalPackages> & additionalPackages) { DARABONBA_PTR_SET_VALUE(additionalPackages_, additionalPackages) };
    inline InstallSoftwaresRequest& setAdditionalPackages(vector<InstallSoftwaresRequest::AdditionalPackages> && additionalPackages) { DARABONBA_PTR_SET_RVALUE(additionalPackages_, additionalPackages) };
  ...
  protected:
    ...
    shared_ptr<vector<InstallSoftwaresRequest::AdditionalPackages>> additionalPackages_ {};
    // The cluster ID.
