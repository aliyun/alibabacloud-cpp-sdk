...
namespace Models
{
  ...
  public:
    ...
    inline const GetJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetJobResponseBody) };
    inline GetJobResponseBody getBody() { DARABONBA_PTR_GET(body_, GetJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetJobResponseBody> body_ {};
  };
