...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->jobId_ == nullptr
        && this->requestId_ == nullptr && this->stderrLog_ == nullptr && this->stderrLogSize_ == nullptr && this->stdoutLog_ == nullptr && this->stdoutLogSize_ == nullptr
    ...
    inline string getStderrLog() const { DARABONBA_PTR_GET_DEFAULT(stderrLog_, "") };
    ...
    inline string getStderrLogSize() const { DARABONBA_PTR_GET_DEFAULT(stderrLogSize_, "") };
    ...
    inline string getStdoutLog() const { DARABONBA_PTR_GET_DEFAULT(stdoutLog_, "") };
    ...
    inline string getStdoutLogSize() const { DARABONBA_PTR_GET_DEFAULT(stdoutLogSize_, "") };
  ...
  protected:
    ...
    shared_ptr<string> stderrLog_ {};
    // The size of the error output file.
    shared_ptr<string> stderrLogSize_ {};
    // The standard output log that is encoded in Base64.
    shared_ptr<string> stdoutLog_ {};
    // The size of the standard output file.
    shared_ptr<string> stdoutLogSize_ {};
