...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getActionName() const { DARABONBA_PTR_GET_CONST(actionName_, vector<string>) };
    inline vector<string> getActionName() { DARABONBA_PTR_GET(actionName_, vector<string>) };
  ...
  protected:
    // The action types.
    shared_ptr<vector<string>> actionName_ {};
