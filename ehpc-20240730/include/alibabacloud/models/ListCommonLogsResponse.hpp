...
namespace Models
{
  ...
  public:
    ...
    inline const ListCommonLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCommonLogsResponseBody) };
    inline ListCommonLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCommonLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCommonLogsResponseBody> body_ {};
  };
