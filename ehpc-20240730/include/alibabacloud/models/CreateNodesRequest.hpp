...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterId_ == nullptr
        ...
        && this->hostnameSuffix_ == nullptr && this->hostnames_ == nullptr && this->keepAlive_ == nullptr && this->minCount_ == nullptr && this->queueName_ == nullptr
    ...
    inline CreateNodesRequest& setMinCount(int32_t minCount) { DARABONBA_PTR_SET_VALUE(minCount_, minCount) };
