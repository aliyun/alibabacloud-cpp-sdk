...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAddonTemplatesResponseBodyAddons> & addons() const { DARABONBA_PTR_GET_CONST(addons_, vector<ListAddonTemplatesResponseBodyAddons>) };
    inline vector<ListAddonTemplatesResponseBodyAddons> addons() { DARABONBA_PTR_GET(addons_, vector<ListAddonTemplatesResponseBodyAddons>) };
    inline ListAddonTemplatesResponseBody& setAddons(const vector<ListAddonTemplatesResponseBodyAddons> & addons) { DARABONBA_PTR_SET_VALUE(addons_, addons) };
    inline ListAddonTemplatesResponseBody& setAddons(vector<ListAddonTemplatesResponseBodyAddons> && addons) { DARABONBA_PTR_SET_RVALUE(addons_, addons) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAddonTemplatesResponseBodyAddons>> addons_ = nullptr;
