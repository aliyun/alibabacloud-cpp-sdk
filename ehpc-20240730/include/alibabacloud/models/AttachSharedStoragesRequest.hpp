...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AttachSharedStoragesRequestSharedStorages> & sharedStorages() const { DARABONBA_PTR_GET_CONST(sharedStorages_, vector<AttachSharedStoragesRequestSharedStorages>) };
    inline vector<AttachSharedStoragesRequestSharedStorages> sharedStorages() { DARABONBA_PTR_GET(sharedStorages_, vector<AttachSharedStoragesRequestSharedStorages>) };
    inline AttachSharedStoragesRequest& setSharedStorages(const vector<AttachSharedStoragesRequestSharedStorages> & sharedStorages) { DARABONBA_PTR_SET_VALUE(sharedStorages_, sharedStorages) };
    inline AttachSharedStoragesRequest& setSharedStorages(vector<AttachSharedStoragesRequestSharedStorages> && sharedStorages) { DARABONBA_PTR_SET_RVALUE(sharedStorages_, sharedStorages) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<vector<AttachSharedStoragesRequestSharedStorages>> sharedStorages_ = nullptr;
  };
