...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterIdsShrink_ == nullptr
        && return this->clusterNamesShrink_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr; };
    ...
    inline string clusterNamesShrink() const { DARABONBA_PTR_GET_DEFAULT(clusterNamesShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> clusterNamesShrink_ = nullptr;
