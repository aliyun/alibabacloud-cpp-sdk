...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAvailableFileSystemsResponseBodyFileSystemList> & fileSystemList() const { DARABONBA_PTR_GET_CONST(fileSystemList_, vector<ListAvailableFileSystemsResponseBodyFileSystemList>) };
    inline vector<ListAvailableFileSystemsResponseBodyFileSystemList> fileSystemList() { DARABONBA_PTR_GET(fileSystemList_, vector<ListAvailableFileSystemsResponseBodyFileSystemList>) };
    inline ListAvailableFileSystemsResponseBody& setFileSystemList(const vector<ListAvailableFileSystemsResponseBodyFileSystemList> & fileSystemList) { DARABONBA_PTR_SET_VALUE(fileSystemList_, fileSystemList) };
    inline ListAvailableFileSystemsResponseBody& setFileSystemList(vector<ListAvailableFileSystemsResponseBodyFileSystemList> && fileSystemList) { DARABONBA_PTR_SET_RVALUE(fileSystemList_, fileSystemList) };
  ...
  protected:
    // The file systems.
    std::shared_ptr<vector<ListAvailableFileSystemsResponseBodyFileSystemList>> fileSystemList_ = nullptr;
    // The page number.
