...
namespace Models
{
  ...
  public:
    ...
    inline const StopJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopJobsResponseBody) };
    inline StopJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, StopJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopJobsResponseBody> body_ {};
  };
