...
namespace Models
{
  ...
  public:
    ...
    inline const ListComponentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListComponentsResponseBody) };
    inline ListComponentsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListComponentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListComponentsResponseBody> body_ {};
  };
