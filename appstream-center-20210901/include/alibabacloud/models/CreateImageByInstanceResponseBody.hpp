...
namespace Models
{
  ...
  public:
    ...
    inline const CreateImageByInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateImageByInstanceResponseBodyData) };
    inline CreateImageByInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateImageByInstanceResponseBodyData) };
    inline CreateImageByInstanceResponseBody& setData(const CreateImageByInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateImageByInstanceResponseBody& setData(CreateImageByInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
