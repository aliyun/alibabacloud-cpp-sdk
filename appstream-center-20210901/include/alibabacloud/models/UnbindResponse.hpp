...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnbindResponseBody) };
    inline UnbindResponseBody getBody() { DARABONBA_PTR_GET(body_, UnbindResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnbindResponseBody> body_ {};
  };
