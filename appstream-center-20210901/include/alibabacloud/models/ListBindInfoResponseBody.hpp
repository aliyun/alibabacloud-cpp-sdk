...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->bindInfoModels_ != nullptr
    ...
    inline const vector<ListBindInfoResponseBodyBindInfoModels> & bindInfoModels() const { DARABONBA_PTR_GET_CONST(bindInfoModels_, vector<ListBindInfoResponseBodyBindInfoModels>) };
    inline vector<ListBindInfoResponseBodyBindInfoModels> bindInfoModels() { DARABONBA_PTR_GET(bindInfoModels_, vector<ListBindInfoResponseBodyBindInfoModels>) };
    inline ListBindInfoResponseBody& setBindInfoModels(const vector<ListBindInfoResponseBodyBindInfoModels> & bindInfoModels) { DARABONBA_PTR_SET_VALUE(bindInfoModels_, bindInfoModels) };
    inline ListBindInfoResponseBody& setBindInfoModels(vector<ListBindInfoResponseBodyBindInfoModels> && bindInfoModels) { DARABONBA_PTR_SET_RVALUE(bindInfoModels_, bindInfoModels) };
  ...
  protected:
    std::shared_ptr<vector<ListBindInfoResponseBodyBindInfoModels>> bindInfoModels_ = nullptr;
