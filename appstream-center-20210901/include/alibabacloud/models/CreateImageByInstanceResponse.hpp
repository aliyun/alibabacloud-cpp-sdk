...
namespace Models
{
  ...
  public:
    ...
    inline const CreateImageByInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateImageByInstanceResponseBody) };
    inline CreateImageByInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateImageByInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateImageByInstanceResponseBody> body_ {};
  };
