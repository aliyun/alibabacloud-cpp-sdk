...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourcePriceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResourcePriceResponseBody) };
    inline GetResourcePriceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResourcePriceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResourcePriceResponseBody> body_ {};
  };
