...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWuyingServerEipInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWuyingServerEipInfoResponseBody) };
    inline DescribeWuyingServerEipInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWuyingServerEipInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWuyingServerEipInfoResponseBody> body_ {};
  };
