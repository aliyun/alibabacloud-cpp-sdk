...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appInstanceGroupId_ == nullptr
        ...
        && this->productType_ == nullptr && this->unAuthorizeUserGroupIds_ == nullptr && this->unAuthorizeUserIds_ == nullptr && this->userMeta_ == nullptr; };
    ...
    inline AuthorizeInstanceGroupRequest& setAppInstanceGroupSetId(string appInstanceGroupSetId) { DARABONBA_PTR_SET_VALUE(appInstanceGroupSetId_, appInstanceGroupSetId) };
