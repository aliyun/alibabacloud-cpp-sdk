...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getRenewNodes() const { DARABONBA_PTR_GET_CONST(renewNodes_, vector<string>) };
    inline vector<string> getRenewNodes() { DARABONBA_PTR_GET(renewNodes_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> renewNodes_ {};
  };
