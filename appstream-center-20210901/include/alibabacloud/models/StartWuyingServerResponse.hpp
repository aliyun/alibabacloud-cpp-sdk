...
namespace Models
{
  ...
  public:
    ...
    inline const StartWuyingServerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, StartWuyingServerResponseBody) };
    inline StartWuyingServerResponseBody body() { DARABONBA_PTR_GET(body_, StartWuyingServerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<StartWuyingServerResponseBody> body_ = nullptr;
  };
