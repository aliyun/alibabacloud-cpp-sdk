...
namespace Models
{
  ...
  public:
    ...
    inline const ListImageResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListImageResponseBody) };
    inline ListImageResponseBody body() { DARABONBA_PTR_GET(body_, ListImageResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListImageResponseBody> body_ = nullptr;
  };
