...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyWuyingServerAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyWuyingServerAttributeResponseBody) };
    inline ModifyWuyingServerAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyWuyingServerAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyWuyingServerAttributeResponseBody> body_ {};
  };
