...
namespace Models
{
  ...
  public:
    ...
    inline const StopWuyingServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopWuyingServerResponseBody) };
    inline StopWuyingServerResponseBody getBody() { DARABONBA_PTR_GET(body_, StopWuyingServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopWuyingServerResponseBody> body_ {};
  };
