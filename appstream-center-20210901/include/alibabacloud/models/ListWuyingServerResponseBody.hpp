...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->totalCount_ == nullptr && return this->wuyingServerList_ == nullptr; };
    ...
    inline const vector<ListWuyingServerResponseBodyWuyingServerList> & wuyingServerList() const { DARABONBA_PTR_GET_CONST(wuyingServerList_, vector<ListWuyingServerResponseBodyWuyingServerList>) };
    inline vector<ListWuyingServerResponseBodyWuyingServerList> wuyingServerList() { DARABONBA_PTR_GET(wuyingServerList_, vector<ListWuyingServerResponseBodyWuyingServerList>) };
    inline ListWuyingServerResponseBody& setWuyingServerList(const vector<ListWuyingServerResponseBodyWuyingServerList> & wuyingServerList) { DARABONBA_PTR_SET_VALUE(wuyingServerList_, wuyingServerList) };
    inline ListWuyingServerResponseBody& setWuyingServerList(vector<ListWuyingServerResponseBodyWuyingServerList> && wuyingServerList) { DARABONBA_PTR_SET_RVALUE(wuyingServerList_, wuyingServerList) };
