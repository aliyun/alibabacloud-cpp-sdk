...
#ifndef ALIBABACLOUD_MODELS_GETRESOURCERENEWPRICERESPONSEBODYDATAPRICEPROMOTIONS_HPP_
#define ALIBABACLOUD_MODELS_GETRESOURCERENEWPRICERESPONSEBODYDATAPRICEPROMOTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetResourceRenewPriceResponseBodyDataPricePromotions& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetResourceRenewPriceResponseBodyDataPricePromotions& obj) { 
    ...
    GetResourceRenewPriceResponseBodyDataPricePromotions() = default ;
    GetResourceRenewPriceResponseBodyDataPricePromotions(const GetResourceRenewPriceResponseBodyDataPricePromotions &) = default ;
    GetResourceRenewPriceResponseBodyDataPricePromotions(GetResourceRenewPriceResponseBodyDataPricePromotions &&) = default ;
    GetResourceRenewPriceResponseBodyDataPricePromotions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetResourceRenewPriceResponseBodyDataPricePromotions() = default ;
    GetResourceRenewPriceResponseBodyDataPricePromotions& operator=(const GetResourceRenewPriceResponseBodyDataPricePromotions &) = default ;
    GetResourceRenewPriceResponseBodyDataPricePromotions& operator=(GetResourceRenewPriceResponseBodyDataPricePromotions &&) = default ;
    ...
    inline GetResourceRenewPriceResponseBodyDataPricePromotions& setOptionCode(string optionCode) { DARABONBA_PTR_SET_VALUE(optionCode_, optionCode) };
    ...
    inline GetResourceRenewPriceResponseBodyDataPricePromotions& setPromotionDesc(string promotionDesc) { DARABONBA_PTR_SET_VALUE(promotionDesc_, promotionDesc) };
    ...
    inline GetResourceRenewPriceResponseBodyDataPricePromotions& setPromotionId(string promotionId) { DARABONBA_PTR_SET_VALUE(promotionId_, promotionId) };
    ...
    inline GetResourceRenewPriceResponseBodyDataPricePromotions& setPromotionName(string promotionName) { DARABONBA_PTR_SET_VALUE(promotionName_, promotionName) };
    ...
    inline GetResourceRenewPriceResponseBodyDataPricePromotions& setSelected(bool selected) { DARABONBA_PTR_SET_VALUE(selected_, selected) };
