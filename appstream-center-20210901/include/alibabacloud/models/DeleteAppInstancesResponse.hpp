...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAppInstancesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteAppInstancesResponseBody) };
    inline DeleteAppInstancesResponseBody body() { DARABONBA_PTR_GET(body_, DeleteAppInstancesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteAppInstancesResponseBody> body_ = nullptr;
  };
