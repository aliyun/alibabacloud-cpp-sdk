...
namespace Models
{
  ...
  public:
    ...
    inline const RestartWuyingServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RestartWuyingServerResponseBody) };
    inline RestartWuyingServerResponseBody getBody() { DARABONBA_PTR_GET(body_, RestartWuyingServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RestartWuyingServerResponseBody> body_ {};
  };
