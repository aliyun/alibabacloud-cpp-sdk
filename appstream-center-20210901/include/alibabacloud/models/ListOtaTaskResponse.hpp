...
namespace Models
{
  ...
  public:
    ...
    inline const ListOtaTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOtaTaskResponseBody) };
    inline ListOtaTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOtaTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOtaTaskResponseBody> body_ {};
  };
