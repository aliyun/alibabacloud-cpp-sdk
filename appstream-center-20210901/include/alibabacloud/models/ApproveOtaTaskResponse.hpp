...
namespace Models
{
  ...
  public:
    ...
    inline const ApproveOtaTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApproveOtaTaskResponseBody) };
    inline ApproveOtaTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ApproveOtaTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApproveOtaTaskResponseBody> body_ {};
  };
