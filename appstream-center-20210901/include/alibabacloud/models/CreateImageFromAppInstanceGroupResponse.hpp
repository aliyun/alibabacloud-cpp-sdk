...
namespace Models
{
  ...
  public:
    ...
    inline const CreateImageFromAppInstanceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateImageFromAppInstanceGroupResponseBody) };
    inline CreateImageFromAppInstanceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateImageFromAppInstanceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateImageFromAppInstanceGroupResponseBody> body_ {};
  };
