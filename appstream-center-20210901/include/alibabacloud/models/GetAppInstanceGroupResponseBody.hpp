...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->accessType_ == nullptr
        ...
        && this->sessionType_ == nullptr && this->skipUserAuthCheck_ == nullptr && this->specId_ == nullptr && this->status_ == nullptr && this->supportUserGroupMixedAuth_ == nullptr
      ...
      inline AppInstanceGroupModels& setAppCenterImageName(string appCenterImageName) { DARABONBA_PTR_SET_VALUE(appCenterImageName_, appCenterImageName) };
      ...
      inline string getAppInstanceTypeName() const { DARABONBA_PTR_GET_DEFAULT(appInstanceTypeName_, "") };
      inline AppInstanceGroupModels& setAppInstanceTypeName(string appInstanceTypeName) { DARABONBA_PTR_SET_VALUE(appInstanceTypeName_, appInstanceTypeName) };
      ...
      inline AppInstanceGroupModels& setSessionType(string sessionType) { DARABONBA_PTR_SET_VALUE(sessionType_, sessionType) };
    ...
    inline const GetAppInstanceGroupResponseBody::AppInstanceGroupModels & getAppInstanceGroupModels() const { DARABONBA_PTR_GET_CONST(appInstanceGroupModels_, GetAppInstanceGroupResponseBody::AppInstanceGroupModels) };
    inline GetAppInstanceGroupResponseBody::AppInstanceGroupModels getAppInstanceGroupModels() { DARABONBA_PTR_GET(appInstanceGroupModels_, GetAppInstanceGroupResponseBody::AppInstanceGroupModels) };
    inline GetAppInstanceGroupResponseBody& setAppInstanceGroupModels(const GetAppInstanceGroupResponseBody::AppInstanceGroupModels & appInstanceGroupModels) { DARABONBA_PTR_SET_VALUE(appInstanceGroupModels_, appInstanceGroupModels) };
    inline GetAppInstanceGroupResponseBody& setAppInstanceGroupModels(GetAppInstanceGroupResponseBody::AppInstanceGroupModels && appInstanceGroupModels) { DARABONBA_PTR_SET_RVALUE(appInstanceGroupModels_, appInstanceGroupModels) };
  ...
  protected:
    ...
    shared_ptr<GetAppInstanceGroupResponseBody::AppInstanceGroupModels> appInstanceGroupModels_ {};
    // The request ID.
