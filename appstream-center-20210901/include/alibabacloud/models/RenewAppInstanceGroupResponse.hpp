...
namespace Models
{
  ...
  public:
    ...
    inline const RenewAppInstanceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RenewAppInstanceGroupResponseBody) };
    inline RenewAppInstanceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, RenewAppInstanceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RenewAppInstanceGroupResponseBody> body_ {};
  };
