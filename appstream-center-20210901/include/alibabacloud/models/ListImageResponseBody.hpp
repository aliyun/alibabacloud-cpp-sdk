...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListImageResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListImageResponseBodyData>) };
    inline vector<ListImageResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListImageResponseBodyData>) };
    inline ListImageResponseBody& setData(const vector<ListImageResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListImageResponseBody& setData(vector<ListImageResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
