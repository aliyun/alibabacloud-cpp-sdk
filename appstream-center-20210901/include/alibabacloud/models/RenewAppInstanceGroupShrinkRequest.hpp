...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appInstanceGroupId_ == nullptr
        ...
        && return this->renewAmount_ == nullptr && return this->renewMode_ == nullptr && return this->renewNodesShrink_ == nullptr; };
    ...
    inline string renewNodesShrink() const { DARABONBA_PTR_GET_DEFAULT(renewNodesShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> renewNodesShrink_ = nullptr;
  };
