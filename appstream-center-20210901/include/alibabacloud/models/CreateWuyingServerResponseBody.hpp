...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWuyingServerResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateWuyingServerResponseBodyData) };
    inline CreateWuyingServerResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateWuyingServerResponseBodyData) };
    inline CreateWuyingServerResponseBody& setData(const CreateWuyingServerResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateWuyingServerResponseBody& setData(CreateWuyingServerResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
