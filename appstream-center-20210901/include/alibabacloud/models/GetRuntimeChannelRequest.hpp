...
#ifndef ALIBABACLOUD_MODELS_GETRUNTIMECHANNELREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETRUNTIMECHANNELREQUEST_HPP_
...
namespace Models
{
  class GetRuntimeChannelRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetRuntimeChannelRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetRuntimeChannelRequest& obj) { 
    ...
    GetRuntimeChannelRequest() = default ;
    GetRuntimeChannelRequest(const GetRuntimeChannelRequest &) = default ;
    GetRuntimeChannelRequest(GetRuntimeChannelRequest &&) = default ;
    GetRuntimeChannelRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetRuntimeChannelRequest() = default ;
    GetRuntimeChannelRequest& operator=(const GetRuntimeChannelRequest &) = default ;
    GetRuntimeChannelRequest& operator=(GetRuntimeChannelRequest &&) = default ;
    ...
    inline GetRuntimeChannelRequest& setAgentPlatform(string agentPlatform) { DARABONBA_PTR_SET_VALUE(agentPlatform_, agentPlatform) };
    ...
    inline GetRuntimeChannelRequest& setAgentProvider(string agentProvider) { DARABONBA_PTR_SET_VALUE(agentProvider_, agentProvider) };
    ...
    inline GetRuntimeChannelRequest& setIncludeRiskInfo(bool includeRiskInfo) { DARABONBA_PTR_SET_VALUE(includeRiskInfo_, includeRiskInfo) };
    ...
    inline GetRuntimeChannelRequest& setRuntimeId(string runtimeId) { DARABONBA_PTR_SET_VALUE(runtimeId_, runtimeId) };
    ...
    inline GetRuntimeChannelRequest& setRuntimeType(string runtimeType) { DARABONBA_PTR_SET_VALUE(runtimeType_, runtimeType) };
