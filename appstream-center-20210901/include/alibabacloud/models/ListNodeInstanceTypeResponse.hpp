...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodeInstanceTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNodeInstanceTypeResponseBody) };
    inline ListNodeInstanceTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNodeInstanceTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNodeInstanceTypeResponseBody> body_ {};
  };
