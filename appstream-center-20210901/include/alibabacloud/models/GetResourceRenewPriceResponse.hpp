...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceRenewPriceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResourceRenewPriceResponseBody) };
    inline GetResourceRenewPriceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResourceRenewPriceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResourceRenewPriceResponseBody> body_ {};
  };
