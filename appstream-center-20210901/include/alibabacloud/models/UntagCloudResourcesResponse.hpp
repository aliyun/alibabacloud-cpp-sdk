...
namespace Models
{
  ...
  public:
    ...
    inline const UntagCloudResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UntagCloudResourcesResponseBody) };
    inline UntagCloudResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, UntagCloudResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UntagCloudResourcesResponseBody> body_ {};
  };
