...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyNodePoolAmountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyNodePoolAmountResponseBody) };
    inline ModifyNodePoolAmountResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyNodePoolAmountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyNodePoolAmountResponseBody> body_ {};
  };
