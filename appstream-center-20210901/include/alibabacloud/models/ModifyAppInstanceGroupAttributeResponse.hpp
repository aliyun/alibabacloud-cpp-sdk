...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAppInstanceGroupAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAppInstanceGroupAttributeResponseBody) };
    inline ModifyAppInstanceGroupAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAppInstanceGroupAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAppInstanceGroupAttributeResponseBody> body_ {};
  };
