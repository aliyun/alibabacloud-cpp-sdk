...
namespace Models
{
  ...
  public:
    ...
    inline const GetAppInstanceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAppInstanceGroupResponseBody) };
    inline GetAppInstanceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAppInstanceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAppInstanceGroupResponseBody> body_ {};
  };
