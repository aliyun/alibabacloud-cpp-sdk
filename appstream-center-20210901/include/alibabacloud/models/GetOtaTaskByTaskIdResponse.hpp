...
namespace Models
{
  ...
  public:
    ...
    inline const GetOtaTaskByTaskIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOtaTaskByTaskIdResponseBody) };
    inline GetOtaTaskByTaskIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOtaTaskByTaskIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOtaTaskByTaskIdResponseBody> body_ {};
  };
