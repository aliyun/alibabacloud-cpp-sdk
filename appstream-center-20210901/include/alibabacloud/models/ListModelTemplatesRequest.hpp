...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentPlatform_ == nullptr
        ...
        && this->modelTemplateIdList_ == nullptr && this->name_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->refScope_ == nullptr
    ...
    inline ListModelTemplatesRequest& setAgentPlatformList(const vector<string> & agentPlatformList) { DARABONBA_PTR_SET_VALUE(agentPlatformList_, agentPlatformList) };
    inline ListModelTemplatesRequest& setAgentPlatformList(vector<string> && agentPlatformList) { DARABONBA_PTR_SET_RVALUE(agentPlatformList_, agentPlatformList) };
    ...
    inline ListModelTemplatesRequest& setAgentProviderList(const vector<string> & agentProviderList) { DARABONBA_PTR_SET_VALUE(agentProviderList_, agentProviderList) };
    inline ListModelTemplatesRequest& setAgentProviderList(vector<string> && agentProviderList) { DARABONBA_PTR_SET_RVALUE(agentProviderList_, agentProviderList) };
    ...
    inline ListModelTemplatesRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListModelTemplatesRequest& setRefScope(string refScope) { DARABONBA_PTR_SET_VALUE(refScope_, refScope) };
    ...
    inline ListModelTemplatesRequest& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
