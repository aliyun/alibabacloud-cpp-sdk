...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appInstanceGroupId_ == nullptr
        && return this->appInstanceId_ == nullptr && return this->appInstancePersistentId_ == nullptr && return this->avatarId_ == nullptr && return this->bizRegionId_ == nullptr && return this->osType_ == nullptr
        && return this->requestId_ == nullptr && return this->taskId_ == nullptr && return this->taskStatus_ == nullptr && return this->tenantId_ == nullptr && return this->ticket_ == nullptr; };
