...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAppInstanceGroupImageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAppInstanceGroupImageResponseBody) };
    inline UpdateAppInstanceGroupImageResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAppInstanceGroupImageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAppInstanceGroupImageResponseBody> body_ {};
  };
