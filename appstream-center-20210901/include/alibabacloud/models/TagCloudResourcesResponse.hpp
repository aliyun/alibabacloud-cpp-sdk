...
namespace Models
{
  ...
  public:
    ...
    inline const TagCloudResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TagCloudResourcesResponseBody) };
    inline TagCloudResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, TagCloudResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TagCloudResourcesResponseBody> body_ {};
  };
