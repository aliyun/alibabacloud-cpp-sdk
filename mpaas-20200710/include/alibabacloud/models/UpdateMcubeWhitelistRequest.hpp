...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->id_ == nullptr && this->keyIds_ == nullptr && this->onexFlag_ == nullptr && this->ossUrl_ == nullptr && this->tenantId_ == nullptr
    ...
    inline string getKeyIds() const { DARABONBA_PTR_GET_DEFAULT(keyIds_, "") };
