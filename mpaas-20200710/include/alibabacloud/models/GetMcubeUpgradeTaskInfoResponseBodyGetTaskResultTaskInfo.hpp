...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->appCode_ != nullptr
        && this->appId_ != nullptr && this->appstoreUrl_ != nullptr && this->creator_ != nullptr && this->downloadUrl_ != nullptr && this->greyConfigInfo_ != nullptr
        && this->greyEndtimeData_ != nullptr && this->greyNum_ != nullptr && this->historyForce_ != nullptr && this->id_ != nullptr && this->isEnterprise_ != nullptr
        && this->memo_ != nullptr && this->modifier_ != nullptr && this->packageInfoId_ != nullptr && this->packageType_ != nullptr && this->platform_ != nullptr
        && this->productId_ != nullptr && this->publishMode_ != nullptr && this->publishType_ != nullptr && this->ruleJsonList_ != nullptr && this->silentType_ != nullptr
