...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeMcubeNebulaTaskStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChangeMcubeNebulaTaskStatusResponseBody) };
    inline ChangeMcubeNebulaTaskStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, ChangeMcubeNebulaTaskStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ChangeMcubeNebulaTaskStatusResponseBody> body_ {};
  };
