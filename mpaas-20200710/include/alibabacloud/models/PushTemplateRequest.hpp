...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activityContentState_ == nullptr
        ...
        && this->thirdChannelCategory_ == nullptr && this->transparentMessagePayload_ == nullptr && this->transparentMessageUrgency_ == nullptr && this->vendorTemplate_ == nullptr && this->workspaceId_ == nullptr; };
