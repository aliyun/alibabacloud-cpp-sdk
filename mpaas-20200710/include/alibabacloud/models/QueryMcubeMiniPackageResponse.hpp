...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMcubeMiniPackageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryMcubeMiniPackageResponseBody) };
    inline QueryMcubeMiniPackageResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryMcubeMiniPackageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryMcubeMiniPackageResponseBody> body_ {};
  };
