...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->resultCode_ == nullptr && return this->resultMessage_ == nullptr && return this->uploadRsaResult_ == nullptr; };
    ...
    inline const UploadMcubeRsaKeyResponseBodyUploadRsaResult & uploadRsaResult() const { DARABONBA_PTR_GET_CONST(uploadRsaResult_, UploadMcubeRsaKeyResponseBodyUploadRsaResult) };
    inline UploadMcubeRsaKeyResponseBodyUploadRsaResult uploadRsaResult() { DARABONBA_PTR_GET(uploadRsaResult_, UploadMcubeRsaKeyResponseBodyUploadRsaResult) };
    inline UploadMcubeRsaKeyResponseBody& setUploadRsaResult(const UploadMcubeRsaKeyResponseBodyUploadRsaResult & uploadRsaResult) { DARABONBA_PTR_SET_VALUE(uploadRsaResult_, uploadRsaResult) };
    inline UploadMcubeRsaKeyResponseBody& setUploadRsaResult(UploadMcubeRsaKeyResponseBodyUploadRsaResult && uploadRsaResult) { DARABONBA_PTR_SET_RVALUE(uploadRsaResult_, uploadRsaResult) };
  ...
  protected:
    ...
    std::shared_ptr<UploadMcubeRsaKeyResponseBodyUploadRsaResult> uploadRsaResult_ = nullptr;
  };
