...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowCreateTask_ == nullptr
        ...
        && return this->gmtCreate_ == nullptr && return this->gmtModified_ == nullptr && return this->id_ == nullptr && return this->isEnterprise_ == nullptr && return this->md5_ == nullptr
        && return this->modifier_ == nullptr && return this->needCheck_ == nullptr && return this->packageType_ == nullptr && return this->platform_ == nullptr && return this->productId_ == nullptr
