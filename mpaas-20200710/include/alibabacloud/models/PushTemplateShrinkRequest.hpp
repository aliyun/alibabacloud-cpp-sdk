...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activityContentState_ == nullptr
        ...
        && return this->thirdChannelCategoryShrink_ == nullptr && return this->transparentMessagePayload_ == nullptr && return this->transparentMessageUrgency_ == nullptr && return this->workspaceId_ == nullptr; };
