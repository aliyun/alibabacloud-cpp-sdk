...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPushAnalysisTaskDetailResponseBodyResultContent & resultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, QueryPushAnalysisTaskDetailResponseBodyResultContent) };
    inline QueryPushAnalysisTaskDetailResponseBodyResultContent resultContent() { DARABONBA_PTR_GET(resultContent_, QueryPushAnalysisTaskDetailResponseBodyResultContent) };
    inline QueryPushAnalysisTaskDetailResponseBody& setResultContent(const QueryPushAnalysisTaskDetailResponseBodyResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline QueryPushAnalysisTaskDetailResponseBody& setResultContent(QueryPushAnalysisTaskDetailResponseBodyResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    std::shared_ptr<QueryPushAnalysisTaskDetailResponseBodyResultContent> resultContent_ = nullptr;
