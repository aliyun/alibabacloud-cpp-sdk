...
namespace Models
{
  ...
  public:
    ...
    inline const ListMcubeUpgradePackagesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMcubeUpgradePackagesResponseBody) };
    inline ListMcubeUpgradePackagesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMcubeUpgradePackagesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMcubeUpgradePackagesResponseBody> body_ {};
  };
