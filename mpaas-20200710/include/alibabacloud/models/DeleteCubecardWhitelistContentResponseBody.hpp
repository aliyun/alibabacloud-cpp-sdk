...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCubecardWhitelistContentResponseBody::ResultContent & getResultContent() const { DARABONBA_PTR_GET_CONST(resultContent_, DeleteCubecardWhitelistContentResponseBody::ResultContent) };
    inline DeleteCubecardWhitelistContentResponseBody::ResultContent getResultContent() { DARABONBA_PTR_GET(resultContent_, DeleteCubecardWhitelistContentResponseBody::ResultContent) };
    inline DeleteCubecardWhitelistContentResponseBody& setResultContent(const DeleteCubecardWhitelistContentResponseBody::ResultContent & resultContent) { DARABONBA_PTR_SET_VALUE(resultContent_, resultContent) };
    inline DeleteCubecardWhitelistContentResponseBody& setResultContent(DeleteCubecardWhitelistContentResponseBody::ResultContent && resultContent) { DARABONBA_PTR_SET_RVALUE(resultContent_, resultContent) };
  ...
  protected:
    ...
    shared_ptr<DeleteCubecardWhitelistContentResponseBody::ResultContent> resultContent_ {};
