...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->androidChannel_ == nullptr
        ...
        && this->unBindEndTime_ == nullptr && this->unBindPeriod_ == nullptr && this->unBindStartTime_ == nullptr && this->vendorTemplate_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline int64_t getAndroidChannel() const { DARABONBA_PTR_GET_DEFAULT(androidChannel_, 0L) };
    inline PushBroadcastShrinkRequest& setAndroidChannel(int64_t androidChannel) { DARABONBA_PTR_SET_VALUE(androidChannel_, androidChannel) };
    ...
    inline PushBroadcastShrinkRequest& setVendorTemplate(string vendorTemplate) { DARABONBA_PTR_SET_VALUE(vendorTemplate_, vendorTemplate) };
  ...
  protected:
    shared_ptr<int64_t> androidChannel_ {};
