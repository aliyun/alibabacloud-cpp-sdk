...
namespace Models
{
  ...
  public:
    ...
    class ChangeResult : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const ChangeResult& obj) { 
        DARABONBA_PTR_TO_JSON(ErrorCode, errorCode_);
        DARABONBA_PTR_TO_JSON(RequestId, requestId_);
        DARABONBA_PTR_TO_JSON(ResultMsg, resultMsg_);
        DARABONBA_PTR_TO_JSON(Success, success_);
      };
      friend void from_json(const Darabonba::Json& j, ChangeResult& obj) { 
        DARABONBA_PTR_FROM_JSON(ErrorCode, errorCode_);
        DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
        DARABONBA_PTR_FROM_JSON(ResultMsg, resultMsg_);
        DARABONBA_PTR_FROM_JSON(Success, success_);
      };
      ChangeResult() = default ;
      ChangeResult(const ChangeResult &) = default ;
      ChangeResult(ChangeResult &&) = default ;
      ChangeResult(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~ChangeResult() = default ;
      ChangeResult& operator=(const ChangeResult &) = default ;
      ChangeResult& operator=(ChangeResult &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline ChangeResult& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
      ...
      inline ChangeResult& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
      ...
      inline ChangeResult& setResultMsg(string resultMsg) { DARABONBA_PTR_SET_VALUE(resultMsg_, resultMsg) };
      ...
      inline ChangeResult& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline const ChangeMcubePublicTaskStatusResponseBody::ChangeResult & getChangeResult() const { DARABONBA_PTR_GET_CONST(changeResult_, ChangeMcubePublicTaskStatusResponseBody::ChangeResult) };
    inline ChangeMcubePublicTaskStatusResponseBody::ChangeResult getChangeResult() { DARABONBA_PTR_GET(changeResult_, ChangeMcubePublicTaskStatusResponseBody::ChangeResult) };
    inline ChangeMcubePublicTaskStatusResponseBody& setChangeResult(const ChangeMcubePublicTaskStatusResponseBody::ChangeResult & changeResult) { DARABONBA_PTR_SET_VALUE(changeResult_, changeResult) };
    inline ChangeMcubePublicTaskStatusResponseBody& setChangeResult(ChangeMcubePublicTaskStatusResponseBody::ChangeResult && changeResult) { DARABONBA_PTR_SET_RVALUE(changeResult_, changeResult) };
  ...
  protected:
    shared_ptr<ChangeMcubePublicTaskStatusResponseBody::ChangeResult> changeResult_ {};
    shared_ptr<string> requestId_ {};
