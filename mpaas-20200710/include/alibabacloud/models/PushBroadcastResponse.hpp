...
namespace Models
{
  ...
  public:
    ...
    inline const PushBroadcastResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PushBroadcastResponseBody) };
    inline PushBroadcastResponseBody getBody() { DARABONBA_PTR_GET(body_, PushBroadcastResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PushBroadcastResponseBody> body_ {};
  };
