...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPushSchedulerListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryPushSchedulerListResponseBody) };
    inline QueryPushSchedulerListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryPushSchedulerListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryPushSchedulerListResponseBody> body_ {};
  };
