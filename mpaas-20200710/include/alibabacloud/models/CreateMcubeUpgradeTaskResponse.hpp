...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMcubeUpgradeTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMcubeUpgradeTaskResponseBody) };
    inline CreateMcubeUpgradeTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMcubeUpgradeTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMcubeUpgradeTaskResponseBody> body_ {};
  };
