...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->androidChannel_ == nullptr
        ...
        && return this->notifyLevel_ == nullptr && return this->notifyType_ == nullptr && return this->pushAction_ == nullptr && return this->pushStatus_ == nullptr && return this->silent_ == nullptr
        ...
        && return this->tenantId_ == nullptr && return this->thirdChannelCategory_ == nullptr && return this->timeMode_ == nullptr && return this->transparentMessagePayload_ == nullptr && return this->transparentMessageUrgency_ == nullptr
    ...
    inline PushBroadcastRequest& setAndroidChannel(int64_t androidChannel) { DARABONBA_PTR_SET_VALUE(androidChannel_, androidChannel) };
