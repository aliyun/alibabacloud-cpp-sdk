...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->androidChannel_ != nullptr
        ...
        && this->notifyLevel_ != nullptr && this->notifyType_ != nullptr && this->pushAction_ != nullptr && this->pushStatus_ != nullptr && this->silent_ != nullptr
        ...
        && this->tenantId_ != nullptr && this->thirdChannelCategory_ != nullptr && this->timeMode_ != nullptr && this->transparentMessagePayload_ != nullptr && this->transparentMessageUrgency_ != nullptr
