...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPushAnalysisCoreIndexResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryPushAnalysisCoreIndexResponseBody) };
    inline QueryPushAnalysisCoreIndexResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryPushAnalysisCoreIndexResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryPushAnalysisCoreIndexResponseBody> body_ {};
  };
