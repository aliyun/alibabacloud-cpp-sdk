...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activityContentState_ == nullptr
        ...
        && return this->taskName_ == nullptr && return this->tenantId_ == nullptr && return this->thirdChannelCategory_ == nullptr && return this->title_ == nullptr && return this->transparentMessagePayload_ == nullptr
