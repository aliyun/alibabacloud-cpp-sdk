...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->activityContentState_ != nullptr
        ...
        && this->imageUrls_ != nullptr && this->miChannelId_ != nullptr && this->notifyLevel_ != nullptr && this->notifyType_ != nullptr && this->pushAction_ != nullptr
        ...
        && this->taskName_ != nullptr && this->tenantId_ != nullptr && this->thirdChannelCategory_ != nullptr && this->title_ != nullptr && this->transparentMessagePayload_ != nullptr
