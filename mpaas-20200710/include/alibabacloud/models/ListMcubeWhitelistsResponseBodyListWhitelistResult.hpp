...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && return this->hasMore_ == nullptr && return this->pageSize_ == nullptr && return this->resultMsg_ == nullptr && return this->success_ == nullptr && return this->totalCount_ == nullptr
        && return this->whitelists_ == nullptr; };
