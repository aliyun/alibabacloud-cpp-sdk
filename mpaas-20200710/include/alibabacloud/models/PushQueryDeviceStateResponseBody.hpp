...
namespace Models
{
  ...
  public:
    ...
    inline const PushQueryDeviceStateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, PushQueryDeviceStateResponseBodyData) };
    inline PushQueryDeviceStateResponseBodyData data() { DARABONBA_PTR_GET(data_, PushQueryDeviceStateResponseBodyData) };
    inline PushQueryDeviceStateResponseBody& setData(const PushQueryDeviceStateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PushQueryDeviceStateResponseBody& setData(PushQueryDeviceStateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<PushQueryDeviceStateResponseBodyData> data_ = nullptr;
