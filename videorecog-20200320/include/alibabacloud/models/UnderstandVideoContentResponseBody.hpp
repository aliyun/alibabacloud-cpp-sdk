...
namespace Models
{
  ...
  public:
    ...
    inline const UnderstandVideoContentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UnderstandVideoContentResponseBodyData) };
    inline UnderstandVideoContentResponseBodyData data() { DARABONBA_PTR_GET(data_, UnderstandVideoContentResponseBodyData) };
    inline UnderstandVideoContentResponseBody& setData(const UnderstandVideoContentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UnderstandVideoContentResponseBody& setData(UnderstandVideoContentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<UnderstandVideoContentResponseBodyData> data_ = nullptr;
