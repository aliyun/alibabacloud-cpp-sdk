...
namespace Models
{
  ...
  public:
    ...
    inline const GetAsyncJobResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAsyncJobResultResponseBody) };
    inline GetAsyncJobResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAsyncJobResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAsyncJobResultResponseBody> body_ {};
  };
