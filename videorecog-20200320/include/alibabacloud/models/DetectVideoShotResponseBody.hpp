...
namespace Models
{
  ...
  public:
    ...
    inline const DetectVideoShotResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DetectVideoShotResponseBodyData) };
    inline DetectVideoShotResponseBodyData data() { DARABONBA_PTR_GET(data_, DetectVideoShotResponseBodyData) };
    inline DetectVideoShotResponseBody& setData(const DetectVideoShotResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DetectVideoShotResponseBody& setData(DetectVideoShotResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DetectVideoShotResponseBodyData> data_ = nullptr;
