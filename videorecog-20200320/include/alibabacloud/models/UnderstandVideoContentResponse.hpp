...
namespace Models
{
  ...
  public:
    ...
    inline const UnderstandVideoContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnderstandVideoContentResponseBody) };
    inline UnderstandVideoContentResponseBody getBody() { DARABONBA_PTR_GET(body_, UnderstandVideoContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnderstandVideoContentResponseBody> body_ {};
  };
