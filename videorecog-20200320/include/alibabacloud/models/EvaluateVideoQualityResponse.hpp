...
namespace Models
{
  ...
  public:
    ...
    inline const EvaluateVideoQualityResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, EvaluateVideoQualityResponseBody) };
    inline EvaluateVideoQualityResponseBody body() { DARABONBA_PTR_GET(body_, EvaluateVideoQualityResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<EvaluateVideoQualityResponseBody> body_ = nullptr;
  };
