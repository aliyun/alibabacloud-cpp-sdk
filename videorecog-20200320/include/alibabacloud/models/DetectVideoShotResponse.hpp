...
namespace Models
{
  ...
  public:
    ...
    inline const DetectVideoShotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetectVideoShotResponseBody) };
    inline DetectVideoShotResponseBody getBody() { DARABONBA_PTR_GET(body_, DetectVideoShotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetectVideoShotResponseBody> body_ {};
  };
