...
namespace Models
{
  ...
  public:
    ...
    inline const SplitVideoPartsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SplitVideoPartsResponseBody) };
    inline SplitVideoPartsResponseBody body() { DARABONBA_PTR_GET(body_, SplitVideoPartsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SplitVideoPartsResponseBody> body_ = nullptr;
  };
