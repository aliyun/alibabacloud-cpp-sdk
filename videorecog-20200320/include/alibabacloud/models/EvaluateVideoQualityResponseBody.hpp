...
namespace Models
{
  ...
  public:
    ...
    inline const EvaluateVideoQualityResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, EvaluateVideoQualityResponseBodyData) };
    inline EvaluateVideoQualityResponseBodyData data() { DARABONBA_PTR_GET(data_, EvaluateVideoQualityResponseBodyData) };
    inline EvaluateVideoQualityResponseBody& setData(const EvaluateVideoQualityResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline EvaluateVideoQualityResponseBody& setData(EvaluateVideoQualityResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<EvaluateVideoQualityResponseBodyData> data_ = nullptr;
