...
namespace Models
{
  ...
  public:
    ...
    inline const GetOriginClientCertificateResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetOriginClientCertificateResponseBody) };
    inline GetOriginClientCertificateResponseBody body() { DARABONBA_PTR_GET(body_, GetOriginClientCertificateResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetOriginClientCertificateResponseBody> body_ = nullptr;
  };
