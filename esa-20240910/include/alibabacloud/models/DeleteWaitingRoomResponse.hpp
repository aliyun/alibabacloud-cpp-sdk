...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWaitingRoomResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWaitingRoomResponseBody) };
    inline DeleteWaitingRoomResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWaitingRoomResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWaitingRoomResponseBody> body_ {};
  };
