...
namespace Models
{
  ...
  public:
    ...
    inline const CommitRoutineStagingCodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CommitRoutineStagingCodeResponseBody) };
    inline CommitRoutineStagingCodeResponseBody getBody() { DARABONBA_PTR_GET(body_, CommitRoutineStagingCodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CommitRoutineStagingCodeResponseBody> body_ {};
  };
