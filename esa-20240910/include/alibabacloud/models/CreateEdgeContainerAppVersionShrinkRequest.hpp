...
#ifndef ALIBABACLOUD_MODELS_CREATEEDGECONTAINERAPPVERSIONSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEEDGECONTAINERAPPVERSIONSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateEdgeContainerAppVersionShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AppId, appId_);
      DARABONBA_PTR_TO_JSON(Containers, containersShrink_);
      DARABONBA_PTR_TO_JSON(Name, name_);
      DARABONBA_PTR_TO_JSON(Remarks, remarks_);
    };
    friend void from_json(const Darabonba::Json& j, CreateEdgeContainerAppVersionShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AppId, appId_);
      DARABONBA_PTR_FROM_JSON(Containers, containersShrink_);
      DARABONBA_PTR_FROM_JSON(Name, name_);
      DARABONBA_PTR_FROM_JSON(Remarks, remarks_);
    };
    CreateEdgeContainerAppVersionShrinkRequest() = default ;
    CreateEdgeContainerAppVersionShrinkRequest(const CreateEdgeContainerAppVersionShrinkRequest &) = default ;
    CreateEdgeContainerAppVersionShrinkRequest(CreateEdgeContainerAppVersionShrinkRequest &&) = default ;
    CreateEdgeContainerAppVersionShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateEdgeContainerAppVersionShrinkRequest() = default ;
    CreateEdgeContainerAppVersionShrinkRequest& operator=(const CreateEdgeContainerAppVersionShrinkRequest &) = default ;
    CreateEdgeContainerAppVersionShrinkRequest& operator=(CreateEdgeContainerAppVersionShrinkRequest &&) = default ;
