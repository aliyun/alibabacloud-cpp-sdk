...
namespace Models
{
  ...
  public:
    ...
    inline const GetMainDomainNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMainDomainNameResponseBody) };
    inline GetMainDomainNameResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMainDomainNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMainDomainNameResponseBody> body_ {};
  };
