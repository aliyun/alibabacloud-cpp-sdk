...
namespace Models
{
  ...
  public:
    ...
    inline const BatchPutKvWithHighCapacityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchPutKvWithHighCapacityResponseBody) };
    inline BatchPutKvWithHighCapacityResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchPutKvWithHighCapacityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchPutKvWithHighCapacityResponseBody> body_ {};
  };
