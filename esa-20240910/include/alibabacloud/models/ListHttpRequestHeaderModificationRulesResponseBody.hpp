...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHttpRequestHeaderModificationRulesResponseBody::Configs> & getConfigs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListHttpRequestHeaderModificationRulesResponseBody::Configs>) };
    inline vector<ListHttpRequestHeaderModificationRulesResponseBody::Configs> getConfigs() { DARABONBA_PTR_GET(configs_, vector<ListHttpRequestHeaderModificationRulesResponseBody::Configs>) };
    inline ListHttpRequestHeaderModificationRulesResponseBody& setConfigs(const vector<ListHttpRequestHeaderModificationRulesResponseBody::Configs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListHttpRequestHeaderModificationRulesResponseBody& setConfigs(vector<ListHttpRequestHeaderModificationRulesResponseBody::Configs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
