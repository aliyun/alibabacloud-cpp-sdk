...
namespace Models
{
  ...
  public:
    ...
    inline const GetHttpsBasicConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHttpsBasicConfigurationResponseBody) };
    inline GetHttpsBasicConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHttpsBasicConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHttpsBasicConfigurationResponseBody> body_ {};
  };
