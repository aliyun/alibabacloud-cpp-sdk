...
namespace Models
{
  ...
  public:
    ...
    inline const GetClientCertificateResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, GetClientCertificateResponseBody::Result) };
    inline GetClientCertificateResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, GetClientCertificateResponseBody::Result) };
    inline GetClientCertificateResponseBody& setResult(const GetClientCertificateResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetClientCertificateResponseBody& setResult(GetClientCertificateResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
