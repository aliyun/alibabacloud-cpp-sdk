...
namespace Models
{
  ...
  public:
    ...
    inline const BatchDeleteKvWithHighCapacityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchDeleteKvWithHighCapacityResponseBody) };
    inline BatchDeleteKvWithHighCapacityResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchDeleteKvWithHighCapacityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchDeleteKvWithHighCapacityResponseBody> body_ {};
  };
