...
namespace Models
{
  ...
  public:
    ...
    inline const GetPurgeQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPurgeQuotaResponseBody) };
    inline GetPurgeQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPurgeQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPurgeQuotaResponseBody> body_ {};
  };
