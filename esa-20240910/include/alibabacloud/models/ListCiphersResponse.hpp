...
namespace Models
{
  ...
  public:
    ...
    inline const ListCiphersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCiphersResponseBody) };
    inline ListCiphersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCiphersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCiphersResponseBody> body_ {};
  };
