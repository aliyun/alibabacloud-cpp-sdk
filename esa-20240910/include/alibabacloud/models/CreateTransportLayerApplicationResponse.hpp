...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTransportLayerApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTransportLayerApplicationResponseBody) };
    inline CreateTransportLayerApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTransportLayerApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTransportLayerApplicationResponseBody> body_ {};
  };
