...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->cacheArchitectureMode_ != nullptr
    ...
    inline string cacheArchitectureMode() const { DARABONBA_PTR_GET_DEFAULT(cacheArchitectureMode_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> cacheArchitectureMode_ = nullptr;
    // Request ID.
