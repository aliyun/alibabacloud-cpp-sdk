...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateHttpIncomingRequestHeaderModificationRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateHttpIncomingRequestHeaderModificationRuleResponseBody) };
    inline UpdateHttpIncomingRequestHeaderModificationRuleResponseBody body() { DARABONBA_PTR_GET(body_, UpdateHttpIncomingRequestHeaderModificationRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateHttpIncomingRequestHeaderModificationRuleResponseBody> body_ = nullptr;
  };
