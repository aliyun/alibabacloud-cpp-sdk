...
namespace Models
{
  ...
  public:
    ...
    inline const GetImageTransformResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetImageTransformResponseBody) };
    inline GetImageTransformResponseBody getBody() { DARABONBA_PTR_GET(body_, GetImageTransformResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetImageTransformResponseBody> body_ {};
  };
