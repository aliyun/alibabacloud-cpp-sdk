...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessType_ == nullptr
        ...
        && this->httpDelivery_ == nullptr && this->kafkaDelivery_ == nullptr && this->ossDelivery_ == nullptr && this->s3Delivery_ == nullptr && this->siteId_ == nullptr
    ...
    inline const CreateSiteDeliveryTaskRequest::HttpDelivery & getHttpDelivery() const { DARABONBA_PTR_GET_CONST(httpDelivery_, CreateSiteDeliveryTaskRequest::HttpDelivery) };
    inline CreateSiteDeliveryTaskRequest::HttpDelivery getHttpDelivery() { DARABONBA_PTR_GET(httpDelivery_, CreateSiteDeliveryTaskRequest::HttpDelivery) };
    inline CreateSiteDeliveryTaskRequest& setHttpDelivery(const CreateSiteDeliveryTaskRequest::HttpDelivery & httpDelivery) { DARABONBA_PTR_SET_VALUE(httpDelivery_, httpDelivery) };
    inline CreateSiteDeliveryTaskRequest& setHttpDelivery(CreateSiteDeliveryTaskRequest::HttpDelivery && httpDelivery) { DARABONBA_PTR_SET_RVALUE(httpDelivery_, httpDelivery) };
    ...
    inline const CreateSiteDeliveryTaskRequest::KafkaDelivery & getKafkaDelivery() const { DARABONBA_PTR_GET_CONST(kafkaDelivery_, CreateSiteDeliveryTaskRequest::KafkaDelivery) };
    inline CreateSiteDeliveryTaskRequest::KafkaDelivery getKafkaDelivery() { DARABONBA_PTR_GET(kafkaDelivery_, CreateSiteDeliveryTaskRequest::KafkaDelivery) };
    inline CreateSiteDeliveryTaskRequest& setKafkaDelivery(const CreateSiteDeliveryTaskRequest::KafkaDelivery & kafkaDelivery) { DARABONBA_PTR_SET_VALUE(kafkaDelivery_, kafkaDelivery) };
    inline CreateSiteDeliveryTaskRequest& setKafkaDelivery(CreateSiteDeliveryTaskRequest::KafkaDelivery && kafkaDelivery) { DARABONBA_PTR_SET_RVALUE(kafkaDelivery_, kafkaDelivery) };
    ...
    inline const CreateSiteDeliveryTaskRequest::OssDelivery & getOssDelivery() const { DARABONBA_PTR_GET_CONST(ossDelivery_, CreateSiteDeliveryTaskRequest::OssDelivery) };
    inline CreateSiteDeliveryTaskRequest::OssDelivery getOssDelivery() { DARABONBA_PTR_GET(ossDelivery_, CreateSiteDeliveryTaskRequest::OssDelivery) };
    inline CreateSiteDeliveryTaskRequest& setOssDelivery(const CreateSiteDeliveryTaskRequest::OssDelivery & ossDelivery) { DARABONBA_PTR_SET_VALUE(ossDelivery_, ossDelivery) };
    inline CreateSiteDeliveryTaskRequest& setOssDelivery(CreateSiteDeliveryTaskRequest::OssDelivery && ossDelivery) { DARABONBA_PTR_SET_RVALUE(ossDelivery_, ossDelivery) };
    ...
    inline const CreateSiteDeliveryTaskRequest::S3Delivery & getS3Delivery() const { DARABONBA_PTR_GET_CONST(s3Delivery_, CreateSiteDeliveryTaskRequest::S3Delivery) };
    inline CreateSiteDeliveryTaskRequest::S3Delivery getS3Delivery() { DARABONBA_PTR_GET(s3Delivery_, CreateSiteDeliveryTaskRequest::S3Delivery) };
    inline CreateSiteDeliveryTaskRequest& setS3Delivery(const CreateSiteDeliveryTaskRequest::S3Delivery & s3Delivery) { DARABONBA_PTR_SET_VALUE(s3Delivery_, s3Delivery) };
    inline CreateSiteDeliveryTaskRequest& setS3Delivery(CreateSiteDeliveryTaskRequest::S3Delivery && s3Delivery) { DARABONBA_PTR_SET_RVALUE(s3Delivery_, s3Delivery) };
    ...
    inline const CreateSiteDeliveryTaskRequest::SlsDelivery & getSlsDelivery() const { DARABONBA_PTR_GET_CONST(slsDelivery_, CreateSiteDeliveryTaskRequest::SlsDelivery) };
    inline CreateSiteDeliveryTaskRequest::SlsDelivery getSlsDelivery() { DARABONBA_PTR_GET(slsDelivery_, CreateSiteDeliveryTaskRequest::SlsDelivery) };
    inline CreateSiteDeliveryTaskRequest& setSlsDelivery(const CreateSiteDeliveryTaskRequest::SlsDelivery & slsDelivery) { DARABONBA_PTR_SET_VALUE(slsDelivery_, slsDelivery) };
    inline CreateSiteDeliveryTaskRequest& setSlsDelivery(CreateSiteDeliveryTaskRequest::SlsDelivery && slsDelivery) { DARABONBA_PTR_SET_RVALUE(slsDelivery_, slsDelivery) };
