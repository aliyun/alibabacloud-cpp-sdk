...
#include <vector>
#include <alibabacloud/models/ListHttpsApplicationConfigurationsResponseBodyConfigs.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHttpsApplicationConfigurationsResponseBodyConfigs> & configs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListHttpsApplicationConfigurationsResponseBodyConfigs>) };
    inline vector<ListHttpsApplicationConfigurationsResponseBodyConfigs> configs() { DARABONBA_PTR_GET(configs_, vector<ListHttpsApplicationConfigurationsResponseBodyConfigs>) };
    inline ListHttpsApplicationConfigurationsResponseBody& setConfigs(const vector<ListHttpsApplicationConfigurationsResponseBodyConfigs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListHttpsApplicationConfigurationsResponseBody& setConfigs(vector<ListHttpsApplicationConfigurationsResponseBodyConfigs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHttpsApplicationConfigurationsResponseBodyConfigs>> configs_ = nullptr;
    // Current page number.
