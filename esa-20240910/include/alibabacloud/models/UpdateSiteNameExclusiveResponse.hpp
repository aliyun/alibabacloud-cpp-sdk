...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSiteNameExclusiveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSiteNameExclusiveResponseBody) };
    inline UpdateSiteNameExclusiveResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateSiteNameExclusiveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateSiteNameExclusiveResponseBody> body_ {};
  };
