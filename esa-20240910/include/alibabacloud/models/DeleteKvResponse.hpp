...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteKvResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteKvResponseBody) };
    inline DeleteKvResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteKvResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteKvResponseBody> body_ {};
  };
