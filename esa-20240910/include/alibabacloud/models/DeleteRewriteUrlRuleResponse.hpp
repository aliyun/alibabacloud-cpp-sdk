...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRewriteUrlRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRewriteUrlRuleResponseBody) };
    inline DeleteRewriteUrlRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRewriteUrlRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRewriteUrlRuleResponseBody> body_ {};
  };
