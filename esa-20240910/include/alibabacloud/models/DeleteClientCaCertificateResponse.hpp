...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteClientCaCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteClientCaCertificateResponseBody) };
    inline DeleteClientCaCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteClientCaCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteClientCaCertificateResponseBody> body_ {};
  };
