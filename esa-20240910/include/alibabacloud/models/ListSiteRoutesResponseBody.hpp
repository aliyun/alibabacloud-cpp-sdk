...
#include <vector>
#include <alibabacloud/models/ListSiteRoutesResponseBodyConfigs.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSiteRoutesResponseBodyConfigs> & configs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListSiteRoutesResponseBodyConfigs>) };
    inline vector<ListSiteRoutesResponseBodyConfigs> configs() { DARABONBA_PTR_GET(configs_, vector<ListSiteRoutesResponseBodyConfigs>) };
    inline ListSiteRoutesResponseBody& setConfigs(const vector<ListSiteRoutesResponseBodyConfigs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListSiteRoutesResponseBody& setConfigs(vector<ListSiteRoutesResponseBodyConfigs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListSiteRoutesResponseBodyConfigs>> configs_ = nullptr;
