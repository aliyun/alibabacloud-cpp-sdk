...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEdgeContainerAppLogRiverResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEdgeContainerAppLogRiverResponseBody) };
    inline UpdateEdgeContainerAppLogRiverResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEdgeContainerAppLogRiverResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEdgeContainerAppLogRiverResponseBody> body_ {};
  };
