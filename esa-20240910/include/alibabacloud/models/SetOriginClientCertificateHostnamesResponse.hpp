...
namespace Models
{
  ...
  public:
    ...
    inline const SetOriginClientCertificateHostnamesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetOriginClientCertificateHostnamesResponseBody) };
    inline SetOriginClientCertificateHostnamesResponseBody getBody() { DARABONBA_PTR_GET(body_, SetOriginClientCertificateHostnamesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetOriginClientCertificateHostnamesResponseBody> body_ {};
  };
