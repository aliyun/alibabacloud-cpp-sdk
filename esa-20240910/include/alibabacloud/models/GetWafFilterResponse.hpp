...
namespace Models
{
  ...
  public:
    ...
    inline const GetWafFilterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetWafFilterResponseBody) };
    inline GetWafFilterResponseBody getBody() { DARABONBA_PTR_GET(body_, GetWafFilterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetWafFilterResponseBody> body_ {};
  };
