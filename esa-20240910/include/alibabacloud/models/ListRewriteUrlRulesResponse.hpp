...
namespace Models
{
  ...
  public:
    ...
    inline const ListRewriteUrlRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRewriteUrlRulesResponseBody) };
    inline ListRewriteUrlRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRewriteUrlRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRewriteUrlRulesResponseBody> body_ {};
  };
