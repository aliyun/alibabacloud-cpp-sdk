...
#ifndef ALIBABACLOUD_MODELS_LISTSITEORIGINCLIENTCERTIFICATESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTSITEORIGINCLIENTCERTIFICATESRESPONSEBODY_HPP_
...
namespace Models
{
  class ListSiteOriginClientCertificatesResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListSiteOriginClientCertificatesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListSiteOriginClientCertificatesResponseBody& obj) { 
    ...
    ListSiteOriginClientCertificatesResponseBody() = default ;
    ListSiteOriginClientCertificatesResponseBody(const ListSiteOriginClientCertificatesResponseBody &) = default ;
    ListSiteOriginClientCertificatesResponseBody(ListSiteOriginClientCertificatesResponseBody &&) = default ;
    ListSiteOriginClientCertificatesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListSiteOriginClientCertificatesResponseBody() = default ;
    ListSiteOriginClientCertificatesResponseBody& operator=(const ListSiteOriginClientCertificatesResponseBody &) = default ;
    ListSiteOriginClientCertificatesResponseBody& operator=(ListSiteOriginClientCertificatesResponseBody &&) = default ;
    ...
    inline ListSiteOriginClientCertificatesResponseBody& setPageNumber(int64_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListSiteOriginClientCertificatesResponseBody& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListSiteOriginClientCertificatesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const vector<ListSiteOriginClientCertificatesResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListSiteOriginClientCertificatesResponseBody::Result>) };
    inline vector<ListSiteOriginClientCertificatesResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListSiteOriginClientCertificatesResponseBody::Result>) };
    inline ListSiteOriginClientCertificatesResponseBody& setResult(const vector<ListSiteOriginClientCertificatesResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListSiteOriginClientCertificatesResponseBody& setResult(vector<ListSiteOriginClientCertificatesResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline ListSiteOriginClientCertificatesResponseBody& setSiteId(int64_t siteId) { DARABONBA_PTR_SET_VALUE(siteId_, siteId) };
    ...
    inline ListSiteOriginClientCertificatesResponseBody& setSiteName(string siteName) { DARABONBA_PTR_SET_VALUE(siteName_, siteName) };
    ...
    inline ListSiteOriginClientCertificatesResponseBody& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
  ...
  protected:
    ...
    shared_ptr<vector<ListSiteOriginClientCertificatesResponseBody::Result>> result_ {};
