...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessType_ == nullptr
        ...
        && return this->httpDeliveryShrink_ == nullptr && return this->kafkaDeliveryShrink_ == nullptr && return this->ossDeliveryShrink_ == nullptr && return this->s3DeliveryShrink_ == nullptr && return this->siteId_ == nullptr
