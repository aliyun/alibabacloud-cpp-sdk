...
namespace Models
{
  ...
  public:
    ...
    inline const ListOriginCaCertificatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOriginCaCertificatesResponseBody) };
    inline ListOriginCaCertificatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOriginCaCertificatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOriginCaCertificatesResponseBody> body_ {};
  };
