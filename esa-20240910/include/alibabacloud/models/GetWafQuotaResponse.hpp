...
namespace Models
{
  ...
  public:
    ...
    inline const GetWafQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetWafQuotaResponseBody) };
    inline GetWafQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetWafQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetWafQuotaResponseBody> body_ {};
  };
