...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCacheRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateCacheRuleResponseBody) };
    inline CreateCacheRuleResponseBody body() { DARABONBA_PTR_GET(body_, CreateCacheRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateCacheRuleResponseBody> body_ = nullptr;
  };
