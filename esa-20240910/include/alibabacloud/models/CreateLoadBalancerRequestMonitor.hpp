...
#ifndef ALIBABACLOUD_MODELS_CREATELOADBALANCERREQUESTMONITOR_HPP_
#define ALIBABACLOUD_MODELS_CREATELOADBALANCERREQUESTMONITOR_HPP_
...
namespace Models
{
  class CreateLoadBalancerRequestMonitor : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateLoadBalancerRequestMonitor& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLoadBalancerRequestMonitor& obj) { 
    ...
    CreateLoadBalancerRequestMonitor() = default ;
    CreateLoadBalancerRequestMonitor(const CreateLoadBalancerRequestMonitor &) = default ;
    CreateLoadBalancerRequestMonitor(CreateLoadBalancerRequestMonitor &&) = default ;
    CreateLoadBalancerRequestMonitor(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLoadBalancerRequestMonitor() = default ;
    CreateLoadBalancerRequestMonitor& operator=(const CreateLoadBalancerRequestMonitor &) = default ;
    CreateLoadBalancerRequestMonitor& operator=(CreateLoadBalancerRequestMonitor &&) = default ;
    ...
    inline CreateLoadBalancerRequestMonitor& setConsecutiveDown(int32_t consecutiveDown) { DARABONBA_PTR_SET_VALUE(consecutiveDown_, consecutiveDown) };
    ...
    inline CreateLoadBalancerRequestMonitor& setConsecutiveUp(int32_t consecutiveUp) { DARABONBA_PTR_SET_VALUE(consecutiveUp_, consecutiveUp) };
    ...
    inline CreateLoadBalancerRequestMonitor& setExpectedCodes(string expectedCodes) { DARABONBA_PTR_SET_VALUE(expectedCodes_, expectedCodes) };
    ...
    inline CreateLoadBalancerRequestMonitor& setFollowRedirects(bool followRedirects) { DARABONBA_PTR_SET_VALUE(followRedirects_, followRedirects) };
    ...
    inline CreateLoadBalancerRequestMonitor& setHeader(const Darabonba::Json & header) { DARABONBA_SET_VALUE(header_, header) };
    inline CreateLoadBalancerRequestMonitor& setHeader(Darabonba::Json & header) { DARABONBA_SET_RVALUE(header_, header) };
    ...
    inline CreateLoadBalancerRequestMonitor& setInterval(int32_t interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline CreateLoadBalancerRequestMonitor& setMethod(string method) { DARABONBA_PTR_SET_VALUE(method_, method) };
    ...
    inline CreateLoadBalancerRequestMonitor& setMonitoringRegion(string monitoringRegion) { DARABONBA_PTR_SET_VALUE(monitoringRegion_, monitoringRegion) };
    ...
    inline CreateLoadBalancerRequestMonitor& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline CreateLoadBalancerRequestMonitor& setPort(int32_t port) { DARABONBA_PTR_SET_VALUE(port_, port) };
    ...
    inline CreateLoadBalancerRequestMonitor& setTimeout(int32_t timeout) { DARABONBA_PTR_SET_VALUE(timeout_, timeout) };
    ...
    inline CreateLoadBalancerRequestMonitor& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
