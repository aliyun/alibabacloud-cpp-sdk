...
#include <vector>
#include <alibabacloud/models/ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigs.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigs> & configs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigs>) };
    inline vector<ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigs> configs() { DARABONBA_PTR_GET(configs_, vector<ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigs>) };
    inline ListHttpIncomingResponseHeaderModificationRulesResponseBody& setConfigs(const vector<ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListHttpIncomingResponseHeaderModificationRulesResponseBody& setConfigs(vector<ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
  ...
  protected:
    std::shared_ptr<vector<ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigs>> configs_ = nullptr;
