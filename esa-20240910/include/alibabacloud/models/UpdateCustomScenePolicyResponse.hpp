...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCustomScenePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateCustomScenePolicyResponseBody) };
    inline UpdateCustomScenePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateCustomScenePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateCustomScenePolicyResponseBody> body_ {};
  };
