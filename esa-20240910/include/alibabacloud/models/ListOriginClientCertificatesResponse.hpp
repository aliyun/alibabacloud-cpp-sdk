...
namespace Models
{
  ...
  public:
    ...
    inline const ListOriginClientCertificatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOriginClientCertificatesResponseBody) };
    inline ListOriginClientCertificatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOriginClientCertificatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOriginClientCertificatesResponseBody> body_ {};
  };
