...
namespace Models
{
  ...
  public:
    ...
    inline const PublishEdgeContainerAppVersionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, PublishEdgeContainerAppVersionResponseBody) };
    inline PublishEdgeContainerAppVersionResponseBody body() { DARABONBA_PTR_GET(body_, PublishEdgeContainerAppVersionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<PublishEdgeContainerAppVersionResponseBody> body_ = nullptr;
  };
