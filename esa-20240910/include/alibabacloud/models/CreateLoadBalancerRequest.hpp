...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adaptiveRouting_ == nullptr
        && return this->defaultPools_ == nullptr && return this->description_ == nullptr && return this->enabled_ == nullptr && return this->fallbackPool_ == nullptr && return this->monitor_ == nullptr
        && return this->name_ == nullptr && return this->randomSteering_ == nullptr && return this->regionPools_ == nullptr && return this->rules_ == nullptr && return this->sessionAffinity_ == nullptr
