...
#ifndef ALIBABACLOUD_MODELS_CREATETRANSPORTLAYERAPPLICATIONREQUESTRULES_HPP_
#define ALIBABACLOUD_MODELS_CREATETRANSPORTLAYERAPPLICATIONREQUESTRULES_HPP_
...
namespace Models
{
  class CreateTransportLayerApplicationRequestRules : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateTransportLayerApplicationRequestRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTransportLayerApplicationRequestRules& obj) { 
    ...
    CreateTransportLayerApplicationRequestRules() = default ;
    CreateTransportLayerApplicationRequestRules(const CreateTransportLayerApplicationRequestRules &) = default ;
    CreateTransportLayerApplicationRequestRules(CreateTransportLayerApplicationRequestRules &&) = default ;
    CreateTransportLayerApplicationRequestRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTransportLayerApplicationRequestRules() = default ;
    CreateTransportLayerApplicationRequestRules& operator=(const CreateTransportLayerApplicationRequestRules &) = default ;
    CreateTransportLayerApplicationRequestRules& operator=(CreateTransportLayerApplicationRequestRules &&) = default ;
    ...
    inline CreateTransportLayerApplicationRequestRules& setClientIPPassThroughMode(string clientIPPassThroughMode) { DARABONBA_PTR_SET_VALUE(clientIPPassThroughMode_, clientIPPassThroughMode) };
    ...
    inline CreateTransportLayerApplicationRequestRules& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline CreateTransportLayerApplicationRequestRules& setEdgePort(string edgePort) { DARABONBA_PTR_SET_VALUE(edgePort_, edgePort) };
    ...
    inline CreateTransportLayerApplicationRequestRules& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline CreateTransportLayerApplicationRequestRules& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline CreateTransportLayerApplicationRequestRules& setSourcePort(string sourcePort) { DARABONBA_PTR_SET_VALUE(sourcePort_, sourcePort) };
    ...
    inline CreateTransportLayerApplicationRequestRules& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
