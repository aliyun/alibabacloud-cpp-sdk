...
namespace Models
{
  ...
  public:
    ...
    inline const GetOriginProtectionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetOriginProtectionResponseBody) };
    inline GetOriginProtectionResponseBody body() { DARABONBA_PTR_GET(body_, GetOriginProtectionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetOriginProtectionResponseBody> body_ = nullptr;
  };
