...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessType_ == nullptr
        && return this->discardRate_ == nullptr && return this->fieldName_ == nullptr && return this->filterVer_ == nullptr && return this->siteId_ == nullptr && return this->taskName_ == nullptr; };
