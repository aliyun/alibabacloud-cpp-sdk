...
namespace Models
{
  ...
  public:
    ...
    inline const ListHttpRequestHeaderModificationRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHttpRequestHeaderModificationRulesResponseBody) };
    inline ListHttpRequestHeaderModificationRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHttpRequestHeaderModificationRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHttpRequestHeaderModificationRulesResponseBody> body_ {};
  };
