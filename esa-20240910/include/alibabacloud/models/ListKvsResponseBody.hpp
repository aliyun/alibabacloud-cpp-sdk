...
#include <vector>
#include <alibabacloud/models/ListKvsResponseBodyKeys.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListKvsResponseBodyKeys> & keys() const { DARABONBA_PTR_GET_CONST(keys_, vector<ListKvsResponseBodyKeys>) };
    inline vector<ListKvsResponseBodyKeys> keys() { DARABONBA_PTR_GET(keys_, vector<ListKvsResponseBodyKeys>) };
    inline ListKvsResponseBody& setKeys(const vector<ListKvsResponseBodyKeys> & keys) { DARABONBA_PTR_SET_VALUE(keys_, keys) };
    inline ListKvsResponseBody& setKeys(vector<ListKvsResponseBodyKeys> && keys) { DARABONBA_PTR_SET_RVALUE(keys_, keys) };
  ...
  protected:
    // The key-value pairs.
    std::shared_ptr<vector<ListKvsResponseBodyKeys>> keys_ = nullptr;
