...
namespace Models
{
  ...
  public:
    ...
    inline const UploadFileResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UploadFileResponseBody) };
    inline UploadFileResponseBody body() { DARABONBA_PTR_GET(body_, UploadFileResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UploadFileResponseBody> body_ = nullptr;
  };
