...
namespace Models
{
  ...
  public:
    ...
    inline const GetKvAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetKvAccountResponseBody) };
    inline GetKvAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, GetKvAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetKvAccountResponseBody> body_ {};
  };
