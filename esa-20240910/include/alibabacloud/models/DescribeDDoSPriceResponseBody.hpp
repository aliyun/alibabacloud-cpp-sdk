...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDDOSPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDDOSPRICERESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeDDoSPriceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDDoSPriceResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(PriceModel, priceModel_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeDDoSPriceResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(PriceModel, priceModel_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeDDoSPriceResponseBody() = default ;
    DescribeDDoSPriceResponseBody(const DescribeDDoSPriceResponseBody &) = default ;
    DescribeDDoSPriceResponseBody(DescribeDDoSPriceResponseBody &&) = default ;
    DescribeDDoSPriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDDoSPriceResponseBody() = default ;
    DescribeDDoSPriceResponseBody& operator=(const DescribeDDoSPriceResponseBody &) = default ;
    DescribeDDoSPriceResponseBody& operator=(DescribeDDoSPriceResponseBody &&) = default ;
    ...
    inline const DescribeDDoSPriceResponseBody::PriceModel & getPriceModel() const { DARABONBA_PTR_GET_CONST(priceModel_, DescribeDDoSPriceResponseBody::PriceModel) };
    inline DescribeDDoSPriceResponseBody::PriceModel getPriceModel() { DARABONBA_PTR_GET(priceModel_, DescribeDDoSPriceResponseBody::PriceModel) };
    inline DescribeDDoSPriceResponseBody& setPriceModel(const DescribeDDoSPriceResponseBody::PriceModel & priceModel) { DARABONBA_PTR_SET_VALUE(priceModel_, priceModel) };
    inline DescribeDDoSPriceResponseBody& setPriceModel(DescribeDDoSPriceResponseBody::PriceModel && priceModel) { DARABONBA_PTR_SET_RVALUE(priceModel_, priceModel) };
    ...
    inline DescribeDDoSPriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The price information.
    shared_ptr<DescribeDDoSPriceResponseBody::PriceModel> priceModel_ {};
    // The request ID.
