...
namespace Models
{
  ...
  public:
    ...
    inline const ListCacheRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCacheRulesResponseBody) };
    inline ListCacheRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCacheRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCacheRulesResponseBody> body_ {};
  };
