...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVideoProcessingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteVideoProcessingResponseBody) };
    inline DeleteVideoProcessingResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteVideoProcessingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteVideoProcessingResponseBody> body_ {};
  };
