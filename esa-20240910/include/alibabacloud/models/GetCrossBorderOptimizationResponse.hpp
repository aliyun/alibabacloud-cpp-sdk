...
namespace Models
{
  ...
  public:
    ...
    inline const GetCrossBorderOptimizationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCrossBorderOptimizationResponseBody) };
    inline GetCrossBorderOptimizationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCrossBorderOptimizationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCrossBorderOptimizationResponseBody> body_ {};
  };
