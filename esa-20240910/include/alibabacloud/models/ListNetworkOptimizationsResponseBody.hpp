...
#include <vector>
#include <alibabacloud/models/ListNetworkOptimizationsResponseBodyConfigs.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListNetworkOptimizationsResponseBodyConfigs> & configs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListNetworkOptimizationsResponseBodyConfigs>) };
    inline vector<ListNetworkOptimizationsResponseBodyConfigs> configs() { DARABONBA_PTR_GET(configs_, vector<ListNetworkOptimizationsResponseBodyConfigs>) };
    inline ListNetworkOptimizationsResponseBody& setConfigs(const vector<ListNetworkOptimizationsResponseBodyConfigs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListNetworkOptimizationsResponseBody& setConfigs(vector<ListNetworkOptimizationsResponseBodyConfigs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListNetworkOptimizationsResponseBodyConfigs>> configs_ = nullptr;
