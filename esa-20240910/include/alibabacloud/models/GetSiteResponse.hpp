...
namespace Models
{
  ...
  public:
    ...
    inline const GetSiteResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetSiteResponseBody) };
    inline GetSiteResponseBody body() { DARABONBA_PTR_GET(body_, GetSiteResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetSiteResponseBody> body_ = nullptr;
  };
