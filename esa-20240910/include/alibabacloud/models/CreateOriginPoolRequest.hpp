...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->enabled_ == nullptr
        && this->name_ == nullptr && this->origins_ == nullptr && this->siteId_ == nullptr; };
    // enabled Field Functions 
    bool hasEnabled() const { return this->enabled_ != nullptr;};
    void deleteEnabled() { this->enabled_ = nullptr;};
    inline bool getEnabled() const { DARABONBA_PTR_GET_DEFAULT(enabled_, false) };
    ...
    inline const vector<CreateOriginPoolRequest::Origins> & getOrigins() const { DARABONBA_PTR_GET_CONST(origins_, vector<CreateOriginPoolRequest::Origins>) };
    inline vector<CreateOriginPoolRequest::Origins> getOrigins() { DARABONBA_PTR_GET(origins_, vector<CreateOriginPoolRequest::Origins>) };
    inline CreateOriginPoolRequest& setOrigins(const vector<CreateOriginPoolRequest::Origins> & origins) { DARABONBA_PTR_SET_VALUE(origins_, origins) };
    inline CreateOriginPoolRequest& setOrigins(vector<CreateOriginPoolRequest::Origins> && origins) { DARABONBA_PTR_SET_RVALUE(origins_, origins) };
