...
namespace Models
{
  ...
  public:
    ...
    inline const UploadClientCaCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadClientCaCertificateResponseBody) };
    inline UploadClientCaCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadClientCaCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadClientCaCertificateResponseBody> body_ {};
  };
