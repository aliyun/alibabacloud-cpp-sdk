...
namespace Models
{
  ...
  public:
    ...
    inline const ListEdgeRoutineRecordsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListEdgeRoutineRecordsResponseBody) };
    inline ListEdgeRoutineRecordsResponseBody body() { DARABONBA_PTR_GET(body_, ListEdgeRoutineRecordsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListEdgeRoutineRecordsResponseBody> body_ = nullptr;
  };
