...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSiteTopDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSiteTopDataResponseBody) };
    inline DescribeSiteTopDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSiteTopDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSiteTopDataResponseBody> body_ {};
  };
