...
namespace Models
{
  ...
  public:
    ...
    inline const ActivateClientCertificateResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ActivateClientCertificateResponseBody) };
    inline ActivateClientCertificateResponseBody body() { DARABONBA_PTR_GET(body_, ActivateClientCertificateResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ActivateClientCertificateResponseBody> body_ = nullptr;
  };
