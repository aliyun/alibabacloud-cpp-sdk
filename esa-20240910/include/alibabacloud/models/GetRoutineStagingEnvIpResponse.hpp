...
namespace Models
{
  ...
  public:
    ...
    inline const GetRoutineStagingEnvIpResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRoutineStagingEnvIpResponseBody) };
    inline GetRoutineStagingEnvIpResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRoutineStagingEnvIpResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRoutineStagingEnvIpResponseBody> body_ {};
  };
