...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateHttpIncomingRequestHeaderModificationRuleRequest::RequestHeaderModification> & getRequestHeaderModification() const { DARABONBA_PTR_GET_CONST(requestHeaderModification_, vector<UpdateHttpIncomingRequestHeaderModificationRuleRequest::RequestHeaderModification>) };
    inline vector<UpdateHttpIncomingRequestHeaderModificationRuleRequest::RequestHeaderModification> getRequestHeaderModification() { DARABONBA_PTR_GET(requestHeaderModification_, vector<UpdateHttpIncomingRequestHeaderModificationRuleRequest::RequestHeaderModification>) };
    inline UpdateHttpIncomingRequestHeaderModificationRuleRequest& setRequestHeaderModification(const vector<UpdateHttpIncomingRequestHeaderModificationRuleRequest::RequestHeaderModification> & requestHeaderModification) { DARABONBA_PTR_SET_VALUE(requestHeaderModification_, requestHeaderModification) };
    inline UpdateHttpIncomingRequestHeaderModificationRuleRequest& setRequestHeaderModification(vector<UpdateHttpIncomingRequestHeaderModificationRuleRequest::RequestHeaderModification> && requestHeaderModification) { DARABONBA_PTR_SET_RVALUE(requestHeaderModification_, requestHeaderModification) };
