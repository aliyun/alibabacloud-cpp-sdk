...
#include <vector>
#include <alibabacloud/models/ListRewriteUrlRulesResponseBodyConfigs.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListRewriteUrlRulesResponseBodyConfigs> & configs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListRewriteUrlRulesResponseBodyConfigs>) };
    inline vector<ListRewriteUrlRulesResponseBodyConfigs> configs() { DARABONBA_PTR_GET(configs_, vector<ListRewriteUrlRulesResponseBodyConfigs>) };
    inline ListRewriteUrlRulesResponseBody& setConfigs(const vector<ListRewriteUrlRulesResponseBodyConfigs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListRewriteUrlRulesResponseBody& setConfigs(vector<ListRewriteUrlRulesResponseBodyConfigs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListRewriteUrlRulesResponseBodyConfigs>> configs_ = nullptr;
