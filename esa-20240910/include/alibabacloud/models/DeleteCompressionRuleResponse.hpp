...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCompressionRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCompressionRuleResponseBody) };
    inline DeleteCompressionRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCompressionRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCompressionRuleResponseBody> body_ {};
  };
