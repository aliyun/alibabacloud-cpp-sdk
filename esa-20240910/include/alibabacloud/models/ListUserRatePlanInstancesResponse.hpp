...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserRatePlanInstancesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListUserRatePlanInstancesResponseBody) };
    inline ListUserRatePlanInstancesResponseBody body() { DARABONBA_PTR_GET(body_, ListUserRatePlanInstancesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListUserRatePlanInstancesResponseBody> body_ = nullptr;
  };
