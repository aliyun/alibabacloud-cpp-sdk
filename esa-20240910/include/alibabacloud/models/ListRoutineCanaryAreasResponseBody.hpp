...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getCanaryAreas() const { DARABONBA_PTR_GET_CONST(canaryAreas_, vector<string>) };
    inline vector<string> getCanaryAreas() { DARABONBA_PTR_GET(canaryAreas_, vector<string>) };
