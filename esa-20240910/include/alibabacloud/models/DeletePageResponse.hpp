...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePageResponseBody) };
    inline DeletePageResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePageResponseBody> body_ {};
  };
