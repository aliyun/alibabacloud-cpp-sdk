...
#include <alibabacloud/models/GetOriginClientCertificateResponseBodyResult.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetOriginClientCertificateResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetOriginClientCertificateResponseBodyResult) };
    inline GetOriginClientCertificateResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetOriginClientCertificateResponseBodyResult) };
    inline GetOriginClientCertificateResponseBody& setResult(const GetOriginClientCertificateResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetOriginClientCertificateResponseBody& setResult(GetOriginClientCertificateResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetOriginClientCertificateResponseBodyResult> result_ = nullptr;
    // The website ID.
