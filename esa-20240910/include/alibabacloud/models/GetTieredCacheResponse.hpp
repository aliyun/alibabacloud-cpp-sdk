...
namespace Models
{
  ...
  public:
    ...
    inline const GetTieredCacheResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTieredCacheResponseBody) };
    inline GetTieredCacheResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTieredCacheResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTieredCacheResponseBody> body_ {};
  };
