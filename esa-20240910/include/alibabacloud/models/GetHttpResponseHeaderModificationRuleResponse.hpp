...
namespace Models
{
  ...
  public:
    ...
    inline const GetHttpResponseHeaderModificationRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHttpResponseHeaderModificationRuleResponseBody) };
    inline GetHttpResponseHeaderModificationRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHttpResponseHeaderModificationRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHttpResponseHeaderModificationRuleResponseBody> body_ {};
  };
