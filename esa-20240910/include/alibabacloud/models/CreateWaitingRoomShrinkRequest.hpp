...
#ifndef ALIBABACLOUD_MODELS_CREATEWAITINGROOMSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEWAITINGROOMSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateWaitingRoomShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(HostNameAndPath, hostNameAndPathShrink_);
    ...
    friend void from_json(const Darabonba::Json& j, CreateWaitingRoomShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(HostNameAndPath, hostNameAndPathShrink_);
    ...
    CreateWaitingRoomShrinkRequest() = default ;
    CreateWaitingRoomShrinkRequest(const CreateWaitingRoomShrinkRequest &) = default ;
    CreateWaitingRoomShrinkRequest(CreateWaitingRoomShrinkRequest &&) = default ;
    CreateWaitingRoomShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateWaitingRoomShrinkRequest() = default ;
    CreateWaitingRoomShrinkRequest& operator=(const CreateWaitingRoomShrinkRequest &) = default ;
    CreateWaitingRoomShrinkRequest& operator=(CreateWaitingRoomShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->cookieName_ == nullptr
        && return this->customPageHtml_ == nullptr && return this->description_ == nullptr && return this->disableSessionRenewalEnable_ == nullptr && return this->enable_ == nullptr && return this->hostNameAndPathShrink_ == nullptr
    ...
    inline CreateWaitingRoomShrinkRequest& setCookieName(string cookieName) { DARABONBA_PTR_SET_VALUE(cookieName_, cookieName) };
    ...
    inline CreateWaitingRoomShrinkRequest& setCustomPageHtml(string customPageHtml) { DARABONBA_PTR_SET_VALUE(customPageHtml_, customPageHtml) };
    ...
    inline CreateWaitingRoomShrinkRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreateWaitingRoomShrinkRequest& setDisableSessionRenewalEnable(string disableSessionRenewalEnable) { DARABONBA_PTR_SET_VALUE(disableSessionRenewalEnable_, disableSessionRenewalEnable) };
    ...
    inline CreateWaitingRoomShrinkRequest& setEnable(string enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };


    // hostNameAndPathShrink Field Functions 
    bool hasHostNameAndPathShrink() const { return this->hostNameAndPathShrink_ != nullptr;};
    void deleteHostNameAndPathShrink() { this->hostNameAndPathShrink_ = nullptr;};
    inline string hostNameAndPathShrink() const { DARABONBA_PTR_GET_DEFAULT(hostNameAndPathShrink_, "") };
    inline CreateWaitingRoomShrinkRequest& setHostNameAndPathShrink(string hostNameAndPathShrink) { DARABONBA_PTR_SET_VALUE(hostNameAndPathShrink_, hostNameAndPathShrink) };
    ...
    inline CreateWaitingRoomShrinkRequest& setJsonResponseEnable(string jsonResponseEnable) { DARABONBA_PTR_SET_VALUE(jsonResponseEnable_, jsonResponseEnable) };
    ...
    inline CreateWaitingRoomShrinkRequest& setLanguage(string language) { DARABONBA_PTR_SET_VALUE(language_, language) };
    ...
    inline CreateWaitingRoomShrinkRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateWaitingRoomShrinkRequest& setNewUsersPerMinute(string newUsersPerMinute) { DARABONBA_PTR_SET_VALUE(newUsersPerMinute_, newUsersPerMinute) };
    ...
    inline CreateWaitingRoomShrinkRequest& setQueueAllEnable(string queueAllEnable) { DARABONBA_PTR_SET_VALUE(queueAllEnable_, queueAllEnable) };
    ...
    inline CreateWaitingRoomShrinkRequest& setQueuingMethod(string queuingMethod) { DARABONBA_PTR_SET_VALUE(queuingMethod_, queuingMethod) };
    ...
    inline CreateWaitingRoomShrinkRequest& setQueuingStatusCode(string queuingStatusCode) { DARABONBA_PTR_SET_VALUE(queuingStatusCode_, queuingStatusCode) };
    ...
    inline CreateWaitingRoomShrinkRequest& setSessionDuration(string sessionDuration) { DARABONBA_PTR_SET_VALUE(sessionDuration_, sessionDuration) };
    ...
    inline CreateWaitingRoomShrinkRequest& setSiteId(int64_t siteId) { DARABONBA_PTR_SET_VALUE(siteId_, siteId) };
    ...
    inline CreateWaitingRoomShrinkRequest& setTotalActiveUsers(string totalActiveUsers) { DARABONBA_PTR_SET_VALUE(totalActiveUsers_, totalActiveUsers) };
    ...
    inline CreateWaitingRoomShrinkRequest& setWaitingRoomType(string waitingRoomType) { DARABONBA_PTR_SET_VALUE(waitingRoomType_, waitingRoomType) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> hostNameAndPathShrink_ = nullptr;
