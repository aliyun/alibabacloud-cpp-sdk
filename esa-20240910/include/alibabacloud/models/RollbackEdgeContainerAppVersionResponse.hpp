...
namespace Models
{
  ...
  public:
    ...
    inline const RollbackEdgeContainerAppVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RollbackEdgeContainerAppVersionResponseBody) };
    inline RollbackEdgeContainerAppVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, RollbackEdgeContainerAppVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RollbackEdgeContainerAppVersionResponseBody> body_ {};
  };
