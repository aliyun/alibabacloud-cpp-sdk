...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHttpIncomingRequestHeaderModificationRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHttpIncomingRequestHeaderModificationRuleResponseBody) };
    inline CreateHttpIncomingRequestHeaderModificationRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHttpIncomingRequestHeaderModificationRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHttpIncomingRequestHeaderModificationRuleResponseBody> body_ {};
  };
