...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteOriginPoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteOriginPoolResponseBody) };
    inline DeleteOriginPoolResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteOriginPoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteOriginPoolResponseBody> body_ {};
  };
