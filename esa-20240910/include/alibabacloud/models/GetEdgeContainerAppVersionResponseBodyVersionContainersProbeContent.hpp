...
#ifndef ALIBABACLOUD_MODELS_GETEDGECONTAINERAPPVERSIONRESPONSEBODYVERSIONCONTAINERSPROBECONTENT_HPP_
#define ALIBABACLOUD_MODELS_GETEDGECONTAINERAPPVERSIONRESPONSEBODYVERSIONCONTAINERSPROBECONTENT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& obj) { 
    ...
    GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent() = default ;
    GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent(const GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent &) = default ;
    GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent(GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent &&) = default ;
    GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent() = default ;
    GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& operator=(const GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent &) = default ;
    GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& operator=(GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent &&) = default ;
    ...
    inline GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& setCommand(string command) { DARABONBA_PTR_SET_VALUE(command_, command) };
    ...
    inline GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& setFailureThreshold(int32_t failureThreshold) { DARABONBA_PTR_SET_VALUE(failureThreshold_, failureThreshold) };
    ...
    inline GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& setHost(string host) { DARABONBA_PTR_SET_VALUE(host_, host) };
    ...
    inline GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& setHttpHeaders(string httpHeaders) { DARABONBA_PTR_SET_VALUE(httpHeaders_, httpHeaders) };
    ...
    inline GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& setInitialDelaySeconds(int32_t initialDelaySeconds) { DARABONBA_PTR_SET_VALUE(initialDelaySeconds_, initialDelaySeconds) };
    ...
    inline GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& setPeriodSeconds(int32_t periodSeconds) { DARABONBA_PTR_SET_VALUE(periodSeconds_, periodSeconds) };
    ...
    inline GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& setPort(int32_t port) { DARABONBA_PTR_SET_VALUE(port_, port) };
    ...
    inline GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& setScheme(string scheme) { DARABONBA_PTR_SET_VALUE(scheme_, scheme) };
    ...
    inline GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& setSuccessThreshold(int32_t successThreshold) { DARABONBA_PTR_SET_VALUE(successThreshold_, successThreshold) };
    ...
    inline GetEdgeContainerAppVersionResponseBodyVersionContainersProbeContent& setTimeoutSeconds(int32_t timeoutSeconds) { DARABONBA_PTR_SET_VALUE(timeoutSeconds_, timeoutSeconds) };
