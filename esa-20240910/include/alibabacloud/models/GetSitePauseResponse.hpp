...
namespace Models
{
  ...
  public:
    ...
    inline const GetSitePauseResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetSitePauseResponseBody) };
    inline GetSitePauseResponseBody body() { DARABONBA_PTR_GET(body_, GetSitePauseResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetSitePauseResponseBody> body_ = nullptr;
  };
