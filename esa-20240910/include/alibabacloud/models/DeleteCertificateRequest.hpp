...
namespace Models
{
  ...
  public:
    ...
    inline DeleteCertificateRequest& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DeleteCertificateRequest& setSiteId(int64_t siteId) { DARABONBA_PTR_SET_VALUE(siteId_, siteId) };
