...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateVideoProcessingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateVideoProcessingResponseBody) };
    inline UpdateVideoProcessingResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateVideoProcessingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateVideoProcessingResponseBody> body_ {};
  };
