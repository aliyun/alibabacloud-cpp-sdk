...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateOriginProtectionIpWhiteListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateOriginProtectionIpWhiteListResponseBody) };
    inline UpdateOriginProtectionIpWhiteListResponseBody body() { DARABONBA_PTR_GET(body_, UpdateOriginProtectionIpWhiteListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateOriginProtectionIpWhiteListResponseBody> body_ = nullptr;
  };
