...
#ifndef ALIBABACLOUD_MODELS_CREATESITEDELIVERYTASKREQUESTS3DELIVERY_HPP_
#define ALIBABACLOUD_MODELS_CREATESITEDELIVERYTASKREQUESTS3DELIVERY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateSiteDeliveryTaskRequestS3Delivery& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateSiteDeliveryTaskRequestS3Delivery& obj) { 
    ...
    CreateSiteDeliveryTaskRequestS3Delivery() = default ;
    CreateSiteDeliveryTaskRequestS3Delivery(const CreateSiteDeliveryTaskRequestS3Delivery &) = default ;
    CreateSiteDeliveryTaskRequestS3Delivery(CreateSiteDeliveryTaskRequestS3Delivery &&) = default ;
    CreateSiteDeliveryTaskRequestS3Delivery(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateSiteDeliveryTaskRequestS3Delivery() = default ;
    CreateSiteDeliveryTaskRequestS3Delivery& operator=(const CreateSiteDeliveryTaskRequestS3Delivery &) = default ;
    CreateSiteDeliveryTaskRequestS3Delivery& operator=(CreateSiteDeliveryTaskRequestS3Delivery &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->accessKey_ == nullptr
        && return this->bucketPath_ == nullptr && return this->endpoint_ == nullptr && return this->prefixPath_ == nullptr && return this->region_ == nullptr && return this->s3Cmpt_ == nullptr
        && return this->secretKey_ == nullptr && return this->serverSideEncryption_ == nullptr && return this->vertifyType_ == nullptr; };
    // accessKey Field Functions 
    bool hasAccessKey() const { return this->accessKey_ != nullptr;};
    void deleteAccessKey() { this->accessKey_ = nullptr;};
    inline string accessKey() const { DARABONBA_PTR_GET_DEFAULT(accessKey_, "") };
    inline CreateSiteDeliveryTaskRequestS3Delivery& setAccessKey(string accessKey) { DARABONBA_PTR_SET_VALUE(accessKey_, accessKey) };
    ...
    inline CreateSiteDeliveryTaskRequestS3Delivery& setBucketPath(string bucketPath) { DARABONBA_PTR_SET_VALUE(bucketPath_, bucketPath) };
    ...
    inline CreateSiteDeliveryTaskRequestS3Delivery& setEndpoint(string endpoint) { DARABONBA_PTR_SET_VALUE(endpoint_, endpoint) };
    ...
    inline CreateSiteDeliveryTaskRequestS3Delivery& setPrefixPath(string prefixPath) { DARABONBA_PTR_SET_VALUE(prefixPath_, prefixPath) };
    ...
    inline CreateSiteDeliveryTaskRequestS3Delivery& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
    ...
    inline CreateSiteDeliveryTaskRequestS3Delivery& setS3Cmpt(bool s3Cmpt) { DARABONBA_PTR_SET_VALUE(s3Cmpt_, s3Cmpt) };
    ...
    inline CreateSiteDeliveryTaskRequestS3Delivery& setSecretKey(string secretKey) { DARABONBA_PTR_SET_VALUE(secretKey_, secretKey) };
    ...
    inline CreateSiteDeliveryTaskRequestS3Delivery& setServerSideEncryption(bool serverSideEncryption) { DARABONBA_PTR_SET_VALUE(serverSideEncryption_, serverSideEncryption) };
    ...
    inline CreateSiteDeliveryTaskRequestS3Delivery& setVertifyType(string vertifyType) { DARABONBA_PTR_SET_VALUE(vertifyType_, vertifyType) };
