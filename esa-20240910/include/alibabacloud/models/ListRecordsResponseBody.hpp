...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListRecordsResponseBodyRecords> & records() const { DARABONBA_PTR_GET_CONST(records_, vector<ListRecordsResponseBodyRecords>) };
    inline vector<ListRecordsResponseBodyRecords> records() { DARABONBA_PTR_GET(records_, vector<ListRecordsResponseBodyRecords>) };
    inline ListRecordsResponseBody& setRecords(const vector<ListRecordsResponseBodyRecords> & records) { DARABONBA_PTR_SET_VALUE(records_, records) };
    inline ListRecordsResponseBody& setRecords(vector<ListRecordsResponseBodyRecords> && records) { DARABONBA_PTR_SET_RVALUE(records_, records) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListRecordsResponseBodyRecords>> records_ = nullptr;
    // The request ID.
