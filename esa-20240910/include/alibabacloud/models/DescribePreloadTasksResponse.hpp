...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePreloadTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePreloadTasksResponseBody) };
    inline DescribePreloadTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePreloadTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePreloadTasksResponseBody> body_ {};
  };
