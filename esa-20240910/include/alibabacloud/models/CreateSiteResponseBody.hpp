...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->nameServerList_ == nullptr
        && return this->requestId_ == nullptr && return this->siteId_ == nullptr && return this->verifyCode_ == nullptr; };
