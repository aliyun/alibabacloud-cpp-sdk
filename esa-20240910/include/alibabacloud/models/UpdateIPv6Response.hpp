...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateIPv6ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateIPv6ResponseBody) };
    inline UpdateIPv6ResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateIPv6ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateIPv6ResponseBody> body_ {};
  };
