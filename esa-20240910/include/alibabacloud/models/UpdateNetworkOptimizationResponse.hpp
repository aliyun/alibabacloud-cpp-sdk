...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateNetworkOptimizationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateNetworkOptimizationResponseBody) };
    inline UpdateNetworkOptimizationResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateNetworkOptimizationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateNetworkOptimizationResponseBody> body_ {};
  };
