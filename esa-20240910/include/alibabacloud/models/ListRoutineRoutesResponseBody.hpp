...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Configs& setSiteId(int64_t siteId) { DARABONBA_PTR_SET_VALUE(siteId_, siteId) };
      ...
      inline Configs& setSiteName(string siteName) { DARABONBA_PTR_SET_VALUE(siteName_, siteName) };
    ...
    inline const vector<ListRoutineRoutesResponseBody::Configs> & getConfigs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListRoutineRoutesResponseBody::Configs>) };
    inline vector<ListRoutineRoutesResponseBody::Configs> getConfigs() { DARABONBA_PTR_GET(configs_, vector<ListRoutineRoutesResponseBody::Configs>) };
    inline ListRoutineRoutesResponseBody& setConfigs(const vector<ListRoutineRoutesResponseBody::Configs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListRoutineRoutesResponseBody& setConfigs(vector<ListRoutineRoutesResponseBody::Configs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
