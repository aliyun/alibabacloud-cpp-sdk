...
namespace Models
{
  ...
  public:
    ...
    inline const EnableCustomScenePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableCustomScenePolicyResponseBody) };
    inline EnableCustomScenePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableCustomScenePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableCustomScenePolicyResponseBody> body_ {};
  };
