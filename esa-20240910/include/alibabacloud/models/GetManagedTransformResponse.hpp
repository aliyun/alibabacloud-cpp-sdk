...
namespace Models
{
  ...
  public:
    ...
    inline const GetManagedTransformResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetManagedTransformResponseBody) };
    inline GetManagedTransformResponseBody body() { DARABONBA_PTR_GET(body_, GetManagedTransformResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetManagedTransformResponseBody> body_ = nullptr;
  };
