...
#ifndef ALIBABACLOUD_MODELS_LISTUSERROUTINESREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTUSERROUTINESREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListUserRoutinesRequest& obj) { 
      DARABONBA_PTR_TO_JSON(PageNumber, pageNumber_);
      DARABONBA_PTR_TO_JSON(PageSize, pageSize_);
      DARABONBA_PTR_TO_JSON(SearchKeyWord, searchKeyWord_);
    };
    friend void from_json(const Darabonba::Json& j, ListUserRoutinesRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(PageNumber, pageNumber_);
      DARABONBA_PTR_FROM_JSON(PageSize, pageSize_);
      DARABONBA_PTR_FROM_JSON(SearchKeyWord, searchKeyWord_);
    };
    ListUserRoutinesRequest() = default ;
    ListUserRoutinesRequest(const ListUserRoutinesRequest &) = default ;
    ListUserRoutinesRequest(ListUserRoutinesRequest &&) = default ;
    ListUserRoutinesRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListUserRoutinesRequest() = default ;
    ListUserRoutinesRequest& operator=(const ListUserRoutinesRequest &) = default ;
    ListUserRoutinesRequest& operator=(ListUserRoutinesRequest &&) = default ;
