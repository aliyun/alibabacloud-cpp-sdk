...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteOriginProtectionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteOriginProtectionResponseBody) };
    inline DeleteOriginProtectionResponseBody body() { DARABONBA_PTR_GET(body_, DeleteOriginProtectionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteOriginProtectionResponseBody> body_ = nullptr;
  };
