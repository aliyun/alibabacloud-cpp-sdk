...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->crossBorderOptimization_ == nullptr
        && this->ipAccessRule_ == nullptr && this->ipv6_ == nullptr && this->keepAliveProtection_ == nullptr && this->recordName_ == nullptr && this->rulesShrink_ == nullptr
    ...
    inline CreateTransportLayerApplicationShrinkRequest& setKeepAliveProtection(string keepAliveProtection) { DARABONBA_PTR_SET_VALUE(keepAliveProtection_, keepAliveProtection) };
