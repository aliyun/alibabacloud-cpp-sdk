...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authConf_ == nullptr
        && return this->bizName_ == nullptr && return this->data_ == nullptr && return this->proxied_ == nullptr && return this->recordName_ == nullptr && return this->sourceType_ == nullptr
        && return this->ttl_ == nullptr && return this->type_ == nullptr; };
