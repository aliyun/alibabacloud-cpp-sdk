...
#include <vector>
#include <alibabacloud/models/DescribePurgeTasksResponseBodyTasks.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribePurgeTasksResponseBodyTasks> & tasks() const { DARABONBA_PTR_GET_CONST(tasks_, vector<DescribePurgeTasksResponseBodyTasks>) };
    inline vector<DescribePurgeTasksResponseBodyTasks> tasks() { DARABONBA_PTR_GET(tasks_, vector<DescribePurgeTasksResponseBodyTasks>) };
    inline DescribePurgeTasksResponseBody& setTasks(const vector<DescribePurgeTasksResponseBodyTasks> & tasks) { DARABONBA_PTR_SET_VALUE(tasks_, tasks) };
    inline DescribePurgeTasksResponseBody& setTasks(vector<DescribePurgeTasksResponseBodyTasks> && tasks) { DARABONBA_PTR_SET_RVALUE(tasks_, tasks) };
  ...
  protected:
    ...
    // The tasks.
    std::shared_ptr<vector<DescribePurgeTasksResponseBodyTasks>> tasks_ = nullptr;
