...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteListResponseBody) };
    inline DeleteListResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteListResponseBody> body_ {};
  };
