...
namespace Models
{
  ...
  public:
    ...
    inline const vector<WafRuleMatch2Criteria> & criteria() const { DARABONBA_PTR_GET_CONST(criteria_, vector<WafRuleMatch2Criteria>) };
    inline vector<WafRuleMatch2Criteria> criteria() { DARABONBA_PTR_GET(criteria_, vector<WafRuleMatch2Criteria>) };
    inline WafRuleMatch2& setCriteria(const vector<WafRuleMatch2Criteria> & criteria) { DARABONBA_PTR_SET_VALUE(criteria_, criteria) };
    inline WafRuleMatch2& setCriteria(vector<WafRuleMatch2Criteria> && criteria) { DARABONBA_PTR_SET_RVALUE(criteria_, criteria) };
  ...
  protected:
    ...
    std::shared_ptr<vector<WafRuleMatch2Criteria>> criteria_ = nullptr;
