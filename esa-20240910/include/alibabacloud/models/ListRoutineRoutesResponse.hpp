...
namespace Models
{
  ...
  public:
    ...
    inline const ListRoutineRoutesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRoutineRoutesResponseBody) };
    inline ListRoutineRoutesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRoutineRoutesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRoutineRoutesResponseBody> body_ {};
  };
