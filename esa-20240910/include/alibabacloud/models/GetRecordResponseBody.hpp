...
#include <alibabacloud/models/GetRecordResponseBodyRecordModel.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->recordModel_ != nullptr
    ...
    inline const GetRecordResponseBodyRecordModel & recordModel() const { DARABONBA_PTR_GET_CONST(recordModel_, GetRecordResponseBodyRecordModel) };
    inline GetRecordResponseBodyRecordModel recordModel() { DARABONBA_PTR_GET(recordModel_, GetRecordResponseBodyRecordModel) };
    inline GetRecordResponseBody& setRecordModel(const GetRecordResponseBodyRecordModel & recordModel) { DARABONBA_PTR_SET_VALUE(recordModel_, recordModel) };
    inline GetRecordResponseBody& setRecordModel(GetRecordResponseBodyRecordModel && recordModel) { DARABONBA_PTR_SET_RVALUE(recordModel_, recordModel) };
  ...
  protected:
    ...
    std::shared_ptr<GetRecordResponseBodyRecordModel> recordModel_ = nullptr;
    // The request ID.
