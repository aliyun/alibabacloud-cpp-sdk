...
#ifndef ALIBABACLOUD_MODELS_UPDATESITECUSTOMLOGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATESITECUSTOMLOGREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateSiteCustomLogRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateSiteCustomLogRequest& obj) { 
    ...
    UpdateSiteCustomLogRequest() = default ;
    UpdateSiteCustomLogRequest(const UpdateSiteCustomLogRequest &) = default ;
    UpdateSiteCustomLogRequest(UpdateSiteCustomLogRequest &&) = default ;
    UpdateSiteCustomLogRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateSiteCustomLogRequest() = default ;
    UpdateSiteCustomLogRequest& operator=(const UpdateSiteCustomLogRequest &) = default ;
    UpdateSiteCustomLogRequest& operator=(UpdateSiteCustomLogRequest &&) = default ;
    ...
    inline UpdateSiteCustomLogRequest& setCookies(const vector<string> & cookies) { DARABONBA_PTR_SET_VALUE(cookies_, cookies) };
    inline UpdateSiteCustomLogRequest& setCookies(vector<string> && cookies) { DARABONBA_PTR_SET_RVALUE(cookies_, cookies) };
    ...
    inline UpdateSiteCustomLogRequest& setRequestHeaders(const vector<string> & requestHeaders) { DARABONBA_PTR_SET_VALUE(requestHeaders_, requestHeaders) };
    inline UpdateSiteCustomLogRequest& setRequestHeaders(vector<string> && requestHeaders) { DARABONBA_PTR_SET_RVALUE(requestHeaders_, requestHeaders) };
    ...
    inline UpdateSiteCustomLogRequest& setResponseHeaders(const vector<string> & responseHeaders) { DARABONBA_PTR_SET_VALUE(responseHeaders_, responseHeaders) };
    inline UpdateSiteCustomLogRequest& setResponseHeaders(vector<string> && responseHeaders) { DARABONBA_PTR_SET_RVALUE(responseHeaders_, responseHeaders) };
    ...
    inline UpdateSiteCustomLogRequest& setSiteId(int64_t siteId) { DARABONBA_PTR_SET_VALUE(siteId_, siteId) };
