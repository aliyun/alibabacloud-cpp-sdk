...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetHttpResponseHeaderModificationRuleResponseBodyResponseHeaderModification> & responseHeaderModification() const { DARABONBA_PTR_GET_CONST(responseHeaderModification_, vector<GetHttpResponseHeaderModificationRuleResponseBodyResponseHeaderModification>) };
    inline vector<GetHttpResponseHeaderModificationRuleResponseBodyResponseHeaderModification> responseHeaderModification() { DARABONBA_PTR_GET(responseHeaderModification_, vector<GetHttpResponseHeaderModificationRuleResponseBodyResponseHeaderModification>) };
    inline GetHttpResponseHeaderModificationRuleResponseBody& setResponseHeaderModification(const vector<GetHttpResponseHeaderModificationRuleResponseBodyResponseHeaderModification> & responseHeaderModification) { DARABONBA_PTR_SET_VALUE(responseHeaderModification_, responseHeaderModification) };
    inline GetHttpResponseHeaderModificationRuleResponseBody& setResponseHeaderModification(vector<GetHttpResponseHeaderModificationRuleResponseBodyResponseHeaderModification> && responseHeaderModification) { DARABONBA_PTR_SET_RVALUE(responseHeaderModification_, responseHeaderModification) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetHttpResponseHeaderModificationRuleResponseBodyResponseHeaderModification>> responseHeaderModification_ = nullptr;
