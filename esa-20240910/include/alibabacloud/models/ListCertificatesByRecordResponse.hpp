...
namespace Models
{
  ...
  public:
    ...
    inline const ListCertificatesByRecordResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListCertificatesByRecordResponseBody) };
    inline ListCertificatesByRecordResponseBody body() { DARABONBA_PTR_GET(body_, ListCertificatesByRecordResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListCertificatesByRecordResponseBody> body_ = nullptr;
  };
