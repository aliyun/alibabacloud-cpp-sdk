...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Result& setCACertificateId(string CACertificateId) { DARABONBA_PTR_SET_VALUE(CACertificateId_, CACertificateId) };
    ...
    inline const vector<ListClientCertificatesResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListClientCertificatesResponseBody::Result>) };
    inline vector<ListClientCertificatesResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListClientCertificatesResponseBody::Result>) };
    inline ListClientCertificatesResponseBody& setResult(const vector<ListClientCertificatesResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListClientCertificatesResponseBody& setResult(vector<ListClientCertificatesResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
