...
#ifndef ALIBABACLOUD_MODELS_GETCLIENTCERTIFICATERESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_GETCLIENTCERTIFICATERESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetClientCertificateResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetClientCertificateResponseBodyResult& obj) { 
    ...
    GetClientCertificateResponseBodyResult() = default ;
    GetClientCertificateResponseBodyResult(const GetClientCertificateResponseBodyResult &) = default ;
    GetClientCertificateResponseBodyResult(GetClientCertificateResponseBodyResult &&) = default ;
    GetClientCertificateResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetClientCertificateResponseBodyResult() = default ;
    GetClientCertificateResponseBodyResult& operator=(const GetClientCertificateResponseBodyResult &) = default ;
    GetClientCertificateResponseBodyResult& operator=(GetClientCertificateResponseBodyResult &&) = default ;
    ...
    inline GetClientCertificateResponseBodyResult& setCACertificateId(string CACertificateId) { DARABONBA_PTR_SET_VALUE(CACertificateId_, CACertificateId) };
    ...
    inline GetClientCertificateResponseBodyResult& setCommonName(string commonName) { DARABONBA_PTR_SET_VALUE(commonName_, commonName) };
    ...
    inline GetClientCertificateResponseBodyResult& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline GetClientCertificateResponseBodyResult& setFingerprintSha256(string fingerprintSha256) { DARABONBA_PTR_SET_VALUE(fingerprintSha256_, fingerprintSha256) };
    ...
    inline GetClientCertificateResponseBodyResult& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetClientCertificateResponseBodyResult& setIssuer(string issuer) { DARABONBA_PTR_SET_VALUE(issuer_, issuer) };
    ...
    inline GetClientCertificateResponseBodyResult& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetClientCertificateResponseBodyResult& setNotAfter(string notAfter) { DARABONBA_PTR_SET_VALUE(notAfter_, notAfter) };
    ...
    inline GetClientCertificateResponseBodyResult& setNotBefore(string notBefore) { DARABONBA_PTR_SET_VALUE(notBefore_, notBefore) };
    ...
    inline GetClientCertificateResponseBodyResult& setPubkeyAlgorithm(string pubkeyAlgorithm) { DARABONBA_PTR_SET_VALUE(pubkeyAlgorithm_, pubkeyAlgorithm) };
    ...
    inline GetClientCertificateResponseBodyResult& setSAN(string SAN) { DARABONBA_PTR_SET_VALUE(SAN_, SAN) };
    ...
    inline GetClientCertificateResponseBodyResult& setSerialNumber(string serialNumber) { DARABONBA_PTR_SET_VALUE(serialNumber_, serialNumber) };
    ...
    inline GetClientCertificateResponseBodyResult& setSignatureAlgorithm(string signatureAlgorithm) { DARABONBA_PTR_SET_VALUE(signatureAlgorithm_, signatureAlgorithm) };
    ...
    inline GetClientCertificateResponseBodyResult& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetClientCertificateResponseBodyResult& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline GetClientCertificateResponseBodyResult& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
