...
#include <vector>
#include <alibabacloud/models/ListWafManagedRulesResponseBodyRules.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->rules_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const vector<ListWafManagedRulesResponseBodyRules> & rules() const { DARABONBA_PTR_GET_CONST(rules_, vector<ListWafManagedRulesResponseBodyRules>) };
    inline vector<ListWafManagedRulesResponseBodyRules> rules() { DARABONBA_PTR_GET(rules_, vector<ListWafManagedRulesResponseBodyRules>) };
    inline ListWafManagedRulesResponseBody& setRules(const vector<ListWafManagedRulesResponseBodyRules> & rules) { DARABONBA_PTR_SET_VALUE(rules_, rules) };
    inline ListWafManagedRulesResponseBody& setRules(vector<ListWafManagedRulesResponseBodyRules> && rules) { DARABONBA_PTR_SET_RVALUE(rules_, rules) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListWafManagedRulesResponseBodyRules>> rules_ = nullptr;
