...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateManagedTransformResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateManagedTransformResponseBody) };
    inline UpdateManagedTransformResponseBody body() { DARABONBA_PTR_GET(body_, UpdateManagedTransformResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateManagedTransformResponseBody> body_ = nullptr;
  };
