...
#ifndef ALIBABACLOUD_MODELS_LISTCLIENTCACERTIFICATESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListClientCaCertificatesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListClientCaCertificatesResponseBody& obj) { 
    ...
    ListClientCaCertificatesResponseBody() = default ;
    ListClientCaCertificatesResponseBody(const ListClientCaCertificatesResponseBody &) = default ;
    ListClientCaCertificatesResponseBody(ListClientCaCertificatesResponseBody &&) = default ;
    ListClientCaCertificatesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListClientCaCertificatesResponseBody() = default ;
    ListClientCaCertificatesResponseBody& operator=(const ListClientCaCertificatesResponseBody &) = default ;
    ListClientCaCertificatesResponseBody& operator=(ListClientCaCertificatesResponseBody &&) = default ;
