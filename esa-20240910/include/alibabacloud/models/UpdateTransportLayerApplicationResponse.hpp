...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTransportLayerApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTransportLayerApplicationResponseBody) };
    inline UpdateTransportLayerApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTransportLayerApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTransportLayerApplicationResponseBody> body_ {};
  };
