...
namespace Models
{
  ...
  public:
    ...
    inline const ExportRecordsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ExportRecordsResponseBody) };
    inline ExportRecordsResponseBody body() { DARABONBA_PTR_GET(body_, ExportRecordsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ExportRecordsResponseBody> body_ = nullptr;
  };
