...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->additionalCacheablePorts_ == nullptr
        ...
        && this->checkPresenceCookie_ == nullptr && this->checkPresenceHeader_ == nullptr && this->edgeCacheMode_ == nullptr && this->edgeCacheTtl_ == nullptr && this->edgeStatusCodeCacheTtl_ == nullptr
        && this->includeCookie_ == nullptr && this->includeHeader_ == nullptr && this->postBodyCacheKey_ == nullptr && this->postBodySizeLimit_ == nullptr && this->postCache_ == nullptr
        && this->queryString_ == nullptr && this->queryStringMode_ == nullptr && this->rule_ == nullptr && this->ruleEnable_ == nullptr && this->ruleName_ == nullptr
        && this->sequence_ == nullptr && this->serveStale_ == nullptr && this->siteId_ == nullptr && this->siteVersion_ == nullptr && this->sortQueryStringForCache_ == nullptr
