...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWaitingRoomRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWaitingRoomRuleResponseBody) };
    inline DeleteWaitingRoomRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWaitingRoomRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWaitingRoomRuleResponseBody> body_ {};
  };
