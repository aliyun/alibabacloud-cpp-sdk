...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWafRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateWafRuleResponseBody) };
    inline CreateWafRuleResponseBody body() { DARABONBA_PTR_GET(body_, CreateWafRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateWafRuleResponseBody> body_ = nullptr;
  };
