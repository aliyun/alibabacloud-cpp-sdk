...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWafRulesetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWafRulesetResponseBody) };
    inline DeleteWafRulesetResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWafRulesetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWafRulesetResponseBody> body_ {};
  };
