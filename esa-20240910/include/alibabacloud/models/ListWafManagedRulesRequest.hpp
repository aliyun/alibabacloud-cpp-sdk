...
namespace Models
{
  ...
  public:
    ...
    inline const ListWafManagedRulesRequestQueryArgs & queryArgs() const { DARABONBA_PTR_GET_CONST(queryArgs_, ListWafManagedRulesRequestQueryArgs) };
    inline ListWafManagedRulesRequestQueryArgs queryArgs() { DARABONBA_PTR_GET(queryArgs_, ListWafManagedRulesRequestQueryArgs) };
    inline ListWafManagedRulesRequest& setQueryArgs(const ListWafManagedRulesRequestQueryArgs & queryArgs) { DARABONBA_PTR_SET_VALUE(queryArgs_, queryArgs) };
    inline ListWafManagedRulesRequest& setQueryArgs(ListWafManagedRulesRequestQueryArgs && queryArgs) { DARABONBA_PTR_SET_RVALUE(queryArgs_, queryArgs) };
