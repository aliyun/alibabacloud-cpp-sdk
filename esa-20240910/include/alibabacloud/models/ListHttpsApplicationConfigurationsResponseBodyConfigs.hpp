...
#ifndef ALIBABACLOUD_MODELS_LISTHTTPSAPPLICATIONCONFIGURATIONSRESPONSEBODYCONFIGS_HPP_
#define ALIBABACLOUD_MODELS_LISTHTTPSAPPLICATIONCONFIGURATIONSRESPONSEBODYCONFIGS_HPP_
...
namespace Models
{
  class ListHttpsApplicationConfigurationsResponseBodyConfigs : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListHttpsApplicationConfigurationsResponseBodyConfigs& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListHttpsApplicationConfigurationsResponseBodyConfigs& obj) { 
    ...
    ListHttpsApplicationConfigurationsResponseBodyConfigs() = default ;
    ListHttpsApplicationConfigurationsResponseBodyConfigs(const ListHttpsApplicationConfigurationsResponseBodyConfigs &) = default ;
    ListHttpsApplicationConfigurationsResponseBodyConfigs(ListHttpsApplicationConfigurationsResponseBodyConfigs &&) = default ;
    ListHttpsApplicationConfigurationsResponseBodyConfigs(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHttpsApplicationConfigurationsResponseBodyConfigs() = default ;
    ListHttpsApplicationConfigurationsResponseBodyConfigs& operator=(const ListHttpsApplicationConfigurationsResponseBodyConfigs &) = default ;
    ListHttpsApplicationConfigurationsResponseBodyConfigs& operator=(ListHttpsApplicationConfigurationsResponseBodyConfigs &&) = default ;
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setAltSvc(string altSvc) { DARABONBA_PTR_SET_VALUE(altSvc_, altSvc) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setAltSvcClear(string altSvcClear) { DARABONBA_PTR_SET_VALUE(altSvcClear_, altSvcClear) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setAltSvcMa(string altSvcMa) { DARABONBA_PTR_SET_VALUE(altSvcMa_, altSvcMa) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setAltSvcPersist(string altSvcPersist) { DARABONBA_PTR_SET_VALUE(altSvcPersist_, altSvcPersist) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setConfigId(int64_t configId) { DARABONBA_PTR_SET_VALUE(configId_, configId) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setConfigType(string configType) { DARABONBA_PTR_SET_VALUE(configType_, configType) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setHsts(string hsts) { DARABONBA_PTR_SET_VALUE(hsts_, hsts) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setHstsIncludeSubdomains(string hstsIncludeSubdomains) { DARABONBA_PTR_SET_VALUE(hstsIncludeSubdomains_, hstsIncludeSubdomains) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setHstsMaxAge(string hstsMaxAge) { DARABONBA_PTR_SET_VALUE(hstsMaxAge_, hstsMaxAge) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setHstsPreload(string hstsPreload) { DARABONBA_PTR_SET_VALUE(hstsPreload_, hstsPreload) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setHttpsForce(string httpsForce) { DARABONBA_PTR_SET_VALUE(httpsForce_, httpsForce) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setHttpsForceCode(string httpsForceCode) { DARABONBA_PTR_SET_VALUE(httpsForceCode_, httpsForceCode) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setHttpsNoSniDeny(string httpsNoSniDeny) { DARABONBA_PTR_SET_VALUE(httpsNoSniDeny_, httpsNoSniDeny) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setHttpsSniVerify(string httpsSniVerify) { DARABONBA_PTR_SET_VALUE(httpsSniVerify_, httpsSniVerify) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setHttpsSniWhitelist(string httpsSniWhitelist) { DARABONBA_PTR_SET_VALUE(httpsSniWhitelist_, httpsSniWhitelist) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setRule(string rule) { DARABONBA_PTR_SET_VALUE(rule_, rule) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setRuleEnable(string ruleEnable) { DARABONBA_PTR_SET_VALUE(ruleEnable_, ruleEnable) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setSequence(int32_t sequence) { DARABONBA_PTR_SET_VALUE(sequence_, sequence) };
    ...
    inline ListHttpsApplicationConfigurationsResponseBodyConfigs& setSiteVersion(int32_t siteVersion) { DARABONBA_PTR_SET_VALUE(siteVersion_, siteVersion) };
