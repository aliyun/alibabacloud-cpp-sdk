...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceQuotasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceQuotasResponseBody) };
    inline ListInstanceQuotasResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstanceQuotasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstanceQuotasResponseBody> body_ {};
  };
