...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECACHERESERVEPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECACHERESERVEPRICERESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeCacheReservePriceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCacheReservePriceResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(PriceModel, priceModel_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeCacheReservePriceResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(PriceModel, priceModel_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeCacheReservePriceResponseBody() = default ;
    DescribeCacheReservePriceResponseBody(const DescribeCacheReservePriceResponseBody &) = default ;
    DescribeCacheReservePriceResponseBody(DescribeCacheReservePriceResponseBody &&) = default ;
    DescribeCacheReservePriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCacheReservePriceResponseBody() = default ;
    DescribeCacheReservePriceResponseBody& operator=(const DescribeCacheReservePriceResponseBody &) = default ;
    DescribeCacheReservePriceResponseBody& operator=(DescribeCacheReservePriceResponseBody &&) = default ;
    ...
    inline const DescribeCacheReservePriceResponseBody::PriceModel & getPriceModel() const { DARABONBA_PTR_GET_CONST(priceModel_, DescribeCacheReservePriceResponseBody::PriceModel) };
    inline DescribeCacheReservePriceResponseBody::PriceModel getPriceModel() { DARABONBA_PTR_GET(priceModel_, DescribeCacheReservePriceResponseBody::PriceModel) };
    inline DescribeCacheReservePriceResponseBody& setPriceModel(const DescribeCacheReservePriceResponseBody::PriceModel & priceModel) { DARABONBA_PTR_SET_VALUE(priceModel_, priceModel) };
    inline DescribeCacheReservePriceResponseBody& setPriceModel(DescribeCacheReservePriceResponseBody::PriceModel && priceModel) { DARABONBA_PTR_SET_RVALUE(priceModel_, priceModel) };
    ...
    inline DescribeCacheReservePriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The price information.
    shared_ptr<DescribeCacheReservePriceResponseBody::PriceModel> priceModel_ {};
    // The request ID.
