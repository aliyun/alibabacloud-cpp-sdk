...
namespace Models
{
  ...
  public:
    ...
    inline const GetSiteLogDeliveryQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSiteLogDeliveryQuotaResponseBody) };
    inline GetSiteLogDeliveryQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSiteLogDeliveryQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSiteLogDeliveryQuotaResponseBody> body_ {};
  };
