...
namespace Models
{
  ...
  public:
    ...
    inline const ListCertificatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCertificatesResponseBody) };
    inline ListCertificatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCertificatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCertificatesResponseBody> body_ {};
  };
