...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListRedirectRulesResponseBodyConfigs> & configs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListRedirectRulesResponseBodyConfigs>) };
    inline vector<ListRedirectRulesResponseBodyConfigs> configs() { DARABONBA_PTR_GET(configs_, vector<ListRedirectRulesResponseBodyConfigs>) };
    inline ListRedirectRulesResponseBody& setConfigs(const vector<ListRedirectRulesResponseBodyConfigs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListRedirectRulesResponseBody& setConfigs(vector<ListRedirectRulesResponseBodyConfigs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListRedirectRulesResponseBodyConfigs>> configs_ = nullptr;
    // Current page number.
