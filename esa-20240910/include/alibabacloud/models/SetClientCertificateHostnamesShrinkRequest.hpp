...
#ifndef ALIBABACLOUD_MODELS_SETCLIENTCERTIFICATEHOSTNAMESSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SETCLIENTCERTIFICATEHOSTNAMESSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SetClientCertificateHostnamesShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(Hostnames, hostnamesShrink_);
      DARABONBA_PTR_TO_JSON(Id, id_);
      DARABONBA_PTR_TO_JSON(SiteId, siteId_);
    };
    friend void from_json(const Darabonba::Json& j, SetClientCertificateHostnamesShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(Hostnames, hostnamesShrink_);
      DARABONBA_PTR_FROM_JSON(Id, id_);
      DARABONBA_PTR_FROM_JSON(SiteId, siteId_);
    };
    SetClientCertificateHostnamesShrinkRequest() = default ;
    SetClientCertificateHostnamesShrinkRequest(const SetClientCertificateHostnamesShrinkRequest &) = default ;
    SetClientCertificateHostnamesShrinkRequest(SetClientCertificateHostnamesShrinkRequest &&) = default ;
    SetClientCertificateHostnamesShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SetClientCertificateHostnamesShrinkRequest() = default ;
    SetClientCertificateHostnamesShrinkRequest& operator=(const SetClientCertificateHostnamesShrinkRequest &) = default ;
    SetClientCertificateHostnamesShrinkRequest& operator=(SetClientCertificateHostnamesShrinkRequest &&) = default ;
