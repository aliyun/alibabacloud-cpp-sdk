...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserLogDeliveryQuotaResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetUserLogDeliveryQuotaResponseBody) };
    inline GetUserLogDeliveryQuotaResponseBody body() { DARABONBA_PTR_GET(body_, GetUserLogDeliveryQuotaResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetUserLogDeliveryQuotaResponseBody> body_ = nullptr;
  };
