...
#ifndef ALIBABACLOUD_MODELS_UPLOADORIGINCACERTIFICATERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPLOADORIGINCACERTIFICATERESPONSEBODY_HPP_
...
namespace Models
{
  class UploadOriginCaCertificateResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UploadOriginCaCertificateResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UploadOriginCaCertificateResponseBody& obj) { 
    ...
    UploadOriginCaCertificateResponseBody() = default ;
    UploadOriginCaCertificateResponseBody(const UploadOriginCaCertificateResponseBody &) = default ;
    UploadOriginCaCertificateResponseBody(UploadOriginCaCertificateResponseBody &&) = default ;
    UploadOriginCaCertificateResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UploadOriginCaCertificateResponseBody() = default ;
    UploadOriginCaCertificateResponseBody& operator=(const UploadOriginCaCertificateResponseBody &) = default ;
    UploadOriginCaCertificateResponseBody& operator=(UploadOriginCaCertificateResponseBody &&) = default ;
    ...
    inline UploadOriginCaCertificateResponseBody& setCommonName(string commonName) { DARABONBA_PTR_SET_VALUE(commonName_, commonName) };
    ...
    inline UploadOriginCaCertificateResponseBody& setFingerprintSha256(string fingerprintSha256) { DARABONBA_PTR_SET_VALUE(fingerprintSha256_, fingerprintSha256) };
    ...
    inline UploadOriginCaCertificateResponseBody& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UploadOriginCaCertificateResponseBody& setIssuer(string issuer) { DARABONBA_PTR_SET_VALUE(issuer_, issuer) };
    ...
    inline UploadOriginCaCertificateResponseBody& setNotAfter(string notAfter) { DARABONBA_PTR_SET_VALUE(notAfter_, notAfter) };
    ...
    inline UploadOriginCaCertificateResponseBody& setNotBefore(string notBefore) { DARABONBA_PTR_SET_VALUE(notBefore_, notBefore) };
    ...
    inline UploadOriginCaCertificateResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline UploadOriginCaCertificateResponseBody& setSerialNumber(string serialNumber) { DARABONBA_PTR_SET_VALUE(serialNumber_, serialNumber) };
    ...
    inline UploadOriginCaCertificateResponseBody& setSignatureAlgorithm(string signatureAlgorithm) { DARABONBA_PTR_SET_VALUE(signatureAlgorithm_, signatureAlgorithm) };
    ...
    inline UploadOriginCaCertificateResponseBody& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline UploadOriginCaCertificateResponseBody& setValidityDays(string validityDays) { DARABONBA_PTR_SET_VALUE(validityDays_, validityDays) };
