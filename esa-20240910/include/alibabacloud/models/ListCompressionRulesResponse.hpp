...
namespace Models
{
  ...
  public:
    ...
    inline const ListCompressionRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCompressionRulesResponseBody) };
    inline ListCompressionRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCompressionRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCompressionRulesResponseBody> body_ {};
  };
