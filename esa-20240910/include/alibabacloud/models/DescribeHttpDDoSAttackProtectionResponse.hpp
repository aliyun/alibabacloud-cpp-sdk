...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHttpDDoSAttackProtectionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeHttpDDoSAttackProtectionResponseBody) };
    inline DescribeHttpDDoSAttackProtectionResponseBody body() { DARABONBA_PTR_GET(body_, DescribeHttpDDoSAttackProtectionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeHttpDDoSAttackProtectionResponseBody> body_ = nullptr;
  };
