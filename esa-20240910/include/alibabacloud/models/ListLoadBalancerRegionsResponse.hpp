...
namespace Models
{
  ...
  public:
    ...
    inline const ListLoadBalancerRegionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLoadBalancerRegionsResponseBody) };
    inline ListLoadBalancerRegionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLoadBalancerRegionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLoadBalancerRegionsResponseBody> body_ {};
  };
