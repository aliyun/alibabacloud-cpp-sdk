...
namespace Models
{
  ...
  public:
    ...
    inline const ListClientCertificatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListClientCertificatesResponseBody) };
    inline ListClientCertificatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListClientCertificatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListClientCertificatesResponseBody> body_ {};
  };
