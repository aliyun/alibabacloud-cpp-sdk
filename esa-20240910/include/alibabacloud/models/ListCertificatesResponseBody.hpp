...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListCertificatesResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListCertificatesResponseBody::Result>) };
    inline vector<ListCertificatesResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListCertificatesResponseBody::Result>) };
    inline ListCertificatesResponseBody& setResult(const vector<ListCertificatesResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListCertificatesResponseBody& setResult(vector<ListCertificatesResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
