...
namespace Models
{
  ...
  public:
    ...
    inline ListCertificatesResponseBody& setPageNumber(int64_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListCertificatesResponseBody& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline const vector<ListCertificatesResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListCertificatesResponseBodyResult>) };
    inline vector<ListCertificatesResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListCertificatesResponseBodyResult>) };
    inline ListCertificatesResponseBody& setResult(const vector<ListCertificatesResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListCertificatesResponseBody& setResult(vector<ListCertificatesResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline ListCertificatesResponseBody& setSiteId(int64_t siteId) { DARABONBA_PTR_SET_VALUE(siteId_, siteId) };
    ...
    inline ListCertificatesResponseBody& setSiteName(string siteName) { DARABONBA_PTR_SET_VALUE(siteName_, siteName) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListCertificatesResponseBodyResult>> result_ = nullptr;
    // The website ID.
