...
namespace Models
{
  ...
  public:
    ...
    inline const GetOriginCaCertificateResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetOriginCaCertificateResponseBody) };
    inline GetOriginCaCertificateResponseBody body() { DARABONBA_PTR_GET(body_, GetOriginCaCertificateResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetOriginCaCertificateResponseBody> body_ = nullptr;
  };
