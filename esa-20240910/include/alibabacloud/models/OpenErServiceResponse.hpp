...
namespace Models
{
  ...
  public:
    ...
    inline const OpenErServiceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, OpenErServiceResponseBody) };
    inline OpenErServiceResponseBody body() { DARABONBA_PTR_GET(body_, OpenErServiceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<OpenErServiceResponseBody> body_ = nullptr;
  };
