...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListEdgeRoutineRecordsResponseBody::Records> & getRecords() const { DARABONBA_PTR_GET_CONST(records_, vector<ListEdgeRoutineRecordsResponseBody::Records>) };
    inline vector<ListEdgeRoutineRecordsResponseBody::Records> getRecords() { DARABONBA_PTR_GET(records_, vector<ListEdgeRoutineRecordsResponseBody::Records>) };
    inline ListEdgeRoutineRecordsResponseBody& setRecords(const vector<ListEdgeRoutineRecordsResponseBody::Records> & records) { DARABONBA_PTR_SET_VALUE(records_, records) };
    inline ListEdgeRoutineRecordsResponseBody& setRecords(vector<ListEdgeRoutineRecordsResponseBody::Records> && records) { DARABONBA_PTR_SET_RVALUE(records_, records) };
  ...
  protected:
    ...
    // The list of records.
    shared_ptr<vector<ListEdgeRoutineRecordsResponseBody::Records>> records_ {};
    // The request ID.
