...
namespace Models
{
  ...
  public:
    ...
    inline const VerifySiteResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, VerifySiteResponseBody) };
    inline VerifySiteResponseBody body() { DARABONBA_PTR_GET(body_, VerifySiteResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<VerifySiteResponseBody> body_ = nullptr;
  };
