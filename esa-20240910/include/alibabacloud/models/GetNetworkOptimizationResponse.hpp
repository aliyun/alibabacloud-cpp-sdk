...
namespace Models
{
  ...
  public:
    ...
    inline const GetNetworkOptimizationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetNetworkOptimizationResponseBody) };
    inline GetNetworkOptimizationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetNetworkOptimizationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetNetworkOptimizationResponseBody> body_ {};
  };
