...
namespace Models
{
  ...
  public:
    ...
    inline const GetHttpIncomingResponseHeaderModificationRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetHttpIncomingResponseHeaderModificationRuleResponseBody) };
    inline GetHttpIncomingResponseHeaderModificationRuleResponseBody body() { DARABONBA_PTR_GET(body_, GetHttpIncomingResponseHeaderModificationRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetHttpIncomingResponseHeaderModificationRuleResponseBody> body_ = nullptr;
  };
