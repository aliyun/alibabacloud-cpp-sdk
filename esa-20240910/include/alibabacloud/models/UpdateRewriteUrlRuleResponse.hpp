...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRewriteUrlRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateRewriteUrlRuleResponseBody) };
    inline UpdateRewriteUrlRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateRewriteUrlRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateRewriteUrlRuleResponseBody> body_ {};
  };
