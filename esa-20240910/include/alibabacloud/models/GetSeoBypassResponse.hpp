...
namespace Models
{
  ...
  public:
    ...
    inline const GetSeoBypassResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSeoBypassResponseBody) };
    inline GetSeoBypassResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSeoBypassResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSeoBypassResponseBody> body_ {};
  };
