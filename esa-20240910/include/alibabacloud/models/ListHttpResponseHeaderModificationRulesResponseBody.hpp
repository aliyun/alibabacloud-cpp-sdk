...
#include <vector>
#include <alibabacloud/models/ListHttpResponseHeaderModificationRulesResponseBodyConfigs.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHttpResponseHeaderModificationRulesResponseBodyConfigs> & configs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListHttpResponseHeaderModificationRulesResponseBodyConfigs>) };
    inline vector<ListHttpResponseHeaderModificationRulesResponseBodyConfigs> configs() { DARABONBA_PTR_GET(configs_, vector<ListHttpResponseHeaderModificationRulesResponseBodyConfigs>) };
    inline ListHttpResponseHeaderModificationRulesResponseBody& setConfigs(const vector<ListHttpResponseHeaderModificationRulesResponseBodyConfigs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListHttpResponseHeaderModificationRulesResponseBody& setConfigs(vector<ListHttpResponseHeaderModificationRulesResponseBodyConfigs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHttpResponseHeaderModificationRulesResponseBodyConfigs>> configs_ = nullptr;
    // Page number.
