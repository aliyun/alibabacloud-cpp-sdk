...
namespace Models
{
  ...
  public:
    ...
    inline const GetOriginPoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOriginPoolResponseBody) };
    inline GetOriginPoolResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOriginPoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOriginPoolResponseBody> body_ {};
  };
