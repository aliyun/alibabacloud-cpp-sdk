...
#ifndef ALIBABACLOUD_MODELS_BATCHCREATERECORDSRESPONSEBODYRECORDRESULTLISTFAILEDDATA_HPP_
#define ALIBABACLOUD_MODELS_BATCHCREATERECORDSRESPONSEBODYRECORDRESULTLISTFAILEDDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const BatchCreateRecordsResponseBodyRecordResultListFailedData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, BatchCreateRecordsResponseBodyRecordResultListFailedData& obj) { 
    ...
    BatchCreateRecordsResponseBodyRecordResultListFailedData() = default ;
    BatchCreateRecordsResponseBodyRecordResultListFailedData(const BatchCreateRecordsResponseBodyRecordResultListFailedData &) = default ;
    BatchCreateRecordsResponseBodyRecordResultListFailedData(BatchCreateRecordsResponseBodyRecordResultListFailedData &&) = default ;
    BatchCreateRecordsResponseBodyRecordResultListFailedData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BatchCreateRecordsResponseBodyRecordResultListFailedData() = default ;
    BatchCreateRecordsResponseBodyRecordResultListFailedData& operator=(const BatchCreateRecordsResponseBodyRecordResultListFailedData &) = default ;
    BatchCreateRecordsResponseBodyRecordResultListFailedData& operator=(BatchCreateRecordsResponseBodyRecordResultListFailedData &&) = default ;
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setAlgorithm(int32_t algorithm) { DARABONBA_PTR_SET_VALUE(algorithm_, algorithm) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setCertificate(string certificate) { DARABONBA_PTR_SET_VALUE(certificate_, certificate) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setFingerprint(string fingerprint) { DARABONBA_PTR_SET_VALUE(fingerprint_, fingerprint) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setFlag(int32_t flag) { DARABONBA_PTR_SET_VALUE(flag_, flag) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setKeyTag(int32_t keyTag) { DARABONBA_PTR_SET_VALUE(keyTag_, keyTag) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setMatchingType(int32_t matchingType) { DARABONBA_PTR_SET_VALUE(matchingType_, matchingType) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setPort(int32_t port) { DARABONBA_PTR_SET_VALUE(port_, port) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setSelector(int32_t selector) { DARABONBA_PTR_SET_VALUE(selector_, selector) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setUsage(int32_t usage) { DARABONBA_PTR_SET_VALUE(usage_, usage) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
    ...
    inline BatchCreateRecordsResponseBodyRecordResultListFailedData& setWeight(int32_t weight) { DARABONBA_PTR_SET_VALUE(weight_, weight) };
