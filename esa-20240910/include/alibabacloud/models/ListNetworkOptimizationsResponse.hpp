...
namespace Models
{
  ...
  public:
    ...
    inline const ListNetworkOptimizationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNetworkOptimizationsResponseBody) };
    inline ListNetworkOptimizationsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNetworkOptimizationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNetworkOptimizationsResponseBody> body_ {};
  };
