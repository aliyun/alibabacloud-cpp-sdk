...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCacheRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateCacheRuleResponseBody) };
    inline UpdateCacheRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateCacheRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateCacheRuleResponseBody> body_ {};
  };
