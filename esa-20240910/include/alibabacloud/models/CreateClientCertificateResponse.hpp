...
namespace Models
{
  ...
  public:
    ...
    inline const CreateClientCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateClientCertificateResponseBody) };
    inline CreateClientCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateClientCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateClientCertificateResponseBody> body_ {};
  };
