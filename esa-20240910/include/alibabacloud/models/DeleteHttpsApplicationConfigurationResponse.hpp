...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHttpsApplicationConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHttpsApplicationConfigurationResponseBody) };
    inline DeleteHttpsApplicationConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHttpsApplicationConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHttpsApplicationConfigurationResponseBody> body_ {};
  };
