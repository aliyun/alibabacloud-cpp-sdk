...
#ifndef ALIBABACLOUD_MODELS_GETSCHEDULEDPRELOADJOBRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETSCHEDULEDPRELOADJOBRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetScheduledPreloadJobResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetScheduledPreloadJobResponseBody& obj) { 
    ...
    GetScheduledPreloadJobResponseBody() = default ;
    GetScheduledPreloadJobResponseBody(const GetScheduledPreloadJobResponseBody &) = default ;
    GetScheduledPreloadJobResponseBody(GetScheduledPreloadJobResponseBody &&) = default ;
    GetScheduledPreloadJobResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetScheduledPreloadJobResponseBody() = default ;
    GetScheduledPreloadJobResponseBody& operator=(const GetScheduledPreloadJobResponseBody &) = default ;
    GetScheduledPreloadJobResponseBody& operator=(GetScheduledPreloadJobResponseBody &&) = default ;
    ...
    inline GetScheduledPreloadJobResponseBody& setAliUid(string aliUid) { DARABONBA_PTR_SET_VALUE(aliUid_, aliUid) };
    ...
    inline GetScheduledPreloadJobResponseBody& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };
    ...
    inline GetScheduledPreloadJobResponseBody& setDomains(string domains) { DARABONBA_PTR_SET_VALUE(domains_, domains) };
    ...
    inline GetScheduledPreloadJobResponseBody& setErrorInfo(string errorInfo) { DARABONBA_PTR_SET_VALUE(errorInfo_, errorInfo) };
    ...
    inline GetScheduledPreloadJobResponseBody& setFailedFileOss(string failedFileOss) { DARABONBA_PTR_SET_VALUE(failedFileOss_, failedFileOss) };
    ...
    inline GetScheduledPreloadJobResponseBody& setFileId(string fileId) { DARABONBA_PTR_SET_VALUE(fileId_, fileId) };
    ...
    inline GetScheduledPreloadJobResponseBody& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetScheduledPreloadJobResponseBody& setInsertWay(string insertWay) { DARABONBA_PTR_SET_VALUE(insertWay_, insertWay) };
    ...
    inline GetScheduledPreloadJobResponseBody& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetScheduledPreloadJobResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetScheduledPreloadJobResponseBody& setSiteId(int64_t siteId) { DARABONBA_PTR_SET_VALUE(siteId_, siteId) };
    ...
    inline GetScheduledPreloadJobResponseBody& setTaskSubmitted(int32_t taskSubmitted) { DARABONBA_PTR_SET_VALUE(taskSubmitted_, taskSubmitted) };
    ...
    inline GetScheduledPreloadJobResponseBody& setTaskType(string taskType) { DARABONBA_PTR_SET_VALUE(taskType_, taskType) };
    ...
    inline GetScheduledPreloadJobResponseBody& setUrlCount(int32_t urlCount) { DARABONBA_PTR_SET_VALUE(urlCount_, urlCount) };
    ...
    inline GetScheduledPreloadJobResponseBody& setUrlSubmitted(int32_t urlSubmitted) { DARABONBA_PTR_SET_VALUE(urlSubmitted_, urlSubmitted) };
