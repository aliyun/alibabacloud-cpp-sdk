...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->percentage_ == nullptr && this->remarks_ == nullptr && this->usedPercent_ == nullptr && this->versionId_ == nullptr; };
    ...
    inline bool getUsedPercent() const { DARABONBA_PTR_GET_DEFAULT(usedPercent_, false) };
