...
namespace Models
{
  ...
  public:
    ...
    inline const ListImageTransformsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListImageTransformsResponseBody) };
    inline ListImageTransformsResponseBody body() { DARABONBA_PTR_GET(body_, ListImageTransformsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListImageTransformsResponseBody> body_ = nullptr;
  };
