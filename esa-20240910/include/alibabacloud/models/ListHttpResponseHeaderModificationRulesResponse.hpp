...
namespace Models
{
  ...
  public:
    ...
    inline const ListHttpResponseHeaderModificationRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHttpResponseHeaderModificationRulesResponseBody) };
    inline ListHttpResponseHeaderModificationRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHttpResponseHeaderModificationRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHttpResponseHeaderModificationRulesResponseBody> body_ {};
  };
