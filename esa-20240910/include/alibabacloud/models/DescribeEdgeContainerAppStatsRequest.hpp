...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->app_ == nullptr
        && return this->endTime_ == nullptr && return this->fields_ == nullptr && return this->isp_ == nullptr && return this->locate_ == nullptr && return this->startTime_ == nullptr
        && return this->tenant_ == nullptr; };
    // app Field Functions 
