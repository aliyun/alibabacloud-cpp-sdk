...
#ifndef ALIBABACLOUD_MODELS_UPLOADCLIENTCACERTIFICATERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPLOADCLIENTCACERTIFICATERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UploadClientCaCertificateResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UploadClientCaCertificateResponseBody& obj) { 
    ...
    UploadClientCaCertificateResponseBody() = default ;
    UploadClientCaCertificateResponseBody(const UploadClientCaCertificateResponseBody &) = default ;
    UploadClientCaCertificateResponseBody(UploadClientCaCertificateResponseBody &&) = default ;
    UploadClientCaCertificateResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UploadClientCaCertificateResponseBody() = default ;
    UploadClientCaCertificateResponseBody& operator=(const UploadClientCaCertificateResponseBody &) = default ;
    UploadClientCaCertificateResponseBody& operator=(UploadClientCaCertificateResponseBody &&) = default ;
    ...
    inline UploadClientCaCertificateResponseBody& setCommonName(string commonName) { DARABONBA_PTR_SET_VALUE(commonName_, commonName) };
    ...
    inline UploadClientCaCertificateResponseBody& setFingerprintSha256(string fingerprintSha256) { DARABONBA_PTR_SET_VALUE(fingerprintSha256_, fingerprintSha256) };
    ...
    inline UploadClientCaCertificateResponseBody& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UploadClientCaCertificateResponseBody& setIssuer(string issuer) { DARABONBA_PTR_SET_VALUE(issuer_, issuer) };
    ...
    inline UploadClientCaCertificateResponseBody& setNotAfter(string notAfter) { DARABONBA_PTR_SET_VALUE(notAfter_, notAfter) };
    ...
    inline UploadClientCaCertificateResponseBody& setNotBefore(string notBefore) { DARABONBA_PTR_SET_VALUE(notBefore_, notBefore) };
    ...
    inline UploadClientCaCertificateResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline UploadClientCaCertificateResponseBody& setSerialNumber(string serialNumber) { DARABONBA_PTR_SET_VALUE(serialNumber_, serialNumber) };
    ...
    inline UploadClientCaCertificateResponseBody& setSignatureAlgorithm(string signatureAlgorithm) { DARABONBA_PTR_SET_VALUE(signatureAlgorithm_, signatureAlgorithm) };
    ...
    inline UploadClientCaCertificateResponseBody& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline UploadClientCaCertificateResponseBody& setValidityDays(string validityDays) { DARABONBA_PTR_SET_VALUE(validityDays_, validityDays) };
