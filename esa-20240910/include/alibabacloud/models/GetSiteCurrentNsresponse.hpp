...
namespace Models
{
  ...
  public:
    ...
    inline const GetSiteCurrentNSResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetSiteCurrentNSResponseBody) };
    inline GetSiteCurrentNSResponseBody body() { DARABONBA_PTR_GET(body_, GetSiteCurrentNSResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetSiteCurrentNSResponseBody> body_ = nullptr;
  };
