...
namespace Models
{
  ...
  public:
    ...
    inline const GetHttpRequestHeaderModificationRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHttpRequestHeaderModificationRuleResponseBody) };
    inline GetHttpRequestHeaderModificationRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHttpRequestHeaderModificationRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHttpRequestHeaderModificationRuleResponseBody> body_ {};
  };
