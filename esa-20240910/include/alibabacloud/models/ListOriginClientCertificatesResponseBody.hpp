...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListOriginClientCertificatesResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListOriginClientCertificatesResponseBody::Result>) };
    inline vector<ListOriginClientCertificatesResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListOriginClientCertificatesResponseBody::Result>) };
    inline ListOriginClientCertificatesResponseBody& setResult(const vector<ListOriginClientCertificatesResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListOriginClientCertificatesResponseBody& setResult(vector<ListOriginClientCertificatesResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<vector<ListOriginClientCertificatesResponseBody::Result>> result_ {};
    // The website ID.
