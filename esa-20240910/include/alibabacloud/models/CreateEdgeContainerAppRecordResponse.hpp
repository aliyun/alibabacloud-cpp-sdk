...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEdgeContainerAppRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateEdgeContainerAppRecordResponseBody) };
    inline CreateEdgeContainerAppRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateEdgeContainerAppRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateEdgeContainerAppRecordResponseBody> body_ {};
  };
