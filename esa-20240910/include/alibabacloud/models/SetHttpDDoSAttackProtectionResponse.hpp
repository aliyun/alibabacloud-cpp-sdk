...
namespace Models
{
  ...
  public:
    ...
    inline const SetHttpDDoSAttackProtectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetHttpDDoSAttackProtectionResponseBody) };
    inline SetHttpDDoSAttackProtectionResponseBody getBody() { DARABONBA_PTR_GET(body_, SetHttpDDoSAttackProtectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetHttpDDoSAttackProtectionResponseBody> body_ {};
  };
