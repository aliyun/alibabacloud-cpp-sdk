...
namespace Models
{
  ...
  public:
    ...
    inline const ListVideoProcessingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVideoProcessingsResponseBody) };
    inline ListVideoProcessingsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVideoProcessingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVideoProcessingsResponseBody> body_ {};
  };
