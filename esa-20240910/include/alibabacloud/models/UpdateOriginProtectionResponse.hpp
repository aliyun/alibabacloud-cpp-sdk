...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateOriginProtectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateOriginProtectionResponseBody) };
    inline UpdateOriginProtectionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateOriginProtectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateOriginProtectionResponseBody> body_ {};
  };
