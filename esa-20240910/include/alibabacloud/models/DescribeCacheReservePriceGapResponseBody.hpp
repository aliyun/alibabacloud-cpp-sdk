...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECACHERESERVEPRICEGAPRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECACHERESERVEPRICEGAPRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeCacheReservePriceGapResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCacheReservePriceGapResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(PriceModel, priceModel_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeCacheReservePriceGapResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(PriceModel, priceModel_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeCacheReservePriceGapResponseBody() = default ;
    DescribeCacheReservePriceGapResponseBody(const DescribeCacheReservePriceGapResponseBody &) = default ;
    DescribeCacheReservePriceGapResponseBody(DescribeCacheReservePriceGapResponseBody &&) = default ;
    DescribeCacheReservePriceGapResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCacheReservePriceGapResponseBody() = default ;
    DescribeCacheReservePriceGapResponseBody& operator=(const DescribeCacheReservePriceGapResponseBody &) = default ;
    DescribeCacheReservePriceGapResponseBody& operator=(DescribeCacheReservePriceGapResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->currency_ == nullptr
        && this->discountPrice_ == nullptr && this->instanceId_ == nullptr && this->price_ == nullptr && this->rule_ == nullptr && this->totalPrice_ == nullptr; };
    ...
    inline const DescribeCacheReservePriceGapResponseBody::PriceModel & getPriceModel() const { DARABONBA_PTR_GET_CONST(priceModel_, DescribeCacheReservePriceGapResponseBody::PriceModel) };
    inline DescribeCacheReservePriceGapResponseBody::PriceModel getPriceModel() { DARABONBA_PTR_GET(priceModel_, DescribeCacheReservePriceGapResponseBody::PriceModel) };
    inline DescribeCacheReservePriceGapResponseBody& setPriceModel(const DescribeCacheReservePriceGapResponseBody::PriceModel & priceModel) { DARABONBA_PTR_SET_VALUE(priceModel_, priceModel) };
    inline DescribeCacheReservePriceGapResponseBody& setPriceModel(DescribeCacheReservePriceGapResponseBody::PriceModel && priceModel) { DARABONBA_PTR_SET_RVALUE(priceModel_, priceModel) };
    ...
    inline DescribeCacheReservePriceGapResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
