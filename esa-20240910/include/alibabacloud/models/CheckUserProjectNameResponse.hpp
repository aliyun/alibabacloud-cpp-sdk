...
namespace Models
{
  ...
  public:
    ...
    inline const CheckUserProjectNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckUserProjectNameResponseBody) };
    inline CheckUserProjectNameResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckUserProjectNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckUserProjectNameResponseBody> body_ {};
  };
