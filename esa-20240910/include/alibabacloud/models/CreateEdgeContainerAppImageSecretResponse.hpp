...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEdgeContainerAppImageSecretResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateEdgeContainerAppImageSecretResponseBody) };
    inline CreateEdgeContainerAppImageSecretResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateEdgeContainerAppImageSecretResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateEdgeContainerAppImageSecretResponseBody> body_ {};
  };
