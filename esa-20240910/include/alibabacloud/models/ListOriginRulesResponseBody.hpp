...
#include <vector>
#include <alibabacloud/models/ListOriginRulesResponseBodyConfigs.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListOriginRulesResponseBodyConfigs> & configs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListOriginRulesResponseBodyConfigs>) };
    inline vector<ListOriginRulesResponseBodyConfigs> configs() { DARABONBA_PTR_GET(configs_, vector<ListOriginRulesResponseBodyConfigs>) };
    inline ListOriginRulesResponseBody& setConfigs(const vector<ListOriginRulesResponseBodyConfigs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListOriginRulesResponseBody& setConfigs(vector<ListOriginRulesResponseBodyConfigs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListOriginRulesResponseBodyConfigs>> configs_ = nullptr;
    // Current page number.
