...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->enable_ == nullptr
        && return this->contentLength_ == nullptr; };
    ...
    inline const WafQuotaInteger & contentLength() const { DARABONBA_PTR_GET_CONST(contentLength_, WafQuotaInteger) };
    inline WafQuotaInteger contentLength() { DARABONBA_PTR_GET(contentLength_, WafQuotaInteger) };
  ...
  protected:
    ...
    std::shared_ptr<WafQuotaInteger> contentLength_ = nullptr;
  };
