...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessType_ == nullptr
        && return this->dataCenter_ == nullptr && return this->deliveryType_ == nullptr && return this->details_ == nullptr && return this->discardRate_ == nullptr && return this->fieldList_ == nullptr
        && return this->filterRules_ == nullptr && return this->filterVer_ == nullptr && return this->rawRule_ == nullptr && return this->requestId_ == nullptr && return this->sinkConfig_ == nullptr
