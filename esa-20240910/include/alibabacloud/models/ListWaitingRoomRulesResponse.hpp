...
namespace Models
{
  ...
  public:
    ...
    inline const ListWaitingRoomRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWaitingRoomRulesResponseBody) };
    inline ListWaitingRoomRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWaitingRoomRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWaitingRoomRulesResponseBody> body_ {};
  };
