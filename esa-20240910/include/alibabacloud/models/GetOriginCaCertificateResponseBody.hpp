...
namespace Models
{
  ...
  public:
    ...
    inline const GetOriginCaCertificateResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, GetOriginCaCertificateResponseBody::Result) };
    inline GetOriginCaCertificateResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, GetOriginCaCertificateResponseBody::Result) };
    inline GetOriginCaCertificateResponseBody& setResult(const GetOriginCaCertificateResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetOriginCaCertificateResponseBody& setResult(GetOriginCaCertificateResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<GetOriginCaCertificateResponseBody::Result> result_ {};
    // The website ID.
