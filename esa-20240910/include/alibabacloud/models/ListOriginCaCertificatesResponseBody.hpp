...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListOriginCaCertificatesResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListOriginCaCertificatesResponseBody::Result>) };
    inline vector<ListOriginCaCertificatesResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListOriginCaCertificatesResponseBody::Result>) };
    inline ListOriginCaCertificatesResponseBody& setResult(const vector<ListOriginCaCertificatesResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListOriginCaCertificatesResponseBody& setResult(vector<ListOriginCaCertificatesResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
