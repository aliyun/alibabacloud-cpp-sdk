...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePurgeTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePurgeTasksResponseBody) };
    inline DescribePurgeTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePurgeTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePurgeTasksResponseBody> body_ {};
  };
