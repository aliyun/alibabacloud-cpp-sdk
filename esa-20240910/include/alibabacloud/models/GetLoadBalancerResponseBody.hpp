...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adaptiveRouting_ == nullptr
        ...
        && return this->monitor_ == nullptr && return this->name_ == nullptr && return this->randomSteering_ == nullptr && return this->regionPools_ == nullptr && return this->requestId_ == nullptr
        && return this->rules_ == nullptr && return this->sessionAffinity_ == nullptr && return this->siteId_ == nullptr && return this->status_ == nullptr && return this->steeringPolicy_ == nullptr
        && return this->subRegionPools_ == nullptr && return this->ttl_ == nullptr; };
