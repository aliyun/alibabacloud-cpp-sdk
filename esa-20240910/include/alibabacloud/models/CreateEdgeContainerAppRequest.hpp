...
namespace Models
{
  ...
  public:
    ...
    inline int32_t healthCheckFailTimes() const { DARABONBA_PTR_GET_DEFAULT(healthCheckFailTimes_, 0) };
    ...
    inline int32_t healthCheckSuccTimes() const { DARABONBA_PTR_GET_DEFAULT(healthCheckSuccTimes_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> healthCheckFailTimes_ = nullptr;
    ...
    std::shared_ptr<int32_t> healthCheckSuccTimes_ = nullptr;
