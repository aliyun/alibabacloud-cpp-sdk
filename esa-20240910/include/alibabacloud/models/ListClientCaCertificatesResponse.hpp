...
namespace Models
{
  ...
  public:
    ...
    inline const ListClientCaCertificatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListClientCaCertificatesResponseBody) };
    inline ListClientCaCertificatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListClientCaCertificatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListClientCaCertificatesResponseBody> body_ {};
  };
