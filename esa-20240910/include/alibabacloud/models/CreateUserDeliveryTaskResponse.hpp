...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUserDeliveryTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateUserDeliveryTaskResponseBody) };
    inline CreateUserDeliveryTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateUserDeliveryTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateUserDeliveryTaskResponseBody> body_ {};
  };
