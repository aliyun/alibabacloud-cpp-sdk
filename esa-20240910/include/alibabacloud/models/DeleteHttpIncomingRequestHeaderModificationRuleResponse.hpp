...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHttpIncomingRequestHeaderModificationRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteHttpIncomingRequestHeaderModificationRuleResponseBody) };
    inline DeleteHttpIncomingRequestHeaderModificationRuleResponseBody body() { DARABONBA_PTR_GET(body_, DeleteHttpIncomingRequestHeaderModificationRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteHttpIncomingRequestHeaderModificationRuleResponseBody> body_ = nullptr;
  };
