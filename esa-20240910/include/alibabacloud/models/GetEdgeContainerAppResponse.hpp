...
namespace Models
{
  ...
  public:
    ...
    inline const GetEdgeContainerAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEdgeContainerAppResponseBody) };
    inline GetEdgeContainerAppResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEdgeContainerAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEdgeContainerAppResponseBody> body_ {};
  };
