...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomScenePoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCustomScenePoliciesResponseBody) };
    inline DescribeCustomScenePoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCustomScenePoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCustomScenePoliciesResponseBody> body_ {};
  };
