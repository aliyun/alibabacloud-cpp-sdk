...
#ifndef ALIBABACLOUD_MODELS_CREATEUSERDELIVERYTASKREQUESTSLSDELIVERY_HPP_
#define ALIBABACLOUD_MODELS_CREATEUSERDELIVERYTASKREQUESTSLSDELIVERY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateUserDeliveryTaskRequestSlsDelivery& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateUserDeliveryTaskRequestSlsDelivery& obj) { 
    ...
    CreateUserDeliveryTaskRequestSlsDelivery() = default ;
    CreateUserDeliveryTaskRequestSlsDelivery(const CreateUserDeliveryTaskRequestSlsDelivery &) = default ;
    CreateUserDeliveryTaskRequestSlsDelivery(CreateUserDeliveryTaskRequestSlsDelivery &&) = default ;
    CreateUserDeliveryTaskRequestSlsDelivery(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateUserDeliveryTaskRequestSlsDelivery() = default ;
    CreateUserDeliveryTaskRequestSlsDelivery& operator=(const CreateUserDeliveryTaskRequestSlsDelivery &) = default ;
    CreateUserDeliveryTaskRequestSlsDelivery& operator=(CreateUserDeliveryTaskRequestSlsDelivery &&) = default ;
    ...
    inline CreateUserDeliveryTaskRequestSlsDelivery& setSLSLogStore(string SLSLogStore) { DARABONBA_PTR_SET_VALUE(SLSLogStore_, SLSLogStore) };
    ...
    inline CreateUserDeliveryTaskRequestSlsDelivery& setSLSProject(string SLSProject) { DARABONBA_PTR_SET_VALUE(SLSProject_, SLSProject) };
    ...
    inline CreateUserDeliveryTaskRequestSlsDelivery& setSLSRegion(string SLSRegion) { DARABONBA_PTR_SET_VALUE(SLSRegion_, SLSRegion) };
