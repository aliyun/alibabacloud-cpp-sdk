...
#ifndef ALIBABACLOUD_MODELS_GETRECORDRESPONSEBODYRECORDMODELDATA_HPP_
#define ALIBABACLOUD_MODELS_GETRECORDRESPONSEBODYRECORDMODELDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetRecordResponseBodyRecordModelData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetRecordResponseBodyRecordModelData& obj) { 
    ...
    GetRecordResponseBodyRecordModelData() = default ;
    GetRecordResponseBodyRecordModelData(const GetRecordResponseBodyRecordModelData &) = default ;
    GetRecordResponseBodyRecordModelData(GetRecordResponseBodyRecordModelData &&) = default ;
    GetRecordResponseBodyRecordModelData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetRecordResponseBodyRecordModelData() = default ;
    GetRecordResponseBodyRecordModelData& operator=(const GetRecordResponseBodyRecordModelData &) = default ;
    GetRecordResponseBodyRecordModelData& operator=(GetRecordResponseBodyRecordModelData &&) = default ;
    ...
    inline GetRecordResponseBodyRecordModelData& setAlgorithm(int32_t algorithm) { DARABONBA_PTR_SET_VALUE(algorithm_, algorithm) };
    ...
    inline GetRecordResponseBodyRecordModelData& setCertificate(string certificate) { DARABONBA_PTR_SET_VALUE(certificate_, certificate) };
    ...
    inline GetRecordResponseBodyRecordModelData& setFingerprint(string fingerprint) { DARABONBA_PTR_SET_VALUE(fingerprint_, fingerprint) };
    ...
    inline GetRecordResponseBodyRecordModelData& setFlag(int32_t flag) { DARABONBA_PTR_SET_VALUE(flag_, flag) };
    ...
    inline GetRecordResponseBodyRecordModelData& setKeyTag(int32_t keyTag) { DARABONBA_PTR_SET_VALUE(keyTag_, keyTag) };
    ...
    inline GetRecordResponseBodyRecordModelData& setMatchingType(int32_t matchingType) { DARABONBA_PTR_SET_VALUE(matchingType_, matchingType) };
    ...
    inline GetRecordResponseBodyRecordModelData& setPort(int32_t port) { DARABONBA_PTR_SET_VALUE(port_, port) };
    ...
    inline GetRecordResponseBodyRecordModelData& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline GetRecordResponseBodyRecordModelData& setSelector(int32_t selector) { DARABONBA_PTR_SET_VALUE(selector_, selector) };
    ...
    inline GetRecordResponseBodyRecordModelData& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    ...
    inline GetRecordResponseBodyRecordModelData& setTags(const Darabonba::Json & tags) { DARABONBA_SET_VALUE(tags_, tags) };
    inline GetRecordResponseBodyRecordModelData& setTags(Darabonba::Json & tags) { DARABONBA_SET_RVALUE(tags_, tags) };
    ...
    inline GetRecordResponseBodyRecordModelData& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline GetRecordResponseBodyRecordModelData& setUsage(int32_t usage) { DARABONBA_PTR_SET_VALUE(usage_, usage) };
    ...
    inline GetRecordResponseBodyRecordModelData& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
    ...
    inline GetRecordResponseBodyRecordModelData& setWeight(int32_t weight) { DARABONBA_PTR_SET_VALUE(weight_, weight) };
