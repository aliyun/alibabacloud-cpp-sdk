...
namespace Models
{
  ...
  public:
    ...
    inline const CheckSiteNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckSiteNameResponseBody) };
    inline CheckSiteNameResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckSiteNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckSiteNameResponseBody> body_ {};
  };
