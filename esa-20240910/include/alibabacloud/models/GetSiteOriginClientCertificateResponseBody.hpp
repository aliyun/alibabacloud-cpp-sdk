...
namespace Models
{
  ...
  public:
    ...
    inline const GetSiteOriginClientCertificateResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, GetSiteOriginClientCertificateResponseBody::Result) };
    inline GetSiteOriginClientCertificateResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, GetSiteOriginClientCertificateResponseBody::Result) };
    inline GetSiteOriginClientCertificateResponseBody& setResult(const GetSiteOriginClientCertificateResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetSiteOriginClientCertificateResponseBody& setResult(GetSiteOriginClientCertificateResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
