...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListEdgeContainerAppRecordsResponseBodyRecords> & records() const { DARABONBA_PTR_GET_CONST(records_, vector<ListEdgeContainerAppRecordsResponseBodyRecords>) };
    inline vector<ListEdgeContainerAppRecordsResponseBodyRecords> records() { DARABONBA_PTR_GET(records_, vector<ListEdgeContainerAppRecordsResponseBodyRecords>) };
    inline ListEdgeContainerAppRecordsResponseBody& setRecords(const vector<ListEdgeContainerAppRecordsResponseBodyRecords> & records) { DARABONBA_PTR_SET_VALUE(records_, records) };
    inline ListEdgeContainerAppRecordsResponseBody& setRecords(vector<ListEdgeContainerAppRecordsResponseBodyRecords> && records) { DARABONBA_PTR_SET_RVALUE(records_, records) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListEdgeContainerAppRecordsResponseBodyRecords>> records_ = nullptr;
    // The request ID.
