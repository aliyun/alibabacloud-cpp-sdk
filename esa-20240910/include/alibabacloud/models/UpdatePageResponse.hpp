...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePageResponseBody) };
    inline UpdatePageResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePageResponseBody> body_ {};
  };
