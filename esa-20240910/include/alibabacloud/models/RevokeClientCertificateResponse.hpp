...
namespace Models
{
  ...
  public:
    ...
    inline const RevokeClientCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RevokeClientCertificateResponseBody) };
    inline RevokeClientCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, RevokeClientCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RevokeClientCertificateResponseBody> body_ {};
  };
