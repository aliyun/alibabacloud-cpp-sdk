...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHttpRequestHeaderModificationRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHttpRequestHeaderModificationRuleResponseBody) };
    inline DeleteHttpRequestHeaderModificationRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHttpRequestHeaderModificationRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHttpRequestHeaderModificationRuleResponseBody> body_ {};
  };
