...
#ifndef ALIBABACLOUD_MODELS_LISTRECORDSRESPONSEBODYRECORDSDATA_HPP_
#define ALIBABACLOUD_MODELS_LISTRECORDSRESPONSEBODYRECORDSDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListRecordsResponseBodyRecordsData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListRecordsResponseBodyRecordsData& obj) { 
    ...
    ListRecordsResponseBodyRecordsData() = default ;
    ListRecordsResponseBodyRecordsData(const ListRecordsResponseBodyRecordsData &) = default ;
    ListRecordsResponseBodyRecordsData(ListRecordsResponseBodyRecordsData &&) = default ;
    ListRecordsResponseBodyRecordsData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListRecordsResponseBodyRecordsData() = default ;
    ListRecordsResponseBodyRecordsData& operator=(const ListRecordsResponseBodyRecordsData &) = default ;
    ListRecordsResponseBodyRecordsData& operator=(ListRecordsResponseBodyRecordsData &&) = default ;
    ...
    virtual bool empty() const override { return this->algorithm_ == nullptr
        ...
        && return this->port_ == nullptr && return this->priority_ == nullptr && return this->selector_ == nullptr && return this->tag_ == nullptr && return this->tags_ == nullptr
        && return this->type_ == nullptr && return this->usage_ == nullptr && return this->value_ == nullptr && return this->weight_ == nullptr; };
    // algorithm Field Functions 
    bool hasAlgorithm() const { return this->algorithm_ != nullptr;};
    void deleteAlgorithm() { this->algorithm_ = nullptr;};
    inline int32_t algorithm() const { DARABONBA_PTR_GET_DEFAULT(algorithm_, 0) };
    inline ListRecordsResponseBodyRecordsData& setAlgorithm(int32_t algorithm) { DARABONBA_PTR_SET_VALUE(algorithm_, algorithm) };
    ...
    inline ListRecordsResponseBodyRecordsData& setCertificate(string certificate) { DARABONBA_PTR_SET_VALUE(certificate_, certificate) };
    ...
    inline ListRecordsResponseBodyRecordsData& setFingerprint(string fingerprint) { DARABONBA_PTR_SET_VALUE(fingerprint_, fingerprint) };
    ...
    inline ListRecordsResponseBodyRecordsData& setFlag(int32_t flag) { DARABONBA_PTR_SET_VALUE(flag_, flag) };
    ...
    inline ListRecordsResponseBodyRecordsData& setKeyTag(int32_t keyTag) { DARABONBA_PTR_SET_VALUE(keyTag_, keyTag) };
    ...
    inline ListRecordsResponseBodyRecordsData& setMatchingType(int32_t matchingType) { DARABONBA_PTR_SET_VALUE(matchingType_, matchingType) };
    ...
    inline ListRecordsResponseBodyRecordsData& setPort(int32_t port) { DARABONBA_PTR_SET_VALUE(port_, port) };
    ...
    inline ListRecordsResponseBodyRecordsData& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline ListRecordsResponseBodyRecordsData& setSelector(int32_t selector) { DARABONBA_PTR_SET_VALUE(selector_, selector) };
    ...
    inline ListRecordsResponseBodyRecordsData& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline ListRecordsResponseBodyRecordsData& setUsage(int32_t usage) { DARABONBA_PTR_SET_VALUE(usage_, usage) };
    ...
    inline ListRecordsResponseBodyRecordsData& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
    ...
    inline ListRecordsResponseBodyRecordsData& setWeight(int32_t weight) { DARABONBA_PTR_SET_VALUE(weight_, weight) };
