...
#ifndef ALIBABACLOUD_MODELS_CREATERECORDREQUESTAUTHCONF_HPP_
#define ALIBABACLOUD_MODELS_CREATERECORDREQUESTAUTHCONF_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateRecordRequestAuthConf& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateRecordRequestAuthConf& obj) { 
    ...
    CreateRecordRequestAuthConf() = default ;
    CreateRecordRequestAuthConf(const CreateRecordRequestAuthConf &) = default ;
    CreateRecordRequestAuthConf(CreateRecordRequestAuthConf &&) = default ;
    CreateRecordRequestAuthConf(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateRecordRequestAuthConf() = default ;
    CreateRecordRequestAuthConf& operator=(const CreateRecordRequestAuthConf &) = default ;
    CreateRecordRequestAuthConf& operator=(CreateRecordRequestAuthConf &&) = default ;
    ...
    inline CreateRecordRequestAuthConf& setAccessKey(string accessKey) { DARABONBA_PTR_SET_VALUE(accessKey_, accessKey) };
    ...
    inline CreateRecordRequestAuthConf& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline CreateRecordRequestAuthConf& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
    ...
    inline CreateRecordRequestAuthConf& setSecretKey(string secretKey) { DARABONBA_PTR_SET_VALUE(secretKey_, secretKey) };
    ...
    inline CreateRecordRequestAuthConf& setVersion(string version) { DARABONBA_PTR_SET_VALUE(version_, version) };
