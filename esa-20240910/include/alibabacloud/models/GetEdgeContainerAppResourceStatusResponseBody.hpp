...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetEdgeContainerAppResourceStatusResponseBodyRegions> & regions() const { DARABONBA_PTR_GET_CONST(regions_, vector<GetEdgeContainerAppResourceStatusResponseBodyRegions>) };
    inline vector<GetEdgeContainerAppResourceStatusResponseBodyRegions> regions() { DARABONBA_PTR_GET(regions_, vector<GetEdgeContainerAppResourceStatusResponseBodyRegions>) };
    inline GetEdgeContainerAppResourceStatusResponseBody& setRegions(const vector<GetEdgeContainerAppResourceStatusResponseBodyRegions> & regions) { DARABONBA_PTR_SET_VALUE(regions_, regions) };
    inline GetEdgeContainerAppResourceStatusResponseBody& setRegions(vector<GetEdgeContainerAppResourceStatusResponseBodyRegions> && regions) { DARABONBA_PTR_SET_RVALUE(regions_, regions) };
