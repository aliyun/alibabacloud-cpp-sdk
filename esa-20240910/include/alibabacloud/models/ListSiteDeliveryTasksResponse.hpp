...
namespace Models
{
  ...
  public:
    ...
    inline const ListSiteDeliveryTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSiteDeliveryTasksResponseBody) };
    inline ListSiteDeliveryTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSiteDeliveryTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSiteDeliveryTasksResponseBody> body_ {};
  };
