...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLoadBalancerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLoadBalancerResponseBody) };
    inline DeleteLoadBalancerResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLoadBalancerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLoadBalancerResponseBody> body_ {};
  };
