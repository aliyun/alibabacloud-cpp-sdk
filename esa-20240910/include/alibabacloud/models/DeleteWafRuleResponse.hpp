...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWafRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWafRuleResponseBody) };
    inline DeleteWafRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWafRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWafRuleResponseBody> body_ {};
  };
