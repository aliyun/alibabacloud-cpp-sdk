...
#ifndef ALIBABACLOUD_MODELS_GETRECORDRESPONSEBODYRECORDMODELAUTHCONF_HPP_
#define ALIBABACLOUD_MODELS_GETRECORDRESPONSEBODYRECORDMODELAUTHCONF_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetRecordResponseBodyRecordModelAuthConf& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetRecordResponseBodyRecordModelAuthConf& obj) { 
    ...
    GetRecordResponseBodyRecordModelAuthConf() = default ;
    GetRecordResponseBodyRecordModelAuthConf(const GetRecordResponseBodyRecordModelAuthConf &) = default ;
    GetRecordResponseBodyRecordModelAuthConf(GetRecordResponseBodyRecordModelAuthConf &&) = default ;
    GetRecordResponseBodyRecordModelAuthConf(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetRecordResponseBodyRecordModelAuthConf() = default ;
    GetRecordResponseBodyRecordModelAuthConf& operator=(const GetRecordResponseBodyRecordModelAuthConf &) = default ;
    GetRecordResponseBodyRecordModelAuthConf& operator=(GetRecordResponseBodyRecordModelAuthConf &&) = default ;
    ...
    inline GetRecordResponseBodyRecordModelAuthConf& setAccessKey(string accessKey) { DARABONBA_PTR_SET_VALUE(accessKey_, accessKey) };
    ...
    inline GetRecordResponseBodyRecordModelAuthConf& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline GetRecordResponseBodyRecordModelAuthConf& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
    ...
    inline GetRecordResponseBodyRecordModelAuthConf& setSecretKey(string secretKey) { DARABONBA_PTR_SET_VALUE(secretKey_, secretKey) };
    ...
    inline GetRecordResponseBodyRecordModelAuthConf& setVersion(string version) { DARABONBA_PTR_SET_VALUE(version_, version) };
