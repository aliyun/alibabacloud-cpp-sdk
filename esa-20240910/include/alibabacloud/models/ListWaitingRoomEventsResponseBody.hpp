...
namespace Models
{
  ...
  public:
    ...
    class WaitingRoomEvents : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const WaitingRoomEvents& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, WaitingRoomEvents& obj) { 
      ...
      WaitingRoomEvents(const WaitingRoomEvents &) = default ;
      WaitingRoomEvents(WaitingRoomEvents &&) = default ;
      WaitingRoomEvents(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~WaitingRoomEvents() = default ;
      WaitingRoomEvents& operator=(const WaitingRoomEvents &) = default ;
      WaitingRoomEvents& operator=(WaitingRoomEvents &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->customPageHtml_ == nullptr
        ...
        && this->queuingMethod_ == nullptr && this->queuingStatusCode_ == nullptr && this->randomPreQueueEnable_ == nullptr && this->sessionDuration_ == nullptr && this->startTime_ == nullptr
        && this->totalActiveUsers_ == nullptr && this->waitingRoomEventId_ == nullptr && this->waitingRoomId_ == nullptr && this->waitingRoomType_ == nullptr; };
      ...
      inline WaitingRoomEvents& setCustomPageHtml(string customPageHtml) { DARABONBA_PTR_SET_VALUE(customPageHtml_, customPageHtml) };
      ...
      inline WaitingRoomEvents& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
      ...
      inline WaitingRoomEvents& setDisableSessionRenewalEnable(string disableSessionRenewalEnable) { DARABONBA_PTR_SET_VALUE(disableSessionRenewalEnable_, disableSessionRenewalEnable) };
      ...
      inline WaitingRoomEvents& setEnable(string enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };
      ...
      inline WaitingRoomEvents& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
      ...
      inline WaitingRoomEvents& setJsonResponseEnable(string jsonResponseEnable) { DARABONBA_PTR_SET_VALUE(jsonResponseEnable_, jsonResponseEnable) };
      ...
      inline WaitingRoomEvents& setLanguage(string language) { DARABONBA_PTR_SET_VALUE(language_, language) };
      ...
      inline WaitingRoomEvents& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
      ...
      inline WaitingRoomEvents& setNewUsersPerMinute(string newUsersPerMinute) { DARABONBA_PTR_SET_VALUE(newUsersPerMinute_, newUsersPerMinute) };
      ...
      inline WaitingRoomEvents& setPreQueueEnable(string preQueueEnable) { DARABONBA_PTR_SET_VALUE(preQueueEnable_, preQueueEnable) };
      ...
      inline WaitingRoomEvents& setPreQueueStartTime(string preQueueStartTime) { DARABONBA_PTR_SET_VALUE(preQueueStartTime_, preQueueStartTime) };
      ...
      inline WaitingRoomEvents& setQueuingMethod(string queuingMethod) { DARABONBA_PTR_SET_VALUE(queuingMethod_, queuingMethod) };
      ...
      inline WaitingRoomEvents& setQueuingStatusCode(string queuingStatusCode) { DARABONBA_PTR_SET_VALUE(queuingStatusCode_, queuingStatusCode) };
      ...
      inline WaitingRoomEvents& setRandomPreQueueEnable(string randomPreQueueEnable) { DARABONBA_PTR_SET_VALUE(randomPreQueueEnable_, randomPreQueueEnable) };
      ...
      inline WaitingRoomEvents& setSessionDuration(string sessionDuration) { DARABONBA_PTR_SET_VALUE(sessionDuration_, sessionDuration) };
      ...
      inline WaitingRoomEvents& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
      ...
      inline WaitingRoomEvents& setTotalActiveUsers(string totalActiveUsers) { DARABONBA_PTR_SET_VALUE(totalActiveUsers_, totalActiveUsers) };
      ...
      inline WaitingRoomEvents& setWaitingRoomEventId(int64_t waitingRoomEventId) { DARABONBA_PTR_SET_VALUE(waitingRoomEventId_, waitingRoomEventId) };
      ...
      inline WaitingRoomEvents& setWaitingRoomId(string waitingRoomId) { DARABONBA_PTR_SET_VALUE(waitingRoomId_, waitingRoomId) };
      ...
      inline WaitingRoomEvents& setWaitingRoomType(string waitingRoomType) { DARABONBA_PTR_SET_VALUE(waitingRoomType_, waitingRoomType) };
    ...
    inline const vector<ListWaitingRoomEventsResponseBody::WaitingRoomEvents> & getWaitingRoomEvents() const { DARABONBA_PTR_GET_CONST(waitingRoomEvents_, vector<ListWaitingRoomEventsResponseBody::WaitingRoomEvents>) };
    inline vector<ListWaitingRoomEventsResponseBody::WaitingRoomEvents> getWaitingRoomEvents() { DARABONBA_PTR_GET(waitingRoomEvents_, vector<ListWaitingRoomEventsResponseBody::WaitingRoomEvents>) };
    inline ListWaitingRoomEventsResponseBody& setWaitingRoomEvents(const vector<ListWaitingRoomEventsResponseBody::WaitingRoomEvents> & waitingRoomEvents) { DARABONBA_PTR_SET_VALUE(waitingRoomEvents_, waitingRoomEvents) };
    inline ListWaitingRoomEventsResponseBody& setWaitingRoomEvents(vector<ListWaitingRoomEventsResponseBody::WaitingRoomEvents> && waitingRoomEvents) { DARABONBA_PTR_SET_RVALUE(waitingRoomEvents_, waitingRoomEvents) };
  ...
  protected:
    ...
    shared_ptr<vector<ListWaitingRoomEventsResponseBody::WaitingRoomEvents>> waitingRoomEvents_ {};
  };
