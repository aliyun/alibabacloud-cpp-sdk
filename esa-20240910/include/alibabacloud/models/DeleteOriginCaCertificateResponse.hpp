...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteOriginCaCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteOriginCaCertificateResponseBody) };
    inline DeleteOriginCaCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteOriginCaCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteOriginCaCertificateResponseBody> body_ {};
  };
