...
namespace Models
{
  ...
  public:
    ...
    inline DeleteClientCertificateRequest& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DeleteClientCertificateRequest& setSiteId(int64_t siteId) { DARABONBA_PTR_SET_VALUE(siteId_, siteId) };
