...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHttpsBasicConfigurationsResponseBodyConfigs> & configs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListHttpsBasicConfigurationsResponseBodyConfigs>) };
    inline vector<ListHttpsBasicConfigurationsResponseBodyConfigs> configs() { DARABONBA_PTR_GET(configs_, vector<ListHttpsBasicConfigurationsResponseBodyConfigs>) };
    inline ListHttpsBasicConfigurationsResponseBody& setConfigs(const vector<ListHttpsBasicConfigurationsResponseBodyConfigs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListHttpsBasicConfigurationsResponseBody& setConfigs(vector<ListHttpsBasicConfigurationsResponseBodyConfigs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHttpsBasicConfigurationsResponseBodyConfigs>> configs_ = nullptr;
    // Current page number.
