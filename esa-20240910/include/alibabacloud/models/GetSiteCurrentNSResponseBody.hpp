...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getNSList() const { DARABONBA_PTR_GET_CONST(NSList_, vector<string>) };
    inline vector<string> getNSList() { DARABONBA_PTR_GET(NSList_, vector<string>) };
