...
namespace Models
{
  ...
  public:
    ...
    inline const BatchUpdateWafRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchUpdateWafRulesResponseBody) };
    inline BatchUpdateWafRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchUpdateWafRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchUpdateWafRulesResponseBody> body_ {};
  };
