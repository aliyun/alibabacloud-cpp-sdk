...
namespace Models
{
  ...
  public:
    ...
    inline const ActivateVersionManagementResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ActivateVersionManagementResponseBody) };
    inline ActivateVersionManagementResponseBody getBody() { DARABONBA_PTR_GET(body_, ActivateVersionManagementResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ActivateVersionManagementResponseBody> body_ {};
  };
