...
namespace Models
{
  ...
  public:
    ...
    inline const GetCertificateResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetCertificateResponseBodyResult) };
    inline GetCertificateResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetCertificateResponseBodyResult) };
    inline GetCertificateResponseBody& setResult(const GetCertificateResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetCertificateResponseBody& setResult(GetCertificateResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetCertificateResponseBodyResult> result_ = nullptr;
    // Site ID.
