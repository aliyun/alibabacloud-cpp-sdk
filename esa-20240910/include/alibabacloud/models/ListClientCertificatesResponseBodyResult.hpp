...
#ifndef ALIBABACLOUD_MODELS_LISTCLIENTCERTIFICATESRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_LISTCLIENTCERTIFICATESRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListClientCertificatesResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListClientCertificatesResponseBodyResult& obj) { 
    ...
    ListClientCertificatesResponseBodyResult() = default ;
    ListClientCertificatesResponseBodyResult(const ListClientCertificatesResponseBodyResult &) = default ;
    ListClientCertificatesResponseBodyResult(ListClientCertificatesResponseBodyResult &&) = default ;
    ListClientCertificatesResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListClientCertificatesResponseBodyResult() = default ;
    ListClientCertificatesResponseBodyResult& operator=(const ListClientCertificatesResponseBodyResult &) = default ;
    ListClientCertificatesResponseBodyResult& operator=(ListClientCertificatesResponseBodyResult &&) = default ;
    ...
    inline ListClientCertificatesResponseBodyResult& setCACertificateId(string CACertificateId) { DARABONBA_PTR_SET_VALUE(CACertificateId_, CACertificateId) };
    ...
    inline ListClientCertificatesResponseBodyResult& setCommonName(string commonName) { DARABONBA_PTR_SET_VALUE(commonName_, commonName) };
    ...
    inline ListClientCertificatesResponseBodyResult& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListClientCertificatesResponseBodyResult& setFingerprintSha256(string fingerprintSha256) { DARABONBA_PTR_SET_VALUE(fingerprintSha256_, fingerprintSha256) };
    ...
    inline ListClientCertificatesResponseBodyResult& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListClientCertificatesResponseBodyResult& setIssuer(string issuer) { DARABONBA_PTR_SET_VALUE(issuer_, issuer) };
    ...
    inline ListClientCertificatesResponseBodyResult& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListClientCertificatesResponseBodyResult& setNotAfter(string notAfter) { DARABONBA_PTR_SET_VALUE(notAfter_, notAfter) };
    ...
    inline ListClientCertificatesResponseBodyResult& setNotBefore(string notBefore) { DARABONBA_PTR_SET_VALUE(notBefore_, notBefore) };
    ...
    inline ListClientCertificatesResponseBodyResult& setPubkeyAlgorithm(string pubkeyAlgorithm) { DARABONBA_PTR_SET_VALUE(pubkeyAlgorithm_, pubkeyAlgorithm) };
    ...
    inline ListClientCertificatesResponseBodyResult& setSAN(string SAN) { DARABONBA_PTR_SET_VALUE(SAN_, SAN) };
    ...
    inline ListClientCertificatesResponseBodyResult& setSerialNumber(string serialNumber) { DARABONBA_PTR_SET_VALUE(serialNumber_, serialNumber) };
    ...
    inline ListClientCertificatesResponseBodyResult& setSignatureAlgorithm(string signatureAlgorithm) { DARABONBA_PTR_SET_VALUE(signatureAlgorithm_, signatureAlgorithm) };
    ...
    inline ListClientCertificatesResponseBodyResult& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListClientCertificatesResponseBodyResult& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline ListClientCertificatesResponseBodyResult& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
