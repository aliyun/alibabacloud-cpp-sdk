...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCacheRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCacheRuleResponseBody) };
    inline DeleteCacheRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCacheRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCacheRuleResponseBody> body_ {};
  };
