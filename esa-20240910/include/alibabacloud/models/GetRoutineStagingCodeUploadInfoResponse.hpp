...
namespace Models
{
  ...
  public:
    ...
    inline const GetRoutineStagingCodeUploadInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRoutineStagingCodeUploadInfoResponseBody) };
    inline GetRoutineStagingCodeUploadInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRoutineStagingCodeUploadInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRoutineStagingCodeUploadInfoResponseBody> body_ {};
  };
