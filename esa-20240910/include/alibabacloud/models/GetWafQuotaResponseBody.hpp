...
namespace Models
{
  ...
  public:
    ...
    inline const GetWafQuotaResponseBodyQuota & quota() const { DARABONBA_PTR_GET_CONST(quota_, GetWafQuotaResponseBodyQuota) };
    inline GetWafQuotaResponseBodyQuota quota() { DARABONBA_PTR_GET(quota_, GetWafQuotaResponseBodyQuota) };
    inline GetWafQuotaResponseBody& setQuota(const GetWafQuotaResponseBodyQuota & quota) { DARABONBA_PTR_SET_VALUE(quota_, quota) };
    inline GetWafQuotaResponseBody& setQuota(GetWafQuotaResponseBodyQuota && quota) { DARABONBA_PTR_SET_RVALUE(quota_, quota) };
  ...
  protected:
    ...
    std::shared_ptr<GetWafQuotaResponseBodyQuota> quota_ = nullptr;
    // Request ID.
