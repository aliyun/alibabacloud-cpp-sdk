...
namespace Models
{
  ...
  public:
    ...
    inline const GetKvResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetKvResponseBody) };
    inline GetKvResponseBody getBody() { DARABONBA_PTR_GET(body_, GetKvResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetKvResponseBody> body_ {};
  };
