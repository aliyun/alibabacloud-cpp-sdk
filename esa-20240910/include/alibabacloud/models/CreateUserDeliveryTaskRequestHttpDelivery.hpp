...
#ifndef ALIBABACLOUD_MODELS_CREATEUSERDELIVERYTASKREQUESTHTTPDELIVERY_HPP_
#define ALIBABACLOUD_MODELS_CREATEUSERDELIVERYTASKREQUESTHTTPDELIVERY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateUserDeliveryTaskRequestHttpDelivery& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateUserDeliveryTaskRequestHttpDelivery& obj) { 
    ...
    CreateUserDeliveryTaskRequestHttpDelivery() = default ;
    CreateUserDeliveryTaskRequestHttpDelivery(const CreateUserDeliveryTaskRequestHttpDelivery &) = default ;
    CreateUserDeliveryTaskRequestHttpDelivery(CreateUserDeliveryTaskRequestHttpDelivery &&) = default ;
    CreateUserDeliveryTaskRequestHttpDelivery(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateUserDeliveryTaskRequestHttpDelivery() = default ;
    CreateUserDeliveryTaskRequestHttpDelivery& operator=(const CreateUserDeliveryTaskRequestHttpDelivery &) = default ;
    CreateUserDeliveryTaskRequestHttpDelivery& operator=(CreateUserDeliveryTaskRequestHttpDelivery &&) = default ;
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setCompress(string compress) { DARABONBA_PTR_SET_VALUE(compress_, compress) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setDestUrl(string destUrl) { DARABONBA_PTR_SET_VALUE(destUrl_, destUrl) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setHeaderParam(const map<string, Models::HttpDeliveryHeaderParamValue> & headerParam) { DARABONBA_PTR_SET_VALUE(headerParam_, headerParam) };
    inline CreateUserDeliveryTaskRequestHttpDelivery& setHeaderParam(map<string, Models::HttpDeliveryHeaderParamValue> && headerParam) { DARABONBA_PTR_SET_RVALUE(headerParam_, headerParam) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setLastLogSplit(bool lastLogSplit) { DARABONBA_PTR_SET_VALUE(lastLogSplit_, lastLogSplit) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setLogBodyPrefix(string logBodyPrefix) { DARABONBA_PTR_SET_VALUE(logBodyPrefix_, logBodyPrefix) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setLogBodySuffix(string logBodySuffix) { DARABONBA_PTR_SET_VALUE(logBodySuffix_, logBodySuffix) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setLogSplit(bool logSplit) { DARABONBA_PTR_SET_VALUE(logSplit_, logSplit) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setLogSplitWords(string logSplitWords) { DARABONBA_PTR_SET_VALUE(logSplitWords_, logSplitWords) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setMaxBatchMB(int64_t maxBatchMB) { DARABONBA_PTR_SET_VALUE(maxBatchMB_, maxBatchMB) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setMaxBatchSize(int64_t maxBatchSize) { DARABONBA_PTR_SET_VALUE(maxBatchSize_, maxBatchSize) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setMaxRetry(int64_t maxRetry) { DARABONBA_PTR_SET_VALUE(maxRetry_, maxRetry) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setQueryParam(const map<string, Models::HttpDeliveryQueryParamValue> & queryParam) { DARABONBA_PTR_SET_VALUE(queryParam_, queryParam) };
    inline CreateUserDeliveryTaskRequestHttpDelivery& setQueryParam(map<string, Models::HttpDeliveryQueryParamValue> && queryParam) { DARABONBA_PTR_SET_RVALUE(queryParam_, queryParam) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setStandardAuthOn(bool standardAuthOn) { DARABONBA_PTR_SET_VALUE(standardAuthOn_, standardAuthOn) };
    ...
    inline const Models::CreateUserDeliveryTaskRequestHttpDeliveryStandardAuthParam & standardAuthParam() const { DARABONBA_PTR_GET_CONST(standardAuthParam_, Models::CreateUserDeliveryTaskRequestHttpDeliveryStandardAuthParam) };
    inline Models::CreateUserDeliveryTaskRequestHttpDeliveryStandardAuthParam standardAuthParam() { DARABONBA_PTR_GET(standardAuthParam_, Models::CreateUserDeliveryTaskRequestHttpDeliveryStandardAuthParam) };
    inline CreateUserDeliveryTaskRequestHttpDelivery& setStandardAuthParam(const Models::CreateUserDeliveryTaskRequestHttpDeliveryStandardAuthParam & standardAuthParam) { DARABONBA_PTR_SET_VALUE(standardAuthParam_, standardAuthParam) };
    inline CreateUserDeliveryTaskRequestHttpDelivery& setStandardAuthParam(Models::CreateUserDeliveryTaskRequestHttpDeliveryStandardAuthParam && standardAuthParam) { DARABONBA_PTR_SET_RVALUE(standardAuthParam_, standardAuthParam) };
    ...
    inline CreateUserDeliveryTaskRequestHttpDelivery& setTransformTimeout(int64_t transformTimeout) { DARABONBA_PTR_SET_VALUE(transformTimeout_, transformTimeout) };
  ...
  protected:
    ...
    std::shared_ptr<Models::CreateUserDeliveryTaskRequestHttpDeliveryStandardAuthParam> standardAuthParam_ = nullptr;
