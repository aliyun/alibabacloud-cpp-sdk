...
namespace Models
{
  ...
  public:
    ...
    inline const GetIPv6ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetIPv6ResponseBody) };
    inline GetIPv6ResponseBody getBody() { DARABONBA_PTR_GET(body_, GetIPv6ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetIPv6ResponseBody> body_ {};
  };
