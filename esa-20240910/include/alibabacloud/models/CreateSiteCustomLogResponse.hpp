...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSiteCustomLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSiteCustomLogResponseBody) };
    inline CreateSiteCustomLogResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSiteCustomLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSiteCustomLogResponseBody> body_ {};
  };
