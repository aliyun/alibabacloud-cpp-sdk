...
namespace Models
{
  ...
  public:
    ...
    inline const ListWafPhasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWafPhasesResponseBody) };
    inline ListWafPhasesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWafPhasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWafPhasesResponseBody> body_ {};
  };
