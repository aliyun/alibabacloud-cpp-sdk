...
#ifndef ALIBABACLOUD_MODELS_UPDATEROUTINEBUILDCONFIGURATIONSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEROUTINEBUILDCONFIGURATIONSHRINKREQUEST_HPP_
...
namespace Models
{
  class UpdateRoutineBuildConfigurationShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateRoutineBuildConfigurationShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateRoutineBuildConfigurationShrinkRequest& obj) { 
    ...
    UpdateRoutineBuildConfigurationShrinkRequest() = default ;
    UpdateRoutineBuildConfigurationShrinkRequest(const UpdateRoutineBuildConfigurationShrinkRequest &) = default ;
    UpdateRoutineBuildConfigurationShrinkRequest(UpdateRoutineBuildConfigurationShrinkRequest &&) = default ;
    UpdateRoutineBuildConfigurationShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateRoutineBuildConfigurationShrinkRequest() = default ;
    UpdateRoutineBuildConfigurationShrinkRequest& operator=(const UpdateRoutineBuildConfigurationShrinkRequest &) = default ;
    UpdateRoutineBuildConfigurationShrinkRequest& operator=(UpdateRoutineBuildConfigurationShrinkRequest &&) = default ;
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setAssetsDirectory(string assetsDirectory) { DARABONBA_PTR_SET_VALUE(assetsDirectory_, assetsDirectory) };
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setBuildBranches(string buildBranches) { DARABONBA_PTR_SET_VALUE(buildBranches_, buildBranches) };
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setBuildCommand(string buildCommand) { DARABONBA_PTR_SET_VALUE(buildCommand_, buildCommand) };
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setEnvironmentVariablesShrink(string environmentVariablesShrink) { DARABONBA_PTR_SET_VALUE(environmentVariablesShrink_, environmentVariablesShrink) };
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setInstallCommand(string installCommand) { DARABONBA_PTR_SET_VALUE(installCommand_, installCommand) };
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setIsPrivate(bool isPrivate) { DARABONBA_PTR_SET_VALUE(isPrivate_, isPrivate) };
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setNodeVersion(string nodeVersion) { DARABONBA_PTR_SET_VALUE(nodeVersion_, nodeVersion) };
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setProductionBranch(string productionBranch) { DARABONBA_PTR_SET_VALUE(productionBranch_, productionBranch) };
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setRepository(string repository) { DARABONBA_PTR_SET_VALUE(repository_, repository) };
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setRootDirectory(string rootDirectory) { DARABONBA_PTR_SET_VALUE(rootDirectory_, rootDirectory) };
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setRoutineEntry(string routineEntry) { DARABONBA_PTR_SET_VALUE(routineEntry_, routineEntry) };
    ...
    inline UpdateRoutineBuildConfigurationShrinkRequest& setRoutineName(string routineName) { DARABONBA_PTR_SET_VALUE(routineName_, routineName) };
