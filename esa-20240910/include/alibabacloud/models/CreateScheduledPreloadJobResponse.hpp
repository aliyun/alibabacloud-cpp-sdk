...
namespace Models
{
  ...
  public:
    ...
    inline const CreateScheduledPreloadJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateScheduledPreloadJobResponseBody) };
    inline CreateScheduledPreloadJobResponseBody body() { DARABONBA_PTR_GET(body_, CreateScheduledPreloadJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateScheduledPreloadJobResponseBody> body_ = nullptr;
  };
