...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateUserDeliveryTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateUserDeliveryTaskResponseBody) };
    inline UpdateUserDeliveryTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateUserDeliveryTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateUserDeliveryTaskResponseBody> body_ {};
  };
