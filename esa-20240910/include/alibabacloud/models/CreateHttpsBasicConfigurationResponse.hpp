...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHttpsBasicConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHttpsBasicConfigurationResponseBody) };
    inline CreateHttpsBasicConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHttpsBasicConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHttpsBasicConfigurationResponseBody> body_ {};
  };
