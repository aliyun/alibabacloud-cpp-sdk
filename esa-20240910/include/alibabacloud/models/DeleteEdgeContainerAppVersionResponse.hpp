...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEdgeContainerAppVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteEdgeContainerAppVersionResponseBody) };
    inline DeleteEdgeContainerAppVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteEdgeContainerAppVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteEdgeContainerAppVersionResponseBody> body_ {};
  };
