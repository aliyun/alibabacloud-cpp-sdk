...
namespace Models
{
  ...
  public:
    ...
    inline const ListESAIPInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListESAIPInfoResponseBody) };
    inline ListESAIPInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ListESAIPInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListESAIPInfoResponseBody> body_ {};
  };
