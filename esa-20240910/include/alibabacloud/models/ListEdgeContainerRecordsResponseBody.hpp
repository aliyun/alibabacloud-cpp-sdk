...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListEdgeContainerRecordsResponseBodyRecords> & records() const { DARABONBA_PTR_GET_CONST(records_, vector<ListEdgeContainerRecordsResponseBodyRecords>) };
    inline vector<ListEdgeContainerRecordsResponseBodyRecords> records() { DARABONBA_PTR_GET(records_, vector<ListEdgeContainerRecordsResponseBodyRecords>) };
    inline ListEdgeContainerRecordsResponseBody& setRecords(const vector<ListEdgeContainerRecordsResponseBodyRecords> & records) { DARABONBA_PTR_SET_VALUE(records_, records) };
    inline ListEdgeContainerRecordsResponseBody& setRecords(vector<ListEdgeContainerRecordsResponseBodyRecords> && records) { DARABONBA_PTR_SET_RVALUE(records_, records) };
  ...
  protected:
    ...
    // The records.
    std::shared_ptr<vector<ListEdgeContainerRecordsResponseBodyRecords>> records_ = nullptr;
    // Id of the request
