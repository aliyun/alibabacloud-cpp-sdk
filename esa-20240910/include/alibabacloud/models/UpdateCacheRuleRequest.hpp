...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->additionalCacheablePorts_ != nullptr
        ...
        && this->edgeStatusCodeCacheTtl_ != nullptr && this->includeCookie_ != nullptr && this->includeHeader_ != nullptr && this->queryString_ != nullptr && this->queryStringMode_ != nullptr
        && this->rule_ != nullptr && this->ruleEnable_ != nullptr && this->ruleName_ != nullptr && this->sequence_ != nullptr && this->serveStale_ != nullptr
        && this->siteId_ != nullptr && this->sortQueryStringForCache_ != nullptr && this->userDeviceType_ != nullptr && this->userGeo_ != nullptr && this->userLanguage_ != nullptr; };
