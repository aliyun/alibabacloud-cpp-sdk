...
#ifndef ALIBABACLOUD_MODELS_DESCRIBESITEWAFTOPDATARESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBESITEWAFTOPDATARESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeSiteWafTopDataResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeSiteWafTopDataResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeSiteWafTopDataResponseBody& obj) { 
    ...
    DescribeSiteWafTopDataResponseBody() = default ;
    DescribeSiteWafTopDataResponseBody(const DescribeSiteWafTopDataResponseBody &) = default ;
    DescribeSiteWafTopDataResponseBody(DescribeSiteWafTopDataResponseBody &&) = default ;
    DescribeSiteWafTopDataResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeSiteWafTopDataResponseBody() = default ;
    DescribeSiteWafTopDataResponseBody& operator=(const DescribeSiteWafTopDataResponseBody &) = default ;
    DescribeSiteWafTopDataResponseBody& operator=(DescribeSiteWafTopDataResponseBody &&) = default ;
    ...
    inline const vector<DescribeSiteWafTopDataResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeSiteWafTopDataResponseBody::Data>) };
    inline vector<DescribeSiteWafTopDataResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<DescribeSiteWafTopDataResponseBody::Data>) };
    inline DescribeSiteWafTopDataResponseBody& setData(const vector<DescribeSiteWafTopDataResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSiteWafTopDataResponseBody& setData(vector<DescribeSiteWafTopDataResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeSiteWafTopDataResponseBody& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline DescribeSiteWafTopDataResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeSiteWafTopDataResponseBody& setSamplingRate(float samplingRate) { DARABONBA_PTR_SET_VALUE(samplingRate_, samplingRate) };
    ...
    inline DescribeSiteWafTopDataResponseBody& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
