...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListVideoProcessingsResponseBodyConfigs> & configs() const { DARABONBA_PTR_GET_CONST(configs_, vector<ListVideoProcessingsResponseBodyConfigs>) };
    inline vector<ListVideoProcessingsResponseBodyConfigs> configs() { DARABONBA_PTR_GET(configs_, vector<ListVideoProcessingsResponseBodyConfigs>) };
    inline ListVideoProcessingsResponseBody& setConfigs(const vector<ListVideoProcessingsResponseBodyConfigs> & configs) { DARABONBA_PTR_SET_VALUE(configs_, configs) };
    inline ListVideoProcessingsResponseBody& setConfigs(vector<ListVideoProcessingsResponseBodyConfigs> && configs) { DARABONBA_PTR_SET_RVALUE(configs_, configs) };
  ...
  protected:
    // The configurations.
    std::shared_ptr<vector<ListVideoProcessingsResponseBodyConfigs>> configs_ = nullptr;
