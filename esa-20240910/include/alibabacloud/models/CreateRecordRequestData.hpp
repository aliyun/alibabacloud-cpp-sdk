...
#ifndef ALIBABACLOUD_MODELS_CREATERECORDREQUESTDATA_HPP_
#define ALIBABACLOUD_MODELS_CREATERECORDREQUESTDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateRecordRequestData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateRecordRequestData& obj) { 
    ...
    CreateRecordRequestData() = default ;
    CreateRecordRequestData(const CreateRecordRequestData &) = default ;
    CreateRecordRequestData(CreateRecordRequestData &&) = default ;
    CreateRecordRequestData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateRecordRequestData() = default ;
    CreateRecordRequestData& operator=(const CreateRecordRequestData &) = default ;
    CreateRecordRequestData& operator=(CreateRecordRequestData &&) = default ;
    ...
    inline CreateRecordRequestData& setAlgorithm(int32_t algorithm) { DARABONBA_PTR_SET_VALUE(algorithm_, algorithm) };
    ...
    inline CreateRecordRequestData& setCertificate(string certificate) { DARABONBA_PTR_SET_VALUE(certificate_, certificate) };
    ...
    inline CreateRecordRequestData& setFingerprint(string fingerprint) { DARABONBA_PTR_SET_VALUE(fingerprint_, fingerprint) };
    ...
    inline CreateRecordRequestData& setFlag(int32_t flag) { DARABONBA_PTR_SET_VALUE(flag_, flag) };
    ...
    inline CreateRecordRequestData& setKeyTag(int32_t keyTag) { DARABONBA_PTR_SET_VALUE(keyTag_, keyTag) };
    ...
    inline CreateRecordRequestData& setMatchingType(int32_t matchingType) { DARABONBA_PTR_SET_VALUE(matchingType_, matchingType) };
    ...
    inline CreateRecordRequestData& setPort(int32_t port) { DARABONBA_PTR_SET_VALUE(port_, port) };
    ...
    inline CreateRecordRequestData& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline CreateRecordRequestData& setSelector(int32_t selector) { DARABONBA_PTR_SET_VALUE(selector_, selector) };
    ...
    inline CreateRecordRequestData& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    ...
    inline CreateRecordRequestData& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline CreateRecordRequestData& setUsage(int32_t usage) { DARABONBA_PTR_SET_VALUE(usage_, usage) };
    ...
    inline CreateRecordRequestData& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
    ...
    inline CreateRecordRequestData& setWeight(int32_t weight) { DARABONBA_PTR_SET_VALUE(weight_, weight) };
