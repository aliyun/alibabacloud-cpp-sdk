...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDevelopmentModeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDevelopmentModeResponseBody) };
    inline UpdateDevelopmentModeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDevelopmentModeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDevelopmentModeResponseBody> body_ {};
  };
