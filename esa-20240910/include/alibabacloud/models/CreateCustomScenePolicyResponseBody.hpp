...
#ifndef ALIBABACLOUD_MODELS_CREATECUSTOMSCENEPOLICYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATECUSTOMSCENEPOLICYRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateCustomScenePolicyResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateCustomScenePolicyResponseBody& obj) { 
    ...
    CreateCustomScenePolicyResponseBody() = default ;
    CreateCustomScenePolicyResponseBody(const CreateCustomScenePolicyResponseBody &) = default ;
    CreateCustomScenePolicyResponseBody(CreateCustomScenePolicyResponseBody &&) = default ;
    CreateCustomScenePolicyResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateCustomScenePolicyResponseBody() = default ;
    CreateCustomScenePolicyResponseBody& operator=(const CreateCustomScenePolicyResponseBody &) = default ;
    CreateCustomScenePolicyResponseBody& operator=(CreateCustomScenePolicyResponseBody &&) = default ;
