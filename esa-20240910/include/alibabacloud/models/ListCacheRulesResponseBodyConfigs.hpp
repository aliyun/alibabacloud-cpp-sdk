...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->additionalCacheablePorts_ == nullptr
        ...
        && return this->queryStringMode_ == nullptr && return this->rule_ == nullptr && return this->ruleEnable_ == nullptr && return this->ruleName_ == nullptr && return this->sequence_ == nullptr
        && return this->serveStale_ == nullptr && return this->siteVersion_ == nullptr && return this->sortQueryStringForCache_ == nullptr && return this->userDeviceType_ == nullptr && return this->userGeo_ == nullptr
        && return this->userLanguage_ == nullptr; };
