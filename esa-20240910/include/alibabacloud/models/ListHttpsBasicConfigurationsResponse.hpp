...
namespace Models
{
  ...
  public:
    ...
    inline const ListHttpsBasicConfigurationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHttpsBasicConfigurationsResponseBody) };
    inline ListHttpsBasicConfigurationsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHttpsBasicConfigurationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHttpsBasicConfigurationsResponseBody> body_ {};
  };
