...
#ifndef ALIBABACLOUD_MODELS_LISTEDGECONTAINERAPPVERSIONSRESPONSEBODYVERSIONSCONTAINERSPROBECONTENT_HPP_
#define ALIBABACLOUD_MODELS_LISTEDGECONTAINERAPPVERSIONSRESPONSEBODYVERSIONSCONTAINERSPROBECONTENT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& obj) { 
    ...
    ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent() = default ;
    ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent(const ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent &) = default ;
    ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent(ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent &&) = default ;
    ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent() = default ;
    ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& operator=(const ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent &) = default ;
    ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& operator=(ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent &&) = default ;
    ...
    inline ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& setCommand(string command) { DARABONBA_PTR_SET_VALUE(command_, command) };
    ...
    inline ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& setFailureThreshold(int32_t failureThreshold) { DARABONBA_PTR_SET_VALUE(failureThreshold_, failureThreshold) };
    ...
    inline ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& setHost(string host) { DARABONBA_PTR_SET_VALUE(host_, host) };
    ...
    inline ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& setHttpHeaders(string httpHeaders) { DARABONBA_PTR_SET_VALUE(httpHeaders_, httpHeaders) };
    ...
    inline ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& setInitialDelaySeconds(int32_t initialDelaySeconds) { DARABONBA_PTR_SET_VALUE(initialDelaySeconds_, initialDelaySeconds) };
    ...
    inline ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& setPeriodSeconds(int32_t periodSeconds) { DARABONBA_PTR_SET_VALUE(periodSeconds_, periodSeconds) };
    ...
    inline ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& setPort(int32_t port) { DARABONBA_PTR_SET_VALUE(port_, port) };
    ...
    inline ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& setScheme(string scheme) { DARABONBA_PTR_SET_VALUE(scheme_, scheme) };
    ...
    inline ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& setSuccessThreshold(int32_t successThreshold) { DARABONBA_PTR_SET_VALUE(successThreshold_, successThreshold) };
    ...
    inline ListEdgeContainerAppVersionsResponseBodyVersionsContainersProbeContent& setTimeoutSeconds(int32_t timeoutSeconds) { DARABONBA_PTR_SET_VALUE(timeoutSeconds_, timeoutSeconds) };
