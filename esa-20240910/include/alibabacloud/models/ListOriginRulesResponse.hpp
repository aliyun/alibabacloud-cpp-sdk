...
namespace Models
{
  ...
  public:
    ...
    inline const ListOriginRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOriginRulesResponseBody) };
    inline ListOriginRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOriginRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOriginRulesResponseBody> body_ {};
  };
