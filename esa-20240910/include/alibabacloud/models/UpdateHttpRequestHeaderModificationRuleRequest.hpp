...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateHttpRequestHeaderModificationRuleRequest::RequestHeaderModification> & getRequestHeaderModification() const { DARABONBA_PTR_GET_CONST(requestHeaderModification_, vector<UpdateHttpRequestHeaderModificationRuleRequest::RequestHeaderModification>) };
    inline vector<UpdateHttpRequestHeaderModificationRuleRequest::RequestHeaderModification> getRequestHeaderModification() { DARABONBA_PTR_GET(requestHeaderModification_, vector<UpdateHttpRequestHeaderModificationRuleRequest::RequestHeaderModification>) };
    inline UpdateHttpRequestHeaderModificationRuleRequest& setRequestHeaderModification(const vector<UpdateHttpRequestHeaderModificationRuleRequest::RequestHeaderModification> & requestHeaderModification) { DARABONBA_PTR_SET_VALUE(requestHeaderModification_, requestHeaderModification) };
    inline UpdateHttpRequestHeaderModificationRuleRequest& setRequestHeaderModification(vector<UpdateHttpRequestHeaderModificationRuleRequest::RequestHeaderModification> && requestHeaderModification) { DARABONBA_PTR_SET_RVALUE(requestHeaderModification_, requestHeaderModification) };
