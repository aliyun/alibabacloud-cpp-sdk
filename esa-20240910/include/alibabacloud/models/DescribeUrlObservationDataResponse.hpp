...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUrlObservationDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUrlObservationDataResponseBody) };
    inline DescribeUrlObservationDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUrlObservationDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUrlObservationDataResponseBody> body_ {};
  };
