...
namespace Models
{
  ...
  public:
    ...
    inline const ListRoutineCanaryAreasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRoutineCanaryAreasResponseBody) };
    inline ListRoutineCanaryAreasResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRoutineCanaryAreasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRoutineCanaryAreasResponseBody> body_ {};
  };
