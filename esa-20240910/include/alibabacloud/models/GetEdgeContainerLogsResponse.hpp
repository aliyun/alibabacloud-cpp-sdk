...
namespace Models
{
  ...
  public:
    ...
    inline const GetEdgeContainerLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEdgeContainerLogsResponseBody) };
    inline GetEdgeContainerLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEdgeContainerLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEdgeContainerLogsResponseBody> body_ {};
  };
