...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->altSvc_ == nullptr
        ...
        && return this->httpsForceCode_ == nullptr && return this->httpsNoSniDeny_ == nullptr && return this->httpsSniVerify_ == nullptr && return this->httpsSniWhitelist_ == nullptr && return this->requestId_ == nullptr
