...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline App& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };
      ...
      inline App& setGatewayType(string gatewayType) { DARABONBA_PTR_SET_VALUE(gatewayType_, gatewayType) };


      // healthCheck Field Functions 
      bool hasHealthCheck() const { return this->healthCheck_ != nullptr;};
      void deleteHealthCheck() { this->healthCheck_ = nullptr;};
      inline const App::HealthCheck & getHealthCheck() const { DARABONBA_PTR_GET_CONST(healthCheck_, App::HealthCheck) };
      inline App::HealthCheck getHealthCheck() { DARABONBA_PTR_GET(healthCheck_, App::HealthCheck) };
      inline App& setHealthCheck(const App::HealthCheck & healthCheck) { DARABONBA_PTR_SET_VALUE(healthCheck_, healthCheck) };
      inline App& setHealthCheck(App::HealthCheck && healthCheck) { DARABONBA_PTR_SET_RVALUE(healthCheck_, healthCheck) };
      ...
      inline App& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
      ...
      inline App& setQuicCid(string quicCid) { DARABONBA_PTR_SET_VALUE(quicCid_, quicCid) };
      ...
      inline App& setRemarks(string remarks) { DARABONBA_PTR_SET_VALUE(remarks_, remarks) };
      ...
      inline App& setServicePort(int32_t servicePort) { DARABONBA_PTR_SET_VALUE(servicePort_, servicePort) };
      ...
      inline App& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
      ...
      inline App& setTargetPort(int32_t targetPort) { DARABONBA_PTR_SET_VALUE(targetPort_, targetPort) };
      ...
      inline App& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
      ...
      inline App& setVersionCount(int32_t versionCount) { DARABONBA_PTR_SET_VALUE(versionCount_, versionCount) };
    ...
    protected:
      ...
      shared_ptr<App::HealthCheck> healthCheck_ {};
    ...
    inline const GetEdgeContainerAppResponseBody::App & getApp() const { DARABONBA_PTR_GET_CONST(app_, GetEdgeContainerAppResponseBody::App) };
    inline GetEdgeContainerAppResponseBody::App getApp() { DARABONBA_PTR_GET(app_, GetEdgeContainerAppResponseBody::App) };
    inline GetEdgeContainerAppResponseBody& setApp(const GetEdgeContainerAppResponseBody::App & app) { DARABONBA_PTR_SET_VALUE(app_, app) };
    inline GetEdgeContainerAppResponseBody& setApp(GetEdgeContainerAppResponseBody::App && app) { DARABONBA_PTR_SET_RVALUE(app_, app) };
  ...
  protected:
    ...
    shared_ptr<GetEdgeContainerAppResponseBody::App> app_ {};
    // The request ID.
