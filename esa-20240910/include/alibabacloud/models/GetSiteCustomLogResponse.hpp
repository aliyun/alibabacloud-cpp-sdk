...
namespace Models
{
  ...
  public:
    ...
    inline const GetSiteCustomLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSiteCustomLogResponseBody) };
    inline GetSiteCustomLogResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSiteCustomLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSiteCustomLogResponseBody> body_ {};
  };
