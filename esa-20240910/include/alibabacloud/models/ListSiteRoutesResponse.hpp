...
namespace Models
{
  ...
  public:
    ...
    inline const ListSiteRoutesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSiteRoutesResponseBody) };
    inline ListSiteRoutesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSiteRoutesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSiteRoutesResponseBody> body_ {};
  };
