...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->isSubSite_ == nullptr && this->messeage_ == nullptr && this->passed_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline bool getIsSubSite() const { DARABONBA_PTR_GET_DEFAULT(isSubSite_, false) };
    ...
    inline string getMesseage() const { DARABONBA_PTR_GET_DEFAULT(messeage_, "") };
