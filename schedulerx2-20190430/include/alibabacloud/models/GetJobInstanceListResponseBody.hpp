...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      class JobInstanceDetails : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const JobInstanceDetails& obj) { 
        ...
        friend void from_json(const Darabonba::Json& j, JobInstanceDetails& obj) { 
        ...
        JobInstanceDetails() = default ;
        JobInstanceDetails(const JobInstanceDetails &) = default ;
        JobInstanceDetails(JobInstanceDetails &&) = default ;
        JobInstanceDetails(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~JobInstanceDetails() = default ;
        JobInstanceDetails& operator=(const JobInstanceDetails &) = default ;
        JobInstanceDetails& operator=(JobInstanceDetails &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        virtual bool empty() const override { return this->dataTime_ == nullptr
        && this->endTime_ == nullptr && this->executor_ == nullptr && this->instanceId_ == nullptr && this->jobId_ == nullptr && this->progress_ == nullptr
        && this->result_ == nullptr && this->scheduleTime_ == nullptr && this->startTime_ == nullptr && this->status_ == nullptr && this->timeType_ == nullptr
        && this->triggerType_ == nullptr && this->workAddr_ == nullptr; };
        ...
        inline JobInstanceDetails& setDataTime(string dataTime) { DARABONBA_PTR_SET_VALUE(dataTime_, dataTime) };
        ...
        inline JobInstanceDetails& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
        ...
        inline JobInstanceDetails& setExecutor(string executor) { DARABONBA_PTR_SET_VALUE(executor_, executor) };
        ...
        inline JobInstanceDetails& setInstanceId(int64_t instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
        ...
        inline JobInstanceDetails& setJobId(int64_t jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
        ...
        inline JobInstanceDetails& setProgress(string progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
        ...
        inline JobInstanceDetails& setResult(string result) { DARABONBA_PTR_SET_VALUE(result_, result) };
        ...
        inline JobInstanceDetails& setScheduleTime(string scheduleTime) { DARABONBA_PTR_SET_VALUE(scheduleTime_, scheduleTime) };
        ...
        inline JobInstanceDetails& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
        ...
        inline JobInstanceDetails& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
        ...
        inline JobInstanceDetails& setTimeType(int32_t timeType) { DARABONBA_PTR_SET_VALUE(timeType_, timeType) };
        ...
        inline JobInstanceDetails& setTriggerType(int32_t triggerType) { DARABONBA_PTR_SET_VALUE(triggerType_, triggerType) };
        ...
        inline JobInstanceDetails& setWorkAddr(string workAddr) { DARABONBA_PTR_SET_VALUE(workAddr_, workAddr) };
      ...
      inline const vector<Data::JobInstanceDetails> & getJobInstanceDetails() const { DARABONBA_PTR_GET_CONST(jobInstanceDetails_, vector<Data::JobInstanceDetails>) };
      inline vector<Data::JobInstanceDetails> getJobInstanceDetails() { DARABONBA_PTR_GET(jobInstanceDetails_, vector<Data::JobInstanceDetails>) };
      inline Data& setJobInstanceDetails(const vector<Data::JobInstanceDetails> & jobInstanceDetails) { DARABONBA_PTR_SET_VALUE(jobInstanceDetails_, jobInstanceDetails) };
      inline Data& setJobInstanceDetails(vector<Data::JobInstanceDetails> && jobInstanceDetails) { DARABONBA_PTR_SET_RVALUE(jobInstanceDetails_, jobInstanceDetails) };


    protected:
      // The details of the job instance.
      shared_ptr<vector<Data::JobInstanceDetails>> jobInstanceDetails_ {};
    };
    ...
    inline const GetJobInstanceListResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetJobInstanceListResponseBody::Data) };
    inline GetJobInstanceListResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetJobInstanceListResponseBody::Data) };
    inline GetJobInstanceListResponseBody& setData(const GetJobInstanceListResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetJobInstanceListResponseBody& setData(GetJobInstanceListResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<GetJobInstanceListResponseBody::Data> data_ {};
