...
namespace Models
{
  ...
  public:
    ...
    inline const BatchEnableJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchEnableJobsResponseBody) };
    inline BatchEnableJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchEnableJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchEnableJobsResponseBody> body_ {};
  };
