...
#ifndef ALIBABACLOUD_MODELS_LISTJOBSRESPONSEBODYDATAJOBS_HPP_
#define ALIBABACLOUD_MODELS_LISTJOBSRESPONSEBODYDATAJOBS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListJobsResponseBodyDataJobs& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListJobsResponseBodyDataJobs& obj) { 
    ...
    ListJobsResponseBodyDataJobs() = default ;
    ListJobsResponseBodyDataJobs(const ListJobsResponseBodyDataJobs &) = default ;
    ListJobsResponseBodyDataJobs(ListJobsResponseBodyDataJobs &&) = default ;
    ListJobsResponseBodyDataJobs(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListJobsResponseBodyDataJobs() = default ;
    ListJobsResponseBodyDataJobs& operator=(const ListJobsResponseBodyDataJobs &) = default ;
    ListJobsResponseBodyDataJobs& operator=(ListJobsResponseBodyDataJobs &&) = default ;
    ...
    inline ListJobsResponseBodyDataJobs& setAttemptInterval(int32_t attemptInterval) { DARABONBA_PTR_SET_VALUE(attemptInterval_, attemptInterval) };
    ...
    inline ListJobsResponseBodyDataJobs& setClassName(string className) { DARABONBA_PTR_SET_VALUE(className_, className) };
    ...
    inline ListJobsResponseBodyDataJobs& setContent(string content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    ...
    inline ListJobsResponseBodyDataJobs& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListJobsResponseBodyDataJobs& setExecuteMode(string executeMode) { DARABONBA_PTR_SET_VALUE(executeMode_, executeMode) };
    ...
    inline ListJobsResponseBodyDataJobs& setJarUrl(string jarUrl) { DARABONBA_PTR_SET_VALUE(jarUrl_, jarUrl) };
    ...
    inline ListJobsResponseBodyDataJobs& setJobId(int64_t jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline const Models::ListJobsResponseBodyDataJobsJobMonitorInfo & jobMonitorInfo() const { DARABONBA_PTR_GET_CONST(jobMonitorInfo_, Models::ListJobsResponseBodyDataJobsJobMonitorInfo) };
    inline Models::ListJobsResponseBodyDataJobsJobMonitorInfo jobMonitorInfo() { DARABONBA_PTR_GET(jobMonitorInfo_, Models::ListJobsResponseBodyDataJobsJobMonitorInfo) };
    inline ListJobsResponseBodyDataJobs& setJobMonitorInfo(const Models::ListJobsResponseBodyDataJobsJobMonitorInfo & jobMonitorInfo) { DARABONBA_PTR_SET_VALUE(jobMonitorInfo_, jobMonitorInfo) };
    inline ListJobsResponseBodyDataJobs& setJobMonitorInfo(Models::ListJobsResponseBodyDataJobsJobMonitorInfo && jobMonitorInfo) { DARABONBA_PTR_SET_RVALUE(jobMonitorInfo_, jobMonitorInfo) };
    ...
    inline ListJobsResponseBodyDataJobs& setJobType(string jobType) { DARABONBA_PTR_SET_VALUE(jobType_, jobType) };
    ...
    inline const Models::ListJobsResponseBodyDataJobsMapTaskXAttrs & mapTaskXAttrs() const { DARABONBA_PTR_GET_CONST(mapTaskXAttrs_, Models::ListJobsResponseBodyDataJobsMapTaskXAttrs) };
    inline Models::ListJobsResponseBodyDataJobsMapTaskXAttrs mapTaskXAttrs() { DARABONBA_PTR_GET(mapTaskXAttrs_, Models::ListJobsResponseBodyDataJobsMapTaskXAttrs) };
    inline ListJobsResponseBodyDataJobs& setMapTaskXAttrs(const Models::ListJobsResponseBodyDataJobsMapTaskXAttrs & mapTaskXAttrs) { DARABONBA_PTR_SET_VALUE(mapTaskXAttrs_, mapTaskXAttrs) };
    inline ListJobsResponseBodyDataJobs& setMapTaskXAttrs(Models::ListJobsResponseBodyDataJobsMapTaskXAttrs && mapTaskXAttrs) { DARABONBA_PTR_SET_RVALUE(mapTaskXAttrs_, mapTaskXAttrs) };
    ...
    inline ListJobsResponseBodyDataJobs& setMaxAttempt(int32_t maxAttempt) { DARABONBA_PTR_SET_VALUE(maxAttempt_, maxAttempt) };
    ...
    inline ListJobsResponseBodyDataJobs& setMaxConcurrency(string maxConcurrency) { DARABONBA_PTR_SET_VALUE(maxConcurrency_, maxConcurrency) };
    ...
    inline ListJobsResponseBodyDataJobs& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListJobsResponseBodyDataJobs& setParameters(string parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    ...
    inline ListJobsResponseBodyDataJobs& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline const Models::ListJobsResponseBodyDataJobsTimeConfig & timeConfig() const { DARABONBA_PTR_GET_CONST(timeConfig_, Models::ListJobsResponseBodyDataJobsTimeConfig) };
    inline Models::ListJobsResponseBodyDataJobsTimeConfig timeConfig() { DARABONBA_PTR_GET(timeConfig_, Models::ListJobsResponseBodyDataJobsTimeConfig) };
    inline ListJobsResponseBodyDataJobs& setTimeConfig(const Models::ListJobsResponseBodyDataJobsTimeConfig & timeConfig) { DARABONBA_PTR_SET_VALUE(timeConfig_, timeConfig) };
    inline ListJobsResponseBodyDataJobs& setTimeConfig(Models::ListJobsResponseBodyDataJobsTimeConfig && timeConfig) { DARABONBA_PTR_SET_RVALUE(timeConfig_, timeConfig) };
    ...
    inline ListJobsResponseBodyDataJobs& setXAttrs(string XAttrs) { DARABONBA_PTR_SET_VALUE(XAttrs_, XAttrs) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ListJobsResponseBodyDataJobsJobMonitorInfo> jobMonitorInfo_ = nullptr;
    // The type of the job.
    ...
    std::shared_ptr<Models::ListJobsResponseBodyDataJobsMapTaskXAttrs> mapTaskXAttrs_ = nullptr;
    ...
    std::shared_ptr<Models::ListJobsResponseBodyDataJobsTimeConfig> timeConfig_ = nullptr;
    // The extended fields.
