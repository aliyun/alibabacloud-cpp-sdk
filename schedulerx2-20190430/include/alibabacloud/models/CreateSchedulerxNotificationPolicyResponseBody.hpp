...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, CreateSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail) };
    inline CreateSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, CreateSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail) };
    inline CreateSchedulerxNotificationPolicyResponseBody& setAccessDeniedDetail(const CreateSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline CreateSchedulerxNotificationPolicyResponseBody& setAccessDeniedDetail(CreateSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
  ...
  protected:
    ...
    shared_ptr<CreateSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The status code.
