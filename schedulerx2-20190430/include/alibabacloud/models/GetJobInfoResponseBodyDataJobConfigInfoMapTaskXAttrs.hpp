...
#ifndef ALIBABACLOUD_MODELS_GETJOBINFORESPONSEBODYDATAJOBCONFIGINFOMAPTASKXATTRS_HPP_
#define ALIBABACLOUD_MODELS_GETJOBINFORESPONSEBODYDATAJOBCONFIGINFOMAPTASKXATTRS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs& obj) { 
    ...
    GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs() = default ;
    GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs(const GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs &) = default ;
    GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs(GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs &&) = default ;
    GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs() = default ;
    GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs& operator=(const GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs &) = default ;
    GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs& operator=(GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs &&) = default ;
    ...
    inline GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs& setConsumerSize(int32_t consumerSize) { DARABONBA_PTR_SET_VALUE(consumerSize_, consumerSize) };
    ...
    inline GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs& setDispatcherSize(int32_t dispatcherSize) { DARABONBA_PTR_SET_VALUE(dispatcherSize_, dispatcherSize) };
    ...
    inline GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs& setQueueSize(int32_t queueSize) { DARABONBA_PTR_SET_VALUE(queueSize_, queueSize) };
    ...
    inline GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs& setTaskAttemptInterval(int32_t taskAttemptInterval) { DARABONBA_PTR_SET_VALUE(taskAttemptInterval_, taskAttemptInterval) };
    ...
    inline GetJobInfoResponseBodyDataJobConfigInfoMapTaskXAttrs& setTaskMaxAttempt(int32_t taskMaxAttempt) { DARABONBA_PTR_SET_VALUE(taskMaxAttempt_, taskMaxAttempt) };
