...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAppGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateAppGroupResponseBodyData) };
    inline CreateAppGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateAppGroupResponseBodyData) };
    inline CreateAppGroupResponseBody& setData(const CreateAppGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateAppGroupResponseBody& setData(CreateAppGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateAppGroupResponseBodyData> data_ = nullptr;
