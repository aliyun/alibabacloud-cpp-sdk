...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->grantOption_ == nullptr
        && this->groupId_ == nullptr && this->namespace_ == nullptr && this->namespaceSource_ == nullptr && this->regionId_ == nullptr && this->userId_ == nullptr
    ...
    inline bool getGrantOption() const { DARABONBA_PTR_GET_DEFAULT(grantOption_, false) };
