...
namespace Models
{
  ...
  public:
    ...
    inline const ReadSchedulerxDesignateDetailResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, ReadSchedulerxDesignateDetailResponseBody::AccessDeniedDetail) };
    inline ReadSchedulerxDesignateDetailResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, ReadSchedulerxDesignateDetailResponseBody::AccessDeniedDetail) };
    inline ReadSchedulerxDesignateDetailResponseBody& setAccessDeniedDetail(const ReadSchedulerxDesignateDetailResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline ReadSchedulerxDesignateDetailResponseBody& setAccessDeniedDetail(ReadSchedulerxDesignateDetailResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline const ReadSchedulerxDesignateDetailResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ReadSchedulerxDesignateDetailResponseBody::Data) };
    inline ReadSchedulerxDesignateDetailResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ReadSchedulerxDesignateDetailResponseBody::Data) };
    inline ReadSchedulerxDesignateDetailResponseBody& setData(const ReadSchedulerxDesignateDetailResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ReadSchedulerxDesignateDetailResponseBody& setData(ReadSchedulerxDesignateDetailResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<ReadSchedulerxDesignateDetailResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // Th status code.
    shared_ptr<int32_t> code_ {};
    // *
    shared_ptr<ReadSchedulerxDesignateDetailResponseBody::Data> data_ {};
