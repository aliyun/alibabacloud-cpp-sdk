...
namespace Models
{
  ...
  public:
    ...
    inline const SetWfInstanceSuccessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetWfInstanceSuccessResponseBody) };
    inline SetWfInstanceSuccessResponseBody getBody() { DARABONBA_PTR_GET(body_, SetWfInstanceSuccessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetWfInstanceSuccessResponseBody> body_ {};
  };
