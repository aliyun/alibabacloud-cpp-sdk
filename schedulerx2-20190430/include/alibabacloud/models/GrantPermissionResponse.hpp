...
namespace Models
{
  ...
  public:
    ...
    inline const GrantPermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GrantPermissionResponseBody) };
    inline GrantPermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, GrantPermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GrantPermissionResponseBody> body_ {};
  };
