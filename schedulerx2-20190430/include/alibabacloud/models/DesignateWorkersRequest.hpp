...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->designateType_ == nullptr
        && this->groupId_ == nullptr && this->jobId_ == nullptr && this->labels_ == nullptr && this->namespace_ == nullptr && this->namespaceSource_ == nullptr
        && this->regionId_ == nullptr && this->transferable_ == nullptr && this->workers_ == nullptr; };
