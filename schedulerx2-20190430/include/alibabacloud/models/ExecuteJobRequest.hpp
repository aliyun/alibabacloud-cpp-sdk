...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->checkJobStatus_ == nullptr
        && this->designateType_ == nullptr && this->groupId_ == nullptr && this->instanceParameters_ == nullptr && this->jobId_ == nullptr && this->label_ == nullptr
        && this->namespace_ == nullptr && this->namespaceSource_ == nullptr && this->regionId_ == nullptr && this->worker_ == nullptr; };
    ...
    inline bool getCheckJobStatus() const { DARABONBA_PTR_GET_DEFAULT(checkJobStatus_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> checkJobStatus_ {};
