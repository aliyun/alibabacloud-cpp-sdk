...
namespace Models
{
  ...
  public:
    ...
    inline const ReadSchedulerxNotificationPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReadSchedulerxNotificationPolicyResponseBody) };
    inline ReadSchedulerxNotificationPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ReadSchedulerxNotificationPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReadSchedulerxNotificationPolicyResponseBody> body_ {};
  };
