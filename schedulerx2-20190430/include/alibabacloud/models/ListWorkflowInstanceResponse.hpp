...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkflowInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWorkflowInstanceResponseBody) };
    inline ListWorkflowInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWorkflowInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWorkflowInstanceResponseBody> body_ {};
  };
