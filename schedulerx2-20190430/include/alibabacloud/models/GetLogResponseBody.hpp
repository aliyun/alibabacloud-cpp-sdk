...
namespace Models
{
  ...
  public:
    ...
    inline const GetLogResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetLogResponseBodyData) };
    inline GetLogResponseBodyData data() { DARABONBA_PTR_GET(data_, GetLogResponseBodyData) };
    inline GetLogResponseBody& setData(const GetLogResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetLogResponseBody& setData(GetLogResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetLogResponseBodyData> data_ = nullptr;
