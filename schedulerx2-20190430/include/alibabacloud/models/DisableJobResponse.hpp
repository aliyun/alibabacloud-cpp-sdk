...
namespace Models
{
  ...
  public:
    ...
    inline const DisableJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableJobResponseBody) };
    inline DisableJobResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableJobResponseBody> body_ {};
  };
