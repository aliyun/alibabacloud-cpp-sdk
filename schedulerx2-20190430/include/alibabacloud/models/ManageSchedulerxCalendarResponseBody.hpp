...
namespace Models
{
  ...
  public:
    ...
    inline const ManageSchedulerxCalendarResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, ManageSchedulerxCalendarResponseBody::AccessDeniedDetail) };
    inline ManageSchedulerxCalendarResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, ManageSchedulerxCalendarResponseBody::AccessDeniedDetail) };
    inline ManageSchedulerxCalendarResponseBody& setAccessDeniedDetail(const ManageSchedulerxCalendarResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline ManageSchedulerxCalendarResponseBody& setAccessDeniedDetail(ManageSchedulerxCalendarResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
  ...
  protected:
    ...
    shared_ptr<ManageSchedulerxCalendarResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The status code.
