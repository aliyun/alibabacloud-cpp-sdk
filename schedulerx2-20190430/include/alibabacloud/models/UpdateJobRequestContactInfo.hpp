...
#ifndef ALIBABACLOUD_MODELS_UPDATEJOBREQUESTCONTACTINFO_HPP_
#define ALIBABACLOUD_MODELS_UPDATEJOBREQUESTCONTACTINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateJobRequestContactInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateJobRequestContactInfo& obj) { 
    ...
    UpdateJobRequestContactInfo() = default ;
    UpdateJobRequestContactInfo(const UpdateJobRequestContactInfo &) = default ;
    UpdateJobRequestContactInfo(UpdateJobRequestContactInfo &&) = default ;
    UpdateJobRequestContactInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateJobRequestContactInfo() = default ;
    UpdateJobRequestContactInfo& operator=(const UpdateJobRequestContactInfo &) = default ;
    UpdateJobRequestContactInfo& operator=(UpdateJobRequestContactInfo &&) = default ;
    ...
    inline UpdateJobRequestContactInfo& setDing(string ding) { DARABONBA_PTR_SET_VALUE(ding_, ding) };
    ...
    inline UpdateJobRequestContactInfo& setUserMail(string userMail) { DARABONBA_PTR_SET_VALUE(userMail_, userMail) };
    ...
    inline UpdateJobRequestContactInfo& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
    ...
    inline UpdateJobRequestContactInfo& setUserPhone(string userPhone) { DARABONBA_PTR_SET_VALUE(userPhone_, userPhone) };
