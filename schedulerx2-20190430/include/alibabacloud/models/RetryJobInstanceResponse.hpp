...
namespace Models
{
  ...
  public:
    ...
    inline const RetryJobInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RetryJobInstanceResponseBody) };
    inline RetryJobInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, RetryJobInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RetryJobInstanceResponseBody> body_ {};
  };
