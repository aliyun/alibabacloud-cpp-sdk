...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSchedulerxCalendarResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DeleteSchedulerxCalendarResponseBody::AccessDeniedDetail) };
    inline DeleteSchedulerxCalendarResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DeleteSchedulerxCalendarResponseBody::AccessDeniedDetail) };
    inline DeleteSchedulerxCalendarResponseBody& setAccessDeniedDetail(const DeleteSchedulerxCalendarResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DeleteSchedulerxCalendarResponseBody& setAccessDeniedDetail(DeleteSchedulerxCalendarResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
  ...
  protected:
    ...
    shared_ptr<DeleteSchedulerxCalendarResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The status code.
