...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ExecuteJobResponseBodyData) };
    inline ExecuteJobResponseBodyData data() { DARABONBA_PTR_GET(data_, ExecuteJobResponseBodyData) };
    inline ExecuteJobResponseBody& setData(const ExecuteJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ExecuteJobResponseBody& setData(ExecuteJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ExecuteJobResponseBodyData> data_ = nullptr;
