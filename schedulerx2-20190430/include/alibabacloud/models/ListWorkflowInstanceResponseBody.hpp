...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListWorkflowInstanceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListWorkflowInstanceResponseBody& obj) { 
    ...
    ListWorkflowInstanceResponseBody() = default ;
    ListWorkflowInstanceResponseBody(const ListWorkflowInstanceResponseBody &) = default ;
    ListWorkflowInstanceResponseBody(ListWorkflowInstanceResponseBody &&) = default ;
    ListWorkflowInstanceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListWorkflowInstanceResponseBody() = default ;
    ListWorkflowInstanceResponseBody& operator=(const ListWorkflowInstanceResponseBody &) = default ;
    ListWorkflowInstanceResponseBody& operator=(ListWorkflowInstanceResponseBody &&) = default ;
