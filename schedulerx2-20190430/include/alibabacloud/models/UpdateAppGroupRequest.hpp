...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appVersion_ == nullptr
        && this->description_ == nullptr && this->enableLog_ == nullptr && this->groupId_ == nullptr && this->maxConcurrency_ == nullptr && this->monitorConfigJson_ == nullptr
        && this->monitorContactsJson_ == nullptr && this->namespace_ == nullptr && this->notificationPolicyName_ == nullptr && this->regionId_ == nullptr; };
