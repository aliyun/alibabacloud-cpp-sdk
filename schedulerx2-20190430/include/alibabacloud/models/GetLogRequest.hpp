...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->endTimestamp_ == nullptr
        && this->groupId_ == nullptr && this->jobId_ == nullptr && this->jobInstanceId_ == nullptr && this->keyword_ == nullptr && this->line_ == nullptr
        && this->namespace_ == nullptr && this->namespaceSource_ == nullptr && this->offset_ == nullptr && this->regionId_ == nullptr && this->reverse_ == nullptr
    ...
    inline string getJobInstanceId() const { DARABONBA_PTR_GET_DEFAULT(jobInstanceId_, "") };
  ...
  protected:
    ...
    // The job instance ID.
    shared_ptr<string> jobInstanceId_ {};
    // The keyword.
