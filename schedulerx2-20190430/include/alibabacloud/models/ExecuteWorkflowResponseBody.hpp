...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteWorkflowResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ExecuteWorkflowResponseBodyData) };
    inline ExecuteWorkflowResponseBodyData data() { DARABONBA_PTR_GET(data_, ExecuteWorkflowResponseBodyData) };
    inline ExecuteWorkflowResponseBody& setData(const ExecuteWorkflowResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ExecuteWorkflowResponseBody& setData(ExecuteWorkflowResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ExecuteWorkflowResponseBodyData> data_ = nullptr;
