...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWorkflowDagResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateWorkflowDagResponseBody) };
    inline UpdateWorkflowDagResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateWorkflowDagResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateWorkflowDagResponseBody> body_ {};
  };
