...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSchedulerxCalendarResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSchedulerxCalendarResponseBody) };
    inline CreateSchedulerxCalendarResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSchedulerxCalendarResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSchedulerxCalendarResponseBody> body_ {};
  };
