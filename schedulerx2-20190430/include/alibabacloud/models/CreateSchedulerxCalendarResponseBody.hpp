...
#ifndef ALIBABACLOUD_MODELS_CREATESCHEDULERXCALENDARRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATESCHEDULERXCALENDARRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateSchedulerxCalendarResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateSchedulerxCalendarResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateSchedulerxCalendarResponseBody& obj) { 
    ...
    CreateSchedulerxCalendarResponseBody() = default ;
    CreateSchedulerxCalendarResponseBody(const CreateSchedulerxCalendarResponseBody &) = default ;
    CreateSchedulerxCalendarResponseBody(CreateSchedulerxCalendarResponseBody &&) = default ;
    CreateSchedulerxCalendarResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateSchedulerxCalendarResponseBody() = default ;
    CreateSchedulerxCalendarResponseBody& operator=(const CreateSchedulerxCalendarResponseBody &) = default ;
    CreateSchedulerxCalendarResponseBody& operator=(CreateSchedulerxCalendarResponseBody &&) = default ;
    ...
    inline const CreateSchedulerxCalendarResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, CreateSchedulerxCalendarResponseBody::AccessDeniedDetail) };
    inline CreateSchedulerxCalendarResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, CreateSchedulerxCalendarResponseBody::AccessDeniedDetail) };
    inline CreateSchedulerxCalendarResponseBody& setAccessDeniedDetail(const CreateSchedulerxCalendarResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline CreateSchedulerxCalendarResponseBody& setAccessDeniedDetail(CreateSchedulerxCalendarResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline CreateSchedulerxCalendarResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreateSchedulerxCalendarResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateSchedulerxCalendarResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateSchedulerxCalendarResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The access denial details.
    shared_ptr<CreateSchedulerxCalendarResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // Th status code.
