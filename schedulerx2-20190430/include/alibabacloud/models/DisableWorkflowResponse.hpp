...
namespace Models
{
  ...
  public:
    ...
    inline const DisableWorkflowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableWorkflowResponseBody) };
    inline DisableWorkflowResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableWorkflowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableWorkflowResponseBody> body_ {};
  };
