...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorkerListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetWorkerListResponseBody) };
    inline GetWorkerListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetWorkerListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetWorkerListResponseBody> body_ {};
  };
