...
namespace Models
{
  ...
  public:
    ...
    inline const BatchDisableJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchDisableJobsResponseBody) };
    inline BatchDisableJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchDisableJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchDisableJobsResponseBody> body_ {};
  };
