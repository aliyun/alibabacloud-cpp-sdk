...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->endTimestamp_ == nullptr
        && this->groupId_ == nullptr && this->jobId_ == nullptr && this->namespace_ == nullptr && this->namespaceSource_ == nullptr && this->pageNum_ == nullptr
        && this->pageSize_ == nullptr && this->regionId_ == nullptr && this->startTimestamp_ == nullptr && this->status_ == nullptr; };
