...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWorkflowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateWorkflowResponseBody) };
    inline CreateWorkflowResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateWorkflowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateWorkflowResponseBody> body_ {};
  };
