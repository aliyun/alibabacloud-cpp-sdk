...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorkflowInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetWorkflowInstanceResponseBodyData) };
    inline GetWorkflowInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, GetWorkflowInstanceResponseBodyData) };
    inline GetWorkflowInstanceResponseBody& setData(const GetWorkflowInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetWorkflowInstanceResponseBody& setData(GetWorkflowInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetWorkflowInstanceResponseBodyData> data_ = nullptr;
