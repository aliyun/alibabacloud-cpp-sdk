...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAppGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAppGroupResponseBody) };
    inline DeleteAppGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAppGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAppGroupResponseBody> body_ {};
  };
