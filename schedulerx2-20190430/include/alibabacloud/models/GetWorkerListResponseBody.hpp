...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorkerListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetWorkerListResponseBodyData) };
    inline GetWorkerListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetWorkerListResponseBodyData) };
    inline GetWorkerListResponseBody& setData(const GetWorkerListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetWorkerListResponseBody& setData(GetWorkerListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The job information.
    std::shared_ptr<GetWorkerListResponseBodyData> data_ = nullptr;
