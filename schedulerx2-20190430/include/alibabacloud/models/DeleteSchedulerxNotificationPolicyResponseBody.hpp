...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DeleteSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail) };
    inline DeleteSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DeleteSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail) };
    inline DeleteSchedulerxNotificationPolicyResponseBody& setAccessDeniedDetail(const DeleteSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DeleteSchedulerxNotificationPolicyResponseBody& setAccessDeniedDetail(DeleteSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
  ...
  protected:
    ...
    shared_ptr<DeleteSchedulerxNotificationPolicyResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The status code.
