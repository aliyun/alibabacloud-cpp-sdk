...
namespace Models
{
  class ReadSchedulerxCalendarResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ReadSchedulerxCalendarResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadSchedulerxCalendarResponseBody& obj) { 
    ...
    ReadSchedulerxCalendarResponseBody() = default ;
    ReadSchedulerxCalendarResponseBody(const ReadSchedulerxCalendarResponseBody &) = default ;
    ReadSchedulerxCalendarResponseBody(ReadSchedulerxCalendarResponseBody &&) = default ;
    ReadSchedulerxCalendarResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadSchedulerxCalendarResponseBody() = default ;
    ReadSchedulerxCalendarResponseBody& operator=(const ReadSchedulerxCalendarResponseBody &) = default ;
    ReadSchedulerxCalendarResponseBody& operator=(ReadSchedulerxCalendarResponseBody &&) = default ;
