...
namespace Models
{
  ...
  public:
    ...
    inline DeleteJobResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeleteJobResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DeleteJobResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
