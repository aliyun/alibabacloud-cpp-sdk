...
public:
  shared_ptr<vector<long>> jobIdList{};
  shared_ptr<string> namespaceSource{};
  shared_ptr<string> originalGroupId{};
  shared_ptr<string> originalNamespace{};
  shared_ptr<string> regionId{};
  ...
  explicit ManageSchedulerxJobSyncRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (originalGroupId) {
      res["OriginalGroupId"] = boost::any(*originalGroupId);
    }
    if (originalNamespace) {
      res["OriginalNamespace"] = boost::any(*originalNamespace);
    }
    if (regionId) {
      res["RegionId"] = boost::any(*regionId);
    }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("OriginalGroupId") != m.end() && !m["OriginalGroupId"].empty()) {
      originalGroupId = make_shared<string>(boost::any_cast<string>(m["OriginalGroupId"]));
    }
    if (m.find("OriginalNamespace") != m.end() && !m["OriginalNamespace"].empty()) {
      originalNamespace = make_shared<string>(boost::any_cast<string>(m["OriginalNamespace"]));
    }
    if (m.find("RegionId") != m.end() && !m["RegionId"].empty()) {
      regionId = make_shared<string>(boost::any_cast<string>(m["RegionId"]));
    }
...
public:
  shared_ptr<string> jobIdListShrink{};
  shared_ptr<string> namespaceSource{};
  shared_ptr<string> originalGroupId{};
  shared_ptr<string> originalNamespace{};
  shared_ptr<string> regionId{};
  ...
  explicit ManageSchedulerxJobSyncShrinkRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    map<string, boost::any> res;
    if (jobIdListShrink) {
      res["JobIdList"] = boost::any(*jobIdListShrink);
    }
    if (namespaceSource) {
      res["NamespaceSource"] = boost::any(*namespaceSource);
    }
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("JobIdList") != m.end() && !m["JobIdList"].empty()) {
      jobIdListShrink = make_shared<string>(boost::any_cast<string>(m["JobIdList"]));
    }
    if (m.find("NamespaceSource") != m.end() && !m["NamespaceSource"].empty()) {
      namespaceSource = make_shared<string>(boost::any_cast<string>(m["NamespaceSource"]));
    }
...
class ManageSchedulerxJobSyncResponseBody : public Darabonba::Model {
public:
  shared_ptr<long> code{};
  shared_ptr<string> message{};
  shared_ptr<string> requestId{};
  ...
  explicit ManageSchedulerxJobSyncResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~ManageSchedulerxJobSyncResponseBody() = default;
};
class ManageSchedulerxJobSyncResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<ManageSchedulerxJobSyncResponseBody> body{};

  ManageSchedulerxJobSyncResponse() {}

  explicit ManageSchedulerxJobSyncResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        ManageSchedulerxJobSyncResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<ManageSchedulerxJobSyncResponseBody>(model1);
      }
    }
  }


  virtual ~ManageSchedulerxJobSyncResponse() = default;
};
...
public:
  ...
  ManageSchedulerxJobSyncResponse manageSchedulerxJobSyncWithOptions(shared_ptr<ManageSchedulerxJobSyncRequest> tmpReq, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  ManageSchedulerxJobSyncResponse manageSchedulerxJobSync(shared_ptr<ManageSchedulerxJobSyncRequest> request);
