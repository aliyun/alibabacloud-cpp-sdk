...
namespace Models
{
  ...
  public:
    ...
    inline const RegisterMediaStreamResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RegisterMediaStreamResponseBody) };
    inline RegisterMediaStreamResponseBody getBody() { DARABONBA_PTR_GET(body_, RegisterMediaStreamResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RegisterMediaStreamResponseBody> body_ {};
  };
