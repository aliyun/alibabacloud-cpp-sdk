...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitMediaConvertJobResponseBody::Job & getJob() const { DARABONBA_PTR_GET_CONST(job_, SubmitMediaConvertJobResponseBody::Job) };
    inline SubmitMediaConvertJobResponseBody::Job getJob() { DARABONBA_PTR_GET(job_, SubmitMediaConvertJobResponseBody::Job) };
    inline SubmitMediaConvertJobResponseBody& setJob(const SubmitMediaConvertJobResponseBody::Job & job) { DARABONBA_PTR_SET_VALUE(job_, job) };
    inline SubmitMediaConvertJobResponseBody& setJob(SubmitMediaConvertJobResponseBody::Job && job) { DARABONBA_PTR_SET_RVALUE(job_, job) };
