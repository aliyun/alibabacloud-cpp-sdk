...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePlayListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePlayListResponseBody) };
    inline DescribePlayListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePlayListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePlayListResponseBody> body_ {};
  };
