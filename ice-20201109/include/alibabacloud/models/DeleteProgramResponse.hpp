...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteProgramResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteProgramResponseBody) };
    inline DeleteProgramResponseBody body() { DARABONBA_PTR_GET(body_, DeleteProgramResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteProgramResponseBody> body_ = nullptr;
  };
