...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->materialUrls_ != nullptr
    ...
    inline string materialUrls() const { DARABONBA_PTR_GET_DEFAULT(materialUrls_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> materialUrls_ = nullptr;
    // The request ID.
