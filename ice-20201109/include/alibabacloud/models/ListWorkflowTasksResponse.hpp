...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkflowTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWorkflowTasksResponseBody) };
    inline ListWorkflowTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWorkflowTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWorkflowTasksResponseBody> body_ {};
  };
