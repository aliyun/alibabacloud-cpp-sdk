...
#ifndef ALIBABACLOUD_MODELS_PROGRAM_HPP_
#define ALIBABACLOUD_MODELS_PROGRAM_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const Program& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, Program& obj) { 
    ...
    Program(const Darabonba::Json & obj) { from_json(obj, *this); };
    ...
    virtual bool empty() const override { return this->adBreaks_ == nullptr
        && return this->arn_ == nullptr && return this->channelName_ == nullptr && return this->clipRange_ == nullptr && return this->gmtCreate_ == nullptr && return this->gmtModified_ == nullptr
        && return this->programName_ == nullptr && return this->sourceLocationName_ == nullptr && return this->sourceName_ == nullptr && return this->sourceType_ == nullptr && return this->transition_ == nullptr; };
    // adBreaks Field Functions 
    bool hasAdBreaks() const { return this->adBreaks_ != nullptr;};
    void deleteAdBreaks() { this->adBreaks_ = nullptr;};
    inline const vector<ProgramAdBreaks> & adBreaks() const { DARABONBA_PTR_GET_CONST(adBreaks_, vector<ProgramAdBreaks>) };
    inline vector<ProgramAdBreaks> adBreaks() { DARABONBA_PTR_GET(adBreaks_, vector<ProgramAdBreaks>) };
    inline Program& setAdBreaks(const vector<ProgramAdBreaks> & adBreaks) { DARABONBA_PTR_SET_VALUE(adBreaks_, adBreaks) };
    inline Program& setAdBreaks(vector<ProgramAdBreaks> && adBreaks) { DARABONBA_PTR_SET_RVALUE(adBreaks_, adBreaks) };
    ...
    inline Program& setArn(string arn) { DARABONBA_PTR_SET_VALUE(arn_, arn) };
    ...
    inline Program& setChannelName(string channelName) { DARABONBA_PTR_SET_VALUE(channelName_, channelName) };
    ...
    inline Program& setClipRange(string clipRange) { DARABONBA_PTR_SET_VALUE(clipRange_, clipRange) };
    ...
    inline Program& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline Program& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline Program& setProgramName(string programName) { DARABONBA_PTR_SET_VALUE(programName_, programName) };
    ...
    inline Program& setSourceLocationName(string sourceLocationName) { DARABONBA_PTR_SET_VALUE(sourceLocationName_, sourceLocationName) };
    ...
    inline Program& setSourceName(string sourceName) { DARABONBA_PTR_SET_VALUE(sourceName_, sourceName) };
    ...
    inline Program& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline Program& setTransition(string transition) { DARABONBA_PTR_SET_VALUE(transition_, transition) };


  protected:
    std::shared_ptr<vector<ProgramAdBreaks>> adBreaks_ = nullptr;
