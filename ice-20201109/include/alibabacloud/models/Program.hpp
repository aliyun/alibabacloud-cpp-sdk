...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Program::AdBreaks> & getAdBreaks() const { DARABONBA_PTR_GET_CONST(adBreaks_, vector<Program::AdBreaks>) };
    inline vector<Program::AdBreaks> getAdBreaks() { DARABONBA_PTR_GET(adBreaks_, vector<Program::AdBreaks>) };
    inline Program& setAdBreaks(const vector<Program::AdBreaks> & adBreaks) { DARABONBA_PTR_SET_VALUE(adBreaks_, adBreaks) };
    inline Program& setAdBreaks(vector<Program::AdBreaks> && adBreaks) { DARABONBA_PTR_SET_RVALUE(adBreaks_, adBreaks) };
