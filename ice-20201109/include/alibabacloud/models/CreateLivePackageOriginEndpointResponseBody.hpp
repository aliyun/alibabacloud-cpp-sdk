...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint & getLivePackageOriginEndpoint() const { DARABONBA_PTR_GET_CONST(livePackageOriginEndpoint_, CreateLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint) };
    inline CreateLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint getLivePackageOriginEndpoint() { DARABONBA_PTR_GET(livePackageOriginEndpoint_, CreateLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint) };
    inline CreateLivePackageOriginEndpointResponseBody& setLivePackageOriginEndpoint(const CreateLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint & livePackageOriginEndpoint) { DARABONBA_PTR_SET_VALUE(livePackageOriginEndpoint_, livePackageOriginEndpoint) };
    inline CreateLivePackageOriginEndpointResponseBody& setLivePackageOriginEndpoint(CreateLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint && livePackageOriginEndpoint) { DARABONBA_PTR_SET_RVALUE(livePackageOriginEndpoint_, livePackageOriginEndpoint) };
