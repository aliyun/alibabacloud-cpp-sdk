...
namespace Models
{
  ...
  public:
    ...
    inline const ListLiveRecordFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLiveRecordFilesResponseBody) };
    inline ListLiveRecordFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLiveRecordFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLiveRecordFilesResponseBody> body_ {};
  };
