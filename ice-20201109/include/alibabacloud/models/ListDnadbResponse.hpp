...
namespace Models
{
  ...
  public:
    ...
    inline const ListDNADBResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDNADBResponseBody) };
    inline ListDNADBResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDNADBResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDNADBResponseBody> body_ {};
  };
