...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMediaMarksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMediaMarksResponseBody) };
    inline DeleteMediaMarksResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMediaMarksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMediaMarksResponseBody> body_ {};
  };
