...
namespace Models
{
  ...
  public:
    ...
    inline const ListLiveRecordTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLiveRecordTemplatesResponseBody) };
    inline ListLiveRecordTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLiveRecordTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLiveRecordTemplatesResponseBody> body_ {};
  };
