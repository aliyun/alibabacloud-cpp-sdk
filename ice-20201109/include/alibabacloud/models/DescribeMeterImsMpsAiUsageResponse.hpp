...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMeterImsMpsAiUsageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMeterImsMpsAiUsageResponseBody) };
    inline DescribeMeterImsMpsAiUsageResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMeterImsMpsAiUsageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMeterImsMpsAiUsageResponseBody> body_ {};
  };
