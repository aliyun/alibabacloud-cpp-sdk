...
#ifndef ALIBABACLOUD_MODELS_PROGRAMADBREAKS_HPP_
#define ALIBABACLOUD_MODELS_PROGRAMADBREAKS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ProgramAdBreaks& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ProgramAdBreaks& obj) { 
    ...
    ProgramAdBreaks() = default ;
    ProgramAdBreaks(const ProgramAdBreaks &) = default ;
    ProgramAdBreaks(ProgramAdBreaks &&) = default ;
    ProgramAdBreaks(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ProgramAdBreaks() = default ;
    ProgramAdBreaks& operator=(const ProgramAdBreaks &) = default ;
    ProgramAdBreaks& operator=(ProgramAdBreaks &&) = default ;
    ...
    inline ProgramAdBreaks& setChannelName(string channelName) { DARABONBA_PTR_SET_VALUE(channelName_, channelName) };
    ...
    inline ProgramAdBreaks& setMessageType(string messageType) { DARABONBA_PTR_SET_VALUE(messageType_, messageType) };
    ...
    inline ProgramAdBreaks& setOffsetMillis(int64_t offsetMillis) { DARABONBA_PTR_SET_VALUE(offsetMillis_, offsetMillis) };
    ...
    inline ProgramAdBreaks& setProgramName(string programName) { DARABONBA_PTR_SET_VALUE(programName_, programName) };
    ...
    inline ProgramAdBreaks& setSourceLocationName(string sourceLocationName) { DARABONBA_PTR_SET_VALUE(sourceLocationName_, sourceLocationName) };
    ...
    inline ProgramAdBreaks& setSourceName(string sourceName) { DARABONBA_PTR_SET_VALUE(sourceName_, sourceName) };
    ...
    inline ProgramAdBreaks& setSpliceInsertSettings(string spliceInsertSettings) { DARABONBA_PTR_SET_VALUE(spliceInsertSettings_, spliceInsertSettings) };
    ...
    inline ProgramAdBreaks& setTimeSignalSettings(string timeSignalSettings) { DARABONBA_PTR_SET_VALUE(timeSignalSettings_, timeSignalSettings) };
