...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->completeTime_ == nullptr
        && return this->creationTime_ == nullptr && return this->errorCode_ == nullptr && return this->errorMessage_ == nullptr && return this->fileSize_ == nullptr && return this->jobId_ == nullptr
        && return this->mediaId_ == nullptr && return this->status_ == nullptr && return this->uploadURL_ == nullptr && return this->userData_ == nullptr; };
