...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ChannelAssemblyProgram> & getPrograms() const { DARABONBA_PTR_GET_CONST(programs_, vector<ChannelAssemblyProgram>) };
    inline vector<ChannelAssemblyProgram> getPrograms() { DARABONBA_PTR_GET(programs_, vector<ChannelAssemblyProgram>) };
  ...
  protected:
    ...
    // The programs.
    shared_ptr<vector<ChannelAssemblyProgram>> programs_ {};
    // **Request ID**
