...
namespace Models
{
  ...
  public:
    ...
    inline const AddMediaConnectFlowInputResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, AddMediaConnectFlowInputResponseBody::Content) };
    inline AddMediaConnectFlowInputResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, AddMediaConnectFlowInputResponseBody::Content) };
    inline AddMediaConnectFlowInputResponseBody& setContent(const AddMediaConnectFlowInputResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline AddMediaConnectFlowInputResponseBody& setContent(AddMediaConnectFlowInputResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
