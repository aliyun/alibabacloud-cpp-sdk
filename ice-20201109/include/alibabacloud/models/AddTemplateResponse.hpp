...
namespace Models
{
  ...
  public:
    ...
    inline const AddTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddTemplateResponseBody) };
    inline AddTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, AddTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddTemplateResponseBody> body_ {};
  };
