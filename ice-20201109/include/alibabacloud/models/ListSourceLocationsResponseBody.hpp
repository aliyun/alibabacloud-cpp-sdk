...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNo_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->sourceLocationList_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const vector<ChannelAssemblySourceLocation> & sourceLocationList() const { DARABONBA_PTR_GET_CONST(sourceLocationList_, vector<ChannelAssemblySourceLocation>) };
    inline vector<ChannelAssemblySourceLocation> sourceLocationList() { DARABONBA_PTR_GET(sourceLocationList_, vector<ChannelAssemblySourceLocation>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ChannelAssemblySourceLocation>> sourceLocationList_ = nullptr;
