...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->createTime_ == nullptr && return this->finishTime_ == nullptr && return this->message_ == nullptr && return this->name_ == nullptr && return this->outputs_ == nullptr
    ...
    inline const vector<MediaConvertOutputDetail> & outputs() const { DARABONBA_PTR_GET_CONST(outputs_, vector<MediaConvertOutputDetail>) };
    inline vector<MediaConvertOutputDetail> outputs() { DARABONBA_PTR_GET(outputs_, vector<MediaConvertOutputDetail>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<MediaConvertOutputDetail>> outputs_ = nullptr;
