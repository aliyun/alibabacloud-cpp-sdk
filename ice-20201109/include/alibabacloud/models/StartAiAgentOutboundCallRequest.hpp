...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AIAgentId_ == nullptr
        && this->calledNumber_ == nullptr && this->callerNumber_ == nullptr && this->config_ == nullptr && this->imsAIAgentFreeObCall_ == nullptr && this->sessionId_ == nullptr
    ...
    inline const AIAgentOutboundCallConfig & getConfig() const { DARABONBA_PTR_GET_CONST(config_, AIAgentOutboundCallConfig) };
    inline AIAgentOutboundCallConfig getConfig() { DARABONBA_PTR_GET(config_, AIAgentOutboundCallConfig) };
    ...
    inline string getImsAIAgentFreeObCall() const { DARABONBA_PTR_GET_DEFAULT(imsAIAgentFreeObCall_, "") };
  ...
  protected:
    ...
    shared_ptr<AIAgentOutboundCallConfig> config_ {};
