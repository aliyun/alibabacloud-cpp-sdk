...
namespace Models
{
  ...
  public:
    ...
    inline const GetTranscodeJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetTranscodeJobResponseBody) };
    inline GetTranscodeJobResponseBody body() { DARABONBA_PTR_GET(body_, GetTranscodeJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetTranscodeJobResponseBody> body_ = nullptr;
  };
