...
namespace Models
{
  ...
  public:
    ...
    inline AIAgentOutboundCallConfigLlmConfig& setHistorySyncWithTTS(bool historySyncWithTTS) { DARABONBA_PTR_SET_VALUE(historySyncWithTTS_, historySyncWithTTS) };
