...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->assetName_ == nullptr
        && return this->contentId_ == nullptr && return this->createTime_ == nullptr && return this->egressEndpoints_ == nullptr && return this->groupName_ == nullptr && return this->input_ == nullptr; };
