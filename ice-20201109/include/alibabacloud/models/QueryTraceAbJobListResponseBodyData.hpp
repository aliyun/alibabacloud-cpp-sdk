...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->gmtCreate_ == nullptr
        && return this->gmtModified_ == nullptr && return this->input_ == nullptr && return this->jobId_ == nullptr && return this->level_ == nullptr && return this->output_ == nullptr
        && return this->result_ == nullptr && return this->status_ == nullptr && return this->traceMediaId_ == nullptr && return this->userData_ == nullptr && return this->userId_ == nullptr; };
