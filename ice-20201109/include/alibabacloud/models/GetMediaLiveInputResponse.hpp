...
namespace Models
{
  ...
  public:
    ...
    inline const GetMediaLiveInputResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMediaLiveInputResponseBody) };
    inline GetMediaLiveInputResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMediaLiveInputResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMediaLiveInputResponseBody> body_ {};
  };
