...
#ifndef ALIBABACLOUD_MODELS_CHANNELASSEMBLYSCHEDULEDATAADBREAKS_HPP_
#define ALIBABACLOUD_MODELS_CHANNELASSEMBLYSCHEDULEDATAADBREAKS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChannelAssemblyScheduleDataAdBreaks& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChannelAssemblyScheduleDataAdBreaks& obj) { 
    ...
    ChannelAssemblyScheduleDataAdBreaks() = default ;
    ChannelAssemblyScheduleDataAdBreaks(const ChannelAssemblyScheduleDataAdBreaks &) = default ;
    ChannelAssemblyScheduleDataAdBreaks(ChannelAssemblyScheduleDataAdBreaks &&) = default ;
    ChannelAssemblyScheduleDataAdBreaks(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChannelAssemblyScheduleDataAdBreaks() = default ;
    ChannelAssemblyScheduleDataAdBreaks& operator=(const ChannelAssemblyScheduleDataAdBreaks &) = default ;
    ChannelAssemblyScheduleDataAdBreaks& operator=(ChannelAssemblyScheduleDataAdBreaks &&) = default ;
    ...
    inline ChannelAssemblyScheduleDataAdBreaks& setMessageType(string messageType) { DARABONBA_PTR_SET_VALUE(messageType_, messageType) };
    ...
    inline ChannelAssemblyScheduleDataAdBreaks& setOffsetMillis(string offsetMillis) { DARABONBA_PTR_SET_VALUE(offsetMillis_, offsetMillis) };
    ...
    inline ChannelAssemblyScheduleDataAdBreaks& setSourceLocationName(string sourceLocationName) { DARABONBA_PTR_SET_VALUE(sourceLocationName_, sourceLocationName) };
    ...
    inline ChannelAssemblyScheduleDataAdBreaks& setSourceName(string sourceName) { DARABONBA_PTR_SET_VALUE(sourceName_, sourceName) };
    ...
    inline ChannelAssemblyScheduleDataAdBreaks& setSpliceInsertSettings(string spliceInsertSettings) { DARABONBA_PTR_SET_VALUE(spliceInsertSettings_, spliceInsertSettings) };
    ...
    inline ChannelAssemblyScheduleDataAdBreaks& setTimeSignalSettings(string timeSignalSettings) { DARABONBA_PTR_SET_VALUE(timeSignalSettings_, timeSignalSettings) };
