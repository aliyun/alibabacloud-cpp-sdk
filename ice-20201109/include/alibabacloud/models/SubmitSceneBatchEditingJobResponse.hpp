...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitSceneBatchEditingJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitSceneBatchEditingJobResponseBody) };
    inline SubmitSceneBatchEditingJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitSceneBatchEditingJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitSceneBatchEditingJobResponseBody> body_ {};
  };
