...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNo_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->sortBy_ == nullptr && return this->templateList_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const vector<ListLiveSnapshotTemplatesResponseBodyTemplateList> & templateList() const { DARABONBA_PTR_GET_CONST(templateList_, vector<ListLiveSnapshotTemplatesResponseBodyTemplateList>) };
    inline vector<ListLiveSnapshotTemplatesResponseBodyTemplateList> templateList() { DARABONBA_PTR_GET(templateList_, vector<ListLiveSnapshotTemplatesResponseBodyTemplateList>) };
    inline ListLiveSnapshotTemplatesResponseBody& setTemplateList(const vector<ListLiveSnapshotTemplatesResponseBodyTemplateList> & templateList) { DARABONBA_PTR_SET_VALUE(templateList_, templateList) };
    inline ListLiveSnapshotTemplatesResponseBody& setTemplateList(vector<ListLiveSnapshotTemplatesResponseBodyTemplateList> && templateList) { DARABONBA_PTR_SET_RVALUE(templateList_, templateList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListLiveSnapshotTemplatesResponseBodyTemplateList>> templateList_ = nullptr;
