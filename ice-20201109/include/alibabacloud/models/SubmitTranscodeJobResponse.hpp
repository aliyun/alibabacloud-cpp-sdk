...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitTranscodeJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitTranscodeJobResponseBody) };
    inline SubmitTranscodeJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitTranscodeJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitTranscodeJobResponseBody> body_ {};
  };
