...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitTranscodeJobResponseBody::TranscodeParentJob & getTranscodeParentJob() const { DARABONBA_PTR_GET_CONST(transcodeParentJob_, SubmitTranscodeJobResponseBody::TranscodeParentJob) };
    inline SubmitTranscodeJobResponseBody::TranscodeParentJob getTranscodeParentJob() { DARABONBA_PTR_GET(transcodeParentJob_, SubmitTranscodeJobResponseBody::TranscodeParentJob) };
    inline SubmitTranscodeJobResponseBody& setTranscodeParentJob(const SubmitTranscodeJobResponseBody::TranscodeParentJob & transcodeParentJob) { DARABONBA_PTR_SET_VALUE(transcodeParentJob_, transcodeParentJob) };
    inline SubmitTranscodeJobResponseBody& setTranscodeParentJob(SubmitTranscodeJobResponseBody::TranscodeParentJob && transcodeParentJob) { DARABONBA_PTR_SET_RVALUE(transcodeParentJob_, transcodeParentJob) };
  ...
  protected:
    ...
    shared_ptr<SubmitTranscodeJobResponseBody::TranscodeParentJob> transcodeParentJob_ {};
  };
