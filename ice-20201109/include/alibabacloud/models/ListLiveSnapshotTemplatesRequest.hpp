...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNo_ == nullptr
        && return this->pageSize_ == nullptr && return this->searchKeyWord_ == nullptr && return this->sortBy_ == nullptr && return this->templateIds_ == nullptr && return this->type_ == nullptr; };
