...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AIAgentId_ == nullptr
        && this->auditInterval_ == nullptr && this->callbackConfigShrink_ == nullptr && this->capturePoliciesShrink_ == nullptr && this->inputShrink_ == nullptr && this->userData_ == nullptr; };
    ...
    inline string getCapturePoliciesShrink() const { DARABONBA_PTR_GET_DEFAULT(capturePoliciesShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> capturePoliciesShrink_ {};
