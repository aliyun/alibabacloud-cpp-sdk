...
namespace Models
{
  ...
  public:
    ...
    inline const GetCustomizedVoiceJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCustomizedVoiceJobResponseBodyData) };
    inline GetCustomizedVoiceJobResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCustomizedVoiceJobResponseBodyData) };
    inline GetCustomizedVoiceJobResponseBody& setData(const GetCustomizedVoiceJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCustomizedVoiceJobResponseBody& setData(GetCustomizedVoiceJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetCustomizedVoiceJobResponseBodyData> data_ = nullptr;
    // The request ID.
