...
namespace Models
{
  ...
  public:
    ...
    inline const ListLiveSnapshotJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLiveSnapshotJobsResponseBody) };
    inline ListLiveSnapshotJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLiveSnapshotJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLiveSnapshotJobsResponseBody> body_ {};
  };
