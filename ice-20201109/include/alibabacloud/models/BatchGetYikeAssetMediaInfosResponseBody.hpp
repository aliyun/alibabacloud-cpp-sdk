...
#ifndef ALIBABACLOUD_MODELS_BATCHGETYIKEASSETMEDIAINFOSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_BATCHGETYIKEASSETMEDIAINFOSRESPONSEBODY_HPP_
...
namespace Models
{
  class BatchGetYikeAssetMediaInfosResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const BatchGetYikeAssetMediaInfosResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(IgnoredList, ignoredList_);
      DARABONBA_PTR_TO_JSON(MediaInfos, mediaInfos_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, BatchGetYikeAssetMediaInfosResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(IgnoredList, ignoredList_);
      DARABONBA_PTR_FROM_JSON(MediaInfos, mediaInfos_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    BatchGetYikeAssetMediaInfosResponseBody() = default ;
    BatchGetYikeAssetMediaInfosResponseBody(const BatchGetYikeAssetMediaInfosResponseBody &) = default ;
    BatchGetYikeAssetMediaInfosResponseBody(BatchGetYikeAssetMediaInfosResponseBody &&) = default ;
    BatchGetYikeAssetMediaInfosResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BatchGetYikeAssetMediaInfosResponseBody() = default ;
    BatchGetYikeAssetMediaInfosResponseBody& operator=(const BatchGetYikeAssetMediaInfosResponseBody &) = default ;
    BatchGetYikeAssetMediaInfosResponseBody& operator=(BatchGetYikeAssetMediaInfosResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->mediaAssetSubType_ == nullptr && this->mediaAssetType_ == nullptr && this->productionId_ == nullptr && this->sourceId_ == nullptr && this->sourceName_ == nullptr
      ...
      inline const MediaInfos::BizData & getBizData() const { DARABONBA_PTR_GET_CONST(bizData_, MediaInfos::BizData) };
      inline MediaInfos::BizData getBizData() { DARABONBA_PTR_GET(bizData_, MediaInfos::BizData) };
      inline MediaInfos& setBizData(const MediaInfos::BizData & bizData) { DARABONBA_PTR_SET_VALUE(bizData_, bizData) };
      inline MediaInfos& setBizData(MediaInfos::BizData && bizData) { DARABONBA_PTR_SET_RVALUE(bizData_, bizData) };
    ...
    inline BatchGetYikeAssetMediaInfosResponseBody& setIgnoredList(const vector<string> & ignoredList) { DARABONBA_PTR_SET_VALUE(ignoredList_, ignoredList) };
    inline BatchGetYikeAssetMediaInfosResponseBody& setIgnoredList(vector<string> && ignoredList) { DARABONBA_PTR_SET_RVALUE(ignoredList_, ignoredList) };
    ...
    inline const vector<BatchGetYikeAssetMediaInfosResponseBody::MediaInfos> & getMediaInfos() const { DARABONBA_PTR_GET_CONST(mediaInfos_, vector<BatchGetYikeAssetMediaInfosResponseBody::MediaInfos>) };
    inline vector<BatchGetYikeAssetMediaInfosResponseBody::MediaInfos> getMediaInfos() { DARABONBA_PTR_GET(mediaInfos_, vector<BatchGetYikeAssetMediaInfosResponseBody::MediaInfos>) };
    inline BatchGetYikeAssetMediaInfosResponseBody& setMediaInfos(const vector<BatchGetYikeAssetMediaInfosResponseBody::MediaInfos> & mediaInfos) { DARABONBA_PTR_SET_VALUE(mediaInfos_, mediaInfos) };
    inline BatchGetYikeAssetMediaInfosResponseBody& setMediaInfos(vector<BatchGetYikeAssetMediaInfosResponseBody::MediaInfos> && mediaInfos) { DARABONBA_PTR_SET_RVALUE(mediaInfos_, mediaInfos) };
    ...
    inline BatchGetYikeAssetMediaInfosResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
