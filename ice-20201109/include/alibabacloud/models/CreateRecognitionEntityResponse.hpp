...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRecognitionEntityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRecognitionEntityResponseBody) };
    inline CreateRecognitionEntityResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRecognitionEntityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRecognitionEntityResponseBody> body_ {};
  };
