...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMediaIndexJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryMediaIndexJobResponseBody) };
    inline QueryMediaIndexJobResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryMediaIndexJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryMediaIndexJobResponseBody> body_ {};
  };
