...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCustomTemplatesResponseBody) };
    inline ListCustomTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCustomTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCustomTemplatesResponseBody> body_ {};
  };
