...
namespace Models
{
  ...
  public:
    ...
    inline const ListSmartVoiceGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSmartVoiceGroupsResponseBody) };
    inline ListSmartVoiceGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSmartVoiceGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSmartVoiceGroupsResponseBody> body_ {};
  };
