...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->availableCapacity_ == nullptr
        ...
        && return this->licenseCount_ == nullptr && return this->licenseItemId_ == nullptr && return this->modificationTime_ == nullptr && return this->status_ == nullptr && return this->type_ == nullptr
        && return this->validDays_ == nullptr; };
    ...
    inline int64_t licenseCount() const { DARABONBA_PTR_GET_DEFAULT(licenseCount_, 0L) };
    ...
    inline int64_t validDays() const { DARABONBA_PTR_GET_DEFAULT(validDays_, 0L) };
