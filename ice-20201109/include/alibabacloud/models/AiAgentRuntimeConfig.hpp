...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentUserId_ == nullptr
        && return this->authToken_ == nullptr && return this->avatarChat3D_ == nullptr && return this->channelId_ == nullptr && return this->visionChat_ == nullptr && return this->voiceChat_ == nullptr; };
