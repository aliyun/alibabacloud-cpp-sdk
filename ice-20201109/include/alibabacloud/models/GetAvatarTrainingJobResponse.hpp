...
namespace Models
{
  ...
  public:
    ...
    inline const GetAvatarTrainingJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAvatarTrainingJobResponseBody) };
    inline GetAvatarTrainingJobResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAvatarTrainingJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAvatarTrainingJobResponseBody> body_ {};
  };
