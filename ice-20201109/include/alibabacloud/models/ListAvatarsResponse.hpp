...
namespace Models
{
  ...
  public:
    ...
    inline const ListAvatarsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAvatarsResponseBody) };
    inline ListAvatarsResponseBody body() { DARABONBA_PTR_GET(body_, ListAvatarsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAvatarsResponseBody> body_ = nullptr;
  };
