...
namespace Models
{
  ...
  public:
    ...
    inline const ListAvatarTrainingJobsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAvatarTrainingJobsResponseBodyData) };
    inline ListAvatarTrainingJobsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAvatarTrainingJobsResponseBodyData) };
    inline ListAvatarTrainingJobsResponseBody& setData(const ListAvatarTrainingJobsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAvatarTrainingJobsResponseBody& setData(ListAvatarTrainingJobsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListAvatarTrainingJobsResponseBodyData> data_ = nullptr;
    // The request ID.
