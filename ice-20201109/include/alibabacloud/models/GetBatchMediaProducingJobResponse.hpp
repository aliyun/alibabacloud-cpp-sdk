...
namespace Models
{
  ...
  public:
    ...
    inline const GetBatchMediaProducingJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetBatchMediaProducingJobResponseBody) };
    inline GetBatchMediaProducingJobResponseBody body() { DARABONBA_PTR_GET(body_, GetBatchMediaProducingJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetBatchMediaProducingJobResponseBody> body_ = nullptr;
  };
