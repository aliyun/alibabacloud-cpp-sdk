...
namespace Models
{
  ...
  public:
    ...
    inline const ListDynamicImageJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDynamicImageJobsResponseBody) };
    inline ListDynamicImageJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDynamicImageJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDynamicImageJobsResponseBody> body_ {};
  };
