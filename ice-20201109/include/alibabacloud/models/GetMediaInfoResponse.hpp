...
namespace Models
{
  ...
  public:
    ...
    inline const GetMediaInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMediaInfoResponseBody) };
    inline GetMediaInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMediaInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMediaInfoResponseBody> body_ {};
  };
