...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessPolicy_ == nullptr
        && return this->accessToken_ == nullptr && return this->channelName_ == nullptr && return this->channelTier_ == nullptr && return this->fillerSourceLocationName_ == nullptr && return this->fillerSourceName_ == nullptr
        && return this->outPutConfigList_ == nullptr && return this->playbackMode_ == nullptr; };
