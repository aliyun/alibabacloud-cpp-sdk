...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitTextGenerateJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitTextGenerateJobResponseBody) };
    inline SubmitTextGenerateJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitTextGenerateJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitTextGenerateJobResponseBody> body_ {};
  };
