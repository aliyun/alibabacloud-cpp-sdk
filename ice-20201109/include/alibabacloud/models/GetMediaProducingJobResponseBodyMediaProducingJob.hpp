...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clipsParam_ == nullptr
        && return this->code_ == nullptr && return this->completeTime_ == nullptr && return this->createTime_ == nullptr && return this->duration_ == nullptr && return this->jobId_ == nullptr
        && return this->mediaId_ == nullptr && return this->mediaURL_ == nullptr && return this->message_ == nullptr && return this->modifiedTime_ == nullptr && return this->progress_ == nullptr
        && return this->projectId_ == nullptr && return this->status_ == nullptr && return this->subJobMaterials_ == nullptr && return this->templateId_ == nullptr && return this->timeline_ == nullptr
        && return this->userData_ == nullptr && return this->vodMediaId_ == nullptr; };
