...
namespace Models
{
  ...
  public:
    ...
    inline const GetPipelineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPipelineResponseBody) };
    inline GetPipelineResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPipelineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPipelineResponseBody> body_ {};
  };
