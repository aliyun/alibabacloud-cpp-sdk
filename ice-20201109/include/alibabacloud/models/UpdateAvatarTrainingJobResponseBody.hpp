...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAvatarTrainingJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateAvatarTrainingJobResponseBody::Data) };
    inline UpdateAvatarTrainingJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateAvatarTrainingJobResponseBody::Data) };
    inline UpdateAvatarTrainingJobResponseBody& setData(const UpdateAvatarTrainingJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateAvatarTrainingJobResponseBody& setData(UpdateAvatarTrainingJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    shared_ptr<UpdateAvatarTrainingJobResponseBody::Data> data_ {};
    // The request ID.
