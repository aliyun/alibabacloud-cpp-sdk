...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->asrHotWords_ == nullptr
        && return this->asrLanguageId_ == nullptr && return this->asrMaxSilence_ == nullptr && return this->bailianAppParams_ == nullptr && return this->charBreak_ == nullptr && return this->enableIntelligentSegment_ == nullptr
        && return this->enablePushToTalk_ == nullptr && return this->enableVoiceInterrupt_ == nullptr && return this->gracefulShutdown_ == nullptr && return this->greeting_ == nullptr && return this->interruptWords_ == nullptr
        && return this->llmHistory_ == nullptr && return this->llmHistoryLimit_ == nullptr && return this->llmSystemPrompt_ == nullptr && return this->maxIdleTime_ == nullptr && return this->useVoiceprint_ == nullptr
        && return this->userOfflineTimeout_ == nullptr && return this->userOnlineTimeout_ == nullptr && return this->vadLevel_ == nullptr && return this->voiceId_ == nullptr && return this->voiceIdList_ == nullptr
        && return this->voiceprintId_ == nullptr && return this->volume_ == nullptr && return this->wakeUpQuery_ == nullptr && return this->workflowOverrideParams_ == nullptr; };
