...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateMediaLiveChannelRequest::AudioSettings> & getAudioSettings() const { DARABONBA_PTR_GET_CONST(audioSettings_, vector<CreateMediaLiveChannelRequest::AudioSettings>) };
    inline vector<CreateMediaLiveChannelRequest::AudioSettings> getAudioSettings() { DARABONBA_PTR_GET(audioSettings_, vector<CreateMediaLiveChannelRequest::AudioSettings>) };
    inline CreateMediaLiveChannelRequest& setAudioSettings(const vector<CreateMediaLiveChannelRequest::AudioSettings> & audioSettings) { DARABONBA_PTR_SET_VALUE(audioSettings_, audioSettings) };
    inline CreateMediaLiveChannelRequest& setAudioSettings(vector<CreateMediaLiveChannelRequest::AudioSettings> && audioSettings) { DARABONBA_PTR_SET_RVALUE(audioSettings_, audioSettings) };
    ...
    inline const vector<CreateMediaLiveChannelRequest::InputAttachments> & getInputAttachments() const { DARABONBA_PTR_GET_CONST(inputAttachments_, vector<CreateMediaLiveChannelRequest::InputAttachments>) };
    inline vector<CreateMediaLiveChannelRequest::InputAttachments> getInputAttachments() { DARABONBA_PTR_GET(inputAttachments_, vector<CreateMediaLiveChannelRequest::InputAttachments>) };
    inline CreateMediaLiveChannelRequest& setInputAttachments(const vector<CreateMediaLiveChannelRequest::InputAttachments> & inputAttachments) { DARABONBA_PTR_SET_VALUE(inputAttachments_, inputAttachments) };
    inline CreateMediaLiveChannelRequest& setInputAttachments(vector<CreateMediaLiveChannelRequest::InputAttachments> && inputAttachments) { DARABONBA_PTR_SET_RVALUE(inputAttachments_, inputAttachments) };
    ...
    inline const vector<CreateMediaLiveChannelRequest::OutputGroups> & getOutputGroups() const { DARABONBA_PTR_GET_CONST(outputGroups_, vector<CreateMediaLiveChannelRequest::OutputGroups>) };
    inline vector<CreateMediaLiveChannelRequest::OutputGroups> getOutputGroups() { DARABONBA_PTR_GET(outputGroups_, vector<CreateMediaLiveChannelRequest::OutputGroups>) };
    inline CreateMediaLiveChannelRequest& setOutputGroups(const vector<CreateMediaLiveChannelRequest::OutputGroups> & outputGroups) { DARABONBA_PTR_SET_VALUE(outputGroups_, outputGroups) };
    inline CreateMediaLiveChannelRequest& setOutputGroups(vector<CreateMediaLiveChannelRequest::OutputGroups> && outputGroups) { DARABONBA_PTR_SET_RVALUE(outputGroups_, outputGroups) };
    ...
    inline const vector<CreateMediaLiveChannelRequest::VideoSettings> & getVideoSettings() const { DARABONBA_PTR_GET_CONST(videoSettings_, vector<CreateMediaLiveChannelRequest::VideoSettings>) };
    inline vector<CreateMediaLiveChannelRequest::VideoSettings> getVideoSettings() { DARABONBA_PTR_GET(videoSettings_, vector<CreateMediaLiveChannelRequest::VideoSettings>) };
    inline CreateMediaLiveChannelRequest& setVideoSettings(const vector<CreateMediaLiveChannelRequest::VideoSettings> & videoSettings) { DARABONBA_PTR_SET_VALUE(videoSettings_, videoSettings) };
    inline CreateMediaLiveChannelRequest& setVideoSettings(vector<CreateMediaLiveChannelRequest::VideoSettings> && videoSettings) { DARABONBA_PTR_SET_RVALUE(videoSettings_, videoSettings) };


  protected:
    // The audio settings.
    shared_ptr<vector<CreateMediaLiveChannelRequest::AudioSettings>> audioSettings_ {};
    // The associated inputs.
    // 
    // This parameter is required.
    shared_ptr<vector<CreateMediaLiveChannelRequest::InputAttachments>> inputAttachments_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<CreateMediaLiveChannelRequest::OutputGroups>> outputGroups_ {};
    // The video settings.
    shared_ptr<vector<CreateMediaLiveChannelRequest::VideoSettings>> videoSettings_ {};
  };
