...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activatedTime_ == nullptr
        && return this->authCode_ == nullptr && return this->creationTime_ == nullptr && return this->deviceId_ == nullptr && return this->license_ == nullptr && return this->licenseItemId_ == nullptr
        && return this->modificationTime_ == nullptr && return this->status_ == nullptr && return this->type_ == nullptr; };
    ...
    inline string activatedTime() const { DARABONBA_PTR_GET_DEFAULT(activatedTime_, "") };
  ...
  protected:
    std::shared_ptr<string> activatedTime_ = nullptr;
