...
#ifndef ALIBABACLOUD_MODELS_AIAGENTOUTBOUNDCALLCONFIGASRCONFIG_HPP_
#define ALIBABACLOUD_MODELS_AIAGENTOUTBOUNDCALLCONFIGASRCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AIAgentOutboundCallConfigAsrConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AIAgentOutboundCallConfigAsrConfig& obj) { 
    ...
    AIAgentOutboundCallConfigAsrConfig() = default ;
    AIAgentOutboundCallConfigAsrConfig(const AIAgentOutboundCallConfigAsrConfig &) = default ;
    AIAgentOutboundCallConfigAsrConfig(AIAgentOutboundCallConfigAsrConfig &&) = default ;
    AIAgentOutboundCallConfigAsrConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AIAgentOutboundCallConfigAsrConfig() = default ;
    AIAgentOutboundCallConfigAsrConfig& operator=(const AIAgentOutboundCallConfigAsrConfig &) = default ;
    AIAgentOutboundCallConfigAsrConfig& operator=(AIAgentOutboundCallConfigAsrConfig &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->asrHotWords_ == nullptr
        && return this->asrLanguageId_ == nullptr && return this->asrMaxSilence_ == nullptr && return this->customParams_ == nullptr && return this->vadDuration_ == nullptr && return this->vadLevel_ == nullptr; };
    ...
    inline AIAgentOutboundCallConfigAsrConfig& setAsrHotWords(const vector<string> & asrHotWords) { DARABONBA_PTR_SET_VALUE(asrHotWords_, asrHotWords) };
    inline AIAgentOutboundCallConfigAsrConfig& setAsrHotWords(vector<string> && asrHotWords) { DARABONBA_PTR_SET_RVALUE(asrHotWords_, asrHotWords) };
    ...
    inline AIAgentOutboundCallConfigAsrConfig& setAsrLanguageId(string asrLanguageId) { DARABONBA_PTR_SET_VALUE(asrLanguageId_, asrLanguageId) };
    ...
    inline AIAgentOutboundCallConfigAsrConfig& setAsrMaxSilence(int32_t asrMaxSilence) { DARABONBA_PTR_SET_VALUE(asrMaxSilence_, asrMaxSilence) };
    ...
    inline AIAgentOutboundCallConfigAsrConfig& setCustomParams(string customParams) { DARABONBA_PTR_SET_VALUE(customParams_, customParams) };
    ...
    inline AIAgentOutboundCallConfigAsrConfig& setVadDuration(int32_t vadDuration) { DARABONBA_PTR_SET_VALUE(vadDuration_, vadDuration) };
    ...
    inline AIAgentOutboundCallConfigAsrConfig& setVadLevel(int32_t vadLevel) { DARABONBA_PTR_SET_VALUE(vadLevel_, vadLevel) };
