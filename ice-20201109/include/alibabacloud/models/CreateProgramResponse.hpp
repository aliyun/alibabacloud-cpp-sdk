...
namespace Models
{
  ...
  public:
    ...
    inline const CreateProgramResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateProgramResponseBody) };
    inline CreateProgramResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateProgramResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateProgramResponseBody> body_ {};
  };
