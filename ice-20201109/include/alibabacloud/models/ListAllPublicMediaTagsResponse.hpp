...
namespace Models
{
  ...
  public:
    ...
    inline const ListAllPublicMediaTagsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAllPublicMediaTagsResponseBody) };
    inline ListAllPublicMediaTagsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAllPublicMediaTagsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAllPublicMediaTagsResponseBody> body_ {};
  };
