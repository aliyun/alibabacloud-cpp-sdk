...
namespace Models
{
  ...
  public:
    ...
    inline const AddFavoritePublicMediaResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddFavoritePublicMediaResponseBody) };
    inline AddFavoritePublicMediaResponseBody body() { DARABONBA_PTR_GET(body_, AddFavoritePublicMediaResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddFavoritePublicMediaResponseBody> body_ = nullptr;
  };
