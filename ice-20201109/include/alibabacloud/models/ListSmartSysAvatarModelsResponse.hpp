...
namespace Models
{
  ...
  public:
    ...
    inline const ListSmartSysAvatarModelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSmartSysAvatarModelsResponseBody) };
    inline ListSmartSysAvatarModelsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSmartSysAvatarModelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSmartSysAvatarModelsResponseBody> body_ {};
  };
