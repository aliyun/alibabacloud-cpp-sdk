...
namespace Models
{
  ...
  public:
    ...
    inline const ListBatchMediaProducingJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListBatchMediaProducingJobsResponseBody) };
    inline ListBatchMediaProducingJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListBatchMediaProducingJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListBatchMediaProducingJobsResponseBody> body_ {};
  };
