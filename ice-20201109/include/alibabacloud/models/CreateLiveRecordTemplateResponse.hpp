...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLiveRecordTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLiveRecordTemplateResponseBody) };
    inline CreateLiveRecordTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLiveRecordTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLiveRecordTemplateResponseBody> body_ {};
  };
