...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateLiveRecordTemplateRequest::RecordFormat> & getRecordFormat() const { DARABONBA_PTR_GET_CONST(recordFormat_, vector<UpdateLiveRecordTemplateRequest::RecordFormat>) };
    inline vector<UpdateLiveRecordTemplateRequest::RecordFormat> getRecordFormat() { DARABONBA_PTR_GET(recordFormat_, vector<UpdateLiveRecordTemplateRequest::RecordFormat>) };
    inline UpdateLiveRecordTemplateRequest& setRecordFormat(const vector<UpdateLiveRecordTemplateRequest::RecordFormat> & recordFormat) { DARABONBA_PTR_SET_VALUE(recordFormat_, recordFormat) };
    inline UpdateLiveRecordTemplateRequest& setRecordFormat(vector<UpdateLiveRecordTemplateRequest::RecordFormat> && recordFormat) { DARABONBA_PTR_SET_RVALUE(recordFormat_, recordFormat) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<UpdateLiveRecordTemplateRequest::RecordFormat>> recordFormat_ {};
    // The template ID.
    // 
    // This parameter is required.
