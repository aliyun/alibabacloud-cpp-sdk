...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAvatarTrainingJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAvatarTrainingJobResponseBody) };
    inline DeleteAvatarTrainingJobResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAvatarTrainingJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAvatarTrainingJobResponseBody> body_ {};
  };
