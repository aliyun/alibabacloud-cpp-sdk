...
namespace Models
{
  ...
  public:
    ...
    inline const GetDynamicImageJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDynamicImageJobResponseBody) };
    inline GetDynamicImageJobResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDynamicImageJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDynamicImageJobResponseBody> body_ {};
  };
