...
#ifndef ALIBABACLOUD_MODELS_SOURCE_HPP_
#define ALIBABACLOUD_MODELS_SOURCE_HPP_
...
namespace Models
{
  ...
  public:
    ...
    inline Source& setArn(string arn) { DARABONBA_PTR_SET_VALUE(arn_, arn) };
    ...
    inline Source& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline Source& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline Source& setHttpPackageConfigurations(string httpPackageConfigurations) { DARABONBA_PTR_SET_VALUE(httpPackageConfigurations_, httpPackageConfigurations) };
    ...
    inline Source& setSourceLocationName(string sourceLocationName) { DARABONBA_PTR_SET_VALUE(sourceLocationName_, sourceLocationName) };
    ...
    inline Source& setSourceName(string sourceName) { DARABONBA_PTR_SET_VALUE(sourceName_, sourceName) };
    ...
    inline Source& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline Source& setState(int32_t state) { DARABONBA_PTR_SET_VALUE(state_, state) };
