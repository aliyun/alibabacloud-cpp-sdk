...
#ifndef ALIBABACLOUD_MODELS_CREATEMEDIALIVEINPUTREQUESTINPUTSETTINGS_HPP_
#define ALIBABACLOUD_MODELS_CREATEMEDIALIVEINPUTREQUESTINPUTSETTINGS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateMediaLiveInputRequestInputSettings& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateMediaLiveInputRequestInputSettings& obj) { 
    ...
    CreateMediaLiveInputRequestInputSettings() = default ;
    CreateMediaLiveInputRequestInputSettings(const CreateMediaLiveInputRequestInputSettings &) = default ;
    CreateMediaLiveInputRequestInputSettings(CreateMediaLiveInputRequestInputSettings &&) = default ;
    CreateMediaLiveInputRequestInputSettings(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateMediaLiveInputRequestInputSettings() = default ;
    CreateMediaLiveInputRequestInputSettings& operator=(const CreateMediaLiveInputRequestInputSettings &) = default ;
    CreateMediaLiveInputRequestInputSettings& operator=(CreateMediaLiveInputRequestInputSettings &&) = default ;
    ...
    inline CreateMediaLiveInputRequestInputSettings& setFlowId(string flowId) { DARABONBA_PTR_SET_VALUE(flowId_, flowId) };
    ...
    inline CreateMediaLiveInputRequestInputSettings& setFlowOutputName(string flowOutputName) { DARABONBA_PTR_SET_VALUE(flowOutputName_, flowOutputName) };
    ...
    inline CreateMediaLiveInputRequestInputSettings& setSourceUrl(string sourceUrl) { DARABONBA_PTR_SET_VALUE(sourceUrl_, sourceUrl) };
    ...
    inline CreateMediaLiveInputRequestInputSettings& setSrtLatency(int32_t srtLatency) { DARABONBA_PTR_SET_VALUE(srtLatency_, srtLatency) };
    ...
    inline CreateMediaLiveInputRequestInputSettings& setSrtMaxBitrate(int32_t srtMaxBitrate) { DARABONBA_PTR_SET_VALUE(srtMaxBitrate_, srtMaxBitrate) };
    ...
    inline CreateMediaLiveInputRequestInputSettings& setSrtPassphrase(string srtPassphrase) { DARABONBA_PTR_SET_VALUE(srtPassphrase_, srtPassphrase) };
    ...
    inline CreateMediaLiveInputRequestInputSettings& setSrtPbKeyLen(int32_t srtPbKeyLen) { DARABONBA_PTR_SET_VALUE(srtPbKeyLen_, srtPbKeyLen) };
    ...
    inline CreateMediaLiveInputRequestInputSettings& setStreamName(string streamName) { DARABONBA_PTR_SET_VALUE(streamName_, streamName) };
