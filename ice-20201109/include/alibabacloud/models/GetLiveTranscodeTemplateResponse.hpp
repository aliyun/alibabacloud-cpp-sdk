...
namespace Models
{
  ...
  public:
    ...
    inline const GetLiveTranscodeTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLiveTranscodeTemplateResponseBody) };
    inline GetLiveTranscodeTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLiveTranscodeTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLiveTranscodeTemplateResponseBody> body_ {};
  };
