...
namespace Models
{
  ...
  public:
    ...
    inline int32_t bufsize() const { DARABONBA_PTR_GET_DEFAULT(bufsize_, 0) };
    ...
    inline     const Darabonba::Json & crf() const { DARABONBA_GET(crf_) };
    Darabonba::Json & crf() { DARABONBA_GET(crf_) };
    ...
    inline     const Darabonba::Json & fps() const { DARABONBA_GET(fps_) };
    Darabonba::Json & fps() { DARABONBA_GET(fps_) };
    ...
    inline     const Darabonba::Json & gop() const { DARABONBA_GET(gop_) };
    Darabonba::Json & gop() { DARABONBA_GET(gop_) };
    ...
    inline     const Darabonba::Json & maxFps() const { DARABONBA_GET(maxFps_) };
    Darabonba::Json & maxFps() { DARABONBA_GET(maxFps_) };
    ...
    inline int32_t maxrate() const { DARABONBA_PTR_GET_DEFAULT(maxrate_, 0) };
    ...
    inline int32_t qscale() const { DARABONBA_PTR_GET_DEFAULT(qscale_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> bufsize_ = nullptr;
    std::shared_ptr<string> codec_ = nullptr;
    Darabonba::Json crf_ = nullptr;
    std::shared_ptr<string> crop_ = nullptr;
    Darabonba::Json fps_ = nullptr;
    Darabonba::Json gop_ = nullptr;
    std::shared_ptr<int32_t> height_ = nullptr;
    std::shared_ptr<bool> longShortMode_ = nullptr;
    Darabonba::Json maxFps_ = nullptr;
    std::shared_ptr<int32_t> maxrate_ = nullptr;
    std::shared_ptr<string> pad_ = nullptr;
    std::shared_ptr<string> profile_ = nullptr;
    std::shared_ptr<int32_t> qscale_ = nullptr;
