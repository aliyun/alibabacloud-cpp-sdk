...
namespace Models
{
  ...
  public:
    ...
    inline const StartRtcRobotInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartRtcRobotInstanceResponseBody) };
    inline StartRtcRobotInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, StartRtcRobotInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartRtcRobotInstanceResponseBody> body_ {};
  };
