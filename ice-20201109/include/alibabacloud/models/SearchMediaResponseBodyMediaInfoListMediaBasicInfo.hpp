...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->biz_ == nullptr
        ...
        && return this->mediaTags_ == nullptr && return this->mediaType_ == nullptr && return this->modifiedTime_ == nullptr && return this->namespace_ == nullptr && return this->referenceId_ == nullptr
        && return this->snapshots_ == nullptr && return this->source_ == nullptr && return this->spriteImages_ == nullptr && return this->status_ == nullptr && return this->streamStatus_ == nullptr
        && return this->title_ == nullptr && return this->transcodeStatus_ == nullptr && return this->uploadSource_ == nullptr && return this->userData_ == nullptr && return this->visionDescription_ == nullptr; };
    // biz Field Functions 
