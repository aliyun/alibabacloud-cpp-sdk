...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRecognitionLibResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRecognitionLibResponseBody) };
    inline DeleteRecognitionLibResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRecognitionLibResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRecognitionLibResponseBody> body_ {};
  };
