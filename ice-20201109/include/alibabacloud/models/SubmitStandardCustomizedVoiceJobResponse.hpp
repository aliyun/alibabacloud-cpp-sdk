...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitStandardCustomizedVoiceJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitStandardCustomizedVoiceJobResponseBody) };
    inline SubmitStandardCustomizedVoiceJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitStandardCustomizedVoiceJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitStandardCustomizedVoiceJobResponseBody> body_ {};
  };
