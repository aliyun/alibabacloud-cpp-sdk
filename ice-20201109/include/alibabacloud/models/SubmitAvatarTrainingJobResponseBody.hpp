...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitAvatarTrainingJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SubmitAvatarTrainingJobResponseBody::Data) };
    inline SubmitAvatarTrainingJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SubmitAvatarTrainingJobResponseBody::Data) };
    inline SubmitAvatarTrainingJobResponseBody& setData(const SubmitAvatarTrainingJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitAvatarTrainingJobResponseBody& setData(SubmitAvatarTrainingJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
