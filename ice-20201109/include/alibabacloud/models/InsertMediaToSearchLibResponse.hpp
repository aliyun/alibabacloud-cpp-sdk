...
namespace Models
{
  ...
  public:
    ...
    inline const InsertMediaToSearchLibResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InsertMediaToSearchLibResponseBody) };
    inline InsertMediaToSearchLibResponseBody getBody() { DARABONBA_PTR_GET(body_, InsertMediaToSearchLibResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InsertMediaToSearchLibResponseBody> body_ {};
  };
