...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ChannelAssemblyScheduleData::AdBreaks> & getAdBreaks() const { DARABONBA_PTR_GET_CONST(adBreaks_, vector<ChannelAssemblyScheduleData::AdBreaks>) };
    inline vector<ChannelAssemblyScheduleData::AdBreaks> getAdBreaks() { DARABONBA_PTR_GET(adBreaks_, vector<ChannelAssemblyScheduleData::AdBreaks>) };
    inline ChannelAssemblyScheduleData& setAdBreaks(const vector<ChannelAssemblyScheduleData::AdBreaks> & adBreaks) { DARABONBA_PTR_SET_VALUE(adBreaks_, adBreaks) };
    inline ChannelAssemblyScheduleData& setAdBreaks(vector<ChannelAssemblyScheduleData::AdBreaks> && adBreaks) { DARABONBA_PTR_SET_RVALUE(adBreaks_, adBreaks) };
