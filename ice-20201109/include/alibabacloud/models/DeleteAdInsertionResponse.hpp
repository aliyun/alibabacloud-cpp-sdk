...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAdInsertionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAdInsertionResponseBody) };
    inline DeleteAdInsertionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAdInsertionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAdInsertionResponseBody> body_ {};
  };
