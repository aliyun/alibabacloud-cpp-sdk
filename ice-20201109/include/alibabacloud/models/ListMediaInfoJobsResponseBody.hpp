...
#ifndef ALIBABACLOUD_MODELS_LISTMEDIAINFOJOBSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTMEDIAINFOJOBSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListMediaInfoJobsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Jobs, jobs_);
      DARABONBA_PTR_TO_JSON(NextPageToken, nextPageToken_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListMediaInfoJobsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Jobs, jobs_);
      DARABONBA_PTR_FROM_JSON(NextPageToken, nextPageToken_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListMediaInfoJobsResponseBody() = default ;
    ListMediaInfoJobsResponseBody(const ListMediaInfoJobsResponseBody &) = default ;
    ListMediaInfoJobsResponseBody(ListMediaInfoJobsResponseBody &&) = default ;
    ListMediaInfoJobsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMediaInfoJobsResponseBody() = default ;
    ListMediaInfoJobsResponseBody& operator=(const ListMediaInfoJobsResponseBody &) = default ;
    ListMediaInfoJobsResponseBody& operator=(ListMediaInfoJobsResponseBody &&) = default ;
    ...
    public:
      ...
      inline const Jobs::MediaInfoProperty & getMediaInfoProperty() const { DARABONBA_PTR_GET_CONST(mediaInfoProperty_, Jobs::MediaInfoProperty) };
      inline Jobs::MediaInfoProperty getMediaInfoProperty() { DARABONBA_PTR_GET(mediaInfoProperty_, Jobs::MediaInfoProperty) };
      inline Jobs& setMediaInfoProperty(const Jobs::MediaInfoProperty & mediaInfoProperty) { DARABONBA_PTR_SET_VALUE(mediaInfoProperty_, mediaInfoProperty) };
      inline Jobs& setMediaInfoProperty(Jobs::MediaInfoProperty && mediaInfoProperty) { DARABONBA_PTR_SET_RVALUE(mediaInfoProperty_, mediaInfoProperty) };
      ...
      inline Jobs& setSubmitResultJson(const Darabonba::Json & submitResultJson) { DARABONBA_SET_VALUE(submitResultJson_, submitResultJson) };
      inline Jobs& setSubmitResultJson(Darabonba::Json && submitResultJson) { DARABONBA_SET_RVALUE(submitResultJson_, submitResultJson) };
    ...
    protected:
      ...
      shared_ptr<Jobs::MediaInfoProperty> mediaInfoProperty_ {};
      // The job name.
    ...
    inline const vector<ListMediaInfoJobsResponseBody::Jobs> & getJobs() const { DARABONBA_PTR_GET_CONST(jobs_, vector<ListMediaInfoJobsResponseBody::Jobs>) };
    inline vector<ListMediaInfoJobsResponseBody::Jobs> getJobs() { DARABONBA_PTR_GET(jobs_, vector<ListMediaInfoJobsResponseBody::Jobs>) };
    inline ListMediaInfoJobsResponseBody& setJobs(const vector<ListMediaInfoJobsResponseBody::Jobs> & jobs) { DARABONBA_PTR_SET_VALUE(jobs_, jobs) };
    inline ListMediaInfoJobsResponseBody& setJobs(vector<ListMediaInfoJobsResponseBody::Jobs> && jobs) { DARABONBA_PTR_SET_RVALUE(jobs_, jobs) };
    ...
    inline ListMediaInfoJobsResponseBody& setNextPageToken(string nextPageToken) { DARABONBA_PTR_SET_VALUE(nextPageToken_, nextPageToken) };
    ...
    void deleteRequestId() { this->requestId_ = nullptr;};
    inline string getRequestId() const { DARABONBA_PTR_GET_DEFAULT(requestId_, "") };
    inline ListMediaInfoJobsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The list of media information analysis jobs.
    shared_ptr<vector<ListMediaInfoJobsResponseBody::Jobs>> jobs_ {};
