...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitSyncMediaInfoJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SubmitSyncMediaInfoJobResponseBody) };
    inline SubmitSyncMediaInfoJobResponseBody body() { DARABONBA_PTR_GET(body_, SubmitSyncMediaInfoJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitSyncMediaInfoJobResponseBody> body_ = nullptr;
  };
