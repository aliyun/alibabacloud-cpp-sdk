...
namespace Models
{
  ...
  public:
    ...
    inline const ListMediaProducingJobsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListMediaProducingJobsResponseBody) };
    inline ListMediaProducingJobsResponseBody body() { DARABONBA_PTR_GET(body_, ListMediaProducingJobsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListMediaProducingJobsResponseBody> body_ = nullptr;
  };
