...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->integratedLoudnessTarget_ == nullptr
        && this->level_ == nullptr && this->loudnessRangeTarget_ == nullptr && this->method_ == nullptr && this->truePeak_ == nullptr; };
    ...
    inline int32_t getIntegratedLoudnessTarget() const { DARABONBA_PTR_GET_DEFAULT(integratedLoudnessTarget_, 0) };
    ...
    inline int32_t getLoudnessRangeTarget() const { DARABONBA_PTR_GET_DEFAULT(loudnessRangeTarget_, 0) };
    ...
    inline int32_t getTruePeak() const { DARABONBA_PTR_GET_DEFAULT(truePeak_, 0) };
    inline MediaConvertVolume& setTruePeak(int32_t truePeak) { DARABONBA_PTR_SET_VALUE(truePeak_, truePeak) };


  protected:
    shared_ptr<int32_t> integratedLoudnessTarget_ {};
    shared_ptr<int32_t> level_ {};
    shared_ptr<int32_t> loudnessRangeTarget_ {};
    shared_ptr<string> method_ {};
    shared_ptr<int32_t> truePeak_ {};
  };
