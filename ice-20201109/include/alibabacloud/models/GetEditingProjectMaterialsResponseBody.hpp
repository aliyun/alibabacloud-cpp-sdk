...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetEditingProjectMaterialsResponseBody::LiveMaterials> & getLiveMaterials() const { DARABONBA_PTR_GET_CONST(liveMaterials_, vector<GetEditingProjectMaterialsResponseBody::LiveMaterials>) };
    inline vector<GetEditingProjectMaterialsResponseBody::LiveMaterials> getLiveMaterials() { DARABONBA_PTR_GET(liveMaterials_, vector<GetEditingProjectMaterialsResponseBody::LiveMaterials>) };
    inline GetEditingProjectMaterialsResponseBody& setLiveMaterials(const vector<GetEditingProjectMaterialsResponseBody::LiveMaterials> & liveMaterials) { DARABONBA_PTR_SET_VALUE(liveMaterials_, liveMaterials) };
    inline GetEditingProjectMaterialsResponseBody& setLiveMaterials(vector<GetEditingProjectMaterialsResponseBody::LiveMaterials> && liveMaterials) { DARABONBA_PTR_SET_RVALUE(liveMaterials_, liveMaterials) };
    ...
    inline const vector<GetEditingProjectMaterialsResponseBody::MediaInfos> & getMediaInfos() const { DARABONBA_PTR_GET_CONST(mediaInfos_, vector<GetEditingProjectMaterialsResponseBody::MediaInfos>) };
    inline vector<GetEditingProjectMaterialsResponseBody::MediaInfos> getMediaInfos() { DARABONBA_PTR_GET(mediaInfos_, vector<GetEditingProjectMaterialsResponseBody::MediaInfos>) };
    inline GetEditingProjectMaterialsResponseBody& setMediaInfos(const vector<GetEditingProjectMaterialsResponseBody::MediaInfos> & mediaInfos) { DARABONBA_PTR_SET_VALUE(mediaInfos_, mediaInfos) };
    inline GetEditingProjectMaterialsResponseBody& setMediaInfos(vector<GetEditingProjectMaterialsResponseBody::MediaInfos> && mediaInfos) { DARABONBA_PTR_SET_RVALUE(mediaInfos_, mediaInfos) };
  ...
  protected:
    ...
    shared_ptr<vector<GetEditingProjectMaterialsResponseBody::LiveMaterials>> liveMaterials_ {};
    // The media assets that meet the specified conditions.
    shared_ptr<vector<GetEditingProjectMaterialsResponseBody::MediaInfos>> mediaInfos_ {};
    // The project ID.
