...
namespace Models
{
  ...
  public:
    ...
    inline const AddAdInsertionResponseBody::Config & getConfig() const { DARABONBA_PTR_GET_CONST(config_, AddAdInsertionResponseBody::Config) };
    inline AddAdInsertionResponseBody::Config getConfig() { DARABONBA_PTR_GET(config_, AddAdInsertionResponseBody::Config) };
    inline AddAdInsertionResponseBody& setConfig(const AddAdInsertionResponseBody::Config & config) { DARABONBA_PTR_SET_VALUE(config_, config) };
    inline AddAdInsertionResponseBody& setConfig(AddAdInsertionResponseBody::Config && config) { DARABONBA_PTR_SET_RVALUE(config_, config) };
  ...
  protected:
    ...
    shared_ptr<AddAdInsertionResponseBody::Config> config_ {};
