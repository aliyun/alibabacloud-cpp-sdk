...
namespace Models
{
  ...
  public:
    ...
    inline const SendAIAgentTextResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SendAIAgentTextResponseBody) };
    inline SendAIAgentTextResponseBody body() { DARABONBA_PTR_GET(body_, SendAIAgentTextResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SendAIAgentTextResponseBody> body_ = nullptr;
  };
