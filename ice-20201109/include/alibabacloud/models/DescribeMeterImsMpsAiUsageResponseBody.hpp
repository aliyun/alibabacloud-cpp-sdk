...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEMETERIMSMPSAIUSAGERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeMeterImsMpsAiUsageResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeMeterImsMpsAiUsageResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeMeterImsMpsAiUsageResponseBody() = default ;
    DescribeMeterImsMpsAiUsageResponseBody(const DescribeMeterImsMpsAiUsageResponseBody &) = default ;
    DescribeMeterImsMpsAiUsageResponseBody(DescribeMeterImsMpsAiUsageResponseBody &&) = default ;
    DescribeMeterImsMpsAiUsageResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeMeterImsMpsAiUsageResponseBody() = default ;
    DescribeMeterImsMpsAiUsageResponseBody& operator=(const DescribeMeterImsMpsAiUsageResponseBody &) = default ;
    DescribeMeterImsMpsAiUsageResponseBody& operator=(DescribeMeterImsMpsAiUsageResponseBody &&) = default ;
