...
namespace Models
{
  ...
  public:
    ...
    inline const GetDemonstrationForCustomizedVoiceJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDemonstrationForCustomizedVoiceJobResponseBody) };
    inline GetDemonstrationForCustomizedVoiceJobResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDemonstrationForCustomizedVoiceJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDemonstrationForCustomizedVoiceJobResponseBody> body_ {};
  };
