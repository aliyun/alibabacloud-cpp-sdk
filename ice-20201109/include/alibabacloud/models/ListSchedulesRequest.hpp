...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->channelName_ == nullptr
        && return this->pageNo_ == nullptr && return this->pageSize_ == nullptr && return this->windowDurationSeconds_ == nullptr; };
    ...
    inline int64_t windowDurationSeconds() const { DARABONBA_PTR_GET_DEFAULT(windowDurationSeconds_, 0L) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<int64_t> windowDurationSeconds_ = nullptr;
  };
