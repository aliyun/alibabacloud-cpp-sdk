...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomizedVoiceJobsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListCustomizedVoiceJobsResponseBody) };
    inline ListCustomizedVoiceJobsResponseBody body() { DARABONBA_PTR_GET(body_, ListCustomizedVoiceJobsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListCustomizedVoiceJobsResponseBody> body_ = nullptr;
  };
