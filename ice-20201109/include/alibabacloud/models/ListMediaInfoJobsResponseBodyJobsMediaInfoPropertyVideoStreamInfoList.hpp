...
#ifndef ALIBABACLOUD_MODELS_LISTMEDIAINFOJOBSRESPONSEBODYJOBSMEDIAINFOPROPERTYVIDEOSTREAMINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_LISTMEDIAINFOJOBSRESPONSEBODYJOBSMEDIAINFOPROPERTYVIDEOSTREAMINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& obj) { 
    ...
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList() = default ;
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList(const ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList &) = default ;
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList(ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList &&) = default ;
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList() = default ;
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& operator=(const ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList &) = default ;
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& operator=(ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList &&) = default ;
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setAvgFps(string avgFps) { DARABONBA_PTR_SET_VALUE(avgFps_, avgFps) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setBitRate(string bitRate) { DARABONBA_PTR_SET_VALUE(bitRate_, bitRate) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setCodecLongName(string codecLongName) { DARABONBA_PTR_SET_VALUE(codecLongName_, codecLongName) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setCodecName(string codecName) { DARABONBA_PTR_SET_VALUE(codecName_, codecName) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setCodecTag(string codecTag) { DARABONBA_PTR_SET_VALUE(codecTag_, codecTag) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setCodecTagString(string codecTagString) { DARABONBA_PTR_SET_VALUE(codecTagString_, codecTagString) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setCodecTimeBase(string codecTimeBase) { DARABONBA_PTR_SET_VALUE(codecTimeBase_, codecTimeBase) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setDar(string dar) { DARABONBA_PTR_SET_VALUE(dar_, dar) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setFps(string fps) { DARABONBA_PTR_SET_VALUE(fps_, fps) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setHasBFrames(string hasBFrames) { DARABONBA_PTR_SET_VALUE(hasBFrames_, hasBFrames) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setHeight(string height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setIndex(string index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setLevel(string level) { DARABONBA_PTR_SET_VALUE(level_, level) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setNumFrames(string numFrames) { DARABONBA_PTR_SET_VALUE(numFrames_, numFrames) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setPixFmt(string pixFmt) { DARABONBA_PTR_SET_VALUE(pixFmt_, pixFmt) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setProfile(string profile) { DARABONBA_PTR_SET_VALUE(profile_, profile) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setRotate(string rotate) { DARABONBA_PTR_SET_VALUE(rotate_, rotate) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setSar(string sar) { DARABONBA_PTR_SET_VALUE(sar_, sar) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setTimeBase(string timeBase) { DARABONBA_PTR_SET_VALUE(timeBase_, timeBase) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList& setWidth(string width) { DARABONBA_PTR_SET_VALUE(width_, width) };
