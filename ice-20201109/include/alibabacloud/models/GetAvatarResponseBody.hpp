...
namespace Models
{
  ...
  public:
    ...
    inline const GetAvatarResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAvatarResponseBodyData) };
    inline GetAvatarResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAvatarResponseBodyData) };
    inline GetAvatarResponseBody& setData(const GetAvatarResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAvatarResponseBody& setData(GetAvatarResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<GetAvatarResponseBodyData> data_ = nullptr;
    // The request ID.
