...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitDNAJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitDNAJobResponseBody) };
    inline SubmitDNAJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitDNAJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitDNAJobResponseBody> body_ {};
  };
