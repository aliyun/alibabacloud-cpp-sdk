...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->configurationName_ == nullptr
        && this->description_ == nullptr && this->groupName_ == nullptr && this->packageConfigShrink_ == nullptr && this->protocol_ == nullptr; };
    ...
    inline string getPackageConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(packageConfigShrink_, "") };
