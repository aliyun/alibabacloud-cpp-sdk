...
#ifndef ALIBABACLOUD_MODELS_DELETEMEDIACONNECTFLOWRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DELETEMEDIACONNECTFLOWRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteMediaConnectFlowResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Content, content_);
      DARABONBA_PTR_TO_JSON(Description, description_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(RetCode, retCode_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteMediaConnectFlowResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Content, content_);
      DARABONBA_PTR_FROM_JSON(Description, description_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(RetCode, retCode_);
    };
    DeleteMediaConnectFlowResponseBody() = default ;
    DeleteMediaConnectFlowResponseBody(const DeleteMediaConnectFlowResponseBody &) = default ;
    DeleteMediaConnectFlowResponseBody(DeleteMediaConnectFlowResponseBody &&) = default ;
    DeleteMediaConnectFlowResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteMediaConnectFlowResponseBody() = default ;
    DeleteMediaConnectFlowResponseBody& operator=(const DeleteMediaConnectFlowResponseBody &) = default ;
    DeleteMediaConnectFlowResponseBody& operator=(DeleteMediaConnectFlowResponseBody &&) = default ;
