...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitCopyrightExtractJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SubmitCopyrightExtractJobResponseBodyData) };
    inline SubmitCopyrightExtractJobResponseBodyData data() { DARABONBA_PTR_GET(data_, SubmitCopyrightExtractJobResponseBodyData) };
    inline SubmitCopyrightExtractJobResponseBody& setData(const SubmitCopyrightExtractJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitCopyrightExtractJobResponseBody& setData(SubmitCopyrightExtractJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<SubmitCopyrightExtractJobResponseBodyData> data_ = nullptr;
