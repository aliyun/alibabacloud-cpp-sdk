...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryCopyrightJobListResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryCopyrightJobListResponseBody::Data>) };
    inline vector<QueryCopyrightJobListResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<QueryCopyrightJobListResponseBody::Data>) };
    inline QueryCopyrightJobListResponseBody& setData(const vector<QueryCopyrightJobListResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryCopyrightJobListResponseBody& setData(vector<QueryCopyrightJobListResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    shared_ptr<vector<QueryCopyrightJobListResponseBody::Data>> data_ {};
