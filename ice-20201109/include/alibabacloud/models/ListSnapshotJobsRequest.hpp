...
#ifndef ALIBABACLOUD_MODELS_LISTSNAPSHOTJOBSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTSNAPSHOTJOBSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListSnapshotJobsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListSnapshotJobsRequest& obj) { 
    ...
    ListSnapshotJobsRequest() = default ;
    ListSnapshotJobsRequest(const ListSnapshotJobsRequest &) = default ;
    ListSnapshotJobsRequest(ListSnapshotJobsRequest &&) = default ;
    ListSnapshotJobsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListSnapshotJobsRequest() = default ;
    ListSnapshotJobsRequest& operator=(const ListSnapshotJobsRequest &) = default ;
    ListSnapshotJobsRequest& operator=(ListSnapshotJobsRequest &&) = default ;
    ...
    inline ListSnapshotJobsRequest& setEndOfCreateTime(string endOfCreateTime) { DARABONBA_PTR_SET_VALUE(endOfCreateTime_, endOfCreateTime) };
    ...
    inline ListSnapshotJobsRequest& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline ListSnapshotJobsRequest& setNextPageToken(string nextPageToken) { DARABONBA_PTR_SET_VALUE(nextPageToken_, nextPageToken) };
    ...
    inline ListSnapshotJobsRequest& setOrderBy(string orderBy) { DARABONBA_PTR_SET_VALUE(orderBy_, orderBy) };
    ...
    inline ListSnapshotJobsRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListSnapshotJobsRequest& setStartOfCreateTime(string startOfCreateTime) { DARABONBA_PTR_SET_VALUE(startOfCreateTime_, startOfCreateTime) };
    ...
    inline ListSnapshotJobsRequest& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
