...
namespace Models
{
  ...
  public:
    ...
    inline const ListSystemTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSystemTemplatesResponseBody) };
    inline ListSystemTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSystemTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSystemTemplatesResponseBody> body_ {};
  };
