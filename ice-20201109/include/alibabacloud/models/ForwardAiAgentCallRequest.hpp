...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->calledNumber_ == nullptr
        && this->callerNumber_ == nullptr && this->errorPrompt_ == nullptr && this->instanceId_ == nullptr && this->transferPrompt_ == nullptr; };
    ...
    inline string getErrorPrompt() const { DARABONBA_PTR_GET_DEFAULT(errorPrompt_, "") };
    ...
    inline string getTransferPrompt() const { DARABONBA_PTR_GET_DEFAULT(transferPrompt_, "") };
