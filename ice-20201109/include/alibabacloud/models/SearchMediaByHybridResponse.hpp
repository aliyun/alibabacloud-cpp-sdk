...
namespace Models
{
  ...
  public:
    ...
    inline const SearchMediaByHybridResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchMediaByHybridResponseBody) };
    inline SearchMediaByHybridResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchMediaByHybridResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchMediaByHybridResponseBody> body_ {};
  };
