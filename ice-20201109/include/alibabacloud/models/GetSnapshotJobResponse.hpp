...
namespace Models
{
  ...
  public:
    ...
    inline const GetSnapshotJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetSnapshotJobResponseBody) };
    inline GetSnapshotJobResponseBody body() { DARABONBA_PTR_GET(body_, GetSnapshotJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetSnapshotJobResponseBody> body_ = nullptr;
  };
