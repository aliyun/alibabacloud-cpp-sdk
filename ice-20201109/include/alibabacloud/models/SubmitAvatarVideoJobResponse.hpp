...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitAvatarVideoJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SubmitAvatarVideoJobResponseBody) };
    inline SubmitAvatarVideoJobResponseBody body() { DARABONBA_PTR_GET(body_, SubmitAvatarVideoJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitAvatarVideoJobResponseBody> body_ = nullptr;
  };
