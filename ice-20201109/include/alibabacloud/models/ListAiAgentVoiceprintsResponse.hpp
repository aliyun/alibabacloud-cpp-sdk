...
namespace Models
{
  ...
  public:
    ...
    inline const ListAIAgentVoiceprintsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAIAgentVoiceprintsResponseBody) };
    inline ListAIAgentVoiceprintsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAIAgentVoiceprintsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAIAgentVoiceprintsResponseBody> body_ {};
  };
