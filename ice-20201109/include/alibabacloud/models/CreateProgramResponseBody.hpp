...
#ifndef ALIBABACLOUD_MODELS_CREATEPROGRAMRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEPROGRAMRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateProgramResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Program, program_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateProgramResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Program, program_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    CreateProgramResponseBody() = default ;
    CreateProgramResponseBody(const CreateProgramResponseBody &) = default ;
    CreateProgramResponseBody(CreateProgramResponseBody &&) = default ;
    CreateProgramResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateProgramResponseBody() = default ;
    CreateProgramResponseBody& operator=(const CreateProgramResponseBody &) = default ;
    CreateProgramResponseBody& operator=(CreateProgramResponseBody &&) = default ;
