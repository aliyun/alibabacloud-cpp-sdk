...
namespace Models
{
  ...
  public:
    ...
    inline const GetLivePackageChannelGroupResponseBody::LivePackageChannelGroup & getLivePackageChannelGroup() const { DARABONBA_PTR_GET_CONST(livePackageChannelGroup_, GetLivePackageChannelGroupResponseBody::LivePackageChannelGroup) };
    inline GetLivePackageChannelGroupResponseBody::LivePackageChannelGroup getLivePackageChannelGroup() { DARABONBA_PTR_GET(livePackageChannelGroup_, GetLivePackageChannelGroupResponseBody::LivePackageChannelGroup) };
    inline GetLivePackageChannelGroupResponseBody& setLivePackageChannelGroup(const GetLivePackageChannelGroupResponseBody::LivePackageChannelGroup & livePackageChannelGroup) { DARABONBA_PTR_SET_VALUE(livePackageChannelGroup_, livePackageChannelGroup) };
    inline GetLivePackageChannelGroupResponseBody& setLivePackageChannelGroup(GetLivePackageChannelGroupResponseBody::LivePackageChannelGroup && livePackageChannelGroup) { DARABONBA_PTR_SET_RVALUE(livePackageChannelGroup_, livePackageChannelGroup) };
  ...
  protected:
    ...
    shared_ptr<GetLivePackageChannelGroupResponseBody::LivePackageChannelGroup> livePackageChannelGroup_ {};
    // The request ID.
