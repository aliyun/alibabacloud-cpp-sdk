...
namespace Models
{
  ...
  public:
    ...
    inline const CloseStreamToSearchLibResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CloseStreamToSearchLibResponseBody) };
    inline CloseStreamToSearchLibResponseBody getBody() { DARABONBA_PTR_GET(body_, CloseStreamToSearchLibResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CloseStreamToSearchLibResponseBody> body_ {};
  };
