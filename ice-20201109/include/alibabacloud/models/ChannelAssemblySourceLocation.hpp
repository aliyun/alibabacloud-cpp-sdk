...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->arn_ == nullptr
        && this->baseUrl_ == nullptr && this->gmtCreate_ == nullptr && this->gmtModified_ == nullptr && this->segmentDeliveryConfigurations_ == nullptr && this->sourceLocationName_ == nullptr
        && this->state_ == nullptr; };
    // arn Field Functions 
    ...
    inline string getSegmentDeliveryConfigurations() const { DARABONBA_PTR_GET_DEFAULT(segmentDeliveryConfigurations_, "") };
