...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ScheduleDataAdBreaks> & adBreaks() const { DARABONBA_PTR_GET_CONST(adBreaks_, vector<ScheduleDataAdBreaks>) };
    inline vector<ScheduleDataAdBreaks> adBreaks() { DARABONBA_PTR_GET(adBreaks_, vector<ScheduleDataAdBreaks>) };
    inline ScheduleData& setAdBreaks(const vector<ScheduleDataAdBreaks> & adBreaks) { DARABONBA_PTR_SET_VALUE(adBreaks_, adBreaks) };
    inline ScheduleData& setAdBreaks(vector<ScheduleDataAdBreaks> && adBreaks) { DARABONBA_PTR_SET_RVALUE(adBreaks_, adBreaks) };
  ...
  protected:
    std::shared_ptr<vector<ScheduleDataAdBreaks>> adBreaks_ = nullptr;
