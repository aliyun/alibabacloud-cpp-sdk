...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDNADBResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDNADBResponseBody) };
    inline DeleteDNADBResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDNADBResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDNADBResponseBody> body_ {};
  };
