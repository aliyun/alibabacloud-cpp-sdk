...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->generateConfig_ == nullptr && this->title_ == nullptr && this->type_ == nullptr && this->userData_ == nullptr; };
    ...
    inline string getGenerateConfig() const { DARABONBA_PTR_GET_DEFAULT(generateConfig_, "") };
  ...
  protected:
    ...
    shared_ptr<string> generateConfig_ {};
    // The job title.
    // 
