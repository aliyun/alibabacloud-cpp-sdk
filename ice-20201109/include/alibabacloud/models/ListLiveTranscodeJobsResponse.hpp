...
namespace Models
{
  ...
  public:
    ...
    inline const ListLiveTranscodeJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLiveTranscodeJobsResponseBody) };
    inline ListLiveTranscodeJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLiveTranscodeJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLiveTranscodeJobsResponseBody> body_ {};
  };
