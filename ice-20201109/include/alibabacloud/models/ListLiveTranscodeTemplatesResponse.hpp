...
namespace Models
{
  ...
  public:
    ...
    inline const ListLiveTranscodeTemplatesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListLiveTranscodeTemplatesResponseBody) };
    inline ListLiveTranscodeTemplatesResponseBody body() { DARABONBA_PTR_GET(body_, ListLiveTranscodeTemplatesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListLiveTranscodeTemplatesResponseBody> body_ = nullptr;
  };
