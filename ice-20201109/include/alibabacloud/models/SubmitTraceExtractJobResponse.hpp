...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitTraceExtractJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitTraceExtractJobResponseBody) };
    inline SubmitTraceExtractJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitTraceExtractJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitTraceExtractJobResponseBody> body_ {};
  };
