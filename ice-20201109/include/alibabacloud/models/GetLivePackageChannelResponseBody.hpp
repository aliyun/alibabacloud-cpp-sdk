...
#ifndef ALIBABACLOUD_MODELS_GETLIVEPACKAGECHANNELRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETLIVEPACKAGECHANNELRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetLivePackageChannelResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(LivePackageChannel, livePackageChannel_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetLivePackageChannelResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(LivePackageChannel, livePackageChannel_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetLivePackageChannelResponseBody() = default ;
    GetLivePackageChannelResponseBody(const GetLivePackageChannelResponseBody &) = default ;
    GetLivePackageChannelResponseBody(GetLivePackageChannelResponseBody &&) = default ;
    GetLivePackageChannelResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetLivePackageChannelResponseBody() = default ;
    GetLivePackageChannelResponseBody& operator=(const GetLivePackageChannelResponseBody &) = default ;
    GetLivePackageChannelResponseBody& operator=(GetLivePackageChannelResponseBody &&) = default ;
    ...
    inline const GetLivePackageChannelResponseBody::LivePackageChannel & getLivePackageChannel() const { DARABONBA_PTR_GET_CONST(livePackageChannel_, GetLivePackageChannelResponseBody::LivePackageChannel) };
    inline GetLivePackageChannelResponseBody::LivePackageChannel getLivePackageChannel() { DARABONBA_PTR_GET(livePackageChannel_, GetLivePackageChannelResponseBody::LivePackageChannel) };
    inline GetLivePackageChannelResponseBody& setLivePackageChannel(const GetLivePackageChannelResponseBody::LivePackageChannel & livePackageChannel) { DARABONBA_PTR_SET_VALUE(livePackageChannel_, livePackageChannel) };
    inline GetLivePackageChannelResponseBody& setLivePackageChannel(GetLivePackageChannelResponseBody::LivePackageChannel && livePackageChannel) { DARABONBA_PTR_SET_RVALUE(livePackageChannel_, livePackageChannel) };
    ...
    inline GetLivePackageChannelResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // Details of the live package channel.
    shared_ptr<GetLivePackageChannelResponseBody::LivePackageChannel> livePackageChannel_ {};
    // The request ID.
