...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCustomizedVoiceJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCustomizedVoiceJobResponseBody) };
    inline CreateCustomizedVoiceJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCustomizedVoiceJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCustomizedVoiceJobResponseBody> body_ {};
  };
