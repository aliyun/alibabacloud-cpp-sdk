...
#ifndef ALIBABACLOUD_MODELS_CREATELIVEPACKAGEORIGINENDPOINTRESPONSEBODYLIVEPACKAGEORIGINENDPOINT_HPP_
#define ALIBABACLOUD_MODELS_CREATELIVEPACKAGEORIGINENDPOINTRESPONSEBODYLIVEPACKAGEORIGINENDPOINT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& obj) { 
    ...
    CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint() = default ;
    CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint(const CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint &) = default ;
    CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint(CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint &&) = default ;
    CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint() = default ;
    CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& operator=(const CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint &) = default ;
    CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& operator=(CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint &&) = default ;
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setAuthorizationCode(string authorizationCode) { DARABONBA_PTR_SET_VALUE(authorizationCode_, authorizationCode) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setChannelName(string channelName) { DARABONBA_PTR_SET_VALUE(channelName_, channelName) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setEndpointName(string endpointName) { DARABONBA_PTR_SET_VALUE(endpointName_, endpointName) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setEndpointUrl(string endpointUrl) { DARABONBA_PTR_SET_VALUE(endpointUrl_, endpointUrl) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setGroupName(string groupName) { DARABONBA_PTR_SET_VALUE(groupName_, groupName) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setIpBlacklist(string ipBlacklist) { DARABONBA_PTR_SET_VALUE(ipBlacklist_, ipBlacklist) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setIpWhitelist(string ipWhitelist) { DARABONBA_PTR_SET_VALUE(ipWhitelist_, ipWhitelist) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setLastModified(string lastModified) { DARABONBA_PTR_SET_VALUE(lastModified_, lastModified) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setLivePackagingConfig(const Models::LivePackagingConfig & livePackagingConfig) { DARABONBA_PTR_SET_VALUE(livePackagingConfig_, livePackagingConfig) };
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setLivePackagingConfig(Models::LivePackagingConfig && livePackagingConfig) { DARABONBA_PTR_SET_RVALUE(livePackagingConfig_, livePackagingConfig) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setManifestName(string manifestName) { DARABONBA_PTR_SET_VALUE(manifestName_, manifestName) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint& setTimeshiftVision(int32_t timeshiftVision) { DARABONBA_PTR_SET_VALUE(timeshiftVision_, timeshiftVision) };
