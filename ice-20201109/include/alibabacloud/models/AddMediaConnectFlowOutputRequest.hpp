...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cidrs_ == nullptr
        && return this->flowId_ == nullptr && return this->outputName_ == nullptr && return this->outputProtocol_ == nullptr && return this->outputToUrl_ == nullptr && return this->pairFlowId_ == nullptr
        && return this->pairInputName_ == nullptr && return this->playerLimit_ == nullptr && return this->srtLatency_ == nullptr && return this->srtPassphrase_ == nullptr && return this->srtPbkeyLen_ == nullptr; };
