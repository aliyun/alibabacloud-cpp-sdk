...
namespace Models
{
  ...
  public:
    ...
    inline string dynamicMetaDataMatchFields() const { DARABONBA_PTR_GET_DEFAULT(dynamicMetaDataMatchFields_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> dynamicMetaDataMatchFields_ = nullptr;
