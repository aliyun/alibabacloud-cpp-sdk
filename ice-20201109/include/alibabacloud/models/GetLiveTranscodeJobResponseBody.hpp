...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const Job::OutputStream & getOutputStream() const { DARABONBA_PTR_GET_CONST(outputStream_, Job::OutputStream) };
      inline Job::OutputStream getOutputStream() { DARABONBA_PTR_GET(outputStream_, Job::OutputStream) };
      inline Job& setOutputStream(const Job::OutputStream & outputStream) { DARABONBA_PTR_SET_VALUE(outputStream_, outputStream) };
      inline Job& setOutputStream(Job::OutputStream && outputStream) { DARABONBA_PTR_SET_RVALUE(outputStream_, outputStream) };
      ...
      inline Job& setStartMode(int32_t startMode) { DARABONBA_PTR_SET_VALUE(startMode_, startMode) };
      ...
      inline Job& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
      ...
      inline const Job::StreamInput & getStreamInput() const { DARABONBA_PTR_GET_CONST(streamInput_, Job::StreamInput) };
      inline Job::StreamInput getStreamInput() { DARABONBA_PTR_GET(streamInput_, Job::StreamInput) };
      inline Job& setStreamInput(const Job::StreamInput & streamInput) { DARABONBA_PTR_SET_VALUE(streamInput_, streamInput) };
      inline Job& setStreamInput(Job::StreamInput && streamInput) { DARABONBA_PTR_SET_RVALUE(streamInput_, streamInput) };
      ...
      inline Job& setTemplateType(string templateType) { DARABONBA_PTR_SET_VALUE(templateType_, templateType) };
    ...
    protected:
      ...
      // The information about the output stream.
      shared_ptr<Job::OutputStream> outputStream_ {};
    ...
    inline const GetLiveTranscodeJobResponseBody::Job & getJob() const { DARABONBA_PTR_GET_CONST(job_, GetLiveTranscodeJobResponseBody::Job) };
    inline GetLiveTranscodeJobResponseBody::Job getJob() { DARABONBA_PTR_GET(job_, GetLiveTranscodeJobResponseBody::Job) };
    inline GetLiveTranscodeJobResponseBody& setJob(const GetLiveTranscodeJobResponseBody::Job & job) { DARABONBA_PTR_SET_VALUE(job_, job) };
    inline GetLiveTranscodeJobResponseBody& setJob(GetLiveTranscodeJobResponseBody::Job && job) { DARABONBA_PTR_SET_RVALUE(job_, job) };
  ...
  protected:
    ...
    shared_ptr<GetLiveTranscodeJobResponseBody::Job> job_ {};
    // The request ID.
