...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRecognitionSampleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRecognitionSampleResponseBody) };
    inline CreateRecognitionSampleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRecognitionSampleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRecognitionSampleResponseBody> body_ {};
  };
