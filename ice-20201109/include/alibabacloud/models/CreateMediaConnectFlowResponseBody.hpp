...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMediaConnectFlowResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, CreateMediaConnectFlowResponseBody::Content) };
    inline CreateMediaConnectFlowResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, CreateMediaConnectFlowResponseBody::Content) };
    inline CreateMediaConnectFlowResponseBody& setContent(const CreateMediaConnectFlowResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline CreateMediaConnectFlowResponseBody& setContent(CreateMediaConnectFlowResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    // The response body.
    shared_ptr<CreateMediaConnectFlowResponseBody::Content> content_ {};
