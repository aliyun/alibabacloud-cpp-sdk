...
namespace Models
{
  ...
  public:
    ...
    inline const GetSystemTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSystemTemplateResponseBody) };
    inline GetSystemTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSystemTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSystemTemplateResponseBody> body_ {};
  };
