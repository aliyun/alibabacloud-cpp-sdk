...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitSceneTimelineOrganizationJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitSceneTimelineOrganizationJobResponseBody) };
    inline SubmitSceneTimelineOrganizationJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitSceneTimelineOrganizationJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitSceneTimelineOrganizationJobResponseBody> body_ {};
  };
