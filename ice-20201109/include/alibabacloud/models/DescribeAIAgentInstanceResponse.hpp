...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAIAgentInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAIAgentInstanceResponseBody) };
    inline DescribeAIAgentInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAIAgentInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAIAgentInstanceResponseBody> body_ {};
  };
