...
namespace Models
{
  ...
  public:
    ...
    inline const GetSnapshotUrlsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSnapshotUrlsResponseBody) };
    inline GetSnapshotUrlsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSnapshotUrlsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSnapshotUrlsResponseBody> body_ {};
  };
