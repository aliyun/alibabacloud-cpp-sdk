...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AIAgentId_ == nullptr
        && return this->agentConfig_ == nullptr && return this->chatSyncConfig_ == nullptr && return this->runtimeConfig_ == nullptr && return this->sessionId_ == nullptr && return this->templateConfig_ == nullptr
