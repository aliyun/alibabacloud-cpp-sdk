...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->category_ == nullptr
        && return this->gmtEnd_ == nullptr && return this->gmtStart_ == nullptr && return this->pageNo_ == nullptr && return this->pageSize_ == nullptr && return this->resourceArn_ == nullptr
        && return this->sortBy_ == nullptr && return this->sortByModifiedTime_ == nullptr; };
    // category Field Functions 
    bool hasCategory() const { return this->category_ != nullptr;};
    void deleteCategory() { this->category_ = nullptr;};
    inline string category() const { DARABONBA_PTR_GET_DEFAULT(category_, "") };
    inline ListAlertsRequest& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
    ...
    inline ListAlertsRequest& setGmtEnd(string gmtEnd) { DARABONBA_PTR_SET_VALUE(gmtEnd_, gmtEnd) };
    ...
    inline ListAlertsRequest& setGmtStart(string gmtStart) { DARABONBA_PTR_SET_VALUE(gmtStart_, gmtStart) };
    ...
    inline ListAlertsRequest& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline ListAlertsRequest& setResourceArn(string resourceArn) { DARABONBA_PTR_SET_VALUE(resourceArn_, resourceArn) };
    ...
    inline ListAlertsRequest& setSortBy(string sortBy) { DARABONBA_PTR_SET_VALUE(sortBy_, sortBy) };
    ...
    inline ListAlertsRequest& setSortByModifiedTime(string sortByModifiedTime) { DARABONBA_PTR_SET_VALUE(sortByModifiedTime_, sortByModifiedTime) };
