...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->businessConfig_ == nullptr
        ...
        && this->errorCode_ == nullptr && this->errorMessage_ == nullptr && this->modifiedSource_ == nullptr && this->modifiedTime_ == nullptr && this->projectId_ == nullptr
        && this->projectType_ == nullptr && this->status_ == nullptr && this->templateType_ == nullptr && this->title_ == nullptr; };
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && this->nextToken_ == nullptr && this->projectList_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline const vector<ListEditingProjectsResponseBody::ProjectList> & getProjectList() const { DARABONBA_PTR_GET_CONST(projectList_, vector<ListEditingProjectsResponseBody::ProjectList>) };
    inline vector<ListEditingProjectsResponseBody::ProjectList> getProjectList() { DARABONBA_PTR_GET(projectList_, vector<ListEditingProjectsResponseBody::ProjectList>) };
    inline ListEditingProjectsResponseBody& setProjectList(const vector<ListEditingProjectsResponseBody::ProjectList> & projectList) { DARABONBA_PTR_SET_VALUE(projectList_, projectList) };
    inline ListEditingProjectsResponseBody& setProjectList(vector<ListEditingProjectsResponseBody::ProjectList> && projectList) { DARABONBA_PTR_SET_RVALUE(projectList_, projectList) };
  ...
  protected:
    ...
    shared_ptr<vector<ListEditingProjectsResponseBody::ProjectList>> projectList_ {};
    // The request ID.
