...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitCopyrightJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SubmitCopyrightJobResponseBody::Data) };
    inline SubmitCopyrightJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SubmitCopyrightJobResponseBody::Data) };
    inline SubmitCopyrightJobResponseBody& setData(const SubmitCopyrightJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitCopyrightJobResponseBody& setData(SubmitCopyrightJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    shared_ptr<SubmitCopyrightJobResponseBody::Data> data_ {};
