...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeMeterImsMediaConvertUsageResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeMeterImsMediaConvertUsageResponseBodyData>) };
    inline vector<DescribeMeterImsMediaConvertUsageResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeMeterImsMediaConvertUsageResponseBodyData>) };
    inline DescribeMeterImsMediaConvertUsageResponseBody& setData(const vector<DescribeMeterImsMediaConvertUsageResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeMeterImsMediaConvertUsageResponseBody& setData(vector<DescribeMeterImsMediaConvertUsageResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeMeterImsMediaConvertUsageResponseBodyData>> data_ = nullptr;
    // The request ID.
