  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->transcodeStatus_ == nullptr && this->userData_ == nullptr; };
    ...
    class LiveMaterials : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const LiveMaterials& obj) { 
        DARABONBA_PTR_TO_JSON(AppName, appName_);
        DARABONBA_PTR_TO_JSON(DomainName, domainName_);
        DARABONBA_PTR_TO_JSON(LiveUrl, liveUrl_);
        DARABONBA_PTR_TO_JSON(StreamName, streamName_);
      };
      friend void from_json(const Darabonba::Json& j, LiveMaterials& obj) { 
        DARABONBA_PTR_FROM_JSON(AppName, appName_);
        DARABONBA_PTR_FROM_JSON(DomainName, domainName_);
        DARABONBA_PTR_FROM_JSON(LiveUrl, liveUrl_);
        DARABONBA_PTR_FROM_JSON(StreamName, streamName_);
      };
      LiveMaterials() = default ;
      LiveMaterials(const LiveMaterials &) = default ;
      LiveMaterials(LiveMaterials &&) = default ;
      LiveMaterials(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~LiveMaterials() = default ;
      LiveMaterials& operator=(const LiveMaterials &) = default ;
      LiveMaterials& operator=(LiveMaterials &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline LiveMaterials& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
      ...
      inline LiveMaterials& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };


      // liveUrl Field Functions 
      bool hasLiveUrl() const { return this->liveUrl_ != nullptr;};
      void deleteLiveUrl() { this->liveUrl_ = nullptr;};
      inline string getLiveUrl() const { DARABONBA_PTR_GET_DEFAULT(liveUrl_, "") };
      inline LiveMaterials& setLiveUrl(string liveUrl) { DARABONBA_PTR_SET_VALUE(liveUrl_, liveUrl) };
      ...
      inline LiveMaterials& setStreamName(string streamName) { DARABONBA_PTR_SET_VALUE(streamName_, streamName) };
    ...
    inline const vector<AddEditingProjectMaterialsResponseBody::LiveMaterials> & getLiveMaterials() const { DARABONBA_PTR_GET_CONST(liveMaterials_, vector<AddEditingProjectMaterialsResponseBody::LiveMaterials>) };
    inline vector<AddEditingProjectMaterialsResponseBody::LiveMaterials> getLiveMaterials() { DARABONBA_PTR_GET(liveMaterials_, vector<AddEditingProjectMaterialsResponseBody::LiveMaterials>) };
    inline AddEditingProjectMaterialsResponseBody& setLiveMaterials(const vector<AddEditingProjectMaterialsResponseBody::LiveMaterials> & liveMaterials) { DARABONBA_PTR_SET_VALUE(liveMaterials_, liveMaterials) };
    inline AddEditingProjectMaterialsResponseBody& setLiveMaterials(vector<AddEditingProjectMaterialsResponseBody::LiveMaterials> && liveMaterials) { DARABONBA_PTR_SET_RVALUE(liveMaterials_, liveMaterials) };
    ...
    inline const vector<AddEditingProjectMaterialsResponseBody::MediaInfos> & getMediaInfos() const { DARABONBA_PTR_GET_CONST(mediaInfos_, vector<AddEditingProjectMaterialsResponseBody::MediaInfos>) };
    inline vector<AddEditingProjectMaterialsResponseBody::MediaInfos> getMediaInfos() { DARABONBA_PTR_GET(mediaInfos_, vector<AddEditingProjectMaterialsResponseBody::MediaInfos>) };
    inline AddEditingProjectMaterialsResponseBody& setMediaInfos(const vector<AddEditingProjectMaterialsResponseBody::MediaInfos> & mediaInfos) { DARABONBA_PTR_SET_VALUE(mediaInfos_, mediaInfos) };
    inline AddEditingProjectMaterialsResponseBody& setMediaInfos(vector<AddEditingProjectMaterialsResponseBody::MediaInfos> && mediaInfos) { DARABONBA_PTR_SET_RVALUE(mediaInfos_, mediaInfos) };
    ...
    inline const vector<string> & getProjectMaterials() const { DARABONBA_PTR_GET_CONST(projectMaterials_, vector<string>) };
    inline vector<string> getProjectMaterials() { DARABONBA_PTR_GET(projectMaterials_, vector<string>) };
