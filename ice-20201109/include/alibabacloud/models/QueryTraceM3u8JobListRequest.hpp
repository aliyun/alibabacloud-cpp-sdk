...
#ifndef ALIBABACLOUD_MODELS_QUERYTRACEM3U8JOBLISTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_QUERYTRACEM3U8JOBLISTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryTraceM3u8JobListRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryTraceM3u8JobListRequest& obj) { 
    ...
    QueryTraceM3u8JobListRequest() = default ;
    QueryTraceM3u8JobListRequest(const QueryTraceM3u8JobListRequest &) = default ;
    QueryTraceM3u8JobListRequest(QueryTraceM3u8JobListRequest &&) = default ;
    QueryTraceM3u8JobListRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryTraceM3u8JobListRequest() = default ;
    QueryTraceM3u8JobListRequest& operator=(const QueryTraceM3u8JobListRequest &) = default ;
    QueryTraceM3u8JobListRequest& operator=(QueryTraceM3u8JobListRequest &&) = default ;
    ...
    inline QueryTraceM3u8JobListRequest& setCreateTimeEnd(int64_t createTimeEnd) { DARABONBA_PTR_SET_VALUE(createTimeEnd_, createTimeEnd) };
    ...
    inline QueryTraceM3u8JobListRequest& setCreateTimeStart(int64_t createTimeStart) { DARABONBA_PTR_SET_VALUE(createTimeStart_, createTimeStart) };
    ...
    inline QueryTraceM3u8JobListRequest& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline QueryTraceM3u8JobListRequest& setPageNumber(int64_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline QueryTraceM3u8JobListRequest& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
