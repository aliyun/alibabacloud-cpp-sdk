...
namespace Models
{
  ...
  public:
    ...
    inline const ListMediaLiveInputsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMediaLiveInputsResponseBody) };
    inline ListMediaLiveInputsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMediaLiveInputsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMediaLiveInputsResponseBody> body_ {};
  };
