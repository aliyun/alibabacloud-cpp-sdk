...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->audioSettings_ == nullptr
        && return this->channelId_ == nullptr && return this->inputAttachments_ == nullptr && return this->name_ == nullptr && return this->outputGroups_ == nullptr && return this->videoSettings_ == nullptr; };
