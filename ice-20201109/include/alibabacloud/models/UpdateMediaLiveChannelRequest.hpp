...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateMediaLiveChannelRequest::AudioSettings> & getAudioSettings() const { DARABONBA_PTR_GET_CONST(audioSettings_, vector<UpdateMediaLiveChannelRequest::AudioSettings>) };
    inline vector<UpdateMediaLiveChannelRequest::AudioSettings> getAudioSettings() { DARABONBA_PTR_GET(audioSettings_, vector<UpdateMediaLiveChannelRequest::AudioSettings>) };
    inline UpdateMediaLiveChannelRequest& setAudioSettings(const vector<UpdateMediaLiveChannelRequest::AudioSettings> & audioSettings) { DARABONBA_PTR_SET_VALUE(audioSettings_, audioSettings) };
    inline UpdateMediaLiveChannelRequest& setAudioSettings(vector<UpdateMediaLiveChannelRequest::AudioSettings> && audioSettings) { DARABONBA_PTR_SET_RVALUE(audioSettings_, audioSettings) };
    ...
    inline const vector<UpdateMediaLiveChannelRequest::InputAttachments> & getInputAttachments() const { DARABONBA_PTR_GET_CONST(inputAttachments_, vector<UpdateMediaLiveChannelRequest::InputAttachments>) };
    inline vector<UpdateMediaLiveChannelRequest::InputAttachments> getInputAttachments() { DARABONBA_PTR_GET(inputAttachments_, vector<UpdateMediaLiveChannelRequest::InputAttachments>) };
    inline UpdateMediaLiveChannelRequest& setInputAttachments(const vector<UpdateMediaLiveChannelRequest::InputAttachments> & inputAttachments) { DARABONBA_PTR_SET_VALUE(inputAttachments_, inputAttachments) };
    inline UpdateMediaLiveChannelRequest& setInputAttachments(vector<UpdateMediaLiveChannelRequest::InputAttachments> && inputAttachments) { DARABONBA_PTR_SET_RVALUE(inputAttachments_, inputAttachments) };
    ...
    inline const vector<UpdateMediaLiveChannelRequest::OutputGroups> & getOutputGroups() const { DARABONBA_PTR_GET_CONST(outputGroups_, vector<UpdateMediaLiveChannelRequest::OutputGroups>) };
    inline vector<UpdateMediaLiveChannelRequest::OutputGroups> getOutputGroups() { DARABONBA_PTR_GET(outputGroups_, vector<UpdateMediaLiveChannelRequest::OutputGroups>) };
    inline UpdateMediaLiveChannelRequest& setOutputGroups(const vector<UpdateMediaLiveChannelRequest::OutputGroups> & outputGroups) { DARABONBA_PTR_SET_VALUE(outputGroups_, outputGroups) };
    inline UpdateMediaLiveChannelRequest& setOutputGroups(vector<UpdateMediaLiveChannelRequest::OutputGroups> && outputGroups) { DARABONBA_PTR_SET_RVALUE(outputGroups_, outputGroups) };
    ...
    inline const vector<UpdateMediaLiveChannelRequest::VideoSettings> & getVideoSettings() const { DARABONBA_PTR_GET_CONST(videoSettings_, vector<UpdateMediaLiveChannelRequest::VideoSettings>) };
    inline vector<UpdateMediaLiveChannelRequest::VideoSettings> getVideoSettings() { DARABONBA_PTR_GET(videoSettings_, vector<UpdateMediaLiveChannelRequest::VideoSettings>) };
    inline UpdateMediaLiveChannelRequest& setVideoSettings(const vector<UpdateMediaLiveChannelRequest::VideoSettings> & videoSettings) { DARABONBA_PTR_SET_VALUE(videoSettings_, videoSettings) };
    inline UpdateMediaLiveChannelRequest& setVideoSettings(vector<UpdateMediaLiveChannelRequest::VideoSettings> && videoSettings) { DARABONBA_PTR_SET_RVALUE(videoSettings_, videoSettings) };


  protected:
    // The audio settings.
    shared_ptr<vector<UpdateMediaLiveChannelRequest::AudioSettings>> audioSettings_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<UpdateMediaLiveChannelRequest::InputAttachments>> inputAttachments_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<UpdateMediaLiveChannelRequest::OutputGroups>> outputGroups_ {};
    // The video settings.
    shared_ptr<vector<UpdateMediaLiveChannelRequest::VideoSettings>> videoSettings_ {};
  };
