...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cidrs_ == nullptr
        && this->flowId_ == nullptr && this->outputName_ == nullptr && this->outputToUrl_ == nullptr && this->playerLimit_ == nullptr && this->srtLatency_ == nullptr
    ...
    inline string getOutputToUrl() const { DARABONBA_PTR_GET_DEFAULT(outputToUrl_, "") };
    ...
    inline string getPlayerLimit() const { DARABONBA_PTR_GET_DEFAULT(playerLimit_, "") };
    ...
    inline string getSrtLatency() const { DARABONBA_PTR_GET_DEFAULT(srtLatency_, "") };
