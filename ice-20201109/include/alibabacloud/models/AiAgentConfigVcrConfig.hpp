...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->equipment_ == nullptr
        && return this->headMotion_ == nullptr && return this->invalidFrameMotion_ == nullptr && return this->lookAway_ == nullptr && return this->peopleCount_ == nullptr && return this->stillFrameMotion_ == nullptr; };
