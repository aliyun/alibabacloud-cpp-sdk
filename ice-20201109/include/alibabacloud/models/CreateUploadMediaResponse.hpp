...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUploadMediaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateUploadMediaResponseBody) };
    inline CreateUploadMediaResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateUploadMediaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateUploadMediaResponseBody> body_ {};
  };
