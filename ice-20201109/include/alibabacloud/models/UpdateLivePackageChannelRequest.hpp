...
#ifndef ALIBABACLOUD_MODELS_UPDATELIVEPACKAGECHANNELREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATELIVEPACKAGECHANNELREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateLivePackageChannelRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateLivePackageChannelRequest& obj) { 
    ...
    UpdateLivePackageChannelRequest() = default ;
    UpdateLivePackageChannelRequest(const UpdateLivePackageChannelRequest &) = default ;
    UpdateLivePackageChannelRequest(UpdateLivePackageChannelRequest &&) = default ;
    UpdateLivePackageChannelRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateLivePackageChannelRequest() = default ;
    UpdateLivePackageChannelRequest& operator=(const UpdateLivePackageChannelRequest &) = default ;
    UpdateLivePackageChannelRequest& operator=(UpdateLivePackageChannelRequest &&) = default ;
