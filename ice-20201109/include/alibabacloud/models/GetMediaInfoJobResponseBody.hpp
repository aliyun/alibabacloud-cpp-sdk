...
namespace Models
{
  ...
  public:
    ...
    inline const GetMediaInfoJobResponseBody::MediaInfoJob & getMediaInfoJob() const { DARABONBA_PTR_GET_CONST(mediaInfoJob_, GetMediaInfoJobResponseBody::MediaInfoJob) };
    inline GetMediaInfoJobResponseBody::MediaInfoJob getMediaInfoJob() { DARABONBA_PTR_GET(mediaInfoJob_, GetMediaInfoJobResponseBody::MediaInfoJob) };
    inline GetMediaInfoJobResponseBody& setMediaInfoJob(const GetMediaInfoJobResponseBody::MediaInfoJob & mediaInfoJob) { DARABONBA_PTR_SET_VALUE(mediaInfoJob_, mediaInfoJob) };
    inline GetMediaInfoJobResponseBody& setMediaInfoJob(GetMediaInfoJobResponseBody::MediaInfoJob && mediaInfoJob) { DARABONBA_PTR_SET_RVALUE(mediaInfoJob_, mediaInfoJob) };
  ...
  protected:
    // MediaInfoJobDTO
    shared_ptr<GetMediaInfoJobResponseBody::MediaInfoJob> mediaInfoJob_ {};
    // The request ID.
    shared_ptr<string> requestId_ {};
  };
