...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->config_ == nullptr
        && return this->DBId_ == nullptr && return this->input_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->pipelineId_ == nullptr
        && return this->primaryKey_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->templateId_ == nullptr && return this->userData_ == nullptr; };
    ...
    inline const SubmitDNAJobRequestInput & input() const { DARABONBA_PTR_GET_CONST(input_, SubmitDNAJobRequestInput) };
    inline SubmitDNAJobRequestInput input() { DARABONBA_PTR_GET(input_, SubmitDNAJobRequestInput) };
    inline SubmitDNAJobRequest& setInput(const SubmitDNAJobRequestInput & input) { DARABONBA_PTR_SET_VALUE(input_, input) };
    inline SubmitDNAJobRequest& setInput(SubmitDNAJobRequestInput && input) { DARABONBA_PTR_SET_RVALUE(input_, input) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<SubmitDNAJobRequestInput> input_ = nullptr;
