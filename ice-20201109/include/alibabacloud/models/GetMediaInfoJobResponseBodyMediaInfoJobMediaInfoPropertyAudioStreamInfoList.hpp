...
#ifndef ALIBABACLOUD_MODELS_GETMEDIAINFOJOBRESPONSEBODYMEDIAINFOJOBMEDIAINFOPROPERTYAUDIOSTREAMINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_GETMEDIAINFOJOBRESPONSEBODYMEDIAINFOJOBMEDIAINFOPROPERTYAUDIOSTREAMINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& obj) { 
    ...
    GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList() = default ;
    GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList(const GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList &) = default ;
    GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList(GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList &&) = default ;
    GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList() = default ;
    GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& operator=(const GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList &) = default ;
    GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& operator=(GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList &&) = default ;
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setBitrate(string bitrate) { DARABONBA_PTR_SET_VALUE(bitrate_, bitrate) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setChannelLayout(string channelLayout) { DARABONBA_PTR_SET_VALUE(channelLayout_, channelLayout) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setChannels(string channels) { DARABONBA_PTR_SET_VALUE(channels_, channels) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setCodecLongName(string codecLongName) { DARABONBA_PTR_SET_VALUE(codecLongName_, codecLongName) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setCodecName(string codecName) { DARABONBA_PTR_SET_VALUE(codecName_, codecName) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setCodecTag(string codecTag) { DARABONBA_PTR_SET_VALUE(codecTag_, codecTag) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setCodecTagString(string codecTagString) { DARABONBA_PTR_SET_VALUE(codecTagString_, codecTagString) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setCodecTimeBase(string codecTimeBase) { DARABONBA_PTR_SET_VALUE(codecTimeBase_, codecTimeBase) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setIndex(string index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setSampleFmt(string sampleFmt) { DARABONBA_PTR_SET_VALUE(sampleFmt_, sampleFmt) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setSampleRate(string sampleRate) { DARABONBA_PTR_SET_VALUE(sampleRate_, sampleRate) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList& setTimebase(string timebase) { DARABONBA_PTR_SET_VALUE(timebase_, timebase) };
