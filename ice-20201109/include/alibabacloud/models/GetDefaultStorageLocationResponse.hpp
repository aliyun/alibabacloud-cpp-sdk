...
namespace Models
{
  ...
  public:
    ...
    inline const GetDefaultStorageLocationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDefaultStorageLocationResponseBody) };
    inline GetDefaultStorageLocationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDefaultStorageLocationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDefaultStorageLocationResponseBody> body_ {};
  };
