...
#ifndef ALIBABACLOUD_MODELS_CHANNELASSEMBLYCHANNELOUTPUTCONFIGLIST_HPP_
#define ALIBABACLOUD_MODELS_CHANNELASSEMBLYCHANNELOUTPUTCONFIGLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChannelAssemblyChannelOutPutConfigList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChannelAssemblyChannelOutPutConfigList& obj) { 
    ...
    ChannelAssemblyChannelOutPutConfigList() = default ;
    ChannelAssemblyChannelOutPutConfigList(const ChannelAssemblyChannelOutPutConfigList &) = default ;
    ChannelAssemblyChannelOutPutConfigList(ChannelAssemblyChannelOutPutConfigList &&) = default ;
    ChannelAssemblyChannelOutPutConfigList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChannelAssemblyChannelOutPutConfigList() = default ;
    ChannelAssemblyChannelOutPutConfigList& operator=(const ChannelAssemblyChannelOutPutConfigList &) = default ;
    ChannelAssemblyChannelOutPutConfigList& operator=(ChannelAssemblyChannelOutPutConfigList &&) = default ;
    ...
    inline ChannelAssemblyChannelOutPutConfigList& setChannelName(string channelName) { DARABONBA_PTR_SET_VALUE(channelName_, channelName) };
    ...
    inline ChannelAssemblyChannelOutPutConfigList& setFormat(string format) { DARABONBA_PTR_SET_VALUE(format_, format) };
    ...
    inline ChannelAssemblyChannelOutPutConfigList& setManifestName(string manifestName) { DARABONBA_PTR_SET_VALUE(manifestName_, manifestName) };
    ...
    inline ChannelAssemblyChannelOutPutConfigList& setManifestSettings(string manifestSettings) { DARABONBA_PTR_SET_VALUE(manifestSettings_, manifestSettings) };
    ...
    inline ChannelAssemblyChannelOutPutConfigList& setPlaybackUrl(string playbackUrl) { DARABONBA_PTR_SET_VALUE(playbackUrl_, playbackUrl) };
    ...
    inline ChannelAssemblyChannelOutPutConfigList& setSourceGroupName(string sourceGroupName) { DARABONBA_PTR_SET_VALUE(sourceGroupName_, sourceGroupName) };
