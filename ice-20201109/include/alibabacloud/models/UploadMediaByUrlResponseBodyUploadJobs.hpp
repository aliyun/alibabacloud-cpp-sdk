...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->jobId_ == nullptr
        && return this->mediaId_ == nullptr && return this->sourceURL_ == nullptr; };
    ...
    inline UploadMediaByURLResponseBodyUploadJobs& setMediaId(string mediaId) { DARABONBA_PTR_SET_VALUE(mediaId_, mediaId) };
