...
namespace Models
{
  ...
  public:
    ...
    inline string getInputGroupShrink() const { DARABONBA_PTR_GET_DEFAULT(inputGroupShrink_, "") };
    ...
    inline string getOutputGroupShrink() const { DARABONBA_PTR_GET_DEFAULT(outputGroupShrink_, "") };
