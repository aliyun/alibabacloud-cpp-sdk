...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitVideoTranslationJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitVideoTranslationJobResponseBody) };
    inline SubmitVideoTranslationJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitVideoTranslationJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitVideoTranslationJobResponseBody> body_ {};
  };
