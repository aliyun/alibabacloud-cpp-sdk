...
namespace Models
{
  ...
  public:
    ...
    inline const DropSearchLibResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DropSearchLibResponseBody) };
    inline DropSearchLibResponseBody getBody() { DARABONBA_PTR_GET(body_, DropSearchLibResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DropSearchLibResponseBody> body_ {};
  };
