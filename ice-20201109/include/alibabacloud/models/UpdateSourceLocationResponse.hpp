...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSourceLocationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSourceLocationResponseBody) };
    inline UpdateSourceLocationResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateSourceLocationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateSourceLocationResponseBody> body_ {};
  };
