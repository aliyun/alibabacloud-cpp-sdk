...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AIAgentId_ == nullptr
        && return this->agentConfigShrink_ == nullptr && return this->chatSyncConfigShrink_ == nullptr && return this->expire_ == nullptr && return this->sessionId_ == nullptr && return this->templateConfigShrink_ == nullptr
