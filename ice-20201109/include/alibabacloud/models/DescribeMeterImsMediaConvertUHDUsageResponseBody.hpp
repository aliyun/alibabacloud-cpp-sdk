...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeMeterImsMediaConvertUHDUsageResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeMeterImsMediaConvertUHDUsageResponseBody::Data>) };
    inline vector<DescribeMeterImsMediaConvertUHDUsageResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<DescribeMeterImsMediaConvertUHDUsageResponseBody::Data>) };
    inline DescribeMeterImsMediaConvertUHDUsageResponseBody& setData(const vector<DescribeMeterImsMediaConvertUHDUsageResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeMeterImsMediaConvertUHDUsageResponseBody& setData(vector<DescribeMeterImsMediaConvertUHDUsageResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeMeterImsMediaConvertUHDUsageResponseBody::Data>> data_ {};
    // The request ID.
