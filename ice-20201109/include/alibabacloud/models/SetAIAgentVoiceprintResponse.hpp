...
namespace Models
{
  ...
  public:
    ...
    inline const SetAIAgentVoiceprintResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetAIAgentVoiceprintResponseBody) };
    inline SetAIAgentVoiceprintResponseBody getBody() { DARABONBA_PTR_GET(body_, SetAIAgentVoiceprintResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetAIAgentVoiceprintResponseBody> body_ {};
  };
