...
namespace Models
{
  ...
  public:
    ...
    inline const GetLiveRecordJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLiveRecordJobResponseBody) };
    inline GetLiveRecordJobResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLiveRecordJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLiveRecordJobResponseBody> body_ {};
  };
