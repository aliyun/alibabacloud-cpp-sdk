...
#ifndef ALIBABACLOUD_MODELS_MEDIACONVERTOUTPUTDETAILFILEMETAAUDIOSTREAMINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_MEDIACONVERTOUTPUTDETAILFILEMETAAUDIOSTREAMINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const MediaConvertOutputDetailFileMetaAudioStreamInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, MediaConvertOutputDetailFileMetaAudioStreamInfoList& obj) { 
    ...
    MediaConvertOutputDetailFileMetaAudioStreamInfoList() = default ;
    MediaConvertOutputDetailFileMetaAudioStreamInfoList(const MediaConvertOutputDetailFileMetaAudioStreamInfoList &) = default ;
    MediaConvertOutputDetailFileMetaAudioStreamInfoList(MediaConvertOutputDetailFileMetaAudioStreamInfoList &&) = default ;
    MediaConvertOutputDetailFileMetaAudioStreamInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~MediaConvertOutputDetailFileMetaAudioStreamInfoList() = default ;
    MediaConvertOutputDetailFileMetaAudioStreamInfoList& operator=(const MediaConvertOutputDetailFileMetaAudioStreamInfoList &) = default ;
    MediaConvertOutputDetailFileMetaAudioStreamInfoList& operator=(MediaConvertOutputDetailFileMetaAudioStreamInfoList &&) = default ;
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setBitrate(string bitrate) { DARABONBA_PTR_SET_VALUE(bitrate_, bitrate) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setChannelLayout(string channelLayout) { DARABONBA_PTR_SET_VALUE(channelLayout_, channelLayout) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setChannels(string channels) { DARABONBA_PTR_SET_VALUE(channels_, channels) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setCodecLongName(string codecLongName) { DARABONBA_PTR_SET_VALUE(codecLongName_, codecLongName) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setCodecName(string codecName) { DARABONBA_PTR_SET_VALUE(codecName_, codecName) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setCodecTag(string codecTag) { DARABONBA_PTR_SET_VALUE(codecTag_, codecTag) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setCodecTagString(string codecTagString) { DARABONBA_PTR_SET_VALUE(codecTagString_, codecTagString) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setCodecTimeBase(string codecTimeBase) { DARABONBA_PTR_SET_VALUE(codecTimeBase_, codecTimeBase) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setIndex(string index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setSampleFmt(string sampleFmt) { DARABONBA_PTR_SET_VALUE(sampleFmt_, sampleFmt) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setSampleRate(string sampleRate) { DARABONBA_PTR_SET_VALUE(sampleRate_, sampleRate) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline MediaConvertOutputDetailFileMetaAudioStreamInfoList& setTimebase(string timebase) { DARABONBA_PTR_SET_VALUE(timebase_, timebase) };
