...
namespace Models
{
  ...
  public:
    ...
    inline const GetVodPackagingGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVodPackagingGroupResponseBody) };
    inline GetVodPackagingGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVodPackagingGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVodPackagingGroupResponseBody> body_ {};
  };
