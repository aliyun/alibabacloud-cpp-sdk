...
namespace Models
{
  ...
  public:
    ...
    inline const GetPublicMediaInfoResponseBody::MediaInfo & getMediaInfo() const { DARABONBA_PTR_GET_CONST(mediaInfo_, GetPublicMediaInfoResponseBody::MediaInfo) };
    inline GetPublicMediaInfoResponseBody::MediaInfo getMediaInfo() { DARABONBA_PTR_GET(mediaInfo_, GetPublicMediaInfoResponseBody::MediaInfo) };
    inline GetPublicMediaInfoResponseBody& setMediaInfo(const GetPublicMediaInfoResponseBody::MediaInfo & mediaInfo) { DARABONBA_PTR_SET_VALUE(mediaInfo_, mediaInfo) };
    inline GetPublicMediaInfoResponseBody& setMediaInfo(GetPublicMediaInfoResponseBody::MediaInfo && mediaInfo) { DARABONBA_PTR_SET_RVALUE(mediaInfo_, mediaInfo) };
