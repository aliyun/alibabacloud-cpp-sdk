...
namespace Models
{
  ...
  public:
    ...
    inline const ListMediaLiveChannelsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListMediaLiveChannelsResponseBody) };
    inline ListMediaLiveChannelsResponseBody body() { DARABONBA_PTR_GET(body_, ListMediaLiveChannelsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListMediaLiveChannelsResponseBody> body_ = nullptr;
  };
