...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->channelName_ == nullptr
        && return this->clientToken_ == nullptr && return this->description_ == nullptr && return this->groupName_ == nullptr && return this->protocol_ == nullptr && return this->segmentCount_ == nullptr
        && return this->segmentDuration_ == nullptr; };
