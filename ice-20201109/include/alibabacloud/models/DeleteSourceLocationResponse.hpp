...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSourceLocationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSourceLocationResponseBody) };
    inline DeleteSourceLocationResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSourceLocationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSourceLocationResponseBody> body_ {};
  };
