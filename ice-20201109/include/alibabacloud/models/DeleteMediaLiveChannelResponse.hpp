...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMediaLiveChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMediaLiveChannelResponseBody) };
    inline DeleteMediaLiveChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMediaLiveChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMediaLiveChannelResponseBody> body_ {};
  };
