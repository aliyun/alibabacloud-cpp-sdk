...
namespace Models
{
  ...
  public:
    ...
    inline const GetProgramResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetProgramResponseBody) };
    inline GetProgramResponseBody body() { DARABONBA_PTR_GET(body_, GetProgramResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetProgramResponseBody> body_ = nullptr;
  };
