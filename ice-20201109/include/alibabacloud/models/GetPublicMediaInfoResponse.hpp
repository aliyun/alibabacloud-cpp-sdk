...
namespace Models
{
  ...
  public:
    ...
    inline const GetPublicMediaInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPublicMediaInfoResponseBody) };
    inline GetPublicMediaInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPublicMediaInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPublicMediaInfoResponseBody> body_ {};
  };
