...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLivePackageChannelResponseBody::LivePackageChannel & getLivePackageChannel() const { DARABONBA_PTR_GET_CONST(livePackageChannel_, UpdateLivePackageChannelResponseBody::LivePackageChannel) };
    inline UpdateLivePackageChannelResponseBody::LivePackageChannel getLivePackageChannel() { DARABONBA_PTR_GET(livePackageChannel_, UpdateLivePackageChannelResponseBody::LivePackageChannel) };
    inline UpdateLivePackageChannelResponseBody& setLivePackageChannel(const UpdateLivePackageChannelResponseBody::LivePackageChannel & livePackageChannel) { DARABONBA_PTR_SET_VALUE(livePackageChannel_, livePackageChannel) };
    inline UpdateLivePackageChannelResponseBody& setLivePackageChannel(UpdateLivePackageChannelResponseBody::LivePackageChannel && livePackageChannel) { DARABONBA_PTR_SET_RVALUE(livePackageChannel_, livePackageChannel) };
