...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentConfig_ == nullptr
        && return this->callLogUrl_ == nullptr && return this->gmtCreate_ == nullptr && return this->gmtModified_ == nullptr && return this->runtimeConfig_ == nullptr && return this->sessionId_ == nullptr
        && return this->status_ == nullptr && return this->templateConfig_ == nullptr && return this->userData_ == nullptr; };
