...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAIAgentInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAIAgentInstanceResponseBody) };
    inline UpdateAIAgentInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAIAgentInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAIAgentInstanceResponseBody> body_ {};
  };
