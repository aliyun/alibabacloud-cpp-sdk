...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->channelName_ == nullptr
        && return this->groupName_ == nullptr && return this->rotateCredentials_ == nullptr; };
    ...
    inline int32_t rotateCredentials() const { DARABONBA_PTR_GET_DEFAULT(rotateCredentials_, 0) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<int32_t> rotateCredentials_ = nullptr;
  };
