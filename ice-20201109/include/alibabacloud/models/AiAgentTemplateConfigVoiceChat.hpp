...
#ifndef ALIBABACLOUD_MODELS_AIAGENTTEMPLATECONFIGVOICECHAT_HPP_
#define ALIBABACLOUD_MODELS_AIAGENTTEMPLATECONFIGVOICECHAT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AIAgentTemplateConfigVoiceChat& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AIAgentTemplateConfigVoiceChat& obj) { 
    ...
    AIAgentTemplateConfigVoiceChat() = default ;
    AIAgentTemplateConfigVoiceChat(const AIAgentTemplateConfigVoiceChat &) = default ;
    AIAgentTemplateConfigVoiceChat(AIAgentTemplateConfigVoiceChat &&) = default ;
    AIAgentTemplateConfigVoiceChat(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AIAgentTemplateConfigVoiceChat() = default ;
    AIAgentTemplateConfigVoiceChat& operator=(const AIAgentTemplateConfigVoiceChat &) = default ;
    AIAgentTemplateConfigVoiceChat& operator=(AIAgentTemplateConfigVoiceChat &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->asrHotWords_ == nullptr
        && return this->asrLanguageId_ == nullptr && return this->asrMaxSilence_ == nullptr && return this->avatarUrl_ == nullptr && return this->avatarUrlType_ == nullptr && return this->bailianAppParams_ == nullptr
        && return this->charBreak_ == nullptr && return this->enableIntelligentSegment_ == nullptr && return this->enablePushToTalk_ == nullptr && return this->enableVoiceInterrupt_ == nullptr && return this->gracefulShutdown_ == nullptr
        && return this->greeting_ == nullptr && return this->interruptWords_ == nullptr && return this->llmHistory_ == nullptr && return this->llmHistoryLimit_ == nullptr && return this->llmSystemPrompt_ == nullptr
        && return this->maxIdleTime_ == nullptr && return this->useVoiceprint_ == nullptr && return this->userOfflineTimeout_ == nullptr && return this->userOnlineTimeout_ == nullptr && return this->vadLevel_ == nullptr
        && return this->voiceId_ == nullptr && return this->voiceIdList_ == nullptr && return this->voiceprintId_ == nullptr && return this->volume_ == nullptr && return this->wakeUpQuery_ == nullptr
    ...
    inline AIAgentTemplateConfigVoiceChat& setAsrHotWords(const vector<string> & asrHotWords) { DARABONBA_PTR_SET_VALUE(asrHotWords_, asrHotWords) };
    inline AIAgentTemplateConfigVoiceChat& setAsrHotWords(vector<string> && asrHotWords) { DARABONBA_PTR_SET_RVALUE(asrHotWords_, asrHotWords) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setAsrLanguageId(string asrLanguageId) { DARABONBA_PTR_SET_VALUE(asrLanguageId_, asrLanguageId) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setAsrMaxSilence(int32_t asrMaxSilence) { DARABONBA_PTR_SET_VALUE(asrMaxSilence_, asrMaxSilence) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setAvatarUrl(string avatarUrl) { DARABONBA_PTR_SET_VALUE(avatarUrl_, avatarUrl) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setAvatarUrlType(string avatarUrlType) { DARABONBA_PTR_SET_VALUE(avatarUrlType_, avatarUrlType) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setBailianAppParams(string bailianAppParams) { DARABONBA_PTR_SET_VALUE(bailianAppParams_, bailianAppParams) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setCharBreak(bool charBreak) { DARABONBA_PTR_SET_VALUE(charBreak_, charBreak) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setEnableIntelligentSegment(bool enableIntelligentSegment) { DARABONBA_PTR_SET_VALUE(enableIntelligentSegment_, enableIntelligentSegment) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setEnablePushToTalk(bool enablePushToTalk) { DARABONBA_PTR_SET_VALUE(enablePushToTalk_, enablePushToTalk) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setEnableVoiceInterrupt(bool enableVoiceInterrupt) { DARABONBA_PTR_SET_VALUE(enableVoiceInterrupt_, enableVoiceInterrupt) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setGracefulShutdown(bool gracefulShutdown) { DARABONBA_PTR_SET_VALUE(gracefulShutdown_, gracefulShutdown) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setGreeting(string greeting) { DARABONBA_PTR_SET_VALUE(greeting_, greeting) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setInterruptWords(const vector<string> & interruptWords) { DARABONBA_PTR_SET_VALUE(interruptWords_, interruptWords) };
    inline AIAgentTemplateConfigVoiceChat& setInterruptWords(vector<string> && interruptWords) { DARABONBA_PTR_SET_RVALUE(interruptWords_, interruptWords) };
    ...
    inline const vector<Models::AIAgentTemplateConfigVoiceChatLlmHistory> & llmHistory() const { DARABONBA_PTR_GET_CONST(llmHistory_, vector<Models::AIAgentTemplateConfigVoiceChatLlmHistory>) };
    inline vector<Models::AIAgentTemplateConfigVoiceChatLlmHistory> llmHistory() { DARABONBA_PTR_GET(llmHistory_, vector<Models::AIAgentTemplateConfigVoiceChatLlmHistory>) };
    inline AIAgentTemplateConfigVoiceChat& setLlmHistory(const vector<Models::AIAgentTemplateConfigVoiceChatLlmHistory> & llmHistory) { DARABONBA_PTR_SET_VALUE(llmHistory_, llmHistory) };
    inline AIAgentTemplateConfigVoiceChat& setLlmHistory(vector<Models::AIAgentTemplateConfigVoiceChatLlmHistory> && llmHistory) { DARABONBA_PTR_SET_RVALUE(llmHistory_, llmHistory) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setLlmHistoryLimit(int32_t llmHistoryLimit) { DARABONBA_PTR_SET_VALUE(llmHistoryLimit_, llmHistoryLimit) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setLlmSystemPrompt(string llmSystemPrompt) { DARABONBA_PTR_SET_VALUE(llmSystemPrompt_, llmSystemPrompt) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setMaxIdleTime(int32_t maxIdleTime) { DARABONBA_PTR_SET_VALUE(maxIdleTime_, maxIdleTime) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setUseVoiceprint(bool useVoiceprint) { DARABONBA_PTR_SET_VALUE(useVoiceprint_, useVoiceprint) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setUserOfflineTimeout(int32_t userOfflineTimeout) { DARABONBA_PTR_SET_VALUE(userOfflineTimeout_, userOfflineTimeout) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setUserOnlineTimeout(int32_t userOnlineTimeout) { DARABONBA_PTR_SET_VALUE(userOnlineTimeout_, userOnlineTimeout) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setVadLevel(int32_t vadLevel) { DARABONBA_PTR_SET_VALUE(vadLevel_, vadLevel) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setVoiceId(string voiceId) { DARABONBA_PTR_SET_VALUE(voiceId_, voiceId) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setVoiceIdList(const vector<string> & voiceIdList) { DARABONBA_PTR_SET_VALUE(voiceIdList_, voiceIdList) };
    inline AIAgentTemplateConfigVoiceChat& setVoiceIdList(vector<string> && voiceIdList) { DARABONBA_PTR_SET_RVALUE(voiceIdList_, voiceIdList) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setVoiceprintId(string voiceprintId) { DARABONBA_PTR_SET_VALUE(voiceprintId_, voiceprintId) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setVolume(int64_t volume) { DARABONBA_PTR_SET_VALUE(volume_, volume) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setWakeUpQuery(string wakeUpQuery) { DARABONBA_PTR_SET_VALUE(wakeUpQuery_, wakeUpQuery) };
    ...
    inline AIAgentTemplateConfigVoiceChat& setWorkflowOverrideParams(string workflowOverrideParams) { DARABONBA_PTR_SET_VALUE(workflowOverrideParams_, workflowOverrideParams) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::AIAgentTemplateConfigVoiceChatLlmHistory>> llmHistory_ = nullptr;
