...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePipelineResponseBodyPipeline & pipeline() const { DARABONBA_PTR_GET_CONST(pipeline_, CreatePipelineResponseBodyPipeline) };
    inline CreatePipelineResponseBodyPipeline pipeline() { DARABONBA_PTR_GET(pipeline_, CreatePipelineResponseBodyPipeline) };
    inline CreatePipelineResponseBody& setPipeline(const CreatePipelineResponseBodyPipeline & pipeline) { DARABONBA_PTR_SET_VALUE(pipeline_, pipeline) };
    inline CreatePipelineResponseBody& setPipeline(CreatePipelineResponseBodyPipeline && pipeline) { DARABONBA_PTR_SET_RVALUE(pipeline_, pipeline) };
  ...
  protected:
    ...
    std::shared_ptr<CreatePipelineResponseBodyPipeline> pipeline_ = nullptr;
    // The request ID.
