...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<Channels::AudioSettings> & getAudioSettings() const { DARABONBA_PTR_GET_CONST(audioSettings_, vector<Channels::AudioSettings>) };
      inline vector<Channels::AudioSettings> getAudioSettings() { DARABONBA_PTR_GET(audioSettings_, vector<Channels::AudioSettings>) };
      inline Channels& setAudioSettings(const vector<Channels::AudioSettings> & audioSettings) { DARABONBA_PTR_SET_VALUE(audioSettings_, audioSettings) };
      inline Channels& setAudioSettings(vector<Channels::AudioSettings> && audioSettings) { DARABONBA_PTR_SET_RVALUE(audioSettings_, audioSettings) };
      ...
      inline Channels& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
      ...
      inline const vector<Channels::InputAttachments> & getInputAttachments() const { DARABONBA_PTR_GET_CONST(inputAttachments_, vector<Channels::InputAttachments>) };
      inline vector<Channels::InputAttachments> getInputAttachments() { DARABONBA_PTR_GET(inputAttachments_, vector<Channels::InputAttachments>) };
      inline Channels& setInputAttachments(const vector<Channels::InputAttachments> & inputAttachments) { DARABONBA_PTR_SET_VALUE(inputAttachments_, inputAttachments) };
      inline Channels& setInputAttachments(vector<Channels::InputAttachments> && inputAttachments) { DARABONBA_PTR_SET_RVALUE(inputAttachments_, inputAttachments) };
      ...
      inline Channels& setLastStartTime(string lastStartTime) { DARABONBA_PTR_SET_VALUE(lastStartTime_, lastStartTime) };
      ...
      inline Channels& setLastStopTime(string lastStopTime) { DARABONBA_PTR_SET_VALUE(lastStopTime_, lastStopTime) };
      ...
      inline const vector<Channels::OutputGroups> & getOutputGroups() const { DARABONBA_PTR_GET_CONST(outputGroups_, vector<Channels::OutputGroups>) };
      inline vector<Channels::OutputGroups> getOutputGroups() { DARABONBA_PTR_GET(outputGroups_, vector<Channels::OutputGroups>) };
      inline Channels& setOutputGroups(const vector<Channels::OutputGroups> & outputGroups) { DARABONBA_PTR_SET_VALUE(outputGroups_, outputGroups) };
      inline Channels& setOutputGroups(vector<Channels::OutputGroups> && outputGroups) { DARABONBA_PTR_SET_RVALUE(outputGroups_, outputGroups) };
      ...
      inline Channels& setState(string state) { DARABONBA_PTR_SET_VALUE(state_, state) };
      ...
      inline const vector<Channels::VideoSettings> & getVideoSettings() const { DARABONBA_PTR_GET_CONST(videoSettings_, vector<Channels::VideoSettings>) };
      inline vector<Channels::VideoSettings> getVideoSettings() { DARABONBA_PTR_GET(videoSettings_, vector<Channels::VideoSettings>) };
      inline Channels& setVideoSettings(const vector<Channels::VideoSettings> & videoSettings) { DARABONBA_PTR_SET_VALUE(videoSettings_, videoSettings) };
      inline Channels& setVideoSettings(vector<Channels::VideoSettings> && videoSettings) { DARABONBA_PTR_SET_RVALUE(videoSettings_, videoSettings) };


    protected:
      // The audio settings.
      shared_ptr<vector<Channels::AudioSettings>> audioSettings_ {};
      ...
      shared_ptr<vector<Channels::InputAttachments>> inputAttachments_ {};
      ...
      shared_ptr<string> name_ {};
      // The output groups.
      shared_ptr<vector<Channels::OutputGroups>> outputGroups_ {};
      // The state of the channel. Valid values: IDLE, STARTING, RUNNING, RECOVERING, and STOPPING.
      shared_ptr<string> state_ {};
      // The video settings.
      shared_ptr<vector<Channels::VideoSettings>> videoSettings_ {};
    };
    ...
    inline const vector<ListMediaLiveChannelsResponseBody::Channels> & getChannels() const { DARABONBA_PTR_GET_CONST(channels_, vector<ListMediaLiveChannelsResponseBody::Channels>) };
    inline vector<ListMediaLiveChannelsResponseBody::Channels> getChannels() { DARABONBA_PTR_GET(channels_, vector<ListMediaLiveChannelsResponseBody::Channels>) };
    inline ListMediaLiveChannelsResponseBody& setChannels(const vector<ListMediaLiveChannelsResponseBody::Channels> & channels) { DARABONBA_PTR_SET_VALUE(channels_, channels) };
    inline ListMediaLiveChannelsResponseBody& setChannels(vector<ListMediaLiveChannelsResponseBody::Channels> && channels) { DARABONBA_PTR_SET_RVALUE(channels_, channels) };
  ...
  protected:
    // The channels.
    shared_ptr<vector<ListMediaLiveChannelsResponseBody::Channels>> channels_ {};
