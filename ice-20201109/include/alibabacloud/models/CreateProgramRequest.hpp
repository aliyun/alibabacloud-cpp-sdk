...
#ifndef ALIBABACLOUD_MODELS_CREATEPROGRAMREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEPROGRAMREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateProgramRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateProgramRequest& obj) { 
    ...
    CreateProgramRequest(const CreateProgramRequest &) = default ;
    CreateProgramRequest(CreateProgramRequest &&) = default ;
    CreateProgramRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateProgramRequest() = default ;
    CreateProgramRequest& operator=(const CreateProgramRequest &) = default ;
    CreateProgramRequest& operator=(CreateProgramRequest &&) = default ;
    ...
    inline CreateProgramRequest& setAdBreaks(string adBreaks) { DARABONBA_PTR_SET_VALUE(adBreaks_, adBreaks) };
    ...
    inline CreateProgramRequest& setChannelName(string channelName) { DARABONBA_PTR_SET_VALUE(channelName_, channelName) };
    ...
    inline CreateProgramRequest& setClipRange(string clipRange) { DARABONBA_PTR_SET_VALUE(clipRange_, clipRange) };
    ...
    inline CreateProgramRequest& setProgramName(string programName) { DARABONBA_PTR_SET_VALUE(programName_, programName) };
    ...
    inline CreateProgramRequest& setSourceLocationName(string sourceLocationName) { DARABONBA_PTR_SET_VALUE(sourceLocationName_, sourceLocationName) };
    ...
    inline CreateProgramRequest& setSourceName(string sourceName) { DARABONBA_PTR_SET_VALUE(sourceName_, sourceName) };
    ...
    inline CreateProgramRequest& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline CreateProgramRequest& setTransition(string transition) { DARABONBA_PTR_SET_VALUE(transition_, transition) };
