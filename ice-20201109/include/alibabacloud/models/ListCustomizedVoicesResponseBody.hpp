...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomizedVoicesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCustomizedVoicesResponseBodyData) };
    inline ListCustomizedVoicesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCustomizedVoicesResponseBodyData) };
    inline ListCustomizedVoicesResponseBody& setData(const ListCustomizedVoicesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCustomizedVoicesResponseBody& setData(ListCustomizedVoicesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListCustomizedVoicesResponseBodyData> data_ = nullptr;
    // The request ID.
