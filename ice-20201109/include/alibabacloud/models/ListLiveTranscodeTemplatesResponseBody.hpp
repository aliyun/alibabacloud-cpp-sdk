...
namespace Models
{
  ...
  public:
    ...
    class TemplateContentList : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const TemplateContentList& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, TemplateContentList& obj) { 
      ...
      TemplateContentList() = default ;
      TemplateContentList(const TemplateContentList &) = default ;
      TemplateContentList(TemplateContentList &&) = default ;
      TemplateContentList(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~TemplateContentList() = default ;
      TemplateContentList& operator=(const TemplateContentList &) = default ;
      TemplateContentList& operator=(TemplateContentList &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline TemplateContentList& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
      ...
      inline TemplateContentList& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
      ...
      inline TemplateContentList& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };


      // templateConfig Field Functions 
      bool hasTemplateConfig() const { return this->templateConfig_ != nullptr;};
      void deleteTemplateConfig() { this->templateConfig_ = nullptr;};
      inline const TemplateContentList::TemplateConfig & getTemplateConfig() const { DARABONBA_PTR_GET_CONST(templateConfig_, TemplateContentList::TemplateConfig) };
      inline TemplateContentList::TemplateConfig getTemplateConfig() { DARABONBA_PTR_GET(templateConfig_, TemplateContentList::TemplateConfig) };
      inline TemplateContentList& setTemplateConfig(const TemplateContentList::TemplateConfig & templateConfig) { DARABONBA_PTR_SET_VALUE(templateConfig_, templateConfig) };
      inline TemplateContentList& setTemplateConfig(TemplateContentList::TemplateConfig && templateConfig) { DARABONBA_PTR_SET_RVALUE(templateConfig_, templateConfig) };
      ...
      inline TemplateContentList& setTemplateId(string templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
      ...
      inline TemplateContentList& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    protected:
      ...
      shared_ptr<TemplateContentList::TemplateConfig> templateConfig_ {};
      // The template ID.
    ...
    inline const vector<ListLiveTranscodeTemplatesResponseBody::TemplateContentList> & getTemplateContentList() const { DARABONBA_PTR_GET_CONST(templateContentList_, vector<ListLiveTranscodeTemplatesResponseBody::TemplateContentList>) };
    inline vector<ListLiveTranscodeTemplatesResponseBody::TemplateContentList> getTemplateContentList() { DARABONBA_PTR_GET(templateContentList_, vector<ListLiveTranscodeTemplatesResponseBody::TemplateContentList>) };
    inline ListLiveTranscodeTemplatesResponseBody& setTemplateContentList(const vector<ListLiveTranscodeTemplatesResponseBody::TemplateContentList> & templateContentList) { DARABONBA_PTR_SET_VALUE(templateContentList_, templateContentList) };
    inline ListLiveTranscodeTemplatesResponseBody& setTemplateContentList(vector<ListLiveTranscodeTemplatesResponseBody::TemplateContentList> && templateContentList) { DARABONBA_PTR_SET_RVALUE(templateContentList_, templateContentList) };
  ...
  protected:
    ...
    shared_ptr<vector<ListLiveTranscodeTemplatesResponseBody::TemplateContentList>> templateContentList_ {};
