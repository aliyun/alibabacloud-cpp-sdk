...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDNAFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDNAFilesResponseBody) };
    inline DeleteDNAFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDNAFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDNAFilesResponseBody> body_ {};
  };
