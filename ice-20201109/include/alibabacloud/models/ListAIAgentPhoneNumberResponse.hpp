...
namespace Models
{
  ...
  public:
    ...
    inline const ListAIAgentPhoneNumberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAIAgentPhoneNumberResponseBody) };
    inline ListAIAgentPhoneNumberResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAIAgentPhoneNumberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAIAgentPhoneNumberResponseBody> body_ {};
  };
