...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitCustomizedVoiceJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitCustomizedVoiceJobResponseBody) };
    inline SubmitCustomizedVoiceJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitCustomizedVoiceJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitCustomizedVoiceJobResponseBody> body_ {};
  };
