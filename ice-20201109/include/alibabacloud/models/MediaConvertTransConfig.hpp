...
namespace Models
{
  ...
  public:
    ...
    inline bool isCheckAudioBitrate() const { DARABONBA_PTR_GET_DEFAULT(isCheckAudioBitrate_, false) };
    ...
    inline bool isCheckAudioBitrateFail() const { DARABONBA_PTR_GET_DEFAULT(isCheckAudioBitrateFail_, false) };
    ...
    inline bool isCheckReso() const { DARABONBA_PTR_GET_DEFAULT(isCheckReso_, false) };
    ...
    inline bool isCheckResoFail() const { DARABONBA_PTR_GET_DEFAULT(isCheckResoFail_, false) };
    ...
    inline bool isCheckVideoBitrate() const { DARABONBA_PTR_GET_DEFAULT(isCheckVideoBitrate_, false) };
    ...
    inline bool isCheckVideoBitrateFail() const { DARABONBA_PTR_GET_DEFAULT(isCheckVideoBitrateFail_, false) };
  ...
  protected:
    ...
    std::shared_ptr<bool> isCheckAudioBitrate_ = nullptr;
    std::shared_ptr<bool> isCheckAudioBitrateFail_ = nullptr;
    std::shared_ptr<bool> isCheckReso_ = nullptr;
    std::shared_ptr<bool> isCheckResoFail_ = nullptr;
    std::shared_ptr<bool> isCheckVideoBitrate_ = nullptr;
    std::shared_ptr<bool> isCheckVideoBitrateFail_ = nullptr;
