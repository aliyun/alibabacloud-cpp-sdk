...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adMarkerPassthrough_ == nullptr
        && return this->adsUrl_ == nullptr && return this->cdnAdSegmentUrlPrefix_ == nullptr && return this->cdnContentSegmentUrlPrefix_ == nullptr && return this->configAliases_ == nullptr && return this->contentUrlPrefix_ == nullptr
        && return this->name_ == nullptr && return this->personalizationThreshold_ == nullptr && return this->slateAdUrl_ == nullptr; };
