...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMediaLiveInputSecurityGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMediaLiveInputSecurityGroupResponseBody) };
    inline DeleteMediaLiveInputSecurityGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMediaLiveInputSecurityGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMediaLiveInputSecurityGroupResponseBody> body_ {};
  };
