...
namespace Models
{
  ...
  public:
    ...
    inline const GetVodPackagingAssetResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetVodPackagingAssetResponseBody) };
    inline GetVodPackagingAssetResponseBody body() { DARABONBA_PTR_GET(body_, GetVodPackagingAssetResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetVodPackagingAssetResponseBody> body_ = nullptr;
  };
