...
namespace Models
{
  ...
  public:
    ...
    inline const SearchIndexJobRerunResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SearchIndexJobRerunResponseBodyData) };
    inline SearchIndexJobRerunResponseBodyData data() { DARABONBA_PTR_GET(data_, SearchIndexJobRerunResponseBodyData) };
    inline SearchIndexJobRerunResponseBody& setData(const SearchIndexJobRerunResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SearchIndexJobRerunResponseBody& setData(SearchIndexJobRerunResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<SearchIndexJobRerunResponseBodyData> data_ = nullptr;
    // The request ID.
