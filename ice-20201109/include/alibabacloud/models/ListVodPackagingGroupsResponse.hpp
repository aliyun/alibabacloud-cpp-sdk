...
namespace Models
{
  ...
  public:
    ...
    inline const ListVodPackagingGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVodPackagingGroupsResponseBody) };
    inline ListVodPackagingGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVodPackagingGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVodPackagingGroupsResponseBody> body_ {};
  };
