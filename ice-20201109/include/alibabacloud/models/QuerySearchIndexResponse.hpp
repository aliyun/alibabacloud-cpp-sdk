...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySearchIndexResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QuerySearchIndexResponseBody) };
    inline QuerySearchIndexResponseBody getBody() { DARABONBA_PTR_GET(body_, QuerySearchIndexResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QuerySearchIndexResponseBody> body_ {};
  };
