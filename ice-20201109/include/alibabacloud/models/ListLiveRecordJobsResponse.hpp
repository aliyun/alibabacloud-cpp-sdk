...
namespace Models
{
  ...
  public:
    ...
    inline const ListLiveRecordJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLiveRecordJobsResponseBody) };
    inline ListLiveRecordJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLiveRecordJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLiveRecordJobsResponseBody> body_ {};
  };
