...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->jobId_ == nullptr
        && return this->traceMediaId_ == nullptr; };
    ...
    inline SubmitTraceAbJobResponseBodyData& setTraceMediaId(string traceMediaId) { DARABONBA_PTR_SET_VALUE(traceMediaId_, traceMediaId) };
