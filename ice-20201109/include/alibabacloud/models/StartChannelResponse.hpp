...
namespace Models
{
  ...
  public:
    ...
    inline const StartChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartChannelResponseBody) };
    inline StartChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, StartChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartChannelResponseBody> body_ {};
  };
