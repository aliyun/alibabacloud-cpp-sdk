...
namespace Models
{
  ...
  public:
    ...
    inline const QueryVideoCognitionJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryVideoCognitionJobResponseBody) };
    inline QueryVideoCognitionJobResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryVideoCognitionJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryVideoCognitionJobResponseBody> body_ {};
  };
