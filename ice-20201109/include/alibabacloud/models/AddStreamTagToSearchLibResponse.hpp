...
namespace Models
{
  ...
  public:
    ...
    inline const AddStreamTagToSearchLibResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddStreamTagToSearchLibResponseBody) };
    inline AddStreamTagToSearchLibResponseBody getBody() { DARABONBA_PTR_GET(body_, AddStreamTagToSearchLibResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddStreamTagToSearchLibResponseBody> body_ {};
  };
