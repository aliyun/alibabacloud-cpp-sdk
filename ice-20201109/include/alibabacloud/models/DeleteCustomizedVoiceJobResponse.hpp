...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCustomizedVoiceJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteCustomizedVoiceJobResponseBody) };
    inline DeleteCustomizedVoiceJobResponseBody body() { DARABONBA_PTR_GET(body_, DeleteCustomizedVoiceJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteCustomizedVoiceJobResponseBody> body_ = nullptr;
  };
