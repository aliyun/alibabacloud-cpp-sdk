...
#ifndef ALIBABACLOUD_MODELS_LISTMEDIAINFOJOBSRESPONSEBODYJOBSMEDIAINFOPROPERTYAUDIOSTREAMINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_LISTMEDIAINFOJOBSRESPONSEBODYJOBSMEDIAINFOPROPERTYAUDIOSTREAMINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& obj) { 
    ...
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList() = default ;
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList(const ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList &) = default ;
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList(ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList &&) = default ;
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList() = default ;
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& operator=(const ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList &) = default ;
    ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& operator=(ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList &&) = default ;
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setBitrate(string bitrate) { DARABONBA_PTR_SET_VALUE(bitrate_, bitrate) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setChannelLayout(string channelLayout) { DARABONBA_PTR_SET_VALUE(channelLayout_, channelLayout) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setChannels(string channels) { DARABONBA_PTR_SET_VALUE(channels_, channels) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setCodecLongName(string codecLongName) { DARABONBA_PTR_SET_VALUE(codecLongName_, codecLongName) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setCodecName(string codecName) { DARABONBA_PTR_SET_VALUE(codecName_, codecName) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setCodecTag(string codecTag) { DARABONBA_PTR_SET_VALUE(codecTag_, codecTag) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setCodecTagString(string codecTagString) { DARABONBA_PTR_SET_VALUE(codecTagString_, codecTagString) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setCodecTimeBase(string codecTimeBase) { DARABONBA_PTR_SET_VALUE(codecTimeBase_, codecTimeBase) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setIndex(string index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setSampleFmt(string sampleFmt) { DARABONBA_PTR_SET_VALUE(sampleFmt_, sampleFmt) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setSampleRate(string sampleRate) { DARABONBA_PTR_SET_VALUE(sampleRate_, sampleRate) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList& setTimebase(string timebase) { DARABONBA_PTR_SET_VALUE(timebase_, timebase) };
