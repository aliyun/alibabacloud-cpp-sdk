...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ChannelAssemblyChannel> & channelList() const { DARABONBA_PTR_GET_CONST(channelList_, vector<ChannelAssemblyChannel>) };
    inline vector<ChannelAssemblyChannel> channelList() { DARABONBA_PTR_GET(channelList_, vector<ChannelAssemblyChannel>) };
  ...
  protected:
    // The channels.
    std::shared_ptr<vector<ChannelAssemblyChannel>> channelList_ = nullptr;
