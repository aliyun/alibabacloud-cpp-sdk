...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCustomizedVoiceJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateCustomizedVoiceJobResponseBody::Data) };
    inline CreateCustomizedVoiceJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateCustomizedVoiceJobResponseBody::Data) };
    inline CreateCustomizedVoiceJobResponseBody& setData(const CreateCustomizedVoiceJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateCustomizedVoiceJobResponseBody& setData(CreateCustomizedVoiceJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
