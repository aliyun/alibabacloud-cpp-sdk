...
namespace Models
{
  ...
  public:
    ...
    inline const GetAiRtcLicenseInfoListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAiRtcLicenseInfoListResponseBody) };
    inline GetAiRtcLicenseInfoListResponseBody body() { DARABONBA_PTR_GET(body_, GetAiRtcLicenseInfoListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAiRtcLicenseInfoListResponseBody> body_ = nullptr;
  };
