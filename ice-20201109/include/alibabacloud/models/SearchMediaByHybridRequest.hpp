...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->customFilters_ == nullptr
        && this->mediaId_ == nullptr && this->mediaType_ == nullptr && this->namespace_ == nullptr && this->pageNo_ == nullptr && this->pageSize_ == nullptr
        && this->searchLibName_ == nullptr && this->text_ == nullptr && this->utcCreate_ == nullptr; };
