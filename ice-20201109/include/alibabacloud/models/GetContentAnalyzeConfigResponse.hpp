...
namespace Models
{
  ...
  public:
    ...
    inline const GetContentAnalyzeConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetContentAnalyzeConfigResponseBody) };
    inline GetContentAnalyzeConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetContentAnalyzeConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetContentAnalyzeConfigResponseBody> body_ {};
  };
