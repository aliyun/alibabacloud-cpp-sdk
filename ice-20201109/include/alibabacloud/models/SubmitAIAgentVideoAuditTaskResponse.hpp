...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitAIAgentVideoAuditTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitAIAgentVideoAuditTaskResponseBody) };
    inline SubmitAIAgentVideoAuditTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitAIAgentVideoAuditTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitAIAgentVideoAuditTaskResponseBody> body_ {};
  };
