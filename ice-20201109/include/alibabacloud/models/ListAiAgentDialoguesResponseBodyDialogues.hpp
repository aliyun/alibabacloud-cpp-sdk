...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attachedFileList_ == nullptr
        && return this->dialogueId_ == nullptr && return this->extend_ == nullptr && return this->nodeId_ == nullptr && return this->producer_ == nullptr && return this->reasoningText_ == nullptr
        && return this->roundId_ == nullptr && return this->source_ == nullptr && return this->text_ == nullptr && return this->time_ == nullptr && return this->type_ == nullptr; };
