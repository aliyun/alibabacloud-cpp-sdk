...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitHighlightExtractionJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitHighlightExtractionJobResponseBody) };
    inline SubmitHighlightExtractionJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitHighlightExtractionJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitHighlightExtractionJobResponseBody> body_ {};
  };
