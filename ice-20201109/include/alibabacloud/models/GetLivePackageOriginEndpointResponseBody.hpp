...
namespace Models
{
  ...
  public:
    ...
    inline const GetLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint & getLivePackageOriginEndpoint() const { DARABONBA_PTR_GET_CONST(livePackageOriginEndpoint_, GetLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint) };
    inline GetLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint getLivePackageOriginEndpoint() { DARABONBA_PTR_GET(livePackageOriginEndpoint_, GetLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint) };
    inline GetLivePackageOriginEndpointResponseBody& setLivePackageOriginEndpoint(const GetLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint & livePackageOriginEndpoint) { DARABONBA_PTR_SET_VALUE(livePackageOriginEndpoint_, livePackageOriginEndpoint) };
    inline GetLivePackageOriginEndpointResponseBody& setLivePackageOriginEndpoint(GetLivePackageOriginEndpointResponseBody::LivePackageOriginEndpoint && livePackageOriginEndpoint) { DARABONBA_PTR_SET_RVALUE(livePackageOriginEndpoint_, livePackageOriginEndpoint) };
