...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitSyncMediaInfoJobResponseBody::MediaInfoJob & getMediaInfoJob() const { DARABONBA_PTR_GET_CONST(mediaInfoJob_, SubmitSyncMediaInfoJobResponseBody::MediaInfoJob) };
    inline SubmitSyncMediaInfoJobResponseBody::MediaInfoJob getMediaInfoJob() { DARABONBA_PTR_GET(mediaInfoJob_, SubmitSyncMediaInfoJobResponseBody::MediaInfoJob) };
    inline SubmitSyncMediaInfoJobResponseBody& setMediaInfoJob(const SubmitSyncMediaInfoJobResponseBody::MediaInfoJob & mediaInfoJob) { DARABONBA_PTR_SET_VALUE(mediaInfoJob_, mediaInfoJob) };
    inline SubmitSyncMediaInfoJobResponseBody& setMediaInfoJob(SubmitSyncMediaInfoJobResponseBody::MediaInfoJob && mediaInfoJob) { DARABONBA_PTR_SET_RVALUE(mediaInfoJob_, mediaInfoJob) };
  ...
  protected:
    // MediaInfoJobDTO
    shared_ptr<SubmitSyncMediaInfoJobResponseBody::MediaInfoJob> mediaInfoJob_ {};
    // The request ID.
    shared_ptr<string> requestId_ {};
  };
