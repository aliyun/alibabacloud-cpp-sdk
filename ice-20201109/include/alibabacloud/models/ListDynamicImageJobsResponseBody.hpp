...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->createTime_ == nullptr
        && this->finishTime_ == nullptr && this->input_ == nullptr && this->jobId_ == nullptr && this->modifiedTime_ == nullptr && this->name_ == nullptr
        && this->output_ == nullptr && this->pipelineId_ == nullptr && this->status_ == nullptr && this->submitTime_ == nullptr && this->templateId_ == nullptr
        && this->triggerSource_ == nullptr; };
    ...
    inline const vector<ListDynamicImageJobsResponseBody::Jobs> & getJobs() const { DARABONBA_PTR_GET_CONST(jobs_, vector<ListDynamicImageJobsResponseBody::Jobs>) };
    inline vector<ListDynamicImageJobsResponseBody::Jobs> getJobs() { DARABONBA_PTR_GET(jobs_, vector<ListDynamicImageJobsResponseBody::Jobs>) };
    inline ListDynamicImageJobsResponseBody& setJobs(const vector<ListDynamicImageJobsResponseBody::Jobs> & jobs) { DARABONBA_PTR_SET_VALUE(jobs_, jobs) };
    inline ListDynamicImageJobsResponseBody& setJobs(vector<ListDynamicImageJobsResponseBody::Jobs> && jobs) { DARABONBA_PTR_SET_RVALUE(jobs_, jobs) };
  ...
  protected:
    // The list of jobs.
    shared_ptr<vector<ListDynamicImageJobsResponseBody::Jobs>> jobs_ {};
