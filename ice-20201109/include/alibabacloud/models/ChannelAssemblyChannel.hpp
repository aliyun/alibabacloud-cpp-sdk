...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ChannelAssemblyChannel::OutPutConfigList> & getOutPutConfigList() const { DARABONBA_PTR_GET_CONST(outPutConfigList_, vector<ChannelAssemblyChannel::OutPutConfigList>) };
    inline vector<ChannelAssemblyChannel::OutPutConfigList> getOutPutConfigList() { DARABONBA_PTR_GET(outPutConfigList_, vector<ChannelAssemblyChannel::OutPutConfigList>) };
    inline ChannelAssemblyChannel& setOutPutConfigList(const vector<ChannelAssemblyChannel::OutPutConfigList> & outPutConfigList) { DARABONBA_PTR_SET_VALUE(outPutConfigList_, outPutConfigList) };
    inline ChannelAssemblyChannel& setOutPutConfigList(vector<ChannelAssemblyChannel::OutPutConfigList> && outPutConfigList) { DARABONBA_PTR_SET_RVALUE(outPutConfigList_, outPutConfigList) };
