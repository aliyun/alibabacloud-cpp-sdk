...
#ifndef ALIBABACLOUD_MODELS_UPDATEMEDIALIVECHANNELREQUESTVIDEOSETTINGSVIDEOCODECSETTINGRATE_HPP_
#define ALIBABACLOUD_MODELS_UPDATEMEDIALIVECHANNELREQUESTVIDEOSETTINGSVIDEOCODECSETTINGRATE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate& obj) { 
    ...
    UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate() = default ;
    UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate(const UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate &) = default ;
    UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate(UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate &&) = default ;
    UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate() = default ;
    UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate& operator=(const UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate &) = default ;
    UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate& operator=(UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate &&) = default ;
    ...
    inline UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate& setBitrate(int32_t bitrate) { DARABONBA_PTR_SET_VALUE(bitrate_, bitrate) };
    ...
    inline UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate& setBufferSize(int32_t bufferSize) { DARABONBA_PTR_SET_VALUE(bufferSize_, bufferSize) };
    ...
    inline UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate& setMaxBitrate(int32_t maxBitrate) { DARABONBA_PTR_SET_VALUE(maxBitrate_, maxBitrate) };
    ...
    inline UpdateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate& setRateControlMode(string rateControlMode) { DARABONBA_PTR_SET_VALUE(rateControlMode_, rateControlMode) };
