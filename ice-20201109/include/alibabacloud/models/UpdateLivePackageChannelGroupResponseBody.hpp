...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLivePackageChannelGroupResponseBody::LivePackageChannelGroup & getLivePackageChannelGroup() const { DARABONBA_PTR_GET_CONST(livePackageChannelGroup_, UpdateLivePackageChannelGroupResponseBody::LivePackageChannelGroup) };
    inline UpdateLivePackageChannelGroupResponseBody::LivePackageChannelGroup getLivePackageChannelGroup() { DARABONBA_PTR_GET(livePackageChannelGroup_, UpdateLivePackageChannelGroupResponseBody::LivePackageChannelGroup) };
    inline UpdateLivePackageChannelGroupResponseBody& setLivePackageChannelGroup(const UpdateLivePackageChannelGroupResponseBody::LivePackageChannelGroup & livePackageChannelGroup) { DARABONBA_PTR_SET_VALUE(livePackageChannelGroup_, livePackageChannelGroup) };
    inline UpdateLivePackageChannelGroupResponseBody& setLivePackageChannelGroup(UpdateLivePackageChannelGroupResponseBody::LivePackageChannelGroup && livePackageChannelGroup) { DARABONBA_PTR_SET_RVALUE(livePackageChannelGroup_, livePackageChannelGroup) };
  ...
  protected:
    ...
    shared_ptr<UpdateLivePackageChannelGroupResponseBody::LivePackageChannelGroup> livePackageChannelGroup_ {};
    // The request ID.
