...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTraceM3u8JobListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryTraceM3u8JobListResponseBody) };
    inline QueryTraceM3u8JobListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryTraceM3u8JobListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryTraceM3u8JobListResponseBody> body_ {};
  };
