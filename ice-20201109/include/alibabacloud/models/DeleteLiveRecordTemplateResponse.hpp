...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLiveRecordTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLiveRecordTemplateResponseBody) };
    inline DeleteLiveRecordTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLiveRecordTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLiveRecordTemplateResponseBody> body_ {};
  };
