...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitMediaProducingJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitMediaProducingJobResponseBody) };
    inline SubmitMediaProducingJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitMediaProducingJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitMediaProducingJobResponseBody> body_ {};
  };
