...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCopyrightJobListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryCopyrightJobListResponseBody) };
    inline QueryCopyrightJobListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryCopyrightJobListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryCopyrightJobListResponseBody> body_ {};
  };
