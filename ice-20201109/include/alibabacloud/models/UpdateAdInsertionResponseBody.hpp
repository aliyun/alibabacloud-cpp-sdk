...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAdInsertionResponseBody::Config & getConfig() const { DARABONBA_PTR_GET_CONST(config_, UpdateAdInsertionResponseBody::Config) };
    inline UpdateAdInsertionResponseBody::Config getConfig() { DARABONBA_PTR_GET(config_, UpdateAdInsertionResponseBody::Config) };
    inline UpdateAdInsertionResponseBody& setConfig(const UpdateAdInsertionResponseBody::Config & config) { DARABONBA_PTR_SET_VALUE(config_, config) };
    inline UpdateAdInsertionResponseBody& setConfig(UpdateAdInsertionResponseBody::Config && config) { DARABONBA_PTR_SET_RVALUE(config_, config) };
  ...
  protected:
    ...
    shared_ptr<UpdateAdInsertionResponseBody::Config> config_ {};
