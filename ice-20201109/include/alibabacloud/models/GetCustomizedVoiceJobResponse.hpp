...
namespace Models
{
  ...
  public:
    ...
    inline const GetCustomizedVoiceJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetCustomizedVoiceJobResponseBody) };
    inline GetCustomizedVoiceJobResponseBody body() { DARABONBA_PTR_GET(body_, GetCustomizedVoiceJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetCustomizedVoiceJobResponseBody> body_ = nullptr;
  };
