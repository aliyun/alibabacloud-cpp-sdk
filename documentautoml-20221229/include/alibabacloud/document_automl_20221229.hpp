...
public:
  ...
  explicit CreateModelAsyncPredictRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~CreateModelAsyncPredictRequest() = default;
};
class CreateModelAsyncPredictResponseBody : public Darabonba::Model {
public:
  ...
  CreateModelAsyncPredictResponseBody() {}

  explicit CreateModelAsyncPredictResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~CreateModelAsyncPredictResponseBody() = default;
};
class CreateModelAsyncPredictResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<CreateModelAsyncPredictResponseBody> body{};

  CreateModelAsyncPredictResponse() {}

  explicit CreateModelAsyncPredictResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        CreateModelAsyncPredictResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<CreateModelAsyncPredictResponseBody>(model1);
      }
    }
  }


  virtual ~CreateModelAsyncPredictResponse() = default;
};
class GetModelAsyncPredictRequest : public Darabonba::Model {
public:
  shared_ptr<long> asyncPredictId{};

  GetModelAsyncPredictRequest() {}

  explicit GetModelAsyncPredictRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~GetModelAsyncPredictRequest() = default;
};
class GetModelAsyncPredictResponseBody : public Darabonba::Model {
public:
  shared_ptr<long> code{};
  shared_ptr<string> data{};
  shared_ptr<string> message{};
  ...
  GetModelAsyncPredictResponseBody() {}

  explicit GetModelAsyncPredictResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~GetModelAsyncPredictResponseBody() = default;
};
class GetModelAsyncPredictResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<GetModelAsyncPredictResponseBody> body{};

  GetModelAsyncPredictResponse() {}

  explicit GetModelAsyncPredictResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        GetModelAsyncPredictResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<GetModelAsyncPredictResponseBody>(model1);
      }
    }
  }


  virtual ~GetModelAsyncPredictResponse() = default;
};
...
public:
  ...
  CreateModelAsyncPredictResponse createModelAsyncPredictWithOptions(shared_ptr<CreateModelAsyncPredictRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  CreateModelAsyncPredictResponse createModelAsyncPredict(shared_ptr<CreateModelAsyncPredictRequest> request);
  GetModelAsyncPredictResponse getModelAsyncPredictWithOptions(shared_ptr<GetModelAsyncPredictRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  GetModelAsyncPredictResponse getModelAsyncPredict(shared_ptr<GetModelAsyncPredictRequest> request);
