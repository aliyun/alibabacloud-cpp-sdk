...
#ifndef ALIBABACLOUD_MODELS_LISTPROMETHEUSINTEGRATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTPROMETHEUSINTEGRATIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPrometheusIntegrationResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListPrometheusIntegrationResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListPrometheusIntegrationResponseBody() = default ;
    ListPrometheusIntegrationResponseBody(const ListPrometheusIntegrationResponseBody &) = default ;
    ListPrometheusIntegrationResponseBody(ListPrometheusIntegrationResponseBody &&) = default ;
    ListPrometheusIntegrationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPrometheusIntegrationResponseBody() = default ;
    ListPrometheusIntegrationResponseBody& operator=(const ListPrometheusIntegrationResponseBody &) = default ;
    ListPrometheusIntegrationResponseBody& operator=(ListPrometheusIntegrationResponseBody &&) = default ;
    ...
    public:
      ...
      inline bool getShowLog() const { DARABONBA_PTR_GET_DEFAULT(showLog_, false) };
      inline Data& setShowLog(bool showLog) { DARABONBA_PTR_SET_VALUE(showLog_, showLog) };
    ...
    inline ListPrometheusIntegrationResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListPrometheusIntegrationResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListPrometheusIntegrationResponseBody::Data>) };
    inline vector<ListPrometheusIntegrationResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListPrometheusIntegrationResponseBody::Data>) };
    inline ListPrometheusIntegrationResponseBody& setData(const vector<ListPrometheusIntegrationResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPrometheusIntegrationResponseBody& setData(vector<ListPrometheusIntegrationResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListPrometheusIntegrationResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListPrometheusIntegrationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
  ...
  protected:
    ...
    shared_ptr<vector<ListPrometheusIntegrationResponseBody::Data>> data_ {};
