...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getReleaseEndTime() const { DARABONBA_PTR_GET_DEFAULT(releaseEndTime_, 0L) };
    ...
    inline int64_t getReleaseStartTime() const { DARABONBA_PTR_GET_DEFAULT(releaseStartTime_, 0L) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<int64_t> releaseEndTime_ {};
    // The start time of the version release.
    // 
    // This parameter is required.
    shared_ptr<int64_t> releaseStartTime_ {};
