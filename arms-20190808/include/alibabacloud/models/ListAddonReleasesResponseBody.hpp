...
namespace Models
{
  ...
  public:
    ...
    inline const ListAddonReleasesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAddonReleasesResponseBodyData) };
    inline ListAddonReleasesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAddonReleasesResponseBodyData) };
    inline ListAddonReleasesResponseBody& setData(const ListAddonReleasesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAddonReleasesResponseBody& setData(ListAddonReleasesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The result returned.
    std::shared_ptr<ListAddonReleasesResponseBodyData> data_ = nullptr;
