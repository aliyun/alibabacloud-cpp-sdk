...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEnvDropMetricsRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEnvDropMetricsRuleResponseBody) };
    inline UpdateEnvDropMetricsRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEnvDropMetricsRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEnvDropMetricsRuleResponseBody> body_ {};
  };
