...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEnvironmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEnvironmentResponseBody) };
    inline UpdateEnvironmentResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEnvironmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEnvironmentResponseBody> body_ {};
  };
