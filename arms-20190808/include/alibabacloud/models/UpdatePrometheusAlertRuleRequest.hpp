...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdatePrometheusAlertRuleRequestTags> & tags() const { DARABONBA_PTR_GET_CONST(tags_, vector<UpdatePrometheusAlertRuleRequestTags>) };
    inline vector<UpdatePrometheusAlertRuleRequestTags> tags() { DARABONBA_PTR_GET(tags_, vector<UpdatePrometheusAlertRuleRequestTags>) };
    inline UpdatePrometheusAlertRuleRequest& setTags(const vector<UpdatePrometheusAlertRuleRequestTags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline UpdatePrometheusAlertRuleRequest& setTags(vector<UpdatePrometheusAlertRuleRequestTags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    // The tags.
    std::shared_ptr<vector<UpdatePrometheusAlertRuleRequestTags>> tags_ = nullptr;
