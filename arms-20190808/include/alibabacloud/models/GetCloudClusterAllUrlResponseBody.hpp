...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetCloudClusterAllUrlResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetCloudClusterAllUrlResponseBodyData>) };
    inline vector<GetCloudClusterAllUrlResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetCloudClusterAllUrlResponseBodyData>) };
    inline GetCloudClusterAllUrlResponseBody& setData(const vector<GetCloudClusterAllUrlResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCloudClusterAllUrlResponseBody& setData(vector<GetCloudClusterAllUrlResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // An array object.
    std::shared_ptr<vector<GetCloudClusterAllUrlResponseBodyData>> data_ = nullptr;
