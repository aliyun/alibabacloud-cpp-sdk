...
namespace Models
{
  ...
  public:
    ...
    inline CreateEnvironmentResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreateEnvironmentResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
