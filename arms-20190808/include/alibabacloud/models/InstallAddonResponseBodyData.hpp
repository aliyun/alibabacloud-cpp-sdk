...
#ifndef ALIBABACLOUD_MODELS_INSTALLADDONRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_INSTALLADDONRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const InstallAddonResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, InstallAddonResponseBodyData& obj) { 
    ...
    InstallAddonResponseBodyData() = default ;
    InstallAddonResponseBodyData(const InstallAddonResponseBodyData &) = default ;
    InstallAddonResponseBodyData(InstallAddonResponseBodyData &&) = default ;
    InstallAddonResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InstallAddonResponseBodyData() = default ;
    InstallAddonResponseBodyData& operator=(const InstallAddonResponseBodyData &) = default ;
    InstallAddonResponseBodyData& operator=(InstallAddonResponseBodyData &&) = default ;
    ...
    inline InstallAddonResponseBodyData& setAddonName(string addonName) { DARABONBA_PTR_SET_VALUE(addonName_, addonName) };
    ...
    inline InstallAddonResponseBodyData& setAlertRuleCount(int64_t alertRuleCount) { DARABONBA_PTR_SET_VALUE(alertRuleCount_, alertRuleCount) };


    // conditions Field Functions 
    bool hasConditions() const { return this->conditions_ != nullptr;};
    void deleteConditions() { this->conditions_ = nullptr;};
    inline const vector<Models::InstallAddonResponseBodyDataConditions> & conditions() const { DARABONBA_PTR_GET_CONST(conditions_, vector<Models::InstallAddonResponseBodyDataConditions>) };
    inline vector<Models::InstallAddonResponseBodyDataConditions> conditions() { DARABONBA_PTR_GET(conditions_, vector<Models::InstallAddonResponseBodyDataConditions>) };
    inline InstallAddonResponseBodyData& setConditions(const vector<Models::InstallAddonResponseBodyDataConditions> & conditions) { DARABONBA_PTR_SET_VALUE(conditions_, conditions) };
    inline InstallAddonResponseBodyData& setConditions(vector<Models::InstallAddonResponseBodyDataConditions> && conditions) { DARABONBA_PTR_SET_RVALUE(conditions_, conditions) };
    ...
    inline InstallAddonResponseBodyData& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline InstallAddonResponseBodyData& setDashboardCount(int64_t dashboardCount) { DARABONBA_PTR_SET_VALUE(dashboardCount_, dashboardCount) };
    ...
    inline InstallAddonResponseBodyData& setEnvironmentId(string environmentId) { DARABONBA_PTR_SET_VALUE(environmentId_, environmentId) };
    ...
    inline InstallAddonResponseBodyData& setExporterCount(int64_t exporterCount) { DARABONBA_PTR_SET_VALUE(exporterCount_, exporterCount) };
    ...
    inline InstallAddonResponseBodyData& setHaveConfig(bool haveConfig) { DARABONBA_PTR_SET_VALUE(haveConfig_, haveConfig) };
    ...
    inline InstallAddonResponseBodyData& setInstallUserId(string installUserId) { DARABONBA_PTR_SET_VALUE(installUserId_, installUserId) };
    ...
    inline InstallAddonResponseBodyData& setLanguage(string language) { DARABONBA_PTR_SET_VALUE(language_, language) };
    ...
    inline InstallAddonResponseBodyData& setManaged(bool managed) { DARABONBA_PTR_SET_VALUE(managed_, managed) };
    ...
    inline InstallAddonResponseBodyData& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline InstallAddonResponseBodyData& setReleaseId(string releaseId) { DARABONBA_PTR_SET_VALUE(releaseId_, releaseId) };
    ...
    inline InstallAddonResponseBodyData& setReleaseName(string releaseName) { DARABONBA_PTR_SET_VALUE(releaseName_, releaseName) };
    ...
    inline InstallAddonResponseBodyData& setScene(string scene) { DARABONBA_PTR_SET_VALUE(scene_, scene) };
    ...
    inline InstallAddonResponseBodyData& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline InstallAddonResponseBodyData& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline InstallAddonResponseBodyData& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline InstallAddonResponseBodyData& setVersion(string version) { DARABONBA_PTR_SET_VALUE(version_, version) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::InstallAddonResponseBodyDataConditions>> conditions_ = nullptr;
