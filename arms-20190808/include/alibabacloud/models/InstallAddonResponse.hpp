...
namespace Models
{
  ...
  public:
    ...
    inline const InstallAddonResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InstallAddonResponseBody) };
    inline InstallAddonResponseBody getBody() { DARABONBA_PTR_GET(body_, InstallAddonResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InstallAddonResponseBody> body_ {};
  };
