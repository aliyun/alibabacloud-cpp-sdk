...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnvCustomJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEnvCustomJobResponseBody) };
    inline DescribeEnvCustomJobResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEnvCustomJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEnvCustomJobResponseBody> body_ {};
  };
