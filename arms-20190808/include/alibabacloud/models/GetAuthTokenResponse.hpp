...
namespace Models
{
  ...
  public:
    ...
    inline const GetAuthTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAuthTokenResponseBody) };
    inline GetAuthTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAuthTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAuthTokenResponseBody> body_ {};
  };
