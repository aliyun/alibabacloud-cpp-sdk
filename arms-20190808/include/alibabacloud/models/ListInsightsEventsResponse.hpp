...
namespace Models
{
  ...
  public:
    ...
    inline const ListInsightsEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInsightsEventsResponseBody) };
    inline ListInsightsEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInsightsEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInsightsEventsResponseBody> body_ {};
  };
