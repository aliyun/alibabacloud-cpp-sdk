...
namespace Models
{
  ...
  public:
    ...
    inline const ListSilencePoliciesResponseBodyPageBean & pageBean() const { DARABONBA_PTR_GET_CONST(pageBean_, ListSilencePoliciesResponseBodyPageBean) };
    inline ListSilencePoliciesResponseBodyPageBean pageBean() { DARABONBA_PTR_GET(pageBean_, ListSilencePoliciesResponseBodyPageBean) };
    inline ListSilencePoliciesResponseBody& setPageBean(const ListSilencePoliciesResponseBodyPageBean & pageBean) { DARABONBA_PTR_SET_VALUE(pageBean_, pageBean) };
    inline ListSilencePoliciesResponseBody& setPageBean(ListSilencePoliciesResponseBodyPageBean && pageBean) { DARABONBA_PTR_SET_RVALUE(pageBean_, pageBean) };
  ...
  protected:
    // The returned pages.
    std::shared_ptr<ListSilencePoliciesResponseBodyPageBean> pageBean_ = nullptr;
    // The request ID.
