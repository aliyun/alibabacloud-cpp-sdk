...
namespace Models
{
  ...
  public:
    ...
    inline const GetOnCallSchedulesDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetOnCallSchedulesDetailResponseBodyData) };
    inline GetOnCallSchedulesDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetOnCallSchedulesDetailResponseBodyData) };
    inline GetOnCallSchedulesDetailResponseBody& setData(const GetOnCallSchedulesDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetOnCallSchedulesDetailResponseBody& setData(GetOnCallSchedulesDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetOnCallSchedulesDetailResponseBodyData> data_ = nullptr;
    // The request ID.
