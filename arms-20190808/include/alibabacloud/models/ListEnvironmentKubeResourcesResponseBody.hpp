...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListEnvironmentKubeResourcesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListEnvironmentKubeResourcesResponseBodyData>) };
    inline vector<ListEnvironmentKubeResourcesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListEnvironmentKubeResourcesResponseBodyData>) };
    inline ListEnvironmentKubeResourcesResponseBody& setData(const vector<ListEnvironmentKubeResourcesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEnvironmentKubeResourcesResponseBody& setData(vector<ListEnvironmentKubeResourcesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<vector<ListEnvironmentKubeResourcesResponseBodyData>> data_ = nullptr;
