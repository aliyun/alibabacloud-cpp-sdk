...
namespace Models
{
  ...
  public:
    ...
    inline const GetRumOcuStatisticDataResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRumOcuStatisticDataResponseBodyData) };
    inline GetRumOcuStatisticDataResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRumOcuStatisticDataResponseBodyData) };
    inline GetRumOcuStatisticDataResponseBody& setData(const GetRumOcuStatisticDataResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRumOcuStatisticDataResponseBody& setData(GetRumOcuStatisticDataResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<GetRumOcuStatisticDataResponseBodyData> data_ = nullptr;
