...
namespace Models
{
  ...
  public:
    ...
    inline const GetRumDataForPageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRumDataForPageResponseBody) };
    inline GetRumDataForPageResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRumDataForPageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRumDataForPageResponseBody> body_ {};
  };
