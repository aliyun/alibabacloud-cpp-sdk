...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGrafanaWorkspaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateGrafanaWorkspaceResponseBody) };
    inline CreateGrafanaWorkspaceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateGrafanaWorkspaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateGrafanaWorkspaceResponseBody> body_ {};
  };
