...
namespace Models
{
  ...
  public:
    ...
    inline const ListPrometheusMonitoringResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPrometheusMonitoringResponseBody) };
    inline ListPrometheusMonitoringResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPrometheusMonitoringResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPrometheusMonitoringResponseBody> body_ {};
  };
