...
namespace Models
{
  ...
  public:
    ...
    inline const ClaimAlarmResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ClaimAlarmResponseBody) };
    inline ClaimAlarmResponseBody getBody() { DARABONBA_PTR_GET(body_, ClaimAlarmResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ClaimAlarmResponseBody> body_ {};
  };
