...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ascendingSequence_ == nullptr
    ...
    inline bool getAscendingSequence() const { DARABONBA_PTR_GET_DEFAULT(ascendingSequence_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> ascendingSequence_ {};
