...
#ifndef ALIBABACLOUD_MODELS_UPDATETIMINGSYNTHETICTASKREQUESTMONITORCONFFILEDOWNLOAD_HPP_
#define ALIBABACLOUD_MODELS_UPDATETIMINGSYNTHETICTASKREQUESTMONITORCONFFILEDOWNLOAD_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& obj) { 
    ...
    UpdateTimingSyntheticTaskRequestMonitorConfFileDownload() = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfFileDownload(const UpdateTimingSyntheticTaskRequestMonitorConfFileDownload &) = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfFileDownload(UpdateTimingSyntheticTaskRequestMonitorConfFileDownload &&) = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfFileDownload(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateTimingSyntheticTaskRequestMonitorConfFileDownload() = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& operator=(const UpdateTimingSyntheticTaskRequestMonitorConfFileDownload &) = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& operator=(UpdateTimingSyntheticTaskRequestMonitorConfFileDownload &&) = default ;
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setConnectionTimeout(int64_t connectionTimeout) { DARABONBA_PTR_SET_VALUE(connectionTimeout_, connectionTimeout) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setCustomHeaderContent(const map<string, string> & customHeaderContent) { DARABONBA_PTR_SET_VALUE(customHeaderContent_, customHeaderContent) };
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setCustomHeaderContent(map<string, string> && customHeaderContent) { DARABONBA_PTR_SET_RVALUE(customHeaderContent_, customHeaderContent) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setDownloadKernel(int32_t downloadKernel) { DARABONBA_PTR_SET_VALUE(downloadKernel_, downloadKernel) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setIgnoreCertificateAuthError(int32_t ignoreCertificateAuthError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateAuthError_, ignoreCertificateAuthError) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setIgnoreCertificateCanceledError(int32_t ignoreCertificateCanceledError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateCanceledError_, ignoreCertificateCanceledError) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setIgnoreCertificateOutOfDateError(int32_t ignoreCertificateOutOfDateError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateOutOfDateError_, ignoreCertificateOutOfDateError) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setIgnoreCertificateStatusError(int32_t ignoreCertificateStatusError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateStatusError_, ignoreCertificateStatusError) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setIgnoreCertificateUntrustworthyError(int32_t ignoreCertificateUntrustworthyError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateUntrustworthyError_, ignoreCertificateUntrustworthyError) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setIgnoreCertificateUsingError(int32_t ignoreCertificateUsingError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateUsingError_, ignoreCertificateUsingError) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setIgnoreInvalidHostError(int32_t ignoreInvalidHostError) { DARABONBA_PTR_SET_VALUE(ignoreInvalidHostError_, ignoreInvalidHostError) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setMonitorTimeout(int64_t monitorTimeout) { DARABONBA_PTR_SET_VALUE(monitorTimeout_, monitorTimeout) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setQuickProtocol(int32_t quickProtocol) { DARABONBA_PTR_SET_VALUE(quickProtocol_, quickProtocol) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setRedirection(int32_t redirection) { DARABONBA_PTR_SET_VALUE(redirection_, redirection) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setTargetUrl(string targetUrl) { DARABONBA_PTR_SET_VALUE(targetUrl_, targetUrl) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setTransmissionSize(int64_t transmissionSize) { DARABONBA_PTR_SET_VALUE(transmissionSize_, transmissionSize) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setValidateKeywords(string validateKeywords) { DARABONBA_PTR_SET_VALUE(validateKeywords_, validateKeywords) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setVerifyWay(int32_t verifyWay) { DARABONBA_PTR_SET_VALUE(verifyWay_, verifyWay) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfFileDownload& setWhiteList(string whiteList) { DARABONBA_PTR_SET_VALUE(whiteList_, whiteList) };
