...
namespace Models
{
  ...
  public:
    ...
    inline UpdatePrometheusInstanceResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UpdatePrometheusInstanceResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline UpdatePrometheusInstanceResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
