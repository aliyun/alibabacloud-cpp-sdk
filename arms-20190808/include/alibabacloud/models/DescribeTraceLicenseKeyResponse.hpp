...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTraceLicenseKeyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeTraceLicenseKeyResponseBody) };
    inline DescribeTraceLicenseKeyResponseBody body() { DARABONBA_PTR_GET(body_, DescribeTraceLicenseKeyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeTraceLicenseKeyResponseBody> body_ = nullptr;
  };
