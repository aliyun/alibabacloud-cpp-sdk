...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWebhookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateWebhookResponseBody) };
    inline CreateWebhookResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateWebhookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateWebhookResponseBody> body_ {};
  };
