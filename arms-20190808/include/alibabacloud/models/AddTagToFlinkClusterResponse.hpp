...
namespace Models
{
  ...
  public:
    ...
    inline const AddTagToFlinkClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddTagToFlinkClusterResponseBody) };
    inline AddTagToFlinkClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, AddTagToFlinkClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddTagToFlinkClusterResponseBody> body_ {};
  };
