...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnvCustomJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEnvCustomJobResponseBodyData) };
    inline DescribeEnvCustomJobResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEnvCustomJobResponseBodyData) };
    inline DescribeEnvCustomJobResponseBody& setData(const DescribeEnvCustomJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEnvCustomJobResponseBody& setData(DescribeEnvCustomJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<DescribeEnvCustomJobResponseBodyData> data_ = nullptr;
