...
#ifndef ALIBABACLOUD_MODELS_GRAFANAWORKSPACEINIBACKUP_HPP_
#define ALIBABACLOUD_MODELS_GRAFANAWORKSPACEINIBACKUP_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GrafanaWorkspaceIniBackup& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GrafanaWorkspaceIniBackup& obj) { 
    ...
    GrafanaWorkspaceIniBackup() = default ;
    GrafanaWorkspaceIniBackup(const GrafanaWorkspaceIniBackup &) = default ;
    GrafanaWorkspaceIniBackup(GrafanaWorkspaceIniBackup &&) = default ;
    GrafanaWorkspaceIniBackup(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GrafanaWorkspaceIniBackup() = default ;
    GrafanaWorkspaceIniBackup& operator=(const GrafanaWorkspaceIniBackup &) = default ;
    GrafanaWorkspaceIniBackup& operator=(GrafanaWorkspaceIniBackup &&) = default ;
