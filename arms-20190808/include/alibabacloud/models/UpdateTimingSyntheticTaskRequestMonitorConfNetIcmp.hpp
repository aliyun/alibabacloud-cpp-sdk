...
#ifndef ALIBABACLOUD_MODELS_UPDATETIMINGSYNTHETICTASKREQUESTMONITORCONFNETICMP_HPP_
#define ALIBABACLOUD_MODELS_UPDATETIMINGSYNTHETICTASKREQUESTMONITORCONFNETICMP_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& obj) { 
    ...
    UpdateTimingSyntheticTaskRequestMonitorConfNetICMP() = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfNetICMP(const UpdateTimingSyntheticTaskRequestMonitorConfNetICMP &) = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfNetICMP(UpdateTimingSyntheticTaskRequestMonitorConfNetICMP &&) = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfNetICMP(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateTimingSyntheticTaskRequestMonitorConfNetICMP() = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& operator=(const UpdateTimingSyntheticTaskRequestMonitorConfNetICMP &) = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& operator=(UpdateTimingSyntheticTaskRequestMonitorConfNetICMP &&) = default ;
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& setInterval(int64_t interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& setPackageNum(int32_t packageNum) { DARABONBA_PTR_SET_VALUE(packageNum_, packageNum) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& setPackageSize(int32_t packageSize) { DARABONBA_PTR_SET_VALUE(packageSize_, packageSize) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& setSplitPackage(bool splitPackage) { DARABONBA_PTR_SET_VALUE(splitPackage_, splitPackage) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& setTargetUrl(string targetUrl) { DARABONBA_PTR_SET_VALUE(targetUrl_, targetUrl) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& setTimeout(int64_t timeout) { DARABONBA_PTR_SET_VALUE(timeout_, timeout) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& setTracertEnable(bool tracertEnable) { DARABONBA_PTR_SET_VALUE(tracertEnable_, tracertEnable) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& setTracertNumMax(int32_t tracertNumMax) { DARABONBA_PTR_SET_VALUE(tracertNumMax_, tracertNumMax) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfNetICMP& setTracertTimeout(int64_t tracertTimeout) { DARABONBA_PTR_SET_VALUE(tracertTimeout_, tracertTimeout) };
