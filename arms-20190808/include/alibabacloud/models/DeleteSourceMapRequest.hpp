...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->fidList_ == nullptr
    ...
    inline const vector<string> & getFidList() const { DARABONBA_PTR_GET_CONST(fidList_, vector<string>) };
    inline vector<string> getFidList() { DARABONBA_PTR_GET(fidList_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> fidList_ {};
