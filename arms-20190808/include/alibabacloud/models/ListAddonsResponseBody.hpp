...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAddonsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAddonsResponseBodyData>) };
    inline vector<ListAddonsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAddonsResponseBodyData>) };
    inline ListAddonsResponseBody& setData(const vector<ListAddonsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAddonsResponseBody& setData(vector<ListAddonsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The queried add-ons.
    std::shared_ptr<vector<ListAddonsResponseBodyData>> data_ = nullptr;
