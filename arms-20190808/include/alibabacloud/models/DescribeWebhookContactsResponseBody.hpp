...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebhookContactsResponseBodyPageBean & pageBean() const { DARABONBA_PTR_GET_CONST(pageBean_, DescribeWebhookContactsResponseBodyPageBean) };
    inline DescribeWebhookContactsResponseBodyPageBean pageBean() { DARABONBA_PTR_GET(pageBean_, DescribeWebhookContactsResponseBodyPageBean) };
    inline DescribeWebhookContactsResponseBody& setPageBean(const DescribeWebhookContactsResponseBodyPageBean & pageBean) { DARABONBA_PTR_SET_VALUE(pageBean_, pageBean) };
    inline DescribeWebhookContactsResponseBody& setPageBean(DescribeWebhookContactsResponseBodyPageBean && pageBean) { DARABONBA_PTR_SET_RVALUE(pageBean_, pageBean) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeWebhookContactsResponseBodyPageBean> pageBean_ = nullptr;
    // The request ID.
