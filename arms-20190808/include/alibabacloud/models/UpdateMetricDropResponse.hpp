...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMetricDropResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateMetricDropResponseBody) };
    inline UpdateMetricDropResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateMetricDropResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateMetricDropResponseBody> body_ {};
  };
