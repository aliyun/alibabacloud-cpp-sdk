...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRumUploadFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRumUploadFileResponseBody) };
    inline DeleteRumUploadFileResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRumUploadFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRumUploadFileResponseBody> body_ {};
  };
