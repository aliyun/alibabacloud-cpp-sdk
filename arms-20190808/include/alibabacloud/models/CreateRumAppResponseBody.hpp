...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRumAppResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateRumAppResponseBodyData) };
    inline CreateRumAppResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateRumAppResponseBodyData) };
    inline CreateRumAppResponseBody& setData(const CreateRumAppResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateRumAppResponseBody& setData(CreateRumAppResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateRumAppResponseBodyData> data_ = nullptr;
