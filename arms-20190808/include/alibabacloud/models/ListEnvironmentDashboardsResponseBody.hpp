...
namespace Models
{
  ...
  public:
    ...
    inline const ListEnvironmentDashboardsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListEnvironmentDashboardsResponseBodyData) };
    inline ListEnvironmentDashboardsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListEnvironmentDashboardsResponseBodyData) };
    inline ListEnvironmentDashboardsResponseBody& setData(const ListEnvironmentDashboardsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEnvironmentDashboardsResponseBody& setData(ListEnvironmentDashboardsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListEnvironmentDashboardsResponseBodyData> data_ = nullptr;
