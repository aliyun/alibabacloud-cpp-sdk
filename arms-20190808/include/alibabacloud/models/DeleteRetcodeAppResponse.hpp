...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRetcodeAppResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteRetcodeAppResponseBody) };
    inline DeleteRetcodeAppResponseBody body() { DARABONBA_PTR_GET(body_, DeleteRetcodeAppResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteRetcodeAppResponseBody> body_ = nullptr;
  };
