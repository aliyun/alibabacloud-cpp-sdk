...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAlertContactResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateAlertContactResponseBody) };
    inline CreateAlertContactResponseBody body() { DARABONBA_PTR_GET(body_, CreateAlertContactResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateAlertContactResponseBody> body_ = nullptr;
  };
