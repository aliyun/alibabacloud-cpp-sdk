...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTimingSyntheticTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTimingSyntheticTaskResponseBody) };
    inline UpdateTimingSyntheticTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTimingSyntheticTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTimingSyntheticTaskResponseBody> body_ {};
  };
