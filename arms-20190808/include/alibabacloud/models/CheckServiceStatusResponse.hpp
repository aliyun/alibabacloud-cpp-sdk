...
namespace Models
{
  ...
  public:
    ...
    inline const CheckServiceStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckServiceStatusResponseBody) };
    inline CheckServiceStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckServiceStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckServiceStatusResponseBody> body_ {};
  };
