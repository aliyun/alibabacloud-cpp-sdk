...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEnvPodMonitorResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateEnvPodMonitorResponseBody::Data) };
    inline UpdateEnvPodMonitorResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateEnvPodMonitorResponseBody::Data) };
    inline UpdateEnvPodMonitorResponseBody& setData(const UpdateEnvPodMonitorResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateEnvPodMonitorResponseBody& setData(UpdateEnvPodMonitorResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    shared_ptr<UpdateEnvPodMonitorResponseBody::Data> data_ {};
