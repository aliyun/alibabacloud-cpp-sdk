...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSourceMapResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSourceMapResponseBody) };
    inline DeleteSourceMapResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSourceMapResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSourceMapResponseBody> body_ {};
  };
