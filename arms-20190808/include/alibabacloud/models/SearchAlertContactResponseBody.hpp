  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline Contacts& setContent(string content) { DARABONBA_PTR_SET_VALUE(content_, content) };
        ...
        inline Contacts& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
