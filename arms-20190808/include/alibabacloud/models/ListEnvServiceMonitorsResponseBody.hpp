...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListEnvServiceMonitorsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListEnvServiceMonitorsResponseBodyData>) };
    inline vector<ListEnvServiceMonitorsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListEnvServiceMonitorsResponseBodyData>) };
    inline ListEnvServiceMonitorsResponseBody& setData(const vector<ListEnvServiceMonitorsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEnvServiceMonitorsResponseBody& setData(vector<ListEnvServiceMonitorsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<vector<ListEnvServiceMonitorsResponseBodyData>> data_ = nullptr;
