...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasourceAmount_ == nullptr
    ...
    inline int64_t getDatasourceAmount() const { DARABONBA_PTR_GET_DEFAULT(datasourceAmount_, 0L) };
    ...
    inline const vector<GrafanaWorkspaceIntegrationPreview> & getPreviews() const { DARABONBA_PTR_GET_CONST(previews_, vector<GrafanaWorkspaceIntegrationPreview>) };
    inline vector<GrafanaWorkspaceIntegrationPreview> getPreviews() { DARABONBA_PTR_GET(previews_, vector<GrafanaWorkspaceIntegrationPreview>) };
  ...
  protected:
    shared_ptr<int64_t> datasourceAmount_ {};
    shared_ptr<string> integrationId_ {};
    shared_ptr<string> integrationName_ {};
    shared_ptr<vector<GrafanaWorkspaceIntegrationPreview>> previews_ {};
