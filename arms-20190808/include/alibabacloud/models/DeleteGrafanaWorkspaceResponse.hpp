...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGrafanaWorkspaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteGrafanaWorkspaceResponseBody) };
    inline DeleteGrafanaWorkspaceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteGrafanaWorkspaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteGrafanaWorkspaceResponseBody> body_ {};
  };
