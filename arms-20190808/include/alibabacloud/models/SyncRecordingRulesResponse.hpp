...
namespace Models
{
  ...
  public:
    ...
    inline const SyncRecordingRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SyncRecordingRulesResponseBody) };
    inline SyncRecordingRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, SyncRecordingRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SyncRecordingRulesResponseBody> body_ {};
  };
