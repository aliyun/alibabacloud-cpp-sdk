...
namespace Models
{
  ...
  public:
    ...
    inline const GetSyntheticTaskListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSyntheticTaskListResponseBody) };
    inline GetSyntheticTaskListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSyntheticTaskListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSyntheticTaskListResponseBody> body_ {};
  };
