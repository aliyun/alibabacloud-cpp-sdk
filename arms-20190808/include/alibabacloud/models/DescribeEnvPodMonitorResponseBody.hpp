...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnvPodMonitorResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEnvPodMonitorResponseBodyData) };
    inline DescribeEnvPodMonitorResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEnvPodMonitorResponseBodyData) };
    inline DescribeEnvPodMonitorResponseBody& setData(const DescribeEnvPodMonitorResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEnvPodMonitorResponseBody& setData(DescribeEnvPodMonitorResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<DescribeEnvPodMonitorResponseBodyData> data_ = nullptr;
