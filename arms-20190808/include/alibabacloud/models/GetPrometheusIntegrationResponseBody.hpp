...
namespace Models
{
  ...
  public:
    ...
    inline const GetPrometheusIntegrationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPrometheusIntegrationResponseBodyData) };
    inline GetPrometheusIntegrationResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPrometheusIntegrationResponseBodyData) };
    inline GetPrometheusIntegrationResponseBody& setData(const GetPrometheusIntegrationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPrometheusIntegrationResponseBody& setData(GetPrometheusIntegrationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<GetPrometheusIntegrationResponseBodyData> data_ = nullptr;
