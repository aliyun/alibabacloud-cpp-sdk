...
#ifndef ALIBABACLOUD_MODELS_LISTENVIRONMENTADDONSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTENVIRONMENTADDONSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListEnvironmentAddonsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListEnvironmentAddonsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListEnvironmentAddonsResponseBody& obj) { 
    ...
    ListEnvironmentAddonsResponseBody() = default ;
    ListEnvironmentAddonsResponseBody(const ListEnvironmentAddonsResponseBody &) = default ;
    ListEnvironmentAddonsResponseBody(ListEnvironmentAddonsResponseBody &&) = default ;
    ListEnvironmentAddonsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListEnvironmentAddonsResponseBody() = default ;
    ListEnvironmentAddonsResponseBody& operator=(const ListEnvironmentAddonsResponseBody &) = default ;
    ListEnvironmentAddonsResponseBody& operator=(ListEnvironmentAddonsResponseBody &&) = default ;
    ...
    public:
      ...
      inline const vector<Data::Addons> & getAddons() const { DARABONBA_PTR_GET_CONST(addons_, vector<Data::Addons>) };
    ...
    inline ListEnvironmentAddonsResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListEnvironmentAddonsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListEnvironmentAddonsResponseBody::Data) };
    inline ListEnvironmentAddonsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListEnvironmentAddonsResponseBody::Data) };
    inline ListEnvironmentAddonsResponseBody& setData(const ListEnvironmentAddonsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEnvironmentAddonsResponseBody& setData(ListEnvironmentAddonsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListEnvironmentAddonsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListEnvironmentAddonsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListEnvironmentAddonsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
