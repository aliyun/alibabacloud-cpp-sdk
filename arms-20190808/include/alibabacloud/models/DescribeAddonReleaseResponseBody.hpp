...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAddonReleaseResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeAddonReleaseResponseBodyData) };
    inline DescribeAddonReleaseResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeAddonReleaseResponseBodyData) };
    inline DescribeAddonReleaseResponseBody& setData(const DescribeAddonReleaseResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAddonReleaseResponseBody& setData(DescribeAddonReleaseResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAddonReleaseResponseBodyData> data_ = nullptr;
