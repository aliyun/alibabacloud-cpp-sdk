...
#ifndef ALIBABACLOUD_MODELS_GETTIMINGSYNTHETICTASKRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETTIMINGSYNTHETICTASKRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetTimingSyntheticTaskResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetTimingSyntheticTaskResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetTimingSyntheticTaskResponseBody() = default ;
    GetTimingSyntheticTaskResponseBody(const GetTimingSyntheticTaskResponseBody &) = default ;
    GetTimingSyntheticTaskResponseBody(GetTimingSyntheticTaskResponseBody &&) = default ;
    GetTimingSyntheticTaskResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetTimingSyntheticTaskResponseBody() = default ;
    GetTimingSyntheticTaskResponseBody& operator=(const GetTimingSyntheticTaskResponseBody &) = default ;
    GetTimingSyntheticTaskResponseBody& operator=(GetTimingSyntheticTaskResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->verifyStringBlacklist_ == nullptr && this->verifyStringWhitelist_ == nullptr && this->waitCompletionTime_ == nullptr; };
          ...
          inline int32_t getMonitorTimeout() const { DARABONBA_PTR_GET_DEFAULT(monitorTimeout_, 0) };
          inline Website& setMonitorTimeout(int32_t monitorTimeout) { DARABONBA_PTR_SET_VALUE(monitorTimeout_, monitorTimeout) };
        ...
        protected:
          ...
          shared_ptr<int32_t> monitorTimeout_ {};
        ...
        && this->tracertEnable_ == nullptr && this->tracertNumMax_ == nullptr && this->tracertTimeout_ == nullptr; };
          ...
          inline NetICMP& setInterval(int32_t interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
        ...
        && this->verifyWay_ == nullptr && this->whiteList_ == nullptr; };
          ...
          inline FileDownload& setDownloadKernel(int64_t downloadKernel) { DARABONBA_PTR_SET_VALUE(downloadKernel_, downloadKernel) };
          ...
          inline int64_t getQuickProtocol() const { DARABONBA_PTR_GET_DEFAULT(quickProtocol_, 0L) };
          inline FileDownload& setQuickProtocol(int64_t quickProtocol) { DARABONBA_PTR_SET_VALUE(quickProtocol_, quickProtocol) };
        ...
        protected:
          ...
          // *   2: http2
          // *   3: http3
          shared_ptr<int64_t> quickProtocol_ {};
      ...
      public:
        ...
        inline CustomPeriod& setEndHour(int64_t endHour) { DARABONBA_PTR_SET_VALUE(endHour_, endHour) };
        ...
        inline CustomPeriod& setStartHour(int64_t startHour) { DARABONBA_PTR_SET_VALUE(startHour_, startHour) };
      ...
      inline const vector<Data::AvailableAssertions> & getAvailableAssertions() const { DARABONBA_PTR_GET_CONST(availableAssertions_, vector<Data::AvailableAssertions>) };
      inline vector<Data::AvailableAssertions> getAvailableAssertions() { DARABONBA_PTR_GET(availableAssertions_, vector<Data::AvailableAssertions>) };
      inline Data& setAvailableAssertions(const vector<Data::AvailableAssertions> & availableAssertions) { DARABONBA_PTR_SET_VALUE(availableAssertions_, availableAssertions) };
      inline Data& setAvailableAssertions(vector<Data::AvailableAssertions> && availableAssertions) { DARABONBA_PTR_SET_RVALUE(availableAssertions_, availableAssertions) };
      ...
      inline const Data::CommonSetting & getCommonSetting() const { DARABONBA_PTR_GET_CONST(commonSetting_, Data::CommonSetting) };
      inline Data::CommonSetting getCommonSetting() { DARABONBA_PTR_GET(commonSetting_, Data::CommonSetting) };
      inline Data& setCommonSetting(const Data::CommonSetting & commonSetting) { DARABONBA_PTR_SET_VALUE(commonSetting_, commonSetting) };
      inline Data& setCommonSetting(Data::CommonSetting && commonSetting) { DARABONBA_PTR_SET_RVALUE(commonSetting_, commonSetting) };
      ...
      inline const Data::CustomPeriod & getCustomPeriod() const { DARABONBA_PTR_GET_CONST(customPeriod_, Data::CustomPeriod) };
      inline Data::CustomPeriod getCustomPeriod() { DARABONBA_PTR_GET(customPeriod_, Data::CustomPeriod) };
      inline Data& setCustomPeriod(const Data::CustomPeriod & customPeriod) { DARABONBA_PTR_SET_VALUE(customPeriod_, customPeriod) };
      inline Data& setCustomPeriod(Data::CustomPeriod && customPeriod) { DARABONBA_PTR_SET_RVALUE(customPeriod_, customPeriod) };
      ...
      inline int64_t getMonitorCategory() const { DARABONBA_PTR_GET_DEFAULT(monitorCategory_, 0L) };
      inline Data& setMonitorCategory(int64_t monitorCategory) { DARABONBA_PTR_SET_VALUE(monitorCategory_, monitorCategory) };
      ...
      inline const Data::MonitorConf & getMonitorConf() const { DARABONBA_PTR_GET_CONST(monitorConf_, Data::MonitorConf) };
      inline Data::MonitorConf getMonitorConf() { DARABONBA_PTR_GET(monitorConf_, Data::MonitorConf) };
      inline Data& setMonitorConf(const Data::MonitorConf & monitorConf) { DARABONBA_PTR_SET_VALUE(monitorConf_, monitorConf) };
      inline Data& setMonitorConf(Data::MonitorConf && monitorConf) { DARABONBA_PTR_SET_RVALUE(monitorConf_, monitorConf) };


      // monitors Field Functions 
      bool hasMonitors() const { return this->monitors_ != nullptr;};
      void deleteMonitors() { this->monitors_ = nullptr;};
      inline const vector<Data::Monitors> & getMonitors() const { DARABONBA_PTR_GET_CONST(monitors_, vector<Data::Monitors>) };
      inline vector<Data::Monitors> getMonitors() { DARABONBA_PTR_GET(monitors_, vector<Data::Monitors>) };
      inline Data& setMonitors(const vector<Data::Monitors> & monitors) { DARABONBA_PTR_SET_VALUE(monitors_, monitors) };
      inline Data& setMonitors(vector<Data::Monitors> && monitors) { DARABONBA_PTR_SET_RVALUE(monitors_, monitors) };
      ...
      inline Data& setTaskType(int32_t taskType) { DARABONBA_PTR_SET_VALUE(taskType_, taskType) };


    protected:
      // The list of assertions.
      shared_ptr<vector<Data::AvailableAssertions>> availableAssertions_ {};
      // The general settings.
      shared_ptr<Data::CommonSetting> commonSetting_ {};
      // The custom cycle.
      shared_ptr<Data::CustomPeriod> customPeriod_ {};
      // The detection frequency. Valid values: 1m, 5m, 10m, 15m, 20m, 30m, 1h, 2h, 3h, 4h, 6h, 8h, 12h, and 24h.
      shared_ptr<string> frequency_ {};
      // The detection point type. 1: PC. 2: mobile device.
      shared_ptr<int64_t> monitorCategory_ {};
      // The monitoring configurations.
      shared_ptr<Data::MonitorConf> monitorConf_ {};
      // The list of monitoring points.
      shared_ptr<vector<Data::Monitors>> monitors_ {};
    ...
    inline GetTimingSyntheticTaskResponseBody& setCode(int64_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetTimingSyntheticTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetTimingSyntheticTaskResponseBody::Data) };
    inline GetTimingSyntheticTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetTimingSyntheticTaskResponseBody::Data) };
    inline GetTimingSyntheticTaskResponseBody& setData(const GetTimingSyntheticTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTimingSyntheticTaskResponseBody& setData(GetTimingSyntheticTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetTimingSyntheticTaskResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetTimingSyntheticTaskResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
  ...
  protected:
    ...
    // The returned struct.
    shared_ptr<GetTimingSyntheticTaskResponseBody::Data> data_ {};
