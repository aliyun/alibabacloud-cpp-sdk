...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePrometheusMonitoringStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePrometheusMonitoringStatusResponseBody) };
    inline UpdatePrometheusMonitoringStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePrometheusMonitoringStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePrometheusMonitoringStatusResponseBody> body_ {};
  };
