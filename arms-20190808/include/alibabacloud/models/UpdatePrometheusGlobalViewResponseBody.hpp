...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePrometheusGlobalViewResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdatePrometheusGlobalViewResponseBodyData) };
    inline UpdatePrometheusGlobalViewResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdatePrometheusGlobalViewResponseBodyData) };
    inline UpdatePrometheusGlobalViewResponseBody& setData(const UpdatePrometheusGlobalViewResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdatePrometheusGlobalViewResponseBody& setData(UpdatePrometheusGlobalViewResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<UpdatePrometheusGlobalViewResponseBodyData> data_ = nullptr;
