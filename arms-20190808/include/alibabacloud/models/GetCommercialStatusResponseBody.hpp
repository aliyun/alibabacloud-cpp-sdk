...
namespace Models
{
  ...
  public:
    ...
    inline const GetCommercialStatusResponseBodyUserAndCommodityStatus & userAndCommodityStatus() const { DARABONBA_PTR_GET_CONST(userAndCommodityStatus_, GetCommercialStatusResponseBodyUserAndCommodityStatus) };
    inline GetCommercialStatusResponseBodyUserAndCommodityStatus userAndCommodityStatus() { DARABONBA_PTR_GET(userAndCommodityStatus_, GetCommercialStatusResponseBodyUserAndCommodityStatus) };
    inline GetCommercialStatusResponseBody& setUserAndCommodityStatus(const GetCommercialStatusResponseBodyUserAndCommodityStatus & userAndCommodityStatus) { DARABONBA_PTR_SET_VALUE(userAndCommodityStatus_, userAndCommodityStatus) };
    inline GetCommercialStatusResponseBody& setUserAndCommodityStatus(GetCommercialStatusResponseBodyUserAndCommodityStatus && userAndCommodityStatus) { DARABONBA_PTR_SET_RVALUE(userAndCommodityStatus_, userAndCommodityStatus) };
  ...
  protected:
    ...
    std::shared_ptr<GetCommercialStatusResponseBodyUserAndCommodityStatus> userAndCommodityStatus_ = nullptr;
  };
