...
namespace Models
{
  ...
  public:
    ...
    inline const AddPrometheusGlobalViewResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddPrometheusGlobalViewResponseBodyData) };
    inline AddPrometheusGlobalViewResponseBodyData data() { DARABONBA_PTR_GET(data_, AddPrometheusGlobalViewResponseBodyData) };
    inline AddPrometheusGlobalViewResponseBody& setData(const AddPrometheusGlobalViewResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddPrometheusGlobalViewResponseBody& setData(AddPrometheusGlobalViewResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<AddPrometheusGlobalViewResponseBodyData> data_ = nullptr;
    // 返回结果的提示信息。
