...
namespace Models
{
  ...
  public:
    ...
    inline string getGroupRule() const { DARABONBA_PTR_GET_DEFAULT(groupRule_, "") };
    ...
    inline string getNotifyRule() const { DARABONBA_PTR_GET_DEFAULT(notifyRule_, "") };
    ...
    inline string getNotifyTemplate() const { DARABONBA_PTR_GET_DEFAULT(notifyTemplate_, "") };
