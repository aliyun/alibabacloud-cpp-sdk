...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCommercialUsageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryCommercialUsageResponseBodyData) };
    inline QueryCommercialUsageResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryCommercialUsageResponseBodyData) };
    inline QueryCommercialUsageResponseBody& setData(const QueryCommercialUsageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryCommercialUsageResponseBody& setData(QueryCommercialUsageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<QueryCommercialUsageResponseBodyData> data_ = nullptr;
