...
#ifndef ALIBABACLOUD_MODELS_UPDATETIMINGSYNTHETICTASKREQUESTAVAILABLEASSERTIONS_HPP_
#define ALIBABACLOUD_MODELS_UPDATETIMINGSYNTHETICTASKREQUESTAVAILABLEASSERTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateTimingSyntheticTaskRequestAvailableAssertions& obj) { 
      DARABONBA_PTR_TO_JSON(Expect, expect_);
      DARABONBA_PTR_TO_JSON(Operator, operator_);
      DARABONBA_PTR_TO_JSON(Target, target_);
      DARABONBA_PTR_TO_JSON(Type, type_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateTimingSyntheticTaskRequestAvailableAssertions& obj) { 
      DARABONBA_PTR_FROM_JSON(Expect, expect_);
      DARABONBA_PTR_FROM_JSON(Operator, operator_);
      DARABONBA_PTR_FROM_JSON(Target, target_);
      DARABONBA_PTR_FROM_JSON(Type, type_);
    };
    UpdateTimingSyntheticTaskRequestAvailableAssertions() = default ;
    UpdateTimingSyntheticTaskRequestAvailableAssertions(const UpdateTimingSyntheticTaskRequestAvailableAssertions &) = default ;
    UpdateTimingSyntheticTaskRequestAvailableAssertions(UpdateTimingSyntheticTaskRequestAvailableAssertions &&) = default ;
    UpdateTimingSyntheticTaskRequestAvailableAssertions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateTimingSyntheticTaskRequestAvailableAssertions() = default ;
    UpdateTimingSyntheticTaskRequestAvailableAssertions& operator=(const UpdateTimingSyntheticTaskRequestAvailableAssertions &) = default ;
    UpdateTimingSyntheticTaskRequestAvailableAssertions& operator=(UpdateTimingSyntheticTaskRequestAvailableAssertions &&) = default ;
    ...
    inline UpdateTimingSyntheticTaskRequestAvailableAssertions& setExpect(string expect) { DARABONBA_PTR_SET_VALUE(expect_, expect) };
    ...
    inline UpdateTimingSyntheticTaskRequestAvailableAssertions& setOperator(string _operator) { DARABONBA_PTR_SET_VALUE(operator_, _operator) };
    ...
    inline UpdateTimingSyntheticTaskRequestAvailableAssertions& setTarget(string target) { DARABONBA_PTR_SET_VALUE(target_, target) };
    ...
    inline UpdateTimingSyntheticTaskRequestAvailableAssertions& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
