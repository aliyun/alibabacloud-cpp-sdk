...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEventBridgeIntegrationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteEventBridgeIntegrationResponseBody) };
    inline DeleteEventBridgeIntegrationResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteEventBridgeIntegrationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteEventBridgeIntegrationResponseBody> body_ {};
  };
