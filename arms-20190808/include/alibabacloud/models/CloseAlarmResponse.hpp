...
namespace Models
{
  ...
  public:
    ...
    inline const CloseAlarmResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CloseAlarmResponseBody) };
    inline CloseAlarmResponseBody getBody() { DARABONBA_PTR_GET(body_, CloseAlarmResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CloseAlarmResponseBody> body_ {};
  };
