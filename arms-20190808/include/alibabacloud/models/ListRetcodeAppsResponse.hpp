...
namespace Models
{
  ...
  public:
    ...
    inline const ListRetcodeAppsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListRetcodeAppsResponseBody) };
    inline ListRetcodeAppsResponseBody body() { DARABONBA_PTR_GET(body_, ListRetcodeAppsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListRetcodeAppsResponseBody> body_ = nullptr;
  };
