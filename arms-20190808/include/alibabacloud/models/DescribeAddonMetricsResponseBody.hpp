...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAddonMetricsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeAddonMetricsResponseBodyData>) };
    inline vector<DescribeAddonMetricsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeAddonMetricsResponseBodyData>) };
    inline DescribeAddonMetricsResponseBody& setData(const vector<DescribeAddonMetricsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAddonMetricsResponseBody& setData(vector<DescribeAddonMetricsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The metric details.
    std::shared_ptr<vector<DescribeAddonMetricsResponseBodyData>> data_ = nullptr;
