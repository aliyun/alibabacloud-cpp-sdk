...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListRetcodeAppsRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<ListRetcodeAppsRequest::Tags>) };
    inline vector<ListRetcodeAppsRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<ListRetcodeAppsRequest::Tags>) };
    inline ListRetcodeAppsRequest& setTags(const vector<ListRetcodeAppsRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline ListRetcodeAppsRequest& setTags(vector<ListRetcodeAppsRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    shared_ptr<vector<ListRetcodeAppsRequest::Tags>> tags_ {};
  };
