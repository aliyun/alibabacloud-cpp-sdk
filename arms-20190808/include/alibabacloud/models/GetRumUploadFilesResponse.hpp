...
namespace Models
{
  ...
  public:
    ...
    inline const GetRumUploadFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRumUploadFilesResponseBody) };
    inline GetRumUploadFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRumUploadFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRumUploadFilesResponseBody> body_ {};
  };
