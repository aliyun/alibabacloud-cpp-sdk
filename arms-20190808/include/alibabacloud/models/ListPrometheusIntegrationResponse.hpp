...
namespace Models
{
  ...
  public:
    ...
    inline const ListPrometheusIntegrationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPrometheusIntegrationResponseBody) };
    inline ListPrometheusIntegrationResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPrometheusIntegrationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPrometheusIntegrationResponseBody> body_ {};
  };
