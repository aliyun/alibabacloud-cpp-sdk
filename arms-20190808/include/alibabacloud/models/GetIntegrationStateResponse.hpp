...
namespace Models
{
  ...
  public:
    ...
    inline const GetIntegrationStateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetIntegrationStateResponseBody) };
    inline GetIntegrationStateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetIntegrationStateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetIntegrationStateResponseBody> body_ {};
  };
