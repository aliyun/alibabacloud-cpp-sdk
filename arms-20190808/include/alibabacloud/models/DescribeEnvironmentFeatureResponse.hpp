...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnvironmentFeatureResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEnvironmentFeatureResponseBody) };
    inline DescribeEnvironmentFeatureResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEnvironmentFeatureResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEnvironmentFeatureResponseBody> body_ {};
  };
