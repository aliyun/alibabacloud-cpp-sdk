...
namespace Models
{
  ...
  public:
    ...
    inline const ListTraceAppsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListTraceAppsResponseBody) };
    inline ListTraceAppsResponseBody body() { DARABONBA_PTR_GET(body_, ListTraceAppsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListTraceAppsResponseBody> body_ = nullptr;
  };
