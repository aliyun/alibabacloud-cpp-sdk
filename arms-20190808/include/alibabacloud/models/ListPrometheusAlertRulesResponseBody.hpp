...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<PrometheusAlertRules::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<PrometheusAlertRules::Tags>) };
      inline vector<PrometheusAlertRules::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<PrometheusAlertRules::Tags>) };
      inline PrometheusAlertRules& setTags(const vector<PrometheusAlertRules::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
      inline PrometheusAlertRules& setTags(vector<PrometheusAlertRules::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    protected:
      ...
      // The tags.
      shared_ptr<vector<PrometheusAlertRules::Tags>> tags_ {};
