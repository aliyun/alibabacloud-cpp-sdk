...
namespace Models
{
  ...
  public:
    ...
    inline const GetSyntheticMonitorsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSyntheticMonitorsResponseBody) };
    inline GetSyntheticMonitorsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSyntheticMonitorsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSyntheticMonitorsResponseBody> body_ {};
  };
