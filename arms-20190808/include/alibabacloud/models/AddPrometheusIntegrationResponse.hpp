...
namespace Models
{
  ...
  public:
    ...
    inline const AddPrometheusIntegrationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddPrometheusIntegrationResponseBody) };
    inline AddPrometheusIntegrationResponseBody getBody() { DARABONBA_PTR_GET(body_, AddPrometheusIntegrationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddPrometheusIntegrationResponseBody> body_ {};
  };
