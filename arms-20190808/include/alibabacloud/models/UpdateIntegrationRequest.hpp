...
namespace Models
{
  ...
  public:
    ...
    inline string getExtendedFieldRedefineRules() const { DARABONBA_PTR_GET_DEFAULT(extendedFieldRedefineRules_, "") };
    ...
    inline string getFieldRedefineRules() const { DARABONBA_PTR_GET_DEFAULT(fieldRedefineRules_, "") };
    ...
    inline string getStat() const { DARABONBA_PTR_GET_DEFAULT(stat_, "") };
  ...
  protected:
    ...
    shared_ptr<string> extendedFieldRedefineRules_ {};
    ...
    shared_ptr<string> fieldRedefineRules_ {};
