...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOrUpdateWebhookContactResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateOrUpdateWebhookContactResponseBody) };
    inline CreateOrUpdateWebhookContactResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateOrUpdateWebhookContactResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateOrUpdateWebhookContactResponseBody> body_ {};
  };
