...
namespace Models
{
  ...
  public:
    ...
    inline const GetRumUploadFilesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRumUploadFilesResponseBodyData) };
    inline GetRumUploadFilesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRumUploadFilesResponseBodyData) };
    inline GetRumUploadFilesResponseBody& setData(const GetRumUploadFilesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRumUploadFilesResponseBody& setData(GetRumUploadFilesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The queried files.
    std::shared_ptr<GetRumUploadFilesResponseBodyData> data_ = nullptr;
