...
namespace Models
{
  ...
  public:
    ...
    inline const SaveTraceAppConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SaveTraceAppConfigResponseBody) };
    inline SaveTraceAppConfigResponseBody body() { DARABONBA_PTR_GET(body_, SaveTraceAppConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SaveTraceAppConfigResponseBody> body_ = nullptr;
  };
