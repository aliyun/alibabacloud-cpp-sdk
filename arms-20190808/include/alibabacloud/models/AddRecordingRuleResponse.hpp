...
namespace Models
{
  ...
  public:
    ...
    inline const AddRecordingRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddRecordingRuleResponseBody) };
    inline AddRecordingRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, AddRecordingRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddRecordingRuleResponseBody> body_ {};
  };
