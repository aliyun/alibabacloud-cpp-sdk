...
namespace Models
{
  ...
  public:
    ...
    inline const DelAuthTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DelAuthTokenResponseBody) };
    inline DelAuthTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, DelAuthTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DelAuthTokenResponseBody> body_ {};
  };
