...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getCallCount() const { DARABONBA_PTR_GET_DEFAULT(callCount_, "") };
      inline StackInfo& setCallCount(string callCount) { DARABONBA_PTR_SET_VALUE(callCount_, callCount) };
