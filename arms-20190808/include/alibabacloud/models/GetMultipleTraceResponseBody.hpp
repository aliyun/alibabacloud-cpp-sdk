...
namespace Models
{
  ...
  public:
    ...
    class MultiCallChainInfos : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const MultiCallChainInfos& obj) { 
        DARABONBA_PTR_TO_JSON(Spans, spans_);
        DARABONBA_PTR_TO_JSON(TraceID, traceID_);
      };
      friend void from_json(const Darabonba::Json& j, MultiCallChainInfos& obj) { 
        DARABONBA_PTR_FROM_JSON(Spans, spans_);
        DARABONBA_PTR_FROM_JSON(TraceID, traceID_);
      };
      MultiCallChainInfos() = default ;
      MultiCallChainInfos(const MultiCallChainInfos &) = default ;
      MultiCallChainInfos(MultiCallChainInfos &&) = default ;
      MultiCallChainInfos(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~MultiCallChainInfos() = default ;
      MultiCallChainInfos& operator=(const MultiCallChainInfos &) = default ;
      MultiCallChainInfos& operator=(MultiCallChainInfos &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      virtual bool empty() const override { return this->spans_ == nullptr
        && this->traceID_ == nullptr; };
      // spans Field Functions 
      bool hasSpans() const { return this->spans_ != nullptr;};
      void deleteSpans() { this->spans_ = nullptr;};
      inline const vector<MultiCallChainInfos::Spans> & getSpans() const { DARABONBA_PTR_GET_CONST(spans_, vector<MultiCallChainInfos::Spans>) };
      inline vector<MultiCallChainInfos::Spans> getSpans() { DARABONBA_PTR_GET(spans_, vector<MultiCallChainInfos::Spans>) };
      inline MultiCallChainInfos& setSpans(const vector<MultiCallChainInfos::Spans> & spans) { DARABONBA_PTR_SET_VALUE(spans_, spans) };
      inline MultiCallChainInfos& setSpans(vector<MultiCallChainInfos::Spans> && spans) { DARABONBA_PTR_SET_RVALUE(spans_, spans) };
      ...
      void deleteTraceID() { this->traceID_ = nullptr;};
      inline string getTraceID() const { DARABONBA_PTR_GET_DEFAULT(traceID_, "") };
      inline MultiCallChainInfos& setTraceID(string traceID) { DARABONBA_PTR_SET_VALUE(traceID_, traceID) };


    protected:
      // The details of the trace.
      shared_ptr<vector<MultiCallChainInfos::Spans>> spans_ {};
      // The trace ID.
      shared_ptr<string> traceID_ {};
    };

    virtual bool empty() const override { return this->multiCallChainInfos_ == nullptr
    ...
    inline const vector<GetMultipleTraceResponseBody::MultiCallChainInfos> & getMultiCallChainInfos() const { DARABONBA_PTR_GET_CONST(multiCallChainInfos_, vector<GetMultipleTraceResponseBody::MultiCallChainInfos>) };
    inline vector<GetMultipleTraceResponseBody::MultiCallChainInfos> getMultiCallChainInfos() { DARABONBA_PTR_GET(multiCallChainInfos_, vector<GetMultipleTraceResponseBody::MultiCallChainInfos>) };
    inline GetMultipleTraceResponseBody& setMultiCallChainInfos(const vector<GetMultipleTraceResponseBody::MultiCallChainInfos> & multiCallChainInfos) { DARABONBA_PTR_SET_VALUE(multiCallChainInfos_, multiCallChainInfos) };
    inline GetMultipleTraceResponseBody& setMultiCallChainInfos(vector<GetMultipleTraceResponseBody::MultiCallChainInfos> && multiCallChainInfos) { DARABONBA_PTR_SET_RVALUE(multiCallChainInfos_, multiCallChainInfos) };
  ...
  protected:
    ...
    shared_ptr<vector<GetMultipleTraceResponseBody::MultiCallChainInfos>> multiCallChainInfos_ {};
    // The request ID.
