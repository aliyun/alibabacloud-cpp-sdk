...
namespace Models
{
  ...
  public:
    ...
    inline const ListPrometheusAlertTemplatesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListPrometheusAlertTemplatesResponseBody) };
    inline ListPrometheusAlertTemplatesResponseBody body() { DARABONBA_PTR_GET(body_, ListPrometheusAlertTemplatesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListPrometheusAlertTemplatesResponseBody> body_ = nullptr;
  };
