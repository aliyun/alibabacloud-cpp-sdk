...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateGrafanaWorkspaceRequestTags> & tags() const { DARABONBA_PTR_GET_CONST(tags_, vector<CreateGrafanaWorkspaceRequestTags>) };
    inline vector<CreateGrafanaWorkspaceRequestTags> tags() { DARABONBA_PTR_GET(tags_, vector<CreateGrafanaWorkspaceRequestTags>) };
    inline CreateGrafanaWorkspaceRequest& setTags(const vector<CreateGrafanaWorkspaceRequestTags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline CreateGrafanaWorkspaceRequest& setTags(vector<CreateGrafanaWorkspaceRequestTags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    // The list of tags.
    std::shared_ptr<vector<CreateGrafanaWorkspaceRequestTags>> tags_ = nullptr;
  };
