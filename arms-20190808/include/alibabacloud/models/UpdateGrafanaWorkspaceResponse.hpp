...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGrafanaWorkspaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateGrafanaWorkspaceResponseBody) };
    inline UpdateGrafanaWorkspaceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateGrafanaWorkspaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateGrafanaWorkspaceResponseBody> body_ {};
  };
