...
namespace Models
{
  ...
  public:
    ...
    inline const GetRumOcuStatisticDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRumOcuStatisticDataResponseBody) };
    inline GetRumOcuStatisticDataResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRumOcuStatisticDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRumOcuStatisticDataResponseBody> body_ {};
  };
