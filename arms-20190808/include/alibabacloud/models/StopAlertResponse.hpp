...
namespace Models
{
  ...
  public:
    ...
    inline const StopAlertResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, StopAlertResponseBody) };
    inline StopAlertResponseBody body() { DARABONBA_PTR_GET(body_, StopAlertResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<StopAlertResponseBody> body_ = nullptr;
  };
