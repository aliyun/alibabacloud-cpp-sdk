...
namespace Models
{
  ...
  public:
    ...
    inline const ListEventBridgeIntegrationsResponseBodyPageBean & pageBean() const { DARABONBA_PTR_GET_CONST(pageBean_, ListEventBridgeIntegrationsResponseBodyPageBean) };
    inline ListEventBridgeIntegrationsResponseBodyPageBean pageBean() { DARABONBA_PTR_GET(pageBean_, ListEventBridgeIntegrationsResponseBodyPageBean) };
    inline ListEventBridgeIntegrationsResponseBody& setPageBean(const ListEventBridgeIntegrationsResponseBodyPageBean & pageBean) { DARABONBA_PTR_SET_VALUE(pageBean_, pageBean) };
    inline ListEventBridgeIntegrationsResponseBody& setPageBean(ListEventBridgeIntegrationsResponseBodyPageBean && pageBean) { DARABONBA_PTR_SET_RVALUE(pageBean_, pageBean) };
  ...
  protected:
    ...
    std::shared_ptr<ListEventBridgeIntegrationsResponseBodyPageBean> pageBean_ = nullptr;
