...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Spans& setChildren(const vector<Darabonba::Json> & children) { DARABONBA_PTR_SET_VALUE(children_, children) };
      inline Spans& setChildren(vector<Darabonba::Json> && children) { DARABONBA_PTR_SET_RVALUE(children_, children) };
