...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getLastSendTime() const { DARABONBA_PTR_GET_DEFAULT(lastSendTime_, 0L) };
    ...
    inline string getReportChannelTarget() const { DARABONBA_PTR_GET_DEFAULT(reportChannelTarget_, "") };
    ...
    inline string getReportChannelType() const { DARABONBA_PTR_GET_DEFAULT(reportChannelType_, "") };
    ...
    inline string getReportStyle() const { DARABONBA_PTR_GET_DEFAULT(reportStyle_, "") };
    ...
    inline string getTriggerDay() const { DARABONBA_PTR_GET_DEFAULT(triggerDay_, "") };
  ...
  protected:
    ...
    shared_ptr<int64_t> lastSendTime_ {};
    shared_ptr<string> msg_ {};
    shared_ptr<string> name_ {};
    shared_ptr<string> reportChannelTarget_ {};
    shared_ptr<string> reportChannelType_ {};
    shared_ptr<string> reportStyle_ {};
    shared_ptr<string> reportType_ {};
    shared_ptr<string> status_ {};
    shared_ptr<string> triggerDay_ {};
