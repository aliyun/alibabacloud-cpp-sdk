...
namespace Models
{
  ...
  public:
    ...
    inline const SearchAlertHistoriesResponseBodyPageBean & pageBean() const { DARABONBA_PTR_GET_CONST(pageBean_, SearchAlertHistoriesResponseBodyPageBean) };
    inline SearchAlertHistoriesResponseBodyPageBean pageBean() { DARABONBA_PTR_GET(pageBean_, SearchAlertHistoriesResponseBodyPageBean) };
    inline SearchAlertHistoriesResponseBody& setPageBean(const SearchAlertHistoriesResponseBodyPageBean & pageBean) { DARABONBA_PTR_SET_VALUE(pageBean_, pageBean) };
    inline SearchAlertHistoriesResponseBody& setPageBean(SearchAlertHistoriesResponseBodyPageBean && pageBean) { DARABONBA_PTR_SET_RVALUE(pageBean_, pageBean) };
  ...
  protected:
    // The returned struct.
    std::shared_ptr<SearchAlertHistoriesResponseBodyPageBean> pageBean_ = nullptr;
