...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEnvServiceMonitorResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateEnvServiceMonitorResponseBodyData) };
    inline CreateEnvServiceMonitorResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateEnvServiceMonitorResponseBodyData) };
    inline CreateEnvServiceMonitorResponseBody& setData(const CreateEnvServiceMonitorResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateEnvServiceMonitorResponseBody& setData(CreateEnvServiceMonitorResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<CreateEnvServiceMonitorResponseBodyData> data_ = nullptr;
