...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnvServiceMonitorResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEnvServiceMonitorResponseBodyData) };
    inline DescribeEnvServiceMonitorResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEnvServiceMonitorResponseBodyData) };
    inline DescribeEnvServiceMonitorResponseBody& setData(const DescribeEnvServiceMonitorResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEnvServiceMonitorResponseBody& setData(DescribeEnvServiceMonitorResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<DescribeEnvServiceMonitorResponseBodyData> data_ = nullptr;
