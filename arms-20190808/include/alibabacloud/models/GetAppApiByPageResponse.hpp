...
namespace Models
{
  ...
  public:
    ...
    inline const GetAppApiByPageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAppApiByPageResponseBody) };
    inline GetAppApiByPageResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAppApiByPageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAppApiByPageResponseBody> body_ {};
  };
