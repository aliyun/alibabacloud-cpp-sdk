...
namespace Models
{
  ...
  public:
    ...
    inline const GetGrafanaWorkspaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetGrafanaWorkspaceResponseBody) };
    inline GetGrafanaWorkspaceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetGrafanaWorkspaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetGrafanaWorkspaceResponseBody> body_ {};
  };
