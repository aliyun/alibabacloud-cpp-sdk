...
namespace Models
{
  ...
  public:
    ...
    inline const ListEnvironmentMetricTargetsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListEnvironmentMetricTargetsResponseBodyData) };
    inline ListEnvironmentMetricTargetsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListEnvironmentMetricTargetsResponseBodyData) };
    inline ListEnvironmentMetricTargetsResponseBody& setData(const ListEnvironmentMetricTargetsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEnvironmentMetricTargetsResponseBody& setData(ListEnvironmentMetricTargetsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The struct returned.
    std::shared_ptr<ListEnvironmentMetricTargetsResponseBodyData> data_ = nullptr;
