...
namespace Models
{
  ...
  public:
    ...
    inline const ListEscalationPoliciesResponseBodyPageBean & pageBean() const { DARABONBA_PTR_GET_CONST(pageBean_, ListEscalationPoliciesResponseBodyPageBean) };
    inline ListEscalationPoliciesResponseBodyPageBean pageBean() { DARABONBA_PTR_GET(pageBean_, ListEscalationPoliciesResponseBodyPageBean) };
    inline ListEscalationPoliciesResponseBody& setPageBean(const ListEscalationPoliciesResponseBodyPageBean & pageBean) { DARABONBA_PTR_SET_VALUE(pageBean_, pageBean) };
    inline ListEscalationPoliciesResponseBody& setPageBean(ListEscalationPoliciesResponseBodyPageBean && pageBean) { DARABONBA_PTR_SET_RVALUE(pageBean_, pageBean) };
  ...
  protected:
    ...
    std::shared_ptr<ListEscalationPoliciesResponseBodyPageBean> pageBean_ = nullptr;
    // The request ID.
