...
namespace Models
{
  ...
  public:
    ...
    inline const GetPrometheusGlobalViewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPrometheusGlobalViewResponseBody) };
    inline GetPrometheusGlobalViewResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPrometheusGlobalViewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPrometheusGlobalViewResponseBody> body_ {};
  };
