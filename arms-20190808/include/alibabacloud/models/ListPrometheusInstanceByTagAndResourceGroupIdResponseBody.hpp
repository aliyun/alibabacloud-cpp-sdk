...
namespace Models
{
  ...
  public:
    ...
    inline const ListPrometheusInstanceByTagAndResourceGroupIdResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListPrometheusInstanceByTagAndResourceGroupIdResponseBodyData) };
    inline ListPrometheusInstanceByTagAndResourceGroupIdResponseBodyData data() { DARABONBA_PTR_GET(data_, ListPrometheusInstanceByTagAndResourceGroupIdResponseBodyData) };
    inline ListPrometheusInstanceByTagAndResourceGroupIdResponseBody& setData(const ListPrometheusInstanceByTagAndResourceGroupIdResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPrometheusInstanceByTagAndResourceGroupIdResponseBody& setData(ListPrometheusInstanceByTagAndResourceGroupIdResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<ListPrometheusInstanceByTagAndResourceGroupIdResponseBodyData> data_ = nullptr;
