...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentDownloadUrlV2ResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetAgentDownloadUrlV2ResponseBody::Data) };
    inline GetAgentDownloadUrlV2ResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetAgentDownloadUrlV2ResponseBody::Data) };
    inline GetAgentDownloadUrlV2ResponseBody& setData(const GetAgentDownloadUrlV2ResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAgentDownloadUrlV2ResponseBody& setData(GetAgentDownloadUrlV2ResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<GetAgentDownloadUrlV2ResponseBody::Data> data_ {};
