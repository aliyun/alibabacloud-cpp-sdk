...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveAliClusterIdsFromPrometheusGlobalViewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveAliClusterIdsFromPrometheusGlobalViewResponseBody) };
    inline RemoveAliClusterIdsFromPrometheusGlobalViewResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveAliClusterIdsFromPrometheusGlobalViewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveAliClusterIdsFromPrometheusGlobalViewResponseBody> body_ {};
  };
