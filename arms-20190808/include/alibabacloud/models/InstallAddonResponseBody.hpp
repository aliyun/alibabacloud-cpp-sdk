...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Data& setAlertRuleCount(int64_t alertRuleCount) { DARABONBA_PTR_SET_VALUE(alertRuleCount_, alertRuleCount) };


      // conditions Field Functions 
      bool hasConditions() const { return this->conditions_ != nullptr;};
      void deleteConditions() { this->conditions_ = nullptr;};
      inline const vector<Data::Conditions> & getConditions() const { DARABONBA_PTR_GET_CONST(conditions_, vector<Data::Conditions>) };
      inline vector<Data::Conditions> getConditions() { DARABONBA_PTR_GET(conditions_, vector<Data::Conditions>) };
      inline Data& setConditions(const vector<Data::Conditions> & conditions) { DARABONBA_PTR_SET_VALUE(conditions_, conditions) };
      inline Data& setConditions(vector<Data::Conditions> && conditions) { DARABONBA_PTR_SET_RVALUE(conditions_, conditions) };
      ...
      inline Data& setDashboardCount(int64_t dashboardCount) { DARABONBA_PTR_SET_VALUE(dashboardCount_, dashboardCount) };
      ...
      inline Data& setExporterCount(int64_t exporterCount) { DARABONBA_PTR_SET_VALUE(exporterCount_, exporterCount) };
      ...
      inline Data& setHaveConfig(bool haveConfig) { DARABONBA_PTR_SET_VALUE(haveConfig_, haveConfig) };
      ...
      inline Data& setInstallUserId(string installUserId) { DARABONBA_PTR_SET_VALUE(installUserId_, installUserId) };
      ...
      inline Data& setReleaseId(string releaseId) { DARABONBA_PTR_SET_VALUE(releaseId_, releaseId) };
      ...
      inline Data& setReleaseName(string releaseName) { DARABONBA_PTR_SET_VALUE(releaseName_, releaseName) };
    ...
    protected:
      ...
      shared_ptr<vector<Data::Conditions>> conditions_ {};
    ...
    inline InstallAddonResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const InstallAddonResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, InstallAddonResponseBody::Data) };
    inline InstallAddonResponseBody::Data getData() { DARABONBA_PTR_GET(data_, InstallAddonResponseBody::Data) };
    inline InstallAddonResponseBody& setData(const InstallAddonResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline InstallAddonResponseBody& setData(InstallAddonResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    void deleteMessage() { this->message_ = nullptr;};
    inline string getMessage() const { DARABONBA_PTR_GET_DEFAULT(message_, "") };
    inline InstallAddonResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline InstallAddonResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The returned data.
    shared_ptr<InstallAddonResponseBody::Data> data_ {};
    // The returned message.
    shared_ptr<string> message_ {};
