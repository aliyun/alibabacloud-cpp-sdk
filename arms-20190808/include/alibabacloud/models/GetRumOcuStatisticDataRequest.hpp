...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetRumOcuStatisticDataRequestFilter> & filter() const { DARABONBA_PTR_GET_CONST(filter_, vector<GetRumOcuStatisticDataRequestFilter>) };
    inline vector<GetRumOcuStatisticDataRequestFilter> filter() { DARABONBA_PTR_GET(filter_, vector<GetRumOcuStatisticDataRequestFilter>) };
    inline GetRumOcuStatisticDataRequest& setFilter(const vector<GetRumOcuStatisticDataRequestFilter> & filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    inline GetRumOcuStatisticDataRequest& setFilter(vector<GetRumOcuStatisticDataRequestFilter> && filter) { DARABONBA_PTR_SET_RVALUE(filter_, filter) };
  ...
  protected:
    ...
    // *   Data type: dataType
    std::shared_ptr<vector<GetRumOcuStatisticDataRequestFilter>> filter_ = nullptr;
