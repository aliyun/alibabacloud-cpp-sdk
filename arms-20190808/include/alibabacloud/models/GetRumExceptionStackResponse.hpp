...
namespace Models
{
  ...
  public:
    ...
    inline const GetRumExceptionStackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRumExceptionStackResponseBody) };
    inline GetRumExceptionStackResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRumExceptionStackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRumExceptionStackResponseBody> body_ {};
  };
