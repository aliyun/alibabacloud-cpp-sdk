...
namespace Models
{
  ...
  public:
    ...
    inline const GetRumAppInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRumAppInfoResponseBody) };
    inline GetRumAppInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRumAppInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRumAppInfoResponseBody> body_ {};
  };
