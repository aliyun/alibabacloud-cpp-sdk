...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeContactsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeContactsResponseBody) };
    inline DescribeContactsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeContactsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeContactsResponseBody> body_ {};
  };
