...
namespace Models
{
  ...
  public:
    ...
    inline const GetExploreUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetExploreUrlResponseBody) };
    inline GetExploreUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, GetExploreUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetExploreUrlResponseBody> body_ {};
  };
