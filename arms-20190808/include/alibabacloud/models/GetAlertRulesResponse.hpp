...
namespace Models
{
  ...
  public:
    ...
    inline const GetAlertRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAlertRulesResponseBody) };
    inline GetAlertRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAlertRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAlertRulesResponseBody> body_ {};
  };
