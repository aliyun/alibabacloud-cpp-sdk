...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAlertContactGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAlertContactGroupResponseBody) };
    inline CreateAlertContactGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAlertContactGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAlertContactGroupResponseBody> body_ {};
  };
