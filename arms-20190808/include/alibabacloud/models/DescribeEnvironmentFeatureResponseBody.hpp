...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnvironmentFeatureResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEnvironmentFeatureResponseBodyData) };
    inline DescribeEnvironmentFeatureResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEnvironmentFeatureResponseBodyData) };
    inline DescribeEnvironmentFeatureResponseBody& setData(const DescribeEnvironmentFeatureResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEnvironmentFeatureResponseBody& setData(DescribeEnvironmentFeatureResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The struct returned.
    std::shared_ptr<DescribeEnvironmentFeatureResponseBodyData> data_ = nullptr;
