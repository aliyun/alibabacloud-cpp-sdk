  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline bool getHostByAlertManager() const { DARABONBA_PTR_GET_DEFAULT(hostByAlertManager_, false) };
        inline AlertRules& setHostByAlertManager(bool hostByAlertManager) { DARABONBA_PTR_SET_VALUE(hostByAlertManager_, hostByAlertManager) };
        ...
        inline AlertRules& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
      ...
      protected:
        ...
        // *   `true`
        // *   `false`
        shared_ptr<bool> hostByAlertManager_ {};
