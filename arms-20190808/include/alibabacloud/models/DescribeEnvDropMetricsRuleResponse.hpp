...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnvDropMetricsRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEnvDropMetricsRuleResponseBody) };
    inline DescribeEnvDropMetricsRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEnvDropMetricsRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEnvDropMetricsRuleResponseBody> body_ {};
  };
