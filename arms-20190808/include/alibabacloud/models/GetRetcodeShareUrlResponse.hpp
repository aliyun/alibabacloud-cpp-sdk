...
namespace Models
{
  ...
  public:
    ...
    inline const GetRetcodeShareUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRetcodeShareUrlResponseBody) };
    inline GetRetcodeShareUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRetcodeShareUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRetcodeShareUrlResponseBody> body_ {};
  };
