...
#ifndef ALIBABACLOUD_MODELS_GETTIMINGSYNTHETICTASKRESPONSEBODYDATAMONITORCONFFILEDOWNLOAD_HPP_
#define ALIBABACLOUD_MODELS_GETTIMINGSYNTHETICTASKRESPONSEBODYDATAMONITORCONFFILEDOWNLOAD_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& obj) { 
    ...
    GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload() = default ;
    GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload(const GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload &) = default ;
    GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload(GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload &&) = default ;
    GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload() = default ;
    GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& operator=(const GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload &) = default ;
    GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& operator=(GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload &&) = default ;
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setConnectionTimeout(int64_t connectionTimeout) { DARABONBA_PTR_SET_VALUE(connectionTimeout_, connectionTimeout) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setCustomHeaderContent(const map<string, string> & customHeaderContent) { DARABONBA_PTR_SET_VALUE(customHeaderContent_, customHeaderContent) };
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setCustomHeaderContent(map<string, string> && customHeaderContent) { DARABONBA_PTR_SET_RVALUE(customHeaderContent_, customHeaderContent) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setDownloadKernel(int64_t downloadKernel) { DARABONBA_PTR_SET_VALUE(downloadKernel_, downloadKernel) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setIgnoreCertificateAuthError(int32_t ignoreCertificateAuthError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateAuthError_, ignoreCertificateAuthError) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setIgnoreCertificateCanceledError(int32_t ignoreCertificateCanceledError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateCanceledError_, ignoreCertificateCanceledError) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setIgnoreCertificateOutOfDateError(int32_t ignoreCertificateOutOfDateError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateOutOfDateError_, ignoreCertificateOutOfDateError) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setIgnoreCertificateStatusError(int32_t ignoreCertificateStatusError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateStatusError_, ignoreCertificateStatusError) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setIgnoreCertificateUntrustworthyError(int32_t ignoreCertificateUntrustworthyError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateUntrustworthyError_, ignoreCertificateUntrustworthyError) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setIgnoreCertificateUsingError(int32_t ignoreCertificateUsingError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateUsingError_, ignoreCertificateUsingError) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setIgnoreInvalidHostError(int32_t ignoreInvalidHostError) { DARABONBA_PTR_SET_VALUE(ignoreInvalidHostError_, ignoreInvalidHostError) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setMonitorTimeout(int64_t monitorTimeout) { DARABONBA_PTR_SET_VALUE(monitorTimeout_, monitorTimeout) };
    ...
    inline int64_t quickProtocol() const { DARABONBA_PTR_GET_DEFAULT(quickProtocol_, 0L) };
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setQuickProtocol(int64_t quickProtocol) { DARABONBA_PTR_SET_VALUE(quickProtocol_, quickProtocol) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setRedirection(int32_t redirection) { DARABONBA_PTR_SET_VALUE(redirection_, redirection) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setTargetUrl(string targetUrl) { DARABONBA_PTR_SET_VALUE(targetUrl_, targetUrl) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setTransmissionSize(int64_t transmissionSize) { DARABONBA_PTR_SET_VALUE(transmissionSize_, transmissionSize) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setValidateKeywords(string validateKeywords) { DARABONBA_PTR_SET_VALUE(validateKeywords_, validateKeywords) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setVerifyWay(int32_t verifyWay) { DARABONBA_PTR_SET_VALUE(verifyWay_, verifyWay) };
    ...
    inline GetTimingSyntheticTaskResponseBodyDataMonitorConfFileDownload& setWhiteList(string whiteList) { DARABONBA_PTR_SET_VALUE(whiteList_, whiteList) };
  ...
  protected:
    ...
    // *   2: http2
    // *   3: http3
    std::shared_ptr<int64_t> quickProtocol_ = nullptr;
