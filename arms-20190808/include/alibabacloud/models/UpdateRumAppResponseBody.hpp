...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRumAppResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateRumAppResponseBodyData) };
    inline UpdateRumAppResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateRumAppResponseBodyData) };
    inline UpdateRumAppResponseBody& setData(const UpdateRumAppResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateRumAppResponseBody& setData(UpdateRumAppResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateRumAppResponseBodyData> data_ = nullptr;
