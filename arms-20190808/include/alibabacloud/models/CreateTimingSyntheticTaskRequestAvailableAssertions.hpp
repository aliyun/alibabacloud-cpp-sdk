...
#ifndef ALIBABACLOUD_MODELS_CREATETIMINGSYNTHETICTASKREQUESTAVAILABLEASSERTIONS_HPP_
#define ALIBABACLOUD_MODELS_CREATETIMINGSYNTHETICTASKREQUESTAVAILABLEASSERTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTimingSyntheticTaskRequestAvailableAssertions& obj) { 
      DARABONBA_PTR_TO_JSON(Expect, expect_);
      DARABONBA_PTR_TO_JSON(Operator, operator_);
      DARABONBA_PTR_TO_JSON(Target, target_);
      DARABONBA_PTR_TO_JSON(Type, type_);
    };
    friend void from_json(const Darabonba::Json& j, CreateTimingSyntheticTaskRequestAvailableAssertions& obj) { 
      DARABONBA_PTR_FROM_JSON(Expect, expect_);
      DARABONBA_PTR_FROM_JSON(Operator, operator_);
      DARABONBA_PTR_FROM_JSON(Target, target_);
      DARABONBA_PTR_FROM_JSON(Type, type_);
    };
    CreateTimingSyntheticTaskRequestAvailableAssertions() = default ;
    CreateTimingSyntheticTaskRequestAvailableAssertions(const CreateTimingSyntheticTaskRequestAvailableAssertions &) = default ;
    CreateTimingSyntheticTaskRequestAvailableAssertions(CreateTimingSyntheticTaskRequestAvailableAssertions &&) = default ;
    CreateTimingSyntheticTaskRequestAvailableAssertions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTimingSyntheticTaskRequestAvailableAssertions() = default ;
    CreateTimingSyntheticTaskRequestAvailableAssertions& operator=(const CreateTimingSyntheticTaskRequestAvailableAssertions &) = default ;
    CreateTimingSyntheticTaskRequestAvailableAssertions& operator=(CreateTimingSyntheticTaskRequestAvailableAssertions &&) = default ;
    ...
    inline CreateTimingSyntheticTaskRequestAvailableAssertions& setExpect(string expect) { DARABONBA_PTR_SET_VALUE(expect_, expect) };
    ...
    inline CreateTimingSyntheticTaskRequestAvailableAssertions& setOperator(string _operator) { DARABONBA_PTR_SET_VALUE(operator_, _operator) };
    ...
    inline CreateTimingSyntheticTaskRequestAvailableAssertions& setTarget(string target) { DARABONBA_PTR_SET_VALUE(target_, target) };
    ...
    inline CreateTimingSyntheticTaskRequestAvailableAssertions& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
