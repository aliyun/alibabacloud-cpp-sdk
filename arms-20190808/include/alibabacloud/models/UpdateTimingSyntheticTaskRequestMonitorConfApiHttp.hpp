...
#ifndef ALIBABACLOUD_MODELS_UPDATETIMINGSYNTHETICTASKREQUESTMONITORCONFAPIHTTP_HPP_
#define ALIBABACLOUD_MODELS_UPDATETIMINGSYNTHETICTASKREQUESTMONITORCONFAPIHTTP_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& obj) { 
    ...
    UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP() = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP(const UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP &) = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP(UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP &&) = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP() = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& operator=(const UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP &) = default ;
    UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& operator=(UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP &&) = default ;
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& setCheckCert(bool checkCert) { DARABONBA_PTR_SET_VALUE(checkCert_, checkCert) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& setConnectTimeout(int64_t connectTimeout) { DARABONBA_PTR_SET_VALUE(connectTimeout_, connectTimeout) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& setMethod(string method) { DARABONBA_PTR_SET_VALUE(method_, method) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& setProtocolAlpnProtocol(int32_t protocolAlpnProtocol) { DARABONBA_PTR_SET_VALUE(protocolAlpnProtocol_, protocolAlpnProtocol) };
    ...
    inline const Models::UpdateTimingSyntheticTaskRequestMonitorConfApiHTTPRequestBody & requestBody() const { DARABONBA_PTR_GET_CONST(requestBody_, Models::UpdateTimingSyntheticTaskRequestMonitorConfApiHTTPRequestBody) };
    inline Models::UpdateTimingSyntheticTaskRequestMonitorConfApiHTTPRequestBody requestBody() { DARABONBA_PTR_GET(requestBody_, Models::UpdateTimingSyntheticTaskRequestMonitorConfApiHTTPRequestBody) };
    inline UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& setRequestBody(const Models::UpdateTimingSyntheticTaskRequestMonitorConfApiHTTPRequestBody & requestBody) { DARABONBA_PTR_SET_VALUE(requestBody_, requestBody) };
    inline UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& setRequestBody(Models::UpdateTimingSyntheticTaskRequestMonitorConfApiHTTPRequestBody && requestBody) { DARABONBA_PTR_SET_RVALUE(requestBody_, requestBody) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& setRequestHeaders(const map<string, string> & requestHeaders) { DARABONBA_PTR_SET_VALUE(requestHeaders_, requestHeaders) };
    inline UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& setRequestHeaders(map<string, string> && requestHeaders) { DARABONBA_PTR_SET_RVALUE(requestHeaders_, requestHeaders) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& setTargetUrl(string targetUrl) { DARABONBA_PTR_SET_VALUE(targetUrl_, targetUrl) };
    ...
    inline UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP& setTimeout(int64_t timeout) { DARABONBA_PTR_SET_VALUE(timeout_, timeout) };
  ...
  protected:
    ...
    std::shared_ptr<Models::UpdateTimingSyntheticTaskRequestMonitorConfApiHTTPRequestBody> requestBody_ = nullptr;
