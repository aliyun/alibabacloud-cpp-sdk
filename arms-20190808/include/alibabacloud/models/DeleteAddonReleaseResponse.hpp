...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAddonReleaseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAddonReleaseResponseBody) };
    inline DeleteAddonReleaseResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAddonReleaseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAddonReleaseResponseBody> body_ {};
  };
