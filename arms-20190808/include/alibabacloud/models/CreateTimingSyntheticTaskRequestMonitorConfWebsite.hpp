...
#ifndef ALIBABACLOUD_MODELS_CREATETIMINGSYNTHETICTASKREQUESTMONITORCONFWEBSITE_HPP_
#define ALIBABACLOUD_MODELS_CREATETIMINGSYNTHETICTASKREQUESTMONITORCONFWEBSITE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTimingSyntheticTaskRequestMonitorConfWebsite& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTimingSyntheticTaskRequestMonitorConfWebsite& obj) { 
    ...
    CreateTimingSyntheticTaskRequestMonitorConfWebsite() = default ;
    CreateTimingSyntheticTaskRequestMonitorConfWebsite(const CreateTimingSyntheticTaskRequestMonitorConfWebsite &) = default ;
    CreateTimingSyntheticTaskRequestMonitorConfWebsite(CreateTimingSyntheticTaskRequestMonitorConfWebsite &&) = default ;
    CreateTimingSyntheticTaskRequestMonitorConfWebsite(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTimingSyntheticTaskRequestMonitorConfWebsite() = default ;
    CreateTimingSyntheticTaskRequestMonitorConfWebsite& operator=(const CreateTimingSyntheticTaskRequestMonitorConfWebsite &) = default ;
    CreateTimingSyntheticTaskRequestMonitorConfWebsite& operator=(CreateTimingSyntheticTaskRequestMonitorConfWebsite &&) = default ;
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setAutomaticScrolling(int32_t automaticScrolling) { DARABONBA_PTR_SET_VALUE(automaticScrolling_, automaticScrolling) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setCustomHeader(int32_t customHeader) { DARABONBA_PTR_SET_VALUE(customHeader_, customHeader) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setCustomHeaderContent(const map<string, string> & customHeaderContent) { DARABONBA_PTR_SET_VALUE(customHeaderContent_, customHeaderContent) };
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setCustomHeaderContent(map<string, string> && customHeaderContent) { DARABONBA_PTR_SET_RVALUE(customHeaderContent_, customHeaderContent) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setDNSHijackWhitelist(string DNSHijackWhitelist) { DARABONBA_PTR_SET_VALUE(DNSHijackWhitelist_, DNSHijackWhitelist) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setDisableCache(int32_t disableCache) { DARABONBA_PTR_SET_VALUE(disableCache_, disableCache) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setDisableCompression(int32_t disableCompression) { DARABONBA_PTR_SET_VALUE(disableCompression_, disableCompression) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setElementBlacklist(string elementBlacklist) { DARABONBA_PTR_SET_VALUE(elementBlacklist_, elementBlacklist) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setFilterInvalidIP(int32_t filterInvalidIP) { DARABONBA_PTR_SET_VALUE(filterInvalidIP_, filterInvalidIP) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setFlowHijackJumpTimes(int32_t flowHijackJumpTimes) { DARABONBA_PTR_SET_VALUE(flowHijackJumpTimes_, flowHijackJumpTimes) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setFlowHijackLogo(string flowHijackLogo) { DARABONBA_PTR_SET_VALUE(flowHijackLogo_, flowHijackLogo) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setIgnoreCertificateError(int32_t ignoreCertificateError) { DARABONBA_PTR_SET_VALUE(ignoreCertificateError_, ignoreCertificateError) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setMonitorTimeout(int64_t monitorTimeout) { DARABONBA_PTR_SET_VALUE(monitorTimeout_, monitorTimeout) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setPageTamper(string pageTamper) { DARABONBA_PTR_SET_VALUE(pageTamper_, pageTamper) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setRedirection(int32_t redirection) { DARABONBA_PTR_SET_VALUE(redirection_, redirection) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setSlowElementThreshold(int64_t slowElementThreshold) { DARABONBA_PTR_SET_VALUE(slowElementThreshold_, slowElementThreshold) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setTargetUrl(string targetUrl) { DARABONBA_PTR_SET_VALUE(targetUrl_, targetUrl) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setVerifyStringBlacklist(string verifyStringBlacklist) { DARABONBA_PTR_SET_VALUE(verifyStringBlacklist_, verifyStringBlacklist) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setVerifyStringWhitelist(string verifyStringWhitelist) { DARABONBA_PTR_SET_VALUE(verifyStringWhitelist_, verifyStringWhitelist) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfWebsite& setWaitCompletionTime(int64_t waitCompletionTime) { DARABONBA_PTR_SET_VALUE(waitCompletionTime_, waitCompletionTime) };
