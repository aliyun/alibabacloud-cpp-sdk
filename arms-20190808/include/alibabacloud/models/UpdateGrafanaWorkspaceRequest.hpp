...
#ifndef ALIBABACLOUD_MODELS_UPDATEGRAFANAWORKSPACEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEGRAFANAWORKSPACEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateGrafanaWorkspaceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateGrafanaWorkspaceRequest& obj) { 
    ...
    UpdateGrafanaWorkspaceRequest() = default ;
    UpdateGrafanaWorkspaceRequest(const UpdateGrafanaWorkspaceRequest &) = default ;
    UpdateGrafanaWorkspaceRequest(UpdateGrafanaWorkspaceRequest &&) = default ;
    UpdateGrafanaWorkspaceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateGrafanaWorkspaceRequest() = default ;
    UpdateGrafanaWorkspaceRequest& operator=(const UpdateGrafanaWorkspaceRequest &) = default ;
    UpdateGrafanaWorkspaceRequest& operator=(UpdateGrafanaWorkspaceRequest &&) = default ;
