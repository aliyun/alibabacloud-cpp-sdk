...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnvPodMonitorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEnvPodMonitorResponseBody) };
    inline DescribeEnvPodMonitorResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEnvPodMonitorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEnvPodMonitorResponseBody> body_ {};
  };
