...
namespace Models
{
  ...
  public:
    ...
    inline const ListAddonReleasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAddonReleasesResponseBody) };
    inline ListAddonReleasesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAddonReleasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAddonReleasesResponseBody> body_ {};
  };
