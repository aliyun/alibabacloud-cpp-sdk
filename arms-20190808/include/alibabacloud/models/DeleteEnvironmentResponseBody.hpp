...
namespace Models
{
  ...
  public:
    ...
    inline DeleteEnvironmentResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeleteEnvironmentResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
