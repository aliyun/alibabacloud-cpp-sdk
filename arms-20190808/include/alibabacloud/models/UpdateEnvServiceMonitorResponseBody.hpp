...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEnvServiceMonitorResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateEnvServiceMonitorResponseBodyData) };
    inline UpdateEnvServiceMonitorResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateEnvServiceMonitorResponseBodyData) };
    inline UpdateEnvServiceMonitorResponseBody& setData(const UpdateEnvServiceMonitorResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateEnvServiceMonitorResponseBody& setData(UpdateEnvServiceMonitorResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<UpdateEnvServiceMonitorResponseBodyData> data_ = nullptr;
