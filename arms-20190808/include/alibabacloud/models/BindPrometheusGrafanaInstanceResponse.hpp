...
namespace Models
{
  ...
  public:
    ...
    inline const BindPrometheusGrafanaInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindPrometheusGrafanaInstanceResponseBody) };
    inline BindPrometheusGrafanaInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, BindPrometheusGrafanaInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindPrometheusGrafanaInstanceResponseBody> body_ {};
  };
