...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        virtual bool empty() const override { return this->dig_ == nullptr
        ...
        inline int32_t getDig() const { DARABONBA_PTR_GET_DEFAULT(dig_, 0) };
        inline NetDNS& setDig(int32_t dig) { DARABONBA_PTR_SET_VALUE(dig_, dig) };
    ...
    inline const vector<UpdateTimingSyntheticTaskRequest::AvailableAssertions> & getAvailableAssertions() const { DARABONBA_PTR_GET_CONST(availableAssertions_, vector<UpdateTimingSyntheticTaskRequest::AvailableAssertions>) };
    inline vector<UpdateTimingSyntheticTaskRequest::AvailableAssertions> getAvailableAssertions() { DARABONBA_PTR_GET(availableAssertions_, vector<UpdateTimingSyntheticTaskRequest::AvailableAssertions>) };
    inline UpdateTimingSyntheticTaskRequest& setAvailableAssertions(const vector<UpdateTimingSyntheticTaskRequest::AvailableAssertions> & availableAssertions) { DARABONBA_PTR_SET_VALUE(availableAssertions_, availableAssertions) };
    inline UpdateTimingSyntheticTaskRequest& setAvailableAssertions(vector<UpdateTimingSyntheticTaskRequest::AvailableAssertions> && availableAssertions) { DARABONBA_PTR_SET_RVALUE(availableAssertions_, availableAssertions) };
    ...
    inline const UpdateTimingSyntheticTaskRequest::CommonSetting & getCommonSetting() const { DARABONBA_PTR_GET_CONST(commonSetting_, UpdateTimingSyntheticTaskRequest::CommonSetting) };
    inline UpdateTimingSyntheticTaskRequest::CommonSetting getCommonSetting() { DARABONBA_PTR_GET(commonSetting_, UpdateTimingSyntheticTaskRequest::CommonSetting) };
    inline UpdateTimingSyntheticTaskRequest& setCommonSetting(const UpdateTimingSyntheticTaskRequest::CommonSetting & commonSetting) { DARABONBA_PTR_SET_VALUE(commonSetting_, commonSetting) };
    inline UpdateTimingSyntheticTaskRequest& setCommonSetting(UpdateTimingSyntheticTaskRequest::CommonSetting && commonSetting) { DARABONBA_PTR_SET_RVALUE(commonSetting_, commonSetting) };
    ...
    inline const UpdateTimingSyntheticTaskRequest::CustomPeriod & getCustomPeriod() const { DARABONBA_PTR_GET_CONST(customPeriod_, UpdateTimingSyntheticTaskRequest::CustomPeriod) };
    inline UpdateTimingSyntheticTaskRequest::CustomPeriod getCustomPeriod() { DARABONBA_PTR_GET(customPeriod_, UpdateTimingSyntheticTaskRequest::CustomPeriod) };
    inline UpdateTimingSyntheticTaskRequest& setCustomPeriod(const UpdateTimingSyntheticTaskRequest::CustomPeriod & customPeriod) { DARABONBA_PTR_SET_VALUE(customPeriod_, customPeriod) };
    inline UpdateTimingSyntheticTaskRequest& setCustomPeriod(UpdateTimingSyntheticTaskRequest::CustomPeriod && customPeriod) { DARABONBA_PTR_SET_RVALUE(customPeriod_, customPeriod) };
    ...
    inline const UpdateTimingSyntheticTaskRequest::MonitorConf & getMonitorConf() const { DARABONBA_PTR_GET_CONST(monitorConf_, UpdateTimingSyntheticTaskRequest::MonitorConf) };
    inline UpdateTimingSyntheticTaskRequest::MonitorConf getMonitorConf() { DARABONBA_PTR_GET(monitorConf_, UpdateTimingSyntheticTaskRequest::MonitorConf) };
    inline UpdateTimingSyntheticTaskRequest& setMonitorConf(const UpdateTimingSyntheticTaskRequest::MonitorConf & monitorConf) { DARABONBA_PTR_SET_VALUE(monitorConf_, monitorConf) };
    inline UpdateTimingSyntheticTaskRequest& setMonitorConf(UpdateTimingSyntheticTaskRequest::MonitorConf && monitorConf) { DARABONBA_PTR_SET_RVALUE(monitorConf_, monitorConf) };


    // monitors Field Functions 
    bool hasMonitors() const { return this->monitors_ != nullptr;};
    void deleteMonitors() { this->monitors_ = nullptr;};
    inline const vector<UpdateTimingSyntheticTaskRequest::Monitors> & getMonitors() const { DARABONBA_PTR_GET_CONST(monitors_, vector<UpdateTimingSyntheticTaskRequest::Monitors>) };
    inline vector<UpdateTimingSyntheticTaskRequest::Monitors> getMonitors() { DARABONBA_PTR_GET(monitors_, vector<UpdateTimingSyntheticTaskRequest::Monitors>) };
    inline UpdateTimingSyntheticTaskRequest& setMonitors(const vector<UpdateTimingSyntheticTaskRequest::Monitors> & monitors) { DARABONBA_PTR_SET_VALUE(monitors_, monitors) };
    inline UpdateTimingSyntheticTaskRequest& setMonitors(vector<UpdateTimingSyntheticTaskRequest::Monitors> && monitors) { DARABONBA_PTR_SET_RVALUE(monitors_, monitors) };
    ...
    inline const vector<UpdateTimingSyntheticTaskRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<UpdateTimingSyntheticTaskRequest::Tags>) };
    inline vector<UpdateTimingSyntheticTaskRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<UpdateTimingSyntheticTaskRequest::Tags>) };
    inline UpdateTimingSyntheticTaskRequest& setTags(const vector<UpdateTimingSyntheticTaskRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline UpdateTimingSyntheticTaskRequest& setTags(vector<UpdateTimingSyntheticTaskRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateTimingSyntheticTaskRequest::AvailableAssertions>> availableAssertions_ {};
    // The general settings.
    shared_ptr<UpdateTimingSyntheticTaskRequest::CommonSetting> commonSetting_ {};
    // The custom cycle.
    shared_ptr<UpdateTimingSyntheticTaskRequest::CustomPeriod> customPeriod_ {};
    // The detection frequency. Valid values: 1m, 5m, 10m, 15m, 20m, 30m, 1h, 2h, 3h, 4h, 6h, 8h, 12h, and 24h.
    shared_ptr<string> frequency_ {};
    // The monitoring configurations.
    shared_ptr<UpdateTimingSyntheticTaskRequest::MonitorConf> monitorConf_ {};
    // The list of monitoring points.
    shared_ptr<vector<UpdateTimingSyntheticTaskRequest::Monitors>> monitors_ {};
    ...
    // The list of tags.
    shared_ptr<vector<UpdateTimingSyntheticTaskRequest::Tags>> tags_ {};
