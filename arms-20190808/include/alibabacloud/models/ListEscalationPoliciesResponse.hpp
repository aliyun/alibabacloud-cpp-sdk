...
namespace Models
{
  ...
  public:
    ...
    inline const ListEscalationPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListEscalationPoliciesResponseBody) };
    inline ListEscalationPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListEscalationPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListEscalationPoliciesResponseBody> body_ {};
  };
