...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetSyntheticTaskMonitorsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetSyntheticTaskMonitorsResponseBodyData>) };
    inline vector<GetSyntheticTaskMonitorsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetSyntheticTaskMonitorsResponseBodyData>) };
    inline GetSyntheticTaskMonitorsResponseBody& setData(const vector<GetSyntheticTaskMonitorsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSyntheticTaskMonitorsResponseBody& setData(vector<GetSyntheticTaskMonitorsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetSyntheticTaskMonitorsResponseBodyData>> data_ = nullptr;
