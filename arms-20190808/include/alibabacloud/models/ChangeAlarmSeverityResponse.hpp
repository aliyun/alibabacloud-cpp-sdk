...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeAlarmSeverityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChangeAlarmSeverityResponseBody) };
    inline ChangeAlarmSeverityResponseBody getBody() { DARABONBA_PTR_GET(body_, ChangeAlarmSeverityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ChangeAlarmSeverityResponseBody> body_ {};
  };
