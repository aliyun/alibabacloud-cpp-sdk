...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alertRuleId_ == nullptr
    ...
    inline string getAlertRuleId() const { DARABONBA_PTR_GET_DEFAULT(alertRuleId_, "") };
    ...
    inline string getSystemRegionId() const { DARABONBA_PTR_GET_DEFAULT(systemRegionId_, "") };
    ...
    inline const vector<SearchAlertRulesRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<SearchAlertRulesRequest::Tags>) };
    inline vector<SearchAlertRulesRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<SearchAlertRulesRequest::Tags>) };
    inline SearchAlertRulesRequest& setTags(const vector<SearchAlertRulesRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline SearchAlertRulesRequest& setTags(vector<SearchAlertRulesRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    // The id of AlertRule.
    shared_ptr<string> alertRuleId_ {};
    ...
    shared_ptr<string> systemRegionId_ {};
    // The list of tags.
    shared_ptr<vector<SearchAlertRulesRequest::Tags>> tags_ {};
    // The alert rule name.
