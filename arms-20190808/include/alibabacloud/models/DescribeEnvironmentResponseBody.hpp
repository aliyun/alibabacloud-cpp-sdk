...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnvironmentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEnvironmentResponseBodyData) };
    inline DescribeEnvironmentResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEnvironmentResponseBodyData) };
    inline DescribeEnvironmentResponseBody& setData(const DescribeEnvironmentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEnvironmentResponseBody& setData(DescribeEnvironmentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned struct.
    std::shared_ptr<DescribeEnvironmentResponseBodyData> data_ = nullptr;
