...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnvDropMetricsRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEnvDropMetricsRuleResponseBodyData) };
    inline DescribeEnvDropMetricsRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEnvDropMetricsRuleResponseBodyData) };
    inline DescribeEnvDropMetricsRuleResponseBody& setData(const DescribeEnvDropMetricsRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEnvDropMetricsRuleResponseBody& setData(DescribeEnvDropMetricsRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEnvDropMetricsRuleResponseBodyData> data_ = nullptr;
