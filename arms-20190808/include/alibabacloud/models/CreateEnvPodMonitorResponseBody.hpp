...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEnvPodMonitorResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateEnvPodMonitorResponseBody::Data) };
    inline CreateEnvPodMonitorResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateEnvPodMonitorResponseBody::Data) };
    inline CreateEnvPodMonitorResponseBody& setData(const CreateEnvPodMonitorResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateEnvPodMonitorResponseBody& setData(CreateEnvPodMonitorResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<CreateEnvPodMonitorResponseBody::Data> data_ {};
