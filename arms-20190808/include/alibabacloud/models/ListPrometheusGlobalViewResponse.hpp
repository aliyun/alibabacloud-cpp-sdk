...
namespace Models
{
  ...
  public:
    ...
    inline const ListPrometheusGlobalViewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPrometheusGlobalViewResponseBody) };
    inline ListPrometheusGlobalViewResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPrometheusGlobalViewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPrometheusGlobalViewResponseBody> body_ {};
  };
