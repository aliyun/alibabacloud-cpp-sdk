  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline GroupRules& setRepeatInterval(int64_t repeatInterval) { DARABONBA_PTR_SET_VALUE(repeatInterval_, repeatInterval) };
      ...
      virtual bool empty() const override { return this->dispatchType_ == nullptr
      ...
      inline string getDispatchType() const { DARABONBA_PTR_GET_DEFAULT(dispatchType_, "") };
      inline DispatchRule& setDispatchType(string dispatchType) { DARABONBA_PTR_SET_VALUE(dispatchType_, dispatchType) };
      ...
      inline bool getIsRecover() const { DARABONBA_PTR_GET_DEFAULT(isRecover_, false) };
      inline DispatchRule& setIsRecover(bool isRecover) { DARABONBA_PTR_SET_VALUE(isRecover_, isRecover) };
