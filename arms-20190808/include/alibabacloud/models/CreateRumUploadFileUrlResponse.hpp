...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRumUploadFileUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRumUploadFileUrlResponseBody) };
    inline CreateRumUploadFileUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRumUploadFileUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRumUploadFileUrlResponseBody> body_ {};
  };
