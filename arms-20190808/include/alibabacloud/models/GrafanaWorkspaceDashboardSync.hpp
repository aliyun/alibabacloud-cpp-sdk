...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dashboardTitle_ == nullptr
    ...
    inline string getDashboardTitle() const { DARABONBA_PTR_GET_DEFAULT(dashboardTitle_, "") };
    ...
    inline string getDashboardUid() const { DARABONBA_PTR_GET_DEFAULT(dashboardUid_, "") };
    ...
    inline string getFolderTitle() const { DARABONBA_PTR_GET_DEFAULT(folderTitle_, "") };
  ...
  protected:
    shared_ptr<string> dashboardTitle_ {};
    shared_ptr<string> dashboardURL_ {};
    shared_ptr<string> dashboardUid_ {};
    shared_ptr<string> folderId_ {};
    shared_ptr<string> folderTitle_ {};
