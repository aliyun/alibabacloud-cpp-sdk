...
namespace Models
{
  ...
  public:
    ...
    inline const GetPrometheusInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPrometheusInstanceResponseBodyData) };
    inline GetPrometheusInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPrometheusInstanceResponseBodyData) };
    inline GetPrometheusInstanceResponseBody& setData(const GetPrometheusInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPrometheusInstanceResponseBody& setData(GetPrometheusInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetPrometheusInstanceResponseBodyData> data_ = nullptr;
