...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->batchItems_ == nullptr
    ...
    inline string getBatchItems() const { DARABONBA_PTR_GET_DEFAULT(batchItems_, "") };
