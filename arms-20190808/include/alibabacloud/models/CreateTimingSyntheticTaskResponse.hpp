...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTimingSyntheticTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTimingSyntheticTaskResponseBody) };
    inline CreateTimingSyntheticTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTimingSyntheticTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTimingSyntheticTaskResponseBody> body_ {};
  };
