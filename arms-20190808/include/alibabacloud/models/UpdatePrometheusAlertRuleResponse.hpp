...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePrometheusAlertRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePrometheusAlertRuleResponseBody) };
    inline UpdatePrometheusAlertRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePrometheusAlertRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePrometheusAlertRuleResponseBody> body_ {};
  };
