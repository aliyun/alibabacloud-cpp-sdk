...
namespace Models
{
  ...
  public:
    ...
    inline const GetRumExceptionStackResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRumExceptionStackResponseBodyData) };
    inline GetRumExceptionStackResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRumExceptionStackResponseBodyData) };
    inline GetRumExceptionStackResponseBody& setData(const GetRumExceptionStackResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRumExceptionStackResponseBody& setData(GetRumExceptionStackResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetRumExceptionStackResponseBodyData> data_ = nullptr;
