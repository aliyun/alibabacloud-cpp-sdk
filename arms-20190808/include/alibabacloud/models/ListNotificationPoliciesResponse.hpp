...
namespace Models
{
  ...
  public:
    ...
    inline const ListNotificationPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNotificationPoliciesResponseBody) };
    inline ListNotificationPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNotificationPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNotificationPoliciesResponseBody> body_ {};
  };
