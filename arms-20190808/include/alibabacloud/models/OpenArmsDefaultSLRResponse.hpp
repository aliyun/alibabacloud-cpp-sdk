...
namespace Models
{
  ...
  public:
    ...
    inline const OpenArmsDefaultSLRResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenArmsDefaultSLRResponseBody) };
    inline OpenArmsDefaultSLRResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenArmsDefaultSLRResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenArmsDefaultSLRResponseBody> body_ {};
  };
