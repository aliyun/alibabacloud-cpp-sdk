...
#ifndef ALIBABACLOUD_MODELS_UPDATEPROMETHEUSINTEGRATIONREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPROMETHEUSINTEGRATIONREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdatePrometheusIntegrationRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdatePrometheusIntegrationRequest& obj) { 
    ...
    UpdatePrometheusIntegrationRequest() = default ;
    UpdatePrometheusIntegrationRequest(const UpdatePrometheusIntegrationRequest &) = default ;
    UpdatePrometheusIntegrationRequest(UpdatePrometheusIntegrationRequest &&) = default ;
    UpdatePrometheusIntegrationRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdatePrometheusIntegrationRequest() = default ;
    UpdatePrometheusIntegrationRequest& operator=(const UpdatePrometheusIntegrationRequest &) = default ;
    UpdatePrometheusIntegrationRequest& operator=(UpdatePrometheusIntegrationRequest &&) = default ;
