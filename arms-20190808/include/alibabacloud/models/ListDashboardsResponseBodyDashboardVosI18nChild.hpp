...
#ifndef ALIBABACLOUD_MODELS_LISTDASHBOARDSRESPONSEBODYDASHBOARDVOSI18NCHILD_HPP_
#define ALIBABACLOUD_MODELS_LISTDASHBOARDSRESPONSEBODYDASHBOARDVOSI18NCHILD_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDashboardsResponseBodyDashboardVosI18nChild& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDashboardsResponseBodyDashboardVosI18nChild& obj) { 
    ...
    ListDashboardsResponseBodyDashboardVosI18nChild() = default ;
    ListDashboardsResponseBodyDashboardVosI18nChild(const ListDashboardsResponseBodyDashboardVosI18nChild &) = default ;
    ListDashboardsResponseBodyDashboardVosI18nChild(ListDashboardsResponseBodyDashboardVosI18nChild &&) = default ;
    ListDashboardsResponseBodyDashboardVosI18nChild(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDashboardsResponseBodyDashboardVosI18nChild() = default ;
    ListDashboardsResponseBodyDashboardVosI18nChild& operator=(const ListDashboardsResponseBodyDashboardVosI18nChild &) = default ;
    ListDashboardsResponseBodyDashboardVosI18nChild& operator=(ListDashboardsResponseBodyDashboardVosI18nChild &&) = default ;
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setDashboardType(string dashboardType) { DARABONBA_PTR_SET_VALUE(dashboardType_, dashboardType) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setExporter(string exporter) { DARABONBA_PTR_SET_VALUE(exporter_, exporter) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setHttpUrl(string httpUrl) { DARABONBA_PTR_SET_VALUE(httpUrl_, httpUrl) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setHttpsUrl(string httpsUrl) { DARABONBA_PTR_SET_VALUE(httpsUrl_, httpsUrl) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setIsArmsExporter(bool isArmsExporter) { DARABONBA_PTR_SET_VALUE(isArmsExporter_, isArmsExporter) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setKind(string kind) { DARABONBA_PTR_SET_VALUE(kind_, kind) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setLanguage(string language) { DARABONBA_PTR_SET_VALUE(language_, language) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setNeedUpdate(bool needUpdate) { DARABONBA_PTR_SET_VALUE(needUpdate_, needUpdate) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setTags(const vector<string> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setTags(vector<string> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setTime(string time) { DARABONBA_PTR_SET_VALUE(time_, time) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setUid(string uid) { DARABONBA_PTR_SET_VALUE(uid_, uid) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline ListDashboardsResponseBodyDashboardVosI18nChild& setVersion(string version) { DARABONBA_PTR_SET_VALUE(version_, version) };
