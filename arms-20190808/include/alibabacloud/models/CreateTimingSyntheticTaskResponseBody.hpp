...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTimingSyntheticTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateTimingSyntheticTaskResponseBodyData) };
    inline CreateTimingSyntheticTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateTimingSyntheticTaskResponseBodyData) };
    inline CreateTimingSyntheticTaskResponseBody& setData(const CreateTimingSyntheticTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateTimingSyntheticTaskResponseBody& setData(CreateTimingSyntheticTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The struct returned.
    std::shared_ptr<CreateTimingSyntheticTaskResponseBodyData> data_ = nullptr;
