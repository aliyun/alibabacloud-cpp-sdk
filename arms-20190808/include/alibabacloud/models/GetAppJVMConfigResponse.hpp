...
namespace Models
{
  ...
  public:
    ...
    inline const GetAppJVMConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAppJVMConfigResponseBody) };
    inline GetAppJVMConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAppJVMConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAppJVMConfigResponseBody> body_ {};
  };
