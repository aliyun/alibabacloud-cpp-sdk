...
#ifndef ALIBABACLOUD_MODELS_LISTENVPODMONITORSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTENVPODMONITORSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListEnvPodMonitorsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListEnvPodMonitorsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListEnvPodMonitorsResponseBody() = default ;
    ListEnvPodMonitorsResponseBody(const ListEnvPodMonitorsResponseBody &) = default ;
    ListEnvPodMonitorsResponseBody(ListEnvPodMonitorsResponseBody &&) = default ;
    ListEnvPodMonitorsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListEnvPodMonitorsResponseBody() = default ;
    ListEnvPodMonitorsResponseBody& operator=(const ListEnvPodMonitorsResponseBody &) = default ;
    ListEnvPodMonitorsResponseBody& operator=(ListEnvPodMonitorsResponseBody &&) = default ;
    ...
    inline ListEnvPodMonitorsResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListEnvPodMonitorsResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListEnvPodMonitorsResponseBody::Data>) };
    inline vector<ListEnvPodMonitorsResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListEnvPodMonitorsResponseBody::Data>) };
    inline ListEnvPodMonitorsResponseBody& setData(const vector<ListEnvPodMonitorsResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEnvPodMonitorsResponseBody& setData(vector<ListEnvPodMonitorsResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListEnvPodMonitorsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListEnvPodMonitorsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
  ...
  protected:
    ...
    shared_ptr<vector<ListEnvPodMonitorsResponseBody::Data>> data_ {};
