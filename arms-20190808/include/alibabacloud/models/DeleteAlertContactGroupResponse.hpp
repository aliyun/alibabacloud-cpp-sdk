...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAlertContactGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteAlertContactGroupResponseBody) };
    inline DeleteAlertContactGroupResponseBody body() { DARABONBA_PTR_GET(body_, DeleteAlertContactGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteAlertContactGroupResponseBody> body_ = nullptr;
  };
