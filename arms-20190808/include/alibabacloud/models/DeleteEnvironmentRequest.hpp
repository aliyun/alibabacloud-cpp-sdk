...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deletePromInstance_ == nullptr
    ...
    inline bool getDeletePromInstance() const { DARABONBA_PTR_GET_DEFAULT(deletePromInstance_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> deletePromInstance_ {};
