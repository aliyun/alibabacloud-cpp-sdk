...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAddonMetricsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAddonMetricsResponseBody) };
    inline DescribeAddonMetricsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAddonMetricsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAddonMetricsResponseBody> body_ {};
  };
