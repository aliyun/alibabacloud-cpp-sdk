...
namespace Models
{
  ...
  public:
    ...
    inline const ListTimingSyntheticTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTimingSyntheticTasksResponseBody) };
    inline ListTimingSyntheticTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTimingSyntheticTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTimingSyntheticTasksResponseBody> body_ {};
  };
