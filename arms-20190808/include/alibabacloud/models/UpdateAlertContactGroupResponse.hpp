...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAlertContactGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateAlertContactGroupResponseBody) };
    inline UpdateAlertContactGroupResponseBody body() { DARABONBA_PTR_GET(body_, UpdateAlertContactGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateAlertContactGroupResponseBody> body_ = nullptr;
  };
