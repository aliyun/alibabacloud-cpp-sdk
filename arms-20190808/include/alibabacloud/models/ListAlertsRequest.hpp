...
namespace Models
{
  ...
  public:
    ...
    inline bool getShowActivities() const { DARABONBA_PTR_GET_DEFAULT(showActivities_, false) };
    ...
    inline bool getShowEvents() const { DARABONBA_PTR_GET_DEFAULT(showEvents_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> showActivities_ {};
