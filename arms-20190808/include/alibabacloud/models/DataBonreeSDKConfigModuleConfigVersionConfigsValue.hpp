...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->useCustom_ == nullptr
    ...
    inline bool getUseCustom() const { DARABONBA_PTR_GET_DEFAULT(useCustom_, false) };
    ...
    inline const map<string, DataBonreeSDKConfigModuleConfigVersionConfigsValueCustomConfigValue> & getCustomConfig() const { DARABONBA_PTR_GET_CONST(customConfig_, map<string, DataBonreeSDKConfigModuleConfigVersionConfigsValueCustomConfigValue>) };
    inline map<string, DataBonreeSDKConfigModuleConfigVersionConfigsValueCustomConfigValue> getCustomConfig() { DARABONBA_PTR_GET(customConfig_, map<string, DataBonreeSDKConfigModuleConfigVersionConfigsValueCustomConfigValue>) };
