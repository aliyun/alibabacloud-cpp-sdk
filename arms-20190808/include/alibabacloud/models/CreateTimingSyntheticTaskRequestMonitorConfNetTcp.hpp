...
#ifndef ALIBABACLOUD_MODELS_CREATETIMINGSYNTHETICTASKREQUESTMONITORCONFNETTCP_HPP_
#define ALIBABACLOUD_MODELS_CREATETIMINGSYNTHETICTASKREQUESTMONITORCONFNETTCP_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTimingSyntheticTaskRequestMonitorConfNetTCP& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTimingSyntheticTaskRequestMonitorConfNetTCP& obj) { 
    ...
    CreateTimingSyntheticTaskRequestMonitorConfNetTCP() = default ;
    CreateTimingSyntheticTaskRequestMonitorConfNetTCP(const CreateTimingSyntheticTaskRequestMonitorConfNetTCP &) = default ;
    CreateTimingSyntheticTaskRequestMonitorConfNetTCP(CreateTimingSyntheticTaskRequestMonitorConfNetTCP &&) = default ;
    CreateTimingSyntheticTaskRequestMonitorConfNetTCP(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTimingSyntheticTaskRequestMonitorConfNetTCP() = default ;
    CreateTimingSyntheticTaskRequestMonitorConfNetTCP& operator=(const CreateTimingSyntheticTaskRequestMonitorConfNetTCP &) = default ;
    CreateTimingSyntheticTaskRequestMonitorConfNetTCP& operator=(CreateTimingSyntheticTaskRequestMonitorConfNetTCP &&) = default ;
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfNetTCP& setConnectTimes(int32_t connectTimes) { DARABONBA_PTR_SET_VALUE(connectTimes_, connectTimes) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfNetTCP& setInterval(int64_t interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfNetTCP& setTargetUrl(string targetUrl) { DARABONBA_PTR_SET_VALUE(targetUrl_, targetUrl) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfNetTCP& setTimeout(int64_t timeout) { DARABONBA_PTR_SET_VALUE(timeout_, timeout) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfNetTCP& setTracertEnable(bool tracertEnable) { DARABONBA_PTR_SET_VALUE(tracertEnable_, tracertEnable) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfNetTCP& setTracertNumMax(int32_t tracertNumMax) { DARABONBA_PTR_SET_VALUE(tracertNumMax_, tracertNumMax) };
    ...
    inline CreateTimingSyntheticTaskRequestMonitorConfNetTCP& setTracertTimeout(int64_t tracertTimeout) { DARABONBA_PTR_SET_VALUE(tracertTimeout_, tracertTimeout) };
