...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeEnvironmentFeatureResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeEnvironmentFeatureResponseBody) };
    inline UpgradeEnvironmentFeatureResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeEnvironmentFeatureResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeEnvironmentFeatureResponseBody> body_ {};
  };
