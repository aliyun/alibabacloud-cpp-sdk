...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIntegrationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteIntegrationResponseBody) };
    inline DeleteIntegrationResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteIntegrationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteIntegrationResponseBody> body_ {};
  };
