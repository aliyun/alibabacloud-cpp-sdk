...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSyntheticTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSyntheticTaskResponseBody) };
    inline CreateSyntheticTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSyntheticTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSyntheticTaskResponseBody> body_ {};
  };
