...
namespace Models
{
  ...
  public:
    ...
    inline const QueryConferenceMembersHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryConferenceMembersHeaders::AccountContext) };
    inline QueryConferenceMembersHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryConferenceMembersHeaders::AccountContext) };
    inline QueryConferenceMembersHeaders& setAccountContext(const QueryConferenceMembersHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryConferenceMembersHeaders& setAccountContext(QueryConferenceMembersHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryConferenceMembersHeaders::AccountContext> accountContext_ {};
  };
