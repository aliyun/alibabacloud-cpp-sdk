...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appType_ == nullptr
        && this->errorLinesShrink_ == nullptr && this->importSequence_ == nullptr && this->language_ == nullptr && this->status_ == nullptr && this->systemToken_ == nullptr; };
    ...
    inline string getErrorLinesShrink() const { DARABONBA_PTR_GET_DEFAULT(errorLinesShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> errorLinesShrink_ {};
