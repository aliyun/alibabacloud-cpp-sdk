...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLiveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLiveResponseBody) };
    inline UpdateLiveResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLiveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLiveResponseBody> body_ {};
  };
