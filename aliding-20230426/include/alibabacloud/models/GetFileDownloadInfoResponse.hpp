...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileDownloadInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetFileDownloadInfoResponseBody) };
    inline GetFileDownloadInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetFileDownloadInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetFileDownloadInfoResponseBody> body_ {};
  };
