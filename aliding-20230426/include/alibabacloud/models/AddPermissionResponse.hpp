...
namespace Models
{
  ...
  public:
    ...
    inline const AddPermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddPermissionResponseBody) };
    inline AddPermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, AddPermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddPermissionResponseBody> body_ {};
  };
