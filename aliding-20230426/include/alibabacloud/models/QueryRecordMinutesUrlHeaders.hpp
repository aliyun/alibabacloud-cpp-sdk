...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRecordMinutesUrlHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryRecordMinutesUrlHeaders::AccountContext) };
    inline QueryRecordMinutesUrlHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryRecordMinutesUrlHeaders::AccountContext) };
    inline QueryRecordMinutesUrlHeaders& setAccountContext(const QueryRecordMinutesUrlHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryRecordMinutesUrlHeaders& setAccountContext(QueryRecordMinutesUrlHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryRecordMinutesUrlHeaders::AccountContext> accountContext_ {};
  };
