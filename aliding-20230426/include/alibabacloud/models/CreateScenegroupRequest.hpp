...
namespace Models
{
  ...
  public:
    ...
    inline int64_t addFriendForbidden() const { DARABONBA_PTR_GET_DEFAULT(addFriendForbidden_, 0L) };
    ...
    inline int64_t allMembersCanCreateCalendar() const { DARABONBA_PTR_GET_DEFAULT(allMembersCanCreateCalendar_, 0L) };
    ...
    inline int64_t allMembersCanCreateMcsConf() const { DARABONBA_PTR_GET_DEFAULT(allMembersCanCreateMcsConf_, 0L) };
    ...
    inline int64_t chatBannedType() const { DARABONBA_PTR_GET_DEFAULT(chatBannedType_, 0L) };
    ...
    inline int64_t groupEmailDisabled() const { DARABONBA_PTR_GET_DEFAULT(groupEmailDisabled_, 0L) };
    ...
    inline int64_t groupLiveSwitch() const { DARABONBA_PTR_GET_DEFAULT(groupLiveSwitch_, 0L) };
    ...
    inline int64_t managementType() const { DARABONBA_PTR_GET_DEFAULT(managementType_, 0L) };
    ...
    inline int64_t membersToAdminChat() const { DARABONBA_PTR_GET_DEFAULT(membersToAdminChat_, 0L) };
    ...
    inline int64_t mentionAllAuthority() const { DARABONBA_PTR_GET_DEFAULT(mentionAllAuthority_, 0L) };
    ...
    inline int64_t onlyAdminCanDing() const { DARABONBA_PTR_GET_DEFAULT(onlyAdminCanDing_, 0L) };
    ...
    inline int64_t onlyAdminCanSetMsgTop() const { DARABONBA_PTR_GET_DEFAULT(onlyAdminCanSetMsgTop_, 0L) };
    ...
    inline int64_t searchable() const { DARABONBA_PTR_GET_DEFAULT(searchable_, 0L) };
    ...
    inline int64_t showHistoryType() const { DARABONBA_PTR_GET_DEFAULT(showHistoryType_, 0L) };
    ...
    inline string subadminIds() const { DARABONBA_PTR_GET_DEFAULT(subadminIds_, "") };
    ...
    inline int64_t validationType() const { DARABONBA_PTR_GET_DEFAULT(validationType_, 0L) };
  ...
  protected:
    std::shared_ptr<int64_t> addFriendForbidden_ = nullptr;
    std::shared_ptr<int64_t> allMembersCanCreateCalendar_ = nullptr;
    std::shared_ptr<int64_t> allMembersCanCreateMcsConf_ = nullptr;
    std::shared_ptr<int64_t> chatBannedType_ = nullptr;
    std::shared_ptr<int64_t> groupEmailDisabled_ = nullptr;
    std::shared_ptr<int64_t> groupLiveSwitch_ = nullptr;
    std::shared_ptr<string> icon_ = nullptr;
    std::shared_ptr<int64_t> managementType_ = nullptr;
    std::shared_ptr<int64_t> membersToAdminChat_ = nullptr;
    std::shared_ptr<int64_t> mentionAllAuthority_ = nullptr;
    std::shared_ptr<int64_t> onlyAdminCanDing_ = nullptr;
    std::shared_ptr<int64_t> onlyAdminCanSetMsgTop_ = nullptr;
    std::shared_ptr<int64_t> searchable_ = nullptr;
    std::shared_ptr<int64_t> showHistoryType_ = nullptr;
    std::shared_ptr<string> subadminIds_ = nullptr;
    ...
    std::shared_ptr<int64_t> validationType_ = nullptr;
  };
