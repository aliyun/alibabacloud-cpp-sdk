...
namespace Models
{
  ...
  public:
    ...
    inline StartInstanceResponseBody& setResult(string result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    ...
    inline StartInstanceResponseBody& setVendorRequestId(string vendorRequestId) { DARABONBA_PTR_SET_VALUE(vendorRequestId_, vendorRequestId) };
    ...
    inline StartInstanceResponseBody& setVendorType(string vendorType) { DARABONBA_PTR_SET_VALUE(vendorType_, vendorType) };
