...
namespace Models
{
  ...
  public:
    ...
    inline const SaveContentHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, SaveContentHeaders::AccountContext) };
    inline SaveContentHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, SaveContentHeaders::AccountContext) };
    inline SaveContentHeaders& setAccountContext(const SaveContentHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline SaveContentHeaders& setAccountContext(SaveContentHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<SaveContentHeaders::AccountContext> accountContext_ {};
  };
