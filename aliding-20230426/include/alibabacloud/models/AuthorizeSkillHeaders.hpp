...
namespace Models
{
  ...
  public:
    ...
    inline const AuthorizeSkillHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, AuthorizeSkillHeaders::AccountContext) };
    inline AuthorizeSkillHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, AuthorizeSkillHeaders::AccountContext) };
    inline AuthorizeSkillHeaders& setAccountContext(const AuthorizeSkillHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline AuthorizeSkillHeaders& setAccountContext(AuthorizeSkillHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<AuthorizeSkillHeaders::AccountContext> accountContext_ {};
  };
