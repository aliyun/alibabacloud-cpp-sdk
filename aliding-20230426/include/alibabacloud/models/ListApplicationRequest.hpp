...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appFilter_ == nullptr
        && this->appNameSearchKeyword_ == nullptr && this->corpId_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->token_ == nullptr; };
    ...
    inline string getAppFilter() const { DARABONBA_PTR_GET_DEFAULT(appFilter_, "") };
    ...
    inline string getAppNameSearchKeyword() const { DARABONBA_PTR_GET_DEFAULT(appNameSearchKeyword_, "") };
  ...
  protected:
    shared_ptr<string> appFilter_ {};
    shared_ptr<string> appNameSearchKeyword_ {};
