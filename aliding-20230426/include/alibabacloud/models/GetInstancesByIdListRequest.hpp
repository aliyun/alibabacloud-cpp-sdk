...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appType_ == nullptr
        && this->language_ == nullptr && this->processInstanceIds_ == nullptr && this->systemToken_ == nullptr; };
    ...
    inline string getProcessInstanceIds() const { DARABONBA_PTR_GET_DEFAULT(processInstanceIds_, "") };
  ...
  protected:
    ...
    shared_ptr<string> processInstanceIds_ {};
