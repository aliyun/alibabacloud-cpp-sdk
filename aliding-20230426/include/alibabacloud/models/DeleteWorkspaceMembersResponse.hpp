...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWorkspaceMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWorkspaceMembersResponseBody) };
    inline DeleteWorkspaceMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWorkspaceMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWorkspaceMembersResponseBody> body_ {};
  };
