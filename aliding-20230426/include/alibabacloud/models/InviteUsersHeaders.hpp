...
namespace Models
{
  ...
  public:
    ...
    inline const InviteUsersHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, InviteUsersHeaders::AccountContext) };
    inline InviteUsersHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, InviteUsersHeaders::AccountContext) };
    inline InviteUsersHeaders& setAccountContext(const InviteUsersHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline InviteUsersHeaders& setAccountContext(InviteUsersHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<InviteUsersHeaders::AccountContext> accountContext_ {};
  };
