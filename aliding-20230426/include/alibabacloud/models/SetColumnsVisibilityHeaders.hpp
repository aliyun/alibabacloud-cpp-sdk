...
namespace Models
{
  ...
  public:
    ...
    inline const SetColumnsVisibilityHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, SetColumnsVisibilityHeaders::AccountContext) };
    inline SetColumnsVisibilityHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, SetColumnsVisibilityHeaders::AccountContext) };
    inline SetColumnsVisibilityHeaders& setAccountContext(const SetColumnsVisibilityHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline SetColumnsVisibilityHeaders& setAccountContext(SetColumnsVisibilityHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<SetColumnsVisibilityHeaders::AccountContext> accountContext_ {};
  };
