...
#ifndef ALIBABACLOUD_MODELS_GETSHEETSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSHEETSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSheetShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(SheetId, sheetId_);
      DARABONBA_PTR_TO_JSON(TenantContext, tenantContextShrink_);
      DARABONBA_PTR_TO_JSON(WorkbookId, workbookId_);
    };
    friend void from_json(const Darabonba::Json& j, GetSheetShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(SheetId, sheetId_);
      DARABONBA_PTR_FROM_JSON(TenantContext, tenantContextShrink_);
      DARABONBA_PTR_FROM_JSON(WorkbookId, workbookId_);
    };
    GetSheetShrinkRequest() = default ;
    GetSheetShrinkRequest(const GetSheetShrinkRequest &) = default ;
    GetSheetShrinkRequest(GetSheetShrinkRequest &&) = default ;
    GetSheetShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSheetShrinkRequest() = default ;
    GetSheetShrinkRequest& operator=(const GetSheetShrinkRequest &) = default ;
    GetSheetShrinkRequest& operator=(GetSheetShrinkRequest &&) = default ;
