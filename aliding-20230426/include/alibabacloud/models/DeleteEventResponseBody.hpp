...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEventResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, DeleteEventResponseBody::Content) };
    inline DeleteEventResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, DeleteEventResponseBody::Content) };
    inline DeleteEventResponseBody& setContent(const DeleteEventResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline DeleteEventResponseBody& setContent(DeleteEventResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    shared_ptr<DeleteEventResponseBody::Content> content_ {};
