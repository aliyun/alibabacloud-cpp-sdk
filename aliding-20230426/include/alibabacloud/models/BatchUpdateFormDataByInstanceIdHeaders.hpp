...
namespace Models
{
  ...
  public:
    ...
    inline const BatchUpdateFormDataByInstanceIdHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, BatchUpdateFormDataByInstanceIdHeaders::AccountContext) };
    inline BatchUpdateFormDataByInstanceIdHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, BatchUpdateFormDataByInstanceIdHeaders::AccountContext) };
    inline BatchUpdateFormDataByInstanceIdHeaders& setAccountContext(const BatchUpdateFormDataByInstanceIdHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline BatchUpdateFormDataByInstanceIdHeaders& setAccountContext(BatchUpdateFormDataByInstanceIdHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<BatchUpdateFormDataByInstanceIdHeaders::AccountContext> accountContext_ {};
  };
