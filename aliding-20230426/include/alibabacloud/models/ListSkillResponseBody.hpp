...
namespace Models
{
  ...
  public:
    ...
    inline ListSkillResponseBody& setData(const Darabonba::Json & data) { DARABONBA_SET_VALUE(data_, data) };
    inline ListSkillResponseBody& setData(Darabonba::Json && data) { DARABONBA_SET_RVALUE(data_, data) };
