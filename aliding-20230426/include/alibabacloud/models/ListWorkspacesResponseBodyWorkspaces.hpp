...
namespace Models
{
  ...
  public:
    ...
    inline ListWorkspacesResponseBodyWorkspaces& setCorpId(string corpId) { DARABONBA_PTR_SET_VALUE(corpId_, corpId) };
    ...
    inline ListWorkspacesResponseBodyWorkspaces& setCover(string cover) { DARABONBA_PTR_SET_VALUE(cover_, cover) };
    ...
    inline ListWorkspacesResponseBodyWorkspaces& setCreatorId(string creatorId) { DARABONBA_PTR_SET_VALUE(creatorId_, creatorId) };
    ...
    inline const Models::ListWorkspacesResponseBodyWorkspacesIcon & icon() const { DARABONBA_PTR_GET_CONST(icon_, Models::ListWorkspacesResponseBodyWorkspacesIcon) };
    inline Models::ListWorkspacesResponseBodyWorkspacesIcon icon() { DARABONBA_PTR_GET(icon_, Models::ListWorkspacesResponseBodyWorkspacesIcon) };
    inline ListWorkspacesResponseBodyWorkspaces& setIcon(const Models::ListWorkspacesResponseBodyWorkspacesIcon & icon) { DARABONBA_PTR_SET_VALUE(icon_, icon) };
    inline ListWorkspacesResponseBodyWorkspaces& setIcon(Models::ListWorkspacesResponseBodyWorkspacesIcon && icon) { DARABONBA_PTR_SET_RVALUE(icon_, icon) };
    ...
    inline ListWorkspacesResponseBodyWorkspaces& setModifiedTime(string modifiedTime) { DARABONBA_PTR_SET_VALUE(modifiedTime_, modifiedTime) };
    ...
    inline ListWorkspacesResponseBodyWorkspaces& setModifierId(string modifierId) { DARABONBA_PTR_SET_VALUE(modifierId_, modifierId) };
    ...
    inline ListWorkspacesResponseBodyWorkspaces& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListWorkspacesResponseBodyWorkspaces& setPermissionRole(string permissionRole) { DARABONBA_PTR_SET_VALUE(permissionRole_, permissionRole) };
    ...
    inline ListWorkspacesResponseBodyWorkspaces& setRootNodeId(string rootNodeId) { DARABONBA_PTR_SET_VALUE(rootNodeId_, rootNodeId) };
    ...
    inline ListWorkspacesResponseBodyWorkspaces& setTeamId(string teamId) { DARABONBA_PTR_SET_VALUE(teamId_, teamId) };
    ...
    inline ListWorkspacesResponseBodyWorkspaces& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline ListWorkspacesResponseBodyWorkspaces& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ListWorkspacesResponseBodyWorkspacesIcon> icon_ = nullptr;
