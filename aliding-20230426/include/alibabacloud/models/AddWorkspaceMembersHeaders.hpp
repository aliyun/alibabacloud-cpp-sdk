...
namespace Models
{
  ...
  public:
    ...
    inline const AddWorkspaceMembersHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, AddWorkspaceMembersHeaders::AccountContext) };
    inline AddWorkspaceMembersHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, AddWorkspaceMembersHeaders::AccountContext) };
    inline AddWorkspaceMembersHeaders& setAccountContext(const AddWorkspaceMembersHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline AddWorkspaceMembersHeaders& setAccountContext(AddWorkspaceMembersHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<AddWorkspaceMembersHeaders::AccountContext> accountContext_ {};
  };
