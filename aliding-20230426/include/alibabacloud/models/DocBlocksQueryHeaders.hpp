...
namespace Models
{
  ...
  public:
    ...
    inline const DocBlocksQueryHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DocBlocksQueryHeaders::AccountContext) };
    inline DocBlocksQueryHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DocBlocksQueryHeaders::AccountContext) };
    inline DocBlocksQueryHeaders& setAccountContext(const DocBlocksQueryHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DocBlocksQueryHeaders& setAccountContext(DocBlocksQueryHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DocBlocksQueryHeaders::AccountContext> accountContext_ {};
  };
