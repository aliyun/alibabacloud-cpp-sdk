...
namespace Models
{
  ...
  public:
    ...
    inline const AddWorkspaceDocMembersHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, AddWorkspaceDocMembersHeaders::AccountContext) };
    inline AddWorkspaceDocMembersHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, AddWorkspaceDocMembersHeaders::AccountContext) };
    inline AddWorkspaceDocMembersHeaders& setAccountContext(const AddWorkspaceDocMembersHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline AddWorkspaceDocMembersHeaders& setAccountContext(AddWorkspaceDocMembersHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<AddWorkspaceDocMembersHeaders::AccountContext> accountContext_ {};
  };
