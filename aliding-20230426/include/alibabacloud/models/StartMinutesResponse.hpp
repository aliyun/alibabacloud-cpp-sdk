...
namespace Models
{
  ...
  public:
    ...
    inline const StartMinutesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartMinutesResponseBody) };
    inline StartMinutesResponseBody getBody() { DARABONBA_PTR_GET(body_, StartMinutesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartMinutesResponseBody> body_ {};
  };
