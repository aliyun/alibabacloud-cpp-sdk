...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVideoConferenceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVideoConferenceResponseBody) };
    inline CreateVideoConferenceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVideoConferenceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVideoConferenceResponseBody> body_ {};
  };
