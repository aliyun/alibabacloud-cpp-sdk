...
namespace Models
{
  ...
  public:
    ...
    inline const vector<InvokeAssistantResponseBody::Messages> & getMessages() const { DARABONBA_PTR_GET_CONST(messages_, vector<InvokeAssistantResponseBody::Messages>) };
    inline vector<InvokeAssistantResponseBody::Messages> getMessages() { DARABONBA_PTR_GET(messages_, vector<InvokeAssistantResponseBody::Messages>) };
    inline InvokeAssistantResponseBody& setMessages(const vector<InvokeAssistantResponseBody::Messages> & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline InvokeAssistantResponseBody& setMessages(vector<InvokeAssistantResponseBody::Messages> && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
