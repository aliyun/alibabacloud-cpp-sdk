...
namespace Models
{
  ...
  public:
    ...
    inline const GetNodeByUrlResponseBody::Node & getNode() const { DARABONBA_PTR_GET_CONST(node_, GetNodeByUrlResponseBody::Node) };
    inline GetNodeByUrlResponseBody::Node getNode() { DARABONBA_PTR_GET(node_, GetNodeByUrlResponseBody::Node) };
    inline GetNodeByUrlResponseBody& setNode(const GetNodeByUrlResponseBody::Node & node) { DARABONBA_PTR_SET_VALUE(node_, node) };
    inline GetNodeByUrlResponseBody& setNode(GetNodeByUrlResponseBody::Node && node) { DARABONBA_PTR_SET_RVALUE(node_, node) };
