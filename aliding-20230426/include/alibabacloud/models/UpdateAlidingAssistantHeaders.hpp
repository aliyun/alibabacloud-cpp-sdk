...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAlidingAssistantHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateAlidingAssistantHeaders::AccountContext) };
    inline UpdateAlidingAssistantHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateAlidingAssistantHeaders::AccountContext) };
    inline UpdateAlidingAssistantHeaders& setAccountContext(const UpdateAlidingAssistantHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateAlidingAssistantHeaders& setAccountContext(UpdateAlidingAssistantHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateAlidingAssistantHeaders::AccountContext> accountContext_ {};
  };
