...
namespace Models
{
  ...
  public:
    ...
    inline const AuthorizeSkillResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AuthorizeSkillResponseBody) };
    inline AuthorizeSkillResponseBody getBody() { DARABONBA_PTR_GET(body_, AuthorizeSkillResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AuthorizeSkillResponseBody> body_ {};
  };
