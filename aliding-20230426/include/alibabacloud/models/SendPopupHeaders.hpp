...
namespace Models
{
  ...
  public:
    ...
    inline const SendPopupHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, SendPopupHeaders::AccountContext) };
    inline SendPopupHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, SendPopupHeaders::AccountContext) };
    inline SendPopupHeaders& setAccountContext(const SendPopupHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline SendPopupHeaders& setAccountContext(SendPopupHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<SendPopupHeaders::AccountContext> accountContext_ {};
  };
