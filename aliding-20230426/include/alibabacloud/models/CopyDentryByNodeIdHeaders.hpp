...
namespace Models
{
  ...
  public:
    ...
    inline const CopyDentryByNodeIdHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CopyDentryByNodeIdHeaders::AccountContext) };
    inline CopyDentryByNodeIdHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CopyDentryByNodeIdHeaders::AccountContext) };
    inline CopyDentryByNodeIdHeaders& setAccountContext(const CopyDentryByNodeIdHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CopyDentryByNodeIdHeaders& setAccountContext(CopyDentryByNodeIdHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CopyDentryByNodeIdHeaders::AccountContext> accountContext_ {};
  };
