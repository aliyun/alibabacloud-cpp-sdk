...
namespace Models
{
  ...
  public:
    ...
    inline const QueryUserHonorsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryUserHonorsResponseBody) };
    inline QueryUserHonorsResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryUserHonorsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryUserHonorsResponseBody> body_ {};
  };
