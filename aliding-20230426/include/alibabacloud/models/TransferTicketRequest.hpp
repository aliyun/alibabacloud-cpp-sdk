...
namespace Models
{
  ...
  public:
    ...
    inline const TransferTicketRequest::Notify & getNotify() const { DARABONBA_PTR_GET_CONST(notify_, TransferTicketRequest::Notify) };
    inline TransferTicketRequest::Notify getNotify() { DARABONBA_PTR_GET(notify_, TransferTicketRequest::Notify) };
    inline TransferTicketRequest& setNotify(const TransferTicketRequest::Notify & notify) { DARABONBA_PTR_SET_VALUE(notify_, notify) };
    inline TransferTicketRequest& setNotify(TransferTicketRequest::Notify && notify) { DARABONBA_PTR_SET_RVALUE(notify_, notify) };
    ...
    inline const TransferTicketRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, TransferTicketRequest::TenantContext) };
    inline TransferTicketRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, TransferTicketRequest::TenantContext) };
    inline TransferTicketRequest& setTenantContext(const TransferTicketRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline TransferTicketRequest& setTenantContext(TransferTicketRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
    ...
    inline const TransferTicketRequest::TicketMemo & getTicketMemo() const { DARABONBA_PTR_GET_CONST(ticketMemo_, TransferTicketRequest::TicketMemo) };
    inline TransferTicketRequest::TicketMemo getTicketMemo() { DARABONBA_PTR_GET(ticketMemo_, TransferTicketRequest::TicketMemo) };
    inline TransferTicketRequest& setTicketMemo(const TransferTicketRequest::TicketMemo & ticketMemo) { DARABONBA_PTR_SET_VALUE(ticketMemo_, ticketMemo) };
    inline TransferTicketRequest& setTicketMemo(TransferTicketRequest::TicketMemo && ticketMemo) { DARABONBA_PTR_SET_RVALUE(ticketMemo_, ticketMemo) };


  protected:
    shared_ptr<TransferTicketRequest::Notify> notify_ {};
    // This parameter is required.
    shared_ptr<string> openTeamId_ {};
    // This parameter is required.
    shared_ptr<string> openTicketId_ {};
    shared_ptr<vector<string>> processorUserIds_ {};
    shared_ptr<TransferTicketRequest::TenantContext> tenantContext_ {};
    shared_ptr<TransferTicketRequest::TicketMemo> ticketMemo_ {};
  };
