...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteBatchTaskHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, ExecuteBatchTaskHeaders::AccountContext) };
    inline ExecuteBatchTaskHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, ExecuteBatchTaskHeaders::AccountContext) };
    inline ExecuteBatchTaskHeaders& setAccountContext(const ExecuteBatchTaskHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline ExecuteBatchTaskHeaders& setAccountContext(ExecuteBatchTaskHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<ExecuteBatchTaskHeaders::AccountContext> accountContext_ {};
  };
