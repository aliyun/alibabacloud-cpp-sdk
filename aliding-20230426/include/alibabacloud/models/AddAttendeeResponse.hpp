...
namespace Models
{
  ...
  public:
    ...
    inline const AddAttendeeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddAttendeeResponseBody) };
    inline AddAttendeeResponseBody body() { DARABONBA_PTR_GET(body_, AddAttendeeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddAttendeeResponseBody> body_ = nullptr;
  };
