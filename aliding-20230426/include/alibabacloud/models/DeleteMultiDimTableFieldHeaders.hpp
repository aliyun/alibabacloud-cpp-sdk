...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMultiDimTableFieldHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteMultiDimTableFieldHeaders::AccountContext) };
    inline DeleteMultiDimTableFieldHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteMultiDimTableFieldHeaders::AccountContext) };
    inline DeleteMultiDimTableFieldHeaders& setAccountContext(const DeleteMultiDimTableFieldHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteMultiDimTableFieldHeaders& setAccountContext(DeleteMultiDimTableFieldHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DeleteMultiDimTableFieldHeaders::AccountContext> accountContext_ {};
  };
