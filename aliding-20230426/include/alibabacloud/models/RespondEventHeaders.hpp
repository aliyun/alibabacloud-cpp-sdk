...
namespace Models
{
  ...
  public:
    ...
    inline const RespondEventHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, RespondEventHeaders::AccountContext) };
    inline RespondEventHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, RespondEventHeaders::AccountContext) };
    inline RespondEventHeaders& setAccountContext(const RespondEventHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline RespondEventHeaders& setAccountContext(RespondEventHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<RespondEventHeaders::AccountContext> accountContext_ {};
  };
