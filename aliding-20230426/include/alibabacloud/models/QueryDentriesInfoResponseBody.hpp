...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDentriesInfoResponseBody::Dentry & getDentry() const { DARABONBA_PTR_GET_CONST(dentry_, QueryDentriesInfoResponseBody::Dentry) };
    inline QueryDentriesInfoResponseBody::Dentry getDentry() { DARABONBA_PTR_GET(dentry_, QueryDentriesInfoResponseBody::Dentry) };
    inline QueryDentriesInfoResponseBody& setDentry(const QueryDentriesInfoResponseBody::Dentry & dentry) { DARABONBA_PTR_SET_VALUE(dentry_, dentry) };
    inline QueryDentriesInfoResponseBody& setDentry(QueryDentriesInfoResponseBody::Dentry && dentry) { DARABONBA_PTR_SET_RVALUE(dentry_, dentry) };
  ...
  protected:
    shared_ptr<QueryDentriesInfoResponseBody::Dentry> dentry_ {};
