...
namespace Models
{
  ...
  public:
    ...
    inline const RedirectTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RedirectTaskResponseBody) };
    inline RedirectTaskResponseBody body() { DARABONBA_PTR_GET(body_, RedirectTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RedirectTaskResponseBody> body_ = nullptr;
  };
