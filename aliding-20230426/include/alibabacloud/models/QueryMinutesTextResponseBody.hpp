...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->hasMore_ == nullptr
        && return this->nextToken_ == nullptr && return this->paragraphList_ == nullptr && return this->requestId_ == nullptr && return this->vendorRequestId_ == nullptr && return this->vendorType_ == nullptr; };
