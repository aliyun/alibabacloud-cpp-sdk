...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateWorkspaceMembersRequest::Members> & getMembers() const { DARABONBA_PTR_GET_CONST(members_, vector<UpdateWorkspaceMembersRequest::Members>) };
    inline vector<UpdateWorkspaceMembersRequest::Members> getMembers() { DARABONBA_PTR_GET(members_, vector<UpdateWorkspaceMembersRequest::Members>) };
    inline UpdateWorkspaceMembersRequest& setMembers(const vector<UpdateWorkspaceMembersRequest::Members> & members) { DARABONBA_PTR_SET_VALUE(members_, members) };
    inline UpdateWorkspaceMembersRequest& setMembers(vector<UpdateWorkspaceMembersRequest::Members> && members) { DARABONBA_PTR_SET_RVALUE(members_, members) };


    // tenantContext Field Functions 
    bool hasTenantContext() const { return this->tenantContext_ != nullptr;};
    void deleteTenantContext() { this->tenantContext_ = nullptr;};
    inline const UpdateWorkspaceMembersRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, UpdateWorkspaceMembersRequest::TenantContext) };
    inline UpdateWorkspaceMembersRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, UpdateWorkspaceMembersRequest::TenantContext) };
    inline UpdateWorkspaceMembersRequest& setTenantContext(const UpdateWorkspaceMembersRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline UpdateWorkspaceMembersRequest& setTenantContext(UpdateWorkspaceMembersRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    // This parameter is required.
    shared_ptr<vector<UpdateWorkspaceMembersRequest::Members>> members_ {};
    shared_ptr<UpdateWorkspaceMembersRequest::TenantContext> tenantContext_ {};
    // This parameter is required.
