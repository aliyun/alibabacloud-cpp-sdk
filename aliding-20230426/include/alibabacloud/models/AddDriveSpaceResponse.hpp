...
namespace Models
{
  ...
  public:
    ...
    inline const AddDriveSpaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddDriveSpaceResponseBody) };
    inline AddDriveSpaceResponseBody getBody() { DARABONBA_PTR_GET(body_, AddDriveSpaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddDriveSpaceResponseBody> body_ {};
  };
