...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->enableCycleReservation_ == nullptr
        && return this->groupId_ == nullptr && return this->isvRoomId_ == nullptr && return this->reservationAuthorityShrink_ == nullptr && return this->roomCapacity_ == nullptr && return this->roomLabelIdsShrink_ == nullptr
        && return this->roomLocationShrink_ == nullptr && return this->roomName_ == nullptr && return this->roomPicture_ == nullptr && return this->roomStatus_ == nullptr && return this->tenantContextShrink_ == nullptr; };
