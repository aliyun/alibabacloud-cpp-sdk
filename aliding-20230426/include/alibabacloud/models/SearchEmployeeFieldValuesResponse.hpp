...
namespace Models
{
  ...
  public:
    ...
    inline const SearchEmployeeFieldValuesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchEmployeeFieldValuesResponseBody) };
    inline SearchEmployeeFieldValuesResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchEmployeeFieldValuesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchEmployeeFieldValuesResponseBody> body_ {};
  };
