...
namespace Models
{
  ...
  public:
    ...
    inline const GetReportTemplateByNameHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetReportTemplateByNameHeaders::AccountContext) };
    inline GetReportTemplateByNameHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetReportTemplateByNameHeaders::AccountContext) };
    inline GetReportTemplateByNameHeaders& setAccountContext(const GetReportTemplateByNameHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetReportTemplateByNameHeaders& setAccountContext(GetReportTemplateByNameHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetReportTemplateByNameHeaders::AccountContext> accountContext_ {};
  };
