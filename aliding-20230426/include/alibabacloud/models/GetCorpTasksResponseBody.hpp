...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetCorpTasksResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetCorpTasksResponseBodyData>) };
    inline vector<GetCorpTasksResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetCorpTasksResponseBodyData>) };
    inline GetCorpTasksResponseBody& setData(const vector<GetCorpTasksResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCorpTasksResponseBody& setData(vector<GetCorpTasksResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<GetCorpTasksResponseBodyData>> data_ = nullptr;
