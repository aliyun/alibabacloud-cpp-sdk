...
namespace Models
{
  ...
  public:
    ...
    inline const RecallHonorHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, RecallHonorHeaders::AccountContext) };
    inline RecallHonorHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, RecallHonorHeaders::AccountContext) };
    inline RecallHonorHeaders& setAccountContext(const RecallHonorHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline RecallHonorHeaders& setAccountContext(RecallHonorHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<RecallHonorHeaders::AccountContext> accountContext_ {};
  };
