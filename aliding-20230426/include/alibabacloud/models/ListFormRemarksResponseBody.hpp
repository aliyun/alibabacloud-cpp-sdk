...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->formRemarkVoMap_ == nullptr
    ...
    inline     const Darabonba::Json & getFormRemarkVoMap() const { DARABONBA_GET(formRemarkVoMap_) };
    Darabonba::Json & getFormRemarkVoMap() { DARABONBA_GET(formRemarkVoMap_) };
  ...
  protected:
    Darabonba::Json formRemarkVoMap_ {};
