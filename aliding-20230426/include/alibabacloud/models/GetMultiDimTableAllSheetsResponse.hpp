...
namespace Models
{
  ...
  public:
    ...
    inline const GetMultiDimTableAllSheetsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetMultiDimTableAllSheetsResponseBody) };
    inline GetMultiDimTableAllSheetsResponseBody body() { DARABONBA_PTR_GET(body_, GetMultiDimTableAllSheetsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetMultiDimTableAllSheetsResponseBody> body_ = nullptr;
  };
