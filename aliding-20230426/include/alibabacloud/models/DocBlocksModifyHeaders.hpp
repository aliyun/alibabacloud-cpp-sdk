...
namespace Models
{
  ...
  public:
    ...
    inline const DocBlocksModifyHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DocBlocksModifyHeaders::AccountContext) };
    inline DocBlocksModifyHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DocBlocksModifyHeaders::AccountContext) };
    inline DocBlocksModifyHeaders& setAccountContext(const DocBlocksModifyHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DocBlocksModifyHeaders& setAccountContext(DocBlocksModifyHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DocBlocksModifyHeaders::AccountContext> accountContext_ {};
  };
