...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDingtalkPersonalTodoTaskHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateDingtalkPersonalTodoTaskHeaders::AccountContext) };
    inline CreateDingtalkPersonalTodoTaskHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateDingtalkPersonalTodoTaskHeaders::AccountContext) };
    inline CreateDingtalkPersonalTodoTaskHeaders& setAccountContext(const CreateDingtalkPersonalTodoTaskHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateDingtalkPersonalTodoTaskHeaders& setAccountContext(CreateDingtalkPersonalTodoTaskHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateDingtalkPersonalTodoTaskHeaders::AccountContext> accountContext_ {};
  };
