...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSearchKeywordHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateSearchKeywordHeaders::AccountContext) };
    inline CreateSearchKeywordHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateSearchKeywordHeaders::AccountContext) };
    inline CreateSearchKeywordHeaders& setAccountContext(const CreateSearchKeywordHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateSearchKeywordHeaders& setAccountContext(CreateSearchKeywordHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateSearchKeywordHeaders::AccountContext> accountContext_ {};
  };
