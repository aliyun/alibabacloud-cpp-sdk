...
namespace Models
{
  ...
  public:
    ...
    inline const SearchInnerGroupsHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, SearchInnerGroupsHeaders::AccountContext) };
    inline SearchInnerGroupsHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, SearchInnerGroupsHeaders::AccountContext) };
    inline SearchInnerGroupsHeaders& setAccountContext(const SearchInnerGroupsHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline SearchInnerGroupsHeaders& setAccountContext(SearchInnerGroupsHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<SearchInnerGroupsHeaders::AccountContext> accountContext_ {};
  };
