...
namespace Models
{
  ...
  public:
    ...
    inline const AddDriveSpaceHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, AddDriveSpaceHeaders::AccountContext) };
    inline AddDriveSpaceHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, AddDriveSpaceHeaders::AccountContext) };
    inline AddDriveSpaceHeaders& setAccountContext(const AddDriveSpaceHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline AddDriveSpaceHeaders& setAccountContext(AddDriveSpaceHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    // This parameter is required.
    shared_ptr<AddDriveSpaceHeaders::AccountContext> accountContext_ {};
  };
