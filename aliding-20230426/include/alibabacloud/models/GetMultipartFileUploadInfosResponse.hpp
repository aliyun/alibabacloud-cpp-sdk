...
namespace Models
{
  ...
  public:
    ...
    inline const GetMultipartFileUploadInfosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMultipartFileUploadInfosResponseBody) };
    inline GetMultipartFileUploadInfosResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMultipartFileUploadInfosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMultipartFileUploadInfosResponseBody> body_ {};
  };
