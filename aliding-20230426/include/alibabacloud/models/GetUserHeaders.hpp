...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetUserHeaders::AccountContext) };
    inline GetUserHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetUserHeaders::AccountContext) };
    inline GetUserHeaders& setAccountContext(const GetUserHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetUserHeaders& setAccountContext(GetUserHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetUserHeaders::AccountContext> accountContext_ {};
  };
