...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMultiDimTableRecordsHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateMultiDimTableRecordsHeaders::AccountContext) };
    inline UpdateMultiDimTableRecordsHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateMultiDimTableRecordsHeaders::AccountContext) };
    inline UpdateMultiDimTableRecordsHeaders& setAccountContext(const UpdateMultiDimTableRecordsHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateMultiDimTableRecordsHeaders& setAccountContext(UpdateMultiDimTableRecordsHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateMultiDimTableRecordsHeaders::AccountContext> accountContext_ {};
  };
