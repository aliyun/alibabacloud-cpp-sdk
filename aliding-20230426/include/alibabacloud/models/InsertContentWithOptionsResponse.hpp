...
namespace Models
{
  ...
  public:
    ...
    inline const InsertContentWithOptionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InsertContentWithOptionsResponseBody) };
    inline InsertContentWithOptionsResponseBody getBody() { DARABONBA_PTR_GET(body_, InsertContentWithOptionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InsertContentWithOptionsResponseBody> body_ {};
  };
