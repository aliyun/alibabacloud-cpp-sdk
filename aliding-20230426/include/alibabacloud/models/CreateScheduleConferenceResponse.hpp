...
namespace Models
{
  ...
  public:
    ...
    inline const CreateScheduleConferenceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateScheduleConferenceResponseBody) };
    inline CreateScheduleConferenceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateScheduleConferenceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateScheduleConferenceResponseBody> body_ {};
  };
