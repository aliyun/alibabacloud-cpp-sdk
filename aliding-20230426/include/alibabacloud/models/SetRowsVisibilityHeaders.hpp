...
namespace Models
{
  ...
  public:
    ...
    inline const SetRowsVisibilityHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, SetRowsVisibilityHeaders::AccountContext) };
    inline SetRowsVisibilityHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, SetRowsVisibilityHeaders::AccountContext) };
    inline SetRowsVisibilityHeaders& setAccountContext(const SetRowsVisibilityHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline SetRowsVisibilityHeaders& setAccountContext(SetRowsVisibilityHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<SetRowsVisibilityHeaders::AccountContext> accountContext_ {};
  };
