...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMeetingRoomGroupListHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryMeetingRoomGroupListHeaders::AccountContext) };
    inline QueryMeetingRoomGroupListHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryMeetingRoomGroupListHeaders::AccountContext) };
    inline QueryMeetingRoomGroupListHeaders& setAccountContext(const QueryMeetingRoomGroupListHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryMeetingRoomGroupListHeaders& setAccountContext(QueryMeetingRoomGroupListHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryMeetingRoomGroupListHeaders::AccountContext> accountContext_ {};
  };
