...
namespace Models
{
  ...
  public:
    ...
    inline const CommitFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CommitFileResponseBody) };
    inline CommitFileResponseBody getBody() { DARABONBA_PTR_GET(body_, CommitFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CommitFileResponseBody> body_ {};
  };
