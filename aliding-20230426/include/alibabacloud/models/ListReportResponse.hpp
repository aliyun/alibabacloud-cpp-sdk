...
namespace Models
{
  ...
  public:
    ...
    inline const ListReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListReportResponseBody) };
    inline ListReportResponseBody getBody() { DARABONBA_PTR_GET(body_, ListReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListReportResponseBody> body_ {};
  };
