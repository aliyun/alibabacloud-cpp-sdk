...
namespace Models
{
  ...
  public:
    ...
    inline const CreateThreadResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateThreadResponseBody) };
    inline CreateThreadResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateThreadResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateThreadResponseBody> body_ {};
  };
