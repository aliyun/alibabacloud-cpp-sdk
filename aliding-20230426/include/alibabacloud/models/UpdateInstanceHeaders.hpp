...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateInstanceHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateInstanceHeaders::AccountContext) };
    inline UpdateInstanceHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateInstanceHeaders::AccountContext) };
    inline UpdateInstanceHeaders& setAccountContext(const UpdateInstanceHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateInstanceHeaders& setAccountContext(UpdateInstanceHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateInstanceHeaders::AccountContext> accountContext_ {};
  };
