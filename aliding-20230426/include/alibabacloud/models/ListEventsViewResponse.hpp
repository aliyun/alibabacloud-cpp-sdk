...
namespace Models
{
  ...
  public:
    ...
    inline const ListEventsViewResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListEventsViewResponseBody) };
    inline ListEventsViewResponseBody body() { DARABONBA_PTR_GET(body_, ListEventsViewResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListEventsViewResponseBody> body_ = nullptr;
  };
