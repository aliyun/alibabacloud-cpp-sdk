...
namespace Models
{
  ...
  public:
    ...
    inline const AddMeetingRoomsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddMeetingRoomsResponseBody) };
    inline AddMeetingRoomsResponseBody getBody() { DARABONBA_PTR_GET(body_, AddMeetingRoomsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddMeetingRoomsResponseBody> body_ {};
  };
