...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMeetingRoomHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryMeetingRoomHeaders::AccountContext) };
    inline QueryMeetingRoomHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryMeetingRoomHeaders::AccountContext) };
    inline QueryMeetingRoomHeaders& setAccountContext(const QueryMeetingRoomHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryMeetingRoomHeaders& setAccountContext(QueryMeetingRoomHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryMeetingRoomHeaders::AccountContext> accountContext_ {};
  };
