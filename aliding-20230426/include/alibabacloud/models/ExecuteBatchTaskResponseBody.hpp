...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->failNumber_ == nullptr
    ...
    inline int32_t getFailNumber() const { DARABONBA_PTR_GET_DEFAULT(failNumber_, 0) };
    ...
    inline int32_t getSuccessNumber() const { DARABONBA_PTR_GET_DEFAULT(successNumber_, 0) };
  ...
  protected:
    shared_ptr<int32_t> failNumber_ {};
    shared_ptr<string> requestId_ {};
    shared_ptr<int32_t> successNumber_ {};
