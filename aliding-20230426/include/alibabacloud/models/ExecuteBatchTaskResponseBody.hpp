...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->failNumber_ == nullptr
        && return this->requestId_ == nullptr && return this->successNumber_ == nullptr && return this->total_ == nullptr && return this->vendorRequestId_ == nullptr && return this->vendorType_ == nullptr; };
