...
namespace Models
{
  ...
  public:
    ...
    inline const ListSkillHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, ListSkillHeaders::AccountContext) };
    inline ListSkillHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, ListSkillHeaders::AccountContext) };
    inline ListSkillHeaders& setAccountContext(const ListSkillHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline ListSkillHeaders& setAccountContext(ListSkillHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<ListSkillHeaders::AccountContext> accountContext_ {};
  };
