...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMultiDimTableRecordsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteMultiDimTableRecordsResponseBody) };
    inline DeleteMultiDimTableRecordsResponseBody body() { DARABONBA_PTR_GET(body_, DeleteMultiDimTableRecordsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteMultiDimTableRecordsResponseBody> body_ = nullptr;
  };
