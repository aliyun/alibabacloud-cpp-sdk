...
namespace Models
{
  ...
  public:
    ...
    inline const CreateReportHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateReportHeaders::AccountContext) };
    inline CreateReportHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateReportHeaders::AccountContext) };
    inline CreateReportHeaders& setAccountContext(const CreateReportHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateReportHeaders& setAccountContext(CreateReportHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateReportHeaders::AccountContext> accountContext_ {};
  };
