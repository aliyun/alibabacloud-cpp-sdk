...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->commentNum_ == nullptr
        && this->commentUserNum_ == nullptr && this->likeNum_ == nullptr && this->readNum_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline int64_t getCommentNum() const { DARABONBA_PTR_GET_DEFAULT(commentNum_, 0L) };
    ...
    inline int64_t getCommentUserNum() const { DARABONBA_PTR_GET_DEFAULT(commentUserNum_, 0L) };
    ...
    inline int64_t getLikeNum() const { DARABONBA_PTR_GET_DEFAULT(likeNum_, 0L) };
    ...
    inline int64_t getReadNum() const { DARABONBA_PTR_GET_DEFAULT(readNum_, 0L) };
  ...
  protected:
    shared_ptr<int64_t> commentNum_ {};
