...
namespace Models
{
  ...
  public:
    ...
    inline const SendBannerRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, SendBannerRequest::TenantContext) };
    inline SendBannerRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, SendBannerRequest::TenantContext) };
    inline SendBannerRequest& setTenantContext(const SendBannerRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline SendBannerRequest& setTenantContext(SendBannerRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<SendBannerRequest::TenantContext> tenantContext_ {};
  };
