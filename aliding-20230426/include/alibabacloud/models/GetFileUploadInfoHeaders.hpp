...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileUploadInfoHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetFileUploadInfoHeaders::AccountContext) };
    inline GetFileUploadInfoHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetFileUploadInfoHeaders::AccountContext) };
    inline GetFileUploadInfoHeaders& setAccountContext(const GetFileUploadInfoHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetFileUploadInfoHeaders& setAccountContext(GetFileUploadInfoHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetFileUploadInfoHeaders::AccountContext> accountContext_ {};
  };
