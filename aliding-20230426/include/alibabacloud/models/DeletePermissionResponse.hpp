...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePermissionResponseBody) };
    inline DeletePermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePermissionResponseBody> body_ {};
  };
