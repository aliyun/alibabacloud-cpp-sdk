...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCloudRecordVideoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryCloudRecordVideoResponseBody) };
    inline QueryCloudRecordVideoResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryCloudRecordVideoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryCloudRecordVideoResponseBody> body_ {};
  };
