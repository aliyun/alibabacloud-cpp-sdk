...
namespace Models
{
  ...
  public:
    ...
    inline const GetMultiDimTableRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMultiDimTableRecordResponseBody) };
    inline GetMultiDimTableRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMultiDimTableRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMultiDimTableRecordResponseBody> body_ {};
  };
