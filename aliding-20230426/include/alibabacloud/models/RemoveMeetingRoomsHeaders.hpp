...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveMeetingRoomsHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, RemoveMeetingRoomsHeaders::AccountContext) };
    inline RemoveMeetingRoomsHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, RemoveMeetingRoomsHeaders::AccountContext) };
    inline RemoveMeetingRoomsHeaders& setAccountContext(const RemoveMeetingRoomsHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline RemoveMeetingRoomsHeaders& setAccountContext(RemoveMeetingRoomsHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<RemoveMeetingRoomsHeaders::AccountContext> accountContext_ {};
  };
