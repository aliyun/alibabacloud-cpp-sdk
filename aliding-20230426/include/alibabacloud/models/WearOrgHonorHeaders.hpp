...
namespace Models
{
  ...
  public:
    ...
    inline const WearOrgHonorHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, WearOrgHonorHeaders::AccountContext) };
    inline WearOrgHonorHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, WearOrgHonorHeaders::AccountContext) };
    inline WearOrgHonorHeaders& setAccountContext(const WearOrgHonorHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline WearOrgHonorHeaders& setAccountContext(WearOrgHonorHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<WearOrgHonorHeaders::AccountContext> accountContext_ {};
  };
