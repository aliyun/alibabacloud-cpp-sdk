...
namespace Models
{
  ...
  public:
    ...
    inline const InvokeAssistantRequest::ExtLoginUser & getExtLoginUser() const { DARABONBA_PTR_GET_CONST(extLoginUser_, InvokeAssistantRequest::ExtLoginUser) };
    inline InvokeAssistantRequest::ExtLoginUser getExtLoginUser() { DARABONBA_PTR_GET(extLoginUser_, InvokeAssistantRequest::ExtLoginUser) };
    inline InvokeAssistantRequest& setExtLoginUser(const InvokeAssistantRequest::ExtLoginUser & extLoginUser) { DARABONBA_PTR_SET_VALUE(extLoginUser_, extLoginUser) };
    inline InvokeAssistantRequest& setExtLoginUser(InvokeAssistantRequest::ExtLoginUser && extLoginUser) { DARABONBA_PTR_SET_RVALUE(extLoginUser_, extLoginUser) };


    // messages Field Functions 
    bool hasMessages() const { return this->messages_ != nullptr;};
    void deleteMessages() { this->messages_ = nullptr;};
    inline const vector<InvokeAssistantRequest::Messages> & getMessages() const { DARABONBA_PTR_GET_CONST(messages_, vector<InvokeAssistantRequest::Messages>) };
    inline vector<InvokeAssistantRequest::Messages> getMessages() { DARABONBA_PTR_GET(messages_, vector<InvokeAssistantRequest::Messages>) };
    inline InvokeAssistantRequest& setMessages(const vector<InvokeAssistantRequest::Messages> & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline InvokeAssistantRequest& setMessages(vector<InvokeAssistantRequest::Messages> && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
