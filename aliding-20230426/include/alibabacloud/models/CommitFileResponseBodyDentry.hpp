...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appProperties_ == nullptr
        && return this->category_ == nullptr && return this->createTime_ == nullptr && return this->creatorId_ == nullptr && return this->extension_ == nullptr && return this->id_ == nullptr
        && return this->modifiedTime_ == nullptr && return this->modifierId_ == nullptr && return this->name_ == nullptr && return this->parentId_ == nullptr && return this->partitionType_ == nullptr
        && return this->path_ == nullptr && return this->properties_ == nullptr && return this->size_ == nullptr && return this->spaceId_ == nullptr && return this->status_ == nullptr
        && return this->storageDriver_ == nullptr && return this->thumbnail_ == nullptr && return this->type_ == nullptr && return this->uuid_ == nullptr && return this->version_ == nullptr; };
