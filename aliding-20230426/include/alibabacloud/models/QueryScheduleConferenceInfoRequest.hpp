...
namespace Models
{
  ...
  public:
    ...
    inline const QueryScheduleConferenceInfoRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, QueryScheduleConferenceInfoRequest::TenantContext) };
    inline QueryScheduleConferenceInfoRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, QueryScheduleConferenceInfoRequest::TenantContext) };
    inline QueryScheduleConferenceInfoRequest& setTenantContext(const QueryScheduleConferenceInfoRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline QueryScheduleConferenceInfoRequest& setTenantContext(QueryScheduleConferenceInfoRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<QueryScheduleConferenceInfoRequest::TenantContext> tenantContext_ {};
  };
