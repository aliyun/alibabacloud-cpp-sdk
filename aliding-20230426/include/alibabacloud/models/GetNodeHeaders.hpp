...
namespace Models
{
  ...
  public:
    ...
    inline const GetNodeHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetNodeHeaders::AccountContext) };
    inline GetNodeHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetNodeHeaders::AccountContext) };
    inline GetNodeHeaders& setAccountContext(const GetNodeHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetNodeHeaders& setAccountContext(GetNodeHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetNodeHeaders::AccountContext> accountContext_ {};
  };
