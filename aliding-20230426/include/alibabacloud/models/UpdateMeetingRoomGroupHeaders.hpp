...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMeetingRoomGroupHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateMeetingRoomGroupHeaders::AccountContext) };
    inline UpdateMeetingRoomGroupHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateMeetingRoomGroupHeaders::AccountContext) };
    inline UpdateMeetingRoomGroupHeaders& setAccountContext(const UpdateMeetingRoomGroupHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateMeetingRoomGroupHeaders& setAccountContext(UpdateMeetingRoomGroupHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateMeetingRoomGroupHeaders::AccountContext> accountContext_ {};
  };
