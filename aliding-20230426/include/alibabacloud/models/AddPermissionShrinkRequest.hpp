...
#ifndef ALIBABACLOUD_MODELS_ADDPERMISSIONSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDPERMISSIONSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddPermissionShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddPermissionShrinkRequest& obj) { 
    ...
    AddPermissionShrinkRequest() = default ;
    AddPermissionShrinkRequest(const AddPermissionShrinkRequest &) = default ;
    AddPermissionShrinkRequest(AddPermissionShrinkRequest &&) = default ;
    AddPermissionShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddPermissionShrinkRequest() = default ;
    AddPermissionShrinkRequest& operator=(const AddPermissionShrinkRequest &) = default ;
    AddPermissionShrinkRequest& operator=(AddPermissionShrinkRequest &&) = default ;
