...
namespace Models
{
  ...
  public:
    ...
    inline const GetGroupLiveListResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetGroupLiveListResponseBodyResult) };
    inline GetGroupLiveListResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetGroupLiveListResponseBodyResult) };
    inline GetGroupLiveListResponseBody& setResult(const GetGroupLiveListResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetGroupLiveListResponseBody& setResult(GetGroupLiveListResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetGroupLiveListResponseBodyResult> result_ = nullptr;
