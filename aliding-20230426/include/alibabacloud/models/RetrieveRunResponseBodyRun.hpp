...
#ifndef ALIBABACLOUD_MODELS_RETRIEVERUNRESPONSEBODYRUN_HPP_
#define ALIBABACLOUD_MODELS_RETRIEVERUNRESPONSEBODYRUN_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RetrieveRunResponseBodyRun& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RetrieveRunResponseBodyRun& obj) { 
    ...
    RetrieveRunResponseBodyRun() = default ;
    RetrieveRunResponseBodyRun(const RetrieveRunResponseBodyRun &) = default ;
    RetrieveRunResponseBodyRun(RetrieveRunResponseBodyRun &&) = default ;
    RetrieveRunResponseBodyRun(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RetrieveRunResponseBodyRun() = default ;
    RetrieveRunResponseBodyRun& operator=(const RetrieveRunResponseBodyRun &) = default ;
    RetrieveRunResponseBodyRun& operator=(RetrieveRunResponseBodyRun &&) = default ;
    ...
    inline RetrieveRunResponseBodyRun& setCancelledAt(int64_t cancelledAt) { DARABONBA_PTR_SET_VALUE(cancelledAt_, cancelledAt) };
    ...
    inline RetrieveRunResponseBodyRun& setCompletedAt(int64_t completedAt) { DARABONBA_PTR_SET_VALUE(completedAt_, completedAt) };
    ...
    inline RetrieveRunResponseBodyRun& setCreateAt(int64_t createAt) { DARABONBA_PTR_SET_VALUE(createAt_, createAt) };
    ...
    inline RetrieveRunResponseBodyRun& setExpiresAt(int64_t expiresAt) { DARABONBA_PTR_SET_VALUE(expiresAt_, expiresAt) };
    ...
    inline RetrieveRunResponseBodyRun& setFailedAt(int64_t failedAt) { DARABONBA_PTR_SET_VALUE(failedAt_, failedAt) };
    ...
    inline RetrieveRunResponseBodyRun& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RetrieveRunResponseBodyRun& setLastErrorMsg(string lastErrorMsg) { DARABONBA_PTR_SET_VALUE(lastErrorMsg_, lastErrorMsg) };
    ...
    inline RetrieveRunResponseBodyRun& setStartedAt(int64_t startedAt) { DARABONBA_PTR_SET_VALUE(startedAt_, startedAt) };
    ...
    inline RetrieveRunResponseBodyRun& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline RetrieveRunResponseBodyRun& setThreadId(string threadId) { DARABONBA_PTR_SET_VALUE(threadId_, threadId) };
