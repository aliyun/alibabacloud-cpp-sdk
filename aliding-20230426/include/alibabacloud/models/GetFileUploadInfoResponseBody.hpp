...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileUploadInfoResponseBody::HeaderSignatureInfo & getHeaderSignatureInfo() const { DARABONBA_PTR_GET_CONST(headerSignatureInfo_, GetFileUploadInfoResponseBody::HeaderSignatureInfo) };
    inline GetFileUploadInfoResponseBody::HeaderSignatureInfo getHeaderSignatureInfo() { DARABONBA_PTR_GET(headerSignatureInfo_, GetFileUploadInfoResponseBody::HeaderSignatureInfo) };
    inline GetFileUploadInfoResponseBody& setHeaderSignatureInfo(const GetFileUploadInfoResponseBody::HeaderSignatureInfo & headerSignatureInfo) { DARABONBA_PTR_SET_VALUE(headerSignatureInfo_, headerSignatureInfo) };
    inline GetFileUploadInfoResponseBody& setHeaderSignatureInfo(GetFileUploadInfoResponseBody::HeaderSignatureInfo && headerSignatureInfo) { DARABONBA_PTR_SET_RVALUE(headerSignatureInfo_, headerSignatureInfo) };
    ...
    inline GetFileUploadInfoResponseBody& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline GetFileUploadInfoResponseBody& setStorageDriver(string storageDriver) { DARABONBA_PTR_SET_VALUE(storageDriver_, storageDriver) };
    ...
    inline GetFileUploadInfoResponseBody& setUploadKey(string uploadKey) { DARABONBA_PTR_SET_VALUE(uploadKey_, uploadKey) };
    ...
    inline GetFileUploadInfoResponseBody& setVendorRequestId(string vendorRequestId) { DARABONBA_PTR_SET_VALUE(vendorRequestId_, vendorRequestId) };
    ...
    inline GetFileUploadInfoResponseBody& setVendorType(string vendorType) { DARABONBA_PTR_SET_VALUE(vendorType_, vendorType) };


  protected:
    shared_ptr<GetFileUploadInfoResponseBody::HeaderSignatureInfo> headerSignatureInfo_ {};
