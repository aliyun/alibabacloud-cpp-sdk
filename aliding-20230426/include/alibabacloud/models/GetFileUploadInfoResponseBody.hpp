...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileUploadInfoResponseBodyHeaderSignatureInfo & headerSignatureInfo() const { DARABONBA_PTR_GET_CONST(headerSignatureInfo_, GetFileUploadInfoResponseBodyHeaderSignatureInfo) };
    inline GetFileUploadInfoResponseBodyHeaderSignatureInfo headerSignatureInfo() { DARABONBA_PTR_GET(headerSignatureInfo_, GetFileUploadInfoResponseBodyHeaderSignatureInfo) };
    inline GetFileUploadInfoResponseBody& setHeaderSignatureInfo(const GetFileUploadInfoResponseBodyHeaderSignatureInfo & headerSignatureInfo) { DARABONBA_PTR_SET_VALUE(headerSignatureInfo_, headerSignatureInfo) };
    inline GetFileUploadInfoResponseBody& setHeaderSignatureInfo(GetFileUploadInfoResponseBodyHeaderSignatureInfo && headerSignatureInfo) { DARABONBA_PTR_SET_RVALUE(headerSignatureInfo_, headerSignatureInfo) };
  ...
  protected:
    std::shared_ptr<GetFileUploadInfoResponseBodyHeaderSignatureInfo> headerSignatureInfo_ = nullptr;
