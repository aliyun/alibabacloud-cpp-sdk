...
namespace Models
{
  ...
  public:
    ...
    inline const QueryConferenceInfoHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryConferenceInfoHeaders::AccountContext) };
    inline QueryConferenceInfoHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryConferenceInfoHeaders::AccountContext) };
    inline QueryConferenceInfoHeaders& setAccountContext(const QueryConferenceInfoHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryConferenceInfoHeaders& setAccountContext(QueryConferenceInfoHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryConferenceInfoHeaders::AccountContext> accountContext_ {};
  };
