...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMeetingRoomGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMeetingRoomGroupResponseBody) };
    inline DeleteMeetingRoomGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMeetingRoomGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMeetingRoomGroupResponseBody> body_ {};
  };
