...
namespace Models
{
  ...
  public:
    ...
    inline const GetInnerGroupMembersHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetInnerGroupMembersHeaders::AccountContext) };
    inline GetInnerGroupMembersHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetInnerGroupMembersHeaders::AccountContext) };
    inline GetInnerGroupMembersHeaders& setAccountContext(const GetInnerGroupMembersHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetInnerGroupMembersHeaders& setAccountContext(GetInnerGroupMembersHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetInnerGroupMembersHeaders::AccountContext> accountContext_ {};
  };
