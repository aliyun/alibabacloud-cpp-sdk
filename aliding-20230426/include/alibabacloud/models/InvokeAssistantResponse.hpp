...
namespace Models
{
  ...
  public:
    ...
    inline InvokeAssistantResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline InvokeAssistantResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const InvokeAssistantResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InvokeAssistantResponseBody) };
    inline InvokeAssistantResponseBody getBody() { DARABONBA_PTR_GET(body_, InvokeAssistantResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InvokeAssistantResponseBody> body_ {};
  };
