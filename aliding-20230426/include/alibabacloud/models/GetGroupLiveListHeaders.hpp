...
namespace Models
{
  ...
  public:
    ...
    inline const GetGroupLiveListHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetGroupLiveListHeaders::AccountContext) };
    inline GetGroupLiveListHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetGroupLiveListHeaders::AccountContext) };
    inline GetGroupLiveListHeaders& setAccountContext(const GetGroupLiveListHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetGroupLiveListHeaders& setAccountContext(GetGroupLiveListHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetGroupLiveListHeaders::AccountContext> accountContext_ {};
  };
