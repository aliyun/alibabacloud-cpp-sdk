...
namespace Models
{
  ...
  public:
    ...
    inline const BatchUpdateFormDataByInstanceMapHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, BatchUpdateFormDataByInstanceMapHeaders::AccountContext) };
    inline BatchUpdateFormDataByInstanceMapHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, BatchUpdateFormDataByInstanceMapHeaders::AccountContext) };
    inline BatchUpdateFormDataByInstanceMapHeaders& setAccountContext(const BatchUpdateFormDataByInstanceMapHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline BatchUpdateFormDataByInstanceMapHeaders& setAccountContext(BatchUpdateFormDataByInstanceMapHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<BatchUpdateFormDataByInstanceMapHeaders::AccountContext> accountContext_ {};
  };
