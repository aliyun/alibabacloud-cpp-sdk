...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDentryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryDentryResponseBody) };
    inline QueryDentryResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryDentryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryDentryResponseBody> body_ {};
  };
