...
namespace Models
{
  ...
  public:
    ...
    inline const DocBlocksQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DocBlocksQueryResponseBody) };
    inline DocBlocksQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, DocBlocksQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DocBlocksQueryResponseBody> body_ {};
  };
