...
namespace Models
{
  ...
  public:
    ...
    inline const ClearDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ClearDataResponseBody) };
    inline ClearDataResponseBody getBody() { DARABONBA_PTR_GET(body_, ClearDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ClearDataResponseBody> body_ {};
  };
