...
namespace Models
{
  ...
  public:
    ...
    inline const GetMultiDimTableRecordHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetMultiDimTableRecordHeaders::AccountContext) };
    inline GetMultiDimTableRecordHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetMultiDimTableRecordHeaders::AccountContext) };
    inline GetMultiDimTableRecordHeaders& setAccountContext(const GetMultiDimTableRecordHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetMultiDimTableRecordHeaders& setAccountContext(GetMultiDimTableRecordHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetMultiDimTableRecordHeaders::AccountContext> accountContext_ {};
  };
