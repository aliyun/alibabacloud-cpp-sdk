...
namespace Models
{
  ...
  public:
    ...
    inline const QueryGroupLiveInfoHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryGroupLiveInfoHeaders::AccountContext) };
    inline QueryGroupLiveInfoHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryGroupLiveInfoHeaders::AccountContext) };
    inline QueryGroupLiveInfoHeaders& setAccountContext(const QueryGroupLiveInfoHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryGroupLiveInfoHeaders& setAccountContext(QueryGroupLiveInfoHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryGroupLiveInfoHeaders::AccountContext> accountContext_ {};
  };
