...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOrUpdateFormDataHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateOrUpdateFormDataHeaders::AccountContext) };
    inline CreateOrUpdateFormDataHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateOrUpdateFormDataHeaders::AccountContext) };
    inline CreateOrUpdateFormDataHeaders& setAccountContext(const CreateOrUpdateFormDataHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateOrUpdateFormDataHeaders& setAccountContext(CreateOrUpdateFormDataHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateOrUpdateFormDataHeaders::AccountContext> accountContext_ {};
  };
