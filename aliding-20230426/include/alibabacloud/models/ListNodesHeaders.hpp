...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodesHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, ListNodesHeaders::AccountContext) };
    inline ListNodesHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, ListNodesHeaders::AccountContext) };
    inline ListNodesHeaders& setAccountContext(const ListNodesHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline ListNodesHeaders& setAccountContext(ListNodesHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<ListNodesHeaders::AccountContext> accountContext_ {};
  };
