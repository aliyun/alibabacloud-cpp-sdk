...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->calendarId_ == nullptr
        && return this->maxAttendees_ == nullptr && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->seriesMasterId_ == nullptr && return this->showDeleted_ == nullptr
        && return this->syncToken_ == nullptr && return this->timeMax_ == nullptr && return this->timeMin_ == nullptr; };
