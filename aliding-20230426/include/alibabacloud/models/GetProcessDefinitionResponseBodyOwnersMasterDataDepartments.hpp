...
#ifndef ALIBABACLOUD_MODELS_GETPROCESSDEFINITIONRESPONSEBODYOWNERSMASTERDATADEPARTMENTS_HPP_
#define ALIBABACLOUD_MODELS_GETPROCESSDEFINITIONRESPONSEBODYOWNERSMASTERDATADEPARTMENTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& obj) { 
    ...
    GetProcessDefinitionResponseBodyOwnersMasterDataDepartments() = default ;
    GetProcessDefinitionResponseBodyOwnersMasterDataDepartments(const GetProcessDefinitionResponseBodyOwnersMasterDataDepartments &) = default ;
    GetProcessDefinitionResponseBodyOwnersMasterDataDepartments(GetProcessDefinitionResponseBodyOwnersMasterDataDepartments &&) = default ;
    GetProcessDefinitionResponseBodyOwnersMasterDataDepartments(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetProcessDefinitionResponseBodyOwnersMasterDataDepartments() = default ;
    GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& operator=(const GetProcessDefinitionResponseBodyOwnersMasterDataDepartments &) = default ;
    GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& operator=(GetProcessDefinitionResponseBodyOwnersMasterDataDepartments &&) = default ;
    ...
    inline GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& setDeptName(string deptName) { DARABONBA_PTR_SET_VALUE(deptName_, deptName) };
    ...
    inline GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& setDeptNameInEnglish(string deptNameInEnglish) { DARABONBA_PTR_SET_VALUE(deptNameInEnglish_, deptNameInEnglish) };
    ...
    inline GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& setDeptNo(string deptNo) { DARABONBA_PTR_SET_VALUE(deptNo_, deptNo) };
    ...
    inline GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& setDeptPath(string deptPath) { DARABONBA_PTR_SET_VALUE(deptPath_, deptPath) };
    ...
    inline GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& setHumanSourceGroupOrderNumber(string humanSourceGroupOrderNumber) { DARABONBA_PTR_SET_VALUE(humanSourceGroupOrderNumber_, humanSourceGroupOrderNumber) };
    ...
    inline GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& setHumanSourceGroupWorkNo(string humanSourceGroupWorkNo) { DARABONBA_PTR_SET_VALUE(humanSourceGroupWorkNo_, humanSourceGroupWorkNo) };
    ...
    inline GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetProcessDefinitionResponseBodyOwnersMasterDataDepartments& setMasterWorkNo(string masterWorkNo) { DARABONBA_PTR_SET_VALUE(masterWorkNo_, masterWorkNo) };
