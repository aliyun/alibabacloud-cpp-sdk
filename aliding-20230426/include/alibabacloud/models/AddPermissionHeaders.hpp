...
namespace Models
{
  ...
  public:
    ...
    inline const AddPermissionHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, AddPermissionHeaders::AccountContext) };
    inline AddPermissionHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, AddPermissionHeaders::AccountContext) };
    inline AddPermissionHeaders& setAccountContext(const AddPermissionHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline AddPermissionHeaders& setAccountContext(AddPermissionHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<AddPermissionHeaders::AccountContext> accountContext_ {};
  };
