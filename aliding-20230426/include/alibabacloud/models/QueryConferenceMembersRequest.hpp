...
namespace Models
{
  ...
  public:
    ...
    inline const QueryConferenceMembersRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, QueryConferenceMembersRequest::TenantContext) };
    inline QueryConferenceMembersRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, QueryConferenceMembersRequest::TenantContext) };
    inline QueryConferenceMembersRequest& setTenantContext(const QueryConferenceMembersRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline QueryConferenceMembersRequest& setTenantContext(QueryConferenceMembersRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<QueryConferenceMembersRequest::TenantContext> tenantContext_ {};
