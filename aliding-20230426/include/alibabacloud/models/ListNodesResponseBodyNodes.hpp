...
namespace Models
{
  ...
  public:
    ...
    inline ListNodesResponseBodyNodes& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
    ...
    inline ListNodesResponseBodyNodes& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListNodesResponseBodyNodes& setCreatorId(string creatorId) { DARABONBA_PTR_SET_VALUE(creatorId_, creatorId) };
    ...
    inline ListNodesResponseBodyNodes& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline ListNodesResponseBodyNodes& setHasChildren(bool hasChildren) { DARABONBA_PTR_SET_VALUE(hasChildren_, hasChildren) };
    ...
    inline ListNodesResponseBodyNodes& setModifiedTime(string modifiedTime) { DARABONBA_PTR_SET_VALUE(modifiedTime_, modifiedTime) };
    ...
    inline ListNodesResponseBodyNodes& setModifierId(string modifierId) { DARABONBA_PTR_SET_VALUE(modifierId_, modifierId) };
    ...
    inline ListNodesResponseBodyNodes& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListNodesResponseBodyNodes& setNodeId(string nodeId) { DARABONBA_PTR_SET_VALUE(nodeId_, nodeId) };
    ...
    inline ListNodesResponseBodyNodes& setPermissionRole(string permissionRole) { DARABONBA_PTR_SET_VALUE(permissionRole_, permissionRole) };
    ...
    inline ListNodesResponseBodyNodes& setSize(int64_t size) { DARABONBA_PTR_SET_VALUE(size_, size) };
    ...
    inline const Models::ListNodesResponseBodyNodesStatisticalInfo & statisticalInfo() const { DARABONBA_PTR_GET_CONST(statisticalInfo_, Models::ListNodesResponseBodyNodesStatisticalInfo) };
    inline Models::ListNodesResponseBodyNodesStatisticalInfo statisticalInfo() { DARABONBA_PTR_GET(statisticalInfo_, Models::ListNodesResponseBodyNodesStatisticalInfo) };
    inline ListNodesResponseBodyNodes& setStatisticalInfo(const Models::ListNodesResponseBodyNodesStatisticalInfo & statisticalInfo) { DARABONBA_PTR_SET_VALUE(statisticalInfo_, statisticalInfo) };
    inline ListNodesResponseBodyNodes& setStatisticalInfo(Models::ListNodesResponseBodyNodesStatisticalInfo && statisticalInfo) { DARABONBA_PTR_SET_RVALUE(statisticalInfo_, statisticalInfo) };
    ...
    inline ListNodesResponseBodyNodes& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline ListNodesResponseBodyNodes& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
    ...
    inline ListNodesResponseBodyNodes& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ListNodesResponseBodyNodesStatisticalInfo> statisticalInfo_ = nullptr;
