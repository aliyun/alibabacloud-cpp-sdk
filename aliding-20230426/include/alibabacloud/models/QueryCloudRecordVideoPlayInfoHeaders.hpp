...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCloudRecordVideoPlayInfoHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryCloudRecordVideoPlayInfoHeaders::AccountContext) };
    inline QueryCloudRecordVideoPlayInfoHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryCloudRecordVideoPlayInfoHeaders::AccountContext) };
    inline QueryCloudRecordVideoPlayInfoHeaders& setAccountContext(const QueryCloudRecordVideoPlayInfoHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryCloudRecordVideoPlayInfoHeaders& setAccountContext(QueryCloudRecordVideoPlayInfoHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryCloudRecordVideoPlayInfoHeaders::AccountContext> accountContext_ {};
  };
