...
namespace Models
{
  ...
  public:
    ...
    inline const AddWorkspaceHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, AddWorkspaceHeaders::AccountContext) };
    inline AddWorkspaceHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, AddWorkspaceHeaders::AccountContext) };
    inline AddWorkspaceHeaders& setAccountContext(const AddWorkspaceHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline AddWorkspaceHeaders& setAccountContext(AddWorkspaceHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<AddWorkspaceHeaders::AccountContext> accountContext_ {};
  };
