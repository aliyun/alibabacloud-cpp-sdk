...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAlidingAssistantResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAlidingAssistantResponseBody) };
    inline UpdateAlidingAssistantResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAlidingAssistantResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAlidingAssistantResponseBody> body_ {};
  };
