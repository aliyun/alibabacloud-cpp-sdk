...
namespace Models
{
  ...
  public:
    ...
    inline const GetProcessDefinitionHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetProcessDefinitionHeaders::AccountContext) };
    inline GetProcessDefinitionHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetProcessDefinitionHeaders::AccountContext) };
    inline GetProcessDefinitionHeaders& setAccountContext(const GetProcessDefinitionHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetProcessDefinitionHeaders& setAccountContext(GetProcessDefinitionHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetProcessDefinitionHeaders::AccountContext> accountContext_ {};
  };
