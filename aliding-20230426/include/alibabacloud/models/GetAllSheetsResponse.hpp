...
namespace Models
{
  ...
  public:
    ...
    inline const GetAllSheetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAllSheetsResponseBody) };
    inline GetAllSheetsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAllSheetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAllSheetsResponseBody> body_ {};
  };
