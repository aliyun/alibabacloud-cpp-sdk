...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetTaskCopiesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetTaskCopiesResponseBodyData>) };
    inline vector<GetTaskCopiesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetTaskCopiesResponseBodyData>) };
    inline GetTaskCopiesResponseBody& setData(const vector<GetTaskCopiesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTaskCopiesResponseBody& setData(vector<GetTaskCopiesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<GetTaskCopiesResponseBodyData>> data_ = nullptr;
