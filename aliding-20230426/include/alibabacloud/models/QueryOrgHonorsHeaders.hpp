...
namespace Models
{
  ...
  public:
    ...
    inline const QueryOrgHonorsHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryOrgHonorsHeaders::AccountContext) };
    inline QueryOrgHonorsHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryOrgHonorsHeaders::AccountContext) };
    inline QueryOrgHonorsHeaders& setAccountContext(const QueryOrgHonorsHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryOrgHonorsHeaders& setAccountContext(QueryOrgHonorsHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryOrgHonorsHeaders::AccountContext> accountContext_ {};
  };
