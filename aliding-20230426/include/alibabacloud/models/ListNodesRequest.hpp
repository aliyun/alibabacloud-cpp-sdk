...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodesRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, ListNodesRequest::TenantContext) };
    inline ListNodesRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, ListNodesRequest::TenantContext) };
    inline ListNodesRequest& setTenantContext(const ListNodesRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline ListNodesRequest& setTenantContext(ListNodesRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<ListNodesRequest::TenantContext> tenantContext_ {};
