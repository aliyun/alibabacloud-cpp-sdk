...
namespace Models
{
  ...
  public:
    ...
    inline const StopCloudRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopCloudRecordResponseBody) };
    inline StopCloudRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, StopCloudRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopCloudRecordResponseBody> body_ {};
  };
