...
namespace Models
{
  ...
  public:
    ...
    inline const GetOperationRecordsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOperationRecordsResponseBody) };
    inline GetOperationRecordsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOperationRecordsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOperationRecordsResponseBody> body_ {};
  };
