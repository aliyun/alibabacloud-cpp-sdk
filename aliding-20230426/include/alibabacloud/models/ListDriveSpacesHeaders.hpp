...
namespace Models
{
  ...
  public:
    ...
    inline const ListDriveSpacesHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, ListDriveSpacesHeaders::AccountContext) };
    inline ListDriveSpacesHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, ListDriveSpacesHeaders::AccountContext) };
    inline ListDriveSpacesHeaders& setAccountContext(const ListDriveSpacesHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline ListDriveSpacesHeaders& setAccountContext(ListDriveSpacesHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    // This parameter is required.
    shared_ptr<ListDriveSpacesHeaders::AccountContext> accountContext_ {};
  };
