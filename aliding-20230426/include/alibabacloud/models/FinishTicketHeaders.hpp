...
namespace Models
{
  ...
  public:
    ...
    inline const FinishTicketHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, FinishTicketHeaders::AccountContext) };
    inline FinishTicketHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, FinishTicketHeaders::AccountContext) };
    inline FinishTicketHeaders& setAccountContext(const FinishTicketHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline FinishTicketHeaders& setAccountContext(FinishTicketHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<FinishTicketHeaders::AccountContext> accountContext_ {};
  };
