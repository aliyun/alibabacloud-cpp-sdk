...
namespace Models
{
  ...
  public:
    ...
    inline const GetSpaceDirectoriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSpaceDirectoriesResponseBody) };
    inline GetSpaceDirectoriesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSpaceDirectoriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSpaceDirectoriesResponseBody> body_ {};
  };
