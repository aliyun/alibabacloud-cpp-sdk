...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFormDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateFormDataResponseBody) };
    inline UpdateFormDataResponseBody body() { DARABONBA_PTR_GET(body_, UpdateFormDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateFormDataResponseBody> body_ = nullptr;
  };
