...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appType_ == nullptr
        ...
        && return this->updateFormDataJsonMap_ == nullptr && return this->useLatestFormSchemaVersion_ == nullptr; };
    ...
    inline     const Darabonba::Json & updateFormDataJsonMap() const { DARABONBA_GET(updateFormDataJsonMap_) };
    Darabonba::Json & updateFormDataJsonMap() { DARABONBA_GET(updateFormDataJsonMap_) };
  ...
  protected:
    ...
    Darabonba::Json updateFormDataJsonMap_ = nullptr;
