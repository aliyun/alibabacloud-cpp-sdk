...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDriveSpaceHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteDriveSpaceHeaders::AccountContext) };
    inline DeleteDriveSpaceHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteDriveSpaceHeaders::AccountContext) };
    inline DeleteDriveSpaceHeaders& setAccountContext(const DeleteDriveSpaceHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteDriveSpaceHeaders& setAccountContext(DeleteDriveSpaceHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    // This parameter is required.
    shared_ptr<DeleteDriveSpaceHeaders::AccountContext> accountContext_ {};
  };
