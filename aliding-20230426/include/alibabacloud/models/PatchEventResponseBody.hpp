...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->attendees_ != nullptr
        ...
        && this->location_ != nullptr && this->organizer_ != nullptr && this->recurrence_ != nullptr && this->reminders_ != nullptr && this->requestId_ != nullptr
        && this->start_ != nullptr && this->summary_ != nullptr && this->updateTime_ != nullptr; };
