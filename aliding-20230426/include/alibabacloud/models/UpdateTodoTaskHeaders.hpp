...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTodoTaskHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateTodoTaskHeaders::AccountContext) };
    inline UpdateTodoTaskHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateTodoTaskHeaders::AccountContext) };
    inline UpdateTodoTaskHeaders& setAccountContext(const UpdateTodoTaskHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateTodoTaskHeaders& setAccountContext(UpdateTodoTaskHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateTodoTaskHeaders::AccountContext> accountContext_ {};
  };
