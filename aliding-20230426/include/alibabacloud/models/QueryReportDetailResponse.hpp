...
namespace Models
{
  ...
  public:
    ...
    inline const QueryReportDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryReportDetailResponseBody) };
    inline QueryReportDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryReportDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryReportDetailResponseBody> body_ {};
  };
