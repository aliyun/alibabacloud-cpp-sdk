...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMinutesRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, QueryMinutesRequest::TenantContext) };
    inline QueryMinutesRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, QueryMinutesRequest::TenantContext) };
    inline QueryMinutesRequest& setTenantContext(const QueryMinutesRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline QueryMinutesRequest& setTenantContext(QueryMinutesRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    shared_ptr<QueryMinutesRequest::TenantContext> tenantContext_ {};
