...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->blockId_ == nullptr
        && this->dentryUuid_ == nullptr && this->tenantContext_ == nullptr; };
    ...
    inline const DocBlocksDeleteRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, DocBlocksDeleteRequest::TenantContext) };
    inline DocBlocksDeleteRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, DocBlocksDeleteRequest::TenantContext) };
    inline DocBlocksDeleteRequest& setTenantContext(const DocBlocksDeleteRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline DocBlocksDeleteRequest& setTenantContext(DocBlocksDeleteRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<DocBlocksDeleteRequest::TenantContext> tenantContext_ {};
  };
