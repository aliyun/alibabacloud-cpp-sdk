...
namespace Models
{
  ...
  public:
    ...
    inline const GetLiveReplayUrlHeadersAccountContext & accountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetLiveReplayUrlHeadersAccountContext) };
    inline GetLiveReplayUrlHeadersAccountContext accountContext() { DARABONBA_PTR_GET(accountContext_, GetLiveReplayUrlHeadersAccountContext) };
    inline GetLiveReplayUrlHeaders& setAccountContext(const GetLiveReplayUrlHeadersAccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetLiveReplayUrlHeaders& setAccountContext(GetLiveReplayUrlHeadersAccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    std::shared_ptr<map<string, string>> commonHeaders_ = nullptr;
    std::shared_ptr<GetLiveReplayUrlHeadersAccountContext> accountContext_ = nullptr;
  };
