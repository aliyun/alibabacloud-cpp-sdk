...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getAccountHandleStatus() const { DARABONBA_PTR_GET_DEFAULT(accountHandleStatus_, 0) };
    ...
    inline string getAccountHandleTime() const { DARABONBA_PTR_GET_DEFAULT(accountHandleTime_, "") };
    ...
    inline string getAgreementFirstSignTime() const { DARABONBA_PTR_GET_DEFAULT(agreementFirstSignTime_, "") };
    ...
    inline string getAgreementLastSignTime() const { DARABONBA_PTR_GET_DEFAULT(agreementLastSignTime_, "") };
    ...
    inline int32_t getAgreementStatus() const { DARABONBA_PTR_GET_DEFAULT(agreementStatus_, 0) };
    ...
    inline string getDataHandleEndTime() const { DARABONBA_PTR_GET_DEFAULT(dataHandleEndTime_, "") };
    ...
    inline string getDataHandleStartTime() const { DARABONBA_PTR_GET_DEFAULT(dataHandleStartTime_, "") };
    ...
    inline int32_t getDataHandleStatus() const { DARABONBA_PTR_GET_DEFAULT(dataHandleStatus_, 0) };
    ...
    inline int32_t getExclusivePlan() const { DARABONBA_PTR_GET_DEFAULT(exclusivePlan_, 0) };
    ...
    inline int64_t getNewAccountUid() const { DARABONBA_PTR_GET_DEFAULT(newAccountUid_, 0L) };
  ...
  protected:
    shared_ptr<int32_t> accountHandleStatus_ {};
    shared_ptr<string> accountHandleTime_ {};
    shared_ptr<int32_t> accountType_ {};
    shared_ptr<string> agreementFirstSignTime_ {};
    shared_ptr<string> agreementLastSignTime_ {};
    shared_ptr<int32_t> agreementStatus_ {};
    shared_ptr<string> dataHandleEndTime_ {};
    shared_ptr<string> dataHandleStartTime_ {};
    shared_ptr<int32_t> dataHandleStatus_ {};
    shared_ptr<int32_t> exclusivePlan_ {};
    shared_ptr<int64_t> newAccountUid_ {};
