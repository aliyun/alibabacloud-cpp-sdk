...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWorkspaceMembersHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateWorkspaceMembersHeaders::AccountContext) };
    inline UpdateWorkspaceMembersHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateWorkspaceMembersHeaders::AccountContext) };
    inline UpdateWorkspaceMembersHeaders& setAccountContext(const UpdateWorkspaceMembersHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateWorkspaceMembersHeaders& setAccountContext(UpdateWorkspaceMembersHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateWorkspaceMembersHeaders::AccountContext> accountContext_ {};
  };
