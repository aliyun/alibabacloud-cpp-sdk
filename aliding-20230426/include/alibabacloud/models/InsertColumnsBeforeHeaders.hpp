...
namespace Models
{
  ...
  public:
    ...
    inline const InsertColumnsBeforeHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, InsertColumnsBeforeHeaders::AccountContext) };
    inline InsertColumnsBeforeHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, InsertColumnsBeforeHeaders::AccountContext) };
    inline InsertColumnsBeforeHeaders& setAccountContext(const InsertColumnsBeforeHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline InsertColumnsBeforeHeaders& setAccountContext(InsertColumnsBeforeHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<InsertColumnsBeforeHeaders::AccountContext> accountContext_ {};
  };
