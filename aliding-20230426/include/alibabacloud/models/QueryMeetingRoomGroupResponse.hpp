...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMeetingRoomGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryMeetingRoomGroupResponseBody) };
    inline QueryMeetingRoomGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryMeetingRoomGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryMeetingRoomGroupResponseBody> body_ {};
  };
