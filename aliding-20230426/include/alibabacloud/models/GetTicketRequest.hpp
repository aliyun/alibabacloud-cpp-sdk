...
namespace Models
{
  ...
  public:
    ...
    inline const GetTicketRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, GetTicketRequest::TenantContext) };
    inline GetTicketRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, GetTicketRequest::TenantContext) };
    inline GetTicketRequest& setTenantContext(const GetTicketRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline GetTicketRequest& setTenantContext(GetTicketRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<GetTicketRequest::TenantContext> tenantContext_ {};
  };
