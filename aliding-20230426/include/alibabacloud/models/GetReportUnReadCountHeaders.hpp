...
namespace Models
{
  ...
  public:
    ...
    inline const GetReportUnReadCountHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetReportUnReadCountHeaders::AccountContext) };
    inline GetReportUnReadCountHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetReportUnReadCountHeaders::AccountContext) };
    inline GetReportUnReadCountHeaders& setAccountContext(const GetReportUnReadCountHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetReportUnReadCountHeaders& setAccountContext(GetReportUnReadCountHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetReportUnReadCountHeaders::AccountContext> accountContext_ {};
  };
