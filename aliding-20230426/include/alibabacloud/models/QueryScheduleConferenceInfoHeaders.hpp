...
namespace Models
{
  ...
  public:
    ...
    inline const QueryScheduleConferenceInfoHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryScheduleConferenceInfoHeaders::AccountContext) };
    inline QueryScheduleConferenceInfoHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryScheduleConferenceInfoHeaders::AccountContext) };
    inline QueryScheduleConferenceInfoHeaders& setAccountContext(const QueryScheduleConferenceInfoHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryScheduleConferenceInfoHeaders& setAccountContext(QueryScheduleConferenceInfoHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryScheduleConferenceInfoHeaders::AccountContext> accountContext_ {};
  };
