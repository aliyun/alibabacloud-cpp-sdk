...
namespace Models
{
  ...
  public:
    ...
    inline const UnsubscribeEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnsubscribeEventResponseBody) };
    inline UnsubscribeEventResponseBody getBody() { DARABONBA_PTR_GET(body_, UnsubscribeEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnsubscribeEventResponseBody> body_ {};
  };
