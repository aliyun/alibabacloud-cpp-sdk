...
namespace Models
{
  ...
  public:
    ...
    inline const QueryLiveInfoHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryLiveInfoHeaders::AccountContext) };
    inline QueryLiveInfoHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryLiveInfoHeaders::AccountContext) };
    inline QueryLiveInfoHeaders& setAccountContext(const QueryLiveInfoHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryLiveInfoHeaders& setAccountContext(QueryLiveInfoHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryLiveInfoHeaders::AccountContext> accountContext_ {};
  };
