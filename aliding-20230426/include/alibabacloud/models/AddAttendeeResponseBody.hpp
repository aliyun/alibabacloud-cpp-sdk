...
namespace Models
{
  ...
  public:
    ...
    inline const AddAttendeeResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, AddAttendeeResponseBody::Content) };
    inline AddAttendeeResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, AddAttendeeResponseBody::Content) };
    inline AddAttendeeResponseBody& setContent(const AddAttendeeResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline AddAttendeeResponseBody& setContent(AddAttendeeResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    shared_ptr<AddAttendeeResponseBody::Content> content_ {};
