...
namespace Models
{
  ...
  public:
    ...
    inline const StopMinutesRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, StopMinutesRequest::TenantContext) };
    inline StopMinutesRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, StopMinutesRequest::TenantContext) };
    inline StopMinutesRequest& setTenantContext(const StopMinutesRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline StopMinutesRequest& setTenantContext(StopMinutesRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    shared_ptr<StopMinutesRequest::TenantContext> tenantContext_ {};
