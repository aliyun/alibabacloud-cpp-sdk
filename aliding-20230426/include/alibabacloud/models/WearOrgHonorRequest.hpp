...
namespace Models
{
  ...
  public:
    ...
    inline const WearOrgHonorRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, WearOrgHonorRequest::TenantContext) };
    inline WearOrgHonorRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, WearOrgHonorRequest::TenantContext) };
    inline WearOrgHonorRequest& setTenantContext(const WearOrgHonorRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline WearOrgHonorRequest& setTenantContext(WearOrgHonorRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    shared_ptr<WearOrgHonorRequest::TenantContext> tenantContext_ {};
