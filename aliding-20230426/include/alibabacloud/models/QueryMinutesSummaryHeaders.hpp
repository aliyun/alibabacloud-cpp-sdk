...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMinutesSummaryHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryMinutesSummaryHeaders::AccountContext) };
    inline QueryMinutesSummaryHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryMinutesSummaryHeaders::AccountContext) };
    inline QueryMinutesSummaryHeaders& setAccountContext(const QueryMinutesSummaryHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryMinutesSummaryHeaders& setAccountContext(QueryMinutesSummaryHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryMinutesSummaryHeaders::AccountContext> accountContext_ {};
  };
