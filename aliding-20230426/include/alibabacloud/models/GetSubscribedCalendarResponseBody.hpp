...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->author_ == nullptr
        && return this->calendarId_ == nullptr && return this->description_ == nullptr && return this->managers_ == nullptr && return this->name_ == nullptr && return this->requestId_ == nullptr
        && return this->subscribeScope_ == nullptr; };
