...
#ifndef ALIBABACLOUD_MODELS_GETPROCESSDEFINITIONRESPONSEBODYTASKSACTIVITY_HPP_
#define ALIBABACLOUD_MODELS_GETPROCESSDEFINITIONRESPONSEBODYTASKSACTIVITY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetProcessDefinitionResponseBodyTasksActivity& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetProcessDefinitionResponseBodyTasksActivity& obj) { 
    ...
    GetProcessDefinitionResponseBodyTasksActivity() = default ;
    GetProcessDefinitionResponseBodyTasksActivity(const GetProcessDefinitionResponseBodyTasksActivity &) = default ;
    GetProcessDefinitionResponseBodyTasksActivity(GetProcessDefinitionResponseBodyTasksActivity &&) = default ;
    GetProcessDefinitionResponseBodyTasksActivity(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetProcessDefinitionResponseBodyTasksActivity() = default ;
    GetProcessDefinitionResponseBodyTasksActivity& operator=(const GetProcessDefinitionResponseBodyTasksActivity &) = default ;
    GetProcessDefinitionResponseBodyTasksActivity& operator=(GetProcessDefinitionResponseBodyTasksActivity &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->activityId_ == nullptr
        && return this->activityInstanceStatus_ == nullptr && return this->activityName_ == nullptr && return this->activityNameInEnglish_ == nullptr && return this->id_ == nullptr; };
    ...
    inline GetProcessDefinitionResponseBodyTasksActivity& setActivityId(string activityId) { DARABONBA_PTR_SET_VALUE(activityId_, activityId) };
    ...
    inline GetProcessDefinitionResponseBodyTasksActivity& setActivityInstanceStatus(string activityInstanceStatus) { DARABONBA_PTR_SET_VALUE(activityInstanceStatus_, activityInstanceStatus) };
    ...
    inline GetProcessDefinitionResponseBodyTasksActivity& setActivityName(string activityName) { DARABONBA_PTR_SET_VALUE(activityName_, activityName) };
    ...
    inline GetProcessDefinitionResponseBodyTasksActivity& setActivityNameInEnglish(string activityNameInEnglish) { DARABONBA_PTR_SET_VALUE(activityNameInEnglish_, activityNameInEnglish) };
    ...
    inline GetProcessDefinitionResponseBodyTasksActivity& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
