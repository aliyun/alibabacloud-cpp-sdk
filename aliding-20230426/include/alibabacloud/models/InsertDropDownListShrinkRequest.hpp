...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->optionsShrink_ != nullptr
        && this->rangeAddress_ != nullptr && this->sheetId_ != nullptr && this->tenantContextShrink_ != nullptr && this->workbookId_ != nullptr; };
