...
namespace Models
{
  ...
  public:
    ...
    inline const GetFieldDefByUuidHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetFieldDefByUuidHeaders::AccountContext) };
    inline GetFieldDefByUuidHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetFieldDefByUuidHeaders::AccountContext) };
    inline GetFieldDefByUuidHeaders& setAccountContext(const GetFieldDefByUuidHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetFieldDefByUuidHeaders& setAccountContext(GetFieldDefByUuidHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetFieldDefByUuidHeaders::AccountContext> accountContext_ {};
  };
