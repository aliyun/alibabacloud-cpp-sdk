...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSearchDomeHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateSearchDomeHeaders::AccountContext) };
    inline CreateSearchDomeHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateSearchDomeHeaders::AccountContext) };
    inline CreateSearchDomeHeaders& setAccountContext(const CreateSearchDomeHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateSearchDomeHeaders& setAccountContext(CreateSearchDomeHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateSearchDomeHeaders::AccountContext> accountContext_ {};
  };
