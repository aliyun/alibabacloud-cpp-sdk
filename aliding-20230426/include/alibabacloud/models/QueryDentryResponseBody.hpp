...
namespace Models
{
  ...
  public:
    ...
    bool hasCreator() const { return this->creator_ != nullptr;};
    void deleteCreator() { this->creator_ = nullptr;};
    inline const QueryDentryResponseBody::Creator & getCreator() const { DARABONBA_PTR_GET_CONST(creator_, QueryDentryResponseBody::Creator) };
    inline QueryDentryResponseBody::Creator getCreator() { DARABONBA_PTR_GET(creator_, QueryDentryResponseBody::Creator) };
    inline QueryDentryResponseBody& setCreator(const QueryDentryResponseBody::Creator & creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
    inline QueryDentryResponseBody& setCreator(QueryDentryResponseBody::Creator && creator) { DARABONBA_PTR_SET_RVALUE(creator_, creator) };
    ...
    bool hasLinkSourceInfo() const { return this->linkSourceInfo_ != nullptr;};
    void deleteLinkSourceInfo() { this->linkSourceInfo_ = nullptr;};
    inline const QueryDentryResponseBody::LinkSourceInfo & getLinkSourceInfo() const { DARABONBA_PTR_GET_CONST(linkSourceInfo_, QueryDentryResponseBody::LinkSourceInfo) };
    inline QueryDentryResponseBody::LinkSourceInfo getLinkSourceInfo() { DARABONBA_PTR_GET(linkSourceInfo_, QueryDentryResponseBody::LinkSourceInfo) };
    inline QueryDentryResponseBody& setLinkSourceInfo(const QueryDentryResponseBody::LinkSourceInfo & linkSourceInfo) { DARABONBA_PTR_SET_VALUE(linkSourceInfo_, linkSourceInfo) };
    inline QueryDentryResponseBody& setLinkSourceInfo(QueryDentryResponseBody::LinkSourceInfo && linkSourceInfo) { DARABONBA_PTR_SET_RVALUE(linkSourceInfo_, linkSourceInfo) };
    ...
    bool hasSpace() const { return this->space_ != nullptr;};
    void deleteSpace() { this->space_ = nullptr;};
    inline const QueryDentryResponseBody::Space & getSpace() const { DARABONBA_PTR_GET_CONST(space_, QueryDentryResponseBody::Space) };
    inline QueryDentryResponseBody::Space getSpace() { DARABONBA_PTR_GET(space_, QueryDentryResponseBody::Space) };
    inline QueryDentryResponseBody& setSpace(const QueryDentryResponseBody::Space & space) { DARABONBA_PTR_SET_VALUE(space_, space) };
    inline QueryDentryResponseBody& setSpace(QueryDentryResponseBody::Space && space) { DARABONBA_PTR_SET_RVALUE(space_, space) };
    ...
    bool hasUpdater() const { return this->updater_ != nullptr;};
    void deleteUpdater() { this->updater_ = nullptr;};
    inline const QueryDentryResponseBody::Updater & getUpdater() const { DARABONBA_PTR_GET_CONST(updater_, QueryDentryResponseBody::Updater) };
    inline QueryDentryResponseBody::Updater getUpdater() { DARABONBA_PTR_GET(updater_, QueryDentryResponseBody::Updater) };
    inline QueryDentryResponseBody& setUpdater(const QueryDentryResponseBody::Updater & updater) { DARABONBA_PTR_SET_VALUE(updater_, updater) };
    inline QueryDentryResponseBody& setUpdater(QueryDentryResponseBody::Updater && updater) { DARABONBA_PTR_SET_RVALUE(updater_, updater) };
    ...
    bool hasVisitorInfo() const { return this->visitorInfo_ != nullptr;};
    void deleteVisitorInfo() { this->visitorInfo_ = nullptr;};
    inline const QueryDentryResponseBody::VisitorInfo & getVisitorInfo() const { DARABONBA_PTR_GET_CONST(visitorInfo_, QueryDentryResponseBody::VisitorInfo) };
    inline QueryDentryResponseBody::VisitorInfo getVisitorInfo() { DARABONBA_PTR_GET(visitorInfo_, QueryDentryResponseBody::VisitorInfo) };
    inline QueryDentryResponseBody& setVisitorInfo(const QueryDentryResponseBody::VisitorInfo & visitorInfo) { DARABONBA_PTR_SET_VALUE(visitorInfo_, visitorInfo) };
    inline QueryDentryResponseBody& setVisitorInfo(QueryDentryResponseBody::VisitorInfo && visitorInfo) { DARABONBA_PTR_SET_RVALUE(visitorInfo_, visitorInfo) };


  protected:
    shared_ptr<string> contentType_ {};
    shared_ptr<int64_t> createdTime_ {};
    shared_ptr<QueryDentryResponseBody::Creator> creator_ {};
    shared_ptr<string> dentryId_ {};
    shared_ptr<string> dentryType_ {};
    shared_ptr<string> dentryUuid_ {};
    shared_ptr<string> docKey_ {};
    ...
    shared_ptr<string> spaceId_ {};
    shared_ptr<int64_t> updatedTime_ {};
    shared_ptr<QueryDentryResponseBody::Updater> updater_ {};
    shared_ptr<string> url_ {};
    shared_ptr<QueryDentryResponseBody::VisitorInfo> visitorInfo_ {};
  };
