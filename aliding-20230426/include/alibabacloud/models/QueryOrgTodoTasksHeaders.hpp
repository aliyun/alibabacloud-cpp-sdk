...
namespace Models
{
  ...
  public:
    ...
    inline const QueryOrgTodoTasksHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryOrgTodoTasksHeaders::AccountContext) };
    inline QueryOrgTodoTasksHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryOrgTodoTasksHeaders::AccountContext) };
    inline QueryOrgTodoTasksHeaders& setAccountContext(const QueryOrgTodoTasksHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryOrgTodoTasksHeaders& setAccountContext(QueryOrgTodoTasksHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryOrgTodoTasksHeaders::AccountContext> accountContext_ {};
  };
