...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AddWorkspaceDocMembersRequest::Members> & getMembers() const { DARABONBA_PTR_GET_CONST(members_, vector<AddWorkspaceDocMembersRequest::Members>) };
    inline vector<AddWorkspaceDocMembersRequest::Members> getMembers() { DARABONBA_PTR_GET(members_, vector<AddWorkspaceDocMembersRequest::Members>) };
    inline AddWorkspaceDocMembersRequest& setMembers(const vector<AddWorkspaceDocMembersRequest::Members> & members) { DARABONBA_PTR_SET_VALUE(members_, members) };
    inline AddWorkspaceDocMembersRequest& setMembers(vector<AddWorkspaceDocMembersRequest::Members> && members) { DARABONBA_PTR_SET_RVALUE(members_, members) };
    ...
    inline const AddWorkspaceDocMembersRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, AddWorkspaceDocMembersRequest::TenantContext) };
    inline AddWorkspaceDocMembersRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, AddWorkspaceDocMembersRequest::TenantContext) };
    inline AddWorkspaceDocMembersRequest& setTenantContext(const AddWorkspaceDocMembersRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline AddWorkspaceDocMembersRequest& setTenantContext(AddWorkspaceDocMembersRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    // This parameter is required.
    shared_ptr<vector<AddWorkspaceDocMembersRequest::Members>> members_ {};
    // This parameter is required.
    shared_ptr<string> nodeId_ {};
    shared_ptr<AddWorkspaceDocMembersRequest::TenantContext> tenantContext_ {};
    // This parameter is required.
