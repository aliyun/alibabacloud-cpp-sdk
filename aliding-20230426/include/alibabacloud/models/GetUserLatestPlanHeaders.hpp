...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserLatestPlanHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetUserLatestPlanHeaders::AccountContext) };
    inline GetUserLatestPlanHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetUserLatestPlanHeaders::AccountContext) };
    inline GetUserLatestPlanHeaders& setAccountContext(const GetUserLatestPlanHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetUserLatestPlanHeaders& setAccountContext(GetUserLatestPlanHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetUserLatestPlanHeaders::AccountContext> accountContext_ {};
  };
