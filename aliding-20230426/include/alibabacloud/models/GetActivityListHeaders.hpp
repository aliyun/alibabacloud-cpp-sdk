...
namespace Models
{
  ...
  public:
    ...
    inline const GetActivityListHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetActivityListHeaders::AccountContext) };
    inline GetActivityListHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetActivityListHeaders::AccountContext) };
    inline GetActivityListHeaders& setAccountContext(const GetActivityListHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetActivityListHeaders& setAccountContext(GetActivityListHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetActivityListHeaders::AccountContext> accountContext_ {};
  };
