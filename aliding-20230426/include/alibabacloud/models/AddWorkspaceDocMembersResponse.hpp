...
namespace Models
{
  ...
  public:
    ...
    inline const AddWorkspaceDocMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddWorkspaceDocMembersResponseBody) };
    inline AddWorkspaceDocMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, AddWorkspaceDocMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddWorkspaceDocMembersResponseBody> body_ {};
  };
