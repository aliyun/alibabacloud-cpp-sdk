...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteColumnsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteColumnsResponseBody) };
    inline DeleteColumnsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteColumnsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteColumnsResponseBody> body_ {};
  };
