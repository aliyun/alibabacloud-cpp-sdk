...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecuteTaskResponseBody) };
    inline ExecuteTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecuteTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecuteTaskResponseBody> body_ {};
  };
