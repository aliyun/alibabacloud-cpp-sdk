...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSheetHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateSheetHeaders::AccountContext) };
    inline CreateSheetHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateSheetHeaders::AccountContext) };
    inline CreateSheetHeaders& setAccountContext(const CreateSheetHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateSheetHeaders& setAccountContext(CreateSheetHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateSheetHeaders::AccountContext> accountContext_ {};
  };
