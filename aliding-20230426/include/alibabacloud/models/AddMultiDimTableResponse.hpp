...
namespace Models
{
  ...
  public:
    ...
    inline const AddMultiDimTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddMultiDimTableResponseBody) };
    inline AddMultiDimTableResponseBody getBody() { DARABONBA_PTR_GET(body_, AddMultiDimTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddMultiDimTableResponseBody> body_ {};
  };
