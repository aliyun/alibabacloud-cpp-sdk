...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attendees_ == nullptr
        ...
        && return this->organizer_ == nullptr && return this->originStart_ == nullptr && return this->recurrence_ == nullptr && return this->reminders_ == nullptr && return this->richTextDescription_ == nullptr
        && return this->seriesMasterId_ == nullptr && return this->start_ == nullptr && return this->status_ == nullptr && return this->summary_ == nullptr && return this->updateTime_ == nullptr; };
