...
namespace Models
{
  ...
  public:
    ...
    inline const SearchInnerGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchInnerGroupsResponseBody) };
    inline SearchInnerGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchInnerGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchInnerGroupsResponseBody> body_ {};
  };
