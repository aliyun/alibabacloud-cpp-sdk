...
namespace Models
{
  ...
  public:
    ...
    inline const vector<SearchFormDataSecondGenerationNoTableFieldResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<SearchFormDataSecondGenerationNoTableFieldResponseBody::Data>) };
    inline vector<SearchFormDataSecondGenerationNoTableFieldResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<SearchFormDataSecondGenerationNoTableFieldResponseBody::Data>) };
    inline SearchFormDataSecondGenerationNoTableFieldResponseBody& setData(const vector<SearchFormDataSecondGenerationNoTableFieldResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SearchFormDataSecondGenerationNoTableFieldResponseBody& setData(vector<SearchFormDataSecondGenerationNoTableFieldResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    shared_ptr<vector<SearchFormDataSecondGenerationNoTableFieldResponseBody::Data>> data_ {};
