...
namespace Models
{
  ...
  public:
    ...
    inline const CloseVideoConferenceHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CloseVideoConferenceHeaders::AccountContext) };
    inline CloseVideoConferenceHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CloseVideoConferenceHeaders::AccountContext) };
    inline CloseVideoConferenceHeaders& setAccountContext(const CloseVideoConferenceHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CloseVideoConferenceHeaders& setAccountContext(CloseVideoConferenceHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CloseVideoConferenceHeaders::AccountContext> accountContext_ {};
  };
