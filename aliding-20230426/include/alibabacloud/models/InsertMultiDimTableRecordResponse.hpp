...
namespace Models
{
  ...
  public:
    ...
    inline const InsertMultiDimTableRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InsertMultiDimTableRecordResponseBody) };
    inline InsertMultiDimTableRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, InsertMultiDimTableRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InsertMultiDimTableRecordResponseBody> body_ {};
  };
