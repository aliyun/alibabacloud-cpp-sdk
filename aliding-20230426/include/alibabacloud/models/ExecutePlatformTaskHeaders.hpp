...
namespace Models
{
  ...
  public:
    ...
    inline const ExecutePlatformTaskHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, ExecutePlatformTaskHeaders::AccountContext) };
    inline ExecutePlatformTaskHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, ExecutePlatformTaskHeaders::AccountContext) };
    inline ExecutePlatformTaskHeaders& setAccountContext(const ExecutePlatformTaskHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline ExecutePlatformTaskHeaders& setAccountContext(ExecutePlatformTaskHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<ExecutePlatformTaskHeaders::AccountContext> accountContext_ {};
  };
