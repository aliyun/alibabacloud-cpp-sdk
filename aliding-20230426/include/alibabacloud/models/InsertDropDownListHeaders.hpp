...
namespace Models
{
  ...
  public:
    ...
    inline const InsertDropDownListHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, InsertDropDownListHeaders::AccountContext) };
    inline InsertDropDownListHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, InsertDropDownListHeaders::AccountContext) };
    inline InsertDropDownListHeaders& setAccountContext(const InsertDropDownListHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline InsertDropDownListHeaders& setAccountContext(InsertDropDownListHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<InsertDropDownListHeaders::AccountContext> accountContext_ {};
  };
