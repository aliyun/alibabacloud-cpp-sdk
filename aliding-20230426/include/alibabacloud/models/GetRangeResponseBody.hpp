...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backgroundColors_ == nullptr
        && this->displayValues_ == nullptr && this->formulas_ == nullptr && this->hyperlinks_ == nullptr && this->requestId_ == nullptr && this->values_ == nullptr; };
    ...
    inline const vector<vector<GetRangeResponseBody::BackgroundColors>> & getBackgroundColors() const { DARABONBA_PTR_GET_CONST(backgroundColors_, vector<vector<GetRangeResponseBody::BackgroundColors>>) };
    inline vector<vector<GetRangeResponseBody::BackgroundColors>> getBackgroundColors() { DARABONBA_PTR_GET(backgroundColors_, vector<vector<GetRangeResponseBody::BackgroundColors>>) };
    inline GetRangeResponseBody& setBackgroundColors(const vector<vector<GetRangeResponseBody::BackgroundColors>> & backgroundColors) { DARABONBA_PTR_SET_VALUE(backgroundColors_, backgroundColors) };
    inline GetRangeResponseBody& setBackgroundColors(vector<vector<GetRangeResponseBody::BackgroundColors>> && backgroundColors) { DARABONBA_PTR_SET_RVALUE(backgroundColors_, backgroundColors) };
    ...
    inline const vector<vector<string>> & getDisplayValues() const { DARABONBA_PTR_GET_CONST(displayValues_, vector<vector<string>>) };
    inline vector<vector<string>> getDisplayValues() { DARABONBA_PTR_GET(displayValues_, vector<vector<string>>) };
    ...
    inline const vector<vector<string>> & getFormulas() const { DARABONBA_PTR_GET_CONST(formulas_, vector<vector<string>>) };
    inline vector<vector<string>> getFormulas() { DARABONBA_PTR_GET(formulas_, vector<vector<string>>) };
    ...
    inline const vector<vector<GetRangeResponseBody::Hyperlinks>> & getHyperlinks() const { DARABONBA_PTR_GET_CONST(hyperlinks_, vector<vector<GetRangeResponseBody::Hyperlinks>>) };
    inline vector<vector<GetRangeResponseBody::Hyperlinks>> getHyperlinks() { DARABONBA_PTR_GET(hyperlinks_, vector<vector<GetRangeResponseBody::Hyperlinks>>) };
    inline GetRangeResponseBody& setHyperlinks(const vector<vector<GetRangeResponseBody::Hyperlinks>> & hyperlinks) { DARABONBA_PTR_SET_VALUE(hyperlinks_, hyperlinks) };
    inline GetRangeResponseBody& setHyperlinks(vector<vector<GetRangeResponseBody::Hyperlinks>> && hyperlinks) { DARABONBA_PTR_SET_RVALUE(hyperlinks_, hyperlinks) };
    ...
    inline const vector<vector<Darabonba::Json>> & getValues() const { DARABONBA_PTR_GET_CONST(values_, vector<vector<Darabonba::Json>>) };
    inline vector<vector<Darabonba::Json>> getValues() { DARABONBA_PTR_GET(values_, vector<vector<Darabonba::Json>>) };
  ...
  protected:
    shared_ptr<vector<vector<GetRangeResponseBody::BackgroundColors>>> backgroundColors_ {};
