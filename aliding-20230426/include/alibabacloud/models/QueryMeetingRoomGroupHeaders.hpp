...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMeetingRoomGroupHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryMeetingRoomGroupHeaders::AccountContext) };
    inline QueryMeetingRoomGroupHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryMeetingRoomGroupHeaders::AccountContext) };
    inline QueryMeetingRoomGroupHeaders& setAccountContext(const QueryMeetingRoomGroupHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryMeetingRoomGroupHeaders& setAccountContext(QueryMeetingRoomGroupHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryMeetingRoomGroupHeaders::AccountContext> accountContext_ {};
  };
