...
namespace Models
{
  ...
  public:
    ...
    inline const AddFolderResponseBodyDentry & dentry() const { DARABONBA_PTR_GET_CONST(dentry_, AddFolderResponseBodyDentry) };
    inline AddFolderResponseBodyDentry dentry() { DARABONBA_PTR_GET(dentry_, AddFolderResponseBodyDentry) };
    inline AddFolderResponseBody& setDentry(const AddFolderResponseBodyDentry & dentry) { DARABONBA_PTR_SET_VALUE(dentry_, dentry) };
    inline AddFolderResponseBody& setDentry(AddFolderResponseBodyDentry && dentry) { DARABONBA_PTR_SET_RVALUE(dentry_, dentry) };
  ...
  protected:
    std::shared_ptr<AddFolderResponseBodyDentry> dentry_ = nullptr;
