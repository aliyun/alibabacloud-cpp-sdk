...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVideoConferenceHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateVideoConferenceHeaders::AccountContext) };
    inline CreateVideoConferenceHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateVideoConferenceHeaders::AccountContext) };
    inline CreateVideoConferenceHeaders& setAccountContext(const CreateVideoConferenceHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateVideoConferenceHeaders& setAccountContext(CreateVideoConferenceHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateVideoConferenceHeaders::AccountContext> accountContext_ {};
  };
