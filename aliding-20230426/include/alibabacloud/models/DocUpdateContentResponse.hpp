...
namespace Models
{
  ...
  public:
    ...
    inline const DocUpdateContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DocUpdateContentResponseBody) };
    inline DocUpdateContentResponseBody getBody() { DARABONBA_PTR_GET(body_, DocUpdateContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DocUpdateContentResponseBody> body_ {};
  };
