...
namespace Models
{
  ...
  public:
    ...
    inline const SwitchMainOrgResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SwitchMainOrgResponseBody) };
    inline SwitchMainOrgResponseBody getBody() { DARABONBA_PTR_GET(body_, SwitchMainOrgResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SwitchMainOrgResponseBody> body_ {};
  };
