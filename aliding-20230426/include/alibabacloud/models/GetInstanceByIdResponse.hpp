...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceByIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceByIdResponseBody) };
    inline GetInstanceByIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceByIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceByIdResponseBody> body_ {};
  };
