...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appType_ == nullptr
        && this->departmentId_ == nullptr && this->formDataJson_ == nullptr && this->formUuid_ == nullptr && this->language_ == nullptr && this->processCode_ == nullptr
        && this->processData_ == nullptr && this->systemToken_ == nullptr; };
    ...
    inline string getProcessData() const { DARABONBA_PTR_GET_DEFAULT(processData_, "") };
  ...
  protected:
    ...
    shared_ptr<string> processData_ {};
