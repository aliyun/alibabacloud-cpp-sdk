...
namespace Models
{
  ...
  public:
    ...
    inline const InsertRowsBeforeRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, InsertRowsBeforeRequest::TenantContext) };
    inline InsertRowsBeforeRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, InsertRowsBeforeRequest::TenantContext) };
    inline InsertRowsBeforeRequest& setTenantContext(const InsertRowsBeforeRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline InsertRowsBeforeRequest& setTenantContext(InsertRowsBeforeRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<InsertRowsBeforeRequest::TenantContext> tenantContext_ {};
    // This parameter is required.
