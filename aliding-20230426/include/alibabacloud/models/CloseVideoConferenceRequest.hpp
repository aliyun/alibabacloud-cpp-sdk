...
namespace Models
{
  ...
  public:
    ...
    inline const CloseVideoConferenceRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, CloseVideoConferenceRequest::TenantContext) };
    inline CloseVideoConferenceRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, CloseVideoConferenceRequest::TenantContext) };
    inline CloseVideoConferenceRequest& setTenantContext(const CloseVideoConferenceRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline CloseVideoConferenceRequest& setTenantContext(CloseVideoConferenceRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    shared_ptr<CloseVideoConferenceRequest::TenantContext> tenantContext_ {};
