...
namespace Models
{
  ...
  public:
    ...
    inline const StartCloudRecordHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, StartCloudRecordHeaders::AccountContext) };
    inline StartCloudRecordHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, StartCloudRecordHeaders::AccountContext) };
    inline StartCloudRecordHeaders& setAccountContext(const StartCloudRecordHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline StartCloudRecordHeaders& setAccountContext(StartCloudRecordHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<StartCloudRecordHeaders::AccountContext> accountContext_ {};
  };
