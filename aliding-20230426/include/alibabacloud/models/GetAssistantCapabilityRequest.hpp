...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->assistantId_ != nullptr
        && this->messages_ != nullptr && this->originalAssistantId_ != nullptr && this->protocol_ != nullptr && this->sourceIdOfOriginalAssistantId_ != nullptr && this->sourceTypeOfOriginalAssistantId_ != nullptr
        && this->threadId_ != nullptr && this->timeout_ != nullptr; };
