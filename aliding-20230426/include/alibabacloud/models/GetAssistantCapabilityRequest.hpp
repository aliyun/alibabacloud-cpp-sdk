...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->cardTemplateId_ == nullptr && this->cardUpdateOptions_ == nullptr && this->dynamicDataSourceConfigs_ == nullptr && this->privateData_ == nullptr; };
          ...
          inline           const Darabonba::Json & getPrivateData() const { DARABONBA_GET(privateData_) };
          Darabonba::Json & getPrivateData() { DARABONBA_GET(privateData_) };
          inline DingNormalCard& setPrivateData(const Darabonba::Json & privateData) { DARABONBA_SET_VALUE(privateData_, privateData) };
          inline DingNormalCard& setPrivateData(Darabonba::Json && privateData) { DARABONBA_SET_RVALUE(privateData_, privateData) };
    ...
    virtual bool empty() const override { return this->assistantId_ == nullptr
        && this->extLoginUser_ == nullptr && this->messages_ == nullptr && this->originalAssistantId_ == nullptr && this->protocol_ == nullptr && this->sourceIdOfOriginalAssistantId_ == nullptr
        && this->sourceTypeOfOriginalAssistantId_ == nullptr && this->threadId_ == nullptr && this->timeout_ == nullptr; };
    ...
    inline const GetAssistantCapabilityRequest::ExtLoginUser & getExtLoginUser() const { DARABONBA_PTR_GET_CONST(extLoginUser_, GetAssistantCapabilityRequest::ExtLoginUser) };
    inline GetAssistantCapabilityRequest::ExtLoginUser getExtLoginUser() { DARABONBA_PTR_GET(extLoginUser_, GetAssistantCapabilityRequest::ExtLoginUser) };
    inline GetAssistantCapabilityRequest& setExtLoginUser(const GetAssistantCapabilityRequest::ExtLoginUser & extLoginUser) { DARABONBA_PTR_SET_VALUE(extLoginUser_, extLoginUser) };
    inline GetAssistantCapabilityRequest& setExtLoginUser(GetAssistantCapabilityRequest::ExtLoginUser && extLoginUser) { DARABONBA_PTR_SET_RVALUE(extLoginUser_, extLoginUser) };


    // messages Field Functions 
    bool hasMessages() const { return this->messages_ != nullptr;};
    void deleteMessages() { this->messages_ = nullptr;};
    inline const vector<GetAssistantCapabilityRequest::Messages> & getMessages() const { DARABONBA_PTR_GET_CONST(messages_, vector<GetAssistantCapabilityRequest::Messages>) };
    inline vector<GetAssistantCapabilityRequest::Messages> getMessages() { DARABONBA_PTR_GET(messages_, vector<GetAssistantCapabilityRequest::Messages>) };
    inline GetAssistantCapabilityRequest& setMessages(const vector<GetAssistantCapabilityRequest::Messages> & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline GetAssistantCapabilityRequest& setMessages(vector<GetAssistantCapabilityRequest::Messages> && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
  ...
  protected:
    ...
    shared_ptr<GetAssistantCapabilityRequest::ExtLoginUser> extLoginUser_ {};
    // This parameter is required.
    shared_ptr<vector<GetAssistantCapabilityRequest::Messages>> messages_ {};
