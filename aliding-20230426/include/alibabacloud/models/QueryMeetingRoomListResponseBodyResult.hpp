...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->corpId_ == nullptr
        && return this->isvRoomId_ == nullptr && return this->roomCapacity_ == nullptr && return this->roomGroup_ == nullptr && return this->roomId_ == nullptr && return this->roomLabels_ == nullptr
        && return this->roomLocation_ == nullptr && return this->roomName_ == nullptr && return this->roomPicture_ == nullptr && return this->roomStaffId_ == nullptr && return this->roomStatus_ == nullptr; };
