...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocContentTakIdHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetDocContentTakIdHeaders::AccountContext) };
    inline GetDocContentTakIdHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetDocContentTakIdHeaders::AccountContext) };
    inline GetDocContentTakIdHeaders& setAccountContext(const GetDocContentTakIdHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetDocContentTakIdHeaders& setAccountContext(GetDocContentTakIdHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetDocContentTakIdHeaders::AccountContext> accountContext_ {};
  };
