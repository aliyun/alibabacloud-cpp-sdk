...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->appType_ != nullptr
        ...
        && this->language_ != nullptr && this->modifiedFromTimeGMT_ != nullptr && this->modifiedToTimeGMT_ != nullptr && this->orderConfigJson_ != nullptr && this->originatorId_ != nullptr
        && this->pageNumber_ != nullptr && this->pageSize_ != nullptr && this->searchFieldJson_ != nullptr && this->systemToken_ != nullptr && this->taskId_ != nullptr; };
