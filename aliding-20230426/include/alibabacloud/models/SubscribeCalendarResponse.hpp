...
namespace Models
{
  ...
  public:
    ...
    inline const SubscribeCalendarResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubscribeCalendarResponseBody) };
    inline SubscribeCalendarResponseBody getBody() { DARABONBA_PTR_GET(body_, SubscribeCalendarResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubscribeCalendarResponseBody> body_ {};
  };
