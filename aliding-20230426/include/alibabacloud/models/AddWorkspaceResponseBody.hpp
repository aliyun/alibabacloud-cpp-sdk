...
namespace Models
{
  ...
  public:
    ...
    inline const AddWorkspaceResponseBody::Workspace & getWorkspace() const { DARABONBA_PTR_GET_CONST(workspace_, AddWorkspaceResponseBody::Workspace) };
    inline AddWorkspaceResponseBody::Workspace getWorkspace() { DARABONBA_PTR_GET(workspace_, AddWorkspaceResponseBody::Workspace) };
    inline AddWorkspaceResponseBody& setWorkspace(const AddWorkspaceResponseBody::Workspace & workspace) { DARABONBA_PTR_SET_VALUE(workspace_, workspace) };
    inline AddWorkspaceResponseBody& setWorkspace(AddWorkspaceResponseBody::Workspace && workspace) { DARABONBA_PTR_SET_RVALUE(workspace_, workspace) };


  protected:
    // requestId
    shared_ptr<string> requestId_ {};
    shared_ptr<AddWorkspaceResponseBody::Workspace> workspace_ {};
  };
