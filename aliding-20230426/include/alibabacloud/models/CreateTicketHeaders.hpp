...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTicketHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateTicketHeaders::AccountContext) };
    inline CreateTicketHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateTicketHeaders::AccountContext) };
    inline CreateTicketHeaders& setAccountContext(const CreateTicketHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateTicketHeaders& setAccountContext(CreateTicketHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateTicketHeaders::AccountContext> accountContext_ {};
  };
