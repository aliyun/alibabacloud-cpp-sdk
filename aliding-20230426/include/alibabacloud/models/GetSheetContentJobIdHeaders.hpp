...
namespace Models
{
  ...
  public:
    ...
    inline const GetSheetContentJobIdHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetSheetContentJobIdHeaders::AccountContext) };
    inline GetSheetContentJobIdHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetSheetContentJobIdHeaders::AccountContext) };
    inline GetSheetContentJobIdHeaders& setAccountContext(const GetSheetContentJobIdHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetSheetContentJobIdHeaders& setAccountContext(GetSheetContentJobIdHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetSheetContentJobIdHeaders::AccountContext> accountContext_ {};
  };
