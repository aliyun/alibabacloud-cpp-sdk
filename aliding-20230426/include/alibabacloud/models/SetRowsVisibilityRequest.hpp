...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->row_ == nullptr
        && return this->rowCount_ == nullptr && return this->sheetId_ == nullptr && return this->tenantContext_ == nullptr && return this->visibility_ == nullptr && return this->workbookId_ == nullptr; };
    // row Field Functions 
