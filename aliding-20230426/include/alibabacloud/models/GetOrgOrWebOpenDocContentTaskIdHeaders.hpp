...
namespace Models
{
  ...
  public:
    ...
    inline const GetOrgOrWebOpenDocContentTaskIdHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetOrgOrWebOpenDocContentTaskIdHeaders::AccountContext) };
    inline GetOrgOrWebOpenDocContentTaskIdHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetOrgOrWebOpenDocContentTaskIdHeaders::AccountContext) };
    inline GetOrgOrWebOpenDocContentTaskIdHeaders& setAccountContext(const GetOrgOrWebOpenDocContentTaskIdHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetOrgOrWebOpenDocContentTaskIdHeaders& setAccountContext(GetOrgOrWebOpenDocContentTaskIdHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetOrgOrWebOpenDocContentTaskIdHeaders::AccountContext> accountContext_ {};
  };
