...
namespace Models
{
  ...
  public:
    ...
    inline const GetSheetRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, GetSheetRequest::TenantContext) };
    inline GetSheetRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, GetSheetRequest::TenantContext) };
    inline GetSheetRequest& setTenantContext(const GetSheetRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline GetSheetRequest& setTenantContext(GetSheetRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<GetSheetRequest::TenantContext> tenantContext_ {};
    // This parameter is required.
