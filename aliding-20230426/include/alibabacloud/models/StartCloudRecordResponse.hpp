...
namespace Models
{
  ...
  public:
    ...
    inline const StartCloudRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartCloudRecordResponseBody) };
    inline StartCloudRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, StartCloudRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartCloudRecordResponseBody> body_ {};
  };
