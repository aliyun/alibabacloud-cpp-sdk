...
#ifndef ALIBABACLOUD_MODELS_ASSIGNTICKETREQUESTNOTIFY_HPP_
#define ALIBABACLOUD_MODELS_ASSIGNTICKETREQUESTNOTIFY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AssignTicketRequestNotify& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AssignTicketRequestNotify& obj) { 
    ...
    AssignTicketRequestNotify() = default ;
    AssignTicketRequestNotify(const AssignTicketRequestNotify &) = default ;
    AssignTicketRequestNotify(AssignTicketRequestNotify &&) = default ;
    AssignTicketRequestNotify(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AssignTicketRequestNotify() = default ;
    AssignTicketRequestNotify& operator=(const AssignTicketRequestNotify &) = default ;
    AssignTicketRequestNotify& operator=(AssignTicketRequestNotify &&) = default ;
    ...
    inline AssignTicketRequestNotify& setGroupNoticeReceiverUserIds(const vector<string> & groupNoticeReceiverUserIds) { DARABONBA_PTR_SET_VALUE(groupNoticeReceiverUserIds_, groupNoticeReceiverUserIds) };
    inline AssignTicketRequestNotify& setGroupNoticeReceiverUserIds(vector<string> && groupNoticeReceiverUserIds) { DARABONBA_PTR_SET_RVALUE(groupNoticeReceiverUserIds_, groupNoticeReceiverUserIds) };
    ...
    inline AssignTicketRequestNotify& setNoticeAllGroupMember(bool noticeAllGroupMember) { DARABONBA_PTR_SET_VALUE(noticeAllGroupMember_, noticeAllGroupMember) };
    ...
    inline AssignTicketRequestNotify& setWorkNoticeReceiverUserIds(const vector<string> & workNoticeReceiverUserIds) { DARABONBA_PTR_SET_VALUE(workNoticeReceiverUserIds_, workNoticeReceiverUserIds) };
    inline AssignTicketRequestNotify& setWorkNoticeReceiverUserIds(vector<string> && workNoticeReceiverUserIds) { DARABONBA_PTR_SET_RVALUE(workNoticeReceiverUserIds_, workNoticeReceiverUserIds) };
