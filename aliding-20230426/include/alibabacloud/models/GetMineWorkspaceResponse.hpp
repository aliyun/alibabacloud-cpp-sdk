...
namespace Models
{
  ...
  public:
    ...
    inline const GetMineWorkspaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMineWorkspaceResponseBody) };
    inline GetMineWorkspaceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMineWorkspaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMineWorkspaceResponseBody> body_ {};
  };
