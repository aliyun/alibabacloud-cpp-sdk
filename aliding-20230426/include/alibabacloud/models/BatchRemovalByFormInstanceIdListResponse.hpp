...
namespace Models
{
  ...
  public:
    ...
    inline const BatchRemovalByFormInstanceIdListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchRemovalByFormInstanceIdListResponseBody) };
    inline BatchRemovalByFormInstanceIdListResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchRemovalByFormInstanceIdListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchRemovalByFormInstanceIdListResponseBody> body_ {};
  };
