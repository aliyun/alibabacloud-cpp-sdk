...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkspacesHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, ListWorkspacesHeaders::AccountContext) };
    inline ListWorkspacesHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, ListWorkspacesHeaders::AccountContext) };
    inline ListWorkspacesHeaders& setAccountContext(const ListWorkspacesHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline ListWorkspacesHeaders& setAccountContext(ListWorkspacesHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<ListWorkspacesHeaders::AccountContext> accountContext_ {};
  };
