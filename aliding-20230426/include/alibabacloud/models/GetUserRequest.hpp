...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, GetUserRequest::TenantContext) };
    inline GetUserRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, GetUserRequest::TenantContext) };
    inline GetUserRequest& setTenantContext(const GetUserRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline GetUserRequest& setTenantContext(GetUserRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    shared_ptr<GetUserRequest::TenantContext> tenantContext_ {};
