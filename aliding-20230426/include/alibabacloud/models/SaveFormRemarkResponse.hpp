...
namespace Models
{
  ...
  public:
    ...
    inline const SaveFormRemarkResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SaveFormRemarkResponseBody) };
    inline SaveFormRemarkResponseBody body() { DARABONBA_PTR_GET(body_, SaveFormRemarkResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SaveFormRemarkResponseBody> body_ = nullptr;
  };
