...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->assistantId_ == nullptr
        && this->extLoginUser_ == nullptr && this->messages_ == nullptr && this->originalAssistantId_ == nullptr && this->sourceIdOfAssistantId_ == nullptr && this->sourceIdOfOriginalAssistantId_ == nullptr
        && this->sourceTypeOfAssistantId_ == nullptr && this->sourceTypeOfOriginalAssistantId_ == nullptr && this->threadId_ == nullptr; };
    ...
    inline const CreateMessageRequest::ExtLoginUser & getExtLoginUser() const { DARABONBA_PTR_GET_CONST(extLoginUser_, CreateMessageRequest::ExtLoginUser) };
    inline CreateMessageRequest::ExtLoginUser getExtLoginUser() { DARABONBA_PTR_GET(extLoginUser_, CreateMessageRequest::ExtLoginUser) };
    inline CreateMessageRequest& setExtLoginUser(const CreateMessageRequest::ExtLoginUser & extLoginUser) { DARABONBA_PTR_SET_VALUE(extLoginUser_, extLoginUser) };
    inline CreateMessageRequest& setExtLoginUser(CreateMessageRequest::ExtLoginUser && extLoginUser) { DARABONBA_PTR_SET_RVALUE(extLoginUser_, extLoginUser) };


    // messages Field Functions 
    bool hasMessages() const { return this->messages_ != nullptr;};
    void deleteMessages() { this->messages_ = nullptr;};
    inline const vector<CreateMessageRequest::Messages> & getMessages() const { DARABONBA_PTR_GET_CONST(messages_, vector<CreateMessageRequest::Messages>) };
    inline vector<CreateMessageRequest::Messages> getMessages() { DARABONBA_PTR_GET(messages_, vector<CreateMessageRequest::Messages>) };
    inline CreateMessageRequest& setMessages(const vector<CreateMessageRequest::Messages> & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline CreateMessageRequest& setMessages(vector<CreateMessageRequest::Messages> && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
    ...
    inline CreateMessageRequest& setSourceIdOfAssistantId(string sourceIdOfAssistantId) { DARABONBA_PTR_SET_VALUE(sourceIdOfAssistantId_, sourceIdOfAssistantId) };
    ...
    inline CreateMessageRequest& setSourceTypeOfAssistantId(int32_t sourceTypeOfAssistantId) { DARABONBA_PTR_SET_VALUE(sourceTypeOfAssistantId_, sourceTypeOfAssistantId) };
    ...
    inline CreateMessageRequest& setSourceTypeOfOriginalAssistantId(int32_t sourceTypeOfOriginalAssistantId) { DARABONBA_PTR_SET_VALUE(sourceTypeOfOriginalAssistantId_, sourceTypeOfOriginalAssistantId) };
  ...
  protected:
    ...
    shared_ptr<CreateMessageRequest::ExtLoginUser> extLoginUser_ {};
    // This parameter is required.
    shared_ptr<vector<CreateMessageRequest::Messages>> messages_ {};
