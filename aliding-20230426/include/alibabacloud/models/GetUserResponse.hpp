...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetUserResponseBody) };
    inline GetUserResponseBody body() { DARABONBA_PTR_GET(body_, GetUserResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetUserResponseBody> body_ = nullptr;
  };
