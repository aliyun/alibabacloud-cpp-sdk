...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actionExecutor_ == nullptr
        && return this->approvedResult_ == nullptr && return this->data_ == nullptr && return this->formUuid_ == nullptr && return this->instanceStatus_ == nullptr && return this->originator_ == nullptr
        && return this->processCode_ == nullptr && return this->processInstanceId_ == nullptr && return this->title_ == nullptr; };
