...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTodoTaskExecutorStatusHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateTodoTaskExecutorStatusHeaders::AccountContext) };
    inline UpdateTodoTaskExecutorStatusHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateTodoTaskExecutorStatusHeaders::AccountContext) };
    inline UpdateTodoTaskExecutorStatusHeaders& setAccountContext(const UpdateTodoTaskExecutorStatusHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateTodoTaskExecutorStatusHeaders& setAccountContext(UpdateTodoTaskExecutorStatusHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateTodoTaskExecutorStatusHeaders::AccountContext> accountContext_ {};
  };
