...
#ifndef ALIBABACLOUD_MODELS_DELETEROWSSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETEROWSSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteRowsShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeleteRowsShrinkRequest& obj) { 
    ...
    DeleteRowsShrinkRequest() = default ;
    DeleteRowsShrinkRequest(const DeleteRowsShrinkRequest &) = default ;
    DeleteRowsShrinkRequest(DeleteRowsShrinkRequest &&) = default ;
    DeleteRowsShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteRowsShrinkRequest() = default ;
    DeleteRowsShrinkRequest& operator=(const DeleteRowsShrinkRequest &) = default ;
    DeleteRowsShrinkRequest& operator=(DeleteRowsShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->row_ == nullptr
        && return this->rowCount_ == nullptr && return this->sheetId_ == nullptr && return this->tenantContextShrink_ == nullptr && return this->workbookId_ == nullptr; };
    // row Field Functions 
    ...
    inline DeleteRowsShrinkRequest& setRow(int64_t row) { DARABONBA_PTR_SET_VALUE(row_, row) };
    ...
    inline DeleteRowsShrinkRequest& setRowCount(int64_t rowCount) { DARABONBA_PTR_SET_VALUE(rowCount_, rowCount) };
    ...
    inline DeleteRowsShrinkRequest& setSheetId(string sheetId) { DARABONBA_PTR_SET_VALUE(sheetId_, sheetId) };
    ...
    inline DeleteRowsShrinkRequest& setTenantContextShrink(string tenantContextShrink) { DARABONBA_PTR_SET_VALUE(tenantContextShrink_, tenantContextShrink) };
    ...
    inline DeleteRowsShrinkRequest& setWorkbookId(string workbookId) { DARABONBA_PTR_SET_VALUE(workbookId_, workbookId) };
