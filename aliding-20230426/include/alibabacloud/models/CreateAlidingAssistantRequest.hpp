...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appCode_ == nullptr
        && this->description_ == nullptr && this->ext_ == nullptr && this->icon_ == nullptr && this->instructions_ == nullptr && this->name_ == nullptr
        && this->recommendPrompts_ == nullptr && this->source_ == nullptr && this->sourceIdentityId_ == nullptr && this->tenantContext_ == nullptr && this->welcomeContent_ == nullptr; };
    ...
    inline const CreateAlidingAssistantRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, CreateAlidingAssistantRequest::TenantContext) };
    inline CreateAlidingAssistantRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, CreateAlidingAssistantRequest::TenantContext) };
    inline CreateAlidingAssistantRequest& setTenantContext(const CreateAlidingAssistantRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline CreateAlidingAssistantRequest& setTenantContext(CreateAlidingAssistantRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<CreateAlidingAssistantRequest::TenantContext> tenantContext_ {};
    // This parameter is required.
