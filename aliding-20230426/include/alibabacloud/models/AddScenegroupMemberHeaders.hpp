...
namespace Models
{
  ...
  public:
    ...
    inline const AddScenegroupMemberHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, AddScenegroupMemberHeaders::AccountContext) };
    inline AddScenegroupMemberHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, AddScenegroupMemberHeaders::AccountContext) };
    inline AddScenegroupMemberHeaders& setAccountContext(const AddScenegroupMemberHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline AddScenegroupMemberHeaders& setAccountContext(AddScenegroupMemberHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<AddScenegroupMemberHeaders::AccountContext> accountContext_ {};
  };
