...
namespace Models
{
  ...
  public:
    ...
    inline const DocBlocksDeleteResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DocBlocksDeleteResponseBody) };
    inline DocBlocksDeleteResponseBody body() { DARABONBA_PTR_GET(body_, DocBlocksDeleteResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DocBlocksDeleteResponseBody> body_ = nullptr;
  };
