...
namespace Models
{
  ...
  public:
    ...
    inline const ListApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApplicationResponseBody) };
    inline ListApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApplicationResponseBody> body_ {};
  };
