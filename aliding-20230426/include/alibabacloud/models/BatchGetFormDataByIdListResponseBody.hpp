...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchGetFormDataByIdListResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<BatchGetFormDataByIdListResponseBodyResult>) };
    inline vector<BatchGetFormDataByIdListResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<BatchGetFormDataByIdListResponseBodyResult>) };
    inline BatchGetFormDataByIdListResponseBody& setResult(const vector<BatchGetFormDataByIdListResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline BatchGetFormDataByIdListResponseBody& setResult(vector<BatchGetFormDataByIdListResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<BatchGetFormDataByIdListResponseBodyResult>> result_ = nullptr;
