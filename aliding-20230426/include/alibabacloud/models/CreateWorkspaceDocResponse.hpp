...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWorkspaceDocResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateWorkspaceDocResponseBody) };
    inline CreateWorkspaceDocResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateWorkspaceDocResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateWorkspaceDocResponseBody> body_ {};
  };
