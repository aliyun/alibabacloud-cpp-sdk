...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetRunningTasksResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<GetRunningTasksResponseBodyResult>) };
    inline vector<GetRunningTasksResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<GetRunningTasksResponseBodyResult>) };
    inline GetRunningTasksResponseBody& setResult(const vector<GetRunningTasksResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetRunningTasksResponseBody& setResult(vector<GetRunningTasksResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetRunningTasksResponseBodyResult>> result_ = nullptr;
