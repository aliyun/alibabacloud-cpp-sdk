...
namespace Models
{
  ...
  public:
    ...
    inline const UploadMediaHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UploadMediaHeaders::AccountContext) };
    inline UploadMediaHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UploadMediaHeaders::AccountContext) };
    inline UploadMediaHeaders& setAccountContext(const UploadMediaHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UploadMediaHeaders& setAccountContext(UploadMediaHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UploadMediaHeaders::AccountContext> accountContext_ {};
  };
