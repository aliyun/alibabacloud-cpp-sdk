...
namespace Models
{
  ...
  public:
    ...
    inline const ListDentriesHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, ListDentriesHeaders::AccountContext) };
    inline ListDentriesHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, ListDentriesHeaders::AccountContext) };
    inline ListDentriesHeaders& setAccountContext(const ListDentriesHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline ListDentriesHeaders& setAccountContext(ListDentriesHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<ListDentriesHeaders::AccountContext> accountContext_ {};
  };
