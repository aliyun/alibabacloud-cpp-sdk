...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMinutesTextHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryMinutesTextHeaders::AccountContext) };
    inline QueryMinutesTextHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryMinutesTextHeaders::AccountContext) };
    inline QueryMinutesTextHeaders& setAccountContext(const QueryMinutesTextHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryMinutesTextHeaders& setAccountContext(QueryMinutesTextHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryMinutesTextHeaders::AccountContext> accountContext_ {};
  };
