...
namespace Models
{
  ...
  public:
    ...
    inline const GetRunningTasksHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetRunningTasksHeaders::AccountContext) };
    inline GetRunningTasksHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetRunningTasksHeaders::AccountContext) };
    inline GetRunningTasksHeaders& setAccountContext(const GetRunningTasksHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetRunningTasksHeaders& setAccountContext(GetRunningTasksHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetRunningTasksHeaders::AccountContext> accountContext_ {};
  };
