...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSubscribedCalendarHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateSubscribedCalendarHeaders::AccountContext) };
    inline CreateSubscribedCalendarHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateSubscribedCalendarHeaders::AccountContext) };
    inline CreateSubscribedCalendarHeaders& setAccountContext(const CreateSubscribedCalendarHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateSubscribedCalendarHeaders& setAccountContext(CreateSubscribedCalendarHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateSubscribedCalendarHeaders::AccountContext> accountContext_ {};
  };
