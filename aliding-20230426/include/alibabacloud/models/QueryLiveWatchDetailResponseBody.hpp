...
namespace Models
{
  ...
  public:
    ...
    inline int64_t avgWatchTime() const { DARABONBA_PTR_GET_DEFAULT(avgWatchTime_, 0L) };
    ...
    inline int32_t liveUv() const { DARABONBA_PTR_GET_DEFAULT(liveUv_, 0) };
    ...
    inline int32_t msgCount() const { DARABONBA_PTR_GET_DEFAULT(msgCount_, 0) };
    ...
    inline int32_t playbackUv() const { DARABONBA_PTR_GET_DEFAULT(playbackUv_, 0) };
    ...
    inline int32_t praiseCount() const { DARABONBA_PTR_GET_DEFAULT(praiseCount_, 0) };
    ...
    inline int32_t pv() const { DARABONBA_PTR_GET_DEFAULT(pv_, 0) };
    ...
    inline int64_t totalWatchTime() const { DARABONBA_PTR_GET_DEFAULT(totalWatchTime_, 0L) };
  ...
  protected:
    std::shared_ptr<int64_t> avgWatchTime_ = nullptr;
    std::shared_ptr<int32_t> liveUv_ = nullptr;
    std::shared_ptr<int32_t> msgCount_ = nullptr;
    std::shared_ptr<int32_t> playbackUv_ = nullptr;
    std::shared_ptr<int32_t> praiseCount_ = nullptr;
    std::shared_ptr<int32_t> pv_ = nullptr;
    // requestId
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<int64_t> totalWatchTime_ = nullptr;
