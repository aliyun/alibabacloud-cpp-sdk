...
namespace Models
{
  ...
  public:
    ...
    inline const CancelScheduleConferenceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelScheduleConferenceResponseBody) };
    inline CancelScheduleConferenceResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelScheduleConferenceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelScheduleConferenceResponseBody> body_ {};
  };
