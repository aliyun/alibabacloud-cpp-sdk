...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSheetRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, CreateSheetRequest::TenantContext) };
    inline CreateSheetRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, CreateSheetRequest::TenantContext) };
    inline CreateSheetRequest& setTenantContext(const CreateSheetRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline CreateSheetRequest& setTenantContext(CreateSheetRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<CreateSheetRequest::TenantContext> tenantContext_ {};
    // This parameter is required.
