...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDentryHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryDentryHeaders::AccountContext) };
    inline QueryDentryHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryDentryHeaders::AccountContext) };
    inline QueryDentryHeaders& setAccountContext(const QueryDentryHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryDentryHeaders& setAccountContext(QueryDentryHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryDentryHeaders::AccountContext> accountContext_ {};
  };
