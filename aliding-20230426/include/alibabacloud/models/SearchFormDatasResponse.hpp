...
namespace Models
{
  ...
  public:
    ...
    inline const SearchFormDatasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchFormDatasResponseBody) };
    inline SearchFormDatasResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchFormDatasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchFormDatasResponseBody> body_ {};
  };
