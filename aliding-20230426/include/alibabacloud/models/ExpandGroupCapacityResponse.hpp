...
namespace Models
{
  ...
  public:
    ...
    inline const ExpandGroupCapacityResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ExpandGroupCapacityResponseBody) };
    inline ExpandGroupCapacityResponseBody body() { DARABONBA_PTR_GET(body_, ExpandGroupCapacityResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ExpandGroupCapacityResponseBody> body_ = nullptr;
  };
