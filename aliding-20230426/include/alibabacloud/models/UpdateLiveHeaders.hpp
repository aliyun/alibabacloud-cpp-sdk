...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLiveHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateLiveHeaders::AccountContext) };
    inline UpdateLiveHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateLiveHeaders::AccountContext) };
    inline UpdateLiveHeaders& setAccountContext(const UpdateLiveHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateLiveHeaders& setAccountContext(UpdateLiveHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateLiveHeaders::AccountContext> accountContext_ {};
  };
