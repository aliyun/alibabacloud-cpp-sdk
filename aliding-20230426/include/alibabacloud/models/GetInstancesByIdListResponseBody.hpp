...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetInstancesByIdListResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<GetInstancesByIdListResponseBodyResult>) };
    inline vector<GetInstancesByIdListResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<GetInstancesByIdListResponseBodyResult>) };
    inline GetInstancesByIdListResponseBody& setResult(const vector<GetInstancesByIdListResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetInstancesByIdListResponseBody& setResult(vector<GetInstancesByIdListResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetInstancesByIdListResponseBodyResult>> result_ = nullptr;
