...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserIdHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetUserIdHeaders::AccountContext) };
    inline GetUserIdHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetUserIdHeaders::AccountContext) };
    inline GetUserIdHeaders& setAccountContext(const GetUserIdHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetUserIdHeaders& setAccountContext(GetUserIdHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetUserIdHeaders::AccountContext> accountContext_ {};
  };
