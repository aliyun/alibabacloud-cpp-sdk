...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAlidingAssistantRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, DeleteAlidingAssistantRequest::TenantContext) };
    inline DeleteAlidingAssistantRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, DeleteAlidingAssistantRequest::TenantContext) };
    inline DeleteAlidingAssistantRequest& setTenantContext(const DeleteAlidingAssistantRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline DeleteAlidingAssistantRequest& setTenantContext(DeleteAlidingAssistantRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };


  protected:
    // This parameter is required.
    shared_ptr<string> assistantId_ {};
    shared_ptr<DeleteAlidingAssistantRequest::TenantContext> tenantContext_ {};
  };
