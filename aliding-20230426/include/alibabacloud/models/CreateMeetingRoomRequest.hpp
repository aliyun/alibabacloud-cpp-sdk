...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMeetingRoomRequest::ReservationAuthority & getReservationAuthority() const { DARABONBA_PTR_GET_CONST(reservationAuthority_, CreateMeetingRoomRequest::ReservationAuthority) };
    inline CreateMeetingRoomRequest::ReservationAuthority getReservationAuthority() { DARABONBA_PTR_GET(reservationAuthority_, CreateMeetingRoomRequest::ReservationAuthority) };
    inline CreateMeetingRoomRequest& setReservationAuthority(const CreateMeetingRoomRequest::ReservationAuthority & reservationAuthority) { DARABONBA_PTR_SET_VALUE(reservationAuthority_, reservationAuthority) };
    inline CreateMeetingRoomRequest& setReservationAuthority(CreateMeetingRoomRequest::ReservationAuthority && reservationAuthority) { DARABONBA_PTR_SET_RVALUE(reservationAuthority_, reservationAuthority) };
    ...
    inline const CreateMeetingRoomRequest::RoomLocation & getRoomLocation() const { DARABONBA_PTR_GET_CONST(roomLocation_, CreateMeetingRoomRequest::RoomLocation) };
    inline CreateMeetingRoomRequest::RoomLocation getRoomLocation() { DARABONBA_PTR_GET(roomLocation_, CreateMeetingRoomRequest::RoomLocation) };
    inline CreateMeetingRoomRequest& setRoomLocation(const CreateMeetingRoomRequest::RoomLocation & roomLocation) { DARABONBA_PTR_SET_VALUE(roomLocation_, roomLocation) };
    inline CreateMeetingRoomRequest& setRoomLocation(CreateMeetingRoomRequest::RoomLocation && roomLocation) { DARABONBA_PTR_SET_RVALUE(roomLocation_, roomLocation) };
    ...
    inline const CreateMeetingRoomRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, CreateMeetingRoomRequest::TenantContext) };
    inline CreateMeetingRoomRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, CreateMeetingRoomRequest::TenantContext) };
    inline CreateMeetingRoomRequest& setTenantContext(const CreateMeetingRoomRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline CreateMeetingRoomRequest& setTenantContext(CreateMeetingRoomRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<CreateMeetingRoomRequest::ReservationAuthority> reservationAuthority_ {};
    shared_ptr<int32_t> roomCapacity_ {};
    shared_ptr<vector<int64_t>> roomLabelIds_ {};
    shared_ptr<CreateMeetingRoomRequest::RoomLocation> roomLocation_ {};
    shared_ptr<string> roomName_ {};
    shared_ptr<string> roomPicture_ {};
    shared_ptr<int32_t> roomStatus_ {};
    shared_ptr<CreateMeetingRoomRequest::TenantContext> tenantContext_ {};
  };
