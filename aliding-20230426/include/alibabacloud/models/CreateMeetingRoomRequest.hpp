...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->enableCycleReservation_ == nullptr
        && return this->groupId_ == nullptr && return this->isvRoomId_ == nullptr && return this->reservationAuthority_ == nullptr && return this->roomCapacity_ == nullptr && return this->roomLabelIds_ == nullptr
        && return this->roomLocation_ == nullptr && return this->roomName_ == nullptr && return this->roomPicture_ == nullptr && return this->roomStatus_ == nullptr && return this->tenantContext_ == nullptr; };
