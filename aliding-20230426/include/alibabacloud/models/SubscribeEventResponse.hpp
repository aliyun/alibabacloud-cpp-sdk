...
namespace Models
{
  ...
  public:
    ...
    inline const SubscribeEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubscribeEventResponseBody) };
    inline SubscribeEventResponseBody getBody() { DARABONBA_PTR_GET(body_, SubscribeEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubscribeEventResponseBody> body_ {};
  };
