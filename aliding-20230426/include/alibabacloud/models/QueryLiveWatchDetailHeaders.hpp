...
namespace Models
{
  ...
  public:
    ...
    inline const QueryLiveWatchDetailHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryLiveWatchDetailHeaders::AccountContext) };
    inline QueryLiveWatchDetailHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryLiveWatchDetailHeaders::AccountContext) };
    inline QueryLiveWatchDetailHeaders& setAccountContext(const QueryLiveWatchDetailHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryLiveWatchDetailHeaders& setAccountContext(QueryLiveWatchDetailHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryLiveWatchDetailHeaders::AccountContext> accountContext_ {};
  };
