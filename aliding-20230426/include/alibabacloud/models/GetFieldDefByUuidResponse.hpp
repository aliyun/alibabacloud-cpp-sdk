...
namespace Models
{
  ...
  public:
    ...
    inline const GetFieldDefByUuidResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetFieldDefByUuidResponseBody) };
    inline GetFieldDefByUuidResponseBody getBody() { DARABONBA_PTR_GET(body_, GetFieldDefByUuidResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetFieldDefByUuidResponseBody> body_ {};
  };
