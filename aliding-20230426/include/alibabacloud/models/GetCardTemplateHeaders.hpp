...
namespace Models
{
  ...
  public:
    ...
    inline const GetCardTemplateHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetCardTemplateHeaders::AccountContext) };
    inline GetCardTemplateHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetCardTemplateHeaders::AccountContext) };
    inline GetCardTemplateHeaders& setAccountContext(const GetCardTemplateHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetCardTemplateHeaders& setAccountContext(GetCardTemplateHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetCardTemplateHeaders::AccountContext> accountContext_ {};
  };
