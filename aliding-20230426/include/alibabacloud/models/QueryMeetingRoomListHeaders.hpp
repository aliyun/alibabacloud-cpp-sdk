...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMeetingRoomListHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryMeetingRoomListHeaders::AccountContext) };
    inline QueryMeetingRoomListHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryMeetingRoomListHeaders::AccountContext) };
    inline QueryMeetingRoomListHeaders& setAccountContext(const QueryMeetingRoomListHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryMeetingRoomListHeaders& setAccountContext(QueryMeetingRoomListHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryMeetingRoomListHeaders::AccountContext> accountContext_ {};
  };
