...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateStatusResponseBody) };
    inline UpdateStatusResponseBody body() { DARABONBA_PTR_GET(body_, UpdateStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateStatusResponseBody> body_ = nullptr;
  };
