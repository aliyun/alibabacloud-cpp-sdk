...
namespace Models
{
  ...
  public:
    ...
    inline const RecallHonorResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, RecallHonorResponseBodyContent) };
    inline RecallHonorResponseBodyContent content() { DARABONBA_PTR_GET(content_, RecallHonorResponseBodyContent) };
    inline RecallHonorResponseBody& setContent(const RecallHonorResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline RecallHonorResponseBody& setContent(RecallHonorResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    std::shared_ptr<RecallHonorResponseBodyContent> content_ = nullptr;
