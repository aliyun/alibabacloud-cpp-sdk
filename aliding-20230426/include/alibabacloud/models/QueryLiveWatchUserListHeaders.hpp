...
namespace Models
{
  ...
  public:
    ...
    inline const QueryLiveWatchUserListHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryLiveWatchUserListHeaders::AccountContext) };
    inline QueryLiveWatchUserListHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryLiveWatchUserListHeaders::AccountContext) };
    inline QueryLiveWatchUserListHeaders& setAccountContext(const QueryLiveWatchUserListHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryLiveWatchUserListHeaders& setAccountContext(QueryLiveWatchUserListHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryLiveWatchUserListHeaders::AccountContext> accountContext_ {};
  };
