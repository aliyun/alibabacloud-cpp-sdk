...
namespace Models
{
  ...
  public:
    ...
    inline const GetSubscribedCalendarResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSubscribedCalendarResponseBody) };
    inline GetSubscribedCalendarResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSubscribedCalendarResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSubscribedCalendarResponseBody> body_ {};
  };
