...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->coverUrl_ == nullptr
        ...
        && return this->liveStatus_ == nullptr && return this->playbackDuration_ == nullptr && return this->replayUrl_ == nullptr && return this->requestId_ == nullptr && return this->staffId_ == nullptr
        && return this->startTime_ == nullptr && return this->subscribeCount_ == nullptr && return this->title_ == nullptr && return this->uv_ == nullptr && return this->vendorRequestId_ == nullptr
