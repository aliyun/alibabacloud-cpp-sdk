...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteBatchTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecuteBatchTaskResponseBody) };
    inline ExecuteBatchTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecuteBatchTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecuteBatchTaskResponseBody> body_ {};
  };
