...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteScenegroupMemberHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteScenegroupMemberHeaders::AccountContext) };
    inline DeleteScenegroupMemberHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteScenegroupMemberHeaders::AccountContext) };
    inline DeleteScenegroupMemberHeaders& setAccountContext(const DeleteScenegroupMemberHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteScenegroupMemberHeaders& setAccountContext(DeleteScenegroupMemberHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DeleteScenegroupMemberHeaders::AccountContext> accountContext_ {};
  };
