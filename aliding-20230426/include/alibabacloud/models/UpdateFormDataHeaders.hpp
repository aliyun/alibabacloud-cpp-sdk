...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFormDataHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateFormDataHeaders::AccountContext) };
    inline UpdateFormDataHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateFormDataHeaders::AccountContext) };
    inline UpdateFormDataHeaders& setAccountContext(const UpdateFormDataHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateFormDataHeaders& setAccountContext(UpdateFormDataHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateFormDataHeaders::AccountContext> accountContext_ {};
  };
