...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMeetingRoomHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteMeetingRoomHeaders::AccountContext) };
    inline DeleteMeetingRoomHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteMeetingRoomHeaders::AccountContext) };
    inline DeleteMeetingRoomHeaders& setAccountContext(const DeleteMeetingRoomHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteMeetingRoomHeaders& setAccountContext(DeleteMeetingRoomHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DeleteMeetingRoomHeaders::AccountContext> accountContext_ {};
  };
