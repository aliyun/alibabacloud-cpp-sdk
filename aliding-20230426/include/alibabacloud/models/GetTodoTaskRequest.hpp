...
namespace Models
{
  ...
  public:
    ...
    inline const GetTodoTaskRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, GetTodoTaskRequest::TenantContext) };
    inline GetTodoTaskRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, GetTodoTaskRequest::TenantContext) };
    inline GetTodoTaskRequest& setTenantContext(const GetTodoTaskRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline GetTodoTaskRequest& setTenantContext(GetTodoTaskRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };


  protected:
    // This parameter is required.
    shared_ptr<string> taskId_ {};
    shared_ptr<GetTodoTaskRequest::TenantContext> tenantContext_ {};
  };
