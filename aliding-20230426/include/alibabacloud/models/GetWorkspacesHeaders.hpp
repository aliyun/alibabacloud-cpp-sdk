...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorkspacesHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetWorkspacesHeaders::AccountContext) };
    inline GetWorkspacesHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetWorkspacesHeaders::AccountContext) };
    inline GetWorkspacesHeaders& setAccountContext(const GetWorkspacesHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetWorkspacesHeaders& setAccountContext(GetWorkspacesHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetWorkspacesHeaders::AccountContext> accountContext_ {};
  };
