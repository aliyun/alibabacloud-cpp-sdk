...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDriveSpaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDriveSpaceResponseBody) };
    inline DeleteDriveSpaceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDriveSpaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDriveSpaceResponseBody> body_ {};
  };
