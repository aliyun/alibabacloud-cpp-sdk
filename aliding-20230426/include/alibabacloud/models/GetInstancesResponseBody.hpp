...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetInstancesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetInstancesResponseBodyData>) };
    inline vector<GetInstancesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetInstancesResponseBodyData>) };
    inline GetInstancesResponseBody& setData(const vector<GetInstancesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInstancesResponseBody& setData(vector<GetInstancesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<GetInstancesResponseBodyData>> data_ = nullptr;
