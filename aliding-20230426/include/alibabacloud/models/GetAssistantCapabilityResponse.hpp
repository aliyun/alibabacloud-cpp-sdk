...
namespace Models
{
  ...
  public:
    ...
    inline const GetAssistantCapabilityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAssistantCapabilityResponseBody) };
    inline GetAssistantCapabilityResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAssistantCapabilityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAssistantCapabilityResponseBody> body_ {};
  };
