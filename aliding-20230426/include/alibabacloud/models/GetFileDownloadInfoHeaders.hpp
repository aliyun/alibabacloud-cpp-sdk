...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileDownloadInfoHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetFileDownloadInfoHeaders::AccountContext) };
    inline GetFileDownloadInfoHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetFileDownloadInfoHeaders::AccountContext) };
    inline GetFileDownloadInfoHeaders& setAccountContext(const GetFileDownloadInfoHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetFileDownloadInfoHeaders& setAccountContext(GetFileDownloadInfoHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetFileDownloadInfoHeaders::AccountContext> accountContext_ {};
  };
