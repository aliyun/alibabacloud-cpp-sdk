...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateConvExtensionHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateConvExtensionHeaders::AccountContext) };
    inline UpdateConvExtensionHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateConvExtensionHeaders::AccountContext) };
    inline UpdateConvExtensionHeaders& setAccountContext(const UpdateConvExtensionHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateConvExtensionHeaders& setAccountContext(UpdateConvExtensionHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateConvExtensionHeaders::AccountContext> accountContext_ {};
  };
