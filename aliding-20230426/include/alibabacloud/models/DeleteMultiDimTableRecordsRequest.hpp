...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMultiDimTableRecordsRequestTenantContext & tenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, DeleteMultiDimTableRecordsRequestTenantContext) };
    inline DeleteMultiDimTableRecordsRequestTenantContext tenantContext() { DARABONBA_PTR_GET(tenantContext_, DeleteMultiDimTableRecordsRequestTenantContext) };
    inline DeleteMultiDimTableRecordsRequest& setTenantContext(const DeleteMultiDimTableRecordsRequestTenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline DeleteMultiDimTableRecordsRequest& setTenantContext(DeleteMultiDimTableRecordsRequestTenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteMultiDimTableRecordsRequestTenantContext> tenantContext_ = nullptr;
  };
