...
namespace Models
{
  ...
  public:
    ...
    inline const GetAlidingAssistantInfoHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetAlidingAssistantInfoHeaders::AccountContext) };
    inline GetAlidingAssistantInfoHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetAlidingAssistantInfoHeaders::AccountContext) };
    inline GetAlidingAssistantInfoHeaders& setAccountContext(const GetAlidingAssistantInfoHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetAlidingAssistantInfoHeaders& setAccountContext(GetAlidingAssistantInfoHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetAlidingAssistantInfoHeaders::AccountContext> accountContext_ {};
  };
