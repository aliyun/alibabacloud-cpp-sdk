...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appType_ == nullptr
        && return this->digitalSignUrl_ == nullptr && return this->formDataJson_ == nullptr && return this->language_ == nullptr && return this->noExecuteExpressions_ == nullptr && return this->outResult_ == nullptr
        && return this->processInstanceId_ == nullptr && return this->remark_ == nullptr && return this->systemToken_ == nullptr && return this->taskId_ == nullptr; };
    ...
    inline string digitalSignUrl() const { DARABONBA_PTR_GET_DEFAULT(digitalSignUrl_, "") };
    ...
    inline string noExecuteExpressions() const { DARABONBA_PTR_GET_DEFAULT(noExecuteExpressions_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> digitalSignUrl_ = nullptr;
    std::shared_ptr<string> formDataJson_ = nullptr;
    std::shared_ptr<string> language_ = nullptr;
    std::shared_ptr<string> noExecuteExpressions_ = nullptr;
