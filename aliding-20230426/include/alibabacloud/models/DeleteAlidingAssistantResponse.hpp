...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAlidingAssistantResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteAlidingAssistantResponseBody) };
    inline DeleteAlidingAssistantResponseBody body() { DARABONBA_PTR_GET(body_, DeleteAlidingAssistantResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteAlidingAssistantResponseBody> body_ = nullptr;
  };
