...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDentriesInfoHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, QueryDentriesInfoHeaders::AccountContext) };
    inline QueryDentriesInfoHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, QueryDentriesInfoHeaders::AccountContext) };
    inline QueryDentriesInfoHeaders& setAccountContext(const QueryDentriesInfoHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline QueryDentriesInfoHeaders& setAccountContext(QueryDentriesInfoHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<QueryDentriesInfoHeaders::AccountContext> accountContext_ {};
  };
