...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appType_ == nullptr
        && return this->formInstanceId_ == nullptr && return this->formUuid_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->systemToken_ == nullptr
        && return this->tableFieldId_ == nullptr; };
    ...
    inline string tableFieldId() const { DARABONBA_PTR_GET_DEFAULT(tableFieldId_, "") };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<string> tableFieldId_ = nullptr;
  };
