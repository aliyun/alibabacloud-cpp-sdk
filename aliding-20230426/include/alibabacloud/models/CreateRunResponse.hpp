...
namespace Models
{
  ...
  public:
    ...
    inline CreateRunResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline CreateRunResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };
