...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetMeCorpSubmissionResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetMeCorpSubmissionResponseBodyData>) };
    inline vector<GetMeCorpSubmissionResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetMeCorpSubmissionResponseBodyData>) };
    inline GetMeCorpSubmissionResponseBody& setData(const vector<GetMeCorpSubmissionResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMeCorpSubmissionResponseBody& setData(vector<GetMeCorpSubmissionResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<GetMeCorpSubmissionResponseBodyData>> data_ = nullptr;
