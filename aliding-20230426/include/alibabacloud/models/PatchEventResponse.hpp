...
namespace Models
{
  ...
  public:
    ...
    inline const PatchEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PatchEventResponseBody) };
    inline PatchEventResponseBody getBody() { DARABONBA_PTR_GET(body_, PatchEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PatchEventResponseBody> body_ {};
  };
