...
#ifndef ALIBABACLOUD_MODELS_INVOKESKILLHEADERSACCOUNTCONTEXT_HPP_
#define ALIBABACLOUD_MODELS_INVOKESKILLHEADERSACCOUNTCONTEXT_HPP_
...
namespace Models
{
  ...
  public:
    ...
    InvokeSkillHeadersAccountContext(InvokeSkillHeadersAccountContext &&) = default ;
    InvokeSkillHeadersAccountContext(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InvokeSkillHeadersAccountContext() = default ;
    InvokeSkillHeadersAccountContext& operator=(const InvokeSkillHeadersAccountContext &) = default ;
    InvokeSkillHeadersAccountContext& operator=(InvokeSkillHeadersAccountContext &&) = default ;
