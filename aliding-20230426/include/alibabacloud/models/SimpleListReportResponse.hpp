...
namespace Models
{
  ...
  public:
    ...
    inline const SimpleListReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SimpleListReportResponseBody) };
    inline SimpleListReportResponseBody getBody() { DARABONBA_PTR_GET(body_, SimpleListReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SimpleListReportResponseBody> body_ {};
  };
