...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->scheduleConfSettingModel_ == nullptr
        && this->scheduleConferenceId_ == nullptr && this->tenantContext_ == nullptr; };
    ...
    inline const UpdateScheduleConfSettingsRequest::ScheduleConfSettingModel & getScheduleConfSettingModel() const { DARABONBA_PTR_GET_CONST(scheduleConfSettingModel_, UpdateScheduleConfSettingsRequest::ScheduleConfSettingModel) };
    inline UpdateScheduleConfSettingsRequest::ScheduleConfSettingModel getScheduleConfSettingModel() { DARABONBA_PTR_GET(scheduleConfSettingModel_, UpdateScheduleConfSettingsRequest::ScheduleConfSettingModel) };
    inline UpdateScheduleConfSettingsRequest& setScheduleConfSettingModel(const UpdateScheduleConfSettingsRequest::ScheduleConfSettingModel & scheduleConfSettingModel) { DARABONBA_PTR_SET_VALUE(scheduleConfSettingModel_, scheduleConfSettingModel) };
    inline UpdateScheduleConfSettingsRequest& setScheduleConfSettingModel(UpdateScheduleConfSettingsRequest::ScheduleConfSettingModel && scheduleConfSettingModel) { DARABONBA_PTR_SET_RVALUE(scheduleConfSettingModel_, scheduleConfSettingModel) };
    ...
    inline const UpdateScheduleConfSettingsRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, UpdateScheduleConfSettingsRequest::TenantContext) };
    inline UpdateScheduleConfSettingsRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, UpdateScheduleConfSettingsRequest::TenantContext) };
    inline UpdateScheduleConfSettingsRequest& setTenantContext(const UpdateScheduleConfSettingsRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline UpdateScheduleConfSettingsRequest& setTenantContext(UpdateScheduleConfSettingsRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };


  protected:
    shared_ptr<UpdateScheduleConfSettingsRequest::ScheduleConfSettingModel> scheduleConfSettingModel_ {};
    shared_ptr<string> scheduleConferenceId_ {};
    shared_ptr<UpdateScheduleConfSettingsRequest::TenantContext> tenantContext_ {};
  };
