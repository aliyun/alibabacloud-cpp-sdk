...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->baseId_ == nullptr
        && this->fieldIdOrName_ == nullptr && this->sheetIdOrName_ == nullptr && this->tenantContext_ == nullptr; };
    ...
    inline const DeleteMultiDimTableFieldRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, DeleteMultiDimTableFieldRequest::TenantContext) };
    inline DeleteMultiDimTableFieldRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, DeleteMultiDimTableFieldRequest::TenantContext) };
    inline DeleteMultiDimTableFieldRequest& setTenantContext(const DeleteMultiDimTableFieldRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline DeleteMultiDimTableFieldRequest& setTenantContext(DeleteMultiDimTableFieldRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<DeleteMultiDimTableFieldRequest::TenantContext> tenantContext_ {};
  };
