...
namespace Models
{
  ...
  public:
    ...
    inline const CommitFileHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CommitFileHeaders::AccountContext) };
    inline CommitFileHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CommitFileHeaders::AccountContext) };
    inline CommitFileHeaders& setAccountContext(const CommitFileHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CommitFileHeaders& setAccountContext(CommitFileHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CommitFileHeaders::AccountContext> accountContext_ {};
  };
