...
namespace Models
{
  ...
  public:
    ...
    inline const CopyDentryByNodeIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CopyDentryByNodeIdResponseBody) };
    inline CopyDentryByNodeIdResponseBody getBody() { DARABONBA_PTR_GET(body_, CopyDentryByNodeIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CopyDentryByNodeIdResponseBody> body_ {};
  };
