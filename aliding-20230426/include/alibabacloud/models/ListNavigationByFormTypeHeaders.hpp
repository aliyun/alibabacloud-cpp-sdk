...
namespace Models
{
  ...
  public:
    ...
    inline const ListNavigationByFormTypeHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, ListNavigationByFormTypeHeaders::AccountContext) };
    inline ListNavigationByFormTypeHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, ListNavigationByFormTypeHeaders::AccountContext) };
    inline ListNavigationByFormTypeHeaders& setAccountContext(const ListNavigationByFormTypeHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline ListNavigationByFormTypeHeaders& setAccountContext(ListNavigationByFormTypeHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<ListNavigationByFormTypeHeaders::AccountContext> accountContext_ {};
  };
