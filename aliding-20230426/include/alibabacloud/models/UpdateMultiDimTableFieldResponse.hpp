...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMultiDimTableFieldResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateMultiDimTableFieldResponseBody) };
    inline UpdateMultiDimTableFieldResponseBody body() { DARABONBA_PTR_GET(body_, UpdateMultiDimTableFieldResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateMultiDimTableFieldResponseBody> body_ = nullptr;
  };
