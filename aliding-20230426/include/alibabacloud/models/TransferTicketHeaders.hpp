...
namespace Models
{
  ...
  public:
    ...
    inline const TransferTicketHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, TransferTicketHeaders::AccountContext) };
    inline TransferTicketHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, TransferTicketHeaders::AccountContext) };
    inline TransferTicketHeaders& setAccountContext(const TransferTicketHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline TransferTicketHeaders& setAccountContext(TransferTicketHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<TransferTicketHeaders::AccountContext> accountContext_ {};
  };
