...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstancesResponseBody) };
    inline GetInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstancesResponseBody> body_ {};
  };
