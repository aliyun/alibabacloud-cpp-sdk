...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateScheduleConferenceHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateScheduleConferenceHeaders::AccountContext) };
    inline UpdateScheduleConferenceHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateScheduleConferenceHeaders::AccountContext) };
    inline UpdateScheduleConferenceHeaders& setAccountContext(const UpdateScheduleConferenceHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateScheduleConferenceHeaders& setAccountContext(UpdateScheduleConferenceHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateScheduleConferenceHeaders::AccountContext> accountContext_ {};
  };
