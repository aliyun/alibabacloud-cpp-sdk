...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceByIdHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetInstanceByIdHeaders::AccountContext) };
    inline GetInstanceByIdHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetInstanceByIdHeaders::AccountContext) };
    inline GetInstanceByIdHeaders& setAccountContext(const GetInstanceByIdHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetInstanceByIdHeaders& setAccountContext(GetInstanceByIdHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetInstanceByIdHeaders::AccountContext> accountContext_ {};
  };
