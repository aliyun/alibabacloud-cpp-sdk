...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->isAlibabaStaff_ == nullptr
    ...
    inline bool getIsAlibabaStaff() const { DARABONBA_PTR_GET_DEFAULT(isAlibabaStaff_, false) };
  ...
  protected:
    shared_ptr<bool> isAlibabaStaff_ {};
