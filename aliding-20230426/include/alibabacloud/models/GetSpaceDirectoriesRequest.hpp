...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dentryId_ == nullptr
        && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->spaceId_ == nullptr && this->tenantContext_ == nullptr; };
    ...
    inline const GetSpaceDirectoriesRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, GetSpaceDirectoriesRequest::TenantContext) };
    inline GetSpaceDirectoriesRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, GetSpaceDirectoriesRequest::TenantContext) };
    inline GetSpaceDirectoriesRequest& setTenantContext(const GetSpaceDirectoriesRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline GetSpaceDirectoriesRequest& setTenantContext(GetSpaceDirectoriesRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<GetSpaceDirectoriesRequest::TenantContext> tenantContext_ {};
  };
