...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attendees_ == nullptr
        && return this->cardInstances_ == nullptr && return this->description_ == nullptr && return this->end_ == nullptr && return this->extra_ == nullptr && return this->isAllDay_ == nullptr
        && return this->location_ == nullptr && return this->onlineMeetingInfo_ == nullptr && return this->recurrence_ == nullptr && return this->reminders_ == nullptr && return this->richTextDescription_ == nullptr
        && return this->summary_ == nullptr && return this->uiConfigs_ == nullptr && return this->calendarId_ == nullptr && return this->start_ == nullptr; };
