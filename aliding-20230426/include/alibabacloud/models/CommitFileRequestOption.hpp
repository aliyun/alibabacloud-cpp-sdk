...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appProperties_ == nullptr
        && return this->conflictStrategy_ == nullptr && return this->convertToOnlineDoc_ == nullptr && return this->convertToOnlineDocTargetDocumentType_ == nullptr && return this->size_ == nullptr; };
