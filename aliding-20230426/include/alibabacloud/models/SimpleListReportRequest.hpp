...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cursor_ == nullptr
        && return this->endTime_ == nullptr && return this->size_ == nullptr && return this->startTime_ == nullptr && return this->templateName_ == nullptr && return this->tenantContext_ == nullptr; };
