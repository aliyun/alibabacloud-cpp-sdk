...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateMessageResponseBody::Messages> & getMessages() const { DARABONBA_PTR_GET_CONST(messages_, vector<CreateMessageResponseBody::Messages>) };
    inline vector<CreateMessageResponseBody::Messages> getMessages() { DARABONBA_PTR_GET(messages_, vector<CreateMessageResponseBody::Messages>) };
    inline CreateMessageResponseBody& setMessages(const vector<CreateMessageResponseBody::Messages> & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline CreateMessageResponseBody& setMessages(vector<CreateMessageResponseBody::Messages> && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
  ...
  protected:
    shared_ptr<vector<CreateMessageResponseBody::Messages>> messages_ {};
