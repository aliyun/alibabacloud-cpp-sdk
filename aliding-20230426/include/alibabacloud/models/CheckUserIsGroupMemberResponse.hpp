...
namespace Models
{
  ...
  public:
    ...
    inline const CheckUserIsGroupMemberResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CheckUserIsGroupMemberResponseBody) };
    inline CheckUserIsGroupMemberResponseBody body() { DARABONBA_PTR_GET(body_, CheckUserIsGroupMemberResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CheckUserIsGroupMemberResponseBody> body_ = nullptr;
  };
