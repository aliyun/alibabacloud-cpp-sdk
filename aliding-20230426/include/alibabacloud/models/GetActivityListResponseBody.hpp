...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetActivityListResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<GetActivityListResponseBodyResult>) };
    inline vector<GetActivityListResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<GetActivityListResponseBodyResult>) };
    inline GetActivityListResponseBody& setResult(const vector<GetActivityListResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetActivityListResponseBody& setResult(vector<GetActivityListResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetActivityListResponseBodyResult>> result_ = nullptr;
