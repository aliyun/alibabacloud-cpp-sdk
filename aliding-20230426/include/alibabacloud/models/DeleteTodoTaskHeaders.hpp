...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTodoTaskHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteTodoTaskHeaders::AccountContext) };
    inline DeleteTodoTaskHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteTodoTaskHeaders::AccountContext) };
    inline DeleteTodoTaskHeaders& setAccountContext(const DeleteTodoTaskHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteTodoTaskHeaders& setAccountContext(DeleteTodoTaskHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DeleteTodoTaskHeaders::AccountContext> accountContext_ {};
  };
