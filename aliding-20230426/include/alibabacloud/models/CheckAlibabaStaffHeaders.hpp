...
namespace Models
{
  ...
  public:
    ...
    inline const CheckAlibabaStaffHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CheckAlibabaStaffHeaders::AccountContext) };
    inline CheckAlibabaStaffHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CheckAlibabaStaffHeaders::AccountContext) };
    inline CheckAlibabaStaffHeaders& setAccountContext(const CheckAlibabaStaffHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CheckAlibabaStaffHeaders& setAccountContext(CheckAlibabaStaffHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CheckAlibabaStaffHeaders::AccountContext> accountContext_ {};
  };
