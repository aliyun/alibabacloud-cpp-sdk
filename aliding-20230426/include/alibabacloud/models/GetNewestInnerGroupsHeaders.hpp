...
namespace Models
{
  ...
  public:
    ...
    inline const GetNewestInnerGroupsHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetNewestInnerGroupsHeaders::AccountContext) };
    inline GetNewestInnerGroupsHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetNewestInnerGroupsHeaders::AccountContext) };
    inline GetNewestInnerGroupsHeaders& setAccountContext(const GetNewestInnerGroupsHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetNewestInnerGroupsHeaders& setAccountContext(GetNewestInnerGroupsHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetNewestInnerGroupsHeaders::AccountContext> accountContext_ {};
  };
