...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->responseStatus_ == nullptr && this->self_ == nullptr; };
      ...
      inline const vector<Events::Reminders> & getReminders() const { DARABONBA_PTR_GET_CONST(reminders_, vector<Events::Reminders>) };
      inline vector<Events::Reminders> getReminders() { DARABONBA_PTR_GET(reminders_, vector<Events::Reminders>) };
      inline Events& setReminders(const vector<Events::Reminders> & reminders) { DARABONBA_PTR_SET_VALUE(reminders_, reminders) };
      inline Events& setReminders(vector<Events::Reminders> && reminders) { DARABONBA_PTR_SET_RVALUE(reminders_, reminders) };
    ...
    protected:
      ...
      shared_ptr<vector<Events::Reminders>> reminders_ {};
    ...
    inline const vector<ListEventsResponseBody::Events> & getEvents() const { DARABONBA_PTR_GET_CONST(events_, vector<ListEventsResponseBody::Events>) };
    inline vector<ListEventsResponseBody::Events> getEvents() { DARABONBA_PTR_GET(events_, vector<ListEventsResponseBody::Events>) };
    inline ListEventsResponseBody& setEvents(const vector<ListEventsResponseBody::Events> & events) { DARABONBA_PTR_SET_VALUE(events_, events) };
    inline ListEventsResponseBody& setEvents(vector<ListEventsResponseBody::Events> && events) { DARABONBA_PTR_SET_RVALUE(events_, events) };
  ...
  protected:
    shared_ptr<vector<ListEventsResponseBody::Events>> events_ {};
