...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetNodesResponseBody::Nodes> & getNodes() const { DARABONBA_PTR_GET_CONST(nodes_, vector<GetNodesResponseBody::Nodes>) };
    inline vector<GetNodesResponseBody::Nodes> getNodes() { DARABONBA_PTR_GET(nodes_, vector<GetNodesResponseBody::Nodes>) };
    inline GetNodesResponseBody& setNodes(const vector<GetNodesResponseBody::Nodes> & nodes) { DARABONBA_PTR_SET_VALUE(nodes_, nodes) };
    inline GetNodesResponseBody& setNodes(vector<GetNodesResponseBody::Nodes> && nodes) { DARABONBA_PTR_SET_RVALUE(nodes_, nodes) };
  ...
  protected:
    shared_ptr<vector<GetNodesResponseBody::Nodes>> nodes_ {};
    // requestId
