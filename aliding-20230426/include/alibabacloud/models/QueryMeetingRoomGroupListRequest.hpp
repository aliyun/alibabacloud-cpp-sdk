...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMeetingRoomGroupListRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, QueryMeetingRoomGroupListRequest::TenantContext) };
    inline QueryMeetingRoomGroupListRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, QueryMeetingRoomGroupListRequest::TenantContext) };
    inline QueryMeetingRoomGroupListRequest& setTenantContext(const QueryMeetingRoomGroupListRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline QueryMeetingRoomGroupListRequest& setTenantContext(QueryMeetingRoomGroupListRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };


  protected:
    Darabonba::Json request_ {};
    shared_ptr<QueryMeetingRoomGroupListRequest::TenantContext> tenantContext_ {};
  };
