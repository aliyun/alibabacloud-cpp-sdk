...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEventHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateEventHeaders::AccountContext) };
    inline CreateEventHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateEventHeaders::AccountContext) };
    inline CreateEventHeaders& setAccountContext(const CreateEventHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateEventHeaders& setAccountContext(CreateEventHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateEventHeaders::AccountContext> accountContext_ {};
  };
