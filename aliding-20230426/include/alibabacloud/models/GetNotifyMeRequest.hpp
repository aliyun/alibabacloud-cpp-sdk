...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getInstanceCreateFromTimeGMT() const { DARABONBA_PTR_GET_DEFAULT(instanceCreateFromTimeGMT_, 0L) };
    ...
    inline int64_t getInstanceCreateToTimeGMT() const { DARABONBA_PTR_GET_DEFAULT(instanceCreateToTimeGMT_, 0L) };
  ...
  protected:
    ...
    shared_ptr<int64_t> instanceCreateFromTimeGMT_ {};
    shared_ptr<int64_t> instanceCreateToTimeGMT_ {};
