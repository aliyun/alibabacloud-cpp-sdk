...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appTypes_ == nullptr
        && return this->corpId_ == nullptr && return this->createFromTimeGMT_ == nullptr && return this->createToTimeGMT_ == nullptr && return this->instanceCreateFromTimeGMT_ == nullptr && return this->instanceCreateToTimeGMT_ == nullptr
        && return this->keyword_ == nullptr && return this->language_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->processCodes_ == nullptr
