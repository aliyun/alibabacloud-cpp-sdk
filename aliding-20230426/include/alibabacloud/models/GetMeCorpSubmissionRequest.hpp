...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appTypes_ == nullptr
        && this->corpId_ == nullptr && this->createFromTimeGMT_ == nullptr && this->createToTimeGMT_ == nullptr && this->keyword_ == nullptr && this->language_ == nullptr
        && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->processCodes_ == nullptr && this->token_ == nullptr; };
    // appTypes Field Functions 
    bool hasAppTypes() const { return this->appTypes_ != nullptr;};
    void deleteAppTypes() { this->appTypes_ = nullptr;};
    inline string getAppTypes() const { DARABONBA_PTR_GET_DEFAULT(appTypes_, "") };
