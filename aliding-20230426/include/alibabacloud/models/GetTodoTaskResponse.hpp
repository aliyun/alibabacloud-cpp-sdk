...
namespace Models
{
  ...
  public:
    ...
    inline const GetTodoTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTodoTaskResponseBody) };
    inline GetTodoTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTodoTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTodoTaskResponseBody> body_ {};
  };
