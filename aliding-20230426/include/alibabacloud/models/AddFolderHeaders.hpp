...
namespace Models
{
  ...
  public:
    ...
    inline const AddFolderHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, AddFolderHeaders::AccountContext) };
    inline AddFolderHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, AddFolderHeaders::AccountContext) };
    inline AddFolderHeaders& setAccountContext(const AddFolderHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline AddFolderHeaders& setAccountContext(AddFolderHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<AddFolderHeaders::AccountContext> accountContext_ {};
  };
