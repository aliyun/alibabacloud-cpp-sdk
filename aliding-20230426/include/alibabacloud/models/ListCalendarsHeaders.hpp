...
namespace Models
{
  ...
  public:
    ...
    inline const ListCalendarsHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, ListCalendarsHeaders::AccountContext) };
    inline ListCalendarsHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, ListCalendarsHeaders::AccountContext) };
    inline ListCalendarsHeaders& setAccountContext(const ListCalendarsHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline ListCalendarsHeaders& setAccountContext(ListCalendarsHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<ListCalendarsHeaders::AccountContext> accountContext_ {};
  };
