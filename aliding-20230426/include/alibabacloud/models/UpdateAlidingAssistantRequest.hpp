...
namespace Models
{
  ...
  public:
    ...
    inline const map<string, string> & getExt() const { DARABONBA_PTR_GET_CONST(ext_, map<string, string>) };
    inline map<string, string> getExt() { DARABONBA_PTR_GET(ext_, map<string, string>) };
    ...
    inline const map<string, string> & getFeature() const { DARABONBA_PTR_GET_CONST(feature_, map<string, string>) };
    inline map<string, string> getFeature() { DARABONBA_PTR_GET(feature_, map<string, string>) };
    ...
    inline const vector<string> & getRecommendPrompts() const { DARABONBA_PTR_GET_CONST(recommendPrompts_, vector<string>) };
    inline vector<string> getRecommendPrompts() { DARABONBA_PTR_GET(recommendPrompts_, vector<string>) };
    ...
    inline const UpdateAlidingAssistantRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, UpdateAlidingAssistantRequest::TenantContext) };
    inline UpdateAlidingAssistantRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, UpdateAlidingAssistantRequest::TenantContext) };
    inline UpdateAlidingAssistantRequest& setTenantContext(const UpdateAlidingAssistantRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline UpdateAlidingAssistantRequest& setTenantContext(UpdateAlidingAssistantRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<map<string, string>> ext_ {};
    shared_ptr<string> fallbackContent_ {};
    shared_ptr<map<string, string>> feature_ {};
    shared_ptr<string> icon_ {};
    shared_ptr<string> instructions_ {};
    shared_ptr<string> name_ {};
    shared_ptr<vector<string>> recommendPrompts_ {};
    shared_ptr<UpdateAlidingAssistantRequest::TenantContext> tenantContext_ {};
