...
namespace Models
{
  ...
  public:
    ...
    inline const GetTemplateListByUserIdHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetTemplateListByUserIdHeaders::AccountContext) };
    inline GetTemplateListByUserIdHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetTemplateListByUserIdHeaders::AccountContext) };
    inline GetTemplateListByUserIdHeaders& setAccountContext(const GetTemplateListByUserIdHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetTemplateListByUserIdHeaders& setAccountContext(GetTemplateListByUserIdHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetTemplateListByUserIdHeaders::AccountContext> accountContext_ {};
  };
