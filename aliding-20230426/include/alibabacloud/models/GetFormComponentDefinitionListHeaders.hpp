...
namespace Models
{
  ...
  public:
    ...
    inline const GetFormComponentDefinitionListHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetFormComponentDefinitionListHeaders::AccountContext) };
    inline GetFormComponentDefinitionListHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetFormComponentDefinitionListHeaders::AccountContext) };
    inline GetFormComponentDefinitionListHeaders& setAccountContext(const GetFormComponentDefinitionListHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetFormComponentDefinitionListHeaders& setAccountContext(GetFormComponentDefinitionListHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetFormComponentDefinitionListHeaders::AccountContext> accountContext_ {};
  };
