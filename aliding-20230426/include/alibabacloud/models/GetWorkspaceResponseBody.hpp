...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorkspaceResponseBody::Workspace & getWorkspace() const { DARABONBA_PTR_GET_CONST(workspace_, GetWorkspaceResponseBody::Workspace) };
    inline GetWorkspaceResponseBody::Workspace getWorkspace() { DARABONBA_PTR_GET(workspace_, GetWorkspaceResponseBody::Workspace) };
    inline GetWorkspaceResponseBody& setWorkspace(const GetWorkspaceResponseBody::Workspace & workspace) { DARABONBA_PTR_SET_VALUE(workspace_, workspace) };
    inline GetWorkspaceResponseBody& setWorkspace(GetWorkspaceResponseBody::Workspace && workspace) { DARABONBA_PTR_SET_RVALUE(workspace_, workspace) };


  protected:
    // requestId
    shared_ptr<string> requestId_ {};
    shared_ptr<GetWorkspaceResponseBody::Workspace> workspace_ {};
  };
