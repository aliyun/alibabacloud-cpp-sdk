...
namespace Models
{
  ...
  public:
    ...
    inline GetSkillDetailResponseBody& setData(const Darabonba::Json & data) { DARABONBA_SET_VALUE(data_, data) };
    inline GetSkillDetailResponseBody& setData(Darabonba::Json && data) { DARABONBA_SET_RVALUE(data_, data) };
