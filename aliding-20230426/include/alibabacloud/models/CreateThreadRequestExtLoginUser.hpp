...
#ifndef ALIBABACLOUD_MODELS_CREATETHREADREQUESTEXTLOGINUSER_HPP_
#define ALIBABACLOUD_MODELS_CREATETHREADREQUESTEXTLOGINUSER_HPP_
...
namespace Models
{
  class CreateThreadRequestExtLoginUser : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateThreadRequestExtLoginUser& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateThreadRequestExtLoginUser& obj) { 
    ...
    CreateThreadRequestExtLoginUser() = default ;
    CreateThreadRequestExtLoginUser(const CreateThreadRequestExtLoginUser &) = default ;
    CreateThreadRequestExtLoginUser(CreateThreadRequestExtLoginUser &&) = default ;
    CreateThreadRequestExtLoginUser(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateThreadRequestExtLoginUser() = default ;
    CreateThreadRequestExtLoginUser& operator=(const CreateThreadRequestExtLoginUser &) = default ;
    CreateThreadRequestExtLoginUser& operator=(CreateThreadRequestExtLoginUser &&) = default ;
    ...
    inline CreateThreadRequestExtLoginUser& setExtLoginUserDomain(string extLoginUserDomain) { DARABONBA_PTR_SET_VALUE(extLoginUserDomain_, extLoginUserDomain) };
    ...
    inline CreateThreadRequestExtLoginUser& setExtLoginUserId(string extLoginUserId) { DARABONBA_PTR_SET_VALUE(extLoginUserId_, extLoginUserId) };
    ...
    inline CreateThreadRequestExtLoginUser& setExtLoginUserName(string extLoginUserName) { DARABONBA_PTR_SET_VALUE(extLoginUserName_, extLoginUserName) };
