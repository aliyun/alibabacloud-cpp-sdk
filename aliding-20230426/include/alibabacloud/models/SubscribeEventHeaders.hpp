...
namespace Models
{
  ...
  public:
    ...
    inline const SubscribeEventHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, SubscribeEventHeaders::AccountContext) };
    inline SubscribeEventHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, SubscribeEventHeaders::AccountContext) };
    inline SubscribeEventHeaders& setAccountContext(const SubscribeEventHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline SubscribeEventHeaders& setAccountContext(SubscribeEventHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<SubscribeEventHeaders::AccountContext> accountContext_ {};
  };
