...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMeetingRoomResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteMeetingRoomResponseBody) };
    inline DeleteMeetingRoomResponseBody body() { DARABONBA_PTR_GET(body_, DeleteMeetingRoomResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteMeetingRoomResponseBody> body_ = nullptr;
  };
