...
namespace Models
{
  ...
  public:
    ...
    inline const CopyDentryHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CopyDentryHeaders::AccountContext) };
    inline CopyDentryHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CopyDentryHeaders::AccountContext) };
    inline CopyDentryHeaders& setAccountContext(const CopyDentryHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CopyDentryHeaders& setAccountContext(CopyDentryHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CopyDentryHeaders::AccountContext> accountContext_ {};
  };
