...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteFormDataHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteFormDataHeaders::AccountContext) };
    inline DeleteFormDataHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteFormDataHeaders::AccountContext) };
    inline DeleteFormDataHeaders& setAccountContext(const DeleteFormDataHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteFormDataHeaders& setAccountContext(DeleteFormDataHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DeleteFormDataHeaders::AccountContext> accountContext_ {};
  };
