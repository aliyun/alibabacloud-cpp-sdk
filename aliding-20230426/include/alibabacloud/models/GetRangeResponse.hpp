...
namespace Models
{
  ...
  public:
    ...
    inline const GetRangeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRangeResponseBody) };
    inline GetRangeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRangeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRangeResponseBody> body_ {};
  };
