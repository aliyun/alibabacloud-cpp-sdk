...
namespace Models
{
  ...
  public:
    ...
    inline const StatisticsReportHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, StatisticsReportHeaders::AccountContext) };
    inline StatisticsReportHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, StatisticsReportHeaders::AccountContext) };
    inline StatisticsReportHeaders& setAccountContext(const StatisticsReportHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline StatisticsReportHeaders& setAccountContext(StatisticsReportHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<StatisticsReportHeaders::AccountContext> accountContext_ {};
  };
