...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateVideoConferenceSettingHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateVideoConferenceSettingHeaders::AccountContext) };
    inline UpdateVideoConferenceSettingHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateVideoConferenceSettingHeaders::AccountContext) };
    inline UpdateVideoConferenceSettingHeaders& setAccountContext(const UpdateVideoConferenceSettingHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateVideoConferenceSettingHeaders& setAccountContext(UpdateVideoConferenceSettingHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateVideoConferenceSettingHeaders::AccountContext> accountContext_ {};
  };
