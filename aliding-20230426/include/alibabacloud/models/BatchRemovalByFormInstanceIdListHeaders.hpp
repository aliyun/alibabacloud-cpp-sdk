...
namespace Models
{
  ...
  public:
    ...
    inline const BatchRemovalByFormInstanceIdListHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, BatchRemovalByFormInstanceIdListHeaders::AccountContext) };
    inline BatchRemovalByFormInstanceIdListHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, BatchRemovalByFormInstanceIdListHeaders::AccountContext) };
    inline BatchRemovalByFormInstanceIdListHeaders& setAccountContext(const BatchRemovalByFormInstanceIdListHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline BatchRemovalByFormInstanceIdListHeaders& setAccountContext(BatchRemovalByFormInstanceIdListHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<BatchRemovalByFormInstanceIdListHeaders::AccountContext> accountContext_ {};
  };
