...
namespace Models
{
  ...
  public:
    ...
    inline const CommentListReportRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, CommentListReportRequest::TenantContext) };
    inline CommentListReportRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, CommentListReportRequest::TenantContext) };
    inline CommentListReportRequest& setTenantContext(const CommentListReportRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline CommentListReportRequest& setTenantContext(CommentListReportRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<CommentListReportRequest::TenantContext> tenantContext_ {};
  };
