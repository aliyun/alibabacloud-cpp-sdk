...
namespace Models
{
  ...
  public:
    ...
    inline const UnsubscribeCalendarResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnsubscribeCalendarResponseBody) };
    inline UnsubscribeCalendarResponseBody getBody() { DARABONBA_PTR_GET(body_, UnsubscribeCalendarResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnsubscribeCalendarResponseBody> body_ {};
  };
