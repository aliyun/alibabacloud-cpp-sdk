...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteColumnsHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteColumnsHeaders::AccountContext) };
    inline DeleteColumnsHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteColumnsHeaders::AccountContext) };
    inline DeleteColumnsHeaders& setAccountContext(const DeleteColumnsHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteColumnsHeaders& setAccountContext(DeleteColumnsHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DeleteColumnsHeaders::AccountContext> accountContext_ {};
  };
