...
namespace Models
{
  ...
  public:
    ...
    inline const GetLiveReplayUrlRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, GetLiveReplayUrlRequest::TenantContext) };
    inline GetLiveReplayUrlRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, GetLiveReplayUrlRequest::TenantContext) };
    inline GetLiveReplayUrlRequest& setTenantContext(const GetLiveReplayUrlRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline GetLiveReplayUrlRequest& setTenantContext(GetLiveReplayUrlRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };


  protected:
    // This parameter is required.
    shared_ptr<string> liveId_ {};
    shared_ptr<GetLiveReplayUrlRequest::TenantContext> tenantContext_ {};
  };
