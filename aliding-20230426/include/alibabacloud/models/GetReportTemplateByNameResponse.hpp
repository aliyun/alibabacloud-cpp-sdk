...
namespace Models
{
  ...
  public:
    ...
    inline const GetReportTemplateByNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetReportTemplateByNameResponseBody) };
    inline GetReportTemplateByNameResponseBody getBody() { DARABONBA_PTR_GET(body_, GetReportTemplateByNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetReportTemplateByNameResponseBody> body_ {};
  };
