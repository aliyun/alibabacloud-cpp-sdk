...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCloudRecordVideoRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, QueryCloudRecordVideoRequest::TenantContext) };
    inline QueryCloudRecordVideoRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, QueryCloudRecordVideoRequest::TenantContext) };
    inline QueryCloudRecordVideoRequest& setTenantContext(const QueryCloudRecordVideoRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline QueryCloudRecordVideoRequest& setTenantContext(QueryCloudRecordVideoRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    shared_ptr<QueryCloudRecordVideoRequest::TenantContext> tenantContext_ {};
