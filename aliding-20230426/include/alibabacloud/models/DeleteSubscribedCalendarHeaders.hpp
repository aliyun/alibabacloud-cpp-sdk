...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSubscribedCalendarHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteSubscribedCalendarHeaders::AccountContext) };
    inline DeleteSubscribedCalendarHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteSubscribedCalendarHeaders::AccountContext) };
    inline DeleteSubscribedCalendarHeaders& setAccountContext(const DeleteSubscribedCalendarHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteSubscribedCalendarHeaders& setAccountContext(DeleteSubscribedCalendarHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DeleteSubscribedCalendarHeaders::AccountContext> accountContext_ {};
  };
