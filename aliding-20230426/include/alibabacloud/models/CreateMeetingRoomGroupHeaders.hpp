...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMeetingRoomGroupHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateMeetingRoomGroupHeaders::AccountContext) };
    inline CreateMeetingRoomGroupHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateMeetingRoomGroupHeaders::AccountContext) };
    inline CreateMeetingRoomGroupHeaders& setAccountContext(const CreateMeetingRoomGroupHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateMeetingRoomGroupHeaders& setAccountContext(CreateMeetingRoomGroupHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateMeetingRoomGroupHeaders::AccountContext> accountContext_ {};
  };
