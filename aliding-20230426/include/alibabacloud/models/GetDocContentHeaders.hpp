...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocContentHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetDocContentHeaders::AccountContext) };
    inline GetDocContentHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetDocContentHeaders::AccountContext) };
    inline GetDocContentHeaders& setAccountContext(const GetDocContentHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetDocContentHeaders& setAccountContext(GetDocContentHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetDocContentHeaders::AccountContext> accountContext_ {};
  };
