...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWorkspaceDocHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CreateWorkspaceDocHeaders::AccountContext) };
    inline CreateWorkspaceDocHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CreateWorkspaceDocHeaders::AccountContext) };
    inline CreateWorkspaceDocHeaders& setAccountContext(const CreateWorkspaceDocHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CreateWorkspaceDocHeaders& setAccountContext(CreateWorkspaceDocHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CreateWorkspaceDocHeaders::AccountContext> accountContext_ {};
  };
