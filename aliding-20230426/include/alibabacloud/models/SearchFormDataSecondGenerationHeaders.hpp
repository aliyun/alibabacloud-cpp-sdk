...
namespace Models
{
  ...
  public:
    ...
    inline const SearchFormDataSecondGenerationHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, SearchFormDataSecondGenerationHeaders::AccountContext) };
    inline SearchFormDataSecondGenerationHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, SearchFormDataSecondGenerationHeaders::AccountContext) };
    inline SearchFormDataSecondGenerationHeaders& setAccountContext(const SearchFormDataSecondGenerationHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline SearchFormDataSecondGenerationHeaders& setAccountContext(SearchFormDataSecondGenerationHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<SearchFormDataSecondGenerationHeaders::AccountContext> accountContext_ {};
  };
