...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateRunResponseBody::Messages> & getMessages() const { DARABONBA_PTR_GET_CONST(messages_, vector<CreateRunResponseBody::Messages>) };
    inline vector<CreateRunResponseBody::Messages> getMessages() { DARABONBA_PTR_GET(messages_, vector<CreateRunResponseBody::Messages>) };
    inline CreateRunResponseBody& setMessages(const vector<CreateRunResponseBody::Messages> & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline CreateRunResponseBody& setMessages(vector<CreateRunResponseBody::Messages> && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
    ...
    inline const CreateRunResponseBody::Run & getRun() const { DARABONBA_PTR_GET_CONST(run_, CreateRunResponseBody::Run) };
    inline CreateRunResponseBody::Run getRun() { DARABONBA_PTR_GET(run_, CreateRunResponseBody::Run) };
    inline CreateRunResponseBody& setRun(const CreateRunResponseBody::Run & run) { DARABONBA_PTR_SET_VALUE(run_, run) };
