...
namespace Models
{
  ...
  public:
    ...
    inline const CancelScheduleConferenceHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, CancelScheduleConferenceHeaders::AccountContext) };
    inline CancelScheduleConferenceHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, CancelScheduleConferenceHeaders::AccountContext) };
    inline CancelScheduleConferenceHeaders& setAccountContext(const CancelScheduleConferenceHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline CancelScheduleConferenceHeaders& setAccountContext(CancelScheduleConferenceHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<CancelScheduleConferenceHeaders::AccountContext> accountContext_ {};
  };
