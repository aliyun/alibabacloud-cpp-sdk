...
namespace Models
{
  ...
  public:
    ...
    inline const GetNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetNodesResponseBody) };
    inline GetNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetNodesResponseBody> body_ {};
  };
