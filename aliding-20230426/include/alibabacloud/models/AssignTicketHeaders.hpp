...
namespace Models
{
  ...
  public:
    ...
    inline const AssignTicketHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, AssignTicketHeaders::AccountContext) };
    inline AssignTicketHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, AssignTicketHeaders::AccountContext) };
    inline AssignTicketHeaders& setAccountContext(const AssignTicketHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline AssignTicketHeaders& setAccountContext(AssignTicketHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<AssignTicketHeaders::AccountContext> accountContext_ {};
  };
