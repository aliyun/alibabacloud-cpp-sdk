...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserIdByOrgIdAndStaffIdHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetUserIdByOrgIdAndStaffIdHeaders::AccountContext) };
    inline GetUserIdByOrgIdAndStaffIdHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetUserIdByOrgIdAndStaffIdHeaders::AccountContext) };
    inline GetUserIdByOrgIdAndStaffIdHeaders& setAccountContext(const GetUserIdByOrgIdAndStaffIdHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetUserIdByOrgIdAndStaffIdHeaders& setAccountContext(GetUserIdByOrgIdAndStaffIdHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetUserIdByOrgIdAndStaffIdHeaders::AccountContext> accountContext_ {};
  };
