...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actioner_ == nullptr
        && return this->actionerId_ == nullptr && return this->actionerName_ == nullptr && return this->appType_ == nullptr && return this->createTimeGMT_ == nullptr && return this->currentActivityInstances_ == nullptr
        ...
        && return this->processInstanceStatus_ == nullptr && return this->processInstanceStatusText_ == nullptr && return this->processName_ == nullptr && return this->title_ == nullptr && return this->version_ == nullptr; };
