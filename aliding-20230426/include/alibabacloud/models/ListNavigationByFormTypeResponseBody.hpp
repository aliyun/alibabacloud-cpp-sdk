...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListNavigationByFormTypeResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListNavigationByFormTypeResponseBodyResult>) };
    inline vector<ListNavigationByFormTypeResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListNavigationByFormTypeResponseBodyResult>) };
    inline ListNavigationByFormTypeResponseBody& setResult(const vector<ListNavigationByFormTypeResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListNavigationByFormTypeResponseBody& setResult(vector<ListNavigationByFormTypeResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListNavigationByFormTypeResponseBodyResult>> result_ = nullptr;
