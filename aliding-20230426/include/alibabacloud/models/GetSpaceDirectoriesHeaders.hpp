...
namespace Models
{
  ...
  public:
    ...
    inline const GetSpaceDirectoriesHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetSpaceDirectoriesHeaders::AccountContext) };
    inline GetSpaceDirectoriesHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetSpaceDirectoriesHeaders::AccountContext) };
    inline GetSpaceDirectoriesHeaders& setAccountContext(const GetSpaceDirectoriesHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetSpaceDirectoriesHeaders& setAccountContext(GetSpaceDirectoriesHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetSpaceDirectoriesHeaders::AccountContext> accountContext_ {};
  };
