...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMultiDimTableFieldResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMultiDimTableFieldResponseBody) };
    inline DeleteMultiDimTableFieldResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMultiDimTableFieldResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMultiDimTableFieldResponseBody> body_ {};
  };
