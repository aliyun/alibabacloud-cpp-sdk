...
namespace Models
{
  ...
  public:
    ...
    inline const GetNotifyMeHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetNotifyMeHeaders::AccountContext) };
    inline GetNotifyMeHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetNotifyMeHeaders::AccountContext) };
    inline GetNotifyMeHeaders& setAccountContext(const GetNotifyMeHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetNotifyMeHeaders& setAccountContext(GetNotifyMeHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetNotifyMeHeaders::AccountContext> accountContext_ {};
  };
