...
namespace Models
{
  ...
  public:
    ...
    inline const StartMinutesHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, StartMinutesHeaders::AccountContext) };
    inline StartMinutesHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, StartMinutesHeaders::AccountContext) };
    inline StartMinutesHeaders& setAccountContext(const StartMinutesHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline StartMinutesHeaders& setAccountContext(StartMinutesHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<StartMinutesHeaders::AccountContext> accountContext_ {};
  };
