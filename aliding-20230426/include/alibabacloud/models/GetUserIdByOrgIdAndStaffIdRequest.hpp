...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserIdByOrgIdAndStaffIdRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, GetUserIdByOrgIdAndStaffIdRequest::TenantContext) };
    inline GetUserIdByOrgIdAndStaffIdRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, GetUserIdByOrgIdAndStaffIdRequest::TenantContext) };
    inline GetUserIdByOrgIdAndStaffIdRequest& setTenantContext(const GetUserIdByOrgIdAndStaffIdRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline GetUserIdByOrgIdAndStaffIdRequest& setTenantContext(GetUserIdByOrgIdAndStaffIdRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };


  protected:
    shared_ptr<int64_t> orgId_ {};
    shared_ptr<GetUserIdByOrgIdAndStaffIdRequest::TenantContext> tenantContext_ {};
  };
