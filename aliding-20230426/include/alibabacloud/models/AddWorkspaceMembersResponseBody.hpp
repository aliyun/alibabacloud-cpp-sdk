...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getNotInOrgList() const { DARABONBA_PTR_GET_CONST(notInOrgList_, vector<string>) };
    inline vector<string> getNotInOrgList() { DARABONBA_PTR_GET(notInOrgList_, vector<string>) };
