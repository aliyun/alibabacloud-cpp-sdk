...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetNewestInnerGroupsResponseBody::GroupInfos> & getGroupInfos() const { DARABONBA_PTR_GET_CONST(groupInfos_, vector<GetNewestInnerGroupsResponseBody::GroupInfos>) };
    inline vector<GetNewestInnerGroupsResponseBody::GroupInfos> getGroupInfos() { DARABONBA_PTR_GET(groupInfos_, vector<GetNewestInnerGroupsResponseBody::GroupInfos>) };
    inline GetNewestInnerGroupsResponseBody& setGroupInfos(const vector<GetNewestInnerGroupsResponseBody::GroupInfos> & groupInfos) { DARABONBA_PTR_SET_VALUE(groupInfos_, groupInfos) };
    inline GetNewestInnerGroupsResponseBody& setGroupInfos(vector<GetNewestInnerGroupsResponseBody::GroupInfos> && groupInfos) { DARABONBA_PTR_SET_RVALUE(groupInfos_, groupInfos) };
  ...
  protected:
    shared_ptr<vector<GetNewestInnerGroupsResponseBody::GroupInfos>> groupInfos_ {};
