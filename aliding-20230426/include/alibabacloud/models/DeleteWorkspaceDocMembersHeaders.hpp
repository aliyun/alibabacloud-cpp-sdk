...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWorkspaceDocMembersHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteWorkspaceDocMembersHeaders::AccountContext) };
    inline DeleteWorkspaceDocMembersHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteWorkspaceDocMembersHeaders::AccountContext) };
    inline DeleteWorkspaceDocMembersHeaders& setAccountContext(const DeleteWorkspaceDocMembersHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteWorkspaceDocMembersHeaders& setAccountContext(DeleteWorkspaceDocMembersHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DeleteWorkspaceDocMembersHeaders::AccountContext> accountContext_ {};
  };
