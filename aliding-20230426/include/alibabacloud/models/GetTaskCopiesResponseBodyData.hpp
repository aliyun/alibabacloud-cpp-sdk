...
#ifndef ALIBABACLOUD_MODELS_GETTASKCOPIESRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETTASKCOPIESRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetTaskCopiesResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetTaskCopiesResponseBodyData& obj) { 
    ...
    GetTaskCopiesResponseBodyData() = default ;
    GetTaskCopiesResponseBodyData(const GetTaskCopiesResponseBodyData &) = default ;
    GetTaskCopiesResponseBodyData(GetTaskCopiesResponseBodyData &&) = default ;
    GetTaskCopiesResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetTaskCopiesResponseBodyData() = default ;
    GetTaskCopiesResponseBodyData& operator=(const GetTaskCopiesResponseBodyData &) = default ;
    GetTaskCopiesResponseBodyData& operator=(GetTaskCopiesResponseBodyData &&) = default ;
    ...
    inline const vector<string> & actionExecutorId() const { DARABONBA_PTR_GET_CONST(actionExecutorId_, vector<string>) };
    inline vector<string> actionExecutorId() { DARABONBA_PTR_GET(actionExecutorId_, vector<string>) };
    inline GetTaskCopiesResponseBodyData& setActionExecutorId(const vector<string> & actionExecutorId) { DARABONBA_PTR_SET_VALUE(actionExecutorId_, actionExecutorId) };
    inline GetTaskCopiesResponseBodyData& setActionExecutorId(vector<string> && actionExecutorId) { DARABONBA_PTR_SET_RVALUE(actionExecutorId_, actionExecutorId) };
    ...
    inline const vector<string> & actionExecutorName() const { DARABONBA_PTR_GET_CONST(actionExecutorName_, vector<string>) };
    inline vector<string> actionExecutorName() { DARABONBA_PTR_GET(actionExecutorName_, vector<string>) };
    inline GetTaskCopiesResponseBodyData& setActionExecutorName(const vector<string> & actionExecutorName) { DARABONBA_PTR_SET_VALUE(actionExecutorName_, actionExecutorName) };
    inline GetTaskCopiesResponseBodyData& setActionExecutorName(vector<string> && actionExecutorName) { DARABONBA_PTR_SET_RVALUE(actionExecutorName_, actionExecutorName) };
    ...
    inline GetTaskCopiesResponseBodyData& setAppType(string appType) { DARABONBA_PTR_SET_VALUE(appType_, appType) };
    ...
    inline string carbonActivityId() const { DARABONBA_PTR_GET_DEFAULT(carbonActivityId_, "") };
    inline GetTaskCopiesResponseBodyData& setCarbonActivityId(string carbonActivityId) { DARABONBA_PTR_SET_VALUE(carbonActivityId_, carbonActivityId) };
    ...
    inline GetTaskCopiesResponseBodyData& setCreateTimeGMT(string createTimeGMT) { DARABONBA_PTR_SET_VALUE(createTimeGMT_, createTimeGMT) };
    ...
    inline const vector<Models::GetTaskCopiesResponseBodyDataCurrentActivityInstances> & currentActivityInstances() const { DARABONBA_PTR_GET_CONST(currentActivityInstances_, vector<Models::GetTaskCopiesResponseBodyDataCurrentActivityInstances>) };
    inline vector<Models::GetTaskCopiesResponseBodyDataCurrentActivityInstances> currentActivityInstances() { DARABONBA_PTR_GET(currentActivityInstances_, vector<Models::GetTaskCopiesResponseBodyDataCurrentActivityInstances>) };
    inline GetTaskCopiesResponseBodyData& setCurrentActivityInstances(const vector<Models::GetTaskCopiesResponseBodyDataCurrentActivityInstances> & currentActivityInstances) { DARABONBA_PTR_SET_VALUE(currentActivityInstances_, currentActivityInstances) };
    inline GetTaskCopiesResponseBodyData& setCurrentActivityInstances(vector<Models::GetTaskCopiesResponseBodyDataCurrentActivityInstances> && currentActivityInstances) { DARABONBA_PTR_SET_RVALUE(currentActivityInstances_, currentActivityInstances) };
    ...
    inline GetTaskCopiesResponseBodyData& setDataMap(const Darabonba::Json & dataMap) { DARABONBA_SET_VALUE(dataMap_, dataMap) };
    inline GetTaskCopiesResponseBodyData& setDataMap(Darabonba::Json & dataMap) { DARABONBA_SET_RVALUE(dataMap_, dataMap) };
    ...
    inline GetTaskCopiesResponseBodyData& setDataType(string dataType) { DARABONBA_PTR_SET_VALUE(dataType_, dataType) };
    ...
    inline GetTaskCopiesResponseBodyData& setFinishTimeGMT(string finishTimeGMT) { DARABONBA_PTR_SET_VALUE(finishTimeGMT_, finishTimeGMT) };
    ...
    inline GetTaskCopiesResponseBodyData& setFormInstanceId(string formInstanceId) { DARABONBA_PTR_SET_VALUE(formInstanceId_, formInstanceId) };
    ...
    inline GetTaskCopiesResponseBodyData& setFormUuid(string formUuid) { DARABONBA_PTR_SET_VALUE(formUuid_, formUuid) };
    ...
    inline GetTaskCopiesResponseBodyData& setInstanceValue(string instanceValue) { DARABONBA_PTR_SET_VALUE(instanceValue_, instanceValue) };
    ...
    inline GetTaskCopiesResponseBodyData& setModifiedTimeGMT(string modifiedTimeGMT) { DARABONBA_PTR_SET_VALUE(modifiedTimeGMT_, modifiedTimeGMT) };
    ...
    inline GetTaskCopiesResponseBodyData& setOriginatorAvatar(string originatorAvatar) { DARABONBA_PTR_SET_VALUE(originatorAvatar_, originatorAvatar) };
    ...
    inline GetTaskCopiesResponseBodyData& setOriginatorDisplayName(string originatorDisplayName) { DARABONBA_PTR_SET_VALUE(originatorDisplayName_, originatorDisplayName) };
    ...
    inline GetTaskCopiesResponseBodyData& setOriginatorId(string originatorId) { DARABONBA_PTR_SET_VALUE(originatorId_, originatorId) };
    ...
    inline GetTaskCopiesResponseBodyData& setProcessApprovedResult(string processApprovedResult) { DARABONBA_PTR_SET_VALUE(processApprovedResult_, processApprovedResult) };
    ...
    inline GetTaskCopiesResponseBodyData& setProcessApprovedResultText(string processApprovedResultText) { DARABONBA_PTR_SET_VALUE(processApprovedResultText_, processApprovedResultText) };
    ...
    inline GetTaskCopiesResponseBodyData& setProcessCode(string processCode) { DARABONBA_PTR_SET_VALUE(processCode_, processCode) };
    ...
    inline GetTaskCopiesResponseBodyData& setProcessId(int64_t processId) { DARABONBA_PTR_SET_VALUE(processId_, processId) };
    ...
    inline GetTaskCopiesResponseBodyData& setProcessInstanceId(string processInstanceId) { DARABONBA_PTR_SET_VALUE(processInstanceId_, processInstanceId) };
    ...
    inline GetTaskCopiesResponseBodyData& setProcessInstanceStatus(string processInstanceStatus) { DARABONBA_PTR_SET_VALUE(processInstanceStatus_, processInstanceStatus) };
    ...
    inline GetTaskCopiesResponseBodyData& setProcessInstanceStatusText(string processInstanceStatusText) { DARABONBA_PTR_SET_VALUE(processInstanceStatusText_, processInstanceStatusText) };
    ...
    inline GetTaskCopiesResponseBodyData& setProcessName(string processName) { DARABONBA_PTR_SET_VALUE(processName_, processName) };
    ...
    inline GetTaskCopiesResponseBodyData& setSerialNumber(string serialNumber) { DARABONBA_PTR_SET_VALUE(serialNumber_, serialNumber) };
    ...
    inline GetTaskCopiesResponseBodyData& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline GetTaskCopiesResponseBodyData& setVersion(int64_t version) { DARABONBA_PTR_SET_VALUE(version_, version) };


  protected:
    std::shared_ptr<vector<string>> actionExecutorId_ = nullptr;
    std::shared_ptr<vector<string>> actionExecutorName_ = nullptr;
    std::shared_ptr<string> appType_ = nullptr;
    std::shared_ptr<string> carbonActivityId_ = nullptr;
    std::shared_ptr<string> createTimeGMT_ = nullptr;
    std::shared_ptr<vector<Models::GetTaskCopiesResponseBodyDataCurrentActivityInstances>> currentActivityInstances_ = nullptr;
