...
namespace Models
{
  ...
  public:
    ...
    inline const SetColumnsVisibilityRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, SetColumnsVisibilityRequest::TenantContext) };
    inline SetColumnsVisibilityRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, SetColumnsVisibilityRequest::TenantContext) };
    inline SetColumnsVisibilityRequest& setTenantContext(const SetColumnsVisibilityRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline SetColumnsVisibilityRequest& setTenantContext(SetColumnsVisibilityRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
  ...
  protected:
    ...
    shared_ptr<SetColumnsVisibilityRequest::TenantContext> tenantContext_ {};
    // This parameter is required.
