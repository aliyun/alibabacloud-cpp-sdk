...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->column_ == nullptr
        && return this->columnCount_ == nullptr && return this->sheetId_ == nullptr && return this->tenantContext_ == nullptr && return this->visibility_ == nullptr && return this->workbookId_ == nullptr; };
