...
#ifndef ALIBABACLOUD_MODELS_QUERYMEETINGROOMSHRINKHEADERS_HPP_
#define ALIBABACLOUD_MODELS_QUERYMEETINGROOMSHRINKHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryMeetingRoomShrinkHeaders& obj) { 
      DARABONBA_PTR_TO_JSON(commonHeaders, commonHeaders_);
      DARABONBA_PTR_TO_JSON(AccountContext, accountContextShrink_);
    };
    friend void from_json(const Darabonba::Json& j, QueryMeetingRoomShrinkHeaders& obj) { 
      DARABONBA_PTR_FROM_JSON(commonHeaders, commonHeaders_);
      DARABONBA_PTR_FROM_JSON(AccountContext, accountContextShrink_);
    };
    QueryMeetingRoomShrinkHeaders() = default ;
    QueryMeetingRoomShrinkHeaders(const QueryMeetingRoomShrinkHeaders &) = default ;
    QueryMeetingRoomShrinkHeaders(QueryMeetingRoomShrinkHeaders &&) = default ;
    QueryMeetingRoomShrinkHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryMeetingRoomShrinkHeaders() = default ;
    QueryMeetingRoomShrinkHeaders& operator=(const QueryMeetingRoomShrinkHeaders &) = default ;
    QueryMeetingRoomShrinkHeaders& operator=(QueryMeetingRoomShrinkHeaders &&) = default ;
