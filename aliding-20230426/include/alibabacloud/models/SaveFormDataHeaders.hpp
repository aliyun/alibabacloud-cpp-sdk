...
namespace Models
{
  ...
  public:
    ...
    inline const SaveFormDataHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, SaveFormDataHeaders::AccountContext) };
    inline SaveFormDataHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, SaveFormDataHeaders::AccountContext) };
    inline SaveFormDataHeaders& setAccountContext(const SaveFormDataHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline SaveFormDataHeaders& setAccountContext(SaveFormDataHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<SaveFormDataHeaders::AccountContext> accountContext_ {};
  };
