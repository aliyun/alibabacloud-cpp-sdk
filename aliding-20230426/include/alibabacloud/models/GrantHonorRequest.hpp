...
namespace Models
{
  ...
  public:
    ...
    inline const GrantHonorRequest::TenantContext & getTenantContext() const { DARABONBA_PTR_GET_CONST(tenantContext_, GrantHonorRequest::TenantContext) };
    inline GrantHonorRequest::TenantContext getTenantContext() { DARABONBA_PTR_GET(tenantContext_, GrantHonorRequest::TenantContext) };
    inline GrantHonorRequest& setTenantContext(const GrantHonorRequest::TenantContext & tenantContext) { DARABONBA_PTR_SET_VALUE(tenantContext_, tenantContext) };
    inline GrantHonorRequest& setTenantContext(GrantHonorRequest::TenantContext && tenantContext) { DARABONBA_PTR_SET_RVALUE(tenantContext_, tenantContext) };
    ...
    inline const vector<string> & getReceiverUserIds() const { DARABONBA_PTR_GET_CONST(receiverUserIds_, vector<string>) };
    inline vector<string> getReceiverUserIds() { DARABONBA_PTR_GET(receiverUserIds_, vector<string>) };
  ...
  protected:
    shared_ptr<GrantHonorRequest::TenantContext> tenantContext_ {};
    ...
    // This parameter is required.
    shared_ptr<vector<string>> receiverUserIds_ {};
    // This parameter is required.
