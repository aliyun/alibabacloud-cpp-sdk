...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMeetingRoomGroupHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteMeetingRoomGroupHeaders::AccountContext) };
    inline DeleteMeetingRoomGroupHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteMeetingRoomGroupHeaders::AccountContext) };
    inline DeleteMeetingRoomGroupHeaders& setAccountContext(const DeleteMeetingRoomGroupHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteMeetingRoomGroupHeaders& setAccountContext(DeleteMeetingRoomGroupHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DeleteMeetingRoomGroupHeaders::AccountContext> accountContext_ {};
  };
