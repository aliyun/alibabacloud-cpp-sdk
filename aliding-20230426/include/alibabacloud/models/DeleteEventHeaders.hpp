...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEventHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteEventHeaders::AccountContext) };
    inline DeleteEventHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteEventHeaders::AccountContext) };
    inline DeleteEventHeaders& setAccountContext(const DeleteEventHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteEventHeaders& setAccountContext(DeleteEventHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DeleteEventHeaders::AccountContext> accountContext_ {};
  };
