...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserLatestPlanResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetUserLatestPlanResponseBody) };
    inline GetUserLatestPlanResponseBody body() { DARABONBA_PTR_GET(body_, GetUserLatestPlanResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetUserLatestPlanResponseBody> body_ = nullptr;
  };
