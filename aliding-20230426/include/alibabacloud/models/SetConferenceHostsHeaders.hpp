...
namespace Models
{
  ...
  public:
    ...
    inline const SetConferenceHostsHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, SetConferenceHostsHeaders::AccountContext) };
    inline SetConferenceHostsHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, SetConferenceHostsHeaders::AccountContext) };
    inline SetConferenceHostsHeaders& setAccountContext(const SetConferenceHostsHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline SetConferenceHostsHeaders& setAccountContext(SetConferenceHostsHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<SetConferenceHostsHeaders::AccountContext> accountContext_ {};
  };
