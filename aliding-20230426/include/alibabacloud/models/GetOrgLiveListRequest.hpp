...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->corpId_ == nullptr
        && return this->endTime_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->startTime_ == nullptr && return this->tenantContext_ == nullptr
