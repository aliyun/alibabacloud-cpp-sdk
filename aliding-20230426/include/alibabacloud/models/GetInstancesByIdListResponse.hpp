...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstancesByIdListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetInstancesByIdListResponseBody) };
    inline GetInstancesByIdListResponseBody body() { DARABONBA_PTR_GET(body_, GetInstancesByIdListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetInstancesByIdListResponseBody> body_ = nullptr;
  };
