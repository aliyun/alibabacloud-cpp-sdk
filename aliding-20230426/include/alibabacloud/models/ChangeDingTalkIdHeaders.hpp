...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeDingTalkIdHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, ChangeDingTalkIdHeaders::AccountContext) };
    inline ChangeDingTalkIdHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, ChangeDingTalkIdHeaders::AccountContext) };
    inline ChangeDingTalkIdHeaders& setAccountContext(const ChangeDingTalkIdHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline ChangeDingTalkIdHeaders& setAccountContext(ChangeDingTalkIdHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<ChangeDingTalkIdHeaders::AccountContext> accountContext_ {};
  };
