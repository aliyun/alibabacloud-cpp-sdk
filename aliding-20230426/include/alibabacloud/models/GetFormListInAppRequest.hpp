...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appType_ == nullptr
        && return this->formTypes_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->systemToken_ == nullptr; };
    ...
    inline string formTypes() const { DARABONBA_PTR_GET_DEFAULT(formTypes_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> formTypes_ = nullptr;
