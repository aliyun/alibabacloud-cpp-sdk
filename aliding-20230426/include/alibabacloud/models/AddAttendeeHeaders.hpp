...
namespace Models
{
  ...
  public:
    ...
    inline const AddAttendeeHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, AddAttendeeHeaders::AccountContext) };
    inline AddAttendeeHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, AddAttendeeHeaders::AccountContext) };
    inline AddAttendeeHeaders& setAccountContext(const AddAttendeeHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline AddAttendeeHeaders& setAccountContext(AddAttendeeHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<AddAttendeeHeaders::AccountContext> accountContext_ {};
  };
