...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetWorkspacesResponseBody::Workspace> & getWorkspace() const { DARABONBA_PTR_GET_CONST(workspace_, vector<GetWorkspacesResponseBody::Workspace>) };
    inline vector<GetWorkspacesResponseBody::Workspace> getWorkspace() { DARABONBA_PTR_GET(workspace_, vector<GetWorkspacesResponseBody::Workspace>) };
    inline GetWorkspacesResponseBody& setWorkspace(const vector<GetWorkspacesResponseBody::Workspace> & workspace) { DARABONBA_PTR_SET_VALUE(workspace_, workspace) };
    inline GetWorkspacesResponseBody& setWorkspace(vector<GetWorkspacesResponseBody::Workspace> && workspace) { DARABONBA_PTR_SET_RVALUE(workspace_, workspace) };


  protected:
    // requestId
    shared_ptr<string> requestId_ {};
    shared_ptr<vector<GetWorkspacesResponseBody::Workspace>> workspace_ {};
  };
