...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInstanceHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, DeleteInstanceHeaders::AccountContext) };
    inline DeleteInstanceHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, DeleteInstanceHeaders::AccountContext) };
    inline DeleteInstanceHeaders& setAccountContext(const DeleteInstanceHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline DeleteInstanceHeaders& setAccountContext(DeleteInstanceHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<DeleteInstanceHeaders::AccountContext> accountContext_ {};
  };
