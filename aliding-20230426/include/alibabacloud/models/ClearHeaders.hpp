...
namespace Models
{
  ...
  public:
    ...
    inline const ClearHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, ClearHeaders::AccountContext) };
    inline ClearHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, ClearHeaders::AccountContext) };
    inline ClearHeaders& setAccountContext(const ClearHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline ClearHeaders& setAccountContext(ClearHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<ClearHeaders::AccountContext> accountContext_ {};
  };
