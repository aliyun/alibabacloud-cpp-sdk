...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actionExecutor_ == nullptr
        ...
        && return this->modifiedTimeGMT_ == nullptr && return this->originator_ == nullptr && return this->processCode_ == nullptr && return this->processInstanceId_ == nullptr && return this->requestId_ == nullptr
        && return this->title_ == nullptr && return this->vendorRequestId_ == nullptr && return this->vendorType_ == nullptr && return this->version_ == nullptr; };
