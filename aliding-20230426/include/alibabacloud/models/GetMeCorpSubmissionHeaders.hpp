...
namespace Models
{
  ...
  public:
    ...
    inline const GetMeCorpSubmissionHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetMeCorpSubmissionHeaders::AccountContext) };
    inline GetMeCorpSubmissionHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetMeCorpSubmissionHeaders::AccountContext) };
    inline GetMeCorpSubmissionHeaders& setAccountContext(const GetMeCorpSubmissionHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetMeCorpSubmissionHeaders& setAccountContext(GetMeCorpSubmissionHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetMeCorpSubmissionHeaders::AccountContext> accountContext_ {};
  };
