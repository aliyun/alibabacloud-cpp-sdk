...
namespace Models
{
  ...
  public:
    ...
    inline const GetOperationRecordsHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, GetOperationRecordsHeaders::AccountContext) };
    inline GetOperationRecordsHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, GetOperationRecordsHeaders::AccountContext) };
    inline GetOperationRecordsHeaders& setAccountContext(const GetOperationRecordsHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline GetOperationRecordsHeaders& setAccountContext(GetOperationRecordsHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<GetOperationRecordsHeaders::AccountContext> accountContext_ {};
  };
