...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateScheduleConfSettingsHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateScheduleConfSettingsHeaders::AccountContext) };
    inline UpdateScheduleConfSettingsHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateScheduleConfSettingsHeaders::AccountContext) };
    inline UpdateScheduleConfSettingsHeaders& setAccountContext(const UpdateScheduleConfSettingsHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateScheduleConfSettingsHeaders& setAccountContext(UpdateScheduleConfSettingsHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateScheduleConfSettingsHeaders::AccountContext> accountContext_ {};
  };
