...
namespace Models
{
  ...
  public:
    ...
    inline const UnsubscribeCalendarHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UnsubscribeCalendarHeaders::AccountContext) };
    inline UnsubscribeCalendarHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UnsubscribeCalendarHeaders::AccountContext) };
    inline UnsubscribeCalendarHeaders& setAccountContext(const UnsubscribeCalendarHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UnsubscribeCalendarHeaders& setAccountContext(UnsubscribeCalendarHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UnsubscribeCalendarHeaders::AccountContext> accountContext_ {};
  };
