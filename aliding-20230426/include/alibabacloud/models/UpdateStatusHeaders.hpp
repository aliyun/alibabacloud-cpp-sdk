...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateStatusHeaders::AccountContext & getAccountContext() const { DARABONBA_PTR_GET_CONST(accountContext_, UpdateStatusHeaders::AccountContext) };
    inline UpdateStatusHeaders::AccountContext getAccountContext() { DARABONBA_PTR_GET(accountContext_, UpdateStatusHeaders::AccountContext) };
    inline UpdateStatusHeaders& setAccountContext(const UpdateStatusHeaders::AccountContext & accountContext) { DARABONBA_PTR_SET_VALUE(accountContext_, accountContext) };
    inline UpdateStatusHeaders& setAccountContext(UpdateStatusHeaders::AccountContext && accountContext) { DARABONBA_PTR_SET_RVALUE(accountContext_, accountContext) };


  protected:
    shared_ptr<map<string, string>> commonHeaders_ {};
    shared_ptr<UpdateStatusHeaders::AccountContext> accountContext_ {};
  };
