...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWorkspaceMembersResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateWorkspaceMembersResponseBody) };
    inline UpdateWorkspaceMembersResponseBody body() { DARABONBA_PTR_GET(body_, UpdateWorkspaceMembersResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateWorkspaceMembersResponseBody> body_ = nullptr;
  };
