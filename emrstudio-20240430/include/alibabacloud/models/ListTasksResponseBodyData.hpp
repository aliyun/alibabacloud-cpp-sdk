...
#ifndef ALIBABACLOUD_MODELS_LISTTASKSRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_LISTTASKSRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListTasksResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListTasksResponseBodyData& obj) { 
    ...
    ListTasksResponseBodyData() = default ;
    ListTasksResponseBodyData(const ListTasksResponseBodyData &) = default ;
    ListTasksResponseBodyData(ListTasksResponseBodyData &&) = default ;
    ListTasksResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListTasksResponseBodyData() = default ;
    ListTasksResponseBodyData& operator=(const ListTasksResponseBodyData &) = default ;
    ListTasksResponseBodyData& operator=(ListTasksResponseBodyData &&) = default ;
    ...
    virtual bool empty() const override { return this->createTime_ == nullptr
        ...
        && return this->updateTime_ == nullptr && return this->version_ == nullptr; };
    // createTime Field Functions 
    bool hasCreateTime() const { return this->createTime_ != nullptr;};
    void deleteCreateTime() { this->createTime_ = nullptr;};
    inline string createTime() const { DARABONBA_PTR_GET_DEFAULT(createTime_, "") };
    inline ListTasksResponseBodyData& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListTasksResponseBodyData& setDelayTime(int32_t delayTime) { DARABONBA_PTR_SET_VALUE(delayTime_, delayTime) };
    ...
    inline ListTasksResponseBodyData& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListTasksResponseBodyData& setFailRetryInterval(int32_t failRetryInterval) { DARABONBA_PTR_SET_VALUE(failRetryInterval_, failRetryInterval) };
    ...
    inline ListTasksResponseBodyData& setFailRetryTimes(int32_t failRetryTimes) { DARABONBA_PTR_SET_VALUE(failRetryTimes_, failRetryTimes) };
    ...
    inline ListTasksResponseBodyData& setFlag(string flag) { DARABONBA_PTR_SET_VALUE(flag_, flag) };
    ...
    inline ListTasksResponseBodyData& setProjectId(string projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline ListTasksResponseBodyData& setResourceIds(string resourceIds) { DARABONBA_PTR_SET_VALUE(resourceIds_, resourceIds) };
    ...
    inline ListTasksResponseBodyData& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
    ...
    inline ListTasksResponseBodyData& setTaskName(string taskName) { DARABONBA_PTR_SET_VALUE(taskName_, taskName) };
    ...
    inline ListTasksResponseBodyData& setTaskParams(string taskParams) { DARABONBA_PTR_SET_VALUE(taskParams_, taskParams) };
    ...
    inline ListTasksResponseBodyData& setTaskPriority(string taskPriority) { DARABONBA_PTR_SET_VALUE(taskPriority_, taskPriority) };
    ...
    inline ListTasksResponseBodyData& setTaskType(string taskType) { DARABONBA_PTR_SET_VALUE(taskType_, taskType) };
    ...
    inline ListTasksResponseBodyData& setTimeout(int32_t timeout) { DARABONBA_PTR_SET_VALUE(timeout_, timeout) };
    ...
    inline ListTasksResponseBodyData& setTimeoutFlag(string timeoutFlag) { DARABONBA_PTR_SET_VALUE(timeoutFlag_, timeoutFlag) };
    ...
    inline ListTasksResponseBodyData& setTimeoutNotifyStrategy(string timeoutNotifyStrategy) { DARABONBA_PTR_SET_VALUE(timeoutNotifyStrategy_, timeoutNotifyStrategy) };
    ...
    inline ListTasksResponseBodyData& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline ListTasksResponseBodyData& setVersion(string version) { DARABONBA_PTR_SET_VALUE(version_, version) };
