...
namespace Models
{
  ...
  public:
    ...
    inline UpdateWorkflowRequest& setAlertGroupId(string alertGroupId) { DARABONBA_PTR_SET_VALUE(alertGroupId_, alertGroupId) };
    ...
    inline UpdateWorkflowRequest& setAlertStrategy(string alertStrategy) { DARABONBA_PTR_SET_VALUE(alertStrategy_, alertStrategy) };
    ...
    inline UpdateWorkflowRequest& setTaskDefinitionJsonValue(string taskDefinitionJsonValue) { DARABONBA_PTR_SET_VALUE(taskDefinitionJsonValue_, taskDefinitionJsonValue) };
    ...
    inline UpdateWorkflowRequest& setTaskRelationJsonValue(string taskRelationJsonValue) { DARABONBA_PTR_SET_VALUE(taskRelationJsonValue_, taskRelationJsonValue) };
    ...
    inline UpdateWorkflowRequest& setCronExpr(string cronExpr) { DARABONBA_PTR_SET_VALUE(cronExpr_, cronExpr) };
    ...
    inline UpdateWorkflowRequest& setExecutionType(string executionType) { DARABONBA_PTR_SET_VALUE(executionType_, executionType) };
    ...
    inline UpdateWorkflowRequest& setFailureStrategy(string failureStrategy) { DARABONBA_PTR_SET_VALUE(failureStrategy_, failureStrategy) };
    ...
    inline UpdateWorkflowRequest& setParentDirectoryId(string parentDirectoryId) { DARABONBA_PTR_SET_VALUE(parentDirectoryId_, parentDirectoryId) };
    ...
    inline UpdateWorkflowRequest& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline UpdateWorkflowRequest& setScheduleEndTime(string scheduleEndTime) { DARABONBA_PTR_SET_VALUE(scheduleEndTime_, scheduleEndTime) };
    ...
    inline UpdateWorkflowRequest& setScheduleStartTime(string scheduleStartTime) { DARABONBA_PTR_SET_VALUE(scheduleStartTime_, scheduleStartTime) };
    ...
    inline UpdateWorkflowRequest& setScheduleState(string scheduleState) { DARABONBA_PTR_SET_VALUE(scheduleState_, scheduleState) };
    ...
    inline UpdateWorkflowRequest& setTaskDefinitionJson(string taskDefinitionJson) { DARABONBA_PTR_SET_VALUE(taskDefinitionJson_, taskDefinitionJson) };
    ...
    inline UpdateWorkflowRequest& setTaskRelationJson(string taskRelationJson) { DARABONBA_PTR_SET_VALUE(taskRelationJson_, taskRelationJson) };
    ...
    inline UpdateWorkflowRequest& setTimeout(int32_t timeout) { DARABONBA_PTR_SET_VALUE(timeout_, timeout) };
    ...
    inline UpdateWorkflowRequest& setWorkflowInstancePriority(string workflowInstancePriority) { DARABONBA_PTR_SET_VALUE(workflowInstancePriority_, workflowInstancePriority) };
    ...
    inline UpdateWorkflowRequest& setWorkflowParams(string workflowParams) { DARABONBA_PTR_SET_VALUE(workflowParams_, workflowParams) };
    ...
    inline UpdateWorkflowRequest& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
