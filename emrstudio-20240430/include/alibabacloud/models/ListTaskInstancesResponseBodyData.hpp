...
#ifndef ALIBABACLOUD_MODELS_LISTTASKINSTANCESRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_LISTTASKINSTANCESRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListTaskInstancesResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListTaskInstancesResponseBodyData& obj) { 
    ...
    ListTaskInstancesResponseBodyData() = default ;
    ListTaskInstancesResponseBodyData(const ListTaskInstancesResponseBodyData &) = default ;
    ListTaskInstancesResponseBodyData(ListTaskInstancesResponseBodyData &&) = default ;
    ListTaskInstancesResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListTaskInstancesResponseBodyData() = default ;
    ListTaskInstancesResponseBodyData& operator=(const ListTaskInstancesResponseBodyData &) = default ;
    ListTaskInstancesResponseBodyData& operator=(ListTaskInstancesResponseBodyData &&) = default ;
    ...
    inline ListTaskInstancesResponseBodyData& setDryRun(string dryRun) { DARABONBA_PTR_SET_VALUE(dryRun_, dryRun) };
    ...
    inline ListTaskInstancesResponseBodyData& setEmrClusterId(string emrClusterId) { DARABONBA_PTR_SET_VALUE(emrClusterId_, emrClusterId) };
    ...
    inline ListTaskInstancesResponseBodyData& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ListTaskInstancesResponseBodyData& setExternalAppId(string externalAppId) { DARABONBA_PTR_SET_VALUE(externalAppId_, externalAppId) };
    ...
    inline ListTaskInstancesResponseBodyData& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline ListTaskInstancesResponseBodyData& setRetryTimes(int32_t retryTimes) { DARABONBA_PTR_SET_VALUE(retryTimes_, retryTimes) };
    ...
    inline ListTaskInstancesResponseBodyData& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ListTaskInstancesResponseBodyData& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListTaskInstancesResponseBodyData& setSubmitTime(string submitTime) { DARABONBA_PTR_SET_VALUE(submitTime_, submitTime) };
    ...
    inline ListTaskInstancesResponseBodyData& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
    ...
    inline ListTaskInstancesResponseBodyData& setTaskInstanceId(string taskInstanceId) { DARABONBA_PTR_SET_VALUE(taskInstanceId_, taskInstanceId) };
    ...
    inline ListTaskInstancesResponseBodyData& setTaskInstanceName(string taskInstanceName) { DARABONBA_PTR_SET_VALUE(taskInstanceName_, taskInstanceName) };
    ...
    inline ListTaskInstancesResponseBodyData& setTaskParams(string taskParams) { DARABONBA_PTR_SET_VALUE(taskParams_, taskParams) };
    ...
    inline ListTaskInstancesResponseBodyData& setTaskType(string taskType) { DARABONBA_PTR_SET_VALUE(taskType_, taskType) };
    ...
    inline ListTaskInstancesResponseBodyData& setTaskVersion(string taskVersion) { DARABONBA_PTR_SET_VALUE(taskVersion_, taskVersion) };
    ...
    inline ListTaskInstancesResponseBodyData& setWorkflowInstanceId(string workflowInstanceId) { DARABONBA_PTR_SET_VALUE(workflowInstanceId_, workflowInstanceId) };
