...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListWorkflowsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListWorkflowsResponseBodyData>) };
    inline vector<ListWorkflowsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListWorkflowsResponseBodyData>) };
    inline ListWorkflowsResponseBody& setData(const vector<ListWorkflowsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListWorkflowsResponseBody& setData(vector<ListWorkflowsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListWorkflowsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListWorkflowsResponseBody& setTotalSize(int32_t totalSize) { DARABONBA_PTR_SET_VALUE(totalSize_, totalSize) };


  protected:
    std::shared_ptr<vector<ListWorkflowsResponseBodyData>> data_ = nullptr;
