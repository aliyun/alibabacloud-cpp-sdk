...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListTaskInstancesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListTaskInstancesResponseBodyData>) };
    inline vector<ListTaskInstancesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListTaskInstancesResponseBodyData>) };
    inline ListTaskInstancesResponseBody& setData(const vector<ListTaskInstancesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTaskInstancesResponseBody& setData(vector<ListTaskInstancesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListTaskInstancesResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListTaskInstancesResponseBody& setTotalSize(int32_t totalSize) { DARABONBA_PTR_SET_VALUE(totalSize_, totalSize) };


  protected:
    std::shared_ptr<vector<ListTaskInstancesResponseBodyData>> data_ = nullptr;
