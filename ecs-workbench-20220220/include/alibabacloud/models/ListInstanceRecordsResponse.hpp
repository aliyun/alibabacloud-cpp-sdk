...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceRecordsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceRecordsResponseBody) };
    inline ListInstanceRecordsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstanceRecordsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstanceRecordsResponseBody> body_ {};
  };
