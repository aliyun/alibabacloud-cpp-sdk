...
namespace Models
{
  ...
  public:
    ...
    inline const SetInstanceRecordConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetInstanceRecordConfigResponseBody) };
    inline SetInstanceRecordConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, SetInstanceRecordConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetInstanceRecordConfigResponseBody> body_ {};
  };
