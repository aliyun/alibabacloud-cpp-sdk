...
namespace Models
{
  ...
  public:
    ...
    inline const LoginInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, LoginInstanceResponseBody) };
    inline LoginInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, LoginInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<LoginInstanceResponseBody> body_ {};
  };
