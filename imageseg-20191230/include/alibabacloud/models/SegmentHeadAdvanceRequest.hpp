...
#ifndef ALIBABACLOUD_MODELS_SEGMENTHEADADVANCEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SEGMENTHEADADVANCEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SegmentHeadAdvanceRequest& obj) { 
      DARABONBA_TO_JSON(ImageURL, imageURLObject_);
      DARABONBA_PTR_TO_JSON(ReturnForm, returnForm_);
    };
    friend void from_json(const Darabonba::Json& j, SegmentHeadAdvanceRequest& obj) { 
      DARABONBA_FROM_JSON(ImageURL, imageURLObject_);
      DARABONBA_PTR_FROM_JSON(ReturnForm, returnForm_);
    };
    SegmentHeadAdvanceRequest() = default ;
    SegmentHeadAdvanceRequest(const SegmentHeadAdvanceRequest &) = default ;
    SegmentHeadAdvanceRequest(SegmentHeadAdvanceRequest &&) = default ;
    SegmentHeadAdvanceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SegmentHeadAdvanceRequest() = default ;
    SegmentHeadAdvanceRequest& operator=(const SegmentHeadAdvanceRequest &) = default ;
    SegmentHeadAdvanceRequest& operator=(SegmentHeadAdvanceRequest &&) = default ;
    ...
    inline SegmentHeadAdvanceRequest& setImageURLObject(shared_ptr<Darabonba::IStream> imageURLObject) { DARABONBA_SET_VALUE(imageURLObject_, imageURLObject) };
    ...
    inline SegmentHeadAdvanceRequest& setReturnForm(string returnForm) { DARABONBA_PTR_SET_VALUE(returnForm_, returnForm) };
