...
using namespace AlibabaCloud::Imageseg20191230::Models;
namespace AlibabaCloud
{
namespace Imageseg20191230
{

AlibabaCloud::Imageseg20191230::Client::Client(AlibabaCloud::OpenApi::Utils::Models::Config &config): OpenApiClient(config){
 ...
 */
ChangeSkyResponse Client::changeSkyWithOptions(const ChangeSkyRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  ...
  return json(callApi(params, req, runtime)).get<ChangeSkyResponse>();
}
 ...
 * @return ChangeSkyResponse
 */
ChangeSkyResponse Client::changeSky(const ChangeSkyRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return changeSkyWithOptions(request, runtime);
}

ChangeSkyResponse Client::changeSkyAdvance(const ChangeSkyAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  ...
  ChangeSkyRequest changeSkyReq = ChangeSkyRequest();
  Utils::Utils::convert(request, changeSkyReq);
  ...
  if (!!request.hasReplaceImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
    authResponseBody = Utils::Utils::stringifyMapValue(tmpBody);
 ...
 */
ParseFaceResponse Client::parseFaceWithOptions(const ParseFaceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasImageURL()) {
    query["ImageURL"] = request.imageURL();
  ...
  return json(callApi(params, req, runtime)).get<ParseFaceResponse>();
}
 ...
 * @return ParseFaceResponse
 */
ParseFaceResponse Client::parseFace(const ParseFaceRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return parseFaceWithOptions(request, runtime);
}

ParseFaceResponse Client::parseFaceAdvance(const ParseFaceAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  ParseFaceRequest parseFaceReq = ParseFaceRequest();
  Utils::Utils::convert(request, parseFaceReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
 ...
 */
RefineMaskResponse Client::refineMaskWithOptions(const RefineMaskRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasImageURL()) {
  ...
  return json(callApi(params, req, runtime)).get<RefineMaskResponse>();
}
 ...
 * @return RefineMaskResponse
 */
RefineMaskResponse Client::refineMask(const RefineMaskRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return refineMaskWithOptions(request, runtime);
}

RefineMaskResponse Client::refineMaskAdvance(const RefineMaskAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  RefineMaskRequest refineMaskReq = RefineMaskRequest();
  Utils::Utils::convert(request, refineMaskReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
  ...
  if (!!request.hasMaskImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
    authResponseBody = Utils::Utils::stringifyMapValue(tmpBody);
 ...
 */
SegmentBodyResponse Client::segmentBodyWithOptions(const SegmentBodyRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasImageURL()) {
    query["ImageURL"] = request.imageURL();
  ...
  return json(callApi(params, req, runtime)).get<SegmentBodyResponse>();
}
 ...
 * @return SegmentBodyResponse
 */
SegmentBodyResponse Client::segmentBody(const SegmentBodyRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentBodyWithOptions(request, runtime);
}

SegmentBodyResponse Client::segmentBodyAdvance(const SegmentBodyAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentBodyRequest segmentBodyReq = SegmentBodyRequest();
  Utils::Utils::convert(request, segmentBodyReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
 ...
 */
SegmentClothResponse Client::segmentClothWithOptions(const SegmentClothRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasClothClass()) {
  ...
  return json(callApi(params, req, runtime)).get<SegmentClothResponse>();
}
 ...
 * @return SegmentClothResponse
 */
SegmentClothResponse Client::segmentCloth(const SegmentClothRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentClothWithOptions(request, runtime);
}

SegmentClothResponse Client::segmentClothAdvance(const SegmentClothAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentClothRequest segmentClothReq = SegmentClothRequest();
  Utils::Utils::convert(request, segmentClothReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
 ...
 */
SegmentCommodityResponse Client::segmentCommodityWithOptions(const SegmentCommodityRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasImageURL()) {
    query["ImageURL"] = request.imageURL();
  ...
  return json(callApi(params, req, runtime)).get<SegmentCommodityResponse>();
}
 ...
 * @return SegmentCommodityResponse
 */
SegmentCommodityResponse Client::segmentCommodity(const SegmentCommodityRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentCommodityWithOptions(request, runtime);
}

SegmentCommodityResponse Client::segmentCommodityAdvance(const SegmentCommodityAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentCommodityRequest segmentCommodityReq = SegmentCommodityRequest();
  Utils::Utils::convert(request, segmentCommodityReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
 ...
 */
SegmentCommonImageResponse Client::segmentCommonImageWithOptions(const SegmentCommonImageRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasImageURL()) {
    query["ImageURL"] = request.imageURL();
  ...
  return json(callApi(params, req, runtime)).get<SegmentCommonImageResponse>();
}
 ...
 * @return SegmentCommonImageResponse
 */
SegmentCommonImageResponse Client::segmentCommonImage(const SegmentCommonImageRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentCommonImageWithOptions(request, runtime);
}

SegmentCommonImageResponse Client::segmentCommonImageAdvance(const SegmentCommonImageAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentCommonImageRequest segmentCommonImageReq = SegmentCommonImageRequest();
  Utils::Utils::convert(request, segmentCommonImageReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
 ...
 */
SegmentFoodResponse Client::segmentFoodWithOptions(const SegmentFoodRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasImageURL()) {
    query["ImageURL"] = request.imageURL();
  ...
  return json(callApi(params, req, runtime)).get<SegmentFoodResponse>();
}
 ...
 * @return SegmentFoodResponse
 */
SegmentFoodResponse Client::segmentFood(const SegmentFoodRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentFoodWithOptions(request, runtime);
}

SegmentFoodResponse Client::segmentFoodAdvance(const SegmentFoodAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentFoodRequest segmentFoodReq = SegmentFoodRequest();
  Utils::Utils::convert(request, segmentFoodReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
 ...
 */
SegmentHDBodyResponse Client::segmentHDBodyWithOptions(const SegmentHDBodyRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasImageURL()) {
    query["ImageURL"] = request.imageURL();
  ...
  return json(callApi(params, req, runtime)).get<SegmentHDBodyResponse>();
}
 ...
 * @return SegmentHDBodyResponse
 */
SegmentHDBodyResponse Client::segmentHDBody(const SegmentHDBodyRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentHDBodyWithOptions(request, runtime);
}

SegmentHDBodyResponse Client::segmentHDBodyAdvance(const SegmentHDBodyAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentHDBodyRequest segmentHDBodyReq = SegmentHDBodyRequest();
  Utils::Utils::convert(request, segmentHDBodyReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
 ...
 */
SegmentHDCommonImageResponse Client::segmentHDCommonImageWithOptions(const SegmentHDCommonImageRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasImageUrl()) {
    body["ImageUrl"] = request.imageUrl();
  ...
  return json(callApi(params, req, runtime)).get<SegmentHDCommonImageResponse>();
}
 ...
 * @return SegmentHDCommonImageResponse
 */
SegmentHDCommonImageResponse Client::segmentHDCommonImage(const SegmentHDCommonImageRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentHDCommonImageWithOptions(request, runtime);
}

SegmentHDCommonImageResponse Client::segmentHDCommonImageAdvance(const SegmentHDCommonImageAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentHDCommonImageRequest segmentHDCommonImageReq = SegmentHDCommonImageRequest();
  Utils::Utils::convert(request, segmentHDCommonImageReq);
  if (!!request.hasImageUrlObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
 ...
 */
SegmentHDSkyResponse Client::segmentHDSkyWithOptions(const SegmentHDSkyRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasImageURL()) {
    body["ImageURL"] = request.imageURL();
  ...
  return json(callApi(params, req, runtime)).get<SegmentHDSkyResponse>();
}
 ...
 * @return SegmentHDSkyResponse
 */
SegmentHDSkyResponse Client::segmentHDSky(const SegmentHDSkyRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentHDSkyWithOptions(request, runtime);
}

SegmentHDSkyResponse Client::segmentHDSkyAdvance(const SegmentHDSkyAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentHDSkyRequest segmentHDSkyReq = SegmentHDSkyRequest();
  Utils::Utils::convert(request, segmentHDSkyReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
 ...
 */
SegmentHairResponse Client::segmentHairWithOptions(const SegmentHairRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasImageURL()) {
    query["ImageURL"] = request.imageURL();
  ...
  return json(callApi(params, req, runtime)).get<SegmentHairResponse>();
}
 ...
 * @return SegmentHairResponse
 */
SegmentHairResponse Client::segmentHair(const SegmentHairRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentHairWithOptions(request, runtime);
}

SegmentHairResponse Client::segmentHairAdvance(const SegmentHairAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentHairRequest segmentHairReq = SegmentHairRequest();
  Utils::Utils::convert(request, segmentHairReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
 ...
 */
SegmentHeadResponse Client::segmentHeadWithOptions(const SegmentHeadRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasImageURL()) {
    query["ImageURL"] = request.imageURL();
  ...
  return json(callApi(params, req, runtime)).get<SegmentHeadResponse>();
}
 ...
 * @return SegmentHeadResponse
 */
SegmentHeadResponse Client::segmentHead(const SegmentHeadRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentHeadWithOptions(request, runtime);
}

SegmentHeadResponse Client::segmentHeadAdvance(const SegmentHeadAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentHeadRequest segmentHeadReq = SegmentHeadRequest();
  Utils::Utils::convert(request, segmentHeadReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
 ...
 */
SegmentSkinResponse Client::segmentSkinWithOptions(const SegmentSkinRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasURL()) {
  ...
  return json(callApi(params, req, runtime)).get<SegmentSkinResponse>();
}
 ...
 * @return SegmentSkinResponse
 */
SegmentSkinResponse Client::segmentSkin(const SegmentSkinRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentSkinWithOptions(request, runtime);
}

SegmentSkinResponse Client::segmentSkinAdvance(const SegmentSkinAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentSkinRequest segmentSkinReq = SegmentSkinRequest();
  Utils::Utils::convert(request, segmentSkinReq);
 ...
 */
SegmentSkyResponse Client::segmentSkyWithOptions(const SegmentSkyRequest &request, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasImageURL()) {
    query["ImageURL"] = request.imageURL();
  ...
  return json(callApi(params, req, runtime)).get<SegmentSkyResponse>();
}
 ...
 * @return SegmentSkyResponse
 */
SegmentSkyResponse Client::segmentSky(const SegmentSkyRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  return segmentSkyWithOptions(request, runtime);
}

SegmentSkyResponse Client::segmentSkyAdvance(const SegmentSkyAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  // Step 0: init client
  if (Darabonba::isNull(_credential)) {
    throw ClientException(json({
      {"code" , "InvalidCredentials"},
  ...
  bool useAccelerate = false;
  map<string, string> authResponseBody = {};
  SegmentSkyRequest segmentSkyReq = SegmentSkyRequest();
  Utils::Utils::convert(request, segmentSkyReq);
  if (!!request.hasImageURLObject()) {
    authResponse = authClient->callApi(authParams, authReq, runtime);
    tmpBody = json(authResponse.at("body"));
    useAccelerate = Darabonba::Convert::boolVal(tmpBody.at("UseAccelerate"));
