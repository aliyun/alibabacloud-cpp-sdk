...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListServerGroupServersResponseBodyServers> & servers() const { DARABONBA_PTR_GET_CONST(servers_, vector<ListServerGroupServersResponseBodyServers>) };
    inline vector<ListServerGroupServersResponseBodyServers> servers() { DARABONBA_PTR_GET(servers_, vector<ListServerGroupServersResponseBodyServers>) };
    inline ListServerGroupServersResponseBody& setServers(const vector<ListServerGroupServersResponseBodyServers> & servers) { DARABONBA_PTR_SET_VALUE(servers_, servers) };
    inline ListServerGroupServersResponseBody& setServers(vector<ListServerGroupServersResponseBodyServers> && servers) { DARABONBA_PTR_SET_RVALUE(servers_, servers) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListServerGroupServersResponseBodyServers>> servers_ = nullptr;
