...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateHealthCheckTemplateAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateHealthCheckTemplateAttributeResponseBody) };
    inline UpdateHealthCheckTemplateAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateHealthCheckTemplateAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateHealthCheckTemplateAttributeResponseBody> body_ {};
  };
