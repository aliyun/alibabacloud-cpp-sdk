...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Rules& setDirection(string direction) { DARABONBA_PTR_SET_VALUE(direction_, direction) };
      ...
      inline Rules& setListenerId(string listenerId) { DARABONBA_PTR_SET_VALUE(listenerId_, listenerId) };
      ...
      inline Rules& setLoadBalancerId(string loadBalancerId) { DARABONBA_PTR_SET_VALUE(loadBalancerId_, loadBalancerId) };
      ...
      inline const vector<Rules::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<Rules::Tags>) };
      inline vector<Rules::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<Rules::Tags>) };
      inline Rules& setTags(const vector<Rules::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
      inline Rules& setTags(vector<Rules::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    protected:
      ...
      // The tags.
      shared_ptr<vector<Rules::Tags>> tags_ {};
    };
