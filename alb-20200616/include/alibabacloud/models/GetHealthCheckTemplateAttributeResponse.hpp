...
namespace Models
{
  ...
  public:
    ...
    inline const GetHealthCheckTemplateAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHealthCheckTemplateAttributeResponseBody) };
    inline GetHealthCheckTemplateAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHealthCheckTemplateAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHealthCheckTemplateAttributeResponseBody> body_ {};
  };
