...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveEntriesFromAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveEntriesFromAclResponseBody) };
    inline RemoveEntriesFromAclResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveEntriesFromAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveEntriesFromAclResponseBody> body_ {};
  };
