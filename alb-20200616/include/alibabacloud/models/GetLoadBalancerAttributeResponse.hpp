...
namespace Models
{
  ...
  public:
    ...
    inline const GetLoadBalancerAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLoadBalancerAttributeResponseBody) };
    inline GetLoadBalancerAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLoadBalancerAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLoadBalancerAttributeResponseBody> body_ {};
  };
