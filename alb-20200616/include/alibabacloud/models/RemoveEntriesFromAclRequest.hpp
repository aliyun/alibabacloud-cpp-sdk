...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & entries() const { DARABONBA_PTR_GET_CONST(entries_, vector<string>) };
    inline vector<string> entries() { DARABONBA_PTR_GET(entries_, vector<string>) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<vector<string>> entries_ = nullptr;
  };
