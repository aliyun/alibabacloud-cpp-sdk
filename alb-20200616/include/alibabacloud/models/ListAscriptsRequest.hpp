...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & AScriptIds() const { DARABONBA_PTR_GET_CONST(AScriptIds_, vector<string>) };
    inline vector<string> AScriptIds() { DARABONBA_PTR_GET(AScriptIds_, vector<string>) };
    ...
    inline const vector<string> & AScriptNames() const { DARABONBA_PTR_GET_CONST(AScriptNames_, vector<string>) };
    inline vector<string> AScriptNames() { DARABONBA_PTR_GET(AScriptNames_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> AScriptIds_ = nullptr;
    // The AScript rule names. You can specify at most 10 names in each call.
    std::shared_ptr<vector<string>> AScriptNames_ = nullptr;
