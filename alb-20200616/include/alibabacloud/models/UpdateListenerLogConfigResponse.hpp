...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateListenerLogConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateListenerLogConfigResponseBody) };
    inline UpdateListenerLogConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateListenerLogConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateListenerLogConfigResponseBody> body_ {};
  };
