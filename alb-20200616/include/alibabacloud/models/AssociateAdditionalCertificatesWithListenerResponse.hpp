...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateAdditionalCertificatesWithListenerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AssociateAdditionalCertificatesWithListenerResponseBody) };
    inline AssociateAdditionalCertificatesWithListenerResponseBody body() { DARABONBA_PTR_GET(body_, AssociateAdditionalCertificatesWithListenerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AssociateAdditionalCertificatesWithListenerResponseBody> body_ = nullptr;
  };
