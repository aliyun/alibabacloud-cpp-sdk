...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAScriptsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAScriptsResponseBody) };
    inline DeleteAScriptsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAScriptsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAScriptsResponseBody> body_ {};
  };
