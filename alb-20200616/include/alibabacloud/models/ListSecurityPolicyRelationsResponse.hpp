...
namespace Models
{
  ...
  public:
    ...
    inline const ListSecurityPolicyRelationsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListSecurityPolicyRelationsResponseBody) };
    inline ListSecurityPolicyRelationsResponseBody body() { DARABONBA_PTR_GET(body_, ListSecurityPolicyRelationsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListSecurityPolicyRelationsResponseBody> body_ = nullptr;
  };
