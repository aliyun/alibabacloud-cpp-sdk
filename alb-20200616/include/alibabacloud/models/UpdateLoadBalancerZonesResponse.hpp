...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLoadBalancerZonesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateLoadBalancerZonesResponseBody) };
    inline UpdateLoadBalancerZonesResponseBody body() { DARABONBA_PTR_GET(body_, UpdateLoadBalancerZonesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateLoadBalancerZonesResponseBody> body_ = nullptr;
  };
