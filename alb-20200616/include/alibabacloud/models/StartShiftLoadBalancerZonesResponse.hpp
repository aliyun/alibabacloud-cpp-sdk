...
namespace Models
{
  ...
  public:
    ...
    inline const StartShiftLoadBalancerZonesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, StartShiftLoadBalancerZonesResponseBody) };
    inline StartShiftLoadBalancerZonesResponseBody body() { DARABONBA_PTR_GET(body_, StartShiftLoadBalancerZonesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<StartShiftLoadBalancerZonesResponseBody> body_ = nullptr;
  };
