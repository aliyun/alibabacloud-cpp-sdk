...
namespace Models
{
  ...
  public:
    ...
    inline const DisableLoadBalancerIpv6InternetResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DisableLoadBalancerIpv6InternetResponseBody) };
    inline DisableLoadBalancerIpv6InternetResponseBody body() { DARABONBA_PTR_GET(body_, DisableLoadBalancerIpv6InternetResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DisableLoadBalancerIpv6InternetResponseBody> body_ = nullptr;
  };
