...
namespace Models
{
  ...
  public:
    ...
    inline const ListAclRelationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAclRelationsResponseBody) };
    inline ListAclRelationsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAclRelationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAclRelationsResponseBody> body_ {};
  };
