...
#ifndef ALIBABACLOUD_MODELS_LISTHEALTHCHECKTEMPLATESRESPONSEBODYHEALTHCHECKTEMPLATES_HPP_
#define ALIBABACLOUD_MODELS_LISTHEALTHCHECKTEMPLATESRESPONSEBODYHEALTHCHECKTEMPLATES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& obj) { 
    ...
    ListHealthCheckTemplatesResponseBodyHealthCheckTemplates() = default ;
    ListHealthCheckTemplatesResponseBodyHealthCheckTemplates(const ListHealthCheckTemplatesResponseBodyHealthCheckTemplates &) = default ;
    ListHealthCheckTemplatesResponseBodyHealthCheckTemplates(ListHealthCheckTemplatesResponseBodyHealthCheckTemplates &&) = default ;
    ListHealthCheckTemplatesResponseBodyHealthCheckTemplates(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHealthCheckTemplatesResponseBodyHealthCheckTemplates() = default ;
    ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& operator=(const ListHealthCheckTemplatesResponseBodyHealthCheckTemplates &) = default ;
    ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& operator=(ListHealthCheckTemplatesResponseBodyHealthCheckTemplates &&) = default ;
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckCodes(const vector<string> & healthCheckCodes) { DARABONBA_PTR_SET_VALUE(healthCheckCodes_, healthCheckCodes) };
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckCodes(vector<string> && healthCheckCodes) { DARABONBA_PTR_SET_RVALUE(healthCheckCodes_, healthCheckCodes) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckConnectPort(int32_t healthCheckConnectPort) { DARABONBA_PTR_SET_VALUE(healthCheckConnectPort_, healthCheckConnectPort) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckHost(string healthCheckHost) { DARABONBA_PTR_SET_VALUE(healthCheckHost_, healthCheckHost) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckHttpVersion(string healthCheckHttpVersion) { DARABONBA_PTR_SET_VALUE(healthCheckHttpVersion_, healthCheckHttpVersion) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckInterval(int32_t healthCheckInterval) { DARABONBA_PTR_SET_VALUE(healthCheckInterval_, healthCheckInterval) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckMethod(string healthCheckMethod) { DARABONBA_PTR_SET_VALUE(healthCheckMethod_, healthCheckMethod) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckPath(string healthCheckPath) { DARABONBA_PTR_SET_VALUE(healthCheckPath_, healthCheckPath) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckProtocol(string healthCheckProtocol) { DARABONBA_PTR_SET_VALUE(healthCheckProtocol_, healthCheckProtocol) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckTemplateId(string healthCheckTemplateId) { DARABONBA_PTR_SET_VALUE(healthCheckTemplateId_, healthCheckTemplateId) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckTemplateName(string healthCheckTemplateName) { DARABONBA_PTR_SET_VALUE(healthCheckTemplateName_, healthCheckTemplateName) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthCheckTimeout(int32_t healthCheckTimeout) { DARABONBA_PTR_SET_VALUE(healthCheckTimeout_, healthCheckTimeout) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setHealthyThreshold(int32_t healthyThreshold) { DARABONBA_PTR_SET_VALUE(healthyThreshold_, healthyThreshold) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };


    // tags Field Functions 
    bool hasTags() const { return this->tags_ != nullptr;};
    void deleteTags() { this->tags_ = nullptr;};
    inline const vector<Models::ListHealthCheckTemplatesResponseBodyHealthCheckTemplatesTags> & tags() const { DARABONBA_PTR_GET_CONST(tags_, vector<Models::ListHealthCheckTemplatesResponseBodyHealthCheckTemplatesTags>) };
    inline vector<Models::ListHealthCheckTemplatesResponseBodyHealthCheckTemplatesTags> tags() { DARABONBA_PTR_GET(tags_, vector<Models::ListHealthCheckTemplatesResponseBodyHealthCheckTemplatesTags>) };
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setTags(const vector<Models::ListHealthCheckTemplatesResponseBodyHealthCheckTemplatesTags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setTags(vector<Models::ListHealthCheckTemplatesResponseBodyHealthCheckTemplatesTags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    inline ListHealthCheckTemplatesResponseBodyHealthCheckTemplates& setUnhealthyThreshold(int32_t unhealthyThreshold) { DARABONBA_PTR_SET_VALUE(unhealthyThreshold_, unhealthyThreshold) };
  ...
  protected:
    ...
    // The tags.
    std::shared_ptr<vector<Models::ListHealthCheckTemplatesResponseBodyHealthCheckTemplatesTags>> tags_ = nullptr;
