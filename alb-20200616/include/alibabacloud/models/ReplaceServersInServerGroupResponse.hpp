...
namespace Models
{
  ...
  public:
    ...
    inline const ReplaceServersInServerGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReplaceServersInServerGroupResponseBody) };
    inline ReplaceServersInServerGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ReplaceServersInServerGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReplaceServersInServerGroupResponseBody> body_ {};
  };
