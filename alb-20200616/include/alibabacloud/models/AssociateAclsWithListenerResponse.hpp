...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateAclsWithListenerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AssociateAclsWithListenerResponseBody) };
    inline AssociateAclsWithListenerResponseBody body() { DARABONBA_PTR_GET(body_, AssociateAclsWithListenerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AssociateAclsWithListenerResponseBody> body_ = nullptr;
  };
