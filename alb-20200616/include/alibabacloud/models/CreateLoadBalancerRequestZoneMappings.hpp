...
namespace Models
{
  ...
  public:
    ...
    inline CreateLoadBalancerRequestZoneMappings& setEipType(string eipType) { DARABONBA_PTR_SET_VALUE(eipType_, eipType) };
    ...
    inline CreateLoadBalancerRequestZoneMappings& setIntranetAddress(string intranetAddress) { DARABONBA_PTR_SET_VALUE(intranetAddress_, intranetAddress) };
