...
#ifndef ALIBABACLOUD_MODELS_LISTRULESRESPONSEBODYRULESRULEACTIONSCORSCONFIG_HPP_
#define ALIBABACLOUD_MODELS_LISTRULESRESPONSEBODYRULESRULEACTIONSCORSCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListRulesResponseBodyRulesRuleActionsCorsConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListRulesResponseBodyRulesRuleActionsCorsConfig& obj) { 
    ...
    ListRulesResponseBodyRulesRuleActionsCorsConfig() = default ;
    ListRulesResponseBodyRulesRuleActionsCorsConfig(const ListRulesResponseBodyRulesRuleActionsCorsConfig &) = default ;
    ListRulesResponseBodyRulesRuleActionsCorsConfig(ListRulesResponseBodyRulesRuleActionsCorsConfig &&) = default ;
    ListRulesResponseBodyRulesRuleActionsCorsConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListRulesResponseBodyRulesRuleActionsCorsConfig() = default ;
    ListRulesResponseBodyRulesRuleActionsCorsConfig& operator=(const ListRulesResponseBodyRulesRuleActionsCorsConfig &) = default ;
    ListRulesResponseBodyRulesRuleActionsCorsConfig& operator=(ListRulesResponseBodyRulesRuleActionsCorsConfig &&) = default ;
    ...
    inline ListRulesResponseBodyRulesRuleActionsCorsConfig& setAllowCredentials(string allowCredentials) { DARABONBA_PTR_SET_VALUE(allowCredentials_, allowCredentials) };
    ...
    inline ListRulesResponseBodyRulesRuleActionsCorsConfig& setAllowHeaders(const vector<string> & allowHeaders) { DARABONBA_PTR_SET_VALUE(allowHeaders_, allowHeaders) };
    inline ListRulesResponseBodyRulesRuleActionsCorsConfig& setAllowHeaders(vector<string> && allowHeaders) { DARABONBA_PTR_SET_RVALUE(allowHeaders_, allowHeaders) };
    ...
    inline ListRulesResponseBodyRulesRuleActionsCorsConfig& setAllowMethods(const vector<string> & allowMethods) { DARABONBA_PTR_SET_VALUE(allowMethods_, allowMethods) };
    inline ListRulesResponseBodyRulesRuleActionsCorsConfig& setAllowMethods(vector<string> && allowMethods) { DARABONBA_PTR_SET_RVALUE(allowMethods_, allowMethods) };
    ...
    inline ListRulesResponseBodyRulesRuleActionsCorsConfig& setAllowOrigin(const vector<string> & allowOrigin) { DARABONBA_PTR_SET_VALUE(allowOrigin_, allowOrigin) };
    inline ListRulesResponseBodyRulesRuleActionsCorsConfig& setAllowOrigin(vector<string> && allowOrigin) { DARABONBA_PTR_SET_RVALUE(allowOrigin_, allowOrigin) };
    ...
    inline ListRulesResponseBodyRulesRuleActionsCorsConfig& setExposeHeaders(const vector<string> & exposeHeaders) { DARABONBA_PTR_SET_VALUE(exposeHeaders_, exposeHeaders) };
    inline ListRulesResponseBodyRulesRuleActionsCorsConfig& setExposeHeaders(vector<string> && exposeHeaders) { DARABONBA_PTR_SET_RVALUE(exposeHeaders_, exposeHeaders) };
    ...
    inline ListRulesResponseBodyRulesRuleActionsCorsConfig& setMaxAge(int64_t maxAge) { DARABONBA_PTR_SET_VALUE(maxAge_, maxAge) };
