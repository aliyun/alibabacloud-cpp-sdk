...
namespace Models
{
  ...
  public:
    ...
    inline GetListenerHealthStatusResponseBodyListenerHealthStatusServerGroupInfosNonNormalServersReason& setActualResponse(string actualResponse) { DARABONBA_PTR_SET_VALUE(actualResponse_, actualResponse) };
    ...
    inline GetListenerHealthStatusResponseBodyListenerHealthStatusServerGroupInfosNonNormalServersReason& setExpectedResponse(string expectedResponse) { DARABONBA_PTR_SET_VALUE(expectedResponse_, expectedResponse) };
