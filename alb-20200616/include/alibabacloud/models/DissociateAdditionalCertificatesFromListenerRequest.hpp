...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DissociateAdditionalCertificatesFromListenerRequest::Certificates> & getCertificates() const { DARABONBA_PTR_GET_CONST(certificates_, vector<DissociateAdditionalCertificatesFromListenerRequest::Certificates>) };
    inline vector<DissociateAdditionalCertificatesFromListenerRequest::Certificates> getCertificates() { DARABONBA_PTR_GET(certificates_, vector<DissociateAdditionalCertificatesFromListenerRequest::Certificates>) };
    inline DissociateAdditionalCertificatesFromListenerRequest& setCertificates(const vector<DissociateAdditionalCertificatesFromListenerRequest::Certificates> & certificates) { DARABONBA_PTR_SET_VALUE(certificates_, certificates) };
    inline DissociateAdditionalCertificatesFromListenerRequest& setCertificates(vector<DissociateAdditionalCertificatesFromListenerRequest::Certificates> && certificates) { DARABONBA_PTR_SET_RVALUE(certificates_, certificates) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<DissociateAdditionalCertificatesFromListenerRequest::Certificates>> certificates_ {};
