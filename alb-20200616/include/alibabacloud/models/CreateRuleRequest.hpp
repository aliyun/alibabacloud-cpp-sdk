...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateRuleRequest::RuleActions> & getRuleActions() const { DARABONBA_PTR_GET_CONST(ruleActions_, vector<CreateRuleRequest::RuleActions>) };
    inline vector<CreateRuleRequest::RuleActions> getRuleActions() { DARABONBA_PTR_GET(ruleActions_, vector<CreateRuleRequest::RuleActions>) };
    inline CreateRuleRequest& setRuleActions(const vector<CreateRuleRequest::RuleActions> & ruleActions) { DARABONBA_PTR_SET_VALUE(ruleActions_, ruleActions) };
    inline CreateRuleRequest& setRuleActions(vector<CreateRuleRequest::RuleActions> && ruleActions) { DARABONBA_PTR_SET_RVALUE(ruleActions_, ruleActions) };
    ...
    inline const vector<CreateRuleRequest::RuleConditions> & getRuleConditions() const { DARABONBA_PTR_GET_CONST(ruleConditions_, vector<CreateRuleRequest::RuleConditions>) };
    inline vector<CreateRuleRequest::RuleConditions> getRuleConditions() { DARABONBA_PTR_GET(ruleConditions_, vector<CreateRuleRequest::RuleConditions>) };
    inline CreateRuleRequest& setRuleConditions(const vector<CreateRuleRequest::RuleConditions> & ruleConditions) { DARABONBA_PTR_SET_VALUE(ruleConditions_, ruleConditions) };
    inline CreateRuleRequest& setRuleConditions(vector<CreateRuleRequest::RuleConditions> && ruleConditions) { DARABONBA_PTR_SET_RVALUE(ruleConditions_, ruleConditions) };
    ...
    inline const vector<CreateRuleRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateRuleRequest::Tag>) };
    inline vector<CreateRuleRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateRuleRequest::Tag>) };
    inline CreateRuleRequest& setTag(const vector<CreateRuleRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateRuleRequest& setTag(vector<CreateRuleRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<CreateRuleRequest::RuleActions>> ruleActions_ {};
    // The match conditions of the forwarding rule.
    // 
    // This parameter is required.
    shared_ptr<vector<CreateRuleRequest::RuleConditions>> ruleConditions_ {};
    ...
    // The tags.
    shared_ptr<vector<CreateRuleRequest::Tag>> tag_ {};
  };
