...
namespace Models
{
  ...
  public:
    ...
    inline GetLoadBalancerAttributeResponseBodyTags& setKey(string key) { DARABONBA_PTR_SET_VALUE(key_, key) };
    ...
    inline GetLoadBalancerAttributeResponseBodyTags& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
