...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<Rules::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<Rules::Tag>) };
      inline vector<Rules::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<Rules::Tag>) };
      inline Rules& setTag(const vector<Rules::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
      inline Rules& setTag(vector<Rules::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline const vector<CreateRulesRequest::Rules> & getRules() const { DARABONBA_PTR_GET_CONST(rules_, vector<CreateRulesRequest::Rules>) };
    inline vector<CreateRulesRequest::Rules> getRules() { DARABONBA_PTR_GET(rules_, vector<CreateRulesRequest::Rules>) };
    inline CreateRulesRequest& setRules(const vector<CreateRulesRequest::Rules> & rules) { DARABONBA_PTR_SET_VALUE(rules_, rules) };
    inline CreateRulesRequest& setRules(vector<CreateRulesRequest::Rules> && rules) { DARABONBA_PTR_SET_RVALUE(rules_, rules) };
