...
namespace Models
{
  ...
  public:
    ...
    inline const ListAScriptsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAScriptsResponseBody) };
    inline ListAScriptsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAScriptsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAScriptsResponseBody> body_ {};
  };
