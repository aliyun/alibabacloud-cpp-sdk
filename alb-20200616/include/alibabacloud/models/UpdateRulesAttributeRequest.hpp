...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateRulesAttributeRequestRules> & rules() const { DARABONBA_PTR_GET_CONST(rules_, vector<UpdateRulesAttributeRequestRules>) };
    inline vector<UpdateRulesAttributeRequestRules> rules() { DARABONBA_PTR_GET(rules_, vector<UpdateRulesAttributeRequestRules>) };
    inline UpdateRulesAttributeRequest& setRules(const vector<UpdateRulesAttributeRequestRules> & rules) { DARABONBA_PTR_SET_VALUE(rules_, rules) };
    inline UpdateRulesAttributeRequest& setRules(vector<UpdateRulesAttributeRequestRules> && rules) { DARABONBA_PTR_SET_RVALUE(rules_, rules) };
  ...
  protected:
    ...
    std::shared_ptr<vector<UpdateRulesAttributeRequestRules>> rules_ = nullptr;
  };
