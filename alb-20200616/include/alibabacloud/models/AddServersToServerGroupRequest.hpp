...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AddServersToServerGroupRequestServers> & servers() const { DARABONBA_PTR_GET_CONST(servers_, vector<AddServersToServerGroupRequestServers>) };
    inline vector<AddServersToServerGroupRequestServers> servers() { DARABONBA_PTR_GET(servers_, vector<AddServersToServerGroupRequestServers>) };
    inline AddServersToServerGroupRequest& setServers(const vector<AddServersToServerGroupRequestServers> & servers) { DARABONBA_PTR_SET_VALUE(servers_, servers) };
    inline AddServersToServerGroupRequest& setServers(vector<AddServersToServerGroupRequestServers> && servers) { DARABONBA_PTR_SET_RVALUE(servers_, servers) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<vector<AddServersToServerGroupRequestServers>> servers_ = nullptr;
  };
