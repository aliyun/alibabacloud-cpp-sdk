...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHealthCheckTemplateResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateHealthCheckTemplateResponseBody) };
    inline CreateHealthCheckTemplateResponseBody body() { DARABONBA_PTR_GET(body_, CreateHealthCheckTemplateResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateHealthCheckTemplateResponseBody> body_ = nullptr;
  };
