...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->eipType_ != nullptr
    ...
    inline UpdateLoadBalancerZonesRequestZoneMappings& setIntranetAddress(string intranetAddress) { DARABONBA_PTR_SET_VALUE(intranetAddress_, intranetAddress) };
