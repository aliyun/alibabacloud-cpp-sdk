...
namespace Models
{
  ...
  public:
    ...
    inline const EnableLoadBalancerAccessLogResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, EnableLoadBalancerAccessLogResponseBody) };
    inline EnableLoadBalancerAccessLogResponseBody body() { DARABONBA_PTR_GET(body_, EnableLoadBalancerAccessLogResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<EnableLoadBalancerAccessLogResponseBody> body_ = nullptr;
  };
