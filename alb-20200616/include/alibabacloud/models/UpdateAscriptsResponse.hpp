...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAScriptsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateAScriptsResponseBody) };
    inline UpdateAScriptsResponseBody body() { DARABONBA_PTR_GET(body_, UpdateAScriptsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateAScriptsResponseBody> body_ = nullptr;
  };
