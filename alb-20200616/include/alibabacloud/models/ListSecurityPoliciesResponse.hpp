...
namespace Models
{
  ...
  public:
    ...
    inline const ListSecurityPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSecurityPoliciesResponseBody) };
    inline ListSecurityPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSecurityPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSecurityPoliciesResponseBody> body_ {};
  };
