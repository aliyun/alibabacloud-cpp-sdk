...
namespace Models
{
  ...
  public:
    ...
    inline CreateResourceRequest& setBody(const Darabonba::Json & body) { DARABONBA_SET_VALUE(body_, body) };
    inline CreateResourceRequest& setBody(Darabonba::Json & body) { DARABONBA_SET_RVALUE(body_, body) };
    ...
    inline CreateResourceRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline CreateResourceRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
