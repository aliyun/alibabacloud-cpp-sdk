...
namespace Models
{
  ...
  public:
    ...
    inline const GetPriceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPriceResponseBody) };
    inline GetPriceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPriceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPriceResponseBody> body_ {};
  };
