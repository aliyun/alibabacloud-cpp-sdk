...
#ifndef ALIBABACLOUD_MODELS_GETRESOURCETYPEHEADERS_HPP_
#define ALIBABACLOUD_MODELS_GETRESOURCETYPEHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetResourceTypeHeaders& obj) { 
      DARABONBA_PTR_TO_JSON(commonHeaders, commonHeaders_);
      DARABONBA_PTR_TO_JSON(x-acs-accept-language, xAcsAcceptLanguage_);
    };
    friend void from_json(const Darabonba::Json& j, GetResourceTypeHeaders& obj) { 
      DARABONBA_PTR_FROM_JSON(commonHeaders, commonHeaders_);
      DARABONBA_PTR_FROM_JSON(x-acs-accept-language, xAcsAcceptLanguage_);
    };
    GetResourceTypeHeaders() = default ;
    GetResourceTypeHeaders(const GetResourceTypeHeaders &) = default ;
    GetResourceTypeHeaders(GetResourceTypeHeaders &&) = default ;
    GetResourceTypeHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetResourceTypeHeaders() = default ;
    GetResourceTypeHeaders& operator=(const GetResourceTypeHeaders &) = default ;
    GetResourceTypeHeaders& operator=(GetResourceTypeHeaders &&) = default ;
