...
#ifndef ALIBABACLOUD_MODELS_CREATERESOURCESHARERESPONSEBODYRESOURCESHARE_HPP_
#define ALIBABACLOUD_MODELS_CREATERESOURCESHARERESPONSEBODYRESOURCESHARE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateResourceShareResponseBodyResourceShare& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateResourceShareResponseBodyResourceShare& obj) { 
    ...
    CreateResourceShareResponseBodyResourceShare() = default ;
    CreateResourceShareResponseBodyResourceShare(const CreateResourceShareResponseBodyResourceShare &) = default ;
    CreateResourceShareResponseBodyResourceShare(CreateResourceShareResponseBodyResourceShare &&) = default ;
    CreateResourceShareResponseBodyResourceShare(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateResourceShareResponseBodyResourceShare() = default ;
    CreateResourceShareResponseBodyResourceShare& operator=(const CreateResourceShareResponseBodyResourceShare &) = default ;
    CreateResourceShareResponseBodyResourceShare& operator=(CreateResourceShareResponseBodyResourceShare &&) = default ;
    ...
    inline CreateResourceShareResponseBodyResourceShare& setAllowExternalTargets(bool allowExternalTargets) { DARABONBA_PTR_SET_VALUE(allowExternalTargets_, allowExternalTargets) };
    ...
    inline CreateResourceShareResponseBodyResourceShare& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline CreateResourceShareResponseBodyResourceShare& setResourceShareId(string resourceShareId) { DARABONBA_PTR_SET_VALUE(resourceShareId_, resourceShareId) };
    ...
    inline CreateResourceShareResponseBodyResourceShare& setResourceShareName(string resourceShareName) { DARABONBA_PTR_SET_VALUE(resourceShareName_, resourceShareName) };
    ...
    inline CreateResourceShareResponseBodyResourceShare& setResourceShareOwner(string resourceShareOwner) { DARABONBA_PTR_SET_VALUE(resourceShareOwner_, resourceShareOwner) };
    ...
    inline CreateResourceShareResponseBodyResourceShare& setResourceShareStatus(string resourceShareStatus) { DARABONBA_PTR_SET_VALUE(resourceShareStatus_, resourceShareStatus) };
    ...
    inline CreateResourceShareResponseBodyResourceShare& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
