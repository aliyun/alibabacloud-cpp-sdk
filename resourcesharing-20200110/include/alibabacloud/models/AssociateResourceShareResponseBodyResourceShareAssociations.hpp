...
#ifndef ALIBABACLOUD_MODELS_ASSOCIATERESOURCESHARERESPONSEBODYRESOURCESHAREASSOCIATIONS_HPP_
#define ALIBABACLOUD_MODELS_ASSOCIATERESOURCESHARERESPONSEBODYRESOURCESHAREASSOCIATIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AssociateResourceShareResponseBodyResourceShareAssociations& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AssociateResourceShareResponseBodyResourceShareAssociations& obj) { 
    ...
    AssociateResourceShareResponseBodyResourceShareAssociations() = default ;
    AssociateResourceShareResponseBodyResourceShareAssociations(const AssociateResourceShareResponseBodyResourceShareAssociations &) = default ;
    AssociateResourceShareResponseBodyResourceShareAssociations(AssociateResourceShareResponseBodyResourceShareAssociations &&) = default ;
    AssociateResourceShareResponseBodyResourceShareAssociations(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AssociateResourceShareResponseBodyResourceShareAssociations() = default ;
    AssociateResourceShareResponseBodyResourceShareAssociations& operator=(const AssociateResourceShareResponseBodyResourceShareAssociations &) = default ;
    AssociateResourceShareResponseBodyResourceShareAssociations& operator=(AssociateResourceShareResponseBodyResourceShareAssociations &&) = default ;
    ...
    inline AssociateResourceShareResponseBodyResourceShareAssociations& setAssociationStatus(string associationStatus) { DARABONBA_PTR_SET_VALUE(associationStatus_, associationStatus) };
    ...
    inline AssociateResourceShareResponseBodyResourceShareAssociations& setAssociationStatusMessage(string associationStatusMessage) { DARABONBA_PTR_SET_VALUE(associationStatusMessage_, associationStatusMessage) };
    ...
    inline AssociateResourceShareResponseBodyResourceShareAssociations& setAssociationType(string associationType) { DARABONBA_PTR_SET_VALUE(associationType_, associationType) };
    ...
    inline AssociateResourceShareResponseBodyResourceShareAssociations& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline AssociateResourceShareResponseBodyResourceShareAssociations& setEntityId(string entityId) { DARABONBA_PTR_SET_VALUE(entityId_, entityId) };
    ...
    inline AssociateResourceShareResponseBodyResourceShareAssociations& setEntityType(string entityType) { DARABONBA_PTR_SET_VALUE(entityType_, entityType) };
    ...
    inline AssociateResourceShareResponseBodyResourceShareAssociations& setResourceArn(string resourceArn) { DARABONBA_PTR_SET_VALUE(resourceArn_, resourceArn) };
    ...
    inline AssociateResourceShareResponseBodyResourceShareAssociations& setResourceShareId(string resourceShareId) { DARABONBA_PTR_SET_VALUE(resourceShareId_, resourceShareId) };
    ...
    inline AssociateResourceShareResponseBodyResourceShareAssociations& setResourceShareName(string resourceShareName) { DARABONBA_PTR_SET_VALUE(resourceShareName_, resourceShareName) };
    ...
    inline AssociateResourceShareResponseBodyResourceShareAssociations& setTargetProperty(string targetProperty) { DARABONBA_PTR_SET_VALUE(targetProperty_, targetProperty) };
    ...
    inline AssociateResourceShareResponseBodyResourceShareAssociations& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
