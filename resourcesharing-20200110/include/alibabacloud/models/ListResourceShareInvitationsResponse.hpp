...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceShareInvitationsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListResourceShareInvitationsResponseBody) };
    inline ListResourceShareInvitationsResponseBody body() { DARABONBA_PTR_GET(body_, ListResourceShareInvitationsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListResourceShareInvitationsResponseBody> body_ = nullptr;
  };
