...
#ifndef ALIBABACLOUD_MODELS_LISTPERMISSIONVERSIONSRESPONSEBODYPERMISSIONS_HPP_
#define ALIBABACLOUD_MODELS_LISTPERMISSIONVERSIONSRESPONSEBODYPERMISSIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPermissionVersionsResponseBodyPermissions& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListPermissionVersionsResponseBodyPermissions& obj) { 
    ...
    ListPermissionVersionsResponseBodyPermissions() = default ;
    ListPermissionVersionsResponseBodyPermissions(const ListPermissionVersionsResponseBodyPermissions &) = default ;
    ListPermissionVersionsResponseBodyPermissions(ListPermissionVersionsResponseBodyPermissions &&) = default ;
    ListPermissionVersionsResponseBodyPermissions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPermissionVersionsResponseBodyPermissions() = default ;
    ListPermissionVersionsResponseBodyPermissions& operator=(const ListPermissionVersionsResponseBodyPermissions &) = default ;
    ListPermissionVersionsResponseBodyPermissions& operator=(ListPermissionVersionsResponseBodyPermissions &&) = default ;
    ...
    inline ListPermissionVersionsResponseBodyPermissions& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListPermissionVersionsResponseBodyPermissions& setDefaultPermission(bool defaultPermission) { DARABONBA_PTR_SET_VALUE(defaultPermission_, defaultPermission) };
    ...
    inline ListPermissionVersionsResponseBodyPermissions& setDefaultVersion(bool defaultVersion) { DARABONBA_PTR_SET_VALUE(defaultVersion_, defaultVersion) };
    ...
    inline ListPermissionVersionsResponseBodyPermissions& setPermissionName(string permissionName) { DARABONBA_PTR_SET_VALUE(permissionName_, permissionName) };
    ...
    inline ListPermissionVersionsResponseBodyPermissions& setPermissionVersion(string permissionVersion) { DARABONBA_PTR_SET_VALUE(permissionVersion_, permissionVersion) };
    ...
    inline ListPermissionVersionsResponseBodyPermissions& setResourceType(string resourceType) { DARABONBA_PTR_SET_VALUE(resourceType_, resourceType) };
    ...
    inline ListPermissionVersionsResponseBodyPermissions& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
