...
#ifndef ALIBABACLOUD_MODELS_LISTRESOURCESHAREASSOCIATIONSRESPONSEBODYRESOURCESHAREASSOCIATIONS_HPP_
#define ALIBABACLOUD_MODELS_LISTRESOURCESHAREASSOCIATIONSRESPONSEBODYRESOURCESHAREASSOCIATIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListResourceShareAssociationsResponseBodyResourceShareAssociations& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListResourceShareAssociationsResponseBodyResourceShareAssociations& obj) { 
    ...
    ListResourceShareAssociationsResponseBodyResourceShareAssociations() = default ;
    ListResourceShareAssociationsResponseBodyResourceShareAssociations(const ListResourceShareAssociationsResponseBodyResourceShareAssociations &) = default ;
    ListResourceShareAssociationsResponseBodyResourceShareAssociations(ListResourceShareAssociationsResponseBodyResourceShareAssociations &&) = default ;
    ListResourceShareAssociationsResponseBodyResourceShareAssociations(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListResourceShareAssociationsResponseBodyResourceShareAssociations() = default ;
    ListResourceShareAssociationsResponseBodyResourceShareAssociations& operator=(const ListResourceShareAssociationsResponseBodyResourceShareAssociations &) = default ;
    ListResourceShareAssociationsResponseBodyResourceShareAssociations& operator=(ListResourceShareAssociationsResponseBodyResourceShareAssociations &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->associationFailedDetails_ != nullptr
        ...
        && this->entityType_ != nullptr && this->external_ != nullptr && this->resourceArn_ != nullptr && this->resourceShareId_ != nullptr && this->resourceShareName_ != nullptr
        && this->targetProperty_ != nullptr && this->updateTime_ != nullptr; };
    ...
    inline const vector<Models::ListResourceShareAssociationsResponseBodyResourceShareAssociationsAssociationFailedDetails> & associationFailedDetails() const { DARABONBA_PTR_GET_CONST(associationFailedDetails_, vector<Models::ListResourceShareAssociationsResponseBodyResourceShareAssociationsAssociationFailedDetails>) };
    inline vector<Models::ListResourceShareAssociationsResponseBodyResourceShareAssociationsAssociationFailedDetails> associationFailedDetails() { DARABONBA_PTR_GET(associationFailedDetails_, vector<Models::ListResourceShareAssociationsResponseBodyResourceShareAssociationsAssociationFailedDetails>) };
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setAssociationFailedDetails(const vector<Models::ListResourceShareAssociationsResponseBodyResourceShareAssociationsAssociationFailedDetails> & associationFailedDetails) { DARABONBA_PTR_SET_VALUE(associationFailedDetails_, associationFailedDetails) };
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setAssociationFailedDetails(vector<Models::ListResourceShareAssociationsResponseBodyResourceShareAssociationsAssociationFailedDetails> && associationFailedDetails) { DARABONBA_PTR_SET_RVALUE(associationFailedDetails_, associationFailedDetails) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setAssociationStatus(string associationStatus) { DARABONBA_PTR_SET_VALUE(associationStatus_, associationStatus) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setAssociationStatusMessage(string associationStatusMessage) { DARABONBA_PTR_SET_VALUE(associationStatusMessage_, associationStatusMessage) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setAssociationType(string associationType) { DARABONBA_PTR_SET_VALUE(associationType_, associationType) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setEntityId(string entityId) { DARABONBA_PTR_SET_VALUE(entityId_, entityId) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setEntityType(string entityType) { DARABONBA_PTR_SET_VALUE(entityType_, entityType) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setExternal(bool external) { DARABONBA_PTR_SET_VALUE(external_, external) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setResourceArn(string resourceArn) { DARABONBA_PTR_SET_VALUE(resourceArn_, resourceArn) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setResourceShareId(string resourceShareId) { DARABONBA_PTR_SET_VALUE(resourceShareId_, resourceShareId) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setResourceShareName(string resourceShareName) { DARABONBA_PTR_SET_VALUE(resourceShareName_, resourceShareName) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setTargetProperty(string targetProperty) { DARABONBA_PTR_SET_VALUE(targetProperty_, targetProperty) };
    ...
    inline ListResourceShareAssociationsResponseBodyResourceShareAssociations& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };


  protected:
    // The information about the failure.
    std::shared_ptr<vector<Models::ListResourceShareAssociationsResponseBodyResourceShareAssociationsAssociationFailedDetails>> associationFailedDetails_ = nullptr;
