...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateResourceShareResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AssociateResourceShareResponseBody) };
    inline AssociateResourceShareResponseBody getBody() { DARABONBA_PTR_GET(body_, AssociateResourceShareResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AssociateResourceShareResponseBody> body_ {};
  };
