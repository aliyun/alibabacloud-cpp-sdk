...
namespace Models
{
  ...
  public:
    ...
    inline const DisassociateResourceShareResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisassociateResourceShareResponseBody) };
    inline DisassociateResourceShareResponseBody getBody() { DARABONBA_PTR_GET(body_, DisassociateResourceShareResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisassociateResourceShareResponseBody> body_ {};
  };
