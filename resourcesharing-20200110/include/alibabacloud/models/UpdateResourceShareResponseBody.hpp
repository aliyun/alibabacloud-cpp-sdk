...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateResourceShareResponseBody::ResourceShare & getResourceShare() const { DARABONBA_PTR_GET_CONST(resourceShare_, UpdateResourceShareResponseBody::ResourceShare) };
    inline UpdateResourceShareResponseBody::ResourceShare getResourceShare() { DARABONBA_PTR_GET(resourceShare_, UpdateResourceShareResponseBody::ResourceShare) };
    inline UpdateResourceShareResponseBody& setResourceShare(const UpdateResourceShareResponseBody::ResourceShare & resourceShare) { DARABONBA_PTR_SET_VALUE(resourceShare_, resourceShare) };
    inline UpdateResourceShareResponseBody& setResourceShare(UpdateResourceShareResponseBody::ResourceShare && resourceShare) { DARABONBA_PTR_SET_RVALUE(resourceShare_, resourceShare) };
  ...
  protected:
    ...
    shared_ptr<UpdateResourceShareResponseBody::ResourceShare> resourceShare_ {};
  };
