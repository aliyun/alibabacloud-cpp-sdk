...
#ifndef ALIBABACLOUD_MODELS_LISTRESOURCESHAREPERMISSIONSRESPONSEBODYPERMISSIONS_HPP_
#define ALIBABACLOUD_MODELS_LISTRESOURCESHAREPERMISSIONSRESPONSEBODYPERMISSIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListResourceSharePermissionsResponseBodyPermissions& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListResourceSharePermissionsResponseBodyPermissions& obj) { 
    ...
    ListResourceSharePermissionsResponseBodyPermissions() = default ;
    ListResourceSharePermissionsResponseBodyPermissions(const ListResourceSharePermissionsResponseBodyPermissions &) = default ;
    ListResourceSharePermissionsResponseBodyPermissions(ListResourceSharePermissionsResponseBodyPermissions &&) = default ;
    ListResourceSharePermissionsResponseBodyPermissions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListResourceSharePermissionsResponseBodyPermissions() = default ;
    ListResourceSharePermissionsResponseBodyPermissions& operator=(const ListResourceSharePermissionsResponseBodyPermissions &) = default ;
    ListResourceSharePermissionsResponseBodyPermissions& operator=(ListResourceSharePermissionsResponseBodyPermissions &&) = default ;
    ...
    inline ListResourceSharePermissionsResponseBodyPermissions& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListResourceSharePermissionsResponseBodyPermissions& setDefaultPermission(bool defaultPermission) { DARABONBA_PTR_SET_VALUE(defaultPermission_, defaultPermission) };
    ...
    inline ListResourceSharePermissionsResponseBodyPermissions& setDefaultVersion(bool defaultVersion) { DARABONBA_PTR_SET_VALUE(defaultVersion_, defaultVersion) };
    ...
    inline ListResourceSharePermissionsResponseBodyPermissions& setPermissionName(string permissionName) { DARABONBA_PTR_SET_VALUE(permissionName_, permissionName) };
    ...
    inline ListResourceSharePermissionsResponseBodyPermissions& setPermissionVersion(string permissionVersion) { DARABONBA_PTR_SET_VALUE(permissionVersion_, permissionVersion) };
    ...
    inline ListResourceSharePermissionsResponseBodyPermissions& setResourceType(string resourceType) { DARABONBA_PTR_SET_VALUE(resourceType_, resourceType) };
    ...
    inline ListResourceSharePermissionsResponseBodyPermissions& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
