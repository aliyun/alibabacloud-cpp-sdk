...
#ifndef ALIBABACLOUD_MODELS_LISTPERMISSIONVERSIONSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTPERMISSIONVERSIONSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPermissionVersionsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(NextToken, nextToken_);
      DARABONBA_PTR_TO_JSON(Permissions, permissions_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListPermissionVersionsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(NextToken, nextToken_);
      DARABONBA_PTR_FROM_JSON(Permissions, permissions_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListPermissionVersionsResponseBody() = default ;
    ListPermissionVersionsResponseBody(const ListPermissionVersionsResponseBody &) = default ;
    ListPermissionVersionsResponseBody(ListPermissionVersionsResponseBody &&) = default ;
    ListPermissionVersionsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPermissionVersionsResponseBody() = default ;
    ListPermissionVersionsResponseBody& operator=(const ListPermissionVersionsResponseBody &) = default ;
    ListPermissionVersionsResponseBody& operator=(ListPermissionVersionsResponseBody &&) = default ;
    ...
    inline ListPermissionVersionsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };


    // permissions Field Functions 
    bool hasPermissions() const { return this->permissions_ != nullptr;};
    void deletePermissions() { this->permissions_ = nullptr;};
    inline const vector<ListPermissionVersionsResponseBody::Permissions> & getPermissions() const { DARABONBA_PTR_GET_CONST(permissions_, vector<ListPermissionVersionsResponseBody::Permissions>) };
    inline vector<ListPermissionVersionsResponseBody::Permissions> getPermissions() { DARABONBA_PTR_GET(permissions_, vector<ListPermissionVersionsResponseBody::Permissions>) };
    inline ListPermissionVersionsResponseBody& setPermissions(const vector<ListPermissionVersionsResponseBody::Permissions> & permissions) { DARABONBA_PTR_SET_VALUE(permissions_, permissions) };
    inline ListPermissionVersionsResponseBody& setPermissions(vector<ListPermissionVersionsResponseBody::Permissions> && permissions) { DARABONBA_PTR_SET_RVALUE(permissions_, permissions) };
    ...
    inline ListPermissionVersionsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
  ...
  protected:
    ...
    shared_ptr<vector<ListPermissionVersionsResponseBody::Permissions>> permissions_ {};
