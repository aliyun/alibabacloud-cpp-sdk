...
namespace Models
{
  ...
  public:
    ...
    inline const CreateResourceShareResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateResourceShareResponseBody) };
    inline CreateResourceShareResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateResourceShareResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateResourceShareResponseBody> body_ {};
  };
