...
namespace Models
{
  ...
  public:
    ...
    inline const AcceptResourceShareInvitationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AcceptResourceShareInvitationResponseBody) };
    inline AcceptResourceShareInvitationResponseBody getBody() { DARABONBA_PTR_GET(body_, AcceptResourceShareInvitationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AcceptResourceShareInvitationResponseBody> body_ {};
  };
