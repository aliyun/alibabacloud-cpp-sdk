...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getResourceShareInvitationIds() const { DARABONBA_PTR_GET_CONST(resourceShareInvitationIds_, vector<string>) };
    inline vector<string> getResourceShareInvitationIds() { DARABONBA_PTR_GET(resourceShareInvitationIds_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> resourceShareInvitationIds_ {};
  };
