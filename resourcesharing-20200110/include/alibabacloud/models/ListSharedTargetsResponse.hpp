...
namespace Models
{
  ...
  public:
    ...
    inline const ListSharedTargetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSharedTargetsResponseBody) };
    inline ListSharedTargetsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSharedTargetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSharedTargetsResponseBody> body_ {};
  };
