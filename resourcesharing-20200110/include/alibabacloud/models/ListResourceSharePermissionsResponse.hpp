...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceSharePermissionsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListResourceSharePermissionsResponseBody) };
    inline ListResourceSharePermissionsResponseBody body() { DARABONBA_PTR_GET(body_, ListResourceSharePermissionsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListResourceSharePermissionsResponseBody> body_ = nullptr;
  };
