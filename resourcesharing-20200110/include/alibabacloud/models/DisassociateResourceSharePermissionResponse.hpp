...
namespace Models
{
  ...
  public:
    ...
    inline const DisassociateResourceSharePermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisassociateResourceSharePermissionResponseBody) };
    inline DisassociateResourceSharePermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, DisassociateResourceSharePermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisassociateResourceSharePermissionResponseBody> body_ {};
  };
