...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceSharesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListResourceSharesResponseBody) };
    inline ListResourceSharesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListResourceSharesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListResourceSharesResponseBody> body_ {};
  };
