...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DisassociateResourceShareResponseBody::ResourceShareAssociations> & getResourceShareAssociations() const { DARABONBA_PTR_GET_CONST(resourceShareAssociations_, vector<DisassociateResourceShareResponseBody::ResourceShareAssociations>) };
    inline vector<DisassociateResourceShareResponseBody::ResourceShareAssociations> getResourceShareAssociations() { DARABONBA_PTR_GET(resourceShareAssociations_, vector<DisassociateResourceShareResponseBody::ResourceShareAssociations>) };
    inline DisassociateResourceShareResponseBody& setResourceShareAssociations(const vector<DisassociateResourceShareResponseBody::ResourceShareAssociations> & resourceShareAssociations) { DARABONBA_PTR_SET_VALUE(resourceShareAssociations_, resourceShareAssociations) };
    inline DisassociateResourceShareResponseBody& setResourceShareAssociations(vector<DisassociateResourceShareResponseBody::ResourceShareAssociations> && resourceShareAssociations) { DARABONBA_PTR_SET_RVALUE(resourceShareAssociations_, resourceShareAssociations) };
  ...
  protected:
    ...
    shared_ptr<vector<DisassociateResourceShareResponseBody::ResourceShareAssociations>> resourceShareAssociations_ {};
  };
