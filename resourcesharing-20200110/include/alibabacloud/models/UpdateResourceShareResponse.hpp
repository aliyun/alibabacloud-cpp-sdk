...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateResourceShareResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateResourceShareResponseBody) };
    inline UpdateResourceShareResponseBody body() { DARABONBA_PTR_GET(body_, UpdateResourceShareResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateResourceShareResponseBody> body_ = nullptr;
  };
