...
namespace Models
{
  ...
  public:
    ...
    inline ListPermissionsResponseBodyPermissions& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListPermissionsResponseBodyPermissions& setDefaultPermission(bool defaultPermission) { DARABONBA_PTR_SET_VALUE(defaultPermission_, defaultPermission) };
    ...
    inline ListPermissionsResponseBodyPermissions& setDefaultVersion(bool defaultVersion) { DARABONBA_PTR_SET_VALUE(defaultVersion_, defaultVersion) };
    ...
    inline ListPermissionsResponseBodyPermissions& setPermissionName(string permissionName) { DARABONBA_PTR_SET_VALUE(permissionName_, permissionName) };
    ...
    inline ListPermissionsResponseBodyPermissions& setPermissionVersion(string permissionVersion) { DARABONBA_PTR_SET_VALUE(permissionVersion_, permissionVersion) };
    ...
    inline ListPermissionsResponseBodyPermissions& setResourceType(string resourceType) { DARABONBA_PTR_SET_VALUE(resourceType_, resourceType) };
    ...
    inline ListPermissionsResponseBodyPermissions& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
