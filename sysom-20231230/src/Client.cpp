...
AuthDiagnosisResponse Client::authDiagnosisWithOptions(const AuthDiagnosisRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasXDebugId()) {
    query["X-Debug-Id"] = request.getXDebugId();
  }

  if (!!request.hasXSysomInvokeSource()) {
    query["x-sysom-invoke-source"] = request.getXSysomInvokeSource();
  }
...
CreateAlertDestinationResponse Client::createAlertDestinationWithOptions(const CreateAlertDestinationRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  ...
  json body = {};
  if (!!request.hasAppId()) {
    body["app_id"] = request.getAppId();
  }

  if (!!request.hasAppSecret()) {
    body["app_secret"] = request.getAppSecret();
  }

  if (!!request.hasGroupId()) {
    body["group_id"] = request.getGroupId();
  }

  if (!!request.hasImbot()) {
    body["imbot"] = request.getImbot();
  }
 ...
 */
GetConfigByNameResponse Client::getConfigByNameWithOptions(const GetConfigByNameRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasXDebugId()) {
    query["X-Debug-Id"] = request.getXDebugId();
  ...
  if (!!request.hasUseGlobalUid()) {
    query["useGlobalUid"] = request.getUseGlobalUid();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2023-12-30"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/v1/configManage/config/getConfigByName")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetConfigByNameResponse>();
}
 ...
 * @return GetConfigByNameResponse
 */
GetConfigByNameResponse Client::getConfigByName(const GetConfigByNameRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ListInstanceInfoResponse Client::listInstanceInfoWithOptions(const ListInstanceInfoRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasXDebugId()) {
    query["X-Debug-Id"] = request.getXDebugId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2023-12-30"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/v1/am/instance/listInstanceInfo")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ListInstanceInfoResponse>();
}
 ...
 * @return ListInstanceInfoResponse
 */
ListInstanceInfoResponse Client::listInstanceInfo(const ListInstanceInfoRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
