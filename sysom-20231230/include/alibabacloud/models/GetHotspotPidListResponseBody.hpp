...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetHotspotPidListResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(code, code_);
      DARABONBA_PTR_TO_JSON(data, data_);
      DARABONBA_PTR_TO_JSON(message, message_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetHotspotPidListResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(code, code_);
      DARABONBA_PTR_FROM_JSON(data, data_);
      DARABONBA_PTR_FROM_JSON(message, message_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    GetHotspotPidListResponseBody() = default ;
    GetHotspotPidListResponseBody(const GetHotspotPidListResponseBody &) = default ;
    GetHotspotPidListResponseBody(GetHotspotPidListResponseBody &&) = default ;
    GetHotspotPidListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetHotspotPidListResponseBody() = default ;
    GetHotspotPidListResponseBody& operator=(const GetHotspotPidListResponseBody &) = default ;
    GetHotspotPidListResponseBody& operator=(GetHotspotPidListResponseBody &&) = default ;
