...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotspotCompareResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetHotspotCompareResponseBody) };
    inline GetHotspotCompareResponseBody body() { DARABONBA_PTR_GET(body_, GetHotspotCompareResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetHotspotCompareResponseBody> body_ = nullptr;
  };
