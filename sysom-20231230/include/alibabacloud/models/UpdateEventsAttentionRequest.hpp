...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->xDebugId_ == nullptr
        && this->mode_ == nullptr && this->range_ == nullptr && this->uuid_ == nullptr && this->xSysomInvokeSource_ == nullptr; };
    ...
    inline UpdateEventsAttentionRequest& setXDebugId(string xDebugId) { DARABONBA_PTR_SET_VALUE(xDebugId_, xDebugId) };
    ...
    inline UpdateEventsAttentionRequest& setXSysomInvokeSource(string xSysomInvokeSource) { DARABONBA_PTR_SET_VALUE(xSysomInvokeSource_, xSysomInvokeSource) };
