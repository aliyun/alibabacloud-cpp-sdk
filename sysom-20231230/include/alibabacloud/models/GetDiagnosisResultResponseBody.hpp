...
namespace Models
{
  ...
  public:
    ...
    inline const GetDiagnosisResultResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDiagnosisResultResponseBody::Data) };
    inline GetDiagnosisResultResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDiagnosisResultResponseBody::Data) };
    inline GetDiagnosisResultResponseBody& setData(const GetDiagnosisResultResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDiagnosisResultResponseBody& setData(GetDiagnosisResultResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
