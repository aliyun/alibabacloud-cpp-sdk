...
#ifndef ALIBABACLOUD_MODELS_GETHOSTCOUNTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETHOSTCOUNTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    GetHostCountRequest(GetHostCountRequest &&) = default ;
    GetHostCountRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetHostCountRequest() = default ;
    GetHostCountRequest& operator=(const GetHostCountRequest &) = default ;
    GetHostCountRequest& operator=(GetHostCountRequest &&) = default ;
    ...
    inline GetHostCountRequest& setCluster(string cluster) { DARABONBA_PTR_SET_VALUE(cluster_, cluster) };
    ...
    inline GetHostCountRequest& setEnd(float end) { DARABONBA_PTR_SET_VALUE(end_, end) };
    ...
    inline GetHostCountRequest& setInstance(string instance) { DARABONBA_PTR_SET_VALUE(instance_, instance) };
