...
namespace Models
{
  ...
  public:
    ...
    inline const GetDiagnosisResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDiagnosisResultResponseBody) };
    inline GetDiagnosisResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDiagnosisResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDiagnosisResultResponseBody> body_ {};
  };
