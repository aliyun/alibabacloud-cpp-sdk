...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cluster_ == nullptr
        && return this->end_ == nullptr && return this->instance_ == nullptr && return this->level_ == nullptr && return this->namespace_ == nullptr && return this->pod_ == nullptr
        && return this->showPod_ == nullptr && return this->start_ == nullptr; };
