...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->current_ == nullptr
        && return this->instanceIdName_ == nullptr && return this->instanceTag_ == nullptr && return this->operationType_ == nullptr && return this->pageSize_ == nullptr && return this->pluginId_ == nullptr
