...
namespace Models
{
  ...
  public:
    ...
    inline const GetHostCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHostCountResponseBody) };
    inline GetHostCountResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHostCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHostCountResponseBody> body_ {};
  };
