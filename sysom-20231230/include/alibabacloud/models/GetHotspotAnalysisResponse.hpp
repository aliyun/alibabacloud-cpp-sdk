...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotspotAnalysisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHotspotAnalysisResponseBody) };
    inline GetHotspotAnalysisResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHotspotAnalysisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHotspotAnalysisResponseBody> body_ {};
  };
