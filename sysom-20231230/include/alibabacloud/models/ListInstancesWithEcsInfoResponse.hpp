...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstancesWithEcsInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstancesWithEcsInfoResponseBody) };
    inline ListInstancesWithEcsInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstancesWithEcsInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstancesWithEcsInfoResponseBody> body_ {};
  };
