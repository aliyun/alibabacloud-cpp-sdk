...
namespace Models
{
  ...
  public:
    ...
    inline const AuthDiagnosisResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AuthDiagnosisResponseBody) };
    inline AuthDiagnosisResponseBody body() { DARABONBA_PTR_GET(body_, AuthDiagnosisResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AuthDiagnosisResponseBody> body_ = nullptr;
  };
