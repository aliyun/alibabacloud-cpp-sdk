...
namespace Models
{
  ...
  public:
    ...
    inline const ListAbnormalyEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAbnormalyEventsResponseBody) };
    inline ListAbnormalyEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAbnormalyEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAbnormalyEventsResponseBody> body_ {};
  };
