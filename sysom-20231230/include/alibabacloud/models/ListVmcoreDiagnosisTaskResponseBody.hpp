...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListVmcoreDiagnosisTaskResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListVmcoreDiagnosisTaskResponseBodyData>) };
    inline vector<ListVmcoreDiagnosisTaskResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListVmcoreDiagnosisTaskResponseBodyData>) };
    inline ListVmcoreDiagnosisTaskResponseBody& setData(const vector<ListVmcoreDiagnosisTaskResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListVmcoreDiagnosisTaskResponseBody& setData(vector<ListVmcoreDiagnosisTaskResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListVmcoreDiagnosisTaskResponseBodyData>> data_ = nullptr;
