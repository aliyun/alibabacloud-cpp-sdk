...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceHealthResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceHealthResponseBody) };
    inline ListInstanceHealthResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstanceHealthResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstanceHealthResponseBody> body_ {};
  };
