...
namespace Models
{
  ...
  public:
    ...
    inline const InstallAgentResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, InstallAgentResponseBody::Data) };
    inline InstallAgentResponseBody::Data getData() { DARABONBA_PTR_GET(data_, InstallAgentResponseBody::Data) };
    inline InstallAgentResponseBody& setData(const InstallAgentResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline InstallAgentResponseBody& setData(InstallAgentResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
