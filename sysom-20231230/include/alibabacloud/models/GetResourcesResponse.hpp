...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourcesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetResourcesResponseBody) };
    inline GetResourcesResponseBody body() { DARABONBA_PTR_GET(body_, GetResourcesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetResourcesResponseBody> body_ = nullptr;
  };
