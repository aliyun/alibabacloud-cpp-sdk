...
namespace Models
{
  ...
  public:
    ...
    inline const ListAllInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAllInstancesResponseBody) };
    inline ListAllInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAllInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAllInstancesResponseBody> body_ {};
  };
