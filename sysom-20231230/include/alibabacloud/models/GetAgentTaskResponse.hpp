...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAgentTaskResponseBody) };
    inline GetAgentTaskResponseBody body() { DARABONBA_PTR_GET(body_, GetAgentTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAgentTaskResponseBody> body_ = nullptr;
  };
