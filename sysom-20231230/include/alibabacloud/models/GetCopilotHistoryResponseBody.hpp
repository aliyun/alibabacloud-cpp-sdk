...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetCopilotHistoryResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetCopilotHistoryResponseBodyData>) };
    inline vector<GetCopilotHistoryResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetCopilotHistoryResponseBodyData>) };
    inline GetCopilotHistoryResponseBody& setData(const vector<GetCopilotHistoryResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCopilotHistoryResponseBody& setData(vector<GetCopilotHistoryResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetCopilotHistoryResponseBodyData>> data_ = nullptr;
