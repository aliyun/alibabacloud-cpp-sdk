...
namespace Models
{
  ...
  public:
    ...
    inline const UninstallAgentForClusterResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UninstallAgentForClusterResponseBody::Data) };
    inline UninstallAgentForClusterResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UninstallAgentForClusterResponseBody::Data) };
    inline UninstallAgentForClusterResponseBody& setData(const UninstallAgentForClusterResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UninstallAgentForClusterResponseBody& setData(UninstallAgentForClusterResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
