...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotspotCompareResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHotspotCompareResponseBodyData) };
    inline GetHotspotCompareResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHotspotCompareResponseBodyData) };
    inline GetHotspotCompareResponseBody& setData(const GetHotspotCompareResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHotspotCompareResponseBody& setData(GetHotspotCompareResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHotspotCompareResponseBodyData> data_ = nullptr;
