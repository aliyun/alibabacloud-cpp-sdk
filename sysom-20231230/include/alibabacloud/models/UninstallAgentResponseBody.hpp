...
namespace Models
{
  ...
  public:
    ...
    inline const UninstallAgentResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UninstallAgentResponseBody::Data) };
    inline UninstallAgentResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UninstallAgentResponseBody::Data) };
    inline UninstallAgentResponseBody& setData(const UninstallAgentResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UninstallAgentResponseBody& setData(UninstallAgentResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<UninstallAgentResponseBody::Data> data_ {};
