...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotSpotUniqListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHotSpotUniqListResponseBodyData) };
    inline GetHotSpotUniqListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHotSpotUniqListResponseBodyData) };
    inline GetHotSpotUniqListResponseBody& setData(const GetHotSpotUniqListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHotSpotUniqListResponseBody& setData(GetHotSpotUniqListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHotSpotUniqListResponseBodyData> data_ = nullptr;
