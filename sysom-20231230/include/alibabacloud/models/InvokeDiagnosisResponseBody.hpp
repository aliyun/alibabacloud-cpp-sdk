...
namespace Models
{
  ...
  public:
    ...
    inline const InvokeDiagnosisResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, InvokeDiagnosisResponseBodyData) };
    inline InvokeDiagnosisResponseBodyData data() { DARABONBA_PTR_GET(data_, InvokeDiagnosisResponseBodyData) };
    inline InvokeDiagnosisResponseBody& setData(const InvokeDiagnosisResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline InvokeDiagnosisResponseBody& setData(InvokeDiagnosisResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<InvokeDiagnosisResponseBodyData> data_ = nullptr;
