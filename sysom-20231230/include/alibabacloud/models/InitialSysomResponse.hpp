...
namespace Models
{
  ...
  public:
    ...
    inline const InitialSysomResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InitialSysomResponseBody) };
    inline InitialSysomResponseBody getBody() { DARABONBA_PTR_GET(body_, InitialSysomResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InitialSysomResponseBody> body_ {};
  };
