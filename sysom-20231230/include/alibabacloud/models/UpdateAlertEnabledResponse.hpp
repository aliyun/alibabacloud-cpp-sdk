...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAlertEnabledResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAlertEnabledResponseBody) };
    inline UpdateAlertEnabledResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAlertEnabledResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAlertEnabledResponseBody> body_ {};
  };
