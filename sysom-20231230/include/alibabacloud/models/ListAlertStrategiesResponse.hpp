...
namespace Models
{
  ...
  public:
    ...
    inline const ListAlertStrategiesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAlertStrategiesResponseBody) };
    inline ListAlertStrategiesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAlertStrategiesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAlertStrategiesResponseBody> body_ {};
  };
