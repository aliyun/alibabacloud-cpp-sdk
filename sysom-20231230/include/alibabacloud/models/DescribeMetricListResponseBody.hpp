...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeMetricListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeMetricListResponseBodyData>) };
    inline vector<DescribeMetricListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeMetricListResponseBodyData>) };
    inline DescribeMetricListResponseBody& setData(const vector<DescribeMetricListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeMetricListResponseBody& setData(vector<DescribeMetricListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeMetricListResponseBodyData>> data_ = nullptr;
