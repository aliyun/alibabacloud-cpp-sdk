...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotspotInstanceListResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetHotspotInstanceListResponseBody::Data) };
    inline GetHotspotInstanceListResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetHotspotInstanceListResponseBody::Data) };
    inline GetHotspotInstanceListResponseBody& setData(const GetHotspotInstanceListResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHotspotInstanceListResponseBody& setData(GetHotspotInstanceListResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
