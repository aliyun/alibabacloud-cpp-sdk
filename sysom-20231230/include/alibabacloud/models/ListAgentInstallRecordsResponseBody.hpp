...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAgentInstallRecordsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAgentInstallRecordsResponseBodyData>) };
    inline vector<ListAgentInstallRecordsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAgentInstallRecordsResponseBodyData>) };
    inline ListAgentInstallRecordsResponseBody& setData(const vector<ListAgentInstallRecordsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAgentInstallRecordsResponseBody& setData(vector<ListAgentInstallRecordsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAgentInstallRecordsResponseBodyData>> data_ = nullptr;
