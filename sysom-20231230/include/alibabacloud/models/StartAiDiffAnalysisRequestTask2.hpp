...
#ifndef ALIBABACLOUD_MODELS_STARTAIDIFFANALYSISREQUESTTASK2_HPP_
#define ALIBABACLOUD_MODELS_STARTAIDIFFANALYSISREQUESTTASK2_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartAIDiffAnalysisRequestTask2& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartAIDiffAnalysisRequestTask2& obj) { 
    ...
    StartAIDiffAnalysisRequestTask2() = default ;
    StartAIDiffAnalysisRequestTask2(const StartAIDiffAnalysisRequestTask2 &) = default ;
    StartAIDiffAnalysisRequestTask2(StartAIDiffAnalysisRequestTask2 &&) = default ;
    StartAIDiffAnalysisRequestTask2(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartAIDiffAnalysisRequestTask2() = default ;
    StartAIDiffAnalysisRequestTask2& operator=(const StartAIDiffAnalysisRequestTask2 &) = default ;
    StartAIDiffAnalysisRequestTask2& operator=(StartAIDiffAnalysisRequestTask2 &&) = default ;
    ...
    inline StartAIDiffAnalysisRequestTask2& setAnalysisId(string analysisId) { DARABONBA_PTR_SET_VALUE(analysisId_, analysisId) };
    ...
    inline StartAIDiffAnalysisRequestTask2& setPids(const vector<string> & pids) { DARABONBA_PTR_SET_VALUE(pids_, pids) };
    inline StartAIDiffAnalysisRequestTask2& setPids(vector<string> && pids) { DARABONBA_PTR_SET_RVALUE(pids_, pids) };
    ...
    inline StartAIDiffAnalysisRequestTask2& setStepEnd(float stepEnd) { DARABONBA_PTR_SET_VALUE(stepEnd_, stepEnd) };
    ...
    inline StartAIDiffAnalysisRequestTask2& setStepStart(float stepStart) { DARABONBA_PTR_SET_VALUE(stepStart_, stepStart) };
