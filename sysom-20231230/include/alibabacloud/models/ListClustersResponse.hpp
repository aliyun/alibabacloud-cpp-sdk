...
namespace Models
{
  ...
  public:
    ...
    inline const ListClustersResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListClustersResponseBody) };
    inline ListClustersResponseBody body() { DARABONBA_PTR_GET(body_, ListClustersResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListClustersResponseBody> body_ = nullptr;
  };
