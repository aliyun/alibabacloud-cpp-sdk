...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->xDebugId_ == nullptr
        && this->clusterId_ == nullptr && this->current_ == nullptr && this->instance_ == nullptr && this->pageSize_ == nullptr && this->region_ == nullptr
        && this->status_ == nullptr && this->xSysomInvokeSource_ == nullptr; };
    ...
    inline ListInstancesRequest& setXDebugId(string xDebugId) { DARABONBA_PTR_SET_VALUE(xDebugId_, xDebugId) };
    ...
    inline ListInstancesRequest& setXSysomInvokeSource(string xSysomInvokeSource) { DARABONBA_PTR_SET_VALUE(xSysomInvokeSource_, xSysomInvokeSource) };
