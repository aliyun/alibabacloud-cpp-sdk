...
namespace Models
{
  ...
  public:
    ...
    inline const GetVmcoreDiagnosisTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVmcoreDiagnosisTaskResponseBody) };
    inline GetVmcoreDiagnosisTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVmcoreDiagnosisTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVmcoreDiagnosisTaskResponseBody> body_ {};
  };
