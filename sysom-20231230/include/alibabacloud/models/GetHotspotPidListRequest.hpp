...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->xDebugId_ == nullptr
        && this->begEnd_ == nullptr && this->begStart_ == nullptr && this->instance_ == nullptr && this->table_ == nullptr && this->xSysomInvokeSource_ == nullptr; };
    ...
    inline GetHotspotPidListRequest& setXDebugId(string xDebugId) { DARABONBA_PTR_SET_VALUE(xDebugId_, xDebugId) };
    ...
    inline GetHotspotPidListRequest& setXSysomInvokeSource(string xSysomInvokeSource) { DARABONBA_PTR_SET_VALUE(xSysomInvokeSource_, xSysomInvokeSource) };
