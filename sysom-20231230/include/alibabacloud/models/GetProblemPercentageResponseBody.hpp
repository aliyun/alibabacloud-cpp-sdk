...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetProblemPercentageResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetProblemPercentageResponseBodyData>) };
    inline vector<GetProblemPercentageResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetProblemPercentageResponseBodyData>) };
    inline GetProblemPercentageResponseBody& setData(const vector<GetProblemPercentageResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetProblemPercentageResponseBody& setData(vector<GetProblemPercentageResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetProblemPercentageResponseBodyData>> data_ = nullptr;
