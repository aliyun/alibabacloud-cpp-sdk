...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->xDebugId_ == nullptr
        ...
        && this->uniq_ == nullptr && this->xSysomInvokeSource_ == nullptr; };
    ...
    inline GetHotSpotUniqListRequest& setXDebugId(string xDebugId) { DARABONBA_PTR_SET_VALUE(xDebugId_, xDebugId) };
    ...
    inline string getUniq() const { DARABONBA_PTR_GET_DEFAULT(uniq_, "") };
    ...
    inline GetHotSpotUniqListRequest& setXSysomInvokeSource(string xSysomInvokeSource) { DARABONBA_PTR_SET_VALUE(xSysomInvokeSource_, xSysomInvokeSource) };
