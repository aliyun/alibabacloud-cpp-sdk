...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeAgentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeAgentResponseBody) };
    inline UpgradeAgentResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeAgentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeAgentResponseBody> body_ {};
  };
