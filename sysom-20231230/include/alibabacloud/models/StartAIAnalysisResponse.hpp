...
namespace Models
{
  ...
  public:
    ...
    inline const StartAIAnalysisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartAIAnalysisResponseBody) };
    inline StartAIAnalysisResponseBody getBody() { DARABONBA_PTR_GET(body_, StartAIAnalysisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartAIAnalysisResponseBody> body_ {};
  };
