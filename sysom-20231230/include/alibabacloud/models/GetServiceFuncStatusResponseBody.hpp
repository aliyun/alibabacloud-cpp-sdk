...
namespace Models
{
  ...
  public:
    ...
    inline const GetServiceFuncStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetServiceFuncStatusResponseBodyData) };
    inline GetServiceFuncStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, GetServiceFuncStatusResponseBodyData) };
    inline GetServiceFuncStatusResponseBody& setData(const GetServiceFuncStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetServiceFuncStatusResponseBody& setData(GetServiceFuncStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetServiceFuncStatusResponseBodyData> data_ = nullptr;
