...
#include <alibabacloud/models/GetAlertStrategyResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetAlertStrategyResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAlertStrategyResponseBodyData) };
    inline GetAlertStrategyResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAlertStrategyResponseBodyData) };
    inline GetAlertStrategyResponseBody& setData(const GetAlertStrategyResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAlertStrategyResponseBody& setData(GetAlertStrategyResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAlertStrategyResponseBodyData> data_ = nullptr;
