...
namespace Models
{
  ...
  public:
    ...
    inline const StartAIAnalysisResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, StartAIAnalysisResponseBodyData) };
    inline StartAIAnalysisResponseBodyData data() { DARABONBA_PTR_GET(data_, StartAIAnalysisResponseBodyData) };
    inline StartAIAnalysisResponseBody& setData(const StartAIAnalysisResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StartAIAnalysisResponseBody& setData(StartAIAnalysisResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<StartAIAnalysisResponseBodyData> data_ = nullptr;
