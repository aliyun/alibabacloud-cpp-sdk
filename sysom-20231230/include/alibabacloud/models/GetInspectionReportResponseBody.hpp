...
namespace Models
{
  ...
  public:
    ...
    inline GetInspectionReportResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetInspectionReportResponseBody& setData(const Darabonba::Json & data) { DARABONBA_SET_VALUE(data_, data) };
    inline GetInspectionReportResponseBody& setData(Darabonba::Json && data) { DARABONBA_SET_RVALUE(data_, data) };
    ...
    inline GetInspectionReportResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
