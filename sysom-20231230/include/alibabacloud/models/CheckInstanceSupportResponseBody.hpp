...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CheckInstanceSupportResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<CheckInstanceSupportResponseBodyData>) };
    inline vector<CheckInstanceSupportResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<CheckInstanceSupportResponseBodyData>) };
    inline CheckInstanceSupportResponseBody& setData(const vector<CheckInstanceSupportResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CheckInstanceSupportResponseBody& setData(vector<CheckInstanceSupportResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CheckInstanceSupportResponseBodyData>> data_ = nullptr;
