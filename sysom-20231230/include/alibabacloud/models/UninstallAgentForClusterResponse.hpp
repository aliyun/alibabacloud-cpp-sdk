...
namespace Models
{
  ...
  public:
    ...
    inline const UninstallAgentForClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UninstallAgentForClusterResponseBody) };
    inline UninstallAgentForClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, UninstallAgentForClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UninstallAgentForClusterResponseBody> body_ {};
  };
