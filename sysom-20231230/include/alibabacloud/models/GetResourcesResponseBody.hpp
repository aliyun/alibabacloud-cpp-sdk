...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourcesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetResourcesResponseBodyData) };
    inline GetResourcesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetResourcesResponseBodyData) };
    inline GetResourcesResponseBody& setData(const GetResourcesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetResourcesResponseBody& setData(GetResourcesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetResourcesResponseBodyData> data_ = nullptr;
