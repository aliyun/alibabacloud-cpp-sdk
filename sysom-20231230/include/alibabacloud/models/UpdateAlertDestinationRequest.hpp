...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->xDebugId_ == nullptr
        && this->appId_ == nullptr && this->appSecret_ == nullptr && this->groupId_ == nullptr && this->id_ == nullptr && this->imbot_ == nullptr
        && this->name_ == nullptr && this->params_ == nullptr && this->source_ == nullptr && this->target_ == nullptr && this->xSysomInvokeSource_ == nullptr; };
    ...
    inline UpdateAlertDestinationRequest& setXDebugId(string xDebugId) { DARABONBA_PTR_SET_VALUE(xDebugId_, xDebugId) };
    ...
    inline UpdateAlertDestinationRequest& setXSysomInvokeSource(string xSysomInvokeSource) { DARABONBA_PTR_SET_VALUE(xSysomInvokeSource_, xSysomInvokeSource) };
