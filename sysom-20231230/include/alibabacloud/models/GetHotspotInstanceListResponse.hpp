...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotspotInstanceListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetHotspotInstanceListResponseBody) };
    inline GetHotspotInstanceListResponseBody body() { DARABONBA_PTR_GET(body_, GetHotspotInstanceListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetHotspotInstanceListResponseBody> body_ = nullptr;
  };
