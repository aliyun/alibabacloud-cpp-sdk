...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAgentTaskResponseBodyData) };
    inline GetAgentTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAgentTaskResponseBodyData) };
    inline GetAgentTaskResponseBody& setData(const GetAgentTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAgentTaskResponseBody& setData(GetAgentTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAgentTaskResponseBodyData> data_ = nullptr;
