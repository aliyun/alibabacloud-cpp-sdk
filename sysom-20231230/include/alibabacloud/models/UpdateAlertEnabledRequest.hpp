...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->xDebugId_ == nullptr
        && this->enabled_ == nullptr && this->id_ == nullptr && this->xSysomInvokeSource_ == nullptr; };
    ...
    inline UpdateAlertEnabledRequest& setXDebugId(string xDebugId) { DARABONBA_PTR_SET_VALUE(xDebugId_, xDebugId) };
    ...
    inline UpdateAlertEnabledRequest& setXSysomInvokeSource(string xSysomInvokeSource) { DARABONBA_PTR_SET_VALUE(xSysomInvokeSource_, xSysomInvokeSource) };
