...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->current_ == nullptr
        && return this->instanceId_ == nullptr && return this->pageSize_ == nullptr && return this->pluginId_ == nullptr && return this->pluginVersion_ == nullptr && return this->region_ == nullptr
