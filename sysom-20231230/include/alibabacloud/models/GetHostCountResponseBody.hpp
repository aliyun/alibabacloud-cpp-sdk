...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetHostCountResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetHostCountResponseBodyData>) };
    inline vector<GetHostCountResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetHostCountResponseBodyData>) };
    inline GetHostCountResponseBody& setData(const vector<GetHostCountResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHostCountResponseBody& setData(vector<GetHostCountResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetHostCountResponseBodyData>> data_ = nullptr;
