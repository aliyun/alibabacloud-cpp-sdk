...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListPodsOfInstanceResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListPodsOfInstanceResponseBodyData>) };
    inline vector<ListPodsOfInstanceResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListPodsOfInstanceResponseBodyData>) };
    inline ListPodsOfInstanceResponseBody& setData(const vector<ListPodsOfInstanceResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPodsOfInstanceResponseBody& setData(vector<ListPodsOfInstanceResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListPodsOfInstanceResponseBodyData>> data_ = nullptr;
