...
namespace Models
{
  ...
  public:
    ...
    inline const GetAIQueryResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAIQueryResultResponseBody) };
    inline GetAIQueryResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAIQueryResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAIQueryResultResponseBody> body_ {};
  };
