...
namespace Models
{
  ...
  public:
    ...
    inline const CheckInstanceSupportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckInstanceSupportResponseBody) };
    inline CheckInstanceSupportResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckInstanceSupportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckInstanceSupportResponseBody> body_ {};
  };
