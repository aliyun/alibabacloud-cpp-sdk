...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceStatusResponseBody) };
    inline ListInstanceStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstanceStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstanceStatusResponseBody> body_ {};
  };
