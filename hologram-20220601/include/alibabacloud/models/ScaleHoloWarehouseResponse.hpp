...
namespace Models
{
  ...
  public:
    ...
    inline const ScaleHoloWarehouseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ScaleHoloWarehouseResponseBody) };
    inline ScaleHoloWarehouseResponseBody getBody() { DARABONBA_PTR_GET(body_, ScaleHoloWarehouseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ScaleHoloWarehouseResponseBody> body_ {};
  };
