...
namespace Models
{
  ...
  public:
    ...
    inline const GrantTablePermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GrantTablePermissionResponseBody) };
    inline GrantTablePermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, GrantTablePermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GrantTablePermissionResponseBody> body_ {};
  };
