...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterCount_ == nullptr
        && this->cpu_ == nullptr && this->name_ == nullptr; };
    ...
    inline ScaleHoloWarehouseRequest& setClusterCount(int64_t clusterCount) { DARABONBA_PTR_SET_VALUE(clusterCount_, clusterCount) };
