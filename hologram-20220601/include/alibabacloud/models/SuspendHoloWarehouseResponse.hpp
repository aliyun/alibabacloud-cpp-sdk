...
namespace Models
{
  ...
  public:
    ...
    inline const SuspendHoloWarehouseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SuspendHoloWarehouseResponseBody) };
    inline SuspendHoloWarehouseResponseBody getBody() { DARABONBA_PTR_GET(body_, SuspendHoloWarehouseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SuspendHoloWarehouseResponseBody> body_ {};
  };
