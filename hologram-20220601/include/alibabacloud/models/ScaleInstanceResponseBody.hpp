...
namespace Models
{
  ...
  public:
    ...
    inline const ScaleInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ScaleInstanceResponseBodyData) };
    inline ScaleInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, ScaleInstanceResponseBodyData) };
    inline ScaleInstanceResponseBody& setData(const ScaleInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ScaleInstanceResponseBody& setData(ScaleInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<ScaleInstanceResponseBodyData> data_ = nullptr;
