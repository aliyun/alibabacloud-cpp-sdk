...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline TagResources& setTagValue(const vector<string> & tagValue) { DARABONBA_PTR_SET_VALUE(tagValue_, tagValue) };
      inline TagResources& setTagValue(vector<string> && tagValue) { DARABONBA_PTR_SET_RVALUE(tagValue_, tagValue) };
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && this->errorMessage_ == nullptr && this->httpStatusCode_ == nullptr && this->requestId_ == nullptr && this->success_ == nullptr && this->tagResources_ == nullptr; };
    // errorCode Field Functions 
    bool hasErrorCode() const { return this->errorCode_ != nullptr;};
    void deleteErrorCode() { this->errorCode_ = nullptr;};
    inline string getErrorCode() const { DARABONBA_PTR_GET_DEFAULT(errorCode_, "") };
    inline DescribeTagsResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline DescribeTagsResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline DescribeTagsResponseBody& setHttpStatusCode(string httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline DescribeTagsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline const vector<DescribeTagsResponseBody::TagResources> & getTagResources() const { DARABONBA_PTR_GET_CONST(tagResources_, vector<DescribeTagsResponseBody::TagResources>) };
    inline vector<DescribeTagsResponseBody::TagResources> getTagResources() { DARABONBA_PTR_GET(tagResources_, vector<DescribeTagsResponseBody::TagResources>) };
    inline DescribeTagsResponseBody& setTagResources(const vector<DescribeTagsResponseBody::TagResources> & tagResources) { DARABONBA_PTR_SET_VALUE(tagResources_, tagResources) };
    inline DescribeTagsResponseBody& setTagResources(vector<DescribeTagsResponseBody::TagResources> && tagResources) { DARABONBA_PTR_SET_RVALUE(tagResources_, tagResources) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeTagsResponseBody::TagResources>> tagResources_ {};
  };
