...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateModelServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateModelServiceResponseBody) };
    inline UpdateModelServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateModelServiceResponseBody) };
    inline UpdateModelServiceResponse& setBody(const UpdateModelServiceResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateModelServiceResponse& setBody(UpdateModelServiceResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<UpdateModelServiceResponseBody> body_ {};
  };
