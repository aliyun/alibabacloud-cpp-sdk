...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDatabasesResponseBodyDatabaseList> & databaseList() const { DARABONBA_PTR_GET_CONST(databaseList_, vector<ListDatabasesResponseBodyDatabaseList>) };
    inline vector<ListDatabasesResponseBodyDatabaseList> databaseList() { DARABONBA_PTR_GET(databaseList_, vector<ListDatabasesResponseBodyDatabaseList>) };
    inline ListDatabasesResponseBody& setDatabaseList(const vector<ListDatabasesResponseBodyDatabaseList> & databaseList) { DARABONBA_PTR_SET_VALUE(databaseList_, databaseList) };
    inline ListDatabasesResponseBody& setDatabaseList(vector<ListDatabasesResponseBodyDatabaseList> && databaseList) { DARABONBA_PTR_SET_RVALUE(databaseList_, databaseList) };
  ...
  protected:
    std::shared_ptr<vector<ListDatabasesResponseBodyDatabaseList>> databaseList_ = nullptr;
