...
namespace Models
{
  ...
  public:
    ...
    inline CreateUserResponseBody& setData(bool data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline CreateUserResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline CreateUserResponseBody& setHttpStatusCode(string httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateUserResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };
