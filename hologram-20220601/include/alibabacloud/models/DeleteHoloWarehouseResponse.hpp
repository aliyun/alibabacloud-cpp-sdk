...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHoloWarehouseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHoloWarehouseResponseBody) };
    inline DeleteHoloWarehouseResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHoloWarehouseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHoloWarehouseResponseBody> body_ {};
  };
