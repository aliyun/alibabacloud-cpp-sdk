...
namespace Models
{
  ...
  public:
    ...
    inline const DisableHiveAccessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableHiveAccessResponseBody) };
    inline DisableHiveAccessResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableHiveAccessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableHiveAccessResponseBody> body_ {};
  };
