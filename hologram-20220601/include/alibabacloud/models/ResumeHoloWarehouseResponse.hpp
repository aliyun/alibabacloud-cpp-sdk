...
namespace Models
{
  ...
  public:
    ...
    inline const ResumeHoloWarehouseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResumeHoloWarehouseResponseBody) };
    inline ResumeHoloWarehouseResponseBody getBody() { DARABONBA_PTR_GET(body_, ResumeHoloWarehouseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResumeHoloWarehouseResponseBody> body_ {};
  };
