...
namespace Models
{
  ...
  public:
    ...
    inline const GrantDatabasePermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GrantDatabasePermissionResponseBody) };
    inline GrantDatabasePermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, GrantDatabasePermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GrantDatabasePermissionResponseBody> body_ {};
  };
