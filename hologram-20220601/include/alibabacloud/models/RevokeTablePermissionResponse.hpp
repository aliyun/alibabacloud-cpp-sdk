...
namespace Models
{
  ...
  public:
    ...
    inline const RevokeTablePermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RevokeTablePermissionResponseBody) };
    inline RevokeTablePermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, RevokeTablePermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RevokeTablePermissionResponseBody> body_ {};
  };
