...
namespace Models
{
  ...
  public:
    ...
    inline const RenameHoloWarehouseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RenameHoloWarehouseResponseBody) };
    inline RenameHoloWarehouseResponseBody getBody() { DARABONBA_PTR_GET(body_, RenameHoloWarehouseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RenameHoloWarehouseResponseBody> body_ {};
  };
