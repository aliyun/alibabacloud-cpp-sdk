...
namespace Models
{
  ...
  public:
    ...
    inline const GetCertificateAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCertificateAttributeResponseBody) };
    inline GetCertificateAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCertificateAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCertificateAttributeResponseBody> body_ {};
  };
