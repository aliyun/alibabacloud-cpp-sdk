...
namespace Models
{
  ...
  public:
    ...
    inline const GetUpgradeStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUpgradeStatusResponseBody) };
    inline GetUpgradeStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUpgradeStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUpgradeStatusResponseBody> body_ {};
  };
