...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateInstanceNetworkTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateInstanceNetworkTypeResponseBody) };
    inline UpdateInstanceNetworkTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateInstanceNetworkTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateInstanceNetworkTypeResponseBody> body_ {};
  };
