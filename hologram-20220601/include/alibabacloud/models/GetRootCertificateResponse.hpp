...
namespace Models
{
  ...
  public:
    ...
    inline const GetRootCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRootCertificateResponseBody) };
    inline GetRootCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRootCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRootCertificateResponseBody> body_ {};
  };
