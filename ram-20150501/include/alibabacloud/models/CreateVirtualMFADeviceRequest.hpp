...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->virtualMFADeviceName_ == nullptr; };
    ...
    inline string getVirtualMFADeviceName() const { DARABONBA_PTR_GET_DEFAULT(virtualMFADeviceName_, "") };
