...
namespace Models
{
  ...
  public:
    ...
    inline string getNewAssumeRolePolicyDocument() const { DARABONBA_PTR_GET_DEFAULT(newAssumeRolePolicyDocument_, "") };
    ...
    inline int64_t getNewMaxSessionDuration() const { DARABONBA_PTR_GET_DEFAULT(newMaxSessionDuration_, 0L) };
