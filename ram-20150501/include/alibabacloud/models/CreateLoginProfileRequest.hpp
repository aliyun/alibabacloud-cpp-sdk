...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->MFABindRequired_ == nullptr
        && this->password_ == nullptr && this->passwordResetRequired_ == nullptr && this->userName_ == nullptr; };
    ...
    inline CreateLoginProfileRequest& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
