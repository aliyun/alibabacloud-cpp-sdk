...
namespace Models
{
  ...
  public:
    ...
    inline const GetPasswordPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPasswordPolicyResponseBody) };
    inline GetPasswordPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPasswordPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPasswordPolicyResponseBody> body_ {};
  };
