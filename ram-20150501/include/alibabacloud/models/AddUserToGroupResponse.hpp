...
namespace Models
{
  ...
  public:
    ...
    inline const AddUserToGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddUserToGroupResponseBody) };
    inline AddUserToGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, AddUserToGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddUserToGroupResponseBody> body_ {};
  };
