...
#ifndef ALIBABACLOUD_MODELS_LISTPOLICIESFORGROUPRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTPOLICIESFORGROUPRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPoliciesForGroupResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Policies, policies_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListPoliciesForGroupResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Policies, policies_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListPoliciesForGroupResponseBody() = default ;
    ListPoliciesForGroupResponseBody(const ListPoliciesForGroupResponseBody &) = default ;
    ListPoliciesForGroupResponseBody(ListPoliciesForGroupResponseBody &&) = default ;
    ListPoliciesForGroupResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPoliciesForGroupResponseBody() = default ;
    ListPoliciesForGroupResponseBody& operator=(const ListPoliciesForGroupResponseBody &) = default ;
    ListPoliciesForGroupResponseBody& operator=(ListPoliciesForGroupResponseBody &&) = default ;
    ...
    inline const ListPoliciesForGroupResponseBody::Policies & getPolicies() const { DARABONBA_PTR_GET_CONST(policies_, ListPoliciesForGroupResponseBody::Policies) };
    inline ListPoliciesForGroupResponseBody::Policies getPolicies() { DARABONBA_PTR_GET(policies_, ListPoliciesForGroupResponseBody::Policies) };
    inline ListPoliciesForGroupResponseBody& setPolicies(const ListPoliciesForGroupResponseBody::Policies & policies) { DARABONBA_PTR_SET_VALUE(policies_, policies) };
    inline ListPoliciesForGroupResponseBody& setPolicies(ListPoliciesForGroupResponseBody::Policies && policies) { DARABONBA_PTR_SET_RVALUE(policies_, policies) };
    ...
    inline ListPoliciesForGroupResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<ListPoliciesForGroupResponseBody::Policies> policies_ {};
    // The request ID.
