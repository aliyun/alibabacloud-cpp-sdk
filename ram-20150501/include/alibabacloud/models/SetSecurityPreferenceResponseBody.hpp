...
namespace Models
{
  ...
  public:
    ...
    inline const SetSecurityPreferenceResponseBody::SecurityPreference & getSecurityPreference() const { DARABONBA_PTR_GET_CONST(securityPreference_, SetSecurityPreferenceResponseBody::SecurityPreference) };
    inline SetSecurityPreferenceResponseBody::SecurityPreference getSecurityPreference() { DARABONBA_PTR_GET(securityPreference_, SetSecurityPreferenceResponseBody::SecurityPreference) };
    inline SetSecurityPreferenceResponseBody& setSecurityPreference(const SetSecurityPreferenceResponseBody::SecurityPreference & securityPreference) { DARABONBA_PTR_SET_VALUE(securityPreference_, securityPreference) };
    inline SetSecurityPreferenceResponseBody& setSecurityPreference(SetSecurityPreferenceResponseBody::SecurityPreference && securityPreference) { DARABONBA_PTR_SET_RVALUE(securityPreference_, securityPreference) };
