...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteServiceLinkedRoleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteServiceLinkedRoleResponseBody) };
    inline DeleteServiceLinkedRoleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteServiceLinkedRoleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteServiceLinkedRoleResponseBody> body_ {};
  };
