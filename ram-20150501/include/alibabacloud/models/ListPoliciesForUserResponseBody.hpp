...
#ifndef ALIBABACLOUD_MODELS_LISTPOLICIESFORUSERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTPOLICIESFORUSERRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPoliciesForUserResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Policies, policies_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListPoliciesForUserResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Policies, policies_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListPoliciesForUserResponseBody() = default ;
    ListPoliciesForUserResponseBody(const ListPoliciesForUserResponseBody &) = default ;
    ListPoliciesForUserResponseBody(ListPoliciesForUserResponseBody &&) = default ;
    ListPoliciesForUserResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPoliciesForUserResponseBody() = default ;
    ListPoliciesForUserResponseBody& operator=(const ListPoliciesForUserResponseBody &) = default ;
    ListPoliciesForUserResponseBody& operator=(ListPoliciesForUserResponseBody &&) = default ;
    ...
    inline const ListPoliciesForUserResponseBody::Policies & getPolicies() const { DARABONBA_PTR_GET_CONST(policies_, ListPoliciesForUserResponseBody::Policies) };
    inline ListPoliciesForUserResponseBody::Policies getPolicies() { DARABONBA_PTR_GET(policies_, ListPoliciesForUserResponseBody::Policies) };
    inline ListPoliciesForUserResponseBody& setPolicies(const ListPoliciesForUserResponseBody::Policies & policies) { DARABONBA_PTR_SET_VALUE(policies_, policies) };
    inline ListPoliciesForUserResponseBody& setPolicies(ListPoliciesForUserResponseBody::Policies && policies) { DARABONBA_PTR_SET_RVALUE(policies_, policies) };
    ...
    inline ListPoliciesForUserResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<ListPoliciesForUserResponseBody::Policies> policies_ {};
    // The request ID.
