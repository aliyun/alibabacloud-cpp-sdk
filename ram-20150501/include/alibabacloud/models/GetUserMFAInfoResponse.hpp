...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserMFAInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserMFAInfoResponseBody) };
    inline GetUserMFAInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserMFAInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserMFAInfoResponseBody> body_ {};
  };
