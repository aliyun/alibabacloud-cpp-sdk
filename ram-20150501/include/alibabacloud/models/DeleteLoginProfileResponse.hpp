...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLoginProfileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLoginProfileResponseBody) };
    inline DeleteLoginProfileResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLoginProfileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLoginProfileResponseBody> body_ {};
  };
