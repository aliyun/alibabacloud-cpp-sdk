...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->nextToken_ == nullptr
        && this->pageSize_ == nullptr && this->resourceNames_ == nullptr && this->resourceType_ == nullptr && this->tag_ == nullptr; };
    ...
    inline ListTagResourcesRequest& setResourceNames(const vector<string> & resourceNames) { DARABONBA_PTR_SET_VALUE(resourceNames_, resourceNames) };
    inline ListTagResourcesRequest& setResourceNames(vector<string> && resourceNames) { DARABONBA_PTR_SET_RVALUE(resourceNames_, resourceNames) };
