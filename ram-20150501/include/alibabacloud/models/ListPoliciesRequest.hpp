...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->marker_ == nullptr
        && this->maxItems_ == nullptr && this->policyType_ == nullptr && this->tag_ == nullptr; };
    // marker Field Functions 
    bool hasMarker() const { return this->marker_ != nullptr;};
    void deleteMarker() { this->marker_ = nullptr;};
    inline string getMarker() const { DARABONBA_PTR_GET_DEFAULT(marker_, "") };
    inline ListPoliciesRequest& setMarker(string marker) { DARABONBA_PTR_SET_VALUE(marker_, marker) };
    ...
    inline ListPoliciesRequest& setMaxItems(int32_t maxItems) { DARABONBA_PTR_SET_VALUE(maxItems_, maxItems) };
    ...
    inline const vector<ListPoliciesRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<ListPoliciesRequest::Tag>) };
    inline vector<ListPoliciesRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<ListPoliciesRequest::Tag>) };
    inline ListPoliciesRequest& setTag(const vector<ListPoliciesRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline ListPoliciesRequest& setTag(vector<ListPoliciesRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The tags.
    shared_ptr<vector<ListPoliciesRequest::Tag>> tag_ {};
  };
