...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAccessKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAccessKeyResponseBody) };
    inline DeleteAccessKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAccessKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAccessKeyResponseBody> body_ {};
  };
