...
namespace Models
{
  ...
  public:
    ...
    inline const GetSecurityPreferenceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSecurityPreferenceResponseBody) };
    inline GetSecurityPreferenceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSecurityPreferenceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSecurityPreferenceResponseBody> body_ {};
  };
