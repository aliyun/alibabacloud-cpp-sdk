...
namespace Models
{
  ...
  public:
    ...
    inline const ListFilePushStatusesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFilePushStatusesResponseBody) };
    inline ListFilePushStatusesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFilePushStatusesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFilePushStatusesResponseBody> body_ {};
  };
