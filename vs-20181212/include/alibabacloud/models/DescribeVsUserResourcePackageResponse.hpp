...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsUserResourcePackageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVsUserResourcePackageResponseBody) };
    inline DescribeVsUserResourcePackageResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVsUserResourcePackageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVsUserResourcePackageResponseBody> body_ {};
  };
