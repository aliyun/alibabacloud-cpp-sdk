...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchBindDirectoriesResponseBodyResults> & results() const { DARABONBA_PTR_GET_CONST(results_, vector<BatchBindDirectoriesResponseBodyResults>) };
    inline vector<BatchBindDirectoriesResponseBodyResults> results() { DARABONBA_PTR_GET(results_, vector<BatchBindDirectoriesResponseBodyResults>) };
    inline BatchBindDirectoriesResponseBody& setResults(const vector<BatchBindDirectoriesResponseBodyResults> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline BatchBindDirectoriesResponseBody& setResults(vector<BatchBindDirectoriesResponseBodyResults> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<BatchBindDirectoriesResponseBodyResults>> results_ = nullptr;
  };
