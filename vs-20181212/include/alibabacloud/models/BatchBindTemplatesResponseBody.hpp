...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchBindTemplatesResponseBodyResults> & results() const { DARABONBA_PTR_GET_CONST(results_, vector<BatchBindTemplatesResponseBodyResults>) };
    inline vector<BatchBindTemplatesResponseBodyResults> results() { DARABONBA_PTR_GET(results_, vector<BatchBindTemplatesResponseBodyResults>) };
    inline BatchBindTemplatesResponseBody& setResults(const vector<BatchBindTemplatesResponseBodyResults> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline BatchBindTemplatesResponseBody& setResults(vector<BatchBindTemplatesResponseBodyResults> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<BatchBindTemplatesResponseBodyResults>> results_ = nullptr;
  };
