...
namespace Models
{
  ...
  public:
    ...
    inline DeleteGroupRequest& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DeleteGroupRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
