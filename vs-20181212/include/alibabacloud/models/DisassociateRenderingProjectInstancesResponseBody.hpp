...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DisassociateRenderingProjectInstancesResponseBody::FailedInstances> & getFailedInstances() const { DARABONBA_PTR_GET_CONST(failedInstances_, vector<DisassociateRenderingProjectInstancesResponseBody::FailedInstances>) };
    inline vector<DisassociateRenderingProjectInstancesResponseBody::FailedInstances> getFailedInstances() { DARABONBA_PTR_GET(failedInstances_, vector<DisassociateRenderingProjectInstancesResponseBody::FailedInstances>) };
    inline DisassociateRenderingProjectInstancesResponseBody& setFailedInstances(const vector<DisassociateRenderingProjectInstancesResponseBody::FailedInstances> & failedInstances) { DARABONBA_PTR_SET_VALUE(failedInstances_, failedInstances) };
    inline DisassociateRenderingProjectInstancesResponseBody& setFailedInstances(vector<DisassociateRenderingProjectInstancesResponseBody::FailedInstances> && failedInstances) { DARABONBA_PTR_SET_RVALUE(failedInstances_, failedInstances) };
    ...
    inline const vector<DisassociateRenderingProjectInstancesResponseBody::SuccessInstances> & getSuccessInstances() const { DARABONBA_PTR_GET_CONST(successInstances_, vector<DisassociateRenderingProjectInstancesResponseBody::SuccessInstances>) };
    inline vector<DisassociateRenderingProjectInstancesResponseBody::SuccessInstances> getSuccessInstances() { DARABONBA_PTR_GET(successInstances_, vector<DisassociateRenderingProjectInstancesResponseBody::SuccessInstances>) };
    inline DisassociateRenderingProjectInstancesResponseBody& setSuccessInstances(const vector<DisassociateRenderingProjectInstancesResponseBody::SuccessInstances> & successInstances) { DARABONBA_PTR_SET_VALUE(successInstances_, successInstances) };
    inline DisassociateRenderingProjectInstancesResponseBody& setSuccessInstances(vector<DisassociateRenderingProjectInstancesResponseBody::SuccessInstances> && successInstances) { DARABONBA_PTR_SET_RVALUE(successInstances_, successInstances) };
