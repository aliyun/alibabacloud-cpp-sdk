...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVSDOMAINREGIONDATARESPONSEBODYVALUEREGIONPROPORTIONDATA_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVSDOMAINREGIONDATARESPONSEBODYVALUEREGIONPROPORTIONDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& obj) { 
    ...
    DescribeVsDomainRegionDataResponseBodyValueRegionProportionData() = default ;
    DescribeVsDomainRegionDataResponseBodyValueRegionProportionData(const DescribeVsDomainRegionDataResponseBodyValueRegionProportionData &) = default ;
    DescribeVsDomainRegionDataResponseBodyValueRegionProportionData(DescribeVsDomainRegionDataResponseBodyValueRegionProportionData &&) = default ;
    DescribeVsDomainRegionDataResponseBodyValueRegionProportionData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVsDomainRegionDataResponseBodyValueRegionProportionData() = default ;
    DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& operator=(const DescribeVsDomainRegionDataResponseBodyValueRegionProportionData &) = default ;
    DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& operator=(DescribeVsDomainRegionDataResponseBodyValueRegionProportionData &&) = default ;
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setAvgObjectSize(string avgObjectSize) { DARABONBA_PTR_SET_VALUE(avgObjectSize_, avgObjectSize) };
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setAvgResponseRate(string avgResponseRate) { DARABONBA_PTR_SET_VALUE(avgResponseRate_, avgResponseRate) };
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setAvgResponseTime(string avgResponseTime) { DARABONBA_PTR_SET_VALUE(avgResponseTime_, avgResponseTime) };
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setBps(string bps) { DARABONBA_PTR_SET_VALUE(bps_, bps) };
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setBytesProportion(string bytesProportion) { DARABONBA_PTR_SET_VALUE(bytesProportion_, bytesProportion) };
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setProportion(string proportion) { DARABONBA_PTR_SET_VALUE(proportion_, proportion) };
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setQps(string qps) { DARABONBA_PTR_SET_VALUE(qps_, qps) };
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setRegionEname(string regionEname) { DARABONBA_PTR_SET_VALUE(regionEname_, regionEname) };
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setReqErrRate(string reqErrRate) { DARABONBA_PTR_SET_VALUE(reqErrRate_, reqErrRate) };
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setTotalBytes(string totalBytes) { DARABONBA_PTR_SET_VALUE(totalBytes_, totalBytes) };
    ...
    inline DescribeVsDomainRegionDataResponseBodyValueRegionProportionData& setTotalQuery(string totalQuery) { DARABONBA_PTR_SET_VALUE(totalQuery_, totalQuery) };
