...
namespace Models
{
  ...
  public:
    ...
    inline const BatchBindTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchBindTemplatesResponseBody) };
    inline BatchBindTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchBindTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchBindTemplatesResponseBody> body_ {};
  };
