...
namespace Models
{
  ...
  public:
    ...
    inline const ManageLoginResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ManageLoginResponseBody) };
    inline ManageLoginResponseBody getBody() { DARABONBA_PTR_GET(body_, ManageLoginResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ManageLoginResponseBody> body_ {};
  };
