...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsDomainDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVsDomainDetailResponseBody) };
    inline DescribeVsDomainDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVsDomainDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVsDomainDetailResponseBody> body_ {};
  };
