...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyRenderingInstanceBandwidthResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyRenderingInstanceBandwidthResponseBody) };
    inline ModifyRenderingInstanceBandwidthResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyRenderingInstanceBandwidthResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyRenderingInstanceBandwidthResponseBody> body_ {};
  };
