...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alarmMethod_ == nullptr
        ...
        && return this->port_ == nullptr && return this->posInterval_ == nullptr && return this->protocol_ == nullptr && return this->registeredTime_ == nullptr && return this->stats_ == nullptr
        && return this->status_ == nullptr && return this->type_ == nullptr && return this->url_ == nullptr && return this->username_ == nullptr && return this->vendor_ == nullptr; };
