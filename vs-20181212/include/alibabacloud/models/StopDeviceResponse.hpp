...
namespace Models
{
  ...
  public:
    ...
    inline const StopDeviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopDeviceResponseBody) };
    inline StopDeviceResponseBody getBody() { DARABONBA_PTR_GET(body_, StopDeviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopDeviceResponseBody> body_ {};
  };
