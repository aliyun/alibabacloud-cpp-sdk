...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsTopDomainsByFlowResponseBody::TopDomains & getTopDomains() const { DARABONBA_PTR_GET_CONST(topDomains_, DescribeVsTopDomainsByFlowResponseBody::TopDomains) };
    inline DescribeVsTopDomainsByFlowResponseBody::TopDomains getTopDomains() { DARABONBA_PTR_GET(topDomains_, DescribeVsTopDomainsByFlowResponseBody::TopDomains) };
    inline DescribeVsTopDomainsByFlowResponseBody& setTopDomains(const DescribeVsTopDomainsByFlowResponseBody::TopDomains & topDomains) { DARABONBA_PTR_SET_VALUE(topDomains_, topDomains) };
    inline DescribeVsTopDomainsByFlowResponseBody& setTopDomains(DescribeVsTopDomainsByFlowResponseBody::TopDomains && topDomains) { DARABONBA_PTR_SET_RVALUE(topDomains_, topDomains) };
