...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsDomainPvDataResponseBodyPvDataInterval & pvDataInterval() const { DARABONBA_PTR_GET_CONST(pvDataInterval_, DescribeVsDomainPvDataResponseBodyPvDataInterval) };
    inline DescribeVsDomainPvDataResponseBodyPvDataInterval pvDataInterval() { DARABONBA_PTR_GET(pvDataInterval_, DescribeVsDomainPvDataResponseBodyPvDataInterval) };
    inline DescribeVsDomainPvDataResponseBody& setPvDataInterval(const DescribeVsDomainPvDataResponseBodyPvDataInterval & pvDataInterval) { DARABONBA_PTR_SET_VALUE(pvDataInterval_, pvDataInterval) };
    inline DescribeVsDomainPvDataResponseBody& setPvDataInterval(DescribeVsDomainPvDataResponseBodyPvDataInterval && pvDataInterval) { DARABONBA_PTR_SET_RVALUE(pvDataInterval_, pvDataInterval) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVsDomainPvDataResponseBodyPvDataInterval> pvDataInterval_ = nullptr;
