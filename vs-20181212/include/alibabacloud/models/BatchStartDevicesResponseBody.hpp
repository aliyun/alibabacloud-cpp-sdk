...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchStartDevicesResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<BatchStartDevicesResponseBody::Results>) };
    inline vector<BatchStartDevicesResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<BatchStartDevicesResponseBody::Results>) };
    inline BatchStartDevicesResponseBody& setResults(const vector<BatchStartDevicesResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline BatchStartDevicesResponseBody& setResults(vector<BatchStartDevicesResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
