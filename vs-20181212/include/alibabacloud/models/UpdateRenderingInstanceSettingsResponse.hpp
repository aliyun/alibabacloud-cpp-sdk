...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRenderingInstanceSettingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateRenderingInstanceSettingsResponseBody) };
    inline UpdateRenderingInstanceSettingsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateRenderingInstanceSettingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateRenderingInstanceSettingsResponseBody> body_ {};
  };
