...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListPublicKeysResponseBodyPublicKeys> & publicKeys() const { DARABONBA_PTR_GET_CONST(publicKeys_, vector<ListPublicKeysResponseBodyPublicKeys>) };
    inline vector<ListPublicKeysResponseBodyPublicKeys> publicKeys() { DARABONBA_PTR_GET(publicKeys_, vector<ListPublicKeysResponseBodyPublicKeys>) };
    inline ListPublicKeysResponseBody& setPublicKeys(const vector<ListPublicKeysResponseBodyPublicKeys> & publicKeys) { DARABONBA_PTR_SET_VALUE(publicKeys_, publicKeys) };
    inline ListPublicKeysResponseBody& setPublicKeys(vector<ListPublicKeysResponseBodyPublicKeys> && publicKeys) { DARABONBA_PTR_SET_RVALUE(publicKeys_, publicKeys) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListPublicKeysResponseBodyPublicKeys>> publicKeys_ = nullptr;
