...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataInterval_ == nullptr
        && return this->domainName_ == nullptr && return this->endTime_ == nullptr && return this->reqBpsDataPerInterval_ == nullptr && return this->requestId_ == nullptr && return this->startTime_ == nullptr; };
    ...
    inline const DescribeVsDomainReqBpsDataResponseBodyReqBpsDataPerInterval & reqBpsDataPerInterval() const { DARABONBA_PTR_GET_CONST(reqBpsDataPerInterval_, DescribeVsDomainReqBpsDataResponseBodyReqBpsDataPerInterval) };
    inline DescribeVsDomainReqBpsDataResponseBodyReqBpsDataPerInterval reqBpsDataPerInterval() { DARABONBA_PTR_GET(reqBpsDataPerInterval_, DescribeVsDomainReqBpsDataResponseBodyReqBpsDataPerInterval) };
    inline DescribeVsDomainReqBpsDataResponseBody& setReqBpsDataPerInterval(const DescribeVsDomainReqBpsDataResponseBodyReqBpsDataPerInterval & reqBpsDataPerInterval) { DARABONBA_PTR_SET_VALUE(reqBpsDataPerInterval_, reqBpsDataPerInterval) };
    inline DescribeVsDomainReqBpsDataResponseBody& setReqBpsDataPerInterval(DescribeVsDomainReqBpsDataResponseBodyReqBpsDataPerInterval && reqBpsDataPerInterval) { DARABONBA_PTR_SET_RVALUE(reqBpsDataPerInterval_, reqBpsDataPerInterval) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVsDomainReqBpsDataResponseBodyReqBpsDataPerInterval> reqBpsDataPerInterval_ = nullptr;
