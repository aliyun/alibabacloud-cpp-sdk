...
namespace Models
{
  ...
  public:
    ...
    inline const vector<InstallCloudAppResponseBody::FailedInstances> & getFailedInstances() const { DARABONBA_PTR_GET_CONST(failedInstances_, vector<InstallCloudAppResponseBody::FailedInstances>) };
    inline vector<InstallCloudAppResponseBody::FailedInstances> getFailedInstances() { DARABONBA_PTR_GET(failedInstances_, vector<InstallCloudAppResponseBody::FailedInstances>) };
    inline InstallCloudAppResponseBody& setFailedInstances(const vector<InstallCloudAppResponseBody::FailedInstances> & failedInstances) { DARABONBA_PTR_SET_VALUE(failedInstances_, failedInstances) };
    inline InstallCloudAppResponseBody& setFailedInstances(vector<InstallCloudAppResponseBody::FailedInstances> && failedInstances) { DARABONBA_PTR_SET_RVALUE(failedInstances_, failedInstances) };
    ...
    inline const vector<InstallCloudAppResponseBody::SuccessInstances> & getSuccessInstances() const { DARABONBA_PTR_GET_CONST(successInstances_, vector<InstallCloudAppResponseBody::SuccessInstances>) };
    inline vector<InstallCloudAppResponseBody::SuccessInstances> getSuccessInstances() { DARABONBA_PTR_GET(successInstances_, vector<InstallCloudAppResponseBody::SuccessInstances>) };
    inline InstallCloudAppResponseBody& setSuccessInstances(const vector<InstallCloudAppResponseBody::SuccessInstances> & successInstances) { DARABONBA_PTR_SET_VALUE(successInstances_, successInstances) };
    inline InstallCloudAppResponseBody& setSuccessInstances(vector<InstallCloudAppResponseBody::SuccessInstances> && successInstances) { DARABONBA_PTR_SET_RVALUE(successInstances_, successInstances) };


  protected:
    shared_ptr<int32_t> failedInstanceCount_ {};
    shared_ptr<vector<InstallCloudAppResponseBody::FailedInstances>> failedInstances_ {};
    shared_ptr<string> requestId_ {};
    shared_ptr<int32_t> successInstanceCount_ {};
    shared_ptr<vector<InstallCloudAppResponseBody::SuccessInstances>> successInstances_ {};
  };
