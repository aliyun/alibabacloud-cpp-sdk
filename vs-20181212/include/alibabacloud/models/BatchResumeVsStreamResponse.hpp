...
namespace Models
{
  ...
  public:
    ...
    inline const BatchResumeVsStreamResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchResumeVsStreamResponseBody) };
    inline BatchResumeVsStreamResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchResumeVsStreamResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchResumeVsStreamResponseBody> body_ {};
  };
