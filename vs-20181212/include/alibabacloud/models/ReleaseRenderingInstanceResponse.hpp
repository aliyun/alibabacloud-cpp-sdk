...
namespace Models
{
  ...
  public:
    ...
    inline const ReleaseRenderingInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReleaseRenderingInstanceResponseBody) };
    inline ReleaseRenderingInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ReleaseRenderingInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReleaseRenderingInstanceResponseBody> body_ {};
  };
