...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRenderingInstanceConfigurationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteRenderingInstanceConfigurationResponseBody) };
    inline DeleteRenderingInstanceConfigurationResponseBody body() { DARABONBA_PTR_GET(body_, DeleteRenderingInstanceConfigurationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteRenderingInstanceConfigurationResponseBody> body_ = nullptr;
  };
