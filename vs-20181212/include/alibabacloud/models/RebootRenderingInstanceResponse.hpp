...
namespace Models
{
  ...
  public:
    ...
    inline const RebootRenderingInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RebootRenderingInstanceResponseBody) };
    inline RebootRenderingInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, RebootRenderingInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RebootRenderingInstanceResponseBody> body_ {};
  };
