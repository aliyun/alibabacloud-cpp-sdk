...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsDomainRecordDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVsDomainRecordDataResponseBody) };
    inline DescribeVsDomainRecordDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVsDomainRecordDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVsDomainRecordDataResponseBody> body_ {};
  };
