...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePresetResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeletePresetResponseBody) };
    inline DeletePresetResponseBody body() { DARABONBA_PTR_GET(body_, DeletePresetResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeletePresetResponseBody> body_ = nullptr;
  };
