...
#ifndef ALIBABACLOUD_MODELS_DESCRIBETEMPLATERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeTemplateResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeTemplateResponseBody& obj) { 
    ...
    DescribeTemplateResponseBody() = default ;
    DescribeTemplateResponseBody(const DescribeTemplateResponseBody &) = default ;
    DescribeTemplateResponseBody(DescribeTemplateResponseBody &&) = default ;
    DescribeTemplateResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeTemplateResponseBody() = default ;
    DescribeTemplateResponseBody& operator=(const DescribeTemplateResponseBody &) = default ;
    DescribeTemplateResponseBody& operator=(DescribeTemplateResponseBody &&) = default ;
