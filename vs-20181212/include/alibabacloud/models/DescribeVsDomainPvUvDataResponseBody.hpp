...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsDomainPvUvDataResponseBody::PvUvDataInfos & getPvUvDataInfos() const { DARABONBA_PTR_GET_CONST(pvUvDataInfos_, DescribeVsDomainPvUvDataResponseBody::PvUvDataInfos) };
    inline DescribeVsDomainPvUvDataResponseBody::PvUvDataInfos getPvUvDataInfos() { DARABONBA_PTR_GET(pvUvDataInfos_, DescribeVsDomainPvUvDataResponseBody::PvUvDataInfos) };
    inline DescribeVsDomainPvUvDataResponseBody& setPvUvDataInfos(const DescribeVsDomainPvUvDataResponseBody::PvUvDataInfos & pvUvDataInfos) { DARABONBA_PTR_SET_VALUE(pvUvDataInfos_, pvUvDataInfos) };
    inline DescribeVsDomainPvUvDataResponseBody& setPvUvDataInfos(DescribeVsDomainPvUvDataResponseBody::PvUvDataInfos && pvUvDataInfos) { DARABONBA_PTR_SET_RVALUE(pvUvDataInfos_, pvUvDataInfos) };
