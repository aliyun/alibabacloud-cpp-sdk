...
#ifndef ALIBABACLOUD_MODELS_ADDHIVEEDGEWORKERSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ADDHIVEEDGEWORKERSRESPONSEBODY_HPP_
...
namespace Models
{
  class AddHiveEdgeWorkersResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AddHiveEdgeWorkersResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddHiveEdgeWorkersResponseBody& obj) { 
    ...
    AddHiveEdgeWorkersResponseBody() = default ;
    AddHiveEdgeWorkersResponseBody(const AddHiveEdgeWorkersResponseBody &) = default ;
    AddHiveEdgeWorkersResponseBody(AddHiveEdgeWorkersResponseBody &&) = default ;
    AddHiveEdgeWorkersResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddHiveEdgeWorkersResponseBody() = default ;
    AddHiveEdgeWorkersResponseBody& operator=(const AddHiveEdgeWorkersResponseBody &) = default ;
    AddHiveEdgeWorkersResponseBody& operator=(AddHiveEdgeWorkersResponseBody &&) = default ;
    ...
    inline AddHiveEdgeWorkersResponseBody& setFailedInstanceCount(int32_t failedInstanceCount) { DARABONBA_PTR_SET_VALUE(failedInstanceCount_, failedInstanceCount) };
    ...
    inline const vector<AddHiveEdgeWorkersResponseBody::FailedInstances> & getFailedInstances() const { DARABONBA_PTR_GET_CONST(failedInstances_, vector<AddHiveEdgeWorkersResponseBody::FailedInstances>) };
    inline vector<AddHiveEdgeWorkersResponseBody::FailedInstances> getFailedInstances() { DARABONBA_PTR_GET(failedInstances_, vector<AddHiveEdgeWorkersResponseBody::FailedInstances>) };
    inline AddHiveEdgeWorkersResponseBody& setFailedInstances(const vector<AddHiveEdgeWorkersResponseBody::FailedInstances> & failedInstances) { DARABONBA_PTR_SET_VALUE(failedInstances_, failedInstances) };
    inline AddHiveEdgeWorkersResponseBody& setFailedInstances(vector<AddHiveEdgeWorkersResponseBody::FailedInstances> && failedInstances) { DARABONBA_PTR_SET_RVALUE(failedInstances_, failedInstances) };
    ...
    inline AddHiveEdgeWorkersResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline AddHiveEdgeWorkersResponseBody& setSuccessInstanceCount(int32_t successInstanceCount) { DARABONBA_PTR_SET_VALUE(successInstanceCount_, successInstanceCount) };
    ...
    inline const vector<AddHiveEdgeWorkersResponseBody::SuccessInstances> & getSuccessInstances() const { DARABONBA_PTR_GET_CONST(successInstances_, vector<AddHiveEdgeWorkersResponseBody::SuccessInstances>) };
    inline vector<AddHiveEdgeWorkersResponseBody::SuccessInstances> getSuccessInstances() { DARABONBA_PTR_GET(successInstances_, vector<AddHiveEdgeWorkersResponseBody::SuccessInstances>) };
    inline AddHiveEdgeWorkersResponseBody& setSuccessInstances(const vector<AddHiveEdgeWorkersResponseBody::SuccessInstances> & successInstances) { DARABONBA_PTR_SET_VALUE(successInstances_, successInstances) };
    inline AddHiveEdgeWorkersResponseBody& setSuccessInstances(vector<AddHiveEdgeWorkersResponseBody::SuccessInstances> && successInstances) { DARABONBA_PTR_SET_RVALUE(successInstances_, successInstances) };
