...
namespace Models
{
  ...
  public:
    ...
    inline const GetRenderingProjectInstanceStateMetricsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRenderingProjectInstanceStateMetricsResponseBody) };
    inline GetRenderingProjectInstanceStateMetricsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRenderingProjectInstanceStateMetricsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRenderingProjectInstanceStateMetricsResponseBody> body_ {};
  };
