...
namespace Models
{
  ...
  public:
    ...
    inline bool getPan() const { DARABONBA_PTR_GET_DEFAULT(pan_, false) };
    ...
    inline bool getTilt() const { DARABONBA_PTR_GET_DEFAULT(tilt_, false) };
    ...
    inline bool getZoom() const { DARABONBA_PTR_GET_DEFAULT(zoom_, false) };
