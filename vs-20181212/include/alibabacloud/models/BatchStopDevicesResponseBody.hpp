...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchStopDevicesResponseBodyResults> & results() const { DARABONBA_PTR_GET_CONST(results_, vector<BatchStopDevicesResponseBodyResults>) };
    inline vector<BatchStopDevicesResponseBodyResults> results() { DARABONBA_PTR_GET(results_, vector<BatchStopDevicesResponseBodyResults>) };
    inline BatchStopDevicesResponseBody& setResults(const vector<BatchStopDevicesResponseBodyResults> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline BatchStopDevicesResponseBody& setResults(vector<BatchStopDevicesResponseBodyResults> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<BatchStopDevicesResponseBodyResults>> results_ = nullptr;
  };
