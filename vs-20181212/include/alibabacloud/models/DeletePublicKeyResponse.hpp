...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePublicKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePublicKeyResponseBody) };
    inline DeletePublicKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePublicKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePublicKeyResponseBody> body_ {};
  };
