...
namespace Models
{
  ...
  public:
    ...
    inline const ListCloudAppInstallationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCloudAppInstallationsResponseBody) };
    inline ListCloudAppInstallationsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCloudAppInstallationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCloudAppInstallationsResponseBody> body_ {};
  };
