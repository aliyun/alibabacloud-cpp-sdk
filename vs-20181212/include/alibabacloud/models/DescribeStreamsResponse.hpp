...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeStreamsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeStreamsResponseBody) };
    inline DescribeStreamsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeStreamsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeStreamsResponseBody> body_ {};
  };
