...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsCertificateListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVsCertificateListResponseBody) };
    inline DescribeVsCertificateListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVsCertificateListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVsCertificateListResponseBody> body_ {};
  };
