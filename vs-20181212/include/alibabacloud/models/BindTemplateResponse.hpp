...
namespace Models
{
  ...
  public:
    ...
    inline const BindTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindTemplateResponseBody) };
    inline BindTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, BindTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindTemplateResponseBody> body_ {};
  };
