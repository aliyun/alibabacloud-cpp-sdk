...
namespace Models
{
  ...
  public:
    ...
    inline const VerifyVsDomainOwnerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, VerifyVsDomainOwnerResponseBody) };
    inline VerifyVsDomainOwnerResponseBody getBody() { DARABONBA_PTR_GET(body_, VerifyVsDomainOwnerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<VerifyVsDomainOwnerResponseBody> body_ {};
  };
