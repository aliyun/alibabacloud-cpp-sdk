...
namespace Models
{
  ...
  public:
    ...
    inline const UploadPublicKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadPublicKeyResponseBody) };
    inline UploadPublicKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadPublicKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadPublicKeyResponseBody> body_ {};
  };
