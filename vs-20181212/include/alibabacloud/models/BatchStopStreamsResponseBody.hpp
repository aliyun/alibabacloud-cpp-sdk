...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchStopStreamsResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<BatchStopStreamsResponseBody::Results>) };
    inline vector<BatchStopStreamsResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<BatchStopStreamsResponseBody::Results>) };
    inline BatchStopStreamsResponseBody& setResults(const vector<BatchStopStreamsResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline BatchStopStreamsResponseBody& setResults(vector<BatchStopStreamsResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
