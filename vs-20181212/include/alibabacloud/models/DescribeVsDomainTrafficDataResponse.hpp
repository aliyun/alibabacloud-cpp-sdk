...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsDomainTrafficDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVsDomainTrafficDataResponseBody) };
    inline DescribeVsDomainTrafficDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVsDomainTrafficDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVsDomainTrafficDataResponseBody> body_ {};
  };
