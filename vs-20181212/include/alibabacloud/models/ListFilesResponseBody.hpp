...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListFilesResponseBodyFiles> & files() const { DARABONBA_PTR_GET_CONST(files_, vector<ListFilesResponseBodyFiles>) };
    inline vector<ListFilesResponseBodyFiles> files() { DARABONBA_PTR_GET(files_, vector<ListFilesResponseBodyFiles>) };
    inline ListFilesResponseBody& setFiles(const vector<ListFilesResponseBodyFiles> & files) { DARABONBA_PTR_SET_VALUE(files_, files) };
    inline ListFilesResponseBody& setFiles(vector<ListFilesResponseBodyFiles> && files) { DARABONBA_PTR_SET_RVALUE(files_, files) };
  ...
  protected:
    std::shared_ptr<vector<ListFilesResponseBodyFiles>> files_ = nullptr;
