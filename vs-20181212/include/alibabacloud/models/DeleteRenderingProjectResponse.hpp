...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRenderingProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRenderingProjectResponseBody) };
    inline DeleteRenderingProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRenderingProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRenderingProjectResponseBody> body_ {};
  };
