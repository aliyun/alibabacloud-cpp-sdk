...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeParentPlatformResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeParentPlatformResponseBody) };
    inline DescribeParentPlatformResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeParentPlatformResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeParentPlatformResponseBody> body_ {};
  };
