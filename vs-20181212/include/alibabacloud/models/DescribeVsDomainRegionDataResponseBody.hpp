...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsDomainRegionDataResponseBody::Value & getValue() const { DARABONBA_PTR_GET_CONST(value_, DescribeVsDomainRegionDataResponseBody::Value) };
    inline DescribeVsDomainRegionDataResponseBody::Value getValue() { DARABONBA_PTR_GET(value_, DescribeVsDomainRegionDataResponseBody::Value) };
    inline DescribeVsDomainRegionDataResponseBody& setValue(const DescribeVsDomainRegionDataResponseBody::Value & value) { DARABONBA_PTR_SET_VALUE(value_, value) };
    inline DescribeVsDomainRegionDataResponseBody& setValue(DescribeVsDomainRegionDataResponseBody::Value && value) { DARABONBA_PTR_SET_RVALUE(value_, value) };
