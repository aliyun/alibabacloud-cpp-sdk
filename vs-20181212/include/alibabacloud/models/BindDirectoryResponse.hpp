...
namespace Models
{
  ...
  public:
    ...
    inline const BindDirectoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindDirectoryResponseBody) };
    inline BindDirectoryResponseBody getBody() { DARABONBA_PTR_GET(body_, BindDirectoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindDirectoryResponseBody> body_ {};
  };
