...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDirectoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDirectoryResponseBody) };
    inline ModifyDirectoryResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDirectoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDirectoryResponseBody> body_ {};
  };
