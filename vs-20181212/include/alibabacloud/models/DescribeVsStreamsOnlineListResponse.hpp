...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsStreamsOnlineListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeVsStreamsOnlineListResponseBody) };
    inline DescribeVsStreamsOnlineListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeVsStreamsOnlineListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVsStreamsOnlineListResponseBody> body_ = nullptr;
  };
