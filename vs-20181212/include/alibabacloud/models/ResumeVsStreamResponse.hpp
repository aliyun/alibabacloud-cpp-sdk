...
namespace Models
{
  ...
  public:
    ...
    inline const ResumeVsStreamResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ResumeVsStreamResponseBody) };
    inline ResumeVsStreamResponseBody body() { DARABONBA_PTR_GET(body_, ResumeVsStreamResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ResumeVsStreamResponseBody> body_ = nullptr;
  };
