...
namespace Models
{
  ...
  public:
    ...
    inline const StartStreamResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartStreamResponseBody) };
    inline StartStreamResponseBody getBody() { DARABONBA_PTR_GET(body_, StartStreamResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartStreamResponseBody> body_ {};
  };
