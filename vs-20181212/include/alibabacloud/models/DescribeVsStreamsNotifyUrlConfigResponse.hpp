...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsStreamsNotifyUrlConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVsStreamsNotifyUrlConfigResponseBody) };
    inline DescribeVsStreamsNotifyUrlConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVsStreamsNotifyUrlConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVsStreamsNotifyUrlConfigResponseBody> body_ {};
  };
