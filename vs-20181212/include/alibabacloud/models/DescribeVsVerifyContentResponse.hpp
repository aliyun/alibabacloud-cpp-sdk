...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsVerifyContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVsVerifyContentResponseBody) };
    inline DescribeVsVerifyContentResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVsVerifyContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVsVerifyContentResponseBody> body_ {};
  };
