...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsUpPeakPublishStreamDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVsUpPeakPublishStreamDataResponseBody) };
    inline DescribeVsUpPeakPublishStreamDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVsUpPeakPublishStreamDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVsUpPeakPublishStreamDataResponseBody> body_ {};
  };
