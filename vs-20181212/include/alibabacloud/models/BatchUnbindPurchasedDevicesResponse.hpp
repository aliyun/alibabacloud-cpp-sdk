...
namespace Models
{
  ...
  public:
    ...
    inline const BatchUnbindPurchasedDevicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchUnbindPurchasedDevicesResponseBody) };
    inline BatchUnbindPurchasedDevicesResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchUnbindPurchasedDevicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchUnbindPurchasedDevicesResponseBody> body_ {};
  };
