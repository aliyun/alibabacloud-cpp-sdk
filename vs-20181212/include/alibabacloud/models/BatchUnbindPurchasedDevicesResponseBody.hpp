...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchUnbindPurchasedDevicesResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<BatchUnbindPurchasedDevicesResponseBody::Results>) };
    inline vector<BatchUnbindPurchasedDevicesResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<BatchUnbindPurchasedDevicesResponseBody::Results>) };
    inline BatchUnbindPurchasedDevicesResponseBody& setResults(const vector<BatchUnbindPurchasedDevicesResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline BatchUnbindPurchasedDevicesResponseBody& setResults(vector<BatchUnbindPurchasedDevicesResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
