...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cname_ == nullptr
        && return this->description_ == nullptr && return this->domainName_ == nullptr && return this->domainStatus_ == nullptr && return this->domainType_ == nullptr && return this->gmtCreated_ == nullptr
        && return this->gmtModified_ == nullptr && return this->region_ == nullptr && return this->SSLProtocol_ == nullptr && return this->scope_ == nullptr; };
