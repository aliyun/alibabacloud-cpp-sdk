...
namespace Models
{
  ...
  public:
    ...
    inline const ListRenderingProjectsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRenderingProjectsResponseBody) };
    inline ListRenderingProjectsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRenderingProjectsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRenderingProjectsResponseBody> body_ {};
  };
