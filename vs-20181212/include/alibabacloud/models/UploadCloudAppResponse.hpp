...
namespace Models
{
  ...
  public:
    ...
    inline const UploadCloudAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadCloudAppResponseBody) };
    inline UploadCloudAppResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadCloudAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadCloudAppResponseBody> body_ {};
  };
