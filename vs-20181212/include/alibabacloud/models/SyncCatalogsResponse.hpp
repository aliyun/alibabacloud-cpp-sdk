...
namespace Models
{
  ...
  public:
    ...
    inline const SyncCatalogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SyncCatalogsResponseBody) };
    inline SyncCatalogsResponseBody getBody() { DARABONBA_PTR_GET(body_, SyncCatalogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SyncCatalogsResponseBody> body_ {};
  };
