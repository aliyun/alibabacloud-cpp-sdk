...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyRenderingInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyRenderingInstanceResponseBody) };
    inline ModifyRenderingInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyRenderingInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyRenderingInstanceResponseBody> body_ {};
  };
