...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callback_ == nullptr
        && return this->description_ == nullptr && return this->fileFormat_ == nullptr && return this->flv_ == nullptr && return this->hlsM3u8_ == nullptr && return this->hlsTs_ == nullptr
        && return this->interval_ == nullptr && return this->jpgOnDemand_ == nullptr && return this->jpgOverwrite_ == nullptr && return this->jpgSequence_ == nullptr && return this->mp4_ == nullptr
        && return this->name_ == nullptr && return this->ossBucket_ == nullptr && return this->ossEndpoint_ == nullptr && return this->ossFilePrefix_ == nullptr && return this->ownerId_ == nullptr
        && return this->region_ == nullptr && return this->retention_ == nullptr && return this->transConfigsJSON_ == nullptr && return this->trigger_ == nullptr && return this->type_ == nullptr; };
