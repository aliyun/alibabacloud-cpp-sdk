...
namespace Models
{
  ...
  public:
    ...
    inline const ListRenderingProjectInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRenderingProjectInstancesResponseBody) };
    inline ListRenderingProjectInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRenderingProjectInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRenderingProjectInstancesResponseBody> body_ {};
  };
