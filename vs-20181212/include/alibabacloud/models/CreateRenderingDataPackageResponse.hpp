...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRenderingDataPackageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRenderingDataPackageResponseBody) };
    inline CreateRenderingDataPackageResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRenderingDataPackageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRenderingDataPackageResponseBody> body_ {};
  };
