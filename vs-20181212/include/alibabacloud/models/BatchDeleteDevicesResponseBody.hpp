...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchDeleteDevicesResponseBodyResults> & results() const { DARABONBA_PTR_GET_CONST(results_, vector<BatchDeleteDevicesResponseBodyResults>) };
    inline vector<BatchDeleteDevicesResponseBodyResults> results() { DARABONBA_PTR_GET(results_, vector<BatchDeleteDevicesResponseBodyResults>) };
    inline BatchDeleteDevicesResponseBody& setResults(const vector<BatchDeleteDevicesResponseBodyResults> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline BatchDeleteDevicesResponseBody& setResults(vector<BatchDeleteDevicesResponseBodyResults> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<BatchDeleteDevicesResponseBodyResults>> results_ = nullptr;
  };
