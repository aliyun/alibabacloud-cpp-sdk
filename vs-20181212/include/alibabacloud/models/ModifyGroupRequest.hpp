...
namespace Models
{
  ...
  public:
    ...
    inline ModifyGroupRequest& setCallback(string callback) { DARABONBA_PTR_SET_VALUE(callback_, callback) };
    ...
    inline ModifyGroupRequest& setEnabled(bool enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
    ...
    inline ModifyGroupRequest& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ModifyGroupRequest& setInProtocol(string inProtocol) { DARABONBA_PTR_SET_VALUE(inProtocol_, inProtocol) };
    ...
    inline ModifyGroupRequest& setLazyPull(bool lazyPull) { DARABONBA_PTR_SET_VALUE(lazyPull_, lazyPull) };
    ...
    inline ModifyGroupRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ModifyGroupRequest& setOutProtocol(string outProtocol) { DARABONBA_PTR_SET_VALUE(outProtocol_, outProtocol) };
    ...
    inline ModifyGroupRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ModifyGroupRequest& setPlayDomain(string playDomain) { DARABONBA_PTR_SET_VALUE(playDomain_, playDomain) };
    ...
    inline ModifyGroupRequest& setPushDomain(string pushDomain) { DARABONBA_PTR_SET_VALUE(pushDomain_, pushDomain) };
    ...
    inline ModifyGroupRequest& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
