...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchStartStreamsResponseBodyResults> & results() const { DARABONBA_PTR_GET_CONST(results_, vector<BatchStartStreamsResponseBodyResults>) };
    inline vector<BatchStartStreamsResponseBodyResults> results() { DARABONBA_PTR_GET(results_, vector<BatchStartStreamsResponseBodyResults>) };
    inline BatchStartStreamsResponseBody& setResults(const vector<BatchStartStreamsResponseBodyResults> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline BatchStartStreamsResponseBody& setResults(vector<BatchStartStreamsResponseBodyResults> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<BatchStartStreamsResponseBodyResults>> results_ = nullptr;
  };
