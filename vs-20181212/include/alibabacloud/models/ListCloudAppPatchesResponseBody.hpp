...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->patches_ == nullptr && return this->requestId_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const vector<ListCloudAppPatchesResponseBodyPatches> & patches() const { DARABONBA_PTR_GET_CONST(patches_, vector<ListCloudAppPatchesResponseBodyPatches>) };
    inline vector<ListCloudAppPatchesResponseBodyPatches> patches() { DARABONBA_PTR_GET(patches_, vector<ListCloudAppPatchesResponseBodyPatches>) };
    inline ListCloudAppPatchesResponseBody& setPatches(const vector<ListCloudAppPatchesResponseBodyPatches> & patches) { DARABONBA_PTR_SET_VALUE(patches_, patches) };
    inline ListCloudAppPatchesResponseBody& setPatches(vector<ListCloudAppPatchesResponseBodyPatches> && patches) { DARABONBA_PTR_SET_RVALUE(patches_, patches) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListCloudAppPatchesResponseBodyPatches>> patches_ = nullptr;
    // Id of the request
