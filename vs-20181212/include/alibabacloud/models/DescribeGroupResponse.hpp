...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeGroupResponseBody) };
    inline DescribeGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeGroupResponseBody> body_ {};
  };
