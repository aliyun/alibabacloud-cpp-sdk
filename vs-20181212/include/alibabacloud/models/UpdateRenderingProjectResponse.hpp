...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRenderingProjectResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateRenderingProjectResponseBody) };
    inline UpdateRenderingProjectResponseBody body() { DARABONBA_PTR_GET(body_, UpdateRenderingProjectResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateRenderingProjectResponseBody> body_ = nullptr;
  };
