...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsStreamsPublishListResponseBody::PublishInfo & getPublishInfo() const { DARABONBA_PTR_GET_CONST(publishInfo_, DescribeVsStreamsPublishListResponseBody::PublishInfo) };
    inline DescribeVsStreamsPublishListResponseBody::PublishInfo getPublishInfo() { DARABONBA_PTR_GET(publishInfo_, DescribeVsStreamsPublishListResponseBody::PublishInfo) };
    inline DescribeVsStreamsPublishListResponseBody& setPublishInfo(const DescribeVsStreamsPublishListResponseBody::PublishInfo & publishInfo) { DARABONBA_PTR_SET_VALUE(publishInfo_, publishInfo) };
    inline DescribeVsStreamsPublishListResponseBody& setPublishInfo(DescribeVsStreamsPublishListResponseBody::PublishInfo && publishInfo) { DARABONBA_PTR_SET_RVALUE(publishInfo_, publishInfo) };
