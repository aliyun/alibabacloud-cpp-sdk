...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDeviceAlarmResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDeviceAlarmResponseBody) };
    inline CreateDeviceAlarmResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDeviceAlarmResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDeviceAlarmResponseBody> body_ {};
  };
