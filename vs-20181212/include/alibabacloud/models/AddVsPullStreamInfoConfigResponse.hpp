...
namespace Models
{
  ...
  public:
    ...
    inline const AddVsPullStreamInfoConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddVsPullStreamInfoConfigResponseBody) };
    inline AddVsPullStreamInfoConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, AddVsPullStreamInfoConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddVsPullStreamInfoConfigResponseBody> body_ {};
  };
