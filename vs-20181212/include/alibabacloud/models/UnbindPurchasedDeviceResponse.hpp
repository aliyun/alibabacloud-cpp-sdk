...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindPurchasedDeviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnbindPurchasedDeviceResponseBody) };
    inline UnbindPurchasedDeviceResponseBody getBody() { DARABONBA_PTR_GET(body_, UnbindPurchasedDeviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnbindPurchasedDeviceResponseBody> body_ {};
  };
