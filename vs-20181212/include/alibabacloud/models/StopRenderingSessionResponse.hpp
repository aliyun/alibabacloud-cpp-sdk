...
namespace Models
{
  ...
  public:
    ...
    inline const StopRenderingSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopRenderingSessionResponseBody) };
    inline StopRenderingSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, StopRenderingSessionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopRenderingSessionResponseBody> body_ {};
  };
