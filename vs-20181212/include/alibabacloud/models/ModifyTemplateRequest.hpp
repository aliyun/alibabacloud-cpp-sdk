...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callback_ == nullptr
        ...
        && return this->id_ == nullptr && return this->interval_ == nullptr && return this->jpgOnDemand_ == nullptr && return this->jpgOverwrite_ == nullptr && return this->jpgSequence_ == nullptr
        && return this->mp4_ == nullptr && return this->name_ == nullptr && return this->ossBucket_ == nullptr && return this->ossEndpoint_ == nullptr && return this->ossFilePrefix_ == nullptr
        && return this->ownerId_ == nullptr && return this->region_ == nullptr && return this->retention_ == nullptr && return this->transConfigsJSON_ == nullptr && return this->trigger_ == nullptr; };
