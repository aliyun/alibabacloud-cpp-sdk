...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVsCertificateDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVsCertificateDetailResponseBody) };
    inline DescribeVsCertificateDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVsCertificateDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVsCertificateDetailResponseBody> body_ {};
  };
