...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchUnbindParentPlatformDevicesResponseBodyResults> & results() const { DARABONBA_PTR_GET_CONST(results_, vector<BatchUnbindParentPlatformDevicesResponseBodyResults>) };
    inline vector<BatchUnbindParentPlatformDevicesResponseBodyResults> results() { DARABONBA_PTR_GET(results_, vector<BatchUnbindParentPlatformDevicesResponseBodyResults>) };
    inline BatchUnbindParentPlatformDevicesResponseBody& setResults(const vector<BatchUnbindParentPlatformDevicesResponseBodyResults> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline BatchUnbindParentPlatformDevicesResponseBody& setResults(vector<BatchUnbindParentPlatformDevicesResponseBodyResults> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<BatchUnbindParentPlatformDevicesResponseBodyResults>> results_ = nullptr;
  };
