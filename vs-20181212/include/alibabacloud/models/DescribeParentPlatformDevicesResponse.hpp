...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeParentPlatformDevicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeParentPlatformDevicesResponseBody) };
    inline DescribeParentPlatformDevicesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeParentPlatformDevicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeParentPlatformDevicesResponseBody> body_ {};
  };
