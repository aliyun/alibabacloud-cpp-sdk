...
namespace Models
{
  ...
  public:
    ...
    inline const BatchSetVsDomainConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchSetVsDomainConfigsResponseBody) };
    inline BatchSetVsDomainConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchSetVsDomainConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchSetVsDomainConfigsResponseBody> body_ {};
  };
