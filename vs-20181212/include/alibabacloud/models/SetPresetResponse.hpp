...
namespace Models
{
  ...
  public:
    ...
    inline const SetPresetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetPresetResponseBody) };
    inline SetPresetResponseBody getBody() { DARABONBA_PTR_GET(body_, SetPresetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetPresetResponseBody> body_ {};
  };
