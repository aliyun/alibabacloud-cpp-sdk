...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVsStreamsNotifyUrlConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteVsStreamsNotifyUrlConfigResponseBody) };
    inline DeleteVsStreamsNotifyUrlConfigResponseBody body() { DARABONBA_PTR_GET(body_, DeleteVsStreamsNotifyUrlConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteVsStreamsNotifyUrlConfigResponseBody> body_ = nullptr;
  };
