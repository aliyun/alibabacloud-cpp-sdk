...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRenderingInstanceSettingsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteRenderingInstanceSettingsResponseBody) };
    inline DeleteRenderingInstanceSettingsResponseBody body() { DARABONBA_PTR_GET(body_, DeleteRenderingInstanceSettingsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteRenderingInstanceSettingsResponseBody> body_ = nullptr;
  };
