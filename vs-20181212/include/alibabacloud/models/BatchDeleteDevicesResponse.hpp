...
namespace Models
{
  ...
  public:
    ...
    inline const BatchDeleteDevicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchDeleteDevicesResponseBody) };
    inline BatchDeleteDevicesResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchDeleteDevicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchDeleteDevicesResponseBody> body_ {};
  };
