...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRenderingInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRenderingInstanceResponseBody) };
    inline CreateRenderingInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRenderingInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRenderingInstanceResponseBody> body_ {};
  };
