...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->loginInfo_ != nullptr
    ...
    inline const ManageLoginResponseBodyLoginInfo & loginInfo() const { DARABONBA_PTR_GET_CONST(loginInfo_, ManageLoginResponseBodyLoginInfo) };
    inline ManageLoginResponseBodyLoginInfo loginInfo() { DARABONBA_PTR_GET(loginInfo_, ManageLoginResponseBodyLoginInfo) };
    inline ManageLoginResponseBody& setLoginInfo(const ManageLoginResponseBodyLoginInfo & loginInfo) { DARABONBA_PTR_SET_VALUE(loginInfo_, loginInfo) };
    inline ManageLoginResponseBody& setLoginInfo(ManageLoginResponseBodyLoginInfo && loginInfo) { DARABONBA_PTR_SET_RVALUE(loginInfo_, loginInfo) };
  ...
  protected:
    std::shared_ptr<ManageLoginResponseBodyLoginInfo> loginInfo_ = nullptr;
