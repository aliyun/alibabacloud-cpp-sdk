...
namespace Models
{
  ...
  public:
    ...
    inline const ContinuousAdjustResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ContinuousAdjustResponseBody) };
    inline ContinuousAdjustResponseBody getBody() { DARABONBA_PTR_GET(body_, ContinuousAdjustResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ContinuousAdjustResponseBody> body_ {};
  };
