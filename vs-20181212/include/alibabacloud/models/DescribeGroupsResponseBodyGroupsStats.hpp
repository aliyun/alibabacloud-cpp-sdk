...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEGROUPSRESPONSEBODYGROUPSSTATS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEGROUPSRESPONSEBODYGROUPSSTATS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeGroupsResponseBodyGroupsStats& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeGroupsResponseBodyGroupsStats& obj) { 
    ...
    DescribeGroupsResponseBodyGroupsStats() = default ;
    DescribeGroupsResponseBodyGroupsStats(const DescribeGroupsResponseBodyGroupsStats &) = default ;
    DescribeGroupsResponseBodyGroupsStats(DescribeGroupsResponseBodyGroupsStats &&) = default ;
    DescribeGroupsResponseBodyGroupsStats(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeGroupsResponseBodyGroupsStats() = default ;
    DescribeGroupsResponseBodyGroupsStats& operator=(const DescribeGroupsResponseBodyGroupsStats &) = default ;
    DescribeGroupsResponseBodyGroupsStats& operator=(DescribeGroupsResponseBodyGroupsStats &&) = default ;
    ...
    inline DescribeGroupsResponseBodyGroupsStats& setDeviceNum(int64_t deviceNum) { DARABONBA_PTR_SET_VALUE(deviceNum_, deviceNum) };
    ...
    inline DescribeGroupsResponseBodyGroupsStats& setIedNum(int64_t iedNum) { DARABONBA_PTR_SET_VALUE(iedNum_, iedNum) };
    ...
    inline DescribeGroupsResponseBodyGroupsStats& setIpcNum(int64_t ipcNum) { DARABONBA_PTR_SET_VALUE(ipcNum_, ipcNum) };
    ...
    inline DescribeGroupsResponseBodyGroupsStats& setPlatformNum(int64_t platformNum) { DARABONBA_PTR_SET_VALUE(platformNum_, platformNum) };
