...
namespace Models
{
  ...
  public:
    ...
    inline const GotoPresetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GotoPresetResponseBody) };
    inline GotoPresetResponseBody getBody() { DARABONBA_PTR_GET(body_, GotoPresetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GotoPresetResponseBody> body_ {};
  };
