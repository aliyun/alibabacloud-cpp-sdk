...
namespace Models
{
  ...
  public:
    ...
    inline const UnlockDeviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnlockDeviceResponseBody) };
    inline UnlockDeviceResponseBody getBody() { DARABONBA_PTR_GET(body_, UnlockDeviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnlockDeviceResponseBody> body_ {};
  };
