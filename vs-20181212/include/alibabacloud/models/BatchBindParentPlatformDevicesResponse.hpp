...
namespace Models
{
  ...
  public:
    ...
    inline const BatchBindParentPlatformDevicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchBindParentPlatformDevicesResponseBody) };
    inline BatchBindParentPlatformDevicesResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchBindParentPlatformDevicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchBindParentPlatformDevicesResponseBody> body_ {};
  };
