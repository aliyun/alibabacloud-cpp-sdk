...
namespace Models
{
  ...
  public:
    ...
    inline const BindPurchasedDeviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindPurchasedDeviceResponseBody) };
    inline BindPurchasedDeviceResponseBody getBody() { DARABONBA_PTR_GET(body_, BindPurchasedDeviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindPurchasedDeviceResponseBody> body_ {};
  };
