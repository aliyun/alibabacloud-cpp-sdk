...
namespace Models
{
  ...
  public:
    ...
    inline const ListRenderingInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRenderingInstancesResponseBody) };
    inline ListRenderingInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRenderingInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRenderingInstancesResponseBody> body_ {};
  };
