...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribePurchasedDevicesResponseBodyDevices> & devices() const { DARABONBA_PTR_GET_CONST(devices_, vector<DescribePurchasedDevicesResponseBodyDevices>) };
    inline vector<DescribePurchasedDevicesResponseBodyDevices> devices() { DARABONBA_PTR_GET(devices_, vector<DescribePurchasedDevicesResponseBodyDevices>) };
    inline DescribePurchasedDevicesResponseBody& setDevices(const vector<DescribePurchasedDevicesResponseBodyDevices> & devices) { DARABONBA_PTR_SET_VALUE(devices_, devices) };
    inline DescribePurchasedDevicesResponseBody& setDevices(vector<DescribePurchasedDevicesResponseBodyDevices> && devices) { DARABONBA_PTR_SET_RVALUE(devices_, devices) };
  ...
  protected:
    std::shared_ptr<vector<DescribePurchasedDevicesResponseBodyDevices>> devices_ = nullptr;
