...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getGroupLimit() const { DARABONBA_PTR_GET_DEFAULT(groupLimit_, 0L) };
    ...
    inline int64_t getGroupNum() const { DARABONBA_PTR_GET_DEFAULT(groupNum_, 0L) };
    ...
    inline int64_t getTemplateLimit() const { DARABONBA_PTR_GET_DEFAULT(templateLimit_, 0L) };
    ...
    inline int64_t getTemplateNum() const { DARABONBA_PTR_GET_DEFAULT(templateNum_, 0L) };
