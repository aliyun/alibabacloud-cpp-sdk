...
namespace Models
{
  ...
  public:
    ...
    inline const ListRenderingInstanceGatewayResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListRenderingInstanceGatewayResponseBody) };
    inline ListRenderingInstanceGatewayResponseBody body() { DARABONBA_PTR_GET(body_, ListRenderingInstanceGatewayResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListRenderingInstanceGatewayResponseBody> body_ = nullptr;
  };
