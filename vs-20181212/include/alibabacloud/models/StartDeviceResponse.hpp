...
namespace Models
{
  ...
  public:
    ...
    inline const StartDeviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartDeviceResponseBody) };
    inline StartDeviceResponseBody getBody() { DARABONBA_PTR_GET(body_, StartDeviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartDeviceResponseBody> body_ {};
  };
