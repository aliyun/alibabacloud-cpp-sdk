...
#ifndef ALIBABACLOUD_MODELS_UPDATEGATEWAYROUTEHEADEROPREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEGATEWAYROUTEHEADEROPREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateGatewayRouteHeaderOpRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AcceptLanguage, acceptLanguage_);
      DARABONBA_PTR_TO_JSON(GatewayId, gatewayId_);
      DARABONBA_PTR_TO_JSON(GatewayUniqueId, gatewayUniqueId_);
      DARABONBA_PTR_TO_JSON(HeaderOpJSON, headerOpJSON_);
      DARABONBA_PTR_TO_JSON(Id, id_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateGatewayRouteHeaderOpRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AcceptLanguage, acceptLanguage_);
      DARABONBA_PTR_FROM_JSON(GatewayId, gatewayId_);
      DARABONBA_PTR_FROM_JSON(GatewayUniqueId, gatewayUniqueId_);
      DARABONBA_PTR_FROM_JSON(HeaderOpJSON, headerOpJSON_);
      DARABONBA_PTR_FROM_JSON(Id, id_);
    };
    UpdateGatewayRouteHeaderOpRequest() = default ;
    UpdateGatewayRouteHeaderOpRequest(const UpdateGatewayRouteHeaderOpRequest &) = default ;
    UpdateGatewayRouteHeaderOpRequest(UpdateGatewayRouteHeaderOpRequest &&) = default ;
    UpdateGatewayRouteHeaderOpRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateGatewayRouteHeaderOpRequest() = default ;
    UpdateGatewayRouteHeaderOpRequest& operator=(const UpdateGatewayRouteHeaderOpRequest &) = default ;
    UpdateGatewayRouteHeaderOpRequest& operator=(UpdateGatewayRouteHeaderOpRequest &&) = default ;
