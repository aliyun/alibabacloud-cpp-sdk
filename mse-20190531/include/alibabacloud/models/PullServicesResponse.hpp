...
namespace Models
{
  ...
  public:
    ...
    inline const PullServicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PullServicesResponseBody) };
    inline PullServicesResponseBody getBody() { DARABONBA_PTR_GET(body_, PullServicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PullServicesResponseBody> body_ {};
  };
