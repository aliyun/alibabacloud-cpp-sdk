...
namespace Models
{
  ...
  public:
    ...
    inline const QueryClusterDiskSpecificationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryClusterDiskSpecificationResponseBodyData) };
    inline QueryClusterDiskSpecificationResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryClusterDiskSpecificationResponseBodyData) };
    inline QueryClusterDiskSpecificationResponseBody& setData(const QueryClusterDiskSpecificationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryClusterDiskSpecificationResponseBody& setData(QueryClusterDiskSpecificationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryClusterDiskSpecificationResponseBodyData> data_ = nullptr;
