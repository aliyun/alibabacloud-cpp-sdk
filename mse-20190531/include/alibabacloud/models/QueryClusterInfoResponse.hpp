...
namespace Models
{
  ...
  public:
    ...
    inline const QueryClusterInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryClusterInfoResponseBody) };
    inline QueryClusterInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryClusterInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryClusterInfoResponseBody> body_ {};
  };
