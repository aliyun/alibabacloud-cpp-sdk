...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetServiceListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetServiceListResponseBodyData>) };
    inline vector<GetServiceListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetServiceListResponseBodyData>) };
    inline GetServiceListResponseBody& setData(const vector<GetServiceListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetServiceListResponseBody& setData(vector<GetServiceListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetServiceListResponseBodyData>> data_ = nullptr;
