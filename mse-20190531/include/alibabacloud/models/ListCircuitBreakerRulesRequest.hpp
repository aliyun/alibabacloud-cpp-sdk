...
#ifndef ALIBABACLOUD_MODELS_LISTCIRCUITBREAKERRULESREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTCIRCUITBREAKERRULESREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListCircuitBreakerRulesRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListCircuitBreakerRulesRequest& obj) { 
    ...
    ListCircuitBreakerRulesRequest() = default ;
    ListCircuitBreakerRulesRequest(const ListCircuitBreakerRulesRequest &) = default ;
    ListCircuitBreakerRulesRequest(ListCircuitBreakerRulesRequest &&) = default ;
    ListCircuitBreakerRulesRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListCircuitBreakerRulesRequest() = default ;
    ListCircuitBreakerRulesRequest& operator=(const ListCircuitBreakerRulesRequest &) = default ;
    ListCircuitBreakerRulesRequest& operator=(ListCircuitBreakerRulesRequest &&) = default ;
