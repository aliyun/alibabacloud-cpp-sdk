...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateClusterSpecResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateClusterSpecResponseBody) };
    inline UpdateClusterSpecResponseBody body() { DARABONBA_PTR_GET(body_, UpdateClusterSpecResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateClusterSpecResponseBody> body_ = nullptr;
  };
