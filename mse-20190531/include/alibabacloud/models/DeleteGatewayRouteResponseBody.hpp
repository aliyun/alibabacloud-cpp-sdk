...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGatewayRouteResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeleteGatewayRouteResponseBodyData) };
    inline DeleteGatewayRouteResponseBodyData data() { DARABONBA_PTR_GET(data_, DeleteGatewayRouteResponseBodyData) };
    inline DeleteGatewayRouteResponseBody& setData(const DeleteGatewayRouteResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteGatewayRouteResponseBody& setData(DeleteGatewayRouteResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DeleteGatewayRouteResponseBodyData> data_ = nullptr;
    // The HTTP status code returned.
