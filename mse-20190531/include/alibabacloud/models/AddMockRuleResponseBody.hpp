...
namespace Models
{
  ...
  public:
    ...
    inline const AddMockRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddMockRuleResponseBodyData) };
    inline AddMockRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, AddMockRuleResponseBodyData) };
    inline AddMockRuleResponseBody& setData(const AddMockRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddMockRuleResponseBody& setData(AddMockRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<AddMockRuleResponseBodyData> data_ = nullptr;
