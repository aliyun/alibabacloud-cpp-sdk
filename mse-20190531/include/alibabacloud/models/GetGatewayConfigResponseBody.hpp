...
namespace Models
{
  ...
  public:
    ...
    inline const GetGatewayConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetGatewayConfigResponseBodyData) };
    inline GetGatewayConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetGatewayConfigResponseBodyData) };
    inline GetGatewayConfigResponseBody& setData(const GetGatewayConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetGatewayConfigResponseBody& setData(GetGatewayConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetGatewayConfigResponseBodyData> data_ = nullptr;
