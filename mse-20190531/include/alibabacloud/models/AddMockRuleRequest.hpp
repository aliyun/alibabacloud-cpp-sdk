...
namespace Models
{
  ...
  public:
    ...
    inline string getConsumerAppIds() const { DARABONBA_PTR_GET_DEFAULT(consumerAppIds_, "") };
    ...
    inline string getDubboMockItems() const { DARABONBA_PTR_GET_DEFAULT(dubboMockItems_, "") };
    ...
    inline string getScMockItems() const { DARABONBA_PTR_GET_DEFAULT(scMockItems_, "") };
  ...
  protected:
    ...
    shared_ptr<string> consumerAppIds_ {};
    // The items in the recycle bin.
    // 
    // This parameter is required.
    shared_ptr<string> dubboMockItems_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<string> scMockItems_ {};
    // The rule source.
    // 
    // This parameter is required.
