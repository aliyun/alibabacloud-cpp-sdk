...
#ifndef ALIBABACLOUD_MODELS_DELETESECURITYGROUPRULEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETESECURITYGROUPRULEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteSecurityGroupRuleRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AcceptLanguage, acceptLanguage_);
      DARABONBA_PTR_TO_JSON(CascadingDelete, cascadingDelete_);
      DARABONBA_PTR_TO_JSON(GatewayUniqueId, gatewayUniqueId_);
      DARABONBA_PTR_TO_JSON(Id, id_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteSecurityGroupRuleRequest& obj) { 
    ...
    DeleteSecurityGroupRuleRequest(const DeleteSecurityGroupRuleRequest &) = default ;
    DeleteSecurityGroupRuleRequest(DeleteSecurityGroupRuleRequest &&) = default ;
    DeleteSecurityGroupRuleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteSecurityGroupRuleRequest() = default ;
    DeleteSecurityGroupRuleRequest& operator=(const DeleteSecurityGroupRuleRequest &) = default ;
    DeleteSecurityGroupRuleRequest& operator=(DeleteSecurityGroupRuleRequest &&) = default ;
