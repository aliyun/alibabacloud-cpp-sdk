...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEngineNamespaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEngineNamespaceResponseBody) };
    inline UpdateEngineNamespaceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEngineNamespaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEngineNamespaceResponseBody> body_ {};
  };
