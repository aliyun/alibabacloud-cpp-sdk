...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryAllSwimmingLaneGroupResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryAllSwimmingLaneGroupResponseBodyData>) };
    inline vector<QueryAllSwimmingLaneGroupResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryAllSwimmingLaneGroupResponseBodyData>) };
    inline QueryAllSwimmingLaneGroupResponseBody& setData(const vector<QueryAllSwimmingLaneGroupResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAllSwimmingLaneGroupResponseBody& setData(vector<QueryAllSwimmingLaneGroupResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryAllSwimmingLaneGroupResponseBodyData>> data_ = nullptr;
