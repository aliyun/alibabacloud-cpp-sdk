...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryMonitorResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryMonitorResponseBodyData>) };
    inline vector<QueryMonitorResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryMonitorResponseBodyData>) };
    inline QueryMonitorResponseBody& setData(const vector<QueryMonitorResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryMonitorResponseBody& setData(vector<QueryMonitorResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryMonitorResponseBodyData>> data_ = nullptr;
