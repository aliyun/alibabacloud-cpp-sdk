...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowRequestHeaders_ == nullptr
        && return this->allowUpstreamHeaders_ == nullptr && return this->bodyMaxBytes_ == nullptr && return this->isRestrict_ == nullptr && return this->prefixPath_ == nullptr && return this->service_ == nullptr
        && return this->serviceId_ == nullptr && return this->timeout_ == nullptr && return this->tokenKey_ == nullptr && return this->withRematchRoute_ == nullptr && return this->withRequestBody_ == nullptr; };
