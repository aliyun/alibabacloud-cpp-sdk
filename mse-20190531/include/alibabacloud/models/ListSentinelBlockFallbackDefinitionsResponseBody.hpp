...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSentinelBlockFallbackDefinitionsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListSentinelBlockFallbackDefinitionsResponseBodyData>) };
    inline vector<ListSentinelBlockFallbackDefinitionsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListSentinelBlockFallbackDefinitionsResponseBodyData>) };
    inline ListSentinelBlockFallbackDefinitionsResponseBody& setData(const vector<ListSentinelBlockFallbackDefinitionsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSentinelBlockFallbackDefinitionsResponseBody& setData(vector<ListSentinelBlockFallbackDefinitionsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListSentinelBlockFallbackDefinitionsResponseBodyData>> data_ = nullptr;
