...
#ifndef ALIBABACLOUD_MODELS_LISTGATEWAYISOLATIONRULERESPONSEBODYDATARESULTS_HPP_
#define ALIBABACLOUD_MODELS_LISTGATEWAYISOLATIONRULERESPONSEBODYDATARESULTS_HPP_
...
namespace Models
{
  class ListGatewayIsolationRuleResponseBodyDataResults : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListGatewayIsolationRuleResponseBodyDataResults& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListGatewayIsolationRuleResponseBodyDataResults& obj) { 
    ...
    ListGatewayIsolationRuleResponseBodyDataResults() = default ;
    ListGatewayIsolationRuleResponseBodyDataResults(const ListGatewayIsolationRuleResponseBodyDataResults &) = default ;
    ListGatewayIsolationRuleResponseBodyDataResults(ListGatewayIsolationRuleResponseBodyDataResults &&) = default ;
    ListGatewayIsolationRuleResponseBodyDataResults(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListGatewayIsolationRuleResponseBodyDataResults() = default ;
    ListGatewayIsolationRuleResponseBodyDataResults& operator=(const ListGatewayIsolationRuleResponseBodyDataResults &) = default ;
    ListGatewayIsolationRuleResponseBodyDataResults& operator=(ListGatewayIsolationRuleResponseBodyDataResults &&) = default ;
    ...
    virtual bool empty() const override { return this->behaviorType_ == nullptr
        ...
        && return this->idList_ == nullptr && return this->limitMode_ == nullptr && return this->maxConcurrency_ == nullptr && return this->responseAdditionalHeaders_ == nullptr && return this->responseContentBody_ == nullptr
        && return this->responseRedirectUrl_ == nullptr && return this->responseStatusCode_ == nullptr && return this->routeId_ == nullptr && return this->routeName_ == nullptr; };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setBehaviorType(int32_t behaviorType) { DARABONBA_PTR_SET_VALUE(behaviorType_, behaviorType) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setBodyEncoding(int32_t bodyEncoding) { DARABONBA_PTR_SET_VALUE(bodyEncoding_, bodyEncoding) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setEnable(int32_t enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setGatewayId(int64_t gatewayId) { DARABONBA_PTR_SET_VALUE(gatewayId_, gatewayId) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setGatewayUniqueId(string gatewayUniqueId) { DARABONBA_PTR_SET_VALUE(gatewayUniqueId_, gatewayUniqueId) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setIdList(const vector<int64_t> & idList) { DARABONBA_PTR_SET_VALUE(idList_, idList) };
    inline ListGatewayIsolationRuleResponseBodyDataResults& setIdList(vector<int64_t> && idList) { DARABONBA_PTR_SET_RVALUE(idList_, idList) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setLimitMode(int32_t limitMode) { DARABONBA_PTR_SET_VALUE(limitMode_, limitMode) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setMaxConcurrency(int32_t maxConcurrency) { DARABONBA_PTR_SET_VALUE(maxConcurrency_, maxConcurrency) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setResponseAdditionalHeaders(string responseAdditionalHeaders) { DARABONBA_PTR_SET_VALUE(responseAdditionalHeaders_, responseAdditionalHeaders) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setResponseContentBody(string responseContentBody) { DARABONBA_PTR_SET_VALUE(responseContentBody_, responseContentBody) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setResponseRedirectUrl(string responseRedirectUrl) { DARABONBA_PTR_SET_VALUE(responseRedirectUrl_, responseRedirectUrl) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setResponseStatusCode(int32_t responseStatusCode) { DARABONBA_PTR_SET_VALUE(responseStatusCode_, responseStatusCode) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setRouteId(int64_t routeId) { DARABONBA_PTR_SET_VALUE(routeId_, routeId) };
    ...
    inline ListGatewayIsolationRuleResponseBodyDataResults& setRouteName(string routeName) { DARABONBA_PTR_SET_VALUE(routeName_, routeName) };
