...
#ifndef ALIBABACLOUD_MODELS_UPDATEGATEWAYAUTHCONSUMERSTATUSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEGATEWAYAUTHCONSUMERSTATUSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateGatewayAuthConsumerStatusRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AcceptLanguage, acceptLanguage_);
      DARABONBA_PTR_TO_JSON(ConsumerStatus, consumerStatus_);
      DARABONBA_PTR_TO_JSON(GatewayUniqueId, gatewayUniqueId_);
      DARABONBA_PTR_TO_JSON(Id, id_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateGatewayAuthConsumerStatusRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AcceptLanguage, acceptLanguage_);
      DARABONBA_PTR_FROM_JSON(ConsumerStatus, consumerStatus_);
      DARABONBA_PTR_FROM_JSON(GatewayUniqueId, gatewayUniqueId_);
      DARABONBA_PTR_FROM_JSON(Id, id_);
    };
    UpdateGatewayAuthConsumerStatusRequest() = default ;
    UpdateGatewayAuthConsumerStatusRequest(const UpdateGatewayAuthConsumerStatusRequest &) = default ;
    UpdateGatewayAuthConsumerStatusRequest(UpdateGatewayAuthConsumerStatusRequest &&) = default ;
    UpdateGatewayAuthConsumerStatusRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateGatewayAuthConsumerStatusRequest() = default ;
    UpdateGatewayAuthConsumerStatusRequest& operator=(const UpdateGatewayAuthConsumerStatusRequest &) = default ;
    UpdateGatewayAuthConsumerStatusRequest& operator=(UpdateGatewayAuthConsumerStatusRequest &&) = default ;
