...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListServiceSourceResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListServiceSourceResponseBodyData>) };
    inline vector<ListServiceSourceResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListServiceSourceResponseBodyData>) };
    inline ListServiceSourceResponseBody& setData(const vector<ListServiceSourceResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListServiceSourceResponseBody& setData(vector<ListServiceSourceResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<vector<ListServiceSourceResponseBodyData>> data_ = nullptr;
