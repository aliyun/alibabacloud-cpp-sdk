...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayRouteRequestFilterParams & filterParams() const { DARABONBA_PTR_GET_CONST(filterParams_, ListGatewayRouteRequestFilterParams) };
    inline ListGatewayRouteRequestFilterParams filterParams() { DARABONBA_PTR_GET(filterParams_, ListGatewayRouteRequestFilterParams) };
    inline ListGatewayRouteRequest& setFilterParams(const ListGatewayRouteRequestFilterParams & filterParams) { DARABONBA_PTR_SET_VALUE(filterParams_, filterParams) };
    inline ListGatewayRouteRequest& setFilterParams(ListGatewayRouteRequestFilterParams && filterParams) { DARABONBA_PTR_SET_RVALUE(filterParams_, filterParams) };
  ...
  protected:
    ...
    std::shared_ptr<ListGatewayRouteRequestFilterParams> filterParams_ = nullptr;
