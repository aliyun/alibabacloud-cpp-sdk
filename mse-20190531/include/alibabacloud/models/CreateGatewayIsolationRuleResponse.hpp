...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGatewayIsolationRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateGatewayIsolationRuleResponseBody) };
    inline CreateGatewayIsolationRuleResponseBody body() { DARABONBA_PTR_GET(body_, CreateGatewayIsolationRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateGatewayIsolationRuleResponseBody> body_ = nullptr;
  };
