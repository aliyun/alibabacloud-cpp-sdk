...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOrUpdateSwimmingLaneResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateOrUpdateSwimmingLaneResponseBodyData) };
    inline CreateOrUpdateSwimmingLaneResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateOrUpdateSwimmingLaneResponseBodyData) };
    inline CreateOrUpdateSwimmingLaneResponseBody& setData(const CreateOrUpdateSwimmingLaneResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateOrUpdateSwimmingLaneResponseBody& setData(CreateOrUpdateSwimmingLaneResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
