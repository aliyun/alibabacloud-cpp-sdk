...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && this->gatewayUniqueId_ == nullptr && this->isAll_ == nullptr && this->vpcId_ == nullptr; };
    ...
    inline bool getIsAll() const { DARABONBA_PTR_GET_DEFAULT(isAll_, false) };
