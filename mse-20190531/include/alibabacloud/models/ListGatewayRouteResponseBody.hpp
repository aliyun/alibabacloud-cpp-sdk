...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayRouteResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListGatewayRouteResponseBodyData) };
    inline ListGatewayRouteResponseBodyData data() { DARABONBA_PTR_GET(data_, ListGatewayRouteResponseBodyData) };
    inline ListGatewayRouteResponseBody& setData(const ListGatewayRouteResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGatewayRouteResponseBody& setData(ListGatewayRouteResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListGatewayRouteResponseBodyData> data_ = nullptr;
