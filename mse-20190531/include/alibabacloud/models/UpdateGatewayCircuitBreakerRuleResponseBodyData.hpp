...
#ifndef ALIBABACLOUD_MODELS_UPDATEGATEWAYCIRCUITBREAKERRULERESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_UPDATEGATEWAYCIRCUITBREAKERRULERESPONSEBODYDATA_HPP_
...
namespace Models
{
  class UpdateGatewayCircuitBreakerRuleResponseBodyData : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateGatewayCircuitBreakerRuleResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateGatewayCircuitBreakerRuleResponseBodyData& obj) { 
    ...
    UpdateGatewayCircuitBreakerRuleResponseBodyData() = default ;
    UpdateGatewayCircuitBreakerRuleResponseBodyData(const UpdateGatewayCircuitBreakerRuleResponseBodyData &) = default ;
    UpdateGatewayCircuitBreakerRuleResponseBodyData(UpdateGatewayCircuitBreakerRuleResponseBodyData &&) = default ;
    UpdateGatewayCircuitBreakerRuleResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateGatewayCircuitBreakerRuleResponseBodyData() = default ;
    UpdateGatewayCircuitBreakerRuleResponseBodyData& operator=(const UpdateGatewayCircuitBreakerRuleResponseBodyData &) = default ;
    UpdateGatewayCircuitBreakerRuleResponseBodyData& operator=(UpdateGatewayCircuitBreakerRuleResponseBodyData &&) = default ;
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setBehaviorType(int32_t behaviorType) { DARABONBA_PTR_SET_VALUE(behaviorType_, behaviorType) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setBodyEncoding(int32_t bodyEncoding) { DARABONBA_PTR_SET_VALUE(bodyEncoding_, bodyEncoding) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setEnable(int32_t enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setGatewayId(int64_t gatewayId) { DARABONBA_PTR_SET_VALUE(gatewayId_, gatewayId) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setGatewayUniqueId(string gatewayUniqueId) { DARABONBA_PTR_SET_VALUE(gatewayUniqueId_, gatewayUniqueId) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setIdList(const vector<int64_t> & idList) { DARABONBA_PTR_SET_VALUE(idList_, idList) };
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setIdList(vector<int64_t> && idList) { DARABONBA_PTR_SET_RVALUE(idList_, idList) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setLimitMode(int32_t limitMode) { DARABONBA_PTR_SET_VALUE(limitMode_, limitMode) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setMaxAllowedMs(int32_t maxAllowedMs) { DARABONBA_PTR_SET_VALUE(maxAllowedMs_, maxAllowedMs) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setMinRequestAmount(int32_t minRequestAmount) { DARABONBA_PTR_SET_VALUE(minRequestAmount_, minRequestAmount) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setRecoveryTimeoutSec(int32_t recoveryTimeoutSec) { DARABONBA_PTR_SET_VALUE(recoveryTimeoutSec_, recoveryTimeoutSec) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setResponseAdditionalHeaders(string responseAdditionalHeaders) { DARABONBA_PTR_SET_VALUE(responseAdditionalHeaders_, responseAdditionalHeaders) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setResponseContentBody(string responseContentBody) { DARABONBA_PTR_SET_VALUE(responseContentBody_, responseContentBody) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setResponseRedirectUrl(string responseRedirectUrl) { DARABONBA_PTR_SET_VALUE(responseRedirectUrl_, responseRedirectUrl) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setResponseStatusCode(int32_t responseStatusCode) { DARABONBA_PTR_SET_VALUE(responseStatusCode_, responseStatusCode) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setRouteId(int64_t routeId) { DARABONBA_PTR_SET_VALUE(routeId_, routeId) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setRouteName(string routeName) { DARABONBA_PTR_SET_VALUE(routeName_, routeName) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setStatDurationSec(int32_t statDurationSec) { DARABONBA_PTR_SET_VALUE(statDurationSec_, statDurationSec) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setStrategy(int32_t strategy) { DARABONBA_PTR_SET_VALUE(strategy_, strategy) };
    ...
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData& setTriggerRatio(int32_t triggerRatio) { DARABONBA_PTR_SET_VALUE(triggerRatio_, triggerRatio) };
