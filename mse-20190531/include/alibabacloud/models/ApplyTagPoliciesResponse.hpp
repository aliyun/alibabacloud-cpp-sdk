...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyTagPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApplyTagPoliciesResponseBody) };
    inline ApplyTagPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, ApplyTagPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApplyTagPoliciesResponseBody> body_ {};
  };
