...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGatewaySlbResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteGatewaySlbResponseBody) };
    inline DeleteGatewaySlbResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteGatewaySlbResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteGatewaySlbResponseBody> body_ {};
  };
