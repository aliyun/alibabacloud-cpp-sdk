...
namespace Models
{
  ...
  public:
    ...
    inline const QueryInstancesInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryInstancesInfoResponseBody) };
    inline QueryInstancesInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryInstancesInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryInstancesInfoResponseBody> body_ {};
  };
