...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterType_ == nullptr
        && return this->id_ == nullptr && return this->originInstanceAddress_ == nullptr && return this->originInstanceName_ == nullptr && return this->originInstanceNamespace_ == nullptr && return this->projectDesc_ == nullptr
        && return this->syncType_ == nullptr && return this->targetClusterName_ == nullptr && return this->targetClusterUrl_ == nullptr && return this->targetInstanceId_ == nullptr && return this->userId_ == nullptr; };
