...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListGatewayResponseBodyData) };
    inline ListGatewayResponseBodyData data() { DARABONBA_PTR_GET(data_, ListGatewayResponseBodyData) };
    inline ListGatewayResponseBody& setData(const ListGatewayResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGatewayResponseBody& setData(ListGatewayResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListGatewayResponseBodyData> data_ = nullptr;
