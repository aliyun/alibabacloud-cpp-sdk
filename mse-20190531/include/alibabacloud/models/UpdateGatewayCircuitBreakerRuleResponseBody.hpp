...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGatewayCircuitBreakerRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateGatewayCircuitBreakerRuleResponseBodyData) };
    inline UpdateGatewayCircuitBreakerRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateGatewayCircuitBreakerRuleResponseBodyData) };
    inline UpdateGatewayCircuitBreakerRuleResponseBody& setData(const UpdateGatewayCircuitBreakerRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateGatewayCircuitBreakerRuleResponseBody& setData(UpdateGatewayCircuitBreakerRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<UpdateGatewayCircuitBreakerRuleResponseBodyData> data_ = nullptr;
