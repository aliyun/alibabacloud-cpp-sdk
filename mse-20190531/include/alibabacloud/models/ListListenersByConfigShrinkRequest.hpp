...
#ifndef ALIBABACLOUD_MODELS_LISTLISTENERSBYCONFIGSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTLISTENERSBYCONFIGSHRINKREQUEST_HPP_
...
namespace Models
{
  class ListListenersByConfigShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListListenersByConfigShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AcceptLanguage, acceptLanguage_);
      DARABONBA_PTR_TO_JSON(DataId, dataId_);
      DARABONBA_PTR_TO_JSON(ExtGrayRules, extGrayRulesShrink_);
      DARABONBA_PTR_TO_JSON(Group, group_);
      DARABONBA_PTR_TO_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_TO_JSON(NamespaceId, namespaceId_);
      DARABONBA_PTR_TO_JSON(RequestPars, requestPars_);
    };
    friend void from_json(const Darabonba::Json& j, ListListenersByConfigShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AcceptLanguage, acceptLanguage_);
      DARABONBA_PTR_FROM_JSON(DataId, dataId_);
      DARABONBA_PTR_FROM_JSON(ExtGrayRules, extGrayRulesShrink_);
      DARABONBA_PTR_FROM_JSON(Group, group_);
      DARABONBA_PTR_FROM_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_FROM_JSON(NamespaceId, namespaceId_);
      DARABONBA_PTR_FROM_JSON(RequestPars, requestPars_);
    };
    ListListenersByConfigShrinkRequest() = default ;
    ListListenersByConfigShrinkRequest(const ListListenersByConfigShrinkRequest &) = default ;
    ListListenersByConfigShrinkRequest(ListListenersByConfigShrinkRequest &&) = default ;
    ListListenersByConfigShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListListenersByConfigShrinkRequest() = default ;
    ListListenersByConfigShrinkRequest& operator=(const ListListenersByConfigShrinkRequest &) = default ;
    ListListenersByConfigShrinkRequest& operator=(ListListenersByConfigShrinkRequest &&) = default ;
