...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSecurityGroupRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSecurityGroupRuleResponseBody) };
    inline DeleteSecurityGroupRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSecurityGroupRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSecurityGroupRuleResponseBody> body_ {};
  };
