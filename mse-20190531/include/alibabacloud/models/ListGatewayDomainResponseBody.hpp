...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListGatewayDomainResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListGatewayDomainResponseBodyData>) };
    inline vector<ListGatewayDomainResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListGatewayDomainResponseBodyData>) };
    inline ListGatewayDomainResponseBody& setData(const vector<ListGatewayDomainResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGatewayDomainResponseBody& setData(vector<ListGatewayDomainResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListGatewayDomainResponseBodyData>> data_ = nullptr;
