...
namespace Models
{
  ...
  public:
    ...
    inline const ListNacosMcpServersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListNacosMcpServersResponseBodyData) };
    inline ListNacosMcpServersResponseBodyData data() { DARABONBA_PTR_GET(data_, ListNacosMcpServersResponseBodyData) };
    inline ListNacosMcpServersResponseBody& setData(const ListNacosMcpServersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListNacosMcpServersResponseBody& setData(ListNacosMcpServersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<ListNacosMcpServersResponseBodyData> data_ = nullptr;
