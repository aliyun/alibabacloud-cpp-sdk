...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayServiceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListGatewayServiceResponseBodyData) };
    inline ListGatewayServiceResponseBodyData data() { DARABONBA_PTR_GET(data_, ListGatewayServiceResponseBodyData) };
    inline ListGatewayServiceResponseBody& setData(const ListGatewayServiceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGatewayServiceResponseBody& setData(ListGatewayServiceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListGatewayServiceResponseBodyData> data_ = nullptr;
