...
namespace Models
{
  ...
  public:
    ...
    inline const GetServiceListPageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetServiceListPageResponseBody) };
    inline GetServiceListPageResponseBody getBody() { DARABONBA_PTR_GET(body_, GetServiceListPageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetServiceListPageResponseBody> body_ {};
  };
