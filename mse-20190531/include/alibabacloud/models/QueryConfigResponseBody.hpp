...
namespace Models
{
  ...
  public:
    ...
    inline const QueryConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryConfigResponseBodyData) };
    inline QueryConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryConfigResponseBodyData) };
    inline QueryConfigResponseBody& setData(const QueryConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryConfigResponseBody& setData(QueryConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryConfigResponseBodyData> data_ = nullptr;
