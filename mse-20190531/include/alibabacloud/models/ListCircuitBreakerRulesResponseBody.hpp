...
namespace Models
{
  ...
  public:
    ...
    inline const ListCircuitBreakerRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCircuitBreakerRulesResponseBodyData) };
    inline ListCircuitBreakerRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCircuitBreakerRulesResponseBodyData) };
    inline ListCircuitBreakerRulesResponseBody& setData(const ListCircuitBreakerRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCircuitBreakerRulesResponseBody& setData(ListCircuitBreakerRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListCircuitBreakerRulesResponseBodyData> data_ = nullptr;
