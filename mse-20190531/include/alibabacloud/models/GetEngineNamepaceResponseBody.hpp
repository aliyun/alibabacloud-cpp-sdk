...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->configCount_ == nullptr
        && return this->errorCode_ == nullptr && return this->httpCode_ == nullptr && return this->message_ == nullptr && return this->namespace_ == nullptr && return this->namespaceDesc_ == nullptr
        && return this->namespaceShowName_ == nullptr && return this->quota_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->type_ == nullptr; };
