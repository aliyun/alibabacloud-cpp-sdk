...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePluginConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePluginConfigResponseBody) };
    inline DeletePluginConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePluginConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePluginConfigResponseBody> body_ {};
  };
