...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && this->name_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->region_ == nullptr && this->tag_ == nullptr; };
    ...
    inline const vector<ListNamespacesRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<ListNamespacesRequest::Tag>) };
    inline vector<ListNamespacesRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<ListNamespacesRequest::Tag>) };
    inline ListNamespacesRequest& setTag(const vector<ListNamespacesRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline ListNamespacesRequest& setTag(vector<ListNamespacesRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<ListNamespacesRequest::Tag>> tag_ {};
  };
