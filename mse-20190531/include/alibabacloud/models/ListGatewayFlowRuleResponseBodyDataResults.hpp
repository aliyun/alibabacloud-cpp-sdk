...
#ifndef ALIBABACLOUD_MODELS_LISTGATEWAYFLOWRULERESPONSEBODYDATARESULTS_HPP_
#define ALIBABACLOUD_MODELS_LISTGATEWAYFLOWRULERESPONSEBODYDATARESULTS_HPP_
...
namespace Models
{
  class ListGatewayFlowRuleResponseBodyDataResults : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListGatewayFlowRuleResponseBodyDataResults& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListGatewayFlowRuleResponseBodyDataResults& obj) { 
    ...
    ListGatewayFlowRuleResponseBodyDataResults() = default ;
    ListGatewayFlowRuleResponseBodyDataResults(const ListGatewayFlowRuleResponseBodyDataResults &) = default ;
    ListGatewayFlowRuleResponseBodyDataResults(ListGatewayFlowRuleResponseBodyDataResults &&) = default ;
    ListGatewayFlowRuleResponseBodyDataResults(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListGatewayFlowRuleResponseBodyDataResults() = default ;
    ListGatewayFlowRuleResponseBodyDataResults& operator=(const ListGatewayFlowRuleResponseBodyDataResults &) = default ;
    ListGatewayFlowRuleResponseBodyDataResults& operator=(ListGatewayFlowRuleResponseBodyDataResults &&) = default ;
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setBehaviorType(int32_t behaviorType) { DARABONBA_PTR_SET_VALUE(behaviorType_, behaviorType) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setBodyEncoding(int32_t bodyEncoding) { DARABONBA_PTR_SET_VALUE(bodyEncoding_, bodyEncoding) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setEnable(int32_t enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setGatewayId(int64_t gatewayId) { DARABONBA_PTR_SET_VALUE(gatewayId_, gatewayId) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setGatewayUniqueId(string gatewayUniqueId) { DARABONBA_PTR_SET_VALUE(gatewayUniqueId_, gatewayUniqueId) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setIdList(const vector<int64_t> & idList) { DARABONBA_PTR_SET_VALUE(idList_, idList) };
    inline ListGatewayFlowRuleResponseBodyDataResults& setIdList(vector<int64_t> && idList) { DARABONBA_PTR_SET_RVALUE(idList_, idList) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setLimitMode(int32_t limitMode) { DARABONBA_PTR_SET_VALUE(limitMode_, limitMode) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setResponseAdditionalHeaders(string responseAdditionalHeaders) { DARABONBA_PTR_SET_VALUE(responseAdditionalHeaders_, responseAdditionalHeaders) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setResponseContentBody(string responseContentBody) { DARABONBA_PTR_SET_VALUE(responseContentBody_, responseContentBody) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setResponseRedirectUrl(string responseRedirectUrl) { DARABONBA_PTR_SET_VALUE(responseRedirectUrl_, responseRedirectUrl) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setResponseStatusCode(int32_t responseStatusCode) { DARABONBA_PTR_SET_VALUE(responseStatusCode_, responseStatusCode) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setRouteId(int64_t routeId) { DARABONBA_PTR_SET_VALUE(routeId_, routeId) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setRouteName(string routeName) { DARABONBA_PTR_SET_VALUE(routeName_, routeName) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setStatDurationMs(int32_t statDurationMs) { DARABONBA_PTR_SET_VALUE(statDurationMs_, statDurationMs) };
    ...
    inline ListGatewayFlowRuleResponseBodyDataResults& setThreshold(int32_t threshold) { DARABONBA_PTR_SET_VALUE(threshold_, threshold) };
