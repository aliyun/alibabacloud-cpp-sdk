...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && return this->checkPort_ == nullptr && return this->clusterName_ == nullptr && return this->groupName_ == nullptr && return this->healthChecker_ == nullptr && return this->instanceId_ == nullptr
        && return this->namespaceId_ == nullptr && return this->serviceName_ == nullptr && return this->useInstancePortForCheck_ == nullptr; };
    ...
    inline int32_t checkPort() const { DARABONBA_PTR_GET_DEFAULT(checkPort_, 0) };
    ...
    inline string healthChecker() const { DARABONBA_PTR_GET_DEFAULT(healthChecker_, "") };
    ...
    inline bool useInstancePortForCheck() const { DARABONBA_PTR_GET_DEFAULT(useInstancePortForCheck_, false) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> checkPort_ = nullptr;
    ...
    std::shared_ptr<string> healthChecker_ = nullptr;
    ...
    std::shared_ptr<bool> useInstancePortForCheck_ = nullptr;
  };
