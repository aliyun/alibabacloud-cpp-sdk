...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGatewayConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateGatewayConfigResponseBody) };
    inline UpdateGatewayConfigResponseBody body() { DARABONBA_PTR_GET(body_, UpdateGatewayConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateGatewayConfigResponseBody> body_ = nullptr;
  };
