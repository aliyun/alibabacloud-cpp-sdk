...
namespace Models
{
  ...
  public:
    ...
    inline const GetGatewayServiceDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetGatewayServiceDetailResponseBodyData) };
    inline GetGatewayServiceDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetGatewayServiceDetailResponseBodyData) };
    inline GetGatewayServiceDetailResponseBody& setData(const GetGatewayServiceDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetGatewayServiceDetailResponseBody& setData(GetGatewayServiceDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetGatewayServiceDetailResponseBodyData> data_ = nullptr;
