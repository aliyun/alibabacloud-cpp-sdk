...
namespace Models
{
  ...
  public:
    ...
    inline const ListFlowRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFlowRulesResponseBody) };
    inline ListFlowRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFlowRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFlowRulesResponseBody> body_ {};
  };
