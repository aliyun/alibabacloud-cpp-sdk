...
namespace Models
{
  ...
  public:
    ...
    inline const QueryBusinessLocationsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryBusinessLocationsResponseBody) };
    inline QueryBusinessLocationsResponseBody body() { DARABONBA_PTR_GET(body_, QueryBusinessLocationsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryBusinessLocationsResponseBody> body_ = nullptr;
  };
