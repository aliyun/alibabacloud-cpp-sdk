...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && this->authId_ == nullptr && this->authResourceHeaderListShrink_ == nullptr && this->domainId_ == nullptr && this->gatewayUniqueId_ == nullptr && this->ignoreCase_ == nullptr
    ...
    inline string getAuthResourceHeaderListShrink() const { DARABONBA_PTR_GET_DEFAULT(authResourceHeaderListShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> authResourceHeaderListShrink_ {};
    // The domain ID.
