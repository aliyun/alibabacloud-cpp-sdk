...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && return this->corsJSONShrink_ == nullptr && return this->gatewayId_ == nullptr && return this->gatewayUniqueId_ == nullptr && return this->id_ == nullptr; };
    ...
    inline string corsJSONShrink() const { DARABONBA_PTR_GET_DEFAULT(corsJSONShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> corsJSONShrink_ = nullptr;
