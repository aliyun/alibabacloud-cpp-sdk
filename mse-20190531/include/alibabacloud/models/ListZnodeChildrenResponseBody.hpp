...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListZnodeChildrenResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListZnodeChildrenResponseBodyData>) };
    inline vector<ListZnodeChildrenResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListZnodeChildrenResponseBodyData>) };
    inline ListZnodeChildrenResponseBody& setData(const vector<ListZnodeChildrenResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListZnodeChildrenResponseBody& setData(vector<ListZnodeChildrenResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListZnodeChildrenResponseBodyData>> data_ = nullptr;
