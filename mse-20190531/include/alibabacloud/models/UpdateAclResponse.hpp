...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAclResponseBody) };
    inline UpdateAclResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAclResponseBody> body_ {};
  };
