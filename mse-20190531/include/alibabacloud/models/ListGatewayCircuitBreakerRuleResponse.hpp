...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayCircuitBreakerRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListGatewayCircuitBreakerRuleResponseBody) };
    inline ListGatewayCircuitBreakerRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, ListGatewayCircuitBreakerRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListGatewayCircuitBreakerRuleResponseBody> body_ {};
  };
