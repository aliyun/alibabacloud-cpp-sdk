...
namespace Models
{
  ...
  public:
    ...
    inline const ImportZookeeperDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ImportZookeeperDataResponseBody) };
    inline ImportZookeeperDataResponseBody body() { DARABONBA_PTR_GET(body_, ImportZookeeperDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ImportZookeeperDataResponseBody> body_ = nullptr;
  };
