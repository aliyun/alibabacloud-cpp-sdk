...
namespace Models
{
  ...
  public:
    ...
    inline const GetImageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetImageResponseBodyData) };
    inline GetImageResponseBodyData data() { DARABONBA_PTR_GET(data_, GetImageResponseBodyData) };
    inline GetImageResponseBody& setData(const GetImageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetImageResponseBody& setData(GetImageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetImageResponseBodyData> data_ = nullptr;
