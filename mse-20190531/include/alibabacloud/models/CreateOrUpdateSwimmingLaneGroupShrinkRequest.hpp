...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        ...
        && return this->messageQueueFilterSide_ == nullptr && return this->messageQueueGrayEnable_ == nullptr && return this->name_ == nullptr && return this->namespace_ == nullptr && return this->pathsShrink_ == nullptr
        && return this->recordCanaryDetail_ == nullptr && return this->region_ == nullptr && return this->routeIdsShrink_ == nullptr && return this->status_ == nullptr && return this->swimVersion_ == nullptr; };
    ...
    inline string pathsShrink() const { DARABONBA_PTR_GET_DEFAULT(pathsShrink_, "") };
    ...
    inline string routeIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(routeIdsShrink_, "") };
