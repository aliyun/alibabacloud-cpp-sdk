...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWebFlowRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateWebFlowRuleResponseBodyData) };
    inline UpdateWebFlowRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateWebFlowRuleResponseBodyData) };
    inline UpdateWebFlowRuleResponseBody& setData(const UpdateWebFlowRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateWebFlowRuleResponseBody& setData(UpdateWebFlowRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateWebFlowRuleResponseBodyData> data_ = nullptr;
