...
#ifndef ALIBABACLOUD_MODELS_UPDATEGATEWAYROUTECORSREQUESTCORSJSON_HPP_
#define ALIBABACLOUD_MODELS_UPDATEGATEWAYROUTECORSREQUESTCORSJSON_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateGatewayRouteCORSRequestCorsJSON& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateGatewayRouteCORSRequestCorsJSON& obj) { 
    ...
    UpdateGatewayRouteCORSRequestCorsJSON() = default ;
    UpdateGatewayRouteCORSRequestCorsJSON(const UpdateGatewayRouteCORSRequestCorsJSON &) = default ;
    UpdateGatewayRouteCORSRequestCorsJSON(UpdateGatewayRouteCORSRequestCorsJSON &&) = default ;
    UpdateGatewayRouteCORSRequestCorsJSON(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateGatewayRouteCORSRequestCorsJSON() = default ;
    UpdateGatewayRouteCORSRequestCorsJSON& operator=(const UpdateGatewayRouteCORSRequestCorsJSON &) = default ;
    UpdateGatewayRouteCORSRequestCorsJSON& operator=(UpdateGatewayRouteCORSRequestCorsJSON &&) = default ;
    ...
    inline UpdateGatewayRouteCORSRequestCorsJSON& setAllowCredentials(bool allowCredentials) { DARABONBA_PTR_SET_VALUE(allowCredentials_, allowCredentials) };
    ...
    inline UpdateGatewayRouteCORSRequestCorsJSON& setAllowHeaders(string allowHeaders) { DARABONBA_PTR_SET_VALUE(allowHeaders_, allowHeaders) };
    ...
    inline UpdateGatewayRouteCORSRequestCorsJSON& setAllowMethods(string allowMethods) { DARABONBA_PTR_SET_VALUE(allowMethods_, allowMethods) };
    ...
    inline UpdateGatewayRouteCORSRequestCorsJSON& setAllowOrigins(string allowOrigins) { DARABONBA_PTR_SET_VALUE(allowOrigins_, allowOrigins) };
    ...
    inline UpdateGatewayRouteCORSRequestCorsJSON& setExposeHeaders(string exposeHeaders) { DARABONBA_PTR_SET_VALUE(exposeHeaders_, exposeHeaders) };
    ...
    inline UpdateGatewayRouteCORSRequestCorsJSON& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline UpdateGatewayRouteCORSRequestCorsJSON& setTimeUnit(string timeUnit) { DARABONBA_PTR_SET_VALUE(timeUnit_, timeUnit) };
    ...
    inline UpdateGatewayRouteCORSRequestCorsJSON& setUnitNum(int64_t unitNum) { DARABONBA_PTR_SET_VALUE(unitNum_, unitNum) };
