...
namespace Models
{
  ...
  public:
    ...
    inline const ListNacosMcpServersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNacosMcpServersResponseBody) };
    inline ListNacosMcpServersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNacosMcpServersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNacosMcpServersResponseBody> body_ {};
  };
