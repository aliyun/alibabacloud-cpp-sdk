...
namespace Models
{
  ...
  public:
    ...
    inline const ListSecurityGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSecurityGroupResponseBody) };
    inline ListSecurityGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSecurityGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSecurityGroupResponseBody> body_ {};
  };
