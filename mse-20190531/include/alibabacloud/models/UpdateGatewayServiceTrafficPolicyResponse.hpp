...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGatewayServiceTrafficPolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateGatewayServiceTrafficPolicyResponseBody) };
    inline UpdateGatewayServiceTrafficPolicyResponseBody body() { DARABONBA_PTR_GET(body_, UpdateGatewayServiceTrafficPolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateGatewayServiceTrafficPolicyResponseBody> body_ = nullptr;
  };
