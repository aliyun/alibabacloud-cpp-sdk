...
namespace Models
{
  ...
  public:
    ...
    inline const vector<SelectGatewaySlbResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<SelectGatewaySlbResponseBodyData>) };
    inline vector<SelectGatewaySlbResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<SelectGatewaySlbResponseBodyData>) };
    inline SelectGatewaySlbResponseBody& setData(const vector<SelectGatewaySlbResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SelectGatewaySlbResponseBody& setData(vector<SelectGatewaySlbResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data structure.
    std::shared_ptr<vector<SelectGatewaySlbResponseBodyData>> data_ = nullptr;
