...
namespace Models
{
  ...
  public:
    ...
    inline const GetApplicationInstanceListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetApplicationInstanceListResponseBody) };
    inline GetApplicationInstanceListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetApplicationInstanceListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetApplicationInstanceListResponseBody> body_ {};
  };
