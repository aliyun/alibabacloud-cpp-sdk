...
namespace Models
{
  ...
  public:
    ...
    inline const GetNacosConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetNacosConfigResponseBody) };
    inline GetNacosConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetNacosConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetNacosConfigResponseBody> body_ {};
  };
