...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->gatewaySlbMode_ == nullptr
        && return this->gatewaySlbStatus_ == nullptr && return this->internetNetworkFlow_ == nullptr && return this->slbId_ == nullptr && return this->slbIp_ == nullptr && return this->slbPort_ == nullptr
        && return this->slbSpec_ == nullptr && return this->statusDesc_ == nullptr && return this->type_ == nullptr; };
