...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && this->authJSONShrink_ == nullptr && this->gatewayId_ == nullptr && this->gatewayUniqueId_ == nullptr && this->id_ == nullptr; };
    ...
    inline string getAuthJSONShrink() const { DARABONBA_PTR_GET_DEFAULT(authJSONShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> authJSONShrink_ {};
    // The gateway ID.
