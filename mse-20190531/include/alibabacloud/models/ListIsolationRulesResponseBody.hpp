...
#ifndef ALIBABACLOUD_MODELS_LISTISOLATIONRULESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTISOLATIONRULESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListIsolationRulesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListIsolationRulesResponseBody& obj) { 
    ...
    ListIsolationRulesResponseBody() = default ;
    ListIsolationRulesResponseBody(const ListIsolationRulesResponseBody &) = default ;
    ListIsolationRulesResponseBody(ListIsolationRulesResponseBody &&) = default ;
    ListIsolationRulesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIsolationRulesResponseBody() = default ;
    ListIsolationRulesResponseBody& operator=(const ListIsolationRulesResponseBody &) = default ;
    ListIsolationRulesResponseBody& operator=(ListIsolationRulesResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->appName_ == nullptr && this->enable_ == nullptr && this->fallbackObject_ == nullptr && this->limitApp_ == nullptr && this->namespace_ == nullptr
        && this->regionId_ == nullptr && this->resource_ == nullptr && this->ruleId_ == nullptr && this->threshold_ == nullptr; };
    ...
    inline ListIsolationRulesResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListIsolationRulesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListIsolationRulesResponseBody::Data) };
    inline ListIsolationRulesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListIsolationRulesResponseBody::Data) };
    inline ListIsolationRulesResponseBody& setData(const ListIsolationRulesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIsolationRulesResponseBody& setData(ListIsolationRulesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListIsolationRulesResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListIsolationRulesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListIsolationRulesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListIsolationRulesResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<int32_t> code_ {};
    shared_ptr<ListIsolationRulesResponseBody::Data> data_ {};
