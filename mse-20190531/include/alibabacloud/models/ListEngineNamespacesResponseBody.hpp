...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListEngineNamespacesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListEngineNamespacesResponseBodyData>) };
    inline vector<ListEngineNamespacesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListEngineNamespacesResponseBodyData>) };
    inline ListEngineNamespacesResponseBody& setData(const vector<ListEngineNamespacesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEngineNamespacesResponseBody& setData(vector<ListEngineNamespacesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListEngineNamespacesResponseBodyData>> data_ = nullptr;
