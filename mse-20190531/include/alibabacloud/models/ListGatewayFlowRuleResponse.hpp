...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayFlowRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListGatewayFlowRuleResponseBody) };
    inline ListGatewayFlowRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, ListGatewayFlowRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListGatewayFlowRuleResponseBody> body_ {};
  };
