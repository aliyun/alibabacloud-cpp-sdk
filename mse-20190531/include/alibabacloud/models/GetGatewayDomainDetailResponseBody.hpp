...
namespace Models
{
  ...
  public:
    ...
    inline const GetGatewayDomainDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetGatewayDomainDetailResponseBodyData) };
    inline GetGatewayDomainDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetGatewayDomainDetailResponseBodyData) };
    inline GetGatewayDomainDetailResponseBody& setData(const GetGatewayDomainDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetGatewayDomainDetailResponseBody& setData(GetGatewayDomainDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetGatewayDomainDetailResponseBodyData> data_ = nullptr;
