...
namespace Models
{
  ...
  public:
    ...
    inline const GetGatewayAuthDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetGatewayAuthDetailResponseBodyData) };
    inline GetGatewayAuthDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetGatewayAuthDetailResponseBodyData) };
    inline GetGatewayAuthDetailResponseBody& setData(const GetGatewayAuthDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetGatewayAuthDetailResponseBody& setData(GetGatewayAuthDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetGatewayAuthDetailResponseBodyData> data_ = nullptr;
