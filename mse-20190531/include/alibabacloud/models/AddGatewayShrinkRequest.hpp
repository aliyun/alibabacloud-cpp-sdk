...
#ifndef ALIBABACLOUD_MODELS_ADDGATEWAYSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddGatewayShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(ZoneInfo, zoneInfoShrink_);
    };
    friend void from_json(const Darabonba::Json& j, AddGatewayShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(ZoneInfo, zoneInfoShrink_);
    };
    AddGatewayShrinkRequest() = default ;
    AddGatewayShrinkRequest(const AddGatewayShrinkRequest &) = default ;
    AddGatewayShrinkRequest(AddGatewayShrinkRequest &&) = default ;
    AddGatewayShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddGatewayShrinkRequest() = default ;
    AddGatewayShrinkRequest& operator=(const AddGatewayShrinkRequest &) = default ;
    AddGatewayShrinkRequest& operator=(AddGatewayShrinkRequest &&) = default ;
