...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->historyItems_ == nullptr && return this->httpCode_ == nullptr && return this->message_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr
    ...
    inline const vector<ListNacosHistoryConfigsResponseBodyHistoryItems> & historyItems() const { DARABONBA_PTR_GET_CONST(historyItems_, vector<ListNacosHistoryConfigsResponseBodyHistoryItems>) };
    inline vector<ListNacosHistoryConfigsResponseBodyHistoryItems> historyItems() { DARABONBA_PTR_GET(historyItems_, vector<ListNacosHistoryConfigsResponseBodyHistoryItems>) };
    inline ListNacosHistoryConfigsResponseBody& setHistoryItems(const vector<ListNacosHistoryConfigsResponseBodyHistoryItems> & historyItems) { DARABONBA_PTR_SET_VALUE(historyItems_, historyItems) };
    inline ListNacosHistoryConfigsResponseBody& setHistoryItems(vector<ListNacosHistoryConfigsResponseBodyHistoryItems> && historyItems) { DARABONBA_PTR_SET_RVALUE(historyItems_, historyItems) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListNacosHistoryConfigsResponseBodyHistoryItems>> historyItems_ = nullptr;
