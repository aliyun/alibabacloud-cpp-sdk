...
namespace Models
{
  ...
  public:
    ...
    inline const GetImportFileUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetImportFileUrlResponseBody) };
    inline GetImportFileUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, GetImportFileUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetImportFileUrlResponseBody> body_ {};
  };
