...
namespace Models
{
  ...
  public:
    ...
    inline const QueryZnodeDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryZnodeDetailResponseBody) };
    inline QueryZnodeDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryZnodeDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryZnodeDetailResponseBody> body_ {};
  };
