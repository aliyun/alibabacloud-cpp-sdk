...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetKubernetesSourceResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetKubernetesSourceResponseBodyData>) };
    inline vector<GetKubernetesSourceResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetKubernetesSourceResponseBodyData>) };
    inline GetKubernetesSourceResponseBody& setData(const vector<GetKubernetesSourceResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetKubernetesSourceResponseBody& setData(vector<GetKubernetesSourceResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<GetKubernetesSourceResponseBodyData>> data_ = nullptr;
