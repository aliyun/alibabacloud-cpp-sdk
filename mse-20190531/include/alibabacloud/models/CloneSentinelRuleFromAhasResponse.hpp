...
namespace Models
{
  ...
  public:
    ...
    inline const CloneSentinelRuleFromAhasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CloneSentinelRuleFromAhasResponseBody) };
    inline CloneSentinelRuleFromAhasResponseBody getBody() { DARABONBA_PTR_GET(body_, CloneSentinelRuleFromAhasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CloneSentinelRuleFromAhasResponseBody> body_ {};
  };
