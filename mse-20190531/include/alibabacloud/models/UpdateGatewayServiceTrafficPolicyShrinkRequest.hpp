...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && this->gatewayId_ == nullptr && this->gatewayTrafficPolicyShrink_ == nullptr && this->gatewayUniqueId_ == nullptr && this->serviceId_ == nullptr; };
    ...
    inline string getGatewayTrafficPolicyShrink() const { DARABONBA_PTR_GET_DEFAULT(gatewayTrafficPolicyShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> gatewayTrafficPolicyShrink_ {};
