...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCircuitBreakerRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCircuitBreakerRulesResponseBody) };
    inline DeleteCircuitBreakerRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCircuitBreakerRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCircuitBreakerRulesResponseBody> body_ {};
  };
