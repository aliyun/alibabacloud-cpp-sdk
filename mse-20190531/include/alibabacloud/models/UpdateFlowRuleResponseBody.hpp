...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFlowRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateFlowRuleResponseBodyData) };
    inline UpdateFlowRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateFlowRuleResponseBodyData) };
    inline UpdateFlowRuleResponseBody& setData(const UpdateFlowRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateFlowRuleResponseBody& setData(UpdateFlowRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateFlowRuleResponseBodyData> data_ = nullptr;
