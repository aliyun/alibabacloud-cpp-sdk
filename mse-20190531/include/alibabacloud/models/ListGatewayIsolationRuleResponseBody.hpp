...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayIsolationRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListGatewayIsolationRuleResponseBodyData) };
    inline ListGatewayIsolationRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, ListGatewayIsolationRuleResponseBodyData) };
    inline ListGatewayIsolationRuleResponseBody& setData(const ListGatewayIsolationRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGatewayIsolationRuleResponseBody& setData(ListGatewayIsolationRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<ListGatewayIsolationRuleResponseBodyData> data_ = nullptr;
