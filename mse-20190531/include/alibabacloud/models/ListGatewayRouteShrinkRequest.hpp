...
#ifndef ALIBABACLOUD_MODELS_LISTGATEWAYROUTESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTGATEWAYROUTESHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListGatewayRouteShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListGatewayRouteShrinkRequest& obj) { 
    ...
    ListGatewayRouteShrinkRequest() = default ;
    ListGatewayRouteShrinkRequest(const ListGatewayRouteShrinkRequest &) = default ;
    ListGatewayRouteShrinkRequest(ListGatewayRouteShrinkRequest &&) = default ;
    ListGatewayRouteShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListGatewayRouteShrinkRequest() = default ;
    ListGatewayRouteShrinkRequest& operator=(const ListGatewayRouteShrinkRequest &) = default ;
    ListGatewayRouteShrinkRequest& operator=(ListGatewayRouteShrinkRequest &&) = default ;
    ...
    inline ListGatewayRouteShrinkRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline ListGatewayRouteShrinkRequest& setDescSort(bool descSort) { DARABONBA_PTR_SET_VALUE(descSort_, descSort) };
    ...
    inline ListGatewayRouteShrinkRequest& setFilterParamsShrink(string filterParamsShrink) { DARABONBA_PTR_SET_VALUE(filterParamsShrink_, filterParamsShrink) };
    ...
    inline ListGatewayRouteShrinkRequest& setOrderItem(string orderItem) { DARABONBA_PTR_SET_VALUE(orderItem_, orderItem) };
    ...
    inline ListGatewayRouteShrinkRequest& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListGatewayRouteShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
