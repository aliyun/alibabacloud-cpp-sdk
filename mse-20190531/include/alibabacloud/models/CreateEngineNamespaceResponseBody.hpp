...
#ifndef ALIBABACLOUD_MODELS_CREATEENGINENAMESPACERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEENGINENAMESPACERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateEngineNamespaceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateEngineNamespaceResponseBody& obj) { 
    ...
    CreateEngineNamespaceResponseBody() = default ;
    CreateEngineNamespaceResponseBody(const CreateEngineNamespaceResponseBody &) = default ;
    CreateEngineNamespaceResponseBody(CreateEngineNamespaceResponseBody &&) = default ;
    CreateEngineNamespaceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateEngineNamespaceResponseBody() = default ;
    CreateEngineNamespaceResponseBody& operator=(const CreateEngineNamespaceResponseBody &) = default ;
    CreateEngineNamespaceResponseBody& operator=(CreateEngineNamespaceResponseBody &&) = default ;
    ...
    public:
      ...
      inline Data& setServiceCount(int32_t serviceCount) { DARABONBA_PTR_SET_VALUE(serviceCount_, serviceCount) };
    ...
    inline CreateEngineNamespaceResponseBody& setClusterId(string clusterId) { DARABONBA_PTR_SET_VALUE(clusterId_, clusterId) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateEngineNamespaceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateEngineNamespaceResponseBody::Data) };
    inline CreateEngineNamespaceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateEngineNamespaceResponseBody::Data) };
    inline CreateEngineNamespaceResponseBody& setData(const CreateEngineNamespaceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateEngineNamespaceResponseBody& setData(CreateEngineNamespaceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateEngineNamespaceResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline CreateEngineNamespaceResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateEngineNamespaceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateEngineNamespaceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<CreateEngineNamespaceResponseBody::Data> data_ {};
