...
namespace Models
{
  ...
  public:
    ...
    inline const ListListenersByConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListListenersByConfigResponseBody) };
    inline ListListenersByConfigResponseBody body() { DARABONBA_PTR_GET(body_, ListListenersByConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListListenersByConfigResponseBody> body_ = nullptr;
  };
