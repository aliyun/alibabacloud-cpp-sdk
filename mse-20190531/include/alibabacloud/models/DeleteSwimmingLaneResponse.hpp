...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSwimmingLaneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSwimmingLaneResponseBody) };
    inline DeleteSwimmingLaneResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSwimmingLaneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSwimmingLaneResponseBody> body_ {};
  };
