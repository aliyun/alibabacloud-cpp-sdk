...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayAuthConsumerResourceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListGatewayAuthConsumerResourceResponseBodyData) };
    inline ListGatewayAuthConsumerResourceResponseBodyData data() { DARABONBA_PTR_GET(data_, ListGatewayAuthConsumerResourceResponseBodyData) };
    inline ListGatewayAuthConsumerResourceResponseBody& setData(const ListGatewayAuthConsumerResourceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGatewayAuthConsumerResourceResponseBody& setData(ListGatewayAuthConsumerResourceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<ListGatewayAuthConsumerResourceResponseBodyData> data_ = nullptr;
