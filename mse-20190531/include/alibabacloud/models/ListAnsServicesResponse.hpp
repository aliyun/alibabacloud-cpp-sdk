...
namespace Models
{
  ...
  public:
    ...
    inline const ListAnsServicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAnsServicesResponseBody) };
    inline ListAnsServicesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAnsServicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAnsServicesResponseBody> body_ {};
  };
