...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAnsInstancesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAnsInstancesResponseBodyData>) };
    inline vector<ListAnsInstancesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAnsInstancesResponseBodyData>) };
    inline ListAnsInstancesResponseBody& setData(const vector<ListAnsInstancesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAnsInstancesResponseBody& setData(vector<ListAnsInstancesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAnsInstancesResponseBodyData>> data_ = nullptr;
