...
namespace Models
{
  ...
  public:
    ...
    inline const ListWebFlowRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListWebFlowRulesResponseBodyData) };
    inline ListWebFlowRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListWebFlowRulesResponseBodyData) };
    inline ListWebFlowRulesResponseBody& setData(const ListWebFlowRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListWebFlowRulesResponseBody& setData(ListWebFlowRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListWebFlowRulesResponseBodyData> data_ = nullptr;
