...
namespace Models
{
  ...
  public:
    ...
    inline bool getEncryptToolSpec() const { DARABONBA_PTR_GET_DEFAULT(encryptToolSpec_, false) };
    ...
    inline string getEndpointSpecification() const { DARABONBA_PTR_GET_DEFAULT(endpointSpecification_, "") };
    ...
    inline string getServerSpecification() const { DARABONBA_PTR_GET_DEFAULT(serverSpecification_, "") };
    ...
    inline string getToolSpecification() const { DARABONBA_PTR_GET_DEFAULT(toolSpecification_, "") };
  ...
  protected:
    ...
    shared_ptr<bool> encryptToolSpec_ {};
    shared_ptr<string> endpointSpecification_ {};
    shared_ptr<string> instanceId_ {};
    shared_ptr<string> namespaceId_ {};
    shared_ptr<string> serverName_ {};
    shared_ptr<string> serverSpecification_ {};
    shared_ptr<string> toolSpecification_ {};
