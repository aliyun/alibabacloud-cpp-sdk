...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayRouteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListGatewayRouteResponseBody) };
    inline ListGatewayRouteResponseBody getBody() { DARABONBA_PTR_GET(body_, ListGatewayRouteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListGatewayRouteResponseBody> body_ {};
  };
