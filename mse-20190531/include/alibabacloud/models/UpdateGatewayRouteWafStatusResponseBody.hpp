...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGatewayRouteWafStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateGatewayRouteWafStatusResponseBodyData) };
    inline UpdateGatewayRouteWafStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateGatewayRouteWafStatusResponseBodyData) };
    inline UpdateGatewayRouteWafStatusResponseBody& setData(const UpdateGatewayRouteWafStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateGatewayRouteWafStatusResponseBody& setData(UpdateGatewayRouteWafStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<UpdateGatewayRouteWafStatusResponseBodyData> data_ = nullptr;
