...
namespace Models
{
  ...
  public:
    ...
    inline const CreateIsolationRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateIsolationRuleResponseBody) };
    inline CreateIsolationRuleResponseBody body() { DARABONBA_PTR_GET(body_, CreateIsolationRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateIsolationRuleResponseBody> body_ = nullptr;
  };
