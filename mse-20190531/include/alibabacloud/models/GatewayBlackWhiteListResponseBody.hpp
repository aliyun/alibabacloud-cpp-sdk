...
namespace Models
{
  ...
  public:
    ...
    inline const GatewayBlackWhiteListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GatewayBlackWhiteListResponseBodyData) };
    inline GatewayBlackWhiteListResponseBodyData data() { DARABONBA_PTR_GET(data_, GatewayBlackWhiteListResponseBodyData) };
    inline GatewayBlackWhiteListResponseBody& setData(const GatewayBlackWhiteListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GatewayBlackWhiteListResponseBody& setData(GatewayBlackWhiteListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GatewayBlackWhiteListResponseBodyData> data_ = nullptr;
