...
namespace Models
{
  ...
  public:
    ...
    inline const AddGatewaySlbResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddGatewaySlbResponseBody) };
    inline AddGatewaySlbResponseBody getBody() { DARABONBA_PTR_GET(body_, AddGatewaySlbResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddGatewaySlbResponseBody> body_ {};
  };
