...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && this->dataId_ == nullptr && this->grayName_ == nullptr && this->group_ == nullptr && this->instanceId_ == nullptr && this->namespaceId_ == nullptr
        && this->regionId_ == nullptr && this->requestPars_ == nullptr; };
    ...
    inline string getGrayName() const { DARABONBA_PTR_GET_DEFAULT(grayName_, "") };
