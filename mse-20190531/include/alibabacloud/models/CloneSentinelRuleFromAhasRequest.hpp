...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && this->ahasNamespace_ == nullptr && this->appName_ == nullptr && this->isAHASPublicRegion_ == nullptr && this->mseAppName_ == nullptr && this->namespace_ == nullptr; };
    ...
    inline string getAhasNamespace() const { DARABONBA_PTR_GET_DEFAULT(ahasNamespace_, "") };
    ...
    inline bool getIsAHASPublicRegion() const { DARABONBA_PTR_GET_DEFAULT(isAHASPublicRegion_, false) };
  ...
  protected:
    ...
    shared_ptr<string> ahasNamespace_ {};
    // The application name.
    shared_ptr<string> appName_ {};
    // Specifies whether AHAS is deployed in the Internet region.
    shared_ptr<bool> isAHASPublicRegion_ {};
