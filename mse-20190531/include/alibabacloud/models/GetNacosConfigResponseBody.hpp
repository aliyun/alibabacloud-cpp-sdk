...
namespace Models
{
  ...
  public:
    ...
    inline const GetNacosConfigResponseBodyConfiguration & configuration() const { DARABONBA_PTR_GET_CONST(configuration_, GetNacosConfigResponseBodyConfiguration) };
    inline GetNacosConfigResponseBodyConfiguration configuration() { DARABONBA_PTR_GET(configuration_, GetNacosConfigResponseBodyConfiguration) };
    inline GetNacosConfigResponseBody& setConfiguration(const GetNacosConfigResponseBodyConfiguration & configuration) { DARABONBA_PTR_SET_VALUE(configuration_, configuration) };
    inline GetNacosConfigResponseBody& setConfiguration(GetNacosConfigResponseBodyConfiguration && configuration) { DARABONBA_PTR_SET_RVALUE(configuration_, configuration) };
  ...
  protected:
    ...
    std::shared_ptr<GetNacosConfigResponseBodyConfiguration> configuration_ = nullptr;
    // Error code.
