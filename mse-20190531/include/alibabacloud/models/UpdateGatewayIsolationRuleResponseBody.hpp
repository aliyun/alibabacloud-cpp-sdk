...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGatewayIsolationRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateGatewayIsolationRuleResponseBodyData) };
    inline UpdateGatewayIsolationRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateGatewayIsolationRuleResponseBodyData) };
    inline UpdateGatewayIsolationRuleResponseBody& setData(const UpdateGatewayIsolationRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateGatewayIsolationRuleResponseBody& setData(UpdateGatewayIsolationRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<UpdateGatewayIsolationRuleResponseBodyData> data_ = nullptr;
