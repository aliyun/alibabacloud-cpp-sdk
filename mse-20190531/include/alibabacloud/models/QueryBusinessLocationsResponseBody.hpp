...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryBusinessLocationsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryBusinessLocationsResponseBodyData>) };
    inline vector<QueryBusinessLocationsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryBusinessLocationsResponseBodyData>) };
    inline QueryBusinessLocationsResponseBody& setData(const vector<QueryBusinessLocationsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryBusinessLocationsResponseBody& setData(vector<QueryBusinessLocationsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryBusinessLocationsResponseBodyData>> data_ = nullptr;
