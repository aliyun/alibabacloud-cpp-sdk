...
#ifndef ALIBABACLOUD_MODELS_UPDATEGATEWAYFLOWRULEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEGATEWAYFLOWRULEREQUEST_HPP_
...
namespace Models
{
  class UpdateGatewayFlowRuleRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateGatewayFlowRuleRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateGatewayFlowRuleRequest& obj) { 
    ...
    UpdateGatewayFlowRuleRequest() = default ;
    UpdateGatewayFlowRuleRequest(const UpdateGatewayFlowRuleRequest &) = default ;
    UpdateGatewayFlowRuleRequest(UpdateGatewayFlowRuleRequest &&) = default ;
    UpdateGatewayFlowRuleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateGatewayFlowRuleRequest() = default ;
    UpdateGatewayFlowRuleRequest& operator=(const UpdateGatewayFlowRuleRequest &) = default ;
    UpdateGatewayFlowRuleRequest& operator=(UpdateGatewayFlowRuleRequest &&) = default ;
    ...
    inline UpdateGatewayFlowRuleRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline UpdateGatewayFlowRuleRequest& setBehaviorType(int32_t behaviorType) { DARABONBA_PTR_SET_VALUE(behaviorType_, behaviorType) };
    ...
    inline UpdateGatewayFlowRuleRequest& setBodyEncoding(int32_t bodyEncoding) { DARABONBA_PTR_SET_VALUE(bodyEncoding_, bodyEncoding) };
    ...
    inline UpdateGatewayFlowRuleRequest& setEnable(int32_t enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };
    ...
    inline UpdateGatewayFlowRuleRequest& setGatewayId(int64_t gatewayId) { DARABONBA_PTR_SET_VALUE(gatewayId_, gatewayId) };
    ...
    inline UpdateGatewayFlowRuleRequest& setGatewayUniqueId(string gatewayUniqueId) { DARABONBA_PTR_SET_VALUE(gatewayUniqueId_, gatewayUniqueId) };
    ...
    inline UpdateGatewayFlowRuleRequest& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UpdateGatewayFlowRuleRequest& setResponseContentBody(string responseContentBody) { DARABONBA_PTR_SET_VALUE(responseContentBody_, responseContentBody) };
    ...
    inline UpdateGatewayFlowRuleRequest& setResponseRedirectUrl(string responseRedirectUrl) { DARABONBA_PTR_SET_VALUE(responseRedirectUrl_, responseRedirectUrl) };
    ...
    inline UpdateGatewayFlowRuleRequest& setResponseStatusCode(int32_t responseStatusCode) { DARABONBA_PTR_SET_VALUE(responseStatusCode_, responseStatusCode) };
    ...
    inline UpdateGatewayFlowRuleRequest& setRouteId(int64_t routeId) { DARABONBA_PTR_SET_VALUE(routeId_, routeId) };
    ...
    inline UpdateGatewayFlowRuleRequest& setRouteName(string routeName) { DARABONBA_PTR_SET_VALUE(routeName_, routeName) };
    ...
    inline UpdateGatewayFlowRuleRequest& setThreshold(int32_t threshold) { DARABONBA_PTR_SET_VALUE(threshold_, threshold) };
