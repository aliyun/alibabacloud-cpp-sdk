...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGatewayRouteAuthResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateGatewayRouteAuthResponseBody) };
    inline UpdateGatewayRouteAuthResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateGatewayRouteAuthResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateGatewayRouteAuthResponseBody> body_ {};
  };
