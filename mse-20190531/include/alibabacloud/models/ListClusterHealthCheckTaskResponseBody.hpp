...
namespace Models
{
  ...
  public:
    ...
    inline const ListClusterHealthCheckTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListClusterHealthCheckTaskResponseBodyData) };
    inline ListClusterHealthCheckTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, ListClusterHealthCheckTaskResponseBodyData) };
    inline ListClusterHealthCheckTaskResponseBody& setData(const ListClusterHealthCheckTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListClusterHealthCheckTaskResponseBody& setData(ListClusterHealthCheckTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListClusterHealthCheckTaskResponseBodyData> data_ = nullptr;
