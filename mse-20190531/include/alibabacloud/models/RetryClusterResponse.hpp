...
namespace Models
{
  ...
  public:
    ...
    inline const RetryClusterResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RetryClusterResponseBody) };
    inline RetryClusterResponseBody body() { DARABONBA_PTR_GET(body_, RetryClusterResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RetryClusterResponseBody> body_ = nullptr;
  };
