...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AddGatewayAuthRequest::AuthResourceList> & getAuthResourceList() const { DARABONBA_PTR_GET_CONST(authResourceList_, vector<AddGatewayAuthRequest::AuthResourceList>) };
    inline vector<AddGatewayAuthRequest::AuthResourceList> getAuthResourceList() { DARABONBA_PTR_GET(authResourceList_, vector<AddGatewayAuthRequest::AuthResourceList>) };
    inline AddGatewayAuthRequest& setAuthResourceList(const vector<AddGatewayAuthRequest::AuthResourceList> & authResourceList) { DARABONBA_PTR_SET_VALUE(authResourceList_, authResourceList) };
    inline AddGatewayAuthRequest& setAuthResourceList(vector<AddGatewayAuthRequest::AuthResourceList> && authResourceList) { DARABONBA_PTR_SET_RVALUE(authResourceList_, authResourceList) };
    ...
    inline const AddGatewayAuthRequest::ExternalAuthZJSON & getExternalAuthZJSON() const { DARABONBA_PTR_GET_CONST(externalAuthZJSON_, AddGatewayAuthRequest::ExternalAuthZJSON) };
    inline AddGatewayAuthRequest::ExternalAuthZJSON getExternalAuthZJSON() { DARABONBA_PTR_GET(externalAuthZJSON_, AddGatewayAuthRequest::ExternalAuthZJSON) };
    inline AddGatewayAuthRequest& setExternalAuthZJSON(const AddGatewayAuthRequest::ExternalAuthZJSON & externalAuthZJSON) { DARABONBA_PTR_SET_VALUE(externalAuthZJSON_, externalAuthZJSON) };
    inline AddGatewayAuthRequest& setExternalAuthZJSON(AddGatewayAuthRequest::ExternalAuthZJSON && externalAuthZJSON) { DARABONBA_PTR_SET_RVALUE(externalAuthZJSON_, externalAuthZJSON) };
  ...
  protected:
    ...
    shared_ptr<vector<AddGatewayAuthRequest::AuthResourceList>> authResourceList_ {};
    ...
    shared_ptr<AddGatewayAuthRequest::ExternalAuthZJSON> externalAuthZJSON_ {};
