...
namespace Models
{
  ...
  public:
    ...
    inline const SelectGatewaySlbResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SelectGatewaySlbResponseBody) };
    inline SelectGatewaySlbResponseBody getBody() { DARABONBA_PTR_GET(body_, SelectGatewaySlbResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SelectGatewaySlbResponseBody> body_ {};
  };
