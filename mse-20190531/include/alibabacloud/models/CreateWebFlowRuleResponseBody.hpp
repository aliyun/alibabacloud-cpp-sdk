...
#ifndef ALIBABACLOUD_MODELS_CREATEWEBFLOWRULERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEWEBFLOWRULERESPONSEBODY_HPP_
...
namespace Models
{
  class CreateWebFlowRuleResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateWebFlowRuleResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateWebFlowRuleResponseBody& obj) { 
    ...
    CreateWebFlowRuleResponseBody() = default ;
    CreateWebFlowRuleResponseBody(const CreateWebFlowRuleResponseBody &) = default ;
    CreateWebFlowRuleResponseBody(CreateWebFlowRuleResponseBody &&) = default ;
    CreateWebFlowRuleResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateWebFlowRuleResponseBody() = default ;
    CreateWebFlowRuleResponseBody& operator=(const CreateWebFlowRuleResponseBody &) = default ;
    CreateWebFlowRuleResponseBody& operator=(CreateWebFlowRuleResponseBody &&) = default ;
    ...
    inline CreateWebFlowRuleResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateWebFlowRuleResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateWebFlowRuleResponseBody::Data) };
    inline CreateWebFlowRuleResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateWebFlowRuleResponseBody::Data) };
    inline CreateWebFlowRuleResponseBody& setData(const CreateWebFlowRuleResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateWebFlowRuleResponseBody& setData(CreateWebFlowRuleResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateWebFlowRuleResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateWebFlowRuleResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateWebFlowRuleResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<CreateWebFlowRuleResponseBody::Data> data_ {};
