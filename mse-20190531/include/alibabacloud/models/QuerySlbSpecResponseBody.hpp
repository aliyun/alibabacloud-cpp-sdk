...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QuerySlbSpecResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QuerySlbSpecResponseBodyData>) };
    inline vector<QuerySlbSpecResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QuerySlbSpecResponseBodyData>) };
    inline QuerySlbSpecResponseBody& setData(const vector<QuerySlbSpecResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QuerySlbSpecResponseBody& setData(vector<QuerySlbSpecResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QuerySlbSpecResponseBodyData>> data_ = nullptr;
