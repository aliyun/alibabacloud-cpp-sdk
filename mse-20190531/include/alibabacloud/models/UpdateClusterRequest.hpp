...
namespace Models
{
  ...
  public:
    ...
    inline string getMaintenanceEndTime() const { DARABONBA_PTR_GET_DEFAULT(maintenanceEndTime_, "") };
    ...
    inline string getMaintenanceStartTime() const { DARABONBA_PTR_GET_DEFAULT(maintenanceStartTime_, "") };
  ...
  protected:
    ...
    shared_ptr<string> maintenanceEndTime_ {};
    // The start time of the O\\&M window.
    shared_ptr<string> maintenanceStartTime_ {};
