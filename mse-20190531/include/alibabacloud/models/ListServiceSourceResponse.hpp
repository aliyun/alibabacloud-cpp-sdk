...
namespace Models
{
  ...
  public:
    ...
    inline const ListServiceSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListServiceSourceResponseBody) };
    inline ListServiceSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, ListServiceSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListServiceSourceResponseBody> body_ {};
  };
