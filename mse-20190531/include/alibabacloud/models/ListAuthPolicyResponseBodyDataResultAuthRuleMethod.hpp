...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->group_ == nullptr
        && return this->name_ == nullptr && return this->parameterTypes_ == nullptr && return this->returnType_ == nullptr && return this->serviceName_ == nullptr && return this->version_ == nullptr; };
