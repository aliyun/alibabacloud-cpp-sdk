...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGatewayDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteGatewayDomainResponseBody) };
    inline DeleteGatewayDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteGatewayDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteGatewayDomainResponseBody> body_ {};
  };
