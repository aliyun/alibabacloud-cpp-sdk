...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEngineNamespaceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteEngineNamespaceResponseBody) };
    inline DeleteEngineNamespaceResponseBody body() { DARABONBA_PTR_GET(body_, DeleteEngineNamespaceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteEngineNamespaceResponseBody> body_ = nullptr;
  };
