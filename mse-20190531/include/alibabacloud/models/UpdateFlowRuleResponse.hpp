...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFlowRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateFlowRuleResponseBody) };
    inline UpdateFlowRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateFlowRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateFlowRuleResponseBody> body_ {};
  };
