...
namespace Models
{
  ...
  public:
    ...
    inline const AddGatewayAuthResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddGatewayAuthResponseBody) };
    inline AddGatewayAuthResponseBody getBody() { DARABONBA_PTR_GET(body_, AddGatewayAuthResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddGatewayAuthResponseBody> body_ {};
  };
