...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSentinelBlockFallbackDefinitionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateSentinelBlockFallbackDefinitionResponseBodyData) };
    inline CreateSentinelBlockFallbackDefinitionResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateSentinelBlockFallbackDefinitionResponseBodyData) };
    inline CreateSentinelBlockFallbackDefinitionResponseBody& setData(const CreateSentinelBlockFallbackDefinitionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateSentinelBlockFallbackDefinitionResponseBody& setData(CreateSentinelBlockFallbackDefinitionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateSentinelBlockFallbackDefinitionResponseBodyData> data_ = nullptr;
