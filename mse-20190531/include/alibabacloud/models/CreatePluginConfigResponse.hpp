...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePluginConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePluginConfigResponseBody) };
    inline CreatePluginConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePluginConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePluginConfigResponseBody> body_ {};
  };
