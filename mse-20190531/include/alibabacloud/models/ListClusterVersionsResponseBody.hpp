...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListClusterVersionsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListClusterVersionsResponseBodyData>) };
    inline vector<ListClusterVersionsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListClusterVersionsResponseBodyData>) };
    inline ListClusterVersionsResponseBody& setData(const vector<ListClusterVersionsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListClusterVersionsResponseBody& setData(vector<ListClusterVersionsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListClusterVersionsResponseBodyData>> data_ = nullptr;
