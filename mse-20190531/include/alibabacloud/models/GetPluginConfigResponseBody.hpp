...
namespace Models
{
  ...
  public:
    ...
    inline const GetPluginConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPluginConfigResponseBodyData) };
    inline GetPluginConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPluginConfigResponseBodyData) };
    inline GetPluginConfigResponseBody& setData(const GetPluginConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPluginConfigResponseBody& setData(GetPluginConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetPluginConfigResponseBodyData> data_ = nullptr;
