...
namespace Models
{
  ...
  public:
    ...
    inline const ListClusterVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListClusterVersionsResponseBody) };
    inline ListClusterVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListClusterVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListClusterVersionsResponseBody> body_ {};
  };
