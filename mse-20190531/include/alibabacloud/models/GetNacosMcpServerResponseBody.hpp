...
namespace Models
{
  ...
  public:
    ...
    inline const GetNacosMcpServerResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetNacosMcpServerResponseBodyData) };
    inline GetNacosMcpServerResponseBodyData data() { DARABONBA_PTR_GET(data_, GetNacosMcpServerResponseBodyData) };
    inline GetNacosMcpServerResponseBody& setData(const GetNacosMcpServerResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetNacosMcpServerResponseBody& setData(GetNacosMcpServerResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetNacosMcpServerResponseBodyData> data_ = nullptr;
