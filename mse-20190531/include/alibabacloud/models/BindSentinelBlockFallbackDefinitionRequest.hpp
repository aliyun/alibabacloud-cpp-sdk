...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && this->appName_ == nullptr && this->fallbackId_ == nullptr && this->namespace_ == nullptr && this->resource_ == nullptr && this->targetType_ == nullptr; };
    ...
    inline int64_t getFallbackId() const { DARABONBA_PTR_GET_DEFAULT(fallbackId_, 0L) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<int64_t> fallbackId_ {};
