...
namespace Models
{
  ...
  public:
    ...
    inline const AddGatewayAuthConsumerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddGatewayAuthConsumerResponseBody) };
    inline AddGatewayAuthConsumerResponseBody getBody() { DARABONBA_PTR_GET(body_, AddGatewayAuthConsumerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddGatewayAuthConsumerResponseBody> body_ {};
  };
