...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAuthResourceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeleteAuthResourceResponseBodyData) };
    inline DeleteAuthResourceResponseBodyData data() { DARABONBA_PTR_GET(data_, DeleteAuthResourceResponseBodyData) };
    inline DeleteAuthResourceResponseBody& setData(const DeleteAuthResourceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteAuthResourceResponseBody& setData(DeleteAuthResourceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DeleteAuthResourceResponseBodyData> data_ = nullptr;
