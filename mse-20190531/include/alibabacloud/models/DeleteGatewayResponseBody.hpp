...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGatewayResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeleteGatewayResponseBodyData) };
    inline DeleteGatewayResponseBodyData data() { DARABONBA_PTR_GET(data_, DeleteGatewayResponseBodyData) };
    inline DeleteGatewayResponseBody& setData(const DeleteGatewayResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteGatewayResponseBody& setData(DeleteGatewayResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteGatewayResponseBodyData> data_ = nullptr;
