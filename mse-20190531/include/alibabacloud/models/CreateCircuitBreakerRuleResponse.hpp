...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCircuitBreakerRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCircuitBreakerRuleResponseBody) };
    inline CreateCircuitBreakerRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCircuitBreakerRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCircuitBreakerRuleResponseBody> body_ {};
  };
