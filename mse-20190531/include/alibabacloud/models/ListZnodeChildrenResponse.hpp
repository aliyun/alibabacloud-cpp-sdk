...
namespace Models
{
  ...
  public:
    ...
    inline const ListZnodeChildrenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListZnodeChildrenResponseBody) };
    inline ListZnodeChildrenResponseBody getBody() { DARABONBA_PTR_GET(body_, ListZnodeChildrenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListZnodeChildrenResponseBody> body_ {};
  };
