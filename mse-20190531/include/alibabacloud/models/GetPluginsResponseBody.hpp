...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetPluginsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetPluginsResponseBodyData>) };
    inline vector<GetPluginsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetPluginsResponseBodyData>) };
    inline GetPluginsResponseBody& setData(const vector<GetPluginsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPluginsResponseBody& setData(vector<GetPluginsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetPluginsResponseBodyData>> data_ = nullptr;
