...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAllSwimmingLaneGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryAllSwimmingLaneGroupResponseBody) };
    inline QueryAllSwimmingLaneGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryAllSwimmingLaneGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryAllSwimmingLaneGroupResponseBody> body_ {};
  };
