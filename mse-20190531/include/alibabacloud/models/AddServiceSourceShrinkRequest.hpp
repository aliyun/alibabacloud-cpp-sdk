...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && this->address_ == nullptr && this->gatewayUniqueId_ == nullptr && this->groupListShrink_ == nullptr && this->ingressOptionsRequestShrink_ == nullptr && this->name_ == nullptr
        && this->pathListShrink_ == nullptr && this->source_ == nullptr && this->toAuthorizeSecurityGroupsShrink_ == nullptr && this->type_ == nullptr; };
    ...
    inline string getGroupListShrink() const { DARABONBA_PTR_GET_DEFAULT(groupListShrink_, "") };
    ...
    inline string getToAuthorizeSecurityGroupsShrink() const { DARABONBA_PTR_GET_DEFAULT(toAuthorizeSecurityGroupsShrink_, "") };
  ...
  protected:
    ...
    // The data structure.
    shared_ptr<string> groupListShrink_ {};
    ...
    shared_ptr<string> toAuthorizeSecurityGroupsShrink_ {};
