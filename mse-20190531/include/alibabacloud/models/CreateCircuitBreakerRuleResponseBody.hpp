...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCircuitBreakerRuleResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateCircuitBreakerRuleResponseBody::Data) };
    inline CreateCircuitBreakerRuleResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateCircuitBreakerRuleResponseBody::Data) };
    inline CreateCircuitBreakerRuleResponseBody& setData(const CreateCircuitBreakerRuleResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateCircuitBreakerRuleResponseBody& setData(CreateCircuitBreakerRuleResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<CreateCircuitBreakerRuleResponseBody::Data> data_ {};
