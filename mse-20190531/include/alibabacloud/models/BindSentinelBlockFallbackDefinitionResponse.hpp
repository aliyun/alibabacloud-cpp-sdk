...
namespace Models
{
  ...
  public:
    ...
    inline const BindSentinelBlockFallbackDefinitionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, BindSentinelBlockFallbackDefinitionResponseBody) };
    inline BindSentinelBlockFallbackDefinitionResponseBody body() { DARABONBA_PTR_GET(body_, BindSentinelBlockFallbackDefinitionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<BindSentinelBlockFallbackDefinitionResponseBody> body_ = nullptr;
  };
