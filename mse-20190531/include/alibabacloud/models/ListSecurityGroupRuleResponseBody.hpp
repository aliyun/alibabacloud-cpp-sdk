...
#ifndef ALIBABACLOUD_MODELS_LISTSECURITYGROUPRULERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListSecurityGroupRuleResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListSecurityGroupRuleResponseBody& obj) { 
    ...
    ListSecurityGroupRuleResponseBody() = default ;
    ListSecurityGroupRuleResponseBody(const ListSecurityGroupRuleResponseBody &) = default ;
    ListSecurityGroupRuleResponseBody(ListSecurityGroupRuleResponseBody &&) = default ;
    ListSecurityGroupRuleResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListSecurityGroupRuleResponseBody() = default ;
    ListSecurityGroupRuleResponseBody& operator=(const ListSecurityGroupRuleResponseBody &) = default ;
    ListSecurityGroupRuleResponseBody& operator=(ListSecurityGroupRuleResponseBody &&) = default ;
