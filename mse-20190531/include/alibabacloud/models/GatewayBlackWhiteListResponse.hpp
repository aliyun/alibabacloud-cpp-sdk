...
namespace Models
{
  ...
  public:
    ...
    inline const GatewayBlackWhiteListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GatewayBlackWhiteListResponseBody) };
    inline GatewayBlackWhiteListResponseBody getBody() { DARABONBA_PTR_GET(body_, GatewayBlackWhiteListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GatewayBlackWhiteListResponseBody> body_ {};
  };
