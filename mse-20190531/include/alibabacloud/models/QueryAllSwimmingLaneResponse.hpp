...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAllSwimmingLaneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryAllSwimmingLaneResponseBody) };
    inline QueryAllSwimmingLaneResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryAllSwimmingLaneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryAllSwimmingLaneResponseBody> body_ {};
  };
