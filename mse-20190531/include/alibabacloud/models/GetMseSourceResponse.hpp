...
namespace Models
{
  ...
  public:
    ...
    inline const GetMseSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMseSourceResponseBody) };
    inline GetMseSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMseSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMseSourceResponseBody> body_ {};
  };
