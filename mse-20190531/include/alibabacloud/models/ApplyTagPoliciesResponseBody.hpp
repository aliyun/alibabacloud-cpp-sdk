...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ApplyTagPoliciesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ApplyTagPoliciesResponseBodyData>) };
    inline vector<ApplyTagPoliciesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ApplyTagPoliciesResponseBodyData>) };
    inline ApplyTagPoliciesResponseBody& setData(const vector<ApplyTagPoliciesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ApplyTagPoliciesResponseBody& setData(vector<ApplyTagPoliciesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ApplyTagPoliciesResponseBodyData>> data_ = nullptr;
