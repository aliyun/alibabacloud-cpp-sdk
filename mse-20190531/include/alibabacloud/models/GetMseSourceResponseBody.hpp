...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetMseSourceResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetMseSourceResponseBodyData>) };
    inline vector<GetMseSourceResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetMseSourceResponseBodyData>) };
    inline GetMseSourceResponseBody& setData(const vector<GetMseSourceResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMseSourceResponseBody& setData(vector<GetMseSourceResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data structure.
    std::shared_ptr<vector<GetMseSourceResponseBodyData>> data_ = nullptr;
