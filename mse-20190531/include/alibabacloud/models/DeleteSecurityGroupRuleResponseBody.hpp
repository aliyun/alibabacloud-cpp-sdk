...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSecurityGroupRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeleteSecurityGroupRuleResponseBodyData) };
    inline DeleteSecurityGroupRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, DeleteSecurityGroupRuleResponseBodyData) };
    inline DeleteSecurityGroupRuleResponseBody& setData(const DeleteSecurityGroupRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteSecurityGroupRuleResponseBody& setData(DeleteSecurityGroupRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DeleteSecurityGroupRuleResponseBodyData> data_ = nullptr;
