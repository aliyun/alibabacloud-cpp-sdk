...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySwimmingLaneByIdResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QuerySwimmingLaneByIdResponseBody::Data) };
    inline QuerySwimmingLaneByIdResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QuerySwimmingLaneByIdResponseBody::Data) };
    inline QuerySwimmingLaneByIdResponseBody& setData(const QuerySwimmingLaneByIdResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QuerySwimmingLaneByIdResponseBody& setData(QuerySwimmingLaneByIdResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<QuerySwimmingLaneByIdResponseBody::Data> data_ {};
