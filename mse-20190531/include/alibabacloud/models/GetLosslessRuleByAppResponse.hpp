...
namespace Models
{
  ...
  public:
    ...
    inline const GetLosslessRuleByAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLosslessRuleByAppResponseBody) };
    inline GetLosslessRuleByAppResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLosslessRuleByAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLosslessRuleByAppResponseBody> body_ {};
  };
