...
namespace Models
{
  ...
  public:
    ...
    inline const AddMigrationTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddMigrationTaskResponseBody) };
    inline AddMigrationTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, AddMigrationTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddMigrationTaskResponseBody> body_ {};
  };
