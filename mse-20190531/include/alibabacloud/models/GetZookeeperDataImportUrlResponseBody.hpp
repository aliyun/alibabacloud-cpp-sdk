...
namespace Models
{
  ...
  public:
    ...
    inline const GetZookeeperDataImportUrlResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetZookeeperDataImportUrlResponseBodyData) };
    inline GetZookeeperDataImportUrlResponseBodyData data() { DARABONBA_PTR_GET(data_, GetZookeeperDataImportUrlResponseBodyData) };
    inline GetZookeeperDataImportUrlResponseBody& setData(const GetZookeeperDataImportUrlResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetZookeeperDataImportUrlResponseBody& setData(GetZookeeperDataImportUrlResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetZookeeperDataImportUrlResponseBodyData> data_ = nullptr;
