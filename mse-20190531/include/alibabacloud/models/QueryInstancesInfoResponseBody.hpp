...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryInstancesInfoResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryInstancesInfoResponseBodyData>) };
    inline vector<QueryInstancesInfoResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryInstancesInfoResponseBodyData>) };
    inline QueryInstancesInfoResponseBody& setData(const vector<QueryInstancesInfoResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryInstancesInfoResponseBody& setData(vector<QueryInstancesInfoResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryInstancesInfoResponseBodyData>> data_ = nullptr;
