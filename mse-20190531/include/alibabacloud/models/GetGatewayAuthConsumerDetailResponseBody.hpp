...
namespace Models
{
  ...
  public:
    ...
    inline const GetGatewayAuthConsumerDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetGatewayAuthConsumerDetailResponseBodyData) };
    inline GetGatewayAuthConsumerDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetGatewayAuthConsumerDetailResponseBodyData) };
    inline GetGatewayAuthConsumerDetailResponseBody& setData(const GetGatewayAuthConsumerDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetGatewayAuthConsumerDetailResponseBody& setData(GetGatewayAuthConsumerDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetGatewayAuthConsumerDetailResponseBodyData> data_ = nullptr;
