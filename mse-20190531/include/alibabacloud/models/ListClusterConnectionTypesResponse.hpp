...
namespace Models
{
  ...
  public:
    ...
    inline const ListClusterConnectionTypesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListClusterConnectionTypesResponseBody) };
    inline ListClusterConnectionTypesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListClusterConnectionTypesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListClusterConnectionTypesResponseBody> body_ {};
  };
