...
namespace Models
{
  ...
  public:
    ...
    inline const GetPluginsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetPluginsResponseBody) };
    inline GetPluginsResponseBody body() { DARABONBA_PTR_GET(body_, GetPluginsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetPluginsResponseBody> body_ = nullptr;
  };
