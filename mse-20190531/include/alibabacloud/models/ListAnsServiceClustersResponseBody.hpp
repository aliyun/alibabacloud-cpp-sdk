...
namespace Models
{
  ...
  public:
    ...
    inline const ListAnsServiceClustersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAnsServiceClustersResponseBodyData) };
    inline ListAnsServiceClustersResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAnsServiceClustersResponseBodyData) };
    inline ListAnsServiceClustersResponseBody& setData(const ListAnsServiceClustersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAnsServiceClustersResponseBody& setData(ListAnsServiceClustersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListAnsServiceClustersResponseBodyData> data_ = nullptr;
