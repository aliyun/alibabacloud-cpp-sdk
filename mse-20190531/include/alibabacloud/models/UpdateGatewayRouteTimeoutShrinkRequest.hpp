...
#ifndef ALIBABACLOUD_MODELS_UPDATEGATEWAYROUTETIMEOUTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEGATEWAYROUTETIMEOUTSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateGatewayRouteTimeoutShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AcceptLanguage, acceptLanguage_);
      DARABONBA_PTR_TO_JSON(GatewayId, gatewayId_);
      DARABONBA_PTR_TO_JSON(GatewayUniqueId, gatewayUniqueId_);
      DARABONBA_PTR_TO_JSON(Id, id_);
      DARABONBA_PTR_TO_JSON(TimeoutJSON, timeoutJSONShrink_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateGatewayRouteTimeoutShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AcceptLanguage, acceptLanguage_);
      DARABONBA_PTR_FROM_JSON(GatewayId, gatewayId_);
      DARABONBA_PTR_FROM_JSON(GatewayUniqueId, gatewayUniqueId_);
      DARABONBA_PTR_FROM_JSON(Id, id_);
      DARABONBA_PTR_FROM_JSON(TimeoutJSON, timeoutJSONShrink_);
    };
    UpdateGatewayRouteTimeoutShrinkRequest() = default ;
    UpdateGatewayRouteTimeoutShrinkRequest(const UpdateGatewayRouteTimeoutShrinkRequest &) = default ;
    UpdateGatewayRouteTimeoutShrinkRequest(UpdateGatewayRouteTimeoutShrinkRequest &&) = default ;
    UpdateGatewayRouteTimeoutShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateGatewayRouteTimeoutShrinkRequest() = default ;
    UpdateGatewayRouteTimeoutShrinkRequest& operator=(const UpdateGatewayRouteTimeoutShrinkRequest &) = default ;
    UpdateGatewayRouteTimeoutShrinkRequest& operator=(UpdateGatewayRouteTimeoutShrinkRequest &&) = default ;
