...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNacosInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateNacosInstanceResponseBody) };
    inline CreateNacosInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateNacosInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateNacosInstanceResponseBody> body_ {};
  };
