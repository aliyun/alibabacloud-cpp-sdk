...
namespace Models
{
  ...
  public:
    ...
    inline const GetGovernanceKubernetesClusterResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetGovernanceKubernetesClusterResponseBodyData) };
    inline GetGovernanceKubernetesClusterResponseBodyData data() { DARABONBA_PTR_GET(data_, GetGovernanceKubernetesClusterResponseBodyData) };
    inline GetGovernanceKubernetesClusterResponseBody& setData(const GetGovernanceKubernetesClusterResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetGovernanceKubernetesClusterResponseBody& setData(GetGovernanceKubernetesClusterResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetGovernanceKubernetesClusterResponseBodyData> data_ = nullptr;
