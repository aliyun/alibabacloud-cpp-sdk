...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAnsServicesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAnsServicesResponseBodyData>) };
    inline vector<ListAnsServicesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAnsServicesResponseBodyData>) };
    inline ListAnsServicesResponseBody& setData(const vector<ListAnsServicesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAnsServicesResponseBody& setData(vector<ListAnsServicesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAnsServicesResponseBodyData>> data_ = nullptr;
