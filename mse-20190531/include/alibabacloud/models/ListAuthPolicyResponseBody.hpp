...
namespace Models
{
  ...
  public:
    ...
    inline const ListAuthPolicyResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAuthPolicyResponseBodyData) };
    inline ListAuthPolicyResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAuthPolicyResponseBodyData) };
    inline ListAuthPolicyResponseBody& setData(const ListAuthPolicyResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAuthPolicyResponseBody& setData(ListAuthPolicyResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListAuthPolicyResponseBodyData> data_ = nullptr;
