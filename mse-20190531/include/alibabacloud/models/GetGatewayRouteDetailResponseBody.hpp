...
namespace Models
{
  ...
  public:
    ...
    inline const GetGatewayRouteDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetGatewayRouteDetailResponseBodyData) };
    inline GetGatewayRouteDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetGatewayRouteDetailResponseBodyData) };
    inline GetGatewayRouteDetailResponseBody& setData(const GetGatewayRouteDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetGatewayRouteDetailResponseBody& setData(GetGatewayRouteDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetGatewayRouteDetailResponseBodyData> data_ = nullptr;
