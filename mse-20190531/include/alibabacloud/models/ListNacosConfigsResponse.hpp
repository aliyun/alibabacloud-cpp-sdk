...
namespace Models
{
  ...
  public:
    ...
    inline const ListNacosConfigsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListNacosConfigsResponseBody) };
    inline ListNacosConfigsResponseBody body() { DARABONBA_PTR_GET(body_, ListNacosConfigsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListNacosConfigsResponseBody> body_ = nullptr;
  };
