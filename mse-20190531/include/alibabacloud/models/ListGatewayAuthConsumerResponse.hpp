...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayAuthConsumerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListGatewayAuthConsumerResponseBody) };
    inline ListGatewayAuthConsumerResponseBody getBody() { DARABONBA_PTR_GET(body_, ListGatewayAuthConsumerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListGatewayAuthConsumerResponseBody> body_ {};
  };
