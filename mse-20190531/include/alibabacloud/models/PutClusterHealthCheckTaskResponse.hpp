...
namespace Models
{
  ...
  public:
    ...
    inline const PutClusterHealthCheckTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutClusterHealthCheckTaskResponseBody) };
    inline PutClusterHealthCheckTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, PutClusterHealthCheckTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PutClusterHealthCheckTaskResponseBody> body_ {};
  };
