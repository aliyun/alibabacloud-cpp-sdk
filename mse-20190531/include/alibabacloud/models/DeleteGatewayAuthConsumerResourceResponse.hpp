...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGatewayAuthConsumerResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteGatewayAuthConsumerResourceResponseBody) };
    inline DeleteGatewayAuthConsumerResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteGatewayAuthConsumerResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteGatewayAuthConsumerResourceResponseBody> body_ {};
  };
