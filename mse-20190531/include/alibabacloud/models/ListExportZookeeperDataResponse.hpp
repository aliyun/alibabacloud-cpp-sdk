...
namespace Models
{
  ...
  public:
    ...
    inline const ListExportZookeeperDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExportZookeeperDataResponseBody) };
    inline ListExportZookeeperDataResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExportZookeeperDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExportZookeeperDataResponseBody> body_ {};
  };
