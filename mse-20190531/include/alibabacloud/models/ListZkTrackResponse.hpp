...
namespace Models
{
  ...
  public:
    ...
    inline const ListZkTrackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListZkTrackResponseBody) };
    inline ListZkTrackResponseBody getBody() { DARABONBA_PTR_GET(body_, ListZkTrackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListZkTrackResponseBody> body_ {};
  };
