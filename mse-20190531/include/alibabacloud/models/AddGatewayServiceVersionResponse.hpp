...
namespace Models
{
  ...
  public:
    ...
    inline const AddGatewayServiceVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddGatewayServiceVersionResponseBody) };
    inline AddGatewayServiceVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, AddGatewayServiceVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddGatewayServiceVersionResponseBody> body_ {};
  };
