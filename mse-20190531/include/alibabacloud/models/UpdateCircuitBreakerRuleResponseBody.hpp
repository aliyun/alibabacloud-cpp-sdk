...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCircuitBreakerRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateCircuitBreakerRuleResponseBodyData) };
    inline UpdateCircuitBreakerRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateCircuitBreakerRuleResponseBodyData) };
    inline UpdateCircuitBreakerRuleResponseBody& setData(const UpdateCircuitBreakerRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateCircuitBreakerRuleResponseBody& setData(UpdateCircuitBreakerRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateCircuitBreakerRuleResponseBodyData> data_ = nullptr;
