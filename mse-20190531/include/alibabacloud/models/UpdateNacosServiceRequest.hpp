...
#ifndef ALIBABACLOUD_MODELS_UPDATENACOSSERVICEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATENACOSSERVICEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateNacosServiceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateNacosServiceRequest& obj) { 
    ...
    UpdateNacosServiceRequest() = default ;
    UpdateNacosServiceRequest(const UpdateNacosServiceRequest &) = default ;
    UpdateNacosServiceRequest(UpdateNacosServiceRequest &&) = default ;
    UpdateNacosServiceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateNacosServiceRequest() = default ;
    UpdateNacosServiceRequest& operator=(const UpdateNacosServiceRequest &) = default ;
    UpdateNacosServiceRequest& operator=(UpdateNacosServiceRequest &&) = default ;
