...
#ifndef ALIBABACLOUD_MODELS_ADDSERVICESOURCEREQUESTINGRESSOPTIONSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDSERVICESOURCEREQUESTINGRESSOPTIONSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddServiceSourceRequestIngressOptionsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddServiceSourceRequestIngressOptionsRequest& obj) { 
    ...
    AddServiceSourceRequestIngressOptionsRequest() = default ;
    AddServiceSourceRequestIngressOptionsRequest(const AddServiceSourceRequestIngressOptionsRequest &) = default ;
    AddServiceSourceRequestIngressOptionsRequest(AddServiceSourceRequestIngressOptionsRequest &&) = default ;
    AddServiceSourceRequestIngressOptionsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddServiceSourceRequestIngressOptionsRequest() = default ;
    AddServiceSourceRequestIngressOptionsRequest& operator=(const AddServiceSourceRequestIngressOptionsRequest &) = default ;
    AddServiceSourceRequestIngressOptionsRequest& operator=(AddServiceSourceRequestIngressOptionsRequest &&) = default ;
    ...
    inline AddServiceSourceRequestIngressOptionsRequest& setEnableIngress(bool enableIngress) { DARABONBA_PTR_SET_VALUE(enableIngress_, enableIngress) };
    ...
    inline AddServiceSourceRequestIngressOptionsRequest& setEnableStatus(bool enableStatus) { DARABONBA_PTR_SET_VALUE(enableStatus_, enableStatus) };
    ...
    inline AddServiceSourceRequestIngressOptionsRequest& setIngressClass(string ingressClass) { DARABONBA_PTR_SET_VALUE(ingressClass_, ingressClass) };
    ...
    inline AddServiceSourceRequestIngressOptionsRequest& setWatchNamespace(string watchNamespace) { DARABONBA_PTR_SET_VALUE(watchNamespace_, watchNamespace) };
