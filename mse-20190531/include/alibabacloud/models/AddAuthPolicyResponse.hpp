...
namespace Models
{
  ...
  public:
    ...
    inline const AddAuthPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddAuthPolicyResponseBody) };
    inline AddAuthPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, AddAuthPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddAuthPolicyResponseBody> body_ {};
  };
