...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline       const Darabonba::Json & getContentMap() const { DARABONBA_GET(contentMap_) };
      Darabonba::Json & getContentMap() { DARABONBA_GET(contentMap_) };
      inline Data& setContentMap(const Darabonba::Json & contentMap) { DARABONBA_SET_VALUE(contentMap_, contentMap) };
      inline Data& setContentMap(Darabonba::Json && contentMap) { DARABONBA_SET_RVALUE(contentMap_, contentMap) };
    ...
    inline const ExportZookeeperDataResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ExportZookeeperDataResponseBody::Data) };
    inline ExportZookeeperDataResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ExportZookeeperDataResponseBody::Data) };
    inline ExportZookeeperDataResponseBody& setData(const ExportZookeeperDataResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ExportZookeeperDataResponseBody& setData(ExportZookeeperDataResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<ExportZookeeperDataResponseBody::Data> data_ {};
