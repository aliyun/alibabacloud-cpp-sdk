...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSecurityGroupResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListSecurityGroupResponseBodyData>) };
    inline vector<ListSecurityGroupResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListSecurityGroupResponseBodyData>) };
    inline ListSecurityGroupResponseBody& setData(const vector<ListSecurityGroupResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSecurityGroupResponseBody& setData(vector<ListSecurityGroupResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data structure.
    std::shared_ptr<vector<ListSecurityGroupResponseBodyData>> data_ = nullptr;
