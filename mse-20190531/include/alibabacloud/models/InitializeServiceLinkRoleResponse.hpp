...
namespace Models
{
  ...
  public:
    ...
    inline const InitializeServiceLinkRoleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InitializeServiceLinkRoleResponseBody) };
    inline InitializeServiceLinkRoleResponseBody getBody() { DARABONBA_PTR_GET(body_, InitializeServiceLinkRoleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InitializeServiceLinkRoleResponseBody> body_ {};
  };
