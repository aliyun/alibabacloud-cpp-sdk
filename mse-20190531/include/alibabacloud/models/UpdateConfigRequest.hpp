...
namespace Models
{
  ...
  public:
    ...
    inline string extendedTypesEnable() const { DARABONBA_PTR_GET_DEFAULT(extendedTypesEnable_, "") };
    ...
    inline string openSuperAcl() const { DARABONBA_PTR_GET_DEFAULT(openSuperAcl_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> extendedTypesEnable_ = nullptr;
    ...
    // *   `true`: enabled
    // *   `false`: disabled
    std::shared_ptr<string> openSuperAcl_ = nullptr;
