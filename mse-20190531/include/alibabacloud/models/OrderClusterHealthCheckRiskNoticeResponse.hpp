...
namespace Models
{
  ...
  public:
    ...
    inline const OrderClusterHealthCheckRiskNoticeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OrderClusterHealthCheckRiskNoticeResponseBody) };
    inline OrderClusterHealthCheckRiskNoticeResponseBody getBody() { DARABONBA_PTR_GET(body_, OrderClusterHealthCheckRiskNoticeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OrderClusterHealthCheckRiskNoticeResponseBody> body_ {};
  };
