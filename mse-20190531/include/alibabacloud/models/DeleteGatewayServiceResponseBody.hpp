...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGatewayServiceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeleteGatewayServiceResponseBodyData) };
    inline DeleteGatewayServiceResponseBodyData data() { DARABONBA_PTR_GET(data_, DeleteGatewayServiceResponseBodyData) };
    inline DeleteGatewayServiceResponseBody& setData(const DeleteGatewayServiceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteGatewayServiceResponseBody& setData(DeleteGatewayServiceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DeleteGatewayServiceResponseBodyData> data_ = nullptr;
