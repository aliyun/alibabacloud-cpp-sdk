...
namespace Models
{
  ...
  public:
    ...
    inline const vector<PullServicesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<PullServicesResponseBodyData>) };
    inline vector<PullServicesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<PullServicesResponseBodyData>) };
    inline PullServicesResponseBody& setData(const vector<PullServicesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PullServicesResponseBody& setData(vector<PullServicesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<vector<PullServicesResponseBodyData>> data_ = nullptr;
