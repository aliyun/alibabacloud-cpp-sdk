...
namespace Models
{
  ...
  public:
    ...
    inline const GetApplicationListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetApplicationListResponseBody) };
    inline GetApplicationListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetApplicationListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetApplicationListResponseBody> body_ {};
  };
