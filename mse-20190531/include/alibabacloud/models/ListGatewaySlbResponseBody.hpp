...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListGatewaySlbResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListGatewaySlbResponseBodyData>) };
    inline vector<ListGatewaySlbResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListGatewaySlbResponseBodyData>) };
    inline ListGatewaySlbResponseBody& setData(const vector<ListGatewaySlbResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGatewaySlbResponseBody& setData(vector<ListGatewaySlbResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListGatewaySlbResponseBodyData>> data_ = nullptr;
