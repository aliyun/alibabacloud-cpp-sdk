...
#ifndef ALIBABACLOUD_MODELS_CREATEGATEWAYCIRCUITBREAKERRULEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEGATEWAYCIRCUITBREAKERRULEREQUEST_HPP_
...
namespace Models
{
  class CreateGatewayCircuitBreakerRuleRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateGatewayCircuitBreakerRuleRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateGatewayCircuitBreakerRuleRequest& obj) { 
    ...
    CreateGatewayCircuitBreakerRuleRequest() = default ;
    CreateGatewayCircuitBreakerRuleRequest(const CreateGatewayCircuitBreakerRuleRequest &) = default ;
    CreateGatewayCircuitBreakerRuleRequest(CreateGatewayCircuitBreakerRuleRequest &&) = default ;
    CreateGatewayCircuitBreakerRuleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateGatewayCircuitBreakerRuleRequest() = default ;
    CreateGatewayCircuitBreakerRuleRequest& operator=(const CreateGatewayCircuitBreakerRuleRequest &) = default ;
    CreateGatewayCircuitBreakerRuleRequest& operator=(CreateGatewayCircuitBreakerRuleRequest &&) = default ;
