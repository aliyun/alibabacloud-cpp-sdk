...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->httpCode_ == nullptr && return this->message_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->requestId_ == nullptr
        && return this->success_ == nullptr && return this->totalCount_ == nullptr && return this->traces_ == nullptr; };
    ...
    inline const vector<ListZkTrackResponseBodyTraces> & traces() const { DARABONBA_PTR_GET_CONST(traces_, vector<ListZkTrackResponseBodyTraces>) };
    inline vector<ListZkTrackResponseBodyTraces> traces() { DARABONBA_PTR_GET(traces_, vector<ListZkTrackResponseBodyTraces>) };
    inline ListZkTrackResponseBody& setTraces(const vector<ListZkTrackResponseBodyTraces> & traces) { DARABONBA_PTR_SET_VALUE(traces_, traces) };
    inline ListZkTrackResponseBody& setTraces(vector<ListZkTrackResponseBodyTraces> && traces) { DARABONBA_PTR_SET_RVALUE(traces_, traces) };
  ...
  protected:
    ...
    // The track data.
    std::shared_ptr<vector<ListZkTrackResponseBodyTraces>> traces_ = nullptr;
  };
