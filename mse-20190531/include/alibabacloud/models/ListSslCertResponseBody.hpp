...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSSLCertResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListSSLCertResponseBodyData>) };
    inline vector<ListSSLCertResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListSSLCertResponseBodyData>) };
    inline ListSSLCertResponseBody& setData(const vector<ListSSLCertResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSSLCertResponseBody& setData(vector<ListSSLCertResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<vector<ListSSLCertResponseBodyData>> data_ = nullptr;
