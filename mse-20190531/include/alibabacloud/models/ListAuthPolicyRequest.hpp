...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->acceptLanguage_ != nullptr
        && this->appId_ != nullptr && this->name_ != nullptr && this->namespace_ != nullptr && this->pageNumber_ != nullptr && this->pageSize_ != nullptr
        && this->protocol_ != nullptr && this->region_ != nullptr && this->source_ != nullptr; };
