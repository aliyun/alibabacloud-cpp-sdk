...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayAuthConsumerResourceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListGatewayAuthConsumerResourceResponseBody) };
    inline ListGatewayAuthConsumerResourceResponseBody body() { DARABONBA_PTR_GET(body_, ListGatewayAuthConsumerResourceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListGatewayAuthConsumerResourceResponseBody> body_ = nullptr;
  };
