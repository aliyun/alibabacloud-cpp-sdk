...
namespace Models
{
  ...
  public:
    ...
    inline const InitializeServiceLinkRoleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, InitializeServiceLinkRoleResponseBodyData) };
    inline InitializeServiceLinkRoleResponseBodyData data() { DARABONBA_PTR_GET(data_, InitializeServiceLinkRoleResponseBodyData) };
    inline InitializeServiceLinkRoleResponseBody& setData(const InitializeServiceLinkRoleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline InitializeServiceLinkRoleResponseBody& setData(InitializeServiceLinkRoleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<InitializeServiceLinkRoleResponseBodyData> data_ = nullptr;
