...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListGatewayRouteOnAuthResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListGatewayRouteOnAuthResponseBodyData>) };
    inline vector<ListGatewayRouteOnAuthResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListGatewayRouteOnAuthResponseBodyData>) };
    inline ListGatewayRouteOnAuthResponseBody& setData(const vector<ListGatewayRouteOnAuthResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGatewayRouteOnAuthResponseBody& setData(vector<ListGatewayRouteOnAuthResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListGatewayRouteOnAuthResponseBodyData>> data_ = nullptr;
