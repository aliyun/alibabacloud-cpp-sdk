...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateNacosServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateNacosServiceResponseBody) };
    inline UpdateNacosServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateNacosServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateNacosServiceResponseBody> body_ {};
  };
