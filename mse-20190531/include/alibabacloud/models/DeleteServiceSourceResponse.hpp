...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteServiceSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteServiceSourceResponseBody) };
    inline DeleteServiceSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteServiceSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteServiceSourceResponseBody> body_ {};
  };
