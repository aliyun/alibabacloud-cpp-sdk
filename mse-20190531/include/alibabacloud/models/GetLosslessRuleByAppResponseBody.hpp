...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetLosslessRuleByAppResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetLosslessRuleByAppResponseBody& obj) { 
    ...
    GetLosslessRuleByAppResponseBody() = default ;
    GetLosslessRuleByAppResponseBody(const GetLosslessRuleByAppResponseBody &) = default ;
    GetLosslessRuleByAppResponseBody(GetLosslessRuleByAppResponseBody &&) = default ;
    GetLosslessRuleByAppResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetLosslessRuleByAppResponseBody() = default ;
    GetLosslessRuleByAppResponseBody& operator=(const GetLosslessRuleByAppResponseBody &) = default ;
    GetLosslessRuleByAppResponseBody& operator=(GetLosslessRuleByAppResponseBody &&) = default ;
