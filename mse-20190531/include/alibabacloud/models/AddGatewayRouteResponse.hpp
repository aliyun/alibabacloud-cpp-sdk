...
namespace Models
{
  ...
  public:
    ...
    inline const AddGatewayRouteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddGatewayRouteResponseBody) };
    inline AddGatewayRouteResponseBody getBody() { DARABONBA_PTR_GET(body_, AddGatewayRouteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddGatewayRouteResponseBody> body_ {};
  };
