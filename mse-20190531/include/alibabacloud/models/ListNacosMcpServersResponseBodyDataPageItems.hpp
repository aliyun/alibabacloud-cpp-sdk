...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->capabilities_ == nullptr
        && return this->description_ == nullptr && return this->frontProtocol_ == nullptr && return this->id_ == nullptr && return this->name_ == nullptr && return this->protocol_ == nullptr
        && return this->version_ == nullptr && return this->versionDetail_ == nullptr; };
