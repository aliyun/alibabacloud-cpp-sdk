...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMigrationTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateMigrationTaskResponseBodyData) };
    inline UpdateMigrationTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateMigrationTaskResponseBodyData) };
    inline UpdateMigrationTaskResponseBody& setData(const UpdateMigrationTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateMigrationTaskResponseBody& setData(UpdateMigrationTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data structure.
    std::shared_ptr<UpdateMigrationTaskResponseBodyData> data_ = nullptr;
