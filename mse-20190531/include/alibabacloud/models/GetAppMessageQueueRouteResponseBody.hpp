...
namespace Models
{
  ...
  public:
    ...
    inline const GetAppMessageQueueRouteResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAppMessageQueueRouteResponseBodyData) };
    inline GetAppMessageQueueRouteResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAppMessageQueueRouteResponseBodyData) };
    inline GetAppMessageQueueRouteResponseBody& setData(const GetAppMessageQueueRouteResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAppMessageQueueRouteResponseBody& setData(GetAppMessageQueueRouteResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetAppMessageQueueRouteResponseBodyData> data_ = nullptr;
