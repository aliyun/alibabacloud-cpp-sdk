...
#ifndef ALIBABACLOUD_MODELS_LISTGATEWAYCIRCUITBREAKERRULERESPONSEBODYDATARESULT_HPP_
#define ALIBABACLOUD_MODELS_LISTGATEWAYCIRCUITBREAKERRULERESPONSEBODYDATARESULT_HPP_
...
namespace Models
{
  class ListGatewayCircuitBreakerRuleResponseBodyDataResult : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListGatewayCircuitBreakerRuleResponseBodyDataResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListGatewayCircuitBreakerRuleResponseBodyDataResult& obj) { 
    ...
    ListGatewayCircuitBreakerRuleResponseBodyDataResult() = default ;
    ListGatewayCircuitBreakerRuleResponseBodyDataResult(const ListGatewayCircuitBreakerRuleResponseBodyDataResult &) = default ;
    ListGatewayCircuitBreakerRuleResponseBodyDataResult(ListGatewayCircuitBreakerRuleResponseBodyDataResult &&) = default ;
    ListGatewayCircuitBreakerRuleResponseBodyDataResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListGatewayCircuitBreakerRuleResponseBodyDataResult() = default ;
    ListGatewayCircuitBreakerRuleResponseBodyDataResult& operator=(const ListGatewayCircuitBreakerRuleResponseBodyDataResult &) = default ;
    ListGatewayCircuitBreakerRuleResponseBodyDataResult& operator=(ListGatewayCircuitBreakerRuleResponseBodyDataResult &&) = default ;
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setBehaviorType(int32_t behaviorType) { DARABONBA_PTR_SET_VALUE(behaviorType_, behaviorType) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setBodyEncoding(int32_t bodyEncoding) { DARABONBA_PTR_SET_VALUE(bodyEncoding_, bodyEncoding) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setEnable(int32_t enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setGatewayId(int64_t gatewayId) { DARABONBA_PTR_SET_VALUE(gatewayId_, gatewayId) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setGatewayUniqueId(string gatewayUniqueId) { DARABONBA_PTR_SET_VALUE(gatewayUniqueId_, gatewayUniqueId) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setIdList(const vector<int64_t> & idList) { DARABONBA_PTR_SET_VALUE(idList_, idList) };
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setIdList(vector<int64_t> && idList) { DARABONBA_PTR_SET_RVALUE(idList_, idList) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setLimitMode(int32_t limitMode) { DARABONBA_PTR_SET_VALUE(limitMode_, limitMode) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setMaxAllowedMs(int32_t maxAllowedMs) { DARABONBA_PTR_SET_VALUE(maxAllowedMs_, maxAllowedMs) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setMinRequestAmount(int32_t minRequestAmount) { DARABONBA_PTR_SET_VALUE(minRequestAmount_, minRequestAmount) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setRecoveryTimeoutSec(int32_t recoveryTimeoutSec) { DARABONBA_PTR_SET_VALUE(recoveryTimeoutSec_, recoveryTimeoutSec) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setResponseAdditionalHeaders(string responseAdditionalHeaders) { DARABONBA_PTR_SET_VALUE(responseAdditionalHeaders_, responseAdditionalHeaders) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setResponseContentBody(string responseContentBody) { DARABONBA_PTR_SET_VALUE(responseContentBody_, responseContentBody) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setResponseRedirectUrl(string responseRedirectUrl) { DARABONBA_PTR_SET_VALUE(responseRedirectUrl_, responseRedirectUrl) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setResponseStatusCode(int32_t responseStatusCode) { DARABONBA_PTR_SET_VALUE(responseStatusCode_, responseStatusCode) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setRouteId(int64_t routeId) { DARABONBA_PTR_SET_VALUE(routeId_, routeId) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setRouteName(string routeName) { DARABONBA_PTR_SET_VALUE(routeName_, routeName) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setStatDurationSec(int32_t statDurationSec) { DARABONBA_PTR_SET_VALUE(statDurationSec_, statDurationSec) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setStrategy(int32_t strategy) { DARABONBA_PTR_SET_VALUE(strategy_, strategy) };
    ...
    inline ListGatewayCircuitBreakerRuleResponseBodyDataResult& setTriggerRatio(int32_t triggerRatio) { DARABONBA_PTR_SET_VALUE(triggerRatio_, triggerRatio) };
