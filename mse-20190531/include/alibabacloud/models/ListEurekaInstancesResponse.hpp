...
namespace Models
{
  ...
  public:
    ...
    inline const ListEurekaInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListEurekaInstancesResponseBody) };
    inline ListEurekaInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListEurekaInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListEurekaInstancesResponseBody> body_ {};
  };
