...
namespace Models
{
  ...
  public:
    ...
    inline const ListSSLCertResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSSLCertResponseBody) };
    inline ListSSLCertResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSSLCertResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSSLCertResponseBody> body_ {};
  };
