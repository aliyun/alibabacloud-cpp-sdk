...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWebFlowRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWebFlowRulesResponseBody) };
    inline DeleteWebFlowRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWebFlowRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWebFlowRulesResponseBody> body_ {};
  };
