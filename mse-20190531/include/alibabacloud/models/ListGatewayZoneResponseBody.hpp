...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListGatewayZoneResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListGatewayZoneResponseBodyData>) };
    inline vector<ListGatewayZoneResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListGatewayZoneResponseBodyData>) };
    inline ListGatewayZoneResponseBody& setData(const vector<ListGatewayZoneResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGatewayZoneResponseBody& setData(vector<ListGatewayZoneResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The queried zones.
    std::shared_ptr<vector<ListGatewayZoneResponseBodyData>> data_ = nullptr;
