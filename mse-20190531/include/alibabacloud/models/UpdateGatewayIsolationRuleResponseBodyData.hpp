...
#ifndef ALIBABACLOUD_MODELS_UPDATEGATEWAYISOLATIONRULERESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_UPDATEGATEWAYISOLATIONRULERESPONSEBODYDATA_HPP_
...
namespace Models
{
  class UpdateGatewayIsolationRuleResponseBodyData : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateGatewayIsolationRuleResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateGatewayIsolationRuleResponseBodyData& obj) { 
    ...
    UpdateGatewayIsolationRuleResponseBodyData() = default ;
    UpdateGatewayIsolationRuleResponseBodyData(const UpdateGatewayIsolationRuleResponseBodyData &) = default ;
    UpdateGatewayIsolationRuleResponseBodyData(UpdateGatewayIsolationRuleResponseBodyData &&) = default ;
    UpdateGatewayIsolationRuleResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateGatewayIsolationRuleResponseBodyData() = default ;
    UpdateGatewayIsolationRuleResponseBodyData& operator=(const UpdateGatewayIsolationRuleResponseBodyData &) = default ;
    UpdateGatewayIsolationRuleResponseBodyData& operator=(UpdateGatewayIsolationRuleResponseBodyData &&) = default ;
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setBehaviorType(int32_t behaviorType) { DARABONBA_PTR_SET_VALUE(behaviorType_, behaviorType) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setBodyEncoding(int32_t bodyEncoding) { DARABONBA_PTR_SET_VALUE(bodyEncoding_, bodyEncoding) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setEnable(int32_t enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setGatewayId(int64_t gatewayId) { DARABONBA_PTR_SET_VALUE(gatewayId_, gatewayId) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setGatewayUniqueId(string gatewayUniqueId) { DARABONBA_PTR_SET_VALUE(gatewayUniqueId_, gatewayUniqueId) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setIdList(const vector<int64_t> & idList) { DARABONBA_PTR_SET_VALUE(idList_, idList) };
    inline UpdateGatewayIsolationRuleResponseBodyData& setIdList(vector<int64_t> && idList) { DARABONBA_PTR_SET_RVALUE(idList_, idList) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setLimitMode(int32_t limitMode) { DARABONBA_PTR_SET_VALUE(limitMode_, limitMode) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setMaxConcurrency(int32_t maxConcurrency) { DARABONBA_PTR_SET_VALUE(maxConcurrency_, maxConcurrency) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setResponseAdditionalHeaders(string responseAdditionalHeaders) { DARABONBA_PTR_SET_VALUE(responseAdditionalHeaders_, responseAdditionalHeaders) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setResponseContentBody(string responseContentBody) { DARABONBA_PTR_SET_VALUE(responseContentBody_, responseContentBody) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setResponseRedirectUrl(string responseRedirectUrl) { DARABONBA_PTR_SET_VALUE(responseRedirectUrl_, responseRedirectUrl) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setResponseStatusCode(int32_t responseStatusCode) { DARABONBA_PTR_SET_VALUE(responseStatusCode_, responseStatusCode) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setRouteId(int64_t routeId) { DARABONBA_PTR_SET_VALUE(routeId_, routeId) };
    ...
    inline UpdateGatewayIsolationRuleResponseBodyData& setRouteName(string routeName) { DARABONBA_PTR_SET_VALUE(routeName_, routeName) };
