...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSSLCertResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSSLCertResponseBody) };
    inline UpdateSSLCertResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateSSLCertResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateSSLCertResponseBody> body_ {};
  };
