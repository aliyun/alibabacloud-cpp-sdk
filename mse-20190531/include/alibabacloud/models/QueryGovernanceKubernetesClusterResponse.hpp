...
namespace Models
{
  ...
  public:
    ...
    inline const QueryGovernanceKubernetesClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryGovernanceKubernetesClusterResponseBody) };
    inline QueryGovernanceKubernetesClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryGovernanceKubernetesClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryGovernanceKubernetesClusterResponseBody> body_ {};
  };
