...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayAuthConsumerResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListGatewayAuthConsumerResponseBodyData) };
    inline ListGatewayAuthConsumerResponseBodyData data() { DARABONBA_PTR_GET(data_, ListGatewayAuthConsumerResponseBodyData) };
    inline ListGatewayAuthConsumerResponseBody& setData(const ListGatewayAuthConsumerResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGatewayAuthConsumerResponseBody& setData(ListGatewayAuthConsumerResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data structure.
    std::shared_ptr<ListGatewayAuthConsumerResponseBodyData> data_ = nullptr;
