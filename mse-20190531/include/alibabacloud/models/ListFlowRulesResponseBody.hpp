...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListFlowRulesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListFlowRulesResponseBody& obj) { 
    ...
    ListFlowRulesResponseBody() = default ;
    ListFlowRulesResponseBody(const ListFlowRulesResponseBody &) = default ;
    ListFlowRulesResponseBody(ListFlowRulesResponseBody &&) = default ;
    ListFlowRulesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListFlowRulesResponseBody() = default ;
    ListFlowRulesResponseBody& operator=(const ListFlowRulesResponseBody &) = default ;
    ListFlowRulesResponseBody& operator=(ListFlowRulesResponseBody &&) = default ;
