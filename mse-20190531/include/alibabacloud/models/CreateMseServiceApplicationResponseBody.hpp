...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMseServiceApplicationResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateMseServiceApplicationResponseBody::Data) };
    inline CreateMseServiceApplicationResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateMseServiceApplicationResponseBody::Data) };
    inline CreateMseServiceApplicationResponseBody& setData(const CreateMseServiceApplicationResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateMseServiceApplicationResponseBody& setData(CreateMseServiceApplicationResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data structure.
    shared_ptr<CreateMseServiceApplicationResponseBody::Data> data_ {};
