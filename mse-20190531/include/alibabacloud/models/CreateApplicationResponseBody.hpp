...
namespace Models
{
  ...
  public:
    ...
    inline CreateApplicationResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateApplicationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateApplicationResponseBodyData) };
    inline CreateApplicationResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateApplicationResponseBodyData) };
    inline CreateApplicationResponseBody& setData(const CreateApplicationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateApplicationResponseBody& setData(CreateApplicationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateApplicationResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateApplicationResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    std::shared_ptr<CreateApplicationResponseBodyData> data_ = nullptr;
