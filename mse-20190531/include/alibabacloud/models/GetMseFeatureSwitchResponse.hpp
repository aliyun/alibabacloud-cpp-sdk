...
namespace Models
{
  ...
  public:
    ...
    inline const GetMseFeatureSwitchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMseFeatureSwitchResponseBody) };
    inline GetMseFeatureSwitchResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMseFeatureSwitchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMseFeatureSwitchResponseBody> body_ {};
  };
