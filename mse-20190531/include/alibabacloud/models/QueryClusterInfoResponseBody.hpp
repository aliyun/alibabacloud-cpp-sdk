...
namespace Models
{
  ...
  public:
    ...
    inline const QueryClusterInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryClusterInfoResponseBodyData) };
    inline QueryClusterInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryClusterInfoResponseBodyData) };
    inline QueryClusterInfoResponseBody& setData(const QueryClusterInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryClusterInfoResponseBody& setData(QueryClusterInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryClusterInfoResponseBodyData> data_ = nullptr;
