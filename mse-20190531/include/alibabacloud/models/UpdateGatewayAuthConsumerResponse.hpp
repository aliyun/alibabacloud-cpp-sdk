...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGatewayAuthConsumerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateGatewayAuthConsumerResponseBody) };
    inline UpdateGatewayAuthConsumerResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateGatewayAuthConsumerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateGatewayAuthConsumerResponseBody> body_ {};
  };
