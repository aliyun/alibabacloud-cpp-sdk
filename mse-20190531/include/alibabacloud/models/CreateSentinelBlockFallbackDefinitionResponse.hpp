...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSentinelBlockFallbackDefinitionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSentinelBlockFallbackDefinitionResponseBody) };
    inline CreateSentinelBlockFallbackDefinitionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSentinelBlockFallbackDefinitionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSentinelBlockFallbackDefinitionResponseBody> body_ {};
  };
