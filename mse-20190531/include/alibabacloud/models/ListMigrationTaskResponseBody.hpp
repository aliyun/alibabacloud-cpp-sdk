...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListMigrationTaskResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListMigrationTaskResponseBody::Data>) };
    inline vector<ListMigrationTaskResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListMigrationTaskResponseBody::Data>) };
    inline ListMigrationTaskResponseBody& setData(const vector<ListMigrationTaskResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMigrationTaskResponseBody& setData(vector<ListMigrationTaskResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The array structure.
    shared_ptr<vector<ListMigrationTaskResponseBody::Data>> data_ {};
