...
namespace Models
{
  ...
  public:
    ...
    inline const GatewayOption & getGatewayOption() const { DARABONBA_PTR_GET_CONST(gatewayOption_, GatewayOption) };
    inline GatewayOption getGatewayOption() { DARABONBA_PTR_GET(gatewayOption_, GatewayOption) };
  ...
  protected:
    ...
    shared_ptr<GatewayOption> gatewayOption_ {};
