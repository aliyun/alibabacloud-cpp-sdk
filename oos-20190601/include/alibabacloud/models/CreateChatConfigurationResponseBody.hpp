...
#ifndef ALIBABACLOUD_MODELS_CREATECHATCONFIGURATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATECHATCONFIGURATIONRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateChatConfigurationResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateChatConfigurationResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(ChatConfiguration, chatConfiguration_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateChatConfigurationResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(ChatConfiguration, chatConfiguration_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    CreateChatConfigurationResponseBody() = default ;
    CreateChatConfigurationResponseBody(const CreateChatConfigurationResponseBody &) = default ;
    CreateChatConfigurationResponseBody(CreateChatConfigurationResponseBody &&) = default ;
    CreateChatConfigurationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateChatConfigurationResponseBody() = default ;
    CreateChatConfigurationResponseBody& operator=(const CreateChatConfigurationResponseBody &) = default ;
    CreateChatConfigurationResponseBody& operator=(CreateChatConfigurationResponseBody &&) = default ;
    ...
    inline const CreateChatConfigurationResponseBody::ChatConfiguration & getChatConfiguration() const { DARABONBA_PTR_GET_CONST(chatConfiguration_, CreateChatConfigurationResponseBody::ChatConfiguration) };
    inline CreateChatConfigurationResponseBody::ChatConfiguration getChatConfiguration() { DARABONBA_PTR_GET(chatConfiguration_, CreateChatConfigurationResponseBody::ChatConfiguration) };
    inline CreateChatConfigurationResponseBody& setChatConfiguration(const CreateChatConfigurationResponseBody::ChatConfiguration & chatConfiguration) { DARABONBA_PTR_SET_VALUE(chatConfiguration_, chatConfiguration) };
    inline CreateChatConfigurationResponseBody& setChatConfiguration(CreateChatConfigurationResponseBody::ChatConfiguration && chatConfiguration) { DARABONBA_PTR_SET_RVALUE(chatConfiguration_, chatConfiguration) };
    ...
    inline CreateChatConfigurationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<CreateChatConfigurationResponseBody::ChatConfiguration> chatConfiguration_ {};
