...
#ifndef ALIBABACLOUD_MODELS_GETPARAMETERRESPONSEBODYPARAMETER_HPP_
#define ALIBABACLOUD_MODELS_GETPARAMETERRESPONSEBODYPARAMETER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetParameterResponseBodyParameter& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetParameterResponseBodyParameter& obj) { 
    ...
    GetParameterResponseBodyParameter() = default ;
    GetParameterResponseBodyParameter(const GetParameterResponseBodyParameter &) = default ;
    GetParameterResponseBodyParameter(GetParameterResponseBodyParameter &&) = default ;
    GetParameterResponseBodyParameter(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetParameterResponseBodyParameter() = default ;
    GetParameterResponseBodyParameter& operator=(const GetParameterResponseBodyParameter &) = default ;
    GetParameterResponseBodyParameter& operator=(GetParameterResponseBodyParameter &&) = default ;
    ...
    inline GetParameterResponseBodyParameter& setConstraints(string constraints) { DARABONBA_PTR_SET_VALUE(constraints_, constraints) };
    ...
    inline GetParameterResponseBodyParameter& setCreatedBy(string createdBy) { DARABONBA_PTR_SET_VALUE(createdBy_, createdBy) };
    ...
    inline GetParameterResponseBodyParameter& setCreatedDate(string createdDate) { DARABONBA_PTR_SET_VALUE(createdDate_, createdDate) };
    ...
    inline GetParameterResponseBodyParameter& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline GetParameterResponseBodyParameter& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetParameterResponseBodyParameter& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetParameterResponseBodyParameter& setParameterVersion(int32_t parameterVersion) { DARABONBA_PTR_SET_VALUE(parameterVersion_, parameterVersion) };
    ...
    inline GetParameterResponseBodyParameter& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline GetParameterResponseBodyParameter& setShareType(string shareType) { DARABONBA_PTR_SET_VALUE(shareType_, shareType) };
    ...
    inline GetParameterResponseBodyParameter& setTags(const Darabonba::Json & tags) { DARABONBA_SET_VALUE(tags_, tags) };
    inline GetParameterResponseBodyParameter& setTags(Darabonba::Json & tags) { DARABONBA_SET_RVALUE(tags_, tags) };
    ...
    inline GetParameterResponseBodyParameter& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline GetParameterResponseBodyParameter& setUpdatedBy(string updatedBy) { DARABONBA_PTR_SET_VALUE(updatedBy_, updatedBy) };
    ...
    inline GetParameterResponseBodyParameter& setUpdatedDate(string updatedDate) { DARABONBA_PTR_SET_VALUE(updatedDate_, updatedDate) };
    ...
    inline GetParameterResponseBodyParameter& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
