...
namespace Models
{
  ...
  public:
    ...
    inline const ListGitAccountsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListGitAccountsResponseBody) };
    inline ListGitAccountsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListGitAccountsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListGitAccountsResponseBody> body_ {};
  };
