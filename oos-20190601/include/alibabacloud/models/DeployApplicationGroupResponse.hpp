...
namespace Models
{
  ...
  public:
    ...
    inline const DeployApplicationGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeployApplicationGroupResponseBody) };
    inline DeployApplicationGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeployApplicationGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeployApplicationGroupResponseBody> body_ {};
  };
