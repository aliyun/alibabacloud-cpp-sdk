...
#ifndef ALIBABACLOUD_MODELS_CHECKGITREPOFILEEXISTSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CHECKGITREPOFILEEXISTSREQUEST_HPP_
...
namespace Models
{
  class CheckGitRepoFileExistsRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CheckGitRepoFileExistsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CheckGitRepoFileExistsRequest& obj) { 
    ...
    CheckGitRepoFileExistsRequest() = default ;
    CheckGitRepoFileExistsRequest(const CheckGitRepoFileExistsRequest &) = default ;
    CheckGitRepoFileExistsRequest(CheckGitRepoFileExistsRequest &&) = default ;
    CheckGitRepoFileExistsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CheckGitRepoFileExistsRequest() = default ;
    CheckGitRepoFileExistsRequest& operator=(const CheckGitRepoFileExistsRequest &) = default ;
    CheckGitRepoFileExistsRequest& operator=(CheckGitRepoFileExistsRequest &&) = default ;
