...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountId_ == nullptr
        ...
        && this->mode_ == nullptr && this->nextToken_ == nullptr && this->parentExecutionId_ == nullptr && this->ramRole_ == nullptr && this->rdFolderIds_ == nullptr
        ...
        && this->sortOrder_ == nullptr && this->startDateAfter_ == nullptr && this->startDateBefore_ == nullptr && this->status_ == nullptr && this->tags_ == nullptr
        && this->templateName_ == nullptr; };
    // accountId Field Functions 
    bool hasAccountId() const { return this->accountId_ != nullptr;};
    void deleteAccountId() { this->accountId_ = nullptr;};
    inline string getAccountId() const { DARABONBA_PTR_GET_DEFAULT(accountId_, "") };
    inline ListExecutionsRequest& setAccountId(string accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline ListExecutionsRequest& setRdFolderIds(const vector<string> & rdFolderIds) { DARABONBA_PTR_SET_VALUE(rdFolderIds_, rdFolderIds) };
    inline ListExecutionsRequest& setRdFolderIds(vector<string> && rdFolderIds) { DARABONBA_PTR_SET_RVALUE(rdFolderIds_, rdFolderIds) };
