...
namespace Models
{
  ...
  public:
    ...
    inline const GetInventorySchemaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInventorySchemaResponseBody) };
    inline GetInventorySchemaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInventorySchemaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInventorySchemaResponseBody> body_ {};
  };
