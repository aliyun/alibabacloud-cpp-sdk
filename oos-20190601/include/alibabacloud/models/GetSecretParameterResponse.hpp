...
namespace Models
{
  ...
  public:
    ...
    inline const GetSecretParameterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSecretParameterResponseBody) };
    inline GetSecretParameterResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSecretParameterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSecretParameterResponseBody> body_ {};
  };
