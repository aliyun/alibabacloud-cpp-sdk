...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->attributes_ == nullptr
        && this->category_ == nullptr && this->createBy_ == nullptr && this->createDate_ == nullptr && this->description_ == nullptr && this->lastModifiedBy_ == nullptr
      ...
      inline OpsItem& setAttributes(const Darabonba::Json & attributes) { DARABONBA_SET_VALUE(attributes_, attributes) };
      inline OpsItem& setAttributes(Darabonba::Json && attributes) { DARABONBA_SET_RVALUE(attributes_, attributes) };
      ...
      inline string getCreateBy() const { DARABONBA_PTR_GET_DEFAULT(createBy_, "") };
      inline OpsItem& setCreateBy(string createBy) { DARABONBA_PTR_SET_VALUE(createBy_, createBy) };
      ...
      inline OpsItem& setResources(const vector<string> & resources) { DARABONBA_PTR_SET_VALUE(resources_, resources) };
      inline OpsItem& setResources(vector<string> && resources) { DARABONBA_PTR_SET_RVALUE(resources_, resources) };
      ...
      inline const vector<Darabonba::Json> & getSolutions() const { DARABONBA_PTR_GET_CONST(solutions_, vector<Darabonba::Json>) };
      inline vector<Darabonba::Json> getSolutions() { DARABONBA_PTR_GET(solutions_, vector<Darabonba::Json>) };
      inline OpsItem& setSolutions(const vector<Darabonba::Json> & solutions) { DARABONBA_PTR_SET_VALUE(solutions_, solutions) };
      inline OpsItem& setSolutions(vector<Darabonba::Json> && solutions) { DARABONBA_PTR_SET_RVALUE(solutions_, solutions) };
    ...
    protected:
      ...
      shared_ptr<vector<Darabonba::Json>> solutions_ {};
    ...
    inline const GetOpsItemResponseBody::OpsItem & getOpsItem() const { DARABONBA_PTR_GET_CONST(opsItem_, GetOpsItemResponseBody::OpsItem) };
    inline GetOpsItemResponseBody::OpsItem getOpsItem() { DARABONBA_PTR_GET(opsItem_, GetOpsItemResponseBody::OpsItem) };
    inline GetOpsItemResponseBody& setOpsItem(const GetOpsItemResponseBody::OpsItem & opsItem) { DARABONBA_PTR_SET_VALUE(opsItem_, opsItem) };
    inline GetOpsItemResponseBody& setOpsItem(GetOpsItemResponseBody::OpsItem && opsItem) { DARABONBA_PTR_SET_RVALUE(opsItem_, opsItem) };
  ...
  protected:
    ...
    shared_ptr<GetOpsItemResponseBody::OpsItem> opsItem_ {};
    // The request ID.
