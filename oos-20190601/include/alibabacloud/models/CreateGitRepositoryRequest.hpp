...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->isPrivate_ == nullptr && this->orgId_ == nullptr && this->owner_ == nullptr && this->platform_ == nullptr && this->regionId_ == nullptr
        && this->sourceRepoBranch_ == nullptr && this->sourceRepoName_ == nullptr && this->sourceRepoOwner_ == nullptr && this->targetRepoName_ == nullptr && this->targetRepoOwner_ == nullptr; };
    ...
    inline string getSourceRepoBranch() const { DARABONBA_PTR_GET_DEFAULT(sourceRepoBranch_, "") };
    ...
    inline string getSourceRepoOwner() const { DARABONBA_PTR_GET_DEFAULT(sourceRepoOwner_, "") };
    ...
    inline string getTargetRepoOwner() const { DARABONBA_PTR_GET_DEFAULT(targetRepoOwner_, "") };
  ...
  protected:
    ...
    shared_ptr<string> sourceRepoBranch_ {};
    shared_ptr<string> sourceRepoName_ {};
    shared_ptr<string> sourceRepoOwner_ {};
    shared_ptr<string> targetRepoName_ {};
    shared_ptr<string> targetRepoOwner_ {};
  };
