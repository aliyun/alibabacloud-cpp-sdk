...
namespace Models
{
  ...
  public:
    ...
    inline const ListTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTemplatesResponseBody) };
    inline ListTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTemplatesResponseBody> body_ {};
  };
