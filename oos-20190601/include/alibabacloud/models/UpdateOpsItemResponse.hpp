...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateOpsItemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateOpsItemResponseBody) };
    inline UpdateOpsItemResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateOpsItemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateOpsItemResponseBody> body_ {};
  };
