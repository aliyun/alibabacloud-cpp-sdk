...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && return this->nextToken_ == nullptr && return this->requestId_ == nullptr && return this->templateVersions_ == nullptr; };
    ...
    inline const vector<ListTemplateVersionsResponseBodyTemplateVersions> & templateVersions() const { DARABONBA_PTR_GET_CONST(templateVersions_, vector<ListTemplateVersionsResponseBodyTemplateVersions>) };
    inline vector<ListTemplateVersionsResponseBodyTemplateVersions> templateVersions() { DARABONBA_PTR_GET(templateVersions_, vector<ListTemplateVersionsResponseBodyTemplateVersions>) };
    inline ListTemplateVersionsResponseBody& setTemplateVersions(const vector<ListTemplateVersionsResponseBodyTemplateVersions> & templateVersions) { DARABONBA_PTR_SET_VALUE(templateVersions_, templateVersions) };
    inline ListTemplateVersionsResponseBody& setTemplateVersions(vector<ListTemplateVersionsResponseBodyTemplateVersions> && templateVersions) { DARABONBA_PTR_SET_RVALUE(templateVersions_, templateVersions) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListTemplateVersionsResponseBodyTemplateVersions>> templateVersions_ = nullptr;
  };
