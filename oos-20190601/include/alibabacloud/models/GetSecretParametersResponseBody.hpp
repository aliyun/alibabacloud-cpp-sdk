...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->constraints_ == nullptr
        ...
        && this->type_ == nullptr && this->updatedBy_ == nullptr && this->updatedDate_ == nullptr && this->value_ == nullptr; };
    ...
    inline const vector<string> & getInvalidParameters() const { DARABONBA_PTR_GET_CONST(invalidParameters_, vector<string>) };
    inline vector<string> getInvalidParameters() { DARABONBA_PTR_GET(invalidParameters_, vector<string>) };
    ...
    inline const vector<GetSecretParametersResponseBody::Parameters> & getParameters() const { DARABONBA_PTR_GET_CONST(parameters_, vector<GetSecretParametersResponseBody::Parameters>) };
    inline vector<GetSecretParametersResponseBody::Parameters> getParameters() { DARABONBA_PTR_GET(parameters_, vector<GetSecretParametersResponseBody::Parameters>) };
    inline GetSecretParametersResponseBody& setParameters(const vector<GetSecretParametersResponseBody::Parameters> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline GetSecretParametersResponseBody& setParameters(vector<GetSecretParametersResponseBody::Parameters> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> invalidParameters_ {};
    // The information about the encryption parameter.
    shared_ptr<vector<GetSecretParametersResponseBody::Parameters>> parameters_ {};
