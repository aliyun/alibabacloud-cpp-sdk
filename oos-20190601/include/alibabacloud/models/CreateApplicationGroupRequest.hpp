...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationName_ == nullptr
        && this->clientToken_ == nullptr && this->cmsGroupId_ == nullptr && this->deployRegionId_ == nullptr && this->description_ == nullptr && this->importTagKey_ == nullptr
        && this->importTagValue_ == nullptr && this->name_ == nullptr && this->regionId_ == nullptr; };
