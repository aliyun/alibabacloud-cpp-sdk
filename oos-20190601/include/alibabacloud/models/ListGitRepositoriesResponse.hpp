...
namespace Models
{
  ...
  public:
    ...
    inline const ListGitRepositoriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListGitRepositoriesResponseBody) };
    inline ListGitRepositoriesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListGitRepositoriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListGitRepositoriesResponseBody> body_ {};
  };
