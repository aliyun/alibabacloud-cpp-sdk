...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aggregator_ == nullptr
        && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->regionId_ == nullptr && this->typeName_ == nullptr; };
    ...
    inline bool getAggregator() const { DARABONBA_PTR_GET_DEFAULT(aggregator_, false) };
