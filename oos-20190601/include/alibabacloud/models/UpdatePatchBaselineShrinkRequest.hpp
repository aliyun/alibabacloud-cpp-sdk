...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->approvalRules_ == nullptr
        ...
        && this->regionId_ == nullptr && this->rejectedPatchesShrink_ == nullptr && this->rejectedPatchesAction_ == nullptr && this->resourceGroupId_ == nullptr && this->sourcesShrink_ == nullptr
