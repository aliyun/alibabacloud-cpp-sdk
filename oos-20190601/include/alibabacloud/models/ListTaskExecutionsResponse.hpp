...
namespace Models
{
  ...
  public:
    ...
    inline const ListTaskExecutionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTaskExecutionsResponseBody) };
    inline ListTaskExecutionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTaskExecutionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTaskExecutionsResponseBody> body_ {};
  };
