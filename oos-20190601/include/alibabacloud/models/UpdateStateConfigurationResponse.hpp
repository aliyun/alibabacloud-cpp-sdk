...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateStateConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateStateConfigurationResponseBody) };
    inline UpdateStateConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateStateConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateStateConfigurationResponseBody> body_ {};
  };
