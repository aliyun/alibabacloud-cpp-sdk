...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->constraints_ == nullptr
        ...
        && this->tags_ == nullptr && this->type_ == nullptr && this->updatedBy_ == nullptr && this->updatedDate_ == nullptr; };
    ...
    inline const CreateSecretParameterResponseBody::Parameter & getParameter() const { DARABONBA_PTR_GET_CONST(parameter_, CreateSecretParameterResponseBody::Parameter) };
    inline CreateSecretParameterResponseBody::Parameter getParameter() { DARABONBA_PTR_GET(parameter_, CreateSecretParameterResponseBody::Parameter) };
    inline CreateSecretParameterResponseBody& setParameter(const CreateSecretParameterResponseBody::Parameter & parameter) { DARABONBA_PTR_SET_VALUE(parameter_, parameter) };
    inline CreateSecretParameterResponseBody& setParameter(CreateSecretParameterResponseBody::Parameter && parameter) { DARABONBA_PTR_SET_RVALUE(parameter_, parameter) };
  ...
  protected:
    ...
    shared_ptr<CreateSecretParameterResponseBody::Parameter> parameter_ {};
