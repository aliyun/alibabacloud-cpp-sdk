...
namespace Models
{
  ...
  public:
    ...
    inline const ListSecretParameterVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSecretParameterVersionsResponseBody) };
    inline ListSecretParameterVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSecretParameterVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSecretParameterVersionsResponseBody> body_ {};
  };
