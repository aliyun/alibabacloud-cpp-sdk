...
namespace Models
{
  ...
  public:
    ...
    inline const ListExecutionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExecutionsResponseBody) };
    inline ListExecutionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExecutionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExecutionsResponseBody> body_ {};
  };
