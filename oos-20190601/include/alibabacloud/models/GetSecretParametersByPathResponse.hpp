...
namespace Models
{
  ...
  public:
    ...
    inline const GetSecretParametersByPathResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSecretParametersByPathResponseBody) };
    inline GetSecretParametersByPathResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSecretParametersByPathResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSecretParametersByPathResponseBody> body_ {};
  };
