...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSecretParameterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSecretParameterResponseBody) };
    inline DeleteSecretParameterResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSecretParameterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSecretParameterResponseBody> body_ {};
  };
