...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->configurationId_ == nullptr && this->data_ == nullptr && this->dataSource_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline string getConfigurationId() const { DARABONBA_PTR_GET_DEFAULT(configurationId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> configurationId_ {};
