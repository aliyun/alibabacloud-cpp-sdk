...
namespace Models
{
  ...
  public:
    ...
    inline const SearchInventoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchInventoryResponseBody) };
    inline SearchInventoryResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchInventoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchInventoryResponseBody> body_ {};
  };
