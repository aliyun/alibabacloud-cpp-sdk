...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline StateConfiguration& setParameters(string parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
      ...
      inline StateConfiguration& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline const vector<UpdateStateConfigurationResponseBody::StateConfiguration> & getStateConfiguration() const { DARABONBA_PTR_GET_CONST(stateConfiguration_, vector<UpdateStateConfigurationResponseBody::StateConfiguration>) };
    inline vector<UpdateStateConfigurationResponseBody::StateConfiguration> getStateConfiguration() { DARABONBA_PTR_GET(stateConfiguration_, vector<UpdateStateConfigurationResponseBody::StateConfiguration>) };
    inline UpdateStateConfigurationResponseBody& setStateConfiguration(const vector<UpdateStateConfigurationResponseBody::StateConfiguration> & stateConfiguration) { DARABONBA_PTR_SET_VALUE(stateConfiguration_, stateConfiguration) };
    inline UpdateStateConfigurationResponseBody& setStateConfiguration(vector<UpdateStateConfigurationResponseBody::StateConfiguration> && stateConfiguration) { DARABONBA_PTR_SET_RVALUE(stateConfiguration_, stateConfiguration) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateStateConfigurationResponseBody::StateConfiguration>> stateConfiguration_ {};
  };
