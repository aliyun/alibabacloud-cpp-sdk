...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->filter_ == nullptr
        && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->regionId_ == nullptr && this->resourceTagsShrink_ == nullptr && this->tagsShrink_ == nullptr; };
    // filter Field Functions 
    bool hasFilter() const { return this->filter_ != nullptr;};
    void deleteFilter() { this->filter_ = nullptr;};
    inline const vector<ListOpsItemsShrinkRequest::Filter> & getFilter() const { DARABONBA_PTR_GET_CONST(filter_, vector<ListOpsItemsShrinkRequest::Filter>) };
    inline vector<ListOpsItemsShrinkRequest::Filter> getFilter() { DARABONBA_PTR_GET(filter_, vector<ListOpsItemsShrinkRequest::Filter>) };
    inline ListOpsItemsShrinkRequest& setFilter(const vector<ListOpsItemsShrinkRequest::Filter> & filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    inline ListOpsItemsShrinkRequest& setFilter(vector<ListOpsItemsShrinkRequest::Filter> && filter) { DARABONBA_PTR_SET_RVALUE(filter_, filter) };
  ...
  protected:
    ...
    shared_ptr<vector<ListOpsItemsShrinkRequest::Filter>> filter_ {};
