...
#ifndef ALIBABACLOUD_MODELS_UPDATEAPPLICATIONREQUESTALARMCONFIG_HPP_
#define ALIBABACLOUD_MODELS_UPDATEAPPLICATIONREQUESTALARMCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateApplicationRequestAlarmConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateApplicationRequestAlarmConfig& obj) { 
    ...
    UpdateApplicationRequestAlarmConfig() = default ;
    UpdateApplicationRequestAlarmConfig(const UpdateApplicationRequestAlarmConfig &) = default ;
    UpdateApplicationRequestAlarmConfig(UpdateApplicationRequestAlarmConfig &&) = default ;
    UpdateApplicationRequestAlarmConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateApplicationRequestAlarmConfig() = default ;
    UpdateApplicationRequestAlarmConfig& operator=(const UpdateApplicationRequestAlarmConfig &) = default ;
    UpdateApplicationRequestAlarmConfig& operator=(UpdateApplicationRequestAlarmConfig &&) = default ;
    ...
    inline UpdateApplicationRequestAlarmConfig& setContactGroups(const vector<string> & contactGroups) { DARABONBA_PTR_SET_VALUE(contactGroups_, contactGroups) };
    inline UpdateApplicationRequestAlarmConfig& setContactGroups(vector<string> && contactGroups) { DARABONBA_PTR_SET_RVALUE(contactGroups_, contactGroups) };
    ...
    inline UpdateApplicationRequestAlarmConfig& setHealthCheckUrl(string healthCheckUrl) { DARABONBA_PTR_SET_VALUE(healthCheckUrl_, healthCheckUrl) };
    ...
    inline UpdateApplicationRequestAlarmConfig& setTemplateIds(const vector<string> & templateIds) { DARABONBA_PTR_SET_VALUE(templateIds_, templateIds) };
    inline UpdateApplicationRequestAlarmConfig& setTemplateIds(vector<string> && templateIds) { DARABONBA_PTR_SET_RVALUE(templateIds_, templateIds) };
