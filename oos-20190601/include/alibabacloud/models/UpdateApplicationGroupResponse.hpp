...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateApplicationGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateApplicationGroupResponseBody) };
    inline UpdateApplicationGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateApplicationGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateApplicationGroupResponseBody> body_ {};
  };
