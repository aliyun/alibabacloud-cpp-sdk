...
namespace Models
{
  ...
  public:
    ...
    inline const CancelExecutionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelExecutionResponseBody) };
    inline CancelExecutionResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelExecutionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelExecutionResponseBody> body_ {};
  };
