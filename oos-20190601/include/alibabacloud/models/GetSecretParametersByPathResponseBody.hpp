...
#ifndef ALIBABACLOUD_MODELS_GETSECRETPARAMETERSBYPATHRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETSECRETPARAMETERSBYPATHRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSecretParametersByPathResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSecretParametersByPathResponseBody& obj) { 
    ...
    GetSecretParametersByPathResponseBody() = default ;
    GetSecretParametersByPathResponseBody(const GetSecretParametersByPathResponseBody &) = default ;
    GetSecretParametersByPathResponseBody(GetSecretParametersByPathResponseBody &&) = default ;
    GetSecretParametersByPathResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSecretParametersByPathResponseBody() = default ;
    GetSecretParametersByPathResponseBody& operator=(const GetSecretParametersByPathResponseBody &) = default ;
    GetSecretParametersByPathResponseBody& operator=(GetSecretParametersByPathResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->constraints_ == nullptr
        ...
        && this->name_ == nullptr && this->parameterVersion_ == nullptr && this->shareType_ == nullptr && this->type_ == nullptr && this->updatedBy_ == nullptr
    ...
    inline GetSecretParametersByPathResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline GetSecretParametersByPathResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };


    // parameters Field Functions 
    bool hasParameters() const { return this->parameters_ != nullptr;};
    void deleteParameters() { this->parameters_ = nullptr;};
    inline const vector<GetSecretParametersByPathResponseBody::Parameters> & getParameters() const { DARABONBA_PTR_GET_CONST(parameters_, vector<GetSecretParametersByPathResponseBody::Parameters>) };
    inline vector<GetSecretParametersByPathResponseBody::Parameters> getParameters() { DARABONBA_PTR_GET(parameters_, vector<GetSecretParametersByPathResponseBody::Parameters>) };
    inline GetSecretParametersByPathResponseBody& setParameters(const vector<GetSecretParametersByPathResponseBody::Parameters> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline GetSecretParametersByPathResponseBody& setParameters(vector<GetSecretParametersByPathResponseBody::Parameters> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
    ...
    inline GetSecretParametersByPathResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetSecretParametersByPathResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
  ...
  protected:
    ...
    shared_ptr<vector<GetSecretParametersByPathResponseBody::Parameters>> parameters_ {};
    // The request ID.
