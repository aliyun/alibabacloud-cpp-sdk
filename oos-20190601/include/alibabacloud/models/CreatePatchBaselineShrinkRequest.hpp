...
#ifndef ALIBABACLOUD_MODELS_CREATEPATCHBASELINESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEPATCHBASELINESHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePatchBaselineShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePatchBaselineShrinkRequest& obj) { 
    ...
    CreatePatchBaselineShrinkRequest() = default ;
    CreatePatchBaselineShrinkRequest(const CreatePatchBaselineShrinkRequest &) = default ;
    CreatePatchBaselineShrinkRequest(CreatePatchBaselineShrinkRequest &&) = default ;
    CreatePatchBaselineShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePatchBaselineShrinkRequest() = default ;
    CreatePatchBaselineShrinkRequest& operator=(const CreatePatchBaselineShrinkRequest &) = default ;
    CreatePatchBaselineShrinkRequest& operator=(CreatePatchBaselineShrinkRequest &&) = default ;
