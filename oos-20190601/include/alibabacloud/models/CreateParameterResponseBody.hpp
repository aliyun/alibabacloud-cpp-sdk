...
namespace Models
{
  ...
  public:
    ...
    inline const CreateParameterResponseBody::Parameter & getParameter() const { DARABONBA_PTR_GET_CONST(parameter_, CreateParameterResponseBody::Parameter) };
    inline CreateParameterResponseBody::Parameter getParameter() { DARABONBA_PTR_GET(parameter_, CreateParameterResponseBody::Parameter) };
    inline CreateParameterResponseBody& setParameter(const CreateParameterResponseBody::Parameter & parameter) { DARABONBA_PTR_SET_VALUE(parameter_, parameter) };
    inline CreateParameterResponseBody& setParameter(CreateParameterResponseBody::Parameter && parameter) { DARABONBA_PTR_SET_RVALUE(parameter_, parameter) };
  ...
  protected:
    ...
    shared_ptr<CreateParameterResponseBody::Parameter> parameter_ {};
