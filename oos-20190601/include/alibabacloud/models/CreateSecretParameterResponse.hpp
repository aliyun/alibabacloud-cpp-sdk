...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSecretParameterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSecretParameterResponseBody) };
    inline CreateSecretParameterResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSecretParameterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSecretParameterResponseBody> body_ {};
  };
