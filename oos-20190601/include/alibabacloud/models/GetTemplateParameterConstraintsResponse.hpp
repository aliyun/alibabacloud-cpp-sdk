...
namespace Models
{
  ...
  public:
    ...
    inline const GetTemplateParameterConstraintsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTemplateParameterConstraintsResponseBody) };
    inline GetTemplateParameterConstraintsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTemplateParameterConstraintsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTemplateParameterConstraintsResponseBody> body_ {};
  };
