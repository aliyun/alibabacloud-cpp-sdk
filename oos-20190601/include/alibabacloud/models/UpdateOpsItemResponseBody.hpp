...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<string> & getSolutions() const { DARABONBA_PTR_GET_CONST(solutions_, vector<string>) };
      inline vector<string> getSolutions() { DARABONBA_PTR_GET(solutions_, vector<string>) };
      inline OpsItem& setSolutions(const vector<string> & solutions) { DARABONBA_PTR_SET_VALUE(solutions_, solutions) };
      inline OpsItem& setSolutions(vector<string> && solutions) { DARABONBA_PTR_SET_RVALUE(solutions_, solutions) };
    ...
    protected:
      ...
      // The solutions.
      shared_ptr<vector<string>> solutions_ {};
      // The source business.
    ...
    inline const UpdateOpsItemResponseBody::OpsItem & getOpsItem() const { DARABONBA_PTR_GET_CONST(opsItem_, UpdateOpsItemResponseBody::OpsItem) };
    inline UpdateOpsItemResponseBody::OpsItem getOpsItem() { DARABONBA_PTR_GET(opsItem_, UpdateOpsItemResponseBody::OpsItem) };
    inline UpdateOpsItemResponseBody& setOpsItem(const UpdateOpsItemResponseBody::OpsItem & opsItem) { DARABONBA_PTR_SET_VALUE(opsItem_, opsItem) };
    inline UpdateOpsItemResponseBody& setOpsItem(UpdateOpsItemResponseBody::OpsItem && opsItem) { DARABONBA_PTR_SET_RVALUE(opsItem_, opsItem) };
  ...
  protected:
    ...
    shared_ptr<UpdateOpsItemResponseBody::OpsItem> opsItem_ {};
    // The request ID.
