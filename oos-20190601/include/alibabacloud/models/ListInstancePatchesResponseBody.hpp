...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && return this->nextToken_ == nullptr && return this->patches_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const vector<ListInstancePatchesResponseBodyPatches> & patches() const { DARABONBA_PTR_GET_CONST(patches_, vector<ListInstancePatchesResponseBodyPatches>) };
    inline vector<ListInstancePatchesResponseBodyPatches> patches() { DARABONBA_PTR_GET(patches_, vector<ListInstancePatchesResponseBodyPatches>) };
    inline ListInstancePatchesResponseBody& setPatches(const vector<ListInstancePatchesResponseBodyPatches> & patches) { DARABONBA_PTR_SET_VALUE(patches_, patches) };
    inline ListInstancePatchesResponseBody& setPatches(vector<ListInstancePatchesResponseBodyPatches> && patches) { DARABONBA_PTR_SET_RVALUE(patches_, patches) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListInstancePatchesResponseBodyPatches>> patches_ = nullptr;
