...
namespace Models
{
  ...
  public:
    ...
    inline const GetApplicationGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetApplicationGroupResponseBody) };
    inline GetApplicationGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetApplicationGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetApplicationGroupResponseBody> body_ {};
  };
