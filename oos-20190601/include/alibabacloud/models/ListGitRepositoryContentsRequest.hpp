...
#ifndef ALIBABACLOUD_MODELS_LISTGITREPOSITORYCONTENTSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTGITREPOSITORYCONTENTSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListGitRepositoryContentsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListGitRepositoryContentsRequest& obj) { 
    ...
    ListGitRepositoryContentsRequest() = default ;
    ListGitRepositoryContentsRequest(const ListGitRepositoryContentsRequest &) = default ;
    ListGitRepositoryContentsRequest(ListGitRepositoryContentsRequest &&) = default ;
    ListGitRepositoryContentsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListGitRepositoryContentsRequest() = default ;
    ListGitRepositoryContentsRequest& operator=(const ListGitRepositoryContentsRequest &) = default ;
    ListGitRepositoryContentsRequest& operator=(ListGitRepositoryContentsRequest &&) = default ;
