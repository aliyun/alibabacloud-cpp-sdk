...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetParametersResponseBody::Parameters> & getParameters() const { DARABONBA_PTR_GET_CONST(parameters_, vector<GetParametersResponseBody::Parameters>) };
    inline vector<GetParametersResponseBody::Parameters> getParameters() { DARABONBA_PTR_GET(parameters_, vector<GetParametersResponseBody::Parameters>) };
    inline GetParametersResponseBody& setParameters(const vector<GetParametersResponseBody::Parameters> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline GetParametersResponseBody& setParameters(vector<GetParametersResponseBody::Parameters> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
  ...
  protected:
    ...
    shared_ptr<vector<GetParametersResponseBody::Parameters>> parameters_ {};
    // The request ID.
