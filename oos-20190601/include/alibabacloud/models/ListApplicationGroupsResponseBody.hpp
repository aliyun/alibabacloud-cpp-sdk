...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListApplicationGroupsResponseBodyApplicationGroups> & applicationGroups() const { DARABONBA_PTR_GET_CONST(applicationGroups_, vector<ListApplicationGroupsResponseBodyApplicationGroups>) };
    inline vector<ListApplicationGroupsResponseBodyApplicationGroups> applicationGroups() { DARABONBA_PTR_GET(applicationGroups_, vector<ListApplicationGroupsResponseBodyApplicationGroups>) };
    inline ListApplicationGroupsResponseBody& setApplicationGroups(const vector<ListApplicationGroupsResponseBodyApplicationGroups> & applicationGroups) { DARABONBA_PTR_SET_VALUE(applicationGroups_, applicationGroups) };
    inline ListApplicationGroupsResponseBody& setApplicationGroups(vector<ListApplicationGroupsResponseBodyApplicationGroups> && applicationGroups) { DARABONBA_PTR_SET_RVALUE(applicationGroups_, applicationGroups) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListApplicationGroupsResponseBodyApplicationGroups>> applicationGroups_ = nullptr;
