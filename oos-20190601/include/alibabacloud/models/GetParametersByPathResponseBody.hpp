...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetParametersByPathResponseBodyParameters> & parameters() const { DARABONBA_PTR_GET_CONST(parameters_, vector<GetParametersByPathResponseBodyParameters>) };
    inline vector<GetParametersByPathResponseBodyParameters> parameters() { DARABONBA_PTR_GET(parameters_, vector<GetParametersByPathResponseBodyParameters>) };
    inline GetParametersByPathResponseBody& setParameters(const vector<GetParametersByPathResponseBodyParameters> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline GetParametersByPathResponseBody& setParameters(vector<GetParametersByPathResponseBodyParameters> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetParametersByPathResponseBodyParameters>> parameters_ = nullptr;
