...
#ifndef ALIBABACLOUD_MODELS_SETSERVICESETTINGSRESPONSEBODYSERVICESETTINGS_HPP_
#define ALIBABACLOUD_MODELS_SETSERVICESETTINGSRESPONSEBODYSERVICESETTINGS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SetServiceSettingsResponseBodyServiceSettings& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SetServiceSettingsResponseBodyServiceSettings& obj) { 
    ...
    SetServiceSettingsResponseBodyServiceSettings() = default ;
    SetServiceSettingsResponseBodyServiceSettings(const SetServiceSettingsResponseBodyServiceSettings &) = default ;
    SetServiceSettingsResponseBodyServiceSettings(SetServiceSettingsResponseBodyServiceSettings &&) = default ;
    SetServiceSettingsResponseBodyServiceSettings(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SetServiceSettingsResponseBodyServiceSettings() = default ;
    SetServiceSettingsResponseBodyServiceSettings& operator=(const SetServiceSettingsResponseBodyServiceSettings &) = default ;
    SetServiceSettingsResponseBodyServiceSettings& operator=(SetServiceSettingsResponseBodyServiceSettings &&) = default ;
    ...
    inline SetServiceSettingsResponseBodyServiceSettings& setDeliveryOssBucketName(string deliveryOssBucketName) { DARABONBA_PTR_SET_VALUE(deliveryOssBucketName_, deliveryOssBucketName) };
    ...
    inline SetServiceSettingsResponseBodyServiceSettings& setDeliveryOssEnabled(bool deliveryOssEnabled) { DARABONBA_PTR_SET_VALUE(deliveryOssEnabled_, deliveryOssEnabled) };
    ...
    inline SetServiceSettingsResponseBodyServiceSettings& setDeliveryOssKeyPrefix(string deliveryOssKeyPrefix) { DARABONBA_PTR_SET_VALUE(deliveryOssKeyPrefix_, deliveryOssKeyPrefix) };
    ...
    inline SetServiceSettingsResponseBodyServiceSettings& setDeliverySlsEnabled(bool deliverySlsEnabled) { DARABONBA_PTR_SET_VALUE(deliverySlsEnabled_, deliverySlsEnabled) };
    ...
    inline SetServiceSettingsResponseBodyServiceSettings& setDeliverySlsProjectName(string deliverySlsProjectName) { DARABONBA_PTR_SET_VALUE(deliverySlsProjectName_, deliverySlsProjectName) };
    ...
    inline SetServiceSettingsResponseBodyServiceSettings& setRdcEnterpriseId(string rdcEnterpriseId) { DARABONBA_PTR_SET_VALUE(rdcEnterpriseId_, rdcEnterpriseId) };
