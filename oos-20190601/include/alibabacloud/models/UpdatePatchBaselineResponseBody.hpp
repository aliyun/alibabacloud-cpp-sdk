...
#ifndef ALIBABACLOUD_MODELS_UPDATEPATCHBASELINERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPATCHBASELINERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdatePatchBaselineResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(PatchBaseline, patchBaseline_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdatePatchBaselineResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(PatchBaseline, patchBaseline_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    UpdatePatchBaselineResponseBody() = default ;
    UpdatePatchBaselineResponseBody(const UpdatePatchBaselineResponseBody &) = default ;
    UpdatePatchBaselineResponseBody(UpdatePatchBaselineResponseBody &&) = default ;
    UpdatePatchBaselineResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdatePatchBaselineResponseBody() = default ;
    UpdatePatchBaselineResponseBody& operator=(const UpdatePatchBaselineResponseBody &) = default ;
    UpdatePatchBaselineResponseBody& operator=(UpdatePatchBaselineResponseBody &&) = default ;
    ...
    inline const UpdatePatchBaselineResponseBody::PatchBaseline & getPatchBaseline() const { DARABONBA_PTR_GET_CONST(patchBaseline_, UpdatePatchBaselineResponseBody::PatchBaseline) };
    inline UpdatePatchBaselineResponseBody::PatchBaseline getPatchBaseline() { DARABONBA_PTR_GET(patchBaseline_, UpdatePatchBaselineResponseBody::PatchBaseline) };
    inline UpdatePatchBaselineResponseBody& setPatchBaseline(const UpdatePatchBaselineResponseBody::PatchBaseline & patchBaseline) { DARABONBA_PTR_SET_VALUE(patchBaseline_, patchBaseline) };
    inline UpdatePatchBaselineResponseBody& setPatchBaseline(UpdatePatchBaselineResponseBody::PatchBaseline && patchBaseline) { DARABONBA_PTR_SET_RVALUE(patchBaseline_, patchBaseline) };
    ...
    inline UpdatePatchBaselineResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the patch baseline.
    shared_ptr<UpdatePatchBaselineResponseBody::PatchBaseline> patchBaseline_ {};
