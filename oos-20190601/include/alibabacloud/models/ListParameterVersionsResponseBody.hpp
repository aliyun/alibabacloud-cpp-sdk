...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListParameterVersionsResponseBodyParameterVersions> & parameterVersions() const { DARABONBA_PTR_GET_CONST(parameterVersions_, vector<ListParameterVersionsResponseBodyParameterVersions>) };
    inline vector<ListParameterVersionsResponseBodyParameterVersions> parameterVersions() { DARABONBA_PTR_GET(parameterVersions_, vector<ListParameterVersionsResponseBodyParameterVersions>) };
    inline ListParameterVersionsResponseBody& setParameterVersions(const vector<ListParameterVersionsResponseBodyParameterVersions> & parameterVersions) { DARABONBA_PTR_SET_VALUE(parameterVersions_, parameterVersions) };
    inline ListParameterVersionsResponseBody& setParameterVersions(vector<ListParameterVersionsResponseBodyParameterVersions> && parameterVersions) { DARABONBA_PTR_SET_RVALUE(parameterVersions_, parameterVersions) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListParameterVersionsResponseBodyParameterVersions>> parameterVersions_ = nullptr;
    // The request ID.
