...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateTemplateContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ValidateTemplateContentResponseBody) };
    inline ValidateTemplateContentResponseBody getBody() { DARABONBA_PTR_GET(body_, ValidateTemplateContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ValidateTemplateContentResponseBody> body_ {};
  };
