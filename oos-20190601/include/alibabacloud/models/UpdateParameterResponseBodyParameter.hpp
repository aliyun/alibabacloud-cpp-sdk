...
#ifndef ALIBABACLOUD_MODELS_UPDATEPARAMETERRESPONSEBODYPARAMETER_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPARAMETERRESPONSEBODYPARAMETER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateParameterResponseBodyParameter& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateParameterResponseBodyParameter& obj) { 
    ...
    UpdateParameterResponseBodyParameter() = default ;
    UpdateParameterResponseBodyParameter(const UpdateParameterResponseBodyParameter &) = default ;
    UpdateParameterResponseBodyParameter(UpdateParameterResponseBodyParameter &&) = default ;
    UpdateParameterResponseBodyParameter(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateParameterResponseBodyParameter() = default ;
    UpdateParameterResponseBodyParameter& operator=(const UpdateParameterResponseBodyParameter &) = default ;
    UpdateParameterResponseBodyParameter& operator=(UpdateParameterResponseBodyParameter &&) = default ;
    ...
    inline UpdateParameterResponseBodyParameter& setConstraints(string constraints) { DARABONBA_PTR_SET_VALUE(constraints_, constraints) };
    ...
    inline UpdateParameterResponseBodyParameter& setCreatedBy(string createdBy) { DARABONBA_PTR_SET_VALUE(createdBy_, createdBy) };
    ...
    inline UpdateParameterResponseBodyParameter& setCreatedDate(string createdDate) { DARABONBA_PTR_SET_VALUE(createdDate_, createdDate) };
    ...
    inline UpdateParameterResponseBodyParameter& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateParameterResponseBodyParameter& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UpdateParameterResponseBodyParameter& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline UpdateParameterResponseBodyParameter& setParameterVersion(int32_t parameterVersion) { DARABONBA_PTR_SET_VALUE(parameterVersion_, parameterVersion) };
    ...
    inline UpdateParameterResponseBodyParameter& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline UpdateParameterResponseBodyParameter& setShareType(string shareType) { DARABONBA_PTR_SET_VALUE(shareType_, shareType) };
    ...
    inline UpdateParameterResponseBodyParameter& setTags(string tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    ...
    inline UpdateParameterResponseBodyParameter& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline UpdateParameterResponseBodyParameter& setUpdatedBy(string updatedBy) { DARABONBA_PTR_SET_VALUE(updatedBy_, updatedBy) };
    ...
    inline UpdateParameterResponseBodyParameter& setUpdatedDate(string updatedDate) { DARABONBA_PTR_SET_VALUE(updatedDate_, updatedDate) };
