...
namespace Models
{
  ...
  public:
    ...
    inline const ListSecretParametersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSecretParametersResponseBody) };
    inline ListSecretParametersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSecretParametersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSecretParametersResponseBody> body_ {};
  };
