...
namespace Models
{
  ...
  public:
    ...
    inline const TriggerExecutionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TriggerExecutionResponseBody) };
    inline TriggerExecutionResponseBody getBody() { DARABONBA_PTR_GET(body_, TriggerExecutionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TriggerExecutionResponseBody> body_ {};
  };
