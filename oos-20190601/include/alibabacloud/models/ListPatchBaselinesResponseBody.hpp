...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && return this->nextToken_ == nullptr && return this->patchBaselines_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const vector<ListPatchBaselinesResponseBodyPatchBaselines> & patchBaselines() const { DARABONBA_PTR_GET_CONST(patchBaselines_, vector<ListPatchBaselinesResponseBodyPatchBaselines>) };
    inline vector<ListPatchBaselinesResponseBodyPatchBaselines> patchBaselines() { DARABONBA_PTR_GET(patchBaselines_, vector<ListPatchBaselinesResponseBodyPatchBaselines>) };
    inline ListPatchBaselinesResponseBody& setPatchBaselines(const vector<ListPatchBaselinesResponseBodyPatchBaselines> & patchBaselines) { DARABONBA_PTR_SET_VALUE(patchBaselines_, patchBaselines) };
    inline ListPatchBaselinesResponseBody& setPatchBaselines(vector<ListPatchBaselinesResponseBodyPatchBaselines> && patchBaselines) { DARABONBA_PTR_SET_RVALUE(patchBaselines_, patchBaselines) };
  ...
  protected:
    ...
    // The patch baselines.
    std::shared_ptr<vector<ListPatchBaselinesResponseBodyPatchBaselines>> patchBaselines_ = nullptr;
    // The request ID.
