...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->approvalRules_ == nullptr
        ...
        && this->id_ == nullptr && this->isDefault_ == nullptr && this->name_ == nullptr && this->operationSystem_ == nullptr && this->rejectedPatches_ == nullptr
        && this->rejectedPatchesAction_ == nullptr && this->resourceGroupId_ == nullptr && this->shareType_ == nullptr && this->sources_ == nullptr && this->tags_ == nullptr
      ...
      inline PatchBaseline& setIsDefault(bool isDefault) { DARABONBA_PTR_SET_VALUE(isDefault_, isDefault) };
    ...
    inline const GetPatchBaselineResponseBody::PatchBaseline & getPatchBaseline() const { DARABONBA_PTR_GET_CONST(patchBaseline_, GetPatchBaselineResponseBody::PatchBaseline) };
    inline GetPatchBaselineResponseBody::PatchBaseline getPatchBaseline() { DARABONBA_PTR_GET(patchBaseline_, GetPatchBaselineResponseBody::PatchBaseline) };
    inline GetPatchBaselineResponseBody& setPatchBaseline(const GetPatchBaselineResponseBody::PatchBaseline & patchBaseline) { DARABONBA_PTR_SET_VALUE(patchBaseline_, patchBaseline) };
    inline GetPatchBaselineResponseBody& setPatchBaseline(GetPatchBaselineResponseBody::PatchBaseline && patchBaseline) { DARABONBA_PTR_SET_RVALUE(patchBaseline_, patchBaseline) };
  ...
  protected:
    ...
    shared_ptr<GetPatchBaselineResponseBody::PatchBaseline> patchBaseline_ {};
