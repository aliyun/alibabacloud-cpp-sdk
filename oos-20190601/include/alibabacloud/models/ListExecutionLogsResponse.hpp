...
namespace Models
{
  ...
  public:
    ...
    inline const ListExecutionLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExecutionLogsResponseBody) };
    inline ListExecutionLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExecutionLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExecutionLogsResponseBody> body_ {};
  };
