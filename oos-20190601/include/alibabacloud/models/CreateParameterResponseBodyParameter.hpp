...
#ifndef ALIBABACLOUD_MODELS_CREATEPARAMETERRESPONSEBODYPARAMETER_HPP_
#define ALIBABACLOUD_MODELS_CREATEPARAMETERRESPONSEBODYPARAMETER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateParameterResponseBodyParameter& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateParameterResponseBodyParameter& obj) { 
    ...
    CreateParameterResponseBodyParameter() = default ;
    CreateParameterResponseBodyParameter(const CreateParameterResponseBodyParameter &) = default ;
    CreateParameterResponseBodyParameter(CreateParameterResponseBodyParameter &&) = default ;
    CreateParameterResponseBodyParameter(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateParameterResponseBodyParameter() = default ;
    CreateParameterResponseBodyParameter& operator=(const CreateParameterResponseBodyParameter &) = default ;
    CreateParameterResponseBodyParameter& operator=(CreateParameterResponseBodyParameter &&) = default ;
    ...
    inline CreateParameterResponseBodyParameter& setConstraints(string constraints) { DARABONBA_PTR_SET_VALUE(constraints_, constraints) };
    ...
    inline CreateParameterResponseBodyParameter& setCreatedBy(string createdBy) { DARABONBA_PTR_SET_VALUE(createdBy_, createdBy) };
    ...
    inline CreateParameterResponseBodyParameter& setCreatedDate(string createdDate) { DARABONBA_PTR_SET_VALUE(createdDate_, createdDate) };
    ...
    inline CreateParameterResponseBodyParameter& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreateParameterResponseBodyParameter& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline CreateParameterResponseBodyParameter& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateParameterResponseBodyParameter& setParameterVersion(int32_t parameterVersion) { DARABONBA_PTR_SET_VALUE(parameterVersion_, parameterVersion) };
    ...
    inline CreateParameterResponseBodyParameter& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline CreateParameterResponseBodyParameter& setShareType(string shareType) { DARABONBA_PTR_SET_VALUE(shareType_, shareType) };
    ...
    inline CreateParameterResponseBodyParameter& setTags(const Darabonba::Json & tags) { DARABONBA_SET_VALUE(tags_, tags) };
    inline CreateParameterResponseBodyParameter& setTags(Darabonba::Json & tags) { DARABONBA_SET_RVALUE(tags_, tags) };
    ...
    inline CreateParameterResponseBodyParameter& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline CreateParameterResponseBodyParameter& setUpdatedBy(string updatedBy) { DARABONBA_PTR_SET_VALUE(updatedBy_, updatedBy) };
    ...
    inline CreateParameterResponseBodyParameter& setUpdatedDate(string updatedDate) { DARABONBA_PTR_SET_VALUE(updatedDate_, updatedDate) };
