...
namespace Models
{
  ...
  public:
    ...
    inline const GetOpsItemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOpsItemResponseBody) };
    inline GetOpsItemResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOpsItemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOpsItemResponseBody> body_ {};
  };
