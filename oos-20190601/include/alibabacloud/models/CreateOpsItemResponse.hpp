...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOpsItemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateOpsItemResponseBody) };
    inline CreateOpsItemResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateOpsItemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateOpsItemResponseBody> body_ {};
  };
