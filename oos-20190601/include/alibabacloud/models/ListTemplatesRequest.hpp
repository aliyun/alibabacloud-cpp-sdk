...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->category_ == nullptr
        ...
        && return this->shareType_ == nullptr && return this->sortField_ == nullptr && return this->sortOrder_ == nullptr && return this->tags_ == nullptr && return this->templateFormat_ == nullptr
        && return this->templateName_ == nullptr && return this->templateType_ == nullptr; };
    // category Field Functions 
    bool hasCategory() const { return this->category_ != nullptr;};
    void deleteCategory() { this->category_ = nullptr;};
    inline string category() const { DARABONBA_PTR_GET_DEFAULT(category_, "") };
    inline ListTemplatesRequest& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
    ...
    inline ListTemplatesRequest& setCreatedBy(string createdBy) { DARABONBA_PTR_SET_VALUE(createdBy_, createdBy) };
    ...
    inline ListTemplatesRequest& setCreatedDateAfter(string createdDateAfter) { DARABONBA_PTR_SET_VALUE(createdDateAfter_, createdDateAfter) };
    ...
    inline ListTemplatesRequest& setCreatedDateBefore(string createdDateBefore) { DARABONBA_PTR_SET_VALUE(createdDateBefore_, createdDateBefore) };
    ...
    inline ListTemplatesRequest& setHasTrigger(bool hasTrigger) { DARABONBA_PTR_SET_VALUE(hasTrigger_, hasTrigger) };
    ...
    inline ListTemplatesRequest& setIsExample(bool isExample) { DARABONBA_PTR_SET_VALUE(isExample_, isExample) };
    ...
    inline ListTemplatesRequest& setIsFavorite(bool isFavorite) { DARABONBA_PTR_SET_VALUE(isFavorite_, isFavorite) };
    ...
    inline ListTemplatesRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline ListTemplatesRequest& setSortField(string sortField) { DARABONBA_PTR_SET_VALUE(sortField_, sortField) };
    ...
    inline ListTemplatesRequest& setSortOrder(string sortOrder) { DARABONBA_PTR_SET_VALUE(sortOrder_, sortOrder) };
    ...
    inline ListTemplatesRequest& setTags(const Darabonba::Json & tags) { DARABONBA_SET_VALUE(tags_, tags) };
    inline ListTemplatesRequest& setTags(Darabonba::Json & tags) { DARABONBA_SET_RVALUE(tags_, tags) };
    ...
    inline ListTemplatesRequest& setTemplateFormat(string templateFormat) { DARABONBA_PTR_SET_VALUE(templateFormat_, templateFormat) };
