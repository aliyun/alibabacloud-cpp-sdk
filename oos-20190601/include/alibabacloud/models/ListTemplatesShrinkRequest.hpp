...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->category_ == nullptr
        && this->createdBy_ == nullptr && this->createdDateAfter_ == nullptr && this->createdDateBefore_ == nullptr && this->hasTrigger_ == nullptr && this->isExample_ == nullptr
        && this->isFavorite_ == nullptr && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr
        && this->shareType_ == nullptr && this->sortField_ == nullptr && this->sortOrder_ == nullptr && this->tagsShrink_ == nullptr && this->templateFormat_ == nullptr
    ...
    inline string getCreatedDateAfter() const { DARABONBA_PTR_GET_DEFAULT(createdDateAfter_, "") };
    ...
    inline string getCreatedDateBefore() const { DARABONBA_PTR_GET_DEFAULT(createdDateBefore_, "") };
    ...
    inline bool getIsExample() const { DARABONBA_PTR_GET_DEFAULT(isExample_, false) };
