...
namespace Models
{
  ...
  public:
    ...
    inline UpdateTemplateResponseBodyTemplate& setCreatedBy(string createdBy) { DARABONBA_PTR_SET_VALUE(createdBy_, createdBy) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setCreatedDate(string createdDate) { DARABONBA_PTR_SET_VALUE(createdDate_, createdDate) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setHasTrigger(bool hasTrigger) { DARABONBA_PTR_SET_VALUE(hasTrigger_, hasTrigger) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setHash(string hash) { DARABONBA_PTR_SET_VALUE(hash_, hash) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setShareType(string shareType) { DARABONBA_PTR_SET_VALUE(shareType_, shareType) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setTags(const Darabonba::Json & tags) { DARABONBA_SET_VALUE(tags_, tags) };
    inline UpdateTemplateResponseBodyTemplate& setTags(Darabonba::Json & tags) { DARABONBA_SET_RVALUE(tags_, tags) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setTemplateFormat(string templateFormat) { DARABONBA_PTR_SET_VALUE(templateFormat_, templateFormat) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setTemplateId(string templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setTemplateName(string templateName) { DARABONBA_PTR_SET_VALUE(templateName_, templateName) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setTemplateVersion(string templateVersion) { DARABONBA_PTR_SET_VALUE(templateVersion_, templateVersion) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setUpdatedBy(string updatedBy) { DARABONBA_PTR_SET_VALUE(updatedBy_, updatedBy) };
    ...
    inline UpdateTemplateResponseBodyTemplate& setUpdatedDate(string updatedDate) { DARABONBA_PTR_SET_VALUE(updatedDate_, updatedDate) };
