...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateParameterResponseBody::Parameter & getParameter() const { DARABONBA_PTR_GET_CONST(parameter_, UpdateParameterResponseBody::Parameter) };
    inline UpdateParameterResponseBody::Parameter getParameter() { DARABONBA_PTR_GET(parameter_, UpdateParameterResponseBody::Parameter) };
    inline UpdateParameterResponseBody& setParameter(const UpdateParameterResponseBody::Parameter & parameter) { DARABONBA_PTR_SET_VALUE(parameter_, parameter) };
    inline UpdateParameterResponseBody& setParameter(UpdateParameterResponseBody::Parameter && parameter) { DARABONBA_PTR_SET_RVALUE(parameter_, parameter) };
  ...
  protected:
    ...
    shared_ptr<UpdateParameterResponseBody::Parameter> parameter_ {};
    // The request ID.
