...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateParameterResponseBodyParameter & parameter() const { DARABONBA_PTR_GET_CONST(parameter_, UpdateParameterResponseBodyParameter) };
    inline UpdateParameterResponseBodyParameter parameter() { DARABONBA_PTR_GET(parameter_, UpdateParameterResponseBodyParameter) };
    inline UpdateParameterResponseBody& setParameter(const UpdateParameterResponseBodyParameter & parameter) { DARABONBA_PTR_SET_VALUE(parameter_, parameter) };
    inline UpdateParameterResponseBody& setParameter(UpdateParameterResponseBodyParameter && parameter) { DARABONBA_PTR_SET_RVALUE(parameter_, parameter) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateParameterResponseBodyParameter> parameter_ = nullptr;
    // The request ID.
