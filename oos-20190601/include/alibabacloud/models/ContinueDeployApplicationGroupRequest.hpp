...
#ifndef ALIBABACLOUD_MODELS_CONTINUEDEPLOYAPPLICATIONGROUPREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CONTINUEDEPLOYAPPLICATIONGROUPREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ContinueDeployApplicationGroupRequest& obj) { 
      DARABONBA_PTR_TO_JSON(ApplicationName, applicationName_);
      DARABONBA_PTR_TO_JSON(DeployParameters, deployParameters_);
      DARABONBA_PTR_TO_JSON(Name, name_);
      DARABONBA_PTR_TO_JSON(RegionId, regionId_);
    };
    friend void from_json(const Darabonba::Json& j, ContinueDeployApplicationGroupRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(ApplicationName, applicationName_);
      DARABONBA_PTR_FROM_JSON(DeployParameters, deployParameters_);
      DARABONBA_PTR_FROM_JSON(Name, name_);
      DARABONBA_PTR_FROM_JSON(RegionId, regionId_);
    };
    ContinueDeployApplicationGroupRequest() = default ;
    ContinueDeployApplicationGroupRequest(const ContinueDeployApplicationGroupRequest &) = default ;
    ContinueDeployApplicationGroupRequest(ContinueDeployApplicationGroupRequest &&) = default ;
    ContinueDeployApplicationGroupRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ContinueDeployApplicationGroupRequest() = default ;
    ContinueDeployApplicationGroupRequest& operator=(const ContinueDeployApplicationGroupRequest &) = default ;
    ContinueDeployApplicationGroupRequest& operator=(ContinueDeployApplicationGroupRequest &&) = default ;
