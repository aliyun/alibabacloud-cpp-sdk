...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->constraints_ == nullptr
        && this->createdBy_ == nullptr && this->createdDate_ == nullptr && this->DKMSInstanceId_ == nullptr && this->description_ == nullptr && this->id_ == nullptr
        && this->keyId_ == nullptr && this->name_ == nullptr && this->parameterVersion_ == nullptr && this->resourceGroupId_ == nullptr && this->shareType_ == nullptr
        && this->tags_ == nullptr && this->type_ == nullptr && this->updatedBy_ == nullptr && this->updatedDate_ == nullptr && this->value_ == nullptr; };
      ...
      inline Parameter& setDKMSInstanceId(string DKMSInstanceId) { DARABONBA_PTR_SET_VALUE(DKMSInstanceId_, DKMSInstanceId) };
    ...
    inline const GetSecretParameterResponseBody::Parameter & getParameter() const { DARABONBA_PTR_GET_CONST(parameter_, GetSecretParameterResponseBody::Parameter) };
    inline GetSecretParameterResponseBody::Parameter getParameter() { DARABONBA_PTR_GET(parameter_, GetSecretParameterResponseBody::Parameter) };
    inline GetSecretParameterResponseBody& setParameter(const GetSecretParameterResponseBody::Parameter & parameter) { DARABONBA_PTR_SET_VALUE(parameter_, parameter) };
    inline GetSecretParameterResponseBody& setParameter(GetSecretParameterResponseBody::Parameter && parameter) { DARABONBA_PTR_SET_RVALUE(parameter_, parameter) };
  ...
  protected:
    ...
    shared_ptr<GetSecretParameterResponseBody::Parameter> parameter_ {};
