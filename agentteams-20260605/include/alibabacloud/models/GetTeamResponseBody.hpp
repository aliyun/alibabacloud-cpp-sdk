  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline Rooms& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
      ...
      virtual bool empty() const override { return this->adminName_ == nullptr
        ...
        && this->rooms_ == nullptr && this->status_ == nullptr && this->teamMembers_ == nullptr && this->updatedAt_ == nullptr && this->workerNames_ == nullptr; };
      ...
      inline const vector<Data::Rooms> & getRooms() const { DARABONBA_PTR_GET_CONST(rooms_, vector<Data::Rooms>) };
      inline vector<Data::Rooms> getRooms() { DARABONBA_PTR_GET(rooms_, vector<Data::Rooms>) };
      inline Data& setRooms(const vector<Data::Rooms> & rooms) { DARABONBA_PTR_SET_VALUE(rooms_, rooms) };
      inline Data& setRooms(vector<Data::Rooms> && rooms) { DARABONBA_PTR_SET_RVALUE(rooms_, rooms) };
