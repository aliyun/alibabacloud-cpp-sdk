...
#ifndef ALIBABACLOUD_MODELS_CREATEMCPRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEMCPRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateMcpResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateMcpResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateMcpResponseBody& obj) { 
    ...
    CreateMcpResponseBody() = default ;
    CreateMcpResponseBody(const CreateMcpResponseBody &) = default ;
    CreateMcpResponseBody(CreateMcpResponseBody &&) = default ;
    CreateMcpResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateMcpResponseBody() = default ;
    CreateMcpResponseBody& operator=(const CreateMcpResponseBody &) = default ;
    CreateMcpResponseBody& operator=(CreateMcpResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->addresses_ == nullptr
        && this->createType_ == nullptr && this->deployStatus_ == nullptr && this->description_ == nullptr && this->id_ == nullptr && this->mcpServerConfig_ == nullptr
    ...
    inline CreateMcpResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateMcpResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateMcpResponseBody::Data) };
    inline CreateMcpResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateMcpResponseBody::Data) };
    inline CreateMcpResponseBody& setData(const CreateMcpResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateMcpResponseBody& setData(CreateMcpResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateMcpResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateMcpResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateMcpResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
