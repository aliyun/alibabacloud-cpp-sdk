...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInstanceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteInstanceResponseBody::Data) };
    inline DeleteInstanceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteInstanceResponseBody::Data) };
    inline DeleteInstanceResponseBody& setData(const DeleteInstanceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteInstanceResponseBody& setData(DeleteInstanceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
