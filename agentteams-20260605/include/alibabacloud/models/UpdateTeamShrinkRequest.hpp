...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->description_ == nullptr && this->instanceId_ == nullptr && this->name_ == nullptr && this->teamMembersShrink_ == nullptr; };
    ...
    inline UpdateTeamShrinkRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateTeamShrinkRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline UpdateTeamShrinkRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline UpdateTeamShrinkRequest& setTeamMembersShrink(string teamMembersShrink) { DARABONBA_PTR_SET_VALUE(teamMembersShrink_, teamMembersShrink) };
