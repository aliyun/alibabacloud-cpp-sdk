  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->authMethod_ == nullptr
        && this->createdAt_ == nullptr && this->displayName_ == nullptr && this->email_ == nullptr && this->instanceId_ == nullptr && this->name_ == nullptr
    ...
    inline UpdateUserResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const UpdateUserResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateUserResponseBody::Data) };
    inline UpdateUserResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateUserResponseBody::Data) };
    inline UpdateUserResponseBody& setData(const UpdateUserResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateUserResponseBody& setData(UpdateUserResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateUserResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UpdateUserResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateUserResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
