...
namespace Models
{
  ...
  public:
    ...
    inline ListMcpToolsRequest& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListMcpToolsRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
