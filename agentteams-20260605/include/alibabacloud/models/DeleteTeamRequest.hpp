...
namespace Models
{
  ...
  public:
    ...
    inline DeleteTeamRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline DeleteTeamRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
