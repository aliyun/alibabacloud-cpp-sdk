  ...
  public:
    ...
    public:
      friend void to_json(Darabonba::Json& j, const Items& obj) { 
        DARABONBA_PTR_TO_JSON(BoundWorkerCount, boundWorkerCount_);
      ...
      friend void from_json(const Darabonba::Json& j, Items& obj) { 
        DARABONBA_PTR_FROM_JSON(BoundWorkerCount, boundWorkerCount_);
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->boundWorkerCount_ == nullptr
        && this->createTime_ == nullptr && this->description_ == nullptr && this->instanceId_ == nullptr && this->name_ == nullptr && this->updateTime_ == nullptr; };
      // boundWorkerCount Field Functions 
      bool hasBoundWorkerCount() const { return this->boundWorkerCount_ != nullptr;};
      void deleteBoundWorkerCount() { this->boundWorkerCount_ = nullptr;};
      inline int32_t getBoundWorkerCount() const { DARABONBA_PTR_GET_DEFAULT(boundWorkerCount_, 0) };
      inline Items& setBoundWorkerCount(int32_t boundWorkerCount) { DARABONBA_PTR_SET_VALUE(boundWorkerCount_, boundWorkerCount) };
