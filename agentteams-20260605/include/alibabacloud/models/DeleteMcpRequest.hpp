...
namespace Models
{
  ...
  public:
    ...
    inline DeleteMcpRequest& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DeleteMcpRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
