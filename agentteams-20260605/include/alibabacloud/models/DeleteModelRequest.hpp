...
namespace Models
{
  ...
  public:
    ...
    inline DeleteModelRequest& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DeleteModelRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline DeleteModelRequest& setProviderId(string providerId) { DARABONBA_PTR_SET_VALUE(providerId_, providerId) };
