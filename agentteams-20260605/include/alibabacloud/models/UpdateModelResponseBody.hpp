...
namespace Models
{
  ...
  public:
    ...
    inline UpdateModelResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UpdateModelResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateModelResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
