...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instanceName_ == nullptr
        && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->skip_ == nullptr && this->status_ == nullptr; };
    ...
    inline ListInstancesRequest& setSkip(int32_t skip) { DARABONBA_PTR_SET_VALUE(skip_, skip) };
