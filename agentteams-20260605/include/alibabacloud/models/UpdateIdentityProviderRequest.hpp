...
namespace Models
{
  ...
  public:
    ...
    inline UpdateIdentityProviderRequest& setIdentityProviderType(string identityProviderType) { DARABONBA_PTR_SET_VALUE(identityProviderType_, identityProviderType) };
    ...
    inline UpdateIdentityProviderRequest& setIdpMetadata(string idpMetadata) { DARABONBA_PTR_SET_VALUE(idpMetadata_, idpMetadata) };
    ...
    inline UpdateIdentityProviderRequest& setLoginEnabled(bool loginEnabled) { DARABONBA_PTR_SET_VALUE(loginEnabled_, loginEnabled) };
    ...
    inline UpdateIdentityProviderRequest& setSyncEnabled(bool syncEnabled) { DARABONBA_PTR_SET_VALUE(syncEnabled_, syncEnabled) };
