  ...
  public:
    ...
    public:
      friend void to_json(Darabonba::Json& j, const Data& obj) { 
        DARABONBA_PTR_TO_JSON(BoundWorkers, boundWorkers_);
      ...
      friend void from_json(const Darabonba::Json& j, Data& obj) { 
        DARABONBA_PTR_FROM_JSON(BoundWorkers, boundWorkers_);
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      class BoundWorkers : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const BoundWorkers& obj) { 
          DARABONBA_PTR_TO_JSON(Name, name_);
          DARABONBA_PTR_TO_JSON(Status, status_);
          DARABONBA_PTR_TO_JSON(UpdateTime, updateTime_);
        };
        friend void from_json(const Darabonba::Json& j, BoundWorkers& obj) { 
          DARABONBA_PTR_FROM_JSON(Name, name_);
          DARABONBA_PTR_FROM_JSON(Status, status_);
          DARABONBA_PTR_FROM_JSON(UpdateTime, updateTime_);
        };
        BoundWorkers() = default ;
        BoundWorkers(const BoundWorkers &) = default ;
        BoundWorkers(BoundWorkers &&) = default ;
        BoundWorkers(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~BoundWorkers() = default ;
        BoundWorkers& operator=(const BoundWorkers &) = default ;
        BoundWorkers& operator=(BoundWorkers &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        inline BoundWorkers& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
        ...
        inline BoundWorkers& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
        ...
        inline BoundWorkers& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
      ...
      virtual bool empty() const override { return this->boundWorkers_ == nullptr
        && this->createTime_ == nullptr && this->description_ == nullptr && this->instanceId_ == nullptr && this->name_ == nullptr && this->regionId_ == nullptr
        && this->status_ == nullptr && this->updateTime_ == nullptr; };
      // boundWorkers Field Functions 
      bool hasBoundWorkers() const { return this->boundWorkers_ != nullptr;};
      void deleteBoundWorkers() { this->boundWorkers_ = nullptr;};
      inline const vector<Data::BoundWorkers> & getBoundWorkers() const { DARABONBA_PTR_GET_CONST(boundWorkers_, vector<Data::BoundWorkers>) };
      inline vector<Data::BoundWorkers> getBoundWorkers() { DARABONBA_PTR_GET(boundWorkers_, vector<Data::BoundWorkers>) };
      inline Data& setBoundWorkers(const vector<Data::BoundWorkers> & boundWorkers) { DARABONBA_PTR_SET_VALUE(boundWorkers_, boundWorkers) };
      inline Data& setBoundWorkers(vector<Data::BoundWorkers> && boundWorkers) { DARABONBA_PTR_SET_RVALUE(boundWorkers_, boundWorkers) };
