  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->certIdentifier_ == nullptr
        && this->component_ == nullptr && this->createTime_ == nullptr && this->domain_ == nullptr && this->domainType_ == nullptr && this->endpointId_ == nullptr
        && this->endpointName_ == nullptr && this->instanceId_ == nullptr && this->networkType_ == nullptr && this->regionId_ == nullptr && this->status_ == nullptr
