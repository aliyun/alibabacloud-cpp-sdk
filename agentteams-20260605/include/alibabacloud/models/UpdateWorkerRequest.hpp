...
#ifndef ALIBABACLOUD_MODELS_UPDATEWORKERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEWORKERREQUEST_HPP_
...
namespace Models
{
  class UpdateWorkerRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateWorkerRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateWorkerRequest& obj) { 
    ...
    UpdateWorkerRequest(const UpdateWorkerRequest &) = default ;
    UpdateWorkerRequest(UpdateWorkerRequest &&) = default ;
    UpdateWorkerRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateWorkerRequest() = default ;
    UpdateWorkerRequest& operator=(const UpdateWorkerRequest &) = default ;
    UpdateWorkerRequest& operator=(UpdateWorkerRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->agents_ == nullptr
        && this->channels_ == nullptr && this->clientToken_ == nullptr && this->credentials_ == nullptr && this->instanceId_ == nullptr && this->limitConfig_ == nullptr
        && this->mcpServers_ == nullptr && this->model_ == nullptr && this->name_ == nullptr && this->skills_ == nullptr && this->soul_ == nullptr
    ...
    inline UpdateWorkerRequest& setAgents(string agents) { DARABONBA_PTR_SET_VALUE(agents_, agents) };


    // channels Field Functions 
    bool hasChannels() const { return this->channels_ != nullptr;};
    void deleteChannels() { this->channels_ = nullptr;};
    inline const vector<UpdateWorkerRequest::Channels> & getChannels() const { DARABONBA_PTR_GET_CONST(channels_, vector<UpdateWorkerRequest::Channels>) };
    inline vector<UpdateWorkerRequest::Channels> getChannels() { DARABONBA_PTR_GET(channels_, vector<UpdateWorkerRequest::Channels>) };
    inline UpdateWorkerRequest& setChannels(const vector<UpdateWorkerRequest::Channels> & channels) { DARABONBA_PTR_SET_VALUE(channels_, channels) };
    inline UpdateWorkerRequest& setChannels(vector<UpdateWorkerRequest::Channels> && channels) { DARABONBA_PTR_SET_RVALUE(channels_, channels) };
    ...
    inline UpdateWorkerRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline const vector<UpdateWorkerRequest::Credentials> & getCredentials() const { DARABONBA_PTR_GET_CONST(credentials_, vector<UpdateWorkerRequest::Credentials>) };
    inline vector<UpdateWorkerRequest::Credentials> getCredentials() { DARABONBA_PTR_GET(credentials_, vector<UpdateWorkerRequest::Credentials>) };
    inline UpdateWorkerRequest& setCredentials(const vector<UpdateWorkerRequest::Credentials> & credentials) { DARABONBA_PTR_SET_VALUE(credentials_, credentials) };
    inline UpdateWorkerRequest& setCredentials(vector<UpdateWorkerRequest::Credentials> && credentials) { DARABONBA_PTR_SET_RVALUE(credentials_, credentials) };
    ...
    inline UpdateWorkerRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline const UpdateWorkerRequest::LimitConfig & getLimitConfig() const { DARABONBA_PTR_GET_CONST(limitConfig_, UpdateWorkerRequest::LimitConfig) };
    inline UpdateWorkerRequest::LimitConfig getLimitConfig() { DARABONBA_PTR_GET(limitConfig_, UpdateWorkerRequest::LimitConfig) };
    inline UpdateWorkerRequest& setLimitConfig(const UpdateWorkerRequest::LimitConfig & limitConfig) { DARABONBA_PTR_SET_VALUE(limitConfig_, limitConfig) };
    inline UpdateWorkerRequest& setLimitConfig(UpdateWorkerRequest::LimitConfig && limitConfig) { DARABONBA_PTR_SET_RVALUE(limitConfig_, limitConfig) };
    ...
    inline const vector<UpdateWorkerRequest::McpServers> & getMcpServers() const { DARABONBA_PTR_GET_CONST(mcpServers_, vector<UpdateWorkerRequest::McpServers>) };
    inline vector<UpdateWorkerRequest::McpServers> getMcpServers() { DARABONBA_PTR_GET(mcpServers_, vector<UpdateWorkerRequest::McpServers>) };
    inline UpdateWorkerRequest& setMcpServers(const vector<UpdateWorkerRequest::McpServers> & mcpServers) { DARABONBA_PTR_SET_VALUE(mcpServers_, mcpServers) };
    inline UpdateWorkerRequest& setMcpServers(vector<UpdateWorkerRequest::McpServers> && mcpServers) { DARABONBA_PTR_SET_RVALUE(mcpServers_, mcpServers) };


    // model Field Functions 
    bool hasModel() const { return this->model_ != nullptr;};
    void deleteModel() { this->model_ = nullptr;};
    inline const UpdateWorkerRequest::Model & getModel() const { DARABONBA_PTR_GET_CONST(model_, UpdateWorkerRequest::Model) };
    inline UpdateWorkerRequest::Model getModel() { DARABONBA_PTR_GET(model_, UpdateWorkerRequest::Model) };
    inline UpdateWorkerRequest& setModel(const UpdateWorkerRequest::Model & model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    inline UpdateWorkerRequest& setModel(UpdateWorkerRequest::Model && model) { DARABONBA_PTR_SET_RVALUE(model_, model) };
    ...
    void deleteName() { this->name_ = nullptr;};
    inline string getName() const { DARABONBA_PTR_GET_DEFAULT(name_, "") };
    inline UpdateWorkerRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };


    // skills Field Functions 
    bool hasSkills() const { return this->skills_ != nullptr;};
    void deleteSkills() { this->skills_ = nullptr;};
    inline const vector<UpdateWorkerRequest::Skills> & getSkills() const { DARABONBA_PTR_GET_CONST(skills_, vector<UpdateWorkerRequest::Skills>) };
    inline vector<UpdateWorkerRequest::Skills> getSkills() { DARABONBA_PTR_GET(skills_, vector<UpdateWorkerRequest::Skills>) };
    inline UpdateWorkerRequest& setSkills(const vector<UpdateWorkerRequest::Skills> & skills) { DARABONBA_PTR_SET_VALUE(skills_, skills) };
    inline UpdateWorkerRequest& setSkills(vector<UpdateWorkerRequest::Skills> && skills) { DARABONBA_PTR_SET_RVALUE(skills_, skills) };
    ...
    inline UpdateWorkerRequest& setSoul(string soul) { DARABONBA_PTR_SET_VALUE(soul_, soul) };


    // template Field Functions 
    bool hasTemplate() const { return this->template_ != nullptr;};
    void deleteTemplate() { this->template_ = nullptr;};
    inline const UpdateWorkerRequest::Template & getTemplate() const { DARABONBA_PTR_GET_CONST(template_, UpdateWorkerRequest::Template) };
    inline UpdateWorkerRequest::Template getTemplate() { DARABONBA_PTR_GET(template_, UpdateWorkerRequest::Template) };
    inline UpdateWorkerRequest& setTemplate(const UpdateWorkerRequest::Template & _template) { DARABONBA_PTR_SET_VALUE(template_, _template) };
    inline UpdateWorkerRequest& setTemplate(UpdateWorkerRequest::Template && _template) { DARABONBA_PTR_SET_RVALUE(template_, _template) };
    ...
    inline UpdateWorkerRequest& setVersionCode(string versionCode) { DARABONBA_PTR_SET_VALUE(versionCode_, versionCode) };
