...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAcrImageTagsResponseBodyImages> & images() const { DARABONBA_PTR_GET_CONST(images_, vector<ListAcrImageTagsResponseBodyImages>) };
    inline vector<ListAcrImageTagsResponseBodyImages> images() { DARABONBA_PTR_GET(images_, vector<ListAcrImageTagsResponseBodyImages>) };
    inline ListAcrImageTagsResponseBody& setImages(const vector<ListAcrImageTagsResponseBodyImages> & images) { DARABONBA_PTR_SET_VALUE(images_, images) };
    inline ListAcrImageTagsResponseBody& setImages(vector<ListAcrImageTagsResponseBodyImages> && images) { DARABONBA_PTR_SET_RVALUE(images_, images) };
  ...
  protected:
    // The list of images.
    std::shared_ptr<vector<ListAcrImageTagsResponseBodyImages>> images_ = nullptr;
