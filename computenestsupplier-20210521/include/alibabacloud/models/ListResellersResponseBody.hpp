...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListResellersResponseBodySupplierInformation> & supplierInformation() const { DARABONBA_PTR_GET_CONST(supplierInformation_, vector<ListResellersResponseBodySupplierInformation>) };
    inline vector<ListResellersResponseBodySupplierInformation> supplierInformation() { DARABONBA_PTR_GET(supplierInformation_, vector<ListResellersResponseBodySupplierInformation>) };
    inline ListResellersResponseBody& setSupplierInformation(const vector<ListResellersResponseBodySupplierInformation> & supplierInformation) { DARABONBA_PTR_SET_VALUE(supplierInformation_, supplierInformation) };
    inline ListResellersResponseBody& setSupplierInformation(vector<ListResellersResponseBodySupplierInformation> && supplierInformation) { DARABONBA_PTR_SET_RVALUE(supplierInformation_, supplierInformation) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListResellersResponseBodySupplierInformation>> supplierInformation_ = nullptr;
