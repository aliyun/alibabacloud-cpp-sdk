...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAcrImageTagsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAcrImageTagsResponseBody) };
    inline DeleteAcrImageTagsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAcrImageTagsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAcrImageTagsResponseBody> body_ {};
  };
