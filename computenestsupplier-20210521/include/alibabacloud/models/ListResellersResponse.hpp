...
namespace Models
{
  ...
  public:
    ...
    inline const ListResellersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListResellersResponseBody) };
    inline ListResellersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListResellersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListResellersResponseBody> body_ {};
  };
