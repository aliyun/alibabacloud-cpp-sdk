...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateServiceRequestCommodity & commodity() const { DARABONBA_PTR_GET_CONST(commodity_, UpdateServiceRequestCommodity) };
    inline UpdateServiceRequestCommodity commodity() { DARABONBA_PTR_GET(commodity_, UpdateServiceRequestCommodity) };
    inline UpdateServiceRequest& setCommodity(const UpdateServiceRequestCommodity & commodity) { DARABONBA_PTR_SET_VALUE(commodity_, commodity) };
    inline UpdateServiceRequest& setCommodity(UpdateServiceRequestCommodity && commodity) { DARABONBA_PTR_SET_RVALUE(commodity_, commodity) };
    ...
    inline const UpdateServiceRequestComplianceMetadata & complianceMetadata() const { DARABONBA_PTR_GET_CONST(complianceMetadata_, UpdateServiceRequestComplianceMetadata) };
    inline UpdateServiceRequestComplianceMetadata complianceMetadata() { DARABONBA_PTR_GET(complianceMetadata_, UpdateServiceRequestComplianceMetadata) };
    inline UpdateServiceRequest& setComplianceMetadata(const UpdateServiceRequestComplianceMetadata & complianceMetadata) { DARABONBA_PTR_SET_VALUE(complianceMetadata_, complianceMetadata) };
    inline UpdateServiceRequest& setComplianceMetadata(UpdateServiceRequestComplianceMetadata && complianceMetadata) { DARABONBA_PTR_SET_RVALUE(complianceMetadata_, complianceMetadata) };
    ...
    inline const vector<UpdateServiceRequestServiceInfo> & serviceInfo() const { DARABONBA_PTR_GET_CONST(serviceInfo_, vector<UpdateServiceRequestServiceInfo>) };
    inline vector<UpdateServiceRequestServiceInfo> serviceInfo() { DARABONBA_PTR_GET(serviceInfo_, vector<UpdateServiceRequestServiceInfo>) };
    inline UpdateServiceRequest& setServiceInfo(const vector<UpdateServiceRequestServiceInfo> & serviceInfo) { DARABONBA_PTR_SET_VALUE(serviceInfo_, serviceInfo) };
    ...
    inline const UpdateServiceRequestUpdateOption & updateOption() const { DARABONBA_PTR_GET_CONST(updateOption_, UpdateServiceRequestUpdateOption) };
    inline UpdateServiceRequestUpdateOption updateOption() { DARABONBA_PTR_GET(updateOption_, UpdateServiceRequestUpdateOption) };
    inline UpdateServiceRequest& setUpdateOption(const UpdateServiceRequestUpdateOption & updateOption) { DARABONBA_PTR_SET_VALUE(updateOption_, updateOption) };
    inline UpdateServiceRequest& setUpdateOption(UpdateServiceRequestUpdateOption && updateOption) { DARABONBA_PTR_SET_RVALUE(updateOption_, updateOption) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateServiceRequestCommodity> commodity_ = nullptr;
    // Compliance check metadata.
    std::shared_ptr<UpdateServiceRequestComplianceMetadata> complianceMetadata_ = nullptr;
    ...
    // The update option.
    std::shared_ptr<UpdateServiceRequestUpdateOption> updateOption_ = nullptr;
