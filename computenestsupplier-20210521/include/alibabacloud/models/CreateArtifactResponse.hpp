...
namespace Models
{
  ...
  public:
    ...
    inline const CreateArtifactResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateArtifactResponseBody) };
    inline CreateArtifactResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateArtifactResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateArtifactResponseBody> body_ {};
  };
