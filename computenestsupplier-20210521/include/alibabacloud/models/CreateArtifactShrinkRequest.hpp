...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateArtifactShrinkRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateArtifactShrinkRequestTag>) };
    inline vector<CreateArtifactShrinkRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<CreateArtifactShrinkRequestTag>) };
    inline CreateArtifactShrinkRequest& setTag(const vector<CreateArtifactShrinkRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateArtifactShrinkRequest& setTag(vector<CreateArtifactShrinkRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The custom tags.
    std::shared_ptr<vector<CreateArtifactShrinkRequestTag>> tag_ = nullptr;
