...
namespace Models
{
  ...
  public:
    ...
    inline ListServiceInstanceBillResponseBodyItem& setServiceInstanceId(string serviceInstanceId) { DARABONBA_PTR_SET_VALUE(serviceInstanceId_, serviceInstanceId) };
