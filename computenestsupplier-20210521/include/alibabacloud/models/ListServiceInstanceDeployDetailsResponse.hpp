...
namespace Models
{
  ...
  public:
    ...
    inline const ListServiceInstanceDeployDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListServiceInstanceDeployDetailsResponseBody) };
    inline ListServiceInstanceDeployDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListServiceInstanceDeployDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListServiceInstanceDeployDetailsResponseBody> body_ {};
  };
