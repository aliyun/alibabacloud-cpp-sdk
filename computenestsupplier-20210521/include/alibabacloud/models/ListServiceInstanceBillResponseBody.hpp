  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->billingCycle_ == nullptr
        ...
        && this->pretaxGrossAmount_ == nullptr && this->productCode_ == nullptr && this->productDetail_ == nullptr && this->productName_ == nullptr && this->serviceInstanceId_ == nullptr
        && this->splitBillingCycle_ == nullptr && this->subscriptionType_ == nullptr && this->usage_ == nullptr && this->usageUnit_ == nullptr; };
      ...
      inline Item& setServiceInstanceId(string serviceInstanceId) { DARABONBA_PTR_SET_VALUE(serviceInstanceId_, serviceInstanceId) };
