...
namespace Models
{
  ...
  public:
    ...
    inline GetServiceInstanceResponseBodyNetworkConfigPrivateVpcConnections& setEndpointServiceId(string endpointServiceId) { DARABONBA_PTR_SET_VALUE(endpointServiceId_, endpointServiceId) };
