...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateServiceShrinkRequestServiceInfo> & serviceInfo() const { DARABONBA_PTR_GET_CONST(serviceInfo_, vector<CreateServiceShrinkRequestServiceInfo>) };
    inline vector<CreateServiceShrinkRequestServiceInfo> serviceInfo() { DARABONBA_PTR_GET(serviceInfo_, vector<CreateServiceShrinkRequestServiceInfo>) };
    inline CreateServiceShrinkRequest& setServiceInfo(const vector<CreateServiceShrinkRequestServiceInfo> & serviceInfo) { DARABONBA_PTR_SET_VALUE(serviceInfo_, serviceInfo) };
    inline CreateServiceShrinkRequest& setServiceInfo(vector<CreateServiceShrinkRequestServiceInfo> && serviceInfo) { DARABONBA_PTR_SET_RVALUE(serviceInfo_, serviceInfo) };
    ...
    inline const vector<CreateServiceShrinkRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateServiceShrinkRequestTag>) };
    inline vector<CreateServiceShrinkRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<CreateServiceShrinkRequestTag>) };
    inline CreateServiceShrinkRequest& setTag(const vector<CreateServiceShrinkRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateServiceShrinkRequest& setTag(vector<CreateServiceShrinkRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The service details.
    std::shared_ptr<vector<CreateServiceShrinkRequestServiceInfo>> serviceInfo_ = nullptr;
    ...
    // The custom tags.
    std::shared_ptr<vector<CreateServiceShrinkRequestTag>> tag_ = nullptr;
