...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeServiceInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeServiceInstanceResponseBody) };
    inline UpgradeServiceInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeServiceInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeServiceInstanceResponseBody> body_ {};
  };
