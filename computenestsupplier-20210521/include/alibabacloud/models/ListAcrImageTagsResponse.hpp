...
namespace Models
{
  ...
  public:
    ...
    inline const ListAcrImageTagsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAcrImageTagsResponseBody) };
    inline ListAcrImageTagsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAcrImageTagsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAcrImageTagsResponseBody> body_ {};
  };
