...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateDefaultServiceTestConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateDefaultServiceTestConfigResponseBody) };
    inline GenerateDefaultServiceTestConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateDefaultServiceTestConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateDefaultServiceTestConfigResponseBody> body_ {};
  };
