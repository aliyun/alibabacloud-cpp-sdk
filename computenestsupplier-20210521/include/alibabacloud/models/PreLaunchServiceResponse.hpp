...
namespace Models
{
  ...
  public:
    ...
    inline const PreLaunchServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PreLaunchServiceResponseBody) };
    inline PreLaunchServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, PreLaunchServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PreLaunchServiceResponseBody> body_ {};
  };
