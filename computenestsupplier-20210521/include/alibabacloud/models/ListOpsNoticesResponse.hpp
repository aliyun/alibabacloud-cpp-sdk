...
namespace Models
{
  ...
  public:
    ...
    inline const ListOpsNoticesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOpsNoticesResponseBody) };
    inline ListOpsNoticesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOpsNoticesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOpsNoticesResponseBody> body_ {};
  };
