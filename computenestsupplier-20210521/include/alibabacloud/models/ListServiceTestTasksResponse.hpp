...
namespace Models
{
  ...
  public:
    ...
    inline const ListServiceTestTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListServiceTestTasksResponseBody) };
    inline ListServiceTestTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListServiceTestTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListServiceTestTasksResponseBody> body_ {};
  };
