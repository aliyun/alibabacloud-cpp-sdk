...
namespace Models
{
  ...
  public:
    ...
    inline const vector<int64_t> & getUserAliUids() const { DARABONBA_PTR_GET_CONST(userAliUids_, vector<int64_t>) };
    inline vector<int64_t> getUserAliUids() { DARABONBA_PTR_GET(userAliUids_, vector<int64_t>) };
