...
namespace Models
{
  ...
  public:
    ...
    inline const WithdrawServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, WithdrawServiceResponseBody) };
    inline WithdrawServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, WithdrawServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<WithdrawServiceResponseBody> body_ {};
  };
