...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateServicePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateServicePolicyResponseBody) };
    inline GenerateServicePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateServicePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateServicePolicyResponseBody> body_ {};
  };
