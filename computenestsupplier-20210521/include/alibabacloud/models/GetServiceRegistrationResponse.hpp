...
namespace Models
{
  ...
  public:
    ...
    inline const GetServiceRegistrationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetServiceRegistrationResponseBody) };
    inline GetServiceRegistrationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetServiceRegistrationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetServiceRegistrationResponseBody> body_ {};
  };
