...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->alarmMetadata_ != nullptr
        ...
        && this->serviceInfos_ != nullptr && this->serviceProductUrl_ != nullptr && this->serviceType_ != nullptr && this->shareType_ != nullptr && this->shareTypeStatus_ != nullptr
        && this->sourceServiceId_ != nullptr && this->sourceServiceVersion_ != nullptr && this->sourceSupplierName_ != nullptr && this->statistic_ != nullptr && this->status_ != nullptr
        && this->statusDetail_ != nullptr && this->supplierName_ != nullptr && this->supplierUrl_ != nullptr && this->supportContacts_ != nullptr && this->tags_ != nullptr
        && this->tenantType_ != nullptr && this->testStatus_ != nullptr && this->trialDuration_ != nullptr && this->trialType_ != nullptr && this->updateTime_ != nullptr
        && this->upgradeMetadata_ != nullptr && this->version_ != nullptr && this->versionName_ != nullptr && this->virtualInternetService_ != nullptr && this->virtualInternetServiceId_ != nullptr; };
