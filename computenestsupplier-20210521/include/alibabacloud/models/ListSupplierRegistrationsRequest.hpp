...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSupplierRegistrationsRequestFilter> & filter() const { DARABONBA_PTR_GET_CONST(filter_, vector<ListSupplierRegistrationsRequestFilter>) };
    inline vector<ListSupplierRegistrationsRequestFilter> filter() { DARABONBA_PTR_GET(filter_, vector<ListSupplierRegistrationsRequestFilter>) };
    inline ListSupplierRegistrationsRequest& setFilter(const vector<ListSupplierRegistrationsRequestFilter> & filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    inline ListSupplierRegistrationsRequest& setFilter(vector<ListSupplierRegistrationsRequestFilter> && filter) { DARABONBA_PTR_SET_RVALUE(filter_, filter) };
  ...
  protected:
    // The filter.
    std::shared_ptr<vector<ListSupplierRegistrationsRequestFilter>> filter_ = nullptr;
