...
namespace Models
{
  ...
  public:
    ...
    inline const ReleaseArtifactResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReleaseArtifactResponseBody) };
    inline ReleaseArtifactResponseBody getBody() { DARABONBA_PTR_GET(body_, ReleaseArtifactResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReleaseArtifactResponseBody> body_ {};
  };
