...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListServiceUsagesRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(SupplierRole, supplierRole_);
    };
    friend void from_json(const Darabonba::Json& j, ListServiceUsagesRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(Filter, filter_);
      DARABONBA_PTR_FROM_JSON(MaxResults, maxResults_);
      DARABONBA_PTR_FROM_JSON(NextToken, nextToken_);
      DARABONBA_PTR_FROM_JSON(SupplierRole, supplierRole_);
    };
    ...
    virtual bool empty() const override { this->filter_ != nullptr
        && this->maxResults_ != nullptr && this->nextToken_ != nullptr && this->supplierRole_ != nullptr; };
    ...
    // supplierRole Field Functions 
    bool hasSupplierRole() const { return this->supplierRole_ != nullptr;};
    void deleteSupplierRole() { this->supplierRole_ = nullptr;};
    inline string supplierRole() const { DARABONBA_PTR_GET_DEFAULT(supplierRole_, "") };
    inline ListServiceUsagesRequest& setSupplierRole(string supplierRole) { DARABONBA_PTR_SET_VALUE(supplierRole_, supplierRole) };
  ...
  protected:
    ...
    std::shared_ptr<string> supplierRole_ = nullptr;
  };
