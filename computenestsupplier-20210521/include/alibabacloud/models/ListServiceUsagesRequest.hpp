...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->filter_ == nullptr
        && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->regionId_ == nullptr && this->supplierRole_ == nullptr; };
    ...
    inline string getSupplierRole() const { DARABONBA_PTR_GET_DEFAULT(supplierRole_, "") };
