...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authorizedCount_ == nullptr
        && return this->authorizedDeviceCount_ == nullptr && return this->contactor_ == nullptr && return this->memberId_ == nullptr && return this->name_ == nullptr && return this->regionId_ == nullptr
        && return this->remark_ == nullptr && return this->telephony_ == nullptr && return this->uid_ == nullptr; };
    ...
    inline UpdateMemberRequest& setAuthorizedCount(int64_t authorizedCount) { DARABONBA_PTR_SET_VALUE(authorizedCount_, authorizedCount) };
    ...
    inline UpdateMemberRequest& setAuthorizedDeviceCount(int32_t authorizedDeviceCount) { DARABONBA_PTR_SET_VALUE(authorizedDeviceCount_, authorizedDeviceCount) };
    ...
    inline UpdateMemberRequest& setContactor(string contactor) { DARABONBA_PTR_SET_VALUE(contactor_, contactor) };
    ...
    inline UpdateMemberRequest& setMemberId(string memberId) { DARABONBA_PTR_SET_VALUE(memberId_, memberId) };
    ...
    inline UpdateMemberRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline UpdateMemberRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline UpdateMemberRequest& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline UpdateMemberRequest& setTelephony(string telephony) { DARABONBA_PTR_SET_VALUE(telephony_, telephony) };
    ...
    inline UpdateMemberRequest& setUid(string uid) { DARABONBA_PTR_SET_VALUE(uid_, uid) };
