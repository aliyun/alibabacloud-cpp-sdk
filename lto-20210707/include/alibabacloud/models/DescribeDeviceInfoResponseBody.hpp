...
namespace Models
{
  ...
  public:
    ...
    inline DescribeDeviceInfoResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DescribeDeviceInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDeviceInfoResponseBodyData) };
    inline DescribeDeviceInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDeviceInfoResponseBodyData) };
    inline DescribeDeviceInfoResponseBody& setData(const DescribeDeviceInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDeviceInfoResponseBody& setData(DescribeDeviceInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeDeviceInfoResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline DescribeDeviceInfoResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DescribeDeviceInfoResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    std::shared_ptr<string> code_ = nullptr;
    std::shared_ptr<DescribeDeviceInfoResponseBodyData> data_ = nullptr;
