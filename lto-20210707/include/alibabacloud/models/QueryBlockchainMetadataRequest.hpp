...
#ifndef ALIBABACLOUD_MODELS_QUERYBLOCKCHAINMETADATAREQUEST_HPP_
#define ALIBABACLOUD_MODELS_QUERYBLOCKCHAINMETADATAREQUEST_HPP_
...
namespace Models
{
  class QueryBlockchainMetadataRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryBlockchainMetadataRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryBlockchainMetadataRequest& obj) { 
    ...
    QueryBlockchainMetadataRequest() = default ;
    QueryBlockchainMetadataRequest(const QueryBlockchainMetadataRequest &) = default ;
    QueryBlockchainMetadataRequest(QueryBlockchainMetadataRequest &&) = default ;
    QueryBlockchainMetadataRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryBlockchainMetadataRequest() = default ;
    QueryBlockchainMetadataRequest& operator=(const QueryBlockchainMetadataRequest &) = default ;
    QueryBlockchainMetadataRequest& operator=(QueryBlockchainMetadataRequest &&) = default ;
    ...
    inline QueryBlockchainMetadataRequest& setBizChainId(string bizChainId) { DARABONBA_PTR_SET_VALUE(bizChainId_, bizChainId) };
    ...
    inline QueryBlockchainMetadataRequest& setContractName(string contractName) { DARABONBA_PTR_SET_VALUE(contractName_, contractName) };
    ...
    inline QueryBlockchainMetadataRequest& setInvokeType(string invokeType) { DARABONBA_PTR_SET_VALUE(invokeType_, invokeType) };
    ...
    inline QueryBlockchainMetadataRequest& setIotDataDID(string iotDataDID) { DARABONBA_PTR_SET_VALUE(iotDataDID_, iotDataDID) };
    ...
    inline QueryBlockchainMetadataRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline QueryBlockchainMetadataRequest& setTransactionId(string transactionId) { DARABONBA_PTR_SET_VALUE(transactionId_, transactionId) };
