...
namespace Models
{
  ...
  public:
    ...
    inline const SaveWebRTCStatsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveWebRTCStatsResponseBody) };
    inline SaveWebRTCStatsResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveWebRTCStatsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveWebRTCStatsResponseBody> body_ {};
  };
