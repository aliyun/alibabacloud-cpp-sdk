...
namespace Models
{
  ...
  public:
    ...
    inline const StartPredictiveCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, StartPredictiveCallResponseBody::Data) };
    inline StartPredictiveCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, StartPredictiveCallResponseBody::Data) };
    inline StartPredictiveCallResponseBody& setData(const StartPredictiveCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StartPredictiveCallResponseBody& setData(StartPredictiveCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
