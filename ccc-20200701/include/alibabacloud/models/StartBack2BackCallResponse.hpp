...
namespace Models
{
  ...
  public:
    ...
    inline const StartBack2BackCallResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartBack2BackCallResponseBody) };
    inline StartBack2BackCallResponseBody getBody() { DARABONBA_PTR_GET(body_, StartBack2BackCallResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartBack2BackCallResponseBody> body_ {};
  };
