...
namespace Models
{
  ...
  public:
    ...
    inline const GetUploadAudioDataParamsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUploadAudioDataParamsResponseBody) };
    inline GetUploadAudioDataParamsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUploadAudioDataParamsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUploadAudioDataParamsResponseBody> body_ {};
  };
