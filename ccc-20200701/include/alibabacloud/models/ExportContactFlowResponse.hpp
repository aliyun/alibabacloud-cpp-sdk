...
namespace Models
{
  ...
  public:
    ...
    inline const ExportContactFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExportContactFlowResponseBody) };
    inline ExportContactFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, ExportContactFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExportContactFlowResponseBody> body_ {};
  };
