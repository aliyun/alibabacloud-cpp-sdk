...
namespace Models
{
  ...
  public:
    ...
    inline const CoachCallResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CoachCallResponseBody) };
    inline CoachCallResponseBody getBody() { DARABONBA_PTR_GET(body_, CoachCallResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CoachCallResponseBody> body_ {};
  };
