...
namespace Models
{
  ...
  public:
    ...
    inline const ListUnassignedNumbersResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListUnassignedNumbersResponseBody::Data) };
    inline ListUnassignedNumbersResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListUnassignedNumbersResponseBody::Data) };
    inline ListUnassignedNumbersResponseBody& setData(const ListUnassignedNumbersResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListUnassignedNumbersResponseBody& setData(ListUnassignedNumbersResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
