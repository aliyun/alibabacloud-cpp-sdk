...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Data& setCloseCode(string closeCode) { DARABONBA_PTR_SET_VALUE(closeCode_, closeCode) };
      ...
      inline Data& setCurrentTaskId(string currentTaskId) { DARABONBA_PTR_SET_VALUE(currentTaskId_, currentTaskId) };
      ...
      inline Data& setCurrentTaskName(string currentTaskName) { DARABONBA_PTR_SET_VALUE(currentTaskName_, currentTaskName) };
      ...
      inline Data& setCurrentTaskStartTime(int64_t currentTaskStartTime) { DARABONBA_PTR_SET_VALUE(currentTaskStartTime_, currentTaskStartTime) };
    ...
    inline GetTicketResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetTicketResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetTicketResponseBody::Data) };
    inline GetTicketResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetTicketResponseBody::Data) };
    inline GetTicketResponseBody& setData(const GetTicketResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTicketResponseBody& setData(GetTicketResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetTicketResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetTicketResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline GetTicketResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
