...
namespace Models
{
  ...
  public:
    ...
    inline const ListOutboundNumbersOfUserResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListOutboundNumbersOfUserResponseBodyData) };
    inline ListOutboundNumbersOfUserResponseBodyData data() { DARABONBA_PTR_GET(data_, ListOutboundNumbersOfUserResponseBodyData) };
    inline ListOutboundNumbersOfUserResponseBody& setData(const ListOutboundNumbersOfUserResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListOutboundNumbersOfUserResponseBody& setData(ListOutboundNumbersOfUserResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListOutboundNumbersOfUserResponseBodyData> data_ = nullptr;
