...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSchemaPropertyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSchemaPropertyResponseBody) };
    inline DeleteSchemaPropertyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSchemaPropertyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSchemaPropertyResponseBody> body_ {};
  };
