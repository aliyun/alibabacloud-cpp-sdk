...
#ifndef ALIBABACLOUD_MODELS_BLINDTRANSFERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_BLINDTRANSFERRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const BlindTransferResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, BlindTransferResponseBody& obj) { 
    ...
    BlindTransferResponseBody() = default ;
    BlindTransferResponseBody(const BlindTransferResponseBody &) = default ;
    BlindTransferResponseBody(BlindTransferResponseBody &&) = default ;
    BlindTransferResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BlindTransferResponseBody() = default ;
    BlindTransferResponseBody& operator=(const BlindTransferResponseBody &) = default ;
    BlindTransferResponseBody& operator=(BlindTransferResponseBody &&) = default ;
    ...
    inline BlindTransferResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const BlindTransferResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, BlindTransferResponseBody::Data) };
    inline BlindTransferResponseBody::Data getData() { DARABONBA_PTR_GET(data_, BlindTransferResponseBody::Data) };
    inline BlindTransferResponseBody& setData(const BlindTransferResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BlindTransferResponseBody& setData(BlindTransferResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline BlindTransferResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline BlindTransferResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline BlindTransferResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline BlindTransferResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline BlindTransferResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<BlindTransferResponseBody::Data> data_ {};
