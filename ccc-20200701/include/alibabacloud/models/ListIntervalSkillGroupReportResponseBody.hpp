...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListIntervalSkillGroupReportResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListIntervalSkillGroupReportResponseBodyData>) };
    inline vector<ListIntervalSkillGroupReportResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListIntervalSkillGroupReportResponseBodyData>) };
    inline ListIntervalSkillGroupReportResponseBody& setData(const vector<ListIntervalSkillGroupReportResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIntervalSkillGroupReportResponseBody& setData(vector<ListIntervalSkillGroupReportResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListIntervalSkillGroupReportResponseBodyData>> data_ = nullptr;
