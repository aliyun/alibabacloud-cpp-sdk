...
#ifndef ALIBABACLOUD_MODELS_ANSWERCALLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ANSWERCALLRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AnswerCallResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AnswerCallResponseBody& obj) { 
    ...
    AnswerCallResponseBody() = default ;
    AnswerCallResponseBody(const AnswerCallResponseBody &) = default ;
    AnswerCallResponseBody(AnswerCallResponseBody &&) = default ;
    AnswerCallResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AnswerCallResponseBody() = default ;
    AnswerCallResponseBody& operator=(const AnswerCallResponseBody &) = default ;
    AnswerCallResponseBody& operator=(AnswerCallResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->timestamp_ == nullptr && this->userExtension_ == nullptr && this->userId_ == nullptr; };
          ...
          inline ChannelContexts& setIndex(int64_t index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline AnswerCallResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const AnswerCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, AnswerCallResponseBody::Data) };
    inline AnswerCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, AnswerCallResponseBody::Data) };
    inline AnswerCallResponseBody& setData(const AnswerCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AnswerCallResponseBody& setData(AnswerCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline AnswerCallResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline AnswerCallResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline AnswerCallResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline AnswerCallResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline AnswerCallResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<AnswerCallResponseBody::Data> data_ {};
