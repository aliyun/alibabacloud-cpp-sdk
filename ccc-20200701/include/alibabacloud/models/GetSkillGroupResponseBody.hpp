...
namespace Models
{
  ...
  public:
    ...
    inline const GetSkillGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSkillGroupResponseBodyData) };
    inline GetSkillGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSkillGroupResponseBodyData) };
    inline GetSkillGroupResponseBody& setData(const GetSkillGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSkillGroupResponseBody& setData(GetSkillGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSkillGroupResponseBodyData> data_ = nullptr;
