...
namespace Models
{
  ...
  public:
    ...
    inline const BridgeRtcCallResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, BridgeRtcCallResponseBodyData) };
    inline BridgeRtcCallResponseBodyData data() { DARABONBA_PTR_GET(data_, BridgeRtcCallResponseBodyData) };
    inline BridgeRtcCallResponseBody& setData(const BridgeRtcCallResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BridgeRtcCallResponseBody& setData(BridgeRtcCallResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<BridgeRtcCallResponseBodyData> data_ = nullptr;
