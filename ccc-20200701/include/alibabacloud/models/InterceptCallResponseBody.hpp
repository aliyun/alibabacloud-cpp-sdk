...
namespace Models
{
  ...
  public:
    ...
    inline const InterceptCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, InterceptCallResponseBody::Data) };
    inline InterceptCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, InterceptCallResponseBody::Data) };
    inline InterceptCallResponseBody& setData(const InterceptCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline InterceptCallResponseBody& setData(InterceptCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
