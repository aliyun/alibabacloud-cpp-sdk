...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->pagedSkillGroupSummaryReport_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ListSkillGroupSummaryReportsSinceMidnightResponseBodyPagedSkillGroupSummaryReport & pagedSkillGroupSummaryReport() const { DARABONBA_PTR_GET_CONST(pagedSkillGroupSummaryReport_, ListSkillGroupSummaryReportsSinceMidnightResponseBodyPagedSkillGroupSummaryReport) };
    inline ListSkillGroupSummaryReportsSinceMidnightResponseBodyPagedSkillGroupSummaryReport pagedSkillGroupSummaryReport() { DARABONBA_PTR_GET(pagedSkillGroupSummaryReport_, ListSkillGroupSummaryReportsSinceMidnightResponseBodyPagedSkillGroupSummaryReport) };
    inline ListSkillGroupSummaryReportsSinceMidnightResponseBody& setPagedSkillGroupSummaryReport(const ListSkillGroupSummaryReportsSinceMidnightResponseBodyPagedSkillGroupSummaryReport & pagedSkillGroupSummaryReport) { DARABONBA_PTR_SET_VALUE(pagedSkillGroupSummaryReport_, pagedSkillGroupSummaryReport) };
    inline ListSkillGroupSummaryReportsSinceMidnightResponseBody& setPagedSkillGroupSummaryReport(ListSkillGroupSummaryReportsSinceMidnightResponseBodyPagedSkillGroupSummaryReport && pagedSkillGroupSummaryReport) { DARABONBA_PTR_SET_RVALUE(pagedSkillGroupSummaryReport_, pagedSkillGroupSummaryReport) };
  ...
  protected:
    ...
    std::shared_ptr<ListSkillGroupSummaryReportsSinceMidnightResponseBodyPagedSkillGroupSummaryReport> pagedSkillGroupSummaryReport_ = nullptr;
