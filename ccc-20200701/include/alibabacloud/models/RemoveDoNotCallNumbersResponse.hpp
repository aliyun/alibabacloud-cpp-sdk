...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveDoNotCallNumbersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveDoNotCallNumbersResponseBody) };
    inline RemoveDoNotCallNumbersResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveDoNotCallNumbersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveDoNotCallNumbersResponseBody> body_ {};
  };
