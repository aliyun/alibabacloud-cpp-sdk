...
#ifndef ALIBABACLOUD_MODELS_LISTINTERVALINSTANCEREPORTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTINTERVALINSTANCEREPORTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListIntervalInstanceReportResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListIntervalInstanceReportResponseBody& obj) { 
    ...
    ListIntervalInstanceReportResponseBody() = default ;
    ListIntervalInstanceReportResponseBody(const ListIntervalInstanceReportResponseBody &) = default ;
    ListIntervalInstanceReportResponseBody(ListIntervalInstanceReportResponseBody &&) = default ;
    ListIntervalInstanceReportResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIntervalInstanceReportResponseBody() = default ;
    ListIntervalInstanceReportResponseBody& operator=(const ListIntervalInstanceReportResponseBody &) = default ;
    ListIntervalInstanceReportResponseBody& operator=(ListIntervalInstanceReportResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline Inbound& setAbandonedRate(float abandonedRate) { DARABONBA_PTR_SET_VALUE(abandonedRate_, abandonedRate) };
    ...
    inline ListIntervalInstanceReportResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListIntervalInstanceReportResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListIntervalInstanceReportResponseBody::Data>) };
    inline vector<ListIntervalInstanceReportResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListIntervalInstanceReportResponseBody::Data>) };
    inline ListIntervalInstanceReportResponseBody& setData(const vector<ListIntervalInstanceReportResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIntervalInstanceReportResponseBody& setData(vector<ListIntervalInstanceReportResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListIntervalInstanceReportResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListIntervalInstanceReportResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListIntervalInstanceReportResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<vector<ListIntervalInstanceReportResponseBody::Data>> data_ {};
