...
namespace Models
{
  ...
  public:
    ...
    inline const AddPhoneNumberToSkillGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddPhoneNumberToSkillGroupsResponseBody) };
    inline AddPhoneNumberToSkillGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, AddPhoneNumberToSkillGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddPhoneNumberToSkillGroupsResponseBody> body_ {};
  };
