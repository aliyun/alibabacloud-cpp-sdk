...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->abandonRate_ == nullptr
        && return this->averageAbandonTime_ == nullptr && return this->averageAbandonedInQueueTime_ == nullptr && return this->averageAbandonedInRingTime_ == nullptr && return this->averageFirstResponseTime_ == nullptr && return this->averageHoldTime_ == nullptr
        && return this->averageResponseTime_ == nullptr && return this->averageRingTime_ == nullptr && return this->averageTalkTime_ == nullptr && return this->averageWaitTime_ == nullptr && return this->averageWorkTime_ == nullptr
        && return this->callsAbandoned_ == nullptr && return this->callsAbandonedInQueue_ == nullptr && return this->callsAbandonedInRing_ == nullptr && return this->callsAttendedTransferIn_ == nullptr && return this->callsAttendedTransferOut_ == nullptr
        && return this->callsBlindTransferIn_ == nullptr && return this->callsBlindTransferOut_ == nullptr && return this->callsHandled_ == nullptr && return this->callsHold_ == nullptr && return this->callsOffered_ == nullptr
        && return this->callsOverflow_ == nullptr && return this->callsQueued_ == nullptr && return this->callsQueuingOverflow_ == nullptr && return this->callsQueuingTimeout_ == nullptr && return this->callsRinged_ == nullptr
        && return this->callsTimeout_ == nullptr && return this->handleRate_ == nullptr && return this->maxAbandonTime_ == nullptr && return this->maxAbandonedInQueueTime_ == nullptr && return this->maxAbandonedInRingTime_ == nullptr
        && return this->maxHoldTime_ == nullptr && return this->maxRingTime_ == nullptr && return this->maxTalkTime_ == nullptr && return this->maxWaitTime_ == nullptr && return this->maxWorkTime_ == nullptr
        && return this->satisfactionIndex_ == nullptr && return this->satisfactionRate_ == nullptr && return this->satisfactionSurveysOffered_ == nullptr && return this->satisfactionSurveysResponded_ == nullptr && return this->serviceLevel20_ == nullptr
        && return this->totalAbandonTime_ == nullptr && return this->totalAbandonedInQueueTime_ == nullptr && return this->totalAbandonedInRingTime_ == nullptr && return this->totalHoldTime_ == nullptr && return this->totalMessagesSent_ == nullptr
