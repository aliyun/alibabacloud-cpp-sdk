...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateChatRoutingProfileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateChatRoutingProfileResponseBody) };
    inline UpdateChatRoutingProfileResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateChatRoutingProfileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateChatRoutingProfileResponseBody> body_ {};
  };
