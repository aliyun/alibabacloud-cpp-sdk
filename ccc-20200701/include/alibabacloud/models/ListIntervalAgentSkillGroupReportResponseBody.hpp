...
#ifndef ALIBABACLOUD_MODELS_LISTINTERVALAGENTSKILLGROUPREPORTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTINTERVALAGENTSKILLGROUPREPORTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListIntervalAgentSkillGroupReportResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListIntervalAgentSkillGroupReportResponseBody& obj) { 
    ...
    ListIntervalAgentSkillGroupReportResponseBody() = default ;
    ListIntervalAgentSkillGroupReportResponseBody(const ListIntervalAgentSkillGroupReportResponseBody &) = default ;
    ListIntervalAgentSkillGroupReportResponseBody(ListIntervalAgentSkillGroupReportResponseBody &&) = default ;
    ListIntervalAgentSkillGroupReportResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIntervalAgentSkillGroupReportResponseBody() = default ;
    ListIntervalAgentSkillGroupReportResponseBody& operator=(const ListIntervalAgentSkillGroupReportResponseBody &) = default ;
    ListIntervalAgentSkillGroupReportResponseBody& operator=(ListIntervalAgentSkillGroupReportResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline string getTotalOffSiteLoggedInTime() const { DARABONBA_PTR_GET_DEFAULT(totalOffSiteLoggedInTime_, "") };
        inline Overall& setTotalOffSiteLoggedInTime(string totalOffSiteLoggedInTime) { DARABONBA_PTR_SET_VALUE(totalOffSiteLoggedInTime_, totalOffSiteLoggedInTime) };
        ...
        inline string getTotalOfficePhoneLoggedInTime() const { DARABONBA_PTR_GET_DEFAULT(totalOfficePhoneLoggedInTime_, "") };
        inline Overall& setTotalOfficePhoneLoggedInTime(string totalOfficePhoneLoggedInTime) { DARABONBA_PTR_SET_VALUE(totalOfficePhoneLoggedInTime_, totalOfficePhoneLoggedInTime) };
        ...
        inline string getTotalOnSiteLoggedInTime() const { DARABONBA_PTR_GET_DEFAULT(totalOnSiteLoggedInTime_, "") };
        inline Overall& setTotalOnSiteLoggedInTime(string totalOnSiteLoggedInTime) { DARABONBA_PTR_SET_VALUE(totalOnSiteLoggedInTime_, totalOnSiteLoggedInTime) };
      ...
      public:
        ...
        && this->agentHandleRate_ == nullptr && this->answerRate_ == nullptr && this->averageCustomerRingTime_ == nullptr && this->averageRingTime_ == nullptr && this->averageTalkTime_ == nullptr
        && this->callsAgentHandled_ == nullptr && this->callsAnswered_ == nullptr && this->callsCustomerAnswered_ == nullptr && this->callsCustomerHandled_ == nullptr && this->callsDialed_ == nullptr
        && this->customerAnswerRate_ == nullptr && this->customerHandleRate_ == nullptr && this->maxCustomerRingTime_ == nullptr && this->maxRingTime_ == nullptr && this->maxTalkTime_ == nullptr
        && this->totalCustomerRingTime_ == nullptr && this->totalRingTime_ == nullptr && this->totalTalkTime_ == nullptr; };
      ...
      virtual bool empty() const override { return this->back2Back_ == nullptr
        && this->inbound_ == nullptr && this->internal_ == nullptr && this->outbound_ == nullptr && this->overall_ == nullptr && this->statsTime_ == nullptr; };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListIntervalAgentSkillGroupReportResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListIntervalAgentSkillGroupReportResponseBody::Data>) };
    inline vector<ListIntervalAgentSkillGroupReportResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListIntervalAgentSkillGroupReportResponseBody::Data>) };
    inline ListIntervalAgentSkillGroupReportResponseBody& setData(const vector<ListIntervalAgentSkillGroupReportResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIntervalAgentSkillGroupReportResponseBody& setData(vector<ListIntervalAgentSkillGroupReportResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
