...
namespace Models
{
  ...
  public:
    ...
    inline const ReadyForServiceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ReadyForServiceResponseBody::Data) };
    inline ReadyForServiceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ReadyForServiceResponseBody::Data) };
    inline ReadyForServiceResponseBody& setData(const ReadyForServiceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ReadyForServiceResponseBody& setData(ReadyForServiceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
