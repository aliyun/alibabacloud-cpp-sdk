...
namespace Models
{
  ...
  public:
    ...
    inline const ListBriefSkillGroupsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListBriefSkillGroupsResponseBody::Data) };
    inline ListBriefSkillGroupsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListBriefSkillGroupsResponseBody::Data) };
    inline ListBriefSkillGroupsResponseBody& setData(const ListBriefSkillGroupsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListBriefSkillGroupsResponseBody& setData(ListBriefSkillGroupsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
