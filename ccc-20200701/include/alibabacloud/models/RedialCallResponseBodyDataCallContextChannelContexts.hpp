...
#ifndef ALIBABACLOUD_MODELS_REDIALCALLRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
#define ALIBABACLOUD_MODELS_REDIALCALLRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RedialCallResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RedialCallResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    RedialCallResponseBodyDataCallContextChannelContexts() = default ;
    RedialCallResponseBodyDataCallContextChannelContexts(const RedialCallResponseBodyDataCallContextChannelContexts &) = default ;
    RedialCallResponseBodyDataCallContextChannelContexts(RedialCallResponseBodyDataCallContextChannelContexts &&) = default ;
    RedialCallResponseBodyDataCallContextChannelContexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RedialCallResponseBodyDataCallContextChannelContexts() = default ;
    RedialCallResponseBodyDataCallContextChannelContexts& operator=(const RedialCallResponseBodyDataCallContextChannelContexts &) = default ;
    RedialCallResponseBodyDataCallContextChannelContexts& operator=(RedialCallResponseBodyDataCallContextChannelContexts &&) = default ;
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setCallType(string callType) { DARABONBA_PTR_SET_VALUE(callType_, callType) };
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setChannelFlags(string channelFlags) { DARABONBA_PTR_SET_VALUE(channelFlags_, channelFlags) };
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setChannelState(string channelState) { DARABONBA_PTR_SET_VALUE(channelState_, channelState) };
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setDestination(string destination) { DARABONBA_PTR_SET_VALUE(destination_, destination) };
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setOriginator(string originator) { DARABONBA_PTR_SET_VALUE(originator_, originator) };
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setReleaseInitiator(string releaseInitiator) { DARABONBA_PTR_SET_VALUE(releaseInitiator_, releaseInitiator) };
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setReleaseReason(string releaseReason) { DARABONBA_PTR_SET_VALUE(releaseReason_, releaseReason) };
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setUserExtension(string userExtension) { DARABONBA_PTR_SET_VALUE(userExtension_, userExtension) };
    ...
    inline RedialCallResponseBodyDataCallContextChannelContexts& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
