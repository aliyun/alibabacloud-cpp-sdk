...
namespace Models
{
  ...
  public:
    ...
    inline const GetTicketSummaryReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTicketSummaryReportResponseBody) };
    inline GetTicketSummaryReportResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTicketSummaryReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTicketSummaryReportResponseBody> body_ {};
  };
