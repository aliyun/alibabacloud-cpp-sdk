...
namespace Models
{
  ...
  public:
    ...
    inline const LaunchSurveyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, LaunchSurveyResponseBody) };
    inline LaunchSurveyResponseBody getBody() { DARABONBA_PTR_GET(body_, LaunchSurveyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<LaunchSurveyResponseBody> body_ {};
  };
