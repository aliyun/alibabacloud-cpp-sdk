...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCampaignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateCampaignResponseBody) };
    inline UpdateCampaignResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateCampaignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateCampaignResponseBody> body_ {};
  };
