...
namespace Models
{
  ...
  public:
    ...
    inline const InitiateAttendedTransferResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, InitiateAttendedTransferResponseBody::Data) };
    inline InitiateAttendedTransferResponseBody::Data getData() { DARABONBA_PTR_GET(data_, InitiateAttendedTransferResponseBody::Data) };
    inline InitiateAttendedTransferResponseBody& setData(const InitiateAttendedTransferResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline InitiateAttendedTransferResponseBody& setData(InitiateAttendedTransferResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<InitiateAttendedTransferResponseBody::Data> data_ {};
