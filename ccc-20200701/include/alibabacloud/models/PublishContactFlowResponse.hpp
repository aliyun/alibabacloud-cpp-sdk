...
namespace Models
{
  ...
  public:
    ...
    inline const PublishContactFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PublishContactFlowResponseBody) };
    inline PublishContactFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, PublishContactFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PublishContactFlowResponseBody> body_ {};
  };
