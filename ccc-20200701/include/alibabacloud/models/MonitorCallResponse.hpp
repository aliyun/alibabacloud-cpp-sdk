...
namespace Models
{
  ...
  public:
    ...
    inline const MonitorCallResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MonitorCallResponseBody) };
    inline MonitorCallResponseBody getBody() { DARABONBA_PTR_GET(body_, MonitorCallResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MonitorCallResponseBody> body_ {};
  };
