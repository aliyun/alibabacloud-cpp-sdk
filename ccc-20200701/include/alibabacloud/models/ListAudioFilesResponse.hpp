...
namespace Models
{
  ...
  public:
    ...
    inline const ListAudioFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAudioFilesResponseBody) };
    inline ListAudioFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAudioFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAudioFilesResponseBody> body_ {};
  };
