...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentDropCall_ == nullptr
        && return this->agentNo_ == nullptr && return this->aliHangupCause_ == nullptr && return this->callDir_ == nullptr && return this->callId_ == nullptr && return this->callType_ == nullptr
        && return this->calleeId_ == nullptr && return this->callerId_ == nullptr && return this->connId_ == nullptr && return this->extend1_ == nullptr && return this->extend2_ == nullptr
        && return this->extend3_ == nullptr && return this->extend4_ == nullptr && return this->groupNo_ == nullptr && return this->monitedAgentNo_ == nullptr && return this->monitedAgentPhoneNo_ == nullptr
        && return this->outboundScenario_ == nullptr && return this->phoneNo_ == nullptr && return this->statisticDate_ == nullptr && return this->statisticTime_ == nullptr && return this->status_ == nullptr
        && return this->targetRequest_ == nullptr && return this->targetSelect_ == nullptr && return this->tenantId_ == nullptr && return this->transferNo_ == nullptr && return this->transferNumber_ == nullptr; };
