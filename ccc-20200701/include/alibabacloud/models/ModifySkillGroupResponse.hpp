...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySkillGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySkillGroupResponseBody) };
    inline ModifySkillGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySkillGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySkillGroupResponseBody> body_ {};
  };
