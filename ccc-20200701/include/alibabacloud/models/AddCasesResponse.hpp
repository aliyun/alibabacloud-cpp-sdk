...
namespace Models
{
  ...
  public:
    ...
    inline const AddCasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddCasesResponseBody) };
    inline AddCasesResponseBody getBody() { DARABONBA_PTR_GET(body_, AddCasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddCasesResponseBody> body_ {};
  };
