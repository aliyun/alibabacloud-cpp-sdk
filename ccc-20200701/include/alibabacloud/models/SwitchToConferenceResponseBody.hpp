...
#ifndef ALIBABACLOUD_MODELS_SWITCHTOCONFERENCERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SWITCHTOCONFERENCERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SwitchToConferenceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SwitchToConferenceResponseBody& obj) { 
    ...
    SwitchToConferenceResponseBody() = default ;
    SwitchToConferenceResponseBody(const SwitchToConferenceResponseBody &) = default ;
    SwitchToConferenceResponseBody(SwitchToConferenceResponseBody &&) = default ;
    SwitchToConferenceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SwitchToConferenceResponseBody() = default ;
    SwitchToConferenceResponseBody& operator=(const SwitchToConferenceResponseBody &) = default ;
    SwitchToConferenceResponseBody& operator=(SwitchToConferenceResponseBody &&) = default ;
    ...
    inline SwitchToConferenceResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const SwitchToConferenceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SwitchToConferenceResponseBody::Data) };
    inline SwitchToConferenceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SwitchToConferenceResponseBody::Data) };
    inline SwitchToConferenceResponseBody& setData(const SwitchToConferenceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SwitchToConferenceResponseBody& setData(SwitchToConferenceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline SwitchToConferenceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline SwitchToConferenceResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline SwitchToConferenceResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline SwitchToConferenceResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline SwitchToConferenceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<SwitchToConferenceResponseBody::Data> data_ {};
