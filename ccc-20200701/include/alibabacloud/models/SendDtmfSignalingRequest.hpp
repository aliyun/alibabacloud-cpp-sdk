...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->channelId_ == nullptr
        && this->deviceId_ == nullptr && this->dtmf_ == nullptr && this->instanceId_ == nullptr && this->jobId_ == nullptr && this->userId_ == nullptr; };
    ...
    inline string getDtmf() const { DARABONBA_PTR_GET_DEFAULT(dtmf_, "") };
