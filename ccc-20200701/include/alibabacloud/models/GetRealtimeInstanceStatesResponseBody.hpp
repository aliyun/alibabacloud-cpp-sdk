...
namespace Models
{
  ...
  public:
    ...
    inline const GetRealtimeInstanceStatesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRealtimeInstanceStatesResponseBodyData) };
    inline GetRealtimeInstanceStatesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRealtimeInstanceStatesResponseBodyData) };
    inline GetRealtimeInstanceStatesResponseBody& setData(const GetRealtimeInstanceStatesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRealtimeInstanceStatesResponseBody& setData(GetRealtimeInstanceStatesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetRealtimeInstanceStatesResponseBodyData> data_ = nullptr;
