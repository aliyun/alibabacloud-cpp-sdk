...
namespace Models
{
  ...
  public:
    ...
    inline const ListCampaignsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCampaignsResponseBodyData) };
    inline ListCampaignsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCampaignsResponseBodyData) };
    inline ListCampaignsResponseBody& setData(const ListCampaignsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCampaignsResponseBody& setData(ListCampaignsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListCampaignsResponseBodyData> data_ = nullptr;
