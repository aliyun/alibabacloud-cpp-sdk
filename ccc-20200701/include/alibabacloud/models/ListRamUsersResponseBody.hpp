...
namespace Models
{
  ...
  public:
    ...
    inline const ListRamUsersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListRamUsersResponseBodyData) };
    inline ListRamUsersResponseBodyData data() { DARABONBA_PTR_GET(data_, ListRamUsersResponseBodyData) };
    inline ListRamUsersResponseBody& setData(const ListRamUsersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListRamUsersResponseBody& setData(ListRamUsersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListRamUsersResponseBodyData> data_ = nullptr;
