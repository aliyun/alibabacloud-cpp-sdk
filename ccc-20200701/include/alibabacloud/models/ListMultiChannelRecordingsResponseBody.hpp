...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListMultiChannelRecordingsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListMultiChannelRecordingsResponseBodyData>) };
    inline vector<ListMultiChannelRecordingsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListMultiChannelRecordingsResponseBodyData>) };
    inline ListMultiChannelRecordingsResponseBody& setData(const vector<ListMultiChannelRecordingsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMultiChannelRecordingsResponseBody& setData(vector<ListMultiChannelRecordingsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListMultiChannelRecordingsResponseBodyData>> data_ = nullptr;
