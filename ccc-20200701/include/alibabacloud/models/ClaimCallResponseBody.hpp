...
#ifndef ALIBABACLOUD_MODELS_CLAIMCALLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CLAIMCALLRESPONSEBODY_HPP_
...
namespace Models
{
  class ClaimCallResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ClaimCallResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ClaimCallResponseBody& obj) { 
    ...
    ClaimCallResponseBody() = default ;
    ClaimCallResponseBody(const ClaimCallResponseBody &) = default ;
    ClaimCallResponseBody(ClaimCallResponseBody &&) = default ;
    ClaimCallResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ClaimCallResponseBody() = default ;
    ClaimCallResponseBody& operator=(const ClaimCallResponseBody &) = default ;
    ClaimCallResponseBody& operator=(ClaimCallResponseBody &&) = default ;
    ...
    inline ClaimCallResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ClaimCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ClaimCallResponseBody::Data) };
    inline ClaimCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ClaimCallResponseBody::Data) };
    inline ClaimCallResponseBody& setData(const ClaimCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ClaimCallResponseBody& setData(ClaimCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ClaimCallResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ClaimCallResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ClaimCallResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline ClaimCallResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline ClaimCallResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
