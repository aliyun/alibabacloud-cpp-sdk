...
#ifndef ALIBABACLOUD_MODELS_COMPLETEATTENDEDTRANSFERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_COMPLETEATTENDEDTRANSFERRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CompleteAttendedTransferResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CompleteAttendedTransferResponseBody& obj) { 
    ...
    CompleteAttendedTransferResponseBody() = default ;
    CompleteAttendedTransferResponseBody(const CompleteAttendedTransferResponseBody &) = default ;
    CompleteAttendedTransferResponseBody(CompleteAttendedTransferResponseBody &&) = default ;
    CompleteAttendedTransferResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CompleteAttendedTransferResponseBody() = default ;
    CompleteAttendedTransferResponseBody& operator=(const CompleteAttendedTransferResponseBody &) = default ;
    CompleteAttendedTransferResponseBody& operator=(CompleteAttendedTransferResponseBody &&) = default ;
    ...
    inline CompleteAttendedTransferResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CompleteAttendedTransferResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CompleteAttendedTransferResponseBody::Data) };
    inline CompleteAttendedTransferResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CompleteAttendedTransferResponseBody::Data) };
    inline CompleteAttendedTransferResponseBody& setData(const CompleteAttendedTransferResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CompleteAttendedTransferResponseBody& setData(CompleteAttendedTransferResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CompleteAttendedTransferResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CompleteAttendedTransferResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CompleteAttendedTransferResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline CompleteAttendedTransferResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline CompleteAttendedTransferResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<CompleteAttendedTransferResponseBody::Data> data_ {};
