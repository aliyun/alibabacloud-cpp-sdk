...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAudioFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAudioFileResponseBody) };
    inline CreateAudioFileResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAudioFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAudioFileResponseBody> body_ {};
  };
