...
#ifndef ALIBABACLOUD_MODELS_SIGNOUTGROUPRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_SIGNOUTGROUPRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SignOutGroupResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SignOutGroupResponseBodyData& obj) { 
    ...
    SignOutGroupResponseBodyData() = default ;
    SignOutGroupResponseBodyData(const SignOutGroupResponseBodyData &) = default ;
    SignOutGroupResponseBodyData(SignOutGroupResponseBodyData &&) = default ;
    SignOutGroupResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SignOutGroupResponseBodyData() = default ;
    SignOutGroupResponseBodyData& operator=(const SignOutGroupResponseBodyData &) = default ;
    SignOutGroupResponseBodyData& operator=(SignOutGroupResponseBodyData &&) = default ;
    ...
    inline SignOutGroupResponseBodyData& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline SignOutGroupResponseBodyData& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline SignOutGroupResponseBodyData& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline SignOutGroupResponseBodyData& setHeartbeat(int64_t heartbeat) { DARABONBA_PTR_SET_VALUE(heartbeat_, heartbeat) };
    ...
    inline SignOutGroupResponseBodyData& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline SignOutGroupResponseBodyData& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline SignOutGroupResponseBodyData& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline SignOutGroupResponseBodyData& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline SignOutGroupResponseBodyData& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline SignOutGroupResponseBodyData& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline SignOutGroupResponseBodyData& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline SignOutGroupResponseBodyData& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline SignOutGroupResponseBodyData& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline SignOutGroupResponseBodyData& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
