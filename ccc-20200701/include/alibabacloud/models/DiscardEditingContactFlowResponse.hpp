...
namespace Models
{
  ...
  public:
    ...
    inline const DiscardEditingContactFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DiscardEditingContactFlowResponseBody) };
    inline DiscardEditingContactFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, DiscardEditingContactFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DiscardEditingContactFlowResponseBody> body_ {};
  };
