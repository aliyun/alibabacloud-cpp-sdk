...
namespace Models
{
  ...
  public:
    ...
    inline const RestoreArchivedRecordingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RestoreArchivedRecordingsResponseBody) };
    inline RestoreArchivedRecordingsResponseBody getBody() { DARABONBA_PTR_GET(body_, RestoreArchivedRecordingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RestoreArchivedRecordingsResponseBody> body_ {};
  };
