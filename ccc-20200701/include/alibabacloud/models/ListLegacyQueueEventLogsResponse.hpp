...
namespace Models
{
  ...
  public:
    ...
    inline const ListLegacyQueueEventLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLegacyQueueEventLogsResponseBody) };
    inline ListLegacyQueueEventLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLegacyQueueEventLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLegacyQueueEventLogsResponseBody> body_ {};
  };
