...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getContactIdList() const { DARABONBA_PTR_GET_CONST(contactIdList_, vector<string>) };
    inline vector<string> getContactIdList() { DARABONBA_PTR_GET(contactIdList_, vector<string>) };
