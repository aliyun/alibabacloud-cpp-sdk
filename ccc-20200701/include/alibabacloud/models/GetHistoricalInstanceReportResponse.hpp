...
namespace Models
{
  ...
  public:
    ...
    inline const GetHistoricalInstanceReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHistoricalInstanceReportResponseBody) };
    inline GetHistoricalInstanceReportResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHistoricalInstanceReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHistoricalInstanceReportResponseBody> body_ {};
  };
