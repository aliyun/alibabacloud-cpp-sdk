...
namespace Models
{
  ...
  public:
    ...
    inline const GetHistoricalInstanceReportResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHistoricalInstanceReportResponseBodyData) };
    inline GetHistoricalInstanceReportResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHistoricalInstanceReportResponseBodyData) };
    inline GetHistoricalInstanceReportResponseBody& setData(const GetHistoricalInstanceReportResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHistoricalInstanceReportResponseBody& setData(GetHistoricalInstanceReportResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHistoricalInstanceReportResponseBodyData> data_ = nullptr;
