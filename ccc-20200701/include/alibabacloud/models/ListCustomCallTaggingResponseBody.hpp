...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomCallTaggingResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCustomCallTaggingResponseBodyData) };
    inline ListCustomCallTaggingResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCustomCallTaggingResponseBodyData) };
    inline ListCustomCallTaggingResponseBody& setData(const ListCustomCallTaggingResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCustomCallTaggingResponseBody& setData(ListCustomCallTaggingResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListCustomCallTaggingResponseBodyData> data_ = nullptr;
