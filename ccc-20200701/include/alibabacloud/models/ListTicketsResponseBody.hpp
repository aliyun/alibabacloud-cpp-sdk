...
namespace Models
{
  ...
  public:
    ...
    inline const ListTicketsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListTicketsResponseBodyData) };
    inline ListTicketsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListTicketsResponseBodyData) };
    inline ListTicketsResponseBody& setData(const ListTicketsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTicketsResponseBody& setData(ListTicketsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListTicketsResponseBodyData> data_ = nullptr;
