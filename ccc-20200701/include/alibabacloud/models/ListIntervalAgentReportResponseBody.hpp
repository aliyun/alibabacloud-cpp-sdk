...
#ifndef ALIBABACLOUD_MODELS_LISTINTERVALAGENTREPORTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTINTERVALAGENTREPORTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListIntervalAgentReportResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListIntervalAgentReportResponseBody& obj) { 
    ...
    ListIntervalAgentReportResponseBody() = default ;
    ListIntervalAgentReportResponseBody(const ListIntervalAgentReportResponseBody &) = default ;
    ListIntervalAgentReportResponseBody(ListIntervalAgentReportResponseBody &&) = default ;
    ListIntervalAgentReportResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIntervalAgentReportResponseBody() = default ;
    ListIntervalAgentReportResponseBody& operator=(const ListIntervalAgentReportResponseBody &) = default ;
    ListIntervalAgentReportResponseBody& operator=(ListIntervalAgentReportResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        void deleteAverageTalkTime() { this->averageTalkTime_ = nullptr;};
        inline float getAverageTalkTime() const { DARABONBA_PTR_GET_DEFAULT(averageTalkTime_, 0.0) };
        inline Back2Back& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline ListIntervalAgentReportResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListIntervalAgentReportResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListIntervalAgentReportResponseBody::Data>) };
    inline vector<ListIntervalAgentReportResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListIntervalAgentReportResponseBody::Data>) };
    inline ListIntervalAgentReportResponseBody& setData(const vector<ListIntervalAgentReportResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIntervalAgentReportResponseBody& setData(vector<ListIntervalAgentReportResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListIntervalAgentReportResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListIntervalAgentReportResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListIntervalAgentReportResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<vector<ListIntervalAgentReportResponseBody::Data>> data_ {};
