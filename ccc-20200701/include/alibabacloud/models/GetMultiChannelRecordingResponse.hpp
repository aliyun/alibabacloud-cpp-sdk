...
namespace Models
{
  ...
  public:
    ...
    inline const GetMultiChannelRecordingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMultiChannelRecordingResponseBody) };
    inline GetMultiChannelRecordingResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMultiChannelRecordingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMultiChannelRecordingResponseBody> body_ {};
  };
