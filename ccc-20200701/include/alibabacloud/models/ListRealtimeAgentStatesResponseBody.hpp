...
namespace Models
{
  ...
  public:
    ...
    inline const ListRealtimeAgentStatesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListRealtimeAgentStatesResponseBodyData) };
    inline ListRealtimeAgentStatesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListRealtimeAgentStatesResponseBodyData) };
    inline ListRealtimeAgentStatesResponseBody& setData(const ListRealtimeAgentStatesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListRealtimeAgentStatesResponseBody& setData(ListRealtimeAgentStatesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListRealtimeAgentStatesResponseBodyData> data_ = nullptr;
