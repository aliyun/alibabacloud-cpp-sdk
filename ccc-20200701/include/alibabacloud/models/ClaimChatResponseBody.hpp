...
namespace Models
{
  ...
  public:
    ...
    inline const ClaimChatResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ClaimChatResponseBodyData) };
    inline ClaimChatResponseBodyData data() { DARABONBA_PTR_GET(data_, ClaimChatResponseBodyData) };
    inline ClaimChatResponseBody& setData(const ClaimChatResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ClaimChatResponseBody& setData(ClaimChatResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ClaimChatResponseBodyData> data_ = nullptr;
