...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deviceId_ == nullptr
        && this->instanceId_ == nullptr && this->password_ == nullptr && this->userIdListJson_ == nullptr; };
    ...
    inline string getUserIdListJson() const { DARABONBA_PTR_GET_DEFAULT(userIdListJson_, "") };
  ...
  protected:
    ...
    shared_ptr<string> userIdListJson_ {};
  };
