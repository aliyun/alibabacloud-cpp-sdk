...
namespace Models
{
  ...
  public:
    ...
    inline const ClaimChatResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ClaimChatResponseBody) };
    inline ClaimChatResponseBody getBody() { DARABONBA_PTR_GET(body_, ClaimChatResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ClaimChatResponseBody> body_ {};
  };
