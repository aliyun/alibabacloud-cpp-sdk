...
#ifndef ALIBABACLOUD_MODELS_LISTHISTORICALSKILLGROUPREPORTRESPONSEBODYDATALISTOVERALL_HPP_
#define ALIBABACLOUD_MODELS_LISTHISTORICALSKILLGROUPREPORTRESPONSEBODYDATALISTOVERALL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListHistoricalSkillGroupReportResponseBodyDataListOverall& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListHistoricalSkillGroupReportResponseBodyDataListOverall& obj) { 
    ...
    ListHistoricalSkillGroupReportResponseBodyDataListOverall() = default ;
    ListHistoricalSkillGroupReportResponseBodyDataListOverall(const ListHistoricalSkillGroupReportResponseBodyDataListOverall &) = default ;
    ListHistoricalSkillGroupReportResponseBodyDataListOverall(ListHistoricalSkillGroupReportResponseBodyDataListOverall &&) = default ;
    ListHistoricalSkillGroupReportResponseBodyDataListOverall(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHistoricalSkillGroupReportResponseBodyDataListOverall() = default ;
    ListHistoricalSkillGroupReportResponseBodyDataListOverall& operator=(const ListHistoricalSkillGroupReportResponseBodyDataListOverall &) = default ;
    ListHistoricalSkillGroupReportResponseBodyDataListOverall& operator=(ListHistoricalSkillGroupReportResponseBodyDataListOverall &&) = default ;
    ...
    virtual bool empty() const override { return this->averageBreakTime_ == nullptr
        ...
        && return this->maxBreakTime_ == nullptr && return this->maxHoldTime_ == nullptr && return this->maxReadyTime_ == nullptr && return this->maxTalkTime_ == nullptr && return this->maxWorkTime_ == nullptr
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setAverageBreakTime(float averageBreakTime) { DARABONBA_PTR_SET_VALUE(averageBreakTime_, averageBreakTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setAverageHoldTime(float averageHoldTime) { DARABONBA_PTR_SET_VALUE(averageHoldTime_, averageHoldTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setAverageReadyTime(float averageReadyTime) { DARABONBA_PTR_SET_VALUE(averageReadyTime_, averageReadyTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setAverageWorkTime(float averageWorkTime) { DARABONBA_PTR_SET_VALUE(averageWorkTime_, averageWorkTime) };
    ...
    inline const vector<Models::ListHistoricalSkillGroupReportResponseBodyDataListOverallBreakCodeDetailList> & breakCodeDetailList() const { DARABONBA_PTR_GET_CONST(breakCodeDetailList_, vector<Models::ListHistoricalSkillGroupReportResponseBodyDataListOverallBreakCodeDetailList>) };
    inline vector<Models::ListHistoricalSkillGroupReportResponseBodyDataListOverallBreakCodeDetailList> breakCodeDetailList() { DARABONBA_PTR_GET(breakCodeDetailList_, vector<Models::ListHistoricalSkillGroupReportResponseBodyDataListOverallBreakCodeDetailList>) };
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setBreakCodeDetailList(const vector<Models::ListHistoricalSkillGroupReportResponseBodyDataListOverallBreakCodeDetailList> & breakCodeDetailList) { DARABONBA_PTR_SET_VALUE(breakCodeDetailList_, breakCodeDetailList) };
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setBreakCodeDetailList(vector<Models::ListHistoricalSkillGroupReportResponseBodyDataListOverallBreakCodeDetailList> && breakCodeDetailList) { DARABONBA_PTR_SET_RVALUE(breakCodeDetailList_, breakCodeDetailList) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setMaxBreakTime(int64_t maxBreakTime) { DARABONBA_PTR_SET_VALUE(maxBreakTime_, maxBreakTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setMaxHoldTime(int64_t maxHoldTime) { DARABONBA_PTR_SET_VALUE(maxHoldTime_, maxHoldTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setMaxReadyTime(int64_t maxReadyTime) { DARABONBA_PTR_SET_VALUE(maxReadyTime_, maxReadyTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setMaxWorkTime(int64_t maxWorkTime) { DARABONBA_PTR_SET_VALUE(maxWorkTime_, maxWorkTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setOccupancyRate(float occupancyRate) { DARABONBA_PTR_SET_VALUE(occupancyRate_, occupancyRate) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setSatisfactionIndex(float satisfactionIndex) { DARABONBA_PTR_SET_VALUE(satisfactionIndex_, satisfactionIndex) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setSatisfactionRate(float satisfactionRate) { DARABONBA_PTR_SET_VALUE(satisfactionRate_, satisfactionRate) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setSatisfactionSurveysOffered(int64_t satisfactionSurveysOffered) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysOffered_, satisfactionSurveysOffered) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setSatisfactionSurveysResponded(int64_t satisfactionSurveysResponded) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysResponded_, satisfactionSurveysResponded) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setTotalBreakTime(int64_t totalBreakTime) { DARABONBA_PTR_SET_VALUE(totalBreakTime_, totalBreakTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setTotalCalls(int64_t totalCalls) { DARABONBA_PTR_SET_VALUE(totalCalls_, totalCalls) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setTotalHoldTime(int64_t totalHoldTime) { DARABONBA_PTR_SET_VALUE(totalHoldTime_, totalHoldTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setTotalLoggedInTime(int64_t totalLoggedInTime) { DARABONBA_PTR_SET_VALUE(totalLoggedInTime_, totalLoggedInTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setTotalReadyTime(int64_t totalReadyTime) { DARABONBA_PTR_SET_VALUE(totalReadyTime_, totalReadyTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOverall& setTotalWorkTime(int64_t totalWorkTime) { DARABONBA_PTR_SET_VALUE(totalWorkTime_, totalWorkTime) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::ListHistoricalSkillGroupReportResponseBodyDataListOverallBreakCodeDetailList>> breakCodeDetailList_ = nullptr;
