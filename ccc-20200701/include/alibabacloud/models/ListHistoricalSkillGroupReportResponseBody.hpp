...
#ifndef ALIBABACLOUD_MODELS_LISTHISTORICALSKILLGROUPREPORTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTHISTORICALSKILLGROUPREPORTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListHistoricalSkillGroupReportResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListHistoricalSkillGroupReportResponseBody& obj) { 
    ...
    ListHistoricalSkillGroupReportResponseBody() = default ;
    ListHistoricalSkillGroupReportResponseBody(const ListHistoricalSkillGroupReportResponseBody &) = default ;
    ListHistoricalSkillGroupReportResponseBody(ListHistoricalSkillGroupReportResponseBody &&) = default ;
    ListHistoricalSkillGroupReportResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHistoricalSkillGroupReportResponseBody() = default ;
    ListHistoricalSkillGroupReportResponseBody& operator=(const ListHistoricalSkillGroupReportResponseBody &) = default ;
    ListHistoricalSkillGroupReportResponseBody& operator=(ListHistoricalSkillGroupReportResponseBody &&) = default ;
    ...
    inline ListHistoricalSkillGroupReportResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListHistoricalSkillGroupReportResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListHistoricalSkillGroupReportResponseBody::Data) };
    inline ListHistoricalSkillGroupReportResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListHistoricalSkillGroupReportResponseBody::Data) };
    inline ListHistoricalSkillGroupReportResponseBody& setData(const ListHistoricalSkillGroupReportResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHistoricalSkillGroupReportResponseBody& setData(ListHistoricalSkillGroupReportResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListHistoricalSkillGroupReportResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListHistoricalSkillGroupReportResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListHistoricalSkillGroupReportResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
