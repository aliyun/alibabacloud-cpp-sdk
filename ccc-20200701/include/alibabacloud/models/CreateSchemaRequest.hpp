...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Properties& setArray(bool array) { DARABONBA_PTR_SET_VALUE(array_, array) };
      ...
      inline Properties& setAttributes(string attributes) { DARABONBA_PTR_SET_VALUE(attributes_, attributes) };
      ...
      inline Properties& setDataType(string dataType) { DARABONBA_PTR_SET_VALUE(dataType_, dataType) };
      ...
      inline Properties& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
      ...
      inline Properties& setDisabled(bool disabled) { DARABONBA_PTR_SET_VALUE(disabled_, disabled) };
      ...
      inline Properties& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
      ...
      inline Properties& setDisplayOrder(int32_t displayOrder) { DARABONBA_PTR_SET_VALUE(displayOrder_, displayOrder) };
      ...
      inline Properties& setEditorType(string editorType) { DARABONBA_PTR_SET_VALUE(editorType_, editorType) };
      ...
      inline Properties& setMaxLength(int32_t maxLength) { DARABONBA_PTR_SET_VALUE(maxLength_, maxLength) };
      ...
      inline Properties& setMaximum(double maximum) { DARABONBA_PTR_SET_VALUE(maximum_, maximum) };
      ...
      inline Properties& setMinLength(int32_t minLength) { DARABONBA_PTR_SET_VALUE(minLength_, minLength) };
      ...
      inline Properties& setMinimum(double minimum) { DARABONBA_PTR_SET_VALUE(minimum_, minimum) };
      ...
      inline Properties& setPattern(string pattern) { DARABONBA_PTR_SET_VALUE(pattern_, pattern) };
      ...
      inline Properties& setPatternErrorMessage(string patternErrorMessage) { DARABONBA_PTR_SET_VALUE(patternErrorMessage_, patternErrorMessage) };
      ...
      inline Properties& setRequired(bool required) { DARABONBA_PTR_SET_VALUE(required_, required) };
    ...
    inline const vector<CreateSchemaRequest::Properties> & getProperties() const { DARABONBA_PTR_GET_CONST(properties_, vector<CreateSchemaRequest::Properties>) };
    inline vector<CreateSchemaRequest::Properties> getProperties() { DARABONBA_PTR_GET(properties_, vector<CreateSchemaRequest::Properties>) };
    inline CreateSchemaRequest& setProperties(const vector<CreateSchemaRequest::Properties> & properties) { DARABONBA_PTR_SET_VALUE(properties_, properties) };
    inline CreateSchemaRequest& setProperties(vector<CreateSchemaRequest::Properties> && properties) { DARABONBA_PTR_SET_RVALUE(properties_, properties) };
