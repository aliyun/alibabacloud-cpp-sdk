...
namespace Models
{
  ...
  public:
    ...
    inline const ListAgentStateLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAgentStateLogsResponseBody) };
    inline ListAgentStateLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAgentStateLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAgentStateLogsResponseBody> body_ {};
  };
