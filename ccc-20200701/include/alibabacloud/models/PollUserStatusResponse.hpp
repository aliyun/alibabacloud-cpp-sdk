...
namespace Models
{
  ...
  public:
    ...
    inline const PollUserStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PollUserStatusResponseBody) };
    inline PollUserStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, PollUserStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PollUserStatusResponseBody> body_ {};
  };
