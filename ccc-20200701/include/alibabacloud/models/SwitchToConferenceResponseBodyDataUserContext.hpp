...
#ifndef ALIBABACLOUD_MODELS_SWITCHTOCONFERENCERESPONSEBODYDATAUSERCONTEXT_HPP_
#define ALIBABACLOUD_MODELS_SWITCHTOCONFERENCERESPONSEBODYDATAUSERCONTEXT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SwitchToConferenceResponseBodyDataUserContext& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SwitchToConferenceResponseBodyDataUserContext& obj) { 
    ...
    SwitchToConferenceResponseBodyDataUserContext() = default ;
    SwitchToConferenceResponseBodyDataUserContext(const SwitchToConferenceResponseBodyDataUserContext &) = default ;
    SwitchToConferenceResponseBodyDataUserContext(SwitchToConferenceResponseBodyDataUserContext &&) = default ;
    SwitchToConferenceResponseBodyDataUserContext(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SwitchToConferenceResponseBodyDataUserContext() = default ;
    SwitchToConferenceResponseBodyDataUserContext& operator=(const SwitchToConferenceResponseBodyDataUserContext &) = default ;
    SwitchToConferenceResponseBodyDataUserContext& operator=(SwitchToConferenceResponseBodyDataUserContext &&) = default ;
    ...
    virtual bool empty() const override { return this->breakCode_ == nullptr
        ...
        && return this->jobId_ == nullptr && return this->mobile_ == nullptr && return this->outboundScenario_ == nullptr && return this->signedSkillGroupIdList_ == nullptr && return this->userId_ == nullptr
        && return this->userState_ == nullptr && return this->workMode_ == nullptr; };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setDeviceState(string deviceState) { DARABONBA_PTR_SET_VALUE(deviceState_, deviceState) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setHeartbeat(int64_t heartbeat) { DARABONBA_PTR_SET_VALUE(heartbeat_, heartbeat) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline SwitchToConferenceResponseBodyDataUserContext& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline SwitchToConferenceResponseBodyDataUserContext& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
