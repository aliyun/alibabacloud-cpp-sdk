...
#ifndef ALIBABACLOUD_MODELS_STARTCONFERENCERESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
#define ALIBABACLOUD_MODELS_STARTCONFERENCERESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartConferenceResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartConferenceResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    StartConferenceResponseBodyDataCallContextChannelContexts() = default ;
    StartConferenceResponseBodyDataCallContextChannelContexts(const StartConferenceResponseBodyDataCallContextChannelContexts &) = default ;
    StartConferenceResponseBodyDataCallContextChannelContexts(StartConferenceResponseBodyDataCallContextChannelContexts &&) = default ;
    StartConferenceResponseBodyDataCallContextChannelContexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartConferenceResponseBodyDataCallContextChannelContexts() = default ;
    StartConferenceResponseBodyDataCallContextChannelContexts& operator=(const StartConferenceResponseBodyDataCallContextChannelContexts &) = default ;
    StartConferenceResponseBodyDataCallContextChannelContexts& operator=(StartConferenceResponseBodyDataCallContextChannelContexts &&) = default ;
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setCallType(string callType) { DARABONBA_PTR_SET_VALUE(callType_, callType) };
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setChannelFlags(string channelFlags) { DARABONBA_PTR_SET_VALUE(channelFlags_, channelFlags) };
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setChannelState(string channelState) { DARABONBA_PTR_SET_VALUE(channelState_, channelState) };
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setDestination(string destination) { DARABONBA_PTR_SET_VALUE(destination_, destination) };
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setOriginator(string originator) { DARABONBA_PTR_SET_VALUE(originator_, originator) };
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setReleaseInitiator(string releaseInitiator) { DARABONBA_PTR_SET_VALUE(releaseInitiator_, releaseInitiator) };
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setReleaseReason(string releaseReason) { DARABONBA_PTR_SET_VALUE(releaseReason_, releaseReason) };
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setUserExtension(string userExtension) { DARABONBA_PTR_SET_VALUE(userExtension_, userExtension) };
    ...
    inline StartConferenceResponseBodyDataCallContextChannelContexts& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
