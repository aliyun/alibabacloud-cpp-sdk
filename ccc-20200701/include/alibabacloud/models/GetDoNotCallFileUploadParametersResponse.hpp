...
namespace Models
{
  ...
  public:
    ...
    inline const GetDoNotCallFileUploadParametersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDoNotCallFileUploadParametersResponseBody) };
    inline GetDoNotCallFileUploadParametersResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDoNotCallFileUploadParametersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDoNotCallFileUploadParametersResponseBody> body_ {};
  };
