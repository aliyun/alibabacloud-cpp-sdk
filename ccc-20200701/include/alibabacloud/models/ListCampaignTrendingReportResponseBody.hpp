...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListCampaignTrendingReportResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListCampaignTrendingReportResponseBodyData>) };
    inline vector<ListCampaignTrendingReportResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListCampaignTrendingReportResponseBodyData>) };
    inline ListCampaignTrendingReportResponseBody& setData(const vector<ListCampaignTrendingReportResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCampaignTrendingReportResponseBody& setData(vector<ListCampaignTrendingReportResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListCampaignTrendingReportResponseBodyData>> data_ = nullptr;
