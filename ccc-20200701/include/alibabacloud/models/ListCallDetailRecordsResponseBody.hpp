...
namespace Models
{
  ...
  public:
    ...
    inline const ListCallDetailRecordsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCallDetailRecordsResponseBodyData) };
    inline ListCallDetailRecordsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCallDetailRecordsResponseBodyData) };
    inline ListCallDetailRecordsResponseBody& setData(const ListCallDetailRecordsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCallDetailRecordsResponseBody& setData(ListCallDetailRecordsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListCallDetailRecordsResponseBodyData> data_ = nullptr;
