...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callee_ == nullptr
        && this->caller_ == nullptr && this->deviceId_ == nullptr && this->instanceId_ == nullptr && this->serviceProvider_ == nullptr && this->tags_ == nullptr
        && this->timeoutSeconds_ == nullptr && this->userId_ == nullptr && this->videoEnabled_ == nullptr; };
    ...
    inline bool getVideoEnabled() const { DARABONBA_PTR_GET_DEFAULT(videoEnabled_, false) };
