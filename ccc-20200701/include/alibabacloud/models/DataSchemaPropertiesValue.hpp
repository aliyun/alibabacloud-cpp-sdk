...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->displayName_ != nullptr
        ...
        && this->attributes_ != nullptr && this->displayOrder_ != nullptr && this->createdTime_ != nullptr && this->updatedTime_ != nullptr && this->creator_ != nullptr; };
    ...
    inline DataSchemaPropertiesValue& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
