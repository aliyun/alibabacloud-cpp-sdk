...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instanceId_ == nullptr
        && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->skillGroups_ == nullptr; };
    ...
    inline string getSkillGroups() const { DARABONBA_PTR_GET_DEFAULT(skillGroups_, "") };
  ...
  protected:
    ...
    shared_ptr<string> skillGroups_ {};
  };
