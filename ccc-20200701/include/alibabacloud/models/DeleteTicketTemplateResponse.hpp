...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTicketTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTicketTemplateResponseBody) };
    inline DeleteTicketTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTicketTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTicketTemplateResponseBody> body_ {};
  };
