...
namespace Models
{
  ...
  public:
    ...
    inline const ListSkillGroupStatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSkillGroupStatesResponseBody) };
    inline ListSkillGroupStatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSkillGroupStatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSkillGroupStatesResponseBody> body_ {};
  };
