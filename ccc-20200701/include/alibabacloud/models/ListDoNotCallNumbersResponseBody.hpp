...
namespace Models
{
  ...
  public:
    ...
    inline const ListDoNotCallNumbersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDoNotCallNumbersResponseBodyData) };
    inline ListDoNotCallNumbersResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDoNotCallNumbersResponseBodyData) };
    inline ListDoNotCallNumbersResponseBody& setData(const ListDoNotCallNumbersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDoNotCallNumbersResponseBody& setData(ListDoNotCallNumbersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListDoNotCallNumbersResponseBodyData> data_ = nullptr;
