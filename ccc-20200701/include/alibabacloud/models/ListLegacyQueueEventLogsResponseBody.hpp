...
namespace Models
{
  ...
  public:
    ...
    inline const ListLegacyQueueEventLogsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListLegacyQueueEventLogsResponseBodyData) };
    inline ListLegacyQueueEventLogsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListLegacyQueueEventLogsResponseBodyData) };
    inline ListLegacyQueueEventLogsResponseBody& setData(const ListLegacyQueueEventLogsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListLegacyQueueEventLogsResponseBody& setData(ListLegacyQueueEventLogsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListLegacyQueueEventLogsResponseBodyData> data_ = nullptr;
