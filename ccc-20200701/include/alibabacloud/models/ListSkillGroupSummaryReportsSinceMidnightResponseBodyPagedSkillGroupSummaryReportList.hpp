...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->inbound_ == nullptr
        && return this->instanceId_ == nullptr && return this->outbound_ == nullptr && return this->overall_ == nullptr && return this->skillGroupId_ == nullptr && return this->skillGroupName_ == nullptr
