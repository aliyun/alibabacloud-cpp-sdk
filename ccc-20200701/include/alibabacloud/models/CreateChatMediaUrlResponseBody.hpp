...
namespace Models
{
  ...
  public:
    ...
    inline const CreateChatMediaUrlResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateChatMediaUrlResponseBodyData) };
    inline CreateChatMediaUrlResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateChatMediaUrlResponseBodyData) };
    inline CreateChatMediaUrlResponseBody& setData(const CreateChatMediaUrlResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateChatMediaUrlResponseBody& setData(CreateChatMediaUrlResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateChatMediaUrlResponseBodyData> data_ = nullptr;
