...
namespace Models
{
  ...
  public:
    ...
    inline string getSurveyChannel() const { DARABONBA_PTR_GET_DEFAULT(surveyChannel_, "") };
    ...
    inline string getSurveyTemplateId() const { DARABONBA_PTR_GET_DEFAULT(surveyTemplateId_, "") };
    ...
    inline string getSurveyTemplateVariables() const { DARABONBA_PTR_GET_DEFAULT(surveyTemplateVariables_, "") };
