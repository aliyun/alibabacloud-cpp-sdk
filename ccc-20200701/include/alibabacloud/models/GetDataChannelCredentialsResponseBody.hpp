...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataChannelCredentialsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDataChannelCredentialsResponseBodyData) };
    inline GetDataChannelCredentialsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDataChannelCredentialsResponseBodyData) };
    inline GetDataChannelCredentialsResponseBody& setData(const GetDataChannelCredentialsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataChannelCredentialsResponseBody& setData(GetDataChannelCredentialsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataChannelCredentialsResponseBodyData> data_ = nullptr;
