...
namespace Models
{
  ...
  public:
    ...
    inline const ListAttemptsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAttemptsResponseBodyData) };
    inline ListAttemptsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAttemptsResponseBodyData) };
    inline ListAttemptsResponseBody& setData(const ListAttemptsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAttemptsResponseBody& setData(ListAttemptsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListAttemptsResponseBodyData> data_ = nullptr;
