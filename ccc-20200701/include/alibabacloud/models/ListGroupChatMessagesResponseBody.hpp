...
#ifndef ALIBABACLOUD_MODELS_LISTGROUPCHATMESSAGESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTGROUPCHATMESSAGESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListGroupChatMessagesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListGroupChatMessagesResponseBody& obj) { 
    ...
    ListGroupChatMessagesResponseBody() = default ;
    ListGroupChatMessagesResponseBody(const ListGroupChatMessagesResponseBody &) = default ;
    ListGroupChatMessagesResponseBody(ListGroupChatMessagesResponseBody &&) = default ;
    ListGroupChatMessagesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListGroupChatMessagesResponseBody() = default ;
    ListGroupChatMessagesResponseBody& operator=(const ListGroupChatMessagesResponseBody &) = default ;
    ListGroupChatMessagesResponseBody& operator=(ListGroupChatMessagesResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->jobId_ == nullptr && this->recalled_ == nullptr && this->senderAvatarUrl_ == nullptr && this->senderId_ == nullptr && this->senderName_ == nullptr
        && this->senderType_ == nullptr && this->timestamp_ == nullptr; };
        ...
        inline bool getRecalled() const { DARABONBA_PTR_GET_DEFAULT(recalled_, false) };
        inline Messages& setRecalled(bool recalled) { DARABONBA_PTR_SET_VALUE(recalled_, recalled) };
    ...
    inline ListGroupChatMessagesResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListGroupChatMessagesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListGroupChatMessagesResponseBody::Data) };
    inline ListGroupChatMessagesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListGroupChatMessagesResponseBody::Data) };
    inline ListGroupChatMessagesResponseBody& setData(const ListGroupChatMessagesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGroupChatMessagesResponseBody& setData(ListGroupChatMessagesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListGroupChatMessagesResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListGroupChatMessagesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListGroupChatMessagesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
