...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListPrivilegesOfUserResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListPrivilegesOfUserResponseBodyData>) };
    inline vector<ListPrivilegesOfUserResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListPrivilegesOfUserResponseBodyData>) };
    inline ListPrivilegesOfUserResponseBody& setData(const vector<ListPrivilegesOfUserResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPrivilegesOfUserResponseBody& setData(vector<ListPrivilegesOfUserResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListPrivilegesOfUserResponseBodyData>> data_ = nullptr;
