...
namespace Models
{
  ...
  public:
    ...
    inline const GetCallDetailRecordResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCallDetailRecordResponseBodyData) };
    inline GetCallDetailRecordResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCallDetailRecordResponseBodyData) };
    inline GetCallDetailRecordResponseBody& setData(const GetCallDetailRecordResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCallDetailRecordResponseBody& setData(GetCallDetailRecordResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetCallDetailRecordResponseBodyData> data_ = nullptr;
