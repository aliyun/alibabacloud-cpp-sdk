...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessChannelTypeDetails_ == nullptr
        ...
        && return this->averageWorkTime_ == nullptr && return this->callsAttendedTransferIn_ == nullptr && return this->callsAttendedTransferOut_ == nullptr && return this->callsBlindTransferIn_ == nullptr && return this->callsBlindTransferOut_ == nullptr
        && return this->callsHandled_ == nullptr && return this->callsHold_ == nullptr && return this->callsOffered_ == nullptr && return this->callsRinged_ == nullptr && return this->handleRate_ == nullptr
        && return this->maxHoldTime_ == nullptr && return this->maxRingTime_ == nullptr && return this->maxTalkTime_ == nullptr && return this->maxWorkTime_ == nullptr && return this->satisfactionIndex_ == nullptr
        && return this->satisfactionRate_ == nullptr && return this->satisfactionSurveysOffered_ == nullptr && return this->satisfactionSurveysResponded_ == nullptr && return this->serviceLevel15_ == nullptr && return this->totalHoldTime_ == nullptr
        && return this->totalMessagesSent_ == nullptr && return this->totalMessagesSentByAgent_ == nullptr && return this->totalMessagesSentByCustomer_ == nullptr && return this->totalRingTime_ == nullptr && return this->totalTalkTime_ == nullptr
