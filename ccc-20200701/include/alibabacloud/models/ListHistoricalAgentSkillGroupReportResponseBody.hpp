...
namespace Models
{
  ...
  public:
    ...
    inline const ListHistoricalAgentSkillGroupReportResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListHistoricalAgentSkillGroupReportResponseBodyData) };
    inline ListHistoricalAgentSkillGroupReportResponseBodyData data() { DARABONBA_PTR_GET(data_, ListHistoricalAgentSkillGroupReportResponseBodyData) };
    inline ListHistoricalAgentSkillGroupReportResponseBody& setData(const ListHistoricalAgentSkillGroupReportResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHistoricalAgentSkillGroupReportResponseBody& setData(ListHistoricalAgentSkillGroupReportResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListHistoricalAgentSkillGroupReportResponseBodyData> data_ = nullptr;
