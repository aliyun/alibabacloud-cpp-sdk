...
namespace Models
{
  ...
  public:
    ...
    inline const GetAudioFileResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAudioFileResponseBodyData) };
    inline GetAudioFileResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAudioFileResponseBodyData) };
    inline GetAudioFileResponseBody& setData(const GetAudioFileResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAudioFileResponseBody& setData(GetAudioFileResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAudioFileResponseBodyData> data_ = nullptr;
