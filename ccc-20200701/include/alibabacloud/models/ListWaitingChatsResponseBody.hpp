...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListWaitingChatsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListWaitingChatsResponseBodyData>) };
    inline vector<ListWaitingChatsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListWaitingChatsResponseBodyData>) };
    inline ListWaitingChatsResponseBody& setData(const vector<ListWaitingChatsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListWaitingChatsResponseBody& setData(vector<ListWaitingChatsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListWaitingChatsResponseBodyData>> data_ = nullptr;
