...
namespace Models
{
  ...
  public:
    ...
    inline const BargeInCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, BargeInCallResponseBody::Data) };
    inline BargeInCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, BargeInCallResponseBody::Data) };
    inline BargeInCallResponseBody& setData(const BargeInCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BargeInCallResponseBody& setData(BargeInCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<BargeInCallResponseBody::Data> data_ {};
