...
namespace Models
{
  ...
  public:
    ...
    inline const ListCallDetailRecordsV2ResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCallDetailRecordsV2ResponseBodyData) };
    inline ListCallDetailRecordsV2ResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCallDetailRecordsV2ResponseBodyData) };
    inline ListCallDetailRecordsV2ResponseBody& setData(const ListCallDetailRecordsV2ResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCallDetailRecordsV2ResponseBody& setData(ListCallDetailRecordsV2ResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListCallDetailRecordsV2ResponseBodyData> data_ = nullptr;
