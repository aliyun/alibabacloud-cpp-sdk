...
#ifndef ALIBABACLOUD_MODELS_MAKECALLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MAKECALLRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const MakeCallResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, MakeCallResponseBody& obj) { 
    ...
    MakeCallResponseBody() = default ;
    MakeCallResponseBody(const MakeCallResponseBody &) = default ;
    MakeCallResponseBody(MakeCallResponseBody &&) = default ;
    MakeCallResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~MakeCallResponseBody() = default ;
    MakeCallResponseBody& operator=(const MakeCallResponseBody &) = default ;
    MakeCallResponseBody& operator=(MakeCallResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->userExtension_ == nullptr && this->userId_ == nullptr; };
          ...
          inline ChannelContexts& setMediaType(string mediaType) { DARABONBA_PTR_SET_VALUE(mediaType_, mediaType) };
    ...
    inline MakeCallResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const MakeCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, MakeCallResponseBody::Data) };
    inline MakeCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, MakeCallResponseBody::Data) };
    inline MakeCallResponseBody& setData(const MakeCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline MakeCallResponseBody& setData(MakeCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline MakeCallResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline MakeCallResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline MakeCallResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline MakeCallResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline MakeCallResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<MakeCallResponseBody::Data> data_ {};
