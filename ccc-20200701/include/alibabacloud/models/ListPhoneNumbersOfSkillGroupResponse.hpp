...
namespace Models
{
  ...
  public:
    ...
    inline const ListPhoneNumbersOfSkillGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPhoneNumbersOfSkillGroupResponseBody) };
    inline ListPhoneNumbersOfSkillGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPhoneNumbersOfSkillGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPhoneNumbersOfSkillGroupResponseBody> body_ {};
  };
