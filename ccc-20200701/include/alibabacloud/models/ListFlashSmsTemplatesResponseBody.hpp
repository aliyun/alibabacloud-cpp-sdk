...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListFlashSmsTemplatesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListFlashSmsTemplatesResponseBodyData>) };
    inline vector<ListFlashSmsTemplatesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListFlashSmsTemplatesResponseBodyData>) };
    inline ListFlashSmsTemplatesResponseBody& setData(const vector<ListFlashSmsTemplatesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListFlashSmsTemplatesResponseBody& setData(vector<ListFlashSmsTemplatesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListFlashSmsTemplatesResponseBodyData>> data_ = nullptr;
