...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getTemplateDetails() const { DARABONBA_PTR_GET_DEFAULT(templateDetails_, "") };
      inline Data& setTemplateDetails(string templateDetails) { DARABONBA_PTR_SET_VALUE(templateDetails_, templateDetails) };
    ...
    inline const vector<ListFlashSmsTemplatesResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListFlashSmsTemplatesResponseBody::Data>) };
    inline vector<ListFlashSmsTemplatesResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListFlashSmsTemplatesResponseBody::Data>) };
    inline ListFlashSmsTemplatesResponseBody& setData(const vector<ListFlashSmsTemplatesResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListFlashSmsTemplatesResponseBody& setData(vector<ListFlashSmsTemplatesResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
