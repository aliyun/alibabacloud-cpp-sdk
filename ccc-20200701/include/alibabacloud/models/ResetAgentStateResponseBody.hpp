...
namespace Models
{
  ...
  public:
    ...
    inline const ResetAgentStateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ResetAgentStateResponseBodyData) };
    inline ResetAgentStateResponseBodyData data() { DARABONBA_PTR_GET(data_, ResetAgentStateResponseBodyData) };
    inline ResetAgentStateResponseBody& setData(const ResetAgentStateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ResetAgentStateResponseBody& setData(ResetAgentStateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ResetAgentStateResponseBodyData> data_ = nullptr;
