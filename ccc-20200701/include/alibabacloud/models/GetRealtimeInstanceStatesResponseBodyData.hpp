...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->breakCodeDetailList_ == nullptr
        && return this->breakingAgents_ == nullptr && return this->instanceId_ == nullptr && return this->interactiveCalls_ == nullptr && return this->loggedInAgents_ == nullptr && return this->longestWaitingTime_ == nullptr
        && return this->readyAgents_ == nullptr && return this->talkingAgents_ == nullptr && return this->totalAgents_ == nullptr && return this->waitingCalls_ == nullptr && return this->workingAgents_ == nullptr; };
