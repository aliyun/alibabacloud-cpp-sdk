...
namespace Models
{
  ...
  public:
    ...
    inline const SaveWebRtcInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveWebRtcInfoResponseBody) };
    inline SaveWebRtcInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveWebRtcInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveWebRtcInfoResponseBody> body_ {};
  };
