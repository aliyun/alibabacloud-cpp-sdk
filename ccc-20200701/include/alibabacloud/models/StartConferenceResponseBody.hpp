...
#ifndef ALIBABACLOUD_MODELS_STARTCONFERENCERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_STARTCONFERENCERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartConferenceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartConferenceResponseBody& obj) { 
    ...
    StartConferenceResponseBody() = default ;
    StartConferenceResponseBody(const StartConferenceResponseBody &) = default ;
    StartConferenceResponseBody(StartConferenceResponseBody &&) = default ;
    StartConferenceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartConferenceResponseBody() = default ;
    StartConferenceResponseBody& operator=(const StartConferenceResponseBody &) = default ;
    StartConferenceResponseBody& operator=(StartConferenceResponseBody &&) = default ;
    ...
    inline StartConferenceResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const StartConferenceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, StartConferenceResponseBody::Data) };
    inline StartConferenceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, StartConferenceResponseBody::Data) };
    inline StartConferenceResponseBody& setData(const StartConferenceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StartConferenceResponseBody& setData(StartConferenceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline StartConferenceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline StartConferenceResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline StartConferenceResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline StartConferenceResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline StartConferenceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<StartConferenceResponseBody::Data> data_ {};
