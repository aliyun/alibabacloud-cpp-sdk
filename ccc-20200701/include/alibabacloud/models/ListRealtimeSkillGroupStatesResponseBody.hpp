...
namespace Models
{
  ...
  public:
    ...
    inline const ListRealtimeSkillGroupStatesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListRealtimeSkillGroupStatesResponseBodyData) };
    inline ListRealtimeSkillGroupStatesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListRealtimeSkillGroupStatesResponseBodyData) };
    inline ListRealtimeSkillGroupStatesResponseBody& setData(const ListRealtimeSkillGroupStatesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListRealtimeSkillGroupStatesResponseBody& setData(ListRealtimeSkillGroupStatesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListRealtimeSkillGroupStatesResponseBodyData> data_ = nullptr;
