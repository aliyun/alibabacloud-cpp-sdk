...
namespace Models
{
  ...
  public:
    ...
    inline const SwitchToConferenceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SwitchToConferenceResponseBody) };
    inline SwitchToConferenceResponseBody getBody() { DARABONBA_PTR_GET(body_, SwitchToConferenceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SwitchToConferenceResponseBody> body_ {};
  };
