...
namespace Models
{
  ...
  public:
    ...
    inline const ListRecentCallDetailRecordsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListRecentCallDetailRecordsResponseBodyData) };
    inline ListRecentCallDetailRecordsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListRecentCallDetailRecordsResponseBodyData) };
    inline ListRecentCallDetailRecordsResponseBody& setData(const ListRecentCallDetailRecordsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListRecentCallDetailRecordsResponseBody& setData(ListRecentCallDetailRecordsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListRecentCallDetailRecordsResponseBodyData> data_ = nullptr;
