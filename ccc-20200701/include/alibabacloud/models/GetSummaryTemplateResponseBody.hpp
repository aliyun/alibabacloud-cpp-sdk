...
#ifndef ALIBABACLOUD_MODELS_GETSUMMARYTEMPLATERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETSUMMARYTEMPLATERESPONSEBODY_HPP_
...
namespace Models
{
  class GetSummaryTemplateResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetSummaryTemplateResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSummaryTemplateResponseBody& obj) { 
    ...
    GetSummaryTemplateResponseBody() = default ;
    GetSummaryTemplateResponseBody(const GetSummaryTemplateResponseBody &) = default ;
    GetSummaryTemplateResponseBody(GetSummaryTemplateResponseBody &&) = default ;
    GetSummaryTemplateResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSummaryTemplateResponseBody() = default ;
    GetSummaryTemplateResponseBody& operator=(const GetSummaryTemplateResponseBody &) = default ;
    GetSummaryTemplateResponseBody& operator=(GetSummaryTemplateResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline PropertyList& setArray(bool array) { DARABONBA_PTR_SET_VALUE(array_, array) };
        ...
        inline PropertyList& setAttributes(string attributes) { DARABONBA_PTR_SET_VALUE(attributes_, attributes) };
        ...
        inline PropertyList& setCreatedTime(int64_t createdTime) { DARABONBA_PTR_SET_VALUE(createdTime_, createdTime) };
        ...
        inline PropertyList& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
        ...
        inline PropertyList& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
        ...
        inline PropertyList& setDisabled(bool disabled) { DARABONBA_PTR_SET_VALUE(disabled_, disabled) };
        ...
        inline PropertyList& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
        ...
        inline PropertyList& setDisplayOrder(int32_t displayOrder) { DARABONBA_PTR_SET_VALUE(displayOrder_, displayOrder) };
        ...
        inline PropertyList& setEditorType(string editorType) { DARABONBA_PTR_SET_VALUE(editorType_, editorType) };
        ...
        inline PropertyList& setMaxLength(int32_t maxLength) { DARABONBA_PTR_SET_VALUE(maxLength_, maxLength) };
        ...
        inline PropertyList& setMaximum(double maximum) { DARABONBA_PTR_SET_VALUE(maximum_, maximum) };
        ...
        inline PropertyList& setMinLength(int32_t minLength) { DARABONBA_PTR_SET_VALUE(minLength_, minLength) };
        ...
        inline PropertyList& setMinimum(double minimum) { DARABONBA_PTR_SET_VALUE(minimum_, minimum) };
        ...
        inline PropertyList& setPattern(string pattern) { DARABONBA_PTR_SET_VALUE(pattern_, pattern) };
        ...
        inline PropertyList& setPatternErrorMessage(string patternErrorMessage) { DARABONBA_PTR_SET_VALUE(patternErrorMessage_, patternErrorMessage) };
        ...
        inline PropertyList& setReadOnly(bool readOnly) { DARABONBA_PTR_SET_VALUE(readOnly_, readOnly) };
        ...
        inline PropertyList& setRequired(bool required) { DARABONBA_PTR_SET_VALUE(required_, required) };
        ...
        inline PropertyList& setSystem(bool system) { DARABONBA_PTR_SET_VALUE(system_, system) };
        ...
        inline PropertyList& setUpdatedTime(int64_t updatedTime) { DARABONBA_PTR_SET_VALUE(updatedTime_, updatedTime) };
    ...
    inline GetSummaryTemplateResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetSummaryTemplateResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetSummaryTemplateResponseBody::Data) };
    inline GetSummaryTemplateResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetSummaryTemplateResponseBody::Data) };
    inline GetSummaryTemplateResponseBody& setData(const GetSummaryTemplateResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSummaryTemplateResponseBody& setData(GetSummaryTemplateResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetSummaryTemplateResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetSummaryTemplateResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetSummaryTemplateResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline GetSummaryTemplateResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline GetSummaryTemplateResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
