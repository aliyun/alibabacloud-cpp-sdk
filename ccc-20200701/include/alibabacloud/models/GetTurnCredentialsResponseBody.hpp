...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetTurnCredentialsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetTurnCredentialsResponseBody& obj) { 
    ...
    GetTurnCredentialsResponseBody() = default ;
    GetTurnCredentialsResponseBody(const GetTurnCredentialsResponseBody &) = default ;
    GetTurnCredentialsResponseBody(GetTurnCredentialsResponseBody &&) = default ;
    GetTurnCredentialsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetTurnCredentialsResponseBody() = default ;
    GetTurnCredentialsResponseBody& operator=(const GetTurnCredentialsResponseBody &) = default ;
    GetTurnCredentialsResponseBody& operator=(GetTurnCredentialsResponseBody &&) = default ;
