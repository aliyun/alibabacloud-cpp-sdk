...
namespace Models
{
  ...
  public:
    ...
    inline const ResubmitTicketResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResubmitTicketResponseBody) };
    inline ResubmitTicketResponseBody getBody() { DARABONBA_PTR_GET(body_, ResubmitTicketResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResubmitTicketResponseBody> body_ {};
  };
