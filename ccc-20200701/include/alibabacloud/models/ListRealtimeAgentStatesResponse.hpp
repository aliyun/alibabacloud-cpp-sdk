...
namespace Models
{
  ...
  public:
    ...
    inline const ListRealtimeAgentStatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRealtimeAgentStatesResponseBody) };
    inline ListRealtimeAgentStatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRealtimeAgentStatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRealtimeAgentStatesResponseBody> body_ {};
  };
