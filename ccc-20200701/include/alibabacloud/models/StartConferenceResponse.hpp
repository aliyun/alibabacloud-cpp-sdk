...
namespace Models
{
  ...
  public:
    ...
    inline const StartConferenceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartConferenceResponseBody) };
    inline StartConferenceResponseBody getBody() { DARABONBA_PTR_GET(body_, StartConferenceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartConferenceResponseBody> body_ {};
  };
