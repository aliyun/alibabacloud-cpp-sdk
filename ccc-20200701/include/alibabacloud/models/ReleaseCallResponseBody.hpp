...
namespace Models
{
  ...
  public:
    ...
    inline const ReleaseCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ReleaseCallResponseBody::Data) };
    inline ReleaseCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ReleaseCallResponseBody::Data) };
    inline ReleaseCallResponseBody& setData(const ReleaseCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ReleaseCallResponseBody& setData(ReleaseCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<ReleaseCallResponseBody::Data> data_ {};
