...
namespace Models
{
  ...
  public:
    ...
    inline const ListHistoricalAgentReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHistoricalAgentReportResponseBody) };
    inline ListHistoricalAgentReportResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHistoricalAgentReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHistoricalAgentReportResponseBody> body_ {};
  };
