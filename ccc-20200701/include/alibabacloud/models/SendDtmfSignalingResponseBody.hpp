...
namespace Models
{
  ...
  public:
    ...
    inline const SendDtmfSignalingResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SendDtmfSignalingResponseBody::Data) };
    inline SendDtmfSignalingResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SendDtmfSignalingResponseBody::Data) };
    inline SendDtmfSignalingResponseBody& setData(const SendDtmfSignalingResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SendDtmfSignalingResponseBody& setData(SendDtmfSignalingResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<SendDtmfSignalingResponseBody::Data> data_ {};
