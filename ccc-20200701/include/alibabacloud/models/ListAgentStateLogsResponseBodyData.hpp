...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->breakCode_ == nullptr
        && return this->duration_ == nullptr && return this->outboundScenario_ == nullptr && return this->startTime_ == nullptr && return this->state_ == nullptr && return this->stateCode_ == nullptr
