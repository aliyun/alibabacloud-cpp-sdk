...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListMonoRecordingsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListMonoRecordingsResponseBodyData>) };
    inline vector<ListMonoRecordingsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListMonoRecordingsResponseBodyData>) };
    inline ListMonoRecordingsResponseBody& setData(const vector<ListMonoRecordingsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMonoRecordingsResponseBody& setData(vector<ListMonoRecordingsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListMonoRecordingsResponseBodyData>> data_ = nullptr;
