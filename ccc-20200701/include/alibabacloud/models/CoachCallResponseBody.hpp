...
namespace Models
{
  ...
  public:
    ...
    inline const CoachCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CoachCallResponseBody::Data) };
    inline CoachCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CoachCallResponseBody::Data) };
    inline CoachCallResponseBody& setData(const CoachCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CoachCallResponseBody& setData(CoachCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
