...
namespace Models
{
  ...
  public:
    ...
    inline const GetTicketSummaryReportResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTicketSummaryReportResponseBodyData) };
    inline GetTicketSummaryReportResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTicketSummaryReportResponseBodyData) };
    inline GetTicketSummaryReportResponseBody& setData(const GetTicketSummaryReportResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTicketSummaryReportResponseBody& setData(GetTicketSummaryReportResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetTicketSummaryReportResponseBodyData> data_ = nullptr;
