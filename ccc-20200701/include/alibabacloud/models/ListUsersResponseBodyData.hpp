...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Models::ListUsersResponseBodyDataList> & list() const { DARABONBA_PTR_GET_CONST(list_, vector<Models::ListUsersResponseBodyDataList>) };
    inline vector<Models::ListUsersResponseBodyDataList> list() { DARABONBA_PTR_GET(list_, vector<Models::ListUsersResponseBodyDataList>) };
    inline ListUsersResponseBodyData& setList(const vector<Models::ListUsersResponseBodyDataList> & list) { DARABONBA_PTR_SET_VALUE(list_, list) };
    inline ListUsersResponseBodyData& setList(vector<Models::ListUsersResponseBodyDataList> && list) { DARABONBA_PTR_SET_RVALUE(list_, list) };
  ...
  protected:
    std::shared_ptr<vector<Models::ListUsersResponseBodyDataList>> list_ = nullptr;
