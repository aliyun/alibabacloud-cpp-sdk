...
namespace Models
{
  ...
  public:
    ...
    inline const GetTurnCredentialsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTurnCredentialsResponseBody) };
    inline GetTurnCredentialsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTurnCredentialsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTurnCredentialsResponseBody> body_ {};
  };
