...
namespace Models
{
  ...
  public:
    ...
    inline const ListTicketTemplatesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListTicketTemplatesResponseBodyData) };
    inline ListTicketTemplatesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListTicketTemplatesResponseBodyData) };
    inline ListTicketTemplatesResponseBody& setData(const ListTicketTemplatesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTicketTemplatesResponseBody& setData(ListTicketTemplatesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListTicketTemplatesResponseBodyData> data_ = nullptr;
