...
namespace Models
{
  ...
  public:
    ...
    inline const ListPhoneNumbersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListPhoneNumbersResponseBodyData) };
    inline ListPhoneNumbersResponseBodyData data() { DARABONBA_PTR_GET(data_, ListPhoneNumbersResponseBodyData) };
    inline ListPhoneNumbersResponseBody& setData(const ListPhoneNumbersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPhoneNumbersResponseBody& setData(ListPhoneNumbersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListPhoneNumbersResponseBodyData> data_ = nullptr;
