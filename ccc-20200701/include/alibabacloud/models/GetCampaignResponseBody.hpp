...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getCasesUncompletedAfterAttempt() const { DARABONBA_PTR_GET_DEFAULT(casesUncompletedAfterAttempt_, "") };
      inline Data& setCasesUncompletedAfterAttempt(string casesUncompletedAfterAttempt) { DARABONBA_PTR_SET_VALUE(casesUncompletedAfterAttempt_, casesUncompletedAfterAttempt) };
      ...
      inline int64_t getCasesUncompletedAfterAttempted() const { DARABONBA_PTR_GET_DEFAULT(casesUncompletedAfterAttempted_, 0L) };
      inline Data& setCasesUncompletedAfterAttempted(int64_t casesUncompletedAfterAttempted) { DARABONBA_PTR_SET_VALUE(casesUncompletedAfterAttempted_, casesUncompletedAfterAttempted) };
      ...
      inline float getCompletionRate() const { DARABONBA_PTR_GET_DEFAULT(completionRate_, 0.0) };
      inline Data& setCompletionRate(float completionRate) { DARABONBA_PTR_SET_VALUE(completionRate_, completionRate) };
