...
namespace Models
{
  ...
  public:
    ...
    inline const GetCampaignResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCampaignResponseBodyData) };
    inline GetCampaignResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCampaignResponseBodyData) };
    inline GetCampaignResponseBody& setData(const GetCampaignResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCampaignResponseBody& setData(GetCampaignResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetCampaignResponseBodyData> data_ = nullptr;
