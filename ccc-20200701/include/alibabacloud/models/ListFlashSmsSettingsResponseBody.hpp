  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline List& setEnabled(bool enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
    ...
    inline const ListFlashSmsSettingsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListFlashSmsSettingsResponseBody::Data) };
    inline ListFlashSmsSettingsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListFlashSmsSettingsResponseBody::Data) };
    inline ListFlashSmsSettingsResponseBody& setData(const ListFlashSmsSettingsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListFlashSmsSettingsResponseBody& setData(ListFlashSmsSettingsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
