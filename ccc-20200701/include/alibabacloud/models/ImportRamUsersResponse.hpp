...
namespace Models
{
  ...
  public:
    ...
    inline const ImportRamUsersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImportRamUsersResponseBody) };
    inline ImportRamUsersResponseBody getBody() { DARABONBA_PTR_GET(body_, ImportRamUsersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImportRamUsersResponseBody> body_ {};
  };
