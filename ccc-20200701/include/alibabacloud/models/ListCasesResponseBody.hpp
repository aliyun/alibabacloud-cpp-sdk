...
namespace Models
{
  ...
  public:
    ...
    inline const ListCasesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCasesResponseBodyData) };
    inline ListCasesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCasesResponseBodyData) };
    inline ListCasesResponseBody& setData(const ListCasesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCasesResponseBody& setData(ListCasesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListCasesResponseBodyData> data_ = nullptr;
