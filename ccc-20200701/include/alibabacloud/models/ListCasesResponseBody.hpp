  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline string getAbandonPhase() const { DARABONBA_PTR_GET_DEFAULT(abandonPhase_, "") };
        inline List& setAbandonPhase(string abandonPhase) { DARABONBA_PTR_SET_VALUE(abandonPhase_, abandonPhase) };
