...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCampaignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCampaignResponseBody) };
    inline CreateCampaignResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCampaignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCampaignResponseBody> body_ {};
  };
