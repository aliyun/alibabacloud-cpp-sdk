...
namespace Models
{
  ...
  public:
    ...
    inline const ListSkillGroupStatesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListSkillGroupStatesResponseBodyData) };
    inline ListSkillGroupStatesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListSkillGroupStatesResponseBodyData) };
    inline ListSkillGroupStatesResponseBody& setData(const ListSkillGroupStatesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSkillGroupStatesResponseBody& setData(ListSkillGroupStatesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListSkillGroupStatesResponseBodyData> data_ = nullptr;
