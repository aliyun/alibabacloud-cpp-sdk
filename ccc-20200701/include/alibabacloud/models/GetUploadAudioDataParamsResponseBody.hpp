...
namespace Models
{
  ...
  public:
    ...
    inline const GetUploadAudioDataParamsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetUploadAudioDataParamsResponseBodyData) };
    inline GetUploadAudioDataParamsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetUploadAudioDataParamsResponseBodyData) };
    inline GetUploadAudioDataParamsResponseBody& setData(const GetUploadAudioDataParamsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetUploadAudioDataParamsResponseBody& setData(GetUploadAudioDataParamsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetUploadAudioDataParamsResponseBodyData> data_ = nullptr;
