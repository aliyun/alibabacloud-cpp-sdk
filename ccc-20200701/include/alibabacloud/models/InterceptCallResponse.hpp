...
namespace Models
{
  ...
  public:
    ...
    inline const InterceptCallResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InterceptCallResponseBody) };
    inline InterceptCallResponseBody getBody() { DARABONBA_PTR_GET(body_, InterceptCallResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InterceptCallResponseBody> body_ {};
  };
