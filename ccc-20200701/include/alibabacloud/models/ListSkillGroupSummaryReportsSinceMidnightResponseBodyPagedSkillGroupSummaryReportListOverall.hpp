...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->averageReadyTime_ == nullptr
        ...
        && return this->occupancyRate_ == nullptr && return this->satisfactionIndex_ == nullptr && return this->satisfactionSurveysOffered_ == nullptr && return this->satisfactionSurveysResponded_ == nullptr && return this->totalBreakTime_ == nullptr
        && return this->totalCalls_ == nullptr && return this->totalLoggedInTime_ == nullptr && return this->totalReadyTime_ == nullptr && return this->totalTalkTime_ == nullptr && return this->totalWorkTime_ == nullptr; };
