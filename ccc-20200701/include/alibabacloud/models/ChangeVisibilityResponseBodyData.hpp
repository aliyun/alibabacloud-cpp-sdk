...
#ifndef ALIBABACLOUD_MODELS_CHANGEVISIBILITYRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_CHANGEVISIBILITYRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeVisibilityResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeVisibilityResponseBodyData& obj) { 
    ...
    ChangeVisibilityResponseBodyData() = default ;
    ChangeVisibilityResponseBodyData(const ChangeVisibilityResponseBodyData &) = default ;
    ChangeVisibilityResponseBodyData(ChangeVisibilityResponseBodyData &&) = default ;
    ChangeVisibilityResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeVisibilityResponseBodyData() = default ;
    ChangeVisibilityResponseBodyData& operator=(const ChangeVisibilityResponseBodyData &) = default ;
    ChangeVisibilityResponseBodyData& operator=(ChangeVisibilityResponseBodyData &&) = default ;
    ...
    inline ChangeVisibilityResponseBodyData& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline ChangeVisibilityResponseBodyData& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline ChangeVisibilityResponseBodyData& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline ChangeVisibilityResponseBodyData& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ChangeVisibilityResponseBodyData& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline ChangeVisibilityResponseBodyData& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline ChangeVisibilityResponseBodyData& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline ChangeVisibilityResponseBodyData& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline ChangeVisibilityResponseBodyData& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline ChangeVisibilityResponseBodyData& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline ChangeVisibilityResponseBodyData& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
