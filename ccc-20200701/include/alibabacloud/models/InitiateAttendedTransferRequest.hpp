...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callPriority_ == nullptr
        && return this->deviceId_ == nullptr && return this->instanceId_ == nullptr && return this->jobId_ == nullptr && return this->queuingOverflowThreshold_ == nullptr && return this->queuingTimeoutSeconds_ == nullptr
        && return this->routingType_ == nullptr && return this->strategyName_ == nullptr && return this->strategyParams_ == nullptr && return this->tags_ == nullptr && return this->timeoutSeconds_ == nullptr
        && return this->transferee_ == nullptr && return this->transfereeType_ == nullptr && return this->transferor_ == nullptr && return this->userId_ == nullptr; };
