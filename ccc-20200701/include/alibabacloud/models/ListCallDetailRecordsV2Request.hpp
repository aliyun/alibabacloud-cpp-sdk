...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessChannelTypeList_ == nullptr
        && return this->agentId_ == nullptr && return this->analyticsReportReady_ == nullptr && return this->broker_ == nullptr && return this->calledNumber_ == nullptr && return this->callingNumber_ == nullptr
        && return this->contactDispositionList_ == nullptr && return this->contactIdList_ == nullptr && return this->contactTypeList_ == nullptr && return this->earlyMediaStateList_ == nullptr && return this->endTime_ == nullptr
        && return this->firstAgentId_ == nullptr && return this->instanceId_ == nullptr && return this->mediaType_ == nullptr && return this->number_ == nullptr && return this->orderByField_ == nullptr
        && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->releaseInitiatorList_ == nullptr && return this->releaseReasonList_ == nullptr && return this->satisfactionDescriptionList_ == nullptr
        && return this->satisfactionRateList_ == nullptr && return this->satisfactionSurveyChannel_ == nullptr && return this->searchPattern_ == nullptr && return this->skillGroupIdList_ == nullptr && return this->sortOrder_ == nullptr
