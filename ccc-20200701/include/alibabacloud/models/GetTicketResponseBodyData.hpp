...
namespace Models
{
  ...
  public:
    ...
    inline GetTicketResponseBodyData& setAssignee(string assignee) { DARABONBA_PTR_SET_VALUE(assignee_, assignee) };
    ...
    inline GetTicketResponseBodyData& setAssigneeName(string assigneeName) { DARABONBA_PTR_SET_VALUE(assigneeName_, assigneeName) };
    ...
    inline GetTicketResponseBodyData& setCategoryName(string categoryName) { DARABONBA_PTR_SET_VALUE(categoryName_, categoryName) };
    ...
    inline GetTicketResponseBodyData& setCloseCode(string closeCode) { DARABONBA_PTR_SET_VALUE(closeCode_, closeCode) };
    ...
    inline GetTicketResponseBodyData& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline GetTicketResponseBodyData& setContext(string context) { DARABONBA_PTR_SET_VALUE(context_, context) };
    ...
    inline GetTicketResponseBodyData& setCreatedTime(int64_t createdTime) { DARABONBA_PTR_SET_VALUE(createdTime_, createdTime) };
    ...
    inline GetTicketResponseBodyData& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
    ...
    inline GetTicketResponseBodyData& setCreatorName(string creatorName) { DARABONBA_PTR_SET_VALUE(creatorName_, creatorName) };
    ...
    inline GetTicketResponseBodyData& setCurrentTaskId(string currentTaskId) { DARABONBA_PTR_SET_VALUE(currentTaskId_, currentTaskId) };
    ...
    inline GetTicketResponseBodyData& setCurrentTaskName(string currentTaskName) { DARABONBA_PTR_SET_VALUE(currentTaskName_, currentTaskName) };
    ...
    inline GetTicketResponseBodyData& setCurrentTaskStartTime(int64_t currentTaskStartTime) { DARABONBA_PTR_SET_VALUE(currentTaskStartTime_, currentTaskStartTime) };
    ...
    inline GetTicketResponseBodyData& setCustomerId(string customerId) { DARABONBA_PTR_SET_VALUE(customerId_, customerId) };
    ...
    inline GetTicketResponseBodyData& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline GetTicketResponseBodyData& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetTicketResponseBodyData& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline GetTicketResponseBodyData& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline GetTicketResponseBodyData& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline GetTicketResponseBodyData& setState(string state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    ...
    inline GetTicketResponseBodyData& setTemplateId(string templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
    ...
    inline GetTicketResponseBodyData& setTemplateVersion(string templateVersion) { DARABONBA_PTR_SET_VALUE(templateVersion_, templateVersion) };
    ...
    inline GetTicketResponseBodyData& setUpdatedTime(int64_t updatedTime) { DARABONBA_PTR_SET_VALUE(updatedTime_, updatedTime) };
