...
namespace Models
{
  ...
  public:
    ...
    inline const RedialCallResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RedialCallResponseBody) };
    inline RedialCallResponseBody getBody() { DARABONBA_PTR_GET(body_, RedialCallResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RedialCallResponseBody> body_ {};
  };
