  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->documents_ == nullptr
        && this->nextPageToken_ == nullptr && this->schema_ == nullptr && this->totalCount_ == nullptr; };
      ...
      inline const vector<Darabonba::Json> & getDocuments() const { DARABONBA_PTR_GET_CONST(documents_, vector<Darabonba::Json>) };
      inline vector<Darabonba::Json> getDocuments() { DARABONBA_PTR_GET(documents_, vector<Darabonba::Json>) };
      inline Data& setDocuments(const vector<Darabonba::Json> & documents) { DARABONBA_PTR_SET_VALUE(documents_, documents) };
      inline Data& setDocuments(vector<Darabonba::Json> && documents) { DARABONBA_PTR_SET_RVALUE(documents_, documents) };
    ...
    inline ListDocumentsResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListDocumentsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListDocumentsResponseBody::Data) };
    inline ListDocumentsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListDocumentsResponseBody::Data) };
    inline ListDocumentsResponseBody& setData(const ListDocumentsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDocumentsResponseBody& setData(ListDocumentsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListDocumentsResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListDocumentsResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline ListDocumentsResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
