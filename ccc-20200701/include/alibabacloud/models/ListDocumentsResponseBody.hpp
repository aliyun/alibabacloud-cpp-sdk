...
namespace Models
{
  ...
  public:
    ...
    inline const ListDocumentsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDocumentsResponseBodyData) };
    inline ListDocumentsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDocumentsResponseBodyData) };
    inline ListDocumentsResponseBody& setData(const ListDocumentsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDocumentsResponseBody& setData(ListDocumentsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListDocumentsResponseBodyData> data_ = nullptr;
