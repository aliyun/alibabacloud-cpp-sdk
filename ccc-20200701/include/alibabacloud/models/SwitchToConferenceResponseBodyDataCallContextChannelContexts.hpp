...
#ifndef ALIBABACLOUD_MODELS_SWITCHTOCONFERENCERESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
#define ALIBABACLOUD_MODELS_SWITCHTOCONFERENCERESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SwitchToConferenceResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SwitchToConferenceResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    SwitchToConferenceResponseBodyDataCallContextChannelContexts() = default ;
    SwitchToConferenceResponseBodyDataCallContextChannelContexts(const SwitchToConferenceResponseBodyDataCallContextChannelContexts &) = default ;
    SwitchToConferenceResponseBodyDataCallContextChannelContexts(SwitchToConferenceResponseBodyDataCallContextChannelContexts &&) = default ;
    SwitchToConferenceResponseBodyDataCallContextChannelContexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SwitchToConferenceResponseBodyDataCallContextChannelContexts() = default ;
    SwitchToConferenceResponseBodyDataCallContextChannelContexts& operator=(const SwitchToConferenceResponseBodyDataCallContextChannelContexts &) = default ;
    SwitchToConferenceResponseBodyDataCallContextChannelContexts& operator=(SwitchToConferenceResponseBodyDataCallContextChannelContexts &&) = default ;
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setCallType(string callType) { DARABONBA_PTR_SET_VALUE(callType_, callType) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setChannelFlags(string channelFlags) { DARABONBA_PTR_SET_VALUE(channelFlags_, channelFlags) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setChannelState(string channelState) { DARABONBA_PTR_SET_VALUE(channelState_, channelState) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setDestination(string destination) { DARABONBA_PTR_SET_VALUE(destination_, destination) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setIndex(int32_t index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setOriginator(string originator) { DARABONBA_PTR_SET_VALUE(originator_, originator) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setReleaseInitiator(string releaseInitiator) { DARABONBA_PTR_SET_VALUE(releaseInitiator_, releaseInitiator) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setReleaseReason(string releaseReason) { DARABONBA_PTR_SET_VALUE(releaseReason_, releaseReason) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setSkillGroupId(string skillGroupId) { DARABONBA_PTR_SET_VALUE(skillGroupId_, skillGroupId) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setUserExtension(string userExtension) { DARABONBA_PTR_SET_VALUE(userExtension_, userExtension) };
    ...
    inline SwitchToConferenceResponseBodyDataCallContextChannelContexts& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
