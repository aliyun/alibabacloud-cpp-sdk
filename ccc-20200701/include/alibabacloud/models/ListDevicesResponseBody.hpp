...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDevicesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListDevicesResponseBodyData>) };
    inline vector<ListDevicesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListDevicesResponseBodyData>) };
    inline ListDevicesResponseBody& setData(const vector<ListDevicesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDevicesResponseBody& setData(vector<ListDevicesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDevicesResponseBodyData>> data_ = nullptr;
