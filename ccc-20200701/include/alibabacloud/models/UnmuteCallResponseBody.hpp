...
#ifndef ALIBABACLOUD_MODELS_UNMUTECALLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UNMUTECALLRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UnmuteCallResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UnmuteCallResponseBody& obj) { 
    ...
    UnmuteCallResponseBody() = default ;
    UnmuteCallResponseBody(const UnmuteCallResponseBody &) = default ;
    UnmuteCallResponseBody(UnmuteCallResponseBody &&) = default ;
    UnmuteCallResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UnmuteCallResponseBody() = default ;
    UnmuteCallResponseBody& operator=(const UnmuteCallResponseBody &) = default ;
    UnmuteCallResponseBody& operator=(UnmuteCallResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->mobile_ == nullptr && this->outboundScenario_ == nullptr && this->signedSkillGroupIdList_ == nullptr && this->userId_ == nullptr && this->userState_ == nullptr
    ...
    inline UnmuteCallResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const UnmuteCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UnmuteCallResponseBody::Data) };
    inline UnmuteCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UnmuteCallResponseBody::Data) };
    inline UnmuteCallResponseBody& setData(const UnmuteCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UnmuteCallResponseBody& setData(UnmuteCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UnmuteCallResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UnmuteCallResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UnmuteCallResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline UnmuteCallResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline UnmuteCallResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
