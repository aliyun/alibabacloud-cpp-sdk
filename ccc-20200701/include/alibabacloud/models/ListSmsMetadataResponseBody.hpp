...
namespace Models
{
  ...
  public:
    ...
    inline const ListSmsMetadataResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListSmsMetadataResponseBodyData) };
    inline ListSmsMetadataResponseBodyData data() { DARABONBA_PTR_GET(data_, ListSmsMetadataResponseBodyData) };
    inline ListSmsMetadataResponseBody& setData(const ListSmsMetadataResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSmsMetadataResponseBody& setData(ListSmsMetadataResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListSmsMetadataResponseBodyData> data_ = nullptr;
