...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSkillGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSkillGroupResponseBody) };
    inline CreateSkillGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSkillGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSkillGroupResponseBody> body_ {};
  };
