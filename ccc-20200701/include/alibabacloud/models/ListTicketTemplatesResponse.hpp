...
namespace Models
{
  ...
  public:
    ...
    inline const ListTicketTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTicketTemplatesResponseBody) };
    inline ListTicketTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTicketTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTicketTemplatesResponseBody> body_ {};
  };
