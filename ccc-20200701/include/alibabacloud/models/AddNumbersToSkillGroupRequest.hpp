...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instNumberGroupIdList_ == nullptr
        && return this->instanceId_ == nullptr && return this->numberList_ == nullptr && return this->skillGroupId_ == nullptr; };
