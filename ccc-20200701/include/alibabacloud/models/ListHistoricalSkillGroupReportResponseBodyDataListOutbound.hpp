...
#ifndef ALIBABACLOUD_MODELS_LISTHISTORICALSKILLGROUPREPORTRESPONSEBODYDATALISTOUTBOUND_HPP_
#define ALIBABACLOUD_MODELS_LISTHISTORICALSKILLGROUPREPORTRESPONSEBODYDATALISTOUTBOUND_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListHistoricalSkillGroupReportResponseBodyDataListOutbound& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListHistoricalSkillGroupReportResponseBodyDataListOutbound& obj) { 
    ...
    ListHistoricalSkillGroupReportResponseBodyDataListOutbound() = default ;
    ListHistoricalSkillGroupReportResponseBodyDataListOutbound(const ListHistoricalSkillGroupReportResponseBodyDataListOutbound &) = default ;
    ListHistoricalSkillGroupReportResponseBodyDataListOutbound(ListHistoricalSkillGroupReportResponseBodyDataListOutbound &&) = default ;
    ListHistoricalSkillGroupReportResponseBodyDataListOutbound(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHistoricalSkillGroupReportResponseBodyDataListOutbound() = default ;
    ListHistoricalSkillGroupReportResponseBodyDataListOutbound& operator=(const ListHistoricalSkillGroupReportResponseBodyDataListOutbound &) = default ;
    ListHistoricalSkillGroupReportResponseBodyDataListOutbound& operator=(ListHistoricalSkillGroupReportResponseBodyDataListOutbound &&) = default ;
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setAnswerRate(float answerRate) { DARABONBA_PTR_SET_VALUE(answerRate_, answerRate) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setAverageDialingTime(float averageDialingTime) { DARABONBA_PTR_SET_VALUE(averageDialingTime_, averageDialingTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setAverageHoldTime(float averageHoldTime) { DARABONBA_PTR_SET_VALUE(averageHoldTime_, averageHoldTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setAverageRingTime(float averageRingTime) { DARABONBA_PTR_SET_VALUE(averageRingTime_, averageRingTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setAverageWorkTime(float averageWorkTime) { DARABONBA_PTR_SET_VALUE(averageWorkTime_, averageWorkTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setCallsAnswered(int64_t callsAnswered) { DARABONBA_PTR_SET_VALUE(callsAnswered_, callsAnswered) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setCallsAttendedTransferIn(int64_t callsAttendedTransferIn) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferIn_, callsAttendedTransferIn) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setCallsAttendedTransferOut(int64_t callsAttendedTransferOut) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferOut_, callsAttendedTransferOut) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setCallsBlindTransferIn(int64_t callsBlindTransferIn) { DARABONBA_PTR_SET_VALUE(callsBlindTransferIn_, callsBlindTransferIn) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setCallsBlindTransferOut(int64_t callsBlindTransferOut) { DARABONBA_PTR_SET_VALUE(callsBlindTransferOut_, callsBlindTransferOut) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setCallsDialed(int64_t callsDialed) { DARABONBA_PTR_SET_VALUE(callsDialed_, callsDialed) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setCallsHold(int64_t callsHold) { DARABONBA_PTR_SET_VALUE(callsHold_, callsHold) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setCallsRinged(int64_t callsRinged) { DARABONBA_PTR_SET_VALUE(callsRinged_, callsRinged) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setMaxDialingTime(int64_t maxDialingTime) { DARABONBA_PTR_SET_VALUE(maxDialingTime_, maxDialingTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setMaxHoldTime(int64_t maxHoldTime) { DARABONBA_PTR_SET_VALUE(maxHoldTime_, maxHoldTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setMaxRingTime(int64_t maxRingTime) { DARABONBA_PTR_SET_VALUE(maxRingTime_, maxRingTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setMaxWorkTime(int64_t maxWorkTime) { DARABONBA_PTR_SET_VALUE(maxWorkTime_, maxWorkTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setSatisfactionIndex(float satisfactionIndex) { DARABONBA_PTR_SET_VALUE(satisfactionIndex_, satisfactionIndex) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setSatisfactionRate(float satisfactionRate) { DARABONBA_PTR_SET_VALUE(satisfactionRate_, satisfactionRate) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setSatisfactionSurveysOffered(int64_t satisfactionSurveysOffered) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysOffered_, satisfactionSurveysOffered) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setSatisfactionSurveysResponded(int64_t satisfactionSurveysResponded) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysResponded_, satisfactionSurveysResponded) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setTotalDialingTime(int64_t totalDialingTime) { DARABONBA_PTR_SET_VALUE(totalDialingTime_, totalDialingTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setTotalHoldTime(int64_t totalHoldTime) { DARABONBA_PTR_SET_VALUE(totalHoldTime_, totalHoldTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setTotalRingTime(int64_t totalRingTime) { DARABONBA_PTR_SET_VALUE(totalRingTime_, totalRingTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
    ...
    inline ListHistoricalSkillGroupReportResponseBodyDataListOutbound& setTotalWorkTime(int64_t totalWorkTime) { DARABONBA_PTR_SET_VALUE(totalWorkTime_, totalWorkTime) };
