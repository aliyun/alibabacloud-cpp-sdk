...
#ifndef ALIBABACLOUD_MODELS_ADDSCHEMAPROPERTYREQUESTPROPERTY_HPP_
#define ALIBABACLOUD_MODELS_ADDSCHEMAPROPERTYREQUESTPROPERTY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddSchemaPropertyRequestProperty& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddSchemaPropertyRequestProperty& obj) { 
    ...
    AddSchemaPropertyRequestProperty() = default ;
    AddSchemaPropertyRequestProperty(const AddSchemaPropertyRequestProperty &) = default ;
    AddSchemaPropertyRequestProperty(AddSchemaPropertyRequestProperty &&) = default ;
    AddSchemaPropertyRequestProperty(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddSchemaPropertyRequestProperty() = default ;
    AddSchemaPropertyRequestProperty& operator=(const AddSchemaPropertyRequestProperty &) = default ;
    AddSchemaPropertyRequestProperty& operator=(AddSchemaPropertyRequestProperty &&) = default ;
    ...
    inline AddSchemaPropertyRequestProperty& setArray(bool array) { DARABONBA_PTR_SET_VALUE(array_, array) };
    ...
    inline AddSchemaPropertyRequestProperty& setAttributes(string attributes) { DARABONBA_PTR_SET_VALUE(attributes_, attributes) };
    ...
    inline AddSchemaPropertyRequestProperty& setDataType(string dataType) { DARABONBA_PTR_SET_VALUE(dataType_, dataType) };
    ...
    inline AddSchemaPropertyRequestProperty& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline AddSchemaPropertyRequestProperty& setDisabled(bool disabled) { DARABONBA_PTR_SET_VALUE(disabled_, disabled) };
    ...
    inline AddSchemaPropertyRequestProperty& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline AddSchemaPropertyRequestProperty& setDisplayOrder(int32_t displayOrder) { DARABONBA_PTR_SET_VALUE(displayOrder_, displayOrder) };
    ...
    inline AddSchemaPropertyRequestProperty& setEditorType(string editorType) { DARABONBA_PTR_SET_VALUE(editorType_, editorType) };
    ...
    inline AddSchemaPropertyRequestProperty& setMaxLength(int32_t maxLength) { DARABONBA_PTR_SET_VALUE(maxLength_, maxLength) };
    ...
    inline AddSchemaPropertyRequestProperty& setMaximum(double maximum) { DARABONBA_PTR_SET_VALUE(maximum_, maximum) };
    ...
    inline AddSchemaPropertyRequestProperty& setMinLength(int32_t minLength) { DARABONBA_PTR_SET_VALUE(minLength_, minLength) };
    ...
    inline AddSchemaPropertyRequestProperty& setMinimum(double minimum) { DARABONBA_PTR_SET_VALUE(minimum_, minimum) };
    ...
    inline AddSchemaPropertyRequestProperty& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline AddSchemaPropertyRequestProperty& setPattern(string pattern) { DARABONBA_PTR_SET_VALUE(pattern_, pattern) };
    ...
    inline AddSchemaPropertyRequestProperty& setPatternErrorMessage(string patternErrorMessage) { DARABONBA_PTR_SET_VALUE(patternErrorMessage_, patternErrorMessage) };
    ...
    inline AddSchemaPropertyRequestProperty& setReadOnly(bool readOnly) { DARABONBA_PTR_SET_VALUE(readOnly_, readOnly) };
    ...
    inline AddSchemaPropertyRequestProperty& setRequired(bool required) { DARABONBA_PTR_SET_VALUE(required_, required) };
