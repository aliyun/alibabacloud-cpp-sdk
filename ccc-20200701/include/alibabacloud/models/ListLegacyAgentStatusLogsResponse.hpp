...
namespace Models
{
  ...
  public:
    ...
    inline const ListLegacyAgentStatusLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLegacyAgentStatusLogsResponseBody) };
    inline ListLegacyAgentStatusLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLegacyAgentStatusLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLegacyAgentStatusLogsResponseBody> body_ {};
  };
