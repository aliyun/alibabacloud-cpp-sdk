...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCallSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateCallSummaryResponseBody) };
    inline UpdateCallSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateCallSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateCallSummaryResponseBody> body_ {};
  };
