...
namespace Models
{
  ...
  public:
    ...
    inline const LaunchAuthenticationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, LaunchAuthenticationResponseBody) };
    inline LaunchAuthenticationResponseBody getBody() { DARABONBA_PTR_GET(body_, LaunchAuthenticationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<LaunchAuthenticationResponseBody> body_ {};
  };
