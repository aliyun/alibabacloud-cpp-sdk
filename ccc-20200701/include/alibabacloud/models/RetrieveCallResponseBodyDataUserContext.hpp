...
#ifndef ALIBABACLOUD_MODELS_RETRIEVECALLRESPONSEBODYDATAUSERCONTEXT_HPP_
#define ALIBABACLOUD_MODELS_RETRIEVECALLRESPONSEBODYDATAUSERCONTEXT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RetrieveCallResponseBodyDataUserContext& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RetrieveCallResponseBodyDataUserContext& obj) { 
    ...
    RetrieveCallResponseBodyDataUserContext() = default ;
    RetrieveCallResponseBodyDataUserContext(const RetrieveCallResponseBodyDataUserContext &) = default ;
    RetrieveCallResponseBodyDataUserContext(RetrieveCallResponseBodyDataUserContext &&) = default ;
    RetrieveCallResponseBodyDataUserContext(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RetrieveCallResponseBodyDataUserContext() = default ;
    RetrieveCallResponseBodyDataUserContext& operator=(const RetrieveCallResponseBodyDataUserContext &) = default ;
    RetrieveCallResponseBodyDataUserContext& operator=(RetrieveCallResponseBodyDataUserContext &&) = default ;
    ...
    inline RetrieveCallResponseBodyDataUserContext& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setHeartbeat(int64_t heartbeat) { DARABONBA_PTR_SET_VALUE(heartbeat_, heartbeat) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline RetrieveCallResponseBodyDataUserContext& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline RetrieveCallResponseBodyDataUserContext& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
