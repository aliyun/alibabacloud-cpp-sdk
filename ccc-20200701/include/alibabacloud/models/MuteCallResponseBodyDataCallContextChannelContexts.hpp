...
#ifndef ALIBABACLOUD_MODELS_MUTECALLRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
#define ALIBABACLOUD_MODELS_MUTECALLRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const MuteCallResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, MuteCallResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    MuteCallResponseBodyDataCallContextChannelContexts() = default ;
    MuteCallResponseBodyDataCallContextChannelContexts(const MuteCallResponseBodyDataCallContextChannelContexts &) = default ;
    MuteCallResponseBodyDataCallContextChannelContexts(MuteCallResponseBodyDataCallContextChannelContexts &&) = default ;
    MuteCallResponseBodyDataCallContextChannelContexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~MuteCallResponseBodyDataCallContextChannelContexts() = default ;
    MuteCallResponseBodyDataCallContextChannelContexts& operator=(const MuteCallResponseBodyDataCallContextChannelContexts &) = default ;
    MuteCallResponseBodyDataCallContextChannelContexts& operator=(MuteCallResponseBodyDataCallContextChannelContexts &&) = default ;
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setCallType(string callType) { DARABONBA_PTR_SET_VALUE(callType_, callType) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setChannelFlags(string channelFlags) { DARABONBA_PTR_SET_VALUE(channelFlags_, channelFlags) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setChannelState(string channelState) { DARABONBA_PTR_SET_VALUE(channelState_, channelState) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setDestination(string destination) { DARABONBA_PTR_SET_VALUE(destination_, destination) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setIndex(int32_t index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setOriginator(string originator) { DARABONBA_PTR_SET_VALUE(originator_, originator) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setReleaseInitiator(string releaseInitiator) { DARABONBA_PTR_SET_VALUE(releaseInitiator_, releaseInitiator) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setReleaseReason(string releaseReason) { DARABONBA_PTR_SET_VALUE(releaseReason_, releaseReason) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setSkillGroupId(string skillGroupId) { DARABONBA_PTR_SET_VALUE(skillGroupId_, skillGroupId) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setUserExtension(string userExtension) { DARABONBA_PTR_SET_VALUE(userExtension_, userExtension) };
    ...
    inline MuteCallResponseBodyDataCallContextChannelContexts& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
