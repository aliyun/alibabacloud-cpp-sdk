...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actualStartTimeFrom_ == nullptr
        && return this->actualStartTimeTo_ == nullptr && return this->instanceId_ == nullptr && return this->name_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr
        && return this->planedStartTimeFrom_ == nullptr && return this->planedStartTimeTo_ == nullptr && return this->queueId_ == nullptr && return this->state_ == nullptr; };
    ...
    inline string actualStartTimeFrom() const { DARABONBA_PTR_GET_DEFAULT(actualStartTimeFrom_, "") };
    ...
    inline string actualStartTimeTo() const { DARABONBA_PTR_GET_DEFAULT(actualStartTimeTo_, "") };
    ...
    inline string planedStartTimeFrom() const { DARABONBA_PTR_GET_DEFAULT(planedStartTimeFrom_, "") };
    ...
    inline string planedStartTimeTo() const { DARABONBA_PTR_GET_DEFAULT(planedStartTimeTo_, "") };
  ...
  protected:
    std::shared_ptr<string> actualStartTimeFrom_ = nullptr;
    std::shared_ptr<string> actualStartTimeTo_ = nullptr;
    ...
    std::shared_ptr<string> planedStartTimeFrom_ = nullptr;
    std::shared_ptr<string> planedStartTimeTo_ = nullptr;
