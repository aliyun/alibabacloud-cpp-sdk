...
#ifndef ALIBABACLOUD_MODELS_GETHISTORICALINSTANCEREPORTRESPONSEBODYDATAOVERALL_HPP_
#define ALIBABACLOUD_MODELS_GETHISTORICALINSTANCEREPORTRESPONSEBODYDATAOVERALL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetHistoricalInstanceReportResponseBodyDataOverall& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetHistoricalInstanceReportResponseBodyDataOverall& obj) { 
    ...
    GetHistoricalInstanceReportResponseBodyDataOverall() = default ;
    GetHistoricalInstanceReportResponseBodyDataOverall(const GetHistoricalInstanceReportResponseBodyDataOverall &) = default ;
    GetHistoricalInstanceReportResponseBodyDataOverall(GetHistoricalInstanceReportResponseBodyDataOverall &&) = default ;
    GetHistoricalInstanceReportResponseBodyDataOverall(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetHistoricalInstanceReportResponseBodyDataOverall() = default ;
    GetHistoricalInstanceReportResponseBodyDataOverall& operator=(const GetHistoricalInstanceReportResponseBodyDataOverall &) = default ;
    GetHistoricalInstanceReportResponseBodyDataOverall& operator=(GetHistoricalInstanceReportResponseBodyDataOverall &&) = default ;
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setAverageBreakTime(float averageBreakTime) { DARABONBA_PTR_SET_VALUE(averageBreakTime_, averageBreakTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setAverageHoldTime(float averageHoldTime) { DARABONBA_PTR_SET_VALUE(averageHoldTime_, averageHoldTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setAverageReadyTime(float averageReadyTime) { DARABONBA_PTR_SET_VALUE(averageReadyTime_, averageReadyTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setAverageWorkTime(float averageWorkTime) { DARABONBA_PTR_SET_VALUE(averageWorkTime_, averageWorkTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setMaxBreakTime(int64_t maxBreakTime) { DARABONBA_PTR_SET_VALUE(maxBreakTime_, maxBreakTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setMaxHoldTime(int64_t maxHoldTime) { DARABONBA_PTR_SET_VALUE(maxHoldTime_, maxHoldTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setMaxLoggedInAgents(int64_t maxLoggedInAgents) { DARABONBA_PTR_SET_VALUE(maxLoggedInAgents_, maxLoggedInAgents) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setMaxReadyTime(int64_t maxReadyTime) { DARABONBA_PTR_SET_VALUE(maxReadyTime_, maxReadyTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setMaxWorkTime(int64_t maxWorkTime) { DARABONBA_PTR_SET_VALUE(maxWorkTime_, maxWorkTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setOccupancyRate(float occupancyRate) { DARABONBA_PTR_SET_VALUE(occupancyRate_, occupancyRate) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setSatisfactionIndex(float satisfactionIndex) { DARABONBA_PTR_SET_VALUE(satisfactionIndex_, satisfactionIndex) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setSatisfactionRate(float satisfactionRate) { DARABONBA_PTR_SET_VALUE(satisfactionRate_, satisfactionRate) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setSatisfactionSurveysOffered(int64_t satisfactionSurveysOffered) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysOffered_, satisfactionSurveysOffered) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setSatisfactionSurveysResponded(int64_t satisfactionSurveysResponded) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysResponded_, satisfactionSurveysResponded) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setTotalBreakTime(int64_t totalBreakTime) { DARABONBA_PTR_SET_VALUE(totalBreakTime_, totalBreakTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setTotalCalls(int64_t totalCalls) { DARABONBA_PTR_SET_VALUE(totalCalls_, totalCalls) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setTotalHoldTime(int64_t totalHoldTime) { DARABONBA_PTR_SET_VALUE(totalHoldTime_, totalHoldTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setTotalLoggedInTime(int64_t totalLoggedInTime) { DARABONBA_PTR_SET_VALUE(totalLoggedInTime_, totalLoggedInTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setTotalReadyTime(int64_t totalReadyTime) { DARABONBA_PTR_SET_VALUE(totalReadyTime_, totalReadyTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOverall& setTotalWorkTime(int64_t totalWorkTime) { DARABONBA_PTR_SET_VALUE(totalWorkTime_, totalWorkTime) };
