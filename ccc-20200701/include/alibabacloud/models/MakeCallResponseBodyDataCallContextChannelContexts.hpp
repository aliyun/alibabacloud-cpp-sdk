...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callType_ == nullptr
        ...
        && return this->mediaType_ == nullptr && return this->originator_ == nullptr && return this->releaseInitiator_ == nullptr && return this->releaseReason_ == nullptr && return this->timestamp_ == nullptr
