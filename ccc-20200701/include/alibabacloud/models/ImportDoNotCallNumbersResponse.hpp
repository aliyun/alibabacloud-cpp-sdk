...
namespace Models
{
  ...
  public:
    ...
    inline const ImportDoNotCallNumbersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImportDoNotCallNumbersResponseBody) };
    inline ImportDoNotCallNumbersResponseBody getBody() { DARABONBA_PTR_GET(body_, ImportDoNotCallNumbersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImportDoNotCallNumbersResponseBody> body_ {};
  };
