...
namespace Models
{
  ...
  public:
    ...
    inline const ListCallDetailRecordsV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCallDetailRecordsV2ResponseBody) };
    inline ListCallDetailRecordsV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCallDetailRecordsV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCallDetailRecordsV2ResponseBody> body_ {};
  };
