...
namespace Models
{
  ...
  public:
    ...
    inline const TakeBreakResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TakeBreakResponseBody) };
    inline TakeBreakResponseBody getBody() { DARABONBA_PTR_GET(body_, TakeBreakResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TakeBreakResponseBody> body_ {};
  };
