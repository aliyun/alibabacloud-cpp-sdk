...
#ifndef ALIBABACLOUD_MODELS_CHANGEWORKMODERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CHANGEWORKMODERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ChangeWorkModeResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChangeWorkModeResponseBody& obj) { 
    ...
    ChangeWorkModeResponseBody() = default ;
    ChangeWorkModeResponseBody(const ChangeWorkModeResponseBody &) = default ;
    ChangeWorkModeResponseBody(ChangeWorkModeResponseBody &&) = default ;
    ChangeWorkModeResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChangeWorkModeResponseBody() = default ;
    ChangeWorkModeResponseBody& operator=(const ChangeWorkModeResponseBody &) = default ;
    ChangeWorkModeResponseBody& operator=(ChangeWorkModeResponseBody &&) = default ;
    ...
    inline ChangeWorkModeResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ChangeWorkModeResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ChangeWorkModeResponseBody::Data) };
    inline ChangeWorkModeResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ChangeWorkModeResponseBody::Data) };
    inline ChangeWorkModeResponseBody& setData(const ChangeWorkModeResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ChangeWorkModeResponseBody& setData(ChangeWorkModeResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ChangeWorkModeResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ChangeWorkModeResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ChangeWorkModeResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline ChangeWorkModeResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline ChangeWorkModeResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<ChangeWorkModeResponseBody::Data> data_ {};
