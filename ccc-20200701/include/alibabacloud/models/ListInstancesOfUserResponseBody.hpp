...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstancesOfUserResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListInstancesOfUserResponseBodyData) };
    inline ListInstancesOfUserResponseBodyData data() { DARABONBA_PTR_GET(data_, ListInstancesOfUserResponseBodyData) };
    inline ListInstancesOfUserResponseBody& setData(const ListInstancesOfUserResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListInstancesOfUserResponseBody& setData(ListInstancesOfUserResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListInstancesOfUserResponseBodyData> data_ = nullptr;
