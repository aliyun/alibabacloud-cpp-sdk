...
namespace Models
{
  ...
  public:
    ...
    inline const MuteCallResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, MuteCallResponseBodyData) };
    inline MuteCallResponseBodyData data() { DARABONBA_PTR_GET(data_, MuteCallResponseBodyData) };
    inline MuteCallResponseBody& setData(const MuteCallResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline MuteCallResponseBody& setData(MuteCallResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<MuteCallResponseBodyData> data_ = nullptr;
