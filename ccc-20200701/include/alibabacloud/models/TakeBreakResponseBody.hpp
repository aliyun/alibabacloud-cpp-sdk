...
namespace Models
{
  ...
  public:
    ...
    inline const TakeBreakResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, TakeBreakResponseBodyData) };
    inline TakeBreakResponseBodyData data() { DARABONBA_PTR_GET(data_, TakeBreakResponseBodyData) };
    inline TakeBreakResponseBody& setData(const TakeBreakResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TakeBreakResponseBody& setData(TakeBreakResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<TakeBreakResponseBodyData> data_ = nullptr;
