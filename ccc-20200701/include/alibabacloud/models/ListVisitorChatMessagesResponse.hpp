...
namespace Models
{
  ...
  public:
    ...
    inline const ListVisitorChatMessagesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVisitorChatMessagesResponseBody) };
    inline ListVisitorChatMessagesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVisitorChatMessagesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVisitorChatMessagesResponseBody> body_ {};
  };
