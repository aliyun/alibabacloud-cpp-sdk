...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListFeedbacksResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListFeedbacksResponseBodyData>) };
    inline vector<ListFeedbacksResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListFeedbacksResponseBodyData>) };
    inline ListFeedbacksResponseBody& setData(const vector<ListFeedbacksResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListFeedbacksResponseBody& setData(vector<ListFeedbacksResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListFeedbacksResponseBodyData>> data_ = nullptr;
