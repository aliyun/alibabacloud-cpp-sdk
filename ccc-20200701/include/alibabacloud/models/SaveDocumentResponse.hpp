...
namespace Models
{
  ...
  public:
    ...
    inline const SaveDocumentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveDocumentResponseBody) };
    inline SaveDocumentResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveDocumentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveDocumentResponseBody> body_ {};
  };
