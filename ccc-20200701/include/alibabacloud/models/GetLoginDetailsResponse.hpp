...
namespace Models
{
  ...
  public:
    ...
    inline const GetLoginDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLoginDetailsResponseBody) };
    inline GetLoginDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLoginDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLoginDetailsResponseBody> body_ {};
  };
