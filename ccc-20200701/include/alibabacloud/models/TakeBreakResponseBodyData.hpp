...
#ifndef ALIBABACLOUD_MODELS_TAKEBREAKRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_TAKEBREAKRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TakeBreakResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TakeBreakResponseBodyData& obj) { 
    ...
    TakeBreakResponseBodyData() = default ;
    TakeBreakResponseBodyData(const TakeBreakResponseBodyData &) = default ;
    TakeBreakResponseBodyData(TakeBreakResponseBodyData &&) = default ;
    TakeBreakResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TakeBreakResponseBodyData() = default ;
    TakeBreakResponseBodyData& operator=(const TakeBreakResponseBodyData &) = default ;
    TakeBreakResponseBodyData& operator=(TakeBreakResponseBodyData &&) = default ;
    ...
    inline TakeBreakResponseBodyData& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline TakeBreakResponseBodyData& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline TakeBreakResponseBodyData& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline TakeBreakResponseBodyData& setHeartbeat(int64_t heartbeat) { DARABONBA_PTR_SET_VALUE(heartbeat_, heartbeat) };
    ...
    inline TakeBreakResponseBodyData& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline TakeBreakResponseBodyData& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline TakeBreakResponseBodyData& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline TakeBreakResponseBodyData& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline TakeBreakResponseBodyData& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline TakeBreakResponseBodyData& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline TakeBreakResponseBodyData& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline TakeBreakResponseBodyData& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline TakeBreakResponseBodyData& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline TakeBreakResponseBodyData& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
