...
namespace Models
{
  ...
  public:
    ...
    inline const ResumeCampaignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResumeCampaignResponseBody) };
    inline ResumeCampaignResponseBody getBody() { DARABONBA_PTR_GET(body_, ResumeCampaignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResumeCampaignResponseBody> body_ {};
  };
