...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserLevelsOfSkillGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListUserLevelsOfSkillGroupResponseBodyData) };
    inline ListUserLevelsOfSkillGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, ListUserLevelsOfSkillGroupResponseBodyData) };
    inline ListUserLevelsOfSkillGroupResponseBody& setData(const ListUserLevelsOfSkillGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListUserLevelsOfSkillGroupResponseBody& setData(ListUserLevelsOfSkillGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListUserLevelsOfSkillGroupResponseBodyData> data_ = nullptr;
