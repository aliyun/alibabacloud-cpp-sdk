...
#ifndef ALIBABACLOUD_MODELS_LISTHISTORICALAGENTREPORTRESPONSEBODYDATALISTOUTBOUND_HPP_
#define ALIBABACLOUD_MODELS_LISTHISTORICALAGENTREPORTRESPONSEBODYDATALISTOUTBOUND_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListHistoricalAgentReportResponseBodyDataListOutbound& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListHistoricalAgentReportResponseBodyDataListOutbound& obj) { 
    ...
    ListHistoricalAgentReportResponseBodyDataListOutbound() = default ;
    ListHistoricalAgentReportResponseBodyDataListOutbound(const ListHistoricalAgentReportResponseBodyDataListOutbound &) = default ;
    ListHistoricalAgentReportResponseBodyDataListOutbound(ListHistoricalAgentReportResponseBodyDataListOutbound &&) = default ;
    ListHistoricalAgentReportResponseBodyDataListOutbound(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHistoricalAgentReportResponseBodyDataListOutbound() = default ;
    ListHistoricalAgentReportResponseBodyDataListOutbound& operator=(const ListHistoricalAgentReportResponseBodyDataListOutbound &) = default ;
    ListHistoricalAgentReportResponseBodyDataListOutbound& operator=(ListHistoricalAgentReportResponseBodyDataListOutbound &&) = default ;
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setAnswerRate(float answerRate) { DARABONBA_PTR_SET_VALUE(answerRate_, answerRate) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setAverageDialingTime(float averageDialingTime) { DARABONBA_PTR_SET_VALUE(averageDialingTime_, averageDialingTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setAverageHoldTime(float averageHoldTime) { DARABONBA_PTR_SET_VALUE(averageHoldTime_, averageHoldTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setAverageRingTime(float averageRingTime) { DARABONBA_PTR_SET_VALUE(averageRingTime_, averageRingTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setAverageWorkTime(float averageWorkTime) { DARABONBA_PTR_SET_VALUE(averageWorkTime_, averageWorkTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setCallsAnswered(int64_t callsAnswered) { DARABONBA_PTR_SET_VALUE(callsAnswered_, callsAnswered) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setCallsAttendedTransferIn(int64_t callsAttendedTransferIn) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferIn_, callsAttendedTransferIn) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setCallsAttendedTransferOut(int64_t callsAttendedTransferOut) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferOut_, callsAttendedTransferOut) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setCallsBlindTransferIn(int64_t callsBlindTransferIn) { DARABONBA_PTR_SET_VALUE(callsBlindTransferIn_, callsBlindTransferIn) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setCallsBlindTransferOut(int64_t callsBlindTransferOut) { DARABONBA_PTR_SET_VALUE(callsBlindTransferOut_, callsBlindTransferOut) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setCallsDialed(int64_t callsDialed) { DARABONBA_PTR_SET_VALUE(callsDialed_, callsDialed) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setCallsHold(int64_t callsHold) { DARABONBA_PTR_SET_VALUE(callsHold_, callsHold) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setCallsRinged(int64_t callsRinged) { DARABONBA_PTR_SET_VALUE(callsRinged_, callsRinged) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setMaxDialingTime(int64_t maxDialingTime) { DARABONBA_PTR_SET_VALUE(maxDialingTime_, maxDialingTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setMaxHoldTime(int64_t maxHoldTime) { DARABONBA_PTR_SET_VALUE(maxHoldTime_, maxHoldTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setMaxRingTime(int64_t maxRingTime) { DARABONBA_PTR_SET_VALUE(maxRingTime_, maxRingTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setMaxWorkTime(int64_t maxWorkTime) { DARABONBA_PTR_SET_VALUE(maxWorkTime_, maxWorkTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setSatisfactionIndex(float satisfactionIndex) { DARABONBA_PTR_SET_VALUE(satisfactionIndex_, satisfactionIndex) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setSatisfactionRate(float satisfactionRate) { DARABONBA_PTR_SET_VALUE(satisfactionRate_, satisfactionRate) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setSatisfactionSurveysOffered(int64_t satisfactionSurveysOffered) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysOffered_, satisfactionSurveysOffered) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setSatisfactionSurveysResponded(int64_t satisfactionSurveysResponded) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysResponded_, satisfactionSurveysResponded) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setTotalDialingTime(int64_t totalDialingTime) { DARABONBA_PTR_SET_VALUE(totalDialingTime_, totalDialingTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setTotalHoldTime(int64_t totalHoldTime) { DARABONBA_PTR_SET_VALUE(totalHoldTime_, totalHoldTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setTotalRingTime(int64_t totalRingTime) { DARABONBA_PTR_SET_VALUE(totalRingTime_, totalRingTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListOutbound& setTotalWorkTime(int64_t totalWorkTime) { DARABONBA_PTR_SET_VALUE(totalWorkTime_, totalWorkTime) };
