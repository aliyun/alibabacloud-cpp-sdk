...
#ifndef ALIBABACLOUD_MODELS_LAUNCHSURVEYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LAUNCHSURVEYRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const LaunchSurveyResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, LaunchSurveyResponseBody& obj) { 
    ...
    LaunchSurveyResponseBody() = default ;
    LaunchSurveyResponseBody(const LaunchSurveyResponseBody &) = default ;
    LaunchSurveyResponseBody(LaunchSurveyResponseBody &&) = default ;
    LaunchSurveyResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~LaunchSurveyResponseBody() = default ;
    LaunchSurveyResponseBody& operator=(const LaunchSurveyResponseBody &) = default ;
    LaunchSurveyResponseBody& operator=(LaunchSurveyResponseBody &&) = default ;
    ...
    inline LaunchSurveyResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const LaunchSurveyResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, LaunchSurveyResponseBody::Data) };
    inline LaunchSurveyResponseBody::Data getData() { DARABONBA_PTR_GET(data_, LaunchSurveyResponseBody::Data) };
    inline LaunchSurveyResponseBody& setData(const LaunchSurveyResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline LaunchSurveyResponseBody& setData(LaunchSurveyResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline LaunchSurveyResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline LaunchSurveyResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline LaunchSurveyResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline LaunchSurveyResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline LaunchSurveyResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<LaunchSurveyResponseBody::Data> data_ {};
