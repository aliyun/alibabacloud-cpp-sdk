...
namespace Models
{
  ...
  public:
    ...
    inline const PickOutboundNumbersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PickOutboundNumbersResponseBody) };
    inline PickOutboundNumbersResponseBody getBody() { DARABONBA_PTR_GET(body_, PickOutboundNumbersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PickOutboundNumbersResponseBody> body_ {};
  };
