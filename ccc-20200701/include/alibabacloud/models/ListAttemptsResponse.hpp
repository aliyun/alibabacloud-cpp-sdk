...
namespace Models
{
  ...
  public:
    ...
    inline const ListAttemptsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAttemptsResponseBody) };
    inline ListAttemptsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAttemptsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAttemptsResponseBody> body_ {};
  };
