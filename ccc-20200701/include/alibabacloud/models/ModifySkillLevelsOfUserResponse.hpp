...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySkillLevelsOfUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySkillLevelsOfUserResponseBody) };
    inline ModifySkillLevelsOfUserResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySkillLevelsOfUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySkillLevelsOfUserResponseBody> body_ {};
  };
