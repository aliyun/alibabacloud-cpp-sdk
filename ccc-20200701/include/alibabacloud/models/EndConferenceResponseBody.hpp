...
#ifndef ALIBABACLOUD_MODELS_ENDCONFERENCERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ENDCONFERENCERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const EndConferenceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EndConferenceResponseBody& obj) { 
    ...
    EndConferenceResponseBody() = default ;
    EndConferenceResponseBody(const EndConferenceResponseBody &) = default ;
    EndConferenceResponseBody(EndConferenceResponseBody &&) = default ;
    EndConferenceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EndConferenceResponseBody() = default ;
    EndConferenceResponseBody& operator=(const EndConferenceResponseBody &) = default ;
    EndConferenceResponseBody& operator=(EndConferenceResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->deviceId_ == nullptr && this->deviceState_ == nullptr && this->extension_ == nullptr && this->instanceId_ == nullptr && this->jobId_ == nullptr
      ...
      public:
        ...
        && this->releaseInitiator_ == nullptr && this->releaseReason_ == nullptr && this->timestamp_ == nullptr && this->userExtension_ == nullptr && this->userId_ == nullptr; };
    ...
    inline EndConferenceResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const EndConferenceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, EndConferenceResponseBody::Data) };
    inline EndConferenceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, EndConferenceResponseBody::Data) };
    inline EndConferenceResponseBody& setData(const EndConferenceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline EndConferenceResponseBody& setData(EndConferenceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline EndConferenceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline EndConferenceResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline EndConferenceResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline EndConferenceResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline EndConferenceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
