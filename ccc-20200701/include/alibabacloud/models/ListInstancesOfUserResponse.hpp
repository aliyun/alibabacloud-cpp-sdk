...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstancesOfUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstancesOfUserResponseBody) };
    inline ListInstancesOfUserResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstancesOfUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstancesOfUserResponseBody> body_ {};
  };
