...
namespace Models
{
  ...
  public:
    ...
    inline const SignOutGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SignOutGroupResponseBody) };
    inline SignOutGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, SignOutGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SignOutGroupResponseBody> body_ {};
  };
