...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAgentStateLogsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAgentStateLogsResponseBodyData>) };
    inline vector<ListAgentStateLogsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAgentStateLogsResponseBodyData>) };
    inline ListAgentStateLogsResponseBody& setData(const vector<ListAgentStateLogsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAgentStateLogsResponseBody& setData(vector<ListAgentStateLogsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAgentStateLogsResponseBodyData>> data_ = nullptr;
