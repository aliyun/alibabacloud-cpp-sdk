...
namespace Models
{
  ...
  public:
    ...
    inline AnswerCallRequest& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline AnswerCallRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
