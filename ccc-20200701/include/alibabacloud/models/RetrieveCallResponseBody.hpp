...
#ifndef ALIBABACLOUD_MODELS_RETRIEVECALLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_RETRIEVECALLRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RetrieveCallResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RetrieveCallResponseBody& obj) { 
    ...
    RetrieveCallResponseBody() = default ;
    RetrieveCallResponseBody(const RetrieveCallResponseBody &) = default ;
    RetrieveCallResponseBody(RetrieveCallResponseBody &&) = default ;
    RetrieveCallResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RetrieveCallResponseBody() = default ;
    RetrieveCallResponseBody& operator=(const RetrieveCallResponseBody &) = default ;
    RetrieveCallResponseBody& operator=(RetrieveCallResponseBody &&) = default ;
    ...
    inline RetrieveCallResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const RetrieveCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, RetrieveCallResponseBody::Data) };
    inline RetrieveCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, RetrieveCallResponseBody::Data) };
    inline RetrieveCallResponseBody& setData(const RetrieveCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RetrieveCallResponseBody& setData(RetrieveCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline RetrieveCallResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline RetrieveCallResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline RetrieveCallResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline RetrieveCallResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline RetrieveCallResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<RetrieveCallResponseBody::Data> data_ {};
