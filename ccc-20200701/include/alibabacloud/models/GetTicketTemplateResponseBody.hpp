...
namespace Models
{
  ...
  public:
    ...
    inline const GetTicketTemplateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTicketTemplateResponseBodyData) };
    inline GetTicketTemplateResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTicketTemplateResponseBodyData) };
    inline GetTicketTemplateResponseBody& setData(const GetTicketTemplateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTicketTemplateResponseBody& setData(GetTicketTemplateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetTicketTemplateResponseBodyData> data_ = nullptr;
