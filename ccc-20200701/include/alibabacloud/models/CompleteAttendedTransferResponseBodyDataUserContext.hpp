...
#ifndef ALIBABACLOUD_MODELS_COMPLETEATTENDEDTRANSFERRESPONSEBODYDATAUSERCONTEXT_HPP_
#define ALIBABACLOUD_MODELS_COMPLETEATTENDEDTRANSFERRESPONSEBODYDATAUSERCONTEXT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CompleteAttendedTransferResponseBodyDataUserContext& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CompleteAttendedTransferResponseBodyDataUserContext& obj) { 
    ...
    CompleteAttendedTransferResponseBodyDataUserContext() = default ;
    CompleteAttendedTransferResponseBodyDataUserContext(const CompleteAttendedTransferResponseBodyDataUserContext &) = default ;
    CompleteAttendedTransferResponseBodyDataUserContext(CompleteAttendedTransferResponseBodyDataUserContext &&) = default ;
    CompleteAttendedTransferResponseBodyDataUserContext(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CompleteAttendedTransferResponseBodyDataUserContext() = default ;
    CompleteAttendedTransferResponseBodyDataUserContext& operator=(const CompleteAttendedTransferResponseBodyDataUserContext &) = default ;
    CompleteAttendedTransferResponseBodyDataUserContext& operator=(CompleteAttendedTransferResponseBodyDataUserContext &&) = default ;
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setHeartbeat(int64_t heartbeat) { DARABONBA_PTR_SET_VALUE(heartbeat_, heartbeat) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline CompleteAttendedTransferResponseBodyDataUserContext& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline CompleteAttendedTransferResponseBodyDataUserContext& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
