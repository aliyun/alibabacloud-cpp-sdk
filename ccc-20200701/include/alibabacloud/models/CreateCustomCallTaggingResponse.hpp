...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCustomCallTaggingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCustomCallTaggingResponseBody) };
    inline CreateCustomCallTaggingResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCustomCallTaggingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCustomCallTaggingResponseBody> body_ {};
  };
