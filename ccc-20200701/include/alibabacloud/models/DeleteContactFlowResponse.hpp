...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteContactFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteContactFlowResponseBody) };
    inline DeleteContactFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteContactFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteContactFlowResponseBody> body_ {};
  };
