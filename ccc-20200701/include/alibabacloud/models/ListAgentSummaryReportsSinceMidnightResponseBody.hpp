...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->pagedAgentSummaryReport_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ListAgentSummaryReportsSinceMidnightResponseBodyPagedAgentSummaryReport & pagedAgentSummaryReport() const { DARABONBA_PTR_GET_CONST(pagedAgentSummaryReport_, ListAgentSummaryReportsSinceMidnightResponseBodyPagedAgentSummaryReport) };
    inline ListAgentSummaryReportsSinceMidnightResponseBodyPagedAgentSummaryReport pagedAgentSummaryReport() { DARABONBA_PTR_GET(pagedAgentSummaryReport_, ListAgentSummaryReportsSinceMidnightResponseBodyPagedAgentSummaryReport) };
    inline ListAgentSummaryReportsSinceMidnightResponseBody& setPagedAgentSummaryReport(const ListAgentSummaryReportsSinceMidnightResponseBodyPagedAgentSummaryReport & pagedAgentSummaryReport) { DARABONBA_PTR_SET_VALUE(pagedAgentSummaryReport_, pagedAgentSummaryReport) };
    inline ListAgentSummaryReportsSinceMidnightResponseBody& setPagedAgentSummaryReport(ListAgentSummaryReportsSinceMidnightResponseBodyPagedAgentSummaryReport && pagedAgentSummaryReport) { DARABONBA_PTR_SET_RVALUE(pagedAgentSummaryReport_, pagedAgentSummaryReport) };
  ...
  protected:
    ...
    std::shared_ptr<ListAgentSummaryReportsSinceMidnightResponseBodyPagedAgentSummaryReport> pagedAgentSummaryReport_ = nullptr;
