...
#ifndef ALIBABACLOUD_MODELS_RESETAGENTSTATERESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_RESETAGENTSTATERESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ResetAgentStateResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ResetAgentStateResponseBodyData& obj) { 
    ...
    ResetAgentStateResponseBodyData() = default ;
    ResetAgentStateResponseBodyData(const ResetAgentStateResponseBodyData &) = default ;
    ResetAgentStateResponseBodyData(ResetAgentStateResponseBodyData &&) = default ;
    ResetAgentStateResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ResetAgentStateResponseBodyData() = default ;
    ResetAgentStateResponseBodyData& operator=(const ResetAgentStateResponseBodyData &) = default ;
    ResetAgentStateResponseBodyData& operator=(ResetAgentStateResponseBodyData &&) = default ;
    ...
    inline ResetAgentStateResponseBodyData& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline ResetAgentStateResponseBodyData& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline ResetAgentStateResponseBodyData& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline ResetAgentStateResponseBodyData& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ResetAgentStateResponseBodyData& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline ResetAgentStateResponseBodyData& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline ResetAgentStateResponseBodyData& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline ResetAgentStateResponseBodyData& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline ResetAgentStateResponseBodyData& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline ResetAgentStateResponseBodyData& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline ResetAgentStateResponseBodyData& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
