...
namespace Models
{
  ...
  public:
    ...
    inline const ProcessCustomIMCallbackResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ProcessCustomIMCallbackResponseBody) };
    inline ProcessCustomIMCallbackResponseBody body() { DARABONBA_PTR_GET(body_, ProcessCustomIMCallbackResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ProcessCustomIMCallbackResponseBody> body_ = nullptr;
  };
