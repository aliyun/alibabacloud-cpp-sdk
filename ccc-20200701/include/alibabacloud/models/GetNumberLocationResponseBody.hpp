...
namespace Models
{
  ...
  public:
    ...
    inline const GetNumberLocationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetNumberLocationResponseBodyData) };
    inline GetNumberLocationResponseBodyData data() { DARABONBA_PTR_GET(data_, GetNumberLocationResponseBodyData) };
    inline GetNumberLocationResponseBody& setData(const GetNumberLocationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetNumberLocationResponseBody& setData(GetNumberLocationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetNumberLocationResponseBodyData> data_ = nullptr;
