...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callType_ == nullptr
        && return this->channelId_ == nullptr && return this->channelState_ == nullptr && return this->channelVariables_ == nullptr && return this->destination_ == nullptr && return this->index_ == nullptr
