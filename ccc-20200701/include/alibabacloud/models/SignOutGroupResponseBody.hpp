...
#ifndef ALIBABACLOUD_MODELS_SIGNOUTGROUPRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SIGNOUTGROUPRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SignOutGroupResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SignOutGroupResponseBody& obj) { 
    ...
    SignOutGroupResponseBody() = default ;
    SignOutGroupResponseBody(const SignOutGroupResponseBody &) = default ;
    SignOutGroupResponseBody(SignOutGroupResponseBody &&) = default ;
    SignOutGroupResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SignOutGroupResponseBody() = default ;
    SignOutGroupResponseBody& operator=(const SignOutGroupResponseBody &) = default ;
    SignOutGroupResponseBody& operator=(SignOutGroupResponseBody &&) = default ;
    ...
    inline SignOutGroupResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const SignOutGroupResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SignOutGroupResponseBody::Data) };
    inline SignOutGroupResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SignOutGroupResponseBody::Data) };
    inline SignOutGroupResponseBody& setData(const SignOutGroupResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SignOutGroupResponseBody& setData(SignOutGroupResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline SignOutGroupResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline SignOutGroupResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline SignOutGroupResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline SignOutGroupResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline SignOutGroupResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<SignOutGroupResponseBody::Data> data_ {};
