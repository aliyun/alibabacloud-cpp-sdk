...
namespace Models
{
  ...
  public:
    ...
    inline const ListLegacyAppraiseLogsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListLegacyAppraiseLogsResponseBodyData) };
    inline ListLegacyAppraiseLogsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListLegacyAppraiseLogsResponseBodyData) };
    inline ListLegacyAppraiseLogsResponseBody& setData(const ListLegacyAppraiseLogsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListLegacyAppraiseLogsResponseBody& setData(ListLegacyAppraiseLogsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListLegacyAppraiseLogsResponseBodyData> data_ = nullptr;
