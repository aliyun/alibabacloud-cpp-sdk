...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actualEndTime_ == nullptr
        ...
        && return this->completionRate_ == nullptr && return this->contactFlowId_ == nullptr && return this->maxAttemptCount_ == nullptr && return this->minAttemptInterval_ == nullptr && return this->name_ == nullptr
        && return this->planedEndTime_ == nullptr && return this->planedStartTime_ == nullptr && return this->queueId_ == nullptr && return this->queueName_ == nullptr && return this->simulation_ == nullptr
        && return this->state_ == nullptr && return this->strategyParameters_ == nullptr && return this->strategyType_ == nullptr && return this->totalCases_ == nullptr; };
