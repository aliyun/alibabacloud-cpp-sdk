...
namespace Models
{
  ...
  public:
    ...
    inline const GetAudioFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAudioFileResponseBody) };
    inline GetAudioFileResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAudioFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAudioFileResponseBody> body_ {};
  };
