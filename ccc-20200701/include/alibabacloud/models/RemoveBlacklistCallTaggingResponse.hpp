...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveBlacklistCallTaggingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveBlacklistCallTaggingResponseBody) };
    inline RemoveBlacklistCallTaggingResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveBlacklistCallTaggingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveBlacklistCallTaggingResponseBody> body_ {};
  };
