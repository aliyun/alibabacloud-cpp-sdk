...
namespace Models
{
  ...
  public:
    ...
    inline const ReleaseCallResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReleaseCallResponseBody) };
    inline ReleaseCallResponseBody getBody() { DARABONBA_PTR_GET(body_, ReleaseCallResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReleaseCallResponseBody> body_ {};
  };
