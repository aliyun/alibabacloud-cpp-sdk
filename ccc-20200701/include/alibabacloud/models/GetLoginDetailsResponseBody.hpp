...
namespace Models
{
  ...
  public:
    ...
    inline const GetLoginDetailsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetLoginDetailsResponseBodyData) };
    inline GetLoginDetailsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetLoginDetailsResponseBodyData) };
    inline GetLoginDetailsResponseBody& setData(const GetLoginDetailsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetLoginDetailsResponseBody& setData(GetLoginDetailsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetLoginDetailsResponseBodyData> data_ = nullptr;
