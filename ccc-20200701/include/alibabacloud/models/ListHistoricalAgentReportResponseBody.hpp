...
namespace Models
{
  ...
  public:
    ...
    inline const ListHistoricalAgentReportResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListHistoricalAgentReportResponseBodyData) };
    inline ListHistoricalAgentReportResponseBodyData data() { DARABONBA_PTR_GET(data_, ListHistoricalAgentReportResponseBodyData) };
    inline ListHistoricalAgentReportResponseBody& setData(const ListHistoricalAgentReportResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHistoricalAgentReportResponseBody& setData(ListHistoricalAgentReportResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListHistoricalAgentReportResponseBodyData> data_ = nullptr;
