...
namespace Models
{
  ...
  public:
    ...
    inline const ListFeedbacksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFeedbacksResponseBody) };
    inline ListFeedbacksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFeedbacksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFeedbacksResponseBody> body_ {};
  };
