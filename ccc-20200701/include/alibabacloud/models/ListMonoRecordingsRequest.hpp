...
namespace Models
{
  ...
  public:
    ...
    inline ListMonoRecordingsRequest& setAgentChannelId(string agentChannelId) { DARABONBA_PTR_SET_VALUE(agentChannelId_, agentChannelId) };
    ...
    inline ListMonoRecordingsRequest& setAgentId(string agentId) { DARABONBA_PTR_SET_VALUE(agentId_, agentId) };
