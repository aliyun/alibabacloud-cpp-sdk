...
#ifndef ALIBABACLOUD_MODELS_MONITORCALLRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MONITORCALLRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const MonitorCallResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, MonitorCallResponseBody& obj) { 
    ...
    MonitorCallResponseBody() = default ;
    MonitorCallResponseBody(const MonitorCallResponseBody &) = default ;
    MonitorCallResponseBody(MonitorCallResponseBody &&) = default ;
    MonitorCallResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~MonitorCallResponseBody() = default ;
    MonitorCallResponseBody& operator=(const MonitorCallResponseBody &) = default ;
    MonitorCallResponseBody& operator=(MonitorCallResponseBody &&) = default ;
    ...
    public:
      ...
      protected:
        ...
        // The time when the agent was most recently reserved. Being reserved means an incoming call will soon be assigned to the agent, formatted as a UNIX timestamp in milliseconds.
    ...
    inline MonitorCallResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const MonitorCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, MonitorCallResponseBody::Data) };
    inline MonitorCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, MonitorCallResponseBody::Data) };
    inline MonitorCallResponseBody& setData(const MonitorCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline MonitorCallResponseBody& setData(MonitorCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline MonitorCallResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline MonitorCallResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline MonitorCallResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline MonitorCallResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline MonitorCallResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
  ...
  protected:
    ...
    // Data.
    shared_ptr<MonitorCallResponseBody::Data> data_ {};
    // HTTP status code.
