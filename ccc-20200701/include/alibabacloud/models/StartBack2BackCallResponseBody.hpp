...
namespace Models
{
  ...
  public:
    ...
    inline const StartBack2BackCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, StartBack2BackCallResponseBody::Data) };
    inline StartBack2BackCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, StartBack2BackCallResponseBody::Data) };
    inline StartBack2BackCallResponseBody& setData(const StartBack2BackCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StartBack2BackCallResponseBody& setData(StartBack2BackCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<StartBack2BackCallResponseBody::Data> data_ {};
