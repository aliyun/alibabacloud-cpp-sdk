...
#ifndef ALIBABACLOUD_MODELS_ENDCONFERENCERESPONSEBODYDATAUSERCONTEXT_HPP_
#define ALIBABACLOUD_MODELS_ENDCONFERENCERESPONSEBODYDATAUSERCONTEXT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const EndConferenceResponseBodyDataUserContext& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EndConferenceResponseBodyDataUserContext& obj) { 
    ...
    EndConferenceResponseBodyDataUserContext() = default ;
    EndConferenceResponseBodyDataUserContext(const EndConferenceResponseBodyDataUserContext &) = default ;
    EndConferenceResponseBodyDataUserContext(EndConferenceResponseBodyDataUserContext &&) = default ;
    EndConferenceResponseBodyDataUserContext(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EndConferenceResponseBodyDataUserContext() = default ;
    EndConferenceResponseBodyDataUserContext& operator=(const EndConferenceResponseBodyDataUserContext &) = default ;
    EndConferenceResponseBodyDataUserContext& operator=(EndConferenceResponseBodyDataUserContext &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->breakCode_ == nullptr
        && return this->deviceId_ == nullptr && return this->deviceState_ == nullptr && return this->extension_ == nullptr && return this->instanceId_ == nullptr && return this->jobId_ == nullptr
    ...
    inline EndConferenceResponseBodyDataUserContext& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline EndConferenceResponseBodyDataUserContext& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline EndConferenceResponseBodyDataUserContext& setDeviceState(string deviceState) { DARABONBA_PTR_SET_VALUE(deviceState_, deviceState) };
    ...
    inline EndConferenceResponseBodyDataUserContext& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline EndConferenceResponseBodyDataUserContext& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline EndConferenceResponseBodyDataUserContext& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline EndConferenceResponseBodyDataUserContext& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline EndConferenceResponseBodyDataUserContext& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline EndConferenceResponseBodyDataUserContext& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline EndConferenceResponseBodyDataUserContext& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline EndConferenceResponseBodyDataUserContext& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline EndConferenceResponseBodyDataUserContext& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
