...
#ifndef ALIBABACLOUD_MODELS_READYFORSERVICERESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_READYFORSERVICERESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ReadyForServiceResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadyForServiceResponseBodyData& obj) { 
    ...
    ReadyForServiceResponseBodyData() = default ;
    ReadyForServiceResponseBodyData(const ReadyForServiceResponseBodyData &) = default ;
    ReadyForServiceResponseBodyData(ReadyForServiceResponseBodyData &&) = default ;
    ReadyForServiceResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadyForServiceResponseBodyData() = default ;
    ReadyForServiceResponseBodyData& operator=(const ReadyForServiceResponseBodyData &) = default ;
    ReadyForServiceResponseBodyData& operator=(ReadyForServiceResponseBodyData &&) = default ;
    ...
    inline ReadyForServiceResponseBodyData& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline ReadyForServiceResponseBodyData& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline ReadyForServiceResponseBodyData& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline ReadyForServiceResponseBodyData& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ReadyForServiceResponseBodyData& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline ReadyForServiceResponseBodyData& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline ReadyForServiceResponseBodyData& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline ReadyForServiceResponseBodyData& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline ReadyForServiceResponseBodyData& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline ReadyForServiceResponseBodyData& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline ReadyForServiceResponseBodyData& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
