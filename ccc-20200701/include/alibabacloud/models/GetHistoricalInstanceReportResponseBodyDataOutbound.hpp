...
#ifndef ALIBABACLOUD_MODELS_GETHISTORICALINSTANCEREPORTRESPONSEBODYDATAOUTBOUND_HPP_
#define ALIBABACLOUD_MODELS_GETHISTORICALINSTANCEREPORTRESPONSEBODYDATAOUTBOUND_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetHistoricalInstanceReportResponseBodyDataOutbound& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetHistoricalInstanceReportResponseBodyDataOutbound& obj) { 
    ...
    GetHistoricalInstanceReportResponseBodyDataOutbound() = default ;
    GetHistoricalInstanceReportResponseBodyDataOutbound(const GetHistoricalInstanceReportResponseBodyDataOutbound &) = default ;
    GetHistoricalInstanceReportResponseBodyDataOutbound(GetHistoricalInstanceReportResponseBodyDataOutbound &&) = default ;
    GetHistoricalInstanceReportResponseBodyDataOutbound(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetHistoricalInstanceReportResponseBodyDataOutbound() = default ;
    GetHistoricalInstanceReportResponseBodyDataOutbound& operator=(const GetHistoricalInstanceReportResponseBodyDataOutbound &) = default ;
    GetHistoricalInstanceReportResponseBodyDataOutbound& operator=(GetHistoricalInstanceReportResponseBodyDataOutbound &&) = default ;
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setAnswerRate(float answerRate) { DARABONBA_PTR_SET_VALUE(answerRate_, answerRate) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setAverageDialingTime(float averageDialingTime) { DARABONBA_PTR_SET_VALUE(averageDialingTime_, averageDialingTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setAverageHoldTime(float averageHoldTime) { DARABONBA_PTR_SET_VALUE(averageHoldTime_, averageHoldTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setAverageRingTime(float averageRingTime) { DARABONBA_PTR_SET_VALUE(averageRingTime_, averageRingTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setAverageWorkTime(float averageWorkTime) { DARABONBA_PTR_SET_VALUE(averageWorkTime_, averageWorkTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setCallsAnswered(int64_t callsAnswered) { DARABONBA_PTR_SET_VALUE(callsAnswered_, callsAnswered) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setCallsAttendedTransferred(int64_t callsAttendedTransferred) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferred_, callsAttendedTransferred) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setCallsBlindTransferred(int64_t callsBlindTransferred) { DARABONBA_PTR_SET_VALUE(callsBlindTransferred_, callsBlindTransferred) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setCallsDialed(int64_t callsDialed) { DARABONBA_PTR_SET_VALUE(callsDialed_, callsDialed) };
    ...
    inline int32_t callsHold() const { DARABONBA_PTR_GET_DEFAULT(callsHold_, 0) };
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setCallsHold(int32_t callsHold) { DARABONBA_PTR_SET_VALUE(callsHold_, callsHold) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setCallsRinged(int64_t callsRinged) { DARABONBA_PTR_SET_VALUE(callsRinged_, callsRinged) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setMaxDialingTime(int64_t maxDialingTime) { DARABONBA_PTR_SET_VALUE(maxDialingTime_, maxDialingTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setMaxHoldTime(int64_t maxHoldTime) { DARABONBA_PTR_SET_VALUE(maxHoldTime_, maxHoldTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setMaxRingTime(int64_t maxRingTime) { DARABONBA_PTR_SET_VALUE(maxRingTime_, maxRingTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setMaxWorkTime(int64_t maxWorkTime) { DARABONBA_PTR_SET_VALUE(maxWorkTime_, maxWorkTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setSatisfactionIndex(float satisfactionIndex) { DARABONBA_PTR_SET_VALUE(satisfactionIndex_, satisfactionIndex) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setSatisfactionRate(float satisfactionRate) { DARABONBA_PTR_SET_VALUE(satisfactionRate_, satisfactionRate) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setSatisfactionSurveysOffered(int64_t satisfactionSurveysOffered) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysOffered_, satisfactionSurveysOffered) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setSatisfactionSurveysResponded(int64_t satisfactionSurveysResponded) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysResponded_, satisfactionSurveysResponded) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setTotalDialingTime(int64_t totalDialingTime) { DARABONBA_PTR_SET_VALUE(totalDialingTime_, totalDialingTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setTotalHoldTime(int64_t totalHoldTime) { DARABONBA_PTR_SET_VALUE(totalHoldTime_, totalHoldTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setTotalRingTime(int64_t totalRingTime) { DARABONBA_PTR_SET_VALUE(totalRingTime_, totalRingTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
    ...
    inline GetHistoricalInstanceReportResponseBodyDataOutbound& setTotalWorkTime(int64_t totalWorkTime) { DARABONBA_PTR_SET_VALUE(totalWorkTime_, totalWorkTime) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> callsHold_ = nullptr;
