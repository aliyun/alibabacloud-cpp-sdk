...
#ifndef ALIBABACLOUD_MODELS_CREATESCHEMAREQUESTPROPERTIES_HPP_
#define ALIBABACLOUD_MODELS_CREATESCHEMAREQUESTPROPERTIES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateSchemaRequestProperties& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateSchemaRequestProperties& obj) { 
    ...
    CreateSchemaRequestProperties() = default ;
    CreateSchemaRequestProperties(const CreateSchemaRequestProperties &) = default ;
    CreateSchemaRequestProperties(CreateSchemaRequestProperties &&) = default ;
    CreateSchemaRequestProperties(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateSchemaRequestProperties() = default ;
    CreateSchemaRequestProperties& operator=(const CreateSchemaRequestProperties &) = default ;
    CreateSchemaRequestProperties& operator=(CreateSchemaRequestProperties &&) = default ;
    ...
    inline CreateSchemaRequestProperties& setArray(bool array) { DARABONBA_PTR_SET_VALUE(array_, array) };
    ...
    inline CreateSchemaRequestProperties& setAttributes(string attributes) { DARABONBA_PTR_SET_VALUE(attributes_, attributes) };
    ...
    inline CreateSchemaRequestProperties& setDataType(string dataType) { DARABONBA_PTR_SET_VALUE(dataType_, dataType) };
    ...
    inline CreateSchemaRequestProperties& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreateSchemaRequestProperties& setDisabled(bool disabled) { DARABONBA_PTR_SET_VALUE(disabled_, disabled) };
    ...
    inline CreateSchemaRequestProperties& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline CreateSchemaRequestProperties& setDisplayOrder(int32_t displayOrder) { DARABONBA_PTR_SET_VALUE(displayOrder_, displayOrder) };
    ...
    inline CreateSchemaRequestProperties& setEditorType(string editorType) { DARABONBA_PTR_SET_VALUE(editorType_, editorType) };
    ...
    inline CreateSchemaRequestProperties& setMaxLength(int32_t maxLength) { DARABONBA_PTR_SET_VALUE(maxLength_, maxLength) };
    ...
    inline CreateSchemaRequestProperties& setMaximum(double maximum) { DARABONBA_PTR_SET_VALUE(maximum_, maximum) };
    ...
    inline CreateSchemaRequestProperties& setMinLength(int32_t minLength) { DARABONBA_PTR_SET_VALUE(minLength_, minLength) };
    ...
    inline CreateSchemaRequestProperties& setMinimum(double minimum) { DARABONBA_PTR_SET_VALUE(minimum_, minimum) };
    ...
    inline CreateSchemaRequestProperties& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateSchemaRequestProperties& setPattern(string pattern) { DARABONBA_PTR_SET_VALUE(pattern_, pattern) };
    ...
    inline CreateSchemaRequestProperties& setPatternErrorMessage(string patternErrorMessage) { DARABONBA_PTR_SET_VALUE(patternErrorMessage_, patternErrorMessage) };
    ...
    inline CreateSchemaRequestProperties& setReadOnly(bool readOnly) { DARABONBA_PTR_SET_VALUE(readOnly_, readOnly) };
    ...
    inline CreateSchemaRequestProperties& setRequired(bool required) { DARABONBA_PTR_SET_VALUE(required_, required) };
