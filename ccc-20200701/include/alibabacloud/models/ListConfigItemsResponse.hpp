...
namespace Models
{
  ...
  public:
    ...
    inline const ListConfigItemsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListConfigItemsResponseBody) };
    inline ListConfigItemsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListConfigItemsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListConfigItemsResponseBody> body_ {};
  };
