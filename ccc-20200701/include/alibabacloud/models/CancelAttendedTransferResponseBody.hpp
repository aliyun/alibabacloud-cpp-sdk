...
#ifndef ALIBABACLOUD_MODELS_CANCELATTENDEDTRANSFERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CANCELATTENDEDTRANSFERRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CancelAttendedTransferResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CancelAttendedTransferResponseBody& obj) { 
    ...
    CancelAttendedTransferResponseBody() = default ;
    CancelAttendedTransferResponseBody(const CancelAttendedTransferResponseBody &) = default ;
    CancelAttendedTransferResponseBody(CancelAttendedTransferResponseBody &&) = default ;
    CancelAttendedTransferResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CancelAttendedTransferResponseBody() = default ;
    CancelAttendedTransferResponseBody& operator=(const CancelAttendedTransferResponseBody &) = default ;
    CancelAttendedTransferResponseBody& operator=(CancelAttendedTransferResponseBody &&) = default ;
    ...
    inline CancelAttendedTransferResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CancelAttendedTransferResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CancelAttendedTransferResponseBody::Data) };
    inline CancelAttendedTransferResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CancelAttendedTransferResponseBody::Data) };
    inline CancelAttendedTransferResponseBody& setData(const CancelAttendedTransferResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CancelAttendedTransferResponseBody& setData(CancelAttendedTransferResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CancelAttendedTransferResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CancelAttendedTransferResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CancelAttendedTransferResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline CancelAttendedTransferResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline CancelAttendedTransferResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<CancelAttendedTransferResponseBody::Data> data_ {};
