...
namespace Models
{
  ...
  public:
    ...
    inline const ListContactFlowsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListContactFlowsResponseBodyData) };
    inline ListContactFlowsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListContactFlowsResponseBodyData) };
    inline ListContactFlowsResponseBody& setData(const ListContactFlowsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListContactFlowsResponseBody& setData(ListContactFlowsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListContactFlowsResponseBodyData> data_ = nullptr;
