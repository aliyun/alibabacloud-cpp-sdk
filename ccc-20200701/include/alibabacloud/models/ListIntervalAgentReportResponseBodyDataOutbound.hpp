...
#ifndef ALIBABACLOUD_MODELS_LISTINTERVALAGENTREPORTRESPONSEBODYDATAOUTBOUND_HPP_
#define ALIBABACLOUD_MODELS_LISTINTERVALAGENTREPORTRESPONSEBODYDATAOUTBOUND_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListIntervalAgentReportResponseBodyDataOutbound& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListIntervalAgentReportResponseBodyDataOutbound& obj) { 
    ...
    ListIntervalAgentReportResponseBodyDataOutbound() = default ;
    ListIntervalAgentReportResponseBodyDataOutbound(const ListIntervalAgentReportResponseBodyDataOutbound &) = default ;
    ListIntervalAgentReportResponseBodyDataOutbound(ListIntervalAgentReportResponseBodyDataOutbound &&) = default ;
    ListIntervalAgentReportResponseBodyDataOutbound(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIntervalAgentReportResponseBodyDataOutbound() = default ;
    ListIntervalAgentReportResponseBodyDataOutbound& operator=(const ListIntervalAgentReportResponseBodyDataOutbound &) = default ;
    ListIntervalAgentReportResponseBodyDataOutbound& operator=(ListIntervalAgentReportResponseBodyDataOutbound &&) = default ;
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setAnswerRate(float answerRate) { DARABONBA_PTR_SET_VALUE(answerRate_, answerRate) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setAverageDialingTime(float averageDialingTime) { DARABONBA_PTR_SET_VALUE(averageDialingTime_, averageDialingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setAverageHoldTime(float averageHoldTime) { DARABONBA_PTR_SET_VALUE(averageHoldTime_, averageHoldTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setAverageRingTime(float averageRingTime) { DARABONBA_PTR_SET_VALUE(averageRingTime_, averageRingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setAverageWorkTime(float averageWorkTime) { DARABONBA_PTR_SET_VALUE(averageWorkTime_, averageWorkTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setCallsAnswered(int64_t callsAnswered) { DARABONBA_PTR_SET_VALUE(callsAnswered_, callsAnswered) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setCallsAttendedTransferIn(int64_t callsAttendedTransferIn) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferIn_, callsAttendedTransferIn) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setCallsAttendedTransferOut(int64_t callsAttendedTransferOut) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferOut_, callsAttendedTransferOut) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setCallsBlindTransferIn(int64_t callsBlindTransferIn) { DARABONBA_PTR_SET_VALUE(callsBlindTransferIn_, callsBlindTransferIn) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setCallsBlindTransferOut(int64_t callsBlindTransferOut) { DARABONBA_PTR_SET_VALUE(callsBlindTransferOut_, callsBlindTransferOut) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setCallsDialed(int64_t callsDialed) { DARABONBA_PTR_SET_VALUE(callsDialed_, callsDialed) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setCallsHold(int64_t callsHold) { DARABONBA_PTR_SET_VALUE(callsHold_, callsHold) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setCallsRinged(int64_t callsRinged) { DARABONBA_PTR_SET_VALUE(callsRinged_, callsRinged) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setMaxDialingTime(int64_t maxDialingTime) { DARABONBA_PTR_SET_VALUE(maxDialingTime_, maxDialingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setMaxHoldTime(int64_t maxHoldTime) { DARABONBA_PTR_SET_VALUE(maxHoldTime_, maxHoldTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setMaxRingTime(int64_t maxRingTime) { DARABONBA_PTR_SET_VALUE(maxRingTime_, maxRingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setMaxWorkTime(int64_t maxWorkTime) { DARABONBA_PTR_SET_VALUE(maxWorkTime_, maxWorkTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setSatisfactionIndex(float satisfactionIndex) { DARABONBA_PTR_SET_VALUE(satisfactionIndex_, satisfactionIndex) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setSatisfactionRate(float satisfactionRate) { DARABONBA_PTR_SET_VALUE(satisfactionRate_, satisfactionRate) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setSatisfactionSurveysOffered(int64_t satisfactionSurveysOffered) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysOffered_, satisfactionSurveysOffered) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setSatisfactionSurveysResponded(int64_t satisfactionSurveysResponded) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysResponded_, satisfactionSurveysResponded) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setTotalDialingTime(int64_t totalDialingTime) { DARABONBA_PTR_SET_VALUE(totalDialingTime_, totalDialingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setTotalHoldTime(int64_t totalHoldTime) { DARABONBA_PTR_SET_VALUE(totalHoldTime_, totalHoldTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setTotalRingTime(int64_t totalRingTime) { DARABONBA_PTR_SET_VALUE(totalRingTime_, totalRingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataOutbound& setTotalWorkTime(int64_t totalWorkTime) { DARABONBA_PTR_SET_VALUE(totalWorkTime_, totalWorkTime) };
