...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListSkillGroupsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListSkillGroupsResponseBody& obj) { 
    ...
    ListSkillGroupsResponseBody() = default ;
    ListSkillGroupsResponseBody(const ListSkillGroupsResponseBody &) = default ;
    ListSkillGroupsResponseBody(ListSkillGroupsResponseBody &&) = default ;
    ListSkillGroupsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListSkillGroupsResponseBody() = default ;
    ListSkillGroupsResponseBody& operator=(const ListSkillGroupsResponseBody &) = default ;
    ListSkillGroupsResponseBody& operator=(ListSkillGroupsResponseBody &&) = default ;
