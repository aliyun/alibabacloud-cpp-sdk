...
namespace Models
{
  ...
  public:
    ...
    inline const ListFlashSmsTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFlashSmsTemplatesResponseBody) };
    inline ListFlashSmsTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFlashSmsTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFlashSmsTemplatesResponseBody> body_ {};
  };
