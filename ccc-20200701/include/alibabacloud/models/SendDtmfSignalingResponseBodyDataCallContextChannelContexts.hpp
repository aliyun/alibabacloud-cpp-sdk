...
#ifndef ALIBABACLOUD_MODELS_SENDDTMFSIGNALINGRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
#define ALIBABACLOUD_MODELS_SENDDTMFSIGNALINGRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SendDtmfSignalingResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SendDtmfSignalingResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    SendDtmfSignalingResponseBodyDataCallContextChannelContexts() = default ;
    SendDtmfSignalingResponseBodyDataCallContextChannelContexts(const SendDtmfSignalingResponseBodyDataCallContextChannelContexts &) = default ;
    SendDtmfSignalingResponseBodyDataCallContextChannelContexts(SendDtmfSignalingResponseBodyDataCallContextChannelContexts &&) = default ;
    SendDtmfSignalingResponseBodyDataCallContextChannelContexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SendDtmfSignalingResponseBodyDataCallContextChannelContexts() = default ;
    SendDtmfSignalingResponseBodyDataCallContextChannelContexts& operator=(const SendDtmfSignalingResponseBodyDataCallContextChannelContexts &) = default ;
    SendDtmfSignalingResponseBodyDataCallContextChannelContexts& operator=(SendDtmfSignalingResponseBodyDataCallContextChannelContexts &&) = default ;
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setCallType(string callType) { DARABONBA_PTR_SET_VALUE(callType_, callType) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setChannelFlags(string channelFlags) { DARABONBA_PTR_SET_VALUE(channelFlags_, channelFlags) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setChannelState(string channelState) { DARABONBA_PTR_SET_VALUE(channelState_, channelState) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setDestination(string destination) { DARABONBA_PTR_SET_VALUE(destination_, destination) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setIndex(int32_t index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setOriginator(string originator) { DARABONBA_PTR_SET_VALUE(originator_, originator) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setReleaseInitiator(string releaseInitiator) { DARABONBA_PTR_SET_VALUE(releaseInitiator_, releaseInitiator) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setReleaseReason(string releaseReason) { DARABONBA_PTR_SET_VALUE(releaseReason_, releaseReason) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setSkillGroupId(string skillGroupId) { DARABONBA_PTR_SET_VALUE(skillGroupId_, skillGroupId) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setUserExtension(string userExtension) { DARABONBA_PTR_SET_VALUE(userExtension_, userExtension) };
    ...
    inline SendDtmfSignalingResponseBodyDataCallContextChannelContexts& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
