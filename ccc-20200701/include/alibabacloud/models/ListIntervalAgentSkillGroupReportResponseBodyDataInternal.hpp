...
#ifndef ALIBABACLOUD_MODELS_LISTINTERVALAGENTSKILLGROUPREPORTRESPONSEBODYDATAINTERNAL_HPP_
#define ALIBABACLOUD_MODELS_LISTINTERVALAGENTSKILLGROUPREPORTRESPONSEBODYDATAINTERNAL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListIntervalAgentSkillGroupReportResponseBodyDataInternal& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListIntervalAgentSkillGroupReportResponseBodyDataInternal& obj) { 
    ...
    ListIntervalAgentSkillGroupReportResponseBodyDataInternal() = default ;
    ListIntervalAgentSkillGroupReportResponseBodyDataInternal(const ListIntervalAgentSkillGroupReportResponseBodyDataInternal &) = default ;
    ListIntervalAgentSkillGroupReportResponseBodyDataInternal(ListIntervalAgentSkillGroupReportResponseBodyDataInternal &&) = default ;
    ListIntervalAgentSkillGroupReportResponseBodyDataInternal(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIntervalAgentSkillGroupReportResponseBodyDataInternal() = default ;
    ListIntervalAgentSkillGroupReportResponseBodyDataInternal& operator=(const ListIntervalAgentSkillGroupReportResponseBodyDataInternal &) = default ;
    ListIntervalAgentSkillGroupReportResponseBodyDataInternal& operator=(ListIntervalAgentSkillGroupReportResponseBodyDataInternal &&) = default ;
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataInternal& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataInternal& setCallsAnswered(int64_t callsAnswered) { DARABONBA_PTR_SET_VALUE(callsAnswered_, callsAnswered) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataInternal& setCallsDialed(int64_t callsDialed) { DARABONBA_PTR_SET_VALUE(callsDialed_, callsDialed) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataInternal& setCallsHandled(int64_t callsHandled) { DARABONBA_PTR_SET_VALUE(callsHandled_, callsHandled) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataInternal& setCallsOffered(int64_t callsOffered) { DARABONBA_PTR_SET_VALUE(callsOffered_, callsOffered) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataInternal& setCallsTalk(int64_t callsTalk) { DARABONBA_PTR_SET_VALUE(callsTalk_, callsTalk) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataInternal& setCallsTalked(int64_t callsTalked) { DARABONBA_PTR_SET_VALUE(callsTalked_, callsTalked) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataInternal& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataInternal& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
