...
namespace Models
{
  ...
  public:
    ...
    inline const GetMonoRecordingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMonoRecordingResponseBody) };
    inline GetMonoRecordingResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMonoRecordingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMonoRecordingResponseBody> body_ {};
  };
