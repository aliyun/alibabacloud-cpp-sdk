...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callTagList_ == nullptr
        && return this->creator_ == nullptr && return this->description_ == nullptr && return this->instanceId_ == nullptr && return this->number_ == nullptr && return this->updateTime_ == nullptr; };
