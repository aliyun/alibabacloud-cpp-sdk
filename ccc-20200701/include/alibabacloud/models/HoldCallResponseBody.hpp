...
namespace Models
{
  ...
  public:
    ...
    inline const HoldCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, HoldCallResponseBody::Data) };
    inline HoldCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, HoldCallResponseBody::Data) };
    inline HoldCallResponseBody& setData(const HoldCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline HoldCallResponseBody& setData(HoldCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline HoldCallResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline HoldCallResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline HoldCallResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
  ...
  protected:
    ...
    shared_ptr<HoldCallResponseBody::Data> data_ {};
