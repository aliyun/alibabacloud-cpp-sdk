...
namespace Models
{
  ...
  public:
    ...
    inline const vector<PickOutboundNumbersResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<PickOutboundNumbersResponseBodyData>) };
    inline vector<PickOutboundNumbersResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<PickOutboundNumbersResponseBodyData>) };
    inline PickOutboundNumbersResponseBody& setData(const vector<PickOutboundNumbersResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PickOutboundNumbersResponseBody& setData(vector<PickOutboundNumbersResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<PickOutboundNumbersResponseBodyData>> data_ = nullptr;
