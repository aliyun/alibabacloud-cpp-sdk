...
namespace Models
{
  ...
  public:
    ...
    inline const GetContactFlowResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetContactFlowResponseBodyData) };
    inline GetContactFlowResponseBodyData data() { DARABONBA_PTR_GET(data_, GetContactFlowResponseBodyData) };
    inline GetContactFlowResponseBody& setData(const GetContactFlowResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetContactFlowResponseBody& setData(GetContactFlowResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetContactFlowResponseBodyData> data_ = nullptr;
