...
namespace Models
{
  ...
  public:
    ...
    inline const CancelAttendedTransferResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelAttendedTransferResponseBody) };
    inline CancelAttendedTransferResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelAttendedTransferResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelAttendedTransferResponseBody> body_ {};
  };
