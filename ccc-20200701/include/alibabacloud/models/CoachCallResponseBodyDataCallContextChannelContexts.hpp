...
#ifndef ALIBABACLOUD_MODELS_COACHCALLRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
#define ALIBABACLOUD_MODELS_COACHCALLRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CoachCallResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CoachCallResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    CoachCallResponseBodyDataCallContextChannelContexts() = default ;
    CoachCallResponseBodyDataCallContextChannelContexts(const CoachCallResponseBodyDataCallContextChannelContexts &) = default ;
    CoachCallResponseBodyDataCallContextChannelContexts(CoachCallResponseBodyDataCallContextChannelContexts &&) = default ;
    CoachCallResponseBodyDataCallContextChannelContexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CoachCallResponseBodyDataCallContextChannelContexts() = default ;
    CoachCallResponseBodyDataCallContextChannelContexts& operator=(const CoachCallResponseBodyDataCallContextChannelContexts &) = default ;
    CoachCallResponseBodyDataCallContextChannelContexts& operator=(CoachCallResponseBodyDataCallContextChannelContexts &&) = default ;
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setCallType(string callType) { DARABONBA_PTR_SET_VALUE(callType_, callType) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setChannelFlags(string channelFlags) { DARABONBA_PTR_SET_VALUE(channelFlags_, channelFlags) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setChannelState(string channelState) { DARABONBA_PTR_SET_VALUE(channelState_, channelState) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setDestination(string destination) { DARABONBA_PTR_SET_VALUE(destination_, destination) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setIndex(int32_t index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setOriginator(string originator) { DARABONBA_PTR_SET_VALUE(originator_, originator) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setReleaseInitiator(string releaseInitiator) { DARABONBA_PTR_SET_VALUE(releaseInitiator_, releaseInitiator) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setReleaseReason(string releaseReason) { DARABONBA_PTR_SET_VALUE(releaseReason_, releaseReason) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setSkillGroupId(string skillGroupId) { DARABONBA_PTR_SET_VALUE(skillGroupId_, skillGroupId) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setUserExtension(string userExtension) { DARABONBA_PTR_SET_VALUE(userExtension_, userExtension) };
    ...
    inline CoachCallResponseBodyDataCallContextChannelContexts& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
