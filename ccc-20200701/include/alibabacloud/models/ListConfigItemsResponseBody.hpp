...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListConfigItemsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListConfigItemsResponseBodyData>) };
    inline vector<ListConfigItemsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListConfigItemsResponseBodyData>) };
    inline ListConfigItemsResponseBody& setData(const vector<ListConfigItemsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListConfigItemsResponseBody& setData(vector<ListConfigItemsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListConfigItemsResponseBodyData>> data_ = nullptr;
