...
namespace Models
{
  ...
  public:
    ...
    inline const ExportCustomCallTaggingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExportCustomCallTaggingResponseBody) };
    inline ExportCustomCallTaggingResponseBody getBody() { DARABONBA_PTR_GET(body_, ExportCustomCallTaggingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExportCustomCallTaggingResponseBody> body_ {};
  };
