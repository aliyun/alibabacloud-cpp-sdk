...
#ifndef ALIBABACLOUD_MODELS_INTERCEPTCALLRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
#define ALIBABACLOUD_MODELS_INTERCEPTCALLRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const InterceptCallResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, InterceptCallResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    InterceptCallResponseBodyDataCallContextChannelContexts() = default ;
    InterceptCallResponseBodyDataCallContextChannelContexts(const InterceptCallResponseBodyDataCallContextChannelContexts &) = default ;
    InterceptCallResponseBodyDataCallContextChannelContexts(InterceptCallResponseBodyDataCallContextChannelContexts &&) = default ;
    InterceptCallResponseBodyDataCallContextChannelContexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InterceptCallResponseBodyDataCallContextChannelContexts() = default ;
    InterceptCallResponseBodyDataCallContextChannelContexts& operator=(const InterceptCallResponseBodyDataCallContextChannelContexts &) = default ;
    InterceptCallResponseBodyDataCallContextChannelContexts& operator=(InterceptCallResponseBodyDataCallContextChannelContexts &&) = default ;
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setCallType(string callType) { DARABONBA_PTR_SET_VALUE(callType_, callType) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setChannelFlags(string channelFlags) { DARABONBA_PTR_SET_VALUE(channelFlags_, channelFlags) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setChannelState(string channelState) { DARABONBA_PTR_SET_VALUE(channelState_, channelState) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setDestination(string destination) { DARABONBA_PTR_SET_VALUE(destination_, destination) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setIndex(int32_t index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setOriginator(string originator) { DARABONBA_PTR_SET_VALUE(originator_, originator) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setReleaseInitiator(string releaseInitiator) { DARABONBA_PTR_SET_VALUE(releaseInitiator_, releaseInitiator) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setReleaseReason(string releaseReason) { DARABONBA_PTR_SET_VALUE(releaseReason_, releaseReason) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setSkillGroupId(string skillGroupId) { DARABONBA_PTR_SET_VALUE(skillGroupId_, skillGroupId) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setUserExtension(string userExtension) { DARABONBA_PTR_SET_VALUE(userExtension_, userExtension) };
    ...
    inline InterceptCallResponseBodyDataCallContextChannelContexts& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
