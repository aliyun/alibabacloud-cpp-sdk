...
#ifndef ALIBABACLOUD_MODELS_STARTCONFERENCERESPONSEBODYDATAUSERCONTEXT_HPP_
#define ALIBABACLOUD_MODELS_STARTCONFERENCERESPONSEBODYDATAUSERCONTEXT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartConferenceResponseBodyDataUserContext& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartConferenceResponseBodyDataUserContext& obj) { 
    ...
    StartConferenceResponseBodyDataUserContext() = default ;
    StartConferenceResponseBodyDataUserContext(const StartConferenceResponseBodyDataUserContext &) = default ;
    StartConferenceResponseBodyDataUserContext(StartConferenceResponseBodyDataUserContext &&) = default ;
    StartConferenceResponseBodyDataUserContext(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartConferenceResponseBodyDataUserContext() = default ;
    StartConferenceResponseBodyDataUserContext& operator=(const StartConferenceResponseBodyDataUserContext &) = default ;
    StartConferenceResponseBodyDataUserContext& operator=(StartConferenceResponseBodyDataUserContext &&) = default ;
    ...
    inline StartConferenceResponseBodyDataUserContext& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setDeviceState(string deviceState) { DARABONBA_PTR_SET_VALUE(deviceState_, deviceState) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setHeartbeat(int64_t heartbeat) { DARABONBA_PTR_SET_VALUE(heartbeat_, heartbeat) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline StartConferenceResponseBodyDataUserContext& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline StartConferenceResponseBodyDataUserContext& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
