...
#ifndef ALIBABACLOUD_MODELS_LAUNCHAUTHENTICATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LAUNCHAUTHENTICATIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const LaunchAuthenticationResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, LaunchAuthenticationResponseBody& obj) { 
    ...
    LaunchAuthenticationResponseBody() = default ;
    LaunchAuthenticationResponseBody(const LaunchAuthenticationResponseBody &) = default ;
    LaunchAuthenticationResponseBody(LaunchAuthenticationResponseBody &&) = default ;
    LaunchAuthenticationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~LaunchAuthenticationResponseBody() = default ;
    LaunchAuthenticationResponseBody& operator=(const LaunchAuthenticationResponseBody &) = default ;
    LaunchAuthenticationResponseBody& operator=(LaunchAuthenticationResponseBody &&) = default ;
    ...
    inline LaunchAuthenticationResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const LaunchAuthenticationResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, LaunchAuthenticationResponseBody::Data) };
    inline LaunchAuthenticationResponseBody::Data getData() { DARABONBA_PTR_GET(data_, LaunchAuthenticationResponseBody::Data) };
    inline LaunchAuthenticationResponseBody& setData(const LaunchAuthenticationResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline LaunchAuthenticationResponseBody& setData(LaunchAuthenticationResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline LaunchAuthenticationResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline LaunchAuthenticationResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline LaunchAuthenticationResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline LaunchAuthenticationResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline LaunchAuthenticationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<LaunchAuthenticationResponseBody::Data> data_ {};
