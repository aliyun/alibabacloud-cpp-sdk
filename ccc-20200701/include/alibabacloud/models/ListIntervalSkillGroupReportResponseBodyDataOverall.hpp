...
#ifndef ALIBABACLOUD_MODELS_LISTINTERVALSKILLGROUPREPORTRESPONSEBODYDATAOVERALL_HPP_
#define ALIBABACLOUD_MODELS_LISTINTERVALSKILLGROUPREPORTRESPONSEBODYDATAOVERALL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListIntervalSkillGroupReportResponseBodyDataOverall& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListIntervalSkillGroupReportResponseBodyDataOverall& obj) { 
    ...
    ListIntervalSkillGroupReportResponseBodyDataOverall() = default ;
    ListIntervalSkillGroupReportResponseBodyDataOverall(const ListIntervalSkillGroupReportResponseBodyDataOverall &) = default ;
    ListIntervalSkillGroupReportResponseBodyDataOverall(ListIntervalSkillGroupReportResponseBodyDataOverall &&) = default ;
    ListIntervalSkillGroupReportResponseBodyDataOverall(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIntervalSkillGroupReportResponseBodyDataOverall() = default ;
    ListIntervalSkillGroupReportResponseBodyDataOverall& operator=(const ListIntervalSkillGroupReportResponseBodyDataOverall &) = default ;
    ListIntervalSkillGroupReportResponseBodyDataOverall& operator=(ListIntervalSkillGroupReportResponseBodyDataOverall &&) = default ;
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setAverageBreakTime(float averageBreakTime) { DARABONBA_PTR_SET_VALUE(averageBreakTime_, averageBreakTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setAverageHoldTime(float averageHoldTime) { DARABONBA_PTR_SET_VALUE(averageHoldTime_, averageHoldTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setAverageReadyTime(float averageReadyTime) { DARABONBA_PTR_SET_VALUE(averageReadyTime_, averageReadyTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setAverageWorkTime(float averageWorkTime) { DARABONBA_PTR_SET_VALUE(averageWorkTime_, averageWorkTime) };
    ...
    inline const vector<Models::ListIntervalSkillGroupReportResponseBodyDataOverallBreakCodeDetailList> & breakCodeDetailList() const { DARABONBA_PTR_GET_CONST(breakCodeDetailList_, vector<Models::ListIntervalSkillGroupReportResponseBodyDataOverallBreakCodeDetailList>) };
    inline vector<Models::ListIntervalSkillGroupReportResponseBodyDataOverallBreakCodeDetailList> breakCodeDetailList() { DARABONBA_PTR_GET(breakCodeDetailList_, vector<Models::ListIntervalSkillGroupReportResponseBodyDataOverallBreakCodeDetailList>) };
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setBreakCodeDetailList(const vector<Models::ListIntervalSkillGroupReportResponseBodyDataOverallBreakCodeDetailList> & breakCodeDetailList) { DARABONBA_PTR_SET_VALUE(breakCodeDetailList_, breakCodeDetailList) };
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setBreakCodeDetailList(vector<Models::ListIntervalSkillGroupReportResponseBodyDataOverallBreakCodeDetailList> && breakCodeDetailList) { DARABONBA_PTR_SET_RVALUE(breakCodeDetailList_, breakCodeDetailList) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setMaxBreakTime(int64_t maxBreakTime) { DARABONBA_PTR_SET_VALUE(maxBreakTime_, maxBreakTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setMaxHoldTime(int64_t maxHoldTime) { DARABONBA_PTR_SET_VALUE(maxHoldTime_, maxHoldTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setMaxReadyTime(int64_t maxReadyTime) { DARABONBA_PTR_SET_VALUE(maxReadyTime_, maxReadyTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setMaxWorkTime(int64_t maxWorkTime) { DARABONBA_PTR_SET_VALUE(maxWorkTime_, maxWorkTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setOccupancyRate(float occupancyRate) { DARABONBA_PTR_SET_VALUE(occupancyRate_, occupancyRate) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setSatisfactionIndex(float satisfactionIndex) { DARABONBA_PTR_SET_VALUE(satisfactionIndex_, satisfactionIndex) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setSatisfactionRate(float satisfactionRate) { DARABONBA_PTR_SET_VALUE(satisfactionRate_, satisfactionRate) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setSatisfactionSurveysOffered(int64_t satisfactionSurveysOffered) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysOffered_, satisfactionSurveysOffered) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setSatisfactionSurveysResponded(int64_t satisfactionSurveysResponded) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysResponded_, satisfactionSurveysResponded) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setTotalBreakTime(int64_t totalBreakTime) { DARABONBA_PTR_SET_VALUE(totalBreakTime_, totalBreakTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setTotalCalls(int64_t totalCalls) { DARABONBA_PTR_SET_VALUE(totalCalls_, totalCalls) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setTotalHoldTime(int64_t totalHoldTime) { DARABONBA_PTR_SET_VALUE(totalHoldTime_, totalHoldTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setTotalLoggedInTime(int64_t totalLoggedInTime) { DARABONBA_PTR_SET_VALUE(totalLoggedInTime_, totalLoggedInTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setTotalReadyTime(int64_t totalReadyTime) { DARABONBA_PTR_SET_VALUE(totalReadyTime_, totalReadyTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
    ...
    inline ListIntervalSkillGroupReportResponseBodyDataOverall& setTotalWorkTime(int64_t totalWorkTime) { DARABONBA_PTR_SET_VALUE(totalWorkTime_, totalWorkTime) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::ListIntervalSkillGroupReportResponseBodyDataOverallBreakCodeDetailList>> breakCodeDetailList_ = nullptr;
