...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RestoreArchivedRecordingsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<RestoreArchivedRecordingsResponseBodyData>) };
    inline vector<RestoreArchivedRecordingsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<RestoreArchivedRecordingsResponseBodyData>) };
    inline RestoreArchivedRecordingsResponseBody& setData(const vector<RestoreArchivedRecordingsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RestoreArchivedRecordingsResponseBody& setData(vector<RestoreArchivedRecordingsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<RestoreArchivedRecordingsResponseBodyData>> data_ = nullptr;
