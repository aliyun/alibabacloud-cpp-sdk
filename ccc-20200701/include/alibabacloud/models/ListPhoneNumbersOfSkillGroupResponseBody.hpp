...
namespace Models
{
  ...
  public:
    ...
    inline const ListPhoneNumbersOfSkillGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListPhoneNumbersOfSkillGroupResponseBodyData) };
    inline ListPhoneNumbersOfSkillGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, ListPhoneNumbersOfSkillGroupResponseBodyData) };
    inline ListPhoneNumbersOfSkillGroupResponseBody& setData(const ListPhoneNumbersOfSkillGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPhoneNumbersOfSkillGroupResponseBody& setData(ListPhoneNumbersOfSkillGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListPhoneNumbersOfSkillGroupResponseBodyData> data_ = nullptr;
