...
#ifndef ALIBABACLOUD_MODELS_LAUNCHAUTHENTICATIONRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
#define ALIBABACLOUD_MODELS_LAUNCHAUTHENTICATIONRESPONSEBODYDATACALLCONTEXTCHANNELCONTEXTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const LaunchAuthenticationResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, LaunchAuthenticationResponseBodyDataCallContextChannelContexts& obj) { 
    ...
    LaunchAuthenticationResponseBodyDataCallContextChannelContexts() = default ;
    LaunchAuthenticationResponseBodyDataCallContextChannelContexts(const LaunchAuthenticationResponseBodyDataCallContextChannelContexts &) = default ;
    LaunchAuthenticationResponseBodyDataCallContextChannelContexts(LaunchAuthenticationResponseBodyDataCallContextChannelContexts &&) = default ;
    LaunchAuthenticationResponseBodyDataCallContextChannelContexts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~LaunchAuthenticationResponseBodyDataCallContextChannelContexts() = default ;
    LaunchAuthenticationResponseBodyDataCallContextChannelContexts& operator=(const LaunchAuthenticationResponseBodyDataCallContextChannelContexts &) = default ;
    LaunchAuthenticationResponseBodyDataCallContextChannelContexts& operator=(LaunchAuthenticationResponseBodyDataCallContextChannelContexts &&) = default ;
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setCallType(string callType) { DARABONBA_PTR_SET_VALUE(callType_, callType) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setChannelFlags(string channelFlags) { DARABONBA_PTR_SET_VALUE(channelFlags_, channelFlags) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setChannelState(string channelState) { DARABONBA_PTR_SET_VALUE(channelState_, channelState) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setDestination(string destination) { DARABONBA_PTR_SET_VALUE(destination_, destination) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setIndex(int32_t index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setOriginator(string originator) { DARABONBA_PTR_SET_VALUE(originator_, originator) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setReleaseInitiator(string releaseInitiator) { DARABONBA_PTR_SET_VALUE(releaseInitiator_, releaseInitiator) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setReleaseReason(string releaseReason) { DARABONBA_PTR_SET_VALUE(releaseReason_, releaseReason) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setSkillGroupId(string skillGroupId) { DARABONBA_PTR_SET_VALUE(skillGroupId_, skillGroupId) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setUserExtension(string userExtension) { DARABONBA_PTR_SET_VALUE(userExtension_, userExtension) };
    ...
    inline LaunchAuthenticationResponseBodyDataCallContextChannelContexts& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
