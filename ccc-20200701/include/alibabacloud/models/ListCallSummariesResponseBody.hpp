...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListCallSummariesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListCallSummariesResponseBodyData>) };
    inline vector<ListCallSummariesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListCallSummariesResponseBodyData>) };
    inline ListCallSummariesResponseBody& setData(const vector<ListCallSummariesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCallSummariesResponseBody& setData(vector<ListCallSummariesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListCallSummariesResponseBodyData>> data_ = nullptr;
