...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveUsersFromSkillGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveUsersFromSkillGroupResponseBody) };
    inline RemoveUsersFromSkillGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveUsersFromSkillGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveUsersFromSkillGroupResponseBody> body_ {};
  };
