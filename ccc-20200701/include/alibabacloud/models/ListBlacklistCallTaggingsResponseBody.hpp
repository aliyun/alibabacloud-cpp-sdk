...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListBlacklistCallTaggingsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListBlacklistCallTaggingsResponseBodyData>) };
    inline vector<ListBlacklistCallTaggingsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListBlacklistCallTaggingsResponseBodyData>) };
    inline ListBlacklistCallTaggingsResponseBody& setData(const vector<ListBlacklistCallTaggingsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListBlacklistCallTaggingsResponseBody& setData(vector<ListBlacklistCallTaggingsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListBlacklistCallTaggingsResponseBodyData>> data_ = nullptr;
