...
#ifndef ALIBABACLOUD_MODELS_LISTINTERVALAGENTREPORTRESPONSEBODYDATABACK2BACK_HPP_
#define ALIBABACLOUD_MODELS_LISTINTERVALAGENTREPORTRESPONSEBODYDATABACK2BACK_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListIntervalAgentReportResponseBodyDataBack2Back& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListIntervalAgentReportResponseBodyDataBack2Back& obj) { 
    ...
    ListIntervalAgentReportResponseBodyDataBack2Back() = default ;
    ListIntervalAgentReportResponseBodyDataBack2Back(const ListIntervalAgentReportResponseBodyDataBack2Back &) = default ;
    ListIntervalAgentReportResponseBodyDataBack2Back(ListIntervalAgentReportResponseBodyDataBack2Back &&) = default ;
    ListIntervalAgentReportResponseBodyDataBack2Back(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIntervalAgentReportResponseBodyDataBack2Back() = default ;
    ListIntervalAgentReportResponseBodyDataBack2Back& operator=(const ListIntervalAgentReportResponseBodyDataBack2Back &) = default ;
    ListIntervalAgentReportResponseBodyDataBack2Back& operator=(ListIntervalAgentReportResponseBodyDataBack2Back &&) = default ;
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setAgentHandleRate(float agentHandleRate) { DARABONBA_PTR_SET_VALUE(agentHandleRate_, agentHandleRate) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setAnswerRate(float answerRate) { DARABONBA_PTR_SET_VALUE(answerRate_, answerRate) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setAverageCustomerRingTime(float averageCustomerRingTime) { DARABONBA_PTR_SET_VALUE(averageCustomerRingTime_, averageCustomerRingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setAverageRingTime(float averageRingTime) { DARABONBA_PTR_SET_VALUE(averageRingTime_, averageRingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setCallsAgentHandled(int64_t callsAgentHandled) { DARABONBA_PTR_SET_VALUE(callsAgentHandled_, callsAgentHandled) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setCallsAnswered(int64_t callsAnswered) { DARABONBA_PTR_SET_VALUE(callsAnswered_, callsAnswered) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setCallsCustomerAnswered(int64_t callsCustomerAnswered) { DARABONBA_PTR_SET_VALUE(callsCustomerAnswered_, callsCustomerAnswered) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setCallsDialed(int64_t callsDialed) { DARABONBA_PTR_SET_VALUE(callsDialed_, callsDialed) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setCustomerAnswerRate(float customerAnswerRate) { DARABONBA_PTR_SET_VALUE(customerAnswerRate_, customerAnswerRate) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setMaxCustomerRingTime(int64_t maxCustomerRingTime) { DARABONBA_PTR_SET_VALUE(maxCustomerRingTime_, maxCustomerRingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setMaxRingTime(int64_t maxRingTime) { DARABONBA_PTR_SET_VALUE(maxRingTime_, maxRingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setTotalCustomerRingTime(int64_t totalCustomerRingTime) { DARABONBA_PTR_SET_VALUE(totalCustomerRingTime_, totalCustomerRingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setTotalRingTime(int64_t totalRingTime) { DARABONBA_PTR_SET_VALUE(totalRingTime_, totalRingTime) };
    ...
    inline ListIntervalAgentReportResponseBodyDataBack2Back& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
