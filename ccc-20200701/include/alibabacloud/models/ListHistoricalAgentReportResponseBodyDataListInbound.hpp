...
#ifndef ALIBABACLOUD_MODELS_LISTHISTORICALAGENTREPORTRESPONSEBODYDATALISTINBOUND_HPP_
#define ALIBABACLOUD_MODELS_LISTHISTORICALAGENTREPORTRESPONSEBODYDATALISTINBOUND_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListHistoricalAgentReportResponseBodyDataListInbound& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListHistoricalAgentReportResponseBodyDataListInbound& obj) { 
    ...
    ListHistoricalAgentReportResponseBodyDataListInbound() = default ;
    ListHistoricalAgentReportResponseBodyDataListInbound(const ListHistoricalAgentReportResponseBodyDataListInbound &) = default ;
    ListHistoricalAgentReportResponseBodyDataListInbound(ListHistoricalAgentReportResponseBodyDataListInbound &&) = default ;
    ListHistoricalAgentReportResponseBodyDataListInbound(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHistoricalAgentReportResponseBodyDataListInbound() = default ;
    ListHistoricalAgentReportResponseBodyDataListInbound& operator=(const ListHistoricalAgentReportResponseBodyDataListInbound &) = default ;
    ListHistoricalAgentReportResponseBodyDataListInbound& operator=(ListHistoricalAgentReportResponseBodyDataListInbound &&) = default ;
    ...
    inline const vector<Models::ListHistoricalAgentReportResponseBodyDataListInboundAccessChannelTypeDetails> & accessChannelTypeDetails() const { DARABONBA_PTR_GET_CONST(accessChannelTypeDetails_, vector<Models::ListHistoricalAgentReportResponseBodyDataListInboundAccessChannelTypeDetails>) };
    inline vector<Models::ListHistoricalAgentReportResponseBodyDataListInboundAccessChannelTypeDetails> accessChannelTypeDetails() { DARABONBA_PTR_GET(accessChannelTypeDetails_, vector<Models::ListHistoricalAgentReportResponseBodyDataListInboundAccessChannelTypeDetails>) };
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setAccessChannelTypeDetails(const vector<Models::ListHistoricalAgentReportResponseBodyDataListInboundAccessChannelTypeDetails> & accessChannelTypeDetails) { DARABONBA_PTR_SET_VALUE(accessChannelTypeDetails_, accessChannelTypeDetails) };
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setAccessChannelTypeDetails(vector<Models::ListHistoricalAgentReportResponseBodyDataListInboundAccessChannelTypeDetails> && accessChannelTypeDetails) { DARABONBA_PTR_SET_RVALUE(accessChannelTypeDetails_, accessChannelTypeDetails) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setAverageFirstResponseTime(float averageFirstResponseTime) { DARABONBA_PTR_SET_VALUE(averageFirstResponseTime_, averageFirstResponseTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setAverageHoldTime(float averageHoldTime) { DARABONBA_PTR_SET_VALUE(averageHoldTime_, averageHoldTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setAverageResponseTime(float averageResponseTime) { DARABONBA_PTR_SET_VALUE(averageResponseTime_, averageResponseTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setAverageRingTime(float averageRingTime) { DARABONBA_PTR_SET_VALUE(averageRingTime_, averageRingTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setAverageWorkTime(float averageWorkTime) { DARABONBA_PTR_SET_VALUE(averageWorkTime_, averageWorkTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setCallsAttendedTransferIn(int64_t callsAttendedTransferIn) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferIn_, callsAttendedTransferIn) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setCallsAttendedTransferOut(int64_t callsAttendedTransferOut) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferOut_, callsAttendedTransferOut) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setCallsBlindTransferIn(int64_t callsBlindTransferIn) { DARABONBA_PTR_SET_VALUE(callsBlindTransferIn_, callsBlindTransferIn) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setCallsBlindTransferOut(int64_t callsBlindTransferOut) { DARABONBA_PTR_SET_VALUE(callsBlindTransferOut_, callsBlindTransferOut) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setCallsHandled(int64_t callsHandled) { DARABONBA_PTR_SET_VALUE(callsHandled_, callsHandled) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setCallsHold(int64_t callsHold) { DARABONBA_PTR_SET_VALUE(callsHold_, callsHold) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setCallsOffered(int64_t callsOffered) { DARABONBA_PTR_SET_VALUE(callsOffered_, callsOffered) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setCallsRinged(int64_t callsRinged) { DARABONBA_PTR_SET_VALUE(callsRinged_, callsRinged) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setHandleRate(float handleRate) { DARABONBA_PTR_SET_VALUE(handleRate_, handleRate) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setMaxHoldTime(int64_t maxHoldTime) { DARABONBA_PTR_SET_VALUE(maxHoldTime_, maxHoldTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setMaxRingTime(int64_t maxRingTime) { DARABONBA_PTR_SET_VALUE(maxRingTime_, maxRingTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setMaxWorkTime(int64_t maxWorkTime) { DARABONBA_PTR_SET_VALUE(maxWorkTime_, maxWorkTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setSatisfactionIndex(float satisfactionIndex) { DARABONBA_PTR_SET_VALUE(satisfactionIndex_, satisfactionIndex) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setSatisfactionRate(float satisfactionRate) { DARABONBA_PTR_SET_VALUE(satisfactionRate_, satisfactionRate) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setSatisfactionSurveysOffered(int64_t satisfactionSurveysOffered) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysOffered_, satisfactionSurveysOffered) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setSatisfactionSurveysResponded(int64_t satisfactionSurveysResponded) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysResponded_, satisfactionSurveysResponded) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setServiceLevel15(float serviceLevel15) { DARABONBA_PTR_SET_VALUE(serviceLevel15_, serviceLevel15) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setTotalHoldTime(int64_t totalHoldTime) { DARABONBA_PTR_SET_VALUE(totalHoldTime_, totalHoldTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setTotalMessagesSent(int64_t totalMessagesSent) { DARABONBA_PTR_SET_VALUE(totalMessagesSent_, totalMessagesSent) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setTotalMessagesSentByAgent(int64_t totalMessagesSentByAgent) { DARABONBA_PTR_SET_VALUE(totalMessagesSentByAgent_, totalMessagesSentByAgent) };
    ...
    inline string totalMessagesSentByCustomer() const { DARABONBA_PTR_GET_DEFAULT(totalMessagesSentByCustomer_, "") };
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setTotalMessagesSentByCustomer(string totalMessagesSentByCustomer) { DARABONBA_PTR_SET_VALUE(totalMessagesSentByCustomer_, totalMessagesSentByCustomer) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setTotalRingTime(int64_t totalRingTime) { DARABONBA_PTR_SET_VALUE(totalRingTime_, totalRingTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
    ...
    inline ListHistoricalAgentReportResponseBodyDataListInbound& setTotalWorkTime(int64_t totalWorkTime) { DARABONBA_PTR_SET_VALUE(totalWorkTime_, totalWorkTime) };


  protected:
    std::shared_ptr<vector<Models::ListHistoricalAgentReportResponseBodyDataListInboundAccessChannelTypeDetails>> accessChannelTypeDetails_ = nullptr;
    ...
    std::shared_ptr<string> totalMessagesSentByCustomer_ = nullptr;
