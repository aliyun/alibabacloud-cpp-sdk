...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Data& setAbandonRate(float abandonRate) { DARABONBA_PTR_SET_VALUE(abandonRate_, abandonRate) };
      ...
      inline Data& setAnswerRate(float answerRate) { DARABONBA_PTR_SET_VALUE(answerRate_, answerRate) };
