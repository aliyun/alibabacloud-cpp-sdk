...
namespace Models
{
  ...
  public:
    ...
    inline const GetHistoricalCampaignReportResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHistoricalCampaignReportResponseBodyData) };
    inline GetHistoricalCampaignReportResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHistoricalCampaignReportResponseBodyData) };
    inline GetHistoricalCampaignReportResponseBody& setData(const GetHistoricalCampaignReportResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHistoricalCampaignReportResponseBody& setData(GetHistoricalCampaignReportResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHistoricalCampaignReportResponseBodyData> data_ = nullptr;
