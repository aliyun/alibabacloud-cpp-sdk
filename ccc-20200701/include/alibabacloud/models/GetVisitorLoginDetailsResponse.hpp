...
namespace Models
{
  ...
  public:
    ...
    inline const GetVisitorLoginDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVisitorLoginDetailsResponseBody) };
    inline GetVisitorLoginDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVisitorLoginDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVisitorLoginDetailsResponseBody> body_ {};
  };
