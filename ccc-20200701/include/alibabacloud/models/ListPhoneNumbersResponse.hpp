...
namespace Models
{
  ...
  public:
    ...
    inline const ListPhoneNumbersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPhoneNumbersResponseBody) };
    inline ListPhoneNumbersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPhoneNumbersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPhoneNumbersResponseBody> body_ {};
  };
