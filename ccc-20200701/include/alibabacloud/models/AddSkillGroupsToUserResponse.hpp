...
namespace Models
{
  ...
  public:
    ...
    inline const AddSkillGroupsToUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddSkillGroupsToUserResponseBody) };
    inline AddSkillGroupsToUserResponseBody getBody() { DARABONBA_PTR_GET(body_, AddSkillGroupsToUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddSkillGroupsToUserResponseBody> body_ {};
  };
