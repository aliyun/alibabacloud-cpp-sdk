...
#ifndef ALIBABACLOUD_MODELS_SENDDTMFSIGNALINGRESPONSEBODYDATAUSERCONTEXT_HPP_
#define ALIBABACLOUD_MODELS_SENDDTMFSIGNALINGRESPONSEBODYDATAUSERCONTEXT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SendDtmfSignalingResponseBodyDataUserContext& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SendDtmfSignalingResponseBodyDataUserContext& obj) { 
    ...
    SendDtmfSignalingResponseBodyDataUserContext() = default ;
    SendDtmfSignalingResponseBodyDataUserContext(const SendDtmfSignalingResponseBodyDataUserContext &) = default ;
    SendDtmfSignalingResponseBodyDataUserContext(SendDtmfSignalingResponseBodyDataUserContext &&) = default ;
    SendDtmfSignalingResponseBodyDataUserContext(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SendDtmfSignalingResponseBodyDataUserContext() = default ;
    SendDtmfSignalingResponseBodyDataUserContext& operator=(const SendDtmfSignalingResponseBodyDataUserContext &) = default ;
    SendDtmfSignalingResponseBodyDataUserContext& operator=(SendDtmfSignalingResponseBodyDataUserContext &&) = default ;
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setHeartbeat(int64_t heartbeat) { DARABONBA_PTR_SET_VALUE(heartbeat_, heartbeat) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline SendDtmfSignalingResponseBodyDataUserContext& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline SendDtmfSignalingResponseBodyDataUserContext& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
