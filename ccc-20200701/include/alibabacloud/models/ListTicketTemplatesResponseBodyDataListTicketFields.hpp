...
#ifndef ALIBABACLOUD_MODELS_LISTTICKETTEMPLATESRESPONSEBODYDATALISTTICKETFIELDS_HPP_
#define ALIBABACLOUD_MODELS_LISTTICKETTEMPLATESRESPONSEBODYDATALISTTICKETFIELDS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListTicketTemplatesResponseBodyDataListTicketFields& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListTicketTemplatesResponseBodyDataListTicketFields& obj) { 
    ...
    ListTicketTemplatesResponseBodyDataListTicketFields() = default ;
    ListTicketTemplatesResponseBodyDataListTicketFields(const ListTicketTemplatesResponseBodyDataListTicketFields &) = default ;
    ListTicketTemplatesResponseBodyDataListTicketFields(ListTicketTemplatesResponseBodyDataListTicketFields &&) = default ;
    ListTicketTemplatesResponseBodyDataListTicketFields(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListTicketTemplatesResponseBodyDataListTicketFields() = default ;
    ListTicketTemplatesResponseBodyDataListTicketFields& operator=(const ListTicketTemplatesResponseBodyDataListTicketFields &) = default ;
    ListTicketTemplatesResponseBodyDataListTicketFields& operator=(ListTicketTemplatesResponseBodyDataListTicketFields &&) = default ;
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setArray(bool array) { DARABONBA_PTR_SET_VALUE(array_, array) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setAttribute(string attribute) { DARABONBA_PTR_SET_VALUE(attribute_, attribute) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setCreatedTime(int64_t createdTime) { DARABONBA_PTR_SET_VALUE(createdTime_, createdTime) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setDataType(string dataType) { DARABONBA_PTR_SET_VALUE(dataType_, dataType) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setDisabled(bool disabled) { DARABONBA_PTR_SET_VALUE(disabled_, disabled) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setDisplayOrder(int32_t displayOrder) { DARABONBA_PTR_SET_VALUE(displayOrder_, displayOrder) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setEditorType(string editorType) { DARABONBA_PTR_SET_VALUE(editorType_, editorType) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setMaxLength(int32_t maxLength) { DARABONBA_PTR_SET_VALUE(maxLength_, maxLength) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setMaximum(double maximum) { DARABONBA_PTR_SET_VALUE(maximum_, maximum) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setMinLength(int32_t minLength) { DARABONBA_PTR_SET_VALUE(minLength_, minLength) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setMinimum(double minimum) { DARABONBA_PTR_SET_VALUE(minimum_, minimum) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setPattern(string pattern) { DARABONBA_PTR_SET_VALUE(pattern_, pattern) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setPatternErrorMessage(string patternErrorMessage) { DARABONBA_PTR_SET_VALUE(patternErrorMessage_, patternErrorMessage) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setReadOnly(bool readOnly) { DARABONBA_PTR_SET_VALUE(readOnly_, readOnly) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setRequired(bool required) { DARABONBA_PTR_SET_VALUE(required_, required) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setSystem(bool system) { DARABONBA_PTR_SET_VALUE(system_, system) };
    ...
    inline ListTicketTemplatesResponseBodyDataListTicketFields& setUpdatedTime(int64_t updatedTime) { DARABONBA_PTR_SET_VALUE(updatedTime_, updatedTime) };
