...
namespace Models
{
  ...
  public:
    ...
    inline string getCallTypeList() const { DARABONBA_PTR_GET_DEFAULT(callTypeList_, "") };
    ...
    inline string getWorkModeList() const { DARABONBA_PTR_GET_DEFAULT(workModeList_, "") };
