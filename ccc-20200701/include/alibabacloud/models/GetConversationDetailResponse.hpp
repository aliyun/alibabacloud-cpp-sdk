...
namespace Models
{
  ...
  public:
    ...
    inline const GetConversationDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetConversationDetailResponseBody) };
    inline GetConversationDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetConversationDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetConversationDetailResponseBody> body_ {};
  };
