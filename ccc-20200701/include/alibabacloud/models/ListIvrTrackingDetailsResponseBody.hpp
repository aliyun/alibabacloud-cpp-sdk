...
namespace Models
{
  ...
  public:
    ...
    inline const ListIvrTrackingDetailsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListIvrTrackingDetailsResponseBodyData) };
    inline ListIvrTrackingDetailsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListIvrTrackingDetailsResponseBodyData) };
    inline ListIvrTrackingDetailsResponseBody& setData(const ListIvrTrackingDetailsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIvrTrackingDetailsResponseBody& setData(ListIvrTrackingDetailsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListIvrTrackingDetailsResponseBodyData> data_ = nullptr;
