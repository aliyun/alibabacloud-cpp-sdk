...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListTicketTasksResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListTicketTasksResponseBodyData>) };
    inline vector<ListTicketTasksResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListTicketTasksResponseBodyData>) };
    inline ListTicketTasksResponseBody& setData(const vector<ListTicketTasksResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTicketTasksResponseBody& setData(vector<ListTicketTasksResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListTicketTasksResponseBodyData>> data_ = nullptr;
