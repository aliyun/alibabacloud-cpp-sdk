...
namespace Models
{
  ...
  public:
    ...
    inline const ListDoNotCallNumbersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDoNotCallNumbersResponseBody) };
    inline ListDoNotCallNumbersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDoNotCallNumbersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDoNotCallNumbersResponseBody> body_ {};
  };
