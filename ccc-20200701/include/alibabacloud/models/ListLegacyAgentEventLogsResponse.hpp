...
namespace Models
{
  ...
  public:
    ...
    inline const ListLegacyAgentEventLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLegacyAgentEventLogsResponseBody) };
    inline ListLegacyAgentEventLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLegacyAgentEventLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLegacyAgentEventLogsResponseBody> body_ {};
  };
