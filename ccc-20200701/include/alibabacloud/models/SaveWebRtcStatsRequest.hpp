...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callId_ == nullptr
        && return this->generalInfo_ == nullptr && return this->googAddress_ == nullptr && return this->instanceId_ == nullptr && return this->receiverReport_ == nullptr && return this->senderReport_ == nullptr; };
