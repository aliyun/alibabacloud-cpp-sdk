...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSchemaPropertyRequest::Property & getProperty() const { DARABONBA_PTR_GET_CONST(property_, UpdateSchemaPropertyRequest::Property) };
    inline UpdateSchemaPropertyRequest::Property getProperty() { DARABONBA_PTR_GET(property_, UpdateSchemaPropertyRequest::Property) };
    inline UpdateSchemaPropertyRequest& setProperty(const UpdateSchemaPropertyRequest::Property & property) { DARABONBA_PTR_SET_VALUE(property_, property) };
    inline UpdateSchemaPropertyRequest& setProperty(UpdateSchemaPropertyRequest::Property && property) { DARABONBA_PTR_SET_RVALUE(property_, property) };
