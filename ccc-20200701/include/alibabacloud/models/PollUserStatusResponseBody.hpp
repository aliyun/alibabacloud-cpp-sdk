...
namespace Models
{
  ...
  public:
    ...
    inline const PollUserStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, PollUserStatusResponseBodyData) };
    inline PollUserStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, PollUserStatusResponseBodyData) };
    inline PollUserStatusResponseBody& setData(const PollUserStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PollUserStatusResponseBody& setData(PollUserStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<PollUserStatusResponseBodyData> data_ = nullptr;
