...
namespace Models
{
  ...
  public:
    ...
    inline const ListLegacyAgentStatusLogsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListLegacyAgentStatusLogsResponseBodyData) };
    inline ListLegacyAgentStatusLogsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListLegacyAgentStatusLogsResponseBodyData) };
    inline ListLegacyAgentStatusLogsResponseBody& setData(const ListLegacyAgentStatusLogsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListLegacyAgentStatusLogsResponseBody& setData(ListLegacyAgentStatusLogsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListLegacyAgentStatusLogsResponseBodyData> data_ = nullptr;
