...
namespace Models
{
  ...
  public:
    ...
    inline const ListTicketTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTicketTasksResponseBody) };
    inline ListTicketTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTicketTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTicketTasksResponseBody> body_ {};
  };
