...
namespace Models
{
  ...
  public:
    ...
    inline const AddFeedbackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddFeedbackResponseBody) };
    inline AddFeedbackResponseBody getBody() { DARABONBA_PTR_GET(body_, AddFeedbackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddFeedbackResponseBody> body_ {};
  };
