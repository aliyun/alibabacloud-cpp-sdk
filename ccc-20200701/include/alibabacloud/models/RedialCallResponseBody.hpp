...
namespace Models
{
  ...
  public:
    ...
    inline const RedialCallResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, RedialCallResponseBody::Data) };
    inline RedialCallResponseBody::Data getData() { DARABONBA_PTR_GET(data_, RedialCallResponseBody::Data) };
    inline RedialCallResponseBody& setData(const RedialCallResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RedialCallResponseBody& setData(RedialCallResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
