...
namespace Models
{
  ...
  public:
    ...
    inline const EnableTicketTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableTicketTemplateResponseBody) };
    inline EnableTicketTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableTicketTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableTicketTemplateResponseBody> body_ {};
  };
