...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceTrendingReportResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetInstanceTrendingReportResponseBodyData) };
    inline GetInstanceTrendingReportResponseBodyData data() { DARABONBA_PTR_GET(data_, GetInstanceTrendingReportResponseBodyData) };
    inline GetInstanceTrendingReportResponseBody& setData(const GetInstanceTrendingReportResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInstanceTrendingReportResponseBody& setData(GetInstanceTrendingReportResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetInstanceTrendingReportResponseBodyData> data_ = nullptr;
