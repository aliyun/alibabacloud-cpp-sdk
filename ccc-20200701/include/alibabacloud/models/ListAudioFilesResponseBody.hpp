...
namespace Models
{
  ...
  public:
    ...
    inline const ListAudioFilesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAudioFilesResponseBodyData) };
    inline ListAudioFilesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAudioFilesResponseBodyData) };
    inline ListAudioFilesResponseBody& setData(const ListAudioFilesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAudioFilesResponseBody& setData(ListAudioFilesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListAudioFilesResponseBodyData> data_ = nullptr;
