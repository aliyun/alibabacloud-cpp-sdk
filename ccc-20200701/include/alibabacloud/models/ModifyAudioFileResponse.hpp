...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAudioFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAudioFileResponseBody) };
    inline ModifyAudioFileResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAudioFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAudioFileResponseBody> body_ {};
  };
