...
namespace Models
{
  ...
  public:
    ...
    inline const GetRealtimeCampaignStatsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRealtimeCampaignStatsResponseBodyData) };
    inline GetRealtimeCampaignStatsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRealtimeCampaignStatsResponseBodyData) };
    inline GetRealtimeCampaignStatsResponseBody& setData(const GetRealtimeCampaignStatsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRealtimeCampaignStatsResponseBody& setData(GetRealtimeCampaignStatsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetRealtimeCampaignStatsResponseBodyData> data_ = nullptr;
