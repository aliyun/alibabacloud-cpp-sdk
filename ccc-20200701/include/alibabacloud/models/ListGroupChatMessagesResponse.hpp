...
namespace Models
{
  ...
  public:
    ...
    inline const ListGroupChatMessagesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListGroupChatMessagesResponseBody) };
    inline ListGroupChatMessagesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListGroupChatMessagesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListGroupChatMessagesResponseBody> body_ {};
  };
