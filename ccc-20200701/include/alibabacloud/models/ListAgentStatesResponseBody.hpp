...
namespace Models
{
  ...
  public:
    ...
    inline const ListAgentStatesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAgentStatesResponseBodyData) };
    inline ListAgentStatesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAgentStatesResponseBodyData) };
    inline ListAgentStatesResponseBody& setData(const ListAgentStatesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAgentStatesResponseBody& setData(ListAgentStatesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListAgentStatesResponseBodyData> data_ = nullptr;
