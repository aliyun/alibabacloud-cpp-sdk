...
namespace Models
{
  ...
  public:
    ...
    inline const GetSummaryTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSummaryTemplateResponseBody) };
    inline GetSummaryTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSummaryTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSummaryTemplateResponseBody> body_ {};
  };
