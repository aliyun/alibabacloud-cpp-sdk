...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateCustomCallTaggingResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<CreateCustomCallTaggingResponseBodyData>) };
    inline vector<CreateCustomCallTaggingResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<CreateCustomCallTaggingResponseBodyData>) };
    inline CreateCustomCallTaggingResponseBody& setData(const vector<CreateCustomCallTaggingResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateCustomCallTaggingResponseBody& setData(vector<CreateCustomCallTaggingResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CreateCustomCallTaggingResponseBodyData>> data_ = nullptr;
