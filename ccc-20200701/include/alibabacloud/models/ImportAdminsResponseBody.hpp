...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ImportAdminsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ImportAdminsResponseBodyData>) };
    inline vector<ImportAdminsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ImportAdminsResponseBodyData>) };
    inline ImportAdminsResponseBody& setData(const vector<ImportAdminsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ImportAdminsResponseBody& setData(vector<ImportAdminsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ImportAdminsResponseBodyData>> data_ = nullptr;
