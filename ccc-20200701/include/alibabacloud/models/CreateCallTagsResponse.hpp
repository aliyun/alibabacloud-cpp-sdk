...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCallTagsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCallTagsResponseBody) };
    inline CreateCallTagsResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCallTagsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCallTagsResponseBody> body_ {};
  };
