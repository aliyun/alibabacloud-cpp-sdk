...
namespace Models
{
  ...
  public:
    ...
    inline const GetSkillGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSkillGroupResponseBody) };
    inline GetSkillGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSkillGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSkillGroupResponseBody> body_ {};
  };
