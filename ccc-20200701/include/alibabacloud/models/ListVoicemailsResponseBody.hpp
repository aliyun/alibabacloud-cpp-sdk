...
namespace Models
{
  ...
  public:
    ...
    inline const ListVoicemailsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListVoicemailsResponseBodyData) };
    inline ListVoicemailsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListVoicemailsResponseBodyData) };
    inline ListVoicemailsResponseBody& setData(const ListVoicemailsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListVoicemailsResponseBody& setData(ListVoicemailsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListVoicemailsResponseBodyData> data_ = nullptr;
