...
#ifndef ALIBABACLOUD_MODELS_LISTINTERVALAGENTSKILLGROUPREPORTRESPONSEBODYDATAOUTBOUND_HPP_
#define ALIBABACLOUD_MODELS_LISTINTERVALAGENTSKILLGROUPREPORTRESPONSEBODYDATAOUTBOUND_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& obj) { 
    ...
    ListIntervalAgentSkillGroupReportResponseBodyDataOutbound() = default ;
    ListIntervalAgentSkillGroupReportResponseBodyDataOutbound(const ListIntervalAgentSkillGroupReportResponseBodyDataOutbound &) = default ;
    ListIntervalAgentSkillGroupReportResponseBodyDataOutbound(ListIntervalAgentSkillGroupReportResponseBodyDataOutbound &&) = default ;
    ListIntervalAgentSkillGroupReportResponseBodyDataOutbound(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIntervalAgentSkillGroupReportResponseBodyDataOutbound() = default ;
    ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& operator=(const ListIntervalAgentSkillGroupReportResponseBodyDataOutbound &) = default ;
    ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& operator=(ListIntervalAgentSkillGroupReportResponseBodyDataOutbound &&) = default ;
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setAnswerRate(float answerRate) { DARABONBA_PTR_SET_VALUE(answerRate_, answerRate) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setAverageDialingTime(float averageDialingTime) { DARABONBA_PTR_SET_VALUE(averageDialingTime_, averageDialingTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setAverageHoldTime(float averageHoldTime) { DARABONBA_PTR_SET_VALUE(averageHoldTime_, averageHoldTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setAverageRingTime(float averageRingTime) { DARABONBA_PTR_SET_VALUE(averageRingTime_, averageRingTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setAverageWorkTime(float averageWorkTime) { DARABONBA_PTR_SET_VALUE(averageWorkTime_, averageWorkTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setCallsAnswered(int64_t callsAnswered) { DARABONBA_PTR_SET_VALUE(callsAnswered_, callsAnswered) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setCallsAttendedTransferIn(int64_t callsAttendedTransferIn) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferIn_, callsAttendedTransferIn) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setCallsAttendedTransferOut(int64_t callsAttendedTransferOut) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferOut_, callsAttendedTransferOut) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setCallsBlindTransferIn(int64_t callsBlindTransferIn) { DARABONBA_PTR_SET_VALUE(callsBlindTransferIn_, callsBlindTransferIn) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setCallsBlindTransferOut(int64_t callsBlindTransferOut) { DARABONBA_PTR_SET_VALUE(callsBlindTransferOut_, callsBlindTransferOut) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setCallsDialed(int64_t callsDialed) { DARABONBA_PTR_SET_VALUE(callsDialed_, callsDialed) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setCallsHold(int64_t callsHold) { DARABONBA_PTR_SET_VALUE(callsHold_, callsHold) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setCallsRinged(int64_t callsRinged) { DARABONBA_PTR_SET_VALUE(callsRinged_, callsRinged) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setMaxDialingTime(int64_t maxDialingTime) { DARABONBA_PTR_SET_VALUE(maxDialingTime_, maxDialingTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setMaxHoldTime(int64_t maxHoldTime) { DARABONBA_PTR_SET_VALUE(maxHoldTime_, maxHoldTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setMaxRingTime(int64_t maxRingTime) { DARABONBA_PTR_SET_VALUE(maxRingTime_, maxRingTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setMaxWorkTime(int64_t maxWorkTime) { DARABONBA_PTR_SET_VALUE(maxWorkTime_, maxWorkTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setSatisfactionIndex(float satisfactionIndex) { DARABONBA_PTR_SET_VALUE(satisfactionIndex_, satisfactionIndex) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setSatisfactionRate(float satisfactionRate) { DARABONBA_PTR_SET_VALUE(satisfactionRate_, satisfactionRate) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setSatisfactionSurveysOffered(int64_t satisfactionSurveysOffered) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysOffered_, satisfactionSurveysOffered) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setSatisfactionSurveysResponded(int64_t satisfactionSurveysResponded) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysResponded_, satisfactionSurveysResponded) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setTotalDialingTime(int64_t totalDialingTime) { DARABONBA_PTR_SET_VALUE(totalDialingTime_, totalDialingTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setTotalHoldTime(int64_t totalHoldTime) { DARABONBA_PTR_SET_VALUE(totalHoldTime_, totalHoldTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setTotalRingTime(int64_t totalRingTime) { DARABONBA_PTR_SET_VALUE(totalRingTime_, totalRingTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
    ...
    inline ListIntervalAgentSkillGroupReportResponseBodyDataOutbound& setTotalWorkTime(int64_t totalWorkTime) { DARABONBA_PTR_SET_VALUE(totalWorkTime_, totalWorkTime) };
