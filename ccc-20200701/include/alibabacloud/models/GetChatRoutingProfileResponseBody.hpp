...
namespace Models
{
  ...
  public:
    ...
    inline const GetChatRoutingProfileResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetChatRoutingProfileResponseBodyData) };
    inline GetChatRoutingProfileResponseBodyData data() { DARABONBA_PTR_GET(data_, GetChatRoutingProfileResponseBodyData) };
    inline GetChatRoutingProfileResponseBody& setData(const GetChatRoutingProfileResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetChatRoutingProfileResponseBody& setData(GetChatRoutingProfileResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetChatRoutingProfileResponseBodyData> data_ = nullptr;
