...
#ifndef ALIBABACLOUD_MODELS_CANCELATTENDEDTRANSFERRESPONSEBODYDATAUSERCONTEXT_HPP_
#define ALIBABACLOUD_MODELS_CANCELATTENDEDTRANSFERRESPONSEBODYDATAUSERCONTEXT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CancelAttendedTransferResponseBodyDataUserContext& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CancelAttendedTransferResponseBodyDataUserContext& obj) { 
    ...
    CancelAttendedTransferResponseBodyDataUserContext() = default ;
    CancelAttendedTransferResponseBodyDataUserContext(const CancelAttendedTransferResponseBodyDataUserContext &) = default ;
    CancelAttendedTransferResponseBodyDataUserContext(CancelAttendedTransferResponseBodyDataUserContext &&) = default ;
    CancelAttendedTransferResponseBodyDataUserContext(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CancelAttendedTransferResponseBodyDataUserContext() = default ;
    CancelAttendedTransferResponseBodyDataUserContext& operator=(const CancelAttendedTransferResponseBodyDataUserContext &) = default ;
    CancelAttendedTransferResponseBodyDataUserContext& operator=(CancelAttendedTransferResponseBodyDataUserContext &&) = default ;
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setBreakCode(string breakCode) { DARABONBA_PTR_SET_VALUE(breakCode_, breakCode) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setExtension(string extension) { DARABONBA_PTR_SET_VALUE(extension_, extension) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setHeartbeat(int64_t heartbeat) { DARABONBA_PTR_SET_VALUE(heartbeat_, heartbeat) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setOutboundScenario(bool outboundScenario) { DARABONBA_PTR_SET_VALUE(outboundScenario_, outboundScenario) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setSignedSkillGroupIdList(const vector<string> & signedSkillGroupIdList) { DARABONBA_PTR_SET_VALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    inline CancelAttendedTransferResponseBodyDataUserContext& setSignedSkillGroupIdList(vector<string> && signedSkillGroupIdList) { DARABONBA_PTR_SET_RVALUE(signedSkillGroupIdList_, signedSkillGroupIdList) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setUserState(string userState) { DARABONBA_PTR_SET_VALUE(userState_, userState) };
    ...
    inline CancelAttendedTransferResponseBodyDataUserContext& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
