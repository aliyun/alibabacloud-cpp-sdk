...
#ifndef ALIBABACLOUD_MODELS_LISTHISTORICALAGENTSKILLGROUPREPORTRESPONSEBODYDATALISTINBOUND_HPP_
#define ALIBABACLOUD_MODELS_LISTHISTORICALAGENTSKILLGROUPREPORTRESPONSEBODYDATALISTINBOUND_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& obj) { 
    ...
    ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound() = default ;
    ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound(const ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound &) = default ;
    ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound(ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound &&) = default ;
    ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound() = default ;
    ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& operator=(const ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound &) = default ;
    ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& operator=(ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound &&) = default ;
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setAverageFirstResponseTime(float averageFirstResponseTime) { DARABONBA_PTR_SET_VALUE(averageFirstResponseTime_, averageFirstResponseTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setAverageHoldTime(float averageHoldTime) { DARABONBA_PTR_SET_VALUE(averageHoldTime_, averageHoldTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setAverageResponseTime(float averageResponseTime) { DARABONBA_PTR_SET_VALUE(averageResponseTime_, averageResponseTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setAverageRingTime(float averageRingTime) { DARABONBA_PTR_SET_VALUE(averageRingTime_, averageRingTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setAverageTalkTime(float averageTalkTime) { DARABONBA_PTR_SET_VALUE(averageTalkTime_, averageTalkTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setAverageWorkTime(float averageWorkTime) { DARABONBA_PTR_SET_VALUE(averageWorkTime_, averageWorkTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setCallsAttendedTransferIn(int64_t callsAttendedTransferIn) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferIn_, callsAttendedTransferIn) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setCallsAttendedTransferOut(int64_t callsAttendedTransferOut) { DARABONBA_PTR_SET_VALUE(callsAttendedTransferOut_, callsAttendedTransferOut) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setCallsBlindTransferIn(int64_t callsBlindTransferIn) { DARABONBA_PTR_SET_VALUE(callsBlindTransferIn_, callsBlindTransferIn) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setCallsBlindTransferOut(int64_t callsBlindTransferOut) { DARABONBA_PTR_SET_VALUE(callsBlindTransferOut_, callsBlindTransferOut) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setCallsHandled(int64_t callsHandled) { DARABONBA_PTR_SET_VALUE(callsHandled_, callsHandled) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setCallsHold(int64_t callsHold) { DARABONBA_PTR_SET_VALUE(callsHold_, callsHold) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setCallsOffered(int64_t callsOffered) { DARABONBA_PTR_SET_VALUE(callsOffered_, callsOffered) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setCallsRinged(int64_t callsRinged) { DARABONBA_PTR_SET_VALUE(callsRinged_, callsRinged) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setHandleRate(float handleRate) { DARABONBA_PTR_SET_VALUE(handleRate_, handleRate) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setMaxHoldTime(int64_t maxHoldTime) { DARABONBA_PTR_SET_VALUE(maxHoldTime_, maxHoldTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setMaxRingTime(int64_t maxRingTime) { DARABONBA_PTR_SET_VALUE(maxRingTime_, maxRingTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setMaxTalkTime(int64_t maxTalkTime) { DARABONBA_PTR_SET_VALUE(maxTalkTime_, maxTalkTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setMaxWorkTime(int64_t maxWorkTime) { DARABONBA_PTR_SET_VALUE(maxWorkTime_, maxWorkTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setSatisfactionIndex(float satisfactionIndex) { DARABONBA_PTR_SET_VALUE(satisfactionIndex_, satisfactionIndex) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setSatisfactionRate(float satisfactionRate) { DARABONBA_PTR_SET_VALUE(satisfactionRate_, satisfactionRate) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setSatisfactionSurveysOffered(int64_t satisfactionSurveysOffered) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysOffered_, satisfactionSurveysOffered) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setSatisfactionSurveysResponded(int64_t satisfactionSurveysResponded) { DARABONBA_PTR_SET_VALUE(satisfactionSurveysResponded_, satisfactionSurveysResponded) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setTotalHoldTime(int64_t totalHoldTime) { DARABONBA_PTR_SET_VALUE(totalHoldTime_, totalHoldTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setTotalMessagesSent(int64_t totalMessagesSent) { DARABONBA_PTR_SET_VALUE(totalMessagesSent_, totalMessagesSent) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setTotalMessagesSentByAgent(int64_t totalMessagesSentByAgent) { DARABONBA_PTR_SET_VALUE(totalMessagesSentByAgent_, totalMessagesSentByAgent) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setTotalMessagesSentByCustomer(int64_t totalMessagesSentByCustomer) { DARABONBA_PTR_SET_VALUE(totalMessagesSentByCustomer_, totalMessagesSentByCustomer) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setTotalRingTime(int64_t totalRingTime) { DARABONBA_PTR_SET_VALUE(totalRingTime_, totalRingTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setTotalTalkTime(int64_t totalTalkTime) { DARABONBA_PTR_SET_VALUE(totalTalkTime_, totalTalkTime) };
    ...
    inline ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound& setTotalWorkTime(int64_t totalWorkTime) { DARABONBA_PTR_SET_VALUE(totalWorkTime_, totalWorkTime) };
