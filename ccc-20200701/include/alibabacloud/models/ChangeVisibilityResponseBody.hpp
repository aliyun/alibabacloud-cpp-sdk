...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeVisibilityResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ChangeVisibilityResponseBody::Data) };
    inline ChangeVisibilityResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ChangeVisibilityResponseBody::Data) };
    inline ChangeVisibilityResponseBody& setData(const ChangeVisibilityResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ChangeVisibilityResponseBody& setData(ChangeVisibilityResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
