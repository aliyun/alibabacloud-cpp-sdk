...
namespace Models
{
  ...
  public:
    ...
    inline const SignInGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SignInGroupResponseBodyData) };
    inline SignInGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, SignInGroupResponseBodyData) };
    inline SignInGroupResponseBody& setData(const SignInGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SignInGroupResponseBody& setData(SignInGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SignInGroupResponseBodyData> data_ = nullptr;
