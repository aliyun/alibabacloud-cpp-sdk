...
using namespace AlibabaCloud::LHM20250116::Models;
...
AlibabaCloud::LHM20250116::Client::Client(Config &config): OpenApiClient(config){
 ...
 */
AddDataCheckConfigResponse Client::addDataCheckConfigWithOptions(const AddDataCheckConfigRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasIsFullTableCount()) {
    body["isFullTableCount"] = request.getIsFullTableCount();
  }

  if (!!request.hasSourceColumns()) {
    body["sourceColumns"] = request.getSourceColumns();
  }

  if (!!request.hasSourceGroupClause()) {
    body["sourceGroupClause"] = request.getSourceGroupClause();
  }

  if (!!request.hasSourceHint()) {
    body["sourceHint"] = request.getSourceHint();
  }

  if (!!request.hasSourcePartition()) {
    body["sourcePartition"] = request.getSourcePartition();
  }

  if (!!request.hasSourceTable()) {
    body["sourceTable"] = request.getSourceTable();
  }

  if (!!request.hasSourceWhereClause()) {
    body["sourceWhereClause"] = request.getSourceWhereClause();
  }

  if (!!request.hasTargetColumns()) {
    body["targetColumns"] = request.getTargetColumns();
  }

  if (!!request.hasTargetGroupClause()) {
    body["targetGroupClause"] = request.getTargetGroupClause();
  }

  if (!!request.hasTargetHint()) {
    body["targetHint"] = request.getTargetHint();
  }

  if (!!request.hasTargetPartition()) {
    body["targetPartition"] = request.getTargetPartition();
  }

  if (!!request.hasTargetTable()) {
    body["targetTable"] = request.getTargetTable();
  }

  if (!!request.hasTargetWhereClause()) {
    body["targetWhereClause"] = request.getTargetWhereClause();
  }

  if (!!request.hasTaskConfigInfo()) {
    body["taskConfigInfo"] = request.getTaskConfigInfo();
  }
  ...
  if (!!request.hasTotalCountThreshold()) {
    body["totalCountThreshold"] = request.getTotalCountThreshold();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/config/v3/saveConfig")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<AddDataCheckConfigResponse>();
}
 ...
 * @return AddDataCheckConfigResponse
 */
AddDataCheckConfigResponse Client::addDataCheckConfig(const AddDataCheckConfigRequest &request) {
 ...
 */
AddDataCheckTaskResponse Client::addDataCheckTaskWithOptions(const AddDataCheckTaskRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCheckTemplateId()) {
    body["checkTemplateId"] = request.getCheckTemplateId();
  }

  if (!!request.hasCheckType()) {
    body["checkType"] = request.getCheckType();
  }

  if (!!request.hasDstDsId()) {
    body["dstDsId"] = request.getDstDsId();
  }

  if (!!request.hasDstDsName()) {
    body["dstDsName"] = request.getDstDsName();
  }

  if (!!request.hasDstDsType()) {
    body["dstDsType"] = request.getDstDsType();
  }

  if (!!request.hasSrcDsId()) {
    body["srcDsId"] = request.getSrcDsId();
  }

  if (!!request.hasSrcDsName()) {
    body["srcDsName"] = request.getSrcDsName();
  }

  if (!!request.hasSrcDsType()) {
    body["srcDsType"] = request.getSrcDsType();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/add")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<AddDataCheckTaskResponse>();
}
 ...
 * @return AddDataCheckTaskResponse
 */
AddDataCheckTaskResponse Client::addDataCheckTask(const AddDataCheckTaskRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
AddDataCheckTemplateResponse Client::addDataCheckTemplateWithOptions(const AddDataCheckTemplateRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasBasicMetricRules()) {
    body["basicMetricRules"] = request.getBasicMetricRules();
  }
  ...
  if (!!request.hasComplexMetricRules()) {
    body["complexMetricRules"] = request.getComplexMetricRules();
  }

  if (!!request.hasDsEngineRels()) {
    body["dsEngineRels"] = request.getDsEngineRels();
  }

  if (!!request.hasFulltextRule()) {
    body["fulltextRule"] = request.getFulltextRule();
  }

  if (!!request.hasMetricRules()) {
    body["metricRules"] = request.getMetricRules();
  }

  if (!!request.hasNullRules()) {
    body["nullRules"] = request.getNullRules();
  }
  ...
  if (!!request.hasWeakContentRule()) {
    body["weakContentRule"] = request.getWeakContentRule();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/template/v3/create")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<AddDataCheckTemplateResponse>();
}
 ...
 * @return AddDataCheckTemplateResponse
 */
AddDataCheckTemplateResponse Client::addDataCheckTemplate(const AddDataCheckTemplateRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
AddMetaDataComponentResponse Client::addMetaDataComponentWithOptions(const AddMetaDataComponentRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  ...
  if (!!request.hasDsConfig()) {
    body["dsConfig"] = request.getDsConfig();
  }

  if (!!request.hasDsDesc()) {
    body["dsDesc"] = request.getDsDesc();
  }

  if (!!request.hasDsId()) {
    body["dsId"] = request.getDsId();
  }

  if (!!request.hasDsName()) {
    body["dsName"] = request.getDsName();
  }

  if (!!request.hasDsStatus()) {
    body["dsStatus"] = request.getDsStatus();
  }

  if (!!request.hasDsType()) {
    body["dsType"] = request.getDsType();
  }

  if (!!request.hasDsVersion()) {
    body["dsVersion"] = request.getDsVersion();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/v2/meta/data-component")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<AddMetaDataComponentResponse>();
}
 ...
 * @return AddMetaDataComponentResponse
 */
AddMetaDataComponentResponse Client::addMetaDataComponent(const AddMetaDataComponentRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
CreateExecuteSqlConversionResponse Client::createExecuteSqlConversionWithOptions(const CreateExecuteSqlConversionRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/jobMigrate/sqlTranslator/task/api/createExecute")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<CreateExecuteSqlConversionResponse>();
}
 ...
 * @return CreateExecuteSqlConversionResponse
 */
CreateExecuteSqlConversionResponse Client::createExecuteSqlConversion(const CreateExecuteSqlConversionRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
CreateSqlExecJobResponse Client::createSqlExecJobWithOptions(const CreateSqlExecJobRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/sql-translator/execute")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<CreateSqlExecJobResponse>();
}
 ...
 * @return CreateSqlExecJobResponse
 */
CreateSqlExecJobResponse Client::createSqlExecJob(const CreateSqlExecJobRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
DeleteDataCheckConfigResponse Client::deleteDataCheckConfigWithOptions(const DeleteDataCheckConfigRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasId()) {
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/config/v3/deleteConfig")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<DeleteDataCheckConfigResponse>();
}
 ...
 * @return DeleteDataCheckConfigResponse
 */
DeleteDataCheckConfigResponse Client::deleteDataCheckConfig(const DeleteDataCheckConfigRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
DeleteDataCheckTaskResponse Client::deleteDataCheckTaskWithOptions(const DeleteDataCheckTaskRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/delete")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<DeleteDataCheckTaskResponse>();
}
 ...
 * @return DeleteDataCheckTaskResponse
 */
DeleteDataCheckTaskResponse Client::deleteDataCheckTask(const DeleteDataCheckTaskRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
DeleteDataCheckTemplateResponse Client::deleteDataCheckTemplateWithOptions(const DeleteDataCheckTemplateRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/template/v3/delete")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<DeleteDataCheckTemplateResponse>();
}
 ...
 * @return DeleteDataCheckTemplateResponse
 */
DeleteDataCheckTemplateResponse Client::deleteDataCheckTemplate(const DeleteDataCheckTemplateRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
EditTaskPopResponse Client::editTaskPopWithOptions(const EditTaskPopRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasConcurrency()) {
    body["concurrency"] = request.getConcurrency();
  ...
  if (!!request.hasDqlTestDatasourceName()) {
    body["dqlTestDatasourceName"] = request.getDqlTestDatasourceName();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/sql-translator/editPop")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<EditTaskPopResponse>();
}
 ...
 * @return EditTaskPopResponse
 */
EditTaskPopResponse Client::editTaskPop(const EditTaskPopRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecDataCheckDownloadReportResponse Client::execDataCheckDownloadReportWithOptions(const ExecDataCheckDownloadReportRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/report/v3/download")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecDataCheckDownloadReportResponse>();
}
 ...
 * @return ExecDataCheckDownloadReportResponse
 */
ExecDataCheckDownloadReportResponse Client::execDataCheckDownloadReport(const ExecDataCheckDownloadReportRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecDataCheckGenerateReportResponse Client::execDataCheckGenerateReportWithOptions(const ExecDataCheckGenerateReportRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasBatchId()) {
    query["batchId"] = request.getBatchId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/report/v3/generateReport")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecDataCheckGenerateReportResponse>();
}
 ...
 * @return ExecDataCheckGenerateReportResponse
 */
ExecDataCheckGenerateReportResponse Client::execDataCheckGenerateReport(const ExecDataCheckGenerateReportRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecDataCheckReRunResponse Client::execDataCheckReRunWithOptions(const ExecDataCheckReRunRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasBatchId()) {
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/rerun")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecDataCheckReRunResponse>();
}
 ...
 * @return ExecDataCheckReRunResponse
 */
ExecDataCheckReRunResponse Client::execDataCheckReRun(const ExecDataCheckReRunRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecDataCheckRunResponse Client::execDataCheckRunWithOptions(const ExecDataCheckRunRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasBatchId()) {
    body["batchId"] = request.getBatchId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/run")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecDataCheckRunResponse>();
}
 ...
 * @return ExecDataCheckRunResponse
 */
ExecDataCheckRunResponse Client::execDataCheckRun(const ExecDataCheckRunRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecDataCheckRunFailedResponse Client::execDataCheckRunFailedWithOptions(const ExecDataCheckRunFailedRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasBatchId()) {
    body["batchId"] = request.getBatchId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/runFailed")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecDataCheckRunFailedResponse>();
}
 ...
 * @return ExecDataCheckRunFailedResponse
 */
ExecDataCheckRunFailedResponse Client::execDataCheckRunFailed(const ExecDataCheckRunFailedRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecDataCheckSaveTaskResponse Client::execDataCheckSaveTaskWithOptions(const ExecDataCheckSaveTaskRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCheckGlobalParams()) {
    body["checkGlobalParams"] = request.getCheckGlobalParams();
  }

  if (!!request.hasFullTableCount()) {
    body["fullTableCount"] = request.getFullTableCount();
  }

  if (!!request.hasSourceGlobalParams()) {
    body["sourceGlobalParams"] = request.getSourceGlobalParams();
  }
  ...
  if (!!request.hasTargetGlobalParams()) {
    body["targetGlobalParams"] = request.getTargetGlobalParams();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/save")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecDataCheckSaveTaskResponse>();
}
 ...
 * @return ExecDataCheckSaveTaskResponse
 */
ExecDataCheckSaveTaskResponse Client::execDataCheckSaveTask(const ExecDataCheckSaveTaskRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecDataCheckSqlPreviewResponse Client::execDataCheckSqlPreviewWithOptions(const ExecDataCheckSqlPreviewRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCheckColumn()) {
    body["checkColumn"] = request.getCheckColumn();
  }
  ...
  if (!!request.hasEngineId()) {
    body["engineId"] = request.getEngineId();
  }

  if (!!request.hasFullTableName()) {
    body["fullTableName"] = request.getFullTableName();
  }

  if (!!request.hasPartitionCondition()) {
    body["partitionCondition"] = request.getPartitionCondition();
  }
  ...
  if (!!request.hasWhereClause()) {
    body["whereClause"] = request.getWhereClause();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/config/v3/sql/preview")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecDataCheckSqlPreviewResponse>();
}
 ...
 * @return ExecDataCheckSqlPreviewResponse
 */
ExecDataCheckSqlPreviewResponse Client::execDataCheckSqlPreview(const ExecDataCheckSqlPreviewRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecDataCheckStopResponse Client::execDataCheckStopWithOptions(const ExecDataCheckStopRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasBatchId()) {
    body["batchId"] = request.getBatchId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/stop")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecDataCheckStopResponse>();
}
 ...
 * @return ExecDataCheckStopResponse
 */
ExecDataCheckStopResponse Client::execDataCheckStop(const ExecDataCheckStopRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecDataCheckToggleResponse Client::execDataCheckToggleWithOptions(const ExecDataCheckToggleRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/toggle")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecDataCheckToggleResponse>();
}
 ...
 * @return ExecDataCheckToggleResponse
 */
ExecDataCheckToggleResponse Client::execDataCheckToggle(const ExecDataCheckToggleRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecMetaDataComponentNameResponse Client::execMetaDataComponentNameWithOptions(const ExecMetaDataComponentNameRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasDsName()) {
    query["dsName"] = request.getDsName();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/v2/meta/data-component/check-name")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecMetaDataComponentNameResponse>();
}
 ...
 * @return ExecMetaDataComponentNameResponse
 */
ExecMetaDataComponentNameResponse Client::execMetaDataComponentName(const ExecMetaDataComponentNameRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecSqlTransSingleScriptTranslateResponse Client::execSqlTransSingleScriptTranslateWithOptions(const ExecSqlTransSingleScriptTranslateRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasSourceDialect()) {
    body["sourceDialect"] = request.getSourceDialect();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/sql-translator/open/single/translate-sync")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecSqlTransSingleScriptTranslateResponse>();
}
 ...
 * @return ExecSqlTransSingleScriptTranslateResponse
 */
ExecSqlTransSingleScriptTranslateResponse Client::execSqlTransSingleScriptTranslate(const ExecSqlTransSingleScriptTranslateRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ExecWorkflowConnectivityResponse Client::execWorkflowConnectivityWithOptions(const ExecWorkflowConnectivityRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasDsConfig()) {
    body["dsConfig"] = request.getDsConfig();
  ...
  if (!!request.hasIsModified()) {
    body["isModified"] = request.getIsModified();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/v2/meta/data-component/workflow/connectivity")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ExecWorkflowConnectivityResponse>();
}
 ...
 * @return ExecWorkflowConnectivityResponse
 */
ExecWorkflowConnectivityResponse Client::execWorkflowConnectivity(const ExecWorkflowConnectivityRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetAllRulesSummaryResponse Client::getAllRulesSummaryWithOptions(const GetAllRulesSummaryRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/sql-translator/open/rules")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetAllRulesSummaryResponse>();
}
 ...
 * @return GetAllRulesSummaryResponse
 */
GetAllRulesSummaryResponse Client::getAllRulesSummary(const GetAllRulesSummaryRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetBwmMigrationSubmitInstanceListResponse Client::getBwmMigrationSubmitInstanceListWithOptions(const GetBwmMigrationSubmitInstanceListRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bwm/task/migration/submit/instances/list")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetBwmMigrationSubmitInstanceListResponse>();
}
 ...
 * @return GetBwmMigrationSubmitInstanceListResponse
 */
GetBwmMigrationSubmitInstanceListResponse Client::getBwmMigrationSubmitInstanceList(const GetBwmMigrationSubmitInstanceListRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetBwmMigrationTaskWriterResultPackageResponse Client::getBwmMigrationTaskWriterResultPackageWithOptions(const GetBwmMigrationTaskWriterResultPackageRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bwm/task/migration/write/result/export/package")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetBwmMigrationTaskWriterResultPackageResponse>();
}
 ...
 * @return GetBwmMigrationTaskWriterResultPackageResponse
 */
GetBwmMigrationTaskWriterResultPackageResponse Client::getBwmMigrationTaskWriterResultPackage(const GetBwmMigrationTaskWriterResultPackageRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetBwmMigrationTaskWriterWorkflowListResponse Client::getBwmMigrationTaskWriterWorkflowListWithOptions(const GetBwmMigrationTaskWriterWorkflowListRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasInstanceId()) {
    query["instanceId"] = request.getInstanceId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bwm/task/migration/write/result/workflow/list")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetBwmMigrationTaskWriterWorkflowListResponse>();
}
 ...
 * @return GetBwmMigrationTaskWriterWorkflowListResponse
 */
GetBwmMigrationTaskWriterWorkflowListResponse Client::getBwmMigrationTaskWriterWorkflowList(const GetBwmMigrationTaskWriterWorkflowListRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetBwmMigrationWorkflowSubmitStartResponse Client::getBwmMigrationWorkflowSubmitStartWithOptions(const GetBwmMigrationWorkflowSubmitStartRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasTaskId()) {
    query["taskId"] = request.getTaskId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bwm/task/migration/submit/start")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetBwmMigrationWorkflowSubmitStartResponse>();
}
 ...
 * @return GetBwmMigrationWorkflowSubmitStartResponse
 */
GetBwmMigrationWorkflowSubmitStartResponse Client::getBwmMigrationWorkflowSubmitStart(const GetBwmMigrationWorkflowSubmitStartRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetCategoryDetailResponse Client::getCategoryDetailWithOptions(const GetCategoryDetailRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/sql-translator/open/rules/categories")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetCategoryDetailResponse>();
}
 ...
 * @return GetCategoryDetailResponse
 */
GetCategoryDetailResponse Client::getCategoryDetail(const GetCategoryDetailRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetCronExecTimeResponse Client::getCronExecTimeWithOptions(const GetCronExecTimeRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasCronRule()) {
    query["cronRule"] = request.getCronRule();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/cron/exeTime")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetCronExecTimeResponse>();
}
 ...
 * @return GetCronExecTimeResponse
 */
GetCronExecTimeResponse Client::getCronExecTime(const GetCronExecTimeRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetDataCheckConfigResponse Client::getDataCheckConfigWithOptions(const GetDataCheckConfigRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasTaskId()) {
    query["taskId"] = request.getTaskId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/config/v3/getConfig")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetDataCheckConfigResponse>();
}
 ...
 * @return GetDataCheckConfigResponse
 */
GetDataCheckConfigResponse Client::getDataCheckConfig(const GetDataCheckConfigRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetDataCheckReportOverviewResponse Client::getDataCheckReportOverviewWithOptions(const GetDataCheckReportOverviewRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasBatchId()) {
    query["batchId"] = request.getBatchId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/report/v3/overview")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetDataCheckReportOverviewResponse>();
}
 ...
 * @return GetDataCheckReportOverviewResponse
 */
GetDataCheckReportOverviewResponse Client::getDataCheckReportOverview(const GetDataCheckReportOverviewRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetDataCheckReportStatusResponse Client::getDataCheckReportStatusWithOptions(const GetDataCheckReportStatusRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasBatchId()) {
    query["batchId"] = request.getBatchId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/report/v3/getReportStatus")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetDataCheckReportStatusResponse>();
}
 ...
 * @return GetDataCheckReportStatusResponse
 */
GetDataCheckReportStatusResponse Client::getDataCheckReportStatus(const GetDataCheckReportStatusRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetDataCheckTaskConfigResponse Client::getDataCheckTaskConfigWithOptions(const GetDataCheckTaskConfigRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasTaskId()) {
    query["taskId"] = request.getTaskId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/config")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetDataCheckTaskConfigResponse>();
}
 ...
 * @return GetDataCheckTaskConfigResponse
 */
GetDataCheckTaskConfigResponse Client::getDataCheckTaskConfig(const GetDataCheckTaskConfigRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetDataCheckTaskListResponse Client::getDataCheckTaskListWithOptions(const GetDataCheckTaskListRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  ...
  if (!!request.hasExecStatus()) {
    body["execStatus"] = request.getExecStatus();
  }

  if (!!request.hasIsScheduled()) {
    body["isScheduled"] = request.getIsScheduled();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/find")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetDataCheckTaskListResponse>();
}
 ...
 * @return GetDataCheckTaskListResponse
 */
GetDataCheckTaskListResponse Client::getDataCheckTaskList(const GetDataCheckTaskListRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetDataCheckTemplateResponse Client::getDataCheckTemplateWithOptions(const GetDataCheckTemplateRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/template/v3/get")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetDataCheckTemplateResponse>();
}
 ...
 * @return GetDataCheckTemplateResponse
 */
GetDataCheckTemplateResponse Client::getDataCheckTemplate(const GetDataCheckTemplateRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetDataCheckTemplateListResponse Client::getDataCheckTemplateListWithOptions(const GetDataCheckTemplateListRequest &tmpReq, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  tmpReq.validate();
  GetDataCheckTemplateListShrinkRequest request = GetDataCheckTemplateListShrinkRequest();
  ...
  if (!!request.hasIdListShrink()) {
    query["idList"] = request.getIdListShrink();
  }

  if (!!request.hasIsAdmin()) {
    query["isAdmin"] = request.getIsAdmin();
  }

  if (!!request.hasIsBuiltin()) {
    query["isBuiltin"] = request.getIsBuiltin();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/template/v3/list")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetDataCheckTemplateListResponse>();
}
 ...
 * @return GetDataCheckTemplateListResponse
 */
GetDataCheckTemplateListResponse Client::getDataCheckTemplateList(const GetDataCheckTemplateListRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetInnerConvertAsyncResultResponse Client::getInnerConvertAsyncResultWithOptions(const GetInnerConvertAsyncResultRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasTaskId()) {
    body["taskId"] = request.getTaskId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/skill/inner/v1/convert/async-result")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetInnerConvertAsyncResultResponse>();
}
 ...
 * @return GetInnerConvertAsyncResultResponse
 */
GetInnerConvertAsyncResultResponse Client::getInnerConvertAsyncResult(const GetInnerConvertAsyncResultRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetInnerReadAsyncResultResponse Client::getInnerReadAsyncResultWithOptions(const GetInnerReadAsyncResultRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/skill/inner/v1/read/async-result")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetInnerReadAsyncResultResponse>();
}
 ...
 * @return GetInnerReadAsyncResultResponse
 */
GetInnerReadAsyncResultResponse Client::getInnerReadAsyncResult(const GetInnerReadAsyncResultRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetLhmAgentStatusResponse Client::getLhmAgentStatusWithOptions(const GetLhmAgentStatusRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/lhm/agent/getAgentStatus")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetLhmAgentStatusResponse>();
}
 ...
 * @return GetLhmAgentStatusResponse
 */
GetLhmAgentStatusResponse Client::getLhmAgentStatus(const GetLhmAgentStatusRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetLhmDWResourceGroupStatusResponse Client::getLhmDWResourceGroupStatusWithOptions(const GetLhmDWResourceGroupStatusRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/lhm/resource/getDWResourceGroupStatus")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetLhmDWResourceGroupStatusResponse>();
}
 ...
 * @return GetLhmDWResourceGroupStatusResponse
 */
GetLhmDWResourceGroupStatusResponse Client::getLhmDWResourceGroupStatus(const GetLhmDWResourceGroupStatusRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetMetaOssTempKeyResponse Client::getMetaOssTempKeyWithOptions(const GetMetaOssTempKeyRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  OpenApiRequest req = OpenApiRequest(json({
    {"headers" , headers}
  }).get<map<string, map<string, string>>>());
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/v2/meta/data-component/okss-services/file-job/sts")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetMetaOssTempKeyResponse>();
}
 ...
 * @return GetMetaOssTempKeyResponse
 */
GetMetaOssTempKeyResponse Client::getMetaOssTempKey(const GetMetaOssTempKeyRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetSqlConversionProgressResponse Client::getSqlConversionProgressWithOptions(const GetSqlConversionProgressRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasTaskId()) {
    query["taskId"] = request.getTaskId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/jobMigrate/sqlTranslator/task/api/progress")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetSqlConversionProgressResponse>();
}
 ...
 * @return GetSqlConversionProgressResponse
 */
GetSqlConversionProgressResponse Client::getSqlConversionProgress(const GetSqlConversionProgressRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetSqlConversionResultResponse Client::getSqlConversionResultWithOptions(const GetSqlConversionResultRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasPage()) {
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/jobMigrate/sqlTranslator/task/api/result")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetSqlConversionResultResponse>();
}
 ...
 * @return GetSqlConversionResultResponse
 */
GetSqlConversionResultResponse Client::getSqlConversionResult(const GetSqlConversionResultRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetSqlTableLineageResponse Client::getSqlTableLineageWithOptions(const GetSqlTableLineageRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasDefaultSchema()) {
    body["defaultSchema"] = request.getDefaultSchema();
  }

  if (!!request.hasDialect()) {
    body["dialect"] = request.getDialect();
  }

  if (!!request.hasSourceSqlScriptBase64()) {
    body["sourceSqlScriptBase64"] = request.getSourceSqlScriptBase64();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/sql-translator/open/single/getTableLineage")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetSqlTableLineageResponse>();
}
 ...
 * @return GetSqlTableLineageResponse
 */
GetSqlTableLineageResponse Client::getSqlTableLineage(const GetSqlTableLineageRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetSqlTransTableMetaInfoResponse Client::getSqlTransTableMetaInfoWithOptions(const GetSqlTransTableMetaInfoRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasSourceDialect()) {
    body["sourceDialect"] = request.getSourceDialect();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/sql-translator/open/single/get-table-info")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetSqlTransTableMetaInfoResponse>();
}
 ...
 * @return GetSqlTransTableMetaInfoResponse
 */
GetSqlTransTableMetaInfoResponse Client::getSqlTransTableMetaInfo(const GetSqlTransTableMetaInfoRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
GetStepResultOverviewResponse Client::getStepResultOverviewWithOptions(const GetStepResultOverviewRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/report/v3/result/overview")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<GetStepResultOverviewResponse>();
}
 ...
 * @return GetStepResultOverviewResponse
 */
GetStepResultOverviewResponse Client::getStepResultOverview(const GetStepResultOverviewRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ListDataCheckColumnResultsResponse Client::listDataCheckColumnResultsWithOptions(const ListDataCheckColumnResultsRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasPageIndex()) {
    query["pageIndex"] = request.getPageIndex();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/report/v3/column/page")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ListDataCheckColumnResultsResponse>();
}
 ...
 * @return ListDataCheckColumnResultsResponse
 */
ListDataCheckColumnResultsResponse Client::listDataCheckColumnResults(const ListDataCheckColumnResultsRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ListDataCheckConfigResponse Client::listDataCheckConfigWithOptions(const ListDataCheckConfigRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasPageIndex()) {
    query["pageIndex"] = request.getPageIndex();
  ...
  if (!!request.hasSrcTable()) {
    query["srcTable"] = request.getSrcTable();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/config/v3/listConfig/page")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ListDataCheckConfigResponse>();
}
 ...
 * @return ListDataCheckConfigResponse
 */
ListDataCheckConfigResponse Client::listDataCheckConfig(const ListDataCheckConfigRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ListDataCheckReportResponse Client::listDataCheckReportWithOptions(const ListDataCheckReportRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasBatchId()) {
    body["batchId"] = request.getBatchId();
  ...
  if (!!request.hasJobStatus()) {
    body["jobStatus"] = request.getJobStatus();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/report/v3/page")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ListDataCheckReportResponse>();
}
 ...
 * @return ListDataCheckReportResponse
 */
ListDataCheckReportResponse Client::listDataCheckReport(const ListDataCheckReportRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ListDataCheckReportInstanceResponse Client::listDataCheckReportInstanceWithOptions(const ListDataCheckReportInstanceRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasTaskId()) {
    query["taskId"] = request.getTaskId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/report/v3/list")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ListDataCheckReportInstanceResponse>();
}
 ...
 * @return ListDataCheckReportInstanceResponse
 */
ListDataCheckReportInstanceResponse Client::listDataCheckReportInstance(const ListDataCheckReportInstanceRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ListDataCheckReportStepResponse Client::listDataCheckReportStepWithOptions(const ListDataCheckReportStepRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasCheckResult()) {
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/report/v3/step/page")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ListDataCheckReportStepResponse>();
}
 ...
 * @return ListDataCheckReportStepResponse
 */
ListDataCheckReportStepResponse Client::listDataCheckReportStep(const ListDataCheckReportStepRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ListDataCheckReportStepByJobIdResponse Client::listDataCheckReportStepByJobIdWithOptions(const ListDataCheckReportStepByJobIdRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasJobId()) {
    query["jobId"] = request.getJobId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/report/v3/step/pageByJobId")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ListDataCheckReportStepByJobIdResponse>();
}
 ...
 * @return ListDataCheckReportStepByJobIdResponse
 */
ListDataCheckReportStepByJobIdResponse Client::listDataCheckReportStepByJobId(const ListDataCheckReportStepByJobIdRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ListDataCheckTaskHistoryResponse Client::listDataCheckTaskHistoryWithOptions(const ListDataCheckTaskHistoryRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasBatchId()) {
    query["batchId"] = request.getBatchId();
  ...
  if (!!request.hasExecEndTime()) {
    query["execEndTime"] = request.getExecEndTime();
  }

  if (!!request.hasExecStartTime()) {
    query["execStartTime"] = request.getExecStartTime();
  }

  if (!!request.hasExecStatus()) {
    query["execStatus"] = request.getExecStatus();
  }

  if (!!request.hasFinishEndTime()) {
    query["finishEndTime"] = request.getFinishEndTime();
  }

  if (!!request.hasFinishStartTime()) {
    query["finishStartTime"] = request.getFinishStartTime();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/details")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ListDataCheckTaskHistoryResponse>();
}
 ...
 * @return ListDataCheckTaskHistoryResponse
 */
ListDataCheckTaskHistoryResponse Client::listDataCheckTaskHistory(const ListDataCheckTaskHistoryRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
ListMetaDataComponentPageResponse Client::listMetaDataComponentPageWithOptions(const ListMetaDataComponentPageRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCategoryType()) {
    body["categoryType"] = request.getCategoryType();
  ...
  if (!!request.hasDsTypeList()) {
    body["dsTypeList"] = request.getDsTypeList();
  }
  ...
  if (!!request.hasNeedTotalCount()) {
    body["needTotalCount"] = request.getNeedTotalCount();
  }
  ...
  if (!!request.hasSrcComponentId()) {
    body["srcComponentId"] = request.getSrcComponentId();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/v2/meta/data-component/page")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<ListMetaDataComponentPageResponse>();
}
 ...
 * @return ListMetaDataComponentPageResponse
 */
ListMetaDataComponentPageResponse Client::listMetaDataComponentPage(const ListMetaDataComponentPageRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
PostInnerConvertResponse Client::postInnerConvertWithOptions(const PostInnerConvertRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasSqlConvertMap()) {
    body["sqlConvertMap"] = request.getSqlConvertMap();
  }

  if (!!request.hasSrcDataSourceName()) {
    body["srcDataSourceName"] = request.getSrcDataSourceName();
  }

  if (!!request.hasTgtDataSourceName()) {
    body["tgtDataSourceName"] = request.getTgtDataSourceName();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/skill/inner/v1/convert")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<PostInnerConvertResponse>();
}
 ...
 * @return PostInnerConvertResponse
 */
PostInnerConvertResponse Client::postInnerConvert(const PostInnerConvertRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
PostInnerReaderResponse Client::postInnerReaderWithOptions(const PostInnerReaderRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasDataSourceDescriptor()) {
    body["dataSourceDescriptor"] = request.getDataSourceDescriptor();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/skill/inner/v1/read")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<PostInnerReaderResponse>();
}
 ...
 * @return PostInnerReaderResponse
 */
PostInnerReaderResponse Client::postInnerReader(const PostInnerReaderRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
PostInnerUploadConvertPackageResponse Client::postInnerUploadConvertPackageWithOptions(const PostInnerUploadConvertPackageRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasFileContentBase64()) {
    body["fileContentBase64"] = request.getFileContentBase64();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/skill/inner/v1/convert/upload-package")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<PostInnerUploadConvertPackageResponse>();
}
 ...
 * @return PostInnerUploadConvertPackageResponse
 */
PostInnerUploadConvertPackageResponse Client::postInnerUploadConvertPackage(const PostInnerUploadConvertPackageRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
SingleSqlDryRunResponse Client::singleSqlDryRunWithOptions(const SingleSqlDryRunRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasDatasourceName()) {
    body["datasourceName"] = request.getDatasourceName();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/sql-translator/dryRun")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<SingleSqlDryRunResponse>();
}
 ...
 * @return SingleSqlDryRunResponse
 */
SingleSqlDryRunResponse Client::singleSqlDryRun(const SingleSqlDryRunRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
SyntaxCheckAndTransformSqlConversionTaskResponse Client::syntaxCheckAndTransformSqlConversionTaskWithOptions(const SyntaxCheckAndTransformSqlConversionTaskRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json query = {};
  if (!!request.hasTaskId()) {
    query["taskId"] = request.getTaskId();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/api/bigdata/jobMigrate/sqlTranslator/task/api/syntaxCheckAndTransformTask")},
    {"method" , "GET"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<SyntaxCheckAndTransformSqlConversionTaskResponse>();
}
 ...
 * @return SyntaxCheckAndTransformSqlConversionTaskResponse
 */
SyntaxCheckAndTransformSqlConversionTaskResponse Client::syntaxCheckAndTransformSqlConversionTask(const SyntaxCheckAndTransformSqlConversionTaskRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
UpdateDataCheckTaskResponse Client::updateDataCheckTaskWithOptions(const UpdateDataCheckTaskRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasCheckTemplateId()) {
    body["checkTemplateId"] = request.getCheckTemplateId();
  ...
  if (!!request.hasDstEngineId()) {
    body["dstEngineId"] = request.getDstEngineId();
  }

  if (!!request.hasDstEngineName()) {
    body["dstEngineName"] = request.getDstEngineName();
  }

  if (!!request.hasDstEngineType()) {
    body["dstEngineType"] = request.getDstEngineType();
  }
  ...
  if (!!request.hasSrcEngineId()) {
    body["srcEngineId"] = request.getSrcEngineId();
  }

  if (!!request.hasSrcEngineName()) {
    body["srcEngineName"] = request.getSrcEngineName();
  }

  if (!!request.hasSrcEngineType()) {
    body["srcEngineType"] = request.getSrcEngineType();
  }
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/task/v3/update")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<UpdateDataCheckTaskResponse>();
}
 ...
 * @return UpdateDataCheckTaskResponse
 */
UpdateDataCheckTaskResponse Client::updateDataCheckTask(const UpdateDataCheckTaskRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
 ...
 */
UpdateDataCheckTemplateResponse Client::updateDataCheckTemplateWithOptions(const UpdateDataCheckTemplateRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime) {
  request.validate();
  json body = {};
  if (!!request.hasBasicMetricRules()) {
    body["basicMetricRules"] = request.getBasicMetricRules();
  ...
  Params params = Params(json({
    ...
    {"version" , "2025-01-16"},
    {"protocol" , "HTTPS"},
    {"pathname" , DARA_STRING_TEMPLATE("/dataCheck/template/v3/update")},
    {"method" , "POST"},
    {"authType" , "AK"},
    {"style" , "ROA"},
    {"reqBodyType" , "json"},
  ...
  return json(callApi(params, req, runtime)).get<UpdateDataCheckTemplateResponse>();
}
 ...
 * @return UpdateDataCheckTemplateResponse
 */
UpdateDataCheckTemplateResponse Client::updateDataCheckTemplate(const UpdateDataCheckTemplateRequest &request) {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
  map<string, string> headers = {};
