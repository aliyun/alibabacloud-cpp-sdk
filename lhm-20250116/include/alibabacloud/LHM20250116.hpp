...
namespace LHM20250116
{
  class Client : public AlibabaCloud::OpenApi::Client {
    public:
      ...
      /**
       * @summary Retrieves the specified dialect conversion rule.
       *
       ...
       */
      Models::GetAllRulesSummaryResponse getAllRulesSummaryWithOptions(const Models::GetAllRulesSummaryRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime);
       ...
       * @return GetAllRulesSummaryResponse
       */
      Models::GetAllRulesSummaryResponse getAllRulesSummary(const Models::GetAllRulesSummaryRequest &request);
      ...
      /**
       * @summary Retrieves the details of dialect rules.
       *
       ...
       */
      Models::GetCategoryDetailResponse getCategoryDetailWithOptions(const Models::GetCategoryDetailRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime);
       ...
       * @return GetCategoryDetailResponse
       */
      Models::GetCategoryDetailResponse getCategoryDetail(const Models::GetCategoryDetailRequest &request);
      ...
      /**
       * @summary Queries the table-level configuration list of a data validation node by node ID and source table name with paging.
       *
       * @description ## Operation description
      ...
      /**
       * @summary Queries a validation report by paged query, returning job dimension summaries and validation result details for each table within the job.
       *
       * @description ## Operation description
      ...
      /**
       * @summary Queries a paged list of step (partition) dimension verification details by a UUID-format job ID with paging support.
       *
       * @description ## Operation description
      ...
      /**
       * @summary Submits a source workflow read task for a Skill internal operation and returns an asynchronous execution credential. Query the result by calling GetInnerReadAsyncResult.
       *
       * @description ## Operation description
      ...
      /**
       * @summary Validates the syntax of a specified SQL conversion task and then performs the conversion, returning the combined validation and conversion results.
       *
       * @description ## Operation description
      ...
      /**
       * @summary Updates the name and metric definitions of a metric check template. After the update, nodes that reference this template execute based on the new definitions.
       *
       * @description ## Operation description
