...
#ifndef ALIBABACLOUD_MODELS_GETDATACHECKCONFIGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETDATACHECKCONFIGRESPONSEBODY_HPP_
...
namespace Models
{
  class GetDataCheckConfigResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetDataCheckConfigResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDataCheckConfigResponseBody& obj) { 
    ...
    GetDataCheckConfigResponseBody() = default ;
    GetDataCheckConfigResponseBody(const GetDataCheckConfigResponseBody &) = default ;
    GetDataCheckConfigResponseBody(GetDataCheckConfigResponseBody &&) = default ;
    GetDataCheckConfigResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDataCheckConfigResponseBody() = default ;
    GetDataCheckConfigResponseBody& operator=(const GetDataCheckConfigResponseBody &) = default ;
    GetDataCheckConfigResponseBody& operator=(GetDataCheckConfigResponseBody &&) = default ;
    ...
    inline const vector<GetDataCheckConfigResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<GetDataCheckConfigResponseBody::Data>) };
    inline vector<GetDataCheckConfigResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<GetDataCheckConfigResponseBody::Data>) };
    inline GetDataCheckConfigResponseBody& setData(const vector<GetDataCheckConfigResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataCheckConfigResponseBody& setData(vector<GetDataCheckConfigResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetDataCheckConfigResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline GetDataCheckConfigResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline GetDataCheckConfigResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetDataCheckConfigResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The data list returned by the operation. For the structure of each element, see the child field descriptions.
    shared_ptr<vector<GetDataCheckConfigResponseBody::Data>> data_ {};
