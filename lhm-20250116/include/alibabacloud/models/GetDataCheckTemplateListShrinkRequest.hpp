...
#ifndef ALIBABACLOUD_MODELS_GETDATACHECKTEMPLATELISTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETDATACHECKTEMPLATELISTSHRINKREQUEST_HPP_
...
namespace Models
{
  class GetDataCheckTemplateListShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetDataCheckTemplateListShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDataCheckTemplateListShrinkRequest& obj) { 
    ...
    GetDataCheckTemplateListShrinkRequest() = default ;
    GetDataCheckTemplateListShrinkRequest(const GetDataCheckTemplateListShrinkRequest &) = default ;
    GetDataCheckTemplateListShrinkRequest(GetDataCheckTemplateListShrinkRequest &&) = default ;
    GetDataCheckTemplateListShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDataCheckTemplateListShrinkRequest() = default ;
    GetDataCheckTemplateListShrinkRequest& operator=(const GetDataCheckTemplateListShrinkRequest &) = default ;
    GetDataCheckTemplateListShrinkRequest& operator=(GetDataCheckTemplateListShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->checkType_ == nullptr
        && this->groupBy_ == nullptr && this->idListShrink_ == nullptr && this->isAdmin_ == nullptr && this->isBuiltin_ == nullptr && this->needTotalCount_ == nullptr
    ...
    inline GetDataCheckTemplateListShrinkRequest& setCheckType(int32_t checkType) { DARABONBA_PTR_SET_VALUE(checkType_, checkType) };
    ...
    inline GetDataCheckTemplateListShrinkRequest& setGroupBy(string groupBy) { DARABONBA_PTR_SET_VALUE(groupBy_, groupBy) };
    ...
    inline string getIdListShrink() const { DARABONBA_PTR_GET_DEFAULT(idListShrink_, "") };
    inline GetDataCheckTemplateListShrinkRequest& setIdListShrink(string idListShrink) { DARABONBA_PTR_SET_VALUE(idListShrink_, idListShrink) };
    ...
    inline GetDataCheckTemplateListShrinkRequest& setIsAdmin(bool isAdmin) { DARABONBA_PTR_SET_VALUE(isAdmin_, isAdmin) };
    ...
    inline GetDataCheckTemplateListShrinkRequest& setIsBuiltin(int32_t isBuiltin) { DARABONBA_PTR_SET_VALUE(isBuiltin_, isBuiltin) };
    ...
    inline GetDataCheckTemplateListShrinkRequest& setNeedTotalCount(bool needTotalCount) { DARABONBA_PTR_SET_VALUE(needTotalCount_, needTotalCount) };
    ...
    inline GetDataCheckTemplateListShrinkRequest& setOrderBy(string orderBy) { DARABONBA_PTR_SET_VALUE(orderBy_, orderBy) };
    ...
    inline GetDataCheckTemplateListShrinkRequest& setOrderDirection(string orderDirection) { DARABONBA_PTR_SET_VALUE(orderDirection_, orderDirection) };
    ...
    inline GetDataCheckTemplateListShrinkRequest& setPageIndex(int32_t pageIndex) { DARABONBA_PTR_SET_VALUE(pageIndex_, pageIndex) };
    ...
    inline GetDataCheckTemplateListShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetDataCheckTemplateListShrinkRequest& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetDataCheckTemplateListShrinkRequest& setTemplateName(string templateName) { DARABONBA_PTR_SET_VALUE(templateName_, templateName) };
    ...
    inline GetDataCheckTemplateListShrinkRequest& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
