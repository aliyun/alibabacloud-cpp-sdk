...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateProjectResponseBodyAccessDeniedDetail & accessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, UpdateProjectResponseBodyAccessDeniedDetail) };
    inline UpdateProjectResponseBodyAccessDeniedDetail accessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, UpdateProjectResponseBodyAccessDeniedDetail) };
    inline UpdateProjectResponseBody& setAccessDeniedDetail(const UpdateProjectResponseBodyAccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline UpdateProjectResponseBody& setAccessDeniedDetail(UpdateProjectResponseBodyAccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline UpdateProjectResponseBody& setCode(int64_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UpdateProjectResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
  ...
  protected:
    std::shared_ptr<UpdateProjectResponseBodyAccessDeniedDetail> accessDeniedDetail_ = nullptr;
