...
class DecryptContentRequest : public Darabonba::Model {
public:
  shared_ptr<string> content{};

  DecryptContentRequest() {}

  explicit DecryptContentRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DecryptContentRequest() = default;
};
class DecryptContentResponseBody : public Darabonba::Model {
public:
  shared_ptr<long> code{};
  shared_ptr<string> content{};
  shared_ptr<string> message{};
  ...
  DecryptContentResponseBody() {}

  explicit DecryptContentResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DecryptContentResponseBody() = default;
};
class DecryptContentResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<DecryptContentResponseBody> body{};

  DecryptContentResponse() {}

  explicit DecryptContentResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        DecryptContentResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<DecryptContentResponseBody>(model1);
      }
    }
  }


  virtual ~DecryptContentResponse() = default;
};
...
class EncryptContentRequest : public Darabonba::Model {
public:
  shared_ptr<string> content{};

  EncryptContentRequest() {}

  explicit EncryptContentRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~EncryptContentRequest() = default;
};
class EncryptContentResponseBody : public Darabonba::Model {
public:
  shared_ptr<long> code{};
  shared_ptr<string> content{};
  shared_ptr<string> message{};
  ...
  EncryptContentResponseBody() {}

  explicit EncryptContentResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~EncryptContentResponseBody() = default;
};
class EncryptContentResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<EncryptContentResponseBody> body{};

  EncryptContentResponse() {}

  explicit EncryptContentResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        EncryptContentResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<EncryptContentResponseBody>(model1);
      }
    }
  }


  virtual ~EncryptContentResponse() = default;
};
...
public:
  ...
  DecryptContentResponse decryptContentWithOptions(shared_ptr<DecryptContentRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  DecryptContentResponse decryptContent(shared_ptr<DecryptContentRequest> request);
  ...
  EncryptContentResponse encryptContentWithOptions(shared_ptr<EncryptContentRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  EncryptContentResponse encryptContent(shared_ptr<EncryptContentRequest> request);
