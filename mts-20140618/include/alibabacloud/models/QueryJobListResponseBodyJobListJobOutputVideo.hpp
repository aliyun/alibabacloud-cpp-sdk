...
#ifndef ALIBABACLOUD_MODELS_QUERYJOBLISTRESPONSEBODYJOBLISTJOBOUTPUTVIDEO_HPP_
#define ALIBABACLOUD_MODELS_QUERYJOBLISTRESPONSEBODYJOBLISTJOBOUTPUTVIDEO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryJobListResponseBodyJobListJobOutputVideo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryJobListResponseBodyJobListJobOutputVideo& obj) { 
    ...
    QueryJobListResponseBodyJobListJobOutputVideo() = default ;
    QueryJobListResponseBodyJobListJobOutputVideo(const QueryJobListResponseBodyJobListJobOutputVideo &) = default ;
    QueryJobListResponseBodyJobListJobOutputVideo(QueryJobListResponseBodyJobListJobOutputVideo &&) = default ;
    QueryJobListResponseBodyJobListJobOutputVideo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryJobListResponseBodyJobListJobOutputVideo() = default ;
    QueryJobListResponseBodyJobListJobOutputVideo& operator=(const QueryJobListResponseBodyJobListJobOutputVideo &) = default ;
    QueryJobListResponseBodyJobListJobOutputVideo& operator=(QueryJobListResponseBodyJobListJobOutputVideo &&) = default ;
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setBitrate(string bitrate) { DARABONBA_PTR_SET_VALUE(bitrate_, bitrate) };
    ...
    inline const Models::QueryJobListResponseBodyJobListJobOutputVideoBitrateBnd & bitrateBnd() const { DARABONBA_PTR_GET_CONST(bitrateBnd_, Models::QueryJobListResponseBodyJobListJobOutputVideoBitrateBnd) };
    inline Models::QueryJobListResponseBodyJobListJobOutputVideoBitrateBnd bitrateBnd() { DARABONBA_PTR_GET(bitrateBnd_, Models::QueryJobListResponseBodyJobListJobOutputVideoBitrateBnd) };
    inline QueryJobListResponseBodyJobListJobOutputVideo& setBitrateBnd(const Models::QueryJobListResponseBodyJobListJobOutputVideoBitrateBnd & bitrateBnd) { DARABONBA_PTR_SET_VALUE(bitrateBnd_, bitrateBnd) };
    inline QueryJobListResponseBodyJobListJobOutputVideo& setBitrateBnd(Models::QueryJobListResponseBodyJobListJobOutputVideoBitrateBnd && bitrateBnd) { DARABONBA_PTR_SET_RVALUE(bitrateBnd_, bitrateBnd) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setBufsize(string bufsize) { DARABONBA_PTR_SET_VALUE(bufsize_, bufsize) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setCodec(string codec) { DARABONBA_PTR_SET_VALUE(codec_, codec) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setCrf(string crf) { DARABONBA_PTR_SET_VALUE(crf_, crf) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setCrop(string crop) { DARABONBA_PTR_SET_VALUE(crop_, crop) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setDegrain(string degrain) { DARABONBA_PTR_SET_VALUE(degrain_, degrain) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setFps(string fps) { DARABONBA_PTR_SET_VALUE(fps_, fps) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setGop(string gop) { DARABONBA_PTR_SET_VALUE(gop_, gop) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setHeight(string height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setMaxFps(string maxFps) { DARABONBA_PTR_SET_VALUE(maxFps_, maxFps) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setMaxrate(string maxrate) { DARABONBA_PTR_SET_VALUE(maxrate_, maxrate) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setPad(string pad) { DARABONBA_PTR_SET_VALUE(pad_, pad) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setPixFmt(string pixFmt) { DARABONBA_PTR_SET_VALUE(pixFmt_, pixFmt) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setPreset(string preset) { DARABONBA_PTR_SET_VALUE(preset_, preset) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setProfile(string profile) { DARABONBA_PTR_SET_VALUE(profile_, profile) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setQscale(string qscale) { DARABONBA_PTR_SET_VALUE(qscale_, qscale) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setResoPriority(string resoPriority) { DARABONBA_PTR_SET_VALUE(resoPriority_, resoPriority) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setScanMode(string scanMode) { DARABONBA_PTR_SET_VALUE(scanMode_, scanMode) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputVideo& setWidth(string width) { DARABONBA_PTR_SET_VALUE(width_, width) };
  ...
  protected:
    ...
    std::shared_ptr<Models::QueryJobListResponseBodyJobListJobOutputVideoBitrateBnd> bitrateBnd_ = nullptr;
    // The buffer size.
    // 
    // *   Unit: KB.
    // *   Default value: **6000**.
