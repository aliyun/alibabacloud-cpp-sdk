...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMediaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMediaResponseBody) };
    inline DeleteMediaResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMediaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMediaResponseBody> body_ {};
  };
