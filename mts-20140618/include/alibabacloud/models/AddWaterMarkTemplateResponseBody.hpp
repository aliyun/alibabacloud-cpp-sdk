...
namespace Models
{
  ...
  public:
    ...
    inline const AddWaterMarkTemplateResponseBody::WaterMarkTemplate & getWaterMarkTemplate() const { DARABONBA_PTR_GET_CONST(waterMarkTemplate_, AddWaterMarkTemplateResponseBody::WaterMarkTemplate) };
    inline AddWaterMarkTemplateResponseBody::WaterMarkTemplate getWaterMarkTemplate() { DARABONBA_PTR_GET(waterMarkTemplate_, AddWaterMarkTemplateResponseBody::WaterMarkTemplate) };
    inline AddWaterMarkTemplateResponseBody& setWaterMarkTemplate(const AddWaterMarkTemplateResponseBody::WaterMarkTemplate & waterMarkTemplate) { DARABONBA_PTR_SET_VALUE(waterMarkTemplate_, waterMarkTemplate) };
    inline AddWaterMarkTemplateResponseBody& setWaterMarkTemplate(AddWaterMarkTemplateResponseBody::WaterMarkTemplate && waterMarkTemplate) { DARABONBA_PTR_SET_RVALUE(waterMarkTemplate_, waterMarkTemplate) };
  ...
  protected:
    ...
    shared_ptr<AddWaterMarkTemplateResponseBody::WaterMarkTemplate> waterMarkTemplate_ {};
  };
