...
#ifndef ALIBABACLOUD_MODELS_SEARCHTEMPLATERESPONSEBODYTEMPLATELISTTEMPLATEMUXCONFIGGIF_HPP_
#define ALIBABACLOUD_MODELS_SEARCHTEMPLATERESPONSEBODYTEMPLATELISTTEMPLATEMUXCONFIGGIF_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif& obj) { 
    ...
    SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif() = default ;
    SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif(const SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif &) = default ;
    SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif(SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif &&) = default ;
    SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif() = default ;
    SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif& operator=(const SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif &) = default ;
    SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif& operator=(SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif &&) = default ;
    ...
    inline SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif& setDitherMode(string ditherMode) { DARABONBA_PTR_SET_VALUE(ditherMode_, ditherMode) };
    ...
    inline SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif& setFinalDelay(string finalDelay) { DARABONBA_PTR_SET_VALUE(finalDelay_, finalDelay) };
    ...
    inline SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif& setIsCustomPalette(string isCustomPalette) { DARABONBA_PTR_SET_VALUE(isCustomPalette_, isCustomPalette) };
    ...
    inline SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif& setLoop(string loop) { DARABONBA_PTR_SET_VALUE(loop_, loop) };
