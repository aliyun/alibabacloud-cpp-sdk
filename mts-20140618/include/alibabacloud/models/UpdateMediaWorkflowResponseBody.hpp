...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMediaWorkflowResponseBody::MediaWorkflow & getMediaWorkflow() const { DARABONBA_PTR_GET_CONST(mediaWorkflow_, UpdateMediaWorkflowResponseBody::MediaWorkflow) };
    inline UpdateMediaWorkflowResponseBody::MediaWorkflow getMediaWorkflow() { DARABONBA_PTR_GET(mediaWorkflow_, UpdateMediaWorkflowResponseBody::MediaWorkflow) };
    inline UpdateMediaWorkflowResponseBody& setMediaWorkflow(const UpdateMediaWorkflowResponseBody::MediaWorkflow & mediaWorkflow) { DARABONBA_PTR_SET_VALUE(mediaWorkflow_, mediaWorkflow) };
    inline UpdateMediaWorkflowResponseBody& setMediaWorkflow(UpdateMediaWorkflowResponseBody::MediaWorkflow && mediaWorkflow) { DARABONBA_PTR_SET_RVALUE(mediaWorkflow_, mediaWorkflow) };
  ...
  protected:
    ...
    shared_ptr<UpdateMediaWorkflowResponseBody::MediaWorkflow> mediaWorkflow_ {};
