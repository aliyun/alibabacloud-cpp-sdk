...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ownerAccount_ == nullptr
        && this->ownerId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->waterMarkTemplateIds_ == nullptr; };
    ...
    inline string getWaterMarkTemplateIds() const { DARABONBA_PTR_GET_DEFAULT(waterMarkTemplateIds_, "") };
  ...
  protected:
    ...
    shared_ptr<string> waterMarkTemplateIds_ {};
  };
