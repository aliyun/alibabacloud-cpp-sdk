...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitAnalysisJobResponseBody::AnalysisJob & getAnalysisJob() const { DARABONBA_PTR_GET_CONST(analysisJob_, SubmitAnalysisJobResponseBody::AnalysisJob) };
    inline SubmitAnalysisJobResponseBody::AnalysisJob getAnalysisJob() { DARABONBA_PTR_GET(analysisJob_, SubmitAnalysisJobResponseBody::AnalysisJob) };
    inline SubmitAnalysisJobResponseBody& setAnalysisJob(const SubmitAnalysisJobResponseBody::AnalysisJob & analysisJob) { DARABONBA_PTR_SET_VALUE(analysisJob_, analysisJob) };
    inline SubmitAnalysisJobResponseBody& setAnalysisJob(SubmitAnalysisJobResponseBody::AnalysisJob && analysisJob) { DARABONBA_PTR_SET_RVALUE(analysisJob_, analysisJob) };
  ...
  protected:
    ...
    shared_ptr<SubmitAnalysisJobResponseBody::AnalysisJob> analysisJob_ {};
