...
namespace Models
{
  ...
  public:
    ...
    inline const BindInputBucketResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindInputBucketResponseBody) };
    inline BindInputBucketResponseBody getBody() { DARABONBA_PTR_GET(body_, BindInputBucketResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindInputBucketResponseBody> body_ {};
  };
