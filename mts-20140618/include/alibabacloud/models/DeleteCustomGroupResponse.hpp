...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCustomGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCustomGroupResponseBody) };
    inline DeleteCustomGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCustomGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCustomGroupResponseBody> body_ {};
  };
