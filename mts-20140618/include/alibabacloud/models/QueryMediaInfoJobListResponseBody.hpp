...
namespace Models
{
  ...
  public:
    ...
    class NonExistMediaInfoJobIds : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const NonExistMediaInfoJobIds& obj) { 
        DARABONBA_PTR_TO_JSON(String, string_);
      };
      friend void from_json(const Darabonba::Json& j, NonExistMediaInfoJobIds& obj) { 
        DARABONBA_PTR_FROM_JSON(String, string_);
      };
      NonExistMediaInfoJobIds() = default ;
      NonExistMediaInfoJobIds(const NonExistMediaInfoJobIds &) = default ;
      NonExistMediaInfoJobIds(NonExistMediaInfoJobIds &&) = default ;
      NonExistMediaInfoJobIds(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~NonExistMediaInfoJobIds() = default ;
      NonExistMediaInfoJobIds& operator=(const NonExistMediaInfoJobIds &) = default ;
      NonExistMediaInfoJobIds& operator=(NonExistMediaInfoJobIds &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline NonExistMediaInfoJobIds& setString(const vector<string> & string) { DARABONBA_PTR_SET_VALUE(string_, string) };
      inline NonExistMediaInfoJobIds& setString(vector<string> && string) { DARABONBA_PTR_SET_RVALUE(string_, string) };
    ...
    class MediaInfoJobList : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const MediaInfoJobList& obj) { 
        DARABONBA_PTR_TO_JSON(MediaInfoJob, mediaInfoJob_);
      };
      friend void from_json(const Darabonba::Json& j, MediaInfoJobList& obj) { 
        DARABONBA_PTR_FROM_JSON(MediaInfoJob, mediaInfoJob_);
      };
      MediaInfoJobList() = default ;
      MediaInfoJobList(const MediaInfoJobList &) = default ;
      MediaInfoJobList(MediaInfoJobList &&) = default ;
      MediaInfoJobList(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~MediaInfoJobList() = default ;
      MediaInfoJobList& operator=(const MediaInfoJobList &) = default ;
      MediaInfoJobList& operator=(MediaInfoJobList &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      public:
        ...
        && this->fps_ == nullptr && this->height_ == nullptr && this->streams_ == nullptr && this->width_ == nullptr; };
          // bitrate Field Functions 
          bool hasBitrate() const { return this->bitrate_ != nullptr;};
          void deleteBitrate() { this->bitrate_ = nullptr;};
          inline string getBitrate() const { DARABONBA_PTR_GET_DEFAULT(bitrate_, "") };
      ...
      inline const vector<MediaInfoJobList::MediaInfoJob> & getMediaInfoJob() const { DARABONBA_PTR_GET_CONST(mediaInfoJob_, vector<MediaInfoJobList::MediaInfoJob>) };
      inline vector<MediaInfoJobList::MediaInfoJob> getMediaInfoJob() { DARABONBA_PTR_GET(mediaInfoJob_, vector<MediaInfoJobList::MediaInfoJob>) };
      inline MediaInfoJobList& setMediaInfoJob(const vector<MediaInfoJobList::MediaInfoJob> & mediaInfoJob) { DARABONBA_PTR_SET_VALUE(mediaInfoJob_, mediaInfoJob) };
      inline MediaInfoJobList& setMediaInfoJob(vector<MediaInfoJobList::MediaInfoJob> && mediaInfoJob) { DARABONBA_PTR_SET_RVALUE(mediaInfoJob_, mediaInfoJob) };


    protected:
      shared_ptr<vector<MediaInfoJobList::MediaInfoJob>> mediaInfoJob_ {};
    };

    virtual bool empty() const override { return this->mediaInfoJobList_ == nullptr
        && this->nonExistMediaInfoJobIds_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline const QueryMediaInfoJobListResponseBody::MediaInfoJobList & getMediaInfoJobList() const { DARABONBA_PTR_GET_CONST(mediaInfoJobList_, QueryMediaInfoJobListResponseBody::MediaInfoJobList) };
    inline QueryMediaInfoJobListResponseBody::MediaInfoJobList getMediaInfoJobList() { DARABONBA_PTR_GET(mediaInfoJobList_, QueryMediaInfoJobListResponseBody::MediaInfoJobList) };
    inline QueryMediaInfoJobListResponseBody& setMediaInfoJobList(const QueryMediaInfoJobListResponseBody::MediaInfoJobList & mediaInfoJobList) { DARABONBA_PTR_SET_VALUE(mediaInfoJobList_, mediaInfoJobList) };
    inline QueryMediaInfoJobListResponseBody& setMediaInfoJobList(QueryMediaInfoJobListResponseBody::MediaInfoJobList && mediaInfoJobList) { DARABONBA_PTR_SET_RVALUE(mediaInfoJobList_, mediaInfoJobList) };
    ...
    inline const QueryMediaInfoJobListResponseBody::NonExistMediaInfoJobIds & getNonExistMediaInfoJobIds() const { DARABONBA_PTR_GET_CONST(nonExistMediaInfoJobIds_, QueryMediaInfoJobListResponseBody::NonExistMediaInfoJobIds) };
    inline QueryMediaInfoJobListResponseBody::NonExistMediaInfoJobIds getNonExistMediaInfoJobIds() { DARABONBA_PTR_GET(nonExistMediaInfoJobIds_, QueryMediaInfoJobListResponseBody::NonExistMediaInfoJobIds) };
    inline QueryMediaInfoJobListResponseBody& setNonExistMediaInfoJobIds(const QueryMediaInfoJobListResponseBody::NonExistMediaInfoJobIds & nonExistMediaInfoJobIds) { DARABONBA_PTR_SET_VALUE(nonExistMediaInfoJobIds_, nonExistMediaInfoJobIds) };
    inline QueryMediaInfoJobListResponseBody& setNonExistMediaInfoJobIds(QueryMediaInfoJobListResponseBody::NonExistMediaInfoJobIds && nonExistMediaInfoJobIds) { DARABONBA_PTR_SET_RVALUE(nonExistMediaInfoJobIds_, nonExistMediaInfoJobIds) };
  ...
  protected:
    shared_ptr<QueryMediaInfoJobListResponseBody::MediaInfoJobList> mediaInfoJobList_ {};
    shared_ptr<QueryMediaInfoJobListResponseBody::NonExistMediaInfoJobIds> nonExistMediaInfoJobIds_ {};
