...
#ifndef ALIBABACLOUD_MODELS_ADDTEMPLATERESPONSEBODYTEMPLATEAUDIOVOLUME_HPP_
#define ALIBABACLOUD_MODELS_ADDTEMPLATERESPONSEBODYTEMPLATEAUDIOVOLUME_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddTemplateResponseBodyTemplateAudioVolume& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddTemplateResponseBodyTemplateAudioVolume& obj) { 
    ...
    AddTemplateResponseBodyTemplateAudioVolume() = default ;
    AddTemplateResponseBodyTemplateAudioVolume(const AddTemplateResponseBodyTemplateAudioVolume &) = default ;
    AddTemplateResponseBodyTemplateAudioVolume(AddTemplateResponseBodyTemplateAudioVolume &&) = default ;
    AddTemplateResponseBodyTemplateAudioVolume(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddTemplateResponseBodyTemplateAudioVolume() = default ;
    AddTemplateResponseBodyTemplateAudioVolume& operator=(const AddTemplateResponseBodyTemplateAudioVolume &) = default ;
    AddTemplateResponseBodyTemplateAudioVolume& operator=(AddTemplateResponseBodyTemplateAudioVolume &&) = default ;
    ...
    inline AddTemplateResponseBodyTemplateAudioVolume& setIntegratedLoudnessTarget(string integratedLoudnessTarget) { DARABONBA_PTR_SET_VALUE(integratedLoudnessTarget_, integratedLoudnessTarget) };
    ...
    inline AddTemplateResponseBodyTemplateAudioVolume& setLevel(string level) { DARABONBA_PTR_SET_VALUE(level_, level) };
    ...
    inline AddTemplateResponseBodyTemplateAudioVolume& setLoudnessRangeTarget(string loudnessRangeTarget) { DARABONBA_PTR_SET_VALUE(loudnessRangeTarget_, loudnessRangeTarget) };
    ...
    inline AddTemplateResponseBodyTemplateAudioVolume& setMethod(string method) { DARABONBA_PTR_SET_VALUE(method_, method) };
    ...
    inline AddTemplateResponseBodyTemplateAudioVolume& setPeakLevel(string peakLevel) { DARABONBA_PTR_SET_VALUE(peakLevel_, peakLevel) };
    ...
    inline AddTemplateResponseBodyTemplateAudioVolume& setTruePeak(string truePeak) { DARABONBA_PTR_SET_VALUE(truePeak_, truePeak) };
