...
#ifndef ALIBABACLOUD_MODELS_QUERYJOBLISTRESPONSEBODYJOBLISTJOBOUTPUTTAILSLATELISTTAILSLATE_HPP_
#define ALIBABACLOUD_MODELS_QUERYJOBLISTRESPONSEBODYJOBLISTJOBOUTPUTTAILSLATELISTTAILSLATE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate& obj) { 
    ...
    QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate() = default ;
    QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate(const QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate &) = default ;
    QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate(QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate &&) = default ;
    QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate() = default ;
    QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate& operator=(const QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate &) = default ;
    QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate& operator=(QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate &&) = default ;
    ...
    inline QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate& setBgColor(string bgColor) { DARABONBA_PTR_SET_VALUE(bgColor_, bgColor) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate& setBlendDuration(string blendDuration) { DARABONBA_PTR_SET_VALUE(blendDuration_, blendDuration) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate& setHeight(string height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate& setIsMergeAudio(bool isMergeAudio) { DARABONBA_PTR_SET_VALUE(isMergeAudio_, isMergeAudio) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate& setStart(string start) { DARABONBA_PTR_SET_VALUE(start_, start) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate& setTailUrl(string tailUrl) { DARABONBA_PTR_SET_VALUE(tailUrl_, tailUrl) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTailSlateListTailSlate& setWidth(string width) { DARABONBA_PTR_SET_VALUE(width_, width) };
