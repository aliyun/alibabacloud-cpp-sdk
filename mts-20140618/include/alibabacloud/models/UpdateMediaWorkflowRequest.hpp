...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->mediaWorkflowId_ == nullptr
        && this->name_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr
        && this->topology_ == nullptr && this->triggerMode_ == nullptr; };
