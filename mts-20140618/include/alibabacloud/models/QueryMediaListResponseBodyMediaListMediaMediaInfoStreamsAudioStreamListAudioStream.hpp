...
#ifndef ALIBABACLOUD_MODELS_QUERYMEDIALISTRESPONSEBODYMEDIALISTMEDIAMEDIAINFOSTREAMSAUDIOSTREAMLISTAUDIOSTREAM_HPP_
#define ALIBABACLOUD_MODELS_QUERYMEDIALISTRESPONSEBODYMEDIALISTMEDIAMEDIAINFOSTREAMSAUDIOSTREAMLISTAUDIOSTREAM_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& obj) { 
    ...
    QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream() = default ;
    QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream(const QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream &) = default ;
    QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream(QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream &&) = default ;
    QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream() = default ;
    QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& operator=(const QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream &) = default ;
    QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& operator=(QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream &&) = default ;
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setBitrate(string bitrate) { DARABONBA_PTR_SET_VALUE(bitrate_, bitrate) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setChannelLayout(string channelLayout) { DARABONBA_PTR_SET_VALUE(channelLayout_, channelLayout) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setChannels(string channels) { DARABONBA_PTR_SET_VALUE(channels_, channels) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setCodecLongName(string codecLongName) { DARABONBA_PTR_SET_VALUE(codecLongName_, codecLongName) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setCodecName(string codecName) { DARABONBA_PTR_SET_VALUE(codecName_, codecName) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setCodecTag(string codecTag) { DARABONBA_PTR_SET_VALUE(codecTag_, codecTag) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setCodecTagString(string codecTagString) { DARABONBA_PTR_SET_VALUE(codecTagString_, codecTagString) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setCodecTimeBase(string codecTimeBase) { DARABONBA_PTR_SET_VALUE(codecTimeBase_, codecTimeBase) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setIndex(string index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setNumFrames(string numFrames) { DARABONBA_PTR_SET_VALUE(numFrames_, numFrames) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setSampleFmt(string sampleFmt) { DARABONBA_PTR_SET_VALUE(sampleFmt_, sampleFmt) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setSamplerate(string samplerate) { DARABONBA_PTR_SET_VALUE(samplerate_, samplerate) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline QueryMediaListResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream& setTimebase(string timebase) { DARABONBA_PTR_SET_VALUE(timebase_, timebase) };
