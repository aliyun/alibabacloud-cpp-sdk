...
#ifndef ALIBABACLOUD_MODELS_LISTJOBRESPONSEBODYJOBLISTJOBOUTPUTTRANSCONFIG_HPP_
#define ALIBABACLOUD_MODELS_LISTJOBRESPONSEBODYJOBLISTJOBOUTPUTTRANSCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListJobResponseBodyJobListJobOutputTransConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListJobResponseBodyJobListJobOutputTransConfig& obj) { 
    ...
    ListJobResponseBodyJobListJobOutputTransConfig() = default ;
    ListJobResponseBodyJobListJobOutputTransConfig(const ListJobResponseBodyJobListJobOutputTransConfig &) = default ;
    ListJobResponseBodyJobListJobOutputTransConfig(ListJobResponseBodyJobListJobOutputTransConfig &&) = default ;
    ListJobResponseBodyJobListJobOutputTransConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListJobResponseBodyJobListJobOutputTransConfig() = default ;
    ListJobResponseBodyJobListJobOutputTransConfig& operator=(const ListJobResponseBodyJobListJobOutputTransConfig &) = default ;
    ListJobResponseBodyJobListJobOutputTransConfig& operator=(ListJobResponseBodyJobListJobOutputTransConfig &&) = default ;
    ...
    inline ListJobResponseBodyJobListJobOutputTransConfig& setAdjDarMethod(string adjDarMethod) { DARABONBA_PTR_SET_VALUE(adjDarMethod_, adjDarMethod) };
    ...
    inline ListJobResponseBodyJobListJobOutputTransConfig& setIsCheckAudioBitrate(string isCheckAudioBitrate) { DARABONBA_PTR_SET_VALUE(isCheckAudioBitrate_, isCheckAudioBitrate) };
    ...
    inline ListJobResponseBodyJobListJobOutputTransConfig& setIsCheckAudioBitrateFail(string isCheckAudioBitrateFail) { DARABONBA_PTR_SET_VALUE(isCheckAudioBitrateFail_, isCheckAudioBitrateFail) };
    ...
    inline ListJobResponseBodyJobListJobOutputTransConfig& setIsCheckReso(string isCheckReso) { DARABONBA_PTR_SET_VALUE(isCheckReso_, isCheckReso) };
    ...
    inline ListJobResponseBodyJobListJobOutputTransConfig& setIsCheckResoFail(string isCheckResoFail) { DARABONBA_PTR_SET_VALUE(isCheckResoFail_, isCheckResoFail) };
    ...
    inline ListJobResponseBodyJobListJobOutputTransConfig& setIsCheckVideoBitrate(string isCheckVideoBitrate) { DARABONBA_PTR_SET_VALUE(isCheckVideoBitrate_, isCheckVideoBitrate) };
    ...
    inline ListJobResponseBodyJobListJobOutputTransConfig& setIsCheckVideoBitrateFail(string isCheckVideoBitrateFail) { DARABONBA_PTR_SET_VALUE(isCheckVideoBitrateFail_, isCheckVideoBitrateFail) };
    ...
    inline ListJobResponseBodyJobListJobOutputTransConfig& setTransMode(string transMode) { DARABONBA_PTR_SET_VALUE(transMode_, transMode) };
