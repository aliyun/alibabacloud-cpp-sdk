...
#ifndef ALIBABACLOUD_MODELS_LISTJOBRESPONSEBODYJOBLISTJOBOUTPUTTAILSLATELISTTAILSLATE_HPP_
#define ALIBABACLOUD_MODELS_LISTJOBRESPONSEBODYJOBLISTJOBOUTPUTTAILSLATELISTTAILSLATE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListJobResponseBodyJobListJobOutputTailSlateListTailSlate& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListJobResponseBodyJobListJobOutputTailSlateListTailSlate& obj) { 
    ...
    ListJobResponseBodyJobListJobOutputTailSlateListTailSlate() = default ;
    ListJobResponseBodyJobListJobOutputTailSlateListTailSlate(const ListJobResponseBodyJobListJobOutputTailSlateListTailSlate &) = default ;
    ListJobResponseBodyJobListJobOutputTailSlateListTailSlate(ListJobResponseBodyJobListJobOutputTailSlateListTailSlate &&) = default ;
    ListJobResponseBodyJobListJobOutputTailSlateListTailSlate(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListJobResponseBodyJobListJobOutputTailSlateListTailSlate() = default ;
    ListJobResponseBodyJobListJobOutputTailSlateListTailSlate& operator=(const ListJobResponseBodyJobListJobOutputTailSlateListTailSlate &) = default ;
    ListJobResponseBodyJobListJobOutputTailSlateListTailSlate& operator=(ListJobResponseBodyJobListJobOutputTailSlateListTailSlate &&) = default ;
    ...
    inline ListJobResponseBodyJobListJobOutputTailSlateListTailSlate& setBgColor(string bgColor) { DARABONBA_PTR_SET_VALUE(bgColor_, bgColor) };
    ...
    inline ListJobResponseBodyJobListJobOutputTailSlateListTailSlate& setBlendDuration(string blendDuration) { DARABONBA_PTR_SET_VALUE(blendDuration_, blendDuration) };
    ...
    inline ListJobResponseBodyJobListJobOutputTailSlateListTailSlate& setHeight(string height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline ListJobResponseBodyJobListJobOutputTailSlateListTailSlate& setIsMergeAudio(bool isMergeAudio) { DARABONBA_PTR_SET_VALUE(isMergeAudio_, isMergeAudio) };
    ...
    inline ListJobResponseBodyJobListJobOutputTailSlateListTailSlate& setStart(string start) { DARABONBA_PTR_SET_VALUE(start_, start) };
    ...
    inline ListJobResponseBodyJobListJobOutputTailSlateListTailSlate& setTailUrl(string tailUrl) { DARABONBA_PTR_SET_VALUE(tailUrl_, tailUrl) };
    ...
    inline ListJobResponseBodyJobListJobOutputTailSlateListTailSlate& setWidth(string width) { DARABONBA_PTR_SET_VALUE(width_, width) };
