...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitTraceM3u8JobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitTraceM3u8JobResponseBody) };
    inline SubmitTraceM3u8JobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitTraceM3u8JobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitTraceM3u8JobResponseBody> body_ {};
  };
