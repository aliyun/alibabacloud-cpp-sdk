...
namespace Models
{
  ...
  public:
    ...
    class NonExistFileURLs : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const NonExistFileURLs& obj) { 
        DARABONBA_PTR_TO_JSON(FileURL, fileURL_);
      };
      friend void from_json(const Darabonba::Json& j, NonExistFileURLs& obj) { 
        DARABONBA_PTR_FROM_JSON(FileURL, fileURL_);
      };
      NonExistFileURLs() = default ;
      NonExistFileURLs(const NonExistFileURLs &) = default ;
      NonExistFileURLs(NonExistFileURLs &&) = default ;
      NonExistFileURLs(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~NonExistFileURLs() = default ;
      NonExistFileURLs& operator=(const NonExistFileURLs &) = default ;
      NonExistFileURLs& operator=(NonExistFileURLs &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline NonExistFileURLs& setFileURL(const vector<string> & fileURL) { DARABONBA_PTR_SET_VALUE(fileURL_, fileURL) };
      inline NonExistFileURLs& setFileURL(vector<string> && fileURL) { DARABONBA_PTR_SET_RVALUE(fileURL_, fileURL) };
    ...
    virtual bool empty() const override { return this->mediaList_ == nullptr
        && this->nonExistFileURLs_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline const QueryMediaListByURLResponseBody::MediaList & getMediaList() const { DARABONBA_PTR_GET_CONST(mediaList_, QueryMediaListByURLResponseBody::MediaList) };
    inline QueryMediaListByURLResponseBody::MediaList getMediaList() { DARABONBA_PTR_GET(mediaList_, QueryMediaListByURLResponseBody::MediaList) };
    inline QueryMediaListByURLResponseBody& setMediaList(const QueryMediaListByURLResponseBody::MediaList & mediaList) { DARABONBA_PTR_SET_VALUE(mediaList_, mediaList) };
    inline QueryMediaListByURLResponseBody& setMediaList(QueryMediaListByURLResponseBody::MediaList && mediaList) { DARABONBA_PTR_SET_RVALUE(mediaList_, mediaList) };
    ...
    inline const QueryMediaListByURLResponseBody::NonExistFileURLs & getNonExistFileURLs() const { DARABONBA_PTR_GET_CONST(nonExistFileURLs_, QueryMediaListByURLResponseBody::NonExistFileURLs) };
    inline QueryMediaListByURLResponseBody::NonExistFileURLs getNonExistFileURLs() { DARABONBA_PTR_GET(nonExistFileURLs_, QueryMediaListByURLResponseBody::NonExistFileURLs) };
    inline QueryMediaListByURLResponseBody& setNonExistFileURLs(const QueryMediaListByURLResponseBody::NonExistFileURLs & nonExistFileURLs) { DARABONBA_PTR_SET_VALUE(nonExistFileURLs_, nonExistFileURLs) };
    inline QueryMediaListByURLResponseBody& setNonExistFileURLs(QueryMediaListByURLResponseBody::NonExistFileURLs && nonExistFileURLs) { DARABONBA_PTR_SET_RVALUE(nonExistFileURLs_, nonExistFileURLs) };
  ...
  protected:
    shared_ptr<QueryMediaListByURLResponseBody::MediaList> mediaList_ {};
    shared_ptr<QueryMediaListByURLResponseBody::NonExistFileURLs> nonExistFileURLs_ {};
