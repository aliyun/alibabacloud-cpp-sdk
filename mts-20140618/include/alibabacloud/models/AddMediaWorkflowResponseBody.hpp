...
#ifndef ALIBABACLOUD_MODELS_ADDMEDIAWORKFLOWRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ADDMEDIAWORKFLOWRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddMediaWorkflowResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(MediaWorkflow, mediaWorkflow_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, AddMediaWorkflowResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(MediaWorkflow, mediaWorkflow_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    AddMediaWorkflowResponseBody() = default ;
    AddMediaWorkflowResponseBody(const AddMediaWorkflowResponseBody &) = default ;
    AddMediaWorkflowResponseBody(AddMediaWorkflowResponseBody &&) = default ;
    AddMediaWorkflowResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddMediaWorkflowResponseBody() = default ;
    AddMediaWorkflowResponseBody& operator=(const AddMediaWorkflowResponseBody &) = default ;
    AddMediaWorkflowResponseBody& operator=(AddMediaWorkflowResponseBody &&) = default ;
    ...
    inline const AddMediaWorkflowResponseBody::MediaWorkflow & getMediaWorkflow() const { DARABONBA_PTR_GET_CONST(mediaWorkflow_, AddMediaWorkflowResponseBody::MediaWorkflow) };
    inline AddMediaWorkflowResponseBody::MediaWorkflow getMediaWorkflow() { DARABONBA_PTR_GET(mediaWorkflow_, AddMediaWorkflowResponseBody::MediaWorkflow) };
    inline AddMediaWorkflowResponseBody& setMediaWorkflow(const AddMediaWorkflowResponseBody::MediaWorkflow & mediaWorkflow) { DARABONBA_PTR_SET_VALUE(mediaWorkflow_, mediaWorkflow) };
    inline AddMediaWorkflowResponseBody& setMediaWorkflow(AddMediaWorkflowResponseBody::MediaWorkflow && mediaWorkflow) { DARABONBA_PTR_SET_RVALUE(mediaWorkflow_, mediaWorkflow) };
    ...
    inline AddMediaWorkflowResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The information about the media workflow.
    shared_ptr<AddMediaWorkflowResponseBody::MediaWorkflow> mediaWorkflow_ {};
    // The request ID.
