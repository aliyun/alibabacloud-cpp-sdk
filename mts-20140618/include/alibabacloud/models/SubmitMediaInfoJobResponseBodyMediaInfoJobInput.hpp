...
namespace Models
{
  ...
  public:
    ...
    inline SubmitMediaInfoJobResponseBodyMediaInfoJobInput& setBucket(string bucket) { DARABONBA_PTR_SET_VALUE(bucket_, bucket) };
    ...
    inline SubmitMediaInfoJobResponseBodyMediaInfoJobInput& setLocation(string location) { DARABONBA_PTR_SET_VALUE(location_, location) };
    ...
    inline SubmitMediaInfoJobResponseBodyMediaInfoJobInput& setObject(string object) { DARABONBA_PTR_SET_VALUE(object_, object) };
