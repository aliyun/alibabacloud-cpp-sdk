...
namespace Models
{
  ...
  public:
    ...
    class NonExistTids : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const NonExistTids& obj) { 
        DARABONBA_PTR_TO_JSON(String, string_);
      };
      friend void from_json(const Darabonba::Json& j, NonExistTids& obj) { 
        DARABONBA_PTR_FROM_JSON(String, string_);
      };
      NonExistTids() = default ;
      NonExistTids(const NonExistTids &) = default ;
      NonExistTids(NonExistTids &&) = default ;
      NonExistTids(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~NonExistTids() = default ;
      NonExistTids& operator=(const NonExistTids &) = default ;
      NonExistTids& operator=(NonExistTids &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline NonExistTids& setString(const vector<string> & string) { DARABONBA_PTR_SET_VALUE(string_, string) };
      inline NonExistTids& setString(vector<string> && string) { DARABONBA_PTR_SET_RVALUE(string_, string) };
    ...
    inline const QueryTemplateListResponseBody::NonExistTids & getNonExistTids() const { DARABONBA_PTR_GET_CONST(nonExistTids_, QueryTemplateListResponseBody::NonExistTids) };
    inline QueryTemplateListResponseBody::NonExistTids getNonExistTids() { DARABONBA_PTR_GET(nonExistTids_, QueryTemplateListResponseBody::NonExistTids) };
    inline QueryTemplateListResponseBody& setNonExistTids(const QueryTemplateListResponseBody::NonExistTids & nonExistTids) { DARABONBA_PTR_SET_VALUE(nonExistTids_, nonExistTids) };
    inline QueryTemplateListResponseBody& setNonExistTids(QueryTemplateListResponseBody::NonExistTids && nonExistTids) { DARABONBA_PTR_SET_RVALUE(nonExistTids_, nonExistTids) };
    ...
    inline const QueryTemplateListResponseBody::TemplateList & getTemplateList() const { DARABONBA_PTR_GET_CONST(templateList_, QueryTemplateListResponseBody::TemplateList) };
    inline QueryTemplateListResponseBody::TemplateList getTemplateList() { DARABONBA_PTR_GET(templateList_, QueryTemplateListResponseBody::TemplateList) };
    inline QueryTemplateListResponseBody& setTemplateList(const QueryTemplateListResponseBody::TemplateList & templateList) { DARABONBA_PTR_SET_VALUE(templateList_, templateList) };
    inline QueryTemplateListResponseBody& setTemplateList(QueryTemplateListResponseBody::TemplateList && templateList) { DARABONBA_PTR_SET_RVALUE(templateList_, templateList) };


  protected:
    shared_ptr<QueryTemplateListResponseBody::NonExistTids> nonExistTids_ {};
    // The ID of the request.
    shared_ptr<string> requestId_ {};
    shared_ptr<QueryTemplateListResponseBody::TemplateList> templateList_ {};
  };
