...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->analysisConfig_ == nullptr
        && this->input_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->pipelineId_ == nullptr && this->priority_ == nullptr
    ...
    inline string getAnalysisConfig() const { DARABONBA_PTR_GET_DEFAULT(analysisConfig_, "") };
  ...
  protected:
    ...
    shared_ptr<string> analysisConfig_ {};
