...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMediaWorkflowTriggerModeResponseBodyMediaWorkflow & mediaWorkflow() const { DARABONBA_PTR_GET_CONST(mediaWorkflow_, UpdateMediaWorkflowTriggerModeResponseBodyMediaWorkflow) };
    inline UpdateMediaWorkflowTriggerModeResponseBodyMediaWorkflow mediaWorkflow() { DARABONBA_PTR_GET(mediaWorkflow_, UpdateMediaWorkflowTriggerModeResponseBodyMediaWorkflow) };
    inline UpdateMediaWorkflowTriggerModeResponseBody& setMediaWorkflow(const UpdateMediaWorkflowTriggerModeResponseBodyMediaWorkflow & mediaWorkflow) { DARABONBA_PTR_SET_VALUE(mediaWorkflow_, mediaWorkflow) };
    inline UpdateMediaWorkflowTriggerModeResponseBody& setMediaWorkflow(UpdateMediaWorkflowTriggerModeResponseBodyMediaWorkflow && mediaWorkflow) { DARABONBA_PTR_SET_RVALUE(mediaWorkflow_, mediaWorkflow) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateMediaWorkflowTriggerModeResponseBodyMediaWorkflow> mediaWorkflow_ = nullptr;
