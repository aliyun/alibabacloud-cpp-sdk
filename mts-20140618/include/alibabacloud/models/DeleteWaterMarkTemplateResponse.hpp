...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWaterMarkTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWaterMarkTemplateResponseBody) };
    inline DeleteWaterMarkTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWaterMarkTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWaterMarkTemplateResponseBody> body_ {};
  };
