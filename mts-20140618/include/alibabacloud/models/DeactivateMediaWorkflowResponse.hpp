...
namespace Models
{
  ...
  public:
    ...
    inline const DeactivateMediaWorkflowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeactivateMediaWorkflowResponseBody) };
    inline DeactivateMediaWorkflowResponseBody getBody() { DARABONBA_PTR_GET(body_, DeactivateMediaWorkflowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeactivateMediaWorkflowResponseBody> body_ {};
  };
