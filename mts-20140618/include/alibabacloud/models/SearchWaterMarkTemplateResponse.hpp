...
namespace Models
{
  ...
  public:
    ...
    inline const SearchWaterMarkTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchWaterMarkTemplateResponseBody) };
    inline SearchWaterMarkTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchWaterMarkTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchWaterMarkTemplateResponseBody> body_ {};
  };
