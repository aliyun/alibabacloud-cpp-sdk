...
namespace Models
{
  ...
  public:
    ...
    inline SubmitMediaInfoJobResponseBodyMediaInfoJob& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline SubmitMediaInfoJobResponseBodyMediaInfoJob& setCreationTime(string creationTime) { DARABONBA_PTR_SET_VALUE(creationTime_, creationTime) };
    ...
    inline const Models::SubmitMediaInfoJobResponseBodyMediaInfoJobMNSMessageResult & MNSMessageResult() const { DARABONBA_PTR_GET_CONST(MNSMessageResult_, Models::SubmitMediaInfoJobResponseBodyMediaInfoJobMNSMessageResult) };
    inline Models::SubmitMediaInfoJobResponseBodyMediaInfoJobMNSMessageResult MNSMessageResult() { DARABONBA_PTR_GET(MNSMessageResult_, Models::SubmitMediaInfoJobResponseBodyMediaInfoJobMNSMessageResult) };
    inline SubmitMediaInfoJobResponseBodyMediaInfoJob& setMNSMessageResult(const Models::SubmitMediaInfoJobResponseBodyMediaInfoJobMNSMessageResult & MNSMessageResult) { DARABONBA_PTR_SET_VALUE(MNSMessageResult_, MNSMessageResult) };
    inline SubmitMediaInfoJobResponseBodyMediaInfoJob& setMNSMessageResult(Models::SubmitMediaInfoJobResponseBodyMediaInfoJobMNSMessageResult && MNSMessageResult) { DARABONBA_PTR_SET_RVALUE(MNSMessageResult_, MNSMessageResult) };
    ...
    inline SubmitMediaInfoJobResponseBodyMediaInfoJob& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline SubmitMediaInfoJobResponseBodyMediaInfoJob& setPipelineId(string pipelineId) { DARABONBA_PTR_SET_VALUE(pipelineId_, pipelineId) };


    // properties Field Functions 
    bool hasProperties() const { return this->properties_ != nullptr;};
    void deleteProperties() { this->properties_ = nullptr;};
    inline const Models::SubmitMediaInfoJobResponseBodyMediaInfoJobProperties & properties() const { DARABONBA_PTR_GET_CONST(properties_, Models::SubmitMediaInfoJobResponseBodyMediaInfoJobProperties) };
    inline Models::SubmitMediaInfoJobResponseBodyMediaInfoJobProperties properties() { DARABONBA_PTR_GET(properties_, Models::SubmitMediaInfoJobResponseBodyMediaInfoJobProperties) };
    inline SubmitMediaInfoJobResponseBodyMediaInfoJob& setProperties(const Models::SubmitMediaInfoJobResponseBodyMediaInfoJobProperties & properties) { DARABONBA_PTR_SET_VALUE(properties_, properties) };
    inline SubmitMediaInfoJobResponseBodyMediaInfoJob& setProperties(Models::SubmitMediaInfoJobResponseBodyMediaInfoJobProperties && properties) { DARABONBA_PTR_SET_RVALUE(properties_, properties) };
    ...
    inline SubmitMediaInfoJobResponseBodyMediaInfoJob& setState(string state) { DARABONBA_PTR_SET_VALUE(state_, state) };
  ...
  protected:
    ...
    std::shared_ptr<Models::SubmitMediaInfoJobResponseBodyMediaInfoJobMNSMessageResult> MNSMessageResult_ = nullptr;
    ...
    std::shared_ptr<Models::SubmitMediaInfoJobResponseBodyMediaInfoJobProperties> properties_ = nullptr;
