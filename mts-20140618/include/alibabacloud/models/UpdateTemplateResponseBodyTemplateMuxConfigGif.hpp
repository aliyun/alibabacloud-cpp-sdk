...
#ifndef ALIBABACLOUD_MODELS_UPDATETEMPLATERESPONSEBODYTEMPLATEMUXCONFIGGIF_HPP_
#define ALIBABACLOUD_MODELS_UPDATETEMPLATERESPONSEBODYTEMPLATEMUXCONFIGGIF_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateTemplateResponseBodyTemplateMuxConfigGif& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateTemplateResponseBodyTemplateMuxConfigGif& obj) { 
    ...
    UpdateTemplateResponseBodyTemplateMuxConfigGif() = default ;
    UpdateTemplateResponseBodyTemplateMuxConfigGif(const UpdateTemplateResponseBodyTemplateMuxConfigGif &) = default ;
    UpdateTemplateResponseBodyTemplateMuxConfigGif(UpdateTemplateResponseBodyTemplateMuxConfigGif &&) = default ;
    UpdateTemplateResponseBodyTemplateMuxConfigGif(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateTemplateResponseBodyTemplateMuxConfigGif() = default ;
    UpdateTemplateResponseBodyTemplateMuxConfigGif& operator=(const UpdateTemplateResponseBodyTemplateMuxConfigGif &) = default ;
    UpdateTemplateResponseBodyTemplateMuxConfigGif& operator=(UpdateTemplateResponseBodyTemplateMuxConfigGif &&) = default ;
    ...
    inline UpdateTemplateResponseBodyTemplateMuxConfigGif& setDitherMode(string ditherMode) { DARABONBA_PTR_SET_VALUE(ditherMode_, ditherMode) };
    ...
    inline UpdateTemplateResponseBodyTemplateMuxConfigGif& setFinalDelay(string finalDelay) { DARABONBA_PTR_SET_VALUE(finalDelay_, finalDelay) };
    ...
    inline UpdateTemplateResponseBodyTemplateMuxConfigGif& setIsCustomPalette(string isCustomPalette) { DARABONBA_PTR_SET_VALUE(isCustomPalette_, isCustomPalette) };
    ...
    inline UpdateTemplateResponseBodyTemplateMuxConfigGif& setLoop(string loop) { DARABONBA_PTR_SET_VALUE(loop_, loop) };
