...
namespace Models
{
  ...
  public:
    ...
    inline const QueryFpShotJobListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryFpShotJobListResponseBody) };
    inline QueryFpShotJobListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryFpShotJobListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryFpShotJobListResponseBody> body_ {};
  };
