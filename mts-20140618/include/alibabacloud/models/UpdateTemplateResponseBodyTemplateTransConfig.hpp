...
#ifndef ALIBABACLOUD_MODELS_UPDATETEMPLATERESPONSEBODYTEMPLATETRANSCONFIG_HPP_
#define ALIBABACLOUD_MODELS_UPDATETEMPLATERESPONSEBODYTEMPLATETRANSCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateTemplateResponseBodyTemplateTransConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateTemplateResponseBodyTemplateTransConfig& obj) { 
    ...
    UpdateTemplateResponseBodyTemplateTransConfig() = default ;
    UpdateTemplateResponseBodyTemplateTransConfig(const UpdateTemplateResponseBodyTemplateTransConfig &) = default ;
    UpdateTemplateResponseBodyTemplateTransConfig(UpdateTemplateResponseBodyTemplateTransConfig &&) = default ;
    UpdateTemplateResponseBodyTemplateTransConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateTemplateResponseBodyTemplateTransConfig() = default ;
    UpdateTemplateResponseBodyTemplateTransConfig& operator=(const UpdateTemplateResponseBodyTemplateTransConfig &) = default ;
    UpdateTemplateResponseBodyTemplateTransConfig& operator=(UpdateTemplateResponseBodyTemplateTransConfig &&) = default ;
    ...
    inline UpdateTemplateResponseBodyTemplateTransConfig& setAdjDarMethod(string adjDarMethod) { DARABONBA_PTR_SET_VALUE(adjDarMethod_, adjDarMethod) };
    ...
    inline UpdateTemplateResponseBodyTemplateTransConfig& setIsCheckAudioBitrate(string isCheckAudioBitrate) { DARABONBA_PTR_SET_VALUE(isCheckAudioBitrate_, isCheckAudioBitrate) };
    ...
    inline UpdateTemplateResponseBodyTemplateTransConfig& setIsCheckAudioBitrateFail(string isCheckAudioBitrateFail) { DARABONBA_PTR_SET_VALUE(isCheckAudioBitrateFail_, isCheckAudioBitrateFail) };
    ...
    inline UpdateTemplateResponseBodyTemplateTransConfig& setIsCheckReso(string isCheckReso) { DARABONBA_PTR_SET_VALUE(isCheckReso_, isCheckReso) };
    ...
    inline UpdateTemplateResponseBodyTemplateTransConfig& setIsCheckResoFail(string isCheckResoFail) { DARABONBA_PTR_SET_VALUE(isCheckResoFail_, isCheckResoFail) };
    ...
    inline UpdateTemplateResponseBodyTemplateTransConfig& setIsCheckVideoBitrate(string isCheckVideoBitrate) { DARABONBA_PTR_SET_VALUE(isCheckVideoBitrate_, isCheckVideoBitrate) };
    ...
    inline UpdateTemplateResponseBodyTemplateTransConfig& setIsCheckVideoBitrateFail(string isCheckVideoBitrateFail) { DARABONBA_PTR_SET_VALUE(isCheckVideoBitrateFail_, isCheckVideoBitrateFail) };
    ...
    inline UpdateTemplateResponseBodyTemplateTransConfig& setTransMode(string transMode) { DARABONBA_PTR_SET_VALUE(transMode_, transMode) };
