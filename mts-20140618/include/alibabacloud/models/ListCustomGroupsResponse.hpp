...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCustomGroupsResponseBody) };
    inline ListCustomGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCustomGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCustomGroupsResponseBody> body_ {};
  };
