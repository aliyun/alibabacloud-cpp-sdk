...
namespace Models
{
  ...
  public:
    ...
    inline const QueryJobListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryJobListResponseBody) };
    inline QueryJobListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryJobListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryJobListResponseBody> body_ {};
  };
