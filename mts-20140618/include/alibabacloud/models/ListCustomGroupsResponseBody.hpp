...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomGroupsResponseBodyCustomGroups & customGroups() const { DARABONBA_PTR_GET_CONST(customGroups_, ListCustomGroupsResponseBodyCustomGroups) };
    inline ListCustomGroupsResponseBodyCustomGroups customGroups() { DARABONBA_PTR_GET(customGroups_, ListCustomGroupsResponseBodyCustomGroups) };
    inline ListCustomGroupsResponseBody& setCustomGroups(const ListCustomGroupsResponseBodyCustomGroups & customGroups) { DARABONBA_PTR_SET_VALUE(customGroups_, customGroups) };
    inline ListCustomGroupsResponseBody& setCustomGroups(ListCustomGroupsResponseBodyCustomGroups && customGroups) { DARABONBA_PTR_SET_RVALUE(customGroups_, customGroups) };
  ...
  protected:
    std::shared_ptr<ListCustomGroupsResponseBodyCustomGroups> customGroups_ = nullptr;
