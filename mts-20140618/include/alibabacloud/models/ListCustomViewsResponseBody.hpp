...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomViewsResponseBodyCustomViews & customViews() const { DARABONBA_PTR_GET_CONST(customViews_, ListCustomViewsResponseBodyCustomViews) };
    inline ListCustomViewsResponseBodyCustomViews customViews() { DARABONBA_PTR_GET(customViews_, ListCustomViewsResponseBodyCustomViews) };
    inline ListCustomViewsResponseBody& setCustomViews(const ListCustomViewsResponseBodyCustomViews & customViews) { DARABONBA_PTR_SET_VALUE(customViews_, customViews) };
    inline ListCustomViewsResponseBody& setCustomViews(ListCustomViewsResponseBodyCustomViews && customViews) { DARABONBA_PTR_SET_RVALUE(customViews_, customViews) };
  ...
  protected:
    std::shared_ptr<ListCustomViewsResponseBodyCustomViews> customViews_ = nullptr;
