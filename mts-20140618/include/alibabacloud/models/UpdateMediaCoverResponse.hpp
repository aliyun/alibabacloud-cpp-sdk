...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMediaCoverResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateMediaCoverResponseBody) };
    inline UpdateMediaCoverResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateMediaCoverResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateMediaCoverResponseBody> body_ {};
  };
