...
#ifndef ALIBABACLOUD_MODELS_ADDWATERMARKTEMPLATERESPONSEBODYWATERMARKTEMPLATERATIOREFER_HPP_
#define ALIBABACLOUD_MODELS_ADDWATERMARKTEMPLATERESPONSEBODYWATERMARKTEMPLATERATIOREFER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer& obj) { 
      DARABONBA_PTR_TO_JSON(Dx, dx_);
      DARABONBA_PTR_TO_JSON(Dy, dy_);
      DARABONBA_PTR_TO_JSON(Height, height_);
      DARABONBA_PTR_TO_JSON(Width, width_);
    };
    friend void from_json(const Darabonba::Json& j, AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer& obj) { 
      DARABONBA_PTR_FROM_JSON(Dx, dx_);
      DARABONBA_PTR_FROM_JSON(Dy, dy_);
      DARABONBA_PTR_FROM_JSON(Height, height_);
      DARABONBA_PTR_FROM_JSON(Width, width_);
    };
    AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer() = default ;
    AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer(const AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer &) = default ;
    AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer(AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer &&) = default ;
    AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer() = default ;
    AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer& operator=(const AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer &) = default ;
    AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer& operator=(AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer &&) = default ;
    ...
    inline AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer& setDx(string dx) { DARABONBA_PTR_SET_VALUE(dx_, dx) };
    ...
    inline AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer& setDy(string dy) { DARABONBA_PTR_SET_VALUE(dy_, dy) };
    ...
    inline AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer& setHeight(string height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline AddWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer& setWidth(string width) { DARABONBA_PTR_SET_VALUE(width_, width) };
