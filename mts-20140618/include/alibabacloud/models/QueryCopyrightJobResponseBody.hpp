...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryCopyrightJobResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryCopyrightJobResponseBodyData>) };
    inline vector<QueryCopyrightJobResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryCopyrightJobResponseBodyData>) };
    inline QueryCopyrightJobResponseBody& setData(const vector<QueryCopyrightJobResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryCopyrightJobResponseBody& setData(vector<QueryCopyrightJobResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<QueryCopyrightJobResponseBodyData>> data_ = nullptr;
