...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCopyrightExtractJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryCopyrightExtractJobResponseBody) };
    inline QueryCopyrightExtractJobResponseBody body() { DARABONBA_PTR_GET(body_, QueryCopyrightExtractJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryCopyrightExtractJobResponseBody> body_ = nullptr;
  };
