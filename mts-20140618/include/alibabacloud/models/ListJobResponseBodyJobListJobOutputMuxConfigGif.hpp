...
#ifndef ALIBABACLOUD_MODELS_LISTJOBRESPONSEBODYJOBLISTJOBOUTPUTMUXCONFIGGIF_HPP_
#define ALIBABACLOUD_MODELS_LISTJOBRESPONSEBODYJOBLISTJOBOUTPUTMUXCONFIGGIF_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListJobResponseBodyJobListJobOutputMuxConfigGif& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListJobResponseBodyJobListJobOutputMuxConfigGif& obj) { 
    ...
    ListJobResponseBodyJobListJobOutputMuxConfigGif() = default ;
    ListJobResponseBodyJobListJobOutputMuxConfigGif(const ListJobResponseBodyJobListJobOutputMuxConfigGif &) = default ;
    ListJobResponseBodyJobListJobOutputMuxConfigGif(ListJobResponseBodyJobListJobOutputMuxConfigGif &&) = default ;
    ListJobResponseBodyJobListJobOutputMuxConfigGif(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListJobResponseBodyJobListJobOutputMuxConfigGif() = default ;
    ListJobResponseBodyJobListJobOutputMuxConfigGif& operator=(const ListJobResponseBodyJobListJobOutputMuxConfigGif &) = default ;
    ListJobResponseBodyJobListJobOutputMuxConfigGif& operator=(ListJobResponseBodyJobListJobOutputMuxConfigGif &&) = default ;
    ...
    inline ListJobResponseBodyJobListJobOutputMuxConfigGif& setDitherMode(string ditherMode) { DARABONBA_PTR_SET_VALUE(ditherMode_, ditherMode) };
    ...
    inline ListJobResponseBodyJobListJobOutputMuxConfigGif& setFinalDelay(string finalDelay) { DARABONBA_PTR_SET_VALUE(finalDelay_, finalDelay) };
    ...
    inline ListJobResponseBodyJobListJobOutputMuxConfigGif& setIsCustomPalette(string isCustomPalette) { DARABONBA_PTR_SET_VALUE(isCustomPalette_, isCustomPalette) };
    ...
    inline ListJobResponseBodyJobListJobOutputMuxConfigGif& setLoop(string loop) { DARABONBA_PTR_SET_VALUE(loop_, loop) };
