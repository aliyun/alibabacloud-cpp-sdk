...
#ifndef ALIBABACLOUD_MODELS_QUERYJOBLISTRESPONSEBODYJOBLISTJOBOUTPUTMUXCONFIGGIF_HPP_
#define ALIBABACLOUD_MODELS_QUERYJOBLISTRESPONSEBODYJOBLISTJOBOUTPUTMUXCONFIGGIF_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryJobListResponseBodyJobListJobOutputMuxConfigGif& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryJobListResponseBodyJobListJobOutputMuxConfigGif& obj) { 
    ...
    QueryJobListResponseBodyJobListJobOutputMuxConfigGif() = default ;
    QueryJobListResponseBodyJobListJobOutputMuxConfigGif(const QueryJobListResponseBodyJobListJobOutputMuxConfigGif &) = default ;
    QueryJobListResponseBodyJobListJobOutputMuxConfigGif(QueryJobListResponseBodyJobListJobOutputMuxConfigGif &&) = default ;
    QueryJobListResponseBodyJobListJobOutputMuxConfigGif(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryJobListResponseBodyJobListJobOutputMuxConfigGif() = default ;
    QueryJobListResponseBodyJobListJobOutputMuxConfigGif& operator=(const QueryJobListResponseBodyJobListJobOutputMuxConfigGif &) = default ;
    QueryJobListResponseBodyJobListJobOutputMuxConfigGif& operator=(QueryJobListResponseBodyJobListJobOutputMuxConfigGif &&) = default ;
    ...
    inline QueryJobListResponseBodyJobListJobOutputMuxConfigGif& setDitherMode(string ditherMode) { DARABONBA_PTR_SET_VALUE(ditherMode_, ditherMode) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputMuxConfigGif& setFinalDelay(string finalDelay) { DARABONBA_PTR_SET_VALUE(finalDelay_, finalDelay) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputMuxConfigGif& setIsCustomPalette(string isCustomPalette) { DARABONBA_PTR_SET_VALUE(isCustomPalette_, isCustomPalette) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputMuxConfigGif& setLoop(string loop) { DARABONBA_PTR_SET_VALUE(loop_, loop) };
