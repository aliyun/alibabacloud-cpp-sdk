...
namespace Models
{
  ...
  public:
    ...
    inline const AddSmarttagTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddSmarttagTemplateResponseBody) };
    inline AddSmarttagTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, AddSmarttagTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddSmarttagTemplateResponseBody> body_ {};
  };
