...
namespace Models
{
  ...
  public:
    ...
    inline const RegisterCustomViewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RegisterCustomViewResponseBody) };
    inline RegisterCustomViewResponseBody getBody() { DARABONBA_PTR_GET(body_, RegisterCustomViewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RegisterCustomViewResponseBody> body_ {};
  };
