...
namespace Models
{
  ...
  public:
    ...
    class NonExistRunIds : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const NonExistRunIds& obj) { 
        DARABONBA_PTR_TO_JSON(RunId, runId_);
      };
      friend void from_json(const Darabonba::Json& j, NonExistRunIds& obj) { 
        DARABONBA_PTR_FROM_JSON(RunId, runId_);
      };
      NonExistRunIds() = default ;
      NonExistRunIds(const NonExistRunIds &) = default ;
      NonExistRunIds(NonExistRunIds &&) = default ;
      NonExistRunIds(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~NonExistRunIds() = default ;
      NonExistRunIds& operator=(const NonExistRunIds &) = default ;
      NonExistRunIds& operator=(NonExistRunIds &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline NonExistRunIds& setRunId(const vector<string> & runId) { DARABONBA_PTR_SET_VALUE(runId_, runId) };
      inline NonExistRunIds& setRunId(vector<string> && runId) { DARABONBA_PTR_SET_RVALUE(runId_, runId) };
    ...
    virtual bool empty() const override { return this->mediaWorkflowExecutionList_ == nullptr
        && this->nonExistRunIds_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline const QueryMediaWorkflowExecutionListResponseBody::MediaWorkflowExecutionList & getMediaWorkflowExecutionList() const { DARABONBA_PTR_GET_CONST(mediaWorkflowExecutionList_, QueryMediaWorkflowExecutionListResponseBody::MediaWorkflowExecutionList) };
    inline QueryMediaWorkflowExecutionListResponseBody::MediaWorkflowExecutionList getMediaWorkflowExecutionList() { DARABONBA_PTR_GET(mediaWorkflowExecutionList_, QueryMediaWorkflowExecutionListResponseBody::MediaWorkflowExecutionList) };
    inline QueryMediaWorkflowExecutionListResponseBody& setMediaWorkflowExecutionList(const QueryMediaWorkflowExecutionListResponseBody::MediaWorkflowExecutionList & mediaWorkflowExecutionList) { DARABONBA_PTR_SET_VALUE(mediaWorkflowExecutionList_, mediaWorkflowExecutionList) };
    inline QueryMediaWorkflowExecutionListResponseBody& setMediaWorkflowExecutionList(QueryMediaWorkflowExecutionListResponseBody::MediaWorkflowExecutionList && mediaWorkflowExecutionList) { DARABONBA_PTR_SET_RVALUE(mediaWorkflowExecutionList_, mediaWorkflowExecutionList) };
    ...
    inline const QueryMediaWorkflowExecutionListResponseBody::NonExistRunIds & getNonExistRunIds() const { DARABONBA_PTR_GET_CONST(nonExistRunIds_, QueryMediaWorkflowExecutionListResponseBody::NonExistRunIds) };
    inline QueryMediaWorkflowExecutionListResponseBody::NonExistRunIds getNonExistRunIds() { DARABONBA_PTR_GET(nonExistRunIds_, QueryMediaWorkflowExecutionListResponseBody::NonExistRunIds) };
    inline QueryMediaWorkflowExecutionListResponseBody& setNonExistRunIds(const QueryMediaWorkflowExecutionListResponseBody::NonExistRunIds & nonExistRunIds) { DARABONBA_PTR_SET_VALUE(nonExistRunIds_, nonExistRunIds) };
    inline QueryMediaWorkflowExecutionListResponseBody& setNonExistRunIds(QueryMediaWorkflowExecutionListResponseBody::NonExistRunIds && nonExistRunIds) { DARABONBA_PTR_SET_RVALUE(nonExistRunIds_, nonExistRunIds) };
  ...
  protected:
    shared_ptr<QueryMediaWorkflowExecutionListResponseBody::MediaWorkflowExecutionList> mediaWorkflowExecutionList_ {};
    shared_ptr<QueryMediaWorkflowExecutionListResponseBody::NonExistRunIds> nonExistRunIds_ {};
