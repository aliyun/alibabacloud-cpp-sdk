...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySnapshotJobListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QuerySnapshotJobListResponseBody) };
    inline QuerySnapshotJobListResponseBody getBody() { DARABONBA_PTR_GET(body_, QuerySnapshotJobListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QuerySnapshotJobListResponseBody> body_ {};
  };
