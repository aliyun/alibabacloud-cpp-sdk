...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitTraceAbJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SubmitTraceAbJobResponseBodyData) };
    inline SubmitTraceAbJobResponseBodyData data() { DARABONBA_PTR_GET(data_, SubmitTraceAbJobResponseBodyData) };
    inline SubmitTraceAbJobResponseBody& setData(const SubmitTraceAbJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitTraceAbJobResponseBody& setData(SubmitTraceAbJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<SubmitTraceAbJobResponseBodyData> data_ = nullptr;
