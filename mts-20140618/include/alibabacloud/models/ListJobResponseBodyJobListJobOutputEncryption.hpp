...
#ifndef ALIBABACLOUD_MODELS_LISTJOBRESPONSEBODYJOBLISTJOBOUTPUTENCRYPTION_HPP_
#define ALIBABACLOUD_MODELS_LISTJOBRESPONSEBODYJOBLISTJOBOUTPUTENCRYPTION_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListJobResponseBodyJobListJobOutputEncryption& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListJobResponseBodyJobListJobOutputEncryption& obj) { 
    ...
    ListJobResponseBodyJobListJobOutputEncryption() = default ;
    ListJobResponseBodyJobListJobOutputEncryption(const ListJobResponseBodyJobListJobOutputEncryption &) = default ;
    ListJobResponseBodyJobListJobOutputEncryption(ListJobResponseBodyJobListJobOutputEncryption &&) = default ;
    ListJobResponseBodyJobListJobOutputEncryption(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListJobResponseBodyJobListJobOutputEncryption() = default ;
    ListJobResponseBodyJobListJobOutputEncryption& operator=(const ListJobResponseBodyJobListJobOutputEncryption &) = default ;
    ListJobResponseBodyJobListJobOutputEncryption& operator=(ListJobResponseBodyJobListJobOutputEncryption &&) = default ;
    ...
    inline ListJobResponseBodyJobListJobOutputEncryption& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListJobResponseBodyJobListJobOutputEncryption& setKey(string key) { DARABONBA_PTR_SET_VALUE(key_, key) };
    ...
    inline ListJobResponseBodyJobListJobOutputEncryption& setKeyType(string keyType) { DARABONBA_PTR_SET_VALUE(keyType_, keyType) };
    ...
    inline ListJobResponseBodyJobListJobOutputEncryption& setKeyUri(string keyUri) { DARABONBA_PTR_SET_VALUE(keyUri_, keyUri) };
    ...
    inline ListJobResponseBodyJobListJobOutputEncryption& setSkipCnt(string skipCnt) { DARABONBA_PTR_SET_VALUE(skipCnt_, skipCnt) };
    ...
    inline ListJobResponseBodyJobListJobOutputEncryption& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
