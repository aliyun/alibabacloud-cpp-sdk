...
namespace Models
{
  ...
  public:
    ...
    inline SubmitTraceExtractJobRequest& setCallBack(string callBack) { DARABONBA_PTR_SET_VALUE(callBack_, callBack) };
    ...
    inline SubmitTraceExtractJobRequest& setInput(string input) { DARABONBA_PTR_SET_VALUE(input_, input) };
    ...
    inline SubmitTraceExtractJobRequest& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
