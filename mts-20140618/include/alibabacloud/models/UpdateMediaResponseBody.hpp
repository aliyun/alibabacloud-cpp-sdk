...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMediaResponseBody::Media & getMedia() const { DARABONBA_PTR_GET_CONST(media_, UpdateMediaResponseBody::Media) };
    inline UpdateMediaResponseBody::Media getMedia() { DARABONBA_PTR_GET(media_, UpdateMediaResponseBody::Media) };
    inline UpdateMediaResponseBody& setMedia(const UpdateMediaResponseBody::Media & media) { DARABONBA_PTR_SET_VALUE(media_, media) };
    inline UpdateMediaResponseBody& setMedia(UpdateMediaResponseBody::Media && media) { DARABONBA_PTR_SET_RVALUE(media_, media) };
  ...
  protected:
    ...
    shared_ptr<UpdateMediaResponseBody::Media> media_ {};
