...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitTraceExtractJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SubmitTraceExtractJobResponseBodyData) };
    inline SubmitTraceExtractJobResponseBodyData data() { DARABONBA_PTR_GET(data_, SubmitTraceExtractJobResponseBodyData) };
    inline SubmitTraceExtractJobResponseBody& setData(const SubmitTraceExtractJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitTraceExtractJobResponseBody& setData(SubmitTraceExtractJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<SubmitTraceExtractJobResponseBodyData> data_ = nullptr;
