...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTraceM3u8JobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryTraceM3u8JobResponseBody) };
    inline QueryTraceM3u8JobResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryTraceM3u8JobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryTraceM3u8JobResponseBody> body_ {};
  };
