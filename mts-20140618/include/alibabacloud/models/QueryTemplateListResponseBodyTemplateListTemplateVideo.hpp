...
#ifndef ALIBABACLOUD_MODELS_QUERYTEMPLATELISTRESPONSEBODYTEMPLATELISTTEMPLATEVIDEO_HPP_
#define ALIBABACLOUD_MODELS_QUERYTEMPLATELISTRESPONSEBODYTEMPLATELISTTEMPLATEVIDEO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryTemplateListResponseBodyTemplateListTemplateVideo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryTemplateListResponseBodyTemplateListTemplateVideo& obj) { 
    ...
    QueryTemplateListResponseBodyTemplateListTemplateVideo() = default ;
    QueryTemplateListResponseBodyTemplateListTemplateVideo(const QueryTemplateListResponseBodyTemplateListTemplateVideo &) = default ;
    QueryTemplateListResponseBodyTemplateListTemplateVideo(QueryTemplateListResponseBodyTemplateListTemplateVideo &&) = default ;
    QueryTemplateListResponseBodyTemplateListTemplateVideo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryTemplateListResponseBodyTemplateListTemplateVideo() = default ;
    QueryTemplateListResponseBodyTemplateListTemplateVideo& operator=(const QueryTemplateListResponseBodyTemplateListTemplateVideo &) = default ;
    QueryTemplateListResponseBodyTemplateListTemplateVideo& operator=(QueryTemplateListResponseBodyTemplateListTemplateVideo &&) = default ;
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setBitrate(string bitrate) { DARABONBA_PTR_SET_VALUE(bitrate_, bitrate) };
    ...
    inline const Models::QueryTemplateListResponseBodyTemplateListTemplateVideoBitrateBnd & bitrateBnd() const { DARABONBA_PTR_GET_CONST(bitrateBnd_, Models::QueryTemplateListResponseBodyTemplateListTemplateVideoBitrateBnd) };
    inline Models::QueryTemplateListResponseBodyTemplateListTemplateVideoBitrateBnd bitrateBnd() { DARABONBA_PTR_GET(bitrateBnd_, Models::QueryTemplateListResponseBodyTemplateListTemplateVideoBitrateBnd) };
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setBitrateBnd(const Models::QueryTemplateListResponseBodyTemplateListTemplateVideoBitrateBnd & bitrateBnd) { DARABONBA_PTR_SET_VALUE(bitrateBnd_, bitrateBnd) };
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setBitrateBnd(Models::QueryTemplateListResponseBodyTemplateListTemplateVideoBitrateBnd && bitrateBnd) { DARABONBA_PTR_SET_RVALUE(bitrateBnd_, bitrateBnd) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setBufsize(string bufsize) { DARABONBA_PTR_SET_VALUE(bufsize_, bufsize) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setCodec(string codec) { DARABONBA_PTR_SET_VALUE(codec_, codec) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setCrf(string crf) { DARABONBA_PTR_SET_VALUE(crf_, crf) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setCrop(string crop) { DARABONBA_PTR_SET_VALUE(crop_, crop) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setDegrain(string degrain) { DARABONBA_PTR_SET_VALUE(degrain_, degrain) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setFps(string fps) { DARABONBA_PTR_SET_VALUE(fps_, fps) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setGop(string gop) { DARABONBA_PTR_SET_VALUE(gop_, gop) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setHdr2sdr(string hdr2sdr) { DARABONBA_PTR_SET_VALUE(hdr2sdr_, hdr2sdr) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setHeight(string height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setLongShortMode(string longShortMode) { DARABONBA_PTR_SET_VALUE(longShortMode_, longShortMode) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setMaxFps(string maxFps) { DARABONBA_PTR_SET_VALUE(maxFps_, maxFps) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setMaxrate(string maxrate) { DARABONBA_PTR_SET_VALUE(maxrate_, maxrate) };
    ...
    inline const Models::QueryTemplateListResponseBodyTemplateListTemplateVideoNarrowBand & narrowBand() const { DARABONBA_PTR_GET_CONST(narrowBand_, Models::QueryTemplateListResponseBodyTemplateListTemplateVideoNarrowBand) };
    inline Models::QueryTemplateListResponseBodyTemplateListTemplateVideoNarrowBand narrowBand() { DARABONBA_PTR_GET(narrowBand_, Models::QueryTemplateListResponseBodyTemplateListTemplateVideoNarrowBand) };
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setNarrowBand(const Models::QueryTemplateListResponseBodyTemplateListTemplateVideoNarrowBand & narrowBand) { DARABONBA_PTR_SET_VALUE(narrowBand_, narrowBand) };
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setNarrowBand(Models::QueryTemplateListResponseBodyTemplateListTemplateVideoNarrowBand && narrowBand) { DARABONBA_PTR_SET_RVALUE(narrowBand_, narrowBand) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setPad(string pad) { DARABONBA_PTR_SET_VALUE(pad_, pad) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setPixFmt(string pixFmt) { DARABONBA_PTR_SET_VALUE(pixFmt_, pixFmt) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setPreset(string preset) { DARABONBA_PTR_SET_VALUE(preset_, preset) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setProfile(string profile) { DARABONBA_PTR_SET_VALUE(profile_, profile) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setQscale(string qscale) { DARABONBA_PTR_SET_VALUE(qscale_, qscale) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setRemove(string remove) { DARABONBA_PTR_SET_VALUE(remove_, remove) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setResoPriority(string resoPriority) { DARABONBA_PTR_SET_VALUE(resoPriority_, resoPriority) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setScanMode(string scanMode) { DARABONBA_PTR_SET_VALUE(scanMode_, scanMode) };
    ...
    inline QueryTemplateListResponseBodyTemplateListTemplateVideo& setWidth(string width) { DARABONBA_PTR_SET_VALUE(width_, width) };
  ...
  protected:
    ...
    std::shared_ptr<Models::QueryTemplateListResponseBodyTemplateListTemplateVideoBitrateBnd> bitrateBnd_ = nullptr;
    // The buffer size.
    // 
    // *   Unit: KB.
    // *   Default value: **6000**.
    ...
    std::shared_ptr<Models::QueryTemplateListResponseBodyTemplateListTemplateVideoNarrowBand> narrowBand_ = nullptr;
