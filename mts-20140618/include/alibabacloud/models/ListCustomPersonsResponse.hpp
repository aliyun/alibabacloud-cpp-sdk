...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomPersonsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCustomPersonsResponseBody) };
    inline ListCustomPersonsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCustomPersonsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCustomPersonsResponseBody> body_ {};
  };
