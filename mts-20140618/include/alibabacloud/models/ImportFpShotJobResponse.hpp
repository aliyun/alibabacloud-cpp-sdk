...
namespace Models
{
  ...
  public:
    ...
    inline const ImportFpShotJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImportFpShotJobResponseBody) };
    inline ImportFpShotJobResponseBody getBody() { DARABONBA_PTR_GET(body_, ImportFpShotJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImportFpShotJobResponseBody> body_ {};
  };
