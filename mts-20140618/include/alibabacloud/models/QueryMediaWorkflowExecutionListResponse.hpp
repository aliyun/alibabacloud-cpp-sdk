...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMediaWorkflowExecutionListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryMediaWorkflowExecutionListResponseBody) };
    inline QueryMediaWorkflowExecutionListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryMediaWorkflowExecutionListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryMediaWorkflowExecutionListResponseBody> body_ {};
  };
