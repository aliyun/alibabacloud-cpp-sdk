...
#ifndef ALIBABACLOUD_MODELS_DELETEMEDIAWORKFLOWRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DELETEMEDIAWORKFLOWRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteMediaWorkflowResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(MediaWorkflow, mediaWorkflow_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteMediaWorkflowResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(MediaWorkflow, mediaWorkflow_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DeleteMediaWorkflowResponseBody() = default ;
    DeleteMediaWorkflowResponseBody(const DeleteMediaWorkflowResponseBody &) = default ;
    DeleteMediaWorkflowResponseBody(DeleteMediaWorkflowResponseBody &&) = default ;
    DeleteMediaWorkflowResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteMediaWorkflowResponseBody() = default ;
    DeleteMediaWorkflowResponseBody& operator=(const DeleteMediaWorkflowResponseBody &) = default ;
    DeleteMediaWorkflowResponseBody& operator=(DeleteMediaWorkflowResponseBody &&) = default ;
    ...
    inline const DeleteMediaWorkflowResponseBody::MediaWorkflow & getMediaWorkflow() const { DARABONBA_PTR_GET_CONST(mediaWorkflow_, DeleteMediaWorkflowResponseBody::MediaWorkflow) };
    inline DeleteMediaWorkflowResponseBody::MediaWorkflow getMediaWorkflow() { DARABONBA_PTR_GET(mediaWorkflow_, DeleteMediaWorkflowResponseBody::MediaWorkflow) };
    inline DeleteMediaWorkflowResponseBody& setMediaWorkflow(const DeleteMediaWorkflowResponseBody::MediaWorkflow & mediaWorkflow) { DARABONBA_PTR_SET_VALUE(mediaWorkflow_, mediaWorkflow) };
    inline DeleteMediaWorkflowResponseBody& setMediaWorkflow(DeleteMediaWorkflowResponseBody::MediaWorkflow && mediaWorkflow) { DARABONBA_PTR_SET_RVALUE(mediaWorkflow_, mediaWorkflow) };
    ...
    inline DeleteMediaWorkflowResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The information about the media workflow.
    shared_ptr<DeleteMediaWorkflowResponseBody::MediaWorkflow> mediaWorkflow_ {};
