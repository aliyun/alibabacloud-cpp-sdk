...
#ifndef ALIBABACLOUD_MODELS_QUERYJOBLISTRESPONSEBODYJOBLISTJOBOUTPUTTRANSCONFIG_HPP_
#define ALIBABACLOUD_MODELS_QUERYJOBLISTRESPONSEBODYJOBLISTJOBOUTPUTTRANSCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryJobListResponseBodyJobListJobOutputTransConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryJobListResponseBodyJobListJobOutputTransConfig& obj) { 
    ...
    QueryJobListResponseBodyJobListJobOutputTransConfig() = default ;
    QueryJobListResponseBodyJobListJobOutputTransConfig(const QueryJobListResponseBodyJobListJobOutputTransConfig &) = default ;
    QueryJobListResponseBodyJobListJobOutputTransConfig(QueryJobListResponseBodyJobListJobOutputTransConfig &&) = default ;
    QueryJobListResponseBodyJobListJobOutputTransConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryJobListResponseBodyJobListJobOutputTransConfig() = default ;
    QueryJobListResponseBodyJobListJobOutputTransConfig& operator=(const QueryJobListResponseBodyJobListJobOutputTransConfig &) = default ;
    QueryJobListResponseBodyJobListJobOutputTransConfig& operator=(QueryJobListResponseBodyJobListJobOutputTransConfig &&) = default ;
    ...
    inline QueryJobListResponseBodyJobListJobOutputTransConfig& setAdjDarMethod(string adjDarMethod) { DARABONBA_PTR_SET_VALUE(adjDarMethod_, adjDarMethod) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTransConfig& setIsCheckAudioBitrate(string isCheckAudioBitrate) { DARABONBA_PTR_SET_VALUE(isCheckAudioBitrate_, isCheckAudioBitrate) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTransConfig& setIsCheckAudioBitrateFail(string isCheckAudioBitrateFail) { DARABONBA_PTR_SET_VALUE(isCheckAudioBitrateFail_, isCheckAudioBitrateFail) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTransConfig& setIsCheckReso(string isCheckReso) { DARABONBA_PTR_SET_VALUE(isCheckReso_, isCheckReso) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTransConfig& setIsCheckResoFail(string isCheckResoFail) { DARABONBA_PTR_SET_VALUE(isCheckResoFail_, isCheckResoFail) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTransConfig& setIsCheckVideoBitrate(string isCheckVideoBitrate) { DARABONBA_PTR_SET_VALUE(isCheckVideoBitrate_, isCheckVideoBitrate) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTransConfig& setIsCheckVideoBitrateFail(string isCheckVideoBitrateFail) { DARABONBA_PTR_SET_VALUE(isCheckVideoBitrateFail_, isCheckVideoBitrateFail) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputTransConfig& setTransMode(string transMode) { DARABONBA_PTR_SET_VALUE(transMode_, transMode) };
