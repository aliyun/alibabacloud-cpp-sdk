...
namespace Models
{
  ...
  public:
    ...
    class JobResultList : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const JobResultList& obj) { 
        DARABONBA_PTR_TO_JSON(JobResult, jobResult_);
      };
      friend void from_json(const Darabonba::Json& j, JobResultList& obj) { 
        DARABONBA_PTR_FROM_JSON(JobResult, jobResult_);
      };
      JobResultList() = default ;
      JobResultList(const JobResultList &) = default ;
      JobResultList(JobResultList &&) = default ;
      JobResultList(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~JobResultList() = default ;
      JobResultList& operator=(const JobResultList &) = default ;
      JobResultList& operator=(JobResultList &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      public:
        ...
        && this->key_ == nullptr && this->keyType_ == nullptr && this->keyUri_ == nullptr && this->skipCnt_ == nullptr && this->type_ == nullptr; };
            ...
            class DigiWaterMark : public Darabonba::Model {
            public:
              friend void to_json(Darabonba::Json& j, const DigiWaterMark& obj) { 
                DARABONBA_PTR_TO_JSON(Alpha, alpha_);
                DARABONBA_PTR_TO_JSON(InputFile, inputFile_);
                DARABONBA_PTR_TO_JSON(Type, type_);
              };
              friend void from_json(const Darabonba::Json& j, DigiWaterMark& obj) { 
                DARABONBA_PTR_FROM_JSON(Alpha, alpha_);
                DARABONBA_PTR_FROM_JSON(InputFile, inputFile_);
                DARABONBA_PTR_FROM_JSON(Type, type_);
              };
              DigiWaterMark() = default ;
              DigiWaterMark(const DigiWaterMark &) = default ;
              DigiWaterMark(DigiWaterMark &&) = default ;
              DigiWaterMark(const Darabonba::Json & obj) { from_json(obj, *this); };
              virtual ~DigiWaterMark() = default ;
              DigiWaterMark& operator=(const DigiWaterMark &) = default ;
              DigiWaterMark& operator=(DigiWaterMark &&) = default ;
              virtual void validate() const override {
              };
              virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
              virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        && this->inputFile_ == nullptr && this->type_ == nullptr; };
              // alpha Field Functions 
              bool hasAlpha() const { return this->alpha_ != nullptr;};
              void deleteAlpha() { this->alpha_ = nullptr;};
              inline string getAlpha() const { DARABONBA_PTR_GET_DEFAULT(alpha_, "") };
              inline DigiWaterMark& setAlpha(string alpha) { DARABONBA_PTR_SET_VALUE(alpha_, alpha) };


              // inputFile Field Functions 
              bool hasInputFile() const { return this->inputFile_ != nullptr;};
              void deleteInputFile() { this->inputFile_ = nullptr;};
              inline const DigiWaterMark::InputFile & getInputFile() const { DARABONBA_PTR_GET_CONST(inputFile_, DigiWaterMark::InputFile) };
              inline DigiWaterMark::InputFile getInputFile() { DARABONBA_PTR_GET(inputFile_, DigiWaterMark::InputFile) };
              inline DigiWaterMark& setInputFile(const DigiWaterMark::InputFile & inputFile) { DARABONBA_PTR_SET_VALUE(inputFile_, inputFile) };
              inline DigiWaterMark& setInputFile(DigiWaterMark::InputFile && inputFile) { DARABONBA_PTR_SET_RVALUE(inputFile_, inputFile) };
              ...
              void deleteType() { this->type_ = nullptr;};
              inline string getType() const { DARABONBA_PTR_GET_DEFAULT(type_, "") };
              inline DigiWaterMark& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };


            protected:
              shared_ptr<string> alpha_ {};
              shared_ptr<DigiWaterMark::InputFile> inputFile_ {};
              shared_ptr<string> type_ {};
            };
        ...
        && this->volume_ == nullptr; };
            ...
            class AmixList : public Darabonba::Model {
            public:
              friend void to_json(Darabonba::Json& j, const AmixList& obj) { 
                DARABONBA_PTR_TO_JSON(Amix, amix_);
              };
              friend void from_json(const Darabonba::Json& j, AmixList& obj) { 
                DARABONBA_PTR_FROM_JSON(Amix, amix_);
              };
              AmixList() = default ;
              AmixList(const AmixList &) = default ;
              AmixList(AmixList &&) = default ;
              AmixList(const Darabonba::Json & obj) { from_json(obj, *this); };
              virtual ~AmixList() = default ;
              AmixList& operator=(const AmixList &) = default ;
              AmixList& operator=(AmixList &&) = default ;
              virtual void validate() const override {
              };
              virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
              virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
              class Amix : public Darabonba::Model {
              public:
                friend void to_json(Darabonba::Json& j, const Amix& obj) { 
                ...
                friend void from_json(const Darabonba::Json& j, Amix& obj) { 
                ...
                Amix() = default ;
                Amix(const Amix &) = default ;
                Amix(Amix &&) = default ;
                Amix(const Darabonba::Json & obj) { from_json(obj, *this); };
                virtual ~Amix() = default ;
                Amix& operator=(const Amix &) = default ;
                Amix& operator=(Amix &&) = default ;
                virtual void validate() const override {
                };
                virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
                virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
                virtual bool empty() const override { return this->amixURL_ == nullptr
        && this->duration_ == nullptr && this->map_ == nullptr && this->mixDurMode_ == nullptr && this->start_ == nullptr; };
                // amixURL Field Functions 
                bool hasAmixURL() const { return this->amixURL_ != nullptr;};
                void deleteAmixURL() { this->amixURL_ = nullptr;};
                inline string getAmixURL() const { DARABONBA_PTR_GET_DEFAULT(amixURL_, "") };
                inline Amix& setAmixURL(string amixURL) { DARABONBA_PTR_SET_VALUE(amixURL_, amixURL) };
                ...
                void deleteDuration() { this->duration_ = nullptr;};
                inline string getDuration() const { DARABONBA_PTR_GET_DEFAULT(duration_, "") };
                inline Amix& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
                ...
                void deleteMap() { this->map_ = nullptr;};
                inline string getMap() const { DARABONBA_PTR_GET_DEFAULT(map_, "") };
                inline Amix& setMap(string _map) { DARABONBA_PTR_SET_VALUE(map_, _map) };
                ...
                inline string getMixDurMode() const { DARABONBA_PTR_GET_DEFAULT(mixDurMode_, "") };
                inline Amix& setMixDurMode(string mixDurMode) { DARABONBA_PTR_SET_VALUE(mixDurMode_, mixDurMode) };
                ...
                void deleteStart() { this->start_ = nullptr;};
                inline string getStart() const { DARABONBA_PTR_GET_DEFAULT(start_, "") };
                inline Amix& setStart(string start) { DARABONBA_PTR_SET_VALUE(start_, start) };


              protected:
                shared_ptr<string> amixURL_ {};
                shared_ptr<string> duration_ {};
                shared_ptr<string> map_ {};
                shared_ptr<string> mixDurMode_ {};
                shared_ptr<string> start_ {};
              };
              ...
              inline const vector<AmixList::Amix> & getAmix() const { DARABONBA_PTR_GET_CONST(amix_, vector<AmixList::Amix>) };
              inline vector<AmixList::Amix> getAmix() { DARABONBA_PTR_GET(amix_, vector<AmixList::Amix>) };
              inline AmixList& setAmix(const vector<AmixList::Amix> & amix) { DARABONBA_PTR_SET_VALUE(amix_, amix) };
              inline AmixList& setAmix(vector<AmixList::Amix> && amix) { DARABONBA_PTR_SET_RVALUE(amix_, amix) };


            protected:
              shared_ptr<vector<AmixList::Amix>> amix_ {};
            };

            virtual bool empty() const override { return this->amixList_ == nullptr
        && this->audio_ == nullptr && this->audioStreamMap_ == nullptr && this->clip_ == nullptr && this->container_ == nullptr && this->deWatermark_ == nullptr
        && this->digiWaterMark_ == nullptr && this->encryption_ == nullptr && this->m3U8NonStandardSupport_ == nullptr && this->mergeConfigUrl_ == nullptr && this->mergeList_ == nullptr
        ...
        && this->waterMarkConfigUrl_ == nullptr && this->waterMarkList_ == nullptr; };
            ...
            inline const Output::AmixList & getAmixList() const { DARABONBA_PTR_GET_CONST(amixList_, Output::AmixList) };
            inline Output::AmixList getAmixList() { DARABONBA_PTR_GET(amixList_, Output::AmixList) };
            inline Output& setAmixList(const Output::AmixList & amixList) { DARABONBA_PTR_SET_VALUE(amixList_, amixList) };
            inline Output& setAmixList(Output::AmixList && amixList) { DARABONBA_PTR_SET_RVALUE(amixList_, amixList) };
            ...
            inline const Output::DigiWaterMark & getDigiWaterMark() const { DARABONBA_PTR_GET_CONST(digiWaterMark_, Output::DigiWaterMark) };
            inline Output::DigiWaterMark getDigiWaterMark() { DARABONBA_PTR_GET(digiWaterMark_, Output::DigiWaterMark) };
            inline Output& setDigiWaterMark(const Output::DigiWaterMark & digiWaterMark) { DARABONBA_PTR_SET_VALUE(digiWaterMark_, digiWaterMark) };
            inline Output& setDigiWaterMark(Output::DigiWaterMark && digiWaterMark) { DARABONBA_PTR_SET_RVALUE(digiWaterMark_, digiWaterMark) };
          ...
          protected:
            shared_ptr<Output::AmixList> amixList_ {};
            ...
            shared_ptr<Output::DigiWaterMark> digiWaterMark_ {};
        ...
        virtual bool empty() const override { return this->code_ == nullptr
        && this->job_ == nullptr && this->message_ == nullptr && this->success_ == nullptr; };
        // code Field Functions 
        bool hasCode() const { return this->code_ != nullptr;};
        void deleteCode() { this->code_ = nullptr;};
        inline string getCode() const { DARABONBA_PTR_GET_DEFAULT(code_, "") };
        inline JobResult& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


        // job Field Functions 
        bool hasJob() const { return this->job_ != nullptr;};
        void deleteJob() { this->job_ = nullptr;};
        inline const JobResult::Job & getJob() const { DARABONBA_PTR_GET_CONST(job_, JobResult::Job) };
        inline JobResult::Job getJob() { DARABONBA_PTR_GET(job_, JobResult::Job) };
        inline JobResult& setJob(const JobResult::Job & job) { DARABONBA_PTR_SET_VALUE(job_, job) };
        inline JobResult& setJob(JobResult::Job && job) { DARABONBA_PTR_SET_RVALUE(job_, job) };
        ...
        void deleteMessage() { this->message_ = nullptr;};
        inline string getMessage() const { DARABONBA_PTR_GET_DEFAULT(message_, "") };
        inline JobResult& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
        ...
        void deleteSuccess() { this->success_ = nullptr;};
        inline bool getSuccess() const { DARABONBA_PTR_GET_DEFAULT(success_, false) };
        inline JobResult& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


      protected:
        shared_ptr<string> code_ {};
        shared_ptr<JobResult::Job> job_ {};
        shared_ptr<string> message_ {};
        shared_ptr<bool> success_ {};
      };
      ...
      inline const vector<JobResultList::JobResult> & getJobResult() const { DARABONBA_PTR_GET_CONST(jobResult_, vector<JobResultList::JobResult>) };
      inline vector<JobResultList::JobResult> getJobResult() { DARABONBA_PTR_GET(jobResult_, vector<JobResultList::JobResult>) };
      inline JobResultList& setJobResult(const vector<JobResultList::JobResult> & jobResult) { DARABONBA_PTR_SET_VALUE(jobResult_, jobResult) };
      inline JobResultList& setJobResult(vector<JobResultList::JobResult> && jobResult) { DARABONBA_PTR_SET_RVALUE(jobResult_, jobResult) };


    protected:
      shared_ptr<vector<JobResultList::JobResult>> jobResult_ {};
    };
    ...
    inline const SubmitJobsResponseBody::JobResultList & getJobResultList() const { DARABONBA_PTR_GET_CONST(jobResultList_, SubmitJobsResponseBody::JobResultList) };
    inline SubmitJobsResponseBody::JobResultList getJobResultList() { DARABONBA_PTR_GET(jobResultList_, SubmitJobsResponseBody::JobResultList) };
    inline SubmitJobsResponseBody& setJobResultList(const SubmitJobsResponseBody::JobResultList & jobResultList) { DARABONBA_PTR_SET_VALUE(jobResultList_, jobResultList) };
    inline SubmitJobsResponseBody& setJobResultList(SubmitJobsResponseBody::JobResultList && jobResultList) { DARABONBA_PTR_SET_RVALUE(jobResultList_, jobResultList) };
  ...
  protected:
    shared_ptr<SubmitJobsResponseBody::JobResultList> jobResultList_ {};
    // The request ID.
