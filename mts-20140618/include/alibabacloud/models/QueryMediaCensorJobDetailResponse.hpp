...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMediaCensorJobDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryMediaCensorJobDetailResponseBody) };
    inline QueryMediaCensorJobDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryMediaCensorJobDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryMediaCensorJobDetailResponseBody> body_ {};
  };
