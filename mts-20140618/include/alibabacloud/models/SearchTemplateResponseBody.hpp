...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->templateList_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const SearchTemplateResponseBodyTemplateList & templateList() const { DARABONBA_PTR_GET_CONST(templateList_, SearchTemplateResponseBodyTemplateList) };
    inline SearchTemplateResponseBodyTemplateList templateList() { DARABONBA_PTR_GET(templateList_, SearchTemplateResponseBodyTemplateList) };
    inline SearchTemplateResponseBody& setTemplateList(const SearchTemplateResponseBodyTemplateList & templateList) { DARABONBA_PTR_SET_VALUE(templateList_, templateList) };
    inline SearchTemplateResponseBody& setTemplateList(SearchTemplateResponseBodyTemplateList && templateList) { DARABONBA_PTR_SET_RVALUE(templateList_, templateList) };
  ...
  protected:
    ...
    std::shared_ptr<SearchTemplateResponseBodyTemplateList> templateList_ = nullptr;
