...
#ifndef ALIBABACLOUD_MODELS_SUBMITJOBSRESPONSEBODYJOBRESULTLISTJOBRESULTJOBOUTPUTTRANSCONFIG_HPP_
#define ALIBABACLOUD_MODELS_SUBMITJOBSRESPONSEBODYJOBRESULTLISTJOBRESULTJOBOUTPUTTRANSCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& obj) { 
    ...
    SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig() = default ;
    SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig(const SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig &) = default ;
    SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig(SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig &&) = default ;
    SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig() = default ;
    SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& operator=(const SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig &) = default ;
    SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& operator=(SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig &&) = default ;
    ...
    inline SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& setAdjDarMethod(string adjDarMethod) { DARABONBA_PTR_SET_VALUE(adjDarMethod_, adjDarMethod) };
    ...
    inline SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& setIsCheckAudioBitrate(string isCheckAudioBitrate) { DARABONBA_PTR_SET_VALUE(isCheckAudioBitrate_, isCheckAudioBitrate) };
    ...
    inline SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& setIsCheckAudioBitrateFail(string isCheckAudioBitrateFail) { DARABONBA_PTR_SET_VALUE(isCheckAudioBitrateFail_, isCheckAudioBitrateFail) };
    ...
    inline SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& setIsCheckReso(string isCheckReso) { DARABONBA_PTR_SET_VALUE(isCheckReso_, isCheckReso) };
    ...
    inline SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& setIsCheckResoFail(string isCheckResoFail) { DARABONBA_PTR_SET_VALUE(isCheckResoFail_, isCheckResoFail) };
    ...
    inline SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& setIsCheckVideoBitrate(string isCheckVideoBitrate) { DARABONBA_PTR_SET_VALUE(isCheckVideoBitrate_, isCheckVideoBitrate) };
    ...
    inline SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& setIsCheckVideoBitrateFail(string isCheckVideoBitrateFail) { DARABONBA_PTR_SET_VALUE(isCheckVideoBitrateFail_, isCheckVideoBitrateFail) };
    ...
    inline SubmitJobsResponseBodyJobResultListJobResultJobOutputTransConfig& setTransMode(string transMode) { DARABONBA_PTR_SET_VALUE(transMode_, transMode) };
