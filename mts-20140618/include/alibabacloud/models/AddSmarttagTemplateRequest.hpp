...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->analyseTypes_ == nullptr
        ...
        && this->knowledgeConfig_ == nullptr && this->labelCustomCategoryIds_ == nullptr && this->labelCustomParamsConfig_ == nullptr && this->labelType_ == nullptr && this->labelVersion_ == nullptr
        && this->landmarkGroupIds_ == nullptr && this->objectGroupIds_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->resourceOwnerAccount_ == nullptr
        && this->resourceOwnerId_ == nullptr && this->scene_ == nullptr && this->templateConfig_ == nullptr && this->templateName_ == nullptr; };
    ...
    inline string getLabelCustomCategoryIds() const { DARABONBA_PTR_GET_DEFAULT(labelCustomCategoryIds_, "") };
    ...
    inline string getLabelCustomParamsConfig() const { DARABONBA_PTR_GET_DEFAULT(labelCustomParamsConfig_, "") };
  ...
  protected:
    ...
    shared_ptr<string> labelCustomCategoryIds_ {};
    shared_ptr<string> labelCustomParamsConfig_ {};
