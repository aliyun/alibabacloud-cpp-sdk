...
namespace Models
{
  ...
  public:
    ...
    class SnapshotJobList : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const SnapshotJobList& obj) { 
        DARABONBA_PTR_TO_JSON(SnapshotJob, snapshotJob_);
      };
      friend void from_json(const Darabonba::Json& j, SnapshotJobList& obj) { 
        DARABONBA_PTR_FROM_JSON(SnapshotJob, snapshotJob_);
      };
      SnapshotJobList() = default ;
      SnapshotJobList(const SnapshotJobList &) = default ;
      SnapshotJobList(SnapshotJobList &&) = default ;
      SnapshotJobList(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~SnapshotJobList() = default ;
      SnapshotJobList& operator=(const SnapshotJobList &) = default ;
      SnapshotJobList& operator=(SnapshotJobList &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline const vector<SnapshotJobList::SnapshotJob> & getSnapshotJob() const { DARABONBA_PTR_GET_CONST(snapshotJob_, vector<SnapshotJobList::SnapshotJob>) };
      inline vector<SnapshotJobList::SnapshotJob> getSnapshotJob() { DARABONBA_PTR_GET(snapshotJob_, vector<SnapshotJobList::SnapshotJob>) };
      inline SnapshotJobList& setSnapshotJob(const vector<SnapshotJobList::SnapshotJob> & snapshotJob) { DARABONBA_PTR_SET_VALUE(snapshotJob_, snapshotJob) };
      inline SnapshotJobList& setSnapshotJob(vector<SnapshotJobList::SnapshotJob> && snapshotJob) { DARABONBA_PTR_SET_RVALUE(snapshotJob_, snapshotJob) };


    protected:
      shared_ptr<vector<SnapshotJobList::SnapshotJob>> snapshotJob_ {};
    };

    class NonExistSnapshotJobIds : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const NonExistSnapshotJobIds& obj) { 
        DARABONBA_PTR_TO_JSON(String, string_);
      };
      friend void from_json(const Darabonba::Json& j, NonExistSnapshotJobIds& obj) { 
        DARABONBA_PTR_FROM_JSON(String, string_);
      };
      NonExistSnapshotJobIds() = default ;
      NonExistSnapshotJobIds(const NonExistSnapshotJobIds &) = default ;
      NonExistSnapshotJobIds(NonExistSnapshotJobIds &&) = default ;
      NonExistSnapshotJobIds(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~NonExistSnapshotJobIds() = default ;
      NonExistSnapshotJobIds& operator=(const NonExistSnapshotJobIds &) = default ;
      NonExistSnapshotJobIds& operator=(NonExistSnapshotJobIds &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline NonExistSnapshotJobIds& setString(const vector<string> & string) { DARABONBA_PTR_SET_VALUE(string_, string) };
      inline NonExistSnapshotJobIds& setString(vector<string> && string) { DARABONBA_PTR_SET_RVALUE(string_, string) };
    ...
    virtual bool empty() const override { return this->nextPageToken_ == nullptr
        && this->nonExistSnapshotJobIds_ == nullptr && this->requestId_ == nullptr && this->snapshotJobList_ == nullptr; };
    ...
    inline const QuerySnapshotJobListResponseBody::NonExistSnapshotJobIds & getNonExistSnapshotJobIds() const { DARABONBA_PTR_GET_CONST(nonExistSnapshotJobIds_, QuerySnapshotJobListResponseBody::NonExistSnapshotJobIds) };
    inline QuerySnapshotJobListResponseBody::NonExistSnapshotJobIds getNonExistSnapshotJobIds() { DARABONBA_PTR_GET(nonExistSnapshotJobIds_, QuerySnapshotJobListResponseBody::NonExistSnapshotJobIds) };
    inline QuerySnapshotJobListResponseBody& setNonExistSnapshotJobIds(const QuerySnapshotJobListResponseBody::NonExistSnapshotJobIds & nonExistSnapshotJobIds) { DARABONBA_PTR_SET_VALUE(nonExistSnapshotJobIds_, nonExistSnapshotJobIds) };
    inline QuerySnapshotJobListResponseBody& setNonExistSnapshotJobIds(QuerySnapshotJobListResponseBody::NonExistSnapshotJobIds && nonExistSnapshotJobIds) { DARABONBA_PTR_SET_RVALUE(nonExistSnapshotJobIds_, nonExistSnapshotJobIds) };
    ...
    inline const QuerySnapshotJobListResponseBody::SnapshotJobList & getSnapshotJobList() const { DARABONBA_PTR_GET_CONST(snapshotJobList_, QuerySnapshotJobListResponseBody::SnapshotJobList) };
    inline QuerySnapshotJobListResponseBody::SnapshotJobList getSnapshotJobList() { DARABONBA_PTR_GET(snapshotJobList_, QuerySnapshotJobListResponseBody::SnapshotJobList) };
    inline QuerySnapshotJobListResponseBody& setSnapshotJobList(const QuerySnapshotJobListResponseBody::SnapshotJobList & snapshotJobList) { DARABONBA_PTR_SET_VALUE(snapshotJobList_, snapshotJobList) };
    inline QuerySnapshotJobListResponseBody& setSnapshotJobList(QuerySnapshotJobListResponseBody::SnapshotJobList && snapshotJobList) { DARABONBA_PTR_SET_RVALUE(snapshotJobList_, snapshotJobList) };


  protected:
    // The OSS object that is used as the input file.
    shared_ptr<string> nextPageToken_ {};
    shared_ptr<QuerySnapshotJobListResponseBody::NonExistSnapshotJobIds> nonExistSnapshotJobIds_ {};
    // The ID of the snapshot job.
    shared_ptr<string> requestId_ {};
    shared_ptr<QuerySnapshotJobListResponseBody::SnapshotJobList> snapshotJobList_ {};
  };
