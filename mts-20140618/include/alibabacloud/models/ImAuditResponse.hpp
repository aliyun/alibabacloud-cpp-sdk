...
namespace Models
{
  ...
  public:
    ...
    inline const ImAuditResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImAuditResponseBody) };
    inline ImAuditResponseBody getBody() { DARABONBA_PTR_GET(body_, ImAuditResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImAuditResponseBody> body_ {};
  };
