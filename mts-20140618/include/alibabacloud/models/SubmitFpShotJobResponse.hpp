...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitFpShotJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitFpShotJobResponseBody) };
    inline SubmitFpShotJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitFpShotJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitFpShotJobResponseBody> body_ {};
  };
