...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCustomEntityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCustomEntityResponseBody) };
    inline CreateCustomEntityResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCustomEntityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCustomEntityResponseBody> body_ {};
  };
