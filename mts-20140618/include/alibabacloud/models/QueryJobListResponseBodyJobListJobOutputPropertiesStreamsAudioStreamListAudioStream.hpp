...
#ifndef ALIBABACLOUD_MODELS_QUERYJOBLISTRESPONSEBODYJOBLISTJOBOUTPUTPROPERTIESSTREAMSAUDIOSTREAMLISTAUDIOSTREAM_HPP_
#define ALIBABACLOUD_MODELS_QUERYJOBLISTRESPONSEBODYJOBLISTJOBOUTPUTPROPERTIESSTREAMSAUDIOSTREAMLISTAUDIOSTREAM_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& obj) { 
    ...
    QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream() = default ;
    QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream(const QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream &) = default ;
    QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream(QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream &&) = default ;
    QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream() = default ;
    QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& operator=(const QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream &) = default ;
    QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& operator=(QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream &&) = default ;
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setBitrate(string bitrate) { DARABONBA_PTR_SET_VALUE(bitrate_, bitrate) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setChannelLayout(string channelLayout) { DARABONBA_PTR_SET_VALUE(channelLayout_, channelLayout) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setChannels(string channels) { DARABONBA_PTR_SET_VALUE(channels_, channels) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setCodecLongName(string codecLongName) { DARABONBA_PTR_SET_VALUE(codecLongName_, codecLongName) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setCodecName(string codecName) { DARABONBA_PTR_SET_VALUE(codecName_, codecName) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setCodecTag(string codecTag) { DARABONBA_PTR_SET_VALUE(codecTag_, codecTag) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setCodecTagString(string codecTagString) { DARABONBA_PTR_SET_VALUE(codecTagString_, codecTagString) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setCodecTimeBase(string codecTimeBase) { DARABONBA_PTR_SET_VALUE(codecTimeBase_, codecTimeBase) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setIndex(string index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setNumFrames(string numFrames) { DARABONBA_PTR_SET_VALUE(numFrames_, numFrames) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setSampleFmt(string sampleFmt) { DARABONBA_PTR_SET_VALUE(sampleFmt_, sampleFmt) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setSamplerate(string samplerate) { DARABONBA_PTR_SET_VALUE(samplerate_, samplerate) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline QueryJobListResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setTimebase(string timebase) { DARABONBA_PTR_SET_VALUE(timebase_, timebase) };
