...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->endOfJobCreatedTimeRange_ == nullptr
        ...
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->snapshotJobIds_ == nullptr && this->startOfJobCreatedTimeRange_ == nullptr && this->state_ == nullptr; };
    ...
    inline string getSnapshotJobIds() const { DARABONBA_PTR_GET_DEFAULT(snapshotJobIds_, "") };
  ...
  protected:
    ...
    // *   Specify the time in the ISO 8601 standard in the
    // *   YYYY-MM-DDThh:mm:ssZ format. The time must be in UTC.
    shared_ptr<string> snapshotJobIds_ {};
