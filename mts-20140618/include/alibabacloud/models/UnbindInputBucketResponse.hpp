...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindInputBucketResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnbindInputBucketResponseBody) };
    inline UnbindInputBucketResponseBody getBody() { DARABONBA_PTR_GET(body_, UnbindInputBucketResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnbindInputBucketResponseBody> body_ {};
  };
