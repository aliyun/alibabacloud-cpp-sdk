...
#ifndef ALIBABACLOUD_MODELS_LISTJOBRESPONSEBODYJOBLISTJOBOUTPUTPROPERTIESSTREAMSAUDIOSTREAMLISTAUDIOSTREAM_HPP_
#define ALIBABACLOUD_MODELS_LISTJOBRESPONSEBODYJOBLISTJOBOUTPUTPROPERTIESSTREAMSAUDIOSTREAMLISTAUDIOSTREAM_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& obj) { 
    ...
    ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream() = default ;
    ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream(const ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream &) = default ;
    ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream(ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream &&) = default ;
    ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream() = default ;
    ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& operator=(const ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream &) = default ;
    ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& operator=(ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream &&) = default ;
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setBitrate(string bitrate) { DARABONBA_PTR_SET_VALUE(bitrate_, bitrate) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setChannelLayout(string channelLayout) { DARABONBA_PTR_SET_VALUE(channelLayout_, channelLayout) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setChannels(string channels) { DARABONBA_PTR_SET_VALUE(channels_, channels) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setCodecLongName(string codecLongName) { DARABONBA_PTR_SET_VALUE(codecLongName_, codecLongName) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setCodecName(string codecName) { DARABONBA_PTR_SET_VALUE(codecName_, codecName) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setCodecTag(string codecTag) { DARABONBA_PTR_SET_VALUE(codecTag_, codecTag) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setCodecTagString(string codecTagString) { DARABONBA_PTR_SET_VALUE(codecTagString_, codecTagString) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setCodecTimeBase(string codecTimeBase) { DARABONBA_PTR_SET_VALUE(codecTimeBase_, codecTimeBase) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setIndex(string index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setNumFrames(string numFrames) { DARABONBA_PTR_SET_VALUE(numFrames_, numFrames) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setSampleFmt(string sampleFmt) { DARABONBA_PTR_SET_VALUE(sampleFmt_, sampleFmt) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setSamplerate(string samplerate) { DARABONBA_PTR_SET_VALUE(samplerate_, samplerate) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream& setTimebase(string timebase) { DARABONBA_PTR_SET_VALUE(timebase_, timebase) };
