...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Action> & getActions() const { DARABONBA_PTR_GET_CONST(actions_, vector<Action>) };
    inline vector<Action> getActions() { DARABONBA_PTR_GET(actions_, vector<Action>) };
    ...
    inline string getGmtActivatedTime() const { DARABONBA_PTR_GET_DEFAULT(gmtActivatedTime_, "") };
    ...
    inline const Rules & getRules() const { DARABONBA_PTR_GET_CONST(rules_, Rules) };
    inline Rules getRules() { DARABONBA_PTR_GET(rules_, Rules) };
  ...
  protected:
    shared_ptr<vector<Action>> actions_ {};
    shared_ptr<string> description_ {};
    shared_ptr<string> gmtActivatedTime_ {};
