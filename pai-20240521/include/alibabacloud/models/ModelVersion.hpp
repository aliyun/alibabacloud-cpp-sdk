...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->approvalStatus_ == nullptr
        && this->compressionSpec_ == nullptr && this->evaluationSpec_ == nullptr && this->extraInfo_ == nullptr && this->formatType_ == nullptr && this->frameworkType_ == nullptr
        && this->gmtCreateTime_ == nullptr && this->gmtModifiedTime_ == nullptr && this->inferenceSpec_ == nullptr && this->labels_ == nullptr && this->metrics_ == nullptr
        && this->options_ == nullptr && this->ownerId_ == nullptr && this->sourceId_ == nullptr && this->sourceType_ == nullptr && this->trainingSpec_ == nullptr
        && this->uri_ == nullptr && this->userId_ == nullptr && this->versionDescription_ == nullptr && this->versionName_ == nullptr; };
    ...
    inline ModelVersion& setLabels(const vector<Label> & labels) { DARABONBA_PTR_SET_VALUE(labels_, labels) };
    inline ModelVersion& setLabels(vector<Label> && labels) { DARABONBA_PTR_SET_RVALUE(labels_, labels) };
