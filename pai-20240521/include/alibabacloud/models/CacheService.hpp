...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cacheServiceId_ == nullptr
        && this->createdBy_ == nullptr && this->gmtCreated_ == nullptr && this->quotaId_ == nullptr && this->status_ == nullptr && this->supportedClientQuotaIds_ == nullptr
