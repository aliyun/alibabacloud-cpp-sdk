...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->category_ == nullptr
        && this->nextToken_ == nullptr && this->regionId_ == nullptr && this->resourceId_ == nullptr && this->resourceType_ == nullptr && this->scope_ == nullptr
        && this->tag_ == nullptr && this->tagOwnerUid_ == nullptr; };
    ...
    inline ListTagResourcesRequest& setScope(string scope) { DARABONBA_PTR_SET_VALUE(scope_, scope) };
    ...
    inline ListTagResourcesRequest& setTagOwnerUid(int64_t tagOwnerUid) { DARABONBA_PTR_SET_VALUE(tagOwnerUid_, tagOwnerUid) };
