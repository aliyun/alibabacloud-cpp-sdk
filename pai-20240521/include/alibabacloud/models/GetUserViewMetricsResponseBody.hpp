...
namespace Models
{
  ...
  public:
    ...
    inline const UserViewMetric & getSummary() const { DARABONBA_PTR_GET_CONST(summary_, UserViewMetric) };
    inline UserViewMetric getSummary() { DARABONBA_PTR_GET(summary_, UserViewMetric) };
    ...
    inline const vector<UserViewMetric> & getUserMetrics() const { DARABONBA_PTR_GET_CONST(userMetrics_, vector<UserViewMetric>) };
    inline vector<UserViewMetric> getUserMetrics() { DARABONBA_PTR_GET(userMetrics_, vector<UserViewMetric>) };
