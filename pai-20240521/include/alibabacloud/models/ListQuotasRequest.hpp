...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->labels_ == nullptr
        && this->layoutMode_ == nullptr && this->order_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->parentQuotaId_ == nullptr
        && this->quotaIds_ == nullptr && this->quotaName_ == nullptr && this->resourceType_ == nullptr && this->sortBy_ == nullptr && this->statuses_ == nullptr
        && this->verbose_ == nullptr && this->workspaceIds_ == nullptr && this->workspaceName_ == nullptr; };
