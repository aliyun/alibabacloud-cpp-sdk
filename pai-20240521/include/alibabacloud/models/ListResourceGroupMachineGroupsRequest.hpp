...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->creatorID_ == nullptr
        && this->ecsSpec_ == nullptr && this->name_ == nullptr && this->order_ == nullptr && this->orderInstanceId_ == nullptr && this->pageNumber_ == nullptr
        && this->pageSize_ == nullptr && this->paymentDuration_ == nullptr && this->paymentDurationUnit_ == nullptr && this->paymentType_ == nullptr && this->sortBy_ == nullptr
