...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetResourceGroupResponseBody::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<GetResourceGroupResponseBody::Tags>) };
    inline vector<GetResourceGroupResponseBody::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<GetResourceGroupResponseBody::Tags>) };
    inline GetResourceGroupResponseBody& setTags(const vector<GetResourceGroupResponseBody::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline GetResourceGroupResponseBody& setTags(vector<GetResourceGroupResponseBody::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
