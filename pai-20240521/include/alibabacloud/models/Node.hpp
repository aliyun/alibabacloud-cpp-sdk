...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceleratorType_ == nullptr
        && this->boundQuotas_ == nullptr && this->CPU_ == nullptr && this->creatorId_ == nullptr && this->GPU_ == nullptr && this->GPUType_ == nullptr
        && this->gmtCreateTime_ == nullptr && this->gmtExpiredTime_ == nullptr && this->gmtModifiedTime_ == nullptr && this->isBound_ == nullptr && this->limitCPU_ == nullptr
        ...
        && this->resourceGroupName_ == nullptr && this->subNodes_ == nullptr && this->users_ == nullptr && this->workloadNum_ == nullptr; };
    ...
    inline const vector<QuotaIdName> & getBoundQuotas() const { DARABONBA_PTR_GET_CONST(boundQuotas_, vector<QuotaIdName>) };
    inline vector<QuotaIdName> getBoundQuotas() { DARABONBA_PTR_GET(boundQuotas_, vector<QuotaIdName>) };
    ...
    inline bool getIsBound() const { DARABONBA_PTR_GET_DEFAULT(isBound_, false) };
    ...
    inline string getLimitGPU() const { DARABONBA_PTR_GET_DEFAULT(limitGPU_, "") };
    ...
    inline string getLimitMemory() const { DARABONBA_PTR_GET_DEFAULT(limitMemory_, "") };
    ...
    inline int64_t getPodNum() const { DARABONBA_PTR_GET_DEFAULT(podNum_, 0L) };
    ...
    inline const vector<string> & getSubNodes() const { DARABONBA_PTR_GET_CONST(subNodes_, vector<string>) };
    inline vector<string> getSubNodes() { DARABONBA_PTR_GET(subNodes_, vector<string>) };
    ...
    inline const vector<UserInfo> & getUsers() const { DARABONBA_PTR_GET_CONST(users_, vector<UserInfo>) };
    inline vector<UserInfo> getUsers() { DARABONBA_PTR_GET(users_, vector<UserInfo>) };
    ...
    inline int64_t getWorkloadNum() const { DARABONBA_PTR_GET_DEFAULT(workloadNum_, 0L) };
