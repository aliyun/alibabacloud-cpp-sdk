...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListResourceGroupsResponseBody) };
    inline ListResourceGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListResourceGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListResourceGroupsResponseBody> body_ {};
  };
