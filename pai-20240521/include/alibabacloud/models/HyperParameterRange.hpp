...
namespace Models
{
  ...
  public:
    ...
    inline bool getExclusiveMaximum() const { DARABONBA_PTR_GET_DEFAULT(exclusiveMaximum_, false) };
    ...
    inline bool getExclusiveMinimum() const { DARABONBA_PTR_GET_DEFAULT(exclusiveMinimum_, false) };
    ...
    inline string getMaximum() const { DARABONBA_PTR_GET_DEFAULT(maximum_, "") };
    ...
    inline string getMinimum() const { DARABONBA_PTR_GET_DEFAULT(minimum_, "") };
