...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->endTimeMs_ == nullptr
        && this->instanceIdsShrink_ == nullptr && this->instanceStatusShrink_ == nullptr && this->limit_ == nullptr && this->qualifier_ == nullptr && this->startKey_ == nullptr
    ...
    inline string getInstanceStatusShrink() const { DARABONBA_PTR_GET_DEFAULT(instanceStatusShrink_, "") };
