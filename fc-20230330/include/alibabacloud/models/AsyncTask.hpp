...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getAlreadyRetriedTimes() const { DARABONBA_PTR_GET_DEFAULT(alreadyRetriedTimes_, 0L) };
    ...
    inline string getDestinationStatus() const { DARABONBA_PTR_GET_DEFAULT(destinationStatus_, "") };
    ...
    inline const vector<AsyncTaskEvent> & getEvents() const { DARABONBA_PTR_GET_CONST(events_, vector<AsyncTaskEvent>) };
    inline vector<AsyncTaskEvent> getEvents() { DARABONBA_PTR_GET(events_, vector<AsyncTaskEvent>) };
    ...
    inline string getReturnPayload() const { DARABONBA_PTR_GET_DEFAULT(returnPayload_, "") };
    ...
    inline string getTaskPayload() const { DARABONBA_PTR_GET_DEFAULT(taskPayload_, "") };
