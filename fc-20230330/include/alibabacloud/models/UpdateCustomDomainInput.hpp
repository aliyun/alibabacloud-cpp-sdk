...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authConfig_ == nullptr
        && this->certConfig_ == nullptr && this->corsConfig_ == nullptr && this->protocol_ == nullptr && this->routeConfig_ == nullptr && this->tlsConfig_ == nullptr
    ...
    inline UpdateCustomDomainInput& setCorsConfig(const CORSConfig & corsConfig) { DARABONBA_PTR_SET_VALUE(corsConfig_, corsConfig) };
    inline UpdateCustomDomainInput& setCorsConfig(CORSConfig && corsConfig) { DARABONBA_PTR_SET_RVALUE(corsConfig_, corsConfig) };
