...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentError_ == nullptr
        && return this->currentInstances_ == nullptr && return this->functionArn_ == nullptr && return this->minInstances_ == nullptr && return this->residentPoolId_ == nullptr && return this->scalingPolicies_ == nullptr
