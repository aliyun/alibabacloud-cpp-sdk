...
namespace Models
{
  ...
  public:
    ...
    inline const ListProvisionConfigsOutput & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListProvisionConfigsOutput) };
    inline ListProvisionConfigsOutput getBody() { DARABONBA_PTR_GET(body_, ListProvisionConfigsOutput) };
  ...
  protected:
    ...
    shared_ptr<ListProvisionConfigsOutput> body_ {};
  };
