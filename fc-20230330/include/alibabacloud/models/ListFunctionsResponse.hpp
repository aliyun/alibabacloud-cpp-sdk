...
namespace Models
{
  ...
  public:
    ...
    inline const ListFunctionsOutput & body() const { DARABONBA_PTR_GET_CONST(body_, ListFunctionsOutput) };
    inline ListFunctionsOutput body() { DARABONBA_PTR_GET(body_, ListFunctionsOutput) };
  ...
  protected:
    ...
    std::shared_ptr<ListFunctionsOutput> body_ = nullptr;
  };
