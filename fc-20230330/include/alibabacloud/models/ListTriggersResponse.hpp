...
namespace Models
{
  ...
  public:
    ...
    inline const ListTriggersOutput & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTriggersOutput) };
    inline ListTriggersOutput getBody() { DARABONBA_PTR_GET(body_, ListTriggersOutput) };
  ...
  protected:
    ...
    shared_ptr<ListTriggersOutput> body_ {};
  };
