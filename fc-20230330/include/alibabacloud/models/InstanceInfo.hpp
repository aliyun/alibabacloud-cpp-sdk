...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->createdTimeMs_ != nullptr
        && this->destroyedTimeMs_ != nullptr && this->instanceId_ != nullptr && this->qualifier_ != nullptr && this->status_ != nullptr && this->versionId_ != nullptr; };
    ...
    inline int64_t createdTimeMs() const { DARABONBA_PTR_GET_DEFAULT(createdTimeMs_, 0L) };
    ...
    inline int64_t destroyedTimeMs() const { DARABONBA_PTR_GET_DEFAULT(destroyedTimeMs_, 0L) };
  ...
  protected:
    std::shared_ptr<int64_t> createdTimeMs_ = nullptr;
