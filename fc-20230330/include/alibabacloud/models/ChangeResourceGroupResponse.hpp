...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeResourceGroupOutput & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChangeResourceGroupOutput) };
    inline ChangeResourceGroupOutput getBody() { DARABONBA_PTR_GET(body_, ChangeResourceGroupOutput) };
  ...
  protected:
    ...
    shared_ptr<ChangeResourceGroupOutput> body_ {};
  };
