...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeResourceGroupOutput & body() const { DARABONBA_PTR_GET_CONST(body_, ChangeResourceGroupOutput) };
    inline ChangeResourceGroupOutput body() { DARABONBA_PTR_GET(body_, ChangeResourceGroupOutput) };
    inline ChangeResourceGroupResponse& setBody(const ChangeResourceGroupOutput & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ChangeResourceGroupResponse& setBody(ChangeResourceGroupOutput && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<ChangeResourceGroupOutput> body_ = nullptr;
  };
