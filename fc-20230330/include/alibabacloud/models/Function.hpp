...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const Function& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(lockInfo, lockInfo_);
    ...
    friend void from_json(const Darabonba::Json& j, Function& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(lockInfo, lockInfo_);
    ...
    // lockInfo Field Functions 
    bool hasLockInfo() const { return this->lockInfo_ != nullptr;};
    void deleteLockInfo() { this->lockInfo_ = nullptr;};
    inline const FunctionLockInfo & getLockInfo() const { DARABONBA_PTR_GET_CONST(lockInfo_, FunctionLockInfo) };
    inline FunctionLockInfo getLockInfo() { DARABONBA_PTR_GET(lockInfo_, FunctionLockInfo) };
    inline Function& setLockInfo(const FunctionLockInfo & lockInfo) { DARABONBA_PTR_SET_VALUE(lockInfo_, lockInfo) };
    inline Function& setLockInfo(FunctionLockInfo && lockInfo) { DARABONBA_PTR_SET_RVALUE(lockInfo_, lockInfo) };
    ...
    inline Function& setMicroSandboxConfig(const MicroSandboxConfig & microSandboxConfig) { DARABONBA_PTR_SET_VALUE(microSandboxConfig_, microSandboxConfig) };
    inline Function& setMicroSandboxConfig(MicroSandboxConfig && microSandboxConfig) { DARABONBA_PTR_SET_RVALUE(microSandboxConfig_, microSandboxConfig) };
  ...
  protected:
    ...
    shared_ptr<FunctionLockInfo> lockInfo_ {};
