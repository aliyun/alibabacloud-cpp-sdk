...
namespace Models
{
  ...
  public:
    ...
    inline const EnableFunctionInvocationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableFunctionInvocationResponseBody) };
    inline EnableFunctionInvocationResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableFunctionInvocationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableFunctionInvocationResponseBody> body_ {};
  };
