...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const LogConfig& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(enableLlmMetrics, enableLlmMetrics_);
    ...
    friend void from_json(const Darabonba::Json& j, LogConfig& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(enableLlmMetrics, enableLlmMetrics_);
    ...
    virtual bool empty() const override { return this->enableInstanceMetrics_ == nullptr
        && this->enableLlmMetrics_ == nullptr && this->enableRequestMetrics_ == nullptr && this->logBeginRule_ == nullptr && this->logstore_ == nullptr && this->project_ == nullptr; };
    ...
    // enableLlmMetrics Field Functions 
    bool hasEnableLlmMetrics() const { return this->enableLlmMetrics_ != nullptr;};
    void deleteEnableLlmMetrics() { this->enableLlmMetrics_ = nullptr;};
    inline bool getEnableLlmMetrics() const { DARABONBA_PTR_GET_DEFAULT(enableLlmMetrics_, false) };
    inline LogConfig& setEnableLlmMetrics(bool enableLlmMetrics) { DARABONBA_PTR_SET_VALUE(enableLlmMetrics_, enableLlmMetrics) };
