...
namespace Models
{
  ...
  public:
    ...
    inline CreateSessionResponse& setBody(const Session & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CreateSessionResponse& setBody(Session && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
