...
namespace Models
{
  ...
  public:
    ...
    inline const ListScalingConfigsOutput & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListScalingConfigsOutput) };
    inline ListScalingConfigsOutput getBody() { DARABONBA_PTR_GET(body_, ListScalingConfigsOutput) };
  ...
  protected:
    ...
    shared_ptr<ListScalingConfigsOutput> body_ {};
  };
