...
namespace Models
{
  ...
  public:
    ...
    inline CreateFunctionResponse& setBody(const Function & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CreateFunctionResponse& setBody(Function && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
