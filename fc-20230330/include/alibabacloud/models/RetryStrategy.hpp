...
#ifndef ALIBABACLOUD_MODELS_RETRYSTRATEGY_HPP_
#define ALIBABACLOUD_MODELS_RETRYSTRATEGY_HPP_
...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pushRetryStrategy_ == nullptr; };
