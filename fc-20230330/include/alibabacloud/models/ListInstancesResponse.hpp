...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstancesOutput & body() const { DARABONBA_PTR_GET_CONST(body_, ListInstancesOutput) };
    inline ListInstancesOutput body() { DARABONBA_PTR_GET(body_, ListInstancesOutput) };
    inline ListInstancesResponse& setBody(const ListInstancesOutput & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListInstancesResponse& setBody(ListInstancesOutput && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<ListInstancesOutput> body_ = nullptr;
  };
