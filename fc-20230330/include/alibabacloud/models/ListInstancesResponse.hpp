...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstancesOutput & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstancesOutput) };
    inline ListInstancesOutput getBody() { DARABONBA_PTR_GET(body_, ListInstancesOutput) };
  ...
  protected:
    ...
    shared_ptr<ListInstancesOutput> body_ {};
  };
