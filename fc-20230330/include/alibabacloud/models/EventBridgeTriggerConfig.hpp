...
namespace Models
{
  ...
  public:
    ...
    inline bool asyncInvocationType() const { DARABONBA_PTR_GET_DEFAULT(asyncInvocationType_, false) };
    ...
    inline string eventRuleFilterPattern() const { DARABONBA_PTR_GET_DEFAULT(eventRuleFilterPattern_, "") };
    ...
    inline const EventSinkConfig & eventSinkConfig() const { DARABONBA_PTR_GET_CONST(eventSinkConfig_, EventSinkConfig) };
    inline EventSinkConfig eventSinkConfig() { DARABONBA_PTR_GET(eventSinkConfig_, EventSinkConfig) };
    ...
    inline const EventSourceConfig & eventSourceConfig() const { DARABONBA_PTR_GET_CONST(eventSourceConfig_, EventSourceConfig) };
    inline EventSourceConfig eventSourceConfig() { DARABONBA_PTR_GET(eventSourceConfig_, EventSourceConfig) };
    ...
    inline const RunOptions & runOptions() const { DARABONBA_PTR_GET_CONST(runOptions_, RunOptions) };
    inline RunOptions runOptions() { DARABONBA_PTR_GET(runOptions_, RunOptions) };
    ...
    inline bool triggerEnable() const { DARABONBA_PTR_GET_DEFAULT(triggerEnable_, false) };
    inline EventBridgeTriggerConfig& setTriggerEnable(bool triggerEnable) { DARABONBA_PTR_SET_VALUE(triggerEnable_, triggerEnable) };


  protected:
    std::shared_ptr<bool> asyncInvocationType_ = nullptr;
    std::shared_ptr<string> eventRuleFilterPattern_ = nullptr;
    std::shared_ptr<EventSinkConfig> eventSinkConfig_ = nullptr;
    std::shared_ptr<EventSourceConfig> eventSourceConfig_ = nullptr;
    std::shared_ptr<RunOptions> runOptions_ = nullptr;
    std::shared_ptr<bool> triggerEnable_ = nullptr;
  };
