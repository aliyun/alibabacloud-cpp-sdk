...
namespace Models
{
  ...
  public:
    ...
    inline const HTTPTrigger & getHttpTrigger() const { DARABONBA_PTR_GET_CONST(httpTrigger_, HTTPTrigger) };
    inline HTTPTrigger getHttpTrigger() { DARABONBA_PTR_GET(httpTrigger_, HTTPTrigger) };
