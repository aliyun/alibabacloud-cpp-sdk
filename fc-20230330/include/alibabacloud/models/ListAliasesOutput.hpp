...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Alias> & aliases() const { DARABONBA_PTR_GET_CONST(aliases_, vector<Alias>) };
    inline vector<Alias> aliases() { DARABONBA_PTR_GET(aliases_, vector<Alias>) };
  ...
  protected:
    std::shared_ptr<vector<Alias>> aliases_ = nullptr;
