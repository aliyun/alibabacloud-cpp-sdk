...
namespace Models
{
  ...
  public:
    ...
    inline const ListTagResourcesOutput & body() const { DARABONBA_PTR_GET_CONST(body_, ListTagResourcesOutput) };
    inline ListTagResourcesOutput body() { DARABONBA_PTR_GET(body_, ListTagResourcesOutput) };
    inline ListTagResourcesResponse& setBody(const ListTagResourcesOutput & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListTagResourcesResponse& setBody(ListTagResourcesOutput && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<ListTagResourcesOutput> body_ = nullptr;
  };
