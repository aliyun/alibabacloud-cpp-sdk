...
namespace Models
{
  ...
  public:
    ...
    inline const ListTagResourcesOutput & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTagResourcesOutput) };
    inline ListTagResourcesOutput getBody() { DARABONBA_PTR_GET(body_, ListTagResourcesOutput) };
  ...
  protected:
    ...
    shared_ptr<ListTagResourcesOutput> body_ {};
  };
