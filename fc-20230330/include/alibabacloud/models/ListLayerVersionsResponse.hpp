...
namespace Models
{
  ...
  public:
    ...
    inline const ListLayerVersionOutput & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLayerVersionOutput) };
    inline ListLayerVersionOutput getBody() { DARABONBA_PTR_GET(body_, ListLayerVersionOutput) };
  ...
  protected:
    ...
    shared_ptr<ListLayerVersionOutput> body_ {};
  };
