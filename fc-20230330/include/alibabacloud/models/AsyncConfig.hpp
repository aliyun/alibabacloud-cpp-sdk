...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->asyncTask_ == nullptr
        && return this->createdTime_ == nullptr && return this->destinationConfig_ == nullptr && return this->functionArn_ == nullptr && return this->lastModifiedTime_ == nullptr && return this->maxAsyncEventAgeInSeconds_ == nullptr
        && return this->maxAsyncRetryAttempts_ == nullptr; };
