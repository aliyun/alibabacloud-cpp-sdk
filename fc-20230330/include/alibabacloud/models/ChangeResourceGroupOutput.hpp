...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->newResourceGroupId_ == nullptr
        && this->oldResourceGroupId_ == nullptr && this->resourceId_ == nullptr; };
    ...
    inline string getOldResourceGroupId() const { DARABONBA_PTR_GET_DEFAULT(oldResourceGroupId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> oldResourceGroupId_ {};
