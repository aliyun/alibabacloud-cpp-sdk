...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->limit_ == nullptr
        && this->nextToken_ == nullptr && this->official_ == nullptr && this->prefix_ == nullptr && this->public_ == nullptr; };
    ...
    inline string getOfficial() const { DARABONBA_PTR_GET_DEFAULT(official_, "") };
    ...
    inline string getPublic() const { DARABONBA_PTR_GET_DEFAULT(public_, "") };
