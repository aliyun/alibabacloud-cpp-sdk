...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSessionInput & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSessionInput) };
    inline UpdateSessionInput getBody() { DARABONBA_PTR_GET(body_, UpdateSessionInput) };
