...
#ifndef ALIBABACLOUD_MODELS_ERROR_HPP_
#define ALIBABACLOUD_MODELS_ERROR_HPP_
...
namespace Models
{
  ...
  public:
    ...
    inline Error& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
