...
namespace Models
{
  ...
  public:
    ...
    inline const vector<TagResource> & tagResources() const { DARABONBA_PTR_GET_CONST(tagResources_, vector<TagResource>) };
    inline vector<TagResource> tagResources() { DARABONBA_PTR_GET(tagResources_, vector<TagResource>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<TagResource>> tagResources_ = nullptr;
  };
