...
namespace Models
{
  ...
  public:
    ...
    inline const PutScalingConfigInput & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutScalingConfigInput) };
    inline PutScalingConfigInput getBody() { DARABONBA_PTR_GET(body_, PutScalingConfigInput) };
