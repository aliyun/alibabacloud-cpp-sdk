...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lastAllocatedTime_ == nullptr
    ...
    inline string getLastAllocatedTime() const { DARABONBA_PTR_GET_DEFAULT(lastAllocatedTime_, "") };
    ...
    inline const vector<ResidentResourceAllocation> & getLastAllocation() const { DARABONBA_PTR_GET_CONST(lastAllocation_, vector<ResidentResourceAllocation>) };
    inline vector<ResidentResourceAllocation> getLastAllocation() { DARABONBA_PTR_GET(lastAllocation_, vector<ResidentResourceAllocation>) };
  ...
  protected:
    shared_ptr<string> lastAllocatedTime_ {};
    shared_ptr<vector<ResidentResourceAllocation>> lastAllocation_ {};
  };
