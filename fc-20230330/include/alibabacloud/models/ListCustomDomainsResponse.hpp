...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomDomainOutput & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCustomDomainOutput) };
    inline ListCustomDomainOutput getBody() { DARABONBA_PTR_GET(body_, ListCustomDomainOutput) };
  ...
  protected:
    ...
    shared_ptr<ListCustomDomainOutput> body_ {};
  };
