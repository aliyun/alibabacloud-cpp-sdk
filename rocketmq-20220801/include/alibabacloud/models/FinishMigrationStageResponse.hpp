...
namespace Models
{
  ...
  public:
    ...
    inline const FinishMigrationStageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FinishMigrationStageResponseBody) };
    inline FinishMigrationStageResponseBody getBody() { DARABONBA_PTR_GET(body_, FinishMigrationStageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FinishMigrationStageResponseBody> body_ {};
  };
