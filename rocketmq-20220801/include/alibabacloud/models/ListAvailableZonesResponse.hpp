...
namespace Models
{
  ...
  public:
    ...
    inline const ListAvailableZonesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAvailableZonesResponseBody) };
    inline ListAvailableZonesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAvailableZonesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAvailableZonesResponseBody> body_ {};
  };
