...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumeTimespanResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetConsumeTimespanResponseBodyData) };
    inline GetConsumeTimespanResponseBodyData data() { DARABONBA_PTR_GET(data_, GetConsumeTimespanResponseBodyData) };
    inline GetConsumeTimespanResponseBody& setData(const GetConsumeTimespanResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetConsumeTimespanResponseBody& setData(GetConsumeTimespanResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetConsumeTimespanResponseBodyData> data_ = nullptr;
