...
namespace Models
{
  ...
  public:
    ...
    inline const GetDisasterRecoveryPlanResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDisasterRecoveryPlanResponseBodyData) };
    inline GetDisasterRecoveryPlanResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDisasterRecoveryPlanResponseBodyData) };
    inline GetDisasterRecoveryPlanResponseBody& setData(const GetDisasterRecoveryPlanResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDisasterRecoveryPlanResponseBody& setData(GetDisasterRecoveryPlanResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetDisasterRecoveryPlanResponseBodyData> data_ = nullptr;
