...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateDisasterRecoveryPlanRequest::Instances> & getInstances() const { DARABONBA_PTR_GET_CONST(instances_, vector<UpdateDisasterRecoveryPlanRequest::Instances>) };
    inline vector<UpdateDisasterRecoveryPlanRequest::Instances> getInstances() { DARABONBA_PTR_GET(instances_, vector<UpdateDisasterRecoveryPlanRequest::Instances>) };
    inline UpdateDisasterRecoveryPlanRequest& setInstances(const vector<UpdateDisasterRecoveryPlanRequest::Instances> & instances) { DARABONBA_PTR_SET_VALUE(instances_, instances) };
    inline UpdateDisasterRecoveryPlanRequest& setInstances(vector<UpdateDisasterRecoveryPlanRequest::Instances> && instances) { DARABONBA_PTR_SET_RVALUE(instances_, instances) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateDisasterRecoveryPlanRequest::Instances>> instances_ {};
