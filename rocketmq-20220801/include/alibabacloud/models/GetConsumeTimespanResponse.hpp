...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumeTimespanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetConsumeTimespanResponseBody) };
    inline GetConsumeTimespanResponseBody getBody() { DARABONBA_PTR_GET(body_, GetConsumeTimespanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetConsumeTimespanResponseBody> body_ {};
  };
