...
namespace Models
{
  ...
  public:
    ...
    inline const ListDisasterRecoveryPlansResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDisasterRecoveryPlansResponseBody) };
    inline ListDisasterRecoveryPlansResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDisasterRecoveryPlansResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDisasterRecoveryPlansResponseBody> body_ {};
  };
