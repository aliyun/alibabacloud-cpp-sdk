...
namespace Models
{
  ...
  public:
    ...
    inline const ListMetricMetaResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListMetricMetaResponseBodyData) };
    inline ListMetricMetaResponseBodyData data() { DARABONBA_PTR_GET(data_, ListMetricMetaResponseBodyData) };
    inline ListMetricMetaResponseBody& setData(const ListMetricMetaResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMetricMetaResponseBody& setData(ListMetricMetaResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Return result
    std::shared_ptr<ListMetricMetaResponseBodyData> data_ = nullptr;
    // Dynamic error code
