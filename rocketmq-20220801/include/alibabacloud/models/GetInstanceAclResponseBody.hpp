...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceAclResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetInstanceAclResponseBodyData) };
    inline GetInstanceAclResponseBodyData data() { DARABONBA_PTR_GET(data_, GetInstanceAclResponseBodyData) };
    inline GetInstanceAclResponseBody& setData(const GetInstanceAclResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInstanceAclResponseBody& setData(GetInstanceAclResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetInstanceAclResponseBodyData> data_ = nullptr;
