...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListTopicSubscriptionsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListTopicSubscriptionsResponseBodyData>) };
    inline vector<ListTopicSubscriptionsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListTopicSubscriptionsResponseBodyData>) };
    inline ListTopicSubscriptionsResponseBody& setData(const vector<ListTopicSubscriptionsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTopicSubscriptionsResponseBody& setData(vector<ListTopicSubscriptionsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<vector<ListTopicSubscriptionsResponseBodyData>> data_ = nullptr;
