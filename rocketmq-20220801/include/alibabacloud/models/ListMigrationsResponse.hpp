...
namespace Models
{
  ...
  public:
    ...
    inline const ListMigrationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMigrationsResponseBody) };
    inline ListMigrationsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMigrationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMigrationsResponseBody> body_ {};
  };
