...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceAclResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListInstanceAclResponseBodyData) };
    inline ListInstanceAclResponseBodyData data() { DARABONBA_PTR_GET(data_, ListInstanceAclResponseBodyData) };
    inline ListInstanceAclResponseBody& setData(const ListInstanceAclResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListInstanceAclResponseBody& setData(ListInstanceAclResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListInstanceAclResponseBodyData> data_ = nullptr;
