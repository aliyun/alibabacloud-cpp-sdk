...
namespace Models
{
  ...
  public:
    ...
    inline const ResetConsumeOffsetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResetConsumeOffsetResponseBody) };
    inline ResetConsumeOffsetResponseBody getBody() { DARABONBA_PTR_GET(body_, ResetConsumeOffsetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResetConsumeOffsetResponseBody> body_ {};
  };
