...
namespace Models
{
  ...
  public:
    ...
    inline const ListMetricMetaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMetricMetaResponseBody) };
    inline ListMetricMetaResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMetricMetaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMetricMetaResponseBody> body_ {};
  };
