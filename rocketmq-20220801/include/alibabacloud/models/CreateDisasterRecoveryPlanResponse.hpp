...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDisasterRecoveryPlanResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateDisasterRecoveryPlanResponseBody) };
    inline CreateDisasterRecoveryPlanResponseBody body() { DARABONBA_PTR_GET(body_, CreateDisasterRecoveryPlanResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDisasterRecoveryPlanResponseBody> body_ = nullptr;
  };
