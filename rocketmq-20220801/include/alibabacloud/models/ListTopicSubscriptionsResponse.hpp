...
namespace Models
{
  ...
  public:
    ...
    inline const ListTopicSubscriptionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTopicSubscriptionsResponseBody) };
    inline ListTopicSubscriptionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTopicSubscriptionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTopicSubscriptionsResponseBody> body_ {};
  };
