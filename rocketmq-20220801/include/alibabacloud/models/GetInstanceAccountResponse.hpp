...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceAccountResponseBody) };
    inline GetInstanceAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceAccountResponseBody> body_ {};
  };
