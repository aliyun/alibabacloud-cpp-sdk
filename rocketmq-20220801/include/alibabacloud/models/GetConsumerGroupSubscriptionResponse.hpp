...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumerGroupSubscriptionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetConsumerGroupSubscriptionResponseBody) };
    inline GetConsumerGroupSubscriptionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetConsumerGroupSubscriptionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetConsumerGroupSubscriptionResponseBody> body_ {};
  };
