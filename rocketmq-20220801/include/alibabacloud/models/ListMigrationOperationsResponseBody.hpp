...
namespace Models
{
  ...
  public:
    ...
    inline const ListMigrationOperationsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListMigrationOperationsResponseBodyData) };
    inline ListMigrationOperationsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListMigrationOperationsResponseBodyData) };
    inline ListMigrationOperationsResponseBody& setData(const ListMigrationOperationsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMigrationOperationsResponseBody& setData(ListMigrationOperationsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListMigrationOperationsResponseBodyData> data_ = nullptr;
