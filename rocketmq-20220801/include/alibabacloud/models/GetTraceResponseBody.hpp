...
namespace Models
{
  ...
  public:
    ...
    inline const GetTraceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTraceResponseBodyData) };
    inline GetTraceResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTraceResponseBodyData) };
    inline GetTraceResponseBody& setData(const GetTraceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTraceResponseBody& setData(GetTraceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetTraceResponseBodyData> data_ = nullptr;
