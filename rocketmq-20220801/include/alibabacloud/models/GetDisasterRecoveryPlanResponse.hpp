...
namespace Models
{
  ...
  public:
    ...
    inline const GetDisasterRecoveryPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDisasterRecoveryPlanResponseBody) };
    inline GetDisasterRecoveryPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDisasterRecoveryPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDisasterRecoveryPlanResponseBody> body_ {};
  };
