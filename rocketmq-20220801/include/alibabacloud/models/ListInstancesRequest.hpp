...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getSeriesCodes() const { DARABONBA_PTR_GET_CONST(seriesCodes_, vector<string>) };
    inline vector<string> getSeriesCodes() { DARABONBA_PTR_GET(seriesCodes_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> seriesCodes_ {};
