...
namespace Models
{
  ...
  public:
    ...
    inline const CreateInstanceAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateInstanceAclResponseBody) };
    inline CreateInstanceAclResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateInstanceAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateInstanceAclResponseBody> body_ {};
  };
