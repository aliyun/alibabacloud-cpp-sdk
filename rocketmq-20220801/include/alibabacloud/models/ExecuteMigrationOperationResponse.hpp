...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteMigrationOperationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ExecuteMigrationOperationResponseBody) };
    inline ExecuteMigrationOperationResponseBody body() { DARABONBA_PTR_GET(body_, ExecuteMigrationOperationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ExecuteMigrationOperationResponseBody> body_ = nullptr;
  };
