...
namespace Models
{
  ...
  public:
    ...
    inline const StopDisasterRecoveryItemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopDisasterRecoveryItemResponseBody) };
    inline StopDisasterRecoveryItemResponseBody getBody() { DARABONBA_PTR_GET(body_, StopDisasterRecoveryItemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopDisasterRecoveryItemResponseBody> body_ {};
  };
