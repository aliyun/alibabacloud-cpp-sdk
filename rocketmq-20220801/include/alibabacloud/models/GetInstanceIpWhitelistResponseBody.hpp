...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceIpWhitelistResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetInstanceIpWhitelistResponseBodyData) };
    inline GetInstanceIpWhitelistResponseBodyData data() { DARABONBA_PTR_GET(data_, GetInstanceIpWhitelistResponseBodyData) };
    inline GetInstanceIpWhitelistResponseBody& setData(const GetInstanceIpWhitelistResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInstanceIpWhitelistResponseBody& setData(GetInstanceIpWhitelistResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetInstanceIpWhitelistResponseBodyData> data_ = nullptr;
