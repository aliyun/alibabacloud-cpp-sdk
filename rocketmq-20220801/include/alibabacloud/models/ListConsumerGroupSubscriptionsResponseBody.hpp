...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListConsumerGroupSubscriptionsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListConsumerGroupSubscriptionsResponseBodyData>) };
    inline vector<ListConsumerGroupSubscriptionsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListConsumerGroupSubscriptionsResponseBodyData>) };
    inline ListConsumerGroupSubscriptionsResponseBody& setData(const vector<ListConsumerGroupSubscriptionsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListConsumerGroupSubscriptionsResponseBody& setData(vector<ListConsumerGroupSubscriptionsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<vector<ListConsumerGroupSubscriptionsResponseBodyData>> data_ = nullptr;
