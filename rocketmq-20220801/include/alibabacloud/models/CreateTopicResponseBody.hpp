...
namespace Models
{
  ...
  public:
    ...
    inline CreateTopicResponseBody& setData(bool data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline CreateTopicResponseBody& setDynamicCode(string dynamicCode) { DARABONBA_PTR_SET_VALUE(dynamicCode_, dynamicCode) };
    ...
    inline CreateTopicResponseBody& setDynamicMessage(string dynamicMessage) { DARABONBA_PTR_SET_VALUE(dynamicMessage_, dynamicMessage) };
