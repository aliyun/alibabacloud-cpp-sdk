...
namespace Models
{
  ...
  public:
    ...
    inline UntagResourcesResponseBody& setData(bool data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline UntagResourcesResponseBody& setDynamicCode(string dynamicCode) { DARABONBA_PTR_SET_VALUE(dynamicCode_, dynamicCode) };
    ...
    inline UntagResourcesResponseBody& setDynamicMessage(string dynamicMessage) { DARABONBA_PTR_SET_VALUE(dynamicMessage_, dynamicMessage) };
    ...
    inline UntagResourcesResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
