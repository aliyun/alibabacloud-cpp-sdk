...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceAccountResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetInstanceAccountResponseBodyData) };
    inline GetInstanceAccountResponseBodyData data() { DARABONBA_PTR_GET(data_, GetInstanceAccountResponseBodyData) };
    inline GetInstanceAccountResponseBody& setData(const GetInstanceAccountResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInstanceAccountResponseBody& setData(GetInstanceAccountResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetInstanceAccountResponseBodyData> data_ = nullptr;
