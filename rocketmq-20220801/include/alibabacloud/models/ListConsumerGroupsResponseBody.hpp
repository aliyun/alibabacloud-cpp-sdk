...
namespace Models
{
  ...
  public:
    ...
    inline const ListConsumerGroupsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListConsumerGroupsResponseBodyData) };
    inline ListConsumerGroupsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListConsumerGroupsResponseBodyData) };
    inline ListConsumerGroupsResponseBody& setData(const ListConsumerGroupsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListConsumerGroupsResponseBody& setData(ListConsumerGroupsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListConsumerGroupsResponseBodyData> data_ = nullptr;
    // Dynamic error code.
