...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumerGroupLagResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetConsumerGroupLagResponseBody) };
    inline GetConsumerGroupLagResponseBody body() { DARABONBA_PTR_GET(body_, GetConsumerGroupLagResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetConsumerGroupLagResponseBody> body_ = nullptr;
  };
