...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->capacityType_ != nullptr
    ...
    inline ListInstancesResponseBodyDataListProductInfo& setCapacityType(string capacityType) { DARABONBA_PTR_SET_VALUE(capacityType_, capacityType) };
