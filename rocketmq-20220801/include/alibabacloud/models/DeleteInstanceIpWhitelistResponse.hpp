...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInstanceIpWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteInstanceIpWhitelistResponseBody) };
    inline DeleteInstanceIpWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteInstanceIpWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteInstanceIpWhitelistResponseBody> body_ {};
  };
