...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetConsumerGroupSubscriptionResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetConsumerGroupSubscriptionResponseBodyData>) };
    inline vector<GetConsumerGroupSubscriptionResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetConsumerGroupSubscriptionResponseBodyData>) };
    inline GetConsumerGroupSubscriptionResponseBody& setData(const vector<GetConsumerGroupSubscriptionResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetConsumerGroupSubscriptionResponseBody& setData(vector<GetConsumerGroupSubscriptionResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<GetConsumerGroupSubscriptionResponseBodyData>> data_ = nullptr;
