...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDisasterRecoveryPlanResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteDisasterRecoveryPlanResponseBody) };
    inline DeleteDisasterRecoveryPlanResponseBody body() { DARABONBA_PTR_GET(body_, DeleteDisasterRecoveryPlanResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteDisasterRecoveryPlanResponseBody> body_ = nullptr;
  };
