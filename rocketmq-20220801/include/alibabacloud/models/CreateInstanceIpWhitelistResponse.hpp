...
namespace Models
{
  ...
  public:
    ...
    inline const CreateInstanceIpWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateInstanceIpWhitelistResponseBody) };
    inline CreateInstanceIpWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateInstanceIpWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateInstanceIpWhitelistResponseBody> body_ {};
  };
