...
namespace Models
{
  ...
  public:
    ...
    inline ListTopicsResponseBodyDataList& setLiteTopicExpiration(int64_t liteTopicExpiration) { DARABONBA_PTR_SET_VALUE(liteTopicExpiration_, liteTopicExpiration) };
