...
namespace Models
{
  ...
  public:
    ...
    inline const ListConsumerGroupSubscriptionsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListConsumerGroupSubscriptionsResponseBody) };
    inline ListConsumerGroupSubscriptionsResponseBody body() { DARABONBA_PTR_GET(body_, ListConsumerGroupSubscriptionsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListConsumerGroupSubscriptionsResponseBody> body_ = nullptr;
  };
