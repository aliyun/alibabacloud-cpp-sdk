...
namespace Models
{
  ...
  public:
    ...
    inline const ListConsumerConnectionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListConsumerConnectionsResponseBody) };
    inline ListConsumerConnectionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListConsumerConnectionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListConsumerConnectionsResponseBody> body_ {};
  };
