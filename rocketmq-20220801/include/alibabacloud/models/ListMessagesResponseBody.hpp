...
namespace Models
{
  ...
  public:
    ...
    inline const ListMessagesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListMessagesResponseBodyData) };
    inline ListMessagesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListMessagesResponseBodyData) };
    inline ListMessagesResponseBody& setData(const ListMessagesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMessagesResponseBody& setData(ListMessagesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListMessagesResponseBodyData> data_ = nullptr;
