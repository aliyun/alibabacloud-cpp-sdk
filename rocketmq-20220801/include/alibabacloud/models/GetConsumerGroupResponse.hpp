...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumerGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetConsumerGroupResponseBody) };
    inline GetConsumerGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetConsumerGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetConsumerGroupResponseBody> body_ {};
  };
