...
namespace Models
{
  ...
  public:
    ...
    inline const ListMigrationsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListMigrationsResponseBodyData) };
    inline ListMigrationsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListMigrationsResponseBodyData) };
    inline ListMigrationsResponseBody& setData(const ListMigrationsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMigrationsResponseBody& setData(ListMigrationsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListMigrationsResponseBodyData> data_ = nullptr;
