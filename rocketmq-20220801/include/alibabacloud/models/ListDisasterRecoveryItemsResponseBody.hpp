...
namespace Models
{
  ...
  public:
    ...
    inline const ListDisasterRecoveryItemsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDisasterRecoveryItemsResponseBodyData) };
    inline ListDisasterRecoveryItemsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDisasterRecoveryItemsResponseBodyData) };
    inline ListDisasterRecoveryItemsResponseBody& setData(const ListDisasterRecoveryItemsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDisasterRecoveryItemsResponseBody& setData(ListDisasterRecoveryItemsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListDisasterRecoveryItemsResponseBodyData> data_ = nullptr;
