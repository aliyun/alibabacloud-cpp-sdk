...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumerGroupLagResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetConsumerGroupLagResponseBodyData) };
    inline GetConsumerGroupLagResponseBodyData data() { DARABONBA_PTR_GET(data_, GetConsumerGroupLagResponseBodyData) };
    inline GetConsumerGroupLagResponseBody& setData(const GetConsumerGroupLagResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetConsumerGroupLagResponseBody& setData(GetConsumerGroupLagResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetConsumerGroupLagResponseBodyData> data_ = nullptr;
    // Dynamic error code
