...
namespace Models
{
  ...
  public:
    ...
    inline const ListDisasterRecoveryPlansResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDisasterRecoveryPlansResponseBodyData) };
    inline ListDisasterRecoveryPlansResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDisasterRecoveryPlansResponseBodyData) };
    inline ListDisasterRecoveryPlansResponseBody& setData(const ListDisasterRecoveryPlansResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDisasterRecoveryPlansResponseBody& setData(ListDisasterRecoveryPlansResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListDisasterRecoveryPlansResponseBodyData> data_ = nullptr;
