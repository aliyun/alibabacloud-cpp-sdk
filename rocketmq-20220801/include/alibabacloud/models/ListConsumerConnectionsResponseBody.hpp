...
namespace Models
{
  ...
  public:
    ...
    inline const ListConsumerConnectionsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListConsumerConnectionsResponseBodyData) };
    inline ListConsumerConnectionsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListConsumerConnectionsResponseBodyData) };
    inline ListConsumerConnectionsResponseBody& setData(const ListConsumerConnectionsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListConsumerConnectionsResponseBody& setData(ListConsumerConnectionsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListConsumerConnectionsResponseBodyData> data_ = nullptr;
