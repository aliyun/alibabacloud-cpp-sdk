...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateInstanceAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateInstanceAccountResponseBody) };
    inline UpdateInstanceAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateInstanceAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateInstanceAccountResponseBody> body_ {};
  };
