...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumerStackResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetConsumerStackResponseBodyData) };
    inline GetConsumerStackResponseBodyData data() { DARABONBA_PTR_GET(data_, GetConsumerStackResponseBodyData) };
    inline GetConsumerStackResponseBody& setData(const GetConsumerStackResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetConsumerStackResponseBody& setData(GetConsumerStackResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetConsumerStackResponseBodyData> data_ = nullptr;
