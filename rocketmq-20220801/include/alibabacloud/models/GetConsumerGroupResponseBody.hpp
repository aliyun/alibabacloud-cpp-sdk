...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumerGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetConsumerGroupResponseBodyData) };
    inline GetConsumerGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, GetConsumerGroupResponseBodyData) };
    inline GetConsumerGroupResponseBody& setData(const GetConsumerGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetConsumerGroupResponseBody& setData(GetConsumerGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetConsumerGroupResponseBodyData> data_ = nullptr;
