...
namespace Models
{
  ...
  public:
    ...
    inline const GetMessageDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMessageDetailResponseBodyData) };
    inline GetMessageDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMessageDetailResponseBodyData) };
    inline GetMessageDetailResponseBody& setData(const GetMessageDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMessageDetailResponseBody& setData(GetMessageDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetMessageDetailResponseBodyData> data_ = nullptr;
