...
namespace Models
{
  ...
  public:
    ...
    inline const GetDisasterRecoveryItemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDisasterRecoveryItemResponseBody) };
    inline GetDisasterRecoveryItemResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDisasterRecoveryItemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDisasterRecoveryItemResponseBody> body_ {};
  };
