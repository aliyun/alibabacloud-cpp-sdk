...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumerStackResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetConsumerStackResponseBody) };
    inline GetConsumerStackResponseBody body() { DARABONBA_PTR_GET(body_, GetConsumerStackResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetConsumerStackResponseBody> body_ = nullptr;
  };
