...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAvailableZonesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAvailableZonesResponseBodyData>) };
    inline vector<ListAvailableZonesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAvailableZonesResponseBodyData>) };
    inline ListAvailableZonesResponseBody& setData(const vector<ListAvailableZonesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAvailableZonesResponseBody& setData(vector<ListAvailableZonesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAvailableZonesResponseBodyData>> data_ = nullptr;
