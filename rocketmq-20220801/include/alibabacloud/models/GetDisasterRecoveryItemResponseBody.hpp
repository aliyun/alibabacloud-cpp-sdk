...
namespace Models
{
  ...
  public:
    ...
    inline const GetDisasterRecoveryItemResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDisasterRecoveryItemResponseBodyData) };
    inline GetDisasterRecoveryItemResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDisasterRecoveryItemResponseBodyData) };
    inline GetDisasterRecoveryItemResponseBody& setData(const GetDisasterRecoveryItemResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDisasterRecoveryItemResponseBody& setData(GetDisasterRecoveryItemResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetDisasterRecoveryItemResponseBodyData> data_ = nullptr;
