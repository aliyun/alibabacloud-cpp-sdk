...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getFlowRuleScoreType() const { DARABONBA_PTR_GET_DEFAULT(flowRuleScoreType_, 0) };
    ...
    inline const vector<GraphFlowNode> & getNodes() const { DARABONBA_PTR_GET_CONST(nodes_, vector<GraphFlowNode>) };
    inline vector<GraphFlowNode> getNodes() { DARABONBA_PTR_GET(nodes_, vector<GraphFlowNode>) };
    ...
    inline string getShowProperties() const { DARABONBA_PTR_GET_DEFAULT(showProperties_, "") };
    ...
    inline bool getSkipWhenFirstSessionNodeMiss() const { DARABONBA_PTR_GET_DEFAULT(skipWhenFirstSessionNodeMiss_, false) };
