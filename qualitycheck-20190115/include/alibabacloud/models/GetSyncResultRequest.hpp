...
#ifndef ALIBABACLOUD_MODELS_GETSYNCRESULTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSYNCRESULTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSyncResultRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, GetSyncResultRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    GetSyncResultRequest() = default ;
    GetSyncResultRequest(const GetSyncResultRequest &) = default ;
    GetSyncResultRequest(GetSyncResultRequest &&) = default ;
    GetSyncResultRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSyncResultRequest() = default ;
    GetSyncResultRequest& operator=(const GetSyncResultRequest &) = default ;
    GetSyncResultRequest& operator=(GetSyncResultRequest &&) = default ;
    ...
    inline GetSyncResultRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline GetSyncResultRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
