...
namespace Models
{
  ...
  public:
    ...
    inline const DelRuleCategoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DelRuleCategoryResponseBodyData) };
    inline DelRuleCategoryResponseBodyData data() { DARABONBA_PTR_GET(data_, DelRuleCategoryResponseBodyData) };
    inline DelRuleCategoryResponseBody& setData(const DelRuleCategoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DelRuleCategoryResponseBody& setData(DelRuleCategoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DelRuleCategoryResponseBodyData> data_ = nullptr;
