...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agent_ == nullptr
        && return this->asrResult_ == nullptr && return this->comments_ == nullptr && return this->createTime_ == nullptr && return this->errorMessage_ == nullptr && return this->hitResult_ == nullptr
        && return this->recording_ == nullptr && return this->resolver_ == nullptr && return this->reviewResult_ == nullptr && return this->reviewStatus_ == nullptr && return this->reviewer_ == nullptr
        && return this->score_ == nullptr && return this->status_ == nullptr && return this->taskId_ == nullptr && return this->taskName_ == nullptr; };
