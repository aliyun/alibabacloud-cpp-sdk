...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWarningConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateWarningConfigResponseBody) };
    inline CreateWarningConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateWarningConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateWarningConfigResponseBody> body_ {};
  };
