...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataSetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataSetResponseBody) };
    inline ListDataSetResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataSetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataSetResponseBody> body_ {};
  };
