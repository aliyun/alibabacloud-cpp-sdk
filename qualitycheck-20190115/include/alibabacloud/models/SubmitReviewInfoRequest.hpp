...
#ifndef ALIBABACLOUD_MODELS_SUBMITREVIEWINFOREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SUBMITREVIEWINFOREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SubmitReviewInfoRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, SubmitReviewInfoRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    SubmitReviewInfoRequest() = default ;
    SubmitReviewInfoRequest(const SubmitReviewInfoRequest &) = default ;
    SubmitReviewInfoRequest(SubmitReviewInfoRequest &&) = default ;
    SubmitReviewInfoRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitReviewInfoRequest() = default ;
    SubmitReviewInfoRequest& operator=(const SubmitReviewInfoRequest &) = default ;
    SubmitReviewInfoRequest& operator=(SubmitReviewInfoRequest &&) = default ;
    ...
    inline SubmitReviewInfoRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline SubmitReviewInfoRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
