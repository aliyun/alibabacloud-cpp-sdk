...
#ifndef ALIBABACLOUD_MODELS_LISTRULESV4REQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTRULESV4REQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListRulesV4Request& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListRulesV4Request& obj) { 
    ...
    ListRulesV4Request() = default ;
    ListRulesV4Request(const ListRulesV4Request &) = default ;
    ListRulesV4Request(ListRulesV4Request &&) = default ;
    ListRulesV4Request(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListRulesV4Request() = default ;
    ListRulesV4Request& operator=(const ListRulesV4Request &) = default ;
    ListRulesV4Request& operator=(ListRulesV4Request &&) = default ;
    ...
    inline ListRulesV4Request& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline ListRulesV4Request& setBusinessName(string businessName) { DARABONBA_PTR_SET_VALUE(businessName_, businessName) };
    ...
    inline ListRulesV4Request& setBusinessRange(int32_t businessRange) { DARABONBA_PTR_SET_VALUE(businessRange_, businessRange) };
    ...
    inline ListRulesV4Request& setCategoryName(string categoryName) { DARABONBA_PTR_SET_VALUE(categoryName_, categoryName) };
    ...
    inline ListRulesV4Request& setCountTotal(bool countTotal) { DARABONBA_PTR_SET_VALUE(countTotal_, countTotal) };
    ...
    inline ListRulesV4Request& setCreateEmpid(string createEmpid) { DARABONBA_PTR_SET_VALUE(createEmpid_, createEmpid) };
    ...
    inline ListRulesV4Request& setCreateUserId(int64_t createUserId) { DARABONBA_PTR_SET_VALUE(createUserId_, createUserId) };
    ...
    inline ListRulesV4Request& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline ListRulesV4Request& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ListRulesV4Request& setLastUpdateEmpid(string lastUpdateEmpid) { DARABONBA_PTR_SET_VALUE(lastUpdateEmpid_, lastUpdateEmpid) };
    ...
    inline ListRulesV4Request& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListRulesV4Request& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListRulesV4Request& setRequireInfos(const vector<string> & requireInfos) { DARABONBA_PTR_SET_VALUE(requireInfos_, requireInfos) };
    inline ListRulesV4Request& setRequireInfos(vector<string> && requireInfos) { DARABONBA_PTR_SET_RVALUE(requireInfos_, requireInfos) };
    ...
    inline ListRulesV4Request& setRid(int64_t rid) { DARABONBA_PTR_SET_VALUE(rid_, rid) };
    ...
    inline ListRulesV4Request& setRuleIdOrRuleName(string ruleIdOrRuleName) { DARABONBA_PTR_SET_VALUE(ruleIdOrRuleName_, ruleIdOrRuleName) };
    ...
    inline ListRulesV4Request& setRuleScoreSingleType(int32_t ruleScoreSingleType) { DARABONBA_PTR_SET_VALUE(ruleScoreSingleType_, ruleScoreSingleType) };
    ...
    inline ListRulesV4Request& setRuleType(int32_t ruleType) { DARABONBA_PTR_SET_VALUE(ruleType_, ruleType) };
    ...
    inline ListRulesV4Request& setSchemeId(int64_t schemeId) { DARABONBA_PTR_SET_VALUE(schemeId_, schemeId) };
    ...
    inline ListRulesV4Request& setSourceType(int32_t sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline ListRulesV4Request& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ListRulesV4Request& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline ListRulesV4Request& setTypeName(string _typeName) { DARABONBA_PTR_SET_VALUE(typeName_, _typeName) };
    ...
    inline ListRulesV4Request& setUpdateEndTime(string updateEndTime) { DARABONBA_PTR_SET_VALUE(updateEndTime_, updateEndTime) };
    ...
    inline ListRulesV4Request& setUpdateStartTime(string updateStartTime) { DARABONBA_PTR_SET_VALUE(updateStartTime_, updateStartTime) };
    ...
    inline ListRulesV4Request& setUpdateUserId(int64_t updateUserId) { DARABONBA_PTR_SET_VALUE(updateUserId_, updateUserId) };
