...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAsrVocabResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAsrVocabResponseBody) };
    inline DeleteAsrVocabResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAsrVocabResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAsrVocabResponseBody> body_ {};
  };
