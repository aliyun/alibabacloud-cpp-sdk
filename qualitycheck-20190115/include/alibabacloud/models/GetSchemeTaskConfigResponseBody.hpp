...
namespace Models
{
  ...
  public:
    ...
    inline const GetSchemeTaskConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSchemeTaskConfigResponseBodyData) };
    inline GetSchemeTaskConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSchemeTaskConfigResponseBodyData) };
    inline GetSchemeTaskConfigResponseBody& setData(const GetSchemeTaskConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSchemeTaskConfigResponseBody& setData(GetSchemeTaskConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSchemeTaskConfigResponseBodyData> data_ = nullptr;
