...
#ifndef ALIBABACLOUD_MODELS_UPLOADDATAREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPLOADDATAREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UploadDataRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, UploadDataRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    UploadDataRequest() = default ;
    UploadDataRequest(const UploadDataRequest &) = default ;
    UploadDataRequest(UploadDataRequest &&) = default ;
    UploadDataRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UploadDataRequest() = default ;
    UploadDataRequest& operator=(const UploadDataRequest &) = default ;
    UploadDataRequest& operator=(UploadDataRequest &&) = default ;
    ...
    inline UploadDataRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline UploadDataRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
