...
#ifndef ALIBABACLOUD_MODELS_INVALIDRULEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_INVALIDRULEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const InvalidRuleRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, InvalidRuleRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    InvalidRuleRequest() = default ;
    InvalidRuleRequest(const InvalidRuleRequest &) = default ;
    InvalidRuleRequest(InvalidRuleRequest &&) = default ;
    InvalidRuleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InvalidRuleRequest() = default ;
    InvalidRuleRequest& operator=(const InvalidRuleRequest &) = default ;
    InvalidRuleRequest& operator=(InvalidRuleRequest &&) = default ;
    ...
    inline InvalidRuleRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline InvalidRuleRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
