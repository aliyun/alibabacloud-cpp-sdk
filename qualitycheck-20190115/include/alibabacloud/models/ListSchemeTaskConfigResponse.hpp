...
namespace Models
{
  ...
  public:
    ...
    inline const ListSchemeTaskConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSchemeTaskConfigResponseBody) };
    inline ListSchemeTaskConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSchemeTaskConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSchemeTaskConfigResponseBody> body_ {};
  };
