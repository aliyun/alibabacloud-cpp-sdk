...
#ifndef ALIBABACLOUD_MODELS_GETASRVOCABREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETASRVOCABREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAsrVocabRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, GetAsrVocabRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    GetAsrVocabRequest() = default ;
    GetAsrVocabRequest(const GetAsrVocabRequest &) = default ;
    GetAsrVocabRequest(GetAsrVocabRequest &&) = default ;
    GetAsrVocabRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAsrVocabRequest() = default ;
    GetAsrVocabRequest& operator=(const GetAsrVocabRequest &) = default ;
    GetAsrVocabRequest& operator=(GetAsrVocabRequest &&) = default ;
    ...
    inline GetAsrVocabRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline GetAsrVocabRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
