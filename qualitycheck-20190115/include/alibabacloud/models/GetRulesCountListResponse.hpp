...
namespace Models
{
  ...
  public:
    ...
    inline const GetRulesCountListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRulesCountListResponseBody) };
    inline GetRulesCountListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRulesCountListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRulesCountListResponseBody> body_ {};
  };
