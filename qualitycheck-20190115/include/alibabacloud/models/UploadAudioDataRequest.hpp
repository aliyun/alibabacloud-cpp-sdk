...
#ifndef ALIBABACLOUD_MODELS_UPLOADAUDIODATAREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPLOADAUDIODATAREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UploadAudioDataRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, UploadAudioDataRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    UploadAudioDataRequest() = default ;
    UploadAudioDataRequest(const UploadAudioDataRequest &) = default ;
    UploadAudioDataRequest(UploadAudioDataRequest &&) = default ;
    UploadAudioDataRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UploadAudioDataRequest() = default ;
    UploadAudioDataRequest& operator=(const UploadAudioDataRequest &) = default ;
    UploadAudioDataRequest& operator=(UploadAudioDataRequest &&) = default ;
    ...
    inline UploadAudioDataRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline UploadAudioDataRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
