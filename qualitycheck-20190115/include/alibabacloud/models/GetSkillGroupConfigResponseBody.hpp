...
#ifndef ALIBABACLOUD_MODELS_GETSKILLGROUPCONFIGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETSKILLGROUPCONFIGRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSkillGroupConfigResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSkillGroupConfigResponseBody& obj) { 
    ...
    GetSkillGroupConfigResponseBody() = default ;
    GetSkillGroupConfigResponseBody(const GetSkillGroupConfigResponseBody &) = default ;
    GetSkillGroupConfigResponseBody(GetSkillGroupConfigResponseBody &&) = default ;
    GetSkillGroupConfigResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSkillGroupConfigResponseBody() = default ;
    GetSkillGroupConfigResponseBody& operator=(const GetSkillGroupConfigResponseBody &) = default ;
    GetSkillGroupConfigResponseBody& operator=(GetSkillGroupConfigResponseBody &&) = default ;
    ...
    public:
      ...
      inline Data& setAllContentQualityCheck(int32_t allContentQualityCheck) { DARABONBA_PTR_SET_VALUE(allContentQualityCheck_, allContentQualityCheck) };
      ...
      inline Data& setAllRids(string allRids) { DARABONBA_PTR_SET_VALUE(allRids_, allRids) };
      ...
      inline const Data::AllRuleList & getAllRuleList() const { DARABONBA_PTR_GET_CONST(allRuleList_, Data::AllRuleList) };
      inline Data::AllRuleList getAllRuleList() { DARABONBA_PTR_GET(allRuleList_, Data::AllRuleList) };
      inline Data& setAllRuleList(const Data::AllRuleList & allRuleList) { DARABONBA_PTR_SET_VALUE(allRuleList_, allRuleList) };
      inline Data& setAllRuleList(Data::AllRuleList && allRuleList) { DARABONBA_PTR_SET_RVALUE(allRuleList_, allRuleList) };
      ...
      inline Data& setQualityCheckType(int32_t qualityCheckType) { DARABONBA_PTR_SET_VALUE(qualityCheckType_, qualityCheckType) };
      ...
      inline Data& setRid(string rid) { DARABONBA_PTR_SET_VALUE(rid_, rid) };
      ...
      inline Data& setSkillGroupFrom(int32_t skillGroupFrom) { DARABONBA_PTR_SET_VALUE(skillGroupFrom_, skillGroupFrom) };
      ...
      inline Data& setVocabId(int64_t vocabId) { DARABONBA_PTR_SET_VALUE(vocabId_, vocabId) };
      ...
      inline Data& setVocabName(string vocabName) { DARABONBA_PTR_SET_VALUE(vocabName_, vocabName) };
    ...
    inline GetSkillGroupConfigResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetSkillGroupConfigResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetSkillGroupConfigResponseBody::Data) };
    inline GetSkillGroupConfigResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetSkillGroupConfigResponseBody::Data) };
    inline GetSkillGroupConfigResponseBody& setData(const GetSkillGroupConfigResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSkillGroupConfigResponseBody& setData(GetSkillGroupConfigResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetSkillGroupConfigResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetSkillGroupConfigResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetSkillGroupConfigResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
