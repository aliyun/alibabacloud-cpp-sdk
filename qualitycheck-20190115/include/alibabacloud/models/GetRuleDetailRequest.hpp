...
#ifndef ALIBABACLOUD_MODELS_GETRULEDETAILREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETRULEDETAILREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetRuleDetailRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, GetRuleDetailRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    GetRuleDetailRequest() = default ;
    GetRuleDetailRequest(const GetRuleDetailRequest &) = default ;
    GetRuleDetailRequest(GetRuleDetailRequest &&) = default ;
    GetRuleDetailRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetRuleDetailRequest() = default ;
    GetRuleDetailRequest& operator=(const GetRuleDetailRequest &) = default ;
    GetRuleDetailRequest& operator=(GetRuleDetailRequest &&) = default ;
    ...
    inline GetRuleDetailRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline GetRuleDetailRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
