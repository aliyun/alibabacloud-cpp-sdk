...
namespace Models
{
  ...
  public:
    ...
    inline const ListWarningStrategyConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListWarningStrategyConfigResponseBodyData) };
    inline ListWarningStrategyConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, ListWarningStrategyConfigResponseBodyData) };
    inline ListWarningStrategyConfigResponseBody& setData(const ListWarningStrategyConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListWarningStrategyConfigResponseBody& setData(ListWarningStrategyConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListWarningStrategyConfigResponseBodyData> data_ = nullptr;
