...
#ifndef ALIBABACLOUD_MODELS_SUBMITCOMPLAINTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SUBMITCOMPLAINTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SubmitComplaintRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, SubmitComplaintRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    SubmitComplaintRequest() = default ;
    SubmitComplaintRequest(const SubmitComplaintRequest &) = default ;
    SubmitComplaintRequest(SubmitComplaintRequest &&) = default ;
    SubmitComplaintRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitComplaintRequest() = default ;
    SubmitComplaintRequest& operator=(const SubmitComplaintRequest &) = default ;
    SubmitComplaintRequest& operator=(SubmitComplaintRequest &&) = default ;
    ...
    inline SubmitComplaintRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline SubmitComplaintRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
