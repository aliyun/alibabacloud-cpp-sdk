...
namespace Models
{
  ...
  public:
    ...
    inline const ListSkillGroupConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListSkillGroupConfigResponseBodyData) };
    inline ListSkillGroupConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, ListSkillGroupConfigResponseBodyData) };
    inline ListSkillGroupConfigResponseBody& setData(const ListSkillGroupConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSkillGroupConfigResponseBody& setData(ListSkillGroupConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListSkillGroupConfigResponseBodyData> data_ = nullptr;
