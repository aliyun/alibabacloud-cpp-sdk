...
namespace Models
{
  ...
  public:
    ...
    inline const TestRuleV4ResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, TestRuleV4ResponseBodyData) };
    inline TestRuleV4ResponseBodyData data() { DARABONBA_PTR_GET(data_, TestRuleV4ResponseBodyData) };
    inline TestRuleV4ResponseBody& setData(const TestRuleV4ResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TestRuleV4ResponseBody& setData(TestRuleV4ResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<TestRuleV4ResponseBodyData> data_ = nullptr;
