...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCheckTypeToSchemeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCheckTypeToSchemeResponseBody) };
    inline CreateCheckTypeToSchemeResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCheckTypeToSchemeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCheckTypeToSchemeResponseBody> body_ {};
  };
