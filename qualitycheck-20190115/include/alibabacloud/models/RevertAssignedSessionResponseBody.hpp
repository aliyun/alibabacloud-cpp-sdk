...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RevertAssignedSessionResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RevertAssignedSessionResponseBody& obj) { 
    ...
    RevertAssignedSessionResponseBody() = default ;
    RevertAssignedSessionResponseBody(const RevertAssignedSessionResponseBody &) = default ;
    RevertAssignedSessionResponseBody(RevertAssignedSessionResponseBody &&) = default ;
    RevertAssignedSessionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RevertAssignedSessionResponseBody() = default ;
    RevertAssignedSessionResponseBody& operator=(const RevertAssignedSessionResponseBody &) = default ;
    RevertAssignedSessionResponseBody& operator=(RevertAssignedSessionResponseBody &&) = default ;
