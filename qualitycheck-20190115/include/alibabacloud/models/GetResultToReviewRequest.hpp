...
#ifndef ALIBABACLOUD_MODELS_GETRESULTTOREVIEWREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETRESULTTOREVIEWREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetResultToReviewRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, GetResultToReviewRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    GetResultToReviewRequest() = default ;
    GetResultToReviewRequest(const GetResultToReviewRequest &) = default ;
    GetResultToReviewRequest(GetResultToReviewRequest &&) = default ;
    GetResultToReviewRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetResultToReviewRequest() = default ;
    GetResultToReviewRequest& operator=(const GetResultToReviewRequest &) = default ;
    GetResultToReviewRequest& operator=(GetResultToReviewRequest &&) = default ;
    ...
    inline GetResultToReviewRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline GetResultToReviewRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
