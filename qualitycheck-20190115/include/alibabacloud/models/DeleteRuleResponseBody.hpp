...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRuleResponseBodyMessages & messages() const { DARABONBA_PTR_GET_CONST(messages_, DeleteRuleResponseBodyMessages) };
    inline DeleteRuleResponseBodyMessages messages() { DARABONBA_PTR_GET(messages_, DeleteRuleResponseBodyMessages) };
    inline DeleteRuleResponseBody& setMessages(const DeleteRuleResponseBodyMessages & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline DeleteRuleResponseBody& setMessages(DeleteRuleResponseBodyMessages && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteRuleResponseBodyMessages> messages_ = nullptr;
