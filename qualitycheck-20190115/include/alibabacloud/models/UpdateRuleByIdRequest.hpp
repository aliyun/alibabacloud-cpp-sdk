...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->baseMeAgentId_ == nullptr
        && this->isCopy_ == nullptr && this->jsonStrForRule_ == nullptr && this->returnRelatedSchemes_ == nullptr && this->ruleId_ == nullptr; };
    ...
    inline string getJsonStrForRule() const { DARABONBA_PTR_GET_DEFAULT(jsonStrForRule_, "") };
    ...
    inline bool getReturnRelatedSchemes() const { DARABONBA_PTR_GET_DEFAULT(returnRelatedSchemes_, false) };
