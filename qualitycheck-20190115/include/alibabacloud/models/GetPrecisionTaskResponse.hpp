...
namespace Models
{
  ...
  public:
    ...
    inline const GetPrecisionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPrecisionTaskResponseBody) };
    inline GetPrecisionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPrecisionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPrecisionTaskResponseBody> body_ {};
  };
