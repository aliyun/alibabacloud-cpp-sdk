...
#ifndef ALIBABACLOUD_MODELS_DELETEASRVOCABREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETEASRVOCABREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteAsrVocabRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteAsrVocabRequest& obj) { 
    ...
    DeleteAsrVocabRequest(const DeleteAsrVocabRequest &) = default ;
    DeleteAsrVocabRequest(DeleteAsrVocabRequest &&) = default ;
    DeleteAsrVocabRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteAsrVocabRequest() = default ;
    DeleteAsrVocabRequest& operator=(const DeleteAsrVocabRequest &) = default ;
    DeleteAsrVocabRequest& operator=(DeleteAsrVocabRequest &&) = default ;
    ...
    inline DeleteAsrVocabRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline DeleteAsrVocabRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
