...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRuleByIdResponseBody::Messages & getMessages() const { DARABONBA_PTR_GET_CONST(messages_, UpdateRuleByIdResponseBody::Messages) };
    inline UpdateRuleByIdResponseBody::Messages getMessages() { DARABONBA_PTR_GET(messages_, UpdateRuleByIdResponseBody::Messages) };
    inline UpdateRuleByIdResponseBody& setMessages(const UpdateRuleByIdResponseBody::Messages & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline UpdateRuleByIdResponseBody& setMessages(UpdateRuleByIdResponseBody::Messages && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
  ...
  protected:
    ...
    shared_ptr<UpdateRuleByIdResponseBody::Messages> messages_ {};
