...
#ifndef ALIBABACLOUD_MODELS_SYNCQUALITYCHECKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SYNCQUALITYCHECKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SyncQualityCheckRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, SyncQualityCheckRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    SyncQualityCheckRequest() = default ;
    SyncQualityCheckRequest(const SyncQualityCheckRequest &) = default ;
    SyncQualityCheckRequest(SyncQualityCheckRequest &&) = default ;
    SyncQualityCheckRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SyncQualityCheckRequest() = default ;
    SyncQualityCheckRequest& operator=(const SyncQualityCheckRequest &) = default ;
    SyncQualityCheckRequest& operator=(SyncQualityCheckRequest &&) = default ;
    ...
    inline SyncQualityCheckRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline SyncQualityCheckRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
