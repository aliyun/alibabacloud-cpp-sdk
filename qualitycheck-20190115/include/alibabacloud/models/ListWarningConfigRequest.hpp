...
#ifndef ALIBABACLOUD_MODELS_LISTWARNINGCONFIGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTWARNINGCONFIGREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListWarningConfigRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, ListWarningConfigRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    ListWarningConfigRequest() = default ;
    ListWarningConfigRequest(const ListWarningConfigRequest &) = default ;
    ListWarningConfigRequest(ListWarningConfigRequest &&) = default ;
    ListWarningConfigRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListWarningConfigRequest() = default ;
    ListWarningConfigRequest& operator=(const ListWarningConfigRequest &) = default ;
    ListWarningConfigRequest& operator=(ListWarningConfigRequest &&) = default ;
    ...
    inline ListWarningConfigRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline ListWarningConfigRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
