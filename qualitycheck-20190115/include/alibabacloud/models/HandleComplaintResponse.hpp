...
namespace Models
{
  ...
  public:
    ...
    inline const HandleComplaintResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HandleComplaintResponseBody) };
    inline HandleComplaintResponseBody getBody() { DARABONBA_PTR_GET(body_, HandleComplaintResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HandleComplaintResponseBody> body_ {};
  };
