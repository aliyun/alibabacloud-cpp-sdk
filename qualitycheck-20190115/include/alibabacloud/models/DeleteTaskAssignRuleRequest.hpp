...
#ifndef ALIBABACLOUD_MODELS_DELETETASKASSIGNRULEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETETASKASSIGNRULEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteTaskAssignRuleRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteTaskAssignRuleRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    DeleteTaskAssignRuleRequest() = default ;
    DeleteTaskAssignRuleRequest(const DeleteTaskAssignRuleRequest &) = default ;
    DeleteTaskAssignRuleRequest(DeleteTaskAssignRuleRequest &&) = default ;
    DeleteTaskAssignRuleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteTaskAssignRuleRequest() = default ;
    DeleteTaskAssignRuleRequest& operator=(const DeleteTaskAssignRuleRequest &) = default ;
    DeleteTaskAssignRuleRequest& operator=(DeleteTaskAssignRuleRequest &&) = default ;
