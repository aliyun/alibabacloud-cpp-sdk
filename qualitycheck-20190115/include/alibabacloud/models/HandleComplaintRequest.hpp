...
#ifndef ALIBABACLOUD_MODELS_HANDLECOMPLAINTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_HANDLECOMPLAINTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const HandleComplaintRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, HandleComplaintRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    HandleComplaintRequest() = default ;
    HandleComplaintRequest(const HandleComplaintRequest &) = default ;
    HandleComplaintRequest(HandleComplaintRequest &&) = default ;
    HandleComplaintRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~HandleComplaintRequest() = default ;
    HandleComplaintRequest& operator=(const HandleComplaintRequest &) = default ;
    HandleComplaintRequest& operator=(HandleComplaintRequest &&) = default ;
    ...
    inline HandleComplaintRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline HandleComplaintRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
