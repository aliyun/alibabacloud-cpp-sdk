...
#ifndef ALIBABACLOUD_MODELS_LISTDATASETREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTDATASETREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDataSetRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, ListDataSetRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    ListDataSetRequest() = default ;
    ListDataSetRequest(const ListDataSetRequest &) = default ;
    ListDataSetRequest(ListDataSetRequest &&) = default ;
    ListDataSetRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDataSetRequest() = default ;
    ListDataSetRequest& operator=(const ListDataSetRequest &) = default ;
    ListDataSetRequest& operator=(ListDataSetRequest &&) = default ;
    ...
    inline ListDataSetRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline ListDataSetRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
