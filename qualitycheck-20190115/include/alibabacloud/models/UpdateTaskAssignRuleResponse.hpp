...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTaskAssignRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTaskAssignRuleResponseBody) };
    inline UpdateTaskAssignRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTaskAssignRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTaskAssignRuleResponseBody> body_ {};
  };
