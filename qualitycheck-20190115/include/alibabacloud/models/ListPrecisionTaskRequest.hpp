...
#ifndef ALIBABACLOUD_MODELS_LISTPRECISIONTASKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTPRECISIONTASKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPrecisionTaskRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, ListPrecisionTaskRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    ListPrecisionTaskRequest() = default ;
    ListPrecisionTaskRequest(const ListPrecisionTaskRequest &) = default ;
    ListPrecisionTaskRequest(ListPrecisionTaskRequest &&) = default ;
    ListPrecisionTaskRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPrecisionTaskRequest() = default ;
    ListPrecisionTaskRequest& operator=(const ListPrecisionTaskRequest &) = default ;
    ListPrecisionTaskRequest& operator=(ListPrecisionTaskRequest &&) = default ;
    ...
    inline ListPrecisionTaskRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline ListPrecisionTaskRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
