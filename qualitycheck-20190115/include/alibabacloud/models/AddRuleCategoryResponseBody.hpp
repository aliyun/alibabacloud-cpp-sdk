...
namespace Models
{
  ...
  public:
    ...
    inline const AddRuleCategoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddRuleCategoryResponseBodyData) };
    inline AddRuleCategoryResponseBodyData data() { DARABONBA_PTR_GET(data_, AddRuleCategoryResponseBodyData) };
    inline AddRuleCategoryResponseBody& setData(const AddRuleCategoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddRuleCategoryResponseBody& setData(AddRuleCategoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<AddRuleCategoryResponseBodyData> data_ = nullptr;
