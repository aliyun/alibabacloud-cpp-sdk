...
namespace Models
{
  ...
  public:
    ...
    inline const RevertAssignedSessionGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RevertAssignedSessionGroupResponseBody) };
    inline RevertAssignedSessionGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, RevertAssignedSessionGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RevertAssignedSessionGroupResponseBody> body_ {};
  };
