...
#ifndef ALIBABACLOUD_MODELS_GETTAGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETTAGREQUEST_HPP_
...
namespace Models
{
  class GetTagRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetTagRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, GetTagRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    GetTagRequest() = default ;
    GetTagRequest(const GetTagRequest &) = default ;
    GetTagRequest(GetTagRequest &&) = default ;
    GetTagRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetTagRequest() = default ;
    GetTagRequest& operator=(const GetTagRequest &) = default ;
    GetTagRequest& operator=(GetTagRequest &&) = default ;
    ...
    inline GetTagRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline GetTagRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
