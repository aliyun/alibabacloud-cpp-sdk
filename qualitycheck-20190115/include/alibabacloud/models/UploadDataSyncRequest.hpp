...
#ifndef ALIBABACLOUD_MODELS_UPLOADDATASYNCREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPLOADDATASYNCREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UploadDataSyncRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, UploadDataSyncRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    UploadDataSyncRequest() = default ;
    UploadDataSyncRequest(const UploadDataSyncRequest &) = default ;
    UploadDataSyncRequest(UploadDataSyncRequest &&) = default ;
    UploadDataSyncRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UploadDataSyncRequest() = default ;
    UploadDataSyncRequest& operator=(const UploadDataSyncRequest &) = default ;
    UploadDataSyncRequest& operator=(UploadDataSyncRequest &&) = default ;
    ...
    inline UploadDataSyncRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline UploadDataSyncRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
