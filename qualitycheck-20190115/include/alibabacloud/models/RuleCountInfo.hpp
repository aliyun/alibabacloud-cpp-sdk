...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BusinessCategoryBasicInfo> & getBusinessCategoryBasicInfoList() const { DARABONBA_PTR_GET_CONST(businessCategoryBasicInfoList_, vector<BusinessCategoryBasicInfo>) };
    inline vector<BusinessCategoryBasicInfo> getBusinessCategoryBasicInfoList() { DARABONBA_PTR_GET(businessCategoryBasicInfoList_, vector<BusinessCategoryBasicInfo>) };
    ...
    inline const vector<int32_t> & getBusinessRange() const { DARABONBA_PTR_GET_CONST(businessRange_, vector<int32_t>) };
    inline vector<int32_t> getBusinessRange() { DARABONBA_PTR_GET(businessRange_, vector<int32_t>) };
    ...
    inline int64_t getCheckNumber() const { DARABONBA_PTR_GET_DEFAULT(checkNumber_, 0L) };
    ...
    inline float getHitRate() const { DARABONBA_PTR_GET_DEFAULT(hitRate_, 0.0) };
    ...
    inline float getHitRealViolationRate() const { DARABONBA_PTR_GET_DEFAULT(hitRealViolationRate_, 0.0) };
    ...
    inline bool getIsSelect() const { DARABONBA_PTR_GET_DEFAULT(isSelect_, false) };
    ...
    inline int64_t getPreReviewNumber() const { DARABONBA_PTR_GET_DEFAULT(preReviewNumber_, 0L) };
    ...
    inline int64_t getProblemNumber() const { DARABONBA_PTR_GET_DEFAULT(problemNumber_, 0L) };
    ...
    inline int32_t getRealViolationNumber() const { DARABONBA_PTR_GET_DEFAULT(realViolationNumber_, 0) };
    ...
    inline float getReviewAccuracyRate() const { DARABONBA_PTR_GET_DEFAULT(reviewAccuracyRate_, 0.0) };
    ...
    inline int64_t getReviewNumber() const { DARABONBA_PTR_GET_DEFAULT(reviewNumber_, 0L) };
    ...
    inline float getReviewRate() const { DARABONBA_PTR_GET_DEFAULT(reviewRate_, 0.0) };
    ...
    inline string getReviewStatusName() const { DARABONBA_PTR_GET_DEFAULT(reviewStatusName_, "") };
    ...
    inline int64_t getUnReviewNumber() const { DARABONBA_PTR_GET_DEFAULT(unReviewNumber_, 0L) };
