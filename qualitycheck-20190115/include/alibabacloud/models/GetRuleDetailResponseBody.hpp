...
namespace Models
{
  ...
  public:
    ...
    inline const GetRuleDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRuleDetailResponseBodyData) };
    inline GetRuleDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRuleDetailResponseBodyData) };
    inline GetRuleDetailResponseBody& setData(const GetRuleDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRuleDetailResponseBody& setData(GetRuleDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetRuleDetailResponseBodyData> data_ = nullptr;
