...
namespace Models
{
  ...
  public:
    ...
    inline const GetBusinessCategoryListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetBusinessCategoryListResponseBodyData) };
    inline GetBusinessCategoryListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetBusinessCategoryListResponseBodyData) };
    inline GetBusinessCategoryListResponseBody& setData(const GetBusinessCategoryListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetBusinessCategoryListResponseBody& setData(GetBusinessCategoryListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetBusinessCategoryListResponseBodyData> data_ = nullptr;
