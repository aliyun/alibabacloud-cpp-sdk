...
namespace Models
{
  ...
  public:
    ...
    inline const UploadRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UploadRuleResponseBodyData) };
    inline UploadRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, UploadRuleResponseBodyData) };
    inline UploadRuleResponseBody& setData(const UploadRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UploadRuleResponseBody& setData(UploadRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UploadRuleResponseBodyData> data_ = nullptr;
