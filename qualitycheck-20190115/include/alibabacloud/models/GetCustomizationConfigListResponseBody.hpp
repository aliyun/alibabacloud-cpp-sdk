...
namespace Models
{
  ...
  public:
    ...
    inline const GetCustomizationConfigListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCustomizationConfigListResponseBodyData) };
    inline GetCustomizationConfigListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCustomizationConfigListResponseBodyData) };
    inline GetCustomizationConfigListResponseBody& setData(const GetCustomizationConfigListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCustomizationConfigListResponseBody& setData(GetCustomizationConfigListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetCustomizationConfigListResponseBodyData> data_ = nullptr;
