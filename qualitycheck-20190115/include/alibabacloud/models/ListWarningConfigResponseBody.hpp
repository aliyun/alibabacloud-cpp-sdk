...
namespace Models
{
  ...
  public:
    ...
    inline const ListWarningConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListWarningConfigResponseBodyData) };
    inline ListWarningConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, ListWarningConfigResponseBodyData) };
    inline ListWarningConfigResponseBody& setData(const ListWarningConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListWarningConfigResponseBody& setData(ListWarningConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListWarningConfigResponseBodyData> data_ = nullptr;
