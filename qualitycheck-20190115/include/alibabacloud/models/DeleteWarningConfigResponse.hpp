...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWarningConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWarningConfigResponseBody) };
    inline DeleteWarningConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWarningConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWarningConfigResponseBody> body_ {};
  };
