...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRuleToSchemeResponseBodyMessages & messages() const { DARABONBA_PTR_GET_CONST(messages_, UpdateRuleToSchemeResponseBodyMessages) };
    inline UpdateRuleToSchemeResponseBodyMessages messages() { DARABONBA_PTR_GET(messages_, UpdateRuleToSchemeResponseBodyMessages) };
    inline UpdateRuleToSchemeResponseBody& setMessages(const UpdateRuleToSchemeResponseBodyMessages & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline UpdateRuleToSchemeResponseBody& setMessages(UpdateRuleToSchemeResponseBodyMessages && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateRuleToSchemeResponseBodyMessages> messages_ = nullptr;
