...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->comments_ == nullptr
        && return this->level_ == nullptr && return this->ruleCategoryName_ == nullptr && return this->scoreNum_ == nullptr && return this->scoreNumType_ == nullptr && return this->scoreType_ == nullptr
