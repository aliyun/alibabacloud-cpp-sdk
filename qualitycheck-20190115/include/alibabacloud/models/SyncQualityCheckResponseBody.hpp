...
namespace Models
{
  ...
  public:
    ...
    inline const SyncQualityCheckResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SyncQualityCheckResponseBodyData) };
    inline SyncQualityCheckResponseBodyData data() { DARABONBA_PTR_GET(data_, SyncQualityCheckResponseBodyData) };
    inline SyncQualityCheckResponseBody& setData(const SyncQualityCheckResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SyncQualityCheckResponseBody& setData(SyncQualityCheckResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SyncQualityCheckResponseBodyData> data_ = nullptr;
