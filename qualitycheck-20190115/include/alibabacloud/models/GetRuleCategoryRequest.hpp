...
#ifndef ALIBABACLOUD_MODELS_GETRULECATEGORYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETRULECATEGORYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetRuleCategoryRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, GetRuleCategoryRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    GetRuleCategoryRequest() = default ;
    GetRuleCategoryRequest(const GetRuleCategoryRequest &) = default ;
    GetRuleCategoryRequest(GetRuleCategoryRequest &&) = default ;
    GetRuleCategoryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetRuleCategoryRequest() = default ;
    GetRuleCategoryRequest& operator=(const GetRuleCategoryRequest &) = default ;
    GetRuleCategoryRequest& operator=(GetRuleCategoryRequest &&) = default ;
    ...
    inline GetRuleCategoryRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline GetRuleCategoryRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
