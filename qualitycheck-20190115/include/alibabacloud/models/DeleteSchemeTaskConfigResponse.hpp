...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSchemeTaskConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSchemeTaskConfigResponseBody) };
    inline DeleteSchemeTaskConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSchemeTaskConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSchemeTaskConfigResponseBody> body_ {};
  };
