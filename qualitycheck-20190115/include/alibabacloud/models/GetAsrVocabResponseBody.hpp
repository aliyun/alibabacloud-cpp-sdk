...
namespace Models
{
  ...
  public:
    ...
    inline const GetAsrVocabResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAsrVocabResponseBodyData) };
    inline GetAsrVocabResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAsrVocabResponseBodyData) };
    inline GetAsrVocabResponseBody& setData(const GetAsrVocabResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAsrVocabResponseBody& setData(GetAsrVocabResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAsrVocabResponseBodyData> data_ = nullptr;
