...
#ifndef ALIBABACLOUD_MODELS_UPLOADDATASYNCRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPLOADDATASYNCRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UploadDataSyncResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UploadDataSyncResponseBody& obj) { 
    ...
    UploadDataSyncResponseBody() = default ;
    UploadDataSyncResponseBody(const UploadDataSyncResponseBody &) = default ;
    UploadDataSyncResponseBody(UploadDataSyncResponseBody &&) = default ;
    UploadDataSyncResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UploadDataSyncResponseBody() = default ;
    UploadDataSyncResponseBody& operator=(const UploadDataSyncResponseBody &) = default ;
    UploadDataSyncResponseBody& operator=(UploadDataSyncResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->val_ == nullptr; };
                    ...
                    inline string getIsMatch() const { DARABONBA_PTR_GET_DEFAULT(isMatch_, "") };
                    inline HitKeyWord& setIsMatch(string isMatch) { DARABONBA_PTR_SET_VALUE(isMatch_, isMatch) };
        ...
        class HandScoreIdList : public Darabonba::Model {
        public:
          friend void to_json(Darabonba::Json& j, const HandScoreIdList& obj) { 
            DARABONBA_PTR_TO_JSON(HandScoreIdList, handScoreIdList_);
          };
          friend void from_json(const Darabonba::Json& j, HandScoreIdList& obj) { 
            DARABONBA_PTR_FROM_JSON(HandScoreIdList, handScoreIdList_);
          };
          HandScoreIdList() = default ;
          HandScoreIdList(const HandScoreIdList &) = default ;
          HandScoreIdList(HandScoreIdList &&) = default ;
          HandScoreIdList(const Darabonba::Json & obj) { from_json(obj, *this); };
          virtual ~HandScoreIdList() = default ;
          HandScoreIdList& operator=(const HandScoreIdList &) = default ;
          HandScoreIdList& operator=(HandScoreIdList &&) = default ;
          virtual void validate() const override {
          };
          virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
          virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
          ...
          inline const vector<string> & getHandScoreIdList() const { DARABONBA_PTR_GET_CONST(handScoreIdList_, vector<string>) };
          inline vector<string> getHandScoreIdList() { DARABONBA_PTR_GET(handScoreIdList_, vector<string>) };
          inline HandScoreIdList& setHandScoreIdList(const vector<string> & handScoreIdList) { DARABONBA_PTR_SET_VALUE(handScoreIdList_, handScoreIdList) };
          inline HandScoreIdList& setHandScoreIdList(vector<string> && handScoreIdList) { DARABONBA_PTR_SET_RVALUE(handScoreIdList_, handScoreIdList) };


        protected:
          shared_ptr<vector<string>> handScoreIdList_ {};
        };
        ...
        bool hasHandScoreIdList() const { return this->handScoreIdList_ != nullptr;};
        void deleteHandScoreIdList() { this->handScoreIdList_ = nullptr;};
        inline const ResultInfo::HandScoreIdList & getHandScoreIdList() const { DARABONBA_PTR_GET_CONST(handScoreIdList_, ResultInfo::HandScoreIdList) };
        inline ResultInfo::HandScoreIdList getHandScoreIdList() { DARABONBA_PTR_GET(handScoreIdList_, ResultInfo::HandScoreIdList) };
        inline ResultInfo& setHandScoreIdList(const ResultInfo::HandScoreIdList & handScoreIdList) { DARABONBA_PTR_SET_VALUE(handScoreIdList_, handScoreIdList) };
        inline ResultInfo& setHandScoreIdList(ResultInfo::HandScoreIdList && handScoreIdList) { DARABONBA_PTR_SET_RVALUE(handScoreIdList_, handScoreIdList) };
    ...
    inline UploadDataSyncResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const UploadDataSyncResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UploadDataSyncResponseBody::Data) };
    inline UploadDataSyncResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UploadDataSyncResponseBody::Data) };
    inline UploadDataSyncResponseBody& setData(const UploadDataSyncResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UploadDataSyncResponseBody& setData(UploadDataSyncResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UploadDataSyncResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UploadDataSyncResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline UploadDataSyncResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
