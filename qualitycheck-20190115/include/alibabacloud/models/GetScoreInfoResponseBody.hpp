...
namespace Models
{
  ...
  public:
    ...
    inline const GetScoreInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetScoreInfoResponseBodyData) };
    inline GetScoreInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetScoreInfoResponseBodyData) };
    inline GetScoreInfoResponseBody& setData(const GetScoreInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetScoreInfoResponseBody& setData(GetScoreInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetScoreInfoResponseBodyData> data_ = nullptr;
