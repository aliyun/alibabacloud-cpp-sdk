...
namespace Models
{
  ...
  public:
    ...
    inline const ListQualityCheckSchemeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListQualityCheckSchemeResponseBody) };
    inline ListQualityCheckSchemeResponseBody getBody() { DARABONBA_PTR_GET(body_, ListQualityCheckSchemeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListQualityCheckSchemeResponseBody> body_ {};
  };
