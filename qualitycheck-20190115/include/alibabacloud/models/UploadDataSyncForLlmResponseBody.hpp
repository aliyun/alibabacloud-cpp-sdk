...
namespace Models
{
  ...
  public:
    ...
    inline const UploadDataSyncForLLMResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UploadDataSyncForLLMResponseBodyData) };
    inline UploadDataSyncForLLMResponseBodyData data() { DARABONBA_PTR_GET(data_, UploadDataSyncForLLMResponseBodyData) };
    inline UploadDataSyncForLLMResponseBody& setData(const UploadDataSyncForLLMResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UploadDataSyncForLLMResponseBody& setData(UploadDataSyncForLLMResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UploadDataSyncForLLMResponseBodyData> data_ = nullptr;
