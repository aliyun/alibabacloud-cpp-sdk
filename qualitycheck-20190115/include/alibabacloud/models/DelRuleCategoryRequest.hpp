...
#ifndef ALIBABACLOUD_MODELS_DELRULECATEGORYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELRULECATEGORYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DelRuleCategoryRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, DelRuleCategoryRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    DelRuleCategoryRequest() = default ;
    DelRuleCategoryRequest(const DelRuleCategoryRequest &) = default ;
    DelRuleCategoryRequest(DelRuleCategoryRequest &&) = default ;
    DelRuleCategoryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DelRuleCategoryRequest() = default ;
    DelRuleCategoryRequest& operator=(const DelRuleCategoryRequest &) = default ;
    DelRuleCategoryRequest& operator=(DelRuleCategoryRequest &&) = default ;
    ...
    inline DelRuleCategoryRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline DelRuleCategoryRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
