...
namespace Models
{
  ...
  public:
    ...
    inline const ListAsrVocabResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAsrVocabResponseBodyData) };
    inline ListAsrVocabResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAsrVocabResponseBodyData) };
    inline ListAsrVocabResponseBody& setData(const ListAsrVocabResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAsrVocabResponseBody& setData(ListAsrVocabResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListAsrVocabResponseBodyData> data_ = nullptr;
