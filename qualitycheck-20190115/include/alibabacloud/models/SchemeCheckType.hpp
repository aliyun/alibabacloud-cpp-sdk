...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->checkName_ == nullptr
        && return this->checkType_ == nullptr && return this->enable_ == nullptr && return this->schemeId_ == nullptr && return this->schemeScoreInfoList_ == nullptr && return this->score_ == nullptr
        && return this->sourceScore_ == nullptr && return this->taskFlowScoreInfoList_ == nullptr; };
