...
#ifndef ALIBABACLOUD_MODELS_VERIFYSENTENCEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_VERIFYSENTENCEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const VerifySentenceRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, VerifySentenceRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    VerifySentenceRequest() = default ;
    VerifySentenceRequest(const VerifySentenceRequest &) = default ;
    VerifySentenceRequest(VerifySentenceRequest &&) = default ;
    VerifySentenceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~VerifySentenceRequest() = default ;
    VerifySentenceRequest& operator=(const VerifySentenceRequest &) = default ;
    VerifySentenceRequest& operator=(VerifySentenceRequest &&) = default ;
    ...
    inline VerifySentenceRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline VerifySentenceRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
