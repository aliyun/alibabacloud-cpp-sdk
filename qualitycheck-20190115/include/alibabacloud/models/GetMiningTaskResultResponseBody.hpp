...
namespace Models
{
  ...
  public:
    ...
    inline const GetMiningTaskResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMiningTaskResultResponseBodyData) };
    inline GetMiningTaskResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMiningTaskResultResponseBodyData) };
    inline GetMiningTaskResultResponseBody& setData(const GetMiningTaskResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMiningTaskResultResponseBody& setData(GetMiningTaskResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetMiningTaskResultResponseBodyData> data_ = nullptr;
