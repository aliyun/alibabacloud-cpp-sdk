...
#ifndef ALIBABACLOUD_MODELS_SAVECONFIGDATASETREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SAVECONFIGDATASETREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SaveConfigDataSetRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, SaveConfigDataSetRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    SaveConfigDataSetRequest() = default ;
    SaveConfigDataSetRequest(const SaveConfigDataSetRequest &) = default ;
    SaveConfigDataSetRequest(SaveConfigDataSetRequest &&) = default ;
    SaveConfigDataSetRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SaveConfigDataSetRequest() = default ;
    SaveConfigDataSetRequest& operator=(const SaveConfigDataSetRequest &) = default ;
    SaveConfigDataSetRequest& operator=(SaveConfigDataSetRequest &&) = default ;
    ...
    inline SaveConfigDataSetRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline SaveConfigDataSetRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
