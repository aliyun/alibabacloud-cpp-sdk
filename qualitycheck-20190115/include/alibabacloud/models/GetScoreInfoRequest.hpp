...
#ifndef ALIBABACLOUD_MODELS_GETSCOREINFOREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETSCOREINFOREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetScoreInfoRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, GetScoreInfoRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    GetScoreInfoRequest() = default ;
    GetScoreInfoRequest(const GetScoreInfoRequest &) = default ;
    GetScoreInfoRequest(GetScoreInfoRequest &&) = default ;
    GetScoreInfoRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetScoreInfoRequest() = default ;
    GetScoreInfoRequest& operator=(const GetScoreInfoRequest &) = default ;
    GetScoreInfoRequest& operator=(GetScoreInfoRequest &&) = default ;
    ...
    inline GetScoreInfoRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline GetScoreInfoRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
