...
#ifndef ALIBABACLOUD_MODELS_UPLOADRULEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPLOADRULEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UploadRuleRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, UploadRuleRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    UploadRuleRequest() = default ;
    UploadRuleRequest(const UploadRuleRequest &) = default ;
    UploadRuleRequest(UploadRuleRequest &&) = default ;
    UploadRuleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UploadRuleRequest() = default ;
    UploadRuleRequest& operator=(const UploadRuleRequest &) = default ;
    UploadRuleRequest& operator=(UploadRuleRequest &&) = default ;
    ...
    inline UploadRuleRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline UploadRuleRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
