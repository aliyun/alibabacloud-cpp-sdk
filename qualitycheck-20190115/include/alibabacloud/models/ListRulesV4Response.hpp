...
namespace Models
{
  ...
  public:
    ...
    inline const ListRulesV4ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRulesV4ResponseBody) };
    inline ListRulesV4ResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRulesV4ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRulesV4ResponseBody> body_ {};
  };
