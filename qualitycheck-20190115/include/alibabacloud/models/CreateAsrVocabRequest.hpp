...
#ifndef ALIBABACLOUD_MODELS_CREATEASRVOCABREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEASRVOCABREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAsrVocabRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, CreateAsrVocabRequest& obj) { 
    ...
    CreateAsrVocabRequest(const CreateAsrVocabRequest &) = default ;
    CreateAsrVocabRequest(CreateAsrVocabRequest &&) = default ;
    CreateAsrVocabRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAsrVocabRequest() = default ;
    CreateAsrVocabRequest& operator=(const CreateAsrVocabRequest &) = default ;
    CreateAsrVocabRequest& operator=(CreateAsrVocabRequest &&) = default ;
    ...
    inline CreateAsrVocabRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline CreateAsrVocabRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
