...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListRulesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListRulesResponseBodyData>) };
    inline vector<ListRulesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListRulesResponseBodyData>) };
    inline ListRulesResponseBody& setData(const vector<ListRulesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListRulesResponseBody& setData(vector<ListRulesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListRulesResponseBodyData>> data_ = nullptr;
