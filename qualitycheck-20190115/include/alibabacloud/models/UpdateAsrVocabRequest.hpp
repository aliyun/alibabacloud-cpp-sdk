...
#ifndef ALIBABACLOUD_MODELS_UPDATEASRVOCABREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEASRVOCABREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAsrVocabRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateAsrVocabRequest& obj) { 
    ...
    UpdateAsrVocabRequest(const UpdateAsrVocabRequest &) = default ;
    UpdateAsrVocabRequest(UpdateAsrVocabRequest &&) = default ;
    UpdateAsrVocabRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAsrVocabRequest() = default ;
    UpdateAsrVocabRequest& operator=(const UpdateAsrVocabRequest &) = default ;
    UpdateAsrVocabRequest& operator=(UpdateAsrVocabRequest &&) = default ;
    ...
    inline UpdateAsrVocabRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline UpdateAsrVocabRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
