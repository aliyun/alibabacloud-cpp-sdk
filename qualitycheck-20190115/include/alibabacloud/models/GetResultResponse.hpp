...
namespace Models
{
  ...
  public:
    ...
    inline const GetResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResultResponseBody) };
    inline GetResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResultResponseBody> body_ {};
  };
