...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRuleToSchemeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateRuleToSchemeResponseBody) };
    inline UpdateRuleToSchemeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateRuleToSchemeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateRuleToSchemeResponseBody> body_ {};
  };
