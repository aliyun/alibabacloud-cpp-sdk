...
namespace Models
{
  ...
  public:
    ...
    inline const ListWarningConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWarningConfigResponseBody) };
    inline ListWarningConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWarningConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWarningConfigResponseBody> body_ {};
  };
