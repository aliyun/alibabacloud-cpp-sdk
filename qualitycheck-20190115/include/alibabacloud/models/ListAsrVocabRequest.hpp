...
#ifndef ALIBABACLOUD_MODELS_LISTASRVOCABREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTASRVOCABREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAsrVocabRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, ListAsrVocabRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    ListAsrVocabRequest() = default ;
    ListAsrVocabRequest(const ListAsrVocabRequest &) = default ;
    ListAsrVocabRequest(ListAsrVocabRequest &&) = default ;
    ListAsrVocabRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAsrVocabRequest() = default ;
    ListAsrVocabRequest& operator=(const ListAsrVocabRequest &) = default ;
    ListAsrVocabRequest& operator=(ListAsrVocabRequest &&) = default ;
    ...
    inline ListAsrVocabRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline ListAsrVocabRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
