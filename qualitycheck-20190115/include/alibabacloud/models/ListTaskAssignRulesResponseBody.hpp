...
namespace Models
{
  ...
  public:
    ...
    inline const ListTaskAssignRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListTaskAssignRulesResponseBodyData) };
    inline ListTaskAssignRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListTaskAssignRulesResponseBodyData) };
    inline ListTaskAssignRulesResponseBody& setData(const ListTaskAssignRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTaskAssignRulesResponseBody& setData(ListTaskAssignRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListTaskAssignRulesResponseBodyData> data_ = nullptr;
