...
#ifndef ALIBABACLOUD_MODELS_ADDRULECATEGORYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDRULECATEGORYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddRuleCategoryRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, AddRuleCategoryRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    AddRuleCategoryRequest() = default ;
    AddRuleCategoryRequest(const AddRuleCategoryRequest &) = default ;
    AddRuleCategoryRequest(AddRuleCategoryRequest &&) = default ;
    AddRuleCategoryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddRuleCategoryRequest() = default ;
    AddRuleCategoryRequest& operator=(const AddRuleCategoryRequest &) = default ;
    AddRuleCategoryRequest& operator=(AddRuleCategoryRequest &&) = default ;
    ...
    inline AddRuleCategoryRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline AddRuleCategoryRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
