...
namespace Models
{
  ...
  public:
    ...
    inline const AddRuleV4ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddRuleV4ResponseBody) };
    inline AddRuleV4ResponseBody getBody() { DARABONBA_PTR_GET(body_, AddRuleV4ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddRuleV4ResponseBody> body_ {};
  };
