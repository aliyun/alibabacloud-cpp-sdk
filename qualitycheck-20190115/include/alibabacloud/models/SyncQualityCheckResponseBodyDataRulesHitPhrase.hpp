...
#ifndef ALIBABACLOUD_MODELS_SYNCQUALITYCHECKRESPONSEBODYDATARULESHITPHRASE_HPP_
#define ALIBABACLOUD_MODELS_SYNCQUALITYCHECKRESPONSEBODYDATARULESHITPHRASE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SyncQualityCheckResponseBodyDataRulesHitPhrase& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SyncQualityCheckResponseBodyDataRulesHitPhrase& obj) { 
    ...
    SyncQualityCheckResponseBodyDataRulesHitPhrase() = default ;
    SyncQualityCheckResponseBodyDataRulesHitPhrase(const SyncQualityCheckResponseBodyDataRulesHitPhrase &) = default ;
    SyncQualityCheckResponseBodyDataRulesHitPhrase(SyncQualityCheckResponseBodyDataRulesHitPhrase &&) = default ;
    SyncQualityCheckResponseBodyDataRulesHitPhrase(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SyncQualityCheckResponseBodyDataRulesHitPhrase() = default ;
    SyncQualityCheckResponseBodyDataRulesHitPhrase& operator=(const SyncQualityCheckResponseBodyDataRulesHitPhrase &) = default ;
    SyncQualityCheckResponseBodyDataRulesHitPhrase& operator=(SyncQualityCheckResponseBodyDataRulesHitPhrase &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->begin_ == nullptr
        && return this->emotionValue_ == nullptr && return this->end_ == nullptr && return this->identity_ == nullptr && return this->role_ == nullptr && return this->silenceDuration_ == nullptr
        && return this->speechRate_ == nullptr && return this->words_ == nullptr; };
    ...
    inline SyncQualityCheckResponseBodyDataRulesHitPhrase& setBegin(int64_t begin) { DARABONBA_PTR_SET_VALUE(begin_, begin) };
    ...
    inline SyncQualityCheckResponseBodyDataRulesHitPhrase& setEmotionValue(int32_t emotionValue) { DARABONBA_PTR_SET_VALUE(emotionValue_, emotionValue) };
    ...
    inline SyncQualityCheckResponseBodyDataRulesHitPhrase& setEnd(int64_t end) { DARABONBA_PTR_SET_VALUE(end_, end) };
    ...
    inline SyncQualityCheckResponseBodyDataRulesHitPhrase& setIdentity(string identity) { DARABONBA_PTR_SET_VALUE(identity_, identity) };
    ...
    inline SyncQualityCheckResponseBodyDataRulesHitPhrase& setRole(string role) { DARABONBA_PTR_SET_VALUE(role_, role) };
    ...
    inline SyncQualityCheckResponseBodyDataRulesHitPhrase& setSilenceDuration(int32_t silenceDuration) { DARABONBA_PTR_SET_VALUE(silenceDuration_, silenceDuration) };
    ...
    inline SyncQualityCheckResponseBodyDataRulesHitPhrase& setSpeechRate(int32_t speechRate) { DARABONBA_PTR_SET_VALUE(speechRate_, speechRate) };
    ...
    inline SyncQualityCheckResponseBodyDataRulesHitPhrase& setWords(string words) { DARABONBA_PTR_SET_VALUE(words_, words) };
