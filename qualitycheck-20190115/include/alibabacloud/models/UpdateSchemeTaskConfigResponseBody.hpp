...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSchemeTaskConfigResponseBody::Messages & getMessages() const { DARABONBA_PTR_GET_CONST(messages_, UpdateSchemeTaskConfigResponseBody::Messages) };
    inline UpdateSchemeTaskConfigResponseBody::Messages getMessages() { DARABONBA_PTR_GET(messages_, UpdateSchemeTaskConfigResponseBody::Messages) };
    inline UpdateSchemeTaskConfigResponseBody& setMessages(const UpdateSchemeTaskConfigResponseBody::Messages & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline UpdateSchemeTaskConfigResponseBody& setMessages(UpdateSchemeTaskConfigResponseBody::Messages && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
  ...
  protected:
    ...
    shared_ptr<UpdateSchemeTaskConfigResponseBody::Messages> messages_ {};
