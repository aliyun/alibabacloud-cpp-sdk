...
namespace Models
{
  ...
  public:
    ...
    inline const GetRuleCategoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRuleCategoryResponseBodyData) };
    inline GetRuleCategoryResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRuleCategoryResponseBodyData) };
    inline GetRuleCategoryResponseBody& setData(const GetRuleCategoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRuleCategoryResponseBody& setData(GetRuleCategoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetRuleCategoryResponseBodyData> data_ = nullptr;
