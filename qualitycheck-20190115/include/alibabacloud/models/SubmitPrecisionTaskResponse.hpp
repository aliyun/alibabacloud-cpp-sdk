...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitPrecisionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitPrecisionTaskResponseBody) };
    inline SubmitPrecisionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitPrecisionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitPrecisionTaskResponseBody> body_ {};
  };
