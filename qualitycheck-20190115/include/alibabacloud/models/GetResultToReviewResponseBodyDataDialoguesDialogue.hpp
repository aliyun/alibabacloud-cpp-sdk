...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->begin_ == nullptr
        && return this->beginTime_ == nullptr && return this->beginTimeMs_ == nullptr && return this->emotionValue_ == nullptr && return this->end_ == nullptr && return this->hourMinSec_ == nullptr
        && return this->identity_ == nullptr && return this->role_ == nullptr && return this->silenceDuration_ == nullptr && return this->speechRate_ == nullptr && return this->words_ == nullptr; };
