...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RuleCountInfo> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<RuleCountInfo>) };
    inline vector<RuleCountInfo> getData() { DARABONBA_PTR_GET(data_, vector<RuleCountInfo>) };
  ...
  protected:
    ...
    shared_ptr<vector<RuleCountInfo>> data_ {};
