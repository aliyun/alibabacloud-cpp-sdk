...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRuleV4ResponseBody::Messages & getMessages() const { DARABONBA_PTR_GET_CONST(messages_, DeleteRuleV4ResponseBody::Messages) };
    inline DeleteRuleV4ResponseBody::Messages getMessages() { DARABONBA_PTR_GET(messages_, DeleteRuleV4ResponseBody::Messages) };
    inline DeleteRuleV4ResponseBody& setMessages(const DeleteRuleV4ResponseBody::Messages & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline DeleteRuleV4ResponseBody& setMessages(DeleteRuleV4ResponseBody::Messages && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
  ...
  protected:
    ...
    shared_ptr<DeleteRuleV4ResponseBody::Messages> messages_ {};
