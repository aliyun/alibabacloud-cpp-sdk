...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RuleInfo> & getRules() const { DARABONBA_PTR_GET_CONST(rules_, vector<RuleInfo>) };
    inline vector<RuleInfo> getRules() { DARABONBA_PTR_GET(rules_, vector<RuleInfo>) };
