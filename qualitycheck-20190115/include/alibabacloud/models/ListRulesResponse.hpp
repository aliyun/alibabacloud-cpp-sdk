...
namespace Models
{
  ...
  public:
    ...
    inline const ListRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRulesResponseBody) };
    inline ListRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRulesResponseBody> body_ {};
  };
