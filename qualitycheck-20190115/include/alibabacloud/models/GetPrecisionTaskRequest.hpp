...
#ifndef ALIBABACLOUD_MODELS_GETPRECISIONTASKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETPRECISIONTASKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetPrecisionTaskRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, GetPrecisionTaskRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    GetPrecisionTaskRequest() = default ;
    GetPrecisionTaskRequest(const GetPrecisionTaskRequest &) = default ;
    GetPrecisionTaskRequest(GetPrecisionTaskRequest &&) = default ;
    GetPrecisionTaskRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetPrecisionTaskRequest() = default ;
    GetPrecisionTaskRequest& operator=(const GetPrecisionTaskRequest &) = default ;
    GetPrecisionTaskRequest& operator=(GetPrecisionTaskRequest &&) = default ;
    ...
    inline GetPrecisionTaskRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline GetPrecisionTaskRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
