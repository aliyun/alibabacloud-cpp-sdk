...
#ifndef ALIBABACLOUD_MODELS_VERIFYFILEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_VERIFYFILEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const VerifyFileRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, VerifyFileRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    VerifyFileRequest() = default ;
    VerifyFileRequest(const VerifyFileRequest &) = default ;
    VerifyFileRequest(VerifyFileRequest &&) = default ;
    VerifyFileRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~VerifyFileRequest() = default ;
    VerifyFileRequest& operator=(const VerifyFileRequest &) = default ;
    VerifyFileRequest& operator=(VerifyFileRequest &&) = default ;
    ...
    inline VerifyFileRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline VerifyFileRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
