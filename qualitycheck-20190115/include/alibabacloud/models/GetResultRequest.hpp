...
#ifndef ALIBABACLOUD_MODELS_GETRESULTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETRESULTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetResultRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_TO_JSON(JsonStr, jsonStr_);
    };
    friend void from_json(const Darabonba::Json& j, GetResultRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BaseMeAgentId, baseMeAgentId_);
      DARABONBA_PTR_FROM_JSON(JsonStr, jsonStr_);
    };
    GetResultRequest() = default ;
    GetResultRequest(const GetResultRequest &) = default ;
    GetResultRequest(GetResultRequest &&) = default ;
    GetResultRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetResultRequest() = default ;
    GetResultRequest& operator=(const GetResultRequest &) = default ;
    GetResultRequest& operator=(GetResultRequest &&) = default ;
    ...
    inline GetResultRequest& setBaseMeAgentId(int64_t baseMeAgentId) { DARABONBA_PTR_SET_VALUE(baseMeAgentId_, baseMeAgentId) };
    ...
    inline GetResultRequest& setJsonStr(string jsonStr) { DARABONBA_PTR_SET_VALUE(jsonStr_, jsonStr) };
