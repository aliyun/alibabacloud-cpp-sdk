...
namespace Models
{
  ...
  public:
    ...
    inline const GetPrecisionTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPrecisionTaskResponseBodyData) };
    inline GetPrecisionTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPrecisionTaskResponseBodyData) };
    inline GetPrecisionTaskResponseBody& setData(const GetPrecisionTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPrecisionTaskResponseBody& setData(GetPrecisionTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetPrecisionTaskResponseBodyData> data_ = nullptr;
