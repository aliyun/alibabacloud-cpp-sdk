...
namespace Models
{
  ...
  public:
    ...
    inline const GetResultToReviewResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetResultToReviewResponseBodyData) };
    inline GetResultToReviewResponseBodyData data() { DARABONBA_PTR_GET(data_, GetResultToReviewResponseBodyData) };
    inline GetResultToReviewResponseBody& setData(const GetResultToReviewResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetResultToReviewResponseBody& setData(GetResultToReviewResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetResultToReviewResponseBodyData> data_ = nullptr;
