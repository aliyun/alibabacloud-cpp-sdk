...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAsrVocabResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAsrVocabResponseBody) };
    inline UpdateAsrVocabResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAsrVocabResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAsrVocabResponseBody> body_ {};
  };
