...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCheckTypeToSchemeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateCheckTypeToSchemeResponseBody) };
    inline UpdateCheckTypeToSchemeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateCheckTypeToSchemeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateCheckTypeToSchemeResponseBody> body_ {};
  };
