...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSyncQualityCheckDataResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateSyncQualityCheckDataResponseBodyData) };
    inline UpdateSyncQualityCheckDataResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateSyncQualityCheckDataResponseBodyData) };
    inline UpdateSyncQualityCheckDataResponseBody& setData(const UpdateSyncQualityCheckDataResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateSyncQualityCheckDataResponseBody& setData(UpdateSyncQualityCheckDataResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateSyncQualityCheckDataResponseBodyData> data_ = nullptr;
