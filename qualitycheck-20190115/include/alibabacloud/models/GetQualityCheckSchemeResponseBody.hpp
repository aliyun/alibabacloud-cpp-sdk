...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualityCheckSchemeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQualityCheckSchemeResponseBodyData) };
    inline GetQualityCheckSchemeResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQualityCheckSchemeResponseBodyData) };
    inline GetQualityCheckSchemeResponseBody& setData(const GetQualityCheckSchemeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualityCheckSchemeResponseBody& setData(GetQualityCheckSchemeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQualityCheckSchemeResponseBodyData> data_ = nullptr;
