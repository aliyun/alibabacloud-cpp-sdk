...
namespace Models
{
  ...
  public:
    ...
    inline const GetWarningStrategyConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetWarningStrategyConfigResponseBodyData) };
    inline GetWarningStrategyConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetWarningStrategyConfigResponseBodyData) };
    inline GetWarningStrategyConfigResponseBody& setData(const GetWarningStrategyConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetWarningStrategyConfigResponseBody& setData(GetWarningStrategyConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetWarningStrategyConfigResponseBodyData> data_ = nullptr;
