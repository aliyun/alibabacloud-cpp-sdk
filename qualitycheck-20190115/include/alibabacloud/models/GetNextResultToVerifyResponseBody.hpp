...
namespace Models
{
  ...
  public:
    ...
    inline const GetNextResultToVerifyResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetNextResultToVerifyResponseBodyData) };
    inline GetNextResultToVerifyResponseBodyData data() { DARABONBA_PTR_GET(data_, GetNextResultToVerifyResponseBodyData) };
    inline GetNextResultToVerifyResponseBody& setData(const GetNextResultToVerifyResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetNextResultToVerifyResponseBody& setData(GetNextResultToVerifyResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetNextResultToVerifyResponseBodyData> data_ = nullptr;
