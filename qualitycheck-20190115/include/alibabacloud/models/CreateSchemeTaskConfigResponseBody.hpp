...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSchemeTaskConfigResponseBodyMessages & messages() const { DARABONBA_PTR_GET_CONST(messages_, CreateSchemeTaskConfigResponseBodyMessages) };
    inline CreateSchemeTaskConfigResponseBodyMessages messages() { DARABONBA_PTR_GET(messages_, CreateSchemeTaskConfigResponseBodyMessages) };
    inline CreateSchemeTaskConfigResponseBody& setMessages(const CreateSchemeTaskConfigResponseBodyMessages & messages) { DARABONBA_PTR_SET_VALUE(messages_, messages) };
    inline CreateSchemeTaskConfigResponseBody& setMessages(CreateSchemeTaskConfigResponseBodyMessages && messages) { DARABONBA_PTR_SET_RVALUE(messages_, messages) };
  ...
  protected:
    ...
    std::shared_ptr<CreateSchemeTaskConfigResponseBodyMessages> messages_ = nullptr;
