...
namespace Models
{
  ...
  public:
    ...
    inline const AddBusinessCategoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddBusinessCategoryResponseBody) };
    inline AddBusinessCategoryResponseBody getBody() { DARABONBA_PTR_GET(body_, AddBusinessCategoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddBusinessCategoryResponseBody> body_ {};
  };
