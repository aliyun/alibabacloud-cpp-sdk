...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListQualityCheckSchemeResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListQualityCheckSchemeResponseBodyData>) };
    inline vector<ListQualityCheckSchemeResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListQualityCheckSchemeResponseBodyData>) };
    inline ListQualityCheckSchemeResponseBody& setData(const vector<ListQualityCheckSchemeResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListQualityCheckSchemeResponseBody& setData(vector<ListQualityCheckSchemeResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListQualityCheckSchemeResponseBodyData>> data_ = nullptr;
