...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSkillGroupConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSkillGroupConfigResponseBody) };
    inline CreateSkillGroupConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSkillGroupConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSkillGroupConfigResponseBody> body_ {};
  };
