...
namespace Models
{
  ...
  public:
    ...
    inline const TestRuleV4ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TestRuleV4ResponseBody) };
    inline TestRuleV4ResponseBody getBody() { DARABONBA_PTR_GET(body_, TestRuleV4ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TestRuleV4ResponseBody> body_ {};
  };
