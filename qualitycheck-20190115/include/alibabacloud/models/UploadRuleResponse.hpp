...
namespace Models
{
  ...
  public:
    ...
    inline const UploadRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadRuleResponseBody) };
    inline UploadRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadRuleResponseBody> body_ {};
  };
