...
namespace Models
{
  ...
  public:
    ...
    inline const GetRuleCategoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRuleCategoryResponseBody) };
    inline GetRuleCategoryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRuleCategoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRuleCategoryResponseBody> body_ {};
  };
