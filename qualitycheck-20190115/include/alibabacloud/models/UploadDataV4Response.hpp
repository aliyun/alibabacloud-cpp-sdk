...
namespace Models
{
  ...
  public:
    ...
    inline const UploadDataV4ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadDataV4ResponseBody) };
    inline UploadDataV4ResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadDataV4ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadDataV4ResponseBody> body_ {};
  };
