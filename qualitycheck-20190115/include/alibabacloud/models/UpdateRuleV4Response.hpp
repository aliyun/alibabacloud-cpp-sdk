...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRuleV4ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateRuleV4ResponseBody) };
    inline UpdateRuleV4ResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateRuleV4ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateRuleV4ResponseBody> body_ {};
  };
