...
#ifndef ALIBABACLOUD_MODELS_SCHEMECHECKTYPETASKFLOWSCOREINFOLISTSCHEMESCOREINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_SCHEMECHECKTYPETASKFLOWSCOREINFOLISTSCHEMESCOREINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& obj) { 
    ...
    SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList() = default ;
    SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList(const SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList &) = default ;
    SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList(SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList &&) = default ;
    SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList() = default ;
    SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& operator=(const SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList &) = default ;
    SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& operator=(SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList &&) = default ;
    ...
    inline SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& setRid(int64_t rid) { DARABONBA_PTR_SET_VALUE(rid_, rid) };
    ...
    inline SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& setScoreNum(int32_t scoreNum) { DARABONBA_PTR_SET_VALUE(scoreNum_, scoreNum) };
    ...
    inline SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& setScoreNumType(int32_t scoreNumType) { DARABONBA_PTR_SET_VALUE(scoreNumType_, scoreNumType) };
    ...
    inline SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& setScoreRuleHitType(int32_t scoreRuleHitType) { DARABONBA_PTR_SET_VALUE(scoreRuleHitType_, scoreRuleHitType) };
    ...
    inline SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& setScoreType(int32_t scoreType) { DARABONBA_PTR_SET_VALUE(scoreType_, scoreType) };
    ...
    inline SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& setTaskFlowId(int64_t taskFlowId) { DARABONBA_PTR_SET_VALUE(taskFlowId_, taskFlowId) };
    ...
    inline SchemeCheckTypeTaskFlowScoreInfoListSchemeScoreInfoList& setTaskFlowName(string taskFlowName) { DARABONBA_PTR_SET_VALUE(taskFlowName_, taskFlowName) };
