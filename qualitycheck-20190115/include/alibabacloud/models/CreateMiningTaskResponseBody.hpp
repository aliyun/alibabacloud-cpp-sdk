...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMiningTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateMiningTaskResponseBody::Data) };
    inline CreateMiningTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateMiningTaskResponseBody::Data) };
    inline CreateMiningTaskResponseBody& setData(const CreateMiningTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateMiningTaskResponseBody& setData(CreateMiningTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
