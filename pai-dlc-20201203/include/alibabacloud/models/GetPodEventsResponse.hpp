...
namespace Models
{
  ...
  public:
    ...
    inline const GetPodEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPodEventsResponseBody) };
    inline GetPodEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPodEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPodEventsResponseBody> body_ {};
  };
