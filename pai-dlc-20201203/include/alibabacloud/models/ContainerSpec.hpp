...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->args_ == nullptr
        && return this->command_ == nullptr && return this->env_ == nullptr && return this->image_ == nullptr && return this->name_ == nullptr && return this->resources_ == nullptr
    ...
    inline const vector<EnvVar> & env() const { DARABONBA_PTR_GET_CONST(env_, vector<EnvVar>) };
    inline vector<EnvVar> env() { DARABONBA_PTR_GET(env_, vector<EnvVar>) };
    ...
    inline const ResourceRequirements & resources() const { DARABONBA_PTR_GET_CONST(resources_, ResourceRequirements) };
    inline ResourceRequirements resources() { DARABONBA_PTR_GET(resources_, ResourceRequirements) };
  ...
  protected:
    ...
    std::shared_ptr<vector<EnvVar>> env_ = nullptr;
    std::shared_ptr<string> image_ = nullptr;
    std::shared_ptr<string> name_ = nullptr;
    std::shared_ptr<ResourceRequirements> resources_ = nullptr;
