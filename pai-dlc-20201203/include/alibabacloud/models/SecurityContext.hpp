...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->capabilities_ == nullptr
        && return this->privileged_ == nullptr && return this->runAsGroup_ == nullptr && return this->runAsUser_ == nullptr && return this->seccompProfile_ == nullptr; };
    ...
    inline const SecurityContextCapabilities & capabilities() const { DARABONBA_PTR_GET_CONST(capabilities_, SecurityContextCapabilities) };
    inline SecurityContextCapabilities capabilities() { DARABONBA_PTR_GET(capabilities_, SecurityContextCapabilities) };
    ...
    inline int64_t runAsGroup() const { DARABONBA_PTR_GET_DEFAULT(runAsGroup_, 0L) };
    ...
    inline const SeccompProfile & seccompProfile() const { DARABONBA_PTR_GET_CONST(seccompProfile_, SeccompProfile) };
    inline SeccompProfile seccompProfile() { DARABONBA_PTR_GET(seccompProfile_, SeccompProfile) };
  ...
  protected:
    std::shared_ptr<SecurityContextCapabilities> capabilities_ = nullptr;
    std::shared_ptr<bool> privileged_ = nullptr;
    std::shared_ptr<int64_t> runAsGroup_ = nullptr;
    std::shared_ptr<int64_t> runAsUser_ = nullptr;
    std::shared_ptr<SeccompProfile> seccompProfile_ = nullptr;
  };
