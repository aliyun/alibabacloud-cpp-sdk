...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getCacheWorkerNum() const { DARABONBA_PTR_GET_DEFAULT(cacheWorkerNum_, 0L) };
    ...
    inline int64_t getCacheWorkerSize() const { DARABONBA_PTR_GET_DEFAULT(cacheWorkerSize_, 0L) };
    ...
    inline string getSmartCacheId() const { DARABONBA_PTR_GET_DEFAULT(smartCacheId_, "") };
