...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->tensorboardSharedUrl_ == nullptr; };
    ...
    inline string tensorboardSharedUrl() const { DARABONBA_PTR_GET_DEFAULT(tensorboardSharedUrl_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> tensorboardSharedUrl_ = nullptr;
  };
