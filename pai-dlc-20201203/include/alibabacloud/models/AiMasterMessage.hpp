...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->extended_ == nullptr
        && return this->jobRestartCount_ == nullptr && return this->messageContent_ == nullptr && return this->messageEvent_ == nullptr && return this->messageVersion_ == nullptr && return this->restartType_ == nullptr; };
    // extended Field Functions 
    bool hasExtended() const { return this->extended_ != nullptr;};
    void deleteExtended() { this->extended_ = nullptr;};
    inline string extended() const { DARABONBA_PTR_GET_DEFAULT(extended_, "") };
    ...
    inline int32_t jobRestartCount() const { DARABONBA_PTR_GET_DEFAULT(jobRestartCount_, 0) };
    ...
    inline string messageEvent() const { DARABONBA_PTR_GET_DEFAULT(messageEvent_, "") };
    ...
    inline int32_t messageVersion() const { DARABONBA_PTR_GET_DEFAULT(messageVersion_, 0) };
  ...
  protected:
    std::shared_ptr<string> extended_ = nullptr;
    std::shared_ptr<int32_t> jobRestartCount_ = nullptr;
    std::shared_ptr<string> messageContent_ = nullptr;
    std::shared_ptr<string> messageEvent_ = nullptr;
    std::shared_ptr<int32_t> messageVersion_ = nullptr;
