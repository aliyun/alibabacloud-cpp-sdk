...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Member> & getMembers() const { DARABONBA_PTR_GET_CONST(members_, vector<Member>) };
    inline vector<Member> getMembers() { DARABONBA_PTR_GET(members_, vector<Member>) };
    ...
    inline const Resources & getTotalResources() const { DARABONBA_PTR_GET_CONST(totalResources_, Resources) };
    inline Resources getTotalResources() { DARABONBA_PTR_GET(totalResources_, Resources) };
    ...
    inline const vector<Member> & getWorkspaceAdmins() const { DARABONBA_PTR_GET_CONST(workspaceAdmins_, vector<Member>) };
    inline vector<Member> getWorkspaceAdmins() { DARABONBA_PTR_GET(workspaceAdmins_, vector<Member>) };
  ...
  protected:
    ...
    shared_ptr<vector<Member>> members_ {};
    shared_ptr<vector<Quota>> quotas_ {};
    shared_ptr<Resources> totalResources_ {};
    shared_ptr<vector<Member>> workspaceAdmins_ {};
