...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getSupportedGPUDrivers() const { DARABONBA_PTR_GET_CONST(supportedGPUDrivers_, vector<string>) };
    inline vector<string> getSupportedGPUDrivers() { DARABONBA_PTR_GET(supportedGPUDrivers_, vector<string>) };
