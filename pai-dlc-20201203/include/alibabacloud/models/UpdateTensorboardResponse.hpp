...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTensorboardResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateTensorboardResponseBody) };
    inline UpdateTensorboardResponseBody body() { DARABONBA_PTR_GET(body_, UpdateTensorboardResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateTensorboardResponseBody> body_ = nullptr;
  };
