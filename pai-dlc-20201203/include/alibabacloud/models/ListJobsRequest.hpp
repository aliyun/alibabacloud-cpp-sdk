...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessibility_ == nullptr
        ...
        && this->startTime_ == nullptr && this->status_ == nullptr && this->tags_ == nullptr && this->templateId_ == nullptr && this->timeRangeField_ == nullptr
    ...
    inline ListJobsRequest& setAccessibility(string accessibility) { DARABONBA_PTR_SET_VALUE(accessibility_, accessibility) };
    ...
    inline ListJobsRequest& setBusinessUserId(string businessUserId) { DARABONBA_PTR_SET_VALUE(businessUserId_, businessUserId) };
    ...
    inline ListJobsRequest& setCaller(string caller) { DARABONBA_PTR_SET_VALUE(caller_, caller) };
    ...
    inline ListJobsRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ListJobsRequest& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline ListJobsRequest& setJobIds(string jobIds) { DARABONBA_PTR_SET_VALUE(jobIds_, jobIds) };
    ...
    inline ListJobsRequest& setOrder(string order) { DARABONBA_PTR_SET_VALUE(order_, order) };
    ...
    inline ListJobsRequest& setOversoldInfo(string oversoldInfo) { DARABONBA_PTR_SET_VALUE(oversoldInfo_, oversoldInfo) };
    ...
    inline ListJobsRequest& setPaymentType(string paymentType) { DARABONBA_PTR_SET_VALUE(paymentType_, paymentType) };
    ...
    inline ListJobsRequest& setResourceQuotaName(string resourceQuotaName) { DARABONBA_PTR_SET_VALUE(resourceQuotaName_, resourceQuotaName) };
    ...
    inline ListJobsRequest& setShowOwn(bool showOwn) { DARABONBA_PTR_SET_VALUE(showOwn_, showOwn) };
    ...
    inline ListJobsRequest& setSortBy(string sortBy) { DARABONBA_PTR_SET_VALUE(sortBy_, sortBy) };
    ...
    inline ListJobsRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ListJobsRequest& setTags(const map<string, string> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    ...
    inline ListJobsRequest& setTemplateId(string templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
    ...
    inline ListJobsRequest& setUserIdForFilter(string userIdForFilter) { DARABONBA_PTR_SET_VALUE(userIdForFilter_, userIdForFilter) };
    ...
    inline ListJobsRequest& setUsername(string username) { DARABONBA_PTR_SET_VALUE(username_, username) };
    ...
    inline ListJobsRequest& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
