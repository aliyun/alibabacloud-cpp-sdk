...
namespace Models
{
  ...
  public:
    ...
    inline const vector<PodMetric> & getPodMetrics() const { DARABONBA_PTR_GET_CONST(podMetrics_, vector<PodMetric>) };
    inline vector<PodMetric> getPodMetrics() { DARABONBA_PTR_GET(podMetrics_, vector<PodMetric>) };
