...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateJobResponseBody) };
    inline UpdateJobResponseBody body() { DARABONBA_PTR_GET(body_, UpdateJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateJobResponseBody> body_ = nullptr;
  };
