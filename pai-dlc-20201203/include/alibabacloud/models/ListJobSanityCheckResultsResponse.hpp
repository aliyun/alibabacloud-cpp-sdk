...
namespace Models
{
  ...
  public:
    ...
    inline const ListJobSanityCheckResultsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListJobSanityCheckResultsResponseBody) };
    inline ListJobSanityCheckResultsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListJobSanityCheckResultsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListJobSanityCheckResultsResponseBody> body_ {};
  };
