...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->CPU_ == nullptr
        && return this->GPU_ == nullptr && return this->GPUDetails_ == nullptr && return this->GPUType_ == nullptr && return this->GPUTypeFullName_ == nullptr && return this->memory_ == nullptr; };
    // CPU Field Functions 
    ...
    inline const vector<GPUDetail> & GPUDetails() const { DARABONBA_PTR_GET_CONST(GPUDetails_, vector<GPUDetail>) };
    inline vector<GPUDetail> GPUDetails() { DARABONBA_PTR_GET(GPUDetails_, vector<GPUDetail>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GPUDetail>> GPUDetails_ = nullptr;
