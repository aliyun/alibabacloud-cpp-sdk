...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceleratorType_ == nullptr
        && this->instanceTypes_ == nullptr && this->order_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->resourceType_ == nullptr
    ...
    inline string getInstanceTypes() const { DARABONBA_PTR_GET_DEFAULT(instanceTypes_, "") };
