...
namespace Models
{
  ...
  public:
    ...
    inline const GetPodLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPodLogsResponseBody) };
    inline GetPodLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPodLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPodLogsResponseBody> body_ {};
  };
