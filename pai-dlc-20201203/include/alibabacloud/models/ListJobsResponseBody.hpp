...
namespace Models
{
  ...
  public:
    ...
    inline const vector<JobItem> & getJobs() const { DARABONBA_PTR_GET_CONST(jobs_, vector<JobItem>) };
    inline vector<JobItem> getJobs() { DARABONBA_PTR_GET(jobs_, vector<JobItem>) };
