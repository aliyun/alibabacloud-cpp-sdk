...
namespace Models
{
  ...
  public:
    ...
    inline string getAuthorId() const { DARABONBA_PTR_GET_DEFAULT(authorId_, "") };
    ...
    inline string getImageProviderType() const { DARABONBA_PTR_GET_DEFAULT(imageProviderType_, "") };
    ...
    inline string getImageUrlVpc() const { DARABONBA_PTR_GET_DEFAULT(imageUrlVpc_, "") };
