...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dimensions_ == nullptr
        && this->endTime_ == nullptr && this->jobId_ == nullptr && this->length_ == nullptr && this->metricName_ == nullptr && this->namespace_ == nullptr
        && this->nextToken_ == nullptr && this->period_ == nullptr && this->startTime_ == nullptr && this->token_ == nullptr; };
    ...
    inline GetMetricsRequest& setJobId(string jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline GetMetricsRequest& setToken(string token) { DARABONBA_PTR_SET_VALUE(token_, token) };
