...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->advancedSettings_ == nullptr
        && return this->allocateAllRDMADevices_ == nullptr && return this->businessUserId_ == nullptr && return this->caller_ == nullptr && return this->dataJuicerConfig_ == nullptr && return this->disableEcsStockCheck_ == nullptr
        && return this->driver_ == nullptr && return this->enableCPUAffinity_ == nullptr && return this->enableDSWDev_ == nullptr && return this->enableErrorMonitoringInAIMaster_ == nullptr && return this->enableOssAppend_ == nullptr
        ...
        && return this->jobReservedPolicy_ == nullptr && return this->modelConfig_ == nullptr && return this->oversoldType_ == nullptr && return this->pipelineId_ == nullptr && return this->sanityCheckArgs_ == nullptr
