...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->debuggerConfigContent_ == nullptr
        && this->debuggerJobIssues_ == nullptr && this->debuggerJobStatus_ == nullptr && this->debuggerReportURL_ == nullptr && this->jobDisplayName_ == nullptr && this->jobId_ == nullptr
        && this->jobUserId_ == nullptr; };
    ...
    inline string getDebuggerJobIssues() const { DARABONBA_PTR_GET_DEFAULT(debuggerJobIssues_, "") };
    ...
    inline string getDebuggerJobStatus() const { DARABONBA_PTR_GET_DEFAULT(debuggerJobStatus_, "") };
    ...
    inline string getDebuggerReportURL() const { DARABONBA_PTR_GET_DEFAULT(debuggerReportURL_, "") };
    ...
    inline string getJobDisplayName() const { DARABONBA_PTR_GET_DEFAULT(jobDisplayName_, "") };
    ...
    inline string getJobUserId() const { DARABONBA_PTR_GET_DEFAULT(jobUserId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> debuggerJobIssues_ {};
    shared_ptr<string> debuggerJobStatus_ {};
    shared_ptr<string> debuggerReportURL_ {};
    shared_ptr<string> jobDisplayName_ {};
    shared_ptr<string> jobId_ {};
    shared_ptr<string> jobUserId_ {};
  };
