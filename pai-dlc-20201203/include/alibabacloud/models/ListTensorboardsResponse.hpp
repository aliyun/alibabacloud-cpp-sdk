...
namespace Models
{
  ...
  public:
    ...
    inline const ListTensorboardsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTensorboardsResponseBody) };
    inline ListTensorboardsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTensorboardsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTensorboardsResponseBody> body_ {};
  };
