...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->defaultPort_ == nullptr
    ...
    inline const vector<int32_t> & getExtraPorts() const { DARABONBA_PTR_GET_CONST(extraPorts_, vector<int32_t>) };
    inline vector<int32_t> getExtraPorts() { DARABONBA_PTR_GET(extraPorts_, vector<int32_t>) };
