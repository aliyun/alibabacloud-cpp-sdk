...
namespace Models
{
  ...
  public:
    ...
    inline string getAIMasterDockerImage() const { DARABONBA_PTR_GET_DEFAULT(AIMasterDockerImage_, "") };
    ...
    inline string getAIMasterType() const { DARABONBA_PTR_GET_DEFAULT(AIMasterType_, "") };
    ...
    inline int32_t getEDPMaxParallelism() const { DARABONBA_PTR_GET_DEFAULT(EDPMaxParallelism_, 0) };
    ...
    inline int32_t getEDPMinParallelism() const { DARABONBA_PTR_GET_DEFAULT(EDPMinParallelism_, 0) };
    ...
    inline string getElasticStrategy() const { DARABONBA_PTR_GET_DEFAULT(elasticStrategy_, "") };
    ...
    inline bool getEnableAIMaster() const { DARABONBA_PTR_GET_DEFAULT(enableAIMaster_, false) };
    ...
    inline bool getEnableEDP() const { DARABONBA_PTR_GET_DEFAULT(enableEDP_, false) };
    ...
    inline bool getEnableElasticTraining() const { DARABONBA_PTR_GET_DEFAULT(enableElasticTraining_, false) };
    ...
    inline bool getEnablePsJobElasticPS() const { DARABONBA_PTR_GET_DEFAULT(enablePsJobElasticPS_, false) };
    ...
    inline bool getEnablePsJobElasticWorker() const { DARABONBA_PTR_GET_DEFAULT(enablePsJobElasticWorker_, false) };
    ...
    inline bool getEnablePsResourceEstimate() const { DARABONBA_PTR_GET_DEFAULT(enablePsResourceEstimate_, false) };
    ...
    inline int32_t getMinParallelism() const { DARABONBA_PTR_GET_DEFAULT(minParallelism_, 0) };
    ...
    inline int32_t getPSMaxParallelism() const { DARABONBA_PTR_GET_DEFAULT(PSMaxParallelism_, 0) };
    ...
    inline int32_t getPSMinParallelism() const { DARABONBA_PTR_GET_DEFAULT(PSMinParallelism_, 0) };
  ...
  protected:
    shared_ptr<string> AIMasterDockerImage_ {};
    shared_ptr<string> AIMasterType_ {};
    shared_ptr<int32_t> EDPMaxParallelism_ {};
    shared_ptr<int32_t> EDPMinParallelism_ {};
    shared_ptr<string> elasticStrategy_ {};
    shared_ptr<bool> enableAIMaster_ {};
    shared_ptr<bool> enableEDP_ {};
    shared_ptr<bool> enableElasticTraining_ {};
    shared_ptr<bool> enablePsJobElasticPS_ {};
    shared_ptr<bool> enablePsJobElasticWorker_ {};
    shared_ptr<bool> enablePsResourceEstimate_ {};
    shared_ptr<int32_t> maxParallelism_ {};
    shared_ptr<int32_t> minParallelism_ {};
    shared_ptr<int32_t> PSMaxParallelism_ {};
    shared_ptr<int32_t> PSMinParallelism_ {};
  };
