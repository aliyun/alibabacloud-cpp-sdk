...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->accessibility_ != nullptr
        ...
        && this->jobMaxRunningTimeMinutes_ != nullptr && this->jobSpecs_ != nullptr && this->jobType_ != nullptr && this->nodeCount_ != nullptr && this->nodeNames_ != nullptr
        && this->pods_ != nullptr && this->priority_ != nullptr && this->reasonCode_ != nullptr && this->reasonMessage_ != nullptr && this->requestCPU_ != nullptr
        && this->requestGPU_ != nullptr && this->requestMemory_ != nullptr && this->resourceId_ != nullptr && this->resourceLevel_ != nullptr && this->resourceName_ != nullptr
        && this->resourceQuotaName_ != nullptr && this->resourceType_ != nullptr && this->restartTimes_ != nullptr && this->settings_ != nullptr && this->status_ != nullptr
        && this->statusHistory_ != nullptr && this->subStatus_ != nullptr && this->systemEnvs_ != nullptr && this->tenantId_ != nullptr && this->thirdpartyLibDir_ != nullptr
