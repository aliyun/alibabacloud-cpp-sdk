...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DataSourceItem> & getDataSources() const { DARABONBA_PTR_GET_CONST(dataSources_, vector<DataSourceItem>) };
    inline vector<DataSourceItem> getDataSources() { DARABONBA_PTR_GET(dataSources_, vector<DataSourceItem>) };
