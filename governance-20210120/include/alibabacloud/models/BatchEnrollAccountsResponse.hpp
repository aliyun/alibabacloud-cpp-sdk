...
namespace Models
{
  ...
  public:
    ...
    inline const BatchEnrollAccountsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchEnrollAccountsResponseBody) };
    inline BatchEnrollAccountsResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchEnrollAccountsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchEnrollAccountsResponseBody> body_ {};
  };
