...
namespace Models
{
  ...
  public:
    ...
    inline const ListAccountFactoryBaselinesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAccountFactoryBaselinesResponseBody) };
    inline ListAccountFactoryBaselinesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAccountFactoryBaselinesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAccountFactoryBaselinesResponseBody> body_ {};
  };
