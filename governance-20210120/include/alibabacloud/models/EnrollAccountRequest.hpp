...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountNamePrefix_ == nullptr
        ...
        && return this->payerAccountUid_ == nullptr && return this->regionId_ == nullptr && return this->resellAccountType_ == nullptr && return this->tag_ == nullptr; };
    ...
    inline const vector<EnrollAccountRequestBaselineItems> & baselineItems() const { DARABONBA_PTR_GET_CONST(baselineItems_, vector<EnrollAccountRequestBaselineItems>) };
    inline vector<EnrollAccountRequestBaselineItems> baselineItems() { DARABONBA_PTR_GET(baselineItems_, vector<EnrollAccountRequestBaselineItems>) };
    inline EnrollAccountRequest& setBaselineItems(const vector<EnrollAccountRequestBaselineItems> & baselineItems) { DARABONBA_PTR_SET_VALUE(baselineItems_, baselineItems) };
    inline EnrollAccountRequest& setBaselineItems(vector<EnrollAccountRequestBaselineItems> && baselineItems) { DARABONBA_PTR_SET_RVALUE(baselineItems_, baselineItems) };
    ...
    inline const vector<EnrollAccountRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<EnrollAccountRequestTag>) };
    inline vector<EnrollAccountRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<EnrollAccountRequestTag>) };
    inline EnrollAccountRequest& setTag(const vector<EnrollAccountRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline EnrollAccountRequest& setTag(vector<EnrollAccountRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    std::shared_ptr<vector<EnrollAccountRequestBaselineItems>> baselineItems_ = nullptr;
    ...
    std::shared_ptr<vector<EnrollAccountRequestTag>> tag_ = nullptr;
  };
