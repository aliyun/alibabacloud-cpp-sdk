...
namespace Models
{
  ...
  public:
    ...
    inline const ListEvaluationMetadataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListEvaluationMetadataResponseBody) };
    inline ListEvaluationMetadataResponseBody getBody() { DARABONBA_PTR_GET(body_, ListEvaluationMetadataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListEvaluationMetadataResponseBody> body_ {};
  };
