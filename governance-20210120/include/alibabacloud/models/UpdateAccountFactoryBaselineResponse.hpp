...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAccountFactoryBaselineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAccountFactoryBaselineResponseBody) };
    inline UpdateAccountFactoryBaselineResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAccountFactoryBaselineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAccountFactoryBaselineResponseBody> body_ {};
  };
