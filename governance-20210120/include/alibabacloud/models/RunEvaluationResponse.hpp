...
namespace Models
{
  ...
  public:
    ...
    inline const RunEvaluationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunEvaluationResponseBody) };
    inline RunEvaluationResponseBody getBody() { DARABONBA_PTR_GET(body_, RunEvaluationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunEvaluationResponseBody> body_ {};
  };
