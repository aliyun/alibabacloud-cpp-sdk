...
namespace Models
{
  ...
  public:
    ...
    inline const ListEvaluationMetricDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListEvaluationMetricDetailsResponseBody) };
    inline ListEvaluationMetricDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListEvaluationMetricDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListEvaluationMetricDetailsResponseBody> body_ {};
  };
