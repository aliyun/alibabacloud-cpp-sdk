...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAccountFactoryBaselineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAccountFactoryBaselineResponseBody) };
    inline CreateAccountFactoryBaselineResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAccountFactoryBaselineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAccountFactoryBaselineResponseBody> body_ {};
  };
