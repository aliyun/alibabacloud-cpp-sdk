...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccountFactoryBaselineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAccountFactoryBaselineResponseBody) };
    inline GetAccountFactoryBaselineResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAccountFactoryBaselineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAccountFactoryBaselineResponseBody> body_ {};
  };
