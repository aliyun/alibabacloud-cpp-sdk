...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->baselineId_ == nullptr
        && this->baselineItems_ == nullptr && this->baselineName_ == nullptr && this->description_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline const vector<UpdateAccountFactoryBaselineRequest::BaselineItems> & getBaselineItems() const { DARABONBA_PTR_GET_CONST(baselineItems_, vector<UpdateAccountFactoryBaselineRequest::BaselineItems>) };
    inline vector<UpdateAccountFactoryBaselineRequest::BaselineItems> getBaselineItems() { DARABONBA_PTR_GET(baselineItems_, vector<UpdateAccountFactoryBaselineRequest::BaselineItems>) };
    inline UpdateAccountFactoryBaselineRequest& setBaselineItems(const vector<UpdateAccountFactoryBaselineRequest::BaselineItems> & baselineItems) { DARABONBA_PTR_SET_VALUE(baselineItems_, baselineItems) };
    inline UpdateAccountFactoryBaselineRequest& setBaselineItems(vector<UpdateAccountFactoryBaselineRequest::BaselineItems> && baselineItems) { DARABONBA_PTR_SET_RVALUE(baselineItems_, baselineItems) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateAccountFactoryBaselineRequest::BaselineItems>> baselineItems_ {};
