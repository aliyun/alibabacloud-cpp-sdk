...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRegionsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeRegionsResponseBodyData) };
    inline DescribeRegionsResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeRegionsResponseBodyData) };
    inline DescribeRegionsResponseBody& setData(const DescribeRegionsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeRegionsResponseBody& setData(DescribeRegionsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRegionsResponseBodyData> data_ = nullptr;
