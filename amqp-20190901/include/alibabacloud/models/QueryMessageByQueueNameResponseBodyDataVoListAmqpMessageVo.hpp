...
#ifndef ALIBABACLOUD_MODELS_QUERYMESSAGEBYQUEUENAMERESPONSEBODYDATAVOLISTAMQPMESSAGEVO_HPP_
#define ALIBABACLOUD_MODELS_QUERYMESSAGEBYQUEUENAMERESPONSEBODYDATAVOLISTAMQPMESSAGEVO_HPP_
...
namespace Models
{
  class QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& obj) { 
    ...
    QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO() = default ;
    QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO(const QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO &) = default ;
    QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO(QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO &&) = default ;
    QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO() = default ;
    QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& operator=(const QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO &) = default ;
    QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& operator=(QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO &&) = default ;
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setAppId(string appId) { DARABONBA_PTR_SET_VALUE(appId_, appId) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setBody(string body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setClusterId(string clusterId) { DARABONBA_PTR_SET_VALUE(clusterId_, clusterId) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setContentEncoding(string contentEncoding) { DARABONBA_PTR_SET_VALUE(contentEncoding_, contentEncoding) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setContentType(string contentType) { DARABONBA_PTR_SET_VALUE(contentType_, contentType) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setCorrelationId(string correlationId) { DARABONBA_PTR_SET_VALUE(correlationId_, correlationId) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setDeliveryMode(int32_t deliveryMode) { DARABONBA_PTR_SET_VALUE(deliveryMode_, deliveryMode) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setExchangeName(string exchangeName) { DARABONBA_PTR_SET_VALUE(exchangeName_, exchangeName) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setExpiration(string expiration) { DARABONBA_PTR_SET_VALUE(expiration_, expiration) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setHeaders(string headers) { DARABONBA_PTR_SET_VALUE(headers_, headers) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setImmediate(bool immediate) { DARABONBA_PTR_SET_VALUE(immediate_, immediate) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setMandatory(bool mandatory) { DARABONBA_PTR_SET_VALUE(mandatory_, mandatory) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setMessageId(string messageId) { DARABONBA_PTR_SET_VALUE(messageId_, messageId) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setProcessToken(string processToken) { DARABONBA_PTR_SET_VALUE(processToken_, processToken) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setReconsumeTimes(int32_t reconsumeTimes) { DARABONBA_PTR_SET_VALUE(reconsumeTimes_, reconsumeTimes) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setReplyTo(string replyTo) { DARABONBA_PTR_SET_VALUE(replyTo_, replyTo) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setRoutingKey(string routingKey) { DARABONBA_PTR_SET_VALUE(routingKey_, routingKey) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setStoreTimestamp(int64_t storeTimestamp) { DARABONBA_PTR_SET_VALUE(storeTimestamp_, storeTimestamp) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline QueryMessageByQueueNameResponseBodyDataVoListAmqpMessageVO& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
