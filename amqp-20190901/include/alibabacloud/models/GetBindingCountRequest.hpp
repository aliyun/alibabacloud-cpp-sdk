...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bindingType_ == nullptr
        && this->consoleSessionId_ == nullptr && this->instanceId_ == nullptr && this->resourceName_ == nullptr && this->upstream_ == nullptr && this->vhostName_ == nullptr; };
    ...
    inline bool getUpstream() const { DARABONBA_PTR_GET_DEFAULT(upstream_, false) };
