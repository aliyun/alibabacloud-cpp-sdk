...
namespace Models
{
  ...
  public:
    ...
    inline const ListLogstoreResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListLogstoreResponseBodyData) };
    inline ListLogstoreResponseBodyData data() { DARABONBA_PTR_GET(data_, ListLogstoreResponseBodyData) };
    inline ListLogstoreResponseBody& setData(const ListLogstoreResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListLogstoreResponseBody& setData(ListLogstoreResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListLogstoreResponseBodyData> data_ = nullptr;
