...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListInstanceResponseBodyData) };
    inline ListInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, ListInstanceResponseBodyData) };
    inline ListInstanceResponseBody& setData(const ListInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListInstanceResponseBody& setData(ListInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListInstanceResponseBodyData> data_ = nullptr;
