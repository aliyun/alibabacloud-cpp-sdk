...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueueErrorByTaskIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQueueErrorByTaskIdResponseBody) };
    inline GetQueueErrorByTaskIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQueueErrorByTaskIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQueueErrorByTaskIdResponseBody> body_ {};
  };
