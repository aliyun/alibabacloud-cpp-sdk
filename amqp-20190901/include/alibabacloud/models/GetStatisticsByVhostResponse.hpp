...
namespace Models
{
  ...
  public:
    ...
    inline const GetStatisticsByVhostResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetStatisticsByVhostResponseBody) };
    inline GetStatisticsByVhostResponseBody getBody() { DARABONBA_PTR_GET(body_, GetStatisticsByVhostResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetStatisticsByVhostResponseBody> body_ {};
  };
