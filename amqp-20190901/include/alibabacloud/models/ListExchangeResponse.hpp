...
namespace Models
{
  ...
  public:
    ...
    inline const ListExchangeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExchangeResponseBody) };
    inline ListExchangeResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExchangeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExchangeResponseBody> body_ {};
  };
