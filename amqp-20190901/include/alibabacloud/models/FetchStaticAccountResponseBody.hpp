...
namespace Models
{
  ...
  public:
    ...
    inline const FetchStaticAccountResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, FetchStaticAccountResponseBodyData) };
    inline FetchStaticAccountResponseBodyData data() { DARABONBA_PTR_GET(data_, FetchStaticAccountResponseBodyData) };
    inline FetchStaticAccountResponseBody& setData(const FetchStaticAccountResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline FetchStaticAccountResponseBody& setData(FetchStaticAccountResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<FetchStaticAccountResponseBodyData> data_ = nullptr;
