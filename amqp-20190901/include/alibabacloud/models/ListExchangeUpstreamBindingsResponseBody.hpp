  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->bindType_ == nullptr && this->bindingKey_ == nullptr && this->dstName_ == nullptr && this->srcName_ == nullptr; };
          ...
          inline int32_t getBindType() const { DARABONBA_PTR_GET_DEFAULT(bindType_, 0) };
          inline BindingVO& setBindType(int32_t bindType) { DARABONBA_PTR_SET_VALUE(bindType_, bindType) };
