...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountAccessKey_ == nullptr
        && this->consoleSessionId_ == nullptr && this->createTimeStamp_ == nullptr && this->instanceId_ == nullptr && this->remark_ == nullptr && this->SKey_ == nullptr
        && this->secretSign_ == nullptr && this->userName_ == nullptr; };
    ...
    inline string getSKey() const { DARABONBA_PTR_GET_DEFAULT(SKey_, "") };
