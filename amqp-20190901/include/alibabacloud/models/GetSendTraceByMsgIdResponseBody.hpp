...
namespace Models
{
  ...
  public:
    ...
    inline const GetSendTraceByMsgIdResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSendTraceByMsgIdResponseBodyData) };
    inline GetSendTraceByMsgIdResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSendTraceByMsgIdResponseBodyData) };
    inline GetSendTraceByMsgIdResponseBody& setData(const GetSendTraceByMsgIdResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSendTraceByMsgIdResponseBody& setData(GetSendTraceByMsgIdResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSendTraceByMsgIdResponseBodyData> data_ = nullptr;
