...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueueConsumersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQueueConsumersResponseBodyData) };
    inline GetQueueConsumersResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQueueConsumersResponseBodyData) };
    inline GetQueueConsumersResponseBody& setData(const GetQueueConsumersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQueueConsumersResponseBody& setData(GetQueueConsumersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQueueConsumersResponseBodyData> data_ = nullptr;
