...
namespace Models
{
  ...
  public:
    ...
    inline const InstancePreivewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InstancePreivewResponseBody) };
    inline InstancePreivewResponseBody getBody() { DARABONBA_PTR_GET(body_, InstancePreivewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InstancePreivewResponseBody> body_ {};
  };
