...
namespace Models
{
  ...
  public:
    ...
    inline const GetExchangeRateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetExchangeRateResponseBodyData) };
    inline GetExchangeRateResponseBodyData data() { DARABONBA_PTR_GET(data_, GetExchangeRateResponseBodyData) };
    inline GetExchangeRateResponseBody& setData(const GetExchangeRateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetExchangeRateResponseBody& setData(GetExchangeRateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetExchangeRateResponseBodyData> data_ = nullptr;
