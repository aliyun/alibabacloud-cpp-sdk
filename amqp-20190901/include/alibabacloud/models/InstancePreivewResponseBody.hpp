...
namespace Models
{
  ...
  public:
    ...
    inline const InstancePreivewResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, InstancePreivewResponseBodyData) };
    inline InstancePreivewResponseBodyData data() { DARABONBA_PTR_GET(data_, InstancePreivewResponseBodyData) };
    inline InstancePreivewResponseBody& setData(const InstancePreivewResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline InstancePreivewResponseBody& setData(InstancePreivewResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<InstancePreivewResponseBodyData> data_ = nullptr;
