...
namespace Models
{
  ...
  public:
    ...
    inline const GetStatisticsByVhostResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetStatisticsByVhostResponseBodyData) };
    inline GetStatisticsByVhostResponseBodyData data() { DARABONBA_PTR_GET(data_, GetStatisticsByVhostResponseBodyData) };
    inline GetStatisticsByVhostResponseBody& setData(const GetStatisticsByVhostResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetStatisticsByVhostResponseBody& setData(GetStatisticsByVhostResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetStatisticsByVhostResponseBodyData> data_ = nullptr;
