...
namespace Models
{
  ...
  public:
    ...
    inline const GetSendTraceByConnectionAndChannelAndDeliveryTagResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSendTraceByConnectionAndChannelAndDeliveryTagResponseBodyData) };
    inline GetSendTraceByConnectionAndChannelAndDeliveryTagResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSendTraceByConnectionAndChannelAndDeliveryTagResponseBodyData) };
    inline GetSendTraceByConnectionAndChannelAndDeliveryTagResponseBody& setData(const GetSendTraceByConnectionAndChannelAndDeliveryTagResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSendTraceByConnectionAndChannelAndDeliveryTagResponseBody& setData(GetSendTraceByConnectionAndChannelAndDeliveryTagResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSendTraceByConnectionAndChannelAndDeliveryTagResponseBodyData> data_ = nullptr;
