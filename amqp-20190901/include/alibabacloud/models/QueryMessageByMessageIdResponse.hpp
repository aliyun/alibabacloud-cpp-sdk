...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMessageByMessageIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryMessageByMessageIdResponseBody) };
    inline QueryMessageByMessageIdResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryMessageByMessageIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryMessageByMessageIdResponseBody> body_ {};
  };
