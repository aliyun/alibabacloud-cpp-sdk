...
namespace Models
{
  ...
  public:
    ...
    inline CreateExchangeResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreateExchangeResponseBody& setData(bool data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline CreateExchangeResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateExchangeResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
