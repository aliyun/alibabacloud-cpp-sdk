...
namespace Models
{
  ...
  public:
    ...
    inline const GetVhostErrorByTaskIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVhostErrorByTaskIdResponseBody) };
    inline GetVhostErrorByTaskIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVhostErrorByTaskIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVhostErrorByTaskIdResponseBody> body_ {};
  };
