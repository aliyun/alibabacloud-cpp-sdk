...
namespace Models
{
  ...
  public:
    ...
    inline const GetTaskByUidResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTaskByUidResponseBody) };
    inline GetTaskByUidResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTaskByUidResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTaskByUidResponseBody> body_ {};
  };
