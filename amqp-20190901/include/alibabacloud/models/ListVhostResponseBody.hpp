...
namespace Models
{
  ...
  public:
    ...
    inline const ListVhostResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListVhostResponseBodyData) };
    inline ListVhostResponseBodyData data() { DARABONBA_PTR_GET(data_, ListVhostResponseBodyData) };
    inline ListVhostResponseBody& setData(const ListVhostResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListVhostResponseBody& setData(ListVhostResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListVhostResponseBodyData> data_ = nullptr;
