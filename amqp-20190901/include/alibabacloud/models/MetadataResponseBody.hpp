...
namespace Models
{
  ...
  public:
    ...
    inline const MetadataResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, MetadataResponseBodyData) };
    inline MetadataResponseBodyData data() { DARABONBA_PTR_GET(data_, MetadataResponseBodyData) };
    inline MetadataResponseBody& setData(const MetadataResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline MetadataResponseBody& setData(MetadataResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<MetadataResponseBodyData> data_ = nullptr;
