...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->consoleSessionId_ == nullptr && this->currentPage_ == nullptr && this->endTime_ == nullptr && this->instanceId_ == nullptr && this->intervalSec_ == nullptr
    ...
    inline int32_t getIntervalSec() const { DARABONBA_PTR_GET_DEFAULT(intervalSec_, 0) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<int32_t> intervalSec_ {};
    // This parameter is required.
