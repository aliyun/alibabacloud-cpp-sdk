...
namespace Models
{
  ...
  public:
    ...
    inline UnbindResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UnbindResponseBody& setData(bool data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline UnbindResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UnbindResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
