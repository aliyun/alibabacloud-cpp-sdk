...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueueErrorByTaskIdResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQueueErrorByTaskIdResponseBodyData) };
    inline GetQueueErrorByTaskIdResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQueueErrorByTaskIdResponseBodyData) };
    inline GetQueueErrorByTaskIdResponseBody& setData(const GetQueueErrorByTaskIdResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQueueErrorByTaskIdResponseBody& setData(GetQueueErrorByTaskIdResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQueueErrorByTaskIdResponseBodyData> data_ = nullptr;
