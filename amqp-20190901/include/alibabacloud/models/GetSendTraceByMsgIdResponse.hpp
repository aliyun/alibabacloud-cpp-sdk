...
namespace Models
{
  ...
  public:
    ...
    inline const GetSendTraceByMsgIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSendTraceByMsgIdResponseBody) };
    inline GetSendTraceByMsgIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSendTraceByMsgIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSendTraceByMsgIdResponseBody> body_ {};
  };
