...
namespace Models
{
  ...
  public:
    ...
    inline const ListStaticAccountsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListStaticAccountsResponseBody) };
    inline ListStaticAccountsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListStaticAccountsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListStaticAccountsResponseBody> body_ {};
  };
