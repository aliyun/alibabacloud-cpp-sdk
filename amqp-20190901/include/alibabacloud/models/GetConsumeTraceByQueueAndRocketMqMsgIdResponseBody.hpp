...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetConsumeTraceByQueueAndRocketMqMsgIdResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetConsumeTraceByQueueAndRocketMqMsgIdResponseBodyData>) };
    inline vector<GetConsumeTraceByQueueAndRocketMqMsgIdResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetConsumeTraceByQueueAndRocketMqMsgIdResponseBodyData>) };
    inline GetConsumeTraceByQueueAndRocketMqMsgIdResponseBody& setData(const vector<GetConsumeTraceByQueueAndRocketMqMsgIdResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetConsumeTraceByQueueAndRocketMqMsgIdResponseBody& setData(vector<GetConsumeTraceByQueueAndRocketMqMsgIdResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetConsumeTraceByQueueAndRocketMqMsgIdResponseBodyData>> data_ = nullptr;
