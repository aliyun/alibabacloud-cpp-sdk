...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueueConsumersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQueueConsumersResponseBody) };
    inline GetQueueConsumersResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQueueConsumersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQueueConsumersResponseBody> body_ {};
  };
