...
namespace Models
{
  ...
  public:
    ...
    inline const GetExchangeRateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetExchangeRateResponseBody) };
    inline GetExchangeRateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetExchangeRateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetExchangeRateResponseBody> body_ {};
  };
