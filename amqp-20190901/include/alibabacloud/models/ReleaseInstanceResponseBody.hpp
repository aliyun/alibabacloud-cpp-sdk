...
namespace Models
{
  ...
  public:
    ...
    inline ReleaseInstanceResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ReleaseInstanceResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
