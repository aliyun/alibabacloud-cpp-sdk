...
namespace Models
{
  ...
  public:
    ...
    inline const ExportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExportResponseBody) };
    inline ExportResponseBody getBody() { DARABONBA_PTR_GET(body_, ExportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExportResponseBody> body_ {};
  };
