...
namespace Models
{
  ...
  public:
    ...
    inline const GetExchangeErrorByTaskIdResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetExchangeErrorByTaskIdResponseBodyData) };
    inline GetExchangeErrorByTaskIdResponseBodyData data() { DARABONBA_PTR_GET(data_, GetExchangeErrorByTaskIdResponseBodyData) };
    inline GetExchangeErrorByTaskIdResponseBody& setData(const GetExchangeErrorByTaskIdResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetExchangeErrorByTaskIdResponseBody& setData(GetExchangeErrorByTaskIdResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetExchangeErrorByTaskIdResponseBodyData> data_ = nullptr;
