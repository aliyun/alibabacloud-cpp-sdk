...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alternateExchange_ == nullptr
        && this->autoDelete_ == nullptr && this->consoleSessionId_ == nullptr && this->exchangeName_ == nullptr && this->exchangeType_ == nullptr && this->instanceId_ == nullptr
        && this->internal_ == nullptr && this->vhostName_ == nullptr && this->XDelayedType_ == nullptr && this->XHashHeader_ == nullptr; };
    ...
    inline string getXHashHeader() const { DARABONBA_PTR_GET_DEFAULT(XHashHeader_, "") };
  ...
  protected:
    ...
    shared_ptr<string> XHashHeader_ {};
  };
