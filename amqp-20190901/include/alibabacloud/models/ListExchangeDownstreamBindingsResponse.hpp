...
namespace Models
{
  ...
  public:
    ...
    inline const ListExchangeDownstreamBindingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExchangeDownstreamBindingsResponseBody) };
    inline ListExchangeDownstreamBindingsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExchangeDownstreamBindingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExchangeDownstreamBindingsResponseBody> body_ {};
  };
