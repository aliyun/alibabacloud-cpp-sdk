...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateInstanceRetryStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateInstanceRetryStrategyResponseBody) };
    inline UpdateInstanceRetryStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateInstanceRetryStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateInstanceRetryStrategyResponseBody> body_ {};
  };
