...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bucketName_ == nullptr
        && this->consoleSessionId_ == nullptr && this->instanceId_ == nullptr && this->logstore_ == nullptr && this->projectName_ == nullptr && this->putType_ == nullptr; };
    ...
    inline string getPutType() const { DARABONBA_PTR_GET_DEFAULT(putType_, "") };
