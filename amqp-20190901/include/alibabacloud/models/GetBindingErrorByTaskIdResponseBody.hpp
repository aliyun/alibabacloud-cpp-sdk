...
namespace Models
{
  ...
  public:
    ...
    inline const GetBindingErrorByTaskIdResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetBindingErrorByTaskIdResponseBodyData) };
    inline GetBindingErrorByTaskIdResponseBodyData data() { DARABONBA_PTR_GET(data_, GetBindingErrorByTaskIdResponseBodyData) };
    inline GetBindingErrorByTaskIdResponseBody& setData(const GetBindingErrorByTaskIdResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetBindingErrorByTaskIdResponseBody& setData(GetBindingErrorByTaskIdResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetBindingErrorByTaskIdResponseBodyData> data_ = nullptr;
