...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->consoleSessionId_ == nullptr
        && this->instanceId_ == nullptr && this->vhostName_ == nullptr && this->vhostNamesShrink_ == nullptr; };
    ...
    inline string getVhostNamesShrink() const { DARABONBA_PTR_GET_DEFAULT(vhostNamesShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> vhostNamesShrink_ {};
  };
