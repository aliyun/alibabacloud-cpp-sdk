...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->consoleSessionId_ == nullptr
        && this->currentPage_ == nullptr && this->instanceId_ == nullptr && this->pageSize_ == nullptr && this->queueNamePrefix_ == nullptr && this->vhostName_ == nullptr; };
    ...
    inline string getQueueNamePrefix() const { DARABONBA_PTR_GET_DEFAULT(queueNamePrefix_, "") };
  ...
  protected:
    ...
    shared_ptr<string> queueNamePrefix_ {};
    // This parameter is required.
