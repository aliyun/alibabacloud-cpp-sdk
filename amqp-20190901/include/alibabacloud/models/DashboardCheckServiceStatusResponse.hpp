...
namespace Models
{
  ...
  public:
    ...
    inline const DashboardCheckServiceStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DashboardCheckServiceStatusResponseBody) };
    inline DashboardCheckServiceStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DashboardCheckServiceStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DashboardCheckServiceStatusResponseBody> body_ {};
  };
