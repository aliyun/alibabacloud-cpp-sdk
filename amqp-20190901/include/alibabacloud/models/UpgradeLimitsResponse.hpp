...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeLimitsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeLimitsResponseBody) };
    inline UpgradeLimitsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeLimitsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeLimitsResponseBody> body_ {};
  };
