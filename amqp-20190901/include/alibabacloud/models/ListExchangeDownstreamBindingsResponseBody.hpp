...
namespace Models
{
  ...
  public:
    ...
    inline const ListExchangeDownstreamBindingsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListExchangeDownstreamBindingsResponseBodyData) };
    inline ListExchangeDownstreamBindingsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListExchangeDownstreamBindingsResponseBodyData) };
    inline ListExchangeDownstreamBindingsResponseBody& setData(const ListExchangeDownstreamBindingsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListExchangeDownstreamBindingsResponseBody& setData(ListExchangeDownstreamBindingsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListExchangeDownstreamBindingsResponseBodyData> data_ = nullptr;
