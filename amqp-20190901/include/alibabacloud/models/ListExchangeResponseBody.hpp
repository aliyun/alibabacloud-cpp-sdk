...
namespace Models
{
  ...
  public:
    ...
    inline const ListExchangeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListExchangeResponseBodyData) };
    inline ListExchangeResponseBodyData data() { DARABONBA_PTR_GET(data_, ListExchangeResponseBodyData) };
    inline ListExchangeResponseBody& setData(const ListExchangeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListExchangeResponseBody& setData(ListExchangeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListExchangeResponseBodyData> data_ = nullptr;
