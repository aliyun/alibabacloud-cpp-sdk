...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetQueueRateResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetQueueRateResponseBodyData>) };
    inline vector<GetQueueRateResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetQueueRateResponseBodyData>) };
    inline GetQueueRateResponseBody& setData(const vector<GetQueueRateResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQueueRateResponseBody& setData(vector<GetQueueRateResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetQueueRateResponseBodyData>> data_ = nullptr;
