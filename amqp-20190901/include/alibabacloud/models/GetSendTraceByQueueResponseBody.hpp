...
#ifndef ALIBABACLOUD_MODELS_GETSENDTRACEBYQUEUERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETSENDTRACEBYQUEUERESPONSEBODY_HPP_
...
namespace Models
{
  class GetSendTraceByQueueResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetSendTraceByQueueResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSendTraceByQueueResponseBody& obj) { 
    ...
    GetSendTraceByQueueResponseBody() = default ;
    GetSendTraceByQueueResponseBody(const GetSendTraceByQueueResponseBody &) = default ;
    GetSendTraceByQueueResponseBody(GetSendTraceByQueueResponseBody &&) = default ;
    GetSendTraceByQueueResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSendTraceByQueueResponseBody() = default ;
    GetSendTraceByQueueResponseBody& operator=(const GetSendTraceByQueueResponseBody &) = default ;
    GetSendTraceByQueueResponseBody& operator=(GetSendTraceByQueueResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->exchange_ == nullptr && this->messageBodyLength_ == nullptr && this->messageId_ == nullptr && this->messagePropertiesMap_ == nullptr && this->queueMsgIdMap_ == nullptr
    ...
    inline GetSendTraceByQueueResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetSendTraceByQueueResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetSendTraceByQueueResponseBody::Data) };
    inline GetSendTraceByQueueResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetSendTraceByQueueResponseBody::Data) };
    inline GetSendTraceByQueueResponseBody& setData(const GetSendTraceByQueueResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSendTraceByQueueResponseBody& setData(GetSendTraceByQueueResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetSendTraceByQueueResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetSendTraceByQueueResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetSendTraceByQueueResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<int32_t> code_ {};
    shared_ptr<GetSendTraceByQueueResponseBody::Data> data_ {};
