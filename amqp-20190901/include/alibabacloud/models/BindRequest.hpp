...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->argument_ == nullptr
        && this->bindingKey_ == nullptr && this->bindingType_ == nullptr && this->consoleSessionId_ == nullptr && this->dstName_ == nullptr && this->instanceId_ == nullptr
        && this->srcName_ == nullptr && this->vhostName_ == nullptr; };
