...
namespace Models
{
  ...
  public:
    ...
    inline const GetVhostErrorByTaskIdResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetVhostErrorByTaskIdResponseBodyData) };
    inline GetVhostErrorByTaskIdResponseBodyData data() { DARABONBA_PTR_GET(data_, GetVhostErrorByTaskIdResponseBodyData) };
    inline GetVhostErrorByTaskIdResponseBody& setData(const GetVhostErrorByTaskIdResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetVhostErrorByTaskIdResponseBody& setData(GetVhostErrorByTaskIdResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetVhostErrorByTaskIdResponseBodyData> data_ = nullptr;
