...
namespace Models
{
  ...
  public:
    ...
    inline CreateQueueResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreateQueueResponseBody& setData(bool data) { DARABONBA_PTR_SET_VALUE(data_, data) };
