...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMessageByMessageIdResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryMessageByMessageIdResponseBodyData) };
    inline QueryMessageByMessageIdResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryMessageByMessageIdResponseBodyData) };
    inline QueryMessageByMessageIdResponseBody& setData(const QueryMessageByMessageIdResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryMessageByMessageIdResponseBody& setData(QueryMessageByMessageIdResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryMessageByMessageIdResponseBodyData> data_ = nullptr;
