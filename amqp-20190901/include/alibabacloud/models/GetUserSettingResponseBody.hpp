...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserSettingResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetUserSettingResponseBodyData) };
    inline GetUserSettingResponseBodyData data() { DARABONBA_PTR_GET(data_, GetUserSettingResponseBodyData) };
    inline GetUserSettingResponseBody& setData(const GetUserSettingResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetUserSettingResponseBody& setData(GetUserSettingResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetUserSettingResponseBodyData> data_ = nullptr;
