...
namespace Models
{
  ...
  public:
    ...
    inline const GetVhostRateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVhostRateResponseBody) };
    inline GetVhostRateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVhostRateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVhostRateResponseBody> body_ {};
  };
