...
namespace Models
{
  ...
  public:
    ...
    inline const ListQueueResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListQueueResponseBodyData) };
    inline ListQueueResponseBodyData data() { DARABONBA_PTR_GET(data_, ListQueueResponseBodyData) };
    inline ListQueueResponseBody& setData(const ListQueueResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListQueueResponseBody& setData(ListQueueResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListQueueResponseBodyData> data_ = nullptr;
