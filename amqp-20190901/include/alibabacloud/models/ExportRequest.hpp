...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->consoleSessionId_ == nullptr
        && this->exportType_ == nullptr && this->instanceId_ == nullptr && this->vhostName_ == nullptr; };
    ...
    inline int32_t getExportType() const { DARABONBA_PTR_GET_DEFAULT(exportType_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> exportType_ {};
    // This parameter is required.
