...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMessageByQueueNameResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryMessageByQueueNameResponseBodyData) };
    inline QueryMessageByQueueNameResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryMessageByQueueNameResponseBodyData) };
    inline QueryMessageByQueueNameResponseBody& setData(const QueryMessageByQueueNameResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryMessageByQueueNameResponseBody& setData(QueryMessageByQueueNameResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryMessageByQueueNameResponseBodyData> data_ = nullptr;
