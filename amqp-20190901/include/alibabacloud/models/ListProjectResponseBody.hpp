...
namespace Models
{
  ...
  public:
    ...
    inline const ListProjectResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListProjectResponseBodyData) };
    inline ListProjectResponseBodyData data() { DARABONBA_PTR_GET(data_, ListProjectResponseBodyData) };
    inline ListProjectResponseBody& setData(const ListProjectResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListProjectResponseBody& setData(ListProjectResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListProjectResponseBodyData> data_ = nullptr;
