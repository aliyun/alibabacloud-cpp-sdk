...
namespace Models
{
  ...
  public:
    ...
    inline const GetAckInfoByIntervalResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAckInfoByIntervalResponseBodyData) };
    inline GetAckInfoByIntervalResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAckInfoByIntervalResponseBodyData) };
    inline GetAckInfoByIntervalResponseBody& setData(const GetAckInfoByIntervalResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAckInfoByIntervalResponseBody& setData(GetAckInfoByIntervalResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAckInfoByIntervalResponseBodyData> data_ = nullptr;
