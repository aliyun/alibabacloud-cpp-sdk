...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteExchangeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteExchangeResponseBody) };
    inline DeleteExchangeResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteExchangeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteExchangeResponseBody> body_ {};
  };
