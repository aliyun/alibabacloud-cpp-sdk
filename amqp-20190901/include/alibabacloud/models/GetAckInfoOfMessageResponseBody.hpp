...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetAckInfoOfMessageResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetAckInfoOfMessageResponseBodyData>) };
    inline vector<GetAckInfoOfMessageResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetAckInfoOfMessageResponseBodyData>) };
    inline GetAckInfoOfMessageResponseBody& setData(const vector<GetAckInfoOfMessageResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAckInfoOfMessageResponseBody& setData(vector<GetAckInfoOfMessageResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetAckInfoOfMessageResponseBodyData>> data_ = nullptr;
