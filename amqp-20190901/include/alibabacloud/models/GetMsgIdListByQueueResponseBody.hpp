...
namespace Models
{
  ...
  public:
    ...
    inline const GetMsgIdListByQueueResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMsgIdListByQueueResponseBodyData) };
    inline GetMsgIdListByQueueResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMsgIdListByQueueResponseBodyData) };
    inline GetMsgIdListByQueueResponseBody& setData(const GetMsgIdListByQueueResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMsgIdListByQueueResponseBody& setData(GetMsgIdListByQueueResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetMsgIdListByQueueResponseBodyData> data_ = nullptr;
