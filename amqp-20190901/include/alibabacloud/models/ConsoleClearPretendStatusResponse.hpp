...
namespace Models
{
  ...
  public:
    ...
    inline const ConsoleClearPretendStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConsoleClearPretendStatusResponseBody) };
    inline ConsoleClearPretendStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, ConsoleClearPretendStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConsoleClearPretendStatusResponseBody> body_ {};
  };
