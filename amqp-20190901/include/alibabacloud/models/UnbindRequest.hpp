...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bindingKey_ == nullptr
        && return this->bindingType_ == nullptr && return this->consoleSessionId_ == nullptr && return this->dstName_ == nullptr && return this->instanceId_ == nullptr && return this->srcName_ == nullptr
    ...
    inline UnbindRequest& setBindingKey(string bindingKey) { DARABONBA_PTR_SET_VALUE(bindingKey_, bindingKey) };
    ...
    inline UnbindRequest& setBindingType(int32_t bindingType) { DARABONBA_PTR_SET_VALUE(bindingType_, bindingType) };
    ...
    inline UnbindRequest& setConsoleSessionId(string consoleSessionId) { DARABONBA_PTR_SET_VALUE(consoleSessionId_, consoleSessionId) };
    ...
    inline UnbindRequest& setDstName(string dstName) { DARABONBA_PTR_SET_VALUE(dstName_, dstName) };
    ...
    inline UnbindRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline UnbindRequest& setSrcName(string srcName) { DARABONBA_PTR_SET_VALUE(srcName_, srcName) };
    ...
    inline UnbindRequest& setVhostName(string vhostName) { DARABONBA_PTR_SET_VALUE(vhostName_, vhostName) };
