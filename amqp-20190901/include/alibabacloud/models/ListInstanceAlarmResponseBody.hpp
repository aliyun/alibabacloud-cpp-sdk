...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceAlarmResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListInstanceAlarmResponseBodyData) };
    inline ListInstanceAlarmResponseBodyData data() { DARABONBA_PTR_GET(data_, ListInstanceAlarmResponseBodyData) };
    inline ListInstanceAlarmResponseBody& setData(const ListInstanceAlarmResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListInstanceAlarmResponseBody& setData(ListInstanceAlarmResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListInstanceAlarmResponseBodyData> data_ = nullptr;
