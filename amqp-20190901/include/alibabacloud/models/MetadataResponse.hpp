...
namespace Models
{
  ...
  public:
    ...
    inline const MetadataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MetadataResponseBody) };
    inline MetadataResponseBody getBody() { DARABONBA_PTR_GET(body_, MetadataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MetadataResponseBody> body_ {};
  };
