...
namespace Models
{
  ...
  public:
    ...
    inline const GetConsumeTraceByQueueAndRocketMqMsgIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetConsumeTraceByQueueAndRocketMqMsgIdResponseBody) };
    inline GetConsumeTraceByQueueAndRocketMqMsgIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetConsumeTraceByQueueAndRocketMqMsgIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetConsumeTraceByQueueAndRocketMqMsgIdResponseBody> body_ {};
  };
