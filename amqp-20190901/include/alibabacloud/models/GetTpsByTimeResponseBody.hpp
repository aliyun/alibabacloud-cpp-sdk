...
namespace Models
{
  class GetTpsByTimeResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetTpsByTimeResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetTpsByTimeResponseBody& obj) { 
    ...
    GetTpsByTimeResponseBody() = default ;
    GetTpsByTimeResponseBody(const GetTpsByTimeResponseBody &) = default ;
    GetTpsByTimeResponseBody(GetTpsByTimeResponseBody &&) = default ;
    GetTpsByTimeResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetTpsByTimeResponseBody() = default ;
    GetTpsByTimeResponseBody& operator=(const GetTpsByTimeResponseBody &) = default ;
    GetTpsByTimeResponseBody& operator=(GetTpsByTimeResponseBody &&) = default ;
