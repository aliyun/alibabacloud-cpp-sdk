...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPageNum_ == nullptr
        && return this->data_ == nullptr && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->totalItemNum_ == nullptr
    ...
    inline const vector<ListProduceAuthorizationResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListProduceAuthorizationResponseBodyData>) };
    inline vector<ListProduceAuthorizationResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListProduceAuthorizationResponseBodyData>) };
    inline ListProduceAuthorizationResponseBody& setData(const vector<ListProduceAuthorizationResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListProduceAuthorizationResponseBody& setData(vector<ListProduceAuthorizationResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListProduceAuthorizationResponseBodyData>> data_ = nullptr;
