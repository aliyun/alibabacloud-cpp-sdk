...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bizId_ == nullptr
        && this->bizType_ == nullptr && this->employeeCode_ == nullptr && this->personId_ == nullptr && this->remark_ == nullptr; };
    ...
    inline TransferIntentionOwnerRequest& setEmployeeCode(string employeeCode) { DARABONBA_PTR_SET_VALUE(employeeCode_, employeeCode) };


    // personId Field Functions 
    bool hasPersonId() const { return this->personId_ != nullptr;};
    void deletePersonId() { this->personId_ = nullptr;};
    inline int32_t getPersonId() const { DARABONBA_PTR_GET_DEFAULT(personId_, 0) };
