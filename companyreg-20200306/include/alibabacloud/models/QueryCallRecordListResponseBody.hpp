...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryCallRecordListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryCallRecordListResponseBodyData>) };
    inline vector<QueryCallRecordListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryCallRecordListResponseBodyData>) };
    inline QueryCallRecordListResponseBody& setData(const vector<QueryCallRecordListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryCallRecordListResponseBody& setData(vector<QueryCallRecordListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<QueryCallRecordListResponseBodyData>> data_ = nullptr;
