...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bizId_ == nullptr
        && return this->bizType_ == nullptr && return this->callCenterNumber_ == nullptr && return this->caller_ == nullptr && return this->mobileKey_ == nullptr && return this->skillType_ == nullptr; };
    ...
    inline string callCenterNumber() const { DARABONBA_PTR_GET_DEFAULT(callCenterNumber_, "") };
    ...
    inline string mobileKey() const { DARABONBA_PTR_GET_DEFAULT(mobileKey_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> callCenterNumber_ = nullptr;
    // This parameter is required.
    std::shared_ptr<string> caller_ = nullptr;
    std::shared_ptr<string> mobileKey_ = nullptr;
    // This parameter is required.
