...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserDetailSolutionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserDetailSolutionsResponseBody) };
    inline ListUserDetailSolutionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserDetailSolutionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserDetailSolutionsResponseBody> body_ {};
  };
