...
namespace Models
{
  ...
  public:
    ...
    inline const RejectSolutionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RejectSolutionResponseBody) };
    inline RejectSolutionResponseBody getBody() { DARABONBA_PTR_GET(body_, RejectSolutionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RejectSolutionResponseBody> body_ {};
  };
