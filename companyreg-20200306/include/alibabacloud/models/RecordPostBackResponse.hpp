...
namespace Models
{
  ...
  public:
    ...
    inline const RecordPostBackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RecordPostBackResponseBody) };
    inline RecordPostBackResponseBody getBody() { DARABONBA_PTR_GET(body_, RecordPostBackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RecordPostBackResponseBody> body_ {};
  };
