...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListIntentionNoteResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListIntentionNoteResponseBodyData>) };
    inline vector<ListIntentionNoteResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListIntentionNoteResponseBodyData>) };
    inline ListIntentionNoteResponseBody& setData(const vector<ListIntentionNoteResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIntentionNoteResponseBody& setData(vector<ListIntentionNoteResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListIntentionNoteResponseBodyData>> data_ = nullptr;
