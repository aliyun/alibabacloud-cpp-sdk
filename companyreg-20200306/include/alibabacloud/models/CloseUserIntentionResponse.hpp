...
namespace Models
{
  ...
  public:
    ...
    inline const CloseUserIntentionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CloseUserIntentionResponseBody) };
    inline CloseUserIntentionResponseBody getBody() { DARABONBA_PTR_GET(body_, CloseUserIntentionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CloseUserIntentionResponseBody> body_ {};
  };
