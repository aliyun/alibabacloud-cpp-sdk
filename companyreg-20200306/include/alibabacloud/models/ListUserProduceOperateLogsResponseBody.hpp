...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListUserProduceOperateLogsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListUserProduceOperateLogsResponseBodyData>) };
    inline vector<ListUserProduceOperateLogsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListUserProduceOperateLogsResponseBodyData>) };
    inline ListUserProduceOperateLogsResponseBody& setData(const vector<ListUserProduceOperateLogsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListUserProduceOperateLogsResponseBody& setData(vector<ListUserProduceOperateLogsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<ListUserProduceOperateLogsResponseBodyData>> data_ = nullptr;
