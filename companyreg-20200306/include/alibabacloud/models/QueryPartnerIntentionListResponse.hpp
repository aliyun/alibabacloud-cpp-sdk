...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPartnerIntentionListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryPartnerIntentionListResponseBody) };
    inline QueryPartnerIntentionListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryPartnerIntentionListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryPartnerIntentionListResponseBody> body_ {};
  };
