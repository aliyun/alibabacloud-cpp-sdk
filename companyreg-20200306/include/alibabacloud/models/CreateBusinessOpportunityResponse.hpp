...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBusinessOpportunityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBusinessOpportunityResponseBody) };
    inline CreateBusinessOpportunityResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBusinessOpportunityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBusinessOpportunityResponseBody> body_ {};
  };
