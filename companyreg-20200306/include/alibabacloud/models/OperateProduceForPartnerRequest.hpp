...
#ifndef ALIBABACLOUD_MODELS_OPERATEPRODUCEFORPARTNERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_OPERATEPRODUCEFORPARTNERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const OperateProduceForPartnerRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BizId, bizId_);
      DARABONBA_PTR_TO_JSON(BizType, bizType_);
      DARABONBA_PTR_TO_JSON(ExtInfo, extInfo_);
      DARABONBA_PTR_TO_JSON(OperateType, operateType_);
    };
    friend void from_json(const Darabonba::Json& j, OperateProduceForPartnerRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BizId, bizId_);
      DARABONBA_PTR_FROM_JSON(BizType, bizType_);
      DARABONBA_PTR_FROM_JSON(ExtInfo, extInfo_);
      DARABONBA_PTR_FROM_JSON(OperateType, operateType_);
    };
    OperateProduceForPartnerRequest() = default ;
    OperateProduceForPartnerRequest(const OperateProduceForPartnerRequest &) = default ;
    OperateProduceForPartnerRequest(OperateProduceForPartnerRequest &&) = default ;
    OperateProduceForPartnerRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~OperateProduceForPartnerRequest() = default ;
    OperateProduceForPartnerRequest& operator=(const OperateProduceForPartnerRequest &) = default ;
    OperateProduceForPartnerRequest& operator=(OperateProduceForPartnerRequest &&) = default ;
