...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListUserSolutionsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListUserSolutionsResponseBodyData>) };
    inline vector<ListUserSolutionsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListUserSolutionsResponseBodyData>) };
    inline ListUserSolutionsResponseBody& setData(const vector<ListUserSolutionsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListUserSolutionsResponseBody& setData(vector<ListUserSolutionsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListUserSolutionsResponseBodyData>> data_ = nullptr;
