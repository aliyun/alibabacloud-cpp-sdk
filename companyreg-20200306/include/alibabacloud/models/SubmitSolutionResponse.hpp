...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitSolutionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitSolutionResponseBody) };
    inline SubmitSolutionResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitSolutionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitSolutionResponseBody> body_ {};
  };
