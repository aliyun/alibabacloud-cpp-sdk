...
namespace Models
{
  ...
  public:
    ...
    inline const CloseIntentionForPartnerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CloseIntentionForPartnerResponseBody) };
    inline CloseIntentionForPartnerResponseBody getBody() { DARABONBA_PTR_GET(body_, CloseIntentionForPartnerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CloseIntentionForPartnerResponseBody> body_ {};
  };
