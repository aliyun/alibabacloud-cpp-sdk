...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListUserIntentionsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListUserIntentionsResponseBodyData>) };
    inline vector<ListUserIntentionsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListUserIntentionsResponseBodyData>) };
    inline ListUserIntentionsResponseBody& setData(const vector<ListUserIntentionsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListUserIntentionsResponseBody& setData(vector<ListUserIntentionsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListUserIntentionsResponseBodyData>> data_ = nullptr;
