...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryPartnerIntentionListResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryPartnerIntentionListResponseBody::Data>) };
    inline vector<QueryPartnerIntentionListResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<QueryPartnerIntentionListResponseBody::Data>) };
    inline QueryPartnerIntentionListResponseBody& setData(const vector<QueryPartnerIntentionListResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryPartnerIntentionListResponseBody& setData(vector<QueryPartnerIntentionListResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<vector<QueryPartnerIntentionListResponseBody::Data>> data_ {};
