...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->needAuth_ == nullptr
    ...
    inline bool getNeedAuth() const { DARABONBA_PTR_GET_DEFAULT(needAuth_, false) };
