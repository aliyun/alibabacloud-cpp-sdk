...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bizType_ == nullptr
        && return this->existStatusShrink_ == nullptr && return this->intentionBizId_ == nullptr && return this->pageNum_ == nullptr && return this->pageSize_ == nullptr; };
    ...
    inline string existStatusShrink() const { DARABONBA_PTR_GET_DEFAULT(existStatusShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> existStatusShrink_ = nullptr;
