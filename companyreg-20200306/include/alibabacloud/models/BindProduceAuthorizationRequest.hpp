...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->authorizedUserIds_ != nullptr
    ...
    inline string authorizedUserIds() const { DARABONBA_PTR_GET_DEFAULT(authorizedUserIds_, "") };
  ...
  protected:
    std::shared_ptr<string> authorizedUserIds_ = nullptr;
