...
namespace Models
{
  ...
  public:
    ...
    inline const QueryInstanceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryInstanceResponseBody) };
    inline QueryInstanceResponseBody body() { DARABONBA_PTR_GET(body_, QueryInstanceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryInstanceResponseBody> body_ = nullptr;
  };
