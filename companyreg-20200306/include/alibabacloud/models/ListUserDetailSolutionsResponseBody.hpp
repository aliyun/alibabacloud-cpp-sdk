...
#ifndef ALIBABACLOUD_MODELS_LISTUSERDETAILSOLUTIONSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTUSERDETAILSOLUTIONSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListUserDetailSolutionsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListUserDetailSolutionsResponseBody& obj) { 
    ...
    ListUserDetailSolutionsResponseBody() = default ;
    ListUserDetailSolutionsResponseBody(const ListUserDetailSolutionsResponseBody &) = default ;
    ListUserDetailSolutionsResponseBody(ListUserDetailSolutionsResponseBody &&) = default ;
    ListUserDetailSolutionsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListUserDetailSolutionsResponseBody() = default ;
    ListUserDetailSolutionsResponseBody& operator=(const ListUserDetailSolutionsResponseBody &) = default ;
    ListUserDetailSolutionsResponseBody& operator=(ListUserDetailSolutionsResponseBody &&) = default ;
    ...
    inline ListUserDetailSolutionsResponseBody& setCurrentPageNum(int32_t currentPageNum) { DARABONBA_PTR_SET_VALUE(currentPageNum_, currentPageNum) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListUserDetailSolutionsResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListUserDetailSolutionsResponseBody::Data>) };
    inline vector<ListUserDetailSolutionsResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListUserDetailSolutionsResponseBody::Data>) };
    inline ListUserDetailSolutionsResponseBody& setData(const vector<ListUserDetailSolutionsResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListUserDetailSolutionsResponseBody& setData(vector<ListUserDetailSolutionsResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListUserDetailSolutionsResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListUserDetailSolutionsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListUserDetailSolutionsResponseBody& setTotalItemNum(int32_t totalItemNum) { DARABONBA_PTR_SET_VALUE(totalItemNum_, totalItemNum) };
    ...
    inline ListUserDetailSolutionsResponseBody& setTotalPageNum(int32_t totalPageNum) { DARABONBA_PTR_SET_VALUE(totalPageNum_, totalPageNum) };


  protected:
    shared_ptr<int32_t> currentPageNum_ {};
    shared_ptr<vector<ListUserDetailSolutionsResponseBody::Data>> data_ {};
