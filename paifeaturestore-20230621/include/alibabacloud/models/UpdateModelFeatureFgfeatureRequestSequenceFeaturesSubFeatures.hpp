...
#ifndef ALIBABACLOUD_MODELS_UPDATEMODELFEATUREFGFEATUREREQUESTSEQUENCEFEATURESSUBFEATURES_HPP_
#define ALIBABACLOUD_MODELS_UPDATEMODELFEATUREFGFEATUREREQUESTSEQUENCEFEATURESSUBFEATURES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures& obj) { 
    ...
    UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures() = default ;
    UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures(const UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures &) = default ;
    UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures(UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures &&) = default ;
    UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures() = default ;
    UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures& operator=(const UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures &) = default ;
    UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures& operator=(UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures &&) = default ;
    ...
    inline UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures& setFeatureDomain(string featureDomain) { DARABONBA_PTR_SET_VALUE(featureDomain_, featureDomain) };
    ...
    inline UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures& setFeatureName(string featureName) { DARABONBA_PTR_SET_VALUE(featureName_, featureName) };
    ...
    inline UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures& setFeatureType(string featureType) { DARABONBA_PTR_SET_VALUE(featureType_, featureType) };
    ...
    inline UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures& setInputFeatureName(string inputFeatureName) { DARABONBA_PTR_SET_VALUE(inputFeatureName_, inputFeatureName) };
    ...
    inline UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures& setValueType(string valueType) { DARABONBA_PTR_SET_VALUE(valueType_, valueType) };
