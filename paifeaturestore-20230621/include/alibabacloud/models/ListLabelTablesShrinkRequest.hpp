...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->labelTableIdsShrink_ != nullptr
    ...
    inline string labelTableIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(labelTableIdsShrink_, "") };
  ...
  protected:
    std::shared_ptr<string> labelTableIdsShrink_ = nullptr;
