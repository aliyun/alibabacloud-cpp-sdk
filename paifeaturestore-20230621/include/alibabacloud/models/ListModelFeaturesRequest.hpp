...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->modelFeatureIds_ != nullptr
    ...
    inline const vector<string> & modelFeatureIds() const { DARABONBA_PTR_GET_CONST(modelFeatureIds_, vector<string>) };
    inline vector<string> modelFeatureIds() { DARABONBA_PTR_GET(modelFeatureIds_, vector<string>) };
  ...
  protected:
    std::shared_ptr<vector<string>> modelFeatureIds_ = nullptr;
