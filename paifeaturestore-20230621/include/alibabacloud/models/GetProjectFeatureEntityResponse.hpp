...
namespace Models
{
  ...
  public:
    ...
    inline const GetProjectFeatureEntityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetProjectFeatureEntityResponseBody) };
    inline GetProjectFeatureEntityResponseBody getBody() { DARABONBA_PTR_GET(body_, GetProjectFeatureEntityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetProjectFeatureEntityResponseBody> body_ {};
  };
