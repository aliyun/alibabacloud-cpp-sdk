...
namespace Models
{
  ...
  public:
    ...
    inline const ListFeatureViewsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFeatureViewsResponseBody) };
    inline ListFeatureViewsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFeatureViewsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFeatureViewsResponseBody> body_ {};
  };
