...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstancesResponseBody) };
    inline ListInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstancesResponseBody> body_ {};
  };
