...
namespace Models
{
  ...
  public:
    ...
    inline const ListTaskLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTaskLogsResponseBody) };
    inline ListTaskLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTaskLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTaskLogsResponseBody> body_ {};
  };
