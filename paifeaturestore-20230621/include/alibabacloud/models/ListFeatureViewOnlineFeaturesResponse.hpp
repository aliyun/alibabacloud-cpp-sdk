...
namespace Models
{
  ...
  public:
    ...
    inline const ListFeatureViewOnlineFeaturesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFeatureViewOnlineFeaturesResponseBody) };
    inline ListFeatureViewOnlineFeaturesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFeatureViewOnlineFeaturesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFeatureViewOnlineFeaturesResponseBody> body_ {};
  };
