...
#ifndef ALIBABACLOUD_MODELS_UPDATEMODELFEATUREFGFEATUREREQUESTRAWFEATURES_HPP_
#define ALIBABACLOUD_MODELS_UPDATEMODELFEATUREFGFEATUREREQUESTRAWFEATURES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateModelFeatureFGFeatureRequestRawFeatures& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateModelFeatureFGFeatureRequestRawFeatures& obj) { 
    ...
    UpdateModelFeatureFGFeatureRequestRawFeatures() = default ;
    UpdateModelFeatureFGFeatureRequestRawFeatures(const UpdateModelFeatureFGFeatureRequestRawFeatures &) = default ;
    UpdateModelFeatureFGFeatureRequestRawFeatures(UpdateModelFeatureFGFeatureRequestRawFeatures &&) = default ;
    UpdateModelFeatureFGFeatureRequestRawFeatures(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateModelFeatureFGFeatureRequestRawFeatures() = default ;
    UpdateModelFeatureFGFeatureRequestRawFeatures& operator=(const UpdateModelFeatureFGFeatureRequestRawFeatures &) = default ;
    UpdateModelFeatureFGFeatureRequestRawFeatures& operator=(UpdateModelFeatureFGFeatureRequestRawFeatures &&) = default ;
    ...
    inline UpdateModelFeatureFGFeatureRequestRawFeatures& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline UpdateModelFeatureFGFeatureRequestRawFeatures& setFeatureDomain(string featureDomain) { DARABONBA_PTR_SET_VALUE(featureDomain_, featureDomain) };
    ...
    inline UpdateModelFeatureFGFeatureRequestRawFeatures& setFeatureName(string featureName) { DARABONBA_PTR_SET_VALUE(featureName_, featureName) };
    ...
    inline UpdateModelFeatureFGFeatureRequestRawFeatures& setFeatureType(string featureType) { DARABONBA_PTR_SET_VALUE(featureType_, featureType) };
    ...
    inline UpdateModelFeatureFGFeatureRequestRawFeatures& setInputFeatureName(string inputFeatureName) { DARABONBA_PTR_SET_VALUE(inputFeatureName_, inputFeatureName) };
    ...
    inline UpdateModelFeatureFGFeatureRequestRawFeatures& setValueType(string valueType) { DARABONBA_PTR_SET_VALUE(valueType_, valueType) };
