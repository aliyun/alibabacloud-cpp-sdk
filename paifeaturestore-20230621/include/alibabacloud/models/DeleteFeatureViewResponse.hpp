...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteFeatureViewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteFeatureViewResponseBody) };
    inline DeleteFeatureViewResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteFeatureViewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteFeatureViewResponseBody> body_ {};
  };
