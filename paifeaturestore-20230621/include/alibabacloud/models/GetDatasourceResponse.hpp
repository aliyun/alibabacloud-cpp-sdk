...
namespace Models
{
  ...
  public:
    ...
    inline const GetDatasourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDatasourceResponseBody) };
    inline GetDatasourceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDatasourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDatasourceResponseBody> body_ {};
  };
