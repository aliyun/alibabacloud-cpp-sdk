...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->features_ == nullptr
        && return this->labelPriorityLevel_ == nullptr && return this->labelTableId_ == nullptr && return this->name_ == nullptr && return this->projectId_ == nullptr && return this->sequenceFeatureViewIds_ == nullptr; };
