...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatasourceTablesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDatasourceTablesResponseBody) };
    inline ListDatasourceTablesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDatasourceTablesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDatasourceTablesResponseBody> body_ {};
  };
