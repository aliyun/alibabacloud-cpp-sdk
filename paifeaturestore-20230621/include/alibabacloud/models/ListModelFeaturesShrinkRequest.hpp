...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->modelFeatureIdsShrink_ == nullptr
    ...
    inline string getModelFeatureIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(modelFeatureIdsShrink_, "") };
