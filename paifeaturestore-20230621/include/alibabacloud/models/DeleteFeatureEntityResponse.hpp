...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteFeatureEntityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteFeatureEntityResponseBody) };
    inline DeleteFeatureEntityResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteFeatureEntityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteFeatureEntityResponseBody> body_ {};
  };
