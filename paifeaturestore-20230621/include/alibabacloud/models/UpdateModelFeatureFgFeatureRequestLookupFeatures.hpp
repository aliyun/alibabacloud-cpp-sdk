...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->defaultValue_ == nullptr
        && return this->featureName_ == nullptr && return this->keyFeatureDomain_ == nullptr && return this->keyFeatureName_ == nullptr && return this->mapFeatureDomain_ == nullptr && return this->mapFeatureName_ == nullptr
