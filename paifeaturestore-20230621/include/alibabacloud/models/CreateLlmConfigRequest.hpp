...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->apiKey_ == nullptr
        && return this->baseUrl_ == nullptr && return this->batchSize_ == nullptr && return this->maxTokens_ == nullptr && return this->model_ == nullptr && return this->name_ == nullptr
        && return this->rps_ == nullptr && return this->workspaceId_ == nullptr; };
