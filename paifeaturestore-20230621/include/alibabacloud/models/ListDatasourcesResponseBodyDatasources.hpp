...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->config_ == nullptr
        && return this->datasourceId_ == nullptr && return this->gmtCreateTime_ == nullptr && return this->gmtModifiedTime_ == nullptr && return this->name_ == nullptr && return this->type_ == nullptr
        && return this->uri_ == nullptr && return this->workspaceId_ == nullptr; };
    // config Field Functions 
    bool hasConfig() const { return this->config_ != nullptr;};
    void deleteConfig() { this->config_ = nullptr;};
    inline string config() const { DARABONBA_PTR_GET_DEFAULT(config_, "") };
    inline ListDatasourcesResponseBodyDatasources& setConfig(string config) { DARABONBA_PTR_SET_VALUE(config_, config) };
    ...
    inline ListDatasourcesResponseBodyDatasources& setGmtCreateTime(string gmtCreateTime) { DARABONBA_PTR_SET_VALUE(gmtCreateTime_, gmtCreateTime) };
    ...
    inline ListDatasourcesResponseBodyDatasources& setGmtModifiedTime(string gmtModifiedTime) { DARABONBA_PTR_SET_VALUE(gmtModifiedTime_, gmtModifiedTime) };
    ...
    inline ListDatasourcesResponseBodyDatasources& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListDatasourcesResponseBodyDatasources& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline ListDatasourcesResponseBodyDatasources& setUri(string uri) { DARABONBA_PTR_SET_VALUE(uri_, uri) };
    ...
    inline ListDatasourcesResponseBodyDatasources& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
