  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->apiKey_ == nullptr
        ...
        && this->name_ == nullptr && this->resourceGroupId_ == nullptr && this->rps_ == nullptr && this->workspaceId_ == nullptr; };
      ...
      inline LLMConfigs& setEnableFusion(bool enableFusion) { DARABONBA_PTR_SET_VALUE(enableFusion_, enableFusion) };
      ...
      inline LLMConfigs& setModelType(string modelType) { DARABONBA_PTR_SET_VALUE(modelType_, modelType) };
