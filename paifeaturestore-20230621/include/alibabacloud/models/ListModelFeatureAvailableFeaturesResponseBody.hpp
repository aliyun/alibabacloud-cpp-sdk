...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->avaliableFeatures_ != nullptr
    ...
    inline const vector<ListModelFeatureAvailableFeaturesResponseBodyAvaliableFeatures> & avaliableFeatures() const { DARABONBA_PTR_GET_CONST(avaliableFeatures_, vector<ListModelFeatureAvailableFeaturesResponseBodyAvaliableFeatures>) };
    inline vector<ListModelFeatureAvailableFeaturesResponseBodyAvaliableFeatures> avaliableFeatures() { DARABONBA_PTR_GET(avaliableFeatures_, vector<ListModelFeatureAvailableFeaturesResponseBodyAvaliableFeatures>) };
    inline ListModelFeatureAvailableFeaturesResponseBody& setAvaliableFeatures(const vector<ListModelFeatureAvailableFeaturesResponseBodyAvaliableFeatures> & avaliableFeatures) { DARABONBA_PTR_SET_VALUE(avaliableFeatures_, avaliableFeatures) };
    inline ListModelFeatureAvailableFeaturesResponseBody& setAvaliableFeatures(vector<ListModelFeatureAvailableFeaturesResponseBodyAvaliableFeatures> && avaliableFeatures) { DARABONBA_PTR_SET_RVALUE(avaliableFeatures_, avaliableFeatures) };
  ...
  protected:
    std::shared_ptr<vector<ListModelFeatureAvailableFeaturesResponseBodyAvaliableFeatures>> avaliableFeatures_ = nullptr;
