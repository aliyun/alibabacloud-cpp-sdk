...
namespace Models
{
  ...
  public:
    ...
    inline const ListFeatureEntitiesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFeatureEntitiesResponseBody) };
    inline ListFeatureEntitiesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFeatureEntitiesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFeatureEntitiesResponseBody> body_ {};
  };
