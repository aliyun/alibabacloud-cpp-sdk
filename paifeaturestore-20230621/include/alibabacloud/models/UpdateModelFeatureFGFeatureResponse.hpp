...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateModelFeatureFGFeatureResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateModelFeatureFGFeatureResponseBody) };
    inline UpdateModelFeatureFGFeatureResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateModelFeatureFGFeatureResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateModelFeatureFGFeatureResponseBody> body_ {};
  };
