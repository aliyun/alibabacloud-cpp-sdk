...
#ifndef ALIBABACLOUD_MODELS_LISTLABELTABLESREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTLABELTABLESREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListLabelTablesRequest& obj) { 
      DARABONBA_PTR_TO_JSON(LabelTableIds, labelTableIds_);
    ...
    friend void from_json(const Darabonba::Json& j, ListLabelTablesRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(LabelTableIds, labelTableIds_);
    ...
    ListLabelTablesRequest() = default ;
    ListLabelTablesRequest(const ListLabelTablesRequest &) = default ;
    ListLabelTablesRequest(ListLabelTablesRequest &&) = default ;
    ListLabelTablesRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListLabelTablesRequest() = default ;
    ListLabelTablesRequest& operator=(const ListLabelTablesRequest &) = default ;
    ListLabelTablesRequest& operator=(ListLabelTablesRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->labelTableIds_ != nullptr
