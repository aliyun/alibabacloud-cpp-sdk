...
namespace Models
{
  ...
  public:
    ...
    inline const CheckModelFeatureFGFeatureResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckModelFeatureFGFeatureResponseBody) };
    inline CheckModelFeatureFGFeatureResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckModelFeatureFGFeatureResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckModelFeatureFGFeatureResponseBody> body_ {};
  };
