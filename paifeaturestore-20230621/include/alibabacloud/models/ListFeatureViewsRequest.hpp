...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & featureViewIds() const { DARABONBA_PTR_GET_CONST(featureViewIds_, vector<string>) };
    inline vector<string> featureViewIds() { DARABONBA_PTR_GET(featureViewIds_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> featureViewIds_ = nullptr;
