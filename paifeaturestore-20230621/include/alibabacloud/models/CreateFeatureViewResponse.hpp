...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFeatureViewResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateFeatureViewResponseBody) };
    inline CreateFeatureViewResponseBody body() { DARABONBA_PTR_GET(body_, CreateFeatureViewResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateFeatureViewResponseBody> body_ = nullptr;
  };
