...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLLMConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLLMConfigResponseBody) };
    inline DeleteLLMConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLLMConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLLMConfigResponseBody> body_ {};
  };
