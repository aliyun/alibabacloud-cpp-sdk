...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->config_ == nullptr
        && this->eventTime_ == nullptr && this->mode_ == nullptr && this->offlineToOnline_ == nullptr && this->partitions_ == nullptr; };
    ...
    inline bool getOfflineToOnline() const { DARABONBA_PTR_GET_DEFAULT(offlineToOnline_, false) };
