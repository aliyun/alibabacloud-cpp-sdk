...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLLMConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLLMConfigResponseBody) };
    inline UpdateLLMConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLLMConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLLMConfigResponseBody> body_ {};
  };
