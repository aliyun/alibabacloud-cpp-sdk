...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLabelTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLabelTableResponseBody) };
    inline CreateLabelTableResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLabelTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLabelTableResponseBody> body_ {};
  };
