...
namespace Models
{
  ...
  public:
    ...
    inline const GetOssCheckResultDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetOssCheckResultDetailResponseBodyData) };
    inline GetOssCheckResultDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetOssCheckResultDetailResponseBodyData) };
    inline GetOssCheckResultDetailResponseBody& setData(const GetOssCheckResultDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetOssCheckResultDetailResponseBody& setData(GetOssCheckResultDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Detailed data.
    std::shared_ptr<GetOssCheckResultDetailResponseBodyData> data_ = nullptr;
