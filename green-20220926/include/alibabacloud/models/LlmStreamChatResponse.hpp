...
namespace Models
{
  ...
  public:
    ...
    inline const LlmStreamChatResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, LlmStreamChatResponseBody) };
    inline LlmStreamChatResponseBody body() { DARABONBA_PTR_GET(body_, LlmStreamChatResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<LlmStreamChatResponseBody> body_ = nullptr;
  };
