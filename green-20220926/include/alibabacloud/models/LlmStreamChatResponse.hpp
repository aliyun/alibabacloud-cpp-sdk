...
namespace Models
{
  ...
  public:
    ...
    inline LlmStreamChatResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline LlmStreamChatResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };
