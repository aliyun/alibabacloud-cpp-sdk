...
#ifndef ALIBABACLOUD_MODELS_ADDKEYWORDLIBRESPONSEBODYDATAKEYWORDSRESULT_HPP_
#define ALIBABACLOUD_MODELS_ADDKEYWORDLIBRESPONSEBODYDATAKEYWORDSRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddKeywordLibResponseBodyDataKeywordsResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddKeywordLibResponseBodyDataKeywordsResult& obj) { 
    ...
    AddKeywordLibResponseBodyDataKeywordsResult() = default ;
    AddKeywordLibResponseBodyDataKeywordsResult(const AddKeywordLibResponseBodyDataKeywordsResult &) = default ;
    AddKeywordLibResponseBodyDataKeywordsResult(AddKeywordLibResponseBodyDataKeywordsResult &&) = default ;
    AddKeywordLibResponseBodyDataKeywordsResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddKeywordLibResponseBodyDataKeywordsResult() = default ;
    AddKeywordLibResponseBodyDataKeywordsResult& operator=(const AddKeywordLibResponseBodyDataKeywordsResult &) = default ;
    AddKeywordLibResponseBodyDataKeywordsResult& operator=(AddKeywordLibResponseBodyDataKeywordsResult &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->i18nKey_ == nullptr
        && return this->illegalLengthKeywords_ == nullptr && return this->invalidCount_ == nullptr && return this->invalidKeywords_ == nullptr && return this->libId_ == nullptr && return this->repeatCount_ == nullptr
        && return this->repeatKeywords_ == nullptr && return this->successCount_ == nullptr && return this->tips_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline AddKeywordLibResponseBodyDataKeywordsResult& setI18nKey(string i18nKey) { DARABONBA_PTR_SET_VALUE(i18nKey_, i18nKey) };
    ...
    inline AddKeywordLibResponseBodyDataKeywordsResult& setIllegalLengthKeywords(const vector<string> & illegalLengthKeywords) { DARABONBA_PTR_SET_VALUE(illegalLengthKeywords_, illegalLengthKeywords) };
    inline AddKeywordLibResponseBodyDataKeywordsResult& setIllegalLengthKeywords(vector<string> && illegalLengthKeywords) { DARABONBA_PTR_SET_RVALUE(illegalLengthKeywords_, illegalLengthKeywords) };
    ...
    inline AddKeywordLibResponseBodyDataKeywordsResult& setInvalidCount(int32_t invalidCount) { DARABONBA_PTR_SET_VALUE(invalidCount_, invalidCount) };
    ...
    inline AddKeywordLibResponseBodyDataKeywordsResult& setInvalidKeywords(const vector<string> & invalidKeywords) { DARABONBA_PTR_SET_VALUE(invalidKeywords_, invalidKeywords) };
    inline AddKeywordLibResponseBodyDataKeywordsResult& setInvalidKeywords(vector<string> && invalidKeywords) { DARABONBA_PTR_SET_RVALUE(invalidKeywords_, invalidKeywords) };
    ...
    inline AddKeywordLibResponseBodyDataKeywordsResult& setLibId(string libId) { DARABONBA_PTR_SET_VALUE(libId_, libId) };
    ...
    inline AddKeywordLibResponseBodyDataKeywordsResult& setRepeatCount(int32_t repeatCount) { DARABONBA_PTR_SET_VALUE(repeatCount_, repeatCount) };
    ...
    inline AddKeywordLibResponseBodyDataKeywordsResult& setRepeatKeywords(const vector<string> & repeatKeywords) { DARABONBA_PTR_SET_VALUE(repeatKeywords_, repeatKeywords) };
    inline AddKeywordLibResponseBodyDataKeywordsResult& setRepeatKeywords(vector<string> && repeatKeywords) { DARABONBA_PTR_SET_RVALUE(repeatKeywords_, repeatKeywords) };
    ...
    inline AddKeywordLibResponseBodyDataKeywordsResult& setSuccessCount(int32_t successCount) { DARABONBA_PTR_SET_VALUE(successCount_, successCount) };
    ...
    inline AddKeywordLibResponseBodyDataKeywordsResult& setTips(string tips) { DARABONBA_PTR_SET_VALUE(tips_, tips) };
    ...
    inline AddKeywordLibResponseBodyDataKeywordsResult& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
