...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListServiceConfigsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListServiceConfigsResponseBodyData>) };
    inline vector<ListServiceConfigsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListServiceConfigsResponseBodyData>) };
    inline ListServiceConfigsResponseBody& setData(const vector<ListServiceConfigsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListServiceConfigsResponseBody& setData(vector<ListServiceConfigsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Returned data.
    std::shared_ptr<vector<ListServiceConfigsResponseBodyData>> data_ = nullptr;
