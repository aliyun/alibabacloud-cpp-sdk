...
namespace Models
{
  ...
  public:
    ...
    inline const GetScanResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetScanResultResponseBodyData) };
    inline GetScanResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetScanResultResponseBodyData) };
    inline GetScanResultResponseBody& setData(const GetScanResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetScanResultResponseBody& setData(GetScanResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Returned data.
    std::shared_ptr<GetScanResultResponseBodyData> data_ = nullptr;
    // HTTP status code
