...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->byDefault_ == nullptr
        && this->regionId_ == nullptr && this->resourceType_ == nullptr && this->scene_ == nullptr && this->serviceCode_ == nullptr; };
    ...
    inline bool getByDefault() const { DARABONBA_PTR_GET_DEFAULT(byDefault_, false) };
