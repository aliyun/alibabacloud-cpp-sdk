...
namespace Models
{
  ...
  public:
    ...
    inline const ListImagesFromLibResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListImagesFromLibResponseBody) };
    inline ListImagesFromLibResponseBody getBody() { DARABONBA_PTR_GET(body_, ListImagesFromLibResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListImagesFromLibResponseBody> body_ {};
  };
