...
namespace Models
{
  ...
  public:
    ...
    inline const GetOssCheckFreezeResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOssCheckFreezeResultResponseBody) };
    inline GetOssCheckFreezeResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOssCheckFreezeResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOssCheckFreezeResultResponseBody> body_ {};
  };
