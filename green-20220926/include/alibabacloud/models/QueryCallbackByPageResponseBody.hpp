...
#include <vector>
#include <alibabacloud/models/QueryCallbackByPageResponseBodyItems.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryCallbackByPageResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<QueryCallbackByPageResponseBodyItems>) };
    inline vector<QueryCallbackByPageResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<QueryCallbackByPageResponseBodyItems>) };
    inline QueryCallbackByPageResponseBody& setItems(const vector<QueryCallbackByPageResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline QueryCallbackByPageResponseBody& setItems(vector<QueryCallbackByPageResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryCallbackByPageResponseBodyItems>> items_ = nullptr;
    // Page size.
