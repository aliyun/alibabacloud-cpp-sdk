...
namespace Models
{
  ...
  public:
    ...
    inline const map<string, int32_t> & getConfig() const { DARABONBA_PTR_GET_CONST(config_, map<string, int32_t>) };
    inline map<string, int32_t> getConfig() { DARABONBA_PTR_GET(config_, map<string, int32_t>) };
