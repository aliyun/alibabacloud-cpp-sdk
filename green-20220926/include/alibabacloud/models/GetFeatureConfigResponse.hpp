...
namespace Models
{
  ...
  public:
    ...
    inline const GetFeatureConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetFeatureConfigResponseBody) };
    inline GetFeatureConfigResponseBody body() { DARABONBA_PTR_GET(body_, GetFeatureConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetFeatureConfigResponseBody> body_ = nullptr;
  };
