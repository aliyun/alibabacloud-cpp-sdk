...
namespace Models
{
  ...
  public:
    ...
    inline const AddKeywordsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddKeywordsResponseBody) };
    inline AddKeywordsResponseBody body() { DARABONBA_PTR_GET(body_, AddKeywordsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddKeywordsResponseBody> body_ = nullptr;
  };
