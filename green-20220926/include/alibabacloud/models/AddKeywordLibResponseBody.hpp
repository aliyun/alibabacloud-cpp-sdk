  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->illegalLengthKeywords_ == nullptr && this->invalidCount_ == nullptr && this->invalidKeywords_ == nullptr && this->libId_ == nullptr && this->repeatCount_ == nullptr
        && this->repeatKeywords_ == nullptr && this->successCount_ == nullptr && this->tips_ == nullptr && this->totalCount_ == nullptr; };
    ...
    inline const AddKeywordLibResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, AddKeywordLibResponseBody::Data) };
    inline AddKeywordLibResponseBody::Data getData() { DARABONBA_PTR_GET(data_, AddKeywordLibResponseBody::Data) };
    inline AddKeywordLibResponseBody& setData(const AddKeywordLibResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddKeywordLibResponseBody& setData(AddKeywordLibResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
