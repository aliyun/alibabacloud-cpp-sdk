...
namespace Models
{
  ...
  public:
    ...
    inline const ListImageLibResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListImageLibResponseBody) };
    inline ListImageLibResponseBody getBody() { DARABONBA_PTR_GET(body_, ListImageLibResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListImageLibResponseBody> body_ {};
  };
