...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAnswerSampleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAnswerSampleResponseBody) };
    inline DeleteAnswerSampleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAnswerSampleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAnswerSampleResponseBody> body_ {};
  };
