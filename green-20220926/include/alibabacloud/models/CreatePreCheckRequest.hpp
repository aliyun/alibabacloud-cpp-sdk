...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->buckets_ == nullptr
        && this->distinctHistoryTasks_ == nullptr && this->endTime_ == nullptr && this->isInc_ == nullptr && this->mediaType_ == nullptr && this->prefixFilterType_ == nullptr
        && this->prefixFilters_ == nullptr && this->priority_ == nullptr && this->regionId_ == nullptr && this->scanLimit_ == nullptr && this->scanNoFileType_ == nullptr
        && this->scanService_ == nullptr && this->startTime_ == nullptr && this->taskName_ == nullptr; };
