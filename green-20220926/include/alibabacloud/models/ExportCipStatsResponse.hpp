...
namespace Models
{
  ...
  public:
    ...
    inline const ExportCipStatsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExportCipStatsResponseBody) };
    inline ExportCipStatsResponseBody getBody() { DARABONBA_PTR_GET(body_, ExportCipStatsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExportCipStatsResponseBody> body_ {};
  };
