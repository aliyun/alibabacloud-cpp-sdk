...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->i18nKey_ == nullptr
        ...
        && return this->repeatSamples_ == nullptr && return this->requestId_ == nullptr && return this->successCount_ == nullptr && return this->taskId_ == nullptr && return this->tips_ == nullptr
