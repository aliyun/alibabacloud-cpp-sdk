...
namespace Models
{
  ...
  public:
    ...
    inline const OssCheckResultListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OssCheckResultListResponseBody) };
    inline OssCheckResultListResponseBody getBody() { DARABONBA_PTR_GET(body_, OssCheckResultListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OssCheckResultListResponseBody> body_ {};
  };
