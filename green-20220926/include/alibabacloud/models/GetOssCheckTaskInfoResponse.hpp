...
namespace Models
{
  ...
  public:
    ...
    inline const GetOssCheckTaskInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOssCheckTaskInfoResponseBody) };
    inline GetOssCheckTaskInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOssCheckTaskInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOssCheckTaskInfoResponseBody> body_ {};
  };
