...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateOssCheckResultsFeedBackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateOssCheckResultsFeedBackResponseBody) };
    inline UpdateOssCheckResultsFeedBackResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateOssCheckResultsFeedBackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateOssCheckResultsFeedBackResponseBody> body_ {};
  };
