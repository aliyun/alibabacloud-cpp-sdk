...
namespace Models
{
  ...
  public:
    ...
    inline string getFileConfig() const { DARABONBA_PTR_GET_DEFAULT(fileConfig_, "") };
    ...
    inline string getKeywordFilterLibs() const { DARABONBA_PTR_GET_DEFAULT(keywordFilterLibs_, "") };
    ...
    inline string getKeywordHitLibs() const { DARABONBA_PTR_GET_DEFAULT(keywordHitLibs_, "") };
    ...
    inline string getManualMachineConfig() const { DARABONBA_PTR_GET_DEFAULT(manualMachineConfig_, "") };
    ...
    inline string getSceneConfig() const { DARABONBA_PTR_GET_DEFAULT(sceneConfig_, "") };
    ...
    inline string getVideoConfig() const { DARABONBA_PTR_GET_DEFAULT(videoConfig_, "") };
