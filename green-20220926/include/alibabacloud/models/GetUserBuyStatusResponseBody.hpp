...
#include <alibabacloud/models/GetUserBuyStatusResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserBuyStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetUserBuyStatusResponseBodyData) };
    inline GetUserBuyStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, GetUserBuyStatusResponseBodyData) };
    inline GetUserBuyStatusResponseBody& setData(const GetUserBuyStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetUserBuyStatusResponseBody& setData(GetUserBuyStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Returned data.
    std::shared_ptr<GetUserBuyStatusResponseBodyData> data_ = nullptr;
