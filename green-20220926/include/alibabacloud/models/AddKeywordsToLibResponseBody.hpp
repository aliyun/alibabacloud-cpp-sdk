...
namespace Models
{
  ...
  public:
    ...
    inline const AddKeywordsToLibResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddKeywordsToLibResponseBodyData) };
    inline AddKeywordsToLibResponseBodyData data() { DARABONBA_PTR_GET(data_, AddKeywordsToLibResponseBodyData) };
    inline AddKeywordsToLibResponseBody& setData(const AddKeywordsToLibResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddKeywordsToLibResponseBody& setData(AddKeywordsToLibResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<AddKeywordsToLibResponseBodyData> data_ = nullptr;
    // The request ID.
