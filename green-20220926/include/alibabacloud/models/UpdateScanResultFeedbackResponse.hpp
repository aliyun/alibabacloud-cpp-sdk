...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateScanResultFeedbackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateScanResultFeedbackResponseBody) };
    inline UpdateScanResultFeedbackResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateScanResultFeedbackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateScanResultFeedbackResponseBody> body_ {};
  };
