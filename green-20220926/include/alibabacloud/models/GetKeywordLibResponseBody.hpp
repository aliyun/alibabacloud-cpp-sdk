...
#include <alibabacloud/models/GetKeywordLibResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetKeywordLibResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetKeywordLibResponseBodyData) };
    inline GetKeywordLibResponseBodyData data() { DARABONBA_PTR_GET(data_, GetKeywordLibResponseBodyData) };
    inline GetKeywordLibResponseBody& setData(const GetKeywordLibResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetKeywordLibResponseBody& setData(GetKeywordLibResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetKeywordLibResponseBodyData> data_ = nullptr;
