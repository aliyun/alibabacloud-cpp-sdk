...
namespace Models
{
  ...
  public:
    ...
    inline const ExportAnswerSampleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExportAnswerSampleResponseBody) };
    inline ExportAnswerSampleResponseBody getBody() { DARABONBA_PTR_GET(body_, ExportAnswerSampleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExportAnswerSampleResponseBody> body_ {};
  };
