...
#include <vector>
#include <alibabacloud/models/GetBucketsListResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetBucketsListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetBucketsListResponseBodyData>) };
    inline vector<GetBucketsListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetBucketsListResponseBodyData>) };
    inline GetBucketsListResponseBody& setData(const vector<GetBucketsListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetBucketsListResponseBody& setData(vector<GetBucketsListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // Returned data.
    std::shared_ptr<vector<GetBucketsListResponseBodyData>> data_ = nullptr;
