...
#ifndef ALIBABACLOUD_MODELS_ADDKEYWORDSRESPONSEBODYDATAKEYWORDSRESULT_HPP_
#define ALIBABACLOUD_MODELS_ADDKEYWORDSRESPONSEBODYDATAKEYWORDSRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddKeywordsResponseBodyDataKeywordsResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddKeywordsResponseBodyDataKeywordsResult& obj) { 
    ...
    AddKeywordsResponseBodyDataKeywordsResult() = default ;
    AddKeywordsResponseBodyDataKeywordsResult(const AddKeywordsResponseBodyDataKeywordsResult &) = default ;
    AddKeywordsResponseBodyDataKeywordsResult(AddKeywordsResponseBodyDataKeywordsResult &&) = default ;
    AddKeywordsResponseBodyDataKeywordsResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddKeywordsResponseBodyDataKeywordsResult() = default ;
    AddKeywordsResponseBodyDataKeywordsResult& operator=(const AddKeywordsResponseBodyDataKeywordsResult &) = default ;
    AddKeywordsResponseBodyDataKeywordsResult& operator=(AddKeywordsResponseBodyDataKeywordsResult &&) = default ;
    ...
    inline AddKeywordsResponseBodyDataKeywordsResult& setI18nKey(string i18nKey) { DARABONBA_PTR_SET_VALUE(i18nKey_, i18nKey) };
    ...
    inline AddKeywordsResponseBodyDataKeywordsResult& setIllegalLengthKeywords(const vector<string> & illegalLengthKeywords) { DARABONBA_PTR_SET_VALUE(illegalLengthKeywords_, illegalLengthKeywords) };
    inline AddKeywordsResponseBodyDataKeywordsResult& setIllegalLengthKeywords(vector<string> && illegalLengthKeywords) { DARABONBA_PTR_SET_RVALUE(illegalLengthKeywords_, illegalLengthKeywords) };
    ...
    inline AddKeywordsResponseBodyDataKeywordsResult& setInvalidCount(int32_t invalidCount) { DARABONBA_PTR_SET_VALUE(invalidCount_, invalidCount) };
    ...
    inline AddKeywordsResponseBodyDataKeywordsResult& setInvalidKeywords(const vector<string> & invalidKeywords) { DARABONBA_PTR_SET_VALUE(invalidKeywords_, invalidKeywords) };
    inline AddKeywordsResponseBodyDataKeywordsResult& setInvalidKeywords(vector<string> && invalidKeywords) { DARABONBA_PTR_SET_RVALUE(invalidKeywords_, invalidKeywords) };
    ...
    inline AddKeywordsResponseBodyDataKeywordsResult& setLibId(string libId) { DARABONBA_PTR_SET_VALUE(libId_, libId) };
    ...
    inline AddKeywordsResponseBodyDataKeywordsResult& setProgress(int32_t progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
    ...
    inline AddKeywordsResponseBodyDataKeywordsResult& setRepeatCount(int32_t repeatCount) { DARABONBA_PTR_SET_VALUE(repeatCount_, repeatCount) };
    ...
    inline AddKeywordsResponseBodyDataKeywordsResult& setRepeatKeywords(const vector<string> & repeatKeywords) { DARABONBA_PTR_SET_VALUE(repeatKeywords_, repeatKeywords) };
    inline AddKeywordsResponseBodyDataKeywordsResult& setRepeatKeywords(vector<string> && repeatKeywords) { DARABONBA_PTR_SET_RVALUE(repeatKeywords_, repeatKeywords) };
    ...
    inline AddKeywordsResponseBodyDataKeywordsResult& setSuccessCount(int32_t successCount) { DARABONBA_PTR_SET_VALUE(successCount_, successCount) };
    ...
    inline AddKeywordsResponseBodyDataKeywordsResult& setTips(string tips) { DARABONBA_PTR_SET_VALUE(tips_, tips) };
    ...
    inline AddKeywordsResponseBodyDataKeywordsResult& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
