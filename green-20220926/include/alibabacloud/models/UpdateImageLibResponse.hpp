...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateImageLibResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateImageLibResponseBody) };
    inline UpdateImageLibResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateImageLibResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateImageLibResponseBody> body_ {};
  };
