...
namespace Models
{
  ...
  public:
    ...
    inline const GetServiceConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetServiceConfigResponseBody) };
    inline GetServiceConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetServiceConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetServiceConfigResponseBody> body_ {};
  };
