...
#include <vector>
#include <alibabacloud/models/GetOssCheckFreezeResultResponseBodyItems.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetOssCheckFreezeResultResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<GetOssCheckFreezeResultResponseBodyItems>) };
    inline vector<GetOssCheckFreezeResultResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<GetOssCheckFreezeResultResponseBodyItems>) };
    inline GetOssCheckFreezeResultResponseBody& setItems(const vector<GetOssCheckFreezeResultResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline GetOssCheckFreezeResultResponseBody& setItems(vector<GetOssCheckFreezeResultResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetOssCheckFreezeResultResponseBodyItems>> items_ = nullptr;
    // Page size.
