...
namespace Models
{
  ...
  public:
    ...
    inline const StopOnlineTestResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopOnlineTestResponseBody) };
    inline StopOnlineTestResponseBody getBody() { DARABONBA_PTR_GET(body_, StopOnlineTestResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopOnlineTestResponseBody> body_ {};
  };
