...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAnswerLibResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAnswerLibResponseBody) };
    inline CreateAnswerLibResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAnswerLibResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAnswerLibResponseBody> body_ {};
  };
