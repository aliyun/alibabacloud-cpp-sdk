...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListKeywordLibsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListKeywordLibsResponseBodyData>) };
    inline vector<ListKeywordLibsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListKeywordLibsResponseBodyData>) };
    inline ListKeywordLibsResponseBody& setData(const vector<ListKeywordLibsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListKeywordLibsResponseBody& setData(vector<ListKeywordLibsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Returned data.
    std::shared_ptr<vector<ListKeywordLibsResponseBodyData>> data_ = nullptr;
