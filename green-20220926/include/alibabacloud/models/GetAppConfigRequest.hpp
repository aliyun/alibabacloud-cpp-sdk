...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentId_ == nullptr
        && this->appId_ == nullptr && this->appVersion_ == nullptr && this->regionId_ == nullptr && this->resourceType_ == nullptr; };
    // agentId Field Functions 
    bool hasAgentId() const { return this->agentId_ != nullptr;};
    void deleteAgentId() { this->agentId_ = nullptr;};
    inline string getAgentId() const { DARABONBA_PTR_GET_DEFAULT(agentId_, "") };
    inline GetAppConfigRequest& setAgentId(string agentId) { DARABONBA_PTR_SET_VALUE(agentId_, agentId) };
    ...
    inline GetAppConfigRequest& setAppId(string appId) { DARABONBA_PTR_SET_VALUE(appId_, appId) };
    ...
    inline GetAppConfigRequest& setAppVersion(int64_t appVersion) { DARABONBA_PTR_SET_VALUE(appVersion_, appVersion) };
    ...
    inline GetAppConfigRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline GetAppConfigRequest& setResourceType(string resourceType) { DARABONBA_PTR_SET_VALUE(resourceType_, resourceType) };
