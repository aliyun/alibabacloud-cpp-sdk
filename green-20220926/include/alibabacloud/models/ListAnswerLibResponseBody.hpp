...
#include <vector>
#include <alibabacloud/models/ListAnswerLibResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAnswerLibResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAnswerLibResponseBodyData>) };
    inline vector<ListAnswerLibResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAnswerLibResponseBodyData>) };
    inline ListAnswerLibResponseBody& setData(const vector<ListAnswerLibResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAnswerLibResponseBody& setData(vector<ListAnswerLibResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<ListAnswerLibResponseBodyData>> data_ = nullptr;
