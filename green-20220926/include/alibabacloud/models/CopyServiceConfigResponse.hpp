...
namespace Models
{
  ...
  public:
    ...
    inline const CopyServiceConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CopyServiceConfigResponseBody) };
    inline CopyServiceConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, CopyServiceConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CopyServiceConfigResponseBody> body_ {};
  };
