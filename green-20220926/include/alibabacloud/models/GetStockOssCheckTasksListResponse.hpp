...
namespace Models
{
  ...
  public:
    ...
    inline const GetStockOssCheckTasksListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetStockOssCheckTasksListResponseBody) };
    inline GetStockOssCheckTasksListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetStockOssCheckTasksListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetStockOssCheckTasksListResponseBody> body_ {};
  };
