...
namespace Models
{
  ...
  public:
    ...
    inline const CancelStockOssCheckTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CancelStockOssCheckTaskResponseBody) };
    inline CancelStockOssCheckTaskResponseBody body() { DARABONBA_PTR_GET(body_, CancelStockOssCheckTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CancelStockOssCheckTaskResponseBody> body_ = nullptr;
  };
