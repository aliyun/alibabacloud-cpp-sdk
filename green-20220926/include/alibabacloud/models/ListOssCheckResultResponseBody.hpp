...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListOssCheckResultResponseBody::Items> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<ListOssCheckResultResponseBody::Items>) };
    inline vector<ListOssCheckResultResponseBody::Items> getItems() { DARABONBA_PTR_GET(items_, vector<ListOssCheckResultResponseBody::Items>) };
    inline ListOssCheckResultResponseBody& setItems(const vector<ListOssCheckResultResponseBody::Items> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline ListOssCheckResultResponseBody& setItems(vector<ListOssCheckResultResponseBody::Items> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
