...
#include <alibabacloud/models/GetTextScanResultResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetTextScanResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTextScanResultResponseBodyData) };
    inline GetTextScanResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTextScanResultResponseBodyData) };
    inline GetTextScanResultResponseBody& setData(const GetTextScanResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTextScanResultResponseBody& setData(GetTextScanResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Returned data.
    std::shared_ptr<GetTextScanResultResponseBodyData> data_ = nullptr;
