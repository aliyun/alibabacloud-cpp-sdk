...
namespace Models
{
  ...
  public:
    ...
    inline const AddAnswerSampleResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, AddAnswerSampleResponseBody::Result) };
    inline AddAnswerSampleResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, AddAnswerSampleResponseBody::Result) };
    inline AddAnswerSampleResponseBody& setResult(const AddAnswerSampleResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline AddAnswerSampleResponseBody& setResult(AddAnswerSampleResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
