...
namespace Models
{
  ...
  public:
    ...
    inline const ListKeywordLibsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListKeywordLibsResponseBody) };
    inline ListKeywordLibsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListKeywordLibsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListKeywordLibsResponseBody> body_ {};
  };
