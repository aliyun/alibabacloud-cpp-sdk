...
#ifndef ALIBABACLOUD_MODELS_ADDKEYWORDSTOLIBRESPONSEBODYDATAKEYWORDSRESULT_HPP_
#define ALIBABACLOUD_MODELS_ADDKEYWORDSTOLIBRESPONSEBODYDATAKEYWORDSRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddKeywordsToLibResponseBodyDataKeywordsResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddKeywordsToLibResponseBodyDataKeywordsResult& obj) { 
    ...
    AddKeywordsToLibResponseBodyDataKeywordsResult() = default ;
    AddKeywordsToLibResponseBodyDataKeywordsResult(const AddKeywordsToLibResponseBodyDataKeywordsResult &) = default ;
    AddKeywordsToLibResponseBodyDataKeywordsResult(AddKeywordsToLibResponseBodyDataKeywordsResult &&) = default ;
    AddKeywordsToLibResponseBodyDataKeywordsResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddKeywordsToLibResponseBodyDataKeywordsResult() = default ;
    AddKeywordsToLibResponseBodyDataKeywordsResult& operator=(const AddKeywordsToLibResponseBodyDataKeywordsResult &) = default ;
    AddKeywordsToLibResponseBodyDataKeywordsResult& operator=(AddKeywordsToLibResponseBodyDataKeywordsResult &&) = default ;
    ...
    virtual bool empty() const override { return this->i18nKey_ == nullptr
        ...
        && return this->repeatCount_ == nullptr && return this->repeatKeywords_ == nullptr && return this->successCount_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setI18nKey(string i18nKey) { DARABONBA_PTR_SET_VALUE(i18nKey_, i18nKey) };
    ...
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setIllegalLengthKeywords(const vector<string> & illegalLengthKeywords) { DARABONBA_PTR_SET_VALUE(illegalLengthKeywords_, illegalLengthKeywords) };
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setIllegalLengthKeywords(vector<string> && illegalLengthKeywords) { DARABONBA_PTR_SET_RVALUE(illegalLengthKeywords_, illegalLengthKeywords) };
    ...
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setInvalidCount(int32_t invalidCount) { DARABONBA_PTR_SET_VALUE(invalidCount_, invalidCount) };
    ...
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setInvalidKeywords(const vector<string> & invalidKeywords) { DARABONBA_PTR_SET_VALUE(invalidKeywords_, invalidKeywords) };
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setInvalidKeywords(vector<string> && invalidKeywords) { DARABONBA_PTR_SET_RVALUE(invalidKeywords_, invalidKeywords) };
    ...
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setLibId(string libId) { DARABONBA_PTR_SET_VALUE(libId_, libId) };
    ...
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setProgress(int32_t progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
    ...
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setRepeatCount(int32_t repeatCount) { DARABONBA_PTR_SET_VALUE(repeatCount_, repeatCount) };
    ...
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setRepeatKeywords(const vector<string> & repeatKeywords) { DARABONBA_PTR_SET_VALUE(repeatKeywords_, repeatKeywords) };
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setRepeatKeywords(vector<string> && repeatKeywords) { DARABONBA_PTR_SET_RVALUE(repeatKeywords_, repeatKeywords) };
    ...
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setSuccessCount(int32_t successCount) { DARABONBA_PTR_SET_VALUE(successCount_, successCount) };
    ...
    inline AddKeywordsToLibResponseBodyDataKeywordsResult& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
