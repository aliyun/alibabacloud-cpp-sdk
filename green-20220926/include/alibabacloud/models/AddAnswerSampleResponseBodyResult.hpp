...
#ifndef ALIBABACLOUD_MODELS_ADDANSWERSAMPLERESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_ADDANSWERSAMPLERESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddAnswerSampleResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddAnswerSampleResponseBodyResult& obj) { 
    ...
    AddAnswerSampleResponseBodyResult() = default ;
    AddAnswerSampleResponseBodyResult(const AddAnswerSampleResponseBodyResult &) = default ;
    AddAnswerSampleResponseBodyResult(AddAnswerSampleResponseBodyResult &&) = default ;
    AddAnswerSampleResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddAnswerSampleResponseBodyResult() = default ;
    AddAnswerSampleResponseBodyResult& operator=(const AddAnswerSampleResponseBodyResult &) = default ;
    AddAnswerSampleResponseBodyResult& operator=(AddAnswerSampleResponseBodyResult &&) = default ;
    ...
    inline AddAnswerSampleResponseBodyResult& setI18nKey(string i18nKey) { DARABONBA_PTR_SET_VALUE(i18nKey_, i18nKey) };
    ...
    inline AddAnswerSampleResponseBodyResult& setIllegalLengthSamples(const vector<string> & illegalLengthSamples) { DARABONBA_PTR_SET_VALUE(illegalLengthSamples_, illegalLengthSamples) };
    inline AddAnswerSampleResponseBodyResult& setIllegalLengthSamples(vector<string> && illegalLengthSamples) { DARABONBA_PTR_SET_RVALUE(illegalLengthSamples_, illegalLengthSamples) };
    ...
    inline AddAnswerSampleResponseBodyResult& setInvalidCount(int32_t invalidCount) { DARABONBA_PTR_SET_VALUE(invalidCount_, invalidCount) };
    ...
    inline AddAnswerSampleResponseBodyResult& setLibId(string libId) { DARABONBA_PTR_SET_VALUE(libId_, libId) };
    ...
    inline AddAnswerSampleResponseBodyResult& setProgress(int32_t progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
    ...
    inline AddAnswerSampleResponseBodyResult& setRepeatCount(int32_t repeatCount) { DARABONBA_PTR_SET_VALUE(repeatCount_, repeatCount) };
    ...
    inline AddAnswerSampleResponseBodyResult& setRepeatSamples(const vector<string> & repeatSamples) { DARABONBA_PTR_SET_VALUE(repeatSamples_, repeatSamples) };
    inline AddAnswerSampleResponseBodyResult& setRepeatSamples(vector<string> && repeatSamples) { DARABONBA_PTR_SET_RVALUE(repeatSamples_, repeatSamples) };
    ...
    inline AddAnswerSampleResponseBodyResult& setSuccessCount(int32_t successCount) { DARABONBA_PTR_SET_VALUE(successCount_, successCount) };
    ...
    inline AddAnswerSampleResponseBodyResult& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
    ...
    inline AddAnswerSampleResponseBodyResult& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
