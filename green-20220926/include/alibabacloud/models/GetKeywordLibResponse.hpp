...
namespace Models
{
  ...
  public:
    ...
    inline const GetKeywordLibResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetKeywordLibResponseBody) };
    inline GetKeywordLibResponseBody getBody() { DARABONBA_PTR_GET(body_, GetKeywordLibResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetKeywordLibResponseBody> body_ {};
  };
