...
namespace Models
{
  ...
  public:
    ...
    inline const AddImages2LibResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddImages2LibResponseBody) };
    inline AddImages2LibResponseBody getBody() { DARABONBA_PTR_GET(body_, AddImages2LibResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddImages2LibResponseBody> body_ {};
  };
