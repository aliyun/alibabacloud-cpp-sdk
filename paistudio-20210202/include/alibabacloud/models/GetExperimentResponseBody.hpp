...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessibility_ == nullptr
        && return this->content_ == nullptr && return this->creator_ == nullptr && return this->description_ == nullptr && return this->experimentId_ == nullptr && return this->gmtCreateTime_ == nullptr
        && return this->gmtModifiedTime_ == nullptr && return this->name_ == nullptr && return this->options_ == nullptr && return this->requestId_ == nullptr && return this->source_ == nullptr
        && return this->version_ == nullptr && return this->workspaceId_ == nullptr; };
    // accessibility Field Functions 
    bool hasAccessibility() const { return this->accessibility_ != nullptr;};
    void deleteAccessibility() { this->accessibility_ = nullptr;};
    inline string accessibility() const { DARABONBA_PTR_GET_DEFAULT(accessibility_, "") };
    inline GetExperimentResponseBody& setAccessibility(string accessibility) { DARABONBA_PTR_SET_VALUE(accessibility_, accessibility) };
    ...
    inline GetExperimentResponseBody& setContent(string content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    ...
    inline GetExperimentResponseBody& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
    ...
    inline GetExperimentResponseBody& setExperimentId(string experimentId) { DARABONBA_PTR_SET_VALUE(experimentId_, experimentId) };
    ...
    inline GetExperimentResponseBody& setOptions(string options) { DARABONBA_PTR_SET_VALUE(options_, options) };
    ...
    inline GetExperimentResponseBody& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline GetExperimentResponseBody& setVersion(int64_t version) { DARABONBA_PTR_SET_VALUE(version_, version) };
    ...
    inline GetExperimentResponseBody& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
