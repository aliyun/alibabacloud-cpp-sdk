...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterMode_ == nullptr
        && return this->clusterSizeResource_ == nullptr && return this->connectionString_ == nullptr && return this->createTime_ == nullptr && return this->elasticMinComputeResource_ == nullptr && return this->engine_ == nullptr
        && return this->engineParams_ == nullptr && return this->groupName_ == nullptr && return this->groupType_ == nullptr && return this->groupUserList_ == nullptr && return this->groupUsers_ == nullptr
        && return this->maxClusterCount_ == nullptr && return this->maxComputeResource_ == nullptr && return this->minClusterCount_ == nullptr && return this->minComputeResource_ == nullptr && return this->nodeNum_ == nullptr
        && return this->port_ == nullptr && return this->runningClusterCount_ == nullptr && return this->status_ == nullptr && return this->updateTime_ == nullptr; };
