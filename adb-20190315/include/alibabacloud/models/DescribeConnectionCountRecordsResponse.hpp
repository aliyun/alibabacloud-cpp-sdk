...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeConnectionCountRecordsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeConnectionCountRecordsResponseBody) };
    inline DescribeConnectionCountRecordsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeConnectionCountRecordsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeConnectionCountRecordsResponseBody> body_ {};
  };
