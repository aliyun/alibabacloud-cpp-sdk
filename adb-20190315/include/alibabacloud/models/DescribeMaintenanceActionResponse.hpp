...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMaintenanceActionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMaintenanceActionResponseBody) };
    inline DescribeMaintenanceActionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMaintenanceActionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMaintenanceActionResponseBody> body_ {};
  };
