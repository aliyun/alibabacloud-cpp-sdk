...
#ifndef ALIBABACLOUD_MODELS_MODIFYRESUBMITCONFIGREQUESTRULES_HPP_
#define ALIBABACLOUD_MODELS_MODIFYRESUBMITCONFIGREQUESTRULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyResubmitConfigRequestRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyResubmitConfigRequestRules& obj) { 
    ...
    ModifyResubmitConfigRequestRules() = default ;
    ModifyResubmitConfigRequestRules(const ModifyResubmitConfigRequestRules &) = default ;
    ModifyResubmitConfigRequestRules(ModifyResubmitConfigRequestRules &&) = default ;
    ModifyResubmitConfigRequestRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyResubmitConfigRequestRules() = default ;
    ModifyResubmitConfigRequestRules& operator=(const ModifyResubmitConfigRequestRules &) = default ;
    ModifyResubmitConfigRequestRules& operator=(ModifyResubmitConfigRequestRules &&) = default ;
    ...
    inline ModifyResubmitConfigRequestRules& setExceedMemoryException(bool exceedMemoryException) { DARABONBA_PTR_SET_VALUE(exceedMemoryException_, exceedMemoryException) };
    ...
    inline ModifyResubmitConfigRequestRules& setGroupName(string groupName) { DARABONBA_PTR_SET_VALUE(groupName_, groupName) };
    ...
    inline ModifyResubmitConfigRequestRules& setPeakMemory(string peakMemory) { DARABONBA_PTR_SET_VALUE(peakMemory_, peakMemory) };
    ...
    inline ModifyResubmitConfigRequestRules& setQueryTime(string queryTime) { DARABONBA_PTR_SET_VALUE(queryTime_, queryTime) };
    ...
    inline ModifyResubmitConfigRequestRules& setTargetGroupName(string targetGroupName) { DARABONBA_PTR_SET_VALUE(targetGroupName_, targetGroupName) };
