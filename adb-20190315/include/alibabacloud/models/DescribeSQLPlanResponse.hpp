...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSQLPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSQLPlanResponseBody) };
    inline DescribeSQLPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSQLPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSQLPlanResponseBody> body_ {};
  };
