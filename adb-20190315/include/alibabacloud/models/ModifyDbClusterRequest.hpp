...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->computeResource_ == nullptr
        && return this->DBClusterCategory_ == nullptr && return this->DBClusterId_ == nullptr && return this->DBNodeClass_ == nullptr && return this->DBNodeGroupCount_ == nullptr && return this->DBNodeStorage_ == nullptr
        && return this->diskPerformanceLevel_ == nullptr && return this->elasticIOResource_ == nullptr && return this->elasticIOResourceSize_ == nullptr && return this->executorCount_ == nullptr && return this->mode_ == nullptr
        && return this->modifyType_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
        && return this->resourceOwnerId_ == nullptr && return this->storageResource_ == nullptr; };
