...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adviceDate_ == nullptr
        && return this->adviceId_ == nullptr && return this->applyType_ == nullptr && return this->buildImmediately_ == nullptr && return this->DBClusterId_ == nullptr && return this->regionId_ == nullptr; };
