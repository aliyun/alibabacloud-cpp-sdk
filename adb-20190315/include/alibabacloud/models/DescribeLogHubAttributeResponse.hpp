...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLogHubAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLogHubAttributeResponseBody) };
    inline DescribeLogHubAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLogHubAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLogHubAttributeResponseBody> body_ {};
  };
