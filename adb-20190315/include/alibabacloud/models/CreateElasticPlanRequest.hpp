...
namespace Models
{
  ...
  public:
    ...
    inline bool getElasticPlanEnable() const { DARABONBA_PTR_GET_DEFAULT(elasticPlanEnable_, false) };
    ...
    inline string getElasticPlanEndDay() const { DARABONBA_PTR_GET_DEFAULT(elasticPlanEndDay_, "") };
    ...
    inline string getElasticPlanMonthlyRepeat() const { DARABONBA_PTR_GET_DEFAULT(elasticPlanMonthlyRepeat_, "") };
    ...
    inline int32_t getElasticPlanNodeNum() const { DARABONBA_PTR_GET_DEFAULT(elasticPlanNodeNum_, 0) };
    ...
    inline string getElasticPlanStartDay() const { DARABONBA_PTR_GET_DEFAULT(elasticPlanStartDay_, "") };
    ...
    inline string getElasticPlanTimeEnd() const { DARABONBA_PTR_GET_DEFAULT(elasticPlanTimeEnd_, "") };
    ...
    inline string getElasticPlanTimeStart() const { DARABONBA_PTR_GET_DEFAULT(elasticPlanTimeStart_, "") };
    ...
    inline string getElasticPlanWeeklyRepeat() const { DARABONBA_PTR_GET_DEFAULT(elasticPlanWeeklyRepeat_, "") };
  ...
  protected:
    ...
    shared_ptr<string> elasticPlanMonthlyRepeat_ {};
    ...
    shared_ptr<int32_t> elasticPlanNodeNum_ {};
    // The start date of the scaling plan. Specify the date in the yyyy-MM-dd format.
    shared_ptr<string> elasticPlanStartDay_ {};
    ...
    shared_ptr<string> elasticPlanWeeklyRepeat_ {};
