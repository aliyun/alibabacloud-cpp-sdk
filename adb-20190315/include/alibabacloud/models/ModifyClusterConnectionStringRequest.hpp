...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->connectionStringPrefix_ == nullptr
        && return this->currentConnectionString_ == nullptr && return this->DBClusterId_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->port_ == nullptr
