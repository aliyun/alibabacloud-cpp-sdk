...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getPoolUserList() const { DARABONBA_PTR_GET_CONST(poolUserList_, vector<string>) };
    inline vector<string> getPoolUserList() { DARABONBA_PTR_GET(poolUserList_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> poolUserList_ {};
