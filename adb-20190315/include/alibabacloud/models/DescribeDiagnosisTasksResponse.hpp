...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDiagnosisTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDiagnosisTasksResponseBody) };
    inline DescribeDiagnosisTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDiagnosisTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDiagnosisTasksResponseBody> body_ {};
  };
