...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAbnormalPatternDetectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAbnormalPatternDetectionResponseBody) };
    inline DescribeAbnormalPatternDetectionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAbnormalPatternDetectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAbnormalPatternDetectionResponseBody> body_ {};
  };
