...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTaskInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTaskInfoResponseBody) };
    inline DescribeTaskInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTaskInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTaskInfoResponseBody> body_ {};
  };
