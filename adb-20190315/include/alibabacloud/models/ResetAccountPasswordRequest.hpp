...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->accountName_ != nullptr
        && this->accountPassword_ != nullptr && this->accountType_ != nullptr && this->DBClusterId_ != nullptr && this->ownerAccount_ != nullptr && this->ownerId_ != nullptr
    ...
    inline ResetAccountPasswordRequest& setAccountType(string accountType) { DARABONBA_PTR_SET_VALUE(accountType_, accountType) };
