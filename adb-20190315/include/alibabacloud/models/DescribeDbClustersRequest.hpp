...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterDescription_ == nullptr
        && return this->DBClusterIds_ == nullptr && return this->DBClusterStatus_ == nullptr && return this->DBClusterVersion_ == nullptr && return this->DBVersion_ == nullptr && return this->ownerAccount_ == nullptr
