...
namespace Models
{
  ...
  public:
    ...
    inline ModifyElasticPlanRequest& setElasticPlanEnable(bool elasticPlanEnable) { DARABONBA_PTR_SET_VALUE(elasticPlanEnable_, elasticPlanEnable) };
    ...
    inline ModifyElasticPlanRequest& setElasticPlanEndDay(string elasticPlanEndDay) { DARABONBA_PTR_SET_VALUE(elasticPlanEndDay_, elasticPlanEndDay) };
    ...
    inline ModifyElasticPlanRequest& setElasticPlanMonthlyRepeat(string elasticPlanMonthlyRepeat) { DARABONBA_PTR_SET_VALUE(elasticPlanMonthlyRepeat_, elasticPlanMonthlyRepeat) };
    ...
    inline ModifyElasticPlanRequest& setElasticPlanNodeNum(int32_t elasticPlanNodeNum) { DARABONBA_PTR_SET_VALUE(elasticPlanNodeNum_, elasticPlanNodeNum) };
    ...
    inline ModifyElasticPlanRequest& setElasticPlanStartDay(string elasticPlanStartDay) { DARABONBA_PTR_SET_VALUE(elasticPlanStartDay_, elasticPlanStartDay) };
    ...
    inline ModifyElasticPlanRequest& setElasticPlanTimeEnd(string elasticPlanTimeEnd) { DARABONBA_PTR_SET_VALUE(elasticPlanTimeEnd_, elasticPlanTimeEnd) };
    ...
    inline ModifyElasticPlanRequest& setElasticPlanTimeStart(string elasticPlanTimeStart) { DARABONBA_PTR_SET_VALUE(elasticPlanTimeStart_, elasticPlanTimeStart) };
    ...
    inline ModifyElasticPlanRequest& setElasticPlanType(string elasticPlanType) { DARABONBA_PTR_SET_VALUE(elasticPlanType_, elasticPlanType) };
    ...
    inline ModifyElasticPlanRequest& setElasticPlanWeeklyRepeat(string elasticPlanWeeklyRepeat) { DARABONBA_PTR_SET_VALUE(elasticPlanWeeklyRepeat_, elasticPlanWeeklyRepeat) };
    ...
    inline ModifyElasticPlanRequest& setElasticPlanWorkerSpec(string elasticPlanWorkerSpec) { DARABONBA_PTR_SET_VALUE(elasticPlanWorkerSpec_, elasticPlanWorkerSpec) };
    ...
    inline ModifyElasticPlanRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline ModifyElasticPlanRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ModifyElasticPlanRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline ModifyElasticPlanRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline ModifyElasticPlanRequest& setResourcePoolName(string resourcePoolName) { DARABONBA_PTR_SET_VALUE(resourcePoolName_, resourcePoolName) };
