...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyDBResourceGroupRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(PoolUserList, poolUserList_);
    ...
    friend void from_json(const Darabonba::Json& j, ModifyDBResourceGroupRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(PoolUserList, poolUserList_);
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && return this->clusterMode_ == nullptr && return this->clusterSizeResource_ == nullptr && return this->DBClusterId_ == nullptr && return this->engineParams_ == nullptr && return this->groupName_ == nullptr
        && return this->groupType_ == nullptr && return this->maxClusterCount_ == nullptr && return this->maxComputeResource_ == nullptr && return this->minClusterCount_ == nullptr && return this->minComputeResource_ == nullptr
        && return this->nodeNum_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->poolUserList_ == nullptr && return this->resourceOwnerAccount_ == nullptr
        && return this->resourceOwnerId_ == nullptr; };
    // clientToken Field Functions 
    bool hasClientToken() const { return this->clientToken_ != nullptr;};
    void deleteClientToken() { this->clientToken_ = nullptr;};
    inline string clientToken() const { DARABONBA_PTR_GET_DEFAULT(clientToken_, "") };
    inline ModifyDBResourceGroupRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline ModifyDBResourceGroupRequest& setNodeNum(int32_t nodeNum) { DARABONBA_PTR_SET_VALUE(nodeNum_, nodeNum) };
    ...
    inline ModifyDBResourceGroupRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    // poolUserList Field Functions 
    bool hasPoolUserList() const { return this->poolUserList_ != nullptr;};
    void deletePoolUserList() { this->poolUserList_ = nullptr;};
    inline const vector<string> & poolUserList() const { DARABONBA_PTR_GET_CONST(poolUserList_, vector<string>) };
    inline vector<string> poolUserList() { DARABONBA_PTR_GET(poolUserList_, vector<string>) };
    inline ModifyDBResourceGroupRequest& setPoolUserList(const vector<string> & poolUserList) { DARABONBA_PTR_SET_VALUE(poolUserList_, poolUserList) };
    inline ModifyDBResourceGroupRequest& setPoolUserList(vector<string> && poolUserList) { DARABONBA_PTR_SET_RVALUE(poolUserList_, poolUserList) };
    ...
    inline ModifyDBResourceGroupRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline ModifyDBResourceGroupRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> poolUserList_ = nullptr;
