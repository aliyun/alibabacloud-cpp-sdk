...
namespace Models
{
  ...
  public:
    ...
    inline DescribeActiveOperationMaintainConfRequest& setIds(string ids) { DARABONBA_PTR_SET_VALUE(ids_, ids) };
    ...
    inline DescribeActiveOperationMaintainConfRequest& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
