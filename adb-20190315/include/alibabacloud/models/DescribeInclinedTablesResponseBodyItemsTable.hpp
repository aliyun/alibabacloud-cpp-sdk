...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->isIncline_ == nullptr
        && return this->name_ == nullptr && return this->rowCount_ == nullptr && return this->schema_ == nullptr && return this->size_ == nullptr && return this->spaceRatio_ == nullptr
        && return this->totalSize_ == nullptr && return this->type_ == nullptr; };
    ...
    inline string isIncline() const { DARABONBA_PTR_GET_DEFAULT(isIncline_, "") };
    inline DescribeInclinedTablesResponseBodyItemsTable& setIsIncline(string isIncline) { DARABONBA_PTR_SET_VALUE(isIncline_, isIncline) };
    ...
    inline DescribeInclinedTablesResponseBodyItemsTable& setSize(string size) { DARABONBA_PTR_SET_VALUE(size_, size) };
  ...
  protected:
    ...
    std::shared_ptr<string> isIncline_ = nullptr;
