  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->connId_ == nullptr
        && this->DBName_ == nullptr && this->executeTime_ == nullptr && this->executeTimestamp_ == nullptr && this->hostAddress_ == nullptr && this->processID_ == nullptr
        && this->SQLText_ == nullptr && this->SQLType_ == nullptr && this->succeed_ == nullptr && this->totalTime_ == nullptr && this->user_ == nullptr; };
