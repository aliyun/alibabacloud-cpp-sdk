...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->computeResource_ == nullptr
        && return this->DBClusterId_ == nullptr && return this->DBClusterVersion_ == nullptr && return this->operation_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
        && return this->productVersion_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr
        && return this->storageSize_ == nullptr && return this->subOperation_ == nullptr && return this->zoneId_ == nullptr; };
