  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline string getIsIncline() const { DARABONBA_PTR_GET_DEFAULT(isIncline_, "") };
        inline Table& setIsIncline(string isIncline) { DARABONBA_PTR_SET_VALUE(isIncline_, isIncline) };
        ...
        inline Table& setSize(string size) { DARABONBA_PTR_SET_VALUE(size_, size) };
    ...
    virtual bool empty() const override { return this->detectionItems_ == nullptr
