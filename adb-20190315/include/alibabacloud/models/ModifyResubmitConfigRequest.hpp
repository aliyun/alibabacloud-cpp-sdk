...
#ifndef ALIBABACLOUD_MODELS_MODIFYRESUBMITCONFIGREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyResubmitConfigRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyResubmitConfigRequest& obj) { 
    ...
    ModifyResubmitConfigRequest() = default ;
    ModifyResubmitConfigRequest(const ModifyResubmitConfigRequest &) = default ;
    ModifyResubmitConfigRequest(ModifyResubmitConfigRequest &&) = default ;
    ModifyResubmitConfigRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyResubmitConfigRequest() = default ;
    ModifyResubmitConfigRequest& operator=(const ModifyResubmitConfigRequest &) = default ;
    ModifyResubmitConfigRequest& operator=(ModifyResubmitConfigRequest &&) = default ;
