...
namespace Models
{
  ...
  public:
    ...
    inline string getElasticDailyPlanDay() const { DARABONBA_PTR_GET_DEFAULT(elasticDailyPlanDay_, "") };
    ...
    inline string getElasticDailyPlanStatusList() const { DARABONBA_PTR_GET_DEFAULT(elasticDailyPlanStatusList_, "") };
  ...
  protected:
    ...
    shared_ptr<string> elasticDailyPlanDay_ {};
    ...
    shared_ptr<string> elasticDailyPlanStatusList_ {};
