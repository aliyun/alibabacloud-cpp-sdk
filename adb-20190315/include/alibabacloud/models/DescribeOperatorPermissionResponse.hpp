...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOperatorPermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOperatorPermissionResponseBody) };
    inline DescribeOperatorPermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOperatorPermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOperatorPermissionResponseBody> body_ {};
  };
