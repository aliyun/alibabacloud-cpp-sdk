...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline LogHubStores& setFieldKey(string fieldKey) { DARABONBA_PTR_SET_VALUE(fieldKey_, fieldKey) };
      ...
      inline LogHubStores& setLogKey(string logKey) { DARABONBA_PTR_SET_VALUE(logKey_, logKey) };
    ...
    inline const vector<OperateLogHubRequest::LogHubStores> & getLogHubStores() const { DARABONBA_PTR_GET_CONST(logHubStores_, vector<OperateLogHubRequest::LogHubStores>) };
    inline vector<OperateLogHubRequest::LogHubStores> getLogHubStores() { DARABONBA_PTR_GET(logHubStores_, vector<OperateLogHubRequest::LogHubStores>) };
    inline OperateLogHubRequest& setLogHubStores(const vector<OperateLogHubRequest::LogHubStores> & logHubStores) { DARABONBA_PTR_SET_VALUE(logHubStores_, logHubStores) };
    inline OperateLogHubRequest& setLogHubStores(vector<OperateLogHubRequest::LogHubStores> && logHubStores) { DARABONBA_PTR_SET_RVALUE(logHubStores_, logHubStores) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<OperateLogHubRequest::LogHubStores>> logHubStores_ {};
