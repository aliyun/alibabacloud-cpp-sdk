...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        ...
        && this->resourceOwnerId_ == nullptr && this->resourcePools_ == nullptr && this->startTime_ == nullptr; };
    ...
    inline string getResourcePools() const { DARABONBA_PTR_GET_DEFAULT(resourcePools_, "") };
