...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBResourcePoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBResourcePoolResponseBody) };
    inline DescribeDBResourcePoolResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBResourcePoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBResourcePoolResponseBody> body_ {};
  };
