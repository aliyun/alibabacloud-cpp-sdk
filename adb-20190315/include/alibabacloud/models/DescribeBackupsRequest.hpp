...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backupId_ == nullptr
        && this->crossRole_ == nullptr && this->crossUid_ == nullptr && this->DBClusterId_ == nullptr && this->endTime_ == nullptr && this->ownerAccount_ == nullptr
    ...
    inline string getCrossRole() const { DARABONBA_PTR_GET_DEFAULT(crossRole_, "") };
    ...
    inline string getCrossUid() const { DARABONBA_PTR_GET_DEFAULT(crossUid_, "") };
