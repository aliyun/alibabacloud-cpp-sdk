...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySyncJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySyncJobResponseBody) };
    inline ModifySyncJobResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySyncJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySyncJobResponseBody> body_ {};
  };
