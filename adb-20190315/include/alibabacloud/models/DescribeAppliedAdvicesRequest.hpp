...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adviceType_ == nullptr
        && return this->DBClusterId_ == nullptr && return this->endTime_ == nullptr && return this->keyword_ == nullptr && return this->lang_ == nullptr && return this->order_ == nullptr
        && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->regionId_ == nullptr && return this->schemaTableName_ == nullptr && return this->startTime_ == nullptr; };
