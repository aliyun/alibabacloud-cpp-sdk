...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindDBResourcePoolWithUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnbindDBResourcePoolWithUserResponseBody) };
    inline UnbindDBResourcePoolWithUserResponseBody getBody() { DARABONBA_PTR_GET(body_, UnbindDBResourcePoolWithUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnbindDBResourcePoolWithUserResponseBody> body_ {};
  };
