...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountDescription_ == nullptr
        ...
        && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->tag_ == nullptr; };
    ...
    inline const vector<CreateAccountRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateAccountRequestTag>) };
    inline vector<CreateAccountRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<CreateAccountRequestTag>) };
    inline CreateAccountRequest& setTag(const vector<CreateAccountRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateAccountRequest& setTag(vector<CreateAccountRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CreateAccountRequestTag>> tag_ = nullptr;
  };
