...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEIURangeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEIURangeResponseBody) };
    inline DescribeEIURangeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEIURangeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEIURangeResponseBody> body_ {};
  };
