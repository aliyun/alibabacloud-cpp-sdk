...
namespace Models
{
  ...
  public:
    ...
    inline const RevokeOperatorPermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RevokeOperatorPermissionResponseBody) };
    inline RevokeOperatorPermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, RevokeOperatorPermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RevokeOperatorPermissionResponseBody> body_ {};
  };
