...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->elapsedTime_ == nullptr
        && return this->inputRows_ == nullptr && return this->inputSize_ == nullptr && return this->operatorCost_ == nullptr && return this->outputRows_ == nullptr && return this->outputSize_ == nullptr
        && return this->peakMemory_ == nullptr && return this->scanCost_ == nullptr && return this->scanRows_ == nullptr && return this->scanSize_ == nullptr && return this->state_ == nullptr
