...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        ...
        && this->pageSize_ == nullptr && this->regionId_ == nullptr && this->sqlPatternHash_ == nullptr && this->startTime_ == nullptr && this->userName_ == nullptr; };
    ...
    inline int64_t getSqlPatternHash() const { DARABONBA_PTR_GET_DEFAULT(sqlPatternHash_, 0L) };
    inline DescribeSQLPatternsRequest& setSqlPatternHash(int64_t sqlPatternHash) { DARABONBA_PTR_SET_VALUE(sqlPatternHash_, sqlPatternHash) };
  ...
  protected:
    ...
    shared_ptr<int64_t> sqlPatternHash_ {};
