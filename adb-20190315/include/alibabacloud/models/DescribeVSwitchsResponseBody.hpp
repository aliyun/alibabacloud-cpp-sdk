...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVSwitchsResponseBody::VSwitches & getVSwitches() const { DARABONBA_PTR_GET_CONST(vSwitches_, DescribeVSwitchsResponseBody::VSwitches) };
    inline DescribeVSwitchsResponseBody::VSwitches getVSwitches() { DARABONBA_PTR_GET(vSwitches_, DescribeVSwitchsResponseBody::VSwitches) };
    inline DescribeVSwitchsResponseBody& setVSwitches(const DescribeVSwitchsResponseBody::VSwitches & vSwitches) { DARABONBA_PTR_SET_VALUE(vSwitches_, vSwitches) };
    inline DescribeVSwitchsResponseBody& setVSwitches(DescribeVSwitchsResponseBody::VSwitches && vSwitches) { DARABONBA_PTR_SET_RVALUE(vSwitches_, vSwitches) };
  ...
  protected:
    ...
    shared_ptr<DescribeVSwitchsResponseBody::VSwitches> vSwitches_ {};
  };
