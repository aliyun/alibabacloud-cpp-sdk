...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyResubmitConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyResubmitConfigResponseBody) };
    inline ModifyResubmitConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyResubmitConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyResubmitConfigResponseBody> body_ {};
  };
