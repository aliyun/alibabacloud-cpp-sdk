...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->CPUTime_ == nullptr
        && return this->clientIP_ == nullptr && return this->database_ == nullptr && return this->outputRows_ == nullptr && return this->outputSize_ == nullptr && return this->peakMemory_ == nullptr
        && return this->planningTime_ == nullptr && return this->queuedTime_ == nullptr && return this->SQL_ == nullptr && return this->startTime_ == nullptr && return this->state_ == nullptr
        && return this->totalStage_ == nullptr && return this->totalTask_ == nullptr && return this->totalTime_ == nullptr && return this->user_ == nullptr; };
