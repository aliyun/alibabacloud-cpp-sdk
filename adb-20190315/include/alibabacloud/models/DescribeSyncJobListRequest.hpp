...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && this->getSourceDetail_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr
        && this->regionId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->sourceDBClusterDescription_ == nullptr && this->sourceDBClusterId_ == nullptr
        && this->sourceDBType_ == nullptr; };
    ...
    inline bool getGetSourceDetail() const { DARABONBA_PTR_GET_DEFAULT(getSourceDetail_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> getSourceDetail_ {};
