...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDiagnosisSQLInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDiagnosisSQLInfoResponseBody) };
    inline DescribeDiagnosisSQLInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDiagnosisSQLInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDiagnosisSQLInfoResponseBody> body_ {};
  };
