...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->inputDataSize_ == nullptr
        && this->inputRows_ == nullptr && this->operatorCost_ == nullptr && this->outputDataSize_ == nullptr && this->outputRows_ == nullptr && this->peakMemory_ == nullptr
        && this->progress_ == nullptr && this->stageId_ == nullptr && this->state_ == nullptr; };
