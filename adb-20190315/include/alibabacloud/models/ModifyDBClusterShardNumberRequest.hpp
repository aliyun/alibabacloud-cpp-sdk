...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getNewShardNumber() const { DARABONBA_PTR_GET_DEFAULT(newShardNumber_, 0L) };
    ...
    inline int64_t getSwitchTimeMode() const { DARABONBA_PTR_GET_DEFAULT(switchTimeMode_, 0L) };
  ...
  protected:
    ...
    shared_ptr<int64_t> switchTimeMode_ {};
  };
