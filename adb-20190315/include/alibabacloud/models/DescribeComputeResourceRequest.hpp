...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && this->DBClusterVersion_ == nullptr && this->migrate_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->regionId_ == nullptr
    ...
    inline bool getMigrate() const { DARABONBA_PTR_GET_DEFAULT(migrate_, false) };
