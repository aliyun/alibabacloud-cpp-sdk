...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterSpaceSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterSpaceSummaryResponseBody) };
    inline DescribeDBClusterSpaceSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterSpaceSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterSpaceSummaryResponseBody> body_ {};
  };
