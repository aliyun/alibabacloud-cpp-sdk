...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBResourcePoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBResourcePoolResponseBody) };
    inline ModifyDBResourcePoolResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBResourcePoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBResourcePoolResponseBody> body_ {};
  };
