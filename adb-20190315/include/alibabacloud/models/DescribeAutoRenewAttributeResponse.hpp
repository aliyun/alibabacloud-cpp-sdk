...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutoRenewAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAutoRenewAttributeResponseBody) };
    inline DescribeAutoRenewAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAutoRenewAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAutoRenewAttributeResponseBody> body_ {};
  };
