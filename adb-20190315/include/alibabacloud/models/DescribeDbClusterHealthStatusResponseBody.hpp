...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->CS_ == nullptr
        && return this->executor_ == nullptr && return this->instanceStatus_ == nullptr && return this->requestId_ == nullptr && return this->worker_ == nullptr; };
    // CS Field Functions 
