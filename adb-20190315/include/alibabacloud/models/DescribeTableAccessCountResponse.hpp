...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTableAccessCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTableAccessCountResponseBody) };
    inline DescribeTableAccessCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTableAccessCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTableAccessCountResponseBody> body_ {};
  };
