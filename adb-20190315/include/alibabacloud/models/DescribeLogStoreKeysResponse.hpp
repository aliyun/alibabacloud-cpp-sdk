...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLogStoreKeysResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLogStoreKeysResponseBody) };
    inline DescribeLogStoreKeysResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLogStoreKeysResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLogStoreKeysResponseBody> body_ {};
  };
