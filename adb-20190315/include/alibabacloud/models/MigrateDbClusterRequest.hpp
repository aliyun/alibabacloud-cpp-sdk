...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->computeResource_ == nullptr
        && return this->DBClusterId_ == nullptr && return this->dryRun_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->productForm_ == nullptr
        && return this->productVersion_ == nullptr && return this->reservedNodeCount_ == nullptr && return this->reservedNodeSize_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr
        && return this->secondaryVSwitchId_ == nullptr && return this->secondaryZoneId_ == nullptr && return this->shardNumber_ == nullptr && return this->storageResource_ == nullptr && return this->storageResourceSize_ == nullptr; };
