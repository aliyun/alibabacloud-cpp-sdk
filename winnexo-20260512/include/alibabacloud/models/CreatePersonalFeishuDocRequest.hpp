...
#ifndef ALIBABACLOUD_MODELS_CREATEPERSONALFEISHUDOCREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEPERSONALFEISHUDOCREQUEST_HPP_
...
namespace Models
{
  class CreatePersonalFeishuDocRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreatePersonalFeishuDocRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePersonalFeishuDocRequest& obj) { 
    ...
    CreatePersonalFeishuDocRequest() = default ;
    CreatePersonalFeishuDocRequest(const CreatePersonalFeishuDocRequest &) = default ;
    CreatePersonalFeishuDocRequest(CreatePersonalFeishuDocRequest &&) = default ;
    CreatePersonalFeishuDocRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePersonalFeishuDocRequest() = default ;
    CreatePersonalFeishuDocRequest& operator=(const CreatePersonalFeishuDocRequest &) = default ;
    CreatePersonalFeishuDocRequest& operator=(CreatePersonalFeishuDocRequest &&) = default ;
    ...
    inline CreatePersonalFeishuDocRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreatePersonalFeishuDocRequest& setDirectoryId(string directoryId) { DARABONBA_PTR_SET_VALUE(directoryId_, directoryId) };
    ...
    inline CreatePersonalFeishuDocRequest& setDocUrl(string docUrl) { DARABONBA_PTR_SET_VALUE(docUrl_, docUrl) };
    ...
    inline CreatePersonalFeishuDocRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreatePersonalFeishuDocRequest& setNotes(string notes) { DARABONBA_PTR_SET_VALUE(notes_, notes) };
    ...
    inline const vector<CreatePersonalFeishuDocRequest::ObjectBindings> & getObjectBindings() const { DARABONBA_PTR_GET_CONST(objectBindings_, vector<CreatePersonalFeishuDocRequest::ObjectBindings>) };
    inline vector<CreatePersonalFeishuDocRequest::ObjectBindings> getObjectBindings() { DARABONBA_PTR_GET(objectBindings_, vector<CreatePersonalFeishuDocRequest::ObjectBindings>) };
    inline CreatePersonalFeishuDocRequest& setObjectBindings(const vector<CreatePersonalFeishuDocRequest::ObjectBindings> & objectBindings) { DARABONBA_PTR_SET_VALUE(objectBindings_, objectBindings) };
    inline CreatePersonalFeishuDocRequest& setObjectBindings(vector<CreatePersonalFeishuDocRequest::ObjectBindings> && objectBindings) { DARABONBA_PTR_SET_RVALUE(objectBindings_, objectBindings) };
    ...
    inline CreatePersonalFeishuDocRequest& setOperatingObjectName(string operatingObjectName) { DARABONBA_PTR_SET_VALUE(operatingObjectName_, operatingObjectName) };
    ...
    inline CreatePersonalFeishuDocRequest& setSourceTags(string sourceTags) { DARABONBA_PTR_SET_VALUE(sourceTags_, sourceTags) };
    ...
    inline const CreatePersonalFeishuDocRequest::SyncConfig & getSyncConfig() const { DARABONBA_PTR_GET_CONST(syncConfig_, CreatePersonalFeishuDocRequest::SyncConfig) };
    inline CreatePersonalFeishuDocRequest::SyncConfig getSyncConfig() { DARABONBA_PTR_GET(syncConfig_, CreatePersonalFeishuDocRequest::SyncConfig) };
    inline CreatePersonalFeishuDocRequest& setSyncConfig(const CreatePersonalFeishuDocRequest::SyncConfig & syncConfig) { DARABONBA_PTR_SET_VALUE(syncConfig_, syncConfig) };
    inline CreatePersonalFeishuDocRequest& setSyncConfig(CreatePersonalFeishuDocRequest::SyncConfig && syncConfig) { DARABONBA_PTR_SET_RVALUE(syncConfig_, syncConfig) };
    ...
    inline CreatePersonalFeishuDocRequest& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
  ...
  protected:
    ...
    // The object bindings.
    shared_ptr<vector<CreatePersonalFeishuDocRequest::ObjectBindings>> objectBindings_ {};
    // The digital employee name (operating object name, optional).
    shared_ptr<string> operatingObjectName_ {};
    // The resource tags (optional, a JSON string list, such as ["tagA","tagB"]).
    shared_ptr<string> sourceTags_ {};
    // The synchronization settings.
    shared_ptr<CreatePersonalFeishuDocRequest::SyncConfig> syncConfig_ {};
    // The tenant ID.
