...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->directoryId_ == nullptr && this->filePublicUrl_ == nullptr && this->name_ == nullptr && this->operatingObjectName_ == nullptr && this->sourceTags_ == nullptr
    ...
    inline CreatePersonalAlidingDocRequest& setSourceTags(string sourceTags) { DARABONBA_PTR_SET_VALUE(sourceTags_, sourceTags) };
