...
#ifndef ALIBABACLOUD_MODELS_CREATEPERSONALDINGTALKCHATREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEPERSONALDINGTALKCHATREQUEST_HPP_
...
namespace Models
{
  class CreatePersonalDingtalkChatRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreatePersonalDingtalkChatRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePersonalDingtalkChatRequest& obj) { 
    ...
    CreatePersonalDingtalkChatRequest() = default ;
    CreatePersonalDingtalkChatRequest(const CreatePersonalDingtalkChatRequest &) = default ;
    CreatePersonalDingtalkChatRequest(CreatePersonalDingtalkChatRequest &&) = default ;
    CreatePersonalDingtalkChatRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePersonalDingtalkChatRequest() = default ;
    CreatePersonalDingtalkChatRequest& operator=(const CreatePersonalDingtalkChatRequest &) = default ;
    CreatePersonalDingtalkChatRequest& operator=(CreatePersonalDingtalkChatRequest &&) = default ;
    ...
    inline CreatePersonalDingtalkChatRequest& setChatId(string chatId) { DARABONBA_PTR_SET_VALUE(chatId_, chatId) };
    ...
    inline CreatePersonalDingtalkChatRequest& setChatName(string chatName) { DARABONBA_PTR_SET_VALUE(chatName_, chatName) };
    ...
    inline CreatePersonalDingtalkChatRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreatePersonalDingtalkChatRequest& setDirectoryId(string directoryId) { DARABONBA_PTR_SET_VALUE(directoryId_, directoryId) };
    ...
    inline CreatePersonalDingtalkChatRequest& setHistoryStartTime(string historyStartTime) { DARABONBA_PTR_SET_VALUE(historyStartTime_, historyStartTime) };
    ...
    inline CreatePersonalDingtalkChatRequest& setNotes(string notes) { DARABONBA_PTR_SET_VALUE(notes_, notes) };
    ...
    inline CreatePersonalDingtalkChatRequest& setOperatingObjectName(string operatingObjectName) { DARABONBA_PTR_SET_VALUE(operatingObjectName_, operatingObjectName) };
    ...
    inline CreatePersonalDingtalkChatRequest& setSourceTags(string sourceTags) { DARABONBA_PTR_SET_VALUE(sourceTags_, sourceTags) };
    ...
    inline CreatePersonalDingtalkChatRequest& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
    ...
    inline const CreatePersonalDingtalkChatRequest::UpdateFrequency & getUpdateFrequency() const { DARABONBA_PTR_GET_CONST(updateFrequency_, CreatePersonalDingtalkChatRequest::UpdateFrequency) };
    inline CreatePersonalDingtalkChatRequest::UpdateFrequency getUpdateFrequency() { DARABONBA_PTR_GET(updateFrequency_, CreatePersonalDingtalkChatRequest::UpdateFrequency) };
    inline CreatePersonalDingtalkChatRequest& setUpdateFrequency(const CreatePersonalDingtalkChatRequest::UpdateFrequency & updateFrequency) { DARABONBA_PTR_SET_VALUE(updateFrequency_, updateFrequency) };
    inline CreatePersonalDingtalkChatRequest& setUpdateFrequency(CreatePersonalDingtalkChatRequest::UpdateFrequency && updateFrequency) { DARABONBA_PTR_SET_RVALUE(updateFrequency_, updateFrequency) };
  ...
  protected:
    ...
    shared_ptr<CreatePersonalDingtalkChatRequest::UpdateFrequency> updateFrequency_ {};
  };
