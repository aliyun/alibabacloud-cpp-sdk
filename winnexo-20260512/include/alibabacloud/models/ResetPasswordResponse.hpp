...
namespace Models
{
  ...
  public:
    ...
    inline const ResetPasswordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResetPasswordResponseBody) };
    inline ResetPasswordResponseBody getBody() { DARABONBA_PTR_GET(body_, ResetPasswordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResetPasswordResponseBody> body_ {};
  };
