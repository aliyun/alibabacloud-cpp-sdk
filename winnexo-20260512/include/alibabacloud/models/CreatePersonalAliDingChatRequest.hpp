...
#ifndef ALIBABACLOUD_MODELS_CREATEPERSONALALIDINGCHATREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEPERSONALALIDINGCHATREQUEST_HPP_
...
namespace Models
{
  class CreatePersonalAliDingChatRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreatePersonalAliDingChatRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePersonalAliDingChatRequest& obj) { 
    ...
    CreatePersonalAliDingChatRequest() = default ;
    CreatePersonalAliDingChatRequest(const CreatePersonalAliDingChatRequest &) = default ;
    CreatePersonalAliDingChatRequest(CreatePersonalAliDingChatRequest &&) = default ;
    CreatePersonalAliDingChatRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePersonalAliDingChatRequest() = default ;
    CreatePersonalAliDingChatRequest& operator=(const CreatePersonalAliDingChatRequest &) = default ;
    CreatePersonalAliDingChatRequest& operator=(CreatePersonalAliDingChatRequest &&) = default ;
    ...
    inline CreatePersonalAliDingChatRequest& setChatId(string chatId) { DARABONBA_PTR_SET_VALUE(chatId_, chatId) };
    ...
    inline CreatePersonalAliDingChatRequest& setChatName(string chatName) { DARABONBA_PTR_SET_VALUE(chatName_, chatName) };
    ...
    inline CreatePersonalAliDingChatRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreatePersonalAliDingChatRequest& setDirectoryId(string directoryId) { DARABONBA_PTR_SET_VALUE(directoryId_, directoryId) };
    ...
    inline CreatePersonalAliDingChatRequest& setHistoryStartTime(string historyStartTime) { DARABONBA_PTR_SET_VALUE(historyStartTime_, historyStartTime) };
    ...
    inline CreatePersonalAliDingChatRequest& setNotes(string notes) { DARABONBA_PTR_SET_VALUE(notes_, notes) };
    ...
    inline CreatePersonalAliDingChatRequest& setOperatingObjectName(string operatingObjectName) { DARABONBA_PTR_SET_VALUE(operatingObjectName_, operatingObjectName) };
    ...
    inline CreatePersonalAliDingChatRequest& setSourceTags(string sourceTags) { DARABONBA_PTR_SET_VALUE(sourceTags_, sourceTags) };
    ...
    inline CreatePersonalAliDingChatRequest& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
    ...
    inline const CreatePersonalAliDingChatRequest::UpdateFrequency & getUpdateFrequency() const { DARABONBA_PTR_GET_CONST(updateFrequency_, CreatePersonalAliDingChatRequest::UpdateFrequency) };
    inline CreatePersonalAliDingChatRequest::UpdateFrequency getUpdateFrequency() { DARABONBA_PTR_GET(updateFrequency_, CreatePersonalAliDingChatRequest::UpdateFrequency) };
    inline CreatePersonalAliDingChatRequest& setUpdateFrequency(const CreatePersonalAliDingChatRequest::UpdateFrequency & updateFrequency) { DARABONBA_PTR_SET_VALUE(updateFrequency_, updateFrequency) };
    inline CreatePersonalAliDingChatRequest& setUpdateFrequency(CreatePersonalAliDingChatRequest::UpdateFrequency && updateFrequency) { DARABONBA_PTR_SET_RVALUE(updateFrequency_, updateFrequency) };
  ...
  protected:
    ...
    shared_ptr<CreatePersonalAliDingChatRequest::UpdateFrequency> updateFrequency_ {};
  };
