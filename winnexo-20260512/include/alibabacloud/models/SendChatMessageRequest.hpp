...
namespace Models
{
  ...
  public:
    ...
    inline SendChatMessageRequest& setContent(string content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    ...
    inline SendChatMessageRequest& setContentType(string contentType) { DARABONBA_PTR_SET_VALUE(contentType_, contentType) };
    ...
    inline SendChatMessageRequest& setDigitalEmployeeName(const vector<string> & digitalEmployeeName) { DARABONBA_PTR_SET_VALUE(digitalEmployeeName_, digitalEmployeeName) };
    inline SendChatMessageRequest& setDigitalEmployeeName(vector<string> && digitalEmployeeName) { DARABONBA_PTR_SET_RVALUE(digitalEmployeeName_, digitalEmployeeName) };
    ...
    inline SendChatMessageRequest& setDirectChat(bool directChat) { DARABONBA_PTR_SET_VALUE(directChat_, directChat) };
    ...
    void deleteEnableWebSearch() { this->enableWebSearch_ = nullptr;};
    inline bool getEnableWebSearch() const { DARABONBA_PTR_GET_DEFAULT(enableWebSearch_, false) };
    inline SendChatMessageRequest& setEnableWebSearch(bool enableWebSearch) { DARABONBA_PTR_SET_VALUE(enableWebSearch_, enableWebSearch) };


    // files Field Functions 
    bool hasFiles() const { return this->files_ != nullptr;};
    void deleteFiles() { this->files_ = nullptr;};
    inline const vector<SendChatMessageRequest::Files> & getFiles() const { DARABONBA_PTR_GET_CONST(files_, vector<SendChatMessageRequest::Files>) };
    inline vector<SendChatMessageRequest::Files> getFiles() { DARABONBA_PTR_GET(files_, vector<SendChatMessageRequest::Files>) };
    inline SendChatMessageRequest& setFiles(const vector<SendChatMessageRequest::Files> & files) { DARABONBA_PTR_SET_VALUE(files_, files) };
    inline SendChatMessageRequest& setFiles(vector<SendChatMessageRequest::Files> && files) { DARABONBA_PTR_SET_RVALUE(files_, files) };
    ...
    inline SendChatMessageRequest& setModel(string model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    ...
    inline SendChatMessageRequest& setReuseLastSession(bool reuseLastSession) { DARABONBA_PTR_SET_VALUE(reuseLastSession_, reuseLastSession) };
    ...
    inline SendChatMessageRequest& setStream(bool stream) { DARABONBA_PTR_SET_VALUE(stream_, stream) };
    ...
    inline const SendChatMessageRequest::TaskExecution & getTaskExecution() const { DARABONBA_PTR_GET_CONST(taskExecution_, SendChatMessageRequest::TaskExecution) };
    inline SendChatMessageRequest::TaskExecution getTaskExecution() { DARABONBA_PTR_GET(taskExecution_, SendChatMessageRequest::TaskExecution) };
    inline SendChatMessageRequest& setTaskExecution(const SendChatMessageRequest::TaskExecution & taskExecution) { DARABONBA_PTR_SET_VALUE(taskExecution_, taskExecution) };
    inline SendChatMessageRequest& setTaskExecution(SendChatMessageRequest::TaskExecution && taskExecution) { DARABONBA_PTR_SET_RVALUE(taskExecution_, taskExecution) };
    ...
    void deleteTenantId() { this->tenantId_ = nullptr;};
    inline string getTenantId() const { DARABONBA_PTR_GET_DEFAULT(tenantId_, "") };
    inline SendChatMessageRequest& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
    ...
    inline SendChatMessageRequest& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
  ...
  protected:
    ...
    shared_ptr<vector<SendChatMessageRequest::Files>> files_ {};
    ...
    shared_ptr<SendChatMessageRequest::TaskExecution> taskExecution_ {};
