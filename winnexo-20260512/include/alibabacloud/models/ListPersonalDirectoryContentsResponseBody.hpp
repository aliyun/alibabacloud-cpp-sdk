...
#ifndef ALIBABACLOUD_MODELS_LISTPERSONALDIRECTORYCONTENTSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTPERSONALDIRECTORYCONTENTSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListPersonalDirectoryContentsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListPersonalDirectoryContentsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListPersonalDirectoryContentsResponseBody& obj) { 
    ...
    ListPersonalDirectoryContentsResponseBody() = default ;
    ListPersonalDirectoryContentsResponseBody(const ListPersonalDirectoryContentsResponseBody &) = default ;
    ListPersonalDirectoryContentsResponseBody(ListPersonalDirectoryContentsResponseBody &&) = default ;
    ListPersonalDirectoryContentsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPersonalDirectoryContentsResponseBody() = default ;
    ListPersonalDirectoryContentsResponseBody& operator=(const ListPersonalDirectoryContentsResponseBody &) = default ;
    ListPersonalDirectoryContentsResponseBody& operator=(ListPersonalDirectoryContentsResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->objectName_ == nullptr && this->objectType_ == nullptr && this->objectTypeName_ == nullptr; };
    ...
    inline ListPersonalDirectoryContentsResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // items Field Functions 
    bool hasItems() const { return this->items_ != nullptr;};
    void deleteItems() { this->items_ = nullptr;};
    inline const vector<ListPersonalDirectoryContentsResponseBody::Items> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<ListPersonalDirectoryContentsResponseBody::Items>) };
    inline vector<ListPersonalDirectoryContentsResponseBody::Items> getItems() { DARABONBA_PTR_GET(items_, vector<ListPersonalDirectoryContentsResponseBody::Items>) };
    inline ListPersonalDirectoryContentsResponseBody& setItems(const vector<ListPersonalDirectoryContentsResponseBody::Items> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline ListPersonalDirectoryContentsResponseBody& setItems(vector<ListPersonalDirectoryContentsResponseBody::Items> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
    ...
    inline ListPersonalDirectoryContentsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListPersonalDirectoryContentsResponseBody& setPage(int64_t page) { DARABONBA_PTR_SET_VALUE(page_, page) };
    ...
    inline ListPersonalDirectoryContentsResponseBody& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListPersonalDirectoryContentsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListPersonalDirectoryContentsResponseBody& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
