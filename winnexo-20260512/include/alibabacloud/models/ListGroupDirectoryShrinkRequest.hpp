...
#ifndef ALIBABACLOUD_MODELS_LISTGROUPDIRECTORYSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTGROUPDIRECTORYSHRINKREQUEST_HPP_
...
namespace Models
{
  class ListGroupDirectoryShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListGroupDirectoryShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListGroupDirectoryShrinkRequest& obj) { 
    ...
    ListGroupDirectoryShrinkRequest() = default ;
    ListGroupDirectoryShrinkRequest(const ListGroupDirectoryShrinkRequest &) = default ;
    ListGroupDirectoryShrinkRequest(ListGroupDirectoryShrinkRequest &&) = default ;
    ListGroupDirectoryShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListGroupDirectoryShrinkRequest() = default ;
    ListGroupDirectoryShrinkRequest& operator=(const ListGroupDirectoryShrinkRequest &) = default ;
    ListGroupDirectoryShrinkRequest& operator=(ListGroupDirectoryShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->directoryId_ == nullptr
        ...
        && this->sourceStatus_ == nullptr && this->sourceTypesShrink_ == nullptr && this->tenantId_ == nullptr; };
    // directoryId Field Functions 
    bool hasDirectoryId() const { return this->directoryId_ != nullptr;};
    void deleteDirectoryId() { this->directoryId_ = nullptr;};
    inline string getDirectoryId() const { DARABONBA_PTR_GET_DEFAULT(directoryId_, "") };
    inline ListGroupDirectoryShrinkRequest& setDirectoryId(string directoryId) { DARABONBA_PTR_SET_VALUE(directoryId_, directoryId) };
    ...
    inline ListGroupDirectoryShrinkRequest& setGroupId(string groupId) { DARABONBA_PTR_SET_VALUE(groupId_, groupId) };
    ...
    inline ListGroupDirectoryShrinkRequest& setPage(int64_t page) { DARABONBA_PTR_SET_VALUE(page_, page) };
    ...
    inline ListGroupDirectoryShrinkRequest& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListGroupDirectoryShrinkRequest& setSortField(string sortField) { DARABONBA_PTR_SET_VALUE(sortField_, sortField) };
    ...
    inline ListGroupDirectoryShrinkRequest& setSortOrder(string sortOrder) { DARABONBA_PTR_SET_VALUE(sortOrder_, sortOrder) };
    ...
    inline ListGroupDirectoryShrinkRequest& setSourceStatus(string sourceStatus) { DARABONBA_PTR_SET_VALUE(sourceStatus_, sourceStatus) };
    ...
    inline ListGroupDirectoryShrinkRequest& setSourceTypesShrink(string sourceTypesShrink) { DARABONBA_PTR_SET_VALUE(sourceTypesShrink_, sourceTypesShrink) };
    ...
    inline ListGroupDirectoryShrinkRequest& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
