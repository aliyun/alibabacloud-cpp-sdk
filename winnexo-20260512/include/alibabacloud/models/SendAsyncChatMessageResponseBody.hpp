...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        ...
        && this->userMessageId_ == nullptr && this->workMode_ == nullptr; };
    ...
    inline SendAsyncChatMessageResponseBody& setWorkMode(string workMode) { DARABONBA_PTR_SET_VALUE(workMode_, workMode) };
