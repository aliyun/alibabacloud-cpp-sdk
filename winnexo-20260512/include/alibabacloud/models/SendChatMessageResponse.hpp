...
namespace Models
{
  ...
  public:
    ...
    inline SendChatMessageResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline SendChatMessageResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const SendChatMessageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendChatMessageResponseBody) };
    inline SendChatMessageResponseBody getBody() { DARABONBA_PTR_GET(body_, SendChatMessageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendChatMessageResponseBody> body_ {};
  };
