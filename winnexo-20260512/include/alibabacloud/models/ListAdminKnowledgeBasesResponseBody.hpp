...
#ifndef ALIBABACLOUD_MODELS_LISTADMINKNOWLEDGEBASESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTADMINKNOWLEDGEBASESRESPONSEBODY_HPP_
...
namespace Models
{
  class ListAdminKnowledgeBasesResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListAdminKnowledgeBasesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAdminKnowledgeBasesResponseBody& obj) { 
    ...
    ListAdminKnowledgeBasesResponseBody() = default ;
    ListAdminKnowledgeBasesResponseBody(const ListAdminKnowledgeBasesResponseBody &) = default ;
    ListAdminKnowledgeBasesResponseBody(ListAdminKnowledgeBasesResponseBody &&) = default ;
    ListAdminKnowledgeBasesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAdminKnowledgeBasesResponseBody() = default ;
    ListAdminKnowledgeBasesResponseBody& operator=(const ListAdminKnowledgeBasesResponseBody &) = default ;
    ListAdminKnowledgeBasesResponseBody& operator=(ListAdminKnowledgeBasesResponseBody &&) = default ;
    ...
    inline ListAdminKnowledgeBasesResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // items Field Functions 
    bool hasItems() const { return this->items_ != nullptr;};
    void deleteItems() { this->items_ = nullptr;};
    inline const vector<ListAdminKnowledgeBasesResponseBody::Items> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<ListAdminKnowledgeBasesResponseBody::Items>) };
    inline vector<ListAdminKnowledgeBasesResponseBody::Items> getItems() { DARABONBA_PTR_GET(items_, vector<ListAdminKnowledgeBasesResponseBody::Items>) };
    inline ListAdminKnowledgeBasesResponseBody& setItems(const vector<ListAdminKnowledgeBasesResponseBody::Items> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline ListAdminKnowledgeBasesResponseBody& setItems(vector<ListAdminKnowledgeBasesResponseBody::Items> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
    ...
    inline ListAdminKnowledgeBasesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListAdminKnowledgeBasesResponseBody& setPage(int64_t page) { DARABONBA_PTR_SET_VALUE(page_, page) };
    ...
    inline ListAdminKnowledgeBasesResponseBody& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListAdminKnowledgeBasesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListAdminKnowledgeBasesResponseBody& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
