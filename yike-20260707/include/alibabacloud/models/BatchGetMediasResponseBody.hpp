...
#ifndef ALIBABACLOUD_MODELS_BATCHGETMEDIASRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_BATCHGETMEDIASRESPONSEBODY_HPP_
...
namespace Models
{
  class BatchGetMediasResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const BatchGetMediasResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(IgnoredList, ignoredList_);
      DARABONBA_PTR_TO_JSON(MediaInfos, mediaInfos_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, BatchGetMediasResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(IgnoredList, ignoredList_);
      DARABONBA_PTR_FROM_JSON(MediaInfos, mediaInfos_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    BatchGetMediasResponseBody() = default ;
    BatchGetMediasResponseBody(const BatchGetMediasResponseBody &) = default ;
    BatchGetMediasResponseBody(BatchGetMediasResponseBody &&) = default ;
    BatchGetMediasResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BatchGetMediasResponseBody() = default ;
    BatchGetMediasResponseBody& operator=(const BatchGetMediasResponseBody &) = default ;
    BatchGetMediasResponseBody& operator=(BatchGetMediasResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->createTime_ == nullptr && this->description_ == nullptr && this->inputURL_ == nullptr && this->mediaId_ == nullptr && this->mediaTags_ == nullptr
        && this->mediaType_ == nullptr && this->modifiedTime_ == nullptr && this->snapshots_ == nullptr && this->source_ == nullptr && this->spriteImages_ == nullptr
        && this->status_ == nullptr && this->title_ == nullptr && this->userData_ == nullptr; };
    ...
    inline BatchGetMediasResponseBody& setIgnoredList(const vector<string> & ignoredList) { DARABONBA_PTR_SET_VALUE(ignoredList_, ignoredList) };
    inline BatchGetMediasResponseBody& setIgnoredList(vector<string> && ignoredList) { DARABONBA_PTR_SET_RVALUE(ignoredList_, ignoredList) };
    ...
    inline const vector<BatchGetMediasResponseBody::MediaInfos> & getMediaInfos() const { DARABONBA_PTR_GET_CONST(mediaInfos_, vector<BatchGetMediasResponseBody::MediaInfos>) };
    inline vector<BatchGetMediasResponseBody::MediaInfos> getMediaInfos() { DARABONBA_PTR_GET(mediaInfos_, vector<BatchGetMediasResponseBody::MediaInfos>) };
    inline BatchGetMediasResponseBody& setMediaInfos(const vector<BatchGetMediasResponseBody::MediaInfos> & mediaInfos) { DARABONBA_PTR_SET_VALUE(mediaInfos_, mediaInfos) };
    inline BatchGetMediasResponseBody& setMediaInfos(vector<BatchGetMediasResponseBody::MediaInfos> && mediaInfos) { DARABONBA_PTR_SET_RVALUE(mediaInfos_, mediaInfos) };
    ...
    inline BatchGetMediasResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<vector<string>> ignoredList_ {};
    shared_ptr<vector<BatchGetMediasResponseBody::MediaInfos>> mediaInfos_ {};
