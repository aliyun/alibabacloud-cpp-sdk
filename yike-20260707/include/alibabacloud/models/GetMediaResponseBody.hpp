...
#ifndef ALIBABACLOUD_MODELS_GETMEDIARESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETMEDIARESPONSEBODY_HPP_
...
namespace Models
{
  class GetMediaResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetMediaResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(MediaInfo, mediaInfo_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetMediaResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(MediaInfo, mediaInfo_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetMediaResponseBody() = default ;
    GetMediaResponseBody(const GetMediaResponseBody &) = default ;
    GetMediaResponseBody(GetMediaResponseBody &&) = default ;
    GetMediaResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetMediaResponseBody() = default ;
    GetMediaResponseBody& operator=(const GetMediaResponseBody &) = default ;
    GetMediaResponseBody& operator=(GetMediaResponseBody &&) = default ;
    ...
    public:
      ...
      inline const MediaInfo::MediaDynamicInfo & getMediaDynamicInfo() const { DARABONBA_PTR_GET_CONST(mediaDynamicInfo_, MediaInfo::MediaDynamicInfo) };
      inline MediaInfo::MediaDynamicInfo getMediaDynamicInfo() { DARABONBA_PTR_GET(mediaDynamicInfo_, MediaInfo::MediaDynamicInfo) };
      inline MediaInfo& setMediaDynamicInfo(const MediaInfo::MediaDynamicInfo & mediaDynamicInfo) { DARABONBA_PTR_SET_VALUE(mediaDynamicInfo_, mediaDynamicInfo) };
      inline MediaInfo& setMediaDynamicInfo(MediaInfo::MediaDynamicInfo && mediaDynamicInfo) { DARABONBA_PTR_SET_RVALUE(mediaDynamicInfo_, mediaDynamicInfo) };
    ...
    protected:
      ...
      shared_ptr<MediaInfo::MediaDynamicInfo> mediaDynamicInfo_ {};
      shared_ptr<string> mediaId_ {};
    };
    ...
    inline const GetMediaResponseBody::MediaInfo & getMediaInfo() const { DARABONBA_PTR_GET_CONST(mediaInfo_, GetMediaResponseBody::MediaInfo) };
    inline GetMediaResponseBody::MediaInfo getMediaInfo() { DARABONBA_PTR_GET(mediaInfo_, GetMediaResponseBody::MediaInfo) };
    inline GetMediaResponseBody& setMediaInfo(const GetMediaResponseBody::MediaInfo & mediaInfo) { DARABONBA_PTR_SET_VALUE(mediaInfo_, mediaInfo) };
    inline GetMediaResponseBody& setMediaInfo(GetMediaResponseBody::MediaInfo && mediaInfo) { DARABONBA_PTR_SET_RVALUE(mediaInfo_, mediaInfo) };
    ...
    inline GetMediaResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<GetMediaResponseBody::MediaInfo> mediaInfo_ {};
