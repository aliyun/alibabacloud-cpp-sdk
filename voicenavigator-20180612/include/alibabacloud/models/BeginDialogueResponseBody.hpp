...
#ifndef ALIBABACLOUD_MODELS_BEGINDIALOGUERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_BEGINDIALOGUERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const BeginDialogueResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, BeginDialogueResponseBody& obj) { 
    ...
    BeginDialogueResponseBody() = default ;
    BeginDialogueResponseBody(const BeginDialogueResponseBody &) = default ;
    BeginDialogueResponseBody(BeginDialogueResponseBody &&) = default ;
    BeginDialogueResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BeginDialogueResponseBody() = default ;
    BeginDialogueResponseBody& operator=(const BeginDialogueResponseBody &) = default ;
    BeginDialogueResponseBody& operator=(BeginDialogueResponseBody &&) = default ;
    ...
    inline BeginDialogueResponseBody& setAction(string action) { DARABONBA_PTR_SET_VALUE(action_, action) };
    ...
    inline BeginDialogueResponseBody& setActionParams(string actionParams) { DARABONBA_PTR_SET_VALUE(actionParams_, actionParams) };
    ...
    inline BeginDialogueResponseBody& setInterruptible(bool interruptible) { DARABONBA_PTR_SET_VALUE(interruptible_, interruptible) };
    ...
    inline BeginDialogueResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline BeginDialogueResponseBody& setTextResponse(string textResponse) { DARABONBA_PTR_SET_VALUE(textResponse_, textResponse) };
