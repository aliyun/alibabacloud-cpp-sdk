...
#ifndef ALIBABACLOUD_MODELS_DEBUGDIALOGUERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DEBUGDIALOGUERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DebugDialogueResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DebugDialogueResponseBody& obj) { 
    ...
    DebugDialogueResponseBody() = default ;
    DebugDialogueResponseBody(const DebugDialogueResponseBody &) = default ;
    DebugDialogueResponseBody(DebugDialogueResponseBody &&) = default ;
    DebugDialogueResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DebugDialogueResponseBody() = default ;
    DebugDialogueResponseBody& operator=(const DebugDialogueResponseBody &) = default ;
    DebugDialogueResponseBody& operator=(DebugDialogueResponseBody &&) = default ;
    ...
    inline DebugDialogueResponseBody& setAction(string action) { DARABONBA_PTR_SET_VALUE(action_, action) };
    ...
    inline DebugDialogueResponseBody& setActionParams(string actionParams) { DARABONBA_PTR_SET_VALUE(actionParams_, actionParams) };
    ...
    inline DebugDialogueResponseBody& setInterruptible(bool interruptible) { DARABONBA_PTR_SET_VALUE(interruptible_, interruptible) };
    ...
    inline DebugDialogueResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DebugDialogueResponseBody& setTextResponse(string textResponse) { DARABONBA_PTR_SET_VALUE(textResponse_, textResponse) };
