...
#ifndef ALIBABACLOUD_MODELS_DEBUGBEGINDIALOGUERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DEBUGBEGINDIALOGUERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DebugBeginDialogueResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DebugBeginDialogueResponseBody& obj) { 
    ...
    DebugBeginDialogueResponseBody() = default ;
    DebugBeginDialogueResponseBody(const DebugBeginDialogueResponseBody &) = default ;
    DebugBeginDialogueResponseBody(DebugBeginDialogueResponseBody &&) = default ;
    DebugBeginDialogueResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DebugBeginDialogueResponseBody() = default ;
    DebugBeginDialogueResponseBody& operator=(const DebugBeginDialogueResponseBody &) = default ;
    DebugBeginDialogueResponseBody& operator=(DebugBeginDialogueResponseBody &&) = default ;
    ...
    inline DebugBeginDialogueResponseBody& setAction(string action) { DARABONBA_PTR_SET_VALUE(action_, action) };
    ...
    inline DebugBeginDialogueResponseBody& setActionParams(string actionParams) { DARABONBA_PTR_SET_VALUE(actionParams_, actionParams) };
    ...
    inline DebugBeginDialogueResponseBody& setInterruptible(bool interruptible) { DARABONBA_PTR_SET_VALUE(interruptible_, interruptible) };
    ...
    inline DebugBeginDialogueResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DebugBeginDialogueResponseBody& setTextResponse(string textResponse) { DARABONBA_PTR_SET_VALUE(textResponse_, textResponse) };
