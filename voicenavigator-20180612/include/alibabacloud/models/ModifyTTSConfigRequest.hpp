...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aliCustomizedVoice_ == nullptr
        && this->appKey_ == nullptr && this->engine_ == nullptr && this->engineXunfei_ == nullptr && this->extParams_ == nullptr && this->instanceId_ == nullptr
        && this->nlsServiceType_ == nullptr && this->pitchRate_ == nullptr && this->speechRate_ == nullptr && this->ttsOverrides_ == nullptr && this->voice_ == nullptr
    ...
    inline ModifyTTSConfigRequest& setExtParams(string extParams) { DARABONBA_PTR_SET_VALUE(extParams_, extParams) };
