...
#ifndef ALIBABACLOUD_MODELS_COLLECTEDNUMBERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_COLLECTEDNUMBERRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CollectedNumberResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CollectedNumberResponseBody& obj) { 
    ...
    CollectedNumberResponseBody() = default ;
    CollectedNumberResponseBody(const CollectedNumberResponseBody &) = default ;
    CollectedNumberResponseBody(CollectedNumberResponseBody &&) = default ;
    CollectedNumberResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CollectedNumberResponseBody() = default ;
    CollectedNumberResponseBody& operator=(const CollectedNumberResponseBody &) = default ;
    CollectedNumberResponseBody& operator=(CollectedNumberResponseBody &&) = default ;
    ...
    inline CollectedNumberResponseBody& setAction(string action) { DARABONBA_PTR_SET_VALUE(action_, action) };
    ...
    inline CollectedNumberResponseBody& setActionParams(string actionParams) { DARABONBA_PTR_SET_VALUE(actionParams_, actionParams) };
    ...
    inline CollectedNumberResponseBody& setInterruptible(bool interruptible) { DARABONBA_PTR_SET_VALUE(interruptible_, interruptible) };
    ...
    inline CollectedNumberResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CollectedNumberResponseBody& setTextResponse(string textResponse) { DARABONBA_PTR_SET_VALUE(textResponse_, textResponse) };
