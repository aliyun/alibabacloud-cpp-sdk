...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instant_ == nullptr
        && this->labelSeries_ == nullptr && this->PK_ == nullptr && this->token_ == nullptr; };
    ...
    inline QueryCustomerLabelRequest& setInstant(bool instant) { DARABONBA_PTR_SET_VALUE(instant_, instant) };
