...
namespace Models
{
  ...
  public:
    ...
    inline const SaveBatchTaskForDomainNameProxyServiceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SaveBatchTaskForDomainNameProxyServiceResponseBody) };
    inline SaveBatchTaskForDomainNameProxyServiceResponseBody body() { DARABONBA_PTR_GET(body_, SaveBatchTaskForDomainNameProxyServiceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SaveBatchTaskForDomainNameProxyServiceResponseBody> body_ = nullptr;
  };
