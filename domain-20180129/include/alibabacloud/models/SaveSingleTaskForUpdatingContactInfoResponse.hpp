...
namespace Models
{
  ...
  public:
    ...
    inline const SaveSingleTaskForUpdatingContactInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveSingleTaskForUpdatingContactInfoResponseBody) };
    inline SaveSingleTaskForUpdatingContactInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveSingleTaskForUpdatingContactInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveSingleTaskForUpdatingContactInfoResponseBody> body_ {};
  };
