...
#ifndef ALIBABACLOUD_MODELS_QUERYDOMAINSPECIALBIZINFOBYDOMAINRESPONSEBODYMODULEDOMAINSPECIALBIZCONTACT_HPP_
#define ALIBABACLOUD_MODELS_QUERYDOMAINSPECIALBIZINFOBYDOMAINRESPONSEBODYMODULEDOMAINSPECIALBIZCONTACT_HPP_
...
namespace Models
{
  class QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& obj) { 
    ...
    QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact() = default ;
    QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact(const QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact &) = default ;
    QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact(QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact &&) = default ;
    QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact() = default ;
    QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& operator=(const QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact &) = default ;
    QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& operator=(QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact &&) = default ;
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setBizId(int64_t bizId) { DARABONBA_PTR_SET_VALUE(bizId_, bizId) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setCCity(string CCity) { DARABONBA_PTR_SET_VALUE(CCity_, CCity) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setCCompany(string CCompany) { DARABONBA_PTR_SET_VALUE(CCompany_, CCompany) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setCCountry(string CCountry) { DARABONBA_PTR_SET_VALUE(CCountry_, CCountry) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setCName(string CName) { DARABONBA_PTR_SET_VALUE(CName_, CName) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setCProvince(string CProvince) { DARABONBA_PTR_SET_VALUE(CProvince_, CProvince) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setCVenu(string CVenu) { DARABONBA_PTR_SET_VALUE(CVenu_, CVenu) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setECity(string ECity) { DARABONBA_PTR_SET_VALUE(ECity_, ECity) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setECompany(string ECompany) { DARABONBA_PTR_SET_VALUE(ECompany_, ECompany) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setEName(string EName) { DARABONBA_PTR_SET_VALUE(EName_, EName) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setEProvince(string EProvince) { DARABONBA_PTR_SET_VALUE(EProvince_, EProvince) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setEVenu(string EVenu) { DARABONBA_PTR_SET_VALUE(EVenu_, EVenu) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setExtend(string extend) { DARABONBA_PTR_SET_VALUE(extend_, extend) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setFaxArea(string faxArea) { DARABONBA_PTR_SET_VALUE(faxArea_, faxArea) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setFaxExt(string faxExt) { DARABONBA_PTR_SET_VALUE(faxExt_, faxExt) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setFaxMain(string faxMain) { DARABONBA_PTR_SET_VALUE(faxMain_, faxMain) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setPostalcode(string postalcode) { DARABONBA_PTR_SET_VALUE(postalcode_, postalcode) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setRegType(int32_t regType) { DARABONBA_PTR_SET_VALUE(regType_, regType) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setRegistrantId(string registrantId) { DARABONBA_PTR_SET_VALUE(registrantId_, registrantId) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setTelArea(string telArea) { DARABONBA_PTR_SET_VALUE(telArea_, telArea) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setTelExt(string telExt) { DARABONBA_PTR_SET_VALUE(telExt_, telExt) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setTelMain(string telMain) { DARABONBA_PTR_SET_VALUE(telMain_, telMain) };
    ...
    inline QueryDomainSpecialBizInfoByDomainResponseBodyModuleDomainSpecialBizContact& setVspContactId(string vspContactId) { DARABONBA_PTR_SET_VALUE(vspContactId_, vspContactId) };
