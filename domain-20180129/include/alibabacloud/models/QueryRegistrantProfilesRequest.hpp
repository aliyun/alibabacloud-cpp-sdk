...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->defaultRegistrantProfile_ == nullptr
        && return this->email_ == nullptr && return this->lang_ == nullptr && return this->pageNum_ == nullptr && return this->pageSize_ == nullptr && return this->realNameStatus_ == nullptr
        && return this->registrantOrganization_ == nullptr && return this->registrantProfileId_ == nullptr && return this->registrantProfileType_ == nullptr && return this->registrantType_ == nullptr && return this->remark_ == nullptr
        && return this->userClientIp_ == nullptr && return this->zhRegistrantOrganization_ == nullptr; };
