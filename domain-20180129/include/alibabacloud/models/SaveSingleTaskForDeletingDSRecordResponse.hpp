...
namespace Models
{
  ...
  public:
    ...
    inline const SaveSingleTaskForDeletingDSRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveSingleTaskForDeletingDSRecordResponseBody) };
    inline SaveSingleTaskForDeletingDSRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveSingleTaskForDeletingDSRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveSingleTaskForDeletingDSRecordResponseBody> body_ {};
  };
