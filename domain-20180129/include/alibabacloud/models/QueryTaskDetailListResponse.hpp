...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTaskDetailListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryTaskDetailListResponseBody) };
    inline QueryTaskDetailListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryTaskDetailListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryTaskDetailListResponseBody> body_ {};
  };
