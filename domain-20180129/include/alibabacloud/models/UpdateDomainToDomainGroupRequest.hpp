...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataSource_ == nullptr
        && this->domainGroupId_ == nullptr && this->domainName_ == nullptr && this->fileToUpload_ == nullptr && this->lang_ == nullptr && this->replace_ == nullptr
    ...
    inline string getFileToUpload() const { DARABONBA_PTR_GET_DEFAULT(fileToUpload_, "") };
