...
namespace Models
{
  ...
  public:
    ...
    inline const ConfirmTransferInEmailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ConfirmTransferInEmailResponseBody) };
    inline ConfirmTransferInEmailResponseBody body() { DARABONBA_PTR_GET(body_, ConfirmTransferInEmailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ConfirmTransferInEmailResponseBody> body_ = nullptr;
  };
