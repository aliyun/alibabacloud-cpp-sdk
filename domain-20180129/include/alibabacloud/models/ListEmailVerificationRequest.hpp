...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->beginCreateTime_ == nullptr
        && return this->email_ == nullptr && return this->endCreateTime_ == nullptr && return this->lang_ == nullptr && return this->pageNum_ == nullptr && return this->pageSize_ == nullptr
        && return this->userClientIp_ == nullptr && return this->verificationStatus_ == nullptr; };
