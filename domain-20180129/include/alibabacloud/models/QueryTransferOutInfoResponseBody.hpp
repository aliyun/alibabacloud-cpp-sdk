...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->email_ == nullptr
        && return this->expirationDate_ == nullptr && return this->pendingRequestDate_ == nullptr && return this->requestId_ == nullptr && return this->resultCode_ == nullptr && return this->resultMsg_ == nullptr
        && return this->status_ == nullptr && return this->transferAuthorizationCodeSendDate_ == nullptr; };
    ...
    inline string pendingRequestDate() const { DARABONBA_PTR_GET_DEFAULT(pendingRequestDate_, "") };
    ...
    inline string transferAuthorizationCodeSendDate() const { DARABONBA_PTR_GET_DEFAULT(transferAuthorizationCodeSendDate_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> pendingRequestDate_ = nullptr;
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<string> resultCode_ = nullptr;
    std::shared_ptr<string> resultMsg_ = nullptr;
    std::shared_ptr<int32_t> status_ = nullptr;
    std::shared_ptr<string> transferAuthorizationCodeSendDate_ = nullptr;
  };
