...
namespace Models
{
  ...
  public:
    ...
    inline const SaveBatchTaskForCreatingOrderTransferResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SaveBatchTaskForCreatingOrderTransferResponseBody) };
    inline SaveBatchTaskForCreatingOrderTransferResponseBody body() { DARABONBA_PTR_GET(body_, SaveBatchTaskForCreatingOrderTransferResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SaveBatchTaskForCreatingOrderTransferResponseBody> body_ = nullptr;
  };
