...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTaskListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryTaskListResponseBody) };
    inline QueryTaskListResponseBody body() { DARABONBA_PTR_GET(body_, QueryTaskListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryTaskListResponseBody> body_ = nullptr;
  };
