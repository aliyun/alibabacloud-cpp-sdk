...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryFailingReasonListForQualificationResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryFailingReasonListForQualificationResponseBodyData>) };
    inline vector<QueryFailingReasonListForQualificationResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryFailingReasonListForQualificationResponseBodyData>) };
    inline QueryFailingReasonListForQualificationResponseBody& setData(const vector<QueryFailingReasonListForQualificationResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryFailingReasonListForQualificationResponseBody& setData(vector<QueryFailingReasonListForQualificationResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<QueryFailingReasonListForQualificationResponseBodyData>> data_ = nullptr;
