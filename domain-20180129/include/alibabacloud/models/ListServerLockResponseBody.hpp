...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListServerLockResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListServerLockResponseBodyData>) };
    inline vector<ListServerLockResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListServerLockResponseBodyData>) };
    inline ListServerLockResponseBody& setData(const vector<ListServerLockResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListServerLockResponseBody& setData(vector<ListServerLockResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListServerLockResponseBodyData>> data_ = nullptr;
