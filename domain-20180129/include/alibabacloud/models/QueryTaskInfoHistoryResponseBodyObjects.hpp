...
#ifndef ALIBABACLOUD_MODELS_QUERYTASKINFOHISTORYRESPONSEBODYOBJECTS_HPP_
#define ALIBABACLOUD_MODELS_QUERYTASKINFOHISTORYRESPONSEBODYOBJECTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryTaskInfoHistoryResponseBodyObjects& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryTaskInfoHistoryResponseBodyObjects& obj) { 
    ...
    QueryTaskInfoHistoryResponseBodyObjects() = default ;
    QueryTaskInfoHistoryResponseBodyObjects(const QueryTaskInfoHistoryResponseBodyObjects &) = default ;
    QueryTaskInfoHistoryResponseBodyObjects(QueryTaskInfoHistoryResponseBodyObjects &&) = default ;
    QueryTaskInfoHistoryResponseBodyObjects(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryTaskInfoHistoryResponseBodyObjects() = default ;
    QueryTaskInfoHistoryResponseBodyObjects& operator=(const QueryTaskInfoHistoryResponseBodyObjects &) = default ;
    QueryTaskInfoHistoryResponseBodyObjects& operator=(QueryTaskInfoHistoryResponseBodyObjects &&) = default ;
    ...
    inline QueryTaskInfoHistoryResponseBodyObjects& setClientip(string clientip) { DARABONBA_PTR_SET_VALUE(clientip_, clientip) };
    ...
    inline QueryTaskInfoHistoryResponseBodyObjects& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline QueryTaskInfoHistoryResponseBodyObjects& setCreateTimeLong(int64_t createTimeLong) { DARABONBA_PTR_SET_VALUE(createTimeLong_, createTimeLong) };
    ...
    inline QueryTaskInfoHistoryResponseBodyObjects& setTaskNo(string taskNo) { DARABONBA_PTR_SET_VALUE(taskNo_, taskNo) };
    ...
    inline QueryTaskInfoHistoryResponseBodyObjects& setTaskNum(int32_t taskNum) { DARABONBA_PTR_SET_VALUE(taskNum_, taskNum) };
    ...
    inline QueryTaskInfoHistoryResponseBodyObjects& setTaskStatus(string taskStatus) { DARABONBA_PTR_SET_VALUE(taskStatus_, taskStatus) };
    ...
    inline QueryTaskInfoHistoryResponseBodyObjects& setTaskStatusCode(int32_t taskStatusCode) { DARABONBA_PTR_SET_VALUE(taskStatusCode_, taskStatusCode) };
    ...
    inline QueryTaskInfoHistoryResponseBodyObjects& setTaskType(string taskType) { DARABONBA_PTR_SET_VALUE(taskType_, taskType) };
    ...
    inline QueryTaskInfoHistoryResponseBodyObjects& setTaskTypeDescription(string taskTypeDescription) { DARABONBA_PTR_SET_VALUE(taskTypeDescription_, taskTypeDescription) };
