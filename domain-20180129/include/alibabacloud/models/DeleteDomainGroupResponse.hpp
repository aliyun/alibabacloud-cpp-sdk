...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDomainGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDomainGroupResponseBody) };
    inline DeleteDomainGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDomainGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDomainGroupResponseBody> body_ {};
  };
