...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        && return this->taskDetailNo_ == nullptr && return this->userClientIp_ == nullptr; };
    ...
    inline const vector<string> & taskDetailNo() const { DARABONBA_PTR_GET_CONST(taskDetailNo_, vector<string>) };
    inline vector<string> taskDetailNo() { DARABONBA_PTR_GET(taskDetailNo_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> taskDetailNo_ = nullptr;
