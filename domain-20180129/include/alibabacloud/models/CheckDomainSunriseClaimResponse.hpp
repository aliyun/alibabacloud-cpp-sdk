...
namespace Models
{
  ...
  public:
    ...
    inline const CheckDomainSunriseClaimResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckDomainSunriseClaimResponseBody) };
    inline CheckDomainSunriseClaimResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckDomainSunriseClaimResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckDomainSunriseClaimResponseBody> body_ {};
  };
