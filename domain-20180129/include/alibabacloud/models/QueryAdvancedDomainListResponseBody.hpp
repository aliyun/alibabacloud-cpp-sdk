...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAdvancedDomainListResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryAdvancedDomainListResponseBody::Data) };
    inline QueryAdvancedDomainListResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryAdvancedDomainListResponseBody::Data) };
    inline QueryAdvancedDomainListResponseBody& setData(const QueryAdvancedDomainListResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAdvancedDomainListResponseBody& setData(QueryAdvancedDomainListResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
