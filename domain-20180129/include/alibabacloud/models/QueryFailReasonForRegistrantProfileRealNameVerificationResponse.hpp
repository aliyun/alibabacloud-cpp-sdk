...
namespace Models
{
  ...
  public:
    ...
    inline const QueryFailReasonForRegistrantProfileRealNameVerificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryFailReasonForRegistrantProfileRealNameVerificationResponseBody) };
    inline QueryFailReasonForRegistrantProfileRealNameVerificationResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryFailReasonForRegistrantProfileRealNameVerificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryFailReasonForRegistrantProfileRealNameVerificationResponseBody> body_ {};
  };
