...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDomainListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryDomainListResponseBody) };
    inline QueryDomainListResponseBody body() { DARABONBA_PTR_GET(body_, QueryDomainListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryDomainListResponseBody> body_ = nullptr;
  };
