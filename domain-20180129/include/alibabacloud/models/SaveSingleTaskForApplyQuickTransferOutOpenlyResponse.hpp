...
namespace Models
{
  ...
  public:
    ...
    inline const SaveSingleTaskForApplyQuickTransferOutOpenlyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveSingleTaskForApplyQuickTransferOutOpenlyResponseBody) };
    inline SaveSingleTaskForApplyQuickTransferOutOpenlyResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveSingleTaskForApplyQuickTransferOutOpenlyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveSingleTaskForApplyQuickTransferOutOpenlyResponseBody> body_ {};
  };
