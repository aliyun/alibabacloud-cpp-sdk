...
namespace Models
{
  ...
  public:
    ...
    inline const SaveTaskForSubmittingDomainDeleteResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SaveTaskForSubmittingDomainDeleteResponseBody) };
    inline SaveTaskForSubmittingDomainDeleteResponseBody body() { DARABONBA_PTR_GET(body_, SaveTaskForSubmittingDomainDeleteResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SaveTaskForSubmittingDomainDeleteResponseBody> body_ = nullptr;
  };
