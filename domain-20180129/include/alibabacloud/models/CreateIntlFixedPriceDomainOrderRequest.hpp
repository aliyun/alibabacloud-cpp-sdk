...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoPay_ == nullptr
        && return this->contactId_ == nullptr && return this->domain_ == nullptr && return this->expectedPrice_ == nullptr; };
    ...
    inline int64_t expectedPrice() const { DARABONBA_PTR_GET_DEFAULT(expectedPrice_, 0L) };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> expectedPrice_ = nullptr;
  };
