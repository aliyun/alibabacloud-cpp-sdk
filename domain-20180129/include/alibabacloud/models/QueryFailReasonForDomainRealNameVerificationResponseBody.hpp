...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryFailReasonForDomainRealNameVerificationResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryFailReasonForDomainRealNameVerificationResponseBodyData>) };
    inline vector<QueryFailReasonForDomainRealNameVerificationResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryFailReasonForDomainRealNameVerificationResponseBodyData>) };
    inline QueryFailReasonForDomainRealNameVerificationResponseBody& setData(const vector<QueryFailReasonForDomainRealNameVerificationResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryFailReasonForDomainRealNameVerificationResponseBody& setData(vector<QueryFailReasonForDomainRealNameVerificationResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<QueryFailReasonForDomainRealNameVerificationResponseBodyData>> data_ = nullptr;
