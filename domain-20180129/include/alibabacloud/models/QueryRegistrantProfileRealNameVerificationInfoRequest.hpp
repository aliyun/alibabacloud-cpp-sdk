...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->fetchImage_ == nullptr
        && return this->lang_ == nullptr && return this->registrantProfileId_ == nullptr && return this->userClientIp_ == nullptr; };
    ...
    inline bool fetchImage() const { DARABONBA_PTR_GET_DEFAULT(fetchImage_, false) };
  ...
  protected:
    std::shared_ptr<bool> fetchImage_ = nullptr;
