...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTaskInfoHistoryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryTaskInfoHistoryResponseBody) };
    inline QueryTaskInfoHistoryResponseBody body() { DARABONBA_PTR_GET(body_, QueryTaskInfoHistoryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryTaskInfoHistoryResponseBody> body_ = nullptr;
  };
