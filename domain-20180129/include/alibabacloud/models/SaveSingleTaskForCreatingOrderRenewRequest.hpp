...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->couponNo_ == nullptr
        && return this->currentExpirationDate_ == nullptr && return this->domainName_ == nullptr && return this->lang_ == nullptr && return this->promotionNo_ == nullptr && return this->subscriptionDuration_ == nullptr
        && return this->useCoupon_ == nullptr && return this->usePromotion_ == nullptr && return this->userClientIp_ == nullptr; };
