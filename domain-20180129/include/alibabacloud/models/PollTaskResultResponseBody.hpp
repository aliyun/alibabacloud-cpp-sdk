...
namespace Models
{
  ...
  public:
    ...
    inline const PollTaskResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, PollTaskResultResponseBodyData) };
    inline PollTaskResultResponseBodyData data() { DARABONBA_PTR_GET(data_, PollTaskResultResponseBodyData) };
    inline PollTaskResultResponseBody& setData(const PollTaskResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PollTaskResultResponseBody& setData(PollTaskResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<PollTaskResultResponseBodyData> data_ = nullptr;
