...
namespace Models
{
  ...
  public:
    ...
    inline const SaveBatchTaskForGenerateDomainCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveBatchTaskForGenerateDomainCertificateResponseBody) };
    inline SaveBatchTaskForGenerateDomainCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveBatchTaskForGenerateDomainCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveBatchTaskForGenerateDomainCertificateResponseBody> body_ {};
  };
