...
namespace Models
{
  ...
  public:
    ...
    inline const QueryContactInfoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryContactInfoResponseBody) };
    inline QueryContactInfoResponseBody body() { DARABONBA_PTR_GET(body_, QueryContactInfoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryContactInfoResponseBody> body_ = nullptr;
  };
