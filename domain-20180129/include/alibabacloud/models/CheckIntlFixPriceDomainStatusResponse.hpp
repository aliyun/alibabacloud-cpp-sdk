...
namespace Models
{
  ...
  public:
    ...
    inline const CheckIntlFixPriceDomainStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckIntlFixPriceDomainStatusResponseBody) };
    inline CheckIntlFixPriceDomainStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckIntlFixPriceDomainStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckIntlFixPriceDomainStatusResponseBody> body_ {};
  };
