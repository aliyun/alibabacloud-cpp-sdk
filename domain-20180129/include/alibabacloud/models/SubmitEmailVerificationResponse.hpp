...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitEmailVerificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitEmailVerificationResponseBody) };
    inline SubmitEmailVerificationResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitEmailVerificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitEmailVerificationResponseBody> body_ {};
  };
