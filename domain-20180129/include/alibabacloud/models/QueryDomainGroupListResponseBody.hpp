...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDomainGroupListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryDomainGroupListResponseBodyData) };
    inline QueryDomainGroupListResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryDomainGroupListResponseBodyData) };
    inline QueryDomainGroupListResponseBody& setData(const QueryDomainGroupListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryDomainGroupListResponseBody& setData(QueryDomainGroupListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<QueryDomainGroupListResponseBodyData> data_ = nullptr;
