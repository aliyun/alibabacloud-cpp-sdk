...
namespace Models
{
  ...
  public:
    ...
    inline const RegistrantProfileRealNameVerificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RegistrantProfileRealNameVerificationResponseBody) };
    inline RegistrantProfileRealNameVerificationResponseBody getBody() { DARABONBA_PTR_GET(body_, RegistrantProfileRealNameVerificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RegistrantProfileRealNameVerificationResponseBody> body_ {};
  };
