...
namespace Models
{
  ...
  public:
    ...
    inline const ResetQualificationVerificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResetQualificationVerificationResponseBody) };
    inline ResetQualificationVerificationResponseBody getBody() { DARABONBA_PTR_GET(body_, ResetQualificationVerificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResetQualificationVerificationResponseBody> body_ {};
  };
