...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListEmailVerificationResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListEmailVerificationResponseBodyData>) };
    inline vector<ListEmailVerificationResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListEmailVerificationResponseBodyData>) };
    inline ListEmailVerificationResponseBody& setData(const vector<ListEmailVerificationResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEmailVerificationResponseBody& setData(vector<ListEmailVerificationResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListEmailVerificationResponseBodyData>> data_ = nullptr;
