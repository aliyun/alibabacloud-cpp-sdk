...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->suffixList_ == nullptr; };
    ...
    inline const QueryDomainSuffixResponseBodySuffixList & suffixList() const { DARABONBA_PTR_GET_CONST(suffixList_, QueryDomainSuffixResponseBodySuffixList) };
    inline QueryDomainSuffixResponseBodySuffixList suffixList() { DARABONBA_PTR_GET(suffixList_, QueryDomainSuffixResponseBodySuffixList) };
    inline QueryDomainSuffixResponseBody& setSuffixList(const QueryDomainSuffixResponseBodySuffixList & suffixList) { DARABONBA_PTR_SET_VALUE(suffixList_, suffixList) };
    inline QueryDomainSuffixResponseBody& setSuffixList(QueryDomainSuffixResponseBodySuffixList && suffixList) { DARABONBA_PTR_SET_RVALUE(suffixList_, suffixList) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<QueryDomainSuffixResponseBodySuffixList> suffixList_ = nullptr;
  };
