...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryOperationAuditInfoListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryOperationAuditInfoListResponseBodyData>) };
    inline vector<QueryOperationAuditInfoListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryOperationAuditInfoListResponseBodyData>) };
    inline QueryOperationAuditInfoListResponseBody& setData(const vector<QueryOperationAuditInfoListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryOperationAuditInfoListResponseBody& setData(vector<QueryOperationAuditInfoListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryOperationAuditInfoListResponseBodyData>> data_ = nullptr;
