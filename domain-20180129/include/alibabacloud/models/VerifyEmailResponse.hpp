...
namespace Models
{
  ...
  public:
    ...
    inline const VerifyEmailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, VerifyEmailResponseBody) };
    inline VerifyEmailResponseBody body() { DARABONBA_PTR_GET(body_, VerifyEmailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<VerifyEmailResponseBody> body_ = nullptr;
  };
