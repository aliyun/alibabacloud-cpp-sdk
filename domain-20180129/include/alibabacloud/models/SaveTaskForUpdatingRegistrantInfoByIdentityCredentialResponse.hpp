...
namespace Models
{
  ...
  public:
    ...
    inline const SaveTaskForUpdatingRegistrantInfoByIdentityCredentialResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveTaskForUpdatingRegistrantInfoByIdentityCredentialResponseBody) };
    inline SaveTaskForUpdatingRegistrantInfoByIdentityCredentialResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveTaskForUpdatingRegistrantInfoByIdentityCredentialResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveTaskForUpdatingRegistrantInfoByIdentityCredentialResponseBody> body_ {};
  };
