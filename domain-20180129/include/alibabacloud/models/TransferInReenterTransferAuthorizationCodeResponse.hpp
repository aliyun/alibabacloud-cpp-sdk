...
namespace Models
{
  ...
  public:
    ...
    inline const TransferInReenterTransferAuthorizationCodeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, TransferInReenterTransferAuthorizationCodeResponseBody) };
    inline TransferInReenterTransferAuthorizationCodeResponseBody body() { DARABONBA_PTR_GET(body_, TransferInReenterTransferAuthorizationCodeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<TransferInReenterTransferAuthorizationCodeResponseBody> body_ = nullptr;
  };
