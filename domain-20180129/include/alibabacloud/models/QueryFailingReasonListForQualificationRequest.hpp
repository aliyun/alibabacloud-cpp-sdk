...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instanceId_ == nullptr
        && return this->lang_ == nullptr && return this->limit_ == nullptr && return this->qualificationType_ == nullptr && return this->userClientIp_ == nullptr; };
    ...
    inline string qualificationType() const { DARABONBA_PTR_GET_DEFAULT(qualificationType_, "") };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<string> qualificationType_ = nullptr;
