...
namespace Models
{
  ...
  public:
    ...
    inline const CancelDomainVerificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelDomainVerificationResponseBody) };
    inline CancelDomainVerificationResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelDomainVerificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelDomainVerificationResponseBody> body_ {};
  };
