...
namespace Models
{
  ...
  public:
    ...
    inline const SaveBatchTaskForReserveDropListDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveBatchTaskForReserveDropListDomainResponseBody) };
    inline SaveBatchTaskForReserveDropListDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveBatchTaskForReserveDropListDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveBatchTaskForReserveDropListDomainResponseBody> body_ {};
  };
