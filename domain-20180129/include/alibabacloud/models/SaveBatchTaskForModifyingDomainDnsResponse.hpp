...
namespace Models
{
  ...
  public:
    ...
    inline const SaveBatchTaskForModifyingDomainDnsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveBatchTaskForModifyingDomainDnsResponseBody) };
    inline SaveBatchTaskForModifyingDomainDnsResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveBatchTaskForModifyingDomainDnsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveBatchTaskForModifyingDomainDnsResponseBody> body_ {};
  };
