...
namespace Models
{
  ...
  public:
    ...
    inline const CheckProcessingServerLockApplyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckProcessingServerLockApplyResponseBody) };
    inline CheckProcessingServerLockApplyResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckProcessingServerLockApplyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckProcessingServerLockApplyResponseBody> body_ {};
  };
