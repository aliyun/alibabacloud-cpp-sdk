...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->email_ == nullptr
        && return this->lang_ == nullptr && return this->sendIfExist_ == nullptr && return this->userClientIp_ == nullptr; };
    ...
    inline bool sendIfExist() const { DARABONBA_PTR_GET_DEFAULT(sendIfExist_, false) };
  ...
  protected:
    ...
    std::shared_ptr<bool> sendIfExist_ = nullptr;
