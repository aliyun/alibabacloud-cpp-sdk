...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTaskListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryTaskListResponseBodyData) };
    inline QueryTaskListResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryTaskListResponseBodyData) };
    inline QueryTaskListResponseBody& setData(const QueryTaskListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryTaskListResponseBody& setData(QueryTaskListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryTaskListResponseBodyData> data_ = nullptr;
