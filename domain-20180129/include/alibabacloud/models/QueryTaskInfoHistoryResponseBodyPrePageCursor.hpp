...
#ifndef ALIBABACLOUD_MODELS_QUERYTASKINFOHISTORYRESPONSEBODYPREPAGECURSOR_HPP_
#define ALIBABACLOUD_MODELS_QUERYTASKINFOHISTORYRESPONSEBODYPREPAGECURSOR_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryTaskInfoHistoryResponseBodyPrePageCursor& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryTaskInfoHistoryResponseBodyPrePageCursor& obj) { 
    ...
    QueryTaskInfoHistoryResponseBodyPrePageCursor() = default ;
    QueryTaskInfoHistoryResponseBodyPrePageCursor(const QueryTaskInfoHistoryResponseBodyPrePageCursor &) = default ;
    QueryTaskInfoHistoryResponseBodyPrePageCursor(QueryTaskInfoHistoryResponseBodyPrePageCursor &&) = default ;
    QueryTaskInfoHistoryResponseBodyPrePageCursor(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryTaskInfoHistoryResponseBodyPrePageCursor() = default ;
    QueryTaskInfoHistoryResponseBodyPrePageCursor& operator=(const QueryTaskInfoHistoryResponseBodyPrePageCursor &) = default ;
    QueryTaskInfoHistoryResponseBodyPrePageCursor& operator=(QueryTaskInfoHistoryResponseBodyPrePageCursor &&) = default ;
    ...
    inline QueryTaskInfoHistoryResponseBodyPrePageCursor& setClientip(string clientip) { DARABONBA_PTR_SET_VALUE(clientip_, clientip) };
    ...
    inline QueryTaskInfoHistoryResponseBodyPrePageCursor& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline QueryTaskInfoHistoryResponseBodyPrePageCursor& setCreateTimeLong(int64_t createTimeLong) { DARABONBA_PTR_SET_VALUE(createTimeLong_, createTimeLong) };
    ...
    inline QueryTaskInfoHistoryResponseBodyPrePageCursor& setTaskNo(string taskNo) { DARABONBA_PTR_SET_VALUE(taskNo_, taskNo) };
    ...
    inline QueryTaskInfoHistoryResponseBodyPrePageCursor& setTaskNum(int32_t taskNum) { DARABONBA_PTR_SET_VALUE(taskNum_, taskNum) };
    ...
    inline QueryTaskInfoHistoryResponseBodyPrePageCursor& setTaskStatus(string taskStatus) { DARABONBA_PTR_SET_VALUE(taskStatus_, taskStatus) };
    ...
    inline QueryTaskInfoHistoryResponseBodyPrePageCursor& setTaskStatusCode(int32_t taskStatusCode) { DARABONBA_PTR_SET_VALUE(taskStatusCode_, taskStatusCode) };
    ...
    inline QueryTaskInfoHistoryResponseBodyPrePageCursor& setTaskType(string taskType) { DARABONBA_PTR_SET_VALUE(taskType_, taskType) };
    ...
    inline QueryTaskInfoHistoryResponseBodyPrePageCursor& setTaskTypeDescription(string taskTypeDescription) { DARABONBA_PTR_SET_VALUE(taskTypeDescription_, taskTypeDescription) };
