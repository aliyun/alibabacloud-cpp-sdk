...
namespace Models
{
  ...
  public:
    ...
    inline const SaveSingleTaskForCancelingTransferOutResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveSingleTaskForCancelingTransferOutResponseBody) };
    inline SaveSingleTaskForCancelingTransferOutResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveSingleTaskForCancelingTransferOutResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveSingleTaskForCancelingTransferOutResponseBody> body_ {};
  };
