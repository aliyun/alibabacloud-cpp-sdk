...
#ifndef ALIBABACLOUD_MODELS_QUERYOPERATIONAUDITINFODETAILRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYOPERATIONAUDITINFODETAILRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryOperationAuditInfoDetailResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryOperationAuditInfoDetailResponseBody& obj) { 
    ...
    QueryOperationAuditInfoDetailResponseBody() = default ;
    QueryOperationAuditInfoDetailResponseBody(const QueryOperationAuditInfoDetailResponseBody &) = default ;
    QueryOperationAuditInfoDetailResponseBody(QueryOperationAuditInfoDetailResponseBody &&) = default ;
    QueryOperationAuditInfoDetailResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryOperationAuditInfoDetailResponseBody() = default ;
    QueryOperationAuditInfoDetailResponseBody& operator=(const QueryOperationAuditInfoDetailResponseBody &) = default ;
    QueryOperationAuditInfoDetailResponseBody& operator=(QueryOperationAuditInfoDetailResponseBody &&) = default ;
