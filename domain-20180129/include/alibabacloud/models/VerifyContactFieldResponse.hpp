...
namespace Models
{
  ...
  public:
    ...
    inline const VerifyContactFieldResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, VerifyContactFieldResponseBody) };
    inline VerifyContactFieldResponseBody body() { DARABONBA_PTR_GET(body_, VerifyContactFieldResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<VerifyContactFieldResponseBody> body_ = nullptr;
  };
