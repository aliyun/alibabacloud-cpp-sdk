...
#ifndef ALIBABACLOUD_MODELS_QUERYTASKINFOHISTORYRESPONSEBODYNEXTPAGECURSOR_HPP_
#define ALIBABACLOUD_MODELS_QUERYTASKINFOHISTORYRESPONSEBODYNEXTPAGECURSOR_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryTaskInfoHistoryResponseBodyNextPageCursor& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryTaskInfoHistoryResponseBodyNextPageCursor& obj) { 
    ...
    QueryTaskInfoHistoryResponseBodyNextPageCursor() = default ;
    QueryTaskInfoHistoryResponseBodyNextPageCursor(const QueryTaskInfoHistoryResponseBodyNextPageCursor &) = default ;
    QueryTaskInfoHistoryResponseBodyNextPageCursor(QueryTaskInfoHistoryResponseBodyNextPageCursor &&) = default ;
    QueryTaskInfoHistoryResponseBodyNextPageCursor(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryTaskInfoHistoryResponseBodyNextPageCursor() = default ;
    QueryTaskInfoHistoryResponseBodyNextPageCursor& operator=(const QueryTaskInfoHistoryResponseBodyNextPageCursor &) = default ;
    QueryTaskInfoHistoryResponseBodyNextPageCursor& operator=(QueryTaskInfoHistoryResponseBodyNextPageCursor &&) = default ;
    ...
    inline QueryTaskInfoHistoryResponseBodyNextPageCursor& setClientip(string clientip) { DARABONBA_PTR_SET_VALUE(clientip_, clientip) };
    ...
    inline QueryTaskInfoHistoryResponseBodyNextPageCursor& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline QueryTaskInfoHistoryResponseBodyNextPageCursor& setCreateTimeLong(int64_t createTimeLong) { DARABONBA_PTR_SET_VALUE(createTimeLong_, createTimeLong) };
    ...
    inline QueryTaskInfoHistoryResponseBodyNextPageCursor& setTaskNo(string taskNo) { DARABONBA_PTR_SET_VALUE(taskNo_, taskNo) };
    ...
    inline QueryTaskInfoHistoryResponseBodyNextPageCursor& setTaskNum(int32_t taskNum) { DARABONBA_PTR_SET_VALUE(taskNum_, taskNum) };
    ...
    inline QueryTaskInfoHistoryResponseBodyNextPageCursor& setTaskStatus(string taskStatus) { DARABONBA_PTR_SET_VALUE(taskStatus_, taskStatus) };
    ...
    inline QueryTaskInfoHistoryResponseBodyNextPageCursor& setTaskStatusCode(int32_t taskStatusCode) { DARABONBA_PTR_SET_VALUE(taskStatusCode_, taskStatusCode) };
    ...
    inline QueryTaskInfoHistoryResponseBodyNextPageCursor& setTaskType(string taskType) { DARABONBA_PTR_SET_VALUE(taskType_, taskType) };
    ...
    inline QueryTaskInfoHistoryResponseBodyNextPageCursor& setTaskTypeDescription(string taskTypeDescription) { DARABONBA_PTR_SET_VALUE(taskTypeDescription_, taskTypeDescription) };
