...
namespace Models
{
  ...
  public:
    ...
    inline const SaveRegistrantProfileRealNameVerificationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SaveRegistrantProfileRealNameVerificationResponseBody) };
    inline SaveRegistrantProfileRealNameVerificationResponseBody body() { DARABONBA_PTR_GET(body_, SaveRegistrantProfileRealNameVerificationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SaveRegistrantProfileRealNameVerificationResponseBody> body_ = nullptr;
  };
