...
namespace Models
{
  ...
  public:
    ...
    inline const SaveDomainGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SaveDomainGroupResponseBody) };
    inline SaveDomainGroupResponseBody body() { DARABONBA_PTR_GET(body_, SaveDomainGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SaveDomainGroupResponseBody> body_ = nullptr;
  };
