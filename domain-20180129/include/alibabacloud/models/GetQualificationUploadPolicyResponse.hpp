...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualificationUploadPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQualificationUploadPolicyResponseBody) };
    inline GetQualificationUploadPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQualificationUploadPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQualificationUploadPolicyResponseBody> body_ {};
  };
