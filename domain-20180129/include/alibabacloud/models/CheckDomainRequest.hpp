...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->domainName_ == nullptr
        && return this->feeCommand_ == nullptr && return this->feeCurrency_ == nullptr && return this->feePeriod_ == nullptr && return this->lang_ == nullptr; };
    ...
    inline string feeCommand() const { DARABONBA_PTR_GET_DEFAULT(feeCommand_, "") };
    ...
    inline string feeCurrency() const { DARABONBA_PTR_GET_DEFAULT(feeCurrency_, "") };
    ...
    inline int32_t feePeriod() const { DARABONBA_PTR_GET_DEFAULT(feePeriod_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<string> feeCommand_ = nullptr;
    std::shared_ptr<string> feeCurrency_ = nullptr;
    std::shared_ptr<int32_t> feePeriod_ = nullptr;
