...
namespace Models
{
  ...
  public:
    ...
    inline const CheckMaxYearOfServerLockResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckMaxYearOfServerLockResponseBody) };
    inline CheckMaxYearOfServerLockResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckMaxYearOfServerLockResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckMaxYearOfServerLockResponseBody> body_ {};
  };
