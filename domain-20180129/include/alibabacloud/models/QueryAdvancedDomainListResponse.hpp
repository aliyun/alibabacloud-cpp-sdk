...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAdvancedDomainListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryAdvancedDomainListResponseBody) };
    inline QueryAdvancedDomainListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryAdvancedDomainListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryAdvancedDomainListResponseBody> body_ {};
  };
