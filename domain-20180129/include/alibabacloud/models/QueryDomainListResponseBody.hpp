...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDomainListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryDomainListResponseBodyData) };
    inline QueryDomainListResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryDomainListResponseBodyData) };
    inline QueryDomainListResponseBody& setData(const QueryDomainListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryDomainListResponseBody& setData(QueryDomainListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The domain names.
    std::shared_ptr<QueryDomainListResponseBodyData> data_ = nullptr;
