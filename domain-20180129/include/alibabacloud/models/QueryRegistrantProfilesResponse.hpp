...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRegistrantProfilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryRegistrantProfilesResponseBody) };
    inline QueryRegistrantProfilesResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryRegistrantProfilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryRegistrantProfilesResponseBody> body_ {};
  };
