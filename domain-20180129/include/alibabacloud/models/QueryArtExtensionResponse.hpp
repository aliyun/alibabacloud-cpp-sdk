...
namespace Models
{
  ...
  public:
    ...
    inline const QueryArtExtensionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryArtExtensionResponseBody) };
    inline QueryArtExtensionResponseBody body() { DARABONBA_PTR_GET(body_, QueryArtExtensionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryArtExtensionResponseBody> body_ = nullptr;
  };
