...
#ifndef ALIBABACLOUD_MODELS_CREATETEAMINPUT_HPP_
#define ALIBABACLOUD_MODELS_CREATETEAMINPUT_HPP_
...
namespace Models
{
  class CreateTeamInput : public Darabonba::Model {
  public:
    ...
    CreateTeamInput() = default ;
    CreateTeamInput(const CreateTeamInput &) = default ;
    CreateTeamInput(CreateTeamInput &&) = default ;
    CreateTeamInput(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTeamInput() = default ;
    CreateTeamInput& operator=(const CreateTeamInput &) = default ;
    CreateTeamInput& operator=(CreateTeamInput &&) = default ;
    ...
    inline CreateTeamInput& setResourceGroupID(string resourceGroupID) { DARABONBA_PTR_SET_VALUE(resourceGroupID_, resourceGroupID) };
    ...
    inline CreateTeamInput& setTeamName(string teamName) { DARABONBA_PTR_SET_VALUE(teamName_, teamName) };
