...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && this->nextToken_ == nullptr && this->resourceGroupID_ == nullptr && this->status_ == nullptr && this->storageClass_ == nullptr && this->teamID_ == nullptr
        && this->userID_ == nullptr && this->volumeName_ == nullptr; };
    ...
    inline ListVolumesRequest& setStorageClass(string storageClass) { DARABONBA_PTR_SET_VALUE(storageClass_, storageClass) };
