...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agenticBucketVolumeConfig_ == nullptr
        && this->agenticFSVolumeConfig_ == nullptr && this->juiceFSVolumeConfig_ == nullptr && this->mountConfig_ == nullptr && this->ossVolumeConfig_ == nullptr; };
    ...
    inline UpdateVolumeInput& setAgenticBucketVolumeConfig(const AgenticBucketVolumeConfig & agenticBucketVolumeConfig) { DARABONBA_PTR_SET_VALUE(agenticBucketVolumeConfig_, agenticBucketVolumeConfig) };
    inline UpdateVolumeInput& setAgenticBucketVolumeConfig(AgenticBucketVolumeConfig && agenticBucketVolumeConfig) { DARABONBA_PTR_SET_RVALUE(agenticBucketVolumeConfig_, agenticBucketVolumeConfig) };
    ...
    inline const UpdateVolumeInput::AgenticFSVolumeConfig & getAgenticFSVolumeConfig() const { DARABONBA_PTR_GET_CONST(agenticFSVolumeConfig_, UpdateVolumeInput::AgenticFSVolumeConfig) };
    inline UpdateVolumeInput::AgenticFSVolumeConfig getAgenticFSVolumeConfig() { DARABONBA_PTR_GET(agenticFSVolumeConfig_, UpdateVolumeInput::AgenticFSVolumeConfig) };
    inline UpdateVolumeInput& setAgenticFSVolumeConfig(const UpdateVolumeInput::AgenticFSVolumeConfig & agenticFSVolumeConfig) { DARABONBA_PTR_SET_VALUE(agenticFSVolumeConfig_, agenticFSVolumeConfig) };
    inline UpdateVolumeInput& setAgenticFSVolumeConfig(UpdateVolumeInput::AgenticFSVolumeConfig && agenticFSVolumeConfig) { DARABONBA_PTR_SET_RVALUE(agenticFSVolumeConfig_, agenticFSVolumeConfig) };
    ...
    inline UpdateVolumeInput& setJuiceFSVolumeConfig(const JuiceFSVolumeConfig & juiceFSVolumeConfig) { DARABONBA_PTR_SET_VALUE(juiceFSVolumeConfig_, juiceFSVolumeConfig) };
    inline UpdateVolumeInput& setJuiceFSVolumeConfig(JuiceFSVolumeConfig && juiceFSVolumeConfig) { DARABONBA_PTR_SET_RVALUE(juiceFSVolumeConfig_, juiceFSVolumeConfig) };
    ...
    inline const UpdateVolumeInput::MountConfig & getMountConfig() const { DARABONBA_PTR_GET_CONST(mountConfig_, UpdateVolumeInput::MountConfig) };
    inline UpdateVolumeInput::MountConfig getMountConfig() { DARABONBA_PTR_GET(mountConfig_, UpdateVolumeInput::MountConfig) };
    inline UpdateVolumeInput& setMountConfig(const UpdateVolumeInput::MountConfig & mountConfig) { DARABONBA_PTR_SET_VALUE(mountConfig_, mountConfig) };
    inline UpdateVolumeInput& setMountConfig(UpdateVolumeInput::MountConfig && mountConfig) { DARABONBA_PTR_SET_RVALUE(mountConfig_, mountConfig) };
    ...
    inline UpdateVolumeInput& setOssVolumeConfig(const OSSVolumeConfig & ossVolumeConfig) { DARABONBA_PTR_SET_VALUE(ossVolumeConfig_, ossVolumeConfig) };
    inline UpdateVolumeInput& setOssVolumeConfig(OSSVolumeConfig && ossVolumeConfig) { DARABONBA_PTR_SET_RVALUE(ossVolumeConfig_, ossVolumeConfig) };


  protected:
    shared_ptr<AgenticBucketVolumeConfig> agenticBucketVolumeConfig_ {};
    shared_ptr<UpdateVolumeInput::AgenticFSVolumeConfig> agenticFSVolumeConfig_ {};
    shared_ptr<JuiceFSVolumeConfig> juiceFSVolumeConfig_ {};
    shared_ptr<UpdateVolumeInput::MountConfig> mountConfig_ {};
