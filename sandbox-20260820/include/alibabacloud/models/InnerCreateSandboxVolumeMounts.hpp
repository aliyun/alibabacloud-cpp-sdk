...
#ifndef ALIBABACLOUD_MODELS_INNERCREATESANDBOXVOLUMEMOUNTS_HPP_
#define ALIBABACLOUD_MODELS_INNERCREATESANDBOXVOLUMEMOUNTS_HPP_
...
namespace Models
{
  class InnerCreateSandboxVolumeMounts : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const InnerCreateSandboxVolumeMounts& obj) { 
      DARABONBA_PTR_TO_JSON(agenticFs, agenticFs_);
      DARABONBA_PTR_TO_JSON(named, named_);
      DARABONBA_PTR_TO_JSON(oss, oss_);
    };
    friend void from_json(const Darabonba::Json& j, InnerCreateSandboxVolumeMounts& obj) { 
      DARABONBA_PTR_FROM_JSON(agenticFs, agenticFs_);
      DARABONBA_PTR_FROM_JSON(named, named_);
      DARABONBA_PTR_FROM_JSON(oss, oss_);
    };
    InnerCreateSandboxVolumeMounts() = default ;
    InnerCreateSandboxVolumeMounts(const InnerCreateSandboxVolumeMounts &) = default ;
    InnerCreateSandboxVolumeMounts(InnerCreateSandboxVolumeMounts &&) = default ;
    InnerCreateSandboxVolumeMounts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InnerCreateSandboxVolumeMounts() = default ;
    InnerCreateSandboxVolumeMounts& operator=(const InnerCreateSandboxVolumeMounts &) = default ;
    InnerCreateSandboxVolumeMounts& operator=(InnerCreateSandboxVolumeMounts &&) = default ;
    ...
    inline const InnerCreateSandboxVolumeMounts::AgenticFs & getAgenticFs() const { DARABONBA_PTR_GET_CONST(agenticFs_, InnerCreateSandboxVolumeMounts::AgenticFs) };
    inline InnerCreateSandboxVolumeMounts::AgenticFs getAgenticFs() { DARABONBA_PTR_GET(agenticFs_, InnerCreateSandboxVolumeMounts::AgenticFs) };
    inline InnerCreateSandboxVolumeMounts& setAgenticFs(const InnerCreateSandboxVolumeMounts::AgenticFs & agenticFs) { DARABONBA_PTR_SET_VALUE(agenticFs_, agenticFs) };
    inline InnerCreateSandboxVolumeMounts& setAgenticFs(InnerCreateSandboxVolumeMounts::AgenticFs && agenticFs) { DARABONBA_PTR_SET_RVALUE(agenticFs_, agenticFs) };


    // named Field Functions 
    bool hasNamed() const { return this->named_ != nullptr;};
    void deleteNamed() { this->named_ = nullptr;};
    inline const InnerCreateSandboxVolumeMounts::Named & getNamed() const { DARABONBA_PTR_GET_CONST(named_, InnerCreateSandboxVolumeMounts::Named) };
    inline InnerCreateSandboxVolumeMounts::Named getNamed() { DARABONBA_PTR_GET(named_, InnerCreateSandboxVolumeMounts::Named) };
    inline InnerCreateSandboxVolumeMounts& setNamed(const InnerCreateSandboxVolumeMounts::Named & named) { DARABONBA_PTR_SET_VALUE(named_, named) };
    inline InnerCreateSandboxVolumeMounts& setNamed(InnerCreateSandboxVolumeMounts::Named && named) { DARABONBA_PTR_SET_RVALUE(named_, named) };


    // oss Field Functions 
    bool hasOss() const { return this->oss_ != nullptr;};
    void deleteOss() { this->oss_ = nullptr;};
    inline const InnerCreateSandboxVolumeMounts::Oss & getOss() const { DARABONBA_PTR_GET_CONST(oss_, InnerCreateSandboxVolumeMounts::Oss) };
    inline InnerCreateSandboxVolumeMounts::Oss getOss() { DARABONBA_PTR_GET(oss_, InnerCreateSandboxVolumeMounts::Oss) };
    inline InnerCreateSandboxVolumeMounts& setOss(const InnerCreateSandboxVolumeMounts::Oss & oss) { DARABONBA_PTR_SET_VALUE(oss_, oss) };
    inline InnerCreateSandboxVolumeMounts& setOss(InnerCreateSandboxVolumeMounts::Oss && oss) { DARABONBA_PTR_SET_RVALUE(oss_, oss) };


  protected:
    shared_ptr<InnerCreateSandboxVolumeMounts::AgenticFs> agenticFs_ {};
    shared_ptr<InnerCreateSandboxVolumeMounts::Named> named_ {};
    shared_ptr<InnerCreateSandboxVolumeMounts::Oss> oss_ {};
  };
