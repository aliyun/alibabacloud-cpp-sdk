...
#include <alibabacloud/models/VolumeMountConfig.hpp>
...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agenticBucketVolumeConfig_ == nullptr
        && this->agenticFSVolumeConfig_ == nullptr && this->createdAt_ == nullptr && this->juiceFSVolumeConfig_ == nullptr && this->mountConfig_ == nullptr && this->ossVolumeConfig_ == nullptr
        && this->resourceGroupID_ == nullptr && this->status_ == nullptr && this->statusReason_ == nullptr && this->storageClass_ == nullptr && this->teamID_ == nullptr
        && this->updatedAt_ == nullptr && this->userID_ == nullptr && this->volumeID_ == nullptr && this->volumeName_ == nullptr; };
    ...
    inline E2BVolume& setJuiceFSVolumeConfig(const JuiceFSVolumeConfig & juiceFSVolumeConfig) { DARABONBA_PTR_SET_VALUE(juiceFSVolumeConfig_, juiceFSVolumeConfig) };
    inline E2BVolume& setJuiceFSVolumeConfig(JuiceFSVolumeConfig && juiceFSVolumeConfig) { DARABONBA_PTR_SET_RVALUE(juiceFSVolumeConfig_, juiceFSVolumeConfig) };
    ...
    inline const VolumeMountConfig & getMountConfig() const { DARABONBA_PTR_GET_CONST(mountConfig_, VolumeMountConfig) };
    inline VolumeMountConfig getMountConfig() { DARABONBA_PTR_GET(mountConfig_, VolumeMountConfig) };
    inline E2BVolume& setMountConfig(const VolumeMountConfig & mountConfig) { DARABONBA_PTR_SET_VALUE(mountConfig_, mountConfig) };
    inline E2BVolume& setMountConfig(VolumeMountConfig && mountConfig) { DARABONBA_PTR_SET_RVALUE(mountConfig_, mountConfig) };
  ...
  protected:
    ...
    shared_ptr<VolumeMountConfig> mountConfig_ {};
