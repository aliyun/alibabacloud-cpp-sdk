...
namespace Models
{
  ...
  public:
    ...
    inline UpdateQuotaRequest& setBody(const Quota & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateQuotaRequest& setBody(Quota && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
