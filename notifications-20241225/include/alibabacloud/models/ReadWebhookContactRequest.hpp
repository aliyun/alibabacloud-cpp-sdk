...
#ifndef ALIBABACLOUD_MODELS_READWEBHOOKCONTACTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_READWEBHOOKCONTACTREQUEST_HPP_
...
namespace Models
{
  class ReadWebhookContactRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ReadWebhookContactRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadWebhookContactRequest& obj) { 
    ...
    ReadWebhookContactRequest() = default ;
    ReadWebhookContactRequest(const ReadWebhookContactRequest &) = default ;
    ReadWebhookContactRequest(ReadWebhookContactRequest &&) = default ;
    ReadWebhookContactRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadWebhookContactRequest() = default ;
    ReadWebhookContactRequest& operator=(const ReadWebhookContactRequest &) = default ;
    ReadWebhookContactRequest& operator=(ReadWebhookContactRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && this->appName_ == nullptr && this->bizName_ == nullptr && this->callerProtocol_ == nullptr && this->clientSource_ == nullptr && this->contactId_ == nullptr
    ...
    inline ReadWebhookContactRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline ReadWebhookContactRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ReadWebhookContactRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline ReadWebhookContactRequest& setCallerProtocol(string callerProtocol) { DARABONBA_PTR_SET_VALUE(callerProtocol_, callerProtocol) };
    ...
    inline ReadWebhookContactRequest& setClientSource(string clientSource) { DARABONBA_PTR_SET_VALUE(clientSource_, clientSource) };
    ...
    inline ReadWebhookContactRequest& setContactId(int64_t contactId) { DARABONBA_PTR_SET_VALUE(contactId_, contactId) };
    ...
    inline ReadWebhookContactRequest& setCookies(string cookies) { DARABONBA_PTR_SET_VALUE(cookies_, cookies) };
    ...
    inline ReadWebhookContactRequest& setSrcUrl(string srcUrl) { DARABONBA_PTR_SET_VALUE(srcUrl_, srcUrl) };
    ...
    inline ReadWebhookContactRequest& setTenantCode(string tenantCode) { DARABONBA_PTR_SET_VALUE(tenantCode_, tenantCode) };
    ...
    inline ReadWebhookContactRequest& setUidType(string uidType) { DARABONBA_PTR_SET_VALUE(uidType_, uidType) };
