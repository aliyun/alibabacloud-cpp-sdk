...
#ifndef ALIBABACLOUD_MODELS_READMESSAGELANGUAGEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_READMESSAGELANGUAGEREQUEST_HPP_
...
namespace Models
{
  class ReadMessageLanguageRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ReadMessageLanguageRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(ReturnDefaultLang, returnDefaultLang_);
      DARABONBA_PTR_TO_JSON(SrcUrl, srcUrl_);
      DARABONBA_PTR_TO_JSON(TenantCode, tenantCode_);
      DARABONBA_PTR_TO_JSON(UidType, uidType_);
    };
    friend void from_json(const Darabonba::Json& j, ReadMessageLanguageRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(ReturnDefaultLang, returnDefaultLang_);
    ...
    ReadMessageLanguageRequest() = default ;
    ReadMessageLanguageRequest(const ReadMessageLanguageRequest &) = default ;
    ReadMessageLanguageRequest(ReadMessageLanguageRequest &&) = default ;
    ReadMessageLanguageRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadMessageLanguageRequest() = default ;
    ReadMessageLanguageRequest& operator=(const ReadMessageLanguageRequest &) = default ;
    ReadMessageLanguageRequest& operator=(ReadMessageLanguageRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        ...
        && this->returnDefaultLang_ == nullptr && this->srcUrl_ == nullptr && this->tenantCode_ == nullptr && this->uidType_ == nullptr; };
    // acceptLanguage Field Functions 
    bool hasAcceptLanguage() const { return this->acceptLanguage_ != nullptr;};
    void deleteAcceptLanguage() { this->acceptLanguage_ = nullptr;};
    inline string getAcceptLanguage() const { DARABONBA_PTR_GET_DEFAULT(acceptLanguage_, "") };
    inline ReadMessageLanguageRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline ReadMessageLanguageRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ReadMessageLanguageRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline ReadMessageLanguageRequest& setCallerProtocol(string callerProtocol) { DARABONBA_PTR_SET_VALUE(callerProtocol_, callerProtocol) };
    ...
    inline ReadMessageLanguageRequest& setClientSource(string clientSource) { DARABONBA_PTR_SET_VALUE(clientSource_, clientSource) };
    ...
    inline ReadMessageLanguageRequest& setCookies(string cookies) { DARABONBA_PTR_SET_VALUE(cookies_, cookies) };


    // returnDefaultLang Field Functions 
    bool hasReturnDefaultLang() const { return this->returnDefaultLang_ != nullptr;};
    void deleteReturnDefaultLang() { this->returnDefaultLang_ = nullptr;};
    inline string getReturnDefaultLang() const { DARABONBA_PTR_GET_DEFAULT(returnDefaultLang_, "") };
    inline ReadMessageLanguageRequest& setReturnDefaultLang(string returnDefaultLang) { DARABONBA_PTR_SET_VALUE(returnDefaultLang_, returnDefaultLang) };
    ...
    inline ReadMessageLanguageRequest& setSrcUrl(string srcUrl) { DARABONBA_PTR_SET_VALUE(srcUrl_, srcUrl) };
    ...
    inline ReadMessageLanguageRequest& setTenantCode(string tenantCode) { DARABONBA_PTR_SET_VALUE(tenantCode_, tenantCode) };
    ...
    inline ReadMessageLanguageRequest& setUidType(string uidType) { DARABONBA_PTR_SET_VALUE(uidType_, uidType) };
  ...
  protected:
    ...
    shared_ptr<string> returnDefaultLang_ {};
