...
#ifndef ALIBABACLOUD_MODELS_DELETEALLMESSAGEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETEALLMESSAGEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteAllMessageRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeleteAllMessageRequest& obj) { 
    ...
    DeleteAllMessageRequest() = default ;
    DeleteAllMessageRequest(const DeleteAllMessageRequest &) = default ;
    DeleteAllMessageRequest(DeleteAllMessageRequest &&) = default ;
    DeleteAllMessageRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteAllMessageRequest() = default ;
    DeleteAllMessageRequest& operator=(const DeleteAllMessageRequest &) = default ;
    DeleteAllMessageRequest& operator=(DeleteAllMessageRequest &&) = default ;
    ...
    virtual bool empty() const override { this->acceptLanguage_ != nullptr
        ...
        && this->cookies_ != nullptr && this->groupCode_ != nullptr && this->srcUrl_ != nullptr && this->tenantCode_ != nullptr && this->uidType_ != nullptr; };
    // acceptLanguage Field Functions 
    bool hasAcceptLanguage() const { return this->acceptLanguage_ != nullptr;};
    void deleteAcceptLanguage() { this->acceptLanguage_ = nullptr;};
    inline string acceptLanguage() const { DARABONBA_PTR_GET_DEFAULT(acceptLanguage_, "") };
    inline DeleteAllMessageRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline DeleteAllMessageRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline DeleteAllMessageRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline DeleteAllMessageRequest& setCallerProtocol(string callerProtocol) { DARABONBA_PTR_SET_VALUE(callerProtocol_, callerProtocol) };
    ...
    inline DeleteAllMessageRequest& setClassId(int64_t classId) { DARABONBA_PTR_SET_VALUE(classId_, classId) };
    ...
    inline DeleteAllMessageRequest& setClientSource(string clientSource) { DARABONBA_PTR_SET_VALUE(clientSource_, clientSource) };
    ...
    inline DeleteAllMessageRequest& setCookies(string cookies) { DARABONBA_PTR_SET_VALUE(cookies_, cookies) };
    ...
    inline DeleteAllMessageRequest& setGroupCode(string groupCode) { DARABONBA_PTR_SET_VALUE(groupCode_, groupCode) };
    ...
    inline DeleteAllMessageRequest& setSrcUrl(string srcUrl) { DARABONBA_PTR_SET_VALUE(srcUrl_, srcUrl) };
    ...
    inline DeleteAllMessageRequest& setTenantCode(string tenantCode) { DARABONBA_PTR_SET_VALUE(tenantCode_, tenantCode) };
    ...
    inline DeleteAllMessageRequest& setUidType(string uidType) { DARABONBA_PTR_SET_VALUE(uidType_, uidType) };
