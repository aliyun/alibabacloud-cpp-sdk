...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWebhookContactResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWebhookContactResponseBody) };
    inline DeleteWebhookContactResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWebhookContactResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWebhookContactResponseBody> body_ {};
  };
