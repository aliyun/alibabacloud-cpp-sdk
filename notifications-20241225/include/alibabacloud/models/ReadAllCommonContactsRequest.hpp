...
#ifndef ALIBABACLOUD_MODELS_READALLCOMMONCONTACTSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_READALLCOMMONCONTACTSREQUEST_HPP_
...
namespace Models
{
  class ReadAllCommonContactsRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ReadAllCommonContactsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadAllCommonContactsRequest& obj) { 
    ...
    ReadAllCommonContactsRequest() = default ;
    ReadAllCommonContactsRequest(const ReadAllCommonContactsRequest &) = default ;
    ReadAllCommonContactsRequest(ReadAllCommonContactsRequest &&) = default ;
    ReadAllCommonContactsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadAllCommonContactsRequest() = default ;
    ReadAllCommonContactsRequest& operator=(const ReadAllCommonContactsRequest &) = default ;
    ReadAllCommonContactsRequest& operator=(ReadAllCommonContactsRequest &&) = default ;
    ...
    inline ReadAllCommonContactsRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline ReadAllCommonContactsRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ReadAllCommonContactsRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline ReadAllCommonContactsRequest& setCallerProtocol(string callerProtocol) { DARABONBA_PTR_SET_VALUE(callerProtocol_, callerProtocol) };
    ...
    inline ReadAllCommonContactsRequest& setClientSource(string clientSource) { DARABONBA_PTR_SET_VALUE(clientSource_, clientSource) };
    ...
    inline ReadAllCommonContactsRequest& setCookies(string cookies) { DARABONBA_PTR_SET_VALUE(cookies_, cookies) };
    ...
    inline ReadAllCommonContactsRequest& setSrcUrl(string srcUrl) { DARABONBA_PTR_SET_VALUE(srcUrl_, srcUrl) };
    ...
    inline ReadAllCommonContactsRequest& setTenantCode(string tenantCode) { DARABONBA_PTR_SET_VALUE(tenantCode_, tenantCode) };
    ...
    inline ReadAllCommonContactsRequest& setUidType(string uidType) { DARABONBA_PTR_SET_VALUE(uidType_, uidType) };
