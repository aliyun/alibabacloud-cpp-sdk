...
namespace Models
{
  ...
  public:
    ...
    inline string getHistory() const { DARABONBA_PTR_GET_DEFAULT(history_, "") };
    ...
    inline string getLoc() const { DARABONBA_PTR_GET_DEFAULT(loc_, "") };
  ...
  protected:
    ...
    shared_ptr<string> history_ {};
    // The location.
    shared_ptr<string> loc_ {};
    // A system parameter. You do not need to specify this parameter.
