...
#ifndef ALIBABACLOUD_MODELS_READMARKETINGPREFERENCEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_READMARKETINGPREFERENCEREQUEST_HPP_
...
namespace Models
{
  class ReadMarketingPreferenceRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ReadMarketingPreferenceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadMarketingPreferenceRequest& obj) { 
    ...
    ReadMarketingPreferenceRequest() = default ;
    ReadMarketingPreferenceRequest(const ReadMarketingPreferenceRequest &) = default ;
    ReadMarketingPreferenceRequest(ReadMarketingPreferenceRequest &&) = default ;
    ReadMarketingPreferenceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadMarketingPreferenceRequest() = default ;
    ReadMarketingPreferenceRequest& operator=(const ReadMarketingPreferenceRequest &) = default ;
    ReadMarketingPreferenceRequest& operator=(ReadMarketingPreferenceRequest &&) = default ;
    ...
    inline ReadMarketingPreferenceRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline ReadMarketingPreferenceRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ReadMarketingPreferenceRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline ReadMarketingPreferenceRequest& setCallerProtocol(string callerProtocol) { DARABONBA_PTR_SET_VALUE(callerProtocol_, callerProtocol) };
    ...
    inline ReadMarketingPreferenceRequest& setClientSource(string clientSource) { DARABONBA_PTR_SET_VALUE(clientSource_, clientSource) };
    ...
    inline ReadMarketingPreferenceRequest& setContactId(int64_t contactId) { DARABONBA_PTR_SET_VALUE(contactId_, contactId) };
    ...
    inline ReadMarketingPreferenceRequest& setCookies(string cookies) { DARABONBA_PTR_SET_VALUE(cookies_, cookies) };
    ...
    inline ReadMarketingPreferenceRequest& setSrcUrl(string srcUrl) { DARABONBA_PTR_SET_VALUE(srcUrl_, srcUrl) };
    ...
    inline ReadMarketingPreferenceRequest& setTenantCode(string tenantCode) { DARABONBA_PTR_SET_VALUE(tenantCode_, tenantCode) };
    ...
    inline ReadMarketingPreferenceRequest& setUidType(string uidType) { DARABONBA_PTR_SET_VALUE(uidType_, uidType) };
