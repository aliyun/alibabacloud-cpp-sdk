...
#ifndef ALIBABACLOUD_MODELS_READNUMGROUPBYCLASSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_READNUMGROUPBYCLASSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ReadNumGroupByClassRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadNumGroupByClassRequest& obj) { 
    ...
    ReadNumGroupByClassRequest() = default ;
    ReadNumGroupByClassRequest(const ReadNumGroupByClassRequest &) = default ;
    ReadNumGroupByClassRequest(ReadNumGroupByClassRequest &&) = default ;
    ReadNumGroupByClassRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadNumGroupByClassRequest() = default ;
    ReadNumGroupByClassRequest& operator=(const ReadNumGroupByClassRequest &) = default ;
    ReadNumGroupByClassRequest& operator=(ReadNumGroupByClassRequest &&) = default ;
    ...
    inline ReadNumGroupByClassRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline ReadNumGroupByClassRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ReadNumGroupByClassRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline ReadNumGroupByClassRequest& setCallerProtocol(string callerProtocol) { DARABONBA_PTR_SET_VALUE(callerProtocol_, callerProtocol) };
    ...
    inline ReadNumGroupByClassRequest& setClientSource(string clientSource) { DARABONBA_PTR_SET_VALUE(clientSource_, clientSource) };
    ...
    inline ReadNumGroupByClassRequest& setCookies(string cookies) { DARABONBA_PTR_SET_VALUE(cookies_, cookies) };
    ...
    inline ReadNumGroupByClassRequest& setSrcUrl(string srcUrl) { DARABONBA_PTR_SET_VALUE(srcUrl_, srcUrl) };
    ...
    inline ReadNumGroupByClassRequest& setTenantCode(string tenantCode) { DARABONBA_PTR_SET_VALUE(tenantCode_, tenantCode) };
    ...
    inline ReadNumGroupByClassRequest& setUidType(string uidType) { DARABONBA_PTR_SET_VALUE(uidType_, uidType) };
