...
#ifndef ALIBABACLOUD_MODELS_READALLMARKETINGPREFERENCESREQUEST_HPP_
#define ALIBABACLOUD_MODELS_READALLMARKETINGPREFERENCESREQUEST_HPP_
...
namespace Models
{
  class ReadAllMarketingPreferencesRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ReadAllMarketingPreferencesRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadAllMarketingPreferencesRequest& obj) { 
    ...
    ReadAllMarketingPreferencesRequest() = default ;
    ReadAllMarketingPreferencesRequest(const ReadAllMarketingPreferencesRequest &) = default ;
    ReadAllMarketingPreferencesRequest(ReadAllMarketingPreferencesRequest &&) = default ;
    ReadAllMarketingPreferencesRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadAllMarketingPreferencesRequest() = default ;
    ReadAllMarketingPreferencesRequest& operator=(const ReadAllMarketingPreferencesRequest &) = default ;
    ReadAllMarketingPreferencesRequest& operator=(ReadAllMarketingPreferencesRequest &&) = default ;
    ...
    inline ReadAllMarketingPreferencesRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline ReadAllMarketingPreferencesRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ReadAllMarketingPreferencesRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline ReadAllMarketingPreferencesRequest& setCallerProtocol(string callerProtocol) { DARABONBA_PTR_SET_VALUE(callerProtocol_, callerProtocol) };
    ...
    inline ReadAllMarketingPreferencesRequest& setClientSource(string clientSource) { DARABONBA_PTR_SET_VALUE(clientSource_, clientSource) };
    ...
    inline ReadAllMarketingPreferencesRequest& setCookies(string cookies) { DARABONBA_PTR_SET_VALUE(cookies_, cookies) };
    ...
    inline ReadAllMarketingPreferencesRequest& setSrcUrl(string srcUrl) { DARABONBA_PTR_SET_VALUE(srcUrl_, srcUrl) };
    ...
    inline ReadAllMarketingPreferencesRequest& setTenantCode(string tenantCode) { DARABONBA_PTR_SET_VALUE(tenantCode_, tenantCode) };
    ...
    inline ReadAllMarketingPreferencesRequest& setUidType(string uidType) { DARABONBA_PTR_SET_VALUE(uidType_, uidType) };
