...
#ifndef ALIBABACLOUD_MODELS_READALLCOMMONCONTACTSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_READALLCOMMONCONTACTSRESPONSEBODY_HPP_
...
namespace Models
{
  class ReadAllCommonContactsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ReadAllCommonContactsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadAllCommonContactsResponseBody& obj) { 
    ...
    ReadAllCommonContactsResponseBody() = default ;
    ReadAllCommonContactsResponseBody(const ReadAllCommonContactsResponseBody &) = default ;
    ReadAllCommonContactsResponseBody(ReadAllCommonContactsResponseBody &&) = default ;
    ReadAllCommonContactsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadAllCommonContactsResponseBody() = default ;
    ReadAllCommonContactsResponseBody& operator=(const ReadAllCommonContactsResponseBody &) = default ;
    ReadAllCommonContactsResponseBody& operator=(ReadAllCommonContactsResponseBody &&) = default ;
    ...
    inline ReadAllCommonContactsResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ReadAllCommonContactsResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ReadAllCommonContactsResponseBody::Data>) };
    inline vector<ReadAllCommonContactsResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ReadAllCommonContactsResponseBody::Data>) };
    inline ReadAllCommonContactsResponseBody& setData(const vector<ReadAllCommonContactsResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ReadAllCommonContactsResponseBody& setData(vector<ReadAllCommonContactsResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ReadAllCommonContactsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ReadAllCommonContactsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ReadAllCommonContactsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The query result.
    shared_ptr<vector<ReadAllCommonContactsResponseBody::Data>> data_ {};
    // The result message.
