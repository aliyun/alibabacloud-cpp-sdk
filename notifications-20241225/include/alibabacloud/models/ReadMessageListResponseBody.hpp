...
namespace Models
{
  ...
  public:
    ...
    inline const ReadMessageListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ReadMessageListResponseBodyData) };
    inline ReadMessageListResponseBodyData data() { DARABONBA_PTR_GET(data_, ReadMessageListResponseBodyData) };
    inline ReadMessageListResponseBody& setData(const ReadMessageListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ReadMessageListResponseBody& setData(ReadMessageListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Data
    std::shared_ptr<ReadMessageListResponseBodyData> data_ = nullptr;
    // message
