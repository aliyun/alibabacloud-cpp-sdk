...
#ifndef ALIBABACLOUD_MODELS_READMESSAGECONTENTRESPONSEBODYDATADATASNEXTITEM_HPP_
#define ALIBABACLOUD_MODELS_READMESSAGECONTENTRESPONSEBODYDATADATASNEXTITEM_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ReadMessageContentResponseBodyDataDatasNextItem& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadMessageContentResponseBodyDataDatasNextItem& obj) { 
    ...
    ReadMessageContentResponseBodyDataDatasNextItem() = default ;
    ReadMessageContentResponseBodyDataDatasNextItem(const ReadMessageContentResponseBodyDataDatasNextItem &) = default ;
    ReadMessageContentResponseBodyDataDatasNextItem(ReadMessageContentResponseBodyDataDatasNextItem &&) = default ;
    ReadMessageContentResponseBodyDataDatasNextItem(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadMessageContentResponseBodyDataDatasNextItem() = default ;
    ReadMessageContentResponseBodyDataDatasNextItem& operator=(const ReadMessageContentResponseBodyDataDatasNextItem &) = default ;
    ReadMessageContentResponseBodyDataDatasNextItem& operator=(ReadMessageContentResponseBodyDataDatasNextItem &&) = default ;
    ...
    inline ReadMessageContentResponseBodyDataDatasNextItem& setCategoryName(string categoryName) { DARABONBA_PTR_SET_VALUE(categoryName_, categoryName) };
    ...
    inline ReadMessageContentResponseBodyDataDatasNextItem& setClassId(int64_t classId) { DARABONBA_PTR_SET_VALUE(classId_, classId) };
    ...
    inline ReadMessageContentResponseBodyDataDatasNextItem& setContent(string content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    ...
    inline ReadMessageContentResponseBodyDataDatasNextItem& setDeleted(int32_t deleted) { DARABONBA_PTR_SET_VALUE(deleted_, deleted) };
    ...
    inline ReadMessageContentResponseBodyDataDatasNextItem& setGmtCreated(int64_t gmtCreated) { DARABONBA_PTR_SET_VALUE(gmtCreated_, gmtCreated) };
    ...
    inline ReadMessageContentResponseBodyDataDatasNextItem& setGmtUpdate(int64_t gmtUpdate) { DARABONBA_PTR_SET_VALUE(gmtUpdate_, gmtUpdate) };
    ...
    inline ReadMessageContentResponseBodyDataDatasNextItem& setMassId(int64_t massId) { DARABONBA_PTR_SET_VALUE(massId_, massId) };
    ...
    inline ReadMessageContentResponseBodyDataDatasNextItem& setMemo(string memo) { DARABONBA_PTR_SET_VALUE(memo_, memo) };
    ...
    inline ReadMessageContentResponseBodyDataDatasNextItem& setMsgId(int64_t msgId) { DARABONBA_PTR_SET_VALUE(msgId_, msgId) };
    ...
    inline ReadMessageContentResponseBodyDataDatasNextItem& setStatus(int64_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ReadMessageContentResponseBodyDataDatasNextItem& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
