...
#ifndef ALIBABACLOUD_MODELS_READMESSAGECONTENTRESPONSEBODYDATADATASITEM_HPP_
#define ALIBABACLOUD_MODELS_READMESSAGECONTENTRESPONSEBODYDATADATASITEM_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ReadMessageContentResponseBodyDataDatasItem& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadMessageContentResponseBodyDataDatasItem& obj) { 
    ...
    ReadMessageContentResponseBodyDataDatasItem() = default ;
    ReadMessageContentResponseBodyDataDatasItem(const ReadMessageContentResponseBodyDataDatasItem &) = default ;
    ReadMessageContentResponseBodyDataDatasItem(ReadMessageContentResponseBodyDataDatasItem &&) = default ;
    ReadMessageContentResponseBodyDataDatasItem(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadMessageContentResponseBodyDataDatasItem() = default ;
    ReadMessageContentResponseBodyDataDatasItem& operator=(const ReadMessageContentResponseBodyDataDatasItem &) = default ;
    ReadMessageContentResponseBodyDataDatasItem& operator=(ReadMessageContentResponseBodyDataDatasItem &&) = default ;
    ...
    inline ReadMessageContentResponseBodyDataDatasItem& setCategoryName(string categoryName) { DARABONBA_PTR_SET_VALUE(categoryName_, categoryName) };
    ...
    inline ReadMessageContentResponseBodyDataDatasItem& setClassId(int64_t classId) { DARABONBA_PTR_SET_VALUE(classId_, classId) };
    ...
    inline ReadMessageContentResponseBodyDataDatasItem& setContent(string content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    ...
    inline ReadMessageContentResponseBodyDataDatasItem& setDeleted(int32_t deleted) { DARABONBA_PTR_SET_VALUE(deleted_, deleted) };
    ...
    inline ReadMessageContentResponseBodyDataDatasItem& setGmtCreated(int64_t gmtCreated) { DARABONBA_PTR_SET_VALUE(gmtCreated_, gmtCreated) };
    ...
    inline ReadMessageContentResponseBodyDataDatasItem& setGmtUpdate(int64_t gmtUpdate) { DARABONBA_PTR_SET_VALUE(gmtUpdate_, gmtUpdate) };
    ...
    inline ReadMessageContentResponseBodyDataDatasItem& setMassId(int64_t massId) { DARABONBA_PTR_SET_VALUE(massId_, massId) };
    ...
    inline ReadMessageContentResponseBodyDataDatasItem& setMemo(string memo) { DARABONBA_PTR_SET_VALUE(memo_, memo) };
    ...
    inline ReadMessageContentResponseBodyDataDatasItem& setMsgId(int64_t msgId) { DARABONBA_PTR_SET_VALUE(msgId_, msgId) };
    ...
    inline ReadMessageContentResponseBodyDataDatasItem& setStatus(int64_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ReadMessageContentResponseBodyDataDatasItem& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
