...
#ifndef ALIBABACLOUD_MODELS_RESETUSERSUBSCRIPTIONREQUEST_HPP_
#define ALIBABACLOUD_MODELS_RESETUSERSUBSCRIPTIONREQUEST_HPP_
...
namespace Models
{
  class ResetUserSubscriptionRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ResetUserSubscriptionRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AcceptLanguage, acceptLanguage_);
      DARABONBA_PTR_TO_JSON(AppName, appName_);
      DARABONBA_PTR_TO_JSON(BizName, bizName_);
      DARABONBA_PTR_TO_JSON(CallerProtocol, callerProtocol_);
      DARABONBA_PTR_TO_JSON(CategoryCodes, categoryCodes_);
    ...
    friend void from_json(const Darabonba::Json& j, ResetUserSubscriptionRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AcceptLanguage, acceptLanguage_);
      DARABONBA_PTR_FROM_JSON(AppName, appName_);
      DARABONBA_PTR_FROM_JSON(BizName, bizName_);
      DARABONBA_PTR_FROM_JSON(CallerProtocol, callerProtocol_);
      DARABONBA_PTR_FROM_JSON(CategoryCodes, categoryCodes_);
    ...
    ResetUserSubscriptionRequest() = default ;
    ResetUserSubscriptionRequest(const ResetUserSubscriptionRequest &) = default ;
    ResetUserSubscriptionRequest(ResetUserSubscriptionRequest &&) = default ;
    ResetUserSubscriptionRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ResetUserSubscriptionRequest() = default ;
    ResetUserSubscriptionRequest& operator=(const ResetUserSubscriptionRequest &) = default ;
    ResetUserSubscriptionRequest& operator=(ResetUserSubscriptionRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && this->appName_ == nullptr && this->bizName_ == nullptr && this->callerProtocol_ == nullptr && this->categoryCodes_ == nullptr && this->channelGroupCode_ == nullptr
    ...
    inline ResetUserSubscriptionRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline ResetUserSubscriptionRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ResetUserSubscriptionRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline ResetUserSubscriptionRequest& setCallerProtocol(string callerProtocol) { DARABONBA_PTR_SET_VALUE(callerProtocol_, callerProtocol) };


    // categoryCodes Field Functions 
    bool hasCategoryCodes() const { return this->categoryCodes_ != nullptr;};
    void deleteCategoryCodes() { this->categoryCodes_ = nullptr;};
    inline const vector<string> & getCategoryCodes() const { DARABONBA_PTR_GET_CONST(categoryCodes_, vector<string>) };
    inline vector<string> getCategoryCodes() { DARABONBA_PTR_GET(categoryCodes_, vector<string>) };
    inline ResetUserSubscriptionRequest& setCategoryCodes(const vector<string> & categoryCodes) { DARABONBA_PTR_SET_VALUE(categoryCodes_, categoryCodes) };
    inline ResetUserSubscriptionRequest& setCategoryCodes(vector<string> && categoryCodes) { DARABONBA_PTR_SET_RVALUE(categoryCodes_, categoryCodes) };
    ...
    inline ResetUserSubscriptionRequest& setChannelGroupCode(string channelGroupCode) { DARABONBA_PTR_SET_VALUE(channelGroupCode_, channelGroupCode) };
    ...
    inline ResetUserSubscriptionRequest& setClientSource(string clientSource) { DARABONBA_PTR_SET_VALUE(clientSource_, clientSource) };
    ...
    inline ResetUserSubscriptionRequest& setCookies(string cookies) { DARABONBA_PTR_SET_VALUE(cookies_, cookies) };
    ...
    inline ResetUserSubscriptionRequest& setRemarks(string remarks) { DARABONBA_PTR_SET_VALUE(remarks_, remarks) };
    ...
    inline ResetUserSubscriptionRequest& setSrcUrl(string srcUrl) { DARABONBA_PTR_SET_VALUE(srcUrl_, srcUrl) };
    ...
    inline ResetUserSubscriptionRequest& setTenantCode(string tenantCode) { DARABONBA_PTR_SET_VALUE(tenantCode_, tenantCode) };
    ...
    inline ResetUserSubscriptionRequest& setUidType(string uidType) { DARABONBA_PTR_SET_VALUE(uidType_, uidType) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> categoryCodes_ {};
