...
namespace Models
{
  ...
  public:
    ...
    inline const ReadMessageContentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ReadMessageContentResponseBodyData) };
    inline ReadMessageContentResponseBodyData data() { DARABONBA_PTR_GET(data_, ReadMessageContentResponseBodyData) };
    inline ReadMessageContentResponseBody& setData(const ReadMessageContentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ReadMessageContentResponseBody& setData(ReadMessageContentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ReadMessageContentResponseBodyData> data_ = nullptr;
