...
#ifndef ALIBABACLOUD_MODELS_READMETACONFIGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_READMETACONFIGREQUEST_HPP_
...
namespace Models
{
  class ReadMetaConfigRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ReadMetaConfigRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadMetaConfigRequest& obj) { 
    ...
    ReadMetaConfigRequest() = default ;
    ReadMetaConfigRequest(const ReadMetaConfigRequest &) = default ;
    ReadMetaConfigRequest(ReadMetaConfigRequest &&) = default ;
    ReadMetaConfigRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadMetaConfigRequest() = default ;
    ReadMetaConfigRequest& operator=(const ReadMetaConfigRequest &) = default ;
    ReadMetaConfigRequest& operator=(ReadMetaConfigRequest &&) = default ;
    ...
    inline ReadMetaConfigRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline ReadMetaConfigRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ReadMetaConfigRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline ReadMetaConfigRequest& setCallerProtocol(string callerProtocol) { DARABONBA_PTR_SET_VALUE(callerProtocol_, callerProtocol) };
    ...
    inline ReadMetaConfigRequest& setClientSource(string clientSource) { DARABONBA_PTR_SET_VALUE(clientSource_, clientSource) };
    ...
    inline ReadMetaConfigRequest& setCookies(string cookies) { DARABONBA_PTR_SET_VALUE(cookies_, cookies) };
    ...
    inline ReadMetaConfigRequest& setSrcUrl(string srcUrl) { DARABONBA_PTR_SET_VALUE(srcUrl_, srcUrl) };
    ...
    inline ReadMetaConfigRequest& setTenantCode(string tenantCode) { DARABONBA_PTR_SET_VALUE(tenantCode_, tenantCode) };
    ...
    inline ReadMetaConfigRequest& setUidType(string uidType) { DARABONBA_PTR_SET_VALUE(uidType_, uidType) };
