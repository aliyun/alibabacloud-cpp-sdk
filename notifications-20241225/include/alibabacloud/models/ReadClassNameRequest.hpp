...
#ifndef ALIBABACLOUD_MODELS_READCLASSNAMEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_READCLASSNAMEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ReadClassNameRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ReadClassNameRequest& obj) { 
    ...
    ReadClassNameRequest() = default ;
    ReadClassNameRequest(const ReadClassNameRequest &) = default ;
    ReadClassNameRequest(ReadClassNameRequest &&) = default ;
    ReadClassNameRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReadClassNameRequest() = default ;
    ReadClassNameRequest& operator=(const ReadClassNameRequest &) = default ;
    ReadClassNameRequest& operator=(ReadClassNameRequest &&) = default ;
    ...
    inline ReadClassNameRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline ReadClassNameRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ReadClassNameRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline ReadClassNameRequest& setCallerProtocol(string callerProtocol) { DARABONBA_PTR_SET_VALUE(callerProtocol_, callerProtocol) };
    ...
    inline ReadClassNameRequest& setClientSource(string clientSource) { DARABONBA_PTR_SET_VALUE(clientSource_, clientSource) };
    ...
    inline ReadClassNameRequest& setCookies(string cookies) { DARABONBA_PTR_SET_VALUE(cookies_, cookies) };
    ...
    inline ReadClassNameRequest& setSrcUrl(string srcUrl) { DARABONBA_PTR_SET_VALUE(srcUrl_, srcUrl) };
    ...
    inline ReadClassNameRequest& setTenantCode(string tenantCode) { DARABONBA_PTR_SET_VALUE(tenantCode_, tenantCode) };
    ...
    inline ReadClassNameRequest& setUidType(string uidType) { DARABONBA_PTR_SET_VALUE(uidType_, uidType) };
