...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAndPublishAgentSelectiveRequest::ApplicationConfig & getApplicationConfig() const { DARABONBA_PTR_GET_CONST(applicationConfig_, UpdateAndPublishAgentSelectiveRequest::ApplicationConfig) };
    inline UpdateAndPublishAgentSelectiveRequest::ApplicationConfig getApplicationConfig() { DARABONBA_PTR_GET(applicationConfig_, UpdateAndPublishAgentSelectiveRequest::ApplicationConfig) };
    inline UpdateAndPublishAgentSelectiveRequest& setApplicationConfig(const UpdateAndPublishAgentSelectiveRequest::ApplicationConfig & applicationConfig) { DARABONBA_PTR_SET_VALUE(applicationConfig_, applicationConfig) };
    inline UpdateAndPublishAgentSelectiveRequest& setApplicationConfig(UpdateAndPublishAgentSelectiveRequest::ApplicationConfig && applicationConfig) { DARABONBA_PTR_SET_RVALUE(applicationConfig_, applicationConfig) };
    ...
    inline const UpdateAndPublishAgentSelectiveRequest::SampleLibrary & getSampleLibrary() const { DARABONBA_PTR_GET_CONST(sampleLibrary_, UpdateAndPublishAgentSelectiveRequest::SampleLibrary) };
    inline UpdateAndPublishAgentSelectiveRequest::SampleLibrary getSampleLibrary() { DARABONBA_PTR_GET(sampleLibrary_, UpdateAndPublishAgentSelectiveRequest::SampleLibrary) };
    inline UpdateAndPublishAgentSelectiveRequest& setSampleLibrary(const UpdateAndPublishAgentSelectiveRequest::SampleLibrary & sampleLibrary) { DARABONBA_PTR_SET_VALUE(sampleLibrary_, sampleLibrary) };
    inline UpdateAndPublishAgentSelectiveRequest& setSampleLibrary(UpdateAndPublishAgentSelectiveRequest::SampleLibrary && sampleLibrary) { DARABONBA_PTR_SET_RVALUE(sampleLibrary_, sampleLibrary) };


  protected:
    shared_ptr<UpdateAndPublishAgentSelectiveRequest::ApplicationConfig> applicationConfig_ {};
    shared_ptr<string> instructions_ {};
    shared_ptr<string> modelId_ {};
    shared_ptr<string> name_ {};
    shared_ptr<UpdateAndPublishAgentSelectiveRequest::SampleLibrary> sampleLibrary_ {};
  };
