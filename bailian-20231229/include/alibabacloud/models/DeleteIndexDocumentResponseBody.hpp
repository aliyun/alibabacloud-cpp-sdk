...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<string> & getDeletedDocument() const { DARABONBA_PTR_GET_CONST(deletedDocument_, vector<string>) };
      inline vector<string> getDeletedDocument() { DARABONBA_PTR_GET(deletedDocument_, vector<string>) };
      inline Data& setDeletedDocument(const vector<string> & deletedDocument) { DARABONBA_PTR_SET_VALUE(deletedDocument_, deletedDocument) };
      inline Data& setDeletedDocument(vector<string> && deletedDocument) { DARABONBA_PTR_SET_RVALUE(deletedDocument_, deletedDocument) };
    ...
    inline const DeleteIndexDocumentResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteIndexDocumentResponseBody::Data) };
    inline DeleteIndexDocumentResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteIndexDocumentResponseBody::Data) };
    inline DeleteIndexDocumentResponseBody& setData(const DeleteIndexDocumentResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteIndexDocumentResponseBody& setData(DeleteIndexDocumentResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
