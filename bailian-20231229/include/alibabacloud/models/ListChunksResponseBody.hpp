...
namespace Models
{
  ...
  public:
    ...
    inline const ListChunksResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListChunksResponseBody::Data) };
    inline ListChunksResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListChunksResponseBody::Data) };
    inline ListChunksResponseBody& setData(const ListChunksResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListChunksResponseBody& setData(ListChunksResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
