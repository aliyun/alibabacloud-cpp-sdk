...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePromptTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePromptTemplateResponseBody) };
    inline UpdatePromptTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePromptTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePromptTemplateResponseBody> body_ {};
  };
