...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->categoryType_ == nullptr
        && return this->fileName_ == nullptr && return this->md5_ == nullptr && return this->sizeInBytes_ == nullptr && return this->useInternalEndpoint_ == nullptr; };
    ...
    inline string sizeInBytes() const { DARABONBA_PTR_GET_DEFAULT(sizeInBytes_, "") };
    ...
    inline bool useInternalEndpoint() const { DARABONBA_PTR_GET_DEFAULT(useInternalEndpoint_, false) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> sizeInBytes_ = nullptr;
    std::shared_ptr<bool> useInternalEndpoint_ = nullptr;
  };
