...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAndPublishAgentRequest::ApplicationConfig & getApplicationConfig() const { DARABONBA_PTR_GET_CONST(applicationConfig_, UpdateAndPublishAgentRequest::ApplicationConfig) };
    inline UpdateAndPublishAgentRequest::ApplicationConfig getApplicationConfig() { DARABONBA_PTR_GET(applicationConfig_, UpdateAndPublishAgentRequest::ApplicationConfig) };
    inline UpdateAndPublishAgentRequest& setApplicationConfig(const UpdateAndPublishAgentRequest::ApplicationConfig & applicationConfig) { DARABONBA_PTR_SET_VALUE(applicationConfig_, applicationConfig) };
    inline UpdateAndPublishAgentRequest& setApplicationConfig(UpdateAndPublishAgentRequest::ApplicationConfig && applicationConfig) { DARABONBA_PTR_SET_RVALUE(applicationConfig_, applicationConfig) };
    ...
    inline const UpdateAndPublishAgentRequest::SampleLibrary & getSampleLibrary() const { DARABONBA_PTR_GET_CONST(sampleLibrary_, UpdateAndPublishAgentRequest::SampleLibrary) };
    inline UpdateAndPublishAgentRequest::SampleLibrary getSampleLibrary() { DARABONBA_PTR_GET(sampleLibrary_, UpdateAndPublishAgentRequest::SampleLibrary) };
    inline UpdateAndPublishAgentRequest& setSampleLibrary(const UpdateAndPublishAgentRequest::SampleLibrary & sampleLibrary) { DARABONBA_PTR_SET_VALUE(sampleLibrary_, sampleLibrary) };
    inline UpdateAndPublishAgentRequest& setSampleLibrary(UpdateAndPublishAgentRequest::SampleLibrary && sampleLibrary) { DARABONBA_PTR_SET_RVALUE(sampleLibrary_, sampleLibrary) };


  protected:
    shared_ptr<UpdateAndPublishAgentRequest::ApplicationConfig> applicationConfig_ {};
    shared_ptr<string> instructions_ {};
    shared_ptr<string> modelId_ {};
    shared_ptr<string> name_ {};
    shared_ptr<UpdateAndPublishAgentRequest::SampleLibrary> sampleLibrary_ {};
  };
