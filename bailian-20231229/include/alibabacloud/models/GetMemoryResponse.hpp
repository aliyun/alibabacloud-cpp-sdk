...
namespace Models
{
  ...
  public:
    ...
    inline const GetMemoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMemoryResponseBody) };
    inline GetMemoryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMemoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMemoryResponseBody> body_ {};
  };
