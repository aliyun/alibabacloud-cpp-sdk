...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyTempStorageLeaseResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ApplyTempStorageLeaseResponseBodyData) };
    inline ApplyTempStorageLeaseResponseBodyData data() { DARABONBA_PTR_GET(data_, ApplyTempStorageLeaseResponseBodyData) };
    inline ApplyTempStorageLeaseResponseBody& setData(const ApplyTempStorageLeaseResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ApplyTempStorageLeaseResponseBody& setData(ApplyTempStorageLeaseResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ApplyTempStorageLeaseResponseBodyData> data_ = nullptr;
