...
namespace Models
{
  ...
  public:
    ...
    ListPublishedAgentRequest(ListPublishedAgentRequest &&) = default ;
    ListPublishedAgentRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPublishedAgentRequest() = default ;
    ListPublishedAgentRequest& operator=(const ListPublishedAgentRequest &) = default ;
    ListPublishedAgentRequest& operator=(ListPublishedAgentRequest &&) = default ;
    ...
    inline ListPublishedAgentRequest& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
