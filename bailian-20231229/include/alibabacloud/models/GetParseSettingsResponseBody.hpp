...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetParseSettingsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetParseSettingsResponseBodyData>) };
    inline vector<GetParseSettingsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetParseSettingsResponseBodyData>) };
    inline GetParseSettingsResponseBody& setData(const vector<GetParseSettingsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetParseSettingsResponseBody& setData(vector<GetParseSettingsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetParseSettingsResponseBodyData>> data_ = nullptr;
    // The error message.
