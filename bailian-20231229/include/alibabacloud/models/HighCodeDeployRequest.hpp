...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentDesc_ == nullptr
        && return this->agentId_ == nullptr && return this->agentName_ == nullptr && return this->sourceCodeName_ == nullptr && return this->sourceCodeOssUrl_ == nullptr && return this->telemetryEnabled_ == nullptr; };
    ...
    inline string agentDesc() const { DARABONBA_PTR_GET_DEFAULT(agentDesc_, "") };
    ...
    inline string sourceCodeName() const { DARABONBA_PTR_GET_DEFAULT(sourceCodeName_, "") };
    ...
    inline string sourceCodeOssUrl() const { DARABONBA_PTR_GET_DEFAULT(sourceCodeOssUrl_, "") };
    ...
    inline bool telemetryEnabled() const { DARABONBA_PTR_GET_DEFAULT(telemetryEnabled_, false) };
  ...
  protected:
    std::shared_ptr<string> agentDesc_ = nullptr;
    std::shared_ptr<string> agentId_ = nullptr;
    std::shared_ptr<string> agentName_ = nullptr;
    std::shared_ptr<string> sourceCodeName_ = nullptr;
    std::shared_ptr<string> sourceCodeOssUrl_ = nullptr;
    std::shared_ptr<bool> telemetryEnabled_ = nullptr;
  };
