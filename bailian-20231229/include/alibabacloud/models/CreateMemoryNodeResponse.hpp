...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMemoryNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMemoryNodeResponseBody) };
    inline CreateMemoryNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMemoryNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMemoryNodeResponseBody> body_ {};
  };
