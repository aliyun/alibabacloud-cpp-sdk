...
namespace Models
{
  ...
  public:
    ...
    inline const GetIndexJobStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetIndexJobStatusResponseBodyData) };
    inline GetIndexJobStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, GetIndexJobStatusResponseBodyData) };
    inline GetIndexJobStatusResponseBody& setData(const GetIndexJobStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetIndexJobStatusResponseBody& setData(GetIndexJobStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetIndexJobStatusResponseBodyData> data_ = nullptr;
    // The error message.
