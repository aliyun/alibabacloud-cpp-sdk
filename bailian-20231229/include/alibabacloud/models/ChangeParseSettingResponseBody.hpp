...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->changeResult_ == nullptr; };
      ...
      inline bool getChangeResult() const { DARABONBA_PTR_GET_DEFAULT(changeResult_, false) };
      inline Data& setChangeResult(bool changeResult) { DARABONBA_PTR_SET_VALUE(changeResult_, changeResult) };
    ...
    inline const ChangeParseSettingResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ChangeParseSettingResponseBody::Data) };
    inline ChangeParseSettingResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ChangeParseSettingResponseBody::Data) };
    inline ChangeParseSettingResponseBody& setData(const ChangeParseSettingResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ChangeParseSettingResponseBody& setData(ChangeParseSettingResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
