...
namespace Models
{
  ...
  public:
    ...
    inline const ListIndexDocumentsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListIndexDocumentsResponseBodyData) };
    inline ListIndexDocumentsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListIndexDocumentsResponseBodyData) };
    inline ListIndexDocumentsResponseBody& setData(const ListIndexDocumentsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIndexDocumentsResponseBody& setData(ListIndexDocumentsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListIndexDocumentsResponseBodyData> data_ = nullptr;
    // The error message.
