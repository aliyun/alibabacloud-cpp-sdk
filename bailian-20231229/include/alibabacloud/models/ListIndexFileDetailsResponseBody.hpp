...
namespace Models
{
  ...
  public:
    ...
    inline const ListIndexFileDetailsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListIndexFileDetailsResponseBodyData) };
    inline ListIndexFileDetailsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListIndexFileDetailsResponseBodyData) };
    inline ListIndexFileDetailsResponseBody& setData(const ListIndexFileDetailsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIndexFileDetailsResponseBody& setData(ListIndexFileDetailsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListIndexFileDetailsResponseBodyData> data_ = nullptr;
