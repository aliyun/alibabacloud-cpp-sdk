...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMemoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMemoryResponseBody) };
    inline CreateMemoryResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMemoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMemoryResponseBody> body_ {};
  };
