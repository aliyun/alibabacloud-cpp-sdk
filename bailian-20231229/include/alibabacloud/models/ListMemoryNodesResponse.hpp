...
namespace Models
{
  ...
  public:
    ...
    inline const ListMemoryNodesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListMemoryNodesResponseBody) };
    inline ListMemoryNodesResponseBody body() { DARABONBA_PTR_GET(body_, ListMemoryNodesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListMemoryNodesResponseBody> body_ = nullptr;
  };
