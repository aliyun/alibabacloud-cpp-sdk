...
namespace Models
{
  ...
  public:
    ...
    inline const GetAvailableParserTypesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAvailableParserTypesResponseBody) };
    inline GetAvailableParserTypesResponseBody body() { DARABONBA_PTR_GET(body_, GetAvailableParserTypesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAvailableParserTypesResponseBody> body_ = nullptr;
  };
