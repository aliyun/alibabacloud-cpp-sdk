...
namespace Models
{
  ...
  public:
    ...
    inline const AddCategoryResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, AddCategoryResponseBody::Data) };
    inline AddCategoryResponseBody::Data getData() { DARABONBA_PTR_GET(data_, AddCategoryResponseBody::Data) };
    inline AddCategoryResponseBody& setData(const AddCategoryResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddCategoryResponseBody& setData(AddCategoryResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
