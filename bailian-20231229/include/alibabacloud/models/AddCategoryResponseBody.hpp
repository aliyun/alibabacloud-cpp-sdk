...
namespace Models
{
  ...
  public:
    ...
    inline AddCategoryResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const AddCategoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddCategoryResponseBodyData) };
    inline AddCategoryResponseBodyData data() { DARABONBA_PTR_GET(data_, AddCategoryResponseBodyData) };
    inline AddCategoryResponseBody& setData(const AddCategoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddCategoryResponseBody& setData(AddCategoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline AddCategoryResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline AddCategoryResponseBody& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline AddCategoryResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    std::shared_ptr<string> code_ = nullptr;
    std::shared_ptr<AddCategoryResponseBodyData> data_ = nullptr;
