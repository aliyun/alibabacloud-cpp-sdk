...
namespace Models
{
  ...
  public:
    ...
    inline const ListIndexFileDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIndexFileDetailsResponseBody) };
    inline ListIndexFileDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIndexFileDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIndexFileDetailsResponseBody> body_ {};
  };
