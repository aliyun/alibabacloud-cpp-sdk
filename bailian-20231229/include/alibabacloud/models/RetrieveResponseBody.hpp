...
namespace Models
{
  ...
  public:
    ...
    inline const RetrieveResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RetrieveResponseBodyData) };
    inline RetrieveResponseBodyData data() { DARABONBA_PTR_GET(data_, RetrieveResponseBodyData) };
    inline RetrieveResponseBody& setData(const RetrieveResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RetrieveResponseBody& setData(RetrieveResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<RetrieveResponseBodyData> data_ = nullptr;
    // The error message.
