...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->denseSimilarityTopK_ == nullptr
        && return this->enableReranking_ == nullptr && return this->enableRewrite_ == nullptr && return this->imagesShrink_ == nullptr && return this->indexId_ == nullptr && return this->query_ == nullptr
        && return this->queryHistoryShrink_ == nullptr && return this->rerankShrink_ == nullptr && return this->rerankMinScore_ == nullptr && return this->rerankTopN_ == nullptr && return this->rewriteShrink_ == nullptr
        && return this->saveRetrieverHistory_ == nullptr && return this->searchFiltersShrink_ == nullptr && return this->sparseSimilarityTopK_ == nullptr; };
    ...
    inline string imagesShrink() const { DARABONBA_PTR_GET_DEFAULT(imagesShrink_, "") };
    ...
    inline string queryHistoryShrink() const { DARABONBA_PTR_GET_DEFAULT(queryHistoryShrink_, "") };
    ...
    inline string rerankShrink() const { DARABONBA_PTR_GET_DEFAULT(rerankShrink_, "") };
    ...
    inline string rewriteShrink() const { DARABONBA_PTR_GET_DEFAULT(rewriteShrink_, "") };
    ...
    inline string searchFiltersShrink() const { DARABONBA_PTR_GET_DEFAULT(searchFiltersShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> imagesShrink_ = nullptr;
    ...
    std::shared_ptr<string> queryHistoryShrink_ = nullptr;
    // Ranking configurations.
    std::shared_ptr<string> rerankShrink_ = nullptr;
    ...
    std::shared_ptr<string> rewriteShrink_ = nullptr;
    ...
    std::shared_ptr<string> searchFiltersShrink_ = nullptr;
