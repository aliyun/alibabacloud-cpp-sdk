...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePromptTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePromptTemplateResponseBody) };
    inline CreatePromptTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePromptTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePromptTemplateResponseBody> body_ {};
  };
