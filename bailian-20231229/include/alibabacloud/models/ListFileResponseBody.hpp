...
namespace Models
{
  ...
  public:
    ...
    inline const ListFileResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListFileResponseBodyData) };
    inline ListFileResponseBodyData data() { DARABONBA_PTR_GET(data_, ListFileResponseBodyData) };
    inline ListFileResponseBody& setData(const ListFileResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListFileResponseBody& setData(ListFileResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
