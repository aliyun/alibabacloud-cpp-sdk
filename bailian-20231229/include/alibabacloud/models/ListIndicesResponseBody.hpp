...
namespace Models
{
  ...
  public:
    ...
    inline const ListIndicesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListIndicesResponseBodyData) };
    inline ListIndicesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListIndicesResponseBodyData) };
    inline ListIndicesResponseBody& setData(const ListIndicesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIndicesResponseBody& setData(ListIndicesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListIndicesResponseBodyData> data_ = nullptr;
    // The error message.
