...
namespace Models
{
  ...
  public:
    ...
    inline const AddFilesFromAuthorizedOssResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddFilesFromAuthorizedOssResponseBodyData) };
    inline AddFilesFromAuthorizedOssResponseBodyData data() { DARABONBA_PTR_GET(data_, AddFilesFromAuthorizedOssResponseBodyData) };
    inline AddFilesFromAuthorizedOssResponseBody& setData(const AddFilesFromAuthorizedOssResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddFilesFromAuthorizedOssResponseBody& setData(AddFilesFromAuthorizedOssResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<AddFilesFromAuthorizedOssResponseBodyData> data_ = nullptr;
