...
namespace Models
{
  ...
  public:
    ...
    inline const ListCategoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCategoryResponseBodyData) };
    inline ListCategoryResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCategoryResponseBodyData) };
    inline ListCategoryResponseBody& setData(const ListCategoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCategoryResponseBody& setData(ListCategoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListCategoryResponseBodyData> data_ = nullptr;
