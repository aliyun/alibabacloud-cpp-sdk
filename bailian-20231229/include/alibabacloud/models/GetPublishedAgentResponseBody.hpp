...
namespace Models
{
  ...
  public:
    ...
    inline const GetPublishedAgentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPublishedAgentResponseBodyData) };
    inline GetPublishedAgentResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPublishedAgentResponseBodyData) };
    inline GetPublishedAgentResponseBody& setData(const GetPublishedAgentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPublishedAgentResponseBody& setData(GetPublishedAgentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetPublishedAgentResponseBodyData> data_ = nullptr;
