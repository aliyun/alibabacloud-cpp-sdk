...
#ifndef ALIBABACLOUD_MODELS_CREATEANDPULISHAGENTREQUESTAPPLICATIONCONFIGPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_CREATEANDPULISHAGENTREQUESTAPPLICATIONCONFIGPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAndPulishAgentRequestApplicationConfigParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateAndPulishAgentRequestApplicationConfigParameters& obj) { 
    ...
    CreateAndPulishAgentRequestApplicationConfigParameters() = default ;
    CreateAndPulishAgentRequestApplicationConfigParameters(const CreateAndPulishAgentRequestApplicationConfigParameters &) = default ;
    CreateAndPulishAgentRequestApplicationConfigParameters(CreateAndPulishAgentRequestApplicationConfigParameters &&) = default ;
    CreateAndPulishAgentRequestApplicationConfigParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAndPulishAgentRequestApplicationConfigParameters() = default ;
    CreateAndPulishAgentRequestApplicationConfigParameters& operator=(const CreateAndPulishAgentRequestApplicationConfigParameters &) = default ;
    CreateAndPulishAgentRequestApplicationConfigParameters& operator=(CreateAndPulishAgentRequestApplicationConfigParameters &&) = default ;
    ...
    inline CreateAndPulishAgentRequestApplicationConfigParameters& setDialogRound(int32_t dialogRound) { DARABONBA_PTR_SET_VALUE(dialogRound_, dialogRound) };
    ...
    inline CreateAndPulishAgentRequestApplicationConfigParameters& setEnableThinking(bool enableThinking) { DARABONBA_PTR_SET_VALUE(enableThinking_, enableThinking) };
    ...
    inline CreateAndPulishAgentRequestApplicationConfigParameters& setMaxTokens(int32_t maxTokens) { DARABONBA_PTR_SET_VALUE(maxTokens_, maxTokens) };
    ...
    inline CreateAndPulishAgentRequestApplicationConfigParameters& setTemperature(double temperature) { DARABONBA_PTR_SET_VALUE(temperature_, temperature) };
