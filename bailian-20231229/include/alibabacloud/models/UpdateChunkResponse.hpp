...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateChunkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateChunkResponseBody) };
    inline UpdateChunkResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateChunkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateChunkResponseBody> body_ {};
  };
