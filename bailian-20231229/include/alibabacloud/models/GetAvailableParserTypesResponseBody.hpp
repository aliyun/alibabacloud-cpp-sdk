...
namespace Models
{
  ...
  public:
    ...
    inline const GetAvailableParserTypesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAvailableParserTypesResponseBodyData) };
    inline GetAvailableParserTypesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAvailableParserTypesResponseBodyData) };
    inline GetAvailableParserTypesResponseBody& setData(const GetAvailableParserTypesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAvailableParserTypesResponseBody& setData(GetAvailableParserTypesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAvailableParserTypesResponseBodyData> data_ = nullptr;
