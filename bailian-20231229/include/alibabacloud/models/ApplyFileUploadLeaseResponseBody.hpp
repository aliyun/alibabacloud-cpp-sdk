...
#ifndef ALIBABACLOUD_MODELS_APPLYFILEUPLOADLEASERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_APPLYFILEUPLOADLEASERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ApplyFileUploadLeaseResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ApplyFileUploadLeaseResponseBody& obj) { 
    ...
    ApplyFileUploadLeaseResponseBody() = default ;
    ApplyFileUploadLeaseResponseBody(const ApplyFileUploadLeaseResponseBody &) = default ;
    ApplyFileUploadLeaseResponseBody(ApplyFileUploadLeaseResponseBody &&) = default ;
    ApplyFileUploadLeaseResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ApplyFileUploadLeaseResponseBody() = default ;
    ApplyFileUploadLeaseResponseBody& operator=(const ApplyFileUploadLeaseResponseBody &) = default ;
    ApplyFileUploadLeaseResponseBody& operator=(ApplyFileUploadLeaseResponseBody &&) = default ;
    ...
    public:
      ...
      inline string getFileUploadLeaseId() const { DARABONBA_PTR_GET_DEFAULT(fileUploadLeaseId_, "") };
      inline Data& setFileUploadLeaseId(string fileUploadLeaseId) { DARABONBA_PTR_SET_VALUE(fileUploadLeaseId_, fileUploadLeaseId) };
    ...
    inline ApplyFileUploadLeaseResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ApplyFileUploadLeaseResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ApplyFileUploadLeaseResponseBody::Data) };
    inline ApplyFileUploadLeaseResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ApplyFileUploadLeaseResponseBody::Data) };
    inline ApplyFileUploadLeaseResponseBody& setData(const ApplyFileUploadLeaseResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ApplyFileUploadLeaseResponseBody& setData(ApplyFileUploadLeaseResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ApplyFileUploadLeaseResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ApplyFileUploadLeaseResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ApplyFileUploadLeaseResponseBody& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ApplyFileUploadLeaseResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
