...
namespace Models
{
  ...
  public:
    ...
    inline int32_t denseSimilarityTopK() const { DARABONBA_PTR_GET_DEFAULT(denseSimilarityTopK_, 0) };
    ...
    inline bool enableReranking() const { DARABONBA_PTR_GET_DEFAULT(enableReranking_, false) };
    ...
    inline const vector<RetrieveRequestQueryHistory> & queryHistory() const { DARABONBA_PTR_GET_CONST(queryHistory_, vector<RetrieveRequestQueryHistory>) };
    inline vector<RetrieveRequestQueryHistory> queryHistory() { DARABONBA_PTR_GET(queryHistory_, vector<RetrieveRequestQueryHistory>) };
    inline RetrieveRequest& setQueryHistory(const vector<RetrieveRequestQueryHistory> & queryHistory) { DARABONBA_PTR_SET_VALUE(queryHistory_, queryHistory) };
    inline RetrieveRequest& setQueryHistory(vector<RetrieveRequestQueryHistory> && queryHistory) { DARABONBA_PTR_SET_RVALUE(queryHistory_, queryHistory) };


    // rerank Field Functions 
    bool hasRerank() const { return this->rerank_ != nullptr;};
    void deleteRerank() { this->rerank_ = nullptr;};
    inline const vector<RetrieveRequestRerank> & rerank() const { DARABONBA_PTR_GET_CONST(rerank_, vector<RetrieveRequestRerank>) };
    inline vector<RetrieveRequestRerank> rerank() { DARABONBA_PTR_GET(rerank_, vector<RetrieveRequestRerank>) };
    inline RetrieveRequest& setRerank(const vector<RetrieveRequestRerank> & rerank) { DARABONBA_PTR_SET_VALUE(rerank_, rerank) };
    inline RetrieveRequest& setRerank(vector<RetrieveRequestRerank> && rerank) { DARABONBA_PTR_SET_RVALUE(rerank_, rerank) };
    ...
    inline float rerankMinScore() const { DARABONBA_PTR_GET_DEFAULT(rerankMinScore_, 0.0) };
    ...
    inline int32_t rerankTopN() const { DARABONBA_PTR_GET_DEFAULT(rerankTopN_, 0) };
    ...
    inline const vector<RetrieveRequestRewrite> & rewrite() const { DARABONBA_PTR_GET_CONST(rewrite_, vector<RetrieveRequestRewrite>) };
    inline vector<RetrieveRequestRewrite> rewrite() { DARABONBA_PTR_GET(rewrite_, vector<RetrieveRequestRewrite>) };
    inline RetrieveRequest& setRewrite(const vector<RetrieveRequestRewrite> & rewrite) { DARABONBA_PTR_SET_VALUE(rewrite_, rewrite) };
    inline RetrieveRequest& setRewrite(vector<RetrieveRequestRewrite> && rewrite) { DARABONBA_PTR_SET_RVALUE(rewrite_, rewrite) };
    ...
    inline bool saveRetrieverHistory() const { DARABONBA_PTR_GET_DEFAULT(saveRetrieverHistory_, false) };
    ...
    inline const vector<map<string, string>> & searchFilters() const { DARABONBA_PTR_GET_CONST(searchFilters_, vector<map<string, string>>) };
    inline vector<map<string, string>> searchFilters() { DARABONBA_PTR_GET(searchFilters_, vector<map<string, string>>) };
    ...
    inline int32_t sparseSimilarityTopK() const { DARABONBA_PTR_GET_DEFAULT(sparseSimilarityTopK_, 0) };
  ...
  protected:
    ...
    // 
    // Default value: 100.
    std::shared_ptr<int32_t> denseSimilarityTopK_ = nullptr;
    ...
    // 
    // Default value: true.
    std::shared_ptr<bool> enableReranking_ = nullptr;
    ...
    std::shared_ptr<vector<RetrieveRequestQueryHistory>> queryHistory_ = nullptr;
    // Ranking configurations.
    std::shared_ptr<vector<RetrieveRequestRerank>> rerank_ = nullptr;
    ...
    std::shared_ptr<float> rerankMinScore_ = nullptr;
    // The top N return data after reranking. Valid values: 1 to 20. Default value: 5.
    std::shared_ptr<int32_t> rerankTopN_ = nullptr;
    // Conversation rewriting configurations.
    std::shared_ptr<vector<RetrieveRequestRewrite>> rewrite_ = nullptr;
    ...
    // 
    // Default value: false.
    std::shared_ptr<bool> saveRetrieverHistory_ = nullptr;
    ...
    std::shared_ptr<vector<map<string, string>>> searchFilters_ = nullptr;
    ...
    // 
    // Default value: 100.
    std::shared_ptr<int32_t> sparseSimilarityTopK_ = nullptr;
  };
