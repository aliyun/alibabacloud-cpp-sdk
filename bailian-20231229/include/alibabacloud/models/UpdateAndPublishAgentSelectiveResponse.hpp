...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAndPublishAgentSelectiveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAndPublishAgentSelectiveResponseBody) };
    inline UpdateAndPublishAgentSelectiveResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAndPublishAgentSelectiveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAndPublishAgentSelectiveResponseBody> body_ {};
  };
