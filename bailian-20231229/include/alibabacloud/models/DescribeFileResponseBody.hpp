...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFileResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeFileResponseBodyData) };
    inline DescribeFileResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeFileResponseBodyData) };
    inline DescribeFileResponseBody& setData(const DescribeFileResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeFileResponseBody& setData(DescribeFileResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeFileResponseBodyData> data_ = nullptr;
    // The error message.
