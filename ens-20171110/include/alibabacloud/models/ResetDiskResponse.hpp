...
namespace Models
{
  ...
  public:
    ...
    inline const ResetDiskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResetDiskResponseBody) };
    inline ResetDiskResponseBody getBody() { DARABONBA_PTR_GET(body_, ResetDiskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResetDiskResponseBody> body_ {};
  };
