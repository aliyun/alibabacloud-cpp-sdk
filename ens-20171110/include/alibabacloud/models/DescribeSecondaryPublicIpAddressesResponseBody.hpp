...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->secondaryPublicIpAddresses_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const vector<DescribeSecondaryPublicIpAddressesResponseBodySecondaryPublicIpAddresses> & secondaryPublicIpAddresses() const { DARABONBA_PTR_GET_CONST(secondaryPublicIpAddresses_, vector<DescribeSecondaryPublicIpAddressesResponseBodySecondaryPublicIpAddresses>) };
    inline vector<DescribeSecondaryPublicIpAddressesResponseBodySecondaryPublicIpAddresses> secondaryPublicIpAddresses() { DARABONBA_PTR_GET(secondaryPublicIpAddresses_, vector<DescribeSecondaryPublicIpAddressesResponseBodySecondaryPublicIpAddresses>) };
    inline DescribeSecondaryPublicIpAddressesResponseBody& setSecondaryPublicIpAddresses(const vector<DescribeSecondaryPublicIpAddressesResponseBodySecondaryPublicIpAddresses> & secondaryPublicIpAddresses) { DARABONBA_PTR_SET_VALUE(secondaryPublicIpAddresses_, secondaryPublicIpAddresses) };
    inline DescribeSecondaryPublicIpAddressesResponseBody& setSecondaryPublicIpAddresses(vector<DescribeSecondaryPublicIpAddressesResponseBodySecondaryPublicIpAddresses> && secondaryPublicIpAddresses) { DARABONBA_PTR_SET_RVALUE(secondaryPublicIpAddresses_, secondaryPublicIpAddresses) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeSecondaryPublicIpAddressesResponseBodySecondaryPublicIpAddresses>> secondaryPublicIpAddresses_ = nullptr;
