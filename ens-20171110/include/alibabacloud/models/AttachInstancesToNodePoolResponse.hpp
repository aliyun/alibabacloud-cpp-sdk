...
namespace Models
{
  ...
  public:
    ...
    inline const AttachInstancesToNodePoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachInstancesToNodePoolResponseBody) };
    inline AttachInstancesToNodePoolResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachInstancesToNodePoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachInstancesToNodePoolResponseBody> body_ {};
  };
