...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSDGSharedDisksResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSDGSharedDisksResponseBody) };
    inline DescribeSDGSharedDisksResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSDGSharedDisksResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSDGSharedDisksResponseBody> body_ = nullptr;
  };
