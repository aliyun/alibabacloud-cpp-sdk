...
namespace Models
{
  ...
  public:
    ...
    inline const StartEpnInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartEpnInstanceResponseBody) };
    inline StartEpnInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, StartEpnInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartEpnInstanceResponseBody> body_ {};
  };
