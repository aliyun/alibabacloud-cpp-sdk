...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceBootConfigurationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceBootConfigurationResponseBody) };
    inline ModifyInstanceBootConfigurationResponseBody body() { DARABONBA_PTR_GET(body_, ModifyInstanceBootConfigurationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyInstanceBootConfigurationResponseBody> body_ = nullptr;
  };
