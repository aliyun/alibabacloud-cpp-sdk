...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSDGResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeleteSDGResponseBodyData) };
    inline DeleteSDGResponseBodyData data() { DARABONBA_PTR_GET(data_, DeleteSDGResponseBodyData) };
    inline DeleteSDGResponseBody& setData(const DeleteSDGResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteSDGResponseBody& setData(DeleteSDGResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteSDGResponseBodyData> data_ = nullptr;
    // The request ID.
