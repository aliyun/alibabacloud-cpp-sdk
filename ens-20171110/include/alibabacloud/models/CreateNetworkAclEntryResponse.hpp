...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNetworkAclEntryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateNetworkAclEntryResponseBody) };
    inline CreateNetworkAclEntryResponseBody body() { DARABONBA_PTR_GET(body_, CreateNetworkAclEntryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateNetworkAclEntryResponseBody> body_ = nullptr;
  };
