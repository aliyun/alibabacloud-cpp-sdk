...
#ifndef ALIBABACLOUD_MODELS_UNLOADREGIONSDGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UNLOADREGIONSDGRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UnloadRegionSDGResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, UnloadRegionSDGResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    UnloadRegionSDGResponseBody() = default ;
    UnloadRegionSDGResponseBody(const UnloadRegionSDGResponseBody &) = default ;
    UnloadRegionSDGResponseBody(UnloadRegionSDGResponseBody &&) = default ;
    UnloadRegionSDGResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UnloadRegionSDGResponseBody() = default ;
    UnloadRegionSDGResponseBody& operator=(const UnloadRegionSDGResponseBody &) = default ;
    UnloadRegionSDGResponseBody& operator=(UnloadRegionSDGResponseBody &&) = default ;
    ...
    inline const UnloadRegionSDGResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UnloadRegionSDGResponseBody::Data) };
    inline UnloadRegionSDGResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UnloadRegionSDGResponseBody::Data) };
    inline UnloadRegionSDGResponseBody& setData(const UnloadRegionSDGResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UnloadRegionSDGResponseBody& setData(UnloadRegionSDGResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UnloadRegionSDGResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The returned data object.
    shared_ptr<UnloadRegionSDGResponseBody::Data> data_ {};
    // The request ID.
