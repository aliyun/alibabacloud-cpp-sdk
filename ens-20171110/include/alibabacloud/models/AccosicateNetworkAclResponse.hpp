...
namespace Models
{
  ...
  public:
    ...
    inline const AccosicateNetworkAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AccosicateNetworkAclResponseBody) };
    inline AccosicateNetworkAclResponseBody getBody() { DARABONBA_PTR_GET(body_, AccosicateNetworkAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AccosicateNetworkAclResponseBody> body_ {};
  };
