...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAvailableResourceInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAvailableResourceInfoResponseBody) };
    inline DescribeAvailableResourceInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAvailableResourceInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAvailableResourceInfoResponseBody> body_ {};
  };
