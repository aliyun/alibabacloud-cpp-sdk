...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Nodepool& setClusterId(string clusterId) { DARABONBA_PTR_SET_VALUE(clusterId_, clusterId) };
      ...
      inline const Nodepool::Status & getStatus() const { DARABONBA_PTR_GET_CONST(status_, Nodepool::Status) };
      inline Nodepool::Status getStatus() { DARABONBA_PTR_GET(status_, Nodepool::Status) };
      inline Nodepool& setStatus(const Nodepool::Status & status) { DARABONBA_PTR_SET_VALUE(status_, status) };
      inline Nodepool& setStatus(Nodepool::Status && status) { DARABONBA_PTR_SET_RVALUE(status_, status) };
    ...
    protected:
      ...
      shared_ptr<Nodepool::Status> status_ {};
    };

    virtual bool empty() const override { return this->nodepool_ == nullptr
    ...
    inline const CreateClusterNodePoolResponseBody::Nodepool & getNodepool() const { DARABONBA_PTR_GET_CONST(nodepool_, CreateClusterNodePoolResponseBody::Nodepool) };
    inline CreateClusterNodePoolResponseBody::Nodepool getNodepool() { DARABONBA_PTR_GET(nodepool_, CreateClusterNodePoolResponseBody::Nodepool) };
    inline CreateClusterNodePoolResponseBody& setNodepool(const CreateClusterNodePoolResponseBody::Nodepool & nodepool) { DARABONBA_PTR_SET_VALUE(nodepool_, nodepool) };
    inline CreateClusterNodePoolResponseBody& setNodepool(CreateClusterNodePoolResponseBody::Nodepool && nodepool) { DARABONBA_PTR_SET_RVALUE(nodepool_, nodepool) };
  ...
  protected:
    shared_ptr<CreateClusterNodePoolResponseBody::Nodepool> nodepool_ {};
