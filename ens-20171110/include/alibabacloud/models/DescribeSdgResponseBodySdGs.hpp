...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->avaliableRegionIds_ == nullptr
        ...
        && return this->creationTime_ == nullptr && return this->description_ == nullptr && return this->parentSDGId_ == nullptr && return this->performanceLevel_ == nullptr && return this->preloadInfos_ == nullptr
    ...
    inline DescribeSDGResponseBodySDGs& setBillingType(string billingType) { DARABONBA_PTR_SET_VALUE(billingType_, billingType) };
