  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline EnsNetDistrict& setInstanceCount(string instanceCount) { DARABONBA_PTR_SET_VALUE(instanceCount_, instanceCount) };
    ...
    inline const DescribeEnsNetSaleDistrictResponseBody::EnsNetDistricts & getEnsNetDistricts() const { DARABONBA_PTR_GET_CONST(ensNetDistricts_, DescribeEnsNetSaleDistrictResponseBody::EnsNetDistricts) };
    inline DescribeEnsNetSaleDistrictResponseBody::EnsNetDistricts getEnsNetDistricts() { DARABONBA_PTR_GET(ensNetDistricts_, DescribeEnsNetSaleDistrictResponseBody::EnsNetDistricts) };
    inline DescribeEnsNetSaleDistrictResponseBody& setEnsNetDistricts(const DescribeEnsNetSaleDistrictResponseBody::EnsNetDistricts & ensNetDistricts) { DARABONBA_PTR_SET_VALUE(ensNetDistricts_, ensNetDistricts) };
    inline DescribeEnsNetSaleDistrictResponseBody& setEnsNetDistricts(DescribeEnsNetSaleDistrictResponseBody::EnsNetDistricts && ensNetDistricts) { DARABONBA_PTR_SET_RVALUE(ensNetDistricts_, ensNetDistricts) };
