...
namespace Models
{
  ...
  public:
    ...
    inline const ResizeDiskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResizeDiskResponseBody) };
    inline ResizeDiskResponseBody getBody() { DARABONBA_PTR_GET(body_, ResizeDiskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResizeDiskResponseBody> body_ {};
  };
