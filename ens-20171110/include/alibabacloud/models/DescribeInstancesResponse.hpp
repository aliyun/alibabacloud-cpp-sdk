...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstancesResponseBody) };
    inline DescribeInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstancesResponseBody> body_ {};
  };
