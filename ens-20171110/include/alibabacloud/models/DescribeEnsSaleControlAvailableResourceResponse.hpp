...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnsSaleControlAvailableResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEnsSaleControlAvailableResourceResponseBody) };
    inline DescribeEnsSaleControlAvailableResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEnsSaleControlAvailableResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEnsSaleControlAvailableResourceResponseBody> body_ {};
  };
