...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceMonitorDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceMonitorDataResponseBody) };
    inline DescribeInstanceMonitorDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceMonitorDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceMonitorDataResponseBody> body_ {};
  };
