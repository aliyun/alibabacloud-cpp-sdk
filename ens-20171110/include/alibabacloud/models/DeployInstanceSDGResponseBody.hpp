...
#ifndef ALIBABACLOUD_MODELS_DEPLOYINSTANCESDGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYINSTANCESDGRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeployInstanceSDGResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DeployInstanceSDGResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DeployInstanceSDGResponseBody() = default ;
    DeployInstanceSDGResponseBody(const DeployInstanceSDGResponseBody &) = default ;
    DeployInstanceSDGResponseBody(DeployInstanceSDGResponseBody &&) = default ;
    DeployInstanceSDGResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeployInstanceSDGResponseBody() = default ;
    DeployInstanceSDGResponseBody& operator=(const DeployInstanceSDGResponseBody &) = default ;
    DeployInstanceSDGResponseBody& operator=(DeployInstanceSDGResponseBody &&) = default ;
    ...
    inline const DeployInstanceSDGResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeployInstanceSDGResponseBody::Data) };
    inline DeployInstanceSDGResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeployInstanceSDGResponseBody::Data) };
    inline DeployInstanceSDGResponseBody& setData(const DeployInstanceSDGResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeployInstanceSDGResponseBody& setData(DeployInstanceSDGResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DeployInstanceSDGResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The returned data object.
    shared_ptr<DeployInstanceSDGResponseBody::Data> data_ {};
    // The request ID.
