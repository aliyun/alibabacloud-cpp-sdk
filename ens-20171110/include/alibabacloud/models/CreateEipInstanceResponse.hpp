...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEipInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateEipInstanceResponseBody) };
    inline CreateEipInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateEipInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateEipInstanceResponseBody> body_ {};
  };
