...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeReservedResourceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeReservedResourceResponseBody) };
    inline DescribeReservedResourceResponseBody body() { DARABONBA_PTR_GET(body_, DescribeReservedResourceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeReservedResourceResponseBody> body_ = nullptr;
  };
