...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeEnsRouteTablesResponseBodyRouteTables> & routeTables() const { DARABONBA_PTR_GET_CONST(routeTables_, vector<DescribeEnsRouteTablesResponseBodyRouteTables>) };
    inline vector<DescribeEnsRouteTablesResponseBodyRouteTables> routeTables() { DARABONBA_PTR_GET(routeTables_, vector<DescribeEnsRouteTablesResponseBodyRouteTables>) };
    inline DescribeEnsRouteTablesResponseBody& setRouteTables(const vector<DescribeEnsRouteTablesResponseBodyRouteTables> & routeTables) { DARABONBA_PTR_SET_VALUE(routeTables_, routeTables) };
    inline DescribeEnsRouteTablesResponseBody& setRouteTables(vector<DescribeEnsRouteTablesResponseBodyRouteTables> && routeTables) { DARABONBA_PTR_SET_RVALUE(routeTables_, routeTables) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeEnsRouteTablesResponseBodyRouteTables>> routeTables_ = nullptr;
