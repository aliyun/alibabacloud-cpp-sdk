...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveInstanceSDGResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveInstanceSDGResponseBody) };
    inline RemoveInstanceSDGResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveInstanceSDGResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveInstanceSDGResponseBody> body_ {};
  };
