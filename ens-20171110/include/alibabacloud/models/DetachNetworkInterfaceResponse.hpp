...
namespace Models
{
  ...
  public:
    ...
    inline const DetachNetworkInterfaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachNetworkInterfaceResponseBody) };
    inline DetachNetworkInterfaceResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachNetworkInterfaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachNetworkInterfaceResponseBody> body_ {};
  };
