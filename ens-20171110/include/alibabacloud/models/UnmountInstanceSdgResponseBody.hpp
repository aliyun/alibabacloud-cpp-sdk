...
namespace Models
{
  ...
  public:
    ...
    inline const UnmountInstanceSDGResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UnmountInstanceSDGResponseBody::Data) };
    inline UnmountInstanceSDGResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UnmountInstanceSDGResponseBody::Data) };
    inline UnmountInstanceSDGResponseBody& setData(const UnmountInstanceSDGResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UnmountInstanceSDGResponseBody& setData(UnmountInstanceSDGResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<UnmountInstanceSDGResponseBody::Data> data_ {};
    // The request ID.
