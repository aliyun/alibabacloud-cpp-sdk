...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->natGatewayId_ == nullptr
        && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->snatEntryId_ == nullptr && return this->snatEntryName_ == nullptr && return this->snatIp_ == nullptr
        && return this->snatIps_ == nullptr && return this->sourceCIDR_ == nullptr; };
