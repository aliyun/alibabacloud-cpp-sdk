...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getSnatIps() const { DARABONBA_PTR_GET_CONST(snatIps_, vector<string>) };
    inline vector<string> getSnatIps() { DARABONBA_PTR_GET(snatIps_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> snatIps_ {};
