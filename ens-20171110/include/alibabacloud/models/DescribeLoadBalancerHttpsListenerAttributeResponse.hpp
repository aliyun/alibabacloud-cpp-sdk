...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLoadBalancerHTTPSListenerAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLoadBalancerHTTPSListenerAttributeResponseBody) };
    inline DescribeLoadBalancerHTTPSListenerAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLoadBalancerHTTPSListenerAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLoadBalancerHTTPSListenerAttributeResponseBody> body_ {};
  };
