...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLoadBalancerAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLoadBalancerAttributeResponseBody) };
    inline ModifyLoadBalancerAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLoadBalancerAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLoadBalancerAttributeResponseBody> body_ {};
  };
