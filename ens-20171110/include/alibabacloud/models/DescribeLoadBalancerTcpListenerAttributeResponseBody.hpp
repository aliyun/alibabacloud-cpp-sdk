...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backendServerPort_ == nullptr
        ...
        && return this->healthCheckType_ == nullptr && return this->healthCheckURI_ == nullptr && return this->healthyThreshold_ == nullptr && return this->listenerPort_ == nullptr && return this->persistenceTimeout_ == nullptr
        && return this->requestId_ == nullptr && return this->scheduler_ == nullptr && return this->status_ == nullptr && return this->unhealthyThreshold_ == nullptr; };
