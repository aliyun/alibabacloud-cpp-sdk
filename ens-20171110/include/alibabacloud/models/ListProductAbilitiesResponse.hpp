...
namespace Models
{
  ...
  public:
    ...
    inline const ListProductAbilitiesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListProductAbilitiesResponseBody) };
    inline ListProductAbilitiesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListProductAbilitiesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListProductAbilitiesResponseBody> body_ {};
  };
