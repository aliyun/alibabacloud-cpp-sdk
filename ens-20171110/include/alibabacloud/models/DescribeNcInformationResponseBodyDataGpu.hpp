...
#ifndef ALIBABACLOUD_MODELS_DESCRIBENCINFORMATIONRESPONSEBODYDATAGPU_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBENCINFORMATIONRESPONSEBODYDATAGPU_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeNCInformationResponseBodyDataGpu& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeNCInformationResponseBodyDataGpu& obj) { 
    ...
    DescribeNCInformationResponseBodyDataGpu() = default ;
    DescribeNCInformationResponseBodyDataGpu(const DescribeNCInformationResponseBodyDataGpu &) = default ;
    DescribeNCInformationResponseBodyDataGpu(DescribeNCInformationResponseBodyDataGpu &&) = default ;
    DescribeNCInformationResponseBodyDataGpu(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeNCInformationResponseBodyDataGpu() = default ;
    DescribeNCInformationResponseBodyDataGpu& operator=(const DescribeNCInformationResponseBodyDataGpu &) = default ;
    DescribeNCInformationResponseBodyDataGpu& operator=(DescribeNCInformationResponseBodyDataGpu &&) = default ;
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setDisplay(bool display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setOversellRatio(int64_t oversellRatio) { DARABONBA_PTR_SET_VALUE(oversellRatio_, oversellRatio) };
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setRemain(int64_t remain) { DARABONBA_PTR_SET_VALUE(remain_, remain) };
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setReserveDisable(bool reserveDisable) { DARABONBA_PTR_SET_VALUE(reserveDisable_, reserveDisable) };
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setReserveDisableTotal(int64_t reserveDisableTotal) { DARABONBA_PTR_SET_VALUE(reserveDisableTotal_, reserveDisableTotal) };
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setStatusDisable(bool statusDisable) { DARABONBA_PTR_SET_VALUE(statusDisable_, statusDisable) };
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setStatusDisableTotal(int64_t statusDisableTotal) { DARABONBA_PTR_SET_VALUE(statusDisableTotal_, statusDisableTotal) };
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setUsed(int64_t used) { DARABONBA_PTR_SET_VALUE(used_, used) };
    ...
    inline DescribeNCInformationResponseBodyDataGpu& setUsedRatio(int64_t usedRatio) { DARABONBA_PTR_SET_VALUE(usedRatio_, usedRatio) };
