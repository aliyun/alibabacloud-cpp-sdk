...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateNetworkRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateNetworkRequest::Tag>) };
    inline vector<CreateNetworkRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateNetworkRequest::Tag>) };
    inline CreateNetworkRequest& setTag(const vector<CreateNetworkRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateNetworkRequest& setTag(vector<CreateNetworkRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The resource tags.
    shared_ptr<vector<CreateNetworkRequest::Tag>> tag_ {};
  };
