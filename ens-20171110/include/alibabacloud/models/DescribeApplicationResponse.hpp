...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApplicationResponseBody) };
    inline DescribeApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApplicationResponseBody> body_ {};
  };
