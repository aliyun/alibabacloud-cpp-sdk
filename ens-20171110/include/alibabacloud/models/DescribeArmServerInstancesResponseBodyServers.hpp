...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AICInstances_ == nullptr
        && return this->creationTime_ == nullptr && return this->ensRegionId_ == nullptr && return this->expiredTime_ == nullptr && return this->latestAction_ == nullptr && return this->name_ == nullptr
        && return this->namespace_ == nullptr && return this->payType_ == nullptr && return this->serverId_ == nullptr && return this->specName_ == nullptr && return this->state_ == nullptr
