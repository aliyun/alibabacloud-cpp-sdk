...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bucketAcl_ == nullptr
        && return this->bucketName_ == nullptr && return this->comment_ == nullptr && return this->createTime_ == nullptr && return this->ensRegionId_ == nullptr && return this->logicalBucketType_ == nullptr
        && return this->modifyTime_ == nullptr; };
