...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeElbAvailableResourceInfoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeElbAvailableResourceInfoResponseBody) };
    inline DescribeElbAvailableResourceInfoResponseBody body() { DARABONBA_PTR_GET(body_, DescribeElbAvailableResourceInfoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeElbAvailableResourceInfoResponseBody> body_ = nullptr;
  };
