...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEREGIONRESOURCERESPONSEBODYDATASSD_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEREGIONRESOURCERESPONSEBODYDATASSD_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeRegionResourceResponseBodyDataSsd& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeRegionResourceResponseBodyDataSsd& obj) { 
    ...
    DescribeRegionResourceResponseBodyDataSsd() = default ;
    DescribeRegionResourceResponseBodyDataSsd(const DescribeRegionResourceResponseBodyDataSsd &) = default ;
    DescribeRegionResourceResponseBodyDataSsd(DescribeRegionResourceResponseBodyDataSsd &&) = default ;
    DescribeRegionResourceResponseBodyDataSsd(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeRegionResourceResponseBodyDataSsd() = default ;
    DescribeRegionResourceResponseBodyDataSsd& operator=(const DescribeRegionResourceResponseBodyDataSsd &) = default ;
    DescribeRegionResourceResponseBodyDataSsd& operator=(DescribeRegionResourceResponseBodyDataSsd &&) = default ;
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setDisplay(bool display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setOversellRatio(int64_t oversellRatio) { DARABONBA_PTR_SET_VALUE(oversellRatio_, oversellRatio) };
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setRemain(int64_t remain) { DARABONBA_PTR_SET_VALUE(remain_, remain) };
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setReserveDisable(bool reserveDisable) { DARABONBA_PTR_SET_VALUE(reserveDisable_, reserveDisable) };
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setReserveDisableTotal(int64_t reserveDisableTotal) { DARABONBA_PTR_SET_VALUE(reserveDisableTotal_, reserveDisableTotal) };
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setStatusDisable(bool statusDisable) { DARABONBA_PTR_SET_VALUE(statusDisable_, statusDisable) };
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setStatusDisableTotal(int64_t statusDisableTotal) { DARABONBA_PTR_SET_VALUE(statusDisableTotal_, statusDisableTotal) };
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setUsed(int64_t used) { DARABONBA_PTR_SET_VALUE(used_, used) };
    ...
    inline DescribeRegionResourceResponseBodyDataSsd& setUsedRatio(int64_t usedRatio) { DARABONBA_PTR_SET_VALUE(usedRatio_, usedRatio) };
