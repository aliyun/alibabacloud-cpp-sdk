...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeStorageGatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeStorageGatewayResponseBody) };
    inline DescribeStorageGatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeStorageGatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeStorageGatewayResponseBody> body_ {};
  };
