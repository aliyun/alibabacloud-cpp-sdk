...
namespace Models
{
  ...
  public:
    ...
    inline string getAuthPassword() const { DARABONBA_PTR_GET_DEFAULT(authPassword_, "") };
    ...
    inline string getAuthUser() const { DARABONBA_PTR_GET_DEFAULT(authUser_, "") };
