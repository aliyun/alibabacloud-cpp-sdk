...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deleteAfterImageUpload_ == nullptr
        && this->imageName_ == nullptr && this->instanceId_ == nullptr && this->snapshotId_ == nullptr && this->targetOSSRegionId_ == nullptr && this->withDataDisks_ == nullptr; };
    ...
    inline string getDeleteAfterImageUpload() const { DARABONBA_PTR_GET_DEFAULT(deleteAfterImageUpload_, "") };
    ...
    inline bool getWithDataDisks() const { DARABONBA_PTR_GET_DEFAULT(withDataDisks_, false) };
  ...
  protected:
    ...
    shared_ptr<string> deleteAfterImageUpload_ {};
    ...
    shared_ptr<bool> withDataDisks_ {};
  };
