...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeClusterAddonsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeClusterAddonsResponseBody) };
    inline UpgradeClusterAddonsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeClusterAddonsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeClusterAddonsResponseBody> body_ {};
  };
