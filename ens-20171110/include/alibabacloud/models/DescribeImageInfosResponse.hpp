...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageInfosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageInfosResponseBody) };
    inline DescribeImageInfosResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageInfosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageInfosResponseBody> body_ {};
  };
