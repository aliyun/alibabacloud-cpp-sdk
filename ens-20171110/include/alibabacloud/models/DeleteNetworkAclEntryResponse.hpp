...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteNetworkAclEntryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteNetworkAclEntryResponseBody) };
    inline DeleteNetworkAclEntryResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteNetworkAclEntryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteNetworkAclEntryResponseBody> body_ {};
  };
