...
namespace Models
{
  ...
  public:
    ...
    inline const CreateClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateClusterResponseBody) };
    inline CreateClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateClusterResponseBody> body_ {};
  };
