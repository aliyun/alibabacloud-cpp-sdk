...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveVSwitchesFromEpnInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveVSwitchesFromEpnInstanceResponseBody) };
    inline RemoveVSwitchesFromEpnInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveVSwitchesFromEpnInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveVSwitchesFromEpnInstanceResponseBody> body_ {};
  };
