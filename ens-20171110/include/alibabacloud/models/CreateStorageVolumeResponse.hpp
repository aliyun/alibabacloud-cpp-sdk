...
namespace Models
{
  ...
  public:
    ...
    inline const CreateStorageVolumeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateStorageVolumeResponseBody) };
    inline CreateStorageVolumeResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateStorageVolumeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateStorageVolumeResponseBody> body_ {};
  };
