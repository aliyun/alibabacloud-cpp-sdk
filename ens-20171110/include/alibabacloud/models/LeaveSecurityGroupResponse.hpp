...
namespace Models
{
  ...
  public:
    ...
    inline const LeaveSecurityGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, LeaveSecurityGroupResponseBody) };
    inline LeaveSecurityGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, LeaveSecurityGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<LeaveSecurityGroupResponseBody> body_ {};
  };
