...
namespace Models
{
  ...
  public:
    ...
    inline const ScaleClusterNodePoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ScaleClusterNodePoolResponseBody) };
    inline ScaleClusterNodePoolResponseBody getBody() { DARABONBA_PTR_GET(body_, ScaleClusterNodePoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ScaleClusterNodePoolResponseBody> body_ {};
  };
