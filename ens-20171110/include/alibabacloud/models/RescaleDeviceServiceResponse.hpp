...
namespace Models
{
  ...
  public:
    ...
    inline const RescaleDeviceServiceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RescaleDeviceServiceResponseBody) };
    inline RescaleDeviceServiceResponseBody body() { DARABONBA_PTR_GET(body_, RescaleDeviceServiceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RescaleDeviceServiceResponseBody> body_ = nullptr;
  };
