...
#ifndef ALIBABACLOUD_MODELS_UPDATEENSSALECONTROLSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEENSSALECONTROLSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateEnsSaleControlShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateEnsSaleControlShrinkRequest& obj) { 
    ...
    UpdateEnsSaleControlShrinkRequest() = default ;
    UpdateEnsSaleControlShrinkRequest(const UpdateEnsSaleControlShrinkRequest &) = default ;
    UpdateEnsSaleControlShrinkRequest(UpdateEnsSaleControlShrinkRequest &&) = default ;
    UpdateEnsSaleControlShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateEnsSaleControlShrinkRequest() = default ;
    UpdateEnsSaleControlShrinkRequest& operator=(const UpdateEnsSaleControlShrinkRequest &) = default ;
    UpdateEnsSaleControlShrinkRequest& operator=(UpdateEnsSaleControlShrinkRequest &&) = default ;
    ...
    inline UpdateEnsSaleControlShrinkRequest& setAliUidAccount(string aliUidAccount) { DARABONBA_PTR_SET_VALUE(aliUidAccount_, aliUidAccount) };
    ...
    inline UpdateEnsSaleControlShrinkRequest& setCommodityCode(string commodityCode) { DARABONBA_PTR_SET_VALUE(commodityCode_, commodityCode) };
    ...
    inline UpdateEnsSaleControlShrinkRequest& setCustomAccount(string customAccount) { DARABONBA_PTR_SET_VALUE(customAccount_, customAccount) };
    ...
    inline UpdateEnsSaleControlShrinkRequest& setSaleControlsShrink(string saleControlsShrink) { DARABONBA_PTR_SET_VALUE(saleControlsShrink_, saleControlsShrink) };
