...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEnsSaleControlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteEnsSaleControlResponseBody) };
    inline DeleteEnsSaleControlResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteEnsSaleControlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteEnsSaleControlResponseBody> body_ {};
  };
