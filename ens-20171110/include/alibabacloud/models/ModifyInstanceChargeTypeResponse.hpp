...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceChargeTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceChargeTypeResponseBody) };
    inline ModifyInstanceChargeTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyInstanceChargeTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyInstanceChargeTypeResponseBody> body_ {};
  };
