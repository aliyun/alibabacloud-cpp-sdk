...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ip_ == nullptr
        && return this->port_ == nullptr && return this->serverId_ == nullptr && return this->type_ == nullptr && return this->weight_ == nullptr; };
    // ip Field Functions 
    bool hasIp() const { return this->ip_ != nullptr;};
    void deleteIp() { this->ip_ = nullptr;};
    inline string ip() const { DARABONBA_PTR_GET_DEFAULT(ip_, "") };
    inline DescribeLoadBalancerAttributeResponseBodyBackendServers& setIp(string ip) { DARABONBA_PTR_SET_VALUE(ip_, ip) };
    ...
    inline DescribeLoadBalancerAttributeResponseBodyBackendServers& setPort(string port) { DARABONBA_PTR_SET_VALUE(port_, port) };
    ...
    inline DescribeLoadBalancerAttributeResponseBodyBackendServers& setServerId(string serverId) { DARABONBA_PTR_SET_VALUE(serverId_, serverId) };
    ...
    inline DescribeLoadBalancerAttributeResponseBodyBackendServers& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeLoadBalancerAttributeResponseBodyBackendServers& setWeight(int32_t weight) { DARABONBA_PTR_SET_VALUE(weight_, weight) };
