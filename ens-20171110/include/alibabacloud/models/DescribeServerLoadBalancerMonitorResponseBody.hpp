...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeServerLoadBalancerMonitorResponseBodyServerLoadBalancerMonitorData> & serverLoadBalancerMonitorData() const { DARABONBA_PTR_GET_CONST(serverLoadBalancerMonitorData_, vector<DescribeServerLoadBalancerMonitorResponseBodyServerLoadBalancerMonitorData>) };
    inline vector<DescribeServerLoadBalancerMonitorResponseBodyServerLoadBalancerMonitorData> serverLoadBalancerMonitorData() { DARABONBA_PTR_GET(serverLoadBalancerMonitorData_, vector<DescribeServerLoadBalancerMonitorResponseBodyServerLoadBalancerMonitorData>) };
    inline DescribeServerLoadBalancerMonitorResponseBody& setServerLoadBalancerMonitorData(const vector<DescribeServerLoadBalancerMonitorResponseBodyServerLoadBalancerMonitorData> & serverLoadBalancerMonitorData) { DARABONBA_PTR_SET_VALUE(serverLoadBalancerMonitorData_, serverLoadBalancerMonitorData) };
    inline DescribeServerLoadBalancerMonitorResponseBody& setServerLoadBalancerMonitorData(vector<DescribeServerLoadBalancerMonitorResponseBodyServerLoadBalancerMonitorData> && serverLoadBalancerMonitorData) { DARABONBA_PTR_SET_RVALUE(serverLoadBalancerMonitorData_, serverLoadBalancerMonitorData) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeServerLoadBalancerMonitorResponseBodyServerLoadBalancerMonitorData>> serverLoadBalancerMonitorData_ = nullptr;
  };
