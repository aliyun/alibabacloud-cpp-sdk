...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNetworkAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateNetworkAclResponseBody) };
    inline CreateNetworkAclResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateNetworkAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateNetworkAclResponseBody> body_ {};
  };
