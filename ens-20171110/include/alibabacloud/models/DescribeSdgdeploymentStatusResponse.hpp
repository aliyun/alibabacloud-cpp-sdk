...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSDGDeploymentStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSDGDeploymentStatusResponseBody) };
    inline DescribeSDGDeploymentStatusResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSDGDeploymentStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSDGDeploymentStatusResponseBody> body_ = nullptr;
  };
