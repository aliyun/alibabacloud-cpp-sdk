...
namespace Models
{
  ...
  public:
    ...
    inline const MountInstanceSDGResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, MountInstanceSDGResponseBody::Data) };
    inline MountInstanceSDGResponseBody::Data getData() { DARABONBA_PTR_GET(data_, MountInstanceSDGResponseBody::Data) };
    inline MountInstanceSDGResponseBody& setData(const MountInstanceSDGResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline MountInstanceSDGResponseBody& setData(MountInstanceSDGResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<MountInstanceSDGResponseBody::Data> data_ {};
    // The request ID.
