...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLoadBalancerListenersResponseBodyListeners & listeners() const { DARABONBA_PTR_GET_CONST(listeners_, DescribeLoadBalancerListenersResponseBodyListeners) };
    inline DescribeLoadBalancerListenersResponseBodyListeners listeners() { DARABONBA_PTR_GET(listeners_, DescribeLoadBalancerListenersResponseBodyListeners) };
    inline DescribeLoadBalancerListenersResponseBody& setListeners(const DescribeLoadBalancerListenersResponseBodyListeners & listeners) { DARABONBA_PTR_SET_VALUE(listeners_, listeners) };
    inline DescribeLoadBalancerListenersResponseBody& setListeners(DescribeLoadBalancerListenersResponseBodyListeners && listeners) { DARABONBA_PTR_SET_RVALUE(listeners_, listeners) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLoadBalancerListenersResponseBodyListeners> listeners_ = nullptr;
    // The page number.
