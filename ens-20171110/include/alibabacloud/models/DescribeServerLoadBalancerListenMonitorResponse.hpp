...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeServerLoadBalancerListenMonitorResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeServerLoadBalancerListenMonitorResponseBody) };
    inline DescribeServerLoadBalancerListenMonitorResponseBody body() { DARABONBA_PTR_GET(body_, DescribeServerLoadBalancerListenMonitorResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeServerLoadBalancerListenMonitorResponseBody> body_ = nullptr;
  };
