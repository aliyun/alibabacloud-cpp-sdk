...
namespace Models
{
  ...
  public:
    ...
    inline const SetLoadBalancerHTTPSListenerAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetLoadBalancerHTTPSListenerAttributeResponseBody) };
    inline SetLoadBalancerHTTPSListenerAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, SetLoadBalancerHTTPSListenerAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetLoadBalancerHTTPSListenerAttributeResponseBody> body_ {};
  };
