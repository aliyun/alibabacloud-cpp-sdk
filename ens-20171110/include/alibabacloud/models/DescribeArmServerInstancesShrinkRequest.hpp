...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AICSpecsShrink_ == nullptr
        && return this->describeAICInstances_ == nullptr && return this->ensRegionIdsShrink_ == nullptr && return this->maxDate_ == nullptr && return this->minDate_ == nullptr && return this->name_ == nullptr
        && return this->namespace_ == nullptr && return this->orderByParams_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->serverIdsShrink_ == nullptr
        && return this->serverSpecsShrink_ == nullptr && return this->statesShrink_ == nullptr && return this->tagsShrink_ == nullptr; };
