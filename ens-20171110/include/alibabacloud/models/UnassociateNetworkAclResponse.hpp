...
namespace Models
{
  ...
  public:
    ...
    inline const UnassociateNetworkAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnassociateNetworkAclResponseBody) };
    inline UnassociateNetworkAclResponseBody getBody() { DARABONBA_PTR_GET(body_, UnassociateNetworkAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnassociateNetworkAclResponseBody> body_ {};
  };
