...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->keyPairFingerPrint_ != nullptr
        && this->keyPairId_ != nullptr && this->keyPairName_ != nullptr && this->privateKeyBody_ != nullptr && this->requestId_ != nullptr; };
