...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnsEipAddressesResponseBodyEipAddresses & eipAddresses() const { DARABONBA_PTR_GET_CONST(eipAddresses_, DescribeEnsEipAddressesResponseBodyEipAddresses) };
    inline DescribeEnsEipAddressesResponseBodyEipAddresses eipAddresses() { DARABONBA_PTR_GET(eipAddresses_, DescribeEnsEipAddressesResponseBodyEipAddresses) };
    inline DescribeEnsEipAddressesResponseBody& setEipAddresses(const DescribeEnsEipAddressesResponseBodyEipAddresses & eipAddresses) { DARABONBA_PTR_SET_VALUE(eipAddresses_, eipAddresses) };
    inline DescribeEnsEipAddressesResponseBody& setEipAddresses(DescribeEnsEipAddressesResponseBodyEipAddresses && eipAddresses) { DARABONBA_PTR_SET_RVALUE(eipAddresses_, eipAddresses) };
  ...
  protected:
    // Details of the EIPs.
    std::shared_ptr<DescribeEnsEipAddressesResponseBodyEipAddresses> eipAddresses_ = nullptr;
