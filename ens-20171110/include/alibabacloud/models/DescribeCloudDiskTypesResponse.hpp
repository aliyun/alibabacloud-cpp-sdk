...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudDiskTypesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudDiskTypesResponseBody) };
    inline DescribeCloudDiskTypesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCloudDiskTypesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudDiskTypesResponseBody> body_ {};
  };
