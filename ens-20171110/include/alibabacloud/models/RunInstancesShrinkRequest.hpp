...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RunInstancesShrinkRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<RunInstancesShrinkRequestTag>) };
    inline vector<RunInstancesShrinkRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<RunInstancesShrinkRequestTag>) };
    inline RunInstancesShrinkRequest& setTag(const vector<RunInstancesShrinkRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline RunInstancesShrinkRequest& setTag(vector<RunInstancesShrinkRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The tags.
    std::shared_ptr<vector<RunInstancesShrinkRequestTag>> tag_ = nullptr;
