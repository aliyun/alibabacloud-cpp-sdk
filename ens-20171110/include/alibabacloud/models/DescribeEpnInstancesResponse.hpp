...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEpnInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEpnInstancesResponseBody) };
    inline DescribeEpnInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEpnInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEpnInstancesResponseBody> body_ {};
  };
