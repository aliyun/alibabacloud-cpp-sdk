...
namespace Models
{
  ...
  public:
    ...
    inline const RenewARMServerInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RenewARMServerInstanceResponseBody) };
    inline RenewARMServerInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, RenewARMServerInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RenewARMServerInstanceResponseBody> body_ {};
  };
