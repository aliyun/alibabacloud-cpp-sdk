...
namespace Models
{
  ...
  public:
    ...
    inline const CopySDGResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CopySDGResponseBodyData) };
    inline CopySDGResponseBodyData data() { DARABONBA_PTR_GET(data_, CopySDGResponseBodyData) };
    inline CopySDGResponseBody& setData(const CopySDGResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CopySDGResponseBody& setData(CopySDGResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CopySDGResponseBodyData> data_ = nullptr;
