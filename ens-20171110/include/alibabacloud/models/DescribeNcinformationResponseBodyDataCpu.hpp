...
#ifndef ALIBABACLOUD_MODELS_DESCRIBENCINFORMATIONRESPONSEBODYDATACPU_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBENCINFORMATIONRESPONSEBODYDATACPU_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeNCInformationResponseBodyDataCpu& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeNCInformationResponseBodyDataCpu& obj) { 
    ...
    DescribeNCInformationResponseBodyDataCpu() = default ;
    DescribeNCInformationResponseBodyDataCpu(const DescribeNCInformationResponseBodyDataCpu &) = default ;
    DescribeNCInformationResponseBodyDataCpu(DescribeNCInformationResponseBodyDataCpu &&) = default ;
    DescribeNCInformationResponseBodyDataCpu(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeNCInformationResponseBodyDataCpu() = default ;
    DescribeNCInformationResponseBodyDataCpu& operator=(const DescribeNCInformationResponseBodyDataCpu &) = default ;
    DescribeNCInformationResponseBodyDataCpu& operator=(DescribeNCInformationResponseBodyDataCpu &&) = default ;
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setDisplay(bool display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setOversellRatio(int64_t oversellRatio) { DARABONBA_PTR_SET_VALUE(oversellRatio_, oversellRatio) };
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setRemain(int64_t remain) { DARABONBA_PTR_SET_VALUE(remain_, remain) };
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setReserveDisable(bool reserveDisable) { DARABONBA_PTR_SET_VALUE(reserveDisable_, reserveDisable) };
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setReserveDisableTotal(int64_t reserveDisableTotal) { DARABONBA_PTR_SET_VALUE(reserveDisableTotal_, reserveDisableTotal) };
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setStatusDisable(bool statusDisable) { DARABONBA_PTR_SET_VALUE(statusDisable_, statusDisable) };
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setStatusDisableTotal(int64_t statusDisableTotal) { DARABONBA_PTR_SET_VALUE(statusDisableTotal_, statusDisableTotal) };
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setUsed(int64_t used) { DARABONBA_PTR_SET_VALUE(used_, used) };
    ...
    inline DescribeNCInformationResponseBodyDataCpu& setUsedRatio(int64_t usedRatio) { DARABONBA_PTR_SET_VALUE(usedRatio_, usedRatio) };
