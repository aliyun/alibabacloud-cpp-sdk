...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLoadBalancerSpecResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLoadBalancerSpecResponseBody) };
    inline DescribeLoadBalancerSpecResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLoadBalancerSpecResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLoadBalancerSpecResponseBody> body_ {};
  };
