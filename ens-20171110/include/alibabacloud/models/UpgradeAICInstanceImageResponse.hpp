...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeAICInstanceImageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeAICInstanceImageResponseBody) };
    inline UpgradeAICInstanceImageResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeAICInstanceImageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeAICInstanceImageResponseBody> body_ {};
  };
