...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVSwitchAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVSwitchAttributeResponseBody) };
    inline ModifyVSwitchAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVSwitchAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVSwitchAttributeResponseBody> body_ {};
  };
