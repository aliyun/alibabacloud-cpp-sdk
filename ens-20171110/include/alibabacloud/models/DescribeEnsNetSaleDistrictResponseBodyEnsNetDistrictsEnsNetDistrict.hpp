...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ensRegionIdCount_ == nullptr
        && return this->instanceCount_ == nullptr && return this->netDistrictCode_ == nullptr && return this->netDistrictEnName_ == nullptr && return this->netDistrictFatherCode_ == nullptr && return this->netDistrictLevel_ == nullptr
        && return this->netDistrictName_ == nullptr; };
