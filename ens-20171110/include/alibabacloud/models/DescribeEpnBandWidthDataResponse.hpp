...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEpnBandWidthDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeEpnBandWidthDataResponseBody) };
    inline DescribeEpnBandWidthDataResponseBody body() { DARABONBA_PTR_GET(body_, DescribeEpnBandWidthDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEpnBandWidthDataResponseBody> body_ = nullptr;
  };
