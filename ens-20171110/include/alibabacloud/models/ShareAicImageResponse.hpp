...
namespace Models
{
  ...
  public:
    ...
    inline const ShareAICImageResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ShareAICImageResponseBody) };
    inline ShareAICImageResponseBody body() { DARABONBA_PTR_GET(body_, ShareAICImageResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ShareAICImageResponseBody> body_ = nullptr;
  };
