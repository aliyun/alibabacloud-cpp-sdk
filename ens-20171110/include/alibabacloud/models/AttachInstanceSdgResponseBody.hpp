...
namespace Models
{
  ...
  public:
    ...
    inline const AttachInstanceSDGResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, AttachInstanceSDGResponseBody::Data) };
    inline AttachInstanceSDGResponseBody::Data getData() { DARABONBA_PTR_GET(data_, AttachInstanceSDGResponseBody::Data) };
    inline AttachInstanceSDGResponseBody& setData(const AttachInstanceSDGResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AttachInstanceSDGResponseBody& setData(AttachInstanceSDGResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<AttachInstanceSDGResponseBody::Data> data_ {};
    // The request ID.
