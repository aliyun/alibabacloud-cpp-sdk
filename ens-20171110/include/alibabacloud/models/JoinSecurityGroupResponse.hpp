...
namespace Models
{
  ...
  public:
    ...
    inline const JoinSecurityGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, JoinSecurityGroupResponseBody) };
    inline JoinSecurityGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, JoinSecurityGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<JoinSecurityGroupResponseBody> body_ {};
  };
