...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDeviceServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDeviceServiceResponseBody) };
    inline DescribeDeviceServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDeviceServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDeviceServiceResponseBody> body_ {};
  };
