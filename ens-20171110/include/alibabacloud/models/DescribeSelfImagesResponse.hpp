...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSelfImagesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSelfImagesResponseBody) };
    inline DescribeSelfImagesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSelfImagesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSelfImagesResponseBody> body_ {};
  };
