...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataDistResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataDistResultResponseBody) };
    inline DescribeDataDistResultResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDataDistResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDataDistResultResponseBody> body_ {};
  };
