...
namespace Models
{
  ...
  public:
    ...
    inline const GetBucketAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetBucketAclResponseBody) };
    inline GetBucketAclResponseBody getBody() { DARABONBA_PTR_GET(body_, GetBucketAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetBucketAclResponseBody> body_ {};
  };
