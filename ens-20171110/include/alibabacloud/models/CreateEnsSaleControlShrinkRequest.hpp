...
#ifndef ALIBABACLOUD_MODELS_CREATEENSSALECONTROLSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEENSSALECONTROLSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateEnsSaleControlShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateEnsSaleControlShrinkRequest& obj) { 
    ...
    CreateEnsSaleControlShrinkRequest() = default ;
    CreateEnsSaleControlShrinkRequest(const CreateEnsSaleControlShrinkRequest &) = default ;
    CreateEnsSaleControlShrinkRequest(CreateEnsSaleControlShrinkRequest &&) = default ;
    CreateEnsSaleControlShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateEnsSaleControlShrinkRequest() = default ;
    CreateEnsSaleControlShrinkRequest& operator=(const CreateEnsSaleControlShrinkRequest &) = default ;
    CreateEnsSaleControlShrinkRequest& operator=(CreateEnsSaleControlShrinkRequest &&) = default ;
    ...
    inline CreateEnsSaleControlShrinkRequest& setAliUidAccount(string aliUidAccount) { DARABONBA_PTR_SET_VALUE(aliUidAccount_, aliUidAccount) };
    ...
    inline CreateEnsSaleControlShrinkRequest& setCommodityCode(string commodityCode) { DARABONBA_PTR_SET_VALUE(commodityCode_, commodityCode) };
    ...
    inline CreateEnsSaleControlShrinkRequest& setCustomAccount(string customAccount) { DARABONBA_PTR_SET_VALUE(customAccount_, customAccount) };
    ...
    inline CreateEnsSaleControlShrinkRequest& setSaleControlsShrink(string saleControlsShrink) { DARABONBA_PTR_SET_VALUE(saleControlsShrink_, saleControlsShrink) };
