...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeForwardEntryAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeForwardEntryAttributeResponseBody) };
    inline DescribeForwardEntryAttributeResponseBody body() { DARABONBA_PTR_GET(body_, DescribeForwardEntryAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeForwardEntryAttributeResponseBody> body_ = nullptr;
  };
