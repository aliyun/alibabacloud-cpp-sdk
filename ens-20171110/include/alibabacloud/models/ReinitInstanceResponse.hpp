...
namespace Models
{
  ...
  public:
    ...
    inline const ReinitInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReinitInstanceResponseBody) };
    inline ReinitInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ReinitInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReinitInstanceResponseBody> body_ {};
  };
