...
namespace Models
{
  ...
  public:
    ...
    inline const ReInitDiskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReInitDiskResponseBody) };
    inline ReInitDiskResponseBody getBody() { DARABONBA_PTR_GET(body_, ReInitDiskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReInitDiskResponseBody> body_ {};
  };
