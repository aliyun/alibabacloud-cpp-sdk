...
#ifndef ALIBABACLOUD_MODELS_PRELOADREGIONSDGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_PRELOADREGIONSDGRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PreloadRegionSDGResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, PreloadRegionSDGResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    PreloadRegionSDGResponseBody() = default ;
    PreloadRegionSDGResponseBody(const PreloadRegionSDGResponseBody &) = default ;
    PreloadRegionSDGResponseBody(PreloadRegionSDGResponseBody &&) = default ;
    PreloadRegionSDGResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PreloadRegionSDGResponseBody() = default ;
    PreloadRegionSDGResponseBody& operator=(const PreloadRegionSDGResponseBody &) = default ;
    PreloadRegionSDGResponseBody& operator=(PreloadRegionSDGResponseBody &&) = default ;
    ...
    inline const PreloadRegionSDGResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, PreloadRegionSDGResponseBody::Data) };
    inline PreloadRegionSDGResponseBody::Data getData() { DARABONBA_PTR_GET(data_, PreloadRegionSDGResponseBody::Data) };
    inline PreloadRegionSDGResponseBody& setData(const PreloadRegionSDGResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PreloadRegionSDGResponseBody& setData(PreloadRegionSDGResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline PreloadRegionSDGResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The returned data object.
    shared_ptr<PreloadRegionSDGResponseBody::Data> data_ {};
    // The request ID.
