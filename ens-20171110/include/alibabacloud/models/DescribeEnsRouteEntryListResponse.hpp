...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnsRouteEntryListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeEnsRouteEntryListResponseBody) };
    inline DescribeEnsRouteEntryListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeEnsRouteEntryListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEnsRouteEntryListResponseBody> body_ = nullptr;
  };
