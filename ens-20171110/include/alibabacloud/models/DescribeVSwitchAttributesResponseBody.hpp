...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->availableIpAddressCount_ == nullptr
        && return this->cidrBlock_ == nullptr && return this->createdTime_ == nullptr && return this->description_ == nullptr && return this->ensRegionId_ == nullptr && return this->haVipIds_ == nullptr
        && return this->instanceIds_ == nullptr && return this->loadBalancerIds_ == nullptr && return this->natGatewayIds_ == nullptr && return this->networkId_ == nullptr && return this->networkInterfaceIds_ == nullptr
        && return this->requestId_ == nullptr && return this->status_ == nullptr && return this->vSwitchId_ == nullptr && return this->vSwitchName_ == nullptr; };
