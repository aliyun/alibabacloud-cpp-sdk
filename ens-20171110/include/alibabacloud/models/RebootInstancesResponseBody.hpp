...
namespace Models
{
  ...
  public:
    ...
    inline RebootInstancesResponseBody& setInstanceResponses(const vector<InstanceOperateResponse> & instanceResponses) { DARABONBA_PTR_SET_VALUE(instanceResponses_, instanceResponses) };
    inline RebootInstancesResponseBody& setInstanceResponses(vector<InstanceOperateResponse> && instanceResponses) { DARABONBA_PTR_SET_RVALUE(instanceResponses_, instanceResponses) };
