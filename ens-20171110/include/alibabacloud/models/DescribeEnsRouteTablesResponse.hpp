...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnsRouteTablesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEnsRouteTablesResponseBody) };
    inline DescribeEnsRouteTablesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEnsRouteTablesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEnsRouteTablesResponseBody> body_ {};
  };
