...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appVersions_ == nullptr
        && return this->clusterNames_ == nullptr && return this->level_ == nullptr && return this->maxDate_ == nullptr && return this->minDate_ == nullptr && return this->outAppInfoParams_ == nullptr
    ...
    inline string clusterNames() const { DARABONBA_PTR_GET_DEFAULT(clusterNames_, "") };
    ...
    inline string outAppInfoParams() const { DARABONBA_PTR_GET_DEFAULT(outAppInfoParams_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> clusterNames_ = nullptr;
    ...
    std::shared_ptr<string> outAppInfoParams_ = nullptr;
