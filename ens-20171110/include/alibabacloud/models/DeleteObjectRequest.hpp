...
#ifndef ALIBABACLOUD_MODELS_DELETEOBJECTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETEOBJECTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteObjectRequest& obj) { 
      DARABONBA_PTR_TO_JSON(BucketName, bucketName_);
      DARABONBA_PTR_TO_JSON(ObjectKey, objectKey_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteObjectRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(BucketName, bucketName_);
      DARABONBA_PTR_FROM_JSON(ObjectKey, objectKey_);
    };
    DeleteObjectRequest() = default ;
    DeleteObjectRequest(const DeleteObjectRequest &) = default ;
    DeleteObjectRequest(DeleteObjectRequest &&) = default ;
    DeleteObjectRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteObjectRequest() = default ;
    DeleteObjectRequest& operator=(const DeleteObjectRequest &) = default ;
    DeleteObjectRequest& operator=(DeleteObjectRequest &&) = default ;
