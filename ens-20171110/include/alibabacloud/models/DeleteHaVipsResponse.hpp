...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHaVipsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHaVipsResponseBody) };
    inline DeleteHaVipsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHaVipsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHaVipsResponseBody> body_ {};
  };
