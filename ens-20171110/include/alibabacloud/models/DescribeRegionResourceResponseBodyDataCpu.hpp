...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEREGIONRESOURCERESPONSEBODYDATACPU_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEREGIONRESOURCERESPONSEBODYDATACPU_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeRegionResourceResponseBodyDataCpu& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeRegionResourceResponseBodyDataCpu& obj) { 
    ...
    DescribeRegionResourceResponseBodyDataCpu() = default ;
    DescribeRegionResourceResponseBodyDataCpu(const DescribeRegionResourceResponseBodyDataCpu &) = default ;
    DescribeRegionResourceResponseBodyDataCpu(DescribeRegionResourceResponseBodyDataCpu &&) = default ;
    DescribeRegionResourceResponseBodyDataCpu(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeRegionResourceResponseBodyDataCpu() = default ;
    DescribeRegionResourceResponseBodyDataCpu& operator=(const DescribeRegionResourceResponseBodyDataCpu &) = default ;
    DescribeRegionResourceResponseBodyDataCpu& operator=(DescribeRegionResourceResponseBodyDataCpu &&) = default ;
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setDisplay(bool display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setOversellRatio(int64_t oversellRatio) { DARABONBA_PTR_SET_VALUE(oversellRatio_, oversellRatio) };
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setRemain(int64_t remain) { DARABONBA_PTR_SET_VALUE(remain_, remain) };
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setReserveDisable(bool reserveDisable) { DARABONBA_PTR_SET_VALUE(reserveDisable_, reserveDisable) };
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setReserveDisableTotal(int64_t reserveDisableTotal) { DARABONBA_PTR_SET_VALUE(reserveDisableTotal_, reserveDisableTotal) };
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setStatusDisable(bool statusDisable) { DARABONBA_PTR_SET_VALUE(statusDisable_, statusDisable) };
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setStatusDisableTotal(int64_t statusDisableTotal) { DARABONBA_PTR_SET_VALUE(statusDisableTotal_, statusDisableTotal) };
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setUsed(int64_t used) { DARABONBA_PTR_SET_VALUE(used_, used) };
    ...
    inline DescribeRegionResourceResponseBodyDataCpu& setUsedRatio(int64_t usedRatio) { DARABONBA_PTR_SET_VALUE(usedRatio_, usedRatio) };
