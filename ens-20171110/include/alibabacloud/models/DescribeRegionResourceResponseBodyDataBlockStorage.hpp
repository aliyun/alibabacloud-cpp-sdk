...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEREGIONRESOURCERESPONSEBODYDATABLOCKSTORAGE_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEREGIONRESOURCERESPONSEBODYDATABLOCKSTORAGE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeRegionResourceResponseBodyDataBlockStorage& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeRegionResourceResponseBodyDataBlockStorage& obj) { 
    ...
    DescribeRegionResourceResponseBodyDataBlockStorage() = default ;
    DescribeRegionResourceResponseBodyDataBlockStorage(const DescribeRegionResourceResponseBodyDataBlockStorage &) = default ;
    DescribeRegionResourceResponseBodyDataBlockStorage(DescribeRegionResourceResponseBodyDataBlockStorage &&) = default ;
    DescribeRegionResourceResponseBodyDataBlockStorage(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeRegionResourceResponseBodyDataBlockStorage() = default ;
    DescribeRegionResourceResponseBodyDataBlockStorage& operator=(const DescribeRegionResourceResponseBodyDataBlockStorage &) = default ;
    DescribeRegionResourceResponseBodyDataBlockStorage& operator=(DescribeRegionResourceResponseBodyDataBlockStorage &&) = default ;
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setDisplay(bool display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setOversellRatio(int64_t oversellRatio) { DARABONBA_PTR_SET_VALUE(oversellRatio_, oversellRatio) };
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setRemain(int64_t remain) { DARABONBA_PTR_SET_VALUE(remain_, remain) };
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setReserveDisable(bool reserveDisable) { DARABONBA_PTR_SET_VALUE(reserveDisable_, reserveDisable) };
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setReserveDisableTotal(int64_t reserveDisableTotal) { DARABONBA_PTR_SET_VALUE(reserveDisableTotal_, reserveDisableTotal) };
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setStatusDisable(bool statusDisable) { DARABONBA_PTR_SET_VALUE(statusDisable_, statusDisable) };
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setStatusDisableTotal(int64_t statusDisableTotal) { DARABONBA_PTR_SET_VALUE(statusDisableTotal_, statusDisableTotal) };
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setUsed(int64_t used) { DARABONBA_PTR_SET_VALUE(used_, used) };
    ...
    inline DescribeRegionResourceResponseBodyDataBlockStorage& setUsedRatio(int64_t usedRatio) { DARABONBA_PTR_SET_VALUE(usedRatio_, usedRatio) };
