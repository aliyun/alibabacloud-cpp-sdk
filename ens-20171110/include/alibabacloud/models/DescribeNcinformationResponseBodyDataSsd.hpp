...
#ifndef ALIBABACLOUD_MODELS_DESCRIBENCINFORMATIONRESPONSEBODYDATASSD_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBENCINFORMATIONRESPONSEBODYDATASSD_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeNCInformationResponseBodyDataSsd& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeNCInformationResponseBodyDataSsd& obj) { 
    ...
    DescribeNCInformationResponseBodyDataSsd() = default ;
    DescribeNCInformationResponseBodyDataSsd(const DescribeNCInformationResponseBodyDataSsd &) = default ;
    DescribeNCInformationResponseBodyDataSsd(DescribeNCInformationResponseBodyDataSsd &&) = default ;
    DescribeNCInformationResponseBodyDataSsd(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeNCInformationResponseBodyDataSsd() = default ;
    DescribeNCInformationResponseBodyDataSsd& operator=(const DescribeNCInformationResponseBodyDataSsd &) = default ;
    DescribeNCInformationResponseBodyDataSsd& operator=(DescribeNCInformationResponseBodyDataSsd &&) = default ;
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setDisplay(bool display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setOversellRatio(int64_t oversellRatio) { DARABONBA_PTR_SET_VALUE(oversellRatio_, oversellRatio) };
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setRemain(int64_t remain) { DARABONBA_PTR_SET_VALUE(remain_, remain) };
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setReserveDisable(bool reserveDisable) { DARABONBA_PTR_SET_VALUE(reserveDisable_, reserveDisable) };
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setReserveDisableTotal(int64_t reserveDisableTotal) { DARABONBA_PTR_SET_VALUE(reserveDisableTotal_, reserveDisableTotal) };
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setStatusDisable(bool statusDisable) { DARABONBA_PTR_SET_VALUE(statusDisable_, statusDisable) };
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setStatusDisableTotal(int64_t statusDisableTotal) { DARABONBA_PTR_SET_VALUE(statusDisableTotal_, statusDisableTotal) };
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setUsed(int64_t used) { DARABONBA_PTR_SET_VALUE(used_, used) };
    ...
    inline DescribeNCInformationResponseBodyDataSsd& setUsedRatio(int64_t usedRatio) { DARABONBA_PTR_SET_VALUE(usedRatio_, usedRatio) };
