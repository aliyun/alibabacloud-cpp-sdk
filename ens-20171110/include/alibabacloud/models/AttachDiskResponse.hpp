...
namespace Models
{
  ...
  public:
    ...
    inline const AttachDiskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachDiskResponseBody) };
    inline AttachDiskResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachDiskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachDiskResponseBody> body_ {};
  };
