...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AICSpecs_ == nullptr
        && return this->describeAICInstances_ == nullptr && return this->ensRegionIds_ == nullptr && return this->maxDate_ == nullptr && return this->minDate_ == nullptr && return this->name_ == nullptr
        && return this->namespace_ == nullptr && return this->orderByParams_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->serverIds_ == nullptr
        && return this->serverSpecs_ == nullptr && return this->states_ == nullptr && return this->tags_ == nullptr; };
