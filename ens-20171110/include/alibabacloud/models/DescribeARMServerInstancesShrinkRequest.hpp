...
namespace Models
{
  ...
  public:
    ...
    inline string getAICSpecsShrink() const { DARABONBA_PTR_GET_DEFAULT(AICSpecsShrink_, "") };
    ...
    inline string getServerSpecsShrink() const { DARABONBA_PTR_GET_DEFAULT(serverSpecsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> AICSpecsShrink_ {};
    ...
    shared_ptr<string> serverSpecsShrink_ {};
