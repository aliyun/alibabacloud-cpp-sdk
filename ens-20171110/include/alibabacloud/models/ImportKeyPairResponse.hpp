...
namespace Models
{
  ...
  public:
    ...
    inline const ImportKeyPairResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImportKeyPairResponseBody) };
    inline ImportKeyPairResponseBody getBody() { DARABONBA_PTR_GET(body_, ImportKeyPairResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImportKeyPairResponseBody> body_ {};
  };
