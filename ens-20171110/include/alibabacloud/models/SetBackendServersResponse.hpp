...
namespace Models
{
  ...
  public:
    ...
    inline const SetBackendServersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetBackendServersResponseBody) };
    inline SetBackendServersResponseBody getBody() { DARABONBA_PTR_GET(body_, SetBackendServersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetBackendServersResponseBody> body_ {};
  };
