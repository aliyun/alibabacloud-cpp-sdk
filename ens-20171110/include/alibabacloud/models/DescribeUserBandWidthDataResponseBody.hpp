...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getMaxDownBandWidth() const { DARABONBA_PTR_GET_DEFAULT(maxDownBandWidth_, "") };
      inline MonitorData& setMaxDownBandWidth(string maxDownBandWidth) { DARABONBA_PTR_SET_VALUE(maxDownBandWidth_, maxDownBandWidth) };
      ...
      inline string getMaxUpBandWidth() const { DARABONBA_PTR_GET_DEFAULT(maxUpBandWidth_, "") };
      inline MonitorData& setMaxUpBandWidth(string maxUpBandWidth) { DARABONBA_PTR_SET_VALUE(maxUpBandWidth_, maxUpBandWidth) };
    ...
    inline const DescribeUserBandWidthDataResponseBody::MonitorData & getMonitorData() const { DARABONBA_PTR_GET_CONST(monitorData_, DescribeUserBandWidthDataResponseBody::MonitorData) };
    inline DescribeUserBandWidthDataResponseBody::MonitorData getMonitorData() { DARABONBA_PTR_GET(monitorData_, DescribeUserBandWidthDataResponseBody::MonitorData) };
    inline DescribeUserBandWidthDataResponseBody& setMonitorData(const DescribeUserBandWidthDataResponseBody::MonitorData & monitorData) { DARABONBA_PTR_SET_VALUE(monitorData_, monitorData) };
    inline DescribeUserBandWidthDataResponseBody& setMonitorData(DescribeUserBandWidthDataResponseBody::MonitorData && monitorData) { DARABONBA_PTR_SET_RVALUE(monitorData_, monitorData) };
  ...
  protected:
    ...
    // The monitoring data.
    shared_ptr<DescribeUserBandWidthDataResponseBody::MonitorData> monitorData_ {};
