...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClustersV1ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClustersV1ResponseBody) };
    inline DescribeClustersV1ResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClustersV1ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClustersV1ResponseBody> body_ {};
  };
