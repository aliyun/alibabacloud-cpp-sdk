...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->billingCycle_ == nullptr
        && return this->description_ == nullptr && return this->diskType_ == nullptr && return this->fromSDGId_ == nullptr && return this->instanceId_ == nullptr && return this->performanceLevel_ == nullptr
    ...
    inline string fromSDGId() const { DARABONBA_PTR_GET_DEFAULT(fromSDGId_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> fromSDGId_ = nullptr;
