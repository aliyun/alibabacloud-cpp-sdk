...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataDownloadURLResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDataDownloadURLResponseBodyData) };
    inline DescribeDataDownloadURLResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDataDownloadURLResponseBodyData) };
    inline DescribeDataDownloadURLResponseBody& setData(const DescribeDataDownloadURLResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDataDownloadURLResponseBody& setData(DescribeDataDownloadURLResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDataDownloadURLResponseBodyData> data_ = nullptr;
