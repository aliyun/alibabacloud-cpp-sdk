...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSecurityGroupPermissionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSecurityGroupPermissionsResponseBody) };
    inline DeleteSecurityGroupPermissionsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSecurityGroupPermissionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSecurityGroupPermissionsResponseBody> body_ {};
  };
