...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeServcieScheduleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeServcieScheduleResponseBody) };
    inline DescribeServcieScheduleResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeServcieScheduleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeServcieScheduleResponseBody> body_ {};
  };
