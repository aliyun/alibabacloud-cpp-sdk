...
namespace Models
{
  ...
  public:
    ...
    inline const ExportBillDetailDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExportBillDetailDataResponseBody) };
    inline ExportBillDetailDataResponseBody getBody() { DARABONBA_PTR_GET(body_, ExportBillDetailDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExportBillDetailDataResponseBody> body_ {};
  };
