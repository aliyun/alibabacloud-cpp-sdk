...
#ifndef ALIBABACLOUD_MODELS_DEPLOYSDGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYSDGRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeploySDGResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DeploySDGResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DeploySDGResponseBody() = default ;
    DeploySDGResponseBody(const DeploySDGResponseBody &) = default ;
    DeploySDGResponseBody(DeploySDGResponseBody &&) = default ;
    DeploySDGResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeploySDGResponseBody() = default ;
    DeploySDGResponseBody& operator=(const DeploySDGResponseBody &) = default ;
    DeploySDGResponseBody& operator=(DeploySDGResponseBody &&) = default ;
    ...
    inline const DeploySDGResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeploySDGResponseBody::Data) };
    inline DeploySDGResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeploySDGResponseBody::Data) };
    inline DeploySDGResponseBody& setData(const DeploySDGResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeploySDGResponseBody& setData(DeploySDGResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DeploySDGResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The returned data object.
    shared_ptr<DeploySDGResponseBody::Data> data_ {};
