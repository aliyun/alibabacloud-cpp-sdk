...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateEnsSaleControlRequest::SaleControls> & getSaleControls() const { DARABONBA_PTR_GET_CONST(saleControls_, vector<CreateEnsSaleControlRequest::SaleControls>) };
    inline vector<CreateEnsSaleControlRequest::SaleControls> getSaleControls() { DARABONBA_PTR_GET(saleControls_, vector<CreateEnsSaleControlRequest::SaleControls>) };
    inline CreateEnsSaleControlRequest& setSaleControls(const vector<CreateEnsSaleControlRequest::SaleControls> & saleControls) { DARABONBA_PTR_SET_VALUE(saleControls_, saleControls) };
    inline CreateEnsSaleControlRequest& setSaleControls(vector<CreateEnsSaleControlRequest::SaleControls> && saleControls) { DARABONBA_PTR_SET_RVALUE(saleControls_, saleControls) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<CreateEnsSaleControlRequest::SaleControls>> saleControls_ {};
  };
