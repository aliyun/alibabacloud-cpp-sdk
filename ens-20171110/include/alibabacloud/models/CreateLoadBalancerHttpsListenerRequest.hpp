...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backendServerPort_ == nullptr
        && return this->cookie_ == nullptr && return this->cookieTimeout_ == nullptr && return this->description_ == nullptr && return this->forwardPort_ == nullptr && return this->healthCheck_ == nullptr
        ...
        && return this->stickySessionType_ == nullptr && return this->unhealthyThreshold_ == nullptr; };
