...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHaVipResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHaVipResponseBody) };
    inline CreateHaVipResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHaVipResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHaVipResponseBody> body_ {};
  };
