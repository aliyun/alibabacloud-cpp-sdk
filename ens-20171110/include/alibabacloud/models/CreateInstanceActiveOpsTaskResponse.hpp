...
namespace Models
{
  ...
  public:
    ...
    inline const CreateInstanceActiveOpsTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateInstanceActiveOpsTaskResponseBody) };
    inline CreateInstanceActiveOpsTaskResponseBody body() { DARABONBA_PTR_GET(body_, CreateInstanceActiveOpsTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateInstanceActiveOpsTaskResponseBody> body_ = nullptr;
  };
