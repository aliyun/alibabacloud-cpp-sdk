...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClusterKubeConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClusterKubeConfigResponseBody) };
    inline DescribeClusterKubeConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClusterKubeConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClusterKubeConfigResponseBody> body_ {};
  };
