...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecondaryPublicIpAddressesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecondaryPublicIpAddressesResponseBody) };
    inline DescribeSecondaryPublicIpAddressesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSecondaryPublicIpAddressesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSecondaryPublicIpAddressesResponseBody> body_ {};
  };
