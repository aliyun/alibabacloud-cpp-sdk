...
namespace Models
{
  ...
  public:
    ...
    inline const RollbackApplicationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RollbackApplicationResponseBody) };
    inline RollbackApplicationResponseBody body() { DARABONBA_PTR_GET(body_, RollbackApplicationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RollbackApplicationResponseBody> body_ = nullptr;
  };
