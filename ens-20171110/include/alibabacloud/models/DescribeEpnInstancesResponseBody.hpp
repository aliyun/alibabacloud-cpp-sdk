...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->EPNInstances_ != nullptr
    ...
    inline const DescribeEpnInstancesResponseBodyEPNInstances & EPNInstances() const { DARABONBA_PTR_GET_CONST(EPNInstances_, DescribeEpnInstancesResponseBodyEPNInstances) };
    inline DescribeEpnInstancesResponseBodyEPNInstances EPNInstances() { DARABONBA_PTR_GET(EPNInstances_, DescribeEpnInstancesResponseBodyEPNInstances) };
    inline DescribeEpnInstancesResponseBody& setEPNInstances(const DescribeEpnInstancesResponseBodyEPNInstances & EPNInstances) { DARABONBA_PTR_SET_VALUE(EPNInstances_, EPNInstances) };
    inline DescribeEpnInstancesResponseBody& setEPNInstances(DescribeEpnInstancesResponseBodyEPNInstances && EPNInstances) { DARABONBA_PTR_SET_RVALUE(EPNInstances_, EPNInstances) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEpnInstancesResponseBodyEPNInstances> EPNInstances_ = nullptr;
    // The page number.
