...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAICPublicKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAICPublicKeyResponseBody) };
    inline DeleteAICPublicKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAICPublicKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAICPublicKeyResponseBody> body_ {};
  };
