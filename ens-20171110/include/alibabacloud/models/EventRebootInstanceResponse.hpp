...
namespace Models
{
  ...
  public:
    ...
    inline const EventRebootInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EventRebootInstanceResponseBody) };
    inline EventRebootInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, EventRebootInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EventRebootInstanceResponseBody> body_ {};
  };
