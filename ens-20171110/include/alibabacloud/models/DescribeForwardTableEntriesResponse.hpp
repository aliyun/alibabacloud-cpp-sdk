...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeForwardTableEntriesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeForwardTableEntriesResponseBody) };
    inline DescribeForwardTableEntriesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeForwardTableEntriesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeForwardTableEntriesResponseBody> body_ = nullptr;
  };
