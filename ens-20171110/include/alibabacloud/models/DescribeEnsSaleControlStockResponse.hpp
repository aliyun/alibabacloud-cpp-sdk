...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnsSaleControlStockResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeEnsSaleControlStockResponseBody) };
    inline DescribeEnsSaleControlStockResponseBody body() { DARABONBA_PTR_GET(body_, DescribeEnsSaleControlStockResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEnsSaleControlStockResponseBody> body_ = nullptr;
  };
