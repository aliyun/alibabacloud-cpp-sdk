...
#ifndef ALIBABACLOUD_MODELS_DELETEENSSALECONTROLSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETEENSSALECONTROLSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteEnsSaleControlShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeleteEnsSaleControlShrinkRequest& obj) { 
    ...
    DeleteEnsSaleControlShrinkRequest() = default ;
    DeleteEnsSaleControlShrinkRequest(const DeleteEnsSaleControlShrinkRequest &) = default ;
    DeleteEnsSaleControlShrinkRequest(DeleteEnsSaleControlShrinkRequest &&) = default ;
    DeleteEnsSaleControlShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteEnsSaleControlShrinkRequest() = default ;
    DeleteEnsSaleControlShrinkRequest& operator=(const DeleteEnsSaleControlShrinkRequest &) = default ;
    DeleteEnsSaleControlShrinkRequest& operator=(DeleteEnsSaleControlShrinkRequest &&) = default ;
    ...
    inline DeleteEnsSaleControlShrinkRequest& setAliUidAccount(string aliUidAccount) { DARABONBA_PTR_SET_VALUE(aliUidAccount_, aliUidAccount) };
    ...
    inline DeleteEnsSaleControlShrinkRequest& setCommodityCode(string commodityCode) { DARABONBA_PTR_SET_VALUE(commodityCode_, commodityCode) };
    ...
    inline DeleteEnsSaleControlShrinkRequest& setCustomAccount(string customAccount) { DARABONBA_PTR_SET_VALUE(customAccount_, customAccount) };
    ...
    inline DeleteEnsSaleControlShrinkRequest& setSaleControlsShrink(string saleControlsShrink) { DARABONBA_PTR_SET_VALUE(saleControlsShrink_, saleControlsShrink) };
