...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHaVipsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHaVipsResponseBody) };
    inline DescribeHaVipsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHaVipsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHaVipsResponseBody> body_ {};
  };
