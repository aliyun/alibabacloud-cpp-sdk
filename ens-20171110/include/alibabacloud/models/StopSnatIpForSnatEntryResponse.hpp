...
namespace Models
{
  ...
  public:
    ...
    inline const StopSnatIpForSnatEntryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopSnatIpForSnatEntryResponseBody) };
    inline StopSnatIpForSnatEntryResponseBody getBody() { DARABONBA_PTR_GET(body_, StopSnatIpForSnatEntryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopSnatIpForSnatEntryResponseBody> body_ {};
  };
