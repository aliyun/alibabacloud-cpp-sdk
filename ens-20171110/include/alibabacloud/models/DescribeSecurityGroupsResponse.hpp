...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecurityGroupsResponseBody) };
    inline DescribeSecurityGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSecurityGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSecurityGroupsResponseBody> body_ {};
  };
