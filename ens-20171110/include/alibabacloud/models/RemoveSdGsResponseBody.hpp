...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveSDGsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, RemoveSDGsResponseBody::Data) };
    inline RemoveSDGsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, RemoveSDGsResponseBody::Data) };
    inline RemoveSDGsResponseBody& setData(const RemoveSDGsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RemoveSDGsResponseBody& setData(RemoveSDGsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    shared_ptr<RemoveSDGsResponseBody::Data> data_ {};
    // Id of the request
