...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEEPNBANDWITDHBYINTERNETCHARGETYPEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEEPNBANDWITDHBYINTERNETCHARGETYPEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeEpnBandwitdhByInternetChargeTypeRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeEpnBandwitdhByInternetChargeTypeRequest& obj) { 
    ...
    DescribeEpnBandwitdhByInternetChargeTypeRequest() = default ;
    DescribeEpnBandwitdhByInternetChargeTypeRequest(const DescribeEpnBandwitdhByInternetChargeTypeRequest &) = default ;
    DescribeEpnBandwitdhByInternetChargeTypeRequest(DescribeEpnBandwitdhByInternetChargeTypeRequest &&) = default ;
    DescribeEpnBandwitdhByInternetChargeTypeRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeEpnBandwitdhByInternetChargeTypeRequest() = default ;
    DescribeEpnBandwitdhByInternetChargeTypeRequest& operator=(const DescribeEpnBandwitdhByInternetChargeTypeRequest &) = default ;
    DescribeEpnBandwitdhByInternetChargeTypeRequest& operator=(DescribeEpnBandwitdhByInternetChargeTypeRequest &&) = default ;
