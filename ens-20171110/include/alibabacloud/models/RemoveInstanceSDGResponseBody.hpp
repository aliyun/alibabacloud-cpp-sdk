...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveInstanceSDGResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, RemoveInstanceSDGResponseBody::Data) };
    inline RemoveInstanceSDGResponseBody::Data getData() { DARABONBA_PTR_GET(data_, RemoveInstanceSDGResponseBody::Data) };
    inline RemoveInstanceSDGResponseBody& setData(const RemoveInstanceSDGResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RemoveInstanceSDGResponseBody& setData(RemoveInstanceSDGResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<RemoveInstanceSDGResponseBody::Data> data_ {};
    // The request ID.
