...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMeasurementDataResponseBodyMeasurementDatas & measurementDatas() const { DARABONBA_PTR_GET_CONST(measurementDatas_, DescribeMeasurementDataResponseBodyMeasurementDatas) };
    inline DescribeMeasurementDataResponseBodyMeasurementDatas measurementDatas() { DARABONBA_PTR_GET(measurementDatas_, DescribeMeasurementDataResponseBodyMeasurementDatas) };
    inline DescribeMeasurementDataResponseBody& setMeasurementDatas(const DescribeMeasurementDataResponseBodyMeasurementDatas & measurementDatas) { DARABONBA_PTR_SET_VALUE(measurementDatas_, measurementDatas) };
    inline DescribeMeasurementDataResponseBody& setMeasurementDatas(DescribeMeasurementDataResponseBodyMeasurementDatas && measurementDatas) { DARABONBA_PTR_SET_RVALUE(measurementDatas_, measurementDatas) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeMeasurementDataResponseBodyMeasurementDatas> measurementDatas_ = nullptr;
