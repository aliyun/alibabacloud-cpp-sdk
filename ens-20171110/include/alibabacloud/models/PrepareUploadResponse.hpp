...
namespace Models
{
  ...
  public:
    ...
    inline const PrepareUploadResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PrepareUploadResponseBody) };
    inline PrepareUploadResponseBody getBody() { DARABONBA_PTR_GET(body_, PrepareUploadResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PrepareUploadResponseBody> body_ {};
  };
