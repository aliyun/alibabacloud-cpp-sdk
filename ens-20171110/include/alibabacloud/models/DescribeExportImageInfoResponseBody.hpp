...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExportImageInfoResponseBodyImages & images() const { DARABONBA_PTR_GET_CONST(images_, DescribeExportImageInfoResponseBodyImages) };
    inline DescribeExportImageInfoResponseBodyImages images() { DARABONBA_PTR_GET(images_, DescribeExportImageInfoResponseBodyImages) };
    inline DescribeExportImageInfoResponseBody& setImages(const DescribeExportImageInfoResponseBodyImages & images) { DARABONBA_PTR_SET_VALUE(images_, images) };
    inline DescribeExportImageInfoResponseBody& setImages(DescribeExportImageInfoResponseBodyImages && images) { DARABONBA_PTR_SET_RVALUE(images_, images) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeExportImageInfoResponseBodyImages> images_ = nullptr;
    // The page number.
