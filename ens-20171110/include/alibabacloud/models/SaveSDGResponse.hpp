...
namespace Models
{
  ...
  public:
    ...
    inline const SaveSDGResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveSDGResponseBody) };
    inline SaveSDGResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveSDGResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveSDGResponseBody> body_ {};
  };
