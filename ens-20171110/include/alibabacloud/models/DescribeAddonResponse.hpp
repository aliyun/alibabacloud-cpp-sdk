...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAddonResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAddonResponseBody) };
    inline DescribeAddonResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAddonResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAddonResponseBody> body_ {};
  };
