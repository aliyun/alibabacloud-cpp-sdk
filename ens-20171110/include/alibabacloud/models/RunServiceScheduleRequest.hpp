...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && return this->clientIp_ == nullptr && return this->directorys_ == nullptr && return this->podConfigName_ == nullptr && return this->preLockedTimeout_ == nullptr && return this->scheduleStrategy_ == nullptr
        && return this->serviceAction_ == nullptr && return this->serviceCommands_ == nullptr && return this->uuid_ == nullptr; };
    ...
    inline string directorys() const { DARABONBA_PTR_GET_DEFAULT(directorys_, "") };
    ...
    inline int32_t preLockedTimeout() const { DARABONBA_PTR_GET_DEFAULT(preLockedTimeout_, 0) };
    ...
    inline string scheduleStrategy() const { DARABONBA_PTR_GET_DEFAULT(scheduleStrategy_, "") };
    ...
    inline string serviceAction() const { DARABONBA_PTR_GET_DEFAULT(serviceAction_, "") };
    ...
    inline string serviceCommands() const { DARABONBA_PTR_GET_DEFAULT(serviceCommands_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> directorys_ = nullptr;
    ...
    std::shared_ptr<int32_t> preLockedTimeout_ = nullptr;
    // The scheduling policy of the device. The value must be a JSON string.
    std::shared_ptr<string> scheduleStrategy_ = nullptr;
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> serviceAction_ = nullptr;
    // The service commands. The value must be a JSON string.
    std::shared_ptr<string> serviceCommands_ = nullptr;
