...
namespace Models
{
  ...
  public:
    ...
    inline const GetOssStorageAndAccByBucketsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetOssStorageAndAccByBucketsResponseBody) };
    inline GetOssStorageAndAccByBucketsResponseBody body() { DARABONBA_PTR_GET(body_, GetOssStorageAndAccByBucketsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetOssStorageAndAccByBucketsResponseBody> body_ = nullptr;
  };
