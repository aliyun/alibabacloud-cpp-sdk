...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEREGIONRESOURCERESPONSEBODYDATANVME_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEREGIONRESOURCERESPONSEBODYDATANVME_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeRegionResourceResponseBodyDataNvme& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeRegionResourceResponseBodyDataNvme& obj) { 
    ...
    DescribeRegionResourceResponseBodyDataNvme() = default ;
    DescribeRegionResourceResponseBodyDataNvme(const DescribeRegionResourceResponseBodyDataNvme &) = default ;
    DescribeRegionResourceResponseBodyDataNvme(DescribeRegionResourceResponseBodyDataNvme &&) = default ;
    DescribeRegionResourceResponseBodyDataNvme(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeRegionResourceResponseBodyDataNvme() = default ;
    DescribeRegionResourceResponseBodyDataNvme& operator=(const DescribeRegionResourceResponseBodyDataNvme &) = default ;
    DescribeRegionResourceResponseBodyDataNvme& operator=(DescribeRegionResourceResponseBodyDataNvme &&) = default ;
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setDisplay(bool display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setOversellRatio(int64_t oversellRatio) { DARABONBA_PTR_SET_VALUE(oversellRatio_, oversellRatio) };
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setRemain(int64_t remain) { DARABONBA_PTR_SET_VALUE(remain_, remain) };
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setReserveDisable(bool reserveDisable) { DARABONBA_PTR_SET_VALUE(reserveDisable_, reserveDisable) };
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setReserveDisableTotal(int64_t reserveDisableTotal) { DARABONBA_PTR_SET_VALUE(reserveDisableTotal_, reserveDisableTotal) };
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setStatusDisable(bool statusDisable) { DARABONBA_PTR_SET_VALUE(statusDisable_, statusDisable) };
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setStatusDisableTotal(int64_t statusDisableTotal) { DARABONBA_PTR_SET_VALUE(statusDisableTotal_, statusDisableTotal) };
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setUsed(int64_t used) { DARABONBA_PTR_SET_VALUE(used_, used) };
    ...
    inline DescribeRegionResourceResponseBodyDataNvme& setUsedRatio(int64_t usedRatio) { DARABONBA_PTR_SET_VALUE(usedRatio_, usedRatio) };
