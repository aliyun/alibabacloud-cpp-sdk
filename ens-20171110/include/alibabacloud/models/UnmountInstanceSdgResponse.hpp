...
namespace Models
{
  ...
  public:
    ...
    inline const UnmountInstanceSDGResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnmountInstanceSDGResponseBody) };
    inline UnmountInstanceSDGResponseBody getBody() { DARABONBA_PTR_GET(body_, UnmountInstanceSDGResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnmountInstanceSDGResponseBody> body_ {};
  };
