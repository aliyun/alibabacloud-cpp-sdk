...
#ifndef ALIBABACLOUD_MODELS_DESCRIBENCINFORMATIONRESPONSEBODYDATAHDD_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBENCINFORMATIONRESPONSEBODYDATAHDD_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeNCInformationResponseBodyDataHdd& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeNCInformationResponseBodyDataHdd& obj) { 
    ...
    DescribeNCInformationResponseBodyDataHdd() = default ;
    DescribeNCInformationResponseBodyDataHdd(const DescribeNCInformationResponseBodyDataHdd &) = default ;
    DescribeNCInformationResponseBodyDataHdd(DescribeNCInformationResponseBodyDataHdd &&) = default ;
    DescribeNCInformationResponseBodyDataHdd(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeNCInformationResponseBodyDataHdd() = default ;
    DescribeNCInformationResponseBodyDataHdd& operator=(const DescribeNCInformationResponseBodyDataHdd &) = default ;
    DescribeNCInformationResponseBodyDataHdd& operator=(DescribeNCInformationResponseBodyDataHdd &&) = default ;
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setDisplay(bool display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setOversellRatio(int64_t oversellRatio) { DARABONBA_PTR_SET_VALUE(oversellRatio_, oversellRatio) };
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setRemain(int64_t remain) { DARABONBA_PTR_SET_VALUE(remain_, remain) };
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setReserveDisable(bool reserveDisable) { DARABONBA_PTR_SET_VALUE(reserveDisable_, reserveDisable) };
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setReserveDisableTotal(int64_t reserveDisableTotal) { DARABONBA_PTR_SET_VALUE(reserveDisableTotal_, reserveDisableTotal) };
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setStatusDisable(bool statusDisable) { DARABONBA_PTR_SET_VALUE(statusDisable_, statusDisable) };
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setStatusDisableTotal(int64_t statusDisableTotal) { DARABONBA_PTR_SET_VALUE(statusDisableTotal_, statusDisableTotal) };
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setUsed(int64_t used) { DARABONBA_PTR_SET_VALUE(used_, used) };
    ...
    inline DescribeNCInformationResponseBodyDataHdd& setUsedRatio(int64_t usedRatio) { DARABONBA_PTR_SET_VALUE(usedRatio_, usedRatio) };
