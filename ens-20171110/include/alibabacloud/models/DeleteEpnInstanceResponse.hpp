...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEpnInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteEpnInstanceResponseBody) };
    inline DeleteEpnInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteEpnInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteEpnInstanceResponseBody> body_ {};
  };
