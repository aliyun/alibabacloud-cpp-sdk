  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->cleanupCloudResources_ == nullptr
        && this->configSchema_ == nullptr && this->name_ == nullptr && this->status_ == nullptr && this->version_ == nullptr; };
    ...
    inline ListClusterAddonInstancesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
