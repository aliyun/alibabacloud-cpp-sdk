...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getCleanupCloudResources() const { DARABONBA_PTR_GET_DEFAULT(cleanupCloudResources_, "") };
      inline Addons& setCleanupCloudResources(string cleanupCloudResources) { DARABONBA_PTR_SET_VALUE(cleanupCloudResources_, cleanupCloudResources) };
    ...
    protected:
      shared_ptr<string> cleanupCloudResources_ {};
    ...
    inline const vector<DescribeAddonResponseBody::Addons> & getAddons() const { DARABONBA_PTR_GET_CONST(addons_, vector<DescribeAddonResponseBody::Addons>) };
    inline vector<DescribeAddonResponseBody::Addons> getAddons() { DARABONBA_PTR_GET(addons_, vector<DescribeAddonResponseBody::Addons>) };
    inline DescribeAddonResponseBody& setAddons(const vector<DescribeAddonResponseBody::Addons> & addons) { DARABONBA_PTR_SET_VALUE(addons_, addons) };
    inline DescribeAddonResponseBody& setAddons(vector<DescribeAddonResponseBody::Addons> && addons) { DARABONBA_PTR_SET_RVALUE(addons_, addons) };
    ...
    inline DescribeAddonResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<vector<DescribeAddonResponseBody::Addons>> addons_ {};
    // Id of the request
