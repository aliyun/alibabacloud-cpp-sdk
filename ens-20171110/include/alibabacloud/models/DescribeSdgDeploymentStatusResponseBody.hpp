...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSDGDeploymentStatusResponseBodyDeploymentStatus> & deploymentStatus() const { DARABONBA_PTR_GET_CONST(deploymentStatus_, vector<DescribeSDGDeploymentStatusResponseBodyDeploymentStatus>) };
    inline vector<DescribeSDGDeploymentStatusResponseBodyDeploymentStatus> deploymentStatus() { DARABONBA_PTR_GET(deploymentStatus_, vector<DescribeSDGDeploymentStatusResponseBodyDeploymentStatus>) };
    inline DescribeSDGDeploymentStatusResponseBody& setDeploymentStatus(const vector<DescribeSDGDeploymentStatusResponseBodyDeploymentStatus> & deploymentStatus) { DARABONBA_PTR_SET_VALUE(deploymentStatus_, deploymentStatus) };
    inline DescribeSDGDeploymentStatusResponseBody& setDeploymentStatus(vector<DescribeSDGDeploymentStatusResponseBodyDeploymentStatus> && deploymentStatus) { DARABONBA_PTR_SET_RVALUE(deploymentStatus_, deploymentStatus) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeSDGDeploymentStatusResponseBodyDeploymentStatus>> deploymentStatus_ = nullptr;
