...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDisksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDisksResponseBody) };
    inline DescribeDisksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDisksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDisksResponseBody> body_ {};
  };
