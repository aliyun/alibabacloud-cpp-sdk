...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyImageSharePermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyImageSharePermissionResponseBody) };
    inline ModifyImageSharePermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyImageSharePermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyImageSharePermissionResponseBody> body_ {};
  };
