...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->blockRwSplitSize_ == nullptr
        && return this->cacheSize_ == nullptr && return this->diskAccessProtocol_ == nullptr && return this->diskType_ == nullptr && return this->ensRegionId_ == nullptr && return this->instanceId_ == nullptr
        && return this->mountType_ == nullptr && return this->phase_ == nullptr && return this->SDGId_ == nullptr && return this->status_ == nullptr && return this->updateTime_ == nullptr; };
