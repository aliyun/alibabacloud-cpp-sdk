...
namespace Models
{
  ...
  public:
    ...
    inline AttachKeyPairResponseBody& setFailCount(int32_t failCount) { DARABONBA_PTR_SET_VALUE(failCount_, failCount) };
    ...
    inline AttachKeyPairResponseBody& setKeyPairId(string keyPairId) { DARABONBA_PTR_SET_VALUE(keyPairId_, keyPairId) };
    ...
    inline const vector<AttachKeyPairResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<AttachKeyPairResponseBody::Results>) };
    inline vector<AttachKeyPairResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<AttachKeyPairResponseBody::Results>) };
    inline AttachKeyPairResponseBody& setResults(const vector<AttachKeyPairResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline AttachKeyPairResponseBody& setResults(vector<AttachKeyPairResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
    ...
    inline AttachKeyPairResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
  ...
  protected:
    ...
    shared_ptr<vector<AttachKeyPairResponseBody::Results>> results_ {};
