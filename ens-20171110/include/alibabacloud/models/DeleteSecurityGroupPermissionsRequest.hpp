...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->destCidrIp_ == nullptr
        && this->direction_ == nullptr && this->ipProtocol_ == nullptr && this->ipv6DestCidrIp_ == nullptr && this->ipv6SourceCidrIp_ == nullptr && this->policy_ == nullptr
    ...
    inline const vector<DeleteSecurityGroupPermissionsRequest::Permissions> & getPermissions() const { DARABONBA_PTR_GET_CONST(permissions_, vector<DeleteSecurityGroupPermissionsRequest::Permissions>) };
    inline vector<DeleteSecurityGroupPermissionsRequest::Permissions> getPermissions() { DARABONBA_PTR_GET(permissions_, vector<DeleteSecurityGroupPermissionsRequest::Permissions>) };
    inline DeleteSecurityGroupPermissionsRequest& setPermissions(const vector<DeleteSecurityGroupPermissionsRequest::Permissions> & permissions) { DARABONBA_PTR_SET_VALUE(permissions_, permissions) };
    inline DeleteSecurityGroupPermissionsRequest& setPermissions(vector<DeleteSecurityGroupPermissionsRequest::Permissions> && permissions) { DARABONBA_PTR_SET_RVALUE(permissions_, permissions) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<DeleteSecurityGroupPermissionsRequest::Permissions>> permissions_ {};
