...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExportImageStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExportImageStatusResponseBody) };
    inline DescribeExportImageStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExportImageStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExportImageStatusResponseBody> body_ {};
  };
