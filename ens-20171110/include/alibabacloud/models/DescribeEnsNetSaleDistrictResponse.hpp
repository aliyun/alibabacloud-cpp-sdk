...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnsNetSaleDistrictResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEnsNetSaleDistrictResponseBody) };
    inline DescribeEnsNetSaleDistrictResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEnsNetSaleDistrictResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEnsNetSaleDistrictResponseBody> body_ {};
  };
