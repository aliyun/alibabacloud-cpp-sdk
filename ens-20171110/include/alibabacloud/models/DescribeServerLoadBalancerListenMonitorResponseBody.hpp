...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline ServerLoadBalancerMonitorData& setProto(string proto) { DARABONBA_PTR_SET_VALUE(proto_, proto) };
      ...
      inline int32_t getVport() const { DARABONBA_PTR_GET_DEFAULT(vport_, 0) };
      inline ServerLoadBalancerMonitorData& setVport(int32_t vport) { DARABONBA_PTR_SET_VALUE(vport_, vport) };
    ...
    inline const vector<DescribeServerLoadBalancerListenMonitorResponseBody::ServerLoadBalancerMonitorData> & getServerLoadBalancerMonitorData() const { DARABONBA_PTR_GET_CONST(serverLoadBalancerMonitorData_, vector<DescribeServerLoadBalancerListenMonitorResponseBody::ServerLoadBalancerMonitorData>) };
    inline vector<DescribeServerLoadBalancerListenMonitorResponseBody::ServerLoadBalancerMonitorData> getServerLoadBalancerMonitorData() { DARABONBA_PTR_GET(serverLoadBalancerMonitorData_, vector<DescribeServerLoadBalancerListenMonitorResponseBody::ServerLoadBalancerMonitorData>) };
    inline DescribeServerLoadBalancerListenMonitorResponseBody& setServerLoadBalancerMonitorData(const vector<DescribeServerLoadBalancerListenMonitorResponseBody::ServerLoadBalancerMonitorData> & serverLoadBalancerMonitorData) { DARABONBA_PTR_SET_VALUE(serverLoadBalancerMonitorData_, serverLoadBalancerMonitorData) };
    inline DescribeServerLoadBalancerListenMonitorResponseBody& setServerLoadBalancerMonitorData(vector<DescribeServerLoadBalancerListenMonitorResponseBody::ServerLoadBalancerMonitorData> && serverLoadBalancerMonitorData) { DARABONBA_PTR_SET_RVALUE(serverLoadBalancerMonitorData_, serverLoadBalancerMonitorData) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeServerLoadBalancerListenMonitorResponseBody::ServerLoadBalancerMonitorData>> serverLoadBalancerMonitorData_ {};
  };
