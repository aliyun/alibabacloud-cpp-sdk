...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteNetworkInterfacesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteNetworkInterfacesResponseBody) };
    inline DeleteNetworkInterfacesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteNetworkInterfacesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteNetworkInterfacesResponseBody> body_ {};
  };
