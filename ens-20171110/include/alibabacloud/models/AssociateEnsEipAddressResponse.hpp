...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateEnsEipAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AssociateEnsEipAddressResponseBody) };
    inline AssociateEnsEipAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, AssociateEnsEipAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AssociateEnsEipAddressResponseBody> body_ {};
  };
