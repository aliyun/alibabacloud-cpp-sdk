  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline Account& setAliyunUid(string aliyunUid) { DARABONBA_PTR_SET_VALUE(aliyunUid_, aliyunUid) };
    ...
    virtual bool empty() const override { return this->accounts_ == nullptr
        && this->imageId_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->requestId_ == nullptr && this->totalCount_ == nullptr; };
