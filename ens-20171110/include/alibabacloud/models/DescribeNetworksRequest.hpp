...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ensRegionId_ == nullptr
        && return this->ensRegionIds_ == nullptr && return this->networkId_ == nullptr && return this->networkIds_ == nullptr && return this->networkName_ == nullptr && return this->pageNumber_ == nullptr
