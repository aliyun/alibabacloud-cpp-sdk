...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEREGIONRESOURCERESPONSEBODYDATAIPV4S_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEREGIONRESOURCERESPONSEBODYDATAIPV4S_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeRegionResourceResponseBodyDataIpv4s& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeRegionResourceResponseBodyDataIpv4s& obj) { 
    ...
    DescribeRegionResourceResponseBodyDataIpv4s() = default ;
    DescribeRegionResourceResponseBodyDataIpv4s(const DescribeRegionResourceResponseBodyDataIpv4s &) = default ;
    DescribeRegionResourceResponseBodyDataIpv4s(DescribeRegionResourceResponseBodyDataIpv4s &&) = default ;
    DescribeRegionResourceResponseBodyDataIpv4s(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeRegionResourceResponseBodyDataIpv4s() = default ;
    DescribeRegionResourceResponseBodyDataIpv4s& operator=(const DescribeRegionResourceResponseBodyDataIpv4s &) = default ;
    DescribeRegionResourceResponseBodyDataIpv4s& operator=(DescribeRegionResourceResponseBodyDataIpv4s &&) = default ;
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setDisplay(string display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setIsp(string isp) { DARABONBA_PTR_SET_VALUE(isp_, isp) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setOversellRatio(int64_t oversellRatio) { DARABONBA_PTR_SET_VALUE(oversellRatio_, oversellRatio) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setRemain(int64_t remain) { DARABONBA_PTR_SET_VALUE(remain_, remain) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setReserveDisable(bool reserveDisable) { DARABONBA_PTR_SET_VALUE(reserveDisable_, reserveDisable) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setReserveDisableTotal(int64_t reserveDisableTotal) { DARABONBA_PTR_SET_VALUE(reserveDisableTotal_, reserveDisableTotal) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setStatusDisable(bool statusDisable) { DARABONBA_PTR_SET_VALUE(statusDisable_, statusDisable) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setStatusDisableTotal(int64_t statusDisableTotal) { DARABONBA_PTR_SET_VALUE(statusDisableTotal_, statusDisableTotal) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setUsed(int64_t used) { DARABONBA_PTR_SET_VALUE(used_, used) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setUsedRatio(int64_t usedRatio) { DARABONBA_PTR_SET_VALUE(usedRatio_, usedRatio) };
    ...
    inline DescribeRegionResourceResponseBodyDataIpv4s& setVlan(string vlan) { DARABONBA_PTR_SET_VALUE(vlan_, vlan) };
