...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->frequency_ == nullptr
        && return this->imageId_ == nullptr && return this->instanceId_ == nullptr && return this->latestAction_ == nullptr && return this->name_ == nullptr && return this->networkAttributes_ == nullptr
        && return this->resolution_ == nullptr && return this->sdgDeployInfo_ == nullptr && return this->spec_ == nullptr && return this->state_ == nullptr && return this->status_ == nullptr; };
