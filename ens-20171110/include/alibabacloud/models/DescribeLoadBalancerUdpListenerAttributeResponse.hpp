...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLoadBalancerUDPListenerAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLoadBalancerUDPListenerAttributeResponseBody) };
    inline DescribeLoadBalancerUDPListenerAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLoadBalancerUDPListenerAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLoadBalancerUDPListenerAttributeResponseBody> body_ {};
  };
