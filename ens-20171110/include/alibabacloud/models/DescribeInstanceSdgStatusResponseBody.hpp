...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline DeploymentStatus& setEnsRegionId(string ensRegionId) { DARABONBA_PTR_SET_VALUE(ensRegionId_, ensRegionId) };
      ...
      inline DeploymentStatus& setSDGId(string SDGId) { DARABONBA_PTR_SET_VALUE(SDGId_, SDGId) };
    ...
    inline const vector<DescribeInstanceSDGStatusResponseBody::DeploymentStatus> & getDeploymentStatus() const { DARABONBA_PTR_GET_CONST(deploymentStatus_, vector<DescribeInstanceSDGStatusResponseBody::DeploymentStatus>) };
    inline vector<DescribeInstanceSDGStatusResponseBody::DeploymentStatus> getDeploymentStatus() { DARABONBA_PTR_GET(deploymentStatus_, vector<DescribeInstanceSDGStatusResponseBody::DeploymentStatus>) };
    inline DescribeInstanceSDGStatusResponseBody& setDeploymentStatus(const vector<DescribeInstanceSDGStatusResponseBody::DeploymentStatus> & deploymentStatus) { DARABONBA_PTR_SET_VALUE(deploymentStatus_, deploymentStatus) };
    inline DescribeInstanceSDGStatusResponseBody& setDeploymentStatus(vector<DescribeInstanceSDGStatusResponseBody::DeploymentStatus> && deploymentStatus) { DARABONBA_PTR_SET_RVALUE(deploymentStatus_, deploymentStatus) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeInstanceSDGStatusResponseBody::DeploymentStatus>> deploymentStatus_ {};
