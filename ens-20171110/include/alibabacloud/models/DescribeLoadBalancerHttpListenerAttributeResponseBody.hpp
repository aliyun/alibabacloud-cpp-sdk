...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backendServerPort_ == nullptr
        ...
        && return this->unhealthyThreshold_ == nullptr && return this->XForwardedFor_ == nullptr; };
    ...
    inline DescribeLoadBalancerHTTPListenerAttributeResponseBody& setServerCertificateId(string serverCertificateId) { DARABONBA_PTR_SET_VALUE(serverCertificateId_, serverCertificateId) };
