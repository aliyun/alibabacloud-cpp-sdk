  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->moduleValue_ == nullptr && this->stockValue_ == nullptr; };
            ...
            inline string getStockValue() const { DARABONBA_PTR_GET_DEFAULT(stockValue_, "") };
            inline ConditionSaleControl& setStockValue(string stockValue) { DARABONBA_PTR_SET_VALUE(stockValue_, stockValue) };
        ...
        && this->stockValue_ == nullptr; };
            ...
            void deleteStockValue() { this->stockValue_ = nullptr;};
            inline string getStockValue() const { DARABONBA_PTR_GET_DEFAULT(stockValue_, "") };
            inline BasicSaleControl& setStockValue(string stockValue) { DARABONBA_PTR_SET_VALUE(stockValue_, stockValue) };
    ...
    inline const vector<DescribeEnsSaleControlStockResponseBody::SaleControl> & getSaleControl() const { DARABONBA_PTR_GET_CONST(saleControl_, vector<DescribeEnsSaleControlStockResponseBody::SaleControl>) };
    inline vector<DescribeEnsSaleControlStockResponseBody::SaleControl> getSaleControl() { DARABONBA_PTR_GET(saleControl_, vector<DescribeEnsSaleControlStockResponseBody::SaleControl>) };
    inline DescribeEnsSaleControlStockResponseBody& setSaleControl(const vector<DescribeEnsSaleControlStockResponseBody::SaleControl> & saleControl) { DARABONBA_PTR_SET_VALUE(saleControl_, saleControl) };
    inline DescribeEnsSaleControlStockResponseBody& setSaleControl(vector<DescribeEnsSaleControlStockResponseBody::SaleControl> && saleControl) { DARABONBA_PTR_SET_RVALUE(saleControl_, saleControl) };


  protected:
    shared_ptr<string> requestId_ {};
    shared_ptr<vector<DescribeEnsSaleControlStockResponseBody::SaleControl>> saleControl_ {};
  };
