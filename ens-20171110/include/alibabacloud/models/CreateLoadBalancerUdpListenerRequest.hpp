...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backendServerPort_ == nullptr
        ...
        && return this->healthCheckExp_ == nullptr && return this->healthCheckInterval_ == nullptr && return this->healthCheckReq_ == nullptr && return this->healthyThreshold_ == nullptr && return this->listenerPort_ == nullptr
        && return this->loadBalancerId_ == nullptr && return this->scheduler_ == nullptr && return this->unhealthyThreshold_ == nullptr; };
