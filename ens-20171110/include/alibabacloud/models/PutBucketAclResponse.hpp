...
namespace Models
{
  ...
  public:
    ...
    inline const PutBucketAclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutBucketAclResponseBody) };
    inline PutBucketAclResponseBody getBody() { DARABONBA_PTR_GET(body_, PutBucketAclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PutBucketAclResponseBody> body_ {};
  };
