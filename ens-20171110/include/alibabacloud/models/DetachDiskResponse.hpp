...
namespace Models
{
  ...
  public:
    ...
    inline const DetachDiskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachDiskResponseBody) };
    inline DetachDiskResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachDiskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachDiskResponseBody> body_ {};
  };
