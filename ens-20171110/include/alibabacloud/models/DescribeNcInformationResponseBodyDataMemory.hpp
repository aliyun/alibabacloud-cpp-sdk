...
#ifndef ALIBABACLOUD_MODELS_DESCRIBENCINFORMATIONRESPONSEBODYDATAMEMORY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBENCINFORMATIONRESPONSEBODYDATAMEMORY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeNCInformationResponseBodyDataMemory& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeNCInformationResponseBodyDataMemory& obj) { 
    ...
    DescribeNCInformationResponseBodyDataMemory() = default ;
    DescribeNCInformationResponseBodyDataMemory(const DescribeNCInformationResponseBodyDataMemory &) = default ;
    DescribeNCInformationResponseBodyDataMemory(DescribeNCInformationResponseBodyDataMemory &&) = default ;
    DescribeNCInformationResponseBodyDataMemory(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeNCInformationResponseBodyDataMemory() = default ;
    DescribeNCInformationResponseBodyDataMemory& operator=(const DescribeNCInformationResponseBodyDataMemory &) = default ;
    DescribeNCInformationResponseBodyDataMemory& operator=(DescribeNCInformationResponseBodyDataMemory &&) = default ;
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setDisplay(bool display) { DARABONBA_PTR_SET_VALUE(display_, display) };
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setOversellRatio(int64_t oversellRatio) { DARABONBA_PTR_SET_VALUE(oversellRatio_, oversellRatio) };
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setRemain(int64_t remain) { DARABONBA_PTR_SET_VALUE(remain_, remain) };
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setReserveDisable(bool reserveDisable) { DARABONBA_PTR_SET_VALUE(reserveDisable_, reserveDisable) };
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setReserveDisableTotal(int64_t reserveDisableTotal) { DARABONBA_PTR_SET_VALUE(reserveDisableTotal_, reserveDisableTotal) };
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setReserved(int64_t reserved) { DARABONBA_PTR_SET_VALUE(reserved_, reserved) };
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setStatusDisable(bool statusDisable) { DARABONBA_PTR_SET_VALUE(statusDisable_, statusDisable) };
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setStatusDisableTotal(int64_t statusDisableTotal) { DARABONBA_PTR_SET_VALUE(statusDisableTotal_, statusDisableTotal) };
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setUsed(int64_t used) { DARABONBA_PTR_SET_VALUE(used_, used) };
    ...
    inline DescribeNCInformationResponseBodyDataMemory& setUsedRatio(int64_t usedRatio) { DARABONBA_PTR_SET_VALUE(usedRatio_, usedRatio) };
