...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBucketLifecycleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBucketLifecycleResponseBody) };
    inline DeleteBucketLifecycleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBucketLifecycleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBucketLifecycleResponseBody> body_ {};
  };
