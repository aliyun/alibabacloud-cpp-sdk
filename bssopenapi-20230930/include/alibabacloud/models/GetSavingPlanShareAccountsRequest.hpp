...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetSavingPlanShareAccountsRequest::EcIdAccountIds> & getEcIdAccountIds() const { DARABONBA_PTR_GET_CONST(ecIdAccountIds_, vector<GetSavingPlanShareAccountsRequest::EcIdAccountIds>) };
    inline vector<GetSavingPlanShareAccountsRequest::EcIdAccountIds> getEcIdAccountIds() { DARABONBA_PTR_GET(ecIdAccountIds_, vector<GetSavingPlanShareAccountsRequest::EcIdAccountIds>) };
    inline GetSavingPlanShareAccountsRequest& setEcIdAccountIds(const vector<GetSavingPlanShareAccountsRequest::EcIdAccountIds> & ecIdAccountIds) { DARABONBA_PTR_SET_VALUE(ecIdAccountIds_, ecIdAccountIds) };
    inline GetSavingPlanShareAccountsRequest& setEcIdAccountIds(vector<GetSavingPlanShareAccountsRequest::EcIdAccountIds> && ecIdAccountIds) { DARABONBA_PTR_SET_RVALUE(ecIdAccountIds_, ecIdAccountIds) };
  ...
  protected:
    ...
    shared_ptr<vector<GetSavingPlanShareAccountsRequest::EcIdAccountIds>> ecIdAccountIds_ {};
