...
namespace Models
{
  ...
  public:
    ...
    inline string resourceInstanceListShrink() const { DARABONBA_PTR_GET_DEFAULT(resourceInstanceListShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> resourceInstanceListShrink_ = nullptr;
