...
namespace Models
{
  ...
  public:
    ...
    inline const GetFundAccountCanRecycleAmountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetFundAccountCanRecycleAmountResponseBody) };
    inline GetFundAccountCanRecycleAmountResponseBody getBody() { DARABONBA_PTR_GET(body_, GetFundAccountCanRecycleAmountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetFundAccountCanRecycleAmountResponseBody> body_ {};
  };
