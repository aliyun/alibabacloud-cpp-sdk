...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCostCenterRuleRequest::FilterExpression & getFilterExpression() const { DARABONBA_PTR_GET_CONST(filterExpression_, DeleteCostCenterRuleRequest::FilterExpression) };
    inline DeleteCostCenterRuleRequest::FilterExpression getFilterExpression() { DARABONBA_PTR_GET(filterExpression_, DeleteCostCenterRuleRequest::FilterExpression) };
    inline DeleteCostCenterRuleRequest& setFilterExpression(const DeleteCostCenterRuleRequest::FilterExpression & filterExpression) { DARABONBA_PTR_SET_VALUE(filterExpression_, filterExpression) };
    inline DeleteCostCenterRuleRequest& setFilterExpression(DeleteCostCenterRuleRequest::FilterExpression && filterExpression) { DARABONBA_PTR_SET_RVALUE(filterExpression_, filterExpression) };
