...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetSavingPlanShareAccountsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetSavingPlanShareAccountsResponseBodyData>) };
    inline vector<GetSavingPlanShareAccountsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetSavingPlanShareAccountsResponseBodyData>) };
    inline GetSavingPlanShareAccountsResponseBody& setData(const vector<GetSavingPlanShareAccountsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSavingPlanShareAccountsResponseBody& setData(vector<GetSavingPlanShareAccountsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<GetSavingPlanShareAccountsResponseBodyData>> data_ = nullptr;
