...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCouponItemListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeCouponItemListResponseBodyData>) };
    inline vector<DescribeCouponItemListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeCouponItemListResponseBodyData>) };
    inline DescribeCouponItemListResponseBody& setData(const vector<DescribeCouponItemListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCouponItemListResponseBody& setData(vector<DescribeCouponItemListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeCouponItemListResponseBodyData>> data_ = nullptr;
