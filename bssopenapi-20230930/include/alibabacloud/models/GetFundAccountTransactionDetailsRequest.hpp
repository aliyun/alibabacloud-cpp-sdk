...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->billNumber_ != nullptr
    ...
    inline const vector<string> & transactionChannelList() const { DARABONBA_PTR_GET_CONST(transactionChannelList_, vector<string>) };
    inline vector<string> transactionChannelList() { DARABONBA_PTR_GET(transactionChannelList_, vector<string>) };
    ...
    inline const vector<string> & transactionTypeList() const { DARABONBA_PTR_GET_CONST(transactionTypeList_, vector<string>) };
    inline vector<string> transactionTypeList() { DARABONBA_PTR_GET(transactionTypeList_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> transactionChannelList_ = nullptr;
    ...
    std::shared_ptr<vector<string>> transactionTypeList_ = nullptr;
  };
