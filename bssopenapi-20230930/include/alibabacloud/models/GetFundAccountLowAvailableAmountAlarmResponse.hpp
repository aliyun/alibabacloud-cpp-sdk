...
namespace Models
{
  ...
  public:
    ...
    inline const GetFundAccountLowAvailableAmountAlarmResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetFundAccountLowAvailableAmountAlarmResponseBody) };
    inline GetFundAccountLowAvailableAmountAlarmResponseBody getBody() { DARABONBA_PTR_GET(body_, GetFundAccountLowAvailableAmountAlarmResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetFundAccountLowAvailableAmountAlarmResponseBody> body_ {};
  };
