...
namespace Models
{
  ...
  public:
    ...
    inline DescribeCouponRequest& setIncludeShare(bool includeShare) { DARABONBA_PTR_SET_VALUE(includeShare_, includeShare) };
    ...
    inline DescribeCouponRequest& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline DescribeCouponRequest& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline DescribeCouponRequest& setProductCode(string productCode) { DARABONBA_PTR_SET_VALUE(productCode_, productCode) };
