...
namespace Models
{
  ...
  public:
    ...
    inline const GetOrdersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetOrdersResponseBodyData) };
    inline GetOrdersResponseBodyData data() { DARABONBA_PTR_GET(data_, GetOrdersResponseBodyData) };
    inline GetOrdersResponseBody& setData(const GetOrdersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetOrdersResponseBody& setData(GetOrdersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetOrdersResponseBodyData> data_ = nullptr;
