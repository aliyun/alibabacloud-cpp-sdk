...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCouponItemListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeCouponItemListResponseBody) };
    inline DescribeCouponItemListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeCouponItemListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCouponItemListResponseBody> body_ = nullptr;
  };
