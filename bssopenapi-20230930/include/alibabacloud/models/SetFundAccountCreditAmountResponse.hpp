...
namespace Models
{
  ...
  public:
    ...
    inline const SetFundAccountCreditAmountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetFundAccountCreditAmountResponseBody) };
    inline SetFundAccountCreditAmountResponseBody getBody() { DARABONBA_PTR_GET(body_, SetFundAccountCreditAmountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetFundAccountCreditAmountResponseBody> body_ {};
  };
