...
#ifndef ALIBABACLOUD_MODELS_UPDATEBUDGETREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEBUDGETREQUEST_HPP_
...
namespace Models
{
  class UpdateBudgetRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateBudgetRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateBudgetRequest& obj) { 
    ...
    UpdateBudgetRequest(const UpdateBudgetRequest &) = default ;
    UpdateBudgetRequest(UpdateBudgetRequest &&) = default ;
    UpdateBudgetRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateBudgetRequest() = default ;
    UpdateBudgetRequest& operator=(const UpdateBudgetRequest &) = default ;
    UpdateBudgetRequest& operator=(UpdateBudgetRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->budgetName_ == nullptr
        ...
        && this->cycleType_ == nullptr && this->ecIdAccountIds_ == nullptr && this->metric_ == nullptr && this->nbid_ == nullptr && this->originalBudgetName_ == nullptr
        && this->queryFilter_ == nullptr && this->quota_ == nullptr && this->quotaType_ == nullptr && this->warnConfs_ == nullptr; };
    ...
    inline UpdateBudgetRequest& setBudgetName(string budgetName) { DARABONBA_PTR_SET_VALUE(budgetName_, budgetName) };
    ...
    inline UpdateBudgetRequest& setBudgetType(string budgetType) { DARABONBA_PTR_SET_VALUE(budgetType_, budgetType) };
    ...
    void deleteComment() { this->comment_ = nullptr;};
    inline string getComment() const { DARABONBA_PTR_GET_DEFAULT(comment_, "") };
    inline UpdateBudgetRequest& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline UpdateBudgetRequest& setCycleEndPeriod(string cycleEndPeriod) { DARABONBA_PTR_SET_VALUE(cycleEndPeriod_, cycleEndPeriod) };
    ...
    inline const vector<UpdateBudgetRequest::CycleQuota> & getCycleQuota() const { DARABONBA_PTR_GET_CONST(cycleQuota_, vector<UpdateBudgetRequest::CycleQuota>) };
    inline vector<UpdateBudgetRequest::CycleQuota> getCycleQuota() { DARABONBA_PTR_GET(cycleQuota_, vector<UpdateBudgetRequest::CycleQuota>) };
    inline UpdateBudgetRequest& setCycleQuota(const vector<UpdateBudgetRequest::CycleQuota> & cycleQuota) { DARABONBA_PTR_SET_VALUE(cycleQuota_, cycleQuota) };
    inline UpdateBudgetRequest& setCycleQuota(vector<UpdateBudgetRequest::CycleQuota> && cycleQuota) { DARABONBA_PTR_SET_RVALUE(cycleQuota_, cycleQuota) };
    ...
    inline UpdateBudgetRequest& setCycleStartPeriod(string cycleStartPeriod) { DARABONBA_PTR_SET_VALUE(cycleStartPeriod_, cycleStartPeriod) };
    ...
    inline UpdateBudgetRequest& setCycleType(string cycleType) { DARABONBA_PTR_SET_VALUE(cycleType_, cycleType) };
    ...
    inline const vector<UpdateBudgetRequest::EcIdAccountIds> & getEcIdAccountIds() const { DARABONBA_PTR_GET_CONST(ecIdAccountIds_, vector<UpdateBudgetRequest::EcIdAccountIds>) };
    inline vector<UpdateBudgetRequest::EcIdAccountIds> getEcIdAccountIds() { DARABONBA_PTR_GET(ecIdAccountIds_, vector<UpdateBudgetRequest::EcIdAccountIds>) };
    inline UpdateBudgetRequest& setEcIdAccountIds(const vector<UpdateBudgetRequest::EcIdAccountIds> & ecIdAccountIds) { DARABONBA_PTR_SET_VALUE(ecIdAccountIds_, ecIdAccountIds) };
    inline UpdateBudgetRequest& setEcIdAccountIds(vector<UpdateBudgetRequest::EcIdAccountIds> && ecIdAccountIds) { DARABONBA_PTR_SET_RVALUE(ecIdAccountIds_, ecIdAccountIds) };
    ...
    inline UpdateBudgetRequest& setMetric(string metric) { DARABONBA_PTR_SET_VALUE(metric_, metric) };
    ...
    inline UpdateBudgetRequest& setNbid(string nbid) { DARABONBA_PTR_SET_VALUE(nbid_, nbid) };
    ...
    inline UpdateBudgetRequest& setOriginalBudgetName(string originalBudgetName) { DARABONBA_PTR_SET_VALUE(originalBudgetName_, originalBudgetName) };
    ...
    inline const vector<UpdateBudgetRequest::QueryFilter> & getQueryFilter() const { DARABONBA_PTR_GET_CONST(queryFilter_, vector<UpdateBudgetRequest::QueryFilter>) };
    inline vector<UpdateBudgetRequest::QueryFilter> getQueryFilter() { DARABONBA_PTR_GET(queryFilter_, vector<UpdateBudgetRequest::QueryFilter>) };
    inline UpdateBudgetRequest& setQueryFilter(const vector<UpdateBudgetRequest::QueryFilter> & queryFilter) { DARABONBA_PTR_SET_VALUE(queryFilter_, queryFilter) };
    inline UpdateBudgetRequest& setQueryFilter(vector<UpdateBudgetRequest::QueryFilter> && queryFilter) { DARABONBA_PTR_SET_RVALUE(queryFilter_, queryFilter) };
    ...
    void deleteQuota() { this->quota_ = nullptr;};
    inline string getQuota() const { DARABONBA_PTR_GET_DEFAULT(quota_, "") };
    inline UpdateBudgetRequest& setQuota(string quota) { DARABONBA_PTR_SET_VALUE(quota_, quota) };
    ...
    inline UpdateBudgetRequest& setQuotaType(string quotaType) { DARABONBA_PTR_SET_VALUE(quotaType_, quotaType) };
    ...
    inline const vector<UpdateBudgetRequest::WarnConfs> & getWarnConfs() const { DARABONBA_PTR_GET_CONST(warnConfs_, vector<UpdateBudgetRequest::WarnConfs>) };
    inline vector<UpdateBudgetRequest::WarnConfs> getWarnConfs() { DARABONBA_PTR_GET(warnConfs_, vector<UpdateBudgetRequest::WarnConfs>) };
    inline UpdateBudgetRequest& setWarnConfs(const vector<UpdateBudgetRequest::WarnConfs> & warnConfs) { DARABONBA_PTR_SET_VALUE(warnConfs_, warnConfs) };
    inline UpdateBudgetRequest& setWarnConfs(vector<UpdateBudgetRequest::WarnConfs> && warnConfs) { DARABONBA_PTR_SET_RVALUE(warnConfs_, warnConfs) };
