...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->ecid_ != nullptr
    ...
    inline string ecidAllocatedCreditAmount() const { DARABONBA_PTR_GET_DEFAULT(ecidAllocatedCreditAmount_, "") };
    ...
    inline string ecidCreditAmount() const { DARABONBA_PTR_GET_DEFAULT(ecidCreditAmount_, "") };
    ...
    inline string maxCanAllocateCreditAmount() const { DARABONBA_PTR_GET_DEFAULT(maxCanAllocateCreditAmount_, "") };
    ...
    inline string minCanAllocateCreditAmount() const { DARABONBA_PTR_GET_DEFAULT(minCanAllocateCreditAmount_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> ecidAllocatedCreditAmount_ = nullptr;
    std::shared_ptr<string> ecidCreditAmount_ = nullptr;
    ...
    std::shared_ptr<string> maxCanAllocateCreditAmount_ = nullptr;
    Darabonba::Json metadata_ = nullptr;
    std::shared_ptr<string> minCanAllocateCreditAmount_ = nullptr;
