...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCostCenterRuleRequest::FilterExpression & getFilterExpression() const { DARABONBA_PTR_GET_CONST(filterExpression_, ModifyCostCenterRuleRequest::FilterExpression) };
    inline ModifyCostCenterRuleRequest::FilterExpression getFilterExpression() { DARABONBA_PTR_GET(filterExpression_, ModifyCostCenterRuleRequest::FilterExpression) };
    inline ModifyCostCenterRuleRequest& setFilterExpression(const ModifyCostCenterRuleRequest::FilterExpression & filterExpression) { DARABONBA_PTR_SET_VALUE(filterExpression_, filterExpression) };
    inline ModifyCostCenterRuleRequest& setFilterExpression(ModifyCostCenterRuleRequest::FilterExpression && filterExpression) { DARABONBA_PTR_SET_RVALUE(filterExpression_, filterExpression) };
