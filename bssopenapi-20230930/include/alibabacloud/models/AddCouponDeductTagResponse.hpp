...
namespace Models
{
  ...
  public:
    ...
    inline const AddCouponDeductTagResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddCouponDeductTagResponseBody) };
    inline AddCouponDeductTagResponseBody getBody() { DARABONBA_PTR_GET(body_, AddCouponDeductTagResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddCouponDeductTagResponseBody> body_ {};
  };
