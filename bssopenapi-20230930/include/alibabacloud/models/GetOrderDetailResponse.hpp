...
namespace Models
{
  ...
  public:
    ...
    inline const GetOrderDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOrderDetailResponseBody) };
    inline GetOrderDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOrderDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOrderDetailResponseBody> body_ {};
  };
