...
namespace Models
{
  ...
  public:
    ...
    inline const ListFundAccountPayRelationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListFundAccountPayRelationResponseBody) };
    inline ListFundAccountPayRelationResponseBody body() { DARABONBA_PTR_GET(body_, ListFundAccountPayRelationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListFundAccountPayRelationResponseBody> body_ = nullptr;
  };
