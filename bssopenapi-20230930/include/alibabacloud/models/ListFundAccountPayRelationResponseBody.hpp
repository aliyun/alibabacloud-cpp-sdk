...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListFundAccountPayRelationResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListFundAccountPayRelationResponseBodyData>) };
    inline vector<ListFundAccountPayRelationResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListFundAccountPayRelationResponseBodyData>) };
    inline ListFundAccountPayRelationResponseBody& setData(const vector<ListFundAccountPayRelationResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListFundAccountPayRelationResponseBody& setData(vector<ListFundAccountPayRelationResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListFundAccountPayRelationResponseBodyData>> data_ = nullptr;
