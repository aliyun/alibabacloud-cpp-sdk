...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetSavingPlanDeductableCommodityResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetSavingPlanDeductableCommodityResponseBodyData>) };
    inline vector<GetSavingPlanDeductableCommodityResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetSavingPlanDeductableCommodityResponseBodyData>) };
    inline GetSavingPlanDeductableCommodityResponseBody& setData(const vector<GetSavingPlanDeductableCommodityResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSavingPlanDeductableCommodityResponseBody& setData(vector<GetSavingPlanDeductableCommodityResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<GetSavingPlanDeductableCommodityResponseBodyData>> data_ = nullptr;
