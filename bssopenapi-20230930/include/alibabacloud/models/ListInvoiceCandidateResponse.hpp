...
namespace Models
{
  ...
  public:
    ...
    inline const ListInvoiceCandidateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInvoiceCandidateResponseBody) };
    inline ListInvoiceCandidateResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInvoiceCandidateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInvoiceCandidateResponseBody> body_ {};
  };
