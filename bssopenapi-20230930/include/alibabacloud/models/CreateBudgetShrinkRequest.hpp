...
#ifndef ALIBABACLOUD_MODELS_CREATEBUDGETSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEBUDGETSHRINKREQUEST_HPP_
...
namespace Models
{
  class CreateBudgetShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateBudgetShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateBudgetShrinkRequest& obj) { 
    ...
    CreateBudgetShrinkRequest() = default ;
    CreateBudgetShrinkRequest(const CreateBudgetShrinkRequest &) = default ;
    CreateBudgetShrinkRequest(CreateBudgetShrinkRequest &&) = default ;
    CreateBudgetShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateBudgetShrinkRequest() = default ;
    CreateBudgetShrinkRequest& operator=(const CreateBudgetShrinkRequest &) = default ;
    CreateBudgetShrinkRequest& operator=(CreateBudgetShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->budgetName_ == nullptr
        ...
        && this->cycleType_ == nullptr && this->ecIdAccountIdsShrink_ == nullptr && this->metric_ == nullptr && this->nbid_ == nullptr && this->queryFilterShrink_ == nullptr
        && this->quota_ == nullptr && this->quotaType_ == nullptr && this->warnConfsShrink_ == nullptr; };
    ...
    inline CreateBudgetShrinkRequest& setBudgetName(string budgetName) { DARABONBA_PTR_SET_VALUE(budgetName_, budgetName) };
    ...
    inline CreateBudgetShrinkRequest& setBudgetType(string budgetType) { DARABONBA_PTR_SET_VALUE(budgetType_, budgetType) };
    ...
    inline CreateBudgetShrinkRequest& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline CreateBudgetShrinkRequest& setCycleEndPeriod(string cycleEndPeriod) { DARABONBA_PTR_SET_VALUE(cycleEndPeriod_, cycleEndPeriod) };
    ...
    inline CreateBudgetShrinkRequest& setCycleQuotaShrink(string cycleQuotaShrink) { DARABONBA_PTR_SET_VALUE(cycleQuotaShrink_, cycleQuotaShrink) };
    ...
    inline CreateBudgetShrinkRequest& setCycleStartPeriod(string cycleStartPeriod) { DARABONBA_PTR_SET_VALUE(cycleStartPeriod_, cycleStartPeriod) };
    ...
    inline CreateBudgetShrinkRequest& setCycleType(string cycleType) { DARABONBA_PTR_SET_VALUE(cycleType_, cycleType) };
    ...
    inline CreateBudgetShrinkRequest& setEcIdAccountIdsShrink(string ecIdAccountIdsShrink) { DARABONBA_PTR_SET_VALUE(ecIdAccountIdsShrink_, ecIdAccountIdsShrink) };
    ...
    inline CreateBudgetShrinkRequest& setMetric(string metric) { DARABONBA_PTR_SET_VALUE(metric_, metric) };
    ...
    inline CreateBudgetShrinkRequest& setNbid(string nbid) { DARABONBA_PTR_SET_VALUE(nbid_, nbid) };
    ...
    inline CreateBudgetShrinkRequest& setQueryFilterShrink(string queryFilterShrink) { DARABONBA_PTR_SET_VALUE(queryFilterShrink_, queryFilterShrink) };
    ...
    inline CreateBudgetShrinkRequest& setQuota(string quota) { DARABONBA_PTR_SET_VALUE(quota_, quota) };
    ...
    inline CreateBudgetShrinkRequest& setQuotaType(string quotaType) { DARABONBA_PTR_SET_VALUE(quotaType_, quotaType) };
    ...
    inline CreateBudgetShrinkRequest& setWarnConfsShrink(string warnConfsShrink) { DARABONBA_PTR_SET_VALUE(warnConfsShrink_, warnConfsShrink) };
