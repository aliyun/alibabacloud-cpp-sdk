...
namespace Models
{
  ...
  public:
    ...
    inline const CreateReportDefinitionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateReportDefinitionResponseBody) };
    inline CreateReportDefinitionResponseBody body() { DARABONBA_PTR_GET(body_, CreateReportDefinitionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateReportDefinitionResponseBody> body_ = nullptr;
  };
