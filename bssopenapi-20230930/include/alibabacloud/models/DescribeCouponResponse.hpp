...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCouponResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCouponResponseBody) };
    inline DescribeCouponResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCouponResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCouponResponseBody> body_ {};
  };
