...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEBUDGETSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEBUDGETSRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeBudgetsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeBudgetsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeBudgetsResponseBody& obj) { 
    ...
    DescribeBudgetsResponseBody() = default ;
    DescribeBudgetsResponseBody(const DescribeBudgetsResponseBody &) = default ;
    DescribeBudgetsResponseBody(DescribeBudgetsResponseBody &&) = default ;
    DescribeBudgetsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeBudgetsResponseBody() = default ;
    DescribeBudgetsResponseBody& operator=(const DescribeBudgetsResponseBody &) = default ;
    DescribeBudgetsResponseBody& operator=(DescribeBudgetsResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->budgetName_ == nullptr
        ...
        && this->cycleType_ == nullptr && this->ecIdAccountIdsFilter_ == nullptr && this->expireStatus_ == nullptr && this->metric_ == nullptr && this->queryFilter_ == nullptr
      ...
      inline Data& setBudgetName(string budgetName) { DARABONBA_PTR_SET_VALUE(budgetName_, budgetName) };
      ...
      inline Data& setCycleEndPeriod(string cycleEndPeriod) { DARABONBA_PTR_SET_VALUE(cycleEndPeriod_, cycleEndPeriod) };
      ...
      inline const vector<Data::CycleQuota> & getCycleQuota() const { DARABONBA_PTR_GET_CONST(cycleQuota_, vector<Data::CycleQuota>) };
      inline vector<Data::CycleQuota> getCycleQuota() { DARABONBA_PTR_GET(cycleQuota_, vector<Data::CycleQuota>) };
      inline Data& setCycleQuota(const vector<Data::CycleQuota> & cycleQuota) { DARABONBA_PTR_SET_VALUE(cycleQuota_, cycleQuota) };
      inline Data& setCycleQuota(vector<Data::CycleQuota> && cycleQuota) { DARABONBA_PTR_SET_RVALUE(cycleQuota_, cycleQuota) };
      ...
      inline Data& setCycleStartPeriod(string cycleStartPeriod) { DARABONBA_PTR_SET_VALUE(cycleStartPeriod_, cycleStartPeriod) };
      ...
      inline Data& setCycleType(string cycleType) { DARABONBA_PTR_SET_VALUE(cycleType_, cycleType) };
      ...
      inline const Data::EcIdAccountIdsFilter & getEcIdAccountIdsFilter() const { DARABONBA_PTR_GET_CONST(ecIdAccountIdsFilter_, Data::EcIdAccountIdsFilter) };
      inline Data::EcIdAccountIdsFilter getEcIdAccountIdsFilter() { DARABONBA_PTR_GET(ecIdAccountIdsFilter_, Data::EcIdAccountIdsFilter) };
      inline Data& setEcIdAccountIdsFilter(const Data::EcIdAccountIdsFilter & ecIdAccountIdsFilter) { DARABONBA_PTR_SET_VALUE(ecIdAccountIdsFilter_, ecIdAccountIdsFilter) };
      inline Data& setEcIdAccountIdsFilter(Data::EcIdAccountIdsFilter && ecIdAccountIdsFilter) { DARABONBA_PTR_SET_RVALUE(ecIdAccountIdsFilter_, ecIdAccountIdsFilter) };
      ...
      inline Data& setExpireStatus(string expireStatus) { DARABONBA_PTR_SET_VALUE(expireStatus_, expireStatus) };
      ...
      inline Data& setMetric(string metric) { DARABONBA_PTR_SET_VALUE(metric_, metric) };
      ...
      inline const vector<Data::QueryFilter> & getQueryFilter() const { DARABONBA_PTR_GET_CONST(queryFilter_, vector<Data::QueryFilter>) };
      inline vector<Data::QueryFilter> getQueryFilter() { DARABONBA_PTR_GET(queryFilter_, vector<Data::QueryFilter>) };
      inline Data& setQueryFilter(const vector<Data::QueryFilter> & queryFilter) { DARABONBA_PTR_SET_VALUE(queryFilter_, queryFilter) };
      inline Data& setQueryFilter(vector<Data::QueryFilter> && queryFilter) { DARABONBA_PTR_SET_RVALUE(queryFilter_, queryFilter) };
      ...
      void deleteQuota() { this->quota_ = nullptr;};
      inline string getQuota() const { DARABONBA_PTR_GET_DEFAULT(quota_, "") };
      inline Data& setQuota(string quota) { DARABONBA_PTR_SET_VALUE(quota_, quota) };
      ...
      inline const vector<Data::WarnConfs> & getWarnConfs() const { DARABONBA_PTR_GET_CONST(warnConfs_, vector<Data::WarnConfs>) };
      inline vector<Data::WarnConfs> getWarnConfs() { DARABONBA_PTR_GET(warnConfs_, vector<Data::WarnConfs>) };
      inline Data& setWarnConfs(const vector<Data::WarnConfs> & warnConfs) { DARABONBA_PTR_SET_VALUE(warnConfs_, warnConfs) };
      inline Data& setWarnConfs(vector<Data::WarnConfs> && warnConfs) { DARABONBA_PTR_SET_RVALUE(warnConfs_, warnConfs) };
    ...
    inline DescribeBudgetsResponseBody& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<DescribeBudgetsResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeBudgetsResponseBody::Data>) };
    inline vector<DescribeBudgetsResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<DescribeBudgetsResponseBody::Data>) };
    inline DescribeBudgetsResponseBody& setData(const vector<DescribeBudgetsResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeBudgetsResponseBody& setData(vector<DescribeBudgetsResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeBudgetsResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline DescribeBudgetsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeBudgetsResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
