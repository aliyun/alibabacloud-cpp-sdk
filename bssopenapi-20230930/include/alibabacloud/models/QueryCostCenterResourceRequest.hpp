...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryCostCenterResourceRequest::EcIdAccountIds> & getEcIdAccountIds() const { DARABONBA_PTR_GET_CONST(ecIdAccountIds_, vector<QueryCostCenterResourceRequest::EcIdAccountIds>) };
    inline vector<QueryCostCenterResourceRequest::EcIdAccountIds> getEcIdAccountIds() { DARABONBA_PTR_GET(ecIdAccountIds_, vector<QueryCostCenterResourceRequest::EcIdAccountIds>) };
    inline QueryCostCenterResourceRequest& setEcIdAccountIds(const vector<QueryCostCenterResourceRequest::EcIdAccountIds> & ecIdAccountIds) { DARABONBA_PTR_SET_VALUE(ecIdAccountIds_, ecIdAccountIds) };
    inline QueryCostCenterResourceRequest& setEcIdAccountIds(vector<QueryCostCenterResourceRequest::EcIdAccountIds> && ecIdAccountIds) { DARABONBA_PTR_SET_RVALUE(ecIdAccountIds_, ecIdAccountIds) };
