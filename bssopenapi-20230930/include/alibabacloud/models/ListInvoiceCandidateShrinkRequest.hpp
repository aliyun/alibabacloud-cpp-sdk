...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->billingCyclesShrink_ == nullptr
    ...
    inline string getBillingCyclesShrink() const { DARABONBA_PTR_GET_DEFAULT(billingCyclesShrink_, "") };
    ...
    inline string getBusinessIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(businessIdsShrink_, "") };
    ...
    inline string getInvoiceIssuersShrink() const { DARABONBA_PTR_GET_DEFAULT(invoiceIssuersShrink_, "") };
