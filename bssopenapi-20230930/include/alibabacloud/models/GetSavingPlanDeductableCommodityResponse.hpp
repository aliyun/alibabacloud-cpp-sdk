...
namespace Models
{
  ...
  public:
    ...
    inline const GetSavingPlanDeductableCommodityResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetSavingPlanDeductableCommodityResponseBody) };
    inline GetSavingPlanDeductableCommodityResponseBody body() { DARABONBA_PTR_GET(body_, GetSavingPlanDeductableCommodityResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetSavingPlanDeductableCommodityResponseBody> body_ = nullptr;
  };
