...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListFundAccountResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListFundAccountResponseBodyData>) };
    inline vector<ListFundAccountResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListFundAccountResponseBodyData>) };
    inline ListFundAccountResponseBody& setData(const vector<ListFundAccountResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListFundAccountResponseBody& setData(vector<ListFundAccountResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<ListFundAccountResponseBodyData>> data_ = nullptr;
