...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListInvoiceTitleResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListInvoiceTitleResponseBodyData>) };
    inline vector<ListInvoiceTitleResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListInvoiceTitleResponseBodyData>) };
    inline ListInvoiceTitleResponseBody& setData(const vector<ListInvoiceTitleResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListInvoiceTitleResponseBody& setData(vector<ListInvoiceTitleResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<ListInvoiceTitleResponseBodyData>> data_ = nullptr;
