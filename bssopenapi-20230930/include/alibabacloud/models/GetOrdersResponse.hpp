...
namespace Models
{
  ...
  public:
    ...
    inline const GetOrdersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOrdersResponseBody) };
    inline GetOrdersResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOrdersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOrdersResponseBody> body_ {};
  };
