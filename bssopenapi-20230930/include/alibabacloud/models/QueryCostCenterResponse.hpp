...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCostCenterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryCostCenterResponseBody) };
    inline QueryCostCenterResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryCostCenterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryCostCenterResponseBody> body_ {};
  };
