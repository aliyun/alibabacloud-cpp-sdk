...
namespace Models
{
  ...
  public:
    ...
    inline const SaveCostCenterShareRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveCostCenterShareRuleResponseBody) };
    inline SaveCostCenterShareRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveCostCenterShareRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveCostCenterShareRuleResponseBody> body_ {};
  };
