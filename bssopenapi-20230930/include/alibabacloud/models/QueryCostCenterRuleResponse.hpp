...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCostCenterRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryCostCenterRuleResponseBody) };
    inline QueryCostCenterRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryCostCenterRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryCostCenterRuleResponseBody> body_ {};
  };
