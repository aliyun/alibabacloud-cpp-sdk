...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetSavingPlanUserDeductRuleResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetSavingPlanUserDeductRuleResponseBodyData>) };
    inline vector<GetSavingPlanUserDeductRuleResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetSavingPlanUserDeductRuleResponseBodyData>) };
    inline GetSavingPlanUserDeductRuleResponseBody& setData(const vector<GetSavingPlanUserDeductRuleResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSavingPlanUserDeductRuleResponseBody& setData(vector<GetSavingPlanUserDeductRuleResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<GetSavingPlanUserDeductRuleResponseBodyData>> data_ = nullptr;
