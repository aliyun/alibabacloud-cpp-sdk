...
namespace Models
{
  ...
  public:
    ...
    inline const ListReportDefinitionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListReportDefinitionsResponseBody) };
    inline ListReportDefinitionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListReportDefinitionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListReportDefinitionsResponseBody> body_ {};
  };
