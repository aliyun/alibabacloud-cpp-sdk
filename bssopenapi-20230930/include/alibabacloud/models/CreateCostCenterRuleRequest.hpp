...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCostCenterRuleRequest::FilterExpression & getFilterExpression() const { DARABONBA_PTR_GET_CONST(filterExpression_, CreateCostCenterRuleRequest::FilterExpression) };
    inline CreateCostCenterRuleRequest::FilterExpression getFilterExpression() { DARABONBA_PTR_GET(filterExpression_, CreateCostCenterRuleRequest::FilterExpression) };
    inline CreateCostCenterRuleRequest& setFilterExpression(const CreateCostCenterRuleRequest::FilterExpression & filterExpression) { DARABONBA_PTR_SET_VALUE(filterExpression_, filterExpression) };
    inline CreateCostCenterRuleRequest& setFilterExpression(CreateCostCenterRuleRequest::FilterExpression && filterExpression) { DARABONBA_PTR_SET_RVALUE(filterExpression_, filterExpression) };
  ...
  protected:
    ...
    shared_ptr<CreateCostCenterRuleRequest::FilterExpression> filterExpression_ {};
