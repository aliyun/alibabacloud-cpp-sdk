...
namespace Models
{
  ...
  public:
    ...
    inline const GetFundAccountTransactionDetailsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetFundAccountTransactionDetailsResponseBody) };
    inline GetFundAccountTransactionDetailsResponseBody body() { DARABONBA_PTR_GET(body_, GetFundAccountTransactionDetailsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetFundAccountTransactionDetailsResponseBody> body_ = nullptr;
  };
