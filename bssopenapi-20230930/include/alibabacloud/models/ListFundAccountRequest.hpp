...
namespace Models
{
  ...
  public:
    ...
    inline bool getQueryOnlyInUse() const { DARABONBA_PTR_GET_DEFAULT(queryOnlyInUse_, false) };
    ...
    inline bool getQueryOnlyManage() const { DARABONBA_PTR_GET_DEFAULT(queryOnlyManage_, false) };
