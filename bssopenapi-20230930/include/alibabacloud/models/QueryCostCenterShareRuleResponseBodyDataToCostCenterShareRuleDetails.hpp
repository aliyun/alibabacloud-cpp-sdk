...
#ifndef ALIBABACLOUD_MODELS_QUERYCOSTCENTERSHARERULERESPONSEBODYDATATOCOSTCENTERSHARERULEDETAILS_HPP_
#define ALIBABACLOUD_MODELS_QUERYCOSTCENTERSHARERULERESPONSEBODYDATATOCOSTCENTERSHARERULEDETAILS_HPP_
...
namespace Models
{
  class QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& obj) { 
    ...
    QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails() = default ;
    QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails(const QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails &) = default ;
    QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails(QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails &&) = default ;
    QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails() = default ;
    QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& operator=(const QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails &) = default ;
    QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& operator=(QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails &&) = default ;
    ...
    inline QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& setCostCenterCode(string costCenterCode) { DARABONBA_PTR_SET_VALUE(costCenterCode_, costCenterCode) };
    ...
    inline QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& setCostCenterId(int64_t costCenterId) { DARABONBA_PTR_SET_VALUE(costCenterId_, costCenterId) };
    ...
    inline QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& setCostCenterName(string costCenterName) { DARABONBA_PTR_SET_VALUE(costCenterName_, costCenterName) };
    ...
    inline QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& setOwnerAccountId(int64_t ownerAccountId) { DARABONBA_PTR_SET_VALUE(ownerAccountId_, ownerAccountId) };
    ...
    inline QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& setParentCostCenterId(int64_t parentCostCenterId) { DARABONBA_PTR_SET_VALUE(parentCostCenterId_, parentCostCenterId) };
    ...
    inline QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& setPrevCostCenterId(int64_t prevCostCenterId) { DARABONBA_PTR_SET_VALUE(prevCostCenterId_, prevCostCenterId) };
    ...
    inline QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& setRootCostCenterId(int64_t rootCostCenterId) { DARABONBA_PTR_SET_VALUE(rootCostCenterId_, rootCostCenterId) };
    ...
    inline double shareRatio() const { DARABONBA_PTR_GET_DEFAULT(shareRatio_, 0.0) };
    inline QueryCostCenterShareRuleResponseBodyDataToCostCenterShareRuleDetails& setShareRatio(double shareRatio) { DARABONBA_PTR_SET_VALUE(shareRatio_, shareRatio) };
  ...
  protected:
    ...
    std::shared_ptr<double> shareRatio_ = nullptr;
  };
