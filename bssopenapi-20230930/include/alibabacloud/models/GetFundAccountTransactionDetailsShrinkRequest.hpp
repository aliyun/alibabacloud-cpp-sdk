...
namespace Models
{
  ...
  public:
    ...
    inline string transactionChannelListShrink() const { DARABONBA_PTR_GET_DEFAULT(transactionChannelListShrink_, "") };
    ...
    inline string transactionTypeListShrink() const { DARABONBA_PTR_GET_DEFAULT(transactionTypeListShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> transactionChannelListShrink_ = nullptr;
    ...
    std::shared_ptr<string> transactionTypeListShrink_ = nullptr;
  };
