...
namespace Models
{
  ...
  public:
    ...
    inline const CheckAccountExistResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CheckAccountExistResponseBodyData) };
    inline CheckAccountExistResponseBodyData data() { DARABONBA_PTR_GET(data_, CheckAccountExistResponseBodyData) };
    inline CheckAccountExistResponseBody& setData(const CheckAccountExistResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CheckAccountExistResponseBody& setData(CheckAccountExistResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<CheckAccountExistResponseBodyData> data_ = nullptr;
