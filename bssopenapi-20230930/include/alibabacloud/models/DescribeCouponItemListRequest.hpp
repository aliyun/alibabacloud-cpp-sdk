...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCouponItemListRequest::EcIdAccountIds> & getEcIdAccountIds() const { DARABONBA_PTR_GET_CONST(ecIdAccountIds_, vector<DescribeCouponItemListRequest::EcIdAccountIds>) };
    inline vector<DescribeCouponItemListRequest::EcIdAccountIds> getEcIdAccountIds() { DARABONBA_PTR_GET(ecIdAccountIds_, vector<DescribeCouponItemListRequest::EcIdAccountIds>) };
    inline DescribeCouponItemListRequest& setEcIdAccountIds(const vector<DescribeCouponItemListRequest::EcIdAccountIds> & ecIdAccountIds) { DARABONBA_PTR_SET_VALUE(ecIdAccountIds_, ecIdAccountIds) };
    inline DescribeCouponItemListRequest& setEcIdAccountIds(vector<DescribeCouponItemListRequest::EcIdAccountIds> && ecIdAccountIds) { DARABONBA_PTR_SET_RVALUE(ecIdAccountIds_, ecIdAccountIds) };
