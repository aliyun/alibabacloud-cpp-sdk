...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSlsLogstoreInfoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSlsLogstoreInfoResponseBody) };
    inline DescribeSlsLogstoreInfoResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSlsLogstoreInfoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSlsLogstoreInfoResponseBody> body_ = nullptr;
  };
