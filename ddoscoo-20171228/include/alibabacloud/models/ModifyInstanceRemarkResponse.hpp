...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceRemarkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceRemarkResponseBody) };
    inline ModifyInstanceRemarkResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyInstanceRemarkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyInstanceRemarkResponseBody> body_ {};
  };
