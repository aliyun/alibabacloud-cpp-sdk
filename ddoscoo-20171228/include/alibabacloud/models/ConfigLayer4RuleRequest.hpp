...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigLayer4RuleRequest::UsTimeout & getUsTimeout() const { DARABONBA_PTR_GET_CONST(usTimeout_, ConfigLayer4RuleRequest::UsTimeout) };
    inline ConfigLayer4RuleRequest::UsTimeout getUsTimeout() { DARABONBA_PTR_GET(usTimeout_, ConfigLayer4RuleRequest::UsTimeout) };
    inline ConfigLayer4RuleRequest& setUsTimeout(const ConfigLayer4RuleRequest::UsTimeout & usTimeout) { DARABONBA_PTR_SET_VALUE(usTimeout_, usTimeout) };
    inline ConfigLayer4RuleRequest& setUsTimeout(ConfigLayer4RuleRequest::UsTimeout && usTimeout) { DARABONBA_PTR_SET_RVALUE(usTimeout_, usTimeout) };
  ...
  protected:
    ...
    shared_ptr<ConfigLayer4RuleRequest::UsTimeout> usTimeout_ {};
  };
