...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainQpsWithCacheResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainQpsWithCacheResponseBody) };
    inline DescribeDomainQpsWithCacheResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainQpsWithCacheResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainQpsWithCacheResponseBody> body_ {};
  };
