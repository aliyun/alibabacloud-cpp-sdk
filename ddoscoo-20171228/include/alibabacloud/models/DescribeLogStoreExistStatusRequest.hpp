...
namespace Models
{
  ...
  public:
    ...
    inline DescribeLogStoreExistStatusRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline DescribeLogStoreExistStatusRequest& setSourceIp(string sourceIp) { DARABONBA_PTR_SET_VALUE(sourceIp_, sourceIp) };
