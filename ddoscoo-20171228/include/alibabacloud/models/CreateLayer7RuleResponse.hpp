...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLayer7RuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLayer7RuleResponseBody) };
    inline CreateLayer7RuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLayer7RuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLayer7RuleResponseBody> body_ {};
  };
