...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLayer4RuleAttributesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLayer4RuleAttributesResponseBody) };
    inline DescribeLayer4RuleAttributesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLayer4RuleAttributesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLayer4RuleAttributesResponseBody> body_ {};
  };
