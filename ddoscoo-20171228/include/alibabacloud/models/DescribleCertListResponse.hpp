...
namespace Models
{
  ...
  public:
    ...
    inline const DescribleCertListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribleCertListResponseBody) };
    inline DescribleCertListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribleCertListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribleCertListResponseBody> body_ {};
  };
