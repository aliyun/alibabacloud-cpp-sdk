...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDDoSEventsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDDoSEventsResponseBody) };
    inline DescribeDDoSEventsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDDoSEventsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDDoSEventsResponseBody> body_ = nullptr;
  };
