...
namespace Models
{
  ...
  public:
    ...
    inline const DescribleLayer7InstanceRelationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribleLayer7InstanceRelationsResponseBody) };
    inline DescribleLayer7InstanceRelationsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribleLayer7InstanceRelationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribleLayer7InstanceRelationsResponseBody> body_ {};
  };
