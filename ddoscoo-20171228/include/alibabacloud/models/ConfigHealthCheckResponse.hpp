...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigHealthCheckResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigHealthCheckResponseBody) };
    inline ConfigHealthCheckResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigHealthCheckResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigHealthCheckResponseBody> body_ {};
  };
