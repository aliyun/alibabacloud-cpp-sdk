...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIpTrafficResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeIpTrafficResponseBody) };
    inline DescribeIpTrafficResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeIpTrafficResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeIpTrafficResponseBody> body_ {};
  };
