...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->domain_ == nullptr
        && this->domainList_ == nullptr && this->resourceGroupId_ == nullptr && this->sourceIp_ == nullptr; };
    ...
    inline DescribleCertListRequest& setDomainList(string domainList) { DARABONBA_PTR_SET_VALUE(domainList_, domainList) };
