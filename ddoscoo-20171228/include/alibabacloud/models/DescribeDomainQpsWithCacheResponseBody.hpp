...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getBlocks() const { DARABONBA_PTR_GET_CONST(blocks_, vector<string>) };
    inline vector<string> getBlocks() { DARABONBA_PTR_GET(blocks_, vector<string>) };
    ...
    inline const vector<string> & getCacheHits() const { DARABONBA_PTR_GET_CONST(cacheHits_, vector<string>) };
    inline vector<string> getCacheHits() { DARABONBA_PTR_GET(cacheHits_, vector<string>) };
    ...
    inline const vector<string> & getCcBlockQps() const { DARABONBA_PTR_GET_CONST(ccBlockQps_, vector<string>) };
    inline vector<string> getCcBlockQps() { DARABONBA_PTR_GET(ccBlockQps_, vector<string>) };
    ...
    inline const vector<string> & getCcJsQps() const { DARABONBA_PTR_GET_CONST(ccJsQps_, vector<string>) };
    inline vector<string> getCcJsQps() { DARABONBA_PTR_GET(ccJsQps_, vector<string>) };
    ...
    inline const vector<string> & getIpBlockQps() const { DARABONBA_PTR_GET_CONST(ipBlockQps_, vector<string>) };
    inline vector<string> getIpBlockQps() { DARABONBA_PTR_GET(ipBlockQps_, vector<string>) };
    ...
    inline const vector<string> & getPreciseBlocks() const { DARABONBA_PTR_GET_CONST(preciseBlocks_, vector<string>) };
    inline vector<string> getPreciseBlocks() { DARABONBA_PTR_GET(preciseBlocks_, vector<string>) };
    ...
    inline const vector<string> & getPreciseJsQps() const { DARABONBA_PTR_GET_CONST(preciseJsQps_, vector<string>) };
    inline vector<string> getPreciseJsQps() { DARABONBA_PTR_GET(preciseJsQps_, vector<string>) };
    ...
    inline const vector<string> & getRegionBlocks() const { DARABONBA_PTR_GET_CONST(regionBlocks_, vector<string>) };
    inline vector<string> getRegionBlocks() { DARABONBA_PTR_GET(regionBlocks_, vector<string>) };
    ...
    inline const vector<string> & getTotals() const { DARABONBA_PTR_GET_CONST(totals_, vector<string>) };
    inline vector<string> getTotals() { DARABONBA_PTR_GET(totals_, vector<string>) };
  ...
  protected:
    shared_ptr<vector<string>> blocks_ {};
    shared_ptr<vector<string>> cacheHits_ {};
    shared_ptr<vector<string>> ccBlockQps_ {};
    shared_ptr<vector<string>> ccJsQps_ {};
    shared_ptr<int32_t> interval_ {};
    shared_ptr<vector<string>> ipBlockQps_ {};
    shared_ptr<vector<string>> preciseBlocks_ {};
    shared_ptr<vector<string>> preciseJsQps_ {};
    shared_ptr<vector<string>> regionBlocks_ {};
    shared_ptr<string> requestId_ {};
    shared_ptr<int64_t> startTime_ {};
    shared_ptr<vector<string>> totals_ {};
  };
