...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDDoSEventsResponseBodyEvents> & events() const { DARABONBA_PTR_GET_CONST(events_, vector<DescribeDDoSEventsResponseBodyEvents>) };
    inline vector<DescribeDDoSEventsResponseBodyEvents> events() { DARABONBA_PTR_GET(events_, vector<DescribeDDoSEventsResponseBodyEvents>) };
    inline DescribeDDoSEventsResponseBody& setEvents(const vector<DescribeDDoSEventsResponseBodyEvents> & events) { DARABONBA_PTR_SET_VALUE(events_, events) };
    inline DescribeDDoSEventsResponseBody& setEvents(vector<DescribeDDoSEventsResponseBodyEvents> && events) { DARABONBA_PTR_SET_RVALUE(events_, events) };
  ...
  protected:
    std::shared_ptr<vector<DescribeDDoSEventsResponseBodyEvents>> events_ = nullptr;
