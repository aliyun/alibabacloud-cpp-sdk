...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHealthCheckListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHealthCheckListResponseBody) };
    inline DescribeHealthCheckListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHealthCheckListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHealthCheckListResponseBody> body_ {};
  };
