...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDomainAttackEventListResponseBodyDataList> & dataList() const { DARABONBA_PTR_GET_CONST(dataList_, vector<DescribeDomainAttackEventListResponseBodyDataList>) };
    inline vector<DescribeDomainAttackEventListResponseBodyDataList> dataList() { DARABONBA_PTR_GET(dataList_, vector<DescribeDomainAttackEventListResponseBodyDataList>) };
    inline DescribeDomainAttackEventListResponseBody& setDataList(const vector<DescribeDomainAttackEventListResponseBodyDataList> & dataList) { DARABONBA_PTR_SET_VALUE(dataList_, dataList) };
    inline DescribeDomainAttackEventListResponseBody& setDataList(vector<DescribeDomainAttackEventListResponseBodyDataList> && dataList) { DARABONBA_PTR_SET_RVALUE(dataList_, dataList) };
  ...
  protected:
    std::shared_ptr<vector<DescribeDomainAttackEventListResponseBodyDataList>> dataList_ = nullptr;
