...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigLayer7BlackWhiteListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigLayer7BlackWhiteListResponseBody) };
    inline ConfigLayer7BlackWhiteListResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigLayer7BlackWhiteListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigLayer7BlackWhiteListResponseBody> body_ {};
  };
