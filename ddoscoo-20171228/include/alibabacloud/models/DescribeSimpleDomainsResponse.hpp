...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSimpleDomainsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSimpleDomainsResponseBody) };
    inline DescribeSimpleDomainsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSimpleDomainsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSimpleDomainsResponseBody> body_ {};
  };
