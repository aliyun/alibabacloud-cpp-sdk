...
namespace Models
{
  ...
  public:
    ...
    inline DescribeSlsLogstoreInfoRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline DescribeSlsLogstoreInfoRequest& setSourceIp(string sourceIp) { DARABONBA_PTR_SET_VALUE(sourceIp_, sourceIp) };
