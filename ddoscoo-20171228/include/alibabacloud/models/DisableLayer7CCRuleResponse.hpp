...
namespace Models
{
  ...
  public:
    ...
    inline const DisableLayer7CCRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableLayer7CCRuleResponseBody) };
    inline DisableLayer7CCRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableLayer7CCRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableLayer7CCRuleResponseBody> body_ {};
  };
