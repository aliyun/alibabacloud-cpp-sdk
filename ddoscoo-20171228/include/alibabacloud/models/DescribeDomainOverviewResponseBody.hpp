...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxHttp_ == nullptr
    ...
    inline int64_t getMaxHttp() const { DARABONBA_PTR_GET_DEFAULT(maxHttp_, 0L) };
    ...
    inline int64_t getMaxHttps() const { DARABONBA_PTR_GET_DEFAULT(maxHttps_, 0L) };
  ...
  protected:
    shared_ptr<int64_t> maxHttp_ {};
    shared_ptr<int64_t> maxHttps_ {};
