...
namespace Models
{
  ...
  public:
    ...
    inline DescribeHealthCheckListRequest& setListeners(string listeners) { DARABONBA_PTR_SET_VALUE(listeners_, listeners) };
    ...
    inline DescribeHealthCheckListRequest& setSourceIp(string sourceIp) { DARABONBA_PTR_SET_VALUE(sourceIp_, sourceIp) };
