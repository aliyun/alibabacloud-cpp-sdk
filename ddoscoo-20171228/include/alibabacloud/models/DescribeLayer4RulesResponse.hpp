...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLayer4RulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLayer4RulesResponseBody) };
    inline DescribeLayer4RulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLayer4RulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLayer4RulesResponseBody> body_ {};
  };
