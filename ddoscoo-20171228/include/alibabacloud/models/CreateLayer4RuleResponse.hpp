...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLayer4RuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLayer4RuleResponseBody) };
    inline CreateLayer4RuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLayer4RuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLayer4RuleResponseBody> body_ {};
  };
