...
namespace Models
{
  ...
  public:
    ...
    inline const AddLayer7CCRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddLayer7CCRuleResponseBody) };
    inline AddLayer7CCRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, AddLayer7CCRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddLayer7CCRuleResponseBody> body_ {};
  };
