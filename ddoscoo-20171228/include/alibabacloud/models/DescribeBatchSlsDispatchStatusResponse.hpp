...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBatchSlsDispatchStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBatchSlsDispatchStatusResponseBody) };
    inline DescribeBatchSlsDispatchStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBatchSlsDispatchStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBatchSlsDispatchStatusResponseBody> body_ {};
  };
