...
namespace Models
{
  ...
  public:
    ...
    inline const EnableLayer7CCRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableLayer7CCRuleResponseBody) };
    inline EnableLayer7CCRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableLayer7CCRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableLayer7CCRuleResponseBody> body_ {};
  };
