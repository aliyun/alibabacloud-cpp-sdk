...
namespace Models
{
  ...
  public:
    ...
    inline string getProxyTypeList() const { DARABONBA_PTR_GET_DEFAULT(proxyTypeList_, "") };
    ...
    inline const vector<string> & getProxyTypes() const { DARABONBA_PTR_GET_CONST(proxyTypes_, vector<string>) };
    inline vector<string> getProxyTypes() { DARABONBA_PTR_GET(proxyTypes_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<string> proxyTypeList_ {};
    shared_ptr<vector<string>> proxyTypes_ {};
    // This parameter is required.
