...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigLayer7CertResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigLayer7CertResponseBody) };
    inline ConfigLayer7CertResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigLayer7CertResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigLayer7CertResponseBody> body_ {};
  };
