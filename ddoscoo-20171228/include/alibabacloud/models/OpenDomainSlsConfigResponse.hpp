...
namespace Models
{
  ...
  public:
    ...
    inline const OpenDomainSlsConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenDomainSlsConfigResponseBody) };
    inline OpenDomainSlsConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenDomainSlsConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenDomainSlsConfigResponseBody> body_ {};
  };
