...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->eipInfoList_ != nullptr
    ...
    inline const vector<Models::DescribeInstanceDetailsResponseBodyInstanceDetailsEipInfoList> & eipInfoList() const { DARABONBA_PTR_GET_CONST(eipInfoList_, vector<Models::DescribeInstanceDetailsResponseBodyInstanceDetailsEipInfoList>) };
    inline vector<Models::DescribeInstanceDetailsResponseBodyInstanceDetailsEipInfoList> eipInfoList() { DARABONBA_PTR_GET(eipInfoList_, vector<Models::DescribeInstanceDetailsResponseBodyInstanceDetailsEipInfoList>) };
    inline DescribeInstanceDetailsResponseBodyInstanceDetails& setEipInfoList(const vector<Models::DescribeInstanceDetailsResponseBodyInstanceDetailsEipInfoList> & eipInfoList) { DARABONBA_PTR_SET_VALUE(eipInfoList_, eipInfoList) };
    inline DescribeInstanceDetailsResponseBodyInstanceDetails& setEipInfoList(vector<Models::DescribeInstanceDetailsResponseBodyInstanceDetailsEipInfoList> && eipInfoList) { DARABONBA_PTR_SET_RVALUE(eipInfoList_, eipInfoList) };
  ...
  protected:
    std::shared_ptr<vector<Models::DescribeInstanceDetailsResponseBodyInstanceDetailsEipInfoList>> eipInfoList_ = nullptr;
