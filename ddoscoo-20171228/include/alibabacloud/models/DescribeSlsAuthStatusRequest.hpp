...
namespace Models
{
  ...
  public:
    ...
    inline DescribeSlsAuthStatusRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline DescribeSlsAuthStatusRequest& setSourceIp(string sourceIp) { DARABONBA_PTR_SET_VALUE(sourceIp_, sourceIp) };
