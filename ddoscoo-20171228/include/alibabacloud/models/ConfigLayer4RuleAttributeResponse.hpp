...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigLayer4RuleAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigLayer4RuleAttributeResponseBody) };
    inline ConfigLayer4RuleAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigLayer4RuleAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigLayer4RuleAttributeResponseBody> body_ {};
  };
