...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListPoliciesForTargetResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListPoliciesForTargetResponseBodyData>) };
    inline vector<ListPoliciesForTargetResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListPoliciesForTargetResponseBodyData>) };
    inline ListPoliciesForTargetResponseBody& setData(const vector<ListPoliciesForTargetResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPoliciesForTargetResponseBody& setData(vector<ListPoliciesForTargetResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListPoliciesForTargetResponseBodyData>> data_ = nullptr;
