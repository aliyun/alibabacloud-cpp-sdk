...
namespace Models
{
  ...
  public:
    ...
    inline const DisablePolicyTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisablePolicyTypeResponseBody) };
    inline DisablePolicyTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, DisablePolicyTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisablePolicyTypeResponseBody> body_ {};
  };
