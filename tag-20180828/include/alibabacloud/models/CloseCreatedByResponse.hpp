...
namespace Models
{
  ...
  public:
    ...
    inline const CloseCreatedByResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CloseCreatedByResponseBody) };
    inline CloseCreatedByResponseBody getBody() { DARABONBA_PTR_GET(body_, CloseCreatedByResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CloseCreatedByResponseBody> body_ {};
  };
