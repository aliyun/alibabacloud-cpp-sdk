...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAssociatedResourceRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAssociatedResourceRuleResponseBody) };
    inline UpdateAssociatedResourceRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAssociatedResourceRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAssociatedResourceRuleResponseBody> body_ {};
  };
