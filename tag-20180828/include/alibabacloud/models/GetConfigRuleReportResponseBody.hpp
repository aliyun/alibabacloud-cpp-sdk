...
namespace Models
{
  ...
  public:
    ...
    inline const GetConfigRuleReportResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetConfigRuleReportResponseBodyData) };
    inline GetConfigRuleReportResponseBodyData data() { DARABONBA_PTR_GET(data_, GetConfigRuleReportResponseBodyData) };
    inline GetConfigRuleReportResponseBody& setData(const GetConfigRuleReportResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetConfigRuleReportResponseBody& setData(GetConfigRuleReportResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetConfigRuleReportResponseBodyData> data_ = nullptr;
