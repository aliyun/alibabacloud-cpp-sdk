...
namespace Models
{
  ...
  public:
    ...
    inline const ListSupportResourceTypesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSupportResourceTypesResponseBody) };
    inline ListSupportResourceTypesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSupportResourceTypesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSupportResourceTypesResponseBody> body_ {};
  };
