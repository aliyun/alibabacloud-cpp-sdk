...
namespace Models
{
  ...
  public:
    ...
    inline const EnablePolicyTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnablePolicyTypeResponseBody) };
    inline EnablePolicyTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, EnablePolicyTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnablePolicyTypeResponseBody> body_ {};
  };
