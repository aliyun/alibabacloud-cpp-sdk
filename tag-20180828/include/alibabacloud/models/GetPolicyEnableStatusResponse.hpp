...
namespace Models
{
  ...
  public:
    ...
    inline const GetPolicyEnableStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPolicyEnableStatusResponseBody) };
    inline GetPolicyEnableStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPolicyEnableStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPolicyEnableStatusResponseBody> body_ {};
  };
