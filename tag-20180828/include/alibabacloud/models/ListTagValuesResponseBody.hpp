...
namespace Models
{
  ...
  public:
    ...
    inline const ListTagValuesResponseBodyValues & values() const { DARABONBA_PTR_GET_CONST(values_, ListTagValuesResponseBodyValues) };
    inline ListTagValuesResponseBodyValues values() { DARABONBA_PTR_GET(values_, ListTagValuesResponseBodyValues) };
    inline ListTagValuesResponseBody& setValues(const ListTagValuesResponseBodyValues & values) { DARABONBA_PTR_SET_VALUE(values_, values) };
    inline ListTagValuesResponseBody& setValues(ListTagValuesResponseBodyValues && values) { DARABONBA_PTR_SET_RVALUE(values_, values) };
  ...
  protected:
    ...
    std::shared_ptr<ListTagValuesResponseBodyValues> values_ = nullptr;
  };
