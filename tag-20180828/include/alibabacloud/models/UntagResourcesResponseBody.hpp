...
namespace Models
{
  ...
  public:
    ...
    inline const UntagResourcesResponseBody::FailedResources & getFailedResources() const { DARABONBA_PTR_GET_CONST(failedResources_, UntagResourcesResponseBody::FailedResources) };
    inline UntagResourcesResponseBody::FailedResources getFailedResources() { DARABONBA_PTR_GET(failedResources_, UntagResourcesResponseBody::FailedResources) };
    inline UntagResourcesResponseBody& setFailedResources(const UntagResourcesResponseBody::FailedResources & failedResources) { DARABONBA_PTR_SET_VALUE(failedResources_, failedResources) };
    inline UntagResourcesResponseBody& setFailedResources(UntagResourcesResponseBody::FailedResources && failedResources) { DARABONBA_PTR_SET_RVALUE(failedResources_, failedResources) };
  ...
  protected:
    shared_ptr<UntagResourcesResponseBody::FailedResources> failedResources_ {};
