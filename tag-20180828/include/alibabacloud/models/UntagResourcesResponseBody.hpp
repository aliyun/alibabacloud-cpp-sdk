...
namespace Models
{
  ...
  public:
    ...
    inline const UntagResourcesResponseBodyFailedResources & failedResources() const { DARABONBA_PTR_GET_CONST(failedResources_, UntagResourcesResponseBodyFailedResources) };
    inline UntagResourcesResponseBodyFailedResources failedResources() { DARABONBA_PTR_GET(failedResources_, UntagResourcesResponseBodyFailedResources) };
    inline UntagResourcesResponseBody& setFailedResources(const UntagResourcesResponseBodyFailedResources & failedResources) { DARABONBA_PTR_SET_VALUE(failedResources_, failedResources) };
    inline UntagResourcesResponseBody& setFailedResources(UntagResourcesResponseBodyFailedResources && failedResources) { DARABONBA_PTR_SET_RVALUE(failedResources_, failedResources) };
  ...
  protected:
    ...
    std::shared_ptr<UntagResourcesResponseBodyFailedResources> failedResources_ = nullptr;
