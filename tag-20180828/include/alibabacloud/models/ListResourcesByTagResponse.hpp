...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourcesByTagResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListResourcesByTagResponseBody) };
    inline ListResourcesByTagResponseBody getBody() { DARABONBA_PTR_GET(body_, ListResourcesByTagResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListResourcesByTagResponseBody> body_ {};
  };
