...
namespace Models
{
  ...
  public:
    ...
    inline const ListTagValuesRequest::TagFilter & getTagFilter() const { DARABONBA_PTR_GET_CONST(tagFilter_, ListTagValuesRequest::TagFilter) };
    inline ListTagValuesRequest::TagFilter getTagFilter() { DARABONBA_PTR_GET(tagFilter_, ListTagValuesRequest::TagFilter) };
    inline ListTagValuesRequest& setTagFilter(const ListTagValuesRequest::TagFilter & tagFilter) { DARABONBA_PTR_SET_VALUE(tagFilter_, tagFilter) };
    inline ListTagValuesRequest& setTagFilter(ListTagValuesRequest::TagFilter && tagFilter) { DARABONBA_PTR_SET_RVALUE(tagFilter_, tagFilter) };
  ...
  protected:
    shared_ptr<ListTagValuesRequest::TagFilter> tagFilter_ {};
