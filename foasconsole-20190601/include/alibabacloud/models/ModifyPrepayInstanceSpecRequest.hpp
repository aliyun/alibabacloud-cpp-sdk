...
namespace Models
{
  ...
  public:
    ...
    class ModifyPrepayInstanceSpecRequestItem : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const ModifyPrepayInstanceSpecRequestItem& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, ModifyPrepayInstanceSpecRequestItem& obj) { 
      ...
      ModifyPrepayInstanceSpecRequestItem() = default ;
      ModifyPrepayInstanceSpecRequestItem(const ModifyPrepayInstanceSpecRequestItem &) = default ;
      ModifyPrepayInstanceSpecRequestItem(ModifyPrepayInstanceSpecRequestItem &&) = default ;
      ModifyPrepayInstanceSpecRequestItem(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~ModifyPrepayInstanceSpecRequestItem() = default ;
      ModifyPrepayInstanceSpecRequestItem& operator=(const ModifyPrepayInstanceSpecRequestItem &) = default ;
      ModifyPrepayInstanceSpecRequestItem& operator=(ModifyPrepayInstanceSpecRequestItem &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline ModifyPrepayInstanceSpecRequestItem& setHa(bool ha) { DARABONBA_PTR_SET_VALUE(ha_, ha) };
      ...
      inline const ModifyPrepayInstanceSpecRequestItem::HaResourceSpec & getHaResourceSpec() const { DARABONBA_PTR_GET_CONST(haResourceSpec_, ModifyPrepayInstanceSpecRequestItem::HaResourceSpec) };
      inline ModifyPrepayInstanceSpecRequestItem::HaResourceSpec getHaResourceSpec() { DARABONBA_PTR_GET(haResourceSpec_, ModifyPrepayInstanceSpecRequestItem::HaResourceSpec) };
      inline ModifyPrepayInstanceSpecRequestItem& setHaResourceSpec(const ModifyPrepayInstanceSpecRequestItem::HaResourceSpec & haResourceSpec) { DARABONBA_PTR_SET_VALUE(haResourceSpec_, haResourceSpec) };
      inline ModifyPrepayInstanceSpecRequestItem& setHaResourceSpec(ModifyPrepayInstanceSpecRequestItem::HaResourceSpec && haResourceSpec) { DARABONBA_PTR_SET_RVALUE(haResourceSpec_, haResourceSpec) };
      ...
      inline ModifyPrepayInstanceSpecRequestItem& setHaVSwitchIds(const vector<string> & haVSwitchIds) { DARABONBA_PTR_SET_VALUE(haVSwitchIds_, haVSwitchIds) };
      inline ModifyPrepayInstanceSpecRequestItem& setHaVSwitchIds(vector<string> && haVSwitchIds) { DARABONBA_PTR_SET_RVALUE(haVSwitchIds_, haVSwitchIds) };
      ...
      inline ModifyPrepayInstanceSpecRequestItem& setHaZoneId(string haZoneId) { DARABONBA_PTR_SET_VALUE(haZoneId_, haZoneId) };
      ...
      inline ModifyPrepayInstanceSpecRequestItem& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
      ...
      inline ModifyPrepayInstanceSpecRequestItem& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
      ...
      inline const ModifyPrepayInstanceSpecRequestItem::ResourceSpec & getResourceSpec() const { DARABONBA_PTR_GET_CONST(resourceSpec_, ModifyPrepayInstanceSpecRequestItem::ResourceSpec) };
      inline ModifyPrepayInstanceSpecRequestItem::ResourceSpec getResourceSpec() { DARABONBA_PTR_GET(resourceSpec_, ModifyPrepayInstanceSpecRequestItem::ResourceSpec) };
      inline ModifyPrepayInstanceSpecRequestItem& setResourceSpec(const ModifyPrepayInstanceSpecRequestItem::ResourceSpec & resourceSpec) { DARABONBA_PTR_SET_VALUE(resourceSpec_, resourceSpec) };
      inline ModifyPrepayInstanceSpecRequestItem& setResourceSpec(ModifyPrepayInstanceSpecRequestItem::ResourceSpec && resourceSpec) { DARABONBA_PTR_SET_RVALUE(resourceSpec_, resourceSpec) };


    protected:
      shared_ptr<bool> ha_ {};
      shared_ptr<ModifyPrepayInstanceSpecRequestItem::HaResourceSpec> haResourceSpec_ {};
      ...
      // This parameter is required.
      shared_ptr<ModifyPrepayInstanceSpecRequestItem::ResourceSpec> resourceSpec_ {};
    };
    ...
    inline const ModifyPrepayInstanceSpecRequest::ModifyPrepayInstanceSpecRequestItem & getModifyPrepayInstanceSpecRequest() const { DARABONBA_PTR_GET_CONST(modifyPrepayInstanceSpecRequest_, ModifyPrepayInstanceSpecRequest::ModifyPrepayInstanceSpecRequestItem) };
    inline ModifyPrepayInstanceSpecRequest::ModifyPrepayInstanceSpecRequestItem getModifyPrepayInstanceSpecRequest() { DARABONBA_PTR_GET(modifyPrepayInstanceSpecRequest_, ModifyPrepayInstanceSpecRequest::ModifyPrepayInstanceSpecRequestItem) };
    inline ModifyPrepayInstanceSpecRequest& setModifyPrepayInstanceSpecRequest(const ModifyPrepayInstanceSpecRequest::ModifyPrepayInstanceSpecRequestItem & modifyPrepayInstanceSpecRequest) { DARABONBA_PTR_SET_VALUE(modifyPrepayInstanceSpecRequest_, modifyPrepayInstanceSpecRequest) };
    inline ModifyPrepayInstanceSpecRequest& setModifyPrepayInstanceSpecRequest(ModifyPrepayInstanceSpecRequest::ModifyPrepayInstanceSpecRequestItem && modifyPrepayInstanceSpecRequest) { DARABONBA_PTR_SET_RVALUE(modifyPrepayInstanceSpecRequest_, modifyPrepayInstanceSpecRequest) };


  protected:
    // This parameter is required.
    shared_ptr<ModifyPrepayInstanceSpecRequest::ModifyPrepayInstanceSpecRequestItem> modifyPrepayInstanceSpecRequest_ {};
  };
