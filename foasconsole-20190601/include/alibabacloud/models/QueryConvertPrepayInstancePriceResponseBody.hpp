...
namespace Models
{
  ...
  public:
    ...
    inline const QueryConvertPrepayInstancePriceResponseBody::PriceInfo & getPriceInfo() const { DARABONBA_PTR_GET_CONST(priceInfo_, QueryConvertPrepayInstancePriceResponseBody::PriceInfo) };
    inline QueryConvertPrepayInstancePriceResponseBody::PriceInfo getPriceInfo() { DARABONBA_PTR_GET(priceInfo_, QueryConvertPrepayInstancePriceResponseBody::PriceInfo) };
    inline QueryConvertPrepayInstancePriceResponseBody& setPriceInfo(const QueryConvertPrepayInstancePriceResponseBody::PriceInfo & priceInfo) { DARABONBA_PTR_SET_VALUE(priceInfo_, priceInfo) };
    inline QueryConvertPrepayInstancePriceResponseBody& setPriceInfo(QueryConvertPrepayInstancePriceResponseBody::PriceInfo && priceInfo) { DARABONBA_PTR_SET_RVALUE(priceInfo_, priceInfo) };
