...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->gmtCreate_ == nullptr
        && return this->gmtModified_ == nullptr && return this->ha_ == nullptr && return this->namespace_ == nullptr && return this->resourceSpec_ == nullptr && return this->resourceUsed_ == nullptr
