...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRenewInstancePriceResponseBody::PriceInfo & getPriceInfo() const { DARABONBA_PTR_GET_CONST(priceInfo_, QueryRenewInstancePriceResponseBody::PriceInfo) };
    inline QueryRenewInstancePriceResponseBody::PriceInfo getPriceInfo() { DARABONBA_PTR_GET(priceInfo_, QueryRenewInstancePriceResponseBody::PriceInfo) };
    inline QueryRenewInstancePriceResponseBody& setPriceInfo(const QueryRenewInstancePriceResponseBody::PriceInfo & priceInfo) { DARABONBA_PTR_SET_VALUE(priceInfo_, priceInfo) };
    inline QueryRenewInstancePriceResponseBody& setPriceInfo(QueryRenewInstancePriceResponseBody::PriceInfo && priceInfo) { DARABONBA_PTR_SET_RVALUE(priceInfo_, priceInfo) };
