...
namespace Models
{
  ...
  public:
    ...
    inline const ConvertInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConvertInstanceResponseBody) };
    inline ConvertInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ConvertInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConvertInstanceResponseBody> body_ {};
  };
