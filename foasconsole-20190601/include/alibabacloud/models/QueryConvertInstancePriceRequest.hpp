...
namespace Models
{
  ...
  public:
    ...
    inline const QueryConvertInstancePriceRequest::ConvertPostpayInstanceRequest & getConvertPostpayInstanceRequest() const { DARABONBA_PTR_GET_CONST(convertPostpayInstanceRequest_, QueryConvertInstancePriceRequest::ConvertPostpayInstanceRequest) };
    inline QueryConvertInstancePriceRequest::ConvertPostpayInstanceRequest getConvertPostpayInstanceRequest() { DARABONBA_PTR_GET(convertPostpayInstanceRequest_, QueryConvertInstancePriceRequest::ConvertPostpayInstanceRequest) };
    inline QueryConvertInstancePriceRequest& setConvertPostpayInstanceRequest(const QueryConvertInstancePriceRequest::ConvertPostpayInstanceRequest & convertPostpayInstanceRequest) { DARABONBA_PTR_SET_VALUE(convertPostpayInstanceRequest_, convertPostpayInstanceRequest) };
    inline QueryConvertInstancePriceRequest& setConvertPostpayInstanceRequest(QueryConvertInstancePriceRequest::ConvertPostpayInstanceRequest && convertPostpayInstanceRequest) { DARABONBA_PTR_SET_RVALUE(convertPostpayInstanceRequest_, convertPostpayInstanceRequest) };


  protected:
    // This parameter is required.
    shared_ptr<QueryConvertInstancePriceRequest::ConvertPostpayInstanceRequest> convertPostpayInstanceRequest_ {};
  };
