...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSupportedRegionsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSupportedRegionsResponseBody) };
    inline DescribeSupportedRegionsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSupportedRegionsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSupportedRegionsResponseBody> body_ = nullptr;
  };
