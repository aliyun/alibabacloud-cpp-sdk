...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCreateInstancePriceRequest::CreateInstanceRequest & getCreateInstanceRequest() const { DARABONBA_PTR_GET_CONST(createInstanceRequest_, QueryCreateInstancePriceRequest::CreateInstanceRequest) };
    inline QueryCreateInstancePriceRequest::CreateInstanceRequest getCreateInstanceRequest() { DARABONBA_PTR_GET(createInstanceRequest_, QueryCreateInstancePriceRequest::CreateInstanceRequest) };
    inline QueryCreateInstancePriceRequest& setCreateInstanceRequest(const QueryCreateInstancePriceRequest::CreateInstanceRequest & createInstanceRequest) { DARABONBA_PTR_SET_VALUE(createInstanceRequest_, createInstanceRequest) };
    inline QueryCreateInstancePriceRequest& setCreateInstanceRequest(QueryCreateInstancePriceRequest::CreateInstanceRequest && createInstanceRequest) { DARABONBA_PTR_SET_RVALUE(createInstanceRequest_, createInstanceRequest) };


  protected:
    // This parameter is required.
    shared_ptr<QueryCreateInstancePriceRequest::CreateInstanceRequest> createInstanceRequest_ {};
  };
