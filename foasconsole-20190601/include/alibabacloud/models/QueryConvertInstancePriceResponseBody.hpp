...
#ifndef ALIBABACLOUD_MODELS_QUERYCONVERTINSTANCEPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYCONVERTINSTANCEPRICERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryConvertInstancePriceResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(PriceInfo, priceInfo_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, QueryConvertInstancePriceResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(PriceInfo, priceInfo_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    QueryConvertInstancePriceResponseBody() = default ;
    QueryConvertInstancePriceResponseBody(const QueryConvertInstancePriceResponseBody &) = default ;
    QueryConvertInstancePriceResponseBody(QueryConvertInstancePriceResponseBody &&) = default ;
    QueryConvertInstancePriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryConvertInstancePriceResponseBody() = default ;
    QueryConvertInstancePriceResponseBody& operator=(const QueryConvertInstancePriceResponseBody &) = default ;
    QueryConvertInstancePriceResponseBody& operator=(QueryConvertInstancePriceResponseBody &&) = default ;
    ...
    inline const QueryConvertInstancePriceResponseBody::PriceInfo & getPriceInfo() const { DARABONBA_PTR_GET_CONST(priceInfo_, QueryConvertInstancePriceResponseBody::PriceInfo) };
    inline QueryConvertInstancePriceResponseBody::PriceInfo getPriceInfo() { DARABONBA_PTR_GET(priceInfo_, QueryConvertInstancePriceResponseBody::PriceInfo) };
    inline QueryConvertInstancePriceResponseBody& setPriceInfo(const QueryConvertInstancePriceResponseBody::PriceInfo & priceInfo) { DARABONBA_PTR_SET_VALUE(priceInfo_, priceInfo) };
    inline QueryConvertInstancePriceResponseBody& setPriceInfo(QueryConvertInstancePriceResponseBody::PriceInfo && priceInfo) { DARABONBA_PTR_SET_RVALUE(priceInfo_, priceInfo) };
    ...
    inline QueryConvertInstancePriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryConvertInstancePriceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<QueryConvertInstancePriceResponseBody::PriceInfo> priceInfo_ {};
