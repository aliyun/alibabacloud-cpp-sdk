...
#ifndef ALIBABACLOUD_MODELS_QUERYRENEWINSTANCEPRICERESPONSEBODYPRICEINFOOPTIONALPROMOTIONS_HPP_
#define ALIBABACLOUD_MODELS_QUERYRENEWINSTANCEPRICERESPONSEBODYPRICEINFOOPTIONALPROMOTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions& obj) { 
    ...
    QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions() = default ;
    QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions(const QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions &) = default ;
    QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions(QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions &&) = default ;
    QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions() = default ;
    QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions& operator=(const QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions &) = default ;
    QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions& operator=(QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions &&) = default ;
    ...
    inline QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions& setPromotionDesc(string promotionDesc) { DARABONBA_PTR_SET_VALUE(promotionDesc_, promotionDesc) };
    ...
    inline QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions& setPromotionName(string promotionName) { DARABONBA_PTR_SET_VALUE(promotionName_, promotionName) };
    ...
    inline QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions& setPromotionOptionNo(string promotionOptionNo) { DARABONBA_PTR_SET_VALUE(promotionOptionNo_, promotionOptionNo) };
    ...
    inline QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions& setSelected(bool selected) { DARABONBA_PTR_SET_VALUE(selected_, selected) };
