...
#ifndef ALIBABACLOUD_MODELS_GETSAMLIDENTITYPROVIDERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETSAMLIDENTITYPROVIDERRESPONSEBODY_HPP_
...
namespace Models
{
  class GetSAMLIdentityProviderResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetSAMLIdentityProviderResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(SSOIdentityProviderConfiguration, SSOIdentityProviderConfiguration_);
    };
    friend void from_json(const Darabonba::Json& j, GetSAMLIdentityProviderResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(SSOIdentityProviderConfiguration, SSOIdentityProviderConfiguration_);
    };
    GetSAMLIdentityProviderResponseBody() = default ;
    GetSAMLIdentityProviderResponseBody(const GetSAMLIdentityProviderResponseBody &) = default ;
    GetSAMLIdentityProviderResponseBody(GetSAMLIdentityProviderResponseBody &&) = default ;
    GetSAMLIdentityProviderResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSAMLIdentityProviderResponseBody() = default ;
    GetSAMLIdentityProviderResponseBody& operator=(const GetSAMLIdentityProviderResponseBody &) = default ;
    GetSAMLIdentityProviderResponseBody& operator=(GetSAMLIdentityProviderResponseBody &&) = default ;
    ...
    inline GetSAMLIdentityProviderResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline const GetSAMLIdentityProviderResponseBody::SSOIdentityProviderConfiguration & getSSOIdentityProviderConfiguration() const { DARABONBA_PTR_GET_CONST(SSOIdentityProviderConfiguration_, GetSAMLIdentityProviderResponseBody::SSOIdentityProviderConfiguration) };
    inline GetSAMLIdentityProviderResponseBody::SSOIdentityProviderConfiguration getSSOIdentityProviderConfiguration() { DARABONBA_PTR_GET(SSOIdentityProviderConfiguration_, GetSAMLIdentityProviderResponseBody::SSOIdentityProviderConfiguration) };
    inline GetSAMLIdentityProviderResponseBody& setSSOIdentityProviderConfiguration(const GetSAMLIdentityProviderResponseBody::SSOIdentityProviderConfiguration & sSOIdentityProviderConfiguration) { DARABONBA_PTR_SET_VALUE(SSOIdentityProviderConfiguration_, sSOIdentityProviderConfiguration) };
    inline GetSAMLIdentityProviderResponseBody& setSSOIdentityProviderConfiguration(GetSAMLIdentityProviderResponseBody::SSOIdentityProviderConfiguration && sSOIdentityProviderConfiguration) { DARABONBA_PTR_SET_RVALUE(SSOIdentityProviderConfiguration_, sSOIdentityProviderConfiguration) };


  protected:
    shared_ptr<string> requestId_ {};
    shared_ptr<GetSAMLIdentityProviderResponseBody::SSOIdentityProviderConfiguration> SSOIdentityProviderConfiguration_ {};
  };
