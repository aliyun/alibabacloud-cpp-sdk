...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateOAuth2CredentialProviderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateOAuth2CredentialProviderResponseBody) };
    inline UpdateOAuth2CredentialProviderResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateOAuth2CredentialProviderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateOAuth2CredentialProviderResponseBody> body_ {};
  };
