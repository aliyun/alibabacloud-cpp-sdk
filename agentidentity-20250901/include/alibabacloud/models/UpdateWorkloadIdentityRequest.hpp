...
#ifndef ALIBABACLOUD_MODELS_UPDATEWORKLOADIDENTITYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEWORKLOADIDENTITYREQUEST_HPP_
...
namespace Models
{
  class UpdateWorkloadIdentityRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateWorkloadIdentityRequest& obj) { 
    ...
    UpdateWorkloadIdentityRequest(const UpdateWorkloadIdentityRequest &) = default ;
    UpdateWorkloadIdentityRequest(UpdateWorkloadIdentityRequest &&) = default ;
    UpdateWorkloadIdentityRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateWorkloadIdentityRequest() = default ;
    UpdateWorkloadIdentityRequest& operator=(const UpdateWorkloadIdentityRequest &) = default ;
    UpdateWorkloadIdentityRequest& operator=(UpdateWorkloadIdentityRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->allowedConsentCallbackURLs_ == nullptr
        && this->allowedResourceOAuth2ReturnURLs_ == nullptr && this->description_ == nullptr && this->identityProviderName_ == nullptr && this->roleArn_ == nullptr && this->sessionBindingEnabled_ == nullptr
    ...
    inline UpdateWorkloadIdentityRequest& setAllowedConsentCallbackURLs(const vector<string> & allowedConsentCallbackURLs) { DARABONBA_PTR_SET_VALUE(allowedConsentCallbackURLs_, allowedConsentCallbackURLs) };
    inline UpdateWorkloadIdentityRequest& setAllowedConsentCallbackURLs(vector<string> && allowedConsentCallbackURLs) { DARABONBA_PTR_SET_RVALUE(allowedConsentCallbackURLs_, allowedConsentCallbackURLs) };
