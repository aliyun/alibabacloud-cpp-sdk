...
namespace Models
{
  ...
  public:
    ...
    inline ListIdentityProvidersResponseBodyIdentityProviders& setAllowedAudience(const vector<string> & allowedAudience) { DARABONBA_PTR_SET_VALUE(allowedAudience_, allowedAudience) };
    inline ListIdentityProvidersResponseBodyIdentityProviders& setAllowedAudience(vector<string> && allowedAudience) { DARABONBA_PTR_SET_RVALUE(allowedAudience_, allowedAudience) };
    ...
    inline ListIdentityProvidersResponseBodyIdentityProviders& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListIdentityProvidersResponseBodyIdentityProviders& setDiscoveryURL(string discoveryURL) { DARABONBA_PTR_SET_VALUE(discoveryURL_, discoveryURL) };
    ...
    inline ListIdentityProvidersResponseBodyIdentityProviders& setIdentityProviderArn(string identityProviderArn) { DARABONBA_PTR_SET_VALUE(identityProviderArn_, identityProviderArn) };
    ...
    inline ListIdentityProvidersResponseBodyIdentityProviders& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
