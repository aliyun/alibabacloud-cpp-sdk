...
#ifndef ALIBABACLOUD_MODELS_GETTOKENVAULTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETTOKENVAULTRESPONSEBODY_HPP_
...
namespace Models
{
  class GetTokenVaultResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetTokenVaultResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(TokenVault, tokenVault_);
    };
    friend void from_json(const Darabonba::Json& j, GetTokenVaultResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(TokenVault, tokenVault_);
    };
    GetTokenVaultResponseBody() = default ;
    GetTokenVaultResponseBody(const GetTokenVaultResponseBody &) = default ;
    GetTokenVaultResponseBody(GetTokenVaultResponseBody &&) = default ;
    GetTokenVaultResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetTokenVaultResponseBody() = default ;
    GetTokenVaultResponseBody& operator=(const GetTokenVaultResponseBody &) = default ;
    GetTokenVaultResponseBody& operator=(GetTokenVaultResponseBody &&) = default ;
    ...
    public:
      ...
      inline TokenVault& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline GetTokenVaultResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline const GetTokenVaultResponseBody::TokenVault & getTokenVault() const { DARABONBA_PTR_GET_CONST(tokenVault_, GetTokenVaultResponseBody::TokenVault) };
    inline GetTokenVaultResponseBody::TokenVault getTokenVault() { DARABONBA_PTR_GET(tokenVault_, GetTokenVaultResponseBody::TokenVault) };
    inline GetTokenVaultResponseBody& setTokenVault(const GetTokenVaultResponseBody::TokenVault & tokenVault) { DARABONBA_PTR_SET_VALUE(tokenVault_, tokenVault) };
    inline GetTokenVaultResponseBody& setTokenVault(GetTokenVaultResponseBody::TokenVault && tokenVault) { DARABONBA_PTR_SET_RVALUE(tokenVault_, tokenVault) };


  protected:
    shared_ptr<string> requestId_ {};
    shared_ptr<GetTokenVaultResponseBody::TokenVault> tokenVault_ {};
  };
