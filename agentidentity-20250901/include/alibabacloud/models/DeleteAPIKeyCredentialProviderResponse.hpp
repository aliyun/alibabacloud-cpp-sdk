...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAPIKeyCredentialProviderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAPIKeyCredentialProviderResponseBody) };
    inline DeleteAPIKeyCredentialProviderResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAPIKeyCredentialProviderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAPIKeyCredentialProviderResponseBody> body_ {};
  };
