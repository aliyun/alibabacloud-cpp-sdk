...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline UserPools& setOIDCDiscoveryURL(string OIDCDiscoveryURL) { DARABONBA_PTR_SET_VALUE(OIDCDiscoveryURL_, OIDCDiscoveryURL) };
      ...
      inline UserPools& setSigninBaseURL(string signinBaseURL) { DARABONBA_PTR_SET_VALUE(signinBaseURL_, signinBaseURL) };
