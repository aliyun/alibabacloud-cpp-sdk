...
namespace Models
{
  ...
  public:
    ...
    inline CreateWorkloadIdentityRequest& setCreateRAMRole(bool createRAMRole) { DARABONBA_PTR_SET_VALUE(createRAMRole_, createRAMRole) };
    ...
    inline CreateWorkloadIdentityRequest& setSessionBindingEnabled(bool sessionBindingEnabled) { DARABONBA_PTR_SET_VALUE(sessionBindingEnabled_, sessionBindingEnabled) };
    ...
    inline CreateWorkloadIdentityRequest& setSourceAgentArn(string sourceAgentArn) { DARABONBA_PTR_SET_VALUE(sourceAgentArn_, sourceAgentArn) };
    ...
    inline CreateWorkloadIdentityRequest& setSourcePlatform(string sourcePlatform) { DARABONBA_PTR_SET_VALUE(sourcePlatform_, sourcePlatform) };
