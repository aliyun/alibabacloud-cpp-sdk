  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->allowedConsentCallbackURLs_ == nullptr
        && this->allowedResourceOAuth2ReturnURLs_ == nullptr && this->createTime_ == nullptr && this->description_ == nullptr && this->identityProviderName_ == nullptr && this->roleArn_ == nullptr
        && this->sessionBindingEnabled_ == nullptr && this->sourceAgentArn_ == nullptr && this->sourcePlatform_ == nullptr && this->updateTime_ == nullptr && this->workloadIdentityArn_ == nullptr
      ...
      inline WorkloadIdentity& setAllowedConsentCallbackURLs(const vector<string> & allowedConsentCallbackURLs) { DARABONBA_PTR_SET_VALUE(allowedConsentCallbackURLs_, allowedConsentCallbackURLs) };
      inline WorkloadIdentity& setAllowedConsentCallbackURLs(vector<string> && allowedConsentCallbackURLs) { DARABONBA_PTR_SET_RVALUE(allowedConsentCallbackURLs_, allowedConsentCallbackURLs) };
    ...
    inline const GetWorkloadIdentityResponseBody::WorkloadIdentity & getWorkloadIdentity() const { DARABONBA_PTR_GET_CONST(workloadIdentity_, GetWorkloadIdentityResponseBody::WorkloadIdentity) };
    inline GetWorkloadIdentityResponseBody::WorkloadIdentity getWorkloadIdentity() { DARABONBA_PTR_GET(workloadIdentity_, GetWorkloadIdentityResponseBody::WorkloadIdentity) };
    inline GetWorkloadIdentityResponseBody& setWorkloadIdentity(const GetWorkloadIdentityResponseBody::WorkloadIdentity & workloadIdentity) { DARABONBA_PTR_SET_VALUE(workloadIdentity_, workloadIdentity) };
    inline GetWorkloadIdentityResponseBody& setWorkloadIdentity(GetWorkloadIdentityResponseBody::WorkloadIdentity && workloadIdentity) { DARABONBA_PTR_SET_RVALUE(workloadIdentity_, workloadIdentity) };


  protected:
    shared_ptr<string> requestId_ {};
    shared_ptr<GetWorkloadIdentityResponseBody::WorkloadIdentity> workloadIdentity_ {};
  };
