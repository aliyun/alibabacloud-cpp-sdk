...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkloadIdentitiesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListWorkloadIdentitiesResponseBody) };
    inline ListWorkloadIdentitiesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListWorkloadIdentitiesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListWorkloadIdentitiesResponseBody> body_ {};
  };
