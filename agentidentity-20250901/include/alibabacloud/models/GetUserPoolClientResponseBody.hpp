...
#ifndef ALIBABACLOUD_MODELS_GETUSERPOOLCLIENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETUSERPOOLCLIENTRESPONSEBODY_HPP_
...
namespace Models
{
  class GetUserPoolClientResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetUserPoolClientResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Client, client_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetUserPoolClientResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Client, client_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetUserPoolClientResponseBody() = default ;
    GetUserPoolClientResponseBody(const GetUserPoolClientResponseBody &) = default ;
    GetUserPoolClientResponseBody(GetUserPoolClientResponseBody &&) = default ;
    GetUserPoolClientResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetUserPoolClientResponseBody() = default ;
    GetUserPoolClientResponseBody& operator=(const GetUserPoolClientResponseBody &) = default ;
    GetUserPoolClientResponseBody& operator=(GetUserPoolClientResponseBody &&) = default ;
    ...
    inline const GetUserPoolClientResponseBody::Client & getClient() const { DARABONBA_PTR_GET_CONST(client_, GetUserPoolClientResponseBody::Client) };
    inline GetUserPoolClientResponseBody::Client getClient() { DARABONBA_PTR_GET(client_, GetUserPoolClientResponseBody::Client) };
    inline GetUserPoolClientResponseBody& setClient(const GetUserPoolClientResponseBody::Client & client) { DARABONBA_PTR_SET_VALUE(client_, client) };
    inline GetUserPoolClientResponseBody& setClient(GetUserPoolClientResponseBody::Client && client) { DARABONBA_PTR_SET_RVALUE(client_, client) };
    ...
    inline GetUserPoolClientResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<GetUserPoolClientResponseBody::Client> client_ {};
