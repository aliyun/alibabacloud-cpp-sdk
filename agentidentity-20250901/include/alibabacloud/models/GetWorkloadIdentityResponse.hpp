...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorkloadIdentityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetWorkloadIdentityResponseBody) };
    inline GetWorkloadIdentityResponseBody getBody() { DARABONBA_PTR_GET(body_, GetWorkloadIdentityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetWorkloadIdentityResponseBody> body_ {};
  };
