...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWorkloadIdentityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateWorkloadIdentityResponseBody) };
    inline CreateWorkloadIdentityResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateWorkloadIdentityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateWorkloadIdentityResponseBody> body_ {};
  };
