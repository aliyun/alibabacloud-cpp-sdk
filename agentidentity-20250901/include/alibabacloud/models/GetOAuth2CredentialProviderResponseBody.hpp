...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline OAuth2CredentialProvider& setIDaaSInstanceId(string IDaaSInstanceId) { DARABONBA_PTR_SET_VALUE(IDaaSInstanceId_, IDaaSInstanceId) };
      ...
      inline OAuth2CredentialProvider& setOutboundApplicationId(string outboundApplicationId) { DARABONBA_PTR_SET_VALUE(outboundApplicationId_, outboundApplicationId) };
      ...
      inline OAuth2CredentialProvider& setOutboundAudience(string outboundAudience) { DARABONBA_PTR_SET_VALUE(outboundAudience_, outboundAudience) };
      ...
      inline OAuth2CredentialProvider& setOutboundClientId(string outboundClientId) { DARABONBA_PTR_SET_VALUE(outboundClientId_, outboundClientId) };
      ...
      inline OAuth2CredentialProvider& setSourcePlatform(string sourcePlatform) { DARABONBA_PTR_SET_VALUE(sourcePlatform_, sourcePlatform) };
    ...
    inline const GetOAuth2CredentialProviderResponseBody::OAuth2CredentialProvider & getOAuth2CredentialProvider() const { DARABONBA_PTR_GET_CONST(OAuth2CredentialProvider_, GetOAuth2CredentialProviderResponseBody::OAuth2CredentialProvider) };
    inline GetOAuth2CredentialProviderResponseBody::OAuth2CredentialProvider getOAuth2CredentialProvider() { DARABONBA_PTR_GET(OAuth2CredentialProvider_, GetOAuth2CredentialProviderResponseBody::OAuth2CredentialProvider) };
    inline GetOAuth2CredentialProviderResponseBody& setOAuth2CredentialProvider(const GetOAuth2CredentialProviderResponseBody::OAuth2CredentialProvider & oAuth2CredentialProvider) { DARABONBA_PTR_SET_VALUE(OAuth2CredentialProvider_, oAuth2CredentialProvider) };
    inline GetOAuth2CredentialProviderResponseBody& setOAuth2CredentialProvider(GetOAuth2CredentialProviderResponseBody::OAuth2CredentialProvider && oAuth2CredentialProvider) { DARABONBA_PTR_SET_RVALUE(OAuth2CredentialProvider_, oAuth2CredentialProvider) };
  ...
  protected:
    shared_ptr<GetOAuth2CredentialProviderResponseBody::OAuth2CredentialProvider> OAuth2CredentialProvider_ {};
