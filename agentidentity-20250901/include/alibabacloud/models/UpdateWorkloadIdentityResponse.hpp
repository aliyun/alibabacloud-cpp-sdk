...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWorkloadIdentityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateWorkloadIdentityResponseBody) };
    inline UpdateWorkloadIdentityResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateWorkloadIdentityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateWorkloadIdentityResponseBody> body_ {};
  };
