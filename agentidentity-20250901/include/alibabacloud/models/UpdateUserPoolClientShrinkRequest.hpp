...
#ifndef ALIBABACLOUD_MODELS_UPDATEUSERPOOLCLIENTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEUSERPOOLCLIENTSHRINKREQUEST_HPP_
...
namespace Models
{
  class UpdateUserPoolClientShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateUserPoolClientShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateUserPoolClientShrinkRequest& obj) { 
    ...
    UpdateUserPoolClientShrinkRequest() = default ;
    UpdateUserPoolClientShrinkRequest(const UpdateUserPoolClientShrinkRequest &) = default ;
    UpdateUserPoolClientShrinkRequest(UpdateUserPoolClientShrinkRequest &&) = default ;
    UpdateUserPoolClientShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateUserPoolClientShrinkRequest() = default ;
    UpdateUserPoolClientShrinkRequest& operator=(const UpdateUserPoolClientShrinkRequest &) = default ;
    UpdateUserPoolClientShrinkRequest& operator=(UpdateUserPoolClientShrinkRequest &&) = default ;
    ...
    inline UpdateUserPoolClientShrinkRequest& setAccessTokenValidity(string accessTokenValidity) { DARABONBA_PTR_SET_VALUE(accessTokenValidity_, accessTokenValidity) };
    ...
    inline UpdateUserPoolClientShrinkRequest& setClientName(string clientName) { DARABONBA_PTR_SET_VALUE(clientName_, clientName) };
    ...
    inline UpdateUserPoolClientShrinkRequest& setEnforcePKCE(bool enforcePKCE) { DARABONBA_PTR_SET_VALUE(enforcePKCE_, enforcePKCE) };
    ...
    inline UpdateUserPoolClientShrinkRequest& setRedirectURIsShrink(string redirectURIsShrink) { DARABONBA_PTR_SET_VALUE(redirectURIsShrink_, redirectURIsShrink) };
    ...
    inline UpdateUserPoolClientShrinkRequest& setRefreshTokenValidity(string refreshTokenValidity) { DARABONBA_PTR_SET_VALUE(refreshTokenValidity_, refreshTokenValidity) };
    ...
    inline UpdateUserPoolClientShrinkRequest& setSecretRequired(bool secretRequired) { DARABONBA_PTR_SET_VALUE(secretRequired_, secretRequired) };
    ...
    inline UpdateUserPoolClientShrinkRequest& setUserPoolName(string userPoolName) { DARABONBA_PTR_SET_VALUE(userPoolName_, userPoolName) };
