...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline WorkloadIdentities& setAllowedConsentCallbackURLs(const vector<string> & allowedConsentCallbackURLs) { DARABONBA_PTR_SET_VALUE(allowedConsentCallbackURLs_, allowedConsentCallbackURLs) };
      inline WorkloadIdentities& setAllowedConsentCallbackURLs(vector<string> && allowedConsentCallbackURLs) { DARABONBA_PTR_SET_RVALUE(allowedConsentCallbackURLs_, allowedConsentCallbackURLs) };
