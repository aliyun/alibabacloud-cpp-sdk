...
namespace Models
{
  ...
  public:
    ...
    inline CreatePolicyShrinkRequest& setDefinitionShrink(string definitionShrink) { DARABONBA_PTR_SET_VALUE(definitionShrink_, definitionShrink) };
    ...
    inline CreatePolicyShrinkRequest& setPolicySetName(string policySetName) { DARABONBA_PTR_SET_VALUE(policySetName_, policySetName) };
