...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAPIKeyCredentialProviderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAPIKeyCredentialProviderResponseBody) };
    inline UpdateAPIKeyCredentialProviderResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAPIKeyCredentialProviderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAPIKeyCredentialProviderResponseBody> body_ {};
  };
