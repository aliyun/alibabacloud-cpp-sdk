...
namespace Models
{
  ...
  public:
    ...
    inline const ListOAuth2CredentialProvidersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOAuth2CredentialProvidersResponseBody) };
    inline ListOAuth2CredentialProvidersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOAuth2CredentialProvidersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOAuth2CredentialProvidersResponseBody> body_ {};
  };
