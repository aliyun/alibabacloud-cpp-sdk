...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIdentityProviderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteIdentityProviderResponseBody) };
    inline DeleteIdentityProviderResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteIdentityProviderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteIdentityProviderResponseBody> body_ {};
  };
