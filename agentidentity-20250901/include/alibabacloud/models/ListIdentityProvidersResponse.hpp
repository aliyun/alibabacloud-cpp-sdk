...
namespace Models
{
  ...
  public:
    ...
    inline const ListIdentityProvidersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIdentityProvidersResponseBody) };
    inline ListIdentityProvidersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIdentityProvidersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIdentityProvidersResponseBody> body_ {};
  };
