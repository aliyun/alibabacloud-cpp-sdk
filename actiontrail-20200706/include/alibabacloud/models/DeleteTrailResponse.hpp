...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTrailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTrailResponseBody) };
    inline DeleteTrailResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTrailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTrailResponseBody> body_ {};
  };
