...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAdvancedQueryTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAdvancedQueryTemplateResponseBody) };
    inline DeleteAdvancedQueryTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAdvancedQueryTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAdvancedQueryTemplateResponseBody> body_ {};
  };
