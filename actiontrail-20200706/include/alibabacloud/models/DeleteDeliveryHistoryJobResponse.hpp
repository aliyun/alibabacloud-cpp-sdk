...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDeliveryHistoryJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDeliveryHistoryJobResponseBody) };
    inline DeleteDeliveryHistoryJobResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDeliveryHistoryJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDeliveryHistoryJobResponseBody> body_ {};
  };
