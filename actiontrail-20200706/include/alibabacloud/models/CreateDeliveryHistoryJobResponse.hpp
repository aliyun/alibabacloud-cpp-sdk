...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDeliveryHistoryJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDeliveryHistoryJobResponseBody) };
    inline CreateDeliveryHistoryJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDeliveryHistoryJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDeliveryHistoryJobResponseBody> body_ {};
  };
