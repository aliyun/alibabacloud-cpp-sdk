...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceLifeCycleEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceLifeCycleEventsResponseBody) };
    inline DescribeResourceLifeCycleEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourceLifeCycleEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourceLifeCycleEventsResponseBody> body_ {};
  };
