...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAdvancedQueryHistoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAdvancedQueryHistoryResponseBody) };
    inline DescribeAdvancedQueryHistoryResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAdvancedQueryHistoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAdvancedQueryHistoryResponseBody> body_ {};
  };
