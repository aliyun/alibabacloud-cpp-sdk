...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAdvancedQueryTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAdvancedQueryTemplateResponseBody) };
    inline DescribeAdvancedQueryTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAdvancedQueryTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAdvancedQueryTemplateResponseBody> body_ {};
  };
