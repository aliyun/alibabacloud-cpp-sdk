...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeliveryHistoryJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDeliveryHistoryJobsResponseBody) };
    inline ListDeliveryHistoryJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDeliveryHistoryJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDeliveryHistoryJobsResponseBody> body_ {};
  };
