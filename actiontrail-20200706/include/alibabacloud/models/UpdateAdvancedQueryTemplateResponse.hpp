...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAdvancedQueryTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAdvancedQueryTemplateResponseBody) };
    inline UpdateAdvancedQueryTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAdvancedQueryTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAdvancedQueryTemplateResponseBody> body_ {};
  };
