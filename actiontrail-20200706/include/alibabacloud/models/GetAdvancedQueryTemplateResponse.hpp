...
namespace Models
{
  ...
  public:
    ...
    inline const GetAdvancedQueryTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAdvancedQueryTemplateResponseBody) };
    inline GetAdvancedQueryTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAdvancedQueryTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAdvancedQueryTemplateResponseBody> body_ {};
  };
