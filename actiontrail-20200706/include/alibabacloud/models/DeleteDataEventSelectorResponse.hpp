...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDataEventSelectorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDataEventSelectorResponseBody) };
    inline DeleteDataEventSelectorResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDataEventSelectorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDataEventSelectorResponseBody> body_ {};
  };
