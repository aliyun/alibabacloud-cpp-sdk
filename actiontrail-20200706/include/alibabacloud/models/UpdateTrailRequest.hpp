...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->eventRW_ != nullptr
        && this->maxComputeProjectArn_ != nullptr && this->maxComputeWriteRoleArn_ != nullptr && this->name_ != nullptr && this->ossBucketName_ != nullptr && this->ossKeyPrefix_ != nullptr
        && this->ossWriteRoleArn_ != nullptr && this->slsProjectArn_ != nullptr && this->slsWriteRoleArn_ != nullptr && this->trailRegion_ != nullptr; };
