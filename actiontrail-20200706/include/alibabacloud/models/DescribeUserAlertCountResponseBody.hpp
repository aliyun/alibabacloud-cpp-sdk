...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserAlertCountResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeUserAlertCountResponseBodyData) };
    inline DescribeUserAlertCountResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeUserAlertCountResponseBodyData) };
    inline DescribeUserAlertCountResponseBody& setData(const DescribeUserAlertCountResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeUserAlertCountResponseBody& setData(DescribeUserAlertCountResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeUserAlertCountResponseBodyData> data_ = nullptr;
