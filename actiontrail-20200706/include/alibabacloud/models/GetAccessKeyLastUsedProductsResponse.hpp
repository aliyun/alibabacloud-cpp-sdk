...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccessKeyLastUsedProductsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAccessKeyLastUsedProductsResponseBody) };
    inline GetAccessKeyLastUsedProductsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAccessKeyLastUsedProductsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAccessKeyLastUsedProductsResponseBody> body_ {};
  };
