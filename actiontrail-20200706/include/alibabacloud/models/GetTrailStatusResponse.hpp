...
namespace Models
{
  ...
  public:
    ...
    inline const GetTrailStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTrailStatusResponseBody) };
    inline GetTrailStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTrailStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTrailStatusResponseBody> body_ {};
  };
