...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAdvancedQueryHistoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAdvancedQueryHistoryResponseBody) };
    inline DeleteAdvancedQueryHistoryResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAdvancedQueryHistoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAdvancedQueryHistoryResponseBody> body_ {};
  };
