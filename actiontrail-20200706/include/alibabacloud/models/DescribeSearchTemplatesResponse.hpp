...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSearchTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSearchTemplatesResponseBody) };
    inline DescribeSearchTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSearchTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSearchTemplatesResponseBody> body_ {};
  };
