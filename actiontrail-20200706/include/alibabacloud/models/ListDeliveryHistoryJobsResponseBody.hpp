...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->deliveryHistoryJobs_ != nullptr
    ...
    inline const vector<ListDeliveryHistoryJobsResponseBodyDeliveryHistoryJobs> & deliveryHistoryJobs() const { DARABONBA_PTR_GET_CONST(deliveryHistoryJobs_, vector<ListDeliveryHistoryJobsResponseBodyDeliveryHistoryJobs>) };
    inline vector<ListDeliveryHistoryJobsResponseBodyDeliveryHistoryJobs> deliveryHistoryJobs() { DARABONBA_PTR_GET(deliveryHistoryJobs_, vector<ListDeliveryHistoryJobsResponseBodyDeliveryHistoryJobs>) };
    inline ListDeliveryHistoryJobsResponseBody& setDeliveryHistoryJobs(const vector<ListDeliveryHistoryJobsResponseBodyDeliveryHistoryJobs> & deliveryHistoryJobs) { DARABONBA_PTR_SET_VALUE(deliveryHistoryJobs_, deliveryHistoryJobs) };
    inline ListDeliveryHistoryJobsResponseBody& setDeliveryHistoryJobs(vector<ListDeliveryHistoryJobsResponseBodyDeliveryHistoryJobs> && deliveryHistoryJobs) { DARABONBA_PTR_SET_RVALUE(deliveryHistoryJobs_, deliveryHistoryJobs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDeliveryHistoryJobsResponseBodyDeliveryHistoryJobs>> deliveryHistoryJobs_ = nullptr;
