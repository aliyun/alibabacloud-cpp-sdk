...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScenesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeScenesResponseBody) };
    inline DescribeScenesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeScenesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeScenesResponseBody> body_ {};
  };
