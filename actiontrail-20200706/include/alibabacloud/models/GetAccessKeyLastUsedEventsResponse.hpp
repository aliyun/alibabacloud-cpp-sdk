...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccessKeyLastUsedEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAccessKeyLastUsedEventsResponseBody) };
    inline GetAccessKeyLastUsedEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAccessKeyLastUsedEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAccessKeyLastUsedEventsResponseBody> body_ {};
  };
