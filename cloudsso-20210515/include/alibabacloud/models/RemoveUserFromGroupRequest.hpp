...
namespace Models
{
  ...
  public:
    ...
    inline RemoveUserFromGroupRequest& setDirectoryId(string directoryId) { DARABONBA_PTR_SET_VALUE(directoryId_, directoryId) };
    ...
    inline RemoveUserFromGroupRequest& setGroupId(string groupId) { DARABONBA_PTR_SET_VALUE(groupId_, groupId) };
    ...
    inline RemoveUserFromGroupRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
