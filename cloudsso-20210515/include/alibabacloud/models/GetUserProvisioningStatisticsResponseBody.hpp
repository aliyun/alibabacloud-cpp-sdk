...
#ifndef ALIBABACLOUD_MODELS_GETUSERPROVISIONINGSTATISTICSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETUSERPROVISIONINGSTATISTICSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetUserProvisioningStatisticsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(UserProvisioningStatistics, userProvisioningStatistics_);
    };
    friend void from_json(const Darabonba::Json& j, GetUserProvisioningStatisticsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(UserProvisioningStatistics, userProvisioningStatistics_);
    };
    GetUserProvisioningStatisticsResponseBody() = default ;
    GetUserProvisioningStatisticsResponseBody(const GetUserProvisioningStatisticsResponseBody &) = default ;
    GetUserProvisioningStatisticsResponseBody(GetUserProvisioningStatisticsResponseBody &&) = default ;
    GetUserProvisioningStatisticsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetUserProvisioningStatisticsResponseBody() = default ;
    GetUserProvisioningStatisticsResponseBody& operator=(const GetUserProvisioningStatisticsResponseBody &) = default ;
    GetUserProvisioningStatisticsResponseBody& operator=(GetUserProvisioningStatisticsResponseBody &&) = default ;
    ...
    inline GetUserProvisioningStatisticsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline const GetUserProvisioningStatisticsResponseBody::UserProvisioningStatistics & getUserProvisioningStatistics() const { DARABONBA_PTR_GET_CONST(userProvisioningStatistics_, GetUserProvisioningStatisticsResponseBody::UserProvisioningStatistics) };
    inline GetUserProvisioningStatisticsResponseBody::UserProvisioningStatistics getUserProvisioningStatistics() { DARABONBA_PTR_GET(userProvisioningStatistics_, GetUserProvisioningStatisticsResponseBody::UserProvisioningStatistics) };
    inline GetUserProvisioningStatisticsResponseBody& setUserProvisioningStatistics(const GetUserProvisioningStatisticsResponseBody::UserProvisioningStatistics & userProvisioningStatistics) { DARABONBA_PTR_SET_VALUE(userProvisioningStatistics_, userProvisioningStatistics) };
    inline GetUserProvisioningStatisticsResponseBody& setUserProvisioningStatistics(GetUserProvisioningStatisticsResponseBody::UserProvisioningStatistics && userProvisioningStatistics) { DARABONBA_PTR_SET_RVALUE(userProvisioningStatistics_, userProvisioningStatistics) };
  ...
  protected:
    ...
    shared_ptr<GetUserProvisioningStatisticsResponseBody::UserProvisioningStatistics> userProvisioningStatistics_ {};
  };
