...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveUserFromGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveUserFromGroupResponseBody) };
    inline RemoveUserFromGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveUserFromGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveUserFromGroupResponseBody> body_ {};
  };
