...
#ifndef ALIBABACLOUD_MODELS_GETUSERPROVISIONINGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETUSERPROVISIONINGRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetUserProvisioningResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(UserProvisioning, userProvisioning_);
    };
    friend void from_json(const Darabonba::Json& j, GetUserProvisioningResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(UserProvisioning, userProvisioning_);
    };
    GetUserProvisioningResponseBody() = default ;
    GetUserProvisioningResponseBody(const GetUserProvisioningResponseBody &) = default ;
    GetUserProvisioningResponseBody(GetUserProvisioningResponseBody &&) = default ;
    GetUserProvisioningResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetUserProvisioningResponseBody() = default ;
    GetUserProvisioningResponseBody& operator=(const GetUserProvisioningResponseBody &) = default ;
    GetUserProvisioningResponseBody& operator=(GetUserProvisioningResponseBody &&) = default ;
    ...
    inline GetUserProvisioningResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline const GetUserProvisioningResponseBody::UserProvisioning & getUserProvisioning() const { DARABONBA_PTR_GET_CONST(userProvisioning_, GetUserProvisioningResponseBody::UserProvisioning) };
    inline GetUserProvisioningResponseBody::UserProvisioning getUserProvisioning() { DARABONBA_PTR_GET(userProvisioning_, GetUserProvisioningResponseBody::UserProvisioning) };
    inline GetUserProvisioningResponseBody& setUserProvisioning(const GetUserProvisioningResponseBody::UserProvisioning & userProvisioning) { DARABONBA_PTR_SET_VALUE(userProvisioning_, userProvisioning) };
    inline GetUserProvisioningResponseBody& setUserProvisioning(GetUserProvisioningResponseBody::UserProvisioning && userProvisioning) { DARABONBA_PTR_SET_RVALUE(userProvisioning_, userProvisioning) };
  ...
  protected:
    ...
    shared_ptr<GetUserProvisioningResponseBody::UserProvisioning> userProvisioning_ {};
  };
