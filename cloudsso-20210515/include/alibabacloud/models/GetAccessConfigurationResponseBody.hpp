...
#ifndef ALIBABACLOUD_MODELS_GETACCESSCONFIGURATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETACCESSCONFIGURATIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAccessConfigurationResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessConfiguration, accessConfiguration_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetAccessConfigurationResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessConfiguration, accessConfiguration_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetAccessConfigurationResponseBody() = default ;
    GetAccessConfigurationResponseBody(const GetAccessConfigurationResponseBody &) = default ;
    GetAccessConfigurationResponseBody(GetAccessConfigurationResponseBody &&) = default ;
    GetAccessConfigurationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAccessConfigurationResponseBody() = default ;
    GetAccessConfigurationResponseBody& operator=(const GetAccessConfigurationResponseBody &) = default ;
    GetAccessConfigurationResponseBody& operator=(GetAccessConfigurationResponseBody &&) = default ;
    ...
    inline const GetAccessConfigurationResponseBody::AccessConfiguration & getAccessConfiguration() const { DARABONBA_PTR_GET_CONST(accessConfiguration_, GetAccessConfigurationResponseBody::AccessConfiguration) };
    inline GetAccessConfigurationResponseBody::AccessConfiguration getAccessConfiguration() { DARABONBA_PTR_GET(accessConfiguration_, GetAccessConfigurationResponseBody::AccessConfiguration) };
    inline GetAccessConfigurationResponseBody& setAccessConfiguration(const GetAccessConfigurationResponseBody::AccessConfiguration & accessConfiguration) { DARABONBA_PTR_SET_VALUE(accessConfiguration_, accessConfiguration) };
    inline GetAccessConfigurationResponseBody& setAccessConfiguration(GetAccessConfigurationResponseBody::AccessConfiguration && accessConfiguration) { DARABONBA_PTR_SET_RVALUE(accessConfiguration_, accessConfiguration) };
    ...
    inline GetAccessConfigurationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The access configuration information.
    shared_ptr<GetAccessConfigurationResponseBody::AccessConfiguration> accessConfiguration_ {};
    // The request ID.
