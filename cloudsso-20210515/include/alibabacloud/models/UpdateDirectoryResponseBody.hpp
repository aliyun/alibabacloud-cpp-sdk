...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDirectoryResponseBody::Directory & getDirectory() const { DARABONBA_PTR_GET_CONST(directory_, UpdateDirectoryResponseBody::Directory) };
    inline UpdateDirectoryResponseBody::Directory getDirectory() { DARABONBA_PTR_GET(directory_, UpdateDirectoryResponseBody::Directory) };
    inline UpdateDirectoryResponseBody& setDirectory(const UpdateDirectoryResponseBody::Directory & directory) { DARABONBA_PTR_SET_VALUE(directory_, directory) };
    inline UpdateDirectoryResponseBody& setDirectory(UpdateDirectoryResponseBody::Directory && directory) { DARABONBA_PTR_SET_RVALUE(directory_, directory) };
  ...
  protected:
    ...
    shared_ptr<UpdateDirectoryResponseBody::Directory> directory_ {};
    // The request ID.
