...
#ifndef ALIBABACLOUD_MODELS_LISTUSERPROVISIONINGEVENTSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTUSERPROVISIONINGEVENTSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListUserProvisioningEventsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(IsTruncated, isTruncated_);
      DARABONBA_PTR_TO_JSON(MaxResults, maxResults_);
      DARABONBA_PTR_TO_JSON(NextToken, nextToken_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(TotalCounts, totalCounts_);
      DARABONBA_PTR_TO_JSON(UserProvisioningEvents, userProvisioningEvents_);
    };
    friend void from_json(const Darabonba::Json& j, ListUserProvisioningEventsResponseBody& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(UserProvisioningEvents, userProvisioningEvents_);
    };
    ListUserProvisioningEventsResponseBody() = default ;
    ListUserProvisioningEventsResponseBody(const ListUserProvisioningEventsResponseBody &) = default ;
    ListUserProvisioningEventsResponseBody(ListUserProvisioningEventsResponseBody &&) = default ;
    ListUserProvisioningEventsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListUserProvisioningEventsResponseBody() = default ;
    ListUserProvisioningEventsResponseBody& operator=(const ListUserProvisioningEventsResponseBody &) = default ;
    ListUserProvisioningEventsResponseBody& operator=(ListUserProvisioningEventsResponseBody &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    class UserProvisioningEvents : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const UserProvisioningEvents& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, UserProvisioningEvents& obj) { 
      ...
      UserProvisioningEvents() = default ;
      UserProvisioningEvents(const UserProvisioningEvents &) = default ;
      UserProvisioningEvents(UserProvisioningEvents &&) = default ;
      UserProvisioningEvents(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~UserProvisioningEvents() = default ;
      UserProvisioningEvents& operator=(const UserProvisioningEvents &) = default ;
      UserProvisioningEvents& operator=(UserProvisioningEvents &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline UserProvisioningEvents& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
      ...
      inline UserProvisioningEvents& setDeletionStrategy(string deletionStrategy) { DARABONBA_PTR_SET_VALUE(deletionStrategy_, deletionStrategy) };
      ...
      inline UserProvisioningEvents& setDirectoryId(string directoryId) { DARABONBA_PTR_SET_VALUE(directoryId_, directoryId) };
      ...
      inline UserProvisioningEvents& setDuplicationStrategy(string duplicationStrategy) { DARABONBA_PTR_SET_VALUE(duplicationStrategy_, duplicationStrategy) };
      ...
      inline UserProvisioningEvents& setErrorCount(int64_t errorCount) { DARABONBA_PTR_SET_VALUE(errorCount_, errorCount) };
      ...
      inline UserProvisioningEvents& setErrorInfo(string errorInfo) { DARABONBA_PTR_SET_VALUE(errorInfo_, errorInfo) };
      ...
      inline UserProvisioningEvents& setEventId(string eventId) { DARABONBA_PTR_SET_VALUE(eventId_, eventId) };
      ...
      inline UserProvisioningEvents& setLatestAsyncTime(string latestAsyncTime) { DARABONBA_PTR_SET_VALUE(latestAsyncTime_, latestAsyncTime) };
      ...
      inline UserProvisioningEvents& setPrincipalId(string principalId) { DARABONBA_PTR_SET_VALUE(principalId_, principalId) };
      ...
      inline UserProvisioningEvents& setPrincipalName(string principalName) { DARABONBA_PTR_SET_VALUE(principalName_, principalName) };
      ...
      inline UserProvisioningEvents& setPrincipalType(string principalType) { DARABONBA_PTR_SET_VALUE(principalType_, principalType) };
      ...
      inline UserProvisioningEvents& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
      ...
      inline UserProvisioningEvents& setTargetId(string targetId) { DARABONBA_PTR_SET_VALUE(targetId_, targetId) };
      ...
      inline UserProvisioningEvents& setTargetName(string targetName) { DARABONBA_PTR_SET_VALUE(targetName_, targetName) };
      ...
      inline UserProvisioningEvents& setTargetPath(string targetPath) { DARABONBA_PTR_SET_VALUE(targetPath_, targetPath) };
      ...
      inline UserProvisioningEvents& setTargetType(string targetType) { DARABONBA_PTR_SET_VALUE(targetType_, targetType) };
      ...
      inline UserProvisioningEvents& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
      ...
      inline UserProvisioningEvents& setUserProvisioningId(string userProvisioningId) { DARABONBA_PTR_SET_VALUE(userProvisioningId_, userProvisioningId) };
    ...
    virtual bool empty() const override { return this->isTruncated_ == nullptr
        && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->requestId_ == nullptr && this->totalCounts_ == nullptr && this->userProvisioningEvents_ == nullptr; };
    ...
    inline ListUserProvisioningEventsResponseBody& setIsTruncated(bool isTruncated) { DARABONBA_PTR_SET_VALUE(isTruncated_, isTruncated) };
    ...
    inline ListUserProvisioningEventsResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListUserProvisioningEventsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListUserProvisioningEventsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListUserProvisioningEventsResponseBody& setTotalCounts(int32_t totalCounts) { DARABONBA_PTR_SET_VALUE(totalCounts_, totalCounts) };


    // userProvisioningEvents Field Functions 
    bool hasUserProvisioningEvents() const { return this->userProvisioningEvents_ != nullptr;};
    void deleteUserProvisioningEvents() { this->userProvisioningEvents_ = nullptr;};
    inline const vector<ListUserProvisioningEventsResponseBody::UserProvisioningEvents> & getUserProvisioningEvents() const { DARABONBA_PTR_GET_CONST(userProvisioningEvents_, vector<ListUserProvisioningEventsResponseBody::UserProvisioningEvents>) };
    inline vector<ListUserProvisioningEventsResponseBody::UserProvisioningEvents> getUserProvisioningEvents() { DARABONBA_PTR_GET(userProvisioningEvents_, vector<ListUserProvisioningEventsResponseBody::UserProvisioningEvents>) };
    inline ListUserProvisioningEventsResponseBody& setUserProvisioningEvents(const vector<ListUserProvisioningEventsResponseBody::UserProvisioningEvents> & userProvisioningEvents) { DARABONBA_PTR_SET_VALUE(userProvisioningEvents_, userProvisioningEvents) };
    inline ListUserProvisioningEventsResponseBody& setUserProvisioningEvents(vector<ListUserProvisioningEventsResponseBody::UserProvisioningEvents> && userProvisioningEvents) { DARABONBA_PTR_SET_RVALUE(userProvisioningEvents_, userProvisioningEvents) };
  ...
  protected:
    ...
    shared_ptr<vector<ListUserProvisioningEventsResponseBody::UserProvisioningEvents>> userProvisioningEvents_ {};
  };
