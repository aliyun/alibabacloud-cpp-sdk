...
#ifndef ALIBABACLOUD_MODELS_GETUSERPROVISIONINGCONFIGURATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETUSERPROVISIONINGCONFIGURATIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetUserProvisioningConfigurationResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(UserProvisioningConfiguration, userProvisioningConfiguration_);
    };
    friend void from_json(const Darabonba::Json& j, GetUserProvisioningConfigurationResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(UserProvisioningConfiguration, userProvisioningConfiguration_);
    };
    GetUserProvisioningConfigurationResponseBody() = default ;
    GetUserProvisioningConfigurationResponseBody(const GetUserProvisioningConfigurationResponseBody &) = default ;
    GetUserProvisioningConfigurationResponseBody(GetUserProvisioningConfigurationResponseBody &&) = default ;
    GetUserProvisioningConfigurationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetUserProvisioningConfigurationResponseBody() = default ;
    GetUserProvisioningConfigurationResponseBody& operator=(const GetUserProvisioningConfigurationResponseBody &) = default ;
    GetUserProvisioningConfigurationResponseBody& operator=(GetUserProvisioningConfigurationResponseBody &&) = default ;
    ...
    inline GetUserProvisioningConfigurationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline const GetUserProvisioningConfigurationResponseBody::UserProvisioningConfiguration & getUserProvisioningConfiguration() const { DARABONBA_PTR_GET_CONST(userProvisioningConfiguration_, GetUserProvisioningConfigurationResponseBody::UserProvisioningConfiguration) };
    inline GetUserProvisioningConfigurationResponseBody::UserProvisioningConfiguration getUserProvisioningConfiguration() { DARABONBA_PTR_GET(userProvisioningConfiguration_, GetUserProvisioningConfigurationResponseBody::UserProvisioningConfiguration) };
    inline GetUserProvisioningConfigurationResponseBody& setUserProvisioningConfiguration(const GetUserProvisioningConfigurationResponseBody::UserProvisioningConfiguration & userProvisioningConfiguration) { DARABONBA_PTR_SET_VALUE(userProvisioningConfiguration_, userProvisioningConfiguration) };
    inline GetUserProvisioningConfigurationResponseBody& setUserProvisioningConfiguration(GetUserProvisioningConfigurationResponseBody::UserProvisioningConfiguration && userProvisioningConfiguration) { DARABONBA_PTR_SET_RVALUE(userProvisioningConfiguration_, userProvisioningConfiguration) };
  ...
  protected:
    ...
    shared_ptr<GetUserProvisioningConfigurationResponseBody::UserProvisioningConfiguration> userProvisioningConfiguration_ {};
  };
