...
#ifndef ALIBABACLOUD_MODELS_SETEXTERNALSAMLIDENTITYPROVIDERRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SETEXTERNALSAMLIDENTITYPROVIDERRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SetExternalSAMLIdentityProviderResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(SAMLIdentityProviderConfiguration, SAMLIdentityProviderConfiguration_);
    };
    friend void from_json(const Darabonba::Json& j, SetExternalSAMLIdentityProviderResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(SAMLIdentityProviderConfiguration, SAMLIdentityProviderConfiguration_);
    };
    SetExternalSAMLIdentityProviderResponseBody() = default ;
    SetExternalSAMLIdentityProviderResponseBody(const SetExternalSAMLIdentityProviderResponseBody &) = default ;
    SetExternalSAMLIdentityProviderResponseBody(SetExternalSAMLIdentityProviderResponseBody &&) = default ;
    SetExternalSAMLIdentityProviderResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SetExternalSAMLIdentityProviderResponseBody() = default ;
    SetExternalSAMLIdentityProviderResponseBody& operator=(const SetExternalSAMLIdentityProviderResponseBody &) = default ;
    SetExternalSAMLIdentityProviderResponseBody& operator=(SetExternalSAMLIdentityProviderResponseBody &&) = default ;
    ...
    inline SetExternalSAMLIdentityProviderResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline const SetExternalSAMLIdentityProviderResponseBody::SAMLIdentityProviderConfiguration & getSAMLIdentityProviderConfiguration() const { DARABONBA_PTR_GET_CONST(SAMLIdentityProviderConfiguration_, SetExternalSAMLIdentityProviderResponseBody::SAMLIdentityProviderConfiguration) };
    inline SetExternalSAMLIdentityProviderResponseBody::SAMLIdentityProviderConfiguration getSAMLIdentityProviderConfiguration() { DARABONBA_PTR_GET(SAMLIdentityProviderConfiguration_, SetExternalSAMLIdentityProviderResponseBody::SAMLIdentityProviderConfiguration) };
    inline SetExternalSAMLIdentityProviderResponseBody& setSAMLIdentityProviderConfiguration(const SetExternalSAMLIdentityProviderResponseBody::SAMLIdentityProviderConfiguration & sAMLIdentityProviderConfiguration) { DARABONBA_PTR_SET_VALUE(SAMLIdentityProviderConfiguration_, sAMLIdentityProviderConfiguration) };
    inline SetExternalSAMLIdentityProviderResponseBody& setSAMLIdentityProviderConfiguration(SetExternalSAMLIdentityProviderResponseBody::SAMLIdentityProviderConfiguration && sAMLIdentityProviderConfiguration) { DARABONBA_PTR_SET_RVALUE(SAMLIdentityProviderConfiguration_, sAMLIdentityProviderConfiguration) };
  ...
  protected:
    ...
    shared_ptr<SetExternalSAMLIdentityProviderResponseBody::SAMLIdentityProviderConfiguration> SAMLIdentityProviderConfiguration_ {};
  };
