...
#ifndef ALIBABACLOUD_MODELS_DEPROVISIONACCESSCONFIGURATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DEPROVISIONACCESSCONFIGURATIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeprovisionAccessConfigurationResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Tasks, tasks_);
    };
    friend void from_json(const Darabonba::Json& j, DeprovisionAccessConfigurationResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Tasks, tasks_);
    };
    DeprovisionAccessConfigurationResponseBody() = default ;
    DeprovisionAccessConfigurationResponseBody(const DeprovisionAccessConfigurationResponseBody &) = default ;
    DeprovisionAccessConfigurationResponseBody(DeprovisionAccessConfigurationResponseBody &&) = default ;
    DeprovisionAccessConfigurationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeprovisionAccessConfigurationResponseBody() = default ;
    DeprovisionAccessConfigurationResponseBody& operator=(const DeprovisionAccessConfigurationResponseBody &) = default ;
    DeprovisionAccessConfigurationResponseBody& operator=(DeprovisionAccessConfigurationResponseBody &&) = default ;
    ...
    inline DeprovisionAccessConfigurationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // tasks Field Functions 
    bool hasTasks() const { return this->tasks_ != nullptr;};
    void deleteTasks() { this->tasks_ = nullptr;};
    inline const vector<DeprovisionAccessConfigurationResponseBody::Tasks> & getTasks() const { DARABONBA_PTR_GET_CONST(tasks_, vector<DeprovisionAccessConfigurationResponseBody::Tasks>) };
    inline vector<DeprovisionAccessConfigurationResponseBody::Tasks> getTasks() { DARABONBA_PTR_GET(tasks_, vector<DeprovisionAccessConfigurationResponseBody::Tasks>) };
    inline DeprovisionAccessConfigurationResponseBody& setTasks(const vector<DeprovisionAccessConfigurationResponseBody::Tasks> & tasks) { DARABONBA_PTR_SET_VALUE(tasks_, tasks) };
    inline DeprovisionAccessConfigurationResponseBody& setTasks(vector<DeprovisionAccessConfigurationResponseBody::Tasks> && tasks) { DARABONBA_PTR_SET_RVALUE(tasks_, tasks) };
  ...
  protected:
    ...
    shared_ptr<vector<DeprovisionAccessConfigurationResponseBody::Tasks>> tasks_ {};
  };
