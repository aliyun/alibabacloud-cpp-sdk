...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->directoryId_ == nullptr && this->displayName_ == nullptr && this->email_ == nullptr && this->firstName_ == nullptr && this->lastName_ == nullptr
        && this->status_ == nullptr && this->tags_ == nullptr && this->userName_ == nullptr; };
    ...
    inline CreateUserRequest& setFirstName(string firstName) { DARABONBA_PTR_SET_VALUE(firstName_, firstName) };
    ...
    inline CreateUserRequest& setLastName(string lastName) { DARABONBA_PTR_SET_VALUE(lastName_, lastName) };
    ...
    inline CreateUserRequest& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };


    // tags Field Functions 
    bool hasTags() const { return this->tags_ != nullptr;};
    void deleteTags() { this->tags_ = nullptr;};
    inline const vector<CreateUserRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<CreateUserRequest::Tags>) };
    inline vector<CreateUserRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<CreateUserRequest::Tags>) };
    inline CreateUserRequest& setTags(const vector<CreateUserRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline CreateUserRequest& setTags(vector<CreateUserRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    // The list of tags.
    shared_ptr<vector<CreateUserRequest::Tags>> tags_ {};
