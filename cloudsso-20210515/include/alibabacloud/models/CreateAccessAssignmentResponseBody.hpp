...
#ifndef ALIBABACLOUD_MODELS_CREATEACCESSASSIGNMENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEACCESSASSIGNMENTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAccessAssignmentResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Task, task_);
    };
    friend void from_json(const Darabonba::Json& j, CreateAccessAssignmentResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Task, task_);
    };
    CreateAccessAssignmentResponseBody() = default ;
    CreateAccessAssignmentResponseBody(const CreateAccessAssignmentResponseBody &) = default ;
    CreateAccessAssignmentResponseBody(CreateAccessAssignmentResponseBody &&) = default ;
    CreateAccessAssignmentResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAccessAssignmentResponseBody() = default ;
    CreateAccessAssignmentResponseBody& operator=(const CreateAccessAssignmentResponseBody &) = default ;
    CreateAccessAssignmentResponseBody& operator=(CreateAccessAssignmentResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->accessConfigurationId_ == nullptr
        && this->accessConfigurationName_ == nullptr && this->originTargetId_ == nullptr && this->principalId_ == nullptr && this->principalName_ == nullptr && this->principalType_ == nullptr
        && this->status_ == nullptr && this->targetId_ == nullptr && this->targetName_ == nullptr && this->targetPath_ == nullptr && this->targetPathName_ == nullptr
        && this->targetType_ == nullptr && this->taskId_ == nullptr && this->taskType_ == nullptr; };
      ...
      inline Task& setAccessConfigurationId(string accessConfigurationId) { DARABONBA_PTR_SET_VALUE(accessConfigurationId_, accessConfigurationId) };
      ...
      inline Task& setAccessConfigurationName(string accessConfigurationName) { DARABONBA_PTR_SET_VALUE(accessConfigurationName_, accessConfigurationName) };
      ...
      inline Task& setOriginTargetId(string originTargetId) { DARABONBA_PTR_SET_VALUE(originTargetId_, originTargetId) };
      ...
      inline Task& setPrincipalId(string principalId) { DARABONBA_PTR_SET_VALUE(principalId_, principalId) };
      ...
      inline Task& setPrincipalName(string principalName) { DARABONBA_PTR_SET_VALUE(principalName_, principalName) };
      ...
      inline Task& setPrincipalType(string principalType) { DARABONBA_PTR_SET_VALUE(principalType_, principalType) };
      ...
      inline Task& setTargetId(string targetId) { DARABONBA_PTR_SET_VALUE(targetId_, targetId) };
      ...
      inline Task& setTargetName(string targetName) { DARABONBA_PTR_SET_VALUE(targetName_, targetName) };
      ...
      inline Task& setTargetPath(string targetPath) { DARABONBA_PTR_SET_VALUE(targetPath_, targetPath) };
      ...
      inline Task& setTargetPathName(string targetPathName) { DARABONBA_PTR_SET_VALUE(targetPathName_, targetPathName) };
    ...
    inline CreateAccessAssignmentResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // task Field Functions 
    bool hasTask() const { return this->task_ != nullptr;};
    void deleteTask() { this->task_ = nullptr;};
    inline const CreateAccessAssignmentResponseBody::Task & getTask() const { DARABONBA_PTR_GET_CONST(task_, CreateAccessAssignmentResponseBody::Task) };
    inline CreateAccessAssignmentResponseBody::Task getTask() { DARABONBA_PTR_GET(task_, CreateAccessAssignmentResponseBody::Task) };
    inline CreateAccessAssignmentResponseBody& setTask(const CreateAccessAssignmentResponseBody::Task & task) { DARABONBA_PTR_SET_VALUE(task_, task) };
    inline CreateAccessAssignmentResponseBody& setTask(CreateAccessAssignmentResponseBody::Task && task) { DARABONBA_PTR_SET_RVALUE(task_, task) };
  ...
  protected:
    ...
    // The queried task.
    shared_ptr<CreateAccessAssignmentResponseBody::Task> task_ {};
  };
