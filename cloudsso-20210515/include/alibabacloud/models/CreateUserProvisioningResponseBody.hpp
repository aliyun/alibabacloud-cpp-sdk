...
#ifndef ALIBABACLOUD_MODELS_CREATEUSERPROVISIONINGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEUSERPROVISIONINGRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateUserProvisioningResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(UserProvisioning, userProvisioning_);
    };
    friend void from_json(const Darabonba::Json& j, CreateUserProvisioningResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(UserProvisioning, userProvisioning_);
    };
    CreateUserProvisioningResponseBody() = default ;
    CreateUserProvisioningResponseBody(const CreateUserProvisioningResponseBody &) = default ;
    CreateUserProvisioningResponseBody(CreateUserProvisioningResponseBody &&) = default ;
    CreateUserProvisioningResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateUserProvisioningResponseBody() = default ;
    CreateUserProvisioningResponseBody& operator=(const CreateUserProvisioningResponseBody &) = default ;
    CreateUserProvisioningResponseBody& operator=(CreateUserProvisioningResponseBody &&) = default ;
    ...
    inline CreateUserProvisioningResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline const CreateUserProvisioningResponseBody::UserProvisioning & getUserProvisioning() const { DARABONBA_PTR_GET_CONST(userProvisioning_, CreateUserProvisioningResponseBody::UserProvisioning) };
    inline CreateUserProvisioningResponseBody::UserProvisioning getUserProvisioning() { DARABONBA_PTR_GET(userProvisioning_, CreateUserProvisioningResponseBody::UserProvisioning) };
    inline CreateUserProvisioningResponseBody& setUserProvisioning(const CreateUserProvisioningResponseBody::UserProvisioning & userProvisioning) { DARABONBA_PTR_SET_VALUE(userProvisioning_, userProvisioning) };
    inline CreateUserProvisioningResponseBody& setUserProvisioning(CreateUserProvisioningResponseBody::UserProvisioning && userProvisioning) { DARABONBA_PTR_SET_RVALUE(userProvisioning_, userProvisioning) };
  ...
  protected:
    ...
    shared_ptr<CreateUserProvisioningResponseBody::UserProvisioning> userProvisioning_ {};
  };
