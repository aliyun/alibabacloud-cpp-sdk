...
#ifndef ALIBABACLOUD_MODELS_UPDATESCIMSERVERCREDENTIALSTATUSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATESCIMSERVERCREDENTIALSTATUSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateSCIMServerCredentialStatusResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(SCIMServerCredential, SCIMServerCredential_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateSCIMServerCredentialStatusResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(SCIMServerCredential, SCIMServerCredential_);
    };
    UpdateSCIMServerCredentialStatusResponseBody() = default ;
    UpdateSCIMServerCredentialStatusResponseBody(const UpdateSCIMServerCredentialStatusResponseBody &) = default ;
    UpdateSCIMServerCredentialStatusResponseBody(UpdateSCIMServerCredentialStatusResponseBody &&) = default ;
    UpdateSCIMServerCredentialStatusResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateSCIMServerCredentialStatusResponseBody() = default ;
    UpdateSCIMServerCredentialStatusResponseBody& operator=(const UpdateSCIMServerCredentialStatusResponseBody &) = default ;
    UpdateSCIMServerCredentialStatusResponseBody& operator=(UpdateSCIMServerCredentialStatusResponseBody &&) = default ;
    ...
    inline UpdateSCIMServerCredentialStatusResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline const UpdateSCIMServerCredentialStatusResponseBody::SCIMServerCredential & getSCIMServerCredential() const { DARABONBA_PTR_GET_CONST(SCIMServerCredential_, UpdateSCIMServerCredentialStatusResponseBody::SCIMServerCredential) };
    inline UpdateSCIMServerCredentialStatusResponseBody::SCIMServerCredential getSCIMServerCredential() { DARABONBA_PTR_GET(SCIMServerCredential_, UpdateSCIMServerCredentialStatusResponseBody::SCIMServerCredential) };
    inline UpdateSCIMServerCredentialStatusResponseBody& setSCIMServerCredential(const UpdateSCIMServerCredentialStatusResponseBody::SCIMServerCredential & sCIMServerCredential) { DARABONBA_PTR_SET_VALUE(SCIMServerCredential_, sCIMServerCredential) };
    inline UpdateSCIMServerCredentialStatusResponseBody& setSCIMServerCredential(UpdateSCIMServerCredentialStatusResponseBody::SCIMServerCredential && sCIMServerCredential) { DARABONBA_PTR_SET_RVALUE(SCIMServerCredential_, sCIMServerCredential) };
  ...
  protected:
    ...
    shared_ptr<UpdateSCIMServerCredentialStatusResponseBody::SCIMServerCredential> SCIMServerCredential_ {};
  };
