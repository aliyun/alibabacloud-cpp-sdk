...
#ifndef ALIBABACLOUD_MODELS_DELETEACCESSASSIGNMENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DELETEACCESSASSIGNMENTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteAccessAssignmentResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Task, task_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteAccessAssignmentResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Task, task_);
    };
    DeleteAccessAssignmentResponseBody() = default ;
    DeleteAccessAssignmentResponseBody(const DeleteAccessAssignmentResponseBody &) = default ;
    DeleteAccessAssignmentResponseBody(DeleteAccessAssignmentResponseBody &&) = default ;
    DeleteAccessAssignmentResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteAccessAssignmentResponseBody() = default ;
    DeleteAccessAssignmentResponseBody& operator=(const DeleteAccessAssignmentResponseBody &) = default ;
    DeleteAccessAssignmentResponseBody& operator=(DeleteAccessAssignmentResponseBody &&) = default ;
    ...
    inline DeleteAccessAssignmentResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // task Field Functions 
    bool hasTask() const { return this->task_ != nullptr;};
    void deleteTask() { this->task_ = nullptr;};
    inline const DeleteAccessAssignmentResponseBody::Task & getTask() const { DARABONBA_PTR_GET_CONST(task_, DeleteAccessAssignmentResponseBody::Task) };
    inline DeleteAccessAssignmentResponseBody::Task getTask() { DARABONBA_PTR_GET(task_, DeleteAccessAssignmentResponseBody::Task) };
    inline DeleteAccessAssignmentResponseBody& setTask(const DeleteAccessAssignmentResponseBody::Task & task) { DARABONBA_PTR_SET_VALUE(task_, task) };
    inline DeleteAccessAssignmentResponseBody& setTask(DeleteAccessAssignmentResponseBody::Task && task) { DARABONBA_PTR_SET_RVALUE(task_, task) };
  ...
  protected:
    ...
    shared_ptr<DeleteAccessAssignmentResponseBody::Task> task_ {};
  };
