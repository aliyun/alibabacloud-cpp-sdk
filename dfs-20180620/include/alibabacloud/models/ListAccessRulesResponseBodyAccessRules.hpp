...
#ifndef ALIBABACLOUD_MODELS_LISTACCESSRULESRESPONSEBODYACCESSRULES_HPP_
#define ALIBABACLOUD_MODELS_LISTACCESSRULESRESPONSEBODYACCESSRULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAccessRulesResponseBodyAccessRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAccessRulesResponseBodyAccessRules& obj) { 
    ...
    ListAccessRulesResponseBodyAccessRules() = default ;
    ListAccessRulesResponseBodyAccessRules(const ListAccessRulesResponseBodyAccessRules &) = default ;
    ListAccessRulesResponseBodyAccessRules(ListAccessRulesResponseBodyAccessRules &&) = default ;
    ListAccessRulesResponseBodyAccessRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAccessRulesResponseBodyAccessRules() = default ;
    ListAccessRulesResponseBodyAccessRules& operator=(const ListAccessRulesResponseBodyAccessRules &) = default ;
    ListAccessRulesResponseBodyAccessRules& operator=(ListAccessRulesResponseBodyAccessRules &&) = default ;
    ...
    inline ListAccessRulesResponseBodyAccessRules& setAccessGroupId(string accessGroupId) { DARABONBA_PTR_SET_VALUE(accessGroupId_, accessGroupId) };
    ...
    inline ListAccessRulesResponseBodyAccessRules& setAccessRuleId(string accessRuleId) { DARABONBA_PTR_SET_VALUE(accessRuleId_, accessRuleId) };
    ...
    inline ListAccessRulesResponseBodyAccessRules& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListAccessRulesResponseBodyAccessRules& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListAccessRulesResponseBodyAccessRules& setNetworkSegment(string networkSegment) { DARABONBA_PTR_SET_VALUE(networkSegment_, networkSegment) };
    ...
    inline ListAccessRulesResponseBodyAccessRules& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline ListAccessRulesResponseBodyAccessRules& setRWAccessType(string RWAccessType) { DARABONBA_PTR_SET_VALUE(RWAccessType_, RWAccessType) };
    ...
    inline ListAccessRulesResponseBodyAccessRules& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
