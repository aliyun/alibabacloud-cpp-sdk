...
namespace Models
{
  ...
  public:
    ...
    inline const ListAccessRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAccessRulesResponseBody) };
    inline ListAccessRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAccessRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAccessRulesResponseBody> body_ {};
  };
