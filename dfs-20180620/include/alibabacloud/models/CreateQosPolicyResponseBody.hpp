...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorMessages_ == nullptr
        && this->qosPolicyId_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline string getErrorMessages() const { DARABONBA_PTR_GET_DEFAULT(errorMessages_, "") };
  ...
  protected:
    shared_ptr<string> errorMessages_ {};
