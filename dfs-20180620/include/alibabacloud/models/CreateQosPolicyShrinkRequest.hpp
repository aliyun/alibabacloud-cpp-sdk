...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->federationId_ == nullptr && this->fileSystemId_ == nullptr && this->flowIdsShrink_ == nullptr && this->inputRegionId_ == nullptr && this->maxIOBandWidth_ == nullptr
        && this->maxIOps_ == nullptr && this->maxMetaQps_ == nullptr && this->reqTagsShrink_ == nullptr && this->zoneIdsShrink_ == nullptr; };
    ...
    inline string getFlowIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(flowIdsShrink_, "") };
    ...
    inline string getReqTagsShrink() const { DARABONBA_PTR_GET_DEFAULT(reqTagsShrink_, "") };
    ...
    inline string getZoneIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(zoneIdsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> flowIdsShrink_ {};
    ...
    shared_ptr<string> reqTagsShrink_ {};
    shared_ptr<string> zoneIdsShrink_ {};
  };
