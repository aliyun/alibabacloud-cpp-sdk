...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline FileSystems& setMeteringSpaceSize(float meteringSpaceSize) { DARABONBA_PTR_SET_VALUE(meteringSpaceSize_, meteringSpaceSize) };
      ...
      inline FileSystems& setMountPointCount(int64_t mountPointCount) { DARABONBA_PTR_SET_VALUE(mountPointCount_, mountPointCount) };
      ...
      inline FileSystems& setNumberOfDirectories(int64_t numberOfDirectories) { DARABONBA_PTR_SET_VALUE(numberOfDirectories_, numberOfDirectories) };
      ...
      inline FileSystems& setNumberOfFiles(int64_t numberOfFiles) { DARABONBA_PTR_SET_VALUE(numberOfFiles_, numberOfFiles) };
      ...
      inline FileSystems& setProvisionedThroughputInMiBps(int64_t provisionedThroughputInMiBps) { DARABONBA_PTR_SET_VALUE(provisionedThroughputInMiBps_, provisionedThroughputInMiBps) };
      ...
      inline FileSystems& setSpaceCapacity(int64_t spaceCapacity) { DARABONBA_PTR_SET_VALUE(spaceCapacity_, spaceCapacity) };
      ...
      inline FileSystems& setStoragePackageId(string storagePackageId) { DARABONBA_PTR_SET_VALUE(storagePackageId_, storagePackageId) };
      ...
      inline FileSystems& setThroughputMode(string throughputMode) { DARABONBA_PTR_SET_VALUE(throughputMode_, throughputMode) };
      ...
      inline FileSystems& setUsedSpaceSize(float usedSpaceSize) { DARABONBA_PTR_SET_VALUE(usedSpaceSize_, usedSpaceSize) };
      ...
      inline FileSystems& setVersion(string version) { DARABONBA_PTR_SET_VALUE(version_, version) };
    ...
    inline const vector<ListFileSystemsResponseBody::FileSystems> & getFileSystems() const { DARABONBA_PTR_GET_CONST(fileSystems_, vector<ListFileSystemsResponseBody::FileSystems>) };
    inline vector<ListFileSystemsResponseBody::FileSystems> getFileSystems() { DARABONBA_PTR_GET(fileSystems_, vector<ListFileSystemsResponseBody::FileSystems>) };
    inline ListFileSystemsResponseBody& setFileSystems(const vector<ListFileSystemsResponseBody::FileSystems> & fileSystems) { DARABONBA_PTR_SET_VALUE(fileSystems_, fileSystems) };
    inline ListFileSystemsResponseBody& setFileSystems(vector<ListFileSystemsResponseBody::FileSystems> && fileSystems) { DARABONBA_PTR_SET_RVALUE(fileSystems_, fileSystems) };
  ...
  protected:
    shared_ptr<vector<ListFileSystemsResponseBody::FileSystems>> fileSystems_ {};
