...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMountPointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMountPointResponseBody) };
    inline CreateMountPointResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMountPointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMountPointResponseBody> body_ {};
  };
