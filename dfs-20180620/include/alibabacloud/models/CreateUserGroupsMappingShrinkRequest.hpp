...
#ifndef ALIBABACLOUD_MODELS_CREATEUSERGROUPSMAPPINGSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEUSERGROUPSMAPPINGSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateUserGroupsMappingShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(FileSystemId, fileSystemId_);
      DARABONBA_PTR_TO_JSON(GroupNames, groupNamesShrink_);
      DARABONBA_PTR_TO_JSON(InputRegionId, inputRegionId_);
      DARABONBA_PTR_TO_JSON(UserName, userName_);
    };
    friend void from_json(const Darabonba::Json& j, CreateUserGroupsMappingShrinkRequest& obj) { 
    ...
    CreateUserGroupsMappingShrinkRequest() = default ;
    CreateUserGroupsMappingShrinkRequest(const CreateUserGroupsMappingShrinkRequest &) = default ;
    CreateUserGroupsMappingShrinkRequest(CreateUserGroupsMappingShrinkRequest &&) = default ;
    CreateUserGroupsMappingShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateUserGroupsMappingShrinkRequest() = default ;
    CreateUserGroupsMappingShrinkRequest& operator=(const CreateUserGroupsMappingShrinkRequest &) = default ;
    CreateUserGroupsMappingShrinkRequest& operator=(CreateUserGroupsMappingShrinkRequest &&) = default ;
