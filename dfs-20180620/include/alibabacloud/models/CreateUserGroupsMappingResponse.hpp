...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUserGroupsMappingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateUserGroupsMappingResponseBody) };
    inline CreateUserGroupsMappingResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateUserGroupsMappingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateUserGroupsMappingResponseBody> body_ {};
  };
