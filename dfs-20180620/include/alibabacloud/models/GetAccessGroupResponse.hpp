...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccessGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAccessGroupResponseBody) };
    inline GetAccessGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAccessGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAccessGroupResponseBody> body_ {};
  };
