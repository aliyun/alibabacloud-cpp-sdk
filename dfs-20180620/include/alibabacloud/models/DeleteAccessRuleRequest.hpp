...
namespace Models
{
  ...
  public:
    ...
    inline DeleteAccessRuleRequest& setAccessGroupId(string accessGroupId) { DARABONBA_PTR_SET_VALUE(accessGroupId_, accessGroupId) };
    ...
    inline DeleteAccessRuleRequest& setInputRegionId(string inputRegionId) { DARABONBA_PTR_SET_VALUE(inputRegionId_, inputRegionId) };
