...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAccessRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteAccessRuleResponseBody) };
    inline DeleteAccessRuleResponseBody body() { DARABONBA_PTR_GET(body_, DeleteAccessRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteAccessRuleResponseBody> body_ = nullptr;
  };
