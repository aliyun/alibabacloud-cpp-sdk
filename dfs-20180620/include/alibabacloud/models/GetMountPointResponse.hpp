...
namespace Models
{
  ...
  public:
    ...
    inline const GetMountPointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMountPointResponseBody) };
    inline GetMountPointResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMountPointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMountPointResponseBody> body_ {};
  };
