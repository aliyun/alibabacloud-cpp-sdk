...
#ifndef ALIBABACLOUD_MODELS_DELETEMOUNTPOINTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETEMOUNTPOINTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteMountPointRequest& obj) { 
      DARABONBA_PTR_TO_JSON(FileSystemId, fileSystemId_);
      DARABONBA_PTR_TO_JSON(InputRegionId, inputRegionId_);
      DARABONBA_PTR_TO_JSON(MountPointId, mountPointId_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteMountPointRequest& obj) { 
    ...
    DeleteMountPointRequest(const DeleteMountPointRequest &) = default ;
    DeleteMountPointRequest(DeleteMountPointRequest &&) = default ;
    DeleteMountPointRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteMountPointRequest() = default ;
    DeleteMountPointRequest& operator=(const DeleteMountPointRequest &) = default ;
    DeleteMountPointRequest& operator=(DeleteMountPointRequest &&) = default ;
