...
namespace Models
{
  ...
  public:
    ...
    inline const ListFederationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFederationsResponseBody) };
    inline ListFederationsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFederationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFederationsResponseBody> body_ {};
  };
