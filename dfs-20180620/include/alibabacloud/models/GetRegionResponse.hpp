...
namespace Models
{
  ...
  public:
    ...
    inline const GetRegionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRegionResponseBody) };
    inline GetRegionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRegionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRegionResponseBody> body_ {};
  };
