...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->fileSystemId_ == nullptr && this->fileSystemName_ == nullptr && this->inputRegionId_ == nullptr && this->provisionedThroughputInMiBps_ == nullptr && this->spaceCapacity_ == nullptr
        && this->throughputMode_ == nullptr; };
