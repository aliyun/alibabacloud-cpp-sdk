...
namespace Models
{
  ...
  public:
    ...
    inline const AttachVscToMountPointsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachVscToMountPointsResponseBody) };
    inline AttachVscToMountPointsResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachVscToMountPointsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachVscToMountPointsResponseBody> body_ {};
  };
