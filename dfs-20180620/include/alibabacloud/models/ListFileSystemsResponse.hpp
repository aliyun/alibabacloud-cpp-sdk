...
namespace Models
{
  ...
  public:
    ...
    inline const ListFileSystemsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFileSystemsResponseBody) };
    inline ListFileSystemsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFileSystemsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFileSystemsResponseBody> body_ {};
  };
