...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->featureCodeListShrink_ != nullptr
    ...
    inline string featureCodeListShrink() const { DARABONBA_PTR_GET_DEFAULT(featureCodeListShrink_, "") };
  ...
  protected:
    std::shared_ptr<string> featureCodeListShrink_ = nullptr;
