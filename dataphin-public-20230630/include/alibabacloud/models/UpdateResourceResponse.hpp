...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateResourceResponseBody) };
    inline UpdateResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateResourceResponseBody> body_ {};
  };
