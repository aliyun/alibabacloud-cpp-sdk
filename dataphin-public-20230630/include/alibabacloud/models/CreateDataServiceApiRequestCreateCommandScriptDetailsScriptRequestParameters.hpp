...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->exampleValue_ == nullptr
        && return this->isRequiredParameter_ == nullptr && return this->parameterDataType_ == nullptr && return this->parameterDescription_ == nullptr && return this->parameterName_ == nullptr && return this->parameterValueType_ == nullptr; };
