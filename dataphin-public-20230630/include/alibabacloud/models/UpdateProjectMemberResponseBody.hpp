...
namespace Models
{
  ...
  public:
    ...
    inline UpdateProjectMemberResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UpdateProjectMemberResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UpdateProjectMemberResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
