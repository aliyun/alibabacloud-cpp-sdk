...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->env_ == nullptr
        && this->listQueryShrink_ == nullptr && this->opTenantId_ == nullptr && this->opUserId_ == nullptr && this->projectId_ == nullptr; };
    // env Field Functions 
    ...
    inline ListBatchTemplatesShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
