...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->env_ == nullptr
        && return this->opTenantId_ == nullptr && return this->operateCommandShrink_ == nullptr; };
    // env Field Functions 
    ...
    inline string operateCommandShrink() const { DARABONBA_PTR_GET_DEFAULT(operateCommandShrink_, "") };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<string> operateCommandShrink_ = nullptr;
  };
