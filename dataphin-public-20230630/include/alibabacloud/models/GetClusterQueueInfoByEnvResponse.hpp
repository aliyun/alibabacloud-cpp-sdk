...
namespace Models
{
  ...
  public:
    ...
    inline const GetClusterQueueInfoByEnvResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetClusterQueueInfoByEnvResponseBody) };
    inline GetClusterQueueInfoByEnvResponseBody getBody() { DARABONBA_PTR_GET(body_, GetClusterQueueInfoByEnvResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetClusterQueueInfoByEnvResponseBody> body_ {};
  };
