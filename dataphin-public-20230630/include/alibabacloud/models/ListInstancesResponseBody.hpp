...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstancesResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListInstancesResponseBodyPageResult) };
    inline ListInstancesResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListInstancesResponseBodyPageResult) };
    inline ListInstancesResponseBody& setPageResult(const ListInstancesResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListInstancesResponseBody& setPageResult(ListInstancesResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListInstancesResponseBodyPageResult> pageResult_ = nullptr;
