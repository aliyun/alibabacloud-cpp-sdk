...
namespace Models
{
  ...
  public:
    ...
    inline const ListApiByAppResponseBodyListResult & listResult() const { DARABONBA_PTR_GET_CONST(listResult_, ListApiByAppResponseBodyListResult) };
    inline ListApiByAppResponseBodyListResult listResult() { DARABONBA_PTR_GET(listResult_, ListApiByAppResponseBodyListResult) };
    inline ListApiByAppResponseBody& setListResult(const ListApiByAppResponseBodyListResult & listResult) { DARABONBA_PTR_SET_VALUE(listResult_, listResult) };
    inline ListApiByAppResponseBody& setListResult(ListApiByAppResponseBodyListResult && listResult) { DARABONBA_PTR_SET_RVALUE(listResult_, listResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListApiByAppResponseBodyListResult> listResult_ = nullptr;
