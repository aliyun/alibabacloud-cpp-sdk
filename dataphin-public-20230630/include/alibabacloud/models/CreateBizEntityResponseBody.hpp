...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBizEntityResponseBodyCreateResult & createResult() const { DARABONBA_PTR_GET_CONST(createResult_, CreateBizEntityResponseBodyCreateResult) };
    inline CreateBizEntityResponseBodyCreateResult createResult() { DARABONBA_PTR_GET(createResult_, CreateBizEntityResponseBodyCreateResult) };
    inline CreateBizEntityResponseBody& setCreateResult(const CreateBizEntityResponseBodyCreateResult & createResult) { DARABONBA_PTR_SET_VALUE(createResult_, createResult) };
    inline CreateBizEntityResponseBody& setCreateResult(CreateBizEntityResponseBodyCreateResult && createResult) { DARABONBA_PTR_SET_RVALUE(createResult_, createResult) };
  ...
  protected:
    ...
    std::shared_ptr<CreateBizEntityResponseBodyCreateResult> createResult_ = nullptr;
