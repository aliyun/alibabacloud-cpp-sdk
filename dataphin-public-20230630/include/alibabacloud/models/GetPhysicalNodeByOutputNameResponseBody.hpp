...
namespace Models
{
  ...
  public:
    ...
    inline const GetPhysicalNodeByOutputNameResponseBodyNodeInfo & nodeInfo() const { DARABONBA_PTR_GET_CONST(nodeInfo_, GetPhysicalNodeByOutputNameResponseBodyNodeInfo) };
    inline GetPhysicalNodeByOutputNameResponseBodyNodeInfo nodeInfo() { DARABONBA_PTR_GET(nodeInfo_, GetPhysicalNodeByOutputNameResponseBodyNodeInfo) };
    inline GetPhysicalNodeByOutputNameResponseBody& setNodeInfo(const GetPhysicalNodeByOutputNameResponseBodyNodeInfo & nodeInfo) { DARABONBA_PTR_SET_VALUE(nodeInfo_, nodeInfo) };
    inline GetPhysicalNodeByOutputNameResponseBody& setNodeInfo(GetPhysicalNodeByOutputNameResponseBodyNodeInfo && nodeInfo) { DARABONBA_PTR_SET_RVALUE(nodeInfo_, nodeInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetPhysicalNodeByOutputNameResponseBodyNodeInfo> nodeInfo_ = nullptr;
