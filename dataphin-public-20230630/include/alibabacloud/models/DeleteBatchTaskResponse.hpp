...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBatchTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBatchTaskResponseBody) };
    inline DeleteBatchTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBatchTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBatchTaskResponseBody> body_ {};
  };
