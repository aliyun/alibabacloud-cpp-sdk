...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceApiImpactsResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListDataServiceApiImpactsResponseBodyPageResult) };
    inline ListDataServiceApiImpactsResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListDataServiceApiImpactsResponseBodyPageResult) };
    inline ListDataServiceApiImpactsResponseBody& setPageResult(const ListDataServiceApiImpactsResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListDataServiceApiImpactsResponseBody& setPageResult(ListDataServiceApiImpactsResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataServiceApiImpactsResponseBodyPageResult> pageResult_ = nullptr;
    // Id of the request
