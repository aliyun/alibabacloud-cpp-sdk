...
namespace Models
{
  ...
  public:
    ...
    inline const OfflineBizEntityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OfflineBizEntityResponseBody) };
    inline OfflineBizEntityResponseBody getBody() { DARABONBA_PTR_GET(body_, OfflineBizEntityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OfflineBizEntityResponseBody> body_ {};
  };
