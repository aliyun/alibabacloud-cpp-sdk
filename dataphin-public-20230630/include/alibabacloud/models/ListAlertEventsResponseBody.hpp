...
namespace Models
{
  ...
  public:
    ...
    inline const ListAlertEventsResponseBodyListResult & listResult() const { DARABONBA_PTR_GET_CONST(listResult_, ListAlertEventsResponseBodyListResult) };
    inline ListAlertEventsResponseBodyListResult listResult() { DARABONBA_PTR_GET(listResult_, ListAlertEventsResponseBodyListResult) };
    inline ListAlertEventsResponseBody& setListResult(const ListAlertEventsResponseBodyListResult & listResult) { DARABONBA_PTR_SET_VALUE(listResult_, listResult) };
    inline ListAlertEventsResponseBody& setListResult(ListAlertEventsResponseBodyListResult && listResult) { DARABONBA_PTR_SET_RVALUE(listResult_, listResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListAlertEventsResponseBodyListResult> listResult_ = nullptr;
