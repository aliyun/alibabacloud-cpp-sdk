...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAddableRolesResponseBodyRoleList> & roleList() const { DARABONBA_PTR_GET_CONST(roleList_, vector<ListAddableRolesResponseBodyRoleList>) };
    inline vector<ListAddableRolesResponseBodyRoleList> roleList() { DARABONBA_PTR_GET(roleList_, vector<ListAddableRolesResponseBodyRoleList>) };
    inline ListAddableRolesResponseBody& setRoleList(const vector<ListAddableRolesResponseBodyRoleList> & roleList) { DARABONBA_PTR_SET_VALUE(roleList_, roleList) };
    inline ListAddableRolesResponseBody& setRoleList(vector<ListAddableRolesResponseBodyRoleList> && roleList) { DARABONBA_PTR_SET_RVALUE(roleList_, roleList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAddableRolesResponseBodyRoleList>> roleList_ = nullptr;
