...
#include <alibabacloud/models/GetPipelineAsyncResultResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetPipelineAsyncResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPipelineAsyncResultResponseBodyData) };
    inline GetPipelineAsyncResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPipelineAsyncResultResponseBodyData) };
    inline GetPipelineAsyncResultResponseBody& setData(const GetPipelineAsyncResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPipelineAsyncResultResponseBody& setData(GetPipelineAsyncResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetPipelineAsyncResultResponseBodyData> data_ = nullptr;
