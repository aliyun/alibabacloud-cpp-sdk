...
#ifndef ALIBABACLOUD_MODELS_CHECKRESOURCEPERMISSIONSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CHECKRESOURCEPERMISSIONSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    CheckResourcePermissionShrinkRequest(CheckResourcePermissionShrinkRequest &&) = default ;
    CheckResourcePermissionShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CheckResourcePermissionShrinkRequest() = default ;
    CheckResourcePermissionShrinkRequest& operator=(const CheckResourcePermissionShrinkRequest &) = default ;
    CheckResourcePermissionShrinkRequest& operator=(CheckResourcePermissionShrinkRequest &&) = default ;
