...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataServiceApiCallTrendResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataServiceApiCallTrendResponseBody) };
    inline GetDataServiceApiCallTrendResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataServiceApiCallTrendResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataServiceApiCallTrendResponseBody> body_ {};
  };
