...
namespace Models
{
  ...
  public:
    ...
    inline const ListPublishRecordsRequestListQuery & listQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListPublishRecordsRequestListQuery) };
    inline ListPublishRecordsRequestListQuery listQuery() { DARABONBA_PTR_GET(listQuery_, ListPublishRecordsRequestListQuery) };
    inline ListPublishRecordsRequest& setListQuery(const ListPublishRecordsRequestListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListPublishRecordsRequest& setListQuery(ListPublishRecordsRequestListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
  ...
  protected:
    ...
    std::shared_ptr<ListPublishRecordsRequestListQuery> listQuery_ = nullptr;
    // This parameter is required.
