...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAdHocFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAdHocFileResponseBody) };
    inline CreateAdHocFileResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAdHocFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAdHocFileResponseBody> body_ {};
  };
