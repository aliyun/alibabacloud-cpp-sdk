...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->opTenantId_ == nullptr
        && this->opUserId_ == nullptr && this->tableColumnLineageByTaskIdQueryShrink_ == nullptr; };
    ...
    inline GetTableColumnLineageByTaskIdShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline string getTableColumnLineageByTaskIdQueryShrink() const { DARABONBA_PTR_GET_DEFAULT(tableColumnLineageByTaskIdQueryShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> tableColumnLineageByTaskIdQueryShrink_ {};
  };
