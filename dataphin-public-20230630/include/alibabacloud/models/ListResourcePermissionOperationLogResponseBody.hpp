...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourcePermissionOperationLogResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListResourcePermissionOperationLogResponseBodyPageResult) };
    inline ListResourcePermissionOperationLogResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListResourcePermissionOperationLogResponseBodyPageResult) };
    inline ListResourcePermissionOperationLogResponseBody& setPageResult(const ListResourcePermissionOperationLogResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListResourcePermissionOperationLogResponseBody& setPageResult(ListResourcePermissionOperationLogResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListResourcePermissionOperationLogResponseBodyPageResult> pageResult_ = nullptr;
