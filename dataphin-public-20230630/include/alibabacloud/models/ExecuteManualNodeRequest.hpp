...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->env_ == nullptr
        && this->executeCommand_ == nullptr && this->opTenantId_ == nullptr && this->opUserId_ == nullptr; };
    // env Field Functions 
    ...
    inline ExecuteManualNodeRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
