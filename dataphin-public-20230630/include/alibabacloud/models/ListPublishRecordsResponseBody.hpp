...
namespace Models
{
  ...
  public:
    ...
    inline const ListPublishRecordsResponseBodyListResult & listResult() const { DARABONBA_PTR_GET_CONST(listResult_, ListPublishRecordsResponseBodyListResult) };
    inline ListPublishRecordsResponseBodyListResult listResult() { DARABONBA_PTR_GET(listResult_, ListPublishRecordsResponseBodyListResult) };
    inline ListPublishRecordsResponseBody& setListResult(const ListPublishRecordsResponseBodyListResult & listResult) { DARABONBA_PTR_SET_VALUE(listResult_, listResult) };
    inline ListPublishRecordsResponseBody& setListResult(ListPublishRecordsResponseBodyListResult && listResult) { DARABONBA_PTR_SET_RVALUE(listResult_, listResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListPublishRecordsResponseBodyListResult> listResult_ = nullptr;
