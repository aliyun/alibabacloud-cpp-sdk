...
namespace Models
{
  ...
  public:
    ...
    inline const ListBizEntitiesResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListBizEntitiesResponseBodyPageResult) };
    inline ListBizEntitiesResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListBizEntitiesResponseBodyPageResult) };
    inline ListBizEntitiesResponseBody& setPageResult(const ListBizEntitiesResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListBizEntitiesResponseBody& setPageResult(ListBizEntitiesResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListBizEntitiesResponseBodyPageResult> pageResult_ = nullptr;
