...
namespace Models
{
  ...
  public:
    ...
    inline const GetPhysicalInstanceLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPhysicalInstanceLogResponseBody) };
    inline GetPhysicalInstanceLogResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPhysicalInstanceLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPhysicalInstanceLogResponseBody> body_ {};
  };
