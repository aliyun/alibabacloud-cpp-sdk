...
#ifndef ALIBABACLOUD_MODELS_EXECKGGREMLINREQUEST_HPP_
#define ALIBABACLOUD_MODELS_EXECKGGREMLINREQUEST_HPP_
...
namespace Models
{
  class ExecKgGremlinRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ExecKgGremlinRequest& obj) { 
      DARABONBA_PTR_TO_JSON(ExecCommand, execCommand_);
      DARABONBA_PTR_TO_JSON(OpTenantId, opTenantId_);
      DARABONBA_PTR_TO_JSON(OpUserId, opUserId_);
      DARABONBA_PTR_TO_JSON(WorkspaceId, workspaceId_);
    };
    friend void from_json(const Darabonba::Json& j, ExecKgGremlinRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(ExecCommand, execCommand_);
      DARABONBA_PTR_FROM_JSON(OpTenantId, opTenantId_);
      DARABONBA_PTR_FROM_JSON(OpUserId, opUserId_);
      DARABONBA_PTR_FROM_JSON(WorkspaceId, workspaceId_);
    };
    ExecKgGremlinRequest() = default ;
    ExecKgGremlinRequest(const ExecKgGremlinRequest &) = default ;
    ExecKgGremlinRequest(ExecKgGremlinRequest &&) = default ;
    ExecKgGremlinRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExecKgGremlinRequest() = default ;
    ExecKgGremlinRequest& operator=(const ExecKgGremlinRequest &) = default ;
    ExecKgGremlinRequest& operator=(ExecKgGremlinRequest &&) = default ;
    ...
    inline const ExecKgGremlinRequest::ExecCommand & getExecCommand() const { DARABONBA_PTR_GET_CONST(execCommand_, ExecKgGremlinRequest::ExecCommand) };
    inline ExecKgGremlinRequest::ExecCommand getExecCommand() { DARABONBA_PTR_GET(execCommand_, ExecKgGremlinRequest::ExecCommand) };
    inline ExecKgGremlinRequest& setExecCommand(const ExecKgGremlinRequest::ExecCommand & execCommand) { DARABONBA_PTR_SET_VALUE(execCommand_, execCommand) };
    inline ExecKgGremlinRequest& setExecCommand(ExecKgGremlinRequest::ExecCommand && execCommand) { DARABONBA_PTR_SET_RVALUE(execCommand_, execCommand) };
    ...
    inline ExecKgGremlinRequest& setOpTenantId(int64_t opTenantId) { DARABONBA_PTR_SET_VALUE(opTenantId_, opTenantId) };
    ...
    inline ExecKgGremlinRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline ExecKgGremlinRequest& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
  ...
  protected:
    ...
    shared_ptr<ExecKgGremlinRequest::ExecCommand> execCommand_ {};
    // The tenant ID.
    // 
    // This parameter is required.
