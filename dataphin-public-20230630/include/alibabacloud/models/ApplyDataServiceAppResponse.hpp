...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyDataServiceAppResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ApplyDataServiceAppResponseBody) };
    inline ApplyDataServiceAppResponseBody body() { DARABONBA_PTR_GET(body_, ApplyDataServiceAppResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ApplyDataServiceAppResponseBody> body_ = nullptr;
  };
