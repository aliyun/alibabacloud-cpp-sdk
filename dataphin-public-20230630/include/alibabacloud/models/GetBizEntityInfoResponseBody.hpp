...
namespace Models
{
  ...
  public:
    ...
    inline const GetBizEntityInfoResponseBody::BizEntityInfo & getBizEntityInfo() const { DARABONBA_PTR_GET_CONST(bizEntityInfo_, GetBizEntityInfoResponseBody::BizEntityInfo) };
    inline GetBizEntityInfoResponseBody::BizEntityInfo getBizEntityInfo() { DARABONBA_PTR_GET(bizEntityInfo_, GetBizEntityInfoResponseBody::BizEntityInfo) };
    inline GetBizEntityInfoResponseBody& setBizEntityInfo(const GetBizEntityInfoResponseBody::BizEntityInfo & bizEntityInfo) { DARABONBA_PTR_SET_VALUE(bizEntityInfo_, bizEntityInfo) };
    inline GetBizEntityInfoResponseBody& setBizEntityInfo(GetBizEntityInfoResponseBody::BizEntityInfo && bizEntityInfo) { DARABONBA_PTR_SET_RVALUE(bizEntityInfo_, bizEntityInfo) };
