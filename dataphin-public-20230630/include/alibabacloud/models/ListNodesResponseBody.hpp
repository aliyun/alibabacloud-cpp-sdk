...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodesResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListNodesResponseBodyPageResult) };
    inline ListNodesResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListNodesResponseBodyPageResult) };
    inline ListNodesResponseBody& setPageResult(const ListNodesResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListNodesResponseBody& setPageResult(ListNodesResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListNodesResponseBodyPageResult> pageResult_ = nullptr;
