...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->directory_ == nullptr
        && this->fileId_ == nullptr && this->opTenantId_ == nullptr && this->opUserId_ == nullptr && this->projectId_ == nullptr; };
    ...
    inline UpdateFileDirectoryRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
