...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->id_ == nullptr
        && this->nullable_ == nullptr && this->opTenantId_ == nullptr && this->opUserId_ == nullptr; };
    // id Field Functions 
    ...
    inline GetStandardLookupTableRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
