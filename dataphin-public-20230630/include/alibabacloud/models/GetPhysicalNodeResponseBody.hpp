...
#ifndef ALIBABACLOUD_MODELS_GETPHYSICALNODERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETPHYSICALNODERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetPhysicalNodeResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetPhysicalNodeResponseBody& obj) { 
    ...
    GetPhysicalNodeResponseBody() = default ;
    GetPhysicalNodeResponseBody(const GetPhysicalNodeResponseBody &) = default ;
    GetPhysicalNodeResponseBody(GetPhysicalNodeResponseBody &&) = default ;
    GetPhysicalNodeResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetPhysicalNodeResponseBody() = default ;
    GetPhysicalNodeResponseBody& operator=(const GetPhysicalNodeResponseBody &) = default ;
    GetPhysicalNodeResponseBody& operator=(GetPhysicalNodeResponseBody &&) = default ;
    ...
    public:
      ...
      inline NodeInfo& setCronExpression(string cronExpression) { DARABONBA_PTR_SET_VALUE(cronExpression_, cronExpression) };
      ...
      inline NodeInfo& setDataSourceId(int64_t dataSourceId) { DARABONBA_PTR_SET_VALUE(dataSourceId_, dataSourceId) };
      ...
      inline NodeInfo& setDataSourceSchema(string dataSourceSchema) { DARABONBA_PTR_SET_VALUE(dataSourceSchema_, dataSourceSchema) };
      ...
      inline const vector<string> & getOutputNameList() const { DARABONBA_PTR_GET_CONST(outputNameList_, vector<string>) };
      inline vector<string> getOutputNameList() { DARABONBA_PTR_GET(outputNameList_, vector<string>) };
      inline NodeInfo& setOutputNameList(const vector<string> & outputNameList) { DARABONBA_PTR_SET_VALUE(outputNameList_, outputNameList) };
      inline NodeInfo& setOutputNameList(vector<string> && outputNameList) { DARABONBA_PTR_SET_RVALUE(outputNameList_, outputNameList) };
    ...
    inline GetPhysicalNodeResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetPhysicalNodeResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetPhysicalNodeResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };


    // nodeInfo Field Functions 
    bool hasNodeInfo() const { return this->nodeInfo_ != nullptr;};
    void deleteNodeInfo() { this->nodeInfo_ = nullptr;};
    inline const GetPhysicalNodeResponseBody::NodeInfo & getNodeInfo() const { DARABONBA_PTR_GET_CONST(nodeInfo_, GetPhysicalNodeResponseBody::NodeInfo) };
    inline GetPhysicalNodeResponseBody::NodeInfo getNodeInfo() { DARABONBA_PTR_GET(nodeInfo_, GetPhysicalNodeResponseBody::NodeInfo) };
    inline GetPhysicalNodeResponseBody& setNodeInfo(const GetPhysicalNodeResponseBody::NodeInfo & nodeInfo) { DARABONBA_PTR_SET_VALUE(nodeInfo_, nodeInfo) };
    inline GetPhysicalNodeResponseBody& setNodeInfo(GetPhysicalNodeResponseBody::NodeInfo && nodeInfo) { DARABONBA_PTR_SET_RVALUE(nodeInfo_, nodeInfo) };
    ...
    inline GetPhysicalNodeResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetPhysicalNodeResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
