...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->nodeInfoList_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<ListNodeDownStreamResponseBodyNodeInfoList> & nodeInfoList() const { DARABONBA_PTR_GET_CONST(nodeInfoList_, vector<ListNodeDownStreamResponseBodyNodeInfoList>) };
    inline vector<ListNodeDownStreamResponseBodyNodeInfoList> nodeInfoList() { DARABONBA_PTR_GET(nodeInfoList_, vector<ListNodeDownStreamResponseBodyNodeInfoList>) };
    inline ListNodeDownStreamResponseBody& setNodeInfoList(const vector<ListNodeDownStreamResponseBodyNodeInfoList> & nodeInfoList) { DARABONBA_PTR_SET_VALUE(nodeInfoList_, nodeInfoList) };
    inline ListNodeDownStreamResponseBody& setNodeInfoList(vector<ListNodeDownStreamResponseBodyNodeInfoList> && nodeInfoList) { DARABONBA_PTR_SET_RVALUE(nodeInfoList_, nodeInfoList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListNodeDownStreamResponseBodyNodeInfoList>> nodeInfoList_ = nullptr;
