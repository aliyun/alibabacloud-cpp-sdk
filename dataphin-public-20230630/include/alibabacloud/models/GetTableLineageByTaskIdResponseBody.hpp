...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetTableLineageByTaskIdResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<GetTableLineageByTaskIdResponseBody::Data>) };
    inline vector<GetTableLineageByTaskIdResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<GetTableLineageByTaskIdResponseBody::Data>) };
    inline GetTableLineageByTaskIdResponseBody& setData(const vector<GetTableLineageByTaskIdResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTableLineageByTaskIdResponseBody& setData(vector<GetTableLineageByTaskIdResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
