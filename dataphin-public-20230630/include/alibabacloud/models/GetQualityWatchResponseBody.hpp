...
#ifndef ALIBABACLOUD_MODELS_GETQUALITYWATCHRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETQUALITYWATCHRESPONSEBODY_HPP_
...
namespace Models
{
  class GetQualityWatchResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetQualityWatchResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetQualityWatchResponseBody& obj) { 
    ...
    GetQualityWatchResponseBody() = default ;
    GetQualityWatchResponseBody(const GetQualityWatchResponseBody &) = default ;
    GetQualityWatchResponseBody(GetQualityWatchResponseBody &&) = default ;
    GetQualityWatchResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetQualityWatchResponseBody() = default ;
    GetQualityWatchResponseBody& operator=(const GetQualityWatchResponseBody &) = default ;
    GetQualityWatchResponseBody& operator=(GetQualityWatchResponseBody &&) = default ;
    ...
    inline GetQualityWatchResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetQualityWatchResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetQualityWatchResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline const GetQualityWatchResponseBody::QualityWatchInfo & getQualityWatchInfo() const { DARABONBA_PTR_GET_CONST(qualityWatchInfo_, GetQualityWatchResponseBody::QualityWatchInfo) };
    inline GetQualityWatchResponseBody::QualityWatchInfo getQualityWatchInfo() { DARABONBA_PTR_GET(qualityWatchInfo_, GetQualityWatchResponseBody::QualityWatchInfo) };
    inline GetQualityWatchResponseBody& setQualityWatchInfo(const GetQualityWatchResponseBody::QualityWatchInfo & qualityWatchInfo) { DARABONBA_PTR_SET_VALUE(qualityWatchInfo_, qualityWatchInfo) };
    inline GetQualityWatchResponseBody& setQualityWatchInfo(GetQualityWatchResponseBody::QualityWatchInfo && qualityWatchInfo) { DARABONBA_PTR_SET_RVALUE(qualityWatchInfo_, qualityWatchInfo) };
    ...
    inline GetQualityWatchResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetQualityWatchResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
