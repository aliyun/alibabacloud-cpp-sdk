...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataServiceApiErrorImpactResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDataServiceApiErrorImpactResponseBodyData) };
    inline GetDataServiceApiErrorImpactResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDataServiceApiErrorImpactResponseBodyData) };
    inline GetDataServiceApiErrorImpactResponseBody& setData(const GetDataServiceApiErrorImpactResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataServiceApiErrorImpactResponseBody& setData(GetDataServiceApiErrorImpactResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataServiceApiErrorImpactResponseBodyData> data_ = nullptr;
