...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline ListQuery& setCatalog(string catalog) { DARABONBA_PTR_SET_VALUE(catalog_, catalog) };
    ...
    inline const ListTablesRequest::ListQuery & getListQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListTablesRequest::ListQuery) };
    inline ListTablesRequest::ListQuery getListQuery() { DARABONBA_PTR_GET(listQuery_, ListTablesRequest::ListQuery) };
    inline ListTablesRequest& setListQuery(const ListTablesRequest::ListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListTablesRequest& setListQuery(ListTablesRequest::ListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
    ...
    inline ListTablesRequest& setOpTenantId(int64_t opTenantId) { DARABONBA_PTR_SET_VALUE(opTenantId_, opTenantId) };
    ...
    inline ListTablesRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
