...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->id_ == nullptr
        && this->opTenantId_ == nullptr && this->opUserId_ == nullptr && this->versionId_ == nullptr; };
    // id Field Functions 
    ...
    inline GetDataServiceApiDocumentRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
