...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteManualNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecuteManualNodeResponseBody) };
    inline ExecuteManualNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecuteManualNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecuteManualNodeResponseBody> body_ {};
  };
