...
#ifndef ALIBABACLOUD_MODELS_GETBIZENTITYINFORESPONSEBODYBIZENTITYINFOBIZOBJECT_HPP_
#define ALIBABACLOUD_MODELS_GETBIZENTITYINFORESPONSEBODYBIZENTITYINFOBIZOBJECT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetBizEntityInfoResponseBodyBizEntityInfoBizObject& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetBizEntityInfoResponseBodyBizEntityInfoBizObject& obj) { 
    ...
    GetBizEntityInfoResponseBodyBizEntityInfoBizObject() = default ;
    GetBizEntityInfoResponseBodyBizEntityInfoBizObject(const GetBizEntityInfoResponseBodyBizEntityInfoBizObject &) = default ;
    GetBizEntityInfoResponseBodyBizEntityInfoBizObject(GetBizEntityInfoResponseBodyBizEntityInfoBizObject &&) = default ;
    GetBizEntityInfoResponseBodyBizEntityInfoBizObject(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetBizEntityInfoResponseBodyBizEntityInfoBizObject() = default ;
    GetBizEntityInfoResponseBodyBizEntityInfoBizObject& operator=(const GetBizEntityInfoResponseBodyBizEntityInfoBizObject &) = default ;
    GetBizEntityInfoResponseBodyBizEntityInfoBizObject& operator=(GetBizEntityInfoResponseBodyBizEntityInfoBizObject &&) = default ;
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setApprovalId(string approvalId) { DARABONBA_PTR_SET_VALUE(approvalId_, approvalId) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setApprovalStatus(string approvalStatus) { DARABONBA_PTR_SET_VALUE(approvalStatus_, approvalStatus) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setChildBizEntityIdList(const vector<int64_t> & childBizEntityIdList) { DARABONBA_PTR_SET_VALUE(childBizEntityIdList_, childBizEntityIdList) };
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setChildBizEntityIdList(vector<int64_t> && childBizEntityIdList) { DARABONBA_PTR_SET_RVALUE(childBizEntityIdList_, childBizEntityIdList) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setLastModifier(string lastModifier) { DARABONBA_PTR_SET_VALUE(lastModifier_, lastModifier) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setLastModifierName(string lastModifierName) { DARABONBA_PTR_SET_VALUE(lastModifierName_, lastModifierName) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setOnlineStatus(string onlineStatus) { DARABONBA_PTR_SET_VALUE(onlineStatus_, onlineStatus) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setOwnerName(string ownerName) { DARABONBA_PTR_SET_VALUE(ownerName_, ownerName) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setOwnerUserId(string ownerUserId) { DARABONBA_PTR_SET_VALUE(ownerUserId_, ownerUserId) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setParentId(int64_t parentId) { DARABONBA_PTR_SET_VALUE(parentId_, parentId) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setRefBizEntityIdList(const vector<int64_t> & refBizEntityIdList) { DARABONBA_PTR_SET_VALUE(refBizEntityIdList_, refBizEntityIdList) };
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setRefBizEntityIdList(vector<int64_t> && refBizEntityIdList) { DARABONBA_PTR_SET_RVALUE(refBizEntityIdList_, refBizEntityIdList) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setRefDimTableCount(int32_t refDimTableCount) { DARABONBA_PTR_SET_VALUE(refDimTableCount_, refDimTableCount) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setRefSummaryTableCount(int32_t refSummaryTableCount) { DARABONBA_PTR_SET_VALUE(refSummaryTableCount_, refSummaryTableCount) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetBizEntityInfoResponseBodyBizEntityInfoBizObject& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
