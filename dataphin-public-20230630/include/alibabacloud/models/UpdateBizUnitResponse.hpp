...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateBizUnitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateBizUnitResponseBody) };
    inline UpdateBizUnitResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateBizUnitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateBizUnitResponseBody> body_ {};
  };
