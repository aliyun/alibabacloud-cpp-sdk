...
namespace Models
{
  ...
  public:
    ...
    inline const GetBatchTaskVersionsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetBatchTaskVersionsResponseBodyData) };
    inline GetBatchTaskVersionsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetBatchTaskVersionsResponseBodyData) };
    inline GetBatchTaskVersionsResponseBody& setData(const GetBatchTaskVersionsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetBatchTaskVersionsResponseBody& setData(GetBatchTaskVersionsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetBatchTaskVersionsResponseBodyData> data_ = nullptr;
