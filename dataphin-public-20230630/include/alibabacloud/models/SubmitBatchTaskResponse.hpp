...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitBatchTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitBatchTaskResponseBody) };
    inline SubmitBatchTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitBatchTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitBatchTaskResponseBody> body_ {};
  };
