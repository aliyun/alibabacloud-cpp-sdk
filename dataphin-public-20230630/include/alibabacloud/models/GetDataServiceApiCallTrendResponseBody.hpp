...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataServiceApiCallTrendResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDataServiceApiCallTrendResponseBodyData) };
    inline GetDataServiceApiCallTrendResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDataServiceApiCallTrendResponseBodyData) };
    inline GetDataServiceApiCallTrendResponseBody& setData(const GetDataServiceApiCallTrendResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataServiceApiCallTrendResponseBody& setData(GetDataServiceApiCallTrendResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataServiceApiCallTrendResponseBodyData> data_ = nullptr;
