...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataDomainsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDataDomainsResponseBodyData) };
    inline ListDataDomainsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDataDomainsResponseBodyData) };
    inline ListDataDomainsResponseBody& setData(const ListDataDomainsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDataDomainsResponseBody& setData(ListDataDomainsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataDomainsResponseBodyData> data_ = nullptr;
