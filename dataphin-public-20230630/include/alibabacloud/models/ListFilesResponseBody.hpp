...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->fileList_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<ListFilesResponseBodyFileList> & fileList() const { DARABONBA_PTR_GET_CONST(fileList_, vector<ListFilesResponseBodyFileList>) };
    inline vector<ListFilesResponseBodyFileList> fileList() { DARABONBA_PTR_GET(fileList_, vector<ListFilesResponseBodyFileList>) };
    inline ListFilesResponseBody& setFileList(const vector<ListFilesResponseBodyFileList> & fileList) { DARABONBA_PTR_SET_VALUE(fileList_, fileList) };
    inline ListFilesResponseBody& setFileList(vector<ListFilesResponseBodyFileList> && fileList) { DARABONBA_PTR_SET_RVALUE(fileList_, fileList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListFilesResponseBodyFileList>> fileList_ = nullptr;
