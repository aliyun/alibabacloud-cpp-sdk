...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->opTenantId_ == nullptr
        && this->opUserId_ == nullptr && this->tableLineageByTaskIdQueryShrink_ == nullptr; };
    ...
    inline GetTableLineageByTaskIdShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline string getTableLineageByTaskIdQueryShrink() const { DARABONBA_PTR_GET_DEFAULT(tableLineageByTaskIdQueryShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> tableLineageByTaskIdQueryShrink_ {};
  };
