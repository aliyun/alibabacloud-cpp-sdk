...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateUserGroupSwitchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateUserGroupSwitchResponseBody) };
    inline UpdateUserGroupSwitchResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateUserGroupSwitchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateUserGroupSwitchResponseBody> body_ {};
  };
