...
#ifndef ALIBABACLOUD_MODELS_UPDATECOMPUTECLUSTERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATECOMPUTECLUSTERREQUEST_HPP_
...
namespace Models
{
  class UpdateComputeClusterRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateComputeClusterRequest& obj) { 
      DARABONBA_PTR_TO_JSON(ClusterConfig, clusterConfig_);
      DARABONBA_PTR_TO_JSON(Id, id_);
      DARABONBA_PTR_TO_JSON(OpTenantId, opTenantId_);
      DARABONBA_PTR_TO_JSON(OpUserId, opUserId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateComputeClusterRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(ClusterConfig, clusterConfig_);
      DARABONBA_PTR_FROM_JSON(Id, id_);
      DARABONBA_PTR_FROM_JSON(OpTenantId, opTenantId_);
      DARABONBA_PTR_FROM_JSON(OpUserId, opUserId_);
    };
    UpdateComputeClusterRequest() = default ;
    UpdateComputeClusterRequest(const UpdateComputeClusterRequest &) = default ;
    UpdateComputeClusterRequest(UpdateComputeClusterRequest &&) = default ;
    UpdateComputeClusterRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateComputeClusterRequest() = default ;
    UpdateComputeClusterRequest& operator=(const UpdateComputeClusterRequest &) = default ;
    UpdateComputeClusterRequest& operator=(UpdateComputeClusterRequest &&) = default ;
    ...
    inline const UpdateComputeClusterRequest::ClusterConfig & getClusterConfig() const { DARABONBA_PTR_GET_CONST(clusterConfig_, UpdateComputeClusterRequest::ClusterConfig) };
    inline UpdateComputeClusterRequest::ClusterConfig getClusterConfig() { DARABONBA_PTR_GET(clusterConfig_, UpdateComputeClusterRequest::ClusterConfig) };
    inline UpdateComputeClusterRequest& setClusterConfig(const UpdateComputeClusterRequest::ClusterConfig & clusterConfig) { DARABONBA_PTR_SET_VALUE(clusterConfig_, clusterConfig) };
    inline UpdateComputeClusterRequest& setClusterConfig(UpdateComputeClusterRequest::ClusterConfig && clusterConfig) { DARABONBA_PTR_SET_RVALUE(clusterConfig_, clusterConfig) };
    ...
    inline UpdateComputeClusterRequest& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UpdateComputeClusterRequest& setOpTenantId(int64_t opTenantId) { DARABONBA_PTR_SET_VALUE(opTenantId_, opTenantId) };
    ...
    inline UpdateComputeClusterRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
