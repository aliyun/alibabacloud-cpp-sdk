...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceByVersionResponseBodyResourceInfo & resourceInfo() const { DARABONBA_PTR_GET_CONST(resourceInfo_, GetResourceByVersionResponseBodyResourceInfo) };
    inline GetResourceByVersionResponseBodyResourceInfo resourceInfo() { DARABONBA_PTR_GET(resourceInfo_, GetResourceByVersionResponseBodyResourceInfo) };
    inline GetResourceByVersionResponseBody& setResourceInfo(const GetResourceByVersionResponseBodyResourceInfo & resourceInfo) { DARABONBA_PTR_SET_VALUE(resourceInfo_, resourceInfo) };
    inline GetResourceByVersionResponseBody& setResourceInfo(GetResourceByVersionResponseBodyResourceInfo && resourceInfo) { DARABONBA_PTR_SET_RVALUE(resourceInfo_, resourceInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetResourceByVersionResponseBodyResourceInfo> resourceInfo_ = nullptr;
