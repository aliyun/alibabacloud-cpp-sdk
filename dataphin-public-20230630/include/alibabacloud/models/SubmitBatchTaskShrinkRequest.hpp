...
#ifndef ALIBABACLOUD_MODELS_SUBMITBATCHTASKSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SUBMITBATCHTASKSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SubmitBatchTaskShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(OpTenantId, opTenantId_);
      DARABONBA_PTR_TO_JSON(OpUserId, opUserId_);
      DARABONBA_PTR_TO_JSON(SubmitCommand, submitCommandShrink_);
    };
    friend void from_json(const Darabonba::Json& j, SubmitBatchTaskShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(OpTenantId, opTenantId_);
      DARABONBA_PTR_FROM_JSON(OpUserId, opUserId_);
      DARABONBA_PTR_FROM_JSON(SubmitCommand, submitCommandShrink_);
    };
    SubmitBatchTaskShrinkRequest() = default ;
    SubmitBatchTaskShrinkRequest(const SubmitBatchTaskShrinkRequest &) = default ;
    SubmitBatchTaskShrinkRequest(SubmitBatchTaskShrinkRequest &&) = default ;
    SubmitBatchTaskShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitBatchTaskShrinkRequest() = default ;
    SubmitBatchTaskShrinkRequest& operator=(const SubmitBatchTaskShrinkRequest &) = default ;
    SubmitBatchTaskShrinkRequest& operator=(SubmitBatchTaskShrinkRequest &&) = default ;
    ...
    inline SubmitBatchTaskShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
