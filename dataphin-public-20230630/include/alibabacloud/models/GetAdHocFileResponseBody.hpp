...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->fileInfo_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetAdHocFileResponseBodyFileInfo & fileInfo() const { DARABONBA_PTR_GET_CONST(fileInfo_, GetAdHocFileResponseBodyFileInfo) };
    inline GetAdHocFileResponseBodyFileInfo fileInfo() { DARABONBA_PTR_GET(fileInfo_, GetAdHocFileResponseBodyFileInfo) };
    inline GetAdHocFileResponseBody& setFileInfo(const GetAdHocFileResponseBodyFileInfo & fileInfo) { DARABONBA_PTR_SET_VALUE(fileInfo_, fileInfo) };
    inline GetAdHocFileResponseBody& setFileInfo(GetAdHocFileResponseBodyFileInfo && fileInfo) { DARABONBA_PTR_SET_RVALUE(fileInfo_, fileInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetAdHocFileResponseBodyFileInfo> fileInfo_ = nullptr;
