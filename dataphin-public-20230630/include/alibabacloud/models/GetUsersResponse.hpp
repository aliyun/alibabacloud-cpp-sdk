...
namespace Models
{
  ...
  public:
    ...
    inline const GetUsersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUsersResponseBody) };
    inline GetUsersResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUsersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUsersResponseBody> body_ {};
  };
