...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBizUnitRequestCreateCommand & createCommand() const { DARABONBA_PTR_GET_CONST(createCommand_, CreateBizUnitRequestCreateCommand) };
    inline CreateBizUnitRequestCreateCommand createCommand() { DARABONBA_PTR_GET(createCommand_, CreateBizUnitRequestCreateCommand) };
    inline CreateBizUnitRequest& setCreateCommand(const CreateBizUnitRequestCreateCommand & createCommand) { DARABONBA_PTR_SET_VALUE(createCommand_, createCommand) };
    inline CreateBizUnitRequest& setCreateCommand(CreateBizUnitRequestCreateCommand && createCommand) { DARABONBA_PTR_SET_RVALUE(createCommand_, createCommand) };
  ...
  protected:
    ...
    std::shared_ptr<CreateBizUnitRequestCreateCommand> createCommand_ = nullptr;
    // This parameter is required.
