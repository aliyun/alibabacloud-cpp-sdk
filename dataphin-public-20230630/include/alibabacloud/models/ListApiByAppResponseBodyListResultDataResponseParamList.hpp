...
#ifndef ALIBABACLOUD_MODELS_LISTAPIBYAPPRESPONSEBODYLISTRESULTDATARESPONSEPARAMLIST_HPP_
#define ALIBABACLOUD_MODELS_LISTAPIBYAPPRESPONSEBODYLISTRESULTDATARESPONSEPARAMLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListApiByAppResponseBodyListResultDataResponseParamList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListApiByAppResponseBodyListResultDataResponseParamList& obj) { 
    ...
    ListApiByAppResponseBodyListResultDataResponseParamList() = default ;
    ListApiByAppResponseBodyListResultDataResponseParamList(const ListApiByAppResponseBodyListResultDataResponseParamList &) = default ;
    ListApiByAppResponseBodyListResultDataResponseParamList(ListApiByAppResponseBodyListResultDataResponseParamList &&) = default ;
    ListApiByAppResponseBodyListResultDataResponseParamList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListApiByAppResponseBodyListResultDataResponseParamList() = default ;
    ListApiByAppResponseBodyListResultDataResponseParamList& operator=(const ListApiByAppResponseBodyListResultDataResponseParamList &) = default ;
    ListApiByAppResponseBodyListResultDataResponseParamList& operator=(ListApiByAppResponseBodyListResultDataResponseParamList &&) = default ;
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setDateFormat(string dateFormat) { DARABONBA_PTR_SET_VALUE(dateFormat_, dateFormat) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setDescriptionCode(string descriptionCode) { DARABONBA_PTR_SET_VALUE(descriptionCode_, descriptionCode) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setInitialValue(string initialValue) { DARABONBA_PTR_SET_VALUE(initialValue_, initialValue) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setMappingColumn(string mappingColumn) { DARABONBA_PTR_SET_VALUE(mappingColumn_, mappingColumn) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setMust(int64_t must) { DARABONBA_PTR_SET_VALUE(must_, must) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setOperator(string _operator) { DARABONBA_PTR_SET_VALUE(operator_, _operator) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setOptional(int64_t optional) { DARABONBA_PTR_SET_VALUE(optional_, optional) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setOriginalColumn(string originalColumn) { DARABONBA_PTR_SET_VALUE(originalColumn_, originalColumn) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setParamName(string paramName) { DARABONBA_PTR_SET_VALUE(paramName_, paramName) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setParamType(string paramType) { DARABONBA_PTR_SET_VALUE(paramType_, paramType) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setParameterLocation(string parameterLocation) { DARABONBA_PTR_SET_VALUE(parameterLocation_, parameterLocation) };
    ...
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setSample(string sample) { DARABONBA_PTR_SET_VALUE(sample_, sample) };
    ...
    inline const vector<Models::ListApiByAppResponseBodyListResultDataResponseParamListTableAndDsList> & tableAndDsList() const { DARABONBA_PTR_GET_CONST(tableAndDsList_, vector<Models::ListApiByAppResponseBodyListResultDataResponseParamListTableAndDsList>) };
    inline vector<Models::ListApiByAppResponseBodyListResultDataResponseParamListTableAndDsList> tableAndDsList() { DARABONBA_PTR_GET(tableAndDsList_, vector<Models::ListApiByAppResponseBodyListResultDataResponseParamListTableAndDsList>) };
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setTableAndDsList(const vector<Models::ListApiByAppResponseBodyListResultDataResponseParamListTableAndDsList> & tableAndDsList) { DARABONBA_PTR_SET_VALUE(tableAndDsList_, tableAndDsList) };
    inline ListApiByAppResponseBodyListResultDataResponseParamList& setTableAndDsList(vector<Models::ListApiByAppResponseBodyListResultDataResponseParamListTableAndDsList> && tableAndDsList) { DARABONBA_PTR_SET_RVALUE(tableAndDsList_, tableAndDsList) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<vector<Models::ListApiByAppResponseBodyListResultDataResponseParamListTableAndDsList>> tableAndDsList_ = nullptr;
  };
