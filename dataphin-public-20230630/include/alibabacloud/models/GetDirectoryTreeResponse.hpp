...
namespace Models
{
  ...
  public:
    ...
    inline const GetDirectoryTreeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDirectoryTreeResponseBody) };
    inline GetDirectoryTreeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDirectoryTreeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDirectoryTreeResponseBody> body_ {};
  };
