...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->envEnum_ != nullptr
    ...
    inline string envEnum() const { DARABONBA_PTR_GET_DEFAULT(envEnum_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> envEnum_ = nullptr;
    // This parameter is required.
