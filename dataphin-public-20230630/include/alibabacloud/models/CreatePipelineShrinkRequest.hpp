...
#ifndef ALIBABACLOUD_MODELS_CREATEPIPELINESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEPIPELINESHRINKREQUEST_HPP_
...
namespace Models
{
  class CreatePipelineShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreatePipelineShrinkRequest& obj) { 
    ...
    CreatePipelineShrinkRequest(CreatePipelineShrinkRequest &&) = default ;
    CreatePipelineShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePipelineShrinkRequest() = default ;
    CreatePipelineShrinkRequest& operator=(const CreatePipelineShrinkRequest &) = default ;
    CreatePipelineShrinkRequest& operator=(CreatePipelineShrinkRequest &&) = default ;
    ...
    inline CreatePipelineShrinkRequest& setContextShrink(string contextShrink) { DARABONBA_PTR_SET_VALUE(contextShrink_, contextShrink) };
    ...
    inline CreatePipelineShrinkRequest& setCreateCommandShrink(string createCommandShrink) { DARABONBA_PTR_SET_VALUE(createCommandShrink_, createCommandShrink) };
