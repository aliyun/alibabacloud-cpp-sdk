...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataServiceApiDocumentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataServiceApiDocumentResponseBody) };
    inline GetDataServiceApiDocumentResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataServiceApiDocumentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataServiceApiDocumentResponseBody> body_ {};
  };
