...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->bizEntityInfo_ != nullptr
    ...
    inline const GetBizEntityInfoByVersionResponseBodyBizEntityInfo & bizEntityInfo() const { DARABONBA_PTR_GET_CONST(bizEntityInfo_, GetBizEntityInfoByVersionResponseBodyBizEntityInfo) };
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfo bizEntityInfo() { DARABONBA_PTR_GET(bizEntityInfo_, GetBizEntityInfoByVersionResponseBodyBizEntityInfo) };
    inline GetBizEntityInfoByVersionResponseBody& setBizEntityInfo(const GetBizEntityInfoByVersionResponseBodyBizEntityInfo & bizEntityInfo) { DARABONBA_PTR_SET_VALUE(bizEntityInfo_, bizEntityInfo) };
    inline GetBizEntityInfoByVersionResponseBody& setBizEntityInfo(GetBizEntityInfoByVersionResponseBodyBizEntityInfo && bizEntityInfo) { DARABONBA_PTR_SET_RVALUE(bizEntityInfo_, bizEntityInfo) };
  ...
  protected:
    std::shared_ptr<GetBizEntityInfoByVersionResponseBodyBizEntityInfo> bizEntityInfo_ = nullptr;
