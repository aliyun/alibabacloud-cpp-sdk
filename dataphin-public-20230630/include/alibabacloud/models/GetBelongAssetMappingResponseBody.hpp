...
#ifndef ALIBABACLOUD_MODELS_GETBELONGASSETMAPPINGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETBELONGASSETMAPPINGRESPONSEBODY_HPP_
...
namespace Models
{
  class GetBelongAssetMappingResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetBelongAssetMappingResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetBelongAssetMappingResponseBody& obj) { 
    ...
    GetBelongAssetMappingResponseBody() = default ;
    GetBelongAssetMappingResponseBody(const GetBelongAssetMappingResponseBody &) = default ;
    GetBelongAssetMappingResponseBody(GetBelongAssetMappingResponseBody &&) = default ;
    GetBelongAssetMappingResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetBelongAssetMappingResponseBody() = default ;
    GetBelongAssetMappingResponseBody& operator=(const GetBelongAssetMappingResponseBody &) = default ;
    GetBelongAssetMappingResponseBody& operator=(GetBelongAssetMappingResponseBody &&) = default ;
    ...
    inline GetBelongAssetMappingResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetBelongAssetMappingResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline const vector<GetBelongAssetMappingResponseBody::MappingRelationList> & getMappingRelationList() const { DARABONBA_PTR_GET_CONST(mappingRelationList_, vector<GetBelongAssetMappingResponseBody::MappingRelationList>) };
    inline vector<GetBelongAssetMappingResponseBody::MappingRelationList> getMappingRelationList() { DARABONBA_PTR_GET(mappingRelationList_, vector<GetBelongAssetMappingResponseBody::MappingRelationList>) };
    inline GetBelongAssetMappingResponseBody& setMappingRelationList(const vector<GetBelongAssetMappingResponseBody::MappingRelationList> & mappingRelationList) { DARABONBA_PTR_SET_VALUE(mappingRelationList_, mappingRelationList) };
    inline GetBelongAssetMappingResponseBody& setMappingRelationList(vector<GetBelongAssetMappingResponseBody::MappingRelationList> && mappingRelationList) { DARABONBA_PTR_SET_RVALUE(mappingRelationList_, mappingRelationList) };
    ...
    inline GetBelongAssetMappingResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetBelongAssetMappingResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetBelongAssetMappingResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<int32_t> httpStatusCode_ {};
    shared_ptr<vector<GetBelongAssetMappingResponseBody::MappingRelationList>> mappingRelationList_ {};
