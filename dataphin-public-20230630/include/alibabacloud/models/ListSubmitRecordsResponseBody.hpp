...
namespace Models
{
  ...
  public:
    ...
    inline const ListSubmitRecordsResponseBodyListResult & listResult() const { DARABONBA_PTR_GET_CONST(listResult_, ListSubmitRecordsResponseBodyListResult) };
    inline ListSubmitRecordsResponseBodyListResult listResult() { DARABONBA_PTR_GET(listResult_, ListSubmitRecordsResponseBodyListResult) };
    inline ListSubmitRecordsResponseBody& setListResult(const ListSubmitRecordsResponseBodyListResult & listResult) { DARABONBA_PTR_SET_VALUE(listResult_, listResult) };
    inline ListSubmitRecordsResponseBody& setListResult(ListSubmitRecordsResponseBodyListResult && listResult) { DARABONBA_PTR_SET_RVALUE(listResult_, listResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListSubmitRecordsResponseBodyListResult> listResult_ = nullptr;
