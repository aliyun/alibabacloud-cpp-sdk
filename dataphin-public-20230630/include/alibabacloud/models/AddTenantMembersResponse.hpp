...
namespace Models
{
  ...
  public:
    ...
    inline const AddTenantMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddTenantMembersResponseBody) };
    inline AddTenantMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, AddTenantMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddTenantMembersResponseBody> body_ {};
  };
