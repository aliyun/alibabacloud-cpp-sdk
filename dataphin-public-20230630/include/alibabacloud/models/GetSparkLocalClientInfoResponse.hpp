...
namespace Models
{
  ...
  public:
    ...
    inline const GetSparkLocalClientInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSparkLocalClientInfoResponseBody) };
    inline GetSparkLocalClientInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSparkLocalClientInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSparkLocalClientInfoResponseBody> body_ {};
  };
