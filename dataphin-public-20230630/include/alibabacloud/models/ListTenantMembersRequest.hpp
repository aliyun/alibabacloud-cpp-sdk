...
namespace Models
{
  ...
  public:
    ...
    inline const ListTenantMembersRequestListQuery & listQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListTenantMembersRequestListQuery) };
    inline ListTenantMembersRequestListQuery listQuery() { DARABONBA_PTR_GET(listQuery_, ListTenantMembersRequestListQuery) };
    inline ListTenantMembersRequest& setListQuery(const ListTenantMembersRequestListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListTenantMembersRequest& setListQuery(ListTenantMembersRequestListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
  ...
  protected:
    ...
    std::shared_ptr<ListTenantMembersRequestListQuery> listQuery_ = nullptr;
    // This parameter is required.
