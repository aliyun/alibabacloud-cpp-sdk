...
namespace Models
{
  ...
  public:
    ...
    inline const GetPhysicalNodeContentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPhysicalNodeContentResponseBodyData) };
    inline GetPhysicalNodeContentResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPhysicalNodeContentResponseBodyData) };
    inline GetPhysicalNodeContentResponseBody& setData(const GetPhysicalNodeContentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPhysicalNodeContentResponseBody& setData(GetPhysicalNodeContentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetPhysicalNodeContentResponseBodyData> data_ = nullptr;
