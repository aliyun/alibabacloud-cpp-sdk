...
#ifndef ALIBABACLOUD_MODELS_SUBMITASSETSONSHELVERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SUBMITASSETSONSHELVERESPONSEBODY_HPP_
...
namespace Models
{
  class SubmitAssetsOnShelveResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const SubmitAssetsOnShelveResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SubmitAssetsOnShelveResponseBody& obj) { 
    ...
    SubmitAssetsOnShelveResponseBody() = default ;
    SubmitAssetsOnShelveResponseBody(const SubmitAssetsOnShelveResponseBody &) = default ;
    SubmitAssetsOnShelveResponseBody(SubmitAssetsOnShelveResponseBody &&) = default ;
    SubmitAssetsOnShelveResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitAssetsOnShelveResponseBody() = default ;
    SubmitAssetsOnShelveResponseBody& operator=(const SubmitAssetsOnShelveResponseBody &) = default ;
    SubmitAssetsOnShelveResponseBody& operator=(SubmitAssetsOnShelveResponseBody &&) = default ;
    ...
    inline SubmitAssetsOnShelveResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const SubmitAssetsOnShelveResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SubmitAssetsOnShelveResponseBody::Data) };
    inline SubmitAssetsOnShelveResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SubmitAssetsOnShelveResponseBody::Data) };
    inline SubmitAssetsOnShelveResponseBody& setData(const SubmitAssetsOnShelveResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitAssetsOnShelveResponseBody& setData(SubmitAssetsOnShelveResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline SubmitAssetsOnShelveResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline SubmitAssetsOnShelveResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline SubmitAssetsOnShelveResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    void deleteSuccess() { this->success_ = nullptr;};
    inline bool getSuccess() const { DARABONBA_PTR_GET_DEFAULT(success_, false) };
    inline SubmitAssetsOnShelveResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<SubmitAssetsOnShelveResponseBody::Data> data_ {};
