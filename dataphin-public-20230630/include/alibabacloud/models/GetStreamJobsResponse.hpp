...
namespace Models
{
  ...
  public:
    ...
    inline const GetStreamJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetStreamJobsResponseBody) };
    inline GetStreamJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetStreamJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetStreamJobsResponseBody> body_ {};
  };
