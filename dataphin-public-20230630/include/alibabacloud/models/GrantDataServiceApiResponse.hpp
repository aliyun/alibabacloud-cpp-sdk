...
namespace Models
{
  ...
  public:
    ...
    inline const GrantDataServiceApiResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GrantDataServiceApiResponseBody) };
    inline GrantDataServiceApiResponseBody getBody() { DARABONBA_PTR_GET(body_, GrantDataServiceApiResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GrantDataServiceApiResponseBody> body_ {};
  };
