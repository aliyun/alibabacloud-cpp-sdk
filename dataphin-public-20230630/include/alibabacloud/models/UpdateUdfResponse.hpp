...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateUdfResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateUdfResponseBody) };
    inline UpdateUdfResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateUdfResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateUdfResponseBody> body_ {};
  };
