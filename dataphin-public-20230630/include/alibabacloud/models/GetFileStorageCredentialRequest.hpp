...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->opTenantId_ == nullptr
        && this->opUserId_ == nullptr && this->projectId_ == nullptr && this->purpose_ == nullptr && this->useVpcEndpoint_ == nullptr; };
    ...
    inline GetFileStorageCredentialRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline bool getUseVpcEndpoint() const { DARABONBA_PTR_GET_DEFAULT(useVpcEndpoint_, false) };
