...
namespace Models
{
  ...
  public:
    ...
    inline const GetUdfResponseBodyUdfInfo & udfInfo() const { DARABONBA_PTR_GET_CONST(udfInfo_, GetUdfResponseBodyUdfInfo) };
    inline GetUdfResponseBodyUdfInfo udfInfo() { DARABONBA_PTR_GET(udfInfo_, GetUdfResponseBodyUdfInfo) };
    inline GetUdfResponseBody& setUdfInfo(const GetUdfResponseBodyUdfInfo & udfInfo) { DARABONBA_PTR_SET_VALUE(udfInfo_, udfInfo) };
    inline GetUdfResponseBody& setUdfInfo(GetUdfResponseBodyUdfInfo && udfInfo) { DARABONBA_PTR_SET_RVALUE(udfInfo_, udfInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetUdfResponseBodyUdfInfo> udfInfo_ = nullptr;
  };
