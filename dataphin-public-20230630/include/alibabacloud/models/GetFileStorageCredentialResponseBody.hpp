...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->storageCredential_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetFileStorageCredentialResponseBodyStorageCredential & storageCredential() const { DARABONBA_PTR_GET_CONST(storageCredential_, GetFileStorageCredentialResponseBodyStorageCredential) };
    inline GetFileStorageCredentialResponseBodyStorageCredential storageCredential() { DARABONBA_PTR_GET(storageCredential_, GetFileStorageCredentialResponseBodyStorageCredential) };
    inline GetFileStorageCredentialResponseBody& setStorageCredential(const GetFileStorageCredentialResponseBodyStorageCredential & storageCredential) { DARABONBA_PTR_SET_VALUE(storageCredential_, storageCredential) };
    inline GetFileStorageCredentialResponseBody& setStorageCredential(GetFileStorageCredentialResponseBodyStorageCredential && storageCredential) { DARABONBA_PTR_SET_RVALUE(storageCredential_, storageCredential) };
  ...
  protected:
    ...
    std::shared_ptr<GetFileStorageCredentialResponseBodyStorageCredential> storageCredential_ = nullptr;
