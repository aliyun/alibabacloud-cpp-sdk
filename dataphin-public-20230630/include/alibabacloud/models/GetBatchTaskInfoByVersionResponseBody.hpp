...
namespace Models
{
  ...
  public:
    ...
    inline const GetBatchTaskInfoByVersionResponseBodyTaskInfo & taskInfo() const { DARABONBA_PTR_GET_CONST(taskInfo_, GetBatchTaskInfoByVersionResponseBodyTaskInfo) };
    inline GetBatchTaskInfoByVersionResponseBodyTaskInfo taskInfo() { DARABONBA_PTR_GET(taskInfo_, GetBatchTaskInfoByVersionResponseBodyTaskInfo) };
    inline GetBatchTaskInfoByVersionResponseBody& setTaskInfo(const GetBatchTaskInfoByVersionResponseBodyTaskInfo & taskInfo) { DARABONBA_PTR_SET_VALUE(taskInfo_, taskInfo) };
    inline GetBatchTaskInfoByVersionResponseBody& setTaskInfo(GetBatchTaskInfoByVersionResponseBodyTaskInfo && taskInfo) { DARABONBA_PTR_SET_RVALUE(taskInfo_, taskInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetBatchTaskInfoByVersionResponseBodyTaskInfo> taskInfo_ = nullptr;
  };
