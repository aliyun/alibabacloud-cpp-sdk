...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->asyncId_ == nullptr
        && this->context_ == nullptr && this->opTenantId_ == nullptr && this->opUserId_ == nullptr; };
    ...
    inline GetPipelineAsyncResultRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
