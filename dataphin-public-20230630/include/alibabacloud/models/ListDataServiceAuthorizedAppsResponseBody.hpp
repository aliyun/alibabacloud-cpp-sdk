...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceAuthorizedAppsResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListDataServiceAuthorizedAppsResponseBodyPageResult) };
    inline ListDataServiceAuthorizedAppsResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListDataServiceAuthorizedAppsResponseBodyPageResult) };
    inline ListDataServiceAuthorizedAppsResponseBody& setPageResult(const ListDataServiceAuthorizedAppsResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListDataServiceAuthorizedAppsResponseBody& setPageResult(ListDataServiceAuthorizedAppsResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataServiceAuthorizedAppsResponseBodyPageResult> pageResult_ = nullptr;
    // Id of the request
