...
namespace Models
{
  ...
  public:
    ...
    inline const GetTransferInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTransferInfoResponseBodyData) };
    inline GetTransferInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTransferInfoResponseBodyData) };
    inline GetTransferInfoResponseBody& setData(const GetTransferInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTransferInfoResponseBody& setData(GetTransferInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetTransferInfoResponseBodyData> data_ = nullptr;
