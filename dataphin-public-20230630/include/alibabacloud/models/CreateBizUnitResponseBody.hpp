...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBizUnitResponseBodyCreateResult & createResult() const { DARABONBA_PTR_GET_CONST(createResult_, CreateBizUnitResponseBodyCreateResult) };
    inline CreateBizUnitResponseBodyCreateResult createResult() { DARABONBA_PTR_GET(createResult_, CreateBizUnitResponseBodyCreateResult) };
    inline CreateBizUnitResponseBody& setCreateResult(const CreateBizUnitResponseBodyCreateResult & createResult) { DARABONBA_PTR_SET_VALUE(createResult_, createResult) };
    inline CreateBizUnitResponseBody& setCreateResult(CreateBizUnitResponseBodyCreateResult && createResult) { DARABONBA_PTR_SET_RVALUE(createResult_, createResult) };
  ...
  protected:
    ...
    std::shared_ptr<CreateBizUnitResponseBodyCreateResult> createResult_ = nullptr;
