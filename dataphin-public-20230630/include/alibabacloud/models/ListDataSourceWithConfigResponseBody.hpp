...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataSourceWithConfigResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListDataSourceWithConfigResponseBodyPageResult) };
    inline ListDataSourceWithConfigResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListDataSourceWithConfigResponseBodyPageResult) };
    inline ListDataSourceWithConfigResponseBody& setPageResult(const ListDataSourceWithConfigResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListDataSourceWithConfigResponseBody& setPageResult(ListDataSourceWithConfigResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataSourceWithConfigResponseBodyPageResult> pageResult_ = nullptr;
