...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodeDownStreamRequestListQuery & listQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListNodeDownStreamRequestListQuery) };
    inline ListNodeDownStreamRequestListQuery listQuery() { DARABONBA_PTR_GET(listQuery_, ListNodeDownStreamRequestListQuery) };
    inline ListNodeDownStreamRequest& setListQuery(const ListNodeDownStreamRequestListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListNodeDownStreamRequest& setListQuery(ListNodeDownStreamRequestListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
  ...
  protected:
    ...
    std::shared_ptr<ListNodeDownStreamRequestListQuery> listQuery_ = nullptr;
    // This parameter is required.
