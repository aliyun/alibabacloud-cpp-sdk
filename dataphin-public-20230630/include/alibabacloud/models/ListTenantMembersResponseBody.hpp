...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListTenantMembersResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListTenantMembersResponseBody& obj) { 
    ...
    ListTenantMembersResponseBody() = default ;
    ListTenantMembersResponseBody(const ListTenantMembersResponseBody &) = default ;
    ListTenantMembersResponseBody(ListTenantMembersResponseBody &&) = default ;
    ListTenantMembersResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListTenantMembersResponseBody() = default ;
    ListTenantMembersResponseBody& operator=(const ListTenantMembersResponseBody &) = default ;
    ListTenantMembersResponseBody& operator=(ListTenantMembersResponseBody &&) = default ;
