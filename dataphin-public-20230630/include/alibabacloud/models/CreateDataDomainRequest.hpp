...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataDomainRequestCreateCommand & createCommand() const { DARABONBA_PTR_GET_CONST(createCommand_, CreateDataDomainRequestCreateCommand) };
    inline CreateDataDomainRequestCreateCommand createCommand() { DARABONBA_PTR_GET(createCommand_, CreateDataDomainRequestCreateCommand) };
    inline CreateDataDomainRequest& setCreateCommand(const CreateDataDomainRequestCreateCommand & createCommand) { DARABONBA_PTR_SET_VALUE(createCommand_, createCommand) };
    inline CreateDataDomainRequest& setCreateCommand(CreateDataDomainRequestCreateCommand && createCommand) { DARABONBA_PTR_SET_RVALUE(createCommand_, createCommand) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDataDomainRequestCreateCommand> createCommand_ = nullptr;
    // This parameter is required.
