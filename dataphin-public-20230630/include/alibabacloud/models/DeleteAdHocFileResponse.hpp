...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAdHocFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAdHocFileResponseBody) };
    inline DeleteAdHocFileResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAdHocFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAdHocFileResponseBody> body_ {};
  };
