...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->instanceRelationList_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<GetInstanceDownStreamResponseBodyInstanceRelationList> & instanceRelationList() const { DARABONBA_PTR_GET_CONST(instanceRelationList_, vector<GetInstanceDownStreamResponseBodyInstanceRelationList>) };
    inline vector<GetInstanceDownStreamResponseBodyInstanceRelationList> instanceRelationList() { DARABONBA_PTR_GET(instanceRelationList_, vector<GetInstanceDownStreamResponseBodyInstanceRelationList>) };
    inline GetInstanceDownStreamResponseBody& setInstanceRelationList(const vector<GetInstanceDownStreamResponseBodyInstanceRelationList> & instanceRelationList) { DARABONBA_PTR_SET_VALUE(instanceRelationList_, instanceRelationList) };
    inline GetInstanceDownStreamResponseBody& setInstanceRelationList(vector<GetInstanceDownStreamResponseBodyInstanceRelationList> && instanceRelationList) { DARABONBA_PTR_SET_RVALUE(instanceRelationList_, instanceRelationList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetInstanceDownStreamResponseBodyInstanceRelationList>> instanceRelationList_ = nullptr;
