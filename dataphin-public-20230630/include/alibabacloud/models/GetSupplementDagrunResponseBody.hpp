...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->dagrunList_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<GetSupplementDagrunResponseBodyDagrunList> & dagrunList() const { DARABONBA_PTR_GET_CONST(dagrunList_, vector<GetSupplementDagrunResponseBodyDagrunList>) };
    inline vector<GetSupplementDagrunResponseBodyDagrunList> dagrunList() { DARABONBA_PTR_GET(dagrunList_, vector<GetSupplementDagrunResponseBodyDagrunList>) };
    inline GetSupplementDagrunResponseBody& setDagrunList(const vector<GetSupplementDagrunResponseBodyDagrunList> & dagrunList) { DARABONBA_PTR_SET_VALUE(dagrunList_, dagrunList) };
    inline GetSupplementDagrunResponseBody& setDagrunList(vector<GetSupplementDagrunResponseBodyDagrunList> && dagrunList) { DARABONBA_PTR_SET_RVALUE(dagrunList_, dagrunList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetSupplementDagrunResponseBodyDagrunList>> dagrunList_ = nullptr;
