...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->devDataSourceId_ == nullptr
      ...
      inline int64_t getDevDataSourceId() const { DARABONBA_PTR_GET_DEFAULT(devDataSourceId_, 0L) };
      inline CreateResult& setDevDataSourceId(int64_t devDataSourceId) { DARABONBA_PTR_SET_VALUE(devDataSourceId_, devDataSourceId) };
      ...
      inline CreateResult& setProdDataSourceId(int64_t prodDataSourceId) { DARABONBA_PTR_SET_VALUE(prodDataSourceId_, prodDataSourceId) };
    ...
    inline const CreateDataSourceResponseBody::CreateResult & getCreateResult() const { DARABONBA_PTR_GET_CONST(createResult_, CreateDataSourceResponseBody::CreateResult) };
    inline CreateDataSourceResponseBody::CreateResult getCreateResult() { DARABONBA_PTR_GET(createResult_, CreateDataSourceResponseBody::CreateResult) };
    inline CreateDataSourceResponseBody& setCreateResult(const CreateDataSourceResponseBody::CreateResult & createResult) { DARABONBA_PTR_SET_VALUE(createResult_, createResult) };
    inline CreateDataSourceResponseBody& setCreateResult(CreateDataSourceResponseBody::CreateResult && createResult) { DARABONBA_PTR_SET_RVALUE(createResult_, createResult) };
