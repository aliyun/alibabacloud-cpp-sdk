...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataServiceAuthorizedAppsByGroupIdResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetDataServiceAuthorizedAppsByGroupIdResponseBody) };
    inline GetDataServiceAuthorizedAppsByGroupIdResponseBody body() { DARABONBA_PTR_GET(body_, GetDataServiceAuthorizedAppsByGroupIdResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataServiceAuthorizedAppsByGroupIdResponseBody> body_ = nullptr;
  };
