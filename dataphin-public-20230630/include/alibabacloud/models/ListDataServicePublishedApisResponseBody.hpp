...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServicePublishedApisResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListDataServicePublishedApisResponseBodyPageResult) };
    inline ListDataServicePublishedApisResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListDataServicePublishedApisResponseBodyPageResult) };
    inline ListDataServicePublishedApisResponseBody& setPageResult(const ListDataServicePublishedApisResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListDataServicePublishedApisResponseBody& setPageResult(ListDataServicePublishedApisResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataServicePublishedApisResponseBodyPageResult> pageResult_ = nullptr;
    // Id of the request
