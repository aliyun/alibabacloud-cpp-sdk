...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->downStreamDepth_ == nullptr
        && this->env_ == nullptr && this->instanceGetShrink_ == nullptr && this->opTenantId_ == nullptr && this->opUserId_ == nullptr && this->runStatus_ == nullptr; };
    ...
    inline GetInstanceDownStreamShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
