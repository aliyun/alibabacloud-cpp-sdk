...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->user_ == nullptr; };
    ...
    inline const GetUserBySourceIdResponseBodyUser & user() const { DARABONBA_PTR_GET_CONST(user_, GetUserBySourceIdResponseBodyUser) };
    inline GetUserBySourceIdResponseBodyUser user() { DARABONBA_PTR_GET(user_, GetUserBySourceIdResponseBodyUser) };
    inline GetUserBySourceIdResponseBody& setUser(const GetUserBySourceIdResponseBodyUser & user) { DARABONBA_PTR_SET_VALUE(user_, user) };
    inline GetUserBySourceIdResponseBody& setUser(GetUserBySourceIdResponseBodyUser && user) { DARABONBA_PTR_SET_RVALUE(user_, user) };
  ...
  protected:
    ...
    std::shared_ptr<GetUserBySourceIdResponseBodyUser> user_ = nullptr;
  };
