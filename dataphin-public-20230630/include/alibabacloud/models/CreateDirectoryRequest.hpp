...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDirectoryRequestCreateCommand & createCommand() const { DARABONBA_PTR_GET_CONST(createCommand_, CreateDirectoryRequestCreateCommand) };
    inline CreateDirectoryRequestCreateCommand createCommand() { DARABONBA_PTR_GET(createCommand_, CreateDirectoryRequestCreateCommand) };
    inline CreateDirectoryRequest& setCreateCommand(const CreateDirectoryRequestCreateCommand & createCommand) { DARABONBA_PTR_SET_VALUE(createCommand_, createCommand) };
    inline CreateDirectoryRequest& setCreateCommand(CreateDirectoryRequestCreateCommand && createCommand) { DARABONBA_PTR_SET_RVALUE(createCommand_, createCommand) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDirectoryRequestCreateCommand> createCommand_ = nullptr;
    // This parameter is required.
