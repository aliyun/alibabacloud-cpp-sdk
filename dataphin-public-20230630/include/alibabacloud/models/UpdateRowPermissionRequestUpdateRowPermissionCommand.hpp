...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->mappingColumns_ == nullptr
        && return this->rowPermissionDesc_ == nullptr && return this->rowPermissionId_ == nullptr && return this->rowPermissionName_ == nullptr && return this->rules_ == nullptr && return this->tables_ == nullptr; };
