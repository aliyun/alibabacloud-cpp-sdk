...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->computeSourceInfo_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetComputeSourceResponseBodyComputeSourceInfo & computeSourceInfo() const { DARABONBA_PTR_GET_CONST(computeSourceInfo_, GetComputeSourceResponseBodyComputeSourceInfo) };
    inline GetComputeSourceResponseBodyComputeSourceInfo computeSourceInfo() { DARABONBA_PTR_GET(computeSourceInfo_, GetComputeSourceResponseBodyComputeSourceInfo) };
    inline GetComputeSourceResponseBody& setComputeSourceInfo(const GetComputeSourceResponseBodyComputeSourceInfo & computeSourceInfo) { DARABONBA_PTR_SET_VALUE(computeSourceInfo_, computeSourceInfo) };
    inline GetComputeSourceResponseBody& setComputeSourceInfo(GetComputeSourceResponseBodyComputeSourceInfo && computeSourceInfo) { DARABONBA_PTR_SET_RVALUE(computeSourceInfo_, computeSourceInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetComputeSourceResponseBodyComputeSourceInfo> computeSourceInfo_ = nullptr;
