...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->appGroupList_ != nullptr
    ...
    inline const vector<GetDataServiceAppGroupsResponseBodyAppGroupList> & appGroupList() const { DARABONBA_PTR_GET_CONST(appGroupList_, vector<GetDataServiceAppGroupsResponseBodyAppGroupList>) };
    inline vector<GetDataServiceAppGroupsResponseBodyAppGroupList> appGroupList() { DARABONBA_PTR_GET(appGroupList_, vector<GetDataServiceAppGroupsResponseBodyAppGroupList>) };
    inline GetDataServiceAppGroupsResponseBody& setAppGroupList(const vector<GetDataServiceAppGroupsResponseBodyAppGroupList> & appGroupList) { DARABONBA_PTR_SET_VALUE(appGroupList_, appGroupList) };
    inline GetDataServiceAppGroupsResponseBody& setAppGroupList(vector<GetDataServiceAppGroupsResponseBodyAppGroupList> && appGroupList) { DARABONBA_PTR_SET_RVALUE(appGroupList_, appGroupList) };
  ...
  protected:
    std::shared_ptr<vector<GetDataServiceAppGroupsResponseBodyAppGroupList>> appGroupList_ = nullptr;
