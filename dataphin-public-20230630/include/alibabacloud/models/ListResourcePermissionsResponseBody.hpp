...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourcePermissionsResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListResourcePermissionsResponseBodyPageResult) };
    inline ListResourcePermissionsResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListResourcePermissionsResponseBodyPageResult) };
    inline ListResourcePermissionsResponseBody& setPageResult(const ListResourcePermissionsResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListResourcePermissionsResponseBody& setPageResult(ListResourcePermissionsResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListResourcePermissionsResponseBodyPageResult> pageResult_ = nullptr;
