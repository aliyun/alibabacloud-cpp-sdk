...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetStreamJobsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetStreamJobsResponseBodyData>) };
    inline vector<GetStreamJobsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetStreamJobsResponseBodyData>) };
    inline GetStreamJobsResponseBody& setData(const vector<GetStreamJobsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetStreamJobsResponseBody& setData(vector<GetStreamJobsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetStreamJobsResponseBodyData>> data_ = nullptr;
