...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePipelineResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdatePipelineResponseBody::Data) };
    inline UpdatePipelineResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdatePipelineResponseBody::Data) };
    inline UpdatePipelineResponseBody& setData(const UpdatePipelineResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdatePipelineResponseBody& setData(UpdatePipelineResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
