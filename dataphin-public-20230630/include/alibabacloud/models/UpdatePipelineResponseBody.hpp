...
#include <alibabacloud/models/UpdatePipelineResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline UpdatePipelineResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const UpdatePipelineResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdatePipelineResponseBodyData) };
    inline UpdatePipelineResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdatePipelineResponseBodyData) };
    inline UpdatePipelineResponseBody& setData(const UpdatePipelineResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdatePipelineResponseBody& setData(UpdatePipelineResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdatePipelineResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UpdatePipelineResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdatePipelineResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    std::shared_ptr<string> code_ = nullptr;
    std::shared_ptr<UpdatePipelineResponseBodyData> data_ = nullptr;
