...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataDomainResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateDataDomainResponseBody) };
    inline CreateDataDomainResponseBody body() { DARABONBA_PTR_GET(body_, CreateDataDomainResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDataDomainResponseBody> body_ = nullptr;
  };
