...
namespace Models
{
  ...
  public:
    ...
    inline const CreateComputeSourceResponseBody::CreateResult & getCreateResult() const { DARABONBA_PTR_GET_CONST(createResult_, CreateComputeSourceResponseBody::CreateResult) };
    inline CreateComputeSourceResponseBody::CreateResult getCreateResult() { DARABONBA_PTR_GET(createResult_, CreateComputeSourceResponseBody::CreateResult) };
    inline CreateComputeSourceResponseBody& setCreateResult(const CreateComputeSourceResponseBody::CreateResult & createResult) { DARABONBA_PTR_SET_VALUE(createResult_, createResult) };
    inline CreateComputeSourceResponseBody& setCreateResult(CreateComputeSourceResponseBody::CreateResult && createResult) { DARABONBA_PTR_SET_RVALUE(createResult_, createResult) };
  ...
  protected:
    ...
    shared_ptr<CreateComputeSourceResponseBody::CreateResult> createResult_ {};
