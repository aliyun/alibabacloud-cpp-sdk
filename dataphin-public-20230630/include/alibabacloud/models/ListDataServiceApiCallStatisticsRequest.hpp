  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->endTime_ == nullptr
        && this->keyword_ == nullptr && this->orderColumn_ == nullptr && this->orderType_ == nullptr && this->pageNo_ == nullptr && this->pageSize_ == nullptr
    ...
    inline const ListDataServiceApiCallStatisticsRequest::ListQuery & getListQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListDataServiceApiCallStatisticsRequest::ListQuery) };
    inline ListDataServiceApiCallStatisticsRequest::ListQuery getListQuery() { DARABONBA_PTR_GET(listQuery_, ListDataServiceApiCallStatisticsRequest::ListQuery) };
    inline ListDataServiceApiCallStatisticsRequest& setListQuery(const ListDataServiceApiCallStatisticsRequest::ListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListDataServiceApiCallStatisticsRequest& setListQuery(ListDataServiceApiCallStatisticsRequest::ListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
    ...
    inline ListDataServiceApiCallStatisticsRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
