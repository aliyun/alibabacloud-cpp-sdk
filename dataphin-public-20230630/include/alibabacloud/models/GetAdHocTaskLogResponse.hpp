...
namespace Models
{
  ...
  public:
    ...
    inline const GetAdHocTaskLogResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAdHocTaskLogResponseBody) };
    inline GetAdHocTaskLogResponseBody body() { DARABONBA_PTR_GET(body_, GetAdHocTaskLogResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAdHocTaskLogResponseBody> body_ = nullptr;
  };
