...
namespace Models
{
  ...
  public:
    ...
    inline const GetBatchTaskUdfLineagesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetBatchTaskUdfLineagesResponseBody) };
    inline GetBatchTaskUdfLineagesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetBatchTaskUdfLineagesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetBatchTaskUdfLineagesResponseBody> body_ {};
  };
