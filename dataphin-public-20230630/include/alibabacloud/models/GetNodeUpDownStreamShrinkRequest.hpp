...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->downStreamDepth_ == nullptr
        && this->env_ == nullptr && this->nodeIdShrink_ == nullptr && this->opTenantId_ == nullptr && this->opUserId_ == nullptr && this->projectId_ == nullptr
    ...
    inline string getNodeIdShrink() const { DARABONBA_PTR_GET_DEFAULT(nodeIdShrink_, "") };
    ...
    inline GetNodeUpDownStreamShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
  ...
  protected:
    ...
    shared_ptr<string> nodeIdShrink_ {};
    // The tenant ID.
    // 
    // This parameter is required.
