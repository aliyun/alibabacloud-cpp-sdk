...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataServiceApiDocumentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDataServiceApiDocumentResponseBodyData) };
    inline GetDataServiceApiDocumentResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDataServiceApiDocumentResponseBodyData) };
    inline GetDataServiceApiDocumentResponseBody& setData(const GetDataServiceApiDocumentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataServiceApiDocumentResponseBody& setData(GetDataServiceApiDocumentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataServiceApiDocumentResponseBodyData> data_ = nullptr;
