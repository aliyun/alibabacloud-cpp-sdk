...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataDomainsRequestListQuery & listQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListDataDomainsRequestListQuery) };
    inline ListDataDomainsRequestListQuery listQuery() { DARABONBA_PTR_GET(listQuery_, ListDataDomainsRequestListQuery) };
    inline ListDataDomainsRequest& setListQuery(const ListDataDomainsRequestListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListDataDomainsRequest& setListQuery(ListDataDomainsRequestListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataDomainsRequestListQuery> listQuery_ = nullptr;
    // This parameter is required.
