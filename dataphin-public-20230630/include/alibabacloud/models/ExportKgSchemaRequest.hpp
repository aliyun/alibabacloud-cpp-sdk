...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->opTenantId_ == nullptr
        && this->opUserId_ == nullptr && this->outputFormat_ == nullptr && this->versionId_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline ExportKgSchemaRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
