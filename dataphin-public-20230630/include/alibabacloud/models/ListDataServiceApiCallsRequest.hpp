...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceApiCallsRequestListQuery & listQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListDataServiceApiCallsRequestListQuery) };
    inline ListDataServiceApiCallsRequestListQuery listQuery() { DARABONBA_PTR_GET(listQuery_, ListDataServiceApiCallsRequestListQuery) };
    inline ListDataServiceApiCallsRequest& setListQuery(const ListDataServiceApiCallsRequestListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListDataServiceApiCallsRequest& setListQuery(ListDataServiceApiCallsRequestListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataServiceApiCallsRequestListQuery> listQuery_ = nullptr;
    // This parameter is required.
