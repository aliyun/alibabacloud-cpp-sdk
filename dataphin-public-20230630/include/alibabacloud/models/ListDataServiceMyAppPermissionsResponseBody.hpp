...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceMyAppPermissionsResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListDataServiceMyAppPermissionsResponseBodyPageResult) };
    inline ListDataServiceMyAppPermissionsResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListDataServiceMyAppPermissionsResponseBodyPageResult) };
    inline ListDataServiceMyAppPermissionsResponseBody& setPageResult(const ListDataServiceMyAppPermissionsResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListDataServiceMyAppPermissionsResponseBody& setPageResult(ListDataServiceMyAppPermissionsResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataServiceMyAppPermissionsResponseBodyPageResult> pageResult_ = nullptr;
    // Id of the request
