...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->instanceDagInfo_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetInstanceUpDownStreamResponseBodyInstanceDagInfo & instanceDagInfo() const { DARABONBA_PTR_GET_CONST(instanceDagInfo_, GetInstanceUpDownStreamResponseBodyInstanceDagInfo) };
    inline GetInstanceUpDownStreamResponseBodyInstanceDagInfo instanceDagInfo() { DARABONBA_PTR_GET(instanceDagInfo_, GetInstanceUpDownStreamResponseBodyInstanceDagInfo) };
    inline GetInstanceUpDownStreamResponseBody& setInstanceDagInfo(const GetInstanceUpDownStreamResponseBodyInstanceDagInfo & instanceDagInfo) { DARABONBA_PTR_SET_VALUE(instanceDagInfo_, instanceDagInfo) };
    inline GetInstanceUpDownStreamResponseBody& setInstanceDagInfo(GetInstanceUpDownStreamResponseBodyInstanceDagInfo && instanceDagInfo) { DARABONBA_PTR_SET_RVALUE(instanceDagInfo_, instanceDagInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetInstanceUpDownStreamResponseBodyInstanceDagInfo> instanceDagInfo_ = nullptr;
