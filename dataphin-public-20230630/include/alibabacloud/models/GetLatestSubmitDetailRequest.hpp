...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->opTenantId_ == nullptr
        && return this->submitDetailQuery_ == nullptr; };
    ...
    inline const GetLatestSubmitDetailRequestSubmitDetailQuery & submitDetailQuery() const { DARABONBA_PTR_GET_CONST(submitDetailQuery_, GetLatestSubmitDetailRequestSubmitDetailQuery) };
    inline GetLatestSubmitDetailRequestSubmitDetailQuery submitDetailQuery() { DARABONBA_PTR_GET(submitDetailQuery_, GetLatestSubmitDetailRequestSubmitDetailQuery) };
    inline GetLatestSubmitDetailRequest& setSubmitDetailQuery(const GetLatestSubmitDetailRequestSubmitDetailQuery & submitDetailQuery) { DARABONBA_PTR_SET_VALUE(submitDetailQuery_, submitDetailQuery) };
    inline GetLatestSubmitDetailRequest& setSubmitDetailQuery(GetLatestSubmitDetailRequestSubmitDetailQuery && submitDetailQuery) { DARABONBA_PTR_SET_RVALUE(submitDetailQuery_, submitDetailQuery) };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<GetLatestSubmitDetailRequestSubmitDetailQuery> submitDetailQuery_ = nullptr;
  };
