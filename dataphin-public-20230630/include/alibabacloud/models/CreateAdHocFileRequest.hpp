...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAdHocFileRequestCreateCommand & createCommand() const { DARABONBA_PTR_GET_CONST(createCommand_, CreateAdHocFileRequestCreateCommand) };
    inline CreateAdHocFileRequestCreateCommand createCommand() { DARABONBA_PTR_GET(createCommand_, CreateAdHocFileRequestCreateCommand) };
    inline CreateAdHocFileRequest& setCreateCommand(const CreateAdHocFileRequestCreateCommand & createCommand) { DARABONBA_PTR_SET_VALUE(createCommand_, createCommand) };
    inline CreateAdHocFileRequest& setCreateCommand(CreateAdHocFileRequestCreateCommand && createCommand) { DARABONBA_PTR_SET_RVALUE(createCommand_, createCommand) };
  ...
  protected:
    ...
    std::shared_ptr<CreateAdHocFileRequestCreateCommand> createCommand_ = nullptr;
    // This parameter is required.
