...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceMyAppPermissionsRequestListQuery & listQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListDataServiceMyAppPermissionsRequestListQuery) };
    inline ListDataServiceMyAppPermissionsRequestListQuery listQuery() { DARABONBA_PTR_GET(listQuery_, ListDataServiceMyAppPermissionsRequestListQuery) };
    inline ListDataServiceMyAppPermissionsRequest& setListQuery(const ListDataServiceMyAppPermissionsRequestListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListDataServiceMyAppPermissionsRequest& setListQuery(ListDataServiceMyAppPermissionsRequestListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataServiceMyAppPermissionsRequestListQuery> listQuery_ = nullptr;
    // This parameter is required.
