...
namespace Models
{
  ...
  public:
    ...
    inline const GetBizEntityInfoByVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetBizEntityInfoByVersionResponseBody) };
    inline GetBizEntityInfoByVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetBizEntityInfoByVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetBizEntityInfoByVersionResponseBody> body_ {};
  };
