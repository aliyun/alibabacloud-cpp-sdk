...
#ifndef ALIBABACLOUD_MODELS_UPDATEBATCHTASKREQUESTUPDATECOMMANDUPSTREAMLIST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEBATCHTASKREQUESTUPDATECOMMANDUPSTREAMLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateBatchTaskRequestUpdateCommandUpStreamList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateBatchTaskRequestUpdateCommandUpStreamList& obj) { 
    ...
    UpdateBatchTaskRequestUpdateCommandUpStreamList() = default ;
    UpdateBatchTaskRequestUpdateCommandUpStreamList(const UpdateBatchTaskRequestUpdateCommandUpStreamList &) = default ;
    UpdateBatchTaskRequestUpdateCommandUpStreamList(UpdateBatchTaskRequestUpdateCommandUpStreamList &&) = default ;
    UpdateBatchTaskRequestUpdateCommandUpStreamList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateBatchTaskRequestUpdateCommandUpStreamList() = default ;
    UpdateBatchTaskRequestUpdateCommandUpStreamList& operator=(const UpdateBatchTaskRequestUpdateCommandUpStreamList &) = default ;
    UpdateBatchTaskRequestUpdateCommandUpStreamList& operator=(UpdateBatchTaskRequestUpdateCommandUpStreamList &&) = default ;
    ...
    inline const Models::UpdateBatchTaskRequestUpdateCommandUpStreamListDependPeriod & dependPeriod() const { DARABONBA_PTR_GET_CONST(dependPeriod_, Models::UpdateBatchTaskRequestUpdateCommandUpStreamListDependPeriod) };
    inline Models::UpdateBatchTaskRequestUpdateCommandUpStreamListDependPeriod dependPeriod() { DARABONBA_PTR_GET(dependPeriod_, Models::UpdateBatchTaskRequestUpdateCommandUpStreamListDependPeriod) };
    inline UpdateBatchTaskRequestUpdateCommandUpStreamList& setDependPeriod(const Models::UpdateBatchTaskRequestUpdateCommandUpStreamListDependPeriod & dependPeriod) { DARABONBA_PTR_SET_VALUE(dependPeriod_, dependPeriod) };
    inline UpdateBatchTaskRequestUpdateCommandUpStreamList& setDependPeriod(Models::UpdateBatchTaskRequestUpdateCommandUpStreamListDependPeriod && dependPeriod) { DARABONBA_PTR_SET_RVALUE(dependPeriod_, dependPeriod) };
    ...
    inline UpdateBatchTaskRequestUpdateCommandUpStreamList& setDependStrategy(string dependStrategy) { DARABONBA_PTR_SET_VALUE(dependStrategy_, dependStrategy) };
    ...
    inline UpdateBatchTaskRequestUpdateCommandUpStreamList& setFieldList(const vector<string> & fieldList) { DARABONBA_PTR_SET_VALUE(fieldList_, fieldList) };
    inline UpdateBatchTaskRequestUpdateCommandUpStreamList& setFieldList(vector<string> && fieldList) { DARABONBA_PTR_SET_RVALUE(fieldList_, fieldList) };
    ...
    inline UpdateBatchTaskRequestUpdateCommandUpStreamList& setNodeType(string nodeType) { DARABONBA_PTR_SET_VALUE(nodeType_, nodeType) };
    ...
    inline UpdateBatchTaskRequestUpdateCommandUpStreamList& setPeriodDiff(int32_t periodDiff) { DARABONBA_PTR_SET_VALUE(periodDiff_, periodDiff) };
    ...
    inline UpdateBatchTaskRequestUpdateCommandUpStreamList& setSourceNodeEnabled(bool sourceNodeEnabled) { DARABONBA_PTR_SET_VALUE(sourceNodeEnabled_, sourceNodeEnabled) };
    ...
    inline UpdateBatchTaskRequestUpdateCommandUpStreamList& setSourceNodeId(string sourceNodeId) { DARABONBA_PTR_SET_VALUE(sourceNodeId_, sourceNodeId) };
    ...
    inline UpdateBatchTaskRequestUpdateCommandUpStreamList& setSourceNodeOutputName(string sourceNodeOutputName) { DARABONBA_PTR_SET_VALUE(sourceNodeOutputName_, sourceNodeOutputName) };
    ...
    inline UpdateBatchTaskRequestUpdateCommandUpStreamList& setSourceTableName(string sourceTableName) { DARABONBA_PTR_SET_VALUE(sourceTableName_, sourceTableName) };


  protected:
    std::shared_ptr<Models::UpdateBatchTaskRequestUpdateCommandUpStreamListDependPeriod> dependPeriod_ = nullptr;
