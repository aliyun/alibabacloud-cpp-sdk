...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDataDomainRequestUpdateCommand & updateCommand() const { DARABONBA_PTR_GET_CONST(updateCommand_, UpdateDataDomainRequestUpdateCommand) };
    inline UpdateDataDomainRequestUpdateCommand updateCommand() { DARABONBA_PTR_GET(updateCommand_, UpdateDataDomainRequestUpdateCommand) };
    inline UpdateDataDomainRequest& setUpdateCommand(const UpdateDataDomainRequestUpdateCommand & updateCommand) { DARABONBA_PTR_SET_VALUE(updateCommand_, updateCommand) };
    inline UpdateDataDomainRequest& setUpdateCommand(UpdateDataDomainRequestUpdateCommand && updateCommand) { DARABONBA_PTR_SET_RVALUE(updateCommand_, updateCommand) };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<UpdateDataDomainRequestUpdateCommand> updateCommand_ = nullptr;
  };
