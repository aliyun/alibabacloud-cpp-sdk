...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->entityType_ == nullptr
        && this->listQueryShrink_ == nullptr && this->opTenantId_ == nullptr && this->opUserId_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline ListKgEntityShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
