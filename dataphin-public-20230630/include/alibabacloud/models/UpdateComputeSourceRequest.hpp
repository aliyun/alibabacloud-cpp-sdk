...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateComputeSourceRequestUpdateCommand & updateCommand() const { DARABONBA_PTR_GET_CONST(updateCommand_, UpdateComputeSourceRequestUpdateCommand) };
    inline UpdateComputeSourceRequestUpdateCommand updateCommand() { DARABONBA_PTR_GET(updateCommand_, UpdateComputeSourceRequestUpdateCommand) };
    inline UpdateComputeSourceRequest& setUpdateCommand(const UpdateComputeSourceRequestUpdateCommand & updateCommand) { DARABONBA_PTR_SET_VALUE(updateCommand_, updateCommand) };
    inline UpdateComputeSourceRequest& setUpdateCommand(UpdateComputeSourceRequestUpdateCommand && updateCommand) { DARABONBA_PTR_SET_RVALUE(updateCommand_, updateCommand) };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<UpdateComputeSourceRequestUpdateCommand> updateCommand_ = nullptr;
  };
