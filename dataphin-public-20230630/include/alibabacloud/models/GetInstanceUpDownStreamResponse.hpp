...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceUpDownStreamResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceUpDownStreamResponseBody) };
    inline GetInstanceUpDownStreamResponseBody body() { DARABONBA_PTR_GET(body_, GetInstanceUpDownStreamResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetInstanceUpDownStreamResponseBody> body_ = nullptr;
  };
