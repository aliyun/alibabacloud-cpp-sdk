...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetClusterQueueInfoByEnvResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetClusterQueueInfoByEnvResponseBodyData>) };
    inline vector<GetClusterQueueInfoByEnvResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetClusterQueueInfoByEnvResponseBodyData>) };
    inline GetClusterQueueInfoByEnvResponseBody& setData(const vector<GetClusterQueueInfoByEnvResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetClusterQueueInfoByEnvResponseBody& setData(vector<GetClusterQueueInfoByEnvResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetClusterQueueInfoByEnvResponseBodyData>> data_ = nullptr;
