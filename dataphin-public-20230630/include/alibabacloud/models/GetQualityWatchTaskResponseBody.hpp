...
#ifndef ALIBABACLOUD_MODELS_GETQUALITYWATCHTASKRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETQUALITYWATCHTASKRESPONSEBODY_HPP_
...
namespace Models
{
  class GetQualityWatchTaskResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetQualityWatchTaskResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(HttpStatusCode, httpStatusCode_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
      DARABONBA_PTR_TO_JSON(WatchTaskInfo, watchTaskInfo_);
    };
    friend void from_json(const Darabonba::Json& j, GetQualityWatchTaskResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(HttpStatusCode, httpStatusCode_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
      DARABONBA_PTR_FROM_JSON(WatchTaskInfo, watchTaskInfo_);
    };
    GetQualityWatchTaskResponseBody() = default ;
    GetQualityWatchTaskResponseBody(const GetQualityWatchTaskResponseBody &) = default ;
    GetQualityWatchTaskResponseBody(GetQualityWatchTaskResponseBody &&) = default ;
    GetQualityWatchTaskResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetQualityWatchTaskResponseBody() = default ;
    GetQualityWatchTaskResponseBody& operator=(const GetQualityWatchTaskResponseBody &) = default ;
    GetQualityWatchTaskResponseBody& operator=(GetQualityWatchTaskResponseBody &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    class WatchTaskInfo : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const WatchTaskInfo& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, WatchTaskInfo& obj) { 
      ...
      WatchTaskInfo() = default ;
      WatchTaskInfo(const WatchTaskInfo &) = default ;
      WatchTaskInfo(WatchTaskInfo &&) = default ;
      WatchTaskInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~WatchTaskInfo() = default ;
      WatchTaskInfo& operator=(const WatchTaskInfo &) = default ;
      WatchTaskInfo& operator=(WatchTaskInfo &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline WatchTaskInfo& setBizDate(string bizDate) { DARABONBA_PTR_SET_VALUE(bizDate_, bizDate) };
      ...
      inline WatchTaskInfo& setBizDateFormat(string bizDateFormat) { DARABONBA_PTR_SET_VALUE(bizDateFormat_, bizDateFormat) };
      ...
      inline WatchTaskInfo& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
      ...
      inline WatchTaskInfo& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
      ...
      inline WatchTaskInfo& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
      ...
      inline WatchTaskInfo& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
      ...
      inline WatchTaskInfo& setModifier(string modifier) { DARABONBA_PTR_SET_VALUE(modifier_, modifier) };
      ...
      inline WatchTaskInfo& setModifyTime(string modifyTime) { DARABONBA_PTR_SET_VALUE(modifyTime_, modifyTime) };
      ...
      inline WatchTaskInfo& setQualityOwner(string qualityOwner) { DARABONBA_PTR_SET_VALUE(qualityOwner_, qualityOwner) };
      ...
      inline WatchTaskInfo& setQualityOwnerName(string qualityOwnerName) { DARABONBA_PTR_SET_VALUE(qualityOwnerName_, qualityOwnerName) };
      ...
      inline const WatchTaskInfo::RuleCountInfo & getRuleCountInfo() const { DARABONBA_PTR_GET_CONST(ruleCountInfo_, WatchTaskInfo::RuleCountInfo) };
      inline WatchTaskInfo::RuleCountInfo getRuleCountInfo() { DARABONBA_PTR_GET(ruleCountInfo_, WatchTaskInfo::RuleCountInfo) };
      inline WatchTaskInfo& setRuleCountInfo(const WatchTaskInfo::RuleCountInfo & ruleCountInfo) { DARABONBA_PTR_SET_VALUE(ruleCountInfo_, ruleCountInfo) };
      inline WatchTaskInfo& setRuleCountInfo(WatchTaskInfo::RuleCountInfo && ruleCountInfo) { DARABONBA_PTR_SET_RVALUE(ruleCountInfo_, ruleCountInfo) };
      ...
      inline WatchTaskInfo& setRuleIdList(const vector<int64_t> & ruleIdList) { DARABONBA_PTR_SET_VALUE(ruleIdList_, ruleIdList) };
      inline WatchTaskInfo& setRuleIdList(vector<int64_t> && ruleIdList) { DARABONBA_PTR_SET_RVALUE(ruleIdList_, ruleIdList) };
      ...
      inline WatchTaskInfo& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
      ...
      inline WatchTaskInfo& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
      ...
      inline WatchTaskInfo& setWatchId(int64_t watchId) { DARABONBA_PTR_SET_VALUE(watchId_, watchId) };
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && this->httpStatusCode_ == nullptr && this->message_ == nullptr && this->requestId_ == nullptr && this->success_ == nullptr && this->watchTaskInfo_ == nullptr; };
    // code Field Functions 
    bool hasCode() const { return this->code_ != nullptr;};
    void deleteCode() { this->code_ = nullptr;};
    inline string getCode() const { DARABONBA_PTR_GET_DEFAULT(code_, "") };
    inline GetQualityWatchTaskResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetQualityWatchTaskResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetQualityWatchTaskResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetQualityWatchTaskResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetQualityWatchTaskResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


    // watchTaskInfo Field Functions 
    bool hasWatchTaskInfo() const { return this->watchTaskInfo_ != nullptr;};
    void deleteWatchTaskInfo() { this->watchTaskInfo_ = nullptr;};
    inline const GetQualityWatchTaskResponseBody::WatchTaskInfo & getWatchTaskInfo() const { DARABONBA_PTR_GET_CONST(watchTaskInfo_, GetQualityWatchTaskResponseBody::WatchTaskInfo) };
    inline GetQualityWatchTaskResponseBody::WatchTaskInfo getWatchTaskInfo() { DARABONBA_PTR_GET(watchTaskInfo_, GetQualityWatchTaskResponseBody::WatchTaskInfo) };
    inline GetQualityWatchTaskResponseBody& setWatchTaskInfo(const GetQualityWatchTaskResponseBody::WatchTaskInfo & watchTaskInfo) { DARABONBA_PTR_SET_VALUE(watchTaskInfo_, watchTaskInfo) };
    inline GetQualityWatchTaskResponseBody& setWatchTaskInfo(GetQualityWatchTaskResponseBody::WatchTaskInfo && watchTaskInfo) { DARABONBA_PTR_SET_RVALUE(watchTaskInfo_, watchTaskInfo) };
