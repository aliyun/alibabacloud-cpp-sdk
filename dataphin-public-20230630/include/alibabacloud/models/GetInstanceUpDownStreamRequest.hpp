...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->downStreamDepth_ == nullptr
        && return this->env_ == nullptr && return this->instanceId_ == nullptr && return this->opTenantId_ == nullptr && return this->projectId_ == nullptr && return this->upStreamDepth_ == nullptr; };
