...
namespace Models
{
  ...
  public:
    ...
    inline const vector<PausePhysicalNodeResponseBody::NodeOperateResultList> & getNodeOperateResultList() const { DARABONBA_PTR_GET_CONST(nodeOperateResultList_, vector<PausePhysicalNodeResponseBody::NodeOperateResultList>) };
    inline vector<PausePhysicalNodeResponseBody::NodeOperateResultList> getNodeOperateResultList() { DARABONBA_PTR_GET(nodeOperateResultList_, vector<PausePhysicalNodeResponseBody::NodeOperateResultList>) };
    inline PausePhysicalNodeResponseBody& setNodeOperateResultList(const vector<PausePhysicalNodeResponseBody::NodeOperateResultList> & nodeOperateResultList) { DARABONBA_PTR_SET_VALUE(nodeOperateResultList_, nodeOperateResultList) };
    inline PausePhysicalNodeResponseBody& setNodeOperateResultList(vector<PausePhysicalNodeResponseBody::NodeOperateResultList> && nodeOperateResultList) { DARABONBA_PTR_SET_RVALUE(nodeOperateResultList_, nodeOperateResultList) };
  ...
  protected:
    ...
    shared_ptr<vector<PausePhysicalNodeResponseBody::NodeOperateResultList>> nodeOperateResultList_ {};
