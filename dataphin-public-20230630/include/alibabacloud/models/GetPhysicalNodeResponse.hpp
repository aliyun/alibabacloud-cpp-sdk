...
namespace Models
{
  ...
  public:
    ...
    inline const GetPhysicalNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPhysicalNodeResponseBody) };
    inline GetPhysicalNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPhysicalNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPhysicalNodeResponseBody> body_ {};
  };
