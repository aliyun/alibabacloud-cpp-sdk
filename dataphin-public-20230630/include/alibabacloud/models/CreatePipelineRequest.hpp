...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePipelineRequest::Context & getContext() const { DARABONBA_PTR_GET_CONST(context_, CreatePipelineRequest::Context) };
    inline CreatePipelineRequest::Context getContext() { DARABONBA_PTR_GET(context_, CreatePipelineRequest::Context) };
    inline CreatePipelineRequest& setContext(const CreatePipelineRequest::Context & context) { DARABONBA_PTR_SET_VALUE(context_, context) };
    inline CreatePipelineRequest& setContext(CreatePipelineRequest::Context && context) { DARABONBA_PTR_SET_RVALUE(context_, context) };
    ...
    inline const CreatePipelineRequest::CreateCommand & getCreateCommand() const { DARABONBA_PTR_GET_CONST(createCommand_, CreatePipelineRequest::CreateCommand) };
    inline CreatePipelineRequest::CreateCommand getCreateCommand() { DARABONBA_PTR_GET(createCommand_, CreatePipelineRequest::CreateCommand) };
    inline CreatePipelineRequest& setCreateCommand(const CreatePipelineRequest::CreateCommand & createCommand) { DARABONBA_PTR_SET_VALUE(createCommand_, createCommand) };
    inline CreatePipelineRequest& setCreateCommand(CreatePipelineRequest::CreateCommand && createCommand) { DARABONBA_PTR_SET_RVALUE(createCommand_, createCommand) };
    ...
    inline CreatePipelineRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
