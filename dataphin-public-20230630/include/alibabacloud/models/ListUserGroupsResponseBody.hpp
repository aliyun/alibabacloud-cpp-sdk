...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserGroupsResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListUserGroupsResponseBodyPageResult) };
    inline ListUserGroupsResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListUserGroupsResponseBodyPageResult) };
    inline ListUserGroupsResponseBody& setPageResult(const ListUserGroupsResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListUserGroupsResponseBody& setPageResult(ListUserGroupsResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListUserGroupsResponseBodyPageResult> pageResult_ = nullptr;
