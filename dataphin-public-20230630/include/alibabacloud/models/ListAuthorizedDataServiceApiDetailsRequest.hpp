...
namespace Models
{
  ...
  public:
    ...
    inline const ListAuthorizedDataServiceApiDetailsRequestListQuery & listQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListAuthorizedDataServiceApiDetailsRequestListQuery) };
    inline ListAuthorizedDataServiceApiDetailsRequestListQuery listQuery() { DARABONBA_PTR_GET(listQuery_, ListAuthorizedDataServiceApiDetailsRequestListQuery) };
    inline ListAuthorizedDataServiceApiDetailsRequest& setListQuery(const ListAuthorizedDataServiceApiDetailsRequestListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListAuthorizedDataServiceApiDetailsRequest& setListQuery(ListAuthorizedDataServiceApiDetailsRequestListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
  ...
  protected:
    ...
    std::shared_ptr<ListAuthorizedDataServiceApiDetailsRequestListQuery> listQuery_ = nullptr;
    // This parameter is required.
