...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->operationLogList_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<GetPhysicalNodeOperationLogResponseBodyOperationLogList> & operationLogList() const { DARABONBA_PTR_GET_CONST(operationLogList_, vector<GetPhysicalNodeOperationLogResponseBodyOperationLogList>) };
    inline vector<GetPhysicalNodeOperationLogResponseBodyOperationLogList> operationLogList() { DARABONBA_PTR_GET(operationLogList_, vector<GetPhysicalNodeOperationLogResponseBodyOperationLogList>) };
    inline GetPhysicalNodeOperationLogResponseBody& setOperationLogList(const vector<GetPhysicalNodeOperationLogResponseBodyOperationLogList> & operationLogList) { DARABONBA_PTR_SET_VALUE(operationLogList_, operationLogList) };
    inline GetPhysicalNodeOperationLogResponseBody& setOperationLogList(vector<GetPhysicalNodeOperationLogResponseBodyOperationLogList> && operationLogList) { DARABONBA_PTR_SET_RVALUE(operationLogList_, operationLogList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetPhysicalNodeOperationLogResponseBodyOperationLogList>> operationLogList_ = nullptr;
