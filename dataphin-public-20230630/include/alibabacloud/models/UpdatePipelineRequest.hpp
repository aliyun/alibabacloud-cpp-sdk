...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePipelineRequest::Context & getContext() const { DARABONBA_PTR_GET_CONST(context_, UpdatePipelineRequest::Context) };
    inline UpdatePipelineRequest::Context getContext() { DARABONBA_PTR_GET(context_, UpdatePipelineRequest::Context) };
    inline UpdatePipelineRequest& setContext(const UpdatePipelineRequest::Context & context) { DARABONBA_PTR_SET_VALUE(context_, context) };
    inline UpdatePipelineRequest& setContext(UpdatePipelineRequest::Context && context) { DARABONBA_PTR_SET_RVALUE(context_, context) };
    ...
    inline UpdatePipelineRequest& setOpTenantId(int64_t opTenantId) { DARABONBA_PTR_SET_VALUE(opTenantId_, opTenantId) };
    ...
    inline UpdatePipelineRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline const UpdatePipelineRequest::UpdateCommand & getUpdateCommand() const { DARABONBA_PTR_GET_CONST(updateCommand_, UpdatePipelineRequest::UpdateCommand) };
    inline UpdatePipelineRequest::UpdateCommand getUpdateCommand() { DARABONBA_PTR_GET(updateCommand_, UpdatePipelineRequest::UpdateCommand) };
    inline UpdatePipelineRequest& setUpdateCommand(const UpdatePipelineRequest::UpdateCommand & updateCommand) { DARABONBA_PTR_SET_VALUE(updateCommand_, updateCommand) };
    inline UpdatePipelineRequest& setUpdateCommand(UpdatePipelineRequest::UpdateCommand && updateCommand) { DARABONBA_PTR_SET_RVALUE(updateCommand_, updateCommand) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<UpdatePipelineRequest::Context> context_ {};
    // The tenant ID.
    // 
    // This parameter is required.
    ...
    // 
    // This parameter is required.
    shared_ptr<UpdatePipelineRequest::UpdateCommand> updateCommand_ {};
  };
