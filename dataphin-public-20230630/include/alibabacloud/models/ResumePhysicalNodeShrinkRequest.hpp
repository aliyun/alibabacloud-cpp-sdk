...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->env_ == nullptr
        && this->opTenantId_ == nullptr && this->opUserId_ == nullptr && this->resumeCommandShrink_ == nullptr; };
    // env Field Functions 
    ...
    inline ResumePhysicalNodeShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline string getResumeCommandShrink() const { DARABONBA_PTR_GET_DEFAULT(resumeCommandShrink_, "") };
