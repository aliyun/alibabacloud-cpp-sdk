...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServicePublishedApisRequestListQuery & listQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListDataServicePublishedApisRequestListQuery) };
    inline ListDataServicePublishedApisRequestListQuery listQuery() { DARABONBA_PTR_GET(listQuery_, ListDataServicePublishedApisRequestListQuery) };
    inline ListDataServicePublishedApisRequest& setListQuery(const ListDataServicePublishedApisRequestListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListDataServicePublishedApisRequest& setListQuery(ListDataServicePublishedApisRequestListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
  ...
  protected:
    std::shared_ptr<ListDataServicePublishedApisRequestListQuery> listQuery_ = nullptr;
