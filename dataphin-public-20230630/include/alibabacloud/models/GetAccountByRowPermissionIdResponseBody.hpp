...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetAccountByRowPermissionIdResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetAccountByRowPermissionIdResponseBodyData>) };
    inline vector<GetAccountByRowPermissionIdResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetAccountByRowPermissionIdResponseBodyData>) };
    inline GetAccountByRowPermissionIdResponseBody& setData(const vector<GetAccountByRowPermissionIdResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAccountByRowPermissionIdResponseBody& setData(vector<GetAccountByRowPermissionIdResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetAccountByRowPermissionIdResponseBodyData>> data_ = nullptr;
