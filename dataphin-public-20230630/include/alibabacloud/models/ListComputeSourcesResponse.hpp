...
namespace Models
{
  ...
  public:
    ...
    inline const ListComputeSourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListComputeSourcesResponseBody) };
    inline ListComputeSourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListComputeSourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListComputeSourcesResponseBody> body_ {};
  };
