...
namespace Models
{
  ...
  public:
    ...
    inline const GetBatchTaskUdfLineagesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetBatchTaskUdfLineagesResponseBodyData) };
    inline GetBatchTaskUdfLineagesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetBatchTaskUdfLineagesResponseBodyData) };
    inline GetBatchTaskUdfLineagesResponseBody& setData(const GetBatchTaskUdfLineagesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetBatchTaskUdfLineagesResponseBody& setData(GetBatchTaskUdfLineagesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetBatchTaskUdfLineagesResponseBodyData> data_ = nullptr;
