...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->result_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ListAuthorizedDataServiceApiDetailsResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListAuthorizedDataServiceApiDetailsResponseBodyResult) };
    inline ListAuthorizedDataServiceApiDetailsResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListAuthorizedDataServiceApiDetailsResponseBodyResult) };
    inline ListAuthorizedDataServiceApiDetailsResponseBody& setResult(const ListAuthorizedDataServiceApiDetailsResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListAuthorizedDataServiceApiDetailsResponseBody& setResult(ListAuthorizedDataServiceApiDetailsResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ListAuthorizedDataServiceApiDetailsResponseBodyResult> result_ = nullptr;
