...
#ifndef ALIBABACLOUD_MODELS_DELETESTANDARDINVALIDMAPPINGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETESTANDARDINVALIDMAPPINGREQUEST_HPP_
...
namespace Models
{
  class DeleteStandardInValidMappingRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DeleteStandardInValidMappingRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DeleteCommand, deleteCommand_);
      DARABONBA_PTR_TO_JSON(OpTenantId, opTenantId_);
      DARABONBA_PTR_TO_JSON(OpUserId, opUserId_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteStandardInValidMappingRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DeleteCommand, deleteCommand_);
      DARABONBA_PTR_FROM_JSON(OpTenantId, opTenantId_);
      DARABONBA_PTR_FROM_JSON(OpUserId, opUserId_);
    };
    DeleteStandardInValidMappingRequest() = default ;
    DeleteStandardInValidMappingRequest(const DeleteStandardInValidMappingRequest &) = default ;
    DeleteStandardInValidMappingRequest(DeleteStandardInValidMappingRequest &&) = default ;
    DeleteStandardInValidMappingRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteStandardInValidMappingRequest() = default ;
    DeleteStandardInValidMappingRequest& operator=(const DeleteStandardInValidMappingRequest &) = default ;
    DeleteStandardInValidMappingRequest& operator=(DeleteStandardInValidMappingRequest &&) = default ;
    ...
    inline const DeleteStandardInValidMappingRequest::DeleteCommand & getDeleteCommand() const { DARABONBA_PTR_GET_CONST(deleteCommand_, DeleteStandardInValidMappingRequest::DeleteCommand) };
    inline DeleteStandardInValidMappingRequest::DeleteCommand getDeleteCommand() { DARABONBA_PTR_GET(deleteCommand_, DeleteStandardInValidMappingRequest::DeleteCommand) };
    inline DeleteStandardInValidMappingRequest& setDeleteCommand(const DeleteStandardInValidMappingRequest::DeleteCommand & deleteCommand) { DARABONBA_PTR_SET_VALUE(deleteCommand_, deleteCommand) };
    inline DeleteStandardInValidMappingRequest& setDeleteCommand(DeleteStandardInValidMappingRequest::DeleteCommand && deleteCommand) { DARABONBA_PTR_SET_RVALUE(deleteCommand_, deleteCommand) };
    ...
    inline DeleteStandardInValidMappingRequest& setOpTenantId(int64_t opTenantId) { DARABONBA_PTR_SET_VALUE(opTenantId_, opTenantId) };
    ...
    inline DeleteStandardInValidMappingRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
