...
#ifndef ALIBABACLOUD_MODELS_GETDIRECTORYTREERESPONSEBODYDATAPARENT_HPP_
#define ALIBABACLOUD_MODELS_GETDIRECTORYTREERESPONSEBODYDATAPARENT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDirectoryTreeResponseBodyDataParent& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDirectoryTreeResponseBodyDataParent& obj) { 
    ...
    GetDirectoryTreeResponseBodyDataParent() = default ;
    GetDirectoryTreeResponseBodyDataParent(const GetDirectoryTreeResponseBodyDataParent &) = default ;
    GetDirectoryTreeResponseBodyDataParent(GetDirectoryTreeResponseBodyDataParent &&) = default ;
    GetDirectoryTreeResponseBodyDataParent(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDirectoryTreeResponseBodyDataParent() = default ;
    GetDirectoryTreeResponseBodyDataParent& operator=(const GetDirectoryTreeResponseBodyDataParent &) = default ;
    GetDirectoryTreeResponseBodyDataParent& operator=(GetDirectoryTreeResponseBodyDataParent &&) = default ;
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setCategoryType(string categoryType) { DARABONBA_PTR_SET_VALUE(categoryType_, categoryType) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setCreatorName(string creatorName) { DARABONBA_PTR_SET_VALUE(creatorName_, creatorName) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setDataCellId(int64_t dataCellId) { DARABONBA_PTR_SET_VALUE(dataCellId_, dataCellId) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setDirName(string dirName) { DARABONBA_PTR_SET_VALUE(dirName_, dirName) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setLastModifier(string lastModifier) { DARABONBA_PTR_SET_VALUE(lastModifier_, lastModifier) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setLastModifierName(string lastModifierName) { DARABONBA_PTR_SET_VALUE(lastModifierName_, lastModifierName) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setStringId(string stringId) { DARABONBA_PTR_SET_VALUE(stringId_, stringId) };
    ...
    inline GetDirectoryTreeResponseBodyDataParent& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
