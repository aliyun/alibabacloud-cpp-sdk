...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->id_ == nullptr
        && this->opTenantId_ == nullptr && this->opUserId_ == nullptr && this->replaceCommandShrink_ == nullptr; };
    // id Field Functions 
    ...
    inline ReplaceProjectWhiteListsShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline string getReplaceCommandShrink() const { DARABONBA_PTR_GET_DEFAULT(replaceCommandShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> replaceCommandShrink_ {};
  };
