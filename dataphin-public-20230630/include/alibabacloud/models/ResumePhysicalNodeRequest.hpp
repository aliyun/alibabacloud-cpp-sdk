...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->env_ == nullptr
        && this->opTenantId_ == nullptr && this->opUserId_ == nullptr && this->resumeCommand_ == nullptr; };
    // env Field Functions 
    ...
    inline ResumePhysicalNodeRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
