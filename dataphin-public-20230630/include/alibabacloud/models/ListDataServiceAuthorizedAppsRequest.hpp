...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceAuthorizedAppsRequest::ListQuery & getListQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListDataServiceAuthorizedAppsRequest::ListQuery) };
    inline ListDataServiceAuthorizedAppsRequest::ListQuery getListQuery() { DARABONBA_PTR_GET(listQuery_, ListDataServiceAuthorizedAppsRequest::ListQuery) };
    inline ListDataServiceAuthorizedAppsRequest& setListQuery(const ListDataServiceAuthorizedAppsRequest::ListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListDataServiceAuthorizedAppsRequest& setListQuery(ListDataServiceAuthorizedAppsRequest::ListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
    ...
    inline ListDataServiceAuthorizedAppsRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
  ...
  protected:
    ...
    shared_ptr<ListDataServiceAuthorizedAppsRequest::ListQuery> listQuery_ {};
    // The tenant ID.
    // 
