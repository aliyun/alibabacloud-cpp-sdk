...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->dataDomainInfo_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetDataDomainInfoResponseBodyDataDomainInfo & dataDomainInfo() const { DARABONBA_PTR_GET_CONST(dataDomainInfo_, GetDataDomainInfoResponseBodyDataDomainInfo) };
    inline GetDataDomainInfoResponseBodyDataDomainInfo dataDomainInfo() { DARABONBA_PTR_GET(dataDomainInfo_, GetDataDomainInfoResponseBodyDataDomainInfo) };
    inline GetDataDomainInfoResponseBody& setDataDomainInfo(const GetDataDomainInfoResponseBodyDataDomainInfo & dataDomainInfo) { DARABONBA_PTR_SET_VALUE(dataDomainInfo_, dataDomainInfo) };
    inline GetDataDomainInfoResponseBody& setDataDomainInfo(GetDataDomainInfoResponseBodyDataDomainInfo && dataDomainInfo) { DARABONBA_PTR_SET_RVALUE(dataDomainInfo_, dataDomainInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataDomainInfoResponseBodyDataDomainInfo> dataDomainInfo_ = nullptr;
