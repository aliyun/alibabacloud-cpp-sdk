...
namespace Models
{
  ...
  public:
    ...
    inline DeleteDataSourceResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeleteDataSourceResponseBody& setData(bool data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline DeleteDataSourceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline DeleteDataSourceResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
