...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePipelineNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePipelineNodeResponseBody) };
    inline CreatePipelineNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePipelineNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePipelineNodeResponseBody> body_ {};
  };
