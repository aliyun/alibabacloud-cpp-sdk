...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->nodeDagInfo_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetNodeUpDownStreamResponseBodyNodeDagInfo & nodeDagInfo() const { DARABONBA_PTR_GET_CONST(nodeDagInfo_, GetNodeUpDownStreamResponseBodyNodeDagInfo) };
    inline GetNodeUpDownStreamResponseBodyNodeDagInfo nodeDagInfo() { DARABONBA_PTR_GET(nodeDagInfo_, GetNodeUpDownStreamResponseBodyNodeDagInfo) };
    inline GetNodeUpDownStreamResponseBody& setNodeDagInfo(const GetNodeUpDownStreamResponseBodyNodeDagInfo & nodeDagInfo) { DARABONBA_PTR_SET_VALUE(nodeDagInfo_, nodeDagInfo) };
    inline GetNodeUpDownStreamResponseBody& setNodeDagInfo(GetNodeUpDownStreamResponseBodyNodeDagInfo && nodeDagInfo) { DARABONBA_PTR_SET_RVALUE(nodeDagInfo_, nodeDagInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetNodeUpDownStreamResponseBodyNodeDagInfo> nodeDagInfo_ = nullptr;
