...
namespace Models
{
  ...
  public:
    ...
    inline const GetTransferInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTransferInfoResponseBody) };
    inline GetTransferInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTransferInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTransferInfoResponseBody> body_ {};
  };
