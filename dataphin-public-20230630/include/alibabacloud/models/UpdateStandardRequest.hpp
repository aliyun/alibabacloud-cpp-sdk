...
#ifndef ALIBABACLOUD_MODELS_UPDATESTANDARDREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATESTANDARDREQUEST_HPP_
...
namespace Models
{
  class UpdateStandardRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateStandardRequest& obj) { 
      DARABONBA_PTR_TO_JSON(OpTenantId, opTenantId_);
      DARABONBA_PTR_TO_JSON(OpUserId, opUserId_);
      DARABONBA_PTR_TO_JSON(UpdateCommand, updateCommand_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateStandardRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(OpTenantId, opTenantId_);
      DARABONBA_PTR_FROM_JSON(OpUserId, opUserId_);
      DARABONBA_PTR_FROM_JSON(UpdateCommand, updateCommand_);
    };
    UpdateStandardRequest() = default ;
    UpdateStandardRequest(const UpdateStandardRequest &) = default ;
    UpdateStandardRequest(UpdateStandardRequest &&) = default ;
    UpdateStandardRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateStandardRequest() = default ;
    UpdateStandardRequest& operator=(const UpdateStandardRequest &) = default ;
    UpdateStandardRequest& operator=(UpdateStandardRequest &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->description_ == nullptr
        && this->effectiveTimeConfig_ == nullptr && this->needGenerateStandardCode_ == nullptr && this->owner_ == nullptr && this->standardGeneralMonitorConfig_ == nullptr && this->standardId_ == nullptr
        && this->standardSetReference_ == nullptr && this->standardStatus_ == nullptr && this->standardTemplateReference_ == nullptr && this->version_ == nullptr; };
      // description Field Functions 
      bool hasDescription() const { return this->description_ != nullptr;};
      void deleteDescription() { this->description_ = nullptr;};
      inline string getDescription() const { DARABONBA_PTR_GET_DEFAULT(description_, "") };
      ...
      inline const UpdateCommand::EffectiveTimeConfig & getEffectiveTimeConfig() const { DARABONBA_PTR_GET_CONST(effectiveTimeConfig_, UpdateCommand::EffectiveTimeConfig) };
      inline UpdateCommand::EffectiveTimeConfig getEffectiveTimeConfig() { DARABONBA_PTR_GET(effectiveTimeConfig_, UpdateCommand::EffectiveTimeConfig) };
      inline UpdateCommand& setEffectiveTimeConfig(const UpdateCommand::EffectiveTimeConfig & effectiveTimeConfig) { DARABONBA_PTR_SET_VALUE(effectiveTimeConfig_, effectiveTimeConfig) };
      inline UpdateCommand& setEffectiveTimeConfig(UpdateCommand::EffectiveTimeConfig && effectiveTimeConfig) { DARABONBA_PTR_SET_RVALUE(effectiveTimeConfig_, effectiveTimeConfig) };
      ...
      inline UpdateCommand& setNeedGenerateStandardCode(bool needGenerateStandardCode) { DARABONBA_PTR_SET_VALUE(needGenerateStandardCode_, needGenerateStandardCode) };
      ...
      inline const UpdateCommand::StandardGeneralMonitorConfig & getStandardGeneralMonitorConfig() const { DARABONBA_PTR_GET_CONST(standardGeneralMonitorConfig_, UpdateCommand::StandardGeneralMonitorConfig) };
      inline UpdateCommand::StandardGeneralMonitorConfig getStandardGeneralMonitorConfig() { DARABONBA_PTR_GET(standardGeneralMonitorConfig_, UpdateCommand::StandardGeneralMonitorConfig) };
      inline UpdateCommand& setStandardGeneralMonitorConfig(const UpdateCommand::StandardGeneralMonitorConfig & standardGeneralMonitorConfig) { DARABONBA_PTR_SET_VALUE(standardGeneralMonitorConfig_, standardGeneralMonitorConfig) };
      inline UpdateCommand& setStandardGeneralMonitorConfig(UpdateCommand::StandardGeneralMonitorConfig && standardGeneralMonitorConfig) { DARABONBA_PTR_SET_RVALUE(standardGeneralMonitorConfig_, standardGeneralMonitorConfig) };
      ...
      inline const UpdateCommand::StandardSetReference & getStandardSetReference() const { DARABONBA_PTR_GET_CONST(standardSetReference_, UpdateCommand::StandardSetReference) };
      inline UpdateCommand::StandardSetReference getStandardSetReference() { DARABONBA_PTR_GET(standardSetReference_, UpdateCommand::StandardSetReference) };
      inline UpdateCommand& setStandardSetReference(const UpdateCommand::StandardSetReference & standardSetReference) { DARABONBA_PTR_SET_VALUE(standardSetReference_, standardSetReference) };
      inline UpdateCommand& setStandardSetReference(UpdateCommand::StandardSetReference && standardSetReference) { DARABONBA_PTR_SET_RVALUE(standardSetReference_, standardSetReference) };
      ...
      inline UpdateCommand& setStandardStatus(string standardStatus) { DARABONBA_PTR_SET_VALUE(standardStatus_, standardStatus) };
      ...
      inline const UpdateCommand::StandardTemplateReference & getStandardTemplateReference() const { DARABONBA_PTR_GET_CONST(standardTemplateReference_, UpdateCommand::StandardTemplateReference) };
      inline UpdateCommand::StandardTemplateReference getStandardTemplateReference() { DARABONBA_PTR_GET(standardTemplateReference_, UpdateCommand::StandardTemplateReference) };
      inline UpdateCommand& setStandardTemplateReference(const UpdateCommand::StandardTemplateReference & standardTemplateReference) { DARABONBA_PTR_SET_VALUE(standardTemplateReference_, standardTemplateReference) };
      inline UpdateCommand& setStandardTemplateReference(UpdateCommand::StandardTemplateReference && standardTemplateReference) { DARABONBA_PTR_SET_RVALUE(standardTemplateReference_, standardTemplateReference) };
    ...
    protected:
      ...
      shared_ptr<UpdateCommand::EffectiveTimeConfig> effectiveTimeConfig_ {};
      ...
      shared_ptr<UpdateCommand::StandardGeneralMonitorConfig> standardGeneralMonitorConfig_ {};
      // The lookup table.
      // 
      // This parameter is required.
      ...
      // 
      // This parameter is required.
      shared_ptr<UpdateCommand::StandardSetReference> standardSetReference_ {};
      ...
      // 
      // This parameter is required.
      shared_ptr<UpdateCommand::StandardTemplateReference> standardTemplateReference_ {};
      // The version number.
      shared_ptr<int32_t> version_ {};
    };
    ...
    inline UpdateStandardRequest& setOpTenantId(int64_t opTenantId) { DARABONBA_PTR_SET_VALUE(opTenantId_, opTenantId) };
    ...
    inline UpdateStandardRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline const UpdateStandardRequest::UpdateCommand & getUpdateCommand() const { DARABONBA_PTR_GET_CONST(updateCommand_, UpdateStandardRequest::UpdateCommand) };
    inline UpdateStandardRequest::UpdateCommand getUpdateCommand() { DARABONBA_PTR_GET(updateCommand_, UpdateStandardRequest::UpdateCommand) };
    inline UpdateStandardRequest& setUpdateCommand(const UpdateStandardRequest::UpdateCommand & updateCommand) { DARABONBA_PTR_SET_VALUE(updateCommand_, updateCommand) };
    inline UpdateStandardRequest& setUpdateCommand(UpdateStandardRequest::UpdateCommand && updateCommand) { DARABONBA_PTR_SET_RVALUE(updateCommand_, updateCommand) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<UpdateStandardRequest::UpdateCommand> updateCommand_ {};
  };
