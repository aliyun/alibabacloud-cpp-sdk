...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataServiceAppGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataServiceAppGroupsResponseBody) };
    inline GetDataServiceAppGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataServiceAppGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataServiceAppGroupsResponseBody> body_ {};
  };
