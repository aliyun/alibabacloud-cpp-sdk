...
namespace Models
{
  ...
  public:
    ...
    inline const FixDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FixDataResponseBody) };
    inline FixDataResponseBody getBody() { DARABONBA_PTR_GET(body_, FixDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FixDataResponseBody> body_ {};
  };
