...
namespace Models
{
  ...
  public:
    ...
    inline const ListFilesRequestListQuery & listQuery() const { DARABONBA_PTR_GET_CONST(listQuery_, ListFilesRequestListQuery) };
    inline ListFilesRequestListQuery listQuery() { DARABONBA_PTR_GET(listQuery_, ListFilesRequestListQuery) };
    inline ListFilesRequest& setListQuery(const ListFilesRequestListQuery & listQuery) { DARABONBA_PTR_SET_VALUE(listQuery_, listQuery) };
    inline ListFilesRequest& setListQuery(ListFilesRequestListQuery && listQuery) { DARABONBA_PTR_SET_RVALUE(listQuery_, listQuery) };
  ...
  protected:
    ...
    std::shared_ptr<ListFilesRequestListQuery> listQuery_ = nullptr;
    // This parameter is required.
