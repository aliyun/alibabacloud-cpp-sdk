...
namespace Models
{
  ...
  public:
    ...
    inline const ListAddableUsersResponseBody::PageResult & getPageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListAddableUsersResponseBody::PageResult) };
    inline ListAddableUsersResponseBody::PageResult getPageResult() { DARABONBA_PTR_GET(pageResult_, ListAddableUsersResponseBody::PageResult) };
    inline ListAddableUsersResponseBody& setPageResult(const ListAddableUsersResponseBody::PageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListAddableUsersResponseBody& setPageResult(ListAddableUsersResponseBody::PageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
