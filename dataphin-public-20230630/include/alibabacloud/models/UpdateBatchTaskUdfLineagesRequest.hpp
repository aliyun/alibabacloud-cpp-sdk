...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateBatchTaskUdfLineagesRequestUpdateCommand & updateCommand() const { DARABONBA_PTR_GET_CONST(updateCommand_, UpdateBatchTaskUdfLineagesRequestUpdateCommand) };
    inline UpdateBatchTaskUdfLineagesRequestUpdateCommand updateCommand() { DARABONBA_PTR_GET(updateCommand_, UpdateBatchTaskUdfLineagesRequestUpdateCommand) };
    inline UpdateBatchTaskUdfLineagesRequest& setUpdateCommand(const UpdateBatchTaskUdfLineagesRequestUpdateCommand & updateCommand) { DARABONBA_PTR_SET_VALUE(updateCommand_, updateCommand) };
    inline UpdateBatchTaskUdfLineagesRequest& setUpdateCommand(UpdateBatchTaskUdfLineagesRequestUpdateCommand && updateCommand) { DARABONBA_PTR_SET_RVALUE(updateCommand_, updateCommand) };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<UpdateBatchTaskUdfLineagesRequestUpdateCommand> updateCommand_ = nullptr;
  };
