...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->projectList_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<GetDataServiceAuthorizedProjectsResponseBodyProjectList> & projectList() const { DARABONBA_PTR_GET_CONST(projectList_, vector<GetDataServiceAuthorizedProjectsResponseBodyProjectList>) };
    inline vector<GetDataServiceAuthorizedProjectsResponseBodyProjectList> projectList() { DARABONBA_PTR_GET(projectList_, vector<GetDataServiceAuthorizedProjectsResponseBodyProjectList>) };
    inline GetDataServiceAuthorizedProjectsResponseBody& setProjectList(const vector<GetDataServiceAuthorizedProjectsResponseBodyProjectList> & projectList) { DARABONBA_PTR_SET_VALUE(projectList_, projectList) };
    inline GetDataServiceAuthorizedProjectsResponseBody& setProjectList(vector<GetDataServiceAuthorizedProjectsResponseBodyProjectList> && projectList) { DARABONBA_PTR_SET_RVALUE(projectList_, projectList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetDataServiceAuthorizedProjectsResponseBodyProjectList>> projectList_ = nullptr;
    // Id of the request
