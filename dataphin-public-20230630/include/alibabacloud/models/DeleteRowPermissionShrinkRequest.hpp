...
namespace Models
{
  ...
  public:
    ...
    inline string getDeleteRowPermissionCommandShrink() const { DARABONBA_PTR_GET_DEFAULT(deleteRowPermissionCommandShrink_, "") };
    ...
    inline DeleteRowPermissionShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
  ...
  protected:
    ...
    shared_ptr<string> deleteRowPermissionCommandShrink_ {};
    // The tenant ID.
    // 
    // This parameter is required.
