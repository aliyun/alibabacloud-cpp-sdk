...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserGroupMembersResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListUserGroupMembersResponseBodyPageResult) };
    inline ListUserGroupMembersResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListUserGroupMembersResponseBodyPageResult) };
    inline ListUserGroupMembersResponseBody& setPageResult(const ListUserGroupMembersResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListUserGroupMembersResponseBody& setPageResult(ListUserGroupMembersResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListUserGroupMembersResponseBodyPageResult> pageResult_ = nullptr;
