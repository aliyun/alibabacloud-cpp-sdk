...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline const vector<Data::MappingColumns> & getMappingColumns() const { DARABONBA_PTR_GET_CONST(mappingColumns_, vector<Data::MappingColumns>) };
        inline vector<Data::MappingColumns> getMappingColumns() { DARABONBA_PTR_GET(mappingColumns_, vector<Data::MappingColumns>) };
        inline Data& setMappingColumns(const vector<Data::MappingColumns> & mappingColumns) { DARABONBA_PTR_SET_VALUE(mappingColumns_, mappingColumns) };
        inline Data& setMappingColumns(vector<Data::MappingColumns> && mappingColumns) { DARABONBA_PTR_SET_RVALUE(mappingColumns_, mappingColumns) };
        ...
        inline Data& setRowPermissionId(int64_t rowPermissionId) { DARABONBA_PTR_SET_VALUE(rowPermissionId_, rowPermissionId) };
      ...
      protected:
        ...
        shared_ptr<vector<Data::MappingColumns>> mappingColumns_ {};
    ...
    inline const ListRowPermissionResponseBody::PageResult & getPageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListRowPermissionResponseBody::PageResult) };
    inline ListRowPermissionResponseBody::PageResult getPageResult() { DARABONBA_PTR_GET(pageResult_, ListRowPermissionResponseBody::PageResult) };
    inline ListRowPermissionResponseBody& setPageResult(const ListRowPermissionResponseBody::PageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListRowPermissionResponseBody& setPageResult(ListRowPermissionResponseBody::PageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    shared_ptr<ListRowPermissionResponseBody::PageResult> pageResult_ {};
