...
#ifndef ALIBABACLOUD_MODELS_SUBMITASSETSOFFSHELVERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SUBMITASSETSOFFSHELVERESPONSEBODY_HPP_
...
namespace Models
{
  class SubmitAssetsOffShelveResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const SubmitAssetsOffShelveResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SubmitAssetsOffShelveResponseBody& obj) { 
    ...
    SubmitAssetsOffShelveResponseBody() = default ;
    SubmitAssetsOffShelveResponseBody(const SubmitAssetsOffShelveResponseBody &) = default ;
    SubmitAssetsOffShelveResponseBody(SubmitAssetsOffShelveResponseBody &&) = default ;
    SubmitAssetsOffShelveResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SubmitAssetsOffShelveResponseBody() = default ;
    SubmitAssetsOffShelveResponseBody& operator=(const SubmitAssetsOffShelveResponseBody &) = default ;
    SubmitAssetsOffShelveResponseBody& operator=(SubmitAssetsOffShelveResponseBody &&) = default ;
    ...
    inline SubmitAssetsOffShelveResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const SubmitAssetsOffShelveResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SubmitAssetsOffShelveResponseBody::Data) };
    inline SubmitAssetsOffShelveResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SubmitAssetsOffShelveResponseBody::Data) };
    inline SubmitAssetsOffShelveResponseBody& setData(const SubmitAssetsOffShelveResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitAssetsOffShelveResponseBody& setData(SubmitAssetsOffShelveResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline SubmitAssetsOffShelveResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline SubmitAssetsOffShelveResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline SubmitAssetsOffShelveResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    void deleteSuccess() { this->success_ = nullptr;};
    inline bool getSuccess() const { DARABONBA_PTR_GET_DEFAULT(success_, false) };
    inline SubmitAssetsOffShelveResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<SubmitAssetsOffShelveResponseBody::Data> data_ {};
