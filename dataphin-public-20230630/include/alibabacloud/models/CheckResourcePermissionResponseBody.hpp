...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->resourcePermissionList_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<CheckResourcePermissionResponseBodyResourcePermissionList> & resourcePermissionList() const { DARABONBA_PTR_GET_CONST(resourcePermissionList_, vector<CheckResourcePermissionResponseBodyResourcePermissionList>) };
    inline vector<CheckResourcePermissionResponseBodyResourcePermissionList> resourcePermissionList() { DARABONBA_PTR_GET(resourcePermissionList_, vector<CheckResourcePermissionResponseBodyResourcePermissionList>) };
    inline CheckResourcePermissionResponseBody& setResourcePermissionList(const vector<CheckResourcePermissionResponseBodyResourcePermissionList> & resourcePermissionList) { DARABONBA_PTR_SET_VALUE(resourcePermissionList_, resourcePermissionList) };
    inline CheckResourcePermissionResponseBody& setResourcePermissionList(vector<CheckResourcePermissionResponseBodyResourcePermissionList> && resourcePermissionList) { DARABONBA_PTR_SET_RVALUE(resourcePermissionList_, resourcePermissionList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CheckResourcePermissionResponseBodyResourcePermissionList>> resourcePermissionList_ = nullptr;
