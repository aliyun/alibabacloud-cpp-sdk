...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetDataServiceAppsByGroupIdResponseBodyAppInfoList> & appInfoList() const { DARABONBA_PTR_GET_CONST(appInfoList_, vector<GetDataServiceAppsByGroupIdResponseBodyAppInfoList>) };
    inline vector<GetDataServiceAppsByGroupIdResponseBodyAppInfoList> appInfoList() { DARABONBA_PTR_GET(appInfoList_, vector<GetDataServiceAppsByGroupIdResponseBodyAppInfoList>) };
    inline GetDataServiceAppsByGroupIdResponseBody& setAppInfoList(const vector<GetDataServiceAppsByGroupIdResponseBodyAppInfoList> & appInfoList) { DARABONBA_PTR_SET_VALUE(appInfoList_, appInfoList) };
    inline GetDataServiceAppsByGroupIdResponseBody& setAppInfoList(vector<GetDataServiceAppsByGroupIdResponseBodyAppInfoList> && appInfoList) { DARABONBA_PTR_SET_RVALUE(appInfoList_, appInfoList) };
  ...
  protected:
    std::shared_ptr<vector<GetDataServiceAppsByGroupIdResponseBodyAppInfoList>> appInfoList_ = nullptr;
