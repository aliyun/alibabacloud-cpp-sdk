...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetDirectoryTreeResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetDirectoryTreeResponseBodyData>) };
    inline vector<GetDirectoryTreeResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetDirectoryTreeResponseBodyData>) };
    inline GetDirectoryTreeResponseBody& setData(const vector<GetDirectoryTreeResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDirectoryTreeResponseBody& setData(vector<GetDirectoryTreeResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetDirectoryTreeResponseBodyData>> data_ = nullptr;
