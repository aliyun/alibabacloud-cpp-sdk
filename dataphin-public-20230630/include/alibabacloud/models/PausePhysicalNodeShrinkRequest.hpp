...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->env_ == nullptr
        && this->opTenantId_ == nullptr && this->opUserId_ == nullptr && this->pauseCommandShrink_ == nullptr; };
    // env Field Functions 
    ...
    inline PausePhysicalNodeShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline string getPauseCommandShrink() const { DARABONBA_PTR_GET_DEFAULT(pauseCommandShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> pauseCommandShrink_ {};
  };
