...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBizUnitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBizUnitResponseBody) };
    inline DeleteBizUnitResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBizUnitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBizUnitResponseBody> body_ {};
  };
