...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFileNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateFileNameResponseBody) };
    inline UpdateFileNameResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateFileNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateFileNameResponseBody> body_ {};
  };
