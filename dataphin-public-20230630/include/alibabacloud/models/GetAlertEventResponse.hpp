...
namespace Models
{
  ...
  public:
    ...
    inline const GetAlertEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAlertEventResponseBody) };
    inline GetAlertEventResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAlertEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAlertEventResponseBody> body_ {};
  };
