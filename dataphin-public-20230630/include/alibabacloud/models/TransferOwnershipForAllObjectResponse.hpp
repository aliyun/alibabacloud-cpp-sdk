...
namespace Models
{
  ...
  public:
    ...
    inline const TransferOwnershipForAllObjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TransferOwnershipForAllObjectResponseBody) };
    inline TransferOwnershipForAllObjectResponseBody getBody() { DARABONBA_PTR_GET(body_, TransferOwnershipForAllObjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TransferOwnershipForAllObjectResponseBody> body_ {};
  };
