...
namespace Models
{
  ...
  public:
    ...
    inline const ListComputeSourcesResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListComputeSourcesResponseBodyPageResult) };
    inline ListComputeSourcesResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListComputeSourcesResponseBodyPageResult) };
    inline ListComputeSourcesResponseBody& setPageResult(const ListComputeSourcesResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListComputeSourcesResponseBody& setPageResult(ListComputeSourcesResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListComputeSourcesResponseBodyPageResult> pageResult_ = nullptr;
    // Id of the request
