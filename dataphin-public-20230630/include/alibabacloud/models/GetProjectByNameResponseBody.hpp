...
namespace Models
{
  ...
  public:
    ...
    inline const GetProjectByNameResponseBody::ProjectInfo & getProjectInfo() const { DARABONBA_PTR_GET_CONST(projectInfo_, GetProjectByNameResponseBody::ProjectInfo) };
    inline GetProjectByNameResponseBody::ProjectInfo getProjectInfo() { DARABONBA_PTR_GET(projectInfo_, GetProjectByNameResponseBody::ProjectInfo) };
    inline GetProjectByNameResponseBody& setProjectInfo(const GetProjectByNameResponseBody::ProjectInfo & projectInfo) { DARABONBA_PTR_SET_VALUE(projectInfo_, projectInfo) };
    inline GetProjectByNameResponseBody& setProjectInfo(GetProjectByNameResponseBody::ProjectInfo && projectInfo) { DARABONBA_PTR_SET_RVALUE(projectInfo_, projectInfo) };
