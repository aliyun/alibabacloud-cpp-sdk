...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBatchTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBatchTaskResponseBody) };
    inline CreateBatchTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBatchTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBatchTaskResponseBody> body_ {};
  };
