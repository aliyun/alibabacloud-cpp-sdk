...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceByVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResourceByVersionResponseBody) };
    inline GetResourceByVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResourceByVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResourceByVersionResponseBody> body_ {};
  };
