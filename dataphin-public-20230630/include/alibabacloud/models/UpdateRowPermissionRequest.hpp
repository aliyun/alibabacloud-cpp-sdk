...
namespace Models
{
  ...
  public:
    ...
    class UpdateRowPermissionCommand : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const UpdateRowPermissionCommand& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, UpdateRowPermissionCommand& obj) { 
      ...
      UpdateRowPermissionCommand() = default ;
      UpdateRowPermissionCommand(const UpdateRowPermissionCommand &) = default ;
      UpdateRowPermissionCommand(UpdateRowPermissionCommand &&) = default ;
      UpdateRowPermissionCommand(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~UpdateRowPermissionCommand() = default ;
      UpdateRowPermissionCommand& operator=(const UpdateRowPermissionCommand &) = default ;
      UpdateRowPermissionCommand& operator=(UpdateRowPermissionCommand &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline const vector<UpdateRowPermissionCommand::MappingColumns> & getMappingColumns() const { DARABONBA_PTR_GET_CONST(mappingColumns_, vector<UpdateRowPermissionCommand::MappingColumns>) };
      inline vector<UpdateRowPermissionCommand::MappingColumns> getMappingColumns() { DARABONBA_PTR_GET(mappingColumns_, vector<UpdateRowPermissionCommand::MappingColumns>) };
      inline UpdateRowPermissionCommand& setMappingColumns(const vector<UpdateRowPermissionCommand::MappingColumns> & mappingColumns) { DARABONBA_PTR_SET_VALUE(mappingColumns_, mappingColumns) };
      inline UpdateRowPermissionCommand& setMappingColumns(vector<UpdateRowPermissionCommand::MappingColumns> && mappingColumns) { DARABONBA_PTR_SET_RVALUE(mappingColumns_, mappingColumns) };
      ...
      inline UpdateRowPermissionCommand& setRowPermissionDesc(string rowPermissionDesc) { DARABONBA_PTR_SET_VALUE(rowPermissionDesc_, rowPermissionDesc) };
      ...
      inline UpdateRowPermissionCommand& setRowPermissionId(int64_t rowPermissionId) { DARABONBA_PTR_SET_VALUE(rowPermissionId_, rowPermissionId) };
      ...
      inline UpdateRowPermissionCommand& setRowPermissionName(string rowPermissionName) { DARABONBA_PTR_SET_VALUE(rowPermissionName_, rowPermissionName) };


      // rules Field Functions 
      bool hasRules() const { return this->rules_ != nullptr;};
      void deleteRules() { this->rules_ = nullptr;};
      inline const vector<UpdateRowPermissionCommand::Rules> & getRules() const { DARABONBA_PTR_GET_CONST(rules_, vector<UpdateRowPermissionCommand::Rules>) };
      inline vector<UpdateRowPermissionCommand::Rules> getRules() { DARABONBA_PTR_GET(rules_, vector<UpdateRowPermissionCommand::Rules>) };
      inline UpdateRowPermissionCommand& setRules(const vector<UpdateRowPermissionCommand::Rules> & rules) { DARABONBA_PTR_SET_VALUE(rules_, rules) };
      inline UpdateRowPermissionCommand& setRules(vector<UpdateRowPermissionCommand::Rules> && rules) { DARABONBA_PTR_SET_RVALUE(rules_, rules) };


      // tables Field Functions 
      bool hasTables() const { return this->tables_ != nullptr;};
      void deleteTables() { this->tables_ = nullptr;};
      inline const vector<UpdateRowPermissionCommand::Tables> & getTables() const { DARABONBA_PTR_GET_CONST(tables_, vector<UpdateRowPermissionCommand::Tables>) };
      inline vector<UpdateRowPermissionCommand::Tables> getTables() { DARABONBA_PTR_GET(tables_, vector<UpdateRowPermissionCommand::Tables>) };
      inline UpdateRowPermissionCommand& setTables(const vector<UpdateRowPermissionCommand::Tables> & tables) { DARABONBA_PTR_SET_VALUE(tables_, tables) };
      inline UpdateRowPermissionCommand& setTables(vector<UpdateRowPermissionCommand::Tables> && tables) { DARABONBA_PTR_SET_RVALUE(tables_, tables) };
    ...
    virtual bool empty() const override { return this->opTenantId_ == nullptr
        && this->opUserId_ == nullptr && this->updateRowPermissionCommand_ == nullptr; };
    ...
    inline UpdateRowPermissionRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline const UpdateRowPermissionRequest::UpdateRowPermissionCommand & getUpdateRowPermissionCommand() const { DARABONBA_PTR_GET_CONST(updateRowPermissionCommand_, UpdateRowPermissionRequest::UpdateRowPermissionCommand) };
    inline UpdateRowPermissionRequest::UpdateRowPermissionCommand getUpdateRowPermissionCommand() { DARABONBA_PTR_GET(updateRowPermissionCommand_, UpdateRowPermissionRequest::UpdateRowPermissionCommand) };
    inline UpdateRowPermissionRequest& setUpdateRowPermissionCommand(const UpdateRowPermissionRequest::UpdateRowPermissionCommand & updateRowPermissionCommand) { DARABONBA_PTR_SET_VALUE(updateRowPermissionCommand_, updateRowPermissionCommand) };
    inline UpdateRowPermissionRequest& setUpdateRowPermissionCommand(UpdateRowPermissionRequest::UpdateRowPermissionCommand && updateRowPermissionCommand) { DARABONBA_PTR_SET_RVALUE(updateRowPermissionCommand_, updateRowPermissionCommand) };
