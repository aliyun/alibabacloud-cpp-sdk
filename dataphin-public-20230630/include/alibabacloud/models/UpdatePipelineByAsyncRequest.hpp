...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline UpdateCommand& setMode(string mode) { DARABONBA_PTR_SET_VALUE(mode_, mode) };


      // nodeInfo Field Functions 
      bool hasNodeInfo() const { return this->nodeInfo_ != nullptr;};
      void deleteNodeInfo() { this->nodeInfo_ = nullptr;};
      inline const UpdateCommand::NodeInfo & getNodeInfo() const { DARABONBA_PTR_GET_CONST(nodeInfo_, UpdateCommand::NodeInfo) };
      inline UpdateCommand::NodeInfo getNodeInfo() { DARABONBA_PTR_GET(nodeInfo_, UpdateCommand::NodeInfo) };
      inline UpdateCommand& setNodeInfo(const UpdateCommand::NodeInfo & nodeInfo) { DARABONBA_PTR_SET_VALUE(nodeInfo_, nodeInfo) };
      inline UpdateCommand& setNodeInfo(UpdateCommand::NodeInfo && nodeInfo) { DARABONBA_PTR_SET_RVALUE(nodeInfo_, nodeInfo) };
      ...
      inline const UpdateCommand::PipelineConfig & getPipelineConfig() const { DARABONBA_PTR_GET_CONST(pipelineConfig_, UpdateCommand::PipelineConfig) };
      inline UpdateCommand::PipelineConfig getPipelineConfig() { DARABONBA_PTR_GET(pipelineConfig_, UpdateCommand::PipelineConfig) };
      inline UpdateCommand& setPipelineConfig(const UpdateCommand::PipelineConfig & pipelineConfig) { DARABONBA_PTR_SET_VALUE(pipelineConfig_, pipelineConfig) };
      inline UpdateCommand& setPipelineConfig(UpdateCommand::PipelineConfig && pipelineConfig) { DARABONBA_PTR_SET_RVALUE(pipelineConfig_, pipelineConfig) };
      ...
      inline UpdateCommand& setPipelineJson(string pipelineJson) { DARABONBA_PTR_SET_VALUE(pipelineJson_, pipelineJson) };
      ...
      inline UpdateCommand& setPipelineType(int32_t pipelineType) { DARABONBA_PTR_SET_VALUE(pipelineType_, pipelineType) };
      ...
      inline UpdateCommand& setScheduleConfig(string scheduleConfig) { DARABONBA_PTR_SET_VALUE(scheduleConfig_, scheduleConfig) };
      ...
      inline UpdateCommand& setSettings(string settings) { DARABONBA_PTR_SET_VALUE(settings_, settings) };
      ...
      inline UpdateCommand& setSubmit(bool submit) { DARABONBA_PTR_SET_VALUE(submit_, submit) };
    ...
    protected:
      ...
      // 
      // This parameter is required.
      shared_ptr<UpdateCommand::NodeInfo> nodeInfo_ {};
      // The integration pipeline component configuration.
      // 
      // This parameter is required.
      shared_ptr<UpdateCommand::PipelineConfig> pipelineConfig_ {};
    ...
    inline const UpdatePipelineByAsyncRequest::Context & getContext() const { DARABONBA_PTR_GET_CONST(context_, UpdatePipelineByAsyncRequest::Context) };
    inline UpdatePipelineByAsyncRequest::Context getContext() { DARABONBA_PTR_GET(context_, UpdatePipelineByAsyncRequest::Context) };
    inline UpdatePipelineByAsyncRequest& setContext(const UpdatePipelineByAsyncRequest::Context & context) { DARABONBA_PTR_SET_VALUE(context_, context) };
    inline UpdatePipelineByAsyncRequest& setContext(UpdatePipelineByAsyncRequest::Context && context) { DARABONBA_PTR_SET_RVALUE(context_, context) };
    ...
    inline UpdatePipelineByAsyncRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline const UpdatePipelineByAsyncRequest::UpdateCommand & getUpdateCommand() const { DARABONBA_PTR_GET_CONST(updateCommand_, UpdatePipelineByAsyncRequest::UpdateCommand) };
    inline UpdatePipelineByAsyncRequest::UpdateCommand getUpdateCommand() { DARABONBA_PTR_GET(updateCommand_, UpdatePipelineByAsyncRequest::UpdateCommand) };
    inline UpdatePipelineByAsyncRequest& setUpdateCommand(const UpdatePipelineByAsyncRequest::UpdateCommand & updateCommand) { DARABONBA_PTR_SET_VALUE(updateCommand_, updateCommand) };
    inline UpdatePipelineByAsyncRequest& setUpdateCommand(UpdatePipelineByAsyncRequest::UpdateCommand && updateCommand) { DARABONBA_PTR_SET_RVALUE(updateCommand_, updateCommand) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<UpdatePipelineByAsyncRequest::Context> context_ {};
    // The tenant ID.
    // 
    // This parameter is required.
    ...
    // 
    // This parameter is required.
    shared_ptr<UpdatePipelineByAsyncRequest::UpdateCommand> updateCommand_ {};
  };
