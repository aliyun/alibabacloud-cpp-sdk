...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceMyApiPermissionsResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListDataServiceMyApiPermissionsResponseBodyPageResult) };
    inline ListDataServiceMyApiPermissionsResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListDataServiceMyApiPermissionsResponseBodyPageResult) };
    inline ListDataServiceMyApiPermissionsResponseBody& setPageResult(const ListDataServiceMyApiPermissionsResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListDataServiceMyApiPermissionsResponseBody& setPageResult(ListDataServiceMyApiPermissionsResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataServiceMyApiPermissionsResponseBodyPageResult> pageResult_ = nullptr;
    // Id of the request
