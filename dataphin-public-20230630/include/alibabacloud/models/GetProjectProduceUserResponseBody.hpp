...
namespace Models
{
  ...
  public:
    ...
    inline const GetProjectProduceUserResponseBodyUser & user() const { DARABONBA_PTR_GET_CONST(user_, GetProjectProduceUserResponseBodyUser) };
    inline GetProjectProduceUserResponseBodyUser user() { DARABONBA_PTR_GET(user_, GetProjectProduceUserResponseBodyUser) };
    inline GetProjectProduceUserResponseBody& setUser(const GetProjectProduceUserResponseBodyUser & user) { DARABONBA_PTR_SET_VALUE(user_, user) };
    inline GetProjectProduceUserResponseBody& setUser(GetProjectProduceUserResponseBodyUser && user) { DARABONBA_PTR_SET_RVALUE(user_, user) };
  ...
  protected:
    ...
    std::shared_ptr<GetProjectProduceUserResponseBodyUser> user_ = nullptr;
  };
