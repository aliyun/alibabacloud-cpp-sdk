  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline const vector<QualityRuleList::AttributeWithValueList> & getAttributeWithValueList() const { DARABONBA_PTR_GET_CONST(attributeWithValueList_, vector<QualityRuleList::AttributeWithValueList>) };
        inline vector<QualityRuleList::AttributeWithValueList> getAttributeWithValueList() { DARABONBA_PTR_GET(attributeWithValueList_, vector<QualityRuleList::AttributeWithValueList>) };
        inline QualityRuleList& setAttributeWithValueList(const vector<QualityRuleList::AttributeWithValueList> & attributeWithValueList) { DARABONBA_PTR_SET_VALUE(attributeWithValueList_, attributeWithValueList) };
        inline QualityRuleList& setAttributeWithValueList(vector<QualityRuleList::AttributeWithValueList> && attributeWithValueList) { DARABONBA_PTR_SET_RVALUE(attributeWithValueList_, attributeWithValueList) };
        ...
        inline QualityRuleList& setCatalogList(const vector<string> & catalogList) { DARABONBA_PTR_SET_VALUE(catalogList_, catalogList) };
        inline QualityRuleList& setCatalogList(vector<string> && catalogList) { DARABONBA_PTR_SET_RVALUE(catalogList_, catalogList) };
        ...
        inline QualityRuleList& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
        ...
        inline QualityRuleList& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
        ...
        inline QualityRuleList& setCreatorName(string creatorName) { DARABONBA_PTR_SET_VALUE(creatorName_, creatorName) };
        ...
        void deleteDescription() { this->description_ = nullptr;};
        inline string getDescription() const { DARABONBA_PTR_GET_DEFAULT(description_, "") };
        inline QualityRuleList& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
        ...
        inline QualityRuleList& setEnableErrorArchive(bool enableErrorArchive) { DARABONBA_PTR_SET_VALUE(enableErrorArchive_, enableErrorArchive) };
        ...
        inline const vector<QualityRuleList::FormPropertyList> & getFormPropertyList() const { DARABONBA_PTR_GET_CONST(formPropertyList_, vector<QualityRuleList::FormPropertyList>) };
        inline vector<QualityRuleList::FormPropertyList> getFormPropertyList() { DARABONBA_PTR_GET(formPropertyList_, vector<QualityRuleList::FormPropertyList>) };
        inline QualityRuleList& setFormPropertyList(const vector<QualityRuleList::FormPropertyList> & formPropertyList) { DARABONBA_PTR_SET_VALUE(formPropertyList_, formPropertyList) };
        inline QualityRuleList& setFormPropertyList(vector<QualityRuleList::FormPropertyList> && formPropertyList) { DARABONBA_PTR_SET_RVALUE(formPropertyList_, formPropertyList) };
        ...
        void deleteId() { this->id_ = nullptr;};
        inline int64_t getId() const { DARABONBA_PTR_GET_DEFAULT(id_, 0L) };
        inline QualityRuleList& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
        ...
        inline QualityRuleList& setModifier(string modifier) { DARABONBA_PTR_SET_VALUE(modifier_, modifier) };
        ...
        inline QualityRuleList& setModifierName(string modifierName) { DARABONBA_PTR_SET_VALUE(modifierName_, modifierName) };
        ...
        inline QualityRuleList& setModifyTime(string modifyTime) { DARABONBA_PTR_SET_VALUE(modifyTime_, modifyTime) };
        ...
        inline const vector<QualityRuleList::ScheduleBindList> & getScheduleBindList() const { DARABONBA_PTR_GET_CONST(scheduleBindList_, vector<QualityRuleList::ScheduleBindList>) };
        inline vector<QualityRuleList::ScheduleBindList> getScheduleBindList() { DARABONBA_PTR_GET(scheduleBindList_, vector<QualityRuleList::ScheduleBindList>) };
        inline QualityRuleList& setScheduleBindList(const vector<QualityRuleList::ScheduleBindList> & scheduleBindList) { DARABONBA_PTR_SET_VALUE(scheduleBindList_, scheduleBindList) };
        inline QualityRuleList& setScheduleBindList(vector<QualityRuleList::ScheduleBindList> && scheduleBindList) { DARABONBA_PTR_SET_RVALUE(scheduleBindList_, scheduleBindList) };
        ...
        inline QualityRuleList& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
        ...
        inline QualityRuleList& setStrength(string strength) { DARABONBA_PTR_SET_VALUE(strength_, strength) };
        ...
        inline QualityRuleList& setTemplateId(int64_t templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
        ...
        inline QualityRuleList& setTemplateName(string templateName) { DARABONBA_PTR_SET_VALUE(templateName_, templateName) };
        ...
        inline QualityRuleList& setTemplateScope(string templateScope) { DARABONBA_PTR_SET_VALUE(templateScope_, templateScope) };
        ...
        inline QualityRuleList& setTemplateType(string templateType) { DARABONBA_PTR_SET_VALUE(templateType_, templateType) };
        ...
        inline QualityRuleList& setTestRunRuleTaskId(int64_t testRunRuleTaskId) { DARABONBA_PTR_SET_VALUE(testRunRuleTaskId_, testRunRuleTaskId) };
        ...
        inline QualityRuleList& setTestRunRuleTaskStatus(string testRunRuleTaskStatus) { DARABONBA_PTR_SET_VALUE(testRunRuleTaskStatus_, testRunRuleTaskStatus) };
        ...
        inline QualityRuleList& setTestRunRuleValidateResult(bool testRunRuleValidateResult) { DARABONBA_PTR_SET_VALUE(testRunRuleValidateResult_, testRunRuleValidateResult) };
        ...
        inline const vector<QualityRuleList::ValidateConditionList> & getValidateConditionList() const { DARABONBA_PTR_GET_CONST(validateConditionList_, vector<QualityRuleList::ValidateConditionList>) };
        inline vector<QualityRuleList::ValidateConditionList> getValidateConditionList() { DARABONBA_PTR_GET(validateConditionList_, vector<QualityRuleList::ValidateConditionList>) };
        inline QualityRuleList& setValidateConditionList(const vector<QualityRuleList::ValidateConditionList> & validateConditionList) { DARABONBA_PTR_SET_VALUE(validateConditionList_, validateConditionList) };
        inline QualityRuleList& setValidateConditionList(vector<QualityRuleList::ValidateConditionList> && validateConditionList) { DARABONBA_PTR_SET_RVALUE(validateConditionList_, validateConditionList) };
        ...
        inline const QualityRuleList::ValidateObject & getValidateObject() const { DARABONBA_PTR_GET_CONST(validateObject_, QualityRuleList::ValidateObject) };
        inline QualityRuleList::ValidateObject getValidateObject() { DARABONBA_PTR_GET(validateObject_, QualityRuleList::ValidateObject) };
        inline QualityRuleList& setValidateObject(const QualityRuleList::ValidateObject & validateObject) { DARABONBA_PTR_SET_VALUE(validateObject_, validateObject) };
        inline QualityRuleList& setValidateObject(QualityRuleList::ValidateObject && validateObject) { DARABONBA_PTR_SET_RVALUE(validateObject_, validateObject) };
        ...
        inline QualityRuleList& setWatchId(int64_t watchId) { DARABONBA_PTR_SET_VALUE(watchId_, watchId) };
      ...
      virtual bool empty() const override { return this->qualityRuleList_ == nullptr
      ...
      inline const vector<PageResult::QualityRuleList> & getQualityRuleList() const { DARABONBA_PTR_GET_CONST(qualityRuleList_, vector<PageResult::QualityRuleList>) };
      inline vector<PageResult::QualityRuleList> getQualityRuleList() { DARABONBA_PTR_GET(qualityRuleList_, vector<PageResult::QualityRuleList>) };
      inline PageResult& setQualityRuleList(const vector<PageResult::QualityRuleList> & qualityRuleList) { DARABONBA_PTR_SET_VALUE(qualityRuleList_, qualityRuleList) };
      inline PageResult& setQualityRuleList(vector<PageResult::QualityRuleList> && qualityRuleList) { DARABONBA_PTR_SET_RVALUE(qualityRuleList_, qualityRuleList) };
    ...
    inline ListQualityRulesResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ListQualityRulesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline const ListQualityRulesResponseBody::PageResult & getPageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListQualityRulesResponseBody::PageResult) };
    inline ListQualityRulesResponseBody::PageResult getPageResult() { DARABONBA_PTR_GET(pageResult_, ListQualityRulesResponseBody::PageResult) };
    inline ListQualityRulesResponseBody& setPageResult(const ListQualityRulesResponseBody::PageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListQualityRulesResponseBody& setPageResult(ListQualityRulesResponseBody::PageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
