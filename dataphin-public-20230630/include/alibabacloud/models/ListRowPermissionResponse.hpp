...
namespace Models
{
  ...
  public:
    ...
    inline const ListRowPermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRowPermissionResponseBody) };
    inline ListRowPermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRowPermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRowPermissionResponseBody> body_ {};
  };
