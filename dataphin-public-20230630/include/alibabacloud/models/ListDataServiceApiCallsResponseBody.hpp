...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceApiCallsResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListDataServiceApiCallsResponseBodyPageResult) };
    inline ListDataServiceApiCallsResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListDataServiceApiCallsResponseBodyPageResult) };
    inline ListDataServiceApiCallsResponseBody& setPageResult(const ListDataServiceApiCallsResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListDataServiceApiCallsResponseBody& setPageResult(ListDataServiceApiCallsResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataServiceApiCallsResponseBodyPageResult> pageResult_ = nullptr;
    // Id of the request
