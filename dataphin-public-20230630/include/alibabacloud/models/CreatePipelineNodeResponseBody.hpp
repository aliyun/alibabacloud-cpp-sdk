...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePipelineNodeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreatePipelineNodeResponseBodyData) };
    inline CreatePipelineNodeResponseBodyData data() { DARABONBA_PTR_GET(data_, CreatePipelineNodeResponseBodyData) };
    inline CreatePipelineNodeResponseBody& setData(const CreatePipelineNodeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreatePipelineNodeResponseBody& setData(CreatePipelineNodeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreatePipelineNodeResponseBodyData> data_ = nullptr;
