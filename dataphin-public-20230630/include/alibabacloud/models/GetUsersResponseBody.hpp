...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetUsersResponseBodyUserList> & userList() const { DARABONBA_PTR_GET_CONST(userList_, vector<GetUsersResponseBodyUserList>) };
    inline vector<GetUsersResponseBodyUserList> userList() { DARABONBA_PTR_GET(userList_, vector<GetUsersResponseBodyUserList>) };
    inline GetUsersResponseBody& setUserList(const vector<GetUsersResponseBodyUserList> & userList) { DARABONBA_PTR_SET_VALUE(userList_, userList) };
    inline GetUsersResponseBody& setUserList(vector<GetUsersResponseBodyUserList> && userList) { DARABONBA_PTR_SET_RVALUE(userList_, userList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetUsersResponseBodyUserList>> userList_ = nullptr;
  };
