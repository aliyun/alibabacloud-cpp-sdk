...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getDevelopOwnerId() const { DARABONBA_PTR_GET_DEFAULT(developOwnerId_, "") };
      ...
      inline string getOpsOwnerId() const { DARABONBA_PTR_GET_DEFAULT(opsOwnerId_, "") };
    ...
    inline const GetBatchTaskInfoResponseBody::TaskInfo & getTaskInfo() const { DARABONBA_PTR_GET_CONST(taskInfo_, GetBatchTaskInfoResponseBody::TaskInfo) };
    inline GetBatchTaskInfoResponseBody::TaskInfo getTaskInfo() { DARABONBA_PTR_GET(taskInfo_, GetBatchTaskInfoResponseBody::TaskInfo) };
    inline GetBatchTaskInfoResponseBody& setTaskInfo(const GetBatchTaskInfoResponseBody::TaskInfo & taskInfo) { DARABONBA_PTR_SET_VALUE(taskInfo_, taskInfo) };
    inline GetBatchTaskInfoResponseBody& setTaskInfo(GetBatchTaskInfoResponseBody::TaskInfo && taskInfo) { DARABONBA_PTR_SET_RVALUE(taskInfo_, taskInfo) };
