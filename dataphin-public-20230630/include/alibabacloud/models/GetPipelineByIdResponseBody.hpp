...
#include <alibabacloud/models/GetPipelineByIdResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetPipelineByIdResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPipelineByIdResponseBodyData) };
    inline GetPipelineByIdResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPipelineByIdResponseBodyData) };
    inline GetPipelineByIdResponseBody& setData(const GetPipelineByIdResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPipelineByIdResponseBody& setData(GetPipelineByIdResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetPipelineByIdResponseBodyData> data_ = nullptr;
