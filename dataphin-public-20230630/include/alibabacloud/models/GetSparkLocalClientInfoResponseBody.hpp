...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetSparkLocalClientInfoResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetSparkLocalClientInfoResponseBodyData>) };
    inline vector<GetSparkLocalClientInfoResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetSparkLocalClientInfoResponseBodyData>) };
    inline GetSparkLocalClientInfoResponseBody& setData(const vector<GetSparkLocalClientInfoResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSparkLocalClientInfoResponseBody& setData(vector<GetSparkLocalClientInfoResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetSparkLocalClientInfoResponseBodyData>> data_ = nullptr;
