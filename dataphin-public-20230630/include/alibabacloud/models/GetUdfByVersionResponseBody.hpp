...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->udfInfo_ == nullptr; };
    ...
    inline const GetUdfByVersionResponseBodyUdfInfo & udfInfo() const { DARABONBA_PTR_GET_CONST(udfInfo_, GetUdfByVersionResponseBodyUdfInfo) };
    inline GetUdfByVersionResponseBodyUdfInfo udfInfo() { DARABONBA_PTR_GET(udfInfo_, GetUdfByVersionResponseBodyUdfInfo) };
    inline GetUdfByVersionResponseBody& setUdfInfo(const GetUdfByVersionResponseBodyUdfInfo & udfInfo) { DARABONBA_PTR_SET_VALUE(udfInfo_, udfInfo) };
    inline GetUdfByVersionResponseBody& setUdfInfo(GetUdfByVersionResponseBodyUdfInfo && udfInfo) { DARABONBA_PTR_SET_RVALUE(udfInfo_, udfInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetUdfByVersionResponseBodyUdfInfo> udfInfo_ = nullptr;
  };
