...
namespace Models
{
  ...
  public:
    ...
    inline const ListRowPermissionByUserIdResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListRowPermissionByUserIdResponseBodyPageResult) };
    inline ListRowPermissionByUserIdResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListRowPermissionByUserIdResponseBodyPageResult) };
    inline ListRowPermissionByUserIdResponseBody& setPageResult(const ListRowPermissionByUserIdResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListRowPermissionByUserIdResponseBody& setPageResult(ListRowPermissionByUserIdResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListRowPermissionByUserIdResponseBodyPageResult> pageResult_ = nullptr;
