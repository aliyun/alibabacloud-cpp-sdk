...
#include <alibabacloud/models/CreatePipelineResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePipelineResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreatePipelineResponseBodyData) };
    inline CreatePipelineResponseBodyData data() { DARABONBA_PTR_GET(data_, CreatePipelineResponseBodyData) };
    inline CreatePipelineResponseBody& setData(const CreatePipelineResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreatePipelineResponseBody& setData(CreatePipelineResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreatePipelineResponseBodyData> data_ = nullptr;
