...
namespace Models
{
  ...
  public:
    ...
    inline const ResumePhysicalNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResumePhysicalNodeResponseBody) };
    inline ResumePhysicalNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, ResumePhysicalNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResumePhysicalNodeResponseBody> body_ {};
  };
