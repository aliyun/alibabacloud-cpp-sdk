...
#ifndef ALIBABACLOUD_MODELS_GETLLMMODELPROVIDERBYNAMERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETLLMMODELPROVIDERBYNAMERESPONSEBODY_HPP_
...
namespace Models
{
  class GetLlmModelProviderByNameResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetLlmModelProviderByNameResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetLlmModelProviderByNameResponseBody& obj) { 
    ...
    GetLlmModelProviderByNameResponseBody() = default ;
    GetLlmModelProviderByNameResponseBody(const GetLlmModelProviderByNameResponseBody &) = default ;
    GetLlmModelProviderByNameResponseBody(GetLlmModelProviderByNameResponseBody &&) = default ;
    GetLlmModelProviderByNameResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetLlmModelProviderByNameResponseBody() = default ;
    GetLlmModelProviderByNameResponseBody& operator=(const GetLlmModelProviderByNameResponseBody &) = default ;
    GetLlmModelProviderByNameResponseBody& operator=(GetLlmModelProviderByNameResponseBody &&) = default ;
    ...
    inline GetLlmModelProviderByNameResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetLlmModelProviderByNameResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetLlmModelProviderByNameResponseBody::Data) };
    inline GetLlmModelProviderByNameResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetLlmModelProviderByNameResponseBody::Data) };
    inline GetLlmModelProviderByNameResponseBody& setData(const GetLlmModelProviderByNameResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetLlmModelProviderByNameResponseBody& setData(GetLlmModelProviderByNameResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetLlmModelProviderByNameResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetLlmModelProviderByNameResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetLlmModelProviderByNameResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetLlmModelProviderByNameResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<GetLlmModelProviderByNameResponseBody::Data> data_ {};
