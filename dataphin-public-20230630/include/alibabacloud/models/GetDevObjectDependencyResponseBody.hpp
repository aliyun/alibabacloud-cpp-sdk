...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->devObjectDependencyList_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<GetDevObjectDependencyResponseBodyDevObjectDependencyList> & devObjectDependencyList() const { DARABONBA_PTR_GET_CONST(devObjectDependencyList_, vector<GetDevObjectDependencyResponseBodyDevObjectDependencyList>) };
    inline vector<GetDevObjectDependencyResponseBodyDevObjectDependencyList> devObjectDependencyList() { DARABONBA_PTR_GET(devObjectDependencyList_, vector<GetDevObjectDependencyResponseBodyDevObjectDependencyList>) };
    inline GetDevObjectDependencyResponseBody& setDevObjectDependencyList(const vector<GetDevObjectDependencyResponseBodyDevObjectDependencyList> & devObjectDependencyList) { DARABONBA_PTR_SET_VALUE(devObjectDependencyList_, devObjectDependencyList) };
    inline GetDevObjectDependencyResponseBody& setDevObjectDependencyList(vector<GetDevObjectDependencyResponseBodyDevObjectDependencyList> && devObjectDependencyList) { DARABONBA_PTR_SET_RVALUE(devObjectDependencyList_, devObjectDependencyList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetDevObjectDependencyResponseBodyDevObjectDependencyList>> devObjectDependencyList_ = nullptr;
