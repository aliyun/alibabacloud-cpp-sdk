...
#ifndef ALIBABACLOUD_MODELS_LISTAPIBYAPPRESPONSEBODYLISTRESULTDATAPUBLICPARAMLIST_HPP_
#define ALIBABACLOUD_MODELS_LISTAPIBYAPPRESPONSEBODYLISTRESULTDATAPUBLICPARAMLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListApiByAppResponseBodyListResultDataPublicParamList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListApiByAppResponseBodyListResultDataPublicParamList& obj) { 
    ...
    ListApiByAppResponseBodyListResultDataPublicParamList() = default ;
    ListApiByAppResponseBodyListResultDataPublicParamList(const ListApiByAppResponseBodyListResultDataPublicParamList &) = default ;
    ListApiByAppResponseBodyListResultDataPublicParamList(ListApiByAppResponseBodyListResultDataPublicParamList &&) = default ;
    ListApiByAppResponseBodyListResultDataPublicParamList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListApiByAppResponseBodyListResultDataPublicParamList() = default ;
    ListApiByAppResponseBodyListResultDataPublicParamList& operator=(const ListApiByAppResponseBodyListResultDataPublicParamList &) = default ;
    ListApiByAppResponseBodyListResultDataPublicParamList& operator=(ListApiByAppResponseBodyListResultDataPublicParamList &&) = default ;
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setDateFormat(string dateFormat) { DARABONBA_PTR_SET_VALUE(dateFormat_, dateFormat) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setDescriptionCode(string descriptionCode) { DARABONBA_PTR_SET_VALUE(descriptionCode_, descriptionCode) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setInitialValue(string initialValue) { DARABONBA_PTR_SET_VALUE(initialValue_, initialValue) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setMappingColumn(string mappingColumn) { DARABONBA_PTR_SET_VALUE(mappingColumn_, mappingColumn) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setMust(int64_t must) { DARABONBA_PTR_SET_VALUE(must_, must) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setOperator(string _operator) { DARABONBA_PTR_SET_VALUE(operator_, _operator) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setOptional(int64_t optional) { DARABONBA_PTR_SET_VALUE(optional_, optional) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setOriginalColumn(string originalColumn) { DARABONBA_PTR_SET_VALUE(originalColumn_, originalColumn) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setParamName(string paramName) { DARABONBA_PTR_SET_VALUE(paramName_, paramName) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setParamType(string paramType) { DARABONBA_PTR_SET_VALUE(paramType_, paramType) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setParameterLocation(string parameterLocation) { DARABONBA_PTR_SET_VALUE(parameterLocation_, parameterLocation) };
    ...
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setSample(string sample) { DARABONBA_PTR_SET_VALUE(sample_, sample) };
    ...
    inline const vector<Models::ListApiByAppResponseBodyListResultDataPublicParamListTableAndDsList> & tableAndDsList() const { DARABONBA_PTR_GET_CONST(tableAndDsList_, vector<Models::ListApiByAppResponseBodyListResultDataPublicParamListTableAndDsList>) };
    inline vector<Models::ListApiByAppResponseBodyListResultDataPublicParamListTableAndDsList> tableAndDsList() { DARABONBA_PTR_GET(tableAndDsList_, vector<Models::ListApiByAppResponseBodyListResultDataPublicParamListTableAndDsList>) };
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setTableAndDsList(const vector<Models::ListApiByAppResponseBodyListResultDataPublicParamListTableAndDsList> & tableAndDsList) { DARABONBA_PTR_SET_VALUE(tableAndDsList_, tableAndDsList) };
    inline ListApiByAppResponseBodyListResultDataPublicParamList& setTableAndDsList(vector<Models::ListApiByAppResponseBodyListResultDataPublicParamListTableAndDsList> && tableAndDsList) { DARABONBA_PTR_SET_RVALUE(tableAndDsList_, tableAndDsList) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<vector<Models::ListApiByAppResponseBodyListResultDataPublicParamListTableAndDsList>> tableAndDsList_ = nullptr;
  };
