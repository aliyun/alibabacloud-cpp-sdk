...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceResponseBody::ResourceInfo & getResourceInfo() const { DARABONBA_PTR_GET_CONST(resourceInfo_, GetResourceResponseBody::ResourceInfo) };
    inline GetResourceResponseBody::ResourceInfo getResourceInfo() { DARABONBA_PTR_GET(resourceInfo_, GetResourceResponseBody::ResourceInfo) };
    inline GetResourceResponseBody& setResourceInfo(const GetResourceResponseBody::ResourceInfo & resourceInfo) { DARABONBA_PTR_SET_VALUE(resourceInfo_, resourceInfo) };
    inline GetResourceResponseBody& setResourceInfo(GetResourceResponseBody::ResourceInfo && resourceInfo) { DARABONBA_PTR_SET_RVALUE(resourceInfo_, resourceInfo) };
  ...
  protected:
    ...
    shared_ptr<GetResourceResponseBody::ResourceInfo> resourceInfo_ {};
