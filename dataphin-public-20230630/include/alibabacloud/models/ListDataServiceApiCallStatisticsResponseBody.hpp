...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceApiCallStatisticsResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListDataServiceApiCallStatisticsResponseBodyPageResult) };
    inline ListDataServiceApiCallStatisticsResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListDataServiceApiCallStatisticsResponseBodyPageResult) };
    inline ListDataServiceApiCallStatisticsResponseBody& setPageResult(const ListDataServiceApiCallStatisticsResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListDataServiceApiCallStatisticsResponseBody& setPageResult(ListDataServiceApiCallStatisticsResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataServiceApiCallStatisticsResponseBodyPageResult> pageResult_ = nullptr;
    // Id of the request
