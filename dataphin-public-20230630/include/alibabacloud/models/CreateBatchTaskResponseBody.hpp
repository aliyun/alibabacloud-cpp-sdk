...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline CreateResult& setFileId(int64_t fileId) { DARABONBA_PTR_SET_VALUE(fileId_, fileId) };
    ...
    inline CreateBatchTaskResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline const CreateBatchTaskResponseBody::CreateResult & getCreateResult() const { DARABONBA_PTR_GET_CONST(createResult_, CreateBatchTaskResponseBody::CreateResult) };
    inline CreateBatchTaskResponseBody::CreateResult getCreateResult() { DARABONBA_PTR_GET(createResult_, CreateBatchTaskResponseBody::CreateResult) };
    inline CreateBatchTaskResponseBody& setCreateResult(const CreateBatchTaskResponseBody::CreateResult & createResult) { DARABONBA_PTR_SET_VALUE(createResult_, createResult) };
    inline CreateBatchTaskResponseBody& setCreateResult(CreateBatchTaskResponseBody::CreateResult && createResult) { DARABONBA_PTR_SET_RVALUE(createResult_, createResult) };
    ...
    inline CreateBatchTaskResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateBatchTaskResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateBatchTaskResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<CreateBatchTaskResponseBody::CreateResult> createResult_ {};
