...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBatchTaskResponseBodyCreateResult & createResult() const { DARABONBA_PTR_GET_CONST(createResult_, CreateBatchTaskResponseBodyCreateResult) };
    inline CreateBatchTaskResponseBodyCreateResult createResult() { DARABONBA_PTR_GET(createResult_, CreateBatchTaskResponseBodyCreateResult) };
    inline CreateBatchTaskResponseBody& setCreateResult(const CreateBatchTaskResponseBodyCreateResult & createResult) { DARABONBA_PTR_SET_VALUE(createResult_, createResult) };
    inline CreateBatchTaskResponseBody& setCreateResult(CreateBatchTaskResponseBodyCreateResult && createResult) { DARABONBA_PTR_SET_RVALUE(createResult_, createResult) };
  ...
  protected:
    ...
    std::shared_ptr<CreateBatchTaskResponseBodyCreateResult> createResult_ = nullptr;
