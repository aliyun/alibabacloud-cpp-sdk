...
namespace Models
{
  ...
  public:
    ...
    inline const CheckProjectHasDependencyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckProjectHasDependencyResponseBody) };
    inline CheckProjectHasDependencyResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckProjectHasDependencyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckProjectHasDependencyResponseBody> body_ {};
  };
