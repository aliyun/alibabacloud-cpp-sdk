...
namespace Models
{
  ...
  public:
    ...
    inline const AddRegisterLineageResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddRegisterLineageResponseBody) };
    inline AddRegisterLineageResponseBody body() { DARABONBA_PTR_GET(body_, AddRegisterLineageResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddRegisterLineageResponseBody> body_ = nullptr;
  };
