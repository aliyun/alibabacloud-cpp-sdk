...
namespace Models
{
  ...
  public:
    ...
    inline const ListBizUnitsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListBizUnitsResponseBodyData) };
    inline ListBizUnitsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListBizUnitsResponseBodyData) };
    inline ListBizUnitsResponseBody& setData(const ListBizUnitsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListBizUnitsResponseBody& setData(ListBizUnitsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListBizUnitsResponseBodyData> data_ = nullptr;
