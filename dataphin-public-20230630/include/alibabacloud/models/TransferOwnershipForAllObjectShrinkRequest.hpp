...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->opTenantId_ == nullptr
        && this->opUserId_ == nullptr && this->privilegeTransferRecordShrink_ == nullptr; };
    ...
    inline TransferOwnershipForAllObjectShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline string getPrivilegeTransferRecordShrink() const { DARABONBA_PTR_GET_DEFAULT(privilegeTransferRecordShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> privilegeTransferRecordShrink_ {};
  };
