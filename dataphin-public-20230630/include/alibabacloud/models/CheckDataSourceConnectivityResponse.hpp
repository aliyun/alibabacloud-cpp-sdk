...
namespace Models
{
  ...
  public:
    ...
    inline const CheckDataSourceConnectivityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckDataSourceConnectivityResponseBody) };
    inline CheckDataSourceConnectivityResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckDataSourceConnectivityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckDataSourceConnectivityResponseBody> body_ {};
  };
