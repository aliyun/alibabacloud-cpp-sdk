...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->grantCommandShrink_ != nullptr
    ...
    inline string grantCommandShrink() const { DARABONBA_PTR_GET_DEFAULT(grantCommandShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> grantCommandShrink_ = nullptr;
    // This parameter is required.
