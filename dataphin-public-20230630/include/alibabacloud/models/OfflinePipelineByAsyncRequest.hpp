...
namespace Models
{
  ...
  public:
    ...
    inline const OfflinePipelineByAsyncRequest::Context & getContext() const { DARABONBA_PTR_GET_CONST(context_, OfflinePipelineByAsyncRequest::Context) };
    inline OfflinePipelineByAsyncRequest::Context getContext() { DARABONBA_PTR_GET(context_, OfflinePipelineByAsyncRequest::Context) };
    inline OfflinePipelineByAsyncRequest& setContext(const OfflinePipelineByAsyncRequest::Context & context) { DARABONBA_PTR_SET_VALUE(context_, context) };
    inline OfflinePipelineByAsyncRequest& setContext(OfflinePipelineByAsyncRequest::Context && context) { DARABONBA_PTR_SET_RVALUE(context_, context) };
    ...
    inline const OfflinePipelineByAsyncRequest::OfflineCommand & getOfflineCommand() const { DARABONBA_PTR_GET_CONST(offlineCommand_, OfflinePipelineByAsyncRequest::OfflineCommand) };
    inline OfflinePipelineByAsyncRequest::OfflineCommand getOfflineCommand() { DARABONBA_PTR_GET(offlineCommand_, OfflinePipelineByAsyncRequest::OfflineCommand) };
    inline OfflinePipelineByAsyncRequest& setOfflineCommand(const OfflinePipelineByAsyncRequest::OfflineCommand & offlineCommand) { DARABONBA_PTR_SET_VALUE(offlineCommand_, offlineCommand) };
    inline OfflinePipelineByAsyncRequest& setOfflineCommand(OfflinePipelineByAsyncRequest::OfflineCommand && offlineCommand) { DARABONBA_PTR_SET_RVALUE(offlineCommand_, offlineCommand) };
    ...
    inline OfflinePipelineByAsyncRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
