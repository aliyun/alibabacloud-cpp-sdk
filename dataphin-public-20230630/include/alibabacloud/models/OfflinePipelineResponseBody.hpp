...
#include <alibabacloud/models/OfflinePipelineResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const OfflinePipelineResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, OfflinePipelineResponseBodyData) };
    inline OfflinePipelineResponseBodyData data() { DARABONBA_PTR_GET(data_, OfflinePipelineResponseBodyData) };
    inline OfflinePipelineResponseBody& setData(const OfflinePipelineResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline OfflinePipelineResponseBody& setData(OfflinePipelineResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<OfflinePipelineResponseBodyData> data_ = nullptr;
