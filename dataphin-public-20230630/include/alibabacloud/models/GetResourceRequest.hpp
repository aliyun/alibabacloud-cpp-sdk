...
namespace Models
{
  ...
  public:
    ...
    inline GetResourceRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetResourceRequest& setOpTenantId(int64_t opTenantId) { DARABONBA_PTR_SET_VALUE(opTenantId_, opTenantId) };
    ...
    inline GetResourceRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
