...
namespace Models
{
  ...
  public:
    ...
    inline const AddDataServiceProjectMemberRequestAddCommand & addCommand() const { DARABONBA_PTR_GET_CONST(addCommand_, AddDataServiceProjectMemberRequestAddCommand) };
    inline AddDataServiceProjectMemberRequestAddCommand addCommand() { DARABONBA_PTR_GET(addCommand_, AddDataServiceProjectMemberRequestAddCommand) };
    inline AddDataServiceProjectMemberRequest& setAddCommand(const AddDataServiceProjectMemberRequestAddCommand & addCommand) { DARABONBA_PTR_SET_VALUE(addCommand_, addCommand) };
    inline AddDataServiceProjectMemberRequest& setAddCommand(AddDataServiceProjectMemberRequestAddCommand && addCommand) { DARABONBA_PTR_SET_RVALUE(addCommand_, addCommand) };
  ...
  protected:
    ...
    std::shared_ptr<AddDataServiceProjectMemberRequestAddCommand> addCommand_ = nullptr;
    // This parameter is required.
