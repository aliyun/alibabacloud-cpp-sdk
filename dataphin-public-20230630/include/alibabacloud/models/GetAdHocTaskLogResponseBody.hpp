...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->logInfo_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetAdHocTaskLogResponseBodyLogInfo & logInfo() const { DARABONBA_PTR_GET_CONST(logInfo_, GetAdHocTaskLogResponseBodyLogInfo) };
    inline GetAdHocTaskLogResponseBodyLogInfo logInfo() { DARABONBA_PTR_GET(logInfo_, GetAdHocTaskLogResponseBodyLogInfo) };
    inline GetAdHocTaskLogResponseBody& setLogInfo(const GetAdHocTaskLogResponseBodyLogInfo & logInfo) { DARABONBA_PTR_SET_VALUE(logInfo_, logInfo) };
    inline GetAdHocTaskLogResponseBody& setLogInfo(GetAdHocTaskLogResponseBodyLogInfo && logInfo) { DARABONBA_PTR_SET_RVALUE(logInfo_, logInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetAdHocTaskLogResponseBodyLogInfo> logInfo_ = nullptr;
