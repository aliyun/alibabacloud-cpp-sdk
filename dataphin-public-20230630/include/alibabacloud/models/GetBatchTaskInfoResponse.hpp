...
namespace Models
{
  ...
  public:
    ...
    inline const GetBatchTaskInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetBatchTaskInfoResponseBody) };
    inline GetBatchTaskInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetBatchTaskInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetBatchTaskInfoResponseBody> body_ {};
  };
