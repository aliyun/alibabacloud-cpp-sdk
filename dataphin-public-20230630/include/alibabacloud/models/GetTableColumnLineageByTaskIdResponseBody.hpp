...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetTableColumnLineageByTaskIdResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetTableColumnLineageByTaskIdResponseBodyData>) };
    inline vector<GetTableColumnLineageByTaskIdResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetTableColumnLineageByTaskIdResponseBodyData>) };
    inline GetTableColumnLineageByTaskIdResponseBody& setData(const vector<GetTableColumnLineageByTaskIdResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTableColumnLineageByTaskIdResponseBody& setData(vector<GetTableColumnLineageByTaskIdResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetTableColumnLineageByTaskIdResponseBodyData>> data_ = nullptr;
