...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->contextShrink_ == nullptr
        && this->opTenantId_ == nullptr && this->opUserId_ == nullptr && this->updateCommandShrink_ == nullptr; };
    ...
    inline UpdatePipelineByAsyncShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
