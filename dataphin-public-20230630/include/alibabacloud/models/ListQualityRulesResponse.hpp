...
namespace Models
{
  ...
  public:
    ...
    inline const ListQualityRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListQualityRulesResponseBody) };
    inline ListQualityRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListQualityRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListQualityRulesResponseBody> body_ {};
  };
