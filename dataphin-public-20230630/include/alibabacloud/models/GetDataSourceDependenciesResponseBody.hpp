...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->dependencyList_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<GetDataSourceDependenciesResponseBodyDependencyList> & dependencyList() const { DARABONBA_PTR_GET_CONST(dependencyList_, vector<GetDataSourceDependenciesResponseBodyDependencyList>) };
    inline vector<GetDataSourceDependenciesResponseBodyDependencyList> dependencyList() { DARABONBA_PTR_GET(dependencyList_, vector<GetDataSourceDependenciesResponseBodyDependencyList>) };
    inline GetDataSourceDependenciesResponseBody& setDependencyList(const vector<GetDataSourceDependenciesResponseBodyDependencyList> & dependencyList) { DARABONBA_PTR_SET_VALUE(dependencyList_, dependencyList) };
    inline GetDataSourceDependenciesResponseBody& setDependencyList(vector<GetDataSourceDependenciesResponseBodyDependencyList> && dependencyList) { DARABONBA_PTR_SET_RVALUE(dependencyList_, dependencyList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetDataSourceDependenciesResponseBodyDependencyList>> dependencyList_ = nullptr;
