...
namespace Models
{
  ...
  public:
    ...
    inline const GetProjectByNameResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetProjectByNameResponseBody) };
    inline GetProjectByNameResponseBody body() { DARABONBA_PTR_GET(body_, GetProjectByNameResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetProjectByNameResponseBody> body_ = nullptr;
  };
