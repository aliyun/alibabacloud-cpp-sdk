...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRegisterLineageResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteRegisterLineageResponseBody) };
    inline DeleteRegisterLineageResponseBody body() { DARABONBA_PTR_GET(body_, DeleteRegisterLineageResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteRegisterLineageResponseBody> body_ = nullptr;
  };
