...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataServiceApiResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDataServiceApiResponseBody) };
    inline CreateDataServiceApiResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDataServiceApiResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDataServiceApiResponseBody> body_ {};
  };
