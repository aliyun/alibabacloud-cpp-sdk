...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataServiceMyProjectsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetDataServiceMyProjectsResponseBody) };
    inline GetDataServiceMyProjectsResponseBody body() { DARABONBA_PTR_GET(body_, GetDataServiceMyProjectsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataServiceMyProjectsResponseBody> body_ = nullptr;
  };
