...
#ifndef ALIBABACLOUD_MODELS_GETBATCHTASKINFORESPONSEBODYTASKINFOUPSTREAMLIST_HPP_
#define ALIBABACLOUD_MODELS_GETBATCHTASKINFORESPONSEBODYTASKINFOUPSTREAMLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& obj) { 
    ...
    GetBatchTaskInfoResponseBodyTaskInfoUpStreamList() = default ;
    GetBatchTaskInfoResponseBodyTaskInfoUpStreamList(const GetBatchTaskInfoResponseBodyTaskInfoUpStreamList &) = default ;
    GetBatchTaskInfoResponseBodyTaskInfoUpStreamList(GetBatchTaskInfoResponseBodyTaskInfoUpStreamList &&) = default ;
    GetBatchTaskInfoResponseBodyTaskInfoUpStreamList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetBatchTaskInfoResponseBodyTaskInfoUpStreamList() = default ;
    GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& operator=(const GetBatchTaskInfoResponseBodyTaskInfoUpStreamList &) = default ;
    GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& operator=(GetBatchTaskInfoResponseBodyTaskInfoUpStreamList &&) = default ;
    ...
    inline const Models::GetBatchTaskInfoResponseBodyTaskInfoUpStreamListDependPeriod & dependPeriod() const { DARABONBA_PTR_GET_CONST(dependPeriod_, Models::GetBatchTaskInfoResponseBodyTaskInfoUpStreamListDependPeriod) };
    inline Models::GetBatchTaskInfoResponseBodyTaskInfoUpStreamListDependPeriod dependPeriod() { DARABONBA_PTR_GET(dependPeriod_, Models::GetBatchTaskInfoResponseBodyTaskInfoUpStreamListDependPeriod) };
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setDependPeriod(const Models::GetBatchTaskInfoResponseBodyTaskInfoUpStreamListDependPeriod & dependPeriod) { DARABONBA_PTR_SET_VALUE(dependPeriod_, dependPeriod) };
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setDependPeriod(Models::GetBatchTaskInfoResponseBodyTaskInfoUpStreamListDependPeriod && dependPeriod) { DARABONBA_PTR_SET_RVALUE(dependPeriod_, dependPeriod) };
    ...
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setDependStrategy(string dependStrategy) { DARABONBA_PTR_SET_VALUE(dependStrategy_, dependStrategy) };
    ...
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setFieldList(const vector<string> & fieldList) { DARABONBA_PTR_SET_VALUE(fieldList_, fieldList) };
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setFieldList(vector<string> && fieldList) { DARABONBA_PTR_SET_RVALUE(fieldList_, fieldList) };
    ...
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setNodeType(string nodeType) { DARABONBA_PTR_SET_VALUE(nodeType_, nodeType) };
    ...
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setPeriodDiff(int32_t periodDiff) { DARABONBA_PTR_SET_VALUE(periodDiff_, periodDiff) };
    ...
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setSourceNodeEnabled(bool sourceNodeEnabled) { DARABONBA_PTR_SET_VALUE(sourceNodeEnabled_, sourceNodeEnabled) };
    ...
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setSourceNodeId(string sourceNodeId) { DARABONBA_PTR_SET_VALUE(sourceNodeId_, sourceNodeId) };
    ...
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setSourceNodeName(string sourceNodeName) { DARABONBA_PTR_SET_VALUE(sourceNodeName_, sourceNodeName) };
    ...
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setSourceNodeOutputName(string sourceNodeOutputName) { DARABONBA_PTR_SET_VALUE(sourceNodeOutputName_, sourceNodeOutputName) };
    ...
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setSourceNodeUserName(string sourceNodeUserName) { DARABONBA_PTR_SET_VALUE(sourceNodeUserName_, sourceNodeUserName) };
    ...
    inline GetBatchTaskInfoResponseBodyTaskInfoUpStreamList& setSourceTableName(string sourceTableName) { DARABONBA_PTR_SET_VALUE(sourceTableName_, sourceTableName) };


  protected:
    std::shared_ptr<Models::GetBatchTaskInfoResponseBodyTaskInfoUpStreamListDependPeriod> dependPeriod_ = nullptr;
