...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataDomainResponseBodyCreateResult & createResult() const { DARABONBA_PTR_GET_CONST(createResult_, CreateDataDomainResponseBodyCreateResult) };
    inline CreateDataDomainResponseBodyCreateResult createResult() { DARABONBA_PTR_GET(createResult_, CreateDataDomainResponseBodyCreateResult) };
    inline CreateDataDomainResponseBody& setCreateResult(const CreateDataDomainResponseBodyCreateResult & createResult) { DARABONBA_PTR_SET_VALUE(createResult_, createResult) };
    inline CreateDataDomainResponseBody& setCreateResult(CreateDataDomainResponseBodyCreateResult && createResult) { DARABONBA_PTR_SET_RVALUE(createResult_, createResult) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDataDomainResponseBodyCreateResult> createResult_ = nullptr;
