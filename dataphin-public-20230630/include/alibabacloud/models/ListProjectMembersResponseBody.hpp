...
namespace Models
{
  ...
  public:
    ...
    inline const ListProjectMembersResponseBodyPageResult & pageResult() const { DARABONBA_PTR_GET_CONST(pageResult_, ListProjectMembersResponseBodyPageResult) };
    inline ListProjectMembersResponseBodyPageResult pageResult() { DARABONBA_PTR_GET(pageResult_, ListProjectMembersResponseBodyPageResult) };
    inline ListProjectMembersResponseBody& setPageResult(const ListProjectMembersResponseBodyPageResult & pageResult) { DARABONBA_PTR_SET_VALUE(pageResult_, pageResult) };
    inline ListProjectMembersResponseBody& setPageResult(ListProjectMembersResponseBodyPageResult && pageResult) { DARABONBA_PTR_SET_RVALUE(pageResult_, pageResult) };
  ...
  protected:
    ...
    std::shared_ptr<ListProjectMembersResponseBodyPageResult> pageResult_ = nullptr;
