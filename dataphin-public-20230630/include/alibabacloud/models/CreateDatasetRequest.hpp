  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->apiInfo_ == nullptr
        && this->contentType_ == nullptr && this->dataCellId_ == nullptr && this->description_ == nullptr && this->dirName_ == nullptr && this->fileId_ == nullptr
      ...
      inline const CreateCommand::ApiInfo & getApiInfo() const { DARABONBA_PTR_GET_CONST(apiInfo_, CreateCommand::ApiInfo) };
      inline CreateCommand::ApiInfo getApiInfo() { DARABONBA_PTR_GET(apiInfo_, CreateCommand::ApiInfo) };
      inline CreateCommand& setApiInfo(const CreateCommand::ApiInfo & apiInfo) { DARABONBA_PTR_SET_VALUE(apiInfo_, apiInfo) };
      inline CreateCommand& setApiInfo(CreateCommand::ApiInfo && apiInfo) { DARABONBA_PTR_SET_RVALUE(apiInfo_, apiInfo) };
    ...
    inline CreateDatasetRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
