...
#ifndef ALIBABACLOUD_MODELS_GETBIZENTITYINFOBYVERSIONRESPONSEBODYBIZENTITYINFOBIZPROCESS_HPP_
#define ALIBABACLOUD_MODELS_GETBIZENTITYINFOBYVERSIONRESPONSEBODYBIZENTITYINFOBIZPROCESS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& obj) { 
    ...
    GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess() = default ;
    GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess(const GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess &) = default ;
    GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess(GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess &&) = default ;
    GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess() = default ;
    GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& operator=(const GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess &) = default ;
    GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& operator=(GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess &&) = default ;
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setApprovalId(string approvalId) { DARABONBA_PTR_SET_VALUE(approvalId_, approvalId) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setApprovalStatus(string approvalStatus) { DARABONBA_PTR_SET_VALUE(approvalStatus_, approvalStatus) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setBizEventEntityIdList(const vector<int64_t> & bizEventEntityIdList) { DARABONBA_PTR_SET_VALUE(bizEventEntityIdList_, bizEventEntityIdList) };
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setBizEventEntityIdList(vector<int64_t> && bizEventEntityIdList) { DARABONBA_PTR_SET_RVALUE(bizEventEntityIdList_, bizEventEntityIdList) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setHasDependent(bool hasDependent) { DARABONBA_PTR_SET_VALUE(hasDependent_, hasDependent) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setLastModifier(string lastModifier) { DARABONBA_PTR_SET_VALUE(lastModifier_, lastModifier) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setLastModifierName(string lastModifierName) { DARABONBA_PTR_SET_VALUE(lastModifierName_, lastModifierName) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setOnlineStatus(string onlineStatus) { DARABONBA_PTR_SET_VALUE(onlineStatus_, onlineStatus) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setOwnerName(string ownerName) { DARABONBA_PTR_SET_VALUE(ownerName_, ownerName) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setOwnerUserId(string ownerUserId) { DARABONBA_PTR_SET_VALUE(ownerUserId_, ownerUserId) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setPreBizProcessIdList(const vector<int64_t> & preBizProcessIdList) { DARABONBA_PTR_SET_VALUE(preBizProcessIdList_, preBizProcessIdList) };
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setPreBizProcessIdList(vector<int64_t> && preBizProcessIdList) { DARABONBA_PTR_SET_RVALUE(preBizProcessIdList_, preBizProcessIdList) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setRefBizEntityIdList(const vector<int64_t> & refBizEntityIdList) { DARABONBA_PTR_SET_VALUE(refBizEntityIdList_, refBizEntityIdList) };
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setRefBizEntityIdList(vector<int64_t> && refBizEntityIdList) { DARABONBA_PTR_SET_RVALUE(refBizEntityIdList_, refBizEntityIdList) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setRefFactTableCount(int32_t refFactTableCount) { DARABONBA_PTR_SET_VALUE(refFactTableCount_, refFactTableCount) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetBizEntityInfoByVersionResponseBodyBizEntityInfoBizProcess& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
