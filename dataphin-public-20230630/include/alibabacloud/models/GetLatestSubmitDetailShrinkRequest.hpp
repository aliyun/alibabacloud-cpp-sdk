...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->opTenantId_ == nullptr
        && this->opUserId_ == nullptr && this->submitDetailQueryShrink_ == nullptr; };
    ...
    inline GetLatestSubmitDetailShrinkRequest& setOpUserId(string opUserId) { DARABONBA_PTR_SET_VALUE(opUserId_, opUserId) };
    ...
    inline string getSubmitDetailQueryShrink() const { DARABONBA_PTR_GET_DEFAULT(submitDetailQueryShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> submitDetailQueryShrink_ {};
  };
