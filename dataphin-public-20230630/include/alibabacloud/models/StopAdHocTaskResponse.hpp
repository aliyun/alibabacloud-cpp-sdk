...
namespace Models
{
  ...
  public:
    ...
    inline const StopAdHocTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, StopAdHocTaskResponseBody) };
    inline StopAdHocTaskResponseBody body() { DARABONBA_PTR_GET(body_, StopAdHocTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<StopAdHocTaskResponseBody> body_ = nullptr;
  };
