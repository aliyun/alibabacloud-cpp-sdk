...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->userGroupInfo_ == nullptr; };
    ...
    inline const GetUserGroupResponseBodyUserGroupInfo & userGroupInfo() const { DARABONBA_PTR_GET_CONST(userGroupInfo_, GetUserGroupResponseBodyUserGroupInfo) };
    inline GetUserGroupResponseBodyUserGroupInfo userGroupInfo() { DARABONBA_PTR_GET(userGroupInfo_, GetUserGroupResponseBodyUserGroupInfo) };
    inline GetUserGroupResponseBody& setUserGroupInfo(const GetUserGroupResponseBodyUserGroupInfo & userGroupInfo) { DARABONBA_PTR_SET_VALUE(userGroupInfo_, userGroupInfo) };
    inline GetUserGroupResponseBody& setUserGroupInfo(GetUserGroupResponseBodyUserGroupInfo && userGroupInfo) { DARABONBA_PTR_SET_RVALUE(userGroupInfo_, userGroupInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetUserGroupResponseBodyUserGroupInfo> userGroupInfo_ = nullptr;
  };
