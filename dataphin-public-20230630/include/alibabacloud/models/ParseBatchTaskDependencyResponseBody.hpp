...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->parseResult_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ParseBatchTaskDependencyResponseBodyParseResult & parseResult() const { DARABONBA_PTR_GET_CONST(parseResult_, ParseBatchTaskDependencyResponseBodyParseResult) };
    inline ParseBatchTaskDependencyResponseBodyParseResult parseResult() { DARABONBA_PTR_GET(parseResult_, ParseBatchTaskDependencyResponseBodyParseResult) };
    inline ParseBatchTaskDependencyResponseBody& setParseResult(const ParseBatchTaskDependencyResponseBodyParseResult & parseResult) { DARABONBA_PTR_SET_VALUE(parseResult_, parseResult) };
    inline ParseBatchTaskDependencyResponseBody& setParseResult(ParseBatchTaskDependencyResponseBodyParseResult && parseResult) { DARABONBA_PTR_SET_RVALUE(parseResult_, parseResult) };
  ...
  protected:
    ...
    std::shared_ptr<ParseBatchTaskDependencyResponseBodyParseResult> parseResult_ = nullptr;
