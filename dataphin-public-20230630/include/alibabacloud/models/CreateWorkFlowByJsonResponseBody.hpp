...
#ifndef ALIBABACLOUD_MODELS_CREATEWORKFLOWBYJSONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEWORKFLOWBYJSONRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateWorkFlowByJsonResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateWorkFlowByJsonResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateWorkFlowByJsonResponseBody& obj) { 
    ...
    CreateWorkFlowByJsonResponseBody() = default ;
    CreateWorkFlowByJsonResponseBody(const CreateWorkFlowByJsonResponseBody &) = default ;
    CreateWorkFlowByJsonResponseBody(CreateWorkFlowByJsonResponseBody &&) = default ;
    CreateWorkFlowByJsonResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateWorkFlowByJsonResponseBody() = default ;
    CreateWorkFlowByJsonResponseBody& operator=(const CreateWorkFlowByJsonResponseBody &) = default ;
    CreateWorkFlowByJsonResponseBody& operator=(CreateWorkFlowByJsonResponseBody &&) = default ;
    ...
    inline CreateWorkFlowByJsonResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateWorkFlowByJsonResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateWorkFlowByJsonResponseBody::Data) };
    inline CreateWorkFlowByJsonResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateWorkFlowByJsonResponseBody::Data) };
    inline CreateWorkFlowByJsonResponseBody& setData(const CreateWorkFlowByJsonResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateWorkFlowByJsonResponseBody& setData(CreateWorkFlowByJsonResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateWorkFlowByJsonResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateWorkFlowByJsonResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateWorkFlowByJsonResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateWorkFlowByJsonResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
