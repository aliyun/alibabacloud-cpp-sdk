...
#ifndef ALIBABACLOUD_MODELS_GETPHYSICALINSTANCERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETPHYSICALINSTANCERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetPhysicalInstanceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetPhysicalInstanceResponseBody& obj) { 
    ...
    GetPhysicalInstanceResponseBody() = default ;
    GetPhysicalInstanceResponseBody(const GetPhysicalInstanceResponseBody &) = default ;
    GetPhysicalInstanceResponseBody(GetPhysicalInstanceResponseBody &&) = default ;
    GetPhysicalInstanceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetPhysicalInstanceResponseBody() = default ;
    GetPhysicalInstanceResponseBody& operator=(const GetPhysicalInstanceResponseBody &) = default ;
    GetPhysicalInstanceResponseBody& operator=(GetPhysicalInstanceResponseBody &&) = default ;
    ...
    public:
      ...
      inline Instance& setBizDate(string bizDate) { DARABONBA_PTR_SET_VALUE(bizDate_, bizDate) };
      ...
      inline Instance& setDueTime(string dueTime) { DARABONBA_PTR_SET_VALUE(dueTime_, dueTime) };
      ...
      inline Instance& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
      ...
      inline Instance& setEndExecuteTime(int64_t endExecuteTime) { DARABONBA_PTR_SET_VALUE(endExecuteTime_, endExecuteTime) };
      ...
      inline Instance& setExtendInfo(string extendInfo) { DARABONBA_PTR_SET_VALUE(extendInfo_, extendInfo) };
      ...
      void deleteId() { this->id_ = nullptr;};
      inline string getId() const { DARABONBA_PTR_GET_DEFAULT(id_, "") };
      inline Instance& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
      ...
      inline Instance& setIndex(int32_t index) { DARABONBA_PTR_SET_VALUE(index_, index) };


      // nodeInfo Field Functions 
      bool hasNodeInfo() const { return this->nodeInfo_ != nullptr;};
      void deleteNodeInfo() { this->nodeInfo_ = nullptr;};
      inline const Instance::NodeInfo & getNodeInfo() const { DARABONBA_PTR_GET_CONST(nodeInfo_, Instance::NodeInfo) };
      inline Instance::NodeInfo getNodeInfo() { DARABONBA_PTR_GET(nodeInfo_, Instance::NodeInfo) };
      inline Instance& setNodeInfo(const Instance::NodeInfo & nodeInfo) { DARABONBA_PTR_SET_VALUE(nodeInfo_, nodeInfo) };
      inline Instance& setNodeInfo(Instance::NodeInfo && nodeInfo) { DARABONBA_PTR_SET_RVALUE(nodeInfo_, nodeInfo) };
      ...
      inline Instance& setStartExecuteTime(int64_t startExecuteTime) { DARABONBA_PTR_SET_VALUE(startExecuteTime_, startExecuteTime) };
      ...
      inline Instance& setStatusList(const vector<string> & statusList) { DARABONBA_PTR_SET_VALUE(statusList_, statusList) };
      inline Instance& setStatusList(vector<string> && statusList) { DARABONBA_PTR_SET_RVALUE(statusList_, statusList) };
    ...
    inline GetPhysicalInstanceResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetPhysicalInstanceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };


    // instance Field Functions 
    bool hasInstance() const { return this->instance_ != nullptr;};
    void deleteInstance() { this->instance_ = nullptr;};
    inline const GetPhysicalInstanceResponseBody::Instance & getInstance() const { DARABONBA_PTR_GET_CONST(instance_, GetPhysicalInstanceResponseBody::Instance) };
    inline GetPhysicalInstanceResponseBody::Instance getInstance() { DARABONBA_PTR_GET(instance_, GetPhysicalInstanceResponseBody::Instance) };
    inline GetPhysicalInstanceResponseBody& setInstance(const GetPhysicalInstanceResponseBody::Instance & instance) { DARABONBA_PTR_SET_VALUE(instance_, instance) };
    inline GetPhysicalInstanceResponseBody& setInstance(GetPhysicalInstanceResponseBody::Instance && instance) { DARABONBA_PTR_SET_RVALUE(instance_, instance) };
    ...
    inline GetPhysicalInstanceResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetPhysicalInstanceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetPhysicalInstanceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
