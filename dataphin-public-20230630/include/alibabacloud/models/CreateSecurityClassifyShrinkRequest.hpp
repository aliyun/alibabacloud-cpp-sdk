...
#ifndef ALIBABACLOUD_MODELS_CREATESECURITYCLASSIFYSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATESECURITYCLASSIFYSHRINKREQUEST_HPP_
...
namespace Models
{
  class CreateSecurityClassifyShrinkRequest : public Darabonba::Model {
  public:
    ...
    CreateSecurityClassifyShrinkRequest(CreateSecurityClassifyShrinkRequest &&) = default ;
    CreateSecurityClassifyShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateSecurityClassifyShrinkRequest() = default ;
    CreateSecurityClassifyShrinkRequest& operator=(const CreateSecurityClassifyShrinkRequest &) = default ;
    CreateSecurityClassifyShrinkRequest& operator=(CreateSecurityClassifyShrinkRequest &&) = default ;
    ...
    inline CreateSecurityClassifyShrinkRequest& setCreateCommandShrink(string createCommandShrink) { DARABONBA_PTR_SET_VALUE(createCommandShrink_, createCommandShrink) };
