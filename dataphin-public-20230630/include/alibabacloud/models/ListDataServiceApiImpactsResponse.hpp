...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceApiImpactsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataServiceApiImpactsResponseBody) };
    inline ListDataServiceApiImpactsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataServiceApiImpactsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataServiceApiImpactsResponseBody> body_ {};
  };
