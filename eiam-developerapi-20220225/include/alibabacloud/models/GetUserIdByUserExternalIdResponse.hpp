...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserIdByUserExternalIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserIdByUserExternalIdResponseBody) };
    inline GetUserIdByUserExternalIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserIdByUserExternalIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserIdByUserExternalIdResponseBody> body_ {};
  };
