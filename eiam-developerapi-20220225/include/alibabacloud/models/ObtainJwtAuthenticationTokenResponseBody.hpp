...
#ifndef ALIBABACLOUD_MODELS_OBTAINJWTAUTHENTICATIONTOKENRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_OBTAINJWTAUTHENTICATIONTOKENRESPONSEBODY_HPP_
...
namespace Models
{
  class ObtainJwtAuthenticationTokenResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ObtainJwtAuthenticationTokenResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ObtainJwtAuthenticationTokenResponseBody& obj) { 
    ...
    ObtainJwtAuthenticationTokenResponseBody() = default ;
    ObtainJwtAuthenticationTokenResponseBody(const ObtainJwtAuthenticationTokenResponseBody &) = default ;
    ObtainJwtAuthenticationTokenResponseBody(ObtainJwtAuthenticationTokenResponseBody &&) = default ;
    ObtainJwtAuthenticationTokenResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ObtainJwtAuthenticationTokenResponseBody() = default ;
    ObtainJwtAuthenticationTokenResponseBody& operator=(const ObtainJwtAuthenticationTokenResponseBody &) = default ;
    ObtainJwtAuthenticationTokenResponseBody& operator=(ObtainJwtAuthenticationTokenResponseBody &&) = default ;
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setAuthenticationTokenId(string authenticationTokenId) { DARABONBA_PTR_SET_VALUE(authenticationTokenId_, authenticationTokenId) };
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setAuthenticationTokenType(string authenticationTokenType) { DARABONBA_PTR_SET_VALUE(authenticationTokenType_, authenticationTokenType) };
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setConsumerId(string consumerId) { DARABONBA_PTR_SET_VALUE(consumerId_, consumerId) };
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setConsumerType(string consumerType) { DARABONBA_PTR_SET_VALUE(consumerType_, consumerType) };
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setCreatorId(string creatorId) { DARABONBA_PTR_SET_VALUE(creatorId_, creatorId) };
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setCreatorType(string creatorType) { DARABONBA_PTR_SET_VALUE(creatorType_, creatorType) };
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setCredentialProviderId(string credentialProviderId) { DARABONBA_PTR_SET_VALUE(credentialProviderId_, credentialProviderId) };
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setExpirationTime(int64_t expirationTime) { DARABONBA_PTR_SET_VALUE(expirationTime_, expirationTime) };
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline const ObtainJwtAuthenticationTokenResponseBody::JwtContent & getJwtContent() const { DARABONBA_PTR_GET_CONST(jwtContent_, ObtainJwtAuthenticationTokenResponseBody::JwtContent) };
    inline ObtainJwtAuthenticationTokenResponseBody::JwtContent getJwtContent() { DARABONBA_PTR_GET(jwtContent_, ObtainJwtAuthenticationTokenResponseBody::JwtContent) };
    inline ObtainJwtAuthenticationTokenResponseBody& setJwtContent(const ObtainJwtAuthenticationTokenResponseBody::JwtContent & jwtContent) { DARABONBA_PTR_SET_VALUE(jwtContent_, jwtContent) };
    inline ObtainJwtAuthenticationTokenResponseBody& setJwtContent(ObtainJwtAuthenticationTokenResponseBody::JwtContent && jwtContent) { DARABONBA_PTR_SET_RVALUE(jwtContent_, jwtContent) };
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setRevoked(bool revoked) { DARABONBA_PTR_SET_VALUE(revoked_, revoked) };
    ...
    inline ObtainJwtAuthenticationTokenResponseBody& setUpdateTime(int64_t updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
