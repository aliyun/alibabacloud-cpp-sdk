...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserIdByPhoneNumberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserIdByPhoneNumberResponseBody) };
    inline GetUserIdByPhoneNumberResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserIdByPhoneNumberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserIdByPhoneNumberResponseBody> body_ {};
  };
