...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateTokenResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GenerateTokenResponseBody) };
    inline GenerateTokenResponseBody body() { DARABONBA_PTR_GET(body_, GenerateTokenResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GenerateTokenResponseBody> body_ = nullptr;
  };
