...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListGroupsForUserResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListGroupsForUserResponseBodyData>) };
    inline vector<ListGroupsForUserResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListGroupsForUserResponseBodyData>) };
    inline ListGroupsForUserResponseBody& setData(const vector<ListGroupsForUserResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGroupsForUserResponseBody& setData(vector<ListGroupsForUserResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<ListGroupsForUserResponseBodyData>> data_ = nullptr;
