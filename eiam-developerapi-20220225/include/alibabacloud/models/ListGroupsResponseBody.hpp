...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListGroupsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListGroupsResponseBodyData>) };
    inline vector<ListGroupsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListGroupsResponseBodyData>) };
    inline ListGroupsResponseBody& setData(const vector<ListGroupsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGroupsResponseBody& setData(vector<ListGroupsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<vector<ListGroupsResponseBodyData>> data_ = nullptr;
