...
namespace Models
{
  ...
  public:
    ...
    inline const ListOrganizationalUnitsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOrganizationalUnitsResponseBody) };
    inline ListOrganizationalUnitsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOrganizationalUnitsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOrganizationalUnitsResponseBody> body_ {};
  };
