...
#ifndef ALIBABACLOUD_MODELS_OBTAINJWTAUTHENTICATIONTOKENBYDERIVEDSHORTTOKENRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_OBTAINJWTAUTHENTICATIONTOKENBYDERIVEDSHORTTOKENRESPONSEBODY_HPP_
...
namespace Models
{
  class ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& obj) { 
    ...
    ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody() = default ;
    ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody(const ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody &) = default ;
    ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody(ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody &&) = default ;
    ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody() = default ;
    ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& operator=(const ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody &) = default ;
    ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& operator=(ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody &&) = default ;
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setAuthenticationTokenId(string authenticationTokenId) { DARABONBA_PTR_SET_VALUE(authenticationTokenId_, authenticationTokenId) };
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setAuthenticationTokenType(string authenticationTokenType) { DARABONBA_PTR_SET_VALUE(authenticationTokenType_, authenticationTokenType) };
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setConsumerId(string consumerId) { DARABONBA_PTR_SET_VALUE(consumerId_, consumerId) };
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setConsumerType(string consumerType) { DARABONBA_PTR_SET_VALUE(consumerType_, consumerType) };
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setCreatorId(string creatorId) { DARABONBA_PTR_SET_VALUE(creatorId_, creatorId) };
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setCreatorType(string creatorType) { DARABONBA_PTR_SET_VALUE(creatorType_, creatorType) };
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setCredentialProviderId(string credentialProviderId) { DARABONBA_PTR_SET_VALUE(credentialProviderId_, credentialProviderId) };
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setExpirationTime(int64_t expirationTime) { DARABONBA_PTR_SET_VALUE(expirationTime_, expirationTime) };
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline const ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody::JwtContent & getJwtContent() const { DARABONBA_PTR_GET_CONST(jwtContent_, ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody::JwtContent) };
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody::JwtContent getJwtContent() { DARABONBA_PTR_GET(jwtContent_, ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody::JwtContent) };
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setJwtContent(const ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody::JwtContent & jwtContent) { DARABONBA_PTR_SET_VALUE(jwtContent_, jwtContent) };
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setJwtContent(ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody::JwtContent && jwtContent) { DARABONBA_PTR_SET_RVALUE(jwtContent_, jwtContent) };
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setRevoked(bool revoked) { DARABONBA_PTR_SET_VALUE(revoked_, revoked) };
    ...
    inline ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody& setUpdateTime(int64_t updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
  ...
  protected:
    ...
    shared_ptr<ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody::JwtContent> jwtContent_ {};
