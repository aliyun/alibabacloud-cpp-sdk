...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateDeviceCodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateDeviceCodeResponseBody) };
    inline GenerateDeviceCodeResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateDeviceCodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateDeviceCodeResponseBody> body_ {};
  };
