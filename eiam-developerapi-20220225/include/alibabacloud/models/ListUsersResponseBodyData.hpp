...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountExpireTime_ == nullptr
        ...
        && return this->instanceId_ == nullptr && return this->lockExpireTime_ == nullptr && return this->passwordSet_ == nullptr && return this->phoneNumber_ == nullptr && return this->phoneNumberVerified_ == nullptr
        && return this->phoneRegion_ == nullptr && return this->registerTime_ == nullptr && return this->status_ == nullptr && return this->updateTime_ == nullptr && return this->userExternalId_ == nullptr
        && return this->userId_ == nullptr && return this->userSourceId_ == nullptr && return this->userSourceType_ == nullptr && return this->username_ == nullptr; };
    ...
    inline ListUsersResponseBodyData& setAccountExpireTime(int64_t accountExpireTime) { DARABONBA_PTR_SET_VALUE(accountExpireTime_, accountExpireTime) };
    ...
    inline ListUsersResponseBodyData& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListUsersResponseBodyData& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListUsersResponseBodyData& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline ListUsersResponseBodyData& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline ListUsersResponseBodyData& setEmailVerified(bool emailVerified) { DARABONBA_PTR_SET_VALUE(emailVerified_, emailVerified) };
    ...
    inline ListUsersResponseBodyData& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ListUsersResponseBodyData& setLockExpireTime(int64_t lockExpireTime) { DARABONBA_PTR_SET_VALUE(lockExpireTime_, lockExpireTime) };
    ...
    inline ListUsersResponseBodyData& setPasswordSet(bool passwordSet) { DARABONBA_PTR_SET_VALUE(passwordSet_, passwordSet) };
    ...
    inline ListUsersResponseBodyData& setPhoneNumber(string phoneNumber) { DARABONBA_PTR_SET_VALUE(phoneNumber_, phoneNumber) };
    ...
    inline ListUsersResponseBodyData& setPhoneNumberVerified(bool phoneNumberVerified) { DARABONBA_PTR_SET_VALUE(phoneNumberVerified_, phoneNumberVerified) };
    ...
    inline ListUsersResponseBodyData& setPhoneRegion(string phoneRegion) { DARABONBA_PTR_SET_VALUE(phoneRegion_, phoneRegion) };
    ...
    inline ListUsersResponseBodyData& setRegisterTime(int64_t registerTime) { DARABONBA_PTR_SET_VALUE(registerTime_, registerTime) };
    ...
    inline ListUsersResponseBodyData& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListUsersResponseBodyData& setUpdateTime(int64_t updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline ListUsersResponseBodyData& setUserExternalId(string userExternalId) { DARABONBA_PTR_SET_VALUE(userExternalId_, userExternalId) };
    ...
    inline ListUsersResponseBodyData& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline ListUsersResponseBodyData& setUserSourceId(string userSourceId) { DARABONBA_PTR_SET_VALUE(userSourceId_, userSourceId) };
    ...
    inline ListUsersResponseBodyData& setUserSourceType(string userSourceType) { DARABONBA_PTR_SET_VALUE(userSourceType_, userSourceType) };
    ...
    inline ListUsersResponseBodyData& setUsername(string username) { DARABONBA_PTR_SET_VALUE(username_, username) };
