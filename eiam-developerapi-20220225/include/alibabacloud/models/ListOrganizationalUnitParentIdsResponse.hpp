...
namespace Models
{
  ...
  public:
    ...
    inline const ListOrganizationalUnitParentIdsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListOrganizationalUnitParentIdsResponseBody) };
    inline ListOrganizationalUnitParentIdsResponseBody body() { DARABONBA_PTR_GET(body_, ListOrganizationalUnitParentIdsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListOrganizationalUnitParentIdsResponseBody> body_ = nullptr;
  };
