...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserIdByEmailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserIdByEmailResponseBody) };
    inline GetUserIdByEmailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserIdByEmailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserIdByEmailResponseBody> body_ {};
  };
