...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserIdByUsernameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserIdByUsernameResponseBody) };
    inline GetUserIdByUsernameResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserIdByUsernameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserIdByUsernameResponseBody> body_ {};
  };
