...
namespace Models
{
  ...
  public:
    ...
    inline const ListGroupsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListGroupsResponseBody) };
    inline ListGroupsResponseBody body() { DARABONBA_PTR_GET(body_, ListGroupsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListGroupsResponseBody> body_ = nullptr;
  };
