...
namespace Models
{
  ...
  public:
    ...
    inline const GetApplicationProvisioningScopeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetApplicationProvisioningScopeResponseBody) };
    inline GetApplicationProvisioningScopeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetApplicationProvisioningScopeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetApplicationProvisioningScopeResponseBody> body_ {};
  };
