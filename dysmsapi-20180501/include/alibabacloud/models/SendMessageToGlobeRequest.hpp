...
#ifndef ALIBABACLOUD_MODELS_SENDMESSAGETOGLOBEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SENDMESSAGETOGLOBEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SendMessageToGlobeRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SendMessageToGlobeRequest& obj) { 
    ...
    SendMessageToGlobeRequest() = default ;
    SendMessageToGlobeRequest(const SendMessageToGlobeRequest &) = default ;
    SendMessageToGlobeRequest(SendMessageToGlobeRequest &&) = default ;
    SendMessageToGlobeRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SendMessageToGlobeRequest() = default ;
    SendMessageToGlobeRequest& operator=(const SendMessageToGlobeRequest &) = default ;
    SendMessageToGlobeRequest& operator=(SendMessageToGlobeRequest &&) = default ;
    ...
    inline SendMessageToGlobeRequest& setChannelId(string channelId) { DARABONBA_PTR_SET_VALUE(channelId_, channelId) };
    ...
    inline SendMessageToGlobeRequest& setFrom(string from) { DARABONBA_PTR_SET_VALUE(from_, from) };
    ...
    inline SendMessageToGlobeRequest& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline SendMessageToGlobeRequest& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
    ...
    inline SendMessageToGlobeRequest& setTo(string to) { DARABONBA_PTR_SET_VALUE(to_, to) };
    ...
    inline SendMessageToGlobeRequest& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline SendMessageToGlobeRequest& setValidityPeriod(int64_t validityPeriod) { DARABONBA_PTR_SET_VALUE(validityPeriod_, validityPeriod) };
