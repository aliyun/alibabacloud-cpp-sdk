...
#ifndef ALIBABACLOUD_MODELS_SMSCONVERSIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SMSCONVERSIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SmsConversionResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(ResponseCode, responseCode_);
      DARABONBA_PTR_TO_JSON(ResponseDescription, responseDescription_);
    };
    friend void from_json(const Darabonba::Json& j, SmsConversionResponseBody& obj) { 
    ...
    SmsConversionResponseBody() = default ;
    SmsConversionResponseBody(const SmsConversionResponseBody &) = default ;
    SmsConversionResponseBody(SmsConversionResponseBody &&) = default ;
    SmsConversionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SmsConversionResponseBody() = default ;
    SmsConversionResponseBody& operator=(const SmsConversionResponseBody &) = default ;
    SmsConversionResponseBody& operator=(SmsConversionResponseBody &&) = default ;
    ...
    inline SmsConversionResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline SmsConversionResponseBody& setResponseCode(string responseCode) { DARABONBA_PTR_SET_VALUE(responseCode_, responseCode) };
    ...
    inline SmsConversionResponseBody& setResponseDescription(string responseDescription) { DARABONBA_PTR_SET_VALUE(responseDescription_, responseDescription) };
