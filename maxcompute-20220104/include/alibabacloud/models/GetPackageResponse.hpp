...
namespace Models
{
  ...
  public:
    ...
    inline const GetPackageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPackageResponseBody) };
    inline GetPackageResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPackageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPackageResponseBody> body_ {};
  };
