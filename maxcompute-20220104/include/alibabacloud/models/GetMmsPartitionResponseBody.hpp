...
namespace Models
{
  ...
  public:
    ...
    inline const GetMmsPartitionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMmsPartitionResponseBodyData) };
    inline GetMmsPartitionResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMmsPartitionResponseBodyData) };
    inline GetMmsPartitionResponseBody& setData(const GetMmsPartitionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMmsPartitionResponseBody& setData(GetMmsPartitionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetMmsPartitionResponseBodyData> data_ = nullptr;
