...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Data& setRetriedTimes(int32_t retriedTimes) { DARABONBA_PTR_SET_VALUE(retriedTimes_, retriedTimes) };
      ...
      inline Data& setSrcTableName(string srcTableName) { DARABONBA_PTR_SET_VALUE(srcTableName_, srcTableName) };
    ...
    inline const GetMmsTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetMmsTaskResponseBody::Data) };
    inline GetMmsTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetMmsTaskResponseBody::Data) };
    inline GetMmsTaskResponseBody& setData(const GetMmsTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMmsTaskResponseBody& setData(GetMmsTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
