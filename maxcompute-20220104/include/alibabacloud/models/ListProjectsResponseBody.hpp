...
namespace Models
{
  ...
  public:
    ...
    inline const ListProjectsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListProjectsResponseBodyData) };
    inline ListProjectsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListProjectsResponseBodyData) };
    inline ListProjectsResponseBody& setData(const ListProjectsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListProjectsResponseBody& setData(ListProjectsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListProjectsResponseBodyData> data_ = nullptr;
    // The request ID.
