...
#ifndef ALIBABACLOUD_MODELS_GETMMSJOBRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETMMSJOBRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetMmsJobResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetMmsJobResponseBodyData& obj) { 
    ...
    GetMmsJobResponseBodyData() = default ;
    GetMmsJobResponseBodyData(const GetMmsJobResponseBodyData &) = default ;
    GetMmsJobResponseBodyData(GetMmsJobResponseBodyData &&) = default ;
    GetMmsJobResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetMmsJobResponseBodyData() = default ;
    GetMmsJobResponseBodyData& operator=(const GetMmsJobResponseBodyData &) = default ;
    GetMmsJobResponseBodyData& operator=(GetMmsJobResponseBodyData &&) = default ;
    ...
    inline const Models::GetMmsJobResponseBodyDataConfig & config() const { DARABONBA_PTR_GET_CONST(config_, Models::GetMmsJobResponseBodyDataConfig) };
    inline Models::GetMmsJobResponseBodyDataConfig config() { DARABONBA_PTR_GET(config_, Models::GetMmsJobResponseBodyDataConfig) };
    inline GetMmsJobResponseBodyData& setConfig(const Models::GetMmsJobResponseBodyDataConfig & config) { DARABONBA_PTR_SET_VALUE(config_, config) };
    inline GetMmsJobResponseBodyData& setConfig(Models::GetMmsJobResponseBodyDataConfig && config) { DARABONBA_PTR_SET_RVALUE(config_, config) };
    ...
    inline GetMmsJobResponseBodyData& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline GetMmsJobResponseBodyData& setDbId(int64_t dbId) { DARABONBA_PTR_SET_VALUE(dbId_, dbId) };
    ...
    inline GetMmsJobResponseBodyData& setDstDbName(string dstDbName) { DARABONBA_PTR_SET_VALUE(dstDbName_, dstDbName) };
    ...
    inline GetMmsJobResponseBodyData& setDstSchemaName(string dstSchemaName) { DARABONBA_PTR_SET_VALUE(dstSchemaName_, dstSchemaName) };
    ...
    inline GetMmsJobResponseBodyData& setEta(string eta) { DARABONBA_PTR_SET_VALUE(eta_, eta) };
    ...
    inline GetMmsJobResponseBodyData& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetMmsJobResponseBodyData& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetMmsJobResponseBodyData& setSourceId(int64_t sourceId) { DARABONBA_PTR_SET_VALUE(sourceId_, sourceId) };
    ...
    inline GetMmsJobResponseBodyData& setSourceName(string sourceName) { DARABONBA_PTR_SET_VALUE(sourceName_, sourceName) };
    ...
    inline GetMmsJobResponseBodyData& setSrcDbName(string srcDbName) { DARABONBA_PTR_SET_VALUE(srcDbName_, srcDbName) };
    ...
    inline GetMmsJobResponseBodyData& setSrcSchemaName(string srcSchemaName) { DARABONBA_PTR_SET_VALUE(srcSchemaName_, srcSchemaName) };
    ...
    inline GetMmsJobResponseBodyData& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetMmsJobResponseBodyData& setStopped(bool stopped) { DARABONBA_PTR_SET_VALUE(stopped_, stopped) };
    ...
    inline GetMmsJobResponseBodyData& setTaskDone(int32_t taskDone) { DARABONBA_PTR_SET_VALUE(taskDone_, taskDone) };
    ...
    inline GetMmsJobResponseBodyData& setTaskNum(int32_t taskNum) { DARABONBA_PTR_SET_VALUE(taskNum_, taskNum) };
    ...
    inline GetMmsJobResponseBodyData& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };


  protected:
    std::shared_ptr<Models::GetMmsJobResponseBodyDataConfig> config_ = nullptr;
