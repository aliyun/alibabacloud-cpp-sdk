...
namespace Models
{
  ...
  public:
    ...
    inline const ListMmsTablesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMmsTablesResponseBody) };
    inline ListMmsTablesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMmsTablesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMmsTablesResponseBody> body_ {};
  };
