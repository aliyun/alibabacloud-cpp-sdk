...
namespace Models
{
  ...
  public:
    ...
    inline const GetProjectResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetProjectResponseBodyData) };
    inline GetProjectResponseBodyData data() { DARABONBA_PTR_GET(data_, GetProjectResponseBodyData) };
    inline GetProjectResponseBody& setData(const GetProjectResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetProjectResponseBody& setData(GetProjectResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<GetProjectResponseBodyData> data_ = nullptr;
    // The error code.
