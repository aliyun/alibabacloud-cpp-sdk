...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMmsFetchMetadataJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMmsFetchMetadataJobResponseBody) };
    inline CreateMmsFetchMetadataJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMmsFetchMetadataJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMmsFetchMetadataJobResponseBody> body_ {};
  };
