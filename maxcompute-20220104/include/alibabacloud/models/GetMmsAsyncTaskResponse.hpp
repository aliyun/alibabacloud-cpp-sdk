...
namespace Models
{
  ...
  public:
    ...
    inline const GetMmsAsyncTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMmsAsyncTaskResponseBody) };
    inline GetMmsAsyncTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMmsAsyncTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMmsAsyncTaskResponseBody> body_ {};
  };
