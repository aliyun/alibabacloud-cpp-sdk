...
namespace Models
{
  ...
  public:
    ...
    inline const GetMmsDbResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMmsDbResponseBody) };
    inline GetMmsDbResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMmsDbResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMmsDbResponseBody> body_ {};
  };
