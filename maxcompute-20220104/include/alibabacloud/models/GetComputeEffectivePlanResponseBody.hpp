...
namespace Models
{
  ...
  public:
    ...
    inline const GetComputeEffectivePlanResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetComputeEffectivePlanResponseBody::Data) };
    inline GetComputeEffectivePlanResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetComputeEffectivePlanResponseBody::Data) };
    inline GetComputeEffectivePlanResponseBody& setData(const GetComputeEffectivePlanResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetComputeEffectivePlanResponseBody& setData(GetComputeEffectivePlanResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
