...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->class_ == nullptr
        && return this->creationTime_ == nullptr && return this->displayName_ == nullptr && return this->name_ == nullptr && return this->owner_ == nullptr && return this->resources_ == nullptr
