...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Sorter& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    virtual bool empty() const override { return this->sorter_ == nullptr
        && this->dstDbName_ == nullptr && this->dstTableName_ == nullptr && this->jobId_ == nullptr && this->jobName_ == nullptr && this->pageNum_ == nullptr
        && this->pageSize_ == nullptr && this->partition_ == nullptr && this->srcDbName_ == nullptr && this->srcTableName_ == nullptr && this->status_ == nullptr; };
    // sorter Field Functions 
    bool hasSorter() const { return this->sorter_ != nullptr;};
    void deleteSorter() { this->sorter_ = nullptr;};
    inline const ListMmsTasksRequest::Sorter & getSorter() const { DARABONBA_PTR_GET_CONST(sorter_, ListMmsTasksRequest::Sorter) };
    inline ListMmsTasksRequest::Sorter getSorter() { DARABONBA_PTR_GET(sorter_, ListMmsTasksRequest::Sorter) };
    inline ListMmsTasksRequest& setSorter(const ListMmsTasksRequest::Sorter & sorter) { DARABONBA_PTR_SET_VALUE(sorter_, sorter) };
    inline ListMmsTasksRequest& setSorter(ListMmsTasksRequest::Sorter && sorter) { DARABONBA_PTR_SET_RVALUE(sorter_, sorter) };
