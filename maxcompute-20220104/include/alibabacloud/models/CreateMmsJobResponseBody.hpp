...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMmsJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateMmsJobResponseBody::Data) };
    inline CreateMmsJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateMmsJobResponseBody::Data) };
    inline CreateMmsJobResponseBody& setData(const CreateMmsJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateMmsJobResponseBody& setData(CreateMmsJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
