...
namespace Models
{
  ...
  public:
    ...
    inline const GetComputeQuotaPlanResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetComputeQuotaPlanResponseBodyData) };
    inline GetComputeQuotaPlanResponseBodyData data() { DARABONBA_PTR_GET(data_, GetComputeQuotaPlanResponseBodyData) };
    inline GetComputeQuotaPlanResponseBody& setData(const GetComputeQuotaPlanResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetComputeQuotaPlanResponseBody& setData(GetComputeQuotaPlanResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<GetComputeQuotaPlanResponseBodyData> data_ = nullptr;
    // The error code.
