...
namespace Models
{
  ...
  public:
    ...
    inline const ListQuotasPlansResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListQuotasPlansResponseBody) };
    inline ListQuotasPlansResponseBody getBody() { DARABONBA_PTR_GET(body_, ListQuotasPlansResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListQuotasPlansResponseBody> body_ {};
  };
