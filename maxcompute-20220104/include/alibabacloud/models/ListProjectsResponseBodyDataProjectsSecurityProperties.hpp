...
#ifndef ALIBABACLOUD_MODELS_LISTPROJECTSRESPONSEBODYDATAPROJECTSSECURITYPROPERTIES_HPP_
#define ALIBABACLOUD_MODELS_LISTPROJECTSRESPONSEBODYDATAPROJECTSSECURITYPROPERTIES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListProjectsResponseBodyDataProjectsSecurityProperties& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListProjectsResponseBodyDataProjectsSecurityProperties& obj) { 
    ...
    ListProjectsResponseBodyDataProjectsSecurityProperties() = default ;
    ListProjectsResponseBodyDataProjectsSecurityProperties(const ListProjectsResponseBodyDataProjectsSecurityProperties &) = default ;
    ListProjectsResponseBodyDataProjectsSecurityProperties(ListProjectsResponseBodyDataProjectsSecurityProperties &&) = default ;
    ListProjectsResponseBodyDataProjectsSecurityProperties(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListProjectsResponseBodyDataProjectsSecurityProperties() = default ;
    ListProjectsResponseBodyDataProjectsSecurityProperties& operator=(const ListProjectsResponseBodyDataProjectsSecurityProperties &) = default ;
    ListProjectsResponseBodyDataProjectsSecurityProperties& operator=(ListProjectsResponseBodyDataProjectsSecurityProperties &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->enableDownloadPrivilege_ != nullptr
    ...
    inline ListProjectsResponseBodyDataProjectsSecurityProperties& setEnableDownloadPrivilege(bool enableDownloadPrivilege) { DARABONBA_PTR_SET_VALUE(enableDownloadPrivilege_, enableDownloadPrivilege) };
    ...
    inline ListProjectsResponseBodyDataProjectsSecurityProperties& setLabelSecurity(bool labelSecurity) { DARABONBA_PTR_SET_VALUE(labelSecurity_, labelSecurity) };
    ...
    inline ListProjectsResponseBodyDataProjectsSecurityProperties& setObjectCreatorHasAccessPermission(bool objectCreatorHasAccessPermission) { DARABONBA_PTR_SET_VALUE(objectCreatorHasAccessPermission_, objectCreatorHasAccessPermission) };
    ...
    inline ListProjectsResponseBodyDataProjectsSecurityProperties& setObjectCreatorHasGrantPermission(bool objectCreatorHasGrantPermission) { DARABONBA_PTR_SET_VALUE(objectCreatorHasGrantPermission_, objectCreatorHasGrantPermission) };
    ...
    inline const Models::ListProjectsResponseBodyDataProjectsSecurityPropertiesProjectProtection & projectProtection() const { DARABONBA_PTR_GET_CONST(projectProtection_, Models::ListProjectsResponseBodyDataProjectsSecurityPropertiesProjectProtection) };
    inline Models::ListProjectsResponseBodyDataProjectsSecurityPropertiesProjectProtection projectProtection() { DARABONBA_PTR_GET(projectProtection_, Models::ListProjectsResponseBodyDataProjectsSecurityPropertiesProjectProtection) };
    inline ListProjectsResponseBodyDataProjectsSecurityProperties& setProjectProtection(const Models::ListProjectsResponseBodyDataProjectsSecurityPropertiesProjectProtection & projectProtection) { DARABONBA_PTR_SET_VALUE(projectProtection_, projectProtection) };
    inline ListProjectsResponseBodyDataProjectsSecurityProperties& setProjectProtection(Models::ListProjectsResponseBodyDataProjectsSecurityPropertiesProjectProtection && projectProtection) { DARABONBA_PTR_SET_RVALUE(projectProtection_, projectProtection) };
    ...
    inline ListProjectsResponseBodyDataProjectsSecurityProperties& setUsingAcl(bool usingAcl) { DARABONBA_PTR_SET_VALUE(usingAcl_, usingAcl) };
    ...
    inline ListProjectsResponseBodyDataProjectsSecurityProperties& setUsingPolicy(bool usingPolicy) { DARABONBA_PTR_SET_VALUE(usingPolicy_, usingPolicy) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ListProjectsResponseBodyDataProjectsSecurityPropertiesProjectProtection> projectProtection_ = nullptr;
