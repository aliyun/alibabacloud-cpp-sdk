...
#ifndef ALIBABACLOUD_MODELS_GETQUOTARESPONSEBODYDATASCHEDULEINFO_HPP_
#define ALIBABACLOUD_MODELS_GETQUOTARESPONSEBODYDATASCHEDULEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetQuotaResponseBodyDataScheduleInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetQuotaResponseBodyDataScheduleInfo& obj) { 
    ...
    GetQuotaResponseBodyDataScheduleInfo() = default ;
    GetQuotaResponseBodyDataScheduleInfo(const GetQuotaResponseBodyDataScheduleInfo &) = default ;
    GetQuotaResponseBodyDataScheduleInfo(GetQuotaResponseBodyDataScheduleInfo &&) = default ;
    GetQuotaResponseBodyDataScheduleInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetQuotaResponseBodyDataScheduleInfo() = default ;
    GetQuotaResponseBodyDataScheduleInfo& operator=(const GetQuotaResponseBodyDataScheduleInfo &) = default ;
    GetQuotaResponseBodyDataScheduleInfo& operator=(GetQuotaResponseBodyDataScheduleInfo &&) = default ;
    ...
    inline GetQuotaResponseBodyDataScheduleInfo& setCurrPlan(string currPlan) { DARABONBA_PTR_SET_VALUE(currPlan_, currPlan) };
    ...
    inline GetQuotaResponseBodyDataScheduleInfo& setCurrTime(string currTime) { DARABONBA_PTR_SET_VALUE(currTime_, currTime) };
    ...
    inline GetQuotaResponseBodyDataScheduleInfo& setNextPlan(string nextPlan) { DARABONBA_PTR_SET_VALUE(nextPlan_, nextPlan) };
    ...
    inline GetQuotaResponseBodyDataScheduleInfo& setNextTime(string nextTime) { DARABONBA_PTR_SET_VALUE(nextTime_, nextTime) };
    ...
    inline GetQuotaResponseBodyDataScheduleInfo& setOncePlan(string oncePlan) { DARABONBA_PTR_SET_VALUE(oncePlan_, oncePlan) };
    ...
    inline GetQuotaResponseBodyDataScheduleInfo& setOnceTime(string onceTime) { DARABONBA_PTR_SET_VALUE(onceTime_, onceTime) };
    ...
    inline GetQuotaResponseBodyDataScheduleInfo& setOperatorName(string operatorName) { DARABONBA_PTR_SET_VALUE(operatorName_, operatorName) };
    ...
    inline GetQuotaResponseBodyDataScheduleInfo& setTimezone(string timezone) { DARABONBA_PTR_SET_VALUE(timezone_, timezone) };
