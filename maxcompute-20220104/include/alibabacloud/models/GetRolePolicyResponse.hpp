...
namespace Models
{
  ...
  public:
    ...
    inline const GetRolePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRolePolicyResponseBody) };
    inline GetRolePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRolePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRolePolicyResponseBody> body_ {};
  };
