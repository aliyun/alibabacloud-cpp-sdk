...
namespace Models
{
  ...
  public:
    ...
    inline GetMmsTableResponseBodyData& setDstName(string dstName) { DARABONBA_PTR_SET_VALUE(dstName_, dstName) };
    ...
    inline GetMmsTableResponseBodyData& setDstProjectName(string dstProjectName) { DARABONBA_PTR_SET_VALUE(dstProjectName_, dstProjectName) };
    ...
    inline GetMmsTableResponseBodyData& setDstSchemaName(string dstSchemaName) { DARABONBA_PTR_SET_VALUE(dstSchemaName_, dstSchemaName) };
