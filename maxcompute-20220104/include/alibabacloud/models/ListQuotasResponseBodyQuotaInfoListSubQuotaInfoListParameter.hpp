...
#ifndef ALIBABACLOUD_MODELS_LISTQUOTASRESPONSEBODYQUOTAINFOLISTSUBQUOTAINFOLISTPARAMETER_HPP_
#define ALIBABACLOUD_MODELS_LISTQUOTASRESPONSEBODYQUOTAINFOLISTSUBQUOTAINFOLISTPARAMETER_HPP_
...
namespace Models
{
  ...
  public:
    ...
    ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter(ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter &&) = default ;
    ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter() = default ;
    ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter& operator=(const ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter &) = default ;
    ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter& operator=(ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter &&) = default ;
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter& setAutoScaleCPULimit(int64_t autoScaleCPULimit) { DARABONBA_PTR_SET_VALUE(autoScaleCPULimit_, autoScaleCPULimit) };
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter& setElasticReservedCU(int64_t elasticReservedCU) { DARABONBA_PTR_SET_VALUE(elasticReservedCU_, elasticReservedCU) };
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter& setEnablePriority(bool enablePriority) { DARABONBA_PTR_SET_VALUE(enablePriority_, enablePriority) };
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter& setForceReservedMin(bool forceReservedMin) { DARABONBA_PTR_SET_VALUE(forceReservedMin_, forceReservedMin) };
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListParameter& setSchedulerType(string schedulerType) { DARABONBA_PTR_SET_VALUE(schedulerType_, schedulerType) };
