...
#ifndef ALIBABACLOUD_MODELS_QUERYQUOTARESPONSEBODYDATASUBQUOTAINFOLISTSCHEDULEINFO_HPP_
#define ALIBABACLOUD_MODELS_QUERYQUOTARESPONSEBODYDATASUBQUOTAINFOLISTSCHEDULEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& obj) { 
    ...
    QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo() = default ;
    QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo(const QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo &) = default ;
    QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo(QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo &&) = default ;
    QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo() = default ;
    QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& operator=(const QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo &) = default ;
    QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& operator=(QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo &&) = default ;
    ...
    inline QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setCurrPlan(string currPlan) { DARABONBA_PTR_SET_VALUE(currPlan_, currPlan) };
    ...
    inline QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setCurrTime(string currTime) { DARABONBA_PTR_SET_VALUE(currTime_, currTime) };
    ...
    inline QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setNextPlan(string nextPlan) { DARABONBA_PTR_SET_VALUE(nextPlan_, nextPlan) };
    ...
    inline QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setNextTime(string nextTime) { DARABONBA_PTR_SET_VALUE(nextTime_, nextTime) };
    ...
    inline QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setOncePlan(string oncePlan) { DARABONBA_PTR_SET_VALUE(oncePlan_, oncePlan) };
    ...
    inline QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setOnceTime(string onceTime) { DARABONBA_PTR_SET_VALUE(onceTime_, onceTime) };
    ...
    inline QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setOperatorName(string operatorName) { DARABONBA_PTR_SET_VALUE(operatorName_, operatorName) };
    ...
    inline QueryQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setTimezone(string timezone) { DARABONBA_PTR_SET_VALUE(timezone_, timezone) };
