...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ascOrder_ == nullptr
        ...
        && return this->region_ == nullptr && return this->schema_ == nullptr && return this->tablePrefix_ == nullptr && return this->tenantId_ == nullptr && return this->typesShrink_ == nullptr; };
