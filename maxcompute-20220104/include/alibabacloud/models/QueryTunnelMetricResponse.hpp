...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTunnelMetricResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryTunnelMetricResponseBody) };
    inline QueryTunnelMetricResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryTunnelMetricResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryTunnelMetricResponseBody> body_ {};
  };
