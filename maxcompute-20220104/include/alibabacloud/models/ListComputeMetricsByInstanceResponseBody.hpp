...
namespace Models
{
  ...
  public:
    ...
    inline const ListComputeMetricsByInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListComputeMetricsByInstanceResponseBodyData) };
    inline ListComputeMetricsByInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, ListComputeMetricsByInstanceResponseBodyData) };
    inline ListComputeMetricsByInstanceResponseBody& setData(const ListComputeMetricsByInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListComputeMetricsByInstanceResponseBody& setData(ListComputeMetricsByInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListComputeMetricsByInstanceResponseBodyData> data_ = nullptr;
    // The error code.
