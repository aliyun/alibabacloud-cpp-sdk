...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->billingPolicy_ == nullptr
        && return this->cluster_ == nullptr && return this->createTime_ == nullptr && return this->creatorId_ == nullptr && return this->data_ == nullptr && return this->id_ == nullptr
        && return this->name_ == nullptr && return this->nickName_ == nullptr && return this->parameter_ == nullptr && return this->parentId_ == nullptr && return this->regionId_ == nullptr
        && return this->requestId_ == nullptr && return this->saleTag_ == nullptr && return this->scheduleInfo_ == nullptr && return this->status_ == nullptr && return this->subQuotaInfoList_ == nullptr
        && return this->tag_ == nullptr && return this->tenantId_ == nullptr && return this->type_ == nullptr && return this->version_ == nullptr; };
