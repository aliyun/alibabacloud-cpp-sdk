...
#ifndef ALIBABACLOUD_MODELS_GETQUOTAPLANRESPONSEBODYDATAQUOTASCHEDULEINFO_HPP_
#define ALIBABACLOUD_MODELS_GETQUOTAPLANRESPONSEBODYDATAQUOTASCHEDULEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetQuotaPlanResponseBodyDataQuotaScheduleInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetQuotaPlanResponseBodyDataQuotaScheduleInfo& obj) { 
    ...
    GetQuotaPlanResponseBodyDataQuotaScheduleInfo() = default ;
    GetQuotaPlanResponseBodyDataQuotaScheduleInfo(const GetQuotaPlanResponseBodyDataQuotaScheduleInfo &) = default ;
    GetQuotaPlanResponseBodyDataQuotaScheduleInfo(GetQuotaPlanResponseBodyDataQuotaScheduleInfo &&) = default ;
    GetQuotaPlanResponseBodyDataQuotaScheduleInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetQuotaPlanResponseBodyDataQuotaScheduleInfo() = default ;
    GetQuotaPlanResponseBodyDataQuotaScheduleInfo& operator=(const GetQuotaPlanResponseBodyDataQuotaScheduleInfo &) = default ;
    GetQuotaPlanResponseBodyDataQuotaScheduleInfo& operator=(GetQuotaPlanResponseBodyDataQuotaScheduleInfo &&) = default ;
    ...
    inline GetQuotaPlanResponseBodyDataQuotaScheduleInfo& setCurrPlan(string currPlan) { DARABONBA_PTR_SET_VALUE(currPlan_, currPlan) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaScheduleInfo& setCurrTime(string currTime) { DARABONBA_PTR_SET_VALUE(currTime_, currTime) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaScheduleInfo& setNextPlan(string nextPlan) { DARABONBA_PTR_SET_VALUE(nextPlan_, nextPlan) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaScheduleInfo& setNextTime(string nextTime) { DARABONBA_PTR_SET_VALUE(nextTime_, nextTime) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaScheduleInfo& setOncePlan(string oncePlan) { DARABONBA_PTR_SET_VALUE(oncePlan_, oncePlan) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaScheduleInfo& setOnceTime(string onceTime) { DARABONBA_PTR_SET_VALUE(onceTime_, onceTime) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaScheduleInfo& setOperatorName(string operatorName) { DARABONBA_PTR_SET_VALUE(operatorName_, operatorName) };
