...
namespace Models
{
  ...
  public:
    ...
    inline const GetQuotaUsageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQuotaUsageResponseBody) };
    inline GetQuotaUsageResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQuotaUsageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQuotaUsageResponseBody> body_ {};
  };
