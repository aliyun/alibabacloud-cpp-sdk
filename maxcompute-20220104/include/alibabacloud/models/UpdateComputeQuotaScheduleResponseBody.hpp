...
#ifndef ALIBABACLOUD_MODELS_UPDATECOMPUTEQUOTASCHEDULERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATECOMPUTEQUOTASCHEDULERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateComputeQuotaScheduleResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateComputeQuotaScheduleResponseBody& obj) { 
    ...
    UpdateComputeQuotaScheduleResponseBody() = default ;
    UpdateComputeQuotaScheduleResponseBody(const UpdateComputeQuotaScheduleResponseBody &) = default ;
    UpdateComputeQuotaScheduleResponseBody(UpdateComputeQuotaScheduleResponseBody &&) = default ;
    UpdateComputeQuotaScheduleResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateComputeQuotaScheduleResponseBody() = default ;
    UpdateComputeQuotaScheduleResponseBody& operator=(const UpdateComputeQuotaScheduleResponseBody &) = default ;
    UpdateComputeQuotaScheduleResponseBody& operator=(UpdateComputeQuotaScheduleResponseBody &&) = default ;
