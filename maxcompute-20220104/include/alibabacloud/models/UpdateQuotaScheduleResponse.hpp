...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateQuotaScheduleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateQuotaScheduleResponseBody) };
    inline UpdateQuotaScheduleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateQuotaScheduleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateQuotaScheduleResponseBody> body_ {};
  };
