...
namespace Models
{
  ...
  public:
    ...
    inline const GetStorageAmountSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetStorageAmountSummaryResponseBody) };
    inline GetStorageAmountSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetStorageAmountSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetStorageAmountSummaryResponseBody> body_ {};
  };
