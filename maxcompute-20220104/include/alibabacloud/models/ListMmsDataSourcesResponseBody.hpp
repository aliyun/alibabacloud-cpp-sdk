  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline ObjectList& setAgentIsOnline(bool agentIsOnline) { DARABONBA_PTR_SET_VALUE(agentIsOnline_, agentIsOnline) };


        // config Field Functions 
        bool hasConfig() const { return this->config_ != nullptr;};
        void deleteConfig() { this->config_ = nullptr;};
        inline const vector<ObjectList::Config> & getConfig() const { DARABONBA_PTR_GET_CONST(config_, vector<ObjectList::Config>) };
        inline vector<ObjectList::Config> getConfig() { DARABONBA_PTR_GET(config_, vector<ObjectList::Config>) };
        inline ObjectList& setConfig(const vector<ObjectList::Config> & config) { DARABONBA_PTR_SET_VALUE(config_, config) };
        inline ObjectList& setConfig(vector<ObjectList::Config> && config) { DARABONBA_PTR_SET_RVALUE(config_, config) };
        ...
        inline ObjectList& setDbNum(int32_t dbNum) { DARABONBA_PTR_SET_VALUE(dbNum_, dbNum) };
        ...
        inline ObjectList& setDstProject(string dstProject) { DARABONBA_PTR_SET_VALUE(dstProject_, dstProject) };
        ...
        inline ObjectList& setDstProjects(const vector<string> & dstProjects) { DARABONBA_PTR_SET_VALUE(dstProjects_, dstProjects) };
        inline ObjectList& setDstProjects(vector<string> && dstProjects) { DARABONBA_PTR_SET_RVALUE(dstProjects_, dstProjects) };
        ...
        inline ObjectList& setErrMsg(string errMsg) { DARABONBA_PTR_SET_VALUE(errMsg_, errMsg) };
        ...
        inline ObjectList& setLastUpdateTime(string lastUpdateTime) { DARABONBA_PTR_SET_VALUE(lastUpdateTime_, lastUpdateTime) };
        ...
        inline ObjectList& setNetworklink(string networklink) { DARABONBA_PTR_SET_VALUE(networklink_, networklink) };
        ...
        inline ObjectList& setPartitionNum(int32_t partitionNum) { DARABONBA_PTR_SET_VALUE(partitionNum_, partitionNum) };
        ...
        inline ObjectList& setPartitionsDoingNum(int32_t partitionsDoingNum) { DARABONBA_PTR_SET_VALUE(partitionsDoingNum_, partitionsDoingNum) };
        ...
        inline ObjectList& setPartitionsDoneNum(int32_t partitionsDoneNum) { DARABONBA_PTR_SET_VALUE(partitionsDoneNum_, partitionsDoneNum) };
        ...
        inline ObjectList& setPartitionsFailedNum(int32_t partitionsFailedNum) { DARABONBA_PTR_SET_VALUE(partitionsFailedNum_, partitionsFailedNum) };
        ...
        inline ObjectList& setTableNum(int32_t tableNum) { DARABONBA_PTR_SET_VALUE(tableNum_, tableNum) };
        ...
        inline ObjectList& setTablesDoingNum(int32_t tablesDoingNum) { DARABONBA_PTR_SET_VALUE(tablesDoingNum_, tablesDoingNum) };
        ...
        inline ObjectList& setTablesDoneNum(int32_t tablesDoneNum) { DARABONBA_PTR_SET_VALUE(tablesDoneNum_, tablesDoneNum) };
        ...
        inline ObjectList& setTablesFailedNum(int32_t tablesFailedNum) { DARABONBA_PTR_SET_VALUE(tablesFailedNum_, tablesFailedNum) };
        ...
        inline ObjectList& setTablesPartDoneNum(int32_t tablesPartDoneNum) { DARABONBA_PTR_SET_VALUE(tablesPartDoneNum_, tablesPartDoneNum) };
    ...
    inline const ListMmsDataSourcesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListMmsDataSourcesResponseBody::Data) };
    inline ListMmsDataSourcesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListMmsDataSourcesResponseBody::Data) };
    inline ListMmsDataSourcesResponseBody& setData(const ListMmsDataSourcesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMmsDataSourcesResponseBody& setData(ListMmsDataSourcesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
