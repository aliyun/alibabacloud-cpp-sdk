...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowFullScan_ == nullptr
        && return this->enableDecimal2_ == nullptr && return this->enableTunnelQuotaRoute_ == nullptr && return this->encryption_ == nullptr && return this->externalProjectProperties_ == nullptr && return this->retentionDays_ == nullptr
