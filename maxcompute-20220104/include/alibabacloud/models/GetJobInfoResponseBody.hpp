...
namespace Models
{
  ...
  public:
    ...
    inline const GetJobInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetJobInfoResponseBodyData) };
    inline GetJobInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetJobInfoResponseBodyData) };
    inline GetJobInfoResponseBody& setData(const GetJobInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetJobInfoResponseBody& setData(GetJobInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned result.
    std::shared_ptr<GetJobInfoResponseBodyData> data_ = nullptr;
    // The error code.
