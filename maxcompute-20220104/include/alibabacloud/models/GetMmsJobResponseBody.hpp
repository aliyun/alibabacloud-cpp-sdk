...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Data& setDstDbName(string dstDbName) { DARABONBA_PTR_SET_VALUE(dstDbName_, dstDbName) };
      ...
      inline Data& setEta(string eta) { DARABONBA_PTR_SET_VALUE(eta_, eta) };
      ...
      inline Data& setSrcSchemaName(string srcSchemaName) { DARABONBA_PTR_SET_VALUE(srcSchemaName_, srcSchemaName) };
      ...
      inline Data& setTaskDone(int32_t taskDone) { DARABONBA_PTR_SET_VALUE(taskDone_, taskDone) };
      ...
      inline Data& setTaskNum(int32_t taskNum) { DARABONBA_PTR_SET_VALUE(taskNum_, taskNum) };
    ...
    inline const GetMmsJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetMmsJobResponseBody::Data) };
    inline GetMmsJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetMmsJobResponseBody::Data) };
    inline GetMmsJobResponseBody& setData(const GetMmsJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMmsJobResponseBody& setData(GetMmsJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
