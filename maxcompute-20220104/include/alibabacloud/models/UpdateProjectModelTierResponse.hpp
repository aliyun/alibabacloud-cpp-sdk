...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateProjectModelTierResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateProjectModelTierResponseBody) };
    inline UpdateProjectModelTierResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateProjectModelTierResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateProjectModelTierResponseBody> body_ {};
  };
