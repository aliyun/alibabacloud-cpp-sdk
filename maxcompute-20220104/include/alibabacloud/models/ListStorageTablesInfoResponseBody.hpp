...
namespace Models
{
  ...
  public:
    ...
    inline const ListStorageTablesInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListStorageTablesInfoResponseBodyData) };
    inline ListStorageTablesInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, ListStorageTablesInfoResponseBodyData) };
    inline ListStorageTablesInfoResponseBody& setData(const ListStorageTablesInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListStorageTablesInfoResponseBody& setData(ListStorageTablesInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListStorageTablesInfoResponseBodyData> data_ = nullptr;
    // The error code.
