...
#ifndef ALIBABACLOUD_MODELS_SUMBILLSBYDATERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SUMBILLSBYDATERESPONSEBODY_HPP_
...
namespace Models
{
  class SumBillsByDateResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const SumBillsByDateResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(data, data_);
      DARABONBA_PTR_TO_JSON(httpCode, httpCode_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, SumBillsByDateResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(data, data_);
      DARABONBA_PTR_FROM_JSON(httpCode, httpCode_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    SumBillsByDateResponseBody() = default ;
    SumBillsByDateResponseBody(const SumBillsByDateResponseBody &) = default ;
    SumBillsByDateResponseBody(SumBillsByDateResponseBody &&) = default ;
    SumBillsByDateResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SumBillsByDateResponseBody() = default ;
    SumBillsByDateResponseBody& operator=(const SumBillsByDateResponseBody &) = default ;
    SumBillsByDateResponseBody& operator=(SumBillsByDateResponseBody &&) = default ;
    ...
    public:
      ...
      void deleteCost() { this->cost_ = nullptr;};
      inline string getCost() const { DARABONBA_PTR_GET_DEFAULT(cost_, "") };
      inline Data& setCost(string cost) { DARABONBA_PTR_SET_VALUE(cost_, cost) };
    ...
    inline const vector<SumBillsByDateResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<SumBillsByDateResponseBody::Data>) };
    inline vector<SumBillsByDateResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<SumBillsByDateResponseBody::Data>) };
    inline SumBillsByDateResponseBody& setData(const vector<SumBillsByDateResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SumBillsByDateResponseBody& setData(vector<SumBillsByDateResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline SumBillsByDateResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline SumBillsByDateResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
