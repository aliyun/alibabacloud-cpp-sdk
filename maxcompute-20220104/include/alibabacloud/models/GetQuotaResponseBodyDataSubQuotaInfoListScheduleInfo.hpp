...
#ifndef ALIBABACLOUD_MODELS_GETQUOTARESPONSEBODYDATASUBQUOTAINFOLISTSCHEDULEINFO_HPP_
#define ALIBABACLOUD_MODELS_GETQUOTARESPONSEBODYDATASUBQUOTAINFOLISTSCHEDULEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& obj) { 
    ...
    GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo() = default ;
    GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo(const GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo &) = default ;
    GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo(GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo &&) = default ;
    GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo() = default ;
    GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& operator=(const GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo &) = default ;
    GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& operator=(GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo &&) = default ;
    ...
    inline GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setCurrPlan(string currPlan) { DARABONBA_PTR_SET_VALUE(currPlan_, currPlan) };
    ...
    inline GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setCurrTime(string currTime) { DARABONBA_PTR_SET_VALUE(currTime_, currTime) };
    ...
    inline GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setNextPlan(string nextPlan) { DARABONBA_PTR_SET_VALUE(nextPlan_, nextPlan) };
    ...
    inline GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setNextTime(string nextTime) { DARABONBA_PTR_SET_VALUE(nextTime_, nextTime) };
    ...
    inline GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setOncePlan(string oncePlan) { DARABONBA_PTR_SET_VALUE(oncePlan_, oncePlan) };
    ...
    inline GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setOnceTime(string onceTime) { DARABONBA_PTR_SET_VALUE(onceTime_, onceTime) };
    ...
    inline GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setOperatorName(string operatorName) { DARABONBA_PTR_SET_VALUE(operatorName_, operatorName) };
    ...
    inline GetQuotaResponseBodyDataSubQuotaInfoListScheduleInfo& setTimezone(string timezone) { DARABONBA_PTR_SET_VALUE(timezone_, timezone) };
