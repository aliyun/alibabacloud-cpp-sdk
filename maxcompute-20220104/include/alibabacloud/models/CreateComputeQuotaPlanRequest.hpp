...
namespace Models
{
  ...
  public:
    ...
    inline const CreateComputeQuotaPlanRequest::Quota & getQuota() const { DARABONBA_PTR_GET_CONST(quota_, CreateComputeQuotaPlanRequest::Quota) };
    inline CreateComputeQuotaPlanRequest::Quota getQuota() { DARABONBA_PTR_GET(quota_, CreateComputeQuotaPlanRequest::Quota) };
    inline CreateComputeQuotaPlanRequest& setQuota(const CreateComputeQuotaPlanRequest::Quota & quota) { DARABONBA_PTR_SET_VALUE(quota_, quota) };
    inline CreateComputeQuotaPlanRequest& setQuota(CreateComputeQuotaPlanRequest::Quota && quota) { DARABONBA_PTR_SET_RVALUE(quota_, quota) };


  protected:
    // This parameter is required.
    shared_ptr<string> name_ {};
    shared_ptr<CreateComputeQuotaPlanRequest::Quota> quota_ {};
  };
