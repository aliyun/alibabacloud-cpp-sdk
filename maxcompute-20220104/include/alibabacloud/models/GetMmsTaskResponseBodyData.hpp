...
#ifndef ALIBABACLOUD_MODELS_GETMMSTASKRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETMMSTASKRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetMmsTaskResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetMmsTaskResponseBodyData& obj) { 
    ...
    GetMmsTaskResponseBodyData() = default ;
    GetMmsTaskResponseBodyData(const GetMmsTaskResponseBodyData &) = default ;
    GetMmsTaskResponseBodyData(GetMmsTaskResponseBodyData &&) = default ;
    GetMmsTaskResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetMmsTaskResponseBodyData() = default ;
    GetMmsTaskResponseBodyData& operator=(const GetMmsTaskResponseBodyData &) = default ;
    GetMmsTaskResponseBodyData& operator=(GetMmsTaskResponseBodyData &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->createTime_ == nullptr
        && return this->dbId_ == nullptr && return this->dstDbName_ == nullptr && return this->dstSchemaName_ == nullptr && return this->dstTableName_ == nullptr && return this->endTime_ == nullptr
        && return this->id_ == nullptr && return this->jobId_ == nullptr && return this->jobName_ == nullptr && return this->retriedTimes_ == nullptr && return this->running_ == nullptr
        && return this->sourceId_ == nullptr && return this->sourceName_ == nullptr && return this->srcDbName_ == nullptr && return this->srcSchemaName_ == nullptr && return this->srcTableName_ == nullptr
        && return this->startTime_ == nullptr && return this->status_ == nullptr && return this->stopped_ == nullptr && return this->tableId_ == nullptr && return this->type_ == nullptr; };
    // createTime Field Functions 
    bool hasCreateTime() const { return this->createTime_ != nullptr;};
    void deleteCreateTime() { this->createTime_ = nullptr;};
    inline string createTime() const { DARABONBA_PTR_GET_DEFAULT(createTime_, "") };
    inline GetMmsTaskResponseBodyData& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline GetMmsTaskResponseBodyData& setDbId(int64_t dbId) { DARABONBA_PTR_SET_VALUE(dbId_, dbId) };
    ...
    inline GetMmsTaskResponseBodyData& setDstDbName(string dstDbName) { DARABONBA_PTR_SET_VALUE(dstDbName_, dstDbName) };
    ...
    inline GetMmsTaskResponseBodyData& setDstSchemaName(string dstSchemaName) { DARABONBA_PTR_SET_VALUE(dstSchemaName_, dstSchemaName) };
    ...
    inline GetMmsTaskResponseBodyData& setDstTableName(string dstTableName) { DARABONBA_PTR_SET_VALUE(dstTableName_, dstTableName) };
    ...
    inline GetMmsTaskResponseBodyData& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline GetMmsTaskResponseBodyData& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetMmsTaskResponseBodyData& setJobId(int64_t jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline GetMmsTaskResponseBodyData& setJobName(string jobName) { DARABONBA_PTR_SET_VALUE(jobName_, jobName) };
    ...
    inline GetMmsTaskResponseBodyData& setRetriedTimes(int32_t retriedTimes) { DARABONBA_PTR_SET_VALUE(retriedTimes_, retriedTimes) };
    ...
    inline GetMmsTaskResponseBodyData& setRunning(bool running) { DARABONBA_PTR_SET_VALUE(running_, running) };
    ...
    inline GetMmsTaskResponseBodyData& setSourceId(int64_t sourceId) { DARABONBA_PTR_SET_VALUE(sourceId_, sourceId) };
    ...
    inline GetMmsTaskResponseBodyData& setSourceName(string sourceName) { DARABONBA_PTR_SET_VALUE(sourceName_, sourceName) };
    ...
    inline GetMmsTaskResponseBodyData& setSrcDbName(string srcDbName) { DARABONBA_PTR_SET_VALUE(srcDbName_, srcDbName) };
    ...
    inline GetMmsTaskResponseBodyData& setSrcSchemaName(string srcSchemaName) { DARABONBA_PTR_SET_VALUE(srcSchemaName_, srcSchemaName) };
    ...
    inline GetMmsTaskResponseBodyData& setSrcTableName(string srcTableName) { DARABONBA_PTR_SET_VALUE(srcTableName_, srcTableName) };
    ...
    inline GetMmsTaskResponseBodyData& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline GetMmsTaskResponseBodyData& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetMmsTaskResponseBodyData& setStopped(bool stopped) { DARABONBA_PTR_SET_VALUE(stopped_, stopped) };
    ...
    inline GetMmsTaskResponseBodyData& setTableId(int64_t tableId) { DARABONBA_PTR_SET_VALUE(tableId_, tableId) };
    ...
    inline GetMmsTaskResponseBodyData& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
