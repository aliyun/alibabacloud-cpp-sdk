...
namespace Models
{
  ...
  public:
    ...
    inline const QueryQuotaMetricResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryQuotaMetricResponseBodyData) };
    inline QueryQuotaMetricResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryQuotaMetricResponseBodyData) };
    inline QueryQuotaMetricResponseBody& setData(const QueryQuotaMetricResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryQuotaMetricResponseBody& setData(QueryQuotaMetricResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<QueryQuotaMetricResponseBodyData> data_ = nullptr;
