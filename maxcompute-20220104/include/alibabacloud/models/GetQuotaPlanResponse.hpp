...
namespace Models
{
  ...
  public:
    ...
    inline const GetQuotaPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQuotaPlanResponseBody) };
    inline GetQuotaPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQuotaPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQuotaPlanResponseBody> body_ {};
  };
