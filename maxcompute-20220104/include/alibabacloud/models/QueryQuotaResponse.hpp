...
namespace Models
{
  ...
  public:
    ...
    inline const QueryQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryQuotaResponseBody) };
    inline QueryQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryQuotaResponseBody> body_ {};
  };
