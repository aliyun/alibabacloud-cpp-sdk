...
namespace Models
{
  ...
  public:
    ...
    inline const GetRoleAclResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRoleAclResponseBodyData) };
    inline GetRoleAclResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRoleAclResponseBodyData) };
    inline GetRoleAclResponseBody& setData(const GetRoleAclResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRoleAclResponseBody& setData(GetRoleAclResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<GetRoleAclResponseBodyData> data_ = nullptr;
