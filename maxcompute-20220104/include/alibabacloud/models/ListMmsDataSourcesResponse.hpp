...
namespace Models
{
  ...
  public:
    ...
    inline const ListMmsDataSourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMmsDataSourcesResponseBody) };
    inline ListMmsDataSourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMmsDataSourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMmsDataSourcesResponseBody> body_ {};
  };
