...
namespace Models
{
  ...
  public:
    ...
    inline const GetMmsPartitionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMmsPartitionResponseBody) };
    inline GetMmsPartitionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMmsPartitionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMmsPartitionResponseBody> body_ {};
  };
