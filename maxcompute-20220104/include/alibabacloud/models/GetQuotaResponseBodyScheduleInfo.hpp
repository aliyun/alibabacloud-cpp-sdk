...
#ifndef ALIBABACLOUD_MODELS_GETQUOTARESPONSEBODYSCHEDULEINFO_HPP_
#define ALIBABACLOUD_MODELS_GETQUOTARESPONSEBODYSCHEDULEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetQuotaResponseBodyScheduleInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetQuotaResponseBodyScheduleInfo& obj) { 
    ...
    GetQuotaResponseBodyScheduleInfo() = default ;
    GetQuotaResponseBodyScheduleInfo(const GetQuotaResponseBodyScheduleInfo &) = default ;
    GetQuotaResponseBodyScheduleInfo(GetQuotaResponseBodyScheduleInfo &&) = default ;
    GetQuotaResponseBodyScheduleInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetQuotaResponseBodyScheduleInfo() = default ;
    GetQuotaResponseBodyScheduleInfo& operator=(const GetQuotaResponseBodyScheduleInfo &) = default ;
    GetQuotaResponseBodyScheduleInfo& operator=(GetQuotaResponseBodyScheduleInfo &&) = default ;
    ...
    inline GetQuotaResponseBodyScheduleInfo& setCurrPlan(string currPlan) { DARABONBA_PTR_SET_VALUE(currPlan_, currPlan) };
    ...
    inline GetQuotaResponseBodyScheduleInfo& setCurrTime(string currTime) { DARABONBA_PTR_SET_VALUE(currTime_, currTime) };
    ...
    inline GetQuotaResponseBodyScheduleInfo& setNextPlan(string nextPlan) { DARABONBA_PTR_SET_VALUE(nextPlan_, nextPlan) };
    ...
    inline GetQuotaResponseBodyScheduleInfo& setNextTime(string nextTime) { DARABONBA_PTR_SET_VALUE(nextTime_, nextTime) };
    ...
    inline GetQuotaResponseBodyScheduleInfo& setOncePlan(string oncePlan) { DARABONBA_PTR_SET_VALUE(oncePlan_, oncePlan) };
    ...
    inline GetQuotaResponseBodyScheduleInfo& setOnceTime(string onceTime) { DARABONBA_PTR_SET_VALUE(onceTime_, onceTime) };
    ...
    inline GetQuotaResponseBodyScheduleInfo& setOperatorName(string operatorName) { DARABONBA_PTR_SET_VALUE(operatorName_, operatorName) };
    ...
    inline GetQuotaResponseBodyScheduleInfo& setTimezone(string timezone) { DARABONBA_PTR_SET_VALUE(timezone_, timezone) };
