...
namespace Models
{
  ...
  public:
    ...
    inline const GetPackageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPackageResponseBodyData) };
    inline GetPackageResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPackageResponseBodyData) };
    inline GetPackageResponseBody& setData(const GetPackageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPackageResponseBody& setData(GetPackageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<GetPackageResponseBodyData> data_ = nullptr;
