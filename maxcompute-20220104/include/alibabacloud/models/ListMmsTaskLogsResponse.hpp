...
namespace Models
{
  ...
  public:
    ...
    inline const ListMmsTaskLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMmsTaskLogsResponseBody) };
    inline ListMmsTaskLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMmsTaskLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMmsTaskLogsResponseBody> body_ {};
  };
