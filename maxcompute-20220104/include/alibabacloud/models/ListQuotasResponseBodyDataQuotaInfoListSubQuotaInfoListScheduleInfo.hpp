...
#ifndef ALIBABACLOUD_MODELS_LISTQUOTASRESPONSEBODYDATAQUOTAINFOLISTSUBQUOTAINFOLISTSCHEDULEINFO_HPP_
#define ALIBABACLOUD_MODELS_LISTQUOTASRESPONSEBODYDATAQUOTAINFOLISTSUBQUOTAINFOLISTSCHEDULEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& obj) { 
    ...
    ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo() = default ;
    ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo(const ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo &) = default ;
    ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo(ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo &&) = default ;
    ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo() = default ;
    ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& operator=(const ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo &) = default ;
    ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& operator=(ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo &&) = default ;
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& setCurrPlan(string currPlan) { DARABONBA_PTR_SET_VALUE(currPlan_, currPlan) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& setCurrTime(string currTime) { DARABONBA_PTR_SET_VALUE(currTime_, currTime) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& setNextPlan(string nextPlan) { DARABONBA_PTR_SET_VALUE(nextPlan_, nextPlan) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& setNextTime(string nextTime) { DARABONBA_PTR_SET_VALUE(nextTime_, nextTime) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& setOncePlan(string oncePlan) { DARABONBA_PTR_SET_VALUE(oncePlan_, oncePlan) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& setOnceTime(string onceTime) { DARABONBA_PTR_SET_VALUE(onceTime_, onceTime) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& setOperatorName(string operatorName) { DARABONBA_PTR_SET_VALUE(operatorName_, operatorName) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListSubQuotaInfoListScheduleInfo& setTimezone(string timezone) { DARABONBA_PTR_SET_VALUE(timezone_, timezone) };
