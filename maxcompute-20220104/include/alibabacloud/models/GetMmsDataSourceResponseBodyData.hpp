...
#ifndef ALIBABACLOUD_MODELS_GETMMSDATASOURCERESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETMMSDATASOURCERESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetMmsDataSourceResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetMmsDataSourceResponseBodyData& obj) { 
    ...
    GetMmsDataSourceResponseBodyData() = default ;
    GetMmsDataSourceResponseBodyData(const GetMmsDataSourceResponseBodyData &) = default ;
    GetMmsDataSourceResponseBodyData(GetMmsDataSourceResponseBodyData &&) = default ;
    GetMmsDataSourceResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetMmsDataSourceResponseBodyData() = default ;
    GetMmsDataSourceResponseBodyData& operator=(const GetMmsDataSourceResponseBodyData &) = default ;
    GetMmsDataSourceResponseBodyData& operator=(GetMmsDataSourceResponseBodyData &&) = default ;
    ...
    inline GetMmsDataSourceResponseBodyData& setAgentIsOnline(bool agentIsOnline) { DARABONBA_PTR_SET_VALUE(agentIsOnline_, agentIsOnline) };


    // config Field Functions 
    bool hasConfig() const { return this->config_ != nullptr;};
    void deleteConfig() { this->config_ = nullptr;};
    inline const vector<Models::GetMmsDataSourceResponseBodyDataConfig> & config() const { DARABONBA_PTR_GET_CONST(config_, vector<Models::GetMmsDataSourceResponseBodyDataConfig>) };
    inline vector<Models::GetMmsDataSourceResponseBodyDataConfig> config() { DARABONBA_PTR_GET(config_, vector<Models::GetMmsDataSourceResponseBodyDataConfig>) };
    inline GetMmsDataSourceResponseBodyData& setConfig(const vector<Models::GetMmsDataSourceResponseBodyDataConfig> & config) { DARABONBA_PTR_SET_VALUE(config_, config) };
    inline GetMmsDataSourceResponseBodyData& setConfig(vector<Models::GetMmsDataSourceResponseBodyDataConfig> && config) { DARABONBA_PTR_SET_RVALUE(config_, config) };
    ...
    inline GetMmsDataSourceResponseBodyData& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline GetMmsDataSourceResponseBodyData& setDbNum(int32_t dbNum) { DARABONBA_PTR_SET_VALUE(dbNum_, dbNum) };
    ...
    inline GetMmsDataSourceResponseBodyData& setDstProject(string dstProject) { DARABONBA_PTR_SET_VALUE(dstProject_, dstProject) };
    ...
    inline GetMmsDataSourceResponseBodyData& setDstProjects(const vector<string> & dstProjects) { DARABONBA_PTR_SET_VALUE(dstProjects_, dstProjects) };
    inline GetMmsDataSourceResponseBodyData& setDstProjects(vector<string> && dstProjects) { DARABONBA_PTR_SET_RVALUE(dstProjects_, dstProjects) };
    ...
    inline GetMmsDataSourceResponseBodyData& setErrMsg(string errMsg) { DARABONBA_PTR_SET_VALUE(errMsg_, errMsg) };
    ...
    inline GetMmsDataSourceResponseBodyData& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetMmsDataSourceResponseBodyData& setLastUpdateTime(string lastUpdateTime) { DARABONBA_PTR_SET_VALUE(lastUpdateTime_, lastUpdateTime) };
    ...
    inline GetMmsDataSourceResponseBodyData& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetMmsDataSourceResponseBodyData& setNetworklink(string networklink) { DARABONBA_PTR_SET_VALUE(networklink_, networklink) };
    ...
    inline GetMmsDataSourceResponseBodyData& setPartitionNum(int32_t partitionNum) { DARABONBA_PTR_SET_VALUE(partitionNum_, partitionNum) };
    ...
    inline GetMmsDataSourceResponseBodyData& setPartitionsDoingNum(int32_t partitionsDoingNum) { DARABONBA_PTR_SET_VALUE(partitionsDoingNum_, partitionsDoingNum) };
    ...
    inline GetMmsDataSourceResponseBodyData& setPartitionsDoneNum(int32_t partitionsDoneNum) { DARABONBA_PTR_SET_VALUE(partitionsDoneNum_, partitionsDoneNum) };
    ...
    inline GetMmsDataSourceResponseBodyData& setPartitionsFailedNum(int32_t partitionsFailedNum) { DARABONBA_PTR_SET_VALUE(partitionsFailedNum_, partitionsFailedNum) };
    ...
    inline GetMmsDataSourceResponseBodyData& setRegion(string region) { DARABONBA_PTR_SET_VALUE(region_, region) };
    ...
    inline GetMmsDataSourceResponseBodyData& setScanId(int64_t scanId) { DARABONBA_PTR_SET_VALUE(scanId_, scanId) };
    ...
    inline GetMmsDataSourceResponseBodyData& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetMmsDataSourceResponseBodyData& setTableNum(int32_t tableNum) { DARABONBA_PTR_SET_VALUE(tableNum_, tableNum) };
    ...
    inline GetMmsDataSourceResponseBodyData& setTablesDoingNum(int32_t tablesDoingNum) { DARABONBA_PTR_SET_VALUE(tablesDoingNum_, tablesDoingNum) };
    ...
    inline GetMmsDataSourceResponseBodyData& setTablesDoneNum(int32_t tablesDoneNum) { DARABONBA_PTR_SET_VALUE(tablesDoneNum_, tablesDoneNum) };
    ...
    inline GetMmsDataSourceResponseBodyData& setTablesFailedNum(int32_t tablesFailedNum) { DARABONBA_PTR_SET_VALUE(tablesFailedNum_, tablesFailedNum) };
    ...
    inline GetMmsDataSourceResponseBodyData& setTablesPartDoneNum(int32_t tablesPartDoneNum) { DARABONBA_PTR_SET_VALUE(tablesPartDoneNum_, tablesPartDoneNum) };
    ...
    inline GetMmsDataSourceResponseBodyData& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };


  protected:
    std::shared_ptr<bool> agentIsOnline_ = nullptr;
    std::shared_ptr<vector<Models::GetMmsDataSourceResponseBodyDataConfig>> config_ = nullptr;
