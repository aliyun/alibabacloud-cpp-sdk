...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetComputeQuotaScheduleResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetComputeQuotaScheduleResponseBodyData>) };
    inline vector<GetComputeQuotaScheduleResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetComputeQuotaScheduleResponseBodyData>) };
    inline GetComputeQuotaScheduleResponseBody& setData(const vector<GetComputeQuotaScheduleResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetComputeQuotaScheduleResponseBody& setData(vector<GetComputeQuotaScheduleResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<vector<GetComputeQuotaScheduleResponseBodyData>> data_ = nullptr;
    // The error code.
