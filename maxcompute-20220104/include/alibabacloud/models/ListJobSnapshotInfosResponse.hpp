...
namespace Models
{
  ...
  public:
    ...
    inline const ListJobSnapshotInfosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListJobSnapshotInfosResponseBody) };
    inline ListJobSnapshotInfosResponseBody getBody() { DARABONBA_PTR_GET(body_, ListJobSnapshotInfosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListJobSnapshotInfosResponseBody> body_ {};
  };
