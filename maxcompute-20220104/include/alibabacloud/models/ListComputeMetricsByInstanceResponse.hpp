...
namespace Models
{
  ...
  public:
    ...
    inline const ListComputeMetricsByInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListComputeMetricsByInstanceResponseBody) };
    inline ListComputeMetricsByInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ListComputeMetricsByInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListComputeMetricsByInstanceResponseBody> body_ {};
  };
