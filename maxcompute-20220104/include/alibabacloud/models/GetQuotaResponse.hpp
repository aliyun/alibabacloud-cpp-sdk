...
namespace Models
{
  ...
  public:
    ...
    inline const GetQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQuotaResponseBody) };
    inline GetQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQuotaResponseBody> body_ {};
  };
