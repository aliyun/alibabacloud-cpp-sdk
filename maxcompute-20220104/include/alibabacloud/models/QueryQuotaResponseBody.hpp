...
namespace Models
{
  ...
  public:
    ...
    inline const QueryQuotaResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryQuotaResponseBodyData) };
    inline QueryQuotaResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryQuotaResponseBodyData) };
    inline QueryQuotaResponseBody& setData(const QueryQuotaResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryQuotaResponseBody& setData(QueryQuotaResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<QueryQuotaResponseBodyData> data_ = nullptr;
    // The error code.
