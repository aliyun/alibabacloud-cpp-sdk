...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMmsJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMmsJobResponseBody) };
    inline CreateMmsJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMmsJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMmsJobResponseBody> body_ {};
  };
