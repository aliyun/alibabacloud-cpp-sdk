...
namespace Models
{
  ...
  public:
    ...
    inline const GetRunningJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRunningJobsResponseBody) };
    inline GetRunningJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRunningJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRunningJobsResponseBody> body_ {};
  };
