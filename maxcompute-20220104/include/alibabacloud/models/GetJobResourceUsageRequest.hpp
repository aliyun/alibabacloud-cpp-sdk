...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getQuotaNicknameList() const { DARABONBA_PTR_GET_CONST(quotaNicknameList_, vector<string>) };
    inline vector<string> getQuotaNicknameList() { DARABONBA_PTR_GET(quotaNicknameList_, vector<string>) };
