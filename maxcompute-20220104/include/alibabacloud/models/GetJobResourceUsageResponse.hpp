...
namespace Models
{
  ...
  public:
    ...
    inline const GetJobResourceUsageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetJobResourceUsageResponseBody) };
    inline GetJobResourceUsageResponseBody getBody() { DARABONBA_PTR_GET(body_, GetJobResourceUsageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetJobResourceUsageResponseBody> body_ {};
  };
