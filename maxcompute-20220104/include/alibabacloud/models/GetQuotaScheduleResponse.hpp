...
namespace Models
{
  ...
  public:
    ...
    inline const GetQuotaScheduleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQuotaScheduleResponseBody) };
    inline GetQuotaScheduleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQuotaScheduleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQuotaScheduleResponseBody> body_ {};
  };
