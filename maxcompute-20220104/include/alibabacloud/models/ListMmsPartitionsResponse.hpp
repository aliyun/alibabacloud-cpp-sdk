...
namespace Models
{
  ...
  public:
    ...
    inline const ListMmsPartitionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMmsPartitionsResponseBody) };
    inline ListMmsPartitionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMmsPartitionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMmsPartitionsResponseBody> body_ {};
  };
