...
#ifndef ALIBABACLOUD_MODELS_LISTCOMPUTEQUOTAPLANRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTCOMPUTEQUOTAPLANRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListComputeQuotaPlanResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListComputeQuotaPlanResponseBody& obj) { 
    ...
    ListComputeQuotaPlanResponseBody() = default ;
    ListComputeQuotaPlanResponseBody(const ListComputeQuotaPlanResponseBody &) = default ;
    ListComputeQuotaPlanResponseBody(ListComputeQuotaPlanResponseBody &&) = default ;
    ListComputeQuotaPlanResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListComputeQuotaPlanResponseBody() = default ;
    ListComputeQuotaPlanResponseBody& operator=(const ListComputeQuotaPlanResponseBody &) = default ;
    ListComputeQuotaPlanResponseBody& operator=(ListComputeQuotaPlanResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline PlanList& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
        ...
        void deleteName() { this->name_ = nullptr;};
        inline string getName() const { DARABONBA_PTR_GET_DEFAULT(name_, "") };
        inline PlanList& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };


        // quota Field Functions 
        bool hasQuota() const { return this->quota_ != nullptr;};
        void deleteQuota() { this->quota_ = nullptr;};
        inline const PlanList::Quota & getQuota() const { DARABONBA_PTR_GET_CONST(quota_, PlanList::Quota) };
        inline PlanList::Quota getQuota() { DARABONBA_PTR_GET(quota_, PlanList::Quota) };
        inline PlanList& setQuota(const PlanList::Quota & quota) { DARABONBA_PTR_SET_VALUE(quota_, quota) };
        inline PlanList& setQuota(PlanList::Quota && quota) { DARABONBA_PTR_SET_RVALUE(quota_, quota) };
      ...
      inline const vector<Data::PlanList> & getPlanList() const { DARABONBA_PTR_GET_CONST(planList_, vector<Data::PlanList>) };
      inline vector<Data::PlanList> getPlanList() { DARABONBA_PTR_GET(planList_, vector<Data::PlanList>) };
      inline Data& setPlanList(const vector<Data::PlanList> & planList) { DARABONBA_PTR_SET_VALUE(planList_, planList) };
      inline Data& setPlanList(vector<Data::PlanList> && planList) { DARABONBA_PTR_SET_RVALUE(planList_, planList) };
    ...
    inline const ListComputeQuotaPlanResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListComputeQuotaPlanResponseBody::Data) };
    inline ListComputeQuotaPlanResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListComputeQuotaPlanResponseBody::Data) };
    inline ListComputeQuotaPlanResponseBody& setData(const ListComputeQuotaPlanResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListComputeQuotaPlanResponseBody& setData(ListComputeQuotaPlanResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListComputeQuotaPlanResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline ListComputeQuotaPlanResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    inline ListComputeQuotaPlanResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline ListComputeQuotaPlanResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
