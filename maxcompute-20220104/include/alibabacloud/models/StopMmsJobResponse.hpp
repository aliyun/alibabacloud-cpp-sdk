...
namespace Models
{
  ...
  public:
    ...
    inline const StopMmsJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopMmsJobResponseBody) };
    inline StopMmsJobResponseBody getBody() { DARABONBA_PTR_GET(body_, StopMmsJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopMmsJobResponseBody> body_ {};
  };
