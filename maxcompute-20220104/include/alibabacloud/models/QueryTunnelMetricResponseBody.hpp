...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTunnelMetricResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryTunnelMetricResponseBodyData) };
    inline QueryTunnelMetricResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryTunnelMetricResponseBodyData) };
    inline QueryTunnelMetricResponseBody& setData(const QueryTunnelMetricResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryTunnelMetricResponseBody& setData(QueryTunnelMetricResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<QueryTunnelMetricResponseBodyData> data_ = nullptr;
