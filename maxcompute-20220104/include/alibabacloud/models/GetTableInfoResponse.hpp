...
namespace Models
{
  ...
  public:
    ...
    inline const GetTableInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTableInfoResponseBody) };
    inline GetTableInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTableInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTableInfoResponseBody> body_ {};
  };
