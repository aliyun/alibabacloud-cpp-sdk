...
#ifndef ALIBABACLOUD_MODELS_LISTSTORAGETABLESINFOREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTSTORAGETABLESINFOREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListStorageTablesInfoRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListStorageTablesInfoRequest& obj) { 
    ...
    ListStorageTablesInfoRequest() = default ;
    ListStorageTablesInfoRequest(const ListStorageTablesInfoRequest &) = default ;
    ListStorageTablesInfoRequest(ListStorageTablesInfoRequest &&) = default ;
    ListStorageTablesInfoRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListStorageTablesInfoRequest() = default ;
    ListStorageTablesInfoRequest& operator=(const ListStorageTablesInfoRequest &) = default ;
    ListStorageTablesInfoRequest& operator=(ListStorageTablesInfoRequest &&) = default ;
