...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteComputeQuotaPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteComputeQuotaPlanResponseBody) };
    inline DeleteComputeQuotaPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteComputeQuotaPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteComputeQuotaPlanResponseBody> body_ {};
  };
