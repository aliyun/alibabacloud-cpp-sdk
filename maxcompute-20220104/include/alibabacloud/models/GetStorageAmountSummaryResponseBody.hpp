...
namespace Models
{
  ...
  public:
    ...
    inline const GetStorageAmountSummaryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetStorageAmountSummaryResponseBodyData) };
    inline GetStorageAmountSummaryResponseBodyData data() { DARABONBA_PTR_GET(data_, GetStorageAmountSummaryResponseBodyData) };
    inline GetStorageAmountSummaryResponseBody& setData(const GetStorageAmountSummaryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetStorageAmountSummaryResponseBody& setData(GetStorageAmountSummaryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetStorageAmountSummaryResponseBodyData> data_ = nullptr;
