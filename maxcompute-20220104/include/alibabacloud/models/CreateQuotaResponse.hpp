...
namespace Models
{
  ...
  public:
    ...
    inline const CreateQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateQuotaResponseBody) };
    inline CreateQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateQuotaResponseBody> body_ {};
  };
