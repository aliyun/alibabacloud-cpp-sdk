...
namespace Models
{
  ...
  public:
    ...
    inline const ListQuotasPlansResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListQuotasPlansResponseBody::Data) };
    inline ListQuotasPlansResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListQuotasPlansResponseBody::Data) };
    inline ListQuotasPlansResponseBody& setData(const ListQuotasPlansResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListQuotasPlansResponseBody& setData(ListQuotasPlansResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
