...
namespace Models
{
  ...
  public:
    ...
    inline const GetRunningJobsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRunningJobsResponseBodyData) };
    inline GetRunningJobsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRunningJobsResponseBodyData) };
    inline GetRunningJobsResponseBody& setData(const GetRunningJobsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRunningJobsResponseBody& setData(GetRunningJobsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<GetRunningJobsResponseBodyData> data_ = nullptr;
