...
#ifndef ALIBABACLOUD_MODELS_LISTQUOTASRESPONSEBODYQUOTAINFOLISTSUBQUOTAINFOLISTSCHEDULEINFO_HPP_
#define ALIBABACLOUD_MODELS_LISTQUOTASRESPONSEBODYQUOTAINFOLISTSUBQUOTAINFOLISTSCHEDULEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& obj) { 
    ...
    ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo() = default ;
    ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo(const ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo &) = default ;
    ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo(ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo &&) = default ;
    ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo() = default ;
    ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& operator=(const ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo &) = default ;
    ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& operator=(ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo &&) = default ;
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& setCurrPlan(string currPlan) { DARABONBA_PTR_SET_VALUE(currPlan_, currPlan) };
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& setCurrTime(string currTime) { DARABONBA_PTR_SET_VALUE(currTime_, currTime) };
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& setNextPlan(string nextPlan) { DARABONBA_PTR_SET_VALUE(nextPlan_, nextPlan) };
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& setNextTime(string nextTime) { DARABONBA_PTR_SET_VALUE(nextTime_, nextTime) };
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& setOncePlan(string oncePlan) { DARABONBA_PTR_SET_VALUE(oncePlan_, oncePlan) };
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& setOnceTime(string onceTime) { DARABONBA_PTR_SET_VALUE(onceTime_, onceTime) };
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& setOperatorName(string operatorName) { DARABONBA_PTR_SET_VALUE(operatorName_, operatorName) };
    ...
    inline ListQuotasResponseBodyQuotaInfoListSubQuotaInfoListScheduleInfo& setTimezone(string timezone) { DARABONBA_PTR_SET_VALUE(timezone_, timezone) };
