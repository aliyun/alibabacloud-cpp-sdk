...
namespace Models
{
  ...
  public:
    ...
    inline const GetMmsFetchMetadataJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMmsFetchMetadataJobResponseBody) };
    inline GetMmsFetchMetadataJobResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMmsFetchMetadataJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMmsFetchMetadataJobResponseBody> body_ {};
  };
