...
#ifndef ALIBABACLOUD_MODELS_LISTPROJECTSRESPONSEBODYDATAPROJECTSIPWHITELIST_HPP_
#define ALIBABACLOUD_MODELS_LISTPROJECTSRESPONSEBODYDATAPROJECTSIPWHITELIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListProjectsResponseBodyDataProjectsIpWhiteList& obj) { 
      DARABONBA_PTR_TO_JSON(ipList, ipList_);
      DARABONBA_PTR_TO_JSON(vpcIpList, vpcIpList_);
    };
    friend void from_json(const Darabonba::Json& j, ListProjectsResponseBodyDataProjectsIpWhiteList& obj) { 
      DARABONBA_PTR_FROM_JSON(ipList, ipList_);
      DARABONBA_PTR_FROM_JSON(vpcIpList, vpcIpList_);
    };
    ListProjectsResponseBodyDataProjectsIpWhiteList() = default ;
    ListProjectsResponseBodyDataProjectsIpWhiteList(const ListProjectsResponseBodyDataProjectsIpWhiteList &) = default ;
    ListProjectsResponseBodyDataProjectsIpWhiteList(ListProjectsResponseBodyDataProjectsIpWhiteList &&) = default ;
    ListProjectsResponseBodyDataProjectsIpWhiteList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListProjectsResponseBodyDataProjectsIpWhiteList() = default ;
    ListProjectsResponseBodyDataProjectsIpWhiteList& operator=(const ListProjectsResponseBodyDataProjectsIpWhiteList &) = default ;
    ListProjectsResponseBodyDataProjectsIpWhiteList& operator=(ListProjectsResponseBodyDataProjectsIpWhiteList &&) = default ;
    ...
    inline ListProjectsResponseBodyDataProjectsIpWhiteList& setIpList(string ipList) { DARABONBA_PTR_SET_VALUE(ipList_, ipList) };
    ...
    inline ListProjectsResponseBodyDataProjectsIpWhiteList& setVpcIpList(string vpcIpList) { DARABONBA_PTR_SET_VALUE(vpcIpList_, vpcIpList) };
