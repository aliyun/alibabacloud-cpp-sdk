...
namespace Models
{
  ...
  public:
    ...
    inline const GetQuotaUsageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQuotaUsageResponseBodyData) };
    inline GetQuotaUsageResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQuotaUsageResponseBodyData) };
    inline GetQuotaUsageResponseBody& setData(const GetQuotaUsageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQuotaUsageResponseBody& setData(GetQuotaUsageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<GetQuotaUsageResponseBodyData> data_ = nullptr;
    // The error code.
