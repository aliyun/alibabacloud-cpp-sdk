...
namespace Models
{
  ...
  public:
    ...
    inline const ListTunnelQuotaTimerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTunnelQuotaTimerResponseBody) };
    inline ListTunnelQuotaTimerResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTunnelQuotaTimerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTunnelQuotaTimerResponseBody> body_ {};
  };
