...
#ifndef ALIBABACLOUD_MODELS_CREATECOMPUTEQUOTAPLANREQUESTQUOTASUBQUOTAINFOLISTPARAMETER_HPP_
#define ALIBABACLOUD_MODELS_CREATECOMPUTEQUOTAPLANREQUESTQUOTASUBQUOTAINFOLISTPARAMETER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter& obj) { 
    ...
    CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter() = default ;
    CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter(const CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter &) = default ;
    CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter(CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter &&) = default ;
    CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter() = default ;
    CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter& operator=(const CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter &) = default ;
    CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter& operator=(CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter &&) = default ;
    ...
    inline CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter& setElasticReservedCU(int64_t elasticReservedCU) { DARABONBA_PTR_SET_VALUE(elasticReservedCU_, elasticReservedCU) };
    ...
    inline CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter& setMaxCU(int64_t maxCU) { DARABONBA_PTR_SET_VALUE(maxCU_, maxCU) };
    ...
    inline CreateComputeQuotaPlanRequestQuotaSubQuotaInfoListParameter& setMinCU(int64_t minCU) { DARABONBA_PTR_SET_VALUE(minCU_, minCU) };
