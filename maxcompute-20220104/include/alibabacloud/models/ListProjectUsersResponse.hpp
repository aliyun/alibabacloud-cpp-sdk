...
namespace Models
{
  ...
  public:
    ...
    inline const ListProjectUsersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListProjectUsersResponseBody) };
    inline ListProjectUsersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListProjectUsersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListProjectUsersResponseBody> body_ {};
  };
