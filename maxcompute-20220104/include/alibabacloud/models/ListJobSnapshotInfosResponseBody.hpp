...
namespace Models
{
  ...
  public:
    ...
    inline const ListJobSnapshotInfosResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListJobSnapshotInfosResponseBodyData) };
    inline ListJobSnapshotInfosResponseBodyData data() { DARABONBA_PTR_GET(data_, ListJobSnapshotInfosResponseBodyData) };
    inline ListJobSnapshotInfosResponseBody& setData(const ListJobSnapshotInfosResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListJobSnapshotInfosResponseBody& setData(ListJobSnapshotInfosResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<ListJobSnapshotInfosResponseBodyData> data_ = nullptr;
    // The error code.
