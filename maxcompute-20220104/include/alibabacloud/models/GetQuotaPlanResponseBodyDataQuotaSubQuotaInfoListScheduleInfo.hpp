...
#ifndef ALIBABACLOUD_MODELS_GETQUOTAPLANRESPONSEBODYDATAQUOTASUBQUOTAINFOLISTSCHEDULEINFO_HPP_
#define ALIBABACLOUD_MODELS_GETQUOTAPLANRESPONSEBODYDATAQUOTASUBQUOTAINFOLISTSCHEDULEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo& obj) { 
    ...
    GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo() = default ;
    GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo(const GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo &) = default ;
    GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo(GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo &&) = default ;
    GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo() = default ;
    GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo& operator=(const GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo &) = default ;
    GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo& operator=(GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo &&) = default ;
    ...
    inline GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo& setCurrPlan(string currPlan) { DARABONBA_PTR_SET_VALUE(currPlan_, currPlan) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo& setCurrTime(string currTime) { DARABONBA_PTR_SET_VALUE(currTime_, currTime) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo& setNextPlan(string nextPlan) { DARABONBA_PTR_SET_VALUE(nextPlan_, nextPlan) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo& setNextTime(string nextTime) { DARABONBA_PTR_SET_VALUE(nextTime_, nextTime) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo& setOncePlan(string oncePlan) { DARABONBA_PTR_SET_VALUE(oncePlan_, oncePlan) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo& setOnceTime(string onceTime) { DARABONBA_PTR_SET_VALUE(onceTime_, onceTime) };
    ...
    inline GetQuotaPlanResponseBodyDataQuotaSubQuotaInfoListScheduleInfo& setOperatorName(string operatorName) { DARABONBA_PTR_SET_VALUE(operatorName_, operatorName) };
