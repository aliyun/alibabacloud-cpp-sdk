...
namespace Models
{
  ...
  public:
    ...
    inline const GetMmsJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMmsJobResponseBody) };
    inline GetMmsJobResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMmsJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMmsJobResponseBody> body_ {};
  };
