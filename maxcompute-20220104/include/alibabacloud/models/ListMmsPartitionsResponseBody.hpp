  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline ObjectList& setDstValue(string dstValue) { DARABONBA_PTR_SET_VALUE(dstValue_, dstValue) };
        ...
        inline ObjectList& setTableName(string tableName) { DARABONBA_PTR_SET_VALUE(tableName_, tableName) };
    ...
    inline const ListMmsPartitionsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListMmsPartitionsResponseBody::Data) };
    inline ListMmsPartitionsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListMmsPartitionsResponseBody::Data) };
    inline ListMmsPartitionsResponseBody& setData(const ListMmsPartitionsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMmsPartitionsResponseBody& setData(ListMmsPartitionsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
