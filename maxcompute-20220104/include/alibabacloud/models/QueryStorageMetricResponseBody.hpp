...
#ifndef ALIBABACLOUD_MODELS_QUERYSTORAGEMETRICRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYSTORAGEMETRICRESPONSEBODY_HPP_
...
namespace Models
{
  class QueryStorageMetricResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryStorageMetricResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryStorageMetricResponseBody& obj) { 
    ...
    QueryStorageMetricResponseBody() = default ;
    QueryStorageMetricResponseBody(const QueryStorageMetricResponseBody &) = default ;
    QueryStorageMetricResponseBody(QueryStorageMetricResponseBody &&) = default ;
    QueryStorageMetricResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryStorageMetricResponseBody() = default ;
    QueryStorageMetricResponseBody& operator=(const QueryStorageMetricResponseBody &) = default ;
    QueryStorageMetricResponseBody& operator=(QueryStorageMetricResponseBody &&) = default ;
    ...
    inline const QueryStorageMetricResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryStorageMetricResponseBody::Data) };
    inline QueryStorageMetricResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryStorageMetricResponseBody::Data) };
    inline QueryStorageMetricResponseBody& setData(const QueryStorageMetricResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryStorageMetricResponseBody& setData(QueryStorageMetricResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryStorageMetricResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline QueryStorageMetricResponseBody& setErrorMsg(string errorMsg) { DARABONBA_PTR_SET_VALUE(errorMsg_, errorMsg) };
    ...
    inline QueryStorageMetricResponseBody& setHttpCode(int32_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline QueryStorageMetricResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The data returned.
    shared_ptr<QueryStorageMetricResponseBody::Data> data_ {};
    // The error code.
