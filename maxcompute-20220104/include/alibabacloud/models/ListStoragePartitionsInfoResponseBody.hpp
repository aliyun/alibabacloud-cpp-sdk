...
namespace Models
{
  ...
  public:
    ...
    inline const ListStoragePartitionsInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListStoragePartitionsInfoResponseBodyData) };
    inline ListStoragePartitionsInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, ListStoragePartitionsInfoResponseBodyData) };
    inline ListStoragePartitionsInfoResponseBody& setData(const ListStoragePartitionsInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListStoragePartitionsInfoResponseBody& setData(ListStoragePartitionsInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListStoragePartitionsInfoResponseBodyData> data_ = nullptr;
    // The error code.
