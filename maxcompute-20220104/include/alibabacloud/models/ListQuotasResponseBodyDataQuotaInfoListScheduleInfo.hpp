...
#ifndef ALIBABACLOUD_MODELS_LISTQUOTASRESPONSEBODYDATAQUOTAINFOLISTSCHEDULEINFO_HPP_
#define ALIBABACLOUD_MODELS_LISTQUOTASRESPONSEBODYDATAQUOTAINFOLISTSCHEDULEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& obj) { 
    ...
    ListQuotasResponseBodyDataQuotaInfoListScheduleInfo() = default ;
    ListQuotasResponseBodyDataQuotaInfoListScheduleInfo(const ListQuotasResponseBodyDataQuotaInfoListScheduleInfo &) = default ;
    ListQuotasResponseBodyDataQuotaInfoListScheduleInfo(ListQuotasResponseBodyDataQuotaInfoListScheduleInfo &&) = default ;
    ListQuotasResponseBodyDataQuotaInfoListScheduleInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListQuotasResponseBodyDataQuotaInfoListScheduleInfo() = default ;
    ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& operator=(const ListQuotasResponseBodyDataQuotaInfoListScheduleInfo &) = default ;
    ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& operator=(ListQuotasResponseBodyDataQuotaInfoListScheduleInfo &&) = default ;
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& setCurrPlan(string currPlan) { DARABONBA_PTR_SET_VALUE(currPlan_, currPlan) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& setCurrTime(string currTime) { DARABONBA_PTR_SET_VALUE(currTime_, currTime) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& setNextPlan(string nextPlan) { DARABONBA_PTR_SET_VALUE(nextPlan_, nextPlan) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& setNextTime(string nextTime) { DARABONBA_PTR_SET_VALUE(nextTime_, nextTime) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& setOncePlan(string oncePlan) { DARABONBA_PTR_SET_VALUE(oncePlan_, oncePlan) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& setOnceTime(string onceTime) { DARABONBA_PTR_SET_VALUE(onceTime_, onceTime) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& setOperatorName(string operatorName) { DARABONBA_PTR_SET_VALUE(operatorName_, operatorName) };
    ...
    inline ListQuotasResponseBodyDataQuotaInfoListScheduleInfo& setTimezone(string timezone) { DARABONBA_PTR_SET_VALUE(timezone_, timezone) };
