...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->areaSite_ == nullptr
        && return this->authenticationCode_ == nullptr && return this->availableFeatures_ == nullptr && return this->channel_ == nullptr && return this->clientId_ == nullptr && return this->clientName_ == nullptr
