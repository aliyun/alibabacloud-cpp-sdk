...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->areaSite_ == nullptr
        && this->authenticationCode_ == nullptr && this->availableFeatures_ == nullptr && this->channel_ == nullptr && this->clientId_ == nullptr && this->clientName_ == nullptr
        && this->clientOS_ == nullptr && this->clientType_ == nullptr && this->clientVersion_ == nullptr && this->currentStage_ == nullptr && this->directoryId_ == nullptr
        && this->encryptedFingerPrintData_ == nullptr && this->encryptedKey_ == nullptr && this->encryptedPassword_ == nullptr && this->endUserId_ == nullptr && this->fingerPrintData_ == nullptr
        && this->idpId_ == nullptr && this->imageUrl_ == nullptr && this->keepAlive_ == nullptr && this->keepAliveToken_ == nullptr && this->loginIdentifier_ == nullptr
        && this->loginName_ == nullptr && this->mfaType_ == nullptr && this->networkType_ == nullptr && this->newPassword_ == nullptr && this->officeSiteId_ == nullptr
        && this->oldPassword_ == nullptr && this->password_ == nullptr && this->phone_ == nullptr && this->phoneVerifyCode_ == nullptr && this->profileRegion_ == nullptr
        && this->regionId_ == nullptr && this->sessionId_ == nullptr && this->ssoExtendsCookies_ == nullptr && this->ssoSessionToken_ == nullptr && this->tokenCode_ == nullptr
        && this->umidToken_ == nullptr && this->uuid_ == nullptr; };
    ...
    inline GetLoginTokenRequest& setAreaSite(string areaSite) { DARABONBA_PTR_SET_VALUE(areaSite_, areaSite) };
    ...
    inline GetLoginTokenRequest& setChannel(string channel) { DARABONBA_PTR_SET_VALUE(channel_, channel) };
    ...
    inline GetLoginTokenRequest& setEncryptedFingerPrintData(string encryptedFingerPrintData) { DARABONBA_PTR_SET_VALUE(encryptedFingerPrintData_, encryptedFingerPrintData) };
    ...
    inline GetLoginTokenRequest& setEncryptedKey(string encryptedKey) { DARABONBA_PTR_SET_VALUE(encryptedKey_, encryptedKey) };
    ...
    inline GetLoginTokenRequest& setEncryptedPassword(string encryptedPassword) { DARABONBA_PTR_SET_VALUE(encryptedPassword_, encryptedPassword) };
    ...
    inline GetLoginTokenRequest& setFingerPrintData(string fingerPrintData) { DARABONBA_PTR_SET_VALUE(fingerPrintData_, fingerPrintData) };
    ...
    inline GetLoginTokenRequest& setIdpId(string idpId) { DARABONBA_PTR_SET_VALUE(idpId_, idpId) };
    ...
    inline GetLoginTokenRequest& setImageUrl(string imageUrl) { DARABONBA_PTR_SET_VALUE(imageUrl_, imageUrl) };
    ...
    inline GetLoginTokenRequest& setLoginIdentifier(string loginIdentifier) { DARABONBA_PTR_SET_VALUE(loginIdentifier_, loginIdentifier) };
    ...
    inline GetLoginTokenRequest& setLoginName(string loginName) { DARABONBA_PTR_SET_VALUE(loginName_, loginName) };
    ...
    inline GetLoginTokenRequest& setMfaType(string mfaType) { DARABONBA_PTR_SET_VALUE(mfaType_, mfaType) };
    ...
    inline GetLoginTokenRequest& setNetworkType(string networkType) { DARABONBA_PTR_SET_VALUE(networkType_, networkType) };
    ...
    inline GetLoginTokenRequest& setPhone(string phone) { DARABONBA_PTR_SET_VALUE(phone_, phone) };
    ...
    inline GetLoginTokenRequest& setPhoneVerifyCode(string phoneVerifyCode) { DARABONBA_PTR_SET_VALUE(phoneVerifyCode_, phoneVerifyCode) };
    ...
    inline GetLoginTokenRequest& setProfileRegion(string profileRegion) { DARABONBA_PTR_SET_VALUE(profileRegion_, profileRegion) };
    ...
    inline GetLoginTokenRequest& setSsoExtendsCookies(string ssoExtendsCookies) { DARABONBA_PTR_SET_VALUE(ssoExtendsCookies_, ssoExtendsCookies) };
    ...
    inline GetLoginTokenRequest& setSsoSessionToken(string ssoSessionToken) { DARABONBA_PTR_SET_VALUE(ssoSessionToken_, ssoSessionToken) };
    ...
    inline GetLoginTokenRequest& setUmidToken(string umidToken) { DARABONBA_PTR_SET_VALUE(umidToken_, umidToken) };
