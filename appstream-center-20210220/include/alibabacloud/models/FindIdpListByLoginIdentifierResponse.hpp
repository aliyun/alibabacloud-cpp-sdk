...
namespace Models
{
  ...
  public:
    ...
    inline const FindIdpListByLoginIdentifierResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FindIdpListByLoginIdentifierResponseBody) };
    inline FindIdpListByLoginIdentifierResponseBody getBody() { DARABONBA_PTR_GET(body_, FindIdpListByLoginIdentifierResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FindIdpListByLoginIdentifierResponseBody> body_ {};
  };
