...
namespace Models
{
  ...
  public:
    ...
    inline const GetLoginTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLoginTokenResponseBody) };
    inline GetLoginTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLoginTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLoginTokenResponseBody> body_ {};
  };
