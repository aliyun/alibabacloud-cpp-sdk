...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeKeyResponseBody) };
    inline DescribeKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeKeyResponseBody> body_ {};
  };
