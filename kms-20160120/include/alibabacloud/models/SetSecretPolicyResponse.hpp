...
namespace Models
{
  ...
  public:
    ...
    inline const SetSecretPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetSecretPolicyResponseBody) };
    inline SetSecretPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, SetSecretPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetSecretPolicyResponseBody> body_ {};
  };
