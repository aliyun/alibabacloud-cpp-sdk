...
namespace Models
{
  ...
  public:
    ...
    inline const GetParametersForImportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetParametersForImportResponseBody) };
    inline GetParametersForImportResponseBody getBody() { DARABONBA_PTR_GET(body_, GetParametersForImportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetParametersForImportResponseBody> body_ {};
  };
