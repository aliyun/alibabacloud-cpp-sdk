...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecretResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecretResponseBody) };
    inline DescribeSecretResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSecretResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSecretResponseBody> body_ = nullptr;
  };
