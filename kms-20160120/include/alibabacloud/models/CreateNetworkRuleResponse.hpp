...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNetworkRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateNetworkRuleResponseBody) };
    inline CreateNetworkRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateNetworkRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateNetworkRuleResponseBody> body_ {};
  };
