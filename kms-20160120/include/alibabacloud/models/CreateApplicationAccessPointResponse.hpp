...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApplicationAccessPointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateApplicationAccessPointResponseBody) };
    inline CreateApplicationAccessPointResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateApplicationAccessPointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateApplicationAccessPointResponseBody> body_ {};
  };
