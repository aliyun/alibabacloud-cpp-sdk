...
namespace Models
{
  ...
  public:
    ...
    inline const PutSecretValueResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutSecretValueResponseBody) };
    inline PutSecretValueResponseBody getBody() { DARABONBA_PTR_GET(body_, PutSecretValueResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PutSecretValueResponseBody> body_ {};
  };
