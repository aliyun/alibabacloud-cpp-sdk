...
namespace Models
{
  ...
  public:
    ...
    inline const EncryptResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EncryptResponseBody) };
    inline EncryptResponseBody getBody() { DARABONBA_PTR_GET(body_, EncryptResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EncryptResponseBody> body_ {};
  };
