...
namespace Models
{
  ...
  public:
    ...
    inline const UntagResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UntagResourceResponseBody) };
    inline UntagResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, UntagResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UntagResourceResponseBody> body_ {};
  };
