...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeKeyVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeKeyVersionResponseBody) };
    inline DescribeKeyVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeKeyVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeKeyVersionResponseBody> body_ {};
  };
