...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->KMProvider_ == nullptr
        && this->kmsInstanceId_ == nullptr && this->vSwitchIds_ == nullptr && this->vpcId_ == nullptr && this->zoneIds_ == nullptr; };
    ...
    inline string getKMProvider() const { DARABONBA_PTR_GET_DEFAULT(KMProvider_, "") };
