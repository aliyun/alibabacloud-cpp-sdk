...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceTagsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListResourceTagsResponseBody) };
    inline ListResourceTagsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListResourceTagsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListResourceTagsResponseBody> body_ {};
  };
