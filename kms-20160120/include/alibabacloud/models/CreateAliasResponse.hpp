...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAliasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAliasResponseBody) };
    inline CreateAliasResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAliasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAliasResponseBody> body_ {};
  };
