...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ciphertextBlob_ == nullptr
        && this->dryRun_ == nullptr && this->encryptionContext_ == nullptr && this->recipient_ == nullptr; };
    ...
    inline DecryptRequest& setRecipient(string recipient) { DARABONBA_PTR_SET_VALUE(recipient_, recipient) };
