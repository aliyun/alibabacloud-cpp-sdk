...
namespace Models
{
  ...
  public:
    ...
    inline const CreateKeyVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateKeyVersionResponseBody) };
    inline CreateKeyVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateKeyVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateKeyVersionResponseBody> body_ {};
  };
