...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateAndExportDataKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateAndExportDataKeyResponseBody) };
    inline GenerateAndExportDataKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateAndExportDataKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateAndExportDataKeyResponseBody> body_ {};
  };
