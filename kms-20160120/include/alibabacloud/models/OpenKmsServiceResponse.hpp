...
namespace Models
{
  ...
  public:
    ...
    inline const OpenKmsServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenKmsServiceResponseBody) };
    inline OpenKmsServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenKmsServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenKmsServiceResponseBody> body_ {};
  };
