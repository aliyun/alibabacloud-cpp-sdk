...
namespace Models
{
  ...
  public:
    ...
    inline const ListNetworkRulesResponseBodyNetworkRules & networkRules() const { DARABONBA_PTR_GET_CONST(networkRules_, ListNetworkRulesResponseBodyNetworkRules) };
    inline ListNetworkRulesResponseBodyNetworkRules networkRules() { DARABONBA_PTR_GET(networkRules_, ListNetworkRulesResponseBodyNetworkRules) };
    inline ListNetworkRulesResponseBody& setNetworkRules(const ListNetworkRulesResponseBodyNetworkRules & networkRules) { DARABONBA_PTR_SET_VALUE(networkRules_, networkRules) };
    inline ListNetworkRulesResponseBody& setNetworkRules(ListNetworkRulesResponseBodyNetworkRules && networkRules) { DARABONBA_PTR_SET_RVALUE(networkRules_, networkRules) };
  ...
  protected:
    ...
    std::shared_ptr<ListNetworkRulesResponseBodyNetworkRules> networkRules_ = nullptr;
    // The page number.
