...
namespace Models
{
  ...
  public:
    ...
    inline const ListAliasesByKeyIdResponseBody::Aliases & getAliases() const { DARABONBA_PTR_GET_CONST(aliases_, ListAliasesByKeyIdResponseBody::Aliases) };
    inline ListAliasesByKeyIdResponseBody::Aliases getAliases() { DARABONBA_PTR_GET(aliases_, ListAliasesByKeyIdResponseBody::Aliases) };
    inline ListAliasesByKeyIdResponseBody& setAliases(const ListAliasesByKeyIdResponseBody::Aliases & aliases) { DARABONBA_PTR_SET_VALUE(aliases_, aliases) };
    inline ListAliasesByKeyIdResponseBody& setAliases(ListAliasesByKeyIdResponseBody::Aliases && aliases) { DARABONBA_PTR_SET_RVALUE(aliases_, aliases) };
  ...
  protected:
    shared_ptr<ListAliasesByKeyIdResponseBody::Aliases> aliases_ {};
