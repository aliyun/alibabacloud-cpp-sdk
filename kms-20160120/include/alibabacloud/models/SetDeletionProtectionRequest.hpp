...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deletionProtectionDescription_ == nullptr
        && this->enableDeletionProtection_ == nullptr && this->keyId_ == nullptr && this->kmsInstanceId_ == nullptr && this->protectedResourceArn_ == nullptr; };
    ...
    inline bool getEnableDeletionProtection() const { DARABONBA_PTR_GET_DEFAULT(enableDeletionProtection_, false) };
    ...
    inline SetDeletionProtectionRequest& setKmsInstanceId(string kmsInstanceId) { DARABONBA_PTR_SET_VALUE(kmsInstanceId_, kmsInstanceId) };
    ...
    inline string getProtectedResourceArn() const { DARABONBA_PTR_GET_DEFAULT(protectedResourceArn_, "") };
