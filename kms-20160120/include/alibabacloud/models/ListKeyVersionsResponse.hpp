...
namespace Models
{
  ...
  public:
    ...
    inline const ListKeyVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListKeyVersionsResponseBody) };
    inline ListKeyVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListKeyVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListKeyVersionsResponseBody> body_ {};
  };
