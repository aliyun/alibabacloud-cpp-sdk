...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dryRun_ == nullptr
        && this->encryptionContext_ == nullptr && this->keyId_ == nullptr && this->keySpec_ == nullptr && this->numberOfBytes_ == nullptr && this->recipient_ == nullptr; };
    ...
    inline GenerateDataKeyRequest& setRecipient(string recipient) { DARABONBA_PTR_SET_VALUE(recipient_, recipient) };
