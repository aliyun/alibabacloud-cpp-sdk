...
namespace Models
{
  ...
  public:
    ...
    inline const DisableKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableKeyResponseBody) };
    inline DisableKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableKeyResponseBody> body_ {};
  };
