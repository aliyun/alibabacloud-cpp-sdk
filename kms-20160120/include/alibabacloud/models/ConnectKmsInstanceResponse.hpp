...
namespace Models
{
  ...
  public:
    ...
    inline const ConnectKmsInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConnectKmsInstanceResponseBody) };
    inline ConnectKmsInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ConnectKmsInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConnectKmsInstanceResponseBody> body_ {};
  };
