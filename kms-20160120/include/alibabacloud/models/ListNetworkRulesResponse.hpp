...
namespace Models
{
  ...
  public:
    ...
    inline const ListNetworkRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNetworkRulesResponseBody) };
    inline ListNetworkRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNetworkRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNetworkRulesResponseBody> body_ {};
  };
