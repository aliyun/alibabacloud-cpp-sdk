...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateDataKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateDataKeyResponseBody) };
    inline GenerateDataKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateDataKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateDataKeyResponseBody> body_ {};
  };
