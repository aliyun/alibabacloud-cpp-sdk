...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainPvDataResponseBody::PvDataInterval & getPvDataInterval() const { DARABONBA_PTR_GET_CONST(pvDataInterval_, DescribeDcdnDomainPvDataResponseBody::PvDataInterval) };
    inline DescribeDcdnDomainPvDataResponseBody::PvDataInterval getPvDataInterval() { DARABONBA_PTR_GET(pvDataInterval_, DescribeDcdnDomainPvDataResponseBody::PvDataInterval) };
    inline DescribeDcdnDomainPvDataResponseBody& setPvDataInterval(const DescribeDcdnDomainPvDataResponseBody::PvDataInterval & pvDataInterval) { DARABONBA_PTR_SET_VALUE(pvDataInterval_, pvDataInterval) };
    inline DescribeDcdnDomainPvDataResponseBody& setPvDataInterval(DescribeDcdnDomainPvDataResponseBody::PvDataInterval && pvDataInterval) { DARABONBA_PTR_SET_RVALUE(pvDataInterval_, pvDataInterval) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnDomainPvDataResponseBody::PvDataInterval> pvDataInterval_ {};
    // The request ID.
