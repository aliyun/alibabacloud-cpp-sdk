...
namespace Models
{
  ...
  public:
    ...
    inline const SetDcdnDomainStagingConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetDcdnDomainStagingConfigResponseBody) };
    inline SetDcdnDomainStagingConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, SetDcdnDomainStagingConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetDcdnDomainStagingConfigResponseBody> body_ {};
  };
