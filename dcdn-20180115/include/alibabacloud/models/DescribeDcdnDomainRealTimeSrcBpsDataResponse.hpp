...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainRealTimeSrcBpsDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainRealTimeSrcBpsDataResponseBody) };
    inline DescribeDcdnDomainRealTimeSrcBpsDataResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainRealTimeSrcBpsDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainRealTimeSrcBpsDataResponseBody> body_ = nullptr;
  };
