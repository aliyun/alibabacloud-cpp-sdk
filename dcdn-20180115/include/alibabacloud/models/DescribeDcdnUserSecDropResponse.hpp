...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnUserSecDropResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnUserSecDropResponseBody) };
    inline DescribeDcdnUserSecDropResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnUserSecDropResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnUserSecDropResponseBody> body_ {};
  };
