...
namespace Models
{
  ...
  public:
    ...
    inline const UploadRoutineCodeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UploadRoutineCodeResponseBody) };
    inline UploadRoutineCodeResponseBody body() { DARABONBA_PTR_GET(body_, UploadRoutineCodeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UploadRoutineCodeResponseBody> body_ = nullptr;
  };
