...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainMultiUsageDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainMultiUsageDataResponseBody) };
    inline DescribeDcdnDomainMultiUsageDataResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainMultiUsageDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainMultiUsageDataResponseBody> body_ = nullptr;
  };
