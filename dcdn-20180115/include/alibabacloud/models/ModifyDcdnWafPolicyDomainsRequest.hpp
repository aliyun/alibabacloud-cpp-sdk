...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->bindDomains_ != nullptr
    ...
    inline string bindDomains() const { DARABONBA_PTR_GET_DEFAULT(bindDomains_, "") };
    ...
    inline int32_t method() const { DARABONBA_PTR_GET_DEFAULT(method_, 0) };
    ...
    inline string unbindDomains() const { DARABONBA_PTR_GET_DEFAULT(unbindDomains_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> bindDomains_ = nullptr;
    ...
    std::shared_ptr<int32_t> method_ = nullptr;
    ...
    // 
    // > You can configure either **BindDomains** or **UnbindDomains**.
    std::shared_ptr<string> unbindDomains_ = nullptr;
  };
