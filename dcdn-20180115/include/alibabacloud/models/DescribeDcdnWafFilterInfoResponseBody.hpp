...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDcdnWafFilterInfoResponseBodyContent> & content() const { DARABONBA_PTR_GET_CONST(content_, vector<DescribeDcdnWafFilterInfoResponseBodyContent>) };
    inline vector<DescribeDcdnWafFilterInfoResponseBodyContent> content() { DARABONBA_PTR_GET(content_, vector<DescribeDcdnWafFilterInfoResponseBodyContent>) };
    inline DescribeDcdnWafFilterInfoResponseBody& setContent(const vector<DescribeDcdnWafFilterInfoResponseBodyContent> & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline DescribeDcdnWafFilterInfoResponseBody& setContent(vector<DescribeDcdnWafFilterInfoResponseBodyContent> && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDcdnWafFilterInfoResponseBodyContent>> content_ = nullptr;
