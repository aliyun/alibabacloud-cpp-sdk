...
namespace Models
{
  ...
  public:
    ...
    inline const StopDcdnDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopDcdnDomainResponseBody) };
    inline StopDcdnDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, StopDcdnDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopDcdnDomainResponseBody> body_ {};
  };
