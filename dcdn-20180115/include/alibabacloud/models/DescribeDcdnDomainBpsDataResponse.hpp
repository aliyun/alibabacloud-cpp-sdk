...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainBpsDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainBpsDataResponseBody) };
    inline DescribeDcdnDomainBpsDataResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainBpsDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainBpsDataResponseBody> body_ = nullptr;
  };
