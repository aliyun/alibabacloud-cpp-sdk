...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnUserResourcePackageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnUserResourcePackageResponseBody) };
    inline DescribeDcdnUserResourcePackageResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnUserResourcePackageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnUserResourcePackageResponseBody> body_ {};
  };
