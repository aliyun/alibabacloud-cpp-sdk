...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDCDNDOMAINTOPURLVISITRESPONSEBODYURL400LISTURLLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDCDNDOMAINTOPURLVISITRESPONSEBODYURL400LISTURLLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList& obj) { 
    ...
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList() = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList(const DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList &) = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList(DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList &&) = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList() = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList& operator=(const DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList &) = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList& operator=(DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList &&) = default ;
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList& setFlow(string flow) { DARABONBA_PTR_SET_VALUE(flow_, flow) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList& setFlowProportion(float flowProportion) { DARABONBA_PTR_SET_VALUE(flowProportion_, flowProportion) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList& setUrlDetail(string urlDetail) { DARABONBA_PTR_SET_VALUE(urlDetail_, urlDetail) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList& setVisitData(string visitData) { DARABONBA_PTR_SET_VALUE(visitData_, visitData) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl400ListUrlList& setVisitProportion(float visitProportion) { DARABONBA_PTR_SET_VALUE(visitProportion_, visitProportion) };
