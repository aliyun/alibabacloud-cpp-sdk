...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnRefreshQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnRefreshQuotaResponseBody) };
    inline DescribeDcdnRefreshQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnRefreshQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnRefreshQuotaResponseBody> body_ {};
  };
