...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnIpInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnIpInfoResponseBody) };
    inline DescribeDcdnIpInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnIpInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnIpInfoResponseBody> body_ {};
  };
