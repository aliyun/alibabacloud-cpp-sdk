...
namespace Models
{
  ...
  public:
    ...
    inline const ListDcdnRealTimeDeliveryProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDcdnRealTimeDeliveryProjectResponseBody) };
    inline ListDcdnRealTimeDeliveryProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDcdnRealTimeDeliveryProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDcdnRealTimeDeliveryProjectResponseBody> body_ {};
  };
