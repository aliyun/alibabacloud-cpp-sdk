...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnWafScenesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnWafScenesResponseBody) };
    inline DescribeDcdnWafScenesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnWafScenesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnWafScenesResponseBody> body_ {};
  };
