...
namespace Models
{
  ...
  public:
    ...
    inline const BatchPutDcdnKvWithHighCapacityResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, BatchPutDcdnKvWithHighCapacityResponseBody) };
    inline BatchPutDcdnKvWithHighCapacityResponseBody body() { DARABONBA_PTR_GET(body_, BatchPutDcdnKvWithHighCapacityResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<BatchPutDcdnKvWithHighCapacityResponseBody> body_ = nullptr;
  };
