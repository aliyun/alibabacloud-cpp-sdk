...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDcdnUserRealTimeDeliveryFieldResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDcdnUserRealTimeDeliveryFieldResponseBody) };
    inline UpdateDcdnUserRealTimeDeliveryFieldResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDcdnUserRealTimeDeliveryFieldResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDcdnUserRealTimeDeliveryFieldResponseBody> body_ {};
  };
