...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDcdnSLSRealtimeLogDeliveryResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, UpdateDcdnSLSRealtimeLogDeliveryResponseBody::Content) };
    inline UpdateDcdnSLSRealtimeLogDeliveryResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, UpdateDcdnSLSRealtimeLogDeliveryResponseBody::Content) };
    inline UpdateDcdnSLSRealtimeLogDeliveryResponseBody& setContent(const UpdateDcdnSLSRealtimeLogDeliveryResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline UpdateDcdnSLSRealtimeLogDeliveryResponseBody& setContent(UpdateDcdnSLSRealtimeLogDeliveryResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    shared_ptr<UpdateDcdnSLSRealtimeLogDeliveryResponseBody::Content> content_ {};
