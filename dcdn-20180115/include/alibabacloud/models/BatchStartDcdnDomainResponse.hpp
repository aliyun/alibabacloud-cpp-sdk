...
namespace Models
{
  ...
  public:
    ...
    inline const BatchStartDcdnDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchStartDcdnDomainResponseBody) };
    inline BatchStartDcdnDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchStartDcdnDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchStartDcdnDomainResponseBody> body_ {};
  };
