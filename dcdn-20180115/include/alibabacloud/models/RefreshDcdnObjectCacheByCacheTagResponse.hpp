...
namespace Models
{
  ...
  public:
    ...
    inline const RefreshDcdnObjectCacheByCacheTagResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RefreshDcdnObjectCacheByCacheTagResponseBody) };
    inline RefreshDcdnObjectCacheByCacheTagResponseBody body() { DARABONBA_PTR_GET(body_, RefreshDcdnObjectCacheByCacheTagResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RefreshDcdnObjectCacheByCacheTagResponseBody> body_ = nullptr;
  };
