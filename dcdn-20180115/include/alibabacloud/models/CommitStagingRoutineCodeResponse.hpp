...
namespace Models
{
  ...
  public:
    ...
    inline const CommitStagingRoutineCodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CommitStagingRoutineCodeResponseBody) };
    inline CommitStagingRoutineCodeResponseBody getBody() { DARABONBA_PTR_GET(body_, CommitStagingRoutineCodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CommitStagingRoutineCodeResponseBody> body_ {};
  };
