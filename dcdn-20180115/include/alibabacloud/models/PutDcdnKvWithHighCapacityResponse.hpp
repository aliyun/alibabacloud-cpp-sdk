...
namespace Models
{
  ...
  public:
    ...
    inline const PutDcdnKvWithHighCapacityResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, PutDcdnKvWithHighCapacityResponseBody) };
    inline PutDcdnKvWithHighCapacityResponseBody body() { DARABONBA_PTR_GET(body_, PutDcdnKvWithHighCapacityResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<PutDcdnKvWithHighCapacityResponseBody> body_ = nullptr;
  };
