...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnWafUsageDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnWafUsageDataResponseBody) };
    inline DescribeDcdnWafUsageDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnWafUsageDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnWafUsageDataResponseBody> body_ {};
  };
