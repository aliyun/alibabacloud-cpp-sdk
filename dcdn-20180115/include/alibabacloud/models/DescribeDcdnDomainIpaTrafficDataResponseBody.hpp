...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerInterval & trafficDataPerInterval() const { DARABONBA_PTR_GET_CONST(trafficDataPerInterval_, DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerInterval) };
    inline DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerInterval trafficDataPerInterval() { DARABONBA_PTR_GET(trafficDataPerInterval_, DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerInterval) };
    inline DescribeDcdnDomainIpaTrafficDataResponseBody& setTrafficDataPerInterval(const DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerInterval & trafficDataPerInterval) { DARABONBA_PTR_SET_VALUE(trafficDataPerInterval_, trafficDataPerInterval) };
    inline DescribeDcdnDomainIpaTrafficDataResponseBody& setTrafficDataPerInterval(DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerInterval && trafficDataPerInterval) { DARABONBA_PTR_SET_RVALUE(trafficDataPerInterval_, trafficDataPerInterval) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerInterval> trafficDataPerInterval_ = nullptr;
  };
