...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDeletedDomainsResponseBodyDomains & domains() const { DARABONBA_PTR_GET_CONST(domains_, DescribeDcdnDeletedDomainsResponseBodyDomains) };
    inline DescribeDcdnDeletedDomainsResponseBodyDomains domains() { DARABONBA_PTR_GET(domains_, DescribeDcdnDeletedDomainsResponseBodyDomains) };
    inline DescribeDcdnDeletedDomainsResponseBody& setDomains(const DescribeDcdnDeletedDomainsResponseBodyDomains & domains) { DARABONBA_PTR_SET_VALUE(domains_, domains) };
    inline DescribeDcdnDeletedDomainsResponseBody& setDomains(DescribeDcdnDeletedDomainsResponseBodyDomains && domains) { DARABONBA_PTR_SET_RVALUE(domains_, domains) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDeletedDomainsResponseBodyDomains> domains_ = nullptr;
