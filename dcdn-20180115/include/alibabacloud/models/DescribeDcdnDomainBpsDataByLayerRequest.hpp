...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDCDNDOMAINBPSDATABYLAYERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDCDNDOMAINBPSDATABYLAYERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDcdnDomainBpsDataByLayerRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDcdnDomainBpsDataByLayerRequest& obj) { 
    ...
    DescribeDcdnDomainBpsDataByLayerRequest() = default ;
    DescribeDcdnDomainBpsDataByLayerRequest(const DescribeDcdnDomainBpsDataByLayerRequest &) = default ;
    DescribeDcdnDomainBpsDataByLayerRequest(DescribeDcdnDomainBpsDataByLayerRequest &&) = default ;
    DescribeDcdnDomainBpsDataByLayerRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDcdnDomainBpsDataByLayerRequest() = default ;
    DescribeDcdnDomainBpsDataByLayerRequest& operator=(const DescribeDcdnDomainBpsDataByLayerRequest &) = default ;
    DescribeDcdnDomainBpsDataByLayerRequest& operator=(DescribeDcdnDomainBpsDataByLayerRequest &&) = default ;
    ...
    inline DescribeDcdnDomainBpsDataByLayerRequest& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };
    ...
    inline DescribeDcdnDomainBpsDataByLayerRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline DescribeDcdnDomainBpsDataByLayerRequest& setInterval(string interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline DescribeDcdnDomainBpsDataByLayerRequest& setIspNameEn(string ispNameEn) { DARABONBA_PTR_SET_VALUE(ispNameEn_, ispNameEn) };
    ...
    inline DescribeDcdnDomainBpsDataByLayerRequest& setLayer(string layer) { DARABONBA_PTR_SET_VALUE(layer_, layer) };
    ...
    inline DescribeDcdnDomainBpsDataByLayerRequest& setLocationNameEn(string locationNameEn) { DARABONBA_PTR_SET_VALUE(locationNameEn_, locationNameEn) };
    ...
    inline DescribeDcdnDomainBpsDataByLayerRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
