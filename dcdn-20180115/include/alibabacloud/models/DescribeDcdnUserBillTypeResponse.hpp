...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnUserBillTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnUserBillTypeResponseBody) };
    inline DescribeDcdnUserBillTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnUserBillTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnUserBillTypeResponseBody> body_ {};
  };
