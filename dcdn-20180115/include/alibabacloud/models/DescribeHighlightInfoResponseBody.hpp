...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeHighlightInfoResponseBodyDataModule> & dataModule() const { DARABONBA_PTR_GET_CONST(dataModule_, vector<DescribeHighlightInfoResponseBodyDataModule>) };
    inline vector<DescribeHighlightInfoResponseBodyDataModule> dataModule() { DARABONBA_PTR_GET(dataModule_, vector<DescribeHighlightInfoResponseBodyDataModule>) };
    inline DescribeHighlightInfoResponseBody& setDataModule(const vector<DescribeHighlightInfoResponseBodyDataModule> & dataModule) { DARABONBA_PTR_SET_VALUE(dataModule_, dataModule) };
    inline DescribeHighlightInfoResponseBody& setDataModule(vector<DescribeHighlightInfoResponseBodyDataModule> && dataModule) { DARABONBA_PTR_SET_RVALUE(dataModule_, dataModule) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeHighlightInfoResponseBodyDataModule>> dataModule_ = nullptr;
    // The request ID.
