...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBody) };
    inline DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBody> body_ {};
  };
