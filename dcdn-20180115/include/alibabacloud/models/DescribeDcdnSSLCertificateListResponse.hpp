...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnSSLCertificateListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnSSLCertificateListResponseBody) };
    inline DescribeDcdnSSLCertificateListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnSSLCertificateListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnSSLCertificateListResponseBody> body_ {};
  };
