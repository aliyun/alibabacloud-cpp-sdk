...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainBpsDataByLayerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainBpsDataByLayerResponseBody) };
    inline DescribeDcdnDomainBpsDataByLayerResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainBpsDataByLayerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainBpsDataByLayerResponseBody> body_ = nullptr;
  };
