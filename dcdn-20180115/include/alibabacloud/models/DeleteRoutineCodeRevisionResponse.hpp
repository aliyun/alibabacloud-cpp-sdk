...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRoutineCodeRevisionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRoutineCodeRevisionResponseBody) };
    inline DeleteRoutineCodeRevisionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRoutineCodeRevisionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRoutineCodeRevisionResponseBody> body_ {};
  };
