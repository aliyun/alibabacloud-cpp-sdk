...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainIspDataResponseBodyValue & value() const { DARABONBA_PTR_GET_CONST(value_, DescribeDcdnDomainIspDataResponseBodyValue) };
    inline DescribeDcdnDomainIspDataResponseBodyValue value() { DARABONBA_PTR_GET(value_, DescribeDcdnDomainIspDataResponseBodyValue) };
    inline DescribeDcdnDomainIspDataResponseBody& setValue(const DescribeDcdnDomainIspDataResponseBodyValue & value) { DARABONBA_PTR_SET_VALUE(value_, value) };
    inline DescribeDcdnDomainIspDataResponseBody& setValue(DescribeDcdnDomainIspDataResponseBodyValue && value) { DARABONBA_PTR_SET_RVALUE(value_, value) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainIspDataResponseBodyValue> value_ = nullptr;
  };
