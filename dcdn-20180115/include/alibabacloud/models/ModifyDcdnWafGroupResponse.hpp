...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDcdnWafGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyDcdnWafGroupResponseBody) };
    inline ModifyDcdnWafGroupResponseBody body() { DARABONBA_PTR_GET(body_, ModifyDcdnWafGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyDcdnWafGroupResponseBody> body_ = nullptr;
  };
