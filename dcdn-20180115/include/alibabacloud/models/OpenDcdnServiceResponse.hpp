...
namespace Models
{
  ...
  public:
    ...
    inline const OpenDcdnServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenDcdnServiceResponseBody) };
    inline OpenDcdnServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenDcdnServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenDcdnServiceResponseBody> body_ {};
  };
