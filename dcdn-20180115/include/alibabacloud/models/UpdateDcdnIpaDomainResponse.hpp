...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDcdnIpaDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDcdnIpaDomainResponseBody) };
    inline UpdateDcdnIpaDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDcdnIpaDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDcdnIpaDomainResponseBody> body_ {};
  };
