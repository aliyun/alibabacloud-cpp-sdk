...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHighlightInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHighlightInfoResponseBody) };
    inline DescribeHighlightInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHighlightInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHighlightInfoResponseBody> body_ {};
  };
