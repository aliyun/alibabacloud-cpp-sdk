...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnAclFieldsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnAclFieldsResponseBody) };
    inline DescribeDcdnAclFieldsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnAclFieldsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnAclFieldsResponseBody> body_ = nullptr;
  };
