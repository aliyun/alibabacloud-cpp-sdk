...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnIpaUserDomainsResponseBody::Domains & getDomains() const { DARABONBA_PTR_GET_CONST(domains_, DescribeDcdnIpaUserDomainsResponseBody::Domains) };
    inline DescribeDcdnIpaUserDomainsResponseBody::Domains getDomains() { DARABONBA_PTR_GET(domains_, DescribeDcdnIpaUserDomainsResponseBody::Domains) };
    inline DescribeDcdnIpaUserDomainsResponseBody& setDomains(const DescribeDcdnIpaUserDomainsResponseBody::Domains & domains) { DARABONBA_PTR_SET_VALUE(domains_, domains) };
    inline DescribeDcdnIpaUserDomainsResponseBody& setDomains(DescribeDcdnIpaUserDomainsResponseBody::Domains && domains) { DARABONBA_PTR_SET_RVALUE(domains_, domains) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnIpaUserDomainsResponseBody::Domains> domains_ {};
