...
namespace Models
{
  ...
  public:
    ...
    inline int32_t changingDomianNum() const { DARABONBA_PTR_GET_DEFAULT(changingDomianNum_, 0) };
    ...
    inline string changingEdition() const { DARABONBA_PTR_GET_DEFAULT(changingEdition_, "") };
    ...
    inline int32_t changingProtectNum() const { DARABONBA_PTR_GET_DEFAULT(changingProtectNum_, 0) };
    ...
    inline int32_t domianNum() const { DARABONBA_PTR_GET_DEFAULT(domianNum_, 0) };
    ...
    inline string endingTime() const { DARABONBA_PTR_GET_DEFAULT(endingTime_, "") };
    ...
    inline int32_t protectNum() const { DARABONBA_PTR_GET_DEFAULT(protectNum_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> changingDomianNum_ = nullptr;
    ...
    std::shared_ptr<string> changingEdition_ = nullptr;
    // The number of mitigation sessions with configuration changes.
    std::shared_ptr<int32_t> changingProtectNum_ = nullptr;
    ...
    // The number of protected domain names.
    std::shared_ptr<int32_t> domianNum_ = nullptr;
