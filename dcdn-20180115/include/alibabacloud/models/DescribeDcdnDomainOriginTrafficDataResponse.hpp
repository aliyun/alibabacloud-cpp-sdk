...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainOriginTrafficDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainOriginTrafficDataResponseBody) };
    inline DescribeDcdnDomainOriginTrafficDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainOriginTrafficDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnDomainOriginTrafficDataResponseBody> body_ {};
  };
