...
namespace Models
{
  ...
  public:
    ...
    inline const BatchSetDcdnWafDomainConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchSetDcdnWafDomainConfigsResponseBody) };
    inline BatchSetDcdnWafDomainConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchSetDcdnWafDomainConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchSetDcdnWafDomainConfigsResponseBody> body_ {};
  };
