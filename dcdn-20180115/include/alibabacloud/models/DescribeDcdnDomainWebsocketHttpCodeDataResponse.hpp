...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainWebsocketHttpCodeDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainWebsocketHttpCodeDataResponseBody) };
    inline DescribeDcdnDomainWebsocketHttpCodeDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainWebsocketHttpCodeDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnDomainWebsocketHttpCodeDataResponseBody> body_ {};
  };
