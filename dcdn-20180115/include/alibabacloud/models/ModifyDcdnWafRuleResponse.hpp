...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDcdnWafRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyDcdnWafRuleResponseBody) };
    inline ModifyDcdnWafRuleResponseBody body() { DARABONBA_PTR_GET(body_, ModifyDcdnWafRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyDcdnWafRuleResponseBody> body_ = nullptr;
  };
