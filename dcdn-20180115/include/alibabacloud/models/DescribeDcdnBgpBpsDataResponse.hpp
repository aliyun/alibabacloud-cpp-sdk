...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnBgpBpsDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnBgpBpsDataResponseBody) };
    inline DescribeDcdnBgpBpsDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnBgpBpsDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnBgpBpsDataResponseBody> body_ {};
  };
