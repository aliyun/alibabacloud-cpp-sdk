...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainTrafficDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainTrafficDataResponseBody) };
    inline DescribeDcdnDomainTrafficDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainTrafficDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnDomainTrafficDataResponseBody> body_ {};
  };
