...
namespace Models
{
  ...
  public:
    ...
    inline const PublishRoutineCodeRevisionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PublishRoutineCodeRevisionResponseBody) };
    inline PublishRoutineCodeRevisionResponseBody getBody() { DARABONBA_PTR_GET(body_, PublishRoutineCodeRevisionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PublishRoutineCodeRevisionResponseBody> body_ {};
  };
