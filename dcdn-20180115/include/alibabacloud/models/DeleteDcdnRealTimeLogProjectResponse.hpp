...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDcdnRealTimeLogProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDcdnRealTimeLogProjectResponseBody) };
    inline DeleteDcdnRealTimeLogProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDcdnRealTimeLogProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDcdnRealTimeLogProjectResponseBody> body_ {};
  };
