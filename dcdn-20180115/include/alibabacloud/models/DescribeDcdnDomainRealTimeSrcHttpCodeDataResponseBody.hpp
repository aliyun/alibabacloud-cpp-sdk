...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBodyRealTimeSrcHttpCodeData & realTimeSrcHttpCodeData() const { DARABONBA_PTR_GET_CONST(realTimeSrcHttpCodeData_, DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBodyRealTimeSrcHttpCodeData) };
    inline DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBodyRealTimeSrcHttpCodeData realTimeSrcHttpCodeData() { DARABONBA_PTR_GET(realTimeSrcHttpCodeData_, DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBodyRealTimeSrcHttpCodeData) };
    inline DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBody& setRealTimeSrcHttpCodeData(const DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBodyRealTimeSrcHttpCodeData & realTimeSrcHttpCodeData) { DARABONBA_PTR_SET_VALUE(realTimeSrcHttpCodeData_, realTimeSrcHttpCodeData) };
    inline DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBody& setRealTimeSrcHttpCodeData(DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBodyRealTimeSrcHttpCodeData && realTimeSrcHttpCodeData) { DARABONBA_PTR_SET_RVALUE(realTimeSrcHttpCodeData_, realTimeSrcHttpCodeData) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBodyRealTimeSrcHttpCodeData> realTimeSrcHttpCodeData_ = nullptr;
