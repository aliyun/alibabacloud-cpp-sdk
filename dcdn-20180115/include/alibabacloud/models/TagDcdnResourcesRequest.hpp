...
namespace Models
{
  ...
  public:
    ...
    inline const vector<TagDcdnResourcesRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<TagDcdnResourcesRequest::Tag>) };
    inline vector<TagDcdnResourcesRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<TagDcdnResourcesRequest::Tag>) };
    inline TagDcdnResourcesRequest& setTag(const vector<TagDcdnResourcesRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline TagDcdnResourcesRequest& setTag(vector<TagDcdnResourcesRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<TagDcdnResourcesRequest::Tag>> tag_ {};
  };
