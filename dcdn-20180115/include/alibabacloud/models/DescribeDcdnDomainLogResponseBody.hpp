...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainLogResponseBody::DomainLogDetails & getDomainLogDetails() const { DARABONBA_PTR_GET_CONST(domainLogDetails_, DescribeDcdnDomainLogResponseBody::DomainLogDetails) };
    inline DescribeDcdnDomainLogResponseBody::DomainLogDetails getDomainLogDetails() { DARABONBA_PTR_GET(domainLogDetails_, DescribeDcdnDomainLogResponseBody::DomainLogDetails) };
    inline DescribeDcdnDomainLogResponseBody& setDomainLogDetails(const DescribeDcdnDomainLogResponseBody::DomainLogDetails & domainLogDetails) { DARABONBA_PTR_SET_VALUE(domainLogDetails_, domainLogDetails) };
    inline DescribeDcdnDomainLogResponseBody& setDomainLogDetails(DescribeDcdnDomainLogResponseBody::DomainLogDetails && domainLogDetails) { DARABONBA_PTR_SET_RVALUE(domainLogDetails_, domainLogDetails) };
  ...
  protected:
    // The log information.
    shared_ptr<DescribeDcdnDomainLogResponseBody::DomainLogDetails> domainLogDetails_ {};
    // The domain name.
