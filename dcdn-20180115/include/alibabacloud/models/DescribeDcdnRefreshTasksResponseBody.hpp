...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnRefreshTasksResponseBodyTasks & tasks() const { DARABONBA_PTR_GET_CONST(tasks_, DescribeDcdnRefreshTasksResponseBodyTasks) };
    inline DescribeDcdnRefreshTasksResponseBodyTasks tasks() { DARABONBA_PTR_GET(tasks_, DescribeDcdnRefreshTasksResponseBodyTasks) };
    inline DescribeDcdnRefreshTasksResponseBody& setTasks(const DescribeDcdnRefreshTasksResponseBodyTasks & tasks) { DARABONBA_PTR_SET_VALUE(tasks_, tasks) };
    inline DescribeDcdnRefreshTasksResponseBody& setTasks(DescribeDcdnRefreshTasksResponseBodyTasks && tasks) { DARABONBA_PTR_SET_RVALUE(tasks_, tasks) };
  ...
  protected:
    ...
    // Details about tasks.
    std::shared_ptr<DescribeDcdnRefreshTasksResponseBodyTasks> tasks_ = nullptr;
    // The number of tasks.
