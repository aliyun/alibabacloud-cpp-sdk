...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainRealTimeHttpCodeDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainRealTimeHttpCodeDataResponseBody) };
    inline DescribeDcdnDomainRealTimeHttpCodeDataResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainRealTimeHttpCodeDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainRealTimeHttpCodeDataResponseBody> body_ = nullptr;
  };
