...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnIpaDomainDetailResponseBody::DomainDetail & getDomainDetail() const { DARABONBA_PTR_GET_CONST(domainDetail_, DescribeDcdnIpaDomainDetailResponseBody::DomainDetail) };
    inline DescribeDcdnIpaDomainDetailResponseBody::DomainDetail getDomainDetail() { DARABONBA_PTR_GET(domainDetail_, DescribeDcdnIpaDomainDetailResponseBody::DomainDetail) };
    inline DescribeDcdnIpaDomainDetailResponseBody& setDomainDetail(const DescribeDcdnIpaDomainDetailResponseBody::DomainDetail & domainDetail) { DARABONBA_PTR_SET_VALUE(domainDetail_, domainDetail) };
    inline DescribeDcdnIpaDomainDetailResponseBody& setDomainDetail(DescribeDcdnIpaDomainDetailResponseBody::DomainDetail && domainDetail) { DARABONBA_PTR_SET_RVALUE(domainDetail_, domainDetail) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnIpaDomainDetailResponseBody::DomainDetail> domainDetail_ {};
