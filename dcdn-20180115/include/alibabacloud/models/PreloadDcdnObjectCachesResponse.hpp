...
namespace Models
{
  ...
  public:
    ...
    inline const PreloadDcdnObjectCachesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PreloadDcdnObjectCachesResponseBody) };
    inline PreloadDcdnObjectCachesResponseBody getBody() { DARABONBA_PTR_GET(body_, PreloadDcdnObjectCachesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PreloadDcdnObjectCachesResponseBody> body_ {};
  };
