...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDcdnDeliverTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDcdnDeliverTaskResponseBody) };
    inline CreateDcdnDeliverTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDcdnDeliverTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDcdnDeliverTaskResponseBody> body_ {};
  };
