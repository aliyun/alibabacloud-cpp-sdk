...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnKvNamespaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnKvNamespaceResponseBody) };
    inline DescribeDcdnKvNamespaceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnKvNamespaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnKvNamespaceResponseBody> body_ {};
  };
