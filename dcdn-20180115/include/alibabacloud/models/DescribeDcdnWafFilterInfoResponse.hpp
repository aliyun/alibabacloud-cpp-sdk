...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnWafFilterInfoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnWafFilterInfoResponseBody) };
    inline DescribeDcdnWafFilterInfoResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnWafFilterInfoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnWafFilterInfoResponseBody> body_ = nullptr;
  };
