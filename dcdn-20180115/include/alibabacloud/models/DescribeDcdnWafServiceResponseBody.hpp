...
namespace Models
{
  ...
  public:
    ...
    inline string requestBillingType() const { DARABONBA_PTR_GET_DEFAULT(requestBillingType_, "") };
    ...
    inline string ruleBillingType() const { DARABONBA_PTR_GET_DEFAULT(ruleBillingType_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> requestBillingType_ = nullptr;
    // The ID of the request.
    std::shared_ptr<string> requestId_ = nullptr;
    // The metering method for rules. You are charged for the number of SeCUs.
    std::shared_ptr<string> ruleBillingType_ = nullptr;
    // The status of WAF. Valid values:
    // 
    // *   Normal
    // *   WaitForExpire
