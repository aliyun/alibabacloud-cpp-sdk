...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnBgpTrafficDataResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnBgpTrafficDataResponseBody) };
    inline DescribeDcdnBgpTrafficDataResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnBgpTrafficDataResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnBgpTrafficDataResponseBody> body_ = nullptr;
  };
