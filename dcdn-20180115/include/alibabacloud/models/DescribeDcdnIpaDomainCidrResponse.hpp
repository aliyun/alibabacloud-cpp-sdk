...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnIpaDomainCidrResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnIpaDomainCidrResponseBody) };
    inline DescribeDcdnIpaDomainCidrResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnIpaDomainCidrResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnIpaDomainCidrResponseBody> body_ {};
  };
