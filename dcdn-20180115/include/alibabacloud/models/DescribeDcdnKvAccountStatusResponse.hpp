...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnKvAccountStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnKvAccountStatusResponseBody) };
    inline DescribeDcdnKvAccountStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnKvAccountStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnKvAccountStatusResponseBody> body_ {};
  };
