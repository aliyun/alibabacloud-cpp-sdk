...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnsecServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnsecServiceResponseBody) };
    inline DescribeDcdnsecServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnsecServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnsecServiceResponseBody> body_ {};
  };
