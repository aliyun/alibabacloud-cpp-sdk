...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainRegionDataResponseBodyValue & value() const { DARABONBA_PTR_GET_CONST(value_, DescribeDcdnDomainRegionDataResponseBodyValue) };
    inline DescribeDcdnDomainRegionDataResponseBodyValue value() { DARABONBA_PTR_GET(value_, DescribeDcdnDomainRegionDataResponseBodyValue) };
    inline DescribeDcdnDomainRegionDataResponseBody& setValue(const DescribeDcdnDomainRegionDataResponseBodyValue & value) { DARABONBA_PTR_SET_VALUE(value_, value) };
    inline DescribeDcdnDomainRegionDataResponseBody& setValue(DescribeDcdnDomainRegionDataResponseBodyValue && value) { DARABONBA_PTR_SET_RVALUE(value_, value) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainRegionDataResponseBodyValue> value_ = nullptr;
  };
