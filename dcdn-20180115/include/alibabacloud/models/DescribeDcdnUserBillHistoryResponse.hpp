...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnUserBillHistoryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnUserBillHistoryResponseBody) };
    inline DescribeDcdnUserBillHistoryResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnUserBillHistoryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnUserBillHistoryResponseBody> body_ = nullptr;
  };
