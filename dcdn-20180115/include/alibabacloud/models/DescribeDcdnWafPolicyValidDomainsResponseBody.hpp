...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDcdnWafPolicyValidDomainsResponseBodyDomains> & domains() const { DARABONBA_PTR_GET_CONST(domains_, vector<DescribeDcdnWafPolicyValidDomainsResponseBodyDomains>) };
    inline vector<DescribeDcdnWafPolicyValidDomainsResponseBodyDomains> domains() { DARABONBA_PTR_GET(domains_, vector<DescribeDcdnWafPolicyValidDomainsResponseBodyDomains>) };
    inline DescribeDcdnWafPolicyValidDomainsResponseBody& setDomains(const vector<DescribeDcdnWafPolicyValidDomainsResponseBodyDomains> & domains) { DARABONBA_PTR_SET_VALUE(domains_, domains) };
    inline DescribeDcdnWafPolicyValidDomainsResponseBody& setDomains(vector<DescribeDcdnWafPolicyValidDomainsResponseBodyDomains> && domains) { DARABONBA_PTR_SET_RVALUE(domains_, domains) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDcdnWafPolicyValidDomainsResponseBodyDomains>> domains_ = nullptr;
