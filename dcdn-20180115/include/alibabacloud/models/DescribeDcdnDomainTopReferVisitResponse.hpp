...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainTopReferVisitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainTopReferVisitResponseBody) };
    inline DescribeDcdnDomainTopReferVisitResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainTopReferVisitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnDomainTopReferVisitResponseBody> body_ {};
  };
