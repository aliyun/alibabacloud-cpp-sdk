...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnUserQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnUserQuotaResponseBody) };
    inline DescribeDcdnUserQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnUserQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnUserQuotaResponseBody> body_ {};
  };
