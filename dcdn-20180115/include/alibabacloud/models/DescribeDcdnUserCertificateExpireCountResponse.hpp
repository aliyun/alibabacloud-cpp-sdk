...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnUserCertificateExpireCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnUserCertificateExpireCountResponseBody) };
    inline DescribeDcdnUserCertificateExpireCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnUserCertificateExpireCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnUserCertificateExpireCountResponseBody> body_ {};
  };
