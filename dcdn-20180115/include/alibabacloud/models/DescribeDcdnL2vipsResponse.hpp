...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnL2VipsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnL2VipsResponseBody) };
    inline DescribeDcdnL2VipsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnL2VipsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnL2VipsResponseBody> body_ = nullptr;
  };
