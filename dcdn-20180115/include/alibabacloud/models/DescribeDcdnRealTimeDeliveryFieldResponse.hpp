...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnRealTimeDeliveryFieldResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnRealTimeDeliveryFieldResponseBody) };
    inline DescribeDcdnRealTimeDeliveryFieldResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnRealTimeDeliveryFieldResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnRealTimeDeliveryFieldResponseBody> body_ {};
  };
