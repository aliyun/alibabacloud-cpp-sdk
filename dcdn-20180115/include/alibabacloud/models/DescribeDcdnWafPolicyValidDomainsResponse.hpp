...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnWafPolicyValidDomainsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnWafPolicyValidDomainsResponseBody) };
    inline DescribeDcdnWafPolicyValidDomainsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnWafPolicyValidDomainsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnWafPolicyValidDomainsResponseBody> body_ = nullptr;
  };
