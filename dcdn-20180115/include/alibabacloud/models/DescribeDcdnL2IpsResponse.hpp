...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnL2IpsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnL2IpsResponseBody) };
    inline DescribeDcdnL2IpsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnL2IpsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnL2IpsResponseBody> body_ {};
  };
