...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDCDNDOMAINTOPURLVISITRESPONSEBODYURL500LISTURLLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDCDNDOMAINTOPURLVISITRESPONSEBODYURL500LISTURLLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList& obj) { 
    ...
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList() = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList(const DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList &) = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList(DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList &&) = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList() = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList& operator=(const DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList &) = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList& operator=(DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList &&) = default ;
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList& setFlow(string flow) { DARABONBA_PTR_SET_VALUE(flow_, flow) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList& setFlowProportion(float flowProportion) { DARABONBA_PTR_SET_VALUE(flowProportion_, flowProportion) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList& setUrlDetail(string urlDetail) { DARABONBA_PTR_SET_VALUE(urlDetail_, urlDetail) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList& setVisitData(string visitData) { DARABONBA_PTR_SET_VALUE(visitData_, visitData) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl500ListUrlList& setVisitProportion(float visitProportion) { DARABONBA_PTR_SET_VALUE(visitProportion_, visitProportion) };
