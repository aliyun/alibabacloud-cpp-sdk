...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDcdnSpecificConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteDcdnSpecificConfigResponseBody) };
    inline DeleteDcdnSpecificConfigResponseBody body() { DARABONBA_PTR_GET(body_, DeleteDcdnSpecificConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteDcdnSpecificConfigResponseBody> body_ = nullptr;
  };
