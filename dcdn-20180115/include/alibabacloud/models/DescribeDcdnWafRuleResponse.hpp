...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnWafRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnWafRuleResponseBody) };
    inline DescribeDcdnWafRuleResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnWafRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnWafRuleResponseBody> body_ = nullptr;
  };
