...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnUserSecDropByMinuteResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnUserSecDropByMinuteResponseBody) };
    inline DescribeDcdnUserSecDropByMinuteResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnUserSecDropByMinuteResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnUserSecDropByMinuteResponseBody> body_ = nullptr;
  };
