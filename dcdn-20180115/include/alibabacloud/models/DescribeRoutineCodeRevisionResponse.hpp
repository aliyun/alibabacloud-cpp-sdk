...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRoutineCodeRevisionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeRoutineCodeRevisionResponseBody) };
    inline DescribeRoutineCodeRevisionResponseBody body() { DARABONBA_PTR_GET(body_, DescribeRoutineCodeRevisionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRoutineCodeRevisionResponseBody> body_ = nullptr;
  };
