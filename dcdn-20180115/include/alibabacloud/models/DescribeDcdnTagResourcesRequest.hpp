...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDcdnTagResourcesRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeDcdnTagResourcesRequest::Tag>) };
    inline vector<DescribeDcdnTagResourcesRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeDcdnTagResourcesRequest::Tag>) };
    inline DescribeDcdnTagResourcesRequest& setTag(const vector<DescribeDcdnTagResourcesRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeDcdnTagResourcesRequest& setTag(vector<DescribeDcdnTagResourcesRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeDcdnTagResourcesRequest::Tag>> tag_ {};
  };
