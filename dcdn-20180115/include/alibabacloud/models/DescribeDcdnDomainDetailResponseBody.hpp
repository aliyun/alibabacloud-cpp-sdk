...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainDetailResponseBodyDomainDetail & domainDetail() const { DARABONBA_PTR_GET_CONST(domainDetail_, DescribeDcdnDomainDetailResponseBodyDomainDetail) };
    inline DescribeDcdnDomainDetailResponseBodyDomainDetail domainDetail() { DARABONBA_PTR_GET(domainDetail_, DescribeDcdnDomainDetailResponseBodyDomainDetail) };
    inline DescribeDcdnDomainDetailResponseBody& setDomainDetail(const DescribeDcdnDomainDetailResponseBodyDomainDetail & domainDetail) { DARABONBA_PTR_SET_VALUE(domainDetail_, domainDetail) };
    inline DescribeDcdnDomainDetailResponseBody& setDomainDetail(DescribeDcdnDomainDetailResponseBodyDomainDetail && domainDetail) { DARABONBA_PTR_SET_RVALUE(domainDetail_, domainDetail) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainDetailResponseBodyDomainDetail> domainDetail_ = nullptr;
