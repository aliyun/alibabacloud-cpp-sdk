...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCustomDomainSampleRateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCustomDomainSampleRateResponseBody) };
    inline DeleteCustomDomainSampleRateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCustomDomainSampleRateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCustomDomainSampleRateResponseBody> body_ {};
  };
