...
namespace Models
{
  ...
  public:
    ...
    inline const BatchDeleteDcdnKvWithHighCapacityResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, BatchDeleteDcdnKvWithHighCapacityResponseBody) };
    inline BatchDeleteDcdnKvWithHighCapacityResponseBody body() { DARABONBA_PTR_GET(body_, BatchDeleteDcdnKvWithHighCapacityResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<BatchDeleteDcdnKvWithHighCapacityResponseBody> body_ = nullptr;
  };
