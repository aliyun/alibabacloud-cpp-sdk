...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDdosAllEventListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDdosAllEventListResponseBody) };
    inline DescribeDdosAllEventListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDdosAllEventListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDdosAllEventListResponseBody> body_ {};
  };
