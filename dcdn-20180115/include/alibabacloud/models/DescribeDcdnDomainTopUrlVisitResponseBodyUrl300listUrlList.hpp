...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDCDNDOMAINTOPURLVISITRESPONSEBODYURL300LISTURLLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDCDNDOMAINTOPURLVISITRESPONSEBODYURL300LISTURLLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList& obj) { 
    ...
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList() = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList(const DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList &) = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList(DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList &&) = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList() = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList& operator=(const DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList &) = default ;
    DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList& operator=(DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList &&) = default ;
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList& setFlow(string flow) { DARABONBA_PTR_SET_VALUE(flow_, flow) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList& setFlowProportion(float flowProportion) { DARABONBA_PTR_SET_VALUE(flowProportion_, flowProportion) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList& setUrlDetail(string urlDetail) { DARABONBA_PTR_SET_VALUE(urlDetail_, urlDetail) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList& setVisitData(string visitData) { DARABONBA_PTR_SET_VALUE(visitData_, visitData) };
    ...
    inline DescribeDcdnDomainTopUrlVisitResponseBodyUrl300ListUrlList& setVisitProportion(float visitProportion) { DARABONBA_PTR_SET_VALUE(visitProportion_, visitProportion) };
