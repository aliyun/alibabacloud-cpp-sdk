...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnRefreshTaskByIdResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnRefreshTaskByIdResponseBody) };
    inline DescribeDcdnRefreshTaskByIdResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnRefreshTaskByIdResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnRefreshTaskByIdResponseBody> body_ = nullptr;
  };
