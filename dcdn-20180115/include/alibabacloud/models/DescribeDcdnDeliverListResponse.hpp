...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDeliverListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDeliverListResponseBody) };
    inline DescribeDcdnDeliverListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnDeliverListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDeliverListResponseBody> body_ = nullptr;
  };
