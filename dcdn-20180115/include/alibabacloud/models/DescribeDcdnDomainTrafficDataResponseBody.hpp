...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainTrafficDataResponseBodyTrafficDataPerInterval & trafficDataPerInterval() const { DARABONBA_PTR_GET_CONST(trafficDataPerInterval_, DescribeDcdnDomainTrafficDataResponseBodyTrafficDataPerInterval) };
    inline DescribeDcdnDomainTrafficDataResponseBodyTrafficDataPerInterval trafficDataPerInterval() { DARABONBA_PTR_GET(trafficDataPerInterval_, DescribeDcdnDomainTrafficDataResponseBodyTrafficDataPerInterval) };
    inline DescribeDcdnDomainTrafficDataResponseBody& setTrafficDataPerInterval(const DescribeDcdnDomainTrafficDataResponseBodyTrafficDataPerInterval & trafficDataPerInterval) { DARABONBA_PTR_SET_VALUE(trafficDataPerInterval_, trafficDataPerInterval) };
    inline DescribeDcdnDomainTrafficDataResponseBody& setTrafficDataPerInterval(DescribeDcdnDomainTrafficDataResponseBodyTrafficDataPerInterval && trafficDataPerInterval) { DARABONBA_PTR_SET_RVALUE(trafficDataPerInterval_, trafficDataPerInterval) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainTrafficDataResponseBodyTrafficDataPerInterval> trafficDataPerInterval_ = nullptr;
  };
