...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRoutineUserInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRoutineUserInfoResponseBody) };
    inline DescribeRoutineUserInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRoutineUserInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRoutineUserInfoResponseBody> body_ {};
  };
