...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainLogResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainLogResponseBody) };
    inline DescribeDcdnDomainLogResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainLogResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnDomainLogResponseBody> body_ = nullptr;
  };
