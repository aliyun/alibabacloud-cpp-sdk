...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnWafDomainDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnWafDomainDetailResponseBody) };
    inline DescribeDcdnWafDomainDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnWafDomainDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnWafDomainDetailResponseBody> body_ {};
  };
