...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDcdnIpaDomainResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteDcdnIpaDomainResponseBody) };
    inline DeleteDcdnIpaDomainResponseBody body() { DARABONBA_PTR_GET(body_, DeleteDcdnIpaDomainResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteDcdnIpaDomainResponseBody> body_ = nullptr;
  };
