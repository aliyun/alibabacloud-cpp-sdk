...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnFullDomainsBlockIPConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnFullDomainsBlockIPConfigResponseBody) };
    inline DescribeDcdnFullDomainsBlockIPConfigResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDcdnFullDomainsBlockIPConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDcdnFullDomainsBlockIPConfigResponseBody> body_ = nullptr;
  };
