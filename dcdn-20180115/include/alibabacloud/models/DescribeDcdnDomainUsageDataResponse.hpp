...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainUsageDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainUsageDataResponseBody) };
    inline DescribeDcdnDomainUsageDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainUsageDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnDomainUsageDataResponseBody> body_ {};
  };
