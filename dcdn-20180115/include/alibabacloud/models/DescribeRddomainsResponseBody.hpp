...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRDDomainsResponseBodyDomains & domains() const { DARABONBA_PTR_GET_CONST(domains_, DescribeRDDomainsResponseBodyDomains) };
    inline DescribeRDDomainsResponseBodyDomains domains() { DARABONBA_PTR_GET(domains_, DescribeRDDomainsResponseBodyDomains) };
    inline DescribeRDDomainsResponseBody& setDomains(const DescribeRDDomainsResponseBodyDomains & domains) { DARABONBA_PTR_SET_VALUE(domains_, domains) };
    inline DescribeRDDomainsResponseBody& setDomains(DescribeRDDomainsResponseBodyDomains && domains) { DARABONBA_PTR_SET_RVALUE(domains_, domains) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRDDomainsResponseBodyDomains> domains_ = nullptr;
