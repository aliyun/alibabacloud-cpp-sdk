...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDCDNWAFRULESREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDCDNWAFRULESREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDcdnWafRulesRequest& obj) { 
      DARABONBA_PTR_TO_JSON(PageNumber, pageNumber_);
      DARABONBA_PTR_TO_JSON(PageSize, pageSize_);
      DARABONBA_PTR_TO_JSON(QueryArgs, queryArgs_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeDcdnWafRulesRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(PageNumber, pageNumber_);
      DARABONBA_PTR_FROM_JSON(PageSize, pageSize_);
      DARABONBA_PTR_FROM_JSON(QueryArgs, queryArgs_);
    };
    DescribeDcdnWafRulesRequest() = default ;
    DescribeDcdnWafRulesRequest(const DescribeDcdnWafRulesRequest &) = default ;
    DescribeDcdnWafRulesRequest(DescribeDcdnWafRulesRequest &&) = default ;
    DescribeDcdnWafRulesRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDcdnWafRulesRequest() = default ;
    DescribeDcdnWafRulesRequest& operator=(const DescribeDcdnWafRulesRequest &) = default ;
    DescribeDcdnWafRulesRequest& operator=(DescribeDcdnWafRulesRequest &&) = default ;
