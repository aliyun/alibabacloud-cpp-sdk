...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnIpaDomainConfigsResponseBody::DomainConfigs & getDomainConfigs() const { DARABONBA_PTR_GET_CONST(domainConfigs_, DescribeDcdnIpaDomainConfigsResponseBody::DomainConfigs) };
    inline DescribeDcdnIpaDomainConfigsResponseBody::DomainConfigs getDomainConfigs() { DARABONBA_PTR_GET(domainConfigs_, DescribeDcdnIpaDomainConfigsResponseBody::DomainConfigs) };
    inline DescribeDcdnIpaDomainConfigsResponseBody& setDomainConfigs(const DescribeDcdnIpaDomainConfigsResponseBody::DomainConfigs & domainConfigs) { DARABONBA_PTR_SET_VALUE(domainConfigs_, domainConfigs) };
    inline DescribeDcdnIpaDomainConfigsResponseBody& setDomainConfigs(DescribeDcdnIpaDomainConfigsResponseBody::DomainConfigs && domainConfigs) { DARABONBA_PTR_SET_RVALUE(domainConfigs_, domainConfigs) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnIpaDomainConfigsResponseBody::DomainConfigs> domainConfigs_ {};
