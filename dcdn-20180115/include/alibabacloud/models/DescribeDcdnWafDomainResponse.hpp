...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnWafDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnWafDomainResponseBody) };
    inline DescribeDcdnWafDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnWafDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnWafDomainResponseBody> body_ {};
  };
