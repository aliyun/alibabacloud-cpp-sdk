...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnWafPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnWafPolicyResponseBody) };
    inline DescribeDcdnWafPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnWafPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnWafPolicyResponseBody> body_ {};
  };
