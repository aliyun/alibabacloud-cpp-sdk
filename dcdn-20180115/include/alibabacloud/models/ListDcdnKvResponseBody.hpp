...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDcdnKvResponseBody::Keys> & getKeys() const { DARABONBA_PTR_GET_CONST(keys_, vector<ListDcdnKvResponseBody::Keys>) };
    inline vector<ListDcdnKvResponseBody::Keys> getKeys() { DARABONBA_PTR_GET(keys_, vector<ListDcdnKvResponseBody::Keys>) };
    inline ListDcdnKvResponseBody& setKeys(const vector<ListDcdnKvResponseBody::Keys> & keys) { DARABONBA_PTR_SET_VALUE(keys_, keys) };
    inline ListDcdnKvResponseBody& setKeys(vector<ListDcdnKvResponseBody::Keys> && keys) { DARABONBA_PTR_SET_RVALUE(keys_, keys) };
  ...
  protected:
    ...
    shared_ptr<vector<ListDcdnKvResponseBody::Keys>> keys_ {};
