...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDcdnSLSRealtimeLogDeliveryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateDcdnSLSRealtimeLogDeliveryResponseBody) };
    inline UpdateDcdnSLSRealtimeLogDeliveryResponseBody body() { DARABONBA_PTR_GET(body_, UpdateDcdnSLSRealtimeLogDeliveryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateDcdnSLSRealtimeLogDeliveryResponseBody> body_ = nullptr;
  };
