...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainWebsocketBpsDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainWebsocketBpsDataResponseBody) };
    inline DescribeDcdnDomainWebsocketBpsDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainWebsocketBpsDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnDomainWebsocketBpsDataResponseBody> body_ {};
  };
