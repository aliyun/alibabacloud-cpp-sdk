...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnWafDefaultRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnWafDefaultRulesResponseBody) };
    inline DescribeDcdnWafDefaultRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnWafDefaultRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnWafDefaultRulesResponseBody> body_ {};
  };
