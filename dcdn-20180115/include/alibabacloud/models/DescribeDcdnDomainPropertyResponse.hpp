...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnDomainPropertyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnDomainPropertyResponseBody) };
    inline DescribeDcdnDomainPropertyResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnDomainPropertyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnDomainPropertyResponseBody> body_ {};
  };
