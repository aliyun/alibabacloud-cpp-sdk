...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDcdnCertificateSigningRequestResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDcdnCertificateSigningRequestResponseBody) };
    inline CreateDcdnCertificateSigningRequestResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDcdnCertificateSigningRequestResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDcdnCertificateSigningRequestResponseBody> body_ {};
  };
