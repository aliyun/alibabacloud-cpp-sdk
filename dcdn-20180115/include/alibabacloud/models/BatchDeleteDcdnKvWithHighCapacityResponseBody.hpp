...
#ifndef ALIBABACLOUD_MODELS_BATCHDELETEDCDNKVWITHHIGHCAPACITYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_BATCHDELETEDCDNKVWITHHIGHCAPACITYRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const BatchDeleteDcdnKvWithHighCapacityResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(FailKeys, failKeys_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(SuccessKeys, successKeys_);
    };
    friend void from_json(const Darabonba::Json& j, BatchDeleteDcdnKvWithHighCapacityResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(FailKeys, failKeys_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(SuccessKeys, successKeys_);
    };
    BatchDeleteDcdnKvWithHighCapacityResponseBody() = default ;
    BatchDeleteDcdnKvWithHighCapacityResponseBody(const BatchDeleteDcdnKvWithHighCapacityResponseBody &) = default ;
    BatchDeleteDcdnKvWithHighCapacityResponseBody(BatchDeleteDcdnKvWithHighCapacityResponseBody &&) = default ;
    BatchDeleteDcdnKvWithHighCapacityResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BatchDeleteDcdnKvWithHighCapacityResponseBody() = default ;
    BatchDeleteDcdnKvWithHighCapacityResponseBody& operator=(const BatchDeleteDcdnKvWithHighCapacityResponseBody &) = default ;
    BatchDeleteDcdnKvWithHighCapacityResponseBody& operator=(BatchDeleteDcdnKvWithHighCapacityResponseBody &&) = default ;
