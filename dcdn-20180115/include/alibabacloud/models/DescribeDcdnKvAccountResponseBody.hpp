...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDcdnKvAccountResponseBody::NamespaceList> & getNamespaceList() const { DARABONBA_PTR_GET_CONST(namespaceList_, vector<DescribeDcdnKvAccountResponseBody::NamespaceList>) };
    inline vector<DescribeDcdnKvAccountResponseBody::NamespaceList> getNamespaceList() { DARABONBA_PTR_GET(namespaceList_, vector<DescribeDcdnKvAccountResponseBody::NamespaceList>) };
    inline DescribeDcdnKvAccountResponseBody& setNamespaceList(const vector<DescribeDcdnKvAccountResponseBody::NamespaceList> & namespaceList) { DARABONBA_PTR_SET_VALUE(namespaceList_, namespaceList) };
    inline DescribeDcdnKvAccountResponseBody& setNamespaceList(vector<DescribeDcdnKvAccountResponseBody::NamespaceList> && namespaceList) { DARABONBA_PTR_SET_RVALUE(namespaceList_, namespaceList) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeDcdnKvAccountResponseBody::NamespaceList>> namespaceList_ {};
