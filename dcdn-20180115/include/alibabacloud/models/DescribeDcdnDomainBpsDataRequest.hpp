...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDCDNDOMAINBPSDATAREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDCDNDOMAINBPSDATAREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDcdnDomainBpsDataRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDcdnDomainBpsDataRequest& obj) { 
    ...
    DescribeDcdnDomainBpsDataRequest() = default ;
    DescribeDcdnDomainBpsDataRequest(const DescribeDcdnDomainBpsDataRequest &) = default ;
    DescribeDcdnDomainBpsDataRequest(DescribeDcdnDomainBpsDataRequest &&) = default ;
    DescribeDcdnDomainBpsDataRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDcdnDomainBpsDataRequest() = default ;
    DescribeDcdnDomainBpsDataRequest& operator=(const DescribeDcdnDomainBpsDataRequest &) = default ;
    DescribeDcdnDomainBpsDataRequest& operator=(DescribeDcdnDomainBpsDataRequest &&) = default ;
    ...
    inline DescribeDcdnDomainBpsDataRequest& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };
    ...
    inline DescribeDcdnDomainBpsDataRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline DescribeDcdnDomainBpsDataRequest& setInterval(string interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline DescribeDcdnDomainBpsDataRequest& setIspNameEn(string ispNameEn) { DARABONBA_PTR_SET_VALUE(ispNameEn_, ispNameEn) };
    ...
    inline DescribeDcdnDomainBpsDataRequest& setLocationNameEn(string locationNameEn) { DARABONBA_PTR_SET_VALUE(locationNameEn_, locationNameEn) };
    ...
    inline DescribeDcdnDomainBpsDataRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
