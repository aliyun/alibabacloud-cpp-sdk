...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnBlockedRegionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnBlockedRegionsResponseBody) };
    inline DescribeDcdnBlockedRegionsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnBlockedRegionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnBlockedRegionsResponseBody> body_ {};
  };
