...
namespace Models
{
  ...
  public:
    ...
    inline const StartDcdnIpaDomainResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, StartDcdnIpaDomainResponseBody) };
    inline StartDcdnIpaDomainResponseBody body() { DARABONBA_PTR_GET(body_, StartDcdnIpaDomainResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<StartDcdnIpaDomainResponseBody> body_ = nullptr;
  };
