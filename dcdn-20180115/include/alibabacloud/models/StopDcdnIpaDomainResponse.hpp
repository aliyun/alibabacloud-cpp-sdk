...
namespace Models
{
  ...
  public:
    ...
    inline const StopDcdnIpaDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopDcdnIpaDomainResponseBody) };
    inline StopDcdnIpaDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, StopDcdnIpaDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopDcdnIpaDomainResponseBody> body_ {};
  };
