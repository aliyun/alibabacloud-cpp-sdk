...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDcdnUserTagsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDcdnUserTagsResponseBody) };
    inline DescribeDcdnUserTagsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDcdnUserTagsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDcdnUserTagsResponseBody> body_ {};
  };
