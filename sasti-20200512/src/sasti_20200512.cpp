...
GetGraphQueryTemplatesResponse Alibabacloud_Sasti20200512::Client::getGraphQueryTemplatesWithOptions(shared_ptr<GetGraphQueryTemplatesRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> body = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->env)) {
    body->insert(pair<string, string>("Env", *request->env));
  }
  if (!Darabonba_Util::Client::isUnset<string>(request->serviceUnit)) {
    body->insert(pair<string, string>("ServiceUnit", *request->serviceUnit));
  }
  shared_ptr<Alibabacloud_OpenApi::OpenApiRequest> req = make_shared<Alibabacloud_OpenApi::OpenApiRequest>(map<string, boost::any>({
    {"body", boost::any(Alibabacloud_OpenApiUtil::Client::parseToMap(body))}
  }));
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("GetGraphQueryTemplates"))},
    {"version", boost::any(string("2020-05-12"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return GetGraphQueryTemplatesResponse(callApi(params, req, runtime));
}

GetGraphQueryTemplatesResponse Alibabacloud_Sasti20200512::Client::getGraphQueryTemplates(shared_ptr<GetGraphQueryTemplatesRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
