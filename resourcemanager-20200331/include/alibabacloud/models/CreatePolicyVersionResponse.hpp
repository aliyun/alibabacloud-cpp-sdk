...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePolicyVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePolicyVersionResponseBody) };
    inline CreatePolicyVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePolicyVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePolicyVersionResponseBody> body_ {};
  };
