  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->arn_ == nullptr
        ...
        && this->roleName_ == nullptr && this->rolePrincipalName_ == nullptr && this->updateDate_ == nullptr; };
      // arn Field Functions 
    ...
    inline const UpdateRoleResponseBody::Role & getRole() const { DARABONBA_PTR_GET_CONST(role_, UpdateRoleResponseBody::Role) };
    inline UpdateRoleResponseBody::Role getRole() { DARABONBA_PTR_GET(role_, UpdateRoleResponseBody::Role) };
    inline UpdateRoleResponseBody& setRole(const UpdateRoleResponseBody::Role & role) { DARABONBA_PTR_SET_VALUE(role_, role) };
    inline UpdateRoleResponseBody& setRole(UpdateRoleResponseBody::Role && role) { DARABONBA_PTR_SET_RVALUE(role_, role) };
