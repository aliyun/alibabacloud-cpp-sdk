...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceGroupCapabilityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListResourceGroupCapabilityResponseBody) };
    inline ListResourceGroupCapabilityResponseBody getBody() { DARABONBA_PTR_GET(body_, ListResourceGroupCapabilityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListResourceGroupCapabilityResponseBody> body_ {};
  };
