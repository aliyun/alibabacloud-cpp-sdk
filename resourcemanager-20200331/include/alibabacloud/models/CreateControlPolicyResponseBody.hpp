...
namespace Models
{
  ...
  public:
    ...
    inline const CreateControlPolicyResponseBodyControlPolicy & controlPolicy() const { DARABONBA_PTR_GET_CONST(controlPolicy_, CreateControlPolicyResponseBodyControlPolicy) };
    inline CreateControlPolicyResponseBodyControlPolicy controlPolicy() { DARABONBA_PTR_GET(controlPolicy_, CreateControlPolicyResponseBodyControlPolicy) };
    inline CreateControlPolicyResponseBody& setControlPolicy(const CreateControlPolicyResponseBodyControlPolicy & controlPolicy) { DARABONBA_PTR_SET_VALUE(controlPolicy_, controlPolicy) };
    inline CreateControlPolicyResponseBody& setControlPolicy(CreateControlPolicyResponseBodyControlPolicy && controlPolicy) { DARABONBA_PTR_SET_RVALUE(controlPolicy_, controlPolicy) };
  ...
  protected:
    ...
    std::shared_ptr<CreateControlPolicyResponseBodyControlPolicy> controlPolicy_ = nullptr;
