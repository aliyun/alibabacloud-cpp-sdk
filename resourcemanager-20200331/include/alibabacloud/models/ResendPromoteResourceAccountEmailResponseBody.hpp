...
namespace Models
{
  ...
  public:
    ...
    inline const ResendPromoteResourceAccountEmailResponseBody::Account & getAccount() const { DARABONBA_PTR_GET_CONST(account_, ResendPromoteResourceAccountEmailResponseBody::Account) };
    inline ResendPromoteResourceAccountEmailResponseBody::Account getAccount() { DARABONBA_PTR_GET(account_, ResendPromoteResourceAccountEmailResponseBody::Account) };
    inline ResendPromoteResourceAccountEmailResponseBody& setAccount(const ResendPromoteResourceAccountEmailResponseBody::Account & account) { DARABONBA_PTR_SET_VALUE(account_, account) };
    inline ResendPromoteResourceAccountEmailResponseBody& setAccount(ResendPromoteResourceAccountEmailResponseBody::Account && account) { DARABONBA_PTR_SET_RVALUE(account_, account) };
  ...
  protected:
    ...
    shared_ptr<ResendPromoteResourceAccountEmailResponseBody::Account> account_ {};
