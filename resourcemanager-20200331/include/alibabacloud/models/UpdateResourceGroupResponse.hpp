...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateResourceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateResourceGroupResponseBody) };
    inline UpdateResourceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateResourceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateResourceGroupResponseBody> body_ {};
  };
