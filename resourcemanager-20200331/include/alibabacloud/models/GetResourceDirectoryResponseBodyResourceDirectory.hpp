...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->controlPolicyStatus_ == nullptr
        && return this->createTime_ == nullptr && return this->identityInformation_ == nullptr && return this->masterAccountId_ == nullptr && return this->masterAccountName_ == nullptr && return this->memberDeletionStatus_ == nullptr
        && return this->resourceDirectoryId_ == nullptr && return this->rootFolderId_ == nullptr; };
