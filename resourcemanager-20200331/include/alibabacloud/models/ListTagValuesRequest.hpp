...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && return this->nextToken_ == nullptr && return this->resourceType_ == nullptr && return this->tagKey_ == nullptr && return this->valueFilter_ == nullptr; };
    ...
    inline string valueFilter() const { DARABONBA_PTR_GET_DEFAULT(valueFilter_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> valueFilter_ = nullptr;
  };
