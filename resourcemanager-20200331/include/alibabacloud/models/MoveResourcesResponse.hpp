...
namespace Models
{
  ...
  public:
    ...
    inline const MoveResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MoveResourcesResponseBody) };
    inline MoveResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, MoveResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MoveResourcesResponseBody> body_ {};
  };
