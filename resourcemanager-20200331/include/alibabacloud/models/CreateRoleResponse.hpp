...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRoleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRoleResponseBody) };
    inline CreateRoleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRoleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRoleResponseBody> body_ {};
  };
