...
namespace Models
{
  ...
  public:
    ...
    inline const DetachPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachPolicyResponseBody) };
    inline DetachPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachPolicyResponseBody> body_ {};
  };
