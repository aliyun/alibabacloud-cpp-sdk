...
#ifndef ALIBABACLOUD_MODELS_RESENDCREATECLOUDACCOUNTEMAILRESPONSEBODYACCOUNT_HPP_
#define ALIBABACLOUD_MODELS_RESENDCREATECLOUDACCOUNTEMAILRESPONSEBODYACCOUNT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ResendCreateCloudAccountEmailResponseBodyAccount& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ResendCreateCloudAccountEmailResponseBodyAccount& obj) { 
    ...
    ResendCreateCloudAccountEmailResponseBodyAccount() = default ;
    ResendCreateCloudAccountEmailResponseBodyAccount(const ResendCreateCloudAccountEmailResponseBodyAccount &) = default ;
    ResendCreateCloudAccountEmailResponseBodyAccount(ResendCreateCloudAccountEmailResponseBodyAccount &&) = default ;
    ResendCreateCloudAccountEmailResponseBodyAccount(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ResendCreateCloudAccountEmailResponseBodyAccount() = default ;
    ResendCreateCloudAccountEmailResponseBodyAccount& operator=(const ResendCreateCloudAccountEmailResponseBodyAccount &) = default ;
    ResendCreateCloudAccountEmailResponseBodyAccount& operator=(ResendCreateCloudAccountEmailResponseBodyAccount &&) = default ;
    ...
    inline ResendCreateCloudAccountEmailResponseBodyAccount& setAccountId(string accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline ResendCreateCloudAccountEmailResponseBodyAccount& setAccountName(string accountName) { DARABONBA_PTR_SET_VALUE(accountName_, accountName) };
    ...
    inline ResendCreateCloudAccountEmailResponseBodyAccount& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline ResendCreateCloudAccountEmailResponseBodyAccount& setFolderId(string folderId) { DARABONBA_PTR_SET_VALUE(folderId_, folderId) };
    ...
    inline ResendCreateCloudAccountEmailResponseBodyAccount& setJoinMethod(string joinMethod) { DARABONBA_PTR_SET_VALUE(joinMethod_, joinMethod) };
    ...
    inline ResendCreateCloudAccountEmailResponseBodyAccount& setJoinTime(string joinTime) { DARABONBA_PTR_SET_VALUE(joinTime_, joinTime) };
    ...
    inline ResendCreateCloudAccountEmailResponseBodyAccount& setModifyTime(string modifyTime) { DARABONBA_PTR_SET_VALUE(modifyTime_, modifyTime) };
    ...
    inline ResendCreateCloudAccountEmailResponseBodyAccount& setRecordId(string recordId) { DARABONBA_PTR_SET_VALUE(recordId_, recordId) };
    ...
    inline ResendCreateCloudAccountEmailResponseBodyAccount& setResourceDirectoryId(string resourceDirectoryId) { DARABONBA_PTR_SET_VALUE(resourceDirectoryId_, resourceDirectoryId) };
    ...
    inline ResendCreateCloudAccountEmailResponseBodyAccount& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ResendCreateCloudAccountEmailResponseBodyAccount& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
