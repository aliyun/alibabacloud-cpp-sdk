...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->keyFilter_ == nullptr
    ...
    inline string getKeyFilter() const { DARABONBA_PTR_GET_DEFAULT(keyFilter_, "") };
