...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourcesResponseBodyResources & resources() const { DARABONBA_PTR_GET_CONST(resources_, ListResourcesResponseBodyResources) };
    inline ListResourcesResponseBodyResources resources() { DARABONBA_PTR_GET(resources_, ListResourcesResponseBodyResources) };
    inline ListResourcesResponseBody& setResources(const ListResourcesResponseBodyResources & resources) { DARABONBA_PTR_SET_VALUE(resources_, resources) };
    inline ListResourcesResponseBody& setResources(ListResourcesResponseBodyResources && resources) { DARABONBA_PTR_SET_RVALUE(resources_, resources) };
  ...
  protected:
    ...
    std::shared_ptr<ListResourcesResponseBodyResources> resources_ = nullptr;
