...
namespace Models
{
  ...
  public:
    ...
    inline const SetMemberDeletionPermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetMemberDeletionPermissionResponseBody) };
    inline SetMemberDeletionPermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, SetMemberDeletionPermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetMemberDeletionPermissionResponseBody> body_ {};
  };
