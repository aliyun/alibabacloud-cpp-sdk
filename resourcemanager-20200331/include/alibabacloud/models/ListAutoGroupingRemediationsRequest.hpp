...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->earliestRemediationTime_ == nullptr
        && this->latestRemediationTime_ == nullptr && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->resourceId_ == nullptr && this->resourceType_ == nullptr
        && this->ruleId_ == nullptr && this->service_ == nullptr && this->targetResourceGroupId_ == nullptr; };
    ...
    inline string getEarliestRemediationTime() const { DARABONBA_PTR_GET_DEFAULT(earliestRemediationTime_, "") };
    ...
    inline string getLatestRemediationTime() const { DARABONBA_PTR_GET_DEFAULT(latestRemediationTime_, "") };
  ...
  protected:
    ...
    shared_ptr<string> earliestRemediationTime_ {};
    // The latest remediation time. This parameter is empty by default.
    shared_ptr<string> latestRemediationTime_ {};
