...
namespace Models
{
  ...
  public:
    ...
    inline const DisableAssociatedTransferResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableAssociatedTransferResponseBody) };
    inline DisableAssociatedTransferResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableAssociatedTransferResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableAssociatedTransferResponseBody> body_ {};
  };
