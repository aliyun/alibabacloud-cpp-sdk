...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAutoGroupingRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAutoGroupingRuleResponseBody) };
    inline UpdateAutoGroupingRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAutoGroupingRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAutoGroupingRuleResponseBody> body_ {};
  };
