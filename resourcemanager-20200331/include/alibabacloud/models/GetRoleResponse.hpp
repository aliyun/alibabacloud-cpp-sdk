...
namespace Models
{
  ...
  public:
    ...
    inline const GetRoleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRoleResponseBody) };
    inline GetRoleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRoleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRoleResponseBody> body_ {};
  };
