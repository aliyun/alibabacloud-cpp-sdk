...
namespace Models
{
  ...
  public:
    ...
    inline const ListHandshakesForAccountResponseBody::Handshakes & getHandshakes() const { DARABONBA_PTR_GET_CONST(handshakes_, ListHandshakesForAccountResponseBody::Handshakes) };
    inline ListHandshakesForAccountResponseBody::Handshakes getHandshakes() { DARABONBA_PTR_GET(handshakes_, ListHandshakesForAccountResponseBody::Handshakes) };
    inline ListHandshakesForAccountResponseBody& setHandshakes(const ListHandshakesForAccountResponseBody::Handshakes & handshakes) { DARABONBA_PTR_SET_VALUE(handshakes_, handshakes) };
    inline ListHandshakesForAccountResponseBody& setHandshakes(ListHandshakesForAccountResponseBody::Handshakes && handshakes) { DARABONBA_PTR_SET_RVALUE(handshakes_, handshakes) };
  ...
  protected:
    shared_ptr<ListHandshakesForAccountResponseBody::Handshakes> handshakes_ {};
