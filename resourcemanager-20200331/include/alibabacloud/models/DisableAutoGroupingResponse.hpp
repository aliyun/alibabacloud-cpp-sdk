...
namespace Models
{
  ...
  public:
    ...
    inline const DisableAutoGroupingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableAutoGroupingResponseBody) };
    inline DisableAutoGroupingResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableAutoGroupingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableAutoGroupingResponseBody> body_ {};
  };
