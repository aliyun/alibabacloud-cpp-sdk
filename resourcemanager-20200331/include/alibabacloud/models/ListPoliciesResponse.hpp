...
namespace Models
{
  ...
  public:
    ...
    inline const ListPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPoliciesResponseBody) };
    inline ListPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPoliciesResponseBody> body_ {};
  };
