...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccountResponseBodyAccount & account() const { DARABONBA_PTR_GET_CONST(account_, GetAccountResponseBodyAccount) };
    inline GetAccountResponseBodyAccount account() { DARABONBA_PTR_GET(account_, GetAccountResponseBodyAccount) };
    inline GetAccountResponseBody& setAccount(const GetAccountResponseBodyAccount & account) { DARABONBA_PTR_SET_VALUE(account_, account) };
    inline GetAccountResponseBody& setAccount(GetAccountResponseBodyAccount && account) { DARABONBA_PTR_SET_RVALUE(account_, account) };
  ...
  protected:
    ...
    std::shared_ptr<GetAccountResponseBodyAccount> account_ = nullptr;
