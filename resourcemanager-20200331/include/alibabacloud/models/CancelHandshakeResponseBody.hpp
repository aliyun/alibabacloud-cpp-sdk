...
namespace Models
{
  ...
  public:
    ...
    inline const CancelHandshakeResponseBody::Handshake & getHandshake() const { DARABONBA_PTR_GET_CONST(handshake_, CancelHandshakeResponseBody::Handshake) };
    inline CancelHandshakeResponseBody::Handshake getHandshake() { DARABONBA_PTR_GET(handshake_, CancelHandshakeResponseBody::Handshake) };
    inline CancelHandshakeResponseBody& setHandshake(const CancelHandshakeResponseBody::Handshake & handshake) { DARABONBA_PTR_SET_VALUE(handshake_, handshake) };
    inline CancelHandshakeResponseBody& setHandshake(CancelHandshakeResponseBody::Handshake && handshake) { DARABONBA_PTR_SET_RVALUE(handshake_, handshake) };
  ...
  protected:
    ...
    shared_ptr<CancelHandshakeResponseBody::Handshake> handshake_ {};
