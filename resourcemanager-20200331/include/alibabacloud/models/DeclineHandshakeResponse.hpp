...
namespace Models
{
  ...
  public:
    ...
    inline const DeclineHandshakeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeclineHandshakeResponseBody) };
    inline DeclineHandshakeResponseBody body() { DARABONBA_PTR_GET(body_, DeclineHandshakeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeclineHandshakeResponseBody> body_ = nullptr;
  };
