  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->controlPolicyStatus_ == nullptr
        && this->createTime_ == nullptr && this->identityInformation_ == nullptr && this->masterAccountId_ == nullptr && this->masterAccountName_ == nullptr && this->memberDeletionStatus_ == nullptr
        && this->resourceDirectoryId_ == nullptr && this->rootFolderId_ == nullptr; };
