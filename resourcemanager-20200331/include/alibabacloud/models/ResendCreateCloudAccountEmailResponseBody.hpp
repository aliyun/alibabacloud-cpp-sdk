...
#ifndef ALIBABACLOUD_MODELS_RESENDCREATECLOUDACCOUNTEMAILRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_RESENDCREATECLOUDACCOUNTEMAILRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ResendCreateCloudAccountEmailResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Account, account_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ResendCreateCloudAccountEmailResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Account, account_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ResendCreateCloudAccountEmailResponseBody() = default ;
    ResendCreateCloudAccountEmailResponseBody(const ResendCreateCloudAccountEmailResponseBody &) = default ;
    ResendCreateCloudAccountEmailResponseBody(ResendCreateCloudAccountEmailResponseBody &&) = default ;
    ResendCreateCloudAccountEmailResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ResendCreateCloudAccountEmailResponseBody() = default ;
    ResendCreateCloudAccountEmailResponseBody& operator=(const ResendCreateCloudAccountEmailResponseBody &) = default ;
    ResendCreateCloudAccountEmailResponseBody& operator=(ResendCreateCloudAccountEmailResponseBody &&) = default ;
    ...
    inline const ResendCreateCloudAccountEmailResponseBody::Account & getAccount() const { DARABONBA_PTR_GET_CONST(account_, ResendCreateCloudAccountEmailResponseBody::Account) };
    inline ResendCreateCloudAccountEmailResponseBody::Account getAccount() { DARABONBA_PTR_GET(account_, ResendCreateCloudAccountEmailResponseBody::Account) };
    inline ResendCreateCloudAccountEmailResponseBody& setAccount(const ResendCreateCloudAccountEmailResponseBody::Account & account) { DARABONBA_PTR_SET_VALUE(account_, account) };
    inline ResendCreateCloudAccountEmailResponseBody& setAccount(ResendCreateCloudAccountEmailResponseBody::Account && account) { DARABONBA_PTR_SET_RVALUE(account_, account) };
    ...
    inline ResendCreateCloudAccountEmailResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The information of the member account.
    shared_ptr<ResendCreateCloudAccountEmailResponseBody::Account> account_ {};
