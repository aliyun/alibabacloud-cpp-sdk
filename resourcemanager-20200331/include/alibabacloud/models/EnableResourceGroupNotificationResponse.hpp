...
namespace Models
{
  ...
  public:
    ...
    inline const EnableResourceGroupNotificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableResourceGroupNotificationResponseBody) };
    inline EnableResourceGroupNotificationResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableResourceGroupNotificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableResourceGroupNotificationResponseBody> body_ {};
  };
