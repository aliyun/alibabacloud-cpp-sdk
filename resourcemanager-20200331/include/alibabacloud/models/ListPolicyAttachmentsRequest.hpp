...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->language_ == nullptr
        && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->policyName_ == nullptr && this->policyType_ == nullptr && this->principalName_ == nullptr
        && this->principalType_ == nullptr && this->resourceGroupId_ == nullptr; };
