...
namespace Models
{
  ...
  public:
    ...
    inline const InitResourceDirectoryResponseBody::ResourceDirectory & getResourceDirectory() const { DARABONBA_PTR_GET_CONST(resourceDirectory_, InitResourceDirectoryResponseBody::ResourceDirectory) };
    inline InitResourceDirectoryResponseBody::ResourceDirectory getResourceDirectory() { DARABONBA_PTR_GET(resourceDirectory_, InitResourceDirectoryResponseBody::ResourceDirectory) };
    inline InitResourceDirectoryResponseBody& setResourceDirectory(const InitResourceDirectoryResponseBody::ResourceDirectory & resourceDirectory) { DARABONBA_PTR_SET_VALUE(resourceDirectory_, resourceDirectory) };
    inline InitResourceDirectoryResponseBody& setResourceDirectory(InitResourceDirectoryResponseBody::ResourceDirectory && resourceDirectory) { DARABONBA_PTR_SET_RVALUE(resourceDirectory_, resourceDirectory) };
  ...
  protected:
    ...
    shared_ptr<InitResourceDirectoryResponseBody::ResourceDirectory> resourceDirectory_ {};
  };
