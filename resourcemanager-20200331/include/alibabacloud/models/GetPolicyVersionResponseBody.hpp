...
namespace Models
{
  ...
  public:
    ...
    inline const GetPolicyVersionResponseBodyPolicyVersion & policyVersion() const { DARABONBA_PTR_GET_CONST(policyVersion_, GetPolicyVersionResponseBodyPolicyVersion) };
    inline GetPolicyVersionResponseBodyPolicyVersion policyVersion() { DARABONBA_PTR_GET(policyVersion_, GetPolicyVersionResponseBodyPolicyVersion) };
    inline GetPolicyVersionResponseBody& setPolicyVersion(const GetPolicyVersionResponseBodyPolicyVersion & policyVersion) { DARABONBA_PTR_SET_VALUE(policyVersion_, policyVersion) };
    inline GetPolicyVersionResponseBody& setPolicyVersion(GetPolicyVersionResponseBodyPolicyVersion && policyVersion) { DARABONBA_PTR_SET_RVALUE(policyVersion_, policyVersion) };
  ...
  protected:
    ...
    std::shared_ptr<GetPolicyVersionResponseBodyPolicyVersion> policyVersion_ = nullptr;
    // The request ID.
