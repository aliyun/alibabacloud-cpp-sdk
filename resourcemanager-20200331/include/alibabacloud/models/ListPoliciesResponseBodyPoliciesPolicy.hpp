...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attachmentCount_ == nullptr
        && return this->createDate_ == nullptr && return this->defaultVersion_ == nullptr && return this->description_ == nullptr && return this->policyName_ == nullptr && return this->policyType_ == nullptr
    ...
    inline ListPoliciesResponseBodyPoliciesPolicy& setAttachmentCount(int32_t attachmentCount) { DARABONBA_PTR_SET_VALUE(attachmentCount_, attachmentCount) };
    ...
    inline ListPoliciesResponseBodyPoliciesPolicy& setCreateDate(string createDate) { DARABONBA_PTR_SET_VALUE(createDate_, createDate) };
    ...
    inline ListPoliciesResponseBodyPoliciesPolicy& setDefaultVersion(string defaultVersion) { DARABONBA_PTR_SET_VALUE(defaultVersion_, defaultVersion) };
    ...
    inline ListPoliciesResponseBodyPoliciesPolicy& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListPoliciesResponseBodyPoliciesPolicy& setPolicyName(string policyName) { DARABONBA_PTR_SET_VALUE(policyName_, policyName) };
    ...
    inline ListPoliciesResponseBodyPoliciesPolicy& setPolicyType(string policyType) { DARABONBA_PTR_SET_VALUE(policyType_, policyType) };
    ...
    inline ListPoliciesResponseBodyPoliciesPolicy& setUpdateDate(string updateDate) { DARABONBA_PTR_SET_VALUE(updateDate_, updateDate) };
