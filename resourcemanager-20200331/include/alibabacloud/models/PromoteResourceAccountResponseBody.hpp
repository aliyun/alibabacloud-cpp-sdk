...
namespace Models
{
  ...
  public:
    ...
    inline const PromoteResourceAccountResponseBodyAccount & account() const { DARABONBA_PTR_GET_CONST(account_, PromoteResourceAccountResponseBodyAccount) };
    inline PromoteResourceAccountResponseBodyAccount account() { DARABONBA_PTR_GET(account_, PromoteResourceAccountResponseBodyAccount) };
    inline PromoteResourceAccountResponseBody& setAccount(const PromoteResourceAccountResponseBodyAccount & account) { DARABONBA_PTR_SET_VALUE(account_, account) };
    inline PromoteResourceAccountResponseBody& setAccount(PromoteResourceAccountResponseBodyAccount && account) { DARABONBA_PTR_SET_RVALUE(account_, account) };
  ...
  protected:
    ...
    std::shared_ptr<PromoteResourceAccountResponseBodyAccount> account_ = nullptr;
