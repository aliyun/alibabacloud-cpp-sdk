...
namespace Models
{
  ...
  public:
    ...
    inline const MoveAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MoveAccountResponseBody) };
    inline MoveAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, MoveAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MoveAccountResponseBody> body_ {};
  };
