...
namespace Models
{
  ...
  public:
    ...
    inline const ListAutoGroupingRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAutoGroupingRulesResponseBody) };
    inline ListAutoGroupingRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAutoGroupingRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAutoGroupingRulesResponseBody> body_ {};
  };
