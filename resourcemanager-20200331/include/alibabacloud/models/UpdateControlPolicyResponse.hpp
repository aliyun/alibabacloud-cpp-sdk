...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateControlPolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateControlPolicyResponseBody) };
    inline UpdateControlPolicyResponseBody body() { DARABONBA_PTR_GET(body_, UpdateControlPolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateControlPolicyResponseBody> body_ = nullptr;
  };
