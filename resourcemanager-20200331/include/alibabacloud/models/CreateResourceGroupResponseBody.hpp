...
namespace Models
{
  ...
  public:
    ...
    inline const CreateResourceGroupResponseBody::ResourceGroup & getResourceGroup() const { DARABONBA_PTR_GET_CONST(resourceGroup_, CreateResourceGroupResponseBody::ResourceGroup) };
    inline CreateResourceGroupResponseBody::ResourceGroup getResourceGroup() { DARABONBA_PTR_GET(resourceGroup_, CreateResourceGroupResponseBody::ResourceGroup) };
    inline CreateResourceGroupResponseBody& setResourceGroup(const CreateResourceGroupResponseBody::ResourceGroup & resourceGroup) { DARABONBA_PTR_SET_VALUE(resourceGroup_, resourceGroup) };
    inline CreateResourceGroupResponseBody& setResourceGroup(CreateResourceGroupResponseBody::ResourceGroup && resourceGroup) { DARABONBA_PTR_SET_RVALUE(resourceGroup_, resourceGroup) };
  ...
  protected:
    ...
    shared_ptr<CreateResourceGroupResponseBody::ResourceGroup> resourceGroup_ {};
  };
