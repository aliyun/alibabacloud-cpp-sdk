...
namespace Models
{
  ...
  public:
    ...
    inline const ListDelegatedAdministratorsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDelegatedAdministratorsResponseBody) };
    inline ListDelegatedAdministratorsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDelegatedAdministratorsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDelegatedAdministratorsResponseBody> body_ {};
  };
