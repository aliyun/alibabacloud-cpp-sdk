...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccountDeletionCheckResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAccountDeletionCheckResultResponseBody) };
    inline GetAccountDeletionCheckResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAccountDeletionCheckResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAccountDeletionCheckResultResponseBody> body_ {};
  };
