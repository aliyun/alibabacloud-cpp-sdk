...
namespace Models
{
  ...
  public:
    ...
    inline const GetServiceLinkedRoleDeletionStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetServiceLinkedRoleDeletionStatusResponseBody) };
    inline GetServiceLinkedRoleDeletionStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetServiceLinkedRoleDeletionStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetServiceLinkedRoleDeletionStatusResponseBody> body_ {};
  };
