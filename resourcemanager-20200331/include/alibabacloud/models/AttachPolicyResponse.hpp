...
namespace Models
{
  ...
  public:
    ...
    inline const AttachPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachPolicyResponseBody) };
    inline AttachPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachPolicyResponseBody> body_ {};
  };
