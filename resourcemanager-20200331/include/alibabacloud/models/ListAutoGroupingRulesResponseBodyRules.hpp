...
#ifndef ALIBABACLOUD_MODELS_LISTAUTOGROUPINGRULESRESPONSEBODYRULES_HPP_
#define ALIBABACLOUD_MODELS_LISTAUTOGROUPINGRULESRESPONSEBODYRULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAutoGroupingRulesResponseBodyRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAutoGroupingRulesResponseBodyRules& obj) { 
    ...
    ListAutoGroupingRulesResponseBodyRules() = default ;
    ListAutoGroupingRulesResponseBodyRules(const ListAutoGroupingRulesResponseBodyRules &) = default ;
    ListAutoGroupingRulesResponseBodyRules(ListAutoGroupingRulesResponseBodyRules &&) = default ;
    ListAutoGroupingRulesResponseBodyRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAutoGroupingRulesResponseBodyRules() = default ;
    ListAutoGroupingRulesResponseBodyRules& operator=(const ListAutoGroupingRulesResponseBodyRules &) = default ;
    ListAutoGroupingRulesResponseBodyRules& operator=(ListAutoGroupingRulesResponseBodyRules &&) = default ;
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setExcludeRegionIdsScope(string excludeRegionIdsScope) { DARABONBA_PTR_SET_VALUE(excludeRegionIdsScope_, excludeRegionIdsScope) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setExcludeResourceGroupIdsScope(string excludeResourceGroupIdsScope) { DARABONBA_PTR_SET_VALUE(excludeResourceGroupIdsScope_, excludeResourceGroupIdsScope) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setExcludeResourceIdsScope(string excludeResourceIdsScope) { DARABONBA_PTR_SET_VALUE(excludeResourceIdsScope_, excludeResourceIdsScope) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setExcludeResourceTypesScope(string excludeResourceTypesScope) { DARABONBA_PTR_SET_VALUE(excludeResourceTypesScope_, excludeResourceTypesScope) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setModifyTime(string modifyTime) { DARABONBA_PTR_SET_VALUE(modifyTime_, modifyTime) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setRegionIdsScope(string regionIdsScope) { DARABONBA_PTR_SET_VALUE(regionIdsScope_, regionIdsScope) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setResourceGroupIdsScope(string resourceGroupIdsScope) { DARABONBA_PTR_SET_VALUE(resourceGroupIdsScope_, resourceGroupIdsScope) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setResourceIdsScope(string resourceIdsScope) { DARABONBA_PTR_SET_VALUE(resourceIdsScope_, resourceIdsScope) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setResourceTypesScope(string resourceTypesScope) { DARABONBA_PTR_SET_VALUE(resourceTypesScope_, resourceTypesScope) };
    ...
    inline const vector<Models::ListAutoGroupingRulesResponseBodyRulesRuleContents> & ruleContents() const { DARABONBA_PTR_GET_CONST(ruleContents_, vector<Models::ListAutoGroupingRulesResponseBodyRulesRuleContents>) };
    inline vector<Models::ListAutoGroupingRulesResponseBodyRulesRuleContents> ruleContents() { DARABONBA_PTR_GET(ruleContents_, vector<Models::ListAutoGroupingRulesResponseBodyRulesRuleContents>) };
    inline ListAutoGroupingRulesResponseBodyRules& setRuleContents(const vector<Models::ListAutoGroupingRulesResponseBodyRulesRuleContents> & ruleContents) { DARABONBA_PTR_SET_VALUE(ruleContents_, ruleContents) };
    inline ListAutoGroupingRulesResponseBodyRules& setRuleContents(vector<Models::ListAutoGroupingRulesResponseBodyRulesRuleContents> && ruleContents) { DARABONBA_PTR_SET_RVALUE(ruleContents_, ruleContents) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setRuleDesc(string ruleDesc) { DARABONBA_PTR_SET_VALUE(ruleDesc_, ruleDesc) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setRuleId(string ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline ListAutoGroupingRulesResponseBodyRules& setRuleType(string ruleType) { DARABONBA_PTR_SET_VALUE(ruleType_, ruleType) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::ListAutoGroupingRulesResponseBodyRulesRuleContents>> ruleContents_ = nullptr;
