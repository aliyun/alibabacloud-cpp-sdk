...
namespace Models
{
  ...
  public:
    ...
    inline const GetJobStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetJobStatusResponseBody) };
    inline GetJobStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetJobStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetJobStatusResponseBody> body_ {};
  };
