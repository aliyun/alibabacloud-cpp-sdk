...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLoadBalancerAddressTypeConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateLoadBalancerAddressTypeConfigResponseBody) };
    inline UpdateLoadBalancerAddressTypeConfigResponseBody body() { DARABONBA_PTR_GET(body_, UpdateLoadBalancerAddressTypeConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateLoadBalancerAddressTypeConfigResponseBody> body_ = nullptr;
  };
