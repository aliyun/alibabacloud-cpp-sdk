...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateListenerAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateListenerAttributeResponseBody) };
    inline UpdateListenerAttributeResponseBody body() { DARABONBA_PTR_GET(body_, UpdateListenerAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateListenerAttributeResponseBody> body_ = nullptr;
  };
