...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && this->nextToken_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->serverGroupIds_ == nullptr && this->serverGroupNames_ == nullptr
        && this->serverGroupType_ == nullptr && this->tag_ == nullptr && this->vpcId_ == nullptr; };
    ...
    inline ListServerGroupsRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
