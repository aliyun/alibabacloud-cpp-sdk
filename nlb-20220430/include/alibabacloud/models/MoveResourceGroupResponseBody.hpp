...
namespace Models
{
  ...
  public:
    ...
    inline const MoveResourceGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, MoveResourceGroupResponseBodyData) };
    inline MoveResourceGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, MoveResourceGroupResponseBodyData) };
    inline MoveResourceGroupResponseBody& setData(const MoveResourceGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline MoveResourceGroupResponseBody& setData(MoveResourceGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<MoveResourceGroupResponseBodyData> data_ = nullptr;
