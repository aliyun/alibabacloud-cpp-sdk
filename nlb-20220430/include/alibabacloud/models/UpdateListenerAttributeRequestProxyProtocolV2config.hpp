...
#ifndef ALIBABACLOUD_MODELS_UPDATELISTENERATTRIBUTEREQUESTPROXYPROTOCOLV2CONFIG_HPP_
#define ALIBABACLOUD_MODELS_UPDATELISTENERATTRIBUTEREQUESTPROXYPROTOCOLV2CONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateListenerAttributeRequestProxyProtocolV2Config& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateListenerAttributeRequestProxyProtocolV2Config& obj) { 
    ...
    UpdateListenerAttributeRequestProxyProtocolV2Config() = default ;
    UpdateListenerAttributeRequestProxyProtocolV2Config(const UpdateListenerAttributeRequestProxyProtocolV2Config &) = default ;
    UpdateListenerAttributeRequestProxyProtocolV2Config(UpdateListenerAttributeRequestProxyProtocolV2Config &&) = default ;
    UpdateListenerAttributeRequestProxyProtocolV2Config(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateListenerAttributeRequestProxyProtocolV2Config() = default ;
    UpdateListenerAttributeRequestProxyProtocolV2Config& operator=(const UpdateListenerAttributeRequestProxyProtocolV2Config &) = default ;
    UpdateListenerAttributeRequestProxyProtocolV2Config& operator=(UpdateListenerAttributeRequestProxyProtocolV2Config &&) = default ;
    ...
    inline UpdateListenerAttributeRequestProxyProtocolV2Config& setPpv2PrivateLinkEpIdEnabled(bool ppv2PrivateLinkEpIdEnabled) { DARABONBA_PTR_SET_VALUE(ppv2PrivateLinkEpIdEnabled_, ppv2PrivateLinkEpIdEnabled) };
    ...
    inline UpdateListenerAttributeRequestProxyProtocolV2Config& setPpv2PrivateLinkEpsIdEnabled(bool ppv2PrivateLinkEpsIdEnabled) { DARABONBA_PTR_SET_VALUE(ppv2PrivateLinkEpsIdEnabled_, ppv2PrivateLinkEpsIdEnabled) };
    ...
    inline UpdateListenerAttributeRequestProxyProtocolV2Config& setPpv2VpcIdEnabled(bool ppv2VpcIdEnabled) { DARABONBA_PTR_SET_VALUE(ppv2VpcIdEnabled_, ppv2VpcIdEnabled) };
