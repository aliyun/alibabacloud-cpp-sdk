...
namespace Models
{
  ...
  public:
    ...
    inline const ListSystemSecurityPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSystemSecurityPolicyResponseBody) };
    inline ListSystemSecurityPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSystemSecurityPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSystemSecurityPolicyResponseBody> body_ {};
  };
