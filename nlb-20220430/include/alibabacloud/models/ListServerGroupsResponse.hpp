...
namespace Models
{
  ...
  public:
    ...
    inline const ListServerGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListServerGroupsResponseBody) };
    inline ListServerGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListServerGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListServerGroupsResponseBody> body_ {};
  };
