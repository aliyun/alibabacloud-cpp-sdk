...
namespace Models
{
  ...
  public:
    ...
    inline const LoadBalancerLeaveSecurityGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, LoadBalancerLeaveSecurityGroupResponseBody) };
    inline LoadBalancerLeaveSecurityGroupResponseBody body() { DARABONBA_PTR_GET(body_, LoadBalancerLeaveSecurityGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<LoadBalancerLeaveSecurityGroupResponseBody> body_ = nullptr;
  };
