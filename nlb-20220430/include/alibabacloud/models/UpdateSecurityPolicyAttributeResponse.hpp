...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSecurityPolicyAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateSecurityPolicyAttributeResponseBody) };
    inline UpdateSecurityPolicyAttributeResponseBody body() { DARABONBA_PTR_GET(body_, UpdateSecurityPolicyAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateSecurityPolicyAttributeResponseBody> body_ = nullptr;
  };
