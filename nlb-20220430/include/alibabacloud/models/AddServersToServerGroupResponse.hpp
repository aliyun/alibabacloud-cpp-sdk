...
namespace Models
{
  ...
  public:
    ...
    inline const AddServersToServerGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddServersToServerGroupResponseBody) };
    inline AddServersToServerGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, AddServersToServerGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddServersToServerGroupResponseBody> body_ {};
  };
