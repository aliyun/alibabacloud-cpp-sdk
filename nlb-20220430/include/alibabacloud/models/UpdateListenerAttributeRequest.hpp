...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateListenerAttributeRequestProxyProtocolV2Config & proxyProtocolV2Config() const { DARABONBA_PTR_GET_CONST(proxyProtocolV2Config_, UpdateListenerAttributeRequestProxyProtocolV2Config) };
    inline UpdateListenerAttributeRequestProxyProtocolV2Config proxyProtocolV2Config() { DARABONBA_PTR_GET(proxyProtocolV2Config_, UpdateListenerAttributeRequestProxyProtocolV2Config) };
    inline UpdateListenerAttributeRequest& setProxyProtocolV2Config(const UpdateListenerAttributeRequestProxyProtocolV2Config & proxyProtocolV2Config) { DARABONBA_PTR_SET_VALUE(proxyProtocolV2Config_, proxyProtocolV2Config) };
    inline UpdateListenerAttributeRequest& setProxyProtocolV2Config(UpdateListenerAttributeRequestProxyProtocolV2Config && proxyProtocolV2Config) { DARABONBA_PTR_SET_RVALUE(proxyProtocolV2Config_, proxyProtocolV2Config) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateListenerAttributeRequestProxyProtocolV2Config> proxyProtocolV2Config_ = nullptr;
