...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & serverIps() const { DARABONBA_PTR_GET_CONST(serverIps_, vector<string>) };
    inline vector<string> serverIps() { DARABONBA_PTR_GET(serverIps_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> serverIps_ = nullptr;
  };
