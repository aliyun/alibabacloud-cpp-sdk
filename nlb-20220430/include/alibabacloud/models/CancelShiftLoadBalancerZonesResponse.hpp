...
namespace Models
{
  ...
  public:
    ...
    inline const CancelShiftLoadBalancerZonesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CancelShiftLoadBalancerZonesResponseBody) };
    inline CancelShiftLoadBalancerZonesResponseBody body() { DARABONBA_PTR_GET(body_, CancelShiftLoadBalancerZonesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CancelShiftLoadBalancerZonesResponseBody> body_ = nullptr;
  };
