...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->additionalCertificateIds_ != nullptr
    ...
    inline const vector<string> & additionalCertificateIds() const { DARABONBA_PTR_GET_CONST(additionalCertificateIds_, vector<string>) };
    inline vector<string> additionalCertificateIds() { DARABONBA_PTR_GET(additionalCertificateIds_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> additionalCertificateIds_ = nullptr;
