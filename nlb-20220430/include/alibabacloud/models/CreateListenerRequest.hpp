...
namespace Models
{
  ...
  public:
    ...
    inline const CreateListenerRequestProxyProtocolV2Config & proxyProtocolV2Config() const { DARABONBA_PTR_GET_CONST(proxyProtocolV2Config_, CreateListenerRequestProxyProtocolV2Config) };
    inline CreateListenerRequestProxyProtocolV2Config proxyProtocolV2Config() { DARABONBA_PTR_GET(proxyProtocolV2Config_, CreateListenerRequestProxyProtocolV2Config) };
    inline CreateListenerRequest& setProxyProtocolV2Config(const CreateListenerRequestProxyProtocolV2Config & proxyProtocolV2Config) { DARABONBA_PTR_SET_VALUE(proxyProtocolV2Config_, proxyProtocolV2Config) };
    inline CreateListenerRequest& setProxyProtocolV2Config(CreateListenerRequestProxyProtocolV2Config && proxyProtocolV2Config) { DARABONBA_PTR_SET_RVALUE(proxyProtocolV2Config_, proxyProtocolV2Config) };
  ...
  protected:
    ...
    std::shared_ptr<CreateListenerRequestProxyProtocolV2Config> proxyProtocolV2Config_ = nullptr;
