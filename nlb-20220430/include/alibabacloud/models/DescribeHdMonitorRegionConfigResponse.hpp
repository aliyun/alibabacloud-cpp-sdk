...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHdMonitorRegionConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHdMonitorRegionConfigResponseBody) };
    inline DescribeHdMonitorRegionConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHdMonitorRegionConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHdMonitorRegionConfigResponseBody> body_ {};
  };
