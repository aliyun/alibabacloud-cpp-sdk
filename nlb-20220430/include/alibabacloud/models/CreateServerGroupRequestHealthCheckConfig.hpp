...
#ifndef ALIBABACLOUD_MODELS_CREATESERVERGROUPREQUESTHEALTHCHECKCONFIG_HPP_
#define ALIBABACLOUD_MODELS_CREATESERVERGROUPREQUESTHEALTHCHECKCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateServerGroupRequestHealthCheckConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateServerGroupRequestHealthCheckConfig& obj) { 
    ...
    CreateServerGroupRequestHealthCheckConfig() = default ;
    CreateServerGroupRequestHealthCheckConfig(const CreateServerGroupRequestHealthCheckConfig &) = default ;
    CreateServerGroupRequestHealthCheckConfig(CreateServerGroupRequestHealthCheckConfig &&) = default ;
    CreateServerGroupRequestHealthCheckConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateServerGroupRequestHealthCheckConfig() = default ;
    CreateServerGroupRequestHealthCheckConfig& operator=(const CreateServerGroupRequestHealthCheckConfig &) = default ;
    CreateServerGroupRequestHealthCheckConfig& operator=(CreateServerGroupRequestHealthCheckConfig &&) = default ;
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckConnectPort(int32_t healthCheckConnectPort) { DARABONBA_PTR_SET_VALUE(healthCheckConnectPort_, healthCheckConnectPort) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckConnectTimeout(int32_t healthCheckConnectTimeout) { DARABONBA_PTR_SET_VALUE(healthCheckConnectTimeout_, healthCheckConnectTimeout) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckDomain(string healthCheckDomain) { DARABONBA_PTR_SET_VALUE(healthCheckDomain_, healthCheckDomain) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckEnabled(bool healthCheckEnabled) { DARABONBA_PTR_SET_VALUE(healthCheckEnabled_, healthCheckEnabled) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckExp(string healthCheckExp) { DARABONBA_PTR_SET_VALUE(healthCheckExp_, healthCheckExp) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckHttpCode(const vector<string> & healthCheckHttpCode) { DARABONBA_PTR_SET_VALUE(healthCheckHttpCode_, healthCheckHttpCode) };
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckHttpCode(vector<string> && healthCheckHttpCode) { DARABONBA_PTR_SET_RVALUE(healthCheckHttpCode_, healthCheckHttpCode) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckHttpVersion(string healthCheckHttpVersion) { DARABONBA_PTR_SET_VALUE(healthCheckHttpVersion_, healthCheckHttpVersion) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckInterval(int32_t healthCheckInterval) { DARABONBA_PTR_SET_VALUE(healthCheckInterval_, healthCheckInterval) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckReq(string healthCheckReq) { DARABONBA_PTR_SET_VALUE(healthCheckReq_, healthCheckReq) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckType(string healthCheckType) { DARABONBA_PTR_SET_VALUE(healthCheckType_, healthCheckType) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthCheckUrl(string healthCheckUrl) { DARABONBA_PTR_SET_VALUE(healthCheckUrl_, healthCheckUrl) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHealthyThreshold(int32_t healthyThreshold) { DARABONBA_PTR_SET_VALUE(healthyThreshold_, healthyThreshold) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setHttpCheckMethod(string httpCheckMethod) { DARABONBA_PTR_SET_VALUE(httpCheckMethod_, httpCheckMethod) };
    ...
    inline CreateServerGroupRequestHealthCheckConfig& setUnhealthyThreshold(int32_t unhealthyThreshold) { DARABONBA_PTR_SET_VALUE(unhealthyThreshold_, unhealthyThreshold) };
