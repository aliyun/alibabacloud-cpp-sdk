...
#ifndef ALIBABACLOUD_MODELS_LISTENTERPRISESUPPORTPLANRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTENTERPRISESUPPORTPLANRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListEnterpriseSupportPlanResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListEnterpriseSupportPlanResponseBody& obj) { 
    ...
    ListEnterpriseSupportPlanResponseBody() = default ;
    ListEnterpriseSupportPlanResponseBody(const ListEnterpriseSupportPlanResponseBody &) = default ;
    ListEnterpriseSupportPlanResponseBody(ListEnterpriseSupportPlanResponseBody &&) = default ;
    ListEnterpriseSupportPlanResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListEnterpriseSupportPlanResponseBody() = default ;
    ListEnterpriseSupportPlanResponseBody& operator=(const ListEnterpriseSupportPlanResponseBody &) = default ;
    ListEnterpriseSupportPlanResponseBody& operator=(ListEnterpriseSupportPlanResponseBody &&) = default ;
    ...
    public:
      friend void to_json(Darabonba::Json& j, const Data& obj) { 
        ...
        DARABONBA_PTR_TO_JSON(gtspProjectId, gtspProjectId_);
      ...
      friend void from_json(const Darabonba::Json& j, Data& obj) { 
        ...
        DARABONBA_PTR_FROM_JSON(gtspProjectId, gtspProjectId_);
      ...
      public:
        ...
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        virtual bool empty() const override { return this->extendInfos_ == nullptr
        && this->show_ == nullptr && this->tagCode_ == nullptr && this->tagName_ == nullptr; };
        ...
        inline const vector<string> & getExtendInfos() const { DARABONBA_PTR_GET_CONST(extendInfos_, vector<string>) };
        inline vector<string> getExtendInfos() { DARABONBA_PTR_GET(extendInfos_, vector<string>) };
        inline Tags& setExtendInfos(const vector<string> & extendInfos) { DARABONBA_PTR_SET_VALUE(extendInfos_, extendInfos) };
        inline Tags& setExtendInfos(vector<string> && extendInfos) { DARABONBA_PTR_SET_RVALUE(extendInfos_, extendInfos) };
        ...
        inline Tags& setShow(bool show) { DARABONBA_PTR_SET_VALUE(show_, show) };
      ...
      protected:
        shared_ptr<vector<string>> extendInfos_ {};
      ...
      public:
        ...
        && this->docId_ == nullptr && this->docName_ == nullptr && this->docSubmitTime_ == nullptr && this->fileName_ == nullptr && this->freeOrderApplyCode_ == nullptr
        && this->orderId_ == nullptr; };
          ...
          inline const vector<Darabonba::Json> & getAttachments() const { DARABONBA_PTR_GET_CONST(attachments_, vector<Darabonba::Json>) };
          inline vector<Darabonba::Json> getAttachments() { DARABONBA_PTR_GET(attachments_, vector<Darabonba::Json>) };
          inline DocNode& setAttachments(const vector<Darabonba::Json> & attachments) { DARABONBA_PTR_SET_VALUE(attachments_, attachments) };
          inline DocNode& setAttachments(vector<Darabonba::Json> && attachments) { DARABONBA_PTR_SET_RVALUE(attachments_, attachments) };
        ...
        protected:
          shared_ptr<vector<Darabonba::Json>> attachments_ {};
      ...
      public:
        friend void to_json(Darabonba::Json& j, const Docs& obj) { 
          DARABONBA_PTR_TO_JSON(attachments, attachments_);
          DARABONBA_PTR_TO_JSON(docId, docId_);
          DARABONBA_PTR_TO_JSON(evaluated, evaluated_);
          DARABONBA_PTR_TO_JSON(evaluationUrl, evaluationUrl_);
          DARABONBA_PTR_TO_JSON(fileName, fileName_);
          DARABONBA_PTR_TO_JSON(freeOrderApplyCode, freeOrderApplyCode_);
          DARABONBA_PTR_TO_JSON(name, name_);
          DARABONBA_PTR_TO_JSON(orderId, orderId_);
        ...
        friend void from_json(const Darabonba::Json& j, Docs& obj) { 
          DARABONBA_PTR_FROM_JSON(attachments, attachments_);
          DARABONBA_PTR_FROM_JSON(docId, docId_);
          DARABONBA_PTR_FROM_JSON(evaluated, evaluated_);
          DARABONBA_PTR_FROM_JSON(evaluationUrl, evaluationUrl_);
          DARABONBA_PTR_FROM_JSON(fileName, fileName_);
          DARABONBA_PTR_FROM_JSON(freeOrderApplyCode, freeOrderApplyCode_);
          DARABONBA_PTR_FROM_JSON(name, name_);
          DARABONBA_PTR_FROM_JSON(orderId, orderId_);
        ...
        && this->evaluated_ == nullptr && this->evaluationUrl_ == nullptr && this->fileName_ == nullptr && this->freeOrderApplyCode_ == nullptr && this->name_ == nullptr
        && this->orderId_ == nullptr && this->uploadTime_ == nullptr && this->url_ == nullptr; };
          // docId Field Functions 
          bool hasDocId() const { return this->docId_ != nullptr;};
          void deleteDocId() { this->docId_ = nullptr;};
          inline int64_t getDocId() const { DARABONBA_PTR_GET_DEFAULT(docId_, 0L) };
          inline Attachments& setDocId(int64_t docId) { DARABONBA_PTR_SET_VALUE(docId_, docId) };


          // evaluated Field Functions 
          bool hasEvaluated() const { return this->evaluated_ != nullptr;};
          void deleteEvaluated() { this->evaluated_ = nullptr;};
          inline bool getEvaluated() const { DARABONBA_PTR_GET_DEFAULT(evaluated_, false) };
          inline Attachments& setEvaluated(bool evaluated) { DARABONBA_PTR_SET_VALUE(evaluated_, evaluated) };


          // evaluationUrl Field Functions 
          bool hasEvaluationUrl() const { return this->evaluationUrl_ != nullptr;};
          void deleteEvaluationUrl() { this->evaluationUrl_ = nullptr;};
          inline string getEvaluationUrl() const { DARABONBA_PTR_GET_DEFAULT(evaluationUrl_, "") };
          inline Attachments& setEvaluationUrl(string evaluationUrl) { DARABONBA_PTR_SET_VALUE(evaluationUrl_, evaluationUrl) };
          ...
          void deleteFreeOrderApplyCode() { this->freeOrderApplyCode_ = nullptr;};
          inline string getFreeOrderApplyCode() const { DARABONBA_PTR_GET_DEFAULT(freeOrderApplyCode_, "") };
          inline Attachments& setFreeOrderApplyCode(string freeOrderApplyCode) { DARABONBA_PTR_SET_VALUE(freeOrderApplyCode_, freeOrderApplyCode) };
          ...
          void deleteOrderId() { this->orderId_ = nullptr;};
          inline string getOrderId() const { DARABONBA_PTR_GET_DEFAULT(orderId_, "") };
          inline Attachments& setOrderId(string orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
          ...
          inline Attachments& setUploadTime(string uploadTime) { DARABONBA_PTR_SET_VALUE(uploadTime_, uploadTime) };
          ...
          void deleteUrl() { this->url_ = nullptr;};
          inline string getUrl() const { DARABONBA_PTR_GET_DEFAULT(url_, "") };
          inline Attachments& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };


        protected:
          shared_ptr<int64_t> docId_ {};
          shared_ptr<bool> evaluated_ {};
          shared_ptr<string> evaluationUrl_ {};
          shared_ptr<string> fileName_ {};
          shared_ptr<string> freeOrderApplyCode_ {};
          shared_ptr<string> name_ {};
          shared_ptr<string> orderId_ {};
        ...
        virtual bool empty() const override { return this->attachments_ == nullptr
        && this->docId_ == nullptr && this->evaluated_ == nullptr && this->evaluationUrl_ == nullptr && this->fileName_ == nullptr && this->freeOrderApplyCode_ == nullptr
        && this->name_ == nullptr && this->orderId_ == nullptr && this->uploadTime_ == nullptr && this->url_ == nullptr; };
        // attachments Field Functions 
        bool hasAttachments() const { return this->attachments_ != nullptr;};
        void deleteAttachments() { this->attachments_ = nullptr;};
        inline const vector<Docs::Attachments> & getAttachments() const { DARABONBA_PTR_GET_CONST(attachments_, vector<Docs::Attachments>) };
        inline vector<Docs::Attachments> getAttachments() { DARABONBA_PTR_GET(attachments_, vector<Docs::Attachments>) };
        inline Docs& setAttachments(const vector<Docs::Attachments> & attachments) { DARABONBA_PTR_SET_VALUE(attachments_, attachments) };
        inline Docs& setAttachments(vector<Docs::Attachments> && attachments) { DARABONBA_PTR_SET_RVALUE(attachments_, attachments) };
        ...
        void deleteEvaluated() { this->evaluated_ = nullptr;};
        inline bool getEvaluated() const { DARABONBA_PTR_GET_DEFAULT(evaluated_, false) };
        inline Docs& setEvaluated(bool evaluated) { DARABONBA_PTR_SET_VALUE(evaluated_, evaluated) };
        ...
        void deleteEvaluationUrl() { this->evaluationUrl_ = nullptr;};
        inline string getEvaluationUrl() const { DARABONBA_PTR_GET_DEFAULT(evaluationUrl_, "") };
        inline Docs& setEvaluationUrl(string evaluationUrl) { DARABONBA_PTR_SET_VALUE(evaluationUrl_, evaluationUrl) };
      ...
      protected:
        shared_ptr<vector<Docs::Attachments>> attachments_ {};
        shared_ptr<int64_t> docId_ {};
        shared_ptr<bool> evaluated_ {};
        shared_ptr<string> evaluationUrl_ {};
        shared_ptr<string> fileName_ {};
      ...
      virtual bool empty() const override { return this->canApplyFreeOrder_ == nullptr
        ...
        && this->freeOrderApplyId_ == nullptr && this->freeOrderApplyTime_ == nullptr && this->freeOrderApprovedTime_ == nullptr && this->freeOrderExpectStartTime_ == nullptr && this->gtspProjectId_ == nullptr
        && this->instanceId_ == nullptr && this->nodes_ == nullptr && this->operateInfos_ == nullptr && this->orderIds_ == nullptr && this->serviceName_ == nullptr
        && this->serviceStatus_ == nullptr && this->serviceStatusName_ == nullptr && this->serviceType_ == nullptr && this->sortTime_ == nullptr && this->startTime_ == nullptr
        && this->tags_ == nullptr && this->taskNum_ == nullptr; };
      ...
      // gtspProjectId Field Functions 
      bool hasGtspProjectId() const { return this->gtspProjectId_ != nullptr;};
      void deleteGtspProjectId() { this->gtspProjectId_ = nullptr;};
      inline int64_t getGtspProjectId() const { DARABONBA_PTR_GET_DEFAULT(gtspProjectId_, 0L) };
      inline Data& setGtspProjectId(int64_t gtspProjectId) { DARABONBA_PTR_SET_VALUE(gtspProjectId_, gtspProjectId) };
    ...
    protected:
      ...
      shared_ptr<int64_t> gtspProjectId_ {};
    ...
    inline ListEnterpriseSupportPlanResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListEnterpriseSupportPlanResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListEnterpriseSupportPlanResponseBody::Data>) };
    inline vector<ListEnterpriseSupportPlanResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListEnterpriseSupportPlanResponseBody::Data>) };
    inline ListEnterpriseSupportPlanResponseBody& setData(const vector<ListEnterpriseSupportPlanResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEnterpriseSupportPlanResponseBody& setData(vector<ListEnterpriseSupportPlanResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListEnterpriseSupportPlanResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListEnterpriseSupportPlanResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListEnterpriseSupportPlanResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListEnterpriseSupportPlanResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<vector<ListEnterpriseSupportPlanResponseBody::Data>> data_ {};
