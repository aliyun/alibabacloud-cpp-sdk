...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePdnsRequestStatisticsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribePdnsRequestStatisticsResponseBody) };
    inline DescribePdnsRequestStatisticsResponseBody body() { DARABONBA_PTR_GET(body_, DescribePdnsRequestStatisticsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePdnsRequestStatisticsResponseBody> body_ = nullptr;
  };
