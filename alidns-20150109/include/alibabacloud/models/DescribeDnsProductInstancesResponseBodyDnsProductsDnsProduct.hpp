...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoRenewal_ == nullptr
        ...
        && return this->DDosDefendQuery_ == nullptr && return this->dnsSLBCount_ == nullptr && return this->dnsSecurity_ == nullptr && return this->domain_ == nullptr && return this->endTime_ == nullptr
        && return this->endTimestamp_ == nullptr && return this->gslb_ == nullptr && return this->ISPLines_ == nullptr && return this->ISPRegionLines_ == nullptr && return this->inBlackHole_ == nullptr
        && return this->inClean_ == nullptr && return this->instanceId_ == nullptr && return this->monitorFrequency_ == nullptr && return this->monitorNodeCount_ == nullptr && return this->monitorTaskCount_ == nullptr
        && return this->overseaDDosDefendFlow_ == nullptr && return this->overseaLine_ == nullptr && return this->paymentType_ == nullptr && return this->regionLines_ == nullptr && return this->searchEngineLines_ == nullptr
        && return this->startTime_ == nullptr && return this->startTimestamp_ == nullptr && return this->subDomainLevel_ == nullptr && return this->TTLMinValue_ == nullptr && return this->URLForwardCount_ == nullptr
        && return this->versionCode_ == nullptr && return this->versionName_ == nullptr; };
