...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addr_ == nullptr
        && return this->alertStatus_ == nullptr && return this->attributeInfo_ == nullptr && return this->createTime_ == nullptr && return this->createTimestamp_ == nullptr && return this->lbaWeight_ == nullptr
        && return this->mode_ == nullptr && return this->remark_ == nullptr && return this->updateTime_ == nullptr && return this->updateTimestamp_ == nullptr; };
