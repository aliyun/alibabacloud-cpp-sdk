...
namespace Models
{
  ...
  public:
    ...
    inline const AddDomainGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddDomainGroupResponseBody) };
    inline AddDomainGroupResponseBody body() { DARABONBA_PTR_GET(body_, AddDomainGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddDomainGroupResponseBody> body_ = nullptr;
  };
