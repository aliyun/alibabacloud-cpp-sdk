...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePdnsThreatLogsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribePdnsThreatLogsResponseBody) };
    inline DescribePdnsThreatLogsResponseBody body() { DARABONBA_PTR_GET(body_, DescribePdnsThreatLogsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePdnsThreatLogsResponseBody> body_ = nullptr;
  };
