...
namespace Models
{
  ...
  public:
    ...
    inline const RemovePdnsUdpIpSegmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemovePdnsUdpIpSegmentResponseBody) };
    inline RemovePdnsUdpIpSegmentResponseBody getBody() { DARABONBA_PTR_GET(body_, RemovePdnsUdpIpSegmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemovePdnsUdpIpSegmentResponseBody> body_ {};
  };
