...
namespace Models
{
  ...
  public:
    ...
    inline const SetDnsGtmMonitorStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetDnsGtmMonitorStatusResponseBody) };
    inline SetDnsGtmMonitorStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, SetDnsGtmMonitorStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetDnsGtmMonitorStatusResponseBody> body_ {};
  };
