...
namespace Models
{
  ...
  public:
    ...
    inline const ListCloudGtmAddressesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCloudGtmAddressesResponseBody) };
    inline ListCloudGtmAddressesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCloudGtmAddressesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCloudGtmAddressesResponseBody> body_ {};
  };
