...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCloudGtmInstanceConfigBasicResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateCloudGtmInstanceConfigBasicResponseBody) };
    inline UpdateCloudGtmInstanceConfigBasicResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateCloudGtmInstanceConfigBasicResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateCloudGtmInstanceConfigBasicResponseBody> body_ {};
  };
