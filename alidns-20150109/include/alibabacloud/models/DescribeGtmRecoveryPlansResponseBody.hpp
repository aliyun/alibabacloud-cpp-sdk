...
#include <alibabacloud/models/DescribeGtmRecoveryPlansResponseBodyRecoveryPlans.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->recoveryPlans_ == nullptr && return this->requestId_ == nullptr && return this->totalItems_ == nullptr && return this->totalPages_ == nullptr; };
    ...
    inline const DescribeGtmRecoveryPlansResponseBodyRecoveryPlans & recoveryPlans() const { DARABONBA_PTR_GET_CONST(recoveryPlans_, DescribeGtmRecoveryPlansResponseBodyRecoveryPlans) };
    inline DescribeGtmRecoveryPlansResponseBodyRecoveryPlans recoveryPlans() { DARABONBA_PTR_GET(recoveryPlans_, DescribeGtmRecoveryPlansResponseBodyRecoveryPlans) };
    inline DescribeGtmRecoveryPlansResponseBody& setRecoveryPlans(const DescribeGtmRecoveryPlansResponseBodyRecoveryPlans & recoveryPlans) { DARABONBA_PTR_SET_VALUE(recoveryPlans_, recoveryPlans) };
    inline DescribeGtmRecoveryPlansResponseBody& setRecoveryPlans(DescribeGtmRecoveryPlansResponseBodyRecoveryPlans && recoveryPlans) { DARABONBA_PTR_SET_RVALUE(recoveryPlans_, recoveryPlans) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeGtmRecoveryPlansResponseBodyRecoveryPlans> recoveryPlans_ = nullptr;
