...
#ifndef ALIBABACLOUD_MODELS_SEARCHCLOUDGTMADDRESSESRESPONSEBODYADDRESSESADDRESS_HPP_
#define ALIBABACLOUD_MODELS_SEARCHCLOUDGTMADDRESSESRESPONSEBODYADDRESSESADDRESS_HPP_
#include <darabonba/Core.hpp>
#include <alibabacloud/models/SearchCloudGtmAddressesResponseBodyAddressesAddressHealthTasks.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchCloudGtmAddressesResponseBodyAddressesAddress& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SearchCloudGtmAddressesResponseBodyAddressesAddress& obj) { 
    ...
    SearchCloudGtmAddressesResponseBodyAddressesAddress() = default ;
    SearchCloudGtmAddressesResponseBodyAddressesAddress(const SearchCloudGtmAddressesResponseBodyAddressesAddress &) = default ;
    SearchCloudGtmAddressesResponseBodyAddressesAddress(SearchCloudGtmAddressesResponseBodyAddressesAddress &&) = default ;
    SearchCloudGtmAddressesResponseBodyAddressesAddress(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchCloudGtmAddressesResponseBodyAddressesAddress() = default ;
    SearchCloudGtmAddressesResponseBodyAddressesAddress& operator=(const SearchCloudGtmAddressesResponseBodyAddressesAddress &) = default ;
    SearchCloudGtmAddressesResponseBodyAddressesAddress& operator=(SearchCloudGtmAddressesResponseBodyAddressesAddress &&) = default ;
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setAddress(string address) { DARABONBA_PTR_SET_VALUE(address_, address) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setAddressId(string addressId) { DARABONBA_PTR_SET_VALUE(addressId_, addressId) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setAttributeInfo(string attributeInfo) { DARABONBA_PTR_SET_VALUE(attributeInfo_, attributeInfo) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setAvailableMode(string availableMode) { DARABONBA_PTR_SET_VALUE(availableMode_, availableMode) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setAvailableStatus(string availableStatus) { DARABONBA_PTR_SET_VALUE(availableStatus_, availableStatus) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setCreateTimestamp(int64_t createTimestamp) { DARABONBA_PTR_SET_VALUE(createTimestamp_, createTimestamp) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setEnableStatus(string enableStatus) { DARABONBA_PTR_SET_VALUE(enableStatus_, enableStatus) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setHealthJudgement(string healthJudgement) { DARABONBA_PTR_SET_VALUE(healthJudgement_, healthJudgement) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setHealthStatus(string healthStatus) { DARABONBA_PTR_SET_VALUE(healthStatus_, healthStatus) };
    ...
    inline const Models::SearchCloudGtmAddressesResponseBodyAddressesAddressHealthTasks & healthTasks() const { DARABONBA_PTR_GET_CONST(healthTasks_, Models::SearchCloudGtmAddressesResponseBodyAddressesAddressHealthTasks) };
    inline Models::SearchCloudGtmAddressesResponseBodyAddressesAddressHealthTasks healthTasks() { DARABONBA_PTR_GET(healthTasks_, Models::SearchCloudGtmAddressesResponseBodyAddressesAddressHealthTasks) };
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setHealthTasks(const Models::SearchCloudGtmAddressesResponseBodyAddressesAddressHealthTasks & healthTasks) { DARABONBA_PTR_SET_VALUE(healthTasks_, healthTasks) };
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setHealthTasks(Models::SearchCloudGtmAddressesResponseBodyAddressesAddressHealthTasks && healthTasks) { DARABONBA_PTR_SET_RVALUE(healthTasks_, healthTasks) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setManualAvailableStatus(string manualAvailableStatus) { DARABONBA_PTR_SET_VALUE(manualAvailableStatus_, manualAvailableStatus) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline SearchCloudGtmAddressesResponseBodyAddressesAddress& setUpdateTimestamp(int64_t updateTimestamp) { DARABONBA_PTR_SET_VALUE(updateTimestamp_, updateTimestamp) };
  ...
  protected:
    ...
    std::shared_ptr<Models::SearchCloudGtmAddressesResponseBodyAddressesAddressHealthTasks> healthTasks_ = nullptr;
    // The availability state of the address when AvailableMode is set to manual. Valid values:
    // 
    // *   available: The address is normal. In this state, the address is returned for DNS requests even if an alert is triggered when the address fails health checks.
    // *   unavailable: The address is abnormal. In this state, the address is not returned for DNS requests even if the address passes health checks.
