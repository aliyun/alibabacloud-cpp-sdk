...
#ifndef ALIBABACLOUD_MODELS_REVOKEATIREGISTRANTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_REVOKEATIREGISTRANTRESPONSEBODY_HPP_
...
namespace Models
{
  class RevokeAtiRegistrantResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const RevokeAtiRegistrantResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, RevokeAtiRegistrantResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    RevokeAtiRegistrantResponseBody() = default ;
    RevokeAtiRegistrantResponseBody(const RevokeAtiRegistrantResponseBody &) = default ;
    RevokeAtiRegistrantResponseBody(RevokeAtiRegistrantResponseBody &&) = default ;
    RevokeAtiRegistrantResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RevokeAtiRegistrantResponseBody() = default ;
    RevokeAtiRegistrantResponseBody& operator=(const RevokeAtiRegistrantResponseBody &) = default ;
    RevokeAtiRegistrantResponseBody& operator=(RevokeAtiRegistrantResponseBody &&) = default ;
    ...
    inline const RevokeAtiRegistrantResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, RevokeAtiRegistrantResponseBody::AccessDeniedDetail) };
    inline RevokeAtiRegistrantResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, RevokeAtiRegistrantResponseBody::AccessDeniedDetail) };
    inline RevokeAtiRegistrantResponseBody& setAccessDeniedDetail(const RevokeAtiRegistrantResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline RevokeAtiRegistrantResponseBody& setAccessDeniedDetail(RevokeAtiRegistrantResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline RevokeAtiRegistrantResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline RevokeAtiRegistrantResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The details about the access denial. This parameter is returned only when the RAM authentication fails.
    shared_ptr<RevokeAtiRegistrantResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The request ID.
