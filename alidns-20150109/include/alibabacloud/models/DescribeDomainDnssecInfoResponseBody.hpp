...
namespace Models
{
  ...
  public:
    ...
    inline string digestType() const { DARABONBA_PTR_GET_DEFAULT(digestType_, "") };
    ...
    inline string dsRecord() const { DARABONBA_PTR_GET_DEFAULT(dsRecord_, "") };
    ...
    inline string keyTag() const { DARABONBA_PTR_GET_DEFAULT(keyTag_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> keyTag_ = nullptr;
