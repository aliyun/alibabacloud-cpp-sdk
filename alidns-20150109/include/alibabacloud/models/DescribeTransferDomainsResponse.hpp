...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTransferDomainsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTransferDomainsResponseBody) };
    inline DescribeTransferDomainsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTransferDomainsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTransferDomainsResponseBody> body_ {};
  };
