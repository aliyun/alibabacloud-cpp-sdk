...
#ifndef ALIBABACLOUD_MODELS_DELETEATIREGISTRANTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DELETEATIREGISTRANTRESPONSEBODY_HPP_
...
namespace Models
{
  class DeleteAtiRegistrantResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DeleteAtiRegistrantResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteAtiRegistrantResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    DeleteAtiRegistrantResponseBody() = default ;
    DeleteAtiRegistrantResponseBody(const DeleteAtiRegistrantResponseBody &) = default ;
    DeleteAtiRegistrantResponseBody(DeleteAtiRegistrantResponseBody &&) = default ;
    DeleteAtiRegistrantResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteAtiRegistrantResponseBody() = default ;
    DeleteAtiRegistrantResponseBody& operator=(const DeleteAtiRegistrantResponseBody &) = default ;
    DeleteAtiRegistrantResponseBody& operator=(DeleteAtiRegistrantResponseBody &&) = default ;
    ...
    inline const DeleteAtiRegistrantResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DeleteAtiRegistrantResponseBody::AccessDeniedDetail) };
    inline DeleteAtiRegistrantResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DeleteAtiRegistrantResponseBody::AccessDeniedDetail) };
    inline DeleteAtiRegistrantResponseBody& setAccessDeniedDetail(const DeleteAtiRegistrantResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DeleteAtiRegistrantResponseBody& setAccessDeniedDetail(DeleteAtiRegistrantResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline DeleteAtiRegistrantResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DeleteAtiRegistrantResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The details about the access denial. This field is returned only when RAM authentication fails.
    shared_ptr<DeleteAtiRegistrantResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The request ID.
