...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && return this->addressPoolsShrink_ == nullptr && return this->clientToken_ == nullptr && return this->configId_ == nullptr && return this->instanceId_ == nullptr; };
    ...
    inline string addressPoolsShrink() const { DARABONBA_PTR_GET_DEFAULT(addressPoolsShrink_, "") };
  ...
  protected:
    ...
    // The address pools.
    std::shared_ptr<string> addressPoolsShrink_ = nullptr;
