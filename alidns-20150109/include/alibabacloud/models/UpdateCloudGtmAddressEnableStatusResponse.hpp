...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCloudGtmAddressEnableStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateCloudGtmAddressEnableStatusResponseBody) };
    inline UpdateCloudGtmAddressEnableStatusResponseBody body() { DARABONBA_PTR_GET(body_, UpdateCloudGtmAddressEnableStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateCloudGtmAddressEnableStatusResponseBody> body_ = nullptr;
  };
