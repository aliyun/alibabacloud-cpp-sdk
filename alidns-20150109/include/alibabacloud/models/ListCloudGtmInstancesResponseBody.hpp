...
#include <alibabacloud/models/ListCloudGtmInstancesResponseBodyInstances.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const ListCloudGtmInstancesResponseBodyInstances & instances() const { DARABONBA_PTR_GET_CONST(instances_, ListCloudGtmInstancesResponseBodyInstances) };
    inline ListCloudGtmInstancesResponseBodyInstances instances() { DARABONBA_PTR_GET(instances_, ListCloudGtmInstancesResponseBodyInstances) };
    inline ListCloudGtmInstancesResponseBody& setInstances(const ListCloudGtmInstancesResponseBodyInstances & instances) { DARABONBA_PTR_SET_VALUE(instances_, instances) };
    inline ListCloudGtmInstancesResponseBody& setInstances(ListCloudGtmInstancesResponseBodyInstances && instances) { DARABONBA_PTR_SET_RVALUE(instances_, instances) };
  ...
  protected:
    // The instances.
    std::shared_ptr<ListCloudGtmInstancesResponseBodyInstances> instances_ = nullptr;
