...
#ifndef ALIBABACLOUD_MODELS_ADDGTMADDRESSPOOLREQUESTISPCITYNODE_HPP_
#define ALIBABACLOUD_MODELS_ADDGTMADDRESSPOOLREQUESTISPCITYNODE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddGtmAddressPoolRequestIspCityNode& obj) { 
      DARABONBA_PTR_TO_JSON(CityCode, cityCode_);
      DARABONBA_PTR_TO_JSON(IspCode, ispCode_);
    };
    friend void from_json(const Darabonba::Json& j, AddGtmAddressPoolRequestIspCityNode& obj) { 
      DARABONBA_PTR_FROM_JSON(CityCode, cityCode_);
      DARABONBA_PTR_FROM_JSON(IspCode, ispCode_);
    };
    AddGtmAddressPoolRequestIspCityNode() = default ;
    AddGtmAddressPoolRequestIspCityNode(const AddGtmAddressPoolRequestIspCityNode &) = default ;
    AddGtmAddressPoolRequestIspCityNode(AddGtmAddressPoolRequestIspCityNode &&) = default ;
    AddGtmAddressPoolRequestIspCityNode(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddGtmAddressPoolRequestIspCityNode() = default ;
    AddGtmAddressPoolRequestIspCityNode& operator=(const AddGtmAddressPoolRequestIspCityNode &) = default ;
    AddGtmAddressPoolRequestIspCityNode& operator=(AddGtmAddressPoolRequestIspCityNode &&) = default ;
    ...
    inline AddGtmAddressPoolRequestIspCityNode& setCityCode(string cityCode) { DARABONBA_PTR_SET_VALUE(cityCode_, cityCode) };
    ...
    inline AddGtmAddressPoolRequestIspCityNode& setIspCode(string ispCode) { DARABONBA_PTR_SET_VALUE(ispCode_, ispCode) };
