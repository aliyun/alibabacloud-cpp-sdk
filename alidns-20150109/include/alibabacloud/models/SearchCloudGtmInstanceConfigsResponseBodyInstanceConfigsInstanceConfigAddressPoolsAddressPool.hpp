...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addressLbStrategy_ == nullptr
        && return this->addressPoolId_ == nullptr && return this->addressPoolName_ == nullptr && return this->addressPoolType_ == nullptr && return this->availableStatus_ == nullptr && return this->createTime_ == nullptr
        && return this->createTimestamp_ == nullptr && return this->enableStatus_ == nullptr && return this->healthJudgement_ == nullptr && return this->healthStatus_ == nullptr && return this->requestSource_ == nullptr
        && return this->seqNonPreemptiveSchedule_ == nullptr && return this->sequenceLbStrategyMode_ == nullptr && return this->serialNumber_ == nullptr && return this->updateTime_ == nullptr && return this->updateTimestamp_ == nullptr
        && return this->weightValue_ == nullptr; };
