...
#include <alibabacloud/models/DescribeCloudGtmMonitorTemplateResponseBodyIspCityNodes.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->createTime_ == nullptr
        && return this->createTimestamp_ == nullptr && return this->evaluationCount_ == nullptr && return this->extendInfo_ == nullptr && return this->failureRate_ == nullptr && return this->interval_ == nullptr
        && return this->ipVersion_ == nullptr && return this->ispCityNodes_ == nullptr && return this->name_ == nullptr && return this->protocol_ == nullptr && return this->remark_ == nullptr
        && return this->requestId_ == nullptr && return this->templateId_ == nullptr && return this->timeout_ == nullptr && return this->updateTime_ == nullptr && return this->updateTimestamp_ == nullptr; };
    ...
    inline const DescribeCloudGtmMonitorTemplateResponseBodyIspCityNodes & ispCityNodes() const { DARABONBA_PTR_GET_CONST(ispCityNodes_, DescribeCloudGtmMonitorTemplateResponseBodyIspCityNodes) };
    inline DescribeCloudGtmMonitorTemplateResponseBodyIspCityNodes ispCityNodes() { DARABONBA_PTR_GET(ispCityNodes_, DescribeCloudGtmMonitorTemplateResponseBodyIspCityNodes) };
    inline DescribeCloudGtmMonitorTemplateResponseBody& setIspCityNodes(const DescribeCloudGtmMonitorTemplateResponseBodyIspCityNodes & ispCityNodes) { DARABONBA_PTR_SET_VALUE(ispCityNodes_, ispCityNodes) };
    inline DescribeCloudGtmMonitorTemplateResponseBody& setIspCityNodes(DescribeCloudGtmMonitorTemplateResponseBodyIspCityNodes && ispCityNodes) { DARABONBA_PTR_SET_RVALUE(ispCityNodes_, ispCityNodes) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCloudGtmMonitorTemplateResponseBodyIspCityNodes> ispCityNodes_ = nullptr;
