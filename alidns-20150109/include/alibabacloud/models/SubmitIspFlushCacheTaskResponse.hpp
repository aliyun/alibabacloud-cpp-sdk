...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitIspFlushCacheTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SubmitIspFlushCacheTaskResponseBody) };
    inline SubmitIspFlushCacheTaskResponseBody body() { DARABONBA_PTR_GET(body_, SubmitIspFlushCacheTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitIspFlushCacheTaskResponseBody> body_ = nullptr;
  };
