...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECLOUDGTMADDRESSPOOLREFERENCERESPONSEBODYINSTANCECONFIGSINSTANCECONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECLOUDGTMADDRESSPOOLREFERENCERESPONSEBODYINSTANCECONFIGSINSTANCECONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& obj) { 
    ...
    DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig() = default ;
    DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig(const DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig &) = default ;
    DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig(DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig &&) = default ;
    DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig() = default ;
    DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& operator=(const DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig &) = default ;
    DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& operator=(DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig &&) = default ;
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setAddressPoolLbStrategy(string addressPoolLbStrategy) { DARABONBA_PTR_SET_VALUE(addressPoolLbStrategy_, addressPoolLbStrategy) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setAvailableStatus(string availableStatus) { DARABONBA_PTR_SET_VALUE(availableStatus_, availableStatus) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setConfigId(string configId) { DARABONBA_PTR_SET_VALUE(configId_, configId) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setEnableStatus(string enableStatus) { DARABONBA_PTR_SET_VALUE(enableStatus_, enableStatus) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setHealthStatus(string healthStatus) { DARABONBA_PTR_SET_VALUE(healthStatus_, healthStatus) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setInstanceName(string instanceName) { DARABONBA_PTR_SET_VALUE(instanceName_, instanceName) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setScheduleDomainName(string scheduleDomainName) { DARABONBA_PTR_SET_VALUE(scheduleDomainName_, scheduleDomainName) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setScheduleHostname(string scheduleHostname) { DARABONBA_PTR_SET_VALUE(scheduleHostname_, scheduleHostname) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setScheduleRrType(string scheduleRrType) { DARABONBA_PTR_SET_VALUE(scheduleRrType_, scheduleRrType) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setScheduleZoneName(string scheduleZoneName) { DARABONBA_PTR_SET_VALUE(scheduleZoneName_, scheduleZoneName) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setSequenceLbStrategyMode(string sequenceLbStrategyMode) { DARABONBA_PTR_SET_VALUE(sequenceLbStrategyMode_, sequenceLbStrategyMode) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setTtl(int32_t ttl) { DARABONBA_PTR_SET_VALUE(ttl_, ttl) };
    ...
    inline DescribeCloudGtmAddressPoolReferenceResponseBodyInstanceConfigsInstanceConfig& setVersionCode(string versionCode) { DARABONBA_PTR_SET_VALUE(versionCode_, versionCode) };
