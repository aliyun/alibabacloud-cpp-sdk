...
#ifndef ALIBABACLOUD_MODELS_UPDATEATIAGENTREGISTERINFORESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEATIAGENTREGISTERINFORESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateAtiAgentRegisterInfoResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAtiAgentRegisterInfoResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateAtiAgentRegisterInfoResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    UpdateAtiAgentRegisterInfoResponseBody() = default ;
    UpdateAtiAgentRegisterInfoResponseBody(const UpdateAtiAgentRegisterInfoResponseBody &) = default ;
    UpdateAtiAgentRegisterInfoResponseBody(UpdateAtiAgentRegisterInfoResponseBody &&) = default ;
    UpdateAtiAgentRegisterInfoResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAtiAgentRegisterInfoResponseBody() = default ;
    UpdateAtiAgentRegisterInfoResponseBody& operator=(const UpdateAtiAgentRegisterInfoResponseBody &) = default ;
    UpdateAtiAgentRegisterInfoResponseBody& operator=(UpdateAtiAgentRegisterInfoResponseBody &&) = default ;
    ...
    inline const UpdateAtiAgentRegisterInfoResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, UpdateAtiAgentRegisterInfoResponseBody::AccessDeniedDetail) };
    inline UpdateAtiAgentRegisterInfoResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, UpdateAtiAgentRegisterInfoResponseBody::AccessDeniedDetail) };
    inline UpdateAtiAgentRegisterInfoResponseBody& setAccessDeniedDetail(const UpdateAtiAgentRegisterInfoResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline UpdateAtiAgentRegisterInfoResponseBody& setAccessDeniedDetail(UpdateAtiAgentRegisterInfoResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline UpdateAtiAgentRegisterInfoResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline UpdateAtiAgentRegisterInfoResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The access denial details. This field is returned only when RAM authentication fails.
    shared_ptr<UpdateAtiAgentRegisterInfoResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The request ID.
