...
namespace Models
{
  ...
  public:
    ...
    inline const ListRecursionRecordsResponseBody::Records & getRecords() const { DARABONBA_PTR_GET_CONST(records_, ListRecursionRecordsResponseBody::Records) };
    inline ListRecursionRecordsResponseBody::Records getRecords() { DARABONBA_PTR_GET(records_, ListRecursionRecordsResponseBody::Records) };
    inline ListRecursionRecordsResponseBody& setRecords(const ListRecursionRecordsResponseBody::Records & records) { DARABONBA_PTR_SET_VALUE(records_, records) };
    inline ListRecursionRecordsResponseBody& setRecords(ListRecursionRecordsResponseBody::Records && records) { DARABONBA_PTR_SET_RVALUE(records_, records) };
  ...
  protected:
    ...
    shared_ptr<ListRecursionRecordsResponseBody::Records> records_ {};
