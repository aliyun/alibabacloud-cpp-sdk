...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addressLbStrategy_ == nullptr
        ...
        && return this->requestSource_ == nullptr && return this->seqNonPreemptiveSchedule_ == nullptr && return this->sequenceLbStrategyMode_ == nullptr && return this->serialNumber_ == nullptr && return this->updateTime_ == nullptr
        && return this->updateTimestamp_ == nullptr && return this->weightValue_ == nullptr; };
