...
namespace Models
{
  ...
  public:
    ...
    inline const AddGtmAccessStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddGtmAccessStrategyResponseBody) };
    inline AddGtmAccessStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, AddGtmAccessStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddGtmAccessStrategyResponseBody> body_ {};
  };
