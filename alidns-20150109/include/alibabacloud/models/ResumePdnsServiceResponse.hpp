...
namespace Models
{
  ...
  public:
    ...
    inline const ResumePdnsServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResumePdnsServiceResponseBody) };
    inline ResumePdnsServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, ResumePdnsServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResumePdnsServiceResponseBody> body_ {};
  };
