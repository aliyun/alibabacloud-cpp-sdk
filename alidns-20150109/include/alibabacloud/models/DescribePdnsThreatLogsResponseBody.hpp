...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribePdnsThreatLogsResponseBodyLogs> & logs() const { DARABONBA_PTR_GET_CONST(logs_, vector<DescribePdnsThreatLogsResponseBodyLogs>) };
    inline vector<DescribePdnsThreatLogsResponseBodyLogs> logs() { DARABONBA_PTR_GET(logs_, vector<DescribePdnsThreatLogsResponseBodyLogs>) };
    inline DescribePdnsThreatLogsResponseBody& setLogs(const vector<DescribePdnsThreatLogsResponseBodyLogs> & logs) { DARABONBA_PTR_SET_VALUE(logs_, logs) };
    inline DescribePdnsThreatLogsResponseBody& setLogs(vector<DescribePdnsThreatLogsResponseBodyLogs> && logs) { DARABONBA_PTR_SET_RVALUE(logs_, logs) };
  ...
  protected:
    std::shared_ptr<vector<DescribePdnsThreatLogsResponseBodyLogs>> logs_ = nullptr;
