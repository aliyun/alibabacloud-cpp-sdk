...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGtmAvailableAlertGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeGtmAvailableAlertGroupResponseBody) };
    inline DescribeGtmAvailableAlertGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeGtmAvailableAlertGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeGtmAvailableAlertGroupResponseBody> body_ {};
  };
