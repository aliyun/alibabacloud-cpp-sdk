...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addressLbStrategy_ == nullptr
        ...
        && return this->remark_ == nullptr && return this->requestId_ == nullptr && return this->sequenceLbStrategyMode_ == nullptr && return this->updateTime_ == nullptr && return this->updateTimestamp_ == nullptr; };
