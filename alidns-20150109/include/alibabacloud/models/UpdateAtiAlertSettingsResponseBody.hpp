...
#ifndef ALIBABACLOUD_MODELS_UPDATEATIALERTSETTINGSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEATIALERTSETTINGSRESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateAtiAlertSettingsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAtiAlertSettingsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateAtiAlertSettingsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    UpdateAtiAlertSettingsResponseBody() = default ;
    UpdateAtiAlertSettingsResponseBody(const UpdateAtiAlertSettingsResponseBody &) = default ;
    UpdateAtiAlertSettingsResponseBody(UpdateAtiAlertSettingsResponseBody &&) = default ;
    UpdateAtiAlertSettingsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAtiAlertSettingsResponseBody() = default ;
    UpdateAtiAlertSettingsResponseBody& operator=(const UpdateAtiAlertSettingsResponseBody &) = default ;
    UpdateAtiAlertSettingsResponseBody& operator=(UpdateAtiAlertSettingsResponseBody &&) = default ;
    ...
    inline const UpdateAtiAlertSettingsResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, UpdateAtiAlertSettingsResponseBody::AccessDeniedDetail) };
    inline UpdateAtiAlertSettingsResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, UpdateAtiAlertSettingsResponseBody::AccessDeniedDetail) };
    inline UpdateAtiAlertSettingsResponseBody& setAccessDeniedDetail(const UpdateAtiAlertSettingsResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline UpdateAtiAlertSettingsResponseBody& setAccessDeniedDetail(UpdateAtiAlertSettingsResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline UpdateAtiAlertSettingsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline UpdateAtiAlertSettingsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
