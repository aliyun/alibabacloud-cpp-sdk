...
namespace Models
{
  ...
  public:
    ...
    inline const ReplaceCloudGtmInstanceConfigAddressPoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReplaceCloudGtmInstanceConfigAddressPoolResponseBody) };
    inline ReplaceCloudGtmInstanceConfigAddressPoolResponseBody getBody() { DARABONBA_PTR_GET(body_, ReplaceCloudGtmInstanceConfigAddressPoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReplaceCloudGtmInstanceConfigAddressPoolResponseBody> body_ {};
  };
