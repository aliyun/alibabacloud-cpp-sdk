...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDnsGtmInstancesResponseBodyGtmInstances> & gtmInstances() const { DARABONBA_PTR_GET_CONST(gtmInstances_, vector<DescribeDnsGtmInstancesResponseBodyGtmInstances>) };
    inline vector<DescribeDnsGtmInstancesResponseBodyGtmInstances> gtmInstances() { DARABONBA_PTR_GET(gtmInstances_, vector<DescribeDnsGtmInstancesResponseBodyGtmInstances>) };
    inline DescribeDnsGtmInstancesResponseBody& setGtmInstances(const vector<DescribeDnsGtmInstancesResponseBodyGtmInstances> & gtmInstances) { DARABONBA_PTR_SET_VALUE(gtmInstances_, gtmInstances) };
    inline DescribeDnsGtmInstancesResponseBody& setGtmInstances(vector<DescribeDnsGtmInstancesResponseBodyGtmInstances> && gtmInstances) { DARABONBA_PTR_SET_RVALUE(gtmInstances_, gtmInstances) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDnsGtmInstancesResponseBodyGtmInstances>> gtmInstances_ = nullptr;
