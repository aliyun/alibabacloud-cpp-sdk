...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addrCount_ == nullptr
        && return this->addrPoolId_ == nullptr && return this->createTime_ == nullptr && return this->createTimestamp_ == nullptr && return this->lbaStrategy_ == nullptr && return this->monitorConfigId_ == nullptr
        && return this->monitorStatus_ == nullptr && return this->name_ == nullptr && return this->type_ == nullptr && return this->updateTime_ == nullptr && return this->updateTimestamp_ == nullptr; };
