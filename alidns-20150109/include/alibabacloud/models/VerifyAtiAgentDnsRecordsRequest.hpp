...
#ifndef ALIBABACLOUD_MODELS_VERIFYATIAGENTDNSRECORDSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_VERIFYATIAGENTDNSRECORDSREQUEST_HPP_
...
namespace Models
{
  class VerifyAtiAgentDnsRecordsRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const VerifyAtiAgentDnsRecordsRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AgentRegisterInfoId, agentRegisterInfoId_);
      DARABONBA_PTR_TO_JSON(ClientToken, clientToken_);
      DARABONBA_PTR_TO_JSON(TrustLevel, trustLevel_);
    };
    friend void from_json(const Darabonba::Json& j, VerifyAtiAgentDnsRecordsRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AgentRegisterInfoId, agentRegisterInfoId_);
      DARABONBA_PTR_FROM_JSON(ClientToken, clientToken_);
      DARABONBA_PTR_FROM_JSON(TrustLevel, trustLevel_);
    };
    VerifyAtiAgentDnsRecordsRequest() = default ;
    VerifyAtiAgentDnsRecordsRequest(const VerifyAtiAgentDnsRecordsRequest &) = default ;
    VerifyAtiAgentDnsRecordsRequest(VerifyAtiAgentDnsRecordsRequest &&) = default ;
    VerifyAtiAgentDnsRecordsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~VerifyAtiAgentDnsRecordsRequest() = default ;
    VerifyAtiAgentDnsRecordsRequest& operator=(const VerifyAtiAgentDnsRecordsRequest &) = default ;
    VerifyAtiAgentDnsRecordsRequest& operator=(VerifyAtiAgentDnsRecordsRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->agentRegisterInfoId_ == nullptr
        && this->clientToken_ == nullptr && this->trustLevel_ == nullptr; };
    ...
    inline VerifyAtiAgentDnsRecordsRequest& setAgentRegisterInfoId(string agentRegisterInfoId) { DARABONBA_PTR_SET_VALUE(agentRegisterInfoId_, agentRegisterInfoId) };
    ...
    inline VerifyAtiAgentDnsRecordsRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline VerifyAtiAgentDnsRecordsRequest& setTrustLevel(string trustLevel) { DARABONBA_PTR_SET_VALUE(trustLevel_, trustLevel) };
