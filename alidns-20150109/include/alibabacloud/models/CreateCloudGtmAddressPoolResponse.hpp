...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCloudGtmAddressPoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCloudGtmAddressPoolResponseBody) };
    inline CreateCloudGtmAddressPoolResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCloudGtmAddressPoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCloudGtmAddressPoolResponseBody> body_ {};
  };
