...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGtmAccessStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateGtmAccessStrategyResponseBody) };
    inline UpdateGtmAccessStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateGtmAccessStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateGtmAccessStrategyResponseBody> body_ {};
  };
