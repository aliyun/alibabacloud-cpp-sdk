...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRecordLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRecordLogsResponseBody) };
    inline DescribeRecordLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRecordLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRecordLogsResponseBody> body_ {};
  };
