...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline Instance& setExpireTime(int64_t expireTime) { DARABONBA_PTR_SET_VALUE(expireTime_, expireTime) };
        ...
        inline Instance& setExpireTimestamp(string expireTimestamp) { DARABONBA_PTR_SET_VALUE(expireTimestamp_, expireTimestamp) };
    ...
    inline const SearchCloudGtmInstancesResponseBody::Instances & getInstances() const { DARABONBA_PTR_GET_CONST(instances_, SearchCloudGtmInstancesResponseBody::Instances) };
    inline SearchCloudGtmInstancesResponseBody::Instances getInstances() { DARABONBA_PTR_GET(instances_, SearchCloudGtmInstancesResponseBody::Instances) };
    inline SearchCloudGtmInstancesResponseBody& setInstances(const SearchCloudGtmInstancesResponseBody::Instances & instances) { DARABONBA_PTR_SET_VALUE(instances_, instances) };
    inline SearchCloudGtmInstancesResponseBody& setInstances(SearchCloudGtmInstancesResponseBody::Instances && instances) { DARABONBA_PTR_SET_RVALUE(instances_, instances) };
  ...
  protected:
    // The instances.
    shared_ptr<SearchCloudGtmInstancesResponseBody::Instances> instances_ {};
