...
namespace Models
{
  ...
  public:
    ...
    inline const RemovePdnsAppKeyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RemovePdnsAppKeyResponseBody) };
    inline RemovePdnsAppKeyResponseBody body() { DARABONBA_PTR_GET(body_, RemovePdnsAppKeyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RemovePdnsAppKeyResponseBody> body_ = nullptr;
  };
