...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGtmMonitorConfigResponseBody::IspCityNodes & getIspCityNodes() const { DARABONBA_PTR_GET_CONST(ispCityNodes_, DescribeGtmMonitorConfigResponseBody::IspCityNodes) };
    inline DescribeGtmMonitorConfigResponseBody::IspCityNodes getIspCityNodes() { DARABONBA_PTR_GET(ispCityNodes_, DescribeGtmMonitorConfigResponseBody::IspCityNodes) };
    inline DescribeGtmMonitorConfigResponseBody& setIspCityNodes(const DescribeGtmMonitorConfigResponseBody::IspCityNodes & ispCityNodes) { DARABONBA_PTR_SET_VALUE(ispCityNodes_, ispCityNodes) };
    inline DescribeGtmMonitorConfigResponseBody& setIspCityNodes(DescribeGtmMonitorConfigResponseBody::IspCityNodes && ispCityNodes) { DARABONBA_PTR_SET_RVALUE(ispCityNodes_, ispCityNodes) };
