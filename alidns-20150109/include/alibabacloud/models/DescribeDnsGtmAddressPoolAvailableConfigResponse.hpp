...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDnsGtmAddressPoolAvailableConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDnsGtmAddressPoolAvailableConfigResponseBody) };
    inline DescribeDnsGtmAddressPoolAvailableConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDnsGtmAddressPoolAvailableConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDnsGtmAddressPoolAvailableConfigResponseBody> body_ {};
  };
