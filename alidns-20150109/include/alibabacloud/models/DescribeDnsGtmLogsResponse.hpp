...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDnsGtmLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDnsGtmLogsResponseBody) };
    inline DescribeDnsGtmLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDnsGtmLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDnsGtmLogsResponseBody> body_ {};
  };
