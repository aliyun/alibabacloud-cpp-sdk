...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alertConfig_ == nullptr
        && return this->alertGroup_ == nullptr && return this->cnameType_ == nullptr && return this->instanceName_ == nullptr && return this->publicCnameMode_ == nullptr && return this->publicRr_ == nullptr
        && return this->publicUserDomainName_ == nullptr && return this->publicZoneName_ == nullptr && return this->strategyMode_ == nullptr && return this->ttl_ == nullptr; };
