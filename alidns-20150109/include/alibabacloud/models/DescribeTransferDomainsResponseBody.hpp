...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->domainTransfers_ != nullptr
    ...
    inline const DescribeTransferDomainsResponseBodyDomainTransfers & domainTransfers() const { DARABONBA_PTR_GET_CONST(domainTransfers_, DescribeTransferDomainsResponseBodyDomainTransfers) };
    inline DescribeTransferDomainsResponseBodyDomainTransfers domainTransfers() { DARABONBA_PTR_GET(domainTransfers_, DescribeTransferDomainsResponseBodyDomainTransfers) };
    inline DescribeTransferDomainsResponseBody& setDomainTransfers(const DescribeTransferDomainsResponseBodyDomainTransfers & domainTransfers) { DARABONBA_PTR_SET_VALUE(domainTransfers_, domainTransfers) };
    inline DescribeTransferDomainsResponseBody& setDomainTransfers(DescribeTransferDomainsResponseBodyDomainTransfers && domainTransfers) { DARABONBA_PTR_SET_RVALUE(domainTransfers_, domainTransfers) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeTransferDomainsResponseBodyDomainTransfers> domainTransfers_ = nullptr;
