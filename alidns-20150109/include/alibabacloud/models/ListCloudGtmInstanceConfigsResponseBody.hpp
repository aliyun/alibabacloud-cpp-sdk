...
namespace Models
{
  ...
  public:
    ...
    inline const ListCloudGtmInstanceConfigsResponseBody::InstanceConfigs & getInstanceConfigs() const { DARABONBA_PTR_GET_CONST(instanceConfigs_, ListCloudGtmInstanceConfigsResponseBody::InstanceConfigs) };
    inline ListCloudGtmInstanceConfigsResponseBody::InstanceConfigs getInstanceConfigs() { DARABONBA_PTR_GET(instanceConfigs_, ListCloudGtmInstanceConfigsResponseBody::InstanceConfigs) };
    inline ListCloudGtmInstanceConfigsResponseBody& setInstanceConfigs(const ListCloudGtmInstanceConfigsResponseBody::InstanceConfigs & instanceConfigs) { DARABONBA_PTR_SET_VALUE(instanceConfigs_, instanceConfigs) };
    inline ListCloudGtmInstanceConfigsResponseBody& setInstanceConfigs(ListCloudGtmInstanceConfigsResponseBody::InstanceConfigs && instanceConfigs) { DARABONBA_PTR_SET_RVALUE(instanceConfigs_, instanceConfigs) };
  ...
  protected:
    ...
    shared_ptr<ListCloudGtmInstanceConfigsResponseBody::InstanceConfigs> instanceConfigs_ {};
