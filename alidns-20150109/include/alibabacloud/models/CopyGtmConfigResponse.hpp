...
namespace Models
{
  ...
  public:
    ...
    inline const CopyGtmConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CopyGtmConfigResponseBody) };
    inline CopyGtmConfigResponseBody body() { DARABONBA_PTR_GET(body_, CopyGtmConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CopyGtmConfigResponseBody> body_ = nullptr;
  };
