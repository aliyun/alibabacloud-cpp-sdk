...
namespace Models
{
  ...
  public:
    ...
    inline const AddGtmAddressPoolResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddGtmAddressPoolResponseBody) };
    inline AddGtmAddressPoolResponseBody body() { DARABONBA_PTR_GET(body_, AddGtmAddressPoolResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddGtmAddressPoolResponseBody> body_ = nullptr;
  };
