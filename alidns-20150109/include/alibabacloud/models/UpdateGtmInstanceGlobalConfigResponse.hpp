...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGtmInstanceGlobalConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateGtmInstanceGlobalConfigResponseBody) };
    inline UpdateGtmInstanceGlobalConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateGtmInstanceGlobalConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateGtmInstanceGlobalConfigResponseBody> body_ {};
  };
