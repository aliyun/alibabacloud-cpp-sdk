  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->domainName_ == nullptr
        && this->httpCount_ == nullptr && this->httpsCount_ == nullptr && this->ipCount_ == nullptr && this->totalCount_ == nullptr && this->v4HttpCount_ == nullptr
    ...
    inline const vector<DescribeDohDomainStatisticsSummaryResponseBody::Statistics> & getStatistics() const { DARABONBA_PTR_GET_CONST(statistics_, vector<DescribeDohDomainStatisticsSummaryResponseBody::Statistics>) };
    inline vector<DescribeDohDomainStatisticsSummaryResponseBody::Statistics> getStatistics() { DARABONBA_PTR_GET(statistics_, vector<DescribeDohDomainStatisticsSummaryResponseBody::Statistics>) };
    inline DescribeDohDomainStatisticsSummaryResponseBody& setStatistics(const vector<DescribeDohDomainStatisticsSummaryResponseBody::Statistics> & statistics) { DARABONBA_PTR_SET_VALUE(statistics_, statistics) };
    inline DescribeDohDomainStatisticsSummaryResponseBody& setStatistics(vector<DescribeDohDomainStatisticsSummaryResponseBody::Statistics> && statistics) { DARABONBA_PTR_SET_RVALUE(statistics_, statistics) };
