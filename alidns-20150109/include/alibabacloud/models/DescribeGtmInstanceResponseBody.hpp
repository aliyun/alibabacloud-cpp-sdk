...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessStrategyNum_ == nullptr
        ...
        && return this->lbaStrategy_ == nullptr && return this->requestId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->ttl_ == nullptr && return this->userDomainName_ == nullptr
