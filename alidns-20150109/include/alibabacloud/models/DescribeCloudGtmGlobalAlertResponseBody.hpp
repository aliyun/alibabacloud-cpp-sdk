  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline AlertConfigItem& setQpsThreshold(int64_t qpsThreshold) { DARABONBA_PTR_SET_VALUE(qpsThreshold_, qpsThreshold) };
        ...
        inline AlertConfigItem& setThreshold(int32_t threshold) { DARABONBA_PTR_SET_VALUE(threshold_, threshold) };
