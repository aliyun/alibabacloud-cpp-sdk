...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainStatisticsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainStatisticsResponseBody) };
    inline DescribeDomainStatisticsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDomainStatisticsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDomainStatisticsResponseBody> body_ = nullptr;
  };
