...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateCloudGtmMonitorTemplateRequest::IspCityNodes> & getIspCityNodes() const { DARABONBA_PTR_GET_CONST(ispCityNodes_, vector<UpdateCloudGtmMonitorTemplateRequest::IspCityNodes>) };
    inline vector<UpdateCloudGtmMonitorTemplateRequest::IspCityNodes> getIspCityNodes() { DARABONBA_PTR_GET(ispCityNodes_, vector<UpdateCloudGtmMonitorTemplateRequest::IspCityNodes>) };
    inline UpdateCloudGtmMonitorTemplateRequest& setIspCityNodes(const vector<UpdateCloudGtmMonitorTemplateRequest::IspCityNodes> & ispCityNodes) { DARABONBA_PTR_SET_VALUE(ispCityNodes_, ispCityNodes) };
    inline UpdateCloudGtmMonitorTemplateRequest& setIspCityNodes(vector<UpdateCloudGtmMonitorTemplateRequest::IspCityNodes> && ispCityNodes) { DARABONBA_PTR_SET_RVALUE(ispCityNodes_, ispCityNodes) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateCloudGtmMonitorTemplateRequest::IspCityNodes>> ispCityNodes_ {};
