...
#ifndef ALIBABACLOUD_MODELS_UPDATECLOUDGTMMONITORTEMPLATEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATECLOUDGTMMONITORTEMPLATEREQUEST_HPP_
#include <darabonba/Core.hpp>
#include <vector>
#include <alibabacloud/models/UpdateCloudGtmMonitorTemplateRequestIspCityNodes.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateCloudGtmMonitorTemplateRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateCloudGtmMonitorTemplateRequest& obj) { 
    ...
    UpdateCloudGtmMonitorTemplateRequest() = default ;
    UpdateCloudGtmMonitorTemplateRequest(const UpdateCloudGtmMonitorTemplateRequest &) = default ;
    UpdateCloudGtmMonitorTemplateRequest(UpdateCloudGtmMonitorTemplateRequest &&) = default ;
    UpdateCloudGtmMonitorTemplateRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateCloudGtmMonitorTemplateRequest() = default ;
    UpdateCloudGtmMonitorTemplateRequest& operator=(const UpdateCloudGtmMonitorTemplateRequest &) = default ;
    UpdateCloudGtmMonitorTemplateRequest& operator=(UpdateCloudGtmMonitorTemplateRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        ...
        && return this->ispCityNodes_ == nullptr && return this->name_ == nullptr && return this->templateId_ == nullptr && return this->timeout_ == nullptr; };
    // acceptLanguage Field Functions 
    bool hasAcceptLanguage() const { return this->acceptLanguage_ != nullptr;};
    void deleteAcceptLanguage() { this->acceptLanguage_ = nullptr;};
    inline string acceptLanguage() const { DARABONBA_PTR_GET_DEFAULT(acceptLanguage_, "") };
    inline UpdateCloudGtmMonitorTemplateRequest& setAcceptLanguage(string acceptLanguage) { DARABONBA_PTR_SET_VALUE(acceptLanguage_, acceptLanguage) };
    ...
    inline UpdateCloudGtmMonitorTemplateRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline UpdateCloudGtmMonitorTemplateRequest& setEvaluationCount(int32_t evaluationCount) { DARABONBA_PTR_SET_VALUE(evaluationCount_, evaluationCount) };
    ...
    inline UpdateCloudGtmMonitorTemplateRequest& setExtendInfo(string extendInfo) { DARABONBA_PTR_SET_VALUE(extendInfo_, extendInfo) };
    ...
    inline UpdateCloudGtmMonitorTemplateRequest& setFailureRate(int32_t failureRate) { DARABONBA_PTR_SET_VALUE(failureRate_, failureRate) };
    ...
    inline UpdateCloudGtmMonitorTemplateRequest& setInterval(int32_t interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline const vector<UpdateCloudGtmMonitorTemplateRequestIspCityNodes> & ispCityNodes() const { DARABONBA_PTR_GET_CONST(ispCityNodes_, vector<UpdateCloudGtmMonitorTemplateRequestIspCityNodes>) };
    inline vector<UpdateCloudGtmMonitorTemplateRequestIspCityNodes> ispCityNodes() { DARABONBA_PTR_GET(ispCityNodes_, vector<UpdateCloudGtmMonitorTemplateRequestIspCityNodes>) };
    inline UpdateCloudGtmMonitorTemplateRequest& setIspCityNodes(const vector<UpdateCloudGtmMonitorTemplateRequestIspCityNodes> & ispCityNodes) { DARABONBA_PTR_SET_VALUE(ispCityNodes_, ispCityNodes) };
    inline UpdateCloudGtmMonitorTemplateRequest& setIspCityNodes(vector<UpdateCloudGtmMonitorTemplateRequestIspCityNodes> && ispCityNodes) { DARABONBA_PTR_SET_RVALUE(ispCityNodes_, ispCityNodes) };
    ...
    inline UpdateCloudGtmMonitorTemplateRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline UpdateCloudGtmMonitorTemplateRequest& setTemplateId(string templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
    ...
    inline UpdateCloudGtmMonitorTemplateRequest& setTimeout(int32_t timeout) { DARABONBA_PTR_SET_VALUE(timeout_, timeout) };
  ...
  protected:
    ...
    std::shared_ptr<vector<UpdateCloudGtmMonitorTemplateRequestIspCityNodes>> ispCityNodes_ = nullptr;
