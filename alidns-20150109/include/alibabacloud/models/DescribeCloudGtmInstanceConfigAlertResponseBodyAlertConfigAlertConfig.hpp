...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECLOUDGTMINSTANCECONFIGALERTRESPONSEBODYALERTCONFIGALERTCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECLOUDGTMINSTANCECONFIGALERTRESPONSEBODYALERTCONFIGALERTCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig& obj) { 
    ...
    DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig() = default ;
    DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig(const DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig &) = default ;
    DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig(DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig &&) = default ;
    DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig() = default ;
    DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig& operator=(const DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig &) = default ;
    DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig& operator=(DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig &&) = default ;
    ...
    inline DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig& setDingtalkNotice(bool dingtalkNotice) { DARABONBA_PTR_SET_VALUE(dingtalkNotice_, dingtalkNotice) };
    ...
    inline DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig& setEmailNotice(bool emailNotice) { DARABONBA_PTR_SET_VALUE(emailNotice_, emailNotice) };
    ...
    inline DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig& setNoticeType(string noticeType) { DARABONBA_PTR_SET_VALUE(noticeType_, noticeType) };
    ...
    inline DescribeCloudGtmInstanceConfigAlertResponseBodyAlertConfigAlertConfig& setSmsNotice(bool smsNotice) { DARABONBA_PTR_SET_VALUE(smsNotice_, smsNotice) };
