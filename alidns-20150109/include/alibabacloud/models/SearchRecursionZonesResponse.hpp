...
namespace Models
{
  ...
  public:
    ...
    inline const SearchRecursionZonesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchRecursionZonesResponseBody) };
    inline SearchRecursionZonesResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchRecursionZonesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchRecursionZonesResponseBody> body_ {};
  };
