...
#ifndef ALIBABACLOUD_MODELS_REVOKEATIAGENTREGISTERINFORESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_REVOKEATIAGENTREGISTERINFORESPONSEBODY_HPP_
...
namespace Models
{
  class RevokeAtiAgentRegisterInfoResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const RevokeAtiAgentRegisterInfoResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, RevokeAtiAgentRegisterInfoResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    RevokeAtiAgentRegisterInfoResponseBody() = default ;
    RevokeAtiAgentRegisterInfoResponseBody(const RevokeAtiAgentRegisterInfoResponseBody &) = default ;
    RevokeAtiAgentRegisterInfoResponseBody(RevokeAtiAgentRegisterInfoResponseBody &&) = default ;
    RevokeAtiAgentRegisterInfoResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RevokeAtiAgentRegisterInfoResponseBody() = default ;
    RevokeAtiAgentRegisterInfoResponseBody& operator=(const RevokeAtiAgentRegisterInfoResponseBody &) = default ;
    RevokeAtiAgentRegisterInfoResponseBody& operator=(RevokeAtiAgentRegisterInfoResponseBody &&) = default ;
    ...
    inline const RevokeAtiAgentRegisterInfoResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, RevokeAtiAgentRegisterInfoResponseBody::AccessDeniedDetail) };
    inline RevokeAtiAgentRegisterInfoResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, RevokeAtiAgentRegisterInfoResponseBody::AccessDeniedDetail) };
    inline RevokeAtiAgentRegisterInfoResponseBody& setAccessDeniedDetail(const RevokeAtiAgentRegisterInfoResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline RevokeAtiAgentRegisterInfoResponseBody& setAccessDeniedDetail(RevokeAtiAgentRegisterInfoResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline RevokeAtiAgentRegisterInfoResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline RevokeAtiAgentRegisterInfoResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The details about the access denial. This field is returned only when RAM authentication fails.
    shared_ptr<RevokeAtiAgentRegisterInfoResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
