...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRecursionZoneResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteRecursionZoneResponseBody) };
    inline DeleteRecursionZoneResponseBody body() { DARABONBA_PTR_GET(body_, DeleteRecursionZoneResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteRecursionZoneResponseBody> body_ = nullptr;
  };
