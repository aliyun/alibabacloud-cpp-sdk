...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceptLanguage_ == nullptr
        && return this->address_ == nullptr && return this->addressId_ == nullptr && return this->availableStatus_ == nullptr && return this->enableStatus_ == nullptr && return this->healthStatus_ == nullptr
        && return this->monitorTemplateName_ == nullptr && return this->nameSearchCondition_ == nullptr && return this->names_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr
        && return this->remarkSearchCondition_ == nullptr && return this->remarks_ == nullptr && return this->type_ == nullptr; };
    ...
    inline string monitorTemplateName() const { DARABONBA_PTR_GET_DEFAULT(monitorTemplateName_, "") };
    ...
    inline string nameSearchCondition() const { DARABONBA_PTR_GET_DEFAULT(nameSearchCondition_, "") };
    ...
    inline string remarkSearchCondition() const { DARABONBA_PTR_GET_DEFAULT(remarkSearchCondition_, "") };
    ...
    inline const vector<string> & remarks() const { DARABONBA_PTR_GET_CONST(remarks_, vector<string>) };
    inline vector<string> remarks() { DARABONBA_PTR_GET(remarks_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<string> monitorTemplateName_ = nullptr;
    ...
    std::shared_ptr<string> nameSearchCondition_ = nullptr;
    ...
    // 
    // or: displays the results that match some or all search conditions.
    std::shared_ptr<string> remarkSearchCondition_ = nullptr;
    // Remarks for the address.
    std::shared_ptr<vector<string>> remarks_ = nullptr;
