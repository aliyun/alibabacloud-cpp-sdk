...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSupportLinesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSupportLinesResponseBody) };
    inline DescribeSupportLinesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSupportLinesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSupportLinesResponseBody> body_ {};
  };
