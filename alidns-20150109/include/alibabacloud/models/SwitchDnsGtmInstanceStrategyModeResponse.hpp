...
namespace Models
{
  ...
  public:
    ...
    inline const SwitchDnsGtmInstanceStrategyModeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SwitchDnsGtmInstanceStrategyModeResponseBody) };
    inline SwitchDnsGtmInstanceStrategyModeResponseBody getBody() { DARABONBA_PTR_GET(body_, SwitchDnsGtmInstanceStrategyModeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SwitchDnsGtmInstanceStrategyModeResponseBody> body_ {};
  };
