...
namespace Models
{
  ...
  public:
    ...
    inline const SearchCloudGtmAddressesResponseBody::Addresses & getAddresses() const { DARABONBA_PTR_GET_CONST(addresses_, SearchCloudGtmAddressesResponseBody::Addresses) };
    inline SearchCloudGtmAddressesResponseBody::Addresses getAddresses() { DARABONBA_PTR_GET(addresses_, SearchCloudGtmAddressesResponseBody::Addresses) };
    inline SearchCloudGtmAddressesResponseBody& setAddresses(const SearchCloudGtmAddressesResponseBody::Addresses & addresses) { DARABONBA_PTR_SET_VALUE(addresses_, addresses) };
    inline SearchCloudGtmAddressesResponseBody& setAddresses(SearchCloudGtmAddressesResponseBody::Addresses && addresses) { DARABONBA_PTR_SET_RVALUE(addresses_, addresses) };
