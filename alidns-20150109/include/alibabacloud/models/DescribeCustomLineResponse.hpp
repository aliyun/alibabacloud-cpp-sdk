...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomLineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCustomLineResponseBody) };
    inline DescribeCustomLineResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCustomLineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCustomLineResponseBody> body_ {};
  };
