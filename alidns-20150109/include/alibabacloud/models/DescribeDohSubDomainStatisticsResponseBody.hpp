...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDohSubDomainStatisticsResponseBody::Statistics> & getStatistics() const { DARABONBA_PTR_GET_CONST(statistics_, vector<DescribeDohSubDomainStatisticsResponseBody::Statistics>) };
    inline vector<DescribeDohSubDomainStatisticsResponseBody::Statistics> getStatistics() { DARABONBA_PTR_GET(statistics_, vector<DescribeDohSubDomainStatisticsResponseBody::Statistics>) };
    inline DescribeDohSubDomainStatisticsResponseBody& setStatistics(const vector<DescribeDohSubDomainStatisticsResponseBody::Statistics> & statistics) { DARABONBA_PTR_SET_VALUE(statistics_, statistics) };
    inline DescribeDohSubDomainStatisticsResponseBody& setStatistics(vector<DescribeDohSubDomainStatisticsResponseBody::Statistics> && statistics) { DARABONBA_PTR_SET_RVALUE(statistics_, statistics) };
  ...
  protected:
    ...
    // The statistics list.
    shared_ptr<vector<DescribeDohSubDomainStatisticsResponseBody::Statistics>> statistics_ {};
  };
