...
namespace Models
{
  ...
  public:
    ...
    inline const ListRecursionZonesResponseBody::Zones & getZones() const { DARABONBA_PTR_GET_CONST(zones_, ListRecursionZonesResponseBody::Zones) };
    inline ListRecursionZonesResponseBody::Zones getZones() { DARABONBA_PTR_GET(zones_, ListRecursionZonesResponseBody::Zones) };
    inline ListRecursionZonesResponseBody& setZones(const ListRecursionZonesResponseBody::Zones & zones) { DARABONBA_PTR_SET_VALUE(zones_, zones) };
    inline ListRecursionZonesResponseBody& setZones(ListRecursionZonesResponseBody::Zones && zones) { DARABONBA_PTR_SET_RVALUE(zones_, zones) };
