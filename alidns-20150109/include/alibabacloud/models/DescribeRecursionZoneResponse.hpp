...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRecursionZoneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRecursionZoneResponseBody) };
    inline DescribeRecursionZoneResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRecursionZoneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRecursionZoneResponseBody> body_ {};
  };
