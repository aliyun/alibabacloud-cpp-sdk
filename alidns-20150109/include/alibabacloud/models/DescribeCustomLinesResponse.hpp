...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomLinesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeCustomLinesResponseBody) };
    inline DescribeCustomLinesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeCustomLinesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCustomLinesResponseBody> body_ = nullptr;
  };
