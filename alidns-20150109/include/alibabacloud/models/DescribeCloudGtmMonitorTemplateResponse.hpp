...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudGtmMonitorTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudGtmMonitorTemplateResponseBody) };
    inline DescribeCloudGtmMonitorTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCloudGtmMonitorTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudGtmMonitorTemplateResponseBody> body_ {};
  };
