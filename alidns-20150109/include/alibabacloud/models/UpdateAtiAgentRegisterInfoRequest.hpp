...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentDescription_ == nullptr
        ...
        && this->clientToken_ == nullptr && this->domainMode_ == nullptr && this->endpoints_ == nullptr && this->registrantId_ == nullptr; };
    ...
    inline UpdateAtiAgentRegisterInfoRequest& setAgentSubHost(string agentSubHost) { DARABONBA_PTR_SET_VALUE(agentSubHost_, agentSubHost) };
    ...
    inline UpdateAtiAgentRegisterInfoRequest& setDomainMode(string domainMode) { DARABONBA_PTR_SET_VALUE(domainMode_, domainMode) };
