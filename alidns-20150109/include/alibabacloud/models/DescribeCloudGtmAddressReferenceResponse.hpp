...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudGtmAddressReferenceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudGtmAddressReferenceResponseBody) };
    inline DescribeCloudGtmAddressReferenceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCloudGtmAddressReferenceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudGtmAddressReferenceResponseBody> body_ {};
  };
