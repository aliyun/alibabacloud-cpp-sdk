...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->type_ == nullptr && this->updateTime_ == nullptr && this->updateTimestamp_ == nullptr && this->weightValue_ == nullptr; };
            ...
            inline Address& setRequestSource(string requestSource) { DARABONBA_PTR_SET_VALUE(requestSource_, requestSource) };
    ...
    inline const SearchCloudGtmAddressPoolsResponseBody::AddressPools & getAddressPools() const { DARABONBA_PTR_GET_CONST(addressPools_, SearchCloudGtmAddressPoolsResponseBody::AddressPools) };
    inline SearchCloudGtmAddressPoolsResponseBody::AddressPools getAddressPools() { DARABONBA_PTR_GET(addressPools_, SearchCloudGtmAddressPoolsResponseBody::AddressPools) };
    inline SearchCloudGtmAddressPoolsResponseBody& setAddressPools(const SearchCloudGtmAddressPoolsResponseBody::AddressPools & addressPools) { DARABONBA_PTR_SET_VALUE(addressPools_, addressPools) };
    inline SearchCloudGtmAddressPoolsResponseBody& setAddressPools(SearchCloudGtmAddressPoolsResponseBody::AddressPools && addressPools) { DARABONBA_PTR_SET_RVALUE(addressPools_, addressPools) };
  ...
  protected:
    // The address pools.
    shared_ptr<SearchCloudGtmAddressPoolsResponseBody::AddressPools> addressPools_ {};
