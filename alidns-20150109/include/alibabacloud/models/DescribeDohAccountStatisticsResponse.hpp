...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDohAccountStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDohAccountStatisticsResponseBody) };
    inline DescribeDohAccountStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDohAccountStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDohAccountStatisticsResponseBody> body_ {};
  };
