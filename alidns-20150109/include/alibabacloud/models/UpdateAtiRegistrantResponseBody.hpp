...
#ifndef ALIBABACLOUD_MODELS_UPDATEATIREGISTRANTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEATIREGISTRANTRESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateAtiRegistrantResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAtiRegistrantResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateAtiRegistrantResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    UpdateAtiRegistrantResponseBody() = default ;
    UpdateAtiRegistrantResponseBody(const UpdateAtiRegistrantResponseBody &) = default ;
    UpdateAtiRegistrantResponseBody(UpdateAtiRegistrantResponseBody &&) = default ;
    UpdateAtiRegistrantResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAtiRegistrantResponseBody() = default ;
    UpdateAtiRegistrantResponseBody& operator=(const UpdateAtiRegistrantResponseBody &) = default ;
    UpdateAtiRegistrantResponseBody& operator=(UpdateAtiRegistrantResponseBody &&) = default ;
    ...
    inline const UpdateAtiRegistrantResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, UpdateAtiRegistrantResponseBody::AccessDeniedDetail) };
    inline UpdateAtiRegistrantResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, UpdateAtiRegistrantResponseBody::AccessDeniedDetail) };
    inline UpdateAtiRegistrantResponseBody& setAccessDeniedDetail(const UpdateAtiRegistrantResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline UpdateAtiRegistrantResponseBody& setAccessDeniedDetail(UpdateAtiRegistrantResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline UpdateAtiRegistrantResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline UpdateAtiRegistrantResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
