...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSubDomainRecordsResponseBody::DomainRecords & getDomainRecords() const { DARABONBA_PTR_GET_CONST(domainRecords_, DescribeSubDomainRecordsResponseBody::DomainRecords) };
    inline DescribeSubDomainRecordsResponseBody::DomainRecords getDomainRecords() { DARABONBA_PTR_GET(domainRecords_, DescribeSubDomainRecordsResponseBody::DomainRecords) };
    inline DescribeSubDomainRecordsResponseBody& setDomainRecords(const DescribeSubDomainRecordsResponseBody::DomainRecords & domainRecords) { DARABONBA_PTR_SET_VALUE(domainRecords_, domainRecords) };
    inline DescribeSubDomainRecordsResponseBody& setDomainRecords(DescribeSubDomainRecordsResponseBody::DomainRecords && domainRecords) { DARABONBA_PTR_SET_RVALUE(domainRecords_, domainRecords) };
