...
namespace Models
{
  ...
  public:
    ...
    inline const AddRecursionZoneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddRecursionZoneResponseBody) };
    inline AddRecursionZoneResponseBody getBody() { DARABONBA_PTR_GET(body_, AddRecursionZoneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddRecursionZoneResponseBody> body_ {};
  };
