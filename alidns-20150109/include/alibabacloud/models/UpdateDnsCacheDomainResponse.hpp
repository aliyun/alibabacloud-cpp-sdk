...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDnsCacheDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDnsCacheDomainResponseBody) };
    inline UpdateDnsCacheDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDnsCacheDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDnsCacheDomainResponseBody> body_ {};
  };
