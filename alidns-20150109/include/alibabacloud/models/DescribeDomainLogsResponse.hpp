...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainLogsResponseBody) };
    inline DescribeDomainLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainLogsResponseBody> body_ {};
  };
