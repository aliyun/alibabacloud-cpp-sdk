...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEGTMMONITORCONFIGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEGTMMONITORCONFIGREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeGtmMonitorConfigRequest& obj) { 
      DARABONBA_PTR_TO_JSON(Lang, lang_);
      DARABONBA_PTR_TO_JSON(MonitorConfigId, monitorConfigId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeGtmMonitorConfigRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(Lang, lang_);
      DARABONBA_PTR_FROM_JSON(MonitorConfigId, monitorConfigId_);
    };
    DescribeGtmMonitorConfigRequest() = default ;
    DescribeGtmMonitorConfigRequest(const DescribeGtmMonitorConfigRequest &) = default ;
    DescribeGtmMonitorConfigRequest(DescribeGtmMonitorConfigRequest &&) = default ;
    DescribeGtmMonitorConfigRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeGtmMonitorConfigRequest() = default ;
    DescribeGtmMonitorConfigRequest& operator=(const DescribeGtmMonitorConfigRequest &) = default ;
    DescribeGtmMonitorConfigRequest& operator=(DescribeGtmMonitorConfigRequest &&) = default ;
