...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ip_ == nullptr
        && this->ipToken_ == nullptr && this->lang_ == nullptr && this->name_ == nullptr; };
    // ip Field Functions 
    ...
    inline string getIpToken() const { DARABONBA_PTR_GET_DEFAULT(ipToken_, "") };
