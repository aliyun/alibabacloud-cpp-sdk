...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDnsCacheDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDnsCacheDomainResponseBody) };
    inline DeleteDnsCacheDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDnsCacheDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDnsCacheDomainResponseBody> body_ {};
  };
