...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGtmInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeGtmInstancesResponseBody) };
    inline DescribeGtmInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeGtmInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeGtmInstancesResponseBody> body_ {};
  };
