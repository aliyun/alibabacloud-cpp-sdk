...
#ifndef ALIBABACLOUD_MODELS_DELETEATIAGENTREGISTERINFORESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DELETEATIAGENTREGISTERINFORESPONSEBODY_HPP_
...
namespace Models
{
  class DeleteAtiAgentRegisterInfoResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DeleteAtiAgentRegisterInfoResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteAtiAgentRegisterInfoResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    DeleteAtiAgentRegisterInfoResponseBody() = default ;
    DeleteAtiAgentRegisterInfoResponseBody(const DeleteAtiAgentRegisterInfoResponseBody &) = default ;
    DeleteAtiAgentRegisterInfoResponseBody(DeleteAtiAgentRegisterInfoResponseBody &&) = default ;
    DeleteAtiAgentRegisterInfoResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteAtiAgentRegisterInfoResponseBody() = default ;
    DeleteAtiAgentRegisterInfoResponseBody& operator=(const DeleteAtiAgentRegisterInfoResponseBody &) = default ;
    DeleteAtiAgentRegisterInfoResponseBody& operator=(DeleteAtiAgentRegisterInfoResponseBody &&) = default ;
    ...
    inline const DeleteAtiAgentRegisterInfoResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DeleteAtiAgentRegisterInfoResponseBody::AccessDeniedDetail) };
    inline DeleteAtiAgentRegisterInfoResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DeleteAtiAgentRegisterInfoResponseBody::AccessDeniedDetail) };
    inline DeleteAtiAgentRegisterInfoResponseBody& setAccessDeniedDetail(const DeleteAtiAgentRegisterInfoResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DeleteAtiAgentRegisterInfoResponseBody& setAccessDeniedDetail(DeleteAtiAgentRegisterInfoResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline DeleteAtiAgentRegisterInfoResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DeleteAtiAgentRegisterInfoResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
