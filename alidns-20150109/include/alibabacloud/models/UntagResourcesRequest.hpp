...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->all_ == nullptr
        && return this->lang_ == nullptr && return this->resourceId_ == nullptr && return this->resourceType_ == nullptr && return this->tagKey_ == nullptr; };
    // all Field Functions 
    ...
    inline UntagResourcesRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
