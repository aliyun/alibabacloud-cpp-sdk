...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDohDomainStatisticsResponseBody::Statistics> & getStatistics() const { DARABONBA_PTR_GET_CONST(statistics_, vector<DescribeDohDomainStatisticsResponseBody::Statistics>) };
    inline vector<DescribeDohDomainStatisticsResponseBody::Statistics> getStatistics() { DARABONBA_PTR_GET(statistics_, vector<DescribeDohDomainStatisticsResponseBody::Statistics>) };
    inline DescribeDohDomainStatisticsResponseBody& setStatistics(const vector<DescribeDohDomainStatisticsResponseBody::Statistics> & statistics) { DARABONBA_PTR_SET_VALUE(statistics_, statistics) };
    inline DescribeDohDomainStatisticsResponseBody& setStatistics(vector<DescribeDohDomainStatisticsResponseBody::Statistics> && statistics) { DARABONBA_PTR_SET_RVALUE(statistics_, statistics) };
