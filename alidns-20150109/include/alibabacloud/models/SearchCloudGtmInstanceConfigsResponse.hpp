...
namespace Models
{
  ...
  public:
    ...
    inline const SearchCloudGtmInstanceConfigsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SearchCloudGtmInstanceConfigsResponseBody) };
    inline SearchCloudGtmInstanceConfigsResponseBody body() { DARABONBA_PTR_GET(body_, SearchCloudGtmInstanceConfigsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SearchCloudGtmInstanceConfigsResponseBody> body_ = nullptr;
  };
