...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateDnsGtmCnameRrCanUseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ValidateDnsGtmCnameRrCanUseResponseBody) };
    inline ValidateDnsGtmCnameRrCanUseResponseBody getBody() { DARABONBA_PTR_GET(body_, ValidateDnsGtmCnameRrCanUseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ValidateDnsGtmCnameRrCanUseResponseBody> body_ {};
  };
