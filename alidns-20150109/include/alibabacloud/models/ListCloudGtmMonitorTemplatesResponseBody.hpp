...
namespace Models
{
  ...
  public:
    ...
    inline const ListCloudGtmMonitorTemplatesResponseBody::Templates & getTemplates() const { DARABONBA_PTR_GET_CONST(templates_, ListCloudGtmMonitorTemplatesResponseBody::Templates) };
    inline ListCloudGtmMonitorTemplatesResponseBody::Templates getTemplates() { DARABONBA_PTR_GET(templates_, ListCloudGtmMonitorTemplatesResponseBody::Templates) };
    inline ListCloudGtmMonitorTemplatesResponseBody& setTemplates(const ListCloudGtmMonitorTemplatesResponseBody::Templates & templates) { DARABONBA_PTR_SET_VALUE(templates_, templates) };
    inline ListCloudGtmMonitorTemplatesResponseBody& setTemplates(ListCloudGtmMonitorTemplatesResponseBody::Templates && templates) { DARABONBA_PTR_SET_RVALUE(templates_, templates) };
