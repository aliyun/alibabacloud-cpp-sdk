...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCloudGtmInstanceConfigLbStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateCloudGtmInstanceConfigLbStrategyResponseBody) };
    inline UpdateCloudGtmInstanceConfigLbStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateCloudGtmInstanceConfigLbStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateCloudGtmInstanceConfigLbStrategyResponseBody> body_ {};
  };
