...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeDomainGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChangeDomainGroupResponseBody) };
    inline ChangeDomainGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ChangeDomainGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ChangeDomainGroupResponseBody> body_ {};
  };
