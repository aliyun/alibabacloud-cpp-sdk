...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addressPoolLbStrategy_ == nullptr
        && return this->addressPools_ == nullptr && return this->availableStatus_ == nullptr && return this->commodityCode_ == nullptr && return this->configId_ == nullptr && return this->createTime_ == nullptr
        && return this->createTimestamp_ == nullptr && return this->enableStatus_ == nullptr && return this->healthStatus_ == nullptr && return this->instanceId_ == nullptr && return this->remark_ == nullptr
        && return this->scheduleDomainName_ == nullptr && return this->scheduleHostname_ == nullptr && return this->scheduleRrType_ == nullptr && return this->scheduleZoneMode_ == nullptr && return this->scheduleZoneName_ == nullptr
        && return this->sequenceLbStrategyMode_ == nullptr && return this->ttl_ == nullptr && return this->updateTime_ == nullptr && return this->updateTimestamp_ == nullptr && return this->versionCode_ == nullptr; };
