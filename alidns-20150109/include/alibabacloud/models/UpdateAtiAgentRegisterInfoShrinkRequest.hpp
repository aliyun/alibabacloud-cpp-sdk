...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentDescription_ == nullptr
        && this->agentDisplayName_ == nullptr && this->agentHost_ == nullptr && this->agentRegisterInfoId_ == nullptr && this->agentSubHost_ == nullptr && this->agentVersion_ == nullptr
        && this->clientToken_ == nullptr && this->domainMode_ == nullptr && this->endpointsShrink_ == nullptr && this->registrantId_ == nullptr; };
    ...
    inline UpdateAtiAgentRegisterInfoShrinkRequest& setAgentSubHost(string agentSubHost) { DARABONBA_PTR_SET_VALUE(agentSubHost_, agentSubHost) };
    ...
    inline UpdateAtiAgentRegisterInfoShrinkRequest& setDomainMode(string domainMode) { DARABONBA_PTR_SET_VALUE(domainMode_, domainMode) };
