...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIspFlushCacheInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeIspFlushCacheInstancesResponseBody) };
    inline DescribeIspFlushCacheInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeIspFlushCacheInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeIspFlushCacheInstancesResponseBody> body_ {};
  };
