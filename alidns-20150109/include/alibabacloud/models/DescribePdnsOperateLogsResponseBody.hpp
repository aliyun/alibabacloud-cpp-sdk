...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribePdnsOperateLogsResponseBodyLogs> & logs() const { DARABONBA_PTR_GET_CONST(logs_, vector<DescribePdnsOperateLogsResponseBodyLogs>) };
    inline vector<DescribePdnsOperateLogsResponseBodyLogs> logs() { DARABONBA_PTR_GET(logs_, vector<DescribePdnsOperateLogsResponseBodyLogs>) };
    inline DescribePdnsOperateLogsResponseBody& setLogs(const vector<DescribePdnsOperateLogsResponseBodyLogs> & logs) { DARABONBA_PTR_SET_VALUE(logs_, logs) };
    inline DescribePdnsOperateLogsResponseBody& setLogs(vector<DescribePdnsOperateLogsResponseBodyLogs> && logs) { DARABONBA_PTR_SET_RVALUE(logs_, logs) };
  ...
  protected:
    std::shared_ptr<vector<DescribePdnsOperateLogsResponseBodyLogs>> logs_ = nullptr;
