...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRecursionZoneRemarkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateRecursionZoneRemarkResponseBody) };
    inline UpdateRecursionZoneRemarkResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateRecursionZoneRemarkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateRecursionZoneRemarkResponseBody> body_ {};
  };
