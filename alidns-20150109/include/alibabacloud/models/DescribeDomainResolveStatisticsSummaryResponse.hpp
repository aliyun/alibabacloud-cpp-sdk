...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainResolveStatisticsSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainResolveStatisticsSummaryResponseBody) };
    inline DescribeDomainResolveStatisticsSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainResolveStatisticsSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainResolveStatisticsSummaryResponseBody> body_ {};
  };
