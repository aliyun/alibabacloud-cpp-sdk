...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDnsCacheDomainRemarkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDnsCacheDomainRemarkResponseBody) };
    inline UpdateDnsCacheDomainRemarkResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDnsCacheDomainRemarkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDnsCacheDomainRemarkResponseBody> body_ {};
  };
