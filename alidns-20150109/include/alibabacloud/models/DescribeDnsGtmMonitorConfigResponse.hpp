...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDnsGtmMonitorConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDnsGtmMonitorConfigResponseBody) };
    inline DescribeDnsGtmMonitorConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDnsGtmMonitorConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDnsGtmMonitorConfigResponseBody> body_ {};
  };
