...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribePdnsUdpIpSegmentsResponseBodyIpSegments> & ipSegments() const { DARABONBA_PTR_GET_CONST(ipSegments_, vector<DescribePdnsUdpIpSegmentsResponseBodyIpSegments>) };
    inline vector<DescribePdnsUdpIpSegmentsResponseBodyIpSegments> ipSegments() { DARABONBA_PTR_GET(ipSegments_, vector<DescribePdnsUdpIpSegmentsResponseBodyIpSegments>) };
    inline DescribePdnsUdpIpSegmentsResponseBody& setIpSegments(const vector<DescribePdnsUdpIpSegmentsResponseBodyIpSegments> & ipSegments) { DARABONBA_PTR_SET_VALUE(ipSegments_, ipSegments) };
    inline DescribePdnsUdpIpSegmentsResponseBody& setIpSegments(vector<DescribePdnsUdpIpSegmentsResponseBodyIpSegments> && ipSegments) { DARABONBA_PTR_SET_RVALUE(ipSegments_, ipSegments) };
  ...
  protected:
    std::shared_ptr<vector<DescribePdnsUdpIpSegmentsResponseBodyIpSegments>> ipSegments_ = nullptr;
