...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGtmMonitorAvailableConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeGtmMonitorAvailableConfigResponseBody) };
    inline DescribeGtmMonitorAvailableConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeGtmMonitorAvailableConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeGtmMonitorAvailableConfigResponseBody> body_ {};
  };
