...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGtmRecoveryPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteGtmRecoveryPlanResponseBody) };
    inline DeleteGtmRecoveryPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteGtmRecoveryPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteGtmRecoveryPlanResponseBody> body_ {};
  };
