...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRecursionRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateRecursionRecordResponseBody) };
    inline UpdateRecursionRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateRecursionRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateRecursionRecordResponseBody> body_ {};
  };
