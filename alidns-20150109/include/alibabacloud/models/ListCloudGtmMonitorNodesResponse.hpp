...
namespace Models
{
  ...
  public:
    ...
    inline const ListCloudGtmMonitorNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCloudGtmMonitorNodesResponseBody) };
    inline ListCloudGtmMonitorNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCloudGtmMonitorNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCloudGtmMonitorNodesResponseBody> body_ {};
  };
