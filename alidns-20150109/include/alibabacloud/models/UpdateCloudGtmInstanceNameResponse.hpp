...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCloudGtmInstanceNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateCloudGtmInstanceNameResponseBody) };
    inline UpdateCloudGtmInstanceNameResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateCloudGtmInstanceNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateCloudGtmInstanceNameResponseBody> body_ {};
  };
