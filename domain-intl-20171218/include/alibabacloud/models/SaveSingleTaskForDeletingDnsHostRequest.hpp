...
namespace Models
{
  ...
  public:
    ...
    inline SaveSingleTaskForDeletingDnsHostRequest& setIp(const vector<string> & ip) { DARABONBA_PTR_SET_VALUE(ip_, ip) };
    inline SaveSingleTaskForDeletingDnsHostRequest& setIp(vector<string> && ip) { DARABONBA_PTR_SET_RVALUE(ip_, ip) };
