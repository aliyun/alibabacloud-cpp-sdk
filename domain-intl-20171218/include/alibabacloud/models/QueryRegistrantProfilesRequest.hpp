...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->defaultRegistrantProfile_ == nullptr
        ...
        && this->registrantOrganization_ == nullptr && this->registrantProfileId_ == nullptr && this->registrantProfileType_ == nullptr && this->registrantType_ == nullptr && this->userClientIp_ == nullptr; };
