...
namespace Models
{
  ...
  public:
    ...
    class OrderActivateParam : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const OrderActivateParam& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, OrderActivateParam& obj) { 
      ...
      OrderActivateParam() = default ;
      OrderActivateParam(const OrderActivateParam &) = default ;
      OrderActivateParam(OrderActivateParam &&) = default ;
      OrderActivateParam(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~OrderActivateParam() = default ;
      OrderActivateParam& operator=(const OrderActivateParam &) = default ;
      OrderActivateParam& operator=(OrderActivateParam &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline OrderActivateParam& setAddress(string address) { DARABONBA_PTR_SET_VALUE(address_, address) };
      ...
      inline OrderActivateParam& setAliyunDns(bool aliyunDns) { DARABONBA_PTR_SET_VALUE(aliyunDns_, aliyunDns) };
      ...
      inline OrderActivateParam& setCity(string city) { DARABONBA_PTR_SET_VALUE(city_, city) };
      ...
      inline OrderActivateParam& setCountry(string country) { DARABONBA_PTR_SET_VALUE(country_, country) };
      ...
      inline OrderActivateParam& setDns1(string dns1) { DARABONBA_PTR_SET_VALUE(dns1_, dns1) };
      ...
      inline OrderActivateParam& setDns2(string dns2) { DARABONBA_PTR_SET_VALUE(dns2_, dns2) };
      ...
      inline OrderActivateParam& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };
      ...
      inline OrderActivateParam& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
      ...
      inline OrderActivateParam& setPermitPremiumActivation(bool permitPremiumActivation) { DARABONBA_PTR_SET_VALUE(permitPremiumActivation_, permitPremiumActivation) };
      ...
      inline OrderActivateParam& setPostalCode(string postalCode) { DARABONBA_PTR_SET_VALUE(postalCode_, postalCode) };
      ...
      inline OrderActivateParam& setProvince(string province) { DARABONBA_PTR_SET_VALUE(province_, province) };
      ...
      inline OrderActivateParam& setRegistrantName(string registrantName) { DARABONBA_PTR_SET_VALUE(registrantName_, registrantName) };
      ...
      inline OrderActivateParam& setRegistrantOrganization(string registrantOrganization) { DARABONBA_PTR_SET_VALUE(registrantOrganization_, registrantOrganization) };
      ...
      inline OrderActivateParam& setRegistrantProfileId(int64_t registrantProfileId) { DARABONBA_PTR_SET_VALUE(registrantProfileId_, registrantProfileId) };
      ...
      inline OrderActivateParam& setRegistrantType(string registrantType) { DARABONBA_PTR_SET_VALUE(registrantType_, registrantType) };
      ...
      inline OrderActivateParam& setSubscriptionDuration(int32_t subscriptionDuration) { DARABONBA_PTR_SET_VALUE(subscriptionDuration_, subscriptionDuration) };
      ...
      inline OrderActivateParam& setTelArea(string telArea) { DARABONBA_PTR_SET_VALUE(telArea_, telArea) };
      ...
      inline OrderActivateParam& setTelExt(string telExt) { DARABONBA_PTR_SET_VALUE(telExt_, telExt) };
      ...
      inline OrderActivateParam& setTelephone(string telephone) { DARABONBA_PTR_SET_VALUE(telephone_, telephone) };
      ...
      inline OrderActivateParam& setTrademarkDomainActivation(bool trademarkDomainActivation) { DARABONBA_PTR_SET_VALUE(trademarkDomainActivation_, trademarkDomainActivation) };
    ...
    virtual bool empty() const override { return this->couponNo_ == nullptr
        && this->lang_ == nullptr && this->orderActivateParam_ == nullptr && this->promotionNo_ == nullptr && this->useCoupon_ == nullptr && this->usePromotion_ == nullptr
    ...
    inline const vector<SaveBatchTaskForCreatingOrderActivateRequest::OrderActivateParam> & getOrderActivateParam() const { DARABONBA_PTR_GET_CONST(orderActivateParam_, vector<SaveBatchTaskForCreatingOrderActivateRequest::OrderActivateParam>) };
    inline vector<SaveBatchTaskForCreatingOrderActivateRequest::OrderActivateParam> getOrderActivateParam() { DARABONBA_PTR_GET(orderActivateParam_, vector<SaveBatchTaskForCreatingOrderActivateRequest::OrderActivateParam>) };
    inline SaveBatchTaskForCreatingOrderActivateRequest& setOrderActivateParam(const vector<SaveBatchTaskForCreatingOrderActivateRequest::OrderActivateParam> & orderActivateParam) { DARABONBA_PTR_SET_VALUE(orderActivateParam_, orderActivateParam) };
    inline SaveBatchTaskForCreatingOrderActivateRequest& setOrderActivateParam(vector<SaveBatchTaskForCreatingOrderActivateRequest::OrderActivateParam> && orderActivateParam) { DARABONBA_PTR_SET_RVALUE(orderActivateParam_, orderActivateParam) };
