...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTransferOutInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryTransferOutInfoResponseBody) };
    inline QueryTransferOutInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryTransferOutInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryTransferOutInfoResponseBody> body_ {};
  };
