...
namespace Models
{
  ...
  public:
    ...
    inline const SaveBatchTaskForCreatingOrderRedeemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveBatchTaskForCreatingOrderRedeemResponseBody) };
    inline SaveBatchTaskForCreatingOrderRedeemResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveBatchTaskForCreatingOrderRedeemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveBatchTaskForCreatingOrderRedeemResponseBody> body_ {};
  };
