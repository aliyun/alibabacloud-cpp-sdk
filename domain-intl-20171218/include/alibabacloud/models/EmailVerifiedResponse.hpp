...
namespace Models
{
  ...
  public:
    ...
    inline const EmailVerifiedResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EmailVerifiedResponseBody) };
    inline EmailVerifiedResponseBody getBody() { DARABONBA_PTR_GET(body_, EmailVerifiedResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EmailVerifiedResponseBody> body_ {};
  };
