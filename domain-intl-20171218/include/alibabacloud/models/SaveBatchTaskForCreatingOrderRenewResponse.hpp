...
namespace Models
{
  ...
  public:
    ...
    inline const SaveBatchTaskForCreatingOrderRenewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveBatchTaskForCreatingOrderRenewResponseBody) };
    inline SaveBatchTaskForCreatingOrderRenewResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveBatchTaskForCreatingOrderRenewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveBatchTaskForCreatingOrderRenewResponseBody> body_ {};
  };
