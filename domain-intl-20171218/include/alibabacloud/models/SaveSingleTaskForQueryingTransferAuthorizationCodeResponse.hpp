...
namespace Models
{
  ...
  public:
    ...
    inline const SaveSingleTaskForQueryingTransferAuthorizationCodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveSingleTaskForQueryingTransferAuthorizationCodeResponseBody) };
    inline SaveSingleTaskForQueryingTransferAuthorizationCodeResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveSingleTaskForQueryingTransferAuthorizationCodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveSingleTaskForQueryingTransferAuthorizationCodeResponseBody> body_ {};
  };
