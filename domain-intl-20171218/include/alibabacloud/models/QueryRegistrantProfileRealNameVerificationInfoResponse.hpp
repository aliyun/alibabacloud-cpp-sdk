...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRegistrantProfileRealNameVerificationInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryRegistrantProfileRealNameVerificationInfoResponseBody) };
    inline QueryRegistrantProfileRealNameVerificationInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryRegistrantProfileRealNameVerificationInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryRegistrantProfileRealNameVerificationInfoResponseBody> body_ {};
  };
