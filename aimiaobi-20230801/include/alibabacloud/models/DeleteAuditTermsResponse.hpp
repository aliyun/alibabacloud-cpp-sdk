...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAuditTermsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAuditTermsResponseBody) };
    inline DeleteAuditTermsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAuditTermsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAuditTermsResponseBody> body_ {};
  };
