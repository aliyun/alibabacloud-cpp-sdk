...
namespace Models
{
  ...
  public:
    ...
    inline const GetAuditNoteProcessingStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAuditNoteProcessingStatusResponseBodyData) };
    inline GetAuditNoteProcessingStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAuditNoteProcessingStatusResponseBodyData) };
    inline GetAuditNoteProcessingStatusResponseBody& setData(const GetAuditNoteProcessingStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAuditNoteProcessingStatusResponseBody& setData(GetAuditNoteProcessingStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAuditNoteProcessingStatusResponseBodyData> data_ = nullptr;
