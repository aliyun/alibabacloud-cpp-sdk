...
namespace Models
{
  ...
  public:
    ...
    inline const GetInterveneGlobalReplyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInterveneGlobalReplyResponseBody) };
    inline GetInterveneGlobalReplyResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInterveneGlobalReplyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInterveneGlobalReplyResponseBody> body_ {};
  };
