...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAuditContentErrorTypesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAuditContentErrorTypesResponseBodyData>) };
    inline vector<ListAuditContentErrorTypesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAuditContentErrorTypesResponseBodyData>) };
    inline ListAuditContentErrorTypesResponseBody& setData(const vector<ListAuditContentErrorTypesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAuditContentErrorTypesResponseBody& setData(vector<ListAuditContentErrorTypesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAuditContentErrorTypesResponseBodyData>> data_ = nullptr;
