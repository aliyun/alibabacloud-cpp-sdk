...
namespace Models
{
  ...
  public:
    ...
    inline const RunSummaryGenerateResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunSummaryGenerateResponseBody::Header) };
    inline RunSummaryGenerateResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunSummaryGenerateResponseBody::Header) };
    inline RunSummaryGenerateResponseBody& setHeader(const RunSummaryGenerateResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunSummaryGenerateResponseBody& setHeader(RunSummaryGenerateResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunSummaryGenerateResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunSummaryGenerateResponseBody::Payload) };
    inline RunSummaryGenerateResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunSummaryGenerateResponseBody::Payload) };
    inline RunSummaryGenerateResponseBody& setPayload(const RunSummaryGenerateResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunSummaryGenerateResponseBody& setPayload(RunSummaryGenerateResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
