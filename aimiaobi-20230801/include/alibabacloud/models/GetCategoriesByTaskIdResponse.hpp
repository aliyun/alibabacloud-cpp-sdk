...
namespace Models
{
  ...
  public:
    ...
    inline const GetCategoriesByTaskIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCategoriesByTaskIdResponseBody) };
    inline GetCategoriesByTaskIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCategoriesByTaskIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCategoriesByTaskIdResponseBody> body_ {};
  };
