...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->externalUserId_ == nullptr
        && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->query_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline ListPptArtifactsRequest& setExternalUserId(string externalUserId) { DARABONBA_PTR_SET_VALUE(externalUserId_, externalUserId) };
