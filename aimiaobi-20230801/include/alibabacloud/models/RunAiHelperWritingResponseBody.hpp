  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline Output& setWritingParams(const map<string, string> & writingParams) { DARABONBA_PTR_SET_VALUE(writingParams_, writingParams) };
        inline Output& setWritingParams(map<string, string> && writingParams) { DARABONBA_PTR_SET_RVALUE(writingParams_, writingParams) };
    ...
    inline const RunAiHelperWritingResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunAiHelperWritingResponseBody::Header) };
    inline RunAiHelperWritingResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunAiHelperWritingResponseBody::Header) };
    inline RunAiHelperWritingResponseBody& setHeader(const RunAiHelperWritingResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunAiHelperWritingResponseBody& setHeader(RunAiHelperWritingResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };
    ...
    inline const RunAiHelperWritingResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunAiHelperWritingResponseBody::Payload) };
    inline RunAiHelperWritingResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunAiHelperWritingResponseBody::Payload) };
    inline RunAiHelperWritingResponseBody& setPayload(const RunAiHelperWritingResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunAiHelperWritingResponseBody& setPayload(RunAiHelperWritingResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
