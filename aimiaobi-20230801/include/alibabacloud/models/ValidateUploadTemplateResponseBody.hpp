...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateUploadTemplateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ValidateUploadTemplateResponseBodyData) };
    inline ValidateUploadTemplateResponseBodyData data() { DARABONBA_PTR_GET(data_, ValidateUploadTemplateResponseBodyData) };
    inline ValidateUploadTemplateResponseBody& setData(const ValidateUploadTemplateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ValidateUploadTemplateResponseBody& setData(ValidateUploadTemplateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ValidateUploadTemplateResponseBodyData> data_ = nullptr;
