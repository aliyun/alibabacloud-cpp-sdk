...
namespace Models
{
  ...
  public:
    ...
    inline const ListAnalysisTagDetailByTaskIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAnalysisTagDetailByTaskIdResponseBody) };
    inline ListAnalysisTagDetailByTaskIdResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAnalysisTagDetailByTaskIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAnalysisTagDetailByTaskIdResponseBody> body_ {};
  };
