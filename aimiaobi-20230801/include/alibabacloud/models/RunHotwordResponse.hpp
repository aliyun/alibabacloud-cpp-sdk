...
namespace Models
{
  ...
  public:
    ...
    inline RunHotwordResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunHotwordResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunHotwordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunHotwordResponseBody) };
    inline RunHotwordResponseBody getBody() { DARABONBA_PTR_GET(body_, RunHotwordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunHotwordResponseBody> body_ {};
  };
