...
namespace Models
{
  ...
  public:
    ...
    inline const GetPropertiesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPropertiesResponseBodyData) };
    inline GetPropertiesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPropertiesResponseBodyData) };
    inline GetPropertiesResponseBody& setData(const GetPropertiesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPropertiesResponseBody& setData(GetPropertiesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetPropertiesResponseBodyData> data_ = nullptr;
