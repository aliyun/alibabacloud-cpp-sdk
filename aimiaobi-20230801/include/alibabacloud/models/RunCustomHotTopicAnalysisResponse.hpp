...
namespace Models
{
  ...
  public:
    ...
    inline RunCustomHotTopicAnalysisResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunCustomHotTopicAnalysisResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunCustomHotTopicAnalysisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunCustomHotTopicAnalysisResponseBody) };
    inline RunCustomHotTopicAnalysisResponseBody getBody() { DARABONBA_PTR_GET(body_, RunCustomHotTopicAnalysisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunCustomHotTopicAnalysisResponseBody> body_ {};
  };
