...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListGeneratedContentsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListGeneratedContentsResponseBodyData>) };
    inline vector<ListGeneratedContentsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListGeneratedContentsResponseBodyData>) };
    inline ListGeneratedContentsResponseBody& setData(const vector<ListGeneratedContentsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGeneratedContentsResponseBody& setData(vector<ListGeneratedContentsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListGeneratedContentsResponseBodyData>> data_ = nullptr;
