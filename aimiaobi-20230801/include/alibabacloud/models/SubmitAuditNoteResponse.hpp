...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitAuditNoteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitAuditNoteResponseBody) };
    inline SubmitAuditNoteResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitAuditNoteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitAuditNoteResponseBody> body_ {};
  };
