...
namespace Models
{
  ...
  public:
    ...
    inline const RunDocTranslationResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunDocTranslationResponseBody::Header) };
    inline RunDocTranslationResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunDocTranslationResponseBody::Header) };
    inline RunDocTranslationResponseBody& setHeader(const RunDocTranslationResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunDocTranslationResponseBody& setHeader(RunDocTranslationResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunDocTranslationResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunDocTranslationResponseBody::Payload) };
    inline RunDocTranslationResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunDocTranslationResponseBody::Payload) };
    inline RunDocTranslationResponseBody& setPayload(const RunDocTranslationResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunDocTranslationResponseBody& setPayload(RunDocTranslationResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
