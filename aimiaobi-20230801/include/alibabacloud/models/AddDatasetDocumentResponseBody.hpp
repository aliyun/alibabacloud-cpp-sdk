...
namespace Models
{
  ...
  public:
    ...
    inline const AddDatasetDocumentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddDatasetDocumentResponseBodyData) };
    inline AddDatasetDocumentResponseBodyData data() { DARABONBA_PTR_GET(data_, AddDatasetDocumentResponseBodyData) };
    inline AddDatasetDocumentResponseBody& setData(const AddDatasetDocumentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddDatasetDocumentResponseBody& setData(AddDatasetDocumentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<AddDatasetDocumentResponseBodyData> data_ = nullptr;
