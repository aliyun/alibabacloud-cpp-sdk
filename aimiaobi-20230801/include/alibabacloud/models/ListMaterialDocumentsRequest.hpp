...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentKey_ == nullptr
        ...
        && this->docTypeList_ == nullptr && this->generatePublicUrl_ == nullptr && this->id_ == nullptr && this->keywords_ == nullptr && this->query_ == nullptr
    ...
    inline const vector<string> & getDocTypeList() const { DARABONBA_PTR_GET_CONST(docTypeList_, vector<string>) };
    inline vector<string> getDocTypeList() { DARABONBA_PTR_GET(docTypeList_, vector<string>) };
