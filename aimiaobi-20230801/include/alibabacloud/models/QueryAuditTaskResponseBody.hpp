...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAuditTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryAuditTaskResponseBodyData) };
    inline QueryAuditTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryAuditTaskResponseBodyData) };
    inline QueryAuditTaskResponseBody& setData(const QueryAuditTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAuditTaskResponseBody& setData(QueryAuditTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryAuditTaskResponseBodyData> data_ = nullptr;
