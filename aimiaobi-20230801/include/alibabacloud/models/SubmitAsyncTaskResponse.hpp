...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitAsyncTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitAsyncTaskResponseBody) };
    inline SubmitAsyncTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitAsyncTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitAsyncTaskResponseBody> body_ {};
  };
