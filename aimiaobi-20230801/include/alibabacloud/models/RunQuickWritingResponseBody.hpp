...
#ifndef ALIBABACLOUD_MODELS_RUNQUICKWRITINGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_RUNQUICKWRITINGRESPONSEBODY_HPP_
...
namespace Models
{
  class RunQuickWritingResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const RunQuickWritingResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(End, end_);
      DARABONBA_PTR_TO_JSON(Header, header_);
      DARABONBA_PTR_TO_JSON(Payload, payload_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, RunQuickWritingResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(End, end_);
      DARABONBA_PTR_FROM_JSON(Header, header_);
      DARABONBA_PTR_FROM_JSON(Payload, payload_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    RunQuickWritingResponseBody() = default ;
    RunQuickWritingResponseBody(const RunQuickWritingResponseBody &) = default ;
    RunQuickWritingResponseBody(RunQuickWritingResponseBody &&) = default ;
    RunQuickWritingResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RunQuickWritingResponseBody() = default ;
    RunQuickWritingResponseBody& operator=(const RunQuickWritingResponseBody &) = default ;
    RunQuickWritingResponseBody& operator=(RunQuickWritingResponseBody &&) = default ;
    ...
    inline RunQuickWritingResponseBody& setEnd(bool end) { DARABONBA_PTR_SET_VALUE(end_, end) };


    // header Field Functions 
    bool hasHeader() const { return this->header_ != nullptr;};
    void deleteHeader() { this->header_ = nullptr;};
    inline const RunQuickWritingResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunQuickWritingResponseBody::Header) };
    inline RunQuickWritingResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunQuickWritingResponseBody::Header) };
    inline RunQuickWritingResponseBody& setHeader(const RunQuickWritingResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunQuickWritingResponseBody& setHeader(RunQuickWritingResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunQuickWritingResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunQuickWritingResponseBody::Payload) };
    inline RunQuickWritingResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunQuickWritingResponseBody::Payload) };
    inline RunQuickWritingResponseBody& setPayload(const RunQuickWritingResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunQuickWritingResponseBody& setPayload(RunQuickWritingResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
    ...
    inline RunQuickWritingResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<bool> end_ {};
    shared_ptr<RunQuickWritingResponseBody::Header> header_ {};
    shared_ptr<RunQuickWritingResponseBody::Payload> payload_ {};
