...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dialogueTypesShrink_ == nullptr
        && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->workspaceId_ == nullptr; };
