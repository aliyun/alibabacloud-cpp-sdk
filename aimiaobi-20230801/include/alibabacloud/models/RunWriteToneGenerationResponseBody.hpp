...
#ifndef ALIBABACLOUD_MODELS_RUNWRITETONEGENERATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_RUNWRITETONEGENERATIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RunWriteToneGenerationResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Header, header_);
      DARABONBA_PTR_TO_JSON(Payload, payload_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, RunWriteToneGenerationResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Header, header_);
      DARABONBA_PTR_FROM_JSON(Payload, payload_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    RunWriteToneGenerationResponseBody() = default ;
    RunWriteToneGenerationResponseBody(const RunWriteToneGenerationResponseBody &) = default ;
    RunWriteToneGenerationResponseBody(RunWriteToneGenerationResponseBody &&) = default ;
    RunWriteToneGenerationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RunWriteToneGenerationResponseBody() = default ;
    RunWriteToneGenerationResponseBody& operator=(const RunWriteToneGenerationResponseBody &) = default ;
    RunWriteToneGenerationResponseBody& operator=(RunWriteToneGenerationResponseBody &&) = default ;
    ...
    inline const RunWriteToneGenerationResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunWriteToneGenerationResponseBody::Header) };
    inline RunWriteToneGenerationResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunWriteToneGenerationResponseBody::Header) };
    inline RunWriteToneGenerationResponseBody& setHeader(const RunWriteToneGenerationResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunWriteToneGenerationResponseBody& setHeader(RunWriteToneGenerationResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunWriteToneGenerationResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunWriteToneGenerationResponseBody::Payload) };
    inline RunWriteToneGenerationResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunWriteToneGenerationResponseBody::Payload) };
    inline RunWriteToneGenerationResponseBody& setPayload(const RunWriteToneGenerationResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunWriteToneGenerationResponseBody& setPayload(RunWriteToneGenerationResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
    ...
    inline RunWriteToneGenerationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<RunWriteToneGenerationResponseBody::Header> header_ {};
    shared_ptr<RunWriteToneGenerationResponseBody::Payload> payload_ {};
