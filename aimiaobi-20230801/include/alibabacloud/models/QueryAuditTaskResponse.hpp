...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAuditTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryAuditTaskResponseBody) };
    inline QueryAuditTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryAuditTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryAuditTaskResponseBody> body_ {};
  };
