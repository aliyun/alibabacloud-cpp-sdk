...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateImageTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GenerateImageTaskResponseBodyData) };
    inline GenerateImageTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GenerateImageTaskResponseBodyData) };
    inline GenerateImageTaskResponseBody& setData(const GenerateImageTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GenerateImageTaskResponseBody& setData(GenerateImageTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GenerateImageTaskResponseBodyData> data_ = nullptr;
