...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDocsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListDocsResponseBodyData>) };
    inline vector<ListDocsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListDocsResponseBodyData>) };
    inline ListDocsResponseBody& setData(const vector<ListDocsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDocsResponseBody& setData(vector<ListDocsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDocsResponseBodyData>> data_ = nullptr;
