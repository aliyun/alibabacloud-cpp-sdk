...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDatasetDocumentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateDatasetDocumentResponseBodyData) };
    inline UpdateDatasetDocumentResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateDatasetDocumentResponseBodyData) };
    inline UpdateDatasetDocumentResponseBody& setData(const UpdateDatasetDocumentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateDatasetDocumentResponseBody& setData(UpdateDatasetDocumentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateDatasetDocumentResponseBodyData> data_ = nullptr;
