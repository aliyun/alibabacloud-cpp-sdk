...
namespace Models
{
  ...
  public:
    ...
    inline const RunContinueContentResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunContinueContentResponseBody::Header) };
    inline RunContinueContentResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunContinueContentResponseBody::Header) };
    inline RunContinueContentResponseBody& setHeader(const RunContinueContentResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunContinueContentResponseBody& setHeader(RunContinueContentResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunContinueContentResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunContinueContentResponseBody::Payload) };
    inline RunContinueContentResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunContinueContentResponseBody::Payload) };
    inline RunContinueContentResponseBody& setPayload(const RunContinueContentResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunContinueContentResponseBody& setPayload(RunContinueContentResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    // Is output complete? True indicates completion.
    shared_ptr<bool> end_ {};
    // Streaming output header, contains general return information.
    shared_ptr<RunContinueContentResponseBody::Header> header_ {};
    // Payload of the returned result, JSON structure.
    shared_ptr<RunContinueContentResponseBody::Payload> payload_ {};
    // Unique request ID.
