...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAuditTermsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAuditTermsResponseBodyData>) };
    inline vector<ListAuditTermsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAuditTermsResponseBodyData>) };
    inline ListAuditTermsResponseBody& setData(const vector<ListAuditTermsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAuditTermsResponseBody& setData(vector<ListAuditTermsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAuditTermsResponseBodyData>> data_ = nullptr;
