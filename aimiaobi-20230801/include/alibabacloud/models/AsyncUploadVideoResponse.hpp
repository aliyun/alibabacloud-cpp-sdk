...
namespace Models
{
  ...
  public:
    ...
    inline const AsyncUploadVideoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AsyncUploadVideoResponseBody) };
    inline AsyncUploadVideoResponseBody body() { DARABONBA_PTR_GET(body_, AsyncUploadVideoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AsyncUploadVideoResponseBody> body_ = nullptr;
  };
