...
namespace Models
{
  ...
  public:
    ...
    inline const ExportCustomSourceAnalysisTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExportCustomSourceAnalysisTaskResponseBody) };
    inline ExportCustomSourceAnalysisTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ExportCustomSourceAnalysisTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExportCustomSourceAnalysisTaskResponseBody> body_ {};
  };
