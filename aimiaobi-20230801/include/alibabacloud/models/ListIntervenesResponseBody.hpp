...
namespace Models
{
  ...
  public:
    ...
    inline const ListIntervenesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListIntervenesResponseBodyData) };
    inline ListIntervenesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListIntervenesResponseBodyData) };
    inline ListIntervenesResponseBody& setData(const ListIntervenesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIntervenesResponseBody& setData(ListIntervenesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListIntervenesResponseBodyData> data_ = nullptr;
