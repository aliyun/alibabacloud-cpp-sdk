...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSearchTasksResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListSearchTasksResponseBodyData>) };
    inline vector<ListSearchTasksResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListSearchTasksResponseBodyData>) };
    inline ListSearchTasksResponseBody& setData(const vector<ListSearchTasksResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSearchTasksResponseBody& setData(vector<ListSearchTasksResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListSearchTasksResponseBodyData>> data_ = nullptr;
