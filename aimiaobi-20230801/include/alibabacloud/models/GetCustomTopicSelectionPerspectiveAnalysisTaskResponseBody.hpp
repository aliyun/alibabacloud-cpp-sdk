...
namespace Models
{
  ...
  public:
    ...
    inline const GetCustomTopicSelectionPerspectiveAnalysisTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCustomTopicSelectionPerspectiveAnalysisTaskResponseBodyData) };
    inline GetCustomTopicSelectionPerspectiveAnalysisTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCustomTopicSelectionPerspectiveAnalysisTaskResponseBodyData) };
    inline GetCustomTopicSelectionPerspectiveAnalysisTaskResponseBody& setData(const GetCustomTopicSelectionPerspectiveAnalysisTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCustomTopicSelectionPerspectiveAnalysisTaskResponseBody& setData(GetCustomTopicSelectionPerspectiveAnalysisTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetCustomTopicSelectionPerspectiveAnalysisTaskResponseBodyData> data_ = nullptr;
