...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->data_ == nullptr && return this->dataV1_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr
    ...
    inline const AddAuditTermsResponseBodyDataV1 & dataV1() const { DARABONBA_PTR_GET_CONST(dataV1_, AddAuditTermsResponseBodyDataV1) };
    inline AddAuditTermsResponseBodyDataV1 dataV1() { DARABONBA_PTR_GET(dataV1_, AddAuditTermsResponseBodyDataV1) };
    inline AddAuditTermsResponseBody& setDataV1(const AddAuditTermsResponseBodyDataV1 & dataV1) { DARABONBA_PTR_SET_VALUE(dataV1_, dataV1) };
    inline AddAuditTermsResponseBody& setDataV1(AddAuditTermsResponseBodyDataV1 && dataV1) { DARABONBA_PTR_SET_RVALUE(dataV1_, dataV1) };
  ...
  protected:
    ...
    std::shared_ptr<AddAuditTermsResponseBodyDataV1> dataV1_ = nullptr;
