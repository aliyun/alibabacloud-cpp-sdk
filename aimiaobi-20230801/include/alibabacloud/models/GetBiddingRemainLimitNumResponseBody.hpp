...
namespace Models
{
  ...
  public:
    ...
    inline const GetBiddingRemainLimitNumResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetBiddingRemainLimitNumResponseBodyData) };
    inline GetBiddingRemainLimitNumResponseBodyData data() { DARABONBA_PTR_GET(data_, GetBiddingRemainLimitNumResponseBodyData) };
    inline GetBiddingRemainLimitNumResponseBody& setData(const GetBiddingRemainLimitNumResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetBiddingRemainLimitNumResponseBody& setData(GetBiddingRemainLimitNumResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetBiddingRemainLimitNumResponseBodyData> data_ = nullptr;
