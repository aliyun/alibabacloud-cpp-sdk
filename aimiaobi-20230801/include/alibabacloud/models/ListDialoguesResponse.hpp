...
namespace Models
{
  ...
  public:
    ...
    inline const ListDialoguesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDialoguesResponseBody) };
    inline ListDialoguesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDialoguesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDialoguesResponseBody> body_ {};
  };
