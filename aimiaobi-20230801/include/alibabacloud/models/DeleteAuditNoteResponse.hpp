...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAuditNoteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAuditNoteResponseBody) };
    inline DeleteAuditNoteResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAuditNoteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAuditNoteResponseBody> body_ {};
  };
