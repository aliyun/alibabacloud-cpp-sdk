...
namespace Models
{
  ...
  public:
    ...
    inline RunDocIntroductionResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunDocIntroductionResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunDocIntroductionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunDocIntroductionResponseBody) };
    inline RunDocIntroductionResponseBody getBody() { DARABONBA_PTR_GET(body_, RunDocIntroductionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunDocIntroductionResponseBody> body_ {};
  };
