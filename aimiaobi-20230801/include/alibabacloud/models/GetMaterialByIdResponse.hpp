...
namespace Models
{
  ...
  public:
    ...
    inline const GetMaterialByIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMaterialByIdResponseBody) };
    inline GetMaterialByIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMaterialByIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMaterialByIdResponseBody> body_ {};
  };
