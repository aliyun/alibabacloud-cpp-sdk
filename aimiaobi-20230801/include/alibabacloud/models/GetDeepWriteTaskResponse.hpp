...
namespace Models
{
  ...
  public:
    ...
    inline const GetDeepWriteTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDeepWriteTaskResponseBody) };
    inline GetDeepWriteTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDeepWriteTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDeepWriteTaskResponseBody> body_ {};
  };
