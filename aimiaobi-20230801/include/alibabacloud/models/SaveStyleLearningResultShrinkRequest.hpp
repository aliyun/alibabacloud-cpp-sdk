...
namespace Models
{
  ...
  public:
    ...
    inline string getCustomTextIdListShrink() const { DARABONBA_PTR_GET_DEFAULT(customTextIdListShrink_, "") };
    ...
    inline string getMaterialIdListShrink() const { DARABONBA_PTR_GET_DEFAULT(materialIdListShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> customTextIdListShrink_ {};
    shared_ptr<string> materialIdListShrink_ {};
