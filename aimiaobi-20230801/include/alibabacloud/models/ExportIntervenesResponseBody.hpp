...
namespace Models
{
  ...
  public:
    ...
    inline const ExportIntervenesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ExportIntervenesResponseBody::Data) };
    inline ExportIntervenesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ExportIntervenesResponseBody::Data) };
    inline ExportIntervenesResponseBody& setData(const ExportIntervenesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ExportIntervenesResponseBody& setData(ExportIntervenesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
