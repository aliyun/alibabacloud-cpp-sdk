...
namespace Models
{
  ...
  public:
    ...
    inline const RunKeywordsExtractionGenerationResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunKeywordsExtractionGenerationResponseBody::Header) };
    inline RunKeywordsExtractionGenerationResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunKeywordsExtractionGenerationResponseBody::Header) };
    inline RunKeywordsExtractionGenerationResponseBody& setHeader(const RunKeywordsExtractionGenerationResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunKeywordsExtractionGenerationResponseBody& setHeader(RunKeywordsExtractionGenerationResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunKeywordsExtractionGenerationResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunKeywordsExtractionGenerationResponseBody::Payload) };
    inline RunKeywordsExtractionGenerationResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunKeywordsExtractionGenerationResponseBody::Payload) };
    inline RunKeywordsExtractionGenerationResponseBody& setPayload(const RunKeywordsExtractionGenerationResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunKeywordsExtractionGenerationResponseBody& setPayload(RunKeywordsExtractionGenerationResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
