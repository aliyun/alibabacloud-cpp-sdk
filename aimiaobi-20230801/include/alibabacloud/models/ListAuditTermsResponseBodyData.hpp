...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->exceptionWord_ == nullptr
        && return this->id_ == nullptr && return this->keyword_ == nullptr && return this->suggestWord_ == nullptr && return this->termsDesc_ == nullptr && return this->termsName_ == nullptr; };
    ...
    inline ListAuditTermsResponseBodyData& setTermsName(string termsName) { DARABONBA_PTR_SET_VALUE(termsName_, termsName) };
