...
namespace Models
{
  ...
  public:
    ...
    inline const FetchImageTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FetchImageTaskResponseBody) };
    inline FetchImageTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, FetchImageTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FetchImageTaskResponseBody> body_ {};
  };
