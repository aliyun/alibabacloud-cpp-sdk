...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDocInfoResponseBodyData) };
    inline GetDocInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDocInfoResponseBodyData) };
    inline GetDocInfoResponseBody& setData(const GetDocInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDocInfoResponseBody& setData(GetDocInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDocInfoResponseBodyData> data_ = nullptr;
