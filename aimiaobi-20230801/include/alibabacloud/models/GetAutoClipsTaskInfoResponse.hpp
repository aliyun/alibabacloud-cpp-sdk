...
namespace Models
{
  ...
  public:
    ...
    inline const GetAutoClipsTaskInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAutoClipsTaskInfoResponseBody) };
    inline GetAutoClipsTaskInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAutoClipsTaskInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAutoClipsTaskInfoResponseBody> body_ {};
  };
