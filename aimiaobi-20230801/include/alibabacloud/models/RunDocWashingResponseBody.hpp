...
namespace Models
{
  ...
  public:
    ...
    inline const RunDocWashingResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunDocWashingResponseBody::Header) };
    inline RunDocWashingResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunDocWashingResponseBody::Header) };
    inline RunDocWashingResponseBody& setHeader(const RunDocWashingResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunDocWashingResponseBody& setHeader(RunDocWashingResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunDocWashingResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunDocWashingResponseBody::Payload) };
    inline RunDocWashingResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunDocWashingResponseBody::Payload) };
    inline RunDocWashingResponseBody& setPayload(const RunDocWashingResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunDocWashingResponseBody& setPayload(RunDocWashingResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
