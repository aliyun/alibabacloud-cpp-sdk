  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->alert_ == nullptr
        && this->appKey_ == nullptr && this->exportTaskId_ == nullptr && this->pptArtifactCover_ == nullptr && this->pptArtifactId_ == nullptr && this->pptProcessId_ == nullptr
      ...
      inline string getAlert() const { DARABONBA_PTR_GET_DEFAULT(alert_, "") };
      inline Data& setAlert(string alert) { DARABONBA_PTR_SET_VALUE(alert_, alert) };
