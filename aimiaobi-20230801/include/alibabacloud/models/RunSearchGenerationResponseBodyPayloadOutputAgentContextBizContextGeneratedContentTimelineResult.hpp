...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->generateFinished_ == nullptr
        && return this->generateTraceability_ == nullptr && return this->multimodalSearchResultList_ == nullptr && return this->reasonTextGenerate_ == nullptr && return this->referenceList_ == nullptr && return this->textGenerate_ == nullptr
        && return this->textGenerateMultimodalMediaList_ == nullptr; };
