...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListBuildConfigsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListBuildConfigsResponseBodyData>) };
    inline vector<ListBuildConfigsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListBuildConfigsResponseBodyData>) };
    inline ListBuildConfigsResponseBody& setData(const vector<ListBuildConfigsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListBuildConfigsResponseBody& setData(vector<ListBuildConfigsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListBuildConfigsResponseBodyData>> data_ = nullptr;
