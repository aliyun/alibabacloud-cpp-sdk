...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteStyleLearningResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteStyleLearningResultResponseBody) };
    inline DeleteStyleLearningResultResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteStyleLearningResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteStyleLearningResultResponseBody> body_ {};
  };
