...
namespace Models
{
  ...
  public:
    ...
    inline const AsyncUploadVideoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AsyncUploadVideoResponseBodyData) };
    inline AsyncUploadVideoResponseBodyData data() { DARABONBA_PTR_GET(data_, AsyncUploadVideoResponseBodyData) };
    inline AsyncUploadVideoResponseBody& setData(const AsyncUploadVideoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AsyncUploadVideoResponseBody& setData(AsyncUploadVideoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<AsyncUploadVideoResponseBodyData> data_ = nullptr;
