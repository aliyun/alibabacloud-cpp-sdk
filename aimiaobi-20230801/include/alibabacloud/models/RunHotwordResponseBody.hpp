...
namespace Models
{
  ...
  public:
    ...
    inline const RunHotwordResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunHotwordResponseBody::Header) };
    inline RunHotwordResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunHotwordResponseBody::Header) };
    inline RunHotwordResponseBody& setHeader(const RunHotwordResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunHotwordResponseBody& setHeader(RunHotwordResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunHotwordResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunHotwordResponseBody::Payload) };
    inline RunHotwordResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunHotwordResponseBody::Payload) };
    inline RunHotwordResponseBody& setPayload(const RunHotwordResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunHotwordResponseBody& setPayload(RunHotwordResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    shared_ptr<RunHotwordResponseBody::Header> header_ {};
    shared_ptr<RunHotwordResponseBody::Payload> payload_ {};
    // Id of the request
