...
namespace Models
{
  ...
  public:
    ...
    inline const RunGenerateQuestionsResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunGenerateQuestionsResponseBody::Header) };
    inline RunGenerateQuestionsResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunGenerateQuestionsResponseBody::Header) };
    inline RunGenerateQuestionsResponseBody& setHeader(const RunGenerateQuestionsResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunGenerateQuestionsResponseBody& setHeader(RunGenerateQuestionsResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunGenerateQuestionsResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunGenerateQuestionsResponseBody::Payload) };
    inline RunGenerateQuestionsResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunGenerateQuestionsResponseBody::Payload) };
    inline RunGenerateQuestionsResponseBody& setPayload(const RunGenerateQuestionsResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunGenerateQuestionsResponseBody& setPayload(RunGenerateQuestionsResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    shared_ptr<RunGenerateQuestionsResponseBody::Header> header_ {};
    shared_ptr<RunGenerateQuestionsResponseBody::Payload> payload_ {};
    // Id of the request
