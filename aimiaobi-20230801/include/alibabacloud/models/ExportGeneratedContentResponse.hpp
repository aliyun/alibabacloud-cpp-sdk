...
namespace Models
{
  ...
  public:
    ...
    inline const ExportGeneratedContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExportGeneratedContentResponseBody) };
    inline ExportGeneratedContentResponseBody getBody() { DARABONBA_PTR_GET(body_, ExportGeneratedContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExportGeneratedContentResponseBody> body_ {};
  };
