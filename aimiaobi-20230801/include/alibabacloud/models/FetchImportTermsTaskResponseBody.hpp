...
namespace Models
{
  ...
  public:
    ...
    inline const FetchImportTermsTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, FetchImportTermsTaskResponseBody::Data) };
    inline FetchImportTermsTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, FetchImportTermsTaskResponseBody::Data) };
    inline FetchImportTermsTaskResponseBody& setData(const FetchImportTermsTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline FetchImportTermsTaskResponseBody& setData(FetchImportTermsTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<FetchImportTermsTaskResponseBody::Data> data_ {};
