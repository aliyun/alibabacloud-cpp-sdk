...
namespace Models
{
  ...
  public:
    ...
    inline const GetGeneratedContentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetGeneratedContentResponseBodyData) };
    inline GetGeneratedContentResponseBodyData data() { DARABONBA_PTR_GET(data_, GetGeneratedContentResponseBodyData) };
    inline GetGeneratedContentResponseBody& setData(const GetGeneratedContentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetGeneratedContentResponseBody& setData(GetGeneratedContentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetGeneratedContentResponseBodyData> data_ = nullptr;
