...
namespace Models
{
  ...
  public:
    ...
    inline const RunAbbreviationContentResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunAbbreviationContentResponseBody::Header) };
    inline RunAbbreviationContentResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunAbbreviationContentResponseBody::Header) };
    inline RunAbbreviationContentResponseBody& setHeader(const RunAbbreviationContentResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunAbbreviationContentResponseBody& setHeader(RunAbbreviationContentResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunAbbreviationContentResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunAbbreviationContentResponseBody::Payload) };
    inline RunAbbreviationContentResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunAbbreviationContentResponseBody::Payload) };
    inline RunAbbreviationContentResponseBody& setPayload(const RunAbbreviationContentResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunAbbreviationContentResponseBody& setPayload(RunAbbreviationContentResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    ...
    shared_ptr<RunAbbreviationContentResponseBody::Header> header_ {};
    shared_ptr<RunAbbreviationContentResponseBody::Payload> payload_ {};
