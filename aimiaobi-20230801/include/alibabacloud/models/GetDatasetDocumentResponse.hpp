...
namespace Models
{
  ...
  public:
    ...
    inline const GetDatasetDocumentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDatasetDocumentResponseBody) };
    inline GetDatasetDocumentResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDatasetDocumentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDatasetDocumentResponseBody> body_ {};
  };
