...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowEmoji_ == nullptr
        && return this->extraInfo_ == nullptr && return this->length_ == nullptr && return this->lengthRangeShrink_ == nullptr && return this->modelId_ == nullptr && return this->numComments_ == nullptr
        && return this->sentimentShrink_ == nullptr && return this->sessionId_ == nullptr && return this->sourceMaterial_ == nullptr && return this->style_ == nullptr && return this->typeShrink_ == nullptr
