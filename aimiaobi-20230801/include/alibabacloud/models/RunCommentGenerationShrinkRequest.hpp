...
namespace Models
{
  ...
  public:
    ...
    inline string getLengthRangeShrink() const { DARABONBA_PTR_GET_DEFAULT(lengthRangeShrink_, "") };
    ...
    inline string getSentimentShrink() const { DARABONBA_PTR_GET_DEFAULT(sentimentShrink_, "") };
    ...
    inline string getTypeShrink() const { DARABONBA_PTR_GET_DEFAULT(typeShrink_, "") };
