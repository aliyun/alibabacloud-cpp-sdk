...
namespace Models
{
  ...
  public:
    ...
    inline RunDocSummaryResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunDocSummaryResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunDocSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunDocSummaryResponseBody) };
    inline RunDocSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, RunDocSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunDocSummaryResponseBody> body_ {};
  };
