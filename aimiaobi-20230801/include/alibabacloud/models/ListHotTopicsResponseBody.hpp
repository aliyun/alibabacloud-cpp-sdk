...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHotTopicsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListHotTopicsResponseBodyData>) };
    inline vector<ListHotTopicsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListHotTopicsResponseBodyData>) };
    inline ListHotTopicsResponseBody& setData(const vector<ListHotTopicsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHotTopicsResponseBody& setData(vector<ListHotTopicsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHotTopicsResponseBodyData>> data_ = nullptr;
