...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocClusterTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDocClusterTaskResponseBody) };
    inline GetDocClusterTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDocClusterTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDocClusterTaskResponseBody> body_ {};
  };
