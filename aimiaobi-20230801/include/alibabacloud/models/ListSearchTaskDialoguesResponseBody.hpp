...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->data_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr
    ...
    inline const vector<ListSearchTaskDialoguesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListSearchTaskDialoguesResponseBodyData>) };
    inline vector<ListSearchTaskDialoguesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListSearchTaskDialoguesResponseBodyData>) };
    inline ListSearchTaskDialoguesResponseBody& setData(const vector<ListSearchTaskDialoguesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSearchTaskDialoguesResponseBody& setData(vector<ListSearchTaskDialoguesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListSearchTaskDialoguesResponseBodyData>> data_ = nullptr;
