...
namespace Models
{
  ...
  public:
    ...
    inline const RunTextPolishingResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunTextPolishingResponseBody::Header) };
    inline RunTextPolishingResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunTextPolishingResponseBody::Header) };
    inline RunTextPolishingResponseBody& setHeader(const RunTextPolishingResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunTextPolishingResponseBody& setHeader(RunTextPolishingResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunTextPolishingResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunTextPolishingResponseBody::Payload) };
    inline RunTextPolishingResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunTextPolishingResponseBody::Payload) };
    inline RunTextPolishingResponseBody& setPayload(const RunTextPolishingResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunTextPolishingResponseBody& setPayload(RunTextPolishingResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
