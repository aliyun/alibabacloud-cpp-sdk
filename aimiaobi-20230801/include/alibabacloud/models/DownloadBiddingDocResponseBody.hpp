...
namespace Models
{
  ...
  public:
    ...
    inline const DownloadBiddingDocResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DownloadBiddingDocResponseBody::Data) };
    inline DownloadBiddingDocResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DownloadBiddingDocResponseBody::Data) };
    inline DownloadBiddingDocResponseBody& setData(const DownloadBiddingDocResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DownloadBiddingDocResponseBody& setData(DownloadBiddingDocResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
