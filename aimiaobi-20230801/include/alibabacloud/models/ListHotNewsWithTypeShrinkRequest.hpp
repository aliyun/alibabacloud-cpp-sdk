...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentKey_ == nullptr
        && return this->current_ == nullptr && return this->newsType_ == nullptr && return this->newsTypesShrink_ == nullptr && return this->size_ == nullptr; };
    ...
    inline string newsTypesShrink() const { DARABONBA_PTR_GET_DEFAULT(newsTypesShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> newsTypesShrink_ = nullptr;
