...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitCustomSourceTopicAnalysisResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SubmitCustomSourceTopicAnalysisResponseBodyData) };
    inline SubmitCustomSourceTopicAnalysisResponseBodyData data() { DARABONBA_PTR_GET(data_, SubmitCustomSourceTopicAnalysisResponseBodyData) };
    inline SubmitCustomSourceTopicAnalysisResponseBody& setData(const SubmitCustomSourceTopicAnalysisResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitCustomSourceTopicAnalysisResponseBody& setData(SubmitCustomSourceTopicAnalysisResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitCustomSourceTopicAnalysisResponseBodyData> data_ = nullptr;
