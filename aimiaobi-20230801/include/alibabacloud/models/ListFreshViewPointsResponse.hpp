...
namespace Models
{
  ...
  public:
    ...
    inline const ListFreshViewPointsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFreshViewPointsResponseBody) };
    inline ListFreshViewPointsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFreshViewPointsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFreshViewPointsResponseBody> body_ {};
  };
