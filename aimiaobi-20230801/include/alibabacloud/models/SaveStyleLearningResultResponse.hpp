...
namespace Models
{
  ...
  public:
    ...
    inline const SaveStyleLearningResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveStyleLearningResultResponseBody) };
    inline SaveStyleLearningResultResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveStyleLearningResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveStyleLearningResultResponseBody> body_ {};
  };
