...
namespace Models
{
  ...
  public:
    ...
    inline const GetStyleLearningResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetStyleLearningResultResponseBodyData) };
    inline GetStyleLearningResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetStyleLearningResultResponseBodyData) };
    inline GetStyleLearningResultResponseBody& setData(const GetStyleLearningResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetStyleLearningResultResponseBody& setData(GetStyleLearningResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetStyleLearningResultResponseBodyData> data_ = nullptr;
