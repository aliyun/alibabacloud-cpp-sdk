...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        class ExtraOutput : public Darabonba::Model {
        public:
          friend void to_json(Darabonba::Json& j, const ExtraOutput& obj) { 
            DARABONBA_PTR_TO_JSON(summarization, summarization_);
          };
          friend void from_json(const Darabonba::Json& j, ExtraOutput& obj) { 
            DARABONBA_PTR_FROM_JSON(summarization, summarization_);
          };
          ExtraOutput() = default ;
          ExtraOutput(const ExtraOutput &) = default ;
          ExtraOutput(ExtraOutput &&) = default ;
          ExtraOutput(const Darabonba::Json & obj) { from_json(obj, *this); };
          virtual ~ExtraOutput() = default ;
          ExtraOutput& operator=(const ExtraOutput &) = default ;
          ExtraOutput& operator=(ExtraOutput &&) = default ;
          virtual void validate() const override {
          };
          virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
          virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
          ...
          inline ExtraOutput& setSummarization(const vector<string> & summarization) { DARABONBA_PTR_SET_VALUE(summarization_, summarization) };
          inline ExtraOutput& setSummarization(vector<string> && summarization) { DARABONBA_PTR_SET_RVALUE(summarization_, summarization) };
        ...
        && this->extraOutput_ == nullptr && this->miniDoc_ == nullptr && this->searchQuery_ == nullptr && this->text_ == nullptr; };
        ...
        inline const Output::ExtraOutput & getExtraOutput() const { DARABONBA_PTR_GET_CONST(extraOutput_, Output::ExtraOutput) };
        inline Output::ExtraOutput getExtraOutput() { DARABONBA_PTR_GET(extraOutput_, Output::ExtraOutput) };
        inline Output& setExtraOutput(const Output::ExtraOutput & extraOutput) { DARABONBA_PTR_SET_VALUE(extraOutput_, extraOutput) };
        inline Output& setExtraOutput(Output::ExtraOutput && extraOutput) { DARABONBA_PTR_SET_RVALUE(extraOutput_, extraOutput) };
      ...
      protected:
        ...
        shared_ptr<Output::ExtraOutput> extraOutput_ {};
    ...
    inline const RunStepByStepWritingResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunStepByStepWritingResponseBody::Header) };
    inline RunStepByStepWritingResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunStepByStepWritingResponseBody::Header) };
    inline RunStepByStepWritingResponseBody& setHeader(const RunStepByStepWritingResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunStepByStepWritingResponseBody& setHeader(RunStepByStepWritingResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunStepByStepWritingResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunStepByStepWritingResponseBody::Payload) };
    inline RunStepByStepWritingResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunStepByStepWritingResponseBody::Payload) };
    inline RunStepByStepWritingResponseBody& setPayload(const RunStepByStepWritingResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunStepByStepWritingResponseBody& setPayload(RunStepByStepWritingResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    shared_ptr<RunStepByStepWritingResponseBody::Header> header_ {};
    shared_ptr<RunStepByStepWritingResponseBody::Payload> payload_ {};
