...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitCustomSourceTopicAnalysisResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SubmitCustomSourceTopicAnalysisResponseBody) };
    inline SubmitCustomSourceTopicAnalysisResponseBody body() { DARABONBA_PTR_GET(body_, SubmitCustomSourceTopicAnalysisResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitCustomSourceTopicAnalysisResponseBody> body_ = nullptr;
  };
