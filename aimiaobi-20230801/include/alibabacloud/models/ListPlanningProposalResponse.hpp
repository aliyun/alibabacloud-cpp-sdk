...
namespace Models
{
  ...
  public:
    ...
    inline const ListPlanningProposalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPlanningProposalResponseBody) };
    inline ListPlanningProposalResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPlanningProposalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPlanningProposalResponseBody> body_ {};
  };
