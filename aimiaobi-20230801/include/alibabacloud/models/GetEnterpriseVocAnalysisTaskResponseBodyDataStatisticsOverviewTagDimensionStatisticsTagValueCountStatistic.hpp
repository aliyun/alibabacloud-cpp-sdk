...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->tagName_ == nullptr
        && return this->tagTaskType_ == nullptr && return this->valueCount_ == nullptr; };
    ...
    inline GetEnterpriseVocAnalysisTaskResponseBodyDataStatisticsOverviewTagDimensionStatisticsTagValueCountStatistic& setTagTaskType(string tagTaskType) { DARABONBA_PTR_SET_VALUE(tagTaskType_, tagTaskType) };
