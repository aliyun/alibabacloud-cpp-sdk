...
namespace Models
{
  ...
  public:
    ...
    inline const GetDatasetDocumentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDatasetDocumentResponseBodyData) };
    inline GetDatasetDocumentResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDatasetDocumentResponseBodyData) };
    inline GetDatasetDocumentResponseBody& setData(const GetDatasetDocumentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDatasetDocumentResponseBody& setData(GetDatasetDocumentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDatasetDocumentResponseBodyData> data_ = nullptr;
