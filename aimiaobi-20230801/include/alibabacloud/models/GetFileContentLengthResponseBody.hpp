...
namespace Models
{
  ...
  public:
    ...
    inline const GetFileContentLengthResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetFileContentLengthResponseBodyData) };
    inline GetFileContentLengthResponseBodyData data() { DARABONBA_PTR_GET(data_, GetFileContentLengthResponseBodyData) };
    inline GetFileContentLengthResponseBody& setData(const GetFileContentLengthResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFileContentLengthResponseBody& setData(GetFileContentLengthResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetFileContentLengthResponseBodyData> data_ = nullptr;
