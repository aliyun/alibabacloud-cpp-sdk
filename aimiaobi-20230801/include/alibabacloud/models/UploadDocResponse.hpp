...
namespace Models
{
  ...
  public:
    ...
    inline const UploadDocResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadDocResponseBody) };
    inline UploadDocResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadDocResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadDocResponseBody> body_ {};
  };
