...
#ifndef ALIBABACLOUD_MODELS_UPDATEGENERALCONFIGRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_UPDATEGENERALCONFIGRESPONSEBODYDATA_HPP_
...
namespace Models
{
  class UpdateGeneralConfigResponseBodyData : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateGeneralConfigResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateGeneralConfigResponseBodyData& obj) { 
    ...
    UpdateGeneralConfigResponseBodyData() = default ;
    UpdateGeneralConfigResponseBodyData(const UpdateGeneralConfigResponseBodyData &) = default ;
    UpdateGeneralConfigResponseBodyData(UpdateGeneralConfigResponseBodyData &&) = default ;
    UpdateGeneralConfigResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateGeneralConfigResponseBodyData() = default ;
    UpdateGeneralConfigResponseBodyData& operator=(const UpdateGeneralConfigResponseBodyData &) = default ;
    UpdateGeneralConfigResponseBodyData& operator=(UpdateGeneralConfigResponseBodyData &&) = default ;
    ...
    inline UpdateGeneralConfigResponseBodyData& setConfigDesc(string configDesc) { DARABONBA_PTR_SET_VALUE(configDesc_, configDesc) };
    ...
    inline UpdateGeneralConfigResponseBodyData& setConfigKey(string configKey) { DARABONBA_PTR_SET_VALUE(configKey_, configKey) };
    ...
    inline UpdateGeneralConfigResponseBodyData& setConfigValue(string configValue) { DARABONBA_PTR_SET_VALUE(configValue_, configValue) };
    ...
    inline UpdateGeneralConfigResponseBodyData& setConfigValueType(string configValueType) { DARABONBA_PTR_SET_VALUE(configValueType_, configValueType) };
