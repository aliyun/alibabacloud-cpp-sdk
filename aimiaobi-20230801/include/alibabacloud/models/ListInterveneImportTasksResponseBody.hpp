...
namespace Models
{
  ...
  public:
    ...
    inline const ListInterveneImportTasksResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListInterveneImportTasksResponseBodyData) };
    inline ListInterveneImportTasksResponseBodyData data() { DARABONBA_PTR_GET(data_, ListInterveneImportTasksResponseBodyData) };
    inline ListInterveneImportTasksResponseBody& setData(const ListInterveneImportTasksResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListInterveneImportTasksResponseBody& setData(ListInterveneImportTasksResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListInterveneImportTasksResponseBodyData> data_ = nullptr;
