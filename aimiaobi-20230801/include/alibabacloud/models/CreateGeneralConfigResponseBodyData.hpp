...
#ifndef ALIBABACLOUD_MODELS_CREATEGENERALCONFIGRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_CREATEGENERALCONFIGRESPONSEBODYDATA_HPP_
...
namespace Models
{
  class CreateGeneralConfigResponseBodyData : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateGeneralConfigResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateGeneralConfigResponseBodyData& obj) { 
    ...
    CreateGeneralConfigResponseBodyData() = default ;
    CreateGeneralConfigResponseBodyData(const CreateGeneralConfigResponseBodyData &) = default ;
    CreateGeneralConfigResponseBodyData(CreateGeneralConfigResponseBodyData &&) = default ;
    CreateGeneralConfigResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateGeneralConfigResponseBodyData() = default ;
    CreateGeneralConfigResponseBodyData& operator=(const CreateGeneralConfigResponseBodyData &) = default ;
    CreateGeneralConfigResponseBodyData& operator=(CreateGeneralConfigResponseBodyData &&) = default ;
    ...
    inline CreateGeneralConfigResponseBodyData& setConfigDesc(string configDesc) { DARABONBA_PTR_SET_VALUE(configDesc_, configDesc) };
    ...
    inline CreateGeneralConfigResponseBodyData& setConfigKey(string configKey) { DARABONBA_PTR_SET_VALUE(configKey_, configKey) };
    ...
    inline CreateGeneralConfigResponseBodyData& setConfigValue(string configValue) { DARABONBA_PTR_SET_VALUE(configValue_, configValue) };
    ...
    inline CreateGeneralConfigResponseBodyData& setConfigValueType(string configValueType) { DARABONBA_PTR_SET_VALUE(configValueType_, configValueType) };
