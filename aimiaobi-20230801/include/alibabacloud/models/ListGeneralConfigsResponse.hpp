...
namespace Models
{
  ...
  public:
    ...
    inline const ListGeneralConfigsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListGeneralConfigsResponseBody) };
    inline ListGeneralConfigsResponseBody body() { DARABONBA_PTR_GET(body_, ListGeneralConfigsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListGeneralConfigsResponseBody> body_ = nullptr;
  };
