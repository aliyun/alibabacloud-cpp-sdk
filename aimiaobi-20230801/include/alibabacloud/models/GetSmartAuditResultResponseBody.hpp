...
namespace Models
{
  ...
  public:
    ...
    inline const GetSmartAuditResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSmartAuditResultResponseBodyData) };
    inline GetSmartAuditResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSmartAuditResultResponseBodyData) };
    inline GetSmartAuditResultResponseBody& setData(const GetSmartAuditResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSmartAuditResultResponseBody& setData(GetSmartAuditResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSmartAuditResultResponseBodyData> data_ = nullptr;
