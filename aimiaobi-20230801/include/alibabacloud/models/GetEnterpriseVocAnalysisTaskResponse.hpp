...
namespace Models
{
  ...
  public:
    ...
    inline const GetEnterpriseVocAnalysisTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEnterpriseVocAnalysisTaskResponseBody) };
    inline GetEnterpriseVocAnalysisTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEnterpriseVocAnalysisTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEnterpriseVocAnalysisTaskResponseBody> body_ {};
  };
