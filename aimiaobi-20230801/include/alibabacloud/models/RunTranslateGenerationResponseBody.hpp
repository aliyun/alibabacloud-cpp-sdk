...
namespace Models
{
  ...
  public:
    ...
    inline const RunTranslateGenerationResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunTranslateGenerationResponseBody::Header) };
    inline RunTranslateGenerationResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunTranslateGenerationResponseBody::Header) };
    inline RunTranslateGenerationResponseBody& setHeader(const RunTranslateGenerationResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunTranslateGenerationResponseBody& setHeader(RunTranslateGenerationResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunTranslateGenerationResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunTranslateGenerationResponseBody::Payload) };
    inline RunTranslateGenerationResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunTranslateGenerationResponseBody::Payload) };
    inline RunTranslateGenerationResponseBody& setPayload(const RunTranslateGenerationResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunTranslateGenerationResponseBody& setPayload(RunTranslateGenerationResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
