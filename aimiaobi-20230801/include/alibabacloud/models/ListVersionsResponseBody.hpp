...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListVersionsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListVersionsResponseBodyData>) };
    inline vector<ListVersionsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListVersionsResponseBodyData>) };
    inline ListVersionsResponseBody& setData(const vector<ListVersionsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListVersionsResponseBody& setData(vector<ListVersionsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListVersionsResponseBodyData>> data_ = nullptr;
