...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListMaterialDocumentsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListMaterialDocumentsResponseBodyData>) };
    inline vector<ListMaterialDocumentsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListMaterialDocumentsResponseBodyData>) };
    inline ListMaterialDocumentsResponseBody& setData(const vector<ListMaterialDocumentsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMaterialDocumentsResponseBody& setData(vector<ListMaterialDocumentsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListMaterialDocumentsResponseBodyData>> data_ = nullptr;
