...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->metadataKeyValueSearchEnable_ == nullptr && this->tagGenerateEnable_ == nullptr && this->tagSearchEnable_ == nullptr; };
          ...
          inline string getMetadataKeyValueGenerateEnable() const { DARABONBA_PTR_GET_DEFAULT(metadataKeyValueGenerateEnable_, "") };
          inline SearchSourceConfig& setMetadataKeyValueGenerateEnable(string metadataKeyValueGenerateEnable) { DARABONBA_PTR_SET_VALUE(metadataKeyValueGenerateEnable_, metadataKeyValueGenerateEnable) };
          ...
          inline string getMetadataKeyValueSearchEnable() const { DARABONBA_PTR_GET_DEFAULT(metadataKeyValueSearchEnable_, "") };
          inline SearchSourceConfig& setMetadataKeyValueSearchEnable(string metadataKeyValueSearchEnable) { DARABONBA_PTR_SET_VALUE(metadataKeyValueSearchEnable_, metadataKeyValueSearchEnable) };
          ...
          inline string getTagGenerateEnable() const { DARABONBA_PTR_GET_DEFAULT(tagGenerateEnable_, "") };
          inline SearchSourceConfig& setTagGenerateEnable(string tagGenerateEnable) { DARABONBA_PTR_SET_VALUE(tagGenerateEnable_, tagGenerateEnable) };
          ...
          inline string getTagSearchEnable() const { DARABONBA_PTR_GET_DEFAULT(tagSearchEnable_, "") };
          inline SearchSourceConfig& setTagSearchEnable(string tagSearchEnable) { DARABONBA_PTR_SET_VALUE(tagSearchEnable_, tagSearchEnable) };
      ...
      inline const Data::DatasetConfig & getDatasetConfig() const { DARABONBA_PTR_GET_CONST(datasetConfig_, Data::DatasetConfig) };
      inline Data::DatasetConfig getDatasetConfig() { DARABONBA_PTR_GET(datasetConfig_, Data::DatasetConfig) };
      inline Data& setDatasetConfig(const Data::DatasetConfig & datasetConfig) { DARABONBA_PTR_SET_VALUE(datasetConfig_, datasetConfig) };
      inline Data& setDatasetConfig(Data::DatasetConfig && datasetConfig) { DARABONBA_PTR_SET_RVALUE(datasetConfig_, datasetConfig) };
      ...
      inline const Data::DocumentHandleConfig & getDocumentHandleConfig() const { DARABONBA_PTR_GET_CONST(documentHandleConfig_, Data::DocumentHandleConfig) };
      inline Data::DocumentHandleConfig getDocumentHandleConfig() { DARABONBA_PTR_GET(documentHandleConfig_, Data::DocumentHandleConfig) };
      inline Data& setDocumentHandleConfig(const Data::DocumentHandleConfig & documentHandleConfig) { DARABONBA_PTR_SET_VALUE(documentHandleConfig_, documentHandleConfig) };
      inline Data& setDocumentHandleConfig(Data::DocumentHandleConfig && documentHandleConfig) { DARABONBA_PTR_SET_RVALUE(documentHandleConfig_, documentHandleConfig) };
    ...
    inline const GetDatasetResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDatasetResponseBody::Data) };
    inline GetDatasetResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDatasetResponseBody::Data) };
    inline GetDatasetResponseBody& setData(const GetDatasetResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDatasetResponseBody& setData(GetDatasetResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
