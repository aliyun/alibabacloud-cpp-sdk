...
namespace Models
{
  ...
  public:
    ...
    inline const GetDatasetResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDatasetResponseBodyData) };
    inline GetDatasetResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDatasetResponseBodyData) };
    inline GetDatasetResponseBody& setData(const GetDatasetResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDatasetResponseBody& setData(GetDatasetResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDatasetResponseBodyData> data_ = nullptr;
