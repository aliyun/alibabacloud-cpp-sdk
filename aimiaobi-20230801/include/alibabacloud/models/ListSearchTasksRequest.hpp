...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dialogueTypes_ == nullptr
    ...
    inline const vector<int32_t> & getDialogueTypes() const { DARABONBA_PTR_GET_CONST(dialogueTypes_, vector<int32_t>) };
    inline vector<int32_t> getDialogueTypes() { DARABONBA_PTR_GET(dialogueTypes_, vector<int32_t>) };
  ...
  protected:
    shared_ptr<vector<int32_t>> dialogueTypes_ {};
