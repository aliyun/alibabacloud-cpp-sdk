...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentKey_ == nullptr
        && return this->attitude_ == nullptr && return this->attitudesShrink_ == nullptr && return this->customViewPointId_ == nullptr && return this->customViewPointIdsShrink_ == nullptr && return this->maxResults_ == nullptr
    ...
    inline string attitudesShrink() const { DARABONBA_PTR_GET_DEFAULT(attitudesShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> attitudesShrink_ = nullptr;
