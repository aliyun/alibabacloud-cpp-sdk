...
namespace Models
{
  ...
  public:
    ...
    inline const ListAuditTermsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAuditTermsResponseBody) };
    inline ListAuditTermsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAuditTermsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAuditTermsResponseBody> body_ {};
  };
