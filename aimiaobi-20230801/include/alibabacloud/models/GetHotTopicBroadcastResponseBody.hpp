...
namespace Models
{
  ...
  public:
    ...
    inline const GetHotTopicBroadcastResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHotTopicBroadcastResponseBodyData) };
    inline GetHotTopicBroadcastResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHotTopicBroadcastResponseBodyData) };
    inline GetHotTopicBroadcastResponseBody& setData(const GetHotTopicBroadcastResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHotTopicBroadcastResponseBody& setData(GetHotTopicBroadcastResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHotTopicBroadcastResponseBodyData> data_ = nullptr;
