...
#ifndef ALIBABACLOUD_MODELS_ASYNCEDITTIMELINEREQUESTTIMELINESCLIPS_HPP_
#define ALIBABACLOUD_MODELS_ASYNCEDITTIMELINEREQUESTTIMELINESCLIPS_HPP_
...
namespace Models
{
  class AsyncEditTimelineRequestTimelinesClips : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AsyncEditTimelineRequestTimelinesClips& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AsyncEditTimelineRequestTimelinesClips& obj) { 
    ...
    AsyncEditTimelineRequestTimelinesClips() = default ;
    AsyncEditTimelineRequestTimelinesClips(const AsyncEditTimelineRequestTimelinesClips &) = default ;
    AsyncEditTimelineRequestTimelinesClips(AsyncEditTimelineRequestTimelinesClips &&) = default ;
    AsyncEditTimelineRequestTimelinesClips(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AsyncEditTimelineRequestTimelinesClips() = default ;
    AsyncEditTimelineRequestTimelinesClips& operator=(const AsyncEditTimelineRequestTimelinesClips &) = default ;
    AsyncEditTimelineRequestTimelinesClips& operator=(AsyncEditTimelineRequestTimelinesClips &&) = default ;
    ...
    inline AsyncEditTimelineRequestTimelinesClips& setClipId(string clipId) { DARABONBA_PTR_SET_VALUE(clipId_, clipId) };
    ...
    inline AsyncEditTimelineRequestTimelinesClips& setContentInner(string contentInner) { DARABONBA_PTR_SET_VALUE(contentInner_, contentInner) };
    ...
    inline AsyncEditTimelineRequestTimelinesClips& setIn(int32_t in) { DARABONBA_PTR_SET_VALUE(in_, in) };
    ...
    inline AsyncEditTimelineRequestTimelinesClips& setInEx(float inEx) { DARABONBA_PTR_SET_VALUE(inEx_, inEx) };
    ...
    inline AsyncEditTimelineRequestTimelinesClips& setOut(int32_t out) { DARABONBA_PTR_SET_VALUE(out_, out) };
    ...
    inline AsyncEditTimelineRequestTimelinesClips& setOutEx(float outEx) { DARABONBA_PTR_SET_VALUE(outEx_, outEx) };
    ...
    inline AsyncEditTimelineRequestTimelinesClips& setVideoId(string videoId) { DARABONBA_PTR_SET_VALUE(videoId_, videoId) };
    ...
    inline AsyncEditTimelineRequestTimelinesClips& setVideoName(string videoName) { DARABONBA_PTR_SET_VALUE(videoName_, videoName) };
