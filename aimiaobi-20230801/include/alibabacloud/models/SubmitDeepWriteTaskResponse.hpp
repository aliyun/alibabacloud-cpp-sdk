...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitDeepWriteTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitDeepWriteTaskResponseBody) };
    inline SubmitDeepWriteTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitDeepWriteTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitDeepWriteTaskResponseBody> body_ {};
  };
