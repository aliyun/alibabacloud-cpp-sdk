...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomViewPointsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCustomViewPointsResponseBody) };
    inline ListCustomViewPointsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCustomViewPointsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCustomViewPointsResponseBody> body_ {};
  };
