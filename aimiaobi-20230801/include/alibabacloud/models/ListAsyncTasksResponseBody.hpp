...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAsyncTasksResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAsyncTasksResponseBodyData>) };
    inline vector<ListAsyncTasksResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAsyncTasksResponseBodyData>) };
    inline ListAsyncTasksResponseBody& setData(const vector<ListAsyncTasksResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAsyncTasksResponseBody& setData(vector<ListAsyncTasksResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAsyncTasksResponseBodyData>> data_ = nullptr;
