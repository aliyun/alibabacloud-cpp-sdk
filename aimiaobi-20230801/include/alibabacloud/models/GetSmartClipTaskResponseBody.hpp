...
namespace Models
{
  ...
  public:
    ...
    inline const GetSmartClipTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSmartClipTaskResponseBodyData) };
    inline GetSmartClipTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSmartClipTaskResponseBodyData) };
    inline GetSmartClipTaskResponseBody& setData(const GetSmartClipTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSmartClipTaskResponseBody& setData(GetSmartClipTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSmartClipTaskResponseBodyData> data_ = nullptr;
