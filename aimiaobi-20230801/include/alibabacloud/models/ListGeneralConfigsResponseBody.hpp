...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListGeneralConfigsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListGeneralConfigsResponseBodyData>) };
    inline vector<ListGeneralConfigsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListGeneralConfigsResponseBodyData>) };
    inline ListGeneralConfigsResponseBody& setData(const vector<ListGeneralConfigsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListGeneralConfigsResponseBody& setData(vector<ListGeneralConfigsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListGeneralConfigsResponseBodyData>> data_ = nullptr;
