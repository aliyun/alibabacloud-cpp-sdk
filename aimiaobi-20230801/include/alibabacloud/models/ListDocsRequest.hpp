...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->categoryId_ == nullptr
        && return this->docName_ == nullptr && return this->docType_ == nullptr && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->skip_ == nullptr
        && return this->statuses_ == nullptr && return this->workspaceId_ == nullptr; };
    ...
    inline const vector<int32_t> & statuses() const { DARABONBA_PTR_GET_CONST(statuses_, vector<int32_t>) };
    inline vector<int32_t> statuses() { DARABONBA_PTR_GET(statuses_, vector<int32_t>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<int32_t>> statuses_ = nullptr;
