...
namespace Models
{
  ...
  public:
    ...
    inline const ListHotTopicsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHotTopicsResponseBody) };
    inline ListHotTopicsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHotTopicsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHotTopicsResponseBody> body_ {};
  };
