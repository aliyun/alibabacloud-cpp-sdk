...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListCustomTextResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListCustomTextResponseBody::Data>) };
    inline vector<ListCustomTextResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListCustomTextResponseBody::Data>) };
    inline ListCustomTextResponseBody& setData(const vector<ListCustomTextResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCustomTextResponseBody& setData(vector<ListCustomTextResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
