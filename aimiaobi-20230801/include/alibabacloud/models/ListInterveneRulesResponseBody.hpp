...
namespace Models
{
  ...
  public:
    ...
    inline const ListInterveneRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListInterveneRulesResponseBodyData) };
    inline ListInterveneRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListInterveneRulesResponseBodyData) };
    inline ListInterveneRulesResponseBody& setData(const ListInterveneRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListInterveneRulesResponseBody& setData(ListInterveneRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListInterveneRulesResponseBodyData> data_ = nullptr;
