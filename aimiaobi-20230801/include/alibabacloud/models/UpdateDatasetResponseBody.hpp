...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDatasetResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateDatasetResponseBodyData) };
    inline UpdateDatasetResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateDatasetResponseBodyData) };
    inline UpdateDatasetResponseBody& setData(const UpdateDatasetResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateDatasetResponseBody& setData(UpdateDatasetResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateDatasetResponseBodyData> data_ = nullptr;
