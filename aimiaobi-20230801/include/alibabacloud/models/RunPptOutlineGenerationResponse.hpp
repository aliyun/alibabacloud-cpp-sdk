...
namespace Models
{
  ...
  public:
    ...
    inline RunPptOutlineGenerationResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunPptOutlineGenerationResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };
