...
namespace Models
{
  ...
  public:
    ...
    inline const RunPptOutlineGenerationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RunPptOutlineGenerationResponseBody) };
    inline RunPptOutlineGenerationResponseBody body() { DARABONBA_PTR_GET(body_, RunPptOutlineGenerationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RunPptOutlineGenerationResponseBody> body_ = nullptr;
  };
