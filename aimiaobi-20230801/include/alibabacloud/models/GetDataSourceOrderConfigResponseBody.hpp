...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataSourceOrderConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDataSourceOrderConfigResponseBodyData) };
    inline GetDataSourceOrderConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDataSourceOrderConfigResponseBodyData) };
    inline GetDataSourceOrderConfigResponseBody& setData(const GetDataSourceOrderConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataSourceOrderConfigResponseBody& setData(GetDataSourceOrderConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataSourceOrderConfigResponseBodyData> data_ = nullptr;
