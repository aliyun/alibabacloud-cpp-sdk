...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      class Administrators : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const Administrators& obj) { 
          DARABONBA_PTR_TO_JSON(UserId, userId_);
          DARABONBA_PTR_TO_JSON(Username, username_);
        };
        friend void from_json(const Darabonba::Json& j, Administrators& obj) { 
          DARABONBA_PTR_FROM_JSON(UserId, userId_);
          DARABONBA_PTR_FROM_JSON(Username, username_);
        };
        Administrators() = default ;
        Administrators(const Administrators &) = default ;
        Administrators(Administrators &&) = default ;
        Administrators(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~Administrators() = default ;
        Administrators& operator=(const Administrators &) = default ;
        Administrators& operator=(Administrators &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        inline Administrators& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
        ...
        inline Administrators& setUsername(string username) { DARABONBA_PTR_SET_VALUE(username_, username) };
      ...
      virtual bool empty() const override { return this->accessLevel_ == nullptr
        && this->administrators_ == nullptr && this->createTime_ == nullptr && this->createUser_ == nullptr && this->datasetDescription_ == nullptr && this->datasetId_ == nullptr
        && this->datasetName_ == nullptr && this->datasetType_ == nullptr && this->docUsedQuota_ == nullptr && this->searchDatasetEnable_ == nullptr; };
      ...
      inline const vector<Data::Administrators> & getAdministrators() const { DARABONBA_PTR_GET_CONST(administrators_, vector<Data::Administrators>) };
      inline vector<Data::Administrators> getAdministrators() { DARABONBA_PTR_GET(administrators_, vector<Data::Administrators>) };
      inline Data& setAdministrators(const vector<Data::Administrators> & administrators) { DARABONBA_PTR_SET_VALUE(administrators_, administrators) };
      inline Data& setAdministrators(vector<Data::Administrators> && administrators) { DARABONBA_PTR_SET_RVALUE(administrators_, administrators) };
