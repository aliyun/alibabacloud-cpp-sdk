...
namespace Models
{
  ...
  public:
    ...
    inline const GetInterveneImportTaskInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetInterveneImportTaskInfoResponseBodyData) };
    inline GetInterveneImportTaskInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetInterveneImportTaskInfoResponseBodyData) };
    inline GetInterveneImportTaskInfoResponseBody& setData(const GetInterveneImportTaskInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInterveneImportTaskInfoResponseBody& setData(GetInterveneImportTaskInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetInterveneImportTaskInfoResponseBodyData> data_ = nullptr;
