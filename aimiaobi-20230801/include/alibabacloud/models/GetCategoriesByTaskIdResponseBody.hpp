...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetCategoriesByTaskIdResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetCategoriesByTaskIdResponseBodyData>) };
    inline vector<GetCategoriesByTaskIdResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetCategoriesByTaskIdResponseBodyData>) };
    inline GetCategoriesByTaskIdResponseBody& setData(const vector<GetCategoriesByTaskIdResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCategoriesByTaskIdResponseBody& setData(vector<GetCategoriesByTaskIdResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetCategoriesByTaskIdResponseBodyData>> data_ = nullptr;
