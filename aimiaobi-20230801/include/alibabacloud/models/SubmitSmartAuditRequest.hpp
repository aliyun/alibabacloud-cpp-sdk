...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->imageUrlList_ != nullptr
        && this->subCodes_ != nullptr && this->text_ != nullptr && this->workspaceId_ != nullptr && this->imageUrls_ != nullptr; };
