...
namespace Models
{
  ...
  public:
    ...
    inline const RunStyleFeatureAnalysisResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunStyleFeatureAnalysisResponseBody::Header) };
    inline RunStyleFeatureAnalysisResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunStyleFeatureAnalysisResponseBody::Header) };
    inline RunStyleFeatureAnalysisResponseBody& setHeader(const RunStyleFeatureAnalysisResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunStyleFeatureAnalysisResponseBody& setHeader(RunStyleFeatureAnalysisResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunStyleFeatureAnalysisResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunStyleFeatureAnalysisResponseBody::Payload) };
    inline RunStyleFeatureAnalysisResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunStyleFeatureAnalysisResponseBody::Payload) };
    inline RunStyleFeatureAnalysisResponseBody& setPayload(const RunStyleFeatureAnalysisResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunStyleFeatureAnalysisResponseBody& setPayload(RunStyleFeatureAnalysisResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    ...
    shared_ptr<RunStyleFeatureAnalysisResponseBody::Header> header_ {};
    shared_ptr<RunStyleFeatureAnalysisResponseBody::Payload> payload_ {};
