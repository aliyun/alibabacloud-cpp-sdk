...
namespace Models
{
  ...
  public:
    ...
    inline const GetAutoClipsTaskInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAutoClipsTaskInfoResponseBodyData) };
    inline GetAutoClipsTaskInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAutoClipsTaskInfoResponseBodyData) };
    inline GetAutoClipsTaskInfoResponseBody& setData(const GetAutoClipsTaskInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAutoClipsTaskInfoResponseBody& setData(GetAutoClipsTaskInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAutoClipsTaskInfoResponseBodyData> data_ = nullptr;
