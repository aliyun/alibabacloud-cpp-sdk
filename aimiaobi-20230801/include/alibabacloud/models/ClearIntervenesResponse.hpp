...
namespace Models
{
  ...
  public:
    ...
    inline const ClearIntervenesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ClearIntervenesResponseBody) };
    inline ClearIntervenesResponseBody getBody() { DARABONBA_PTR_GET(body_, ClearIntervenesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ClearIntervenesResponseBody> body_ {};
  };
