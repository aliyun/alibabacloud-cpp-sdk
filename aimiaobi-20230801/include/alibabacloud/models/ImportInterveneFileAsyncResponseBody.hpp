...
namespace Models
{
  ...
  public:
    ...
    inline const ImportInterveneFileAsyncResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ImportInterveneFileAsyncResponseBodyData) };
    inline ImportInterveneFileAsyncResponseBodyData data() { DARABONBA_PTR_GET(data_, ImportInterveneFileAsyncResponseBodyData) };
    inline ImportInterveneFileAsyncResponseBody& setData(const ImportInterveneFileAsyncResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ImportInterveneFileAsyncResponseBody& setData(ImportInterveneFileAsyncResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ImportInterveneFileAsyncResponseBodyData> data_ = nullptr;
