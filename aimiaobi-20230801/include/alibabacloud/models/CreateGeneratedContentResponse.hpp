...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGeneratedContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateGeneratedContentResponseBody) };
    inline CreateGeneratedContentResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateGeneratedContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateGeneratedContentResponseBody> body_ {};
  };
