...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->chunks_ == nullptr
        ...
        && return this->searchSource_ == nullptr && return this->searchSourceName_ == nullptr && return this->searchSourceType_ == nullptr && return this->source_ == nullptr && return this->summary_ == nullptr
