...
namespace Models
{
  ...
  public:
    ...
    inline const GetMaterialByIdResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetMaterialByIdResponseBody::Data) };
    inline GetMaterialByIdResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetMaterialByIdResponseBody::Data) };
    inline GetMaterialByIdResponseBody& setData(const GetMaterialByIdResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMaterialByIdResponseBody& setData(GetMaterialByIdResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
