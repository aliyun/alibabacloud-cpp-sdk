...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDialoguesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListDialoguesResponseBodyData>) };
    inline vector<ListDialoguesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListDialoguesResponseBodyData>) };
    inline ListDialoguesResponseBody& setData(const vector<ListDialoguesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDialoguesResponseBody& setData(vector<ListDialoguesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDialoguesResponseBodyData>> data_ = nullptr;
