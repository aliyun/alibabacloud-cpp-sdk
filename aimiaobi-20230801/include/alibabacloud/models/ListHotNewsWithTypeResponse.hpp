...
namespace Models
{
  ...
  public:
    ...
    inline const ListHotNewsWithTypeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListHotNewsWithTypeResponseBody) };
    inline ListHotNewsWithTypeResponseBody body() { DARABONBA_PTR_GET(body_, ListHotNewsWithTypeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListHotNewsWithTypeResponseBody> body_ = nullptr;
  };
