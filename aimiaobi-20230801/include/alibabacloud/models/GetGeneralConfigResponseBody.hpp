...
namespace Models
{
  ...
  public:
    ...
    inline const GetGeneralConfigResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetGeneralConfigResponseBody::Data) };
    inline GetGeneralConfigResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetGeneralConfigResponseBody::Data) };
    inline GetGeneralConfigResponseBody& setData(const GetGeneralConfigResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetGeneralConfigResponseBody& setData(GetGeneralConfigResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
