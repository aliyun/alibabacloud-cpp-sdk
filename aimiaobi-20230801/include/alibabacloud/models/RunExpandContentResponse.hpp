...
namespace Models
{
  ...
  public:
    ...
    inline RunExpandContentResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunExpandContentResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunExpandContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunExpandContentResponseBody) };
    inline RunExpandContentResponseBody getBody() { DARABONBA_PTR_GET(body_, RunExpandContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunExpandContentResponseBody> body_ {};
  };
