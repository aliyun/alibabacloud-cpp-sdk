...
namespace Models
{
  ...
  public:
    ...
    inline const GetInterveneRuleDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetInterveneRuleDetailResponseBodyData) };
    inline GetInterveneRuleDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetInterveneRuleDetailResponseBodyData) };
    inline GetInterveneRuleDetailResponseBody& setData(const GetInterveneRuleDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInterveneRuleDetailResponseBody& setData(GetInterveneRuleDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetInterveneRuleDetailResponseBodyData> data_ = nullptr;
