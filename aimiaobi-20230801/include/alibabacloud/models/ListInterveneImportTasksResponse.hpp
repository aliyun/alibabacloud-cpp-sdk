...
namespace Models
{
  ...
  public:
    ...
    inline const ListInterveneImportTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInterveneImportTasksResponseBody) };
    inline ListInterveneImportTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInterveneImportTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInterveneImportTasksResponseBody> body_ {};
  };
