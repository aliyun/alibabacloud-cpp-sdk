...
namespace Models
{
  ...
  public:
    ...
    inline const FetchImageTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, FetchImageTaskResponseBodyData) };
    inline FetchImageTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, FetchImageTaskResponseBodyData) };
    inline FetchImageTaskResponseBody& setData(const FetchImageTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline FetchImageTaskResponseBody& setData(FetchImageTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<FetchImageTaskResponseBodyData> data_ = nullptr;
