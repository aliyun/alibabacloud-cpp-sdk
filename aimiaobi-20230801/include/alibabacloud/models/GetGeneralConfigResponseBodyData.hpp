...
#ifndef ALIBABACLOUD_MODELS_GETGENERALCONFIGRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETGENERALCONFIGRESPONSEBODYDATA_HPP_
...
namespace Models
{
  class GetGeneralConfigResponseBodyData : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetGeneralConfigResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetGeneralConfigResponseBodyData& obj) { 
    ...
    GetGeneralConfigResponseBodyData() = default ;
    GetGeneralConfigResponseBodyData(const GetGeneralConfigResponseBodyData &) = default ;
    GetGeneralConfigResponseBodyData(GetGeneralConfigResponseBodyData &&) = default ;
    GetGeneralConfigResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetGeneralConfigResponseBodyData() = default ;
    GetGeneralConfigResponseBodyData& operator=(const GetGeneralConfigResponseBodyData &) = default ;
    GetGeneralConfigResponseBodyData& operator=(GetGeneralConfigResponseBodyData &&) = default ;
    ...
    inline GetGeneralConfigResponseBodyData& setConfigDesc(string configDesc) { DARABONBA_PTR_SET_VALUE(configDesc_, configDesc) };
    ...
    inline GetGeneralConfigResponseBodyData& setConfigKey(string configKey) { DARABONBA_PTR_SET_VALUE(configKey_, configKey) };
    ...
    inline GetGeneralConfigResponseBodyData& setConfigValue(string configValue) { DARABONBA_PTR_SET_VALUE(configValue_, configValue) };
    ...
    inline GetGeneralConfigResponseBodyData& setConfigValueType(string configValueType) { DARABONBA_PTR_SET_VALUE(configValueType_, configValueType) };
