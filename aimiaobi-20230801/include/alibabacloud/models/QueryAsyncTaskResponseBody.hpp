...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAsyncTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryAsyncTaskResponseBodyData) };
    inline QueryAsyncTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryAsyncTaskResponseBodyData) };
    inline QueryAsyncTaskResponseBody& setData(const QueryAsyncTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAsyncTaskResponseBody& setData(QueryAsyncTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryAsyncTaskResponseBodyData> data_ = nullptr;
