...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHotNewsWithTypeResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListHotNewsWithTypeResponseBodyData>) };
    inline vector<ListHotNewsWithTypeResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListHotNewsWithTypeResponseBodyData>) };
    inline ListHotNewsWithTypeResponseBody& setData(const vector<ListHotNewsWithTypeResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHotNewsWithTypeResponseBody& setData(vector<ListHotNewsWithTypeResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHotNewsWithTypeResponseBodyData>> data_ = nullptr;
