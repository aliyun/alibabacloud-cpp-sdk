...
namespace Models
{
  ...
  public:
    ...
    inline const SearchDatasetDocumentsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SearchDatasetDocumentsResponseBodyData) };
    inline SearchDatasetDocumentsResponseBodyData data() { DARABONBA_PTR_GET(data_, SearchDatasetDocumentsResponseBodyData) };
    inline SearchDatasetDocumentsResponseBody& setData(const SearchDatasetDocumentsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SearchDatasetDocumentsResponseBody& setData(SearchDatasetDocumentsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SearchDatasetDocumentsResponseBodyData> data_ = nullptr;
