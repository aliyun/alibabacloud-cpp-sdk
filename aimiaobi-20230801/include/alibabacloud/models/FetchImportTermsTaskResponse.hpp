...
namespace Models
{
  ...
  public:
    ...
    inline const FetchImportTermsTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FetchImportTermsTaskResponseBody) };
    inline FetchImportTermsTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, FetchImportTermsTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FetchImportTermsTaskResponseBody> body_ {};
  };
