...
#ifndef ALIBABACLOUD_MODELS_LISTFRESHVIEWPOINTSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTFRESHVIEWPOINTSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListFreshViewPointsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListFreshViewPointsResponseBody& obj) { 
    ...
    ListFreshViewPointsResponseBody() = default ;
    ListFreshViewPointsResponseBody(const ListFreshViewPointsResponseBody &) = default ;
    ListFreshViewPointsResponseBody(ListFreshViewPointsResponseBody &&) = default ;
    ListFreshViewPointsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListFreshViewPointsResponseBody() = default ;
    ListFreshViewPointsResponseBody& operator=(const ListFreshViewPointsResponseBody &) = default ;
    ListFreshViewPointsResponseBody& operator=(ListFreshViewPointsResponseBody &&) = default ;
    ...
    public:
      ...
      inline Data& setPoint(string point) { DARABONBA_PTR_SET_VALUE(point_, point) };
    ...
    inline ListFreshViewPointsResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListFreshViewPointsResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListFreshViewPointsResponseBody::Data>) };
    inline vector<ListFreshViewPointsResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListFreshViewPointsResponseBody::Data>) };
    inline ListFreshViewPointsResponseBody& setData(const vector<ListFreshViewPointsResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListFreshViewPointsResponseBody& setData(vector<ListFreshViewPointsResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListFreshViewPointsResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListFreshViewPointsResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListFreshViewPointsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListFreshViewPointsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListFreshViewPointsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListFreshViewPointsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline ListFreshViewPointsResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
