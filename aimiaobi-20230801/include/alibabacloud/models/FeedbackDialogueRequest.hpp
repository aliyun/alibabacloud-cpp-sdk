...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentKey_ == nullptr
        && return this->customerResponse_ == nullptr && return this->goodText_ == nullptr && return this->modifiedResponse_ == nullptr && return this->rating_ == nullptr && return this->ratingTags_ == nullptr
    ...
    inline const vector<string> & ratingTags() const { DARABONBA_PTR_GET_CONST(ratingTags_, vector<string>) };
    inline vector<string> ratingTags() { DARABONBA_PTR_GET(ratingTags_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> ratingTags_ = nullptr;
    // This parameter is required.
