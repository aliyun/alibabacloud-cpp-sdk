...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetDescription_ == nullptr
        && return this->datasetId_ == nullptr && return this->datasetName_ == nullptr && return this->docType_ == nullptr && return this->excludeFields_ == nullptr && return this->includeFields_ == nullptr
