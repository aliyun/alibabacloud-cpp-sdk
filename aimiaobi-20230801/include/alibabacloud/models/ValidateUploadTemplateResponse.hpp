...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateUploadTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ValidateUploadTemplateResponseBody) };
    inline ValidateUploadTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, ValidateUploadTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ValidateUploadTemplateResponseBody> body_ {};
  };
