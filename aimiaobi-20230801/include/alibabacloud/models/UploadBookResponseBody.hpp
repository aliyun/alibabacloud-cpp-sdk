...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UploadBookResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UploadBookResponseBody& obj) { 
    ...
    UploadBookResponseBody() = default ;
    UploadBookResponseBody(const UploadBookResponseBody &) = default ;
    UploadBookResponseBody(UploadBookResponseBody &&) = default ;
    UploadBookResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UploadBookResponseBody() = default ;
    UploadBookResponseBody& operator=(const UploadBookResponseBody &) = default ;
    UploadBookResponseBody& operator=(UploadBookResponseBody &&) = default ;
