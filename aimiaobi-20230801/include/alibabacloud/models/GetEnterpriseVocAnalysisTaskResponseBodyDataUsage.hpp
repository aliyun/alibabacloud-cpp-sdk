...
namespace Models
{
  ...
  public:
    ...
    inline GetEnterpriseVocAnalysisTaskResponseBodyDataUsage& setInputTokens(int64_t inputTokens) { DARABONBA_PTR_SET_VALUE(inputTokens_, inputTokens) };
    ...
    inline GetEnterpriseVocAnalysisTaskResponseBodyDataUsage& setOutputTokens(int64_t outputTokens) { DARABONBA_PTR_SET_VALUE(outputTokens_, outputTokens) };
