...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDatasetDocumentsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListDatasetDocumentsResponseBodyData>) };
    inline vector<ListDatasetDocumentsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListDatasetDocumentsResponseBodyData>) };
    inline ListDatasetDocumentsResponseBody& setData(const vector<ListDatasetDocumentsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDatasetDocumentsResponseBody& setData(vector<ListDatasetDocumentsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDatasetDocumentsResponseBodyData>> data_ = nullptr;
