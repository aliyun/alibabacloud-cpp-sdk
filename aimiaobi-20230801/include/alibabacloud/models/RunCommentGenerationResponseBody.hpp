...
namespace Models
{
  ...
  public:
    ...
    inline const RunCommentGenerationResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunCommentGenerationResponseBody::Header) };
    inline RunCommentGenerationResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunCommentGenerationResponseBody::Header) };
    inline RunCommentGenerationResponseBody& setHeader(const RunCommentGenerationResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunCommentGenerationResponseBody& setHeader(RunCommentGenerationResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunCommentGenerationResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunCommentGenerationResponseBody::Payload) };
    inline RunCommentGenerationResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunCommentGenerationResponseBody::Payload) };
    inline RunCommentGenerationResponseBody& setPayload(const RunCommentGenerationResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunCommentGenerationResponseBody& setPayload(RunCommentGenerationResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
