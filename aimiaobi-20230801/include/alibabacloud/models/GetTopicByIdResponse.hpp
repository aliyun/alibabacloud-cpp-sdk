...
namespace Models
{
  ...
  public:
    ...
    inline const GetTopicByIdResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetTopicByIdResponseBody) };
    inline GetTopicByIdResponseBody body() { DARABONBA_PTR_GET(body_, GetTopicByIdResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetTopicByIdResponseBody> body_ = nullptr;
  };
