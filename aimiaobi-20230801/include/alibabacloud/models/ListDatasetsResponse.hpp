...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatasetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDatasetsResponseBody) };
    inline ListDatasetsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDatasetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDatasetsResponseBody> body_ {};
  };
