...
namespace Models
{
  ...
  public:
    ...
    inline const GetCustomSourceTopicAnalysisTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCustomSourceTopicAnalysisTaskResponseBodyData) };
    inline GetCustomSourceTopicAnalysisTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCustomSourceTopicAnalysisTaskResponseBodyData) };
    inline GetCustomSourceTopicAnalysisTaskResponseBody& setData(const GetCustomSourceTopicAnalysisTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCustomSourceTopicAnalysisTaskResponseBody& setData(GetCustomSourceTopicAnalysisTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetCustomSourceTopicAnalysisTaskResponseBodyData> data_ = nullptr;
