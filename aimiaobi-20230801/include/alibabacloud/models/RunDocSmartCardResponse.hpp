...
namespace Models
{
  ...
  public:
    ...
    inline RunDocSmartCardResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunDocSmartCardResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunDocSmartCardResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunDocSmartCardResponseBody) };
    inline RunDocSmartCardResponseBody getBody() { DARABONBA_PTR_GET(body_, RunDocSmartCardResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunDocSmartCardResponseBody> body_ {};
  };
