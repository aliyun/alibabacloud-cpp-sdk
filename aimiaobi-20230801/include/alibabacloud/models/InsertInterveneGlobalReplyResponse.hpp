...
namespace Models
{
  ...
  public:
    ...
    inline const InsertInterveneGlobalReplyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InsertInterveneGlobalReplyResponseBody) };
    inline InsertInterveneGlobalReplyResponseBody getBody() { DARABONBA_PTR_GET(body_, InsertInterveneGlobalReplyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InsertInterveneGlobalReplyResponseBody> body_ {};
  };
