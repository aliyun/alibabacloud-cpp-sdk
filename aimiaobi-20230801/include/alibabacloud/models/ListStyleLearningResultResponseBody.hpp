...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListStyleLearningResultResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListStyleLearningResultResponseBodyData>) };
    inline vector<ListStyleLearningResultResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListStyleLearningResultResponseBodyData>) };
    inline ListStyleLearningResultResponseBody& setData(const vector<ListStyleLearningResultResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListStyleLearningResultResponseBody& setData(vector<ListStyleLearningResultResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListStyleLearningResultResponseBodyData>> data_ = nullptr;
