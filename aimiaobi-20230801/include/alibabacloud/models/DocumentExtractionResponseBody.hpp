...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DocumentExtractionResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DocumentExtractionResponseBodyData>) };
    inline vector<DocumentExtractionResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DocumentExtractionResponseBodyData>) };
    inline DocumentExtractionResponseBody& setData(const vector<DocumentExtractionResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DocumentExtractionResponseBody& setData(vector<DocumentExtractionResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DocumentExtractionResponseBodyData>> data_ = nullptr;
