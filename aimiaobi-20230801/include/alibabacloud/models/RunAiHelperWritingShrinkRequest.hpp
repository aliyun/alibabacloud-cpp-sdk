...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->distributeWriting_ == nullptr
        && return this->prompt_ == nullptr && return this->promptMode_ == nullptr && return this->workspaceId_ == nullptr && return this->writingParamsShrink_ == nullptr && return this->writingScene_ == nullptr
