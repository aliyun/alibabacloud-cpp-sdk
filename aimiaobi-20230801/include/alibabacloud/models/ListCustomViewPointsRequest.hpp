...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentKey_ == nullptr
        && this->attitude_ == nullptr && this->attitudes_ == nullptr && this->customViewPointId_ == nullptr && this->customViewPointIds_ == nullptr && this->maxResults_ == nullptr
    ...
    inline const vector<string> & getAttitudes() const { DARABONBA_PTR_GET_CONST(attitudes_, vector<string>) };
    inline vector<string> getAttitudes() { DARABONBA_PTR_GET(attitudes_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> attitudes_ {};
