...
namespace Models
{
  ...
  public:
    ...
    inline const GetCustomHotTopicBroadcastJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCustomHotTopicBroadcastJobResponseBodyData) };
    inline GetCustomHotTopicBroadcastJobResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCustomHotTopicBroadcastJobResponseBodyData) };
    inline GetCustomHotTopicBroadcastJobResponseBody& setData(const GetCustomHotTopicBroadcastJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCustomHotTopicBroadcastJobResponseBody& setData(GetCustomHotTopicBroadcastJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetCustomHotTopicBroadcastJobResponseBodyData> data_ = nullptr;
