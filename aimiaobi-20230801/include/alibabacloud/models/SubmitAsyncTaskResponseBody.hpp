...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitAsyncTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SubmitAsyncTaskResponseBodyData) };
    inline SubmitAsyncTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, SubmitAsyncTaskResponseBodyData) };
    inline SubmitAsyncTaskResponseBody& setData(const SubmitAsyncTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitAsyncTaskResponseBody& setData(SubmitAsyncTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitAsyncTaskResponseBodyData> data_ = nullptr;
