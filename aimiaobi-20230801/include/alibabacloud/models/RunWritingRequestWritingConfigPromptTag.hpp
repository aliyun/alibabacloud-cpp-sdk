...
#ifndef ALIBABACLOUD_MODELS_RUNWRITINGREQUESTWRITINGCONFIGPROMPTTAG_HPP_
#define ALIBABACLOUD_MODELS_RUNWRITINGREQUESTWRITINGCONFIGPROMPTTAG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RunWritingRequestWritingConfigPromptTag& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RunWritingRequestWritingConfigPromptTag& obj) { 
    ...
    RunWritingRequestWritingConfigPromptTag() = default ;
    RunWritingRequestWritingConfigPromptTag(const RunWritingRequestWritingConfigPromptTag &) = default ;
    RunWritingRequestWritingConfigPromptTag(RunWritingRequestWritingConfigPromptTag &&) = default ;
    RunWritingRequestWritingConfigPromptTag(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RunWritingRequestWritingConfigPromptTag() = default ;
    RunWritingRequestWritingConfigPromptTag& operator=(const RunWritingRequestWritingConfigPromptTag &) = default ;
    RunWritingRequestWritingConfigPromptTag& operator=(RunWritingRequestWritingConfigPromptTag &&) = default ;
    ...
    inline RunWritingRequestWritingConfigPromptTag& setNecessaryTips(string necessaryTips) { DARABONBA_PTR_SET_VALUE(necessaryTips_, necessaryTips) };
    ...
    inline RunWritingRequestWritingConfigPromptTag& setPosition(string position) { DARABONBA_PTR_SET_VALUE(position_, position) };
    ...
    inline RunWritingRequestWritingConfigPromptTag& setReverseWords(string reverseWords) { DARABONBA_PTR_SET_VALUE(reverseWords_, reverseWords) };
    ...
    inline RunWritingRequestWritingConfigPromptTag& setTheme(string theme) { DARABONBA_PTR_SET_VALUE(theme_, theme) };
