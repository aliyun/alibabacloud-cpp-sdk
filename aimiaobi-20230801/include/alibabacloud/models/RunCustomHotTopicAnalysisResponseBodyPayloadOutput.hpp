...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->articles_ == nullptr
        && return this->askUser_ == nullptr && return this->asyncTaskId_ == nullptr && return this->attitude_ == nullptr && return this->searchQuery_ == nullptr && return this->text_ == nullptr
