...
namespace Models
{
  ...
  public:
    ...
    inline const RunTitleGenerationResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunTitleGenerationResponseBody::Header) };
    inline RunTitleGenerationResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunTitleGenerationResponseBody::Header) };
    inline RunTitleGenerationResponseBody& setHeader(const RunTitleGenerationResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunTitleGenerationResponseBody& setHeader(RunTitleGenerationResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };
    ...
    inline const RunTitleGenerationResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunTitleGenerationResponseBody::Payload) };
    inline RunTitleGenerationResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunTitleGenerationResponseBody::Payload) };
    inline RunTitleGenerationResponseBody& setPayload(const RunTitleGenerationResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunTitleGenerationResponseBody& setPayload(RunTitleGenerationResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
