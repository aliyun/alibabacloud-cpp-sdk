...
namespace Models
{
  ...
  public:
    ...
    inline const ListStyleLearningResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListStyleLearningResultResponseBody) };
    inline ListStyleLearningResultResponseBody getBody() { DARABONBA_PTR_GET(body_, ListStyleLearningResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListStyleLearningResultResponseBody> body_ {};
  };
