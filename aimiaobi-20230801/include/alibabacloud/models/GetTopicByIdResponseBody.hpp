...
namespace Models
{
  ...
  public:
    ...
    inline const GetTopicByIdResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetTopicByIdResponseBody::Data) };
    inline GetTopicByIdResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetTopicByIdResponseBody::Data) };
    inline GetTopicByIdResponseBody& setData(const GetTopicByIdResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTopicByIdResponseBody& setData(GetTopicByIdResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
