...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListWritingStylesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListWritingStylesResponseBodyData>) };
    inline vector<ListWritingStylesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListWritingStylesResponseBodyData>) };
    inline ListWritingStylesResponseBody& setData(const vector<ListWritingStylesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListWritingStylesResponseBody& setData(vector<ListWritingStylesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListWritingStylesResponseBodyData>> data_ = nullptr;
