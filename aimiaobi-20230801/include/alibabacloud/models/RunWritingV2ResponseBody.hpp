  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline const GenerateTraceability & getGenerateTraceability() const { DARABONBA_PTR_GET_CONST(generateTraceability_, GenerateTraceability) };
        inline GenerateTraceability getGenerateTraceability() { DARABONBA_PTR_GET(generateTraceability_, GenerateTraceability) };
        inline Output& setGenerateTraceability(const GenerateTraceability & generateTraceability) { DARABONBA_PTR_SET_VALUE(generateTraceability_, generateTraceability) };
        inline Output& setGenerateTraceability(GenerateTraceability && generateTraceability) { DARABONBA_PTR_SET_RVALUE(generateTraceability_, generateTraceability) };
        ...
        inline const vector<WritingOutline> & getOutlines() const { DARABONBA_PTR_GET_CONST(outlines_, vector<WritingOutline>) };
        inline vector<WritingOutline> getOutlines() { DARABONBA_PTR_GET(outlines_, vector<WritingOutline>) };
        inline Output& setOutlines(const vector<WritingOutline> & outlines) { DARABONBA_PTR_SET_VALUE(outlines_, outlines) };
        inline Output& setOutlines(vector<WritingOutline> && outlines) { DARABONBA_PTR_SET_RVALUE(outlines_, outlines) };
        ...
        inline const OutlineSearchResult & getSearchResult() const { DARABONBA_PTR_GET_CONST(searchResult_, OutlineSearchResult) };
        inline OutlineSearchResult getSearchResult() { DARABONBA_PTR_GET(searchResult_, OutlineSearchResult) };
        inline Output& setSearchResult(const OutlineSearchResult & searchResult) { DARABONBA_PTR_SET_VALUE(searchResult_, searchResult) };
        inline Output& setSearchResult(OutlineSearchResult && searchResult) { DARABONBA_PTR_SET_RVALUE(searchResult_, searchResult) };
        ...
        void deleteTitle() { this->title_ = nullptr;};
        inline string getTitle() const { DARABONBA_PTR_GET_DEFAULT(title_, "") };
        inline Output& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline const RunWritingV2ResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunWritingV2ResponseBody::Header) };
    inline RunWritingV2ResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunWritingV2ResponseBody::Header) };
    inline RunWritingV2ResponseBody& setHeader(const RunWritingV2ResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunWritingV2ResponseBody& setHeader(RunWritingV2ResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunWritingV2ResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunWritingV2ResponseBody::Payload) };
    inline RunWritingV2ResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunWritingV2ResponseBody::Payload) };
    inline RunWritingV2ResponseBody& setPayload(const RunWritingV2ResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunWritingV2ResponseBody& setPayload(RunWritingV2ResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
