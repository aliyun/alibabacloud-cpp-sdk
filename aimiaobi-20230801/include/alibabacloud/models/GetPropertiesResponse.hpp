...
namespace Models
{
  ...
  public:
    ...
    inline const GetPropertiesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetPropertiesResponseBody) };
    inline GetPropertiesResponseBody body() { DARABONBA_PTR_GET(body_, GetPropertiesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetPropertiesResponseBody> body_ = nullptr;
  };
