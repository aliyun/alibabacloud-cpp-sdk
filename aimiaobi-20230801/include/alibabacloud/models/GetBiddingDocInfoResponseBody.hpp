...
namespace Models
{
  ...
  public:
    ...
    inline const GetBiddingDocInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetBiddingDocInfoResponseBodyData) };
    inline GetBiddingDocInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetBiddingDocInfoResponseBodyData) };
    inline GetBiddingDocInfoResponseBody& setData(const GetBiddingDocInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetBiddingDocInfoResponseBody& setData(GetBiddingDocInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetBiddingDocInfoResponseBodyData> data_ = nullptr;
