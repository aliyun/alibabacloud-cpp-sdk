...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->askUser_ == nullptr
        && return this->forceAnalysisExistsTopic_ == nullptr && return this->prompt_ == nullptr && return this->sessionId_ == nullptr && return this->taskId_ == nullptr && return this->userBack_ == nullptr
