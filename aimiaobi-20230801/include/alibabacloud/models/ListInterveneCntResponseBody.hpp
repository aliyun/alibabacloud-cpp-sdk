...
namespace Models
{
  ...
  public:
    ...
    inline const ListInterveneCntResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListInterveneCntResponseBodyData) };
    inline ListInterveneCntResponseBodyData data() { DARABONBA_PTR_GET(data_, ListInterveneCntResponseBodyData) };
    inline ListInterveneCntResponseBody& setData(const ListInterveneCntResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListInterveneCntResponseBody& setData(ListInterveneCntResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListInterveneCntResponseBodyData> data_ = nullptr;
