  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline Output& setTags(const vector<string> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
        inline Output& setTags(vector<string> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    inline const RunBookSmartCardResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunBookSmartCardResponseBody::Header) };
    inline RunBookSmartCardResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunBookSmartCardResponseBody::Header) };
    inline RunBookSmartCardResponseBody& setHeader(const RunBookSmartCardResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunBookSmartCardResponseBody& setHeader(RunBookSmartCardResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunBookSmartCardResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunBookSmartCardResponseBody::Payload) };
    inline RunBookSmartCardResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunBookSmartCardResponseBody::Payload) };
    inline RunBookSmartCardResponseBody& setPayload(const RunBookSmartCardResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunBookSmartCardResponseBody& setPayload(RunBookSmartCardResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
