...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentKey_ == nullptr
        && this->customerResponse_ == nullptr && this->goodText_ == nullptr && this->modifiedResponse_ == nullptr && this->rating_ == nullptr && this->ratingTagsShrink_ == nullptr
    ...
    inline string getRatingTagsShrink() const { DARABONBA_PTR_GET_DEFAULT(ratingTagsShrink_, "") };
