...
namespace Models
{
  ...
  public:
    ...
    inline const RunDeepWritingResponseBodyHeader & header() const { DARABONBA_PTR_GET_CONST(header_, RunDeepWritingResponseBodyHeader) };
    inline RunDeepWritingResponseBodyHeader header() { DARABONBA_PTR_GET(header_, RunDeepWritingResponseBodyHeader) };
    inline RunDeepWritingResponseBody& setHeader(const RunDeepWritingResponseBodyHeader & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunDeepWritingResponseBody& setHeader(RunDeepWritingResponseBodyHeader && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };
    ...
    inline const RunDeepWritingResponseBodyPayload & payload() const { DARABONBA_PTR_GET_CONST(payload_, RunDeepWritingResponseBodyPayload) };
    inline RunDeepWritingResponseBodyPayload payload() { DARABONBA_PTR_GET(payload_, RunDeepWritingResponseBodyPayload) };
    inline RunDeepWritingResponseBody& setPayload(const RunDeepWritingResponseBodyPayload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunDeepWritingResponseBody& setPayload(RunDeepWritingResponseBodyPayload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    ...
    std::shared_ptr<RunDeepWritingResponseBodyHeader> header_ = nullptr;
    std::shared_ptr<string> httpStatusCode_ = nullptr;
    std::shared_ptr<string> message_ = nullptr;
    std::shared_ptr<RunDeepWritingResponseBodyPayload> payload_ = nullptr;
