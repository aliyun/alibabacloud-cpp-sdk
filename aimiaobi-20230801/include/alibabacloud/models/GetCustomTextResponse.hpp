...
namespace Models
{
  ...
  public:
    ...
    inline const GetCustomTextResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCustomTextResponseBody) };
    inline GetCustomTextResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCustomTextResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCustomTextResponseBody> body_ {};
  };
