...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListPlanningProposalResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListPlanningProposalResponseBodyData>) };
    inline vector<ListPlanningProposalResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListPlanningProposalResponseBodyData>) };
    inline ListPlanningProposalResponseBody& setData(const vector<ListPlanningProposalResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListPlanningProposalResponseBody& setData(vector<ListPlanningProposalResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListPlanningProposalResponseBodyData>> data_ = nullptr;
