...
#ifndef ALIBABACLOUD_MODELS_RUNTOPICSELECTIONMERGERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_RUNTOPICSELECTIONMERGERESPONSEBODY_HPP_
...
namespace Models
{
  class RunTopicSelectionMergeResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const RunTopicSelectionMergeResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(End, end_);
      DARABONBA_PTR_TO_JSON(Header, header_);
      DARABONBA_PTR_TO_JSON(Payload, payload_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, RunTopicSelectionMergeResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(End, end_);
      DARABONBA_PTR_FROM_JSON(Header, header_);
      DARABONBA_PTR_FROM_JSON(Payload, payload_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    RunTopicSelectionMergeResponseBody() = default ;
    RunTopicSelectionMergeResponseBody(const RunTopicSelectionMergeResponseBody &) = default ;
    RunTopicSelectionMergeResponseBody(RunTopicSelectionMergeResponseBody &&) = default ;
    RunTopicSelectionMergeResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RunTopicSelectionMergeResponseBody() = default ;
    RunTopicSelectionMergeResponseBody& operator=(const RunTopicSelectionMergeResponseBody &) = default ;
    RunTopicSelectionMergeResponseBody& operator=(RunTopicSelectionMergeResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline const TopicSelection & getTopic() const { DARABONBA_PTR_GET_CONST(topic_, TopicSelection) };
        inline TopicSelection getTopic() { DARABONBA_PTR_GET(topic_, TopicSelection) };
        inline Output& setTopic(const TopicSelection & topic) { DARABONBA_PTR_SET_VALUE(topic_, topic) };
        inline Output& setTopic(TopicSelection && topic) { DARABONBA_PTR_SET_RVALUE(topic_, topic) };
    ...
    inline RunTopicSelectionMergeResponseBody& setEnd(bool end) { DARABONBA_PTR_SET_VALUE(end_, end) };


    // header Field Functions 
    bool hasHeader() const { return this->header_ != nullptr;};
    void deleteHeader() { this->header_ = nullptr;};
    inline const RunTopicSelectionMergeResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunTopicSelectionMergeResponseBody::Header) };
    inline RunTopicSelectionMergeResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunTopicSelectionMergeResponseBody::Header) };
    inline RunTopicSelectionMergeResponseBody& setHeader(const RunTopicSelectionMergeResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunTopicSelectionMergeResponseBody& setHeader(RunTopicSelectionMergeResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunTopicSelectionMergeResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunTopicSelectionMergeResponseBody::Payload) };
    inline RunTopicSelectionMergeResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunTopicSelectionMergeResponseBody::Payload) };
    inline RunTopicSelectionMergeResponseBody& setPayload(const RunTopicSelectionMergeResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunTopicSelectionMergeResponseBody& setPayload(RunTopicSelectionMergeResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
    ...
    inline RunTopicSelectionMergeResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
