...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->answerConfig_ == nullptr
        && return this->createTime_ == nullptr && return this->effectTime_ == nullptr && return this->interveneType_ == nullptr && return this->namespaceList_ == nullptr && return this->ruleId_ == nullptr
