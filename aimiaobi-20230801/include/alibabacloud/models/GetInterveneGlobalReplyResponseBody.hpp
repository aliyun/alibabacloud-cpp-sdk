...
namespace Models
{
  ...
  public:
    ...
    inline const GetInterveneGlobalReplyResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetInterveneGlobalReplyResponseBodyData) };
    inline GetInterveneGlobalReplyResponseBodyData data() { DARABONBA_PTR_GET(data_, GetInterveneGlobalReplyResponseBodyData) };
    inline GetInterveneGlobalReplyResponseBody& setData(const GetInterveneGlobalReplyResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInterveneGlobalReplyResponseBody& setData(GetInterveneGlobalReplyResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetInterveneGlobalReplyResponseBodyData> data_ = nullptr;
