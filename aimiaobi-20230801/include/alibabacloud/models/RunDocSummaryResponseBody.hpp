...
namespace Models
{
  ...
  public:
    ...
    inline const RunDocSummaryResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunDocSummaryResponseBody::Header) };
    inline RunDocSummaryResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunDocSummaryResponseBody::Header) };
    inline RunDocSummaryResponseBody& setHeader(const RunDocSummaryResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunDocSummaryResponseBody& setHeader(RunDocSummaryResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunDocSummaryResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunDocSummaryResponseBody::Payload) };
    inline RunDocSummaryResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunDocSummaryResponseBody::Payload) };
    inline RunDocSummaryResponseBody& setPayload(const RunDocSummaryResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunDocSummaryResponseBody& setPayload(RunDocSummaryResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    shared_ptr<RunDocSummaryResponseBody::Header> header_ {};
    shared_ptr<RunDocSummaryResponseBody::Payload> payload_ {};
