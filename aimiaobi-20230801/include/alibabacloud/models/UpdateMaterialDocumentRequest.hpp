...
#ifndef ALIBABACLOUD_MODELS_UPDATEMATERIALDOCUMENTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEMATERIALDOCUMENTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateMaterialDocumentRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateMaterialDocumentRequest& obj) { 
    ...
    UpdateMaterialDocumentRequest() = default ;
    UpdateMaterialDocumentRequest(const UpdateMaterialDocumentRequest &) = default ;
    UpdateMaterialDocumentRequest(UpdateMaterialDocumentRequest &&) = default ;
    UpdateMaterialDocumentRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateMaterialDocumentRequest() = default ;
    UpdateMaterialDocumentRequest& operator=(const UpdateMaterialDocumentRequest &) = default ;
    UpdateMaterialDocumentRequest& operator=(UpdateMaterialDocumentRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->agentKey_ == nullptr
        && return this->author_ == nullptr && return this->docKeywords_ == nullptr && return this->docType_ == nullptr && return this->externalUrl_ == nullptr && return this->htmlContent_ == nullptr
    ...
    inline UpdateMaterialDocumentRequest& setAgentKey(string agentKey) { DARABONBA_PTR_SET_VALUE(agentKey_, agentKey) };
    ...
    inline UpdateMaterialDocumentRequest& setAuthor(string author) { DARABONBA_PTR_SET_VALUE(author_, author) };
    ...
    inline UpdateMaterialDocumentRequest& setDocKeywords(const vector<string> & docKeywords) { DARABONBA_PTR_SET_VALUE(docKeywords_, docKeywords) };
    inline UpdateMaterialDocumentRequest& setDocKeywords(vector<string> && docKeywords) { DARABONBA_PTR_SET_RVALUE(docKeywords_, docKeywords) };
    ...
    inline UpdateMaterialDocumentRequest& setDocType(string docType) { DARABONBA_PTR_SET_VALUE(docType_, docType) };
    ...
    inline UpdateMaterialDocumentRequest& setExternalUrl(string externalUrl) { DARABONBA_PTR_SET_VALUE(externalUrl_, externalUrl) };
    ...
    inline UpdateMaterialDocumentRequest& setHtmlContent(string htmlContent) { DARABONBA_PTR_SET_VALUE(htmlContent_, htmlContent) };
    ...
    inline UpdateMaterialDocumentRequest& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UpdateMaterialDocumentRequest& setPubTime(string pubTime) { DARABONBA_PTR_SET_VALUE(pubTime_, pubTime) };
    ...
    inline UpdateMaterialDocumentRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline UpdateMaterialDocumentRequest& setShareAttr(int32_t shareAttr) { DARABONBA_PTR_SET_VALUE(shareAttr_, shareAttr) };
    ...
    inline UpdateMaterialDocumentRequest& setSrcFrom(string srcFrom) { DARABONBA_PTR_SET_VALUE(srcFrom_, srcFrom) };
    ...
    inline UpdateMaterialDocumentRequest& setSummary(string summary) { DARABONBA_PTR_SET_VALUE(summary_, summary) };
    ...
    inline UpdateMaterialDocumentRequest& setTextContent(string textContent) { DARABONBA_PTR_SET_VALUE(textContent_, textContent) };
    ...
    inline UpdateMaterialDocumentRequest& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline UpdateMaterialDocumentRequest& setUrl(string url) { DARABONBA_PTR_SET_VALUE(url_, url) };
