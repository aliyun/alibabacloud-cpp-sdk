...
namespace Models
{
  ...
  public:
    ...
    inline const ListTimedViewAttitudeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTimedViewAttitudeResponseBody) };
    inline ListTimedViewAttitudeResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTimedViewAttitudeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTimedViewAttitudeResponseBody> body_ {};
  };
