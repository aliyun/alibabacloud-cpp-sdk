...
namespace Models
{
  ...
  public:
    ...
    inline RunSearchSimilarArticlesResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunSearchSimilarArticlesResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };
