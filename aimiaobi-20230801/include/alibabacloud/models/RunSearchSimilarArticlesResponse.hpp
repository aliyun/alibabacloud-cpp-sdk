...
namespace Models
{
  ...
  public:
    ...
    inline const RunSearchSimilarArticlesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RunSearchSimilarArticlesResponseBody) };
    inline RunSearchSimilarArticlesResponseBody body() { DARABONBA_PTR_GET(body_, RunSearchSimilarArticlesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RunSearchSimilarArticlesResponseBody> body_ = nullptr;
  };
