...
namespace Models
{
  ...
  public:
    ...
    class DocumentHandleConfig : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const DocumentHandleConfig& obj) { 
        DARABONBA_PTR_TO_JSON(DisableHandleMultimodalMedia, disableHandleMultimodalMedia_);
      };
      friend void from_json(const Darabonba::Json& j, DocumentHandleConfig& obj) { 
        DARABONBA_PTR_FROM_JSON(DisableHandleMultimodalMedia, disableHandleMultimodalMedia_);
      };
      DocumentHandleConfig() = default ;
      DocumentHandleConfig(const DocumentHandleConfig &) = default ;
      DocumentHandleConfig(DocumentHandleConfig &&) = default ;
      DocumentHandleConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~DocumentHandleConfig() = default ;
      DocumentHandleConfig& operator=(const DocumentHandleConfig &) = default ;
      DocumentHandleConfig& operator=(DocumentHandleConfig &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline DocumentHandleConfig& setDisableHandleMultimodalMedia(bool disableHandleMultimodalMedia) { DARABONBA_PTR_SET_VALUE(disableHandleMultimodalMedia_, disableHandleMultimodalMedia) };
    ...
    inline const CreateDatasetRequest::DatasetConfig & getDatasetConfig() const { DARABONBA_PTR_GET_CONST(datasetConfig_, CreateDatasetRequest::DatasetConfig) };
    inline CreateDatasetRequest::DatasetConfig getDatasetConfig() { DARABONBA_PTR_GET(datasetConfig_, CreateDatasetRequest::DatasetConfig) };
    inline CreateDatasetRequest& setDatasetConfig(const CreateDatasetRequest::DatasetConfig & datasetConfig) { DARABONBA_PTR_SET_VALUE(datasetConfig_, datasetConfig) };
    inline CreateDatasetRequest& setDatasetConfig(CreateDatasetRequest::DatasetConfig && datasetConfig) { DARABONBA_PTR_SET_RVALUE(datasetConfig_, datasetConfig) };
    ...
    inline const CreateDatasetRequest::DocumentHandleConfig & getDocumentHandleConfig() const { DARABONBA_PTR_GET_CONST(documentHandleConfig_, CreateDatasetRequest::DocumentHandleConfig) };
    inline CreateDatasetRequest::DocumentHandleConfig getDocumentHandleConfig() { DARABONBA_PTR_GET(documentHandleConfig_, CreateDatasetRequest::DocumentHandleConfig) };
    inline CreateDatasetRequest& setDocumentHandleConfig(const CreateDatasetRequest::DocumentHandleConfig & documentHandleConfig) { DARABONBA_PTR_SET_VALUE(documentHandleConfig_, documentHandleConfig) };
    inline CreateDatasetRequest& setDocumentHandleConfig(CreateDatasetRequest::DocumentHandleConfig && documentHandleConfig) { DARABONBA_PTR_SET_RVALUE(documentHandleConfig_, documentHandleConfig) };
