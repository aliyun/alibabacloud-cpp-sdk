...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGeneralConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateGeneralConfigResponseBodyData) };
    inline CreateGeneralConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateGeneralConfigResponseBodyData) };
    inline CreateGeneralConfigResponseBody& setData(const CreateGeneralConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateGeneralConfigResponseBody& setData(CreateGeneralConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateGeneralConfigResponseBodyData> data_ = nullptr;
