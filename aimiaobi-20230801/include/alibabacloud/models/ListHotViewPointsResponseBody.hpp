...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHotViewPointsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListHotViewPointsResponseBodyData>) };
    inline vector<ListHotViewPointsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListHotViewPointsResponseBodyData>) };
    inline ListHotViewPointsResponseBody& setData(const vector<ListHotViewPointsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHotViewPointsResponseBody& setData(vector<ListHotViewPointsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHotViewPointsResponseBodyData>> data_ = nullptr;
