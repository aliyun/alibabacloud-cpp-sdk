...
namespace Models
{
  ...
  public:
    ...
    inline const GetInterveneImportTaskInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInterveneImportTaskInfoResponseBody) };
    inline GetInterveneImportTaskInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInterveneImportTaskInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInterveneImportTaskInfoResponseBody> body_ {};
  };
