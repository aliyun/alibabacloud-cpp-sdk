...
namespace Models
{
  ...
  public:
    ...
    inline const RunKeywordsExtractionGenerationRequest::ReferenceData & getReferenceData() const { DARABONBA_PTR_GET_CONST(referenceData_, RunKeywordsExtractionGenerationRequest::ReferenceData) };
    inline RunKeywordsExtractionGenerationRequest::ReferenceData getReferenceData() { DARABONBA_PTR_GET(referenceData_, RunKeywordsExtractionGenerationRequest::ReferenceData) };
    inline RunKeywordsExtractionGenerationRequest& setReferenceData(const RunKeywordsExtractionGenerationRequest::ReferenceData & referenceData) { DARABONBA_PTR_SET_VALUE(referenceData_, referenceData) };
    inline RunKeywordsExtractionGenerationRequest& setReferenceData(RunKeywordsExtractionGenerationRequest::ReferenceData && referenceData) { DARABONBA_PTR_SET_RVALUE(referenceData_, referenceData) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<RunKeywordsExtractionGenerationRequest::ReferenceData> referenceData_ {};
