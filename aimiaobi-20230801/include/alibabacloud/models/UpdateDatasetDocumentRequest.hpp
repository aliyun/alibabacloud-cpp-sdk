...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetId_ == nullptr
        && return this->datasetName_ == nullptr && return this->document_ == nullptr && return this->workspaceId_ == nullptr; };
    ...
    inline const UpdateDatasetDocumentRequestDocument & document() const { DARABONBA_PTR_GET_CONST(document_, UpdateDatasetDocumentRequestDocument) };
    inline UpdateDatasetDocumentRequestDocument document() { DARABONBA_PTR_GET(document_, UpdateDatasetDocumentRequestDocument) };
    inline UpdateDatasetDocumentRequest& setDocument(const UpdateDatasetDocumentRequestDocument & document) { DARABONBA_PTR_SET_VALUE(document_, document) };
    inline UpdateDatasetDocumentRequest& setDocument(UpdateDatasetDocumentRequestDocument && document) { DARABONBA_PTR_SET_RVALUE(document_, document) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateDatasetDocumentRequestDocument> document_ = nullptr;
