...
namespace Models
{
  ...
  public:
    ...
    inline const RunBookIntroductionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RunBookIntroductionResponseBody) };
    inline RunBookIntroductionResponseBody body() { DARABONBA_PTR_GET(body_, RunBookIntroductionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RunBookIntroductionResponseBody> body_ = nullptr;
  };
