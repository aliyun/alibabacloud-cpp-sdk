...
namespace Models
{
  ...
  public:
    ...
    inline RunBookIntroductionResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunBookIntroductionResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };
