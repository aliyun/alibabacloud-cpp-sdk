...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocClusterTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDocClusterTaskResponseBodyData) };
    inline GetDocClusterTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDocClusterTaskResponseBodyData) };
    inline GetDocClusterTaskResponseBody& setData(const GetDocClusterTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDocClusterTaskResponseBody& setData(GetDocClusterTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDocClusterTaskResponseBodyData> data_ = nullptr;
