...
namespace Models
{
  ...
  public:
    ...
    inline const RunExpandContentResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunExpandContentResponseBody::Header) };
    inline RunExpandContentResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunExpandContentResponseBody::Header) };
    inline RunExpandContentResponseBody& setHeader(const RunExpandContentResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunExpandContentResponseBody& setHeader(RunExpandContentResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunExpandContentResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunExpandContentResponseBody::Payload) };
    inline RunExpandContentResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunExpandContentResponseBody::Payload) };
    inline RunExpandContentResponseBody& setPayload(const RunExpandContentResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunExpandContentResponseBody& setPayload(RunExpandContentResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    ...
    shared_ptr<RunExpandContentResponseBody::Header> header_ {};
    shared_ptr<RunExpandContentResponseBody::Payload> payload_ {};
