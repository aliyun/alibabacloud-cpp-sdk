...
namespace Models
{
  ...
  public:
    ...
    inline const RunDocSmartCardResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunDocSmartCardResponseBody::Header) };
    inline RunDocSmartCardResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunDocSmartCardResponseBody::Header) };
    inline RunDocSmartCardResponseBody& setHeader(const RunDocSmartCardResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunDocSmartCardResponseBody& setHeader(RunDocSmartCardResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunDocSmartCardResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunDocSmartCardResponseBody::Payload) };
    inline RunDocSmartCardResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunDocSmartCardResponseBody::Payload) };
    inline RunDocSmartCardResponseBody& setPayload(const RunDocSmartCardResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunDocSmartCardResponseBody& setPayload(RunDocSmartCardResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
