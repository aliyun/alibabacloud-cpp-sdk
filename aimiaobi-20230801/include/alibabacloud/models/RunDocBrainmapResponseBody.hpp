...
namespace Models
{
  ...
  public:
    ...
    inline const RunDocBrainmapResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunDocBrainmapResponseBody::Header) };
    inline RunDocBrainmapResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunDocBrainmapResponseBody::Header) };
    inline RunDocBrainmapResponseBody& setHeader(const RunDocBrainmapResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunDocBrainmapResponseBody& setHeader(RunDocBrainmapResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunDocBrainmapResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunDocBrainmapResponseBody::Payload) };
    inline RunDocBrainmapResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunDocBrainmapResponseBody::Payload) };
    inline RunDocBrainmapResponseBody& setPayload(const RunDocBrainmapResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunDocBrainmapResponseBody& setPayload(RunDocBrainmapResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    shared_ptr<RunDocBrainmapResponseBody::Header> header_ {};
    shared_ptr<RunDocBrainmapResponseBody::Payload> payload_ {};
