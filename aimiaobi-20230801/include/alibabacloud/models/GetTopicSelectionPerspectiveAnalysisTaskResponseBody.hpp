...
namespace Models
{
  ...
  public:
    ...
    inline const GetTopicSelectionPerspectiveAnalysisTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTopicSelectionPerspectiveAnalysisTaskResponseBodyData) };
    inline GetTopicSelectionPerspectiveAnalysisTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTopicSelectionPerspectiveAnalysisTaskResponseBodyData) };
    inline GetTopicSelectionPerspectiveAnalysisTaskResponseBody& setData(const GetTopicSelectionPerspectiveAnalysisTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTopicSelectionPerspectiveAnalysisTaskResponseBody& setData(GetTopicSelectionPerspectiveAnalysisTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetTopicSelectionPerspectiveAnalysisTaskResponseBodyData> data_ = nullptr;
