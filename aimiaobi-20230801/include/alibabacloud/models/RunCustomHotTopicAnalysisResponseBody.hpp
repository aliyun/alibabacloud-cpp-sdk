...
namespace Models
{
  ...
  public:
    ...
    inline const RunCustomHotTopicAnalysisResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunCustomHotTopicAnalysisResponseBody::Header) };
    inline RunCustomHotTopicAnalysisResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunCustomHotTopicAnalysisResponseBody::Header) };
    inline RunCustomHotTopicAnalysisResponseBody& setHeader(const RunCustomHotTopicAnalysisResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunCustomHotTopicAnalysisResponseBody& setHeader(RunCustomHotTopicAnalysisResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunCustomHotTopicAnalysisResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunCustomHotTopicAnalysisResponseBody::Payload) };
    inline RunCustomHotTopicAnalysisResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunCustomHotTopicAnalysisResponseBody::Payload) };
    inline RunCustomHotTopicAnalysisResponseBody& setPayload(const RunCustomHotTopicAnalysisResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunCustomHotTopicAnalysisResponseBody& setPayload(RunCustomHotTopicAnalysisResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
