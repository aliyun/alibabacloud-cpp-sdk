...
namespace Models
{
  ...
  public:
    ...
    inline const RunBookIntroductionResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunBookIntroductionResponseBody::Header) };
    inline RunBookIntroductionResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunBookIntroductionResponseBody::Header) };
    inline RunBookIntroductionResponseBody& setHeader(const RunBookIntroductionResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunBookIntroductionResponseBody& setHeader(RunBookIntroductionResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunBookIntroductionResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunBookIntroductionResponseBody::Payload) };
    inline RunBookIntroductionResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunBookIntroductionResponseBody::Payload) };
    inline RunBookIntroductionResponseBody& setPayload(const RunBookIntroductionResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunBookIntroductionResponseBody& setPayload(RunBookIntroductionResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
