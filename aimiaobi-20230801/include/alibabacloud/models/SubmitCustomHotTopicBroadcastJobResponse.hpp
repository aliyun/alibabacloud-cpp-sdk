...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitCustomHotTopicBroadcastJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitCustomHotTopicBroadcastJobResponseBody) };
    inline SubmitCustomHotTopicBroadcastJobResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitCustomHotTopicBroadcastJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitCustomHotTopicBroadcastJobResponseBody> body_ {};
  };
