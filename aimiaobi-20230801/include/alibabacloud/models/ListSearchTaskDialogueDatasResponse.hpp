...
namespace Models
{
  ...
  public:
    ...
    inline const ListSearchTaskDialogueDatasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSearchTaskDialogueDatasResponseBody) };
    inline ListSearchTaskDialogueDatasResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSearchTaskDialogueDatasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSearchTaskDialogueDatasResponseBody> body_ {};
  };
