...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->editingConfigShrink_ == nullptr
        && this->extendParam_ == nullptr && this->inputConfigShrink_ == nullptr && this->outputConfigShrink_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline string getEditingConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(editingConfigShrink_, "") };
    ...
    inline string getInputConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(inputConfigShrink_, "") };
    ...
    inline string getOutputConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(outputConfigShrink_, "") };
