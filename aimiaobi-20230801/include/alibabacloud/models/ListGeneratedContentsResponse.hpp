...
namespace Models
{
  ...
  public:
    ...
    inline const ListGeneratedContentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListGeneratedContentsResponseBody) };
    inline ListGeneratedContentsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListGeneratedContentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListGeneratedContentsResponseBody> body_ {};
  };
