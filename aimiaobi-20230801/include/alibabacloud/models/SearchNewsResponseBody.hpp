...
#ifndef ALIBABACLOUD_MODELS_SEARCHNEWSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchNewsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SearchNewsResponseBody& obj) { 
    ...
    SearchNewsResponseBody() = default ;
    SearchNewsResponseBody(const SearchNewsResponseBody &) = default ;
    SearchNewsResponseBody(SearchNewsResponseBody &&) = default ;
    SearchNewsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchNewsResponseBody() = default ;
    SearchNewsResponseBody& operator=(const SearchNewsResponseBody &) = default ;
    SearchNewsResponseBody& operator=(SearchNewsResponseBody &&) = default ;
