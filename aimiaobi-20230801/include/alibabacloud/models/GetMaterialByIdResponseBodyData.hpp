...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->author_ == nullptr
        && return this->createTime_ == nullptr && return this->createUser_ == nullptr && return this->docKeywords_ == nullptr && return this->docType_ == nullptr && return this->externalUrl_ == nullptr
        && return this->htmlContent_ == nullptr && return this->id_ == nullptr && return this->pubTime_ == nullptr && return this->publicUrl_ == nullptr && return this->shareAttr_ == nullptr
        && return this->srcFrom_ == nullptr && return this->summary_ == nullptr && return this->textContent_ == nullptr && return this->thumbnailInBase64_ == nullptr && return this->title_ == nullptr
        && return this->updateTime_ == nullptr && return this->updateUser_ == nullptr && return this->url_ == nullptr; };
