...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatasetDocumentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDatasetDocumentsResponseBody) };
    inline ListDatasetDocumentsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDatasetDocumentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDatasetDocumentsResponseBody> body_ {};
  };
