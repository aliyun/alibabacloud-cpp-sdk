...
namespace Models
{
  ...
  public:
    ...
    inline const GetAuditNotePostProcessingStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAuditNotePostProcessingStatusResponseBodyData) };
    inline GetAuditNotePostProcessingStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAuditNotePostProcessingStatusResponseBodyData) };
    inline GetAuditNotePostProcessingStatusResponseBody& setData(const GetAuditNotePostProcessingStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAuditNotePostProcessingStatusResponseBody& setData(GetAuditNotePostProcessingStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAuditNotePostProcessingStatusResponseBodyData> data_ = nullptr;
