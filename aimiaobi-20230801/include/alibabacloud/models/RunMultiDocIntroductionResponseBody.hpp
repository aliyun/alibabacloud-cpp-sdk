  ...
  public:
    ...
    public:
      ...
      public:
        ...
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        class KeyPoints : public Darabonba::Model {
        public:
          friend void to_json(Darabonba::Json& j, const KeyPoints& obj) { 
            DARABONBA_PTR_TO_JSON(KeyPoint, keyPoint_);
            DARABONBA_PTR_TO_JSON(Source, source_);
          };
          friend void from_json(const Darabonba::Json& j, KeyPoints& obj) { 
          ...
          KeyPoints(const Darabonba::Json & obj) { from_json(obj, *this); };
          virtual ~KeyPoints() = default ;
          KeyPoints& operator=(const KeyPoints &) = default ;
          KeyPoints& operator=(KeyPoints &&) = default ;
          virtual void validate() const override {
          };
          virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
          virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        && this->source_ == nullptr; };
          ...
          inline KeyPoints& setKeyPoint(string keyPoint) { DARABONBA_PTR_SET_VALUE(keyPoint_, keyPoint) };
          ...
          inline KeyPoints& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
        ...
        inline const vector<Output::KeyPoints> & getKeyPoints() const { DARABONBA_PTR_GET_CONST(keyPoints_, vector<Output::KeyPoints>) };
        inline vector<Output::KeyPoints> getKeyPoints() { DARABONBA_PTR_GET(keyPoints_, vector<Output::KeyPoints>) };
        inline Output& setKeyPoints(const vector<Output::KeyPoints> & keyPoints) { DARABONBA_PTR_SET_VALUE(keyPoints_, keyPoints) };
        inline Output& setKeyPoints(vector<Output::KeyPoints> && keyPoints) { DARABONBA_PTR_SET_RVALUE(keyPoints_, keyPoints) };
    ...
    inline const RunMultiDocIntroductionResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunMultiDocIntroductionResponseBody::Header) };
    inline RunMultiDocIntroductionResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunMultiDocIntroductionResponseBody::Header) };
    inline RunMultiDocIntroductionResponseBody& setHeader(const RunMultiDocIntroductionResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunMultiDocIntroductionResponseBody& setHeader(RunMultiDocIntroductionResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunMultiDocIntroductionResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunMultiDocIntroductionResponseBody::Payload) };
    inline RunMultiDocIntroductionResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunMultiDocIntroductionResponseBody::Payload) };
    inline RunMultiDocIntroductionResponseBody& setPayload(const RunMultiDocIntroductionResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunMultiDocIntroductionResponseBody& setPayload(RunMultiDocIntroductionResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
