...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->errorCode_ == nullptr
        && return this->errorMessage_ == nullptr && return this->pipelineRun_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetPipelineRunResponseBodyPipelineRun & pipelineRun() const { DARABONBA_PTR_GET_CONST(pipelineRun_, GetPipelineRunResponseBodyPipelineRun) };
    inline GetPipelineRunResponseBodyPipelineRun pipelineRun() { DARABONBA_PTR_GET(pipelineRun_, GetPipelineRunResponseBodyPipelineRun) };
    inline GetPipelineRunResponseBody& setPipelineRun(const GetPipelineRunResponseBodyPipelineRun & pipelineRun) { DARABONBA_PTR_SET_VALUE(pipelineRun_, pipelineRun) };
    inline GetPipelineRunResponseBody& setPipelineRun(GetPipelineRunResponseBodyPipelineRun && pipelineRun) { DARABONBA_PTR_SET_RVALUE(pipelineRun_, pipelineRun) };
    ...
    inline GetPipelineRunResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    std::shared_ptr<string> errorCode_ = nullptr;
    std::shared_ptr<string> errorMessage_ = nullptr;
    std::shared_ptr<GetPipelineRunResponseBodyPipelineRun> pipelineRun_ = nullptr;
