...
#ifndef ALIBABACLOUD_MODELS_CREATETAGRESPONSEBODYRESULTCOMMIT_HPP_
#define ALIBABACLOUD_MODELS_CREATETAGRESPONSEBODYRESULTCOMMIT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTagResponseBodyResultCommit& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTagResponseBodyResultCommit& obj) { 
    ...
    CreateTagResponseBodyResultCommit() = default ;
    CreateTagResponseBodyResultCommit(const CreateTagResponseBodyResultCommit &) = default ;
    CreateTagResponseBodyResultCommit(CreateTagResponseBodyResultCommit &&) = default ;
    CreateTagResponseBodyResultCommit(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTagResponseBodyResultCommit() = default ;
    CreateTagResponseBodyResultCommit& operator=(const CreateTagResponseBodyResultCommit &) = default ;
    CreateTagResponseBodyResultCommit& operator=(CreateTagResponseBodyResultCommit &&) = default ;
    ...
    inline CreateTagResponseBodyResultCommit& setAuthorEmail(string authorEmail) { DARABONBA_PTR_SET_VALUE(authorEmail_, authorEmail) };
    ...
    inline CreateTagResponseBodyResultCommit& setAuthorName(string authorName) { DARABONBA_PTR_SET_VALUE(authorName_, authorName) };
    ...
    inline CreateTagResponseBodyResultCommit& setAuthoredDate(string authoredDate) { DARABONBA_PTR_SET_VALUE(authoredDate_, authoredDate) };
    ...
    inline CreateTagResponseBodyResultCommit& setCommittedDate(string committedDate) { DARABONBA_PTR_SET_VALUE(committedDate_, committedDate) };
    ...
    inline CreateTagResponseBodyResultCommit& setCommitterEmail(string committerEmail) { DARABONBA_PTR_SET_VALUE(committerEmail_, committerEmail) };
    ...
    inline CreateTagResponseBodyResultCommit& setCommitterName(string committerName) { DARABONBA_PTR_SET_VALUE(committerName_, committerName) };
    ...
    inline CreateTagResponseBodyResultCommit& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };
    ...
    inline CreateTagResponseBodyResultCommit& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline CreateTagResponseBodyResultCommit& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateTagResponseBodyResultCommit& setParentIds(const vector<string> & parentIds) { DARABONBA_PTR_SET_VALUE(parentIds_, parentIds) };
    inline CreateTagResponseBodyResultCommit& setParentIds(vector<string> && parentIds) { DARABONBA_PTR_SET_RVALUE(parentIds_, parentIds) };
    ...
    inline CreateTagResponseBodyResultCommit& setShortId(string shortId) { DARABONBA_PTR_SET_VALUE(shortId_, shortId) };
    ...
    inline CreateTagResponseBodyResultCommit& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
