...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFileResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CreateFileResponseBodyResult) };
    inline CreateFileResponseBodyResult result() { DARABONBA_PTR_GET(result_, CreateFileResponseBodyResult) };
    inline CreateFileResponseBody& setResult(const CreateFileResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreateFileResponseBody& setResult(CreateFileResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<CreateFileResponseBodyResult> result_ = nullptr;
