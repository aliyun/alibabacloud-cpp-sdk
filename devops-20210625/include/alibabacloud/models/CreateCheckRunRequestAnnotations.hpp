...
#ifndef ALIBABACLOUD_MODELS_CREATECHECKRUNREQUESTANNOTATIONS_HPP_
#define ALIBABACLOUD_MODELS_CREATECHECKRUNREQUESTANNOTATIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateCheckRunRequestAnnotations& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateCheckRunRequestAnnotations& obj) { 
    ...
    CreateCheckRunRequestAnnotations() = default ;
    CreateCheckRunRequestAnnotations(const CreateCheckRunRequestAnnotations &) = default ;
    CreateCheckRunRequestAnnotations(CreateCheckRunRequestAnnotations &&) = default ;
    CreateCheckRunRequestAnnotations(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateCheckRunRequestAnnotations() = default ;
    CreateCheckRunRequestAnnotations& operator=(const CreateCheckRunRequestAnnotations &) = default ;
    CreateCheckRunRequestAnnotations& operator=(CreateCheckRunRequestAnnotations &&) = default ;
    ...
    inline CreateCheckRunRequestAnnotations& setAnnotationLevel(string annotationLevel) { DARABONBA_PTR_SET_VALUE(annotationLevel_, annotationLevel) };
    ...
    inline CreateCheckRunRequestAnnotations& setEndColumn(int64_t endColumn) { DARABONBA_PTR_SET_VALUE(endColumn_, endColumn) };
    ...
    inline CreateCheckRunRequestAnnotations& setEndLine(int64_t endLine) { DARABONBA_PTR_SET_VALUE(endLine_, endLine) };
    ...
    inline CreateCheckRunRequestAnnotations& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateCheckRunRequestAnnotations& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline CreateCheckRunRequestAnnotations& setRawDetails(string rawDetails) { DARABONBA_PTR_SET_VALUE(rawDetails_, rawDetails) };
    ...
    inline CreateCheckRunRequestAnnotations& setStartColumn(int64_t startColumn) { DARABONBA_PTR_SET_VALUE(startColumn_, startColumn) };
    ...
    inline CreateCheckRunRequestAnnotations& setStartLine(int64_t startLine) { DARABONBA_PTR_SET_VALUE(startLine_, startLine) };
    ...
    inline CreateCheckRunRequestAnnotations& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
