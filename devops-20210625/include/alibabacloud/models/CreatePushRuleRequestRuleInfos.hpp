...
#ifndef ALIBABACLOUD_MODELS_CREATEPUSHRULEREQUESTRULEINFOS_HPP_
#define ALIBABACLOUD_MODELS_CREATEPUSHRULEREQUESTRULEINFOS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePushRuleRequestRuleInfos& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePushRuleRequestRuleInfos& obj) { 
    ...
    CreatePushRuleRequestRuleInfos() = default ;
    CreatePushRuleRequestRuleInfos(const CreatePushRuleRequestRuleInfos &) = default ;
    CreatePushRuleRequestRuleInfos(CreatePushRuleRequestRuleInfos &&) = default ;
    CreatePushRuleRequestRuleInfos(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePushRuleRequestRuleInfos() = default ;
    CreatePushRuleRequestRuleInfos& operator=(const CreatePushRuleRequestRuleInfos &) = default ;
    CreatePushRuleRequestRuleInfos& operator=(CreatePushRuleRequestRuleInfos &&) = default ;
    ...
    inline CreatePushRuleRequestRuleInfos& setCheckerName(string checkerName) { DARABONBA_PTR_SET_VALUE(checkerName_, checkerName) };
    ...
    inline CreatePushRuleRequestRuleInfos& setCheckerType(string checkerType) { DARABONBA_PTR_SET_VALUE(checkerType_, checkerType) };
    ...
    inline CreatePushRuleRequestRuleInfos& setExtraMessage(string extraMessage) { DARABONBA_PTR_SET_VALUE(extraMessage_, extraMessage) };
    ...
    inline CreatePushRuleRequestRuleInfos& setFileRuleRegexes(const vector<string> & fileRuleRegexes) { DARABONBA_PTR_SET_VALUE(fileRuleRegexes_, fileRuleRegexes) };
    inline CreatePushRuleRequestRuleInfos& setFileRuleRegexes(vector<string> && fileRuleRegexes) { DARABONBA_PTR_SET_RVALUE(fileRuleRegexes_, fileRuleRegexes) };
