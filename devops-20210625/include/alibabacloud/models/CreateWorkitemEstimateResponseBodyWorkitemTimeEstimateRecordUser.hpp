...
#ifndef ALIBABACLOUD_MODELS_CREATEWORKITEMESTIMATERESPONSEBODYWORKITEMTIMEESTIMATERECORDUSER_HPP_
#define ALIBABACLOUD_MODELS_CREATEWORKITEMESTIMATERESPONSEBODYWORKITEMTIMEESTIMATERECORDUSER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& obj) { 
    ...
    CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser() = default ;
    CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser(const CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser &) = default ;
    CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser(CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser &&) = default ;
    CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser() = default ;
    CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& operator=(const CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser &) = default ;
    CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& operator=(CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser &&) = default ;
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setAccount(string account) { DARABONBA_PTR_SET_VALUE(account_, account) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setAvatar(string avatar) { DARABONBA_PTR_SET_VALUE(avatar_, avatar) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setDingTalkId(string dingTalkId) { DARABONBA_PTR_SET_VALUE(dingTalkId_, dingTalkId) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setDisplayNickName(string displayNickName) { DARABONBA_PTR_SET_VALUE(displayNickName_, displayNickName) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setDisplayRealName(string displayRealName) { DARABONBA_PTR_SET_VALUE(displayRealName_, displayRealName) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setGender(string gender) { DARABONBA_PTR_SET_VALUE(gender_, gender) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setIdentifier(string identifier) { DARABONBA_PTR_SET_VALUE(identifier_, identifier) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setIsDisabled(bool isDisabled) { DARABONBA_PTR_SET_VALUE(isDisabled_, isDisabled) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setNameEn(string nameEn) { DARABONBA_PTR_SET_VALUE(nameEn_, nameEn) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setNickName(string nickName) { DARABONBA_PTR_SET_VALUE(nickName_, nickName) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setNickNamePinyin(string nickNamePinyin) { DARABONBA_PTR_SET_VALUE(nickNamePinyin_, nickNamePinyin) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setRealName(string realName) { DARABONBA_PTR_SET_VALUE(realName_, realName) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setRealNamePinyin(string realNamePinyin) { DARABONBA_PTR_SET_VALUE(realNamePinyin_, realNamePinyin) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setStamp(string stamp) { DARABONBA_PTR_SET_VALUE(stamp_, stamp) };
    ...
    inline CreateWorkitemEstimateResponseBodyWorkitemTimeEstimateRecordUser& setTbRoleId(string tbRoleId) { DARABONBA_PTR_SET_VALUE(tbRoleId_, tbRoleId) };
