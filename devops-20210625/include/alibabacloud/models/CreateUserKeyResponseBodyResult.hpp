...
#ifndef ALIBABACLOUD_MODELS_CREATEUSERKEYRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_CREATEUSERKEYRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateUserKeyResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateUserKeyResponseBodyResult& obj) { 
    ...
    CreateUserKeyResponseBodyResult() = default ;
    CreateUserKeyResponseBodyResult(const CreateUserKeyResponseBodyResult &) = default ;
    CreateUserKeyResponseBodyResult(CreateUserKeyResponseBodyResult &&) = default ;
    CreateUserKeyResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateUserKeyResponseBodyResult() = default ;
    CreateUserKeyResponseBodyResult& operator=(const CreateUserKeyResponseBodyResult &) = default ;
    CreateUserKeyResponseBodyResult& operator=(CreateUserKeyResponseBodyResult &&) = default ;
    ...
    inline CreateUserKeyResponseBodyResult& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };
    ...
    inline CreateUserKeyResponseBodyResult& setExpireTime(string expireTime) { DARABONBA_PTR_SET_VALUE(expireTime_, expireTime) };
    ...
    inline CreateUserKeyResponseBodyResult& setFingerPrint(string fingerPrint) { DARABONBA_PTR_SET_VALUE(fingerPrint_, fingerPrint) };
    ...
    inline CreateUserKeyResponseBodyResult& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline CreateUserKeyResponseBodyResult& setKeyScope(string keyScope) { DARABONBA_PTR_SET_VALUE(keyScope_, keyScope) };
    ...
    inline CreateUserKeyResponseBodyResult& setLastUsedTime(string lastUsedTime) { DARABONBA_PTR_SET_VALUE(lastUsedTime_, lastUsedTime) };
    ...
    inline CreateUserKeyResponseBodyResult& setPublicKey(string publicKey) { DARABONBA_PTR_SET_VALUE(publicKey_, publicKey) };
    ...
    inline CreateUserKeyResponseBodyResult& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
