...
#ifndef ALIBABACLOUD_MODELS_CREATEPROTECTDBRANCHRESPONSEBODYRESULTMERGEREQUESTSETTING_HPP_
#define ALIBABACLOUD_MODELS_CREATEPROTECTDBRANCHRESPONSEBODYRESULTMERGEREQUESTSETTING_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateProtectdBranchResponseBodyResultMergeRequestSetting& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateProtectdBranchResponseBodyResultMergeRequestSetting& obj) { 
    ...
    CreateProtectdBranchResponseBodyResultMergeRequestSetting() = default ;
    CreateProtectdBranchResponseBodyResultMergeRequestSetting(const CreateProtectdBranchResponseBodyResultMergeRequestSetting &) = default ;
    CreateProtectdBranchResponseBodyResultMergeRequestSetting(CreateProtectdBranchResponseBodyResultMergeRequestSetting &&) = default ;
    CreateProtectdBranchResponseBodyResultMergeRequestSetting(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateProtectdBranchResponseBodyResultMergeRequestSetting() = default ;
    CreateProtectdBranchResponseBodyResultMergeRequestSetting& operator=(const CreateProtectdBranchResponseBodyResultMergeRequestSetting &) = default ;
    CreateProtectdBranchResponseBodyResultMergeRequestSetting& operator=(CreateProtectdBranchResponseBodyResultMergeRequestSetting &&) = default ;
    ...
    inline CreateProtectdBranchResponseBodyResultMergeRequestSetting& setAllowMergeRequestRoles(const vector<int32_t> & allowMergeRequestRoles) { DARABONBA_PTR_SET_VALUE(allowMergeRequestRoles_, allowMergeRequestRoles) };
    inline CreateProtectdBranchResponseBodyResultMergeRequestSetting& setAllowMergeRequestRoles(vector<int32_t> && allowMergeRequestRoles) { DARABONBA_PTR_SET_RVALUE(allowMergeRequestRoles_, allowMergeRequestRoles) };
    ...
    inline CreateProtectdBranchResponseBodyResultMergeRequestSetting& setDefaultAssignees(const vector<string> & defaultAssignees) { DARABONBA_PTR_SET_VALUE(defaultAssignees_, defaultAssignees) };
    inline CreateProtectdBranchResponseBodyResultMergeRequestSetting& setDefaultAssignees(vector<string> && defaultAssignees) { DARABONBA_PTR_SET_RVALUE(defaultAssignees_, defaultAssignees) };
    ...
    inline CreateProtectdBranchResponseBodyResultMergeRequestSetting& setIsAllowSelfApproval(bool isAllowSelfApproval) { DARABONBA_PTR_SET_VALUE(isAllowSelfApproval_, isAllowSelfApproval) };
    ...
    inline CreateProtectdBranchResponseBodyResultMergeRequestSetting& setIsRequireDiscussionProcessed(bool isRequireDiscussionProcessed) { DARABONBA_PTR_SET_VALUE(isRequireDiscussionProcessed_, isRequireDiscussionProcessed) };
    ...
    inline CreateProtectdBranchResponseBodyResultMergeRequestSetting& setIsRequired(bool isRequired) { DARABONBA_PTR_SET_VALUE(isRequired_, isRequired) };
    ...
    inline CreateProtectdBranchResponseBodyResultMergeRequestSetting& setIsResetApprovalWhenNewPush(bool isResetApprovalWhenNewPush) { DARABONBA_PTR_SET_VALUE(isResetApprovalWhenNewPush_, isResetApprovalWhenNewPush) };
    ...
    inline CreateProtectdBranchResponseBodyResultMergeRequestSetting& setMinimumApproval(int32_t minimumApproval) { DARABONBA_PTR_SET_VALUE(minimumApproval_, minimumApproval) };
    ...
    inline CreateProtectdBranchResponseBodyResultMergeRequestSetting& setMrMode(string mrMode) { DARABONBA_PTR_SET_VALUE(mrMode_, mrMode) };
    ...
    inline CreateProtectdBranchResponseBodyResultMergeRequestSetting& setWhiteList(string whiteList) { DARABONBA_PTR_SET_VALUE(whiteList_, whiteList) };
