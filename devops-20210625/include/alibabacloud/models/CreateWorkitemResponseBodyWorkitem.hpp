...
#ifndef ALIBABACLOUD_MODELS_CREATEWORKITEMRESPONSEBODYWORKITEM_HPP_
#define ALIBABACLOUD_MODELS_CREATEWORKITEMRESPONSEBODYWORKITEM_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateWorkitemResponseBodyWorkitem& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateWorkitemResponseBodyWorkitem& obj) { 
    ...
    CreateWorkitemResponseBodyWorkitem() = default ;
    CreateWorkitemResponseBodyWorkitem(const CreateWorkitemResponseBodyWorkitem &) = default ;
    CreateWorkitemResponseBodyWorkitem(CreateWorkitemResponseBodyWorkitem &&) = default ;
    CreateWorkitemResponseBodyWorkitem(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateWorkitemResponseBodyWorkitem() = default ;
    CreateWorkitemResponseBodyWorkitem& operator=(const CreateWorkitemResponseBodyWorkitem &) = default ;
    CreateWorkitemResponseBodyWorkitem& operator=(CreateWorkitemResponseBodyWorkitem &&) = default ;
    ...
    inline CreateWorkitemResponseBodyWorkitem& setAssignedTo(string assignedTo) { DARABONBA_PTR_SET_VALUE(assignedTo_, assignedTo) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setCategoryIdentifier(string categoryIdentifier) { DARABONBA_PTR_SET_VALUE(categoryIdentifier_, categoryIdentifier) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setDocument(string document) { DARABONBA_PTR_SET_VALUE(document_, document) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setDocumentFormat(string documentFormat) { DARABONBA_PTR_SET_VALUE(documentFormat_, documentFormat) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setGmtCreate(int64_t gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setGmtModified(int64_t gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setIdentifier(string identifier) { DARABONBA_PTR_SET_VALUE(identifier_, identifier) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setLogicalStatus(string logicalStatus) { DARABONBA_PTR_SET_VALUE(logicalStatus_, logicalStatus) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setModifier(string modifier) { DARABONBA_PTR_SET_VALUE(modifier_, modifier) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setParentIdentifier(string parentIdentifier) { DARABONBA_PTR_SET_VALUE(parentIdentifier_, parentIdentifier) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setSerialNumber(string serialNumber) { DARABONBA_PTR_SET_VALUE(serialNumber_, serialNumber) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setSpaceIdentifier(string spaceIdentifier) { DARABONBA_PTR_SET_VALUE(spaceIdentifier_, spaceIdentifier) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setSpaceName(string spaceName) { DARABONBA_PTR_SET_VALUE(spaceName_, spaceName) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setSpaceType(string spaceType) { DARABONBA_PTR_SET_VALUE(spaceType_, spaceType) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setSprintIdentifier(string sprintIdentifier) { DARABONBA_PTR_SET_VALUE(sprintIdentifier_, sprintIdentifier) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setStatusIdentifier(string statusIdentifier) { DARABONBA_PTR_SET_VALUE(statusIdentifier_, statusIdentifier) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setStatusStageIdentifier(string statusStageIdentifier) { DARABONBA_PTR_SET_VALUE(statusStageIdentifier_, statusStageIdentifier) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setSubject(string subject) { DARABONBA_PTR_SET_VALUE(subject_, subject) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setUpdateStatusAt(int64_t updateStatusAt) { DARABONBA_PTR_SET_VALUE(updateStatusAt_, updateStatusAt) };
    ...
    inline CreateWorkitemResponseBodyWorkitem& setWorkitemTypeIdentifier(string workitemTypeIdentifier) { DARABONBA_PTR_SET_VALUE(workitemTypeIdentifier_, workitemTypeIdentifier) };
