...
#ifndef ALIBABACLOUD_MODELS_LISTORGANIZATIONMEMBERSRESPONSEBODYMEMBERS_HPP_
#define ALIBABACLOUD_MODELS_LISTORGANIZATIONMEMBERSRESPONSEBODYMEMBERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListOrganizationMembersResponseBodyMembers& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListOrganizationMembersResponseBodyMembers& obj) { 
    ...
    ListOrganizationMembersResponseBodyMembers() = default ;
    ListOrganizationMembersResponseBodyMembers(const ListOrganizationMembersResponseBodyMembers &) = default ;
    ListOrganizationMembersResponseBodyMembers(ListOrganizationMembersResponseBodyMembers &&) = default ;
    ListOrganizationMembersResponseBodyMembers(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListOrganizationMembersResponseBodyMembers() = default ;
    ListOrganizationMembersResponseBodyMembers& operator=(const ListOrganizationMembersResponseBodyMembers &) = default ;
    ListOrganizationMembersResponseBodyMembers& operator=(ListOrganizationMembersResponseBodyMembers &&) = default ;
    ...
    inline ListOrganizationMembersResponseBodyMembers& setAccountId(string accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setBirthday(int64_t birthday) { DARABONBA_PTR_SET_VALUE(birthday_, birthday) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setDeptLists(const vector<string> & deptLists) { DARABONBA_PTR_SET_VALUE(deptLists_, deptLists) };
    inline ListOrganizationMembersResponseBodyMembers& setDeptLists(vector<string> && deptLists) { DARABONBA_PTR_SET_RVALUE(deptLists_, deptLists) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setHiredDate(int64_t hiredDate) { DARABONBA_PTR_SET_VALUE(hiredDate_, hiredDate) };
    ...
    inline const Models::ListOrganizationMembersResponseBodyMembersIdentities & identities() const { DARABONBA_PTR_GET_CONST(identities_, Models::ListOrganizationMembersResponseBodyMembersIdentities) };
    inline Models::ListOrganizationMembersResponseBodyMembersIdentities identities() { DARABONBA_PTR_GET(identities_, Models::ListOrganizationMembersResponseBodyMembersIdentities) };
    inline ListOrganizationMembersResponseBodyMembers& setIdentities(const Models::ListOrganizationMembersResponseBodyMembersIdentities & identities) { DARABONBA_PTR_SET_VALUE(identities_, identities) };
    inline ListOrganizationMembersResponseBodyMembers& setIdentities(Models::ListOrganizationMembersResponseBodyMembersIdentities && identities) { DARABONBA_PTR_SET_RVALUE(identities_, identities) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setJobNumber(string jobNumber) { DARABONBA_PTR_SET_VALUE(jobNumber_, jobNumber) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setJoinTime(int64_t joinTime) { DARABONBA_PTR_SET_VALUE(joinTime_, joinTime) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setLastVisitTime(int64_t lastVisitTime) { DARABONBA_PTR_SET_VALUE(lastVisitTime_, lastVisitTime) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setMobile(string mobile) { DARABONBA_PTR_SET_VALUE(mobile_, mobile) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setOrganizationMemberName(string organizationMemberName) { DARABONBA_PTR_SET_VALUE(organizationMemberName_, organizationMemberName) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setOrganizationRoleId(string organizationRoleId) { DARABONBA_PTR_SET_VALUE(organizationRoleId_, organizationRoleId) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setOrganizationRoleName(string organizationRoleName) { DARABONBA_PTR_SET_VALUE(organizationRoleName_, organizationRoleName) };
    ...
    inline ListOrganizationMembersResponseBodyMembers& setState(string state) { DARABONBA_PTR_SET_VALUE(state_, state) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ListOrganizationMembersResponseBodyMembersIdentities> identities_ = nullptr;
