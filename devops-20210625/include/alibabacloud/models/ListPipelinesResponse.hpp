...
namespace Models
{
  ...
  public:
    ...
    inline const ListPipelinesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListPipelinesResponseBody) };
    inline ListPipelinesResponseBody body() { DARABONBA_PTR_GET(body_, ListPipelinesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListPipelinesResponseBody> body_ = nullptr;
  };
