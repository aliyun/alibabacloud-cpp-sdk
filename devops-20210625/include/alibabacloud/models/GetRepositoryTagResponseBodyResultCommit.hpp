...
#ifndef ALIBABACLOUD_MODELS_GETREPOSITORYTAGRESPONSEBODYRESULTCOMMIT_HPP_
#define ALIBABACLOUD_MODELS_GETREPOSITORYTAGRESPONSEBODYRESULTCOMMIT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetRepositoryTagResponseBodyResultCommit& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetRepositoryTagResponseBodyResultCommit& obj) { 
    ...
    GetRepositoryTagResponseBodyResultCommit() = default ;
    GetRepositoryTagResponseBodyResultCommit(const GetRepositoryTagResponseBodyResultCommit &) = default ;
    GetRepositoryTagResponseBodyResultCommit(GetRepositoryTagResponseBodyResultCommit &&) = default ;
    GetRepositoryTagResponseBodyResultCommit(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetRepositoryTagResponseBodyResultCommit() = default ;
    GetRepositoryTagResponseBodyResultCommit& operator=(const GetRepositoryTagResponseBodyResultCommit &) = default ;
    GetRepositoryTagResponseBodyResultCommit& operator=(GetRepositoryTagResponseBodyResultCommit &&) = default ;
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setAuthorEmail(string authorEmail) { DARABONBA_PTR_SET_VALUE(authorEmail_, authorEmail) };
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setAuthorName(string authorName) { DARABONBA_PTR_SET_VALUE(authorName_, authorName) };
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setAuthoredDate(string authoredDate) { DARABONBA_PTR_SET_VALUE(authoredDate_, authoredDate) };
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setCommittedDate(string committedDate) { DARABONBA_PTR_SET_VALUE(committedDate_, committedDate) };
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setCommitterEmail(string committerEmail) { DARABONBA_PTR_SET_VALUE(committerEmail_, committerEmail) };
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setCommitterName(string committerName) { DARABONBA_PTR_SET_VALUE(committerName_, committerName) };
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setParentIds(const vector<string> & parentIds) { DARABONBA_PTR_SET_VALUE(parentIds_, parentIds) };
    inline GetRepositoryTagResponseBodyResultCommit& setParentIds(vector<string> && parentIds) { DARABONBA_PTR_SET_RVALUE(parentIds_, parentIds) };
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setShortId(string shortId) { DARABONBA_PTR_SET_VALUE(shortId_, shortId) };


    // signature Field Functions 
    bool hasSignature() const { return this->signature_ != nullptr;};
    void deleteSignature() { this->signature_ = nullptr;};
    inline const Models::GetRepositoryTagResponseBodyResultCommitSignature & signature() const { DARABONBA_PTR_GET_CONST(signature_, Models::GetRepositoryTagResponseBodyResultCommitSignature) };
    inline Models::GetRepositoryTagResponseBodyResultCommitSignature signature() { DARABONBA_PTR_GET(signature_, Models::GetRepositoryTagResponseBodyResultCommitSignature) };
    inline GetRepositoryTagResponseBodyResultCommit& setSignature(const Models::GetRepositoryTagResponseBodyResultCommitSignature & signature) { DARABONBA_PTR_SET_VALUE(signature_, signature) };
    inline GetRepositoryTagResponseBodyResultCommit& setSignature(Models::GetRepositoryTagResponseBodyResultCommitSignature && signature) { DARABONBA_PTR_SET_RVALUE(signature_, signature) };
    ...
    inline GetRepositoryTagResponseBodyResultCommit& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
  ...
  protected:
    ...
    std::shared_ptr<Models::GetRepositoryTagResponseBodyResultCommitSignature> signature_ = nullptr;
