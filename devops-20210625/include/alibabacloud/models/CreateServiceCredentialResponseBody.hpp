...
namespace Models
{
  ...
  public:
    ...
    inline CreateServiceCredentialResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline CreateServiceCredentialResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline CreateServiceCredentialResponseBody& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline CreateServiceCredentialResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
