...
#ifndef ALIBABACLOUD_MODELS_UPDATEPROTECTEDBRANCHESRESPONSEBODYRESULTMERGEREQUESTSETTING_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPROTECTEDBRANCHESRESPONSEBODYRESULTMERGEREQUESTSETTING_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& obj) { 
    ...
    UpdateProtectedBranchesResponseBodyResultMergeRequestSetting() = default ;
    UpdateProtectedBranchesResponseBodyResultMergeRequestSetting(const UpdateProtectedBranchesResponseBodyResultMergeRequestSetting &) = default ;
    UpdateProtectedBranchesResponseBodyResultMergeRequestSetting(UpdateProtectedBranchesResponseBodyResultMergeRequestSetting &&) = default ;
    UpdateProtectedBranchesResponseBodyResultMergeRequestSetting(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateProtectedBranchesResponseBodyResultMergeRequestSetting() = default ;
    UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& operator=(const UpdateProtectedBranchesResponseBodyResultMergeRequestSetting &) = default ;
    UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& operator=(UpdateProtectedBranchesResponseBodyResultMergeRequestSetting &&) = default ;
    ...
    inline UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& setAllowMergeRequestRoles(const vector<int32_t> & allowMergeRequestRoles) { DARABONBA_PTR_SET_VALUE(allowMergeRequestRoles_, allowMergeRequestRoles) };
    inline UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& setAllowMergeRequestRoles(vector<int32_t> && allowMergeRequestRoles) { DARABONBA_PTR_SET_RVALUE(allowMergeRequestRoles_, allowMergeRequestRoles) };
    ...
    inline UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& setDefaultAssignees(const vector<string> & defaultAssignees) { DARABONBA_PTR_SET_VALUE(defaultAssignees_, defaultAssignees) };
    inline UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& setDefaultAssignees(vector<string> && defaultAssignees) { DARABONBA_PTR_SET_RVALUE(defaultAssignees_, defaultAssignees) };
    ...
    inline UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& setIsAllowSelfApproval(bool isAllowSelfApproval) { DARABONBA_PTR_SET_VALUE(isAllowSelfApproval_, isAllowSelfApproval) };
    ...
    inline UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& setIsRequireDiscussionProcessed(bool isRequireDiscussionProcessed) { DARABONBA_PTR_SET_VALUE(isRequireDiscussionProcessed_, isRequireDiscussionProcessed) };
    ...
    inline UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& setIsRequired(bool isRequired) { DARABONBA_PTR_SET_VALUE(isRequired_, isRequired) };
    ...
    inline UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& setIsResetApprovalWhenNewPush(bool isResetApprovalWhenNewPush) { DARABONBA_PTR_SET_VALUE(isResetApprovalWhenNewPush_, isResetApprovalWhenNewPush) };
    ...
    inline UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& setMinimumApproval(int32_t minimumApproval) { DARABONBA_PTR_SET_VALUE(minimumApproval_, minimumApproval) };
    ...
    inline UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& setMrMode(string mrMode) { DARABONBA_PTR_SET_VALUE(mrMode_, mrMode) };
    ...
    inline UpdateProtectedBranchesResponseBodyResultMergeRequestSetting& setWhiteList(string whiteList) { DARABONBA_PTR_SET_VALUE(whiteList_, whiteList) };
