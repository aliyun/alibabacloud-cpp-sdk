...
namespace Models
{
  ...
  public:
    ...
    inline UpdateGroupResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline UpdateGroupResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline const UpdateGroupResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, UpdateGroupResponseBodyResult) };
    inline UpdateGroupResponseBodyResult result() { DARABONBA_PTR_GET(result_, UpdateGroupResponseBodyResult) };
    inline UpdateGroupResponseBody& setResult(const UpdateGroupResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateGroupResponseBody& setResult(UpdateGroupResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline UpdateGroupResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateGroupResponseBodyResult> result_ = nullptr;
