...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->customCode_ == nullptr
        && return this->name_ == nullptr && return this->scope_ == nullptr && return this->templateIdentifier_ == nullptr; };
    ...
    inline CreateProjectRequest& setCustomCode(string customCode) { DARABONBA_PTR_SET_VALUE(customCode_, customCode) };
    ...
    inline CreateProjectRequest& setScope(string scope) { DARABONBA_PTR_SET_VALUE(scope_, scope) };
    ...
    inline CreateProjectRequest& setTemplateIdentifier(string templateIdentifier) { DARABONBA_PTR_SET_VALUE(templateIdentifier_, templateIdentifier) };
