...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFileResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, UpdateFileResponseBodyResult) };
    inline UpdateFileResponseBodyResult result() { DARABONBA_PTR_GET(result_, UpdateFileResponseBodyResult) };
    inline UpdateFileResponseBody& setResult(const UpdateFileResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateFileResponseBody& setResult(UpdateFileResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateFileResponseBodyResult> result_ = nullptr;
