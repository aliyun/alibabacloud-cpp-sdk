...
#ifndef ALIBABACLOUD_MODELS_CREATEPUSHRULERESPONSEBODYRESULTRULEINFOS_HPP_
#define ALIBABACLOUD_MODELS_CREATEPUSHRULERESPONSEBODYRESULTRULEINFOS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePushRuleResponseBodyResultRuleInfos& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePushRuleResponseBodyResultRuleInfos& obj) { 
    ...
    CreatePushRuleResponseBodyResultRuleInfos() = default ;
    CreatePushRuleResponseBodyResultRuleInfos(const CreatePushRuleResponseBodyResultRuleInfos &) = default ;
    CreatePushRuleResponseBodyResultRuleInfos(CreatePushRuleResponseBodyResultRuleInfos &&) = default ;
    CreatePushRuleResponseBodyResultRuleInfos(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePushRuleResponseBodyResultRuleInfos() = default ;
    CreatePushRuleResponseBodyResultRuleInfos& operator=(const CreatePushRuleResponseBodyResultRuleInfos &) = default ;
    CreatePushRuleResponseBodyResultRuleInfos& operator=(CreatePushRuleResponseBodyResultRuleInfos &&) = default ;
    ...
    inline CreatePushRuleResponseBodyResultRuleInfos& setCheckerName(string checkerName) { DARABONBA_PTR_SET_VALUE(checkerName_, checkerName) };
    ...
    inline CreatePushRuleResponseBodyResultRuleInfos& setCheckerType(string checkerType) { DARABONBA_PTR_SET_VALUE(checkerType_, checkerType) };
    ...
    inline CreatePushRuleResponseBodyResultRuleInfos& setExtraMessage(string extraMessage) { DARABONBA_PTR_SET_VALUE(extraMessage_, extraMessage) };
    ...
    inline CreatePushRuleResponseBodyResultRuleInfos& setFileRuleRegexes(const vector<string> & fileRuleRegexes) { DARABONBA_PTR_SET_VALUE(fileRuleRegexes_, fileRuleRegexes) };
    inline CreatePushRuleResponseBodyResultRuleInfos& setFileRuleRegexes(vector<string> && fileRuleRegexes) { DARABONBA_PTR_SET_RVALUE(fileRuleRegexes_, fileRuleRegexes) };
