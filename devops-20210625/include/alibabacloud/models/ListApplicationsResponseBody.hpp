...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListApplicationsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListApplicationsResponseBodyData>) };
    inline vector<ListApplicationsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListApplicationsResponseBodyData>) };
    inline ListApplicationsResponseBody& setData(const vector<ListApplicationsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListApplicationsResponseBody& setData(vector<ListApplicationsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<ListApplicationsResponseBodyData>> data_ = nullptr;
