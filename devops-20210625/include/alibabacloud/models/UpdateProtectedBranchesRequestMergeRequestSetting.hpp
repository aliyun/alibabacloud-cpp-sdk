...
#ifndef ALIBABACLOUD_MODELS_UPDATEPROTECTEDBRANCHESREQUESTMERGEREQUESTSETTING_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPROTECTEDBRANCHESREQUESTMERGEREQUESTSETTING_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateProtectedBranchesRequestMergeRequestSetting& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateProtectedBranchesRequestMergeRequestSetting& obj) { 
    ...
    UpdateProtectedBranchesRequestMergeRequestSetting() = default ;
    UpdateProtectedBranchesRequestMergeRequestSetting(const UpdateProtectedBranchesRequestMergeRequestSetting &) = default ;
    UpdateProtectedBranchesRequestMergeRequestSetting(UpdateProtectedBranchesRequestMergeRequestSetting &&) = default ;
    UpdateProtectedBranchesRequestMergeRequestSetting(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateProtectedBranchesRequestMergeRequestSetting() = default ;
    UpdateProtectedBranchesRequestMergeRequestSetting& operator=(const UpdateProtectedBranchesRequestMergeRequestSetting &) = default ;
    UpdateProtectedBranchesRequestMergeRequestSetting& operator=(UpdateProtectedBranchesRequestMergeRequestSetting &&) = default ;
    ...
    inline UpdateProtectedBranchesRequestMergeRequestSetting& setAllowMergeRequestRoles(const vector<int32_t> & allowMergeRequestRoles) { DARABONBA_PTR_SET_VALUE(allowMergeRequestRoles_, allowMergeRequestRoles) };
    inline UpdateProtectedBranchesRequestMergeRequestSetting& setAllowMergeRequestRoles(vector<int32_t> && allowMergeRequestRoles) { DARABONBA_PTR_SET_RVALUE(allowMergeRequestRoles_, allowMergeRequestRoles) };
    ...
    inline UpdateProtectedBranchesRequestMergeRequestSetting& setDefaultAssignees(const vector<string> & defaultAssignees) { DARABONBA_PTR_SET_VALUE(defaultAssignees_, defaultAssignees) };
    inline UpdateProtectedBranchesRequestMergeRequestSetting& setDefaultAssignees(vector<string> && defaultAssignees) { DARABONBA_PTR_SET_RVALUE(defaultAssignees_, defaultAssignees) };
    ...
    inline UpdateProtectedBranchesRequestMergeRequestSetting& setIsAllowSelfApproval(bool isAllowSelfApproval) { DARABONBA_PTR_SET_VALUE(isAllowSelfApproval_, isAllowSelfApproval) };
    ...
    inline UpdateProtectedBranchesRequestMergeRequestSetting& setIsRequireDiscussionProcessed(bool isRequireDiscussionProcessed) { DARABONBA_PTR_SET_VALUE(isRequireDiscussionProcessed_, isRequireDiscussionProcessed) };
    ...
    inline UpdateProtectedBranchesRequestMergeRequestSetting& setIsRequired(bool isRequired) { DARABONBA_PTR_SET_VALUE(isRequired_, isRequired) };
    ...
    inline UpdateProtectedBranchesRequestMergeRequestSetting& setIsResetApprovalWhenNewPush(bool isResetApprovalWhenNewPush) { DARABONBA_PTR_SET_VALUE(isResetApprovalWhenNewPush_, isResetApprovalWhenNewPush) };
    ...
    inline UpdateProtectedBranchesRequestMergeRequestSetting& setMinimumApproval(int32_t minimumApproval) { DARABONBA_PTR_SET_VALUE(minimumApproval_, minimumApproval) };
    ...
    inline UpdateProtectedBranchesRequestMergeRequestSetting& setMrMode(string mrMode) { DARABONBA_PTR_SET_VALUE(mrMode_, mrMode) };
    ...
    inline UpdateProtectedBranchesRequestMergeRequestSetting& setWhiteList(string whiteList) { DARABONBA_PTR_SET_VALUE(whiteList_, whiteList) };
