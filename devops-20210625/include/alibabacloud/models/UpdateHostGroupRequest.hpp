...
#ifndef ALIBABACLOUD_MODELS_UPDATEHOSTGROUPREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEHOSTGROUPREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateHostGroupRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateHostGroupRequest& obj) { 
    ...
    UpdateHostGroupRequest() = default ;
    UpdateHostGroupRequest(const UpdateHostGroupRequest &) = default ;
    UpdateHostGroupRequest(UpdateHostGroupRequest &&) = default ;
    UpdateHostGroupRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateHostGroupRequest() = default ;
    UpdateHostGroupRequest& operator=(const UpdateHostGroupRequest &) = default ;
    UpdateHostGroupRequest& operator=(UpdateHostGroupRequest &&) = default ;
    ...
    inline UpdateHostGroupRequest& setAliyunRegion(string aliyunRegion) { DARABONBA_PTR_SET_VALUE(aliyunRegion_, aliyunRegion) };
    ...
    inline UpdateHostGroupRequest& setEcsLabelKey(string ecsLabelKey) { DARABONBA_PTR_SET_VALUE(ecsLabelKey_, ecsLabelKey) };
    ...
    inline UpdateHostGroupRequest& setEcsLabelValue(string ecsLabelValue) { DARABONBA_PTR_SET_VALUE(ecsLabelValue_, ecsLabelValue) };
    ...
    inline UpdateHostGroupRequest& setEcsType(string ecsType) { DARABONBA_PTR_SET_VALUE(ecsType_, ecsType) };
    ...
    inline UpdateHostGroupRequest& setEnvId(string envId) { DARABONBA_PTR_SET_VALUE(envId_, envId) };
    ...
    inline UpdateHostGroupRequest& setMachineInfos(string machineInfos) { DARABONBA_PTR_SET_VALUE(machineInfos_, machineInfos) };
    ...
    inline UpdateHostGroupRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline UpdateHostGroupRequest& setServiceConnectionId(int64_t serviceConnectionId) { DARABONBA_PTR_SET_VALUE(serviceConnectionId_, serviceConnectionId) };
    ...
    inline UpdateHostGroupRequest& setTagIds(string tagIds) { DARABONBA_PTR_SET_VALUE(tagIds_, tagIds) };
    ...
    inline UpdateHostGroupRequest& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
