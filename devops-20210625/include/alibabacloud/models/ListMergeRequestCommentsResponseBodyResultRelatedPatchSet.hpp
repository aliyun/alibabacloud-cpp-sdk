...
#ifndef ALIBABACLOUD_MODELS_LISTMERGEREQUESTCOMMENTSRESPONSEBODYRESULTRELATEDPATCHSET_HPP_
#define ALIBABACLOUD_MODELS_LISTMERGEREQUESTCOMMENTSRESPONSEBODYRESULTRELATEDPATCHSET_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListMergeRequestCommentsResponseBodyResultRelatedPatchSet& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListMergeRequestCommentsResponseBodyResultRelatedPatchSet& obj) { 
    ...
    ListMergeRequestCommentsResponseBodyResultRelatedPatchSet() = default ;
    ListMergeRequestCommentsResponseBodyResultRelatedPatchSet(const ListMergeRequestCommentsResponseBodyResultRelatedPatchSet &) = default ;
    ListMergeRequestCommentsResponseBodyResultRelatedPatchSet(ListMergeRequestCommentsResponseBodyResultRelatedPatchSet &&) = default ;
    ListMergeRequestCommentsResponseBodyResultRelatedPatchSet(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMergeRequestCommentsResponseBodyResultRelatedPatchSet() = default ;
    ListMergeRequestCommentsResponseBodyResultRelatedPatchSet& operator=(const ListMergeRequestCommentsResponseBodyResultRelatedPatchSet &) = default ;
    ListMergeRequestCommentsResponseBodyResultRelatedPatchSet& operator=(ListMergeRequestCommentsResponseBodyResultRelatedPatchSet &&) = default ;
    ...
    inline ListMergeRequestCommentsResponseBodyResultRelatedPatchSet& setCommitId(string commitId) { DARABONBA_PTR_SET_VALUE(commitId_, commitId) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultRelatedPatchSet& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultRelatedPatchSet& setPatchSetBizId(string patchSetBizId) { DARABONBA_PTR_SET_VALUE(patchSetBizId_, patchSetBizId) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultRelatedPatchSet& setPatchSetName(string patchSetName) { DARABONBA_PTR_SET_VALUE(patchSetName_, patchSetName) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultRelatedPatchSet& setPatchSetNo(string patchSetNo) { DARABONBA_PTR_SET_VALUE(patchSetNo_, patchSetNo) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultRelatedPatchSet& setRelatedMergeItemType(string relatedMergeItemType) { DARABONBA_PTR_SET_VALUE(relatedMergeItemType_, relatedMergeItemType) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultRelatedPatchSet& setShortId(string shortId) { DARABONBA_PTR_SET_VALUE(shortId_, shortId) };
