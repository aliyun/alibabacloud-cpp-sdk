...
namespace Models
{
  ...
  public:
    ...
    inline GetUserInfoResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline GetUserInfoResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline const GetUserInfoResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetUserInfoResponseBodyResult) };
    inline GetUserInfoResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetUserInfoResponseBodyResult) };
    inline GetUserInfoResponseBody& setResult(const GetUserInfoResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetUserInfoResponseBody& setResult(GetUserInfoResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline GetUserInfoResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    std::shared_ptr<GetUserInfoResponseBodyResult> result_ = nullptr;
