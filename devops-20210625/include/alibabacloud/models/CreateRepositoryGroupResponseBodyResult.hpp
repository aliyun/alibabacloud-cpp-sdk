...
#ifndef ALIBABACLOUD_MODELS_CREATEREPOSITORYGROUPRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_CREATEREPOSITORYGROUPRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateRepositoryGroupResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateRepositoryGroupResponseBodyResult& obj) { 
    ...
    CreateRepositoryGroupResponseBodyResult() = default ;
    CreateRepositoryGroupResponseBodyResult(const CreateRepositoryGroupResponseBodyResult &) = default ;
    CreateRepositoryGroupResponseBodyResult(CreateRepositoryGroupResponseBodyResult &&) = default ;
    CreateRepositoryGroupResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateRepositoryGroupResponseBodyResult() = default ;
    CreateRepositoryGroupResponseBodyResult& operator=(const CreateRepositoryGroupResponseBodyResult &) = default ;
    CreateRepositoryGroupResponseBodyResult& operator=(CreateRepositoryGroupResponseBodyResult &&) = default ;
    ...
    inline CreateRepositoryGroupResponseBodyResult& setAvatarUrl(string avatarUrl) { DARABONBA_PTR_SET_VALUE(avatarUrl_, avatarUrl) };
    ...
    inline CreateRepositoryGroupResponseBodyResult& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreateRepositoryGroupResponseBodyResult& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline CreateRepositoryGroupResponseBodyResult& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateRepositoryGroupResponseBodyResult& setNameWithNamespace(string nameWithNamespace) { DARABONBA_PTR_SET_VALUE(nameWithNamespace_, nameWithNamespace) };
    ...
    inline CreateRepositoryGroupResponseBodyResult& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline CreateRepositoryGroupResponseBodyResult& setParentId(int64_t parentId) { DARABONBA_PTR_SET_VALUE(parentId_, parentId) };
    ...
    inline CreateRepositoryGroupResponseBodyResult& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline CreateRepositoryGroupResponseBodyResult& setPathWithNamespace(string pathWithNamespace) { DARABONBA_PTR_SET_VALUE(pathWithNamespace_, pathWithNamespace) };
    ...
    inline CreateRepositoryGroupResponseBodyResult& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline CreateRepositoryGroupResponseBodyResult& setVisibilityLevel(int32_t visibilityLevel) { DARABONBA_PTR_SET_VALUE(visibilityLevel_, visibilityLevel) };
    ...
    inline CreateRepositoryGroupResponseBodyResult& setWebUrl(string webUrl) { DARABONBA_PTR_SET_VALUE(webUrl_, webUrl) };
