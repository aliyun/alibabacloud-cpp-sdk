...
#ifndef ALIBABACLOUD_MODELS_UPDATEGROUPRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_UPDATEGROUPRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateGroupResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateGroupResponseBodyResult& obj) { 
    ...
    UpdateGroupResponseBodyResult() = default ;
    UpdateGroupResponseBodyResult(const UpdateGroupResponseBodyResult &) = default ;
    UpdateGroupResponseBodyResult(UpdateGroupResponseBodyResult &&) = default ;
    UpdateGroupResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateGroupResponseBodyResult() = default ;
    UpdateGroupResponseBodyResult& operator=(const UpdateGroupResponseBodyResult &) = default ;
    UpdateGroupResponseBodyResult& operator=(UpdateGroupResponseBodyResult &&) = default ;
    ...
    inline UpdateGroupResponseBodyResult& setAvatarUrl(string avatarUrl) { DARABONBA_PTR_SET_VALUE(avatarUrl_, avatarUrl) };
    ...
    inline UpdateGroupResponseBodyResult& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateGroupResponseBodyResult& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UpdateGroupResponseBodyResult& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline UpdateGroupResponseBodyResult& setNameWithNamespace(string nameWithNamespace) { DARABONBA_PTR_SET_VALUE(nameWithNamespace_, nameWithNamespace) };
    ...
    inline UpdateGroupResponseBodyResult& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline UpdateGroupResponseBodyResult& setParentId(int64_t parentId) { DARABONBA_PTR_SET_VALUE(parentId_, parentId) };
    ...
    inline UpdateGroupResponseBodyResult& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline UpdateGroupResponseBodyResult& setPathWithNamespace(string pathWithNamespace) { DARABONBA_PTR_SET_VALUE(pathWithNamespace_, pathWithNamespace) };
    ...
    inline UpdateGroupResponseBodyResult& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline UpdateGroupResponseBodyResult& setVisibilityLevel(int32_t visibilityLevel) { DARABONBA_PTR_SET_VALUE(visibilityLevel_, visibilityLevel) };
    ...
    inline UpdateGroupResponseBodyResult& setWebUrl(string webUrl) { DARABONBA_PTR_SET_VALUE(webUrl_, webUrl) };
