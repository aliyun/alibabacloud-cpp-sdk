...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessToken_ == nullptr
        && return this->branchName_ == nullptr && return this->commitMessage_ == nullptr && return this->content_ == nullptr && return this->encoding_ == nullptr && return this->newPath_ == nullptr
        && return this->oldPath_ == nullptr && return this->organizationId_ == nullptr; };
    // accessToken Field Functions 
    bool hasAccessToken() const { return this->accessToken_ != nullptr;};
    void deleteAccessToken() { this->accessToken_ = nullptr;};
    inline string accessToken() const { DARABONBA_PTR_GET_DEFAULT(accessToken_, "") };
    inline UpdateFileRequest& setAccessToken(string accessToken) { DARABONBA_PTR_SET_VALUE(accessToken_, accessToken) };
    ...
    inline UpdateFileRequest& setBranchName(string branchName) { DARABONBA_PTR_SET_VALUE(branchName_, branchName) };
    ...
    inline UpdateFileRequest& setCommitMessage(string commitMessage) { DARABONBA_PTR_SET_VALUE(commitMessage_, commitMessage) };
    ...
    inline UpdateFileRequest& setEncoding(string encoding) { DARABONBA_PTR_SET_VALUE(encoding_, encoding) };
    ...
    inline UpdateFileRequest& setNewPath(string newPath) { DARABONBA_PTR_SET_VALUE(newPath_, newPath) };
    ...
    inline UpdateFileRequest& setOldPath(string oldPath) { DARABONBA_PTR_SET_VALUE(oldPath_, oldPath) };
    ...
    inline UpdateFileRequest& setOrganizationId(string organizationId) { DARABONBA_PTR_SET_VALUE(organizationId_, organizationId) };
