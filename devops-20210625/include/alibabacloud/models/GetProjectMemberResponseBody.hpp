...
namespace Models
{
  ...
  public:
    ...
    inline GetProjectMemberResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline GetProjectMemberResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline const GetProjectMemberResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetProjectMemberResponseBodyResult) };
    inline GetProjectMemberResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetProjectMemberResponseBodyResult) };
    inline GetProjectMemberResponseBody& setResult(const GetProjectMemberResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetProjectMemberResponseBody& setResult(GetProjectMemberResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline GetProjectMemberResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    std::shared_ptr<GetProjectMemberResponseBodyResult> result_ = nullptr;
