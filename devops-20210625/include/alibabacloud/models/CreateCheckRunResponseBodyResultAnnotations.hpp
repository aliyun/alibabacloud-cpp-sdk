...
#ifndef ALIBABACLOUD_MODELS_CREATECHECKRUNRESPONSEBODYRESULTANNOTATIONS_HPP_
#define ALIBABACLOUD_MODELS_CREATECHECKRUNRESPONSEBODYRESULTANNOTATIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateCheckRunResponseBodyResultAnnotations& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateCheckRunResponseBodyResultAnnotations& obj) { 
    ...
    CreateCheckRunResponseBodyResultAnnotations() = default ;
    CreateCheckRunResponseBodyResultAnnotations(const CreateCheckRunResponseBodyResultAnnotations &) = default ;
    CreateCheckRunResponseBodyResultAnnotations(CreateCheckRunResponseBodyResultAnnotations &&) = default ;
    CreateCheckRunResponseBodyResultAnnotations(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateCheckRunResponseBodyResultAnnotations() = default ;
    CreateCheckRunResponseBodyResultAnnotations& operator=(const CreateCheckRunResponseBodyResultAnnotations &) = default ;
    CreateCheckRunResponseBodyResultAnnotations& operator=(CreateCheckRunResponseBodyResultAnnotations &&) = default ;
    ...
    inline CreateCheckRunResponseBodyResultAnnotations& setAnnotationLevel(string annotationLevel) { DARABONBA_PTR_SET_VALUE(annotationLevel_, annotationLevel) };
    ...
    inline CreateCheckRunResponseBodyResultAnnotations& setEndColumn(int64_t endColumn) { DARABONBA_PTR_SET_VALUE(endColumn_, endColumn) };
    ...
    inline CreateCheckRunResponseBodyResultAnnotations& setEndLine(int64_t endLine) { DARABONBA_PTR_SET_VALUE(endLine_, endLine) };
    ...
    inline CreateCheckRunResponseBodyResultAnnotations& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline CreateCheckRunResponseBodyResultAnnotations& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateCheckRunResponseBodyResultAnnotations& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline CreateCheckRunResponseBodyResultAnnotations& setRawDetails(string rawDetails) { DARABONBA_PTR_SET_VALUE(rawDetails_, rawDetails) };
    ...
    inline CreateCheckRunResponseBodyResultAnnotations& setStartColumn(int64_t startColumn) { DARABONBA_PTR_SET_VALUE(startColumn_, startColumn) };
    ...
    inline CreateCheckRunResponseBodyResultAnnotations& setStartLine(int64_t startLine) { DARABONBA_PTR_SET_VALUE(startLine_, startLine) };
    ...
    inline CreateCheckRunResponseBodyResultAnnotations& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
