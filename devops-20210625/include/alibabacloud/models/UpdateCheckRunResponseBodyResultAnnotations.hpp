...
#ifndef ALIBABACLOUD_MODELS_UPDATECHECKRUNRESPONSEBODYRESULTANNOTATIONS_HPP_
#define ALIBABACLOUD_MODELS_UPDATECHECKRUNRESPONSEBODYRESULTANNOTATIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateCheckRunResponseBodyResultAnnotations& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateCheckRunResponseBodyResultAnnotations& obj) { 
    ...
    UpdateCheckRunResponseBodyResultAnnotations() = default ;
    UpdateCheckRunResponseBodyResultAnnotations(const UpdateCheckRunResponseBodyResultAnnotations &) = default ;
    UpdateCheckRunResponseBodyResultAnnotations(UpdateCheckRunResponseBodyResultAnnotations &&) = default ;
    UpdateCheckRunResponseBodyResultAnnotations(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateCheckRunResponseBodyResultAnnotations() = default ;
    UpdateCheckRunResponseBodyResultAnnotations& operator=(const UpdateCheckRunResponseBodyResultAnnotations &) = default ;
    UpdateCheckRunResponseBodyResultAnnotations& operator=(UpdateCheckRunResponseBodyResultAnnotations &&) = default ;
    ...
    inline UpdateCheckRunResponseBodyResultAnnotations& setAnnotationLevel(string annotationLevel) { DARABONBA_PTR_SET_VALUE(annotationLevel_, annotationLevel) };
    ...
    inline UpdateCheckRunResponseBodyResultAnnotations& setEndColumn(int64_t endColumn) { DARABONBA_PTR_SET_VALUE(endColumn_, endColumn) };
    ...
    inline UpdateCheckRunResponseBodyResultAnnotations& setEndLine(int64_t endLine) { DARABONBA_PTR_SET_VALUE(endLine_, endLine) };
    ...
    inline UpdateCheckRunResponseBodyResultAnnotations& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline UpdateCheckRunResponseBodyResultAnnotations& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateCheckRunResponseBodyResultAnnotations& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline UpdateCheckRunResponseBodyResultAnnotations& setRawDetails(string rawDetails) { DARABONBA_PTR_SET_VALUE(rawDetails_, rawDetails) };
    ...
    inline UpdateCheckRunResponseBodyResultAnnotations& setStartColumn(int64_t startColumn) { DARABONBA_PTR_SET_VALUE(startColumn_, startColumn) };
    ...
    inline UpdateCheckRunResponseBodyResultAnnotations& setStartLine(int64_t startLine) { DARABONBA_PTR_SET_VALUE(startLine_, startLine) };
    ...
    inline UpdateCheckRunResponseBodyResultAnnotations& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
