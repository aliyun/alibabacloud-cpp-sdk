...
#ifndef ALIBABACLOUD_MODELS_CREATEBRANCHRESPONSEBODYRESULTCOMMIT_HPP_
#define ALIBABACLOUD_MODELS_CREATEBRANCHRESPONSEBODYRESULTCOMMIT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateBranchResponseBodyResultCommit& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateBranchResponseBodyResultCommit& obj) { 
    ...
    CreateBranchResponseBodyResultCommit() = default ;
    CreateBranchResponseBodyResultCommit(const CreateBranchResponseBodyResultCommit &) = default ;
    CreateBranchResponseBodyResultCommit(CreateBranchResponseBodyResultCommit &&) = default ;
    CreateBranchResponseBodyResultCommit(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateBranchResponseBodyResultCommit() = default ;
    CreateBranchResponseBodyResultCommit& operator=(const CreateBranchResponseBodyResultCommit &) = default ;
    CreateBranchResponseBodyResultCommit& operator=(CreateBranchResponseBodyResultCommit &&) = default ;
    ...
    inline CreateBranchResponseBodyResultCommit& setAuthorEmail(string authorEmail) { DARABONBA_PTR_SET_VALUE(authorEmail_, authorEmail) };
    ...
    inline CreateBranchResponseBodyResultCommit& setAuthorName(string authorName) { DARABONBA_PTR_SET_VALUE(authorName_, authorName) };
    ...
    inline CreateBranchResponseBodyResultCommit& setAuthoredDate(string authoredDate) { DARABONBA_PTR_SET_VALUE(authoredDate_, authoredDate) };
    ...
    inline CreateBranchResponseBodyResultCommit& setCommittedDate(string committedDate) { DARABONBA_PTR_SET_VALUE(committedDate_, committedDate) };
    ...
    inline CreateBranchResponseBodyResultCommit& setCommitterEmail(string committerEmail) { DARABONBA_PTR_SET_VALUE(committerEmail_, committerEmail) };
    ...
    inline CreateBranchResponseBodyResultCommit& setCommitterName(string committerName) { DARABONBA_PTR_SET_VALUE(committerName_, committerName) };
    ...
    inline CreateBranchResponseBodyResultCommit& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };
    ...
    inline CreateBranchResponseBodyResultCommit& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline CreateBranchResponseBodyResultCommit& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateBranchResponseBodyResultCommit& setParentIds(const vector<string> & parentIds) { DARABONBA_PTR_SET_VALUE(parentIds_, parentIds) };
    inline CreateBranchResponseBodyResultCommit& setParentIds(vector<string> && parentIds) { DARABONBA_PTR_SET_RVALUE(parentIds_, parentIds) };
    ...
    inline CreateBranchResponseBodyResultCommit& setShortId(string shortId) { DARABONBA_PTR_SET_VALUE(shortId_, shortId) };
    ...
    inline CreateBranchResponseBodyResultCommit& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
