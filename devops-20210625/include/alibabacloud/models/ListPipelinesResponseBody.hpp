...
namespace Models
{
  ...
  public:
    ...
    inline ListPipelinesResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline ListPipelinesResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline const vector<ListPipelinesResponseBodyPipelines> & pipelines() const { DARABONBA_PTR_GET_CONST(pipelines_, vector<ListPipelinesResponseBodyPipelines>) };
    inline vector<ListPipelinesResponseBodyPipelines> pipelines() { DARABONBA_PTR_GET(pipelines_, vector<ListPipelinesResponseBodyPipelines>) };
    inline ListPipelinesResponseBody& setPipelines(const vector<ListPipelinesResponseBodyPipelines> & pipelines) { DARABONBA_PTR_SET_VALUE(pipelines_, pipelines) };
    inline ListPipelinesResponseBody& setPipelines(vector<ListPipelinesResponseBodyPipelines> && pipelines) { DARABONBA_PTR_SET_RVALUE(pipelines_, pipelines) };
    ...
    inline ListPipelinesResponseBody& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListPipelinesResponseBodyPipelines>> pipelines_ = nullptr;
