...
#ifndef ALIBABACLOUD_MODELS_LISTPUSHRULESRESPONSEBODYRESULTRULEINFOS_HPP_
#define ALIBABACLOUD_MODELS_LISTPUSHRULESRESPONSEBODYRESULTRULEINFOS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPushRulesResponseBodyResultRuleInfos& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListPushRulesResponseBodyResultRuleInfos& obj) { 
    ...
    ListPushRulesResponseBodyResultRuleInfos() = default ;
    ListPushRulesResponseBodyResultRuleInfos(const ListPushRulesResponseBodyResultRuleInfos &) = default ;
    ListPushRulesResponseBodyResultRuleInfos(ListPushRulesResponseBodyResultRuleInfos &&) = default ;
    ListPushRulesResponseBodyResultRuleInfos(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPushRulesResponseBodyResultRuleInfos() = default ;
    ListPushRulesResponseBodyResultRuleInfos& operator=(const ListPushRulesResponseBodyResultRuleInfos &) = default ;
    ListPushRulesResponseBodyResultRuleInfos& operator=(ListPushRulesResponseBodyResultRuleInfos &&) = default ;
    ...
    inline ListPushRulesResponseBodyResultRuleInfos& setCheckerName(string checkerName) { DARABONBA_PTR_SET_VALUE(checkerName_, checkerName) };
    ...
    inline ListPushRulesResponseBodyResultRuleInfos& setCheckerType(string checkerType) { DARABONBA_PTR_SET_VALUE(checkerType_, checkerType) };
    ...
    inline ListPushRulesResponseBodyResultRuleInfos& setExtraMessage(string extraMessage) { DARABONBA_PTR_SET_VALUE(extraMessage_, extraMessage) };
    ...
    inline ListPushRulesResponseBodyResultRuleInfos& setFileRuleRegexes(const vector<string> & fileRuleRegexes) { DARABONBA_PTR_SET_VALUE(fileRuleRegexes_, fileRuleRegexes) };
    inline ListPushRulesResponseBodyResultRuleInfos& setFileRuleRegexes(vector<string> && fileRuleRegexes) { DARABONBA_PTR_SET_RVALUE(fileRuleRegexes_, fileRuleRegexes) };
