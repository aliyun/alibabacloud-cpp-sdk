...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteFileResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DeleteFileResponseBodyResult) };
    inline DeleteFileResponseBodyResult result() { DARABONBA_PTR_GET(result_, DeleteFileResponseBodyResult) };
    inline DeleteFileResponseBody& setResult(const DeleteFileResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DeleteFileResponseBody& setResult(DeleteFileResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteFileResponseBodyResult> result_ = nullptr;
