...
#ifndef ALIBABACLOUD_MODELS_LISTMERGEREQUESTCOMMENTSRESPONSEBODYRESULTCHILDCOMMENTSRELATEDPATCHSET_HPP_
#define ALIBABACLOUD_MODELS_LISTMERGEREQUESTCOMMENTSRESPONSEBODYRESULTCHILDCOMMENTSRELATEDPATCHSET_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet& obj) { 
    ...
    ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet() = default ;
    ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet(const ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet &) = default ;
    ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet(ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet &&) = default ;
    ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet() = default ;
    ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet& operator=(const ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet &) = default ;
    ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet& operator=(ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet &&) = default ;
    ...
    inline ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet& setCommitId(string commitId) { DARABONBA_PTR_SET_VALUE(commitId_, commitId) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet& setCreatedAt(string createdAt) { DARABONBA_PTR_SET_VALUE(createdAt_, createdAt) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet& setPatchSetBizId(string patchSetBizId) { DARABONBA_PTR_SET_VALUE(patchSetBizId_, patchSetBizId) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet& setPatchSetName(string patchSetName) { DARABONBA_PTR_SET_VALUE(patchSetName_, patchSetName) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet& setPatchSetNo(string patchSetNo) { DARABONBA_PTR_SET_VALUE(patchSetNo_, patchSetNo) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet& setRelatedMergeItemType(string relatedMergeItemType) { DARABONBA_PTR_SET_VALUE(relatedMergeItemType_, relatedMergeItemType) };
    ...
    inline ListMergeRequestCommentsResponseBodyResultChildCommentsRelatedPatchSet& setShortId(string shortId) { DARABONBA_PTR_SET_VALUE(shortId_, shortId) };
