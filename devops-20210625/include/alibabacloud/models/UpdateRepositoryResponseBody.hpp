...
namespace Models
{
  ...
  public:
    ...
    inline UpdateRepositoryResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline UpdateRepositoryResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline const UpdateRepositoryResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, UpdateRepositoryResponseBodyResult) };
    inline UpdateRepositoryResponseBodyResult result() { DARABONBA_PTR_GET(result_, UpdateRepositoryResponseBodyResult) };
    inline UpdateRepositoryResponseBody& setResult(const UpdateRepositoryResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateRepositoryResponseBody& setResult(UpdateRepositoryResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline UpdateRepositoryResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateRepositoryResponseBodyResult> result_ = nullptr;
