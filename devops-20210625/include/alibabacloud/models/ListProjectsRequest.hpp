...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->category_ == nullptr
        && return this->conditions_ == nullptr && return this->extraConditions_ == nullptr && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->scope_ == nullptr; };
    // category Field Functions 
    bool hasCategory() const { return this->category_ != nullptr;};
    void deleteCategory() { this->category_ = nullptr;};
    inline string category() const { DARABONBA_PTR_GET_DEFAULT(category_, "") };
    inline ListProjectsRequest& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
    ...
    inline ListProjectsRequest& setConditions(string conditions) { DARABONBA_PTR_SET_VALUE(conditions_, conditions) };
    ...
    inline ListProjectsRequest& setExtraConditions(string extraConditions) { DARABONBA_PTR_SET_VALUE(extraConditions_, extraConditions) };
    ...
    inline ListProjectsRequest& setScope(string scope) { DARABONBA_PTR_SET_VALUE(scope_, scope) };
