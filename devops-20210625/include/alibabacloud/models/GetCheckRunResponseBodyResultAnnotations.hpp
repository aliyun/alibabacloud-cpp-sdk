...
#ifndef ALIBABACLOUD_MODELS_GETCHECKRUNRESPONSEBODYRESULTANNOTATIONS_HPP_
#define ALIBABACLOUD_MODELS_GETCHECKRUNRESPONSEBODYRESULTANNOTATIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetCheckRunResponseBodyResultAnnotations& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetCheckRunResponseBodyResultAnnotations& obj) { 
    ...
    GetCheckRunResponseBodyResultAnnotations() = default ;
    GetCheckRunResponseBodyResultAnnotations(const GetCheckRunResponseBodyResultAnnotations &) = default ;
    GetCheckRunResponseBodyResultAnnotations(GetCheckRunResponseBodyResultAnnotations &&) = default ;
    GetCheckRunResponseBodyResultAnnotations(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetCheckRunResponseBodyResultAnnotations() = default ;
    GetCheckRunResponseBodyResultAnnotations& operator=(const GetCheckRunResponseBodyResultAnnotations &) = default ;
    GetCheckRunResponseBodyResultAnnotations& operator=(GetCheckRunResponseBodyResultAnnotations &&) = default ;
    ...
    inline GetCheckRunResponseBodyResultAnnotations& setAnnotationLevel(string annotationLevel) { DARABONBA_PTR_SET_VALUE(annotationLevel_, annotationLevel) };
    ...
    inline GetCheckRunResponseBodyResultAnnotations& setEndColumn(int64_t endColumn) { DARABONBA_PTR_SET_VALUE(endColumn_, endColumn) };
    ...
    inline GetCheckRunResponseBodyResultAnnotations& setEndLine(int64_t endLine) { DARABONBA_PTR_SET_VALUE(endLine_, endLine) };
    ...
    inline GetCheckRunResponseBodyResultAnnotations& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetCheckRunResponseBodyResultAnnotations& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetCheckRunResponseBodyResultAnnotations& setPath(string path) { DARABONBA_PTR_SET_VALUE(path_, path) };
    ...
    inline GetCheckRunResponseBodyResultAnnotations& setRawDetails(string rawDetails) { DARABONBA_PTR_SET_VALUE(rawDetails_, rawDetails) };
    ...
    inline GetCheckRunResponseBodyResultAnnotations& setStartColumn(int64_t startColumn) { DARABONBA_PTR_SET_VALUE(startColumn_, startColumn) };
    ...
    inline GetCheckRunResponseBodyResultAnnotations& setStartLine(int64_t startLine) { DARABONBA_PTR_SET_VALUE(startLine_, startLine) };
    ...
    inline GetCheckRunResponseBodyResultAnnotations& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
