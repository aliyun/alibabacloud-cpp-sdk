...
#ifndef ALIBABACLOUD_MODELS_CREATEFLOWTAGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEFLOWTAGREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateFlowTagRequest& obj) { 
      DARABONBA_PTR_TO_JSON(color, color_);
      DARABONBA_PTR_TO_JSON(flowTagGroupId, flowTagGroupId_);
      DARABONBA_PTR_TO_JSON(name, name_);
    };
    friend void from_json(const Darabonba::Json& j, CreateFlowTagRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(color, color_);
      DARABONBA_PTR_FROM_JSON(flowTagGroupId, flowTagGroupId_);
      DARABONBA_PTR_FROM_JSON(name, name_);
    };
    CreateFlowTagRequest() = default ;
    CreateFlowTagRequest(const CreateFlowTagRequest &) = default ;
    CreateFlowTagRequest(CreateFlowTagRequest &&) = default ;
    CreateFlowTagRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateFlowTagRequest() = default ;
    CreateFlowTagRequest& operator=(const CreateFlowTagRequest &) = default ;
    CreateFlowTagRequest& operator=(CreateFlowTagRequest &&) = default ;
    ...
    inline CreateFlowTagRequest& setColor(string color) { DARABONBA_PTR_SET_VALUE(color_, color) };
    ...
    inline CreateFlowTagRequest& setFlowTagGroupId(int64_t flowTagGroupId) { DARABONBA_PTR_SET_VALUE(flowTagGroupId_, flowTagGroupId) };
    ...
    inline CreateFlowTagRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
