...
namespace Models
{
  ...
  public:
    ...
    inline const GetServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetServiceResponseBody) };
    inline GetServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetServiceResponseBody> body_ {};
  };
