...
namespace Models
{
  ...
  public:
    ...
    inline const ListBackupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListBackupsResponseBody) };
    inline ListBackupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListBackupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListBackupsResponseBody> body_ {};
  };
