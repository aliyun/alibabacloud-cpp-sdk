...
namespace Models
{
  ...
  public:
    ...
    inline const StartServiceInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartServiceInstanceResponseBody) };
    inline StartServiceInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, StartServiceInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartServiceInstanceResponseBody> body_ {};
  };
