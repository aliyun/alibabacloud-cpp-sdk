...
namespace Models
{
  ...
  public:
    ...
    inline const ContinueDeployServiceInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ContinueDeployServiceInstanceResponseBody) };
    inline ContinueDeployServiceInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ContinueDeployServiceInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ContinueDeployServiceInstanceResponseBody> body_ {};
  };
