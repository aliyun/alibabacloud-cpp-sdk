...
namespace Models
{
  ...
  public:
    ...
    inline const GetNetworkAvailableZonesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetNetworkAvailableZonesResponseBody) };
    inline GetNetworkAvailableZonesResponseBody getBody() { DARABONBA_PTR_GET(body_, GetNetworkAvailableZonesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetNetworkAvailableZonesResponseBody> body_ {};
  };
