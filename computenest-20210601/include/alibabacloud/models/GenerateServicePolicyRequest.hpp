...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->operationTypes_ == nullptr
        && this->parameters_ == nullptr && this->regionId_ == nullptr && this->serviceId_ == nullptr && this->serviceVersion_ == nullptr && this->templateName_ == nullptr
    ...
    inline GenerateServicePolicyRequest& setParameters(const Darabonba::Json & parameters) { DARABONBA_SET_VALUE(parameters_, parameters) };
    inline GenerateServicePolicyRequest& setParameters(Darabonba::Json && parameters) { DARABONBA_SET_RVALUE(parameters_, parameters) };
