...
namespace Models
{
  ...
  public:
    ...
    inline const ListServiceInstanceUpgradeHistoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListServiceInstanceUpgradeHistoryResponseBody) };
    inline ListServiceInstanceUpgradeHistoryResponseBody getBody() { DARABONBA_PTR_GET(body_, ListServiceInstanceUpgradeHistoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListServiceInstanceUpgradeHistoryResponseBody> body_ {};
  };
