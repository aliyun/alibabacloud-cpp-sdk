...
#ifndef ALIBABACLOUD_MODELS_LISTPUBLICSKILLSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTPUBLICSKILLSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListPublicSkillsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListPublicSkillsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListPublicSkillsResponseBody& obj) { 
    ...
    ListPublicSkillsResponseBody() = default ;
    ListPublicSkillsResponseBody(const ListPublicSkillsResponseBody &) = default ;
    ListPublicSkillsResponseBody(ListPublicSkillsResponseBody &&) = default ;
    ListPublicSkillsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPublicSkillsResponseBody() = default ;
    ListPublicSkillsResponseBody& operator=(const ListPublicSkillsResponseBody &) = default ;
    ListPublicSkillsResponseBody& operator=(ListPublicSkillsResponseBody &&) = default ;
    ...
    inline ListPublicSkillsResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListPublicSkillsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListPublicSkillsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // skills Field Functions 
    bool hasSkills() const { return this->skills_ != nullptr;};
    void deleteSkills() { this->skills_ = nullptr;};
    inline const vector<ListPublicSkillsResponseBody::Skills> & getSkills() const { DARABONBA_PTR_GET_CONST(skills_, vector<ListPublicSkillsResponseBody::Skills>) };
    inline vector<ListPublicSkillsResponseBody::Skills> getSkills() { DARABONBA_PTR_GET(skills_, vector<ListPublicSkillsResponseBody::Skills>) };
    inline ListPublicSkillsResponseBody& setSkills(const vector<ListPublicSkillsResponseBody::Skills> & skills) { DARABONBA_PTR_SET_VALUE(skills_, skills) };
    inline ListPublicSkillsResponseBody& setSkills(vector<ListPublicSkillsResponseBody::Skills> && skills) { DARABONBA_PTR_SET_RVALUE(skills_, skills) };
    ...
    inline ListPublicSkillsResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
