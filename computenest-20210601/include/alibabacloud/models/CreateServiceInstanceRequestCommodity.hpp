...
#ifndef ALIBABACLOUD_MODELS_CREATESERVICEINSTANCEREQUESTCOMMODITY_HPP_
#define ALIBABACLOUD_MODELS_CREATESERVICEINSTANCEREQUESTCOMMODITY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateServiceInstanceRequestCommodity& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateServiceInstanceRequestCommodity& obj) { 
    ...
    CreateServiceInstanceRequestCommodity() = default ;
    CreateServiceInstanceRequestCommodity(const CreateServiceInstanceRequestCommodity &) = default ;
    CreateServiceInstanceRequestCommodity(CreateServiceInstanceRequestCommodity &&) = default ;
    CreateServiceInstanceRequestCommodity(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateServiceInstanceRequestCommodity() = default ;
    CreateServiceInstanceRequestCommodity& operator=(const CreateServiceInstanceRequestCommodity &) = default ;
    CreateServiceInstanceRequestCommodity& operator=(CreateServiceInstanceRequestCommodity &&) = default ;
    ...
    inline CreateServiceInstanceRequestCommodity& setAutoPay(bool autoPay) { DARABONBA_PTR_SET_VALUE(autoPay_, autoPay) };
    ...
    inline CreateServiceInstanceRequestCommodity& setAutoRenew(bool autoRenew) { DARABONBA_PTR_SET_VALUE(autoRenew_, autoRenew) };
    ...
    inline CreateServiceInstanceRequestCommodity& setCouponId(string couponId) { DARABONBA_PTR_SET_VALUE(couponId_, couponId) };
    ...
    inline CreateServiceInstanceRequestCommodity& setPayPeriod(int64_t payPeriod) { DARABONBA_PTR_SET_VALUE(payPeriod_, payPeriod) };
    ...
    inline CreateServiceInstanceRequestCommodity& setPayPeriodUnit(string payPeriodUnit) { DARABONBA_PTR_SET_VALUE(payPeriodUnit_, payPeriodUnit) };
    ...
    inline CreateServiceInstanceRequestCommodity& setQuotationId(string quotationId) { DARABONBA_PTR_SET_VALUE(quotationId_, quotationId) };
