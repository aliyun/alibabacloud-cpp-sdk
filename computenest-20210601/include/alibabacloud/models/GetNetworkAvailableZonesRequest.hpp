...
namespace Models
{
  ...
  public:
    ...
    inline bool getIsPoc() const { DARABONBA_PTR_GET_DEFAULT(isPoc_, false) };
    ...
    inline string getNetworkRegionId() const { DARABONBA_PTR_GET_DEFAULT(networkRegionId_, "") };
    ...
    inline string getPrivateVpcConnectionMode() const { DARABONBA_PTR_GET_DEFAULT(privateVpcConnectionMode_, "") };
    ...
    inline string getServiceInstanceEndpointServiceType() const { DARABONBA_PTR_GET_DEFAULT(serviceInstanceEndpointServiceType_, "") };
