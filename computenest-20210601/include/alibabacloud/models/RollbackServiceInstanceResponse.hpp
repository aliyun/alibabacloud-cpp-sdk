...
namespace Models
{
  ...
  public:
    ...
    inline const RollbackServiceInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RollbackServiceInstanceResponseBody) };
    inline RollbackServiceInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, RollbackServiceInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RollbackServiceInstanceResponseBody> body_ {};
  };
