...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateServiceUsageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateServiceUsageResponseBody) };
    inline UpdateServiceUsageResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateServiceUsageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateServiceUsageResponseBody> body_ {};
  };
