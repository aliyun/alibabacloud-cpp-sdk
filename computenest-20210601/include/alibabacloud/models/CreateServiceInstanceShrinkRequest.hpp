...
namespace Models
{
  ...
  public:
    ...
    inline const CreateServiceInstanceShrinkRequest::Commodity & getCommodity() const { DARABONBA_PTR_GET_CONST(commodity_, CreateServiceInstanceShrinkRequest::Commodity) };
    inline CreateServiceInstanceShrinkRequest::Commodity getCommodity() { DARABONBA_PTR_GET(commodity_, CreateServiceInstanceShrinkRequest::Commodity) };
    inline CreateServiceInstanceShrinkRequest& setCommodity(const CreateServiceInstanceShrinkRequest::Commodity & commodity) { DARABONBA_PTR_SET_VALUE(commodity_, commodity) };
    inline CreateServiceInstanceShrinkRequest& setCommodity(CreateServiceInstanceShrinkRequest::Commodity && commodity) { DARABONBA_PTR_SET_RVALUE(commodity_, commodity) };
    ...
    inline const CreateServiceInstanceShrinkRequest::OperationMetadata & getOperationMetadata() const { DARABONBA_PTR_GET_CONST(operationMetadata_, CreateServiceInstanceShrinkRequest::OperationMetadata) };
    inline CreateServiceInstanceShrinkRequest::OperationMetadata getOperationMetadata() { DARABONBA_PTR_GET(operationMetadata_, CreateServiceInstanceShrinkRequest::OperationMetadata) };
    inline CreateServiceInstanceShrinkRequest& setOperationMetadata(const CreateServiceInstanceShrinkRequest::OperationMetadata & operationMetadata) { DARABONBA_PTR_SET_VALUE(operationMetadata_, operationMetadata) };
    inline CreateServiceInstanceShrinkRequest& setOperationMetadata(CreateServiceInstanceShrinkRequest::OperationMetadata && operationMetadata) { DARABONBA_PTR_SET_RVALUE(operationMetadata_, operationMetadata) };
