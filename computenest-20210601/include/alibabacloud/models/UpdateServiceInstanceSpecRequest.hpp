...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && return this->commodity_ == nullptr && return this->dryRun_ == nullptr && return this->enableUserPrometheus_ == nullptr && return this->operationName_ == nullptr && return this->parameters_ == nullptr
    ...
    inline const UpdateServiceInstanceSpecRequestCommodity & commodity() const { DARABONBA_PTR_GET_CONST(commodity_, UpdateServiceInstanceSpecRequestCommodity) };
    inline UpdateServiceInstanceSpecRequestCommodity commodity() { DARABONBA_PTR_GET(commodity_, UpdateServiceInstanceSpecRequestCommodity) };
    inline UpdateServiceInstanceSpecRequest& setCommodity(const UpdateServiceInstanceSpecRequestCommodity & commodity) { DARABONBA_PTR_SET_VALUE(commodity_, commodity) };
    inline UpdateServiceInstanceSpecRequest& setCommodity(UpdateServiceInstanceSpecRequestCommodity && commodity) { DARABONBA_PTR_SET_RVALUE(commodity_, commodity) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateServiceInstanceSpecRequestCommodity> commodity_ = nullptr;
