...
namespace Models
{
  ...
  public:
    ...
    inline const GetServiceTemplateParameterConstraintsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetServiceTemplateParameterConstraintsResponseBody) };
    inline GetServiceTemplateParameterConstraintsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetServiceTemplateParameterConstraintsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetServiceTemplateParameterConstraintsResponseBody> body_ {};
  };
