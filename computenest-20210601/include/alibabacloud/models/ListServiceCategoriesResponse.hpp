...
namespace Models
{
  ...
  public:
    ...
    inline const ListServiceCategoriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListServiceCategoriesResponseBody) };
    inline ListServiceCategoriesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListServiceCategoriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListServiceCategoriesResponseBody> body_ {};
  };
