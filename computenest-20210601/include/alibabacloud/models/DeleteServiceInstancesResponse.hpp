...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteServiceInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteServiceInstancesResponseBody) };
    inline DeleteServiceInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteServiceInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteServiceInstancesResponseBody> body_ {};
  };
