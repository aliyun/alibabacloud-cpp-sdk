...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoEnableService_ == nullptr
        && return this->commodityProvisions_ == nullptr && return this->enableURL_ == nullptr && return this->roleProvision_ == nullptr && return this->serviceName_ == nullptr && return this->status_ == nullptr
        && return this->statusReason_ == nullptr; };
