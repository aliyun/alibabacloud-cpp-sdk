...
namespace Models
{
  ...
  public:
    ...
    inline const RenewServiceInstanceResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RenewServiceInstanceResourcesResponseBody) };
    inline RenewServiceInstanceResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, RenewServiceInstanceResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RenewServiceInstanceResourcesResponseBody> body_ {};
  };
