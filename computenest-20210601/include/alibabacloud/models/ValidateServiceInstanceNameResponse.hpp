...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateServiceInstanceNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ValidateServiceInstanceNameResponseBody) };
    inline ValidateServiceInstanceNameResponseBody getBody() { DARABONBA_PTR_GET(body_, ValidateServiceInstanceNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ValidateServiceInstanceNameResponseBody> body_ {};
  };
