...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateMultiOrderRequest::OrderItems> & getOrderItems() const { DARABONBA_PTR_GET_CONST(orderItems_, vector<CreateMultiOrderRequest::OrderItems>) };
    inline vector<CreateMultiOrderRequest::OrderItems> getOrderItems() { DARABONBA_PTR_GET(orderItems_, vector<CreateMultiOrderRequest::OrderItems>) };
    inline CreateMultiOrderRequest& setOrderItems(const vector<CreateMultiOrderRequest::OrderItems> & orderItems) { DARABONBA_PTR_SET_VALUE(orderItems_, orderItems) };
    inline CreateMultiOrderRequest& setOrderItems(vector<CreateMultiOrderRequest::OrderItems> && orderItems) { DARABONBA_PTR_SET_RVALUE(orderItems_, orderItems) };
