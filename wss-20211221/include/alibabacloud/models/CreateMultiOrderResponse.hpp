...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMultiOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMultiOrderResponseBody) };
    inline CreateMultiOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMultiOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMultiOrderResponseBody> body_ {};
  };
