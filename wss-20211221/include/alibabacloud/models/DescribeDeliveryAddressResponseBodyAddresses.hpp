...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->area_ == nullptr
        && return this->city_ == nullptr && return this->contacts_ == nullptr && return this->defaultAddress_ == nullptr && return this->detail_ == nullptr && return this->mobile_ == nullptr
        && return this->postalCode_ == nullptr && return this->province_ == nullptr && return this->town_ == nullptr; };
