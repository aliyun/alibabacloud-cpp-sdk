...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline OrderItems& setAutoPay(bool autoPay) { DARABONBA_PTR_SET_VALUE(autoPay_, autoPay) };
      ...
      inline OrderItems& setAutoRenew(bool autoRenew) { DARABONBA_PTR_SET_VALUE(autoRenew_, autoRenew) };
      ...
      inline bool getBuyChange() const { DARABONBA_PTR_GET_DEFAULT(buyChange_, false) };
      inline OrderItems& setBuyChange(bool buyChange) { DARABONBA_PTR_SET_VALUE(buyChange_, buyChange) };
    ...
    virtual bool empty() const override { return this->channelCookie_ == nullptr
        && this->orderItems_ == nullptr && this->orderType_ == nullptr && this->propertiesShrink_ == nullptr && this->resellerOwnerUid_ == nullptr; };
    ...
    inline CreateMultiOrderShrinkRequest& setChannelCookie(string channelCookie) { DARABONBA_PTR_SET_VALUE(channelCookie_, channelCookie) };
    ...
    inline const vector<CreateMultiOrderShrinkRequest::OrderItems> & getOrderItems() const { DARABONBA_PTR_GET_CONST(orderItems_, vector<CreateMultiOrderShrinkRequest::OrderItems>) };
    inline vector<CreateMultiOrderShrinkRequest::OrderItems> getOrderItems() { DARABONBA_PTR_GET(orderItems_, vector<CreateMultiOrderShrinkRequest::OrderItems>) };
    inline CreateMultiOrderShrinkRequest& setOrderItems(const vector<CreateMultiOrderShrinkRequest::OrderItems> & orderItems) { DARABONBA_PTR_SET_VALUE(orderItems_, orderItems) };
    inline CreateMultiOrderShrinkRequest& setOrderItems(vector<CreateMultiOrderShrinkRequest::OrderItems> && orderItems) { DARABONBA_PTR_SET_RVALUE(orderItems_, orderItems) };
