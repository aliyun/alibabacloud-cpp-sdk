...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDeliveryAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDeliveryAddressResponseBody) };
    inline DescribeDeliveryAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDeliveryAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDeliveryAddressResponseBody> body_ {};
  };
