...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePackageDeductionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePackageDeductionsResponseBody) };
    inline DescribePackageDeductionsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePackageDeductionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePackageDeductionsResponseBody> body_ {};
  };
