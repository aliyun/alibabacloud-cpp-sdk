...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDeliveryAddressResponseBodyAddresses> & addresses() const { DARABONBA_PTR_GET_CONST(addresses_, vector<DescribeDeliveryAddressResponseBodyAddresses>) };
    inline vector<DescribeDeliveryAddressResponseBodyAddresses> addresses() { DARABONBA_PTR_GET(addresses_, vector<DescribeDeliveryAddressResponseBodyAddresses>) };
    inline DescribeDeliveryAddressResponseBody& setAddresses(const vector<DescribeDeliveryAddressResponseBodyAddresses> & addresses) { DARABONBA_PTR_SET_VALUE(addresses_, addresses) };
    inline DescribeDeliveryAddressResponseBody& setAddresses(vector<DescribeDeliveryAddressResponseBodyAddresses> && addresses) { DARABONBA_PTR_SET_RVALUE(addresses_, addresses) };
  ...
  protected:
    std::shared_ptr<vector<DescribeDeliveryAddressResponseBodyAddresses>> addresses_ = nullptr;
