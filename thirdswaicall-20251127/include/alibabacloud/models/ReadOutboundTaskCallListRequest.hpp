...
namespace Models
{
  ...
  public:
    ...
    inline ReadOutboundTaskCallListRequest& setCallerUacAccountId(string callerUacAccountId) { DARABONBA_PTR_SET_VALUE(callerUacAccountId_, callerUacAccountId) };
    ...
    inline ReadOutboundTaskCallListRequest& setCurrentWorkspaceId(string currentWorkspaceId) { DARABONBA_PTR_SET_VALUE(currentWorkspaceId_, currentWorkspaceId) };
