...
#ifndef ALIBABACLOUD_MODELS_LISTTRACESDATASREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTTRACESDATASREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListTracesDatasRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(SpanIds, spanIds_);
    ...
    friend void from_json(const Darabonba::Json& j, ListTracesDatasRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(SpanIds, spanIds_);
    ...
    ListTracesDatasRequest() = default ;
    ListTracesDatasRequest(const ListTracesDatasRequest &) = default ;
    ListTracesDatasRequest(ListTracesDatasRequest &&) = default ;
    ListTracesDatasRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListTracesDatasRequest() = default ;
    ListTracesDatasRequest& operator=(const ListTracesDatasRequest &) = default ;
    ListTracesDatasRequest& operator=(ListTracesDatasRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->endUserId_ != nullptr
        && this->filters_ != nullptr && this->hasEvents_ != nullptr && this->hasStatusMessage_ != nullptr && this->llmAppName_ != nullptr && this->maxDuration_ != nullptr
        ...
        && this->sortOrder_ != nullptr && this->spanIds_ != nullptr && this->spanName_ != nullptr && this->traceIds_ != nullptr && this->traceReduceMethod_ != nullptr; };
    // endUserId Field Functions 
    bool hasEndUserId() const { return this->endUserId_ != nullptr;};
    void deleteEndUserId() { this->endUserId_ = nullptr;};
    inline string endUserId() const { DARABONBA_PTR_GET_DEFAULT(endUserId_, "") };
    inline ListTracesDatasRequest& setEndUserId(string endUserId) { DARABONBA_PTR_SET_VALUE(endUserId_, endUserId) };


    // filters Field Functions 
    bool hasFilters() const { return this->filters_ != nullptr;};
    void deleteFilters() { this->filters_ = nullptr;};
    inline const vector<ListTracesDatasRequestFilters> & filters() const { DARABONBA_PTR_GET_CONST(filters_, vector<ListTracesDatasRequestFilters>) };
    inline vector<ListTracesDatasRequestFilters> filters() { DARABONBA_PTR_GET(filters_, vector<ListTracesDatasRequestFilters>) };
    inline ListTracesDatasRequest& setFilters(const vector<ListTracesDatasRequestFilters> & filters) { DARABONBA_PTR_SET_VALUE(filters_, filters) };
    inline ListTracesDatasRequest& setFilters(vector<ListTracesDatasRequestFilters> && filters) { DARABONBA_PTR_SET_RVALUE(filters_, filters) };
    ...
    inline ListTracesDatasRequest& setHasEvents(bool hasEvents) { DARABONBA_PTR_SET_VALUE(hasEvents_, hasEvents) };
    ...
    inline ListTracesDatasRequest& setHasStatusMessage(bool hasStatusMessage) { DARABONBA_PTR_SET_VALUE(hasStatusMessage_, hasStatusMessage) };
    ...
    inline ListTracesDatasRequest& setLlmAppName(string llmAppName) { DARABONBA_PTR_SET_VALUE(llmAppName_, llmAppName) };
    ...
    inline ListTracesDatasRequest& setMaxDuration(float maxDuration) { DARABONBA_PTR_SET_VALUE(maxDuration_, maxDuration) };
    ...
    inline ListTracesDatasRequest& setMaxTime(string maxTime) { DARABONBA_PTR_SET_VALUE(maxTime_, maxTime) };
    ...
    inline ListTracesDatasRequest& setMinDuration(float minDuration) { DARABONBA_PTR_SET_VALUE(minDuration_, minDuration) };
    ...
    inline ListTracesDatasRequest& setMinTime(string minTime) { DARABONBA_PTR_SET_VALUE(minTime_, minTime) };
    ...
    inline ListTracesDatasRequest& setOpentelemetryCompatible(bool opentelemetryCompatible) { DARABONBA_PTR_SET_VALUE(opentelemetryCompatible_, opentelemetryCompatible) };
    ...
    inline ListTracesDatasRequest& setOwnerId(string ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ListTracesDatasRequest& setOwnerSubId(string ownerSubId) { DARABONBA_PTR_SET_VALUE(ownerSubId_, ownerSubId) };
    ...
    inline ListTracesDatasRequest& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListTracesDatasRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListTracesDatasRequest& setSessionId(string sessionId) { DARABONBA_PTR_SET_VALUE(sessionId_, sessionId) };
    ...
    inline ListTracesDatasRequest& setSortBy(string sortBy) { DARABONBA_PTR_SET_VALUE(sortBy_, sortBy) };
    ...
    inline ListTracesDatasRequest& setSortOrder(string sortOrder) { DARABONBA_PTR_SET_VALUE(sortOrder_, sortOrder) };


    // spanIds Field Functions 
    bool hasSpanIds() const { return this->spanIds_ != nullptr;};
    void deleteSpanIds() { this->spanIds_ = nullptr;};
    inline const vector<string> & spanIds() const { DARABONBA_PTR_GET_CONST(spanIds_, vector<string>) };
    inline vector<string> spanIds() { DARABONBA_PTR_GET(spanIds_, vector<string>) };
    inline ListTracesDatasRequest& setSpanIds(const vector<string> & spanIds) { DARABONBA_PTR_SET_VALUE(spanIds_, spanIds) };
    inline ListTracesDatasRequest& setSpanIds(vector<string> && spanIds) { DARABONBA_PTR_SET_RVALUE(spanIds_, spanIds) };
    ...
    inline ListTracesDatasRequest& setSpanName(string spanName) { DARABONBA_PTR_SET_VALUE(spanName_, spanName) };
    ...
    inline ListTracesDatasRequest& setTraceIds(const vector<string> & traceIds) { DARABONBA_PTR_SET_VALUE(traceIds_, traceIds) };
    inline ListTracesDatasRequest& setTraceIds(vector<string> && traceIds) { DARABONBA_PTR_SET_RVALUE(traceIds_, traceIds) };
    ...
    inline ListTracesDatasRequest& setTraceReduceMethod(string traceReduceMethod) { DARABONBA_PTR_SET_VALUE(traceReduceMethod_, traceReduceMethod) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListTracesDatasRequestFilters>> filters_ = nullptr;
    ...
    std::shared_ptr<vector<string>> spanIds_ = nullptr;
