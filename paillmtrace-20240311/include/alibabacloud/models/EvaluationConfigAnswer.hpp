...
#ifndef ALIBABACLOUD_MODELS_EVALUATIONCONFIGANSWER_HPP_
#define ALIBABACLOUD_MODELS_EVALUATIONCONFIGANSWER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const EvaluationConfigAnswer& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EvaluationConfigAnswer& obj) { 
    ...
    EvaluationConfigAnswer() = default ;
    EvaluationConfigAnswer(const EvaluationConfigAnswer &) = default ;
    EvaluationConfigAnswer(EvaluationConfigAnswer &&) = default ;
    EvaluationConfigAnswer(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EvaluationConfigAnswer() = default ;
    EvaluationConfigAnswer& operator=(const EvaluationConfigAnswer &) = default ;
    EvaluationConfigAnswer& operator=(EvaluationConfigAnswer &&) = default ;
    ...
    inline EvaluationConfigAnswer& setJsonPathInSpan(string jsonPathInSpan) { DARABONBA_PTR_SET_VALUE(jsonPathInSpan_, jsonPathInSpan) };
    ...
    inline EvaluationConfigAnswer& setJsonPathInSpanValue(string jsonPathInSpanValue) { DARABONBA_PTR_SET_VALUE(jsonPathInSpanValue_, jsonPathInSpanValue) };
    ...
    inline EvaluationConfigAnswer& setSpanName(string spanName) { DARABONBA_PTR_SET_VALUE(spanName_, spanName) };
