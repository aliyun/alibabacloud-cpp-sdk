...
namespace Models
{
  ...
  public:
    ...
    inline const GetAttachmentUploadUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAttachmentUploadUrlResponseBody) };
    inline GetAttachmentUploadUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAttachmentUploadUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAttachmentUploadUrlResponseBody> body_ {};
  };
