...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHotKeysResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHotKeysResponseBody) };
    inline DescribeHotKeysResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHotKeysResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHotKeysResponseBody> body_ {};
  };
