...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTopHotKeysResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeTopHotKeysResponseBody) };
    inline DescribeTopHotKeysResponseBody body() { DARABONBA_PTR_GET(body_, DescribeTopHotKeysResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeTopHotKeysResponseBody> body_ = nullptr;
  };
