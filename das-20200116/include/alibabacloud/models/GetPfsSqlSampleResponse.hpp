...
namespace Models
{
  ...
  public:
    ...
    inline const GetPfsSqlSampleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPfsSqlSampleResponseBody) };
    inline GetPfsSqlSampleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPfsSqlSampleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPfsSqlSampleResponseBody> body_ {};
  };
