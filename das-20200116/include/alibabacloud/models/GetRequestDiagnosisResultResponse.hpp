...
namespace Models
{
  ...
  public:
    ...
    inline const GetRequestDiagnosisResultResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetRequestDiagnosisResultResponseBody) };
    inline GetRequestDiagnosisResultResponseBody body() { DARABONBA_PTR_GET(body_, GetRequestDiagnosisResultResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetRequestDiagnosisResultResponseBody> body_ = nullptr;
  };
