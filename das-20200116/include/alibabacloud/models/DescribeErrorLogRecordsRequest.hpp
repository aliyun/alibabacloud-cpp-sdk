...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->endTime_ == nullptr
        && return this->filters_ == nullptr && return this->instanceId_ == nullptr && return this->nodeId_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr
        && return this->role_ == nullptr && return this->startTime_ == nullptr; };
    ...
    inline const vector<DescribeErrorLogRecordsRequestFilters> & filters() const { DARABONBA_PTR_GET_CONST(filters_, vector<DescribeErrorLogRecordsRequestFilters>) };
    inline vector<DescribeErrorLogRecordsRequestFilters> filters() { DARABONBA_PTR_GET(filters_, vector<DescribeErrorLogRecordsRequestFilters>) };
    inline DescribeErrorLogRecordsRequest& setFilters(const vector<DescribeErrorLogRecordsRequestFilters> & filters) { DARABONBA_PTR_SET_VALUE(filters_, filters) };
    inline DescribeErrorLogRecordsRequest& setFilters(vector<DescribeErrorLogRecordsRequestFilters> && filters) { DARABONBA_PTR_SET_RVALUE(filters_, filters) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeErrorLogRecordsRequestFilters>> filters_ = nullptr;
    // This parameter is required.
