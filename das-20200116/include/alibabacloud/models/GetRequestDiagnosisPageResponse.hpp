...
namespace Models
{
  ...
  public:
    ...
    inline const GetRequestDiagnosisPageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRequestDiagnosisPageResponseBody) };
    inline GetRequestDiagnosisPageResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRequestDiagnosisPageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRequestDiagnosisPageResponseBody> body_ {};
  };
