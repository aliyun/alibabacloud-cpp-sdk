...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeErrorLogRecordsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeErrorLogRecordsResponseBody) };
    inline DescribeErrorLogRecordsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeErrorLogRecordsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeErrorLogRecordsResponseBody> body_ {};
  };
