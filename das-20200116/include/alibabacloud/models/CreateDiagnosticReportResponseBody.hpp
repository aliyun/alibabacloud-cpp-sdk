...
namespace Models
{
  ...
  public:
    ...
    inline CreateDiagnosticReportResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreateDiagnosticReportResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline CreateDiagnosticReportResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateDiagnosticReportResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };
