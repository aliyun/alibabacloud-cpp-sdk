...
namespace Models
{
  ...
  public:
    ...
    inline const GetStorageAnalysisResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetStorageAnalysisResultResponseBodyData) };
    inline GetStorageAnalysisResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetStorageAnalysisResultResponseBodyData) };
    inline GetStorageAnalysisResultResponseBody& setData(const GetStorageAnalysisResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetStorageAnalysisResultResponseBody& setData(GetStorageAnalysisResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetStorageAnalysisResultResponseBodyData> data_ = nullptr;
