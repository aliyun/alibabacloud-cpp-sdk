...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityIPGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSecurityIPGroupResponseBodyData) };
    inline DescribeSecurityIPGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSecurityIPGroupResponseBodyData) };
    inline DescribeSecurityIPGroupResponseBody& setData(const DescribeSecurityIPGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSecurityIPGroupResponseBody& setData(DescribeSecurityIPGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSecurityIPGroupResponseBodyData> data_ = nullptr;
