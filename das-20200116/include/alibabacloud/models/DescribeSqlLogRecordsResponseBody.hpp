...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSqlLogRecordsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSqlLogRecordsResponseBodyData) };
    inline DescribeSqlLogRecordsResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSqlLogRecordsResponseBodyData) };
    inline DescribeSqlLogRecordsResponseBody& setData(const DescribeSqlLogRecordsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSqlLogRecordsResponseBody& setData(DescribeSqlLogRecordsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSqlLogRecordsResponseBodyData> data_ = nullptr;
