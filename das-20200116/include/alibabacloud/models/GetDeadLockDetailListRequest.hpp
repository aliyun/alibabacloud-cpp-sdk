...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->dbNameList_ != nullptr
        && this->endTime_ != nullptr && this->instanceId_ != nullptr && this->pageNo_ != nullptr && this->pageSize_ != nullptr && this->startTime_ != nullptr; };
