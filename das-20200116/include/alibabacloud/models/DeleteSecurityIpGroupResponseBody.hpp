...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSecurityIPGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeleteSecurityIPGroupResponseBodyData) };
    inline DeleteSecurityIPGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, DeleteSecurityIPGroupResponseBodyData) };
    inline DeleteSecurityIPGroupResponseBody& setData(const DeleteSecurityIPGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteSecurityIPGroupResponseBody& setData(DeleteSecurityIPGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteSecurityIPGroupResponseBodyData> data_ = nullptr;
