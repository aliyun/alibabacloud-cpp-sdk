...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityIPGroupRelationResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeSecurityIPGroupRelationResponseBody::Data) };
    inline DescribeSecurityIPGroupRelationResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeSecurityIPGroupRelationResponseBody::Data) };
    inline DescribeSecurityIPGroupRelationResponseBody& setData(const DescribeSecurityIPGroupRelationResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSecurityIPGroupRelationResponseBody& setData(DescribeSecurityIPGroupRelationResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
