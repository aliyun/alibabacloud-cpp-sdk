...
namespace Models
{
  ...
  public:
    ...
    inline const GetHDMLastAliyunResourceSyncResultResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetHDMLastAliyunResourceSyncResultResponseBody::Data) };
    inline GetHDMLastAliyunResourceSyncResultResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetHDMLastAliyunResourceSyncResultResponseBody::Data) };
    inline GetHDMLastAliyunResourceSyncResultResponseBody& setData(const GetHDMLastAliyunResourceSyncResultResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHDMLastAliyunResourceSyncResultResponseBody& setData(GetHDMLastAliyunResourceSyncResultResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<GetHDMLastAliyunResourceSyncResultResponseBody::Data> data_ {};
