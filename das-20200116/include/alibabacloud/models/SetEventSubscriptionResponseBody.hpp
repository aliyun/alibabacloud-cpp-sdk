...
namespace Models
{
  ...
  public:
    ...
    inline const SetEventSubscriptionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SetEventSubscriptionResponseBodyData) };
    inline SetEventSubscriptionResponseBodyData data() { DARABONBA_PTR_GET(data_, SetEventSubscriptionResponseBodyData) };
    inline SetEventSubscriptionResponseBody& setData(const SetEventSubscriptionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SetEventSubscriptionResponseBody& setData(SetEventSubscriptionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SetEventSubscriptionResponseBodyData> data_ = nullptr;
