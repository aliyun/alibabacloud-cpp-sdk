...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityIPGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecurityIPGroupResponseBody) };
    inline DescribeSecurityIPGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSecurityIPGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSecurityIPGroupResponseBody> body_ {};
  };
