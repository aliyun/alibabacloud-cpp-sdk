...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetInstanceGroupInspectReportListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetInstanceGroupInspectReportListResponseBodyData>) };
    inline vector<GetInstanceGroupInspectReportListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetInstanceGroupInspectReportListResponseBodyData>) };
    inline GetInstanceGroupInspectReportListResponseBody& setData(const vector<GetInstanceGroupInspectReportListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInstanceGroupInspectReportListResponseBody& setData(vector<GetInstanceGroupInspectReportListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // List<ReportStatus>
    std::shared_ptr<vector<GetInstanceGroupInspectReportListResponseBodyData>> data_ = nullptr;
