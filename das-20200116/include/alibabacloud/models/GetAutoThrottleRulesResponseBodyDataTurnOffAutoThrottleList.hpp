...
#ifndef ALIBABACLOUD_MODELS_GETAUTOTHROTTLERULESRESPONSEBODYDATATURNOFFAUTOTHROTTLELIST_HPP_
#define ALIBABACLOUD_MODELS_GETAUTOTHROTTLERULESRESPONSEBODYDATATURNOFFAUTOTHROTTLELIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& obj) { 
    ...
    GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList() = default ;
    GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList(const GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList &) = default ;
    GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList(GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList &&) = default ;
    GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList() = default ;
    GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& operator=(const GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList &) = default ;
    GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& operator=(GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList &&) = default ;
    ...
    inline GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& setAbnormalDuration(double abnormalDuration) { DARABONBA_PTR_SET_VALUE(abnormalDuration_, abnormalDuration) };
    ...
    inline GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& setActiveSessions(int64_t activeSessions) { DARABONBA_PTR_SET_VALUE(activeSessions_, activeSessions) };
    ...
    inline GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& setAllowThrottleEndTime(string allowThrottleEndTime) { DARABONBA_PTR_SET_VALUE(allowThrottleEndTime_, allowThrottleEndTime) };
    ...
    inline GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& setAllowThrottleStartTime(string allowThrottleStartTime) { DARABONBA_PTR_SET_VALUE(allowThrottleStartTime_, allowThrottleStartTime) };
    ...
    inline GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& setAutoKillSession(bool autoKillSession) { DARABONBA_PTR_SET_VALUE(autoKillSession_, autoKillSession) };
    ...
    inline GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& setCpuSessionRelation(string cpuSessionRelation) { DARABONBA_PTR_SET_VALUE(cpuSessionRelation_, cpuSessionRelation) };
    ...
    inline GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& setCpuUsage(double cpuUsage) { DARABONBA_PTR_SET_VALUE(cpuUsage_, cpuUsage) };
    ...
    inline GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& setMaxThrottleTime(double maxThrottleTime) { DARABONBA_PTR_SET_VALUE(maxThrottleTime_, maxThrottleTime) };
    ...
    inline GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline GetAutoThrottleRulesResponseBodyDataTurnOffAutoThrottleList& setVisible(bool visible) { DARABONBA_PTR_SET_VALUE(visible_, visible) };
