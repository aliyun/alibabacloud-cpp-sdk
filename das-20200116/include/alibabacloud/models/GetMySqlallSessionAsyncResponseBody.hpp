...
namespace Models
{
  ...
  public:
    ...
    inline const GetMySQLAllSessionAsyncResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMySQLAllSessionAsyncResponseBodyData) };
    inline GetMySQLAllSessionAsyncResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMySQLAllSessionAsyncResponseBodyData) };
    inline GetMySQLAllSessionAsyncResponseBody& setData(const GetMySQLAllSessionAsyncResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMySQLAllSessionAsyncResponseBody& setData(GetMySQLAllSessionAsyncResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetMySQLAllSessionAsyncResponseBodyData> data_ = nullptr;
