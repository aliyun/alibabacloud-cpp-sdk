...
namespace Models
{
  ...
  public:
    ...
    inline const GetPfsSqlSummariesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetPfsSqlSummariesResponseBodyData) };
    inline GetPfsSqlSummariesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetPfsSqlSummariesResponseBodyData) };
    inline GetPfsSqlSummariesResponseBody& setData(const GetPfsSqlSummariesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPfsSqlSummariesResponseBody& setData(GetPfsSqlSummariesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetPfsSqlSummariesResponseBodyData> data_ = nullptr;
