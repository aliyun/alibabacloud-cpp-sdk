...
namespace Models
{
  ...
  public:
    ...
    inline const CreateQueryOptimizeTagResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateQueryOptimizeTagResponseBody) };
    inline CreateQueryOptimizeTagResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateQueryOptimizeTagResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateQueryOptimizeTagResponseBody> body_ {};
  };
