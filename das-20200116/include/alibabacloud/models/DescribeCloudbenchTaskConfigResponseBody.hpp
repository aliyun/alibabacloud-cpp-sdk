...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudbenchTaskConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCloudbenchTaskConfigResponseBodyData) };
    inline DescribeCloudbenchTaskConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCloudbenchTaskConfigResponseBodyData) };
    inline DescribeCloudbenchTaskConfigResponseBody& setData(const DescribeCloudbenchTaskConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCloudbenchTaskConfigResponseBody& setData(DescribeCloudbenchTaskConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCloudbenchTaskConfigResponseBodyData> data_ = nullptr;
