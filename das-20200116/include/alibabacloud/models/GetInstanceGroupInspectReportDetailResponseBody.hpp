...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceGroupInspectReportDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetInstanceGroupInspectReportDetailResponseBodyData) };
    inline GetInstanceGroupInspectReportDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetInstanceGroupInspectReportDetailResponseBodyData) };
    inline GetInstanceGroupInspectReportDetailResponseBody& setData(const GetInstanceGroupInspectReportDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInstanceGroupInspectReportDetailResponseBody& setData(GetInstanceGroupInspectReportDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // ReportDetail
    std::shared_ptr<GetInstanceGroupInspectReportDetailResponseBodyData> data_ = nullptr;
