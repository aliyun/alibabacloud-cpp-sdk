...
namespace Models
{
  ...
  public:
    ...
    inline const GetAutoThrottleRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAutoThrottleRulesResponseBodyData) };
    inline GetAutoThrottleRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAutoThrottleRulesResponseBodyData) };
    inline GetAutoThrottleRulesResponseBody& setData(const GetAutoThrottleRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAutoThrottleRulesResponseBody& setData(GetAutoThrottleRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetAutoThrottleRulesResponseBodyData> data_ = nullptr;
