...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySqlLogConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ModifySqlLogConfigResponseBodyData) };
    inline ModifySqlLogConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, ModifySqlLogConfigResponseBodyData) };
    inline ModifySqlLogConfigResponseBody& setData(const ModifySqlLogConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifySqlLogConfigResponseBody& setData(ModifySqlLogConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ModifySqlLogConfigResponseBodyData> data_ = nullptr;
