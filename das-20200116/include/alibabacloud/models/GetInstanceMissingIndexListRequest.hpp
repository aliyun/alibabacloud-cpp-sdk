...
namespace Models
{
  ...
  public:
    ...
    inline string getAvgTotalUserCost() const { DARABONBA_PTR_GET_DEFAULT(avgTotalUserCost_, "") };
    ...
    inline string getAvgUserImpact() const { DARABONBA_PTR_GET_DEFAULT(avgUserImpact_, "") };
    ...
    inline string getIndexCount() const { DARABONBA_PTR_GET_DEFAULT(indexCount_, "") };
    ...
    inline string getReservedPages() const { DARABONBA_PTR_GET_DEFAULT(reservedPages_, "") };
    ...
    inline string getReservedSize() const { DARABONBA_PTR_GET_DEFAULT(reservedSize_, "") };
    ...
    inline string getRowCount() const { DARABONBA_PTR_GET_DEFAULT(rowCount_, "") };
    ...
    inline string getUniqueCompiles() const { DARABONBA_PTR_GET_DEFAULT(uniqueCompiles_, "") };
    ...
    inline string getUserScans() const { DARABONBA_PTR_GET_DEFAULT(userScans_, "") };
    ...
    inline string getUserSeeks() const { DARABONBA_PTR_GET_DEFAULT(userSeeks_, "") };
  ...
  protected:
    ...
    shared_ptr<string> avgTotalUserCost_ {};
    // The query condition based on the performance improvement.
    shared_ptr<string> avgUserImpact_ {};
