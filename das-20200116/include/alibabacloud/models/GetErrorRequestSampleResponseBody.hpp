...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetErrorRequestSampleResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetErrorRequestSampleResponseBodyData>) };
    inline vector<GetErrorRequestSampleResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetErrorRequestSampleResponseBodyData>) };
    inline GetErrorRequestSampleResponseBody& setData(const vector<GetErrorRequestSampleResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetErrorRequestSampleResponseBody& setData(vector<GetErrorRequestSampleResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<vector<GetErrorRequestSampleResponseBodyData>> data_ = nullptr;
