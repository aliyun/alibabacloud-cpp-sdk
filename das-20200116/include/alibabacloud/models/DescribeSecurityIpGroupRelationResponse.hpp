...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityIPGroupRelationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecurityIPGroupRelationResponseBody) };
    inline DescribeSecurityIPGroupRelationResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSecurityIPGroupRelationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSecurityIPGroupRelationResponseBody> body_ {};
  };
