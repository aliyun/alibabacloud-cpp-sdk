...
namespace Models
{
  ...
  public:
    ...
    inline const GetMongoDBCurrentOpResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMongoDBCurrentOpResponseBodyData) };
    inline GetMongoDBCurrentOpResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMongoDBCurrentOpResponseBodyData) };
    inline GetMongoDBCurrentOpResponseBody& setData(const GetMongoDBCurrentOpResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMongoDBCurrentOpResponseBody& setData(GetMongoDBCurrentOpResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetMongoDBCurrentOpResponseBodyData> data_ = nullptr;
