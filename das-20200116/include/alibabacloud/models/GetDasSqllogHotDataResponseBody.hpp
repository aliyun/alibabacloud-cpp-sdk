...
namespace Models
{
  ...
  public:
    ...
    inline const GetDasSQLLogHotDataResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDasSQLLogHotDataResponseBodyData) };
    inline GetDasSQLLogHotDataResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDasSQLLogHotDataResponseBodyData) };
    inline GetDasSQLLogHotDataResponseBody& setData(const GetDasSQLLogHotDataResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDasSQLLogHotDataResponseBody& setData(GetDasSQLLogHotDataResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetDasSQLLogHotDataResponseBodyData> data_ = nullptr;
