...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSlowLogHistogramAsyncResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSlowLogHistogramAsyncResponseBodyData) };
    inline DescribeSlowLogHistogramAsyncResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSlowLogHistogramAsyncResponseBodyData) };
    inline DescribeSlowLogHistogramAsyncResponseBody& setData(const DescribeSlowLogHistogramAsyncResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSlowLogHistogramAsyncResponseBody& setData(DescribeSlowLogHistogramAsyncResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSlowLogHistogramAsyncResponseBodyData> data_ = nullptr;
