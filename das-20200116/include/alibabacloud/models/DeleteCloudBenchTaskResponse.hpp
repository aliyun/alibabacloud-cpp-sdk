...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCloudBenchTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteCloudBenchTaskResponseBody) };
    inline DeleteCloudBenchTaskResponseBody body() { DARABONBA_PTR_GET(body_, DeleteCloudBenchTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteCloudBenchTaskResponseBody> body_ = nullptr;
  };
