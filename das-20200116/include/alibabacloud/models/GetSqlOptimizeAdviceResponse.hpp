...
namespace Models
{
  ...
  public:
    ...
    inline const GetSqlOptimizeAdviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSqlOptimizeAdviceResponseBody) };
    inline GetSqlOptimizeAdviceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSqlOptimizeAdviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSqlOptimizeAdviceResponseBody> body_ {};
  };
