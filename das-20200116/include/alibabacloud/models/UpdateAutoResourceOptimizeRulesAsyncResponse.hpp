...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAutoResourceOptimizeRulesAsyncResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateAutoResourceOptimizeRulesAsyncResponseBody) };
    inline UpdateAutoResourceOptimizeRulesAsyncResponseBody body() { DARABONBA_PTR_GET(body_, UpdateAutoResourceOptimizeRulesAsyncResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateAutoResourceOptimizeRulesAsyncResponseBody> body_ = nullptr;
  };
