...
namespace Models
{
  ...
  public:
    ...
    inline const GetRedisAllSessionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRedisAllSessionResponseBodyData) };
    inline GetRedisAllSessionResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRedisAllSessionResponseBodyData) };
    inline GetRedisAllSessionResponseBody& setData(const GetRedisAllSessionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRedisAllSessionResponseBody& setData(GetRedisAllSessionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The session data.
    std::shared_ptr<GetRedisAllSessionResponseBodyData> data_ = nullptr;
