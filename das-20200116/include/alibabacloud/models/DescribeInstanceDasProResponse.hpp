...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceDasProResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceDasProResponseBody) };
    inline DescribeInstanceDasProResponseBody body() { DARABONBA_PTR_GET(body_, DescribeInstanceDasProResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeInstanceDasProResponseBody> body_ = nullptr;
  };
