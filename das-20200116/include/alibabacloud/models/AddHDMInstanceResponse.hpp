...
namespace Models
{
  ...
  public:
    ...
    inline const AddHDMInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddHDMInstanceResponseBody) };
    inline AddHDMInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, AddHDMInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddHDMInstanceResponseBody> body_ {};
  };
