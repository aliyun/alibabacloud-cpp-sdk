...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAutoScalingConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAutoScalingConfigResponseBody) };
    inline ModifyAutoScalingConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAutoScalingConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAutoScalingConfigResponseBody> body_ {};
  };
