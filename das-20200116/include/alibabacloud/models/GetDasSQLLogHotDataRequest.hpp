...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountName_ == nullptr
        && this->childDBInstanceIDs_ == nullptr && this->DBName_ == nullptr && this->end_ == nullptr && this->fail_ == nullptr && this->hostAddress_ == nullptr
        && this->instanceId_ == nullptr && this->logicalOperator_ == nullptr && this->maxLatancy_ == nullptr && this->maxRecordsPerPage_ == nullptr && this->maxRows_ == nullptr
        && this->maxScanRows_ == nullptr && this->maxSpillCnt_ == nullptr && this->minLatancy_ == nullptr && this->minRows_ == nullptr && this->minScanRows_ == nullptr
        && this->minSpillCnt_ == nullptr && this->pageNumbers_ == nullptr && this->queryKeyword_ == nullptr && this->role_ == nullptr && this->sortKey_ == nullptr
        && this->sortMethod_ == nullptr && this->sqlType_ == nullptr && this->start_ == nullptr && this->state_ == nullptr && this->threadID_ == nullptr
        && this->traceId_ == nullptr && this->transactionId_ == nullptr; };
    ...
    inline string getChildDBInstanceIDs() const { DARABONBA_PTR_GET_DEFAULT(childDBInstanceIDs_, "") };
    ...
    inline int64_t getMaxLatancy() const { DARABONBA_PTR_GET_DEFAULT(maxLatancy_, 0L) };
    ...
    inline int64_t getMaxRecordsPerPage() const { DARABONBA_PTR_GET_DEFAULT(maxRecordsPerPage_, 0L) };
    ...
    inline int64_t getMaxScanRows() const { DARABONBA_PTR_GET_DEFAULT(maxScanRows_, 0L) };
    ...
    inline int64_t getMaxSpillCnt() const { DARABONBA_PTR_GET_DEFAULT(maxSpillCnt_, 0L) };
    ...
    inline int64_t getMinLatancy() const { DARABONBA_PTR_GET_DEFAULT(minLatancy_, 0L) };
    ...
    inline int64_t getMinRows() const { DARABONBA_PTR_GET_DEFAULT(minRows_, 0L) };
    ...
    inline int64_t getMinScanRows() const { DARABONBA_PTR_GET_DEFAULT(minScanRows_, 0L) };
    ...
    inline int64_t getMinSpillCnt() const { DARABONBA_PTR_GET_DEFAULT(minSpillCnt_, 0L) };
    ...
    inline int64_t getPageNumbers() const { DARABONBA_PTR_GET_DEFAULT(pageNumbers_, 0L) };
