...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSqlLogTasksResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSqlLogTasksResponseBody) };
    inline DescribeSqlLogTasksResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSqlLogTasksResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSqlLogTasksResponseBody> body_ = nullptr;
  };
