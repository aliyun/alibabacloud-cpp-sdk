...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySecurityIPGroupRelationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ModifySecurityIPGroupRelationResponseBodyData) };
    inline ModifySecurityIPGroupRelationResponseBodyData data() { DARABONBA_PTR_GET(data_, ModifySecurityIPGroupRelationResponseBodyData) };
    inline ModifySecurityIPGroupRelationResponseBody& setData(const ModifySecurityIPGroupRelationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifySecurityIPGroupRelationResponseBody& setData(ModifySecurityIPGroupRelationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ModifySecurityIPGroupRelationResponseBodyData> data_ = nullptr;
