...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudbenchTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCloudbenchTaskResponseBodyData) };
    inline DescribeCloudbenchTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCloudbenchTaskResponseBodyData) };
    inline DescribeCloudbenchTaskResponseBody& setData(const DescribeCloudbenchTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCloudbenchTaskResponseBody& setData(DescribeCloudbenchTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCloudbenchTaskResponseBodyData> data_ = nullptr;
