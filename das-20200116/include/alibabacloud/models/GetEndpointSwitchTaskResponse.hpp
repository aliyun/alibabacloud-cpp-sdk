...
namespace Models
{
  ...
  public:
    ...
    inline const GetEndpointSwitchTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEndpointSwitchTaskResponseBody) };
    inline GetEndpointSwitchTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEndpointSwitchTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEndpointSwitchTaskResponseBody> body_ {};
  };
