...
namespace Models
{
  ...
  public:
    ...
    inline const GetAsyncErrorRequestStatResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAsyncErrorRequestStatResultResponseBody) };
    inline GetAsyncErrorRequestStatResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAsyncErrorRequestStatResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAsyncErrorRequestStatResultResponseBody> body_ {};
  };
