...
namespace Models
{
  ...
  public:
    ...
    inline const GetRequestDiagnosisPageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRequestDiagnosisPageResponseBodyData) };
    inline GetRequestDiagnosisPageResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRequestDiagnosisPageResponseBodyData) };
    inline GetRequestDiagnosisPageResponseBody& setData(const GetRequestDiagnosisPageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRequestDiagnosisPageResponseBody& setData(GetRequestDiagnosisPageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetRequestDiagnosisPageResponseBodyData> data_ = nullptr;
