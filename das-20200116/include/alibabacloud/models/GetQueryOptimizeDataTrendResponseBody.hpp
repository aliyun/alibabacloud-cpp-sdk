...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueryOptimizeDataTrendResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQueryOptimizeDataTrendResponseBodyData) };
    inline GetQueryOptimizeDataTrendResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQueryOptimizeDataTrendResponseBodyData) };
    inline GetQueryOptimizeDataTrendResponseBody& setData(const GetQueryOptimizeDataTrendResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQueryOptimizeDataTrendResponseBody& setData(GetQueryOptimizeDataTrendResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQueryOptimizeDataTrendResponseBodyData> data_ = nullptr;
