...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTopBigKeysResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeTopBigKeysResponseBodyData) };
    inline DescribeTopBigKeysResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeTopBigKeysResponseBodyData) };
    inline DescribeTopBigKeysResponseBody& setData(const DescribeTopBigKeysResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeTopBigKeysResponseBody& setData(DescribeTopBigKeysResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeTopBigKeysResponseBodyData> data_ = nullptr;
