...
namespace Models
{
  ...
  public:
    ...
    inline const GetSqlConcurrencyControlRulesHistoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSqlConcurrencyControlRulesHistoryResponseBodyData) };
    inline GetSqlConcurrencyControlRulesHistoryResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSqlConcurrencyControlRulesHistoryResponseBodyData) };
    inline GetSqlConcurrencyControlRulesHistoryResponseBody& setData(const GetSqlConcurrencyControlRulesHistoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSqlConcurrencyControlRulesHistoryResponseBody& setData(GetSqlConcurrencyControlRulesHistoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSqlConcurrencyControlRulesHistoryResponseBodyData> data_ = nullptr;
