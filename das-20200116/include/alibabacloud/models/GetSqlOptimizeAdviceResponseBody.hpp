...
namespace Models
{
  ...
  public:
    ...
    inline const GetSqlOptimizeAdviceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSqlOptimizeAdviceResponseBodyData) };
    inline GetSqlOptimizeAdviceResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSqlOptimizeAdviceResponseBodyData) };
    inline GetSqlOptimizeAdviceResponseBody& setData(const GetSqlOptimizeAdviceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSqlOptimizeAdviceResponseBody& setData(GetSqlOptimizeAdviceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSqlOptimizeAdviceResponseBodyData> data_ = nullptr;
