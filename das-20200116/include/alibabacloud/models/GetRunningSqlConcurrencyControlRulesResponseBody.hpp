...
namespace Models
{
  ...
  public:
    ...
    inline const GetRunningSqlConcurrencyControlRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRunningSqlConcurrencyControlRulesResponseBodyData) };
    inline GetRunningSqlConcurrencyControlRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRunningSqlConcurrencyControlRulesResponseBodyData) };
    inline GetRunningSqlConcurrencyControlRulesResponseBody& setData(const GetRunningSqlConcurrencyControlRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRunningSqlConcurrencyControlRulesResponseBody& setData(GetRunningSqlConcurrencyControlRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetRunningSqlConcurrencyControlRulesResponseBodyData> data_ = nullptr;
