...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSqlLogTasksResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSqlLogTasksResponseBodyData) };
    inline DescribeSqlLogTasksResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSqlLogTasksResponseBodyData) };
    inline DescribeSqlLogTasksResponseBody& setData(const DescribeSqlLogTasksResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSqlLogTasksResponseBody& setData(DescribeSqlLogTasksResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeSqlLogTasksResponseBodyData> data_ = nullptr;
