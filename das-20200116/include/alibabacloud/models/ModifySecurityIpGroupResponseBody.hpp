...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySecurityIPGroupResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifySecurityIPGroupResponseBody::Data) };
    inline ModifySecurityIPGroupResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifySecurityIPGroupResponseBody::Data) };
    inline ModifySecurityIPGroupResponseBody& setData(const ModifySecurityIPGroupResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifySecurityIPGroupResponseBody& setData(ModifySecurityIPGroupResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
