...
namespace Models
{
  ...
  public:
    ...
    inline const GetDeadLockDetailListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDeadLockDetailListResponseBodyData) };
    inline GetDeadLockDetailListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDeadLockDetailListResponseBodyData) };
    inline GetDeadLockDetailListResponseBody& setData(const GetDeadLockDetailListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDeadLockDetailListResponseBody& setData(GetDeadLockDetailListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetDeadLockDetailListResponseBodyData> data_ = nullptr;
