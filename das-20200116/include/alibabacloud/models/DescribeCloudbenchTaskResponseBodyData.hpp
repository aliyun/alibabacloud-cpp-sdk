...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECLOUDBENCHTASKRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECLOUDBENCHTASKRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCloudbenchTaskResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeCloudbenchTaskResponseBodyData& obj) { 
    ...
    DescribeCloudbenchTaskResponseBodyData() = default ;
    DescribeCloudbenchTaskResponseBodyData(const DescribeCloudbenchTaskResponseBodyData &) = default ;
    DescribeCloudbenchTaskResponseBodyData(DescribeCloudbenchTaskResponseBodyData &&) = default ;
    DescribeCloudbenchTaskResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCloudbenchTaskResponseBodyData() = default ;
    DescribeCloudbenchTaskResponseBodyData& operator=(const DescribeCloudbenchTaskResponseBodyData &) = default ;
    DescribeCloudbenchTaskResponseBodyData& operator=(DescribeCloudbenchTaskResponseBodyData &&) = default ;
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setArchiveJobId(string archiveJobId) { DARABONBA_PTR_SET_VALUE(archiveJobId_, archiveJobId) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setArchiveOssTableName(string archiveOssTableName) { DARABONBA_PTR_SET_VALUE(archiveOssTableName_, archiveOssTableName) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setArchiveState(int32_t archiveState) { DARABONBA_PTR_SET_VALUE(archiveState_, archiveState) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setBackupId(string backupId) { DARABONBA_PTR_SET_VALUE(backupId_, backupId) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setBackupType(string backupType) { DARABONBA_PTR_SET_VALUE(backupType_, backupType) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setBenchStep(string benchStep) { DARABONBA_PTR_SET_VALUE(benchStep_, benchStep) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setBenchStepStatus(string benchStepStatus) { DARABONBA_PTR_SET_VALUE(benchStepStatus_, benchStepStatus) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setClientGatewayId(string clientGatewayId) { DARABONBA_PTR_SET_VALUE(clientGatewayId_, clientGatewayId) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setClientType(string clientType) { DARABONBA_PTR_SET_VALUE(clientType_, clientType) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setDstInstanceUuid(string dstInstanceUuid) { DARABONBA_PTR_SET_VALUE(dstInstanceUuid_, dstInstanceUuid) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setDstIp(string dstIp) { DARABONBA_PTR_SET_VALUE(dstIp_, dstIp) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setDstPort(int32_t dstPort) { DARABONBA_PTR_SET_VALUE(dstPort_, dstPort) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setDstType(string dstType) { DARABONBA_PTR_SET_VALUE(dstType_, dstType) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setDtsJobClass(string dtsJobClass) { DARABONBA_PTR_SET_VALUE(dtsJobClass_, dtsJobClass) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setDtsJobId(string dtsJobId) { DARABONBA_PTR_SET_VALUE(dtsJobId_, dtsJobId) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setDtsJobName(string dtsJobName) { DARABONBA_PTR_SET_VALUE(dtsJobName_, dtsJobName) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setDtsJobState(int32_t dtsJobState) { DARABONBA_PTR_SET_VALUE(dtsJobState_, dtsJobState) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setDtsJobStatus(string dtsJobStatus) { DARABONBA_PTR_SET_VALUE(dtsJobStatus_, dtsJobStatus) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setEcsInstanceId(string ecsInstanceId) { DARABONBA_PTR_SET_VALUE(ecsInstanceId_, ecsInstanceId) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setEndState(string endState) { DARABONBA_PTR_SET_VALUE(endState_, endState) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setExternal(string external) { DARABONBA_PTR_SET_VALUE(external_, external) };


    // rate Field Functions 
    bool hasRate() const { return this->rate_ != nullptr;};
    void deleteRate() { this->rate_ = nullptr;};
    inline int64_t rate() const { DARABONBA_PTR_GET_DEFAULT(rate_, 0L) };
    inline DescribeCloudbenchTaskResponseBodyData& setRate(int64_t rate) { DARABONBA_PTR_SET_VALUE(rate_, rate) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setRequestDuration(int64_t requestDuration) { DARABONBA_PTR_SET_VALUE(requestDuration_, requestDuration) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setSmartPressureTime(int32_t smartPressureTime) { DARABONBA_PTR_SET_VALUE(smartPressureTime_, smartPressureTime) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setSqlCompleteReuse(string sqlCompleteReuse) { DARABONBA_PTR_SET_VALUE(sqlCompleteReuse_, sqlCompleteReuse) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setSrcInstanceArea(string srcInstanceArea) { DARABONBA_PTR_SET_VALUE(srcInstanceArea_, srcInstanceArea) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setSrcInstanceUuid(string srcInstanceUuid) { DARABONBA_PTR_SET_VALUE(srcInstanceUuid_, srcInstanceUuid) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setSrcPublicIp(string srcPublicIp) { DARABONBA_PTR_SET_VALUE(srcPublicIp_, srcPublicIp) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setState(string state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setTableSchema(string tableSchema) { DARABONBA_PTR_SET_VALUE(tableSchema_, tableSchema) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setTaskType(string taskType) { DARABONBA_PTR_SET_VALUE(taskType_, taskType) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setTopic(string topic) { DARABONBA_PTR_SET_VALUE(topic_, topic) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setVersion(string version) { DARABONBA_PTR_SET_VALUE(version_, version) };
    ...
    inline DescribeCloudbenchTaskResponseBodyData& setWorkDir(string workDir) { DARABONBA_PTR_SET_VALUE(workDir_, workDir) };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> rate_ = nullptr;
