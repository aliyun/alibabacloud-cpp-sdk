...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueryOptimizeDataStatsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQueryOptimizeDataStatsResponseBodyData) };
    inline GetQueryOptimizeDataStatsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQueryOptimizeDataStatsResponseBodyData) };
    inline GetQueryOptimizeDataStatsResponseBody& setData(const GetQueryOptimizeDataStatsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQueryOptimizeDataStatsResponseBody& setData(GetQueryOptimizeDataStatsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetQueryOptimizeDataStatsResponseBodyData> data_ = nullptr;
