...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudBenchTasksResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCloudBenchTasksResponseBodyData) };
    inline DescribeCloudBenchTasksResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCloudBenchTasksResponseBodyData) };
    inline DescribeCloudBenchTasksResponseBody& setData(const DescribeCloudBenchTasksResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCloudBenchTasksResponseBody& setData(DescribeCloudBenchTasksResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCloudBenchTasksResponseBodyData> data_ = nullptr;
