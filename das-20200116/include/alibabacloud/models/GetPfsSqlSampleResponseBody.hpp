...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetPfsSqlSampleResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetPfsSqlSampleResponseBodyData>) };
    inline vector<GetPfsSqlSampleResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetPfsSqlSampleResponseBodyData>) };
    inline GetPfsSqlSampleResponseBody& setData(const vector<GetPfsSqlSampleResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetPfsSqlSampleResponseBody& setData(vector<GetPfsSqlSampleResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The SQL sample data.
    std::shared_ptr<vector<GetPfsSqlSampleResponseBodyData>> data_ = nullptr;
