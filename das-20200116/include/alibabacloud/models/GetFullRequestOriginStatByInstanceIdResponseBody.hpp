...
namespace Models
{
  ...
  public:
    ...
    inline const GetFullRequestOriginStatByInstanceIdResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetFullRequestOriginStatByInstanceIdResponseBodyData) };
    inline GetFullRequestOriginStatByInstanceIdResponseBodyData data() { DARABONBA_PTR_GET(data_, GetFullRequestOriginStatByInstanceIdResponseBodyData) };
    inline GetFullRequestOriginStatByInstanceIdResponseBody& setData(const GetFullRequestOriginStatByInstanceIdResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFullRequestOriginStatByInstanceIdResponseBody& setData(GetFullRequestOriginStatByInstanceIdResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetFullRequestOriginStatByInstanceIdResponseBodyData> data_ = nullptr;
