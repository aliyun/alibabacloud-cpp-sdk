...
namespace Models
{
  ...
  public:
    ...
    inline const SetEventSubscriptionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetEventSubscriptionResponseBody) };
    inline SetEventSubscriptionResponseBody getBody() { DARABONBA_PTR_GET(body_, SetEventSubscriptionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetEventSubscriptionResponseBody> body_ {};
  };
