...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSqlLogTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSqlLogTaskResponseBodyData) };
    inline DescribeSqlLogTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSqlLogTaskResponseBodyData) };
    inline DescribeSqlLogTaskResponseBody& setData(const DescribeSqlLogTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSqlLogTaskResponseBody& setData(DescribeSqlLogTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeSqlLogTaskResponseBodyData> data_ = nullptr;
