...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCloudBenchTasksResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateCloudBenchTasksResponseBodyData) };
    inline CreateCloudBenchTasksResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateCloudBenchTasksResponseBodyData) };
    inline CreateCloudBenchTasksResponseBody& setData(const CreateCloudBenchTasksResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateCloudBenchTasksResponseBody& setData(CreateCloudBenchTasksResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateCloudBenchTasksResponseBodyData> data_ = nullptr;
