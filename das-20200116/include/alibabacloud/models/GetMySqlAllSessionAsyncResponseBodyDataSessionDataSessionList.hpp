...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->client_ == nullptr
        && return this->command_ == nullptr && return this->dbName_ == nullptr && return this->sessionId_ == nullptr && return this->sqlTemplateId_ == nullptr && return this->sqlText_ == nullptr
        && return this->state_ == nullptr && return this->time_ == nullptr && return this->trxDuration_ == nullptr && return this->trxId_ == nullptr && return this->user_ == nullptr
        && return this->userClientAlias_ == nullptr; };
