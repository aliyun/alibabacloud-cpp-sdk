...
namespace Models
{
  ...
  public:
    ...
    inline const GetHDMAliyunResourceSyncResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHDMAliyunResourceSyncResultResponseBodyData) };
    inline GetHDMAliyunResourceSyncResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHDMAliyunResourceSyncResultResponseBodyData) };
    inline GetHDMAliyunResourceSyncResultResponseBody& setData(const GetHDMAliyunResourceSyncResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHDMAliyunResourceSyncResultResponseBody& setData(GetHDMAliyunResourceSyncResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHDMAliyunResourceSyncResultResponseBodyData> data_ = nullptr;
