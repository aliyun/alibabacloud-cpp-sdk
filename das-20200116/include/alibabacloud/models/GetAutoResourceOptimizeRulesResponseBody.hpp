...
namespace Models
{
  ...
  public:
    ...
    inline const GetAutoResourceOptimizeRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAutoResourceOptimizeRulesResponseBodyData) };
    inline GetAutoResourceOptimizeRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAutoResourceOptimizeRulesResponseBodyData) };
    inline GetAutoResourceOptimizeRulesResponseBody& setData(const GetAutoResourceOptimizeRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAutoResourceOptimizeRulesResponseBody& setData(GetAutoResourceOptimizeRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetAutoResourceOptimizeRulesResponseBodyData> data_ = nullptr;
