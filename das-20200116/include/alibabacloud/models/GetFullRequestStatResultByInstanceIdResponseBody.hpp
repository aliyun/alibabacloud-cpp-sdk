...
namespace Models
{
  ...
  public:
    ...
    inline const GetFullRequestStatResultByInstanceIdResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetFullRequestStatResultByInstanceIdResponseBodyData) };
    inline GetFullRequestStatResultByInstanceIdResponseBodyData data() { DARABONBA_PTR_GET(data_, GetFullRequestStatResultByInstanceIdResponseBodyData) };
    inline GetFullRequestStatResultByInstanceIdResponseBody& setData(const GetFullRequestStatResultByInstanceIdResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFullRequestStatResultByInstanceIdResponseBody& setData(GetFullRequestStatResultByInstanceIdResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetFullRequestStatResultByInstanceIdResponseBodyData> data_ = nullptr;
