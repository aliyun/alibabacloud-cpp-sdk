...
namespace Models
{
  ...
  public:
    ...
    inline const GetKillInstanceSessionTaskResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetKillInstanceSessionTaskResultResponseBodyData) };
    inline GetKillInstanceSessionTaskResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetKillInstanceSessionTaskResultResponseBodyData) };
    inline GetKillInstanceSessionTaskResultResponseBody& setData(const GetKillInstanceSessionTaskResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetKillInstanceSessionTaskResultResponseBody& setData(GetKillInstanceSessionTaskResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetKillInstanceSessionTaskResultResponseBodyData> data_ = nullptr;
