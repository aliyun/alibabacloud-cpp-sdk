...
namespace Models
{
  ...
  public:
    ...
    inline const DisableAllSqlConcurrencyControlRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableAllSqlConcurrencyControlRulesResponseBody) };
    inline DisableAllSqlConcurrencyControlRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableAllSqlConcurrencyControlRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableAllSqlConcurrencyControlRulesResponseBody> body_ {};
  };
