...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueryOptimizeExecErrorSampleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQueryOptimizeExecErrorSampleResponseBodyData) };
    inline GetQueryOptimizeExecErrorSampleResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQueryOptimizeExecErrorSampleResponseBodyData) };
    inline GetQueryOptimizeExecErrorSampleResponseBody& setData(const GetQueryOptimizeExecErrorSampleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQueryOptimizeExecErrorSampleResponseBody& setData(GetQueryOptimizeExecErrorSampleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQueryOptimizeExecErrorSampleResponseBodyData> data_ = nullptr;
