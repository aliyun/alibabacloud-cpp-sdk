...
namespace Models
{
  ...
  public:
    ...
    inline const GetRequestDiagnosisResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRequestDiagnosisResultResponseBodyData) };
    inline GetRequestDiagnosisResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRequestDiagnosisResultResponseBodyData) };
    inline GetRequestDiagnosisResultResponseBody& setData(const GetRequestDiagnosisResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRequestDiagnosisResultResponseBody& setData(GetRequestDiagnosisResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetRequestDiagnosisResultResponseBodyData> data_ = nullptr;
