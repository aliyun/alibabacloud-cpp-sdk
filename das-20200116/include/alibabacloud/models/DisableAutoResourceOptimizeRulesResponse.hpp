...
namespace Models
{
  ...
  public:
    ...
    inline const DisableAutoResourceOptimizeRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableAutoResourceOptimizeRulesResponseBody) };
    inline DisableAutoResourceOptimizeRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableAutoResourceOptimizeRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableAutoResourceOptimizeRulesResponseBody> body_ {};
  };
