...
#ifndef ALIBABACLOUD_MODELS_GETREQUESTDIAGNOSISRESULTRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETREQUESTDIAGNOSISRESULTRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetRequestDiagnosisResultResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetRequestDiagnosisResultResponseBodyData& obj) { 
    ...
    GetRequestDiagnosisResultResponseBodyData() = default ;
    GetRequestDiagnosisResultResponseBodyData(const GetRequestDiagnosisResultResponseBodyData &) = default ;
    GetRequestDiagnosisResultResponseBodyData(GetRequestDiagnosisResultResponseBodyData &&) = default ;
    GetRequestDiagnosisResultResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetRequestDiagnosisResultResponseBodyData() = default ;
    GetRequestDiagnosisResultResponseBodyData& operator=(const GetRequestDiagnosisResultResponseBodyData &) = default ;
    GetRequestDiagnosisResultResponseBodyData& operator=(GetRequestDiagnosisResultResponseBodyData &&) = default ;
    ...
    inline GetRequestDiagnosisResultResponseBodyData& setAccountId(string accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline GetRequestDiagnosisResultResponseBodyData& setDbSchema(string dbSchema) { DARABONBA_PTR_SET_VALUE(dbSchema_, dbSchema) };
    ...
    inline GetRequestDiagnosisResultResponseBodyData& setEngine(string engine) { DARABONBA_PTR_SET_VALUE(engine_, engine) };
    ...
    inline GetRequestDiagnosisResultResponseBodyData& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline GetRequestDiagnosisResultResponseBodyData& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline GetRequestDiagnosisResultResponseBodyData& setMessageId(string messageId) { DARABONBA_PTR_SET_VALUE(messageId_, messageId) };
    ...
    inline GetRequestDiagnosisResultResponseBodyData& setParam(string param) { DARABONBA_PTR_SET_VALUE(param_, param) };
    ...
    inline GetRequestDiagnosisResultResponseBodyData& setResult(string result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    ...
    inline GetRequestDiagnosisResultResponseBodyData& setSqlId(string sqlId) { DARABONBA_PTR_SET_VALUE(sqlId_, sqlId) };
    ...
    inline GetRequestDiagnosisResultResponseBodyData& setState(int32_t state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    ...
    inline GetRequestDiagnosisResultResponseBodyData& setUuid(string uuid) { DARABONBA_PTR_SET_VALUE(uuid_, uuid) };
