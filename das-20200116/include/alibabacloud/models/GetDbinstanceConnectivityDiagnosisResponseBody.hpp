...
namespace Models
{
  ...
  public:
    ...
    inline const GetDBInstanceConnectivityDiagnosisResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDBInstanceConnectivityDiagnosisResponseBodyData) };
    inline GetDBInstanceConnectivityDiagnosisResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDBInstanceConnectivityDiagnosisResponseBodyData) };
    inline GetDBInstanceConnectivityDiagnosisResponseBody& setData(const GetDBInstanceConnectivityDiagnosisResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDBInstanceConnectivityDiagnosisResponseBody& setData(GetDBInstanceConnectivityDiagnosisResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDBInstanceConnectivityDiagnosisResponseBodyData> data_ = nullptr;
