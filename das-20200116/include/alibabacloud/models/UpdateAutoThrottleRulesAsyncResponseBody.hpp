...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAutoThrottleRulesAsyncResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateAutoThrottleRulesAsyncResponseBody::Data) };
    inline UpdateAutoThrottleRulesAsyncResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateAutoThrottleRulesAsyncResponseBody::Data) };
    inline UpdateAutoThrottleRulesAsyncResponseBody& setData(const UpdateAutoThrottleRulesAsyncResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateAutoThrottleRulesAsyncResponseBody& setData(UpdateAutoThrottleRulesAsyncResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
