...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceInspectionsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetInstanceInspectionsResponseBodyData) };
    inline GetInstanceInspectionsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetInstanceInspectionsResponseBodyData) };
    inline GetInstanceInspectionsResponseBody& setData(const GetInstanceInspectionsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetInstanceInspectionsResponseBody& setData(GetInstanceInspectionsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The details.
    std::shared_ptr<GetInstanceInspectionsResponseBodyData> data_ = nullptr;
