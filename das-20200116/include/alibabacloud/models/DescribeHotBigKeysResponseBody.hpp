...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHotBigKeysResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeHotBigKeysResponseBodyData) };
    inline DescribeHotBigKeysResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeHotBigKeysResponseBodyData) };
    inline DescribeHotBigKeysResponseBody& setData(const DescribeHotBigKeysResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeHotBigKeysResponseBody& setData(DescribeHotBigKeysResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeHotBigKeysResponseBodyData> data_ = nullptr;
