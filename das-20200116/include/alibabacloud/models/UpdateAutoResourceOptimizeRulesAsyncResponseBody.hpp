...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAutoResourceOptimizeRulesAsyncResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateAutoResourceOptimizeRulesAsyncResponseBodyData) };
    inline UpdateAutoResourceOptimizeRulesAsyncResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateAutoResourceOptimizeRulesAsyncResponseBodyData) };
    inline UpdateAutoResourceOptimizeRulesAsyncResponseBody& setData(const UpdateAutoResourceOptimizeRulesAsyncResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateAutoResourceOptimizeRulesAsyncResponseBody& setData(UpdateAutoResourceOptimizeRulesAsyncResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<UpdateAutoResourceOptimizeRulesAsyncResponseBodyData> data_ = nullptr;
