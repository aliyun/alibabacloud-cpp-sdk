...
namespace Models
{
  ...
  public:
    ...
    inline const GetBlockingDetailListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetBlockingDetailListResponseBody) };
    inline GetBlockingDetailListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetBlockingDetailListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetBlockingDetailListResponseBody> body_ {};
  };
