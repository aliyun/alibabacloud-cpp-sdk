...
namespace Models
{
  ...
  public:
    ...
    inline const DisableAutoThrottleRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DisableAutoThrottleRulesResponseBodyData) };
    inline DisableAutoThrottleRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, DisableAutoThrottleRulesResponseBodyData) };
    inline DisableAutoThrottleRulesResponseBody& setData(const DisableAutoThrottleRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DisableAutoThrottleRulesResponseBody& setData(DisableAutoThrottleRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DisableAutoThrottleRulesResponseBodyData> data_ = nullptr;
