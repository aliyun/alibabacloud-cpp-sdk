...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSqlLogStatisticResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSqlLogStatisticResponseBodyData) };
    inline DescribeSqlLogStatisticResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSqlLogStatisticResponseBodyData) };
    inline DescribeSqlLogStatisticResponseBody& setData(const DescribeSqlLogStatisticResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSqlLogStatisticResponseBody& setData(DescribeSqlLogStatisticResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeSqlLogStatisticResponseBodyData> data_ = nullptr;
