  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->clientIp_ == nullptr
        && this->clientPort_ == nullptr && this->clientUa_ == nullptr && this->columnName_ == nullptr && this->creationTime_ == nullptr && this->databaseName_ == nullptr
        && this->effectRow_ == nullptr && this->executeStatus_ == nullptr && this->executeTime_ == nullptr && this->id_ == nullptr && this->inWhiteList_ == nullptr
        && this->instanceAuditStatus_ == nullptr && this->instanceDescription_ == nullptr && this->instanceName_ == nullptr && this->ipType_ == nullptr && this->logSource_ == nullptr
        && this->logTime_ == nullptr && this->message_ == nullptr && this->operateType_ == nullptr && this->ossObjectKey_ == nullptr && this->packageName_ == nullptr
