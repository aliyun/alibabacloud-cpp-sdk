...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->asc_ == nullptr
        && return this->end_ == nullptr && return this->instanceId_ == nullptr && return this->nodeId_ == nullptr && return this->orderBy_ == nullptr && return this->pageNo_ == nullptr
        && return this->pageSize_ == nullptr && return this->role_ == nullptr && return this->sqlType_ == nullptr && return this->start_ == nullptr && return this->userId_ == nullptr; };
    // asc Field Functions 
