...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSlowLogStatisticResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSlowLogStatisticResponseBodyData) };
    inline DescribeSlowLogStatisticResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSlowLogStatisticResponseBodyData) };
    inline DescribeSlowLogStatisticResponseBody& setData(const DescribeSlowLogStatisticResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSlowLogStatisticResponseBody& setData(DescribeSlowLogStatisticResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSlowLogStatisticResponseBodyData> data_ = nullptr;
