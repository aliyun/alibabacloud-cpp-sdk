...
namespace Models
{
  ...
  public:
    ...
    inline const DisableSqlConcurrencyControlResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DisableSqlConcurrencyControlResponseBody) };
    inline DisableSqlConcurrencyControlResponseBody body() { DARABONBA_PTR_GET(body_, DisableSqlConcurrencyControlResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DisableSqlConcurrencyControlResponseBody> body_ = nullptr;
  };
