...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceSqlOptimizeStatisticResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceSqlOptimizeStatisticResponseBody) };
    inline GetInstanceSqlOptimizeStatisticResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceSqlOptimizeStatisticResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceSqlOptimizeStatisticResponseBody> body_ {};
  };
