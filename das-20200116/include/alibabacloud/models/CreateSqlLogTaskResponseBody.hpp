...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSqlLogTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateSqlLogTaskResponseBodyData) };
    inline CreateSqlLogTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateSqlLogTaskResponseBodyData) };
    inline CreateSqlLogTaskResponseBody& setData(const CreateSqlLogTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateSqlLogTaskResponseBody& setData(CreateSqlLogTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<CreateSqlLogTaskResponseBodyData> data_ = nullptr;
