...
namespace Models
{
  ...
  public:
    ...
    inline const RunCloudBenchTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RunCloudBenchTaskResponseBodyData) };
    inline RunCloudBenchTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, RunCloudBenchTaskResponseBodyData) };
    inline RunCloudBenchTaskResponseBody& setData(const RunCloudBenchTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RunCloudBenchTaskResponseBody& setData(RunCloudBenchTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<RunCloudBenchTaskResponseBodyData> data_ = nullptr;
