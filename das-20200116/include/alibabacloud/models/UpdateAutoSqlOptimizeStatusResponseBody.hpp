...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAutoSqlOptimizeStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateAutoSqlOptimizeStatusResponseBodyData) };
    inline UpdateAutoSqlOptimizeStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateAutoSqlOptimizeStatusResponseBodyData) };
    inline UpdateAutoSqlOptimizeStatusResponseBody& setData(const UpdateAutoSqlOptimizeStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateAutoSqlOptimizeStatusResponseBody& setData(UpdateAutoSqlOptimizeStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<UpdateAutoSqlOptimizeStatusResponseBodyData> data_ = nullptr;
