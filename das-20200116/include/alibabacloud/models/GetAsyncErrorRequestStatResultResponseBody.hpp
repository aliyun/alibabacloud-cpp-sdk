...
namespace Models
{
  ...
  public:
    ...
    inline const GetAsyncErrorRequestStatResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAsyncErrorRequestStatResultResponseBodyData) };
    inline GetAsyncErrorRequestStatResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAsyncErrorRequestStatResultResponseBodyData) };
    inline GetAsyncErrorRequestStatResultResponseBody& setData(const GetAsyncErrorRequestStatResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAsyncErrorRequestStatResultResponseBody& setData(GetAsyncErrorRequestStatResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetAsyncErrorRequestStatResultResponseBodyData> data_ = nullptr;
