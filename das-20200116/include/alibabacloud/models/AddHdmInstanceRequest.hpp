...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->engine_ == nullptr
        && return this->flushAccount_ == nullptr && return this->instanceAlias_ == nullptr && return this->instanceArea_ == nullptr && return this->instanceId_ == nullptr && return this->ip_ == nullptr
        && return this->networkType_ == nullptr && return this->password_ == nullptr && return this->port_ == nullptr && return this->region_ == nullptr && return this->username_ == nullptr
        && return this->vpcId_ == nullptr && return this->context_ == nullptr; };
