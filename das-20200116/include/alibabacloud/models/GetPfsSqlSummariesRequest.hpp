...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->asc_ == nullptr
        && return this->endTime_ == nullptr && return this->instanceId_ == nullptr && return this->keywords_ == nullptr && return this->nodeId_ == nullptr && return this->orderBy_ == nullptr
        && return this->pageNo_ == nullptr && return this->pageSize_ == nullptr && return this->sqlId_ == nullptr && return this->startTime_ == nullptr; };
    // asc Field Functions 
