...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHotKeysResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeHotKeysResponseBodyData) };
    inline DescribeHotKeysResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeHotKeysResponseBodyData) };
    inline DescribeHotKeysResponseBody& setData(const DescribeHotKeysResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeHotKeysResponseBody& setData(DescribeHotKeysResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeHotKeysResponseBodyData> data_ = nullptr;
