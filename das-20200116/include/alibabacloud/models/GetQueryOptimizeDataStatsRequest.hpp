...
namespace Models
{
  ...
  public:
    ...
    inline string getAsc() const { DARABONBA_PTR_GET_DEFAULT(asc_, "") };
    ...
    inline string getOnlyOptimizedSql() const { DARABONBA_PTR_GET_DEFAULT(onlyOptimizedSql_, "") };
  ...
  protected:
    ...
    shared_ptr<string> onlyOptimizedSql_ {};
