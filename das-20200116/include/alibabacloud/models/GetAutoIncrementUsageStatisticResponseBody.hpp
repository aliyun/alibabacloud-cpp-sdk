...
namespace Models
{
  ...
  public:
    ...
    inline const GetAutoIncrementUsageStatisticResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAutoIncrementUsageStatisticResponseBodyData) };
    inline GetAutoIncrementUsageStatisticResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAutoIncrementUsageStatisticResponseBodyData) };
    inline GetAutoIncrementUsageStatisticResponseBody& setData(const GetAutoIncrementUsageStatisticResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAutoIncrementUsageStatisticResponseBody& setData(GetAutoIncrementUsageStatisticResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetAutoIncrementUsageStatisticResponseBodyData> data_ = nullptr;
