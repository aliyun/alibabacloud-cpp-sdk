...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->avgExaminedRows_ == nullptr
        ...
        && return this->avgReturnedRows_ == nullptr && return this->avgRt_ == nullptr && return this->avgSqlCount_ == nullptr && return this->avgUpdatedRows_ == nullptr && return this->count_ == nullptr
        && return this->countRate_ == nullptr && return this->database_ == nullptr && return this->errorCount_ == nullptr && return this->examinedRows_ == nullptr && return this->fetchRows_ == nullptr
        && return this->ip_ == nullptr && return this->lockWaitTime_ == nullptr && return this->logicalRead_ == nullptr && return this->physicalAsyncRead_ == nullptr && return this->physicalSyncRead_ == nullptr
        && return this->port_ == nullptr && return this->psql_ == nullptr && return this->rows_ == nullptr && return this->rtGreaterThanOneSecondCount_ == nullptr && return this->rtRate_ == nullptr
        && return this->sqlCount_ == nullptr && return this->sqlId_ == nullptr && return this->sumUpdatedRows_ == nullptr && return this->tables_ == nullptr && return this->version_ == nullptr
