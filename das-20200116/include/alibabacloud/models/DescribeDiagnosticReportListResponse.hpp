...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDiagnosticReportListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDiagnosticReportListResponseBody) };
    inline DescribeDiagnosticReportListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDiagnosticReportListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDiagnosticReportListResponseBody> body_ {};
  };
