...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCacheAnalysisJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateCacheAnalysisJobResponseBodyData) };
    inline CreateCacheAnalysisJobResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateCacheAnalysisJobResponseBodyData) };
    inline CreateCacheAnalysisJobResponseBody& setData(const CreateCacheAnalysisJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateCacheAnalysisJobResponseBody& setData(CreateCacheAnalysisJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateCacheAnalysisJobResponseBodyData> data_ = nullptr;
