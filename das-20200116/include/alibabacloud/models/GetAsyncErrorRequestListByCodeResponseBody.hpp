...
namespace Models
{
  ...
  public:
    ...
    inline const GetAsyncErrorRequestListByCodeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAsyncErrorRequestListByCodeResponseBodyData) };
    inline GetAsyncErrorRequestListByCodeResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAsyncErrorRequestListByCodeResponseBodyData) };
    inline GetAsyncErrorRequestListByCodeResponseBody& setData(const GetAsyncErrorRequestListByCodeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAsyncErrorRequestListByCodeResponseBody& setData(GetAsyncErrorRequestListByCodeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetAsyncErrorRequestListByCodeResponseBodyData> data_ = nullptr;
