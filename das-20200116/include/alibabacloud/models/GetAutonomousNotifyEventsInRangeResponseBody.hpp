...
namespace Models
{
  ...
  public:
    ...
    inline const GetAutonomousNotifyEventsInRangeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAutonomousNotifyEventsInRangeResponseBodyData) };
    inline GetAutonomousNotifyEventsInRangeResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAutonomousNotifyEventsInRangeResponseBodyData) };
    inline GetAutonomousNotifyEventsInRangeResponseBody& setData(const GetAutonomousNotifyEventsInRangeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAutonomousNotifyEventsInRangeResponseBody& setData(GetAutonomousNotifyEventsInRangeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAutonomousNotifyEventsInRangeResponseBodyData> data_ = nullptr;
