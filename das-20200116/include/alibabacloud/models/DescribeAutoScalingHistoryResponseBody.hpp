...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutoScalingHistoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeAutoScalingHistoryResponseBodyData) };
    inline DescribeAutoScalingHistoryResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeAutoScalingHistoryResponseBodyData) };
    inline DescribeAutoScalingHistoryResponseBody& setData(const DescribeAutoScalingHistoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAutoScalingHistoryResponseBody& setData(DescribeAutoScalingHistoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAutoScalingHistoryResponseBodyData> data_ = nullptr;
