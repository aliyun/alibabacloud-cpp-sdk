...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceInspectionsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceInspectionsResponseBody) };
    inline GetInstanceInspectionsResponseBody body() { DARABONBA_PTR_GET(body_, GetInstanceInspectionsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetInstanceInspectionsResponseBody> body_ = nullptr;
  };
