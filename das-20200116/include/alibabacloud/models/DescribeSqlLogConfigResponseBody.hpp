...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSqlLogConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSqlLogConfigResponseBodyData) };
    inline DescribeSqlLogConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSqlLogConfigResponseBodyData) };
    inline DescribeSqlLogConfigResponseBody& setData(const DescribeSqlLogConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSqlLogConfigResponseBody& setData(DescribeSqlLogConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSqlLogConfigResponseBodyData> data_ = nullptr;
