...
namespace Models
{
  ...
  public:
    ...
    inline const GetKillInstanceSessionTaskResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetKillInstanceSessionTaskResultResponseBody) };
    inline GetKillInstanceSessionTaskResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetKillInstanceSessionTaskResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetKillInstanceSessionTaskResultResponseBody> body_ {};
  };
