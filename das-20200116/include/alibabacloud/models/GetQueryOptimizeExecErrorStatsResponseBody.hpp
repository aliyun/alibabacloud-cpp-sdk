...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueryOptimizeExecErrorStatsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQueryOptimizeExecErrorStatsResponseBodyData) };
    inline GetQueryOptimizeExecErrorStatsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQueryOptimizeExecErrorStatsResponseBodyData) };
    inline GetQueryOptimizeExecErrorStatsResponseBody& setData(const GetQueryOptimizeExecErrorStatsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQueryOptimizeExecErrorStatsResponseBody& setData(GetQueryOptimizeExecErrorStatsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQueryOptimizeExecErrorStatsResponseBodyData> data_ = nullptr;
