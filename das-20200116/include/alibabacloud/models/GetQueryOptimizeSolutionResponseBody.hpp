...
namespace Models
{
  ...
  public:
    ...
    inline const GetQueryOptimizeSolutionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQueryOptimizeSolutionResponseBodyData) };
    inline GetQueryOptimizeSolutionResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQueryOptimizeSolutionResponseBodyData) };
    inline GetQueryOptimizeSolutionResponseBody& setData(const GetQueryOptimizeSolutionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQueryOptimizeSolutionResponseBody& setData(GetQueryOptimizeSolutionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetQueryOptimizeSolutionResponseBodyData> data_ = nullptr;
