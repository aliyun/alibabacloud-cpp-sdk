...
namespace Models
{
  ...
  public:
    ...
    inline const GetEventSubscriptionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetEventSubscriptionResponseBodyData) };
    inline GetEventSubscriptionResponseBodyData data() { DARABONBA_PTR_GET(data_, GetEventSubscriptionResponseBodyData) };
    inline GetEventSubscriptionResponseBody& setData(const GetEventSubscriptionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetEventSubscriptionResponseBody& setData(GetEventSubscriptionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetEventSubscriptionResponseBodyData> data_ = nullptr;
