...
namespace Models
{
  ...
  public:
    ...
    inline const DisableAutoResourceOptimizeRulesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DisableAutoResourceOptimizeRulesResponseBody::Data) };
    inline DisableAutoResourceOptimizeRulesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DisableAutoResourceOptimizeRulesResponseBody::Data) };
    inline DisableAutoResourceOptimizeRulesResponseBody& setData(const DisableAutoResourceOptimizeRulesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DisableAutoResourceOptimizeRulesResponseBody& setData(DisableAutoResourceOptimizeRulesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
