...
namespace Models
{
  ...
  public:
    ...
    inline const GetAutonomousNotifyEventContentResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAutonomousNotifyEventContentResponseBody) };
    inline GetAutonomousNotifyEventContentResponseBody body() { DARABONBA_PTR_GET(body_, GetAutonomousNotifyEventContentResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAutonomousNotifyEventContentResponseBody> body_ = nullptr;
  };
