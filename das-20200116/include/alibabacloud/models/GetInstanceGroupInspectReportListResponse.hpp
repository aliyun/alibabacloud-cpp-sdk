...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceGroupInspectReportListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceGroupInspectReportListResponseBody) };
    inline GetInstanceGroupInspectReportListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceGroupInspectReportListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceGroupInspectReportListResponseBody> body_ {};
  };
