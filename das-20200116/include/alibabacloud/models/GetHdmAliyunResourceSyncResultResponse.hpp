...
namespace Models
{
  ...
  public:
    ...
    inline const GetHDMAliyunResourceSyncResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHDMAliyunResourceSyncResultResponseBody) };
    inline GetHDMAliyunResourceSyncResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHDMAliyunResourceSyncResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHDMAliyunResourceSyncResultResponseBody> body_ {};
  };
