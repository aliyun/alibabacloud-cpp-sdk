...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSqlLogConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSqlLogConfigResponseBody) };
    inline DescribeSqlLogConfigResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSqlLogConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSqlLogConfigResponseBody> body_ = nullptr;
  };
