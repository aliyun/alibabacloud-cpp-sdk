...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAsyncErrorRequestStatByCodeResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAsyncErrorRequestStatByCodeResponseBody& obj) { 
    ...
    GetAsyncErrorRequestStatByCodeResponseBody() = default ;
    GetAsyncErrorRequestStatByCodeResponseBody(const GetAsyncErrorRequestStatByCodeResponseBody &) = default ;
    GetAsyncErrorRequestStatByCodeResponseBody(GetAsyncErrorRequestStatByCodeResponseBody &&) = default ;
    GetAsyncErrorRequestStatByCodeResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAsyncErrorRequestStatByCodeResponseBody() = default ;
    GetAsyncErrorRequestStatByCodeResponseBody& operator=(const GetAsyncErrorRequestStatByCodeResponseBody &) = default ;
    GetAsyncErrorRequestStatByCodeResponseBody& operator=(GetAsyncErrorRequestStatByCodeResponseBody &&) = default ;
