...
#include <map>
#include <alibabacloud/models/DeleteSessionResponseBody.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSessionResponseBody) };
    inline DeleteSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSessionResponseBody) };
    inline DeleteSessionResponse& setBody(const DeleteSessionResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline DeleteSessionResponse& setBody(DeleteSessionResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<DeleteSessionResponseBody> body_ {};
  };
