...
#ifndef ALIBABACLOUD_MODELS_ONSTRENDTOPICINPUTTPSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ONSTRENDTOPICINPUTTPSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const OnsTrendTopicInputTpsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, OnsTrendTopicInputTpsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    OnsTrendTopicInputTpsResponseBody() = default ;
    OnsTrendTopicInputTpsResponseBody(const OnsTrendTopicInputTpsResponseBody &) = default ;
    OnsTrendTopicInputTpsResponseBody(OnsTrendTopicInputTpsResponseBody &&) = default ;
    OnsTrendTopicInputTpsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~OnsTrendTopicInputTpsResponseBody() = default ;
    OnsTrendTopicInputTpsResponseBody& operator=(const OnsTrendTopicInputTpsResponseBody &) = default ;
    OnsTrendTopicInputTpsResponseBody& operator=(OnsTrendTopicInputTpsResponseBody &&) = default ;
    ...
    inline const OnsTrendTopicInputTpsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, OnsTrendTopicInputTpsResponseBody::Data) };
    inline OnsTrendTopicInputTpsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, OnsTrendTopicInputTpsResponseBody::Data) };
    inline OnsTrendTopicInputTpsResponseBody& setData(const OnsTrendTopicInputTpsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline OnsTrendTopicInputTpsResponseBody& setData(OnsTrendTopicInputTpsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline OnsTrendTopicInputTpsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The data returned.
    shared_ptr<OnsTrendTopicInputTpsResponseBody::Data> data_ {};
