...
#ifndef ALIBABACLOUD_MODELS_ONSDLQMESSAGEGETBYIDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ONSDLQMESSAGEGETBYIDRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const OnsDLQMessageGetByIdResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, OnsDLQMessageGetByIdResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    OnsDLQMessageGetByIdResponseBody() = default ;
    OnsDLQMessageGetByIdResponseBody(const OnsDLQMessageGetByIdResponseBody &) = default ;
    OnsDLQMessageGetByIdResponseBody(OnsDLQMessageGetByIdResponseBody &&) = default ;
    OnsDLQMessageGetByIdResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~OnsDLQMessageGetByIdResponseBody() = default ;
    OnsDLQMessageGetByIdResponseBody& operator=(const OnsDLQMessageGetByIdResponseBody &) = default ;
    OnsDLQMessageGetByIdResponseBody& operator=(OnsDLQMessageGetByIdResponseBody &&) = default ;
    ...
    inline const OnsDLQMessageGetByIdResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, OnsDLQMessageGetByIdResponseBody::Data) };
    inline OnsDLQMessageGetByIdResponseBody::Data getData() { DARABONBA_PTR_GET(data_, OnsDLQMessageGetByIdResponseBody::Data) };
    inline OnsDLQMessageGetByIdResponseBody& setData(const OnsDLQMessageGetByIdResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline OnsDLQMessageGetByIdResponseBody& setData(OnsDLQMessageGetByIdResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline OnsDLQMessageGetByIdResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The data returned.
    shared_ptr<OnsDLQMessageGetByIdResponseBody::Data> data_ {};
