...
#ifndef ALIBABACLOUD_MODELS_ONSDLQMESSAGEPAGEQUERYBYGROUPIDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ONSDLQMESSAGEPAGEQUERYBYGROUPIDRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const OnsDLQMessagePageQueryByGroupIdResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(MsgFoundDo, msgFoundDo_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, OnsDLQMessagePageQueryByGroupIdResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(MsgFoundDo, msgFoundDo_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    OnsDLQMessagePageQueryByGroupIdResponseBody() = default ;
    OnsDLQMessagePageQueryByGroupIdResponseBody(const OnsDLQMessagePageQueryByGroupIdResponseBody &) = default ;
    OnsDLQMessagePageQueryByGroupIdResponseBody(OnsDLQMessagePageQueryByGroupIdResponseBody &&) = default ;
    OnsDLQMessagePageQueryByGroupIdResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~OnsDLQMessagePageQueryByGroupIdResponseBody() = default ;
    OnsDLQMessagePageQueryByGroupIdResponseBody& operator=(const OnsDLQMessagePageQueryByGroupIdResponseBody &) = default ;
    OnsDLQMessagePageQueryByGroupIdResponseBody& operator=(OnsDLQMessagePageQueryByGroupIdResponseBody &&) = default ;
    ...
    inline const OnsDLQMessagePageQueryByGroupIdResponseBody::MsgFoundDo & getMsgFoundDo() const { DARABONBA_PTR_GET_CONST(msgFoundDo_, OnsDLQMessagePageQueryByGroupIdResponseBody::MsgFoundDo) };
    inline OnsDLQMessagePageQueryByGroupIdResponseBody::MsgFoundDo getMsgFoundDo() { DARABONBA_PTR_GET(msgFoundDo_, OnsDLQMessagePageQueryByGroupIdResponseBody::MsgFoundDo) };
    inline OnsDLQMessagePageQueryByGroupIdResponseBody& setMsgFoundDo(const OnsDLQMessagePageQueryByGroupIdResponseBody::MsgFoundDo & msgFoundDo) { DARABONBA_PTR_SET_VALUE(msgFoundDo_, msgFoundDo) };
    inline OnsDLQMessagePageQueryByGroupIdResponseBody& setMsgFoundDo(OnsDLQMessagePageQueryByGroupIdResponseBody::MsgFoundDo && msgFoundDo) { DARABONBA_PTR_SET_RVALUE(msgFoundDo_, msgFoundDo) };
    ...
    inline OnsDLQMessagePageQueryByGroupIdResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The information about dead-letter messages that are queried.
    shared_ptr<OnsDLQMessagePageQueryByGroupIdResponseBody::MsgFoundDo> msgFoundDo_ {};
