...
#ifndef ALIBABACLOUD_MODELS_ONSMESSAGEGETBYMSGIDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ONSMESSAGEGETBYMSGIDRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const OnsMessageGetByMsgIdResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, OnsMessageGetByMsgIdResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    OnsMessageGetByMsgIdResponseBody() = default ;
    OnsMessageGetByMsgIdResponseBody(const OnsMessageGetByMsgIdResponseBody &) = default ;
    OnsMessageGetByMsgIdResponseBody(OnsMessageGetByMsgIdResponseBody &&) = default ;
    OnsMessageGetByMsgIdResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~OnsMessageGetByMsgIdResponseBody() = default ;
    OnsMessageGetByMsgIdResponseBody& operator=(const OnsMessageGetByMsgIdResponseBody &) = default ;
    OnsMessageGetByMsgIdResponseBody& operator=(OnsMessageGetByMsgIdResponseBody &&) = default ;
    ...
    public:
      ...
      inline const Data::PropertyList & getPropertyList() const { DARABONBA_PTR_GET_CONST(propertyList_, Data::PropertyList) };
      inline Data::PropertyList getPropertyList() { DARABONBA_PTR_GET(propertyList_, Data::PropertyList) };
      inline Data& setPropertyList(const Data::PropertyList & propertyList) { DARABONBA_PTR_SET_VALUE(propertyList_, propertyList) };
      inline Data& setPropertyList(Data::PropertyList && propertyList) { DARABONBA_PTR_SET_RVALUE(propertyList_, propertyList) };
    ...
    protected:
      ...
      shared_ptr<Data::PropertyList> propertyList_ {};
    ...
    inline const OnsMessageGetByMsgIdResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, OnsMessageGetByMsgIdResponseBody::Data) };
    inline OnsMessageGetByMsgIdResponseBody::Data getData() { DARABONBA_PTR_GET(data_, OnsMessageGetByMsgIdResponseBody::Data) };
    inline OnsMessageGetByMsgIdResponseBody& setData(const OnsMessageGetByMsgIdResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline OnsMessageGetByMsgIdResponseBody& setData(OnsMessageGetByMsgIdResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline OnsMessageGetByMsgIdResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The data returned.
    shared_ptr<OnsMessageGetByMsgIdResponseBody::Data> data_ {};
