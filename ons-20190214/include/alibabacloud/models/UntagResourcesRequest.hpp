...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->all_ == nullptr
        && this->instanceId_ == nullptr && this->resourceId_ == nullptr && this->resourceType_ == nullptr && this->tagKey_ == nullptr; };
    // all Field Functions 
    ...
    inline UntagResourcesRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
