...
#ifndef ALIBABACLOUD_MODELS_LISTCUSTOMROUTINGPORTMAPPINGSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTCUSTOMROUTINGPORTMAPPINGSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListCustomRoutingPortMappingsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListCustomRoutingPortMappingsResponseBody& obj) { 
    ...
    ListCustomRoutingPortMappingsResponseBody() = default ;
    ListCustomRoutingPortMappingsResponseBody(const ListCustomRoutingPortMappingsResponseBody &) = default ;
    ListCustomRoutingPortMappingsResponseBody(ListCustomRoutingPortMappingsResponseBody &&) = default ;
    ListCustomRoutingPortMappingsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListCustomRoutingPortMappingsResponseBody() = default ;
    ListCustomRoutingPortMappingsResponseBody& operator=(const ListCustomRoutingPortMappingsResponseBody &) = default ;
    ListCustomRoutingPortMappingsResponseBody& operator=(ListCustomRoutingPortMappingsResponseBody &&) = default ;
    ...
    inline ListCustomRoutingPortMappingsResponseBody& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListCustomRoutingPortMappingsResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline const vector<ListCustomRoutingPortMappingsResponseBody::PortMappings> & getPortMappings() const { DARABONBA_PTR_GET_CONST(portMappings_, vector<ListCustomRoutingPortMappingsResponseBody::PortMappings>) };
    inline vector<ListCustomRoutingPortMappingsResponseBody::PortMappings> getPortMappings() { DARABONBA_PTR_GET(portMappings_, vector<ListCustomRoutingPortMappingsResponseBody::PortMappings>) };
    inline ListCustomRoutingPortMappingsResponseBody& setPortMappings(const vector<ListCustomRoutingPortMappingsResponseBody::PortMappings> & portMappings) { DARABONBA_PTR_SET_VALUE(portMappings_, portMappings) };
    inline ListCustomRoutingPortMappingsResponseBody& setPortMappings(vector<ListCustomRoutingPortMappingsResponseBody::PortMappings> && portMappings) { DARABONBA_PTR_SET_RVALUE(portMappings_, portMappings) };
    ...
    inline ListCustomRoutingPortMappingsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListCustomRoutingPortMappingsResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
