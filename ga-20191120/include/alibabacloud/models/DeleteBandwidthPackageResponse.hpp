...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBandwidthPackageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBandwidthPackageResponseBody) };
    inline DeleteBandwidthPackageResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBandwidthPackageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBandwidthPackageResponseBody> body_ {};
  };
