...
#ifndef ALIBABACLOUD_MODELS_LISTCUSTOMROUTINGENDPOINTTRAFFICPOLICIESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTCUSTOMROUTINGENDPOINTTRAFFICPOLICIESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListCustomRoutingEndpointTrafficPoliciesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListCustomRoutingEndpointTrafficPoliciesResponseBody& obj) { 
    ...
    ListCustomRoutingEndpointTrafficPoliciesResponseBody() = default ;
    ListCustomRoutingEndpointTrafficPoliciesResponseBody(const ListCustomRoutingEndpointTrafficPoliciesResponseBody &) = default ;
    ListCustomRoutingEndpointTrafficPoliciesResponseBody(ListCustomRoutingEndpointTrafficPoliciesResponseBody &&) = default ;
    ListCustomRoutingEndpointTrafficPoliciesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListCustomRoutingEndpointTrafficPoliciesResponseBody() = default ;
    ListCustomRoutingEndpointTrafficPoliciesResponseBody& operator=(const ListCustomRoutingEndpointTrafficPoliciesResponseBody &) = default ;
    ListCustomRoutingEndpointTrafficPoliciesResponseBody& operator=(ListCustomRoutingEndpointTrafficPoliciesResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->acceleratorId_ == nullptr
        && this->address_ == nullptr && this->endpointGroupId_ == nullptr && this->endpointId_ == nullptr && this->listenerId_ == nullptr && this->policyId_ == nullptr
        && this->portRanges_ == nullptr && this->serviceId_ == nullptr && this->serviceManaged_ == nullptr && this->serviceManagedInfos_ == nullptr; };
      // acceleratorId Field Functions 
      bool hasAcceleratorId() const { return this->acceleratorId_ != nullptr;};
      void deleteAcceleratorId() { this->acceleratorId_ = nullptr;};
      inline string getAcceleratorId() const { DARABONBA_PTR_GET_DEFAULT(acceleratorId_, "") };
      inline Policies& setAcceleratorId(string acceleratorId) { DARABONBA_PTR_SET_VALUE(acceleratorId_, acceleratorId) };
      ...
      inline Policies& setAddress(string address) { DARABONBA_PTR_SET_VALUE(address_, address) };
      ...
      inline Policies& setEndpointGroupId(string endpointGroupId) { DARABONBA_PTR_SET_VALUE(endpointGroupId_, endpointGroupId) };
      ...
      inline Policies& setEndpointId(string endpointId) { DARABONBA_PTR_SET_VALUE(endpointId_, endpointId) };
      ...
      inline Policies& setListenerId(string listenerId) { DARABONBA_PTR_SET_VALUE(listenerId_, listenerId) };
      ...
      inline const vector<Policies::PortRanges> & getPortRanges() const { DARABONBA_PTR_GET_CONST(portRanges_, vector<Policies::PortRanges>) };
      inline vector<Policies::PortRanges> getPortRanges() { DARABONBA_PTR_GET(portRanges_, vector<Policies::PortRanges>) };
      inline Policies& setPortRanges(const vector<Policies::PortRanges> & portRanges) { DARABONBA_PTR_SET_VALUE(portRanges_, portRanges) };
      inline Policies& setPortRanges(vector<Policies::PortRanges> && portRanges) { DARABONBA_PTR_SET_RVALUE(portRanges_, portRanges) };
      ...
      inline Policies& setServiceId(string serviceId) { DARABONBA_PTR_SET_VALUE(serviceId_, serviceId) };
      ...
      inline Policies& setServiceManaged(bool serviceManaged) { DARABONBA_PTR_SET_VALUE(serviceManaged_, serviceManaged) };
      ...
      inline const vector<Policies::ServiceManagedInfos> & getServiceManagedInfos() const { DARABONBA_PTR_GET_CONST(serviceManagedInfos_, vector<Policies::ServiceManagedInfos>) };
      inline vector<Policies::ServiceManagedInfos> getServiceManagedInfos() { DARABONBA_PTR_GET(serviceManagedInfos_, vector<Policies::ServiceManagedInfos>) };
      inline Policies& setServiceManagedInfos(const vector<Policies::ServiceManagedInfos> & serviceManagedInfos) { DARABONBA_PTR_SET_VALUE(serviceManagedInfos_, serviceManagedInfos) };
      inline Policies& setServiceManagedInfos(vector<Policies::ServiceManagedInfos> && serviceManagedInfos) { DARABONBA_PTR_SET_RVALUE(serviceManagedInfos_, serviceManagedInfos) };
    ...
    protected:
      ...
      shared_ptr<vector<Policies::PortRanges>> portRanges_ {};
      ...
      shared_ptr<vector<Policies::ServiceManagedInfos>> serviceManagedInfos_ {};
    };
    ...
    inline ListCustomRoutingEndpointTrafficPoliciesResponseBody& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListCustomRoutingEndpointTrafficPoliciesResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };


    // policies Field Functions 
    bool hasPolicies() const { return this->policies_ != nullptr;};
    void deletePolicies() { this->policies_ = nullptr;};
    inline const vector<ListCustomRoutingEndpointTrafficPoliciesResponseBody::Policies> & getPolicies() const { DARABONBA_PTR_GET_CONST(policies_, vector<ListCustomRoutingEndpointTrafficPoliciesResponseBody::Policies>) };
    inline vector<ListCustomRoutingEndpointTrafficPoliciesResponseBody::Policies> getPolicies() { DARABONBA_PTR_GET(policies_, vector<ListCustomRoutingEndpointTrafficPoliciesResponseBody::Policies>) };
    inline ListCustomRoutingEndpointTrafficPoliciesResponseBody& setPolicies(const vector<ListCustomRoutingEndpointTrafficPoliciesResponseBody::Policies> & policies) { DARABONBA_PTR_SET_VALUE(policies_, policies) };
    inline ListCustomRoutingEndpointTrafficPoliciesResponseBody& setPolicies(vector<ListCustomRoutingEndpointTrafficPoliciesResponseBody::Policies> && policies) { DARABONBA_PTR_SET_RVALUE(policies_, policies) };
    ...
    inline ListCustomRoutingEndpointTrafficPoliciesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListCustomRoutingEndpointTrafficPoliciesResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
  ...
  protected:
    ...
    shared_ptr<vector<ListCustomRoutingEndpointTrafficPoliciesResponseBody::Policies>> policies_ {};
    // The request ID.
