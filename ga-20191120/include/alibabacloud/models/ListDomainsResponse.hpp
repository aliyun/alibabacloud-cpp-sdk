...
namespace Models
{
  ...
  public:
    ...
    inline const ListDomainsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDomainsResponseBody) };
    inline ListDomainsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDomainsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDomainsResponseBody> body_ {};
  };
