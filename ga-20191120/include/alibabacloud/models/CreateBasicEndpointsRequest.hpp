...
#ifndef ALIBABACLOUD_MODELS_CREATEBASICENDPOINTSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEBASICENDPOINTSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateBasicEndpointsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateBasicEndpointsRequest& obj) { 
    ...
    CreateBasicEndpointsRequest() = default ;
    CreateBasicEndpointsRequest(const CreateBasicEndpointsRequest &) = default ;
    CreateBasicEndpointsRequest(CreateBasicEndpointsRequest &&) = default ;
    CreateBasicEndpointsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateBasicEndpointsRequest() = default ;
    CreateBasicEndpointsRequest& operator=(const CreateBasicEndpointsRequest &) = default ;
    CreateBasicEndpointsRequest& operator=(CreateBasicEndpointsRequest &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->endpointAddress_ == nullptr
        && this->endpointSubAddress_ == nullptr && this->endpointSubAddressType_ == nullptr && this->endpointType_ == nullptr && this->endpointZoneId_ == nullptr && this->name_ == nullptr; };
    ...
    virtual bool empty() const override { return this->acceleratorId_ == nullptr
        && this->clientToken_ == nullptr && this->endpointGroupId_ == nullptr && this->endpoints_ == nullptr && this->regionId_ == nullptr; };
    // acceleratorId Field Functions 
    bool hasAcceleratorId() const { return this->acceleratorId_ != nullptr;};
    void deleteAcceleratorId() { this->acceleratorId_ = nullptr;};
    inline string getAcceleratorId() const { DARABONBA_PTR_GET_DEFAULT(acceleratorId_, "") };
    inline CreateBasicEndpointsRequest& setAcceleratorId(string acceleratorId) { DARABONBA_PTR_SET_VALUE(acceleratorId_, acceleratorId) };
    ...
    inline CreateBasicEndpointsRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline CreateBasicEndpointsRequest& setEndpointGroupId(string endpointGroupId) { DARABONBA_PTR_SET_VALUE(endpointGroupId_, endpointGroupId) };


    // endpoints Field Functions 
    bool hasEndpoints() const { return this->endpoints_ != nullptr;};
    void deleteEndpoints() { this->endpoints_ = nullptr;};
    inline const vector<CreateBasicEndpointsRequest::Endpoints> & getEndpoints() const { DARABONBA_PTR_GET_CONST(endpoints_, vector<CreateBasicEndpointsRequest::Endpoints>) };
    inline vector<CreateBasicEndpointsRequest::Endpoints> getEndpoints() { DARABONBA_PTR_GET(endpoints_, vector<CreateBasicEndpointsRequest::Endpoints>) };
    inline CreateBasicEndpointsRequest& setEndpoints(const vector<CreateBasicEndpointsRequest::Endpoints> & endpoints) { DARABONBA_PTR_SET_VALUE(endpoints_, endpoints) };
    inline CreateBasicEndpointsRequest& setEndpoints(vector<CreateBasicEndpointsRequest::Endpoints> && endpoints) { DARABONBA_PTR_SET_RVALUE(endpoints_, endpoints) };
    ...
    inline CreateBasicEndpointsRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<CreateBasicEndpointsRequest::Endpoints>> endpoints_ {};
