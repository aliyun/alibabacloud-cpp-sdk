...
#ifndef ALIBABACLOUD_MODELS_LISTCOMMONAREASRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTCOMMONAREASRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListCommonAreasResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Areas, areas_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListCommonAreasResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Areas, areas_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListCommonAreasResponseBody() = default ;
    ListCommonAreasResponseBody(const ListCommonAreasResponseBody &) = default ;
    ListCommonAreasResponseBody(ListCommonAreasResponseBody &&) = default ;
    ListCommonAreasResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListCommonAreasResponseBody() = default ;
    ListCommonAreasResponseBody& operator=(const ListCommonAreasResponseBody &) = default ;
    ListCommonAreasResponseBody& operator=(ListCommonAreasResponseBody &&) = default ;
    ...
    inline const vector<ListCommonAreasResponseBody::Areas> & getAreas() const { DARABONBA_PTR_GET_CONST(areas_, vector<ListCommonAreasResponseBody::Areas>) };
    inline vector<ListCommonAreasResponseBody::Areas> getAreas() { DARABONBA_PTR_GET(areas_, vector<ListCommonAreasResponseBody::Areas>) };
    inline ListCommonAreasResponseBody& setAreas(const vector<ListCommonAreasResponseBody::Areas> & areas) { DARABONBA_PTR_SET_VALUE(areas_, areas) };
    inline ListCommonAreasResponseBody& setAreas(vector<ListCommonAreasResponseBody::Areas> && areas) { DARABONBA_PTR_SET_RVALUE(areas_, areas) };
    ...
    inline ListCommonAreasResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
