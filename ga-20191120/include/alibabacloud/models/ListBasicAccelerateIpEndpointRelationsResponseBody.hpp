...
#ifndef ALIBABACLOUD_MODELS_LISTBASICACCELERATEIPENDPOINTRELATIONSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTBASICACCELERATEIPENDPOINTRELATIONSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListBasicAccelerateIpEndpointRelationsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListBasicAccelerateIpEndpointRelationsResponseBody& obj) { 
    ...
    ListBasicAccelerateIpEndpointRelationsResponseBody() = default ;
    ListBasicAccelerateIpEndpointRelationsResponseBody(const ListBasicAccelerateIpEndpointRelationsResponseBody &) = default ;
    ListBasicAccelerateIpEndpointRelationsResponseBody(ListBasicAccelerateIpEndpointRelationsResponseBody &&) = default ;
    ListBasicAccelerateIpEndpointRelationsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListBasicAccelerateIpEndpointRelationsResponseBody() = default ;
    ListBasicAccelerateIpEndpointRelationsResponseBody& operator=(const ListBasicAccelerateIpEndpointRelationsResponseBody &) = default ;
    ListBasicAccelerateIpEndpointRelationsResponseBody& operator=(ListBasicAccelerateIpEndpointRelationsResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->accelerateIpId_ == nullptr
        ...
        && this->endpointSubAddressType_ == nullptr && this->endpointType_ == nullptr && this->endpointZoneId_ == nullptr && this->ipAddress_ == nullptr && this->state_ == nullptr; };
      ...
      inline AccelerateIpEndpointRelations& setAcceleratorId(string acceleratorId) { DARABONBA_PTR_SET_VALUE(acceleratorId_, acceleratorId) };
      ...
      inline AccelerateIpEndpointRelations& setEndpointAddress(string endpointAddress) { DARABONBA_PTR_SET_VALUE(endpointAddress_, endpointAddress) };
      ...
      inline AccelerateIpEndpointRelations& setEndpointName(string endpointName) { DARABONBA_PTR_SET_VALUE(endpointName_, endpointName) };
      ...
      inline AccelerateIpEndpointRelations& setEndpointSubAddress(string endpointSubAddress) { DARABONBA_PTR_SET_VALUE(endpointSubAddress_, endpointSubAddress) };
      ...
      inline AccelerateIpEndpointRelations& setEndpointSubAddressType(string endpointSubAddressType) { DARABONBA_PTR_SET_VALUE(endpointSubAddressType_, endpointSubAddressType) };
      ...
      inline AccelerateIpEndpointRelations& setEndpointType(string endpointType) { DARABONBA_PTR_SET_VALUE(endpointType_, endpointType) };
      ...
      inline AccelerateIpEndpointRelations& setEndpointZoneId(string endpointZoneId) { DARABONBA_PTR_SET_VALUE(endpointZoneId_, endpointZoneId) };
      ...
      inline AccelerateIpEndpointRelations& setIpAddress(string ipAddress) { DARABONBA_PTR_SET_VALUE(ipAddress_, ipAddress) };
      ...
      inline AccelerateIpEndpointRelations& setState(string state) { DARABONBA_PTR_SET_VALUE(state_, state) };
    ...
    inline const vector<ListBasicAccelerateIpEndpointRelationsResponseBody::AccelerateIpEndpointRelations> & getAccelerateIpEndpointRelations() const { DARABONBA_PTR_GET_CONST(accelerateIpEndpointRelations_, vector<ListBasicAccelerateIpEndpointRelationsResponseBody::AccelerateIpEndpointRelations>) };
    inline vector<ListBasicAccelerateIpEndpointRelationsResponseBody::AccelerateIpEndpointRelations> getAccelerateIpEndpointRelations() { DARABONBA_PTR_GET(accelerateIpEndpointRelations_, vector<ListBasicAccelerateIpEndpointRelationsResponseBody::AccelerateIpEndpointRelations>) };
    inline ListBasicAccelerateIpEndpointRelationsResponseBody& setAccelerateIpEndpointRelations(const vector<ListBasicAccelerateIpEndpointRelationsResponseBody::AccelerateIpEndpointRelations> & accelerateIpEndpointRelations) { DARABONBA_PTR_SET_VALUE(accelerateIpEndpointRelations_, accelerateIpEndpointRelations) };
    inline ListBasicAccelerateIpEndpointRelationsResponseBody& setAccelerateIpEndpointRelations(vector<ListBasicAccelerateIpEndpointRelationsResponseBody::AccelerateIpEndpointRelations> && accelerateIpEndpointRelations) { DARABONBA_PTR_SET_RVALUE(accelerateIpEndpointRelations_, accelerateIpEndpointRelations) };
    ...
    inline ListBasicAccelerateIpEndpointRelationsResponseBody& setMaxResults(string maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListBasicAccelerateIpEndpointRelationsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListBasicAccelerateIpEndpointRelationsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListBasicAccelerateIpEndpointRelationsResponseBody& setTotalCount(string totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };


  protected:
    // A list of accelerated IP addresses and the endpoints with which the accelerated IP addresses are associated.
    shared_ptr<vector<ListBasicAccelerateIpEndpointRelationsResponseBody::AccelerateIpEndpointRelations>> accelerateIpEndpointRelations_ {};
