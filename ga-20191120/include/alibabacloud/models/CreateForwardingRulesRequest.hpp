...
#ifndef ALIBABACLOUD_MODELS_CREATEFORWARDINGRULESREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEFORWARDINGRULESREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateForwardingRulesRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateForwardingRulesRequest& obj) { 
    ...
    CreateForwardingRulesRequest() = default ;
    CreateForwardingRulesRequest(const CreateForwardingRulesRequest &) = default ;
    CreateForwardingRulesRequest(CreateForwardingRulesRequest &&) = default ;
    CreateForwardingRulesRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateForwardingRulesRequest() = default ;
    CreateForwardingRulesRequest& operator=(const CreateForwardingRulesRequest &) = default ;
    CreateForwardingRulesRequest& operator=(CreateForwardingRulesRequest &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->forwardingRuleName_ == nullptr
        && this->priority_ == nullptr && this->ruleActions_ == nullptr && this->ruleConditions_ == nullptr && this->ruleDirection_ == nullptr; };
    ...
    inline CreateForwardingRulesRequest& setAcceleratorId(string acceleratorId) { DARABONBA_PTR_SET_VALUE(acceleratorId_, acceleratorId) };
    ...
    inline CreateForwardingRulesRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline const vector<CreateForwardingRulesRequest::ForwardingRules> & getForwardingRules() const { DARABONBA_PTR_GET_CONST(forwardingRules_, vector<CreateForwardingRulesRequest::ForwardingRules>) };
    inline vector<CreateForwardingRulesRequest::ForwardingRules> getForwardingRules() { DARABONBA_PTR_GET(forwardingRules_, vector<CreateForwardingRulesRequest::ForwardingRules>) };
    inline CreateForwardingRulesRequest& setForwardingRules(const vector<CreateForwardingRulesRequest::ForwardingRules> & forwardingRules) { DARABONBA_PTR_SET_VALUE(forwardingRules_, forwardingRules) };
    inline CreateForwardingRulesRequest& setForwardingRules(vector<CreateForwardingRulesRequest::ForwardingRules> && forwardingRules) { DARABONBA_PTR_SET_RVALUE(forwardingRules_, forwardingRules) };
    ...
    inline CreateForwardingRulesRequest& setListenerId(string listenerId) { DARABONBA_PTR_SET_VALUE(listenerId_, listenerId) };
    ...
    inline CreateForwardingRulesRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<CreateForwardingRulesRequest::ForwardingRules>> forwardingRules_ {};
