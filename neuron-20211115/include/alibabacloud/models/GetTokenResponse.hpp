...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTokenResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTokenResult) };
    inline CreateTokenResult getBody() { DARABONBA_PTR_GET(body_, CreateTokenResult) };
    inline GetTokenResponse& setBody(const CreateTokenResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline GetTokenResponse& setBody(CreateTokenResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<CreateTokenResult> body_ {};
  };
