...
namespace Models
{
  ...
  public:
    ...
    inline GetResourceResponse& setBody(const PdpResource & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline GetResourceResponse& setBody(PdpResource && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
