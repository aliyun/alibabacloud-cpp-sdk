...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListRolesShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(roleIds, roleIdsShrink_);
    ...
    friend void from_json(const Darabonba::Json& j, ListRolesShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(roleIds, roleIdsShrink_);
    ...
    virtual bool empty() const override { return this->authorizerId_ == nullptr
        ...
        && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->platform_ == nullptr && this->roleIdsShrink_ == nullptr && this->roleType_ == nullptr; };
    ...
    inline ListRolesShrinkRequest& setAuthorizerId(string authorizerId) { DARABONBA_PTR_SET_VALUE(authorizerId_, authorizerId) };
    ...
    inline ListRolesShrinkRequest& setAuthorizerType(string authorizerType) { DARABONBA_PTR_SET_VALUE(authorizerType_, authorizerType) };
    ...
    inline ListRolesShrinkRequest& setEnterpriseId(int64_t enterpriseId) { DARABONBA_PTR_SET_VALUE(enterpriseId_, enterpriseId) };
    ...
    inline ListRolesShrinkRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListRolesShrinkRequest& setOrderBy(string orderBy) { DARABONBA_PTR_SET_VALUE(orderBy_, orderBy) };
    ...
    inline ListRolesShrinkRequest& setOrderDirection(string orderDirection) { DARABONBA_PTR_SET_VALUE(orderDirection_, orderDirection) };
    ...
    inline ListRolesShrinkRequest& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListRolesShrinkRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListRolesShrinkRequest& setPlatform(string platform) { DARABONBA_PTR_SET_VALUE(platform_, platform) };


    // roleIdsShrink Field Functions 
    bool hasRoleIdsShrink() const { return this->roleIdsShrink_ != nullptr;};
    void deleteRoleIdsShrink() { this->roleIdsShrink_ = nullptr;};
    inline string getRoleIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(roleIdsShrink_, "") };
    inline ListRolesShrinkRequest& setRoleIdsShrink(string roleIdsShrink) { DARABONBA_PTR_SET_VALUE(roleIdsShrink_, roleIdsShrink) };
    ...
    inline ListRolesShrinkRequest& setRoleType(string roleType) { DARABONBA_PTR_SET_VALUE(roleType_, roleType) };
  ...
  protected:
    ...
    shared_ptr<string> roleIdsShrink_ {};
