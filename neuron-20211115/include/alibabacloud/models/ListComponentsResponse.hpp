...
namespace Models
{
  ...
  public:
    ...
    inline const ComponentPageResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, ComponentPageResult) };
    inline ComponentPageResult getBody() { DARABONBA_PTR_GET(body_, ComponentPageResult) };
    inline ListComponentsResponse& setBody(const ComponentPageResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListComponentsResponse& setBody(ComponentPageResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<ComponentPageResult> body_ {};
  };
