...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->companyId_ == nullptr
        && this->env_ == nullptr && this->name_ == nullptr && this->orderBy_ == nullptr && this->orderDirection_ == nullptr && this->pageNumber_ == nullptr
        && this->pageSize_ == nullptr && this->productId_ == nullptr && this->templateId_ == nullptr && this->type_ == nullptr; };
    // companyId Field Functions 
    bool hasCompanyId() const { return this->companyId_ != nullptr;};
    void deleteCompanyId() { this->companyId_ = nullptr;};
    inline int64_t getCompanyId() const { DARABONBA_PTR_GET_DEFAULT(companyId_, 0L) };
    inline ListComponentsRequest& setCompanyId(int64_t companyId) { DARABONBA_PTR_SET_VALUE(companyId_, companyId) };
    ...
    inline ListComponentsRequest& setEnv(string env) { DARABONBA_PTR_SET_VALUE(env_, env) };
    ...
    inline ListComponentsRequest& setOrderBy(string orderBy) { DARABONBA_PTR_SET_VALUE(orderBy_, orderBy) };
    ...
    inline ListComponentsRequest& setOrderDirection(string orderDirection) { DARABONBA_PTR_SET_VALUE(orderDirection_, orderDirection) };
    ...
    inline ListComponentsRequest& setProductId(int64_t productId) { DARABONBA_PTR_SET_VALUE(productId_, productId) };
    ...
    inline ListComponentsRequest& setTemplateId(int64_t templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
    ...
    inline ListComponentsRequest& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
