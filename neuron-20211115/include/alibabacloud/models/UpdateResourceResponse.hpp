...
namespace Models
{
  ...
  public:
    ...
    inline const PdpResource & getBody() const { DARABONBA_PTR_GET_CONST(body_, PdpResource) };
    inline PdpResource getBody() { DARABONBA_PTR_GET(body_, PdpResource) };
    inline UpdateResourceResponse& setBody(const PdpResource & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateResourceResponse& setBody(PdpResource && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<PdpResource> body_ {};
  };
