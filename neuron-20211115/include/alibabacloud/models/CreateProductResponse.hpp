...
namespace Models
{
  ...
  public:
    ...
    inline CreateProductResponse& setBody(const Product & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CreateProductResponse& setBody(Product && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
