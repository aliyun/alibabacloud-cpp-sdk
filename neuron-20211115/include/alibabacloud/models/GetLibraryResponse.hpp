...
namespace Models
{
  ...
  public:
    ...
    inline GetLibraryResponse& setBody(const Library & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline GetLibraryResponse& setBody(Library && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
