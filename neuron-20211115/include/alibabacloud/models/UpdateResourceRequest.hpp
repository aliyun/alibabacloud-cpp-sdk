...
namespace Models
{
  ...
  public:
    ...
    inline const ResourceUpdateCmd & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResourceUpdateCmd) };
    inline ResourceUpdateCmd getBody() { DARABONBA_PTR_GET(body_, ResourceUpdateCmd) };
    inline UpdateResourceRequest& setBody(const ResourceUpdateCmd & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateResourceRequest& setBody(ResourceUpdateCmd && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<ResourceUpdateCmd> body_ {};
  };
