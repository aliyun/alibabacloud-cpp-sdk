...
namespace Models
{
  ...
  public:
    ...
    inline const LibraryUpdateCmd & getBody() const { DARABONBA_PTR_GET_CONST(body_, LibraryUpdateCmd) };
    inline LibraryUpdateCmd getBody() { DARABONBA_PTR_GET(body_, LibraryUpdateCmd) };
    inline UpdateLibraryRequest& setBody(const LibraryUpdateCmd & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateLibraryRequest& setBody(LibraryUpdateCmd && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<LibraryUpdateCmd> body_ {};
  };
