...
namespace Models
{
  ...
  public:
    ...
    inline const PdpDeploymentPageResult & getBody() const { DARABONBA_PTR_GET_CONST(body_, PdpDeploymentPageResult) };
    inline PdpDeploymentPageResult getBody() { DARABONBA_PTR_GET(body_, PdpDeploymentPageResult) };
    inline ListDeploymentsResponse& setBody(const PdpDeploymentPageResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListDeploymentsResponse& setBody(PdpDeploymentPageResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<PdpDeploymentPageResult> body_ {};
  };
