...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->companyId_ == nullptr
        ...
        && this->pageSize_ == nullptr && this->productId_ == nullptr && this->type_ == nullptr; };
    // companyId Field Functions 
    bool hasCompanyId() const { return this->companyId_ != nullptr;};
    void deleteCompanyId() { this->companyId_ = nullptr;};
    inline int64_t getCompanyId() const { DARABONBA_PTR_GET_DEFAULT(companyId_, 0L) };
    inline ListResourcesRequest& setCompanyId(int64_t companyId) { DARABONBA_PTR_SET_VALUE(companyId_, companyId) };
    ...
    inline ListResourcesRequest& setEnv(string env) { DARABONBA_PTR_SET_VALUE(env_, env) };
    ...
    inline ListResourcesRequest& setOrderBy(string orderBy) { DARABONBA_PTR_SET_VALUE(orderBy_, orderBy) };
    ...
    inline ListResourcesRequest& setOrderDirection(string orderDirection) { DARABONBA_PTR_SET_VALUE(orderDirection_, orderDirection) };
    ...
    inline ListResourcesRequest& setProductId(int64_t productId) { DARABONBA_PTR_SET_VALUE(productId_, productId) };
