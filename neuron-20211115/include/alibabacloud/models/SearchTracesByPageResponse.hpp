...
namespace Models
{
  ...
  public:
    ...
    inline const SearchTracesByPageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchTracesByPageResponseBody) };
    inline SearchTracesByPageResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchTracesByPageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchTracesByPageResponseBody> body_ {};
  };
