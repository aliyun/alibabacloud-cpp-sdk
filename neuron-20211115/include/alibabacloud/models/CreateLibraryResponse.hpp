...
namespace Models
{
  ...
  public:
    ...
    inline const Library & getBody() const { DARABONBA_PTR_GET_CONST(body_, Library) };
    inline Library getBody() { DARABONBA_PTR_GET(body_, Library) };
    inline CreateLibraryResponse& setBody(const Library & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CreateLibraryResponse& setBody(Library && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<Library> body_ {};
  };
