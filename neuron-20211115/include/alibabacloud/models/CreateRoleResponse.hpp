...
namespace Models
{
  ...
  public:
    ...
    inline CreateRoleResponse& setBody(const Role & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CreateRoleResponse& setBody(Role && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
