...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->customParametersShrink_ == nullptr
        && this->customState_ == nullptr && this->forceAuthentication_ == nullptr && this->OAuth2Flow_ == nullptr && this->resourceCredentialProviderName_ == nullptr && this->resourceOAuth2ReturnURL_ == nullptr
        && this->scopesShrink_ == nullptr && this->sessionURI_ == nullptr && this->workloadAccessToken_ == nullptr; };
    ...
    inline string getCustomParametersShrink() const { DARABONBA_PTR_GET_DEFAULT(customParametersShrink_, "") };
    ...
    inline string getCustomState() const { DARABONBA_PTR_GET_DEFAULT(customState_, "") };
    ...
    inline string getOAuth2Flow() const { DARABONBA_PTR_GET_DEFAULT(OAuth2Flow_, "") };
    ...
    inline string getResourceOAuth2ReturnURL() const { DARABONBA_PTR_GET_DEFAULT(resourceOAuth2ReturnURL_, "") };
    ...
    inline string getScopesShrink() const { DARABONBA_PTR_GET_DEFAULT(scopesShrink_, "") };
  ...
  protected:
    shared_ptr<string> customParametersShrink_ {};
    shared_ptr<string> customState_ {};
    shared_ptr<bool> forceAuthentication_ {};
    shared_ptr<string> OAuth2Flow_ {};
    shared_ptr<string> resourceCredentialProviderName_ {};
    shared_ptr<string> resourceOAuth2ReturnURL_ {};
    shared_ptr<string> scopesShrink_ {};
