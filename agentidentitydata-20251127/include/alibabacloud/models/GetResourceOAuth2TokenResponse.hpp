...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceOAuth2TokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResourceOAuth2TokenResponseBody) };
    inline GetResourceOAuth2TokenResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResourceOAuth2TokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResourceOAuth2TokenResponseBody> body_ {};
  };
