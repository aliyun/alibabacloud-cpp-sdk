...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorkloadAccessTokenForUserIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetWorkloadAccessTokenForUserIdResponseBody) };
    inline GetWorkloadAccessTokenForUserIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetWorkloadAccessTokenForUserIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetWorkloadAccessTokenForUserIdResponseBody> body_ {};
  };
