...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteUpgradeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ExecuteUpgradeResponseBody) };
    inline ExecuteUpgradeResponseBody body() { DARABONBA_PTR_GET(body_, ExecuteUpgradeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ExecuteUpgradeResponseBody> body_ = nullptr;
  };
