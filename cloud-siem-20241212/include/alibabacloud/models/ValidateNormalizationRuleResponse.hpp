...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateNormalizationRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ValidateNormalizationRuleResponseBody) };
    inline ValidateNormalizationRuleResponseBody body() { DARABONBA_PTR_GET(body_, ValidateNormalizationRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ValidateNormalizationRuleResponseBody> body_ = nullptr;
  };
