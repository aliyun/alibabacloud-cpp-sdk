...
namespace Models
{
  ...
  public:
    ...
    inline const ListLogRegionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLogRegionsResponseBody) };
    inline ListLogRegionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLogRegionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLogRegionsResponseBody> body_ {};
  };
