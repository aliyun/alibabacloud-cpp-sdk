...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDataBatchIngestionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDataBatchIngestionResponseBody) };
    inline UpdateDataBatchIngestionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDataBatchIngestionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDataBatchIngestionResponseBody> body_ {};
  };
