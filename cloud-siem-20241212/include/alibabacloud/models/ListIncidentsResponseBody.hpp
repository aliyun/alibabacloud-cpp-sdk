...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListIncidentsResponseBodyIncidents> & incidents() const { DARABONBA_PTR_GET_CONST(incidents_, vector<ListIncidentsResponseBodyIncidents>) };
    inline vector<ListIncidentsResponseBodyIncidents> incidents() { DARABONBA_PTR_GET(incidents_, vector<ListIncidentsResponseBodyIncidents>) };
    inline ListIncidentsResponseBody& setIncidents(const vector<ListIncidentsResponseBodyIncidents> & incidents) { DARABONBA_PTR_SET_VALUE(incidents_, incidents) };
    inline ListIncidentsResponseBody& setIncidents(vector<ListIncidentsResponseBodyIncidents> && incidents) { DARABONBA_PTR_SET_RVALUE(incidents_, incidents) };
  ...
  protected:
    std::shared_ptr<vector<ListIncidentsResponseBodyIncidents>> incidents_ = nullptr;
