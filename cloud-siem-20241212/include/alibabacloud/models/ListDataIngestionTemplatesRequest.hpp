...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataIngestionTemplateStatus_ == nullptr
        && this->dataSourceTemplateIds_ == nullptr && this->lang_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->productId_ == nullptr
    ...
    inline string getDataSourceTemplateIds() const { DARABONBA_PTR_GET_DEFAULT(dataSourceTemplateIds_, "") };
