...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateVendorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateVendorResponseBody) };
    inline UpdateVendorResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateVendorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateVendorResponseBody> body_ {};
  };
