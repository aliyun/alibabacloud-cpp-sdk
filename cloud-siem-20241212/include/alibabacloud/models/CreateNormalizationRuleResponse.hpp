...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNormalizationRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateNormalizationRuleResponseBody) };
    inline CreateNormalizationRuleResponseBody body() { DARABONBA_PTR_GET(body_, CreateNormalizationRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateNormalizationRuleResponseBody> body_ = nullptr;
  };
