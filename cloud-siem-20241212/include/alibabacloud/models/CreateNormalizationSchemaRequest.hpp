...
#ifndef ALIBABACLOUD_MODELS_CREATENORMALIZATIONSCHEMAREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATENORMALIZATIONSCHEMAREQUEST_HPP_
...
namespace Models
{
  class CreateNormalizationSchemaRequest : public Darabonba::Model {
  public:
    ...
    CreateNormalizationSchemaRequest(CreateNormalizationSchemaRequest &&) = default ;
    CreateNormalizationSchemaRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateNormalizationSchemaRequest() = default ;
    CreateNormalizationSchemaRequest& operator=(const CreateNormalizationSchemaRequest &) = default ;
    CreateNormalizationSchemaRequest& operator=(CreateNormalizationSchemaRequest &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->normalizationFieldDescription_ == nullptr
        ...
        && this->normalizationFieldRequired_ == nullptr && this->normalizationFieldRequirement_ == nullptr && this->normalizationFieldReserved_ == nullptr && this->normalizationFieldTokenize_ == nullptr && this->normalizationFieldType_ == nullptr; };
      // normalizationFieldDescription Field Functions 
      bool hasNormalizationFieldDescription() const { return this->normalizationFieldDescription_ != nullptr;};
      void deleteNormalizationFieldDescription() { this->normalizationFieldDescription_ = nullptr;};
      inline string getNormalizationFieldDescription() const { DARABONBA_PTR_GET_DEFAULT(normalizationFieldDescription_, "") };
    ...
    inline CreateNormalizationSchemaRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline const vector<CreateNormalizationSchemaRequest::NormalizationFields> & getNormalizationFields() const { DARABONBA_PTR_GET_CONST(normalizationFields_, vector<CreateNormalizationSchemaRequest::NormalizationFields>) };
    inline vector<CreateNormalizationSchemaRequest::NormalizationFields> getNormalizationFields() { DARABONBA_PTR_GET(normalizationFields_, vector<CreateNormalizationSchemaRequest::NormalizationFields>) };
    inline CreateNormalizationSchemaRequest& setNormalizationFields(const vector<CreateNormalizationSchemaRequest::NormalizationFields> & normalizationFields) { DARABONBA_PTR_SET_VALUE(normalizationFields_, normalizationFields) };
    inline CreateNormalizationSchemaRequest& setNormalizationFields(vector<CreateNormalizationSchemaRequest::NormalizationFields> && normalizationFields) { DARABONBA_PTR_SET_RVALUE(normalizationFields_, normalizationFields) };
    ...
    inline CreateNormalizationSchemaRequest& setNormalizationSchemaDescription(string normalizationSchemaDescription) { DARABONBA_PTR_SET_VALUE(normalizationSchemaDescription_, normalizationSchemaDescription) };
    ...
    inline CreateNormalizationSchemaRequest& setNormalizationSchemaId(string normalizationSchemaId) { DARABONBA_PTR_SET_VALUE(normalizationSchemaId_, normalizationSchemaId) };
    ...
    inline CreateNormalizationSchemaRequest& setNormalizationSchemaName(string normalizationSchemaName) { DARABONBA_PTR_SET_VALUE(normalizationSchemaName_, normalizationSchemaName) };
    ...
    inline CreateNormalizationSchemaRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline CreateNormalizationSchemaRequest& setRoleFor(int64_t roleFor) { DARABONBA_PTR_SET_VALUE(roleFor_, roleFor) };
