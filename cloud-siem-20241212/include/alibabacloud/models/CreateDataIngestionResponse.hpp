...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataIngestionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateDataIngestionResponseBody) };
    inline CreateDataIngestionResponseBody body() { DARABONBA_PTR_GET(body_, CreateDataIngestionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDataIngestionResponseBody> body_ = nullptr;
  };
