...
namespace Models
{
  ...
  public:
    ...
    inline const GetNormalizationRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetNormalizationRuleResponseBody) };
    inline GetNormalizationRuleResponseBody body() { DARABONBA_PTR_GET(body_, GetNormalizationRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetNormalizationRuleResponseBody> body_ = nullptr;
  };
