...
#ifndef ALIBABACLOUD_MODELS_LISTNORMALIZATIONRULESRESPONSEBODYNORMALIZATIONRULES_HPP_
#define ALIBABACLOUD_MODELS_LISTNORMALIZATIONRULESRESPONSEBODYNORMALIZATIONRULES_HPP_
...
namespace Models
{
  class ListNormalizationRulesResponseBodyNormalizationRules : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListNormalizationRulesResponseBodyNormalizationRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListNormalizationRulesResponseBodyNormalizationRules& obj) { 
    ...
    ListNormalizationRulesResponseBodyNormalizationRules() = default ;
    ListNormalizationRulesResponseBodyNormalizationRules(const ListNormalizationRulesResponseBodyNormalizationRules &) = default ;
    ListNormalizationRulesResponseBodyNormalizationRules(ListNormalizationRulesResponseBodyNormalizationRules &&) = default ;
    ListNormalizationRulesResponseBodyNormalizationRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListNormalizationRulesResponseBodyNormalizationRules() = default ;
    ListNormalizationRulesResponseBodyNormalizationRules& operator=(const ListNormalizationRulesResponseBodyNormalizationRules &) = default ;
    ListNormalizationRulesResponseBodyNormalizationRules& operator=(ListNormalizationRulesResponseBodyNormalizationRules &&) = default ;
    ...
    virtual bool empty() const override { return this->createTime_ == nullptr
        ...
        && return this->normalizationRuleId_ == nullptr && return this->normalizationRuleMode_ == nullptr && return this->normalizationRuleName_ == nullptr && return this->normalizationRuleReferences_ == nullptr && return this->normalizationRuleStatus_ == nullptr
        && return this->normalizationRuleType_ == nullptr && return this->normalizationRuleVersion_ == nullptr && return this->normalizationSchemaId_ == nullptr && return this->productId_ == nullptr && return this->updateTime_ == nullptr
        && return this->vendorId_ == nullptr; };
    // createTime Field Functions 
    bool hasCreateTime() const { return this->createTime_ != nullptr;};
    void deleteCreateTime() { this->createTime_ = nullptr;};
    inline int64_t createTime() const { DARABONBA_PTR_GET_DEFAULT(createTime_, 0L) };
    inline ListNormalizationRulesResponseBodyNormalizationRules& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setExtendContentPacked(string extendContentPacked) { DARABONBA_PTR_SET_VALUE(extendContentPacked_, extendContentPacked) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationCategoryId(string normalizationCategoryId) { DARABONBA_PTR_SET_VALUE(normalizationCategoryId_, normalizationCategoryId) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationRuleDescription(string normalizationRuleDescription) { DARABONBA_PTR_SET_VALUE(normalizationRuleDescription_, normalizationRuleDescription) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationRuleExpression(string normalizationRuleExpression) { DARABONBA_PTR_SET_VALUE(normalizationRuleExpression_, normalizationRuleExpression) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationRuleFormat(string normalizationRuleFormat) { DARABONBA_PTR_SET_VALUE(normalizationRuleFormat_, normalizationRuleFormat) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationRuleId(string normalizationRuleId) { DARABONBA_PTR_SET_VALUE(normalizationRuleId_, normalizationRuleId) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationRuleMode(string normalizationRuleMode) { DARABONBA_PTR_SET_VALUE(normalizationRuleMode_, normalizationRuleMode) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationRuleName(string normalizationRuleName) { DARABONBA_PTR_SET_VALUE(normalizationRuleName_, normalizationRuleName) };
    ...
    inline const vector<Models::ListNormalizationRulesResponseBodyNormalizationRulesNormalizationRuleReferences> & normalizationRuleReferences() const { DARABONBA_PTR_GET_CONST(normalizationRuleReferences_, vector<Models::ListNormalizationRulesResponseBodyNormalizationRulesNormalizationRuleReferences>) };
    inline vector<Models::ListNormalizationRulesResponseBodyNormalizationRulesNormalizationRuleReferences> normalizationRuleReferences() { DARABONBA_PTR_GET(normalizationRuleReferences_, vector<Models::ListNormalizationRulesResponseBodyNormalizationRulesNormalizationRuleReferences>) };
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationRuleReferences(const vector<Models::ListNormalizationRulesResponseBodyNormalizationRulesNormalizationRuleReferences> & normalizationRuleReferences) { DARABONBA_PTR_SET_VALUE(normalizationRuleReferences_, normalizationRuleReferences) };
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationRuleReferences(vector<Models::ListNormalizationRulesResponseBodyNormalizationRulesNormalizationRuleReferences> && normalizationRuleReferences) { DARABONBA_PTR_SET_RVALUE(normalizationRuleReferences_, normalizationRuleReferences) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationRuleStatus(string normalizationRuleStatus) { DARABONBA_PTR_SET_VALUE(normalizationRuleStatus_, normalizationRuleStatus) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationRuleType(string normalizationRuleType) { DARABONBA_PTR_SET_VALUE(normalizationRuleType_, normalizationRuleType) };
    ...
    inline string normalizationRuleVersion() const { DARABONBA_PTR_GET_DEFAULT(normalizationRuleVersion_, "") };
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationRuleVersion(string normalizationRuleVersion) { DARABONBA_PTR_SET_VALUE(normalizationRuleVersion_, normalizationRuleVersion) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setNormalizationSchemaId(string normalizationSchemaId) { DARABONBA_PTR_SET_VALUE(normalizationSchemaId_, normalizationSchemaId) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setProductId(string productId) { DARABONBA_PTR_SET_VALUE(productId_, productId) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setUpdateTime(int64_t updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline ListNormalizationRulesResponseBodyNormalizationRules& setVendorId(string vendorId) { DARABONBA_PTR_SET_VALUE(vendorId_, vendorId) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::ListNormalizationRulesResponseBodyNormalizationRulesNormalizationRuleReferences>> normalizationRuleReferences_ = nullptr;
    std::shared_ptr<string> normalizationRuleStatus_ = nullptr;
    std::shared_ptr<string> normalizationRuleType_ = nullptr;
    std::shared_ptr<string> normalizationRuleVersion_ = nullptr;
