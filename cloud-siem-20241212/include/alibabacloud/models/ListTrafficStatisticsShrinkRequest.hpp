...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        && this->logUserIdsShrink_ == nullptr && this->productId_ == nullptr && this->regionId_ == nullptr && this->regionTag_ == nullptr && this->roleFor_ == nullptr
    ...
    inline int32_t getRegionTag() const { DARABONBA_PTR_GET_DEFAULT(regionTag_, 0) };
    ...
    inline string getTrafficStatisticPeriod() const { DARABONBA_PTR_GET_DEFAULT(trafficStatisticPeriod_, "") };
    ...
    inline string getTrafficStatisticPeriodType() const { DARABONBA_PTR_GET_DEFAULT(trafficStatisticPeriodType_, "") };
    ...
    inline string getTrafficStatisticType() const { DARABONBA_PTR_GET_DEFAULT(trafficStatisticType_, "") };
    ...
    inline ListTrafficStatisticsShrinkRequest& setTrafficType(string trafficType) { DARABONBA_PTR_SET_VALUE(trafficType_, trafficType) };
