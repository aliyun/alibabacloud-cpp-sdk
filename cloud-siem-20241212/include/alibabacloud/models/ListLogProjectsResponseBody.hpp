...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getLogProjects() const { DARABONBA_PTR_GET_CONST(logProjects_, vector<string>) };
    inline vector<string> getLogProjects() { DARABONBA_PTR_GET(logProjects_, vector<string>) };
