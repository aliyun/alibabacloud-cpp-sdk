...
namespace Models
{
  ...
  public:
    ...
    inline ListNormalizationRulesShrinkRequest& setNormalizationSecurityDomainId(string normalizationSecurityDomainId) { DARABONBA_PTR_SET_VALUE(normalizationSecurityDomainId_, normalizationSecurityDomainId) };
