...
namespace Models
{
  ...
  public:
    ...
    inline const GetNormalizationRuleVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetNormalizationRuleVersionResponseBody) };
    inline GetNormalizationRuleVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetNormalizationRuleVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetNormalizationRuleVersionResponseBody> body_ {};
  };
