...
#ifndef ALIBABACLOUD_MODELS_CREATEDATASOURCESHRINKREQUESTDATASOURCESTORES_HPP_
#define ALIBABACLOUD_MODELS_CREATEDATASOURCESHRINKREQUESTDATASOURCESTORES_HPP_
...
namespace Models
{
  class CreateDataSourceShrinkRequestDataSourceStores : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateDataSourceShrinkRequestDataSourceStores& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateDataSourceShrinkRequestDataSourceStores& obj) { 
    ...
    CreateDataSourceShrinkRequestDataSourceStores() = default ;
    CreateDataSourceShrinkRequestDataSourceStores(const CreateDataSourceShrinkRequestDataSourceStores &) = default ;
    CreateDataSourceShrinkRequestDataSourceStores(CreateDataSourceShrinkRequestDataSourceStores &&) = default ;
    CreateDataSourceShrinkRequestDataSourceStores(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateDataSourceShrinkRequestDataSourceStores() = default ;
    CreateDataSourceShrinkRequestDataSourceStores& operator=(const CreateDataSourceShrinkRequestDataSourceStores &) = default ;
    CreateDataSourceShrinkRequestDataSourceStores& operator=(CreateDataSourceShrinkRequestDataSourceStores &&) = default ;
    ...
    inline CreateDataSourceShrinkRequestDataSourceStores& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline CreateDataSourceShrinkRequestDataSourceStores& setDataSourceStoreFrom(string dataSourceStoreFrom) { DARABONBA_PTR_SET_VALUE(dataSourceStoreFrom_, dataSourceStoreFrom) };
    ...
    inline CreateDataSourceShrinkRequestDataSourceStores& setDataSourceStoreId(string dataSourceStoreId) { DARABONBA_PTR_SET_VALUE(dataSourceStoreId_, dataSourceStoreId) };
    ...
    inline CreateDataSourceShrinkRequestDataSourceStores& setDataSourceStoreStatus(string dataSourceStoreStatus) { DARABONBA_PTR_SET_VALUE(dataSourceStoreStatus_, dataSourceStoreStatus) };
    ...
    inline CreateDataSourceShrinkRequestDataSourceStores& setLogProjectName(string logProjectName) { DARABONBA_PTR_SET_VALUE(logProjectName_, logProjectName) };
    ...
    inline CreateDataSourceShrinkRequestDataSourceStores& setLogRegionId(string logRegionId) { DARABONBA_PTR_SET_VALUE(logRegionId_, logRegionId) };
    ...
    inline CreateDataSourceShrinkRequestDataSourceStores& setLogStoreName(string logStoreName) { DARABONBA_PTR_SET_VALUE(logStoreName_, logStoreName) };
    ...
    inline CreateDataSourceShrinkRequestDataSourceStores& setUpdateTime(int64_t updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
