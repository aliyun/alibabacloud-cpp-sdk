...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        && return this->logStoreColdTtl_ == nullptr && return this->logStoreHotTtl_ == nullptr && return this->logStoreName_ == nullptr && return this->logStoreTtl_ == nullptr && return this->regionId_ == nullptr
    ...
    inline string logStoreColdTtl() const { DARABONBA_PTR_GET_DEFAULT(logStoreColdTtl_, "") };
    ...
    inline string logStoreHotTtl() const { DARABONBA_PTR_GET_DEFAULT(logStoreHotTtl_, "") };
    ...
    inline string logStoreTtl() const { DARABONBA_PTR_GET_DEFAULT(logStoreTtl_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> logStoreColdTtl_ = nullptr;
    std::shared_ptr<string> logStoreHotTtl_ = nullptr;
    std::shared_ptr<string> logStoreName_ = nullptr;
    std::shared_ptr<string> logStoreTtl_ = nullptr;
