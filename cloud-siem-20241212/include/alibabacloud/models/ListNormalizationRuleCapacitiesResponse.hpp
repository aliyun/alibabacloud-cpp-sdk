...
namespace Models
{
  ...
  public:
    ...
    inline const ListNormalizationRuleCapacitiesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNormalizationRuleCapacitiesResponseBody) };
    inline ListNormalizationRuleCapacitiesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNormalizationRuleCapacitiesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNormalizationRuleCapacitiesResponseBody> body_ {};
  };
