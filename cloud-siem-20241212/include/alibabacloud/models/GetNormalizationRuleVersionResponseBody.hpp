  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->createTime_ == nullptr
        ...
        && this->normalizationRuleName_ == nullptr && this->normalizationRuleStatus_ == nullptr && this->normalizationRuleType_ == nullptr && this->normalizationRuleVersion_ == nullptr && this->normalizationRuleVersionName_ == nullptr
        && this->normalizationSchemaId_ == nullptr && this->productId_ == nullptr && this->regionId_ == nullptr && this->updateTime_ == nullptr && this->vendorId_ == nullptr; };
      ...
      inline string getNormalizationRuleVersionName() const { DARABONBA_PTR_GET_DEFAULT(normalizationRuleVersionName_, "") };
      inline NormalizationRuleVersion& setNormalizationRuleVersionName(string normalizationRuleVersionName) { DARABONBA_PTR_SET_VALUE(normalizationRuleVersionName_, normalizationRuleVersionName) };
      ...
      inline NormalizationRuleVersion& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    bool hasNormalizationRuleVersion() const { return this->normalizationRuleVersion_ != nullptr;};
    void deleteNormalizationRuleVersion() { this->normalizationRuleVersion_ = nullptr;};
    inline const GetNormalizationRuleVersionResponseBody::NormalizationRuleVersion & getNormalizationRuleVersion() const { DARABONBA_PTR_GET_CONST(normalizationRuleVersion_, GetNormalizationRuleVersionResponseBody::NormalizationRuleVersion) };
    inline GetNormalizationRuleVersionResponseBody::NormalizationRuleVersion getNormalizationRuleVersion() { DARABONBA_PTR_GET(normalizationRuleVersion_, GetNormalizationRuleVersionResponseBody::NormalizationRuleVersion) };
    inline GetNormalizationRuleVersionResponseBody& setNormalizationRuleVersion(const GetNormalizationRuleVersionResponseBody::NormalizationRuleVersion & normalizationRuleVersion) { DARABONBA_PTR_SET_VALUE(normalizationRuleVersion_, normalizationRuleVersion) };
    inline GetNormalizationRuleVersionResponseBody& setNormalizationRuleVersion(GetNormalizationRuleVersionResponseBody::NormalizationRuleVersion && normalizationRuleVersion) { DARABONBA_PTR_SET_RVALUE(normalizationRuleVersion_, normalizationRuleVersion) };
