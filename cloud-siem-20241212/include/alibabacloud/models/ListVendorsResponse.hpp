...
namespace Models
{
  ...
  public:
    ...
    inline const ListVendorsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListVendorsResponseBody) };
    inline ListVendorsResponseBody body() { DARABONBA_PTR_GET(body_, ListVendorsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListVendorsResponseBody> body_ = nullptr;
  };
