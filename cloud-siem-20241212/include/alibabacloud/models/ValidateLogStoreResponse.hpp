...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateLogStoreResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ValidateLogStoreResponseBody) };
    inline ValidateLogStoreResponseBody getBody() { DARABONBA_PTR_GET(body_, ValidateLogStoreResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ValidateLogStoreResponseBody> body_ {};
  };
