...
#include <alibabacloud/models/GetDataStorageResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataStorageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDataStorageResponseBodyData) };
    inline GetDataStorageResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDataStorageResponseBodyData) };
    inline GetDataStorageResponseBody& setData(const GetDataStorageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataStorageResponseBody& setData(GetDataStorageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetDataStorageResponseBodyData> data_ = nullptr;
