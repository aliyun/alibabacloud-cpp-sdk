...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getDataSourceTemplateIds() const { DARABONBA_PTR_GET_CONST(dataSourceTemplateIds_, vector<string>) };
    inline vector<string> getDataSourceTemplateIds() { DARABONBA_PTR_GET(dataSourceTemplateIds_, vector<string>) };
  ...
  protected:
    shared_ptr<vector<string>> dataSourceTemplateIds_ {};
