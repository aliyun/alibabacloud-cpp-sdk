...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alertAttCk_ == nullptr
        ...
        && this->detectionRuleIds_ == nullptr && this->detectionRuleName_ == nullptr && this->detectionRuleStatus_ == nullptr && this->detectionRuleType_ == nullptr && this->incidentAggregationType_ == nullptr
