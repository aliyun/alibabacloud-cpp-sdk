  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->alertAttCk_ == nullptr
        ...
        && this->alertType_ == nullptr && this->alertTypeMapping_ == nullptr && this->createTime_ == nullptr && this->detectionExpressionContent_ == nullptr && this->detectionExpressionType_ == nullptr
        && this->detectionRuleDescription_ == nullptr && this->detectionRuleId_ == nullptr && this->detectionRuleName_ == nullptr && this->detectionRuleStatus_ == nullptr && this->detectionRuleType_ == nullptr
        && this->entityMappings_ == nullptr && this->incidentAggregationExpression_ == nullptr && this->incidentAggregationType_ == nullptr && this->logCategoryId_ == nullptr && this->logSchemaId_ == nullptr
        && this->playbook_ == nullptr && this->playbookParameters_ == nullptr && this->playbookUuid_ == nullptr && this->scheduleBeginTime_ == nullptr && this->scheduleExpression_ == nullptr
        && this->scheduleMaxRetries_ == nullptr && this->scheduleMaxTimeout_ == nullptr && this->scheduleType_ == nullptr && this->scheduleWindow_ == nullptr && this->updateTime_ == nullptr; };
      ...
      inline DetectionRules& setAlertAttCkMapping(string alertAttCkMapping) { DARABONBA_PTR_SET_VALUE(alertAttCkMapping_, alertAttCkMapping) };
      ...
      inline DetectionRules& setAlertLevelMapping(string alertLevelMapping) { DARABONBA_PTR_SET_VALUE(alertLevelMapping_, alertLevelMapping) };
      ...
      inline DetectionRules& setAlertTypeMapping(string alertTypeMapping) { DARABONBA_PTR_SET_VALUE(alertTypeMapping_, alertTypeMapping) };
