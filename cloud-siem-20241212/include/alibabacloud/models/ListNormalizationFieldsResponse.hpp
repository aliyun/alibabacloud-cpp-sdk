...
namespace Models
{
  ...
  public:
    ...
    inline const ListNormalizationFieldsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNormalizationFieldsResponseBody) };
    inline ListNormalizationFieldsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNormalizationFieldsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNormalizationFieldsResponseBody> body_ {};
  };
