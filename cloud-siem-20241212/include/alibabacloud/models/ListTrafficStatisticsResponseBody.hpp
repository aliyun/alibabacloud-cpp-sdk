...
#include <vector>
#include <alibabacloud/models/ListTrafficStatisticsResponseBodyTrafficStatistics.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->trafficStatistics_ == nullptr; };
    ...
    inline const vector<ListTrafficStatisticsResponseBodyTrafficStatistics> & trafficStatistics() const { DARABONBA_PTR_GET_CONST(trafficStatistics_, vector<ListTrafficStatisticsResponseBodyTrafficStatistics>) };
    inline vector<ListTrafficStatisticsResponseBodyTrafficStatistics> trafficStatistics() { DARABONBA_PTR_GET(trafficStatistics_, vector<ListTrafficStatisticsResponseBodyTrafficStatistics>) };
    inline ListTrafficStatisticsResponseBody& setTrafficStatistics(const vector<ListTrafficStatisticsResponseBodyTrafficStatistics> & trafficStatistics) { DARABONBA_PTR_SET_VALUE(trafficStatistics_, trafficStatistics) };
    inline ListTrafficStatisticsResponseBody& setTrafficStatistics(vector<ListTrafficStatisticsResponseBodyTrafficStatistics> && trafficStatistics) { DARABONBA_PTR_SET_RVALUE(trafficStatistics_, trafficStatistics) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<ListTrafficStatisticsResponseBodyTrafficStatistics>> trafficStatistics_ = nullptr;
  };
