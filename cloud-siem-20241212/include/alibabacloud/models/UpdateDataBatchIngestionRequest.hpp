...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoScanNew_ == nullptr
        && this->dataBatchIngestionMode_ == nullptr && this->dataIngestionIds_ == nullptr && this->dataSourceRecognizeEnabled_ == nullptr && this->lang_ == nullptr && this->logUserIds_ == nullptr
    ...
    inline const vector<int64_t> & getLogUserIds() const { DARABONBA_PTR_GET_CONST(logUserIds_, vector<int64_t>) };
    inline vector<int64_t> getLogUserIds() { DARABONBA_PTR_GET(logUserIds_, vector<int64_t>) };
