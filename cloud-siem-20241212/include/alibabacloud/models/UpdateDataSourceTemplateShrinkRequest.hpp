...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoScanNew_ == nullptr
        ...
        && return this->logRegionIds_ == nullptr && return this->logStorePattern_ == nullptr && return this->logUserIdsShrink_ == nullptr && return this->regionId_ == nullptr && return this->roleFor_ == nullptr; };
