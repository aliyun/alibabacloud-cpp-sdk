...
namespace Models
{
  ...
  public:
    ...
    inline const GetExportTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetExportTaskResponseBody) };
    inline GetExportTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetExportTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetExportTaskResponseBody> body_ {};
  };
