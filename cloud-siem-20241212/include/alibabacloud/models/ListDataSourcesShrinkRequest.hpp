...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataSourceFrom_ == nullptr
        && this->dataSourceIdsShrink_ == nullptr && this->dataSourceName_ == nullptr && this->dataSourceStatus_ == nullptr && this->dataSourceStoreStatus_ == nullptr && this->dataSourceTemplateIdsShrink_ == nullptr
        && this->dataSourceType_ == nullptr && this->lang_ == nullptr && this->logProjectName_ == nullptr && this->logRegionId_ == nullptr && this->logStoreName_ == nullptr
        && this->logUserIdsShrink_ == nullptr && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->order_ == nullptr && this->orderField_ == nullptr
        && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->regionId_ == nullptr && this->roleFor_ == nullptr; };
