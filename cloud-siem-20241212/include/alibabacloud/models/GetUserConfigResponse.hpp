...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserConfigResponseBody) };
    inline GetUserConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserConfigResponseBody> body_ {};
  };
