...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteNormalizationRuleVersionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteNormalizationRuleVersionResponseBody) };
    inline DeleteNormalizationRuleVersionResponseBody body() { DARABONBA_PTR_GET(body_, DeleteNormalizationRuleVersionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteNormalizationRuleVersionResponseBody> body_ = nullptr;
  };
