...
namespace Models
{
  ...
  public:
    ...
    inline const ListNormalizationCategoriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNormalizationCategoriesResponseBody) };
    inline ListNormalizationCategoriesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNormalizationCategoriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNormalizationCategoriesResponseBody> body_ {};
  };
