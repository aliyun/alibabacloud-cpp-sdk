...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataStorageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataStorageResponseBody) };
    inline GetDataStorageResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataStorageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataStorageResponseBody> body_ {};
  };
