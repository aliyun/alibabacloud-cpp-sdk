...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataBatchIngestionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataBatchIngestionResponseBody) };
    inline GetDataBatchIngestionResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataBatchIngestionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataBatchIngestionResponseBody> body_ {};
  };
