...
namespace Models
{
  ...
  public:
    ...
    inline const GetDetectionStatisticResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetDetectionStatisticResponseBody) };
    inline GetDetectionStatisticResponseBody body() { DARABONBA_PTR_GET(body_, GetDetectionStatisticResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetDetectionStatisticResponseBody> body_ = nullptr;
  };
