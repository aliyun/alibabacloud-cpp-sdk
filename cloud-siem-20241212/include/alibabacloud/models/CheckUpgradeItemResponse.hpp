...
namespace Models
{
  ...
  public:
    ...
    inline const CheckUpgradeItemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckUpgradeItemResponseBody) };
    inline CheckUpgradeItemResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckUpgradeItemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckUpgradeItemResponseBody> body_ {};
  };
