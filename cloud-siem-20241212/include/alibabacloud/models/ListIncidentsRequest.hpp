...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getIncidentUuids() const { DARABONBA_PTR_GET_CONST(incidentUuids_, vector<string>) };
    inline vector<string> getIncidentUuids() { DARABONBA_PTR_GET(incidentUuids_, vector<string>) };
    ...
    inline ListIncidentsRequest& setOwners(const vector<string> & owners) { DARABONBA_PTR_SET_VALUE(owners_, owners) };
    inline ListIncidentsRequest& setOwners(vector<string> && owners) { DARABONBA_PTR_SET_RVALUE(owners_, owners) };
