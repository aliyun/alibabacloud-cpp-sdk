...
namespace Models
{
  ...
  public:
    ...
    inline const SetDefaultNormalizationRuleVersionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetDefaultNormalizationRuleVersionResponseBody) };
    inline SetDefaultNormalizationRuleVersionResponseBody body() { DARABONBA_PTR_GET(body_, SetDefaultNormalizationRuleVersionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetDefaultNormalizationRuleVersionResponseBody> body_ = nullptr;
  };
