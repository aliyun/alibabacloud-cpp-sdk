...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDataSetRecordsResponseBodyDataSetRecords> & dataSetRecords() const { DARABONBA_PTR_GET_CONST(dataSetRecords_, vector<ListDataSetRecordsResponseBodyDataSetRecords>) };
    inline vector<ListDataSetRecordsResponseBodyDataSetRecords> dataSetRecords() { DARABONBA_PTR_GET(dataSetRecords_, vector<ListDataSetRecordsResponseBodyDataSetRecords>) };
    inline ListDataSetRecordsResponseBody& setDataSetRecords(const vector<ListDataSetRecordsResponseBodyDataSetRecords> & dataSetRecords) { DARABONBA_PTR_SET_VALUE(dataSetRecords_, dataSetRecords) };
    inline ListDataSetRecordsResponseBody& setDataSetRecords(vector<ListDataSetRecordsResponseBodyDataSetRecords> && dataSetRecords) { DARABONBA_PTR_SET_RVALUE(dataSetRecords_, dataSetRecords) };
  ...
  protected:
    std::shared_ptr<vector<ListDataSetRecordsResponseBodyDataSetRecords>> dataSetRecords_ = nullptr;
