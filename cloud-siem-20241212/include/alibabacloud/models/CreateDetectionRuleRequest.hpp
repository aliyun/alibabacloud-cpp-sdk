...
namespace Models
{
  ...
  public:
    ...
    inline CreateDetectionRuleRequest& setAlertAttCkMapping(string alertAttCkMapping) { DARABONBA_PTR_SET_VALUE(alertAttCkMapping_, alertAttCkMapping) };
    ...
    inline CreateDetectionRuleRequest& setAlertLevelMapping(string alertLevelMapping) { DARABONBA_PTR_SET_VALUE(alertLevelMapping_, alertLevelMapping) };
    ...
    inline CreateDetectionRuleRequest& setAlertTypeMapping(string alertTypeMapping) { DARABONBA_PTR_SET_VALUE(alertTypeMapping_, alertTypeMapping) };
