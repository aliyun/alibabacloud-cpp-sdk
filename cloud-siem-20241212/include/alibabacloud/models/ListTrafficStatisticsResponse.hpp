...
namespace Models
{
  ...
  public:
    ...
    inline const ListTrafficStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTrafficStatisticsResponseBody) };
    inline ListTrafficStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTrafficStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTrafficStatisticsResponseBody> body_ {};
  };
