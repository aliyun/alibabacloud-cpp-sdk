...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && return this->nextToken_ == nullptr && return this->normalizationSchemas_ == nullptr && return this->requestId_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const vector<ListNormalizationSchemasResponseBodyNormalizationSchemas> & normalizationSchemas() const { DARABONBA_PTR_GET_CONST(normalizationSchemas_, vector<ListNormalizationSchemasResponseBodyNormalizationSchemas>) };
    inline vector<ListNormalizationSchemasResponseBodyNormalizationSchemas> normalizationSchemas() { DARABONBA_PTR_GET(normalizationSchemas_, vector<ListNormalizationSchemasResponseBodyNormalizationSchemas>) };
    inline ListNormalizationSchemasResponseBody& setNormalizationSchemas(const vector<ListNormalizationSchemasResponseBodyNormalizationSchemas> & normalizationSchemas) { DARABONBA_PTR_SET_VALUE(normalizationSchemas_, normalizationSchemas) };
    inline ListNormalizationSchemasResponseBody& setNormalizationSchemas(vector<ListNormalizationSchemasResponseBodyNormalizationSchemas> && normalizationSchemas) { DARABONBA_PTR_SET_RVALUE(normalizationSchemas_, normalizationSchemas) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListNormalizationSchemasResponseBodyNormalizationSchemas>> normalizationSchemas_ = nullptr;
