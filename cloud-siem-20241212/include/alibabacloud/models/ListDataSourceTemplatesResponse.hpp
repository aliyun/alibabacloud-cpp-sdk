...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataSourceTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataSourceTemplatesResponseBody) };
    inline ListDataSourceTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataSourceTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataSourceTemplatesResponseBody> body_ {};
  };
