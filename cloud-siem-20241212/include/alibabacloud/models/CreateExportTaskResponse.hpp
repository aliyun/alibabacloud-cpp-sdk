...
namespace Models
{
  ...
  public:
    ...
    inline const CreateExportTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateExportTaskResponseBody) };
    inline CreateExportTaskResponseBody body() { DARABONBA_PTR_GET(body_, CreateExportTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateExportTaskResponseBody> body_ = nullptr;
  };
