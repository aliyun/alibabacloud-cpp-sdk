...
namespace Models
{
  ...
  public:
    ...
    inline const ListNormalizationSchemasResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListNormalizationSchemasResponseBody) };
    inline ListNormalizationSchemasResponseBody body() { DARABONBA_PTR_GET(body_, ListNormalizationSchemasResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListNormalizationSchemasResponseBody> body_ = nullptr;
  };
