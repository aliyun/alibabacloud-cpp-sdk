...
namespace Models
{
  ...
  public:
    ...
    inline const ListNormalizationRuleVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNormalizationRuleVersionsResponseBody) };
    inline ListNormalizationRuleVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNormalizationRuleVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNormalizationRuleVersionsResponseBody> body_ {};
  };
