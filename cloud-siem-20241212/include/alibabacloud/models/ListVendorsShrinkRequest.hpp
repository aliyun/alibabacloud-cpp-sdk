...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->regionId_ == nullptr && return this->roleFor_ == nullptr && return this->vendorIdsShrink_ == nullptr
    ...
    inline string vendorIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(vendorIdsShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> vendorIdsShrink_ = nullptr;
