...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->extendContentPacked_ == nullptr
        ...
        && return this->normalizationRuleIdsShrink_ == nullptr && return this->normalizationRuleMode_ == nullptr && return this->normalizationRuleName_ == nullptr && return this->normalizationRuleType_ == nullptr && return this->normalizationRuleVersion_ == nullptr
