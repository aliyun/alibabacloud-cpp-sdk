...
namespace Models
{
  ...
  public:
    ...
    inline CreateNormalizationRuleShrinkRequest& setNormalizationSecurityDomainId(string normalizationSecurityDomainId) { DARABONBA_PTR_SET_VALUE(normalizationSecurityDomainId_, normalizationSecurityDomainId) };
