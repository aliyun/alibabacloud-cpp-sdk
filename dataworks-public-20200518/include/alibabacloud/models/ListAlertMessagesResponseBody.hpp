...
#ifndef ALIBABACLOUD_MODELS_LISTALERTMESSAGESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTALERTMESSAGESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAlertMessagesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAlertMessagesResponseBody& obj) { 
    ...
    ListAlertMessagesResponseBody() = default ;
    ListAlertMessagesResponseBody(const ListAlertMessagesResponseBody &) = default ;
    ListAlertMessagesResponseBody(ListAlertMessagesResponseBody &&) = default ;
    ListAlertMessagesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAlertMessagesResponseBody() = default ;
    ListAlertMessagesResponseBody& operator=(const ListAlertMessagesResponseBody &) = default ;
    ListAlertMessagesResponseBody& operator=(ListAlertMessagesResponseBody &&) = default ;
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      class AlertMessages : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const AlertMessages& obj) { 
        ...
        friend void from_json(const Darabonba::Json& j, AlertMessages& obj) { 
        ...
        AlertMessages(const AlertMessages &) = default ;
        AlertMessages(AlertMessages &&) = default ;
        AlertMessages(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~AlertMessages() = default ;
        AlertMessages& operator=(const AlertMessages &) = default ;
        AlertMessages& operator=(AlertMessages &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        inline AlertMessages& setAlertId(int64_t alertId) { DARABONBA_PTR_SET_VALUE(alertId_, alertId) };
        ...
        inline AlertMessages& setAlertMessageStatus(string alertMessageStatus) { DARABONBA_PTR_SET_VALUE(alertMessageStatus_, alertMessageStatus) };
        ...
        inline AlertMessages& setAlertMethod(string alertMethod) { DARABONBA_PTR_SET_VALUE(alertMethod_, alertMethod) };
        ...
        inline AlertMessages& setAlertTime(int64_t alertTime) { DARABONBA_PTR_SET_VALUE(alertTime_, alertTime) };
        ...
        inline AlertMessages& setAlertUser(string alertUser) { DARABONBA_PTR_SET_VALUE(alertUser_, alertUser) };
        ...
        inline AlertMessages& setContent(string content) { DARABONBA_PTR_SET_VALUE(content_, content) };


        // instances Field Functions 
        bool hasInstances() const { return this->instances_ != nullptr;};
        void deleteInstances() { this->instances_ = nullptr;};
        inline const vector<AlertMessages::Instances> & getInstances() const { DARABONBA_PTR_GET_CONST(instances_, vector<AlertMessages::Instances>) };
        inline vector<AlertMessages::Instances> getInstances() { DARABONBA_PTR_GET(instances_, vector<AlertMessages::Instances>) };
        inline AlertMessages& setInstances(const vector<AlertMessages::Instances> & instances) { DARABONBA_PTR_SET_VALUE(instances_, instances) };
        inline AlertMessages& setInstances(vector<AlertMessages::Instances> && instances) { DARABONBA_PTR_SET_RVALUE(instances_, instances) };


        // nodes Field Functions 
        bool hasNodes() const { return this->nodes_ != nullptr;};
        void deleteNodes() { this->nodes_ = nullptr;};
        inline const vector<AlertMessages::Nodes> & getNodes() const { DARABONBA_PTR_GET_CONST(nodes_, vector<AlertMessages::Nodes>) };
        inline vector<AlertMessages::Nodes> getNodes() { DARABONBA_PTR_GET(nodes_, vector<AlertMessages::Nodes>) };
        inline AlertMessages& setNodes(const vector<AlertMessages::Nodes> & nodes) { DARABONBA_PTR_SET_VALUE(nodes_, nodes) };
        inline AlertMessages& setNodes(vector<AlertMessages::Nodes> && nodes) { DARABONBA_PTR_SET_RVALUE(nodes_, nodes) };
        ...
        inline AlertMessages& setRemindId(int64_t remindId) { DARABONBA_PTR_SET_VALUE(remindId_, remindId) };
        ...
        inline AlertMessages& setRemindName(string remindName) { DARABONBA_PTR_SET_VALUE(remindName_, remindName) };


        // slaAlert Field Functions 
        bool hasSlaAlert() const { return this->slaAlert_ != nullptr;};
        void deleteSlaAlert() { this->slaAlert_ = nullptr;};
        inline const AlertMessages::SlaAlert & getSlaAlert() const { DARABONBA_PTR_GET_CONST(slaAlert_, AlertMessages::SlaAlert) };
        inline AlertMessages::SlaAlert getSlaAlert() { DARABONBA_PTR_GET(slaAlert_, AlertMessages::SlaAlert) };
        inline AlertMessages& setSlaAlert(const AlertMessages::SlaAlert & slaAlert) { DARABONBA_PTR_SET_VALUE(slaAlert_, slaAlert) };
        inline AlertMessages& setSlaAlert(AlertMessages::SlaAlert && slaAlert) { DARABONBA_PTR_SET_RVALUE(slaAlert_, slaAlert) };
        ...
        inline AlertMessages& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };


        // topics Field Functions 
        bool hasTopics() const { return this->topics_ != nullptr;};
        void deleteTopics() { this->topics_ = nullptr;};
        inline const vector<AlertMessages::Topics> & getTopics() const { DARABONBA_PTR_GET_CONST(topics_, vector<AlertMessages::Topics>) };
        inline vector<AlertMessages::Topics> getTopics() { DARABONBA_PTR_GET(topics_, vector<AlertMessages::Topics>) };
        inline AlertMessages& setTopics(const vector<AlertMessages::Topics> & topics) { DARABONBA_PTR_SET_VALUE(topics_, topics) };
        inline AlertMessages& setTopics(vector<AlertMessages::Topics> && topics) { DARABONBA_PTR_SET_RVALUE(topics_, topics) };
      ...
      protected:
        ...
        shared_ptr<vector<AlertMessages::Instances>> instances_ {};
        ...
        shared_ptr<vector<AlertMessages::Nodes>> nodes_ {};
        ...
        shared_ptr<AlertMessages::SlaAlert> slaAlert_ {};
        ...
        shared_ptr<vector<AlertMessages::Topics>> topics_ {};
      };

      virtual bool empty() const override { return this->alertMessages_ == nullptr
      ...
      inline const vector<Data::AlertMessages> & getAlertMessages() const { DARABONBA_PTR_GET_CONST(alertMessages_, vector<Data::AlertMessages>) };
      inline vector<Data::AlertMessages> getAlertMessages() { DARABONBA_PTR_GET(alertMessages_, vector<Data::AlertMessages>) };
      inline Data& setAlertMessages(const vector<Data::AlertMessages> & alertMessages) { DARABONBA_PTR_SET_VALUE(alertMessages_, alertMessages) };
      inline Data& setAlertMessages(vector<Data::AlertMessages> && alertMessages) { DARABONBA_PTR_SET_RVALUE(alertMessages_, alertMessages) };
    ...
    protected:
      // The alerts.
      shared_ptr<vector<Data::AlertMessages>> alertMessages_ {};
      // The page number.
    ...
    inline const ListAlertMessagesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListAlertMessagesResponseBody::Data) };
    inline ListAlertMessagesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListAlertMessagesResponseBody::Data) };
    inline ListAlertMessagesResponseBody& setData(const ListAlertMessagesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAlertMessagesResponseBody& setData(ListAlertMessagesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListAlertMessagesResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline ListAlertMessagesResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline ListAlertMessagesResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListAlertMessagesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListAlertMessagesResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The information about returned alerts.
    shared_ptr<ListAlertMessagesResponseBody::Data> data_ {};
    // The error code.
