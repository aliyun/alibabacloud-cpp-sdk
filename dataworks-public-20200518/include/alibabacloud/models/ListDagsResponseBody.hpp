...
namespace Models
{
  ...
  public:
    ...
    inline const ListDagsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDagsResponseBodyData) };
    inline ListDagsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDagsResponseBodyData) };
    inline ListDagsResponseBody& setData(const ListDagsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDagsResponseBody& setData(ListDagsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The details of DAGs.
    std::shared_ptr<ListDagsResponseBodyData> data_ = nullptr;
    // The error code.
