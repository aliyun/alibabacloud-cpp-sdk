...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUdfFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateUdfFileResponseBody) };
    inline CreateUdfFileResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateUdfFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateUdfFileResponseBody> body_ {};
  };
