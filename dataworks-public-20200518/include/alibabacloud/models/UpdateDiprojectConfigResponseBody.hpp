...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDIProjectConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateDIProjectConfigResponseBodyData) };
    inline UpdateDIProjectConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateDIProjectConfigResponseBodyData) };
    inline UpdateDIProjectConfigResponseBody& setData(const UpdateDIProjectConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateDIProjectConfigResponseBody& setData(UpdateDIProjectConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateDIProjectConfigResponseBodyData> data_ = nullptr;
