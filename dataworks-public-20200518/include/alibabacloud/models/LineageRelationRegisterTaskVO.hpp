...
namespace Models
{
  ...
  public:
    ...
    inline const vector<LineageEntityVO> & getInputEntities() const { DARABONBA_PTR_GET_CONST(inputEntities_, vector<LineageEntityVO>) };
    inline vector<LineageEntityVO> getInputEntities() { DARABONBA_PTR_GET(inputEntities_, vector<LineageEntityVO>) };
    ...
    inline const vector<LineageEntityVO> & getOutputEntities() const { DARABONBA_PTR_GET_CONST(outputEntities_, vector<LineageEntityVO>) };
    inline vector<LineageEntityVO> getOutputEntities() { DARABONBA_PTR_GET(outputEntities_, vector<LineageEntityVO>) };
  ...
  protected:
    ...
    shared_ptr<vector<LineageEntityVO>> inputEntities_ {};
    shared_ptr<string> name_ {};
    shared_ptr<vector<LineageEntityVO>> outputEntities_ {};
