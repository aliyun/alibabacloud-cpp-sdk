...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableListByCategoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMetaTableListByCategoryResponseBody) };
    inline GetMetaTableListByCategoryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMetaTableListByCategoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMetaTableListByCategoryResponseBody> body_ {};
  };
