...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMetaTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateMetaTableResponseBody) };
    inline UpdateMetaTableResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateMetaTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateMetaTableResponseBody> body_ {};
  };
