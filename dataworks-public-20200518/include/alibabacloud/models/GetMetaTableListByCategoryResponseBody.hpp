...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableListByCategoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetaTableListByCategoryResponseBodyData) };
    inline GetMetaTableListByCategoryResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetaTableListByCategoryResponseBodyData) };
    inline GetMetaTableListByCategoryResponseBody& setData(const GetMetaTableListByCategoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaTableListByCategoryResponseBody& setData(GetMetaTableListByCategoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetMetaTableListByCategoryResponseBodyData> data_ = nullptr;
