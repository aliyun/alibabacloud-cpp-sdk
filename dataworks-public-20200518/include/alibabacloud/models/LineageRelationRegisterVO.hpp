...
namespace Models
{
  ...
  public:
    ...
    inline const LineageEntityVO & getDestEntity() const { DARABONBA_PTR_GET_CONST(destEntity_, LineageEntityVO) };
    inline LineageEntityVO getDestEntity() { DARABONBA_PTR_GET(destEntity_, LineageEntityVO) };
    ...
    inline const LineageEntityVO & getSrcEntity() const { DARABONBA_PTR_GET_CONST(srcEntity_, LineageEntityVO) };
    inline LineageEntityVO getSrcEntity() { DARABONBA_PTR_GET(srcEntity_, LineageEntityVO) };
