...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDISyncTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteDISyncTaskResponseBody::Data) };
    inline DeleteDISyncTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteDISyncTaskResponseBody::Data) };
    inline DeleteDISyncTaskResponseBody& setData(const DeleteDISyncTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteDISyncTaskResponseBody& setData(DeleteDISyncTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The deletion result.
    shared_ptr<DeleteDISyncTaskResponseBody::Data> data_ {};
