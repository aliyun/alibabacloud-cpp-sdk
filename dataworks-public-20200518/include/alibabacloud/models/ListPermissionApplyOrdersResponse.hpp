...
namespace Models
{
  ...
  public:
    ...
    inline const ListPermissionApplyOrdersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPermissionApplyOrdersResponseBody) };
    inline ListPermissionApplyOrdersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPermissionApplyOrdersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPermissionApplyOrdersResponseBody> body_ {};
  };
