...
namespace Models
{
  ...
  public:
    ...
    inline const ListBaselinesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListBaselinesResponseBodyData) };
    inline ListBaselinesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListBaselinesResponseBodyData) };
    inline ListBaselinesResponseBody& setData(const ListBaselinesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListBaselinesResponseBody& setData(ListBaselinesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListBaselinesResponseBodyData> data_ = nullptr;
    // The error code.
