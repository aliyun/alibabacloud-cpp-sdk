...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveProjectMemberFromRoleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveProjectMemberFromRoleResponseBody) };
    inline RemoveProjectMemberFromRoleResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveProjectMemberFromRoleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveProjectMemberFromRoleResponseBody> body_ {};
  };
