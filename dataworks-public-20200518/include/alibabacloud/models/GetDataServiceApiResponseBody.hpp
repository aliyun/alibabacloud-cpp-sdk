...
#ifndef ALIBABACLOUD_MODELS_GETDATASERVICEAPIRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETDATASERVICEAPIRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDataServiceApiResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDataServiceApiResponseBody& obj) { 
    ...
    GetDataServiceApiResponseBody() = default ;
    GetDataServiceApiResponseBody(const GetDataServiceApiResponseBody &) = default ;
    GetDataServiceApiResponseBody(GetDataServiceApiResponseBody &&) = default ;
    GetDataServiceApiResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDataServiceApiResponseBody() = default ;
    GetDataServiceApiResponseBody& operator=(const GetDataServiceApiResponseBody &) = default ;
    GetDataServiceApiResponseBody& operator=(GetDataServiceApiResponseBody &&) = default ;
    ...
    public:
      ...
      inline Data& setFolderId(int64_t folderId) { DARABONBA_PTR_SET_VALUE(folderId_, folderId) };
    ...
    inline const GetDataServiceApiResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDataServiceApiResponseBody::Data) };
    inline GetDataServiceApiResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDataServiceApiResponseBody::Data) };
    inline GetDataServiceApiResponseBody& setData(const GetDataServiceApiResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataServiceApiResponseBody& setData(GetDataServiceApiResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    void deleteErrorCode() { this->errorCode_ = nullptr;};
    inline string getErrorCode() const { DARABONBA_PTR_GET_DEFAULT(errorCode_, "") };
    inline GetDataServiceApiResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    void deleteErrorMessage() { this->errorMessage_ = nullptr;};
    inline string getErrorMessage() const { DARABONBA_PTR_GET_DEFAULT(errorMessage_, "") };
    inline GetDataServiceApiResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline GetDataServiceApiResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetDataServiceApiResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetDataServiceApiResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The returned data.
    shared_ptr<GetDataServiceApiResponseBody::Data> data_ {};
