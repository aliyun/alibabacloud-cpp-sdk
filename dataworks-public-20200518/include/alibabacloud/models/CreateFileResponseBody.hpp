...
namespace Models
{
  ...
  public:
    ...
    inline CreateFileResponseBody& setData(int64_t data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline CreateFileResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline CreateFileResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline CreateFileResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateFileResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
