...
namespace Models
{
  ...
  public:
    ...
    inline string getProjectPermissions() const { DARABONBA_PTR_GET_DEFAULT(projectPermissions_, "") };
    ...
    inline string getUserPermissions() const { DARABONBA_PTR_GET_DEFAULT(userPermissions_, "") };
  ...
  protected:
    ...
    shared_ptr<string> projectPermissions_ {};
    ...
    shared_ptr<string> userPermissions_ {};
  };
