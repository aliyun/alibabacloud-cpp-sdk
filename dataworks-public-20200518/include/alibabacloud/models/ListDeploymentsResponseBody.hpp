...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeploymentsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListDeploymentsResponseBody::Data) };
    inline ListDeploymentsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListDeploymentsResponseBody::Data) };
    inline ListDeploymentsResponseBody& setData(const ListDeploymentsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDeploymentsResponseBody& setData(ListDeploymentsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    shared_ptr<ListDeploymentsResponseBody::Data> data_ {};
    // The request ID.
