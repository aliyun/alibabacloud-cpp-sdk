...
namespace Models
{
  ...
  public:
    ...
    inline const ListQualityResultsByEntityResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListQualityResultsByEntityResponseBody::Data) };
    inline ListQualityResultsByEntityResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListQualityResultsByEntityResponseBody::Data) };
    inline ListQualityResultsByEntityResponseBody& setData(const ListQualityResultsByEntityResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListQualityResultsByEntityResponseBody& setData(ListQualityResultsByEntityResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
