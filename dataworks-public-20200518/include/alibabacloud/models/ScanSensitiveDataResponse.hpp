...
namespace Models
{
  ...
  public:
    ...
    inline const ScanSensitiveDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ScanSensitiveDataResponseBody) };
    inline ScanSensitiveDataResponseBody getBody() { DARABONBA_PTR_GET(body_, ScanSensitiveDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ScanSensitiveDataResponseBody> body_ {};
  };
