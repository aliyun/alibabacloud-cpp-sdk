...
namespace Models
{
  ...
  public:
    ...
    inline const GetAlertMessageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAlertMessageResponseBodyData) };
    inline GetAlertMessageResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAlertMessageResponseBodyData) };
    inline GetAlertMessageResponseBody& setData(const GetAlertMessageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAlertMessageResponseBody& setData(GetAlertMessageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAlertMessageResponseBodyData> data_ = nullptr;
    // The error code.
