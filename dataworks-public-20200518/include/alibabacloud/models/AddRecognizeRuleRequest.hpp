...
namespace Models
{
  ...
  public:
    ...
    inline string getColExclude() const { DARABONBA_PTR_GET_DEFAULT(colExclude_, "") };
    ...
    inline string getColScan() const { DARABONBA_PTR_GET_DEFAULT(colScan_, "") };
    ...
    inline string getCommentScan() const { DARABONBA_PTR_GET_DEFAULT(commentScan_, "") };
    ...
    inline string getContentScan() const { DARABONBA_PTR_GET_DEFAULT(contentScan_, "") };
    ...
    inline int32_t getHitThreshold() const { DARABONBA_PTR_GET_DEFAULT(hitThreshold_, 0) };
    ...
    inline string getNodeParent() const { DARABONBA_PTR_GET_DEFAULT(nodeParent_, "") };
    ...
    inline string getRecognizeRules() const { DARABONBA_PTR_GET_DEFAULT(recognizeRules_, "") };
    ...
    inline string getSensitiveDescription() const { DARABONBA_PTR_GET_DEFAULT(sensitiveDescription_, "") };
  ...
  protected:
    ...
    shared_ptr<string> contentScan_ {};
    ...
    shared_ptr<int32_t> hitThreshold_ {};
    ...
    shared_ptr<string> recognizeRules_ {};
    ...
    shared_ptr<string> sensitiveDescription_ {};
