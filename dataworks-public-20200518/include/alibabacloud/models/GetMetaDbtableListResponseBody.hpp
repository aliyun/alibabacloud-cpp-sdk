...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaDBTableListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetaDBTableListResponseBodyData) };
    inline GetMetaDBTableListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetaDBTableListResponseBodyData) };
    inline GetMetaDBTableListResponseBody& setData(const GetMetaDBTableListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaDBTableListResponseBody& setData(GetMetaDBTableListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetMetaDBTableListResponseBodyData> data_ = nullptr;
    // The request ID.
