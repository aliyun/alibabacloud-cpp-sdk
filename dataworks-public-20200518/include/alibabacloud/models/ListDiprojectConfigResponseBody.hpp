...
namespace Models
{
  ...
  public:
    ...
    inline const ListDIProjectConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDIProjectConfigResponseBodyData) };
    inline ListDIProjectConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDIProjectConfigResponseBodyData) };
    inline ListDIProjectConfigResponseBody& setData(const ListDIProjectConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDIProjectConfigResponseBody& setData(ListDIProjectConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListDIProjectConfigResponseBodyData> data_ = nullptr;
    // The request ID.
