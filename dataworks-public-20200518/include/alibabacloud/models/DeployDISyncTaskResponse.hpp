...
namespace Models
{
  ...
  public:
    ...
    inline const DeployDISyncTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeployDISyncTaskResponseBody) };
    inline DeployDISyncTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DeployDISyncTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeployDISyncTaskResponseBody> body_ {};
  };
