...
namespace Models
{
  ...
  public:
    ...
    inline const GetDIJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDIJobResponseBodyData) };
    inline GetDIJobResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDIJobResponseBodyData) };
    inline GetDIJobResponseBody& setData(const GetDIJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDIJobResponseBody& setData(GetDIJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDIJobResponseBodyData> data_ = nullptr;
    // The request ID.
