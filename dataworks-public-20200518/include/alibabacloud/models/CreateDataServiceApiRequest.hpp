...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getRequestContentType() const { DARABONBA_PTR_GET_DEFAULT(requestContentType_, 0) };
    ...
    inline int64_t getSqlMode() const { DARABONBA_PTR_GET_DEFAULT(sqlMode_, 0L) };
  ...
  protected:
    ...
    // *   1: JSON format
    // *   2: form format
    shared_ptr<int32_t> requestContentType_ {};
