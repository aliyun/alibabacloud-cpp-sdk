...
namespace Models
{
  ...
  public:
    ...
    inline const GetNodeParentsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetNodeParentsResponseBodyData) };
    inline GetNodeParentsResponseBodyData data() { DARABONBA_PTR_GET(data_, GetNodeParentsResponseBodyData) };
    inline GetNodeParentsResponseBody& setData(const GetNodeParentsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetNodeParentsResponseBody& setData(GetNodeParentsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The ancestor nodes.
    std::shared_ptr<GetNodeParentsResponseBodyData> data_ = nullptr;
    // The error code.
