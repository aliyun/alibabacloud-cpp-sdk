...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableThemeLevelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMetaTableThemeLevelResponseBody) };
    inline GetMetaTableThemeLevelResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMetaTableThemeLevelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMetaTableThemeLevelResponseBody> body_ {};
  };
