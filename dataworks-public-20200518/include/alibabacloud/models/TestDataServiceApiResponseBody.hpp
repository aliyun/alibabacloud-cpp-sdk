...
namespace Models
{
  ...
  public:
    ...
    inline const TestDataServiceApiResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, TestDataServiceApiResponseBodyData) };
    inline TestDataServiceApiResponseBodyData data() { DARABONBA_PTR_GET(data_, TestDataServiceApiResponseBodyData) };
    inline TestDataServiceApiResponseBody& setData(const TestDataServiceApiResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TestDataServiceApiResponseBody& setData(TestDataServiceApiResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<TestDataServiceApiResponseBodyData> data_ = nullptr;
