...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataSourceMetaResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDataSourceMetaResponseBodyData) };
    inline GetDataSourceMetaResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDataSourceMetaResponseBodyData) };
    inline GetDataSourceMetaResponseBody& setData(const GetDataSourceMetaResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataSourceMetaResponseBody& setData(GetDataSourceMetaResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned result.
    std::shared_ptr<GetDataSourceMetaResponseBodyData> data_ = nullptr;
