...
namespace Models
{
  ...
  public:
    ...
    inline const GetFolderResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetFolderResponseBodyData) };
    inline GetFolderResponseBodyData data() { DARABONBA_PTR_GET(data_, GetFolderResponseBodyData) };
    inline GetFolderResponseBody& setData(const GetFolderResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFolderResponseBody& setData(GetFolderResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetFolderResponseBodyData> data_ = nullptr;
    // The error code.
