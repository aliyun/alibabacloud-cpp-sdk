...
namespace Models
{
  ...
  public:
    ...
    inline const CreateQualityRelativeNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateQualityRelativeNodeResponseBody) };
    inline CreateQualityRelativeNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateQualityRelativeNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateQualityRelativeNodeResponseBody> body_ {};
  };
