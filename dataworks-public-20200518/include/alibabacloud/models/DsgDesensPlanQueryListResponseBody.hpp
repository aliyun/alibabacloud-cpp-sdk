...
namespace Models
{
  ...
  public:
    ...
    inline const DsgDesensPlanQueryListResponseBodyPageData & pageData() const { DARABONBA_PTR_GET_CONST(pageData_, DsgDesensPlanQueryListResponseBodyPageData) };
    inline DsgDesensPlanQueryListResponseBodyPageData pageData() { DARABONBA_PTR_GET(pageData_, DsgDesensPlanQueryListResponseBodyPageData) };
    inline DsgDesensPlanQueryListResponseBody& setPageData(const DsgDesensPlanQueryListResponseBodyPageData & pageData) { DARABONBA_PTR_SET_VALUE(pageData_, pageData) };
    inline DsgDesensPlanQueryListResponseBody& setPageData(DsgDesensPlanQueryListResponseBodyPageData && pageData) { DARABONBA_PTR_SET_RVALUE(pageData_, pageData) };
  ...
  protected:
    ...
    std::shared_ptr<DsgDesensPlanQueryListResponseBodyPageData> pageData_ = nullptr;
