...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataServiceApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataServiceApplicationResponseBody) };
    inline GetDataServiceApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataServiceApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataServiceApplicationResponseBody> body_ {};
  };
