...
#ifndef ALIBABACLOUD_MODELS_DSGPLATFORMQUERYPROJECTSANDSCHEMAFROMMETARESPONSEBODY_HPP_
...
namespace Models
{
  class DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody& obj) { 
    ...
    DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody() = default ;
    DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody(const DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody &) = default ;
    DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody(DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody &&) = default ;
    DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody() = default ;
    DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody& operator=(const DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody &) = default ;
    DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody& operator=(DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody &&) = default ;
