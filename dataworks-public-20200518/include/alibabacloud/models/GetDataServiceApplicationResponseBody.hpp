...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataServiceApplicationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDataServiceApplicationResponseBodyData) };
    inline GetDataServiceApplicationResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDataServiceApplicationResponseBodyData) };
    inline GetDataServiceApplicationResponseBody& setData(const GetDataServiceApplicationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDataServiceApplicationResponseBody& setData(GetDataServiceApplicationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDataServiceApplicationResponseBodyData> data_ = nullptr;
    // The error code.
