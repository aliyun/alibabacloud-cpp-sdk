...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceApiAuthoritiesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDataServiceApiAuthoritiesResponseBodyData) };
    inline ListDataServiceApiAuthoritiesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDataServiceApiAuthoritiesResponseBodyData) };
    inline ListDataServiceApiAuthoritiesResponseBody& setData(const ListDataServiceApiAuthoritiesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDataServiceApiAuthoritiesResponseBody& setData(ListDataServiceApiAuthoritiesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataServiceApiAuthoritiesResponseBodyData> data_ = nullptr;
    // The error code.
