...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Data& setBeginRunningTime(int64_t beginRunningTime) { DARABONBA_PTR_SET_VALUE(beginRunningTime_, beginRunningTime) };
      ...
      inline Data& setBeginWaitResTime(int64_t beginWaitResTime) { DARABONBA_PTR_SET_VALUE(beginWaitResTime_, beginWaitResTime) };
      ...
      inline Data& setBeginWaitTimeTime(int64_t beginWaitTimeTime) { DARABONBA_PTR_SET_VALUE(beginWaitTimeTime_, beginWaitTimeTime) };
      ...
      inline Data& setCycTime(int64_t cycTime) { DARABONBA_PTR_SET_VALUE(cycTime_, cycTime) };
      ...
      inline Data& setDagType(string dagType) { DARABONBA_PTR_SET_VALUE(dagType_, dagType) };
      ...
      inline Data& setPeriodNumber(int32_t periodNumber) { DARABONBA_PTR_SET_VALUE(periodNumber_, periodNumber) };
      ...
      inline Data& setRepeatability(bool repeatability) { DARABONBA_PTR_SET_VALUE(repeatability_, repeatability) };
      ...
      inline Data& setTaskRerunTime(int32_t taskRerunTime) { DARABONBA_PTR_SET_VALUE(taskRerunTime_, taskRerunTime) };
