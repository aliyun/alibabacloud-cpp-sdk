...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServicePublishedApisResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDataServicePublishedApisResponseBodyData) };
    inline ListDataServicePublishedApisResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDataServicePublishedApisResponseBodyData) };
    inline ListDataServicePublishedApisResponseBody& setData(const ListDataServicePublishedApisResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDataServicePublishedApisResponseBody& setData(ListDataServicePublishedApisResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListDataServicePublishedApisResponseBodyData> data_ = nullptr;
    // The error code.
