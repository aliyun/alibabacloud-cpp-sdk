...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableFullInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetaTableFullInfoResponseBodyData) };
    inline GetMetaTableFullInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetaTableFullInfoResponseBodyData) };
    inline GetMetaTableFullInfoResponseBody& setData(const GetMetaTableFullInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaTableFullInfoResponseBody& setData(GetMetaTableFullInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The business data.
    std::shared_ptr<GetMetaTableFullInfoResponseBodyData> data_ = nullptr;
    // The error code.
