...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListNodeInputOrOutputResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListNodeInputOrOutputResponseBodyData>) };
    inline vector<ListNodeInputOrOutputResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListNodeInputOrOutputResponseBodyData>) };
    inline ListNodeInputOrOutputResponseBody& setData(const vector<ListNodeInputOrOutputResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListNodeInputOrOutputResponseBody& setData(vector<ListNodeInputOrOutputResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListNodeInputOrOutputResponseBodyData>> data_ = nullptr;
    // The error code.
