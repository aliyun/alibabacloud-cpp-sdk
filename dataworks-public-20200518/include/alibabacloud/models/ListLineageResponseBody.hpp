...
namespace Models
{
  ...
  public:
    ...
    inline const ListLineageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListLineageResponseBodyData) };
    inline ListLineageResponseBodyData data() { DARABONBA_PTR_GET(data_, ListLineageResponseBodyData) };
    inline ListLineageResponseBody& setData(const ListLineageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListLineageResponseBody& setData(ListLineageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListLineageResponseBodyData> data_ = nullptr;
    // The error code.
