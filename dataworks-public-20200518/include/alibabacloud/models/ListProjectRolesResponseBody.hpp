...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->projectRoleList_ != nullptr
    ...
    inline const vector<ListProjectRolesResponseBodyProjectRoleList> & projectRoleList() const { DARABONBA_PTR_GET_CONST(projectRoleList_, vector<ListProjectRolesResponseBodyProjectRoleList>) };
    inline vector<ListProjectRolesResponseBodyProjectRoleList> projectRoleList() { DARABONBA_PTR_GET(projectRoleList_, vector<ListProjectRolesResponseBodyProjectRoleList>) };
    inline ListProjectRolesResponseBody& setProjectRoleList(const vector<ListProjectRolesResponseBodyProjectRoleList> & projectRoleList) { DARABONBA_PTR_SET_VALUE(projectRoleList_, projectRoleList) };
    inline ListProjectRolesResponseBody& setProjectRoleList(vector<ListProjectRolesResponseBodyProjectRoleList> && projectRoleList) { DARABONBA_PTR_SET_RVALUE(projectRoleList_, projectRoleList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListProjectRolesResponseBodyProjectRoleList>> projectRoleList_ = nullptr;
    // The request ID.
