...
#ifndef ALIBABACLOUD_MODELS_LISTDATASERVICEPUBLISHEDAPISRESPONSEBODYDATAAPISSCRIPTDETAILSSCRIPTREQUESTPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_LISTDATASERVICEPUBLISHEDAPISRESPONSEBODYDATAAPISSCRIPTDETAILSSCRIPTREQUESTPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& obj) { 
    ...
    ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters() = default ;
    ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters(const ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters &) = default ;
    ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters(ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters &&) = default ;
    ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters() = default ;
    ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& operator=(const ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters &) = default ;
    ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& operator=(ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters &&) = default ;
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setExampleValue(string exampleValue) { DARABONBA_PTR_SET_VALUE(exampleValue_, exampleValue) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setIsRequiredParameter(bool isRequiredParameter) { DARABONBA_PTR_SET_VALUE(isRequiredParameter_, isRequiredParameter) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setParameterDataType(int32_t parameterDataType) { DARABONBA_PTR_SET_VALUE(parameterDataType_, parameterDataType) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setParameterDescription(string parameterDescription) { DARABONBA_PTR_SET_VALUE(parameterDescription_, parameterDescription) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setParameterName(string parameterName) { DARABONBA_PTR_SET_VALUE(parameterName_, parameterName) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setParameterOperator(int32_t parameterOperator) { DARABONBA_PTR_SET_VALUE(parameterOperator_, parameterOperator) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setParameterPosition(int32_t parameterPosition) { DARABONBA_PTR_SET_VALUE(parameterPosition_, parameterPosition) };
