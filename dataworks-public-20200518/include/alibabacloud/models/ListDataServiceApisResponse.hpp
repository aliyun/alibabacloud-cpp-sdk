...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceApisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataServiceApisResponseBody) };
    inline ListDataServiceApisResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataServiceApisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataServiceApisResponseBody> body_ {};
  };
