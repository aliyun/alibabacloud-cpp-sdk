...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetBaselineKeyPathResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetBaselineKeyPathResponseBodyData>) };
    inline vector<GetBaselineKeyPathResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetBaselineKeyPathResponseBodyData>) };
    inline GetBaselineKeyPathResponseBody& setData(const vector<GetBaselineKeyPathResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetBaselineKeyPathResponseBody& setData(vector<GetBaselineKeyPathResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetBaselineKeyPathResponseBodyData>> data_ = nullptr;
    // Error code
