...
namespace Models
{
  ...
  public:
    ...
    inline const GetDIJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDIJobResponseBody) };
    inline GetDIJobResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDIJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDIJobResponseBody> body_ {};
  };
