...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateNodeOwnerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateNodeOwnerResponseBody) };
    inline UpdateNodeOwnerResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateNodeOwnerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateNodeOwnerResponseBody> body_ {};
  };
