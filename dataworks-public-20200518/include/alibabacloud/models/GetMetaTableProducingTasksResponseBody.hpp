...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetMetaTableProducingTasksResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetMetaTableProducingTasksResponseBodyData>) };
    inline vector<GetMetaTableProducingTasksResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetMetaTableProducingTasksResponseBodyData>) };
    inline GetMetaTableProducingTasksResponseBody& setData(const vector<GetMetaTableProducingTasksResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaTableProducingTasksResponseBody& setData(vector<GetMetaTableProducingTasksResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetMetaTableProducingTasksResponseBodyData>> data_ = nullptr;
    // The error code.
