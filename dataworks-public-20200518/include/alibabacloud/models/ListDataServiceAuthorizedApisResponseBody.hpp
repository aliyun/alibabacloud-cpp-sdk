...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceAuthorizedApisResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDataServiceAuthorizedApisResponseBodyData) };
    inline ListDataServiceAuthorizedApisResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDataServiceAuthorizedApisResponseBodyData) };
    inline ListDataServiceAuthorizedApisResponseBody& setData(const ListDataServiceAuthorizedApisResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDataServiceAuthorizedApisResponseBody& setData(ListDataServiceAuthorizedApisResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataServiceAuthorizedApisResponseBodyData> data_ = nullptr;
    // The error code.
