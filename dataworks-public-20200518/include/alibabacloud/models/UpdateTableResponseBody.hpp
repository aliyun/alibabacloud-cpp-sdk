...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTableResponseBodyTaskInfo & taskInfo() const { DARABONBA_PTR_GET_CONST(taskInfo_, UpdateTableResponseBodyTaskInfo) };
    inline UpdateTableResponseBodyTaskInfo taskInfo() { DARABONBA_PTR_GET(taskInfo_, UpdateTableResponseBodyTaskInfo) };
    inline UpdateTableResponseBody& setTaskInfo(const UpdateTableResponseBodyTaskInfo & taskInfo) { DARABONBA_PTR_SET_VALUE(taskInfo_, taskInfo) };
    inline UpdateTableResponseBody& setTaskInfo(UpdateTableResponseBodyTaskInfo && taskInfo) { DARABONBA_PTR_SET_RVALUE(taskInfo_, taskInfo) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateTableResponseBodyTaskInfo> taskInfo_ = nullptr;
  };
