...
#ifndef ALIBABACLOUD_MODELS_LISTPROJECTROLESRESPONSEBODYPROJECTROLELIST_HPP_
#define ALIBABACLOUD_MODELS_LISTPROJECTROLESRESPONSEBODYPROJECTROLELIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListProjectRolesResponseBodyProjectRoleList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListProjectRolesResponseBodyProjectRoleList& obj) { 
    ...
    ListProjectRolesResponseBodyProjectRoleList() = default ;
    ListProjectRolesResponseBodyProjectRoleList(const ListProjectRolesResponseBodyProjectRoleList &) = default ;
    ListProjectRolesResponseBodyProjectRoleList(ListProjectRolesResponseBodyProjectRoleList &&) = default ;
    ListProjectRolesResponseBodyProjectRoleList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListProjectRolesResponseBodyProjectRoleList() = default ;
    ListProjectRolesResponseBodyProjectRoleList& operator=(const ListProjectRolesResponseBodyProjectRoleList &) = default ;
    ListProjectRolesResponseBodyProjectRoleList& operator=(ListProjectRolesResponseBodyProjectRoleList &&) = default ;
    ...
    inline ListProjectRolesResponseBodyProjectRoleList& setProjectRoleCode(string projectRoleCode) { DARABONBA_PTR_SET_VALUE(projectRoleCode_, projectRoleCode) };
    ...
    inline ListProjectRolesResponseBodyProjectRoleList& setProjectRoleId(int32_t projectRoleId) { DARABONBA_PTR_SET_VALUE(projectRoleId_, projectRoleId) };
    ...
    inline ListProjectRolesResponseBodyProjectRoleList& setProjectRoleName(string projectRoleName) { DARABONBA_PTR_SET_VALUE(projectRoleName_, projectRoleName) };
    ...
    inline ListProjectRolesResponseBodyProjectRoleList& setProjectRoleType(string projectRoleType) { DARABONBA_PTR_SET_VALUE(projectRoleType_, projectRoleType) };
