...
namespace Models
{
  ...
  public:
    ...
    inline const GetTopicInfluenceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTopicInfluenceResponseBodyData) };
    inline GetTopicInfluenceResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTopicInfluenceResponseBodyData) };
    inline GetTopicInfluenceResponseBody& setData(const GetTopicInfluenceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTopicInfluenceResponseBody& setData(GetTopicInfluenceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<GetTopicInfluenceResponseBodyData> data_ = nullptr;
