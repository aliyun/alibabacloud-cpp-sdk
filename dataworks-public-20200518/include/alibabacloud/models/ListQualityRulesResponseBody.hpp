...
namespace Models
{
  ...
  public:
    ...
    inline const ListQualityRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListQualityRulesResponseBodyData) };
    inline ListQualityRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListQualityRulesResponseBodyData) };
    inline ListQualityRulesResponseBody& setData(const ListQualityRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListQualityRulesResponseBody& setData(ListQualityRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListQualityRulesResponseBodyData> data_ = nullptr;
    // The error code.
