...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataSourcesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListDataSourcesResponseBodyData) };
    inline ListDataSourcesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListDataSourcesResponseBodyData) };
    inline ListDataSourcesResponseBody& setData(const ListDataSourcesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListDataSourcesResponseBody& setData(ListDataSourcesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataSourcesResponseBodyData> data_ = nullptr;
