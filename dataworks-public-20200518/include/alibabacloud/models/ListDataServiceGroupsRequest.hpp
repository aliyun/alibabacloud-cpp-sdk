...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->groupNameKeyword_ == nullptr
    ...
    inline string getGroupNameKeyword() const { DARABONBA_PTR_GET_DEFAULT(groupNameKeyword_, "") };
  ...
  protected:
    ...
    shared_ptr<string> groupNameKeyword_ {};
