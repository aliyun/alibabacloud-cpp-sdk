...
namespace Models
{
  ...
  public:
    ...
    inline const GetPermissionApplyOrderDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPermissionApplyOrderDetailResponseBody) };
    inline GetPermissionApplyOrderDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPermissionApplyOrderDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPermissionApplyOrderDetailResponseBody> body_ {};
  };
