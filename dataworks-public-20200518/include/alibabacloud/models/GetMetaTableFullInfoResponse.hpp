...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableFullInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMetaTableFullInfoResponseBody) };
    inline GetMetaTableFullInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMetaTableFullInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMetaTableFullInfoResponseBody> body_ {};
  };
