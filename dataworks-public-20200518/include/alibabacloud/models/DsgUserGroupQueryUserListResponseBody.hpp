...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DsgUserGroupQueryUserListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DsgUserGroupQueryUserListResponseBodyData>) };
    inline vector<DsgUserGroupQueryUserListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DsgUserGroupQueryUserListResponseBodyData>) };
    inline DsgUserGroupQueryUserListResponseBody& setData(const vector<DsgUserGroupQueryUserListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DsgUserGroupQueryUserListResponseBody& setData(vector<DsgUserGroupQueryUserListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned result.
    std::shared_ptr<vector<DsgUserGroupQueryUserListResponseBodyData>> data_ = nullptr;
    // The error code.
