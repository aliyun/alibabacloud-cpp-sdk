...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaCategoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetaCategoryResponseBodyData) };
    inline GetMetaCategoryResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetaCategoryResponseBodyData) };
    inline GetMetaCategoryResponseBody& setData(const GetMetaCategoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaCategoryResponseBody& setData(GetMetaCategoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The business data.
    std::shared_ptr<GetMetaCategoryResponseBodyData> data_ = nullptr;
    // The error code.
