...
namespace Models
{
  ...
  public:
    ...
    inline const TerminateDISyncInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, TerminateDISyncInstanceResponseBodyData) };
    inline TerminateDISyncInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, TerminateDISyncInstanceResponseBodyData) };
    inline TerminateDISyncInstanceResponseBody& setData(const TerminateDISyncInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TerminateDISyncInstanceResponseBody& setData(TerminateDISyncInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<TerminateDISyncInstanceResponseBodyData> data_ = nullptr;
