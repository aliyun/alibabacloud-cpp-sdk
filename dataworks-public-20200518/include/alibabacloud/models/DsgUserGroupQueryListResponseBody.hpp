...
namespace Models
{
  ...
  public:
    ...
    inline const DsgUserGroupQueryListResponseBodyPageData & pageData() const { DARABONBA_PTR_GET_CONST(pageData_, DsgUserGroupQueryListResponseBodyPageData) };
    inline DsgUserGroupQueryListResponseBodyPageData pageData() { DARABONBA_PTR_GET(pageData_, DsgUserGroupQueryListResponseBodyPageData) };
    inline DsgUserGroupQueryListResponseBody& setPageData(const DsgUserGroupQueryListResponseBodyPageData & pageData) { DARABONBA_PTR_SET_VALUE(pageData_, pageData) };
    inline DsgUserGroupQueryListResponseBody& setPageData(DsgUserGroupQueryListResponseBodyPageData && pageData) { DARABONBA_PTR_SET_RVALUE(pageData_, pageData) };
  ...
  protected:
    ...
    std::shared_ptr<DsgUserGroupQueryListResponseBodyPageData> pageData_ = nullptr;
    // The request ID.
