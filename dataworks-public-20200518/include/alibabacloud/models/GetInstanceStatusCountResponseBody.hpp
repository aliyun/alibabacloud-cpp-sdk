...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceStatusCountResponseBody::StatusCount & getStatusCount() const { DARABONBA_PTR_GET_CONST(statusCount_, GetInstanceStatusCountResponseBody::StatusCount) };
    inline GetInstanceStatusCountResponseBody::StatusCount getStatusCount() { DARABONBA_PTR_GET(statusCount_, GetInstanceStatusCountResponseBody::StatusCount) };
    inline GetInstanceStatusCountResponseBody& setStatusCount(const GetInstanceStatusCountResponseBody::StatusCount & statusCount) { DARABONBA_PTR_SET_VALUE(statusCount_, statusCount) };
    inline GetInstanceStatusCountResponseBody& setStatusCount(GetInstanceStatusCountResponseBody::StatusCount && statusCount) { DARABONBA_PTR_SET_RVALUE(statusCount_, statusCount) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceStatusCountResponseBody::StatusCount> statusCount_ {};
  };
