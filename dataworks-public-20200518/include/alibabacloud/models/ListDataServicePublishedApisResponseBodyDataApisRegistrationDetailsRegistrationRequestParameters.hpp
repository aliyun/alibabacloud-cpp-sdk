...
#ifndef ALIBABACLOUD_MODELS_LISTDATASERVICEPUBLISHEDAPISRESPONSEBODYDATAAPISREGISTRATIONDETAILSREGISTRATIONREQUESTPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_LISTDATASERVICEPUBLISHEDAPISRESPONSEBODYDATAAPISREGISTRATIONDETAILSREGISTRATIONREQUESTPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& obj) { 
    ...
    ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters() = default ;
    ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters(const ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters &) = default ;
    ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters(ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters &&) = default ;
    ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters() = default ;
    ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& operator=(const ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters &) = default ;
    ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& operator=(ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters &&) = default ;
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setExampleValue(string exampleValue) { DARABONBA_PTR_SET_VALUE(exampleValue_, exampleValue) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setIsRequiredParameter(bool isRequiredParameter) { DARABONBA_PTR_SET_VALUE(isRequiredParameter_, isRequiredParameter) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setParameterDataType(int32_t parameterDataType) { DARABONBA_PTR_SET_VALUE(parameterDataType_, parameterDataType) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setParameterDescription(string parameterDescription) { DARABONBA_PTR_SET_VALUE(parameterDescription_, parameterDescription) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setParameterName(string parameterName) { DARABONBA_PTR_SET_VALUE(parameterName_, parameterName) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setParameterOperator(int32_t parameterOperator) { DARABONBA_PTR_SET_VALUE(parameterOperator_, parameterOperator) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setParameterPosition(int32_t parameterPosition) { DARABONBA_PTR_SET_VALUE(parameterPosition_, parameterPosition) };
