...
namespace Models
{
  ...
  public:
    ...
    inline const Models::CreateDIJobRequestJobSettingsImportRuleSettings & importRuleSettings() const { DARABONBA_PTR_GET_CONST(importRuleSettings_, Models::CreateDIJobRequestJobSettingsImportRuleSettings) };
    inline Models::CreateDIJobRequestJobSettingsImportRuleSettings importRuleSettings() { DARABONBA_PTR_GET(importRuleSettings_, Models::CreateDIJobRequestJobSettingsImportRuleSettings) };
    inline CreateDIJobRequestJobSettings& setImportRuleSettings(const Models::CreateDIJobRequestJobSettingsImportRuleSettings & importRuleSettings) { DARABONBA_PTR_SET_VALUE(importRuleSettings_, importRuleSettings) };
    inline CreateDIJobRequestJobSettings& setImportRuleSettings(Models::CreateDIJobRequestJobSettingsImportRuleSettings && importRuleSettings) { DARABONBA_PTR_SET_RVALUE(importRuleSettings_, importRuleSettings) };
  ...
  protected:
    ...
    std::shared_ptr<Models::CreateDIJobRequestJobSettingsImportRuleSettings> importRuleSettings_ = nullptr;
