...
namespace Models
{
  ...
  public:
    ...
    inline const GetBaselineResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetBaselineResponseBodyData) };
    inline GetBaselineResponseBodyData data() { DARABONBA_PTR_GET(data_, GetBaselineResponseBodyData) };
    inline GetBaselineResponseBody& setData(const GetBaselineResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetBaselineResponseBody& setData(GetBaselineResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<GetBaselineResponseBodyData> data_ = nullptr;
    // The error code.
