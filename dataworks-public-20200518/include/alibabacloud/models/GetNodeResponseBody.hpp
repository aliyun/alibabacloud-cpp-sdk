...
namespace Models
{
  ...
  public:
    ...
    inline const GetNodeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetNodeResponseBodyData) };
    inline GetNodeResponseBodyData data() { DARABONBA_PTR_GET(data_, GetNodeResponseBodyData) };
    inline GetNodeResponseBody& setData(const GetNodeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetNodeResponseBody& setData(GetNodeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetNodeResponseBodyData> data_ = nullptr;
