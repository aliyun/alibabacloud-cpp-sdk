...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodeInputOrOutputResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNodeInputOrOutputResponseBody) };
    inline ListNodeInputOrOutputResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNodeInputOrOutputResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNodeInputOrOutputResponseBody> body_ {};
  };
