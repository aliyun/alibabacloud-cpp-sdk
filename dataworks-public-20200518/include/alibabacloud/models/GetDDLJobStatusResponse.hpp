...
namespace Models
{
  ...
  public:
    ...
    inline const GetDDLJobStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDDLJobStatusResponseBody) };
    inline GetDDLJobStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDDLJobStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDDLJobStatusResponseBody> body_ {};
  };
