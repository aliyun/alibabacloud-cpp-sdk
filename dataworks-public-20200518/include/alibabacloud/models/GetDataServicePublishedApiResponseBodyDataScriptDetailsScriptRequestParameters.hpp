...
#ifndef ALIBABACLOUD_MODELS_GETDATASERVICEPUBLISHEDAPIRESPONSEBODYDATASCRIPTDETAILSSCRIPTREQUESTPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_GETDATASERVICEPUBLISHEDAPIRESPONSEBODYDATASCRIPTDETAILSSCRIPTREQUESTPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& obj) { 
    ...
    GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters() = default ;
    GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters(const GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters &) = default ;
    GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters(GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters &&) = default ;
    GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters() = default ;
    GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& operator=(const GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters &) = default ;
    GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& operator=(GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters &&) = default ;
    ...
    inline GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& setExampleValue(string exampleValue) { DARABONBA_PTR_SET_VALUE(exampleValue_, exampleValue) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& setIsRequiredParameter(bool isRequiredParameter) { DARABONBA_PTR_SET_VALUE(isRequiredParameter_, isRequiredParameter) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& setParameterDataType(int32_t parameterDataType) { DARABONBA_PTR_SET_VALUE(parameterDataType_, parameterDataType) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& setParameterDescription(string parameterDescription) { DARABONBA_PTR_SET_VALUE(parameterDescription_, parameterDescription) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& setParameterName(string parameterName) { DARABONBA_PTR_SET_VALUE(parameterName_, parameterName) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& setParameterOperator(int32_t parameterOperator) { DARABONBA_PTR_SET_VALUE(parameterOperator_, parameterOperator) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataScriptDetailsScriptRequestParameters& setParameterPosition(int32_t parameterPosition) { DARABONBA_PTR_SET_VALUE(parameterPosition_, parameterPosition) };
