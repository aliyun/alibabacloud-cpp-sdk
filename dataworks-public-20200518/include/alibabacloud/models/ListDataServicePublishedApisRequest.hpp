...
namespace Models
{
  ...
  public:
    ...
    inline ListDataServicePublishedApisRequest& setApiNameKeyword(string apiNameKeyword) { DARABONBA_PTR_SET_VALUE(apiNameKeyword_, apiNameKeyword) };
    ...
    inline ListDataServicePublishedApisRequest& setApiPathKeyword(string apiPathKeyword) { DARABONBA_PTR_SET_VALUE(apiPathKeyword_, apiPathKeyword) };
    ...
    inline ListDataServicePublishedApisRequest& setCreatorId(string creatorId) { DARABONBA_PTR_SET_VALUE(creatorId_, creatorId) };
    ...
    inline ListDataServicePublishedApisRequest& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListDataServicePublishedApisRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListDataServicePublishedApisRequest& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline ListDataServicePublishedApisRequest& setTenantId(int64_t tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
