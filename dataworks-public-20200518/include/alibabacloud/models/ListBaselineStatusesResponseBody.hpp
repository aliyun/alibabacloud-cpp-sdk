...
namespace Models
{
  ...
  public:
    ...
    inline const ListBaselineStatusesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListBaselineStatusesResponseBodyData) };
    inline ListBaselineStatusesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListBaselineStatusesResponseBodyData) };
    inline ListBaselineStatusesResponseBody& setData(const ListBaselineStatusesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListBaselineStatusesResponseBody& setData(ListBaselineStatusesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListBaselineStatusesResponseBodyData> data_ = nullptr;
