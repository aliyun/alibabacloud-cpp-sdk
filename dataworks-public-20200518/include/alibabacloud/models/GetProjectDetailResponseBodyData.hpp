...
#ifndef ALIBABACLOUD_MODELS_GETPROJECTDETAILRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETPROJECTDETAILRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetProjectDetailResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetProjectDetailResponseBodyData& obj) { 
    ...
    GetProjectDetailResponseBodyData() = default ;
    GetProjectDetailResponseBodyData(const GetProjectDetailResponseBodyData &) = default ;
    GetProjectDetailResponseBodyData(GetProjectDetailResponseBodyData &&) = default ;
    GetProjectDetailResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetProjectDetailResponseBodyData() = default ;
    GetProjectDetailResponseBodyData& operator=(const GetProjectDetailResponseBodyData &) = default ;
    GetProjectDetailResponseBodyData& operator=(GetProjectDetailResponseBodyData &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->defaultDiResourceGroupIdentifier_ != nullptr
    ...
    inline GetProjectDetailResponseBodyData& setDefaultDiResourceGroupIdentifier(string defaultDiResourceGroupIdentifier) { DARABONBA_PTR_SET_VALUE(defaultDiResourceGroupIdentifier_, defaultDiResourceGroupIdentifier) };
    ...
    inline GetProjectDetailResponseBodyData& setDevelopmentType(int32_t developmentType) { DARABONBA_PTR_SET_VALUE(developmentType_, developmentType) };
    ...
    inline GetProjectDetailResponseBodyData& setDisableDevelopment(bool disableDevelopment) { DARABONBA_PTR_SET_VALUE(disableDevelopment_, disableDevelopment) };
    ...
    inline GetProjectDetailResponseBodyData& setEnvTypes(const vector<string> & envTypes) { DARABONBA_PTR_SET_VALUE(envTypes_, envTypes) };
    inline GetProjectDetailResponseBodyData& setEnvTypes(vector<string> && envTypes) { DARABONBA_PTR_SET_RVALUE(envTypes_, envTypes) };
    ...
    inline GetProjectDetailResponseBodyData& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline GetProjectDetailResponseBodyData& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline GetProjectDetailResponseBodyData& setIsAllowDownload(int32_t isAllowDownload) { DARABONBA_PTR_SET_VALUE(isAllowDownload_, isAllowDownload) };
    ...
    inline GetProjectDetailResponseBodyData& setIsDefault(int32_t isDefault) { DARABONBA_PTR_SET_VALUE(isDefault_, isDefault) };
    ...
    inline GetProjectDetailResponseBodyData& setProjectDescription(string projectDescription) { DARABONBA_PTR_SET_VALUE(projectDescription_, projectDescription) };
    ...
    inline GetProjectDetailResponseBodyData& setProjectId(int32_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline GetProjectDetailResponseBodyData& setProjectIdentifier(string projectIdentifier) { DARABONBA_PTR_SET_VALUE(projectIdentifier_, projectIdentifier) };
    ...
    inline GetProjectDetailResponseBodyData& setProjectMode(int32_t projectMode) { DARABONBA_PTR_SET_VALUE(projectMode_, projectMode) };
    ...
    inline GetProjectDetailResponseBodyData& setProjectName(string projectName) { DARABONBA_PTR_SET_VALUE(projectName_, projectName) };
    ...
    inline GetProjectDetailResponseBodyData& setProjectOwnerBaseId(string projectOwnerBaseId) { DARABONBA_PTR_SET_VALUE(projectOwnerBaseId_, projectOwnerBaseId) };
    ...
    inline GetProjectDetailResponseBodyData& setProtectedMode(int32_t protectedMode) { DARABONBA_PTR_SET_VALUE(protectedMode_, protectedMode) };
    ...
    inline GetProjectDetailResponseBodyData& setResidentArea(string residentArea) { DARABONBA_PTR_SET_VALUE(residentArea_, residentArea) };
    ...
    inline GetProjectDetailResponseBodyData& setResourceManagerResourceGroupId(string resourceManagerResourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceManagerResourceGroupId_, resourceManagerResourceGroupId) };
    ...
    inline GetProjectDetailResponseBodyData& setSchedulerMaxRetryTimes(int32_t schedulerMaxRetryTimes) { DARABONBA_PTR_SET_VALUE(schedulerMaxRetryTimes_, schedulerMaxRetryTimes) };
    ...
    inline GetProjectDetailResponseBodyData& setSchedulerRetryInterval(int32_t schedulerRetryInterval) { DARABONBA_PTR_SET_VALUE(schedulerRetryInterval_, schedulerRetryInterval) };
    ...
    inline GetProjectDetailResponseBodyData& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetProjectDetailResponseBodyData& setTablePrivacyMode(int32_t tablePrivacyMode) { DARABONBA_PTR_SET_VALUE(tablePrivacyMode_, tablePrivacyMode) };


    // tags Field Functions 
    bool hasTags() const { return this->tags_ != nullptr;};
    void deleteTags() { this->tags_ = nullptr;};
    inline const vector<Models::GetProjectDetailResponseBodyDataTags> & tags() const { DARABONBA_PTR_GET_CONST(tags_, vector<Models::GetProjectDetailResponseBodyDataTags>) };
    inline vector<Models::GetProjectDetailResponseBodyDataTags> tags() { DARABONBA_PTR_GET(tags_, vector<Models::GetProjectDetailResponseBodyDataTags>) };
    inline GetProjectDetailResponseBodyData& setTags(const vector<Models::GetProjectDetailResponseBodyDataTags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline GetProjectDetailResponseBodyData& setTags(vector<Models::GetProjectDetailResponseBodyDataTags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    inline GetProjectDetailResponseBodyData& setTenantId(int64_t tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
    ...
    inline GetProjectDetailResponseBodyData& setUseProxyOdpsAccount(bool useProxyOdpsAccount) { DARABONBA_PTR_SET_VALUE(useProxyOdpsAccount_, useProxyOdpsAccount) };
  ...
  protected:
    ...
    // The tag information.
    std::shared_ptr<vector<Models::GetProjectDetailResponseBodyDataTags>> tags_ = nullptr;
    // The tenant ID.
