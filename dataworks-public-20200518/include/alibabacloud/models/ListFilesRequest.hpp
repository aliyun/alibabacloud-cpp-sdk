...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->exactFileName_ == nullptr
    ...
    inline string getExactFileName() const { DARABONBA_PTR_GET_DEFAULT(exactFileName_, "") };
    ...
    inline string getFileIdIn() const { DARABONBA_PTR_GET_DEFAULT(fileIdIn_, "") };
    ...
    inline string getFileTypes() const { DARABONBA_PTR_GET_DEFAULT(fileTypes_, "") };
    ...
    inline bool getNeedAbsoluteFolderPath() const { DARABONBA_PTR_GET_DEFAULT(needAbsoluteFolderPath_, false) };
    ...
    inline bool getNeedContent() const { DARABONBA_PTR_GET_DEFAULT(needContent_, false) };
  ...
  protected:
    ...
    shared_ptr<string> exactFileName_ {};
    ...
    shared_ptr<bool> needAbsoluteFolderPath_ {};
