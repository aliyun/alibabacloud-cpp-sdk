...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getTargetNodeProjectId() const { DARABONBA_PTR_GET_DEFAULT(targetNodeProjectId_, 0L) };
    ...
    inline string getTargetNodeProjectName() const { DARABONBA_PTR_GET_DEFAULT(targetNodeProjectName_, "") };
