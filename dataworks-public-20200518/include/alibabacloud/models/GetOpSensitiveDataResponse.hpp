...
namespace Models
{
  ...
  public:
    ...
    inline const GetOpSensitiveDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOpSensitiveDataResponseBody) };
    inline GetOpSensitiveDataResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOpSensitiveDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOpSensitiveDataResponseBody> body_ {};
  };
