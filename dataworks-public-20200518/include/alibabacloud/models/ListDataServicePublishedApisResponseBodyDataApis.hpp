...
#ifndef ALIBABACLOUD_MODELS_LISTDATASERVICEPUBLISHEDAPISRESPONSEBODYDATAAPIS_HPP_
#define ALIBABACLOUD_MODELS_LISTDATASERVICEPUBLISHEDAPISRESPONSEBODYDATAAPIS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDataServicePublishedApisResponseBodyDataApis& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDataServicePublishedApisResponseBodyDataApis& obj) { 
    ...
    ListDataServicePublishedApisResponseBodyDataApis() = default ;
    ListDataServicePublishedApisResponseBodyDataApis(const ListDataServicePublishedApisResponseBodyDataApis &) = default ;
    ListDataServicePublishedApisResponseBodyDataApis(ListDataServicePublishedApisResponseBodyDataApis &&) = default ;
    ListDataServicePublishedApisResponseBodyDataApis(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDataServicePublishedApisResponseBodyDataApis() = default ;
    ListDataServicePublishedApisResponseBodyDataApis& operator=(const ListDataServicePublishedApisResponseBodyDataApis &) = default ;
    ListDataServicePublishedApisResponseBodyDataApis& operator=(ListDataServicePublishedApisResponseBodyDataApis &&) = default ;
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setApiId(int64_t apiId) { DARABONBA_PTR_SET_VALUE(apiId_, apiId) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setApiMode(int32_t apiMode) { DARABONBA_PTR_SET_VALUE(apiMode_, apiMode) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setApiName(string apiName) { DARABONBA_PTR_SET_VALUE(apiName_, apiName) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setApiPath(string apiPath) { DARABONBA_PTR_SET_VALUE(apiPath_, apiPath) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setCreatedTime(string createdTime) { DARABONBA_PTR_SET_VALUE(createdTime_, createdTime) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setCreatorId(string creatorId) { DARABONBA_PTR_SET_VALUE(creatorId_, creatorId) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setGroupId(string groupId) { DARABONBA_PTR_SET_VALUE(groupId_, groupId) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setModifiedTime(string modifiedTime) { DARABONBA_PTR_SET_VALUE(modifiedTime_, modifiedTime) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setOperatorId(string operatorId) { DARABONBA_PTR_SET_VALUE(operatorId_, operatorId) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setProtocols(const vector<int32_t> & protocols) { DARABONBA_PTR_SET_VALUE(protocols_, protocols) };
    inline ListDataServicePublishedApisResponseBodyDataApis& setProtocols(vector<int32_t> && protocols) { DARABONBA_PTR_SET_RVALUE(protocols_, protocols) };
    ...
    inline const Models::ListDataServicePublishedApisResponseBodyDataApisRegistrationDetails & registrationDetails() const { DARABONBA_PTR_GET_CONST(registrationDetails_, Models::ListDataServicePublishedApisResponseBodyDataApisRegistrationDetails) };
    inline Models::ListDataServicePublishedApisResponseBodyDataApisRegistrationDetails registrationDetails() { DARABONBA_PTR_GET(registrationDetails_, Models::ListDataServicePublishedApisResponseBodyDataApisRegistrationDetails) };
    inline ListDataServicePublishedApisResponseBodyDataApis& setRegistrationDetails(const Models::ListDataServicePublishedApisResponseBodyDataApisRegistrationDetails & registrationDetails) { DARABONBA_PTR_SET_VALUE(registrationDetails_, registrationDetails) };
    inline ListDataServicePublishedApisResponseBodyDataApis& setRegistrationDetails(Models::ListDataServicePublishedApisResponseBodyDataApisRegistrationDetails && registrationDetails) { DARABONBA_PTR_SET_RVALUE(registrationDetails_, registrationDetails) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setRequestMethod(int32_t requestMethod) { DARABONBA_PTR_SET_VALUE(requestMethod_, requestMethod) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setResponseContentType(int32_t responseContentType) { DARABONBA_PTR_SET_VALUE(responseContentType_, responseContentType) };
    ...
    inline const Models::ListDataServicePublishedApisResponseBodyDataApisScriptDetails & scriptDetails() const { DARABONBA_PTR_GET_CONST(scriptDetails_, Models::ListDataServicePublishedApisResponseBodyDataApisScriptDetails) };
    inline Models::ListDataServicePublishedApisResponseBodyDataApisScriptDetails scriptDetails() { DARABONBA_PTR_GET(scriptDetails_, Models::ListDataServicePublishedApisResponseBodyDataApisScriptDetails) };
    inline ListDataServicePublishedApisResponseBodyDataApis& setScriptDetails(const Models::ListDataServicePublishedApisResponseBodyDataApisScriptDetails & scriptDetails) { DARABONBA_PTR_SET_VALUE(scriptDetails_, scriptDetails) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setTenantId(int64_t tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setTimeout(int32_t timeout) { DARABONBA_PTR_SET_VALUE(timeout_, timeout) };
    ...
    inline ListDataServicePublishedApisResponseBodyDataApis& setVisibleRange(int32_t visibleRange) { DARABONBA_PTR_SET_VALUE(visibleRange_, visibleRange) };
    ...
    inline const Models::ListDataServicePublishedApisResponseBodyDataApisWizardDetails & wizardDetails() const { DARABONBA_PTR_GET_CONST(wizardDetails_, Models::ListDataServicePublishedApisResponseBodyDataApisWizardDetails) };
    inline Models::ListDataServicePublishedApisResponseBodyDataApisWizardDetails wizardDetails() { DARABONBA_PTR_GET(wizardDetails_, Models::ListDataServicePublishedApisResponseBodyDataApisWizardDetails) };
    inline ListDataServicePublishedApisResponseBodyDataApis& setWizardDetails(const Models::ListDataServicePublishedApisResponseBodyDataApisWizardDetails & wizardDetails) { DARABONBA_PTR_SET_VALUE(wizardDetails_, wizardDetails) };
    inline ListDataServicePublishedApisResponseBodyDataApis& setWizardDetails(Models::ListDataServicePublishedApisResponseBodyDataApisWizardDetails && wizardDetails) { DARABONBA_PTR_SET_RVALUE(wizardDetails_, wizardDetails) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ListDataServicePublishedApisResponseBodyDataApisRegistrationDetails> registrationDetails_ = nullptr;
    ...
    std::shared_ptr<Models::ListDataServicePublishedApisResponseBodyDataApisWizardDetails> wizardDetails_ = nullptr;
  };
