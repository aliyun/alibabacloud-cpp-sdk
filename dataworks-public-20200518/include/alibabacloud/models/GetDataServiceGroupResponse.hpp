...
namespace Models
{
  ...
  public:
    ...
    inline const GetDataServiceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDataServiceGroupResponseBody) };
    inline GetDataServiceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDataServiceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDataServiceGroupResponseBody> body_ {};
  };
