...
namespace Models
{
  ...
  public:
    ...
    inline const ListMetaCollectionEntitiesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListMetaCollectionEntitiesResponseBodyData) };
    inline ListMetaCollectionEntitiesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListMetaCollectionEntitiesResponseBodyData) };
    inline ListMetaCollectionEntitiesResponseBody& setData(const ListMetaCollectionEntitiesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListMetaCollectionEntitiesResponseBody& setData(ListMetaCollectionEntitiesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListMetaCollectionEntitiesResponseBodyData> data_ = nullptr;
    // The error code.
