...
namespace Models
{
  ...
  public:
    ...
    inline const ListMetaCollectionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMetaCollectionsResponseBody) };
    inline ListMetaCollectionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMetaCollectionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMetaCollectionsResponseBody> body_ {};
  };
