...
namespace Models
{
  ...
  public:
    ...
    inline const GetOptionValueForProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOptionValueForProjectResponseBody) };
    inline GetOptionValueForProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOptionValueForProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOptionValueForProjectResponseBody> body_ {};
  };
