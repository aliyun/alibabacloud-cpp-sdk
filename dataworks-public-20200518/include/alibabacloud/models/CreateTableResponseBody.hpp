...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTableResponseBody::TaskInfo & getTaskInfo() const { DARABONBA_PTR_GET_CONST(taskInfo_, CreateTableResponseBody::TaskInfo) };
    inline CreateTableResponseBody::TaskInfo getTaskInfo() { DARABONBA_PTR_GET(taskInfo_, CreateTableResponseBody::TaskInfo) };
    inline CreateTableResponseBody& setTaskInfo(const CreateTableResponseBody::TaskInfo & taskInfo) { DARABONBA_PTR_SET_VALUE(taskInfo_, taskInfo) };
    inline CreateTableResponseBody& setTaskInfo(CreateTableResponseBody::TaskInfo && taskInfo) { DARABONBA_PTR_SET_RVALUE(taskInfo_, taskInfo) };
