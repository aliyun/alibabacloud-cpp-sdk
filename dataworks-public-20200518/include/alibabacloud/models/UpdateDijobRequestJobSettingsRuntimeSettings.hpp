...
#ifndef ALIBABACLOUD_MODELS_UPDATEDIJOBREQUESTJOBSETTINGSRUNTIMESETTINGS_HPP_
#define ALIBABACLOUD_MODELS_UPDATEDIJOBREQUESTJOBSETTINGSRUNTIMESETTINGS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateDIJobRequestJobSettingsRuntimeSettings& obj) { 
      DARABONBA_PTR_TO_JSON(Name, name_);
      DARABONBA_PTR_TO_JSON(Value, value_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateDIJobRequestJobSettingsRuntimeSettings& obj) { 
      DARABONBA_PTR_FROM_JSON(Name, name_);
      DARABONBA_PTR_FROM_JSON(Value, value_);
    };
    UpdateDIJobRequestJobSettingsRuntimeSettings() = default ;
    UpdateDIJobRequestJobSettingsRuntimeSettings(const UpdateDIJobRequestJobSettingsRuntimeSettings &) = default ;
    UpdateDIJobRequestJobSettingsRuntimeSettings(UpdateDIJobRequestJobSettingsRuntimeSettings &&) = default ;
    UpdateDIJobRequestJobSettingsRuntimeSettings(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateDIJobRequestJobSettingsRuntimeSettings() = default ;
    UpdateDIJobRequestJobSettingsRuntimeSettings& operator=(const UpdateDIJobRequestJobSettingsRuntimeSettings &) = default ;
    UpdateDIJobRequestJobSettingsRuntimeSettings& operator=(UpdateDIJobRequestJobSettingsRuntimeSettings &&) = default ;
    ...
    inline UpdateDIJobRequestJobSettingsRuntimeSettings& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline UpdateDIJobRequestJobSettingsRuntimeSettings& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
