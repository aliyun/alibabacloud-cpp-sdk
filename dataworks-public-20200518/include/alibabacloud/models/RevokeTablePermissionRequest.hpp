...
namespace Models
{
  ...
  public:
    ...
    inline string getRevokeUserId() const { DARABONBA_PTR_GET_DEFAULT(revokeUserId_, "") };
    ...
    inline string getRevokeUserName() const { DARABONBA_PTR_GET_DEFAULT(revokeUserName_, "") };
  ...
  protected:
    ...
    shared_ptr<string> revokeUserId_ {};
    ...
    shared_ptr<string> revokeUserName_ {};
