...
#ifndef ALIBABACLOUD_MODELS_LISTDATASERVICEAPISRESPONSEBODYDATAAPISREGISTRATIONDETAILSREGISTRATIONREQUESTPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_LISTDATASERVICEAPISRESPONSEBODYDATAAPISREGISTRATIONDETAILSREGISTRATIONREQUESTPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& obj) { 
    ...
    ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters() = default ;
    ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters(const ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters &) = default ;
    ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters(ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters &&) = default ;
    ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters() = default ;
    ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& operator=(const ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters &) = default ;
    ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& operator=(ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters &&) = default ;
    ...
    inline ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setColumnName(string columnName) { DARABONBA_PTR_SET_VALUE(columnName_, columnName) };
    ...
    inline ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setExampleValue(string exampleValue) { DARABONBA_PTR_SET_VALUE(exampleValue_, exampleValue) };
    ...
    inline ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setIsRequiredParameter(bool isRequiredParameter) { DARABONBA_PTR_SET_VALUE(isRequiredParameter_, isRequiredParameter) };
    ...
    inline ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setParameterDataType(int32_t parameterDataType) { DARABONBA_PTR_SET_VALUE(parameterDataType_, parameterDataType) };
    ...
    inline ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setParameterDescription(string parameterDescription) { DARABONBA_PTR_SET_VALUE(parameterDescription_, parameterDescription) };
    ...
    inline ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setParameterName(string parameterName) { DARABONBA_PTR_SET_VALUE(parameterName_, parameterName) };
    ...
    inline ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setParameterOperator(int32_t parameterOperator) { DARABONBA_PTR_SET_VALUE(parameterOperator_, parameterOperator) };
    ...
    inline ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters& setParameterPosition(int32_t parameterPosition) { DARABONBA_PTR_SET_VALUE(parameterPosition_, parameterPosition) };
