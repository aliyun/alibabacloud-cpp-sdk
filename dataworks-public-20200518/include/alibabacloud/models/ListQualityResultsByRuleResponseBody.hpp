...
namespace Models
{
  ...
  public:
    ...
    inline const ListQualityResultsByRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListQualityResultsByRuleResponseBodyData) };
    inline ListQualityResultsByRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, ListQualityResultsByRuleResponseBodyData) };
    inline ListQualityResultsByRuleResponseBody& setData(const ListQualityResultsByRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListQualityResultsByRuleResponseBody& setData(ListQualityResultsByRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListQualityResultsByRuleResponseBodyData> data_ = nullptr;
    // The error code.
