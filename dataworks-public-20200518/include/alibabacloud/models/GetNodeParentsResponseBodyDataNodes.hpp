...
#ifndef ALIBABACLOUD_MODELS_GETNODEPARENTSRESPONSEBODYDATANODES_HPP_
#define ALIBABACLOUD_MODELS_GETNODEPARENTSRESPONSEBODYDATANODES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetNodeParentsResponseBodyDataNodes& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetNodeParentsResponseBodyDataNodes& obj) { 
    ...
    GetNodeParentsResponseBodyDataNodes() = default ;
    GetNodeParentsResponseBodyDataNodes(const GetNodeParentsResponseBodyDataNodes &) = default ;
    GetNodeParentsResponseBodyDataNodes(GetNodeParentsResponseBodyDataNodes &&) = default ;
    GetNodeParentsResponseBodyDataNodes(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetNodeParentsResponseBodyDataNodes() = default ;
    GetNodeParentsResponseBodyDataNodes& operator=(const GetNodeParentsResponseBodyDataNodes &) = default ;
    GetNodeParentsResponseBodyDataNodes& operator=(GetNodeParentsResponseBodyDataNodes &&) = default ;
    ...
    inline GetNodeParentsResponseBodyDataNodes& setBaselineId(int64_t baselineId) { DARABONBA_PTR_SET_VALUE(baselineId_, baselineId) };
    ...
    inline GetNodeParentsResponseBodyDataNodes& setCronExpress(string cronExpress) { DARABONBA_PTR_SET_VALUE(cronExpress_, cronExpress) };
    ...
    inline GetNodeParentsResponseBodyDataNodes& setNodeId(int64_t nodeId) { DARABONBA_PTR_SET_VALUE(nodeId_, nodeId) };
    ...
    inline GetNodeParentsResponseBodyDataNodes& setNodeName(string nodeName) { DARABONBA_PTR_SET_VALUE(nodeName_, nodeName) };
    ...
    inline GetNodeParentsResponseBodyDataNodes& setOwnerId(string ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline GetNodeParentsResponseBodyDataNodes& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline GetNodeParentsResponseBodyDataNodes& setProgramType(string programType) { DARABONBA_PTR_SET_VALUE(programType_, programType) };
    ...
    inline GetNodeParentsResponseBodyDataNodes& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline GetNodeParentsResponseBodyDataNodes& setRepeatability(bool repeatability) { DARABONBA_PTR_SET_VALUE(repeatability_, repeatability) };
    ...
    inline GetNodeParentsResponseBodyDataNodes& setSchedulerType(string schedulerType) { DARABONBA_PTR_SET_VALUE(schedulerType_, schedulerType) };
    ...
    inline GetNodeParentsResponseBodyDataNodes& setStepType(string stepType) { DARABONBA_PTR_SET_VALUE(stepType_, stepType) };
