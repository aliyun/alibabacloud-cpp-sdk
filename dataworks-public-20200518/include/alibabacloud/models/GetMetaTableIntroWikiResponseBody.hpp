...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableIntroWikiResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetaTableIntroWikiResponseBodyData) };
    inline GetMetaTableIntroWikiResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetaTableIntroWikiResponseBodyData) };
    inline GetMetaTableIntroWikiResponseBody& setData(const GetMetaTableIntroWikiResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaTableIntroWikiResponseBody& setData(GetMetaTableIntroWikiResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The business data.
    std::shared_ptr<GetMetaTableIntroWikiResponseBodyData> data_ = nullptr;
    // The error code.
