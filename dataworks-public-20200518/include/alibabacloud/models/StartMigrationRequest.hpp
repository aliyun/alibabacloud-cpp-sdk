...
#ifndef ALIBABACLOUD_MODELS_STARTMIGRATIONREQUEST_HPP_
#define ALIBABACLOUD_MODELS_STARTMIGRATIONREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartMigrationRequest& obj) { 
      DARABONBA_PTR_TO_JSON(MigrationId, migrationId_);
      DARABONBA_PTR_TO_JSON(ProjectId, projectId_);
    };
    friend void from_json(const Darabonba::Json& j, StartMigrationRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(MigrationId, migrationId_);
      DARABONBA_PTR_FROM_JSON(ProjectId, projectId_);
    };
    StartMigrationRequest() = default ;
    StartMigrationRequest(const StartMigrationRequest &) = default ;
    StartMigrationRequest(StartMigrationRequest &&) = default ;
    StartMigrationRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartMigrationRequest() = default ;
    StartMigrationRequest& operator=(const StartMigrationRequest &) = default ;
    StartMigrationRequest& operator=(StartMigrationRequest &&) = default ;
    ...
    inline StartMigrationRequest& setMigrationId(int64_t migrationId) { DARABONBA_PTR_SET_VALUE(migrationId_, migrationId) };
    ...
    inline StartMigrationRequest& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
