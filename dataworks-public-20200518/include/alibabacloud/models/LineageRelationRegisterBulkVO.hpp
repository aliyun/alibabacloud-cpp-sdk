...
namespace Models
{
  ...
  public:
    ...
    inline const vector<LineageEntityVO> & getDestEntities() const { DARABONBA_PTR_GET_CONST(destEntities_, vector<LineageEntityVO>) };
    inline vector<LineageEntityVO> getDestEntities() { DARABONBA_PTR_GET(destEntities_, vector<LineageEntityVO>) };
    ...
    inline const RelationshipVO & getRelationship() const { DARABONBA_PTR_GET_CONST(relationship_, RelationshipVO) };
    inline RelationshipVO getRelationship() { DARABONBA_PTR_GET(relationship_, RelationshipVO) };
    ...
    inline const vector<LineageEntityVO> & getSrcEntities() const { DARABONBA_PTR_GET_CONST(srcEntities_, vector<LineageEntityVO>) };
    inline vector<LineageEntityVO> getSrcEntities() { DARABONBA_PTR_GET(srcEntities_, vector<LineageEntityVO>) };
  ...
  protected:
    ...
    shared_ptr<vector<LineageEntityVO>> destEntities_ {};
    shared_ptr<RelationshipVO> relationship_ {};
    shared_ptr<vector<LineageEntityVO>> srcEntities_ {};
  };
