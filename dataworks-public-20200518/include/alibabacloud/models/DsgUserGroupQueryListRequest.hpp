...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->name_ == nullptr
        && this->owner_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->projectName_ == nullptr && this->userGroupType_ == nullptr; };
    ...
    inline DsgUserGroupQueryListRequest& setUserGroupType(int32_t userGroupType) { DARABONBA_PTR_SET_VALUE(userGroupType_, userGroupType) };
