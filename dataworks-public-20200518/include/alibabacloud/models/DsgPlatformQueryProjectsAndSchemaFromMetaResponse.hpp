...
namespace Models
{
  ...
  public:
    ...
    inline const DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody) };
    inline DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody getBody() { DARABONBA_PTR_GET(body_, DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DsgPlatformQueryProjectsAndSchemaFromMetaResponseBody> body_ {};
  };
