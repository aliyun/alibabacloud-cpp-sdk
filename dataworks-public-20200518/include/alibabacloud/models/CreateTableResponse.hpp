...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTableResponseBody) };
    inline CreateTableResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTableResponseBody> body_ {};
  };
