...
namespace Models
{
  ...
  public:
    ...
    inline const ListTopicsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListTopicsResponseBodyData) };
    inline ListTopicsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListTopicsResponseBodyData) };
    inline ListTopicsResponseBody& setData(const ListTopicsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTopicsResponseBody& setData(ListTopicsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListTopicsResponseBodyData> data_ = nullptr;
