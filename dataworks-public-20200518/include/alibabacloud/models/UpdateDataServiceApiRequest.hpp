...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->apiDescription_ == nullptr
    ...
    inline string getApiDescription() const { DARABONBA_PTR_GET_DEFAULT(apiDescription_, "") };
    ...
    inline string getProtocols() const { DARABONBA_PTR_GET_DEFAULT(protocols_, "") };
    ...
    inline string getRegistrationDetails() const { DARABONBA_PTR_GET_DEFAULT(registrationDetails_, "") };
    ...
    inline string getScriptDetails() const { DARABONBA_PTR_GET_DEFAULT(scriptDetails_, "") };
    ...
    inline string getWizardDetails() const { DARABONBA_PTR_GET_DEFAULT(wizardDetails_, "") };
  ...
  protected:
    ...
    shared_ptr<string> apiDescription_ {};
    // The ID of the API.
    // 
    // This parameter is required.
    ...
    shared_ptr<string> registrationDetails_ {};
    ...
    shared_ptr<string> scriptDetails_ {};
    ...
    shared_ptr<string> wizardDetails_ {};
  };
