...
namespace Models
{
  ...
  public:
    ...
    inline CreateDIJobRequestDestinationDataSourceSettings& setDataSourceProperties(const map<string, string> & dataSourceProperties) { DARABONBA_PTR_SET_VALUE(dataSourceProperties_, dataSourceProperties) };
    inline CreateDIJobRequestDestinationDataSourceSettings& setDataSourceProperties(map<string, string> && dataSourceProperties) { DARABONBA_PTR_SET_RVALUE(dataSourceProperties_, dataSourceProperties) };
