...
namespace Models
{
  ...
  public:
    ...
    inline const ListBusinessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListBusinessResponseBody) };
    inline ListBusinessResponseBody getBody() { DARABONBA_PTR_GET(body_, ListBusinessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListBusinessResponseBody> body_ {};
  };
