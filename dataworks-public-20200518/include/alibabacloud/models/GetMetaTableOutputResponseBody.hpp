...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableOutputResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetaTableOutputResponseBodyData) };
    inline GetMetaTableOutputResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetaTableOutputResponseBodyData) };
    inline GetMetaTableOutputResponseBody& setData(const GetMetaTableOutputResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaTableOutputResponseBody& setData(GetMetaTableOutputResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The business data.
    std::shared_ptr<GetMetaTableOutputResponseBodyData> data_ = nullptr;
    // The error code.
