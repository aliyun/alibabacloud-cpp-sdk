...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->esMetaParamsShrink_ == nullptr
    ...
    inline string getEsMetaParamsShrink() const { DARABONBA_PTR_GET_DEFAULT(esMetaParamsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> esMetaParamsShrink_ {};
