...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTableThemeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTableThemeResponseBody) };
    inline DeleteTableThemeResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTableThemeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTableThemeResponseBody> body_ {};
  };
