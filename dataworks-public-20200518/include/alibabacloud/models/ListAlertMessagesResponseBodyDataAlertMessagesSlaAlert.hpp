...
#ifndef ALIBABACLOUD_MODELS_LISTALERTMESSAGESRESPONSEBODYDATAALERTMESSAGESSLAALERT_HPP_
#define ALIBABACLOUD_MODELS_LISTALERTMESSAGESRESPONSEBODYDATAALERTMESSAGESSLAALERT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert& obj) { 
    ...
    ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert() = default ;
    ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert(const ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert &) = default ;
    ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert(ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert &&) = default ;
    ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert() = default ;
    ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert& operator=(const ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert &) = default ;
    ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert& operator=(ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert &&) = default ;
    ...
    inline ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert& setBaselineId(int64_t baselineId) { DARABONBA_PTR_SET_VALUE(baselineId_, baselineId) };
    ...
    inline ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert& setBaselineName(string baselineName) { DARABONBA_PTR_SET_VALUE(baselineName_, baselineName) };
    ...
    inline ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert& setBaselineOwner(string baselineOwner) { DARABONBA_PTR_SET_VALUE(baselineOwner_, baselineOwner) };
    ...
    inline ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert& setBizdate(int64_t bizdate) { DARABONBA_PTR_SET_VALUE(bizdate_, bizdate) };
    ...
    inline ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert& setInGroupId(int32_t inGroupId) { DARABONBA_PTR_SET_VALUE(inGroupId_, inGroupId) };
    ...
    inline ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline ListAlertMessagesResponseBodyDataAlertMessagesSlaAlert& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
