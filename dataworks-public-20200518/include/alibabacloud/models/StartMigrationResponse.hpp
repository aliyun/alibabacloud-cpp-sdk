...
namespace Models
{
  ...
  public:
    ...
    inline const StartMigrationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartMigrationResponseBody) };
    inline StartMigrationResponseBody getBody() { DARABONBA_PTR_GET(body_, StartMigrationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartMigrationResponseBody> body_ {};
  };
