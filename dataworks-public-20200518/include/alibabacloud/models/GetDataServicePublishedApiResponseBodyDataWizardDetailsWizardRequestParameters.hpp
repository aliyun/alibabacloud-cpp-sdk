...
#ifndef ALIBABACLOUD_MODELS_GETDATASERVICEPUBLISHEDAPIRESPONSEBODYDATAWIZARDDETAILSWIZARDREQUESTPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_GETDATASERVICEPUBLISHEDAPIRESPONSEBODYDATAWIZARDDETAILSWIZARDREQUESTPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& obj) { 
    ...
    GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters() = default ;
    GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters(const GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters &) = default ;
    GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters(GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters &&) = default ;
    GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters() = default ;
    GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& operator=(const GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters &) = default ;
    GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& operator=(GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters &&) = default ;
    ...
    inline GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& setExampleValue(string exampleValue) { DARABONBA_PTR_SET_VALUE(exampleValue_, exampleValue) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& setIsRequiredParameter(bool isRequiredParameter) { DARABONBA_PTR_SET_VALUE(isRequiredParameter_, isRequiredParameter) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& setParameterDataType(int32_t parameterDataType) { DARABONBA_PTR_SET_VALUE(parameterDataType_, parameterDataType) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& setParameterDescription(string parameterDescription) { DARABONBA_PTR_SET_VALUE(parameterDescription_, parameterDescription) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& setParameterName(string parameterName) { DARABONBA_PTR_SET_VALUE(parameterName_, parameterName) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& setParameterOperator(int32_t parameterOperator) { DARABONBA_PTR_SET_VALUE(parameterOperator_, parameterOperator) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataWizardDetailsWizardRequestParameters& setParameterPosition(int32_t parameterPosition) { DARABONBA_PTR_SET_VALUE(parameterPosition_, parameterPosition) };
