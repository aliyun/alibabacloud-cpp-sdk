...
namespace Models
{
  ...
  public:
    ...
    inline const DsgWhiteListQueryListResponseBodyPageData & pageData() const { DARABONBA_PTR_GET_CONST(pageData_, DsgWhiteListQueryListResponseBodyPageData) };
    inline DsgWhiteListQueryListResponseBodyPageData pageData() { DARABONBA_PTR_GET(pageData_, DsgWhiteListQueryListResponseBodyPageData) };
    inline DsgWhiteListQueryListResponseBody& setPageData(const DsgWhiteListQueryListResponseBodyPageData & pageData) { DARABONBA_PTR_SET_VALUE(pageData_, pageData) };
    inline DsgWhiteListQueryListResponseBody& setPageData(DsgWhiteListQueryListResponseBodyPageData && pageData) { DARABONBA_PTR_SET_RVALUE(pageData_, pageData) };
  ...
  protected:
    ...
    std::shared_ptr<DsgWhiteListQueryListResponseBodyPageData> pageData_ = nullptr;
