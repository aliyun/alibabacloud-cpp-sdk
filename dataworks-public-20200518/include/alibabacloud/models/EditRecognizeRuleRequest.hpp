...
#ifndef ALIBABACLOUD_MODELS_EDITRECOGNIZERULEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_EDITRECOGNIZERULEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const EditRecognizeRuleRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EditRecognizeRuleRequest& obj) { 
    ...
    EditRecognizeRuleRequest() = default ;
    EditRecognizeRuleRequest(const EditRecognizeRuleRequest &) = default ;
    EditRecognizeRuleRequest(EditRecognizeRuleRequest &&) = default ;
    EditRecognizeRuleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EditRecognizeRuleRequest() = default ;
    EditRecognizeRuleRequest& operator=(const EditRecognizeRuleRequest &) = default ;
    EditRecognizeRuleRequest& operator=(EditRecognizeRuleRequest &&) = default ;
    ...
    virtual bool empty() const override { this->accountName_ != nullptr
        ...
        && this->levelName_ != nullptr && this->nodeId_ != nullptr && this->nodeParent_ != nullptr && this->operationType_ != nullptr && this->recognizeRules_ != nullptr
        && this->recognizeRulesType_ != nullptr && this->sensitiveDescription_ != nullptr && this->sensitiveId_ != nullptr && this->sensitiveName_ != nullptr && this->status_ != nullptr
        && this->templateId_ != nullptr && this->tenantId_ != nullptr && this->level_ != nullptr; };
    // accountName Field Functions 
    bool hasAccountName() const { return this->accountName_ != nullptr;};
    void deleteAccountName() { this->accountName_ = nullptr;};
    inline string accountName() const { DARABONBA_PTR_GET_DEFAULT(accountName_, "") };
    inline EditRecognizeRuleRequest& setAccountName(string accountName) { DARABONBA_PTR_SET_VALUE(accountName_, accountName) };
    ...
    inline EditRecognizeRuleRequest& setColExclude(string colExclude) { DARABONBA_PTR_SET_VALUE(colExclude_, colExclude) };
    ...
    inline EditRecognizeRuleRequest& setColScan(string colScan) { DARABONBA_PTR_SET_VALUE(colScan_, colScan) };
    ...
    inline EditRecognizeRuleRequest& setCommentScan(string commentScan) { DARABONBA_PTR_SET_VALUE(commentScan_, commentScan) };
    ...
    inline EditRecognizeRuleRequest& setContentScan(string contentScan) { DARABONBA_PTR_SET_VALUE(contentScan_, contentScan) };
    ...
    inline EditRecognizeRuleRequest& setHitThreshold(int32_t hitThreshold) { DARABONBA_PTR_SET_VALUE(hitThreshold_, hitThreshold) };
    ...
    inline EditRecognizeRuleRequest& setLevelName(string levelName) { DARABONBA_PTR_SET_VALUE(levelName_, levelName) };
    ...
    inline EditRecognizeRuleRequest& setNodeId(string nodeId) { DARABONBA_PTR_SET_VALUE(nodeId_, nodeId) };
    ...
    inline EditRecognizeRuleRequest& setNodeParent(string nodeParent) { DARABONBA_PTR_SET_VALUE(nodeParent_, nodeParent) };
    ...
    inline EditRecognizeRuleRequest& setOperationType(int32_t operationType) { DARABONBA_PTR_SET_VALUE(operationType_, operationType) };
    ...
    inline EditRecognizeRuleRequest& setRecognizeRules(string recognizeRules) { DARABONBA_PTR_SET_VALUE(recognizeRules_, recognizeRules) };
    ...
    inline EditRecognizeRuleRequest& setRecognizeRulesType(string recognizeRulesType) { DARABONBA_PTR_SET_VALUE(recognizeRulesType_, recognizeRulesType) };
    ...
    inline EditRecognizeRuleRequest& setSensitiveDescription(string sensitiveDescription) { DARABONBA_PTR_SET_VALUE(sensitiveDescription_, sensitiveDescription) };
    ...
    inline EditRecognizeRuleRequest& setSensitiveId(string sensitiveId) { DARABONBA_PTR_SET_VALUE(sensitiveId_, sensitiveId) };
    ...
    inline EditRecognizeRuleRequest& setSensitiveName(string sensitiveName) { DARABONBA_PTR_SET_VALUE(sensitiveName_, sensitiveName) };
    ...
    inline EditRecognizeRuleRequest& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline EditRecognizeRuleRequest& setTemplateId(string templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
    ...
    inline EditRecognizeRuleRequest& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
    ...
    inline EditRecognizeRuleRequest& setLevel(string level) { DARABONBA_PTR_SET_VALUE(level_, level) };
