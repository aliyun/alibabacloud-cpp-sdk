...
#ifndef ALIBABACLOUD_MODELS_UPDATETABLERESPONSEBODYTASKINFO_HPP_
#define ALIBABACLOUD_MODELS_UPDATETABLERESPONSEBODYTASKINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateTableResponseBodyTaskInfo& obj) { 
      DARABONBA_PTR_TO_JSON(Content, content_);
      DARABONBA_PTR_TO_JSON(NextTaskId, nextTaskId_);
      DARABONBA_PTR_TO_JSON(Status, status_);
      DARABONBA_PTR_TO_JSON(TaskId, taskId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateTableResponseBodyTaskInfo& obj) { 
      DARABONBA_PTR_FROM_JSON(Content, content_);
      DARABONBA_PTR_FROM_JSON(NextTaskId, nextTaskId_);
      DARABONBA_PTR_FROM_JSON(Status, status_);
      DARABONBA_PTR_FROM_JSON(TaskId, taskId_);
    };
    UpdateTableResponseBodyTaskInfo() = default ;
    UpdateTableResponseBodyTaskInfo(const UpdateTableResponseBodyTaskInfo &) = default ;
    UpdateTableResponseBodyTaskInfo(UpdateTableResponseBodyTaskInfo &&) = default ;
    UpdateTableResponseBodyTaskInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateTableResponseBodyTaskInfo() = default ;
    UpdateTableResponseBodyTaskInfo& operator=(const UpdateTableResponseBodyTaskInfo &) = default ;
    UpdateTableResponseBodyTaskInfo& operator=(UpdateTableResponseBodyTaskInfo &&) = default ;
    ...
    inline UpdateTableResponseBodyTaskInfo& setContent(string content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    ...
    inline UpdateTableResponseBodyTaskInfo& setNextTaskId(string nextTaskId) { DARABONBA_PTR_SET_VALUE(nextTaskId_, nextTaskId) };
    ...
    inline UpdateTableResponseBodyTaskInfo& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline UpdateTableResponseBodyTaskInfo& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
