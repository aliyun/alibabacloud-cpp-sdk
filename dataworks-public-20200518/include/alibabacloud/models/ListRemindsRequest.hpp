...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alertTarget_ == nullptr
    ...
    inline string getAlertTarget() const { DARABONBA_PTR_GET_DEFAULT(alertTarget_, "") };
    ...
    inline string getRemindTypes() const { DARABONBA_PTR_GET_DEFAULT(remindTypes_, "") };
  ...
  protected:
    ...
    shared_ptr<string> alertTarget_ {};
    ...
    shared_ptr<string> remindTypes_ {};
