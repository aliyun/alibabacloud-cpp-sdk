...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDISyncTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDISyncTaskResponseBody) };
    inline CreateDISyncTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDISyncTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDISyncTaskResponseBody> body_ {};
  };
