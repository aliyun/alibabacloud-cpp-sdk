...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetQualityEntityResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetQualityEntityResponseBodyData>) };
    inline vector<GetQualityEntityResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetQualityEntityResponseBodyData>) };
    inline GetQualityEntityResponseBody& setData(const vector<GetQualityEntityResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualityEntityResponseBody& setData(vector<GetQualityEntityResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetQualityEntityResponseBodyData>> data_ = nullptr;
