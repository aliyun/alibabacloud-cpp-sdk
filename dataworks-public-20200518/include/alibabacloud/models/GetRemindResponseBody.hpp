...
namespace Models
{
  ...
  public:
    ...
    inline const GetRemindResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetRemindResponseBodyData) };
    inline GetRemindResponseBodyData data() { DARABONBA_PTR_GET(data_, GetRemindResponseBodyData) };
    inline GetRemindResponseBody& setData(const GetRemindResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetRemindResponseBody& setData(GetRemindResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetRemindResponseBodyData> data_ = nullptr;
    // The error code.
