...
#ifndef ALIBABACLOUD_MODELS_GETBASELINECONFIGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETBASELINECONFIGRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetBaselineConfigResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetBaselineConfigResponseBody& obj) { 
    ...
    GetBaselineConfigResponseBody() = default ;
    GetBaselineConfigResponseBody(const GetBaselineConfigResponseBody &) = default ;
    GetBaselineConfigResponseBody(GetBaselineConfigResponseBody &&) = default ;
    GetBaselineConfigResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetBaselineConfigResponseBody() = default ;
    GetBaselineConfigResponseBody& operator=(const GetBaselineConfigResponseBody &) = default ;
    GetBaselineConfigResponseBody& operator=(GetBaselineConfigResponseBody &&) = default ;
    ...
    public:
      ...
      inline Data& setExpHour(int32_t expHour) { DARABONBA_PTR_SET_VALUE(expHour_, expHour) };
      ...
      inline Data& setExpMinu(int32_t expMinu) { DARABONBA_PTR_SET_VALUE(expMinu_, expMinu) };
      ...
      inline Data& setHourExpDetail(string hourExpDetail) { DARABONBA_PTR_SET_VALUE(hourExpDetail_, hourExpDetail) };
      ...
      inline Data& setHourSlaDetail(string hourSlaDetail) { DARABONBA_PTR_SET_VALUE(hourSlaDetail_, hourSlaDetail) };
      ...
      inline Data& setSlaHour(int32_t slaHour) { DARABONBA_PTR_SET_VALUE(slaHour_, slaHour) };
      ...
      inline Data& setSlaMinu(int32_t slaMinu) { DARABONBA_PTR_SET_VALUE(slaMinu_, slaMinu) };
    ...
    inline const GetBaselineConfigResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetBaselineConfigResponseBody::Data) };
    inline GetBaselineConfigResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetBaselineConfigResponseBody::Data) };
    inline GetBaselineConfigResponseBody& setData(const GetBaselineConfigResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetBaselineConfigResponseBody& setData(GetBaselineConfigResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetBaselineConfigResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };
    ...
    inline GetBaselineConfigResponseBody& setErrorMessage(string errorMessage) { DARABONBA_PTR_SET_VALUE(errorMessage_, errorMessage) };
    ...
    inline GetBaselineConfigResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetBaselineConfigResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetBaselineConfigResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The details of the baseline.
    shared_ptr<GetBaselineConfigResponseBody::Data> data_ {};
    // The error code.
