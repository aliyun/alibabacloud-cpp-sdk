...
namespace Models
{
  ...
  public:
    ...
    inline CreateConnectionResponseBody& setData(int64_t data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline CreateConnectionResponseBody& setHttpStatusCode(string httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateConnectionResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
