...
namespace Models
{
  ...
  public:
    ...
    inline const GetNodeChildrenResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetNodeChildrenResponseBody::Data) };
    inline GetNodeChildrenResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetNodeChildrenResponseBody::Data) };
    inline GetNodeChildrenResponseBody& setData(const GetNodeChildrenResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetNodeChildrenResponseBody& setData(GetNodeChildrenResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<GetNodeChildrenResponseBody::Data> data_ {};
    // The error code.
