...
namespace Models
{
  ...
  public:
    ...
    inline const TestDataServiceApiResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TestDataServiceApiResponseBody) };
    inline TestDataServiceApiResponseBody getBody() { DARABONBA_PTR_GET(body_, TestDataServiceApiResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TestDataServiceApiResponseBody> body_ {};
  };
