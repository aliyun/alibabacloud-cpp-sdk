...
namespace Models
{
  ...
  public:
    ...
    inline shared_ptr<Darabonba::IStream> getPackageFileObject() const { DARABONBA_GET(packageFileObject_) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<Darabonba::IStream> packageFileObject_ {};
