...
#ifndef ALIBABACLOUD_MODELS_CREATEIMPORTMIGRATIONADVANCEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEIMPORTMIGRATIONADVANCEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateImportMigrationAdvanceRequest& obj) { 
      DARABONBA_PTR_TO_JSON(CalculateEngineMap, calculateEngineMap_);
      DARABONBA_PTR_TO_JSON(CommitRule, commitRule_);
      DARABONBA_PTR_TO_JSON(Description, description_);
      DARABONBA_PTR_TO_JSON(Name, name_);
      DARABONBA_TO_JSON(PackageFile, packageFileObject_);
    ...
    friend void from_json(const Darabonba::Json& j, CreateImportMigrationAdvanceRequest& obj) { 
      ...
      DARABONBA_FROM_JSON(PackageFile, packageFileObject_);
    ...
    CreateImportMigrationAdvanceRequest() = default ;
    CreateImportMigrationAdvanceRequest(const CreateImportMigrationAdvanceRequest &) = default ;
    CreateImportMigrationAdvanceRequest(CreateImportMigrationAdvanceRequest &&) = default ;
    CreateImportMigrationAdvanceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateImportMigrationAdvanceRequest() = default ;
    CreateImportMigrationAdvanceRequest& operator=(const CreateImportMigrationAdvanceRequest &) = default ;
    CreateImportMigrationAdvanceRequest& operator=(CreateImportMigrationAdvanceRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->calculateEngineMap_ != nullptr
        && this->commitRule_ != nullptr && this->description_ != nullptr && this->name_ != nullptr && this->packageFileObject_ != nullptr && this->packageType_ != nullptr
    ...
    inline CreateImportMigrationAdvanceRequest& setCalculateEngineMap(string calculateEngineMap) { DARABONBA_PTR_SET_VALUE(calculateEngineMap_, calculateEngineMap) };
    ...
    inline CreateImportMigrationAdvanceRequest& setCommitRule(string commitRule) { DARABONBA_PTR_SET_VALUE(commitRule_, commitRule) };
    ...
    inline CreateImportMigrationAdvanceRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreateImportMigrationAdvanceRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };


    // packageFileObject Field Functions 
    bool hasPackageFileObject() const { return this->packageFileObject_ != nullptr;};
    void deletePackageFileObject() { this->packageFileObject_ = nullptr;};
    inline shared_ptr<Darabonba::IStream> packageFileObject() const { DARABONBA_GET(packageFileObject_) };
    inline CreateImportMigrationAdvanceRequest& setPackageFileObject(shared_ptr<Darabonba::IStream> packageFileObject) { DARABONBA_SET_VALUE(packageFileObject_, packageFileObject) };
    ...
    inline CreateImportMigrationAdvanceRequest& setPackageType(string packageType) { DARABONBA_PTR_SET_VALUE(packageType_, packageType) };
    ...
    inline CreateImportMigrationAdvanceRequest& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline CreateImportMigrationAdvanceRequest& setResourceGroupMap(string resourceGroupMap) { DARABONBA_PTR_SET_VALUE(resourceGroupMap_, resourceGroupMap) };
    ...
    inline CreateImportMigrationAdvanceRequest& setWorkspaceMap(string workspaceMap) { DARABONBA_PTR_SET_VALUE(workspaceMap_, workspaceMap) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<Darabonba::IStream> packageFileObject_ = nullptr;
