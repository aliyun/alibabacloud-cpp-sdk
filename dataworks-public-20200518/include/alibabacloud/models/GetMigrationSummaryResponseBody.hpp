...
namespace Models
{
  ...
  public:
    ...
    inline const GetMigrationSummaryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMigrationSummaryResponseBodyData) };
    inline GetMigrationSummaryResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMigrationSummaryResponseBodyData) };
    inline GetMigrationSummaryResponseBody& setData(const GetMigrationSummaryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMigrationSummaryResponseBody& setData(GetMigrationSummaryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetMigrationSummaryResponseBodyData> data_ = nullptr;
