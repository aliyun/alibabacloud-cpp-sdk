...
namespace Models
{
  ...
  public:
    ...
    inline const ListEntitiesByTagsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListEntitiesByTagsResponseBodyData) };
    inline ListEntitiesByTagsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListEntitiesByTagsResponseBodyData) };
    inline ListEntitiesByTagsResponseBody& setData(const ListEntitiesByTagsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEntitiesByTagsResponseBody& setData(ListEntitiesByTagsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListEntitiesByTagsResponseBodyData> data_ = nullptr;
    // The error code.
