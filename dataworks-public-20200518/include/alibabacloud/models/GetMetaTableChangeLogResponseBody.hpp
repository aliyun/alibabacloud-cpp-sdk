...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableChangeLogResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetaTableChangeLogResponseBodyData) };
    inline GetMetaTableChangeLogResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetaTableChangeLogResponseBodyData) };
    inline GetMetaTableChangeLogResponseBody& setData(const GetMetaTableChangeLogResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaTableChangeLogResponseBody& setData(GetMetaTableChangeLogResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The business data.
    std::shared_ptr<GetMetaTableChangeLogResponseBodyData> data_ = nullptr;
    // The error code.
