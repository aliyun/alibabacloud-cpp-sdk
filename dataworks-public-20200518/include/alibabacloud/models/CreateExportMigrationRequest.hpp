...
namespace Models
{
  ...
  public:
    ...
    inline string getExportObjectStatus() const { DARABONBA_PTR_GET_DEFAULT(exportObjectStatus_, "") };
    ...
    inline int64_t getIncrementalSince() const { DARABONBA_PTR_GET_DEFAULT(incrementalSince_, 0L) };
  ...
  protected:
    ...
    // *   SUBMITTED
    // *   DEPLOYED
    shared_ptr<string> exportObjectStatus_ {};
    ...
    shared_ptr<int64_t> incrementalSince_ {};
