...
namespace Models
{
  ...
  public:
    ...
    inline const ListRemindsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRemindsResponseBody) };
    inline ListRemindsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRemindsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRemindsResponseBody> body_ {};
  };
