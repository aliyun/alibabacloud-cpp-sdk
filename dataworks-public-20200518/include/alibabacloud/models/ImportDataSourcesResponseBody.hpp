...
namespace Models
{
  ...
  public:
    ...
    inline const ImportDataSourcesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ImportDataSourcesResponseBodyData) };
    inline ImportDataSourcesResponseBodyData data() { DARABONBA_PTR_GET(data_, ImportDataSourcesResponseBodyData) };
    inline ImportDataSourcesResponseBody& setData(const ImportDataSourcesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ImportDataSourcesResponseBody& setData(ImportDataSourcesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ImportDataSourcesResponseBodyData> data_ = nullptr;
