...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceCountTrendResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceCountTrendResponseBody) };
    inline GetInstanceCountTrendResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceCountTrendResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceCountTrendResponseBody> body_ {};
  };
