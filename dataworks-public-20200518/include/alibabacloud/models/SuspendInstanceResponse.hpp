...
namespace Models
{
  ...
  public:
    ...
    inline const SuspendInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SuspendInstanceResponseBody) };
    inline SuspendInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, SuspendInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SuspendInstanceResponseBody> body_ {};
  };
