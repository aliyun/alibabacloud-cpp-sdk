...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->asyncProcessId_ == nullptr
    ...
    inline int64_t getAsyncProcessId() const { DARABONBA_PTR_GET_DEFAULT(asyncProcessId_, 0L) };
  ...
  protected:
    ...
    shared_ptr<int64_t> asyncProcessId_ {};
