...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataServiceFolderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDataServiceFolderResponseBody) };
    inline CreateDataServiceFolderResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDataServiceFolderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDataServiceFolderResponseBody> body_ {};
  };
