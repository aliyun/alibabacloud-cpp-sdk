...
namespace Models
{
  ...
  public:
    ...
    inline const GetNodeChildrenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetNodeChildrenResponseBody) };
    inline GetNodeChildrenResponseBody getBody() { DARABONBA_PTR_GET(body_, GetNodeChildrenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetNodeChildrenResponseBody> body_ {};
  };
