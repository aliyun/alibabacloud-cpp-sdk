...
namespace Models
{
  ...
  public:
    ...
    inline const TopTenErrorTimesInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TopTenErrorTimesInstanceResponseBody) };
    inline TopTenErrorTimesInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, TopTenErrorTimesInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TopTenErrorTimesInstanceResponseBody> body_ {};
  };
