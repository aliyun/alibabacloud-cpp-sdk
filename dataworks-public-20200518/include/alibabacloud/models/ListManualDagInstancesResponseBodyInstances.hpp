...
#ifndef ALIBABACLOUD_MODELS_LISTMANUALDAGINSTANCESRESPONSEBODYINSTANCES_HPP_
#define ALIBABACLOUD_MODELS_LISTMANUALDAGINSTANCESRESPONSEBODYINSTANCES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListManualDagInstancesResponseBodyInstances& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListManualDagInstancesResponseBodyInstances& obj) { 
    ...
    ListManualDagInstancesResponseBodyInstances() = default ;
    ListManualDagInstancesResponseBodyInstances(const ListManualDagInstancesResponseBodyInstances &) = default ;
    ListManualDagInstancesResponseBodyInstances(ListManualDagInstancesResponseBodyInstances &&) = default ;
    ListManualDagInstancesResponseBodyInstances(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListManualDagInstancesResponseBodyInstances() = default ;
    ListManualDagInstancesResponseBodyInstances& operator=(const ListManualDagInstancesResponseBodyInstances &) = default ;
    ListManualDagInstancesResponseBodyInstances& operator=(ListManualDagInstancesResponseBodyInstances &&) = default ;
    ...
    inline ListManualDagInstancesResponseBodyInstances& setBeginRunningTime(int64_t beginRunningTime) { DARABONBA_PTR_SET_VALUE(beginRunningTime_, beginRunningTime) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setBeginWaitResTime(int64_t beginWaitResTime) { DARABONBA_PTR_SET_VALUE(beginWaitResTime_, beginWaitResTime) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setBeginWaitTimeTime(int64_t beginWaitTimeTime) { DARABONBA_PTR_SET_VALUE(beginWaitTimeTime_, beginWaitTimeTime) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setBizDate(int64_t bizDate) { DARABONBA_PTR_SET_VALUE(bizDate_, bizDate) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setCreateUser(string createUser) { DARABONBA_PTR_SET_VALUE(createUser_, createUser) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setCycTime(int64_t cycTime) { DARABONBA_PTR_SET_VALUE(cycTime_, cycTime) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setDagId(int64_t dagId) { DARABONBA_PTR_SET_VALUE(dagId_, dagId) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setDagType(string dagType) { DARABONBA_PTR_SET_VALUE(dagType_, dagType) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setFinishTime(int64_t finishTime) { DARABONBA_PTR_SET_VALUE(finishTime_, finishTime) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setInstanceId(int64_t instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setModifyTime(int64_t modifyTime) { DARABONBA_PTR_SET_VALUE(modifyTime_, modifyTime) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setNodeId(int64_t nodeId) { DARABONBA_PTR_SET_VALUE(nodeId_, nodeId) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setNodeName(string nodeName) { DARABONBA_PTR_SET_VALUE(nodeName_, nodeName) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setParamValues(string paramValues) { DARABONBA_PTR_SET_VALUE(paramValues_, paramValues) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListManualDagInstancesResponseBodyInstances& setTaskType(string taskType) { DARABONBA_PTR_SET_VALUE(taskType_, taskType) };
