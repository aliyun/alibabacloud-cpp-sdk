...
namespace Models
{
  ...
  public:
    ...
    inline const TestNetworkConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TestNetworkConnectionResponseBody) };
    inline TestNetworkConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, TestNetworkConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TestNetworkConnectionResponseBody> body_ {};
  };
