...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualityRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQualityRuleResponseBodyData) };
    inline GetQualityRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQualityRuleResponseBodyData) };
    inline GetQualityRuleResponseBody& setData(const GetQualityRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualityRuleResponseBody& setData(GetQualityRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQualityRuleResponseBodyData> data_ = nullptr;
    // The error code.
