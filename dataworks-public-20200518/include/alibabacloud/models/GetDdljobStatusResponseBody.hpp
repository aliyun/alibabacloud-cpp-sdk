...
namespace Models
{
  ...
  public:
    ...
    inline const GetDDLJobStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDDLJobStatusResponseBodyData) };
    inline GetDDLJobStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDDLJobStatusResponseBodyData) };
    inline GetDDLJobStatusResponseBody& setData(const GetDDLJobStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDDLJobStatusResponseBody& setData(GetDDLJobStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDDLJobStatusResponseBodyData> data_ = nullptr;
    // The request ID.
