...
#ifndef ALIBABACLOUD_MODELS_LISTDATASERVICEAPISRESPONSEBODYDATAAPISSCRIPTDETAILSSCRIPTREQUESTPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_LISTDATASERVICEAPISRESPONSEBODYDATAAPISSCRIPTDETAILSSCRIPTREQUESTPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& obj) { 
    ...
    ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters() = default ;
    ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters(const ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters &) = default ;
    ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters(ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters &&) = default ;
    ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters() = default ;
    ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& operator=(const ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters &) = default ;
    ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& operator=(ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters &&) = default ;
    ...
    inline ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setColumnName(string columnName) { DARABONBA_PTR_SET_VALUE(columnName_, columnName) };
    ...
    inline ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setExampleValue(string exampleValue) { DARABONBA_PTR_SET_VALUE(exampleValue_, exampleValue) };
    ...
    inline ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setIsRequiredParameter(bool isRequiredParameter) { DARABONBA_PTR_SET_VALUE(isRequiredParameter_, isRequiredParameter) };
    ...
    inline ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setParameterDataType(int32_t parameterDataType) { DARABONBA_PTR_SET_VALUE(parameterDataType_, parameterDataType) };
    ...
    inline ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setParameterDescription(string parameterDescription) { DARABONBA_PTR_SET_VALUE(parameterDescription_, parameterDescription) };
    ...
    inline ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setParameterName(string parameterName) { DARABONBA_PTR_SET_VALUE(parameterName_, parameterName) };
    ...
    inline ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setParameterOperator(int32_t parameterOperator) { DARABONBA_PTR_SET_VALUE(parameterOperator_, parameterOperator) };
    ...
    inline ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters& setParameterPosition(int32_t parameterPosition) { DARABONBA_PTR_SET_VALUE(parameterPosition_, parameterPosition) };
