...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ClusterConfig> & getConfigValues() const { DARABONBA_PTR_GET_CONST(configValues_, vector<ClusterConfig>) };
    inline vector<ClusterConfig> getConfigValues() { DARABONBA_PTR_GET(configValues_, vector<ClusterConfig>) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<ClusterConfig>> configValues_ {};
