...
namespace Models
{
  ...
  public:
    ...
    inline const GetMigrationSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMigrationSummaryResponseBody) };
    inline GetMigrationSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMigrationSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMigrationSummaryResponseBody> body_ {};
  };
