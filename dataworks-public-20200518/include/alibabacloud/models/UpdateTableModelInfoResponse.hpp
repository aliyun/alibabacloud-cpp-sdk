...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTableModelInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTableModelInfoResponseBody) };
    inline UpdateTableModelInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTableModelInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTableModelInfoResponseBody> body_ {};
  };
