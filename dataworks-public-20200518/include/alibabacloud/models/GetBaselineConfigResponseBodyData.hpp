...
#ifndef ALIBABACLOUD_MODELS_GETBASELINECONFIGRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETBASELINECONFIGRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetBaselineConfigResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetBaselineConfigResponseBodyData& obj) { 
    ...
    GetBaselineConfigResponseBodyData() = default ;
    GetBaselineConfigResponseBodyData(const GetBaselineConfigResponseBodyData &) = default ;
    GetBaselineConfigResponseBodyData(GetBaselineConfigResponseBodyData &&) = default ;
    GetBaselineConfigResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetBaselineConfigResponseBodyData() = default ;
    GetBaselineConfigResponseBodyData& operator=(const GetBaselineConfigResponseBodyData &) = default ;
    GetBaselineConfigResponseBodyData& operator=(GetBaselineConfigResponseBodyData &&) = default ;
    ...
    inline GetBaselineConfigResponseBodyData& setBaselineId(int64_t baselineId) { DARABONBA_PTR_SET_VALUE(baselineId_, baselineId) };
    ...
    inline GetBaselineConfigResponseBodyData& setBaselineName(string baselineName) { DARABONBA_PTR_SET_VALUE(baselineName_, baselineName) };
    ...
    inline GetBaselineConfigResponseBodyData& setBaselineType(string baselineType) { DARABONBA_PTR_SET_VALUE(baselineType_, baselineType) };
    ...
    inline GetBaselineConfigResponseBodyData& setExpHour(int32_t expHour) { DARABONBA_PTR_SET_VALUE(expHour_, expHour) };
    ...
    inline GetBaselineConfigResponseBodyData& setExpMinu(int32_t expMinu) { DARABONBA_PTR_SET_VALUE(expMinu_, expMinu) };
    ...
    inline GetBaselineConfigResponseBodyData& setHourExpDetail(string hourExpDetail) { DARABONBA_PTR_SET_VALUE(hourExpDetail_, hourExpDetail) };
    ...
    inline GetBaselineConfigResponseBodyData& setHourSlaDetail(string hourSlaDetail) { DARABONBA_PTR_SET_VALUE(hourSlaDetail_, hourSlaDetail) };
    ...
    inline GetBaselineConfigResponseBodyData& setIsDefault(bool isDefault) { DARABONBA_PTR_SET_VALUE(isDefault_, isDefault) };
    ...
    inline GetBaselineConfigResponseBodyData& setOwner(string owner) { DARABONBA_PTR_SET_VALUE(owner_, owner) };
    ...
    inline GetBaselineConfigResponseBodyData& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline GetBaselineConfigResponseBodyData& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline GetBaselineConfigResponseBodyData& setSlaHour(int32_t slaHour) { DARABONBA_PTR_SET_VALUE(slaHour_, slaHour) };
    ...
    inline GetBaselineConfigResponseBodyData& setSlaMinu(int32_t slaMinu) { DARABONBA_PTR_SET_VALUE(slaMinu_, slaMinu) };
    ...
    inline GetBaselineConfigResponseBodyData& setUseFlag(bool useFlag) { DARABONBA_PTR_SET_VALUE(useFlag_, useFlag) };
