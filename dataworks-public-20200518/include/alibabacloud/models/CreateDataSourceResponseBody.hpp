...
namespace Models
{
  ...
  public:
    ...
    inline CreateDataSourceResponseBody& setData(int64_t data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline CreateDataSourceResponseBody& setHttpStatusCode(string httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
