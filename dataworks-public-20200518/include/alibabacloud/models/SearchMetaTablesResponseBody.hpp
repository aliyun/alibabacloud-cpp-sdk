...
namespace Models
{
  ...
  public:
    ...
    inline const SearchMetaTablesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SearchMetaTablesResponseBodyData) };
    inline SearchMetaTablesResponseBodyData data() { DARABONBA_PTR_GET(data_, SearchMetaTablesResponseBodyData) };
    inline SearchMetaTablesResponseBody& setData(const SearchMetaTablesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SearchMetaTablesResponseBody& setData(SearchMetaTablesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The search results.
    std::shared_ptr<SearchMetaTablesResponseBodyData> data_ = nullptr;
    // The error code.
