...
namespace Models
{
  ...
  public:
    ...
    inline const ExportDataSourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExportDataSourcesResponseBody) };
    inline ExportDataSourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ExportDataSourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExportDataSourcesResponseBody> body_ {};
  };
