...
namespace Models
{
  ...
  public:
    ...
    inline const RunManualDagNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunManualDagNodesResponseBody) };
    inline RunManualDagNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, RunManualDagNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunManualDagNodesResponseBody> body_ {};
  };
