...
namespace Models
{
  ...
  public:
    ...
    inline const ListBaselineConfigsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListBaselineConfigsResponseBodyData) };
    inline ListBaselineConfigsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListBaselineConfigsResponseBodyData) };
    inline ListBaselineConfigsResponseBody& setData(const ListBaselineConfigsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListBaselineConfigsResponseBody& setData(ListBaselineConfigsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<ListBaselineConfigsResponseBodyData> data_ = nullptr;
    // The error code.
