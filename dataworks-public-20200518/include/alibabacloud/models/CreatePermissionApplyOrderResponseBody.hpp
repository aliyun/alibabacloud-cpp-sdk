...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getFlowId() const { DARABONBA_PTR_GET_CONST(flowId_, vector<string>) };
    inline vector<string> getFlowId() { DARABONBA_PTR_GET(flowId_, vector<string>) };
