...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTableThemeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTableThemeResponseBody) };
    inline UpdateTableThemeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTableThemeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTableThemeResponseBody> body_ {};
  };
