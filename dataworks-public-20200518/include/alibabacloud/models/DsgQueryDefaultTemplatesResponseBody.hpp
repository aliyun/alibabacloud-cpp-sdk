...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DsgQueryDefaultTemplatesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DsgQueryDefaultTemplatesResponseBodyData>) };
    inline vector<DsgQueryDefaultTemplatesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DsgQueryDefaultTemplatesResponseBodyData>) };
    inline DsgQueryDefaultTemplatesResponseBody& setData(const vector<DsgQueryDefaultTemplatesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DsgQueryDefaultTemplatesResponseBody& setData(vector<DsgQueryDefaultTemplatesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<vector<DsgQueryDefaultTemplatesResponseBodyData>> data_ = nullptr;
    // The error code.
