...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetQualityFollowerResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetQualityFollowerResponseBodyData>) };
    inline vector<GetQualityFollowerResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetQualityFollowerResponseBodyData>) };
    inline GetQualityFollowerResponseBody& setData(const vector<GetQualityFollowerResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualityFollowerResponseBody& setData(vector<GetQualityFollowerResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetQualityFollowerResponseBodyData>> data_ = nullptr;
    // The error code.
