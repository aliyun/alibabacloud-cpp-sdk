...
#ifndef ALIBABACLOUD_MODELS_GETDATASERVICEAPIRESPONSEBODYDATAWIZARDDETAILSWIZARDREQUESTPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_GETDATASERVICEAPIRESPONSEBODYDATAWIZARDDETAILSWIZARDREQUESTPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& obj) { 
    ...
    GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters() = default ;
    GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters(const GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters &) = default ;
    GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters(GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters &&) = default ;
    GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters() = default ;
    GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& operator=(const GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters &) = default ;
    GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& operator=(GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters &&) = default ;
    ...
    inline GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& setColumnName(string columnName) { DARABONBA_PTR_SET_VALUE(columnName_, columnName) };
    ...
    inline GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& setExampleValue(string exampleValue) { DARABONBA_PTR_SET_VALUE(exampleValue_, exampleValue) };
    ...
    inline GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& setIsRequiredParameter(bool isRequiredParameter) { DARABONBA_PTR_SET_VALUE(isRequiredParameter_, isRequiredParameter) };
    ...
    inline GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& setParameterDataType(int32_t parameterDataType) { DARABONBA_PTR_SET_VALUE(parameterDataType_, parameterDataType) };
    ...
    inline GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& setParameterDescription(string parameterDescription) { DARABONBA_PTR_SET_VALUE(parameterDescription_, parameterDescription) };
    ...
    inline GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& setParameterName(string parameterName) { DARABONBA_PTR_SET_VALUE(parameterName_, parameterName) };
    ...
    inline GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& setParameterOperator(int32_t parameterOperator) { DARABONBA_PTR_SET_VALUE(parameterOperator_, parameterOperator) };
    ...
    inline GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters& setParameterPosition(int32_t parameterPosition) { DARABONBA_PTR_SET_VALUE(parameterPosition_, parameterPosition) };
