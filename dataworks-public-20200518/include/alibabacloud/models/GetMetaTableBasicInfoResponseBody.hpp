...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableBasicInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetaTableBasicInfoResponseBodyData) };
    inline GetMetaTableBasicInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetaTableBasicInfoResponseBodyData) };
    inline GetMetaTableBasicInfoResponseBody& setData(const GetMetaTableBasicInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaTableBasicInfoResponseBody& setData(GetMetaTableBasicInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The business data.
    std::shared_ptr<GetMetaTableBasicInfoResponseBodyData> data_ = nullptr;
    // The error code.
