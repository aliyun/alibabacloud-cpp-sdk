...
namespace Models
{
  ...
  public:
    ...
    inline const GetBaselineStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetBaselineStatusResponseBodyData) };
    inline GetBaselineStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, GetBaselineStatusResponseBodyData) };
    inline GetBaselineStatusResponseBody& setData(const GetBaselineStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetBaselineStatusResponseBody& setData(GetBaselineStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetBaselineStatusResponseBodyData> data_ = nullptr;
