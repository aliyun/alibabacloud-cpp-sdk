...
namespace Models
{
  ...
  public:
    ...
    inline const GetNodeParentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetNodeParentsResponseBody) };
    inline GetNodeParentsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetNodeParentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetNodeParentsResponseBody> body_ {};
  };
