...
namespace Models
{
  ...
  public:
    ...
    inline const PublishDataServiceApiResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PublishDataServiceApiResponseBody) };
    inline PublishDataServiceApiResponseBody getBody() { DARABONBA_PTR_GET(body_, PublishDataServiceApiResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PublishDataServiceApiResponseBody> body_ {};
  };
