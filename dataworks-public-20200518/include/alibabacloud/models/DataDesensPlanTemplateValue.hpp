...
namespace Models
{
  ...
  public:
    ...
    inline bool getSupportWaterMark() const { DARABONBA_PTR_GET_DEFAULT(supportWaterMark_, false) };
    ...
    inline const vector<Darabonba::Json> & getExtParamTemplate() const { DARABONBA_PTR_GET_CONST(extParamTemplate_, vector<Darabonba::Json>) };
    inline vector<Darabonba::Json> getExtParamTemplate() { DARABONBA_PTR_GET(extParamTemplate_, vector<Darabonba::Json>) };
