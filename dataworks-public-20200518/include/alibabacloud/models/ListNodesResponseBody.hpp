...
namespace Models
{
  ...
  public:
    ...
    inline const ListNodesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListNodesResponseBodyData) };
    inline ListNodesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListNodesResponseBodyData) };
    inline ListNodesResponseBody& setData(const ListNodesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListNodesResponseBody& setData(ListNodesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The nodes.
    std::shared_ptr<ListNodesResponseBodyData> data_ = nullptr;
