...
namespace Models
{
  ...
  public:
    ...
    inline const DsgWhiteListQueryListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DsgWhiteListQueryListResponseBody) };
    inline DsgWhiteListQueryListResponseBody getBody() { DARABONBA_PTR_GET(body_, DsgWhiteListQueryListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DsgWhiteListQueryListResponseBody> body_ {};
  };
