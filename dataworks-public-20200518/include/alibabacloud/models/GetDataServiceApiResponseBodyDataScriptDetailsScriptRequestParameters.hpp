...
#ifndef ALIBABACLOUD_MODELS_GETDATASERVICEAPIRESPONSEBODYDATASCRIPTDETAILSSCRIPTREQUESTPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_GETDATASERVICEAPIRESPONSEBODYDATASCRIPTDETAILSSCRIPTREQUESTPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& obj) { 
    ...
    GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters() = default ;
    GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters(const GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters &) = default ;
    GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters(GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters &&) = default ;
    GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters() = default ;
    GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& operator=(const GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters &) = default ;
    GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& operator=(GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters &&) = default ;
    ...
    inline GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& setColumnName(string columnName) { DARABONBA_PTR_SET_VALUE(columnName_, columnName) };
    ...
    inline GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& setExampleValue(string exampleValue) { DARABONBA_PTR_SET_VALUE(exampleValue_, exampleValue) };
    ...
    inline GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& setIsRequiredParameter(bool isRequiredParameter) { DARABONBA_PTR_SET_VALUE(isRequiredParameter_, isRequiredParameter) };
    ...
    inline GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& setParameterDataType(int32_t parameterDataType) { DARABONBA_PTR_SET_VALUE(parameterDataType_, parameterDataType) };
    ...
    inline GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& setParameterDescription(string parameterDescription) { DARABONBA_PTR_SET_VALUE(parameterDescription_, parameterDescription) };
    ...
    inline GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& setParameterName(string parameterName) { DARABONBA_PTR_SET_VALUE(parameterName_, parameterName) };
    ...
    inline GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& setParameterOperator(int32_t parameterOperator) { DARABONBA_PTR_SET_VALUE(parameterOperator_, parameterOperator) };
    ...
    inline GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters& setParameterPosition(int32_t parameterPosition) { DARABONBA_PTR_SET_VALUE(parameterPosition_, parameterPosition) };
