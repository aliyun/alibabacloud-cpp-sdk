...
#ifndef ALIBABACLOUD_MODELS_GETDATASERVICEPUBLISHEDAPIRESPONSEBODYDATAREGISTRATIONDETAILSREGISTRATIONREQUESTPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_GETDATASERVICEPUBLISHEDAPIRESPONSEBODYDATAREGISTRATIONDETAILSREGISTRATIONREQUESTPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& obj) { 
    ...
    GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters() = default ;
    GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters(const GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters &) = default ;
    GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters(GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters &&) = default ;
    GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters() = default ;
    GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& operator=(const GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters &) = default ;
    GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& operator=(GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters &&) = default ;
    ...
    inline GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& setExampleValue(string exampleValue) { DARABONBA_PTR_SET_VALUE(exampleValue_, exampleValue) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& setIsRequiredParameter(bool isRequiredParameter) { DARABONBA_PTR_SET_VALUE(isRequiredParameter_, isRequiredParameter) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& setParameterDataType(int32_t parameterDataType) { DARABONBA_PTR_SET_VALUE(parameterDataType_, parameterDataType) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& setParameterDescription(string parameterDescription) { DARABONBA_PTR_SET_VALUE(parameterDescription_, parameterDescription) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& setParameterName(string parameterName) { DARABONBA_PTR_SET_VALUE(parameterName_, parameterName) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& setParameterOperator(int32_t parameterOperator) { DARABONBA_PTR_SET_VALUE(parameterOperator_, parameterOperator) };
    ...
    inline GetDataServicePublishedApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters& setParameterPosition(int32_t parameterPosition) { DARABONBA_PTR_SET_VALUE(parameterPosition_, parameterPosition) };
