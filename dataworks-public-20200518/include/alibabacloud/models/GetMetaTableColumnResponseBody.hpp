...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableColumnResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetaTableColumnResponseBodyData) };
    inline GetMetaTableColumnResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetaTableColumnResponseBodyData) };
    inline GetMetaTableColumnResponseBody& setData(const GetMetaTableColumnResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaTableColumnResponseBody& setData(GetMetaTableColumnResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The business data.
    std::shared_ptr<GetMetaTableColumnResponseBodyData> data_ = nullptr;
    // The error code.
