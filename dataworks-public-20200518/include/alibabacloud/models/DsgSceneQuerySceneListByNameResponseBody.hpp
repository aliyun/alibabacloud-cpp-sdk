...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DsgSceneQuerySceneListByNameResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DsgSceneQuerySceneListByNameResponseBodyData>) };
    inline vector<DsgSceneQuerySceneListByNameResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DsgSceneQuerySceneListByNameResponseBodyData>) };
    inline DsgSceneQuerySceneListByNameResponseBody& setData(const vector<DsgSceneQuerySceneListByNameResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DsgSceneQuerySceneListByNameResponseBody& setData(vector<DsgSceneQuerySceneListByNameResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<vector<DsgSceneQuerySceneListByNameResponseBodyData>> data_ = nullptr;
    // The error code.
