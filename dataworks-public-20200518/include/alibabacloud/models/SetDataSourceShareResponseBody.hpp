...
namespace Models
{
  ...
  public:
    ...
    inline const SetDataSourceShareResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SetDataSourceShareResponseBody::Data) };
    inline SetDataSourceShareResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SetDataSourceShareResponseBody::Data) };
    inline SetDataSourceShareResponseBody& setData(const SetDataSourceShareResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SetDataSourceShareResponseBody& setData(SetDataSourceShareResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<SetDataSourceShareResponseBody::Data> data_ {};
    // The request ID.
