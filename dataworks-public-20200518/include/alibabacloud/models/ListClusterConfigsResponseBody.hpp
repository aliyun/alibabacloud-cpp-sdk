...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterConfigs_ == nullptr
    ...
    inline const vector<ClusterConfig> & getClusterConfigs() const { DARABONBA_PTR_GET_CONST(clusterConfigs_, vector<ClusterConfig>) };
    inline vector<ClusterConfig> getClusterConfigs() { DARABONBA_PTR_GET(clusterConfigs_, vector<ClusterConfig>) };
  ...
  protected:
    ...
    shared_ptr<vector<ClusterConfig>> clusterConfigs_ {};
    // The error code.
