...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateDISyncTaskConfigForUpdatingResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GenerateDISyncTaskConfigForUpdatingResponseBodyData) };
    inline GenerateDISyncTaskConfigForUpdatingResponseBodyData data() { DARABONBA_PTR_GET(data_, GenerateDISyncTaskConfigForUpdatingResponseBodyData) };
    inline GenerateDISyncTaskConfigForUpdatingResponseBody& setData(const GenerateDISyncTaskConfigForUpdatingResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GenerateDISyncTaskConfigForUpdatingResponseBody& setData(GenerateDISyncTaskConfigForUpdatingResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GenerateDISyncTaskConfigForUpdatingResponseBodyData> data_ = nullptr;
