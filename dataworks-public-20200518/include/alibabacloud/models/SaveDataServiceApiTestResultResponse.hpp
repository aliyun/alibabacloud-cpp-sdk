...
namespace Models
{
  ...
  public:
    ...
    inline const SaveDataServiceApiTestResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveDataServiceApiTestResultResponseBody) };
    inline SaveDataServiceApiTestResultResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveDataServiceApiTestResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveDataServiceApiTestResultResponseBody> body_ {};
  };
