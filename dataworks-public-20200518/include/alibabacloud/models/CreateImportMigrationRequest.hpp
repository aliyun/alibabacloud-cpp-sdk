...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->calculateEngineMap_ == nullptr
    ...
    inline string getCalculateEngineMap() const { DARABONBA_PTR_GET_DEFAULT(calculateEngineMap_, "") };
    ...
    inline string getCommitRule() const { DARABONBA_PTR_GET_DEFAULT(commitRule_, "") };
    ...
    inline string getPackageFile() const { DARABONBA_PTR_GET_DEFAULT(packageFile_, "") };
    ...
    inline string getResourceGroupMap() const { DARABONBA_PTR_GET_DEFAULT(resourceGroupMap_, "") };
    ...
    inline string getWorkspaceMap() const { DARABONBA_PTR_GET_DEFAULT(workspaceMap_, "") };
  ...
  protected:
    ...
    shared_ptr<string> calculateEngineMap_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<string> packageFile_ {};
    ...
    // }
    // ```
    shared_ptr<string> resourceGroupMap_ {};
    ...
    shared_ptr<string> workspaceMap_ {};
  };
