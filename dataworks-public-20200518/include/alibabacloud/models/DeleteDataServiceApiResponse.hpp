...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDataServiceApiResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDataServiceApiResponseBody) };
    inline DeleteDataServiceApiResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDataServiceApiResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDataServiceApiResponseBody> body_ {};
  };
