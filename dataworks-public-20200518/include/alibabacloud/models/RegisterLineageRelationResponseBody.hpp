...
namespace Models
{
  ...
  public:
    ...
    inline const RegisterLineageRelationResponseBodyLineageRelation & lineageRelation() const { DARABONBA_PTR_GET_CONST(lineageRelation_, RegisterLineageRelationResponseBodyLineageRelation) };
    inline RegisterLineageRelationResponseBodyLineageRelation lineageRelation() { DARABONBA_PTR_GET(lineageRelation_, RegisterLineageRelationResponseBodyLineageRelation) };
    inline RegisterLineageRelationResponseBody& setLineageRelation(const RegisterLineageRelationResponseBodyLineageRelation & lineageRelation) { DARABONBA_PTR_SET_VALUE(lineageRelation_, lineageRelation) };
    inline RegisterLineageRelationResponseBody& setLineageRelation(RegisterLineageRelationResponseBodyLineageRelation && lineageRelation) { DARABONBA_PTR_SET_RVALUE(lineageRelation_, lineageRelation) };
  ...
  protected:
    ...
    // The lineage.
    std::shared_ptr<RegisterLineageRelationResponseBodyLineageRelation> lineageRelation_ = nullptr;
