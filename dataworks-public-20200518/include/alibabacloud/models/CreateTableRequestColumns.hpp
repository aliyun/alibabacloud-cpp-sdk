...
#ifndef ALIBABACLOUD_MODELS_CREATETABLEREQUESTCOLUMNS_HPP_
#define ALIBABACLOUD_MODELS_CREATETABLEREQUESTCOLUMNS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTableRequestColumns& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTableRequestColumns& obj) { 
    ...
    CreateTableRequestColumns() = default ;
    CreateTableRequestColumns(const CreateTableRequestColumns &) = default ;
    CreateTableRequestColumns(CreateTableRequestColumns &&) = default ;
    CreateTableRequestColumns(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTableRequestColumns() = default ;
    CreateTableRequestColumns& operator=(const CreateTableRequestColumns &) = default ;
    CreateTableRequestColumns& operator=(CreateTableRequestColumns &&) = default ;
    ...
    inline CreateTableRequestColumns& setColumnName(string columnName) { DARABONBA_PTR_SET_VALUE(columnName_, columnName) };
    ...
    inline CreateTableRequestColumns& setColumnNameCn(string columnNameCn) { DARABONBA_PTR_SET_VALUE(columnNameCn_, columnNameCn) };
    ...
    inline CreateTableRequestColumns& setColumnType(string columnType) { DARABONBA_PTR_SET_VALUE(columnType_, columnType) };
    ...
    inline CreateTableRequestColumns& setComment(string comment) { DARABONBA_PTR_SET_VALUE(comment_, comment) };
    ...
    inline CreateTableRequestColumns& setIsPartitionCol(bool isPartitionCol) { DARABONBA_PTR_SET_VALUE(isPartitionCol_, isPartitionCol) };
    ...
    inline CreateTableRequestColumns& setLength(int32_t length) { DARABONBA_PTR_SET_VALUE(length_, length) };
    ...
    inline CreateTableRequestColumns& setSeqNumber(int32_t seqNumber) { DARABONBA_PTR_SET_VALUE(seqNumber_, seqNumber) };
