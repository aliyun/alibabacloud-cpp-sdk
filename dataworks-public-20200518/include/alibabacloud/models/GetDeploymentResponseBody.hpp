...
namespace Models
{
  ...
  public:
    ...
    inline const GetDeploymentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDeploymentResponseBodyData) };
    inline GetDeploymentResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDeploymentResponseBodyData) };
    inline GetDeploymentResponseBody& setData(const GetDeploymentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDeploymentResponseBody& setData(GetDeploymentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDeploymentResponseBodyData> data_ = nullptr;
