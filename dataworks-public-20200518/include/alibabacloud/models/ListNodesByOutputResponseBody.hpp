...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListNodesByOutputResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListNodesByOutputResponseBodyData>) };
    inline vector<ListNodesByOutputResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListNodesByOutputResponseBodyData>) };
    inline ListNodesByOutputResponseBody& setData(const vector<ListNodesByOutputResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListNodesByOutputResponseBody& setData(vector<ListNodesByOutputResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The nodes returned.
    std::shared_ptr<vector<ListNodesByOutputResponseBodyData>> data_ = nullptr;
    // The error code.
