...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMetaCategoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateMetaCategoryResponseBodyData) };
    inline CreateMetaCategoryResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateMetaCategoryResponseBodyData) };
    inline CreateMetaCategoryResponseBody& setData(const CreateMetaCategoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateMetaCategoryResponseBody& setData(CreateMetaCategoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateMetaCategoryResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
  ...
  protected:
    ...
    std::shared_ptr<CreateMetaCategoryResponseBodyData> data_ = nullptr;
    // The error code.
