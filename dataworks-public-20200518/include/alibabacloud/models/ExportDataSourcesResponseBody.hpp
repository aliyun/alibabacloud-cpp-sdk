...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline DataSources& setBindingCalcEngineId(int32_t bindingCalcEngineId) { DARABONBA_PTR_SET_VALUE(bindingCalcEngineId_, bindingCalcEngineId) };
        ...
        inline DataSources& setId(int32_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline const ExportDataSourcesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ExportDataSourcesResponseBody::Data) };
    inline ExportDataSourcesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ExportDataSourcesResponseBody::Data) };
    inline ExportDataSourcesResponseBody& setData(const ExportDataSourcesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ExportDataSourcesResponseBody& setData(ExportDataSourcesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<ExportDataSourcesResponseBody::Data> data_ {};
