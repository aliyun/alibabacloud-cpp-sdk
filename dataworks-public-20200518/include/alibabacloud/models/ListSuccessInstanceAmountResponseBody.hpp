...
namespace Models
{
  ...
  public:
    ...
    inline const ListSuccessInstanceAmountResponseBody::InstanceStatusTrend & getInstanceStatusTrend() const { DARABONBA_PTR_GET_CONST(instanceStatusTrend_, ListSuccessInstanceAmountResponseBody::InstanceStatusTrend) };
    inline ListSuccessInstanceAmountResponseBody::InstanceStatusTrend getInstanceStatusTrend() { DARABONBA_PTR_GET(instanceStatusTrend_, ListSuccessInstanceAmountResponseBody::InstanceStatusTrend) };
    inline ListSuccessInstanceAmountResponseBody& setInstanceStatusTrend(const ListSuccessInstanceAmountResponseBody::InstanceStatusTrend & instanceStatusTrend) { DARABONBA_PTR_SET_VALUE(instanceStatusTrend_, instanceStatusTrend) };
    inline ListSuccessInstanceAmountResponseBody& setInstanceStatusTrend(ListSuccessInstanceAmountResponseBody::InstanceStatusTrend && instanceStatusTrend) { DARABONBA_PTR_SET_RVALUE(instanceStatusTrend_, instanceStatusTrend) };
