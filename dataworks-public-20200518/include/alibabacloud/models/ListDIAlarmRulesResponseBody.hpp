...
namespace Models
{
  ...
  public:
    ...
    class DIAlarmRulePaging : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const DIAlarmRulePaging& obj) { 
        DARABONBA_PTR_TO_JSON(DIJobAlarmRules, DIJobAlarmRules_);
        DARABONBA_PTR_TO_JSON(PageNumber, pageNumber_);
        DARABONBA_PTR_TO_JSON(PageSize, pageSize_);
        DARABONBA_PTR_TO_JSON(TotalCount, totalCount_);
      };
      friend void from_json(const Darabonba::Json& j, DIAlarmRulePaging& obj) { 
        DARABONBA_PTR_FROM_JSON(DIJobAlarmRules, DIJobAlarmRules_);
        DARABONBA_PTR_FROM_JSON(PageNumber, pageNumber_);
        DARABONBA_PTR_FROM_JSON(PageSize, pageSize_);
        DARABONBA_PTR_FROM_JSON(TotalCount, totalCount_);
      };
      DIAlarmRulePaging() = default ;
      DIAlarmRulePaging(const DIAlarmRulePaging &) = default ;
      DIAlarmRulePaging(DIAlarmRulePaging &&) = default ;
      DIAlarmRulePaging(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~DIAlarmRulePaging() = default ;
      DIAlarmRulePaging& operator=(const DIAlarmRulePaging &) = default ;
      DIAlarmRulePaging& operator=(DIAlarmRulePaging &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline const vector<DIAlarmRulePaging::DIJobAlarmRules> & getDIJobAlarmRules() const { DARABONBA_PTR_GET_CONST(DIJobAlarmRules_, vector<DIAlarmRulePaging::DIJobAlarmRules>) };
      inline vector<DIAlarmRulePaging::DIJobAlarmRules> getDIJobAlarmRules() { DARABONBA_PTR_GET(DIJobAlarmRules_, vector<DIAlarmRulePaging::DIJobAlarmRules>) };
      inline DIAlarmRulePaging& setDIJobAlarmRules(const vector<DIAlarmRulePaging::DIJobAlarmRules> & dIJobAlarmRules) { DARABONBA_PTR_SET_VALUE(DIJobAlarmRules_, dIJobAlarmRules) };
      inline DIAlarmRulePaging& setDIJobAlarmRules(vector<DIAlarmRulePaging::DIJobAlarmRules> && dIJobAlarmRules) { DARABONBA_PTR_SET_RVALUE(DIJobAlarmRules_, dIJobAlarmRules) };
      ...
      inline DIAlarmRulePaging& setPageNumber(int64_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
      ...
      inline DIAlarmRulePaging& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
      ...
      inline DIAlarmRulePaging& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
    ...
    virtual bool empty() const override { return this->DIAlarmRulePaging_ == nullptr
    ...
    inline const ListDIAlarmRulesResponseBody::DIAlarmRulePaging & getDIAlarmRulePaging() const { DARABONBA_PTR_GET_CONST(DIAlarmRulePaging_, ListDIAlarmRulesResponseBody::DIAlarmRulePaging) };
    inline ListDIAlarmRulesResponseBody::DIAlarmRulePaging getDIAlarmRulePaging() { DARABONBA_PTR_GET(DIAlarmRulePaging_, ListDIAlarmRulesResponseBody::DIAlarmRulePaging) };
    inline ListDIAlarmRulesResponseBody& setDIAlarmRulePaging(const ListDIAlarmRulesResponseBody::DIAlarmRulePaging & dIAlarmRulePaging) { DARABONBA_PTR_SET_VALUE(DIAlarmRulePaging_, dIAlarmRulePaging) };
    inline ListDIAlarmRulesResponseBody& setDIAlarmRulePaging(ListDIAlarmRulesResponseBody::DIAlarmRulePaging && dIAlarmRulePaging) { DARABONBA_PTR_SET_RVALUE(DIAlarmRulePaging_, dIAlarmRulePaging) };
