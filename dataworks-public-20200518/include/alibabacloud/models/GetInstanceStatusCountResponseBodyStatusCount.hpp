...
#ifndef ALIBABACLOUD_MODELS_GETINSTANCESTATUSCOUNTRESPONSEBODYSTATUSCOUNT_HPP_
#define ALIBABACLOUD_MODELS_GETINSTANCESTATUSCOUNTRESPONSEBODYSTATUSCOUNT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetInstanceStatusCountResponseBodyStatusCount& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetInstanceStatusCountResponseBodyStatusCount& obj) { 
    ...
    GetInstanceStatusCountResponseBodyStatusCount() = default ;
    GetInstanceStatusCountResponseBodyStatusCount(const GetInstanceStatusCountResponseBodyStatusCount &) = default ;
    GetInstanceStatusCountResponseBodyStatusCount(GetInstanceStatusCountResponseBodyStatusCount &&) = default ;
    GetInstanceStatusCountResponseBodyStatusCount(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetInstanceStatusCountResponseBodyStatusCount() = default ;
    GetInstanceStatusCountResponseBodyStatusCount& operator=(const GetInstanceStatusCountResponseBodyStatusCount &) = default ;
    GetInstanceStatusCountResponseBodyStatusCount& operator=(GetInstanceStatusCountResponseBodyStatusCount &&) = default ;
    ...
    inline GetInstanceStatusCountResponseBodyStatusCount& setFailureCount(int32_t failureCount) { DARABONBA_PTR_SET_VALUE(failureCount_, failureCount) };
    ...
    inline GetInstanceStatusCountResponseBodyStatusCount& setNotRunCount(int32_t notRunCount) { DARABONBA_PTR_SET_VALUE(notRunCount_, notRunCount) };
    ...
    inline GetInstanceStatusCountResponseBodyStatusCount& setRunningCount(int32_t runningCount) { DARABONBA_PTR_SET_VALUE(runningCount_, runningCount) };
    ...
    inline GetInstanceStatusCountResponseBodyStatusCount& setSuccessCount(int32_t successCount) { DARABONBA_PTR_SET_VALUE(successCount_, successCount) };
    ...
    inline GetInstanceStatusCountResponseBodyStatusCount& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
    ...
    inline GetInstanceStatusCountResponseBodyStatusCount& setWaitResCount(int32_t waitResCount) { DARABONBA_PTR_SET_VALUE(waitResCount_, waitResCount) };
    ...
    inline GetInstanceStatusCountResponseBodyStatusCount& setWaitTimeCount(int32_t waitTimeCount) { DARABONBA_PTR_SET_VALUE(waitTimeCount_, waitTimeCount) };
