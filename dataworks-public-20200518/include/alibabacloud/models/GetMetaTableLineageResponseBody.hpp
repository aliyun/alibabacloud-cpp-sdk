...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTableLineageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetaTableLineageResponseBodyData) };
    inline GetMetaTableLineageResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetaTableLineageResponseBodyData) };
    inline GetMetaTableLineageResponseBody& setData(const GetMetaTableLineageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaTableLineageResponseBody& setData(GetMetaTableLineageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The business data.
    std::shared_ptr<GetMetaTableLineageResponseBodyData> data_ = nullptr;
    // The error code.
