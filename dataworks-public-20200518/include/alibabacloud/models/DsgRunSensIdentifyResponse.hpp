...
namespace Models
{
  ...
  public:
    ...
    inline const DsgRunSensIdentifyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DsgRunSensIdentifyResponseBody) };
    inline DsgRunSensIdentifyResponseBody getBody() { DARABONBA_PTR_GET(body_, DsgRunSensIdentifyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DsgRunSensIdentifyResponseBody> body_ {};
  };
