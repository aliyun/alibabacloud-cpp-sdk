...
namespace Models
{
  ...
  public:
    ...
    inline const ListTableThemeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListTableThemeResponseBodyData) };
    inline ListTableThemeResponseBodyData data() { DARABONBA_PTR_GET(data_, ListTableThemeResponseBodyData) };
    inline ListTableThemeResponseBody& setData(const ListTableThemeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTableThemeResponseBody& setData(ListTableThemeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned result.
    std::shared_ptr<ListTableThemeResponseBodyData> data_ = nullptr;
    // The error code.
