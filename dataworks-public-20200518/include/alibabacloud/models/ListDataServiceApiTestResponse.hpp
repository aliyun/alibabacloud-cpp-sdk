...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceApiTestResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataServiceApiTestResponseBody) };
    inline ListDataServiceApiTestResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataServiceApiTestResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataServiceApiTestResponseBody> body_ {};
  };
