...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataServiceAuthorizedApisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataServiceAuthorizedApisResponseBody) };
    inline ListDataServiceAuthorizedApisResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataServiceAuthorizedApisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataServiceAuthorizedApisResponseBody> body_ {};
  };
