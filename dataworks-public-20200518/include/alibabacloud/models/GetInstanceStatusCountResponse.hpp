...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceStatusCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceStatusCountResponseBody) };
    inline GetInstanceStatusCountResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceStatusCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceStatusCountResponseBody> body_ {};
  };
