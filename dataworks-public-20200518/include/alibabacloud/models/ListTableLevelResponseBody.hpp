...
namespace Models
{
  ...
  public:
    ...
    inline const ListTableLevelResponseBodyTableLevelInfo & tableLevelInfo() const { DARABONBA_PTR_GET_CONST(tableLevelInfo_, ListTableLevelResponseBodyTableLevelInfo) };
    inline ListTableLevelResponseBodyTableLevelInfo tableLevelInfo() { DARABONBA_PTR_GET(tableLevelInfo_, ListTableLevelResponseBodyTableLevelInfo) };
    inline ListTableLevelResponseBody& setTableLevelInfo(const ListTableLevelResponseBodyTableLevelInfo & tableLevelInfo) { DARABONBA_PTR_SET_VALUE(tableLevelInfo_, tableLevelInfo) };
    inline ListTableLevelResponseBody& setTableLevelInfo(ListTableLevelResponseBodyTableLevelInfo && tableLevelInfo) { DARABONBA_PTR_SET_RVALUE(tableLevelInfo_, tableLevelInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ListTableLevelResponseBodyTableLevelInfo> tableLevelInfo_ = nullptr;
  };
