...
namespace Models
{
  ...
  public:
    ...
    inline const GetDagResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDagResponseBodyData) };
    inline GetDagResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDagResponseBodyData) };
    inline GetDagResponseBody& setData(const GetDagResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDagResponseBody& setData(GetDagResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDagResponseBodyData> data_ = nullptr;
    // The error code.
