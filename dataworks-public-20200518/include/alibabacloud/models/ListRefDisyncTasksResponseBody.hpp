...
namespace Models
{
  ...
  public:
    ...
    inline const ListRefDISyncTasksResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListRefDISyncTasksResponseBodyData) };
    inline ListRefDISyncTasksResponseBodyData data() { DARABONBA_PTR_GET(data_, ListRefDISyncTasksResponseBodyData) };
    inline ListRefDISyncTasksResponseBody& setData(const ListRefDISyncTasksResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListRefDISyncTasksResponseBody& setData(ListRefDISyncTasksResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned result.
    std::shared_ptr<ListRefDISyncTasksResponseBodyData> data_ = nullptr;
