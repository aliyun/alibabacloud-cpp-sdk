...
namespace Models
{
  ...
  public:
    ...
    inline const GetMetaTablePartitionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetMetaTablePartitionResponseBodyData) };
    inline GetMetaTablePartitionResponseBodyData data() { DARABONBA_PTR_GET(data_, GetMetaTablePartitionResponseBodyData) };
    inline GetMetaTablePartitionResponseBody& setData(const GetMetaTablePartitionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetMetaTablePartitionResponseBody& setData(GetMetaTablePartitionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned result.
    std::shared_ptr<GetMetaTablePartitionResponseBodyData> data_ = nullptr;
