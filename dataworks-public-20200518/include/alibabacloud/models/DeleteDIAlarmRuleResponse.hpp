...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDIAlarmRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDIAlarmRuleResponseBody) };
    inline DeleteDIAlarmRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDIAlarmRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDIAlarmRuleResponseBody> body_ {};
  };
