...
namespace Models
{
  ...
  public:
    ...
    inline GetPrivateAccessPolicyResponseBodyPolicy& setValidFrom(int64_t validFrom) { DARABONBA_PTR_SET_VALUE(validFrom_, validFrom) };
    ...
    inline GetPrivateAccessPolicyResponseBodyPolicy& setValidTimeStatus(string validTimeStatus) { DARABONBA_PTR_SET_VALUE(validTimeStatus_, validTimeStatus) };
    ...
    inline GetPrivateAccessPolicyResponseBodyPolicy& setValidUntil(int64_t validUntil) { DARABONBA_PTR_SET_VALUE(validUntil_, validUntil) };
