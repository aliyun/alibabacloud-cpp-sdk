...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWmBaseImageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateWmBaseImageResponseBodyData) };
    inline CreateWmBaseImageResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateWmBaseImageResponseBodyData) };
    inline CreateWmBaseImageResponseBody& setData(const CreateWmBaseImageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateWmBaseImageResponseBody& setData(CreateWmBaseImageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<CreateWmBaseImageResponseBodyData> data_ = nullptr;
