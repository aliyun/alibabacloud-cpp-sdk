...
namespace Models
{
  ...
  public:
    ...
    inline const GetWmExtractTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetWmExtractTaskResponseBody) };
    inline GetWmExtractTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetWmExtractTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetWmExtractTaskResponseBody> body_ {};
  };
