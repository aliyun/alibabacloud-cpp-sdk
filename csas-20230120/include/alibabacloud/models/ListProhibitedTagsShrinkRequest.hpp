...
#ifndef ALIBABACLOUD_MODELS_LISTPROHIBITEDTAGSSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTPROHIBITEDTAGSSHRINKREQUEST_HPP_
...
namespace Models
{
  class ListProhibitedTagsShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListProhibitedTagsShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListProhibitedTagsShrinkRequest& obj) { 
    ...
    ListProhibitedTagsShrinkRequest() = default ;
    ListProhibitedTagsShrinkRequest(const ListProhibitedTagsShrinkRequest &) = default ;
    ListProhibitedTagsShrinkRequest(ListProhibitedTagsShrinkRequest &&) = default ;
    ListProhibitedTagsShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListProhibitedTagsShrinkRequest() = default ;
    ListProhibitedTagsShrinkRequest& operator=(const ListProhibitedTagsShrinkRequest &) = default ;
    ListProhibitedTagsShrinkRequest& operator=(ListProhibitedTagsShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && this->name_ == nullptr && this->pageSize_ == nullptr && this->policyId_ == nullptr && this->softwareIdShrink_ == nullptr && this->tagIds_ == nullptr; };
    // currentPage Field Functions 
    bool hasCurrentPage() const { return this->currentPage_ != nullptr;};
    void deleteCurrentPage() { this->currentPage_ = nullptr;};
    inline int64_t getCurrentPage() const { DARABONBA_PTR_GET_DEFAULT(currentPage_, 0L) };
    inline ListProhibitedTagsShrinkRequest& setCurrentPage(int64_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline ListProhibitedTagsShrinkRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListProhibitedTagsShrinkRequest& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListProhibitedTagsShrinkRequest& setPolicyId(string policyId) { DARABONBA_PTR_SET_VALUE(policyId_, policyId) };
    ...
    inline ListProhibitedTagsShrinkRequest& setSoftwareIdShrink(string softwareIdShrink) { DARABONBA_PTR_SET_VALUE(softwareIdShrink_, softwareIdShrink) };


    // tagIds Field Functions 
    bool hasTagIds() const { return this->tagIds_ != nullptr;};
    void deleteTagIds() { this->tagIds_ = nullptr;};
    inline const vector<ListProhibitedTagsShrinkRequest::TagIds> & getTagIds() const { DARABONBA_PTR_GET_CONST(tagIds_, vector<ListProhibitedTagsShrinkRequest::TagIds>) };
    inline vector<ListProhibitedTagsShrinkRequest::TagIds> getTagIds() { DARABONBA_PTR_GET(tagIds_, vector<ListProhibitedTagsShrinkRequest::TagIds>) };
    inline ListProhibitedTagsShrinkRequest& setTagIds(const vector<ListProhibitedTagsShrinkRequest::TagIds> & tagIds) { DARABONBA_PTR_SET_VALUE(tagIds_, tagIds) };
    inline ListProhibitedTagsShrinkRequest& setTagIds(vector<ListProhibitedTagsShrinkRequest::TagIds> && tagIds) { DARABONBA_PTR_SET_RVALUE(tagIds_, tagIds) };
  ...
  protected:
    ...
    shared_ptr<vector<ListProhibitedTagsShrinkRequest::TagIds>> tagIds_ {};
  };
