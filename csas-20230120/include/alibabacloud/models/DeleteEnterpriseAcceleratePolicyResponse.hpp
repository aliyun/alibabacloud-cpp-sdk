...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEnterpriseAcceleratePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteEnterpriseAcceleratePolicyResponseBody) };
    inline DeleteEnterpriseAcceleratePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteEnterpriseAcceleratePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteEnterpriseAcceleratePolicyResponseBody> body_ {};
  };
