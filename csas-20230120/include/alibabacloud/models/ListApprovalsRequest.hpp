...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getApprovalIds() const { DARABONBA_PTR_GET_CONST(approvalIds_, vector<string>) };
    inline vector<string> getApprovalIds() { DARABONBA_PTR_GET(approvalIds_, vector<string>) };
    ...
    inline string getOperatorUsername() const { DARABONBA_PTR_GET_DEFAULT(operatorUsername_, "") };
