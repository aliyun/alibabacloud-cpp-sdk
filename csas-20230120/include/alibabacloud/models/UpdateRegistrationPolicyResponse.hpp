...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRegistrationPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateRegistrationPolicyResponseBody) };
    inline UpdateRegistrationPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateRegistrationPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateRegistrationPolicyResponseBody> body_ {};
  };
