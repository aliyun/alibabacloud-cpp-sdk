...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->audioControl_ == nullptr
        && return this->csvControl_ == nullptr && return this->documentControl_ == nullptr && return this->fileUrl_ == nullptr && return this->filename_ == nullptr && return this->imageControl_ == nullptr
        && return this->imageEmbedJpegQuality_ == nullptr && return this->imageEmbedLevel_ == nullptr && return this->invisibleEnable_ == nullptr && return this->videoBitrate_ == nullptr && return this->videoControl_ == nullptr
