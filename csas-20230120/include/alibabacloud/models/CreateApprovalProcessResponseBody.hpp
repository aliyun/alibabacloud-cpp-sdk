...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApprovalProcessResponseBodyProcess & process() const { DARABONBA_PTR_GET_CONST(process_, CreateApprovalProcessResponseBodyProcess) };
    inline CreateApprovalProcessResponseBodyProcess process() { DARABONBA_PTR_GET(process_, CreateApprovalProcessResponseBodyProcess) };
    inline CreateApprovalProcessResponseBody& setProcess(const CreateApprovalProcessResponseBodyProcess & process) { DARABONBA_PTR_SET_VALUE(process_, process) };
    inline CreateApprovalProcessResponseBody& setProcess(CreateApprovalProcessResponseBodyProcess && process) { DARABONBA_PTR_SET_RVALUE(process_, process) };
  ...
  protected:
    std::shared_ptr<CreateApprovalProcessResponseBodyProcess> process_ = nullptr;
