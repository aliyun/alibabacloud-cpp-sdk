...
#ifndef ALIBABACLOUD_MODELS_GETVULSCANSCHEDULEDSTRATEGYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETVULSCANSCHEDULEDSTRATEGYRESPONSEBODY_HPP_
...
namespace Models
{
  class GetVulScanScheduledStrategyResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetVulScanScheduledStrategyResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetVulScanScheduledStrategyResponseBody& obj) { 
    ...
    GetVulScanScheduledStrategyResponseBody() = default ;
    GetVulScanScheduledStrategyResponseBody(const GetVulScanScheduledStrategyResponseBody &) = default ;
    GetVulScanScheduledStrategyResponseBody(GetVulScanScheduledStrategyResponseBody &&) = default ;
    GetVulScanScheduledStrategyResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetVulScanScheduledStrategyResponseBody() = default ;
    GetVulScanScheduledStrategyResponseBody& operator=(const GetVulScanScheduledStrategyResponseBody &) = default ;
    GetVulScanScheduledStrategyResponseBody& operator=(GetVulScanScheduledStrategyResponseBody &&) = default ;
    ...
    inline GetVulScanScheduledStrategyResponseBody& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline const vector<GetVulScanScheduledStrategyResponseBody::CustomMatchGroup> & getCustomMatchGroup() const { DARABONBA_PTR_GET_CONST(customMatchGroup_, vector<GetVulScanScheduledStrategyResponseBody::CustomMatchGroup>) };
    inline vector<GetVulScanScheduledStrategyResponseBody::CustomMatchGroup> getCustomMatchGroup() { DARABONBA_PTR_GET(customMatchGroup_, vector<GetVulScanScheduledStrategyResponseBody::CustomMatchGroup>) };
    inline GetVulScanScheduledStrategyResponseBody& setCustomMatchGroup(const vector<GetVulScanScheduledStrategyResponseBody::CustomMatchGroup> & customMatchGroup) { DARABONBA_PTR_SET_VALUE(customMatchGroup_, customMatchGroup) };
    inline GetVulScanScheduledStrategyResponseBody& setCustomMatchGroup(vector<GetVulScanScheduledStrategyResponseBody::CustomMatchGroup> && customMatchGroup) { DARABONBA_PTR_SET_RVALUE(customMatchGroup_, customMatchGroup) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setLastTriggerTime(int64_t lastTriggerTime) { DARABONBA_PTR_SET_VALUE(lastTriggerTime_, lastTriggerTime) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setMatchMode(string matchMode) { DARABONBA_PTR_SET_VALUE(matchMode_, matchMode) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setMatchTargetIds(const vector<string> & matchTargetIds) { DARABONBA_PTR_SET_VALUE(matchTargetIds_, matchTargetIds) };
    inline GetVulScanScheduledStrategyResponseBody& setMatchTargetIds(vector<string> && matchTargetIds) { DARABONBA_PTR_SET_RVALUE(matchTargetIds_, matchTargetIds) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setScanBeginTime(int32_t scanBeginTime) { DARABONBA_PTR_SET_VALUE(scanBeginTime_, scanBeginTime) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setScanEndTime(int32_t scanEndTime) { DARABONBA_PTR_SET_VALUE(scanEndTime_, scanEndTime) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setScanFrequency(string scanFrequency) { DARABONBA_PTR_SET_VALUE(scanFrequency_, scanFrequency) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setScanInterval(int32_t scanInterval) { DARABONBA_PTR_SET_VALUE(scanInterval_, scanInterval) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setStrategyDescription(string strategyDescription) { DARABONBA_PTR_SET_VALUE(strategyDescription_, strategyDescription) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setStrategyId(string strategyId) { DARABONBA_PTR_SET_VALUE(strategyId_, strategyId) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setStrategyName(string strategyName) { DARABONBA_PTR_SET_VALUE(strategyName_, strategyName) };
    ...
    inline GetVulScanScheduledStrategyResponseBody& setWhitelist(const vector<string> & whitelist) { DARABONBA_PTR_SET_VALUE(whitelist_, whitelist) };
    inline GetVulScanScheduledStrategyResponseBody& setWhitelist(vector<string> && whitelist) { DARABONBA_PTR_SET_RVALUE(whitelist_, whitelist) };
  ...
  protected:
    ...
    shared_ptr<vector<GetVulScanScheduledStrategyResponseBody::CustomMatchGroup>> customMatchGroup_ {};
