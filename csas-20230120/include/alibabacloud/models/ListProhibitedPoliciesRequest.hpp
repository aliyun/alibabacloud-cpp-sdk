...
#ifndef ALIBABACLOUD_MODELS_LISTPROHIBITEDPOLICIESREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTPROHIBITEDPOLICIESREQUEST_HPP_
...
namespace Models
{
  class ListProhibitedPoliciesRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListProhibitedPoliciesRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListProhibitedPoliciesRequest& obj) { 
    ...
    ListProhibitedPoliciesRequest() = default ;
    ListProhibitedPoliciesRequest(const ListProhibitedPoliciesRequest &) = default ;
    ListProhibitedPoliciesRequest(ListProhibitedPoliciesRequest &&) = default ;
    ListProhibitedPoliciesRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListProhibitedPoliciesRequest() = default ;
    ListProhibitedPoliciesRequest& operator=(const ListProhibitedPoliciesRequest &) = default ;
    ListProhibitedPoliciesRequest& operator=(ListProhibitedPoliciesRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        ...
        && this->policyIds_ == nullptr && this->policyType_ == nullptr && this->softwareId_ == nullptr && this->softwareName_ == nullptr && this->tagId_ == nullptr
        && this->tagName_ == nullptr && this->userGroupId_ == nullptr; };
    // currentPage Field Functions 
    bool hasCurrentPage() const { return this->currentPage_ != nullptr;};
    void deleteCurrentPage() { this->currentPage_ = nullptr;};
    inline int64_t getCurrentPage() const { DARABONBA_PTR_GET_DEFAULT(currentPage_, 0L) };
    inline ListProhibitedPoliciesRequest& setCurrentPage(int64_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline ListProhibitedPoliciesRequest& setEnabled(bool enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
    ...
    inline ListProhibitedPoliciesRequest& setMatchMode(string matchMode) { DARABONBA_PTR_SET_VALUE(matchMode_, matchMode) };
    ...
    inline ListProhibitedPoliciesRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListProhibitedPoliciesRequest& setObjectType(string objectType) { DARABONBA_PTR_SET_VALUE(objectType_, objectType) };
    ...
    inline ListProhibitedPoliciesRequest& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListProhibitedPoliciesRequest& setPolicyIds(const vector<string> & policyIds) { DARABONBA_PTR_SET_VALUE(policyIds_, policyIds) };
    inline ListProhibitedPoliciesRequest& setPolicyIds(vector<string> && policyIds) { DARABONBA_PTR_SET_RVALUE(policyIds_, policyIds) };
    ...
    inline ListProhibitedPoliciesRequest& setPolicyType(string policyType) { DARABONBA_PTR_SET_VALUE(policyType_, policyType) };


    // softwareId Field Functions 
    bool hasSoftwareId() const { return this->softwareId_ != nullptr;};
    void deleteSoftwareId() { this->softwareId_ = nullptr;};
    inline const ListProhibitedPoliciesRequest::SoftwareId & getSoftwareId() const { DARABONBA_PTR_GET_CONST(softwareId_, ListProhibitedPoliciesRequest::SoftwareId) };
    inline ListProhibitedPoliciesRequest::SoftwareId getSoftwareId() { DARABONBA_PTR_GET(softwareId_, ListProhibitedPoliciesRequest::SoftwareId) };
    inline ListProhibitedPoliciesRequest& setSoftwareId(const ListProhibitedPoliciesRequest::SoftwareId & softwareId) { DARABONBA_PTR_SET_VALUE(softwareId_, softwareId) };
    inline ListProhibitedPoliciesRequest& setSoftwareId(ListProhibitedPoliciesRequest::SoftwareId && softwareId) { DARABONBA_PTR_SET_RVALUE(softwareId_, softwareId) };
    ...
    inline ListProhibitedPoliciesRequest& setSoftwareName(string softwareName) { DARABONBA_PTR_SET_VALUE(softwareName_, softwareName) };
    ...
    inline ListProhibitedPoliciesRequest& setTagId(string tagId) { DARABONBA_PTR_SET_VALUE(tagId_, tagId) };
    ...
    inline ListProhibitedPoliciesRequest& setTagName(string tagName) { DARABONBA_PTR_SET_VALUE(tagName_, tagName) };
    ...
    inline ListProhibitedPoliciesRequest& setUserGroupId(string userGroupId) { DARABONBA_PTR_SET_VALUE(userGroupId_, userGroupId) };
  ...
  protected:
    ...
    shared_ptr<ListProhibitedPoliciesRequest::SoftwareId> softwareId_ {};
