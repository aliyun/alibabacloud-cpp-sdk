...
namespace Models
{
  ...
  public:
    ...
    inline const GetConnectorResponseBody::Connector & getConnector() const { DARABONBA_PTR_GET_CONST(connector_, GetConnectorResponseBody::Connector) };
    inline GetConnectorResponseBody::Connector getConnector() { DARABONBA_PTR_GET(connector_, GetConnectorResponseBody::Connector) };
    inline GetConnectorResponseBody& setConnector(const GetConnectorResponseBody::Connector & connector) { DARABONBA_PTR_SET_VALUE(connector_, connector) };
    inline GetConnectorResponseBody& setConnector(GetConnectorResponseBody::Connector && connector) { DARABONBA_PTR_SET_RVALUE(connector_, connector) };
  ...
  protected:
    // Connector。
    shared_ptr<GetConnectorResponseBody::Connector> connector_ {};
    // Id of the request
