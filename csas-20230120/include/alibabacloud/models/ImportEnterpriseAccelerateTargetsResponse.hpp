...
namespace Models
{
  ...
  public:
    ...
    inline const ImportEnterpriseAccelerateTargetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImportEnterpriseAccelerateTargetsResponseBody) };
    inline ImportEnterpriseAccelerateTargetsResponseBody getBody() { DARABONBA_PTR_GET(body_, ImportEnterpriseAccelerateTargetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImportEnterpriseAccelerateTargetsResponseBody> body_ {};
  };
