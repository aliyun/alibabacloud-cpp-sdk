...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWmExtractTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateWmExtractTaskResponseBody) };
    inline CreateWmExtractTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateWmExtractTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateWmExtractTaskResponseBody> body_ {};
  };
