...
#ifndef ALIBABACLOUD_MODELS_CREATEWMBASEIMAGEREQUESTIMAGECONTROLTEXTVISIBLECONTROL_HPP_
#define ALIBABACLOUD_MODELS_CREATEWMBASEIMAGEREQUESTIMAGECONTROLTEXTVISIBLECONTROL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateWmBaseImageRequestImageControlTextVisibleControl& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateWmBaseImageRequestImageControlTextVisibleControl& obj) { 
    ...
    CreateWmBaseImageRequestImageControlTextVisibleControl() = default ;
    CreateWmBaseImageRequestImageControlTextVisibleControl(const CreateWmBaseImageRequestImageControlTextVisibleControl &) = default ;
    CreateWmBaseImageRequestImageControlTextVisibleControl(CreateWmBaseImageRequestImageControlTextVisibleControl &&) = default ;
    CreateWmBaseImageRequestImageControlTextVisibleControl(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateWmBaseImageRequestImageControlTextVisibleControl() = default ;
    CreateWmBaseImageRequestImageControlTextVisibleControl& operator=(const CreateWmBaseImageRequestImageControlTextVisibleControl &) = default ;
    CreateWmBaseImageRequestImageControlTextVisibleControl& operator=(CreateWmBaseImageRequestImageControlTextVisibleControl &&) = default ;
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setAngle(int64_t angle) { DARABONBA_PTR_SET_VALUE(angle_, angle) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setFontColor(string fontColor) { DARABONBA_PTR_SET_VALUE(fontColor_, fontColor) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setFontSize(int64_t fontSize) { DARABONBA_PTR_SET_VALUE(fontSize_, fontSize) };


    // margin Field Functions 
    bool hasMargin() const { return this->margin_ != nullptr;};
    void deleteMargin() { this->margin_ = nullptr;};
    inline const Models::CreateWmBaseImageRequestImageControlTextVisibleControlMargin & margin() const { DARABONBA_PTR_GET_CONST(margin_, Models::CreateWmBaseImageRequestImageControlTextVisibleControlMargin) };
    inline Models::CreateWmBaseImageRequestImageControlTextVisibleControlMargin margin() { DARABONBA_PTR_GET(margin_, Models::CreateWmBaseImageRequestImageControlTextVisibleControlMargin) };
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setMargin(const Models::CreateWmBaseImageRequestImageControlTextVisibleControlMargin & margin) { DARABONBA_PTR_SET_VALUE(margin_, margin) };
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setMargin(Models::CreateWmBaseImageRequestImageControlTextVisibleControlMargin && margin) { DARABONBA_PTR_SET_RVALUE(margin_, margin) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setMode(string mode) { DARABONBA_PTR_SET_VALUE(mode_, mode) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setOpacity(int32_t opacity) { DARABONBA_PTR_SET_VALUE(opacity_, opacity) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setPosAx(float posAx) { DARABONBA_PTR_SET_VALUE(posAx_, posAx) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setPosAy(float posAy) { DARABONBA_PTR_SET_VALUE(posAy_, posAy) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setPosX(int64_t posX) { DARABONBA_PTR_SET_VALUE(posX_, posX) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setPosY(int64_t posY) { DARABONBA_PTR_SET_VALUE(posY_, posY) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setSpaceX(int64_t spaceX) { DARABONBA_PTR_SET_VALUE(spaceX_, spaceX) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setSpaceY(int64_t spaceY) { DARABONBA_PTR_SET_VALUE(spaceY_, spaceY) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setVisible(bool visible) { DARABONBA_PTR_SET_VALUE(visible_, visible) };
    ...
    inline CreateWmBaseImageRequestImageControlTextVisibleControl& setVisibleText(string visibleText) { DARABONBA_PTR_SET_VALUE(visibleText_, visibleText) };
  ...
  protected:
    ...
    std::shared_ptr<Models::CreateWmBaseImageRequestImageControlTextVisibleControlMargin> margin_ = nullptr;
