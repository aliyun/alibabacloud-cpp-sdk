...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePrivateAccessPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePrivateAccessPolicyResponseBody) };
    inline DeletePrivateAccessPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePrivateAccessPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePrivateAccessPolicyResponseBody> body_ {};
  };
