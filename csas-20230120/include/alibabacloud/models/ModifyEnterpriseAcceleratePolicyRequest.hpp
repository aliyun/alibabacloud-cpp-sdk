...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accelerationType_ == nullptr
        && return this->description_ == nullptr && return this->eapId_ == nullptr && return this->name_ == nullptr && return this->onTls_ == nullptr && return this->priority_ == nullptr
        && return this->showInClient_ == nullptr && return this->upstreamHost_ == nullptr && return this->upstreamPort_ == nullptr && return this->upstreamType_ == nullptr && return this->userAttributeGroup_ == nullptr; };
