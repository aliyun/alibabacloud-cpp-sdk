...
namespace Models
{
  ...
  public:
    ...
    inline string getPublicKeyEndpoint() const { DARABONBA_PTR_GET_DEFAULT(publicKeyEndpoint_, "") };
    ...
    inline string getSamlMetadata() const { DARABONBA_PTR_GET_DEFAULT(samlMetadata_, "") };
