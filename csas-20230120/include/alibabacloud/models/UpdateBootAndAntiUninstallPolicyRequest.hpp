...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowReport_ == nullptr
        && this->blockContent_ == nullptr && this->isAntiUninstall_ == nullptr && this->isBoot_ == nullptr && this->userGroupIds_ == nullptr && this->whitelistUsers_ == nullptr; };
    ...
    inline const UpdateBootAndAntiUninstallPolicyRequest::BlockContent & getBlockContent() const { DARABONBA_PTR_GET_CONST(blockContent_, UpdateBootAndAntiUninstallPolicyRequest::BlockContent) };
    inline UpdateBootAndAntiUninstallPolicyRequest::BlockContent getBlockContent() { DARABONBA_PTR_GET(blockContent_, UpdateBootAndAntiUninstallPolicyRequest::BlockContent) };
    inline UpdateBootAndAntiUninstallPolicyRequest& setBlockContent(const UpdateBootAndAntiUninstallPolicyRequest::BlockContent & blockContent) { DARABONBA_PTR_SET_VALUE(blockContent_, blockContent) };
    inline UpdateBootAndAntiUninstallPolicyRequest& setBlockContent(UpdateBootAndAntiUninstallPolicyRequest::BlockContent && blockContent) { DARABONBA_PTR_SET_RVALUE(blockContent_, blockContent) };
