...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePrivateAccessPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePrivateAccessPolicyResponseBody) };
    inline UpdatePrivateAccessPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePrivateAccessPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePrivateAccessPolicyResponseBody> body_ {};
  };
