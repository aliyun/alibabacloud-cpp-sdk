...
#ifndef ALIBABACLOUD_MODELS_UPDATECONNECTORCLIENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATECONNECTORCLIENTRESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateConnectorClientResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateConnectorClientResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(ConnectorClient, connectorClient_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateConnectorClientResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(ConnectorClient, connectorClient_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    UpdateConnectorClientResponseBody() = default ;
    UpdateConnectorClientResponseBody(const UpdateConnectorClientResponseBody &) = default ;
    UpdateConnectorClientResponseBody(UpdateConnectorClientResponseBody &&) = default ;
    UpdateConnectorClientResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateConnectorClientResponseBody() = default ;
    UpdateConnectorClientResponseBody& operator=(const UpdateConnectorClientResponseBody &) = default ;
    UpdateConnectorClientResponseBody& operator=(UpdateConnectorClientResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->CPUSize_ == nullptr
        && this->connectionStatus_ == nullptr && this->connectorId_ == nullptr && this->createTime_ == nullptr && this->devTag_ == nullptr && this->hosname_ == nullptr
        && this->kernelVersion_ == nullptr && this->memorySize_ == nullptr && this->operationStatus_ == nullptr && this->privateIp_ == nullptr && this->processRunTime_ == nullptr
        && this->publicIp_ == nullptr && this->releaseNotes_ == nullptr && this->status_ == nullptr && this->upgradeStatus_ == nullptr && this->version_ == nullptr
      ...
      inline ConnectorClient& setVersion(string version) { DARABONBA_PTR_SET_VALUE(version_, version) };
    ...
    inline const UpdateConnectorClientResponseBody::ConnectorClient & getConnectorClient() const { DARABONBA_PTR_GET_CONST(connectorClient_, UpdateConnectorClientResponseBody::ConnectorClient) };
    inline UpdateConnectorClientResponseBody::ConnectorClient getConnectorClient() { DARABONBA_PTR_GET(connectorClient_, UpdateConnectorClientResponseBody::ConnectorClient) };
    inline UpdateConnectorClientResponseBody& setConnectorClient(const UpdateConnectorClientResponseBody::ConnectorClient & connectorClient) { DARABONBA_PTR_SET_VALUE(connectorClient_, connectorClient) };
    inline UpdateConnectorClientResponseBody& setConnectorClient(UpdateConnectorClientResponseBody::ConnectorClient && connectorClient) { DARABONBA_PTR_SET_RVALUE(connectorClient_, connectorClient) };
    ...
    inline UpdateConnectorClientResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // ConnectorClient。
    shared_ptr<UpdateConnectorClientResponseBody::ConnectorClient> connectorClient_ {};
    // The request ID.
