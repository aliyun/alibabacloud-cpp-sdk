...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListRegistrationPoliciesResponseBody::Policies> & getPolicies() const { DARABONBA_PTR_GET_CONST(policies_, vector<ListRegistrationPoliciesResponseBody::Policies>) };
    inline vector<ListRegistrationPoliciesResponseBody::Policies> getPolicies() { DARABONBA_PTR_GET(policies_, vector<ListRegistrationPoliciesResponseBody::Policies>) };
    inline ListRegistrationPoliciesResponseBody& setPolicies(const vector<ListRegistrationPoliciesResponseBody::Policies> & policies) { DARABONBA_PTR_SET_VALUE(policies_, policies) };
    inline ListRegistrationPoliciesResponseBody& setPolicies(vector<ListRegistrationPoliciesResponseBody::Policies> && policies) { DARABONBA_PTR_SET_RVALUE(policies_, policies) };
  ...
  protected:
    shared_ptr<vector<ListRegistrationPoliciesResponseBody::Policies>> policies_ {};
