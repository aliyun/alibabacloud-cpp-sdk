  ...
  public:
    ...
    public:
      ...
      public:
        ...
        void deleteExternalProcessId() { this->externalProcessId_ = nullptr;};
        inline string getExternalProcessId() const { DARABONBA_PTR_GET_DEFAULT(externalProcessId_, "") };
        inline PeripheralBlockPolicies& setExternalProcessId(string externalProcessId) { DARABONBA_PTR_SET_VALUE(externalProcessId_, externalProcessId) };


        // fieldMap Field Functions 
        bool hasFieldMap() const { return this->fieldMap_ != nullptr;};
        void deleteFieldMap() { this->fieldMap_ = nullptr;};
        inline const vector<PeripheralBlockPolicies::FieldMap> & getFieldMap() const { DARABONBA_PTR_GET_CONST(fieldMap_, vector<PeripheralBlockPolicies::FieldMap>) };
        inline vector<PeripheralBlockPolicies::FieldMap> getFieldMap() { DARABONBA_PTR_GET(fieldMap_, vector<PeripheralBlockPolicies::FieldMap>) };
        inline PeripheralBlockPolicies& setFieldMap(const vector<PeripheralBlockPolicies::FieldMap> & fieldMap) { DARABONBA_PTR_SET_VALUE(fieldMap_, fieldMap) };
        inline PeripheralBlockPolicies& setFieldMap(vector<PeripheralBlockPolicies::FieldMap> && fieldMap) { DARABONBA_PTR_SET_RVALUE(fieldMap_, fieldMap) };
    ...
    inline const GetApprovalProcessResponseBody::Process & getProcess() const { DARABONBA_PTR_GET_CONST(process_, GetApprovalProcessResponseBody::Process) };
    inline GetApprovalProcessResponseBody::Process getProcess() { DARABONBA_PTR_GET(process_, GetApprovalProcessResponseBody::Process) };
    inline GetApprovalProcessResponseBody& setProcess(const GetApprovalProcessResponseBody::Process & process) { DARABONBA_PTR_SET_VALUE(process_, process) };
    inline GetApprovalProcessResponseBody& setProcess(GetApprovalProcessResponseBody::Process && process) { DARABONBA_PTR_SET_RVALUE(process_, process) };
