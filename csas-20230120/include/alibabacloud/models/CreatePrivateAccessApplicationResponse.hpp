...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePrivateAccessApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePrivateAccessApplicationResponseBody) };
    inline CreatePrivateAccessApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePrivateAccessApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePrivateAccessApplicationResponseBody> body_ {};
  };
