...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addresses_ == nullptr
        && return this->browserAccessStatus_ == nullptr && return this->description_ == nullptr && return this->l7Config_ == nullptr && return this->l7ProxyDomainAutomaticPrefix_ == nullptr && return this->l7ProxyDomainCustom_ == nullptr
