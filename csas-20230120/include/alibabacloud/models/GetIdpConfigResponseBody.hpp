...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getGetGroupUrl() const { DARABONBA_PTR_GET_DEFAULT(getGroupUrl_, "") };
      inline Data& setGetGroupUrl(string getGroupUrl) { DARABONBA_PTR_SET_VALUE(getGroupUrl_, getGroupUrl) };
      ...
      inline Data& setIdpMetadata(string idpMetadata) { DARABONBA_PTR_SET_VALUE(idpMetadata_, idpMetadata) };
      ...
      inline string getMfaConfigType() const { DARABONBA_PTR_GET_DEFAULT(mfaConfigType_, "") };
      inline Data& setMfaConfigType(string mfaConfigType) { DARABONBA_PTR_SET_VALUE(mfaConfigType_, mfaConfigType) };
      ...
      inline Data& setMobileLoginType(string mobileLoginType) { DARABONBA_PTR_SET_VALUE(mobileLoginType_, mobileLoginType) };
      ...
      inline Data& setMobileMfaConfigType(string mobileMfaConfigType) { DARABONBA_PTR_SET_VALUE(mobileMfaConfigType_, mobileMfaConfigType) };
      ...
      inline Data& setMultiIdpInfo(string multiIdpInfo) { DARABONBA_PTR_SET_VALUE(multiIdpInfo_, multiIdpInfo) };
      ...
      inline Data& setPcLoginType(string pcLoginType) { DARABONBA_PTR_SET_VALUE(pcLoginType_, pcLoginType) };
      ...
      inline string getVerifyAesKey() const { DARABONBA_PTR_GET_DEFAULT(verifyAesKey_, "") };
      inline Data& setVerifyAesKey(string verifyAesKey) { DARABONBA_PTR_SET_VALUE(verifyAesKey_, verifyAesKey) };
      ...
      inline Data& setVerifyToken(string verifyToken) { DARABONBA_PTR_SET_VALUE(verifyToken_, verifyToken) };
      ...
      inline string getVerifyUrl() const { DARABONBA_PTR_GET_DEFAULT(verifyUrl_, "") };
      inline Data& setVerifyUrl(string verifyUrl) { DARABONBA_PTR_SET_VALUE(verifyUrl_, verifyUrl) };
    ...
    inline const GetIdpConfigResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetIdpConfigResponseBody::Data) };
    inline GetIdpConfigResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetIdpConfigResponseBody::Data) };
    inline GetIdpConfigResponseBody& setData(const GetIdpConfigResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetIdpConfigResponseBody& setData(GetIdpConfigResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
