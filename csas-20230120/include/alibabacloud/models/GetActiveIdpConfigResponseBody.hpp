...
namespace Models
{
  ...
  public:
    ...
    inline const GetActiveIdpConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetActiveIdpConfigResponseBodyData) };
    inline GetActiveIdpConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetActiveIdpConfigResponseBodyData) };
    inline GetActiveIdpConfigResponseBody& setData(const GetActiveIdpConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetActiveIdpConfigResponseBody& setData(GetActiveIdpConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetActiveIdpConfigResponseBodyData> data_ = nullptr;
