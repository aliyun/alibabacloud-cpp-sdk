...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWmBaseImageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateWmBaseImageResponseBody) };
    inline CreateWmBaseImageResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateWmBaseImageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateWmBaseImageResponseBody> body_ {};
  };
