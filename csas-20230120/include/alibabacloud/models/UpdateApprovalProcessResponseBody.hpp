  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->appUninstallPolicies_ == nullptr
        ...
        && this->peripheraBlockPolicies_ == nullptr && this->privateAccessBlockPolicies_ == nullptr && this->processId_ == nullptr && this->processName_ == nullptr && this->processNodes_ == nullptr
