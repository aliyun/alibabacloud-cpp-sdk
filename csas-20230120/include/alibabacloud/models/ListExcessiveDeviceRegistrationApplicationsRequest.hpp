...
#ifndef ALIBABACLOUD_MODELS_LISTEXCESSIVEDEVICEREGISTRATIONAPPLICATIONSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTEXCESSIVEDEVICEREGISTRATIONAPPLICATIONSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListExcessiveDeviceRegistrationApplicationsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListExcessiveDeviceRegistrationApplicationsRequest& obj) { 
    ...
    ListExcessiveDeviceRegistrationApplicationsRequest() = default ;
    ListExcessiveDeviceRegistrationApplicationsRequest(const ListExcessiveDeviceRegistrationApplicationsRequest &) = default ;
    ListExcessiveDeviceRegistrationApplicationsRequest(ListExcessiveDeviceRegistrationApplicationsRequest &&) = default ;
    ListExcessiveDeviceRegistrationApplicationsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListExcessiveDeviceRegistrationApplicationsRequest() = default ;
    ListExcessiveDeviceRegistrationApplicationsRequest& operator=(const ListExcessiveDeviceRegistrationApplicationsRequest &) = default ;
    ListExcessiveDeviceRegistrationApplicationsRequest& operator=(ListExcessiveDeviceRegistrationApplicationsRequest &&) = default ;
