...
#ifndef ALIBABACLOUD_MODELS_UPDATEUSERDEVICESSTATUSRESPONSEBODYDEVICES_HPP_
#define ALIBABACLOUD_MODELS_UPDATEUSERDEVICESSTATUSRESPONSEBODYDEVICES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateUserDevicesStatusResponseBodyDevices& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateUserDevicesStatusResponseBodyDevices& obj) { 
    ...
    UpdateUserDevicesStatusResponseBodyDevices() = default ;
    UpdateUserDevicesStatusResponseBodyDevices(const UpdateUserDevicesStatusResponseBodyDevices &) = default ;
    UpdateUserDevicesStatusResponseBodyDevices(UpdateUserDevicesStatusResponseBodyDevices &&) = default ;
    UpdateUserDevicesStatusResponseBodyDevices(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateUserDevicesStatusResponseBodyDevices() = default ;
    UpdateUserDevicesStatusResponseBodyDevices& operator=(const UpdateUserDevicesStatusResponseBodyDevices &) = default ;
    UpdateUserDevicesStatusResponseBodyDevices& operator=(UpdateUserDevicesStatusResponseBodyDevices &&) = default ;
    ...
    virtual bool empty() const override { this->appStatus_ != nullptr
        ...
        && this->disk_ != nullptr && this->dlpStatus_ != nullptr && this->hostname_ != nullptr && this->iaStatus_ != nullptr && this->innerIP_ != nullptr
        && this->mac_ != nullptr && this->memory_ != nullptr && this->nacStatus_ != nullptr && this->netInterfaceInfo_ != nullptr && this->paStatus_ != nullptr
        && this->saseUserId_ != nullptr && this->sharingStatus_ != nullptr && this->srcIP_ != nullptr && this->updateTime_ != nullptr && this->username_ != nullptr; };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setAppStatus(string appStatus) { DARABONBA_PTR_SET_VALUE(appStatus_, appStatus) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setAppVersion(string appVersion) { DARABONBA_PTR_SET_VALUE(appVersion_, appVersion) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setCPU(string CPU) { DARABONBA_PTR_SET_VALUE(CPU_, CPU) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setDepartment(string department) { DARABONBA_PTR_SET_VALUE(department_, department) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setDeviceBelong(string deviceBelong) { DARABONBA_PTR_SET_VALUE(deviceBelong_, deviceBelong) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setDeviceModel(string deviceModel) { DARABONBA_PTR_SET_VALUE(deviceModel_, deviceModel) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setDeviceStatus(string deviceStatus) { DARABONBA_PTR_SET_VALUE(deviceStatus_, deviceStatus) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setDeviceTag(string deviceTag) { DARABONBA_PTR_SET_VALUE(deviceTag_, deviceTag) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setDeviceType(string deviceType) { DARABONBA_PTR_SET_VALUE(deviceType_, deviceType) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setDeviceVersion(string deviceVersion) { DARABONBA_PTR_SET_VALUE(deviceVersion_, deviceVersion) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setDisk(string disk) { DARABONBA_PTR_SET_VALUE(disk_, disk) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setDlpStatus(string dlpStatus) { DARABONBA_PTR_SET_VALUE(dlpStatus_, dlpStatus) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setHostname(string hostname) { DARABONBA_PTR_SET_VALUE(hostname_, hostname) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setIaStatus(string iaStatus) { DARABONBA_PTR_SET_VALUE(iaStatus_, iaStatus) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setInnerIP(string innerIP) { DARABONBA_PTR_SET_VALUE(innerIP_, innerIP) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setMac(string mac) { DARABONBA_PTR_SET_VALUE(mac_, mac) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setMemory(string memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setNacStatus(string nacStatus) { DARABONBA_PTR_SET_VALUE(nacStatus_, nacStatus) };
    ...
    inline const vector<Models::UpdateUserDevicesStatusResponseBodyDevicesNetInterfaceInfo> & netInterfaceInfo() const { DARABONBA_PTR_GET_CONST(netInterfaceInfo_, vector<Models::UpdateUserDevicesStatusResponseBodyDevicesNetInterfaceInfo>) };
    inline vector<Models::UpdateUserDevicesStatusResponseBodyDevicesNetInterfaceInfo> netInterfaceInfo() { DARABONBA_PTR_GET(netInterfaceInfo_, vector<Models::UpdateUserDevicesStatusResponseBodyDevicesNetInterfaceInfo>) };
    inline UpdateUserDevicesStatusResponseBodyDevices& setNetInterfaceInfo(const vector<Models::UpdateUserDevicesStatusResponseBodyDevicesNetInterfaceInfo> & netInterfaceInfo) { DARABONBA_PTR_SET_VALUE(netInterfaceInfo_, netInterfaceInfo) };
    inline UpdateUserDevicesStatusResponseBodyDevices& setNetInterfaceInfo(vector<Models::UpdateUserDevicesStatusResponseBodyDevicesNetInterfaceInfo> && netInterfaceInfo) { DARABONBA_PTR_SET_RVALUE(netInterfaceInfo_, netInterfaceInfo) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setPaStatus(string paStatus) { DARABONBA_PTR_SET_VALUE(paStatus_, paStatus) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setSaseUserId(string saseUserId) { DARABONBA_PTR_SET_VALUE(saseUserId_, saseUserId) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setSharingStatus(bool sharingStatus) { DARABONBA_PTR_SET_VALUE(sharingStatus_, sharingStatus) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setSrcIP(string srcIP) { DARABONBA_PTR_SET_VALUE(srcIP_, srcIP) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline UpdateUserDevicesStatusResponseBodyDevices& setUsername(string username) { DARABONBA_PTR_SET_VALUE(username_, username) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::UpdateUserDevicesStatusResponseBodyDevicesNetInterfaceInfo>> netInterfaceInfo_ = nullptr;
