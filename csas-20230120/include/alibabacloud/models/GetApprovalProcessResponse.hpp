...
namespace Models
{
  ...
  public:
    ...
    inline const GetApprovalProcessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetApprovalProcessResponseBody) };
    inline GetApprovalProcessResponseBody getBody() { DARABONBA_PTR_GET(body_, GetApprovalProcessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetApprovalProcessResponseBody> body_ {};
  };
