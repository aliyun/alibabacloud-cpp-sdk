...
#ifndef ALIBABACLOUD_MODELS_UPDATEPRIVATEACCESSPOLICYREQUESTCUSTOMUSERATTRIBUTES_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPRIVATEACCESSPOLICYREQUESTCUSTOMUSERATTRIBUTES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdatePrivateAccessPolicyRequestCustomUserAttributes& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdatePrivateAccessPolicyRequestCustomUserAttributes& obj) { 
    ...
    UpdatePrivateAccessPolicyRequestCustomUserAttributes() = default ;
    UpdatePrivateAccessPolicyRequestCustomUserAttributes(const UpdatePrivateAccessPolicyRequestCustomUserAttributes &) = default ;
    UpdatePrivateAccessPolicyRequestCustomUserAttributes(UpdatePrivateAccessPolicyRequestCustomUserAttributes &&) = default ;
    UpdatePrivateAccessPolicyRequestCustomUserAttributes(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdatePrivateAccessPolicyRequestCustomUserAttributes() = default ;
    UpdatePrivateAccessPolicyRequestCustomUserAttributes& operator=(const UpdatePrivateAccessPolicyRequestCustomUserAttributes &) = default ;
    UpdatePrivateAccessPolicyRequestCustomUserAttributes& operator=(UpdatePrivateAccessPolicyRequestCustomUserAttributes &&) = default ;
    ...
    inline UpdatePrivateAccessPolicyRequestCustomUserAttributes& setIdpId(int32_t idpId) { DARABONBA_PTR_SET_VALUE(idpId_, idpId) };
    ...
    inline UpdatePrivateAccessPolicyRequestCustomUserAttributes& setRelation(string relation) { DARABONBA_PTR_SET_VALUE(relation_, relation) };
    ...
    inline UpdatePrivateAccessPolicyRequestCustomUserAttributes& setUserGroupType(string userGroupType) { DARABONBA_PTR_SET_VALUE(userGroupType_, userGroupType) };
    ...
    inline UpdatePrivateAccessPolicyRequestCustomUserAttributes& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
