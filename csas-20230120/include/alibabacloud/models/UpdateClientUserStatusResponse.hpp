...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateClientUserStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateClientUserStatusResponseBody) };
    inline UpdateClientUserStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateClientUserStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateClientUserStatusResponseBody> body_ {};
  };
