...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->applications_ != nullptr
        && this->connectorClients_ != nullptr && this->connectorId_ != nullptr && this->createTime_ != nullptr && this->name_ != nullptr && this->regionId_ != nullptr
        && this->status_ != nullptr && this->switchStatus_ != nullptr && this->upgradeTime_ != nullptr; };
