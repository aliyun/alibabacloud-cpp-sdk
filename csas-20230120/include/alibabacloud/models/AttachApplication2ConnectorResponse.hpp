...
namespace Models
{
  ...
  public:
    ...
    inline const AttachApplication2ConnectorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachApplication2ConnectorResponseBody) };
    inline AttachApplication2ConnectorResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachApplication2ConnectorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachApplication2ConnectorResponseBody> body_ {};
  };
