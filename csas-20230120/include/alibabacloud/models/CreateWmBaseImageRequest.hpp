...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->height_ == nullptr
        && return this->imageControl_ == nullptr && return this->opacity_ == nullptr && return this->scale_ == nullptr && return this->width_ == nullptr && return this->wmInfoBytesB64_ == nullptr
    ...
    inline const CreateWmBaseImageRequestImageControl & imageControl() const { DARABONBA_PTR_GET_CONST(imageControl_, CreateWmBaseImageRequestImageControl) };
    inline CreateWmBaseImageRequestImageControl imageControl() { DARABONBA_PTR_GET(imageControl_, CreateWmBaseImageRequestImageControl) };
    inline CreateWmBaseImageRequest& setImageControl(const CreateWmBaseImageRequestImageControl & imageControl) { DARABONBA_PTR_SET_VALUE(imageControl_, imageControl) };
    inline CreateWmBaseImageRequest& setImageControl(CreateWmBaseImageRequestImageControl && imageControl) { DARABONBA_PTR_SET_RVALUE(imageControl_, imageControl) };
  ...
  protected:
    ...
    std::shared_ptr<CreateWmBaseImageRequestImageControl> imageControl_ = nullptr;
    // This parameter is required.
