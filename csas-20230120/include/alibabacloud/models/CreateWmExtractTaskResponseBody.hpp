...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWmExtractTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateWmExtractTaskResponseBody::Data) };
    inline CreateWmExtractTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateWmExtractTaskResponseBody::Data) };
    inline CreateWmExtractTaskResponseBody& setData(const CreateWmExtractTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateWmExtractTaskResponseBody& setData(CreateWmExtractTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
