...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getDnsNames() const { DARABONBA_PTR_GET_CONST(dnsNames_, vector<string>) };
    inline vector<string> getDnsNames() { DARABONBA_PTR_GET(dnsNames_, vector<string>) };
    ...
    inline int64_t getExpTimeUnix() const { DARABONBA_PTR_GET_DEFAULT(expTimeUnix_, 0L) };
    ...
    inline int64_t getGmtCreateUnix() const { DARABONBA_PTR_GET_DEFAULT(gmtCreateUnix_, 0L) };
    ...
    inline int64_t getGmtModifiedUnix() const { DARABONBA_PTR_GET_DEFAULT(gmtModifiedUnix_, 0L) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> dnsNames_ {};
    shared_ptr<int64_t> expTimeUnix_ {};
    shared_ptr<int64_t> gmtCreateUnix_ {};
    shared_ptr<int64_t> gmtModifiedUnix_ {};
