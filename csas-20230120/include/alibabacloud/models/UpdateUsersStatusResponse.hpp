...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateUsersStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateUsersStatusResponseBody) };
    inline UpdateUsersStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateUsersStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateUsersStatusResponseBody> body_ {};
  };
