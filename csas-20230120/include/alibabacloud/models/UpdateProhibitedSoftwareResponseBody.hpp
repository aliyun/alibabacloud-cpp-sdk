...
#ifndef ALIBABACLOUD_MODELS_UPDATEPROHIBITEDSOFTWARERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPROHIBITEDSOFTWARERESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateProhibitedSoftwareResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateProhibitedSoftwareResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Software, software_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateProhibitedSoftwareResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Software, software_);
    };
    UpdateProhibitedSoftwareResponseBody() = default ;
    UpdateProhibitedSoftwareResponseBody(const UpdateProhibitedSoftwareResponseBody &) = default ;
    UpdateProhibitedSoftwareResponseBody(UpdateProhibitedSoftwareResponseBody &&) = default ;
    UpdateProhibitedSoftwareResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateProhibitedSoftwareResponseBody() = default ;
    UpdateProhibitedSoftwareResponseBody& operator=(const UpdateProhibitedSoftwareResponseBody &) = default ;
    UpdateProhibitedSoftwareResponseBody& operator=(UpdateProhibitedSoftwareResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->createTime_ == nullptr
        && this->description_ == nullptr && this->linuxProcesses_ == nullptr && this->macOSProcesses_ == nullptr && this->name_ == nullptr && this->policyIds_ == nullptr
        && this->softwareId_ == nullptr && this->tagIds_ == nullptr && this->windowsProcesses_ == nullptr; };
    ...
    inline UpdateProhibitedSoftwareResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // software Field Functions 
    bool hasSoftware() const { return this->software_ != nullptr;};
    void deleteSoftware() { this->software_ = nullptr;};
    inline const UpdateProhibitedSoftwareResponseBody::Software & getSoftware() const { DARABONBA_PTR_GET_CONST(software_, UpdateProhibitedSoftwareResponseBody::Software) };
    inline UpdateProhibitedSoftwareResponseBody::Software getSoftware() { DARABONBA_PTR_GET(software_, UpdateProhibitedSoftwareResponseBody::Software) };
    inline UpdateProhibitedSoftwareResponseBody& setSoftware(const UpdateProhibitedSoftwareResponseBody::Software & software) { DARABONBA_PTR_SET_VALUE(software_, software) };
    inline UpdateProhibitedSoftwareResponseBody& setSoftware(UpdateProhibitedSoftwareResponseBody::Software && software) { DARABONBA_PTR_SET_RVALUE(software_, software) };
  ...
  protected:
    ...
    shared_ptr<UpdateProhibitedSoftwareResponseBody::Software> software_ {};
  };
