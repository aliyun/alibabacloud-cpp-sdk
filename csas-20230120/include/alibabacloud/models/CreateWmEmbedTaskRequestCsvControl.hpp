...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->embedBitsNumberInEachTime_ == nullptr
        && return this->embedColumn_ == nullptr && return this->embedDensity_ == nullptr && return this->embedPrecision_ == nullptr && return this->embedTimePosition_ == nullptr && return this->method_ == nullptr
        && return this->timeFormat_ == nullptr; };
