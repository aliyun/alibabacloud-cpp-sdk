...
namespace Models
{
  ...
  public:
    ...
    inline const GetWmEmbedTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetWmEmbedTaskResponseBody) };
    inline GetWmEmbedTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetWmEmbedTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetWmEmbedTaskResponseBody> body_ {};
  };
