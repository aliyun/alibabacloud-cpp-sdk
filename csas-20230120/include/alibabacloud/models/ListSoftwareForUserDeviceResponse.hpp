...
namespace Models
{
  ...
  public:
    ...
    inline const ListSoftwareForUserDeviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSoftwareForUserDeviceResponseBody) };
    inline ListSoftwareForUserDeviceResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSoftwareForUserDeviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSoftwareForUserDeviceResponseBody> body_ {};
  };
