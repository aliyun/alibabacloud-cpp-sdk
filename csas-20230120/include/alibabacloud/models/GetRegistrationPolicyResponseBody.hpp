...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetRegistrationPolicyResponseBody::LimitDetail> & getLimitDetail() const { DARABONBA_PTR_GET_CONST(limitDetail_, vector<GetRegistrationPolicyResponseBody::LimitDetail>) };
    inline vector<GetRegistrationPolicyResponseBody::LimitDetail> getLimitDetail() { DARABONBA_PTR_GET(limitDetail_, vector<GetRegistrationPolicyResponseBody::LimitDetail>) };
    inline GetRegistrationPolicyResponseBody& setLimitDetail(const vector<GetRegistrationPolicyResponseBody::LimitDetail> & limitDetail) { DARABONBA_PTR_SET_VALUE(limitDetail_, limitDetail) };
    inline GetRegistrationPolicyResponseBody& setLimitDetail(vector<GetRegistrationPolicyResponseBody::LimitDetail> && limitDetail) { DARABONBA_PTR_SET_RVALUE(limitDetail_, limitDetail) };
  ...
  protected:
    ...
    shared_ptr<vector<GetRegistrationPolicyResponseBody::LimitDetail>> limitDetail_ {};
