...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->approvalDetail_ == nullptr
        && return this->approvalId_ == nullptr && return this->approvalProgresses_ == nullptr && return this->approvalType_ == nullptr && return this->createTime_ == nullptr && return this->creatorDepartment_ == nullptr
        && return this->creatorDevTag_ == nullptr && return this->creatorUserId_ == nullptr && return this->creatorUsername_ == nullptr && return this->endTimestamp_ == nullptr && return this->policyType_ == nullptr
        && return this->processId_ == nullptr && return this->processName_ == nullptr && return this->reason_ == nullptr && return this->schemaContent_ == nullptr && return this->schemaId_ == nullptr
        && return this->schemaName_ == nullptr && return this->status_ == nullptr; };
