...
namespace Models
{
  ...
  public:
    ...
    inline const ListPrivateAccessApplicationsForDynamicRouteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPrivateAccessApplicationsForDynamicRouteResponseBody) };
    inline ListPrivateAccessApplicationsForDynamicRouteResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPrivateAccessApplicationsForDynamicRouteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPrivateAccessApplicationsForDynamicRouteResponseBody> body_ {};
  };
