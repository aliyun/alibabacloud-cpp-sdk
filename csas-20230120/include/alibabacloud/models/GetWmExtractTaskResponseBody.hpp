...
namespace Models
{
  ...
  public:
    ...
    inline const GetWmExtractTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetWmExtractTaskResponseBodyData) };
    inline GetWmExtractTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetWmExtractTaskResponseBodyData) };
    inline GetWmExtractTaskResponseBody& setData(const GetWmExtractTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetWmExtractTaskResponseBody& setData(GetWmExtractTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetWmExtractTaskResponseBodyData> data_ = nullptr;
