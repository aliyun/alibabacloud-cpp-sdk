...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRegistrationPolicyRequest::CompanyLimitCount & getCompanyLimitCount() const { DARABONBA_PTR_GET_CONST(companyLimitCount_, UpdateRegistrationPolicyRequest::CompanyLimitCount) };
    inline UpdateRegistrationPolicyRequest::CompanyLimitCount getCompanyLimitCount() { DARABONBA_PTR_GET(companyLimitCount_, UpdateRegistrationPolicyRequest::CompanyLimitCount) };
    inline UpdateRegistrationPolicyRequest& setCompanyLimitCount(const UpdateRegistrationPolicyRequest::CompanyLimitCount & companyLimitCount) { DARABONBA_PTR_SET_VALUE(companyLimitCount_, companyLimitCount) };
    inline UpdateRegistrationPolicyRequest& setCompanyLimitCount(UpdateRegistrationPolicyRequest::CompanyLimitCount && companyLimitCount) { DARABONBA_PTR_SET_RVALUE(companyLimitCount_, companyLimitCount) };
    ...
    inline const UpdateRegistrationPolicyRequest::PersonalLimitCount & getPersonalLimitCount() const { DARABONBA_PTR_GET_CONST(personalLimitCount_, UpdateRegistrationPolicyRequest::PersonalLimitCount) };
    inline UpdateRegistrationPolicyRequest::PersonalLimitCount getPersonalLimitCount() { DARABONBA_PTR_GET(personalLimitCount_, UpdateRegistrationPolicyRequest::PersonalLimitCount) };
    inline UpdateRegistrationPolicyRequest& setPersonalLimitCount(const UpdateRegistrationPolicyRequest::PersonalLimitCount & personalLimitCount) { DARABONBA_PTR_SET_VALUE(personalLimitCount_, personalLimitCount) };
    inline UpdateRegistrationPolicyRequest& setPersonalLimitCount(UpdateRegistrationPolicyRequest::PersonalLimitCount && personalLimitCount) { DARABONBA_PTR_SET_RVALUE(personalLimitCount_, personalLimitCount) };
  ...
  protected:
    shared_ptr<UpdateRegistrationPolicyRequest::CompanyLimitCount> companyLimitCount_ {};
    shared_ptr<string> companyLimitType_ {};
    shared_ptr<string> description_ {};
    shared_ptr<string> matchMode_ {};
    shared_ptr<string> name_ {};
    shared_ptr<UpdateRegistrationPolicyRequest::PersonalLimitCount> personalLimitCount_ {};
