...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRegistrationPolicyResponseBody::Policy & getPolicy() const { DARABONBA_PTR_GET_CONST(policy_, UpdateRegistrationPolicyResponseBody::Policy) };
    inline UpdateRegistrationPolicyResponseBody::Policy getPolicy() { DARABONBA_PTR_GET(policy_, UpdateRegistrationPolicyResponseBody::Policy) };
    inline UpdateRegistrationPolicyResponseBody& setPolicy(const UpdateRegistrationPolicyResponseBody::Policy & policy) { DARABONBA_PTR_SET_VALUE(policy_, policy) };
    inline UpdateRegistrationPolicyResponseBody& setPolicy(UpdateRegistrationPolicyResponseBody::Policy && policy) { DARABONBA_PTR_SET_RVALUE(policy_, policy) };
  ...
  protected:
    shared_ptr<UpdateRegistrationPolicyResponseBody::Policy> policy_ {};
