...
namespace Models
{
  ...
  public:
    ...
    inline const AuthReportInterval & getAuthReportInterval() const { DARABONBA_PTR_GET_CONST(authReportInterval_, AuthReportInterval) };
    inline AuthReportInterval getAuthReportInterval() { DARABONBA_PTR_GET(authReportInterval_, AuthReportInterval) };
    ...
    inline const vector<string> & getRecoveryActions() const { DARABONBA_PTR_GET_CONST(recoveryActions_, vector<string>) };
    inline vector<string> getRecoveryActions() { DARABONBA_PTR_GET(recoveryActions_, vector<string>) };
  ...
  protected:
    shared_ptr<AuthReportInterval> authReportInterval_ {};
    // This parameter is required.
    shared_ptr<vector<string>> recoveryActions_ {};
  };
