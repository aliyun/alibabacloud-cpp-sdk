...
namespace Models
{
  ...
  public:
    ...
    inline GetApprovalProcessResponseBodyProcessDeviceRegistrationPoliciesFieldMap& setDisplayFieldValue(string displayFieldValue) { DARABONBA_PTR_SET_VALUE(displayFieldValue_, displayFieldValue) };
