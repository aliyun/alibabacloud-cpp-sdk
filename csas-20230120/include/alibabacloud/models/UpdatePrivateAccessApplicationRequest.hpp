...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addresses_ == nullptr
        && return this->applicationId_ == nullptr && return this->description_ == nullptr && return this->l7Config_ == nullptr && return this->l7ProxyDomainAutomaticPrefix_ == nullptr && return this->l7ProxyDomainCustom_ == nullptr
    ...
    inline const vector<UpdatePrivateAccessApplicationRequestPortRanges> & portRanges() const { DARABONBA_PTR_GET_CONST(portRanges_, vector<UpdatePrivateAccessApplicationRequestPortRanges>) };
    inline vector<UpdatePrivateAccessApplicationRequestPortRanges> portRanges() { DARABONBA_PTR_GET(portRanges_, vector<UpdatePrivateAccessApplicationRequestPortRanges>) };
    inline UpdatePrivateAccessApplicationRequest& setPortRanges(const vector<UpdatePrivateAccessApplicationRequestPortRanges> & portRanges) { DARABONBA_PTR_SET_VALUE(portRanges_, portRanges) };
    inline UpdatePrivateAccessApplicationRequest& setPortRanges(vector<UpdatePrivateAccessApplicationRequestPortRanges> && portRanges) { DARABONBA_PTR_SET_RVALUE(portRanges_, portRanges) };
  ...
  protected:
    ...
    std::shared_ptr<vector<UpdatePrivateAccessApplicationRequestPortRanges>> portRanges_ = nullptr;
