...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->addresses_ != nullptr
        && this->applicationId_ != nullptr && this->description_ != nullptr && this->l7Config_ != nullptr && this->l7ProxyDomainAutomaticPrefix_ != nullptr && this->l7ProxyDomainCustom_ != nullptr
