...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addressGroups_ == nullptr
        ...
        && this->portRanges_ == nullptr && this->protocol_ == nullptr && this->status_ == nullptr && this->tagIds_ == nullptr && this->unauthorizedAccessConfig_ == nullptr; };
    ...
    inline UpdatePrivateAccessApplicationRequest& setUnauthorizedAccessConfig(const PAApplicationUnauthorizedAccessConfig & unauthorizedAccessConfig) { DARABONBA_PTR_SET_VALUE(unauthorizedAccessConfig_, unauthorizedAccessConfig) };
    inline UpdatePrivateAccessApplicationRequest& setUnauthorizedAccessConfig(PAApplicationUnauthorizedAccessConfig && unauthorizedAccessConfig) { DARABONBA_PTR_SET_RVALUE(unauthorizedAccessConfig_, unauthorizedAccessConfig) };
