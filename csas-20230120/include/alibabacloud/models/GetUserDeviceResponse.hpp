...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserDeviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserDeviceResponseBody) };
    inline GetUserDeviceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserDeviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserDeviceResponseBody> body_ {};
  };
