...
#ifndef ALIBABACLOUD_MODELS_LISTUSERDEVICESRESPONSEBODYDEVICES_HPP_
#define ALIBABACLOUD_MODELS_LISTUSERDEVICESRESPONSEBODYDEVICES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListUserDevicesResponseBodyDevices& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListUserDevicesResponseBodyDevices& obj) { 
    ...
    ListUserDevicesResponseBodyDevices() = default ;
    ListUserDevicesResponseBodyDevices(const ListUserDevicesResponseBodyDevices &) = default ;
    ListUserDevicesResponseBodyDevices(ListUserDevicesResponseBodyDevices &&) = default ;
    ListUserDevicesResponseBodyDevices(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListUserDevicesResponseBodyDevices() = default ;
    ListUserDevicesResponseBodyDevices& operator=(const ListUserDevicesResponseBodyDevices &) = default ;
    ListUserDevicesResponseBodyDevices& operator=(ListUserDevicesResponseBodyDevices &&) = default ;
    ...
    virtual bool empty() const override { return this->appStatus_ == nullptr
        ...
        && return this->deviceVersion_ == nullptr && return this->disk_ == nullptr && return this->dlpStatus_ == nullptr && return this->edrStatus_ == nullptr && return this->hostname_ == nullptr
        && return this->iaStatus_ == nullptr && return this->innerIP_ == nullptr && return this->mac_ == nullptr && return this->matchDeviceGroupIds_ == nullptr && return this->memory_ == nullptr
        && return this->nacStatus_ == nullptr && return this->netInterfaceInfo_ == nullptr && return this->paStatus_ == nullptr && return this->saseUserId_ == nullptr && return this->sharingStatus_ == nullptr
        && return this->snBaseBoard_ == nullptr && return this->snBios_ == nullptr && return this->snDiskDrive_ == nullptr && return this->snProcessor_ == nullptr && return this->snSystem_ == nullptr
        && return this->srcIP_ == nullptr && return this->updateTime_ == nullptr && return this->username_ == nullptr && return this->workshop_ == nullptr; };
    ...
    inline ListUserDevicesResponseBodyDevices& setAppStatus(string appStatus) { DARABONBA_PTR_SET_VALUE(appStatus_, appStatus) };
    ...
    inline ListUserDevicesResponseBodyDevices& setAppVersion(string appVersion) { DARABONBA_PTR_SET_VALUE(appVersion_, appVersion) };
    ...
    inline ListUserDevicesResponseBodyDevices& setAutoLoginStatus(string autoLoginStatus) { DARABONBA_PTR_SET_VALUE(autoLoginStatus_, autoLoginStatus) };
    ...
    inline ListUserDevicesResponseBodyDevices& setCPU(string CPU) { DARABONBA_PTR_SET_VALUE(CPU_, CPU) };
    ...
    inline ListUserDevicesResponseBodyDevices& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListUserDevicesResponseBodyDevices& setDepartment(string department) { DARABONBA_PTR_SET_VALUE(department_, department) };
    ...
    inline ListUserDevicesResponseBodyDevices& setDeviceBelong(string deviceBelong) { DARABONBA_PTR_SET_VALUE(deviceBelong_, deviceBelong) };
    ...
    inline ListUserDevicesResponseBodyDevices& setDeviceModel(string deviceModel) { DARABONBA_PTR_SET_VALUE(deviceModel_, deviceModel) };
    ...
    inline ListUserDevicesResponseBodyDevices& setDeviceStatus(string deviceStatus) { DARABONBA_PTR_SET_VALUE(deviceStatus_, deviceStatus) };
    ...
    inline ListUserDevicesResponseBodyDevices& setDeviceTag(string deviceTag) { DARABONBA_PTR_SET_VALUE(deviceTag_, deviceTag) };
    ...
    inline ListUserDevicesResponseBodyDevices& setDeviceType(string deviceType) { DARABONBA_PTR_SET_VALUE(deviceType_, deviceType) };
    ...
    inline ListUserDevicesResponseBodyDevices& setDeviceVersion(string deviceVersion) { DARABONBA_PTR_SET_VALUE(deviceVersion_, deviceVersion) };
    ...
    inline ListUserDevicesResponseBodyDevices& setDisk(string disk) { DARABONBA_PTR_SET_VALUE(disk_, disk) };
    ...
    inline ListUserDevicesResponseBodyDevices& setDlpStatus(string dlpStatus) { DARABONBA_PTR_SET_VALUE(dlpStatus_, dlpStatus) };
    ...
    inline ListUserDevicesResponseBodyDevices& setEdrStatus(string edrStatus) { DARABONBA_PTR_SET_VALUE(edrStatus_, edrStatus) };
    ...
    inline ListUserDevicesResponseBodyDevices& setHostname(string hostname) { DARABONBA_PTR_SET_VALUE(hostname_, hostname) };
    ...
    inline ListUserDevicesResponseBodyDevices& setIaStatus(string iaStatus) { DARABONBA_PTR_SET_VALUE(iaStatus_, iaStatus) };
    ...
    inline ListUserDevicesResponseBodyDevices& setInnerIP(string innerIP) { DARABONBA_PTR_SET_VALUE(innerIP_, innerIP) };
    ...
    inline ListUserDevicesResponseBodyDevices& setMac(string mac) { DARABONBA_PTR_SET_VALUE(mac_, mac) };
    ...
    inline ListUserDevicesResponseBodyDevices& setMatchDeviceGroupIds(const vector<string> & matchDeviceGroupIds) { DARABONBA_PTR_SET_VALUE(matchDeviceGroupIds_, matchDeviceGroupIds) };
    inline ListUserDevicesResponseBodyDevices& setMatchDeviceGroupIds(vector<string> && matchDeviceGroupIds) { DARABONBA_PTR_SET_RVALUE(matchDeviceGroupIds_, matchDeviceGroupIds) };
    ...
    inline ListUserDevicesResponseBodyDevices& setMemory(string memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
    ...
    inline ListUserDevicesResponseBodyDevices& setNacStatus(string nacStatus) { DARABONBA_PTR_SET_VALUE(nacStatus_, nacStatus) };
    ...
    inline const vector<Models::ListUserDevicesResponseBodyDevicesNetInterfaceInfo> & netInterfaceInfo() const { DARABONBA_PTR_GET_CONST(netInterfaceInfo_, vector<Models::ListUserDevicesResponseBodyDevicesNetInterfaceInfo>) };
    inline vector<Models::ListUserDevicesResponseBodyDevicesNetInterfaceInfo> netInterfaceInfo() { DARABONBA_PTR_GET(netInterfaceInfo_, vector<Models::ListUserDevicesResponseBodyDevicesNetInterfaceInfo>) };
    inline ListUserDevicesResponseBodyDevices& setNetInterfaceInfo(const vector<Models::ListUserDevicesResponseBodyDevicesNetInterfaceInfo> & netInterfaceInfo) { DARABONBA_PTR_SET_VALUE(netInterfaceInfo_, netInterfaceInfo) };
    inline ListUserDevicesResponseBodyDevices& setNetInterfaceInfo(vector<Models::ListUserDevicesResponseBodyDevicesNetInterfaceInfo> && netInterfaceInfo) { DARABONBA_PTR_SET_RVALUE(netInterfaceInfo_, netInterfaceInfo) };
    ...
    inline ListUserDevicesResponseBodyDevices& setPaStatus(string paStatus) { DARABONBA_PTR_SET_VALUE(paStatus_, paStatus) };
    ...
    inline ListUserDevicesResponseBodyDevices& setSaseUserId(string saseUserId) { DARABONBA_PTR_SET_VALUE(saseUserId_, saseUserId) };
    ...
    inline ListUserDevicesResponseBodyDevices& setSharingStatus(bool sharingStatus) { DARABONBA_PTR_SET_VALUE(sharingStatus_, sharingStatus) };
    ...
    inline ListUserDevicesResponseBodyDevices& setSnBaseBoard(string snBaseBoard) { DARABONBA_PTR_SET_VALUE(snBaseBoard_, snBaseBoard) };
    ...
    inline ListUserDevicesResponseBodyDevices& setSnBios(string snBios) { DARABONBA_PTR_SET_VALUE(snBios_, snBios) };
    ...
    inline ListUserDevicesResponseBodyDevices& setSnDiskDrive(string snDiskDrive) { DARABONBA_PTR_SET_VALUE(snDiskDrive_, snDiskDrive) };
    ...
    inline ListUserDevicesResponseBodyDevices& setSnProcessor(string snProcessor) { DARABONBA_PTR_SET_VALUE(snProcessor_, snProcessor) };
    ...
    inline ListUserDevicesResponseBodyDevices& setSnSystem(string snSystem) { DARABONBA_PTR_SET_VALUE(snSystem_, snSystem) };
    ...
    inline ListUserDevicesResponseBodyDevices& setSrcIP(string srcIP) { DARABONBA_PTR_SET_VALUE(srcIP_, srcIP) };
    ...
    inline ListUserDevicesResponseBodyDevices& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline ListUserDevicesResponseBodyDevices& setUsername(string username) { DARABONBA_PTR_SET_VALUE(username_, username) };
    ...
    inline ListUserDevicesResponseBodyDevices& setWorkshop(string workshop) { DARABONBA_PTR_SET_VALUE(workshop_, workshop) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::ListUserDevicesResponseBodyDevicesNetInterfaceInfo>> netInterfaceInfo_ = nullptr;
