...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->approvalType_ == nullptr
        && return this->description_ == nullptr && return this->eventLabel_ == nullptr && return this->externalConfig_ == nullptr && return this->matchSchemaConfigs_ == nullptr && return this->matchSchemas_ == nullptr
