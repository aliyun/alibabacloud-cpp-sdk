...
namespace Models
{
  ...
  public:
    ...
    inline const ListClientUsersResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListClientUsersResponseBodyData) };
    inline ListClientUsersResponseBodyData data() { DARABONBA_PTR_GET(data_, ListClientUsersResponseBodyData) };
    inline ListClientUsersResponseBody& setData(const ListClientUsersResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListClientUsersResponseBody& setData(ListClientUsersResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<ListClientUsersResponseBodyData> data_ = nullptr;
