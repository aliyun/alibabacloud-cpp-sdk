...
namespace Models
{
  ...
  public:
    ...
    inline const DetachPolicy2ApprovalProcessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachPolicy2ApprovalProcessResponseBody) };
    inline DetachPolicy2ApprovalProcessResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachPolicy2ApprovalProcessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachPolicy2ApprovalProcessResponseBody> body_ {};
  };
