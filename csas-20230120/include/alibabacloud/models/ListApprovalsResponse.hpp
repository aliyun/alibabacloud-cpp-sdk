...
namespace Models
{
  ...
  public:
    ...
    inline const ListApprovalsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApprovalsResponseBody) };
    inline ListApprovalsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApprovalsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApprovalsResponseBody> body_ {};
  };
