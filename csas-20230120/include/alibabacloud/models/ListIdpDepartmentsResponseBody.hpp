...
namespace Models
{
  ...
  public:
    ...
    inline const ListIdpDepartmentsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListIdpDepartmentsResponseBodyData) };
    inline ListIdpDepartmentsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListIdpDepartmentsResponseBodyData) };
    inline ListIdpDepartmentsResponseBody& setData(const ListIdpDepartmentsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIdpDepartmentsResponseBody& setData(ListIdpDepartmentsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<ListIdpDepartmentsResponseBodyData> data_ = nullptr;
