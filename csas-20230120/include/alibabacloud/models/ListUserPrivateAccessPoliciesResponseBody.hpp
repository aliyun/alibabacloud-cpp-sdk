...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListUserPrivateAccessPoliciesResponseBodyPolices> & polices() const { DARABONBA_PTR_GET_CONST(polices_, vector<ListUserPrivateAccessPoliciesResponseBodyPolices>) };
    inline vector<ListUserPrivateAccessPoliciesResponseBodyPolices> polices() { DARABONBA_PTR_GET(polices_, vector<ListUserPrivateAccessPoliciesResponseBodyPolices>) };
    inline ListUserPrivateAccessPoliciesResponseBody& setPolices(const vector<ListUserPrivateAccessPoliciesResponseBodyPolices> & polices) { DARABONBA_PTR_SET_VALUE(polices_, polices) };
    inline ListUserPrivateAccessPoliciesResponseBody& setPolices(vector<ListUserPrivateAccessPoliciesResponseBodyPolices> && polices) { DARABONBA_PTR_SET_RVALUE(polices_, polices) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListUserPrivateAccessPoliciesResponseBodyPolices>> polices_ = nullptr;
    // ID of the request.
