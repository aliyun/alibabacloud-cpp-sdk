...
#ifndef ALIBABACLOUD_MODELS_GETFORWARDSTRATEGYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETFORWARDSTRATEGYRESPONSEBODY_HPP_
...
namespace Models
{
  class GetForwardStrategyResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetForwardStrategyResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(ForwardStrategy, forwardStrategy_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetForwardStrategyResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(ForwardStrategy, forwardStrategy_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetForwardStrategyResponseBody() = default ;
    GetForwardStrategyResponseBody(const GetForwardStrategyResponseBody &) = default ;
    GetForwardStrategyResponseBody(GetForwardStrategyResponseBody &&) = default ;
    GetForwardStrategyResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetForwardStrategyResponseBody() = default ;
    GetForwardStrategyResponseBody& operator=(const GetForwardStrategyResponseBody &) = default ;
    GetForwardStrategyResponseBody& operator=(GetForwardStrategyResponseBody &&) = default ;
    ...
    inline const GetForwardStrategyResponseBody::ForwardStrategy & getForwardStrategy() const { DARABONBA_PTR_GET_CONST(forwardStrategy_, GetForwardStrategyResponseBody::ForwardStrategy) };
    inline GetForwardStrategyResponseBody::ForwardStrategy getForwardStrategy() { DARABONBA_PTR_GET(forwardStrategy_, GetForwardStrategyResponseBody::ForwardStrategy) };
    inline GetForwardStrategyResponseBody& setForwardStrategy(const GetForwardStrategyResponseBody::ForwardStrategy & forwardStrategy) { DARABONBA_PTR_SET_VALUE(forwardStrategy_, forwardStrategy) };
    inline GetForwardStrategyResponseBody& setForwardStrategy(GetForwardStrategyResponseBody::ForwardStrategy && forwardStrategy) { DARABONBA_PTR_SET_RVALUE(forwardStrategy_, forwardStrategy) };
    ...
    inline GetForwardStrategyResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The forwarding rule.
    shared_ptr<GetForwardStrategyResponseBody::ForwardStrategy> forwardStrategy_ {};
    // Id of the request
