...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteOtpConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteOtpConfigResponseBody) };
    inline DeleteOtpConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteOtpConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteOtpConfigResponseBody> body_ {};
  };
