...
#ifndef ALIBABACLOUD_MODELS_UPDATEPROHIBITEDPOLICYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPROHIBITEDPOLICYRESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateProhibitedPolicyResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateProhibitedPolicyResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Policy, policy_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateProhibitedPolicyResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Policy, policy_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    UpdateProhibitedPolicyResponseBody() = default ;
    UpdateProhibitedPolicyResponseBody(const UpdateProhibitedPolicyResponseBody &) = default ;
    UpdateProhibitedPolicyResponseBody(UpdateProhibitedPolicyResponseBody &&) = default ;
    UpdateProhibitedPolicyResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateProhibitedPolicyResponseBody() = default ;
    UpdateProhibitedPolicyResponseBody& operator=(const UpdateProhibitedPolicyResponseBody &) = default ;
    UpdateProhibitedPolicyResponseBody& operator=(UpdateProhibitedPolicyResponseBody &&) = default ;
    ...
    inline const UpdateProhibitedPolicyResponseBody::Policy & getPolicy() const { DARABONBA_PTR_GET_CONST(policy_, UpdateProhibitedPolicyResponseBody::Policy) };
    inline UpdateProhibitedPolicyResponseBody::Policy getPolicy() { DARABONBA_PTR_GET(policy_, UpdateProhibitedPolicyResponseBody::Policy) };
    inline UpdateProhibitedPolicyResponseBody& setPolicy(const UpdateProhibitedPolicyResponseBody::Policy & policy) { DARABONBA_PTR_SET_VALUE(policy_, policy) };
    inline UpdateProhibitedPolicyResponseBody& setPolicy(UpdateProhibitedPolicyResponseBody::Policy && policy) { DARABONBA_PTR_SET_RVALUE(policy_, policy) };
    ...
    inline UpdateProhibitedPolicyResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the software prohibition policy.
    shared_ptr<UpdateProhibitedPolicyResponseBody::Policy> policy_ {};
    // Id of the request
