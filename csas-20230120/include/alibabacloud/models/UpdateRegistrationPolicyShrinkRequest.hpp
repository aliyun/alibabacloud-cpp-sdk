...
namespace Models
{
  ...
  public:
    ...
    inline string getCompanyLimitCountShrink() const { DARABONBA_PTR_GET_DEFAULT(companyLimitCountShrink_, "") };
    ...
    inline string getPersonalLimitCountShrink() const { DARABONBA_PTR_GET_DEFAULT(personalLimitCountShrink_, "") };
