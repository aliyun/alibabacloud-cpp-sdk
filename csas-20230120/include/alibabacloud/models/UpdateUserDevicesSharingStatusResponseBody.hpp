...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateUserDevicesSharingStatusResponseBody::Devices> & getDevices() const { DARABONBA_PTR_GET_CONST(devices_, vector<UpdateUserDevicesSharingStatusResponseBody::Devices>) };
    inline vector<UpdateUserDevicesSharingStatusResponseBody::Devices> getDevices() { DARABONBA_PTR_GET(devices_, vector<UpdateUserDevicesSharingStatusResponseBody::Devices>) };
    inline UpdateUserDevicesSharingStatusResponseBody& setDevices(const vector<UpdateUserDevicesSharingStatusResponseBody::Devices> & devices) { DARABONBA_PTR_SET_VALUE(devices_, devices) };
    inline UpdateUserDevicesSharingStatusResponseBody& setDevices(vector<UpdateUserDevicesSharingStatusResponseBody::Devices> && devices) { DARABONBA_PTR_SET_RVALUE(devices_, devices) };
