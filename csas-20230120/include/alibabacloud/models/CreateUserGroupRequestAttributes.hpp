...
#ifndef ALIBABACLOUD_MODELS_CREATEUSERGROUPREQUESTATTRIBUTES_HPP_
#define ALIBABACLOUD_MODELS_CREATEUSERGROUPREQUESTATTRIBUTES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateUserGroupRequestAttributes& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateUserGroupRequestAttributes& obj) { 
    ...
    CreateUserGroupRequestAttributes() = default ;
    CreateUserGroupRequestAttributes(const CreateUserGroupRequestAttributes &) = default ;
    CreateUserGroupRequestAttributes(CreateUserGroupRequestAttributes &&) = default ;
    CreateUserGroupRequestAttributes(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateUserGroupRequestAttributes() = default ;
    CreateUserGroupRequestAttributes& operator=(const CreateUserGroupRequestAttributes &) = default ;
    CreateUserGroupRequestAttributes& operator=(CreateUserGroupRequestAttributes &&) = default ;
    ...
    inline CreateUserGroupRequestAttributes& setIdpId(int32_t idpId) { DARABONBA_PTR_SET_VALUE(idpId_, idpId) };
    ...
    inline CreateUserGroupRequestAttributes& setRelation(string relation) { DARABONBA_PTR_SET_VALUE(relation_, relation) };
    ...
    inline CreateUserGroupRequestAttributes& setUserGroupType(string userGroupType) { DARABONBA_PTR_SET_VALUE(userGroupType_, userGroupType) };
    ...
    inline CreateUserGroupRequestAttributes& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
