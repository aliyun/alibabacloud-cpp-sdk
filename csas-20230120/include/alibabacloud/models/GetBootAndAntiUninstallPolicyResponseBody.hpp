...
namespace Models
{
  ...
  public:
    ...
    inline const GetBootAndAntiUninstallPolicyResponseBody::Strategy & getStrategy() const { DARABONBA_PTR_GET_CONST(strategy_, GetBootAndAntiUninstallPolicyResponseBody::Strategy) };
    inline GetBootAndAntiUninstallPolicyResponseBody::Strategy getStrategy() { DARABONBA_PTR_GET(strategy_, GetBootAndAntiUninstallPolicyResponseBody::Strategy) };
    inline GetBootAndAntiUninstallPolicyResponseBody& setStrategy(const GetBootAndAntiUninstallPolicyResponseBody::Strategy & strategy) { DARABONBA_PTR_SET_VALUE(strategy_, strategy) };
    inline GetBootAndAntiUninstallPolicyResponseBody& setStrategy(GetBootAndAntiUninstallPolicyResponseBody::Strategy && strategy) { DARABONBA_PTR_SET_RVALUE(strategy_, strategy) };
