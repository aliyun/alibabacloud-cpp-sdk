...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateApprovalProcessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateApprovalProcessResponseBody) };
    inline UpdateApprovalProcessResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateApprovalProcessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateApprovalProcessResponseBody> body_ {};
  };
