...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateBootAndAntiUninstallPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateBootAndAntiUninstallPolicyResponseBody) };
    inline UpdateBootAndAntiUninstallPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateBootAndAntiUninstallPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateBootAndAntiUninstallPolicyResponseBody> body_ {};
  };
