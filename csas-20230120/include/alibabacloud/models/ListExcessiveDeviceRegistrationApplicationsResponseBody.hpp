...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListExcessiveDeviceRegistrationApplicationsResponseBody::Applications> & getApplications() const { DARABONBA_PTR_GET_CONST(applications_, vector<ListExcessiveDeviceRegistrationApplicationsResponseBody::Applications>) };
    inline vector<ListExcessiveDeviceRegistrationApplicationsResponseBody::Applications> getApplications() { DARABONBA_PTR_GET(applications_, vector<ListExcessiveDeviceRegistrationApplicationsResponseBody::Applications>) };
    inline ListExcessiveDeviceRegistrationApplicationsResponseBody& setApplications(const vector<ListExcessiveDeviceRegistrationApplicationsResponseBody::Applications> & applications) { DARABONBA_PTR_SET_VALUE(applications_, applications) };
    inline ListExcessiveDeviceRegistrationApplicationsResponseBody& setApplications(vector<ListExcessiveDeviceRegistrationApplicationsResponseBody::Applications> && applications) { DARABONBA_PTR_SET_RVALUE(applications_, applications) };
