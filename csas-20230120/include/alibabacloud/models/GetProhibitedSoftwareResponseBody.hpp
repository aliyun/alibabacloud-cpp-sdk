...
#ifndef ALIBABACLOUD_MODELS_GETPROHIBITEDSOFTWARERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETPROHIBITEDSOFTWARERESPONSEBODY_HPP_
...
namespace Models
{
  class GetProhibitedSoftwareResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetProhibitedSoftwareResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Software, software_);
    };
    friend void from_json(const Darabonba::Json& j, GetProhibitedSoftwareResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Software, software_);
    };
    GetProhibitedSoftwareResponseBody() = default ;
    GetProhibitedSoftwareResponseBody(const GetProhibitedSoftwareResponseBody &) = default ;
    GetProhibitedSoftwareResponseBody(GetProhibitedSoftwareResponseBody &&) = default ;
    GetProhibitedSoftwareResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetProhibitedSoftwareResponseBody() = default ;
    GetProhibitedSoftwareResponseBody& operator=(const GetProhibitedSoftwareResponseBody &) = default ;
    GetProhibitedSoftwareResponseBody& operator=(GetProhibitedSoftwareResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->createTime_ == nullptr
        && this->description_ == nullptr && this->isDefault_ == nullptr && this->linuxProcesses_ == nullptr && this->macOSProcesses_ == nullptr && this->name_ == nullptr
        && this->policyIds_ == nullptr && this->softwareId_ == nullptr && this->tagIds_ == nullptr && this->windowsProcesses_ == nullptr; };
    ...
    inline GetProhibitedSoftwareResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // software Field Functions 
    bool hasSoftware() const { return this->software_ != nullptr;};
    void deleteSoftware() { this->software_ = nullptr;};
    inline const GetProhibitedSoftwareResponseBody::Software & getSoftware() const { DARABONBA_PTR_GET_CONST(software_, GetProhibitedSoftwareResponseBody::Software) };
    inline GetProhibitedSoftwareResponseBody::Software getSoftware() { DARABONBA_PTR_GET(software_, GetProhibitedSoftwareResponseBody::Software) };
    inline GetProhibitedSoftwareResponseBody& setSoftware(const GetProhibitedSoftwareResponseBody::Software & software) { DARABONBA_PTR_SET_VALUE(software_, software) };
    inline GetProhibitedSoftwareResponseBody& setSoftware(GetProhibitedSoftwareResponseBody::Software && software) { DARABONBA_PTR_SET_RVALUE(software_, software) };
  ...
  protected:
    ...
    shared_ptr<GetProhibitedSoftwareResponseBody::Software> software_ {};
  };
