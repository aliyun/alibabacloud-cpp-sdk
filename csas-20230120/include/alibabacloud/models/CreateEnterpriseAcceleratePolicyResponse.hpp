...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEnterpriseAcceleratePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateEnterpriseAcceleratePolicyResponseBody) };
    inline CreateEnterpriseAcceleratePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateEnterpriseAcceleratePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateEnterpriseAcceleratePolicyResponseBody> body_ {};
  };
