...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateExcessiveDeviceRegistrationApplicationsStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateExcessiveDeviceRegistrationApplicationsStatusResponseBody) };
    inline UpdateExcessiveDeviceRegistrationApplicationsStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateExcessiveDeviceRegistrationApplicationsStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateExcessiveDeviceRegistrationApplicationsStatusResponseBody> body_ {};
  };
