...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateUserDevicesStatusResponseBody::Devices> & getDevices() const { DARABONBA_PTR_GET_CONST(devices_, vector<UpdateUserDevicesStatusResponseBody::Devices>) };
    inline vector<UpdateUserDevicesStatusResponseBody::Devices> getDevices() { DARABONBA_PTR_GET(devices_, vector<UpdateUserDevicesStatusResponseBody::Devices>) };
    inline UpdateUserDevicesStatusResponseBody& setDevices(const vector<UpdateUserDevicesStatusResponseBody::Devices> & devices) { DARABONBA_PTR_SET_VALUE(devices_, devices) };
    inline UpdateUserDevicesStatusResponseBody& setDevices(vector<UpdateUserDevicesStatusResponseBody::Devices> && devices) { DARABONBA_PTR_SET_RVALUE(devices_, devices) };
