...
namespace Models
{
  ...
  public:
    ...
    inline const ListApprovalSchemasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApprovalSchemasResponseBody) };
    inline ListApprovalSchemasResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApprovalSchemasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApprovalSchemasResponseBody> body_ {};
  };
