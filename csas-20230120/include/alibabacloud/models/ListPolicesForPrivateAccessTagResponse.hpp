...
namespace Models
{
  ...
  public:
    ...
    inline const ListPolicesForPrivateAccessTagResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPolicesForPrivateAccessTagResponseBody) };
    inline ListPolicesForPrivateAccessTagResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPolicesForPrivateAccessTagResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPolicesForPrivateAccessTagResponseBody> body_ {};
  };
