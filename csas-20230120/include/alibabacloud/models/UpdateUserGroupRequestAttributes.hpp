...
#ifndef ALIBABACLOUD_MODELS_UPDATEUSERGROUPREQUESTATTRIBUTES_HPP_
#define ALIBABACLOUD_MODELS_UPDATEUSERGROUPREQUESTATTRIBUTES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateUserGroupRequestAttributes& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateUserGroupRequestAttributes& obj) { 
    ...
    UpdateUserGroupRequestAttributes() = default ;
    UpdateUserGroupRequestAttributes(const UpdateUserGroupRequestAttributes &) = default ;
    UpdateUserGroupRequestAttributes(UpdateUserGroupRequestAttributes &&) = default ;
    UpdateUserGroupRequestAttributes(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateUserGroupRequestAttributes() = default ;
    UpdateUserGroupRequestAttributes& operator=(const UpdateUserGroupRequestAttributes &) = default ;
    UpdateUserGroupRequestAttributes& operator=(UpdateUserGroupRequestAttributes &&) = default ;
    ...
    inline UpdateUserGroupRequestAttributes& setIdpId(int32_t idpId) { DARABONBA_PTR_SET_VALUE(idpId_, idpId) };
    ...
    inline UpdateUserGroupRequestAttributes& setRelation(string relation) { DARABONBA_PTR_SET_VALUE(relation_, relation) };
    ...
    inline UpdateUserGroupRequestAttributes& setUserGroupType(string userGroupType) { DARABONBA_PTR_SET_VALUE(userGroupType_, userGroupType) };
    ...
    inline UpdateUserGroupRequestAttributes& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
