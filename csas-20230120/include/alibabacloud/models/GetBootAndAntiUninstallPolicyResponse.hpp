...
namespace Models
{
  ...
  public:
    ...
    inline const GetBootAndAntiUninstallPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetBootAndAntiUninstallPolicyResponseBody) };
    inline GetBootAndAntiUninstallPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, GetBootAndAntiUninstallPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetBootAndAntiUninstallPolicyResponseBody> body_ {};
  };
