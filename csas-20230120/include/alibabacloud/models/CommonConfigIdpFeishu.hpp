...
#ifndef ALIBABACLOUD_MODELS_COMMONCONFIGIDPFEISHU_HPP_
#define ALIBABACLOUD_MODELS_COMMONCONFIGIDPFEISHU_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CommonConfigIdpFeishu& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CommonConfigIdpFeishu& obj) { 
    ...
    CommonConfigIdpFeishu() = default ;
    CommonConfigIdpFeishu(const CommonConfigIdpFeishu &) = default ;
    CommonConfigIdpFeishu(CommonConfigIdpFeishu &&) = default ;
    CommonConfigIdpFeishu(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CommonConfigIdpFeishu() = default ;
    CommonConfigIdpFeishu& operator=(const CommonConfigIdpFeishu &) = default ;
    CommonConfigIdpFeishu& operator=(CommonConfigIdpFeishu &&) = default ;
    ...
    inline CommonConfigIdpFeishu& setEventCallbackBase(string eventCallbackBase) { DARABONBA_PTR_SET_VALUE(eventCallbackBase_, eventCallbackBase) };
    ...
    inline CommonConfigIdpFeishu& setEventLabel(string eventLabel) { DARABONBA_PTR_SET_VALUE(eventLabel_, eventLabel) };
    ...
    inline CommonConfigIdpFeishu& setHomePage(string homePage) { DARABONBA_PTR_SET_VALUE(homePage_, homePage) };
    ...
    inline CommonConfigIdpFeishu& setLoginRedirect(string loginRedirect) { DARABONBA_PTR_SET_VALUE(loginRedirect_, loginRedirect) };
