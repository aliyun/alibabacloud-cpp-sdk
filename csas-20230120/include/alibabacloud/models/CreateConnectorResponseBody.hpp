...
#ifndef ALIBABACLOUD_MODELS_CREATECONNECTORRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATECONNECTORRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateConnectorResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateConnectorResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Connector, connector_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateConnectorResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Connector, connector_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    CreateConnectorResponseBody() = default ;
    CreateConnectorResponseBody(const CreateConnectorResponseBody &) = default ;
    CreateConnectorResponseBody(CreateConnectorResponseBody &&) = default ;
    CreateConnectorResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateConnectorResponseBody() = default ;
    CreateConnectorResponseBody& operator=(const CreateConnectorResponseBody &) = default ;
    CreateConnectorResponseBody& operator=(CreateConnectorResponseBody &&) = default ;
    ...
    inline const CreateConnectorResponseBody::Connector & getConnector() const { DARABONBA_PTR_GET_CONST(connector_, CreateConnectorResponseBody::Connector) };
    inline CreateConnectorResponseBody::Connector getConnector() { DARABONBA_PTR_GET(connector_, CreateConnectorResponseBody::Connector) };
    inline CreateConnectorResponseBody& setConnector(const CreateConnectorResponseBody::Connector & connector) { DARABONBA_PTR_SET_VALUE(connector_, connector) };
    inline CreateConnectorResponseBody& setConnector(CreateConnectorResponseBody::Connector && connector) { DARABONBA_PTR_SET_RVALUE(connector_, connector) };
    ...
    inline CreateConnectorResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // Connector。
    shared_ptr<CreateConnectorResponseBody::Connector> connector_ {};
    // Id of the request
