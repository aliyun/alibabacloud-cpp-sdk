...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDynamicRouteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDynamicRouteResponseBody) };
    inline CreateDynamicRouteResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDynamicRouteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDynamicRouteResponseBody> body_ {};
  };
