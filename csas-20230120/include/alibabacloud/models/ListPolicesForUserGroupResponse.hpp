...
namespace Models
{
  ...
  public:
    ...
    inline const ListPolicesForUserGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPolicesForUserGroupResponseBody) };
    inline ListPolicesForUserGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPolicesForUserGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPolicesForUserGroupResponseBody> body_ {};
  };
