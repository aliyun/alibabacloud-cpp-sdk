...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserPrivateAccessPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserPrivateAccessPoliciesResponseBody) };
    inline ListUserPrivateAccessPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserPrivateAccessPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserPrivateAccessPoliciesResponseBody> body_ {};
  };
