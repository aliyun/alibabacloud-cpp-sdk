...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyEnterpriseAcceleratePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyEnterpriseAcceleratePolicyResponseBody) };
    inline ModifyEnterpriseAcceleratePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyEnterpriseAcceleratePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyEnterpriseAcceleratePolicyResponseBody> body_ {};
  };
