...
namespace Models
{
  ...
  public:
    ...
    inline const ListUninstallApplicationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUninstallApplicationsResponseBody) };
    inline ListUninstallApplicationsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUninstallApplicationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUninstallApplicationsResponseBody> body_ {};
  };
