...
#ifndef ALIBABACLOUD_MODELS_LISTDYNAMICROUTESRESPONSEBODYDYNAMICROUTES_HPP_
#define ALIBABACLOUD_MODELS_LISTDYNAMICROUTESRESPONSEBODYDYNAMICROUTES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDynamicRoutesResponseBodyDynamicRoutes& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListDynamicRoutesResponseBodyDynamicRoutes& obj) { 
    ...
    ListDynamicRoutesResponseBodyDynamicRoutes() = default ;
    ListDynamicRoutesResponseBodyDynamicRoutes(const ListDynamicRoutesResponseBodyDynamicRoutes &) = default ;
    ListDynamicRoutesResponseBodyDynamicRoutes(ListDynamicRoutesResponseBodyDynamicRoutes &&) = default ;
    ListDynamicRoutesResponseBodyDynamicRoutes(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDynamicRoutesResponseBodyDynamicRoutes() = default ;
    ListDynamicRoutesResponseBodyDynamicRoutes& operator=(const ListDynamicRoutesResponseBodyDynamicRoutes &) = default ;
    ListDynamicRoutesResponseBodyDynamicRoutes& operator=(ListDynamicRoutesResponseBodyDynamicRoutes &&) = default ;
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setApplicationIds(const vector<string> & applicationIds) { DARABONBA_PTR_SET_VALUE(applicationIds_, applicationIds) };
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setApplicationIds(vector<string> && applicationIds) { DARABONBA_PTR_SET_RVALUE(applicationIds_, applicationIds) };
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setApplicationType(string applicationType) { DARABONBA_PTR_SET_VALUE(applicationType_, applicationType) };
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setDynamicRouteId(string dynamicRouteId) { DARABONBA_PTR_SET_VALUE(dynamicRouteId_, dynamicRouteId) };
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setDynamicRouteType(string dynamicRouteType) { DARABONBA_PTR_SET_VALUE(dynamicRouteType_, dynamicRouteType) };
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setNextHop(string nextHop) { DARABONBA_PTR_SET_VALUE(nextHop_, nextHop) };
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setRegionIds(const vector<string> & regionIds) { DARABONBA_PTR_SET_VALUE(regionIds_, regionIds) };
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setRegionIds(vector<string> && regionIds) { DARABONBA_PTR_SET_RVALUE(regionIds_, regionIds) };
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setTagIds(const vector<string> & tagIds) { DARABONBA_PTR_SET_VALUE(tagIds_, tagIds) };
    inline ListDynamicRoutesResponseBodyDynamicRoutes& setTagIds(vector<string> && tagIds) { DARABONBA_PTR_SET_RVALUE(tagIds_, tagIds) };
