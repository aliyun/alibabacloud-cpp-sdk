...
#ifndef ALIBABACLOUD_MODELS_LISTENTERPRISEACCELERATETARGETSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTENTERPRISEACCELERATETARGETSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListEnterpriseAccelerateTargetsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListEnterpriseAccelerateTargetsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(EapId, eapId_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Targets, targets_);
      DARABONBA_PTR_TO_JSON(Total, total_);
    };
    friend void from_json(const Darabonba::Json& j, ListEnterpriseAccelerateTargetsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(EapId, eapId_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Targets, targets_);
      DARABONBA_PTR_FROM_JSON(Total, total_);
    };
    ListEnterpriseAccelerateTargetsResponseBody() = default ;
    ListEnterpriseAccelerateTargetsResponseBody(const ListEnterpriseAccelerateTargetsResponseBody &) = default ;
    ListEnterpriseAccelerateTargetsResponseBody(ListEnterpriseAccelerateTargetsResponseBody &&) = default ;
    ListEnterpriseAccelerateTargetsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListEnterpriseAccelerateTargetsResponseBody() = default ;
    ListEnterpriseAccelerateTargetsResponseBody& operator=(const ListEnterpriseAccelerateTargetsResponseBody &) = default ;
    ListEnterpriseAccelerateTargetsResponseBody& operator=(ListEnterpriseAccelerateTargetsResponseBody &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->eapId_ != nullptr
