...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateUserDevicesStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateUserDevicesStatusResponseBody) };
    inline UpdateUserDevicesStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateUserDevicesStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateUserDevicesStatusResponseBody> body_ {};
  };
