...
#ifndef ALIBABACLOUD_MODELS_CREATEAPPROVALPROCESSREQUESTMATCHSCHEMAS_HPP_
#define ALIBABACLOUD_MODELS_CREATEAPPROVALPROCESSREQUESTMATCHSCHEMAS_HPP_
...
namespace Models
{
  class CreateApprovalProcessRequestMatchSchemas : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateApprovalProcessRequestMatchSchemas& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateApprovalProcessRequestMatchSchemas& obj) { 
    ...
    CreateApprovalProcessRequestMatchSchemas() = default ;
    CreateApprovalProcessRequestMatchSchemas(const CreateApprovalProcessRequestMatchSchemas &) = default ;
    CreateApprovalProcessRequestMatchSchemas(CreateApprovalProcessRequestMatchSchemas &&) = default ;
    CreateApprovalProcessRequestMatchSchemas(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateApprovalProcessRequestMatchSchemas() = default ;
    CreateApprovalProcessRequestMatchSchemas& operator=(const CreateApprovalProcessRequestMatchSchemas &) = default ;
    CreateApprovalProcessRequestMatchSchemas& operator=(CreateApprovalProcessRequestMatchSchemas &&) = default ;
    ...
    inline CreateApprovalProcessRequestMatchSchemas& setAppUninstallSchemaId(string appUninstallSchemaId) { DARABONBA_PTR_SET_VALUE(appUninstallSchemaId_, appUninstallSchemaId) };
    ...
    inline CreateApprovalProcessRequestMatchSchemas& setDeviceRegistrationSchemaId(string deviceRegistrationSchemaId) { DARABONBA_PTR_SET_VALUE(deviceRegistrationSchemaId_, deviceRegistrationSchemaId) };
    ...
    inline CreateApprovalProcessRequestMatchSchemas& setDlpSendSchemaId(string dlpSendSchemaId) { DARABONBA_PTR_SET_VALUE(dlpSendSchemaId_, dlpSendSchemaId) };
    ...
    inline CreateApprovalProcessRequestMatchSchemas& setDomainBlacklistSchemaId(string domainBlacklistSchemaId) { DARABONBA_PTR_SET_VALUE(domainBlacklistSchemaId_, domainBlacklistSchemaId) };
    ...
    inline CreateApprovalProcessRequestMatchSchemas& setDomainWhitelistSchemaId(string domainWhitelistSchemaId) { DARABONBA_PTR_SET_VALUE(domainWhitelistSchemaId_, domainWhitelistSchemaId) };
    ...
    inline CreateApprovalProcessRequestMatchSchemas& setEndpointHardeningSchemaId(string endpointHardeningSchemaId) { DARABONBA_PTR_SET_VALUE(endpointHardeningSchemaId_, endpointHardeningSchemaId) };
    ...
    inline CreateApprovalProcessRequestMatchSchemas& setPeripheralBlockSchemaId(string peripheralBlockSchemaId) { DARABONBA_PTR_SET_VALUE(peripheralBlockSchemaId_, peripheralBlockSchemaId) };
    ...
    inline CreateApprovalProcessRequestMatchSchemas& setSoftwareBlockSchemaId(string softwareBlockSchemaId) { DARABONBA_PTR_SET_VALUE(softwareBlockSchemaId_, softwareBlockSchemaId) };
    ...
    inline CreateApprovalProcessRequestMatchSchemas& setSoftwareHardeningSchemaId(string softwareHardeningSchemaId) { DARABONBA_PTR_SET_VALUE(softwareHardeningSchemaId_, softwareHardeningSchemaId) };
