...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationIds_ == nullptr
        ...
        && return this->userGroupIds_ == nullptr && return this->userGroupMode_ == nullptr && return this->validFrom_ == nullptr && return this->validTimeStatus_ == nullptr && return this->validUntil_ == nullptr; };
    ...
    inline const vector<UpdatePrivateAccessPolicyRequestCustomUserAttributes> & customUserAttributes() const { DARABONBA_PTR_GET_CONST(customUserAttributes_, vector<UpdatePrivateAccessPolicyRequestCustomUserAttributes>) };
    inline vector<UpdatePrivateAccessPolicyRequestCustomUserAttributes> customUserAttributes() { DARABONBA_PTR_GET(customUserAttributes_, vector<UpdatePrivateAccessPolicyRequestCustomUserAttributes>) };
    inline UpdatePrivateAccessPolicyRequest& setCustomUserAttributes(const vector<UpdatePrivateAccessPolicyRequestCustomUserAttributes> & customUserAttributes) { DARABONBA_PTR_SET_VALUE(customUserAttributes_, customUserAttributes) };
    inline UpdatePrivateAccessPolicyRequest& setCustomUserAttributes(vector<UpdatePrivateAccessPolicyRequestCustomUserAttributes> && customUserAttributes) { DARABONBA_PTR_SET_RVALUE(customUserAttributes_, customUserAttributes) };
  ...
  protected:
    ...
    std::shared_ptr<vector<UpdatePrivateAccessPolicyRequestCustomUserAttributes>> customUserAttributes_ = nullptr;
