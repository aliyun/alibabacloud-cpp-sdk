...
namespace Models
{
  ...
  public:
    ...
    inline const DisableEnterpriseAcceleratePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableEnterpriseAcceleratePolicyResponseBody) };
    inline DisableEnterpriseAcceleratePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableEnterpriseAcceleratePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableEnterpriseAcceleratePolicyResponseBody> body_ {};
  };
