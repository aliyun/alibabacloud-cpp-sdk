...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteClientUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteClientUserResponseBody) };
    inline DeleteClientUserResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteClientUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteClientUserResponseBody> body_ {};
  };
