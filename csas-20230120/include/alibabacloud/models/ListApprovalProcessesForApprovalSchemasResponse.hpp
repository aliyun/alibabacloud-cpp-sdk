...
namespace Models
{
  ...
  public:
    ...
    inline const ListApprovalProcessesForApprovalSchemasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApprovalProcessesForApprovalSchemasResponseBody) };
    inline ListApprovalProcessesForApprovalSchemasResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApprovalProcessesForApprovalSchemasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApprovalProcessesForApprovalSchemasResponseBody> body_ {};
  };
