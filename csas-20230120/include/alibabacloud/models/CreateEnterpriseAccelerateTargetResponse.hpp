...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEnterpriseAccelerateTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateEnterpriseAccelerateTargetResponseBody) };
    inline CreateEnterpriseAccelerateTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateEnterpriseAccelerateTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateEnterpriseAccelerateTargetResponseBody> body_ {};
  };
