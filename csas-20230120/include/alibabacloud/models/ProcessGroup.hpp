...
namespace Models
{
  ...
  public:
    ...
    inline string getProcessGroupId() const { DARABONBA_PTR_GET_DEFAULT(processGroupId_, "") };
    ...
    inline const vector<ProcessItem> & getProcesses() const { DARABONBA_PTR_GET_CONST(processes_, vector<ProcessItem>) };
    inline vector<ProcessItem> getProcesses() { DARABONBA_PTR_GET(processes_, vector<ProcessItem>) };
  ...
  protected:
    ...
    shared_ptr<string> processGroupId_ {};
    shared_ptr<vector<ProcessItem>> processes_ {};
  };
