...
namespace Models
{
  ...
  public:
    ...
    inline const ListEnterpriseAcceleratePoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListEnterpriseAcceleratePoliciesResponseBody) };
    inline ListEnterpriseAcceleratePoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListEnterpriseAcceleratePoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListEnterpriseAcceleratePoliciesResponseBody> body_ {};
  };
