...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateApprovalStatusResponseBody::Approval> & getApproval() const { DARABONBA_PTR_GET_CONST(approval_, vector<UpdateApprovalStatusResponseBody::Approval>) };
    inline vector<UpdateApprovalStatusResponseBody::Approval> getApproval() { DARABONBA_PTR_GET(approval_, vector<UpdateApprovalStatusResponseBody::Approval>) };
    inline UpdateApprovalStatusResponseBody& setApproval(const vector<UpdateApprovalStatusResponseBody::Approval> & approval) { DARABONBA_PTR_SET_VALUE(approval_, approval) };
    inline UpdateApprovalStatusResponseBody& setApproval(vector<UpdateApprovalStatusResponseBody::Approval> && approval) { DARABONBA_PTR_SET_RVALUE(approval_, approval) };
