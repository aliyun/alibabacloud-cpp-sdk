...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserGroupsForRegistrationPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserGroupsForRegistrationPolicyResponseBody) };
    inline ListUserGroupsForRegistrationPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserGroupsForRegistrationPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserGroupsForRegistrationPolicyResponseBody> body_ {};
  };
