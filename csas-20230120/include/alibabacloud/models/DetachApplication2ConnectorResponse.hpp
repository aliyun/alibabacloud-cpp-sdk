...
namespace Models
{
  ...
  public:
    ...
    inline const DetachApplication2ConnectorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachApplication2ConnectorResponseBody) };
    inline DetachApplication2ConnectorResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachApplication2ConnectorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachApplication2ConnectorResponseBody> body_ {};
  };
