...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->apiId_ == nullptr
        && return this->appId_ == nullptr && return this->appName_ == nullptr && return this->appOwnerId_ == nullptr && return this->groupId_ == nullptr && return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->securityToken_ == nullptr && return this->stageName_ == nullptr; };
    ...
    inline int64_t appOwnerId() const { DARABONBA_PTR_GET_DEFAULT(appOwnerId_, 0L) };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> appOwnerId_ = nullptr;
