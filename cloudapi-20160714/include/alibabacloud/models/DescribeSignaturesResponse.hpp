...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSignaturesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSignaturesResponseBody) };
    inline DescribeSignaturesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSignaturesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSignaturesResponseBody> body_ {};
  };
