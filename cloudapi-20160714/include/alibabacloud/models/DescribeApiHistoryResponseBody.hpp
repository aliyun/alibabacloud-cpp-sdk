...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->contentTypeCatagory_ == nullptr
        && this->contentTypeValue_ == nullptr && this->eventBridgeConfig_ == nullptr && this->functionComputeConfig_ == nullptr && this->mock_ == nullptr && this->mockHeaders_ == nullptr
        && this->mockResult_ == nullptr && this->mockStatusCode_ == nullptr && this->ossConfig_ == nullptr && this->serviceAddress_ == nullptr && this->serviceHttpMethod_ == nullptr
        && this->servicePath_ == nullptr && this->serviceProtocol_ == nullptr && this->serviceTimeout_ == nullptr && this->serviceVpcEnable_ == nullptr && this->vpcConfig_ == nullptr
        && this->vpcId_ == nullptr; };
      // contentTypeCatagory Field Functions 
      bool hasContentTypeCatagory() const { return this->contentTypeCatagory_ != nullptr;};
      void deleteContentTypeCatagory() { this->contentTypeCatagory_ = nullptr;};
    ...
    virtual bool empty() const override { return this->allowSignatureMethod_ == nullptr
        ...
        && this->backendEnable_ == nullptr && this->constantParameters_ == nullptr && this->customSystemParameters_ == nullptr && this->deployedTime_ == nullptr && this->description_ == nullptr
        && this->disableInternet_ == nullptr && this->errorCodeSamples_ == nullptr && this->failResultSample_ == nullptr && this->forceNonceCheck_ == nullptr && this->groupId_ == nullptr
        && this->groupName_ == nullptr && this->historyVersion_ == nullptr && this->openIdConnectConfig_ == nullptr && this->regionId_ == nullptr && this->requestConfig_ == nullptr
        && this->requestId_ == nullptr && this->requestParameters_ == nullptr && this->resultBodyModel_ == nullptr && this->resultDescriptions_ == nullptr && this->resultSample_ == nullptr
        && this->resultType_ == nullptr && this->serviceConfig_ == nullptr && this->serviceParameters_ == nullptr && this->serviceParametersMap_ == nullptr && this->stageName_ == nullptr
        && this->status_ == nullptr && this->systemParameters_ == nullptr && this->visibility_ == nullptr && this->webSocketApiType_ == nullptr; };
    ...
    inline const DescribeApiHistoryResponseBody::BackendConfig & getBackendConfig() const { DARABONBA_PTR_GET_CONST(backendConfig_, DescribeApiHistoryResponseBody::BackendConfig) };
    inline DescribeApiHistoryResponseBody::BackendConfig getBackendConfig() { DARABONBA_PTR_GET(backendConfig_, DescribeApiHistoryResponseBody::BackendConfig) };
    inline DescribeApiHistoryResponseBody& setBackendConfig(const DescribeApiHistoryResponseBody::BackendConfig & backendConfig) { DARABONBA_PTR_SET_VALUE(backendConfig_, backendConfig) };
    inline DescribeApiHistoryResponseBody& setBackendConfig(DescribeApiHistoryResponseBody::BackendConfig && backendConfig) { DARABONBA_PTR_SET_RVALUE(backendConfig_, backendConfig) };
    ...
    inline const DescribeApiHistoryResponseBody::ConstantParameters & getConstantParameters() const { DARABONBA_PTR_GET_CONST(constantParameters_, DescribeApiHistoryResponseBody::ConstantParameters) };
    inline DescribeApiHistoryResponseBody::ConstantParameters getConstantParameters() { DARABONBA_PTR_GET(constantParameters_, DescribeApiHistoryResponseBody::ConstantParameters) };
    inline DescribeApiHistoryResponseBody& setConstantParameters(const DescribeApiHistoryResponseBody::ConstantParameters & constantParameters) { DARABONBA_PTR_SET_VALUE(constantParameters_, constantParameters) };
    inline DescribeApiHistoryResponseBody& setConstantParameters(DescribeApiHistoryResponseBody::ConstantParameters && constantParameters) { DARABONBA_PTR_SET_RVALUE(constantParameters_, constantParameters) };
    ...
    inline const DescribeApiHistoryResponseBody::CustomSystemParameters & getCustomSystemParameters() const { DARABONBA_PTR_GET_CONST(customSystemParameters_, DescribeApiHistoryResponseBody::CustomSystemParameters) };
    inline DescribeApiHistoryResponseBody::CustomSystemParameters getCustomSystemParameters() { DARABONBA_PTR_GET(customSystemParameters_, DescribeApiHistoryResponseBody::CustomSystemParameters) };
    inline DescribeApiHistoryResponseBody& setCustomSystemParameters(const DescribeApiHistoryResponseBody::CustomSystemParameters & customSystemParameters) { DARABONBA_PTR_SET_VALUE(customSystemParameters_, customSystemParameters) };
    inline DescribeApiHistoryResponseBody& setCustomSystemParameters(DescribeApiHistoryResponseBody::CustomSystemParameters && customSystemParameters) { DARABONBA_PTR_SET_RVALUE(customSystemParameters_, customSystemParameters) };
    ...
    inline const DescribeApiHistoryResponseBody::ErrorCodeSamples & getErrorCodeSamples() const { DARABONBA_PTR_GET_CONST(errorCodeSamples_, DescribeApiHistoryResponseBody::ErrorCodeSamples) };
    inline DescribeApiHistoryResponseBody::ErrorCodeSamples getErrorCodeSamples() { DARABONBA_PTR_GET(errorCodeSamples_, DescribeApiHistoryResponseBody::ErrorCodeSamples) };
    inline DescribeApiHistoryResponseBody& setErrorCodeSamples(const DescribeApiHistoryResponseBody::ErrorCodeSamples & errorCodeSamples) { DARABONBA_PTR_SET_VALUE(errorCodeSamples_, errorCodeSamples) };
    inline DescribeApiHistoryResponseBody& setErrorCodeSamples(DescribeApiHistoryResponseBody::ErrorCodeSamples && errorCodeSamples) { DARABONBA_PTR_SET_RVALUE(errorCodeSamples_, errorCodeSamples) };
    ...
    inline const DescribeApiHistoryResponseBody::OpenIdConnectConfig & getOpenIdConnectConfig() const { DARABONBA_PTR_GET_CONST(openIdConnectConfig_, DescribeApiHistoryResponseBody::OpenIdConnectConfig) };
    inline DescribeApiHistoryResponseBody::OpenIdConnectConfig getOpenIdConnectConfig() { DARABONBA_PTR_GET(openIdConnectConfig_, DescribeApiHistoryResponseBody::OpenIdConnectConfig) };
    inline DescribeApiHistoryResponseBody& setOpenIdConnectConfig(const DescribeApiHistoryResponseBody::OpenIdConnectConfig & openIdConnectConfig) { DARABONBA_PTR_SET_VALUE(openIdConnectConfig_, openIdConnectConfig) };
    inline DescribeApiHistoryResponseBody& setOpenIdConnectConfig(DescribeApiHistoryResponseBody::OpenIdConnectConfig && openIdConnectConfig) { DARABONBA_PTR_SET_RVALUE(openIdConnectConfig_, openIdConnectConfig) };
    ...
    inline const DescribeApiHistoryResponseBody::RequestConfig & getRequestConfig() const { DARABONBA_PTR_GET_CONST(requestConfig_, DescribeApiHistoryResponseBody::RequestConfig) };
    inline DescribeApiHistoryResponseBody::RequestConfig getRequestConfig() { DARABONBA_PTR_GET(requestConfig_, DescribeApiHistoryResponseBody::RequestConfig) };
    inline DescribeApiHistoryResponseBody& setRequestConfig(const DescribeApiHistoryResponseBody::RequestConfig & requestConfig) { DARABONBA_PTR_SET_VALUE(requestConfig_, requestConfig) };
    inline DescribeApiHistoryResponseBody& setRequestConfig(DescribeApiHistoryResponseBody::RequestConfig && requestConfig) { DARABONBA_PTR_SET_RVALUE(requestConfig_, requestConfig) };
    ...
    inline const DescribeApiHistoryResponseBody::RequestParameters & getRequestParameters() const { DARABONBA_PTR_GET_CONST(requestParameters_, DescribeApiHistoryResponseBody::RequestParameters) };
    inline DescribeApiHistoryResponseBody::RequestParameters getRequestParameters() { DARABONBA_PTR_GET(requestParameters_, DescribeApiHistoryResponseBody::RequestParameters) };
    inline DescribeApiHistoryResponseBody& setRequestParameters(const DescribeApiHistoryResponseBody::RequestParameters & requestParameters) { DARABONBA_PTR_SET_VALUE(requestParameters_, requestParameters) };
    inline DescribeApiHistoryResponseBody& setRequestParameters(DescribeApiHistoryResponseBody::RequestParameters && requestParameters) { DARABONBA_PTR_SET_RVALUE(requestParameters_, requestParameters) };
    ...
    inline const DescribeApiHistoryResponseBody::ResultDescriptions & getResultDescriptions() const { DARABONBA_PTR_GET_CONST(resultDescriptions_, DescribeApiHistoryResponseBody::ResultDescriptions) };
    inline DescribeApiHistoryResponseBody::ResultDescriptions getResultDescriptions() { DARABONBA_PTR_GET(resultDescriptions_, DescribeApiHistoryResponseBody::ResultDescriptions) };
    inline DescribeApiHistoryResponseBody& setResultDescriptions(const DescribeApiHistoryResponseBody::ResultDescriptions & resultDescriptions) { DARABONBA_PTR_SET_VALUE(resultDescriptions_, resultDescriptions) };
    inline DescribeApiHistoryResponseBody& setResultDescriptions(DescribeApiHistoryResponseBody::ResultDescriptions && resultDescriptions) { DARABONBA_PTR_SET_RVALUE(resultDescriptions_, resultDescriptions) };
    ...
    inline const DescribeApiHistoryResponseBody::ServiceConfig & getServiceConfig() const { DARABONBA_PTR_GET_CONST(serviceConfig_, DescribeApiHistoryResponseBody::ServiceConfig) };
    inline DescribeApiHistoryResponseBody::ServiceConfig getServiceConfig() { DARABONBA_PTR_GET(serviceConfig_, DescribeApiHistoryResponseBody::ServiceConfig) };
    inline DescribeApiHistoryResponseBody& setServiceConfig(const DescribeApiHistoryResponseBody::ServiceConfig & serviceConfig) { DARABONBA_PTR_SET_VALUE(serviceConfig_, serviceConfig) };
    inline DescribeApiHistoryResponseBody& setServiceConfig(DescribeApiHistoryResponseBody::ServiceConfig && serviceConfig) { DARABONBA_PTR_SET_RVALUE(serviceConfig_, serviceConfig) };
    ...
    inline const DescribeApiHistoryResponseBody::ServiceParameters & getServiceParameters() const { DARABONBA_PTR_GET_CONST(serviceParameters_, DescribeApiHistoryResponseBody::ServiceParameters) };
    inline DescribeApiHistoryResponseBody::ServiceParameters getServiceParameters() { DARABONBA_PTR_GET(serviceParameters_, DescribeApiHistoryResponseBody::ServiceParameters) };
    inline DescribeApiHistoryResponseBody& setServiceParameters(const DescribeApiHistoryResponseBody::ServiceParameters & serviceParameters) { DARABONBA_PTR_SET_VALUE(serviceParameters_, serviceParameters) };
    inline DescribeApiHistoryResponseBody& setServiceParameters(DescribeApiHistoryResponseBody::ServiceParameters && serviceParameters) { DARABONBA_PTR_SET_RVALUE(serviceParameters_, serviceParameters) };
    ...
    inline const DescribeApiHistoryResponseBody::ServiceParametersMap & getServiceParametersMap() const { DARABONBA_PTR_GET_CONST(serviceParametersMap_, DescribeApiHistoryResponseBody::ServiceParametersMap) };
    inline DescribeApiHistoryResponseBody::ServiceParametersMap getServiceParametersMap() { DARABONBA_PTR_GET(serviceParametersMap_, DescribeApiHistoryResponseBody::ServiceParametersMap) };
    inline DescribeApiHistoryResponseBody& setServiceParametersMap(const DescribeApiHistoryResponseBody::ServiceParametersMap & serviceParametersMap) { DARABONBA_PTR_SET_VALUE(serviceParametersMap_, serviceParametersMap) };
    inline DescribeApiHistoryResponseBody& setServiceParametersMap(DescribeApiHistoryResponseBody::ServiceParametersMap && serviceParametersMap) { DARABONBA_PTR_SET_RVALUE(serviceParametersMap_, serviceParametersMap) };
    ...
    inline const DescribeApiHistoryResponseBody::SystemParameters & getSystemParameters() const { DARABONBA_PTR_GET_CONST(systemParameters_, DescribeApiHistoryResponseBody::SystemParameters) };
    inline DescribeApiHistoryResponseBody::SystemParameters getSystemParameters() { DARABONBA_PTR_GET(systemParameters_, DescribeApiHistoryResponseBody::SystemParameters) };
    inline DescribeApiHistoryResponseBody& setSystemParameters(const DescribeApiHistoryResponseBody::SystemParameters & systemParameters) { DARABONBA_PTR_SET_VALUE(systemParameters_, systemParameters) };
    inline DescribeApiHistoryResponseBody& setSystemParameters(DescribeApiHistoryResponseBody::SystemParameters && systemParameters) { DARABONBA_PTR_SET_RVALUE(systemParameters_, systemParameters) };
  ...
  protected:
    ...
    shared_ptr<DescribeApiHistoryResponseBody::BackendConfig> backendConfig_ {};
    // Specifies whether to enable backend services.
    shared_ptr<bool> backendEnable_ {};
    // The constant parameters.
    shared_ptr<DescribeApiHistoryResponseBody::ConstantParameters> constantParameters_ {};
    // The custom system parameters.
    shared_ptr<DescribeApiHistoryResponseBody::CustomSystemParameters> customSystemParameters_ {};
    ...
    shared_ptr<DescribeApiHistoryResponseBody::ErrorCodeSamples> errorCodeSamples_ {};
    ...
    shared_ptr<DescribeApiHistoryResponseBody::OpenIdConnectConfig> openIdConnectConfig_ {};
    // The region where the API is located.
    shared_ptr<string> regionId_ {};
    // The configuration items of API requests sent by the consumer to API Gateway.
    // 
    // For more information, see [RequestConfig](https://help.aliyun.com/document_detail/43985.html).
    shared_ptr<DescribeApiHistoryResponseBody::RequestConfig> requestConfig_ {};
    // The ID of the request.
    shared_ptr<string> requestId_ {};
    // The parameters of API requests sent by the consumer to API Gateway.
    // 
    // For more information, see [RequestParameter](https://help.aliyun.com/document_detail/43986.html).
    shared_ptr<DescribeApiHistoryResponseBody::RequestParameters> requestParameters_ {};
    // The return description of the API.
    shared_ptr<string> resultBodyModel_ {};
    // The return description of the API.
    shared_ptr<DescribeApiHistoryResponseBody::ResultDescriptions> resultDescriptions_ {};
    // The sample response.
    shared_ptr<string> resultSample_ {};
    // The type of the data to return.
    shared_ptr<string> resultType_ {};
    // The information about a backend service call.
    shared_ptr<DescribeApiHistoryResponseBody::ServiceConfig> serviceConfig_ {};
    // The parameters of API requests sent by API Gateway to the backend service.
    // 
    // For more information, see [ServiceParameter](https://help.aliyun.com/document_detail/43988.html).
    shared_ptr<DescribeApiHistoryResponseBody::ServiceParameters> serviceParameters_ {};
    ...
    shared_ptr<DescribeApiHistoryResponseBody::ServiceParametersMap> serviceParametersMap_ {};
    ...
    shared_ptr<DescribeApiHistoryResponseBody::SystemParameters> systemParameters_ {};
