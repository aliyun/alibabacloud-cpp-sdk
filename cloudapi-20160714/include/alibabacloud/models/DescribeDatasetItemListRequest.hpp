...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->datasetId_ == nullptr
        && return this->datasetItemIds_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->securityToken_ == nullptr; };
    ...
    inline string datasetItemIds() const { DARABONBA_PTR_GET_DEFAULT(datasetItemIds_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> datasetItemIds_ = nullptr;
