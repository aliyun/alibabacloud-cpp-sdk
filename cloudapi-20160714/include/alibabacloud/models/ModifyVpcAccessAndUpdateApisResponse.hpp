...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVpcAccessAndUpdateApisResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyVpcAccessAndUpdateApisResponseBody) };
    inline ModifyVpcAccessAndUpdateApisResponseBody body() { DARABONBA_PTR_GET(body_, ModifyVpcAccessAndUpdateApisResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyVpcAccessAndUpdateApisResponseBody> body_ = nullptr;
  };
