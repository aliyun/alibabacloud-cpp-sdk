...
#ifndef ALIBABACLOUD_MODELS_DETACHPLUGINREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DETACHPLUGINREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DetachPluginRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DetachPluginRequest& obj) { 
    ...
    DetachPluginRequest(const DetachPluginRequest &) = default ;
    DetachPluginRequest(DetachPluginRequest &&) = default ;
    DetachPluginRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DetachPluginRequest() = default ;
    DetachPluginRequest& operator=(const DetachPluginRequest &) = default ;
    DetachPluginRequest& operator=(DetachPluginRequest &&) = default ;
