...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDomainResponseBody) };
    inline DeleteDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDomainResponseBody> body_ {};
  };
