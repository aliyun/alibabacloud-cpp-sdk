...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApiSignaturesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApiSignaturesResponseBody) };
    inline DescribeApiSignaturesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApiSignaturesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApiSignaturesResponseBody> body_ {};
  };
