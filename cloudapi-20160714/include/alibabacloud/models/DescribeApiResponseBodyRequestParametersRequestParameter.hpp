...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAPIRESPONSEBODYREQUESTPARAMETERSREQUESTPARAMETER_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEAPIRESPONSEBODYREQUESTPARAMETERSREQUESTPARAMETER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeApiResponseBodyRequestParametersRequestParameter& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeApiResponseBodyRequestParametersRequestParameter& obj) { 
    ...
    DescribeApiResponseBodyRequestParametersRequestParameter() = default ;
    DescribeApiResponseBodyRequestParametersRequestParameter(const DescribeApiResponseBodyRequestParametersRequestParameter &) = default ;
    DescribeApiResponseBodyRequestParametersRequestParameter(DescribeApiResponseBodyRequestParametersRequestParameter &&) = default ;
    DescribeApiResponseBodyRequestParametersRequestParameter(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeApiResponseBodyRequestParametersRequestParameter() = default ;
    DescribeApiResponseBodyRequestParametersRequestParameter& operator=(const DescribeApiResponseBodyRequestParametersRequestParameter &) = default ;
    DescribeApiResponseBodyRequestParametersRequestParameter& operator=(DescribeApiResponseBodyRequestParametersRequestParameter &&) = default ;
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setApiParameterName(string apiParameterName) { DARABONBA_PTR_SET_VALUE(apiParameterName_, apiParameterName) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setArrayItemsType(string arrayItemsType) { DARABONBA_PTR_SET_VALUE(arrayItemsType_, arrayItemsType) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setDemoValue(string demoValue) { DARABONBA_PTR_SET_VALUE(demoValue_, demoValue) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setDocOrder(int32_t docOrder) { DARABONBA_PTR_SET_VALUE(docOrder_, docOrder) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setDocShow(string docShow) { DARABONBA_PTR_SET_VALUE(docShow_, docShow) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setEnumValue(string enumValue) { DARABONBA_PTR_SET_VALUE(enumValue_, enumValue) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setJsonScheme(string jsonScheme) { DARABONBA_PTR_SET_VALUE(jsonScheme_, jsonScheme) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setLocation(string location) { DARABONBA_PTR_SET_VALUE(location_, location) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setMaxLength(int64_t maxLength) { DARABONBA_PTR_SET_VALUE(maxLength_, maxLength) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setMaxValue(int64_t maxValue) { DARABONBA_PTR_SET_VALUE(maxValue_, maxValue) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setMinLength(int64_t minLength) { DARABONBA_PTR_SET_VALUE(minLength_, minLength) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setMinValue(int64_t minValue) { DARABONBA_PTR_SET_VALUE(minValue_, minValue) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setParameterType(string parameterType) { DARABONBA_PTR_SET_VALUE(parameterType_, parameterType) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setRegularExpression(string regularExpression) { DARABONBA_PTR_SET_VALUE(regularExpression_, regularExpression) };
    ...
    inline DescribeApiResponseBodyRequestParametersRequestParameter& setRequired(string required) { DARABONBA_PTR_SET_VALUE(required_, required) };
