...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceSlbConnectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceSlbConnectResponseBody) };
    inline DescribeInstanceSlbConnectResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceSlbConnectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceSlbConnectResponseBody> body_ {};
  };
