...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveApiProductsAuthoritiesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RemoveApiProductsAuthoritiesResponseBody) };
    inline RemoveApiProductsAuthoritiesResponseBody body() { DARABONBA_PTR_GET(body_, RemoveApiProductsAuthoritiesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RemoveApiProductsAuthoritiesResponseBody> body_ = nullptr;
  };
