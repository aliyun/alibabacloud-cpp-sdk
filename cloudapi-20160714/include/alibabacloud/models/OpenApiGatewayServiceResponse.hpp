...
namespace Models
{
  ...
  public:
    ...
    inline const OpenApiGatewayServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenApiGatewayServiceResponseBody) };
    inline OpenApiGatewayServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenApiGatewayServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenApiGatewayServiceResponseBody> body_ {};
  };
