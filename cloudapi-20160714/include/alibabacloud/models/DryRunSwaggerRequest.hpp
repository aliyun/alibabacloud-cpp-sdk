...
#ifndef ALIBABACLOUD_MODELS_DRYRUNSWAGGERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DRYRUNSWAGGERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DryRunSwaggerRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DryRunSwaggerRequest& obj) { 
    ...
    DryRunSwaggerRequest() = default ;
    DryRunSwaggerRequest(const DryRunSwaggerRequest &) = default ;
    DryRunSwaggerRequest(DryRunSwaggerRequest &&) = default ;
    DryRunSwaggerRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DryRunSwaggerRequest() = default ;
    DryRunSwaggerRequest& operator=(const DryRunSwaggerRequest &) = default ;
    DryRunSwaggerRequest& operator=(DryRunSwaggerRequest &&) = default ;
