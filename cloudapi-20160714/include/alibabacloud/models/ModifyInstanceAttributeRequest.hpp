...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deleteVpcIpBlock_ == nullptr
        ...
        && return this->intranetSegments_ == nullptr && return this->maintainEndTime_ == nullptr && return this->maintainStartTime_ == nullptr && return this->toConnectVpcIpBlock_ == nullptr && return this->token_ == nullptr
    ...
    inline const ModifyInstanceAttributeRequestToConnectVpcIpBlock & toConnectVpcIpBlock() const { DARABONBA_PTR_GET_CONST(toConnectVpcIpBlock_, ModifyInstanceAttributeRequestToConnectVpcIpBlock) };
    inline ModifyInstanceAttributeRequestToConnectVpcIpBlock toConnectVpcIpBlock() { DARABONBA_PTR_GET(toConnectVpcIpBlock_, ModifyInstanceAttributeRequestToConnectVpcIpBlock) };
    inline ModifyInstanceAttributeRequest& setToConnectVpcIpBlock(const ModifyInstanceAttributeRequestToConnectVpcIpBlock & toConnectVpcIpBlock) { DARABONBA_PTR_SET_VALUE(toConnectVpcIpBlock_, toConnectVpcIpBlock) };
    inline ModifyInstanceAttributeRequest& setToConnectVpcIpBlock(ModifyInstanceAttributeRequestToConnectVpcIpBlock && toConnectVpcIpBlock) { DARABONBA_PTR_SET_RVALUE(toConnectVpcIpBlock_, toConnectVpcIpBlock) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyInstanceAttributeRequestToConnectVpcIpBlock> toConnectVpcIpBlock_ = nullptr;
