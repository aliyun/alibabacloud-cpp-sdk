...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDatasetItemListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDatasetItemListResponseBody) };
    inline DescribeDatasetItemListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDatasetItemListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDatasetItemListResponseBody> body_ {};
  };
