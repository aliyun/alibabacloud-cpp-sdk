...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAPIHISTORYRESPONSEBODYREQUESTCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEAPIHISTORYRESPONSEBODYREQUESTCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeApiHistoryResponseBodyRequestConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeApiHistoryResponseBodyRequestConfig& obj) { 
    ...
    DescribeApiHistoryResponseBodyRequestConfig() = default ;
    DescribeApiHistoryResponseBodyRequestConfig(const DescribeApiHistoryResponseBodyRequestConfig &) = default ;
    DescribeApiHistoryResponseBodyRequestConfig(DescribeApiHistoryResponseBodyRequestConfig &&) = default ;
    DescribeApiHistoryResponseBodyRequestConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeApiHistoryResponseBodyRequestConfig() = default ;
    DescribeApiHistoryResponseBodyRequestConfig& operator=(const DescribeApiHistoryResponseBodyRequestConfig &) = default ;
    DescribeApiHistoryResponseBodyRequestConfig& operator=(DescribeApiHistoryResponseBodyRequestConfig &&) = default ;
    ...
    inline DescribeApiHistoryResponseBodyRequestConfig& setBodyFormat(string bodyFormat) { DARABONBA_PTR_SET_VALUE(bodyFormat_, bodyFormat) };
    ...
    inline DescribeApiHistoryResponseBodyRequestConfig& setBodyModel(string bodyModel) { DARABONBA_PTR_SET_VALUE(bodyModel_, bodyModel) };
    ...
    inline DescribeApiHistoryResponseBodyRequestConfig& setEscapePathParam(bool escapePathParam) { DARABONBA_PTR_SET_VALUE(escapePathParam_, escapePathParam) };
    ...
    inline DescribeApiHistoryResponseBodyRequestConfig& setPostBodyDescription(string postBodyDescription) { DARABONBA_PTR_SET_VALUE(postBodyDescription_, postBodyDescription) };
    ...
    inline DescribeApiHistoryResponseBodyRequestConfig& setRequestHttpMethod(string requestHttpMethod) { DARABONBA_PTR_SET_VALUE(requestHttpMethod_, requestHttpMethod) };
    ...
    inline DescribeApiHistoryResponseBodyRequestConfig& setRequestMode(string requestMode) { DARABONBA_PTR_SET_VALUE(requestMode_, requestMode) };
    ...
    inline DescribeApiHistoryResponseBodyRequestConfig& setRequestPath(string requestPath) { DARABONBA_PTR_SET_VALUE(requestPath_, requestPath) };
    ...
    inline DescribeApiHistoryResponseBodyRequestConfig& setRequestProtocol(string requestProtocol) { DARABONBA_PTR_SET_VALUE(requestProtocol_, requestProtocol) };
