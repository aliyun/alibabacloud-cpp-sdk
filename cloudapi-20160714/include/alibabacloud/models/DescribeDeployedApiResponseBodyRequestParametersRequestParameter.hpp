...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDEPLOYEDAPIRESPONSEBODYREQUESTPARAMETERSREQUESTPARAMETER_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDEPLOYEDAPIRESPONSEBODYREQUESTPARAMETERSREQUESTPARAMETER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDeployedApiResponseBodyRequestParametersRequestParameter& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDeployedApiResponseBodyRequestParametersRequestParameter& obj) { 
    ...
    DescribeDeployedApiResponseBodyRequestParametersRequestParameter() = default ;
    DescribeDeployedApiResponseBodyRequestParametersRequestParameter(const DescribeDeployedApiResponseBodyRequestParametersRequestParameter &) = default ;
    DescribeDeployedApiResponseBodyRequestParametersRequestParameter(DescribeDeployedApiResponseBodyRequestParametersRequestParameter &&) = default ;
    DescribeDeployedApiResponseBodyRequestParametersRequestParameter(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDeployedApiResponseBodyRequestParametersRequestParameter() = default ;
    DescribeDeployedApiResponseBodyRequestParametersRequestParameter& operator=(const DescribeDeployedApiResponseBodyRequestParametersRequestParameter &) = default ;
    DescribeDeployedApiResponseBodyRequestParametersRequestParameter& operator=(DescribeDeployedApiResponseBodyRequestParametersRequestParameter &&) = default ;
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setApiParameterName(string apiParameterName) { DARABONBA_PTR_SET_VALUE(apiParameterName_, apiParameterName) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setArrayItemsType(string arrayItemsType) { DARABONBA_PTR_SET_VALUE(arrayItemsType_, arrayItemsType) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setDemoValue(string demoValue) { DARABONBA_PTR_SET_VALUE(demoValue_, demoValue) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setDocOrder(int32_t docOrder) { DARABONBA_PTR_SET_VALUE(docOrder_, docOrder) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setDocShow(string docShow) { DARABONBA_PTR_SET_VALUE(docShow_, docShow) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setEnumValue(string enumValue) { DARABONBA_PTR_SET_VALUE(enumValue_, enumValue) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setJsonScheme(string jsonScheme) { DARABONBA_PTR_SET_VALUE(jsonScheme_, jsonScheme) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setLocation(string location) { DARABONBA_PTR_SET_VALUE(location_, location) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setMaxLength(int64_t maxLength) { DARABONBA_PTR_SET_VALUE(maxLength_, maxLength) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setMaxValue(int64_t maxValue) { DARABONBA_PTR_SET_VALUE(maxValue_, maxValue) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setMinLength(int64_t minLength) { DARABONBA_PTR_SET_VALUE(minLength_, minLength) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setMinValue(int64_t minValue) { DARABONBA_PTR_SET_VALUE(minValue_, minValue) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setParameterType(string parameterType) { DARABONBA_PTR_SET_VALUE(parameterType_, parameterType) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setRegularExpression(string regularExpression) { DARABONBA_PTR_SET_VALUE(regularExpression_, regularExpression) };
    ...
    inline DescribeDeployedApiResponseBodyRequestParametersRequestParameter& setRequired(string required) { DARABONBA_PTR_SET_VALUE(required_, required) };
