...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyApiGroupNetworkPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyApiGroupNetworkPolicyResponseBody) };
    inline ModifyApiGroupNetworkPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyApiGroupNetworkPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyApiGroupNetworkPolicyResponseBody> body_ {};
  };
