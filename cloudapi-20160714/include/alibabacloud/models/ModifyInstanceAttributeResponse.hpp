...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceAttributeResponseBody) };
    inline ModifyInstanceAttributeResponseBody body() { DARABONBA_PTR_GET(body_, ModifyInstanceAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyInstanceAttributeResponseBody> body_ = nullptr;
  };
