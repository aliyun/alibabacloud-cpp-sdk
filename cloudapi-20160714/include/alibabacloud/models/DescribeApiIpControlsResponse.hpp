...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApiIpControlsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApiIpControlsResponseBody) };
    inline DescribeApiIpControlsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApiIpControlsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApiIpControlsResponseBody> body_ {};
  };
