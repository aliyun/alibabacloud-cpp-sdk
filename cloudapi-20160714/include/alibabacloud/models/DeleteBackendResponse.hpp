...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBackendResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteBackendResponseBody) };
    inline DeleteBackendResponseBody body() { DARABONBA_PTR_GET(body_, DeleteBackendResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteBackendResponseBody> body_ = nullptr;
  };
