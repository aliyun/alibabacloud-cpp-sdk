...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSignaturesByApiResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSignaturesByApiResponseBody) };
    inline DescribeSignaturesByApiResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSignaturesByApiResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSignaturesByApiResponseBody> body_ = nullptr;
  };
