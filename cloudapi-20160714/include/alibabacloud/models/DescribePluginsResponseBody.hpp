  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->pluginType_ == nullptr && this->regionId_ == nullptr && this->tags_ == nullptr; };
        ...
        inline const PluginAttribute::Tags & getTags() const { DARABONBA_PTR_GET_CONST(tags_, PluginAttribute::Tags) };
        inline PluginAttribute::Tags getTags() { DARABONBA_PTR_GET(tags_, PluginAttribute::Tags) };
        inline PluginAttribute& setTags(const PluginAttribute::Tags & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
        inline PluginAttribute& setTags(PluginAttribute::Tags && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    inline const DescribePluginsResponseBody::Plugins & getPlugins() const { DARABONBA_PTR_GET_CONST(plugins_, DescribePluginsResponseBody::Plugins) };
    inline DescribePluginsResponseBody::Plugins getPlugins() { DARABONBA_PTR_GET(plugins_, DescribePluginsResponseBody::Plugins) };
    inline DescribePluginsResponseBody& setPlugins(const DescribePluginsResponseBody::Plugins & plugins) { DARABONBA_PTR_SET_VALUE(plugins_, plugins) };
    inline DescribePluginsResponseBody& setPlugins(DescribePluginsResponseBody::Plugins && plugins) { DARABONBA_PTR_SET_RVALUE(plugins_, plugins) };
