...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUpdateBackendTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUpdateBackendTaskResponseBody) };
    inline DescribeUpdateBackendTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUpdateBackendTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUpdateBackendTaskResponseBody> body_ {};
  };
