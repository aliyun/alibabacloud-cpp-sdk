...
namespace Models
{
  ...
  public:
    ...
    inline const DetachApiProductResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachApiProductResponseBody) };
    inline DetachApiProductResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachApiProductResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachApiProductResponseBody> body_ {};
  };
