...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAppResponseBody) };
    inline CreateAppResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAppResponseBody> body_ {};
  };
