...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePrivateDNSResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeletePrivateDNSResponseBody) };
    inline DeletePrivateDNSResponseBody body() { DARABONBA_PTR_GET(body_, DeletePrivateDNSResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeletePrivateDNSResponseBody> body_ = nullptr;
  };
