...
namespace Models
{
  ...
  public:
    ...
    inline const ResetAppSecretResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ResetAppSecretResponseBody) };
    inline ResetAppSecretResponseBody body() { DARABONBA_PTR_GET(body_, ResetAppSecretResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ResetAppSecretResponseBody> body_ = nullptr;
  };
