...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDeployedApisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDeployedApisResponseBody) };
    inline DescribeDeployedApisResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDeployedApisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDeployedApisResponseBody> body_ {};
  };
