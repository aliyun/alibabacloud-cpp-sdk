...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAppsByApiProductResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAppsByApiProductResponseBody) };
    inline DescribeAppsByApiProductResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAppsByApiProductResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAppsByApiProductResponseBody> body_ {};
  };
