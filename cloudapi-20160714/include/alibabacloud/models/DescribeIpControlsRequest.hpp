...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ipControlId_ == nullptr
        && return this->ipControlName_ == nullptr && return this->ipControlType_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->securityToken_ == nullptr; };
