...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->apiName_ == nullptr && this->authVaildTime_ == nullptr && this->authorizationSource_ == nullptr && this->createdTime_ == nullptr && this->description_ == nullptr
        && this->groupId_ == nullptr && this->groupName_ == nullptr && this->method_ == nullptr && this->operator_ == nullptr && this->path_ == nullptr
        && this->regionId_ == nullptr && this->stageAlias_ == nullptr && this->stageName_ == nullptr; };
        ...
        inline AppApiRelationInfo& setAuthVaildTime(string authVaildTime) { DARABONBA_PTR_SET_VALUE(authVaildTime_, authVaildTime) };
        ...
        inline AppApiRelationInfo& setStageAlias(string stageAlias) { DARABONBA_PTR_SET_VALUE(stageAlias_, stageAlias) };
        ...
        inline AppApiRelationInfo& setStageName(string stageName) { DARABONBA_PTR_SET_VALUE(stageName_, stageName) };
    ...
    inline const DescribeApisByAppResponseBody::AppApiRelationInfos & getAppApiRelationInfos() const { DARABONBA_PTR_GET_CONST(appApiRelationInfos_, DescribeApisByAppResponseBody::AppApiRelationInfos) };
    inline DescribeApisByAppResponseBody::AppApiRelationInfos getAppApiRelationInfos() { DARABONBA_PTR_GET(appApiRelationInfos_, DescribeApisByAppResponseBody::AppApiRelationInfos) };
    inline DescribeApisByAppResponseBody& setAppApiRelationInfos(const DescribeApisByAppResponseBody::AppApiRelationInfos & appApiRelationInfos) { DARABONBA_PTR_SET_VALUE(appApiRelationInfos_, appApiRelationInfos) };
    inline DescribeApisByAppResponseBody& setAppApiRelationInfos(DescribeApisByAppResponseBody::AppApiRelationInfos && appApiRelationInfos) { DARABONBA_PTR_SET_RVALUE(appApiRelationInfos_, appApiRelationInfos) };
  ...
  protected:
    ...
    shared_ptr<DescribeApisByAppResponseBody::AppApiRelationInfos> appApiRelationInfos_ {};
