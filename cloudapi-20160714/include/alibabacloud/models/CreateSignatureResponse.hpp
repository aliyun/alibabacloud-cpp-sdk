...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSignatureResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSignatureResponseBody) };
    inline CreateSignatureResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSignatureResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSignatureResponseBody> body_ {};
  };
