...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEINSTANCELATENCYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEINSTANCELATENCYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeInstanceLatencyRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeInstanceLatencyRequest& obj) { 
    ...
    DescribeInstanceLatencyRequest() = default ;
    DescribeInstanceLatencyRequest(const DescribeInstanceLatencyRequest &) = default ;
    DescribeInstanceLatencyRequest(DescribeInstanceLatencyRequest &&) = default ;
    DescribeInstanceLatencyRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeInstanceLatencyRequest() = default ;
    DescribeInstanceLatencyRequest& operator=(const DescribeInstanceLatencyRequest &) = default ;
    DescribeInstanceLatencyRequest& operator=(DescribeInstanceLatencyRequest &&) = default ;
