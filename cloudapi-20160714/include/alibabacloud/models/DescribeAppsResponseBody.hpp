...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAppsResponseBodyApps & apps() const { DARABONBA_PTR_GET_CONST(apps_, DescribeAppsResponseBodyApps) };
    inline DescribeAppsResponseBodyApps apps() { DARABONBA_PTR_GET(apps_, DescribeAppsResponseBodyApps) };
    inline DescribeAppsResponseBody& setApps(const DescribeAppsResponseBodyApps & apps) { DARABONBA_PTR_SET_VALUE(apps_, apps) };
    inline DescribeAppsResponseBody& setApps(DescribeAppsResponseBodyApps && apps) { DARABONBA_PTR_SET_RVALUE(apps_, apps) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAppsResponseBodyApps> apps_ = nullptr;
