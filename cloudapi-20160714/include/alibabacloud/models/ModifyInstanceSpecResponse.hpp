...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceSpecResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceSpecResponseBody) };
    inline ModifyInstanceSpecResponseBody body() { DARABONBA_PTR_GET(body_, ModifyInstanceSpecResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyInstanceSpecResponseBody> body_ = nullptr;
  };
