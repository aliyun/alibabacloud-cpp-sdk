...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveSignatureApisResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RemoveSignatureApisResponseBody) };
    inline RemoveSignatureApisResponseBody body() { DARABONBA_PTR_GET(body_, RemoveSignatureApisResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RemoveSignatureApisResponseBody> body_ = nullptr;
  };
