...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUpdateVpcInfoTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeUpdateVpcInfoTaskResponseBody) };
    inline DescribeUpdateVpcInfoTaskResponseBody body() { DARABONBA_PTR_GET(body_, DescribeUpdateVpcInfoTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeUpdateVpcInfoTaskResponseBody> body_ = nullptr;
  };
