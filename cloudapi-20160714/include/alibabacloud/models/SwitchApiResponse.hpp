...
namespace Models
{
  ...
  public:
    ...
    inline const SwitchApiResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SwitchApiResponseBody) };
    inline SwitchApiResponseBody body() { DARABONBA_PTR_GET(body_, SwitchApiResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SwitchApiResponseBody> body_ = nullptr;
  };
