...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAppAttributesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAppAttributesResponseBody) };
    inline DescribeAppAttributesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAppAttributesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAppAttributesResponseBody> body_ = nullptr;
  };
