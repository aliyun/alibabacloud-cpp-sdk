...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyApiGroupInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyApiGroupInstanceResponseBody) };
    inline ModifyApiGroupInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyApiGroupInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyApiGroupInstanceResponseBody> body_ {};
  };
