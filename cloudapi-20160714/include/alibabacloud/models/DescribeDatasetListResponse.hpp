...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDatasetListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDatasetListResponseBody) };
    inline DescribeDatasetListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDatasetListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDatasetListResponseBody> body_ {};
  };
