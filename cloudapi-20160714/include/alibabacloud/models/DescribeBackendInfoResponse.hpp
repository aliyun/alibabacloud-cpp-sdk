...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBackendInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBackendInfoResponseBody) };
    inline DescribeBackendInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBackendInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBackendInfoResponseBody> body_ {};
  };
