...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAppSecurityRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeAppSecurityRequest::Tag>) };
    inline vector<DescribeAppSecurityRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeAppSecurityRequest::Tag>) };
    inline DescribeAppSecurityRequest& setTag(const vector<DescribeAppSecurityRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeAppSecurityRequest& setTag(vector<DescribeAppSecurityRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeAppSecurityRequest::Tag>> tag_ {};
  };
