...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->pluginData_ == nullptr && this->pluginId_ == nullptr && this->pluginName_ == nullptr && this->securityToken_ == nullptr && this->tag_ == nullptr; };
    ...
    inline const vector<ModifyPluginRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<ModifyPluginRequest::Tag>) };
    inline vector<ModifyPluginRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<ModifyPluginRequest::Tag>) };
    inline ModifyPluginRequest& setTag(const vector<ModifyPluginRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline ModifyPluginRequest& setTag(vector<ModifyPluginRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<ModifyPluginRequest::Tag>> tag_ {};
  };
