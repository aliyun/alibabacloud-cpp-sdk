...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeBackendListResponseBodyBackendInfoList> & backendInfoList() const { DARABONBA_PTR_GET_CONST(backendInfoList_, vector<DescribeBackendListResponseBodyBackendInfoList>) };
    inline vector<DescribeBackendListResponseBodyBackendInfoList> backendInfoList() { DARABONBA_PTR_GET(backendInfoList_, vector<DescribeBackendListResponseBodyBackendInfoList>) };
    inline DescribeBackendListResponseBody& setBackendInfoList(const vector<DescribeBackendListResponseBodyBackendInfoList> & backendInfoList) { DARABONBA_PTR_SET_VALUE(backendInfoList_, backendInfoList) };
    inline DescribeBackendListResponseBody& setBackendInfoList(vector<DescribeBackendListResponseBodyBackendInfoList> && backendInfoList) { DARABONBA_PTR_SET_RVALUE(backendInfoList_, backendInfoList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeBackendListResponseBodyBackendInfoList>> backendInfoList_ = nullptr;
