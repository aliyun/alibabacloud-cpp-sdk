...
namespace Models
{
  ...
  public:
    ...
    inline const SetAppsAuthToApiProductResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetAppsAuthToApiProductResponseBody) };
    inline SetAppsAuthToApiProductResponseBody getBody() { DARABONBA_PTR_GET(body_, SetAppsAuthToApiProductResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetAppsAuthToApiProductResponseBody> body_ {};
  };
