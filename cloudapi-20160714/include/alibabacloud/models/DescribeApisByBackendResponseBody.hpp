...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApisByBackendResponseBodyApiInfoList & apiInfoList() const { DARABONBA_PTR_GET_CONST(apiInfoList_, DescribeApisByBackendResponseBodyApiInfoList) };
    inline DescribeApisByBackendResponseBodyApiInfoList apiInfoList() { DARABONBA_PTR_GET(apiInfoList_, DescribeApisByBackendResponseBodyApiInfoList) };
    inline DescribeApisByBackendResponseBody& setApiInfoList(const DescribeApisByBackendResponseBodyApiInfoList & apiInfoList) { DARABONBA_PTR_SET_VALUE(apiInfoList_, apiInfoList) };
    inline DescribeApisByBackendResponseBody& setApiInfoList(DescribeApisByBackendResponseBodyApiInfoList && apiInfoList) { DARABONBA_PTR_SET_RVALUE(apiInfoList_, apiInfoList) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeApisByBackendResponseBodyApiInfoList> apiInfoList_ = nullptr;
