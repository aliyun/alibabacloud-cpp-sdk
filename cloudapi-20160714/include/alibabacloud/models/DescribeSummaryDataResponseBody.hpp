...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->expireInstanceNum_ == nullptr
        && return this->region_ == nullptr && return this->requestId_ == nullptr && return this->usageApiNum_ == nullptr && return this->usageGroupNum_ == nullptr && return this->usageInstanceNum_ == nullptr; };
    ...
    inline int32_t expireInstanceNum() const { DARABONBA_PTR_GET_DEFAULT(expireInstanceNum_, 0) };
    ...
    inline int32_t usageApiNum() const { DARABONBA_PTR_GET_DEFAULT(usageApiNum_, 0) };
    ...
    inline int32_t usageGroupNum() const { DARABONBA_PTR_GET_DEFAULT(usageGroupNum_, 0) };
    ...
    inline int32_t usageInstanceNum() const { DARABONBA_PTR_GET_DEFAULT(usageInstanceNum_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> expireInstanceNum_ = nullptr;
    // The region ID.
    std::shared_ptr<string> region_ = nullptr;
    // The request ID.
    std::shared_ptr<string> requestId_ = nullptr;
    // The number of APIs.
    std::shared_ptr<int32_t> usageApiNum_ = nullptr;
    // The number of API groups.
    std::shared_ptr<int32_t> usageGroupNum_ = nullptr;
    // The number of running dedicated instances.
    std::shared_ptr<int32_t> usageInstanceNum_ = nullptr;
  };
