...
namespace Models
{
  ...
  public:
    ...
    inline const AttachGroupPluginResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachGroupPluginResponseBody) };
    inline AttachGroupPluginResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachGroupPluginResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachGroupPluginResponseBody> body_ {};
  };
