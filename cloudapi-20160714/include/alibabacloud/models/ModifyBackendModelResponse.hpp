...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBackendModelResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyBackendModelResponseBody) };
    inline ModifyBackendModelResponseBody body() { DARABONBA_PTR_GET(body_, ModifyBackendModelResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyBackendModelResponseBody> body_ = nullptr;
  };
