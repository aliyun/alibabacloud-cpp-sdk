...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteApiResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteApiResponseBody) };
    inline DeleteApiResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteApiResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteApiResponseBody> body_ {};
  };
