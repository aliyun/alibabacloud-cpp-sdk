...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDatasetItemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDatasetItemResponseBody) };
    inline ModifyDatasetItemResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDatasetItemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDatasetItemResponseBody> body_ {};
  };
