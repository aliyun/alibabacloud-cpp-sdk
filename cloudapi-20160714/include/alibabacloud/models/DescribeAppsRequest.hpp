...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appId_ == nullptr
        && this->appOwner_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->securityToken_ == nullptr; };
    ...
    inline int64_t getAppOwner() const { DARABONBA_PTR_GET_DEFAULT(appOwner_, 0L) };
