...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->privateDNSList_ == nullptr && return this->requestId_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const vector<ListPrivateDNSResponseBodyPrivateDNSList> & privateDNSList() const { DARABONBA_PTR_GET_CONST(privateDNSList_, vector<ListPrivateDNSResponseBodyPrivateDNSList>) };
    inline vector<ListPrivateDNSResponseBodyPrivateDNSList> privateDNSList() { DARABONBA_PTR_GET(privateDNSList_, vector<ListPrivateDNSResponseBodyPrivateDNSList>) };
    inline ListPrivateDNSResponseBody& setPrivateDNSList(const vector<ListPrivateDNSResponseBodyPrivateDNSList> & privateDNSList) { DARABONBA_PTR_SET_VALUE(privateDNSList_, privateDNSList) };
    inline ListPrivateDNSResponseBody& setPrivateDNSList(vector<ListPrivateDNSResponseBodyPrivateDNSList> && privateDNSList) { DARABONBA_PTR_SET_RVALUE(privateDNSList_, privateDNSList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListPrivateDNSResponseBodyPrivateDNSList>> privateDNSList_ = nullptr;
    // The request ID.
