...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateInstanceWithPrivateDNSResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AssociateInstanceWithPrivateDNSResponseBody) };
    inline AssociateInstanceWithPrivateDNSResponseBody getBody() { DARABONBA_PTR_GET(body_, AssociateInstanceWithPrivateDNSResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AssociateInstanceWithPrivateDNSResponseBody> body_ {};
  };
