...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAPIHISTORYRESPONSEBODYOPENIDCONNECTCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEAPIHISTORYRESPONSEBODYOPENIDCONNECTCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeApiHistoryResponseBodyOpenIdConnectConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeApiHistoryResponseBodyOpenIdConnectConfig& obj) { 
    ...
    DescribeApiHistoryResponseBodyOpenIdConnectConfig() = default ;
    DescribeApiHistoryResponseBodyOpenIdConnectConfig(const DescribeApiHistoryResponseBodyOpenIdConnectConfig &) = default ;
    DescribeApiHistoryResponseBodyOpenIdConnectConfig(DescribeApiHistoryResponseBodyOpenIdConnectConfig &&) = default ;
    DescribeApiHistoryResponseBodyOpenIdConnectConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeApiHistoryResponseBodyOpenIdConnectConfig() = default ;
    DescribeApiHistoryResponseBodyOpenIdConnectConfig& operator=(const DescribeApiHistoryResponseBodyOpenIdConnectConfig &) = default ;
    DescribeApiHistoryResponseBodyOpenIdConnectConfig& operator=(DescribeApiHistoryResponseBodyOpenIdConnectConfig &&) = default ;
    ...
    inline DescribeApiHistoryResponseBodyOpenIdConnectConfig& setIdTokenParamName(string idTokenParamName) { DARABONBA_PTR_SET_VALUE(idTokenParamName_, idTokenParamName) };
    ...
    inline DescribeApiHistoryResponseBodyOpenIdConnectConfig& setOpenIdApiType(string openIdApiType) { DARABONBA_PTR_SET_VALUE(openIdApiType_, openIdApiType) };
    ...
    inline DescribeApiHistoryResponseBodyOpenIdConnectConfig& setPublicKey(string publicKey) { DARABONBA_PTR_SET_VALUE(publicKey_, publicKey) };
    ...
    inline DescribeApiHistoryResponseBodyOpenIdConnectConfig& setPublicKeyId(string publicKeyId) { DARABONBA_PTR_SET_VALUE(publicKeyId_, publicKeyId) };
