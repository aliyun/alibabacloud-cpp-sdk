...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->caCertificateBody_ == nullptr
        && this->certificateBody_ == nullptr && this->certificateName_ == nullptr && this->certificatePrivateKey_ == nullptr && this->clientCertSDnPassThrough_ == nullptr && this->domainName_ == nullptr
        && this->groupId_ == nullptr && this->securityToken_ == nullptr && this->sslOcspCacheEnable_ == nullptr && this->sslOcspEnable_ == nullptr && this->sslVerifyDepth_ == nullptr; };
    ...
    inline string getCaCertificateBody() const { DARABONBA_PTR_GET_DEFAULT(caCertificateBody_, "") };
    ...
    inline string getSslVerifyDepth() const { DARABONBA_PTR_GET_DEFAULT(sslVerifyDepth_, "") };
  ...
  protected:
    ...
    shared_ptr<string> caCertificateBody_ {};
    ...
    shared_ptr<string> sslVerifyDepth_ {};
  };
