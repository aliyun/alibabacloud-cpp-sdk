...
namespace Models
{
  ...
  public:
    ...
    inline const SetApiProductsAuthoritiesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetApiProductsAuthoritiesResponseBody) };
    inline SetApiProductsAuthoritiesResponseBody body() { DARABONBA_PTR_GET(body_, SetApiProductsAuthoritiesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetApiProductsAuthoritiesResponseBody> body_ = nullptr;
  };
