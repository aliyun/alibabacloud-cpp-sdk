...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccessControlListsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccessControlListsResponseBody) };
    inline DescribeAccessControlListsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAccessControlListsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAccessControlListsResponseBody> body_ = nullptr;
  };
