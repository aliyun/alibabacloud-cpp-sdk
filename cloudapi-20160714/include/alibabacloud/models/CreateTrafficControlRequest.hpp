...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->apiDefault_ == nullptr
        && return this->appDefault_ == nullptr && return this->description_ == nullptr && return this->securityToken_ == nullptr && return this->trafficControlName_ == nullptr && return this->trafficControlUnit_ == nullptr
        && return this->userDefault_ == nullptr; };
