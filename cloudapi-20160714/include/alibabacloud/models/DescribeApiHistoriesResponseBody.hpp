...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApiHistoriesResponseBodyApiHisItems & apiHisItems() const { DARABONBA_PTR_GET_CONST(apiHisItems_, DescribeApiHistoriesResponseBodyApiHisItems) };
    inline DescribeApiHistoriesResponseBodyApiHisItems apiHisItems() { DARABONBA_PTR_GET(apiHisItems_, DescribeApiHistoriesResponseBodyApiHisItems) };
    inline DescribeApiHistoriesResponseBody& setApiHisItems(const DescribeApiHistoriesResponseBodyApiHisItems & apiHisItems) { DARABONBA_PTR_SET_VALUE(apiHisItems_, apiHisItems) };
    inline DescribeApiHistoriesResponseBody& setApiHisItems(DescribeApiHistoriesResponseBodyApiHisItems && apiHisItems) { DARABONBA_PTR_SET_RVALUE(apiHisItems_, apiHisItems) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeApiHistoriesResponseBodyApiHisItems> apiHisItems_ = nullptr;
