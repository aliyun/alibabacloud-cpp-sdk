...
namespace Models
{
  ...
  public:
    ...
    inline const DryRunSwaggerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DryRunSwaggerResponseBody) };
    inline DryRunSwaggerResponseBody body() { DARABONBA_PTR_GET(body_, DryRunSwaggerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DryRunSwaggerResponseBody> body_ = nullptr;
  };
