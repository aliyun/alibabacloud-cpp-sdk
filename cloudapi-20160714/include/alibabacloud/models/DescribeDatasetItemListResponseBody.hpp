...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDatasetItemListResponseBodyDatasetItemInfoList> & datasetItemInfoList() const { DARABONBA_PTR_GET_CONST(datasetItemInfoList_, vector<DescribeDatasetItemListResponseBodyDatasetItemInfoList>) };
    inline vector<DescribeDatasetItemListResponseBodyDatasetItemInfoList> datasetItemInfoList() { DARABONBA_PTR_GET(datasetItemInfoList_, vector<DescribeDatasetItemListResponseBodyDatasetItemInfoList>) };
    inline DescribeDatasetItemListResponseBody& setDatasetItemInfoList(const vector<DescribeDatasetItemListResponseBodyDatasetItemInfoList> & datasetItemInfoList) { DARABONBA_PTR_SET_VALUE(datasetItemInfoList_, datasetItemInfoList) };
    inline DescribeDatasetItemListResponseBody& setDatasetItemInfoList(vector<DescribeDatasetItemListResponseBodyDatasetItemInfoList> && datasetItemInfoList) { DARABONBA_PTR_SET_RVALUE(datasetItemInfoList_, datasetItemInfoList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDatasetItemListResponseBodyDatasetItemInfoList>> datasetItemInfoList_ = nullptr;
