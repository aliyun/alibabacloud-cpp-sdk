...
namespace Models
{
  ...
  public:
    ...
    inline const SetDomainWebSocketStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetDomainWebSocketStatusResponseBody) };
    inline SetDomainWebSocketStatusResponseBody body() { DARABONBA_PTR_GET(body_, SetDomainWebSocketStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetDomainWebSocketStatusResponseBody> body_ = nullptr;
  };
