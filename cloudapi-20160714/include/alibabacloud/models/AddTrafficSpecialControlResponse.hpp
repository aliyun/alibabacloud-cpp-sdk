...
namespace Models
{
  ...
  public:
    ...
    inline const AddTrafficSpecialControlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddTrafficSpecialControlResponseBody) };
    inline AddTrafficSpecialControlResponseBody getBody() { DARABONBA_PTR_GET(body_, AddTrafficSpecialControlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddTrafficSpecialControlResponseBody> body_ {};
  };
