...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAPIRESPONSEBODYOPENIDCONNECTCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEAPIRESPONSEBODYOPENIDCONNECTCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeApiResponseBodyOpenIdConnectConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeApiResponseBodyOpenIdConnectConfig& obj) { 
    ...
    DescribeApiResponseBodyOpenIdConnectConfig() = default ;
    DescribeApiResponseBodyOpenIdConnectConfig(const DescribeApiResponseBodyOpenIdConnectConfig &) = default ;
    DescribeApiResponseBodyOpenIdConnectConfig(DescribeApiResponseBodyOpenIdConnectConfig &&) = default ;
    DescribeApiResponseBodyOpenIdConnectConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeApiResponseBodyOpenIdConnectConfig() = default ;
    DescribeApiResponseBodyOpenIdConnectConfig& operator=(const DescribeApiResponseBodyOpenIdConnectConfig &) = default ;
    DescribeApiResponseBodyOpenIdConnectConfig& operator=(DescribeApiResponseBodyOpenIdConnectConfig &&) = default ;
    ...
    inline DescribeApiResponseBodyOpenIdConnectConfig& setIdTokenParamName(string idTokenParamName) { DARABONBA_PTR_SET_VALUE(idTokenParamName_, idTokenParamName) };
    ...
    inline DescribeApiResponseBodyOpenIdConnectConfig& setOpenIdApiType(string openIdApiType) { DARABONBA_PTR_SET_VALUE(openIdApiType_, openIdApiType) };
    ...
    inline DescribeApiResponseBodyOpenIdConnectConfig& setPublicKey(string publicKey) { DARABONBA_PTR_SET_VALUE(publicKey_, publicKey) };
    ...
    inline DescribeApiResponseBodyOpenIdConnectConfig& setPublicKeyId(string publicKeyId) { DARABONBA_PTR_SET_VALUE(publicKeyId_, publicKeyId) };
