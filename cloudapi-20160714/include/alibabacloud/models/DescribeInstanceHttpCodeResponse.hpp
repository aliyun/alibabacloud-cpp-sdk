...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceHttpCodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceHttpCodeResponseBody) };
    inline DescribeInstanceHttpCodeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceHttpCodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceHttpCodeResponseBody> body_ {};
  };
