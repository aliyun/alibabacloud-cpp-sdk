...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLogConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteLogConfigResponseBody) };
    inline DeleteLogConfigResponseBody body() { DARABONBA_PTR_GET(body_, DeleteLogConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteLogConfigResponseBody> body_ = nullptr;
  };
