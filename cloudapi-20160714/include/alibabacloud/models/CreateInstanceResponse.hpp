...
namespace Models
{
  ...
  public:
    ...
    inline const CreateInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateInstanceResponseBody) };
    inline CreateInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateInstanceResponseBody> body_ {};
  };
