...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyIpControlPolicyItemResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyIpControlPolicyItemResponseBody) };
    inline ModifyIpControlPolicyItemResponseBody body() { DARABONBA_PTR_GET(body_, ModifyIpControlPolicyItemResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyIpControlPolicyItemResponseBody> body_ = nullptr;
  };
