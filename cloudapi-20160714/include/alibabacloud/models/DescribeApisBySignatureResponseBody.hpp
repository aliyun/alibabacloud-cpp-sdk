...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApisBySignatureResponseBody::ApiInfos & getApiInfos() const { DARABONBA_PTR_GET_CONST(apiInfos_, DescribeApisBySignatureResponseBody::ApiInfos) };
    inline DescribeApisBySignatureResponseBody::ApiInfos getApiInfos() { DARABONBA_PTR_GET(apiInfos_, DescribeApisBySignatureResponseBody::ApiInfos) };
    inline DescribeApisBySignatureResponseBody& setApiInfos(const DescribeApisBySignatureResponseBody::ApiInfos & apiInfos) { DARABONBA_PTR_SET_VALUE(apiInfos_, apiInfos) };
    inline DescribeApisBySignatureResponseBody& setApiInfos(DescribeApisBySignatureResponseBody::ApiInfos && apiInfos) { DARABONBA_PTR_SET_RVALUE(apiInfos_, apiInfos) };
  ...
  protected:
    ...
    shared_ptr<DescribeApisBySignatureResponseBody::ApiInfos> apiInfos_ {};
