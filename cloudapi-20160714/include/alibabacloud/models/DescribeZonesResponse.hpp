...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeZonesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeZonesResponseBody) };
    inline DescribeZonesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeZonesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeZonesResponseBody> body_ = nullptr;
  };
