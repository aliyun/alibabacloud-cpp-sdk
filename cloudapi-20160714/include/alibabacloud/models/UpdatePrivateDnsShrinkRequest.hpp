...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->intranetDomain_ == nullptr
        && return this->recordsShrink_ == nullptr && return this->securityToken_ == nullptr && return this->type_ == nullptr; };
    ...
    inline string recordsShrink() const { DARABONBA_PTR_GET_DEFAULT(recordsShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> recordsShrink_ = nullptr;
