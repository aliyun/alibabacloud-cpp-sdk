...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceTrafficResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceTrafficResponseBody) };
    inline DescribeInstanceTrafficResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceTrafficResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceTrafficResponseBody> body_ {};
  };
