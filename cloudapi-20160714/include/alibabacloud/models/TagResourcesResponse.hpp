...
namespace Models
{
  ...
  public:
    ...
    inline const TagResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TagResourcesResponseBody) };
    inline TagResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, TagResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TagResourcesResponseBody> body_ {};
  };
