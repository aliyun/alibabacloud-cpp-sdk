...
namespace Models
{
  ...
  public:
    ...
    inline const SetWildcardDomainPatternsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetWildcardDomainPatternsResponseBody) };
    inline SetWildcardDomainPatternsResponseBody getBody() { DARABONBA_PTR_GET(body_, SetWildcardDomainPatternsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetWildcardDomainPatternsResponseBody> body_ {};
  };
