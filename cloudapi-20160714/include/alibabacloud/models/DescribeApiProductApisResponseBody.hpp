  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->path_ == nullptr && this->regionId_ == nullptr && this->stageName_ == nullptr; };
    ...
    inline const DescribeApiProductApisResponseBody::ApiInfoList & getApiInfoList() const { DARABONBA_PTR_GET_CONST(apiInfoList_, DescribeApiProductApisResponseBody::ApiInfoList) };
    inline DescribeApiProductApisResponseBody::ApiInfoList getApiInfoList() { DARABONBA_PTR_GET(apiInfoList_, DescribeApiProductApisResponseBody::ApiInfoList) };
    inline DescribeApiProductApisResponseBody& setApiInfoList(const DescribeApiProductApisResponseBody::ApiInfoList & apiInfoList) { DARABONBA_PTR_SET_VALUE(apiInfoList_, apiInfoList) };
    inline DescribeApiProductApisResponseBody& setApiInfoList(DescribeApiProductApisResponseBody::ApiInfoList && apiInfoList) { DARABONBA_PTR_SET_RVALUE(apiInfoList_, apiInfoList) };
