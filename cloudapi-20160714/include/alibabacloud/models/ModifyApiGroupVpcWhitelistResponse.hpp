...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyApiGroupVpcWhitelistResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyApiGroupVpcWhitelistResponseBody) };
    inline ModifyApiGroupVpcWhitelistResponseBody body() { DARABONBA_PTR_GET(body_, ModifyApiGroupVpcWhitelistResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyApiGroupVpcWhitelistResponseBody> body_ = nullptr;
  };
