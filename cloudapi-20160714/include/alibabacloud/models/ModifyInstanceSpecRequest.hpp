...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoPay_ == nullptr
        && this->instanceId_ == nullptr && this->instanceSpec_ == nullptr && this->modifyAction_ == nullptr && this->skipWaitSwitch_ == nullptr && this->token_ == nullptr; };
    ...
    inline string getModifyAction() const { DARABONBA_PTR_GET_DEFAULT(modifyAction_, "") };
    ...
    inline bool getSkipWaitSwitch() const { DARABONBA_PTR_GET_DEFAULT(skipWaitSwitch_, false) };
  ...
  protected:
    ...
    shared_ptr<string> modifyAction_ {};
    ...
    shared_ptr<bool> skipWaitSwitch_ {};
    // The password.
    // 
    // This parameter is required.
