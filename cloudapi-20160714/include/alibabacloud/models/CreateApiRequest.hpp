...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowSignatureMethod_ == nullptr
        && return this->apiName_ == nullptr && return this->appCodeAuthType_ == nullptr && return this->authType_ == nullptr && return this->backendEnable_ == nullptr && return this->backendId_ == nullptr
        && return this->constantParameters_ == nullptr && return this->description_ == nullptr && return this->disableInternet_ == nullptr && return this->errorCodeSamples_ == nullptr && return this->failResultSample_ == nullptr
        && return this->forceNonceCheck_ == nullptr && return this->groupId_ == nullptr && return this->openIdConnectConfig_ == nullptr && return this->requestConfig_ == nullptr && return this->requestParameters_ == nullptr
        && return this->resultBodyModel_ == nullptr && return this->resultDescriptions_ == nullptr && return this->resultSample_ == nullptr && return this->resultType_ == nullptr && return this->securityToken_ == nullptr
        && return this->serviceConfig_ == nullptr && return this->serviceParameters_ == nullptr && return this->serviceParametersMap_ == nullptr && return this->systemParameters_ == nullptr && return this->tag_ == nullptr
    ...
    inline const vector<CreateApiRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateApiRequestTag>) };
    inline vector<CreateApiRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<CreateApiRequestTag>) };
    inline CreateApiRequest& setTag(const vector<CreateApiRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateApiRequest& setTag(vector<CreateApiRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The list of tags.
    std::shared_ptr<vector<CreateApiRequestTag>> tag_ = nullptr;
