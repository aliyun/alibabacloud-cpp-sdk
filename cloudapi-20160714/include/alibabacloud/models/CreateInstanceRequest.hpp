...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoPay_ == nullptr
        && return this->chargeType_ == nullptr && return this->duration_ == nullptr && return this->httpsPolicy_ == nullptr && return this->instanceCidr_ == nullptr && return this->instanceName_ == nullptr
        && return this->instanceSpec_ == nullptr && return this->instanceType_ == nullptr && return this->pricingCycle_ == nullptr && return this->tag_ == nullptr && return this->token_ == nullptr
        && return this->userVpcId_ == nullptr && return this->zoneId_ == nullptr && return this->zoneVSwitchSecurityGroup_ == nullptr; };
    ...
    inline string instanceCidr() const { DARABONBA_PTR_GET_DEFAULT(instanceCidr_, "") };
    ...
    inline const vector<CreateInstanceRequestZoneVSwitchSecurityGroup> & zoneVSwitchSecurityGroup() const { DARABONBA_PTR_GET_CONST(zoneVSwitchSecurityGroup_, vector<CreateInstanceRequestZoneVSwitchSecurityGroup>) };
    inline vector<CreateInstanceRequestZoneVSwitchSecurityGroup> zoneVSwitchSecurityGroup() { DARABONBA_PTR_GET(zoneVSwitchSecurityGroup_, vector<CreateInstanceRequestZoneVSwitchSecurityGroup>) };
    inline CreateInstanceRequest& setZoneVSwitchSecurityGroup(const vector<CreateInstanceRequestZoneVSwitchSecurityGroup> & zoneVSwitchSecurityGroup) { DARABONBA_PTR_SET_VALUE(zoneVSwitchSecurityGroup_, zoneVSwitchSecurityGroup) };
    inline CreateInstanceRequest& setZoneVSwitchSecurityGroup(vector<CreateInstanceRequestZoneVSwitchSecurityGroup> && zoneVSwitchSecurityGroup) { DARABONBA_PTR_SET_RVALUE(zoneVSwitchSecurityGroup_, zoneVSwitchSecurityGroup) };
  ...
  protected:
    ...
    std::shared_ptr<string> instanceCidr_ = nullptr;
    // Instance Name
    // 
    // This parameter is required.
    ...
    // 
    // >  This parameter is in invitational preview and not available for public use.
    std::shared_ptr<vector<CreateInstanceRequestZoneVSwitchSecurityGroup>> zoneVSwitchSecurityGroup_ = nullptr;
  };
