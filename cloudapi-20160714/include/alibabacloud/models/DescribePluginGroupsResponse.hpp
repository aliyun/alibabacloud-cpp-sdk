...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePluginGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePluginGroupsResponseBody) };
    inline DescribePluginGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePluginGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePluginGroupsResponseBody> body_ {};
  };
