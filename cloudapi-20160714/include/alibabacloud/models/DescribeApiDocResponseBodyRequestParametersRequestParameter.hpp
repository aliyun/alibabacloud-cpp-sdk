...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAPIDOCRESPONSEBODYREQUESTPARAMETERSREQUESTPARAMETER_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEAPIDOCRESPONSEBODYREQUESTPARAMETERSREQUESTPARAMETER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeApiDocResponseBodyRequestParametersRequestParameter& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeApiDocResponseBodyRequestParametersRequestParameter& obj) { 
    ...
    DescribeApiDocResponseBodyRequestParametersRequestParameter() = default ;
    DescribeApiDocResponseBodyRequestParametersRequestParameter(const DescribeApiDocResponseBodyRequestParametersRequestParameter &) = default ;
    DescribeApiDocResponseBodyRequestParametersRequestParameter(DescribeApiDocResponseBodyRequestParametersRequestParameter &&) = default ;
    DescribeApiDocResponseBodyRequestParametersRequestParameter(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeApiDocResponseBodyRequestParametersRequestParameter() = default ;
    DescribeApiDocResponseBodyRequestParametersRequestParameter& operator=(const DescribeApiDocResponseBodyRequestParametersRequestParameter &) = default ;
    DescribeApiDocResponseBodyRequestParametersRequestParameter& operator=(DescribeApiDocResponseBodyRequestParametersRequestParameter &&) = default ;
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setApiParameterName(string apiParameterName) { DARABONBA_PTR_SET_VALUE(apiParameterName_, apiParameterName) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setArrayItemsType(string arrayItemsType) { DARABONBA_PTR_SET_VALUE(arrayItemsType_, arrayItemsType) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setDefaultValue(string defaultValue) { DARABONBA_PTR_SET_VALUE(defaultValue_, defaultValue) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setDemoValue(string demoValue) { DARABONBA_PTR_SET_VALUE(demoValue_, demoValue) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setDocOrder(int32_t docOrder) { DARABONBA_PTR_SET_VALUE(docOrder_, docOrder) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setDocShow(string docShow) { DARABONBA_PTR_SET_VALUE(docShow_, docShow) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setEnumValue(string enumValue) { DARABONBA_PTR_SET_VALUE(enumValue_, enumValue) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setJsonScheme(string jsonScheme) { DARABONBA_PTR_SET_VALUE(jsonScheme_, jsonScheme) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setLocation(string location) { DARABONBA_PTR_SET_VALUE(location_, location) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setMaxLength(int64_t maxLength) { DARABONBA_PTR_SET_VALUE(maxLength_, maxLength) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setMaxValue(int64_t maxValue) { DARABONBA_PTR_SET_VALUE(maxValue_, maxValue) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setMinLength(int64_t minLength) { DARABONBA_PTR_SET_VALUE(minLength_, minLength) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setMinValue(int64_t minValue) { DARABONBA_PTR_SET_VALUE(minValue_, minValue) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setParameterType(string parameterType) { DARABONBA_PTR_SET_VALUE(parameterType_, parameterType) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setRegularExpression(string regularExpression) { DARABONBA_PTR_SET_VALUE(regularExpression_, regularExpression) };
    ...
    inline DescribeApiDocResponseBodyRequestParametersRequestParameter& setRequired(string required) { DARABONBA_PTR_SET_VALUE(required_, required) };
