...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDatasetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDatasetResponseBody) };
    inline ModifyDatasetResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDatasetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDatasetResponseBody> body_ {};
  };
