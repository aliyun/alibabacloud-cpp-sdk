...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->apiName_ == nullptr
        && this->apiUid_ == nullptr && this->appId_ == nullptr && this->description_ == nullptr && this->method_ == nullptr && this->pageNumber_ == nullptr
        && this->pageSize_ == nullptr && this->path_ == nullptr && this->securityToken_ == nullptr; };
