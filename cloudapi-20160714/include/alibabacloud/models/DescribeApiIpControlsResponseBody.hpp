...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApiIpControlsResponseBodyApiIpControls & apiIpControls() const { DARABONBA_PTR_GET_CONST(apiIpControls_, DescribeApiIpControlsResponseBodyApiIpControls) };
    inline DescribeApiIpControlsResponseBodyApiIpControls apiIpControls() { DARABONBA_PTR_GET(apiIpControls_, DescribeApiIpControlsResponseBodyApiIpControls) };
    inline DescribeApiIpControlsResponseBody& setApiIpControls(const DescribeApiIpControlsResponseBodyApiIpControls & apiIpControls) { DARABONBA_PTR_SET_VALUE(apiIpControls_, apiIpControls) };
    inline DescribeApiIpControlsResponseBody& setApiIpControls(DescribeApiIpControlsResponseBodyApiIpControls && apiIpControls) { DARABONBA_PTR_SET_RVALUE(apiIpControls_, apiIpControls) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeApiIpControlsResponseBodyApiIpControls> apiIpControls_ = nullptr;
