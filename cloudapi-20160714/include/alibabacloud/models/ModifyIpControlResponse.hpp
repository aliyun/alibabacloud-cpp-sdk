...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyIpControlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyIpControlResponseBody) };
    inline ModifyIpControlResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyIpControlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyIpControlResponseBody> body_ {};
  };
