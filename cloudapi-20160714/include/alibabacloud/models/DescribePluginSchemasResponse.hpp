...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePluginSchemasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePluginSchemasResponseBody) };
    inline DescribePluginSchemasResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePluginSchemasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePluginSchemasResponseBody> body_ {};
  };
