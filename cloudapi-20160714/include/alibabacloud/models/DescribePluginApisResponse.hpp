...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePluginApisResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribePluginApisResponseBody) };
    inline DescribePluginApisResponseBody body() { DARABONBA_PTR_GET(body_, DescribePluginApisResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePluginApisResponseBody> body_ = nullptr;
  };
