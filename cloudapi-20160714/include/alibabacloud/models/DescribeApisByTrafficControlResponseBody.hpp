...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApisByTrafficControlResponseBody::ApiInfos & getApiInfos() const { DARABONBA_PTR_GET_CONST(apiInfos_, DescribeApisByTrafficControlResponseBody::ApiInfos) };
    inline DescribeApisByTrafficControlResponseBody::ApiInfos getApiInfos() { DARABONBA_PTR_GET(apiInfos_, DescribeApisByTrafficControlResponseBody::ApiInfos) };
    inline DescribeApisByTrafficControlResponseBody& setApiInfos(const DescribeApisByTrafficControlResponseBody::ApiInfos & apiInfos) { DARABONBA_PTR_SET_VALUE(apiInfos_, apiInfos) };
    inline DescribeApisByTrafficControlResponseBody& setApiInfos(DescribeApisByTrafficControlResponseBody::ApiInfos && apiInfos) { DARABONBA_PTR_SET_RVALUE(apiInfos_, apiInfos) };
