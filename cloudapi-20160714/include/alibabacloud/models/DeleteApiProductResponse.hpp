...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteApiProductResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteApiProductResponseBody) };
    inline DeleteApiProductResponseBody body() { DARABONBA_PTR_GET(body_, DeleteApiProductResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteApiProductResponseBody> body_ = nullptr;
  };
