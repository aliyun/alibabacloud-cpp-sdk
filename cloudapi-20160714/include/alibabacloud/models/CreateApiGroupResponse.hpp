...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApiGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateApiGroupResponseBody) };
    inline CreateApiGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateApiGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateApiGroupResponseBody> body_ {};
  };
