...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAuthorizedAppsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAuthorizedAppsResponseBody) };
    inline DescribeAuthorizedAppsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAuthorizedAppsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAuthorizedAppsResponseBody> body_ {};
  };
