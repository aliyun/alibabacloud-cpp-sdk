...
namespace Models
{
  ...
  public:
    ...
    inline const EnableInstanceAccessControlResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, EnableInstanceAccessControlResponseBody) };
    inline EnableInstanceAccessControlResponseBody body() { DARABONBA_PTR_GET(body_, EnableInstanceAccessControlResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<EnableInstanceAccessControlResponseBody> body_ = nullptr;
  };
