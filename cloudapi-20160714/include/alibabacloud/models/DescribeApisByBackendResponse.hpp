...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApisByBackendResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeApisByBackendResponseBody) };
    inline DescribeApisByBackendResponseBody body() { DARABONBA_PTR_GET(body_, DescribeApisByBackendResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeApisByBackendResponseBody> body_ = nullptr;
  };
