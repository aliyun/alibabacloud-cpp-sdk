...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePrivateDNSResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePrivateDNSResponseBody) };
    inline CreatePrivateDNSResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePrivateDNSResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePrivateDNSResponseBody> body_ {};
  };
