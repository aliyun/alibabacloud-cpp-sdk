...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApiQpsDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApiQpsDataResponseBody) };
    inline DescribeApiQpsDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApiQpsDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApiQpsDataResponseBody> body_ {};
  };
