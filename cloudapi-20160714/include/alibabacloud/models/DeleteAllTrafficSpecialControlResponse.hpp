...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAllTrafficSpecialControlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAllTrafficSpecialControlResponseBody) };
    inline DeleteAllTrafficSpecialControlResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAllTrafficSpecialControlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAllTrafficSpecialControlResponseBody> body_ {};
  };
