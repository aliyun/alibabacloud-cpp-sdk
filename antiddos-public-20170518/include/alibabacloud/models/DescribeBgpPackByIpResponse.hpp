...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBgpPackByIpResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBgpPackByIpResponseBody) };
    inline DescribeBgpPackByIpResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBgpPackByIpResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBgpPackByIpResponseBody> body_ {};
  };
