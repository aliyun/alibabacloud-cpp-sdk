...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceIpAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceIpAddressResponseBody) };
    inline DescribeInstanceIpAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceIpAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceIpAddressResponseBody> body_ {};
  };
