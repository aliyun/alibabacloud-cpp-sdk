...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEINSTANCEIPADDRESSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEINSTANCEIPADDRESSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeInstanceIpAddressRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeInstanceIpAddressRequest& obj) { 
    ...
    DescribeInstanceIpAddressRequest() = default ;
    DescribeInstanceIpAddressRequest(const DescribeInstanceIpAddressRequest &) = default ;
    DescribeInstanceIpAddressRequest(DescribeInstanceIpAddressRequest &&) = default ;
    DescribeInstanceIpAddressRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeInstanceIpAddressRequest() = default ;
    DescribeInstanceIpAddressRequest& operator=(const DescribeInstanceIpAddressRequest &) = default ;
    DescribeInstanceIpAddressRequest& operator=(DescribeInstanceIpAddressRequest &&) = default ;
    ...
    inline DescribeInstanceIpAddressRequest& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline DescribeInstanceIpAddressRequest& setDdosRegionId(string ddosRegionId) { DARABONBA_PTR_SET_VALUE(ddosRegionId_, ddosRegionId) };
    ...
    inline DescribeInstanceIpAddressRequest& setDdosStatus(string ddosStatus) { DARABONBA_PTR_SET_VALUE(ddosStatus_, ddosStatus) };
    ...
    inline DescribeInstanceIpAddressRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline DescribeInstanceIpAddressRequest& setInstanceIp(string instanceIp) { DARABONBA_PTR_SET_VALUE(instanceIp_, instanceIp) };
    ...
    inline DescribeInstanceIpAddressRequest& setInstanceName(string instanceName) { DARABONBA_PTR_SET_VALUE(instanceName_, instanceName) };
    ...
    inline DescribeInstanceIpAddressRequest& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline DescribeInstanceIpAddressRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
