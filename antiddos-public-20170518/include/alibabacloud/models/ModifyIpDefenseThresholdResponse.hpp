...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyIpDefenseThresholdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyIpDefenseThresholdResponseBody) };
    inline ModifyIpDefenseThresholdResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyIpDefenseThresholdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyIpDefenseThresholdResponseBody> body_ {};
  };
