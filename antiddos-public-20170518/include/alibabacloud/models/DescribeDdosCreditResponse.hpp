...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDdosCreditResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDdosCreditResponseBody) };
    inline DescribeDdosCreditResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDdosCreditResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDdosCreditResponseBody> body_ {};
  };
