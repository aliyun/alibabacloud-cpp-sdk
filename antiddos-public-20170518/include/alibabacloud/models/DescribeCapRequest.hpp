...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->begTime_ == nullptr
    ...
    inline int64_t getBegTime() const { DARABONBA_PTR_GET_DEFAULT(begTime_, 0L) };
