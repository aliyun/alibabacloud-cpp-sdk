...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIpLocationServiceResponseBodyInstance & instance() const { DARABONBA_PTR_GET_CONST(instance_, DescribeIpLocationServiceResponseBodyInstance) };
    inline DescribeIpLocationServiceResponseBodyInstance instance() { DARABONBA_PTR_GET(instance_, DescribeIpLocationServiceResponseBodyInstance) };
    inline DescribeIpLocationServiceResponseBody& setInstance(const DescribeIpLocationServiceResponseBodyInstance & instance) { DARABONBA_PTR_SET_VALUE(instance_, instance) };
    inline DescribeIpLocationServiceResponseBody& setInstance(DescribeIpLocationServiceResponseBodyInstance && instance) { DARABONBA_PTR_SET_RVALUE(instance_, instance) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeIpLocationServiceResponseBodyInstance> instance_ = nullptr;
