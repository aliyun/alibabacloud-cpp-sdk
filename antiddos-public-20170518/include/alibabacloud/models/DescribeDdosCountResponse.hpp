...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDdosCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDdosCountResponseBody) };
    inline DescribeDdosCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDdosCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDdosCountResponseBody> body_ {};
  };
