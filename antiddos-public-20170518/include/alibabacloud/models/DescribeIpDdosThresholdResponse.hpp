...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIpDdosThresholdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeIpDdosThresholdResponseBody) };
    inline DescribeIpDdosThresholdResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeIpDdosThresholdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeIpDdosThresholdResponseBody> body_ {};
  };
