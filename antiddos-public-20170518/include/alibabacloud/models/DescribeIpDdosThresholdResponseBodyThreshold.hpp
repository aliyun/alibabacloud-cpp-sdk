...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEIPDDOSTHRESHOLDRESPONSEBODYTHRESHOLD_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEIPDDOSTHRESHOLDRESPONSEBODYTHRESHOLD_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeIpDdosThresholdResponseBodyThreshold& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeIpDdosThresholdResponseBodyThreshold& obj) { 
    ...
    DescribeIpDdosThresholdResponseBodyThreshold() = default ;
    DescribeIpDdosThresholdResponseBodyThreshold(const DescribeIpDdosThresholdResponseBodyThreshold &) = default ;
    DescribeIpDdosThresholdResponseBodyThreshold(DescribeIpDdosThresholdResponseBodyThreshold &&) = default ;
    DescribeIpDdosThresholdResponseBodyThreshold(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeIpDdosThresholdResponseBodyThreshold() = default ;
    DescribeIpDdosThresholdResponseBodyThreshold& operator=(const DescribeIpDdosThresholdResponseBodyThreshold &) = default ;
    DescribeIpDdosThresholdResponseBodyThreshold& operator=(DescribeIpDdosThresholdResponseBodyThreshold &&) = default ;
    ...
    inline DescribeIpDdosThresholdResponseBodyThreshold& setBps(int32_t bps) { DARABONBA_PTR_SET_VALUE(bps_, bps) };
    ...
    inline DescribeIpDdosThresholdResponseBodyThreshold& setDdosType(string ddosType) { DARABONBA_PTR_SET_VALUE(ddosType_, ddosType) };
    ...
    inline DescribeIpDdosThresholdResponseBodyThreshold& setElasticBps(int32_t elasticBps) { DARABONBA_PTR_SET_VALUE(elasticBps_, elasticBps) };
    ...
    inline DescribeIpDdosThresholdResponseBodyThreshold& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline DescribeIpDdosThresholdResponseBodyThreshold& setInternetIp(string internetIp) { DARABONBA_PTR_SET_VALUE(internetIp_, internetIp) };
    ...
    inline DescribeIpDdosThresholdResponseBodyThreshold& setIsAuto(bool isAuto) { DARABONBA_PTR_SET_VALUE(isAuto_, isAuto) };
    ...
    inline DescribeIpDdosThresholdResponseBodyThreshold& setMaxBps(int32_t maxBps) { DARABONBA_PTR_SET_VALUE(maxBps_, maxBps) };
    ...
    inline DescribeIpDdosThresholdResponseBodyThreshold& setMaxPps(int32_t maxPps) { DARABONBA_PTR_SET_VALUE(maxPps_, maxPps) };
    ...
    inline DescribeIpDdosThresholdResponseBodyThreshold& setPps(int32_t pps) { DARABONBA_PTR_SET_VALUE(pps_, pps) };
