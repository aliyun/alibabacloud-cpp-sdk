...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clusterId_ == nullptr
        && this->multimodCmsUrl_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline string getMultimodCmsUrl() const { DARABONBA_PTR_GET_DEFAULT(multimodCmsUrl_, "") };
  ...
  protected:
    ...
    shared_ptr<string> multimodCmsUrl_ {};
    // The request ID.
