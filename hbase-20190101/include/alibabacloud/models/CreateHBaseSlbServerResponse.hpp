...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHBaseSlbServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHBaseSlbServerResponseBody) };
    inline CreateHBaseSlbServerResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHBaseSlbServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHBaseSlbServerResponseBody> body_ {};
  };
