...
namespace Models
{
  ...
  public:
    ...
    inline const QueryHBaseHaDBResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryHBaseHaDBResponseBody) };
    inline QueryHBaseHaDBResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryHBaseHaDBResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryHBaseHaDBResponseBody> body_ {};
  };
