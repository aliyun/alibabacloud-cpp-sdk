...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEMULTIZONEAVAILABLERESOURCERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEMULTIZONEAVAILABLERESOURCERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeMultiZoneAvailableResourceResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AvailableZones, availableZones_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeMultiZoneAvailableResourceResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AvailableZones, availableZones_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeMultiZoneAvailableResourceResponseBody() = default ;
    DescribeMultiZoneAvailableResourceResponseBody(const DescribeMultiZoneAvailableResourceResponseBody &) = default ;
    DescribeMultiZoneAvailableResourceResponseBody(DescribeMultiZoneAvailableResourceResponseBody &&) = default ;
    DescribeMultiZoneAvailableResourceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeMultiZoneAvailableResourceResponseBody() = default ;
    DescribeMultiZoneAvailableResourceResponseBody& operator=(const DescribeMultiZoneAvailableResourceResponseBody &) = default ;
    DescribeMultiZoneAvailableResourceResponseBody& operator=(DescribeMultiZoneAvailableResourceResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->regionId_ == nullptr && this->supportedEngines_ == nullptr && this->zoneCombination_ == nullptr; };
        ...
        inline AvailableZone& setZoneCombination(string zoneCombination) { DARABONBA_PTR_SET_VALUE(zoneCombination_, zoneCombination) };
    ...
    inline const DescribeMultiZoneAvailableResourceResponseBody::AvailableZones & getAvailableZones() const { DARABONBA_PTR_GET_CONST(availableZones_, DescribeMultiZoneAvailableResourceResponseBody::AvailableZones) };
    inline DescribeMultiZoneAvailableResourceResponseBody::AvailableZones getAvailableZones() { DARABONBA_PTR_GET(availableZones_, DescribeMultiZoneAvailableResourceResponseBody::AvailableZones) };
    inline DescribeMultiZoneAvailableResourceResponseBody& setAvailableZones(const DescribeMultiZoneAvailableResourceResponseBody::AvailableZones & availableZones) { DARABONBA_PTR_SET_VALUE(availableZones_, availableZones) };
    inline DescribeMultiZoneAvailableResourceResponseBody& setAvailableZones(DescribeMultiZoneAvailableResourceResponseBody::AvailableZones && availableZones) { DARABONBA_PTR_SET_RVALUE(availableZones_, availableZones) };
    ...
    inline DescribeMultiZoneAvailableResourceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<DescribeMultiZoneAvailableResourceResponseBody::AvailableZones> availableZones_ {};
    // The request ID.
