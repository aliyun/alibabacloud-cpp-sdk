...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEndpointsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEndpointsResponseBody) };
    inline DescribeEndpointsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEndpointsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEndpointsResponseBody> body_ {};
  };
