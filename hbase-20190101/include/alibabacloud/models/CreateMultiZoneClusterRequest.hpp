...
#ifndef ALIBABACLOUD_MODELS_CREATEMULTIZONECLUSTERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEMULTIZONECLUSTERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateMultiZoneClusterRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateMultiZoneClusterRequest& obj) { 
    ...
    CreateMultiZoneClusterRequest() = default ;
    CreateMultiZoneClusterRequest(const CreateMultiZoneClusterRequest &) = default ;
    CreateMultiZoneClusterRequest(CreateMultiZoneClusterRequest &&) = default ;
    CreateMultiZoneClusterRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateMultiZoneClusterRequest() = default ;
    CreateMultiZoneClusterRequest& operator=(const CreateMultiZoneClusterRequest &) = default ;
    CreateMultiZoneClusterRequest& operator=(CreateMultiZoneClusterRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->arbiterVSwitchId_ == nullptr
        ...
        && this->primaryVSwitchId_ == nullptr && this->primaryZoneId_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->securityIPList_ == nullptr
        && this->standbyVSwitchId_ == nullptr && this->standbyZoneId_ == nullptr && this->vpcId_ == nullptr; };
    ...
    inline CreateMultiZoneClusterRequest& setArbiterVSwitchId(string arbiterVSwitchId) { DARABONBA_PTR_SET_VALUE(arbiterVSwitchId_, arbiterVSwitchId) };
    ...
    inline CreateMultiZoneClusterRequest& setArbiterZoneId(string arbiterZoneId) { DARABONBA_PTR_SET_VALUE(arbiterZoneId_, arbiterZoneId) };
    ...
    inline CreateMultiZoneClusterRequest& setArchVersion(string archVersion) { DARABONBA_PTR_SET_VALUE(archVersion_, archVersion) };
    ...
    inline CreateMultiZoneClusterRequest& setAutoRenewPeriod(int32_t autoRenewPeriod) { DARABONBA_PTR_SET_VALUE(autoRenewPeriod_, autoRenewPeriod) };
    ...
    inline CreateMultiZoneClusterRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline CreateMultiZoneClusterRequest& setClusterName(string clusterName) { DARABONBA_PTR_SET_VALUE(clusterName_, clusterName) };
    ...
    inline CreateMultiZoneClusterRequest& setCoreDiskSize(int32_t coreDiskSize) { DARABONBA_PTR_SET_VALUE(coreDiskSize_, coreDiskSize) };
    ...
    inline CreateMultiZoneClusterRequest& setCoreDiskType(string coreDiskType) { DARABONBA_PTR_SET_VALUE(coreDiskType_, coreDiskType) };
    ...
    inline CreateMultiZoneClusterRequest& setCoreInstanceType(string coreInstanceType) { DARABONBA_PTR_SET_VALUE(coreInstanceType_, coreInstanceType) };
    ...
    inline CreateMultiZoneClusterRequest& setCoreNodeCount(int32_t coreNodeCount) { DARABONBA_PTR_SET_VALUE(coreNodeCount_, coreNodeCount) };
    ...
    inline CreateMultiZoneClusterRequest& setEngine(string engine) { DARABONBA_PTR_SET_VALUE(engine_, engine) };
    ...
    inline CreateMultiZoneClusterRequest& setEngineVersion(string engineVersion) { DARABONBA_PTR_SET_VALUE(engineVersion_, engineVersion) };
    ...
    inline CreateMultiZoneClusterRequest& setLogDiskSize(int32_t logDiskSize) { DARABONBA_PTR_SET_VALUE(logDiskSize_, logDiskSize) };
    ...
    inline CreateMultiZoneClusterRequest& setLogDiskType(string logDiskType) { DARABONBA_PTR_SET_VALUE(logDiskType_, logDiskType) };
    ...
    inline CreateMultiZoneClusterRequest& setLogInstanceType(string logInstanceType) { DARABONBA_PTR_SET_VALUE(logInstanceType_, logInstanceType) };
    ...
    inline CreateMultiZoneClusterRequest& setLogNodeCount(int32_t logNodeCount) { DARABONBA_PTR_SET_VALUE(logNodeCount_, logNodeCount) };
    ...
    inline CreateMultiZoneClusterRequest& setMasterInstanceType(string masterInstanceType) { DARABONBA_PTR_SET_VALUE(masterInstanceType_, masterInstanceType) };
    ...
    inline CreateMultiZoneClusterRequest& setMultiZoneCombination(string multiZoneCombination) { DARABONBA_PTR_SET_VALUE(multiZoneCombination_, multiZoneCombination) };
    ...
    inline CreateMultiZoneClusterRequest& setPayType(string payType) { DARABONBA_PTR_SET_VALUE(payType_, payType) };
    ...
    inline CreateMultiZoneClusterRequest& setPeriod(int32_t period) { DARABONBA_PTR_SET_VALUE(period_, period) };
    ...
    inline CreateMultiZoneClusterRequest& setPeriodUnit(string periodUnit) { DARABONBA_PTR_SET_VALUE(periodUnit_, periodUnit) };
    ...
    inline CreateMultiZoneClusterRequest& setPrimaryVSwitchId(string primaryVSwitchId) { DARABONBA_PTR_SET_VALUE(primaryVSwitchId_, primaryVSwitchId) };
    ...
    inline CreateMultiZoneClusterRequest& setPrimaryZoneId(string primaryZoneId) { DARABONBA_PTR_SET_VALUE(primaryZoneId_, primaryZoneId) };
    ...
    inline CreateMultiZoneClusterRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline CreateMultiZoneClusterRequest& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline CreateMultiZoneClusterRequest& setSecurityIPList(string securityIPList) { DARABONBA_PTR_SET_VALUE(securityIPList_, securityIPList) };
    ...
    inline CreateMultiZoneClusterRequest& setStandbyVSwitchId(string standbyVSwitchId) { DARABONBA_PTR_SET_VALUE(standbyVSwitchId_, standbyVSwitchId) };
    ...
    inline CreateMultiZoneClusterRequest& setStandbyZoneId(string standbyZoneId) { DARABONBA_PTR_SET_VALUE(standbyZoneId_, standbyZoneId) };
    ...
    inline CreateMultiZoneClusterRequest& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
