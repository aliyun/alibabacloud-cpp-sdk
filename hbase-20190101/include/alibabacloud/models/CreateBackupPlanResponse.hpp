...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBackupPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBackupPlanResponseBody) };
    inline CreateBackupPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBackupPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBackupPlanResponseBody> body_ {};
  };
