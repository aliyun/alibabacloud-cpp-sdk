...
namespace Models
{
  ...
  public:
    ...
    inline const RelateDbForHBaseHaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RelateDbForHBaseHaResponseBody) };
    inline RelateDbForHBaseHaResponseBody getBody() { DARABONBA_PTR_GET(body_, RelateDbForHBaseHaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RelateDbForHBaseHaResponseBody> body_ {};
  };
