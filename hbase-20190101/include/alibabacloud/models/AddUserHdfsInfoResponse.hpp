...
namespace Models
{
  ...
  public:
    ...
    inline const AddUserHdfsInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddUserHdfsInfoResponseBody) };
    inline AddUserHdfsInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, AddUserHdfsInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddUserHdfsInfoResponseBody> body_ {};
  };
