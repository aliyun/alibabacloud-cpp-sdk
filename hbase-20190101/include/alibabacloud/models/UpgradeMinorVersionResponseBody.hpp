...
namespace Models
{
  ...
  public:
    ...
    inline UpgradeMinorVersionResponseBody& setUpgradingComponents(string upgradingComponents) { DARABONBA_PTR_SET_VALUE(upgradingComponents_, upgradingComponents) };
