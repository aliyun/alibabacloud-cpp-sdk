...
namespace Models
{
  ...
  public:
    ...
    inline bool getClearAllocationDefaultCidrMask() const { DARABONBA_PTR_GET_DEFAULT(clearAllocationDefaultCidrMask_, false) };
  ...
  protected:
    ...
    // *   **true**
    // *   **false**
    shared_ptr<bool> clearAllocationDefaultCidrMask_ {};
