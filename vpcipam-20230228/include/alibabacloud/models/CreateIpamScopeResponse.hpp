...
namespace Models
{
  ...
  public:
    ...
    inline const CreateIpamScopeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateIpamScopeResponseBody) };
    inline CreateIpamScopeResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateIpamScopeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateIpamScopeResponseBody> body_ {};
  };
