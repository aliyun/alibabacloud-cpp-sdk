...
namespace Models
{
  ...
  public:
    ...
    inline const OpenVpcIpamServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenVpcIpamServiceResponseBody) };
    inline OpenVpcIpamServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenVpcIpamServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenVpcIpamServiceResponseBody> body_ {};
  };
