...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getIpamPoolIds() const { DARABONBA_PTR_GET_CONST(ipamPoolIds_, vector<string>) };
    inline vector<string> getIpamPoolIds() { DARABONBA_PTR_GET(ipamPoolIds_, vector<string>) };
    ...
    inline const vector<ListIpamPoolsRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<ListIpamPoolsRequest::Tags>) };
    inline vector<ListIpamPoolsRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<ListIpamPoolsRequest::Tags>) };
    inline ListIpamPoolsRequest& setTags(const vector<ListIpamPoolsRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline ListIpamPoolsRequest& setTags(vector<ListIpamPoolsRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };


  protected:
    shared_ptr<string> ipVersion_ {};
    // The IDs of IPAM pools. Valid values of N: 1 to 100. A maximum of 100 IPAM pools can be queried at a time.
    shared_ptr<vector<string>> ipamPoolIds_ {};
    ...
    // The tag information.
    shared_ptr<vector<ListIpamPoolsRequest::Tags>> tags_ {};
  };
