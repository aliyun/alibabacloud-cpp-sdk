...
#ifndef ALIBABACLOUD_MODELS_LISTIPAMPOOLALLOCATIONSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTIPAMPOOLALLOCATIONSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListIpamPoolAllocationsRequest& obj) { 
      DARABONBA_PTR_TO_JSON(Cidr, cidr_);
      DARABONBA_PTR_TO_JSON(IpamPoolAllocationIds, ipamPoolAllocationIds_);
    ...
    friend void from_json(const Darabonba::Json& j, ListIpamPoolAllocationsRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(Cidr, cidr_);
      DARABONBA_PTR_FROM_JSON(IpamPoolAllocationIds, ipamPoolAllocationIds_);
    ...
    ListIpamPoolAllocationsRequest() = default ;
    ListIpamPoolAllocationsRequest(const ListIpamPoolAllocationsRequest &) = default ;
    ListIpamPoolAllocationsRequest(ListIpamPoolAllocationsRequest &&) = default ;
    ListIpamPoolAllocationsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIpamPoolAllocationsRequest() = default ;
    ListIpamPoolAllocationsRequest& operator=(const ListIpamPoolAllocationsRequest &) = default ;
    ListIpamPoolAllocationsRequest& operator=(ListIpamPoolAllocationsRequest &&) = default ;
