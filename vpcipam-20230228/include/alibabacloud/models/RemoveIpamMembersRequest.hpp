...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RemoveIpamMembersRequestMembers> & members() const { DARABONBA_PTR_GET_CONST(members_, vector<RemoveIpamMembersRequestMembers>) };
    inline vector<RemoveIpamMembersRequestMembers> members() { DARABONBA_PTR_GET(members_, vector<RemoveIpamMembersRequestMembers>) };
    inline RemoveIpamMembersRequest& setMembers(const vector<RemoveIpamMembersRequestMembers> & members) { DARABONBA_PTR_SET_VALUE(members_, members) };
    inline RemoveIpamMembersRequest& setMembers(vector<RemoveIpamMembersRequestMembers> && members) { DARABONBA_PTR_SET_RVALUE(members_, members) };
  ...
  protected:
    ...
    std::shared_ptr<vector<RemoveIpamMembersRequestMembers>> members_ = nullptr;
