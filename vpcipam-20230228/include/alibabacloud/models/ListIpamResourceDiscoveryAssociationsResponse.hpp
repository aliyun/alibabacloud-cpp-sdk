...
namespace Models
{
  ...
  public:
    ...
    inline const ListIpamResourceDiscoveryAssociationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIpamResourceDiscoveryAssociationsResponseBody) };
    inline ListIpamResourceDiscoveryAssociationsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIpamResourceDiscoveryAssociationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIpamResourceDiscoveryAssociationsResponseBody> body_ {};
  };
