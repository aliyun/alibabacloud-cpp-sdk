...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveIpamMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveIpamMembersResponseBody) };
    inline RemoveIpamMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveIpamMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveIpamMembersResponseBody> body_ {};
  };
