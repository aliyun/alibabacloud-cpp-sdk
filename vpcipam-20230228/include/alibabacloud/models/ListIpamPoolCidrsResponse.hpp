...
namespace Models
{
  ...
  public:
    ...
    inline const ListIpamPoolCidrsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIpamPoolCidrsResponseBody) };
    inline ListIpamPoolCidrsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIpamPoolCidrsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIpamPoolCidrsResponseBody> body_ {};
  };
