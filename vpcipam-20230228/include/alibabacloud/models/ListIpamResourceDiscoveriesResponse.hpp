...
namespace Models
{
  ...
  public:
    ...
    inline const ListIpamResourceDiscoveriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIpamResourceDiscoveriesResponseBody) };
    inline ListIpamResourceDiscoveriesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIpamResourceDiscoveriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIpamResourceDiscoveriesResponseBody> body_ {};
  };
