...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cidr_ == nullptr
        && this->clientToken_ == nullptr && this->dryRun_ == nullptr && this->ipamPoolId_ == nullptr && this->netmaskLength_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline int32_t getNetmaskLength() const { DARABONBA_PTR_GET_DEFAULT(netmaskLength_, 0) };
