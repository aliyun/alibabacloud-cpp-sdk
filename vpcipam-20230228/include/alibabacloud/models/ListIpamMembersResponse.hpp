...
namespace Models
{
  ...
  public:
    ...
    inline const ListIpamMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIpamMembersResponseBody) };
    inline ListIpamMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIpamMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIpamMembersResponseBody> body_ {};
  };
