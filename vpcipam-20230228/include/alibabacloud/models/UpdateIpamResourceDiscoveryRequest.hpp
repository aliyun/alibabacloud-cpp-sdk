...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addOperatingRegion_ == nullptr
        && this->clientToken_ == nullptr && this->dryRun_ == nullptr && this->ipamResourceDiscoveryDescription_ == nullptr && this->ipamResourceDiscoveryId_ == nullptr && this->ipamResourceDiscoveryName_ == nullptr
    ...
    inline const vector<string> & getAddOperatingRegion() const { DARABONBA_PTR_GET_CONST(addOperatingRegion_, vector<string>) };
    inline vector<string> getAddOperatingRegion() { DARABONBA_PTR_GET(addOperatingRegion_, vector<string>) };
    ...
    inline const vector<string> & getRemoveOperatingRegion() const { DARABONBA_PTR_GET_CONST(removeOperatingRegion_, vector<string>) };
    inline vector<string> getRemoveOperatingRegion() { DARABONBA_PTR_GET(removeOperatingRegion_, vector<string>) };
