...
namespace Models
{
  ...
  public:
    ...
    inline const CreateIpamResourceDiscoveryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateIpamResourceDiscoveryResponseBody) };
    inline CreateIpamResourceDiscoveryResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateIpamResourceDiscoveryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateIpamResourceDiscoveryResponseBody> body_ {};
  };
