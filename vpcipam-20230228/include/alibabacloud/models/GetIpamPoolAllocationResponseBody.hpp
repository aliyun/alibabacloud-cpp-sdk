...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->cidr_ != nullptr
        ...
        && this->regionId_ != nullptr && this->requestId_ != nullptr && this->resourceId_ != nullptr && this->resourceOwnerId_ != nullptr && this->resourceRegionId_ != nullptr
        && this->resourceType_ != nullptr && this->sourceCidr_ != nullptr && this->status_ != nullptr; };
