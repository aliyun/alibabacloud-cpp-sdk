...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aclId_ == nullptr
        && this->aclStatus_ == nullptr && this->aclType_ == nullptr && this->backendServerPort_ == nullptr && this->bandwidth_ == nullptr && this->connectionDrain_ == nullptr
        && this->connectionDrainTimeout_ == nullptr && this->description_ == nullptr && this->establishedTimeout_ == nullptr && this->healthCheckConnectPort_ == nullptr && this->healthCheckConnectTimeout_ == nullptr
        && this->healthCheckDomain_ == nullptr && this->healthCheckHttpCode_ == nullptr && this->healthCheckSwitch_ == nullptr && this->healthCheckType_ == nullptr && this->healthCheckURI_ == nullptr
        && this->healthyThreshold_ == nullptr && this->listenerPort_ == nullptr && this->loadBalancerId_ == nullptr && this->masterSlaveServerGroupId_ == nullptr && this->ownerAccount_ == nullptr
        && this->ownerId_ == nullptr && this->persistenceTimeout_ == nullptr && this->proxyProtocolV2Enabled_ == nullptr && this->regionId_ == nullptr && this->resourceOwnerAccount_ == nullptr
        && this->resourceOwnerId_ == nullptr && this->scheduler_ == nullptr && this->tag_ == nullptr && this->unhealthyThreshold_ == nullptr && this->VServerGroupId_ == nullptr
        && this->healthCheckInterval_ == nullptr; };
    ...
    inline const vector<CreateLoadBalancerTCPListenerRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateLoadBalancerTCPListenerRequest::Tag>) };
    inline vector<CreateLoadBalancerTCPListenerRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateLoadBalancerTCPListenerRequest::Tag>) };
    inline CreateLoadBalancerTCPListenerRequest& setTag(const vector<CreateLoadBalancerTCPListenerRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateLoadBalancerTCPListenerRequest& setTag(vector<CreateLoadBalancerTCPListenerRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The tags.
    shared_ptr<vector<CreateLoadBalancerTCPListenerRequest::Tag>> tag_ {};
