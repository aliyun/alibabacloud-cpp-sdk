...
namespace Models
{
  ...
  public:
    ...
    inline const SetRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetRuleResponseBody) };
    inline SetRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, SetRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetRuleResponseBody> body_ {};
  };
