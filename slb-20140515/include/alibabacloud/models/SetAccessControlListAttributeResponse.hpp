...
namespace Models
{
  ...
  public:
    ...
    inline const SetAccessControlListAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetAccessControlListAttributeResponseBody) };
    inline SetAccessControlListAttributeResponseBody body() { DARABONBA_PTR_GET(body_, SetAccessControlListAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetAccessControlListAttributeResponseBody> body_ = nullptr;
  };
