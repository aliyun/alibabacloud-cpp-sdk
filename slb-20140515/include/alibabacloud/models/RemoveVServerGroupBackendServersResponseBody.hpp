...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveVServerGroupBackendServersResponseBody::BackendServers & getBackendServers() const { DARABONBA_PTR_GET_CONST(backendServers_, RemoveVServerGroupBackendServersResponseBody::BackendServers) };
    inline RemoveVServerGroupBackendServersResponseBody::BackendServers getBackendServers() { DARABONBA_PTR_GET(backendServers_, RemoveVServerGroupBackendServersResponseBody::BackendServers) };
    inline RemoveVServerGroupBackendServersResponseBody& setBackendServers(const RemoveVServerGroupBackendServersResponseBody::BackendServers & backendServers) { DARABONBA_PTR_SET_VALUE(backendServers_, backendServers) };
    inline RemoveVServerGroupBackendServersResponseBody& setBackendServers(RemoveVServerGroupBackendServersResponseBody::BackendServers && backendServers) { DARABONBA_PTR_SET_RVALUE(backendServers_, backendServers) };
  ...
  protected:
    shared_ptr<RemoveVServerGroupBackendServersResponseBody::BackendServers> backendServers_ {};
    // The request ID.
