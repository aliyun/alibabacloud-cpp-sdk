...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aclId_ == nullptr
        && this->aclStatus_ == nullptr && this->aclType_ == nullptr && this->bandwidth_ == nullptr && this->connectionDrain_ == nullptr && this->connectionDrainTimeout_ == nullptr
        && this->description_ == nullptr && this->dryRun_ == nullptr && this->establishedTimeout_ == nullptr && this->healthCheckConnectPort_ == nullptr && this->healthCheckConnectTimeout_ == nullptr
        && this->healthCheckDomain_ == nullptr && this->healthCheckHttpCode_ == nullptr && this->healthCheckInterval_ == nullptr && this->healthCheckSwitch_ == nullptr && this->healthCheckType_ == nullptr
        && this->healthCheckURI_ == nullptr && this->healthyThreshold_ == nullptr && this->listenerPort_ == nullptr && this->loadBalancerId_ == nullptr && this->masterSlaveServerGroup_ == nullptr
        && this->masterSlaveServerGroupId_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->persistenceTimeout_ == nullptr && this->proxyProtocolV2Enabled_ == nullptr
        && this->regionId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->scheduler_ == nullptr && this->synProxy_ == nullptr
        && this->unhealthyThreshold_ == nullptr && this->VServerGroup_ == nullptr && this->VServerGroupId_ == nullptr; };
    ...
    inline SetLoadBalancerTCPListenerAttributeRequest& setDryRun(bool dryRun) { DARABONBA_PTR_SET_VALUE(dryRun_, dryRun) };
    ...
    inline string getMasterSlaveServerGroup() const { DARABONBA_PTR_GET_DEFAULT(masterSlaveServerGroup_, "") };
  ...
  protected:
    ...
    shared_ptr<string> masterSlaveServerGroup_ {};
