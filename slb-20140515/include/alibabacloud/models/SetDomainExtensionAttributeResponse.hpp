...
namespace Models
{
  ...
  public:
    ...
    inline const SetDomainExtensionAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetDomainExtensionAttributeResponseBody) };
    inline SetDomainExtensionAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, SetDomainExtensionAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetDomainExtensionAttributeResponseBody> body_ {};
  };
