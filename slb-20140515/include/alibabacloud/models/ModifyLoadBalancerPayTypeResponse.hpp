...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLoadBalancerPayTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLoadBalancerPayTypeResponseBody) };
    inline ModifyLoadBalancerPayTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLoadBalancerPayTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLoadBalancerPayTypeResponseBody> body_ {};
  };
