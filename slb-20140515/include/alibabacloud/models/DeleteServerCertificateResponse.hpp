...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteServerCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteServerCertificateResponseBody) };
    inline DeleteServerCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteServerCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteServerCertificateResponseBody> body_ {};
  };
