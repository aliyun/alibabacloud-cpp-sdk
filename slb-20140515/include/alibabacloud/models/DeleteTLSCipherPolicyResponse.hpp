...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTLSCipherPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTLSCipherPolicyResponseBody) };
    inline DeleteTLSCipherPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTLSCipherPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTLSCipherPolicyResponseBody> body_ {};
  };
