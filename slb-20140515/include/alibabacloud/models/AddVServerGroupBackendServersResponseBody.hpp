...
namespace Models
{
  ...
  public:
    ...
    inline const AddVServerGroupBackendServersResponseBodyBackendServers & backendServers() const { DARABONBA_PTR_GET_CONST(backendServers_, AddVServerGroupBackendServersResponseBodyBackendServers) };
    inline AddVServerGroupBackendServersResponseBodyBackendServers backendServers() { DARABONBA_PTR_GET(backendServers_, AddVServerGroupBackendServersResponseBodyBackendServers) };
    inline AddVServerGroupBackendServersResponseBody& setBackendServers(const AddVServerGroupBackendServersResponseBodyBackendServers & backendServers) { DARABONBA_PTR_SET_VALUE(backendServers_, backendServers) };
    inline AddVServerGroupBackendServersResponseBody& setBackendServers(AddVServerGroupBackendServersResponseBodyBackendServers && backendServers) { DARABONBA_PTR_SET_RVALUE(backendServers_, backendServers) };
  ...
  protected:
    // The backend servers.
    std::shared_ptr<AddVServerGroupBackendServersResponseBodyBackendServers> backendServers_ = nullptr;
    // The request ID.
