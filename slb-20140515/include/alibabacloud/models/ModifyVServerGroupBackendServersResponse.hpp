...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVServerGroupBackendServersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyVServerGroupBackendServersResponseBody) };
    inline ModifyVServerGroupBackendServersResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyVServerGroupBackendServersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyVServerGroupBackendServersResponseBody> body_ {};
  };
