...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVServerGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVServerGroupResponseBody) };
    inline CreateVServerGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVServerGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVServerGroupResponseBody> body_ {};
  };
