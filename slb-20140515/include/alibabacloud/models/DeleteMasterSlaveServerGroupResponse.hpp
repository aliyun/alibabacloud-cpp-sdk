...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMasterSlaveServerGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMasterSlaveServerGroupResponseBody) };
    inline DeleteMasterSlaveServerGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMasterSlaveServerGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMasterSlaveServerGroupResponseBody> body_ {};
  };
