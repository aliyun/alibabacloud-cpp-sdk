...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backendServers_ == nullptr
        && this->requestId_ == nullptr && this->VServerGroupId_ == nullptr && this->VServerGroupName_ == nullptr; };
    ...
    inline const SetVServerGroupAttributeResponseBody::BackendServers & getBackendServers() const { DARABONBA_PTR_GET_CONST(backendServers_, SetVServerGroupAttributeResponseBody::BackendServers) };
    inline SetVServerGroupAttributeResponseBody::BackendServers getBackendServers() { DARABONBA_PTR_GET(backendServers_, SetVServerGroupAttributeResponseBody::BackendServers) };
    inline SetVServerGroupAttributeResponseBody& setBackendServers(const SetVServerGroupAttributeResponseBody::BackendServers & backendServers) { DARABONBA_PTR_SET_VALUE(backendServers_, backendServers) };
    inline SetVServerGroupAttributeResponseBody& setBackendServers(SetVServerGroupAttributeResponseBody::BackendServers && backendServers) { DARABONBA_PTR_SET_RVALUE(backendServers_, backendServers) };
  ...
  protected:
    shared_ptr<SetVServerGroupAttributeResponseBody::BackendServers> backendServers_ {};
    // The request ID.
