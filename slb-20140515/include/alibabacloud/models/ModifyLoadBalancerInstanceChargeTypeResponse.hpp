...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLoadBalancerInstanceChargeTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLoadBalancerInstanceChargeTypeResponseBody) };
    inline ModifyLoadBalancerInstanceChargeTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLoadBalancerInstanceChargeTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLoadBalancerInstanceChargeTypeResponseBody> body_ {};
  };
