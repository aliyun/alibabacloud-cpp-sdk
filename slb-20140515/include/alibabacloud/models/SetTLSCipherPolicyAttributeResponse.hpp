...
namespace Models
{
  ...
  public:
    ...
    inline const SetTLSCipherPolicyAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetTLSCipherPolicyAttributeResponseBody) };
    inline SetTLSCipherPolicyAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, SetTLSCipherPolicyAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetTLSCipherPolicyAttributeResponseBody> body_ {};
  };
