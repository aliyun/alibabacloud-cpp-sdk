...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDomainExtensionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDomainExtensionResponseBody) };
    inline DeleteDomainExtensionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDomainExtensionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDomainExtensionResponseBody> body_ {};
  };
