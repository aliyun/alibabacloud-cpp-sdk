...
namespace Models
{
  ...
  public:
    ...
    inline AddTagsRequest& setLoadBalancerId(string loadBalancerId) { DARABONBA_PTR_SET_VALUE(loadBalancerId_, loadBalancerId) };
    ...
    inline AddTagsRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline AddTagsRequest& setTags(string tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
