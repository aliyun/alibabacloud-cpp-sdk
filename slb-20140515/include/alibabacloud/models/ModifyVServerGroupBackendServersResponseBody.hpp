...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVServerGroupBackendServersResponseBody::BackendServers & getBackendServers() const { DARABONBA_PTR_GET_CONST(backendServers_, ModifyVServerGroupBackendServersResponseBody::BackendServers) };
    inline ModifyVServerGroupBackendServersResponseBody::BackendServers getBackendServers() { DARABONBA_PTR_GET(backendServers_, ModifyVServerGroupBackendServersResponseBody::BackendServers) };
    inline ModifyVServerGroupBackendServersResponseBody& setBackendServers(const ModifyVServerGroupBackendServersResponseBody::BackendServers & backendServers) { DARABONBA_PTR_SET_VALUE(backendServers_, backendServers) };
    inline ModifyVServerGroupBackendServersResponseBody& setBackendServers(ModifyVServerGroupBackendServersResponseBody::BackendServers && backendServers) { DARABONBA_PTR_SET_RVALUE(backendServers_, backendServers) };
  ...
  protected:
    shared_ptr<ModifyVServerGroupBackendServersResponseBody::BackendServers> backendServers_ {};
    // The request ID.
