...
#ifndef ALIBABACLOUD_MODELS_STARTLOADBALANCERLISTENERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_STARTLOADBALANCERLISTENERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const StartLoadBalancerListenerRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, StartLoadBalancerListenerRequest& obj) { 
    ...
    StartLoadBalancerListenerRequest() = default ;
    StartLoadBalancerListenerRequest(const StartLoadBalancerListenerRequest &) = default ;
    StartLoadBalancerListenerRequest(StartLoadBalancerListenerRequest &&) = default ;
    StartLoadBalancerListenerRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~StartLoadBalancerListenerRequest() = default ;
    StartLoadBalancerListenerRequest& operator=(const StartLoadBalancerListenerRequest &) = default ;
    StartLoadBalancerListenerRequest& operator=(StartLoadBalancerListenerRequest &&) = default ;
    ...
    inline StartLoadBalancerListenerRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline StartLoadBalancerListenerRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline StartLoadBalancerListenerRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline StartLoadBalancerListenerRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline StartLoadBalancerListenerRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
