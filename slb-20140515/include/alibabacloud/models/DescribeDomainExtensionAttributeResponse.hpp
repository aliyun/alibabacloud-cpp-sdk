...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainExtensionAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainExtensionAttributeResponseBody) };
    inline DescribeDomainExtensionAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainExtensionAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainExtensionAttributeResponseBody> body_ {};
  };
