...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMasterSlaveServerGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMasterSlaveServerGroupResponseBody) };
    inline CreateMasterSlaveServerGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMasterSlaveServerGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMasterSlaveServerGroupResponseBody> body_ {};
  };
