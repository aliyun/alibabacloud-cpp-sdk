...
namespace Models
{
  ...
  public:
    ...
    inline const AddVServerGroupBackendServersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddVServerGroupBackendServersResponseBody) };
    inline AddVServerGroupBackendServersResponseBody getBody() { DARABONBA_PTR_GET(body_, AddVServerGroupBackendServersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddVServerGroupBackendServersResponseBody> body_ {};
  };
