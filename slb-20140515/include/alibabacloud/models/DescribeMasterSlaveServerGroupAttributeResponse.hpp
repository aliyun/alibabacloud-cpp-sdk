...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMasterSlaveServerGroupAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMasterSlaveServerGroupAttributeResponseBody) };
    inline DescribeMasterSlaveServerGroupAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMasterSlaveServerGroupAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMasterSlaveServerGroupAttributeResponseBody> body_ {};
  };
