...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDomainExtensionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDomainExtensionResponseBody) };
    inline CreateDomainExtensionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDomainExtensionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDomainExtensionResponseBody> body_ {};
  };
