...
#ifndef ALIBABACLOUD_MODELS_DELETEACCESSLOGSDOWNLOADATTRIBUTEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETEACCESSLOGSDOWNLOADATTRIBUTEREQUEST_HPP_
...
namespace Models
{
  class DeleteAccessLogsDownloadAttributeRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DeleteAccessLogsDownloadAttributeRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeleteAccessLogsDownloadAttributeRequest& obj) { 
    ...
    DeleteAccessLogsDownloadAttributeRequest() = default ;
    DeleteAccessLogsDownloadAttributeRequest(const DeleteAccessLogsDownloadAttributeRequest &) = default ;
    DeleteAccessLogsDownloadAttributeRequest(DeleteAccessLogsDownloadAttributeRequest &&) = default ;
    DeleteAccessLogsDownloadAttributeRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteAccessLogsDownloadAttributeRequest() = default ;
    DeleteAccessLogsDownloadAttributeRequest& operator=(const DeleteAccessLogsDownloadAttributeRequest &) = default ;
    DeleteAccessLogsDownloadAttributeRequest& operator=(DeleteAccessLogsDownloadAttributeRequest &&) = default ;
