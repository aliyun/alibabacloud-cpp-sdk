...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->CACertificate_ == nullptr
        && this->CACertificateName_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr
    ...
    inline const vector<UploadCACertificateRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<UploadCACertificateRequest::Tag>) };
    inline vector<UploadCACertificateRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<UploadCACertificateRequest::Tag>) };
    inline UploadCACertificateRequest& setTag(const vector<UploadCACertificateRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline UploadCACertificateRequest& setTag(vector<UploadCACertificateRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The tags.
    shared_ptr<vector<UploadCACertificateRequest::Tag>> tag_ {};
  };
