...
namespace Models
{
  ...
  public:
    ...
    inline const SetLoadBalancerModificationProtectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetLoadBalancerModificationProtectionResponseBody) };
    inline SetLoadBalancerModificationProtectionResponseBody getBody() { DARABONBA_PTR_GET(body_, SetLoadBalancerModificationProtectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetLoadBalancerModificationProtectionResponseBody> body_ {};
  };
