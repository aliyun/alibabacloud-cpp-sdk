...
namespace Models
{
  ...
  public:
    ...
    inline const ListTLSCipherPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTLSCipherPoliciesResponseBody) };
    inline ListTLSCipherPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTLSCipherPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTLSCipherPoliciesResponseBody> body_ {};
  };
