...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAccessLogsDownloadAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAccessLogsDownloadAttributeResponseBody) };
    inline DeleteAccessLogsDownloadAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAccessLogsDownloadAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAccessLogsDownloadAttributeResponseBody> body_ {};
  };
