...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->tagSets_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const DescribeTagsResponseBodyTagSets & tagSets() const { DARABONBA_PTR_GET_CONST(tagSets_, DescribeTagsResponseBodyTagSets) };
    inline DescribeTagsResponseBodyTagSets tagSets() { DARABONBA_PTR_GET(tagSets_, DescribeTagsResponseBodyTagSets) };
    inline DescribeTagsResponseBody& setTagSets(const DescribeTagsResponseBodyTagSets & tagSets) { DARABONBA_PTR_SET_VALUE(tagSets_, tagSets) };
    inline DescribeTagsResponseBody& setTagSets(DescribeTagsResponseBodyTagSets && tagSets) { DARABONBA_PTR_SET_RVALUE(tagSets_, tagSets) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeTagsResponseBodyTagSets> tagSets_ = nullptr;
