...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCACertificatesRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeCACertificatesRequestTag>) };
    inline vector<DescribeCACertificatesRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<DescribeCACertificatesRequestTag>) };
    inline DescribeCACertificatesRequest& setTag(const vector<DescribeCACertificatesRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeCACertificatesRequest& setTag(vector<DescribeCACertificatesRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeCACertificatesRequestTag>> tag_ = nullptr;
  };
