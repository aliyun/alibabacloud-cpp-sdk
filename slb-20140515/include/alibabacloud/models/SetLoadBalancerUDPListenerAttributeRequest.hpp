...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aclId_ == nullptr
        && this->aclStatus_ == nullptr && this->aclType_ == nullptr && this->bandwidth_ == nullptr && this->description_ == nullptr && this->dryRun_ == nullptr
        && this->healthCheckConnectPort_ == nullptr && this->healthCheckConnectTimeout_ == nullptr && this->healthCheckInterval_ == nullptr && this->healthCheckSwitch_ == nullptr && this->healthyThreshold_ == nullptr
        && this->listenerPort_ == nullptr && this->loadBalancerId_ == nullptr && this->masterSlaveServerGroup_ == nullptr && this->masterSlaveServerGroupId_ == nullptr && this->ownerAccount_ == nullptr
        && this->ownerId_ == nullptr && this->proxyProtocolV2Enabled_ == nullptr && this->regionId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr
        && this->scheduler_ == nullptr && this->unhealthyThreshold_ == nullptr && this->VServerGroup_ == nullptr && this->VServerGroupId_ == nullptr && this->healthCheckExp_ == nullptr
        && this->healthCheckReq_ == nullptr; };
    ...
    inline SetLoadBalancerUDPListenerAttributeRequest& setDryRun(bool dryRun) { DARABONBA_PTR_SET_VALUE(dryRun_, dryRun) };
