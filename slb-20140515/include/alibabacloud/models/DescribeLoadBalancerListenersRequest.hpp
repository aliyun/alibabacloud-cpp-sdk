...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->listenerPort_ == nullptr && this->listenerProtocol_ == nullptr && this->loadBalancerId_ == nullptr && this->maxResults_ == nullptr && this->nextToken_ == nullptr
    ...
    inline const vector<DescribeLoadBalancerListenersRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeLoadBalancerListenersRequest::Tag>) };
    inline vector<DescribeLoadBalancerListenersRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeLoadBalancerListenersRequest::Tag>) };
    inline DescribeLoadBalancerListenersRequest& setTag(const vector<DescribeLoadBalancerListenersRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeLoadBalancerListenersRequest& setTag(vector<DescribeLoadBalancerListenersRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The tags.
    shared_ptr<vector<DescribeLoadBalancerListenersRequest::Tag>> tag_ {};
  };
