...
namespace Models
{
  ...
  public:
    ...
    inline const SetServerCertificateNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetServerCertificateNameResponseBody) };
    inline SetServerCertificateNameResponseBody getBody() { DARABONBA_PTR_GET(body_, SetServerCertificateNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetServerCertificateNameResponseBody> body_ {};
  };
