...
namespace Models
{
  ...
  public:
    ...
    inline const SetListenerAccessControlStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetListenerAccessControlStatusResponseBody) };
    inline SetListenerAccessControlStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, SetListenerAccessControlStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetListenerAccessControlStatusResponseBody> body_ {};
  };
