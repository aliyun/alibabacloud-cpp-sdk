...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cookie_ == nullptr
        && this->cookieTimeout_ == nullptr && this->dryRun_ == nullptr && this->healthCheck_ == nullptr && this->healthCheckConnectPort_ == nullptr && this->healthCheckDomain_ == nullptr
        ...
        && this->listenerSync_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->regionId_ == nullptr && this->resourceOwnerAccount_ == nullptr
        && this->resourceOwnerId_ == nullptr && this->ruleId_ == nullptr && this->ruleName_ == nullptr && this->scheduler_ == nullptr && this->stickySession_ == nullptr
        && this->stickySessionType_ == nullptr && this->unhealthyThreshold_ == nullptr && this->VServerGroupId_ == nullptr; };
    ...
    inline SetRuleRequest& setDryRun(bool dryRun) { DARABONBA_PTR_SET_VALUE(dryRun_, dryRun) };
