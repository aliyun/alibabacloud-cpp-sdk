...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->includeListener_ == nullptr
        && this->maxItems_ == nullptr && this->name_ == nullptr && this->nextToken_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr
        && this->regionId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->TLSCipherPolicyId_ == nullptr; };
    ...
    inline string getTLSCipherPolicyId() const { DARABONBA_PTR_GET_DEFAULT(TLSCipherPolicyId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> TLSCipherPolicyId_ {};
  };
