...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->loadBalancerId_ == nullptr
        && this->modificationProtectionReason_ == nullptr && this->modificationProtectionStatus_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->regionId_ == nullptr
