...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLoadBalancerUDPListenerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLoadBalancerUDPListenerResponseBody) };
    inline CreateLoadBalancerUDPListenerResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLoadBalancerUDPListenerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLoadBalancerUDPListenerResponseBody> body_ {};
  };
