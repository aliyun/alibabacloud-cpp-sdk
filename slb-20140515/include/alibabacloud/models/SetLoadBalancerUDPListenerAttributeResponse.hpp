...
namespace Models
{
  ...
  public:
    ...
    inline const SetLoadBalancerUDPListenerAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetLoadBalancerUDPListenerAttributeResponseBody) };
    inline SetLoadBalancerUDPListenerAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, SetLoadBalancerUDPListenerAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetLoadBalancerUDPListenerAttributeResponseBody> body_ {};
  };
