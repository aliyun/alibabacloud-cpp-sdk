...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aclId_ == nullptr
        && this->aclStatus_ == nullptr && this->aclType_ == nullptr && this->backendServerPort_ == nullptr && this->bandwidth_ == nullptr && this->description_ == nullptr
        && this->healthCheckConnectPort_ == nullptr && this->healthCheckConnectTimeout_ == nullptr && this->healthCheckSwitch_ == nullptr && this->healthyThreshold_ == nullptr && this->listenerPort_ == nullptr
        && this->loadBalancerId_ == nullptr && this->masterSlaveServerGroupId_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->proxyProtocolV2Enabled_ == nullptr
        && this->regionId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->scheduler_ == nullptr && this->tag_ == nullptr
        && this->unhealthyThreshold_ == nullptr && this->VServerGroupId_ == nullptr && this->healthCheckExp_ == nullptr && this->healthCheckInterval_ == nullptr && this->healthCheckReq_ == nullptr; };
    ...
    inline string getHealthCheckSwitch() const { DARABONBA_PTR_GET_DEFAULT(healthCheckSwitch_, "") };
    ...
    inline const vector<CreateLoadBalancerUDPListenerRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateLoadBalancerUDPListenerRequest::Tag>) };
    inline vector<CreateLoadBalancerUDPListenerRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateLoadBalancerUDPListenerRequest::Tag>) };
    inline CreateLoadBalancerUDPListenerRequest& setTag(const vector<CreateLoadBalancerUDPListenerRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateLoadBalancerUDPListenerRequest& setTag(vector<CreateLoadBalancerUDPListenerRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // *   **on** (default): yes
    // *   **off**: no
    shared_ptr<string> healthCheckSwitch_ {};
    ...
    // The tags.
    shared_ptr<vector<CreateLoadBalancerUDPListenerRequest::Tag>> tag_ {};
