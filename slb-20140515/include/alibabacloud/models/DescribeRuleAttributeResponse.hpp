...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRuleAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRuleAttributeResponseBody) };
    inline DescribeRuleAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRuleAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRuleAttributeResponseBody> body_ {};
  };
