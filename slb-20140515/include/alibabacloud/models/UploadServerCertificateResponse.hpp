...
namespace Models
{
  ...
  public:
    ...
    inline const UploadServerCertificateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadServerCertificateResponseBody) };
    inline UploadServerCertificateResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadServerCertificateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadServerCertificateResponseBody> body_ {};
  };
