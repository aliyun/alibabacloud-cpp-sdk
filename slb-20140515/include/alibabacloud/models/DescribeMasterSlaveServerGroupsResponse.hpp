...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMasterSlaveServerGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMasterSlaveServerGroupsResponseBody) };
    inline DescribeMasterSlaveServerGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMasterSlaveServerGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMasterSlaveServerGroupsResponseBody> body_ {};
  };
