...
#ifndef ALIBABACLOUD_MODELS_ADDVSERVERGROUPBACKENDSERVERSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDVSERVERGROUPBACKENDSERVERSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddVServerGroupBackendServersRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddVServerGroupBackendServersRequest& obj) { 
    ...
    AddVServerGroupBackendServersRequest() = default ;
    AddVServerGroupBackendServersRequest(const AddVServerGroupBackendServersRequest &) = default ;
    AddVServerGroupBackendServersRequest(AddVServerGroupBackendServersRequest &&) = default ;
    AddVServerGroupBackendServersRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddVServerGroupBackendServersRequest() = default ;
    AddVServerGroupBackendServersRequest& operator=(const AddVServerGroupBackendServersRequest &) = default ;
    AddVServerGroupBackendServersRequest& operator=(AddVServerGroupBackendServersRequest &&) = default ;
    ...
    inline AddVServerGroupBackendServersRequest& setBackendServers(string backendServers) { DARABONBA_PTR_SET_VALUE(backendServers_, backendServers) };
    ...
    inline AddVServerGroupBackendServersRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline AddVServerGroupBackendServersRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline AddVServerGroupBackendServersRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline AddVServerGroupBackendServersRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline AddVServerGroupBackendServersRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline AddVServerGroupBackendServersRequest& setVServerGroupId(string VServerGroupId) { DARABONBA_PTR_SET_VALUE(VServerGroupId_, VServerGroupId) };
