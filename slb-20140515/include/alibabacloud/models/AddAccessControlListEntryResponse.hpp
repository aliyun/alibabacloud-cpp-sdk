...
namespace Models
{
  ...
  public:
    ...
    inline const AddAccessControlListEntryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddAccessControlListEntryResponseBody) };
    inline AddAccessControlListEntryResponseBody body() { DARABONBA_PTR_GET(body_, AddAccessControlListEntryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddAccessControlListEntryResponseBody> body_ = nullptr;
  };
