...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLoadBalancerInstanceSpecResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLoadBalancerInstanceSpecResponseBody) };
    inline ModifyLoadBalancerInstanceSpecResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLoadBalancerInstanceSpecResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLoadBalancerInstanceSpecResponseBody> body_ {};
  };
