...
namespace Models
{
  ...
  public:
    ...
    inline const GetLifecycleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetLifecycleResponseBody) };
    inline GetLifecycleResponseBody body() { DARABONBA_PTR_GET(body_, GetLifecycleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetLifecycleResponseBody> body_ = nullptr;
  };
