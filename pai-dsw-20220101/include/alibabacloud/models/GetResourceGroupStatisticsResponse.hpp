...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceGroupStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResourceGroupStatisticsResponseBody) };
    inline GetResourceGroupStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResourceGroupStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResourceGroupStatisticsResponseBody> body_ {};
  };
