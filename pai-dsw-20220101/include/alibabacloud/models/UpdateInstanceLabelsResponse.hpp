...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateInstanceLabelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateInstanceLabelsResponseBody) };
    inline UpdateInstanceLabelsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateInstanceLabelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateInstanceLabelsResponseBody> body_ {};
  };
