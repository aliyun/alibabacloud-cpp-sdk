...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDiagnosisResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateDiagnosisResponseBody) };
    inline CreateDiagnosisResponseBody body() { DARABONBA_PTR_GET(body_, CreateDiagnosisResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDiagnosisResponseBody> body_ = nullptr;
  };
