...
#ifndef ALIBABACLOUD_MODELS_CREATEINSTANCEREQUESTDATASETS_HPP_
#define ALIBABACLOUD_MODELS_CREATEINSTANCEREQUESTDATASETS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateInstanceRequestDatasets& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateInstanceRequestDatasets& obj) { 
    ...
    CreateInstanceRequestDatasets() = default ;
    CreateInstanceRequestDatasets(const CreateInstanceRequestDatasets &) = default ;
    CreateInstanceRequestDatasets(CreateInstanceRequestDatasets &&) = default ;
    CreateInstanceRequestDatasets(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateInstanceRequestDatasets() = default ;
    CreateInstanceRequestDatasets& operator=(const CreateInstanceRequestDatasets &) = default ;
    CreateInstanceRequestDatasets& operator=(CreateInstanceRequestDatasets &&) = default ;
    ...
    inline CreateInstanceRequestDatasets& setDatasetId(string datasetId) { DARABONBA_PTR_SET_VALUE(datasetId_, datasetId) };
    ...
    inline CreateInstanceRequestDatasets& setDatasetVersion(string datasetVersion) { DARABONBA_PTR_SET_VALUE(datasetVersion_, datasetVersion) };
    ...
    inline CreateInstanceRequestDatasets& setDynamic(bool dynamic) { DARABONBA_PTR_SET_VALUE(dynamic_, dynamic) };
    ...
    inline CreateInstanceRequestDatasets& setMountAccess(string mountAccess) { DARABONBA_PTR_SET_VALUE(mountAccess_, mountAccess) };
    ...
    inline CreateInstanceRequestDatasets& setMountPath(string mountPath) { DARABONBA_PTR_SET_VALUE(mountPath_, mountPath) };
    ...
    inline CreateInstanceRequestDatasets& setOptionType(string optionType) { DARABONBA_PTR_SET_VALUE(optionType_, optionType) };
    ...
    inline CreateInstanceRequestDatasets& setOptions(string options) { DARABONBA_PTR_SET_VALUE(options_, options) };
    ...
    inline CreateInstanceRequestDatasets& setUri(string uri) { DARABONBA_PTR_SET_VALUE(uri_, uri) };
