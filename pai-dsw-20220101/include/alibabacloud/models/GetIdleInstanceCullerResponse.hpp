...
namespace Models
{
  ...
  public:
    ...
    inline const GetIdleInstanceCullerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetIdleInstanceCullerResponseBody) };
    inline GetIdleInstanceCullerResponseBody getBody() { DARABONBA_PTR_GET(body_, GetIdleInstanceCullerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetIdleInstanceCullerResponseBody> body_ {};
  };
