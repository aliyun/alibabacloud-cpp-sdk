...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteIdleInstanceCullerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteIdleInstanceCullerResponseBody) };
    inline DeleteIdleInstanceCullerResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteIdleInstanceCullerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteIdleInstanceCullerResponseBody> body_ {};
  };
