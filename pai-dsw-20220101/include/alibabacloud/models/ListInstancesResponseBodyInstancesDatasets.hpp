...
#ifndef ALIBABACLOUD_MODELS_LISTINSTANCESRESPONSEBODYINSTANCESDATASETS_HPP_
#define ALIBABACLOUD_MODELS_LISTINSTANCESRESPONSEBODYINSTANCESDATASETS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListInstancesResponseBodyInstancesDatasets& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListInstancesResponseBodyInstancesDatasets& obj) { 
    ...
    ListInstancesResponseBodyInstancesDatasets() = default ;
    ListInstancesResponseBodyInstancesDatasets(const ListInstancesResponseBodyInstancesDatasets &) = default ;
    ListInstancesResponseBodyInstancesDatasets(ListInstancesResponseBodyInstancesDatasets &&) = default ;
    ListInstancesResponseBodyInstancesDatasets(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListInstancesResponseBodyInstancesDatasets() = default ;
    ListInstancesResponseBodyInstancesDatasets& operator=(const ListInstancesResponseBodyInstancesDatasets &) = default ;
    ListInstancesResponseBodyInstancesDatasets& operator=(ListInstancesResponseBodyInstancesDatasets &&) = default ;
    ...
    inline ListInstancesResponseBodyInstancesDatasets& setDatasetId(string datasetId) { DARABONBA_PTR_SET_VALUE(datasetId_, datasetId) };
    ...
    inline ListInstancesResponseBodyInstancesDatasets& setDatasetVersion(string datasetVersion) { DARABONBA_PTR_SET_VALUE(datasetVersion_, datasetVersion) };
    ...
    inline ListInstancesResponseBodyInstancesDatasets& setDynamic(bool dynamic) { DARABONBA_PTR_SET_VALUE(dynamic_, dynamic) };
    ...
    inline ListInstancesResponseBodyInstancesDatasets& setMountAccess(string mountAccess) { DARABONBA_PTR_SET_VALUE(mountAccess_, mountAccess) };
    ...
    inline ListInstancesResponseBodyInstancesDatasets& setMountPath(string mountPath) { DARABONBA_PTR_SET_VALUE(mountPath_, mountPath) };
    ...
    inline ListInstancesResponseBodyInstancesDatasets& setOptionType(string optionType) { DARABONBA_PTR_SET_VALUE(optionType_, optionType) };
    ...
    inline ListInstancesResponseBodyInstancesDatasets& setOptions(string options) { DARABONBA_PTR_SET_VALUE(options_, options) };
    ...
    inline ListInstancesResponseBodyInstancesDatasets& setUri(string uri) { DARABONBA_PTR_SET_VALUE(uri_, uri) };
