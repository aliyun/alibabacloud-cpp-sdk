...
namespace Models
{
  ...
  public:
    ...
    inline string getEgressRate() const { DARABONBA_PTR_GET_DEFAULT(egressRate_, "") };
    ...
    inline const vector<string> & getEgressWhitelists() const { DARABONBA_PTR_GET_CONST(egressWhitelists_, vector<string>) };
    inline vector<string> getEgressWhitelists() { DARABONBA_PTR_GET(egressWhitelists_, vector<string>) };
    ...
    inline string getIngressRate() const { DARABONBA_PTR_GET_DEFAULT(ingressRate_, "") };
    ...
    inline const vector<string> & getIngressWhitelists() const { DARABONBA_PTR_GET_CONST(ingressWhitelists_, vector<string>) };
    inline vector<string> getIngressWhitelists() { DARABONBA_PTR_GET(ingressWhitelists_, vector<string>) };
  ...
  protected:
    shared_ptr<string> egressRate_ {};
    shared_ptr<vector<string>> egressWhitelists_ {};
    shared_ptr<string> ingressRate_ {};
    shared_ptr<vector<string>> ingressWhitelists_ {};
  };
