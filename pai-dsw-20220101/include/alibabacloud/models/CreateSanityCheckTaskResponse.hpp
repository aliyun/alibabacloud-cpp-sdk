...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSanityCheckTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateSanityCheckTaskResponseBody) };
    inline CreateSanityCheckTaskResponseBody body() { DARABONBA_PTR_GET(body_, CreateSanityCheckTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateSanityCheckTaskResponseBody> body_ = nullptr;
  };
