...
namespace Models
{
  ...
  public:
    ...
    inline const CreateInstanceSnapshotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateInstanceSnapshotResponseBody) };
    inline CreateInstanceSnapshotResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateInstanceSnapshotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateInstanceSnapshotResponseBody> body_ {};
  };
