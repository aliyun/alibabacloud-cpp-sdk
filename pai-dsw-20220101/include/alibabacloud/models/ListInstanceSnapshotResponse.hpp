...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceSnapshotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceSnapshotResponseBody) };
    inline ListInstanceSnapshotResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstanceSnapshotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstanceSnapshotResponseBody> body_ {};
  };
