...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->reasonCode_ == nullptr
        && this->reasonMessage_ == nullptr && this->solutionMessage_ == nullptr; };
    ...
    inline string getSolutionMessage() const { DARABONBA_PTR_GET_DEFAULT(solutionMessage_, "") };
  ...
  protected:
    ...
    shared_ptr<string> solutionMessage_ {};
  };
