...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceMetricsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceMetricsResponseBody) };
    inline GetInstanceMetricsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceMetricsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceMetricsResponseBody> body_ {};
  };
