...
namespace Models
{
  ...
  public:
    ...
    inline const GetTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTokenResponseBody) };
    inline GetTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTokenResponseBody> body_ {};
  };
