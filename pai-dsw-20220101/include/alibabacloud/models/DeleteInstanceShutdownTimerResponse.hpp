...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInstanceShutdownTimerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteInstanceShutdownTimerResponseBody) };
    inline DeleteInstanceShutdownTimerResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteInstanceShutdownTimerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteInstanceShutdownTimerResponseBody> body_ {};
  };
