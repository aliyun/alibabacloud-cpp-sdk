...
namespace Models
{
  ...
  public:
    ...
    inline const ListSystemLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSystemLogsResponseBody) };
    inline ListSystemLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSystemLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSystemLogsResponseBody> body_ {};
  };
