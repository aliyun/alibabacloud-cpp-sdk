...
#ifndef ALIBABACLOUD_MODELS_GETINSTANCERESPONSEBODYIDLEINSTANCECULLER_HPP_
#define ALIBABACLOUD_MODELS_GETINSTANCERESPONSEBODYIDLEINSTANCECULLER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetInstanceResponseBodyIdleInstanceCuller& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetInstanceResponseBodyIdleInstanceCuller& obj) { 
    ...
    GetInstanceResponseBodyIdleInstanceCuller() = default ;
    GetInstanceResponseBodyIdleInstanceCuller(const GetInstanceResponseBodyIdleInstanceCuller &) = default ;
    GetInstanceResponseBodyIdleInstanceCuller(GetInstanceResponseBodyIdleInstanceCuller &&) = default ;
    GetInstanceResponseBodyIdleInstanceCuller(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetInstanceResponseBodyIdleInstanceCuller() = default ;
    GetInstanceResponseBodyIdleInstanceCuller& operator=(const GetInstanceResponseBodyIdleInstanceCuller &) = default ;
    GetInstanceResponseBodyIdleInstanceCuller& operator=(GetInstanceResponseBodyIdleInstanceCuller &&) = default ;
    ...
    inline GetInstanceResponseBodyIdleInstanceCuller& setCpuPercentThreshold(int32_t cpuPercentThreshold) { DARABONBA_PTR_SET_VALUE(cpuPercentThreshold_, cpuPercentThreshold) };
    ...
    inline GetInstanceResponseBodyIdleInstanceCuller& setGpuPercentThreshold(int32_t gpuPercentThreshold) { DARABONBA_PTR_SET_VALUE(gpuPercentThreshold_, gpuPercentThreshold) };
    ...
    inline GetInstanceResponseBodyIdleInstanceCuller& setIdleTimeInMinutes(int32_t idleTimeInMinutes) { DARABONBA_PTR_SET_VALUE(idleTimeInMinutes_, idleTimeInMinutes) };
    ...
    inline GetInstanceResponseBodyIdleInstanceCuller& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetInstanceResponseBodyIdleInstanceCuller& setMaxIdleTimeInMinutes(int32_t maxIdleTimeInMinutes) { DARABONBA_PTR_SET_VALUE(maxIdleTimeInMinutes_, maxIdleTimeInMinutes) };
