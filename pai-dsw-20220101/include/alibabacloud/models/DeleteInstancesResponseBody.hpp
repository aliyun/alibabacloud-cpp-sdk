...
namespace Models
{
  ...
  public:
    ...
    inline DeleteInstancesResponseBody& setAccessDeniedDetail(const Darabonba::Json & accessDeniedDetail) { DARABONBA_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DeleteInstancesResponseBody& setAccessDeniedDetail(Darabonba::Json && accessDeniedDetail) { DARABONBA_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline DeleteInstancesResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline DeleteInstancesResponseBody& setInstanceIds(const vector<string> & instanceIds) { DARABONBA_PTR_SET_VALUE(instanceIds_, instanceIds) };
    inline DeleteInstancesResponseBody& setInstanceIds(vector<string> && instanceIds) { DARABONBA_PTR_SET_RVALUE(instanceIds_, instanceIds) };
