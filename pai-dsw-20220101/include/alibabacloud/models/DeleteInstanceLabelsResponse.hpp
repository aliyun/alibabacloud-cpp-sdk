...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInstanceLabelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteInstanceLabelsResponseBody) };
    inline DeleteInstanceLabelsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteInstanceLabelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteInstanceLabelsResponseBody> body_ {};
  };
