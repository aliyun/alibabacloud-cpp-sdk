...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acceleratorType_ == nullptr
        ...
        && this->imageName_ == nullptr && this->instanceId_ == nullptr && this->instanceName_ == nullptr && this->labelsShrink_ == nullptr && this->maxCpu_ == nullptr
        ...
        && this->status_ == nullptr && this->tagShrink_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline ListInstancesShrinkRequest& setCreateTimeAfter(string createTimeAfter) { DARABONBA_PTR_SET_VALUE(createTimeAfter_, createTimeAfter) };
    ...
    inline ListInstancesShrinkRequest& setCreateTimeBefore(string createTimeBefore) { DARABONBA_PTR_SET_VALUE(createTimeBefore_, createTimeBefore) };
