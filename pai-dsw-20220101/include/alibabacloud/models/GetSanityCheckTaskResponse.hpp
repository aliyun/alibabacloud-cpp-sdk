...
namespace Models
{
  ...
  public:
    ...
    inline const GetSanityCheckTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSanityCheckTaskResponseBody) };
    inline GetSanityCheckTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSanityCheckTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSanityCheckTaskResponseBody> body_ {};
  };
