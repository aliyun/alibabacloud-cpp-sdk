...
namespace Models
{
  ...
  public:
    ...
    inline const EnableMultiAccountResourceCenterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableMultiAccountResourceCenterResponseBody) };
    inline EnableMultiAccountResourceCenterResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableMultiAccountResourceCenterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableMultiAccountResourceCenterResponseBody> body_ {};
  };
