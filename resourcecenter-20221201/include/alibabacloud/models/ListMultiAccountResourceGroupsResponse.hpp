...
namespace Models
{
  ...
  public:
    ...
    inline const ListMultiAccountResourceGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMultiAccountResourceGroupsResponseBody) };
    inline ListMultiAccountResourceGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMultiAccountResourceGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMultiAccountResourceGroupsResponseBody> body_ {};
  };
