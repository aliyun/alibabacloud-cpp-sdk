...
namespace Models
{
  ...
  public:
    ...
    inline const GetDeliveryChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDeliveryChannelResponseBody) };
    inline GetDeliveryChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDeliveryChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDeliveryChannelResponseBody> body_ {};
  };
