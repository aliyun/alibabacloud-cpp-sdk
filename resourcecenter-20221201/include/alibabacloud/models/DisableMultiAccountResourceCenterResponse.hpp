...
namespace Models
{
  ...
  public:
    ...
    inline const DisableMultiAccountResourceCenterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableMultiAccountResourceCenterResponseBody) };
    inline DisableMultiAccountResourceCenterResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableMultiAccountResourceCenterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableMultiAccountResourceCenterResponseBody> body_ {};
  };
