...
namespace Models
{
  ...
  public:
    ...
    inline const ListExampleQueriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExampleQueriesResponseBody) };
    inline ListExampleQueriesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExampleQueriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExampleQueriesResponseBody> body_ {};
  };
