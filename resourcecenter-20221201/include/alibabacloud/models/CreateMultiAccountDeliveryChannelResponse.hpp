...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMultiAccountDeliveryChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMultiAccountDeliveryChannelResponseBody) };
    inline CreateMultiAccountDeliveryChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMultiAccountDeliveryChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMultiAccountDeliveryChannelResponseBody> body_ {};
  };
