...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateDefaultFilterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AssociateDefaultFilterResponseBody) };
    inline AssociateDefaultFilterResponseBody getBody() { DARABONBA_PTR_GET(body_, AssociateDefaultFilterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AssociateDefaultFilterResponseBody> body_ {};
  };
