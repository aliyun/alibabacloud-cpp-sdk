...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceCountsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResourceCountsResponseBody) };
    inline GetResourceCountsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResourceCountsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResourceCountsResponseBody> body_ {};
  };
