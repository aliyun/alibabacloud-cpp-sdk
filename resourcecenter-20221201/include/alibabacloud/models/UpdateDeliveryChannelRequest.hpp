...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDeliveryChannelRequest::DeliveryChannelFilter & getDeliveryChannelFilter() const { DARABONBA_PTR_GET_CONST(deliveryChannelFilter_, UpdateDeliveryChannelRequest::DeliveryChannelFilter) };
    inline UpdateDeliveryChannelRequest::DeliveryChannelFilter getDeliveryChannelFilter() { DARABONBA_PTR_GET(deliveryChannelFilter_, UpdateDeliveryChannelRequest::DeliveryChannelFilter) };
    inline UpdateDeliveryChannelRequest& setDeliveryChannelFilter(const UpdateDeliveryChannelRequest::DeliveryChannelFilter & deliveryChannelFilter) { DARABONBA_PTR_SET_VALUE(deliveryChannelFilter_, deliveryChannelFilter) };
    inline UpdateDeliveryChannelRequest& setDeliveryChannelFilter(UpdateDeliveryChannelRequest::DeliveryChannelFilter && deliveryChannelFilter) { DARABONBA_PTR_SET_RVALUE(deliveryChannelFilter_, deliveryChannelFilter) };
    ...
    inline const UpdateDeliveryChannelRequest::ResourceChangeDelivery & getResourceChangeDelivery() const { DARABONBA_PTR_GET_CONST(resourceChangeDelivery_, UpdateDeliveryChannelRequest::ResourceChangeDelivery) };
    inline UpdateDeliveryChannelRequest::ResourceChangeDelivery getResourceChangeDelivery() { DARABONBA_PTR_GET(resourceChangeDelivery_, UpdateDeliveryChannelRequest::ResourceChangeDelivery) };
    inline UpdateDeliveryChannelRequest& setResourceChangeDelivery(const UpdateDeliveryChannelRequest::ResourceChangeDelivery & resourceChangeDelivery) { DARABONBA_PTR_SET_VALUE(resourceChangeDelivery_, resourceChangeDelivery) };
    inline UpdateDeliveryChannelRequest& setResourceChangeDelivery(UpdateDeliveryChannelRequest::ResourceChangeDelivery && resourceChangeDelivery) { DARABONBA_PTR_SET_RVALUE(resourceChangeDelivery_, resourceChangeDelivery) };
    ...
    inline const UpdateDeliveryChannelRequest::ResourceSnapshotDelivery & getResourceSnapshotDelivery() const { DARABONBA_PTR_GET_CONST(resourceSnapshotDelivery_, UpdateDeliveryChannelRequest::ResourceSnapshotDelivery) };
    inline UpdateDeliveryChannelRequest::ResourceSnapshotDelivery getResourceSnapshotDelivery() { DARABONBA_PTR_GET(resourceSnapshotDelivery_, UpdateDeliveryChannelRequest::ResourceSnapshotDelivery) };
    inline UpdateDeliveryChannelRequest& setResourceSnapshotDelivery(const UpdateDeliveryChannelRequest::ResourceSnapshotDelivery & resourceSnapshotDelivery) { DARABONBA_PTR_SET_VALUE(resourceSnapshotDelivery_, resourceSnapshotDelivery) };
    inline UpdateDeliveryChannelRequest& setResourceSnapshotDelivery(UpdateDeliveryChannelRequest::ResourceSnapshotDelivery && resourceSnapshotDelivery) { DARABONBA_PTR_SET_RVALUE(resourceSnapshotDelivery_, resourceSnapshotDelivery) };
  ...
  protected:
    ...
    shared_ptr<UpdateDeliveryChannelRequest::DeliveryChannelFilter> deliveryChannelFilter_ {};
    ...
    shared_ptr<UpdateDeliveryChannelRequest::ResourceChangeDelivery> resourceChangeDelivery_ {};
    // The configurations for delivery of scheduled resource snapshots.
    shared_ptr<UpdateDeliveryChannelRequest::ResourceSnapshotDelivery> resourceSnapshotDelivery_ {};
  };
