...
#ifndef ALIBABACLOUD_MODELS_LISTDELIVERYCHANNELSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTDELIVERYCHANNELSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDeliveryChannelsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(DeliveryChannels, deliveryChannels_);
      DARABONBA_PTR_TO_JSON(MaxResults, maxResults_);
      DARABONBA_PTR_TO_JSON(NextToken, nextToken_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListDeliveryChannelsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(DeliveryChannels, deliveryChannels_);
      DARABONBA_PTR_FROM_JSON(MaxResults, maxResults_);
      DARABONBA_PTR_FROM_JSON(NextToken, nextToken_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListDeliveryChannelsResponseBody() = default ;
    ListDeliveryChannelsResponseBody(const ListDeliveryChannelsResponseBody &) = default ;
    ListDeliveryChannelsResponseBody(ListDeliveryChannelsResponseBody &&) = default ;
    ListDeliveryChannelsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDeliveryChannelsResponseBody() = default ;
    ListDeliveryChannelsResponseBody& operator=(const ListDeliveryChannelsResponseBody &) = default ;
    ListDeliveryChannelsResponseBody& operator=(ListDeliveryChannelsResponseBody &&) = default ;
    ...
    inline const vector<ListDeliveryChannelsResponseBody::DeliveryChannels> & getDeliveryChannels() const { DARABONBA_PTR_GET_CONST(deliveryChannels_, vector<ListDeliveryChannelsResponseBody::DeliveryChannels>) };
    inline vector<ListDeliveryChannelsResponseBody::DeliveryChannels> getDeliveryChannels() { DARABONBA_PTR_GET(deliveryChannels_, vector<ListDeliveryChannelsResponseBody::DeliveryChannels>) };
    inline ListDeliveryChannelsResponseBody& setDeliveryChannels(const vector<ListDeliveryChannelsResponseBody::DeliveryChannels> & deliveryChannels) { DARABONBA_PTR_SET_VALUE(deliveryChannels_, deliveryChannels) };
    inline ListDeliveryChannelsResponseBody& setDeliveryChannels(vector<ListDeliveryChannelsResponseBody::DeliveryChannels> && deliveryChannels) { DARABONBA_PTR_SET_RVALUE(deliveryChannels_, deliveryChannels) };
    ...
    inline ListDeliveryChannelsResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListDeliveryChannelsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListDeliveryChannelsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The delivery channels.
    shared_ptr<vector<ListDeliveryChannelsResponseBody::DeliveryChannels>> deliveryChannels_ {};
