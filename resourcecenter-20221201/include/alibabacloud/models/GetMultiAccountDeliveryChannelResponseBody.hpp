...
namespace Models
{
  ...
  public:
    ...
    inline const GetMultiAccountDeliveryChannelResponseBodyDeliveryChannelFilter & deliveryChannelFilter() const { DARABONBA_PTR_GET_CONST(deliveryChannelFilter_, GetMultiAccountDeliveryChannelResponseBodyDeliveryChannelFilter) };
    inline GetMultiAccountDeliveryChannelResponseBodyDeliveryChannelFilter deliveryChannelFilter() { DARABONBA_PTR_GET(deliveryChannelFilter_, GetMultiAccountDeliveryChannelResponseBodyDeliveryChannelFilter) };
    inline GetMultiAccountDeliveryChannelResponseBody& setDeliveryChannelFilter(const GetMultiAccountDeliveryChannelResponseBodyDeliveryChannelFilter & deliveryChannelFilter) { DARABONBA_PTR_SET_VALUE(deliveryChannelFilter_, deliveryChannelFilter) };
    inline GetMultiAccountDeliveryChannelResponseBody& setDeliveryChannelFilter(GetMultiAccountDeliveryChannelResponseBodyDeliveryChannelFilter && deliveryChannelFilter) { DARABONBA_PTR_SET_RVALUE(deliveryChannelFilter_, deliveryChannelFilter) };
    ...
    inline const GetMultiAccountDeliveryChannelResponseBodyResourceChangeDelivery & resourceChangeDelivery() const { DARABONBA_PTR_GET_CONST(resourceChangeDelivery_, GetMultiAccountDeliveryChannelResponseBodyResourceChangeDelivery) };
    inline GetMultiAccountDeliveryChannelResponseBodyResourceChangeDelivery resourceChangeDelivery() { DARABONBA_PTR_GET(resourceChangeDelivery_, GetMultiAccountDeliveryChannelResponseBodyResourceChangeDelivery) };
    inline GetMultiAccountDeliveryChannelResponseBody& setResourceChangeDelivery(const GetMultiAccountDeliveryChannelResponseBodyResourceChangeDelivery & resourceChangeDelivery) { DARABONBA_PTR_SET_VALUE(resourceChangeDelivery_, resourceChangeDelivery) };
    inline GetMultiAccountDeliveryChannelResponseBody& setResourceChangeDelivery(GetMultiAccountDeliveryChannelResponseBodyResourceChangeDelivery && resourceChangeDelivery) { DARABONBA_PTR_SET_RVALUE(resourceChangeDelivery_, resourceChangeDelivery) };
    ...
    inline const GetMultiAccountDeliveryChannelResponseBodyResourceSnapshotDelivery & resourceSnapshotDelivery() const { DARABONBA_PTR_GET_CONST(resourceSnapshotDelivery_, GetMultiAccountDeliveryChannelResponseBodyResourceSnapshotDelivery) };
    inline GetMultiAccountDeliveryChannelResponseBodyResourceSnapshotDelivery resourceSnapshotDelivery() { DARABONBA_PTR_GET(resourceSnapshotDelivery_, GetMultiAccountDeliveryChannelResponseBodyResourceSnapshotDelivery) };
    inline GetMultiAccountDeliveryChannelResponseBody& setResourceSnapshotDelivery(const GetMultiAccountDeliveryChannelResponseBodyResourceSnapshotDelivery & resourceSnapshotDelivery) { DARABONBA_PTR_SET_VALUE(resourceSnapshotDelivery_, resourceSnapshotDelivery) };
    inline GetMultiAccountDeliveryChannelResponseBody& setResourceSnapshotDelivery(GetMultiAccountDeliveryChannelResponseBodyResourceSnapshotDelivery && resourceSnapshotDelivery) { DARABONBA_PTR_SET_RVALUE(resourceSnapshotDelivery_, resourceSnapshotDelivery) };
  ...
  protected:
    ...
    std::shared_ptr<GetMultiAccountDeliveryChannelResponseBodyDeliveryChannelFilter> deliveryChannelFilter_ = nullptr;
    ...
    std::shared_ptr<GetMultiAccountDeliveryChannelResponseBodyResourceChangeDelivery> resourceChangeDelivery_ = nullptr;
    // The configurations for delivery of scheduled resource snapshots.
    std::shared_ptr<GetMultiAccountDeliveryChannelResponseBodyResourceSnapshotDelivery> resourceSnapshotDelivery_ = nullptr;
  };
