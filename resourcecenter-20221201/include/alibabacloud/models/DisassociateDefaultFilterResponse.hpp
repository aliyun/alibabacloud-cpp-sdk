...
namespace Models
{
  ...
  public:
    ...
    inline const DisassociateDefaultFilterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisassociateDefaultFilterResponseBody) };
    inline DisassociateDefaultFilterResponseBody getBody() { DARABONBA_PTR_GET(body_, DisassociateDefaultFilterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisassociateDefaultFilterResponseBody> body_ {};
  };
