...
namespace Models
{
  ...
  public:
    ...
    inline const GetMultiAccountDeliveryChannelStatisticsResponseBody::DeliveryChannelStatistics & getDeliveryChannelStatistics() const { DARABONBA_PTR_GET_CONST(deliveryChannelStatistics_, GetMultiAccountDeliveryChannelStatisticsResponseBody::DeliveryChannelStatistics) };
    inline GetMultiAccountDeliveryChannelStatisticsResponseBody::DeliveryChannelStatistics getDeliveryChannelStatistics() { DARABONBA_PTR_GET(deliveryChannelStatistics_, GetMultiAccountDeliveryChannelStatisticsResponseBody::DeliveryChannelStatistics) };
    inline GetMultiAccountDeliveryChannelStatisticsResponseBody& setDeliveryChannelStatistics(const GetMultiAccountDeliveryChannelStatisticsResponseBody::DeliveryChannelStatistics & deliveryChannelStatistics) { DARABONBA_PTR_SET_VALUE(deliveryChannelStatistics_, deliveryChannelStatistics) };
    inline GetMultiAccountDeliveryChannelStatisticsResponseBody& setDeliveryChannelStatistics(GetMultiAccountDeliveryChannelStatisticsResponseBody::DeliveryChannelStatistics && deliveryChannelStatistics) { DARABONBA_PTR_SET_RVALUE(deliveryChannelStatistics_, deliveryChannelStatistics) };
  ...
  protected:
    ...
    shared_ptr<GetMultiAccountDeliveryChannelStatisticsResponseBody::DeliveryChannelStatistics> deliveryChannelStatistics_ {};
    // The request ID.
