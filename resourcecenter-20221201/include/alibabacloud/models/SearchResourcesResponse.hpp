...
namespace Models
{
  ...
  public:
    ...
    inline const SearchResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchResourcesResponseBody) };
    inline SearchResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchResourcesResponseBody> body_ {};
  };
