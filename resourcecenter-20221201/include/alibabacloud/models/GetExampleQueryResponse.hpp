...
namespace Models
{
  ...
  public:
    ...
    inline const GetExampleQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetExampleQueryResponseBody) };
    inline GetExampleQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetExampleQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetExampleQueryResponseBody> body_ {};
  };
