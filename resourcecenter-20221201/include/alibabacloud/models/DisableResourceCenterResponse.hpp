...
namespace Models
{
  ...
  public:
    ...
    inline const DisableResourceCenterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableResourceCenterResponseBody) };
    inline DisableResourceCenterResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableResourceCenterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableResourceCenterResponseBody> body_ {};
  };
