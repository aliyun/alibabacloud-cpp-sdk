...
namespace Models
{
  ...
  public:
    ...
    inline const GetMultiAccountDeliveryChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMultiAccountDeliveryChannelResponseBody) };
    inline GetMultiAccountDeliveryChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMultiAccountDeliveryChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMultiAccountDeliveryChannelResponseBody> body_ {};
  };
