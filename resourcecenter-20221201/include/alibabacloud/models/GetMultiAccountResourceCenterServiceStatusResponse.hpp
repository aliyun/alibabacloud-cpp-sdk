...
namespace Models
{
  ...
  public:
    ...
    inline const GetMultiAccountResourceCenterServiceStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMultiAccountResourceCenterServiceStatusResponseBody) };
    inline GetMultiAccountResourceCenterServiceStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMultiAccountResourceCenterServiceStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMultiAccountResourceCenterServiceStatusResponseBody> body_ {};
  };
