...
namespace Models
{
  ...
  public:
    ...
    inline const ListMultiAccountTagKeysResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListMultiAccountTagKeysResponseBody) };
    inline ListMultiAccountTagKeysResponseBody getBody() { DARABONBA_PTR_GET(body_, ListMultiAccountTagKeysResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListMultiAccountTagKeysResponseBody> body_ {};
  };
