...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ExecuteMultiAccountSQLQueryResponseBody::Columns> & getColumns() const { DARABONBA_PTR_GET_CONST(columns_, vector<ExecuteMultiAccountSQLQueryResponseBody::Columns>) };
    inline vector<ExecuteMultiAccountSQLQueryResponseBody::Columns> getColumns() { DARABONBA_PTR_GET(columns_, vector<ExecuteMultiAccountSQLQueryResponseBody::Columns>) };
    inline ExecuteMultiAccountSQLQueryResponseBody& setColumns(const vector<ExecuteMultiAccountSQLQueryResponseBody::Columns> & columns) { DARABONBA_PTR_SET_VALUE(columns_, columns) };
    inline ExecuteMultiAccountSQLQueryResponseBody& setColumns(vector<ExecuteMultiAccountSQLQueryResponseBody::Columns> && columns) { DARABONBA_PTR_SET_RVALUE(columns_, columns) };
  ...
  protected:
    // The columns.
    shared_ptr<vector<ExecuteMultiAccountSQLQueryResponseBody::Columns>> columns_ {};
