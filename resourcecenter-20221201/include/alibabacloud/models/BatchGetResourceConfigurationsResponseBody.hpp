...
#ifndef ALIBABACLOUD_MODELS_BATCHGETRESOURCECONFIGURATIONSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_BATCHGETRESOURCECONFIGURATIONSRESPONSEBODY_HPP_
...
namespace Models
{
  class BatchGetResourceConfigurationsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const BatchGetResourceConfigurationsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Resources, resources_);
    };
    friend void from_json(const Darabonba::Json& j, BatchGetResourceConfigurationsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Resources, resources_);
    };
    BatchGetResourceConfigurationsResponseBody() = default ;
    BatchGetResourceConfigurationsResponseBody(const BatchGetResourceConfigurationsResponseBody &) = default ;
    BatchGetResourceConfigurationsResponseBody(BatchGetResourceConfigurationsResponseBody &&) = default ;
    BatchGetResourceConfigurationsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BatchGetResourceConfigurationsResponseBody() = default ;
    BatchGetResourceConfigurationsResponseBody& operator=(const BatchGetResourceConfigurationsResponseBody &) = default ;
    BatchGetResourceConfigurationsResponseBody& operator=(BatchGetResourceConfigurationsResponseBody &&) = default ;
    ...
    public:
      ...
      inline Resources& setConfiguration(const Darabonba::Json & configuration) { DARABONBA_SET_VALUE(configuration_, configuration) };
      inline Resources& setConfiguration(Darabonba::Json && configuration) { DARABONBA_SET_RVALUE(configuration_, configuration) };
    ...
    inline BatchGetResourceConfigurationsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // resources Field Functions 
    bool hasResources() const { return this->resources_ != nullptr;};
    void deleteResources() { this->resources_ = nullptr;};
    inline const vector<BatchGetResourceConfigurationsResponseBody::Resources> & getResources() const { DARABONBA_PTR_GET_CONST(resources_, vector<BatchGetResourceConfigurationsResponseBody::Resources>) };
    inline vector<BatchGetResourceConfigurationsResponseBody::Resources> getResources() { DARABONBA_PTR_GET(resources_, vector<BatchGetResourceConfigurationsResponseBody::Resources>) };
    inline BatchGetResourceConfigurationsResponseBody& setResources(const vector<BatchGetResourceConfigurationsResponseBody::Resources> & resources) { DARABONBA_PTR_SET_VALUE(resources_, resources) };
    inline BatchGetResourceConfigurationsResponseBody& setResources(vector<BatchGetResourceConfigurationsResponseBody::Resources> && resources) { DARABONBA_PTR_SET_RVALUE(resources_, resources) };
