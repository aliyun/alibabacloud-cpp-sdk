...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMultiAccountDeliveryChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateMultiAccountDeliveryChannelResponseBody) };
    inline UpdateMultiAccountDeliveryChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateMultiAccountDeliveryChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateMultiAccountDeliveryChannelResponseBody> body_ {};
  };
