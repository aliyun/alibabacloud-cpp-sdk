...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSavedQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSavedQueryResponseBody) };
    inline DeleteSavedQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSavedQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSavedQueryResponseBody> body_ {};
  };
