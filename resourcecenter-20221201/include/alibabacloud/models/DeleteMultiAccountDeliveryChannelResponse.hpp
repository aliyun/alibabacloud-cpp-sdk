...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMultiAccountDeliveryChannelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMultiAccountDeliveryChannelResponseBody) };
    inline DeleteMultiAccountDeliveryChannelResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMultiAccountDeliveryChannelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMultiAccountDeliveryChannelResponseBody> body_ {};
  };
