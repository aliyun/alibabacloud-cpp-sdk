...
#ifndef ALIBABACLOUD_MODELS_CREATEFILTERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEFILTERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateFilterRequest& obj) { 
      DARABONBA_PTR_TO_JSON(FilterConfiguration, filterConfiguration_);
      DARABONBA_PTR_TO_JSON(FilterName, filterName_);
    };
    friend void from_json(const Darabonba::Json& j, CreateFilterRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(FilterConfiguration, filterConfiguration_);
      DARABONBA_PTR_FROM_JSON(FilterName, filterName_);
    };
    CreateFilterRequest() = default ;
    CreateFilterRequest(const CreateFilterRequest &) = default ;
    CreateFilterRequest(CreateFilterRequest &&) = default ;
    CreateFilterRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateFilterRequest() = default ;
    CreateFilterRequest& operator=(const CreateFilterRequest &) = default ;
    CreateFilterRequest& operator=(CreateFilterRequest &&) = default ;
