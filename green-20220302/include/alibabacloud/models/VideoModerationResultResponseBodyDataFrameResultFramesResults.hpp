...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->customImage_ == nullptr
        && return this->logoData_ == nullptr && return this->publicFigure_ == nullptr && return this->result_ == nullptr && return this->service_ == nullptr && return this->textInImage_ == nullptr; };
