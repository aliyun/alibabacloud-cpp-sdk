...
namespace Models
{
  ...
  public:
    ...
    inline const ManualModerationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ManualModerationResponseBodyData) };
    inline ManualModerationResponseBodyData data() { DARABONBA_PTR_GET(data_, ManualModerationResponseBodyData) };
    inline ManualModerationResponseBody& setData(const ManualModerationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ManualModerationResponseBody& setData(ManualModerationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // Returned data.
    std::shared_ptr<ManualModerationResponseBodyData> data_ = nullptr;
    // Error message
