...
namespace Models
{
  ...
  public:
    ...
    inline const ImageBatchModerationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImageBatchModerationResponseBody) };
    inline ImageBatchModerationResponseBody getBody() { DARABONBA_PTR_GET(body_, ImageBatchModerationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImageBatchModerationResponseBody> body_ {};
  };
