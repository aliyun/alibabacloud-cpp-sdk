...
namespace Models
{
  ...
  public:
    ...
    inline const MultimodalAsyncModerationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MultimodalAsyncModerationResponseBody) };
    inline MultimodalAsyncModerationResponseBody getBody() { DARABONBA_PTR_GET(body_, MultimodalAsyncModerationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MultimodalAsyncModerationResponseBody> body_ {};
  };
