...
namespace Models
{
  ...
  public:
    ...
    inline const TextModerationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TextModerationResponseBody) };
    inline TextModerationResponseBody getBody() { DARABONBA_PTR_GET(body_, TextModerationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TextModerationResponseBody> body_ {};
  };
