...
namespace Models
{
  ...
  public:
    ...
    inline const VideoModerationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, VideoModerationResponseBody) };
    inline VideoModerationResponseBody getBody() { DARABONBA_PTR_GET(body_, VideoModerationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<VideoModerationResponseBody> body_ {};
  };
