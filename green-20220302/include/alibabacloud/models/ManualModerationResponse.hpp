...
namespace Models
{
  ...
  public:
    ...
    inline const ManualModerationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ManualModerationResponseBody) };
    inline ManualModerationResponseBody getBody() { DARABONBA_PTR_GET(body_, ManualModerationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ManualModerationResponseBody> body_ {};
  };
