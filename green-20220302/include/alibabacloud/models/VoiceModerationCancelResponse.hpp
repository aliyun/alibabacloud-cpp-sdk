...
namespace Models
{
  ...
  public:
    ...
    inline const VoiceModerationCancelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, VoiceModerationCancelResponseBody) };
    inline VoiceModerationCancelResponseBody getBody() { DARABONBA_PTR_GET(body_, VoiceModerationCancelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<VoiceModerationCancelResponseBody> body_ {};
  };
