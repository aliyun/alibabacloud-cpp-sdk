...
namespace Models
{
  ...
  public:
    ...
    inline const MultiModalGuardForBase64ResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, MultiModalGuardForBase64ResponseBody::Data) };
    inline MultiModalGuardForBase64ResponseBody::Data getData() { DARABONBA_PTR_GET(data_, MultiModalGuardForBase64ResponseBody::Data) };
    inline MultiModalGuardForBase64ResponseBody& setData(const MultiModalGuardForBase64ResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline MultiModalGuardForBase64ResponseBody& setData(MultiModalGuardForBase64ResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
