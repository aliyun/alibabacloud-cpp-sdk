...
namespace Models
{
  ...
  public:
    ...
    inline const TextModerationResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, TextModerationResponseBodyData) };
    inline TextModerationResponseBodyData data() { DARABONBA_PTR_GET(data_, TextModerationResponseBodyData) };
    inline TextModerationResponseBody& setData(const TextModerationResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TextModerationResponseBody& setData(TextModerationResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<TextModerationResponseBodyData> data_ = nullptr;
