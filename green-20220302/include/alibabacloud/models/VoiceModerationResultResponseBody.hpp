...
namespace Models
{
  ...
  public:
    ...
    inline const VoiceModerationResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, VoiceModerationResultResponseBodyData) };
    inline VoiceModerationResultResponseBodyData data() { DARABONBA_PTR_GET(data_, VoiceModerationResultResponseBodyData) };
    inline VoiceModerationResultResponseBody& setData(const VoiceModerationResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline VoiceModerationResultResponseBody& setData(VoiceModerationResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<VoiceModerationResultResponseBodyData> data_ = nullptr;
