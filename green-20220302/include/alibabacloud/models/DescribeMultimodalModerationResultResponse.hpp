...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMultimodalModerationResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMultimodalModerationResultResponseBody) };
    inline DescribeMultimodalModerationResultResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMultimodalModerationResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMultimodalModerationResultResponseBody> body_ {};
  };
