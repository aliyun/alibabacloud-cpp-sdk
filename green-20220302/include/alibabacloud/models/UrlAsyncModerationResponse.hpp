...
namespace Models
{
  ...
  public:
    ...
    inline const UrlAsyncModerationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UrlAsyncModerationResponseBody) };
    inline UrlAsyncModerationResponseBody getBody() { DARABONBA_PTR_GET(body_, UrlAsyncModerationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UrlAsyncModerationResponseBody> body_ {};
  };
