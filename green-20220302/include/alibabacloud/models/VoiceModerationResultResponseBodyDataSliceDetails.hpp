...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->descriptions_ == nullptr
        && return this->endTime_ == nullptr && return this->endTimestamp_ == nullptr && return this->extend_ == nullptr && return this->labels_ == nullptr && return this->originAlgoResult_ == nullptr
        && return this->riskLevel_ == nullptr && return this->riskTips_ == nullptr && return this->riskWords_ == nullptr && return this->score_ == nullptr && return this->startTime_ == nullptr
        && return this->startTimestamp_ == nullptr && return this->text_ == nullptr && return this->url_ == nullptr; };
