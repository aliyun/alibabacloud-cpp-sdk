...
#ifndef ALIBABACLOUD_MODELS_QUERYMODIFYCUPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYMODIFYCUPRICERESPONSEBODY_HPP_
...
namespace Models
{
  class QueryModifyCuPriceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryModifyCuPriceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryModifyCuPriceResponseBody& obj) { 
    ...
    QueryModifyCuPriceResponseBody() = default ;
    QueryModifyCuPriceResponseBody(const QueryModifyCuPriceResponseBody &) = default ;
    QueryModifyCuPriceResponseBody(QueryModifyCuPriceResponseBody &&) = default ;
    QueryModifyCuPriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryModifyCuPriceResponseBody() = default ;
    QueryModifyCuPriceResponseBody& operator=(const QueryModifyCuPriceResponseBody &) = default ;
    QueryModifyCuPriceResponseBody& operator=(QueryModifyCuPriceResponseBody &&) = default ;
    ...
    inline QueryModifyCuPriceResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const QueryModifyCuPriceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryModifyCuPriceResponseBody::Data) };
    inline QueryModifyCuPriceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryModifyCuPriceResponseBody::Data) };
    inline QueryModifyCuPriceResponseBody& setData(const QueryModifyCuPriceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryModifyCuPriceResponseBody& setData(QueryModifyCuPriceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryModifyCuPriceResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline QueryModifyCuPriceResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline QueryModifyCuPriceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryModifyCuPriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryModifyCuPriceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
