...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyNodeNumberPreCheckResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ModifyNodeNumberPreCheckResponseBodyData) };
    inline ModifyNodeNumberPreCheckResponseBodyData data() { DARABONBA_PTR_GET(data_, ModifyNodeNumberPreCheckResponseBodyData) };
    inline ModifyNodeNumberPreCheckResponseBody& setData(const ModifyNodeNumberPreCheckResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyNodeNumberPreCheckResponseBody& setData(ModifyNodeNumberPreCheckResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ModifyNodeNumberPreCheckResponseBodyData> data_ = nullptr;
    // The error code.
