...
#ifndef ALIBABACLOUD_MODELS_QUERYMODIFYCHARGETYPEPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYMODIFYCHARGETYPEPRICERESPONSEBODY_HPP_
...
namespace Models
{
  class QueryModifyChargeTypePriceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryModifyChargeTypePriceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryModifyChargeTypePriceResponseBody& obj) { 
    ...
    QueryModifyChargeTypePriceResponseBody() = default ;
    QueryModifyChargeTypePriceResponseBody(const QueryModifyChargeTypePriceResponseBody &) = default ;
    QueryModifyChargeTypePriceResponseBody(QueryModifyChargeTypePriceResponseBody &&) = default ;
    QueryModifyChargeTypePriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryModifyChargeTypePriceResponseBody() = default ;
    QueryModifyChargeTypePriceResponseBody& operator=(const QueryModifyChargeTypePriceResponseBody &) = default ;
    QueryModifyChargeTypePriceResponseBody& operator=(QueryModifyChargeTypePriceResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->moduleName_ == nullptr && this->standPrice_ == nullptr && this->totalProductFee_ == nullptr; };
        ...
        inline ModuleInstance& setStandPrice(string standPrice) { DARABONBA_PTR_SET_VALUE(standPrice_, standPrice) };
        ...
        inline string getTotalProductFee() const { DARABONBA_PTR_GET_DEFAULT(totalProductFee_, "") };
        inline ModuleInstance& setTotalProductFee(string totalProductFee) { DARABONBA_PTR_SET_VALUE(totalProductFee_, totalProductFee) };
      ...
      virtual bool empty() const override { return this->componentPrices_ == nullptr
        && this->currency_ == nullptr && this->depreciateInfo_ == nullptr && this->discountAmount_ == nullptr && this->moduleInstance_ == nullptr && this->optionalPromotions_ == nullptr
        && this->originalAmount_ == nullptr && this->rules_ == nullptr && this->standDiscountPrice_ == nullptr && this->standPrice_ == nullptr && this->tradeAmount_ == nullptr; };
      ...
      inline const vector<Data::ModuleInstance> & getModuleInstance() const { DARABONBA_PTR_GET_CONST(moduleInstance_, vector<Data::ModuleInstance>) };
      inline vector<Data::ModuleInstance> getModuleInstance() { DARABONBA_PTR_GET(moduleInstance_, vector<Data::ModuleInstance>) };
      inline Data& setModuleInstance(const vector<Data::ModuleInstance> & moduleInstance) { DARABONBA_PTR_SET_VALUE(moduleInstance_, moduleInstance) };
      inline Data& setModuleInstance(vector<Data::ModuleInstance> && moduleInstance) { DARABONBA_PTR_SET_RVALUE(moduleInstance_, moduleInstance) };
    ...
    inline QueryModifyChargeTypePriceResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const QueryModifyChargeTypePriceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryModifyChargeTypePriceResponseBody::Data) };
    inline QueryModifyChargeTypePriceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryModifyChargeTypePriceResponseBody::Data) };
    inline QueryModifyChargeTypePriceResponseBody& setData(const QueryModifyChargeTypePriceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryModifyChargeTypePriceResponseBody& setData(QueryModifyChargeTypePriceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryModifyChargeTypePriceResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline QueryModifyChargeTypePriceResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline QueryModifyChargeTypePriceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryModifyChargeTypePriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryModifyChargeTypePriceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
