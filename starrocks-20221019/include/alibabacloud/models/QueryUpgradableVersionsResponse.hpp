...
namespace Models
{
  ...
  public:
    ...
    inline const QueryUpgradableVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryUpgradableVersionsResponseBody) };
    inline QueryUpgradableVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryUpgradableVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryUpgradableVersionsResponseBody> body_ {};
  };
