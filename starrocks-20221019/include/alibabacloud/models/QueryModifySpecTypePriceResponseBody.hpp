...
#ifndef ALIBABACLOUD_MODELS_QUERYMODIFYSPECTYPEPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYMODIFYSPECTYPEPRICERESPONSEBODY_HPP_
...
namespace Models
{
  class QueryModifySpecTypePriceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryModifySpecTypePriceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryModifySpecTypePriceResponseBody& obj) { 
    ...
    QueryModifySpecTypePriceResponseBody() = default ;
    QueryModifySpecTypePriceResponseBody(const QueryModifySpecTypePriceResponseBody &) = default ;
    QueryModifySpecTypePriceResponseBody(QueryModifySpecTypePriceResponseBody &&) = default ;
    QueryModifySpecTypePriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryModifySpecTypePriceResponseBody() = default ;
    QueryModifySpecTypePriceResponseBody& operator=(const QueryModifySpecTypePriceResponseBody &) = default ;
    QueryModifySpecTypePriceResponseBody& operator=(QueryModifySpecTypePriceResponseBody &&) = default ;
    ...
    inline QueryModifySpecTypePriceResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const QueryModifySpecTypePriceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryModifySpecTypePriceResponseBody::Data) };
    inline QueryModifySpecTypePriceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryModifySpecTypePriceResponseBody::Data) };
    inline QueryModifySpecTypePriceResponseBody& setData(const QueryModifySpecTypePriceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryModifySpecTypePriceResponseBody& setData(QueryModifySpecTypePriceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryModifySpecTypePriceResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline QueryModifySpecTypePriceResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline QueryModifySpecTypePriceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryModifySpecTypePriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryModifySpecTypePriceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // AccessDeniedDetail
    shared_ptr<string> accessDeniedDetail_ {};
    shared_ptr<QueryModifySpecTypePriceResponseBody::Data> data_ {};
