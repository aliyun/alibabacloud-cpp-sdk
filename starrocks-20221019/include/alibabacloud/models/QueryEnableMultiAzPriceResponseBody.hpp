...
#ifndef ALIBABACLOUD_MODELS_QUERYENABLEMULTIAZPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYENABLEMULTIAZPRICERESPONSEBODY_HPP_
...
namespace Models
{
  class QueryEnableMultiAzPriceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryEnableMultiAzPriceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryEnableMultiAzPriceResponseBody& obj) { 
    ...
    QueryEnableMultiAzPriceResponseBody() = default ;
    QueryEnableMultiAzPriceResponseBody(const QueryEnableMultiAzPriceResponseBody &) = default ;
    QueryEnableMultiAzPriceResponseBody(QueryEnableMultiAzPriceResponseBody &&) = default ;
    QueryEnableMultiAzPriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryEnableMultiAzPriceResponseBody() = default ;
    QueryEnableMultiAzPriceResponseBody& operator=(const QueryEnableMultiAzPriceResponseBody &) = default ;
    QueryEnableMultiAzPriceResponseBody& operator=(QueryEnableMultiAzPriceResponseBody &&) = default ;
    ...
    inline QueryEnableMultiAzPriceResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const QueryEnableMultiAzPriceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryEnableMultiAzPriceResponseBody::Data) };
    inline QueryEnableMultiAzPriceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryEnableMultiAzPriceResponseBody::Data) };
    inline QueryEnableMultiAzPriceResponseBody& setData(const QueryEnableMultiAzPriceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryEnableMultiAzPriceResponseBody& setData(QueryEnableMultiAzPriceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryEnableMultiAzPriceResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline QueryEnableMultiAzPriceResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline QueryEnableMultiAzPriceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryEnableMultiAzPriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryEnableMultiAzPriceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // AccessDeniedDetail
    shared_ptr<string> accessDeniedDetail_ {};
    shared_ptr<QueryEnableMultiAzPriceResponseBody::Data> data_ {};
