...
#ifndef ALIBABACLOUD_MODELS_QUERYMODIFYNODENUMBERPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYMODIFYNODENUMBERPRICERESPONSEBODY_HPP_
...
namespace Models
{
  class QueryModifyNodeNumberPriceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryModifyNodeNumberPriceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryModifyNodeNumberPriceResponseBody& obj) { 
    ...
    QueryModifyNodeNumberPriceResponseBody() = default ;
    QueryModifyNodeNumberPriceResponseBody(const QueryModifyNodeNumberPriceResponseBody &) = default ;
    QueryModifyNodeNumberPriceResponseBody(QueryModifyNodeNumberPriceResponseBody &&) = default ;
    QueryModifyNodeNumberPriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryModifyNodeNumberPriceResponseBody() = default ;
    QueryModifyNodeNumberPriceResponseBody& operator=(const QueryModifyNodeNumberPriceResponseBody &) = default ;
    QueryModifyNodeNumberPriceResponseBody& operator=(QueryModifyNodeNumberPriceResponseBody &&) = default ;
    ...
    inline QueryModifyNodeNumberPriceResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const QueryModifyNodeNumberPriceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryModifyNodeNumberPriceResponseBody::Data) };
    inline QueryModifyNodeNumberPriceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryModifyNodeNumberPriceResponseBody::Data) };
    inline QueryModifyNodeNumberPriceResponseBody& setData(const QueryModifyNodeNumberPriceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryModifyNodeNumberPriceResponseBody& setData(QueryModifyNodeNumberPriceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryModifyNodeNumberPriceResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline QueryModifyNodeNumberPriceResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline QueryModifyNodeNumberPriceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryModifyNodeNumberPriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryModifyNodeNumberPriceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
