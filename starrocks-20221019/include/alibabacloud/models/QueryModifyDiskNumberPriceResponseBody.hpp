...
#ifndef ALIBABACLOUD_MODELS_QUERYMODIFYDISKNUMBERPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYMODIFYDISKNUMBERPRICERESPONSEBODY_HPP_
...
namespace Models
{
  class QueryModifyDiskNumberPriceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryModifyDiskNumberPriceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryModifyDiskNumberPriceResponseBody& obj) { 
    ...
    QueryModifyDiskNumberPriceResponseBody() = default ;
    QueryModifyDiskNumberPriceResponseBody(const QueryModifyDiskNumberPriceResponseBody &) = default ;
    QueryModifyDiskNumberPriceResponseBody(QueryModifyDiskNumberPriceResponseBody &&) = default ;
    QueryModifyDiskNumberPriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryModifyDiskNumberPriceResponseBody() = default ;
    QueryModifyDiskNumberPriceResponseBody& operator=(const QueryModifyDiskNumberPriceResponseBody &) = default ;
    QueryModifyDiskNumberPriceResponseBody& operator=(QueryModifyDiskNumberPriceResponseBody &&) = default ;
    ...
    inline QueryModifyDiskNumberPriceResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const QueryModifyDiskNumberPriceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryModifyDiskNumberPriceResponseBody::Data) };
    inline QueryModifyDiskNumberPriceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryModifyDiskNumberPriceResponseBody::Data) };
    inline QueryModifyDiskNumberPriceResponseBody& setData(const QueryModifyDiskNumberPriceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryModifyDiskNumberPriceResponseBody& setData(QueryModifyDiskNumberPriceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryModifyDiskNumberPriceResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline QueryModifyDiskNumberPriceResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline QueryModifyDiskNumberPriceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryModifyDiskNumberPriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryModifyDiskNumberPriceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
