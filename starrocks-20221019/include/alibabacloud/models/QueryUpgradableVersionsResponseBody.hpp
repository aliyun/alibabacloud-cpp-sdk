...
#ifndef ALIBABACLOUD_MODELS_QUERYUPGRADABLEVERSIONSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYUPGRADABLEVERSIONSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryUpgradableVersionsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryUpgradableVersionsResponseBody& obj) { 
    ...
    QueryUpgradableVersionsResponseBody() = default ;
    QueryUpgradableVersionsResponseBody(const QueryUpgradableVersionsResponseBody &) = default ;
    QueryUpgradableVersionsResponseBody(QueryUpgradableVersionsResponseBody &&) = default ;
    QueryUpgradableVersionsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryUpgradableVersionsResponseBody() = default ;
    QueryUpgradableVersionsResponseBody& operator=(const QueryUpgradableVersionsResponseBody &) = default ;
    QueryUpgradableVersionsResponseBody& operator=(QueryUpgradableVersionsResponseBody &&) = default ;
