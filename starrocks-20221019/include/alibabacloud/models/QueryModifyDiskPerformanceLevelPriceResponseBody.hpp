...
#ifndef ALIBABACLOUD_MODELS_QUERYMODIFYDISKPERFORMANCELEVELPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYMODIFYDISKPERFORMANCELEVELPRICERESPONSEBODY_HPP_
...
namespace Models
{
  class QueryModifyDiskPerformanceLevelPriceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryModifyDiskPerformanceLevelPriceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryModifyDiskPerformanceLevelPriceResponseBody& obj) { 
    ...
    QueryModifyDiskPerformanceLevelPriceResponseBody() = default ;
    QueryModifyDiskPerformanceLevelPriceResponseBody(const QueryModifyDiskPerformanceLevelPriceResponseBody &) = default ;
    QueryModifyDiskPerformanceLevelPriceResponseBody(QueryModifyDiskPerformanceLevelPriceResponseBody &&) = default ;
    QueryModifyDiskPerformanceLevelPriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryModifyDiskPerformanceLevelPriceResponseBody() = default ;
    QueryModifyDiskPerformanceLevelPriceResponseBody& operator=(const QueryModifyDiskPerformanceLevelPriceResponseBody &) = default ;
    QueryModifyDiskPerformanceLevelPriceResponseBody& operator=(QueryModifyDiskPerformanceLevelPriceResponseBody &&) = default ;
    ...
    inline QueryModifyDiskPerformanceLevelPriceResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const QueryModifyDiskPerformanceLevelPriceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryModifyDiskPerformanceLevelPriceResponseBody::Data) };
    inline QueryModifyDiskPerformanceLevelPriceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryModifyDiskPerformanceLevelPriceResponseBody::Data) };
    inline QueryModifyDiskPerformanceLevelPriceResponseBody& setData(const QueryModifyDiskPerformanceLevelPriceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryModifyDiskPerformanceLevelPriceResponseBody& setData(QueryModifyDiskPerformanceLevelPriceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryModifyDiskPerformanceLevelPriceResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline QueryModifyDiskPerformanceLevelPriceResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline QueryModifyDiskPerformanceLevelPriceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryModifyDiskPerformanceLevelPriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryModifyDiskPerformanceLevelPriceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
