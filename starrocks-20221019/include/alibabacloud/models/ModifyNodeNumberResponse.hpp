...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyNodeNumberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyNodeNumberResponseBody) };
    inline ModifyNodeNumberResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyNodeNumberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyNodeNumberResponseBody> body_ {};
  };
