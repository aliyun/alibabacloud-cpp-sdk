...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDiskPerformanceLevelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDiskPerformanceLevelResponseBody) };
    inline ModifyDiskPerformanceLevelResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDiskPerformanceLevelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDiskPerformanceLevelResponseBody> body_ {};
  };
