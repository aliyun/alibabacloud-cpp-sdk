...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBackupPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBackupPoliciesResponseBody) };
    inline DescribeBackupPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBackupPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBackupPoliciesResponseBody> body_ {};
  };
