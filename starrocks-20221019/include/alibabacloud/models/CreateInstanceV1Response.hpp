...
namespace Models
{
  ...
  public:
    ...
    inline const CreateInstanceV1ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateInstanceV1ResponseBody) };
    inline CreateInstanceV1ResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateInstanceV1ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateInstanceV1ResponseBody> body_ {};
  };
