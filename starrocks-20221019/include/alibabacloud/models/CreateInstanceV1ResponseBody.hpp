...
namespace Models
{
  ...
  public:
    ...
    inline const CreateInstanceV1ResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateInstanceV1ResponseBody::Data) };
    inline CreateInstanceV1ResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateInstanceV1ResponseBody::Data) };
    inline CreateInstanceV1ResponseBody& setData(const CreateInstanceV1ResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateInstanceV1ResponseBody& setData(CreateInstanceV1ResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The response data.
    shared_ptr<CreateInstanceV1ResponseBody::Data> data_ {};
    // The error code.
