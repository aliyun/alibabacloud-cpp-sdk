...
#ifndef ALIBABACLOUD_MODELS_QUERYMODIFYDISKTYPEPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYMODIFYDISKTYPEPRICERESPONSEBODY_HPP_
...
namespace Models
{
  class QueryModifyDiskTypePriceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryModifyDiskTypePriceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryModifyDiskTypePriceResponseBody& obj) { 
    ...
    QueryModifyDiskTypePriceResponseBody() = default ;
    QueryModifyDiskTypePriceResponseBody(const QueryModifyDiskTypePriceResponseBody &) = default ;
    QueryModifyDiskTypePriceResponseBody(QueryModifyDiskTypePriceResponseBody &&) = default ;
    QueryModifyDiskTypePriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryModifyDiskTypePriceResponseBody() = default ;
    QueryModifyDiskTypePriceResponseBody& operator=(const QueryModifyDiskTypePriceResponseBody &) = default ;
    QueryModifyDiskTypePriceResponseBody& operator=(QueryModifyDiskTypePriceResponseBody &&) = default ;
    ...
    inline QueryModifyDiskTypePriceResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const QueryModifyDiskTypePriceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryModifyDiskTypePriceResponseBody::Data) };
    inline QueryModifyDiskTypePriceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryModifyDiskTypePriceResponseBody::Data) };
    inline QueryModifyDiskTypePriceResponseBody& setData(const QueryModifyDiskTypePriceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryModifyDiskTypePriceResponseBody& setData(QueryModifyDiskTypePriceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryModifyDiskTypePriceResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline QueryModifyDiskTypePriceResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline QueryModifyDiskTypePriceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryModifyDiskTypePriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryModifyDiskTypePriceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
