...
#ifndef ALIBABACLOUD_MODELS_MODIFYDISKNUMBERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYDISKNUMBERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    ModifyDiskNumberRequest() = default ;
    ModifyDiskNumberRequest(const ModifyDiskNumberRequest &) = default ;
    ModifyDiskNumberRequest(ModifyDiskNumberRequest &&) = default ;
    ModifyDiskNumberRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyDiskNumberRequest() = default ;
    ModifyDiskNumberRequest& operator=(const ModifyDiskNumberRequest &) = default ;
    ModifyDiskNumberRequest& operator=(ModifyDiskNumberRequest &&) = default ;
    ...
    inline ModifyDiskNumberRequest& setFastMode(bool fastMode) { DARABONBA_PTR_SET_VALUE(fastMode_, fastMode) };
    ...
    inline ModifyDiskNumberRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ModifyDiskNumberRequest& setNodeGroupId(string nodeGroupId) { DARABONBA_PTR_SET_VALUE(nodeGroupId_, nodeGroupId) };
    ...
    inline ModifyDiskNumberRequest& setPromotionOptionNo(string promotionOptionNo) { DARABONBA_PTR_SET_VALUE(promotionOptionNo_, promotionOptionNo) };
    ...
    inline ModifyDiskNumberRequest& setTarget(int32_t target) { DARABONBA_PTR_SET_VALUE(target_, target) };
