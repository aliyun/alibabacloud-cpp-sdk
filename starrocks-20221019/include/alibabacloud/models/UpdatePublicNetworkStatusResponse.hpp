...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePublicNetworkStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePublicNetworkStatusResponseBody) };
    inline UpdatePublicNetworkStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePublicNetworkStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePublicNetworkStatusResponseBody> body_ {};
  };
