...
#ifndef ALIBABACLOUD_MODELS_QUERYRENEWPRICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYRENEWPRICERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryRenewPriceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryRenewPriceResponseBody& obj) { 
    ...
    QueryRenewPriceResponseBody() = default ;
    QueryRenewPriceResponseBody(const QueryRenewPriceResponseBody &) = default ;
    QueryRenewPriceResponseBody(QueryRenewPriceResponseBody &&) = default ;
    QueryRenewPriceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryRenewPriceResponseBody() = default ;
    QueryRenewPriceResponseBody& operator=(const QueryRenewPriceResponseBody &) = default ;
    QueryRenewPriceResponseBody& operator=(QueryRenewPriceResponseBody &&) = default ;
    ...
    inline const vector<QueryRenewPriceResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryRenewPriceResponseBody::Data>) };
    inline vector<QueryRenewPriceResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<QueryRenewPriceResponseBody::Data>) };
    inline QueryRenewPriceResponseBody& setData(const vector<QueryRenewPriceResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryRenewPriceResponseBody& setData(vector<QueryRenewPriceResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryRenewPriceResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline QueryRenewPriceResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline QueryRenewPriceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryRenewPriceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryRenewPriceResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
