  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->description_ == nullptr
        && this->descriptionEn_ == nullptr && this->regionId_ == nullptr && this->regionName_ == nullptr; };
    ...
    inline DescribeRegionsResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<DescribeRegionsResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeRegionsResponseBody::Data>) };
    inline vector<DescribeRegionsResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<DescribeRegionsResponseBody::Data>) };
    inline DescribeRegionsResponseBody& setData(const vector<DescribeRegionsResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeRegionsResponseBody& setData(vector<DescribeRegionsResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
