...
public:
  ...
  GetPtsSceneResponseBodySceneLoadConfigVpcLoadConfig() {}

  explicit GetPtsSceneResponseBodySceneLoadConfigVpcLoadConfig(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  shared_ptr<string> testMode{};
  shared_ptr<GetPtsSceneResponseBodySceneLoadConfigVpcLoadConfig> vpcLoadConfig{};
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("VpcLoadConfig") != m.end() && !m["VpcLoadConfig"].empty()) {
      if (typeid(map<string, boost::any>) == m["VpcLoadConfig"].type()) {
        GetPtsSceneResponseBodySceneLoadConfigVpcLoadConfig model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["VpcLoadConfig"]));
        vpcLoadConfig = make_shared<GetPtsSceneResponseBodySceneLoadConfigVpcLoadConfig>(model1);
      }
    }
  }
...
public:
  ...
  explicit ListPtsReportsRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  ListPtsReportsResponseBodyReports() {}

  explicit ListPtsReportsResponseBodyReports(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  shared_ptr<long> pageNumber{};
  shared_ptr<long> pageSize{};
  shared_ptr<vector<ListPtsReportsResponseBodyReports>> reports{};
  shared_ptr<string> requestId{};
  shared_ptr<bool> success{};
  shared_ptr<long> totalCount{};

  ListPtsReportsResponseBody() {}

  explicit ListPtsReportsResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Reports") != m.end() && !m["Reports"].empty()) {
      if (typeid(vector<boost::any>) == m["Reports"].type()) {
        vector<ListPtsReportsResponseBodyReports> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["Reports"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            ListPtsReportsResponseBodyReports model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        reports = make_shared<vector<ListPtsReportsResponseBodyReports>>(expect1);
      }
    }
    if (m.find("RequestId") != m.end() && !m["RequestId"].empty()) {
      requestId = make_shared<string>(boost::any_cast<string>(m["RequestId"]));
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<ListPtsReportsResponseBody> body{};

  ListPtsReportsResponse() {}

  explicit ListPtsReportsResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        ListPtsReportsResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<ListPtsReportsResponseBody>(model1);
      }
    }
  }
...
public:
  ...
  ListPtsReportsResponse listPtsReportsWithOptions(shared_ptr<ListPtsReportsRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  ListPtsReportsResponse listPtsReports(shared_ptr<ListPtsReportsRequest> request);
