...
GetJMeterReportDetailsResponse Alibabacloud_PTS20201020::Client::getJMeterReportDetailsWithOptions(shared_ptr<GetJMeterReportDetailsRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->reportId)) {
    query->insert(pair<string, string>("ReportId", *request->reportId));
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("GetJMeterReportDetails"))},
    {"version", boost::any(string("2020-10-20"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return GetJMeterReportDetailsResponse(callApi(params, req, runtime));
}

GetJMeterReportDetailsResponse Alibabacloud_PTS20201020::Client::getJMeterReportDetails(shared_ptr<GetJMeterReportDetailsRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
...
ListPtsReportsResponse Alibabacloud_PTS20201020::Client::listPtsReportsWithOptions(shared_ptr<ListPtsReportsRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("ListPtsReports"))},
    {"version", boost::any(string("2020-10-20"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return ListPtsReportsResponse(callApi(params, req, runtime));
}

ListPtsReportsResponse Alibabacloud_PTS20201020::Client::listPtsReports(shared_ptr<ListPtsReportsRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
