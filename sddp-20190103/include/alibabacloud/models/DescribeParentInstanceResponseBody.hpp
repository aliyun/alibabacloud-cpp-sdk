...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeParentInstanceResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeParentInstanceResponseBodyItems>) };
    inline vector<DescribeParentInstanceResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeParentInstanceResponseBodyItems>) };
    inline DescribeParentInstanceResponseBody& setItems(const vector<DescribeParentInstanceResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeParentInstanceResponseBody& setItems(vector<DescribeParentInstanceResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    // The assets.
    std::shared_ptr<vector<DescribeParentInstanceResponseBodyItems>> items_ = nullptr;
