...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDataLimitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDataLimitResponseBody) };
    inline ModifyDataLimitResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDataLimitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDataLimitResponseBody> body_ {};
  };
