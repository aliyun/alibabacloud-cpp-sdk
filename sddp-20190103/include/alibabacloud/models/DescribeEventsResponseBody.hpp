...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeEventsResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeEventsResponseBodyItems>) };
    inline vector<DescribeEventsResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeEventsResponseBodyItems>) };
    inline DescribeEventsResponseBody& setItems(const vector<DescribeEventsResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeEventsResponseBody& setItems(vector<DescribeEventsResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeEventsResponseBodyItems>> items_ = nullptr;
