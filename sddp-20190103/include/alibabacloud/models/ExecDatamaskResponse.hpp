...
namespace Models
{
  ...
  public:
    ...
    inline const ExecDatamaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExecDatamaskResponseBody) };
    inline ExecDatamaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ExecDatamaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExecDatamaskResponseBody> body_ {};
  };
