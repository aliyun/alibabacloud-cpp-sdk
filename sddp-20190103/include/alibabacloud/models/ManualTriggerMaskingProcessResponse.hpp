...
namespace Models
{
  ...
  public:
    ...
    inline const ManualTriggerMaskingProcessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ManualTriggerMaskingProcessResponseBody) };
    inline ManualTriggerMaskingProcessResponseBody getBody() { DARABONBA_PTR_GET(body_, ManualTriggerMaskingProcessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ManualTriggerMaskingProcessResponseBody> body_ {};
  };
