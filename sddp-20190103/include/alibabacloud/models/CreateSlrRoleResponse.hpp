...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSlrRoleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateSlrRoleResponseBody) };
    inline CreateSlrRoleResponseBody body() { DARABONBA_PTR_GET(body_, CreateSlrRoleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateSlrRoleResponseBody> body_ = nullptr;
  };
