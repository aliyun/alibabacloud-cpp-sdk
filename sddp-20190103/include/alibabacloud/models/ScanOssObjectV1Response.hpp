...
namespace Models
{
  ...
  public:
    ...
    inline const ScanOssObjectV1ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ScanOssObjectV1ResponseBody) };
    inline ScanOssObjectV1ResponseBody getBody() { DARABONBA_PTR_GET(body_, ScanOssObjectV1ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ScanOssObjectV1ResponseBody> body_ {};
  };
