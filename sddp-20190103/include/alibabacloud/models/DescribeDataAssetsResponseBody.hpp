...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDataAssetsResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeDataAssetsResponseBodyItems>) };
    inline vector<DescribeDataAssetsResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeDataAssetsResponseBodyItems>) };
    inline DescribeDataAssetsResponseBody& setItems(const vector<DescribeDataAssetsResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDataAssetsResponseBody& setItems(vector<DescribeDataAssetsResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDataAssetsResponseBodyItems>> items_ = nullptr;
