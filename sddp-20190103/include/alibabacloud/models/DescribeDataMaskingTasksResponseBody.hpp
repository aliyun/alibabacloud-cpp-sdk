...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDataMaskingTasksResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeDataMaskingTasksResponseBodyItems>) };
    inline vector<DescribeDataMaskingTasksResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeDataMaskingTasksResponseBodyItems>) };
    inline DescribeDataMaskingTasksResponseBody& setItems(const vector<DescribeDataMaskingTasksResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDataMaskingTasksResponseBody& setItems(vector<DescribeDataMaskingTasksResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDataMaskingTasksResponseBodyItems>> items_ = nullptr;
