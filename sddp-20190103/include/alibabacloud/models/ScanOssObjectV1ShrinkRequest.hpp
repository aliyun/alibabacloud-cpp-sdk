...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bucketName_ == nullptr
        && this->lang_ == nullptr && this->objectKeyListShrink_ == nullptr && this->serviceRegionId_ == nullptr && this->templateId_ == nullptr; };
    ...
    inline string getObjectKeyListShrink() const { DARABONBA_PTR_GET_DEFAULT(objectKeyListShrink_, "") };
