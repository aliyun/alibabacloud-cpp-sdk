...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeInstancesResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeInstancesResponseBodyItems>) };
    inline vector<DescribeInstancesResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeInstancesResponseBodyItems>) };
    inline DescribeInstancesResponseBody& setItems(const vector<DescribeInstancesResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeInstancesResponseBody& setItems(vector<DescribeInstancesResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    // The data assets.
    std::shared_ptr<vector<DescribeInstancesResponseBodyItems>> items_ = nullptr;
