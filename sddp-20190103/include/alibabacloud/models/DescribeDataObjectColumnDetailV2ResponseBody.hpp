...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDataObjectColumnDetailV2ResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeDataObjectColumnDetailV2ResponseBodyItems>) };
    inline vector<DescribeDataObjectColumnDetailV2ResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeDataObjectColumnDetailV2ResponseBodyItems>) };
    inline DescribeDataObjectColumnDetailV2ResponseBody& setItems(const vector<DescribeDataObjectColumnDetailV2ResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDataObjectColumnDetailV2ResponseBody& setItems(vector<DescribeDataObjectColumnDetailV2ResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDataObjectColumnDetailV2ResponseBodyItems>> items_ = nullptr;
