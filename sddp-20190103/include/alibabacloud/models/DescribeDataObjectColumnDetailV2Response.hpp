...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataObjectColumnDetailV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataObjectColumnDetailV2ResponseBody) };
    inline DescribeDataObjectColumnDetailV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDataObjectColumnDetailV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDataObjectColumnDetailV2ResponseBody> body_ {};
  };
