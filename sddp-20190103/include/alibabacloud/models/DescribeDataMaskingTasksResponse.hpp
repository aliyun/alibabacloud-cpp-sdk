...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataMaskingTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataMaskingTasksResponseBody) };
    inline DescribeDataMaskingTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDataMaskingTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDataMaskingTasksResponseBody> body_ {};
  };
