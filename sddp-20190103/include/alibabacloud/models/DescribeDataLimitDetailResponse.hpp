...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataLimitDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataLimitDetailResponseBody) };
    inline DescribeDataLimitDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDataLimitDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDataLimitDetailResponseBody> body_ {};
  };
