...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeRulesResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeRulesResponseBodyItems>) };
    inline vector<DescribeRulesResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeRulesResponseBodyItems>) };
    inline DescribeRulesResponseBody& setItems(const vector<DescribeRulesResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeRulesResponseBody& setItems(vector<DescribeRulesResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeRulesResponseBodyItems>> items_ = nullptr;
