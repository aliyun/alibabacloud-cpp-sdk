...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRiskLevelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRiskLevelsResponseBody) };
    inline DescribeRiskLevelsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRiskLevelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRiskLevelsResponseBody> body_ {};
  };
