...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDataLimitsResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeDataLimitsResponseBodyItems>) };
    inline vector<DescribeDataLimitsResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeDataLimitsResponseBodyItems>) };
    inline DescribeDataLimitsResponseBody& setItems(const vector<DescribeDataLimitsResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDataLimitsResponseBody& setItems(vector<DescribeDataLimitsResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    // The data assets.
    std::shared_ptr<vector<DescribeDataLimitsResponseBodyItems>> items_ = nullptr;
