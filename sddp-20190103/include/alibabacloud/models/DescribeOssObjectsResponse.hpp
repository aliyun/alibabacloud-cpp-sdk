...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOssObjectsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOssObjectsResponseBody) };
    inline DescribeOssObjectsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOssObjectsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOssObjectsResponseBody> body_ {};
  };
