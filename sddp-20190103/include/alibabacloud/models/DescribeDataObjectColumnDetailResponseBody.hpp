...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDataObjectColumnDetailResponseBody::Items> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeDataObjectColumnDetailResponseBody::Items>) };
    inline vector<DescribeDataObjectColumnDetailResponseBody::Items> getItems() { DARABONBA_PTR_GET(items_, vector<DescribeDataObjectColumnDetailResponseBody::Items>) };
    inline DescribeDataObjectColumnDetailResponseBody& setItems(const vector<DescribeDataObjectColumnDetailResponseBody::Items> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDataObjectColumnDetailResponseBody& setItems(vector<DescribeDataObjectColumnDetailResponseBody::Items> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
