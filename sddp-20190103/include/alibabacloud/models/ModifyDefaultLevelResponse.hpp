...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDefaultLevelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDefaultLevelResponseBody) };
    inline ModifyDefaultLevelResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDefaultLevelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDefaultLevelResponseBody> body_ {};
  };
