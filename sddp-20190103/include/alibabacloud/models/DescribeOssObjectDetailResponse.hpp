...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOssObjectDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOssObjectDetailResponseBody) };
    inline DescribeOssObjectDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOssObjectDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOssObjectDetailResponseBody> body_ {};
  };
