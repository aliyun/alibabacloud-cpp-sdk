...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDocTypesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDocTypesResponseBody) };
    inline DescribeDocTypesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDocTypesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDocTypesResponseBody> body_ {};
  };
