...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getObjectKeyList() const { DARABONBA_PTR_GET_CONST(objectKeyList_, vector<string>) };
    inline vector<string> getObjectKeyList() { DARABONBA_PTR_GET(objectKeyList_, vector<string>) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<string>> objectKeyList_ {};
