...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentPage_ == nullptr
        && return this->lang_ == nullptr && return this->name_ == nullptr && return this->pageSize_ == nullptr && return this->rangeId_ == nullptr && return this->riskLevels_ == nullptr
    ...
    inline int32_t rangeId() const { DARABONBA_PTR_GET_DEFAULT(rangeId_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> rangeId_ = nullptr;
