...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataMaskingRunHistoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataMaskingRunHistoryResponseBody) };
    inline DescribeDataMaskingRunHistoryResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDataMaskingRunHistoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDataMaskingRunHistoryResponseBody> body_ {};
  };
