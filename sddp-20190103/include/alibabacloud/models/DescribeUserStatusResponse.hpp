...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserStatusResponseBody) };
    inline DescribeUserStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUserStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserStatusResponseBody> body_ {};
  };
