...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeColumnsV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeColumnsV2ResponseBody) };
    inline DescribeColumnsV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeColumnsV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeColumnsV2ResponseBody> body_ {};
  };
