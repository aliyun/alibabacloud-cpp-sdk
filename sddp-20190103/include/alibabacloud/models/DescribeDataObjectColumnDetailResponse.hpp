...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataObjectColumnDetailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataObjectColumnDetailResponseBody) };
    inline DescribeDataObjectColumnDetailResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDataObjectColumnDetailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDataObjectColumnDetailResponseBody> body_ = nullptr;
  };
