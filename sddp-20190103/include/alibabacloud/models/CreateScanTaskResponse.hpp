...
namespace Models
{
  ...
  public:
    ...
    inline const CreateScanTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateScanTaskResponseBody) };
    inline CreateScanTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateScanTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateScanTaskResponseBody> body_ {};
  };
