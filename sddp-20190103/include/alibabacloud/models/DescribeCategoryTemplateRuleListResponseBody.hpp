...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCategoryTemplateRuleListResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeCategoryTemplateRuleListResponseBodyItems>) };
    inline vector<DescribeCategoryTemplateRuleListResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeCategoryTemplateRuleListResponseBodyItems>) };
    inline DescribeCategoryTemplateRuleListResponseBody& setItems(const vector<DescribeCategoryTemplateRuleListResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeCategoryTemplateRuleListResponseBody& setItems(vector<DescribeCategoryTemplateRuleListResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    // The list of rules.
    std::shared_ptr<vector<DescribeCategoryTemplateRuleListResponseBodyItems>> items_ = nullptr;
