...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->featureType_ == nullptr
        && return this->lang_ == nullptr && return this->parentTypeId_ == nullptr && return this->resourceId_ == nullptr && return this->status_ == nullptr; };
    ...
    inline int64_t parentTypeId() const { DARABONBA_PTR_GET_DEFAULT(parentTypeId_, 0L) };
    ...
    inline int32_t resourceId() const { DARABONBA_PTR_GET_DEFAULT(resourceId_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> parentTypeId_ = nullptr;
    ...
    std::shared_ptr<int32_t> resourceId_ = nullptr;
