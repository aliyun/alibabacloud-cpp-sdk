...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && this->nextToken_ == nullptr && this->regionId_ == nullptr && this->tagFilterKey_ == nullptr; };
    ...
    inline string getTagFilterKey() const { DARABONBA_PTR_GET_DEFAULT(tagFilterKey_, "") };
  ...
  protected:
    ...
    shared_ptr<string> tagFilterKey_ {};
  };
