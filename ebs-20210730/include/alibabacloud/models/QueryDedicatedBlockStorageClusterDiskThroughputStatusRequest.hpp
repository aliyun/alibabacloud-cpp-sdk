...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->qosRequestId_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline string getQosRequestId() const { DARABONBA_PTR_GET_DEFAULT(qosRequestId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> qosRequestId_ {};
