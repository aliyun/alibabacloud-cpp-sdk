...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnterpriseSnapshotPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEnterpriseSnapshotPolicyResponseBody) };
    inline DescribeEnterpriseSnapshotPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEnterpriseSnapshotPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEnterpriseSnapshotPolicyResponseBody> body_ {};
  };
