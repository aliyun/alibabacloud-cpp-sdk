...
namespace Models
{
  ...
  public:
    ...
    inline const ClearPairDrillResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ClearPairDrillResponseBody) };
    inline ClearPairDrillResponseBody getBody() { DARABONBA_PTR_GET(body_, ClearPairDrillResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ClearPairDrillResponseBody> body_ {};
  };
