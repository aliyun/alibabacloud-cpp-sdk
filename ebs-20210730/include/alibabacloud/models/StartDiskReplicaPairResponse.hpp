...
namespace Models
{
  ...
  public:
    ...
    inline const StartDiskReplicaPairResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartDiskReplicaPairResponseBody) };
    inline StartDiskReplicaPairResponseBody getBody() { DARABONBA_PTR_GET(body_, StartDiskReplicaPairResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartDiskReplicaPairResponseBody> body_ {};
  };
