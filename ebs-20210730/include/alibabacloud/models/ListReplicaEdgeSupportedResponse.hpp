...
namespace Models
{
  ...
  public:
    ...
    inline const ListReplicaEdgeSupportedResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListReplicaEdgeSupportedResponseBody) };
    inline ListReplicaEdgeSupportedResponseBody getBody() { DARABONBA_PTR_GET(body_, ListReplicaEdgeSupportedResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListReplicaEdgeSupportedResponseBody> body_ {};
  };
