...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeReplicaGroupDrillsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeReplicaGroupDrillsResponseBody) };
    inline DescribeReplicaGroupDrillsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeReplicaGroupDrillsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeReplicaGroupDrillsResponseBody> body_ {};
  };
