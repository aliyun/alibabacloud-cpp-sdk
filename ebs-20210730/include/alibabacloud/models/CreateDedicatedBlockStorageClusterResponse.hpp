...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDedicatedBlockStorageClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDedicatedBlockStorageClusterResponseBody) };
    inline CreateDedicatedBlockStorageClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDedicatedBlockStorageClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDedicatedBlockStorageClusterResponseBody> body_ {};
  };
