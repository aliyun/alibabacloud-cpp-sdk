...
namespace Models
{
  ...
  public:
    ...
    inline const GetReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetReportResponseBody) };
    inline GetReportResponseBody getBody() { DARABONBA_PTR_GET(body_, GetReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetReportResponseBody> body_ {};
  };
