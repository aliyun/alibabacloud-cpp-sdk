...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->description_ == nullptr && this->name_ == nullptr && this->regionId_ == nullptr && this->solutionInstanceId_ == nullptr; };
    ...
    inline string getSolutionInstanceId() const { DARABONBA_PTR_GET_DEFAULT(solutionInstanceId_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> solutionInstanceId_ {};
  };
