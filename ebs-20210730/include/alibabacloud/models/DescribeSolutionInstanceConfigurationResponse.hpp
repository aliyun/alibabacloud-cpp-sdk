...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSolutionInstanceConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSolutionInstanceConfigurationResponseBody) };
    inline DescribeSolutionInstanceConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSolutionInstanceConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSolutionInstanceConfigurationResponseBody> body_ {};
  };
