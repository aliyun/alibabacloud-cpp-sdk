...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribePairDrillsResponseBodyDrills> & drills() const { DARABONBA_PTR_GET_CONST(drills_, vector<DescribePairDrillsResponseBodyDrills>) };
    inline vector<DescribePairDrillsResponseBodyDrills> drills() { DARABONBA_PTR_GET(drills_, vector<DescribePairDrillsResponseBodyDrills>) };
    inline DescribePairDrillsResponseBody& setDrills(const vector<DescribePairDrillsResponseBodyDrills> & drills) { DARABONBA_PTR_SET_VALUE(drills_, drills) };
    inline DescribePairDrillsResponseBody& setDrills(vector<DescribePairDrillsResponseBodyDrills> && drills) { DARABONBA_PTR_SET_RVALUE(drills_, drills) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribePairDrillsResponseBodyDrills>> drills_ = nullptr;
