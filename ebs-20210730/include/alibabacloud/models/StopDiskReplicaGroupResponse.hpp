...
namespace Models
{
  ...
  public:
    ...
    inline const StopDiskReplicaGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopDiskReplicaGroupResponseBody) };
    inline StopDiskReplicaGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, StopDiskReplicaGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopDiskReplicaGroupResponseBody> body_ {};
  };
