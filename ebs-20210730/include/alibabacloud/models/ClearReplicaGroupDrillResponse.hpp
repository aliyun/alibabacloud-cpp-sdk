...
namespace Models
{
  ...
  public:
    ...
    inline const ClearReplicaGroupDrillResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ClearReplicaGroupDrillResponseBody) };
    inline ClearReplicaGroupDrillResponseBody getBody() { DARABONBA_PTR_GET(body_, ClearReplicaGroupDrillResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ClearReplicaGroupDrillResponseBody> body_ {};
  };
