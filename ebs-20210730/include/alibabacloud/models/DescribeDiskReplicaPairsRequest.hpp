...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && this->name_ == nullptr && this->nextToken_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->pairIds_ == nullptr
        && this->regionId_ == nullptr && this->replicaGroupId_ == nullptr && this->resourceGroupId_ == nullptr && this->site_ == nullptr && this->tag_ == nullptr; };
    ...
    inline string getPairIds() const { DARABONBA_PTR_GET_DEFAULT(pairIds_, "") };
    ...
    inline const vector<DescribeDiskReplicaPairsRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeDiskReplicaPairsRequest::Tag>) };
    inline vector<DescribeDiskReplicaPairsRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeDiskReplicaPairsRequest::Tag>) };
    inline DescribeDiskReplicaPairsRequest& setTag(const vector<DescribeDiskReplicaPairsRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeDiskReplicaPairsRequest& setTag(vector<DescribeDiskReplicaPairsRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeDiskReplicaPairsRequest::Tag>> tag_ {};
  };
