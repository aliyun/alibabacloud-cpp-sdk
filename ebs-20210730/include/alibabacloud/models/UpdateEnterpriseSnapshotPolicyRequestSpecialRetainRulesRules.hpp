...
#ifndef ALIBABACLOUD_MODELS_UPDATEENTERPRISESNAPSHOTPOLICYREQUESTSPECIALRETAINRULESRULES_HPP_
#define ALIBABACLOUD_MODELS_UPDATEENTERPRISESNAPSHOTPOLICYREQUESTSPECIALRETAINRULESRULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules& obj) { 
    ...
    UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules() = default ;
    UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules(const UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules &) = default ;
    UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules(UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules &&) = default ;
    UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules() = default ;
    UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules& operator=(const UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules &) = default ;
    UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules& operator=(UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules &&) = default ;
    ...
    inline UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules& setSpecialPeriodUnit(string specialPeriodUnit) { DARABONBA_PTR_SET_VALUE(specialPeriodUnit_, specialPeriodUnit) };
    ...
    inline UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules& setTimeInterval(int32_t timeInterval) { DARABONBA_PTR_SET_VALUE(timeInterval_, timeInterval) };
    ...
    inline UpdateEnterpriseSnapshotPolicyRequestSpecialRetainRulesRules& setTimeUnit(string timeUnit) { DARABONBA_PTR_SET_VALUE(timeUnit_, timeUnit) };
