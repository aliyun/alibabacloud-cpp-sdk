...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserTagKeysResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserTagKeysResponseBody) };
    inline DescribeUserTagKeysResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUserTagKeysResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserTagKeysResponseBody> body_ {};
  };
