...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDedicatedBlockStorageClustersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDedicatedBlockStorageClustersResponseBody) };
    inline DescribeDedicatedBlockStorageClustersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDedicatedBlockStorageClustersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDedicatedBlockStorageClustersResponseBody> body_ {};
  };
