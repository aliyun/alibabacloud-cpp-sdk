...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDiskReplicaPairResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDiskReplicaPairResponseBody) };
    inline ModifyDiskReplicaPairResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDiskReplicaPairResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDiskReplicaPairResponseBody> body_ {};
  };
