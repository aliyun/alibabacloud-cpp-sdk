...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDiskReplicaPairsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDiskReplicaPairsResponseBody) };
    inline DescribeDiskReplicaPairsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDiskReplicaPairsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDiskReplicaPairsResponseBody> body_ {};
  };
