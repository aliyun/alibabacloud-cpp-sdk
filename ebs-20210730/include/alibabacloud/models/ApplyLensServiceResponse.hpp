...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyLensServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApplyLensServiceResponseBody) };
    inline ApplyLensServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, ApplyLensServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApplyLensServiceResponseBody> body_ {};
  };
