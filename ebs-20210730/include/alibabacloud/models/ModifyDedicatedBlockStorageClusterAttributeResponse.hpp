...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDedicatedBlockStorageClusterAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDedicatedBlockStorageClusterAttributeResponseBody) };
    inline ModifyDedicatedBlockStorageClusterAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDedicatedBlockStorageClusterAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDedicatedBlockStorageClusterAttributeResponseBody> body_ {};
  };
