...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDedicatedBlockStorageClusterInventoryDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryDedicatedBlockStorageClusterInventoryDataResponseBody) };
    inline QueryDedicatedBlockStorageClusterInventoryDataResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryDedicatedBlockStorageClusterInventoryDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryDedicatedBlockStorageClusterInventoryDataResponseBody> body_ {};
  };
