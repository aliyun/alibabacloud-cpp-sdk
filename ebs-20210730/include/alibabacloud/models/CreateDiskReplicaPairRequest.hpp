...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bandwidth_ == nullptr
        && this->chargeType_ == nullptr && this->clientToken_ == nullptr && this->description_ == nullptr && this->destinationDiskId_ == nullptr && this->destinationRegionId_ == nullptr
        && this->destinationZoneId_ == nullptr && this->diskId_ == nullptr && this->enableRtc_ == nullptr && this->pairName_ == nullptr && this->period_ == nullptr
        && this->periodUnit_ == nullptr && this->RPO_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->sourceZoneId_ == nullptr
        && this->tag_ == nullptr; };
    ...
    inline const vector<CreateDiskReplicaPairRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateDiskReplicaPairRequest::Tag>) };
    inline vector<CreateDiskReplicaPairRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateDiskReplicaPairRequest::Tag>) };
    inline CreateDiskReplicaPairRequest& setTag(const vector<CreateDiskReplicaPairRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateDiskReplicaPairRequest& setTag(vector<CreateDiskReplicaPairRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<CreateDiskReplicaPairRequest::Tag>> tag_ {};
  };
