...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDiskReplicaGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDiskReplicaGroupResponseBody) };
    inline CreateDiskReplicaGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDiskReplicaGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDiskReplicaGroupResponseBody> body_ {};
  };
