...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserTagValuesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserTagValuesResponseBody) };
    inline DescribeUserTagValuesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUserTagValuesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserTagValuesResponseBody> body_ {};
  };
