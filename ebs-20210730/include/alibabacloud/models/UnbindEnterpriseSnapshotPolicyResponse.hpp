...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindEnterpriseSnapshotPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnbindEnterpriseSnapshotPolicyResponseBody) };
    inline UnbindEnterpriseSnapshotPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, UnbindEnterpriseSnapshotPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnbindEnterpriseSnapshotPolicyResponseBody> body_ {};
  };
