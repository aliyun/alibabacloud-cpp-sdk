...
#ifndef ALIBABACLOUD_MODELS_ADDDISKREPLICAPAIRREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDDISKREPLICAPAIRREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddDiskReplicaPairRequest& obj) { 
      DARABONBA_PTR_TO_JSON(ClientToken, clientToken_);
      DARABONBA_PTR_TO_JSON(RegionId, regionId_);
      DARABONBA_PTR_TO_JSON(ReplicaGroupId, replicaGroupId_);
      DARABONBA_PTR_TO_JSON(ReplicaPairId, replicaPairId_);
    };
    friend void from_json(const Darabonba::Json& j, AddDiskReplicaPairRequest& obj) { 
    ...
    AddDiskReplicaPairRequest() = default ;
    AddDiskReplicaPairRequest(const AddDiskReplicaPairRequest &) = default ;
    AddDiskReplicaPairRequest(AddDiskReplicaPairRequest &&) = default ;
    AddDiskReplicaPairRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddDiskReplicaPairRequest() = default ;
    AddDiskReplicaPairRequest& operator=(const AddDiskReplicaPairRequest &) = default ;
    AddDiskReplicaPairRequest& operator=(AddDiskReplicaPairRequest &&) = default ;
    ...
    inline AddDiskReplicaPairRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline AddDiskReplicaPairRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline AddDiskReplicaPairRequest& setReplicaGroupId(string replicaGroupId) { DARABONBA_PTR_SET_VALUE(replicaGroupId_, replicaGroupId) };
    ...
    inline AddDiskReplicaPairRequest& setReplicaPairId(string replicaPairId) { DARABONBA_PTR_SET_VALUE(replicaPairId_, replicaPairId) };
