...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aggreOps_ == nullptr
        && this->aggreOverLineOps_ == nullptr && this->dimensions_ == nullptr && this->endTime_ == nullptr && this->groupByLabelsShrink_ == nullptr && this->metricName_ == nullptr
    ...
    inline string getGroupByLabelsShrink() const { DARABONBA_PTR_GET_DEFAULT(groupByLabelsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> groupByLabelsShrink_ {};
