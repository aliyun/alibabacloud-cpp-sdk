...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLensMonitorDisksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLensMonitorDisksResponseBody) };
    inline DescribeLensMonitorDisksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLensMonitorDisksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLensMonitorDisksResponseBody> body_ {};
  };
