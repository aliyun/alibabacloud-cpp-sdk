...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteScriptResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteScriptResponseBody) };
    inline DeleteScriptResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteScriptResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteScriptResponseBody> body_ {};
  };
