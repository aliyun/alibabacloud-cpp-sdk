...
#ifndef ALIBABACLOUD_MODELS_LISTVOICEACCESSPROFILESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTVOICEACCESSPROFILESRESPONSEBODY_HPP_
...
namespace Models
{
  class ListVoiceAccessProfilesResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListVoiceAccessProfilesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListVoiceAccessProfilesResponseBody& obj) { 
    ...
    ListVoiceAccessProfilesResponseBody() = default ;
    ListVoiceAccessProfilesResponseBody(const ListVoiceAccessProfilesResponseBody &) = default ;
    ListVoiceAccessProfilesResponseBody(ListVoiceAccessProfilesResponseBody &&) = default ;
    ListVoiceAccessProfilesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListVoiceAccessProfilesResponseBody() = default ;
    ListVoiceAccessProfilesResponseBody& operator=(const ListVoiceAccessProfilesResponseBody &) = default ;
    ListVoiceAccessProfilesResponseBody& operator=(ListVoiceAccessProfilesResponseBody &&) = default ;
    ...
    inline ListVoiceAccessProfilesResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListVoiceAccessProfilesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListVoiceAccessProfilesResponseBody::Data) };
    inline ListVoiceAccessProfilesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListVoiceAccessProfilesResponseBody::Data) };
    inline ListVoiceAccessProfilesResponseBody& setData(const ListVoiceAccessProfilesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListVoiceAccessProfilesResponseBody& setData(ListVoiceAccessProfilesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListVoiceAccessProfilesResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListVoiceAccessProfilesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListVoiceAccessProfilesResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline ListVoiceAccessProfilesResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
    ...
    inline ListVoiceAccessProfilesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListVoiceAccessProfilesResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
