...
namespace Models
{
  ...
  public:
    ...
    inline UpdateInstanceResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline UpdateInstanceResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UpdateInstanceResponseBody& setParams(const vector<string> & params) { DARABONBA_PTR_SET_VALUE(params_, params) };
    inline UpdateInstanceResponseBody& setParams(vector<string> && params) { DARABONBA_PTR_SET_RVALUE(params_, params) };
