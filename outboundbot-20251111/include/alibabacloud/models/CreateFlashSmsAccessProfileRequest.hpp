...
#ifndef ALIBABACLOUD_MODELS_CREATEFLASHSMSACCESSPROFILEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEFLASHSMSACCESSPROFILEREQUEST_HPP_
...
namespace Models
{
  class CreateFlashSmsAccessProfileRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateFlashSmsAccessProfileRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AccessProfile, accessProfile_);
      DARABONBA_PTR_TO_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_TO_JSON(ProviderId, providerId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateFlashSmsAccessProfileRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessProfile, accessProfile_);
      DARABONBA_PTR_FROM_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_FROM_JSON(ProviderId, providerId_);
    };
    CreateFlashSmsAccessProfileRequest() = default ;
    CreateFlashSmsAccessProfileRequest(const CreateFlashSmsAccessProfileRequest &) = default ;
    CreateFlashSmsAccessProfileRequest(CreateFlashSmsAccessProfileRequest &&) = default ;
    CreateFlashSmsAccessProfileRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateFlashSmsAccessProfileRequest() = default ;
    CreateFlashSmsAccessProfileRequest& operator=(const CreateFlashSmsAccessProfileRequest &) = default ;
    CreateFlashSmsAccessProfileRequest& operator=(CreateFlashSmsAccessProfileRequest &&) = default ;
    ...
    inline const CreateFlashSmsAccessProfileRequest::AccessProfile & getAccessProfile() const { DARABONBA_PTR_GET_CONST(accessProfile_, CreateFlashSmsAccessProfileRequest::AccessProfile) };
    inline CreateFlashSmsAccessProfileRequest::AccessProfile getAccessProfile() { DARABONBA_PTR_GET(accessProfile_, CreateFlashSmsAccessProfileRequest::AccessProfile) };
    inline CreateFlashSmsAccessProfileRequest& setAccessProfile(const CreateFlashSmsAccessProfileRequest::AccessProfile & accessProfile) { DARABONBA_PTR_SET_VALUE(accessProfile_, accessProfile) };
    inline CreateFlashSmsAccessProfileRequest& setAccessProfile(CreateFlashSmsAccessProfileRequest::AccessProfile && accessProfile) { DARABONBA_PTR_SET_RVALUE(accessProfile_, accessProfile) };
    ...
    inline CreateFlashSmsAccessProfileRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline CreateFlashSmsAccessProfileRequest& setProviderId(string providerId) { DARABONBA_PTR_SET_VALUE(providerId_, providerId) };


  protected:
    // The access configuration.
    shared_ptr<CreateFlashSmsAccessProfileRequest::AccessProfile> accessProfile_ {};
    // The instance ID.
