...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attemptOrder_ == nullptr
        && this->callableTime_ == nullptr && this->caseFileKey_ == nullptr && this->casesShrink_ == nullptr && this->dialingTimeoutSeconds_ == nullptr && this->endTime_ == nullptr
        ...
        && this->minAttemptInterval_ == nullptr && this->name_ == nullptr && this->numbersShrink_ == nullptr && this->redialRestrictions_ == nullptr && this->runUntilEndTime_ == nullptr
    ...
    inline CreateCampaignShrinkRequest& setAttemptOrder(string attemptOrder) { DARABONBA_PTR_SET_VALUE(attemptOrder_, attemptOrder) };
    ...
    inline CreateCampaignShrinkRequest& setCasesShrink(string casesShrink) { DARABONBA_PTR_SET_VALUE(casesShrink_, casesShrink) };
    ...
    inline CreateCampaignShrinkRequest& setDialingTimeoutSeconds(int32_t dialingTimeoutSeconds) { DARABONBA_PTR_SET_VALUE(dialingTimeoutSeconds_, dialingTimeoutSeconds) };
    ...
    inline CreateCampaignShrinkRequest& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline CreateCampaignShrinkRequest& setFixedQuota(int32_t fixedQuota) { DARABONBA_PTR_SET_VALUE(fixedQuota_, fixedQuota) };
    ...
    inline CreateCampaignShrinkRequest& setHolidayRestricted(bool holidayRestricted) { DARABONBA_PTR_SET_VALUE(holidayRestricted_, holidayRestricted) };
    ...
    inline CreateCampaignShrinkRequest& setMaxAttemptCount(int32_t maxAttemptCount) { DARABONBA_PTR_SET_VALUE(maxAttemptCount_, maxAttemptCount) };
    ...
    inline CreateCampaignShrinkRequest& setMinAttemptInterval(int32_t minAttemptInterval) { DARABONBA_PTR_SET_VALUE(minAttemptInterval_, minAttemptInterval) };
    ...
    inline CreateCampaignShrinkRequest& setNumbersShrink(string numbersShrink) { DARABONBA_PTR_SET_VALUE(numbersShrink_, numbersShrink) };
    ...
    inline CreateCampaignShrinkRequest& setRedialRestrictions(string redialRestrictions) { DARABONBA_PTR_SET_VALUE(redialRestrictions_, redialRestrictions) };
    ...
    inline CreateCampaignShrinkRequest& setRunUntilEndTime(bool runUntilEndTime) { DARABONBA_PTR_SET_VALUE(runUntilEndTime_, runUntilEndTime) };
    ...
    inline CreateCampaignShrinkRequest& setScriptId(string scriptId) { DARABONBA_PTR_SET_VALUE(scriptId_, scriptId) };
    ...
    inline CreateCampaignShrinkRequest& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline CreateCampaignShrinkRequest& setWeight(int32_t weight) { DARABONBA_PTR_SET_VALUE(weight_, weight) };
