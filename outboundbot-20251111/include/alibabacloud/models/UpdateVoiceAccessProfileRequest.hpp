  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->accessKey_ == nullptr
        ...
        && this->secretId_ == nullptr && this->secretKey_ == nullptr && this->ttsApiKey_ == nullptr; };
      ...
      inline Profile& setSecretId(string secretId) { DARABONBA_PTR_SET_VALUE(secretId_, secretId) };
      ...
      inline Profile& setSecretKey(string secretKey) { DARABONBA_PTR_SET_VALUE(secretKey_, secretKey) };
