...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instanceId_ == nullptr
        && this->interactionConfigShrink_ == nullptr && this->labelConfigsShrink_ == nullptr && this->scriptId_ == nullptr && this->scriptProfileShrink_ == nullptr && this->sourceVersionId_ == nullptr
    ...
    inline CreateScriptVersionShrinkRequest& setLabelConfigsShrink(string labelConfigsShrink) { DARABONBA_PTR_SET_VALUE(labelConfigsShrink_, labelConfigsShrink) };
