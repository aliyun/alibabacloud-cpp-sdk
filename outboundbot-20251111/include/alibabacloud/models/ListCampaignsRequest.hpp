...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListCampaignsRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(PlannedStartTimeFrom, plannedStartTimeFrom_);
      DARABONBA_PTR_TO_JSON(PlannedStartTimeTo, plannedStartTimeTo_);
    ...
    friend void from_json(const Darabonba::Json& j, ListCampaignsRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(PlannedStartTimeFrom, plannedStartTimeFrom_);
      DARABONBA_PTR_FROM_JSON(PlannedStartTimeTo, plannedStartTimeTo_);
    ...
    virtual bool empty() const override { return this->actualStartTimeFrom_ == nullptr
        ...
        && this->plannedStartTimeFrom_ == nullptr && this->plannedStartTimeTo_ == nullptr && this->state_ == nullptr; };
    ...
    inline ListCampaignsRequest& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListCampaignsRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };


    // plannedStartTimeFrom Field Functions 
    bool hasPlannedStartTimeFrom() const { return this->plannedStartTimeFrom_ != nullptr;};
    void deletePlannedStartTimeFrom() { this->plannedStartTimeFrom_ = nullptr;};
    inline string getPlannedStartTimeFrom() const { DARABONBA_PTR_GET_DEFAULT(plannedStartTimeFrom_, "") };
    inline ListCampaignsRequest& setPlannedStartTimeFrom(string plannedStartTimeFrom) { DARABONBA_PTR_SET_VALUE(plannedStartTimeFrom_, plannedStartTimeFrom) };


    // plannedStartTimeTo Field Functions 
    bool hasPlannedStartTimeTo() const { return this->plannedStartTimeTo_ != nullptr;};
    void deletePlannedStartTimeTo() { this->plannedStartTimeTo_ = nullptr;};
    inline string getPlannedStartTimeTo() const { DARABONBA_PTR_GET_DEFAULT(plannedStartTimeTo_, "") };
    inline ListCampaignsRequest& setPlannedStartTimeTo(string plannedStartTimeTo) { DARABONBA_PTR_SET_VALUE(plannedStartTimeTo_, plannedStartTimeTo) };
  ...
  protected:
    ...
    shared_ptr<string> plannedStartTimeFrom_ {};
    // The latest planned start time.
    shared_ptr<string> plannedStartTimeTo_ {};
