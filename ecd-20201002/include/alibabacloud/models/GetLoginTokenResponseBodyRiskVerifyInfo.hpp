...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->email_ == nullptr
        && return this->lastLockDuration_ == nullptr && return this->locked_ == nullptr && return this->phone_ == nullptr; };
    ...
    inline GetLoginTokenResponseBodyRiskVerifyInfo& setLocked(string locked) { DARABONBA_PTR_SET_VALUE(locked_, locked) };
