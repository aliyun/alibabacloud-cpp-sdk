...
namespace Models
{
  ...
  public:
    ...
    inline const ResetSnapshotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResetSnapshotResponseBody) };
    inline ResetSnapshotResponseBody getBody() { DARABONBA_PTR_GET(body_, ResetSnapshotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResetSnapshotResponseBody> body_ {};
  };
