...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEGLOBALDESKTOPSRESPONSEBODYDESKTOPSDESKTOPTIMERS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEGLOBALDESKTOPSRESPONSEBODYDESKTOPSDESKTOPTIMERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& obj) { 
    ...
    DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers() = default ;
    DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers(const DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers &) = default ;
    DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers(DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers &&) = default ;
    DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers() = default ;
    DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& operator=(const DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers &) = default ;
    DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& operator=(DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers &&) = default ;
    ...
    inline DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& setAllowClientSetting(bool allowClientSetting) { DARABONBA_PTR_SET_VALUE(allowClientSetting_, allowClientSetting) };
    ...
    inline DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& setCronExpression(string cronExpression) { DARABONBA_PTR_SET_VALUE(cronExpression_, cronExpression) };
    ...
    inline DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& setEnforce(bool enforce) { DARABONBA_PTR_SET_VALUE(enforce_, enforce) };
    ...
    inline DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& setExecutionTime(string executionTime) { DARABONBA_PTR_SET_VALUE(executionTime_, executionTime) };
    ...
    inline DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& setInterval(int32_t interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& setOperationType(string operationType) { DARABONBA_PTR_SET_VALUE(operationType_, operationType) };
    ...
    inline DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& setResetType(string resetType) { DARABONBA_PTR_SET_VALUE(resetType_, resetType) };
    ...
    inline DescribeGlobalDesktopsResponseBodyDesktopsDesktopTimers& setTimerType(string timerType) { DARABONBA_PTR_SET_VALUE(timerType_, timerType) };
