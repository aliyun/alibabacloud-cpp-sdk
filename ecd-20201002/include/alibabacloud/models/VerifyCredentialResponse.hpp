...
namespace Models
{
  ...
  public:
    ...
    inline const VerifyCredentialResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, VerifyCredentialResponseBody) };
    inline VerifyCredentialResponseBody getBody() { DARABONBA_PTR_GET(body_, VerifyCredentialResponseBody) };
  ...
  protected:
    ...
    shared_ptr<VerifyCredentialResponseBody> body_ {};
  };
