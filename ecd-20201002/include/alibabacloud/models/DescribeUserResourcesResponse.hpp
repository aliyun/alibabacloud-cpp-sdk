...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserResourcesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserResourcesResponseBody) };
    inline DescribeUserResourcesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeUserResourcesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeUserResourcesResponseBody> body_ = nullptr;
  };
