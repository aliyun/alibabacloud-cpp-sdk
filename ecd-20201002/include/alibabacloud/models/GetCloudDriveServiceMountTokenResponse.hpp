...
namespace Models
{
  ...
  public:
    ...
    inline const GetCloudDriveServiceMountTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCloudDriveServiceMountTokenResponseBody) };
    inline GetCloudDriveServiceMountTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCloudDriveServiceMountTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCloudDriveServiceMountTokenResponseBody> body_ {};
  };
