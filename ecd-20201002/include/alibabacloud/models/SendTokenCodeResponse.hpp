...
namespace Models
{
  ...
  public:
    ...
    inline const SendTokenCodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendTokenCodeResponseBody) };
    inline SendTokenCodeResponseBody getBody() { DARABONBA_PTR_GET(body_, SendTokenCodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendTokenCodeResponseBody> body_ {};
  };
