...
namespace Models
{
  ...
  public:
    ...
    inline const IsKeepAliveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IsKeepAliveResponseBody) };
    inline IsKeepAliveResponseBody getBody() { DARABONBA_PTR_GET(body_, IsKeepAliveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IsKeepAliveResponseBody> body_ {};
  };
