...
namespace Models
{
  ...
  public:
    ...
    inline const StopRecordContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopRecordContentResponseBody) };
    inline StopRecordContentResponseBody getBody() { DARABONBA_PTR_GET(body_, StopRecordContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopRecordContentResponseBody> body_ {};
  };
