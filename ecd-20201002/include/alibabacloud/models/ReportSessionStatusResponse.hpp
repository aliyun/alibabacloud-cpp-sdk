...
namespace Models
{
  ...
  public:
    ...
    inline const ReportSessionStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReportSessionStatusResponseBody) };
    inline ReportSessionStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, ReportSessionStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReportSessionStatusResponseBody> body_ {};
  };
