...
namespace Models
{
  ...
  public:
    ...
    inline ListProjectsRequest& setLabelSelector(const vector<string> & labelSelector) { DARABONBA_PTR_SET_VALUE(labelSelector_, labelSelector) };
    inline ListProjectsRequest& setLabelSelector(vector<string> && labelSelector) { DARABONBA_PTR_SET_RVALUE(labelSelector_, labelSelector) };
    ...
    inline ListProjectsRequest& setPageNumber(int64_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListProjectsRequest& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
