...
namespace Models
{
  ...
  public:
    ...
    inline CreateArtifactResponse& setBody(const Artifact & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CreateArtifactResponse& setBody(Artifact && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
