...
#ifndef ALIBABACLOUD_MODELS_DEPLOYVLLMMODELINPUTLOGCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYVLLMMODELINPUTLOGCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeployVllmModelInputLogConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeployVllmModelInputLogConfig& obj) { 
    ...
    DeployVllmModelInputLogConfig() = default ;
    DeployVllmModelInputLogConfig(const DeployVllmModelInputLogConfig &) = default ;
    DeployVllmModelInputLogConfig(DeployVllmModelInputLogConfig &&) = default ;
    DeployVllmModelInputLogConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeployVllmModelInputLogConfig() = default ;
    DeployVllmModelInputLogConfig& operator=(const DeployVllmModelInputLogConfig &) = default ;
    DeployVllmModelInputLogConfig& operator=(DeployVllmModelInputLogConfig &&) = default ;
    ...
    inline DeployVllmModelInputLogConfig& setEnableInstanceMetrics(bool enableInstanceMetrics) { DARABONBA_PTR_SET_VALUE(enableInstanceMetrics_, enableInstanceMetrics) };
    ...
    inline DeployVllmModelInputLogConfig& setEnableRequestMetrics(bool enableRequestMetrics) { DARABONBA_PTR_SET_VALUE(enableRequestMetrics_, enableRequestMetrics) };
    ...
    inline DeployVllmModelInputLogConfig& setLogBeginRule(string logBeginRule) { DARABONBA_PTR_SET_VALUE(logBeginRule_, logBeginRule) };
    ...
    inline DeployVllmModelInputLogConfig& setLogstore(string logstore) { DARABONBA_PTR_SET_VALUE(logstore_, logstore) };
    ...
    inline DeployVllmModelInputLogConfig& setProject(string project) { DARABONBA_PTR_SET_VALUE(project_, project) };
