...
namespace Models
{
  ...
  public:
    ...
    inline GetPipelineResponse& setBody(const Pipeline & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline GetPipelineResponse& setBody(Pipeline && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
