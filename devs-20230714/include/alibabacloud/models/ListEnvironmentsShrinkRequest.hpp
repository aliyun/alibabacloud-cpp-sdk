...
namespace Models
{
  ...
  public:
    ...
    inline ListEnvironmentsShrinkRequest& setKeyword(string keyword) { DARABONBA_PTR_SET_VALUE(keyword_, keyword) };
    ...
    inline ListEnvironmentsShrinkRequest& setLabelSelectorShrink(string labelSelectorShrink) { DARABONBA_PTR_SET_VALUE(labelSelectorShrink_, labelSelectorShrink) };
    ...
    inline ListEnvironmentsShrinkRequest& setPageNumber(int64_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListEnvironmentsShrinkRequest& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
