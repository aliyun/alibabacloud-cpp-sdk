...
#ifndef ALIBABACLOUD_MODELS_DEPLOYTENSORRTMODELINPUTMODELCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYTENSORRTMODELINPUTMODELCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeployTensorRtModelInputModelConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeployTensorRtModelInputModelConfig& obj) { 
    ...
    DeployTensorRtModelInputModelConfig() = default ;
    DeployTensorRtModelInputModelConfig(const DeployTensorRtModelInputModelConfig &) = default ;
    DeployTensorRtModelInputModelConfig(DeployTensorRtModelInputModelConfig &&) = default ;
    DeployTensorRtModelInputModelConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeployTensorRtModelInputModelConfig() = default ;
    DeployTensorRtModelInputModelConfig& operator=(const DeployTensorRtModelInputModelConfig &) = default ;
    DeployTensorRtModelInputModelConfig& operator=(DeployTensorRtModelInputModelConfig &&) = default ;
    ...
    inline DeployTensorRtModelInputModelConfig& setFramework(string framework) { DARABONBA_PTR_SET_VALUE(framework_, framework) };
    ...
    inline DeployTensorRtModelInputModelConfig& setMultiModelConfig(const vector<Models::ModelConfig> & multiModelConfig) { DARABONBA_PTR_SET_VALUE(multiModelConfig_, multiModelConfig) };
    inline DeployTensorRtModelInputModelConfig& setMultiModelConfig(vector<Models::ModelConfig> && multiModelConfig) { DARABONBA_PTR_SET_RVALUE(multiModelConfig_, multiModelConfig) };
    ...
    inline DeployTensorRtModelInputModelConfig& setPrefix(string prefix) { DARABONBA_PTR_SET_VALUE(prefix_, prefix) };
    ...
    inline DeployTensorRtModelInputModelConfig& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline DeployTensorRtModelInputModelConfig& setSrcModelScopeModelID(string srcModelScopeModelID) { DARABONBA_PTR_SET_VALUE(srcModelScopeModelID_, srcModelScopeModelID) };
    ...
    inline DeployTensorRtModelInputModelConfig& setSrcModelScopeModelRevision(string srcModelScopeModelRevision) { DARABONBA_PTR_SET_VALUE(srcModelScopeModelRevision_, srcModelScopeModelRevision) };
    ...
    inline DeployTensorRtModelInputModelConfig& setSrcModelScopeToken(string srcModelScopeToken) { DARABONBA_PTR_SET_VALUE(srcModelScopeToken_, srcModelScopeToken) };
    ...
    inline DeployTensorRtModelInputModelConfig& setSrcOssBucket(string srcOssBucket) { DARABONBA_PTR_SET_VALUE(srcOssBucket_, srcOssBucket) };
    ...
    inline DeployTensorRtModelInputModelConfig& setSrcOssPath(string srcOssPath) { DARABONBA_PTR_SET_VALUE(srcOssPath_, srcOssPath) };
    ...
    inline DeployTensorRtModelInputModelConfig& setSrcOssRegion(string srcOssRegion) { DARABONBA_PTR_SET_VALUE(srcOssRegion_, srcOssRegion) };
    ...
    inline DeployTensorRtModelInputModelConfig& setSyncStrategy(string syncStrategy) { DARABONBA_PTR_SET_VALUE(syncStrategy_, syncStrategy) };
