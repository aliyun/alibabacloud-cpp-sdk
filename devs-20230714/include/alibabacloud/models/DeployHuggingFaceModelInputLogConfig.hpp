...
#ifndef ALIBABACLOUD_MODELS_DEPLOYHUGGINGFACEMODELINPUTLOGCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYHUGGINGFACEMODELINPUTLOGCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeployHuggingFaceModelInputLogConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeployHuggingFaceModelInputLogConfig& obj) { 
    ...
    DeployHuggingFaceModelInputLogConfig() = default ;
    DeployHuggingFaceModelInputLogConfig(const DeployHuggingFaceModelInputLogConfig &) = default ;
    DeployHuggingFaceModelInputLogConfig(DeployHuggingFaceModelInputLogConfig &&) = default ;
    DeployHuggingFaceModelInputLogConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeployHuggingFaceModelInputLogConfig() = default ;
    DeployHuggingFaceModelInputLogConfig& operator=(const DeployHuggingFaceModelInputLogConfig &) = default ;
    DeployHuggingFaceModelInputLogConfig& operator=(DeployHuggingFaceModelInputLogConfig &&) = default ;
    ...
    inline DeployHuggingFaceModelInputLogConfig& setEnableInstanceMetrics(bool enableInstanceMetrics) { DARABONBA_PTR_SET_VALUE(enableInstanceMetrics_, enableInstanceMetrics) };
    ...
    inline DeployHuggingFaceModelInputLogConfig& setEnableRequestMetrics(bool enableRequestMetrics) { DARABONBA_PTR_SET_VALUE(enableRequestMetrics_, enableRequestMetrics) };
    ...
    inline DeployHuggingFaceModelInputLogConfig& setLogBeginRule(string logBeginRule) { DARABONBA_PTR_SET_VALUE(logBeginRule_, logBeginRule) };
    ...
    inline DeployHuggingFaceModelInputLogConfig& setLogstore(string logstore) { DARABONBA_PTR_SET_VALUE(logstore_, logstore) };
    ...
    inline DeployHuggingFaceModelInputLogConfig& setProject(string project) { DARABONBA_PTR_SET_VALUE(project_, project) };
