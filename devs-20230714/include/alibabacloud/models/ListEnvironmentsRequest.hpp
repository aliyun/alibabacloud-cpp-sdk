...
namespace Models
{
  ...
  public:
    ...
    inline ListEnvironmentsRequest& setKeyword(string keyword) { DARABONBA_PTR_SET_VALUE(keyword_, keyword) };
    ...
    inline ListEnvironmentsRequest& setLabelSelector(const vector<string> & labelSelector) { DARABONBA_PTR_SET_VALUE(labelSelector_, labelSelector) };
    inline ListEnvironmentsRequest& setLabelSelector(vector<string> && labelSelector) { DARABONBA_PTR_SET_RVALUE(labelSelector_, labelSelector) };
    ...
    inline ListEnvironmentsRequest& setPageNumber(int64_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListEnvironmentsRequest& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
