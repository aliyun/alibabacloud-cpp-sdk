...
#ifndef ALIBABACLOUD_MODELS_DEPLOYVLLMMODELINPUTHTTPTRIGGERTRIGGERCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYVLLMMODELINPUTHTTPTRIGGERTRIGGERCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeployVllmModelInputHttpTriggerTriggerConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeployVllmModelInputHttpTriggerTriggerConfig& obj) { 
    ...
    DeployVllmModelInputHttpTriggerTriggerConfig() = default ;
    DeployVllmModelInputHttpTriggerTriggerConfig(const DeployVllmModelInputHttpTriggerTriggerConfig &) = default ;
    DeployVllmModelInputHttpTriggerTriggerConfig(DeployVllmModelInputHttpTriggerTriggerConfig &&) = default ;
    DeployVllmModelInputHttpTriggerTriggerConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeployVllmModelInputHttpTriggerTriggerConfig() = default ;
    DeployVllmModelInputHttpTriggerTriggerConfig& operator=(const DeployVllmModelInputHttpTriggerTriggerConfig &) = default ;
    DeployVllmModelInputHttpTriggerTriggerConfig& operator=(DeployVllmModelInputHttpTriggerTriggerConfig &&) = default ;
    ...
    inline DeployVllmModelInputHttpTriggerTriggerConfig& setAuthConfig(string authConfig) { DARABONBA_PTR_SET_VALUE(authConfig_, authConfig) };
    ...
    inline DeployVllmModelInputHttpTriggerTriggerConfig& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline DeployVllmModelInputHttpTriggerTriggerConfig& setDisableURLInternet(bool disableURLInternet) { DARABONBA_PTR_SET_VALUE(disableURLInternet_, disableURLInternet) };
    ...
    inline DeployVllmModelInputHttpTriggerTriggerConfig& setDsableURLInternet(bool dsableURLInternet) { DARABONBA_PTR_SET_VALUE(dsableURLInternet_, dsableURLInternet) };
    ...
    inline DeployVllmModelInputHttpTriggerTriggerConfig& setMethods(const vector<string> & methods) { DARABONBA_PTR_SET_VALUE(methods_, methods) };
    inline DeployVllmModelInputHttpTriggerTriggerConfig& setMethods(vector<string> && methods) { DARABONBA_PTR_SET_RVALUE(methods_, methods) };
