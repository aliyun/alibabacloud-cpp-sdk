...
#ifndef ALIBABACLOUD_MODELS_DEPLOYTENSORRTMODELINPUTLOGCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYTENSORRTMODELINPUTLOGCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeployTensorRtModelInputLogConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeployTensorRtModelInputLogConfig& obj) { 
    ...
    DeployTensorRtModelInputLogConfig() = default ;
    DeployTensorRtModelInputLogConfig(const DeployTensorRtModelInputLogConfig &) = default ;
    DeployTensorRtModelInputLogConfig(DeployTensorRtModelInputLogConfig &&) = default ;
    DeployTensorRtModelInputLogConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeployTensorRtModelInputLogConfig() = default ;
    DeployTensorRtModelInputLogConfig& operator=(const DeployTensorRtModelInputLogConfig &) = default ;
    DeployTensorRtModelInputLogConfig& operator=(DeployTensorRtModelInputLogConfig &&) = default ;
    ...
    inline DeployTensorRtModelInputLogConfig& setEnableInstanceMetrics(bool enableInstanceMetrics) { DARABONBA_PTR_SET_VALUE(enableInstanceMetrics_, enableInstanceMetrics) };
    ...
    inline DeployTensorRtModelInputLogConfig& setEnableRequestMetrics(bool enableRequestMetrics) { DARABONBA_PTR_SET_VALUE(enableRequestMetrics_, enableRequestMetrics) };
    ...
    inline DeployTensorRtModelInputLogConfig& setLogBeginRule(string logBeginRule) { DARABONBA_PTR_SET_VALUE(logBeginRule_, logBeginRule) };
    ...
    inline DeployTensorRtModelInputLogConfig& setLogstore(string logstore) { DARABONBA_PTR_SET_VALUE(logstore_, logstore) };
    ...
    inline DeployTensorRtModelInputLogConfig& setProject(string project) { DARABONBA_PTR_SET_VALUE(project_, project) };
