...
#ifndef ALIBABACLOUD_MODELS_DEPLOYTENSORRTMODELINPUTHTTPTRIGGERTRIGGERCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYTENSORRTMODELINPUTHTTPTRIGGERTRIGGERCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeployTensorRtModelInputHttpTriggerTriggerConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeployTensorRtModelInputHttpTriggerTriggerConfig& obj) { 
    ...
    DeployTensorRtModelInputHttpTriggerTriggerConfig() = default ;
    DeployTensorRtModelInputHttpTriggerTriggerConfig(const DeployTensorRtModelInputHttpTriggerTriggerConfig &) = default ;
    DeployTensorRtModelInputHttpTriggerTriggerConfig(DeployTensorRtModelInputHttpTriggerTriggerConfig &&) = default ;
    DeployTensorRtModelInputHttpTriggerTriggerConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeployTensorRtModelInputHttpTriggerTriggerConfig() = default ;
    DeployTensorRtModelInputHttpTriggerTriggerConfig& operator=(const DeployTensorRtModelInputHttpTriggerTriggerConfig &) = default ;
    DeployTensorRtModelInputHttpTriggerTriggerConfig& operator=(DeployTensorRtModelInputHttpTriggerTriggerConfig &&) = default ;
    ...
    inline DeployTensorRtModelInputHttpTriggerTriggerConfig& setAuthConfig(string authConfig) { DARABONBA_PTR_SET_VALUE(authConfig_, authConfig) };
    ...
    inline DeployTensorRtModelInputHttpTriggerTriggerConfig& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline DeployTensorRtModelInputHttpTriggerTriggerConfig& setDisableURLInternet(bool disableURLInternet) { DARABONBA_PTR_SET_VALUE(disableURLInternet_, disableURLInternet) };
    ...
    inline DeployTensorRtModelInputHttpTriggerTriggerConfig& setDsableURLInternet(bool dsableURLInternet) { DARABONBA_PTR_SET_VALUE(dsableURLInternet_, dsableURLInternet) };
    ...
    inline DeployTensorRtModelInputHttpTriggerTriggerConfig& setMethods(const vector<string> & methods) { DARABONBA_PTR_SET_VALUE(methods_, methods) };
    inline DeployTensorRtModelInputHttpTriggerTriggerConfig& setMethods(vector<string> && methods) { DARABONBA_PTR_SET_RVALUE(methods_, methods) };
