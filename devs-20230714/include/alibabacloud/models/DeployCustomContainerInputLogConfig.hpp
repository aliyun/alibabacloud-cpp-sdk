...
#ifndef ALIBABACLOUD_MODELS_DEPLOYCUSTOMCONTAINERINPUTLOGCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYCUSTOMCONTAINERINPUTLOGCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeployCustomContainerInputLogConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeployCustomContainerInputLogConfig& obj) { 
    ...
    DeployCustomContainerInputLogConfig() = default ;
    DeployCustomContainerInputLogConfig(const DeployCustomContainerInputLogConfig &) = default ;
    DeployCustomContainerInputLogConfig(DeployCustomContainerInputLogConfig &&) = default ;
    DeployCustomContainerInputLogConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeployCustomContainerInputLogConfig() = default ;
    DeployCustomContainerInputLogConfig& operator=(const DeployCustomContainerInputLogConfig &) = default ;
    DeployCustomContainerInputLogConfig& operator=(DeployCustomContainerInputLogConfig &&) = default ;
    ...
    inline DeployCustomContainerInputLogConfig& setEnableInstanceMetrics(bool enableInstanceMetrics) { DARABONBA_PTR_SET_VALUE(enableInstanceMetrics_, enableInstanceMetrics) };
    ...
    inline DeployCustomContainerInputLogConfig& setEnableRequestMetrics(bool enableRequestMetrics) { DARABONBA_PTR_SET_VALUE(enableRequestMetrics_, enableRequestMetrics) };
    ...
    inline DeployCustomContainerInputLogConfig& setLogBeginRule(string logBeginRule) { DARABONBA_PTR_SET_VALUE(logBeginRule_, logBeginRule) };
    ...
    inline DeployCustomContainerInputLogConfig& setLogstore(string logstore) { DARABONBA_PTR_SET_VALUE(logstore_, logstore) };
    ...
    inline DeployCustomContainerInputLogConfig& setProject(string project) { DARABONBA_PTR_SET_VALUE(project_, project) };
