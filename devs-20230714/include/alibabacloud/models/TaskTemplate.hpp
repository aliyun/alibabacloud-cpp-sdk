...
#ifndef ALIBABACLOUD_MODELS_TASKTEMPLATE_HPP_
#define ALIBABACLOUD_MODELS_TASKTEMPLATE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TaskTemplate& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TaskTemplate& obj) { 
    ...
    TaskTemplate(const Darabonba::Json & obj) { from_json(obj, *this); };
    ...
    inline TaskTemplate& setCreatedTime(string createdTime) { DARABONBA_PTR_SET_VALUE(createdTime_, createdTime) };
    ...
    inline TaskTemplate& setDeletionTime(string deletionTime) { DARABONBA_PTR_SET_VALUE(deletionTime_, deletionTime) };
    ...
    inline TaskTemplate& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline TaskTemplate& setGeneration(int32_t generation) { DARABONBA_PTR_SET_VALUE(generation_, generation) };
    ...
    inline TaskTemplate& setKind(string kind) { DARABONBA_PTR_SET_VALUE(kind_, kind) };
    ...
    inline TaskTemplate& setLabels(const map<string, string> & labels) { DARABONBA_PTR_SET_VALUE(labels_, labels) };
    inline TaskTemplate& setLabels(map<string, string> && labels) { DARABONBA_PTR_SET_RVALUE(labels_, labels) };
    ...
    inline TaskTemplate& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline TaskTemplate& setResourceVersion(int32_t resourceVersion) { DARABONBA_PTR_SET_VALUE(resourceVersion_, resourceVersion) };


    // spec Field Functions 
    bool hasSpec() const { return this->spec_ != nullptr;};
    void deleteSpec() { this->spec_ = nullptr;};
    inline const TaskTemplateSpec & spec() const { DARABONBA_PTR_GET_CONST(spec_, TaskTemplateSpec) };
    inline TaskTemplateSpec spec() { DARABONBA_PTR_GET(spec_, TaskTemplateSpec) };
    inline TaskTemplate& setSpec(const TaskTemplateSpec & spec) { DARABONBA_PTR_SET_VALUE(spec_, spec) };
    inline TaskTemplate& setSpec(TaskTemplateSpec && spec) { DARABONBA_PTR_SET_RVALUE(spec_, spec) };
    ...
    inline TaskTemplate& setUid(string uid) { DARABONBA_PTR_SET_VALUE(uid_, uid) };
  ...
  protected:
    ...
    std::shared_ptr<TaskTemplateSpec> spec_ = nullptr;
