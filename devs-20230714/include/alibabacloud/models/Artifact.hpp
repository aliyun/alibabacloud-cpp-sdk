...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->createdTime_ != nullptr
        ...
        && this->resourceVersion_ != nullptr && this->spec_ != nullptr && this->status_ != nullptr && this->uid_ != nullptr && this->updatedTime_ != nullptr; };
    // createdTime Field Functions 
    bool hasCreatedTime() const { return this->createdTime_ != nullptr;};
    void deleteCreatedTime() { this->createdTime_ = nullptr;};
    inline string createdTime() const { DARABONBA_PTR_GET_DEFAULT(createdTime_, "") };
    inline Artifact& setCreatedTime(string createdTime) { DARABONBA_PTR_SET_VALUE(createdTime_, createdTime) };
    ...
    inline Artifact& setGeneration(int32_t generation) { DARABONBA_PTR_SET_VALUE(generation_, generation) };
    ...
    inline Artifact& setLabels(const map<string, string> & labels) { DARABONBA_PTR_SET_VALUE(labels_, labels) };
    inline Artifact& setLabels(map<string, string> && labels) { DARABONBA_PTR_SET_RVALUE(labels_, labels) };
    ...
    inline Artifact& setResourceVersion(int32_t resourceVersion) { DARABONBA_PTR_SET_VALUE(resourceVersion_, resourceVersion) };


    // spec Field Functions 
    bool hasSpec() const { return this->spec_ != nullptr;};
    void deleteSpec() { this->spec_ = nullptr;};
    inline const ArtifactSpec & spec() const { DARABONBA_PTR_GET_CONST(spec_, ArtifactSpec) };
    inline ArtifactSpec spec() { DARABONBA_PTR_GET(spec_, ArtifactSpec) };
    inline Artifact& setSpec(const ArtifactSpec & spec) { DARABONBA_PTR_SET_VALUE(spec_, spec) };
    inline Artifact& setSpec(ArtifactSpec && spec) { DARABONBA_PTR_SET_RVALUE(spec_, spec) };


    // status Field Functions 
    bool hasStatus() const { return this->status_ != nullptr;};
    void deleteStatus() { this->status_ = nullptr;};
    inline const ArtifactStatus & status() const { DARABONBA_PTR_GET_CONST(status_, ArtifactStatus) };
    inline ArtifactStatus status() { DARABONBA_PTR_GET(status_, ArtifactStatus) };
    inline Artifact& setStatus(const ArtifactStatus & status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    inline Artifact& setStatus(ArtifactStatus && status) { DARABONBA_PTR_SET_RVALUE(status_, status) };
    ...
    inline Artifact& setUid(string uid) { DARABONBA_PTR_SET_VALUE(uid_, uid) };
    ...
    inline Artifact& setUpdatedTime(string updatedTime) { DARABONBA_PTR_SET_VALUE(updatedTime_, updatedTime) };
  ...
  protected:
    ...
    std::shared_ptr<ArtifactSpec> spec_ = nullptr;
    std::shared_ptr<ArtifactStatus> status_ = nullptr;
