...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Connection> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<Connection>) };
    inline vector<Connection> data() { DARABONBA_PTR_GET(data_, vector<Connection>) };
    inline ListConnectionsResponseBody& setData(const vector<Connection> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListConnectionsResponseBody& setData(vector<Connection> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListConnectionsResponseBody& setPageNumber(int64_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListConnectionsResponseBody& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListConnectionsResponseBody& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };


  protected:
    std::shared_ptr<vector<Connection>> data_ = nullptr;
