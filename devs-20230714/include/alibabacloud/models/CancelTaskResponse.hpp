...
namespace Models
{
  ...
  public:
    ...
    inline CancelTaskResponse& setBody(const Task & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CancelTaskResponse& setBody(Task && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
