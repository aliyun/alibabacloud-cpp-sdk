...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Project> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<Project>) };
    inline vector<Project> data() { DARABONBA_PTR_GET(data_, vector<Project>) };
    inline ListProjectsResponseBody& setData(const vector<Project> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListProjectsResponseBody& setData(vector<Project> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListProjectsResponseBody& setPageNumber(int64_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListProjectsResponseBody& setPageSize(int64_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
  ...
  protected:
    std::shared_ptr<vector<Project>> data_ = nullptr;
