...
namespace Models
{
  ...
  public:
    ...
    inline CreateProjectResponse& setBody(const Project & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CreateProjectResponse& setBody(Project && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
