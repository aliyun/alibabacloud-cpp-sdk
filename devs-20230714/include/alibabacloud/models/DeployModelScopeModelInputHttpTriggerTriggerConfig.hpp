...
#ifndef ALIBABACLOUD_MODELS_DEPLOYMODELSCOPEMODELINPUTHTTPTRIGGERTRIGGERCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYMODELSCOPEMODELINPUTHTTPTRIGGERTRIGGERCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeployModelScopeModelInputHttpTriggerTriggerConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeployModelScopeModelInputHttpTriggerTriggerConfig& obj) { 
    ...
    DeployModelScopeModelInputHttpTriggerTriggerConfig() = default ;
    DeployModelScopeModelInputHttpTriggerTriggerConfig(const DeployModelScopeModelInputHttpTriggerTriggerConfig &) = default ;
    DeployModelScopeModelInputHttpTriggerTriggerConfig(DeployModelScopeModelInputHttpTriggerTriggerConfig &&) = default ;
    DeployModelScopeModelInputHttpTriggerTriggerConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeployModelScopeModelInputHttpTriggerTriggerConfig() = default ;
    DeployModelScopeModelInputHttpTriggerTriggerConfig& operator=(const DeployModelScopeModelInputHttpTriggerTriggerConfig &) = default ;
    DeployModelScopeModelInputHttpTriggerTriggerConfig& operator=(DeployModelScopeModelInputHttpTriggerTriggerConfig &&) = default ;
    ...
    inline DeployModelScopeModelInputHttpTriggerTriggerConfig& setAuthConfig(string authConfig) { DARABONBA_PTR_SET_VALUE(authConfig_, authConfig) };
    ...
    inline DeployModelScopeModelInputHttpTriggerTriggerConfig& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline DeployModelScopeModelInputHttpTriggerTriggerConfig& setDisableURLInternet(bool disableURLInternet) { DARABONBA_PTR_SET_VALUE(disableURLInternet_, disableURLInternet) };
    ...
    inline DeployModelScopeModelInputHttpTriggerTriggerConfig& setDsableURLInternet(bool dsableURLInternet) { DARABONBA_PTR_SET_VALUE(dsableURLInternet_, dsableURLInternet) };
    ...
    inline DeployModelScopeModelInputHttpTriggerTriggerConfig& setMethods(const vector<string> & methods) { DARABONBA_PTR_SET_VALUE(methods_, methods) };
    inline DeployModelScopeModelInputHttpTriggerTriggerConfig& setMethods(vector<string> && methods) { DARABONBA_PTR_SET_RVALUE(methods_, methods) };
