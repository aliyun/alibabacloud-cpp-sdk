...
namespace Models
{
  ...
  public:
    ...
    inline Task& setCreatedTime(string createdTime) { DARABONBA_PTR_SET_VALUE(createdTime_, createdTime) };
    ...
    inline Task& setGeneration(int32_t generation) { DARABONBA_PTR_SET_VALUE(generation_, generation) };
    ...
    inline Task& setKind(string kind) { DARABONBA_PTR_SET_VALUE(kind_, kind) };
    ...
    inline Task& setLabels(const map<string, string> & labels) { DARABONBA_PTR_SET_VALUE(labels_, labels) };
    inline Task& setLabels(map<string, string> && labels) { DARABONBA_PTR_SET_RVALUE(labels_, labels) };
    ...
    inline Task& setResourceVersion(int32_t resourceVersion) { DARABONBA_PTR_SET_VALUE(resourceVersion_, resourceVersion) };


    // spec Field Functions 
    bool hasSpec() const { return this->spec_ != nullptr;};
    void deleteSpec() { this->spec_ = nullptr;};
    inline const TaskSpec & spec() const { DARABONBA_PTR_GET_CONST(spec_, TaskSpec) };
    inline TaskSpec spec() { DARABONBA_PTR_GET(spec_, TaskSpec) };
    inline Task& setSpec(const TaskSpec & spec) { DARABONBA_PTR_SET_VALUE(spec_, spec) };
    inline Task& setSpec(TaskSpec && spec) { DARABONBA_PTR_SET_RVALUE(spec_, spec) };


    // status Field Functions 
    bool hasStatus() const { return this->status_ != nullptr;};
    void deleteStatus() { this->status_ = nullptr;};
    inline const TaskStatus & status() const { DARABONBA_PTR_GET_CONST(status_, TaskStatus) };
    inline TaskStatus status() { DARABONBA_PTR_GET(status_, TaskStatus) };
    inline Task& setStatus(const TaskStatus & status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    inline Task& setStatus(TaskStatus && status) { DARABONBA_PTR_SET_RVALUE(status_, status) };
    ...
    inline Task& setUid(string uid) { DARABONBA_PTR_SET_VALUE(uid_, uid) };
  ...
  protected:
    ...
    std::shared_ptr<TaskSpec> spec_ = nullptr;
    std::shared_ptr<TaskStatus> status_ = nullptr;
