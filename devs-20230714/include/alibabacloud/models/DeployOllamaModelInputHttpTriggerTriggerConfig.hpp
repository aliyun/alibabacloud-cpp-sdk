...
#ifndef ALIBABACLOUD_MODELS_DEPLOYOLLAMAMODELINPUTHTTPTRIGGERTRIGGERCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYOLLAMAMODELINPUTHTTPTRIGGERTRIGGERCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeployOllamaModelInputHttpTriggerTriggerConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeployOllamaModelInputHttpTriggerTriggerConfig& obj) { 
    ...
    DeployOllamaModelInputHttpTriggerTriggerConfig() = default ;
    DeployOllamaModelInputHttpTriggerTriggerConfig(const DeployOllamaModelInputHttpTriggerTriggerConfig &) = default ;
    DeployOllamaModelInputHttpTriggerTriggerConfig(DeployOllamaModelInputHttpTriggerTriggerConfig &&) = default ;
    DeployOllamaModelInputHttpTriggerTriggerConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeployOllamaModelInputHttpTriggerTriggerConfig() = default ;
    DeployOllamaModelInputHttpTriggerTriggerConfig& operator=(const DeployOllamaModelInputHttpTriggerTriggerConfig &) = default ;
    DeployOllamaModelInputHttpTriggerTriggerConfig& operator=(DeployOllamaModelInputHttpTriggerTriggerConfig &&) = default ;
    ...
    inline DeployOllamaModelInputHttpTriggerTriggerConfig& setAuthConfig(string authConfig) { DARABONBA_PTR_SET_VALUE(authConfig_, authConfig) };
    ...
    inline DeployOllamaModelInputHttpTriggerTriggerConfig& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline DeployOllamaModelInputHttpTriggerTriggerConfig& setDisableURLInternet(bool disableURLInternet) { DARABONBA_PTR_SET_VALUE(disableURLInternet_, disableURLInternet) };
    ...
    inline DeployOllamaModelInputHttpTriggerTriggerConfig& setDsableURLInternet(bool dsableURLInternet) { DARABONBA_PTR_SET_VALUE(dsableURLInternet_, dsableURLInternet) };
    ...
    inline DeployOllamaModelInputHttpTriggerTriggerConfig& setMethods(const vector<string> & methods) { DARABONBA_PTR_SET_VALUE(methods_, methods) };
    inline DeployOllamaModelInputHttpTriggerTriggerConfig& setMethods(vector<string> && methods) { DARABONBA_PTR_SET_RVALUE(methods_, methods) };
