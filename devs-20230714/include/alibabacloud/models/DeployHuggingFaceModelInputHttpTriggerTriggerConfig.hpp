...
#ifndef ALIBABACLOUD_MODELS_DEPLOYHUGGINGFACEMODELINPUTHTTPTRIGGERTRIGGERCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DEPLOYHUGGINGFACEMODELINPUTHTTPTRIGGERTRIGGERCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeployHuggingFaceModelInputHttpTriggerTriggerConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeployHuggingFaceModelInputHttpTriggerTriggerConfig& obj) { 
    ...
    DeployHuggingFaceModelInputHttpTriggerTriggerConfig() = default ;
    DeployHuggingFaceModelInputHttpTriggerTriggerConfig(const DeployHuggingFaceModelInputHttpTriggerTriggerConfig &) = default ;
    DeployHuggingFaceModelInputHttpTriggerTriggerConfig(DeployHuggingFaceModelInputHttpTriggerTriggerConfig &&) = default ;
    DeployHuggingFaceModelInputHttpTriggerTriggerConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeployHuggingFaceModelInputHttpTriggerTriggerConfig() = default ;
    DeployHuggingFaceModelInputHttpTriggerTriggerConfig& operator=(const DeployHuggingFaceModelInputHttpTriggerTriggerConfig &) = default ;
    DeployHuggingFaceModelInputHttpTriggerTriggerConfig& operator=(DeployHuggingFaceModelInputHttpTriggerTriggerConfig &&) = default ;
    ...
    inline DeployHuggingFaceModelInputHttpTriggerTriggerConfig& setAuthConfig(string authConfig) { DARABONBA_PTR_SET_VALUE(authConfig_, authConfig) };
    ...
    inline DeployHuggingFaceModelInputHttpTriggerTriggerConfig& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline DeployHuggingFaceModelInputHttpTriggerTriggerConfig& setDisableURLInternet(bool disableURLInternet) { DARABONBA_PTR_SET_VALUE(disableURLInternet_, disableURLInternet) };
    ...
    inline DeployHuggingFaceModelInputHttpTriggerTriggerConfig& setDsableURLInternet(bool dsableURLInternet) { DARABONBA_PTR_SET_VALUE(dsableURLInternet_, dsableURLInternet) };
    ...
    inline DeployHuggingFaceModelInputHttpTriggerTriggerConfig& setMethods(const vector<string> & methods) { DARABONBA_PTR_SET_VALUE(methods_, methods) };
    inline DeployHuggingFaceModelInputHttpTriggerTriggerConfig& setMethods(vector<string> && methods) { DARABONBA_PTR_SET_RVALUE(methods_, methods) };
