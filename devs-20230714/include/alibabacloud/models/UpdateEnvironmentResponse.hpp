...
namespace Models
{
  ...
  public:
    ...
    inline UpdateEnvironmentResponse& setBody(const Environment & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateEnvironmentResponse& setBody(Environment && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
