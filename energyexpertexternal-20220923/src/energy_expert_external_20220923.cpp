...
map<string, boost::any> Alibabacloud_EnergyExpertExternal20220923::Client::_postOSSObject(shared_ptr<string> bucketName, shared_ptr<map<string, boost::any>> data) {
...
AnalyzeVlRealtimeResponse Alibabacloud_EnergyExpertExternal20220923::Client::analyzeVlRealtimeAdvance(shared_ptr<AnalyzeVlRealtimeAdvanceRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(request->fileUrlObject)) {
    ...
    analyzeVlRealtimeReq->fileUrl = make_shared<string>(string("http://") + string((*authResponseBody)["Bucket"]) + string(".") + string((*authResponseBody)["Endpoint"]) + string("/") + string((*authResponseBody)["ObjectKey"]));
  }
...
ChatStreamResponse Alibabacloud_EnergyExpertExternal20220923::Client::chatStreamWithOptions(shared_ptr<ChatStreamRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> body = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->question)) {
    body->insert(pair<string, string>("question", *request->question));
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("ChatStream"))},
    {"version", boost::any(string("2022-09-23"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/api/v2/aidoc/document/chat/stream"))},
    {"method", boost::any(string("POST"))},
    {"authType", boost::any(string("AK"))},
    {"style", boost::any(string("ROA"))},
    {"reqBodyType", boost::any(string("json"))},
  ...
  return ChatStreamResponse(callApi(params, req, runtime));
}

ChatStreamResponse Alibabacloud_EnergyExpertExternal20220923::Client::chatStream(shared_ptr<ChatStreamRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
  shared_ptr<map<string, string>> headers = make_shared<map<string, string>>(map<string, string>());
...
SubmitDocExtractionTaskResponse Alibabacloud_EnergyExpertExternal20220923::Client::submitDocExtractionTaskAdvance(shared_ptr<SubmitDocExtractionTaskAdvanceRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(request->fileUrlObject)) {
    ...
    _postOSSObject(make_shared<string>((*authResponseBody)["Bucket"]), ossHeader);
    submitDocExtractionTaskReq->fileUrl = make_shared<string>(string("http://") + string((*authResponseBody)["Bucket"]) + string(".") + string((*authResponseBody)["Endpoint"]) + string("/") + string((*authResponseBody)["ObjectKey"]));
  }
...
SubmitDocParsingTaskResponse Alibabacloud_EnergyExpertExternal20220923::Client::submitDocParsingTaskAdvance(shared_ptr<SubmitDocParsingTaskAdvanceRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(request->fileUrlObject)) {
    ...
    _postOSSObject(make_shared<string>((*authResponseBody)["Bucket"]), ossHeader);
    submitDocParsingTaskReq->fileUrl = make_shared<string>(string("http://") + string((*authResponseBody)["Bucket"]) + string(".") + string((*authResponseBody)["Endpoint"]) + string("/") + string((*authResponseBody)["ObjectKey"]));
  }
...
SubmitDocumentAnalyzeJobResponse Alibabacloud_EnergyExpertExternal20220923::Client::submitDocumentAnalyzeJobAdvance(shared_ptr<SubmitDocumentAnalyzeJobAdvanceRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(request->fileUrlObject)) {
    ...
    _postOSSObject(make_shared<string>((*authResponseBody)["Bucket"]), ossHeader);
    submitDocumentAnalyzeJobReq->fileUrl = make_shared<string>(string("http://") + string((*authResponseBody)["Bucket"]) + string(".") + string((*authResponseBody)["Endpoint"]) + string("/") + string((*authResponseBody)["ObjectKey"]));
  }
...
SubmitVLExtractionTaskResponse Alibabacloud_EnergyExpertExternal20220923::Client::submitVLExtractionTaskAdvance(shared_ptr<SubmitVLExtractionTaskAdvanceRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(request->fileUrlObject)) {
    ...
    _postOSSObject(make_shared<string>((*authResponseBody)["Bucket"]), ossHeader);
    submitVLExtractionTaskReq->fileUrl = make_shared<string>(string("http://") + string((*authResponseBody)["Bucket"]) + string(".") + string((*authResponseBody)["Endpoint"]) + string("/") + string((*authResponseBody)["ObjectKey"]));
  }
