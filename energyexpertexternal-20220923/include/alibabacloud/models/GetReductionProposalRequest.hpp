...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && this->dataQualityEvaluationType_ == nullptr && this->productId_ == nullptr && this->productType_ == nullptr; };
    ...
    inline int32_t getDataQualityEvaluationType() const { DARABONBA_PTR_GET_DEFAULT(dataQualityEvaluationType_, 0) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<int32_t> dataQualityEvaluationType_ {};
    // The product id.
    // 
    // This parameter is required.
