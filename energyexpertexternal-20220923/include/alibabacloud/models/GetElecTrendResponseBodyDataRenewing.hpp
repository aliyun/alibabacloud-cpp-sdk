...
#ifndef ALIBABACLOUD_MODELS_GETELECTRENDRESPONSEBODYDATARENEWING_HPP_
#define ALIBABACLOUD_MODELS_GETELECTRENDRESPONSEBODYDATARENEWING_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetElecTrendResponseBodyDataRenewing& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetElecTrendResponseBodyDataRenewing& obj) { 
    ...
    GetElecTrendResponseBodyDataRenewing() = default ;
    GetElecTrendResponseBodyDataRenewing(const GetElecTrendResponseBodyDataRenewing &) = default ;
    GetElecTrendResponseBodyDataRenewing(GetElecTrendResponseBodyDataRenewing &&) = default ;
    GetElecTrendResponseBodyDataRenewing(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetElecTrendResponseBodyDataRenewing() = default ;
    GetElecTrendResponseBodyDataRenewing& operator=(const GetElecTrendResponseBodyDataRenewing &) = default ;
    GetElecTrendResponseBodyDataRenewing& operator=(GetElecTrendResponseBodyDataRenewing &&) = default ;
    ...
    inline GetElecTrendResponseBodyDataRenewing& setCarbonEmissionData(double carbonEmissionData) { DARABONBA_PTR_SET_VALUE(carbonEmissionData_, carbonEmissionData) };
    ...
    inline GetElecTrendResponseBodyDataRenewing& setDataUnit(string dataUnit) { DARABONBA_PTR_SET_VALUE(dataUnit_, dataUnit) };
    ...
    inline GetElecTrendResponseBodyDataRenewing& setMonth(int32_t month) { DARABONBA_PTR_SET_VALUE(month_, month) };
    ...
    inline GetElecTrendResponseBodyDataRenewing& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetElecTrendResponseBodyDataRenewing& setNameKey(string nameKey) { DARABONBA_PTR_SET_VALUE(nameKey_, nameKey) };
    ...
    inline GetElecTrendResponseBodyDataRenewing& setRatio(double ratio) { DARABONBA_PTR_SET_VALUE(ratio_, ratio) };
    ...
    inline GetElecTrendResponseBodyDataRenewing& setRawData(double rawData) { DARABONBA_PTR_SET_VALUE(rawData_, rawData) };
    ...
    inline GetElecTrendResponseBodyDataRenewing& setYear(string year) { DARABONBA_PTR_SET_VALUE(year_, year) };
