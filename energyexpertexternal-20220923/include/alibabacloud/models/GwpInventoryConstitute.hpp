...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GwpResourceConstitute> & getByResourceType() const { DARABONBA_PTR_GET_CONST(byResourceType_, vector<GwpResourceConstitute>) };
    inline vector<GwpResourceConstitute> getByResourceType() { DARABONBA_PTR_GET(byResourceType_, vector<GwpResourceConstitute>) };
