...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetGasConstituteResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<GetGasConstituteResponseBodyData>) };
    inline vector<GetGasConstituteResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<GetGasConstituteResponseBodyData>) };
    inline GetGasConstituteResponseBody& setData(const vector<GetGasConstituteResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetGasConstituteResponseBody& setData(vector<GetGasConstituteResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<vector<GetGasConstituteResponseBodyData>> data_ = nullptr;
    // The request ID.
