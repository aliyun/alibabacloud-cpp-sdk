...
namespace Models
{
  ...
  public:
    ...
    inline const SetRunningPlanResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetRunningPlanResponseBody) };
    inline SetRunningPlanResponseBody getBody() { DARABONBA_PTR_GET(body_, SetRunningPlanResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetRunningPlanResponseBody> body_ {};
  };
