...
namespace Models
{
  ...
  public:
    ...
    inline const GetElecConstituteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetElecConstituteResponseBody) };
    inline GetElecConstituteResponseBody getBody() { DARABONBA_PTR_GET(body_, GetElecConstituteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetElecConstituteResponseBody> body_ {};
  };
