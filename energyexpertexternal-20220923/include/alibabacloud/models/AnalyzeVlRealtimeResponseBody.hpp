...
namespace Models
{
  ...
  public:
    ...
    inline const AnalyzeVlRealtimeResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, AnalyzeVlRealtimeResponseBody::Data) };
    inline AnalyzeVlRealtimeResponseBody::Data getData() { DARABONBA_PTR_GET(data_, AnalyzeVlRealtimeResponseBody::Data) };
    inline AnalyzeVlRealtimeResponseBody& setData(const AnalyzeVlRealtimeResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AnalyzeVlRealtimeResponseBody& setData(AnalyzeVlRealtimeResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
