...
#ifndef ALIBABACLOUD_MODELS_EDITUNFAVORABLEAREADEVICESREQUESTHVACDEVICECONFIGVOLIST_HPP_
#define ALIBABACLOUD_MODELS_EDITUNFAVORABLEAREADEVICESREQUESTHVACDEVICECONFIGVOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& obj) { 
    ...
    EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList() = default ;
    EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList(const EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList &) = default ;
    EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList(EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList &&) = default ;
    EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList() = default ;
    EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& operator=(const EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList &) = default ;
    EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& operator=(EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList &&) = default ;
    ...
    inline EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& setBuildingId(string buildingId) { DARABONBA_PTR_SET_VALUE(buildingId_, buildingId) };
    ...
    inline EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& setDeviceId(string deviceId) { DARABONBA_PTR_SET_VALUE(deviceId_, deviceId) };
    ...
    inline EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& setDeviceName(string deviceName) { DARABONBA_PTR_SET_VALUE(deviceName_, deviceName) };
    ...
    inline EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& setDeviceType(string deviceType) { DARABONBA_PTR_SET_VALUE(deviceType_, deviceType) };
    ...
    inline EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& setFenceId(string fenceId) { DARABONBA_PTR_SET_VALUE(fenceId_, fenceId) };
    ...
    inline EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& setFloorId(string floorId) { DARABONBA_PTR_SET_VALUE(floorId_, floorId) };
    ...
    inline EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& setIsForbidden(int32_t isForbidden) { DARABONBA_PTR_SET_VALUE(isForbidden_, isForbidden) };
    ...
    inline EditUnfavorableAreaDevicesRequestHvacDeviceConfigVOList& setIsUnfavorableArea(int32_t isUnfavorableArea) { DARABONBA_PTR_SET_VALUE(isUnfavorableArea_, isUnfavorableArea) };
