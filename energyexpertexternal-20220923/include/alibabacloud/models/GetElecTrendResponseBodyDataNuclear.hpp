...
#ifndef ALIBABACLOUD_MODELS_GETELECTRENDRESPONSEBODYDATANUCLEAR_HPP_
#define ALIBABACLOUD_MODELS_GETELECTRENDRESPONSEBODYDATANUCLEAR_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetElecTrendResponseBodyDataNuclear& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetElecTrendResponseBodyDataNuclear& obj) { 
    ...
    GetElecTrendResponseBodyDataNuclear() = default ;
    GetElecTrendResponseBodyDataNuclear(const GetElecTrendResponseBodyDataNuclear &) = default ;
    GetElecTrendResponseBodyDataNuclear(GetElecTrendResponseBodyDataNuclear &&) = default ;
    GetElecTrendResponseBodyDataNuclear(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetElecTrendResponseBodyDataNuclear() = default ;
    GetElecTrendResponseBodyDataNuclear& operator=(const GetElecTrendResponseBodyDataNuclear &) = default ;
    GetElecTrendResponseBodyDataNuclear& operator=(GetElecTrendResponseBodyDataNuclear &&) = default ;
    ...
    inline GetElecTrendResponseBodyDataNuclear& setCarbonEmissionData(double carbonEmissionData) { DARABONBA_PTR_SET_VALUE(carbonEmissionData_, carbonEmissionData) };
    ...
    inline GetElecTrendResponseBodyDataNuclear& setDataUnit(string dataUnit) { DARABONBA_PTR_SET_VALUE(dataUnit_, dataUnit) };
    ...
    inline GetElecTrendResponseBodyDataNuclear& setMonth(int32_t month) { DARABONBA_PTR_SET_VALUE(month_, month) };
    ...
    inline GetElecTrendResponseBodyDataNuclear& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetElecTrendResponseBodyDataNuclear& setNameKey(string nameKey) { DARABONBA_PTR_SET_VALUE(nameKey_, nameKey) };
    ...
    inline GetElecTrendResponseBodyDataNuclear& setRatio(double ratio) { DARABONBA_PTR_SET_VALUE(ratio_, ratio) };
    ...
    inline GetElecTrendResponseBodyDataNuclear& setRawData(double rawData) { DARABONBA_PTR_SET_VALUE(rawData_, rawData) };
    ...
    inline GetElecTrendResponseBodyDataNuclear& setYear(string year) { DARABONBA_PTR_SET_VALUE(year_, year) };
