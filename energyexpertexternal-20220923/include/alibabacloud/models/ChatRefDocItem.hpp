...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->docInfo_ == nullptr
    ...
    inline const ChatRefDocInfo & getDocInfo() const { DARABONBA_PTR_GET_CONST(docInfo_, ChatRefDocInfo) };
    inline ChatRefDocInfo getDocInfo() { DARABONBA_PTR_GET(docInfo_, ChatRefDocInfo) };
    ...
    inline const vector<ChatDocumentPageNum> & getPageNum() const { DARABONBA_PTR_GET_CONST(pageNum_, vector<ChatDocumentPageNum>) };
    inline vector<ChatDocumentPageNum> getPageNum() { DARABONBA_PTR_GET(pageNum_, vector<ChatDocumentPageNum>) };
