...
#ifndef ALIBABACLOUD_MODELS_GETELECTRENDRESPONSEBODYDATAURBAN_HPP_
#define ALIBABACLOUD_MODELS_GETELECTRENDRESPONSEBODYDATAURBAN_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetElecTrendResponseBodyDataUrban& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetElecTrendResponseBodyDataUrban& obj) { 
    ...
    GetElecTrendResponseBodyDataUrban() = default ;
    GetElecTrendResponseBodyDataUrban(const GetElecTrendResponseBodyDataUrban &) = default ;
    GetElecTrendResponseBodyDataUrban(GetElecTrendResponseBodyDataUrban &&) = default ;
    GetElecTrendResponseBodyDataUrban(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetElecTrendResponseBodyDataUrban() = default ;
    GetElecTrendResponseBodyDataUrban& operator=(const GetElecTrendResponseBodyDataUrban &) = default ;
    GetElecTrendResponseBodyDataUrban& operator=(GetElecTrendResponseBodyDataUrban &&) = default ;
    ...
    inline GetElecTrendResponseBodyDataUrban& setCarbonEmissionData(double carbonEmissionData) { DARABONBA_PTR_SET_VALUE(carbonEmissionData_, carbonEmissionData) };
    ...
    inline GetElecTrendResponseBodyDataUrban& setDataUnit(string dataUnit) { DARABONBA_PTR_SET_VALUE(dataUnit_, dataUnit) };
    ...
    inline GetElecTrendResponseBodyDataUrban& setMonth(int32_t month) { DARABONBA_PTR_SET_VALUE(month_, month) };
    ...
    inline GetElecTrendResponseBodyDataUrban& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetElecTrendResponseBodyDataUrban& setNameKey(string nameKey) { DARABONBA_PTR_SET_VALUE(nameKey_, nameKey) };
    ...
    inline GetElecTrendResponseBodyDataUrban& setRatio(double ratio) { DARABONBA_PTR_SET_VALUE(ratio_, ratio) };
    ...
    inline GetElecTrendResponseBodyDataUrban& setRawData(double rawData) { DARABONBA_PTR_SET_VALUE(rawData_, rawData) };
    ...
    inline GetElecTrendResponseBodyDataUrban& setYear(string year) { DARABONBA_PTR_SET_VALUE(year_, year) };
