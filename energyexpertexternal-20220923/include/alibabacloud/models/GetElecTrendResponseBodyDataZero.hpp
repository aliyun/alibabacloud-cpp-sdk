...
#ifndef ALIBABACLOUD_MODELS_GETELECTRENDRESPONSEBODYDATAZERO_HPP_
#define ALIBABACLOUD_MODELS_GETELECTRENDRESPONSEBODYDATAZERO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetElecTrendResponseBodyDataZero& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetElecTrendResponseBodyDataZero& obj) { 
    ...
    GetElecTrendResponseBodyDataZero() = default ;
    GetElecTrendResponseBodyDataZero(const GetElecTrendResponseBodyDataZero &) = default ;
    GetElecTrendResponseBodyDataZero(GetElecTrendResponseBodyDataZero &&) = default ;
    GetElecTrendResponseBodyDataZero(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetElecTrendResponseBodyDataZero() = default ;
    GetElecTrendResponseBodyDataZero& operator=(const GetElecTrendResponseBodyDataZero &) = default ;
    GetElecTrendResponseBodyDataZero& operator=(GetElecTrendResponseBodyDataZero &&) = default ;
    ...
    inline GetElecTrendResponseBodyDataZero& setCarbonEmissionData(double carbonEmissionData) { DARABONBA_PTR_SET_VALUE(carbonEmissionData_, carbonEmissionData) };
    ...
    inline GetElecTrendResponseBodyDataZero& setDataUnit(string dataUnit) { DARABONBA_PTR_SET_VALUE(dataUnit_, dataUnit) };
    ...
    inline GetElecTrendResponseBodyDataZero& setMonth(int32_t month) { DARABONBA_PTR_SET_VALUE(month_, month) };
    ...
    inline GetElecTrendResponseBodyDataZero& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetElecTrendResponseBodyDataZero& setNameKey(string nameKey) { DARABONBA_PTR_SET_VALUE(nameKey_, nameKey) };
    ...
    inline GetElecTrendResponseBodyDataZero& setRatio(double ratio) { DARABONBA_PTR_SET_VALUE(ratio_, ratio) };
    ...
    inline GetElecTrendResponseBodyDataZero& setRawData(double rawData) { DARABONBA_PTR_SET_VALUE(rawData_, rawData) };
    ...
    inline GetElecTrendResponseBodyDataZero& setYear(string year) { DARABONBA_PTR_SET_VALUE(year_, year) };
