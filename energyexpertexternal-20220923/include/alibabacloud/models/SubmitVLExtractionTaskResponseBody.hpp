...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitVLExtractionTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SubmitVLExtractionTaskResponseBody::Data) };
    inline SubmitVLExtractionTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SubmitVLExtractionTaskResponseBody::Data) };
    inline SubmitVLExtractionTaskResponseBody& setData(const SubmitVLExtractionTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitVLExtractionTaskResponseBody& setData(SubmitVLExtractionTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<SubmitVLExtractionTaskResponseBody::Data> data_ {};
    // Request ID.
