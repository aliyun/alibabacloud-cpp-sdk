...
#ifndef ALIBABACLOUD_MODELS_GETELECCONSTITUTERESPONSEBODYDATAWATER_HPP_
#define ALIBABACLOUD_MODELS_GETELECCONSTITUTERESPONSEBODYDATAWATER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetElecConstituteResponseBodyDataWater& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetElecConstituteResponseBodyDataWater& obj) { 
    ...
    GetElecConstituteResponseBodyDataWater() = default ;
    GetElecConstituteResponseBodyDataWater(const GetElecConstituteResponseBodyDataWater &) = default ;
    GetElecConstituteResponseBodyDataWater(GetElecConstituteResponseBodyDataWater &&) = default ;
    GetElecConstituteResponseBodyDataWater(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetElecConstituteResponseBodyDataWater() = default ;
    GetElecConstituteResponseBodyDataWater& operator=(const GetElecConstituteResponseBodyDataWater &) = default ;
    GetElecConstituteResponseBodyDataWater& operator=(GetElecConstituteResponseBodyDataWater &&) = default ;
    ...
    inline GetElecConstituteResponseBodyDataWater& setCarbonEmissionData(double carbonEmissionData) { DARABONBA_PTR_SET_VALUE(carbonEmissionData_, carbonEmissionData) };
    ...
    inline GetElecConstituteResponseBodyDataWater& setDataUnit(string dataUnit) { DARABONBA_PTR_SET_VALUE(dataUnit_, dataUnit) };
    ...
    inline GetElecConstituteResponseBodyDataWater& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetElecConstituteResponseBodyDataWater& setNameKey(string nameKey) { DARABONBA_PTR_SET_VALUE(nameKey_, nameKey) };
    ...
    inline GetElecConstituteResponseBodyDataWater& setRatio(double ratio) { DARABONBA_PTR_SET_VALUE(ratio_, ratio) };
    ...
    inline GetElecConstituteResponseBodyDataWater& setRawData(double rawData) { DARABONBA_PTR_SET_VALUE(rawData_, rawData) };
