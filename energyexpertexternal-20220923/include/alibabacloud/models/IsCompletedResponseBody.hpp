...
namespace Models
{
  ...
  public:
    ...
    inline const IsCompletedResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, IsCompletedResponseBodyData) };
    inline IsCompletedResponseBodyData data() { DARABONBA_PTR_GET(data_, IsCompletedResponseBodyData) };
    inline IsCompletedResponseBody& setData(const IsCompletedResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline IsCompletedResponseBody& setData(IsCompletedResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<IsCompletedResponseBodyData> data_ = nullptr;
