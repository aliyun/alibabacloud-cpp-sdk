...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getDataQualityEvaluationType() const { DARABONBA_PTR_GET_DEFAULT(dataQualityEvaluationType_, 0L) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<int64_t> dataQualityEvaluationType_ {};
    // The product id.
    // 
    // This parameter is required.
