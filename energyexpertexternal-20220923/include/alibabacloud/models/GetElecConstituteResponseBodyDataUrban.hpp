...
#ifndef ALIBABACLOUD_MODELS_GETELECCONSTITUTERESPONSEBODYDATAURBAN_HPP_
#define ALIBABACLOUD_MODELS_GETELECCONSTITUTERESPONSEBODYDATAURBAN_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetElecConstituteResponseBodyDataUrban& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetElecConstituteResponseBodyDataUrban& obj) { 
    ...
    GetElecConstituteResponseBodyDataUrban() = default ;
    GetElecConstituteResponseBodyDataUrban(const GetElecConstituteResponseBodyDataUrban &) = default ;
    GetElecConstituteResponseBodyDataUrban(GetElecConstituteResponseBodyDataUrban &&) = default ;
    GetElecConstituteResponseBodyDataUrban(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetElecConstituteResponseBodyDataUrban() = default ;
    GetElecConstituteResponseBodyDataUrban& operator=(const GetElecConstituteResponseBodyDataUrban &) = default ;
    GetElecConstituteResponseBodyDataUrban& operator=(GetElecConstituteResponseBodyDataUrban &&) = default ;
    ...
    inline GetElecConstituteResponseBodyDataUrban& setCarbonEmissionData(double carbonEmissionData) { DARABONBA_PTR_SET_VALUE(carbonEmissionData_, carbonEmissionData) };
    ...
    inline GetElecConstituteResponseBodyDataUrban& setDataUnit(string dataUnit) { DARABONBA_PTR_SET_VALUE(dataUnit_, dataUnit) };
    ...
    inline GetElecConstituteResponseBodyDataUrban& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetElecConstituteResponseBodyDataUrban& setNameKey(string nameKey) { DARABONBA_PTR_SET_VALUE(nameKey_, nameKey) };
    ...
    inline GetElecConstituteResponseBodyDataUrban& setRatio(double ratio) { DARABONBA_PTR_SET_VALUE(ratio_, ratio) };
    ...
    inline GetElecConstituteResponseBodyDataUrban& setRawData(double rawData) { DARABONBA_PTR_SET_VALUE(rawData_, rawData) };
