...
namespace Models
{
  ...
  public:
    ...
    inline const EditProhibitedDevicesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, EditProhibitedDevicesResponseBody) };
    inline EditProhibitedDevicesResponseBody body() { DARABONBA_PTR_GET(body_, EditProhibitedDevicesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<EditProhibitedDevicesResponseBody> body_ = nullptr;
  };
