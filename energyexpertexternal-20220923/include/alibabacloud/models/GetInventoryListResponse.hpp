...
namespace Models
{
  ...
  public:
    ...
    inline const GetInventoryListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetInventoryListResponseBody) };
    inline GetInventoryListResponseBody body() { DARABONBA_PTR_GET(body_, GetInventoryListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetInventoryListResponseBody> body_ = nullptr;
  };
