...
namespace Models
{
  ...
  public:
    ...
    inline ChatStreamRequest& setDocumentIds(const vector<int64_t> & documentIds) { DARABONBA_PTR_SET_VALUE(documentIds_, documentIds) };
    inline ChatStreamRequest& setDocumentIds(vector<int64_t> && documentIds) { DARABONBA_PTR_SET_RVALUE(documentIds_, documentIds) };
