...
namespace Models
{
  ...
  public:
    ...
    inline const GetFootprintListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetFootprintListResponseBody) };
    inline GetFootprintListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetFootprintListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetFootprintListResponseBody> body_ {};
  };
