...
namespace Models
{
  ...
  public:
    ...
    inline const GetVLExtractionResultResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetVLExtractionResultResponseBody) };
    inline GetVLExtractionResultResponseBody body() { DARABONBA_PTR_GET(body_, GetVLExtractionResultResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetVLExtractionResultResponseBody> body_ = nullptr;
  };
