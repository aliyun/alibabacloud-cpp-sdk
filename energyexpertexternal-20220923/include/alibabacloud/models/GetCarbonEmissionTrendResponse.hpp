...
namespace Models
{
  ...
  public:
    ...
    inline const GetCarbonEmissionTrendResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetCarbonEmissionTrendResponseBody) };
    inline GetCarbonEmissionTrendResponseBody body() { DARABONBA_PTR_GET(body_, GetCarbonEmissionTrendResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetCarbonEmissionTrendResponseBody> body_ = nullptr;
  };
