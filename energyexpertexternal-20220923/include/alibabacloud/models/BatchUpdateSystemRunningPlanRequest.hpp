...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->controlType_ == nullptr
        ...
        && return this->maxCarbonDioxide_ == nullptr && return this->maxTem_ == nullptr && return this->minTem_ == nullptr && return this->seasonMode_ == nullptr && return this->startTime_ == nullptr
        && return this->systemId_ == nullptr && return this->workingEndTime_ == nullptr && return this->workingStartTime_ == nullptr; };
