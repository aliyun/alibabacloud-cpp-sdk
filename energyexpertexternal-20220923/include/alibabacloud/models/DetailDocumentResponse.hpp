...
namespace Models
{
  ...
  public:
    ...
    inline const DetailDocumentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetailDocumentResponseBody) };
    inline DetailDocumentResponseBody getBody() { DARABONBA_PTR_GET(body_, DetailDocumentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetailDocumentResponseBody> body_ {};
  };
