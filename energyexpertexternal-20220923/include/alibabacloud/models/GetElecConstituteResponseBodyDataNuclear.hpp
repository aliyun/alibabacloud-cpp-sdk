...
#ifndef ALIBABACLOUD_MODELS_GETELECCONSTITUTERESPONSEBODYDATANUCLEAR_HPP_
#define ALIBABACLOUD_MODELS_GETELECCONSTITUTERESPONSEBODYDATANUCLEAR_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetElecConstituteResponseBodyDataNuclear& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetElecConstituteResponseBodyDataNuclear& obj) { 
    ...
    GetElecConstituteResponseBodyDataNuclear() = default ;
    GetElecConstituteResponseBodyDataNuclear(const GetElecConstituteResponseBodyDataNuclear &) = default ;
    GetElecConstituteResponseBodyDataNuclear(GetElecConstituteResponseBodyDataNuclear &&) = default ;
    GetElecConstituteResponseBodyDataNuclear(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetElecConstituteResponseBodyDataNuclear() = default ;
    GetElecConstituteResponseBodyDataNuclear& operator=(const GetElecConstituteResponseBodyDataNuclear &) = default ;
    GetElecConstituteResponseBodyDataNuclear& operator=(GetElecConstituteResponseBodyDataNuclear &&) = default ;
    ...
    inline GetElecConstituteResponseBodyDataNuclear& setCarbonEmissionData(double carbonEmissionData) { DARABONBA_PTR_SET_VALUE(carbonEmissionData_, carbonEmissionData) };
    ...
    inline GetElecConstituteResponseBodyDataNuclear& setDataUnit(string dataUnit) { DARABONBA_PTR_SET_VALUE(dataUnit_, dataUnit) };
    ...
    inline GetElecConstituteResponseBodyDataNuclear& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetElecConstituteResponseBodyDataNuclear& setNameKey(string nameKey) { DARABONBA_PTR_SET_VALUE(nameKey_, nameKey) };
    ...
    inline GetElecConstituteResponseBodyDataNuclear& setRatio(double ratio) { DARABONBA_PTR_SET_VALUE(ratio_, ratio) };
    ...
    inline GetElecConstituteResponseBodyDataNuclear& setRawData(double rawData) { DARABONBA_PTR_SET_VALUE(rawData_, rawData) };
