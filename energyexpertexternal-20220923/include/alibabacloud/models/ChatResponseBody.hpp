...
namespace Models
{
  ...
  public:
    ...
    inline const ChatItem & getData() const { DARABONBA_PTR_GET_CONST(data_, ChatItem) };
    inline ChatItem getData() { DARABONBA_PTR_GET(data_, ChatItem) };
