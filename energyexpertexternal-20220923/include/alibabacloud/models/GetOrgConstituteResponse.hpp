...
namespace Models
{
  ...
  public:
    ...
    inline const GetOrgConstituteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOrgConstituteResponseBody) };
    inline GetOrgConstituteResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOrgConstituteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOrgConstituteResponseBody> body_ {};
  };
