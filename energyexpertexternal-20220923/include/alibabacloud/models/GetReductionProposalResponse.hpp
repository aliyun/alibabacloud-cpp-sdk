...
namespace Models
{
  ...
  public:
    ...
    inline const GetReductionProposalResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetReductionProposalResponseBody) };
    inline GetReductionProposalResponseBody body() { DARABONBA_PTR_GET(body_, GetReductionProposalResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetReductionProposalResponseBody> body_ = nullptr;
  };
