...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocumentAnalyzeResultResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetDocumentAnalyzeResultResponseBody::Data) };
    inline GetDocumentAnalyzeResultResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetDocumentAnalyzeResultResponseBody::Data) };
    inline GetDocumentAnalyzeResultResponseBody& setData(const GetDocumentAnalyzeResultResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDocumentAnalyzeResultResponseBody& setData(GetDocumentAnalyzeResultResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // Returned Data
    shared_ptr<GetDocumentAnalyzeResultResponseBody::Data> data_ {};
    // Request ID
