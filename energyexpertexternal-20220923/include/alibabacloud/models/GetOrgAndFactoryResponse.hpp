...
namespace Models
{
  ...
  public:
    ...
    inline const GetOrgAndFactoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOrgAndFactoryResponseBody) };
    inline GetOrgAndFactoryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOrgAndFactoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOrgAndFactoryResponseBody> body_ {};
  };
