...
namespace Models
{
  ...
  public:
    ...
    inline const GetEmissionSourceConstituteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEmissionSourceConstituteResponseBody) };
    inline GetEmissionSourceConstituteResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEmissionSourceConstituteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEmissionSourceConstituteResponseBody> body_ {};
  };
