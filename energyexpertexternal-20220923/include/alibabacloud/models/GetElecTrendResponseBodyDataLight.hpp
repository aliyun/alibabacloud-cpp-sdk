...
#ifndef ALIBABACLOUD_MODELS_GETELECTRENDRESPONSEBODYDATALIGHT_HPP_
#define ALIBABACLOUD_MODELS_GETELECTRENDRESPONSEBODYDATALIGHT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetElecTrendResponseBodyDataLight& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetElecTrendResponseBodyDataLight& obj) { 
    ...
    GetElecTrendResponseBodyDataLight() = default ;
    GetElecTrendResponseBodyDataLight(const GetElecTrendResponseBodyDataLight &) = default ;
    GetElecTrendResponseBodyDataLight(GetElecTrendResponseBodyDataLight &&) = default ;
    GetElecTrendResponseBodyDataLight(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetElecTrendResponseBodyDataLight() = default ;
    GetElecTrendResponseBodyDataLight& operator=(const GetElecTrendResponseBodyDataLight &) = default ;
    GetElecTrendResponseBodyDataLight& operator=(GetElecTrendResponseBodyDataLight &&) = default ;
    ...
    inline GetElecTrendResponseBodyDataLight& setCarbonEmissionData(double carbonEmissionData) { DARABONBA_PTR_SET_VALUE(carbonEmissionData_, carbonEmissionData) };
    ...
    inline GetElecTrendResponseBodyDataLight& setDataUnit(string dataUnit) { DARABONBA_PTR_SET_VALUE(dataUnit_, dataUnit) };
    ...
    inline GetElecTrendResponseBodyDataLight& setMonth(int32_t month) { DARABONBA_PTR_SET_VALUE(month_, month) };
    ...
    inline GetElecTrendResponseBodyDataLight& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetElecTrendResponseBodyDataLight& setNameKey(string nameKey) { DARABONBA_PTR_SET_VALUE(nameKey_, nameKey) };
    ...
    inline GetElecTrendResponseBodyDataLight& setRatio(double ratio) { DARABONBA_PTR_SET_VALUE(ratio_, ratio) };
    ...
    inline GetElecTrendResponseBodyDataLight& setRawData(double rawData) { DARABONBA_PTR_SET_VALUE(rawData_, rawData) };
    ...
    inline GetElecTrendResponseBodyDataLight& setYear(string year) { DARABONBA_PTR_SET_VALUE(year_, year) };
