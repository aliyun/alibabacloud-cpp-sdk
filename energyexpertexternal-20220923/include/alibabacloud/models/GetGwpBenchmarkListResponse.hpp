...
namespace Models
{
  ...
  public:
    ...
    inline const GetGwpBenchmarkListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetGwpBenchmarkListResponseBody) };
    inline GetGwpBenchmarkListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetGwpBenchmarkListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetGwpBenchmarkListResponseBody> body_ {};
  };
