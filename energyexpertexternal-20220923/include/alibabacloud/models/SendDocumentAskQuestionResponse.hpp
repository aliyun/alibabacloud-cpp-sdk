...
namespace Models
{
  ...
  public:
    ...
    inline const SendDocumentAskQuestionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendDocumentAskQuestionResponseBody) };
    inline SendDocumentAskQuestionResponseBody getBody() { DARABONBA_PTR_GET(body_, SendDocumentAskQuestionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendDocumentAskQuestionResponseBody> body_ {};
  };
