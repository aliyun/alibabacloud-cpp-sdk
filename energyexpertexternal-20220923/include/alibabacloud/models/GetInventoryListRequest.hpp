...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && this->emissionType_ == nullptr && this->group_ == nullptr && this->methodType_ == nullptr && this->productId_ == nullptr && this->productType_ == nullptr; };
    ...
    inline string getEmissionType() const { DARABONBA_PTR_GET_DEFAULT(emissionType_, "") };
    ...
    inline string getMethodType() const { DARABONBA_PTR_GET_DEFAULT(methodType_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> emissionType_ {};
    // Group by
    // 
