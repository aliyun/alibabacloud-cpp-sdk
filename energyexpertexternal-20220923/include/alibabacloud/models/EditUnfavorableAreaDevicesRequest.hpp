...
namespace Models
{
  ...
  public:
    ...
    inline const vector<EditUnfavorableAreaDevicesRequest::HvacDeviceConfigVOList> & getHvacDeviceConfigVOList() const { DARABONBA_PTR_GET_CONST(hvacDeviceConfigVOList_, vector<EditUnfavorableAreaDevicesRequest::HvacDeviceConfigVOList>) };
    inline vector<EditUnfavorableAreaDevicesRequest::HvacDeviceConfigVOList> getHvacDeviceConfigVOList() { DARABONBA_PTR_GET(hvacDeviceConfigVOList_, vector<EditUnfavorableAreaDevicesRequest::HvacDeviceConfigVOList>) };
    inline EditUnfavorableAreaDevicesRequest& setHvacDeviceConfigVOList(const vector<EditUnfavorableAreaDevicesRequest::HvacDeviceConfigVOList> & hvacDeviceConfigVOList) { DARABONBA_PTR_SET_VALUE(hvacDeviceConfigVOList_, hvacDeviceConfigVOList) };
    inline EditUnfavorableAreaDevicesRequest& setHvacDeviceConfigVOList(vector<EditUnfavorableAreaDevicesRequest::HvacDeviceConfigVOList> && hvacDeviceConfigVOList) { DARABONBA_PTR_SET_RVALUE(hvacDeviceConfigVOList_, hvacDeviceConfigVOList) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<EditUnfavorableAreaDevicesRequest::HvacDeviceConfigVOList>> hvacDeviceConfigVOList_ {};
    // This parameter is required.
