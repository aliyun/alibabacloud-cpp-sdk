...
namespace Models
{
  ...
  public:
    ...
    inline const GetGasConstituteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetGasConstituteResponseBody) };
    inline GetGasConstituteResponseBody getBody() { DARABONBA_PTR_GET(body_, GetGasConstituteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetGasConstituteResponseBody> body_ {};
  };
