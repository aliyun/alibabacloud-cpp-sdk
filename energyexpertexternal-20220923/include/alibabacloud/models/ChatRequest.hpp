...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->documentIds_ == nullptr
        && this->question_ == nullptr && this->sessionId_ == nullptr; };
    ...
    inline ChatRequest& setDocumentIds(const vector<int64_t> & documentIds) { DARABONBA_PTR_SET_VALUE(documentIds_, documentIds) };
    inline ChatRequest& setDocumentIds(vector<int64_t> && documentIds) { DARABONBA_PTR_SET_RVALUE(documentIds_, documentIds) };
