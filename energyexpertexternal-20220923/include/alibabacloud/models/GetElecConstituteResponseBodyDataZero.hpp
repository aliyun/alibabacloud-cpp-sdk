...
#ifndef ALIBABACLOUD_MODELS_GETELECCONSTITUTERESPONSEBODYDATAZERO_HPP_
#define ALIBABACLOUD_MODELS_GETELECCONSTITUTERESPONSEBODYDATAZERO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetElecConstituteResponseBodyDataZero& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetElecConstituteResponseBodyDataZero& obj) { 
    ...
    GetElecConstituteResponseBodyDataZero() = default ;
    GetElecConstituteResponseBodyDataZero(const GetElecConstituteResponseBodyDataZero &) = default ;
    GetElecConstituteResponseBodyDataZero(GetElecConstituteResponseBodyDataZero &&) = default ;
    GetElecConstituteResponseBodyDataZero(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetElecConstituteResponseBodyDataZero() = default ;
    GetElecConstituteResponseBodyDataZero& operator=(const GetElecConstituteResponseBodyDataZero &) = default ;
    GetElecConstituteResponseBodyDataZero& operator=(GetElecConstituteResponseBodyDataZero &&) = default ;
    ...
    inline GetElecConstituteResponseBodyDataZero& setCarbonEmissionData(double carbonEmissionData) { DARABONBA_PTR_SET_VALUE(carbonEmissionData_, carbonEmissionData) };
    ...
    inline GetElecConstituteResponseBodyDataZero& setDataUnit(string dataUnit) { DARABONBA_PTR_SET_VALUE(dataUnit_, dataUnit) };
    ...
    inline GetElecConstituteResponseBodyDataZero& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetElecConstituteResponseBodyDataZero& setNameKey(string nameKey) { DARABONBA_PTR_SET_VALUE(nameKey_, nameKey) };
    ...
    inline GetElecConstituteResponseBodyDataZero& setRatio(double ratio) { DARABONBA_PTR_SET_VALUE(ratio_, ratio) };
    ...
    inline GetElecConstituteResponseBodyDataZero& setRawData(double rawData) { DARABONBA_PTR_SET_VALUE(rawData_, rawData) };
