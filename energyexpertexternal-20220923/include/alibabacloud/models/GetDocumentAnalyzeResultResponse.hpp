...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocumentAnalyzeResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDocumentAnalyzeResultResponseBody) };
    inline GetDocumentAnalyzeResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDocumentAnalyzeResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDocumentAnalyzeResultResponseBody> body_ {};
  };
