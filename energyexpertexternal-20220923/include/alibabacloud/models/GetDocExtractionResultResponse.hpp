...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocExtractionResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDocExtractionResultResponseBody) };
    inline GetDocExtractionResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDocExtractionResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDocExtractionResultResponseBody> body_ {};
  };
