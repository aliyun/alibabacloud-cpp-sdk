...
namespace Models
{
  ...
  public:
    ...
    inline const GetVLExtractionResultResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetVLExtractionResultResponseBody::Data) };
    inline GetVLExtractionResultResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetVLExtractionResultResponseBody::Data) };
    inline GetVLExtractionResultResponseBody& setData(const GetVLExtractionResultResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetVLExtractionResultResponseBody& setData(GetVLExtractionResultResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // Returned Data
    shared_ptr<GetVLExtractionResultResponseBody::Data> data_ {};
    // Id of the request
