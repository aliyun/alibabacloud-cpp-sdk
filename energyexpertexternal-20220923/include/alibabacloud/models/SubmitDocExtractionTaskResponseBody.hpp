...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitDocExtractionTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SubmitDocExtractionTaskResponseBodyData) };
    inline SubmitDocExtractionTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, SubmitDocExtractionTaskResponseBodyData) };
    inline SubmitDocExtractionTaskResponseBody& setData(const SubmitDocExtractionTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitDocExtractionTaskResponseBody& setData(SubmitDocExtractionTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // Returned data
    std::shared_ptr<SubmitDocExtractionTaskResponseBodyData> data_ = nullptr;
    // Request ID.
