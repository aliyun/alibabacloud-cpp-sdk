...
namespace Models
{
  ...
  public:
    ...
    inline const GetEmissionSummaryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetEmissionSummaryResponseBodyData) };
    inline GetEmissionSummaryResponseBodyData data() { DARABONBA_PTR_GET(data_, GetEmissionSummaryResponseBodyData) };
    inline GetEmissionSummaryResponseBody& setData(const GetEmissionSummaryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetEmissionSummaryResponseBody& setData(GetEmissionSummaryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetEmissionSummaryResponseBodyData> data_ = nullptr;
    // Id of the request.
