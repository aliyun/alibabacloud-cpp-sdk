...
#ifndef ALIBABACLOUD_MODELS_GETELECCONSTITUTERESPONSEBODYDATALIGHT_HPP_
#define ALIBABACLOUD_MODELS_GETELECCONSTITUTERESPONSEBODYDATALIGHT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetElecConstituteResponseBodyDataLight& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetElecConstituteResponseBodyDataLight& obj) { 
    ...
    GetElecConstituteResponseBodyDataLight() = default ;
    GetElecConstituteResponseBodyDataLight(const GetElecConstituteResponseBodyDataLight &) = default ;
    GetElecConstituteResponseBodyDataLight(GetElecConstituteResponseBodyDataLight &&) = default ;
    GetElecConstituteResponseBodyDataLight(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetElecConstituteResponseBodyDataLight() = default ;
    GetElecConstituteResponseBodyDataLight& operator=(const GetElecConstituteResponseBodyDataLight &) = default ;
    GetElecConstituteResponseBodyDataLight& operator=(GetElecConstituteResponseBodyDataLight &&) = default ;
    ...
    inline GetElecConstituteResponseBodyDataLight& setCarbonEmissionData(double carbonEmissionData) { DARABONBA_PTR_SET_VALUE(carbonEmissionData_, carbonEmissionData) };
    ...
    inline GetElecConstituteResponseBodyDataLight& setDataUnit(string dataUnit) { DARABONBA_PTR_SET_VALUE(dataUnit_, dataUnit) };
    ...
    inline GetElecConstituteResponseBodyDataLight& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetElecConstituteResponseBodyDataLight& setNameKey(string nameKey) { DARABONBA_PTR_SET_VALUE(nameKey_, nameKey) };
    ...
    inline GetElecConstituteResponseBodyDataLight& setRatio(double ratio) { DARABONBA_PTR_SET_VALUE(ratio_, ratio) };
    ...
    inline GetElecConstituteResponseBodyDataLight& setRawData(double rawData) { DARABONBA_PTR_SET_VALUE(rawData_, rawData) };
