...
BatchAddFacesResponse Alibabacloud_Facebody20191230::Client::batchAddFacesAdvance(shared_ptr<BatchAddFacesAdvanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  // Step 0: init client
  shared_ptr<string> accessKeyId = make_shared<string>(_credential->getAccessKeyId());
  shared_ptr<string> accessKeySecret = make_shared<string>(_credential->getAccessKeySecret());
  shared_ptr<string> securityToken = make_shared<string>(_credential->getSecurityToken());
  ...
  shared_ptr<Alibabacloud_OSSUtil::RuntimeOptions> ossRuntime = make_shared<Alibabacloud_OSSUtil::RuntimeOptions>();
  Alibabacloud_OpenApiUtil::Client::convert(runtime, ossRuntime);
  shared_ptr<BatchAddFacesRequest> batchAddFacesReq = make_shared<BatchAddFacesRequest>();
  Alibabacloud_OpenApiUtil::Client::convert(request, batchAddFacesReq);
  if (!Darabonba_Util::Client::isUnset<vector<BatchAddFacesAdvanceRequestFaces>>(request->faces)) {
    shared_ptr<int> i0 = make_shared<int>(0);
    for(auto item0 : *request->faces) {
      if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(item0.imageURLObject)) {
        ...
        ossClient->postObject(uploadRequest, ossRuntime);
        shared_ptr<BatchAddFacesRequestFaces> tmp = make_shared<BatchAddFacesRequestFaces>((*batchAddFacesReq->faces)[[object Object]]);
  ...
  shared_ptr<BatchAddFacesResponse> batchAddFacesResp = make_shared<BatchAddFacesResponse>(batchAddFacesWithOptions(batchAddFacesReq, runtime));
...
CompareFaceWithMaskResponse Alibabacloud_Facebody20191230::Client::compareFaceWithMaskWithOptions(shared_ptr<CompareFaceWithMaskRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> body = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->imageURLA)) {
    body->insert(pair<string, string>("ImageURLA", *request->imageURLA));
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("CompareFaceWithMask"))},
    {"version", boost::any(string("2019-12-30"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return CompareFaceWithMaskResponse(callApi(params, req, runtime));
}

CompareFaceWithMaskResponse Alibabacloud_Facebody20191230::Client::compareFaceWithMask(shared_ptr<CompareFaceWithMaskRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
  return compareFaceWithMaskWithOptions(request, runtime);
}

CompareFaceWithMaskResponse Alibabacloud_Facebody20191230::Client::compareFaceWithMaskAdvance(shared_ptr<CompareFaceWithMaskAdvanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  // Step 0: init client
  shared_ptr<string> accessKeyId = make_shared<string>(_credential->getAccessKeyId());
  shared_ptr<string> accessKeySecret = make_shared<string>(_credential->getAccessKeySecret());
  shared_ptr<string> securityToken = make_shared<string>(_credential->getSecurityToken());
  ...
  shared_ptr<Alibabacloud_OSSUtil::RuntimeOptions> ossRuntime = make_shared<Alibabacloud_OSSUtil::RuntimeOptions>();
  Alibabacloud_OpenApiUtil::Client::convert(runtime, ossRuntime);
  shared_ptr<CompareFaceWithMaskRequest> compareFaceWithMaskReq = make_shared<CompareFaceWithMaskRequest>();
  Alibabacloud_OpenApiUtil::Client::convert(request, compareFaceWithMaskReq);
  if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(request->imageURLAObject)) {
    authResponse = make_shared<Alibabacloud_OpenPlatform20191219::AuthorizeFileUploadResponse>(authClient->authorizeFileUploadWithOptions(authRequest, runtime));
    ossConfig->accessKeyId = authResponse->body->accessKeyId;
    ossConfig->endpoint = make_shared<string>(Alibabacloud_OpenApiUtil::Client::getEndpoint(authResponse->body->endpoint, authResponse->body->useAccelerate, _endpointType));
    ...
    ossClient->postObject(uploadRequest, ossRuntime);
    compareFaceWithMaskReq->imageURLA = make_shared<string>(string("http://") + string(*authResponse->body->bucket) + string(".") + string(*authResponse->body->endpoint) + string("/") + string(*authResponse->body->objectKey));
  }
  if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(request->imageURLBObject)) {
    authResponse = make_shared<Alibabacloud_OpenPlatform20191219::AuthorizeFileUploadResponse>(authClient->authorizeFileUploadWithOptions(authRequest, runtime));
    ossConfig->accessKeyId = authResponse->body->accessKeyId;
    ...
    ossClient->postObject(uploadRequest, ossRuntime);
    compareFaceWithMaskReq->imageURLB = make_shared<string>(string("http://") + string(*authResponse->body->bucket) + string(".") + string(*authResponse->body->endpoint) + string("/") + string(*authResponse->body->objectKey));
  }
  shared_ptr<CompareFaceWithMaskResponse> compareFaceWithMaskResp = make_shared<CompareFaceWithMaskResponse>(compareFaceWithMaskWithOptions(compareFaceWithMaskReq, runtime));
...
DeepfakeFaceResponse Alibabacloud_Facebody20191230::Client::deepfakeFaceWithOptions(shared_ptr<DeepfakeFaceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> body = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<vector<DeepfakeFaceRequestTasks>>(request->tasks)) {
    body->insert(pair<string, vector<DeepfakeFaceRequestTasks>>("Tasks", *request->tasks));
  }
  shared_ptr<Alibabacloud_OpenApi::OpenApiRequest> req = make_shared<Alibabacloud_OpenApi::OpenApiRequest>(map<string, boost::any>({
    {"body", boost::any(Alibabacloud_OpenApiUtil::Client::parseToMap(body))}
  }));
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("DeepfakeFace"))},
    {"version", boost::any(string("2019-12-30"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return DeepfakeFaceResponse(callApi(params, req, runtime));
}

DeepfakeFaceResponse Alibabacloud_Facebody20191230::Client::deepfakeFace(shared_ptr<DeepfakeFaceRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
  return deepfakeFaceWithOptions(request, runtime);
}

DeepfakeFaceResponse Alibabacloud_Facebody20191230::Client::deepfakeFaceAdvance(shared_ptr<DeepfakeFaceAdvanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  // Step 0: init client
  shared_ptr<string> accessKeyId = make_shared<string>(_credential->getAccessKeyId());
  shared_ptr<string> accessKeySecret = make_shared<string>(_credential->getAccessKeySecret());
  shared_ptr<string> securityToken = make_shared<string>(_credential->getSecurityToken());
  ...
  shared_ptr<Alibabacloud_OSSUtil::RuntimeOptions> ossRuntime = make_shared<Alibabacloud_OSSUtil::RuntimeOptions>();
  Alibabacloud_OpenApiUtil::Client::convert(runtime, ossRuntime);
  shared_ptr<DeepfakeFaceRequest> deepfakeFaceReq = make_shared<DeepfakeFaceRequest>();
  Alibabacloud_OpenApiUtil::Client::convert(request, deepfakeFaceReq);
  if (!Darabonba_Util::Client::isUnset<vector<DeepfakeFaceAdvanceRequestTasks>>(request->tasks)) {
    shared_ptr<int> i0 = make_shared<int>(0);
    for(auto item0 : *request->tasks) {
      if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(item0.imageURLObject)) {
        ...
        ossClient->postObject(uploadRequest, ossRuntime);
        shared_ptr<DeepfakeFaceRequestTasks> tmp = make_shared<DeepfakeFaceRequestTasks>((*deepfakeFaceReq->tasks)[[object Object]]);
        tmp->imageURL = make_shared<string>(string("http://") + string(*authResponse->body->bucket) + string(".") + string(*authResponse->body->endpoint) + string("/") + string(*authResponse->body->objectKey));
        i0 = make_shared<int>(std::ltoi(std::itol(*i0) + std::itol(1)));
      }
    }
  }
  shared_ptr<DeepfakeFaceResponse> deepfakeFaceResp = make_shared<DeepfakeFaceResponse>(deepfakeFaceWithOptions(deepfakeFaceReq, runtime));
...
DetectInfraredLivingFaceResponse Alibabacloud_Facebody20191230::Client::detectInfraredLivingFaceWithOptions(shared_ptr<DetectInfraredLivingFaceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> body = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<vector<DetectInfraredLivingFaceRequestTasks>>(request->tasks)) {
    body->insert(pair<string, vector<DetectInfraredLivingFaceRequestTasks>>("Tasks", *request->tasks));
  }
  shared_ptr<Alibabacloud_OpenApi::OpenApiRequest> req = make_shared<Alibabacloud_OpenApi::OpenApiRequest>(map<string, boost::any>({
    {"body", boost::any(Alibabacloud_OpenApiUtil::Client::parseToMap(body))}
  }));
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("DetectInfraredLivingFace"))},
    {"version", boost::any(string("2019-12-30"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return DetectInfraredLivingFaceResponse(callApi(params, req, runtime));
}

DetectInfraredLivingFaceResponse Alibabacloud_Facebody20191230::Client::detectInfraredLivingFace(shared_ptr<DetectInfraredLivingFaceRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
  return detectInfraredLivingFaceWithOptions(request, runtime);
}

DetectInfraredLivingFaceResponse Alibabacloud_Facebody20191230::Client::detectInfraredLivingFaceAdvance(shared_ptr<DetectInfraredLivingFaceAdvanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  // Step 0: init client
  shared_ptr<string> accessKeyId = make_shared<string>(_credential->getAccessKeyId());
  shared_ptr<string> accessKeySecret = make_shared<string>(_credential->getAccessKeySecret());
  shared_ptr<string> securityToken = make_shared<string>(_credential->getSecurityToken());
  ...
  shared_ptr<Alibabacloud_OSSUtil::RuntimeOptions> ossRuntime = make_shared<Alibabacloud_OSSUtil::RuntimeOptions>();
  Alibabacloud_OpenApiUtil::Client::convert(runtime, ossRuntime);
  shared_ptr<DetectInfraredLivingFaceRequest> detectInfraredLivingFaceReq = make_shared<DetectInfraredLivingFaceRequest>();
  Alibabacloud_OpenApiUtil::Client::convert(request, detectInfraredLivingFaceReq);
  if (!Darabonba_Util::Client::isUnset<vector<DetectInfraredLivingFaceAdvanceRequestTasks>>(request->tasks)) {
    shared_ptr<int> i0 = make_shared<int>(0);
    for(auto item0 : *request->tasks) {
      if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(item0.imageURLObject)) {
        authResponse = make_shared<Alibabacloud_OpenPlatform20191219::AuthorizeFileUploadResponse>(authClient->authorizeFileUploadWithOptions(authRequest, runtime));
        ...
        ossClient->postObject(uploadRequest, ossRuntime);
        shared_ptr<DetectInfraredLivingFaceRequestTasks> tmp = make_shared<DetectInfraredLivingFaceRequestTasks>((*detectInfraredLivingFaceReq->tasks)[[object Object]]);
        tmp->imageURL = make_shared<string>(string("http://") + string(*authResponse->body->bucket) + string(".") + string(*authResponse->body->endpoint) + string("/") + string(*authResponse->body->objectKey));
        i0 = make_shared<int>(std::ltoi(std::itol(*i0) + std::itol(1)));
      }
    }
  }
  shared_ptr<DetectInfraredLivingFaceResponse> detectInfraredLivingFaceResp = make_shared<DetectInfraredLivingFaceResponse>(detectInfraredLivingFaceWithOptions(detectInfraredLivingFaceReq, runtime));
...
DetectLivingFaceResponse Alibabacloud_Facebody20191230::Client::detectLivingFaceAdvance(shared_ptr<DetectLivingFaceAdvanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  // Step 0: init client
  shared_ptr<string> accessKeyId = make_shared<string>(_credential->getAccessKeyId());
  shared_ptr<string> accessKeySecret = make_shared<string>(_credential->getAccessKeySecret());
  shared_ptr<string> securityToken = make_shared<string>(_credential->getSecurityToken());
  ...
  shared_ptr<DetectLivingFaceResponse> detectLivingFaceResp = make_shared<DetectLivingFaceResponse>(detectLivingFaceWithOptions(detectLivingFaceReq, runtime));
...
MergeImageFaceResponse Alibabacloud_Facebody20191230::Client::mergeImageFaceWithOptions(shared_ptr<MergeImageFaceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (!Darabonba_Util::Client::isUnset<vector<MergeImageFaceRequestMergeInfos>>(request->mergeInfos)) {
    body->insert(pair<string, vector<MergeImageFaceRequestMergeInfos>>("MergeInfos", *request->mergeInfos));
  }
...
RecognizeActionResponse Alibabacloud_Facebody20191230::Client::recognizeActionAdvance(shared_ptr<RecognizeActionAdvanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  // Step 0: init client
  shared_ptr<string> accessKeyId = make_shared<string>(_credential->getAccessKeyId());
  shared_ptr<string> accessKeySecret = make_shared<string>(_credential->getAccessKeySecret());
  shared_ptr<string> securityToken = make_shared<string>(_credential->getSecurityToken());
...
RecognizePublicFaceResponse Alibabacloud_Facebody20191230::Client::recognizePublicFaceAdvance(shared_ptr<RecognizePublicFaceAdvanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  // Step 0: init client
  shared_ptr<string> accessKeyId = make_shared<string>(_credential->getAccessKeyId());
  shared_ptr<string> accessKeySecret = make_shared<string>(_credential->getAccessKeySecret());
  shared_ptr<string> securityToken = make_shared<string>(_credential->getSecurityToken());
  ...
  shared_ptr<RecognizePublicFaceResponse> recognizePublicFaceResp = make_shared<RecognizePublicFaceResponse>(recognizePublicFaceWithOptions(recognizePublicFaceReq, runtime));
