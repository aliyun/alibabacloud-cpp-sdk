...
#ifndef ALIBABACLOUD_MODELS_DETECTFACERESPONSEBODYDATAQUALITIES_HPP_
#define ALIBABACLOUD_MODELS_DETECTFACERESPONSEBODYDATAQUALITIES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DetectFaceResponseBodyDataQualities& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DetectFaceResponseBodyDataQualities& obj) { 
    ...
    DetectFaceResponseBodyDataQualities() = default ;
    DetectFaceResponseBodyDataQualities(const DetectFaceResponseBodyDataQualities &) = default ;
    DetectFaceResponseBodyDataQualities(DetectFaceResponseBodyDataQualities &&) = default ;
    DetectFaceResponseBodyDataQualities(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DetectFaceResponseBodyDataQualities() = default ;
    DetectFaceResponseBodyDataQualities& operator=(const DetectFaceResponseBodyDataQualities &) = default ;
    DetectFaceResponseBodyDataQualities& operator=(DetectFaceResponseBodyDataQualities &&) = default ;
    ...
    inline DetectFaceResponseBodyDataQualities& setBlurList(const vector<float> & blurList) { DARABONBA_PTR_SET_VALUE(blurList_, blurList) };
    inline DetectFaceResponseBodyDataQualities& setBlurList(vector<float> && blurList) { DARABONBA_PTR_SET_RVALUE(blurList_, blurList) };
    ...
    inline DetectFaceResponseBodyDataQualities& setFnfList(const vector<float> & fnfList) { DARABONBA_PTR_SET_VALUE(fnfList_, fnfList) };
    inline DetectFaceResponseBodyDataQualities& setFnfList(vector<float> && fnfList) { DARABONBA_PTR_SET_RVALUE(fnfList_, fnfList) };
    ...
    inline DetectFaceResponseBodyDataQualities& setGlassList(const vector<float> & glassList) { DARABONBA_PTR_SET_VALUE(glassList_, glassList) };
    inline DetectFaceResponseBodyDataQualities& setGlassList(vector<float> && glassList) { DARABONBA_PTR_SET_RVALUE(glassList_, glassList) };
    ...
    inline DetectFaceResponseBodyDataQualities& setIlluList(const vector<float> & illuList) { DARABONBA_PTR_SET_VALUE(illuList_, illuList) };
    inline DetectFaceResponseBodyDataQualities& setIlluList(vector<float> && illuList) { DARABONBA_PTR_SET_RVALUE(illuList_, illuList) };
    ...
    inline DetectFaceResponseBodyDataQualities& setMaskList(const vector<float> & maskList) { DARABONBA_PTR_SET_VALUE(maskList_, maskList) };
    inline DetectFaceResponseBodyDataQualities& setMaskList(vector<float> && maskList) { DARABONBA_PTR_SET_RVALUE(maskList_, maskList) };
    ...
    inline DetectFaceResponseBodyDataQualities& setNoiseList(const vector<float> & noiseList) { DARABONBA_PTR_SET_VALUE(noiseList_, noiseList) };
    inline DetectFaceResponseBodyDataQualities& setNoiseList(vector<float> && noiseList) { DARABONBA_PTR_SET_RVALUE(noiseList_, noiseList) };
    ...
    inline DetectFaceResponseBodyDataQualities& setPoseList(const vector<float> & poseList) { DARABONBA_PTR_SET_VALUE(poseList_, poseList) };
    inline DetectFaceResponseBodyDataQualities& setPoseList(vector<float> && poseList) { DARABONBA_PTR_SET_RVALUE(poseList_, poseList) };
    ...
    inline DetectFaceResponseBodyDataQualities& setScoreList(const vector<float> & scoreList) { DARABONBA_PTR_SET_VALUE(scoreList_, scoreList) };
    inline DetectFaceResponseBodyDataQualities& setScoreList(vector<float> && scoreList) { DARABONBA_PTR_SET_RVALUE(scoreList_, scoreList) };
