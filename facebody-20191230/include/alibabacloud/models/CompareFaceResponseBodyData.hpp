...
#ifndef ALIBABACLOUD_MODELS_COMPAREFACERESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_COMPAREFACERESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CompareFaceResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CompareFaceResponseBodyData& obj) { 
    ...
    CompareFaceResponseBodyData() = default ;
    CompareFaceResponseBodyData(const CompareFaceResponseBodyData &) = default ;
    CompareFaceResponseBodyData(CompareFaceResponseBodyData &&) = default ;
    CompareFaceResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CompareFaceResponseBodyData() = default ;
    CompareFaceResponseBodyData& operator=(const CompareFaceResponseBodyData &) = default ;
    CompareFaceResponseBodyData& operator=(CompareFaceResponseBodyData &&) = default ;
    ...
    inline CompareFaceResponseBodyData& setConfidence(float confidence) { DARABONBA_PTR_SET_VALUE(confidence_, confidence) };
    ...
    inline CompareFaceResponseBodyData& setIsMaskA(int64_t isMaskA) { DARABONBA_PTR_SET_VALUE(isMaskA_, isMaskA) };
    ...
    inline CompareFaceResponseBodyData& setIsMaskB(int64_t isMaskB) { DARABONBA_PTR_SET_VALUE(isMaskB_, isMaskB) };
    ...
    inline CompareFaceResponseBodyData& setLandmarksAList(const vector<int64_t> & landmarksAList) { DARABONBA_PTR_SET_VALUE(landmarksAList_, landmarksAList) };
    inline CompareFaceResponseBodyData& setLandmarksAList(vector<int64_t> && landmarksAList) { DARABONBA_PTR_SET_RVALUE(landmarksAList_, landmarksAList) };
    ...
    inline CompareFaceResponseBodyData& setLandmarksBList(const vector<int64_t> & landmarksBList) { DARABONBA_PTR_SET_VALUE(landmarksBList_, landmarksBList) };
    inline CompareFaceResponseBodyData& setLandmarksBList(vector<int64_t> && landmarksBList) { DARABONBA_PTR_SET_RVALUE(landmarksBList_, landmarksBList) };
    ...
    inline CompareFaceResponseBodyData& setMessageTips(string messageTips) { DARABONBA_PTR_SET_VALUE(messageTips_, messageTips) };
    ...
    inline CompareFaceResponseBodyData& setQualityScoreA(float qualityScoreA) { DARABONBA_PTR_SET_VALUE(qualityScoreA_, qualityScoreA) };
    ...
    inline CompareFaceResponseBodyData& setQualityScoreB(float qualityScoreB) { DARABONBA_PTR_SET_VALUE(qualityScoreB_, qualityScoreB) };
    ...
    inline const vector<int32_t> & rectAList() const { DARABONBA_PTR_GET_CONST(rectAList_, vector<int32_t>) };
    inline vector<int32_t> rectAList() { DARABONBA_PTR_GET(rectAList_, vector<int32_t>) };
    inline CompareFaceResponseBodyData& setRectAList(const vector<int32_t> & rectAList) { DARABONBA_PTR_SET_VALUE(rectAList_, rectAList) };
    inline CompareFaceResponseBodyData& setRectAList(vector<int32_t> && rectAList) { DARABONBA_PTR_SET_RVALUE(rectAList_, rectAList) };
    ...
    inline const vector<int32_t> & rectBList() const { DARABONBA_PTR_GET_CONST(rectBList_, vector<int32_t>) };
    inline vector<int32_t> rectBList() { DARABONBA_PTR_GET(rectBList_, vector<int32_t>) };
    inline CompareFaceResponseBodyData& setRectBList(const vector<int32_t> & rectBList) { DARABONBA_PTR_SET_VALUE(rectBList_, rectBList) };
    inline CompareFaceResponseBodyData& setRectBList(vector<int32_t> && rectBList) { DARABONBA_PTR_SET_RVALUE(rectBList_, rectBList) };
    ...
    inline const vector<float> & thresholds() const { DARABONBA_PTR_GET_CONST(thresholds_, vector<float>) };
    inline vector<float> thresholds() { DARABONBA_PTR_GET(thresholds_, vector<float>) };
    inline CompareFaceResponseBodyData& setThresholds(const vector<float> & thresholds) { DARABONBA_PTR_SET_VALUE(thresholds_, thresholds) };
    inline CompareFaceResponseBodyData& setThresholds(vector<float> && thresholds) { DARABONBA_PTR_SET_RVALUE(thresholds_, thresholds) };
  ...
  protected:
    ...
    // 1
    std::shared_ptr<vector<int32_t>> rectAList_ = nullptr;
    // 1
    std::shared_ptr<vector<int32_t>> rectBList_ = nullptr;
    // 1
    std::shared_ptr<vector<float>> thresholds_ = nullptr;
  };
