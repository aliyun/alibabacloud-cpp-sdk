...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPageSmartShortUrlLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryPageSmartShortUrlLogResponseBody) };
    inline QueryPageSmartShortUrlLogResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryPageSmartShortUrlLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryPageSmartShortUrlLogResponseBody> body_ {};
  };
