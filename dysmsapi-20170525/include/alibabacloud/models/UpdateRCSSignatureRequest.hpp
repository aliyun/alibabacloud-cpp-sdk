...
#ifndef ALIBABACLOUD_MODELS_UPDATERCSSIGNATUREREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATERCSSIGNATUREREQUEST_HPP_
...
namespace Models
{
  class UpdateRCSSignatureRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateRCSSignatureRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateRCSSignatureRequest& obj) { 
    ...
    UpdateRCSSignatureRequest() = default ;
    UpdateRCSSignatureRequest(const UpdateRCSSignatureRequest &) = default ;
    UpdateRCSSignatureRequest(UpdateRCSSignatureRequest &&) = default ;
    UpdateRCSSignatureRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateRCSSignatureRequest() = default ;
    UpdateRCSSignatureRequest& operator=(const UpdateRCSSignatureRequest &) = default ;
    UpdateRCSSignatureRequest& operator=(UpdateRCSSignatureRequest &&) = default ;
    ...
    inline UpdateRCSSignatureRequest& setBackgroundImage(string backgroundImage) { DARABONBA_PTR_SET_VALUE(backgroundImage_, backgroundImage) };
    ...
    inline UpdateRCSSignatureRequest& setBubbleColor(string bubbleColor) { DARABONBA_PTR_SET_VALUE(bubbleColor_, bubbleColor) };
    ...
    inline UpdateRCSSignatureRequest& setCategory(int64_t category) { DARABONBA_PTR_SET_VALUE(category_, category) };
    ...
    inline UpdateRCSSignatureRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateRCSSignatureRequest& setLatitude(string latitude) { DARABONBA_PTR_SET_VALUE(latitude_, latitude) };
    ...
    inline UpdateRCSSignatureRequest& setLogo(string logo) { DARABONBA_PTR_SET_VALUE(logo_, logo) };
    ...
    inline UpdateRCSSignatureRequest& setLongitude(string longitude) { DARABONBA_PTR_SET_VALUE(longitude_, longitude) };
    ...
    inline UpdateRCSSignatureRequest& setOfficeAddress(string officeAddress) { DARABONBA_PTR_SET_VALUE(officeAddress_, officeAddress) };
    ...
    inline UpdateRCSSignatureRequest& setServiceEmail(string serviceEmail) { DARABONBA_PTR_SET_VALUE(serviceEmail_, serviceEmail) };
    ...
    inline UpdateRCSSignatureRequest& setServicePhone(string servicePhone) { DARABONBA_PTR_SET_VALUE(servicePhone_, servicePhone) };
    ...
    inline UpdateRCSSignatureRequest& setServiceTerms(string serviceTerms) { DARABONBA_PTR_SET_VALUE(serviceTerms_, serviceTerms) };
    ...
    inline UpdateRCSSignatureRequest& setServiceWebsite(string serviceWebsite) { DARABONBA_PTR_SET_VALUE(serviceWebsite_, serviceWebsite) };
    ...
    inline UpdateRCSSignatureRequest& setSignName(string signName) { DARABONBA_PTR_SET_VALUE(signName_, signName) };
