...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getCreateDateEnd() const { DARABONBA_PTR_GET_DEFAULT(createDateEnd_, 0L) };
    ...
    inline int64_t getCreateDateStart() const { DARABONBA_PTR_GET_DEFAULT(createDateStart_, 0L) };
  ...
  protected:
    ...
    shared_ptr<int64_t> createDateEnd_ {};
    // This parameter is required.
    shared_ptr<int64_t> createDateStart_ {};
