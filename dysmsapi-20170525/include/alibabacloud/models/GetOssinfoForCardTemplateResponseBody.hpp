...
namespace Models
{
  ...
  public:
    ...
    inline const GetOSSInfoForCardTemplateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetOSSInfoForCardTemplateResponseBodyData) };
    inline GetOSSInfoForCardTemplateResponseBodyData data() { DARABONBA_PTR_GET(data_, GetOSSInfoForCardTemplateResponseBodyData) };
    inline GetOSSInfoForCardTemplateResponseBody& setData(const GetOSSInfoForCardTemplateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetOSSInfoForCardTemplateResponseBody& setData(GetOSSInfoForCardTemplateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<GetOSSInfoForCardTemplateResponseBodyData> data_ = nullptr;
    // The request ID.
