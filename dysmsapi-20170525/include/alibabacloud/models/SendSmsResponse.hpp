...
namespace Models
{
  ...
  public:
    ...
    inline const SendSmsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendSmsResponseBody) };
    inline SendSmsResponseBody getBody() { DARABONBA_PTR_GET(body_, SendSmsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendSmsResponseBody> body_ {};
  };
