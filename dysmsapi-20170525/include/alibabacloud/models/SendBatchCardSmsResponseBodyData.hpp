...
#ifndef ALIBABACLOUD_MODELS_SENDBATCHCARDSMSRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_SENDBATCHCARDSMSRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SendBatchCardSmsResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SendBatchCardSmsResponseBodyData& obj) { 
    ...
    SendBatchCardSmsResponseBodyData() = default ;
    SendBatchCardSmsResponseBodyData(const SendBatchCardSmsResponseBodyData &) = default ;
    SendBatchCardSmsResponseBodyData(SendBatchCardSmsResponseBodyData &&) = default ;
    SendBatchCardSmsResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SendBatchCardSmsResponseBodyData() = default ;
    SendBatchCardSmsResponseBodyData& operator=(const SendBatchCardSmsResponseBodyData &) = default ;
    SendBatchCardSmsResponseBodyData& operator=(SendBatchCardSmsResponseBodyData &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->bizCardId_ != nullptr
    ...
    inline SendBatchCardSmsResponseBodyData& setBizCardId(string bizCardId) { DARABONBA_PTR_SET_VALUE(bizCardId_, bizCardId) };
    ...
    inline SendBatchCardSmsResponseBodyData& setBizDigitalId(string bizDigitalId) { DARABONBA_PTR_SET_VALUE(bizDigitalId_, bizDigitalId) };
    ...
    inline SendBatchCardSmsResponseBodyData& setBizSmsId(string bizSmsId) { DARABONBA_PTR_SET_VALUE(bizSmsId_, bizSmsId) };
    ...
    inline SendBatchCardSmsResponseBodyData& setCardTmpState(int32_t cardTmpState) { DARABONBA_PTR_SET_VALUE(cardTmpState_, cardTmpState) };
    ...
    inline SendBatchCardSmsResponseBodyData& setMediaMobiles(string mediaMobiles) { DARABONBA_PTR_SET_VALUE(mediaMobiles_, mediaMobiles) };
    ...
    inline SendBatchCardSmsResponseBodyData& setNotMediaMobiles(string notMediaMobiles) { DARABONBA_PTR_SET_VALUE(notMediaMobiles_, notMediaMobiles) };
