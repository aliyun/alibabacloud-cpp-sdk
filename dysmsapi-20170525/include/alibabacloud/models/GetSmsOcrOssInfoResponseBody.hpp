...
namespace Models
{
  ...
  public:
    ...
    inline const GetSmsOcrOssInfoResponseBodyModel & model() const { DARABONBA_PTR_GET_CONST(model_, GetSmsOcrOssInfoResponseBodyModel) };
    inline GetSmsOcrOssInfoResponseBodyModel model() { DARABONBA_PTR_GET(model_, GetSmsOcrOssInfoResponseBodyModel) };
    inline GetSmsOcrOssInfoResponseBody& setModel(const GetSmsOcrOssInfoResponseBodyModel & model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    inline GetSmsOcrOssInfoResponseBody& setModel(GetSmsOcrOssInfoResponseBodyModel && model) { DARABONBA_PTR_SET_RVALUE(model_, model) };
  ...
  protected:
    ...
    std::shared_ptr<GetSmsOcrOssInfoResponseBodyModel> model_ = nullptr;
