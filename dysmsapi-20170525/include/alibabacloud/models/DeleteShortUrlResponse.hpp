...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteShortUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteShortUrlResponseBody) };
    inline DeleteShortUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteShortUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteShortUrlResponseBody> body_ {};
  };
