...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adminIDCardExpDate_ == nullptr
        ...
        && return this->companyType_ == nullptr && return this->legalPersonIDCardNo_ == nullptr && return this->legalPersonIDCardType_ == nullptr && return this->legalPersonIdCardBackSide_ == nullptr && return this->legalPersonIdCardEffTime_ == nullptr
        && return this->legalPersonIdCardFrontSide_ == nullptr && return this->legalPersonName_ == nullptr && return this->organizationCode_ == nullptr && return this->otherFiles_ == nullptr && return this->ownerId_ == nullptr
        && return this->qualificationName_ == nullptr && return this->remark_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->useBySelf_ == nullptr
        && return this->whetherShare_ == nullptr; };
    ...
    inline const vector<SubmitSmsQualificationRequestBusinessLicensePics> & businessLicensePics() const { DARABONBA_PTR_GET_CONST(businessLicensePics_, vector<SubmitSmsQualificationRequestBusinessLicensePics>) };
    inline vector<SubmitSmsQualificationRequestBusinessLicensePics> businessLicensePics() { DARABONBA_PTR_GET(businessLicensePics_, vector<SubmitSmsQualificationRequestBusinessLicensePics>) };
    inline SubmitSmsQualificationRequest& setBusinessLicensePics(const vector<SubmitSmsQualificationRequestBusinessLicensePics> & businessLicensePics) { DARABONBA_PTR_SET_VALUE(businessLicensePics_, businessLicensePics) };
    inline SubmitSmsQualificationRequest& setBusinessLicensePics(vector<SubmitSmsQualificationRequestBusinessLicensePics> && businessLicensePics) { DARABONBA_PTR_SET_RVALUE(businessLicensePics_, businessLicensePics) };
    ...
    inline const vector<SubmitSmsQualificationRequestOtherFiles> & otherFiles() const { DARABONBA_PTR_GET_CONST(otherFiles_, vector<SubmitSmsQualificationRequestOtherFiles>) };
    inline vector<SubmitSmsQualificationRequestOtherFiles> otherFiles() { DARABONBA_PTR_GET(otherFiles_, vector<SubmitSmsQualificationRequestOtherFiles>) };
    inline SubmitSmsQualificationRequest& setOtherFiles(const vector<SubmitSmsQualificationRequestOtherFiles> & otherFiles) { DARABONBA_PTR_SET_VALUE(otherFiles_, otherFiles) };
    inline SubmitSmsQualificationRequest& setOtherFiles(vector<SubmitSmsQualificationRequestOtherFiles> && otherFiles) { DARABONBA_PTR_SET_RVALUE(otherFiles_, otherFiles) };
  ...
  protected:
    ...
    // 企业营业证件信息，非大客户必填
    std::shared_ptr<vector<SubmitSmsQualificationRequestBusinessLicensePics>> businessLicensePics_ = nullptr;
    ...
    // 更多资料
    std::shared_ptr<vector<SubmitSmsQualificationRequestOtherFiles>> otherFiles_ = nullptr;
