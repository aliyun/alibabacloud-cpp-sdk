...
namespace Models
{
  ...
  public:
    ...
    inline const ValidPhoneCodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ValidPhoneCodeResponseBody) };
    inline ValidPhoneCodeResponseBody getBody() { DARABONBA_PTR_GET(body_, ValidPhoneCodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ValidPhoneCodeResponseBody> body_ {};
  };
