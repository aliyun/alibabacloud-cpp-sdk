...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitSmsQualificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitSmsQualificationResponseBody) };
    inline SubmitSmsQualificationResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitSmsQualificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitSmsQualificationResponseBody> body_ {};
  };
