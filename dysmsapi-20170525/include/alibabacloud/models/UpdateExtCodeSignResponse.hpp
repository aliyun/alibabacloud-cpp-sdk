...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateExtCodeSignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateExtCodeSignResponseBody) };
    inline UpdateExtCodeSignResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateExtCodeSignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateExtCodeSignResponseBody> body_ {};
  };
