...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualificationOssInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQualificationOssInfoResponseBodyData) };
    inline GetQualificationOssInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQualificationOssInfoResponseBodyData) };
    inline GetQualificationOssInfoResponseBody& setData(const GetQualificationOssInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualificationOssInfoResponseBody& setData(GetQualificationOssInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQualificationOssInfoResponseBodyData> data_ = nullptr;
