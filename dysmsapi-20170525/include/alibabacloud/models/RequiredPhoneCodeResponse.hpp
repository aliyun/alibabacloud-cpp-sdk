...
namespace Models
{
  ...
  public:
    ...
    inline const RequiredPhoneCodeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RequiredPhoneCodeResponseBody) };
    inline RequiredPhoneCodeResponseBody body() { DARABONBA_PTR_GET(body_, RequiredPhoneCodeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RequiredPhoneCodeResponseBody> body_ = nullptr;
  };
