...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSmsQualificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSmsQualificationResponseBody) };
    inline UpdateSmsQualificationResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateSmsQualificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateSmsQualificationResponseBody> body_ {};
  };
