...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySingleSmsQualificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QuerySingleSmsQualificationResponseBody) };
    inline QuerySingleSmsQualificationResponseBody getBody() { DARABONBA_PTR_GET(body_, QuerySingleSmsQualificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QuerySingleSmsQualificationResponseBody> body_ {};
  };
