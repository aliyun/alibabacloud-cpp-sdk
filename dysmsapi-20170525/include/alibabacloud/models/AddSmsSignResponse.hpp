...
namespace Models
{
  ...
  public:
    ...
    inline const AddSmsSignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddSmsSignResponseBody) };
    inline AddSmsSignResponseBody getBody() { DARABONBA_PTR_GET(body_, AddSmsSignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddSmsSignResponseBody> body_ {};
  };
