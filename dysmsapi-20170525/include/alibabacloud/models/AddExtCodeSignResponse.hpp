...
namespace Models
{
  ...
  public:
    ...
    inline const AddExtCodeSignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddExtCodeSignResponseBody) };
    inline AddExtCodeSignResponseBody getBody() { DARABONBA_PTR_GET(body_, AddExtCodeSignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddExtCodeSignResponseBody> body_ {};
  };
