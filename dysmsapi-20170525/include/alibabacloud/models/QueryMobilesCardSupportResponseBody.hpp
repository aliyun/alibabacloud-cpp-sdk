...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMobilesCardSupportResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryMobilesCardSupportResponseBodyData) };
    inline QueryMobilesCardSupportResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryMobilesCardSupportResponseBodyData) };
    inline QueryMobilesCardSupportResponseBody& setData(const QueryMobilesCardSupportResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryMobilesCardSupportResponseBody& setData(QueryMobilesCardSupportResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<QueryMobilesCardSupportResponseBodyData> data_ = nullptr;
    // The request ID.
