...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSmartShortUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSmartShortUrlResponseBody) };
    inline CreateSmartShortUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSmartShortUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSmartShortUrlResponseBody> body_ {};
  };
