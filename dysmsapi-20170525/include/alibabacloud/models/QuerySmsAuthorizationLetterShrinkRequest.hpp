...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authorizationLetterIdListShrink_ == nullptr
    ...
    inline string getAuthorizationLetterIdListShrink() const { DARABONBA_PTR_GET_DEFAULT(authorizationLetterIdListShrink_, "") };
  ...
  protected:
    // 委托授权书id列表
    shared_ptr<string> authorizationLetterIdListShrink_ {};
    // 授权方社会统一信用代码
