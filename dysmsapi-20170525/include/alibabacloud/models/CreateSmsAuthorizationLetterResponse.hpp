...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSmsAuthorizationLetterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSmsAuthorizationLetterResponseBody) };
    inline CreateSmsAuthorizationLetterResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSmsAuthorizationLetterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSmsAuthorizationLetterResponseBody> body_ {};
  };
