...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->certifyCode_ != nullptr
        && this->ownerId_ != nullptr && this->phoneNo_ != nullptr && this->resourceOwnerAccount_ != nullptr && this->resourceOwnerId_ != nullptr; };
