...
namespace Models
{
  ...
  public:
    ...
    inline const VerifyLogisticsSmsMailNoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, VerifyLogisticsSmsMailNoResponseBodyData) };
    inline VerifyLogisticsSmsMailNoResponseBodyData data() { DARABONBA_PTR_GET(data_, VerifyLogisticsSmsMailNoResponseBodyData) };
    inline VerifyLogisticsSmsMailNoResponseBody& setData(const VerifyLogisticsSmsMailNoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline VerifyLogisticsSmsMailNoResponseBody& setData(VerifyLogisticsSmsMailNoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<VerifyLogisticsSmsMailNoResponseBodyData> data_ = nullptr;
