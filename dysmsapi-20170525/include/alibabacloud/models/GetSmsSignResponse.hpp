...
namespace Models
{
  ...
  public:
    ...
    inline const GetSmsSignResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetSmsSignResponseBody) };
    inline GetSmsSignResponseBody body() { DARABONBA_PTR_GET(body_, GetSmsSignResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetSmsSignResponseBody> body_ = nullptr;
  };
