...
namespace Models
{
  ...
  public:
    ...
    inline const AddShortUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddShortUrlResponseBody) };
    inline AddShortUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, AddShortUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddShortUrlResponseBody> body_ {};
  };
