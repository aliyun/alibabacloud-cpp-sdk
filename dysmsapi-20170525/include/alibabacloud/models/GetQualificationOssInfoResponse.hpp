...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualificationOssInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetQualificationOssInfoResponseBody) };
    inline GetQualificationOssInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetQualificationOssInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetQualificationOssInfoResponseBody> body_ {};
  };
