...
namespace Models
{
  ...
  public:
    ...
    inline const QueryExtCodeSignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryExtCodeSignResponseBody) };
    inline QueryExtCodeSignResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryExtCodeSignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryExtCodeSignResponseBody> body_ {};
  };
