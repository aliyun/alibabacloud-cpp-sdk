...
namespace Models
{
  ...
  public:
    ...
    inline const SendLogisticsSmsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SendLogisticsSmsResponseBodyData) };
    inline SendLogisticsSmsResponseBodyData data() { DARABONBA_PTR_GET(data_, SendLogisticsSmsResponseBodyData) };
    inline SendLogisticsSmsResponseBody& setData(const SendLogisticsSmsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SendLogisticsSmsResponseBody& setData(SendLogisticsSmsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SendLogisticsSmsResponseBodyData> data_ = nullptr;
