...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSmsSignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSmsSignResponseBody) };
    inline UpdateSmsSignResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateSmsSignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateSmsSignResponseBody> body_ {};
  };
