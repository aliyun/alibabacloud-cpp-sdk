...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySmsTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySmsTemplateResponseBody) };
    inline ModifySmsTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySmsTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySmsTemplateResponseBody> body_ {};
  };
