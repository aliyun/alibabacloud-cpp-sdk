...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeSignatureQualificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChangeSignatureQualificationResponseBody) };
    inline ChangeSignatureQualificationResponseBody getBody() { DARABONBA_PTR_GET(body_, ChangeSignatureQualificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ChangeSignatureQualificationResponseBody> body_ {};
  };
