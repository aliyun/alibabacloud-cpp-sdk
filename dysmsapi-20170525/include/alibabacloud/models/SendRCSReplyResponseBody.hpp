...
#ifndef ALIBABACLOUD_MODELS_SENDRCSREPLYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SENDRCSREPLYRESPONSEBODY_HPP_
...
namespace Models
{
  class SendRCSReplyResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const SendRCSReplyResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SendRCSReplyResponseBody& obj) { 
    ...
    SendRCSReplyResponseBody() = default ;
    SendRCSReplyResponseBody(const SendRCSReplyResponseBody &) = default ;
    SendRCSReplyResponseBody(SendRCSReplyResponseBody &&) = default ;
    SendRCSReplyResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SendRCSReplyResponseBody() = default ;
    SendRCSReplyResponseBody& operator=(const SendRCSReplyResponseBody &) = default ;
    SendRCSReplyResponseBody& operator=(SendRCSReplyResponseBody &&) = default ;
    ...
    void deleteAccessDeniedDetail() { this->accessDeniedDetail_ = nullptr;};
    inline string getAccessDeniedDetail() const { DARABONBA_PTR_GET_DEFAULT(accessDeniedDetail_, "") };
    inline SendRCSReplyResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    void deleteCode() { this->code_ = nullptr;};
    inline string getCode() const { DARABONBA_PTR_GET_DEFAULT(code_, "") };
    inline SendRCSReplyResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const SendRCSReplyResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SendRCSReplyResponseBody::Data) };
    inline SendRCSReplyResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SendRCSReplyResponseBody::Data) };
    inline SendRCSReplyResponseBody& setData(const SendRCSReplyResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SendRCSReplyResponseBody& setData(SendRCSReplyResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    void deleteMessage() { this->message_ = nullptr;};
    inline string getMessage() const { DARABONBA_PTR_GET_DEFAULT(message_, "") };
    inline SendRCSReplyResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    void deleteRequestId() { this->requestId_ = nullptr;};
    inline string getRequestId() const { DARABONBA_PTR_GET_DEFAULT(requestId_, "") };
    inline SendRCSReplyResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    void deleteSuccess() { this->success_ = nullptr;};
    inline bool getSuccess() const { DARABONBA_PTR_GET_DEFAULT(success_, false) };
    inline SendRCSReplyResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> accessDeniedDetail_ {};
    shared_ptr<string> code_ {};
    shared_ptr<SendRCSReplyResponseBody::Data> data_ {};
    shared_ptr<string> message_ {};
    shared_ptr<string> requestId_ {};
    shared_ptr<bool> success_ {};
  };
