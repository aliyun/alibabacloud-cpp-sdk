...
namespace Models
{
  ...
  public:
    ...
    inline const GetOSSInfoForUploadFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOSSInfoForUploadFileResponseBody) };
    inline GetOSSInfoForUploadFileResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOSSInfoForUploadFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOSSInfoForUploadFileResponseBody> body_ {};
  };
