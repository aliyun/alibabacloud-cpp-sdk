...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteExtCodeSignResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteExtCodeSignResponseBody) };
    inline DeleteExtCodeSignResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteExtCodeSignResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteExtCodeSignResponseBody> body_ {};
  };
