...
namespace Models
{
  ...
  public:
    ...
    inline const QueryExtCodeSignResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryExtCodeSignResponseBodyData) };
    inline QueryExtCodeSignResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryExtCodeSignResponseBodyData) };
    inline QueryExtCodeSignResponseBody& setData(const QueryExtCodeSignResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryExtCodeSignResponseBody& setData(QueryExtCodeSignResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryExtCodeSignResponseBodyData> data_ = nullptr;
