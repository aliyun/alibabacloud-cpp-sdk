...
namespace Models
{
  ...
  public:
    ...
    inline const GetSmsOcrOssInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSmsOcrOssInfoResponseBody) };
    inline GetSmsOcrOssInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSmsOcrOssInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSmsOcrOssInfoResponseBody> body_ {};
  };
