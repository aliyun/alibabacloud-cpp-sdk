...
namespace Models
{
  ...
  public:
    ...
    inline const SendBatchCardSmsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SendBatchCardSmsResponseBodyData) };
    inline SendBatchCardSmsResponseBodyData data() { DARABONBA_PTR_GET(data_, SendBatchCardSmsResponseBodyData) };
    inline SendBatchCardSmsResponseBody& setData(const SendBatchCardSmsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SendBatchCardSmsResponseBody& setData(SendBatchCardSmsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<SendBatchCardSmsResponseBodyData> data_ = nullptr;
    // The request ID.
