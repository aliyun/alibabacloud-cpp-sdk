...
namespace Models
{
  ...
  public:
    ...
    inline const SendBatchCardSmsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendBatchCardSmsResponseBody) };
    inline SendBatchCardSmsResponseBody getBody() { DARABONBA_PTR_GET(body_, SendBatchCardSmsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendBatchCardSmsResponseBody> body_ {};
  };
