...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySmsQualificationRecordResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QuerySmsQualificationRecordResponseBodyData) };
    inline QuerySmsQualificationRecordResponseBodyData data() { DARABONBA_PTR_GET(data_, QuerySmsQualificationRecordResponseBodyData) };
    inline QuerySmsQualificationRecordResponseBody& setData(const QuerySmsQualificationRecordResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QuerySmsQualificationRecordResponseBody& setData(QuerySmsQualificationRecordResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QuerySmsQualificationRecordResponseBodyData> data_ = nullptr;
