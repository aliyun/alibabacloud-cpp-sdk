...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QuerySmsAuthorizationLetterResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QuerySmsAuthorizationLetterResponseBodyData>) };
    inline vector<QuerySmsAuthorizationLetterResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QuerySmsAuthorizationLetterResponseBodyData>) };
    inline QuerySmsAuthorizationLetterResponseBody& setData(const vector<QuerySmsAuthorizationLetterResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QuerySmsAuthorizationLetterResponseBody& setData(vector<QuerySmsAuthorizationLetterResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QuerySmsAuthorizationLetterResponseBodyData>> data_ = nullptr;
