...
namespace Models
{
  ...
  public:
    ...
    inline const GetOSSInfoForCardTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOSSInfoForCardTemplateResponseBody) };
    inline GetOSSInfoForCardTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOSSInfoForCardTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOSSInfoForCardTemplateResponseBody> body_ {};
  };
