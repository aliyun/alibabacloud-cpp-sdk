...
#ifndef ALIBABACLOUD_MODELS_EXECUTEAITEACHERSYNCDIALOGUEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_EXECUTEAITEACHERSYNCDIALOGUEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ExecuteAITeacherSyncDialogueRequest& obj) { 
      DARABONBA_PTR_TO_JSON(dialogueTasks, dialogueTasks_);
      DARABONBA_PTR_TO_JSON(languageCode, languageCode_);
      DARABONBA_PTR_TO_JSON(records, records_);
      DARABONBA_PTR_TO_JSON(userId, userId_);
    };
    friend void from_json(const Darabonba::Json& j, ExecuteAITeacherSyncDialogueRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(dialogueTasks, dialogueTasks_);
      DARABONBA_PTR_FROM_JSON(languageCode, languageCode_);
      DARABONBA_PTR_FROM_JSON(records, records_);
      DARABONBA_PTR_FROM_JSON(userId, userId_);
    };
    ExecuteAITeacherSyncDialogueRequest() = default ;
    ExecuteAITeacherSyncDialogueRequest(const ExecuteAITeacherSyncDialogueRequest &) = default ;
    ExecuteAITeacherSyncDialogueRequest(ExecuteAITeacherSyncDialogueRequest &&) = default ;
    ExecuteAITeacherSyncDialogueRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExecuteAITeacherSyncDialogueRequest() = default ;
    ExecuteAITeacherSyncDialogueRequest& operator=(const ExecuteAITeacherSyncDialogueRequest &) = default ;
    ExecuteAITeacherSyncDialogueRequest& operator=(ExecuteAITeacherSyncDialogueRequest &&) = default ;
    ...
    inline const vector<ExecuteAITeacherSyncDialogueRequest::DialogueTasks> & getDialogueTasks() const { DARABONBA_PTR_GET_CONST(dialogueTasks_, vector<ExecuteAITeacherSyncDialogueRequest::DialogueTasks>) };
    inline vector<ExecuteAITeacherSyncDialogueRequest::DialogueTasks> getDialogueTasks() { DARABONBA_PTR_GET(dialogueTasks_, vector<ExecuteAITeacherSyncDialogueRequest::DialogueTasks>) };
    inline ExecuteAITeacherSyncDialogueRequest& setDialogueTasks(const vector<ExecuteAITeacherSyncDialogueRequest::DialogueTasks> & dialogueTasks) { DARABONBA_PTR_SET_VALUE(dialogueTasks_, dialogueTasks) };
    inline ExecuteAITeacherSyncDialogueRequest& setDialogueTasks(vector<ExecuteAITeacherSyncDialogueRequest::DialogueTasks> && dialogueTasks) { DARABONBA_PTR_SET_RVALUE(dialogueTasks_, dialogueTasks) };
    ...
    inline ExecuteAITeacherSyncDialogueRequest& setLanguageCode(string languageCode) { DARABONBA_PTR_SET_VALUE(languageCode_, languageCode) };


    // records Field Functions 
    bool hasRecords() const { return this->records_ != nullptr;};
    void deleteRecords() { this->records_ = nullptr;};
    inline const vector<ExecuteAITeacherSyncDialogueRequest::Records> & getRecords() const { DARABONBA_PTR_GET_CONST(records_, vector<ExecuteAITeacherSyncDialogueRequest::Records>) };
    inline vector<ExecuteAITeacherSyncDialogueRequest::Records> getRecords() { DARABONBA_PTR_GET(records_, vector<ExecuteAITeacherSyncDialogueRequest::Records>) };
    inline ExecuteAITeacherSyncDialogueRequest& setRecords(const vector<ExecuteAITeacherSyncDialogueRequest::Records> & records) { DARABONBA_PTR_SET_VALUE(records_, records) };
    inline ExecuteAITeacherSyncDialogueRequest& setRecords(vector<ExecuteAITeacherSyncDialogueRequest::Records> && records) { DARABONBA_PTR_SET_RVALUE(records_, records) };
    ...
    inline ExecuteAITeacherSyncDialogueRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
