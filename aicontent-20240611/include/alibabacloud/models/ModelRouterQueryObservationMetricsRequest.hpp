...
namespace Models
{
  ...
  public:
    ...
    inline ModelRouterQueryObservationMetricsRequest& setClientIds(string clientIds) { DARABONBA_PTR_SET_VALUE(clientIds_, clientIds) };
    ...
    inline ModelRouterQueryObservationMetricsRequest& setMemberUserIds(string memberUserIds) { DARABONBA_PTR_SET_VALUE(memberUserIds_, memberUserIds) };
