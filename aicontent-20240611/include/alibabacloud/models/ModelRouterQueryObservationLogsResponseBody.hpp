...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RequestLogDTO> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<RequestLogDTO>) };
    inline vector<RequestLogDTO> getData() { DARABONBA_PTR_GET(data_, vector<RequestLogDTO>) };
    inline ModelRouterQueryObservationLogsResponseBody& setData(const vector<RequestLogDTO> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModelRouterQueryObservationLogsResponseBody& setData(vector<RequestLogDTO> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ModelRouterQueryObservationLogsResponseBody& setPageIndex(int32_t pageIndex) { DARABONBA_PTR_SET_VALUE(pageIndex_, pageIndex) };
    ...
    inline ModelRouterQueryObservationLogsResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ModelRouterQueryObservationLogsResponseBody& setSkip(int32_t skip) { DARABONBA_PTR_SET_VALUE(skip_, skip) };
    ...
    inline ModelRouterQueryObservationLogsResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };


  protected:
    shared_ptr<vector<RequestLogDTO>> data_ {};
