...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->apiKeyId_ == nullptr
        ...
        && this->memberUserIds_ == nullptr && this->modelTypes_ == nullptr && this->nextToken_ == nullptr && this->startTime_ == nullptr; };
    ...
    inline ModelRouterQueryCostOverviewMetricsRequest& setApiKeyId(int64_t apiKeyId) { DARABONBA_PTR_SET_VALUE(apiKeyId_, apiKeyId) };
    ...
    inline ModelRouterQueryCostOverviewMetricsRequest& setClientIds(string clientIds) { DARABONBA_PTR_SET_VALUE(clientIds_, clientIds) };
    ...
    inline ModelRouterQueryCostOverviewMetricsRequest& setMemberUserIds(string memberUserIds) { DARABONBA_PTR_SET_VALUE(memberUserIds_, memberUserIds) };
