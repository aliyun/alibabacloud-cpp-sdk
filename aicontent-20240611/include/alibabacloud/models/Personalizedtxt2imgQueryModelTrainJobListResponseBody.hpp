...
#ifndef ALIBABACLOUD_MODELS_PERSONALIZEDTXT2IMGQUERYMODELTRAINJOBLISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_PERSONALIZEDTXT2IMGQUERYMODELTRAINJOBLISTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const Personalizedtxt2imgQueryModelTrainJobListResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, Personalizedtxt2imgQueryModelTrainJobListResponseBody& obj) { 
    ...
    Personalizedtxt2imgQueryModelTrainJobListResponseBody() = default ;
    Personalizedtxt2imgQueryModelTrainJobListResponseBody(const Personalizedtxt2imgQueryModelTrainJobListResponseBody &) = default ;
    Personalizedtxt2imgQueryModelTrainJobListResponseBody(Personalizedtxt2imgQueryModelTrainJobListResponseBody &&) = default ;
    Personalizedtxt2imgQueryModelTrainJobListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~Personalizedtxt2imgQueryModelTrainJobListResponseBody() = default ;
    Personalizedtxt2imgQueryModelTrainJobListResponseBody& operator=(const Personalizedtxt2imgQueryModelTrainJobListResponseBody &) = default ;
    Personalizedtxt2imgQueryModelTrainJobListResponseBody& operator=(Personalizedtxt2imgQueryModelTrainJobListResponseBody &&) = default ;
    ...
    inline const vector<Personalizedtxt2imgQueryModelTrainJobListResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<Personalizedtxt2imgQueryModelTrainJobListResponseBody::Data>) };
    inline vector<Personalizedtxt2imgQueryModelTrainJobListResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<Personalizedtxt2imgQueryModelTrainJobListResponseBody::Data>) };
    inline Personalizedtxt2imgQueryModelTrainJobListResponseBody& setData(const vector<Personalizedtxt2imgQueryModelTrainJobListResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline Personalizedtxt2imgQueryModelTrainJobListResponseBody& setData(vector<Personalizedtxt2imgQueryModelTrainJobListResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline Personalizedtxt2imgQueryModelTrainJobListResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline Personalizedtxt2imgQueryModelTrainJobListResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline Personalizedtxt2imgQueryModelTrainJobListResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline Personalizedtxt2imgQueryModelTrainJobListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline Personalizedtxt2imgQueryModelTrainJobListResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<vector<Personalizedtxt2imgQueryModelTrainJobListResponseBody::Data>> data_ {};
