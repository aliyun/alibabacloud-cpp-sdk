...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->apiKeyId_ == nullptr
        ...
        && this->memberUserIds_ == nullptr && this->modelId_ == nullptr && this->modelTypes_ == nullptr && this->nextToken_ == nullptr && this->page_ == nullptr
    ...
    inline ModelRouterQueryBillingCostBreakdownRequest& setClientIds(string clientIds) { DARABONBA_PTR_SET_VALUE(clientIds_, clientIds) };
