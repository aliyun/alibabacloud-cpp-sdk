...
#ifndef ALIBABACLOUD_MODELS_MODELROUTERQUERYOBSERVATIONCHARTSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODELROUTERQUERYOBSERVATIONCHARTSREQUEST_HPP_
...
namespace Models
{
  class ModelRouterQueryObservationChartsRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModelRouterQueryObservationChartsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModelRouterQueryObservationChartsRequest& obj) { 
    ...
    ModelRouterQueryObservationChartsRequest() = default ;
    ModelRouterQueryObservationChartsRequest(const ModelRouterQueryObservationChartsRequest &) = default ;
    ModelRouterQueryObservationChartsRequest(ModelRouterQueryObservationChartsRequest &&) = default ;
    ModelRouterQueryObservationChartsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModelRouterQueryObservationChartsRequest() = default ;
    ModelRouterQueryObservationChartsRequest& operator=(const ModelRouterQueryObservationChartsRequest &) = default ;
    ModelRouterQueryObservationChartsRequest& operator=(ModelRouterQueryObservationChartsRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->apiKeyId_ == nullptr
        && this->clientId_ == nullptr && this->clientIds_ == nullptr && this->endTime_ == nullptr && this->memberUserIds_ == nullptr && this->modelId_ == nullptr
    ...
    inline ModelRouterQueryObservationChartsRequest& setApiKeyId(int64_t apiKeyId) { DARABONBA_PTR_SET_VALUE(apiKeyId_, apiKeyId) };
    ...
    inline ModelRouterQueryObservationChartsRequest& setClientId(int64_t clientId) { DARABONBA_PTR_SET_VALUE(clientId_, clientId) };
    ...
    inline ModelRouterQueryObservationChartsRequest& setClientIds(string clientIds) { DARABONBA_PTR_SET_VALUE(clientIds_, clientIds) };
    ...
    inline ModelRouterQueryObservationChartsRequest& setModelId(int64_t modelId) { DARABONBA_PTR_SET_VALUE(modelId_, modelId) };
    ...
    inline ModelRouterQueryObservationChartsRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ModelRouterQueryObservationChartsRequest& setTimeRange(string timeRange) { DARABONBA_PTR_SET_VALUE(timeRange_, timeRange) };
