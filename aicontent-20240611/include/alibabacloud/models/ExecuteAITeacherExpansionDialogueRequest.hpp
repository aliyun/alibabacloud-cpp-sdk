...
#ifndef ALIBABACLOUD_MODELS_EXECUTEAITEACHEREXPANSIONDIALOGUEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_EXECUTEAITEACHEREXPANSIONDIALOGUEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ExecuteAITeacherExpansionDialogueRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ExecuteAITeacherExpansionDialogueRequest& obj) { 
    ...
    ExecuteAITeacherExpansionDialogueRequest() = default ;
    ExecuteAITeacherExpansionDialogueRequest(const ExecuteAITeacherExpansionDialogueRequest &) = default ;
    ExecuteAITeacherExpansionDialogueRequest(ExecuteAITeacherExpansionDialogueRequest &&) = default ;
    ExecuteAITeacherExpansionDialogueRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExecuteAITeacherExpansionDialogueRequest() = default ;
    ExecuteAITeacherExpansionDialogueRequest& operator=(const ExecuteAITeacherExpansionDialogueRequest &) = default ;
    ExecuteAITeacherExpansionDialogueRequest& operator=(ExecuteAITeacherExpansionDialogueRequest &&) = default ;
    ...
    inline ExecuteAITeacherExpansionDialogueRequest& setBackground(string background) { DARABONBA_PTR_SET_VALUE(background_, background) };
    ...
    inline const vector<ExecuteAITeacherExpansionDialogueRequest::DialogueTasks> & getDialogueTasks() const { DARABONBA_PTR_GET_CONST(dialogueTasks_, vector<ExecuteAITeacherExpansionDialogueRequest::DialogueTasks>) };
    inline vector<ExecuteAITeacherExpansionDialogueRequest::DialogueTasks> getDialogueTasks() { DARABONBA_PTR_GET(dialogueTasks_, vector<ExecuteAITeacherExpansionDialogueRequest::DialogueTasks>) };
    inline ExecuteAITeacherExpansionDialogueRequest& setDialogueTasks(const vector<ExecuteAITeacherExpansionDialogueRequest::DialogueTasks> & dialogueTasks) { DARABONBA_PTR_SET_VALUE(dialogueTasks_, dialogueTasks) };
    inline ExecuteAITeacherExpansionDialogueRequest& setDialogueTasks(vector<ExecuteAITeacherExpansionDialogueRequest::DialogueTasks> && dialogueTasks) { DARABONBA_PTR_SET_RVALUE(dialogueTasks_, dialogueTasks) };
    ...
    inline ExecuteAITeacherExpansionDialogueRequest& setLanguageCode(string languageCode) { DARABONBA_PTR_SET_VALUE(languageCode_, languageCode) };


    // records Field Functions 
    bool hasRecords() const { return this->records_ != nullptr;};
    void deleteRecords() { this->records_ = nullptr;};
    inline const vector<ExecuteAITeacherExpansionDialogueRequest::Records> & getRecords() const { DARABONBA_PTR_GET_CONST(records_, vector<ExecuteAITeacherExpansionDialogueRequest::Records>) };
    inline vector<ExecuteAITeacherExpansionDialogueRequest::Records> getRecords() { DARABONBA_PTR_GET(records_, vector<ExecuteAITeacherExpansionDialogueRequest::Records>) };
    inline ExecuteAITeacherExpansionDialogueRequest& setRecords(const vector<ExecuteAITeacherExpansionDialogueRequest::Records> & records) { DARABONBA_PTR_SET_VALUE(records_, records) };
    inline ExecuteAITeacherExpansionDialogueRequest& setRecords(vector<ExecuteAITeacherExpansionDialogueRequest::Records> && records) { DARABONBA_PTR_SET_RVALUE(records_, records) };


    // roleInfo Field Functions 
    bool hasRoleInfo() const { return this->roleInfo_ != nullptr;};
    void deleteRoleInfo() { this->roleInfo_ = nullptr;};
    inline const ExecuteAITeacherExpansionDialogueRequest::RoleInfo & getRoleInfo() const { DARABONBA_PTR_GET_CONST(roleInfo_, ExecuteAITeacherExpansionDialogueRequest::RoleInfo) };
    inline ExecuteAITeacherExpansionDialogueRequest::RoleInfo getRoleInfo() { DARABONBA_PTR_GET(roleInfo_, ExecuteAITeacherExpansionDialogueRequest::RoleInfo) };
    inline ExecuteAITeacherExpansionDialogueRequest& setRoleInfo(const ExecuteAITeacherExpansionDialogueRequest::RoleInfo & roleInfo) { DARABONBA_PTR_SET_VALUE(roleInfo_, roleInfo) };
    inline ExecuteAITeacherExpansionDialogueRequest& setRoleInfo(ExecuteAITeacherExpansionDialogueRequest::RoleInfo && roleInfo) { DARABONBA_PTR_SET_RVALUE(roleInfo_, roleInfo) };
    ...
    inline ExecuteAITeacherExpansionDialogueRequest& setStartSentence(string startSentence) { DARABONBA_PTR_SET_VALUE(startSentence_, startSentence) };
    ...
    inline ExecuteAITeacherExpansionDialogueRequest& setTopic(string topic) { DARABONBA_PTR_SET_VALUE(topic_, topic) };
    ...
    inline ExecuteAITeacherExpansionDialogueRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<ExecuteAITeacherExpansionDialogueRequest::DialogueTasks>> dialogueTasks_ {};
    shared_ptr<string> languageCode_ {};
    shared_ptr<vector<ExecuteAITeacherExpansionDialogueRequest::Records>> records_ {};
    // This parameter is required.
    shared_ptr<ExecuteAITeacherExpansionDialogueRequest::RoleInfo> roleInfo_ {};
