...
#ifndef ALIBABACLOUD_MODELS_EXECUTETEXTBOOKASSISTANTRETRYCONVERSATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_EXECUTETEXTBOOKASSISTANTRETRYCONVERSATIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ExecuteTextbookAssistantRetryConversationResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ExecuteTextbookAssistantRetryConversationResponseBody& obj) { 
    ...
    ExecuteTextbookAssistantRetryConversationResponseBody() = default ;
    ExecuteTextbookAssistantRetryConversationResponseBody(const ExecuteTextbookAssistantRetryConversationResponseBody &) = default ;
    ExecuteTextbookAssistantRetryConversationResponseBody(ExecuteTextbookAssistantRetryConversationResponseBody &&) = default ;
    ExecuteTextbookAssistantRetryConversationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExecuteTextbookAssistantRetryConversationResponseBody() = default ;
    ExecuteTextbookAssistantRetryConversationResponseBody& operator=(const ExecuteTextbookAssistantRetryConversationResponseBody &) = default ;
    ExecuteTextbookAssistantRetryConversationResponseBody& operator=(ExecuteTextbookAssistantRetryConversationResponseBody &&) = default ;
    ...
    inline const ExecuteTextbookAssistantRetryConversationResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ExecuteTextbookAssistantRetryConversationResponseBody::Data) };
    inline ExecuteTextbookAssistantRetryConversationResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ExecuteTextbookAssistantRetryConversationResponseBody::Data) };
    inline ExecuteTextbookAssistantRetryConversationResponseBody& setData(const ExecuteTextbookAssistantRetryConversationResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ExecuteTextbookAssistantRetryConversationResponseBody& setData(ExecuteTextbookAssistantRetryConversationResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ExecuteTextbookAssistantRetryConversationResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline ExecuteTextbookAssistantRetryConversationResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline ExecuteTextbookAssistantRetryConversationResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ExecuteTextbookAssistantRetryConversationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ExecuteTextbookAssistantRetryConversationResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
