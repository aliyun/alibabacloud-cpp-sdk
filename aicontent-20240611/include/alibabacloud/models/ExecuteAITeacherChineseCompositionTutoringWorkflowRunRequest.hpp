...
#ifndef ALIBABACLOUD_MODELS_EXECUTEAITEACHERCHINESECOMPOSITIONTUTORINGWORKFLOWRUNREQUEST_HPP_
#define ALIBABACLOUD_MODELS_EXECUTEAITEACHERCHINESECOMPOSITIONTUTORINGWORKFLOWRUNREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& obj) { 
    ...
    ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest() = default ;
    ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest(const ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest &) = default ;
    ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest(ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest &&) = default ;
    ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest() = default ;
    ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& operator=(const ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest &) = default ;
    ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& operator=(ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest &&) = default ;
    ...
    inline ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& setEssayOutline(string essayOutline) { DARABONBA_PTR_SET_VALUE(essayOutline_, essayOutline) };
    ...
    inline ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& setEssayRequirements(string essayRequirements) { DARABONBA_PTR_SET_VALUE(essayRequirements_, essayRequirements) };
    ...
    inline ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& setEssayTopic(string essayTopic) { DARABONBA_PTR_SET_VALUE(essayTopic_, essayTopic) };
    ...
    inline ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& setEssayType(string essayType) { DARABONBA_PTR_SET_VALUE(essayType_, essayType) };
    ...
    inline ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& setEssayWordCount(int64_t essayWordCount) { DARABONBA_PTR_SET_VALUE(essayWordCount_, essayWordCount) };
    ...
    inline ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& setGrade(int64_t grade) { DARABONBA_PTR_SET_VALUE(grade_, grade) };
    ...
    inline ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& setResponseMode(string responseMode) { DARABONBA_PTR_SET_VALUE(responseMode_, responseMode) };
    ...
    inline ExecuteAITeacherChineseCompositionTutoringWorkflowRunRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
