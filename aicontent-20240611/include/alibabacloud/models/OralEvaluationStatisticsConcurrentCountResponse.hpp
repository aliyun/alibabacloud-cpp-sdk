...
#ifndef ALIBABACLOUD_MODELS_ORALEVALUATIONSTATISTICSCONCURRENTCOUNTRESPONSE_HPP_
#define ALIBABACLOUD_MODELS_ORALEVALUATIONSTATISTICSCONCURRENTCOUNTRESPONSE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const OralEvaluationStatisticsConcurrentCountResponse& obj) { 
      DARABONBA_PTR_TO_JSON(projectData, projectData_);
      DARABONBA_PTR_TO_JSON(projectId, projectId_);
    };
    friend void from_json(const Darabonba::Json& j, OralEvaluationStatisticsConcurrentCountResponse& obj) { 
      DARABONBA_PTR_FROM_JSON(projectData, projectData_);
      DARABONBA_PTR_FROM_JSON(projectId, projectId_);
    };
    OralEvaluationStatisticsConcurrentCountResponse() = default ;
    OralEvaluationStatisticsConcurrentCountResponse(const OralEvaluationStatisticsConcurrentCountResponse &) = default ;
    OralEvaluationStatisticsConcurrentCountResponse(OralEvaluationStatisticsConcurrentCountResponse &&) = default ;
    OralEvaluationStatisticsConcurrentCountResponse(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~OralEvaluationStatisticsConcurrentCountResponse() = default ;
    OralEvaluationStatisticsConcurrentCountResponse& operator=(const OralEvaluationStatisticsConcurrentCountResponse &) = default ;
    OralEvaluationStatisticsConcurrentCountResponse& operator=(OralEvaluationStatisticsConcurrentCountResponse &&) = default ;
    ...
    inline const OralEvaluationStatisticsConcurrentCountResponse::ProjectData & getProjectData() const { DARABONBA_PTR_GET_CONST(projectData_, OralEvaluationStatisticsConcurrentCountResponse::ProjectData) };
    inline OralEvaluationStatisticsConcurrentCountResponse::ProjectData getProjectData() { DARABONBA_PTR_GET(projectData_, OralEvaluationStatisticsConcurrentCountResponse::ProjectData) };
    inline OralEvaluationStatisticsConcurrentCountResponse& setProjectData(const OralEvaluationStatisticsConcurrentCountResponse::ProjectData & projectData) { DARABONBA_PTR_SET_VALUE(projectData_, projectData) };
    inline OralEvaluationStatisticsConcurrentCountResponse& setProjectData(OralEvaluationStatisticsConcurrentCountResponse::ProjectData && projectData) { DARABONBA_PTR_SET_RVALUE(projectData_, projectData) };
    ...
    inline OralEvaluationStatisticsConcurrentCountResponse& setProjectId(string projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
