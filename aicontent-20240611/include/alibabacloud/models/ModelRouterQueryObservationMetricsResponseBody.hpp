...
namespace Models
{
  ...
  public:
    ...
    inline const ModelMetricsDTO & getData() const { DARABONBA_PTR_GET_CONST(data_, ModelMetricsDTO) };
    inline ModelMetricsDTO getData() { DARABONBA_PTR_GET(data_, ModelMetricsDTO) };
    inline ModelRouterQueryObservationMetricsResponseBody& setData(const ModelMetricsDTO & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModelRouterQueryObservationMetricsResponseBody& setData(ModelMetricsDTO && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    shared_ptr<ModelMetricsDTO> data_ {};
