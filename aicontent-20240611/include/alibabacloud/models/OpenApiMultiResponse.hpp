...
#ifndef ALIBABACLOUD_MODELS_OPENAPIMULTIRESPONSE_HPP_
#define ALIBABACLOUD_MODELS_OPENAPIMULTIRESPONSE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const OpenApiMultiResponse& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, OpenApiMultiResponse& obj) { 
    ...
    OpenApiMultiResponse() = default ;
    OpenApiMultiResponse(const OpenApiMultiResponse &) = default ;
    OpenApiMultiResponse(OpenApiMultiResponse &&) = default ;
    OpenApiMultiResponse(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~OpenApiMultiResponse() = default ;
    OpenApiMultiResponse& operator=(const OpenApiMultiResponse &) = default ;
    OpenApiMultiResponse& operator=(OpenApiMultiResponse &&) = default ;
    ...
    inline const vector<OpenApiMultiResponse::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<OpenApiMultiResponse::Data>) };
    inline vector<OpenApiMultiResponse::Data> getData() { DARABONBA_PTR_GET(data_, vector<OpenApiMultiResponse::Data>) };
    inline OpenApiMultiResponse& setData(const vector<OpenApiMultiResponse::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline OpenApiMultiResponse& setData(vector<OpenApiMultiResponse::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline OpenApiMultiResponse& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline OpenApiMultiResponse& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline OpenApiMultiResponse& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline OpenApiMultiResponse& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline OpenApiMultiResponse& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<vector<OpenApiMultiResponse::Data>> data_ {};
