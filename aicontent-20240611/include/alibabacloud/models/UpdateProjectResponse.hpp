...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateProjectResponseBody) };
    inline UpdateProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateProjectResponseBody) };
    inline UpdateProjectResponse& setBody(const UpdateProjectResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateProjectResponse& setBody(UpdateProjectResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    shared_ptr<map<string, string>> headers_ {};
    shared_ptr<int32_t> statusCode_ {};
    shared_ptr<UpdateProjectResponseBody> body_ {};
  };
