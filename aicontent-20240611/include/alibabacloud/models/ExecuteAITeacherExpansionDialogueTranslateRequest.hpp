...
#ifndef ALIBABACLOUD_MODELS_EXECUTEAITEACHEREXPANSIONDIALOGUETRANSLATEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_EXECUTEAITEACHEREXPANSIONDIALOGUETRANSLATEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ExecuteAITeacherExpansionDialogueTranslateRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ExecuteAITeacherExpansionDialogueTranslateRequest& obj) { 
    ...
    ExecuteAITeacherExpansionDialogueTranslateRequest() = default ;
    ExecuteAITeacherExpansionDialogueTranslateRequest(const ExecuteAITeacherExpansionDialogueTranslateRequest &) = default ;
    ExecuteAITeacherExpansionDialogueTranslateRequest(ExecuteAITeacherExpansionDialogueTranslateRequest &&) = default ;
    ExecuteAITeacherExpansionDialogueTranslateRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExecuteAITeacherExpansionDialogueTranslateRequest() = default ;
    ExecuteAITeacherExpansionDialogueTranslateRequest& operator=(const ExecuteAITeacherExpansionDialogueTranslateRequest &) = default ;
    ExecuteAITeacherExpansionDialogueTranslateRequest& operator=(ExecuteAITeacherExpansionDialogueTranslateRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->background_ == nullptr
        && this->dialogueTasks_ == nullptr && this->records_ == nullptr && this->roleInfo_ == nullptr && this->startSentence_ == nullptr && this->topic_ == nullptr
    ...
    inline ExecuteAITeacherExpansionDialogueTranslateRequest& setBackground(string background) { DARABONBA_PTR_SET_VALUE(background_, background) };
    ...
    inline const vector<ExecuteAITeacherExpansionDialogueTranslateRequest::DialogueTasks> & getDialogueTasks() const { DARABONBA_PTR_GET_CONST(dialogueTasks_, vector<ExecuteAITeacherExpansionDialogueTranslateRequest::DialogueTasks>) };
    inline vector<ExecuteAITeacherExpansionDialogueTranslateRequest::DialogueTasks> getDialogueTasks() { DARABONBA_PTR_GET(dialogueTasks_, vector<ExecuteAITeacherExpansionDialogueTranslateRequest::DialogueTasks>) };
    inline ExecuteAITeacherExpansionDialogueTranslateRequest& setDialogueTasks(const vector<ExecuteAITeacherExpansionDialogueTranslateRequest::DialogueTasks> & dialogueTasks) { DARABONBA_PTR_SET_VALUE(dialogueTasks_, dialogueTasks) };
    inline ExecuteAITeacherExpansionDialogueTranslateRequest& setDialogueTasks(vector<ExecuteAITeacherExpansionDialogueTranslateRequest::DialogueTasks> && dialogueTasks) { DARABONBA_PTR_SET_RVALUE(dialogueTasks_, dialogueTasks) };


    // records Field Functions 
    bool hasRecords() const { return this->records_ != nullptr;};
    void deleteRecords() { this->records_ = nullptr;};
    inline const vector<ExecuteAITeacherExpansionDialogueTranslateRequest::Records> & getRecords() const { DARABONBA_PTR_GET_CONST(records_, vector<ExecuteAITeacherExpansionDialogueTranslateRequest::Records>) };
    inline vector<ExecuteAITeacherExpansionDialogueTranslateRequest::Records> getRecords() { DARABONBA_PTR_GET(records_, vector<ExecuteAITeacherExpansionDialogueTranslateRequest::Records>) };
    inline ExecuteAITeacherExpansionDialogueTranslateRequest& setRecords(const vector<ExecuteAITeacherExpansionDialogueTranslateRequest::Records> & records) { DARABONBA_PTR_SET_VALUE(records_, records) };
    inline ExecuteAITeacherExpansionDialogueTranslateRequest& setRecords(vector<ExecuteAITeacherExpansionDialogueTranslateRequest::Records> && records) { DARABONBA_PTR_SET_RVALUE(records_, records) };


    // roleInfo Field Functions 
    bool hasRoleInfo() const { return this->roleInfo_ != nullptr;};
    void deleteRoleInfo() { this->roleInfo_ = nullptr;};
    inline const ExecuteAITeacherExpansionDialogueTranslateRequest::RoleInfo & getRoleInfo() const { DARABONBA_PTR_GET_CONST(roleInfo_, ExecuteAITeacherExpansionDialogueTranslateRequest::RoleInfo) };
    inline ExecuteAITeacherExpansionDialogueTranslateRequest::RoleInfo getRoleInfo() { DARABONBA_PTR_GET(roleInfo_, ExecuteAITeacherExpansionDialogueTranslateRequest::RoleInfo) };
    inline ExecuteAITeacherExpansionDialogueTranslateRequest& setRoleInfo(const ExecuteAITeacherExpansionDialogueTranslateRequest::RoleInfo & roleInfo) { DARABONBA_PTR_SET_VALUE(roleInfo_, roleInfo) };
    inline ExecuteAITeacherExpansionDialogueTranslateRequest& setRoleInfo(ExecuteAITeacherExpansionDialogueTranslateRequest::RoleInfo && roleInfo) { DARABONBA_PTR_SET_RVALUE(roleInfo_, roleInfo) };
    ...
    inline ExecuteAITeacherExpansionDialogueTranslateRequest& setStartSentence(string startSentence) { DARABONBA_PTR_SET_VALUE(startSentence_, startSentence) };
    ...
    inline ExecuteAITeacherExpansionDialogueTranslateRequest& setTopic(string topic) { DARABONBA_PTR_SET_VALUE(topic_, topic) };
    ...
    inline ExecuteAITeacherExpansionDialogueTranslateRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
