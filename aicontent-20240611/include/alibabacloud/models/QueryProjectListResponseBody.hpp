...
#ifndef ALIBABACLOUD_MODELS_QUERYPROJECTLISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYPROJECTLISTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryProjectListResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryProjectListResponseBody& obj) { 
    ...
    QueryProjectListResponseBody() = default ;
    QueryProjectListResponseBody(const QueryProjectListResponseBody &) = default ;
    QueryProjectListResponseBody(QueryProjectListResponseBody &&) = default ;
    QueryProjectListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryProjectListResponseBody() = default ;
    QueryProjectListResponseBody& operator=(const QueryProjectListResponseBody &) = default ;
    QueryProjectListResponseBody& operator=(QueryProjectListResponseBody &&) = default ;
    ...
    inline const vector<QueryProjectListResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryProjectListResponseBody::Data>) };
    inline vector<QueryProjectListResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<QueryProjectListResponseBody::Data>) };
    inline QueryProjectListResponseBody& setData(const vector<QueryProjectListResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryProjectListResponseBody& setData(vector<QueryProjectListResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryProjectListResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline QueryProjectListResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline QueryProjectListResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryProjectListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryProjectListResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
