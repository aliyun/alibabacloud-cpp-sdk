...
#ifndef ALIBABACLOUD_MODELS_AITEACHEREXPANSIONPRACTICETASKGENERATEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_AITEACHEREXPANSIONPRACTICETASKGENERATEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AITeacherExpansionPracticeTaskGenerateRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AITeacherExpansionPracticeTaskGenerateRequest& obj) { 
    ...
    AITeacherExpansionPracticeTaskGenerateRequest() = default ;
    AITeacherExpansionPracticeTaskGenerateRequest(const AITeacherExpansionPracticeTaskGenerateRequest &) = default ;
    AITeacherExpansionPracticeTaskGenerateRequest(AITeacherExpansionPracticeTaskGenerateRequest &&) = default ;
    AITeacherExpansionPracticeTaskGenerateRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AITeacherExpansionPracticeTaskGenerateRequest() = default ;
    AITeacherExpansionPracticeTaskGenerateRequest& operator=(const AITeacherExpansionPracticeTaskGenerateRequest &) = default ;
    AITeacherExpansionPracticeTaskGenerateRequest& operator=(AITeacherExpansionPracticeTaskGenerateRequest &&) = default ;
    ...
    inline AITeacherExpansionPracticeTaskGenerateRequest& setGrade(string grade) { DARABONBA_PTR_SET_VALUE(grade_, grade) };
    ...
    inline AITeacherExpansionPracticeTaskGenerateRequest& setKeySentences(const vector<string> & keySentences) { DARABONBA_PTR_SET_VALUE(keySentences_, keySentences) };
    inline AITeacherExpansionPracticeTaskGenerateRequest& setKeySentences(vector<string> && keySentences) { DARABONBA_PTR_SET_RVALUE(keySentences_, keySentences) };
    ...
    inline AITeacherExpansionPracticeTaskGenerateRequest& setKeyWords(const vector<string> & keyWords) { DARABONBA_PTR_SET_VALUE(keyWords_, keyWords) };
    inline AITeacherExpansionPracticeTaskGenerateRequest& setKeyWords(vector<string> && keyWords) { DARABONBA_PTR_SET_RVALUE(keyWords_, keyWords) };
    ...
    inline AITeacherExpansionPracticeTaskGenerateRequest& setLearningObject(string learningObject) { DARABONBA_PTR_SET_VALUE(learningObject_, learningObject) };
    ...
    inline AITeacherExpansionPracticeTaskGenerateRequest& setTextContent(string textContent) { DARABONBA_PTR_SET_VALUE(textContent_, textContent) };
    ...
    inline AITeacherExpansionPracticeTaskGenerateRequest& setTextbook(string textbook) { DARABONBA_PTR_SET_VALUE(textbook_, textbook) };
    ...
    inline AITeacherExpansionPracticeTaskGenerateRequest& setTopic(string topic) { DARABONBA_PTR_SET_VALUE(topic_, topic) };
    ...
    inline AITeacherExpansionPracticeTaskGenerateRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
