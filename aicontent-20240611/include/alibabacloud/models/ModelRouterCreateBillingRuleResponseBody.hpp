...
#ifndef ALIBABACLOUD_MODELS_MODELROUTERCREATEBILLINGRULERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MODELROUTERCREATEBILLINGRULERESPONSEBODY_HPP_
...
namespace Models
{
  class ModelRouterCreateBillingRuleResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModelRouterCreateBillingRuleResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModelRouterCreateBillingRuleResponseBody& obj) { 
    ...
    ModelRouterCreateBillingRuleResponseBody() = default ;
    ModelRouterCreateBillingRuleResponseBody(const ModelRouterCreateBillingRuleResponseBody &) = default ;
    ModelRouterCreateBillingRuleResponseBody(ModelRouterCreateBillingRuleResponseBody &&) = default ;
    ModelRouterCreateBillingRuleResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModelRouterCreateBillingRuleResponseBody() = default ;
    ModelRouterCreateBillingRuleResponseBody& operator=(const ModelRouterCreateBillingRuleResponseBody &) = default ;
    ModelRouterCreateBillingRuleResponseBody& operator=(ModelRouterCreateBillingRuleResponseBody &&) = default ;
    ...
    inline const ModelRouterCreateBillingRuleResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModelRouterCreateBillingRuleResponseBody::Data) };
    inline ModelRouterCreateBillingRuleResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModelRouterCreateBillingRuleResponseBody::Data) };
    inline ModelRouterCreateBillingRuleResponseBody& setData(const ModelRouterCreateBillingRuleResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModelRouterCreateBillingRuleResponseBody& setData(ModelRouterCreateBillingRuleResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ModelRouterCreateBillingRuleResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline ModelRouterCreateBillingRuleResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline ModelRouterCreateBillingRuleResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ModelRouterCreateBillingRuleResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ModelRouterCreateBillingRuleResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
