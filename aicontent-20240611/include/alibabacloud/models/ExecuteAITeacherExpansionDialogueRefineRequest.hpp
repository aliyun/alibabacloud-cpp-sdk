...
#ifndef ALIBABACLOUD_MODELS_EXECUTEAITEACHEREXPANSIONDIALOGUEREFINEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_EXECUTEAITEACHEREXPANSIONDIALOGUEREFINEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ExecuteAITeacherExpansionDialogueRefineRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ExecuteAITeacherExpansionDialogueRefineRequest& obj) { 
    ...
    ExecuteAITeacherExpansionDialogueRefineRequest() = default ;
    ExecuteAITeacherExpansionDialogueRefineRequest(const ExecuteAITeacherExpansionDialogueRefineRequest &) = default ;
    ExecuteAITeacherExpansionDialogueRefineRequest(ExecuteAITeacherExpansionDialogueRefineRequest &&) = default ;
    ExecuteAITeacherExpansionDialogueRefineRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExecuteAITeacherExpansionDialogueRefineRequest() = default ;
    ExecuteAITeacherExpansionDialogueRefineRequest& operator=(const ExecuteAITeacherExpansionDialogueRefineRequest &) = default ;
    ExecuteAITeacherExpansionDialogueRefineRequest& operator=(ExecuteAITeacherExpansionDialogueRefineRequest &&) = default ;
    ...
    inline ExecuteAITeacherExpansionDialogueRefineRequest& setBackground(string background) { DARABONBA_PTR_SET_VALUE(background_, background) };
    ...
    inline const vector<ExecuteAITeacherExpansionDialogueRefineRequest::DialogueTasks> & getDialogueTasks() const { DARABONBA_PTR_GET_CONST(dialogueTasks_, vector<ExecuteAITeacherExpansionDialogueRefineRequest::DialogueTasks>) };
    inline vector<ExecuteAITeacherExpansionDialogueRefineRequest::DialogueTasks> getDialogueTasks() { DARABONBA_PTR_GET(dialogueTasks_, vector<ExecuteAITeacherExpansionDialogueRefineRequest::DialogueTasks>) };
    inline ExecuteAITeacherExpansionDialogueRefineRequest& setDialogueTasks(const vector<ExecuteAITeacherExpansionDialogueRefineRequest::DialogueTasks> & dialogueTasks) { DARABONBA_PTR_SET_VALUE(dialogueTasks_, dialogueTasks) };
    inline ExecuteAITeacherExpansionDialogueRefineRequest& setDialogueTasks(vector<ExecuteAITeacherExpansionDialogueRefineRequest::DialogueTasks> && dialogueTasks) { DARABONBA_PTR_SET_RVALUE(dialogueTasks_, dialogueTasks) };
    ...
    inline ExecuteAITeacherExpansionDialogueRefineRequest& setLanguageCode(string languageCode) { DARABONBA_PTR_SET_VALUE(languageCode_, languageCode) };


    // records Field Functions 
    bool hasRecords() const { return this->records_ != nullptr;};
    void deleteRecords() { this->records_ = nullptr;};
    inline const vector<ExecuteAITeacherExpansionDialogueRefineRequest::Records> & getRecords() const { DARABONBA_PTR_GET_CONST(records_, vector<ExecuteAITeacherExpansionDialogueRefineRequest::Records>) };
    inline vector<ExecuteAITeacherExpansionDialogueRefineRequest::Records> getRecords() { DARABONBA_PTR_GET(records_, vector<ExecuteAITeacherExpansionDialogueRefineRequest::Records>) };
    inline ExecuteAITeacherExpansionDialogueRefineRequest& setRecords(const vector<ExecuteAITeacherExpansionDialogueRefineRequest::Records> & records) { DARABONBA_PTR_SET_VALUE(records_, records) };
    inline ExecuteAITeacherExpansionDialogueRefineRequest& setRecords(vector<ExecuteAITeacherExpansionDialogueRefineRequest::Records> && records) { DARABONBA_PTR_SET_RVALUE(records_, records) };


    // roleInfo Field Functions 
    bool hasRoleInfo() const { return this->roleInfo_ != nullptr;};
    void deleteRoleInfo() { this->roleInfo_ = nullptr;};
    inline const ExecuteAITeacherExpansionDialogueRefineRequest::RoleInfo & getRoleInfo() const { DARABONBA_PTR_GET_CONST(roleInfo_, ExecuteAITeacherExpansionDialogueRefineRequest::RoleInfo) };
    inline ExecuteAITeacherExpansionDialogueRefineRequest::RoleInfo getRoleInfo() { DARABONBA_PTR_GET(roleInfo_, ExecuteAITeacherExpansionDialogueRefineRequest::RoleInfo) };
    inline ExecuteAITeacherExpansionDialogueRefineRequest& setRoleInfo(const ExecuteAITeacherExpansionDialogueRefineRequest::RoleInfo & roleInfo) { DARABONBA_PTR_SET_VALUE(roleInfo_, roleInfo) };
    inline ExecuteAITeacherExpansionDialogueRefineRequest& setRoleInfo(ExecuteAITeacherExpansionDialogueRefineRequest::RoleInfo && roleInfo) { DARABONBA_PTR_SET_RVALUE(roleInfo_, roleInfo) };
    ...
    inline ExecuteAITeacherExpansionDialogueRefineRequest& setStartSentence(string startSentence) { DARABONBA_PTR_SET_VALUE(startSentence_, startSentence) };
    ...
    inline ExecuteAITeacherExpansionDialogueRefineRequest& setTopic(string topic) { DARABONBA_PTR_SET_VALUE(topic_, topic) };
    ...
    inline ExecuteAITeacherExpansionDialogueRefineRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<ExecuteAITeacherExpansionDialogueRefineRequest::DialogueTasks>> dialogueTasks_ {};
    shared_ptr<string> languageCode_ {};
    // This parameter is required.
    shared_ptr<vector<ExecuteAITeacherExpansionDialogueRefineRequest::Records>> records_ {};
    // This parameter is required.
    shared_ptr<ExecuteAITeacherExpansionDialogueRefineRequest::RoleInfo> roleInfo_ {};
