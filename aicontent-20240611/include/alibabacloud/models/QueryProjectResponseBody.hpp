...
#ifndef ALIBABACLOUD_MODELS_QUERYPROJECTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYPROJECTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryProjectResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryProjectResponseBody& obj) { 
    ...
    QueryProjectResponseBody() = default ;
    QueryProjectResponseBody(const QueryProjectResponseBody &) = default ;
    QueryProjectResponseBody(QueryProjectResponseBody &&) = default ;
    QueryProjectResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryProjectResponseBody() = default ;
    QueryProjectResponseBody& operator=(const QueryProjectResponseBody &) = default ;
    QueryProjectResponseBody& operator=(QueryProjectResponseBody &&) = default ;
    ...
    inline const QueryProjectResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, QueryProjectResponseBody::Data) };
    inline QueryProjectResponseBody::Data getData() { DARABONBA_PTR_GET(data_, QueryProjectResponseBody::Data) };
    inline QueryProjectResponseBody& setData(const QueryProjectResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryProjectResponseBody& setData(QueryProjectResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryProjectResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline QueryProjectResponseBody& setErrMessage(string errMessage) { DARABONBA_PTR_SET_VALUE(errMessage_, errMessage) };
    ...
    inline QueryProjectResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline QueryProjectResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryProjectResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<QueryProjectResponseBody::Data> data_ {};
