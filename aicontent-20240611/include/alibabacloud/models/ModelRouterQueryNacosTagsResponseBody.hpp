...
namespace Models
{
  ...
  public:
    ...
    inline ModelRouterQueryNacosTagsResponseBody& setData(const vector<string> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModelRouterQueryNacosTagsResponseBody& setData(vector<string> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ModelRouterQueryNacosTagsResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ModelRouterQueryNacosTagsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ModelRouterQueryNacosTagsResponseBody& setPageIndex(int32_t pageIndex) { DARABONBA_PTR_SET_VALUE(pageIndex_, pageIndex) };
    ...
    inline ModelRouterQueryNacosTagsResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ModelRouterQueryNacosTagsResponseBody& setSkip(int32_t skip) { DARABONBA_PTR_SET_VALUE(skip_, skip) };
    ...
    inline ModelRouterQueryNacosTagsResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
