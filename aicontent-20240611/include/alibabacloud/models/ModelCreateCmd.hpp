...
#ifndef ALIBABACLOUD_MODELS_MODELCREATECMD_HPP_
#define ALIBABACLOUD_MODELS_MODELCREATECMD_HPP_
...
namespace Models
{
  class ModelCreateCmd : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModelCreateCmd& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModelCreateCmd& obj) { 
    ...
    ModelCreateCmd() = default ;
    ModelCreateCmd(const ModelCreateCmd &) = default ;
    ModelCreateCmd(ModelCreateCmd &&) = default ;
    ModelCreateCmd(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModelCreateCmd() = default ;
    ModelCreateCmd& operator=(const ModelCreateCmd &) = default ;
    ModelCreateCmd& operator=(ModelCreateCmd &&) = default ;
    ...
    inline ModelCreateCmd& setApiKey(string apiKey) { DARABONBA_PTR_SET_VALUE(apiKey_, apiKey) };
    ...
    inline ModelCreateCmd& setBaseUrl(string baseUrl) { DARABONBA_PTR_SET_VALUE(baseUrl_, baseUrl) };
    ...
    inline ModelCreateCmd& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ModelCreateCmd& setMaxInputLength(string maxInputLength) { DARABONBA_PTR_SET_VALUE(maxInputLength_, maxInputLength) };
    ...
    inline ModelCreateCmd& setMaxOutputLength(string maxOutputLength) { DARABONBA_PTR_SET_VALUE(maxOutputLength_, maxOutputLength) };
    ...
    inline ModelCreateCmd& setModelId(string modelId) { DARABONBA_PTR_SET_VALUE(modelId_, modelId) };
    ...
    inline ModelCreateCmd& setModelType(string modelType) { DARABONBA_PTR_SET_VALUE(modelType_, modelType) };
    ...
    inline ModelCreateCmd& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ModelCreateCmd& setSymbol(string symbol) { DARABONBA_PTR_SET_VALUE(symbol_, symbol) };
    ...
    inline ModelCreateCmd& setTags(string tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
