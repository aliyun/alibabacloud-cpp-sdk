...
#ifndef ALIBABACLOUD_MODELS_BILLORDERENTRYDTO_HPP_
#define ALIBABACLOUD_MODELS_BILLORDERENTRYDTO_HPP_
...
namespace Models
{
  class BillOrderEntryDTO : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const BillOrderEntryDTO& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, BillOrderEntryDTO& obj) { 
    ...
    BillOrderEntryDTO() = default ;
    BillOrderEntryDTO(const BillOrderEntryDTO &) = default ;
    BillOrderEntryDTO(BillOrderEntryDTO &&) = default ;
    BillOrderEntryDTO(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BillOrderEntryDTO() = default ;
    BillOrderEntryDTO& operator=(const BillOrderEntryDTO &) = default ;
    BillOrderEntryDTO& operator=(BillOrderEntryDTO &&) = default ;
    ...
    inline BillOrderEntryDTO& setAmount(double amount) { DARABONBA_PTR_SET_VALUE(amount_, amount) };
    ...
    inline BillOrderEntryDTO& setBalanceAfter(double balanceAfter) { DARABONBA_PTR_SET_VALUE(balanceAfter_, balanceAfter) };
    ...
    inline BillOrderEntryDTO& setBalanceBefore(double balanceBefore) { DARABONBA_PTR_SET_VALUE(balanceBefore_, balanceBefore) };
    ...
    inline BillOrderEntryDTO& setBalanceType(string balanceType) { DARABONBA_PTR_SET_VALUE(balanceType_, balanceType) };
    ...
    inline BillOrderEntryDTO& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline BillOrderEntryDTO& setDirection(string direction) { DARABONBA_PTR_SET_VALUE(direction_, direction) };
    ...
    inline BillOrderEntryDTO& setModelCode(string modelCode) { DARABONBA_PTR_SET_VALUE(modelCode_, modelCode) };
    ...
    inline BillOrderEntryDTO& setOperatorId(string operatorId) { DARABONBA_PTR_SET_VALUE(operatorId_, operatorId) };
    ...
    inline BillOrderEntryDTO& setOrderId(string orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline BillOrderEntryDTO& setOrderType(string orderType) { DARABONBA_PTR_SET_VALUE(orderType_, orderType) };
    ...
    inline BillOrderEntryDTO& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline BillOrderEntryDTO& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline BillOrderEntryDTO& setTotalAfter(double totalAfter) { DARABONBA_PTR_SET_VALUE(totalAfter_, totalAfter) };
    ...
    inline BillOrderEntryDTO& setTotalBefore(double totalBefore) { DARABONBA_PTR_SET_VALUE(totalBefore_, totalBefore) };
