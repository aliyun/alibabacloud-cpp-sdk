...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExtensionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExtensionResponseBody) };
    inline DescribeExtensionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExtensionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExtensionResponseBody> body_ {};
  };
