...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteStreamingDataServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteStreamingDataServiceResponseBody) };
    inline DeleteStreamingDataServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteStreamingDataServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteStreamingDataServiceResponseBody> body_ {};
  };
