...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->certCommonName_ == nullptr
        && return this->DBInstanceId_ == nullptr && return this->DBInstanceName_ == nullptr && return this->requestId_ == nullptr && return this->SSLEnabled_ == nullptr && return this->SSLExpiredTime_ == nullptr; };
