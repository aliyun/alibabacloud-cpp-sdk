...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aiNodes_ == nullptr
        ...
        && return this->modelServiceId_ == nullptr && return this->privateConnUrl_ == nullptr && return this->publicConnUrl_ == nullptr && return this->securityIPList_ == nullptr && return this->status_ == nullptr; };
