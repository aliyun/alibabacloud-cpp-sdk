...
namespace Models
{
  ...
  public:
    ...
    inline const CheckJDBCSourceNetConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckJDBCSourceNetConnectionResponseBody) };
    inline CheckJDBCSourceNetConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckJDBCSourceNetConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckJDBCSourceNetConnectionResponseBody> body_ {};
  };
