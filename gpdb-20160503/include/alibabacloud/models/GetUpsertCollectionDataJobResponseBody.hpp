...
namespace Models
{
  ...
  public:
    ...
    inline const GetUpsertCollectionDataJobResponseBodyJob & job() const { DARABONBA_PTR_GET_CONST(job_, GetUpsertCollectionDataJobResponseBodyJob) };
    inline GetUpsertCollectionDataJobResponseBodyJob job() { DARABONBA_PTR_GET(job_, GetUpsertCollectionDataJobResponseBodyJob) };
    inline GetUpsertCollectionDataJobResponseBody& setJob(const GetUpsertCollectionDataJobResponseBodyJob & job) { DARABONBA_PTR_SET_VALUE(job_, job) };
    inline GetUpsertCollectionDataJobResponseBody& setJob(GetUpsertCollectionDataJobResponseBodyJob && job) { DARABONBA_PTR_SET_RVALUE(job_, job) };
  ...
  protected:
    ...
    std::shared_ptr<GetUpsertCollectionDataJobResponseBodyJob> job_ = nullptr;
