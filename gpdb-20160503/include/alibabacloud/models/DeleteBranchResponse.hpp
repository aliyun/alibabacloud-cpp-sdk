...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBranchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBranchResponseBody) };
    inline DeleteBranchResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBranchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBranchResponseBody> body_ {};
  };
