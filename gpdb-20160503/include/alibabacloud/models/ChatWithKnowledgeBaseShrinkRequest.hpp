...
#ifndef ALIBABACLOUD_MODELS_CHATWITHKNOWLEDGEBASESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CHATWITHKNOWLEDGEBASESHRINKREQUEST_HPP_
...
namespace Models
{
  class ChatWithKnowledgeBaseShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ChatWithKnowledgeBaseShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ChatWithKnowledgeBaseShrinkRequest& obj) { 
    ...
    ChatWithKnowledgeBaseShrinkRequest() = default ;
    ChatWithKnowledgeBaseShrinkRequest(const ChatWithKnowledgeBaseShrinkRequest &) = default ;
    ChatWithKnowledgeBaseShrinkRequest(ChatWithKnowledgeBaseShrinkRequest &&) = default ;
    ChatWithKnowledgeBaseShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ChatWithKnowledgeBaseShrinkRequest() = default ;
    ChatWithKnowledgeBaseShrinkRequest& operator=(const ChatWithKnowledgeBaseShrinkRequest &) = default ;
    ChatWithKnowledgeBaseShrinkRequest& operator=(ChatWithKnowledgeBaseShrinkRequest &&) = default ;
    ...
    inline ChatWithKnowledgeBaseShrinkRequest& setDBInstanceId(string DBInstanceId) { DARABONBA_PTR_SET_VALUE(DBInstanceId_, DBInstanceId) };
    ...
    inline ChatWithKnowledgeBaseShrinkRequest& setIncludeKnowledgeBaseResults(bool includeKnowledgeBaseResults) { DARABONBA_PTR_SET_VALUE(includeKnowledgeBaseResults_, includeKnowledgeBaseResults) };
    ...
    inline ChatWithKnowledgeBaseShrinkRequest& setKnowledgeParamsShrink(string knowledgeParamsShrink) { DARABONBA_PTR_SET_VALUE(knowledgeParamsShrink_, knowledgeParamsShrink) };
    ...
    inline ChatWithKnowledgeBaseShrinkRequest& setModelParamsShrink(string modelParamsShrink) { DARABONBA_PTR_SET_VALUE(modelParamsShrink_, modelParamsShrink) };
    ...
    inline ChatWithKnowledgeBaseShrinkRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ChatWithKnowledgeBaseShrinkRequest& setPromptParams(string promptParams) { DARABONBA_PTR_SET_VALUE(promptParams_, promptParams) };
    ...
    inline ChatWithKnowledgeBaseShrinkRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
