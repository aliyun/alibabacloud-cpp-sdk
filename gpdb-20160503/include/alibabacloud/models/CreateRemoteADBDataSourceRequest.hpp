...
namespace Models
{
  ...
  public:
    ...
    inline string getManagerUserPassword() const { DARABONBA_PTR_GET_DEFAULT(managerUserPassword_, "") };
    ...
    inline string getRemoteDBInstanceId() const { DARABONBA_PTR_GET_DEFAULT(remoteDBInstanceId_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> managerUserPassword_ {};
    shared_ptr<int64_t> ownerId_ {};
    // Instance ID providing the data (required).
    // 
    // This parameter is required.
    shared_ptr<string> remoteDBInstanceId_ {};
