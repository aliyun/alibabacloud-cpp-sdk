...
namespace Models
{
  ...
  public:
    ...
    inline const ChatWithKnowledgeBaseStreamResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ChatWithKnowledgeBaseStreamResponseBody) };
    inline ChatWithKnowledgeBaseStreamResponseBody body() { DARABONBA_PTR_GET(body_, ChatWithKnowledgeBaseStreamResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ChatWithKnowledgeBaseStreamResponseBody> body_ = nullptr;
  };
