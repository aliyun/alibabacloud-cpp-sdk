...
namespace Models
{
  ...
  public:
    ...
    inline ChatWithKnowledgeBaseStreamResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ChatWithKnowledgeBaseStreamResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };
