...
namespace Models
{
  ...
  public:
    ...
    inline const ListBackupJobsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListBackupJobsResponseBody) };
    inline ListBackupJobsResponseBody body() { DARABONBA_PTR_GET(body_, ListBackupJobsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListBackupJobsResponseBody> body_ = nullptr;
  };
