...
namespace Models
{
  ...
  public:
    ...
    inline const ResumeInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResumeInstanceResponseBody) };
    inline ResumeInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, ResumeInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResumeInstanceResponseBody> body_ {};
  };
