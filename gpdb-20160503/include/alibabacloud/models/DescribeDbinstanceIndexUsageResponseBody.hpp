...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDBInstanceIndexUsageResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeDBInstanceIndexUsageResponseBodyItems>) };
    inline vector<DescribeDBInstanceIndexUsageResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeDBInstanceIndexUsageResponseBodyItems>) };
    inline DescribeDBInstanceIndexUsageResponseBody& setItems(const vector<DescribeDBInstanceIndexUsageResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDBInstanceIndexUsageResponseBody& setItems(vector<DescribeDBInstanceIndexUsageResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDBInstanceIndexUsageResponseBodyItems>> items_ = nullptr;
    // The page number.
