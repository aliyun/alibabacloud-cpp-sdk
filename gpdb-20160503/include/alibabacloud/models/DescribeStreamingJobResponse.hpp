...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeStreamingJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeStreamingJobResponseBody) };
    inline DescribeStreamingJobResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeStreamingJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeStreamingJobResponseBody> body_ {};
  };
