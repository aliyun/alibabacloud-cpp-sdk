...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->collection_ == nullptr
        ...
        && return this->regionId_ == nullptr && return this->sparseVectorIndexConfigShrink_ == nullptr && return this->supportSparse_ == nullptr && return this->workspaceId_ == nullptr; };
    ...
    inline string sparseVectorIndexConfigShrink() const { DARABONBA_PTR_GET_DEFAULT(sparseVectorIndexConfigShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> sparseVectorIndexConfigShrink_ = nullptr;
