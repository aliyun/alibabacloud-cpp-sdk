...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstanceResourceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBInstanceResourceGroupResponseBody) };
    inline ModifyDBInstanceResourceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBInstanceResourceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBInstanceResourceGroupResponseBody> body_ {};
  };
