...
namespace Models
{
  ...
  public:
    ...
    inline const CreateStreamingDataServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateStreamingDataServiceResponseBody) };
    inline CreateStreamingDataServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateStreamingDataServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateStreamingDataServiceResponseBody> body_ {};
  };
