...
namespace Models
{
  ...
  public:
    ...
    inline const ListStreamingDataSourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListStreamingDataSourcesResponseBody) };
    inline ListStreamingDataSourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListStreamingDataSourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListStreamingDataSourcesResponseBody> body_ {};
  };
