...
namespace Models
{
  ...
  public:
    ...
    inline const ListExternalDataSourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExternalDataSourcesResponseBody) };
    inline ListExternalDataSourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExternalDataSourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExternalDataSourcesResponseBody> body_ {};
  };
