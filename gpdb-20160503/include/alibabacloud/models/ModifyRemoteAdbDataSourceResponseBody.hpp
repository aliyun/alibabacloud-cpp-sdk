...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyRemoteADBDataSourceResponseBodyDataSourceItem & dataSourceItem() const { DARABONBA_PTR_GET_CONST(dataSourceItem_, ModifyRemoteADBDataSourceResponseBodyDataSourceItem) };
    inline ModifyRemoteADBDataSourceResponseBodyDataSourceItem dataSourceItem() { DARABONBA_PTR_GET(dataSourceItem_, ModifyRemoteADBDataSourceResponseBodyDataSourceItem) };
    inline ModifyRemoteADBDataSourceResponseBody& setDataSourceItem(const ModifyRemoteADBDataSourceResponseBodyDataSourceItem & dataSourceItem) { DARABONBA_PTR_SET_VALUE(dataSourceItem_, dataSourceItem) };
    inline ModifyRemoteADBDataSourceResponseBody& setDataSourceItem(ModifyRemoteADBDataSourceResponseBodyDataSourceItem && dataSourceItem) { DARABONBA_PTR_SET_RVALUE(dataSourceItem_, dataSourceItem) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyRemoteADBDataSourceResponseBodyDataSourceItem> dataSourceItem_ = nullptr;
    // Request ID.
