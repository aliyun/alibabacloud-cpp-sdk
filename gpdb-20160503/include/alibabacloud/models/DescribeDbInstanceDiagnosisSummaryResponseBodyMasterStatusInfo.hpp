...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDBINSTANCEDIAGNOSISSUMMARYRESPONSEBODYMASTERSTATUSINFO_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDBINSTANCEDIAGNOSISSUMMARYRESPONSEBODYMASTERSTATUSINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo& obj) { 
    ...
    DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo() = default ;
    DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo(const DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo &) = default ;
    DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo(DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo &&) = default ;
    DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo() = default ;
    DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo& operator=(const DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo &) = default ;
    DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo& operator=(DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo &&) = default ;
    ...
    inline DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo& setExceptionNodeNum(int32_t exceptionNodeNum) { DARABONBA_PTR_SET_VALUE(exceptionNodeNum_, exceptionNodeNum) };
    ...
    inline DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo& setNormalNodeNum(int32_t normalNodeNum) { DARABONBA_PTR_SET_VALUE(normalNodeNum_, normalNodeNum) };
    ...
    inline DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo& setNotPreferredNodeNum(int32_t notPreferredNodeNum) { DARABONBA_PTR_SET_VALUE(notPreferredNodeNum_, notPreferredNodeNum) };
    ...
    inline DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo& setNotSyncingNodeNum(int32_t notSyncingNodeNum) { DARABONBA_PTR_SET_VALUE(notSyncingNodeNum_, notSyncingNodeNum) };
    ...
    inline DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo& setPreferredNodeNum(int32_t preferredNodeNum) { DARABONBA_PTR_SET_VALUE(preferredNodeNum_, preferredNodeNum) };
    ...
    inline DescribeDBInstanceDiagnosisSummaryResponseBodyMasterStatusInfo& setSyncedNodeNum(int32_t syncedNodeNum) { DARABONBA_PTR_SET_VALUE(syncedNodeNum_, syncedNodeNum) };
