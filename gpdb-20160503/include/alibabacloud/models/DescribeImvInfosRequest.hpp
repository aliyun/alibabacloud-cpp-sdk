...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        && return this->database_ == nullptr && return this->MVName_ == nullptr; };
    ...
    inline string MVName() const { DARABONBA_PTR_GET_DEFAULT(MVName_, "") };
  ...
  protected:
    ...
    // The name of MV
    std::shared_ptr<string> MVName_ = nullptr;
  };
