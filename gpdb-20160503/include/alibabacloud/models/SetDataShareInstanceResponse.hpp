...
namespace Models
{
  ...
  public:
    ...
    inline const SetDataShareInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetDataShareInstanceResponseBody) };
    inline SetDataShareInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, SetDataShareInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetDataShareInstanceResponseBody> body_ {};
  };
