...
namespace Models
{
  ...
  public:
    ...
    inline const ListRemoteADBDataSourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRemoteADBDataSourcesResponseBody) };
    inline ListRemoteADBDataSourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRemoteADBDataSourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRemoteADBDataSourcesResponseBody> body_ {};
  };
