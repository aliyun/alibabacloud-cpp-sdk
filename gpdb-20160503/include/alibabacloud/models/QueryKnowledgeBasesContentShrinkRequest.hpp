...
namespace Models
{
  ...
  public:
    ...
    inline string getMergeMethodArgsShrink() const { DARABONBA_PTR_GET_DEFAULT(mergeMethodArgsShrink_, "") };
    ...
    inline string getSourceCollectionShrink() const { DARABONBA_PTR_GET_DEFAULT(sourceCollectionShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> sourceCollectionShrink_ {};
