...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceDatabasesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceDatabasesResponseBody) };
    inline ListInstanceDatabasesResponseBody body() { DARABONBA_PTR_GET(body_, ListInstanceDatabasesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListInstanceDatabasesResponseBody> body_ = nullptr;
  };
