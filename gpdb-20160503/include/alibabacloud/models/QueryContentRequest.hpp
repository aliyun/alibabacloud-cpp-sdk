...
namespace Models
{
  ...
  public:
    ...
    inline const QueryContentRequest::RerankModel & getRerankModel() const { DARABONBA_PTR_GET_CONST(rerankModel_, QueryContentRequest::RerankModel) };
    inline QueryContentRequest::RerankModel getRerankModel() { DARABONBA_PTR_GET(rerankModel_, QueryContentRequest::RerankModel) };
    inline QueryContentRequest& setRerankModel(const QueryContentRequest::RerankModel & rerankModel) { DARABONBA_PTR_SET_VALUE(rerankModel_, rerankModel) };
    inline QueryContentRequest& setRerankModel(QueryContentRequest::RerankModel && rerankModel) { DARABONBA_PTR_SET_RVALUE(rerankModel_, rerankModel) };
  ...
  protected:
    ...
    shared_ptr<QueryContentRequest::RerankModel> rerankModel_ {};
