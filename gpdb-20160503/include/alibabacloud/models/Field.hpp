...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->blobValue_ == nullptr
        && return this->booleanValue_ == nullptr && return this->doubleValue_ == nullptr && return this->isNull_ == nullptr && return this->longValue_ == nullptr && return this->stringValue_ == nullptr; };
    ...
    inline string blobValue() const { DARABONBA_PTR_GET_DEFAULT(blobValue_, "") };
    ...
    inline bool booleanValue() const { DARABONBA_PTR_GET_DEFAULT(booleanValue_, false) };
    ...
    inline bool isNull() const { DARABONBA_PTR_GET_DEFAULT(isNull_, false) };
    ...
    inline string stringValue() const { DARABONBA_PTR_GET_DEFAULT(stringValue_, "") };
    inline Field& setStringValue(string stringValue) { DARABONBA_PTR_SET_VALUE(stringValue_, stringValue) };


  protected:
    std::shared_ptr<string> blobValue_ = nullptr;
    std::shared_ptr<bool> booleanValue_ = nullptr;
    std::shared_ptr<double> doubleValue_ = nullptr;
    std::shared_ptr<bool> isNull_ = nullptr;
    std::shared_ptr<int64_t> longValue_ = nullptr;
    std::shared_ptr<string> stringValue_ = nullptr;
  };
