...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteJDBCDataSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteJDBCDataSourceResponseBody) };
    inline DeleteJDBCDataSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteJDBCDataSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteJDBCDataSourceResponseBody> body_ {};
  };
