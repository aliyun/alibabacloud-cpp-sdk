...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHadoopDataSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHadoopDataSourceResponseBody) };
    inline DeleteHadoopDataSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHadoopDataSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHadoopDataSourceResponseBody> body_ {};
  };
