...
namespace Models
{
  ...
  public:
    ...
    inline const ChatWithKnowledgeBaseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChatWithKnowledgeBaseResponseBody) };
    inline ChatWithKnowledgeBaseResponseBody getBody() { DARABONBA_PTR_GET(body_, ChatWithKnowledgeBaseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ChatWithKnowledgeBaseResponseBody> body_ {};
  };
