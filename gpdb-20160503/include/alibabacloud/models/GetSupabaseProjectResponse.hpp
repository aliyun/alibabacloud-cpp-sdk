...
namespace Models
{
  ...
  public:
    ...
    inline const GetSupabaseProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSupabaseProjectResponseBody) };
    inline GetSupabaseProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSupabaseProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSupabaseProjectResponseBody> body_ {};
  };
