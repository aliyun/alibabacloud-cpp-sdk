...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSupportFeaturesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSupportFeaturesResponseBody) };
    inline DescribeSupportFeaturesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSupportFeaturesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSupportFeaturesResponseBody> body_ {};
  };
