...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSQLLogCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSQLLogCountResponseBody) };
    inline DescribeSQLLogCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSQLLogCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSQLLogCountResponseBody> body_ {};
  };
