...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->collection_ == nullptr
        && return this->DBInstanceId_ == nullptr && return this->entityTypesShrink_ == nullptr && return this->LLMModel_ == nullptr && return this->language_ == nullptr && return this->managerAccount_ == nullptr
        ...
        && return this->relationshipTypesShrink_ == nullptr; };
