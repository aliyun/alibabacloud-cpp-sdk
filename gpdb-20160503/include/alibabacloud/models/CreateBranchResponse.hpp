...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBranchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBranchResponseBody) };
    inline CreateBranchResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBranchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBranchResponseBody> body_ {};
  };
