...
namespace Models
{
  ...
  public:
    ...
    inline const ListStreamingJobsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListStreamingJobsResponseBody) };
    inline ListStreamingJobsResponseBody body() { DARABONBA_PTR_GET(body_, ListStreamingJobsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListStreamingJobsResponseBody> body_ = nullptr;
  };
