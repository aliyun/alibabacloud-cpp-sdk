...
namespace Models
{
  ...
  public:
    ...
    inline const CancelCreateIndexJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelCreateIndexJobResponseBody) };
    inline CancelCreateIndexJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelCreateIndexJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelCreateIndexJobResponseBody> body_ {};
  };
