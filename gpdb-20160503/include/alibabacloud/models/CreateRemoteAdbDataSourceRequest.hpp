...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dataSourceName_ == nullptr
        && return this->localDBInstanceId_ == nullptr && return this->localDatabase_ == nullptr && return this->managerUserName_ == nullptr && return this->managerUserPassword_ == nullptr && return this->ownerId_ == nullptr
        && return this->remoteDBInstanceId_ == nullptr && return this->remoteDatabase_ == nullptr && return this->userName_ == nullptr && return this->userPassword_ == nullptr; };
