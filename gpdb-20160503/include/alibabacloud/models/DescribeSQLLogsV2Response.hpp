...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSQLLogsV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSQLLogsV2ResponseBody) };
    inline DescribeSQLLogsV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSQLLogsV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSQLLogsV2ResponseBody> body_ {};
  };
