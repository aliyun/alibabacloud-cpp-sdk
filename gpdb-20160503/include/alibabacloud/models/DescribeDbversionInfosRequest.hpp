...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->DBInstanceMode_ != nullptr
        && this->DBVersion_ != nullptr && this->ownerId_ != nullptr && this->regionId_ != nullptr && this->resourceGroupId_ != nullptr; };
