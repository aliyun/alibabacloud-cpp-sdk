...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->hostname_ == nullptr
        && return this->nodeAddress_ == nullptr && return this->nodeCID_ == nullptr && return this->nodeID_ == nullptr && return this->nodeName_ == nullptr && return this->nodePort_ == nullptr
        && return this->nodePreferredRole_ == nullptr && return this->nodeReplicationMode_ == nullptr && return this->nodeRole_ == nullptr && return this->nodeStatus_ == nullptr && return this->nodeType_ == nullptr; };
