...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIndexResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeIndexResponseBody) };
    inline DescribeIndexResponseBody body() { DARABONBA_PTR_GET(body_, DescribeIndexResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeIndexResponseBody> body_ = nullptr;
  };
