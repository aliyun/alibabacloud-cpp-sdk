...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNamespaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateNamespaceResponseBody) };
    inline CreateNamespaceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateNamespaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateNamespaceResponseBody> body_ {};
  };
