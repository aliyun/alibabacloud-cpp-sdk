...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceCategoriesShrink_ == nullptr
        && return this->DBInstanceDescription_ == nullptr && return this->DBInstanceIds_ == nullptr && return this->DBInstanceModesShrink_ == nullptr && return this->DBInstanceStatusesShrink_ == nullptr && return this->instanceDeployTypesShrink_ == nullptr
        && return this->instanceNetworkType_ == nullptr && return this->ownerId_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->regionId_ == nullptr
        && return this->resourceGroupId_ == nullptr && return this->tag_ == nullptr && return this->vpcId_ == nullptr; };
