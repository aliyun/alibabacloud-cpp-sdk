...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->accountName_ == nullptr
        && this->DBName_ == nullptr && this->DBRole_ == nullptr && this->executeCost_ == nullptr && this->executeState_ == nullptr && this->operationClass_ == nullptr
        && this->operationExecuteTime_ == nullptr && this->operationType_ == nullptr && this->returnRowCounts_ == nullptr && this->SQLPlan_ == nullptr && this->SQLText_ == nullptr
        && this->scanRowCounts_ == nullptr && this->sourceIP_ == nullptr && this->sourcePort_ == nullptr; };
      ...
      inline string getSQLPlan() const { DARABONBA_PTR_GET_DEFAULT(SQLPlan_, "") };
      inline Items& setSQLPlan(string SQLPlan) { DARABONBA_PTR_SET_VALUE(SQLPlan_, SQLPlan) };
    ...
    inline const vector<DescribeSQLLogsResponseBody::Items> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeSQLLogsResponseBody::Items>) };
    inline vector<DescribeSQLLogsResponseBody::Items> getItems() { DARABONBA_PTR_GET(items_, vector<DescribeSQLLogsResponseBody::Items>) };
    inline DescribeSQLLogsResponseBody& setItems(const vector<DescribeSQLLogsResponseBody::Items> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeSQLLogsResponseBody& setItems(vector<DescribeSQLLogsResponseBody::Items> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeSQLLogsResponseBody::Items>> items_ {};
    // The page number.
