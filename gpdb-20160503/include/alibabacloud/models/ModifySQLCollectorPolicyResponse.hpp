...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySQLCollectorPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySQLCollectorPolicyResponseBody) };
    inline ModifySQLCollectorPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySQLCollectorPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySQLCollectorPolicyResponseBody> body_ {};
  };
