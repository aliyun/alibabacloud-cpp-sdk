...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->collection_ == nullptr
        && return this->content_ == nullptr && return this->DBInstanceId_ == nullptr && return this->filter_ == nullptr && return this->hybridSearch_ == nullptr && return this->hybridSearchArgs_ == nullptr
        ...
        && return this->relationalTableFilter_ == nullptr && return this->sparseVector_ == nullptr && return this->topK_ == nullptr && return this->vector_ == nullptr && return this->workspaceId_ == nullptr; };
