...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceExtensionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceExtensionsResponseBody) };
    inline ListInstanceExtensionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstanceExtensionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstanceExtensionsResponseBody> body_ {};
  };
