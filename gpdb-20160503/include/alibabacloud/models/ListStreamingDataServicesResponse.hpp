...
namespace Models
{
  ...
  public:
    ...
    inline const ListStreamingDataServicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListStreamingDataServicesResponseBody) };
    inline ListStreamingDataServicesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListStreamingDataServicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListStreamingDataServicesResponseBody> body_ {};
  };
