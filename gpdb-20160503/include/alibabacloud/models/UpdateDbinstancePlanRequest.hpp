...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->DBInstanceId_ != nullptr
        && this->ownerId_ != nullptr && this->planConfig_ != nullptr && this->planDesc_ != nullptr && this->planEndDate_ != nullptr && this->planId_ != nullptr
        && this->planName_ != nullptr && this->planStartDate_ != nullptr; };
