...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstanceNetworkTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBInstanceNetworkTypeResponseBody) };
    inline ModifyDBInstanceNetworkTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBInstanceNetworkTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBInstanceNetworkTypeResponseBody> body_ {};
  };
