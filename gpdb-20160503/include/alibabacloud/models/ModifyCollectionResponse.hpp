...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCollectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCollectionResponseBody) };
    inline ModifyCollectionResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCollectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCollectionResponseBody> body_ {};
  };
