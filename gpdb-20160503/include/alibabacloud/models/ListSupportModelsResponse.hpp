...
namespace Models
{
  ...
  public:
    ...
    inline const ListSupportModelsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSupportModelsResponseBody) };
    inline ListSupportModelsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSupportModelsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSupportModelsResponseBody> body_ {};
  };
