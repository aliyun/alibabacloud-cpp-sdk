...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & performanceKeys() const { DARABONBA_PTR_GET_CONST(performanceKeys_, vector<string>) };
    inline vector<string> performanceKeys() { DARABONBA_PTR_GET(performanceKeys_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> performanceKeys_ = nullptr;
    // The request ID.
