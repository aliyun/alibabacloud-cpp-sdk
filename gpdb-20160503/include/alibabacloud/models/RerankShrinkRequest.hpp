...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        && this->documentsShrink_ == nullptr && this->instruct_ == nullptr && this->maxChunksPerDoc_ == nullptr && this->model_ == nullptr && this->ownerId_ == nullptr
    ...
    inline RerankShrinkRequest& setInstruct(string instruct) { DARABONBA_PTR_SET_VALUE(instruct_, instruct) };
