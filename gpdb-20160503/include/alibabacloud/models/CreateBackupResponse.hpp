...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBackupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBackupResponseBody) };
    inline CreateBackupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBackupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBackupResponseBody> body_ {};
  };
