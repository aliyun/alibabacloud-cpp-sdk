...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAccountResponseBody) };
    inline GetAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAccountResponseBody> body_ {};
  };
