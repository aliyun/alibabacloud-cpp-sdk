...
namespace Models
{
  ...
  public:
    ...
    inline const ListSecretsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListSecretsResponseBody) };
    inline ListSecretsResponseBody body() { DARABONBA_PTR_GET(body_, ListSecretsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListSecretsResponseBody> body_ = nullptr;
  };
