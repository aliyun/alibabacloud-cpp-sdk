...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeJDBCDataSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeJDBCDataSourceResponseBody) };
    inline DescribeJDBCDataSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeJDBCDataSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeJDBCDataSourceResponseBody> body_ {};
  };
