...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataReDistributeInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataReDistributeInfoResponseBody) };
    inline DescribeDataReDistributeInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDataReDistributeInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDataReDistributeInfoResponseBody> body_ {};
  };
