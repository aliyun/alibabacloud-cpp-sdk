...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRemoteADBDataSourceResponseBody::DataSourceItem & getDataSourceItem() const { DARABONBA_PTR_GET_CONST(dataSourceItem_, CreateRemoteADBDataSourceResponseBody::DataSourceItem) };
    inline CreateRemoteADBDataSourceResponseBody::DataSourceItem getDataSourceItem() { DARABONBA_PTR_GET(dataSourceItem_, CreateRemoteADBDataSourceResponseBody::DataSourceItem) };
    inline CreateRemoteADBDataSourceResponseBody& setDataSourceItem(const CreateRemoteADBDataSourceResponseBody::DataSourceItem & dataSourceItem) { DARABONBA_PTR_SET_VALUE(dataSourceItem_, dataSourceItem) };
    inline CreateRemoteADBDataSourceResponseBody& setDataSourceItem(CreateRemoteADBDataSourceResponseBody::DataSourceItem && dataSourceItem) { DARABONBA_PTR_SET_RVALUE(dataSourceItem_, dataSourceItem) };
  ...
  protected:
    ...
    shared_ptr<CreateRemoteADBDataSourceResponseBody::DataSourceItem> dataSourceItem_ {};
    // Request ID.
