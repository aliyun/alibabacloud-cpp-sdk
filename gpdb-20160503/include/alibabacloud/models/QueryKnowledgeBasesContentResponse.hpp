...
namespace Models
{
  ...
  public:
    ...
    inline const QueryKnowledgeBasesContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryKnowledgeBasesContentResponseBody) };
    inline QueryKnowledgeBasesContentResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryKnowledgeBasesContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryKnowledgeBasesContentResponseBody> body_ {};
  };
