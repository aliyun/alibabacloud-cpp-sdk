...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSupabaseProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSupabaseProjectResponseBody) };
    inline CreateSupabaseProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSupabaseProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSupabaseProjectResponseBody> body_ {};
  };
