...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeDBInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeDBInstanceResponseBody) };
    inline UpgradeDBInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeDBInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeDBInstanceResponseBody> body_ {};
  };
