...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBVersionInfosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBVersionInfosResponseBody) };
    inline DescribeDBVersionInfosResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBVersionInfosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBVersionInfosResponseBody> body_ {};
  };
