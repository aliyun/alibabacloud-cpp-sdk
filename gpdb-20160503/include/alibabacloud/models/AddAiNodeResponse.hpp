...
namespace Models
{
  ...
  public:
    ...
    inline const AddAINodeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddAINodeResponseBody) };
    inline AddAINodeResponseBody body() { DARABONBA_PTR_GET(body_, AddAINodeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddAINodeResponseBody> body_ = nullptr;
  };
