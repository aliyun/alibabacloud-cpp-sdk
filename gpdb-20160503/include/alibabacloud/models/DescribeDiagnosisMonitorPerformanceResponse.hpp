...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDiagnosisMonitorPerformanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDiagnosisMonitorPerformanceResponseBody) };
    inline DescribeDiagnosisMonitorPerformanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDiagnosisMonitorPerformanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDiagnosisMonitorPerformanceResponseBody> body_ {};
  };
