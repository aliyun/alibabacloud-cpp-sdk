...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBResourceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBResourceGroupResponseBody) };
    inline DescribeDBResourceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBResourceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBResourceGroupResponseBody> body_ {};
  };
