...
namespace Models
{
  ...
  public:
    ...
    inline const CreateStreamingDataSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateStreamingDataSourceResponseBody) };
    inline CreateStreamingDataSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateStreamingDataSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateStreamingDataSourceResponseBody> body_ {};
  };
