...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDBClusterPerformanceResponseBody::PerformanceKeys> & getPerformanceKeys() const { DARABONBA_PTR_GET_CONST(performanceKeys_, vector<DescribeDBClusterPerformanceResponseBody::PerformanceKeys>) };
    inline vector<DescribeDBClusterPerformanceResponseBody::PerformanceKeys> getPerformanceKeys() { DARABONBA_PTR_GET(performanceKeys_, vector<DescribeDBClusterPerformanceResponseBody::PerformanceKeys>) };
    inline DescribeDBClusterPerformanceResponseBody& setPerformanceKeys(const vector<DescribeDBClusterPerformanceResponseBody::PerformanceKeys> & performanceKeys) { DARABONBA_PTR_SET_VALUE(performanceKeys_, performanceKeys) };
    inline DescribeDBClusterPerformanceResponseBody& setPerformanceKeys(vector<DescribeDBClusterPerformanceResponseBody::PerformanceKeys> && performanceKeys) { DARABONBA_PTR_SET_RVALUE(performanceKeys_, performanceKeys) };
  ...
  protected:
    ...
    // The name of the performance metric. For more information, see [Performance parameters](https://help.aliyun.com/document_detail/86943.html).
    shared_ptr<vector<DescribeDBClusterPerformanceResponseBody::PerformanceKeys>> performanceKeys_ {};
    // The request ID.
