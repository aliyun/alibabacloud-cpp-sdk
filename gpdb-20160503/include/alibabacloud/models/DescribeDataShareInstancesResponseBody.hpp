...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataShareInstancesResponseBodyItems & items() const { DARABONBA_PTR_GET_CONST(items_, DescribeDataShareInstancesResponseBodyItems) };
    inline DescribeDataShareInstancesResponseBodyItems items() { DARABONBA_PTR_GET(items_, DescribeDataShareInstancesResponseBodyItems) };
    inline DescribeDataShareInstancesResponseBody& setItems(const DescribeDataShareInstancesResponseBodyItems & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDataShareInstancesResponseBody& setItems(DescribeDataShareInstancesResponseBodyItems && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    // *   **closing**
    // *   **closed**
    std::shared_ptr<DescribeDataShareInstancesResponseBodyItems> items_ = nullptr;
    // The page number.
