...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        && return this->ownerId_ == nullptr && return this->resourceGroupItemsShrink_ == nullptr; };
    ...
    inline string resourceGroupItemsShrink() const { DARABONBA_PTR_GET_DEFAULT(resourceGroupItemsShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> resourceGroupItemsShrink_ = nullptr;
  };
