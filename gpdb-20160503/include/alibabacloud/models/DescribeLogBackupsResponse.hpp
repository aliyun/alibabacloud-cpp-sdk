...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLogBackupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLogBackupsResponseBody) };
    inline DescribeLogBackupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLogBackupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLogBackupsResponseBody> body_ {};
  };
