...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->collections_ == nullptr
        && return this->count_ == nullptr && return this->DBInstanceId_ == nullptr && return this->message_ == nullptr && return this->namespace_ == nullptr && return this->regionId_ == nullptr
    ...
    inline const ListCollectionsResponseBodyCollections & collections() const { DARABONBA_PTR_GET_CONST(collections_, ListCollectionsResponseBodyCollections) };
    inline ListCollectionsResponseBodyCollections collections() { DARABONBA_PTR_GET(collections_, ListCollectionsResponseBodyCollections) };
    inline ListCollectionsResponseBody& setCollections(const ListCollectionsResponseBodyCollections & collections) { DARABONBA_PTR_SET_VALUE(collections_, collections) };
    inline ListCollectionsResponseBody& setCollections(ListCollectionsResponseBodyCollections && collections) { DARABONBA_PTR_SET_RVALUE(collections_, collections) };
  ...
  protected:
    ...
    std::shared_ptr<ListCollectionsResponseBodyCollections> collections_ = nullptr;
