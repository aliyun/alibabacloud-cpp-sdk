...
namespace Models
{
  ...
  public:
    ...
    inline const CheckHadoopDataSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckHadoopDataSourceResponseBody) };
    inline CheckHadoopDataSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckHadoopDataSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckHadoopDataSourceResponseBody> body_ {};
  };
