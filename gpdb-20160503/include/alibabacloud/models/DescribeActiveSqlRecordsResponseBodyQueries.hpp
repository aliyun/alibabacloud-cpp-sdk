...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientAddr_ == nullptr
        && return this->database_ == nullptr && return this->PID_ == nullptr && return this->query_ == nullptr && return this->queryDuration_ == nullptr && return this->queryStart_ == nullptr
        && return this->sessionID_ == nullptr && return this->sqlTruncated_ == nullptr && return this->sqlTruncatedThreshold_ == nullptr && return this->state_ == nullptr && return this->user_ == nullptr; };
