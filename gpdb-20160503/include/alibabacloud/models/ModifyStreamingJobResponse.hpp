...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyStreamingJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyStreamingJobResponseBody) };
    inline ModifyStreamingJobResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyStreamingJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyStreamingJobResponseBody> body_ {};
  };
