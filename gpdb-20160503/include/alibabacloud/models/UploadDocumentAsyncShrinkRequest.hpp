...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->chunkOverlap_ == nullptr
        ...
        && return this->fileName_ == nullptr && return this->fileUrl_ == nullptr && return this->metadataShrink_ == nullptr && return this->namespace_ == nullptr && return this->namespacePassword_ == nullptr
        && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->separatorsShrink_ == nullptr && return this->splitterModel_ == nullptr && return this->textSplitterName_ == nullptr
