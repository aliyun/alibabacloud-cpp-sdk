...
namespace Models
{
  ...
  public:
    ...
    inline DescribeTagsResponseBodyTags& setTagKey(string tagKey) { DARABONBA_PTR_SET_VALUE(tagKey_, tagKey) };
    ...
    inline DescribeTagsResponseBodyTags& setTagValue(string tagValue) { DARABONBA_PTR_SET_VALUE(tagValue_, tagValue) };
