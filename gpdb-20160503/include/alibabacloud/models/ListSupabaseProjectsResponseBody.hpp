...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSupabaseProjectsResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<ListSupabaseProjectsResponseBodyItems>) };
    inline vector<ListSupabaseProjectsResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<ListSupabaseProjectsResponseBodyItems>) };
    inline ListSupabaseProjectsResponseBody& setItems(const vector<ListSupabaseProjectsResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline ListSupabaseProjectsResponseBody& setItems(vector<ListSupabaseProjectsResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
