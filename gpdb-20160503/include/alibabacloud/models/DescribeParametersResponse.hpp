...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeParametersResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeParametersResponseBody) };
    inline DescribeParametersResponseBody body() { DARABONBA_PTR_GET(body_, DescribeParametersResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeParametersResponseBody> body_ = nullptr;
  };
