...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteExtensionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteExtensionResponseBody) };
    inline DeleteExtensionResponseBody body() { DARABONBA_PTR_GET(body_, DeleteExtensionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteExtensionResponseBody> body_ = nullptr;
  };
