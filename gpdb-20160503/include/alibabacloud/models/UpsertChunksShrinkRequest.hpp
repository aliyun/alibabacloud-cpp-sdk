...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowInsertWithFilter_ == nullptr
        ...
        && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->shouldReplaceFile_ == nullptr && return this->textChunksShrink_ == nullptr; };
    ...
    inline string textChunksShrink() const { DARABONBA_PTR_GET_DEFAULT(textChunksShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> textChunksShrink_ = nullptr;
  };
