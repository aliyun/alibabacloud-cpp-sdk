...
namespace Models
{
  ...
  public:
    ...
    inline string getColumnDefault() const { DARABONBA_PTR_GET_DEFAULT(columnDefault_, "") };
    ...
    inline bool getIsCurrency() const { DARABONBA_PTR_GET_DEFAULT(isCurrency_, false) };
    ...
    inline bool getIsSigned() const { DARABONBA_PTR_GET_DEFAULT(isSigned_, false) };
    ...
    inline int32_t getPrecision() const { DARABONBA_PTR_GET_DEFAULT(precision_, 0) };
