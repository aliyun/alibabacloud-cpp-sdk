...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->collection_ == nullptr
        && return this->content_ == nullptr && return this->DBInstanceId_ == nullptr && return this->fileName_ == nullptr && return this->fileUrlObject_ == nullptr && return this->filter_ == nullptr
    ...
    inline const QueryContentAdvanceRequestGraphSearchArgs & graphSearchArgs() const { DARABONBA_PTR_GET_CONST(graphSearchArgs_, QueryContentAdvanceRequestGraphSearchArgs) };
    inline QueryContentAdvanceRequestGraphSearchArgs graphSearchArgs() { DARABONBA_PTR_GET(graphSearchArgs_, QueryContentAdvanceRequestGraphSearchArgs) };
    inline QueryContentAdvanceRequest& setGraphSearchArgs(const QueryContentAdvanceRequestGraphSearchArgs & graphSearchArgs) { DARABONBA_PTR_SET_VALUE(graphSearchArgs_, graphSearchArgs) };
    inline QueryContentAdvanceRequest& setGraphSearchArgs(QueryContentAdvanceRequestGraphSearchArgs && graphSearchArgs) { DARABONBA_PTR_SET_RVALUE(graphSearchArgs_, graphSearchArgs) };
  ...
  protected:
    ...
    std::shared_ptr<QueryContentAdvanceRequestGraphSearchArgs> graphSearchArgs_ = nullptr;
