...
namespace Models
{
  ...
  public:
    ...
    inline const ChatWithKnowledgeBaseResponseBody::ChatCompletion & getChatCompletion() const { DARABONBA_PTR_GET_CONST(chatCompletion_, ChatWithKnowledgeBaseResponseBody::ChatCompletion) };
    inline ChatWithKnowledgeBaseResponseBody::ChatCompletion getChatCompletion() { DARABONBA_PTR_GET(chatCompletion_, ChatWithKnowledgeBaseResponseBody::ChatCompletion) };
    inline ChatWithKnowledgeBaseResponseBody& setChatCompletion(const ChatWithKnowledgeBaseResponseBody::ChatCompletion & chatCompletion) { DARABONBA_PTR_SET_VALUE(chatCompletion_, chatCompletion) };
    inline ChatWithKnowledgeBaseResponseBody& setChatCompletion(ChatWithKnowledgeBaseResponseBody::ChatCompletion && chatCompletion) { DARABONBA_PTR_SET_RVALUE(chatCompletion_, chatCompletion) };
    ...
    inline const ChatWithKnowledgeBaseResponseBody::MultiCollectionRecallResult & getMultiCollectionRecallResult() const { DARABONBA_PTR_GET_CONST(multiCollectionRecallResult_, ChatWithKnowledgeBaseResponseBody::MultiCollectionRecallResult) };
    inline ChatWithKnowledgeBaseResponseBody::MultiCollectionRecallResult getMultiCollectionRecallResult() { DARABONBA_PTR_GET(multiCollectionRecallResult_, ChatWithKnowledgeBaseResponseBody::MultiCollectionRecallResult) };
    inline ChatWithKnowledgeBaseResponseBody& setMultiCollectionRecallResult(const ChatWithKnowledgeBaseResponseBody::MultiCollectionRecallResult & multiCollectionRecallResult) { DARABONBA_PTR_SET_VALUE(multiCollectionRecallResult_, multiCollectionRecallResult) };
    inline ChatWithKnowledgeBaseResponseBody& setMultiCollectionRecallResult(ChatWithKnowledgeBaseResponseBody::MultiCollectionRecallResult && multiCollectionRecallResult) { DARABONBA_PTR_SET_RVALUE(multiCollectionRecallResult_, multiCollectionRecallResult) };
