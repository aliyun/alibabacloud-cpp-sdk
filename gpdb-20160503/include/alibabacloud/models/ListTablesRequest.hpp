...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        ...
        && this->schema_ == nullptr && this->secretArn_ == nullptr && this->tablePattern_ == nullptr; };
    ...
    inline string getTablePattern() const { DARABONBA_PTR_GET_DEFAULT(tablePattern_, "") };
  ...
  protected:
    ...
    shared_ptr<string> tablePattern_ {};
  };
