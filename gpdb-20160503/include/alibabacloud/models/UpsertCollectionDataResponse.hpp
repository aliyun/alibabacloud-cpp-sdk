...
namespace Models
{
  ...
  public:
    ...
    inline const UpsertCollectionDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpsertCollectionDataResponseBody) };
    inline UpsertCollectionDataResponseBody getBody() { DARABONBA_PTR_GET(body_, UpsertCollectionDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpsertCollectionDataResponseBody> body_ {};
  };
