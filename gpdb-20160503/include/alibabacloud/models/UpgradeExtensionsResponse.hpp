...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeExtensionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeExtensionsResponseBody) };
    inline UpgradeExtensionsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeExtensionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeExtensionsResponseBody> body_ {};
  };
