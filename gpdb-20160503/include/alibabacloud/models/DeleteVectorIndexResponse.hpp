...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVectorIndexResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteVectorIndexResponseBody) };
    inline DeleteVectorIndexResponseBody body() { DARABONBA_PTR_GET(body_, DeleteVectorIndexResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteVectorIndexResponseBody> body_ = nullptr;
  };
