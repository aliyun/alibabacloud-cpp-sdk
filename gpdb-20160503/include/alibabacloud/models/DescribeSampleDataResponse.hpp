...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSampleDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSampleDataResponseBody) };
    inline DescribeSampleDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSampleDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSampleDataResponseBody> body_ {};
  };
