...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCollectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCollectionResponseBody) };
    inline DescribeCollectionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCollectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCollectionResponseBody> body_ {};
  };
