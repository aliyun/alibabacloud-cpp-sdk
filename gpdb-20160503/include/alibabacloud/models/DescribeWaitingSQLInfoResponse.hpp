...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWaitingSQLInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWaitingSQLInfoResponseBody) };
    inline DescribeWaitingSQLInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWaitingSQLInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWaitingSQLInfoResponseBody> body_ {};
  };
