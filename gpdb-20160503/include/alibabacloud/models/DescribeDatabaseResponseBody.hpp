...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessPrivilege_ == nullptr
        && return this->characterSetName_ == nullptr && return this->collate_ == nullptr && return this->connLimit_ == nullptr && return this->ctype_ == nullptr && return this->DBInstanceId_ == nullptr
        && return this->databaseName_ == nullptr && return this->description_ == nullptr && return this->owner_ == nullptr && return this->requestId_ == nullptr && return this->size_ == nullptr
        && return this->tableSpace_ == nullptr; };
    ...
    inline string accessPrivilege() const { DARABONBA_PTR_GET_DEFAULT(accessPrivilege_, "") };
  ...
  protected:
    std::shared_ptr<string> accessPrivilege_ = nullptr;
