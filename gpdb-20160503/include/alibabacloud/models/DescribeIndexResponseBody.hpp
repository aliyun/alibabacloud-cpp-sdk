...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->collection_ == nullptr
        && return this->indexDef_ == nullptr && return this->indexName_ == nullptr && return this->message_ == nullptr && return this->namespace_ == nullptr && return this->requestId_ == nullptr
