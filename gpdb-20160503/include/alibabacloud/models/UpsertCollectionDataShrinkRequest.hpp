...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->collection_ == nullptr
        ...
        && return this->rowsShrink_ == nullptr && return this->workspaceId_ == nullptr; };
    ...
    inline string rowsShrink() const { DARABONBA_PTR_GET_DEFAULT(rowsShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> rowsShrink_ = nullptr;
