...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeModelServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeModelServiceResponseBody) };
    inline DescribeModelServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeModelServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeModelServiceResponseBody> body_ {};
  };
