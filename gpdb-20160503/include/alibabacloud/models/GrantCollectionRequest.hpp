...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->collection_ == nullptr
        && return this->DBInstanceId_ == nullptr && return this->grantToNamespace_ == nullptr && return this->grantType_ == nullptr && return this->managerAccount_ == nullptr && return this->managerAccountPassword_ == nullptr
        && return this->namespace_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr; };
