...
namespace Models
{
  ...
  public:
    ...
    inline const CreateJDBCDataSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateJDBCDataSourceResponseBody) };
    inline CreateJDBCDataSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateJDBCDataSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateJDBCDataSourceResponseBody> body_ {};
  };
