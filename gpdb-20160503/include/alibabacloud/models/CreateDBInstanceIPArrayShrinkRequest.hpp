...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        && this->IPArrayAttribute_ == nullptr && this->IPArrayName_ == nullptr && this->securityIPListShrink_ == nullptr; };
    ...
    inline string getSecurityIPListShrink() const { DARABONBA_PTR_GET_DEFAULT(securityIPListShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> securityIPListShrink_ {};
  };
