...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceDataBloatResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstanceDataBloatResponseBody) };
    inline DescribeDBInstanceDataBloatResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBInstanceDataBloatResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBInstanceDataBloatResponseBody> body_ {};
  };
