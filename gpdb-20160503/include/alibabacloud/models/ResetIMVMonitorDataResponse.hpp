...
namespace Models
{
  ...
  public:
    ...
    inline const ResetIMVMonitorDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResetIMVMonitorDataResponseBody) };
    inline ResetIMVMonitorDataResponseBody getBody() { DARABONBA_PTR_GET(body_, ResetIMVMonitorDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResetIMVMonitorDataResponseBody> body_ {};
  };
