...
namespace Models
{
  ...
  public:
    ...
    inline const ListModelServicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListModelServicesResponseBody) };
    inline ListModelServicesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListModelServicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListModelServicesResponseBody> body_ {};
  };
