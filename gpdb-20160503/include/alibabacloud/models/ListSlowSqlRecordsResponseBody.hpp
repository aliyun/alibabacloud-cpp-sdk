...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSlowSQLRecordsResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<ListSlowSQLRecordsResponseBodyItems>) };
    inline vector<ListSlowSQLRecordsResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<ListSlowSQLRecordsResponseBodyItems>) };
    inline ListSlowSQLRecordsResponseBody& setItems(const vector<ListSlowSQLRecordsResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline ListSlowSQLRecordsResponseBody& setItems(vector<ListSlowSQLRecordsResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListSlowSQLRecordsResponseBodyItems>> items_ = nullptr;
