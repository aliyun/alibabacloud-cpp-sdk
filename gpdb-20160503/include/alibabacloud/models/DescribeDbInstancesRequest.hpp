...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceCategories_ == nullptr
        && return this->DBInstanceDescription_ == nullptr && return this->DBInstanceIds_ == nullptr && return this->DBInstanceModes_ == nullptr && return this->DBInstanceStatuses_ == nullptr && return this->instanceDeployTypes_ == nullptr
