...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->collection_ == nullptr
        && return this->collectionData_ == nullptr && return this->collectionDataFilter_ == nullptr && return this->DBInstanceId_ == nullptr && return this->namespace_ == nullptr && return this->namespacePassword_ == nullptr
        && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->workspaceId_ == nullptr; };
    ...
    inline string collectionData() const { DARABONBA_PTR_GET_DEFAULT(collectionData_, "") };
    ...
    inline string collectionDataFilter() const { DARABONBA_PTR_GET_DEFAULT(collectionDataFilter_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> collectionData_ = nullptr;
    // The filter conditions for the data to be deleted.
    std::shared_ptr<string> collectionDataFilter_ = nullptr;
    // The instance ID.
    // 
