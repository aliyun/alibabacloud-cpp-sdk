...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyHadoopDataSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyHadoopDataSourceResponseBody) };
    inline ModifyHadoopDataSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyHadoopDataSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyHadoopDataSourceResponseBody> body_ {};
  };
