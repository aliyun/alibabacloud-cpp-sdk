...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->AINodeSpecInfos_ == nullptr
        && return this->backupId_ == nullptr && return this->cacheStorageSize_ == nullptr && return this->clientToken_ == nullptr && return this->createSampleData_ == nullptr && return this->DBInstanceCategory_ == nullptr
        && return this->DBInstanceClass_ == nullptr && return this->DBInstanceDescription_ == nullptr && return this->DBInstanceGroupCount_ == nullptr && return this->DBInstanceMode_ == nullptr && return this->deployMode_ == nullptr
        && return this->enableSSL_ == nullptr && return this->encryptionKey_ == nullptr && return this->encryptionType_ == nullptr && return this->engine_ == nullptr && return this->engineVersion_ == nullptr
        && return this->idleTime_ == nullptr && return this->instanceNetworkType_ == nullptr && return this->instanceSpec_ == nullptr && return this->masterAISpec_ == nullptr && return this->masterCU_ == nullptr
        && return this->masterNodeNum_ == nullptr && return this->ownerId_ == nullptr && return this->payType_ == nullptr && return this->period_ == nullptr && return this->privateIpAddress_ == nullptr
        && return this->prodType_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->securityIPList_ == nullptr && return this->segDiskPerformanceLevel_ == nullptr
        && return this->segNodeNum_ == nullptr && return this->segStorageType_ == nullptr && return this->serverlessMode_ == nullptr && return this->serverlessResource_ == nullptr && return this->srcDbInstanceName_ == nullptr
        && return this->standbyVSwitchId_ == nullptr && return this->standbyZoneId_ == nullptr && return this->storageSize_ == nullptr && return this->storageType_ == nullptr && return this->tag_ == nullptr
        && return this->usedTime_ == nullptr && return this->VPCId_ == nullptr && return this->vSwitchId_ == nullptr && return this->vectorConfigurationStatus_ == nullptr && return this->zoneId_ == nullptr; };
