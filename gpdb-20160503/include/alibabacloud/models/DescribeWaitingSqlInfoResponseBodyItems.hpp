...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->application_ == nullptr
        && return this->blockedByApplication_ == nullptr && return this->blockedByPID_ == nullptr && return this->blockedBySQLStmt_ == nullptr && return this->blockedByUser_ == nullptr && return this->grantLocks_ == nullptr
        && return this->notGrantLocks_ == nullptr && return this->PID_ == nullptr && return this->SQLStmt_ == nullptr && return this->user_ == nullptr; };
