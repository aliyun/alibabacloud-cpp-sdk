...
namespace Models
{
  ...
  public:
    ...
    inline const ListAINodePoolsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAINodePoolsResponseBody) };
    inline ListAINodePoolsResponseBody body() { DARABONBA_PTR_GET(body_, ListAINodePoolsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAINodePoolsResponseBody> body_ = nullptr;
  };
