...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDBInstanceErrorLogResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeDBInstanceErrorLogResponseBodyItems>) };
    inline vector<DescribeDBInstanceErrorLogResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeDBInstanceErrorLogResponseBodyItems>) };
    inline DescribeDBInstanceErrorLogResponseBody& setItems(const vector<DescribeDBInstanceErrorLogResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDBInstanceErrorLogResponseBody& setItems(vector<DescribeDBInstanceErrorLogResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDBInstanceErrorLogResponseBodyItems>> items_ = nullptr;
    // The page number.
