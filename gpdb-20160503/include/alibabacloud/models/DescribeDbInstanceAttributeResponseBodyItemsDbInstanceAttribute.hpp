...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->availabilityValue_ == nullptr
        && return this->cacheStorageSize_ == nullptr && return this->connectionMode_ == nullptr && return this->connectionString_ == nullptr && return this->coreVersion_ == nullptr && return this->cpuCores_ == nullptr
        && return this->cpuCoresPerNode_ == nullptr && return this->creationTime_ == nullptr && return this->DBInstanceCategory_ == nullptr && return this->DBInstanceClass_ == nullptr && return this->DBInstanceClassType_ == nullptr
        && return this->DBInstanceCpuCores_ == nullptr && return this->DBInstanceDescription_ == nullptr && return this->DBInstanceDiskMBPS_ == nullptr && return this->DBInstanceGroupCount_ == nullptr && return this->DBInstanceId_ == nullptr
        && return this->DBInstanceMemory_ == nullptr && return this->DBInstanceMode_ == nullptr && return this->DBInstanceNetType_ == nullptr && return this->DBInstanceStatus_ == nullptr && return this->DBInstanceStorage_ == nullptr
        && return this->deployMode_ == nullptr && return this->encryptionKey_ == nullptr && return this->encryptionType_ == nullptr && return this->engine_ == nullptr && return this->engineVersion_ == nullptr
        && return this->expireTime_ == nullptr && return this->graphEngineStatus_ == nullptr && return this->hostType_ == nullptr && return this->idleTime_ == nullptr && return this->instanceNetworkType_ == nullptr
        && return this->instanceSpec_ == nullptr && return this->lockMode_ == nullptr && return this->lockReason_ == nullptr && return this->maintainEndTime_ == nullptr && return this->maintainStartTime_ == nullptr
        && return this->masterAISpec_ == nullptr && return this->masterCU_ == nullptr && return this->masterNodeNum_ == nullptr && return this->maxConnections_ == nullptr && return this->memoryPerNode_ == nullptr
        && return this->memorySize_ == nullptr && return this->memoryUnit_ == nullptr && return this->minorVersion_ == nullptr && return this->payType_ == nullptr && return this->port_ == nullptr
        && return this->prodType_ == nullptr && return this->readDelayTime_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->runningTime_ == nullptr
        && return this->securityIPList_ == nullptr && return this->segDiskPerformanceLevel_ == nullptr && return this->segNodeNum_ == nullptr && return this->segmentAISpec_ == nullptr && return this->segmentCounts_ == nullptr
        && return this->serverlessMode_ == nullptr && return this->serverlessResource_ == nullptr && return this->standbyZoneId_ == nullptr && return this->startTime_ == nullptr && return this->storagePerNode_ == nullptr
        && return this->storageSize_ == nullptr && return this->storageType_ == nullptr && return this->storageUnit_ == nullptr && return this->supportRestore_ == nullptr && return this->tags_ == nullptr
        && return this->vSwitchId_ == nullptr && return this->vectorConfigurationStatus_ == nullptr && return this->vpcId_ == nullptr && return this->zoneId_ == nullptr; };
