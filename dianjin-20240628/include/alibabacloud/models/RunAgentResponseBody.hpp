...
namespace Models
{
  ...
  public:
    ...
    inline const RunAgentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RunAgentResponseBodyData) };
    inline RunAgentResponseBodyData data() { DARABONBA_PTR_GET(data_, RunAgentResponseBodyData) };
    inline RunAgentResponseBody& setData(const RunAgentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RunAgentResponseBody& setData(RunAgentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<RunAgentResponseBodyData> data_ = nullptr;
