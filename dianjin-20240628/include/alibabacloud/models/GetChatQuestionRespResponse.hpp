...
namespace Models
{
  ...
  public:
    ...
    inline const GetChatQuestionRespResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetChatQuestionRespResponseBody) };
    inline GetChatQuestionRespResponseBody getBody() { DARABONBA_PTR_GET(body_, GetChatQuestionRespResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetChatQuestionRespResponseBody> body_ {};
  };
