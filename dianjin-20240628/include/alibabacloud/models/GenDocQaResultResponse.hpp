...
namespace Models
{
  ...
  public:
    ...
    inline const GenDocQaResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenDocQaResultResponseBody) };
    inline GenDocQaResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GenDocQaResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenDocQaResultResponseBody> body_ {};
  };
