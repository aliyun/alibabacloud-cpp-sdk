...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitChatQuestionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SubmitChatQuestionResponseBody) };
    inline SubmitChatQuestionResponseBody body() { DARABONBA_PTR_GET(body_, SubmitChatQuestionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitChatQuestionResponseBody> body_ = nullptr;
  };
