...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->indexSetting_ == nullptr && this->libraryId_ == nullptr && this->libraryName_ == nullptr; };
    ...
    inline const UpdateLibraryRequest::IndexSetting & getIndexSetting() const { DARABONBA_PTR_GET_CONST(indexSetting_, UpdateLibraryRequest::IndexSetting) };
    inline UpdateLibraryRequest::IndexSetting getIndexSetting() { DARABONBA_PTR_GET(indexSetting_, UpdateLibraryRequest::IndexSetting) };
    inline UpdateLibraryRequest& setIndexSetting(const UpdateLibraryRequest::IndexSetting & indexSetting) { DARABONBA_PTR_SET_VALUE(indexSetting_, indexSetting) };
    inline UpdateLibraryRequest& setIndexSetting(UpdateLibraryRequest::IndexSetting && indexSetting) { DARABONBA_PTR_SET_RVALUE(indexSetting_, indexSetting) };
