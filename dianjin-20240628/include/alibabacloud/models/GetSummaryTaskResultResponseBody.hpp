...
namespace Models
{
  ...
  public:
    ...
    inline const GetSummaryTaskResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetSummaryTaskResultResponseBodyData) };
    inline GetSummaryTaskResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetSummaryTaskResultResponseBodyData) };
    inline GetSummaryTaskResultResponseBody& setData(const GetSummaryTaskResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetSummaryTaskResultResponseBody& setData(GetSummaryTaskResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetSummaryTaskResultResponseBodyData> data_ = nullptr;
