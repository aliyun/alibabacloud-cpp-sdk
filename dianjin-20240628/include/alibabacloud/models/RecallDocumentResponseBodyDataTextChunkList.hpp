...
#ifndef ALIBABACLOUD_MODELS_RECALLDOCUMENTRESPONSEBODYDATATEXTCHUNKLIST_HPP_
#define ALIBABACLOUD_MODELS_RECALLDOCUMENTRESPONSEBODYDATATEXTCHUNKLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RecallDocumentResponseBodyDataTextChunkList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RecallDocumentResponseBodyDataTextChunkList& obj) { 
    ...
    RecallDocumentResponseBodyDataTextChunkList() = default ;
    RecallDocumentResponseBodyDataTextChunkList(const RecallDocumentResponseBodyDataTextChunkList &) = default ;
    RecallDocumentResponseBodyDataTextChunkList(RecallDocumentResponseBodyDataTextChunkList &&) = default ;
    RecallDocumentResponseBodyDataTextChunkList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RecallDocumentResponseBodyDataTextChunkList() = default ;
    RecallDocumentResponseBodyDataTextChunkList& operator=(const RecallDocumentResponseBodyDataTextChunkList &) = default ;
    RecallDocumentResponseBodyDataTextChunkList& operator=(RecallDocumentResponseBodyDataTextChunkList &&) = default ;
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setChunkId(string chunkId) { DARABONBA_PTR_SET_VALUE(chunkId_, chunkId) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setChunkMeta(const Darabonba::Json & chunkMeta) { DARABONBA_SET_VALUE(chunkMeta_, chunkMeta) };
    inline RecallDocumentResponseBodyDataTextChunkList& setChunkMeta(Darabonba::Json & chunkMeta) { DARABONBA_SET_RVALUE(chunkMeta_, chunkMeta) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setChunkOssUrl(string chunkOssUrl) { DARABONBA_PTR_SET_VALUE(chunkOssUrl_, chunkOssUrl) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setChunkText(string chunkText) { DARABONBA_PTR_SET_VALUE(chunkText_, chunkText) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setChunkType(string chunkType) { DARABONBA_PTR_SET_VALUE(chunkType_, chunkType) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setDocId(string docId) { DARABONBA_PTR_SET_VALUE(docId_, docId) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setFileType(string fileType) { DARABONBA_PTR_SET_VALUE(fileType_, fileType) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setLibraryId(string libraryId) { DARABONBA_PTR_SET_VALUE(libraryId_, libraryId) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setLibraryName(string libraryName) { DARABONBA_PTR_SET_VALUE(libraryName_, libraryName) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setNextChunkId(string nextChunkId) { DARABONBA_PTR_SET_VALUE(nextChunkId_, nextChunkId) };


    // pos Field Functions 
    bool hasPos() const { return this->pos_ != nullptr;};
    void deletePos() { this->pos_ = nullptr;};
    inline const vector<Models::RecallDocumentResponseBodyDataTextChunkListPos> & pos() const { DARABONBA_PTR_GET_CONST(pos_, vector<Models::RecallDocumentResponseBodyDataTextChunkListPos>) };
    inline vector<Models::RecallDocumentResponseBodyDataTextChunkListPos> pos() { DARABONBA_PTR_GET(pos_, vector<Models::RecallDocumentResponseBodyDataTextChunkListPos>) };
    inline RecallDocumentResponseBodyDataTextChunkList& setPos(const vector<Models::RecallDocumentResponseBodyDataTextChunkListPos> & pos) { DARABONBA_PTR_SET_VALUE(pos_, pos) };
    inline RecallDocumentResponseBodyDataTextChunkList& setPos(vector<Models::RecallDocumentResponseBodyDataTextChunkListPos> && pos) { DARABONBA_PTR_SET_RVALUE(pos_, pos) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setPreChunkId(string preChunkId) { DARABONBA_PTR_SET_VALUE(preChunkId_, preChunkId) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setScore(float score) { DARABONBA_PTR_SET_VALUE(score_, score) };
    ...
    inline RecallDocumentResponseBodyDataTextChunkList& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::RecallDocumentResponseBodyDataTextChunkListPos>> pos_ = nullptr;
