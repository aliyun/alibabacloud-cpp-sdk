...
namespace Models
{
  ...
  public:
    ...
    inline const GetDocumentListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDocumentListResponseBodyData) };
    inline GetDocumentListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDocumentListResponseBodyData) };
    inline GetDocumentListResponseBody& setData(const GetDocumentListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDocumentListResponseBody& setData(GetDocumentListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDocumentListResponseBodyData> data_ = nullptr;
