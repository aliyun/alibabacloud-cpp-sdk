...
#ifndef ALIBABACLOUD_MODELS_GETLIBRARYRESPONSEBODYDATAINDEXSETTINGQUERYENHANCER_HPP_
#define ALIBABACLOUD_MODELS_GETLIBRARYRESPONSEBODYDATAINDEXSETTINGQUERYENHANCER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetLibraryResponseBodyDataIndexSettingQueryEnhancer& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetLibraryResponseBodyDataIndexSettingQueryEnhancer& obj) { 
    ...
    GetLibraryResponseBodyDataIndexSettingQueryEnhancer() = default ;
    GetLibraryResponseBodyDataIndexSettingQueryEnhancer(const GetLibraryResponseBodyDataIndexSettingQueryEnhancer &) = default ;
    GetLibraryResponseBodyDataIndexSettingQueryEnhancer(GetLibraryResponseBodyDataIndexSettingQueryEnhancer &&) = default ;
    GetLibraryResponseBodyDataIndexSettingQueryEnhancer(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetLibraryResponseBodyDataIndexSettingQueryEnhancer() = default ;
    GetLibraryResponseBodyDataIndexSettingQueryEnhancer& operator=(const GetLibraryResponseBodyDataIndexSettingQueryEnhancer &) = default ;
    GetLibraryResponseBodyDataIndexSettingQueryEnhancer& operator=(GetLibraryResponseBodyDataIndexSettingQueryEnhancer &&) = default ;
    ...
    inline GetLibraryResponseBodyDataIndexSettingQueryEnhancer& setEnableFollowUp(bool enableFollowUp) { DARABONBA_PTR_SET_VALUE(enableFollowUp_, enableFollowUp) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingQueryEnhancer& setEnableMultiQuery(bool enableMultiQuery) { DARABONBA_PTR_SET_VALUE(enableMultiQuery_, enableMultiQuery) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingQueryEnhancer& setEnableOpenQa(bool enableOpenQa) { DARABONBA_PTR_SET_VALUE(enableOpenQa_, enableOpenQa) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingQueryEnhancer& setEnableQueryRewrite(bool enableQueryRewrite) { DARABONBA_PTR_SET_VALUE(enableQueryRewrite_, enableQueryRewrite) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingQueryEnhancer& setEnableSession(bool enableSession) { DARABONBA_PTR_SET_VALUE(enableSession_, enableSession) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingQueryEnhancer& setLocalKnowledgeId(string localKnowledgeId) { DARABONBA_PTR_SET_VALUE(localKnowledgeId_, localKnowledgeId) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingQueryEnhancer& setWithDocumentReference(bool withDocumentReference) { DARABONBA_PTR_SET_VALUE(withDocumentReference_, withDocumentReference) };
