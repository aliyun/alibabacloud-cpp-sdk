...
namespace Models
{
  ...
  public:
    ...
    inline UploadDocumentResponseBody& setCost(int64_t cost) { DARABONBA_PTR_SET_VALUE(cost_, cost) };
    ...
    inline UploadDocumentResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline UploadDocumentResponseBody& setDataType(string dataType) { DARABONBA_PTR_SET_VALUE(dataType_, dataType) };
    ...
    inline UploadDocumentResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline UploadDocumentResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UploadDocumentResponseBody& setTime(string time) { DARABONBA_PTR_SET_VALUE(time_, time) };
