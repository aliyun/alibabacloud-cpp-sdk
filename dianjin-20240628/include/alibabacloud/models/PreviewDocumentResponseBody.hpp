...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Data& setPreviewType(string previewType) { DARABONBA_PTR_SET_VALUE(previewType_, previewType) };
      ...
      inline Data& setUploadTime(string uploadTime) { DARABONBA_PTR_SET_VALUE(uploadTime_, uploadTime) };
    ...
    inline const PreviewDocumentResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, PreviewDocumentResponseBody::Data) };
    inline PreviewDocumentResponseBody::Data getData() { DARABONBA_PTR_GET(data_, PreviewDocumentResponseBody::Data) };
    inline PreviewDocumentResponseBody& setData(const PreviewDocumentResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PreviewDocumentResponseBody& setData(PreviewDocumentResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
