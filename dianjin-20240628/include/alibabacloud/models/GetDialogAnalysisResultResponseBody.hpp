...
namespace Models
{
  ...
  public:
    ...
    inline const GetDialogAnalysisResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDialogAnalysisResultResponseBodyData) };
    inline GetDialogAnalysisResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDialogAnalysisResultResponseBodyData) };
    inline GetDialogAnalysisResultResponseBody& setData(const GetDialogAnalysisResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDialogAnalysisResultResponseBody& setData(GetDialogAnalysisResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDialogAnalysisResultResponseBodyData> data_ = nullptr;
