...
namespace Models
{
  ...
  public:
    ...
    inline RunChatResultGenerationResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunChatResultGenerationResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunChatResultGenerationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunChatResultGenerationResponseBody) };
    inline RunChatResultGenerationResponseBody getBody() { DARABONBA_PTR_GET(body_, RunChatResultGenerationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunChatResultGenerationResponseBody> body_ {};
  };
