...
namespace Models
{
  ...
  public:
    ...
    inline GetTaskStatusResponseBody& setCost(int64_t cost) { DARABONBA_PTR_SET_VALUE(cost_, cost) };
    ...
    inline GetTaskStatusResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline GetTaskStatusResponseBody& setDataType(string dataType) { DARABONBA_PTR_SET_VALUE(dataType_, dataType) };
    ...
    inline GetTaskStatusResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline GetTaskStatusResponseBody& setTime(string time) { DARABONBA_PTR_SET_VALUE(time_, time) };
