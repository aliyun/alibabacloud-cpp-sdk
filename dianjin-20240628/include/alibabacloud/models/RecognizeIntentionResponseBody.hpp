...
namespace Models
{
  ...
  public:
    ...
    inline const RecognizeIntentionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RecognizeIntentionResponseBodyData) };
    inline RecognizeIntentionResponseBodyData data() { DARABONBA_PTR_GET(data_, RecognizeIntentionResponseBodyData) };
    inline RecognizeIntentionResponseBody& setData(const RecognizeIntentionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RecognizeIntentionResponseBody& setData(RecognizeIntentionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<RecognizeIntentionResponseBodyData> data_ = nullptr;
