...
namespace Models
{
  ...
  public:
    ...
    inline const GetVideoCreationTaskResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVideoCreationTaskResultResponseBody) };
    inline GetVideoCreationTaskResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVideoCreationTaskResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVideoCreationTaskResultResponseBody> body_ {};
  };
