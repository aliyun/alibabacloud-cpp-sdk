...
namespace Models
{
  ...
  public:
    ...
    inline const RecallDocumentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RecallDocumentResponseBody) };
    inline RecallDocumentResponseBody getBody() { DARABONBA_PTR_GET(body_, RecallDocumentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RecallDocumentResponseBody> body_ {};
  };
