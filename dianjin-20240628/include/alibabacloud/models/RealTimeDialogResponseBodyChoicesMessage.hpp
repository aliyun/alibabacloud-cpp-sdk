...
#ifndef ALIBABACLOUD_MODELS_REALTIMEDIALOGRESPONSEBODYCHOICESMESSAGE_HPP_
#define ALIBABACLOUD_MODELS_REALTIMEDIALOGRESPONSEBODYCHOICESMESSAGE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RealTimeDialogResponseBodyChoicesMessage& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RealTimeDialogResponseBodyChoicesMessage& obj) { 
    ...
    RealTimeDialogResponseBodyChoicesMessage() = default ;
    RealTimeDialogResponseBodyChoicesMessage(const RealTimeDialogResponseBodyChoicesMessage &) = default ;
    RealTimeDialogResponseBodyChoicesMessage(RealTimeDialogResponseBodyChoicesMessage &&) = default ;
    RealTimeDialogResponseBodyChoicesMessage(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RealTimeDialogResponseBodyChoicesMessage() = default ;
    RealTimeDialogResponseBodyChoicesMessage& operator=(const RealTimeDialogResponseBodyChoicesMessage &) = default ;
    RealTimeDialogResponseBodyChoicesMessage& operator=(RealTimeDialogResponseBodyChoicesMessage &&) = default ;
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setAnalysisProcess(string analysisProcess) { DARABONBA_PTR_SET_VALUE(analysisProcess_, analysisProcess) };
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setCallTime(string callTime) { DARABONBA_PTR_SET_VALUE(callTime_, callTime) };
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setHangUpDialog(bool hangUpDialog) { DARABONBA_PTR_SET_VALUE(hangUpDialog_, hangUpDialog) };
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setIntentionCode(string intentionCode) { DARABONBA_PTR_SET_VALUE(intentionCode_, intentionCode) };
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setIntentionName(string intentionName) { DARABONBA_PTR_SET_VALUE(intentionName_, intentionName) };
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setIntentionScript(string intentionScript) { DARABONBA_PTR_SET_VALUE(intentionScript_, intentionScript) };
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setInterrupt(bool interrupt) { DARABONBA_PTR_SET_VALUE(interrupt_, interrupt) };
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setRecommendIntention(string recommendIntention) { DARABONBA_PTR_SET_VALUE(recommendIntention_, recommendIntention) };
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setRecommendScript(string recommendScript) { DARABONBA_PTR_SET_VALUE(recommendScript_, recommendScript) };
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setSelfDirectedScript(string selfDirectedScript) { DARABONBA_PTR_SET_VALUE(selfDirectedScript_, selfDirectedScript) };
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setSelfDirectedScriptFullContent(string selfDirectedScriptFullContent) { DARABONBA_PTR_SET_VALUE(selfDirectedScriptFullContent_, selfDirectedScriptFullContent) };
    ...
    inline RealTimeDialogResponseBodyChoicesMessage& setSkipCurrentRecognize(bool skipCurrentRecognize) { DARABONBA_PTR_SET_VALUE(skipCurrentRecognize_, skipCurrentRecognize) };
