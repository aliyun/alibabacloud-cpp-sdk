...
namespace Models
{
  ...
  public:
    ...
    inline RunDialogAnalysisResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunDialogAnalysisResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunDialogAnalysisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunDialogAnalysisResponseBody) };
    inline RunDialogAnalysisResponseBody getBody() { DARABONBA_PTR_GET(body_, RunDialogAnalysisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunDialogAnalysisResponseBody> body_ {};
  };
