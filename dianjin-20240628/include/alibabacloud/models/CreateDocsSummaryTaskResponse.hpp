...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDocsSummaryTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDocsSummaryTaskResponseBody) };
    inline CreateDocsSummaryTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDocsSummaryTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDocsSummaryTaskResponseBody> body_ {};
  };
