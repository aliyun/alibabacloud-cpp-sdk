...
namespace Models
{
  ...
  public:
    ...
    inline const GetImageDetectionTaskResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetImageDetectionTaskResultResponseBody) };
    inline GetImageDetectionTaskResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetImageDetectionTaskResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetImageDetectionTaskResultResponseBody> body_ {};
  };
