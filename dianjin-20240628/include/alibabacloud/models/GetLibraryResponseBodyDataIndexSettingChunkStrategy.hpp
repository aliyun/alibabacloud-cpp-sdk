...
#ifndef ALIBABACLOUD_MODELS_GETLIBRARYRESPONSEBODYDATAINDEXSETTINGCHUNKSTRATEGY_HPP_
#define ALIBABACLOUD_MODELS_GETLIBRARYRESPONSEBODYDATAINDEXSETTINGCHUNKSTRATEGY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetLibraryResponseBodyDataIndexSettingChunkStrategy& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetLibraryResponseBodyDataIndexSettingChunkStrategy& obj) { 
    ...
    GetLibraryResponseBodyDataIndexSettingChunkStrategy() = default ;
    GetLibraryResponseBodyDataIndexSettingChunkStrategy(const GetLibraryResponseBodyDataIndexSettingChunkStrategy &) = default ;
    GetLibraryResponseBodyDataIndexSettingChunkStrategy(GetLibraryResponseBodyDataIndexSettingChunkStrategy &&) = default ;
    GetLibraryResponseBodyDataIndexSettingChunkStrategy(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetLibraryResponseBodyDataIndexSettingChunkStrategy() = default ;
    GetLibraryResponseBodyDataIndexSettingChunkStrategy& operator=(const GetLibraryResponseBodyDataIndexSettingChunkStrategy &) = default ;
    GetLibraryResponseBodyDataIndexSettingChunkStrategy& operator=(GetLibraryResponseBodyDataIndexSettingChunkStrategy &&) = default ;
    ...
    inline GetLibraryResponseBodyDataIndexSettingChunkStrategy& setDocTreeSplit(bool docTreeSplit) { DARABONBA_PTR_SET_VALUE(docTreeSplit_, docTreeSplit) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingChunkStrategy& setDocTreeSplitSize(int32_t docTreeSplitSize) { DARABONBA_PTR_SET_VALUE(docTreeSplitSize_, docTreeSplitSize) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingChunkStrategy& setEnhanceGraph(bool enhanceGraph) { DARABONBA_PTR_SET_VALUE(enhanceGraph_, enhanceGraph) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingChunkStrategy& setEnhanceTable(bool enhanceTable) { DARABONBA_PTR_SET_VALUE(enhanceTable_, enhanceTable) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingChunkStrategy& setOverlap(int32_t overlap) { DARABONBA_PTR_SET_VALUE(overlap_, overlap) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingChunkStrategy& setSentenceSplit(bool sentenceSplit) { DARABONBA_PTR_SET_VALUE(sentenceSplit_, sentenceSplit) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingChunkStrategy& setSentenceSplitSize(int32_t sentenceSplitSize) { DARABONBA_PTR_SET_VALUE(sentenceSplitSize_, sentenceSplitSize) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingChunkStrategy& setSize(int32_t size) { DARABONBA_PTR_SET_VALUE(size_, size) };
    ...
    inline GetLibraryResponseBodyDataIndexSettingChunkStrategy& setSplit(bool split) { DARABONBA_PTR_SET_VALUE(split_, split) };
