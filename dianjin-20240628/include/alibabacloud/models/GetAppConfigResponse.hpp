...
namespace Models
{
  ...
  public:
    ...
    inline const GetAppConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAppConfigResponseBody) };
    inline GetAppConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAppConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAppConfigResponseBody> body_ {};
  };
