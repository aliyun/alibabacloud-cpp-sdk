...
namespace Models
{
  ...
  public:
    ...
    inline const CreateImageDetectionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateImageDetectionTaskResponseBody) };
    inline CreateImageDetectionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateImageDetectionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateImageDetectionTaskResponseBody> body_ {};
  };
