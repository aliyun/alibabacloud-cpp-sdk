...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePdfTranslateTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePdfTranslateTaskResponseBody) };
    inline CreatePdfTranslateTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePdfTranslateTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePdfTranslateTaskResponseBody> body_ {};
  };
