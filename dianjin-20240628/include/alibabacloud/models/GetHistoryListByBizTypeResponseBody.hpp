...
namespace Models
{
  ...
  public:
    ...
    inline const GetHistoryListByBizTypeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetHistoryListByBizTypeResponseBodyData) };
    inline GetHistoryListByBizTypeResponseBodyData data() { DARABONBA_PTR_GET(data_, GetHistoryListByBizTypeResponseBodyData) };
    inline GetHistoryListByBizTypeResponseBody& setData(const GetHistoryListByBizTypeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHistoryListByBizTypeResponseBody& setData(GetHistoryListByBizTypeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetHistoryListByBizTypeResponseBodyData> data_ = nullptr;
