...
namespace Models
{
  ...
  public:
    ...
    inline const GetFilterDocumentListResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetFilterDocumentListResponseBody::Data) };
    inline GetFilterDocumentListResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetFilterDocumentListResponseBody::Data) };
    inline GetFilterDocumentListResponseBody& setData(const GetFilterDocumentListResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetFilterDocumentListResponseBody& setData(GetFilterDocumentListResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
