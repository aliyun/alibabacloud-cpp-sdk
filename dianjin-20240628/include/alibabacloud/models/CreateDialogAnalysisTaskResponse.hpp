...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDialogAnalysisTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDialogAnalysisTaskResponseBody) };
    inline CreateDialogAnalysisTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDialogAnalysisTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDialogAnalysisTaskResponseBody> body_ {};
  };
