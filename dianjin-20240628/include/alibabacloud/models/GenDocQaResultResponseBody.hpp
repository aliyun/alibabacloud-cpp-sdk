...
namespace Models
{
  ...
  public:
    ...
    inline const GenDocQaResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GenDocQaResultResponseBodyData) };
    inline GenDocQaResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GenDocQaResultResponseBodyData) };
    inline GenDocQaResultResponseBody& setData(const GenDocQaResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GenDocQaResultResponseBody& setData(GenDocQaResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GenDocQaResultResponseBodyData> data_ = nullptr;
