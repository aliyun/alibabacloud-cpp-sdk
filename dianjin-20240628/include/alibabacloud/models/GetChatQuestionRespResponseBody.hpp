...
namespace Models
{
  ...
  public:
    ...
    inline const GetChatQuestionRespResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetChatQuestionRespResponseBodyData) };
    inline GetChatQuestionRespResponseBodyData data() { DARABONBA_PTR_GET(data_, GetChatQuestionRespResponseBodyData) };
    inline GetChatQuestionRespResponseBody& setData(const GetChatQuestionRespResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetChatQuestionRespResponseBody& setData(GetChatQuestionRespResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetChatQuestionRespResponseBodyData> data_ = nullptr;
