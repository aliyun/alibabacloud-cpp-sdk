...
namespace Models
{
  ...
  public:
    ...
    inline const GetParseResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetParseResultResponseBodyData) };
    inline GetParseResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetParseResultResponseBodyData) };
    inline GetParseResultResponseBody& setData(const GetParseResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetParseResultResponseBody& setData(GetParseResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetParseResultResponseBodyData> data_ = nullptr;
