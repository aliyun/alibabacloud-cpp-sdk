...
#ifndef ALIBABACLOUD_MODELS_UPDATELIBRARYREQUESTINDEXSETTINGCHUNKSTRATEGY_HPP_
#define ALIBABACLOUD_MODELS_UPDATELIBRARYREQUESTINDEXSETTINGCHUNKSTRATEGY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateLibraryRequestIndexSettingChunkStrategy& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateLibraryRequestIndexSettingChunkStrategy& obj) { 
    ...
    UpdateLibraryRequestIndexSettingChunkStrategy() = default ;
    UpdateLibraryRequestIndexSettingChunkStrategy(const UpdateLibraryRequestIndexSettingChunkStrategy &) = default ;
    UpdateLibraryRequestIndexSettingChunkStrategy(UpdateLibraryRequestIndexSettingChunkStrategy &&) = default ;
    UpdateLibraryRequestIndexSettingChunkStrategy(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateLibraryRequestIndexSettingChunkStrategy() = default ;
    UpdateLibraryRequestIndexSettingChunkStrategy& operator=(const UpdateLibraryRequestIndexSettingChunkStrategy &) = default ;
    UpdateLibraryRequestIndexSettingChunkStrategy& operator=(UpdateLibraryRequestIndexSettingChunkStrategy &&) = default ;
    ...
    inline UpdateLibraryRequestIndexSettingChunkStrategy& setDocTreeSplit(bool docTreeSplit) { DARABONBA_PTR_SET_VALUE(docTreeSplit_, docTreeSplit) };
    ...
    inline UpdateLibraryRequestIndexSettingChunkStrategy& setDocTreeSplitSize(int32_t docTreeSplitSize) { DARABONBA_PTR_SET_VALUE(docTreeSplitSize_, docTreeSplitSize) };
    ...
    inline UpdateLibraryRequestIndexSettingChunkStrategy& setEnhanceGraph(bool enhanceGraph) { DARABONBA_PTR_SET_VALUE(enhanceGraph_, enhanceGraph) };
    ...
    inline UpdateLibraryRequestIndexSettingChunkStrategy& setEnhanceTable(bool enhanceTable) { DARABONBA_PTR_SET_VALUE(enhanceTable_, enhanceTable) };
    ...
    inline UpdateLibraryRequestIndexSettingChunkStrategy& setOverlap(int32_t overlap) { DARABONBA_PTR_SET_VALUE(overlap_, overlap) };
    ...
    inline UpdateLibraryRequestIndexSettingChunkStrategy& setSentenceSplit(bool sentenceSplit) { DARABONBA_PTR_SET_VALUE(sentenceSplit_, sentenceSplit) };
    ...
    inline UpdateLibraryRequestIndexSettingChunkStrategy& setSentenceSplitSize(int32_t sentenceSplitSize) { DARABONBA_PTR_SET_VALUE(sentenceSplitSize_, sentenceSplitSize) };
    ...
    inline UpdateLibraryRequestIndexSettingChunkStrategy& setSize(int32_t size) { DARABONBA_PTR_SET_VALUE(size_, size) };
    ...
    inline UpdateLibraryRequestIndexSettingChunkStrategy& setSplit(bool split) { DARABONBA_PTR_SET_VALUE(split_, split) };
