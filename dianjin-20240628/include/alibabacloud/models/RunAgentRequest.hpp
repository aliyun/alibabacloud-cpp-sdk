...
namespace Models
{
  ...
  public:
    ...
    inline bool getUseDraft() const { DARABONBA_PTR_GET_DEFAULT(useDraft_, false) };
    ...
    inline     const Darabonba::Json & getUserInputs() const { DARABONBA_GET(userInputs_) };
    Darabonba::Json & getUserInputs() { DARABONBA_GET(userInputs_) };
