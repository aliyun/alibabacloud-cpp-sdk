...
namespace Models
{
  ...
  public:
    ...
    inline const RecallDocumentResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RecallDocumentResponseBodyData) };
    inline RecallDocumentResponseBodyData data() { DARABONBA_PTR_GET(data_, RecallDocumentResponseBodyData) };
    inline RecallDocumentResponseBody& setData(const RecallDocumentResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RecallDocumentResponseBody& setData(RecallDocumentResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<RecallDocumentResponseBodyData> data_ = nullptr;
