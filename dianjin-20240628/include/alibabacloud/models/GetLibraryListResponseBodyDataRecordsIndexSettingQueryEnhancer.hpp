...
#ifndef ALIBABACLOUD_MODELS_GETLIBRARYLISTRESPONSEBODYDATARECORDSINDEXSETTINGQUERYENHANCER_HPP_
#define ALIBABACLOUD_MODELS_GETLIBRARYLISTRESPONSEBODYDATARECORDSINDEXSETTINGQUERYENHANCER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer& obj) { 
    ...
    GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer() = default ;
    GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer(const GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer &) = default ;
    GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer(GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer &&) = default ;
    GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer() = default ;
    GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer& operator=(const GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer &) = default ;
    GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer& operator=(GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer &&) = default ;
    ...
    inline GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer& setEnableFollowUp(bool enableFollowUp) { DARABONBA_PTR_SET_VALUE(enableFollowUp_, enableFollowUp) };
    ...
    inline GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer& setEnableMultiQuery(bool enableMultiQuery) { DARABONBA_PTR_SET_VALUE(enableMultiQuery_, enableMultiQuery) };
    ...
    inline GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer& setEnableOpenQa(bool enableOpenQa) { DARABONBA_PTR_SET_VALUE(enableOpenQa_, enableOpenQa) };
    ...
    inline GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer& setEnableQueryRewrite(bool enableQueryRewrite) { DARABONBA_PTR_SET_VALUE(enableQueryRewrite_, enableQueryRewrite) };
    ...
    inline GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer& setEnableSession(bool enableSession) { DARABONBA_PTR_SET_VALUE(enableSession_, enableSession) };
    ...
    inline GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer& setLocalKnowledgeId(string localKnowledgeId) { DARABONBA_PTR_SET_VALUE(localKnowledgeId_, localKnowledgeId) };
    ...
    inline GetLibraryListResponseBodyDataRecordsIndexSettingQueryEnhancer& setWithDocumentReference(bool withDocumentReference) { DARABONBA_PTR_SET_VALUE(withDocumentReference_, withDocumentReference) };
