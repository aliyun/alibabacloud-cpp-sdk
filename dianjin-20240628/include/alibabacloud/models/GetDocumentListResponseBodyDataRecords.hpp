...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->docId_ == nullptr
        && return this->documentMeta_ == nullptr && return this->fileType_ == nullptr && return this->gmtCreate_ == nullptr && return this->gmtModified_ == nullptr && return this->libraryId_ == nullptr
        && return this->statusCode_ == nullptr && return this->title_ == nullptr && return this->url_ == nullptr; };
