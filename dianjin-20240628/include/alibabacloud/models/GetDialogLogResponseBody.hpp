...
namespace Models
{
  ...
  public:
    ...
    inline const GetDialogLogResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDialogLogResponseBodyData) };
    inline GetDialogLogResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDialogLogResponseBodyData) };
    inline GetDialogLogResponseBody& setData(const GetDialogLogResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDialogLogResponseBody& setData(GetDialogLogResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDialogLogResponseBodyData> data_ = nullptr;
