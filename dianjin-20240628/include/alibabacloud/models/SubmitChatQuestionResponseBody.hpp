...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitChatQuestionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SubmitChatQuestionResponseBodyData) };
    inline SubmitChatQuestionResponseBodyData data() { DARABONBA_PTR_GET(data_, SubmitChatQuestionResponseBodyData) };
    inline SubmitChatQuestionResponseBody& setData(const SubmitChatQuestionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitChatQuestionResponseBody& setData(SubmitChatQuestionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitChatQuestionResponseBodyData> data_ = nullptr;
