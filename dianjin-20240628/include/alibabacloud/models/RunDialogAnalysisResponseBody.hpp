  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->failNode_ == nullptr && this->gmtCreate_ == nullptr && this->sessionId_ == nullptr && this->status_ == nullptr; };
        ...
        inline const vector<string> & getFailNode() const { DARABONBA_PTR_GET_CONST(failNode_, vector<string>) };
        inline vector<string> getFailNode() { DARABONBA_PTR_GET(failNode_, vector<string>) };
        inline DialogAnalysisRespList& setFailNode(const vector<string> & failNode) { DARABONBA_PTR_SET_VALUE(failNode_, failNode) };
        inline DialogAnalysisRespList& setFailNode(vector<string> && failNode) { DARABONBA_PTR_SET_RVALUE(failNode_, failNode) };
    ...
    inline const RunDialogAnalysisResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, RunDialogAnalysisResponseBody::Data) };
    inline RunDialogAnalysisResponseBody::Data getData() { DARABONBA_PTR_GET(data_, RunDialogAnalysisResponseBody::Data) };
    inline RunDialogAnalysisResponseBody& setData(const RunDialogAnalysisResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RunDialogAnalysisResponseBody& setData(RunDialogAnalysisResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
