...
namespace Models
{
  ...
  public:
    ...
    inline const GetQualityCheckTaskResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetQualityCheckTaskResultResponseBodyData) };
    inline GetQualityCheckTaskResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetQualityCheckTaskResultResponseBodyData) };
    inline GetQualityCheckTaskResultResponseBody& setData(const GetQualityCheckTaskResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetQualityCheckTaskResultResponseBody& setData(GetQualityCheckTaskResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetQualityCheckTaskResultResponseBodyData> data_ = nullptr;
