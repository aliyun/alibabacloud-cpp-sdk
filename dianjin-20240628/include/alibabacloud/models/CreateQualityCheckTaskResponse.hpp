...
namespace Models
{
  ...
  public:
    ...
    inline const CreateQualityCheckTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateQualityCheckTaskResponseBody) };
    inline CreateQualityCheckTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateQualityCheckTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateQualityCheckTaskResponseBody> body_ {};
  };
