...
#ifndef ALIBABACLOUD_MODELS_RECALLDOCUMENTRESPONSEBODYDATAVECTORCHUNKLIST_HPP_
#define ALIBABACLOUD_MODELS_RECALLDOCUMENTRESPONSEBODYDATAVECTORCHUNKLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RecallDocumentResponseBodyDataVectorChunkList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RecallDocumentResponseBodyDataVectorChunkList& obj) { 
    ...
    RecallDocumentResponseBodyDataVectorChunkList() = default ;
    RecallDocumentResponseBodyDataVectorChunkList(const RecallDocumentResponseBodyDataVectorChunkList &) = default ;
    RecallDocumentResponseBodyDataVectorChunkList(RecallDocumentResponseBodyDataVectorChunkList &&) = default ;
    RecallDocumentResponseBodyDataVectorChunkList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RecallDocumentResponseBodyDataVectorChunkList() = default ;
    RecallDocumentResponseBodyDataVectorChunkList& operator=(const RecallDocumentResponseBodyDataVectorChunkList &) = default ;
    RecallDocumentResponseBodyDataVectorChunkList& operator=(RecallDocumentResponseBodyDataVectorChunkList &&) = default ;
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setChunkId(string chunkId) { DARABONBA_PTR_SET_VALUE(chunkId_, chunkId) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setChunkMeta(const Darabonba::Json & chunkMeta) { DARABONBA_SET_VALUE(chunkMeta_, chunkMeta) };
    inline RecallDocumentResponseBodyDataVectorChunkList& setChunkMeta(Darabonba::Json & chunkMeta) { DARABONBA_SET_RVALUE(chunkMeta_, chunkMeta) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setChunkOssUrl(string chunkOssUrl) { DARABONBA_PTR_SET_VALUE(chunkOssUrl_, chunkOssUrl) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setChunkText(string chunkText) { DARABONBA_PTR_SET_VALUE(chunkText_, chunkText) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setChunkType(string chunkType) { DARABONBA_PTR_SET_VALUE(chunkType_, chunkType) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setDocId(string docId) { DARABONBA_PTR_SET_VALUE(docId_, docId) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setFileType(string fileType) { DARABONBA_PTR_SET_VALUE(fileType_, fileType) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setLibraryId(string libraryId) { DARABONBA_PTR_SET_VALUE(libraryId_, libraryId) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setLibraryName(string libraryName) { DARABONBA_PTR_SET_VALUE(libraryName_, libraryName) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setNextChunkId(string nextChunkId) { DARABONBA_PTR_SET_VALUE(nextChunkId_, nextChunkId) };


    // pos Field Functions 
    bool hasPos() const { return this->pos_ != nullptr;};
    void deletePos() { this->pos_ = nullptr;};
    inline const vector<Models::RecallDocumentResponseBodyDataVectorChunkListPos> & pos() const { DARABONBA_PTR_GET_CONST(pos_, vector<Models::RecallDocumentResponseBodyDataVectorChunkListPos>) };
    inline vector<Models::RecallDocumentResponseBodyDataVectorChunkListPos> pos() { DARABONBA_PTR_GET(pos_, vector<Models::RecallDocumentResponseBodyDataVectorChunkListPos>) };
    inline RecallDocumentResponseBodyDataVectorChunkList& setPos(const vector<Models::RecallDocumentResponseBodyDataVectorChunkListPos> & pos) { DARABONBA_PTR_SET_VALUE(pos_, pos) };
    inline RecallDocumentResponseBodyDataVectorChunkList& setPos(vector<Models::RecallDocumentResponseBodyDataVectorChunkListPos> && pos) { DARABONBA_PTR_SET_RVALUE(pos_, pos) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setPreChunkId(string preChunkId) { DARABONBA_PTR_SET_VALUE(preChunkId_, preChunkId) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setScore(float score) { DARABONBA_PTR_SET_VALUE(score_, score) };
    ...
    inline RecallDocumentResponseBodyDataVectorChunkList& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::RecallDocumentResponseBodyDataVectorChunkListPos>> pos_ = nullptr;
