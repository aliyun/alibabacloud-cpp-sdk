...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLibraryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLibraryResponseBody) };
    inline CreateLibraryResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLibraryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLibraryResponseBody> body_ {};
  };
