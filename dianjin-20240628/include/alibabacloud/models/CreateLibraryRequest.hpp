...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLibraryRequest::IndexSetting & getIndexSetting() const { DARABONBA_PTR_GET_CONST(indexSetting_, CreateLibraryRequest::IndexSetting) };
    inline CreateLibraryRequest::IndexSetting getIndexSetting() { DARABONBA_PTR_GET(indexSetting_, CreateLibraryRequest::IndexSetting) };
    inline CreateLibraryRequest& setIndexSetting(const CreateLibraryRequest::IndexSetting & indexSetting) { DARABONBA_PTR_SET_VALUE(indexSetting_, indexSetting) };
    inline CreateLibraryRequest& setIndexSetting(CreateLibraryRequest::IndexSetting && indexSetting) { DARABONBA_PTR_SET_RVALUE(indexSetting_, indexSetting) };
