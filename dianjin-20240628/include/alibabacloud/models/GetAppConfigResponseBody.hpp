...
namespace Models
{
  ...
  public:
    ...
    inline const GetAppConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAppConfigResponseBodyData) };
    inline GetAppConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAppConfigResponseBodyData) };
    inline GetAppConfigResponseBody& setData(const GetAppConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAppConfigResponseBody& setData(GetAppConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAppConfigResponseBodyData> data_ = nullptr;
