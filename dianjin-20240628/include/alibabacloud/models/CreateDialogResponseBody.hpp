...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDialogResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateDialogResponseBodyData) };
    inline CreateDialogResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateDialogResponseBodyData) };
    inline CreateDialogResponseBody& setData(const CreateDialogResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateDialogResponseBody& setData(CreateDialogResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDialogResponseBodyData> data_ = nullptr;
