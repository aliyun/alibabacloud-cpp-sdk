...
namespace Models
{
  ...
  public:
    ...
    inline const GetDialogDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetDialogDetailResponseBodyData) };
    inline GetDialogDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, GetDialogDetailResponseBodyData) };
    inline GetDialogDetailResponseBody& setData(const GetDialogDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetDialogDetailResponseBody& setData(GetDialogDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetDialogDetailResponseBodyData> data_ = nullptr;
