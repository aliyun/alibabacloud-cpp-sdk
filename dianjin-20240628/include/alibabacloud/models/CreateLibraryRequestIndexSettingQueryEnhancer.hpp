...
#ifndef ALIBABACLOUD_MODELS_CREATELIBRARYREQUESTINDEXSETTINGQUERYENHANCER_HPP_
#define ALIBABACLOUD_MODELS_CREATELIBRARYREQUESTINDEXSETTINGQUERYENHANCER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateLibraryRequestIndexSettingQueryEnhancer& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLibraryRequestIndexSettingQueryEnhancer& obj) { 
    ...
    CreateLibraryRequestIndexSettingQueryEnhancer() = default ;
    CreateLibraryRequestIndexSettingQueryEnhancer(const CreateLibraryRequestIndexSettingQueryEnhancer &) = default ;
    CreateLibraryRequestIndexSettingQueryEnhancer(CreateLibraryRequestIndexSettingQueryEnhancer &&) = default ;
    CreateLibraryRequestIndexSettingQueryEnhancer(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLibraryRequestIndexSettingQueryEnhancer() = default ;
    CreateLibraryRequestIndexSettingQueryEnhancer& operator=(const CreateLibraryRequestIndexSettingQueryEnhancer &) = default ;
    CreateLibraryRequestIndexSettingQueryEnhancer& operator=(CreateLibraryRequestIndexSettingQueryEnhancer &&) = default ;
    ...
    inline CreateLibraryRequestIndexSettingQueryEnhancer& setEnableFollowUp(bool enableFollowUp) { DARABONBA_PTR_SET_VALUE(enableFollowUp_, enableFollowUp) };
    ...
    inline CreateLibraryRequestIndexSettingQueryEnhancer& setEnableMultiQuery(bool enableMultiQuery) { DARABONBA_PTR_SET_VALUE(enableMultiQuery_, enableMultiQuery) };
    ...
    inline CreateLibraryRequestIndexSettingQueryEnhancer& setEnableOpenQa(bool enableOpenQa) { DARABONBA_PTR_SET_VALUE(enableOpenQa_, enableOpenQa) };
    ...
    inline CreateLibraryRequestIndexSettingQueryEnhancer& setEnableQueryRewrite(bool enableQueryRewrite) { DARABONBA_PTR_SET_VALUE(enableQueryRewrite_, enableQueryRewrite) };
    ...
    inline CreateLibraryRequestIndexSettingQueryEnhancer& setEnableSession(bool enableSession) { DARABONBA_PTR_SET_VALUE(enableSession_, enableSession) };
    ...
    inline CreateLibraryRequestIndexSettingQueryEnhancer& setLocalKnowledgeId(string localKnowledgeId) { DARABONBA_PTR_SET_VALUE(localKnowledgeId_, localKnowledgeId) };
    ...
    inline CreateLibraryRequestIndexSettingQueryEnhancer& setWithDocumentReference(bool withDocumentReference) { DARABONBA_PTR_SET_VALUE(withDocumentReference_, withDocumentReference) };
