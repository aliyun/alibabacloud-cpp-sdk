...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->conversationList_ != nullptr
        && this->gmtService_ != nullptr && this->metaData_ != nullptr && this->qualityGroup_ != nullptr && this->requestId_ != nullptr && this->type_ != nullptr; };
