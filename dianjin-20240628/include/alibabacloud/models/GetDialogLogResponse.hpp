...
namespace Models
{
  ...
  public:
    ...
    inline const GetDialogLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDialogLogResponseBody) };
    inline GetDialogLogResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDialogLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDialogLogResponseBody> body_ {};
  };
