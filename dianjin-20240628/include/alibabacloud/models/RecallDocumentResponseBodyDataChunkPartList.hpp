...
#ifndef ALIBABACLOUD_MODELS_RECALLDOCUMENTRESPONSEBODYDATACHUNKPARTLIST_HPP_
#define ALIBABACLOUD_MODELS_RECALLDOCUMENTRESPONSEBODYDATACHUNKPARTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RecallDocumentResponseBodyDataChunkPartList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RecallDocumentResponseBodyDataChunkPartList& obj) { 
    ...
    RecallDocumentResponseBodyDataChunkPartList() = default ;
    RecallDocumentResponseBodyDataChunkPartList(const RecallDocumentResponseBodyDataChunkPartList &) = default ;
    RecallDocumentResponseBodyDataChunkPartList(RecallDocumentResponseBodyDataChunkPartList &&) = default ;
    RecallDocumentResponseBodyDataChunkPartList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RecallDocumentResponseBodyDataChunkPartList() = default ;
    RecallDocumentResponseBodyDataChunkPartList& operator=(const RecallDocumentResponseBodyDataChunkPartList &) = default ;
    RecallDocumentResponseBodyDataChunkPartList& operator=(RecallDocumentResponseBodyDataChunkPartList &&) = default ;
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setChunkId(string chunkId) { DARABONBA_PTR_SET_VALUE(chunkId_, chunkId) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setChunkMeta(const Darabonba::Json & chunkMeta) { DARABONBA_SET_VALUE(chunkMeta_, chunkMeta) };
    inline RecallDocumentResponseBodyDataChunkPartList& setChunkMeta(Darabonba::Json & chunkMeta) { DARABONBA_SET_RVALUE(chunkMeta_, chunkMeta) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setChunkOssUrl(string chunkOssUrl) { DARABONBA_PTR_SET_VALUE(chunkOssUrl_, chunkOssUrl) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setChunkText(string chunkText) { DARABONBA_PTR_SET_VALUE(chunkText_, chunkText) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setChunkType(string chunkType) { DARABONBA_PTR_SET_VALUE(chunkType_, chunkType) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setDocId(string docId) { DARABONBA_PTR_SET_VALUE(docId_, docId) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setFileType(string fileType) { DARABONBA_PTR_SET_VALUE(fileType_, fileType) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setLibraryId(string libraryId) { DARABONBA_PTR_SET_VALUE(libraryId_, libraryId) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setLibraryName(string libraryName) { DARABONBA_PTR_SET_VALUE(libraryName_, libraryName) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setNextChunkId(string nextChunkId) { DARABONBA_PTR_SET_VALUE(nextChunkId_, nextChunkId) };


    // pos Field Functions 
    bool hasPos() const { return this->pos_ != nullptr;};
    void deletePos() { this->pos_ = nullptr;};
    inline const vector<Models::RecallDocumentResponseBodyDataChunkPartListPos> & pos() const { DARABONBA_PTR_GET_CONST(pos_, vector<Models::RecallDocumentResponseBodyDataChunkPartListPos>) };
    inline vector<Models::RecallDocumentResponseBodyDataChunkPartListPos> pos() { DARABONBA_PTR_GET(pos_, vector<Models::RecallDocumentResponseBodyDataChunkPartListPos>) };
    inline RecallDocumentResponseBodyDataChunkPartList& setPos(const vector<Models::RecallDocumentResponseBodyDataChunkPartListPos> & pos) { DARABONBA_PTR_SET_VALUE(pos_, pos) };
    inline RecallDocumentResponseBodyDataChunkPartList& setPos(vector<Models::RecallDocumentResponseBodyDataChunkPartListPos> && pos) { DARABONBA_PTR_SET_RVALUE(pos_, pos) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setPreChunkId(string preChunkId) { DARABONBA_PTR_SET_VALUE(preChunkId_, preChunkId) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setScore(float score) { DARABONBA_PTR_SET_VALUE(score_, score) };
    ...
    inline RecallDocumentResponseBodyDataChunkPartList& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::RecallDocumentResponseBodyDataChunkPartListPos>> pos_ = nullptr;
