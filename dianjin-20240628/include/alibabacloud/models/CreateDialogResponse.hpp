...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDialogResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateDialogResponseBody) };
    inline CreateDialogResponseBody body() { DARABONBA_PTR_GET(body_, CreateDialogResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDialogResponseBody> body_ = nullptr;
  };
