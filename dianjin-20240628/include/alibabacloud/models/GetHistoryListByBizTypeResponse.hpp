...
namespace Models
{
  ...
  public:
    ...
    inline const GetHistoryListByBizTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetHistoryListByBizTypeResponseBody) };
    inline GetHistoryListByBizTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetHistoryListByBizTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetHistoryListByBizTypeResponseBody> body_ {};
  };
