...
namespace Models
{
  ...
  public:
    ...
    inline const EndToEndRealTimeDialogResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, EndToEndRealTimeDialogResponseBody) };
    inline EndToEndRealTimeDialogResponseBody body() { DARABONBA_PTR_GET(body_, EndToEndRealTimeDialogResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<EndToEndRealTimeDialogResponseBody> body_ = nullptr;
  };
