...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDocumentResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateDocumentResponseBody) };
    inline UpdateDocumentResponseBody body() { DARABONBA_PTR_GET(body_, UpdateDocumentResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateDocumentResponseBody> body_ = nullptr;
  };
