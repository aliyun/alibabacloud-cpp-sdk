...
namespace Models
{
  ...
  public:
    ...
    inline const GetLibraryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLibraryResponseBody) };
    inline GetLibraryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLibraryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLibraryResponseBody> body_ {};
  };
