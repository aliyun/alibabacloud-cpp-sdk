...
#ifndef ALIBABACLOUD_MODELS_RECALLDOCUMENTRESPONSEBODYDATACHUNKLIST_HPP_
#define ALIBABACLOUD_MODELS_RECALLDOCUMENTRESPONSEBODYDATACHUNKLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RecallDocumentResponseBodyDataChunkList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RecallDocumentResponseBodyDataChunkList& obj) { 
    ...
    RecallDocumentResponseBodyDataChunkList() = default ;
    RecallDocumentResponseBodyDataChunkList(const RecallDocumentResponseBodyDataChunkList &) = default ;
    RecallDocumentResponseBodyDataChunkList(RecallDocumentResponseBodyDataChunkList &&) = default ;
    RecallDocumentResponseBodyDataChunkList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RecallDocumentResponseBodyDataChunkList() = default ;
    RecallDocumentResponseBodyDataChunkList& operator=(const RecallDocumentResponseBodyDataChunkList &) = default ;
    RecallDocumentResponseBodyDataChunkList& operator=(RecallDocumentResponseBodyDataChunkList &&) = default ;
    ...
    inline RecallDocumentResponseBodyDataChunkList& setChunkId(string chunkId) { DARABONBA_PTR_SET_VALUE(chunkId_, chunkId) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setChunkMeta(const Darabonba::Json & chunkMeta) { DARABONBA_SET_VALUE(chunkMeta_, chunkMeta) };
    inline RecallDocumentResponseBodyDataChunkList& setChunkMeta(Darabonba::Json & chunkMeta) { DARABONBA_SET_RVALUE(chunkMeta_, chunkMeta) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setChunkOssUrl(string chunkOssUrl) { DARABONBA_PTR_SET_VALUE(chunkOssUrl_, chunkOssUrl) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setChunkText(string chunkText) { DARABONBA_PTR_SET_VALUE(chunkText_, chunkText) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setChunkType(string chunkType) { DARABONBA_PTR_SET_VALUE(chunkType_, chunkType) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setDocId(string docId) { DARABONBA_PTR_SET_VALUE(docId_, docId) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setFileType(string fileType) { DARABONBA_PTR_SET_VALUE(fileType_, fileType) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setLibraryId(string libraryId) { DARABONBA_PTR_SET_VALUE(libraryId_, libraryId) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setLibraryName(string libraryName) { DARABONBA_PTR_SET_VALUE(libraryName_, libraryName) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setNextChunkId(string nextChunkId) { DARABONBA_PTR_SET_VALUE(nextChunkId_, nextChunkId) };


    // pos Field Functions 
    bool hasPos() const { return this->pos_ != nullptr;};
    void deletePos() { this->pos_ = nullptr;};
    inline const vector<Models::RecallDocumentResponseBodyDataChunkListPos> & pos() const { DARABONBA_PTR_GET_CONST(pos_, vector<Models::RecallDocumentResponseBodyDataChunkListPos>) };
    inline vector<Models::RecallDocumentResponseBodyDataChunkListPos> pos() { DARABONBA_PTR_GET(pos_, vector<Models::RecallDocumentResponseBodyDataChunkListPos>) };
    inline RecallDocumentResponseBodyDataChunkList& setPos(const vector<Models::RecallDocumentResponseBodyDataChunkListPos> & pos) { DARABONBA_PTR_SET_VALUE(pos_, pos) };
    inline RecallDocumentResponseBodyDataChunkList& setPos(vector<Models::RecallDocumentResponseBodyDataChunkListPos> && pos) { DARABONBA_PTR_SET_RVALUE(pos_, pos) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setPreChunkId(string preChunkId) { DARABONBA_PTR_SET_VALUE(preChunkId_, preChunkId) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setScore(float score) { DARABONBA_PTR_SET_VALUE(score_, score) };
    ...
    inline RecallDocumentResponseBodyDataChunkList& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::RecallDocumentResponseBodyDataChunkListPos>> pos_ = nullptr;
