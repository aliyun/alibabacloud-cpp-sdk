...
namespace Models
{
  ...
  public:
    ...
    inline const GetLibraryListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetLibraryListResponseBodyData) };
    inline GetLibraryListResponseBodyData data() { DARABONBA_PTR_GET(data_, GetLibraryListResponseBodyData) };
    inline GetLibraryListResponseBody& setData(const GetLibraryListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetLibraryListResponseBody& setData(GetLibraryListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetLibraryListResponseBodyData> data_ = nullptr;
