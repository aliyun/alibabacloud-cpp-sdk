...
#ifndef ALIBABACLOUD_MODELS_GETLIBRARYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETLIBRARYRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetLibraryResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetLibraryResponseBody& obj) { 
    ...
    GetLibraryResponseBody() = default ;
    GetLibraryResponseBody(const GetLibraryResponseBody &) = default ;
    GetLibraryResponseBody(GetLibraryResponseBody &&) = default ;
    GetLibraryResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetLibraryResponseBody() = default ;
    GetLibraryResponseBody& operator=(const GetLibraryResponseBody &) = default ;
    GetLibraryResponseBody& operator=(GetLibraryResponseBody &&) = default ;
    ...
    public:
      ...
      inline Data& setDocumentCount(int64_t documentCount) { DARABONBA_PTR_SET_VALUE(documentCount_, documentCount) };
      ...
      inline const Data::IndexSetting & getIndexSetting() const { DARABONBA_PTR_GET_CONST(indexSetting_, Data::IndexSetting) };
      inline Data::IndexSetting getIndexSetting() { DARABONBA_PTR_GET(indexSetting_, Data::IndexSetting) };
      inline Data& setIndexSetting(const Data::IndexSetting & indexSetting) { DARABONBA_PTR_SET_VALUE(indexSetting_, indexSetting) };
      inline Data& setIndexSetting(Data::IndexSetting && indexSetting) { DARABONBA_PTR_SET_RVALUE(indexSetting_, indexSetting) };
      ...
      inline Data& setLibraryName(string libraryName) { DARABONBA_PTR_SET_VALUE(libraryName_, libraryName) };
    ...
    inline GetLibraryResponseBody& setCost(int64_t cost) { DARABONBA_PTR_SET_VALUE(cost_, cost) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetLibraryResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetLibraryResponseBody::Data) };
    inline GetLibraryResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetLibraryResponseBody::Data) };
    inline GetLibraryResponseBody& setData(const GetLibraryResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetLibraryResponseBody& setData(GetLibraryResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetLibraryResponseBody& setDataType(string dataType) { DARABONBA_PTR_SET_VALUE(dataType_, dataType) };
    ...
    inline GetLibraryResponseBody& setErrCode(string errCode) { DARABONBA_PTR_SET_VALUE(errCode_, errCode) };
    ...
    inline GetLibraryResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetLibraryResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetLibraryResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline GetLibraryResponseBody& setTime(string time) { DARABONBA_PTR_SET_VALUE(time_, time) };
