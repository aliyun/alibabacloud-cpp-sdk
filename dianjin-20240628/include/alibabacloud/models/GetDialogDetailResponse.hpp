...
namespace Models
{
  ...
  public:
    ...
    inline const GetDialogDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDialogDetailResponseBody) };
    inline GetDialogDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDialogDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDialogDetailResponseBody> body_ {};
  };
