...
#ifndef ALIBABACLOUD_MODELS_CREATELIBRARYREQUESTINDEXSETTINGCHUNKSTRATEGY_HPP_
#define ALIBABACLOUD_MODELS_CREATELIBRARYREQUESTINDEXSETTINGCHUNKSTRATEGY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateLibraryRequestIndexSettingChunkStrategy& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLibraryRequestIndexSettingChunkStrategy& obj) { 
    ...
    CreateLibraryRequestIndexSettingChunkStrategy() = default ;
    CreateLibraryRequestIndexSettingChunkStrategy(const CreateLibraryRequestIndexSettingChunkStrategy &) = default ;
    CreateLibraryRequestIndexSettingChunkStrategy(CreateLibraryRequestIndexSettingChunkStrategy &&) = default ;
    CreateLibraryRequestIndexSettingChunkStrategy(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLibraryRequestIndexSettingChunkStrategy() = default ;
    CreateLibraryRequestIndexSettingChunkStrategy& operator=(const CreateLibraryRequestIndexSettingChunkStrategy &) = default ;
    CreateLibraryRequestIndexSettingChunkStrategy& operator=(CreateLibraryRequestIndexSettingChunkStrategy &&) = default ;
    ...
    inline CreateLibraryRequestIndexSettingChunkStrategy& setDocTreeSplit(bool docTreeSplit) { DARABONBA_PTR_SET_VALUE(docTreeSplit_, docTreeSplit) };
    ...
    inline CreateLibraryRequestIndexSettingChunkStrategy& setDocTreeSplitSize(int32_t docTreeSplitSize) { DARABONBA_PTR_SET_VALUE(docTreeSplitSize_, docTreeSplitSize) };
    ...
    inline CreateLibraryRequestIndexSettingChunkStrategy& setEnhanceGraph(bool enhanceGraph) { DARABONBA_PTR_SET_VALUE(enhanceGraph_, enhanceGraph) };
    ...
    inline CreateLibraryRequestIndexSettingChunkStrategy& setEnhanceTable(bool enhanceTable) { DARABONBA_PTR_SET_VALUE(enhanceTable_, enhanceTable) };
    ...
    inline CreateLibraryRequestIndexSettingChunkStrategy& setOverlap(int32_t overlap) { DARABONBA_PTR_SET_VALUE(overlap_, overlap) };
    ...
    inline CreateLibraryRequestIndexSettingChunkStrategy& setSentenceSplit(bool sentenceSplit) { DARABONBA_PTR_SET_VALUE(sentenceSplit_, sentenceSplit) };
    ...
    inline CreateLibraryRequestIndexSettingChunkStrategy& setSentenceSplitSize(int32_t sentenceSplitSize) { DARABONBA_PTR_SET_VALUE(sentenceSplitSize_, sentenceSplitSize) };
    ...
    inline CreateLibraryRequestIndexSettingChunkStrategy& setSize(int32_t size) { DARABONBA_PTR_SET_VALUE(size_, size) };
    ...
    inline CreateLibraryRequestIndexSettingChunkStrategy& setSplit(bool split) { DARABONBA_PTR_SET_VALUE(split_, split) };
