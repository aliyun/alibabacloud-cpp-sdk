...
RealtimeDialogAssistResponse Alibabacloud_DianJin20240628::Client::realtimeDialogAssistWithOptions(shared_ptr<string> workspaceId,
  ...
  if (!Darabonba_Util::Client::isUnset<vector<RealtimeDialogAssistRequestConversationModel>>(request->conversationModel)) {
    body->insert(pair<string, vector<RealtimeDialogAssistRequestConversationModel>>("conversationModel", *request->conversationModel));
  }
  if (!Darabonba_Util::Client::isUnset<long>(request->dialogMemoryTurns)) {
    body->insert(pair<string, long>("dialogMemoryTurns", *request->dialogMemoryTurns));
  }
  if (!Darabonba_Util::Client::isUnset<bool>(request->hangUpDialog)) {
    body->insert(pair<string, bool>("hangUpDialog", *request->hangUpDialog));
  }
  if (!Darabonba_Util::Client::isUnset<map<string, boost::any>>(request->metaData)) {
    body->insert(pair<string, map<string, boost::any>>("metaData", *request->metaData));
  }
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("RealtimeDialogAssist"))},
    {"version", boost::any(string("2024-06-28"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/") + string(Alibabacloud_OpenApiUtil::Client::getEncodeParam(workspaceId)) + string("/api/realtime/dialog/assist"))},
    {"method", boost::any(string("POST"))},
    {"authType", boost::any(string("AK"))},
    {"style", boost::any(string("ROA"))},
    {"reqBodyType", boost::any(string("json"))},
  ...
  return RealtimeDialogAssistResponse(callApi(params, req, runtime));
}

RealtimeDialogAssistResponse Alibabacloud_DianJin20240628::Client::realtimeDialogAssist(shared_ptr<string> workspaceId, shared_ptr<RealtimeDialogAssistRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
  shared_ptr<map<string, string>> headers = make_shared<map<string, string>>(map<string, string>());
