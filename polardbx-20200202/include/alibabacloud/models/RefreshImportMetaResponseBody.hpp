...
namespace Models
{
  ...
  public:
    ...
    inline const RefreshImportMetaResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, RefreshImportMetaResponseBody::Data) };
    inline RefreshImportMetaResponseBody::Data getData() { DARABONBA_PTR_GET(data_, RefreshImportMetaResponseBody::Data) };
    inline RefreshImportMetaResponseBody& setData(const RefreshImportMetaResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RefreshImportMetaResponseBody& setData(RefreshImportMetaResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    shared_ptr<RefreshImportMetaResponseBody::Data> data_ {};
