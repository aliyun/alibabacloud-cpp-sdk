...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDBInstanceTDEResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateDBInstanceTDEResponseBodyData) };
    inline UpdateDBInstanceTDEResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateDBInstanceTDEResponseBodyData) };
    inline UpdateDBInstanceTDEResponseBody& setData(const UpdateDBInstanceTDEResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateDBInstanceTDEResponseBody& setData(UpdateDBInstanceTDEResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<UpdateDBInstanceTDEResponseBodyData> data_ = nullptr;
