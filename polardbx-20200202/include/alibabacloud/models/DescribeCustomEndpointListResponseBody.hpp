...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomEndpointListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCustomEndpointListResponseBodyData) };
    inline DescribeCustomEndpointListResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCustomEndpointListResponseBodyData) };
    inline DescribeCustomEndpointListResponseBody& setData(const DescribeCustomEndpointListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCustomEndpointListResponseBody& setData(DescribeCustomEndpointListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeCustomEndpointListResponseBodyData> data_ = nullptr;
    // Id of the request
