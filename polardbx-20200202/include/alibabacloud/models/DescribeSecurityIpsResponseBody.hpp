...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityIpsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSecurityIpsResponseBodyData) };
    inline DescribeSecurityIpsResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSecurityIpsResponseBodyData) };
    inline DescribeSecurityIpsResponseBody& setData(const DescribeSecurityIpsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSecurityIpsResponseBody& setData(DescribeSecurityIpsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeSecurityIpsResponseBodyData> data_ = nullptr;
