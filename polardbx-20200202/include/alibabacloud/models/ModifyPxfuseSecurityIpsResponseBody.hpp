...
#ifndef ALIBABACLOUD_MODELS_MODIFYPXFUSESECURITYIPSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MODIFYPXFUSESECURITYIPSRESPONSEBODY_HPP_
...
namespace Models
{
  class ModifyPxfuseSecurityIpsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyPxfuseSecurityIpsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyPxfuseSecurityIpsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ModifyPxfuseSecurityIpsResponseBody() = default ;
    ModifyPxfuseSecurityIpsResponseBody(const ModifyPxfuseSecurityIpsResponseBody &) = default ;
    ModifyPxfuseSecurityIpsResponseBody(ModifyPxfuseSecurityIpsResponseBody &&) = default ;
    ModifyPxfuseSecurityIpsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyPxfuseSecurityIpsResponseBody() = default ;
    ModifyPxfuseSecurityIpsResponseBody& operator=(const ModifyPxfuseSecurityIpsResponseBody &) = default ;
    ModifyPxfuseSecurityIpsResponseBody& operator=(ModifyPxfuseSecurityIpsResponseBody &&) = default ;
    ...
    inline const ModifyPxfuseSecurityIpsResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, ModifyPxfuseSecurityIpsResponseBody::AccessDeniedDetail) };
    inline ModifyPxfuseSecurityIpsResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, ModifyPxfuseSecurityIpsResponseBody::AccessDeniedDetail) };
    inline ModifyPxfuseSecurityIpsResponseBody& setAccessDeniedDetail(const ModifyPxfuseSecurityIpsResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline ModifyPxfuseSecurityIpsResponseBody& setAccessDeniedDetail(ModifyPxfuseSecurityIpsResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ModifyPxfuseSecurityIpsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyPxfuseSecurityIpsResponseBody::Data) };
    inline ModifyPxfuseSecurityIpsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyPxfuseSecurityIpsResponseBody::Data) };
    inline ModifyPxfuseSecurityIpsResponseBody& setData(const ModifyPxfuseSecurityIpsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyPxfuseSecurityIpsResponseBody& setData(ModifyPxfuseSecurityIpsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ModifyPxfuseSecurityIpsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<ModifyPxfuseSecurityIpsResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The monitoring data.
    shared_ptr<ModifyPxfuseSecurityIpsResponseBody::Data> data_ {};
    // The request ID.
