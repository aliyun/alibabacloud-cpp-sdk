...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEPXFUSEINFORESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEPXFUSEINFORESPONSEBODY_HPP_
...
namespace Models
{
  class DescribePxfuseInfoResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribePxfuseInfoResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribePxfuseInfoResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribePxfuseInfoResponseBody() = default ;
    DescribePxfuseInfoResponseBody(const DescribePxfuseInfoResponseBody &) = default ;
    DescribePxfuseInfoResponseBody(DescribePxfuseInfoResponseBody &&) = default ;
    DescribePxfuseInfoResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribePxfuseInfoResponseBody() = default ;
    DescribePxfuseInfoResponseBody& operator=(const DescribePxfuseInfoResponseBody &) = default ;
    DescribePxfuseInfoResponseBody& operator=(DescribePxfuseInfoResponseBody &&) = default ;
    ...
    inline const DescribePxfuseInfoResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DescribePxfuseInfoResponseBody::AccessDeniedDetail) };
    inline DescribePxfuseInfoResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DescribePxfuseInfoResponseBody::AccessDeniedDetail) };
    inline DescribePxfuseInfoResponseBody& setAccessDeniedDetail(const DescribePxfuseInfoResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DescribePxfuseInfoResponseBody& setAccessDeniedDetail(DescribePxfuseInfoResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DescribePxfuseInfoResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribePxfuseInfoResponseBody::Data) };
    inline DescribePxfuseInfoResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribePxfuseInfoResponseBody::Data) };
    inline DescribePxfuseInfoResponseBody& setData(const DescribePxfuseInfoResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribePxfuseInfoResponseBody& setData(DescribePxfuseInfoResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribePxfuseInfoResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<DescribePxfuseInfoResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The monitoring data.
    shared_ptr<DescribePxfuseInfoResponseBody::Data> data_ {};
    // The request ID.
