...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeActiveOperationTaskCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeActiveOperationTaskCountResponseBody) };
    inline DescribeActiveOperationTaskCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeActiveOperationTaskCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeActiveOperationTaskCountResponseBody> body_ {};
  };
