...
#ifndef ALIBABACLOUD_MODELS_CREATEOPENSEARCHACCOUNTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEOPENSEARCHACCOUNTRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateOpenSearchAccountResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateOpenSearchAccountResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateOpenSearchAccountResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    CreateOpenSearchAccountResponseBody() = default ;
    CreateOpenSearchAccountResponseBody(const CreateOpenSearchAccountResponseBody &) = default ;
    CreateOpenSearchAccountResponseBody(CreateOpenSearchAccountResponseBody &&) = default ;
    CreateOpenSearchAccountResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateOpenSearchAccountResponseBody() = default ;
    CreateOpenSearchAccountResponseBody& operator=(const CreateOpenSearchAccountResponseBody &) = default ;
    CreateOpenSearchAccountResponseBody& operator=(CreateOpenSearchAccountResponseBody &&) = default ;
    ...
    inline const CreateOpenSearchAccountResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, CreateOpenSearchAccountResponseBody::AccessDeniedDetail) };
    inline CreateOpenSearchAccountResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, CreateOpenSearchAccountResponseBody::AccessDeniedDetail) };
    inline CreateOpenSearchAccountResponseBody& setAccessDeniedDetail(const CreateOpenSearchAccountResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline CreateOpenSearchAccountResponseBody& setAccessDeniedDetail(CreateOpenSearchAccountResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateOpenSearchAccountResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateOpenSearchAccountResponseBody::Data) };
    inline CreateOpenSearchAccountResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateOpenSearchAccountResponseBody::Data) };
    inline CreateOpenSearchAccountResponseBody& setData(const CreateOpenSearchAccountResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateOpenSearchAccountResponseBody& setData(CreateOpenSearchAccountResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateOpenSearchAccountResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
