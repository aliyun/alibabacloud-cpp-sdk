...
#ifndef ALIBABACLOUD_MODELS_RELEASEMEM0PUBLICCONNECTIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_RELEASEMEM0PUBLICCONNECTIONRESPONSEBODY_HPP_
...
namespace Models
{
  class ReleaseMem0PublicConnectionResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ReleaseMem0PublicConnectionResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ReleaseMem0PublicConnectionResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ReleaseMem0PublicConnectionResponseBody() = default ;
    ReleaseMem0PublicConnectionResponseBody(const ReleaseMem0PublicConnectionResponseBody &) = default ;
    ReleaseMem0PublicConnectionResponseBody(ReleaseMem0PublicConnectionResponseBody &&) = default ;
    ReleaseMem0PublicConnectionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReleaseMem0PublicConnectionResponseBody() = default ;
    ReleaseMem0PublicConnectionResponseBody& operator=(const ReleaseMem0PublicConnectionResponseBody &) = default ;
    ReleaseMem0PublicConnectionResponseBody& operator=(ReleaseMem0PublicConnectionResponseBody &&) = default ;
    ...
    inline const ReleaseMem0PublicConnectionResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, ReleaseMem0PublicConnectionResponseBody::AccessDeniedDetail) };
    inline ReleaseMem0PublicConnectionResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, ReleaseMem0PublicConnectionResponseBody::AccessDeniedDetail) };
    inline ReleaseMem0PublicConnectionResponseBody& setAccessDeniedDetail(const ReleaseMem0PublicConnectionResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline ReleaseMem0PublicConnectionResponseBody& setAccessDeniedDetail(ReleaseMem0PublicConnectionResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ReleaseMem0PublicConnectionResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details about the access denial.
    shared_ptr<ReleaseMem0PublicConnectionResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The request ID.
