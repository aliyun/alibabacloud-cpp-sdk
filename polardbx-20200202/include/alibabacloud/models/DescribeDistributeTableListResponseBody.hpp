...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDistributeTableListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDistributeTableListResponseBodyData) };
    inline DescribeDistributeTableListResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDistributeTableListResponseBodyData) };
    inline DescribeDistributeTableListResponseBody& setData(const DescribeDistributeTableListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDistributeTableListResponseBody& setData(DescribeDistributeTableListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeDistributeTableListResponseBodyData> data_ = nullptr;
