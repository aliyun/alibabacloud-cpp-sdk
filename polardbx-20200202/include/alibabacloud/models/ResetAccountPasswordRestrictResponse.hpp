...
namespace Models
{
  ...
  public:
    ...
    inline const ResetAccountPasswordRestrictResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResetAccountPasswordRestrictResponseBody) };
    inline ResetAccountPasswordRestrictResponseBody getBody() { DARABONBA_PTR_GET(body_, ResetAccountPasswordRestrictResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResetAccountPasswordRestrictResponseBody> body_ {};
  };
