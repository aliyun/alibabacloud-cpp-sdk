...
#ifndef ALIBABACLOUD_MODELS_ALLOCATECONTEXTDBPUBLICCONNECTIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ALLOCATECONTEXTDBPUBLICCONNECTIONRESPONSEBODY_HPP_
...
namespace Models
{
  class AllocateContextDBPublicConnectionResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AllocateContextDBPublicConnectionResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, AllocateContextDBPublicConnectionResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    AllocateContextDBPublicConnectionResponseBody() = default ;
    AllocateContextDBPublicConnectionResponseBody(const AllocateContextDBPublicConnectionResponseBody &) = default ;
    AllocateContextDBPublicConnectionResponseBody(AllocateContextDBPublicConnectionResponseBody &&) = default ;
    AllocateContextDBPublicConnectionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AllocateContextDBPublicConnectionResponseBody() = default ;
    AllocateContextDBPublicConnectionResponseBody& operator=(const AllocateContextDBPublicConnectionResponseBody &) = default ;
    AllocateContextDBPublicConnectionResponseBody& operator=(AllocateContextDBPublicConnectionResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->connectionString_ == nullptr
        && this->contextDBInstanceName_ == nullptr && this->DBInstanceId_ == nullptr && this->DBInstanceName_ == nullptr && this->DBInstanceNetType_ == nullptr && this->nodeType_ == nullptr
    ...
    inline const AllocateContextDBPublicConnectionResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, AllocateContextDBPublicConnectionResponseBody::AccessDeniedDetail) };
    inline AllocateContextDBPublicConnectionResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, AllocateContextDBPublicConnectionResponseBody::AccessDeniedDetail) };
    inline AllocateContextDBPublicConnectionResponseBody& setAccessDeniedDetail(const AllocateContextDBPublicConnectionResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline AllocateContextDBPublicConnectionResponseBody& setAccessDeniedDetail(AllocateContextDBPublicConnectionResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const AllocateContextDBPublicConnectionResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, AllocateContextDBPublicConnectionResponseBody::Data) };
    inline AllocateContextDBPublicConnectionResponseBody::Data getData() { DARABONBA_PTR_GET(data_, AllocateContextDBPublicConnectionResponseBody::Data) };
    inline AllocateContextDBPublicConnectionResponseBody& setData(const AllocateContextDBPublicConnectionResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AllocateContextDBPublicConnectionResponseBody& setData(AllocateContextDBPublicConnectionResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline AllocateContextDBPublicConnectionResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<AllocateContextDBPublicConnectionResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The task details.
    shared_ptr<AllocateContextDBPublicConnectionResponseBody::Data> data_ {};
    // The request ID.
