...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGdnInstancesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeGdnInstancesResponseBodyData) };
    inline DescribeGdnInstancesResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeGdnInstancesResponseBodyData) };
    inline DescribeGdnInstancesResponseBody& setData(const DescribeGdnInstancesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeGdnInstancesResponseBody& setData(DescribeGdnInstancesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeGdnInstancesResponseBodyData> data_ = nullptr;
