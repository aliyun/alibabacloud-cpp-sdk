...
namespace Models
{
  ...
  public:
    ...
    inline ResetAccountPasswordResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ResetAccountPasswordResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
