...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRplInspectionTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeRplInspectionTaskResponseBody) };
    inline DescribeRplInspectionTaskResponseBody body() { DARABONBA_PTR_GET(body_, DescribeRplInspectionTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRplInspectionTaskResponseBody> body_ = nullptr;
  };
