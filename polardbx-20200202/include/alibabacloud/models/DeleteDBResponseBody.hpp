...
namespace Models
{
  ...
  public:
    ...
    inline DeleteDBResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DeleteDBResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
