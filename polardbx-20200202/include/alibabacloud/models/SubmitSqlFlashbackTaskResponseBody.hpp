...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitSqlFlashbackTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SubmitSqlFlashbackTaskResponseBodyData) };
    inline SubmitSqlFlashbackTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, SubmitSqlFlashbackTaskResponseBodyData) };
    inline SubmitSqlFlashbackTaskResponseBody& setData(const SubmitSqlFlashbackTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitSqlFlashbackTaskResponseBody& setData(SubmitSqlFlashbackTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<SubmitSqlFlashbackTaskResponseBodyData> data_ = nullptr;
