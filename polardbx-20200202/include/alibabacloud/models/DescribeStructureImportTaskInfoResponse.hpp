...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeStructureImportTaskInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeStructureImportTaskInfoResponseBody) };
    inline DescribeStructureImportTaskInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeStructureImportTaskInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeStructureImportTaskInfoResponseBody> body_ {};
  };
