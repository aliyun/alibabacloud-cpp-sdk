...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCdcClassResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCdcClassResponseBody) };
    inline ModifyCdcClassResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCdcClassResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCdcClassResponseBody> body_ {};
  };
