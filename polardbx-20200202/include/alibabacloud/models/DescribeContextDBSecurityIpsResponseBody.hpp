...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECONTEXTDBSECURITYIPSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECONTEXTDBSECURITYIPSRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeContextDBSecurityIpsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeContextDBSecurityIpsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeContextDBSecurityIpsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeContextDBSecurityIpsResponseBody() = default ;
    DescribeContextDBSecurityIpsResponseBody(const DescribeContextDBSecurityIpsResponseBody &) = default ;
    DescribeContextDBSecurityIpsResponseBody(DescribeContextDBSecurityIpsResponseBody &&) = default ;
    DescribeContextDBSecurityIpsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeContextDBSecurityIpsResponseBody() = default ;
    DescribeContextDBSecurityIpsResponseBody& operator=(const DescribeContextDBSecurityIpsResponseBody &) = default ;
    DescribeContextDBSecurityIpsResponseBody& operator=(DescribeContextDBSecurityIpsResponseBody &&) = default ;
    ...
    inline const DescribeContextDBSecurityIpsResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DescribeContextDBSecurityIpsResponseBody::AccessDeniedDetail) };
    inline DescribeContextDBSecurityIpsResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DescribeContextDBSecurityIpsResponseBody::AccessDeniedDetail) };
    inline DescribeContextDBSecurityIpsResponseBody& setAccessDeniedDetail(const DescribeContextDBSecurityIpsResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DescribeContextDBSecurityIpsResponseBody& setAccessDeniedDetail(DescribeContextDBSecurityIpsResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DescribeContextDBSecurityIpsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeContextDBSecurityIpsResponseBody::Data) };
    inline DescribeContextDBSecurityIpsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeContextDBSecurityIpsResponseBody::Data) };
    inline DescribeContextDBSecurityIpsResponseBody& setData(const DescribeContextDBSecurityIpsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeContextDBSecurityIpsResponseBody& setData(DescribeContextDBSecurityIpsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeContextDBSecurityIpsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<DescribeContextDBSecurityIpsResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The paginated result of the instance list.
    shared_ptr<DescribeContextDBSecurityIpsResponseBody::Data> data_ {};
    // The request ID.
