...
#ifndef ALIBABACLOUD_MODELS_CREATEOPENSEARCHRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEOPENSEARCHRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateOpenSearchResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateOpenSearchResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateOpenSearchResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    CreateOpenSearchResponseBody() = default ;
    CreateOpenSearchResponseBody(const CreateOpenSearchResponseBody &) = default ;
    CreateOpenSearchResponseBody(CreateOpenSearchResponseBody &&) = default ;
    CreateOpenSearchResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateOpenSearchResponseBody() = default ;
    CreateOpenSearchResponseBody& operator=(const CreateOpenSearchResponseBody &) = default ;
    CreateOpenSearchResponseBody& operator=(CreateOpenSearchResponseBody &&) = default ;
    ...
    inline const CreateOpenSearchResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, CreateOpenSearchResponseBody::AccessDeniedDetail) };
    inline CreateOpenSearchResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, CreateOpenSearchResponseBody::AccessDeniedDetail) };
    inline CreateOpenSearchResponseBody& setAccessDeniedDetail(const CreateOpenSearchResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline CreateOpenSearchResponseBody& setAccessDeniedDetail(CreateOpenSearchResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateOpenSearchResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateOpenSearchResponseBody::Data) };
    inline CreateOpenSearchResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateOpenSearchResponseBody::Data) };
    inline CreateOpenSearchResponseBody& setData(const CreateOpenSearchResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateOpenSearchResponseBody& setData(CreateOpenSearchResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateOpenSearchResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<CreateOpenSearchResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The operation result.
    shared_ptr<CreateOpenSearchResponseBody::Data> data_ {};
    // The request ID.
