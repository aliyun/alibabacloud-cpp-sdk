...
#ifndef ALIBABACLOUD_MODELS_MODIFYCONTEXT0SECURITYIPSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MODIFYCONTEXT0SECURITYIPSRESPONSEBODY_HPP_
...
namespace Models
{
  class ModifyContext0SecurityIpsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyContext0SecurityIpsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyContext0SecurityIpsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ModifyContext0SecurityIpsResponseBody() = default ;
    ModifyContext0SecurityIpsResponseBody(const ModifyContext0SecurityIpsResponseBody &) = default ;
    ModifyContext0SecurityIpsResponseBody(ModifyContext0SecurityIpsResponseBody &&) = default ;
    ModifyContext0SecurityIpsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyContext0SecurityIpsResponseBody() = default ;
    ModifyContext0SecurityIpsResponseBody& operator=(const ModifyContext0SecurityIpsResponseBody &) = default ;
    ModifyContext0SecurityIpsResponseBody& operator=(ModifyContext0SecurityIpsResponseBody &&) = default ;
    ...
    inline const ModifyContext0SecurityIpsResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, ModifyContext0SecurityIpsResponseBody::AccessDeniedDetail) };
    inline ModifyContext0SecurityIpsResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, ModifyContext0SecurityIpsResponseBody::AccessDeniedDetail) };
    inline ModifyContext0SecurityIpsResponseBody& setAccessDeniedDetail(const ModifyContext0SecurityIpsResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline ModifyContext0SecurityIpsResponseBody& setAccessDeniedDetail(ModifyContext0SecurityIpsResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ModifyContext0SecurityIpsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyContext0SecurityIpsResponseBody::Data) };
    inline ModifyContext0SecurityIpsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyContext0SecurityIpsResponseBody::Data) };
    inline ModifyContext0SecurityIpsResponseBody& setData(const ModifyContext0SecurityIpsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyContext0SecurityIpsResponseBody& setData(ModifyContext0SecurityIpsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ModifyContext0SecurityIpsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<ModifyContext0SecurityIpsResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The returned data.
    shared_ptr<ModifyContext0SecurityIpsResponseBody::Data> data_ {};
    // The request ID.
