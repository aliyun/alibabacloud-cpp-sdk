...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataImportTaskInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataImportTaskInfoResponseBody) };
    inline DescribeDataImportTaskInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDataImportTaskInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDataImportTaskInfoResponseBody> body_ {};
  };
