...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccountListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccountListResponseBody) };
    inline DescribeAccountListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAccountListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAccountListResponseBody> body_ {};
  };
