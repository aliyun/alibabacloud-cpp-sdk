...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRplInspectionTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateRplInspectionTaskResponseBodyData) };
    inline CreateRplInspectionTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateRplInspectionTaskResponseBodyData) };
    inline CreateRplInspectionTaskResponseBody& setData(const CreateRplInspectionTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateRplInspectionTaskResponseBody& setData(CreateRplInspectionTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<CreateRplInspectionTaskResponseBodyData> data_ = nullptr;
