...
#ifndef ALIBABACLOUD_MODELS_SCALEINOPENSEARCHRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SCALEINOPENSEARCHRESPONSEBODY_HPP_
...
namespace Models
{
  class ScaleInOpenSearchResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ScaleInOpenSearchResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(OrderId, orderId_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ScaleInOpenSearchResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(OrderId, orderId_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ScaleInOpenSearchResponseBody() = default ;
    ScaleInOpenSearchResponseBody(const ScaleInOpenSearchResponseBody &) = default ;
    ScaleInOpenSearchResponseBody(ScaleInOpenSearchResponseBody &&) = default ;
    ScaleInOpenSearchResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ScaleInOpenSearchResponseBody() = default ;
    ScaleInOpenSearchResponseBody& operator=(const ScaleInOpenSearchResponseBody &) = default ;
    ScaleInOpenSearchResponseBody& operator=(ScaleInOpenSearchResponseBody &&) = default ;
    ...
    inline const ScaleInOpenSearchResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, ScaleInOpenSearchResponseBody::AccessDeniedDetail) };
    inline ScaleInOpenSearchResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, ScaleInOpenSearchResponseBody::AccessDeniedDetail) };
    inline ScaleInOpenSearchResponseBody& setAccessDeniedDetail(const ScaleInOpenSearchResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline ScaleInOpenSearchResponseBody& setAccessDeniedDetail(ScaleInOpenSearchResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ScaleInOpenSearchResponseBody& setOrderId(string orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline ScaleInOpenSearchResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<ScaleInOpenSearchResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The order ID.
