...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeColumnarVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeColumnarVersionResponseBody) };
    inline UpgradeColumnarVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeColumnarVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeColumnarVersionResponseBody> body_ {};
  };
