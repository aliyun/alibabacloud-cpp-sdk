...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->cdcInstanceName_ != nullptr
        ...
        && this->expireTime_ != nullptr && this->expired_ != nullptr && this->id_ != nullptr && this->lockMode_ != nullptr && this->lockReason_ != nullptr
        && this->minorVersion_ != nullptr && this->network_ != nullptr && this->nodeClass_ != nullptr && this->nodeCount_ != nullptr && this->nodes_ != nullptr
        && this->payType_ != nullptr && this->primaryInstanceId_ != nullptr && this->primaryZone_ != nullptr && this->readDBInstances_ != nullptr && this->regionId_ != nullptr
        && this->resourceGroupId_ != nullptr && this->secondaryZone_ != nullptr && this->series_ != nullptr && this->status_ != nullptr && this->storageType_ != nullptr
        && this->storageUsed_ != nullptr && this->supportBinlogX_ != nullptr && this->tagSet_ != nullptr && this->tertiaryZone_ != nullptr && this->topologyType_ != nullptr
        && this->type_ != nullptr && this->VPCId_ != nullptr && this->zoneId_ != nullptr && this->gdnRole_ != nullptr && this->isInGdn_ != nullptr; };
