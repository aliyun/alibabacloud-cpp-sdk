...
#ifndef ALIBABACLOUD_MODELS_ALLOCATEMEM0PUBLICCONNECTIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ALLOCATEMEM0PUBLICCONNECTIONRESPONSEBODY_HPP_
...
namespace Models
{
  class AllocateMem0PublicConnectionResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AllocateMem0PublicConnectionResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, AllocateMem0PublicConnectionResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    AllocateMem0PublicConnectionResponseBody() = default ;
    AllocateMem0PublicConnectionResponseBody(const AllocateMem0PublicConnectionResponseBody &) = default ;
    AllocateMem0PublicConnectionResponseBody(AllocateMem0PublicConnectionResponseBody &&) = default ;
    AllocateMem0PublicConnectionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AllocateMem0PublicConnectionResponseBody() = default ;
    AllocateMem0PublicConnectionResponseBody& operator=(const AllocateMem0PublicConnectionResponseBody &) = default ;
    AllocateMem0PublicConnectionResponseBody& operator=(AllocateMem0PublicConnectionResponseBody &&) = default ;
    ...
    inline const AllocateMem0PublicConnectionResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, AllocateMem0PublicConnectionResponseBody::AccessDeniedDetail) };
    inline AllocateMem0PublicConnectionResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, AllocateMem0PublicConnectionResponseBody::AccessDeniedDetail) };
    inline AllocateMem0PublicConnectionResponseBody& setAccessDeniedDetail(const AllocateMem0PublicConnectionResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline AllocateMem0PublicConnectionResponseBody& setAccessDeniedDetail(AllocateMem0PublicConnectionResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline AllocateMem0PublicConnectionResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details about the access denial.
    shared_ptr<AllocateMem0PublicConnectionResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // Id of the request
