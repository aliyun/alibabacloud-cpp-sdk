...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDataImportTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateDataImportTaskResponseBody) };
    inline CreateDataImportTaskResponseBody body() { DARABONBA_PTR_GET(body_, CreateDataImportTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateDataImportTaskResponseBody> body_ = nullptr;
  };
