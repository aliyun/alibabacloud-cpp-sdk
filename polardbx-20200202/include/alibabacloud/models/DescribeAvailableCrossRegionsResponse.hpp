...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAvailableCrossRegionsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAvailableCrossRegionsResponseBody) };
    inline DescribeAvailableCrossRegionsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAvailableCrossRegionsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAvailableCrossRegionsResponseBody> body_ = nullptr;
  };
