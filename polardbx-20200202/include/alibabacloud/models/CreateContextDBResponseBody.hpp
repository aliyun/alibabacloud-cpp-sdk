...
#ifndef ALIBABACLOUD_MODELS_CREATECONTEXTDBRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATECONTEXTDBRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateContextDBResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateContextDBResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateContextDBResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    CreateContextDBResponseBody() = default ;
    CreateContextDBResponseBody(const CreateContextDBResponseBody &) = default ;
    CreateContextDBResponseBody(CreateContextDBResponseBody &&) = default ;
    CreateContextDBResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateContextDBResponseBody() = default ;
    CreateContextDBResponseBody& operator=(const CreateContextDBResponseBody &) = default ;
    CreateContextDBResponseBody& operator=(CreateContextDBResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->contextDBAdminKey_ == nullptr
        && this->contextDBInstanceName_ == nullptr && this->DBInstanceName_ == nullptr && this->dashboardReplicaSetName_ == nullptr && this->openSearchInstanceName_ == nullptr && this->serviceReplicaSetName_ == nullptr
    ...
    inline const CreateContextDBResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, CreateContextDBResponseBody::AccessDeniedDetail) };
    inline CreateContextDBResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, CreateContextDBResponseBody::AccessDeniedDetail) };
    inline CreateContextDBResponseBody& setAccessDeniedDetail(const CreateContextDBResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline CreateContextDBResponseBody& setAccessDeniedDetail(CreateContextDBResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateContextDBResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateContextDBResponseBody::Data) };
    inline CreateContextDBResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateContextDBResponseBody::Data) };
    inline CreateContextDBResponseBody& setData(const CreateContextDBResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateContextDBResponseBody& setData(CreateContextDBResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateContextDBResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<CreateContextDBResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The returned result.
    shared_ptr<CreateContextDBResponseBody::Data> data_ {};
    // The request ID.
