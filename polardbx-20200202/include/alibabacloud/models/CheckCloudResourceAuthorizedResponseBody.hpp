...
namespace Models
{
  ...
  public:
    ...
    inline const CheckCloudResourceAuthorizedResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CheckCloudResourceAuthorizedResponseBodyData) };
    inline CheckCloudResourceAuthorizedResponseBodyData data() { DARABONBA_PTR_GET(data_, CheckCloudResourceAuthorizedResponseBodyData) };
    inline CheckCloudResourceAuthorizedResponseBody& setData(const CheckCloudResourceAuthorizedResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CheckCloudResourceAuthorizedResponseBody& setData(CheckCloudResourceAuthorizedResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<CheckCloudResourceAuthorizedResponseBodyData> data_ = nullptr;
