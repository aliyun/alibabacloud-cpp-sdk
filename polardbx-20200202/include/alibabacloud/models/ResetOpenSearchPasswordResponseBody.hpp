...
#ifndef ALIBABACLOUD_MODELS_RESETOPENSEARCHPASSWORDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_RESETOPENSEARCHPASSWORDRESPONSEBODY_HPP_
...
namespace Models
{
  class ResetOpenSearchPasswordResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ResetOpenSearchPasswordResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ResetOpenSearchPasswordResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ResetOpenSearchPasswordResponseBody() = default ;
    ResetOpenSearchPasswordResponseBody(const ResetOpenSearchPasswordResponseBody &) = default ;
    ResetOpenSearchPasswordResponseBody(ResetOpenSearchPasswordResponseBody &&) = default ;
    ResetOpenSearchPasswordResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ResetOpenSearchPasswordResponseBody() = default ;
    ResetOpenSearchPasswordResponseBody& operator=(const ResetOpenSearchPasswordResponseBody &) = default ;
    ResetOpenSearchPasswordResponseBody& operator=(ResetOpenSearchPasswordResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->message_ == nullptr
        && this->passwordLastModified_ == nullptr; };
    ...
    inline const ResetOpenSearchPasswordResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, ResetOpenSearchPasswordResponseBody::AccessDeniedDetail) };
    inline ResetOpenSearchPasswordResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, ResetOpenSearchPasswordResponseBody::AccessDeniedDetail) };
    inline ResetOpenSearchPasswordResponseBody& setAccessDeniedDetail(const ResetOpenSearchPasswordResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline ResetOpenSearchPasswordResponseBody& setAccessDeniedDetail(ResetOpenSearchPasswordResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ResetOpenSearchPasswordResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ResetOpenSearchPasswordResponseBody::Data) };
    inline ResetOpenSearchPasswordResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ResetOpenSearchPasswordResponseBody::Data) };
    inline ResetOpenSearchPasswordResponseBody& setData(const ResetOpenSearchPasswordResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ResetOpenSearchPasswordResponseBody& setData(ResetOpenSearchPasswordResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ResetOpenSearchPasswordResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<ResetOpenSearchPasswordResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The monitoring data.
    shared_ptr<ResetOpenSearchPasswordResponseBody::Data> data_ {};
    // Id of the request
