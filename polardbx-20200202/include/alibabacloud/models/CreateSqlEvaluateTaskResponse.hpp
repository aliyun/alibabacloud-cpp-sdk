...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSQLEvaluateTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateSQLEvaluateTaskResponseBody) };
    inline CreateSQLEvaluateTaskResponseBody body() { DARABONBA_PTR_GET(body_, CreateSQLEvaluateTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateSQLEvaluateTaskResponseBody> body_ = nullptr;
  };
