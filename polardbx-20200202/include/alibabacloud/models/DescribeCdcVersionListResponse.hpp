...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdcVersionListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdcVersionListResponseBody) };
    inline DescribeCdcVersionListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdcVersionListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdcVersionListResponseBody> body_ {};
  };
