...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCustomEndpointResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateCustomEndpointResponseBodyData) };
    inline CreateCustomEndpointResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateCustomEndpointResponseBodyData) };
    inline CreateCustomEndpointResponseBody& setData(const CreateCustomEndpointResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateCustomEndpointResponseBody& setData(CreateCustomEndpointResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<CreateCustomEndpointResponseBodyData> data_ = nullptr;
    // Id of the request
