...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAccountListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeAccountListResponseBodyData>) };
    inline vector<DescribeAccountListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeAccountListResponseBodyData>) };
    inline DescribeAccountListResponseBody& setData(const vector<DescribeAccountListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAccountListResponseBody& setData(vector<DescribeAccountListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<DescribeAccountListResponseBodyData>> data_ = nullptr;
