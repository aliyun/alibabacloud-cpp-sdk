...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->connectionString_ == nullptr
        && this->DBInstanceName_ == nullptr && this->newPort_ == nullptr && this->newPrefix_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline string getNewPort() const { DARABONBA_PTR_GET_DEFAULT(newPort_, "") };
    ...
    inline string getNewPrefix() const { DARABONBA_PTR_GET_DEFAULT(newPrefix_, "") };
