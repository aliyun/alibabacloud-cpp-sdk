...
namespace Models
{
  ...
  public:
    ...
    inline CreateDBResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateDBResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
