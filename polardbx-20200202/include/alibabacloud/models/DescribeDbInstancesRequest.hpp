...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->dbVersion_ == nullptr
        && return this->instanceId_ == nullptr && return this->mustHasCdc_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->regionId_ == nullptr
        && return this->resourceGroupId_ == nullptr && return this->series_ == nullptr && return this->tags_ == nullptr; };
