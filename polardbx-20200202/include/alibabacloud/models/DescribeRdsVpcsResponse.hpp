...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRdsVpcsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRdsVpcsResponseBody) };
    inline DescribeRdsVpcsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRdsVpcsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRdsVpcsResponseBody> body_ {};
  };
