  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->bid_ == nullptr
        && this->creator_ == nullptr && this->deleted_ == nullptr && this->gmtCreated_ == nullptr && this->gmtModified_ == nullptr && this->id_ == nullptr
        && this->regionId_ == nullptr && this->slinkDstDb_ == nullptr && this->slinkDstResId_ == nullptr && this->slinkDstUserName_ == nullptr && this->slinkSrcDb_ == nullptr
        && this->slinkSrcResId_ == nullptr && this->slinkSrcResType_ == nullptr && this->slinkSrcUserName_ == nullptr && this->slinkStage_ == nullptr && this->slinkStatus_ == nullptr
        && this->slinkTaskDesc_ == nullptr && this->slinkTaskId_ == nullptr && this->slinkType_ == nullptr; };
      // bid Field Functions 
    ...
    inline const vector<DescribeEvaluateAndImportTasksResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeEvaluateAndImportTasksResponseBody::Data>) };
    inline vector<DescribeEvaluateAndImportTasksResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<DescribeEvaluateAndImportTasksResponseBody::Data>) };
    inline DescribeEvaluateAndImportTasksResponseBody& setData(const vector<DescribeEvaluateAndImportTasksResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEvaluateAndImportTasksResponseBody& setData(vector<DescribeEvaluateAndImportTasksResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline int64_t getTotalNumber() const { DARABONBA_PTR_GET_DEFAULT(totalNumber_, 0L) };
