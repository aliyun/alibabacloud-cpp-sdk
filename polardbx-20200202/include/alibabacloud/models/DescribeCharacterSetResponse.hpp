...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCharacterSetResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeCharacterSetResponseBody) };
    inline DescribeCharacterSetResponseBody body() { DARABONBA_PTR_GET(body_, DescribeCharacterSetResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCharacterSetResponseBody> body_ = nullptr;
  };
