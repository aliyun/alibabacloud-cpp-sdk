...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceName_ == nullptr
        && this->encryptionKey_ == nullptr && this->regionId_ == nullptr && this->roleArn_ == nullptr && this->TDEStatus_ == nullptr; };
    ...
    inline int32_t getTDEStatus() const { DARABONBA_PTR_GET_DEFAULT(TDEStatus_, 0) };
