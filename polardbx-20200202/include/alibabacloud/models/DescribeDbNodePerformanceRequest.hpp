...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->characterType_ == nullptr
        && return this->DBInstanceName_ == nullptr && return this->DBNodeIds_ == nullptr && return this->DBNodeRole_ == nullptr && return this->endTime_ == nullptr && return this->key_ == nullptr
