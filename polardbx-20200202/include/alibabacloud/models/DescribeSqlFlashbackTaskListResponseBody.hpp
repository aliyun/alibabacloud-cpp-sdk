...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSqlFlashbackTaskListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSqlFlashbackTaskListResponseBodyData) };
    inline DescribeSqlFlashbackTaskListResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSqlFlashbackTaskListResponseBodyData) };
    inline DescribeSqlFlashbackTaskListResponseBody& setData(const DescribeSqlFlashbackTaskListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSqlFlashbackTaskListResponseBody& setData(DescribeSqlFlashbackTaskListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeSqlFlashbackTaskListResponseBodyData> data_ = nullptr;
