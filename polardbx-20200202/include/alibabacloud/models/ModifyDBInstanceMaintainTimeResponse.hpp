...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstanceMaintainTimeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBInstanceMaintainTimeResponseBody) };
    inline ModifyDBInstanceMaintainTimeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBInstanceMaintainTimeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBInstanceMaintainTimeResponseBody> body_ {};
  };
