...
namespace Models
{
  ...
  public:
    ...
    inline const CreateStructureImportTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateStructureImportTaskResponseBody) };
    inline CreateStructureImportTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateStructureImportTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateStructureImportTaskResponseBody> body_ {};
  };
