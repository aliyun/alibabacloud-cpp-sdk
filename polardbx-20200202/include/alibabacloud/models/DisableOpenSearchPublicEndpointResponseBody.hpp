...
#ifndef ALIBABACLOUD_MODELS_DISABLEOPENSEARCHPUBLICENDPOINTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DISABLEOPENSEARCHPUBLICENDPOINTRESPONSEBODY_HPP_
...
namespace Models
{
  class DisableOpenSearchPublicEndpointResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DisableOpenSearchPublicEndpointResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DisableOpenSearchPublicEndpointResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DisableOpenSearchPublicEndpointResponseBody() = default ;
    DisableOpenSearchPublicEndpointResponseBody(const DisableOpenSearchPublicEndpointResponseBody &) = default ;
    DisableOpenSearchPublicEndpointResponseBody(DisableOpenSearchPublicEndpointResponseBody &&) = default ;
    DisableOpenSearchPublicEndpointResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DisableOpenSearchPublicEndpointResponseBody() = default ;
    DisableOpenSearchPublicEndpointResponseBody& operator=(const DisableOpenSearchPublicEndpointResponseBody &) = default ;
    DisableOpenSearchPublicEndpointResponseBody& operator=(DisableOpenSearchPublicEndpointResponseBody &&) = default ;
    ...
    inline const DisableOpenSearchPublicEndpointResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DisableOpenSearchPublicEndpointResponseBody::AccessDeniedDetail) };
    inline DisableOpenSearchPublicEndpointResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DisableOpenSearchPublicEndpointResponseBody::AccessDeniedDetail) };
    inline DisableOpenSearchPublicEndpointResponseBody& setAccessDeniedDetail(const DisableOpenSearchPublicEndpointResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DisableOpenSearchPublicEndpointResponseBody& setAccessDeniedDetail(DisableOpenSearchPublicEndpointResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline DisableOpenSearchPublicEndpointResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DisableOpenSearchPublicEndpointResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details about the access denial.
    shared_ptr<DisableOpenSearchPublicEndpointResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The error message.
