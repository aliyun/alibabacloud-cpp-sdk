...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityIpsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecurityIpsResponseBody) };
    inline DescribeSecurityIpsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSecurityIpsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSecurityIpsResponseBody> body_ {};
  };
