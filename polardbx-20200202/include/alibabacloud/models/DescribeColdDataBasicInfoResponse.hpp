...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeColdDataBasicInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeColdDataBasicInfoResponseBody) };
    inline DescribeColdDataBasicInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeColdDataBasicInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeColdDataBasicInfoResponseBody> body_ {};
  };
