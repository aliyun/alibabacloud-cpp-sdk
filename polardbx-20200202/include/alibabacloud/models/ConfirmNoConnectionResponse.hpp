...
namespace Models
{
  ...
  public:
    ...
    inline const ConfirmNoConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfirmNoConnectionResponseBody) };
    inline ConfirmNoConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfirmNoConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfirmNoConnectionResponseBody> body_ {};
  };
