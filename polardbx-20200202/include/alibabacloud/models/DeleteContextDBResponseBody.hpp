...
#ifndef ALIBABACLOUD_MODELS_DELETECONTEXTDBRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DELETECONTEXTDBRESPONSEBODY_HPP_
...
namespace Models
{
  class DeleteContextDBResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DeleteContextDBResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteContextDBResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DeleteContextDBResponseBody() = default ;
    DeleteContextDBResponseBody(const DeleteContextDBResponseBody &) = default ;
    DeleteContextDBResponseBody(DeleteContextDBResponseBody &&) = default ;
    DeleteContextDBResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteContextDBResponseBody() = default ;
    DeleteContextDBResponseBody& operator=(const DeleteContextDBResponseBody &) = default ;
    DeleteContextDBResponseBody& operator=(DeleteContextDBResponseBody &&) = default ;
    ...
    inline const DeleteContextDBResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DeleteContextDBResponseBody::AccessDeniedDetail) };
    inline DeleteContextDBResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DeleteContextDBResponseBody::AccessDeniedDetail) };
    inline DeleteContextDBResponseBody& setAccessDeniedDetail(const DeleteContextDBResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DeleteContextDBResponseBody& setAccessDeniedDetail(DeleteContextDBResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DeleteContextDBResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteContextDBResponseBody::Data) };
    inline DeleteContextDBResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteContextDBResponseBody::Data) };
    inline DeleteContextDBResponseBody& setData(const DeleteContextDBResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteContextDBResponseBody& setData(DeleteContextDBResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DeleteContextDBResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<DeleteContextDBResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The parameter details.
    shared_ptr<DeleteContextDBResponseBody::Data> data_ {};
    // Id of the request
