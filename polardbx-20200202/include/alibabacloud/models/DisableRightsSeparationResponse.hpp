...
namespace Models
{
  ...
  public:
    ...
    inline const DisableRightsSeparationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableRightsSeparationResponseBody) };
    inline DisableRightsSeparationResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableRightsSeparationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableRightsSeparationResponseBody> body_ {};
  };
