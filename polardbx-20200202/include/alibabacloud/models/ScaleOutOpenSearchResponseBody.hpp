...
#ifndef ALIBABACLOUD_MODELS_SCALEOUTOPENSEARCHRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SCALEOUTOPENSEARCHRESPONSEBODY_HPP_
...
namespace Models
{
  class ScaleOutOpenSearchResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ScaleOutOpenSearchResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(OrderId, orderId_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ScaleOutOpenSearchResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(OrderId, orderId_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ScaleOutOpenSearchResponseBody() = default ;
    ScaleOutOpenSearchResponseBody(const ScaleOutOpenSearchResponseBody &) = default ;
    ScaleOutOpenSearchResponseBody(ScaleOutOpenSearchResponseBody &&) = default ;
    ScaleOutOpenSearchResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ScaleOutOpenSearchResponseBody() = default ;
    ScaleOutOpenSearchResponseBody& operator=(const ScaleOutOpenSearchResponseBody &) = default ;
    ScaleOutOpenSearchResponseBody& operator=(ScaleOutOpenSearchResponseBody &&) = default ;
    ...
    inline const ScaleOutOpenSearchResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, ScaleOutOpenSearchResponseBody::AccessDeniedDetail) };
    inline ScaleOutOpenSearchResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, ScaleOutOpenSearchResponseBody::AccessDeniedDetail) };
    inline ScaleOutOpenSearchResponseBody& setAccessDeniedDetail(const ScaleOutOpenSearchResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline ScaleOutOpenSearchResponseBody& setAccessDeniedDetail(ScaleOutOpenSearchResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ScaleOutOpenSearchResponseBody& setOrderId(string orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline ScaleOutOpenSearchResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<ScaleOutOpenSearchResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The order ID.
