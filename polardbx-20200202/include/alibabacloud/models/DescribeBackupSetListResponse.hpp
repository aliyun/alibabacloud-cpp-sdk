...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBackupSetListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBackupSetListResponseBody) };
    inline DescribeBackupSetListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBackupSetListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBackupSetListResponseBody> body_ {};
  };
