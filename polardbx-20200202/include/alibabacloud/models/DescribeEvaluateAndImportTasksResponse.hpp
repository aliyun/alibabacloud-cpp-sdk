...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEvaluateAndImportTasksResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeEvaluateAndImportTasksResponseBody) };
    inline DescribeEvaluateAndImportTasksResponseBody body() { DARABONBA_PTR_GET(body_, DescribeEvaluateAndImportTasksResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEvaluateAndImportTasksResponseBody> body_ = nullptr;
  };
