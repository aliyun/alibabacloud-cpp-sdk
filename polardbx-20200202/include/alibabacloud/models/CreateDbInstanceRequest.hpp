...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoRenew_ == nullptr
        ...
        && return this->extraParams_ == nullptr && return this->isColumnarReadDBInstance_ == nullptr && return this->isReadDBInstance_ == nullptr && return this->networkType_ == nullptr && return this->payType_ == nullptr
    ...
    inline const map<string, string> & extraParams() const { DARABONBA_PTR_GET_CONST(extraParams_, map<string, string>) };
    inline map<string, string> extraParams() { DARABONBA_PTR_GET(extraParams_, map<string, string>) };
  ...
  protected:
    ...
    std::shared_ptr<map<string, string>> extraParams_ = nullptr;
