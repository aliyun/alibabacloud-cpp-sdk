...
#ifndef ALIBABACLOUD_MODELS_CREATESUPABASENETTYPERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATESUPABASENETTYPERESPONSEBODY_HPP_
...
namespace Models
{
  class CreateSupabaseNetTypeResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateSupabaseNetTypeResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateSupabaseNetTypeResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    CreateSupabaseNetTypeResponseBody() = default ;
    CreateSupabaseNetTypeResponseBody(const CreateSupabaseNetTypeResponseBody &) = default ;
    CreateSupabaseNetTypeResponseBody(CreateSupabaseNetTypeResponseBody &&) = default ;
    CreateSupabaseNetTypeResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateSupabaseNetTypeResponseBody() = default ;
    CreateSupabaseNetTypeResponseBody& operator=(const CreateSupabaseNetTypeResponseBody &) = default ;
    CreateSupabaseNetTypeResponseBody& operator=(CreateSupabaseNetTypeResponseBody &&) = default ;
    ...
    inline const CreateSupabaseNetTypeResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, CreateSupabaseNetTypeResponseBody::AccessDeniedDetail) };
    inline CreateSupabaseNetTypeResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, CreateSupabaseNetTypeResponseBody::AccessDeniedDetail) };
    inline CreateSupabaseNetTypeResponseBody& setAccessDeniedDetail(const CreateSupabaseNetTypeResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline CreateSupabaseNetTypeResponseBody& setAccessDeniedDetail(CreateSupabaseNetTypeResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateSupabaseNetTypeResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateSupabaseNetTypeResponseBody::Data) };
    inline CreateSupabaseNetTypeResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateSupabaseNetTypeResponseBody::Data) };
    inline CreateSupabaseNetTypeResponseBody& setData(const CreateSupabaseNetTypeResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateSupabaseNetTypeResponseBody& setData(CreateSupabaseNetTypeResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateSupabaseNetTypeResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<CreateSupabaseNetTypeResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The operation result.
    shared_ptr<CreateSupabaseNetTypeResponseBody::Data> data_ {};
    // The request ID.
