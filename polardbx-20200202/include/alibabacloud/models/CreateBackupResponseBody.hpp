...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBackupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateBackupResponseBodyData) };
    inline CreateBackupResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateBackupResponseBodyData) };
    inline CreateBackupResponseBody& setData(const CreateBackupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateBackupResponseBody& setData(CreateBackupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateBackupResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateBackupResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    std::shared_ptr<CreateBackupResponseBodyData> data_ = nullptr;
