...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBackupResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateBackupResponseBody::Data) };
    inline CreateBackupResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateBackupResponseBody::Data) };
    inline CreateBackupResponseBody& setData(const CreateBackupResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateBackupResponseBody& setData(CreateBackupResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
