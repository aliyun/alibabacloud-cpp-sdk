...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeCDCVersionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpgradeCDCVersionResponseBodyData) };
    inline UpgradeCDCVersionResponseBodyData data() { DARABONBA_PTR_GET(data_, UpgradeCDCVersionResponseBodyData) };
    inline UpgradeCDCVersionResponseBody& setData(const UpgradeCDCVersionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpgradeCDCVersionResponseBody& setData(UpgradeCDCVersionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<UpgradeCDCVersionResponseBodyData> data_ = nullptr;
