...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addDNSpec_ == nullptr
        && this->CNNodeCount_ == nullptr && this->clientToken_ == nullptr && this->DBInstanceName_ == nullptr && this->DNNodeCount_ == nullptr && this->dbInstanceNodeCount_ == nullptr
        && this->deleteDNIds_ == nullptr && this->regionId_ == nullptr && this->storagePoolName_ == nullptr; };
    ...
    inline string getAddDNSpec() const { DARABONBA_PTR_GET_DEFAULT(addDNSpec_, "") };
    ...
    inline int32_t getDbInstanceNodeCount() const { DARABONBA_PTR_GET_DEFAULT(dbInstanceNodeCount_, 0) };
    ...
    inline string getDeleteDNIds() const { DARABONBA_PTR_GET_DEFAULT(deleteDNIds_, "") };
