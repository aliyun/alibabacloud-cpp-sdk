...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeArchiveTableListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeArchiveTableListResponseBodyData) };
    inline DescribeArchiveTableListResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeArchiveTableListResponseBodyData) };
    inline DescribeArchiveTableListResponseBody& setData(const DescribeArchiveTableListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeArchiveTableListResponseBody& setData(DescribeArchiveTableListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeArchiveTableListResponseBodyData> data_ = nullptr;
