...
namespace Models
{
  ...
  public:
    ...
    inline const PreCheckSqlFlashbackTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, PreCheckSqlFlashbackTaskResponseBodyData) };
    inline PreCheckSqlFlashbackTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, PreCheckSqlFlashbackTaskResponseBodyData) };
    inline PreCheckSqlFlashbackTaskResponseBody& setData(const PreCheckSqlFlashbackTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PreCheckSqlFlashbackTaskResponseBody& setData(PreCheckSqlFlashbackTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<PreCheckSqlFlashbackTaskResponseBodyData> data_ = nullptr;
