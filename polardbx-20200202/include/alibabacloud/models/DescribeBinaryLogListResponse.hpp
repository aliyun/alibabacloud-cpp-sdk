...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBinaryLogListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeBinaryLogListResponseBody) };
    inline DescribeBinaryLogListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeBinaryLogListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeBinaryLogListResponseBody> body_ = nullptr;
  };
