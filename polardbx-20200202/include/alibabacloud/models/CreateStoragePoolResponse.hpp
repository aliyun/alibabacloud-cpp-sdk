...
namespace Models
{
  ...
  public:
    ...
    inline const CreateStoragePoolResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateStoragePoolResponseBody) };
    inline CreateStoragePoolResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateStoragePoolResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateStoragePoolResponseBody> body_ {};
  };
