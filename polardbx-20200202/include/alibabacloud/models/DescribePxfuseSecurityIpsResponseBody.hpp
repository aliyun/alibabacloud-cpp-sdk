...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEPXFUSESECURITYIPSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEPXFUSESECURITYIPSRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribePxfuseSecurityIpsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribePxfuseSecurityIpsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribePxfuseSecurityIpsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribePxfuseSecurityIpsResponseBody() = default ;
    DescribePxfuseSecurityIpsResponseBody(const DescribePxfuseSecurityIpsResponseBody &) = default ;
    DescribePxfuseSecurityIpsResponseBody(DescribePxfuseSecurityIpsResponseBody &&) = default ;
    DescribePxfuseSecurityIpsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribePxfuseSecurityIpsResponseBody() = default ;
    DescribePxfuseSecurityIpsResponseBody& operator=(const DescribePxfuseSecurityIpsResponseBody &) = default ;
    DescribePxfuseSecurityIpsResponseBody& operator=(DescribePxfuseSecurityIpsResponseBody &&) = default ;
    ...
    inline const DescribePxfuseSecurityIpsResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DescribePxfuseSecurityIpsResponseBody::AccessDeniedDetail) };
    inline DescribePxfuseSecurityIpsResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DescribePxfuseSecurityIpsResponseBody::AccessDeniedDetail) };
    inline DescribePxfuseSecurityIpsResponseBody& setAccessDeniedDetail(const DescribePxfuseSecurityIpsResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DescribePxfuseSecurityIpsResponseBody& setAccessDeniedDetail(DescribePxfuseSecurityIpsResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DescribePxfuseSecurityIpsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribePxfuseSecurityIpsResponseBody::Data) };
    inline DescribePxfuseSecurityIpsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribePxfuseSecurityIpsResponseBody::Data) };
    inline DescribePxfuseSecurityIpsResponseBody& setData(const DescribePxfuseSecurityIpsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribePxfuseSecurityIpsResponseBody& setData(DescribePxfuseSecurityIpsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribePxfuseSecurityIpsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details about the access denial.
    shared_ptr<DescribePxfuseSecurityIpsResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The instance details.
    shared_ptr<DescribePxfuseSecurityIpsResponseBody::Data> data_ {};
    // The request ID.
