...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTransformStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeTransformStatusResponseBodyData) };
    inline DescribeTransformStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeTransformStatusResponseBodyData) };
    inline DescribeTransformStatusResponseBody& setData(const DescribeTransformStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeTransformStatusResponseBody& setData(DescribeTransformStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeTransformStatusResponseBodyData> data_ = nullptr;
    // Id of the request
