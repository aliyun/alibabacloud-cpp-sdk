...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEnabledCrossRegionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEnabledCrossRegionsResponseBody) };
    inline DescribeEnabledCrossRegionsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEnabledCrossRegionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEnabledCrossRegionsResponseBody> body_ {};
  };
