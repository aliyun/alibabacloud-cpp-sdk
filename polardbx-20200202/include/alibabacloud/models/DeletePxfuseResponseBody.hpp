...
#ifndef ALIBABACLOUD_MODELS_DELETEPXFUSERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DELETEPXFUSERESPONSEBODY_HPP_
...
namespace Models
{
  class DeletePxfuseResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DeletePxfuseResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DeletePxfuseResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DeletePxfuseResponseBody() = default ;
    DeletePxfuseResponseBody(const DeletePxfuseResponseBody &) = default ;
    DeletePxfuseResponseBody(DeletePxfuseResponseBody &&) = default ;
    DeletePxfuseResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeletePxfuseResponseBody() = default ;
    DeletePxfuseResponseBody& operator=(const DeletePxfuseResponseBody &) = default ;
    DeletePxfuseResponseBody& operator=(DeletePxfuseResponseBody &&) = default ;
    ...
    inline const DeletePxfuseResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DeletePxfuseResponseBody::AccessDeniedDetail) };
    inline DeletePxfuseResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DeletePxfuseResponseBody::AccessDeniedDetail) };
    inline DeletePxfuseResponseBody& setAccessDeniedDetail(const DeletePxfuseResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DeletePxfuseResponseBody& setAccessDeniedDetail(DeletePxfuseResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DeletePxfuseResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeletePxfuseResponseBody::Data) };
    inline DeletePxfuseResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeletePxfuseResponseBody::Data) };
    inline DeletePxfuseResponseBody& setData(const DeletePxfuseResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeletePxfuseResponseBody& setData(DeletePxfuseResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DeletePxfuseResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<DeletePxfuseResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The monitoring data.
    shared_ptr<DeletePxfuseResponseBody::Data> data_ {};
    // The request ID.
