...
namespace Models
{
  ...
  public:
    ...
    inline const SwitchDBInstanceHAResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SwitchDBInstanceHAResponseBody) };
    inline SwitchDBInstanceHAResponseBody getBody() { DARABONBA_PTR_GET(body_, SwitchDBInstanceHAResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SwitchDBInstanceHAResponseBody> body_ {};
  };
