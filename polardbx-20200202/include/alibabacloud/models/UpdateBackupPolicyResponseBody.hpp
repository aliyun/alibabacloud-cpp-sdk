...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateBackupPolicyResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateBackupPolicyResponseBody::Data) };
    inline UpdateBackupPolicyResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateBackupPolicyResponseBody::Data) };
    inline UpdateBackupPolicyResponseBody& setData(const UpdateBackupPolicyResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateBackupPolicyResponseBody& setData(UpdateBackupPolicyResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
