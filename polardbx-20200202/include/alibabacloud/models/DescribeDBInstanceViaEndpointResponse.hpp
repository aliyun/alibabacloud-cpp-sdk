...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceViaEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstanceViaEndpointResponseBody) };
    inline DescribeDBInstanceViaEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBInstanceViaEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBInstanceViaEndpointResponseBody> body_ {};
  };
