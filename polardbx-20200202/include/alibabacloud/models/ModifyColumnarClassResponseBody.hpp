...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyColumnarClassResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyColumnarClassResponseBody::Data) };
    inline ModifyColumnarClassResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyColumnarClassResponseBody::Data) };
    inline ModifyColumnarClassResponseBody& setData(const ModifyColumnarClassResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyColumnarClassResponseBody& setData(ModifyColumnarClassResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
