...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBackupPolicyResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeBackupPolicyResponseBodyData) };
    inline DescribeBackupPolicyResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeBackupPolicyResponseBodyData) };
    inline DescribeBackupPolicyResponseBody& setData(const DescribeBackupPolicyResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeBackupPolicyResponseBody& setData(DescribeBackupPolicyResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeBackupPolicyResponseBodyData> data_ = nullptr;
