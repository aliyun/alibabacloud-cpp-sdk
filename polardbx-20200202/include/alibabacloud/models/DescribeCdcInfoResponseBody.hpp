...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdcInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCdcInfoResponseBodyData) };
    inline DescribeCdcInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCdcInfoResponseBodyData) };
    inline DescribeCdcInfoResponseBody& setData(const DescribeCdcInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCdcInfoResponseBody& setData(DescribeCdcInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeCdcInfoResponseBodyData> data_ = nullptr;
