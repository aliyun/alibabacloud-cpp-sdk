...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEBACKUPPOLICYRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEBACKUPPOLICYRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeBackupPolicyResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeBackupPolicyResponseBodyData& obj) { 
    ...
    DescribeBackupPolicyResponseBodyData() = default ;
    DescribeBackupPolicyResponseBodyData(const DescribeBackupPolicyResponseBodyData &) = default ;
    DescribeBackupPolicyResponseBodyData(DescribeBackupPolicyResponseBodyData &&) = default ;
    DescribeBackupPolicyResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeBackupPolicyResponseBodyData() = default ;
    DescribeBackupPolicyResponseBodyData& operator=(const DescribeBackupPolicyResponseBodyData &) = default ;
    DescribeBackupPolicyResponseBodyData& operator=(DescribeBackupPolicyResponseBodyData &&) = default ;
    ...
    virtual bool empty() const override { return this->backupPeriod_ == nullptr
        ...
        && return this->localLogRetentionNumber_ == nullptr && return this->logLocalRetentionSpace_ == nullptr && return this->removeLogRetention_ == nullptr; };
    ...
    inline DescribeBackupPolicyResponseBodyData& setBackupPeriod(string backupPeriod) { DARABONBA_PTR_SET_VALUE(backupPeriod_, backupPeriod) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setBackupPlanBegin(string backupPlanBegin) { DARABONBA_PTR_SET_VALUE(backupPlanBegin_, backupPlanBegin) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setBackupSetRetention(int32_t backupSetRetention) { DARABONBA_PTR_SET_VALUE(backupSetRetention_, backupSetRetention) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setBackupType(string backupType) { DARABONBA_PTR_SET_VALUE(backupType_, backupType) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setBackupWay(string backupWay) { DARABONBA_PTR_SET_VALUE(backupWay_, backupWay) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setColdDataBackupInterval(int32_t coldDataBackupInterval) { DARABONBA_PTR_SET_VALUE(coldDataBackupInterval_, coldDataBackupInterval) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setColdDataBackupRetention(int32_t coldDataBackupRetention) { DARABONBA_PTR_SET_VALUE(coldDataBackupRetention_, coldDataBackupRetention) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setCrossRegionDataBackupRetention(int32_t crossRegionDataBackupRetention) { DARABONBA_PTR_SET_VALUE(crossRegionDataBackupRetention_, crossRegionDataBackupRetention) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setCrossRegionLogBackupRetention(int32_t crossRegionLogBackupRetention) { DARABONBA_PTR_SET_VALUE(crossRegionLogBackupRetention_, crossRegionLogBackupRetention) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setDBInstanceName(string DBInstanceName) { DARABONBA_PTR_SET_VALUE(DBInstanceName_, DBInstanceName) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setDestCrossRegion(string destCrossRegion) { DARABONBA_PTR_SET_VALUE(destCrossRegion_, destCrossRegion) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setForceCleanOnHighSpaceUsage(int32_t forceCleanOnHighSpaceUsage) { DARABONBA_PTR_SET_VALUE(forceCleanOnHighSpaceUsage_, forceCleanOnHighSpaceUsage) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setIsCrossRegionDataBackupEnabled(bool isCrossRegionDataBackupEnabled) { DARABONBA_PTR_SET_VALUE(isCrossRegionDataBackupEnabled_, isCrossRegionDataBackupEnabled) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setIsCrossRegionLogBackupEnabled(bool isCrossRegionLogBackupEnabled) { DARABONBA_PTR_SET_VALUE(isCrossRegionLogBackupEnabled_, isCrossRegionLogBackupEnabled) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setIsEnabled(int32_t isEnabled) { DARABONBA_PTR_SET_VALUE(isEnabled_, isEnabled) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setLocalLogRetention(int32_t localLogRetention) { DARABONBA_PTR_SET_VALUE(localLogRetention_, localLogRetention) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setLocalLogRetentionNumber(int32_t localLogRetentionNumber) { DARABONBA_PTR_SET_VALUE(localLogRetentionNumber_, localLogRetentionNumber) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setLogLocalRetentionSpace(int32_t logLocalRetentionSpace) { DARABONBA_PTR_SET_VALUE(logLocalRetentionSpace_, logLocalRetentionSpace) };
    ...
    inline DescribeBackupPolicyResponseBodyData& setRemoveLogRetention(int32_t removeLogRetention) { DARABONBA_PTR_SET_VALUE(removeLogRetention_, removeLogRetention) };
