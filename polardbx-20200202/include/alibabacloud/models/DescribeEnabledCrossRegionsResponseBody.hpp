...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeEnabledCrossRegionsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeEnabledCrossRegionsResponseBodyData>) };
    inline vector<DescribeEnabledCrossRegionsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeEnabledCrossRegionsResponseBodyData>) };
    inline DescribeEnabledCrossRegionsResponseBody& setData(const vector<DescribeEnabledCrossRegionsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEnabledCrossRegionsResponseBody& setData(vector<DescribeEnabledCrossRegionsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<DescribeEnabledCrossRegionsResponseBodyData>> data_ = nullptr;
