...
namespace Models
{
  ...
  public:
    ...
    inline ModifySecurityIpsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ModifySecurityIpsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
