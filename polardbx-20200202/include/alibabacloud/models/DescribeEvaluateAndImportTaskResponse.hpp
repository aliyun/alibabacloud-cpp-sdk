...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEvaluateAndImportTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEvaluateAndImportTaskResponseBody) };
    inline DescribeEvaluateAndImportTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEvaluateAndImportTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEvaluateAndImportTaskResponseBody> body_ {};
  };
