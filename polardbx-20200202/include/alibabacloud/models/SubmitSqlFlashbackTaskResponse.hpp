...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitSqlFlashbackTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SubmitSqlFlashbackTaskResponseBody) };
    inline SubmitSqlFlashbackTaskResponseBody body() { DARABONBA_PTR_GET(body_, SubmitSqlFlashbackTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SubmitSqlFlashbackTaskResponseBody> body_ = nullptr;
  };
