...
#ifndef ALIBABACLOUD_MODELS_DESCRIBERPLINSPECTIONTASKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBERPLINSPECTIONTASKREQUEST_HPP_
...
namespace Models
{
  class DescribeRplInspectionTaskRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeRplInspectionTaskRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeRplInspectionTaskRequest& obj) { 
    ...
    DescribeRplInspectionTaskRequest() = default ;
    DescribeRplInspectionTaskRequest(const DescribeRplInspectionTaskRequest &) = default ;
    DescribeRplInspectionTaskRequest(DescribeRplInspectionTaskRequest &&) = default ;
    DescribeRplInspectionTaskRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeRplInspectionTaskRequest() = default ;
    DescribeRplInspectionTaskRequest& operator=(const DescribeRplInspectionTaskRequest &) = default ;
    DescribeRplInspectionTaskRequest& operator=(DescribeRplInspectionTaskRequest &&) = default ;
    ...
    inline DescribeRplInspectionTaskRequest& setFailPageNumber(int32_t failPageNumber) { DARABONBA_PTR_SET_VALUE(failPageNumber_, failPageNumber) };
    ...
    inline DescribeRplInspectionTaskRequest& setFailPageSize(int32_t failPageSize) { DARABONBA_PTR_SET_VALUE(failPageSize_, failPageSize) };
    ...
    inline DescribeRplInspectionTaskRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline DescribeRplInspectionTaskRequest& setSlinkTaskId(string slinkTaskId) { DARABONBA_PTR_SET_VALUE(slinkTaskId_, slinkTaskId) };
    ...
    inline DescribeRplInspectionTaskRequest& setSuccessPageNumber(int64_t successPageNumber) { DARABONBA_PTR_SET_VALUE(successPageNumber_, successPageNumber) };
    ...
    inline DescribeRplInspectionTaskRequest& setSuccessPageSize(int64_t successPageSize) { DARABONBA_PTR_SET_VALUE(successPageSize_, successPageSize) };
