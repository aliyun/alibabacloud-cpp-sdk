...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMem0ResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, CreateMem0ResponseBody::AccessDeniedDetail) };
    inline CreateMem0ResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, CreateMem0ResponseBody::AccessDeniedDetail) };
    inline CreateMem0ResponseBody& setAccessDeniedDetail(const CreateMem0ResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline CreateMem0ResponseBody& setAccessDeniedDetail(CreateMem0ResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
  ...
  protected:
    shared_ptr<CreateMem0ResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The data structure.
