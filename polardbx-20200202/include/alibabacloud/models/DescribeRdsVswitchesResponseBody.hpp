...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRdsVswitchesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeRdsVswitchesResponseBodyData) };
    inline DescribeRdsVswitchesResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeRdsVswitchesResponseBodyData) };
    inline DescribeRdsVswitchesResponseBody& setData(const DescribeRdsVswitchesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeRdsVswitchesResponseBody& setData(DescribeRdsVswitchesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeRdsVswitchesResponseBodyData> data_ = nullptr;
    // Id of the request
