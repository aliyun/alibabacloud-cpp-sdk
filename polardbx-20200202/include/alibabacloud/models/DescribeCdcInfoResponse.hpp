...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdcInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdcInfoResponseBody) };
    inline DescribeCdcInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdcInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdcInfoResponseBody> body_ {};
  };
