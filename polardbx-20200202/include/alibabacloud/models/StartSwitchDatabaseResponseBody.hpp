...
namespace Models
{
  ...
  public:
    ...
    inline const StartSwitchDatabaseResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, StartSwitchDatabaseResponseBody::Data) };
    inline StartSwitchDatabaseResponseBody::Data getData() { DARABONBA_PTR_GET(data_, StartSwitchDatabaseResponseBody::Data) };
    inline StartSwitchDatabaseResponseBody& setData(const StartSwitchDatabaseResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StartSwitchDatabaseResponseBody& setData(StartSwitchDatabaseResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
