...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDBInstanceTDEResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDBInstanceTDEResponseBody) };
    inline UpdateDBInstanceTDEResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDBInstanceTDEResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDBInstanceTDEResponseBody> body_ {};
  };
