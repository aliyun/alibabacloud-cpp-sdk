...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMem0ResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DeleteMem0ResponseBody::AccessDeniedDetail) };
    inline DeleteMem0ResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DeleteMem0ResponseBody::AccessDeniedDetail) };
    inline DeleteMem0ResponseBody& setAccessDeniedDetail(const DeleteMem0ResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DeleteMem0ResponseBody& setAccessDeniedDetail(DeleteMem0ResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };
  ...
  protected:
    shared_ptr<DeleteMem0ResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The returned data.
