...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeColumnarClassListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeColumnarClassListResponseBodyData) };
    inline DescribeColumnarClassListResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeColumnarClassListResponseBodyData) };
    inline DescribeColumnarClassListResponseBody& setData(const DescribeColumnarClassListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeColumnarClassListResponseBody& setData(DescribeColumnarClassListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeColumnarClassListResponseBodyData> data_ = nullptr;
    // Id of the request
