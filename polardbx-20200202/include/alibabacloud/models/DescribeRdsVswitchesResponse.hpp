...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRdsVswitchesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeRdsVswitchesResponseBody) };
    inline DescribeRdsVswitchesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeRdsVswitchesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRdsVswitchesResponseBody> body_ = nullptr;
  };
