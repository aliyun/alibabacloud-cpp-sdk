...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSqlAuditInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSqlAuditInfoResponseBody) };
    inline DescribeSqlAuditInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSqlAuditInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSqlAuditInfoResponseBody> body_ {};
  };
