...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePolarxDataNodesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePolarxDataNodesResponseBody) };
    inline DescribePolarxDataNodesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePolarxDataNodesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePolarxDataNodesResponseBody> body_ {};
  };
