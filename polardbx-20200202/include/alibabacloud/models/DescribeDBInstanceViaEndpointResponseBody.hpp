...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceViaEndpointResponseBody::DBInstance & getDBInstance() const { DARABONBA_PTR_GET_CONST(DBInstance_, DescribeDBInstanceViaEndpointResponseBody::DBInstance) };
    inline DescribeDBInstanceViaEndpointResponseBody::DBInstance getDBInstance() { DARABONBA_PTR_GET(DBInstance_, DescribeDBInstanceViaEndpointResponseBody::DBInstance) };
    inline DescribeDBInstanceViaEndpointResponseBody& setDBInstance(const DescribeDBInstanceViaEndpointResponseBody::DBInstance & dBInstance) { DARABONBA_PTR_SET_VALUE(DBInstance_, dBInstance) };
    inline DescribeDBInstanceViaEndpointResponseBody& setDBInstance(DescribeDBInstanceViaEndpointResponseBody::DBInstance && dBInstance) { DARABONBA_PTR_SET_RVALUE(DBInstance_, dBInstance) };
