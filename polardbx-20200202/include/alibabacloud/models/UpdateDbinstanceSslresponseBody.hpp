...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDBInstanceSSLResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateDBInstanceSSLResponseBodyData) };
    inline UpdateDBInstanceSSLResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateDBInstanceSSLResponseBodyData) };
    inline UpdateDBInstanceSSLResponseBody& setData(const UpdateDBInstanceSSLResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateDBInstanceSSLResponseBody& setData(UpdateDBInstanceSSLResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<UpdateDBInstanceSSLResponseBodyData> data_ = nullptr;
