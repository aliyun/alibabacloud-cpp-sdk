...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOpenBackupSetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOpenBackupSetResponseBody) };
    inline DescribeOpenBackupSetResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOpenBackupSetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOpenBackupSetResponseBody> body_ {};
  };
