...
#ifndef ALIBABACLOUD_MODELS_RELEASECONTEXTDBPUBLICCONNECTIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_RELEASECONTEXTDBPUBLICCONNECTIONRESPONSEBODY_HPP_
...
namespace Models
{
  class ReleaseContextDBPublicConnectionResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ReleaseContextDBPublicConnectionResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ReleaseContextDBPublicConnectionResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ReleaseContextDBPublicConnectionResponseBody() = default ;
    ReleaseContextDBPublicConnectionResponseBody(const ReleaseContextDBPublicConnectionResponseBody &) = default ;
    ReleaseContextDBPublicConnectionResponseBody(ReleaseContextDBPublicConnectionResponseBody &&) = default ;
    ReleaseContextDBPublicConnectionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReleaseContextDBPublicConnectionResponseBody() = default ;
    ReleaseContextDBPublicConnectionResponseBody& operator=(const ReleaseContextDBPublicConnectionResponseBody &) = default ;
    ReleaseContextDBPublicConnectionResponseBody& operator=(ReleaseContextDBPublicConnectionResponseBody &&) = default ;
    ...
    inline const ReleaseContextDBPublicConnectionResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, ReleaseContextDBPublicConnectionResponseBody::AccessDeniedDetail) };
    inline ReleaseContextDBPublicConnectionResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, ReleaseContextDBPublicConnectionResponseBody::AccessDeniedDetail) };
    inline ReleaseContextDBPublicConnectionResponseBody& setAccessDeniedDetail(const ReleaseContextDBPublicConnectionResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline ReleaseContextDBPublicConnectionResponseBody& setAccessDeniedDetail(ReleaseContextDBPublicConnectionResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ReleaseContextDBPublicConnectionResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ReleaseContextDBPublicConnectionResponseBody::Data) };
    inline ReleaseContextDBPublicConnectionResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ReleaseContextDBPublicConnectionResponseBody::Data) };
    inline ReleaseContextDBPublicConnectionResponseBody& setData(const ReleaseContextDBPublicConnectionResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ReleaseContextDBPublicConnectionResponseBody& setData(ReleaseContextDBPublicConnectionResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ReleaseContextDBPublicConnectionResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<ReleaseContextDBPublicConnectionResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The operation result.
    shared_ptr<ReleaseContextDBPublicConnectionResponseBody::Data> data_ {};
    // Id of the request
