...
namespace Models
{
  ...
  public:
    ...
    inline const SkipCurrentStepResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SkipCurrentStepResponseBody) };
    inline SkipCurrentStepResponseBody getBody() { DARABONBA_PTR_GET(body_, SkipCurrentStepResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SkipCurrentStepResponseBody> body_ {};
  };
