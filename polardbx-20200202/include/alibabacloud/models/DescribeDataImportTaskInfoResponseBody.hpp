...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataImportTaskInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDataImportTaskInfoResponseBodyData) };
    inline DescribeDataImportTaskInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDataImportTaskInfoResponseBodyData) };
    inline DescribeDataImportTaskInfoResponseBody& setData(const DescribeDataImportTaskInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDataImportTaskInfoResponseBody& setData(DescribeDataImportTaskInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDataImportTaskInfoResponseBodyData> data_ = nullptr;
