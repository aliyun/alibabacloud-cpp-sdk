...
namespace Models
{
  ...
  public:
    ...
    inline const ReleaseColdDataVolumeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReleaseColdDataVolumeResponseBody) };
    inline ReleaseColdDataVolumeResponseBody getBody() { DARABONBA_PTR_GET(body_, ReleaseColdDataVolumeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReleaseColdDataVolumeResponseBody> body_ {};
  };
