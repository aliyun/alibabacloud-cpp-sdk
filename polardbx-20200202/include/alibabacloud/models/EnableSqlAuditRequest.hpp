...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->auditAccountName_ == nullptr
        && this->auditAccountPassword_ == nullptr && this->DBInstanceId_ == nullptr && this->expireAfterDays_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline int32_t getExpireAfterDays() const { DARABONBA_PTR_GET_DEFAULT(expireAfterDays_, 0) };
