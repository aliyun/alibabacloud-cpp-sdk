...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceSSLResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDBInstanceSSLResponseBodyData) };
    inline DescribeDBInstanceSSLResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDBInstanceSSLResponseBodyData) };
    inline DescribeDBInstanceSSLResponseBody& setData(const DescribeDBInstanceSSLResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDBInstanceSSLResponseBody& setData(DescribeDBInstanceSSLResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeDBInstanceSSLResponseBodyData> data_ = nullptr;
