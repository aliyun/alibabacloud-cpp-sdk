...
#ifndef ALIBABACLOUD_MODELS_RELEASECONTEXT0PUBLICCONNECTIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_RELEASECONTEXT0PUBLICCONNECTIONRESPONSEBODY_HPP_
...
namespace Models
{
  class ReleaseContext0PublicConnectionResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ReleaseContext0PublicConnectionResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ReleaseContext0PublicConnectionResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ReleaseContext0PublicConnectionResponseBody() = default ;
    ReleaseContext0PublicConnectionResponseBody(const ReleaseContext0PublicConnectionResponseBody &) = default ;
    ReleaseContext0PublicConnectionResponseBody(ReleaseContext0PublicConnectionResponseBody &&) = default ;
    ReleaseContext0PublicConnectionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ReleaseContext0PublicConnectionResponseBody() = default ;
    ReleaseContext0PublicConnectionResponseBody& operator=(const ReleaseContext0PublicConnectionResponseBody &) = default ;
    ReleaseContext0PublicConnectionResponseBody& operator=(ReleaseContext0PublicConnectionResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->context0InstanceName_ == nullptr
        && this->DBInstanceId_ == nullptr && this->DBInstanceName_ == nullptr && this->netType_ == nullptr && this->nodeType_ == nullptr && this->oldConnectionString_ == nullptr
        && this->oldPort_ == nullptr && this->taskId_ == nullptr; };
      ...
      inline Data& setOldConnectionString(string oldConnectionString) { DARABONBA_PTR_SET_VALUE(oldConnectionString_, oldConnectionString) };


      // oldPort Field Functions 
      bool hasOldPort() const { return this->oldPort_ != nullptr;};
      void deleteOldPort() { this->oldPort_ = nullptr;};
      inline string getOldPort() const { DARABONBA_PTR_GET_DEFAULT(oldPort_, "") };
      inline Data& setOldPort(string oldPort) { DARABONBA_PTR_SET_VALUE(oldPort_, oldPort) };
    ...
    inline const ReleaseContext0PublicConnectionResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, ReleaseContext0PublicConnectionResponseBody::AccessDeniedDetail) };
    inline ReleaseContext0PublicConnectionResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, ReleaseContext0PublicConnectionResponseBody::AccessDeniedDetail) };
    inline ReleaseContext0PublicConnectionResponseBody& setAccessDeniedDetail(const ReleaseContext0PublicConnectionResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline ReleaseContext0PublicConnectionResponseBody& setAccessDeniedDetail(ReleaseContext0PublicConnectionResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ReleaseContext0PublicConnectionResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ReleaseContext0PublicConnectionResponseBody::Data) };
    inline ReleaseContext0PublicConnectionResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ReleaseContext0PublicConnectionResponseBody::Data) };
    inline ReleaseContext0PublicConnectionResponseBody& setData(const ReleaseContext0PublicConnectionResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ReleaseContext0PublicConnectionResponseBody& setData(ReleaseContext0PublicConnectionResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ReleaseContext0PublicConnectionResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<ReleaseContext0PublicConnectionResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The task details.
    shared_ptr<ReleaseContext0PublicConnectionResponseBody::Data> data_ {};
    // Id of the request
