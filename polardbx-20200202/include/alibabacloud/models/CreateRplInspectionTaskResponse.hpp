...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRplInspectionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRplInspectionTaskResponseBody) };
    inline CreateRplInspectionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRplInspectionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRplInspectionTaskResponseBody> body_ {};
  };
