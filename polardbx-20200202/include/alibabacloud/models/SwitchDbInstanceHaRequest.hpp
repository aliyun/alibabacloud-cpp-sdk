...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceName_ == nullptr
        && return this->regionId_ == nullptr && return this->switchTime_ == nullptr && return this->switchTimeMode_ == nullptr && return this->targetPrimaryAzoneId_ == nullptr && return this->targetPrimaryRegionId_ == nullptr; };
    ...
    inline string targetPrimaryAzoneId() const { DARABONBA_PTR_GET_DEFAULT(targetPrimaryAzoneId_, "") };
    ...
    inline string targetPrimaryRegionId() const { DARABONBA_PTR_GET_DEFAULT(targetPrimaryRegionId_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> targetPrimaryAzoneId_ = nullptr;
    std::shared_ptr<string> targetPrimaryRegionId_ = nullptr;
  };
