...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceHAResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDBInstanceHAResponseBodyData) };
    inline DescribeDBInstanceHAResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDBInstanceHAResponseBodyData) };
    inline DescribeDBInstanceHAResponseBody& setData(const DescribeDBInstanceHAResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDBInstanceHAResponseBody& setData(DescribeDBInstanceHAResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeDBInstanceHAResponseBodyData> data_ = nullptr;
