...
#ifndef ALIBABACLOUD_MODELS_RESTARTOPENSEARCHRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_RESTARTOPENSEARCHRESPONSEBODY_HPP_
...
namespace Models
{
  class RestartOpenSearchResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const RestartOpenSearchResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, RestartOpenSearchResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    RestartOpenSearchResponseBody() = default ;
    RestartOpenSearchResponseBody(const RestartOpenSearchResponseBody &) = default ;
    RestartOpenSearchResponseBody(RestartOpenSearchResponseBody &&) = default ;
    RestartOpenSearchResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RestartOpenSearchResponseBody() = default ;
    RestartOpenSearchResponseBody& operator=(const RestartOpenSearchResponseBody &) = default ;
    RestartOpenSearchResponseBody& operator=(RestartOpenSearchResponseBody &&) = default ;
    ...
    inline const RestartOpenSearchResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, RestartOpenSearchResponseBody::AccessDeniedDetail) };
    inline RestartOpenSearchResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, RestartOpenSearchResponseBody::AccessDeniedDetail) };
    inline RestartOpenSearchResponseBody& setAccessDeniedDetail(const RestartOpenSearchResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline RestartOpenSearchResponseBody& setAccessDeniedDetail(RestartOpenSearchResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const RestartOpenSearchResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, RestartOpenSearchResponseBody::Data) };
    inline RestartOpenSearchResponseBody::Data getData() { DARABONBA_PTR_GET(data_, RestartOpenSearchResponseBody::Data) };
    inline RestartOpenSearchResponseBody& setData(const RestartOpenSearchResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RestartOpenSearchResponseBody& setData(RestartOpenSearchResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline RestartOpenSearchResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
