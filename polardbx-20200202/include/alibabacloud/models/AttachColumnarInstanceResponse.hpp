...
namespace Models
{
  ...
  public:
    ...
    inline const AttachColumnarInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachColumnarInstanceResponseBody) };
    inline AttachColumnarInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachColumnarInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachColumnarInstanceResponseBody> body_ {};
  };
