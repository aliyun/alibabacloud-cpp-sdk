...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEvaluateAndImportTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEvaluateAndImportTaskResponseBodyData) };
    inline DescribeEvaluateAndImportTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEvaluateAndImportTaskResponseBodyData) };
    inline DescribeEvaluateAndImportTaskResponseBody& setData(const DescribeEvaluateAndImportTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEvaluateAndImportTaskResponseBody& setData(DescribeEvaluateAndImportTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeEvaluateAndImportTaskResponseBodyData> data_ = nullptr;
