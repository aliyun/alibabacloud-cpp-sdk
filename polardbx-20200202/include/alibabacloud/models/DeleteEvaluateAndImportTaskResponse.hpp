...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEvaluateAndImportTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteEvaluateAndImportTaskResponseBody) };
    inline DeleteEvaluateAndImportTaskResponseBody body() { DARABONBA_PTR_GET(body_, DeleteEvaluateAndImportTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteEvaluateAndImportTaskResponseBody> body_ = nullptr;
  };
