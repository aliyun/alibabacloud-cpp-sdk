...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyEngineMigrationResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyEngineMigrationResponseBody::Data) };
    inline ModifyEngineMigrationResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyEngineMigrationResponseBody::Data) };
    inline ModifyEngineMigrationResponseBody& setData(const ModifyEngineMigrationResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyEngineMigrationResponseBody& setData(ModifyEngineMigrationResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
