...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeBackupSetListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeBackupSetListResponseBodyData>) };
    inline vector<DescribeBackupSetListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeBackupSetListResponseBodyData>) };
    inline DescribeBackupSetListResponseBody& setData(const vector<DescribeBackupSetListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeBackupSetListResponseBody& setData(vector<DescribeBackupSetListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<DescribeBackupSetListResponseBodyData>> data_ = nullptr;
