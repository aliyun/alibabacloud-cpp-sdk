...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDbListResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeDbListResponseBodyData>) };
    inline vector<DescribeDbListResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeDbListResponseBodyData>) };
    inline DescribeDbListResponseBody& setData(const vector<DescribeDbListResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDbListResponseBody& setData(vector<DescribeDbListResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<vector<DescribeDbListResponseBodyData>> data_ = nullptr;
