...
#ifndef ALIBABACLOUD_MODELS_DELETEOPENSEARCHRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DELETEOPENSEARCHRESPONSEBODY_HPP_
...
namespace Models
{
  class DeleteOpenSearchResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DeleteOpenSearchResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteOpenSearchResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DeleteOpenSearchResponseBody() = default ;
    DeleteOpenSearchResponseBody(const DeleteOpenSearchResponseBody &) = default ;
    DeleteOpenSearchResponseBody(DeleteOpenSearchResponseBody &&) = default ;
    DeleteOpenSearchResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteOpenSearchResponseBody() = default ;
    DeleteOpenSearchResponseBody& operator=(const DeleteOpenSearchResponseBody &) = default ;
    DeleteOpenSearchResponseBody& operator=(DeleteOpenSearchResponseBody &&) = default ;
    ...
    inline const DeleteOpenSearchResponseBody::AccessDeniedDetail & getAccessDeniedDetail() const { DARABONBA_PTR_GET_CONST(accessDeniedDetail_, DeleteOpenSearchResponseBody::AccessDeniedDetail) };
    inline DeleteOpenSearchResponseBody::AccessDeniedDetail getAccessDeniedDetail() { DARABONBA_PTR_GET(accessDeniedDetail_, DeleteOpenSearchResponseBody::AccessDeniedDetail) };
    inline DeleteOpenSearchResponseBody& setAccessDeniedDetail(const DeleteOpenSearchResponseBody::AccessDeniedDetail & accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    inline DeleteOpenSearchResponseBody& setAccessDeniedDetail(DeleteOpenSearchResponseBody::AccessDeniedDetail && accessDeniedDetail) { DARABONBA_PTR_SET_RVALUE(accessDeniedDetail_, accessDeniedDetail) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DeleteOpenSearchResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteOpenSearchResponseBody::Data) };
    inline DeleteOpenSearchResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteOpenSearchResponseBody::Data) };
    inline DeleteOpenSearchResponseBody& setData(const DeleteOpenSearchResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteOpenSearchResponseBody& setData(DeleteOpenSearchResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DeleteOpenSearchResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the access denial.
    shared_ptr<DeleteOpenSearchResponseBody::AccessDeniedDetail> accessDeniedDetail_ {};
    // The data list.
    shared_ptr<DeleteOpenSearchResponseBody::Data> data_ {};
    // Id of the request
