...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeColumnarVersionResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpgradeColumnarVersionResponseBody::Data) };
    inline UpgradeColumnarVersionResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpgradeColumnarVersionResponseBody::Data) };
    inline UpgradeColumnarVersionResponseBody& setData(const UpgradeColumnarVersionResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpgradeColumnarVersionResponseBody& setData(UpgradeColumnarVersionResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
