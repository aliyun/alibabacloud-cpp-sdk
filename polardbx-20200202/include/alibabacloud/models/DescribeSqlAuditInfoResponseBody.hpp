...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSqlAuditInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSqlAuditInfoResponseBodyData) };
    inline DescribeSqlAuditInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSqlAuditInfoResponseBodyData) };
    inline DescribeSqlAuditInfoResponseBody& setData(const DescribeSqlAuditInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSqlAuditInfoResponseBody& setData(DescribeSqlAuditInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeSqlAuditInfoResponseBodyData> data_ = nullptr;
