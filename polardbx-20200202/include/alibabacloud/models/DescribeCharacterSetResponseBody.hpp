...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCharacterSetResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCharacterSetResponseBodyData) };
    inline DescribeCharacterSetResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCharacterSetResponseBodyData) };
    inline DescribeCharacterSetResponseBody& setData(const DescribeCharacterSetResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCharacterSetResponseBody& setData(DescribeCharacterSetResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeCharacterSetResponseBodyData> data_ = nullptr;
