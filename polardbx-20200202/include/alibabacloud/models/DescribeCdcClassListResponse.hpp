...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdcClassListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCdcClassListResponseBody) };
    inline DescribeCdcClassListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCdcClassListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCdcClassListResponseBody> body_ {};
  };
