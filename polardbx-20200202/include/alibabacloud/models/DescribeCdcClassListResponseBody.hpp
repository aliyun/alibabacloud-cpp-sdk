...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCdcClassListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCdcClassListResponseBodyData) };
    inline DescribeCdcClassListResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCdcClassListResponseBodyData) };
    inline DescribeCdcClassListResponseBody& setData(const DescribeCdcClassListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCdcClassListResponseBody& setData(DescribeCdcClassListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeCdcClassListResponseBodyData> data_ = nullptr;
    // Id of the request
