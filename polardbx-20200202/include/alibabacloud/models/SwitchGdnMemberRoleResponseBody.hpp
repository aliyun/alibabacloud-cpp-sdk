...
namespace Models
{
  ...
  public:
    ...
    inline const SwitchGdnMemberRoleResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SwitchGdnMemberRoleResponseBody::Data) };
    inline SwitchGdnMemberRoleResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SwitchGdnMemberRoleResponseBody::Data) };
    inline SwitchGdnMemberRoleResponseBody& setData(const SwitchGdnMemberRoleResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SwitchGdnMemberRoleResponseBody& setData(SwitchGdnMemberRoleResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
