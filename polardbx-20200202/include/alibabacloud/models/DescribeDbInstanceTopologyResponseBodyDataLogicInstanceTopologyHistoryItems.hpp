...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activated_ == nullptr
        && return this->azone_ == nullptr && return this->characterType_ == nullptr && return this->DBInstanceId_ == nullptr && return this->DBInstanceName_ == nullptr && return this->phyInstanceName_ == nullptr
        && return this->region_ == nullptr && return this->role_ == nullptr; };
