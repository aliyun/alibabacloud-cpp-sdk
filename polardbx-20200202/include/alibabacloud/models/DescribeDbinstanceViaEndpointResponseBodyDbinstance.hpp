...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->cnNodeClassCode_ != nullptr
        && this->cnNodeCount_ != nullptr && this->commodityCode_ != nullptr && this->connAddrs_ != nullptr && this->connectionString_ != nullptr && this->createTime_ != nullptr
        ...
        && this->expireDate_ != nullptr && this->expired_ != nullptr && this->id_ != nullptr && this->kindCode_ != nullptr && this->LTSVersions_ != nullptr
        ...
        && this->network_ != nullptr && this->payType_ != nullptr && this->port_ != nullptr && this->readDBInstances_ != nullptr && this->regionId_ != nullptr
        && this->resourceGroupId_ != nullptr && this->rightsSeparationEnabled_ != nullptr && this->rightsSeparationStatus_ != nullptr && this->series_ != nullptr && this->status_ != nullptr
        && this->storageUsed_ != nullptr && this->tagSet_ != nullptr && this->type_ != nullptr && this->VPCId_ != nullptr && this->vSwitchId_ != nullptr
