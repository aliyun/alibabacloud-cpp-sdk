...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->connectionStringPrefix_ == nullptr
        && return this->DBInstanceName_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->port_ == nullptr && return this->regionId_ == nullptr
