...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeActiveOperationTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeActiveOperationTasksResponseBody) };
    inline DescribeActiveOperationTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeActiveOperationTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeActiveOperationTasksResponseBody> body_ {};
  };
