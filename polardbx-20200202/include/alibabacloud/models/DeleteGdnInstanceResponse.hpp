...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGdnInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteGdnInstanceResponseBody) };
    inline DeleteGdnInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteGdnInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteGdnInstanceResponseBody> body_ {};
  };
