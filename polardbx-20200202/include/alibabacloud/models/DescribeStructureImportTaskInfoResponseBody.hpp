...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeStructureImportTaskInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeStructureImportTaskInfoResponseBodyData) };
    inline DescribeStructureImportTaskInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeStructureImportTaskInfoResponseBodyData) };
    inline DescribeStructureImportTaskInfoResponseBody& setData(const DescribeStructureImportTaskInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeStructureImportTaskInfoResponseBody& setData(DescribeStructureImportTaskInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeStructureImportTaskInfoResponseBodyData> data_ = nullptr;
