...
class DescribeInstanceDbPerformanceRequest : public Darabonba::Model {
public:
  shared_ptr<string> regionId{};
  shared_ptr<string> dbInstanceName{};
  ...
  explicit DescribeInstanceDbPerformanceRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribeInstanceDbPerformanceRequest() = default;
};
class DescribeInstanceDbPerformanceResponseBodyDataPerformanceItemsPoints : public Darabonba::Model {
public:
  shared_ptr<string> value{};
  shared_ptr<long> timestamp{};

  DescribeInstanceDbPerformanceResponseBodyDataPerformanceItemsPoints() {}

  explicit DescribeInstanceDbPerformanceResponseBodyDataPerformanceItemsPoints(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribeInstanceDbPerformanceResponseBodyDataPerformanceItemsPoints() = default;
};
class DescribeInstanceDbPerformanceResponseBodyDataPerformanceItems : public Darabonba::Model {
public:
  shared_ptr<string> metricName{};
  shared_ptr<string> measurement{};
  shared_ptr<vector<DescribeInstanceDbPerformanceResponseBodyDataPerformanceItemsPoints>> points{};

  DescribeInstanceDbPerformanceResponseBodyDataPerformanceItems() {}

  explicit DescribeInstanceDbPerformanceResponseBodyDataPerformanceItems(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Points") != m.end() && !m["Points"].empty()) {
      if (typeid(vector<boost::any>) == m["Points"].type()) {
        vector<DescribeInstanceDbPerformanceResponseBodyDataPerformanceItemsPoints> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["Points"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            DescribeInstanceDbPerformanceResponseBodyDataPerformanceItemsPoints model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        points = make_shared<vector<DescribeInstanceDbPerformanceResponseBodyDataPerformanceItemsPoints>>(expect1);
      }
    }
  }


  virtual ~DescribeInstanceDbPerformanceResponseBodyDataPerformanceItems() = default;
};
class DescribeInstanceDbPerformanceResponseBodyData : public Darabonba::Model {
public:
  shared_ptr<vector<DescribeInstanceDbPerformanceResponseBodyDataPerformanceItems>> performanceItems{};

  DescribeInstanceDbPerformanceResponseBodyData() {}

  explicit DescribeInstanceDbPerformanceResponseBodyData(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (performanceItems) {
      vector<boost::any> temp1;
      for(auto item1:*performanceItems){
        temp1.push_back(boost::any(item1.toMap()));
      }
      res["PerformanceItems"] = boost::any(temp1);
    }
    return res;
  }

  void fromMap(map<string, boost::any> m) override {
    if (m.find("PerformanceItems") != m.end() && !m["PerformanceItems"].empty()) {
      if (typeid(vector<boost::any>) == m["PerformanceItems"].type()) {
        vector<DescribeInstanceDbPerformanceResponseBodyDataPerformanceItems> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["PerformanceItems"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            DescribeInstanceDbPerformanceResponseBodyDataPerformanceItems model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        performanceItems = make_shared<vector<DescribeInstanceDbPerformanceResponseBodyDataPerformanceItems>>(expect1);
      }
    }
  }


  virtual ~DescribeInstanceDbPerformanceResponseBodyData() = default;
};
class DescribeInstanceDbPerformanceResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> message{};
  shared_ptr<string> requestId{};
  shared_ptr<bool> success{};
  shared_ptr<DescribeInstanceDbPerformanceResponseBodyData> data{};

  DescribeInstanceDbPerformanceResponseBody() {}

  explicit DescribeInstanceDbPerformanceResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Data") != m.end() && !m["Data"].empty()) {
      if (typeid(map<string, boost::any>) == m["Data"].type()) {
        DescribeInstanceDbPerformanceResponseBodyData model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["Data"]));
        data = make_shared<DescribeInstanceDbPerformanceResponseBodyData>(model1);
      }
    }
  }


  virtual ~DescribeInstanceDbPerformanceResponseBody() = default;
};
class DescribeInstanceDbPerformanceResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<DescribeInstanceDbPerformanceResponseBody> body{};

  DescribeInstanceDbPerformanceResponse() {}

  explicit DescribeInstanceDbPerformanceResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        DescribeInstanceDbPerformanceResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<DescribeInstanceDbPerformanceResponseBody>(model1);
      }
    }
  }


  virtual ~DescribeInstanceDbPerformanceResponse() = default;
};
class DescribeInstancePerformanceRequest : public Darabonba::Model {
public:
  shared_ptr<string> dbInstanceName{};
  ...
  explicit DescribeInstancePerformanceRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribeInstancePerformanceRequest() = default;
};
class DescribeInstancePerformanceResponseBodyDataPerformanceItemsPoints : public Darabonba::Model {
public:
  shared_ptr<string> value{};
  shared_ptr<long> timestamp{};

  DescribeInstancePerformanceResponseBodyDataPerformanceItemsPoints() {}

  explicit DescribeInstancePerformanceResponseBodyDataPerformanceItemsPoints(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribeInstancePerformanceResponseBodyDataPerformanceItemsPoints() = default;
};
class DescribeInstancePerformanceResponseBodyDataPerformanceItems : public Darabonba::Model {
public:
  shared_ptr<string> metricName{};
  shared_ptr<string> measurement{};
  shared_ptr<vector<DescribeInstancePerformanceResponseBodyDataPerformanceItemsPoints>> points{};

  DescribeInstancePerformanceResponseBodyDataPerformanceItems() {}

  explicit DescribeInstancePerformanceResponseBodyDataPerformanceItems(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Points") != m.end() && !m["Points"].empty()) {
      if (typeid(vector<boost::any>) == m["Points"].type()) {
        vector<DescribeInstancePerformanceResponseBodyDataPerformanceItemsPoints> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["Points"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            DescribeInstancePerformanceResponseBodyDataPerformanceItemsPoints model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        points = make_shared<vector<DescribeInstancePerformanceResponseBodyDataPerformanceItemsPoints>>(expect1);
      }
    }
  }


  virtual ~DescribeInstancePerformanceResponseBodyDataPerformanceItems() = default;
};
class DescribeInstancePerformanceResponseBodyData : public Darabonba::Model {
public:
  shared_ptr<vector<DescribeInstancePerformanceResponseBodyDataPerformanceItems>> performanceItems{};

  DescribeInstancePerformanceResponseBodyData() {}

  explicit DescribeInstancePerformanceResponseBodyData(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("PerformanceItems") != m.end() && !m["PerformanceItems"].empty()) {
      if (typeid(vector<boost::any>) == m["PerformanceItems"].type()) {
        vector<DescribeInstancePerformanceResponseBodyDataPerformanceItems> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["PerformanceItems"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            DescribeInstancePerformanceResponseBodyDataPerformanceItems model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        performanceItems = make_shared<vector<DescribeInstancePerformanceResponseBodyDataPerformanceItems>>(expect1);
      }
    }
  }


  virtual ~DescribeInstancePerformanceResponseBodyData() = default;
};
class DescribeInstancePerformanceResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> message{};
  shared_ptr<string> requestId{};
  shared_ptr<bool> success{};
  shared_ptr<DescribeInstancePerformanceResponseBodyData> data{};

  DescribeInstancePerformanceResponseBody() {}

  explicit DescribeInstancePerformanceResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Data") != m.end() && !m["Data"].empty()) {
      if (typeid(map<string, boost::any>) == m["Data"].type()) {
        DescribeInstancePerformanceResponseBodyData model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["Data"]));
        data = make_shared<DescribeInstancePerformanceResponseBodyData>(model1);
      }
    }
  }


  virtual ~DescribeInstancePerformanceResponseBody() = default;
};
class DescribeInstancePerformanceResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<DescribeInstancePerformanceResponseBody> body{};

  DescribeInstancePerformanceResponse() {}

  explicit DescribeInstancePerformanceResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        DescribeInstancePerformanceResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<DescribeInstancePerformanceResponseBody>(model1);
      }
    }
  }


  virtual ~DescribeInstancePerformanceResponse() = default;
};
class DescribeInstanceStoragePerformanceRequest : public Darabonba::Model {
public:
  shared_ptr<string> regionId{};
  shared_ptr<string> dbInstanceName{};
  ...
  explicit DescribeInstanceStoragePerformanceRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribeInstanceStoragePerformanceRequest() = default;
};
class DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItemsPoints : public Darabonba::Model {
public:
  shared_ptr<string> value{};
  shared_ptr<long> timestamp{};

  DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItemsPoints() {}

  explicit DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItemsPoints(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItemsPoints() = default;
};
class DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItems : public Darabonba::Model {
public:
  shared_ptr<string> metricName{};
  shared_ptr<string> measurement{};
  shared_ptr<vector<DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItemsPoints>> points{};

  DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItems() {}

  explicit DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItems(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Points") != m.end() && !m["Points"].empty()) {
      if (typeid(vector<boost::any>) == m["Points"].type()) {
        vector<DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItemsPoints> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["Points"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItemsPoints model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        points = make_shared<vector<DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItemsPoints>>(expect1);
      }
    }
  }


  virtual ~DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItems() = default;
};
class DescribeInstanceStoragePerformanceResponseBodyData : public Darabonba::Model {
public:
  shared_ptr<vector<DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItems>> performanceItems{};

  DescribeInstanceStoragePerformanceResponseBodyData() {}

  explicit DescribeInstanceStoragePerformanceResponseBodyData(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("PerformanceItems") != m.end() && !m["PerformanceItems"].empty()) {
      if (typeid(vector<boost::any>) == m["PerformanceItems"].type()) {
        vector<DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItems> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["PerformanceItems"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItems model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        performanceItems = make_shared<vector<DescribeInstanceStoragePerformanceResponseBodyDataPerformanceItems>>(expect1);
      }
    }
  }


  virtual ~DescribeInstanceStoragePerformanceResponseBodyData() = default;
};
class DescribeInstanceStoragePerformanceResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> message{};
  shared_ptr<string> requestId{};
  shared_ptr<bool> success{};
  shared_ptr<DescribeInstanceStoragePerformanceResponseBodyData> data{};

  DescribeInstanceStoragePerformanceResponseBody() {}

  explicit DescribeInstanceStoragePerformanceResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Data") != m.end() && !m["Data"].empty()) {
      if (typeid(map<string, boost::any>) == m["Data"].type()) {
        DescribeInstanceStoragePerformanceResponseBodyData model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["Data"]));
        data = make_shared<DescribeInstanceStoragePerformanceResponseBodyData>(model1);
      }
    }
  }


  virtual ~DescribeInstanceStoragePerformanceResponseBody() = default;
};
class DescribeInstanceStoragePerformanceResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<DescribeInstanceStoragePerformanceResponseBody> body{};

  DescribeInstanceStoragePerformanceResponse() {}

  explicit DescribeInstanceStoragePerformanceResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        DescribeInstanceStoragePerformanceResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<DescribeInstanceStoragePerformanceResponseBody>(model1);
      }
    }
  }


  virtual ~DescribeInstanceStoragePerformanceResponse() = default;
};
...
public:
  ...
  explicit DescribeSqlAuditInfoRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit DescribeSqlAuditInfoResponseBodyData(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<string> requestId{};
  shared_ptr<DescribeSqlAuditInfoResponseBodyData> data{};

  DescribeSqlAuditInfoResponseBody() {}

  explicit DescribeSqlAuditInfoResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Data") != m.end() && !m["Data"].empty()) {
      if (typeid(map<string, boost::any>) == m["Data"].type()) {
        DescribeSqlAuditInfoResponseBodyData model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["Data"]));
        data = make_shared<DescribeSqlAuditInfoResponseBodyData>(model1);
      }
    }
  }
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<DescribeSqlAuditInfoResponseBody> body{};

  DescribeSqlAuditInfoResponse() {}

  explicit DescribeSqlAuditInfoResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        DescribeSqlAuditInfoResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<DescribeSqlAuditInfoResponseBody>(model1);
      }
    }
  }
...
class GetPolarXPriceRequest : public Darabonba::Model {
public:
  shared_ptr<string> regionId{};
  shared_ptr<string> DBInstanceName{};
  shared_ptr<string> nodeCount{};
  ...
  explicit GetPolarXPriceRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~GetPolarXPriceRequest() = default;
};
class GetPolarXPriceResponseBodyOrderPriceListRules : public Darabonba::Model {
public:
  shared_ptr<long> ruleDescId{};
  shared_ptr<string> title{};
  shared_ptr<string> name{};

  GetPolarXPriceResponseBodyOrderPriceListRules() {}

  explicit GetPolarXPriceResponseBodyOrderPriceListRules(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~GetPolarXPriceResponseBodyOrderPriceListRules() = default;
};
class GetPolarXPriceResponseBodyOrderPriceList : public Darabonba::Model {
public:
  shared_ptr<string> DBInstanceName{};
  ...
  shared_ptr<string> payType{};
  shared_ptr<string> totalCostAmount{};
  shared_ptr<vector<GetPolarXPriceResponseBodyOrderPriceListRules>> rules{};

  GetPolarXPriceResponseBodyOrderPriceList() {}

  explicit GetPolarXPriceResponseBodyOrderPriceList(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (totalCostAmount) {
      res["TotalCostAmount"] = boost::any(*totalCostAmount);
    }
    if (rules) {
      vector<boost::any> temp1;
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("TotalCostAmount") != m.end() && !m["TotalCostAmount"].empty()) {
      totalCostAmount = make_shared<string>(boost::any_cast<string>(m["TotalCostAmount"]));
    }
    if (m.find("Rules") != m.end() && !m["Rules"].empty()) {
      if (typeid(vector<boost::any>) == m["Rules"].type()) {
        vector<GetPolarXPriceResponseBodyOrderPriceListRules> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["Rules"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            GetPolarXPriceResponseBodyOrderPriceListRules model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        rules = make_shared<vector<GetPolarXPriceResponseBodyOrderPriceListRules>>(expect1);
      }
    }
  }


  virtual ~GetPolarXPriceResponseBodyOrderPriceList() = default;
};
class GetPolarXPriceResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> requestId{};
  shared_ptr<vector<GetPolarXPriceResponseBodyOrderPriceList>> orderPriceList{};

  GetPolarXPriceResponseBody() {}

  explicit GetPolarXPriceResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (orderPriceList) {
      vector<boost::any> temp1;
      for(auto item1:*orderPriceList){
        temp1.push_back(boost::any(item1.toMap()));
      }
      res["OrderPriceList"] = boost::any(temp1);
    }
    return res;
  }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("OrderPriceList") != m.end() && !m["OrderPriceList"].empty()) {
      if (typeid(vector<boost::any>) == m["OrderPriceList"].type()) {
        vector<GetPolarXPriceResponseBodyOrderPriceList> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["OrderPriceList"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            GetPolarXPriceResponseBodyOrderPriceList model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        orderPriceList = make_shared<vector<GetPolarXPriceResponseBodyOrderPriceList>>(expect1);
      }
    }
  }


  virtual ~GetPolarXPriceResponseBody() = default;
};
class GetPolarXPriceResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<GetPolarXPriceResponseBody> body{};

  GetPolarXPriceResponse() {}

  explicit GetPolarXPriceResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        GetPolarXPriceResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<GetPolarXPriceResponseBody>(model1);
      }
    }
  }


  virtual ~GetPolarXPriceResponse() = default;
};
...
class RetryPolarxOrderRequest : public Darabonba::Model {
public:
  shared_ptr<string> regionId{};
  shared_ptr<string> DBInstanceName{};
  shared_ptr<string> scaleOutToken{};
  ...
  explicit RetryPolarxOrderRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~RetryPolarxOrderRequest() = default;
};
class RetryPolarxOrderResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> requestId{};

  RetryPolarxOrderResponseBody() {}

  explicit RetryPolarxOrderResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~RetryPolarxOrderResponseBody() = default;
};
class RetryPolarxOrderResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<RetryPolarxOrderResponseBody> body{};

  RetryPolarxOrderResponse() {}

  explicit RetryPolarxOrderResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        RetryPolarxOrderResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<RetryPolarxOrderResponseBody>(model1);
      }
    }
  }


  virtual ~RetryPolarxOrderResponse() = default;
};
...
public:
  ...
  DescribeInstanceDbPerformanceResponse describeInstanceDbPerformanceWithOptions(shared_ptr<DescribeInstanceDbPerformanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  DescribeInstanceDbPerformanceResponse describeInstanceDbPerformance(shared_ptr<DescribeInstanceDbPerformanceRequest> request);
  DescribeInstancePerformanceResponse describeInstancePerformanceWithOptions(shared_ptr<DescribeInstancePerformanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  DescribeInstancePerformanceResponse describeInstancePerformance(shared_ptr<DescribeInstancePerformanceRequest> request);
  DescribeInstanceStoragePerformanceResponse describeInstanceStoragePerformanceWithOptions(shared_ptr<DescribeInstanceStoragePerformanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  DescribeInstanceStoragePerformanceResponse describeInstanceStoragePerformance(shared_ptr<DescribeInstanceStoragePerformanceRequest> request);
  ...
  DescribeSqlAuditInfoResponse describeSqlAuditInfoWithOptions(shared_ptr<DescribeSqlAuditInfoRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  DescribeSqlAuditInfoResponse describeSqlAuditInfo(shared_ptr<DescribeSqlAuditInfoRequest> request);
  ...
  GetPolarXPriceResponse getPolarXPriceWithOptions(shared_ptr<GetPolarXPriceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  GetPolarXPriceResponse getPolarXPrice(shared_ptr<GetPolarXPriceRequest> request);
  ...
  RetryPolarxOrderResponse retryPolarxOrderWithOptions(shared_ptr<RetryPolarxOrderRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  RetryPolarxOrderResponse retryPolarxOrder(shared_ptr<RetryPolarxOrderRequest> request);
