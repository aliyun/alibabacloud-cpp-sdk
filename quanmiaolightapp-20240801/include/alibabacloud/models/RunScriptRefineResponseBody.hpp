  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline Output& setContent(const vector<map<string, string>> & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
        inline Output& setContent(vector<map<string, string>> && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
        ...
        inline Output& setOutline(string outline) { DARABONBA_PTR_SET_VALUE(outline_, outline) };
        ...
        inline Output& setRole(string role) { DARABONBA_PTR_SET_VALUE(role_, role) };
        ...
        inline Output& setScene(string scene) { DARABONBA_PTR_SET_VALUE(scene_, scene) };
    ...
    inline const RunScriptRefineResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunScriptRefineResponseBody::Header) };
    inline RunScriptRefineResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunScriptRefineResponseBody::Header) };
    inline RunScriptRefineResponseBody& setHeader(const RunScriptRefineResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunScriptRefineResponseBody& setHeader(RunScriptRefineResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunScriptRefineResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunScriptRefineResponseBody::Payload) };
    inline RunScriptRefineResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunScriptRefineResponseBody::Payload) };
    inline RunScriptRefineResponseBody& setPayload(const RunScriptRefineResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunScriptRefineResponseBody& setPayload(RunScriptRefineResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };


  protected:
    shared_ptr<bool> end_ {};
    shared_ptr<RunScriptRefineResponseBody::Header> header_ {};
    shared_ptr<RunScriptRefineResponseBody::Payload> payload_ {};
  };
