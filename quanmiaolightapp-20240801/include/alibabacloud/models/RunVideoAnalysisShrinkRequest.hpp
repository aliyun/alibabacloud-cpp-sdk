...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addDocumentParamShrink_ == nullptr
        && this->autoRoleRecognitionVideoUrl_ == nullptr && this->excludeGenerateOptionsShrink_ == nullptr && this->faceIdentitySimilarityMinScore_ == nullptr && this->frameSampleMethodShrink_ == nullptr && this->generateOptionsShrink_ == nullptr
        ...
        && this->snapshotInterval_ == nullptr && this->splitInterval_ == nullptr && this->splitType_ == nullptr && this->taskId_ == nullptr && this->textProcessTasksShrink_ == nullptr
        && this->videoCaptionInfoShrink_ == nullptr && this->videoExtraInfo_ == nullptr && this->videoModelCustomPromptTemplate_ == nullptr && this->videoModelId_ == nullptr && this->videoRolesShrink_ == nullptr
        && this->videoShotFaceIdentityCount_ == nullptr && this->videoUrl_ == nullptr && this->videoUrlsShrink_ == nullptr; };
    ...
    inline RunVideoAnalysisShrinkRequest& setAddDocumentParamShrink(string addDocumentParamShrink) { DARABONBA_PTR_SET_VALUE(addDocumentParamShrink_, addDocumentParamShrink) };
    ...
    inline RunVideoAnalysisShrinkRequest& setSplitType(string splitType) { DARABONBA_PTR_SET_VALUE(splitType_, splitType) };
    ...
    inline RunVideoAnalysisShrinkRequest& setVideoUrlsShrink(string videoUrlsShrink) { DARABONBA_PTR_SET_VALUE(videoUrlsShrink_, videoUrlsShrink) };
