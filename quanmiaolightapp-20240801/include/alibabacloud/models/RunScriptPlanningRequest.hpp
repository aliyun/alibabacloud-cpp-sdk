...
namespace Models
{
  ...
  public:
    ...
    inline string getAdditionalNote() const { DARABONBA_PTR_GET_DEFAULT(additionalNote_, "") };
    ...
    inline bool getDialogueInScene() const { DARABONBA_PTR_GET_DEFAULT(dialogueInScene_, false) };
    ...
    inline bool getPlotConflict() const { DARABONBA_PTR_GET_DEFAULT(plotConflict_, false) };
    ...
    inline int32_t getScriptShotCount() const { DARABONBA_PTR_GET_DEFAULT(scriptShotCount_, 0) };
  ...
  protected:
    shared_ptr<string> additionalNote_ {};
    shared_ptr<bool> dialogueInScene_ {};
    shared_ptr<bool> plotConflict_ {};
    shared_ptr<string> scriptName_ {};
    shared_ptr<int32_t> scriptShotCount_ {};
