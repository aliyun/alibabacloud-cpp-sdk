...
#ifndef ALIBABACLOUD_MODELS_RUNOCRPARSERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_RUNOCRPARSERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RunOcrParseResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(header, header_);
      DARABONBA_PTR_TO_JSON(payload, payload_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, RunOcrParseResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(header, header_);
      DARABONBA_PTR_FROM_JSON(payload, payload_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    RunOcrParseResponseBody() = default ;
    RunOcrParseResponseBody(const RunOcrParseResponseBody &) = default ;
    RunOcrParseResponseBody(RunOcrParseResponseBody &&) = default ;
    RunOcrParseResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RunOcrParseResponseBody() = default ;
    RunOcrParseResponseBody& operator=(const RunOcrParseResponseBody &) = default ;
    RunOcrParseResponseBody& operator=(RunOcrParseResponseBody &&) = default ;
    ...
    inline const RunOcrParseResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunOcrParseResponseBody::Header) };
    inline RunOcrParseResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunOcrParseResponseBody::Header) };
    inline RunOcrParseResponseBody& setHeader(const RunOcrParseResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunOcrParseResponseBody& setHeader(RunOcrParseResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunOcrParseResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunOcrParseResponseBody::Payload) };
    inline RunOcrParseResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunOcrParseResponseBody::Payload) };
    inline RunOcrParseResponseBody& setPayload(const RunOcrParseResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunOcrParseResponseBody& setPayload(RunOcrParseResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
    ...
    inline RunOcrParseResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<RunOcrParseResponseBody::Header> header_ {};
    shared_ptr<RunOcrParseResponseBody::Payload> payload_ {};
    // Id of the request
