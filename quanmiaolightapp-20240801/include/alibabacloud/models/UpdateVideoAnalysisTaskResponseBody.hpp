...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateVideoAnalysisTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateVideoAnalysisTaskResponseBodyData) };
    inline UpdateVideoAnalysisTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateVideoAnalysisTaskResponseBodyData) };
    inline UpdateVideoAnalysisTaskResponseBody& setData(const UpdateVideoAnalysisTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateVideoAnalysisTaskResponseBody& setData(UpdateVideoAnalysisTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateVideoAnalysisTaskResponseBodyData> data_ = nullptr;
