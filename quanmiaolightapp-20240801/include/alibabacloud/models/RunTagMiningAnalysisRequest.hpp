...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RunTagMiningAnalysisRequestTags> & tags() const { DARABONBA_PTR_GET_CONST(tags_, vector<RunTagMiningAnalysisRequestTags>) };
    inline vector<RunTagMiningAnalysisRequestTags> tags() { DARABONBA_PTR_GET(tags_, vector<RunTagMiningAnalysisRequestTags>) };
    inline RunTagMiningAnalysisRequest& setTags(const vector<RunTagMiningAnalysisRequestTags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline RunTagMiningAnalysisRequest& setTags(vector<RunTagMiningAnalysisRequestTags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    std::shared_ptr<vector<RunTagMiningAnalysisRequestTags>> tags_ = nullptr;
