...
namespace Models
{
  ...
  public:
    ...
    inline const RunNetworkContentAuditResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunNetworkContentAuditResponseBody::Header) };
    inline RunNetworkContentAuditResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunNetworkContentAuditResponseBody::Header) };
    inline RunNetworkContentAuditResponseBody& setHeader(const RunNetworkContentAuditResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunNetworkContentAuditResponseBody& setHeader(RunNetworkContentAuditResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunNetworkContentAuditResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunNetworkContentAuditResponseBody::Payload) };
    inline RunNetworkContentAuditResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunNetworkContentAuditResponseBody::Payload) };
    inline RunNetworkContentAuditResponseBody& setPayload(const RunNetworkContentAuditResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunNetworkContentAuditResponseBody& setPayload(RunNetworkContentAuditResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    shared_ptr<RunNetworkContentAuditResponseBody::Header> header_ {};
    shared_ptr<RunNetworkContentAuditResponseBody::Payload> payload_ {};
    // Id of the request
