...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->learningSamples_ == nullptr
        && this->processStage_ == nullptr && this->referenceMaterials_ == nullptr && this->styleFeature_ == nullptr && this->useSearch_ == nullptr && this->writingTheme_ == nullptr; };
    ...
    inline const vector<string> & getLearningSamples() const { DARABONBA_PTR_GET_CONST(learningSamples_, vector<string>) };
    inline vector<string> getLearningSamples() { DARABONBA_PTR_GET(learningSamples_, vector<string>) };
    ...
    inline string getProcessStage() const { DARABONBA_PTR_GET_DEFAULT(processStage_, "") };
    ...
    inline const vector<string> & getReferenceMaterials() const { DARABONBA_PTR_GET_CONST(referenceMaterials_, vector<string>) };
    inline vector<string> getReferenceMaterials() { DARABONBA_PTR_GET(referenceMaterials_, vector<string>) };
    ...
    inline string getStyleFeature() const { DARABONBA_PTR_GET_DEFAULT(styleFeature_, "") };
    ...
    inline string getWritingTheme() const { DARABONBA_PTR_GET_DEFAULT(writingTheme_, "") };
    inline RunStyleWritingRequest& setWritingTheme(string writingTheme) { DARABONBA_PTR_SET_VALUE(writingTheme_, writingTheme) };


  protected:
    shared_ptr<vector<string>> learningSamples_ {};
    shared_ptr<string> processStage_ {};
    shared_ptr<vector<string>> referenceMaterials_ {};
    shared_ptr<string> styleFeature_ {};
    shared_ptr<bool> useSearch_ {};
    shared_ptr<string> writingTheme_ {};
  };
