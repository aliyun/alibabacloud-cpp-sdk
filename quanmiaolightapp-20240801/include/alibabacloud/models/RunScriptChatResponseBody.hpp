...
namespace Models
{
  ...
  public:
    ...
    inline const RunScriptChatResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunScriptChatResponseBody::Header) };
    inline RunScriptChatResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunScriptChatResponseBody::Header) };
    inline RunScriptChatResponseBody& setHeader(const RunScriptChatResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunScriptChatResponseBody& setHeader(RunScriptChatResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunScriptChatResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunScriptChatResponseBody::Payload) };
    inline RunScriptChatResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunScriptChatResponseBody::Payload) };
    inline RunScriptChatResponseBody& setPayload(const RunScriptChatResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunScriptChatResponseBody& setPayload(RunScriptChatResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };


  protected:
    shared_ptr<bool> end_ {};
    shared_ptr<RunScriptChatResponseBody::Header> header_ {};
    shared_ptr<RunScriptChatResponseBody::Payload> payload_ {};
  };
