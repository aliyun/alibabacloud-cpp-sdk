...
namespace Models
{
  ...
  public:
    ...
    inline const GetVideoDetectShotConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetVideoDetectShotConfigResponseBodyData) };
    inline GetVideoDetectShotConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetVideoDetectShotConfigResponseBodyData) };
    inline GetVideoDetectShotConfigResponseBody& setData(const GetVideoDetectShotConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetVideoDetectShotConfigResponseBody& setData(GetVideoDetectShotConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetVideoDetectShotConfigResponseBodyData> data_ = nullptr;
