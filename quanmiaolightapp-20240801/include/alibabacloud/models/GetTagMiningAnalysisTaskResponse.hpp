...
namespace Models
{
  ...
  public:
    ...
    inline const GetTagMiningAnalysisTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTagMiningAnalysisTaskResponseBody) };
    inline GetTagMiningAnalysisTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTagMiningAnalysisTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTagMiningAnalysisTaskResponseBody> body_ {};
  };
