...
namespace Models
{
  ...
  public:
    ...
    inline const GetEssayCorrectionTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetEssayCorrectionTaskResponseBodyData) };
    inline GetEssayCorrectionTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetEssayCorrectionTaskResponseBodyData) };
    inline GetEssayCorrectionTaskResponseBody& setData(const GetEssayCorrectionTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetEssayCorrectionTaskResponseBody& setData(GetEssayCorrectionTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetEssayCorrectionTaskResponseBodyData> data_ = nullptr;
