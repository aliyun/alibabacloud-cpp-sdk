...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->grade_ == nullptr
        && return this->modelId_ == nullptr && return this->otherReviewPoints_ == nullptr && return this->question_ == nullptr && return this->subject_ == nullptr && return this->tasksShrink_ == nullptr
