...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->taskErrorCode_ == nullptr
      ...
      inline Data& setTaskErrorCode(string taskErrorCode) { DARABONBA_PTR_SET_VALUE(taskErrorCode_, taskErrorCode) };
    ...
    inline const vector<UpdateVideoAnalysisTasksResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<UpdateVideoAnalysisTasksResponseBody::Data>) };
    inline vector<UpdateVideoAnalysisTasksResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<UpdateVideoAnalysisTasksResponseBody::Data>) };
    inline UpdateVideoAnalysisTasksResponseBody& setData(const vector<UpdateVideoAnalysisTasksResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateVideoAnalysisTasksResponseBody& setData(vector<UpdateVideoAnalysisTasksResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateVideoAnalysisTasksResponseBody::Data>> data_ {};
