...
namespace Models
{
  ...
  public:
    ...
    inline const RunStyleWritingResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunStyleWritingResponseBody::Header) };
    inline RunStyleWritingResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunStyleWritingResponseBody::Header) };
    inline RunStyleWritingResponseBody& setHeader(const RunStyleWritingResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunStyleWritingResponseBody& setHeader(RunStyleWritingResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunStyleWritingResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunStyleWritingResponseBody::Payload) };
    inline RunStyleWritingResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunStyleWritingResponseBody::Payload) };
    inline RunStyleWritingResponseBody& setPayload(const RunStyleWritingResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunStyleWritingResponseBody& setPayload(RunStyleWritingResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };


  protected:
    shared_ptr<bool> end_ {};
    shared_ptr<RunStyleWritingResponseBody::Header> header_ {};
    shared_ptr<RunStyleWritingResponseBody::Payload> payload_ {};
  };
