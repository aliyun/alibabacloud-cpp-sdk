...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateVideoAnalysisTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateVideoAnalysisTasksResponseBody) };
    inline UpdateVideoAnalysisTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateVideoAnalysisTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateVideoAnalysisTasksResponseBody> body_ {};
  };
