...
namespace Models
{
  ...
  public:
    ...
    inline const RunVideoDetectShotResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunVideoDetectShotResponseBody::Header) };
    inline RunVideoDetectShotResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunVideoDetectShotResponseBody::Header) };
    inline RunVideoDetectShotResponseBody& setHeader(const RunVideoDetectShotResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunVideoDetectShotResponseBody& setHeader(RunVideoDetectShotResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunVideoDetectShotResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunVideoDetectShotResponseBody::Payload) };
    inline RunVideoDetectShotResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunVideoDetectShotResponseBody::Payload) };
    inline RunVideoDetectShotResponseBody& setPayload(const RunVideoDetectShotResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunVideoDetectShotResponseBody& setPayload(RunVideoDetectShotResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    shared_ptr<RunVideoDetectShotResponseBody::Header> header_ {};
    shared_ptr<RunVideoDetectShotResponseBody::Payload> payload_ {};
    // Id of the request
