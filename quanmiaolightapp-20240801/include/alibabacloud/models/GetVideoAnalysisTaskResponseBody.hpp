...
namespace Models
{
  ...
  public:
    ...
    inline const GetVideoAnalysisTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetVideoAnalysisTaskResponseBodyData) };
    inline GetVideoAnalysisTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetVideoAnalysisTaskResponseBodyData) };
    inline GetVideoAnalysisTaskResponseBody& setData(const GetVideoAnalysisTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetVideoAnalysisTaskResponseBody& setData(GetVideoAnalysisTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetVideoAnalysisTaskResponseBodyData> data_ = nullptr;
