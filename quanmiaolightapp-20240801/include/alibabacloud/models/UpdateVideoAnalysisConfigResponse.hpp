...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateVideoAnalysisConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateVideoAnalysisConfigResponseBody) };
    inline UpdateVideoAnalysisConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateVideoAnalysisConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateVideoAnalysisConfigResponseBody> body_ {};
  };
