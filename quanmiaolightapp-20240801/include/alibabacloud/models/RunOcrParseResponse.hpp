...
namespace Models
{
  ...
  public:
    ...
    inline RunOcrParseResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunOcrParseResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunOcrParseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunOcrParseResponseBody) };
    inline RunOcrParseResponseBody getBody() { DARABONBA_PTR_GET(body_, RunOcrParseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunOcrParseResponseBody> body_ {};
  };
