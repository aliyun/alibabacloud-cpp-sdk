...
namespace Models
{
  ...
  public:
    ...
    inline RunScriptRefineResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunScriptRefineResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunScriptRefineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunScriptRefineResponseBody) };
    inline RunScriptRefineResponseBody getBody() { DARABONBA_PTR_GET(body_, RunScriptRefineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunScriptRefineResponseBody> body_ {};
  };
