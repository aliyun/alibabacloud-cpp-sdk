...
namespace Models
{
  ...
  public:
    ...
    inline const HotNewsRecommendResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HotNewsRecommendResponseBody) };
    inline HotNewsRecommendResponseBody getBody() { DARABONBA_PTR_GET(body_, HotNewsRecommendResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HotNewsRecommendResponseBody> body_ {};
  };
