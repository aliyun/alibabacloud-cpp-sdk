...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateVideoDetectShotConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateVideoDetectShotConfigResponseBody) };
    inline UpdateVideoDetectShotConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateVideoDetectShotConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateVideoDetectShotConfigResponseBody> body_ {};
  };
