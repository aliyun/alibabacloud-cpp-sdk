...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->learningSamplesShrink_ == nullptr
        && this->processStage_ == nullptr && this->referenceMaterialsShrink_ == nullptr && this->styleFeature_ == nullptr && this->useSearch_ == nullptr && this->writingTheme_ == nullptr; };
    ...
    inline string getLearningSamplesShrink() const { DARABONBA_PTR_GET_DEFAULT(learningSamplesShrink_, "") };
    ...
    inline string getReferenceMaterialsShrink() const { DARABONBA_PTR_GET_DEFAULT(referenceMaterialsShrink_, "") };
  ...
  protected:
    shared_ptr<string> learningSamplesShrink_ {};
    shared_ptr<string> processStage_ {};
    shared_ptr<string> referenceMaterialsShrink_ {};
