...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateVideoAnalysisTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateVideoAnalysisTaskResponseBody) };
    inline UpdateVideoAnalysisTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateVideoAnalysisTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateVideoAnalysisTaskResponseBody> body_ {};
  };
