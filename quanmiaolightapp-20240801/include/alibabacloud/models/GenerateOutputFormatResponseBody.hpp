...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateOutputFormatResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GenerateOutputFormatResponseBodyData) };
    inline GenerateOutputFormatResponseBodyData data() { DARABONBA_PTR_GET(data_, GenerateOutputFormatResponseBodyData) };
    inline GenerateOutputFormatResponseBody& setData(const GenerateOutputFormatResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GenerateOutputFormatResponseBody& setData(GenerateOutputFormatResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GenerateOutputFormatResponseBodyData> data_ = nullptr;
