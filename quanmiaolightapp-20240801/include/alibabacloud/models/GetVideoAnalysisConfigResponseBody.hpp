...
namespace Models
{
  ...
  public:
    ...
    inline const GetVideoAnalysisConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetVideoAnalysisConfigResponseBodyData) };
    inline GetVideoAnalysisConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, GetVideoAnalysisConfigResponseBodyData) };
    inline GetVideoAnalysisConfigResponseBody& setData(const GetVideoAnalysisConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetVideoAnalysisConfigResponseBody& setData(GetVideoAnalysisConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetVideoAnalysisConfigResponseBodyData> data_ = nullptr;
