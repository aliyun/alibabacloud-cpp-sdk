...
namespace Models
{
  ...
  public:
    ...
    inline const RunScriptContinueResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunScriptContinueResponseBody::Header) };
    inline RunScriptContinueResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunScriptContinueResponseBody::Header) };
    inline RunScriptContinueResponseBody& setHeader(const RunScriptContinueResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunScriptContinueResponseBody& setHeader(RunScriptContinueResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunScriptContinueResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunScriptContinueResponseBody::Payload) };
    inline RunScriptContinueResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunScriptContinueResponseBody::Payload) };
    inline RunScriptContinueResponseBody& setPayload(const RunScriptContinueResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunScriptContinueResponseBody& setPayload(RunScriptContinueResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };


  protected:
    shared_ptr<bool> end_ {};
    shared_ptr<RunScriptContinueResponseBody::Header> header_ {};
    shared_ptr<RunScriptContinueResponseBody::Payload> payload_ {};
  };
