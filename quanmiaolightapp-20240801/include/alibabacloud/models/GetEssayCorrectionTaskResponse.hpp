...
namespace Models
{
  ...
  public:
    ...
    inline const GetEssayCorrectionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEssayCorrectionTaskResponseBody) };
    inline GetEssayCorrectionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEssayCorrectionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEssayCorrectionTaskResponseBody> body_ {};
  };
