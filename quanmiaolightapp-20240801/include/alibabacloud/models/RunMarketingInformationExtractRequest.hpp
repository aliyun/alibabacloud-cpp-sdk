...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getSourceMaterials() const { DARABONBA_PTR_GET_CONST(sourceMaterials_, vector<string>) };
    inline vector<string> getSourceMaterials() { DARABONBA_PTR_GET(sourceMaterials_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> sourceMaterials_ {};
  };
