...
namespace Models
{
  ...
  public:
    ...
    inline const RunMarketingInformationExtractResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunMarketingInformationExtractResponseBody::Header) };
    inline RunMarketingInformationExtractResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunMarketingInformationExtractResponseBody::Header) };
    inline RunMarketingInformationExtractResponseBody& setHeader(const RunMarketingInformationExtractResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunMarketingInformationExtractResponseBody& setHeader(RunMarketingInformationExtractResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunMarketingInformationExtractResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunMarketingInformationExtractResponseBody::Payload) };
    inline RunMarketingInformationExtractResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunMarketingInformationExtractResponseBody::Payload) };
    inline RunMarketingInformationExtractResponseBody& setPayload(const RunMarketingInformationExtractResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunMarketingInformationExtractResponseBody& setPayload(RunMarketingInformationExtractResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };


  protected:
    shared_ptr<bool> end_ {};
    shared_ptr<RunMarketingInformationExtractResponseBody::Header> header_ {};
    shared_ptr<RunMarketingInformationExtractResponseBody::Payload> payload_ {};
  };
