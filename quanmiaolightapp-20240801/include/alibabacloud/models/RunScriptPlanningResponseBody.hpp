...
namespace Models
{
  ...
  public:
    ...
    inline const RunScriptPlanningResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunScriptPlanningResponseBody::Header) };
    inline RunScriptPlanningResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunScriptPlanningResponseBody::Header) };
    inline RunScriptPlanningResponseBody& setHeader(const RunScriptPlanningResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunScriptPlanningResponseBody& setHeader(RunScriptPlanningResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunScriptPlanningResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunScriptPlanningResponseBody::Payload) };
    inline RunScriptPlanningResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunScriptPlanningResponseBody::Payload) };
    inline RunScriptPlanningResponseBody& setPayload(const RunScriptPlanningResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunScriptPlanningResponseBody& setPayload(RunScriptPlanningResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };


  protected:
    shared_ptr<bool> end_ {};
    shared_ptr<RunScriptPlanningResponseBody::Header> header_ {};
    shared_ptr<RunScriptPlanningResponseBody::Payload> payload_ {};
  };
