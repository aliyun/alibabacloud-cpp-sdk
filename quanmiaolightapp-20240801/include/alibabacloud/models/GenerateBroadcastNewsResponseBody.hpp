...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateBroadcastNewsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GenerateBroadcastNewsResponseBodyData) };
    inline GenerateBroadcastNewsResponseBodyData data() { DARABONBA_PTR_GET(data_, GenerateBroadcastNewsResponseBodyData) };
    inline GenerateBroadcastNewsResponseBody& setData(const GenerateBroadcastNewsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GenerateBroadcastNewsResponseBody& setData(GenerateBroadcastNewsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GenerateBroadcastNewsResponseBodyData> data_ = nullptr;
