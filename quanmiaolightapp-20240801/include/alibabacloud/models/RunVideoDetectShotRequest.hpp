...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->intelliSimpPrompt_ == nullptr
        ...
        && return this->options_ == nullptr && return this->originalSessionId_ == nullptr && return this->preModelId_ == nullptr && return this->prompt_ == nullptr && return this->recognitionOptions_ == nullptr
