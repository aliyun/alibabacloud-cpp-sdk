...
#ifndef ALIBABACLOUD_MODELS_RUNVIDEODETECTSHOTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_RUNVIDEODETECTSHOTREQUEST_HPP_
...
namespace Models
{
  class RunVideoDetectShotRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const RunVideoDetectShotRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RunVideoDetectShotRequest& obj) { 
    ...
    RunVideoDetectShotRequest() = default ;
    RunVideoDetectShotRequest(const RunVideoDetectShotRequest &) = default ;
    RunVideoDetectShotRequest(RunVideoDetectShotRequest &&) = default ;
    RunVideoDetectShotRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RunVideoDetectShotRequest() = default ;
    RunVideoDetectShotRequest& operator=(const RunVideoDetectShotRequest &) = default ;
    RunVideoDetectShotRequest& operator=(RunVideoDetectShotRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->intelliSimpPrompt_ == nullptr
        && this->intelliSimpPromptTemplateId_ == nullptr && this->language_ == nullptr && this->modelCustomPromptTemplateId_ == nullptr && this->modelId_ == nullptr && this->modelVlCustomPromptTemplateId_ == nullptr
        && this->options_ == nullptr && this->originalSessionId_ == nullptr && this->preModelId_ == nullptr && this->prompt_ == nullptr && this->recognitionOptions_ == nullptr
        && this->taskId_ == nullptr && this->videoUrl_ == nullptr && this->vlPrompt_ == nullptr; };
    ...
    inline RunVideoDetectShotRequest& setIntelliSimpPrompt(string intelliSimpPrompt) { DARABONBA_PTR_SET_VALUE(intelliSimpPrompt_, intelliSimpPrompt) };
    ...
    inline RunVideoDetectShotRequest& setIntelliSimpPromptTemplateId(string intelliSimpPromptTemplateId) { DARABONBA_PTR_SET_VALUE(intelliSimpPromptTemplateId_, intelliSimpPromptTemplateId) };
    ...
    inline RunVideoDetectShotRequest& setLanguage(string language) { DARABONBA_PTR_SET_VALUE(language_, language) };
    ...
    inline RunVideoDetectShotRequest& setModelCustomPromptTemplateId(string modelCustomPromptTemplateId) { DARABONBA_PTR_SET_VALUE(modelCustomPromptTemplateId_, modelCustomPromptTemplateId) };
    ...
    inline RunVideoDetectShotRequest& setModelId(string modelId) { DARABONBA_PTR_SET_VALUE(modelId_, modelId) };
    ...
    inline RunVideoDetectShotRequest& setModelVlCustomPromptTemplateId(string modelVlCustomPromptTemplateId) { DARABONBA_PTR_SET_VALUE(modelVlCustomPromptTemplateId_, modelVlCustomPromptTemplateId) };
    ...
    inline RunVideoDetectShotRequest& setOptions(const vector<string> & options) { DARABONBA_PTR_SET_VALUE(options_, options) };
    inline RunVideoDetectShotRequest& setOptions(vector<string> && options) { DARABONBA_PTR_SET_RVALUE(options_, options) };
    ...
    inline RunVideoDetectShotRequest& setOriginalSessionId(string originalSessionId) { DARABONBA_PTR_SET_VALUE(originalSessionId_, originalSessionId) };
    ...
    inline RunVideoDetectShotRequest& setPreModelId(string preModelId) { DARABONBA_PTR_SET_VALUE(preModelId_, preModelId) };
    ...
    inline RunVideoDetectShotRequest& setPrompt(string prompt) { DARABONBA_PTR_SET_VALUE(prompt_, prompt) };
    ...
    inline RunVideoDetectShotRequest& setRecognitionOptions(const vector<string> & recognitionOptions) { DARABONBA_PTR_SET_VALUE(recognitionOptions_, recognitionOptions) };
    inline RunVideoDetectShotRequest& setRecognitionOptions(vector<string> && recognitionOptions) { DARABONBA_PTR_SET_RVALUE(recognitionOptions_, recognitionOptions) };
    ...
    inline RunVideoDetectShotRequest& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
    ...
    inline RunVideoDetectShotRequest& setVideoUrl(string videoUrl) { DARABONBA_PTR_SET_VALUE(videoUrl_, videoUrl) };
    ...
    inline RunVideoDetectShotRequest& setVlPrompt(string vlPrompt) { DARABONBA_PTR_SET_VALUE(vlPrompt_, vlPrompt) };
