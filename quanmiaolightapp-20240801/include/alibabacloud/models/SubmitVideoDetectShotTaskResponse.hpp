...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitVideoDetectShotTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitVideoDetectShotTaskResponseBody) };
    inline SubmitVideoDetectShotTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitVideoDetectShotTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitVideoDetectShotTaskResponseBody> body_ {};
  };
