...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitTagMiningAnalysisTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitTagMiningAnalysisTaskResponseBody) };
    inline SubmitTagMiningAnalysisTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitTagMiningAnalysisTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitTagMiningAnalysisTaskResponseBody> body_ {};
  };
