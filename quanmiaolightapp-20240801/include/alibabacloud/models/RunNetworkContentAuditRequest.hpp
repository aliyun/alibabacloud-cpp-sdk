...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RunNetworkContentAuditRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<RunNetworkContentAuditRequest::Tags>) };
    inline vector<RunNetworkContentAuditRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<RunNetworkContentAuditRequest::Tags>) };
    inline RunNetworkContentAuditRequest& setTags(const vector<RunNetworkContentAuditRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline RunNetworkContentAuditRequest& setTags(vector<RunNetworkContentAuditRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    shared_ptr<vector<RunNetworkContentAuditRequest::Tags>> tags_ {};
