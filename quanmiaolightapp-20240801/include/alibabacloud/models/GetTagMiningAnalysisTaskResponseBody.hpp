...
namespace Models
{
  ...
  public:
    ...
    inline const GetTagMiningAnalysisTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTagMiningAnalysisTaskResponseBodyData) };
    inline GetTagMiningAnalysisTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTagMiningAnalysisTaskResponseBodyData) };
    inline GetTagMiningAnalysisTaskResponseBody& setData(const GetTagMiningAnalysisTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTagMiningAnalysisTaskResponseBody& setData(GetTagMiningAnalysisTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetTagMiningAnalysisTaskResponseBodyData> data_ = nullptr;
