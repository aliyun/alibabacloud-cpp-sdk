...
namespace Models
{
  ...
  public:
    ...
    inline const RunTagMiningAnalysisResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunTagMiningAnalysisResponseBody::Header) };
    inline RunTagMiningAnalysisResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunTagMiningAnalysisResponseBody::Header) };
    inline RunTagMiningAnalysisResponseBody& setHeader(const RunTagMiningAnalysisResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunTagMiningAnalysisResponseBody& setHeader(RunTagMiningAnalysisResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunTagMiningAnalysisResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunTagMiningAnalysisResponseBody::Payload) };
    inline RunTagMiningAnalysisResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunTagMiningAnalysisResponseBody::Payload) };
    inline RunTagMiningAnalysisResponseBody& setPayload(const RunTagMiningAnalysisResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunTagMiningAnalysisResponseBody& setPayload(RunTagMiningAnalysisResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    shared_ptr<RunTagMiningAnalysisResponseBody::Header> header_ {};
    shared_ptr<RunTagMiningAnalysisResponseBody::Payload> payload_ {};
    // Id of the request
