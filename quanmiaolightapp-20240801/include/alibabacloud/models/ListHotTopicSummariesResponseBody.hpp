...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListHotTopicSummariesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListHotTopicSummariesResponseBodyData>) };
    inline vector<ListHotTopicSummariesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListHotTopicSummariesResponseBodyData>) };
    inline ListHotTopicSummariesResponseBody& setData(const vector<ListHotTopicSummariesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHotTopicSummariesResponseBody& setData(vector<ListHotTopicSummariesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListHotTopicSummariesResponseBodyData>> data_ = nullptr;
