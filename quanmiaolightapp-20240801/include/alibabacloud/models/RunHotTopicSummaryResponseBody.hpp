...
namespace Models
{
  ...
  public:
    ...
    inline const RunHotTopicSummaryResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunHotTopicSummaryResponseBody::Header) };
    inline RunHotTopicSummaryResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunHotTopicSummaryResponseBody::Header) };
    inline RunHotTopicSummaryResponseBody& setHeader(const RunHotTopicSummaryResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunHotTopicSummaryResponseBody& setHeader(RunHotTopicSummaryResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunHotTopicSummaryResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunHotTopicSummaryResponseBody::Payload) };
    inline RunHotTopicSummaryResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunHotTopicSummaryResponseBody::Payload) };
    inline RunHotTopicSummaryResponseBody& setPayload(const RunHotTopicSummaryResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunHotTopicSummaryResponseBody& setPayload(RunHotTopicSummaryResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
  ...
  protected:
    shared_ptr<RunHotTopicSummaryResponseBody::Header> header_ {};
    shared_ptr<RunHotTopicSummaryResponseBody::Payload> payload_ {};
    // Id of the request
