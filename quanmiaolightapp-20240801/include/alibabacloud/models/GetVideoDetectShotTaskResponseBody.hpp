...
namespace Models
{
  ...
  public:
    ...
    inline const GetVideoDetectShotTaskResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetVideoDetectShotTaskResponseBodyData) };
    inline GetVideoDetectShotTaskResponseBodyData data() { DARABONBA_PTR_GET(data_, GetVideoDetectShotTaskResponseBodyData) };
    inline GetVideoDetectShotTaskResponseBody& setData(const GetVideoDetectShotTaskResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetVideoDetectShotTaskResponseBody& setData(GetVideoDetectShotTaskResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetVideoDetectShotTaskResponseBodyData> data_ = nullptr;
