...
namespace Models
{
  ...
  public:
    ...
    inline RunVideoDetectShotResponse& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline RunVideoDetectShotResponse& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const RunVideoDetectShotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunVideoDetectShotResponseBody) };
    inline RunVideoDetectShotResponseBody getBody() { DARABONBA_PTR_GET(body_, RunVideoDetectShotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunVideoDetectShotResponseBody> body_ {};
  };
