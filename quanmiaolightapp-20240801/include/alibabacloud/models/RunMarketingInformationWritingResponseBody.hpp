...
namespace Models
{
  ...
  public:
    ...
    inline const RunMarketingInformationWritingResponseBody::Header & getHeader() const { DARABONBA_PTR_GET_CONST(header_, RunMarketingInformationWritingResponseBody::Header) };
    inline RunMarketingInformationWritingResponseBody::Header getHeader() { DARABONBA_PTR_GET(header_, RunMarketingInformationWritingResponseBody::Header) };
    inline RunMarketingInformationWritingResponseBody& setHeader(const RunMarketingInformationWritingResponseBody::Header & header) { DARABONBA_PTR_SET_VALUE(header_, header) };
    inline RunMarketingInformationWritingResponseBody& setHeader(RunMarketingInformationWritingResponseBody::Header && header) { DARABONBA_PTR_SET_RVALUE(header_, header) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const RunMarketingInformationWritingResponseBody::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, RunMarketingInformationWritingResponseBody::Payload) };
    inline RunMarketingInformationWritingResponseBody::Payload getPayload() { DARABONBA_PTR_GET(payload_, RunMarketingInformationWritingResponseBody::Payload) };
    inline RunMarketingInformationWritingResponseBody& setPayload(const RunMarketingInformationWritingResponseBody::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline RunMarketingInformationWritingResponseBody& setPayload(RunMarketingInformationWritingResponseBody::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };


  protected:
    shared_ptr<bool> end_ {};
    shared_ptr<RunMarketingInformationWritingResponseBody::Header> header_ {};
    shared_ptr<RunMarketingInformationWritingResponseBody::Payload> payload_ {};
  };
