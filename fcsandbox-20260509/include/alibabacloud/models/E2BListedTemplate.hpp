...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aliases_ == nullptr
        ...
        && this->memoryMB_ == nullptr && this->names_ == nullptr && this->public_ == nullptr && this->spawnCount_ == nullptr && this->statusReason_ == nullptr
        && this->tags_ == nullptr && this->templateID_ == nullptr && this->updatedAt_ == nullptr; };
    ...
    inline E2BListedTemplate& setSpawnCount(string spawnCount) { DARABONBA_PTR_SET_VALUE(spawnCount_, spawnCount) };
