...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAPIKEYRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeApiKeyResponseBody : public Darabonba::Model {
  public:
    ...
    DescribeApiKeyResponseBody(const DescribeApiKeyResponseBody &) = default ;
    DescribeApiKeyResponseBody(DescribeApiKeyResponseBody &&) = default ;
    DescribeApiKeyResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeApiKeyResponseBody() = default ;
    DescribeApiKeyResponseBody& operator=(const DescribeApiKeyResponseBody &) = default ;
    DescribeApiKeyResponseBody& operator=(DescribeApiKeyResponseBody &&) = default ;
    ...
    inline DescribeApiKeyResponseBody& setApiKey(const ApiKey & apiKey) { DARABONBA_PTR_SET_VALUE(apiKey_, apiKey) };
    inline DescribeApiKeyResponseBody& setApiKey(ApiKey && apiKey) { DARABONBA_PTR_SET_RVALUE(apiKey_, apiKey) };
    ...
    inline DescribeApiKeyResponseBody& setIpBlacklist(const vector<IPConfig> & ipBlacklist) { DARABONBA_PTR_SET_VALUE(ipBlacklist_, ipBlacklist) };
    inline DescribeApiKeyResponseBody& setIpBlacklist(vector<IPConfig> && ipBlacklist) { DARABONBA_PTR_SET_RVALUE(ipBlacklist_, ipBlacklist) };
    ...
    inline DescribeApiKeyResponseBody& setIpWhitelist(const vector<IPConfig> & ipWhitelist) { DARABONBA_PTR_SET_VALUE(ipWhitelist_, ipWhitelist) };
    inline DescribeApiKeyResponseBody& setIpWhitelist(vector<IPConfig> && ipWhitelist) { DARABONBA_PTR_SET_RVALUE(ipWhitelist_, ipWhitelist) };
    ...
    inline DescribeApiKeyResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
