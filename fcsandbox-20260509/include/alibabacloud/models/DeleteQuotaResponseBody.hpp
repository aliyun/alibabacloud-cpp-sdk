...
namespace Models
{
  ...
  public:
    ...
    inline DeleteQuotaResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeleteQuotaResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
