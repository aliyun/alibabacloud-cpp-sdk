...
namespace Models
{
  ...
  public:
    ...
    inline GetTeamResponseBody& setTeam(const E2BTeam & team) { DARABONBA_PTR_SET_VALUE(team_, team) };
    inline GetTeamResponseBody& setTeam(E2BTeam && team) { DARABONBA_PTR_SET_RVALUE(team_, team) };
