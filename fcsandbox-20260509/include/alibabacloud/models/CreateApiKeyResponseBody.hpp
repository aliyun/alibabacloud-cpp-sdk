...
namespace Models
{
  ...
  public:
    ...
    inline CreateApiKeyResponseBody& setApiKey(const ApiKey & apiKey) { DARABONBA_PTR_SET_VALUE(apiKey_, apiKey) };
    inline CreateApiKeyResponseBody& setApiKey(ApiKey && apiKey) { DARABONBA_PTR_SET_RVALUE(apiKey_, apiKey) };
    ...
    inline CreateApiKeyResponseBody& setIpBlacklist(const vector<IPConfig> & ipBlacklist) { DARABONBA_PTR_SET_VALUE(ipBlacklist_, ipBlacklist) };
    inline CreateApiKeyResponseBody& setIpBlacklist(vector<IPConfig> && ipBlacklist) { DARABONBA_PTR_SET_RVALUE(ipBlacklist_, ipBlacklist) };
    ...
    inline CreateApiKeyResponseBody& setIpWhitelist(const vector<IPConfig> & ipWhitelist) { DARABONBA_PTR_SET_VALUE(ipWhitelist_, ipWhitelist) };
    inline CreateApiKeyResponseBody& setIpWhitelist(vector<IPConfig> && ipWhitelist) { DARABONBA_PTR_SET_RVALUE(ipWhitelist_, ipWhitelist) };
