...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateImageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateImageResponseBody) };
    inline UpdateImageResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateImageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateImageResponseBody> body_ {};
  };
