...
#ifndef ALIBABACLOUD_MODELS_SEARCHIMAGEBYPICRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SEARCHIMAGEBYPICRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchImageByPicResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SearchImageByPicResponseBody& obj) { 
    ...
    SearchImageByPicResponseBody() = default ;
    SearchImageByPicResponseBody(const SearchImageByPicResponseBody &) = default ;
    SearchImageByPicResponseBody(SearchImageByPicResponseBody &&) = default ;
    SearchImageByPicResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchImageByPicResponseBody() = default ;
    SearchImageByPicResponseBody& operator=(const SearchImageByPicResponseBody &) = default ;
    SearchImageByPicResponseBody& operator=(SearchImageByPicResponseBody &&) = default ;
    ...
    inline const vector<SearchImageByPicResponseBody::Auctions> & getAuctions() const { DARABONBA_PTR_GET_CONST(auctions_, vector<SearchImageByPicResponseBody::Auctions>) };
    inline vector<SearchImageByPicResponseBody::Auctions> getAuctions() { DARABONBA_PTR_GET(auctions_, vector<SearchImageByPicResponseBody::Auctions>) };
    inline SearchImageByPicResponseBody& setAuctions(const vector<SearchImageByPicResponseBody::Auctions> & auctions) { DARABONBA_PTR_SET_VALUE(auctions_, auctions) };
    inline SearchImageByPicResponseBody& setAuctions(vector<SearchImageByPicResponseBody::Auctions> && auctions) { DARABONBA_PTR_SET_RVALUE(auctions_, auctions) };
    ...
    inline SearchImageByPicResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // head Field Functions 
    bool hasHead() const { return this->head_ != nullptr;};
    void deleteHead() { this->head_ = nullptr;};
    inline const SearchImageByPicResponseBody::Head & getHead() const { DARABONBA_PTR_GET_CONST(head_, SearchImageByPicResponseBody::Head) };
    inline SearchImageByPicResponseBody::Head getHead() { DARABONBA_PTR_GET(head_, SearchImageByPicResponseBody::Head) };
    inline SearchImageByPicResponseBody& setHead(const SearchImageByPicResponseBody::Head & head) { DARABONBA_PTR_SET_VALUE(head_, head) };
    inline SearchImageByPicResponseBody& setHead(SearchImageByPicResponseBody::Head && head) { DARABONBA_PTR_SET_RVALUE(head_, head) };
    ...
    inline SearchImageByPicResponseBody& setMsg(string msg) { DARABONBA_PTR_SET_VALUE(msg_, msg) };


    // picInfo Field Functions 
    bool hasPicInfo() const { return this->picInfo_ != nullptr;};
    void deletePicInfo() { this->picInfo_ = nullptr;};
    inline const SearchImageByPicResponseBody::PicInfo & getPicInfo() const { DARABONBA_PTR_GET_CONST(picInfo_, SearchImageByPicResponseBody::PicInfo) };
    inline SearchImageByPicResponseBody::PicInfo getPicInfo() { DARABONBA_PTR_GET(picInfo_, SearchImageByPicResponseBody::PicInfo) };
    inline SearchImageByPicResponseBody& setPicInfo(const SearchImageByPicResponseBody::PicInfo & picInfo) { DARABONBA_PTR_SET_VALUE(picInfo_, picInfo) };
    inline SearchImageByPicResponseBody& setPicInfo(SearchImageByPicResponseBody::PicInfo && picInfo) { DARABONBA_PTR_SET_RVALUE(picInfo_, picInfo) };
    ...
    inline SearchImageByPicResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline SearchImageByPicResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // The product descriptions returned.
    shared_ptr<vector<SearchImageByPicResponseBody::Auctions>> auctions_ {};
    ...
    shared_ptr<SearchImageByPicResponseBody::Head> head_ {};
    // The error message returned.
    shared_ptr<string> msg_ {};
    // The information such as the system-selected category and result of subject recognition.
    shared_ptr<SearchImageByPicResponseBody::PicInfo> picInfo_ {};
