...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->updateResult_ == nullptr; };
    ...
    inline const UpdatePropertyResponseBodyUpdateResult & updateResult() const { DARABONBA_PTR_GET_CONST(updateResult_, UpdatePropertyResponseBodyUpdateResult) };
    inline UpdatePropertyResponseBodyUpdateResult updateResult() { DARABONBA_PTR_GET(updateResult_, UpdatePropertyResponseBodyUpdateResult) };
    inline UpdatePropertyResponseBody& setUpdateResult(const UpdatePropertyResponseBodyUpdateResult & updateResult) { DARABONBA_PTR_SET_VALUE(updateResult_, updateResult) };
    inline UpdatePropertyResponseBody& setUpdateResult(UpdatePropertyResponseBodyUpdateResult && updateResult) { DARABONBA_PTR_SET_RVALUE(updateResult_, updateResult) };
  ...
  protected:
    ...
    std::shared_ptr<UpdatePropertyResponseBodyUpdateResult> updateResult_ = nullptr;
  };
