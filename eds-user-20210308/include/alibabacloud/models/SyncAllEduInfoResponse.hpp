...
namespace Models
{
  ...
  public:
    ...
    inline const SyncAllEduInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SyncAllEduInfoResponseBody) };
    inline SyncAllEduInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, SyncAllEduInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SyncAllEduInfoResponseBody> body_ {};
  };
