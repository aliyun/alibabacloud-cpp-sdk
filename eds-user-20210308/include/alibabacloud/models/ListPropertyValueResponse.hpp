...
namespace Models
{
  ...
  public:
    ...
    inline const ListPropertyValueResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPropertyValueResponseBody) };
    inline ListPropertyValueResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPropertyValueResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPropertyValueResponseBody> body_ {};
  };
