...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->propertyId_ == nullptr
        && return this->propertyKey_ == nullptr && return this->propertyType_ == nullptr && return this->propertyValues_ == nullptr && return this->userId_ == nullptr && return this->userName_ == nullptr; };
