...
namespace Models
{
  ...
  public:
    ...
    inline const RemovePropertyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemovePropertyResponseBody) };
    inline RemovePropertyResponseBody getBody() { DARABONBA_PTR_GET(body_, RemovePropertyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemovePropertyResponseBody> body_ {};
  };
