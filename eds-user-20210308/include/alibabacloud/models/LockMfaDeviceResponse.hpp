...
namespace Models
{
  ...
  public:
    ...
    inline const LockMfaDeviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, LockMfaDeviceResponseBody) };
    inline LockMfaDeviceResponseBody getBody() { DARABONBA_PTR_GET(body_, LockMfaDeviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<LockMfaDeviceResponseBody> body_ {};
  };
