...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteUserPropertyValueResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteUserPropertyValueResponseBody) };
    inline DeleteUserPropertyValueResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteUserPropertyValueResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteUserPropertyValueResponseBody> body_ {};
  };
