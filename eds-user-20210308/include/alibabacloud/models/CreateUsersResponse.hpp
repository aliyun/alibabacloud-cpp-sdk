...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUsersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateUsersResponseBody) };
    inline CreateUsersResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateUsersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateUsersResponseBody> body_ {};
  };
