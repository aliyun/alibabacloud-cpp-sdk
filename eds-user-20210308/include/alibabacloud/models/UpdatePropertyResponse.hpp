...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePropertyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePropertyResponseBody) };
    inline UpdatePropertyResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePropertyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePropertyResponseBody> body_ {};
  };
