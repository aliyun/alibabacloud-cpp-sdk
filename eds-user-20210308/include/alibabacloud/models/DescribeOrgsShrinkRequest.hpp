...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessChannel_ == nullptr
        ...
        && this->parentOrgId_ == nullptr && this->showExtrasShrink_ == nullptr; };
    // businessChannel Field Functions 
    bool hasBusinessChannel() const { return this->businessChannel_ != nullptr;};
    void deleteBusinessChannel() { this->businessChannel_ = nullptr;};
    inline string getBusinessChannel() const { DARABONBA_PTR_GET_DEFAULT(businessChannel_, "") };
    inline DescribeOrgsShrinkRequest& setBusinessChannel(string businessChannel) { DARABONBA_PTR_SET_VALUE(businessChannel_, businessChannel) };
    ...
    inline DescribeOrgsShrinkRequest& setIncludeOrgIds(const vector<string> & includeOrgIds) { DARABONBA_PTR_SET_VALUE(includeOrgIds_, includeOrgIds) };
    inline DescribeOrgsShrinkRequest& setIncludeOrgIds(vector<string> && includeOrgIds) { DARABONBA_PTR_SET_RVALUE(includeOrgIds_, includeOrgIds) };
    ...
    inline DescribeOrgsShrinkRequest& setIsQueryAllSubOrgs(bool isQueryAllSubOrgs) { DARABONBA_PTR_SET_VALUE(isQueryAllSubOrgs_, isQueryAllSubOrgs) };
