...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->excludeEndUserIds_ == nullptr
        ...
        && return this->isQueryAllSubOrgs_ == nullptr && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->orderParam_ == nullptr && return this->orgId_ == nullptr
    ...
    inline const FilterUsersRequestOrderParam & orderParam() const { DARABONBA_PTR_GET_CONST(orderParam_, FilterUsersRequestOrderParam) };
    inline FilterUsersRequestOrderParam orderParam() { DARABONBA_PTR_GET(orderParam_, FilterUsersRequestOrderParam) };
    inline FilterUsersRequest& setOrderParam(const FilterUsersRequestOrderParam & orderParam) { DARABONBA_PTR_SET_VALUE(orderParam_, orderParam) };
    inline FilterUsersRequest& setOrderParam(FilterUsersRequestOrderParam && orderParam) { DARABONBA_PTR_SET_RVALUE(orderParam_, orderParam) };
    ...
    inline const vector<FilterUsersRequestPropertyFilterParam> & propertyFilterParam() const { DARABONBA_PTR_GET_CONST(propertyFilterParam_, vector<FilterUsersRequestPropertyFilterParam>) };
    inline vector<FilterUsersRequestPropertyFilterParam> propertyFilterParam() { DARABONBA_PTR_GET(propertyFilterParam_, vector<FilterUsersRequestPropertyFilterParam>) };
    inline FilterUsersRequest& setPropertyFilterParam(const vector<FilterUsersRequestPropertyFilterParam> & propertyFilterParam) { DARABONBA_PTR_SET_VALUE(propertyFilterParam_, propertyFilterParam) };
    inline FilterUsersRequest& setPropertyFilterParam(vector<FilterUsersRequestPropertyFilterParam> && propertyFilterParam) { DARABONBA_PTR_SET_RVALUE(propertyFilterParam_, propertyFilterParam) };
    ...
    inline const vector<FilterUsersRequestPropertyKeyValueFilterParam> & propertyKeyValueFilterParam() const { DARABONBA_PTR_GET_CONST(propertyKeyValueFilterParam_, vector<FilterUsersRequestPropertyKeyValueFilterParam>) };
    inline vector<FilterUsersRequestPropertyKeyValueFilterParam> propertyKeyValueFilterParam() { DARABONBA_PTR_GET(propertyKeyValueFilterParam_, vector<FilterUsersRequestPropertyKeyValueFilterParam>) };
    inline FilterUsersRequest& setPropertyKeyValueFilterParam(const vector<FilterUsersRequestPropertyKeyValueFilterParam> & propertyKeyValueFilterParam) { DARABONBA_PTR_SET_VALUE(propertyKeyValueFilterParam_, propertyKeyValueFilterParam) };
    inline FilterUsersRequest& setPropertyKeyValueFilterParam(vector<FilterUsersRequestPropertyKeyValueFilterParam> && propertyKeyValueFilterParam) { DARABONBA_PTR_SET_RVALUE(propertyKeyValueFilterParam_, propertyKeyValueFilterParam) };
  ...
  protected:
    ...
    std::shared_ptr<FilterUsersRequestOrderParam> orderParam_ = nullptr;
    ...
    std::shared_ptr<vector<FilterUsersRequestPropertyFilterParam>> propertyFilterParam_ = nullptr;
    // The list of property names and property values.
    std::shared_ptr<vector<FilterUsersRequestPropertyKeyValueFilterParam>> propertyKeyValueFilterParam_ = nullptr;
    // The status.
