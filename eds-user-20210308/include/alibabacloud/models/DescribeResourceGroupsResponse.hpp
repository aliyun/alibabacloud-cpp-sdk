...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceGroupsResponseBody) };
    inline DescribeResourceGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourceGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourceGroupsResponseBody> body_ {};
  };
