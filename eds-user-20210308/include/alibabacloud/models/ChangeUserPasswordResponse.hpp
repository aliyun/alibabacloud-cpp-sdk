...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeUserPasswordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChangeUserPasswordResponseBody) };
    inline ChangeUserPasswordResponseBody getBody() { DARABONBA_PTR_GET(body_, ChangeUserPasswordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ChangeUserPasswordResponseBody> body_ {};
  };
