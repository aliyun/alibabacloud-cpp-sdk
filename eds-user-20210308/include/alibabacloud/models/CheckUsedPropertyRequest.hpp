...
#ifndef ALIBABACLOUD_MODELS_CHECKUSEDPROPERTYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CHECKUSEDPROPERTYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    CheckUsedPropertyRequest(const CheckUsedPropertyRequest &) = default ;
    CheckUsedPropertyRequest(CheckUsedPropertyRequest &&) = default ;
    CheckUsedPropertyRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CheckUsedPropertyRequest() = default ;
    CheckUsedPropertyRequest& operator=(const CheckUsedPropertyRequest &) = default ;
    CheckUsedPropertyRequest& operator=(CheckUsedPropertyRequest &&) = default ;
