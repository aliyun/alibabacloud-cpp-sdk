...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGroupUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeGroupUserResponseBody) };
    inline DescribeGroupUserResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeGroupUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeGroupUserResponseBody> body_ {};
  };
