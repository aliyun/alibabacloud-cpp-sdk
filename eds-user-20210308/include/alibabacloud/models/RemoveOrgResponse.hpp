...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveOrgResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveOrgResponseBody) };
    inline RemoveOrgResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveOrgResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveOrgResponseBody> body_ {};
  };
