...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->resourceGroup_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const vector<DescribeResourceGroupsResponseBodyResourceGroup> & resourceGroup() const { DARABONBA_PTR_GET_CONST(resourceGroup_, vector<DescribeResourceGroupsResponseBodyResourceGroup>) };
    inline vector<DescribeResourceGroupsResponseBodyResourceGroup> resourceGroup() { DARABONBA_PTR_GET(resourceGroup_, vector<DescribeResourceGroupsResponseBodyResourceGroup>) };
    inline DescribeResourceGroupsResponseBody& setResourceGroup(const vector<DescribeResourceGroupsResponseBodyResourceGroup> & resourceGroup) { DARABONBA_PTR_SET_VALUE(resourceGroup_, resourceGroup) };
    inline DescribeResourceGroupsResponseBody& setResourceGroup(vector<DescribeResourceGroupsResponseBodyResourceGroup> && resourceGroup) { DARABONBA_PTR_SET_RVALUE(resourceGroup_, resourceGroup) };
  ...
  protected:
    ...
    // The resource groups.
    std::shared_ptr<vector<DescribeResourceGroupsResponseBodyResourceGroup>> resourceGroup_ = nullptr;
