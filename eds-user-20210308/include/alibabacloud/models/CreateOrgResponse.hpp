...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOrgResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateOrgResponseBody) };
    inline CreateOrgResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateOrgResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateOrgResponseBody> body_ {};
  };
