...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySyncStatusByAliUidResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QuerySyncStatusByAliUidResponseBodyData) };
    inline QuerySyncStatusByAliUidResponseBodyData data() { DARABONBA_PTR_GET(data_, QuerySyncStatusByAliUidResponseBodyData) };
    inline QuerySyncStatusByAliUidResponseBody& setData(const QuerySyncStatusByAliUidResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QuerySyncStatusByAliUidResponseBody& setData(QuerySyncStatusByAliUidResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QuerySyncStatusByAliUidResponseBodyData> data_ = nullptr;
