...
namespace Models
{
  ...
  public:
    ...
    inline const InitTenantAliasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InitTenantAliasResponseBody) };
    inline InitTenantAliasResponseBody getBody() { DARABONBA_PTR_GET(body_, InitTenantAliasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InitTenantAliasResponseBody> body_ {};
  };
