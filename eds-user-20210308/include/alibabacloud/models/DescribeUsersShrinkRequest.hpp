...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bizType_ == nullptr
        ...
        && this->filterMapShrink_ == nullptr && this->filterWithAssignedResourceShrink_ == nullptr && this->filterWithAssignedResourcesShrink_ == nullptr && this->groupId_ == nullptr && this->isQueryAllSubOrgs_ == nullptr
        && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->orgId_ == nullptr && this->showExtrasShrink_ == nullptr && this->solutionId_ == nullptr
    ...
    inline DescribeUsersShrinkRequest& setBusinessChannel(string businessChannel) { DARABONBA_PTR_SET_VALUE(businessChannel_, businessChannel) };
    ...
    inline DescribeUsersShrinkRequest& setFilterMapShrink(string filterMapShrink) { DARABONBA_PTR_SET_VALUE(filterMapShrink_, filterMapShrink) };
    ...
    inline string getFilterWithAssignedResourceShrink() const { DARABONBA_PTR_GET_DEFAULT(filterWithAssignedResourceShrink_, "") };
    ...
    inline string getFilterWithAssignedResourcesShrink() const { DARABONBA_PTR_GET_DEFAULT(filterWithAssignedResourcesShrink_, "") };
    ...
    inline string getShowExtrasShrink() const { DARABONBA_PTR_GET_DEFAULT(showExtrasShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> filterWithAssignedResourceShrink_ {};
    shared_ptr<string> filterWithAssignedResourcesShrink_ {};
    ...
    shared_ptr<string> showExtrasShrink_ {};
