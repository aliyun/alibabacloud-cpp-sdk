...
namespace Models
{
  ...
  public:
    ...
    inline const BatchSetDesktopManagerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchSetDesktopManagerResponseBody) };
    inline BatchSetDesktopManagerResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchSetDesktopManagerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchSetDesktopManagerResponseBody> body_ {};
  };
