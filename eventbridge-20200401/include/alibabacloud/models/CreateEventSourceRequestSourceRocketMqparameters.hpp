...
#ifndef ALIBABACLOUD_MODELS_CREATEEVENTSOURCEREQUESTSOURCEROCKETMQPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_CREATEEVENTSOURCEREQUESTSOURCEROCKETMQPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateEventSourceRequestSourceRocketMQParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateEventSourceRequestSourceRocketMQParameters& obj) { 
    ...
    CreateEventSourceRequestSourceRocketMQParameters() = default ;
    CreateEventSourceRequestSourceRocketMQParameters(const CreateEventSourceRequestSourceRocketMQParameters &) = default ;
    CreateEventSourceRequestSourceRocketMQParameters(CreateEventSourceRequestSourceRocketMQParameters &&) = default ;
    CreateEventSourceRequestSourceRocketMQParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateEventSourceRequestSourceRocketMQParameters() = default ;
    CreateEventSourceRequestSourceRocketMQParameters& operator=(const CreateEventSourceRequestSourceRocketMQParameters &) = default ;
    CreateEventSourceRequestSourceRocketMQParameters& operator=(CreateEventSourceRequestSourceRocketMQParameters &&) = default ;
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setGroupID(string groupID) { DARABONBA_PTR_SET_VALUE(groupID_, groupID) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setInstanceEndpoint(string instanceEndpoint) { DARABONBA_PTR_SET_VALUE(instanceEndpoint_, instanceEndpoint) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setInstanceNetwork(string instanceNetwork) { DARABONBA_PTR_SET_VALUE(instanceNetwork_, instanceNetwork) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setInstancePassword(string instancePassword) { DARABONBA_PTR_SET_VALUE(instancePassword_, instancePassword) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setInstanceSecurityGroupId(string instanceSecurityGroupId) { DARABONBA_PTR_SET_VALUE(instanceSecurityGroupId_, instanceSecurityGroupId) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setInstanceUsername(string instanceUsername) { DARABONBA_PTR_SET_VALUE(instanceUsername_, instanceUsername) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setInstanceVSwitchIds(string instanceVSwitchIds) { DARABONBA_PTR_SET_VALUE(instanceVSwitchIds_, instanceVSwitchIds) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setInstanceVpcId(string instanceVpcId) { DARABONBA_PTR_SET_VALUE(instanceVpcId_, instanceVpcId) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setOffset(string offset) { DARABONBA_PTR_SET_VALUE(offset_, offset) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline CreateEventSourceRequestSourceRocketMQParameters& setTopic(string topic) { DARABONBA_PTR_SET_VALUE(topic_, topic) };
