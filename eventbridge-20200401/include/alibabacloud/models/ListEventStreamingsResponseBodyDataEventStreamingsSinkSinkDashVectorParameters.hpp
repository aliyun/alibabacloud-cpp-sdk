...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Models::ListEventStreamingsResponseBodyDataEventStreamingsSinkSinkDashVectorParametersDashVectorSchemaParameters> & dashVectorSchemaParameters() const { DARABONBA_PTR_GET_CONST(dashVectorSchemaParameters_, vector<Models::ListEventStreamingsResponseBodyDataEventStreamingsSinkSinkDashVectorParametersDashVectorSchemaParameters>) };
    inline vector<Models::ListEventStreamingsResponseBodyDataEventStreamingsSinkSinkDashVectorParametersDashVectorSchemaParameters> dashVectorSchemaParameters() { DARABONBA_PTR_GET(dashVectorSchemaParameters_, vector<Models::ListEventStreamingsResponseBodyDataEventStreamingsSinkSinkDashVectorParametersDashVectorSchemaParameters>) };
    inline ListEventStreamingsResponseBodyDataEventStreamingsSinkSinkDashVectorParameters& setDashVectorSchemaParameters(const vector<Models::ListEventStreamingsResponseBodyDataEventStreamingsSinkSinkDashVectorParametersDashVectorSchemaParameters> & dashVectorSchemaParameters) { DARABONBA_PTR_SET_VALUE(dashVectorSchemaParameters_, dashVectorSchemaParameters) };
    inline ListEventStreamingsResponseBodyDataEventStreamingsSinkSinkDashVectorParameters& setDashVectorSchemaParameters(vector<Models::ListEventStreamingsResponseBodyDataEventStreamingsSinkSinkDashVectorParametersDashVectorSchemaParameters> && dashVectorSchemaParameters) { DARABONBA_PTR_SET_RVALUE(dashVectorSchemaParameters_, dashVectorSchemaParameters) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::ListEventStreamingsResponseBodyDataEventStreamingsSinkSinkDashVectorParametersDashVectorSchemaParameters>> dashVectorSchemaParameters_ = nullptr;
