...
namespace Models
{
  ...
  public:
    ...
    inline const ListAliyunOfficialEventSourcesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAliyunOfficialEventSourcesResponseBodyData) };
    inline ListAliyunOfficialEventSourcesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAliyunOfficialEventSourcesResponseBodyData) };
    inline ListAliyunOfficialEventSourcesResponseBody& setData(const ListAliyunOfficialEventSourcesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAliyunOfficialEventSourcesResponseBody& setData(ListAliyunOfficialEventSourcesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListAliyunOfficialEventSourcesResponseBodyData> data_ = nullptr;
