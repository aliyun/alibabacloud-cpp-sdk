...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->concurrentConfig_ == nullptr
        && return this->endpoint_ == nullptr && return this->errorsTolerance_ == nullptr && return this->eventBusName_ == nullptr && return this->id_ == nullptr && return this->paramList_ == nullptr
        && return this->ruleName_ == nullptr && return this->type_ == nullptr; };
