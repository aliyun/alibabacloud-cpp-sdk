...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        bool hasContentSchema() const { return this->contentSchema_ != nullptr;};
        void deleteContentSchema() { this->contentSchema_ = nullptr;};
        inline const SinkDataHubParameters::ContentSchema & getContentSchema() const { DARABONBA_PTR_GET_CONST(contentSchema_, SinkDataHubParameters::ContentSchema) };
        inline SinkDataHubParameters::ContentSchema getContentSchema() { DARABONBA_PTR_GET(contentSchema_, SinkDataHubParameters::ContentSchema) };
        inline SinkDataHubParameters& setContentSchema(const SinkDataHubParameters::ContentSchema & contentSchema) { DARABONBA_PTR_SET_VALUE(contentSchema_, contentSchema) };
        inline SinkDataHubParameters& setContentSchema(SinkDataHubParameters::ContentSchema && contentSchema) { DARABONBA_PTR_SET_RVALUE(contentSchema_, contentSchema) };


        // contentType Field Functions 
        bool hasContentType() const { return this->contentType_ != nullptr;};
        void deleteContentType() { this->contentType_ = nullptr;};
        inline const SinkDataHubParameters::ContentType & getContentType() const { DARABONBA_PTR_GET_CONST(contentType_, SinkDataHubParameters::ContentType) };
        inline SinkDataHubParameters::ContentType getContentType() { DARABONBA_PTR_GET(contentType_, SinkDataHubParameters::ContentType) };
        inline SinkDataHubParameters& setContentType(const SinkDataHubParameters::ContentType & contentType) { DARABONBA_PTR_SET_VALUE(contentType_, contentType) };
        inline SinkDataHubParameters& setContentType(SinkDataHubParameters::ContentType && contentType) { DARABONBA_PTR_SET_RVALUE(contentType_, contentType) };
      ...
      protected:
        ...
        // The key-value pair of custom logs. This parameter takes effect only if you set ContentType to KeyValue. Each key-value pair is in the Key_n, Value_n format.
        shared_ptr<SinkDataHubParameters::ContentSchema> contentSchema_ {};
        // The data format. Valid values:
        // 
        // *   JSON
        // *   KeyValue
        shared_ptr<SinkDataHubParameters::ContentType> contentType_ {};
        // The name of the DataHub project.
    ...
    inline const UpdateEventStreamingRequest::RunOptions & getRunOptions() const { DARABONBA_PTR_GET_CONST(runOptions_, UpdateEventStreamingRequest::RunOptions) };
    inline UpdateEventStreamingRequest::RunOptions getRunOptions() { DARABONBA_PTR_GET(runOptions_, UpdateEventStreamingRequest::RunOptions) };
    inline UpdateEventStreamingRequest& setRunOptions(const UpdateEventStreamingRequest::RunOptions & runOptions) { DARABONBA_PTR_SET_VALUE(runOptions_, runOptions) };
    inline UpdateEventStreamingRequest& setRunOptions(UpdateEventStreamingRequest::RunOptions && runOptions) { DARABONBA_PTR_SET_RVALUE(runOptions_, runOptions) };


    // sink Field Functions 
    bool hasSink() const { return this->sink_ != nullptr;};
    void deleteSink() { this->sink_ = nullptr;};
    inline const UpdateEventStreamingRequest::Sink & getSink() const { DARABONBA_PTR_GET_CONST(sink_, UpdateEventStreamingRequest::Sink) };
    inline UpdateEventStreamingRequest::Sink getSink() { DARABONBA_PTR_GET(sink_, UpdateEventStreamingRequest::Sink) };
    inline UpdateEventStreamingRequest& setSink(const UpdateEventStreamingRequest::Sink & sink) { DARABONBA_PTR_SET_VALUE(sink_, sink) };
    inline UpdateEventStreamingRequest& setSink(UpdateEventStreamingRequest::Sink && sink) { DARABONBA_PTR_SET_RVALUE(sink_, sink) };


    // source Field Functions 
    bool hasSource() const { return this->source_ != nullptr;};
    void deleteSource() { this->source_ = nullptr;};
    inline const UpdateEventStreamingRequest::Source & getSource() const { DARABONBA_PTR_GET_CONST(source_, UpdateEventStreamingRequest::Source) };
    inline UpdateEventStreamingRequest::Source getSource() { DARABONBA_PTR_GET(source_, UpdateEventStreamingRequest::Source) };
    inline UpdateEventStreamingRequest& setSource(const UpdateEventStreamingRequest::Source & source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    inline UpdateEventStreamingRequest& setSource(UpdateEventStreamingRequest::Source && source) { DARABONBA_PTR_SET_RVALUE(source_, source) };
    ...
    inline const vector<UpdateEventStreamingRequest::Transforms> & getTransforms() const { DARABONBA_PTR_GET_CONST(transforms_, vector<UpdateEventStreamingRequest::Transforms>) };
    inline vector<UpdateEventStreamingRequest::Transforms> getTransforms() { DARABONBA_PTR_GET(transforms_, vector<UpdateEventStreamingRequest::Transforms>) };
    inline UpdateEventStreamingRequest& setTransforms(const vector<UpdateEventStreamingRequest::Transforms> & transforms) { DARABONBA_PTR_SET_VALUE(transforms_, transforms) };
    inline UpdateEventStreamingRequest& setTransforms(vector<UpdateEventStreamingRequest::Transforms> && transforms) { DARABONBA_PTR_SET_RVALUE(transforms_, transforms) };
  ...
  protected:
    ...
    shared_ptr<UpdateEventStreamingRequest::RunOptions> runOptions_ {};
    // The event target. You must and can specify only one event target.
    // 
    // This parameter is required.
    shared_ptr<UpdateEventStreamingRequest::Sink> sink_ {};
    // The event provider, which is also known as the event source. You must and can specify only one event source.
    // 
    // This parameter is required.
    shared_ptr<UpdateEventStreamingRequest::Source> source_ {};
    shared_ptr<vector<UpdateEventStreamingRequest::Transforms>> transforms_ {};
  };
