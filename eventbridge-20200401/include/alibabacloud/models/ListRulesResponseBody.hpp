...
namespace Models
{
  ...
  public:
    ...
    inline const ListRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListRulesResponseBodyData) };
    inline ListRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListRulesResponseBodyData) };
    inline ListRulesResponseBody& setData(const ListRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListRulesResponseBody& setData(ListRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListRulesResponseBodyData> data_ = nullptr;
