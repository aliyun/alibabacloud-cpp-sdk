...
namespace Models
{
  ...
  public:
    ...
    inline GetEventStreamingResponseBodyDataTransforms& setBaiLianAgentTransformParameters(const Models::BaiLianAgentTransformParameters & baiLianAgentTransformParameters) { DARABONBA_PTR_SET_VALUE(baiLianAgentTransformParameters_, baiLianAgentTransformParameters) };
    inline GetEventStreamingResponseBodyDataTransforms& setBaiLianAgentTransformParameters(Models::BaiLianAgentTransformParameters && baiLianAgentTransformParameters) { DARABONBA_PTR_SET_RVALUE(baiLianAgentTransformParameters_, baiLianAgentTransformParameters) };
    ...
    inline GetEventStreamingResponseBodyDataTransforms& setDashScopeTransformParameters(const Models::DashScopeTransformParameters & dashScopeTransformParameters) { DARABONBA_PTR_SET_VALUE(dashScopeTransformParameters_, dashScopeTransformParameters) };
    inline GetEventStreamingResponseBodyDataTransforms& setDashScopeTransformParameters(Models::DashScopeTransformParameters && dashScopeTransformParameters) { DARABONBA_PTR_SET_RVALUE(dashScopeTransformParameters_, dashScopeTransformParameters) };
