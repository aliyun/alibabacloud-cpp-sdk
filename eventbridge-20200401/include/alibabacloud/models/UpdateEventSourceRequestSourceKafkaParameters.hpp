...
#ifndef ALIBABACLOUD_MODELS_UPDATEEVENTSOURCEREQUESTSOURCEKAFKAPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_UPDATEEVENTSOURCEREQUESTSOURCEKAFKAPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateEventSourceRequestSourceKafkaParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateEventSourceRequestSourceKafkaParameters& obj) { 
    ...
    UpdateEventSourceRequestSourceKafkaParameters() = default ;
    UpdateEventSourceRequestSourceKafkaParameters(const UpdateEventSourceRequestSourceKafkaParameters &) = default ;
    UpdateEventSourceRequestSourceKafkaParameters(UpdateEventSourceRequestSourceKafkaParameters &&) = default ;
    UpdateEventSourceRequestSourceKafkaParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateEventSourceRequestSourceKafkaParameters() = default ;
    UpdateEventSourceRequestSourceKafkaParameters& operator=(const UpdateEventSourceRequestSourceKafkaParameters &) = default ;
    UpdateEventSourceRequestSourceKafkaParameters& operator=(UpdateEventSourceRequestSourceKafkaParameters &&) = default ;
    ...
    inline UpdateEventSourceRequestSourceKafkaParameters& setConsumerGroup(string consumerGroup) { DARABONBA_PTR_SET_VALUE(consumerGroup_, consumerGroup) };
    ...
    inline UpdateEventSourceRequestSourceKafkaParameters& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline UpdateEventSourceRequestSourceKafkaParameters& setMaximumTasks(int32_t maximumTasks) { DARABONBA_PTR_SET_VALUE(maximumTasks_, maximumTasks) };
    ...
    inline UpdateEventSourceRequestSourceKafkaParameters& setNetwork(string network) { DARABONBA_PTR_SET_VALUE(network_, network) };
    ...
    inline UpdateEventSourceRequestSourceKafkaParameters& setOffsetReset(string offsetReset) { DARABONBA_PTR_SET_VALUE(offsetReset_, offsetReset) };
    ...
    inline UpdateEventSourceRequestSourceKafkaParameters& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline UpdateEventSourceRequestSourceKafkaParameters& setSecurityGroupId(string securityGroupId) { DARABONBA_PTR_SET_VALUE(securityGroupId_, securityGroupId) };
    ...
    inline UpdateEventSourceRequestSourceKafkaParameters& setTopic(string topic) { DARABONBA_PTR_SET_VALUE(topic_, topic) };
    ...
    inline UpdateEventSourceRequestSourceKafkaParameters& setVSwitchIds(string vSwitchIds) { DARABONBA_PTR_SET_VALUE(vSwitchIds_, vSwitchIds) };
    ...
    inline UpdateEventSourceRequestSourceKafkaParameters& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
