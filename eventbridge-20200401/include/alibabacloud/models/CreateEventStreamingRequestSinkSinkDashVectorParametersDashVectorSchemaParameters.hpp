...
namespace Models
{
  ...
  public:
    ...
    inline CreateEventStreamingRequestSinkSinkDashVectorParametersDashVectorSchemaParameters& setForm(string form) { DARABONBA_PTR_SET_VALUE(form_, form) };
    ...
    inline CreateEventStreamingRequestSinkSinkDashVectorParametersDashVectorSchemaParameters& setTemplate(string _template) { DARABONBA_PTR_SET_VALUE(template_, _template) };
    ...
    inline CreateEventStreamingRequestSinkSinkDashVectorParametersDashVectorSchemaParameters& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
