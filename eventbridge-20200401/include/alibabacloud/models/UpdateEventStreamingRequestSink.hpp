...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->sinkApacheKafkaParameters_ == nullptr
        ...
        && return this->sinkPrometheusParameters_ == nullptr && return this->sinkRabbitMQParameters_ == nullptr && return this->sinkRocketMQCheckpointParameters_ == nullptr && return this->sinkRocketMQParameters_ == nullptr && return this->sinkSLSParameters_ == nullptr; };
    ...
    inline const Models::UpdateEventStreamingRequestSinkSinkApacheKafkaParameters & sinkApacheKafkaParameters() const { DARABONBA_PTR_GET_CONST(sinkApacheKafkaParameters_, Models::UpdateEventStreamingRequestSinkSinkApacheKafkaParameters) };
    inline Models::UpdateEventStreamingRequestSinkSinkApacheKafkaParameters sinkApacheKafkaParameters() { DARABONBA_PTR_GET(sinkApacheKafkaParameters_, Models::UpdateEventStreamingRequestSinkSinkApacheKafkaParameters) };
    inline UpdateEventStreamingRequestSink& setSinkApacheKafkaParameters(const Models::UpdateEventStreamingRequestSinkSinkApacheKafkaParameters & sinkApacheKafkaParameters) { DARABONBA_PTR_SET_VALUE(sinkApacheKafkaParameters_, sinkApacheKafkaParameters) };
    inline UpdateEventStreamingRequestSink& setSinkApacheKafkaParameters(Models::UpdateEventStreamingRequestSinkSinkApacheKafkaParameters && sinkApacheKafkaParameters) { DARABONBA_PTR_SET_RVALUE(sinkApacheKafkaParameters_, sinkApacheKafkaParameters) };
    ...
    inline UpdateEventStreamingRequestSink& setSinkApiDestinationParameters(const Models::SinkApiDestinationParameters & sinkApiDestinationParameters) { DARABONBA_PTR_SET_VALUE(sinkApiDestinationParameters_, sinkApiDestinationParameters) };
    inline UpdateEventStreamingRequestSink& setSinkApiDestinationParameters(Models::SinkApiDestinationParameters && sinkApiDestinationParameters) { DARABONBA_PTR_SET_RVALUE(sinkApiDestinationParameters_, sinkApiDestinationParameters) };
    ...
    inline UpdateEventStreamingRequestSink& setSinkDataWorksTriggerParameters(const Models::SinkDataWorksTriggerParameters & sinkDataWorksTriggerParameters) { DARABONBA_PTR_SET_VALUE(sinkDataWorksTriggerParameters_, sinkDataWorksTriggerParameters) };
    inline UpdateEventStreamingRequestSink& setSinkDataWorksTriggerParameters(Models::SinkDataWorksTriggerParameters && sinkDataWorksTriggerParameters) { DARABONBA_PTR_SET_RVALUE(sinkDataWorksTriggerParameters_, sinkDataWorksTriggerParameters) };
    ...
    inline UpdateEventStreamingRequestSink& setSinkHttpsParameters(const Models::SinkHttpsParameters & sinkHttpsParameters) { DARABONBA_PTR_SET_VALUE(sinkHttpsParameters_, sinkHttpsParameters) };
    inline UpdateEventStreamingRequestSink& setSinkHttpsParameters(Models::SinkHttpsParameters && sinkHttpsParameters) { DARABONBA_PTR_SET_RVALUE(sinkHttpsParameters_, sinkHttpsParameters) };
  ...
  protected:
    std::shared_ptr<Models::UpdateEventStreamingRequestSinkSinkApacheKafkaParameters> sinkApacheKafkaParameters_ = nullptr;
