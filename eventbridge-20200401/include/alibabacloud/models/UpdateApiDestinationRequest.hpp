...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->apiDestinationName_ == nullptr
        && return this->connectionName_ == nullptr && return this->description_ == nullptr && return this->httpApiParameters_ == nullptr; };
    ...
    inline const UpdateApiDestinationRequestHttpApiParameters & httpApiParameters() const { DARABONBA_PTR_GET_CONST(httpApiParameters_, UpdateApiDestinationRequestHttpApiParameters) };
    inline UpdateApiDestinationRequestHttpApiParameters httpApiParameters() { DARABONBA_PTR_GET(httpApiParameters_, UpdateApiDestinationRequestHttpApiParameters) };
    inline UpdateApiDestinationRequest& setHttpApiParameters(const UpdateApiDestinationRequestHttpApiParameters & httpApiParameters) { DARABONBA_PTR_SET_VALUE(httpApiParameters_, httpApiParameters) };
    inline UpdateApiDestinationRequest& setHttpApiParameters(UpdateApiDestinationRequestHttpApiParameters && httpApiParameters) { DARABONBA_PTR_SET_RVALUE(httpApiParameters_, httpApiParameters) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateApiDestinationRequestHttpApiParameters> httpApiParameters_ = nullptr;
  };
