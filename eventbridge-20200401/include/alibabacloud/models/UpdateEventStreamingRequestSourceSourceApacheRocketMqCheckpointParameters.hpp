...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instanceEndpoint_ == nullptr
        && return this->instancePassword_ == nullptr && return this->instanceUsername_ == nullptr && return this->networkType_ == nullptr && return this->regionId_ == nullptr && return this->securityGroupId_ == nullptr
        && return this->topics_ == nullptr && return this->vSwitchId_ == nullptr && return this->vpcId_ == nullptr; };
