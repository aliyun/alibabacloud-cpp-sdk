...
namespace Models
{
  ...
  public:
    ...
    inline const ListEventBusesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListEventBusesResponseBody) };
    inline ListEventBusesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListEventBusesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListEventBusesResponseBody> body_ {};
  };
