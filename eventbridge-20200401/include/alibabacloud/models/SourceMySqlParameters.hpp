...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->databaseName_ == nullptr
        && return this->hostName_ == nullptr && return this->includeSchemaChanges_ == nullptr && return this->networkType_ == nullptr && return this->password_ == nullptr && return this->port_ == nullptr
        && return this->regionId_ == nullptr && return this->securityGroupId_ == nullptr && return this->snapshotMode_ == nullptr && return this->tableNames_ == nullptr && return this->user_ == nullptr
