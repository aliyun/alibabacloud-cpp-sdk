...
namespace Models
{
  ...
  public:
    ...
    inline const StartEventStreamingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartEventStreamingResponseBody) };
    inline StartEventStreamingResponseBody getBody() { DARABONBA_PTR_GET(body_, StartEventStreamingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartEventStreamingResponseBody> body_ {};
  };
