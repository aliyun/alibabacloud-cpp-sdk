...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserDefinedEventSourcesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListUserDefinedEventSourcesResponseBodyData) };
    inline ListUserDefinedEventSourcesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListUserDefinedEventSourcesResponseBodyData) };
    inline ListUserDefinedEventSourcesResponseBody& setData(const ListUserDefinedEventSourcesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListUserDefinedEventSourcesResponseBody& setData(ListUserDefinedEventSourcesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListUserDefinedEventSourcesResponseBodyData> data_ = nullptr;
