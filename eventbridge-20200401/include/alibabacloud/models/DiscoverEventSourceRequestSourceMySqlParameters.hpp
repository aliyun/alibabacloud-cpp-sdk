...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->databaseName_ == nullptr
        && return this->hostName_ == nullptr && return this->limit_ == nullptr && return this->networkType_ == nullptr && return this->offset_ == nullptr && return this->password_ == nullptr
        && return this->port_ == nullptr && return this->regionId_ == nullptr && return this->securityGroupId_ == nullptr && return this->tableName_ == nullptr && return this->user_ == nullptr
