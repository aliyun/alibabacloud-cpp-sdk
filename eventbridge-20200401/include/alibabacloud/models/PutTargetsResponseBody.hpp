...
namespace Models
{
  ...
  public:
    ...
    inline const PutTargetsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, PutTargetsResponseBodyData) };
    inline PutTargetsResponseBodyData data() { DARABONBA_PTR_GET(data_, PutTargetsResponseBodyData) };
    inline PutTargetsResponseBody& setData(const PutTargetsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PutTargetsResponseBody& setData(PutTargetsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<PutTargetsResponseBodyData> data_ = nullptr;
