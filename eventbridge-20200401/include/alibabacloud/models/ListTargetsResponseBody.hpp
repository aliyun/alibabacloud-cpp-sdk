...
namespace Models
{
  ...
  public:
    ...
    inline const ListTargetsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListTargetsResponseBodyData) };
    inline ListTargetsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListTargetsResponseBodyData) };
    inline ListTargetsResponseBody& setData(const ListTargetsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTargetsResponseBody& setData(ListTargetsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListTargetsResponseBodyData> data_ = nullptr;
