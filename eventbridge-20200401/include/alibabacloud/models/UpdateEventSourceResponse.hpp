...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEventSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEventSourceResponseBody) };
    inline UpdateEventSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEventSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEventSourceResponseBody> body_ {};
  };
