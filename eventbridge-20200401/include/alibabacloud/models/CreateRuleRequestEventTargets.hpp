...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->concurrentConfig_ == nullptr
        && return this->deadLetterQueue_ == nullptr && return this->endpoint_ == nullptr && return this->errorsTolerance_ == nullptr && return this->id_ == nullptr && return this->paramList_ == nullptr
        && return this->pushRetryStrategy_ == nullptr && return this->type_ == nullptr; };
