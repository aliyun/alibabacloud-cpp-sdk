...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTracedEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryTracedEventsResponseBody) };
    inline QueryTracedEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryTracedEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryTracedEventsResponseBody> body_ {};
  };
