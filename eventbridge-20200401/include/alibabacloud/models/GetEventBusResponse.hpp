...
namespace Models
{
  ...
  public:
    ...
    inline const GetEventBusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEventBusResponseBody) };
    inline GetEventBusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEventBusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEventBusResponseBody> body_ {};
  };
