...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEventStreamingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEventStreamingResponseBody) };
    inline UpdateEventStreamingResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEventStreamingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEventStreamingResponseBody> body_ {};
  };
