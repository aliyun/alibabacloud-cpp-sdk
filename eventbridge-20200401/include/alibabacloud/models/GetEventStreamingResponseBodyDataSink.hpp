...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->sinkApacheKafkaParameters_ == nullptr
        && return this->sinkApacheRocketMQCheckpointParameters_ == nullptr && return this->sinkApiDestinationParameters_ == nullptr && return this->sinkBaiLianParameters_ == nullptr && return this->sinkCustomizedKafkaConnectorParameters_ == nullptr && return this->sinkCustomizedKafkaParameters_ == nullptr
        && return this->sinkDashVectorParameters_ == nullptr && return this->sinkDataHubParameters_ == nullptr && return this->sinkDataWorksTriggerParameters_ == nullptr && return this->sinkDorisParameters_ == nullptr && return this->sinkFcParameters_ == nullptr
        && return this->sinkFnfParameters_ == nullptr && return this->sinkHttpsParameters_ == nullptr && return this->sinkKafkaParameters_ == nullptr && return this->sinkMNSParameters_ == nullptr && return this->sinkOpenSourceRabbitMQParameters_ == nullptr
        && return this->sinkRabbitMQParameters_ == nullptr && return this->sinkRocketMQCheckpointParameters_ == nullptr && return this->sinkRocketMQParameters_ == nullptr && return this->sinkSLSParameters_ == nullptr; };
    ...
    inline const Models::GetEventStreamingResponseBodyDataSinkSinkApacheKafkaParameters & sinkApacheKafkaParameters() const { DARABONBA_PTR_GET_CONST(sinkApacheKafkaParameters_, Models::GetEventStreamingResponseBodyDataSinkSinkApacheKafkaParameters) };
    inline Models::GetEventStreamingResponseBodyDataSinkSinkApacheKafkaParameters sinkApacheKafkaParameters() { DARABONBA_PTR_GET(sinkApacheKafkaParameters_, Models::GetEventStreamingResponseBodyDataSinkSinkApacheKafkaParameters) };
    inline GetEventStreamingResponseBodyDataSink& setSinkApacheKafkaParameters(const Models::GetEventStreamingResponseBodyDataSinkSinkApacheKafkaParameters & sinkApacheKafkaParameters) { DARABONBA_PTR_SET_VALUE(sinkApacheKafkaParameters_, sinkApacheKafkaParameters) };
    inline GetEventStreamingResponseBodyDataSink& setSinkApacheKafkaParameters(Models::GetEventStreamingResponseBodyDataSinkSinkApacheKafkaParameters && sinkApacheKafkaParameters) { DARABONBA_PTR_SET_RVALUE(sinkApacheKafkaParameters_, sinkApacheKafkaParameters) };
    ...
    inline GetEventStreamingResponseBodyDataSink& setSinkApiDestinationParameters(const Models::SinkApiDestinationParameters & sinkApiDestinationParameters) { DARABONBA_PTR_SET_VALUE(sinkApiDestinationParameters_, sinkApiDestinationParameters) };
    inline GetEventStreamingResponseBodyDataSink& setSinkApiDestinationParameters(Models::SinkApiDestinationParameters && sinkApiDestinationParameters) { DARABONBA_PTR_SET_RVALUE(sinkApiDestinationParameters_, sinkApiDestinationParameters) };
    ...
    inline GetEventStreamingResponseBodyDataSink& setSinkDataWorksTriggerParameters(const Models::SinkDataWorksTriggerParameters & sinkDataWorksTriggerParameters) { DARABONBA_PTR_SET_VALUE(sinkDataWorksTriggerParameters_, sinkDataWorksTriggerParameters) };
    inline GetEventStreamingResponseBodyDataSink& setSinkDataWorksTriggerParameters(Models::SinkDataWorksTriggerParameters && sinkDataWorksTriggerParameters) { DARABONBA_PTR_SET_RVALUE(sinkDataWorksTriggerParameters_, sinkDataWorksTriggerParameters) };
    ...
    inline GetEventStreamingResponseBodyDataSink& setSinkHttpsParameters(const Models::SinkHttpsParameters & sinkHttpsParameters) { DARABONBA_PTR_SET_VALUE(sinkHttpsParameters_, sinkHttpsParameters) };
    inline GetEventStreamingResponseBodyDataSink& setSinkHttpsParameters(Models::SinkHttpsParameters && sinkHttpsParameters) { DARABONBA_PTR_SET_RVALUE(sinkHttpsParameters_, sinkHttpsParameters) };
  ...
  protected:
    std::shared_ptr<Models::GetEventStreamingResponseBodyDataSinkSinkApacheKafkaParameters> sinkApacheKafkaParameters_ = nullptr;
