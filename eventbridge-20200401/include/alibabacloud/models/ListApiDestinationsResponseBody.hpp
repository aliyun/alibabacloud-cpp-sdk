...
namespace Models
{
  ...
  public:
    ...
    inline const ListApiDestinationsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListApiDestinationsResponseBodyData) };
    inline ListApiDestinationsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListApiDestinationsResponseBodyData) };
    inline ListApiDestinationsResponseBody& setData(const ListApiDestinationsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListApiDestinationsResponseBody& setData(ListApiDestinationsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListApiDestinationsResponseBodyData> data_ = nullptr;
