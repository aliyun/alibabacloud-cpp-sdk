...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApiDestinationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateApiDestinationResponseBody) };
    inline CreateApiDestinationResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateApiDestinationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateApiDestinationResponseBody> body_ {};
  };
