...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApiDestinationRequest::HttpApiParameters & getHttpApiParameters() const { DARABONBA_PTR_GET_CONST(httpApiParameters_, CreateApiDestinationRequest::HttpApiParameters) };
    inline CreateApiDestinationRequest::HttpApiParameters getHttpApiParameters() { DARABONBA_PTR_GET(httpApiParameters_, CreateApiDestinationRequest::HttpApiParameters) };
    inline CreateApiDestinationRequest& setHttpApiParameters(const CreateApiDestinationRequest::HttpApiParameters & httpApiParameters) { DARABONBA_PTR_SET_VALUE(httpApiParameters_, httpApiParameters) };
    inline CreateApiDestinationRequest& setHttpApiParameters(CreateApiDestinationRequest::HttpApiParameters && httpApiParameters) { DARABONBA_PTR_SET_RVALUE(httpApiParameters_, httpApiParameters) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<CreateApiDestinationRequest::HttpApiParameters> httpApiParameters_ {};
  };
