...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->breakdowns_ == nullptr
        && return this->calculations_ == nullptr && return this->endTime_ == nullptr && return this->filterCombination_ == nullptr && return this->filters_ == nullptr && return this->granularity_ == nullptr
        && return this->limit_ == nullptr && return this->offset_ == nullptr && return this->orders_ == nullptr && return this->startTime_ == nullptr && return this->timeRange_ == nullptr; };
