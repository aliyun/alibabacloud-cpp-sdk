...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->eventBusName_ == nullptr && this->eventSourceName_ == nullptr && this->externalSourceConfigShrink_ == nullptr && this->externalSourceType_.empty() && this->linkedExternalSource_ == nullptr
    ...
    inline CreateEventSourceShrinkRequest& setSourceOSSEventParametersShrink(string sourceOSSEventParametersShrink) { DARABONBA_PTR_SET_VALUE(sourceOSSEventParametersShrink_, sourceOSSEventParametersShrink) };
