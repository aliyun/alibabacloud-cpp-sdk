...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateRuleResponseBodyData) };
    inline CreateRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateRuleResponseBodyData) };
    inline CreateRuleResponseBody& setData(const CreateRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateRuleResponseBody& setData(CreateRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<CreateRuleResponseBodyData> data_ = nullptr;
