...
#ifndef ALIBABACLOUD_MODELS_GETEVENTSTREAMINGRESPONSEBODYDATARUNOPTIONSBATCHWINDOW_HPP_
#define ALIBABACLOUD_MODELS_GETEVENTSTREAMINGRESPONSEBODYDATARUNOPTIONSBATCHWINDOW_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetEventStreamingResponseBodyDataRunOptionsBatchWindow& obj) { 
      DARABONBA_PTR_TO_JSON(CountBasedWindow, countBasedWindow_);
      DARABONBA_PTR_TO_JSON(TimeBasedWindow, timeBasedWindow_);
    };
    friend void from_json(const Darabonba::Json& j, GetEventStreamingResponseBodyDataRunOptionsBatchWindow& obj) { 
      DARABONBA_PTR_FROM_JSON(CountBasedWindow, countBasedWindow_);
      DARABONBA_PTR_FROM_JSON(TimeBasedWindow, timeBasedWindow_);
    };
    GetEventStreamingResponseBodyDataRunOptionsBatchWindow() = default ;
    GetEventStreamingResponseBodyDataRunOptionsBatchWindow(const GetEventStreamingResponseBodyDataRunOptionsBatchWindow &) = default ;
    GetEventStreamingResponseBodyDataRunOptionsBatchWindow(GetEventStreamingResponseBodyDataRunOptionsBatchWindow &&) = default ;
    GetEventStreamingResponseBodyDataRunOptionsBatchWindow(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetEventStreamingResponseBodyDataRunOptionsBatchWindow() = default ;
    GetEventStreamingResponseBodyDataRunOptionsBatchWindow& operator=(const GetEventStreamingResponseBodyDataRunOptionsBatchWindow &) = default ;
    GetEventStreamingResponseBodyDataRunOptionsBatchWindow& operator=(GetEventStreamingResponseBodyDataRunOptionsBatchWindow &&) = default ;
    ...
    inline GetEventStreamingResponseBodyDataRunOptionsBatchWindow& setCountBasedWindow(int32_t countBasedWindow) { DARABONBA_PTR_SET_VALUE(countBasedWindow_, countBasedWindow) };
    ...
    inline GetEventStreamingResponseBodyDataRunOptionsBatchWindow& setTimeBasedWindow(int32_t timeBasedWindow) { DARABONBA_PTR_SET_VALUE(timeBasedWindow_, timeBasedWindow) };
