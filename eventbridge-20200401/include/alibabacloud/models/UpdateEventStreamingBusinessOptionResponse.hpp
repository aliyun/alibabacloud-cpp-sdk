...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEventStreamingBusinessOptionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEventStreamingBusinessOptionResponseBody) };
    inline UpdateEventStreamingBusinessOptionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEventStreamingBusinessOptionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEventStreamingBusinessOptionResponseBody> body_ {};
  };
