...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEventSourceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateEventSourceResponseBodyData) };
    inline CreateEventSourceResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateEventSourceResponseBodyData) };
    inline CreateEventSourceResponseBody& setData(const CreateEventSourceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateEventSourceResponseBody& setData(CreateEventSourceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<CreateEventSourceResponseBodyData> data_ = nullptr;
