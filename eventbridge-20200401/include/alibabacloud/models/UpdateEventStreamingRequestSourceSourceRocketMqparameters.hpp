...
#ifndef ALIBABACLOUD_MODELS_UPDATEEVENTSTREAMINGREQUESTSOURCESOURCEROCKETMQPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_UPDATEEVENTSTREAMINGREQUESTSOURCESOURCEROCKETMQPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateEventStreamingRequestSourceSourceRocketMQParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateEventStreamingRequestSourceSourceRocketMQParameters& obj) { 
    ...
    UpdateEventStreamingRequestSourceSourceRocketMQParameters() = default ;
    UpdateEventStreamingRequestSourceSourceRocketMQParameters(const UpdateEventStreamingRequestSourceSourceRocketMQParameters &) = default ;
    UpdateEventStreamingRequestSourceSourceRocketMQParameters(UpdateEventStreamingRequestSourceSourceRocketMQParameters &&) = default ;
    UpdateEventStreamingRequestSourceSourceRocketMQParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateEventStreamingRequestSourceSourceRocketMQParameters() = default ;
    UpdateEventStreamingRequestSourceSourceRocketMQParameters& operator=(const UpdateEventStreamingRequestSourceSourceRocketMQParameters &) = default ;
    UpdateEventStreamingRequestSourceSourceRocketMQParameters& operator=(UpdateEventStreamingRequestSourceSourceRocketMQParameters &&) = default ;
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setBodyDataType(string bodyDataType) { DARABONBA_PTR_SET_VALUE(bodyDataType_, bodyDataType) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setFilterSql(string filterSql) { DARABONBA_PTR_SET_VALUE(filterSql_, filterSql) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setFilterType(string filterType) { DARABONBA_PTR_SET_VALUE(filterType_, filterType) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setGroupID(string groupID) { DARABONBA_PTR_SET_VALUE(groupID_, groupID) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setInstanceEndpoint(string instanceEndpoint) { DARABONBA_PTR_SET_VALUE(instanceEndpoint_, instanceEndpoint) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setInstanceNetwork(string instanceNetwork) { DARABONBA_PTR_SET_VALUE(instanceNetwork_, instanceNetwork) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setInstancePassword(string instancePassword) { DARABONBA_PTR_SET_VALUE(instancePassword_, instancePassword) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setInstanceSecurityGroupId(string instanceSecurityGroupId) { DARABONBA_PTR_SET_VALUE(instanceSecurityGroupId_, instanceSecurityGroupId) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setInstanceUsername(string instanceUsername) { DARABONBA_PTR_SET_VALUE(instanceUsername_, instanceUsername) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setInstanceVSwitchIds(string instanceVSwitchIds) { DARABONBA_PTR_SET_VALUE(instanceVSwitchIds_, instanceVSwitchIds) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setInstanceVpcId(string instanceVpcId) { DARABONBA_PTR_SET_VALUE(instanceVpcId_, instanceVpcId) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setNetwork(string network) { DARABONBA_PTR_SET_VALUE(network_, network) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setOffset(string offset) { DARABONBA_PTR_SET_VALUE(offset_, offset) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setSecurityGroupId(string securityGroupId) { DARABONBA_PTR_SET_VALUE(securityGroupId_, securityGroupId) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setTopic(string topic) { DARABONBA_PTR_SET_VALUE(topic_, topic) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setVSwitchIds(string vSwitchIds) { DARABONBA_PTR_SET_VALUE(vSwitchIds_, vSwitchIds) };
    ...
    inline UpdateEventStreamingRequestSourceSourceRocketMQParameters& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
