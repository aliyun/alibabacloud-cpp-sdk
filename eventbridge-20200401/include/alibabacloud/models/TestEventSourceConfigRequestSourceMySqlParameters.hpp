...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowedCIDRs_ == nullptr
        && return this->databaseName_ == nullptr && return this->hostName_ == nullptr && return this->networkType_ == nullptr && return this->password_ == nullptr && return this->port_ == nullptr
        && return this->regionId_ == nullptr && return this->securityGroupId_ == nullptr && return this->tableNames_ == nullptr && return this->user_ == nullptr && return this->vSwitchIds_ == nullptr
    ...
    inline string allowedCIDRs() const { DARABONBA_PTR_GET_DEFAULT(allowedCIDRs_, "") };
    inline TestEventSourceConfigRequestSourceMySQLParameters& setAllowedCIDRs(string allowedCIDRs) { DARABONBA_PTR_SET_VALUE(allowedCIDRs_, allowedCIDRs) };
  ...
  protected:
    std::shared_ptr<string> allowedCIDRs_ = nullptr;
    // The database name.
