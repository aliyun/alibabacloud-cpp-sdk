...
#ifndef ALIBABACLOUD_MODELS_GETEVENTSTREAMINGRESPONSEBODYDATASOURCESOURCEROCKETMQPARAMETERS_HPP_
#define ALIBABACLOUD_MODELS_GETEVENTSTREAMINGRESPONSEBODYDATASOURCESOURCEROCKETMQPARAMETERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& obj) { 
    ...
    GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters() = default ;
    GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters(const GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters &) = default ;
    GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters(GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters &&) = default ;
    GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters() = default ;
    GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& operator=(const GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters &) = default ;
    GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& operator=(GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters &&) = default ;
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setBodyDataType(string bodyDataType) { DARABONBA_PTR_SET_VALUE(bodyDataType_, bodyDataType) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setFilterSql(string filterSql) { DARABONBA_PTR_SET_VALUE(filterSql_, filterSql) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setFilterType(string filterType) { DARABONBA_PTR_SET_VALUE(filterType_, filterType) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setGroupID(string groupID) { DARABONBA_PTR_SET_VALUE(groupID_, groupID) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setInstanceEndpoint(string instanceEndpoint) { DARABONBA_PTR_SET_VALUE(instanceEndpoint_, instanceEndpoint) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setInstanceNetwork(string instanceNetwork) { DARABONBA_PTR_SET_VALUE(instanceNetwork_, instanceNetwork) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setInstancePassword(string instancePassword) { DARABONBA_PTR_SET_VALUE(instancePassword_, instancePassword) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setInstanceSecurityGroupId(string instanceSecurityGroupId) { DARABONBA_PTR_SET_VALUE(instanceSecurityGroupId_, instanceSecurityGroupId) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setInstanceUsername(string instanceUsername) { DARABONBA_PTR_SET_VALUE(instanceUsername_, instanceUsername) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setInstanceVSwitchIds(string instanceVSwitchIds) { DARABONBA_PTR_SET_VALUE(instanceVSwitchIds_, instanceVSwitchIds) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setInstanceVpcId(string instanceVpcId) { DARABONBA_PTR_SET_VALUE(instanceVpcId_, instanceVpcId) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setNetwork(string network) { DARABONBA_PTR_SET_VALUE(network_, network) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setOffset(string offset) { DARABONBA_PTR_SET_VALUE(offset_, offset) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setSecurityGroupId(string securityGroupId) { DARABONBA_PTR_SET_VALUE(securityGroupId_, securityGroupId) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setTag(string tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setTimestamp(int64_t timestamp) { DARABONBA_PTR_SET_VALUE(timestamp_, timestamp) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setTopic(string topic) { DARABONBA_PTR_SET_VALUE(topic_, topic) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setVSwitchIds(string vSwitchIds) { DARABONBA_PTR_SET_VALUE(vSwitchIds_, vSwitchIds) };
    ...
    inline GetEventStreamingResponseBodyDataSourceSourceRocketMQParameters& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
