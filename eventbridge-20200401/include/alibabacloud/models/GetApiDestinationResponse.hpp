...
namespace Models
{
  ...
  public:
    ...
    inline const GetApiDestinationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetApiDestinationResponseBody) };
    inline GetApiDestinationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetApiDestinationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetApiDestinationResponseBody> body_ {};
  };
