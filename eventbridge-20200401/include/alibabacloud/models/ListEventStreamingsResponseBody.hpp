...
#ifndef ALIBABACLOUD_MODELS_LISTEVENTSTREAMINGSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTEVENTSTREAMINGSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListEventStreamingsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListEventStreamingsResponseBody& obj) { 
    ...
    ListEventStreamingsResponseBody() = default ;
    ListEventStreamingsResponseBody(const ListEventStreamingsResponseBody &) = default ;
    ListEventStreamingsResponseBody(ListEventStreamingsResponseBody &&) = default ;
    ListEventStreamingsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListEventStreamingsResponseBody() = default ;
    ListEventStreamingsResponseBody& operator=(const ListEventStreamingsResponseBody &) = default ;
    ListEventStreamingsResponseBody& operator=(ListEventStreamingsResponseBody &&) = default ;
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      class EventStreamings : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const EventStreamings& obj) { 
        ...
        friend void from_json(const Darabonba::Json& j, EventStreamings& obj) { 
        ...
        EventStreamings() = default ;
        EventStreamings(const EventStreamings &) = default ;
        EventStreamings(EventStreamings &&) = default ;
        EventStreamings(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~EventStreamings() = default ;
        EventStreamings& operator=(const EventStreamings &) = default ;
        EventStreamings& operator=(EventStreamings &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        && this->sourcePostgreSQLParameters_ == nullptr && this->sourcePrometheusParameters_ == nullptr && this->sourceRabbitMQMetaParameters_ == nullptr && this->sourceRabbitMQMsgSyncParameters_ == nullptr && this->sourceRabbitMQParameters_ == nullptr
        && this->sourceRocketMQCheckpointParameters_ == nullptr && this->sourceRocketMQParameters_ == nullptr && this->sourceSLSParameters_ == nullptr; };
        ...
        && this->compressionType_ == nullptr && this->instanceId_ == nullptr && this->key_ == nullptr && this->topic_ == nullptr && this->value_ == nullptr; };
        ...
        && this->sinkApiDestinationParameters_ == nullptr && this->sinkBaiLianParameters_ == nullptr && this->sinkCustomizedKafkaConnectorParameters_ == nullptr && this->sinkCustomizedKafkaParameters_ == nullptr && this->sinkDashVectorParameters_ == nullptr
        && this->sinkDataHubParameters_ == nullptr && this->sinkDorisParameters_ == nullptr && this->sinkEventHouseParameters_ == nullptr && this->sinkFcParameters_ == nullptr && this->sinkFnfParameters_ == nullptr
        && this->sinkHttpsParameters_ == nullptr && this->sinkKafkaParameters_ == nullptr && this->sinkMNSParameters_ == nullptr && this->sinkMQTTParameters_ == nullptr && this->sinkOSSParameters_ == nullptr
        && this->sinkOpenSourceRabbitMQParameters_ == nullptr && this->sinkRabbitMQMetaParameters_ == nullptr && this->sinkRabbitMQMsgSyncParameters_ == nullptr && this->sinkRabbitMQParameters_ == nullptr && this->sinkRocketMQCheckpointParameters_ == nullptr
        ...
        inline EventStreamings& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
        ...
        inline EventStreamings& setEventStreamingName(string eventStreamingName) { DARABONBA_PTR_SET_VALUE(eventStreamingName_, eventStreamingName) };
        ...
        inline EventStreamings& setFilterPattern(string filterPattern) { DARABONBA_PTR_SET_VALUE(filterPattern_, filterPattern) };
        ...
        inline const EventStreamings::RunOptions & getRunOptions() const { DARABONBA_PTR_GET_CONST(runOptions_, EventStreamings::RunOptions) };
        inline EventStreamings::RunOptions getRunOptions() { DARABONBA_PTR_GET(runOptions_, EventStreamings::RunOptions) };
        inline EventStreamings& setRunOptions(const EventStreamings::RunOptions & runOptions) { DARABONBA_PTR_SET_VALUE(runOptions_, runOptions) };
        inline EventStreamings& setRunOptions(EventStreamings::RunOptions && runOptions) { DARABONBA_PTR_SET_RVALUE(runOptions_, runOptions) };


        // sink Field Functions 
        bool hasSink() const { return this->sink_ != nullptr;};
        void deleteSink() { this->sink_ = nullptr;};
        inline const EventStreamings::Sink & getSink() const { DARABONBA_PTR_GET_CONST(sink_, EventStreamings::Sink) };
        inline EventStreamings::Sink getSink() { DARABONBA_PTR_GET(sink_, EventStreamings::Sink) };
        inline EventStreamings& setSink(const EventStreamings::Sink & sink) { DARABONBA_PTR_SET_VALUE(sink_, sink) };
        inline EventStreamings& setSink(EventStreamings::Sink && sink) { DARABONBA_PTR_SET_RVALUE(sink_, sink) };


        // source Field Functions 
        bool hasSource() const { return this->source_ != nullptr;};
        void deleteSource() { this->source_ = nullptr;};
        inline const EventStreamings::Source & getSource() const { DARABONBA_PTR_GET_CONST(source_, EventStreamings::Source) };
        inline EventStreamings::Source getSource() { DARABONBA_PTR_GET(source_, EventStreamings::Source) };
        inline EventStreamings& setSource(const EventStreamings::Source & source) { DARABONBA_PTR_SET_VALUE(source_, source) };
        inline EventStreamings& setSource(EventStreamings::Source && source) { DARABONBA_PTR_SET_RVALUE(source_, source) };
        ...
        inline EventStreamings& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
        ...
        inline const vector<EventStreamings::Transforms> & getTransforms() const { DARABONBA_PTR_GET_CONST(transforms_, vector<EventStreamings::Transforms>) };
        inline vector<EventStreamings::Transforms> getTransforms() { DARABONBA_PTR_GET(transforms_, vector<EventStreamings::Transforms>) };
        inline EventStreamings& setTransforms(const vector<EventStreamings::Transforms> & transforms) { DARABONBA_PTR_SET_VALUE(transforms_, transforms) };
        inline EventStreamings& setTransforms(vector<EventStreamings::Transforms> && transforms) { DARABONBA_PTR_SET_RVALUE(transforms_, transforms) };
      ...
      protected:
        ...
        shared_ptr<EventStreamings::RunOptions> runOptions_ {};
        // The event target.
        shared_ptr<EventStreamings::Sink> sink_ {};
        // The event provider, which is also known as the event source.
        shared_ptr<EventStreamings::Source> source_ {};
        // The status of the event stream that is returned.
        shared_ptr<string> status_ {};
        // The transformation-related configurations.
        shared_ptr<vector<EventStreamings::Transforms>> transforms_ {};
      };
      ...
      inline const vector<Data::EventStreamings> & getEventStreamings() const { DARABONBA_PTR_GET_CONST(eventStreamings_, vector<Data::EventStreamings>) };
      inline vector<Data::EventStreamings> getEventStreamings() { DARABONBA_PTR_GET(eventStreamings_, vector<Data::EventStreamings>) };
      inline Data& setEventStreamings(const vector<Data::EventStreamings> & eventStreamings) { DARABONBA_PTR_SET_VALUE(eventStreamings_, eventStreamings) };
      inline Data& setEventStreamings(vector<Data::EventStreamings> && eventStreamings) { DARABONBA_PTR_SET_RVALUE(eventStreamings_, eventStreamings) };
    ...
    protected:
      // The event streams.
      shared_ptr<vector<Data::EventStreamings>> eventStreamings_ {};
    ...
    inline ListEventStreamingsResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListEventStreamingsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListEventStreamingsResponseBody::Data) };
    inline ListEventStreamingsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListEventStreamingsResponseBody::Data) };
    inline ListEventStreamingsResponseBody& setData(const ListEventStreamingsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEventStreamingsResponseBody& setData(ListEventStreamingsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListEventStreamingsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListEventStreamingsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListEventStreamingsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // The returned data.
    shared_ptr<ListEventStreamingsResponseBody::Data> data_ {};
