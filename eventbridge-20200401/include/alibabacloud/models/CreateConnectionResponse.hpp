...
namespace Models
{
  ...
  public:
    ...
    inline const CreateConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateConnectionResponseBody) };
    inline CreateConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateConnectionResponseBody> body_ {};
  };
