...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryTracedEventByEventIdResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryTracedEventByEventIdResponseBodyData>) };
    inline vector<QueryTracedEventByEventIdResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryTracedEventByEventIdResponseBodyData>) };
    inline QueryTracedEventByEventIdResponseBody& setData(const vector<QueryTracedEventByEventIdResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryTracedEventByEventIdResponseBody& setData(vector<QueryTracedEventByEventIdResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryTracedEventByEventIdResponseBodyData>> data_ = nullptr;
