...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authType_ == nullptr
        && return this->body_ == nullptr && return this->endpoint_ == nullptr && return this->exchange_ == nullptr && return this->messageId_ == nullptr && return this->networkType_ == nullptr
        && return this->password_ == nullptr && return this->properties_ == nullptr && return this->queueName_ == nullptr && return this->routingKey_ == nullptr && return this->securityGroupId_ == nullptr
        && return this->targetType_ == nullptr && return this->username_ == nullptr && return this->vSwitchIds_ == nullptr && return this->virtualHostName_ == nullptr && return this->vpcId_ == nullptr; };
