...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTracedEventsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryTracedEventsResponseBodyData) };
    inline QueryTracedEventsResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryTracedEventsResponseBodyData) };
    inline QueryTracedEventsResponseBody& setData(const QueryTracedEventsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryTracedEventsResponseBody& setData(QueryTracedEventsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<QueryTracedEventsResponseBodyData> data_ = nullptr;
