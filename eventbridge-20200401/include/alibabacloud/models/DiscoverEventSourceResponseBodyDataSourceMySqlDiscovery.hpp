...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->databaseNames_ == nullptr
        && return this->estimatedRows_ == nullptr && return this->expireLogsDays_ == nullptr && return this->simpleData_ == nullptr && return this->tableNames_ == nullptr && return this->tableSchema_ == nullptr
        && return this->waitTimeout_ == nullptr; };
