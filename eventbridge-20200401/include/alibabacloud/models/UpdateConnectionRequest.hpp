...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateConnectionRequest::AuthParameters & getAuthParameters() const { DARABONBA_PTR_GET_CONST(authParameters_, UpdateConnectionRequest::AuthParameters) };
    inline UpdateConnectionRequest::AuthParameters getAuthParameters() { DARABONBA_PTR_GET(authParameters_, UpdateConnectionRequest::AuthParameters) };
    inline UpdateConnectionRequest& setAuthParameters(const UpdateConnectionRequest::AuthParameters & authParameters) { DARABONBA_PTR_SET_VALUE(authParameters_, authParameters) };
    inline UpdateConnectionRequest& setAuthParameters(UpdateConnectionRequest::AuthParameters && authParameters) { DARABONBA_PTR_SET_RVALUE(authParameters_, authParameters) };
    ...
    inline const UpdateConnectionRequest::NetworkParameters & getNetworkParameters() const { DARABONBA_PTR_GET_CONST(networkParameters_, UpdateConnectionRequest::NetworkParameters) };
    inline UpdateConnectionRequest::NetworkParameters getNetworkParameters() { DARABONBA_PTR_GET(networkParameters_, UpdateConnectionRequest::NetworkParameters) };
    inline UpdateConnectionRequest& setNetworkParameters(const UpdateConnectionRequest::NetworkParameters & networkParameters) { DARABONBA_PTR_SET_VALUE(networkParameters_, networkParameters) };
    inline UpdateConnectionRequest& setNetworkParameters(UpdateConnectionRequest::NetworkParameters && networkParameters) { DARABONBA_PTR_SET_RVALUE(networkParameters_, networkParameters) };


  protected:
    // The parameters that are configured for authentication.
    shared_ptr<UpdateConnectionRequest::AuthParameters> authParameters_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<UpdateConnectionRequest::NetworkParameters> networkParameters_ {};
  };
