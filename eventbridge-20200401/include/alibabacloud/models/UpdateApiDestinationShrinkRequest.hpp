...
#ifndef ALIBABACLOUD_MODELS_UPDATEAPIDESTINATIONSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEAPIDESTINATIONSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateApiDestinationShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateApiDestinationShrinkRequest& obj) { 
    ...
    UpdateApiDestinationShrinkRequest() = default ;
    UpdateApiDestinationShrinkRequest(const UpdateApiDestinationShrinkRequest &) = default ;
    UpdateApiDestinationShrinkRequest(UpdateApiDestinationShrinkRequest &&) = default ;
    UpdateApiDestinationShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateApiDestinationShrinkRequest() = default ;
    UpdateApiDestinationShrinkRequest& operator=(const UpdateApiDestinationShrinkRequest &) = default ;
    UpdateApiDestinationShrinkRequest& operator=(UpdateApiDestinationShrinkRequest &&) = default ;
    ...
    inline UpdateApiDestinationShrinkRequest& setApiDestinationName(string apiDestinationName) { DARABONBA_PTR_SET_VALUE(apiDestinationName_, apiDestinationName) };
    ...
    inline UpdateApiDestinationShrinkRequest& setConnectionName(string connectionName) { DARABONBA_PTR_SET_VALUE(connectionName_, connectionName) };
    ...
    inline UpdateApiDestinationShrinkRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateApiDestinationShrinkRequest& setHttpApiParametersShrink(string httpApiParametersShrink) { DARABONBA_PTR_SET_VALUE(httpApiParametersShrink_, httpApiParametersShrink) };
