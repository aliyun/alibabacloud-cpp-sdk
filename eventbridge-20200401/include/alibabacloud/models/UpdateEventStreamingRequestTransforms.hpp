...
namespace Models
{
  ...
  public:
    ...
    inline UpdateEventStreamingRequestTransforms& setBaiLianAgentTransformParameters(const Models::BaiLianAgentTransformParameters & baiLianAgentTransformParameters) { DARABONBA_PTR_SET_VALUE(baiLianAgentTransformParameters_, baiLianAgentTransformParameters) };
    inline UpdateEventStreamingRequestTransforms& setBaiLianAgentTransformParameters(Models::BaiLianAgentTransformParameters && baiLianAgentTransformParameters) { DARABONBA_PTR_SET_RVALUE(baiLianAgentTransformParameters_, baiLianAgentTransformParameters) };
    ...
    inline UpdateEventStreamingRequestTransforms& setDashScopeTransformParameters(const Models::DashScopeTransformParameters & dashScopeTransformParameters) { DARABONBA_PTR_SET_VALUE(dashScopeTransformParameters_, dashScopeTransformParameters) };
    inline UpdateEventStreamingRequestTransforms& setDashScopeTransformParameters(Models::DashScopeTransformParameters && dashScopeTransformParameters) { DARABONBA_PTR_SET_RVALUE(dashScopeTransformParameters_, dashScopeTransformParameters) };
