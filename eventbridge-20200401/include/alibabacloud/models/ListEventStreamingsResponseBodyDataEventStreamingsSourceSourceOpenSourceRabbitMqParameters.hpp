...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authType_ == nullptr
        && return this->bodyDataType_ == nullptr && return this->endpoint_ == nullptr && return this->networkType_ == nullptr && return this->password_ == nullptr && return this->queueName_ == nullptr
        && return this->securityGroupId_ == nullptr && return this->username_ == nullptr && return this->vSwitchIds_ == nullptr && return this->virtualHostName_ == nullptr && return this->vpcId_ == nullptr; };
