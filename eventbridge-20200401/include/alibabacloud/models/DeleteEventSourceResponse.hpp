...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEventSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteEventSourceResponseBody) };
    inline DeleteEventSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteEventSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteEventSourceResponseBody> body_ {};
  };
