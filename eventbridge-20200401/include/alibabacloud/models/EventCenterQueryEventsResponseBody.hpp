...
namespace Models
{
  ...
  public:
    ...
    inline const EventCenterQueryEventsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, EventCenterQueryEventsResponseBodyData) };
    inline EventCenterQueryEventsResponseBodyData data() { DARABONBA_PTR_GET(data_, EventCenterQueryEventsResponseBodyData) };
    inline EventCenterQueryEventsResponseBody& setData(const EventCenterQueryEventsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline EventCenterQueryEventsResponseBody& setData(EventCenterQueryEventsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<EventCenterQueryEventsResponseBodyData> data_ = nullptr;
