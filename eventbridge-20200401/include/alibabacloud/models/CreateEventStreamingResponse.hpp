...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEventStreamingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateEventStreamingResponseBody) };
    inline CreateEventStreamingResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateEventStreamingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateEventStreamingResponseBody> body_ {};
  };
