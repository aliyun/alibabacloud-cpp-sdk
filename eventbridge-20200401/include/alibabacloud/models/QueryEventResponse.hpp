...
namespace Models
{
  ...
  public:
    ...
    inline const QueryEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryEventResponseBody) };
    inline QueryEventResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryEventResponseBody> body_ {};
  };
