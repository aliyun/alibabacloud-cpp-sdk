...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTargetsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeleteTargetsResponseBodyData) };
    inline DeleteTargetsResponseBodyData data() { DARABONBA_PTR_GET(data_, DeleteTargetsResponseBodyData) };
    inline DeleteTargetsResponseBody& setData(const DeleteTargetsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteTargetsResponseBody& setData(DeleteTargetsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DeleteTargetsResponseBodyData> data_ = nullptr;
