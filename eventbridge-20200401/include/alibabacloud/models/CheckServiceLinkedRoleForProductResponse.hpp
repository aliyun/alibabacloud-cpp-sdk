...
namespace Models
{
  ...
  public:
    ...
    inline const CheckServiceLinkedRoleForProductResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckServiceLinkedRoleForProductResponseBody) };
    inline CheckServiceLinkedRoleForProductResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckServiceLinkedRoleForProductResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckServiceLinkedRoleForProductResponseBody> body_ {};
  };
