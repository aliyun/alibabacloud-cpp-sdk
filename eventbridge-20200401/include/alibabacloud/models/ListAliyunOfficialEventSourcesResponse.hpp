...
namespace Models
{
  ...
  public:
    ...
    inline const ListAliyunOfficialEventSourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAliyunOfficialEventSourcesResponseBody) };
    inline ListAliyunOfficialEventSourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAliyunOfficialEventSourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAliyunOfficialEventSourcesResponseBody> body_ {};
  };
