...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteConnectionResponseBody) };
    inline DeleteConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteConnectionResponseBody> body_ {};
  };
