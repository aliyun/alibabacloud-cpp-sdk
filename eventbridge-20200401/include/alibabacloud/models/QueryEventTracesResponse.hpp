...
namespace Models
{
  ...
  public:
    ...
    inline const QueryEventTracesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryEventTracesResponseBody) };
    inline QueryEventTracesResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryEventTracesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryEventTracesResponseBody> body_ {};
  };
