...
#ifndef ALIBABACLOUD_MODELS_UPDATEEVENTSTREAMINGREQUESTRUNOPTIONSBATCHWINDOW_HPP_
#define ALIBABACLOUD_MODELS_UPDATEEVENTSTREAMINGREQUESTRUNOPTIONSBATCHWINDOW_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateEventStreamingRequestRunOptionsBatchWindow& obj) { 
      DARABONBA_PTR_TO_JSON(CountBasedWindow, countBasedWindow_);
      DARABONBA_PTR_TO_JSON(TimeBasedWindow, timeBasedWindow_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateEventStreamingRequestRunOptionsBatchWindow& obj) { 
      DARABONBA_PTR_FROM_JSON(CountBasedWindow, countBasedWindow_);
      DARABONBA_PTR_FROM_JSON(TimeBasedWindow, timeBasedWindow_);
    };
    UpdateEventStreamingRequestRunOptionsBatchWindow() = default ;
    UpdateEventStreamingRequestRunOptionsBatchWindow(const UpdateEventStreamingRequestRunOptionsBatchWindow &) = default ;
    UpdateEventStreamingRequestRunOptionsBatchWindow(UpdateEventStreamingRequestRunOptionsBatchWindow &&) = default ;
    UpdateEventStreamingRequestRunOptionsBatchWindow(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateEventStreamingRequestRunOptionsBatchWindow() = default ;
    UpdateEventStreamingRequestRunOptionsBatchWindow& operator=(const UpdateEventStreamingRequestRunOptionsBatchWindow &) = default ;
    UpdateEventStreamingRequestRunOptionsBatchWindow& operator=(UpdateEventStreamingRequestRunOptionsBatchWindow &&) = default ;
    ...
    inline UpdateEventStreamingRequestRunOptionsBatchWindow& setCountBasedWindow(int32_t countBasedWindow) { DARABONBA_PTR_SET_VALUE(countBasedWindow_, countBasedWindow) };
    ...
    inline UpdateEventStreamingRequestRunOptionsBatchWindow& setTimeBasedWindow(int32_t timeBasedWindow) { DARABONBA_PTR_SET_VALUE(timeBasedWindow_, timeBasedWindow) };
