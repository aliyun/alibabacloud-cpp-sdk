...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bizId_ == nullptr
        && this->purchaseCurrency_ == nullptr && this->purchasePrice_ == nullptr && this->purchaseProofs_ == nullptr; };
    ...
    inline string getPurchaseCurrency() const { DARABONBA_PTR_GET_DEFAULT(purchaseCurrency_, "") };
    ...
    inline double getPurchasePrice() const { DARABONBA_PTR_GET_DEFAULT(purchasePrice_, 0.0) };
    ...
    inline const vector<string> & getPurchaseProofs() const { DARABONBA_PTR_GET_CONST(purchaseProofs_, vector<string>) };
    inline vector<string> getPurchaseProofs() { DARABONBA_PTR_GET(purchaseProofs_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<string> purchaseCurrency_ {};
    shared_ptr<double> purchasePrice_ {};
    shared_ptr<vector<string>> purchaseProofs_ {};
  };
