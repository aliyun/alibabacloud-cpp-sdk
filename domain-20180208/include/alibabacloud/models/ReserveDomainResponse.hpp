...
namespace Models
{
  ...
  public:
    ...
    inline const ReserveDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReserveDomainResponseBody) };
    inline ReserveDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, ReserveDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReserveDomainResponseBody> body_ {};
  };
