...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->auctionEndTime_ == nullptr
        ...
        && this->produceStatus_ == nullptr && this->requestId_ == nullptr && this->reserveMet_ == nullptr && this->reservePrice_ == nullptr && this->status_ == nullptr
        && this->transferInPrice_ == nullptr && this->yourCurrentBid_ == nullptr && this->yourMaxBid_ == nullptr; };
