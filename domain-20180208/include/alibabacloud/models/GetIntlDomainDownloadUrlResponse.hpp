...
namespace Models
{
  ...
  public:
    ...
    inline const GetIntlDomainDownloadUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetIntlDomainDownloadUrlResponseBody) };
    inline GetIntlDomainDownloadUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, GetIntlDomainDownloadUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetIntlDomainDownloadUrlResponseBody> body_ {};
  };
