...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryAuctionsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryAuctionsResponseBodyData>) };
    inline vector<QueryAuctionsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryAuctionsResponseBodyData>) };
    inline QueryAuctionsResponseBody& setData(const vector<QueryAuctionsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryAuctionsResponseBody& setData(vector<QueryAuctionsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryAuctionsResponseBodyData>> data_ = nullptr;
