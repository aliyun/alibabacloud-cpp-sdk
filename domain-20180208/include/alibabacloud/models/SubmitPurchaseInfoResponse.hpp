...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitPurchaseInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitPurchaseInfoResponseBody) };
    inline SubmitPurchaseInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitPurchaseInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitPurchaseInfoResponseBody> body_ {};
  };
