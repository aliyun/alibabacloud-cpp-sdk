...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bizIdList_ == nullptr
        && this->domainNameList_ == nullptr && this->endDate_ == nullptr && this->endPrice_ == nullptr && this->pageNum_ == nullptr && this->pageSize_ == nullptr
        && this->sorter_ == nullptr && this->startDate_ == nullptr && this->startPrice_ == nullptr && this->statusList_ == nullptr && this->suffixList_ == nullptr
        && this->tradeTypeList_ == nullptr; };
    ...
    inline const vector<string> & getBizIdList() const { DARABONBA_PTR_GET_CONST(bizIdList_, vector<string>) };
    inline vector<string> getBizIdList() { DARABONBA_PTR_GET(bizIdList_, vector<string>) };
    ...
    inline const vector<string> & getTradeTypeList() const { DARABONBA_PTR_GET_CONST(tradeTypeList_, vector<string>) };
    inline vector<string> getTradeTypeList() { DARABONBA_PTR_GET(tradeTypeList_, vector<string>) };
  ...
  protected:
    shared_ptr<vector<string>> bizIdList_ {};
    ...
    shared_ptr<vector<string>> tradeTypeList_ {};
  };
