...
namespace Models
{
  ...
  public:
    ...
    inline const CheckDomainStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckDomainStatusResponseBody) };
    inline CheckDomainStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckDomainStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckDomainStatusResponseBody> body_ {};
  };
