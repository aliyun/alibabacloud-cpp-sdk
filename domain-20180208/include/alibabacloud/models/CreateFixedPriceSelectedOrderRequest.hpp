...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && this->contactId_ == nullptr && this->domainName_ == nullptr && this->expectedPrice_ == nullptr && this->source_ == nullptr; };
    ...
    inline double getExpectedPrice() const { DARABONBA_PTR_GET_DEFAULT(expectedPrice_, 0.0) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<double> expectedPrice_ {};
