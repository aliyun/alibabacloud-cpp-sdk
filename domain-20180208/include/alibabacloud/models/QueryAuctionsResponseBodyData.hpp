...
#ifndef ALIBABACLOUD_MODELS_QUERYAUCTIONSRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_QUERYAUCTIONSRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryAuctionsResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryAuctionsResponseBodyData& obj) { 
    ...
    QueryAuctionsResponseBodyData() = default ;
    QueryAuctionsResponseBodyData(const QueryAuctionsResponseBodyData &) = default ;
    QueryAuctionsResponseBodyData(QueryAuctionsResponseBodyData &&) = default ;
    QueryAuctionsResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryAuctionsResponseBodyData() = default ;
    QueryAuctionsResponseBodyData& operator=(const QueryAuctionsResponseBodyData &) = default ;
    QueryAuctionsResponseBodyData& operator=(QueryAuctionsResponseBodyData &&) = default ;
    ...
    virtual bool empty() const override { return this->auctionEndTime_ == nullptr
        ...
        && return this->produceStatus_ == nullptr && return this->reserveMax_ == nullptr && return this->reserveMet_ == nullptr && return this->reserveMin_ == nullptr && return this->reservePrice_ == nullptr
        && return this->status_ == nullptr && return this->transferInPrice_ == nullptr && return this->yourCurrentBid_ == nullptr && return this->yourMaxBid_ == nullptr; };
    ...
    inline QueryAuctionsResponseBodyData& setAuctionEndTime(int64_t auctionEndTime) { DARABONBA_PTR_SET_VALUE(auctionEndTime_, auctionEndTime) };
    ...
    inline QueryAuctionsResponseBodyData& setAuctionId(string auctionId) { DARABONBA_PTR_SET_VALUE(auctionId_, auctionId) };
    ...
    inline QueryAuctionsResponseBodyData& setBookEndTime(int64_t bookEndTime) { DARABONBA_PTR_SET_VALUE(bookEndTime_, bookEndTime) };
    ...
    inline QueryAuctionsResponseBodyData& setBookedPartner(string bookedPartner) { DARABONBA_PTR_SET_VALUE(bookedPartner_, bookedPartner) };
    ...
    inline QueryAuctionsResponseBodyData& setCurrency(string currency) { DARABONBA_PTR_SET_VALUE(currency_, currency) };
    ...
    inline QueryAuctionsResponseBodyData& setDeliveryTime(int64_t deliveryTime) { DARABONBA_PTR_SET_VALUE(deliveryTime_, deliveryTime) };
    ...
    inline QueryAuctionsResponseBodyData& setDomainName(string domainName) { DARABONBA_PTR_SET_VALUE(domainName_, domainName) };
    ...
    inline QueryAuctionsResponseBodyData& setDomainType(string domainType) { DARABONBA_PTR_SET_VALUE(domainType_, domainType) };
    ...
    inline QueryAuctionsResponseBodyData& setFailCode(string failCode) { DARABONBA_PTR_SET_VALUE(failCode_, failCode) };
    ...
    inline QueryAuctionsResponseBodyData& setHighBid(float highBid) { DARABONBA_PTR_SET_VALUE(highBid_, highBid) };
    ...
    inline QueryAuctionsResponseBodyData& setHighBidder(string highBidder) { DARABONBA_PTR_SET_VALUE(highBidder_, highBidder) };
    ...
    inline QueryAuctionsResponseBodyData& setNextValidBid(float nextValidBid) { DARABONBA_PTR_SET_VALUE(nextValidBid_, nextValidBid) };
    ...
    inline QueryAuctionsResponseBodyData& setPartnerType(string partnerType) { DARABONBA_PTR_SET_VALUE(partnerType_, partnerType) };
    ...
    inline QueryAuctionsResponseBodyData& setPayEndTime(int64_t payEndTime) { DARABONBA_PTR_SET_VALUE(payEndTime_, payEndTime) };
    ...
    inline QueryAuctionsResponseBodyData& setPayPrice(float payPrice) { DARABONBA_PTR_SET_VALUE(payPrice_, payPrice) };
    ...
    inline QueryAuctionsResponseBodyData& setPayStatus(string payStatus) { DARABONBA_PTR_SET_VALUE(payStatus_, payStatus) };
    ...
    inline QueryAuctionsResponseBodyData& setProduceStatus(string produceStatus) { DARABONBA_PTR_SET_VALUE(produceStatus_, produceStatus) };
    ...
    inline int64_t reserveMax() const { DARABONBA_PTR_GET_DEFAULT(reserveMax_, 0L) };
    inline QueryAuctionsResponseBodyData& setReserveMax(int64_t reserveMax) { DARABONBA_PTR_SET_VALUE(reserveMax_, reserveMax) };
    ...
    inline QueryAuctionsResponseBodyData& setReserveMet(bool reserveMet) { DARABONBA_PTR_SET_VALUE(reserveMet_, reserveMet) };
    ...
    inline int64_t reserveMin() const { DARABONBA_PTR_GET_DEFAULT(reserveMin_, 0L) };
    inline QueryAuctionsResponseBodyData& setReserveMin(int64_t reserveMin) { DARABONBA_PTR_SET_VALUE(reserveMin_, reserveMin) };
    ...
    inline int64_t reservePrice() const { DARABONBA_PTR_GET_DEFAULT(reservePrice_, 0L) };
    inline QueryAuctionsResponseBodyData& setReservePrice(int64_t reservePrice) { DARABONBA_PTR_SET_VALUE(reservePrice_, reservePrice) };
    ...
    inline QueryAuctionsResponseBodyData& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline QueryAuctionsResponseBodyData& setTransferInPrice(float transferInPrice) { DARABONBA_PTR_SET_VALUE(transferInPrice_, transferInPrice) };
    ...
    inline QueryAuctionsResponseBodyData& setYourCurrentBid(float yourCurrentBid) { DARABONBA_PTR_SET_VALUE(yourCurrentBid_, yourCurrentBid) };
    ...
    inline QueryAuctionsResponseBodyData& setYourMaxBid(float yourMaxBid) { DARABONBA_PTR_SET_VALUE(yourMaxBid_, yourMaxBid) };
  ...
  protected:
    ...
    std::shared_ptr<int64_t> reserveMax_ = nullptr;
    std::shared_ptr<bool> reserveMet_ = nullptr;
    std::shared_ptr<int64_t> reserveMin_ = nullptr;
    std::shared_ptr<int64_t> reservePrice_ = nullptr;
