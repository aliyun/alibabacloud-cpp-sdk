...
namespace Models
{
  ...
  public:
    ...
    inline const BatchRecallPushResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, BatchRecallPushResponseBodyModule) };
    inline BatchRecallPushResponseBodyModule module() { DARABONBA_PTR_GET(module_, BatchRecallPushResponseBodyModule) };
    inline BatchRecallPushResponseBody& setModule(const BatchRecallPushResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline BatchRecallPushResponseBody& setModule(BatchRecallPushResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<BatchRecallPushResponseBodyModule> module_ = nullptr;
