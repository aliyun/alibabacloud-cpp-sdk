...
namespace Models
{
  ...
  public:
    ...
    inline const RequestPayDemandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RequestPayDemandResponseBody) };
    inline RequestPayDemandResponseBody getBody() { DARABONBA_PTR_GET(body_, RequestPayDemandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RequestPayDemandResponseBody> body_ {};
  };
