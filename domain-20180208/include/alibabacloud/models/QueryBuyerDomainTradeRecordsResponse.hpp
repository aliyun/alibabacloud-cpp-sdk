...
namespace Models
{
  ...
  public:
    ...
    inline const QueryBuyerDomainTradeRecordsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryBuyerDomainTradeRecordsResponseBody) };
    inline QueryBuyerDomainTradeRecordsResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryBuyerDomainTradeRecordsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryBuyerDomainTradeRecordsResponseBody> body_ {};
  };
