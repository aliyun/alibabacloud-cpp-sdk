...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryBrokerDemandResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryBrokerDemandResponseBodyData>) };
    inline vector<QueryBrokerDemandResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryBrokerDemandResponseBodyData>) };
    inline QueryBrokerDemandResponseBody& setData(const vector<QueryBrokerDemandResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryBrokerDemandResponseBody& setData(vector<QueryBrokerDemandResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryBrokerDemandResponseBodyData>> data_ = nullptr;
