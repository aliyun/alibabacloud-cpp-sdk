...
namespace Models
{
  ...
  public:
    ...
    inline const SelectedDomainListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SelectedDomainListResponseBody) };
    inline SelectedDomainListResponseBody getBody() { DARABONBA_PTR_GET(body_, SelectedDomainListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SelectedDomainListResponseBody> body_ {};
  };
