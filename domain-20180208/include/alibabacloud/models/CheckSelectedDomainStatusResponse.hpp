...
namespace Models
{
  ...
  public:
    ...
    inline const CheckSelectedDomainStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckSelectedDomainStatusResponseBody) };
    inline CheckSelectedDomainStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckSelectedDomainStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckSelectedDomainStatusResponseBody> body_ {};
  };
