...
namespace Models
{
  ...
  public:
    ...
    inline const WebsiteAddDnsRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, WebsiteAddDnsRecordResponseBody) };
    inline WebsiteAddDnsRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, WebsiteAddDnsRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<WebsiteAddDnsRecordResponseBody> body_ {};
  };
