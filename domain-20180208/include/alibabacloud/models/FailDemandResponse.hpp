...
namespace Models
{
  ...
  public:
    ...
    inline const FailDemandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FailDemandResponseBody) };
    inline FailDemandResponseBody getBody() { DARABONBA_PTR_GET(body_, FailDemandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FailDemandResponseBody> body_ {};
  };
