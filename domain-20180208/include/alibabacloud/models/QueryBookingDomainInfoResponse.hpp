...
namespace Models
{
  ...
  public:
    ...
    inline const QueryBookingDomainInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryBookingDomainInfoResponseBody) };
    inline QueryBookingDomainInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryBookingDomainInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryBookingDomainInfoResponseBody> body_ {};
  };
