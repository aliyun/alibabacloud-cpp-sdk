...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->auctionId_ == nullptr
        && this->bookEndTime_ == nullptr && this->currency_ == nullptr && this->maxBid_ == nullptr && this->partnerType_ == nullptr && this->requestId_ == nullptr
        && this->snatchNo_ == nullptr && this->transferInPrice_ == nullptr; };
    ...
    inline int32_t getAuctionId() const { DARABONBA_PTR_GET_DEFAULT(auctionId_, 0) };
