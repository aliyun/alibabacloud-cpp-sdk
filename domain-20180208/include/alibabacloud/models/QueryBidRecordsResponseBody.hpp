...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryBidRecordsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryBidRecordsResponseBodyData>) };
    inline vector<QueryBidRecordsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryBidRecordsResponseBodyData>) };
    inline QueryBidRecordsResponseBody& setData(const vector<QueryBidRecordsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryBidRecordsResponseBody& setData(vector<QueryBidRecordsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryBidRecordsResponseBodyData>> data_ = nullptr;
