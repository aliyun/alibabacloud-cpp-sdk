...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPurchasedDomainsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryPurchasedDomainsResponseBody) };
    inline QueryPurchasedDomainsResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryPurchasedDomainsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryPurchasedDomainsResponseBody> body_ {};
  };
