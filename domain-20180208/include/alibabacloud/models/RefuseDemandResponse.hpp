...
namespace Models
{
  ...
  public:
    ...
    inline const RefuseDemandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RefuseDemandResponseBody) };
    inline RefuseDemandResponseBody getBody() { DARABONBA_PTR_GET(body_, RefuseDemandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RefuseDemandResponseBody> body_ {};
  };
