...
namespace Models
{
  ...
  public:
    ...
    inline const RecordDemandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RecordDemandResponseBody) };
    inline RecordDemandResponseBody getBody() { DARABONBA_PTR_GET(body_, RecordDemandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RecordDemandResponseBody> body_ {};
  };
