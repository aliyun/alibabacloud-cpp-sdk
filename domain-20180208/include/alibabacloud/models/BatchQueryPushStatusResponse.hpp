...
namespace Models
{
  ...
  public:
    ...
    inline const BatchQueryPushStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchQueryPushStatusResponseBody) };
    inline BatchQueryPushStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchQueryPushStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchQueryPushStatusResponseBody> body_ {};
  };
