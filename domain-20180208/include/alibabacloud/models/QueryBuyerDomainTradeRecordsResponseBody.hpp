...
namespace Models
{
  ...
  public:
    ...
    inline const QueryBuyerDomainTradeRecordsResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, QueryBuyerDomainTradeRecordsResponseBodyModule) };
    inline QueryBuyerDomainTradeRecordsResponseBodyModule module() { DARABONBA_PTR_GET(module_, QueryBuyerDomainTradeRecordsResponseBodyModule) };
    inline QueryBuyerDomainTradeRecordsResponseBody& setModule(const QueryBuyerDomainTradeRecordsResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline QueryBuyerDomainTradeRecordsResponseBody& setModule(QueryBuyerDomainTradeRecordsResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    std::shared_ptr<QueryBuyerDomainTradeRecordsResponseBodyModule> module_ = nullptr;
    // Id of the request
