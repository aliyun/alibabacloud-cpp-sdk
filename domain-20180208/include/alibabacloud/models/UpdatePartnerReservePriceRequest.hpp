...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->biddingId_ == nullptr
        && this->domainName_ == nullptr && this->partnerType_ == nullptr && this->reservePrice_ == nullptr; };
    ...
    inline int32_t getBiddingId() const { DARABONBA_PTR_GET_DEFAULT(biddingId_, 0) };
    ...
    inline double getReservePrice() const { DARABONBA_PTR_GET_DEFAULT(reservePrice_, 0.0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> biddingId_ {};
    // This parameter is required.
    shared_ptr<string> domainName_ {};
    // This parameter is required.
    shared_ptr<string> partnerType_ {};
    // This parameter is required.
    shared_ptr<double> reservePrice_ {};
  };
