...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAuctionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryAuctionsResponseBody) };
    inline QueryAuctionsResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryAuctionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryAuctionsResponseBody> body_ {};
  };
