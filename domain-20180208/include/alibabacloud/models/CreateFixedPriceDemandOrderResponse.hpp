...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFixedPriceDemandOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateFixedPriceDemandOrderResponseBody) };
    inline CreateFixedPriceDemandOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateFixedPriceDemandOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateFixedPriceDemandOrderResponseBody> body_ {};
  };
