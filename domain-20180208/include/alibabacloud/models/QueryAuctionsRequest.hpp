...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->auctionEndTimeOrder_ == nullptr
        && this->currentPage_ == nullptr && this->pageSize_ == nullptr && this->status_ == nullptr && this->statuses_ == nullptr; };
    ...
    inline string getAuctionEndTimeOrder() const { DARABONBA_PTR_GET_DEFAULT(auctionEndTimeOrder_, "") };
  ...
  protected:
    shared_ptr<string> auctionEndTimeOrder_ {};
