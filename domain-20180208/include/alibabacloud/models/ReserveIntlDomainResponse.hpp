...
namespace Models
{
  ...
  public:
    ...
    inline const ReserveIntlDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReserveIntlDomainResponseBody) };
    inline ReserveIntlDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, ReserveIntlDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReserveIntlDomainResponseBody> body_ {};
  };
