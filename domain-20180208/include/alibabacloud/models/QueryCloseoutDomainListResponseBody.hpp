...
#ifndef ALIBABACLOUD_MODELS_QUERYCLOSEOUTDOMAINLISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYCLOSEOUTDOMAINLISTRESPONSEBODY_HPP_
...
namespace Models
{
  class QueryCloseoutDomainListResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryCloseoutDomainListResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, QueryCloseoutDomainListResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    QueryCloseoutDomainListResponseBody() = default ;
    QueryCloseoutDomainListResponseBody(const QueryCloseoutDomainListResponseBody &) = default ;
    QueryCloseoutDomainListResponseBody(QueryCloseoutDomainListResponseBody &&) = default ;
    QueryCloseoutDomainListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryCloseoutDomainListResponseBody() = default ;
    QueryCloseoutDomainListResponseBody& operator=(const QueryCloseoutDomainListResponseBody &) = default ;
    QueryCloseoutDomainListResponseBody& operator=(QueryCloseoutDomainListResponseBody &&) = default ;
    ...
    public:
      ...
      inline Data& setTransferInPrice(double transferInPrice) { DARABONBA_PTR_SET_VALUE(transferInPrice_, transferInPrice) };
    ...
    inline const vector<QueryCloseoutDomainListResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryCloseoutDomainListResponseBody::Data>) };
    inline vector<QueryCloseoutDomainListResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<QueryCloseoutDomainListResponseBody::Data>) };
    inline QueryCloseoutDomainListResponseBody& setData(const vector<QueryCloseoutDomainListResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryCloseoutDomainListResponseBody& setData(vector<QueryCloseoutDomainListResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryCloseoutDomainListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<vector<QueryCloseoutDomainListResponseBody::Data>> data_ {};
