...
RecognizeStructuredTaxiInvoicesResponse Alibabacloud_Ocr20191230::Client::recognizeStructuredTaxiInvoicesWithOptions(shared_ptr<RecognizeStructuredTaxiInvoicesRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> body = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->imageURL)) {
    body->insert(pair<string, string>("ImageURL", *request->imageURL));
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("RecognizeStructuredTaxiInvoices"))},
    {"version", boost::any(string("2019-12-30"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return RecognizeStructuredTaxiInvoicesResponse(callApi(params, req, runtime));
}

RecognizeStructuredTaxiInvoicesResponse Alibabacloud_Ocr20191230::Client::recognizeStructuredTaxiInvoices(shared_ptr<RecognizeStructuredTaxiInvoicesRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
  return recognizeStructuredTaxiInvoicesWithOptions(request, runtime);
}

RecognizeStructuredTaxiInvoicesResponse Alibabacloud_Ocr20191230::Client::recognizeStructuredTaxiInvoicesAdvance(shared_ptr<RecognizeStructuredTaxiInvoicesAdvanceRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  // Step 0: init client
  shared_ptr<string> accessKeyId = make_shared<string>(_credential->getAccessKeyId());
  shared_ptr<string> accessKeySecret = make_shared<string>(_credential->getAccessKeySecret());
  shared_ptr<string> securityToken = make_shared<string>(_credential->getSecurityToken());
  ...
  shared_ptr<Alibabacloud_OSSUtil::RuntimeOptions> ossRuntime = make_shared<Alibabacloud_OSSUtil::RuntimeOptions>();
  Alibabacloud_OpenApiUtil::Client::convert(runtime, ossRuntime);
  shared_ptr<RecognizeStructuredTaxiInvoicesRequest> recognizeStructuredTaxiInvoicesReq = make_shared<RecognizeStructuredTaxiInvoicesRequest>();
  Alibabacloud_OpenApiUtil::Client::convert(request, recognizeStructuredTaxiInvoicesReq);
  if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(request->imageURLObject)) {
    authResponse = make_shared<Alibabacloud_OpenPlatform20191219::AuthorizeFileUploadResponse>(authClient->authorizeFileUploadWithOptions(authRequest, runtime));
    ossConfig->accessKeyId = authResponse->accessKeyId;
    ossConfig->endpoint = make_shared<string>(Alibabacloud_OpenApiUtil::Client::getEndpoint(authResponse->endpoint, authResponse->useAccelerate, _endpointType));
    ...
    ossClient->postObject(uploadRequest, ossRuntime);
    recognizeStructuredTaxiInvoicesReq->imageURL = make_shared<string>(string("http://") + string(*authResponse->bucket) + string(".") + string(*authResponse->endpoint) + string("/") + string(*authResponse->objectKey));
  }
  shared_ptr<RecognizeStructuredTaxiInvoicesResponse> recognizeStructuredTaxiInvoicesResp = make_shared<RecognizeStructuredTaxiInvoicesResponse>(recognizeStructuredTaxiInvoicesWithOptions(recognizeStructuredTaxiInvoicesReq, runtime));
