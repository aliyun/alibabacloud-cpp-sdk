...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->invoiceAmount_ != nullptr
        && this->invoiceCode_ != nullptr && this->invoiceDetails_ != nullptr && this->invoiceNo_ != nullptr && this->sumAmount_ != nullptr; };
