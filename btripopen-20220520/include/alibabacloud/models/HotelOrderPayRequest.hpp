...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getCompanyPayFee() const { DARABONBA_PTR_GET_DEFAULT(companyPayFee_, 0L) };
    ...
    inline int64_t getPersonPayFee() const { DARABONBA_PTR_GET_DEFAULT(personPayFee_, 0L) };
    ...
    inline string getThirdPayAccount() const { DARABONBA_PTR_GET_DEFAULT(thirdPayAccount_, "") };
    ...
    inline string getThirdTradeNo() const { DARABONBA_PTR_GET_DEFAULT(thirdTradeNo_, "") };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<int64_t> companyPayFee_ {};
    // This parameter is required.
    shared_ptr<int64_t> personPayFee_ {};
    shared_ptr<string> thirdPayAccount_ {};
    shared_ptr<string> thirdTradeNo_ {};
    // This parameter is required.
