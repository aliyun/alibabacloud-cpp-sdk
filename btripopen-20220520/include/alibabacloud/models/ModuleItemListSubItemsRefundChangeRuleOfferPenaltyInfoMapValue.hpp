...
#ifndef ALIBABACLOUD_MODELS_MODULEITEMLISTSUBITEMSREFUNDCHANGERULEOFFERPENALTYINFOMAPVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULEITEMLISTSUBITEMSREFUNDCHANGERULEOFFERPENALTYINFOMAPVALUE_HPP_
...
namespace Models
{
  class ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& obj) { 
    ...
    ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue() = default ;
    ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue(const ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue &) = default ;
    ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue(ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue &&) = default ;
    ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue() = default ;
    ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& operator=(const ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue &) = default ;
    ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& operator=(ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue &&) = default ;
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setStruct(bool _struct) { DARABONBA_PTR_SET_VALUE(struct_, _struct) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setCancelFeeInd(bool cancelFeeInd) { DARABONBA_PTR_SET_VALUE(cancelFeeInd_, cancelFeeInd) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setChangeFeeInd(bool changeFeeInd) { DARABONBA_PTR_SET_VALUE(changeFeeInd_, changeFeeInd) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setUpgradeFeeInd(bool upgradeFeeInd) { DARABONBA_PTR_SET_VALUE(upgradeFeeInd_, upgradeFeeInd) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setReissueInd(bool reissueInd) { DARABONBA_PTR_SET_VALUE(reissueInd_, reissueInd) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setPenaltyTypeCode(int32_t penaltyTypeCode) { DARABONBA_PTR_SET_VALUE(penaltyTypeCode_, penaltyTypeCode) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setPenaltyApplyRangeCode(int32_t penaltyApplyRangeCode) { DARABONBA_PTR_SET_VALUE(penaltyApplyRangeCode_, penaltyApplyRangeCode) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setPenaltyChargeTypeCode(int32_t penaltyChargeTypeCode) { DARABONBA_PTR_SET_VALUE(penaltyChargeTypeCode_, penaltyChargeTypeCode) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setFee(double fee) { DARABONBA_PTR_SET_VALUE(fee_, fee) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setCurrency(string currency) { DARABONBA_PTR_SET_VALUE(currency_, currency) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setPenaltyPercent(double penaltyPercent) { DARABONBA_PTR_SET_VALUE(penaltyPercent_, penaltyPercent) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setStartTime(int32_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setEndTime(int32_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setTimeUnitCode(int32_t timeUnitCode) { DARABONBA_PTR_SET_VALUE(timeUnitCode_, timeUnitCode) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setDepTime(string depTime) { DARABONBA_PTR_SET_VALUE(depTime_, depTime) };
    ...
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setSegmentNumber(string segmentNumber) { DARABONBA_PTR_SET_VALUE(segmentNumber_, segmentNumber) };
    ...
    inline const map<string, string> & descInfos() const { DARABONBA_PTR_GET_CONST(descInfos_, map<string, string>) };
    inline map<string, string> descInfos() { DARABONBA_PTR_GET(descInfos_, map<string, string>) };
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setDescInfos(const map<string, string> & descInfos) { DARABONBA_PTR_SET_VALUE(descInfos_, descInfos) };
    inline ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue& setDescInfos(map<string, string> && descInfos) { DARABONBA_PTR_SET_RVALUE(descInfos_, descInfos) };
  ...
  protected:
    ...
    std::shared_ptr<map<string, string>> descInfos_ = nullptr;
  };
