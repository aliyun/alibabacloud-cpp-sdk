...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightSegmentAvailableCertResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IntlFlightSegmentAvailableCertResponseBody) };
    inline IntlFlightSegmentAvailableCertResponseBody getBody() { DARABONBA_PTR_GET(body_, IntlFlightSegmentAvailableCertResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IntlFlightSegmentAvailableCertResponseBody> body_ {};
  };
