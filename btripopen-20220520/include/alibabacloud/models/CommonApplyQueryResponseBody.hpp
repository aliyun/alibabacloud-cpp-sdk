...
namespace Models
{
  ...
  public:
    ...
    inline const CommonApplyQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, CommonApplyQueryResponseBodyModule) };
    inline CommonApplyQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, CommonApplyQueryResponseBodyModule) };
    inline CommonApplyQueryResponseBody& setModule(const CommonApplyQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline CommonApplyQueryResponseBody& setModule(CommonApplyQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<CommonApplyQueryResponseBodyModule> module_ = nullptr;
