...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cabinClassShrink_ == nullptr
    ...
    inline string getCabinClassShrink() const { DARABONBA_PTR_GET_DEFAULT(cabinClassShrink_, "") };
    ...
    inline string getDepDateShrink() const { DARABONBA_PTR_GET_DEFAULT(depDateShrink_, "") };
    ...
    inline string getSelectedSegmentsShrink() const { DARABONBA_PTR_GET_DEFAULT(selectedSegmentsShrink_, "") };
