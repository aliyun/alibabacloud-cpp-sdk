...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightReShopCancelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IntlFlightReShopCancelResponseBody) };
    inline IntlFlightReShopCancelResponseBody getBody() { DARABONBA_PTR_GET(body_, IntlFlightReShopCancelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IntlFlightReShopCancelResponseBody> body_ {};
  };
