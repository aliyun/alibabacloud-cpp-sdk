...
namespace Models
{
  ...
  public:
    ...
    inline string getOuterDeptId() const { DARABONBA_PTR_GET_DEFAULT(outerDeptId_, "") };
    ...
    inline string getOuterDeptPid() const { DARABONBA_PTR_GET_DEFAULT(outerDeptPid_, "") };
    ...
    inline const vector<string> & getSubCorpIdList() const { DARABONBA_PTR_GET_CONST(subCorpIdList_, vector<string>) };
    inline vector<string> getSubCorpIdList() { DARABONBA_PTR_GET(subCorpIdList_, vector<string>) };
    ...
    inline bool getSyncGroup() const { DARABONBA_PTR_GET_DEFAULT(syncGroup_, false) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<string> outerDeptId_ {};
    shared_ptr<string> outerDeptPid_ {};
    // This parameter is required.
    shared_ptr<int32_t> status_ {};
    shared_ptr<vector<string>> subCorpIdList_ {};
    shared_ptr<bool> syncGroup_ {};
  };
