...
namespace Models
{
  ...
  public:
    ...
    inline string getModifyApplyId() const { DARABONBA_PTR_GET_DEFAULT(modifyApplyId_, "") };
    ...
    inline string getOutModifyApplyId() const { DARABONBA_PTR_GET_DEFAULT(outModifyApplyId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> modifyApplyId_ {};
    shared_ptr<bool> needQueryServiceFee_ {};
    shared_ptr<string> orderId_ {};
    shared_ptr<string> outModifyApplyId_ {};
