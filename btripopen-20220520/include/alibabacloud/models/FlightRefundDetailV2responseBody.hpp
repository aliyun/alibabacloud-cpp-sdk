...
namespace Models
{
  ...
  public:
    ...
    inline const FlightRefundDetailV2ResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightRefundDetailV2ResponseBodyModule) };
    inline FlightRefundDetailV2ResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightRefundDetailV2ResponseBodyModule) };
    inline FlightRefundDetailV2ResponseBody& setModule(const FlightRefundDetailV2ResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightRefundDetailV2ResponseBody& setModule(FlightRefundDetailV2ResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<FlightRefundDetailV2ResponseBodyModule> module_ = nullptr;
    // requestId
