...
namespace Models
{
  ...
  public:
    ...
    inline const HotelSearchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HotelSearchResponseBody) };
    inline HotelSearchResponseBody getBody() { DARABONBA_PTR_GET(body_, HotelSearchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HotelSearchResponseBody> body_ {};
  };
