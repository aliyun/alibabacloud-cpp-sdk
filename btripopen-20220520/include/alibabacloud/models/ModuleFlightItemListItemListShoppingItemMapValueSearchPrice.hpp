...
#ifndef ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTITEMLISTSHOPPINGITEMMAPVALUESEARCHPRICE_HPP_
#define ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTITEMLISTSHOPPINGITEMMAPVALUESEARCHPRICE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& obj) { 
    ...
    ModuleFlightItemListItemListShoppingItemMapValueSearchPrice() = default ;
    ModuleFlightItemListItemListShoppingItemMapValueSearchPrice(const ModuleFlightItemListItemListShoppingItemMapValueSearchPrice &) = default ;
    ModuleFlightItemListItemListShoppingItemMapValueSearchPrice(ModuleFlightItemListItemListShoppingItemMapValueSearchPrice &&) = default ;
    ModuleFlightItemListItemListShoppingItemMapValueSearchPrice(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleFlightItemListItemListShoppingItemMapValueSearchPrice() = default ;
    ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& operator=(const ModuleFlightItemListItemListShoppingItemMapValueSearchPrice &) = default ;
    ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& operator=(ModuleFlightItemListItemListShoppingItemMapValueSearchPrice &&) = default ;
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setFloorPrice(int32_t floorPrice) { DARABONBA_PTR_SET_VALUE(floorPrice_, floorPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setTicketPrice(int32_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setSellPrice(int32_t sellPrice) { DARABONBA_PTR_SET_VALUE(sellPrice_, sellPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setOriginalSellPrice(int32_t originalSellPrice) { DARABONBA_PTR_SET_VALUE(originalSellPrice_, originalSellPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setBaseTotalPrice(int32_t baseTotalPrice) { DARABONBA_PTR_SET_VALUE(baseTotalPrice_, baseTotalPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setBeforeControlPrice(int32_t beforeControlPrice) { DARABONBA_PTR_SET_VALUE(beforeControlPrice_, beforeControlPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setTax(int32_t tax) { DARABONBA_PTR_SET_VALUE(tax_, tax) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setSupplyPrice(int32_t supplyPrice) { DARABONBA_PTR_SET_VALUE(supplyPrice_, supplyPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setBasicCabinPrice(int32_t basicCabinPrice) { DARABONBA_PTR_SET_VALUE(basicCabinPrice_, basicCabinPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setBuildPrice(int32_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setOilPrice(int32_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setFirstStandardPrice(int32_t firstStandardPrice) { DARABONBA_PTR_SET_VALUE(firstStandardPrice_, firstStandardPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setBusinessStandardPrice(int32_t businessStandardPrice) { DARABONBA_PTR_SET_VALUE(businessStandardPrice_, businessStandardPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setCommonStandardPrice(int32_t commonStandardPrice) { DARABONBA_PTR_SET_VALUE(commonStandardPrice_, commonStandardPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setInterTicketPrice(int32_t interTicketPrice) { DARABONBA_PTR_SET_VALUE(interTicketPrice_, interTicketPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setSubtractedPrice(int32_t subtractedPrice) { DARABONBA_PTR_SET_VALUE(subtractedPrice_, subtractedPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setOriginCommonPrice(int32_t originCommonPrice) { DARABONBA_PTR_SET_VALUE(originCommonPrice_, originCommonPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setDynamicPromotionPrice(int32_t dynamicPromotionPrice) { DARABONBA_PTR_SET_VALUE(dynamicPromotionPrice_, dynamicPromotionPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setInstallmentNum(int32_t installmentNum) { DARABONBA_PTR_SET_VALUE(installmentNum_, installmentNum) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setInstallmentPrice(double installmentPrice) { DARABONBA_PTR_SET_VALUE(installmentPrice_, installmentPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setCompetitionDynamicPrice(int32_t competitionDynamicPrice) { DARABONBA_PTR_SET_VALUE(competitionDynamicPrice_, competitionDynamicPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setCompetitionPromotionPrice(int32_t competitionPromotionPrice) { DARABONBA_PTR_SET_VALUE(competitionPromotionPrice_, competitionPromotionPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setMinBeforeControlPriceOfNormal(int32_t minBeforeControlPriceOfNormal) { DARABONBA_PTR_SET_VALUE(minBeforeControlPriceOfNormal_, minBeforeControlPriceOfNormal) };
    ...
    inline const Models::ModuleFlightItemListItemListShoppingItemMapValueSearchPricePriceShowInfo & priceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, Models::ModuleFlightItemListItemListShoppingItemMapValueSearchPricePriceShowInfo) };
    inline Models::ModuleFlightItemListItemListShoppingItemMapValueSearchPricePriceShowInfo priceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, Models::ModuleFlightItemListItemListShoppingItemMapValueSearchPricePriceShowInfo) };
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setPriceShowInfo(const Models::ModuleFlightItemListItemListShoppingItemMapValueSearchPricePriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleFlightItemListItemListShoppingItemMapValueSearchPrice& setPriceShowInfo(Models::ModuleFlightItemListItemListShoppingItemMapValueSearchPricePriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ModuleFlightItemListItemListShoppingItemMapValueSearchPricePriceShowInfo> priceShowInfo_ = nullptr;
  };
