...
namespace Models
{
  ...
  public:
    ...
    inline bool getAgreementPrice() const { DARABONBA_PTR_GET_DEFAULT(agreementPrice_, false) };
    ...
    inline bool getBreakfastIncluded() const { DARABONBA_PTR_GET_DEFAULT(breakfastIncluded_, false) };
    ...
    inline bool getSpecialInvoice() const { DARABONBA_PTR_GET_DEFAULT(specialInvoice_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> agreementPrice_ {};
    // This parameter is required.
    shared_ptr<string> beginDate_ {};
    shared_ptr<bool> breakfastIncluded_ {};
    // This parameter is required.
    ...
    shared_ptr<bool> specialInvoice_ {};
