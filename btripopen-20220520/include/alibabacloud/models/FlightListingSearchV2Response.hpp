...
namespace Models
{
  ...
  public:
    ...
    inline const FlightListingSearchV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FlightListingSearchV2ResponseBody) };
    inline FlightListingSearchV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, FlightListingSearchV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FlightListingSearchV2ResponseBody> body_ {};
  };
