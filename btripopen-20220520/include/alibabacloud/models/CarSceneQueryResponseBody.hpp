...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CarSceneQueryResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<CarSceneQueryResponseBodyModule>) };
    inline vector<CarSceneQueryResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<CarSceneQueryResponseBodyModule>) };
    inline CarSceneQueryResponseBody& setModule(const vector<CarSceneQueryResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline CarSceneQueryResponseBody& setModule(vector<CarSceneQueryResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CarSceneQueryResponseBodyModule>> module_ = nullptr;
