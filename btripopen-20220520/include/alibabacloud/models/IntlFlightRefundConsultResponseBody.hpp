...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightRefundConsultResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightRefundConsultResponseBodyModule) };
    inline IntlFlightRefundConsultResponseBodyModule module() { DARABONBA_PTR_GET(module_, IntlFlightRefundConsultResponseBodyModule) };
    inline IntlFlightRefundConsultResponseBody& setModule(const IntlFlightRefundConsultResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightRefundConsultResponseBody& setModule(IntlFlightRefundConsultResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IntlFlightRefundConsultResponseBodyModule> module_ = nullptr;
