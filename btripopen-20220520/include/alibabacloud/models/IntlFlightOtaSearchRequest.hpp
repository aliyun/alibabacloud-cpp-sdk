...
namespace Models
{
  ...
  public:
    ...
    inline const vector<IntlFlightOtaSearchRequest::SearchJourneys> & getSearchJourneys() const { DARABONBA_PTR_GET_CONST(searchJourneys_, vector<IntlFlightOtaSearchRequest::SearchJourneys>) };
    inline vector<IntlFlightOtaSearchRequest::SearchJourneys> getSearchJourneys() { DARABONBA_PTR_GET(searchJourneys_, vector<IntlFlightOtaSearchRequest::SearchJourneys>) };
    inline IntlFlightOtaSearchRequest& setSearchJourneys(const vector<IntlFlightOtaSearchRequest::SearchJourneys> & searchJourneys) { DARABONBA_PTR_SET_VALUE(searchJourneys_, searchJourneys) };
    inline IntlFlightOtaSearchRequest& setSearchJourneys(vector<IntlFlightOtaSearchRequest::SearchJourneys> && searchJourneys) { DARABONBA_PTR_SET_RVALUE(searchJourneys_, searchJourneys) };
    ...
    inline const vector<IntlFlightOtaSearchRequest::SearchPassengerList> & getSearchPassengerList() const { DARABONBA_PTR_GET_CONST(searchPassengerList_, vector<IntlFlightOtaSearchRequest::SearchPassengerList>) };
    inline vector<IntlFlightOtaSearchRequest::SearchPassengerList> getSearchPassengerList() { DARABONBA_PTR_GET(searchPassengerList_, vector<IntlFlightOtaSearchRequest::SearchPassengerList>) };
    inline IntlFlightOtaSearchRequest& setSearchPassengerList(const vector<IntlFlightOtaSearchRequest::SearchPassengerList> & searchPassengerList) { DARABONBA_PTR_SET_VALUE(searchPassengerList_, searchPassengerList) };
    inline IntlFlightOtaSearchRequest& setSearchPassengerList(vector<IntlFlightOtaSearchRequest::SearchPassengerList> && searchPassengerList) { DARABONBA_PTR_SET_RVALUE(searchPassengerList_, searchPassengerList) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<IntlFlightOtaSearchRequest::SearchJourneys>> searchJourneys_ {};
    shared_ptr<vector<IntlFlightOtaSearchRequest::SearchPassengerList>> searchPassengerList_ {};
    // This parameter is required.
