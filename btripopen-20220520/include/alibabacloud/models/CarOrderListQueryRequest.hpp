...
#ifndef ALIBABACLOUD_MODELS_CARORDERLISTQUERYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CARORDERLISTQUERYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CarOrderListQueryRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CarOrderListQueryRequest& obj) { 
    ...
    CarOrderListQueryRequest() = default ;
    CarOrderListQueryRequest(const CarOrderListQueryRequest &) = default ;
    CarOrderListQueryRequest(CarOrderListQueryRequest &&) = default ;
    CarOrderListQueryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CarOrderListQueryRequest() = default ;
    CarOrderListQueryRequest& operator=(const CarOrderListQueryRequest &) = default ;
    CarOrderListQueryRequest& operator=(CarOrderListQueryRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->allApply_ == nullptr
    ...
    inline bool getAllApply() const { DARABONBA_PTR_GET_DEFAULT(allApply_, false) };
    inline CarOrderListQueryRequest& setAllApply(bool allApply) { DARABONBA_PTR_SET_VALUE(allApply_, allApply) };
    ...
    inline CarOrderListQueryRequest& setApplyId(int64_t applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline CarOrderListQueryRequest& setDepartId(string departId) { DARABONBA_PTR_SET_VALUE(departId_, departId) };
    ...
    inline CarOrderListQueryRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline CarOrderListQueryRequest& setPage(int32_t page) { DARABONBA_PTR_SET_VALUE(page_, page) };
    ...
    inline CarOrderListQueryRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline CarOrderListQueryRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline CarOrderListQueryRequest& setThirdpartApplyId(string thirdpartApplyId) { DARABONBA_PTR_SET_VALUE(thirdpartApplyId_, thirdpartApplyId) };
    ...
    inline CarOrderListQueryRequest& setUpdateEndTime(string updateEndTime) { DARABONBA_PTR_SET_VALUE(updateEndTime_, updateEndTime) };
    ...
    inline CarOrderListQueryRequest& setUpdateStartTime(string updateStartTime) { DARABONBA_PTR_SET_VALUE(updateStartTime_, updateStartTime) };
    ...
    inline CarOrderListQueryRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };


  protected:
    shared_ptr<bool> allApply_ {};
