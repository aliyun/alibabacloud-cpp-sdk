...
#ifndef ALIBABACLOUD_MODELS_WAITAPPLYINVOICETASKDETAILQUERYRESPONSEBODYMODULE_HPP_
#define ALIBABACLOUD_MODELS_WAITAPPLYINVOICETASKDETAILQUERYRESPONSEBODYMODULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const WaitApplyInvoiceTaskDetailQueryResponseBodyModule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, WaitApplyInvoiceTaskDetailQueryResponseBodyModule& obj) { 
    ...
    WaitApplyInvoiceTaskDetailQueryResponseBodyModule() = default ;
    WaitApplyInvoiceTaskDetailQueryResponseBodyModule(const WaitApplyInvoiceTaskDetailQueryResponseBodyModule &) = default ;
    WaitApplyInvoiceTaskDetailQueryResponseBodyModule(WaitApplyInvoiceTaskDetailQueryResponseBodyModule &&) = default ;
    WaitApplyInvoiceTaskDetailQueryResponseBodyModule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~WaitApplyInvoiceTaskDetailQueryResponseBodyModule() = default ;
    WaitApplyInvoiceTaskDetailQueryResponseBodyModule& operator=(const WaitApplyInvoiceTaskDetailQueryResponseBodyModule &) = default ;
    WaitApplyInvoiceTaskDetailQueryResponseBodyModule& operator=(WaitApplyInvoiceTaskDetailQueryResponseBodyModule &&) = default ;
    ...
    virtual bool empty() const override { this->contact_ != nullptr
        ...
        && this->internationalFlightInvoiceFee_ != nullptr && this->internationalHotelInvoiceFee_ != nullptr && this->invoiceThirdPartId_ != nullptr && this->invoiceTitle_ != nullptr && this->mailAddress_ != nullptr
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setContact(string contact) { DARABONBA_PTR_SET_VALUE(contact_, contact) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setFlightInvoiceFee(string flightInvoiceFee) { DARABONBA_PTR_SET_VALUE(flightInvoiceFee_, flightInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setFuPointInvoiceFee(string fuPointInvoiceFee) { DARABONBA_PTR_SET_VALUE(fuPointInvoiceFee_, fuPointInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setHotelNormalInvoiceFee(string hotelNormalInvoiceFee) { DARABONBA_PTR_SET_VALUE(hotelNormalInvoiceFee_, hotelNormalInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setHotelSpecialInvoiceFee(string hotelSpecialInvoiceFee) { DARABONBA_PTR_SET_VALUE(hotelSpecialInvoiceFee_, hotelSpecialInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setInternationalFlightInvoiceFee(string internationalFlightInvoiceFee) { DARABONBA_PTR_SET_VALUE(internationalFlightInvoiceFee_, internationalFlightInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setInternationalHotelInvoiceFee(string internationalHotelInvoiceFee) { DARABONBA_PTR_SET_VALUE(internationalHotelInvoiceFee_, internationalHotelInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setInvoiceThirdPartId(string invoiceThirdPartId) { DARABONBA_PTR_SET_VALUE(invoiceThirdPartId_, invoiceThirdPartId) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setInvoiceTitle(string invoiceTitle) { DARABONBA_PTR_SET_VALUE(invoiceTitle_, invoiceTitle) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setMailAddress(string mailAddress) { DARABONBA_PTR_SET_VALUE(mailAddress_, mailAddress) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setMailCity(string mailCity) { DARABONBA_PTR_SET_VALUE(mailCity_, mailCity) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setMailFullAddress(string mailFullAddress) { DARABONBA_PTR_SET_VALUE(mailFullAddress_, mailFullAddress) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setMailProvince(string mailProvince) { DARABONBA_PTR_SET_VALUE(mailProvince_, mailProvince) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setMealNormalInvoiceFee(string mealNormalInvoiceFee) { DARABONBA_PTR_SET_VALUE(mealNormalInvoiceFee_, mealNormalInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setPenaltyFee(string penaltyFee) { DARABONBA_PTR_SET_VALUE(penaltyFee_, penaltyFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setServiceFee(string serviceFee) { DARABONBA_PTR_SET_VALUE(serviceFee_, serviceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setTelephone(string telephone) { DARABONBA_PTR_SET_VALUE(telephone_, telephone) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setTrainAccelerationPackageInvoiceFee(string trainAccelerationPackageInvoiceFee) { DARABONBA_PTR_SET_VALUE(trainAccelerationPackageInvoiceFee_, trainAccelerationPackageInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setTrainInvoiceFee(string trainInvoiceFee) { DARABONBA_PTR_SET_VALUE(trainInvoiceFee_, trainInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setVacationNormalInvoiceFee(string vacationNormalInvoiceFee) { DARABONBA_PTR_SET_VALUE(vacationNormalInvoiceFee_, vacationNormalInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setVasMallSpecialInvoiceFee(string vasMallSpecialInvoiceFee) { DARABONBA_PTR_SET_VALUE(vasMallSpecialInvoiceFee_, vasMallSpecialInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setVehicleInvoiceFee(string vehicleInvoiceFee) { DARABONBA_PTR_SET_VALUE(vehicleInvoiceFee_, vehicleInvoiceFee) };
    ...
    inline WaitApplyInvoiceTaskDetailQueryResponseBodyModule& setVehicleNormalInvoiceFee(string vehicleNormalInvoiceFee) { DARABONBA_PTR_SET_VALUE(vehicleNormalInvoiceFee_, vehicleNormalInvoiceFee) };
