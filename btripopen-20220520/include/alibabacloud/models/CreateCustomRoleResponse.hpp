...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCustomRoleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCustomRoleResponseBody) };
    inline CreateCustomRoleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCustomRoleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCustomRoleResponseBody> body_ {};
  };
