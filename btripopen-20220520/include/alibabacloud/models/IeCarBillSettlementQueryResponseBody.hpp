...
#ifndef ALIBABACLOUD_MODELS_IECARBILLSETTLEMENTQUERYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_IECARBILLSETTLEMENTQUERYRESPONSEBODY_HPP_
...
namespace Models
{
  class IeCarBillSettlementQueryResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IeCarBillSettlementQueryResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IeCarBillSettlementQueryResponseBody& obj) { 
    ...
    IeCarBillSettlementQueryResponseBody() = default ;
    IeCarBillSettlementQueryResponseBody(const IeCarBillSettlementQueryResponseBody &) = default ;
    IeCarBillSettlementQueryResponseBody(IeCarBillSettlementQueryResponseBody &&) = default ;
    IeCarBillSettlementQueryResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IeCarBillSettlementQueryResponseBody() = default ;
    IeCarBillSettlementQueryResponseBody& operator=(const IeCarBillSettlementQueryResponseBody &) = default ;
    IeCarBillSettlementQueryResponseBody& operator=(IeCarBillSettlementQueryResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        friend void to_json(Darabonba::Json& j, const Items& obj) { 
          DARABONBA_PTR_TO_JSON(account_month, accountMonth_);
          ...
          DARABONBA_PTR_TO_JSON(arr_date_local, arrDateLocal_);
          ...
          DARABONBA_PTR_TO_JSON(bill_record_time_str, billRecordTimeStr_);
          ...
          DARABONBA_PTR_TO_JSON(book_time_local, bookTimeLocal_);
          ...
          DARABONBA_PTR_TO_JSON(booker_use_id, bookerUseId_);
          ...
          DARABONBA_PTR_TO_JSON(dep_date_local, depDateLocal_);
          ...
          DARABONBA_PTR_TO_JSON(financial_subject, financialSubject_);
          DARABONBA_PTR_TO_JSON(foreigners_tag, foreignersTag_);
          DARABONBA_PTR_TO_JSON(index, index_);
          DARABONBA_PTR_TO_JSON(invoice_title, invoiceTitle_);
          DARABONBA_PTR_TO_JSON(last_department, lastDepartment_);
          ...
          DARABONBA_PTR_TO_JSON(origin_apply_id, originApplyId_);
          ...
          DARABONBA_PTR_TO_JSON(record_status, recordStatus_);
          ...
          DARABONBA_PTR_TO_JSON(traveler_use_id, travelerUseId_);
        ...
        friend void from_json(const Darabonba::Json& j, Items& obj) { 
          DARABONBA_PTR_FROM_JSON(account_month, accountMonth_);
          ...
          DARABONBA_PTR_FROM_JSON(arr_date_local, arrDateLocal_);
          ...
          DARABONBA_PTR_FROM_JSON(bill_record_time_str, billRecordTimeStr_);
          ...
          DARABONBA_PTR_FROM_JSON(book_time_local, bookTimeLocal_);
          ...
          DARABONBA_PTR_FROM_JSON(booker_use_id, bookerUseId_);
          ...
          DARABONBA_PTR_FROM_JSON(dep_date_local, depDateLocal_);
          ...
          DARABONBA_PTR_FROM_JSON(financial_subject, financialSubject_);
          DARABONBA_PTR_FROM_JSON(foreigners_tag, foreignersTag_);
          DARABONBA_PTR_FROM_JSON(index, index_);
          DARABONBA_PTR_FROM_JSON(invoice_title, invoiceTitle_);
          DARABONBA_PTR_FROM_JSON(last_department, lastDepartment_);
          ...
          DARABONBA_PTR_FROM_JSON(origin_apply_id, originApplyId_);
          ...
          DARABONBA_PTR_FROM_JSON(record_status, recordStatus_);
          ...
          DARABONBA_PTR_FROM_JSON(traveler_use_id, travelerUseId_);
        ...
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        virtual bool empty() const override { return this->accountMonth_ == nullptr
        && this->adjustTime_ == nullptr && this->alipayId_ == nullptr && this->alipayTradeNo_ == nullptr && this->applyArrCityCode_ == nullptr && this->applyArrCityName_ == nullptr
        && this->applyDepCityCode_ == nullptr && this->applyDepCityName_ == nullptr && this->applyExtendField_ == nullptr && this->applyId_ == nullptr && this->approverEmail_ == nullptr
        && this->approverId_ == nullptr && this->approverName_ == nullptr && this->arrCity_ == nullptr && this->arrCityCode_ == nullptr && this->arrCountry_ == nullptr
        && this->arrDate_ == nullptr && this->arrDateLocal_ == nullptr && this->arrLocation_ == nullptr && this->baseLocation_ == nullptr && this->billRecordTime_ == nullptr
        && this->billRecordTimeStr_ == nullptr && this->billingEntity_ == nullptr && this->bookChannel_ == nullptr && this->bookMode_ == nullptr && this->bookModel_ == nullptr
        && this->bookTime_ == nullptr && this->bookTimeLocal_ == nullptr && this->bookerId_ == nullptr && this->bookerJobNo_ == nullptr && this->bookerName_ == nullptr
        && this->bookerUseId_ == nullptr && this->businessCategory_ == nullptr && this->capitalDirection_ == nullptr && this->carLevel_ == nullptr && this->cascadeDepartment_ == nullptr
        && this->categoryDesc_ == nullptr && this->costCenter_ == nullptr && this->costCenterNumber_ == nullptr && this->costDepartment_ == nullptr && this->coupon_ == nullptr
        && this->couponPrice_ == nullptr && this->customContent_ == nullptr && this->deductibleTax_ == nullptr && this->depCityCode_ == nullptr && this->depCountry_ == nullptr
        && this->depDateLocal_ == nullptr && this->department_ == nullptr && this->departmentId_ == nullptr && this->deptCity_ == nullptr && this->deptDate_ == nullptr
        && this->deptLocation_ == nullptr && this->driverAddDetail_ == nullptr && this->driverAddFee_ == nullptr && this->estimateDriveDistance_ == nullptr && this->estimatePrice_ == nullptr
        && this->feeType_ == nullptr && this->feeTypeDesc_ == nullptr && this->financialSubject_ == nullptr && this->foreignersTag_ == nullptr && this->index_ == nullptr
        && this->invoiceTitle_ == nullptr && this->lastDepartment_ == nullptr && this->levelName_ == nullptr && this->location_ == nullptr && this->mainApplyId_ == nullptr
        && this->mappingCompanyCode_ == nullptr && this->memo_ == nullptr && this->orderId_ == nullptr && this->orderPrice_ == nullptr && this->orderStatusDesc_ == nullptr
        && this->originApplyId_ == nullptr && this->overApplyId_ == nullptr && this->paymentDepartmentId_ == nullptr && this->paymentDepartmentName_ == nullptr && this->personSettleFee_ == nullptr
        ...
        && this->projectName_ == nullptr && this->protocolDiscountFee_ == nullptr && this->providerName_ == nullptr && this->purchaseOrderId_ == nullptr && this->realDriveDistance_ == nullptr
        && this->realFromAddr_ == nullptr && this->realToAddr_ == nullptr && this->recordStatus_ == nullptr && this->remark_ == nullptr && this->sceneId_ == nullptr
        ...
        && this->settlementTime_ == nullptr && this->settlementType_ == nullptr && this->showSubOrderId_ == nullptr && this->sio_ == nullptr && this->specialOrder_ == nullptr
        && this->specialReason_ == nullptr && this->status_ == nullptr && this->statusDesc_ == nullptr && this->subOrderId_ == nullptr && this->supplementApplyId_ == nullptr
        && this->taxRate_ == nullptr && this->thirdInvoiceId_ == nullptr && this->thirdItineraryId_ == nullptr && this->thirdPartBusinessId_ == nullptr && this->thirdpartApplyId_ == nullptr
        ...
        && this->travelerMemberType_ == nullptr && this->travelerMemberTypeName_ == nullptr && this->travelerName_ == nullptr && this->travelerUseId_ == nullptr && this->userConfirmDesc_ == nullptr
        && this->vehicleSceneId_ == nullptr && this->vehicleSceneName_ == nullptr && this->voucherType_ == nullptr && this->voucherTypeDesc_ == nullptr; };
        // accountMonth Field Functions 
        bool hasAccountMonth() const { return this->accountMonth_ != nullptr;};
        void deleteAccountMonth() { this->accountMonth_ = nullptr;};
        inline string getAccountMonth() const { DARABONBA_PTR_GET_DEFAULT(accountMonth_, "") };
        inline Items& setAccountMonth(string accountMonth) { DARABONBA_PTR_SET_VALUE(accountMonth_, accountMonth) };
        ...
        inline Items& setArrCountry(string arrCountry) { DARABONBA_PTR_SET_VALUE(arrCountry_, arrCountry) };
        ...
        // arrDateLocal Field Functions 
        bool hasArrDateLocal() const { return this->arrDateLocal_ != nullptr;};
        void deleteArrDateLocal() { this->arrDateLocal_ = nullptr;};
        inline string getArrDateLocal() const { DARABONBA_PTR_GET_DEFAULT(arrDateLocal_, "") };
        inline Items& setArrDateLocal(string arrDateLocal) { DARABONBA_PTR_SET_VALUE(arrDateLocal_, arrDateLocal) };
        ...
        inline Items& setArrLocation(string arrLocation) { DARABONBA_PTR_SET_VALUE(arrLocation_, arrLocation) };
        ...
        // billRecordTimeStr Field Functions 
        bool hasBillRecordTimeStr() const { return this->billRecordTimeStr_ != nullptr;};
        void deleteBillRecordTimeStr() { this->billRecordTimeStr_ = nullptr;};
        inline string getBillRecordTimeStr() const { DARABONBA_PTR_GET_DEFAULT(billRecordTimeStr_, "") };
        inline Items& setBillRecordTimeStr(string billRecordTimeStr) { DARABONBA_PTR_SET_VALUE(billRecordTimeStr_, billRecordTimeStr) };
        ...
        inline Items& setBookModel(string bookModel) { DARABONBA_PTR_SET_VALUE(bookModel_, bookModel) };
        ...
        // bookTimeLocal Field Functions 
        bool hasBookTimeLocal() const { return this->bookTimeLocal_ != nullptr;};
        void deleteBookTimeLocal() { this->bookTimeLocal_ = nullptr;};
        inline string getBookTimeLocal() const { DARABONBA_PTR_GET_DEFAULT(bookTimeLocal_, "") };
        inline Items& setBookTimeLocal(string bookTimeLocal) { DARABONBA_PTR_SET_VALUE(bookTimeLocal_, bookTimeLocal) };
        ...
        // bookerUseId Field Functions 
        bool hasBookerUseId() const { return this->bookerUseId_ != nullptr;};
        void deleteBookerUseId() { this->bookerUseId_ = nullptr;};
        inline string getBookerUseId() const { DARABONBA_PTR_GET_DEFAULT(bookerUseId_, "") };
        inline Items& setBookerUseId(string bookerUseId) { DARABONBA_PTR_SET_VALUE(bookerUseId_, bookerUseId) };
        ...
        inline Items& setBusinessCategory(string businessCategory) { DARABONBA_PTR_SET_VALUE(businessCategory_, businessCategory) };
        ...
        inline Items& setCarLevel(string carLevel) { DARABONBA_PTR_SET_VALUE(carLevel_, carLevel) };
        ...
        inline Items& setCouponPrice(double couponPrice) { DARABONBA_PTR_SET_VALUE(couponPrice_, couponPrice) };
        ...
        inline Items& setDepCountry(string depCountry) { DARABONBA_PTR_SET_VALUE(depCountry_, depCountry) };


        // depDateLocal Field Functions 
        bool hasDepDateLocal() const { return this->depDateLocal_ != nullptr;};
        void deleteDepDateLocal() { this->depDateLocal_ = nullptr;};
        inline string getDepDateLocal() const { DARABONBA_PTR_GET_DEFAULT(depDateLocal_, "") };
        inline Items& setDepDateLocal(string depDateLocal) { DARABONBA_PTR_SET_VALUE(depDateLocal_, depDateLocal) };
        ...
        inline Items& setDeptLocation(string deptLocation) { DARABONBA_PTR_SET_VALUE(deptLocation_, deptLocation) };
        ...
        inline Items& setDriverAddDetail(string driverAddDetail) { DARABONBA_PTR_SET_VALUE(driverAddDetail_, driverAddDetail) };
        ...
        inline Items& setDriverAddFee(double driverAddFee) { DARABONBA_PTR_SET_VALUE(driverAddFee_, driverAddFee) };
        ...
        inline Items& setEstimateDriveDistance(string estimateDriveDistance) { DARABONBA_PTR_SET_VALUE(estimateDriveDistance_, estimateDriveDistance) };
        ...
        inline Items& setEstimatePrice(double estimatePrice) { DARABONBA_PTR_SET_VALUE(estimatePrice_, estimatePrice) };
        ...
        // financialSubject Field Functions 
        bool hasFinancialSubject() const { return this->financialSubject_ != nullptr;};
        void deleteFinancialSubject() { this->financialSubject_ = nullptr;};
        inline string getFinancialSubject() const { DARABONBA_PTR_GET_DEFAULT(financialSubject_, "") };
        inline Items& setFinancialSubject(string financialSubject) { DARABONBA_PTR_SET_VALUE(financialSubject_, financialSubject) };
        ...
        // lastDepartment Field Functions 
        bool hasLastDepartment() const { return this->lastDepartment_ != nullptr;};
        void deleteLastDepartment() { this->lastDepartment_ = nullptr;};
        inline string getLastDepartment() const { DARABONBA_PTR_GET_DEFAULT(lastDepartment_, "") };
        inline Items& setLastDepartment(string lastDepartment) { DARABONBA_PTR_SET_VALUE(lastDepartment_, lastDepartment) };
        ...
        inline Items& setLevelName(string levelName) { DARABONBA_PTR_SET_VALUE(levelName_, levelName) };
        ...
        inline Items& setMemo(string memo) { DARABONBA_PTR_SET_VALUE(memo_, memo) };
        ...
        // originApplyId Field Functions 
        bool hasOriginApplyId() const { return this->originApplyId_ != nullptr;};
        void deleteOriginApplyId() { this->originApplyId_ = nullptr;};
        inline string getOriginApplyId() const { DARABONBA_PTR_GET_DEFAULT(originApplyId_, "") };
        inline Items& setOriginApplyId(string originApplyId) { DARABONBA_PTR_SET_VALUE(originApplyId_, originApplyId) };
        ...
        inline Items& setPersonSettleFee(double personSettleFee) { DARABONBA_PTR_SET_VALUE(personSettleFee_, personSettleFee) };
        ...
        inline Items& setProtocolDiscountFee(double protocolDiscountFee) { DARABONBA_PTR_SET_VALUE(protocolDiscountFee_, protocolDiscountFee) };
        ...
        inline Items& setRealDriveDistance(string realDriveDistance) { DARABONBA_PTR_SET_VALUE(realDriveDistance_, realDriveDistance) };
        ...
        inline Items& setRealFromAddr(string realFromAddr) { DARABONBA_PTR_SET_VALUE(realFromAddr_, realFromAddr) };
        ...
        inline Items& setRealToAddr(string realToAddr) { DARABONBA_PTR_SET_VALUE(realToAddr_, realToAddr) };


        // recordStatus Field Functions 
        bool hasRecordStatus() const { return this->recordStatus_ != nullptr;};
        void deleteRecordStatus() { this->recordStatus_ = nullptr;};
        inline string getRecordStatus() const { DARABONBA_PTR_GET_DEFAULT(recordStatus_, "") };
        inline Items& setRecordStatus(string recordStatus) { DARABONBA_PTR_SET_VALUE(recordStatus_, recordStatus) };
        ...
        inline Items& setSpecialOrder(string specialOrder) { DARABONBA_PTR_SET_VALUE(specialOrder_, specialOrder) };
        ...
        inline Items& setSpecialReason(string specialReason) { DARABONBA_PTR_SET_VALUE(specialReason_, specialReason) };
        ...
        inline Items& setSupplementApplyId(string supplementApplyId) { DARABONBA_PTR_SET_VALUE(supplementApplyId_, supplementApplyId) };
        ...
        inline Items& setTimeType(string timeType) { DARABONBA_PTR_SET_VALUE(timeType_, timeType) };
        ...
        // travelerUseId Field Functions 
        bool hasTravelerUseId() const { return this->travelerUseId_ != nullptr;};
        void deleteTravelerUseId() { this->travelerUseId_ = nullptr;};
        inline string getTravelerUseId() const { DARABONBA_PTR_GET_DEFAULT(travelerUseId_, "") };
        inline Items& setTravelerUseId(string travelerUseId) { DARABONBA_PTR_SET_VALUE(travelerUseId_, travelerUseId) };
        ...
        inline Items& setUserConfirmDesc(string userConfirmDesc) { DARABONBA_PTR_SET_VALUE(userConfirmDesc_, userConfirmDesc) };
        ...
        inline Items& setVehicleSceneId(string vehicleSceneId) { DARABONBA_PTR_SET_VALUE(vehicleSceneId_, vehicleSceneId) };
        ...
        inline Items& setVehicleSceneName(string vehicleSceneName) { DARABONBA_PTR_SET_VALUE(vehicleSceneName_, vehicleSceneName) };
      ...
      protected:
        shared_ptr<string> accountMonth_ {};
        ...
        shared_ptr<string> depDateLocal_ {};
        ...
        shared_ptr<string> financialSubject_ {};
        ...
        shared_ptr<string> originApplyId_ {};
        ...
        shared_ptr<string> recordStatus_ {};
        ...
        shared_ptr<string> travelerUseId_ {};
    ...
    inline IeCarBillSettlementQueryResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline IeCarBillSettlementQueryResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const IeCarBillSettlementQueryResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, IeCarBillSettlementQueryResponseBody::Module) };
    inline IeCarBillSettlementQueryResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, IeCarBillSettlementQueryResponseBody::Module) };
    inline IeCarBillSettlementQueryResponseBody& setModule(const IeCarBillSettlementQueryResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IeCarBillSettlementQueryResponseBody& setModule(IeCarBillSettlementQueryResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline IeCarBillSettlementQueryResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline IeCarBillSettlementQueryResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline IeCarBillSettlementQueryResponseBody& setTraceId(string traceId) { DARABONBA_PTR_SET_VALUE(traceId_, traceId) };
