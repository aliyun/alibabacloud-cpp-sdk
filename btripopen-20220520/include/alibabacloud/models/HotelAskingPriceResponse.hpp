...
namespace Models
{
  ...
  public:
    ...
    inline const HotelAskingPriceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HotelAskingPriceResponseBody) };
    inline HotelAskingPriceResponseBody getBody() { DARABONBA_PTR_GET(body_, HotelAskingPriceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HotelAskingPriceResponseBody> body_ {};
  };
