...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->adjustTime_ != nullptr
        ...
        && this->cascadeDepartment_ != nullptr && this->categoryDesc_ != nullptr && this->changeFee_ != nullptr && this->changeReasonCode_ != nullptr && this->changeResult_ != nullptr
        && this->corpPayOrderFee_ != nullptr && this->corpSettlePrice_ != nullptr && this->costCenter_ != nullptr && this->costCenterNumber_ != nullptr && this->costDepartment_ != nullptr
        && this->coupon_ != nullptr && this->customContent_ != nullptr && this->deductibleTax_ != nullptr && this->depAirportCode_ != nullptr && this->depCityCode_ != nullptr
        ...
        && this->flightNo_ != nullptr && this->flightTripType_ != nullptr && this->foreignersTag_ != nullptr && this->index_ != nullptr && this->insOrderId_ != nullptr
        ...
        && this->itineraryPrice_ != nullptr && this->location_ != nullptr && this->mappingCompanyCode_ != nullptr && this->mileage_ != nullptr && this->mostDifferenceDeptTime_ != nullptr
        && this->mostDifferenceDiscount_ != nullptr && this->mostDifferenceFlightNo_ != nullptr && this->mostDifferencePrice_ != nullptr && this->mostDifferenceReason_ != nullptr && this->mostPrice_ != nullptr
        && this->negotiationCouponFee_ != nullptr && this->offlineStatus_ != nullptr && this->oilFee_ != nullptr && this->orderId_ != nullptr && this->orderTicketNo_ != nullptr
        && this->overApplyId_ != nullptr && this->paymentDepartmentId_ != nullptr && this->paymentDepartmentName_ != nullptr && this->personSettlePrice_ != nullptr && this->position_ != nullptr
        && this->positionLevel_ != nullptr && this->preBookTip_ != nullptr && this->primaryId_ != nullptr && this->processorOaCode_ != nullptr && this->projectCode_ != nullptr
        && this->projectName_ != nullptr && this->refundAffiliateNo_ != nullptr && this->refundApplyId_ != nullptr && this->refundFee_ != nullptr && this->refundReasonCode_ != nullptr
        && this->refundResult_ != nullptr && this->refundUpgradeCost_ != nullptr && this->remark_ != nullptr && this->repeatRefund_ != nullptr && this->sceneId_ != nullptr
        && this->sceneName_ != nullptr && this->sealPrice_ != nullptr && this->serviceFee_ != nullptr && this->settleTypeDesc_ != nullptr && this->settlementFee_ != nullptr
        && this->settlementGrantFee_ != nullptr && this->settlementTime_ != nullptr && this->settlementType_ != nullptr && this->sio_ != nullptr && this->status_ != nullptr
        && this->statusDesc_ != nullptr && this->taxRate_ != nullptr && this->thirdItineraryId_ != nullptr && this->ticketId_ != nullptr && this->trade_ != nullptr
    ...
    inline FlightBillSettlementQueryResponseBodyModuleDataList& setApproverEmail(string approverEmail) { DARABONBA_PTR_SET_VALUE(approverEmail_, approverEmail) };
    ...
    inline FlightBillSettlementQueryResponseBodyModuleDataList& setApproverId(string approverId) { DARABONBA_PTR_SET_VALUE(approverId_, approverId) };
    ...
    inline FlightBillSettlementQueryResponseBodyModuleDataList& setApproverName(string approverName) { DARABONBA_PTR_SET_VALUE(approverName_, approverName) };
    ...
    inline FlightBillSettlementQueryResponseBodyModuleDataList& setCabinClassCode(string cabinClassCode) { DARABONBA_PTR_SET_VALUE(cabinClassCode_, cabinClassCode) };
    ...
    inline FlightBillSettlementQueryResponseBodyModuleDataList& setForeignersTag(string foreignersTag) { DARABONBA_PTR_SET_VALUE(foreignersTag_, foreignersTag) };
    ...
    inline FlightBillSettlementQueryResponseBodyModuleDataList& setLocation(string location) { DARABONBA_PTR_SET_VALUE(location_, location) };
    ...
    inline FlightBillSettlementQueryResponseBodyModuleDataList& setSio(string sio) { DARABONBA_PTR_SET_VALUE(sio_, sio) };
    ...
    inline FlightBillSettlementQueryResponseBodyModuleDataList& setTravelerEmail(string travelerEmail) { DARABONBA_PTR_SET_VALUE(travelerEmail_, travelerEmail) };
