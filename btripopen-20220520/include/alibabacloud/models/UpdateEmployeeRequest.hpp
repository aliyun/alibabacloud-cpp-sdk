...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateEmployeeRequest::BaseLocationList> & getBaseLocationList() const { DARABONBA_PTR_GET_CONST(baseLocationList_, vector<UpdateEmployeeRequest::BaseLocationList>) };
    inline vector<UpdateEmployeeRequest::BaseLocationList> getBaseLocationList() { DARABONBA_PTR_GET(baseLocationList_, vector<UpdateEmployeeRequest::BaseLocationList>) };
    inline UpdateEmployeeRequest& setBaseLocationList(const vector<UpdateEmployeeRequest::BaseLocationList> & baseLocationList) { DARABONBA_PTR_SET_VALUE(baseLocationList_, baseLocationList) };
    inline UpdateEmployeeRequest& setBaseLocationList(vector<UpdateEmployeeRequest::BaseLocationList> && baseLocationList) { DARABONBA_PTR_SET_RVALUE(baseLocationList_, baseLocationList) };
    ...
    inline const vector<UpdateEmployeeRequest::CertList> & getCertList() const { DARABONBA_PTR_GET_CONST(certList_, vector<UpdateEmployeeRequest::CertList>) };
    inline vector<UpdateEmployeeRequest::CertList> getCertList() { DARABONBA_PTR_GET(certList_, vector<UpdateEmployeeRequest::CertList>) };
    inline UpdateEmployeeRequest& setCertList(const vector<UpdateEmployeeRequest::CertList> & certList) { DARABONBA_PTR_SET_VALUE(certList_, certList) };
    inline UpdateEmployeeRequest& setCertList(vector<UpdateEmployeeRequest::CertList> && certList) { DARABONBA_PTR_SET_RVALUE(certList_, certList) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateEmployeeRequest::BaseLocationList>> baseLocationList_ {};
    shared_ptr<string> birthday_ {};
    shared_ptr<vector<UpdateEmployeeRequest::CertList>> certList_ {};
