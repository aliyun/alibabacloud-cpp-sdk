...
#ifndef ALIBABACLOUD_MODELS_UPDATEEMPLOYEEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEEMPLOYEEREQUEST_HPP_
...
namespace Models
{
  class UpdateEmployeeRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateEmployeeRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateEmployeeRequest& obj) { 
    ...
    UpdateEmployeeRequest(const UpdateEmployeeRequest &) = default ;
    UpdateEmployeeRequest(UpdateEmployeeRequest &&) = default ;
    UpdateEmployeeRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateEmployeeRequest() = default ;
    UpdateEmployeeRequest& operator=(const UpdateEmployeeRequest &) = default ;
    UpdateEmployeeRequest& operator=(UpdateEmployeeRequest &&) = default ;
    ...
    inline UpdateEmployeeRequest& setAccountEmail(string accountEmail) { DARABONBA_PTR_SET_VALUE(accountEmail_, accountEmail) };
    ...
    inline UpdateEmployeeRequest& setAccountPhone(string accountPhone) { DARABONBA_PTR_SET_VALUE(accountPhone_, accountPhone) };
    ...
    inline UpdateEmployeeRequest& setAttribute(string attribute) { DARABONBA_PTR_SET_VALUE(attribute_, attribute) };
    ...
    inline UpdateEmployeeRequest& setAvatar(string avatar) { DARABONBA_PTR_SET_VALUE(avatar_, avatar) };
    ...
    inline UpdateEmployeeRequest& setBaseCityCodeList(const vector<string> & baseCityCodeList) { DARABONBA_PTR_SET_VALUE(baseCityCodeList_, baseCityCodeList) };
    inline UpdateEmployeeRequest& setBaseCityCodeList(vector<string> && baseCityCodeList) { DARABONBA_PTR_SET_RVALUE(baseCityCodeList_, baseCityCodeList) };
    ...
    inline const vector<UpdateEmployeeRequestBaseLocationList> & baseLocationList() const { DARABONBA_PTR_GET_CONST(baseLocationList_, vector<UpdateEmployeeRequestBaseLocationList>) };
    inline vector<UpdateEmployeeRequestBaseLocationList> baseLocationList() { DARABONBA_PTR_GET(baseLocationList_, vector<UpdateEmployeeRequestBaseLocationList>) };
    inline UpdateEmployeeRequest& setBaseLocationList(const vector<UpdateEmployeeRequestBaseLocationList> & baseLocationList) { DARABONBA_PTR_SET_VALUE(baseLocationList_, baseLocationList) };
    inline UpdateEmployeeRequest& setBaseLocationList(vector<UpdateEmployeeRequestBaseLocationList> && baseLocationList) { DARABONBA_PTR_SET_RVALUE(baseLocationList_, baseLocationList) };
    ...
    inline UpdateEmployeeRequest& setBirthday(string birthday) { DARABONBA_PTR_SET_VALUE(birthday_, birthday) };


    // certList Field Functions 
    bool hasCertList() const { return this->certList_ != nullptr;};
    void deleteCertList() { this->certList_ = nullptr;};
    inline const vector<UpdateEmployeeRequestCertList> & certList() const { DARABONBA_PTR_GET_CONST(certList_, vector<UpdateEmployeeRequestCertList>) };
    inline vector<UpdateEmployeeRequestCertList> certList() { DARABONBA_PTR_GET(certList_, vector<UpdateEmployeeRequestCertList>) };
    inline UpdateEmployeeRequest& setCertList(const vector<UpdateEmployeeRequestCertList> & certList) { DARABONBA_PTR_SET_VALUE(certList_, certList) };
    inline UpdateEmployeeRequest& setCertList(vector<UpdateEmployeeRequestCertList> && certList) { DARABONBA_PTR_SET_RVALUE(certList_, certList) };
    ...
    inline UpdateEmployeeRequest& setCustomRoleCodeList(const vector<string> & customRoleCodeList) { DARABONBA_PTR_SET_VALUE(customRoleCodeList_, customRoleCodeList) };
    inline UpdateEmployeeRequest& setCustomRoleCodeList(vector<string> && customRoleCodeList) { DARABONBA_PTR_SET_RVALUE(customRoleCodeList_, customRoleCodeList) };
    ...
    inline UpdateEmployeeRequest& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline UpdateEmployeeRequest& setGender(string gender) { DARABONBA_PTR_SET_VALUE(gender_, gender) };
    ...
    inline UpdateEmployeeRequest& setIsAdmin(bool isAdmin) { DARABONBA_PTR_SET_VALUE(isAdmin_, isAdmin) };
    ...
    inline UpdateEmployeeRequest& setIsBoss(bool isBoss) { DARABONBA_PTR_SET_VALUE(isBoss_, isBoss) };
    ...
    inline UpdateEmployeeRequest& setIsDeptLeader(bool isDeptLeader) { DARABONBA_PTR_SET_VALUE(isDeptLeader_, isDeptLeader) };
    ...
    inline UpdateEmployeeRequest& setJobNo(string jobNo) { DARABONBA_PTR_SET_VALUE(jobNo_, jobNo) };
    ...
    inline UpdateEmployeeRequest& setManagerUserId(string managerUserId) { DARABONBA_PTR_SET_VALUE(managerUserId_, managerUserId) };
    ...
    inline UpdateEmployeeRequest& setOutDeptIdList(const vector<string> & outDeptIdList) { DARABONBA_PTR_SET_VALUE(outDeptIdList_, outDeptIdList) };
    inline UpdateEmployeeRequest& setOutDeptIdList(vector<string> && outDeptIdList) { DARABONBA_PTR_SET_RVALUE(outDeptIdList_, outDeptIdList) };
    ...
    inline UpdateEmployeeRequest& setPhone(string phone) { DARABONBA_PTR_SET_VALUE(phone_, phone) };
    ...
    inline UpdateEmployeeRequest& setPositionLevel(string positionLevel) { DARABONBA_PTR_SET_VALUE(positionLevel_, positionLevel) };
    ...
    inline UpdateEmployeeRequest& setRealName(string realName) { DARABONBA_PTR_SET_VALUE(realName_, realName) };
    ...
    inline UpdateEmployeeRequest& setRealNameEn(string realNameEn) { DARABONBA_PTR_SET_VALUE(realNameEn_, realNameEn) };
    ...
    inline UpdateEmployeeRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline UpdateEmployeeRequest& setUserNick(string userNick) { DARABONBA_PTR_SET_VALUE(userNick_, userNick) };
  ...
  protected:
    ...
    std::shared_ptr<vector<UpdateEmployeeRequestBaseLocationList>> baseLocationList_ = nullptr;
    std::shared_ptr<string> birthday_ = nullptr;
    std::shared_ptr<vector<UpdateEmployeeRequestCertList>> certList_ = nullptr;
