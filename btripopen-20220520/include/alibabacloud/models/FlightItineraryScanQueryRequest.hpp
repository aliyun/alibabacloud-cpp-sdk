...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->billDate_ == nullptr
        && this->billId_ == nullptr && this->invoiceSubTaskId_ == nullptr && this->itineraryNum_ == nullptr && this->orderId_ == nullptr && this->pageNo_ == nullptr
        && this->pageSize_ == nullptr && this->ticketNo_ == nullptr; };
    ...
    inline FlightItineraryScanQueryRequest& setOrderId(int64_t orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
