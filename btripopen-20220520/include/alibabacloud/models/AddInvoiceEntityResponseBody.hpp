...
namespace Models
{
  ...
  public:
    ...
    inline const AddInvoiceEntityResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, AddInvoiceEntityResponseBodyModule) };
    inline AddInvoiceEntityResponseBodyModule module() { DARABONBA_PTR_GET(module_, AddInvoiceEntityResponseBodyModule) };
    inline AddInvoiceEntityResponseBody& setModule(const AddInvoiceEntityResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline AddInvoiceEntityResponseBody& setModule(AddInvoiceEntityResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<AddInvoiceEntityResponseBodyModule> module_ = nullptr;
