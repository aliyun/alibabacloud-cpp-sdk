...
#ifndef ALIBABACLOUD_MODELS_CARORDERLISTQUERYRESPONSEBODYMODULEPRICEINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_CARORDERLISTQUERYRESPONSEBODYMODULEPRICEINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CarOrderListQueryResponseBodyModulePriceInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CarOrderListQueryResponseBodyModulePriceInfoList& obj) { 
    ...
    CarOrderListQueryResponseBodyModulePriceInfoList() = default ;
    CarOrderListQueryResponseBodyModulePriceInfoList(const CarOrderListQueryResponseBodyModulePriceInfoList &) = default ;
    CarOrderListQueryResponseBodyModulePriceInfoList(CarOrderListQueryResponseBodyModulePriceInfoList &&) = default ;
    CarOrderListQueryResponseBodyModulePriceInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CarOrderListQueryResponseBodyModulePriceInfoList() = default ;
    CarOrderListQueryResponseBodyModulePriceInfoList& operator=(const CarOrderListQueryResponseBodyModulePriceInfoList &) = default ;
    CarOrderListQueryResponseBodyModulePriceInfoList& operator=(CarOrderListQueryResponseBodyModulePriceInfoList &&) = default ;
    ...
    inline CarOrderListQueryResponseBodyModulePriceInfoList& setCategoryCode(int32_t categoryCode) { DARABONBA_PTR_SET_VALUE(categoryCode_, categoryCode) };
    ...
    inline CarOrderListQueryResponseBodyModulePriceInfoList& setCategoryType(int32_t categoryType) { DARABONBA_PTR_SET_VALUE(categoryType_, categoryType) };
    ...
    inline CarOrderListQueryResponseBodyModulePriceInfoList& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline CarOrderListQueryResponseBodyModulePriceInfoList& setPassengerName(string passengerName) { DARABONBA_PTR_SET_VALUE(passengerName_, passengerName) };
    ...
    inline CarOrderListQueryResponseBodyModulePriceInfoList& setPayType(int32_t payType) { DARABONBA_PTR_SET_VALUE(payType_, payType) };
    ...
    inline double personPrice() const { DARABONBA_PTR_GET_DEFAULT(personPrice_, 0.0) };
    inline CarOrderListQueryResponseBodyModulePriceInfoList& setPersonPrice(double personPrice) { DARABONBA_PTR_SET_VALUE(personPrice_, personPrice) };
    ...
    inline CarOrderListQueryResponseBodyModulePriceInfoList& setPrice(double price) { DARABONBA_PTR_SET_VALUE(price_, price) };
    ...
    inline CarOrderListQueryResponseBodyModulePriceInfoList& setTradeId(string tradeId) { DARABONBA_PTR_SET_VALUE(tradeId_, tradeId) };
    ...
    inline CarOrderListQueryResponseBodyModulePriceInfoList& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
  ...
  protected:
    ...
    std::shared_ptr<double> personPrice_ = nullptr;
