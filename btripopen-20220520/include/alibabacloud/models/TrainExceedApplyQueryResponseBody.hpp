...
namespace Models
{
  ...
  public:
    ...
    inline const TrainExceedApplyQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TrainExceedApplyQueryResponseBodyModule) };
    inline TrainExceedApplyQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, TrainExceedApplyQueryResponseBodyModule) };
    inline TrainExceedApplyQueryResponseBody& setModule(const TrainExceedApplyQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainExceedApplyQueryResponseBody& setModule(TrainExceedApplyQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TrainExceedApplyQueryResponseBodyModule> module_ = nullptr;
