...
namespace Models
{
  ...
  public:
    ...
    inline const HotelPricePullResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelPricePullResponseBodyModule) };
    inline HotelPricePullResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelPricePullResponseBodyModule) };
    inline HotelPricePullResponseBody& setModule(const HotelPricePullResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelPricePullResponseBody& setModule(HotelPricePullResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelPricePullResponseBodyModule> module_ = nullptr;
