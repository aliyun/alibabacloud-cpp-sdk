...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline RefundTrainInfos& setArrStationCode(string arrStationCode) { DARABONBA_PTR_SET_VALUE(arrStationCode_, arrStationCode) };
      ...
      inline RefundTrainInfos& setDepStationCode(string depStationCode) { DARABONBA_PTR_SET_VALUE(depStationCode_, depStationCode) };
    ...
    inline const vector<TrainFeeCalculateRefundRequest::RefundTrainInfos> & getRefundTrainInfos() const { DARABONBA_PTR_GET_CONST(refundTrainInfos_, vector<TrainFeeCalculateRefundRequest::RefundTrainInfos>) };
    inline vector<TrainFeeCalculateRefundRequest::RefundTrainInfos> getRefundTrainInfos() { DARABONBA_PTR_GET(refundTrainInfos_, vector<TrainFeeCalculateRefundRequest::RefundTrainInfos>) };
    inline TrainFeeCalculateRefundRequest& setRefundTrainInfos(const vector<TrainFeeCalculateRefundRequest::RefundTrainInfos> & refundTrainInfos) { DARABONBA_PTR_SET_VALUE(refundTrainInfos_, refundTrainInfos) };
    inline TrainFeeCalculateRefundRequest& setRefundTrainInfos(vector<TrainFeeCalculateRefundRequest::RefundTrainInfos> && refundTrainInfos) { DARABONBA_PTR_SET_RVALUE(refundTrainInfos_, refundTrainInfos) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<TrainFeeCalculateRefundRequest::RefundTrainInfos>> refundTrainInfos_ {};
  };
