...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyAddResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApplyAddResponseBody) };
    inline ApplyAddResponseBody getBody() { DARABONBA_PTR_GET(body_, ApplyAddResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApplyAddResponseBody> body_ {};
  };
