...
namespace Models
{
  ...
  public:
    ...
    inline const HotelOrderCreateResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelOrderCreateResponseBodyModule) };
    inline HotelOrderCreateResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelOrderCreateResponseBodyModule) };
    inline HotelOrderCreateResponseBody& setModule(const HotelOrderCreateResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelOrderCreateResponseBody& setModule(HotelOrderCreateResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelOrderCreateResponseBodyModule> module_ = nullptr;
