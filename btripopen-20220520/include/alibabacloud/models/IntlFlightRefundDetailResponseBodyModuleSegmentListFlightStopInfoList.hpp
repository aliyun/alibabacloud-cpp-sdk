...
#ifndef ALIBABACLOUD_MODELS_INTLFLIGHTREFUNDDETAILRESPONSEBODYMODULESEGMENTLISTFLIGHTSTOPINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_INTLFLIGHTREFUNDDETAILRESPONSEBODYMODULESEGMENTLISTFLIGHTSTOPINFOLIST_HPP_
...
namespace Models
{
  class IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& obj) { 
    ...
    IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList() = default ;
    IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList(const IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList &) = default ;
    IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList(IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList &&) = default ;
    IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList() = default ;
    IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& operator=(const IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList &) = default ;
    IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& operator=(IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList &&) = default ;
    ...
    inline IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& setStopAirport(string stopAirport) { DARABONBA_PTR_SET_VALUE(stopAirport_, stopAirport) };
    ...
    inline IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& setStopAirportName(string stopAirportName) { DARABONBA_PTR_SET_VALUE(stopAirportName_, stopAirportName) };
    ...
    inline IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& setStopArrTerm(string stopArrTerm) { DARABONBA_PTR_SET_VALUE(stopArrTerm_, stopArrTerm) };
    ...
    inline IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& setStopArrTime(string stopArrTime) { DARABONBA_PTR_SET_VALUE(stopArrTime_, stopArrTime) };
    ...
    inline IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& setStopCityCode(string stopCityCode) { DARABONBA_PTR_SET_VALUE(stopCityCode_, stopCityCode) };
    ...
    inline IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& setStopCityName(string stopCityName) { DARABONBA_PTR_SET_VALUE(stopCityName_, stopCityName) };
    ...
    inline IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& setStopDepTerm(string stopDepTerm) { DARABONBA_PTR_SET_VALUE(stopDepTerm_, stopDepTerm) };
    ...
    inline IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& setStopDepTime(string stopDepTime) { DARABONBA_PTR_SET_VALUE(stopDepTime_, stopDepTime) };
    ...
    inline IntlFlightRefundDetailResponseBodyModuleSegmentListFlightStopInfoList& setStopTime(string stopTime) { DARABONBA_PTR_SET_VALUE(stopTime_, stopTime) };
