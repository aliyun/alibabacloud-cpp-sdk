...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ModuleItemListShoppingItemMapValue::CabinQuantityList> & getCabinQuantityList() const { DARABONBA_PTR_GET_CONST(cabinQuantityList_, vector<ModuleItemListShoppingItemMapValue::CabinQuantityList>) };
    inline vector<ModuleItemListShoppingItemMapValue::CabinQuantityList> getCabinQuantityList() { DARABONBA_PTR_GET(cabinQuantityList_, vector<ModuleItemListShoppingItemMapValue::CabinQuantityList>) };
    inline ModuleItemListShoppingItemMapValue& setCabinQuantityList(const vector<ModuleItemListShoppingItemMapValue::CabinQuantityList> & cabinQuantityList) { DARABONBA_PTR_SET_VALUE(cabinQuantityList_, cabinQuantityList) };
    inline ModuleItemListShoppingItemMapValue& setCabinQuantityList(vector<ModuleItemListShoppingItemMapValue::CabinQuantityList> && cabinQuantityList) { DARABONBA_PTR_SET_RVALUE(cabinQuantityList_, cabinQuantityList) };


    // searchPrice Field Functions 
    bool hasSearchPrice() const { return this->searchPrice_ != nullptr;};
    void deleteSearchPrice() { this->searchPrice_ = nullptr;};
    inline const ModuleItemListShoppingItemMapValue::SearchPrice & getSearchPrice() const { DARABONBA_PTR_GET_CONST(searchPrice_, ModuleItemListShoppingItemMapValue::SearchPrice) };
    inline ModuleItemListShoppingItemMapValue::SearchPrice getSearchPrice() { DARABONBA_PTR_GET(searchPrice_, ModuleItemListShoppingItemMapValue::SearchPrice) };
    inline ModuleItemListShoppingItemMapValue& setSearchPrice(const ModuleItemListShoppingItemMapValue::SearchPrice & searchPrice) { DARABONBA_PTR_SET_VALUE(searchPrice_, searchPrice) };
    inline ModuleItemListShoppingItemMapValue& setSearchPrice(ModuleItemListShoppingItemMapValue::SearchPrice && searchPrice) { DARABONBA_PTR_SET_RVALUE(searchPrice_, searchPrice) };
    ...
    inline const vector<ModuleItemListShoppingItemMapValue::SegmentPriceList> & getSegmentPriceList() const { DARABONBA_PTR_GET_CONST(segmentPriceList_, vector<ModuleItemListShoppingItemMapValue::SegmentPriceList>) };
    inline vector<ModuleItemListShoppingItemMapValue::SegmentPriceList> getSegmentPriceList() { DARABONBA_PTR_GET(segmentPriceList_, vector<ModuleItemListShoppingItemMapValue::SegmentPriceList>) };
    inline ModuleItemListShoppingItemMapValue& setSegmentPriceList(const vector<ModuleItemListShoppingItemMapValue::SegmentPriceList> & segmentPriceList) { DARABONBA_PTR_SET_VALUE(segmentPriceList_, segmentPriceList) };
    inline ModuleItemListShoppingItemMapValue& setSegmentPriceList(vector<ModuleItemListShoppingItemMapValue::SegmentPriceList> && segmentPriceList) { DARABONBA_PTR_SET_RVALUE(segmentPriceList_, segmentPriceList) };
    ...
    inline const map<string, ModuleItemListShoppingItemMapValueCabinQuantityValue> & getCabinQuantity() const { DARABONBA_PTR_GET_CONST(cabinQuantity_, map<string, ModuleItemListShoppingItemMapValueCabinQuantityValue>) };
    inline map<string, ModuleItemListShoppingItemMapValueCabinQuantityValue> getCabinQuantity() { DARABONBA_PTR_GET(cabinQuantity_, map<string, ModuleItemListShoppingItemMapValueCabinQuantityValue>) };
    ...
    inline const map<string, ModuleItemListShoppingItemMapValueSegmentPriceValue> & getSegmentPrice() const { DARABONBA_PTR_GET_CONST(segmentPrice_, map<string, ModuleItemListShoppingItemMapValueSegmentPriceValue>) };
    inline map<string, ModuleItemListShoppingItemMapValueSegmentPriceValue> getSegmentPrice() { DARABONBA_PTR_GET(segmentPrice_, map<string, ModuleItemListShoppingItemMapValueSegmentPriceValue>) };
  ...
  protected:
    shared_ptr<vector<ModuleItemListShoppingItemMapValue::CabinQuantityList>> cabinQuantityList_ {};
    shared_ptr<ModuleItemListShoppingItemMapValue::SearchPrice> searchPrice_ {};
    shared_ptr<vector<ModuleItemListShoppingItemMapValue::SegmentPriceList>> segmentPriceList_ {};
    // id
    shared_ptr<string> id_ {};
    shared_ptr<map<string, ModuleItemListShoppingItemMapValueCabinQuantityValue>> cabinQuantity_ {};
    shared_ptr<map<string, ModuleItemListShoppingItemMapValueSegmentPriceValue>> segmentPrice_ {};
  };
