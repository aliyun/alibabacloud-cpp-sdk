...
#ifndef ALIBABACLOUD_MODELS_FLIGHTLISTINGSEARCHREQUEST_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTLISTINGSEARCHREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightListingSearchRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightListingSearchRequest& obj) { 
    ...
    FlightListingSearchRequest() = default ;
    FlightListingSearchRequest(const FlightListingSearchRequest &) = default ;
    FlightListingSearchRequest(FlightListingSearchRequest &&) = default ;
    FlightListingSearchRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightListingSearchRequest() = default ;
    FlightListingSearchRequest& operator=(const FlightListingSearchRequest &) = default ;
    FlightListingSearchRequest& operator=(FlightListingSearchRequest &&) = default ;
