...
namespace Models
{
  ...
  public:
    ...
    inline const QueryReimbursementOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryReimbursementOrderResponseBody) };
    inline QueryReimbursementOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryReimbursementOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryReimbursementOrderResponseBody> body_ {};
  };
