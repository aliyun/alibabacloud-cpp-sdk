...
namespace Models
{
  ...
  public:
    ...
    inline const FlightRefundPreCalResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightRefundPreCalResponseBodyModule) };
    inline FlightRefundPreCalResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightRefundPreCalResponseBodyModule) };
    inline FlightRefundPreCalResponseBody& setModule(const FlightRefundPreCalResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightRefundPreCalResponseBody& setModule(FlightRefundPreCalResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<FlightRefundPreCalResponseBodyModule> module_ = nullptr;
