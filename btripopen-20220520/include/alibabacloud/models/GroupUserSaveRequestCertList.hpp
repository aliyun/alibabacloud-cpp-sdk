...
#ifndef ALIBABACLOUD_MODELS_GROUPUSERSAVEREQUESTCERTLIST_HPP_
#define ALIBABACLOUD_MODELS_GROUPUSERSAVEREQUESTCERTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GroupUserSaveRequestCertList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GroupUserSaveRequestCertList& obj) { 
    ...
    GroupUserSaveRequestCertList() = default ;
    GroupUserSaveRequestCertList(const GroupUserSaveRequestCertList &) = default ;
    GroupUserSaveRequestCertList(GroupUserSaveRequestCertList &&) = default ;
    GroupUserSaveRequestCertList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GroupUserSaveRequestCertList() = default ;
    GroupUserSaveRequestCertList& operator=(const GroupUserSaveRequestCertList &) = default ;
    GroupUserSaveRequestCertList& operator=(GroupUserSaveRequestCertList &&) = default ;
    ...
    inline GroupUserSaveRequestCertList& setCertExpiredTime(string certExpiredTime) { DARABONBA_PTR_SET_VALUE(certExpiredTime_, certExpiredTime) };
    ...
    inline GroupUserSaveRequestCertList& setCertNation(string certNation) { DARABONBA_PTR_SET_VALUE(certNation_, certNation) };
    ...
    inline GroupUserSaveRequestCertList& setCertNo(string certNo) { DARABONBA_PTR_SET_VALUE(certNo_, certNo) };
    ...
    inline GroupUserSaveRequestCertList& setCertType(int32_t certType) { DARABONBA_PTR_SET_VALUE(certType_, certType) };
    ...
    inline GroupUserSaveRequestCertList& setNationality(string nationality) { DARABONBA_PTR_SET_VALUE(nationality_, nationality) };
