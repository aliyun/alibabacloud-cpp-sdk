...
namespace Models
{
  ...
  public:
    ...
    inline const TrainOrderQueryV2ResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TrainOrderQueryV2ResponseBodyModule) };
    inline TrainOrderQueryV2ResponseBodyModule module() { DARABONBA_PTR_GET(module_, TrainOrderQueryV2ResponseBodyModule) };
    inline TrainOrderQueryV2ResponseBody& setModule(const TrainOrderQueryV2ResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainOrderQueryV2ResponseBody& setModule(TrainOrderQueryV2ResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TrainOrderQueryV2ResponseBodyModule> module_ = nullptr;
    // requestId
