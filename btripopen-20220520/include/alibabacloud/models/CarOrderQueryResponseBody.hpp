...
namespace Models
{
  ...
  public:
    ...
    inline const CarOrderQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, CarOrderQueryResponseBodyModule) };
    inline CarOrderQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, CarOrderQueryResponseBodyModule) };
    inline CarOrderQueryResponseBody& setModule(const CarOrderQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline CarOrderQueryResponseBody& setModule(CarOrderQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<CarOrderQueryResponseBodyModule> module_ = nullptr;
    // requestId
