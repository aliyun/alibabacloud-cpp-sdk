...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ModuleItemListSubItemsShoppingItemMapValue::CabinQuantityList> & getCabinQuantityList() const { DARABONBA_PTR_GET_CONST(cabinQuantityList_, vector<ModuleItemListSubItemsShoppingItemMapValue::CabinQuantityList>) };
    inline vector<ModuleItemListSubItemsShoppingItemMapValue::CabinQuantityList> getCabinQuantityList() { DARABONBA_PTR_GET(cabinQuantityList_, vector<ModuleItemListSubItemsShoppingItemMapValue::CabinQuantityList>) };
    inline ModuleItemListSubItemsShoppingItemMapValue& setCabinQuantityList(const vector<ModuleItemListSubItemsShoppingItemMapValue::CabinQuantityList> & cabinQuantityList) { DARABONBA_PTR_SET_VALUE(cabinQuantityList_, cabinQuantityList) };
    inline ModuleItemListSubItemsShoppingItemMapValue& setCabinQuantityList(vector<ModuleItemListSubItemsShoppingItemMapValue::CabinQuantityList> && cabinQuantityList) { DARABONBA_PTR_SET_RVALUE(cabinQuantityList_, cabinQuantityList) };


    // searchPrice Field Functions 
    bool hasSearchPrice() const { return this->searchPrice_ != nullptr;};
    void deleteSearchPrice() { this->searchPrice_ = nullptr;};
    inline const ModuleItemListSubItemsShoppingItemMapValue::SearchPrice & getSearchPrice() const { DARABONBA_PTR_GET_CONST(searchPrice_, ModuleItemListSubItemsShoppingItemMapValue::SearchPrice) };
    inline ModuleItemListSubItemsShoppingItemMapValue::SearchPrice getSearchPrice() { DARABONBA_PTR_GET(searchPrice_, ModuleItemListSubItemsShoppingItemMapValue::SearchPrice) };
    inline ModuleItemListSubItemsShoppingItemMapValue& setSearchPrice(const ModuleItemListSubItemsShoppingItemMapValue::SearchPrice & searchPrice) { DARABONBA_PTR_SET_VALUE(searchPrice_, searchPrice) };
    inline ModuleItemListSubItemsShoppingItemMapValue& setSearchPrice(ModuleItemListSubItemsShoppingItemMapValue::SearchPrice && searchPrice) { DARABONBA_PTR_SET_RVALUE(searchPrice_, searchPrice) };
    ...
    inline const vector<ModuleItemListSubItemsShoppingItemMapValue::SegmentPriceList> & getSegmentPriceList() const { DARABONBA_PTR_GET_CONST(segmentPriceList_, vector<ModuleItemListSubItemsShoppingItemMapValue::SegmentPriceList>) };
    inline vector<ModuleItemListSubItemsShoppingItemMapValue::SegmentPriceList> getSegmentPriceList() { DARABONBA_PTR_GET(segmentPriceList_, vector<ModuleItemListSubItemsShoppingItemMapValue::SegmentPriceList>) };
    inline ModuleItemListSubItemsShoppingItemMapValue& setSegmentPriceList(const vector<ModuleItemListSubItemsShoppingItemMapValue::SegmentPriceList> & segmentPriceList) { DARABONBA_PTR_SET_VALUE(segmentPriceList_, segmentPriceList) };
    inline ModuleItemListSubItemsShoppingItemMapValue& setSegmentPriceList(vector<ModuleItemListSubItemsShoppingItemMapValue::SegmentPriceList> && segmentPriceList) { DARABONBA_PTR_SET_RVALUE(segmentPriceList_, segmentPriceList) };
    ...
    inline const map<string, ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue> & getCabinQuantity() const { DARABONBA_PTR_GET_CONST(cabinQuantity_, map<string, ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue>) };
    inline map<string, ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue> getCabinQuantity() { DARABONBA_PTR_GET(cabinQuantity_, map<string, ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue>) };
    ...
    inline const map<string, ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue> & getSegmentPrice() const { DARABONBA_PTR_GET_CONST(segmentPrice_, map<string, ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue>) };
    inline map<string, ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue> getSegmentPrice() { DARABONBA_PTR_GET(segmentPrice_, map<string, ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue>) };
  ...
  protected:
    shared_ptr<vector<ModuleItemListSubItemsShoppingItemMapValue::CabinQuantityList>> cabinQuantityList_ {};
    shared_ptr<ModuleItemListSubItemsShoppingItemMapValue::SearchPrice> searchPrice_ {};
    shared_ptr<vector<ModuleItemListSubItemsShoppingItemMapValue::SegmentPriceList>> segmentPriceList_ {};
    shared_ptr<string> id_ {};
    shared_ptr<map<string, ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue>> cabinQuantity_ {};
    shared_ptr<map<string, ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue>> segmentPrice_ {};
  };
