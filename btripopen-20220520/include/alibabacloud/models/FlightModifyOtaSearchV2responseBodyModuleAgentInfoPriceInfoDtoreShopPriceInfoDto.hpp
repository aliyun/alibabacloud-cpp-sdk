...
#ifndef ALIBABACLOUD_MODELS_FLIGHTMODIFYOTASEARCHV2RESPONSEBODYMODULEAGENTINFOPRICEINFODTORESHOPPRICEINFODTO_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTMODIFYOTASEARCHV2RESPONSEBODYMODULEAGENTINFOPRICEINFODTORESHOPPRICEINFODTO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& obj) { 
    ...
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO() = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO(const FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO &) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO(FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO &&) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO() = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& operator=(const FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO &) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& operator=(FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO &&) = default ;
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& setReShopAdultChangeFee(int32_t reShopAdultChangeFee) { DARABONBA_PTR_SET_VALUE(reShopAdultChangeFee_, reShopAdultChangeFee) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& setReShopAdultPrice(int32_t reShopAdultPrice) { DARABONBA_PTR_SET_VALUE(reShopAdultPrice_, reShopAdultPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& setReShopAdultPriceGap(int32_t reShopAdultPriceGap) { DARABONBA_PTR_SET_VALUE(reShopAdultPriceGap_, reShopAdultPriceGap) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& setReShopChildChangeFee(int32_t reShopChildChangeFee) { DARABONBA_PTR_SET_VALUE(reShopChildChangeFee_, reShopChildChangeFee) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& setReShopChildPrice(int32_t reShopChildPrice) { DARABONBA_PTR_SET_VALUE(reShopChildPrice_, reShopChildPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& setReShopChildPriceGap(int32_t reShopChildPriceGap) { DARABONBA_PTR_SET_VALUE(reShopChildPriceGap_, reShopChildPriceGap) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& setReShopInfChangeFee(int32_t reShopInfChangeFee) { DARABONBA_PTR_SET_VALUE(reShopInfChangeFee_, reShopInfChangeFee) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& setReShopInfPrice(int32_t reShopInfPrice) { DARABONBA_PTR_SET_VALUE(reShopInfPrice_, reShopInfPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO& setReShopInfPriceGap(int32_t reShopInfPriceGap) { DARABONBA_PTR_SET_VALUE(reShopInfPriceGap_, reShopInfPriceGap) };
