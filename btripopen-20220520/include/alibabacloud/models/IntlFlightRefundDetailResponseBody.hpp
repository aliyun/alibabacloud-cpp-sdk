...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightRefundDetailResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightRefundDetailResponseBodyModule) };
    inline IntlFlightRefundDetailResponseBodyModule module() { DARABONBA_PTR_GET(module_, IntlFlightRefundDetailResponseBodyModule) };
    inline IntlFlightRefundDetailResponseBody& setModule(const IntlFlightRefundDetailResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightRefundDetailResponseBody& setModule(IntlFlightRefundDetailResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IntlFlightRefundDetailResponseBodyModule> module_ = nullptr;
