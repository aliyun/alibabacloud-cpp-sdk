...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryGroupCorpListResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<QueryGroupCorpListResponseBodyModule>) };
    inline vector<QueryGroupCorpListResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<QueryGroupCorpListResponseBodyModule>) };
    inline QueryGroupCorpListResponseBody& setModule(const vector<QueryGroupCorpListResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline QueryGroupCorpListResponseBody& setModule(vector<QueryGroupCorpListResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryGroupCorpListResponseBodyModule>> module_ = nullptr;
