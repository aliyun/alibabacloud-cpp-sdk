...
namespace Models
{
  ...
  public:
    ...
    inline const InsureOrderCreateResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, InsureOrderCreateResponseBodyModule) };
    inline InsureOrderCreateResponseBodyModule module() { DARABONBA_PTR_GET(module_, InsureOrderCreateResponseBodyModule) };
    inline InsureOrderCreateResponseBody& setModule(const InsureOrderCreateResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline InsureOrderCreateResponseBody& setModule(InsureOrderCreateResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<InsureOrderCreateResponseBodyModule> module_ = nullptr;
