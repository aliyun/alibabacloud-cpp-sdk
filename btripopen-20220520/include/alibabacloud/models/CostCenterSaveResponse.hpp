...
namespace Models
{
  ...
  public:
    ...
    inline const CostCenterSaveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CostCenterSaveResponseBody) };
    inline CostCenterSaveResponseBody getBody() { DARABONBA_PTR_GET(body_, CostCenterSaveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CostCenterSaveResponseBody> body_ {};
  };
