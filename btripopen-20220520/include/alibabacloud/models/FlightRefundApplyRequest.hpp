...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->corpRefundPrice_ == nullptr
    ...
    inline int64_t getCorpRefundPrice() const { DARABONBA_PTR_GET_DEFAULT(corpRefundPrice_, 0L) };
    ...
    inline string getDisplayRefundMoney() const { DARABONBA_PTR_GET_DEFAULT(displayRefundMoney_, "") };
    ...
    inline string getItemUnitIds() const { DARABONBA_PTR_GET_DEFAULT(itemUnitIds_, "") };
    ...
    inline const vector<FlightRefundApplyRequest::PassengerSegmentInfoList> & getPassengerSegmentInfoList() const { DARABONBA_PTR_GET_CONST(passengerSegmentInfoList_, vector<FlightRefundApplyRequest::PassengerSegmentInfoList>) };
    inline vector<FlightRefundApplyRequest::PassengerSegmentInfoList> getPassengerSegmentInfoList() { DARABONBA_PTR_GET(passengerSegmentInfoList_, vector<FlightRefundApplyRequest::PassengerSegmentInfoList>) };
    inline FlightRefundApplyRequest& setPassengerSegmentInfoList(const vector<FlightRefundApplyRequest::PassengerSegmentInfoList> & passengerSegmentInfoList) { DARABONBA_PTR_SET_VALUE(passengerSegmentInfoList_, passengerSegmentInfoList) };
    inline FlightRefundApplyRequest& setPassengerSegmentInfoList(vector<FlightRefundApplyRequest::PassengerSegmentInfoList> && passengerSegmentInfoList) { DARABONBA_PTR_SET_RVALUE(passengerSegmentInfoList_, passengerSegmentInfoList) };
    ...
    inline int64_t getPersonalRefundPrice() const { DARABONBA_PTR_GET_DEFAULT(personalRefundPrice_, 0L) };
    ...
    inline const vector<string> & getRefundVoucherInfo() const { DARABONBA_PTR_GET_CONST(refundVoucherInfo_, vector<string>) };
    inline vector<string> getRefundVoucherInfo() { DARABONBA_PTR_GET(refundVoucherInfo_, vector<string>) };
  ...
  protected:
    shared_ptr<int64_t> corpRefundPrice_ {};
    // This parameter is required.
    shared_ptr<string> disOrderId_ {};
    // This parameter is required.
    shared_ptr<string> disSubOrderId_ {};
    // This parameter is required.
    shared_ptr<string> displayRefundMoney_ {};
    shared_ptr<map<string, string>> extra_ {};
    // This parameter is required.
    shared_ptr<int32_t> isVoluntary_ {};
    // This parameter is required.
    shared_ptr<string> itemUnitIds_ {};
    shared_ptr<vector<FlightRefundApplyRequest::PassengerSegmentInfoList>> passengerSegmentInfoList_ {};
    shared_ptr<int64_t> personalRefundPrice_ {};
    shared_ptr<string> reasonDetail_ {};
    // This parameter is required.
    shared_ptr<int32_t> reasonType_ {};
    shared_ptr<vector<string>> refundVoucherInfo_ {};
    // This parameter is required.
