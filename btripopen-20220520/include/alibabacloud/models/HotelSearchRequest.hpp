...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getBrandCode() const { DARABONBA_PTR_GET_CONST(brandCode_, vector<string>) };
    inline vector<string> getBrandCode() { DARABONBA_PTR_GET(brandCode_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> brandCode_ {};
