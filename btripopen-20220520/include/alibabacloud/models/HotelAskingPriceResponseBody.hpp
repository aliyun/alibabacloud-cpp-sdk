...
namespace Models
{
  ...
  public:
    ...
    inline const HotelAskingPriceResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelAskingPriceResponseBodyModule) };
    inline HotelAskingPriceResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelAskingPriceResponseBodyModule) };
    inline HotelAskingPriceResponseBody& setModule(const HotelAskingPriceResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelAskingPriceResponseBody& setModule(HotelAskingPriceResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelAskingPriceResponseBodyModule> module_ = nullptr;
