...
namespace Models
{
  ...
  public:
    ...
    inline const GroupDepartSaveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GroupDepartSaveResponseBody) };
    inline GroupDepartSaveResponseBody getBody() { DARABONBA_PTR_GET(body_, GroupDepartSaveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GroupDepartSaveResponseBody> body_ {};
  };
