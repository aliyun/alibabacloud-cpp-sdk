...
namespace Models
{
  ...
  public:
    ...
    inline const InsureOrderPayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InsureOrderPayResponseBody) };
    inline InsureOrderPayResponseBody getBody() { DARABONBA_PTR_GET(body_, InsureOrderPayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InsureOrderPayResponseBody> body_ {};
  };
