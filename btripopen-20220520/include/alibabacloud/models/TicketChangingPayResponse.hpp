...
namespace Models
{
  ...
  public:
    ...
    inline const TicketChangingPayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TicketChangingPayResponseBody) };
    inline TicketChangingPayResponseBody getBody() { DARABONBA_PTR_GET(body_, TicketChangingPayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TicketChangingPayResponseBody> body_ {};
  };
