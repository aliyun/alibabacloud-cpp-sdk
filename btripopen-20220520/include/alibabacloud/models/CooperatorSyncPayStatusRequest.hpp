...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cooperatorOrderId_ == nullptr
    ...
    inline string getCooperatorPayNo() const { DARABONBA_PTR_GET_DEFAULT(cooperatorPayNo_, "") };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<string> cooperatorPayNo_ {};
    // This parameter is required.
