...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightReShopConsultResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightReShopConsultResponseBodyModule) };
    inline IntlFlightReShopConsultResponseBodyModule module() { DARABONBA_PTR_GET(module_, IntlFlightReShopConsultResponseBodyModule) };
    inline IntlFlightReShopConsultResponseBody& setModule(const IntlFlightReShopConsultResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightReShopConsultResponseBody& setModule(IntlFlightReShopConsultResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IntlFlightReShopConsultResponseBodyModule> module_ = nullptr;
