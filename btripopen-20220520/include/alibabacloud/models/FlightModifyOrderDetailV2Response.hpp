...
namespace Models
{
  ...
  public:
    ...
    inline const FlightModifyOrderDetailV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FlightModifyOrderDetailV2ResponseBody) };
    inline FlightModifyOrderDetailV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, FlightModifyOrderDetailV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FlightModifyOrderDetailV2ResponseBody> body_ {};
  };
