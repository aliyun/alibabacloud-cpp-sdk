...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightOtaSearchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IntlFlightOtaSearchResponseBody) };
    inline IntlFlightOtaSearchResponseBody getBody() { DARABONBA_PTR_GET(body_, IntlFlightOtaSearchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IntlFlightOtaSearchResponseBody> body_ {};
  };
