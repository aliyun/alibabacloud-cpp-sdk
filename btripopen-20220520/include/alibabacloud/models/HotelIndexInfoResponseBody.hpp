...
namespace Models
{
  ...
  public:
    ...
    inline const HotelIndexInfoResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelIndexInfoResponseBodyModule) };
    inline HotelIndexInfoResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelIndexInfoResponseBodyModule) };
    inline HotelIndexInfoResponseBody& setModule(const HotelIndexInfoResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelIndexInfoResponseBody& setModule(HotelIndexInfoResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelIndexInfoResponseBodyModule> module_ = nullptr;
