...
#ifndef ALIBABACLOUD_MODELS_FLIGHTCREATEORDERV2REQUESTCONTACTINFO_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTCREATEORDERV2REQUESTCONTACTINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightCreateOrderV2RequestContactInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightCreateOrderV2RequestContactInfo& obj) { 
    ...
    FlightCreateOrderV2RequestContactInfo() = default ;
    FlightCreateOrderV2RequestContactInfo(const FlightCreateOrderV2RequestContactInfo &) = default ;
    FlightCreateOrderV2RequestContactInfo(FlightCreateOrderV2RequestContactInfo &&) = default ;
    FlightCreateOrderV2RequestContactInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightCreateOrderV2RequestContactInfo() = default ;
    FlightCreateOrderV2RequestContactInfo& operator=(const FlightCreateOrderV2RequestContactInfo &) = default ;
    FlightCreateOrderV2RequestContactInfo& operator=(FlightCreateOrderV2RequestContactInfo &&) = default ;
    ...
    inline FlightCreateOrderV2RequestContactInfo& setContactEmail(string contactEmail) { DARABONBA_PTR_SET_VALUE(contactEmail_, contactEmail) };
    ...
    inline FlightCreateOrderV2RequestContactInfo& setContactName(string contactName) { DARABONBA_PTR_SET_VALUE(contactName_, contactName) };
    ...
    inline FlightCreateOrderV2RequestContactInfo& setContactPhone(string contactPhone) { DARABONBA_PTR_SET_VALUE(contactPhone_, contactPhone) };
    ...
    inline FlightCreateOrderV2RequestContactInfo& setSendMsgToPassenger(bool sendMsgToPassenger) { DARABONBA_PTR_SET_VALUE(sendMsgToPassenger_, sendMsgToPassenger) };
