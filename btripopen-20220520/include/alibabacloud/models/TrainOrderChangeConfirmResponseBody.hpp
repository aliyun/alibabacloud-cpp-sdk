...
namespace Models
{
  ...
  public:
    ...
    inline const TrainOrderChangeConfirmResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TrainOrderChangeConfirmResponseBodyModule) };
    inline TrainOrderChangeConfirmResponseBodyModule module() { DARABONBA_PTR_GET(module_, TrainOrderChangeConfirmResponseBodyModule) };
    inline TrainOrderChangeConfirmResponseBody& setModule(const TrainOrderChangeConfirmResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainOrderChangeConfirmResponseBody& setModule(TrainOrderChangeConfirmResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<TrainOrderChangeConfirmResponseBodyModule> module_ = nullptr;
