...
#ifndef ALIBABACLOUD_MODELS_MODULEITEMLISTSHOPPINGITEMMAPVALUESEARCHPRICE_HPP_
#define ALIBABACLOUD_MODELS_MODULEITEMLISTSHOPPINGITEMMAPVALUESEARCHPRICE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleItemListShoppingItemMapValueSearchPrice& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleItemListShoppingItemMapValueSearchPrice& obj) { 
    ...
    ModuleItemListShoppingItemMapValueSearchPrice() = default ;
    ModuleItemListShoppingItemMapValueSearchPrice(const ModuleItemListShoppingItemMapValueSearchPrice &) = default ;
    ModuleItemListShoppingItemMapValueSearchPrice(ModuleItemListShoppingItemMapValueSearchPrice &&) = default ;
    ModuleItemListShoppingItemMapValueSearchPrice(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleItemListShoppingItemMapValueSearchPrice() = default ;
    ModuleItemListShoppingItemMapValueSearchPrice& operator=(const ModuleItemListShoppingItemMapValueSearchPrice &) = default ;
    ModuleItemListShoppingItemMapValueSearchPrice& operator=(ModuleItemListShoppingItemMapValueSearchPrice &&) = default ;
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setFloorPrice(int32_t floorPrice) { DARABONBA_PTR_SET_VALUE(floorPrice_, floorPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setTicketPrice(int32_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setSellPrice(int32_t sellPrice) { DARABONBA_PTR_SET_VALUE(sellPrice_, sellPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setOriginalSellPrice(int32_t originalSellPrice) { DARABONBA_PTR_SET_VALUE(originalSellPrice_, originalSellPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setBaseTotalPrice(int32_t baseTotalPrice) { DARABONBA_PTR_SET_VALUE(baseTotalPrice_, baseTotalPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setBeforeControlPrice(int32_t beforeControlPrice) { DARABONBA_PTR_SET_VALUE(beforeControlPrice_, beforeControlPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setTax(int32_t tax) { DARABONBA_PTR_SET_VALUE(tax_, tax) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setSupplyPrice(int32_t supplyPrice) { DARABONBA_PTR_SET_VALUE(supplyPrice_, supplyPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setBasicCabinPrice(int32_t basicCabinPrice) { DARABONBA_PTR_SET_VALUE(basicCabinPrice_, basicCabinPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setBuildPrice(int32_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setOilPrice(int32_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setFirstStandardPrice(int32_t firstStandardPrice) { DARABONBA_PTR_SET_VALUE(firstStandardPrice_, firstStandardPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setBusinessStandardPrice(int32_t businessStandardPrice) { DARABONBA_PTR_SET_VALUE(businessStandardPrice_, businessStandardPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setCommonStandardPrice(int32_t commonStandardPrice) { DARABONBA_PTR_SET_VALUE(commonStandardPrice_, commonStandardPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setInterTicketPrice(int32_t interTicketPrice) { DARABONBA_PTR_SET_VALUE(interTicketPrice_, interTicketPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setSubtractedPrice(int32_t subtractedPrice) { DARABONBA_PTR_SET_VALUE(subtractedPrice_, subtractedPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setOriginCommonPrice(int32_t originCommonPrice) { DARABONBA_PTR_SET_VALUE(originCommonPrice_, originCommonPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setDynamicPromotionPrice(int32_t dynamicPromotionPrice) { DARABONBA_PTR_SET_VALUE(dynamicPromotionPrice_, dynamicPromotionPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setInstallmentNum(int32_t installmentNum) { DARABONBA_PTR_SET_VALUE(installmentNum_, installmentNum) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setInstallmentPrice(double installmentPrice) { DARABONBA_PTR_SET_VALUE(installmentPrice_, installmentPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setCompetitionDynamicPrice(int32_t competitionDynamicPrice) { DARABONBA_PTR_SET_VALUE(competitionDynamicPrice_, competitionDynamicPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setCompetitionPromotionPrice(int32_t competitionPromotionPrice) { DARABONBA_PTR_SET_VALUE(competitionPromotionPrice_, competitionPromotionPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSearchPrice& setMinBeforeControlPriceOfNormal(int32_t minBeforeControlPriceOfNormal) { DARABONBA_PTR_SET_VALUE(minBeforeControlPriceOfNormal_, minBeforeControlPriceOfNormal) };
    ...
    inline const Models::ModuleItemListShoppingItemMapValueSearchPricePriceShowInfo & priceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, Models::ModuleItemListShoppingItemMapValueSearchPricePriceShowInfo) };
    inline Models::ModuleItemListShoppingItemMapValueSearchPricePriceShowInfo priceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, Models::ModuleItemListShoppingItemMapValueSearchPricePriceShowInfo) };
    inline ModuleItemListShoppingItemMapValueSearchPrice& setPriceShowInfo(const Models::ModuleItemListShoppingItemMapValueSearchPricePriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleItemListShoppingItemMapValueSearchPrice& setPriceShowInfo(Models::ModuleItemListShoppingItemMapValueSearchPricePriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ModuleItemListShoppingItemMapValueSearchPricePriceShowInfo> priceShowInfo_ = nullptr;
  };
