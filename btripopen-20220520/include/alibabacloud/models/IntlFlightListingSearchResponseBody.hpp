...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightListingSearchResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightListingSearchResponseBodyModule) };
    inline IntlFlightListingSearchResponseBodyModule module() { DARABONBA_PTR_GET(module_, IntlFlightListingSearchResponseBodyModule) };
    inline IntlFlightListingSearchResponseBody& setModule(const IntlFlightListingSearchResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightListingSearchResponseBody& setModule(IntlFlightListingSearchResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IntlFlightListingSearchResponseBodyModule> module_ = nullptr;
