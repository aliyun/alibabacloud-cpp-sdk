...
namespace Models
{
  ...
  public:
    ...
    inline const TicketChangingEnquiryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TicketChangingEnquiryResponseBody) };
    inline TicketChangingEnquiryResponseBody getBody() { DARABONBA_PTR_GET(body_, TicketChangingEnquiryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TicketChangingEnquiryResponseBody> body_ {};
  };
