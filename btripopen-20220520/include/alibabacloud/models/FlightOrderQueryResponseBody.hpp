...
namespace Models
{
  ...
  public:
    ...
    inline const FlightOrderQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightOrderQueryResponseBodyModule) };
    inline FlightOrderQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightOrderQueryResponseBodyModule) };
    inline FlightOrderQueryResponseBody& setModule(const FlightOrderQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightOrderQueryResponseBody& setModule(FlightOrderQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<FlightOrderQueryResponseBodyModule> module_ = nullptr;
