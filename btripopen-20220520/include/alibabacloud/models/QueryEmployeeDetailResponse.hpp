...
namespace Models
{
  ...
  public:
    ...
    inline const QueryEmployeeDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryEmployeeDetailResponseBody) };
    inline QueryEmployeeDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryEmployeeDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryEmployeeDetailResponseBody> body_ {};
  };
