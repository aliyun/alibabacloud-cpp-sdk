...
#ifndef ALIBABACLOUD_MODELS_APPLYADDREQUESTTRAVELERLIST_HPP_
#define ALIBABACLOUD_MODELS_APPLYADDREQUESTTRAVELERLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ApplyAddRequestTravelerList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ApplyAddRequestTravelerList& obj) { 
    ...
    ApplyAddRequestTravelerList() = default ;
    ApplyAddRequestTravelerList(const ApplyAddRequestTravelerList &) = default ;
    ApplyAddRequestTravelerList(ApplyAddRequestTravelerList &&) = default ;
    ApplyAddRequestTravelerList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ApplyAddRequestTravelerList() = default ;
    ApplyAddRequestTravelerList& operator=(const ApplyAddRequestTravelerList &) = default ;
    ApplyAddRequestTravelerList& operator=(ApplyAddRequestTravelerList &&) = default ;
    ...
    inline ApplyAddRequestTravelerList& setAttribute(string attribute) { DARABONBA_PTR_SET_VALUE(attribute_, attribute) };
    ...
    inline ApplyAddRequestTravelerList& setCostCenterId(int64_t costCenterId) { DARABONBA_PTR_SET_VALUE(costCenterId_, costCenterId) };
    ...
    inline ApplyAddRequestTravelerList& setInvoiceId(int64_t invoiceId) { DARABONBA_PTR_SET_VALUE(invoiceId_, invoiceId) };
    ...
    inline ApplyAddRequestTravelerList& setPaymentDepartmentId(string paymentDepartmentId) { DARABONBA_PTR_SET_VALUE(paymentDepartmentId_, paymentDepartmentId) };
    ...
    inline ApplyAddRequestTravelerList& setPaymentDepartmentName(string paymentDepartmentName) { DARABONBA_PTR_SET_VALUE(paymentDepartmentName_, paymentDepartmentName) };
    ...
    inline ApplyAddRequestTravelerList& setProjectCode(string projectCode) { DARABONBA_PTR_SET_VALUE(projectCode_, projectCode) };
    ...
    inline ApplyAddRequestTravelerList& setProjectTitle(string projectTitle) { DARABONBA_PTR_SET_VALUE(projectTitle_, projectTitle) };
    ...
    inline ApplyAddRequestTravelerList& setThirdPartInvoiceId(string thirdPartInvoiceId) { DARABONBA_PTR_SET_VALUE(thirdPartInvoiceId_, thirdPartInvoiceId) };
    ...
    inline ApplyAddRequestTravelerList& setThirdpartCostCenterId(string thirdpartCostCenterId) { DARABONBA_PTR_SET_VALUE(thirdpartCostCenterId_, thirdpartCostCenterId) };
    ...
    inline ApplyAddRequestTravelerList& setThirdpartDepartId(string thirdpartDepartId) { DARABONBA_PTR_SET_VALUE(thirdpartDepartId_, thirdpartDepartId) };
    ...
    inline ApplyAddRequestTravelerList& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline ApplyAddRequestTravelerList& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
