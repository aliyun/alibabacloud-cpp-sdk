...
namespace Models
{
  ...
  public:
    ...
    inline const BaseCityInfoSearchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BaseCityInfoSearchResponseBody) };
    inline BaseCityInfoSearchResponseBody getBody() { DARABONBA_PTR_GET(body_, BaseCityInfoSearchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BaseCityInfoSearchResponseBody> body_ {};
  };
