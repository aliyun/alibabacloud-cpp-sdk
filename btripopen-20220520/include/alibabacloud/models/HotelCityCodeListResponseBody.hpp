...
namespace Models
{
  ...
  public:
    ...
    inline const vector<HotelCityCodeListResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<HotelCityCodeListResponseBodyModule>) };
    inline vector<HotelCityCodeListResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<HotelCityCodeListResponseBodyModule>) };
    inline HotelCityCodeListResponseBody& setModule(const vector<HotelCityCodeListResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelCityCodeListResponseBody& setModule(vector<HotelCityCodeListResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<vector<HotelCityCodeListResponseBodyModule>> module_ = nullptr;
