...
namespace Models
{
  ...
  public:
    ...
    inline const AirportSearchResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, AirportSearchResponseBodyModule) };
    inline AirportSearchResponseBodyModule module() { DARABONBA_PTR_GET(module_, AirportSearchResponseBodyModule) };
    inline AirportSearchResponseBody& setModule(const AirportSearchResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline AirportSearchResponseBody& setModule(AirportSearchResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module。
    std::shared_ptr<AirportSearchResponseBodyModule> module_ = nullptr;
