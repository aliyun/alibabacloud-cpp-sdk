...
namespace Models
{
  ...
  public:
    ...
    inline const FlightRefundApplyResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightRefundApplyResponseBodyModule) };
    inline FlightRefundApplyResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightRefundApplyResponseBodyModule) };
    inline FlightRefundApplyResponseBody& setModule(const FlightRefundApplyResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightRefundApplyResponseBody& setModule(FlightRefundApplyResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<FlightRefundApplyResponseBodyModule> module_ = nullptr;
