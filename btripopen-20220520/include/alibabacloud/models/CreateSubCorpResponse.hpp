...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSubCorpResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSubCorpResponseBody) };
    inline CreateSubCorpResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSubCorpResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSubCorpResponseBody> body_ {};
  };
