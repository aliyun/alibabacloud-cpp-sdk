...
namespace Models
{
  ...
  public:
    ...
    inline const HotelOrderCancelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HotelOrderCancelResponseBody) };
    inline HotelOrderCancelResponseBody getBody() { DARABONBA_PTR_GET(body_, HotelOrderCancelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HotelOrderCancelResponseBody> body_ {};
  };
