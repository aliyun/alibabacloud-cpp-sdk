...
#ifndef ALIBABACLOUD_MODELS_IFLIGHTORDERLISTQUERYRESPONSEBODYMODULEFLIGHTSALEORDERFLIGHTSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_IFLIGHTORDERLISTQUERYRESPONSEBODYMODULEFLIGHTSALEORDERFLIGHTSEGMENTLIST_HPP_
...
namespace Models
{
  class IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& obj) { 
    ...
    IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList() = default ;
    IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList(const IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList &) = default ;
    IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList(IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList &&) = default ;
    IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList() = default ;
    IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& operator=(const IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList &) = default ;
    IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& operator=(IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList &&) = default ;
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setAirlineCode(string airlineCode) { DARABONBA_PTR_SET_VALUE(airlineCode_, airlineCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setAirlineName(string airlineName) { DARABONBA_PTR_SET_VALUE(airlineName_, airlineName) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrApt(string arrApt) { DARABONBA_PTR_SET_VALUE(arrApt_, arrApt) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrAptCode(string arrAptCode) { DARABONBA_PTR_SET_VALUE(arrAptCode_, arrAptCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrCity(string arrCity) { DARABONBA_PTR_SET_VALUE(arrCity_, arrCity) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrCityCode(string arrCityCode) { DARABONBA_PTR_SET_VALUE(arrCityCode_, arrCityCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrTerminal(string arrTerminal) { DARABONBA_PTR_SET_VALUE(arrTerminal_, arrTerminal) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrTime(string arrTime) { DARABONBA_PTR_SET_VALUE(arrTime_, arrTime) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setCarrierAirlineCode(string carrierAirlineCode) { DARABONBA_PTR_SET_VALUE(carrierAirlineCode_, carrierAirlineCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setCarrierAirlineName(string carrierAirlineName) { DARABONBA_PTR_SET_VALUE(carrierAirlineName_, carrierAirlineName) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepApt(string depApt) { DARABONBA_PTR_SET_VALUE(depApt_, depApt) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepAptCode(string depAptCode) { DARABONBA_PTR_SET_VALUE(depAptCode_, depAptCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepCity(string depCity) { DARABONBA_PTR_SET_VALUE(depCity_, depCity) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepCityCode(string depCityCode) { DARABONBA_PTR_SET_VALUE(depCityCode_, depCityCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepTerminal(string depTerminal) { DARABONBA_PTR_SET_VALUE(depTerminal_, depTerminal) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepTime(string depTime) { DARABONBA_PTR_SET_VALUE(depTime_, depTime) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setFlightNo(string flightNo) { DARABONBA_PTR_SET_VALUE(flightNo_, flightNo) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setJourneyIndex(int32_t journeyIndex) { DARABONBA_PTR_SET_VALUE(journeyIndex_, journeyIndex) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setSegmentIndex(int32_t segmentIndex) { DARABONBA_PTR_SET_VALUE(segmentIndex_, segmentIndex) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setShare(bool share) { DARABONBA_PTR_SET_VALUE(share_, share) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setStopAptCode(string stopAptCode) { DARABONBA_PTR_SET_VALUE(stopAptCode_, stopAptCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setStopArrTime(string stopArrTime) { DARABONBA_PTR_SET_VALUE(stopArrTime_, stopArrTime) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setStopCity(string stopCity) { DARABONBA_PTR_SET_VALUE(stopCity_, stopCity) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setStopCityCode(string stopCityCode) { DARABONBA_PTR_SET_VALUE(stopCityCode_, stopCityCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setStopDepTime(string stopDepTime) { DARABONBA_PTR_SET_VALUE(stopDepTime_, stopDepTime) };
