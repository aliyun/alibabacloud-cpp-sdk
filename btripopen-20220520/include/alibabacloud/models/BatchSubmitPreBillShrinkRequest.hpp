...
#ifndef ALIBABACLOUD_MODELS_BATCHSUBMITPREBILLSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_BATCHSUBMITPREBILLSHRINKREQUEST_HPP_
...
namespace Models
{
  class BatchSubmitPreBillShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const BatchSubmitPreBillShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, BatchSubmitPreBillShrinkRequest& obj) { 
    ...
    BatchSubmitPreBillShrinkRequest() = default ;
    BatchSubmitPreBillShrinkRequest(const BatchSubmitPreBillShrinkRequest &) = default ;
    BatchSubmitPreBillShrinkRequest(BatchSubmitPreBillShrinkRequest &&) = default ;
    BatchSubmitPreBillShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~BatchSubmitPreBillShrinkRequest() = default ;
    BatchSubmitPreBillShrinkRequest& operator=(const BatchSubmitPreBillShrinkRequest &) = default ;
    BatchSubmitPreBillShrinkRequest& operator=(BatchSubmitPreBillShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->appIp_ == nullptr
        && this->billBatch_ == nullptr && this->customerDecision_ == nullptr && this->dimension_ == nullptr && this->valuesShrink_ == nullptr; };
    ...
    inline BatchSubmitPreBillShrinkRequest& setAppIp(string appIp) { DARABONBA_PTR_SET_VALUE(appIp_, appIp) };
    ...
    inline BatchSubmitPreBillShrinkRequest& setBillBatch(string billBatch) { DARABONBA_PTR_SET_VALUE(billBatch_, billBatch) };
    ...
    inline BatchSubmitPreBillShrinkRequest& setCustomerDecision(int32_t customerDecision) { DARABONBA_PTR_SET_VALUE(customerDecision_, customerDecision) };
    ...
    inline BatchSubmitPreBillShrinkRequest& setDimension(int32_t dimension) { DARABONBA_PTR_SET_VALUE(dimension_, dimension) };
    ...
    inline BatchSubmitPreBillShrinkRequest& setValuesShrink(string valuesShrink) { DARABONBA_PTR_SET_VALUE(valuesShrink_, valuesShrink) };
