...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyModifyResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, ApplyModifyResponseBodyModule) };
    inline ApplyModifyResponseBodyModule module() { DARABONBA_PTR_GET(module_, ApplyModifyResponseBodyModule) };
    inline ApplyModifyResponseBody& setModule(const ApplyModifyResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline ApplyModifyResponseBody& setModule(ApplyModifyResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module。
    std::shared_ptr<ApplyModifyResponseBodyModule> module_ = nullptr;
