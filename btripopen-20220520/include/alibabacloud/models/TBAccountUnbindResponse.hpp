...
namespace Models
{
  ...
  public:
    ...
    inline const TBAccountUnbindResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TBAccountUnbindResponseBody) };
    inline TBAccountUnbindResponseBody getBody() { DARABONBA_PTR_GET(body_, TBAccountUnbindResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TBAccountUnbindResponseBody> body_ {};
  };
