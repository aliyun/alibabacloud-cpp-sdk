...
#ifndef ALIBABACLOUD_MODELS_HOTELROOMINFORESPONSEBODYMODULEBEDINFOS_HPP_
#define ALIBABACLOUD_MODELS_HOTELROOMINFORESPONSEBODYMODULEBEDINFOS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const HotelRoomInfoResponseBodyModuleBedInfos& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, HotelRoomInfoResponseBodyModuleBedInfos& obj) { 
    ...
    HotelRoomInfoResponseBodyModuleBedInfos() = default ;
    HotelRoomInfoResponseBodyModuleBedInfos(const HotelRoomInfoResponseBodyModuleBedInfos &) = default ;
    HotelRoomInfoResponseBodyModuleBedInfos(HotelRoomInfoResponseBodyModuleBedInfos &&) = default ;
    HotelRoomInfoResponseBodyModuleBedInfos(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~HotelRoomInfoResponseBodyModuleBedInfos() = default ;
    HotelRoomInfoResponseBodyModuleBedInfos& operator=(const HotelRoomInfoResponseBodyModuleBedInfos &) = default ;
    HotelRoomInfoResponseBodyModuleBedInfos& operator=(HotelRoomInfoResponseBodyModuleBedInfos &&) = default ;
    ...
    inline HotelRoomInfoResponseBodyModuleBedInfos& setBedDesc(string bedDesc) { DARABONBA_PTR_SET_VALUE(bedDesc_, bedDesc) };
    ...
    inline HotelRoomInfoResponseBodyModuleBedInfos& setBedNum(int32_t bedNum) { DARABONBA_PTR_SET_VALUE(bedNum_, bedNum) };
    ...
    inline HotelRoomInfoResponseBodyModuleBedInfos& setBedSize(string bedSize) { DARABONBA_PTR_SET_VALUE(bedSize_, bedSize) };
    ...
    inline HotelRoomInfoResponseBodyModuleBedInfos& setBedType(string bedType) { DARABONBA_PTR_SET_VALUE(bedType_, bedType) };
    ...
    inline HotelRoomInfoResponseBodyModuleBedInfos& setLength(string length) { DARABONBA_PTR_SET_VALUE(length_, length) };
    ...
    inline HotelRoomInfoResponseBodyModuleBedInfos& setWidth(string width) { DARABONBA_PTR_SET_VALUE(width_, width) };
