...
#ifndef ALIBABACLOUD_MODELS_MEALBILLSETTLEMENTQUERYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MEALBILLSETTLEMENTQUERYREQUEST_HPP_
...
namespace Models
{
  class MealBillSettlementQueryRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const MealBillSettlementQueryRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, MealBillSettlementQueryRequest& obj) { 
    ...
    MealBillSettlementQueryRequest() = default ;
    MealBillSettlementQueryRequest(const MealBillSettlementQueryRequest &) = default ;
    MealBillSettlementQueryRequest(MealBillSettlementQueryRequest &&) = default ;
    MealBillSettlementQueryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~MealBillSettlementQueryRequest() = default ;
    MealBillSettlementQueryRequest& operator=(const MealBillSettlementQueryRequest &) = default ;
    MealBillSettlementQueryRequest& operator=(MealBillSettlementQueryRequest &&) = default ;
    ...
    inline MealBillSettlementQueryRequest& setApplyId(string applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline MealBillSettlementQueryRequest& setBillBatch(string billBatch) { DARABONBA_PTR_SET_VALUE(billBatch_, billBatch) };
    ...
    inline MealBillSettlementQueryRequest& setBillRecordTimeEnd(string billRecordTimeEnd) { DARABONBA_PTR_SET_VALUE(billRecordTimeEnd_, billRecordTimeEnd) };
    ...
    inline MealBillSettlementQueryRequest& setBillRecordTimeStart(string billRecordTimeStart) { DARABONBA_PTR_SET_VALUE(billRecordTimeStart_, billRecordTimeStart) };
    ...
    inline MealBillSettlementQueryRequest& setOrderId(int64_t orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline MealBillSettlementQueryRequest& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline MealBillSettlementQueryRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline MealBillSettlementQueryRequest& setPeriodEnd(string periodEnd) { DARABONBA_PTR_SET_VALUE(periodEnd_, periodEnd) };
    ...
    inline MealBillSettlementQueryRequest& setPeriodStart(string periodStart) { DARABONBA_PTR_SET_VALUE(periodStart_, periodStart) };
    ...
    inline MealBillSettlementQueryRequest& setScrollId(string scrollId) { DARABONBA_PTR_SET_VALUE(scrollId_, scrollId) };
    ...
    inline MealBillSettlementQueryRequest& setScrollMod(bool scrollMod) { DARABONBA_PTR_SET_VALUE(scrollMod_, scrollMod) };
