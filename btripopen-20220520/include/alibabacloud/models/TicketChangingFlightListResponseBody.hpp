...
namespace Models
{
  ...
  public:
    ...
    inline const TicketChangingFlightListResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TicketChangingFlightListResponseBodyModule) };
    inline TicketChangingFlightListResponseBodyModule module() { DARABONBA_PTR_GET(module_, TicketChangingFlightListResponseBodyModule) };
    inline TicketChangingFlightListResponseBody& setModule(const TicketChangingFlightListResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TicketChangingFlightListResponseBody& setModule(TicketChangingFlightListResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TicketChangingFlightListResponseBodyModule> module_ = nullptr;
