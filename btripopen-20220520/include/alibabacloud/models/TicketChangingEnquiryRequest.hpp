...
namespace Models
{
  ...
  public:
    ...
    inline string getModifyDepartDate() const { DARABONBA_PTR_GET_DEFAULT(modifyDepartDate_, "") };
    ...
    inline string getModifyFlightNo() const { DARABONBA_PTR_GET_DEFAULT(modifyFlightNo_, "") };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<string> modifyDepartDate_ {};
    // This parameter is required.
    shared_ptr<string> modifyFlightNo_ {};
    // This parameter is required.
