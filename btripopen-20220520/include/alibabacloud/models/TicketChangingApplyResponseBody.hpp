...
namespace Models
{
  ...
  public:
    ...
    inline const TicketChangingApplyResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TicketChangingApplyResponseBodyModule) };
    inline TicketChangingApplyResponseBodyModule module() { DARABONBA_PTR_GET(module_, TicketChangingApplyResponseBodyModule) };
    inline TicketChangingApplyResponseBody& setModule(const TicketChangingApplyResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TicketChangingApplyResponseBody& setModule(TicketChangingApplyResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TicketChangingApplyResponseBodyModule> module_ = nullptr;
