...
#ifndef ALIBABACLOUD_MODELS_EXTERNALUSERUPDATEREQUESTCERTREQUESTLIST_HPP_
#define ALIBABACLOUD_MODELS_EXTERNALUSERUPDATEREQUESTCERTREQUESTLIST_HPP_
...
namespace Models
{
  class ExternalUserUpdateRequestCertRequestList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ExternalUserUpdateRequestCertRequestList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ExternalUserUpdateRequestCertRequestList& obj) { 
    ...
    ExternalUserUpdateRequestCertRequestList() = default ;
    ExternalUserUpdateRequestCertRequestList(const ExternalUserUpdateRequestCertRequestList &) = default ;
    ExternalUserUpdateRequestCertRequestList(ExternalUserUpdateRequestCertRequestList &&) = default ;
    ExternalUserUpdateRequestCertRequestList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExternalUserUpdateRequestCertRequestList() = default ;
    ExternalUserUpdateRequestCertRequestList& operator=(const ExternalUserUpdateRequestCertRequestList &) = default ;
    ExternalUserUpdateRequestCertRequestList& operator=(ExternalUserUpdateRequestCertRequestList &&) = default ;
    ...
    inline ExternalUserUpdateRequestCertRequestList& setCertExpiredTime(string certExpiredTime) { DARABONBA_PTR_SET_VALUE(certExpiredTime_, certExpiredTime) };
    ...
    inline ExternalUserUpdateRequestCertRequestList& setCertNation(string certNation) { DARABONBA_PTR_SET_VALUE(certNation_, certNation) };
    ...
    inline ExternalUserUpdateRequestCertRequestList& setCertNo(string certNo) { DARABONBA_PTR_SET_VALUE(certNo_, certNo) };
    ...
    inline ExternalUserUpdateRequestCertRequestList& setCertType(int32_t certType) { DARABONBA_PTR_SET_VALUE(certType_, certType) };
    ...
    inline ExternalUserUpdateRequestCertRequestList& setNationality(string nationality) { DARABONBA_PTR_SET_VALUE(nationality_, nationality) };
