...
namespace Models
{
  ...
  public:
    ...
    inline const ExternalUserQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExternalUserQueryResponseBody) };
    inline ExternalUserQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, ExternalUserQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExternalUserQueryResponseBody> body_ {};
  };
