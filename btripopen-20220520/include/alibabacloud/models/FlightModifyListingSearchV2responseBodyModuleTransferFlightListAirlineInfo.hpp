...
#ifndef ALIBABACLOUD_MODELS_FLIGHTMODIFYLISTINGSEARCHV2RESPONSEBODYMODULETRANSFERFLIGHTLISTAIRLINEINFO_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTMODIFYLISTINGSEARCHV2RESPONSEBODYMODULETRANSFERFLIGHTLISTAIRLINEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo& obj) { 
    ...
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo() = default ;
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo(const FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo &) = default ;
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo(FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo &&) = default ;
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo() = default ;
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo& operator=(const FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo &) = default ;
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo& operator=(FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo &&) = default ;
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo& setAirlineChineseName(string airlineChineseName) { DARABONBA_PTR_SET_VALUE(airlineChineseName_, airlineChineseName) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo& setAirlineChineseShortName(string airlineChineseShortName) { DARABONBA_PTR_SET_VALUE(airlineChineseShortName_, airlineChineseShortName) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo& setAirlineCode(string airlineCode) { DARABONBA_PTR_SET_VALUE(airlineCode_, airlineCode) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo& setAirlineIcon(string airlineIcon) { DARABONBA_PTR_SET_VALUE(airlineIcon_, airlineIcon) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListAirlineInfo& setCheapFlight(bool cheapFlight) { DARABONBA_PTR_SET_VALUE(cheapFlight_, cheapFlight) };
