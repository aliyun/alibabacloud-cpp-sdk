...
namespace Models
{
  ...
  public:
    ...
    inline const MealOrderListQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MealOrderListQueryResponseBody) };
    inline MealOrderListQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, MealOrderListQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MealOrderListQueryResponseBody> body_ {};
  };
