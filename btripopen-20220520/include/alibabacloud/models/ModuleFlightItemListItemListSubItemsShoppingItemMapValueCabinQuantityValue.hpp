...
#ifndef ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTITEMLISTSUBITEMSSHOPPINGITEMMAPVALUECABINQUANTITYVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTITEMLISTSUBITEMSSHOPPINGITEMMAPVALUECABINQUANTITYVALUE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& obj) { 
    ...
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue() = default ;
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue(const ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue &) = default ;
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue(ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue &&) = default ;
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue() = default ;
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& operator=(const ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue &) = default ;
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& operator=(ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue &&) = default ;
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setCabinClassName(string cabinClassName) { DARABONBA_PTR_SET_VALUE(cabinClassName_, cabinClassName) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setCabinClassMemo(string cabinClassMemo) { DARABONBA_PTR_SET_VALUE(cabinClassMemo_, cabinClassMemo) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setSpecification(string specification) { DARABONBA_PTR_SET_VALUE(specification_, specification) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setQuantity(string quantity) { DARABONBA_PTR_SET_VALUE(quantity_, quantity) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setLinkCabins(const vector<string> & linkCabins) { DARABONBA_PTR_SET_VALUE(linkCabins_, linkCabins) };
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setLinkCabins(vector<string> && linkCabins) { DARABONBA_PTR_SET_RVALUE(linkCabins_, linkCabins) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setReshopChangeCabin(bool reshopChangeCabin) { DARABONBA_PTR_SET_VALUE(reshopChangeCabin_, reshopChangeCabin) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setChildCabinType(int32_t childCabinType) { DARABONBA_PTR_SET_VALUE(childCabinType_, childCabinType) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setInfantBasicCabin(string infantBasicCabin) { DARABONBA_PTR_SET_VALUE(infantBasicCabin_, infantBasicCabin) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue& setInnerCabinClass(int32_t innerCabinClass) { DARABONBA_PTR_SET_VALUE(innerCabinClass_, innerCabinClass) };
