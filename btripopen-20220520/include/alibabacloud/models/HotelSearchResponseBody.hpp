...
namespace Models
{
  ...
  public:
    ...
    inline const HotelSearchResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelSearchResponseBodyModule) };
    inline HotelSearchResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelSearchResponseBodyModule) };
    inline HotelSearchResponseBody& setModule(const HotelSearchResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelSearchResponseBody& setModule(HotelSearchResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelSearchResponseBodyModule> module_ = nullptr;
