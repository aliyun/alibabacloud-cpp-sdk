...
#ifndef ALIBABACLOUD_MODELS_FLIGHTMODIFYOTASEARCHV2RESPONSEBODYMODULEFLIGHTSEGMENTINFOSAIRLINEINFO_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTMODIFYOTASEARCHV2RESPONSEBODYMODULEFLIGHTSEGMENTINFOSAIRLINEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo& obj) { 
    ...
    FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo() = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo(const FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo &) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo(FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo &&) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo() = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo& operator=(const FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo &) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo& operator=(FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo &&) = default ;
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo& setAirlineCode(string airlineCode) { DARABONBA_PTR_SET_VALUE(airlineCode_, airlineCode) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo& setAirlineChineseName(string airlineChineseName) { DARABONBA_PTR_SET_VALUE(airlineChineseName_, airlineChineseName) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo& setAirlineChineseShortName(string airlineChineseShortName) { DARABONBA_PTR_SET_VALUE(airlineChineseShortName_, airlineChineseShortName) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo& setAirlineIcon(string airlineIcon) { DARABONBA_PTR_SET_VALUE(airlineIcon_, airlineIcon) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleFlightSegmentInfosAirlineInfo& setCheapFlight(bool cheapFlight) { DARABONBA_PTR_SET_VALUE(cheapFlight_, cheapFlight) };
