...
namespace Models
{
  ...
  public:
    ...
    inline const vector<TripCCInfoQueryResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<TripCCInfoQueryResponseBodyModule>) };
    inline vector<TripCCInfoQueryResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<TripCCInfoQueryResponseBodyModule>) };
    inline TripCCInfoQueryResponseBody& setModule(const vector<TripCCInfoQueryResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TripCCInfoQueryResponseBody& setModule(vector<TripCCInfoQueryResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module。
    std::shared_ptr<vector<TripCCInfoQueryResponseBodyModule>> module_ = nullptr;
