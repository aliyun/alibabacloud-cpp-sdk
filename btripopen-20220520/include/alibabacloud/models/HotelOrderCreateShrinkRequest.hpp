...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->btripUserId_ != nullptr
        ...
        && this->itineraryNo_ != nullptr && this->occupantInfoListShrink_ != nullptr && this->personPayPrice_ != nullptr && this->promotionInfoShrink_ != nullptr && this->ratePlanId_ != nullptr
    ...
    inline string invoiceInfoShrink() const { DARABONBA_PTR_GET_DEFAULT(invoiceInfoShrink_, "") };
    ...
    inline string promotionInfoShrink() const { DARABONBA_PTR_GET_DEFAULT(promotionInfoShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> invoiceInfoShrink_ = nullptr;
    // This parameter is required.
    ...
    std::shared_ptr<string> promotionInfoShrink_ = nullptr;
    // This parameter is required.
