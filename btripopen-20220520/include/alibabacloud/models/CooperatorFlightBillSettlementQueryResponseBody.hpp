...
namespace Models
{
  ...
  public:
    ...
    inline const CooperatorFlightBillSettlementQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, CooperatorFlightBillSettlementQueryResponseBodyModule) };
    inline CooperatorFlightBillSettlementQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, CooperatorFlightBillSettlementQueryResponseBodyModule) };
    inline CooperatorFlightBillSettlementQueryResponseBody& setModule(const CooperatorFlightBillSettlementQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline CooperatorFlightBillSettlementQueryResponseBody& setModule(CooperatorFlightBillSettlementQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<CooperatorFlightBillSettlementQueryResponseBodyModule> module_ = nullptr;
