...
namespace Models
{
  ...
  public:
    ...
    inline const FlightListingSearchResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightListingSearchResponseBodyModule) };
    inline FlightListingSearchResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightListingSearchResponseBodyModule) };
    inline FlightListingSearchResponseBody& setModule(const FlightListingSearchResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightListingSearchResponseBody& setModule(FlightListingSearchResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<FlightListingSearchResponseBodyModule> module_ = nullptr;
