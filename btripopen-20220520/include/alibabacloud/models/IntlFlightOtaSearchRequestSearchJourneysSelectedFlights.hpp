...
#ifndef ALIBABACLOUD_MODELS_INTLFLIGHTOTASEARCHREQUESTSEARCHJOURNEYSSELECTEDFLIGHTS_HPP_
#define ALIBABACLOUD_MODELS_INTLFLIGHTOTASEARCHREQUESTSEARCHJOURNEYSSELECTEDFLIGHTS_HPP_
...
namespace Models
{
  class IntlFlightOtaSearchRequestSearchJourneysSelectedFlights : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IntlFlightOtaSearchRequestSearchJourneysSelectedFlights& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IntlFlightOtaSearchRequestSearchJourneysSelectedFlights& obj) { 
    ...
    IntlFlightOtaSearchRequestSearchJourneysSelectedFlights() = default ;
    IntlFlightOtaSearchRequestSearchJourneysSelectedFlights(const IntlFlightOtaSearchRequestSearchJourneysSelectedFlights &) = default ;
    IntlFlightOtaSearchRequestSearchJourneysSelectedFlights(IntlFlightOtaSearchRequestSearchJourneysSelectedFlights &&) = default ;
    IntlFlightOtaSearchRequestSearchJourneysSelectedFlights(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IntlFlightOtaSearchRequestSearchJourneysSelectedFlights() = default ;
    IntlFlightOtaSearchRequestSearchJourneysSelectedFlights& operator=(const IntlFlightOtaSearchRequestSearchJourneysSelectedFlights &) = default ;
    IntlFlightOtaSearchRequestSearchJourneysSelectedFlights& operator=(IntlFlightOtaSearchRequestSearchJourneysSelectedFlights &&) = default ;
    ...
    inline IntlFlightOtaSearchRequestSearchJourneysSelectedFlights& setArrAirportCode(string arrAirportCode) { DARABONBA_PTR_SET_VALUE(arrAirportCode_, arrAirportCode) };
    ...
    inline IntlFlightOtaSearchRequestSearchJourneysSelectedFlights& setArrCityCode(string arrCityCode) { DARABONBA_PTR_SET_VALUE(arrCityCode_, arrCityCode) };
    ...
    inline IntlFlightOtaSearchRequestSearchJourneysSelectedFlights& setDepAirportCode(string depAirportCode) { DARABONBA_PTR_SET_VALUE(depAirportCode_, depAirportCode) };
    ...
    inline IntlFlightOtaSearchRequestSearchJourneysSelectedFlights& setDepCityCode(string depCityCode) { DARABONBA_PTR_SET_VALUE(depCityCode_, depCityCode) };
    ...
    inline IntlFlightOtaSearchRequestSearchJourneysSelectedFlights& setFlightTime(string flightTime) { DARABONBA_PTR_SET_VALUE(flightTime_, flightTime) };
    ...
    inline IntlFlightOtaSearchRequestSearchJourneysSelectedFlights& setMarketFlightNo(string marketFlightNo) { DARABONBA_PTR_SET_VALUE(marketFlightNo_, marketFlightNo) };
    ...
    inline IntlFlightOtaSearchRequestSearchJourneysSelectedFlights& setOperateFlightNo(string operateFlightNo) { DARABONBA_PTR_SET_VALUE(operateFlightNo_, operateFlightNo) };
