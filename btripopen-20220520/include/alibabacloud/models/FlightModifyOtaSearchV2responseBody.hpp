...
namespace Models
{
  ...
  public:
    ...
    inline const FlightModifyOtaSearchV2ResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightModifyOtaSearchV2ResponseBodyModule) };
    inline FlightModifyOtaSearchV2ResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightModifyOtaSearchV2ResponseBodyModule) };
    inline FlightModifyOtaSearchV2ResponseBody& setModule(const FlightModifyOtaSearchV2ResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightModifyOtaSearchV2ResponseBody& setModule(FlightModifyOtaSearchV2ResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<FlightModifyOtaSearchV2ResponseBodyModule> module_ = nullptr;
    // requestId
