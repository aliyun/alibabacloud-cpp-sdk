...
#ifndef ALIBABACLOUD_MODELS_INTLFLIGHTRESHOPCANCELREQUEST_HPP_
#define ALIBABACLOUD_MODELS_INTLFLIGHTRESHOPCANCELREQUEST_HPP_
...
namespace Models
{
  class IntlFlightReShopCancelRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IntlFlightReShopCancelRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IntlFlightReShopCancelRequest& obj) { 
    ...
    IntlFlightReShopCancelRequest() = default ;
    IntlFlightReShopCancelRequest(const IntlFlightReShopCancelRequest &) = default ;
    IntlFlightReShopCancelRequest(IntlFlightReShopCancelRequest &&) = default ;
    IntlFlightReShopCancelRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IntlFlightReShopCancelRequest() = default ;
    IntlFlightReShopCancelRequest& operator=(const IntlFlightReShopCancelRequest &) = default ;
    IntlFlightReShopCancelRequest& operator=(IntlFlightReShopCancelRequest &&) = default ;
