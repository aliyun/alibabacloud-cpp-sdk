...
#ifndef ALIBABACLOUD_MODELS_FLIGHTORDERDETAILINFORESPONSEBODYMODULEFLIGHTINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTORDERDETAILINFORESPONSEBODYMODULEFLIGHTINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightOrderDetailInfoResponseBodyModuleFlightInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightOrderDetailInfoResponseBodyModuleFlightInfoList& obj) { 
    ...
    FlightOrderDetailInfoResponseBodyModuleFlightInfoList() = default ;
    FlightOrderDetailInfoResponseBodyModuleFlightInfoList(const FlightOrderDetailInfoResponseBodyModuleFlightInfoList &) = default ;
    FlightOrderDetailInfoResponseBodyModuleFlightInfoList(FlightOrderDetailInfoResponseBodyModuleFlightInfoList &&) = default ;
    FlightOrderDetailInfoResponseBodyModuleFlightInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightOrderDetailInfoResponseBodyModuleFlightInfoList() = default ;
    FlightOrderDetailInfoResponseBodyModuleFlightInfoList& operator=(const FlightOrderDetailInfoResponseBodyModuleFlightInfoList &) = default ;
    FlightOrderDetailInfoResponseBodyModuleFlightInfoList& operator=(FlightOrderDetailInfoResponseBodyModuleFlightInfoList &&) = default ;
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setAirlineCode(string airlineCode) { DARABONBA_PTR_SET_VALUE(airlineCode_, airlineCode) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setAirlineName(string airlineName) { DARABONBA_PTR_SET_VALUE(airlineName_, airlineName) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setAirlineSimpleName(string airlineSimpleName) { DARABONBA_PTR_SET_VALUE(airlineSimpleName_, airlineSimpleName) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setArrAirport(string arrAirport) { DARABONBA_PTR_SET_VALUE(arrAirport_, arrAirport) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setArrAirportCode(string arrAirportCode) { DARABONBA_PTR_SET_VALUE(arrAirportCode_, arrAirportCode) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setArrAirportCodeName(string arrAirportCodeName) { DARABONBA_PTR_SET_VALUE(arrAirportCodeName_, arrAirportCodeName) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setArrCity(string arrCity) { DARABONBA_PTR_SET_VALUE(arrCity_, arrCity) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setArrCityCode(string arrCityCode) { DARABONBA_PTR_SET_VALUE(arrCityCode_, arrCityCode) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setArrTerminal(string arrTerminal) { DARABONBA_PTR_SET_VALUE(arrTerminal_, arrTerminal) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setArrTime(string arrTime) { DARABONBA_PTR_SET_VALUE(arrTime_, arrTime) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setBaggage(string baggage) { DARABONBA_PTR_SET_VALUE(baggage_, baggage) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setBuildPrice(int64_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setCarrier(string carrier) { DARABONBA_PTR_SET_VALUE(carrier_, carrier) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setDepAirport(string depAirport) { DARABONBA_PTR_SET_VALUE(depAirport_, depAirport) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setDepAirportCode(string depAirportCode) { DARABONBA_PTR_SET_VALUE(depAirportCode_, depAirportCode) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setDepAirportCodeName(string depAirportCodeName) { DARABONBA_PTR_SET_VALUE(depAirportCodeName_, depAirportCodeName) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setDepCity(string depCity) { DARABONBA_PTR_SET_VALUE(depCity_, depCity) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setDepCityCode(string depCityCode) { DARABONBA_PTR_SET_VALUE(depCityCode_, depCityCode) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setDepTerminal(string depTerminal) { DARABONBA_PTR_SET_VALUE(depTerminal_, depTerminal) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setDepTime(string depTime) { DARABONBA_PTR_SET_VALUE(depTime_, depTime) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setFlightNo(string flightNo) { DARABONBA_PTR_SET_VALUE(flightNo_, flightNo) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setLastCabin(string lastCabin) { DARABONBA_PTR_SET_VALUE(lastCabin_, lastCabin) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setLastFlightNo(string lastFlightNo) { DARABONBA_PTR_SET_VALUE(lastFlightNo_, lastFlightNo) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setMeal(string meal) { DARABONBA_PTR_SET_VALUE(meal_, meal) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setOilPrice(int64_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setSegmentType(int32_t segmentType) { DARABONBA_PTR_SET_VALUE(segmentType_, segmentType) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setStopArrTime(string stopArrTime) { DARABONBA_PTR_SET_VALUE(stopArrTime_, stopArrTime) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setStopCity(string stopCity) { DARABONBA_PTR_SET_VALUE(stopCity_, stopCity) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setStopDepTime(string stopDepTime) { DARABONBA_PTR_SET_VALUE(stopDepTime_, stopDepTime) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setTicketPrice(int64_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline FlightOrderDetailInfoResponseBodyModuleFlightInfoList& setTuigaiqianInfo(string tuigaiqianInfo) { DARABONBA_PTR_SET_VALUE(tuigaiqianInfo_, tuigaiqianInfo) };
