...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightOrderDetailResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightOrderDetailResponseBodyModule) };
    inline IntlFlightOrderDetailResponseBodyModule module() { DARABONBA_PTR_GET(module_, IntlFlightOrderDetailResponseBodyModule) };
    inline IntlFlightOrderDetailResponseBody& setModule(const IntlFlightOrderDetailResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightOrderDetailResponseBody& setModule(IntlFlightOrderDetailResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IntlFlightOrderDetailResponseBodyModule> module_ = nullptr;
