...
#ifndef ALIBABACLOUD_MODELS_INTLFLIGHTRESHOPOTASEARCHREQUEST_HPP_
#define ALIBABACLOUD_MODELS_INTLFLIGHTRESHOPOTASEARCHREQUEST_HPP_
...
namespace Models
{
  class IntlFlightReShopOtaSearchRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IntlFlightReShopOtaSearchRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IntlFlightReShopOtaSearchRequest& obj) { 
    ...
    IntlFlightReShopOtaSearchRequest() = default ;
    IntlFlightReShopOtaSearchRequest(const IntlFlightReShopOtaSearchRequest &) = default ;
    IntlFlightReShopOtaSearchRequest(IntlFlightReShopOtaSearchRequest &&) = default ;
    IntlFlightReShopOtaSearchRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IntlFlightReShopOtaSearchRequest() = default ;
    IntlFlightReShopOtaSearchRequest& operator=(const IntlFlightReShopOtaSearchRequest &) = default ;
    IntlFlightReShopOtaSearchRequest& operator=(IntlFlightReShopOtaSearchRequest &&) = default ;
    ...
    inline IntlFlightReShopOtaSearchRequest& setOrderId(string orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline IntlFlightReShopOtaSearchRequest& setOutOrderId(string outOrderId) { DARABONBA_PTR_SET_VALUE(outOrderId_, outOrderId) };
    ...
    inline IntlFlightReShopOtaSearchRequest& setOutWheelSearch(bool outWheelSearch) { DARABONBA_PTR_SET_VALUE(outWheelSearch_, outWheelSearch) };
    ...
    inline IntlFlightReShopOtaSearchRequest& setPassengerJourneyGroupKey(string passengerJourneyGroupKey) { DARABONBA_PTR_SET_VALUE(passengerJourneyGroupKey_, passengerJourneyGroupKey) };
    ...
    inline IntlFlightReShopOtaSearchRequest& setReShopReasonCode(string reShopReasonCode) { DARABONBA_PTR_SET_VALUE(reShopReasonCode_, reShopReasonCode) };
    ...
    inline const vector<IntlFlightReShopOtaSearchRequest::SearchJourneys> & getSearchJourneys() const { DARABONBA_PTR_GET_CONST(searchJourneys_, vector<IntlFlightReShopOtaSearchRequest::SearchJourneys>) };
    inline vector<IntlFlightReShopOtaSearchRequest::SearchJourneys> getSearchJourneys() { DARABONBA_PTR_GET(searchJourneys_, vector<IntlFlightReShopOtaSearchRequest::SearchJourneys>) };
    inline IntlFlightReShopOtaSearchRequest& setSearchJourneys(const vector<IntlFlightReShopOtaSearchRequest::SearchJourneys> & searchJourneys) { DARABONBA_PTR_SET_VALUE(searchJourneys_, searchJourneys) };
    inline IntlFlightReShopOtaSearchRequest& setSearchJourneys(vector<IntlFlightReShopOtaSearchRequest::SearchJourneys> && searchJourneys) { DARABONBA_PTR_SET_RVALUE(searchJourneys_, searchJourneys) };
    ...
    inline const vector<IntlFlightReShopOtaSearchRequest::SelectedPassengers> & getSelectedPassengers() const { DARABONBA_PTR_GET_CONST(selectedPassengers_, vector<IntlFlightReShopOtaSearchRequest::SelectedPassengers>) };
    inline vector<IntlFlightReShopOtaSearchRequest::SelectedPassengers> getSelectedPassengers() { DARABONBA_PTR_GET(selectedPassengers_, vector<IntlFlightReShopOtaSearchRequest::SelectedPassengers>) };
    inline IntlFlightReShopOtaSearchRequest& setSelectedPassengers(const vector<IntlFlightReShopOtaSearchRequest::SelectedPassengers> & selectedPassengers) { DARABONBA_PTR_SET_VALUE(selectedPassengers_, selectedPassengers) };
    inline IntlFlightReShopOtaSearchRequest& setSelectedPassengers(vector<IntlFlightReShopOtaSearchRequest::SelectedPassengers> && selectedPassengers) { DARABONBA_PTR_SET_RVALUE(selectedPassengers_, selectedPassengers) };
    ...
    inline IntlFlightReShopOtaSearchRequest& setToken(string token) { DARABONBA_PTR_SET_VALUE(token_, token) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<IntlFlightReShopOtaSearchRequest::SearchJourneys>> searchJourneys_ {};
    // The list of selected passengers for rebooking.
    // 
    // This parameter is required.
    shared_ptr<vector<IntlFlightReShopOtaSearchRequest::SelectedPassengers>> selectedPassengers_ {};
