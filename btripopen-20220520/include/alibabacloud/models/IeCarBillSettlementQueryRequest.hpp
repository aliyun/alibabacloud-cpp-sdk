...
#ifndef ALIBABACLOUD_MODELS_IECARBILLSETTLEMENTQUERYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_IECARBILLSETTLEMENTQUERYREQUEST_HPP_
...
namespace Models
{
  class IeCarBillSettlementQueryRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IeCarBillSettlementQueryRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IeCarBillSettlementQueryRequest& obj) { 
    ...
    IeCarBillSettlementQueryRequest() = default ;
    IeCarBillSettlementQueryRequest(const IeCarBillSettlementQueryRequest &) = default ;
    IeCarBillSettlementQueryRequest(IeCarBillSettlementQueryRequest &&) = default ;
    IeCarBillSettlementQueryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IeCarBillSettlementQueryRequest() = default ;
    IeCarBillSettlementQueryRequest& operator=(const IeCarBillSettlementQueryRequest &) = default ;
    IeCarBillSettlementQueryRequest& operator=(IeCarBillSettlementQueryRequest &&) = default ;
    ...
    inline IeCarBillSettlementQueryRequest& setApplyId(string applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline IeCarBillSettlementQueryRequest& setBillBatch(string billBatch) { DARABONBA_PTR_SET_VALUE(billBatch_, billBatch) };
    ...
    inline IeCarBillSettlementQueryRequest& setBillRecordTimeEnd(string billRecordTimeEnd) { DARABONBA_PTR_SET_VALUE(billRecordTimeEnd_, billRecordTimeEnd) };
    ...
    inline IeCarBillSettlementQueryRequest& setBillRecordTimeStart(string billRecordTimeStart) { DARABONBA_PTR_SET_VALUE(billRecordTimeStart_, billRecordTimeStart) };
    ...
    inline IeCarBillSettlementQueryRequest& setOrderId(int64_t orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline IeCarBillSettlementQueryRequest& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline IeCarBillSettlementQueryRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline IeCarBillSettlementQueryRequest& setPeriodEnd(string periodEnd) { DARABONBA_PTR_SET_VALUE(periodEnd_, periodEnd) };
    ...
    inline IeCarBillSettlementQueryRequest& setPeriodStart(string periodStart) { DARABONBA_PTR_SET_VALUE(periodStart_, periodStart) };
    ...
    inline IeCarBillSettlementQueryRequest& setScrollId(string scrollId) { DARABONBA_PTR_SET_VALUE(scrollId_, scrollId) };
    ...
    inline IeCarBillSettlementQueryRequest& setScrollMod(bool scrollMod) { DARABONBA_PTR_SET_VALUE(scrollMod_, scrollMod) };
