...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GroupUserSaveRequestCertList> & certList() const { DARABONBA_PTR_GET_CONST(certList_, vector<GroupUserSaveRequestCertList>) };
    inline vector<GroupUserSaveRequestCertList> certList() { DARABONBA_PTR_GET(certList_, vector<GroupUserSaveRequestCertList>) };
    inline GroupUserSaveRequest& setCertList(const vector<GroupUserSaveRequestCertList> & certList) { DARABONBA_PTR_SET_VALUE(certList_, certList) };
    inline GroupUserSaveRequest& setCertList(vector<GroupUserSaveRequestCertList> && certList) { DARABONBA_PTR_SET_RVALUE(certList_, certList) };
    ...
    inline const vector<GroupUserSaveRequestSubCorpIdList> & subCorpIdList() const { DARABONBA_PTR_GET_CONST(subCorpIdList_, vector<GroupUserSaveRequestSubCorpIdList>) };
    inline vector<GroupUserSaveRequestSubCorpIdList> subCorpIdList() { DARABONBA_PTR_GET(subCorpIdList_, vector<GroupUserSaveRequestSubCorpIdList>) };
    inline GroupUserSaveRequest& setSubCorpIdList(const vector<GroupUserSaveRequestSubCorpIdList> & subCorpIdList) { DARABONBA_PTR_SET_VALUE(subCorpIdList_, subCorpIdList) };
    inline GroupUserSaveRequest& setSubCorpIdList(vector<GroupUserSaveRequestSubCorpIdList> && subCorpIdList) { DARABONBA_PTR_SET_RVALUE(subCorpIdList_, subCorpIdList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GroupUserSaveRequestCertList>> certList_ = nullptr;
    ...
    std::shared_ptr<vector<GroupUserSaveRequestSubCorpIdList>> subCorpIdList_ = nullptr;
    // This parameter is required.
