...
namespace Models
{
  ...
  public:
    ...
    inline const HotelOrderPreValidateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HotelOrderPreValidateResponseBody) };
    inline HotelOrderPreValidateResponseBody getBody() { DARABONBA_PTR_GET(body_, HotelOrderPreValidateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HotelOrderPreValidateResponseBody> body_ {};
  };
