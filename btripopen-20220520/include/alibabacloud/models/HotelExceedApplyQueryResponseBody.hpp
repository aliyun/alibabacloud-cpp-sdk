...
namespace Models
{
  ...
  public:
    ...
    inline const HotelExceedApplyQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelExceedApplyQueryResponseBodyModule) };
    inline HotelExceedApplyQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelExceedApplyQueryResponseBodyModule) };
    inline HotelExceedApplyQueryResponseBody& setModule(const HotelExceedApplyQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelExceedApplyQueryResponseBody& setModule(HotelExceedApplyQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelExceedApplyQueryResponseBodyModule> module_ = nullptr;
