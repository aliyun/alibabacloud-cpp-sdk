...
#ifndef ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTITEMLISTSHOPPINGITEMMAPVALUESEGMENTPRICEVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTITEMLISTSHOPPINGITEMMAPVALUESEGMENTPRICEVALUE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& obj) { 
    ...
    ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue() = default ;
    ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue(const ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue &) = default ;
    ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue(ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue &&) = default ;
    ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue() = default ;
    ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& operator=(const ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue &) = default ;
    ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& operator=(ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue &&) = default ;
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setFloorPrice(int32_t floorPrice) { DARABONBA_PTR_SET_VALUE(floorPrice_, floorPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setTicketPrice(int32_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setSellPrice(int32_t sellPrice) { DARABONBA_PTR_SET_VALUE(sellPrice_, sellPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setOriginalSellPrice(int32_t originalSellPrice) { DARABONBA_PTR_SET_VALUE(originalSellPrice_, originalSellPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setBaseTotalPrice(int32_t baseTotalPrice) { DARABONBA_PTR_SET_VALUE(baseTotalPrice_, baseTotalPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setBeforeControlPrice(int32_t beforeControlPrice) { DARABONBA_PTR_SET_VALUE(beforeControlPrice_, beforeControlPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setTax(int32_t tax) { DARABONBA_PTR_SET_VALUE(tax_, tax) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setSupplyPrice(int32_t supplyPrice) { DARABONBA_PTR_SET_VALUE(supplyPrice_, supplyPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setBasicCabinPrice(int32_t basicCabinPrice) { DARABONBA_PTR_SET_VALUE(basicCabinPrice_, basicCabinPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setBuildPrice(int32_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setOilPrice(int32_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setFirstStandardPrice(int32_t firstStandardPrice) { DARABONBA_PTR_SET_VALUE(firstStandardPrice_, firstStandardPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setBusinessStandardPrice(int32_t businessStandardPrice) { DARABONBA_PTR_SET_VALUE(businessStandardPrice_, businessStandardPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setCommonStandardPrice(int32_t commonStandardPrice) { DARABONBA_PTR_SET_VALUE(commonStandardPrice_, commonStandardPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setInterTicketPrice(int32_t interTicketPrice) { DARABONBA_PTR_SET_VALUE(interTicketPrice_, interTicketPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setSubtractedPrice(int32_t subtractedPrice) { DARABONBA_PTR_SET_VALUE(subtractedPrice_, subtractedPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setOriginCommonPrice(int32_t originCommonPrice) { DARABONBA_PTR_SET_VALUE(originCommonPrice_, originCommonPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setDynamicPromotionPrice(int32_t dynamicPromotionPrice) { DARABONBA_PTR_SET_VALUE(dynamicPromotionPrice_, dynamicPromotionPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setInstallmentNum(int32_t installmentNum) { DARABONBA_PTR_SET_VALUE(installmentNum_, installmentNum) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setInstallmentPrice(double installmentPrice) { DARABONBA_PTR_SET_VALUE(installmentPrice_, installmentPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setCompetitionDynamicPrice(int32_t competitionDynamicPrice) { DARABONBA_PTR_SET_VALUE(competitionDynamicPrice_, competitionDynamicPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setCompetitionPromotionPrice(int32_t competitionPromotionPrice) { DARABONBA_PTR_SET_VALUE(competitionPromotionPrice_, competitionPromotionPrice) };
    ...
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setMinBeforeControlPriceOfNormal(int32_t minBeforeControlPriceOfNormal) { DARABONBA_PTR_SET_VALUE(minBeforeControlPriceOfNormal_, minBeforeControlPriceOfNormal) };
    ...
    inline const ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo & priceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo) };
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo priceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo) };
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(const ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo> priceShowInfo_ = nullptr;
  };
