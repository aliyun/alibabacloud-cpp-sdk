...
namespace Models
{
  ...
  public:
    ...
    inline const ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo & getPriceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo) };
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo getPriceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo) };
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(const ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    shared_ptr<ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo> priceShowInfo_ {};
  };
