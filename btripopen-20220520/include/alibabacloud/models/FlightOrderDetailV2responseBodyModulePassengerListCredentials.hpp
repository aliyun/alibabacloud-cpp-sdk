...
#ifndef ALIBABACLOUD_MODELS_FLIGHTORDERDETAILV2RESPONSEBODYMODULEPASSENGERLISTCREDENTIALS_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTORDERDETAILV2RESPONSEBODYMODULEPASSENGERLISTCREDENTIALS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& obj) { 
    ...
    FlightOrderDetailV2ResponseBodyModulePassengerListCredentials() = default ;
    FlightOrderDetailV2ResponseBodyModulePassengerListCredentials(const FlightOrderDetailV2ResponseBodyModulePassengerListCredentials &) = default ;
    FlightOrderDetailV2ResponseBodyModulePassengerListCredentials(FlightOrderDetailV2ResponseBodyModulePassengerListCredentials &&) = default ;
    FlightOrderDetailV2ResponseBodyModulePassengerListCredentials(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightOrderDetailV2ResponseBodyModulePassengerListCredentials() = default ;
    FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& operator=(const FlightOrderDetailV2ResponseBodyModulePassengerListCredentials &) = default ;
    FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& operator=(FlightOrderDetailV2ResponseBodyModulePassengerListCredentials &&) = default ;
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setBirthDate(string birthDate) { DARABONBA_PTR_SET_VALUE(birthDate_, birthDate) };
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setCertIssueDate(string certIssueDate) { DARABONBA_PTR_SET_VALUE(certIssueDate_, certIssueDate) };
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setCertIssuePlace(string certIssuePlace) { DARABONBA_PTR_SET_VALUE(certIssuePlace_, certIssuePlace) };
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setCredentialNo(string credentialNo) { DARABONBA_PTR_SET_VALUE(credentialNo_, credentialNo) };
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setDriveLicenceFirst(string driveLicenceFirst) { DARABONBA_PTR_SET_VALUE(driveLicenceFirst_, driveLicenceFirst) };
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setDriveLicenceType(string driveLicenceType) { DARABONBA_PTR_SET_VALUE(driveLicenceType_, driveLicenceType) };
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setExpireDate(string expireDate) { DARABONBA_PTR_SET_VALUE(expireDate_, expireDate) };
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setHolderNationality(string holderNationality) { DARABONBA_PTR_SET_VALUE(holderNationality_, holderNationality) };
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setIdCheckCode(string idCheckCode) { DARABONBA_PTR_SET_VALUE(idCheckCode_, idCheckCode) };
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setIssueCountry(string issueCountry) { DARABONBA_PTR_SET_VALUE(issueCountry_, issueCountry) };
    ...
    inline FlightOrderDetailV2ResponseBodyModulePassengerListCredentials& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
