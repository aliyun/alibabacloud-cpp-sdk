...
namespace Models
{
  ...
  public:
    ...
    inline const ExternalUserQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, ExternalUserQueryResponseBodyModule) };
    inline ExternalUserQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, ExternalUserQueryResponseBodyModule) };
    inline ExternalUserQueryResponseBody& setModule(const ExternalUserQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline ExternalUserQueryResponseBody& setModule(ExternalUserQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<ExternalUserQueryResponseBodyModule> module_ = nullptr;
