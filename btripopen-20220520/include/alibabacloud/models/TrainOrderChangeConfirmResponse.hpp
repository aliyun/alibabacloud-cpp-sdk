...
namespace Models
{
  ...
  public:
    ...
    inline const TrainOrderChangeConfirmResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TrainOrderChangeConfirmResponseBody) };
    inline TrainOrderChangeConfirmResponseBody getBody() { DARABONBA_PTR_GET(body_, TrainOrderChangeConfirmResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TrainOrderChangeConfirmResponseBody> body_ {};
  };
