...
#ifndef ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTITEMLISTSUBITEMSSHOPPINGITEMMAPVALUESEARCHPRICE_HPP_
#define ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTITEMLISTSUBITEMSSHOPPINGITEMMAPVALUESEARCHPRICE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& obj) { 
    ...
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice() = default ;
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice(const ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice &) = default ;
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice(ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice &&) = default ;
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice() = default ;
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& operator=(const ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice &) = default ;
    ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& operator=(ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice &&) = default ;
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setFloorPrice(int32_t floorPrice) { DARABONBA_PTR_SET_VALUE(floorPrice_, floorPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setTicketPrice(int32_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setSellPrice(int32_t sellPrice) { DARABONBA_PTR_SET_VALUE(sellPrice_, sellPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setOriginalSellPrice(int32_t originalSellPrice) { DARABONBA_PTR_SET_VALUE(originalSellPrice_, originalSellPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setBaseTotalPrice(int32_t baseTotalPrice) { DARABONBA_PTR_SET_VALUE(baseTotalPrice_, baseTotalPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setBeforeControlPrice(int32_t beforeControlPrice) { DARABONBA_PTR_SET_VALUE(beforeControlPrice_, beforeControlPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setTax(int32_t tax) { DARABONBA_PTR_SET_VALUE(tax_, tax) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setSupplyPrice(int32_t supplyPrice) { DARABONBA_PTR_SET_VALUE(supplyPrice_, supplyPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setBasicCabinPrice(int32_t basicCabinPrice) { DARABONBA_PTR_SET_VALUE(basicCabinPrice_, basicCabinPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setBuildPrice(int32_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setOilPrice(int32_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setFirstStandardPrice(int32_t firstStandardPrice) { DARABONBA_PTR_SET_VALUE(firstStandardPrice_, firstStandardPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setBusinessStandardPrice(int32_t businessStandardPrice) { DARABONBA_PTR_SET_VALUE(businessStandardPrice_, businessStandardPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setCommonStandardPrice(int32_t commonStandardPrice) { DARABONBA_PTR_SET_VALUE(commonStandardPrice_, commonStandardPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setInterTicketPrice(int32_t interTicketPrice) { DARABONBA_PTR_SET_VALUE(interTicketPrice_, interTicketPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setSubtractedPrice(int32_t subtractedPrice) { DARABONBA_PTR_SET_VALUE(subtractedPrice_, subtractedPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setOriginCommonPrice(int32_t originCommonPrice) { DARABONBA_PTR_SET_VALUE(originCommonPrice_, originCommonPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setDynamicPromotionPrice(int32_t dynamicPromotionPrice) { DARABONBA_PTR_SET_VALUE(dynamicPromotionPrice_, dynamicPromotionPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setInstallmentNum(int32_t installmentNum) { DARABONBA_PTR_SET_VALUE(installmentNum_, installmentNum) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setInstallmentPrice(double installmentPrice) { DARABONBA_PTR_SET_VALUE(installmentPrice_, installmentPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setCompetitionDynamicPrice(int32_t competitionDynamicPrice) { DARABONBA_PTR_SET_VALUE(competitionDynamicPrice_, competitionDynamicPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setCompetitionPromotionPrice(int32_t competitionPromotionPrice) { DARABONBA_PTR_SET_VALUE(competitionPromotionPrice_, competitionPromotionPrice) };
    ...
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setMinBeforeControlPriceOfNormal(int32_t minBeforeControlPriceOfNormal) { DARABONBA_PTR_SET_VALUE(minBeforeControlPriceOfNormal_, minBeforeControlPriceOfNormal) };
    ...
    inline const Models::ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo & priceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, Models::ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo) };
    inline Models::ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo priceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, Models::ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo) };
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setPriceShowInfo(const Models::ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice& setPriceShowInfo(Models::ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo> priceShowInfo_ = nullptr;
  };
