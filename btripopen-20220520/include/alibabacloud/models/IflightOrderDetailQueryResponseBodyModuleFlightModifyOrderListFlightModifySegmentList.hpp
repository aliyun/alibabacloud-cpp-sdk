...
#ifndef ALIBABACLOUD_MODELS_IFLIGHTORDERDETAILQUERYRESPONSEBODYMODULEFLIGHTMODIFYORDERLISTFLIGHTMODIFYSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_IFLIGHTORDERDETAILQUERYRESPONSEBODYMODULEFLIGHTMODIFYORDERLISTFLIGHTMODIFYSEGMENTLIST_HPP_
...
namespace Models
{
  class IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& obj) { 
    ...
    IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList() = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList(const IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList &) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList(IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList &&) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList() = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& operator=(const IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList &) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& operator=(IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList &&) = default ;
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setAirlineCode(string airlineCode) { DARABONBA_PTR_SET_VALUE(airlineCode_, airlineCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setAirlineName(string airlineName) { DARABONBA_PTR_SET_VALUE(airlineName_, airlineName) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrApt(string arrApt) { DARABONBA_PTR_SET_VALUE(arrApt_, arrApt) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrAptCode(string arrAptCode) { DARABONBA_PTR_SET_VALUE(arrAptCode_, arrAptCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrCity(string arrCity) { DARABONBA_PTR_SET_VALUE(arrCity_, arrCity) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrCityCode(string arrCityCode) { DARABONBA_PTR_SET_VALUE(arrCityCode_, arrCityCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrTerminal(string arrTerminal) { DARABONBA_PTR_SET_VALUE(arrTerminal_, arrTerminal) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrTime(string arrTime) { DARABONBA_PTR_SET_VALUE(arrTime_, arrTime) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setCarrierAirlineCode(string carrierAirlineCode) { DARABONBA_PTR_SET_VALUE(carrierAirlineCode_, carrierAirlineCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setCarrierAirlineName(string carrierAirlineName) { DARABONBA_PTR_SET_VALUE(carrierAirlineName_, carrierAirlineName) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepApt(string depApt) { DARABONBA_PTR_SET_VALUE(depApt_, depApt) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepAptCode(string depAptCode) { DARABONBA_PTR_SET_VALUE(depAptCode_, depAptCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepCity(string depCity) { DARABONBA_PTR_SET_VALUE(depCity_, depCity) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepCityCode(string depCityCode) { DARABONBA_PTR_SET_VALUE(depCityCode_, depCityCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepTerminal(string depTerminal) { DARABONBA_PTR_SET_VALUE(depTerminal_, depTerminal) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepTime(string depTime) { DARABONBA_PTR_SET_VALUE(depTime_, depTime) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setFlightNo(string flightNo) { DARABONBA_PTR_SET_VALUE(flightNo_, flightNo) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setJourneyIndex(int32_t journeyIndex) { DARABONBA_PTR_SET_VALUE(journeyIndex_, journeyIndex) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setSegmentIndex(int32_t segmentIndex) { DARABONBA_PTR_SET_VALUE(segmentIndex_, segmentIndex) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setShare(bool share) { DARABONBA_PTR_SET_VALUE(share_, share) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setStopAptCode(string stopAptCode) { DARABONBA_PTR_SET_VALUE(stopAptCode_, stopAptCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setStopArrTime(string stopArrTime) { DARABONBA_PTR_SET_VALUE(stopArrTime_, stopArrTime) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setStopCity(string stopCity) { DARABONBA_PTR_SET_VALUE(stopCity_, stopCity) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setStopCityCode(string stopCityCode) { DARABONBA_PTR_SET_VALUE(stopCityCode_, stopCityCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setStopDepTime(string stopDepTime) { DARABONBA_PTR_SET_VALUE(stopDepTime_, stopDepTime) };
