...
#ifndef ALIBABACLOUD_MODELS_MODULEITEMLISTSHOPPINGITEMMAPVALUESEGMENTPRICEVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULEITEMLISTSHOPPINGITEMMAPVALUESEGMENTPRICEVALUE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleItemListShoppingItemMapValueSegmentPriceValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleItemListShoppingItemMapValueSegmentPriceValue& obj) { 
    ...
    ModuleItemListShoppingItemMapValueSegmentPriceValue() = default ;
    ModuleItemListShoppingItemMapValueSegmentPriceValue(const ModuleItemListShoppingItemMapValueSegmentPriceValue &) = default ;
    ModuleItemListShoppingItemMapValueSegmentPriceValue(ModuleItemListShoppingItemMapValueSegmentPriceValue &&) = default ;
    ModuleItemListShoppingItemMapValueSegmentPriceValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleItemListShoppingItemMapValueSegmentPriceValue() = default ;
    ModuleItemListShoppingItemMapValueSegmentPriceValue& operator=(const ModuleItemListShoppingItemMapValueSegmentPriceValue &) = default ;
    ModuleItemListShoppingItemMapValueSegmentPriceValue& operator=(ModuleItemListShoppingItemMapValueSegmentPriceValue &&) = default ;
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setFloorPrice(int32_t floorPrice) { DARABONBA_PTR_SET_VALUE(floorPrice_, floorPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setTicketPrice(int32_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setSellPrice(int32_t sellPrice) { DARABONBA_PTR_SET_VALUE(sellPrice_, sellPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setOriginalSellPrice(int32_t originalSellPrice) { DARABONBA_PTR_SET_VALUE(originalSellPrice_, originalSellPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setBaseTotalPrice(int32_t baseTotalPrice) { DARABONBA_PTR_SET_VALUE(baseTotalPrice_, baseTotalPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setBeforeControlPrice(int32_t beforeControlPrice) { DARABONBA_PTR_SET_VALUE(beforeControlPrice_, beforeControlPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setTax(int32_t tax) { DARABONBA_PTR_SET_VALUE(tax_, tax) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setSupplyPrice(int32_t supplyPrice) { DARABONBA_PTR_SET_VALUE(supplyPrice_, supplyPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setBasicCabinPrice(int32_t basicCabinPrice) { DARABONBA_PTR_SET_VALUE(basicCabinPrice_, basicCabinPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setBuildPrice(int32_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setOilPrice(int32_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setFirstStandardPrice(int32_t firstStandardPrice) { DARABONBA_PTR_SET_VALUE(firstStandardPrice_, firstStandardPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setBusinessStandardPrice(int32_t businessStandardPrice) { DARABONBA_PTR_SET_VALUE(businessStandardPrice_, businessStandardPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setCommonStandardPrice(int32_t commonStandardPrice) { DARABONBA_PTR_SET_VALUE(commonStandardPrice_, commonStandardPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setInterTicketPrice(int32_t interTicketPrice) { DARABONBA_PTR_SET_VALUE(interTicketPrice_, interTicketPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setSubtractedPrice(int32_t subtractedPrice) { DARABONBA_PTR_SET_VALUE(subtractedPrice_, subtractedPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setOriginCommonPrice(int32_t originCommonPrice) { DARABONBA_PTR_SET_VALUE(originCommonPrice_, originCommonPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setDynamicPromotionPrice(int32_t dynamicPromotionPrice) { DARABONBA_PTR_SET_VALUE(dynamicPromotionPrice_, dynamicPromotionPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setInstallmentNum(int32_t installmentNum) { DARABONBA_PTR_SET_VALUE(installmentNum_, installmentNum) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setInstallmentPrice(double installmentPrice) { DARABONBA_PTR_SET_VALUE(installmentPrice_, installmentPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setCompetitionDynamicPrice(int32_t competitionDynamicPrice) { DARABONBA_PTR_SET_VALUE(competitionDynamicPrice_, competitionDynamicPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setCompetitionPromotionPrice(int32_t competitionPromotionPrice) { DARABONBA_PTR_SET_VALUE(competitionPromotionPrice_, competitionPromotionPrice) };
    ...
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setMinBeforeControlPriceOfNormal(int32_t minBeforeControlPriceOfNormal) { DARABONBA_PTR_SET_VALUE(minBeforeControlPriceOfNormal_, minBeforeControlPriceOfNormal) };
    ...
    inline const ModuleItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo & priceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, ModuleItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo) };
    inline ModuleItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo priceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, ModuleItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo) };
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(const ModuleItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(ModuleItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ModuleItemListShoppingItemMapValueSegmentPriceValuePriceShowInfo> priceShowInfo_ = nullptr;
  };
