...
namespace Models
{
  ...
  public:
    ...
    inline const ModuleItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo & getPriceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, ModuleItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo) };
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo getPriceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, ModuleItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo) };
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(const ModuleItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleItemListShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(ModuleItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    shared_ptr<ModuleItemListShoppingItemMapValueSegmentPriceValue::PriceShowInfo> priceShowInfo_ {};
  };
