...
#ifndef ALIBABACLOUD_MODELS_HOTELORDERLISTQUERYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_HOTELORDERLISTQUERYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const HotelOrderListQueryRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, HotelOrderListQueryRequest& obj) { 
    ...
    HotelOrderListQueryRequest() = default ;
    HotelOrderListQueryRequest(const HotelOrderListQueryRequest &) = default ;
    HotelOrderListQueryRequest(HotelOrderListQueryRequest &&) = default ;
    HotelOrderListQueryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~HotelOrderListQueryRequest() = default ;
    HotelOrderListQueryRequest& operator=(const HotelOrderListQueryRequest &) = default ;
    HotelOrderListQueryRequest& operator=(HotelOrderListQueryRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->allApply_ != nullptr
        && this->applyId_ != nullptr && this->category_ != nullptr && this->departId_ != nullptr && this->endTime_ != nullptr && this->page_ != nullptr
        && this->pageSize_ != nullptr && this->startTime_ != nullptr && this->thirdpartApplyId_ != nullptr && this->updateEndTime_ != nullptr && this->updateStartTime_ != nullptr
    ...
    inline HotelOrderListQueryRequest& setAllApply(bool allApply) { DARABONBA_PTR_SET_VALUE(allApply_, allApply) };
    ...
    inline HotelOrderListQueryRequest& setApplyId(int64_t applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline HotelOrderListQueryRequest& setCategory(int32_t category) { DARABONBA_PTR_SET_VALUE(category_, category) };
    ...
    inline HotelOrderListQueryRequest& setDepartId(string departId) { DARABONBA_PTR_SET_VALUE(departId_, departId) };
    ...
    inline HotelOrderListQueryRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline HotelOrderListQueryRequest& setPage(int32_t page) { DARABONBA_PTR_SET_VALUE(page_, page) };
    ...
    inline HotelOrderListQueryRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline HotelOrderListQueryRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline HotelOrderListQueryRequest& setThirdpartApplyId(string thirdpartApplyId) { DARABONBA_PTR_SET_VALUE(thirdpartApplyId_, thirdpartApplyId) };
    ...
    inline HotelOrderListQueryRequest& setUpdateEndTime(string updateEndTime) { DARABONBA_PTR_SET_VALUE(updateEndTime_, updateEndTime) };
    ...
    inline HotelOrderListQueryRequest& setUpdateStartTime(string updateStartTime) { DARABONBA_PTR_SET_VALUE(updateStartTime_, updateStartTime) };
    ...
    inline HotelOrderListQueryRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
