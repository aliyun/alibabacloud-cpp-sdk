...
namespace Models
{
  ...
  public:
    ...
    inline const TrainTicketScanQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TrainTicketScanQueryResponseBodyModule) };
    inline TrainTicketScanQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, TrainTicketScanQueryResponseBodyModule) };
    inline TrainTicketScanQueryResponseBody& setModule(const TrainTicketScanQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainTicketScanQueryResponseBody& setModule(TrainTicketScanQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TrainTicketScanQueryResponseBodyModule> module_ = nullptr;
    // requestId
