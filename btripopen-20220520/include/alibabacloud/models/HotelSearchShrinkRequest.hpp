...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adultNum_ == nullptr
        ...
        && this->pageSize_ == nullptr && this->payOverType_ == nullptr && this->paymentType_ == nullptr && this->poi_ == nullptr && this->shidsShrink_ == nullptr
    ...
    inline string getBrandCodeShrink() const { DARABONBA_PTR_GET_DEFAULT(brandCodeShrink_, "") };
    ...
    inline int32_t getPayOverType() const { DARABONBA_PTR_GET_DEFAULT(payOverType_, 0) };
    ...
    inline HotelSearchShrinkRequest& setPoi(string poi) { DARABONBA_PTR_SET_VALUE(poi_, poi) };
    ...
    inline string getShidsShrink() const { DARABONBA_PTR_GET_DEFAULT(shidsShrink_, "") };
    ...
    inline int32_t getSuperMan() const { DARABONBA_PTR_GET_DEFAULT(superMan_, 0) };
  ...
  protected:
    ...
    shared_ptr<string> brandCodeShrink_ {};
    ...
    shared_ptr<string> shidsShrink_ {};
    // This parameter is required.
    shared_ptr<int32_t> sortCode_ {};
    shared_ptr<int32_t> superMan_ {};
  };
