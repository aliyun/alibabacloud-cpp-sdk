...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCustomRoleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateCustomRoleResponseBody) };
    inline UpdateCustomRoleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateCustomRoleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateCustomRoleResponseBody> body_ {};
  };
