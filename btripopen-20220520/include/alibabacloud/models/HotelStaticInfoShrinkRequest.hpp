...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->hotelIdsShrink_ == nullptr; };
    ...
    inline string getHotelIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(hotelIdsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> hotelIdsShrink_ {};
  };
