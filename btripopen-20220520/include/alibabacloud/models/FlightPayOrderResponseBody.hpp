...
namespace Models
{
  ...
  public:
    ...
    inline const FlightPayOrderResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightPayOrderResponseBodyModule) };
    inline FlightPayOrderResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightPayOrderResponseBodyModule) };
    inline FlightPayOrderResponseBody& setModule(const FlightPayOrderResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightPayOrderResponseBody& setModule(FlightPayOrderResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<FlightPayOrderResponseBodyModule> module_ = nullptr;
