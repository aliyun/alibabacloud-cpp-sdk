...
namespace Models
{
  ...
  public:
    ...
    inline const ExternalUserDeleteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExternalUserDeleteResponseBody) };
    inline ExternalUserDeleteResponseBody getBody() { DARABONBA_PTR_GET(body_, ExternalUserDeleteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExternalUserDeleteResponseBody> body_ {};
  };
