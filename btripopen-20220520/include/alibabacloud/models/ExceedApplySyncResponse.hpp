...
namespace Models
{
  ...
  public:
    ...
    inline const ExceedApplySyncResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExceedApplySyncResponseBody) };
    inline ExceedApplySyncResponseBody getBody() { DARABONBA_PTR_GET(body_, ExceedApplySyncResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExceedApplySyncResponseBody> body_ {};
  };
