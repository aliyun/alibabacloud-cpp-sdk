...
namespace Models
{
  ...
  public:
    ...
    inline const FuPointBillSettlementQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FuPointBillSettlementQueryResponseBody) };
    inline FuPointBillSettlementQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, FuPointBillSettlementQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FuPointBillSettlementQueryResponseBody> body_ {};
  };
