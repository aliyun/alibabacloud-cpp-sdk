...
namespace Models
{
  ...
  public:
    ...
    inline const TrainOrderPayResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TrainOrderPayResponseBodyModule) };
    inline TrainOrderPayResponseBodyModule module() { DARABONBA_PTR_GET(module_, TrainOrderPayResponseBodyModule) };
    inline TrainOrderPayResponseBody& setModule(const TrainOrderPayResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainOrderPayResponseBody& setModule(TrainOrderPayResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<TrainOrderPayResponseBodyModule> module_ = nullptr;
