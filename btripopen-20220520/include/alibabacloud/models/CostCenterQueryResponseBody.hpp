...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CostCenterQueryResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<CostCenterQueryResponseBodyModule>) };
    inline vector<CostCenterQueryResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<CostCenterQueryResponseBodyModule>) };
    inline CostCenterQueryResponseBody& setModule(const vector<CostCenterQueryResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline CostCenterQueryResponseBody& setModule(vector<CostCenterQueryResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CostCenterQueryResponseBodyModule>> module_ = nullptr;
