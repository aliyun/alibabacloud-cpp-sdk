...
namespace Models
{
  ...
  public:
    ...
    inline const TrainFeeCalculateRefundResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TrainFeeCalculateRefundResponseBody) };
    inline TrainFeeCalculateRefundResponseBody getBody() { DARABONBA_PTR_GET(body_, TrainFeeCalculateRefundResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TrainFeeCalculateRefundResponseBody> body_ {};
  };
