...
namespace Models
{
  ...
  public:
    ...
    inline const FlightOrderListQueryV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FlightOrderListQueryV2ResponseBody) };
    inline FlightOrderListQueryV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, FlightOrderListQueryV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FlightOrderListQueryV2ResponseBody> body_ {};
  };
