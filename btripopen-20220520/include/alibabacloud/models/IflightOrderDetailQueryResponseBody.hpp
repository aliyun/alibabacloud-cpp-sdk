...
namespace Models
{
  ...
  public:
    ...
    inline const IFlightOrderDetailQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IFlightOrderDetailQueryResponseBodyModule) };
    inline IFlightOrderDetailQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, IFlightOrderDetailQueryResponseBodyModule) };
    inline IFlightOrderDetailQueryResponseBody& setModule(const IFlightOrderDetailQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IFlightOrderDetailQueryResponseBody& setModule(IFlightOrderDetailQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IFlightOrderDetailQueryResponseBodyModule> module_ = nullptr;
