...
#ifndef ALIBABACLOUD_MODELS_FLIGHTMODIFYLISTINGSEARCHV2RESPONSEBODYMODULETRANSFERFLIGHTLISTFLIGHTSTOPINFO_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTMODIFYLISTINGSEARCHV2RESPONSEBODYMODULETRANSFERFLIGHTLISTFLIGHTSTOPINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo& obj) { 
    ...
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo() = default ;
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo(const FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo &) = default ;
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo(FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo &&) = default ;
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo() = default ;
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo& operator=(const FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo &) = default ;
    FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo& operator=(FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo &&) = default ;
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo& setStopAirport(string stopAirport) { DARABONBA_PTR_SET_VALUE(stopAirport_, stopAirport) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo& setStopArrTerm(string stopArrTerm) { DARABONBA_PTR_SET_VALUE(stopArrTerm_, stopArrTerm) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo& setStopArrTime(string stopArrTime) { DARABONBA_PTR_SET_VALUE(stopArrTime_, stopArrTime) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo& setStopCityCode(string stopCityCode) { DARABONBA_PTR_SET_VALUE(stopCityCode_, stopCityCode) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo& setStopCityName(string stopCityName) { DARABONBA_PTR_SET_VALUE(stopCityName_, stopCityName) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo& setStopDepTerm(string stopDepTerm) { DARABONBA_PTR_SET_VALUE(stopDepTerm_, stopDepTerm) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleTransferFlightListFlightStopInfo& setStopDepTime(string stopDepTime) { DARABONBA_PTR_SET_VALUE(stopDepTime_, stopDepTime) };
