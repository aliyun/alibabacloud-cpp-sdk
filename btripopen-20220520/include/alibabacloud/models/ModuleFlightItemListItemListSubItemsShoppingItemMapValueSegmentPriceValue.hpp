...
namespace Models
{
  ...
  public:
    ...
    inline const ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo & getPriceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo) };
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo getPriceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo) };
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(const ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    shared_ptr<ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo> priceShowInfo_ {};
  };
