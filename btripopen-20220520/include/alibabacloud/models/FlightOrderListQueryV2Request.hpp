...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getApproveId() const { DARABONBA_PTR_GET_CONST(approveId_, vector<string>) };
    inline vector<string> getApproveId() { DARABONBA_PTR_GET(approveId_, vector<string>) };
    ...
    inline const vector<string> & getBookerId() const { DARABONBA_PTR_GET_CONST(bookerId_, vector<string>) };
    inline vector<string> getBookerId() { DARABONBA_PTR_GET(bookerId_, vector<string>) };
    ...
    inline const vector<string> & getDepartId() const { DARABONBA_PTR_GET_CONST(departId_, vector<string>) };
    inline vector<string> getDepartId() { DARABONBA_PTR_GET(departId_, vector<string>) };
    ...
    inline const vector<string> & getSupplier() const { DARABONBA_PTR_GET_CONST(supplier_, vector<string>) };
    inline vector<string> getSupplier() { DARABONBA_PTR_GET(supplier_, vector<string>) };
    ...
    inline const vector<string> & getThirdpartApproveId() const { DARABONBA_PTR_GET_CONST(thirdpartApproveId_, vector<string>) };
    inline vector<string> getThirdpartApproveId() { DARABONBA_PTR_GET(thirdpartApproveId_, vector<string>) };
  ...
  protected:
    shared_ptr<vector<string>> approveId_ {};
    shared_ptr<vector<string>> bookerId_ {};
    shared_ptr<vector<string>> departId_ {};
    shared_ptr<string> endDate_ {};
    shared_ptr<int32_t> pageSize_ {};
    shared_ptr<string> scrollId_ {};
    shared_ptr<string> startDate_ {};
    shared_ptr<vector<string>> supplier_ {};
    shared_ptr<vector<string>> thirdpartApproveId_ {};
