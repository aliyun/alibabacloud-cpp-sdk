...
#ifndef ALIBABACLOUD_MODELS_IFLIGHTORDERDETAILQUERYRESPONSEBODYMODULEFLIGHTSALEORDERFLIGHTSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_IFLIGHTORDERDETAILQUERYRESPONSEBODYMODULEFLIGHTSALEORDERFLIGHTSEGMENTLIST_HPP_
...
namespace Models
{
  class IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& obj) { 
    ...
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList() = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList(const IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList &) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList(IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList &&) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList() = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& operator=(const IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList &) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& operator=(IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList &&) = default ;
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setAirlineCode(string airlineCode) { DARABONBA_PTR_SET_VALUE(airlineCode_, airlineCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setAirlineName(string airlineName) { DARABONBA_PTR_SET_VALUE(airlineName_, airlineName) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrApt(string arrApt) { DARABONBA_PTR_SET_VALUE(arrApt_, arrApt) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrAptCode(string arrAptCode) { DARABONBA_PTR_SET_VALUE(arrAptCode_, arrAptCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrCity(string arrCity) { DARABONBA_PTR_SET_VALUE(arrCity_, arrCity) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrCityCode(string arrCityCode) { DARABONBA_PTR_SET_VALUE(arrCityCode_, arrCityCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrTerminal(string arrTerminal) { DARABONBA_PTR_SET_VALUE(arrTerminal_, arrTerminal) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setArrTime(string arrTime) { DARABONBA_PTR_SET_VALUE(arrTime_, arrTime) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setCarrierAirlineCode(string carrierAirlineCode) { DARABONBA_PTR_SET_VALUE(carrierAirlineCode_, carrierAirlineCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setCarrierAirlineName(string carrierAirlineName) { DARABONBA_PTR_SET_VALUE(carrierAirlineName_, carrierAirlineName) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepApt(string depApt) { DARABONBA_PTR_SET_VALUE(depApt_, depApt) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepAptCode(string depAptCode) { DARABONBA_PTR_SET_VALUE(depAptCode_, depAptCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepCity(string depCity) { DARABONBA_PTR_SET_VALUE(depCity_, depCity) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepCityCode(string depCityCode) { DARABONBA_PTR_SET_VALUE(depCityCode_, depCityCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepTerminal(string depTerminal) { DARABONBA_PTR_SET_VALUE(depTerminal_, depTerminal) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setDepTime(string depTime) { DARABONBA_PTR_SET_VALUE(depTime_, depTime) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setFlightNo(string flightNo) { DARABONBA_PTR_SET_VALUE(flightNo_, flightNo) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setJourneyIndex(int32_t journeyIndex) { DARABONBA_PTR_SET_VALUE(journeyIndex_, journeyIndex) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setSegmentIndex(int32_t segmentIndex) { DARABONBA_PTR_SET_VALUE(segmentIndex_, segmentIndex) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setShare(bool share) { DARABONBA_PTR_SET_VALUE(share_, share) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setStopAptCode(string stopAptCode) { DARABONBA_PTR_SET_VALUE(stopAptCode_, stopAptCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setStopArrTime(string stopArrTime) { DARABONBA_PTR_SET_VALUE(stopArrTime_, stopArrTime) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setStopCity(string stopCity) { DARABONBA_PTR_SET_VALUE(stopCity_, stopCity) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setStopCityCode(string stopCityCode) { DARABONBA_PTR_SET_VALUE(stopCityCode_, stopCityCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList& setStopDepTime(string stopDepTime) { DARABONBA_PTR_SET_VALUE(stopDepTime_, stopDepTime) };
