...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightOrderPayCheckResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IntlFlightOrderPayCheckResponseBody) };
    inline IntlFlightOrderPayCheckResponseBody getBody() { DARABONBA_PTR_GET(body_, IntlFlightOrderPayCheckResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IntlFlightOrderPayCheckResponseBody> body_ {};
  };
