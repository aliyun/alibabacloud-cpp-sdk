...
namespace Models
{
  ...
  public:
    ...
    inline const vector<WaitApplyInvoiceTaskDetailQueryResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<WaitApplyInvoiceTaskDetailQueryResponseBodyModule>) };
    inline vector<WaitApplyInvoiceTaskDetailQueryResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<WaitApplyInvoiceTaskDetailQueryResponseBodyModule>) };
    inline WaitApplyInvoiceTaskDetailQueryResponseBody& setModule(const vector<WaitApplyInvoiceTaskDetailQueryResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline WaitApplyInvoiceTaskDetailQueryResponseBody& setModule(vector<WaitApplyInvoiceTaskDetailQueryResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<vector<WaitApplyInvoiceTaskDetailQueryResponseBodyModule>> module_ = nullptr;
    // requestId
