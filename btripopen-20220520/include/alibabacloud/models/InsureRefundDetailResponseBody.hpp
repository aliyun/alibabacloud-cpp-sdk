...
namespace Models
{
  ...
  public:
    ...
    inline const InsureRefundDetailResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, InsureRefundDetailResponseBodyModule) };
    inline InsureRefundDetailResponseBodyModule module() { DARABONBA_PTR_GET(module_, InsureRefundDetailResponseBodyModule) };
    inline InsureRefundDetailResponseBody& setModule(const InsureRefundDetailResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline InsureRefundDetailResponseBody& setModule(InsureRefundDetailResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<InsureRefundDetailResponseBodyModule> module_ = nullptr;
