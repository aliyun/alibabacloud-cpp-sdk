...
namespace Models
{
  ...
  public:
    ...
    inline const MealApplyApproveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MealApplyApproveResponseBody) };
    inline MealApplyApproveResponseBody getBody() { DARABONBA_PTR_GET(body_, MealApplyApproveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MealApplyApproveResponseBody> body_ {};
  };
