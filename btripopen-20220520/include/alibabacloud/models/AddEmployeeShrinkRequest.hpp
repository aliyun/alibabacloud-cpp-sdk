...
namespace Models
{
  ...
  public:
    ...
    inline string getBaseCityCodeListShrink() const { DARABONBA_PTR_GET_DEFAULT(baseCityCodeListShrink_, "") };
    ...
    inline string getBaseLocationListShrink() const { DARABONBA_PTR_GET_DEFAULT(baseLocationListShrink_, "") };
    ...
    inline string getCustomRoleCodeListShrink() const { DARABONBA_PTR_GET_DEFAULT(customRoleCodeListShrink_, "") };
    ...
    inline string getOutDeptIdListShrink() const { DARABONBA_PTR_GET_DEFAULT(outDeptIdListShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> baseCityCodeListShrink_ {};
    shared_ptr<string> baseLocationListShrink_ {};
    shared_ptr<string> birthday_ {};
    shared_ptr<string> certListShrink_ {};
    shared_ptr<string> customRoleCodeListShrink_ {};
    ...
    shared_ptr<string> outDeptIdListShrink_ {};
