...
namespace Models
{
  ...
  public:
    ...
    inline const FlightOtaItemDetailResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightOtaItemDetailResponseBodyModule) };
    inline FlightOtaItemDetailResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightOtaItemDetailResponseBodyModule) };
    inline FlightOtaItemDetailResponseBody& setModule(const FlightOtaItemDetailResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightOtaItemDetailResponseBody& setModule(FlightOtaItemDetailResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<FlightOtaItemDetailResponseBodyModule> module_ = nullptr;
    // requestId
