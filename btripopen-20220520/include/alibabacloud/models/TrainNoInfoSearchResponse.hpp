...
namespace Models
{
  ...
  public:
    ...
    inline const TrainNoInfoSearchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TrainNoInfoSearchResponseBody) };
    inline TrainNoInfoSearchResponseBody getBody() { DARABONBA_PTR_GET(body_, TrainNoInfoSearchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TrainNoInfoSearchResponseBody> body_ {};
  };
