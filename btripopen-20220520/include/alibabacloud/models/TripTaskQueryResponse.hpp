...
namespace Models
{
  ...
  public:
    ...
    inline const TripTaskQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TripTaskQueryResponseBody) };
    inline TripTaskQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, TripTaskQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TripTaskQueryResponseBody> body_ {};
  };
