...
namespace Models
{
  ...
  public:
    ...
    inline const MealApplyAddResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, MealApplyAddResponseBody::Module) };
    inline MealApplyAddResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, MealApplyAddResponseBody::Module) };
    inline MealApplyAddResponseBody& setModule(const MealApplyAddResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline MealApplyAddResponseBody& setModule(MealApplyAddResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    shared_ptr<MealApplyAddResponseBody::Module> module_ {};
