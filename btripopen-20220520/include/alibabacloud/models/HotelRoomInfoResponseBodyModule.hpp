...
#ifndef ALIBABACLOUD_MODELS_HOTELROOMINFORESPONSEBODYMODULE_HPP_
#define ALIBABACLOUD_MODELS_HOTELROOMINFORESPONSEBODYMODULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const HotelRoomInfoResponseBodyModule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, HotelRoomInfoResponseBodyModule& obj) { 
    ...
    HotelRoomInfoResponseBodyModule() = default ;
    HotelRoomInfoResponseBodyModule(const HotelRoomInfoResponseBodyModule &) = default ;
    HotelRoomInfoResponseBodyModule(HotelRoomInfoResponseBodyModule &&) = default ;
    HotelRoomInfoResponseBodyModule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~HotelRoomInfoResponseBodyModule() = default ;
    HotelRoomInfoResponseBodyModule& operator=(const HotelRoomInfoResponseBodyModule &) = default ;
    HotelRoomInfoResponseBodyModule& operator=(HotelRoomInfoResponseBodyModule &&) = default ;
    ...
    inline const vector<Models::HotelRoomInfoResponseBodyModuleBedInfoGroupList> & bedInfoGroupList() const { DARABONBA_PTR_GET_CONST(bedInfoGroupList_, vector<Models::HotelRoomInfoResponseBodyModuleBedInfoGroupList>) };
    inline vector<Models::HotelRoomInfoResponseBodyModuleBedInfoGroupList> bedInfoGroupList() { DARABONBA_PTR_GET(bedInfoGroupList_, vector<Models::HotelRoomInfoResponseBodyModuleBedInfoGroupList>) };
    inline HotelRoomInfoResponseBodyModule& setBedInfoGroupList(const vector<Models::HotelRoomInfoResponseBodyModuleBedInfoGroupList> & bedInfoGroupList) { DARABONBA_PTR_SET_VALUE(bedInfoGroupList_, bedInfoGroupList) };
    inline HotelRoomInfoResponseBodyModule& setBedInfoGroupList(vector<Models::HotelRoomInfoResponseBodyModuleBedInfoGroupList> && bedInfoGroupList) { DARABONBA_PTR_SET_RVALUE(bedInfoGroupList_, bedInfoGroupList) };


    // bedInfos Field Functions 
    bool hasBedInfos() const { return this->bedInfos_ != nullptr;};
    void deleteBedInfos() { this->bedInfos_ = nullptr;};
    inline const vector<Models::HotelRoomInfoResponseBodyModuleBedInfos> & bedInfos() const { DARABONBA_PTR_GET_CONST(bedInfos_, vector<Models::HotelRoomInfoResponseBodyModuleBedInfos>) };
    inline vector<Models::HotelRoomInfoResponseBodyModuleBedInfos> bedInfos() { DARABONBA_PTR_GET(bedInfos_, vector<Models::HotelRoomInfoResponseBodyModuleBedInfos>) };
    inline HotelRoomInfoResponseBodyModule& setBedInfos(const vector<Models::HotelRoomInfoResponseBodyModuleBedInfos> & bedInfos) { DARABONBA_PTR_SET_VALUE(bedInfos_, bedInfos) };
    inline HotelRoomInfoResponseBodyModule& setBedInfos(vector<Models::HotelRoomInfoResponseBodyModuleBedInfos> && bedInfos) { DARABONBA_PTR_SET_RVALUE(bedInfos_, bedInfos) };
    ...
    inline HotelRoomInfoResponseBodyModule& setExtraBed(int32_t extraBed) { DARABONBA_PTR_SET_VALUE(extraBed_, extraBed) };
    ...
    inline HotelRoomInfoResponseBodyModule& setExtraBedDesc(string extraBedDesc) { DARABONBA_PTR_SET_VALUE(extraBedDesc_, extraBedDesc) };
    ...
    inline HotelRoomInfoResponseBodyModule& setFloor(string floor) { DARABONBA_PTR_SET_VALUE(floor_, floor) };
    ...
    inline HotelRoomInfoResponseBodyModule& setInternetWay(string internetWay) { DARABONBA_PTR_SET_VALUE(internetWay_, internetWay) };
    ...
    inline HotelRoomInfoResponseBodyModule& setMaxOccupancy(int32_t maxOccupancy) { DARABONBA_PTR_SET_VALUE(maxOccupancy_, maxOccupancy) };


    // roomDesc Field Functions 
    bool hasRoomDesc() const { return this->roomDesc_ != nullptr;};
    void deleteRoomDesc() { this->roomDesc_ = nullptr;};
    inline string roomDesc() const { DARABONBA_PTR_GET_DEFAULT(roomDesc_, "") };
    inline HotelRoomInfoResponseBodyModule& setRoomDesc(string roomDesc) { DARABONBA_PTR_SET_VALUE(roomDesc_, roomDesc) };
    ...
    inline HotelRoomInfoResponseBodyModule& setRoomFacilities(string roomFacilities) { DARABONBA_PTR_SET_VALUE(roomFacilities_, roomFacilities) };
    ...
    inline HotelRoomInfoResponseBodyModule& setRoomFacilityList(const vector<string> & roomFacilityList) { DARABONBA_PTR_SET_VALUE(roomFacilityList_, roomFacilityList) };
    inline HotelRoomInfoResponseBodyModule& setRoomFacilityList(vector<string> && roomFacilityList) { DARABONBA_PTR_SET_RVALUE(roomFacilityList_, roomFacilityList) };
    ...
    inline HotelRoomInfoResponseBodyModule& setRoomId(string roomId) { DARABONBA_PTR_SET_VALUE(roomId_, roomId) };
    ...
    inline HotelRoomInfoResponseBodyModule& setRoomImage(string roomImage) { DARABONBA_PTR_SET_VALUE(roomImage_, roomImage) };
    ...
    inline const vector<Models::HotelRoomInfoResponseBodyModuleRoomImages> & roomImages() const { DARABONBA_PTR_GET_CONST(roomImages_, vector<Models::HotelRoomInfoResponseBodyModuleRoomImages>) };
    inline vector<Models::HotelRoomInfoResponseBodyModuleRoomImages> roomImages() { DARABONBA_PTR_GET(roomImages_, vector<Models::HotelRoomInfoResponseBodyModuleRoomImages>) };
    inline HotelRoomInfoResponseBodyModule& setRoomImages(const vector<Models::HotelRoomInfoResponseBodyModuleRoomImages> & roomImages) { DARABONBA_PTR_SET_VALUE(roomImages_, roomImages) };
    inline HotelRoomInfoResponseBodyModule& setRoomImages(vector<Models::HotelRoomInfoResponseBodyModuleRoomImages> && roomImages) { DARABONBA_PTR_SET_RVALUE(roomImages_, roomImages) };
    ...
    inline HotelRoomInfoResponseBodyModule& setRoomName(string roomName) { DARABONBA_PTR_SET_VALUE(roomName_, roomName) };
    ...
    inline HotelRoomInfoResponseBodyModule& setRoomType(int32_t roomType) { DARABONBA_PTR_SET_VALUE(roomType_, roomType) };
    ...
    inline HotelRoomInfoResponseBodyModule& setRoomarea(string roomarea) { DARABONBA_PTR_SET_VALUE(roomarea_, roomarea) };
    ...
    inline HotelRoomInfoResponseBodyModule& setRooms(int32_t rooms) { DARABONBA_PTR_SET_VALUE(rooms_, rooms) };


    // smoke Field Functions 
    bool hasSmoke() const { return this->smoke_ != nullptr;};
    void deleteSmoke() { this->smoke_ = nullptr;};
    inline string smoke() const { DARABONBA_PTR_GET_DEFAULT(smoke_, "") };
    inline HotelRoomInfoResponseBodyModule& setSmoke(string smoke) { DARABONBA_PTR_SET_VALUE(smoke_, smoke) };
    ...
    inline HotelRoomInfoResponseBodyModule& setWindow(string window) { DARABONBA_PTR_SET_VALUE(window_, window) };
    ...
    inline HotelRoomInfoResponseBodyModule& setWindowBad(string windowBad) { DARABONBA_PTR_SET_VALUE(windowBad_, windowBad) };
    ...
    inline HotelRoomInfoResponseBodyModule& setWindowView(string windowView) { DARABONBA_PTR_SET_VALUE(windowView_, windowView) };


  protected:
    std::shared_ptr<vector<Models::HotelRoomInfoResponseBodyModuleBedInfoGroupList>> bedInfoGroupList_ = nullptr;
    std::shared_ptr<vector<Models::HotelRoomInfoResponseBodyModuleBedInfos>> bedInfos_ = nullptr;
    ...
    std::shared_ptr<string> roomDesc_ = nullptr;
    ...
    std::shared_ptr<vector<Models::HotelRoomInfoResponseBodyModuleRoomImages>> roomImages_ = nullptr;
    ...
    std::shared_ptr<string> smoke_ = nullptr;
