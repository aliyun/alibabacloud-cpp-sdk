...
#ifndef ALIBABACLOUD_MODELS_FLIGHTLISTINGSEARCHV2RESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTLISTINGSEARCHV2RESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightListingSearchV2ResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightListingSearchV2ResponseBody& obj) { 
    ...
    FlightListingSearchV2ResponseBody() = default ;
    FlightListingSearchV2ResponseBody(const FlightListingSearchV2ResponseBody &) = default ;
    FlightListingSearchV2ResponseBody(FlightListingSearchV2ResponseBody &&) = default ;
    FlightListingSearchV2ResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightListingSearchV2ResponseBody() = default ;
    FlightListingSearchV2ResponseBody& operator=(const FlightListingSearchV2ResponseBody &) = default ;
    FlightListingSearchV2ResponseBody& operator=(FlightListingSearchV2ResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->tag_ == nullptr && this->uniqKey_ == nullptr; };
            ...
            inline const map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValue> & getShoppingItemMap() const { DARABONBA_PTR_GET_CONST(shoppingItemMap_, map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValue>) };
            inline map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValue> getShoppingItemMap() { DARABONBA_PTR_GET(shoppingItemMap_, map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValue>) };
            inline SubItems& setShoppingItemMap(const map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValue> & shoppingItemMap) { DARABONBA_PTR_SET_VALUE(shoppingItemMap_, shoppingItemMap) };
            inline SubItems& setShoppingItemMap(map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValue> && shoppingItemMap) { DARABONBA_PTR_SET_RVALUE(shoppingItemMap_, shoppingItemMap) };
          ...
          protected:
            shared_ptr<map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValue>> shoppingItemMap_ {};
        ...
        && this->flightRuleInfos_ == nullptr && this->itemId_ == nullptr && this->shoppingItemMap_ == nullptr && this->subItemPositionMap_ == nullptr && this->subItems_ == nullptr; };
          ...
          inline const map<string, ModuleFlightItemListItemListFlightRuleInfosValue> & getFlightRuleInfos() const { DARABONBA_PTR_GET_CONST(flightRuleInfos_, map<string, ModuleFlightItemListItemListFlightRuleInfosValue>) };
          inline map<string, ModuleFlightItemListItemListFlightRuleInfosValue> getFlightRuleInfos() { DARABONBA_PTR_GET(flightRuleInfos_, map<string, ModuleFlightItemListItemListFlightRuleInfosValue>) };
          inline ItemList& setFlightRuleInfos(const map<string, ModuleFlightItemListItemListFlightRuleInfosValue> & flightRuleInfos) { DARABONBA_PTR_SET_VALUE(flightRuleInfos_, flightRuleInfos) };
          inline ItemList& setFlightRuleInfos(map<string, ModuleFlightItemListItemListFlightRuleInfosValue> && flightRuleInfos) { DARABONBA_PTR_SET_RVALUE(flightRuleInfos_, flightRuleInfos) };
          ...
          bool hasShoppingItemMap() const { return this->shoppingItemMap_ != nullptr;};
          void deleteShoppingItemMap() { this->shoppingItemMap_ = nullptr;};
          inline const map<string, ModuleFlightItemListItemListShoppingItemMapValue> & getShoppingItemMap() const { DARABONBA_PTR_GET_CONST(shoppingItemMap_, map<string, ModuleFlightItemListItemListShoppingItemMapValue>) };
          inline map<string, ModuleFlightItemListItemListShoppingItemMapValue> getShoppingItemMap() { DARABONBA_PTR_GET(shoppingItemMap_, map<string, ModuleFlightItemListItemListShoppingItemMapValue>) };
          inline ItemList& setShoppingItemMap(const map<string, ModuleFlightItemListItemListShoppingItemMapValue> & shoppingItemMap) { DARABONBA_PTR_SET_VALUE(shoppingItemMap_, shoppingItemMap) };
          inline ItemList& setShoppingItemMap(map<string, ModuleFlightItemListItemListShoppingItemMapValue> && shoppingItemMap) { DARABONBA_PTR_SET_RVALUE(shoppingItemMap_, shoppingItemMap) };
          ...
          inline const map<string, vector<ModuleFlightItemListItemListSubItemPositionMapValue>> & getSubItemPositionMap() const { DARABONBA_PTR_GET_CONST(subItemPositionMap_, map<string, vector<ModuleFlightItemListItemListSubItemPositionMapValue>>) };
          inline map<string, vector<ModuleFlightItemListItemListSubItemPositionMapValue>> getSubItemPositionMap() { DARABONBA_PTR_GET(subItemPositionMap_, map<string, vector<ModuleFlightItemListItemListSubItemPositionMapValue>>) };
          inline ItemList& setSubItemPositionMap(const map<string, vector<ModuleFlightItemListItemListSubItemPositionMapValue>> & subItemPositionMap) { DARABONBA_PTR_SET_VALUE(subItemPositionMap_, subItemPositionMap) };
          inline ItemList& setSubItemPositionMap(map<string, vector<ModuleFlightItemListItemListSubItemPositionMapValue>> && subItemPositionMap) { DARABONBA_PTR_SET_RVALUE(subItemPositionMap_, subItemPositionMap) };
        ...
        protected:
          ...
          shared_ptr<map<string, ModuleFlightItemListItemListFlightRuleInfosValue>> flightRuleInfos_ {};
          shared_ptr<string> itemId_ {};
          shared_ptr<map<string, ModuleFlightItemListItemListShoppingItemMapValue>> shoppingItemMap_ {};
          shared_ptr<map<string, vector<ModuleFlightItemListItemListSubItemPositionMapValue>>> subItemPositionMap_ {};
        ...
        && this->uniqKey_ == nullptr; };
            ...
            bool hasShoppingItemMap() const { return this->shoppingItemMap_ != nullptr;};
            void deleteShoppingItemMap() { this->shoppingItemMap_ = nullptr;};
            inline const map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue> & getShoppingItemMap() const { DARABONBA_PTR_GET_CONST(shoppingItemMap_, map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue>) };
            inline map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue> getShoppingItemMap() { DARABONBA_PTR_GET(shoppingItemMap_, map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue>) };
            inline SubItems& setShoppingItemMap(const map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue> & shoppingItemMap) { DARABONBA_PTR_SET_VALUE(shoppingItemMap_, shoppingItemMap) };
            inline SubItems& setShoppingItemMap(map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue> && shoppingItemMap) { DARABONBA_PTR_SET_RVALUE(shoppingItemMap_, shoppingItemMap) };
          ...
          protected:
            shared_ptr<map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue>> shoppingItemMap_ {};
            shared_ptr<string> uniqKey_ {};
          };
        ...
        && this->flightRuleInfos_ == nullptr && this->itemId_ == nullptr && this->shoppingItemMap_ == nullptr && this->subItemPositionMap_ == nullptr && this->subItems_ == nullptr; };
          ...
          void deleteCodeType() { this->codeType_ = nullptr;};
          inline string getCodeType() const { DARABONBA_PTR_GET_DEFAULT(codeType_, "") };
          inline BestPriceItem& setCodeType(string codeType) { DARABONBA_PTR_SET_VALUE(codeType_, codeType) };


          // flightRuleInfos Field Functions 
          bool hasFlightRuleInfos() const { return this->flightRuleInfos_ != nullptr;};
          void deleteFlightRuleInfos() { this->flightRuleInfos_ = nullptr;};
          inline const map<string, ModuleFlightItemListBestPriceItemFlightRuleInfosValue> & getFlightRuleInfos() const { DARABONBA_PTR_GET_CONST(flightRuleInfos_, map<string, ModuleFlightItemListBestPriceItemFlightRuleInfosValue>) };
          inline map<string, ModuleFlightItemListBestPriceItemFlightRuleInfosValue> getFlightRuleInfos() { DARABONBA_PTR_GET(flightRuleInfos_, map<string, ModuleFlightItemListBestPriceItemFlightRuleInfosValue>) };
          inline BestPriceItem& setFlightRuleInfos(const map<string, ModuleFlightItemListBestPriceItemFlightRuleInfosValue> & flightRuleInfos) { DARABONBA_PTR_SET_VALUE(flightRuleInfos_, flightRuleInfos) };
          inline BestPriceItem& setFlightRuleInfos(map<string, ModuleFlightItemListBestPriceItemFlightRuleInfosValue> && flightRuleInfos) { DARABONBA_PTR_SET_RVALUE(flightRuleInfos_, flightRuleInfos) };
          ...
          bool hasSubItemPositionMap() const { return this->subItemPositionMap_ != nullptr;};
          void deleteSubItemPositionMap() { this->subItemPositionMap_ = nullptr;};
          inline const map<string, vector<ModuleFlightItemListBestPriceItemSubItemPositionMapValue>> & getSubItemPositionMap() const { DARABONBA_PTR_GET_CONST(subItemPositionMap_, map<string, vector<ModuleFlightItemListBestPriceItemSubItemPositionMapValue>>) };
          inline map<string, vector<ModuleFlightItemListBestPriceItemSubItemPositionMapValue>> getSubItemPositionMap() { DARABONBA_PTR_GET(subItemPositionMap_, map<string, vector<ModuleFlightItemListBestPriceItemSubItemPositionMapValue>>) };
          inline BestPriceItem& setSubItemPositionMap(const map<string, vector<ModuleFlightItemListBestPriceItemSubItemPositionMapValue>> & subItemPositionMap) { DARABONBA_PTR_SET_VALUE(subItemPositionMap_, subItemPositionMap) };
          inline BestPriceItem& setSubItemPositionMap(map<string, vector<ModuleFlightItemListBestPriceItemSubItemPositionMapValue>> && subItemPositionMap) { DARABONBA_PTR_SET_RVALUE(subItemPositionMap_, subItemPositionMap) };
        ...
        protected:
          shared_ptr<string> codeType_ {};
          shared_ptr<map<string, ModuleFlightItemListBestPriceItemFlightRuleInfosValue>> flightRuleInfos_ {};
          shared_ptr<string> itemId_ {};
          shared_ptr<map<string, ModuleFlightItemListBestPriceItemShoppingItemMapValue>> shoppingItemMap_ {};
          shared_ptr<map<string, vector<ModuleFlightItemListBestPriceItemSubItemPositionMapValue>>> subItemPositionMap_ {};
        ...
        inline const vector<FlightItemList::ItemList> & getItemList() const { DARABONBA_PTR_GET_CONST(itemList_, vector<FlightItemList::ItemList>) };
        inline vector<FlightItemList::ItemList> getItemList() { DARABONBA_PTR_GET(itemList_, vector<FlightItemList::ItemList>) };
        inline FlightItemList& setItemList(const vector<FlightItemList::ItemList> & itemList) { DARABONBA_PTR_SET_VALUE(itemList_, itemList) };
        inline FlightItemList& setItemList(vector<FlightItemList::ItemList> && itemList) { DARABONBA_PTR_SET_RVALUE(itemList_, itemList) };
      ...
      protected:
        ...
        shared_ptr<vector<FlightItemList::ItemList>> itemList_ {};
      };
    ...
    inline FlightListingSearchV2ResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline FlightListingSearchV2ResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const FlightListingSearchV2ResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, FlightListingSearchV2ResponseBody::Module) };
    inline FlightListingSearchV2ResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, FlightListingSearchV2ResponseBody::Module) };
    inline FlightListingSearchV2ResponseBody& setModule(const FlightListingSearchV2ResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightListingSearchV2ResponseBody& setModule(FlightListingSearchV2ResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline FlightListingSearchV2ResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline FlightListingSearchV2ResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline FlightListingSearchV2ResponseBody& setTraceId(string traceId) { DARABONBA_PTR_SET_VALUE(traceId_, traceId) };
