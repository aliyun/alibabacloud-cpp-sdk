...
#ifndef ALIBABACLOUD_MODELS_UPDATEEMPLOYEESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEEMPLOYEESHRINKREQUEST_HPP_
...
namespace Models
{
  class UpdateEmployeeShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateEmployeeShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateEmployeeShrinkRequest& obj) { 
    ...
    UpdateEmployeeShrinkRequest() = default ;
    UpdateEmployeeShrinkRequest(const UpdateEmployeeShrinkRequest &) = default ;
    UpdateEmployeeShrinkRequest(UpdateEmployeeShrinkRequest &&) = default ;
    UpdateEmployeeShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateEmployeeShrinkRequest() = default ;
    UpdateEmployeeShrinkRequest& operator=(const UpdateEmployeeShrinkRequest &) = default ;
    UpdateEmployeeShrinkRequest& operator=(UpdateEmployeeShrinkRequest &&) = default ;
    ...
    inline UpdateEmployeeShrinkRequest& setAccountEmail(string accountEmail) { DARABONBA_PTR_SET_VALUE(accountEmail_, accountEmail) };
    ...
    inline UpdateEmployeeShrinkRequest& setAccountPhone(string accountPhone) { DARABONBA_PTR_SET_VALUE(accountPhone_, accountPhone) };
    ...
    inline UpdateEmployeeShrinkRequest& setAttribute(string attribute) { DARABONBA_PTR_SET_VALUE(attribute_, attribute) };
    ...
    inline UpdateEmployeeShrinkRequest& setAvatar(string avatar) { DARABONBA_PTR_SET_VALUE(avatar_, avatar) };
    ...
    inline UpdateEmployeeShrinkRequest& setBaseCityCodeListShrink(string baseCityCodeListShrink) { DARABONBA_PTR_SET_VALUE(baseCityCodeListShrink_, baseCityCodeListShrink) };
    ...
    inline UpdateEmployeeShrinkRequest& setBaseLocationListShrink(string baseLocationListShrink) { DARABONBA_PTR_SET_VALUE(baseLocationListShrink_, baseLocationListShrink) };
    ...
    inline UpdateEmployeeShrinkRequest& setBirthday(string birthday) { DARABONBA_PTR_SET_VALUE(birthday_, birthday) };
    ...
    inline UpdateEmployeeShrinkRequest& setCertListShrink(string certListShrink) { DARABONBA_PTR_SET_VALUE(certListShrink_, certListShrink) };
    ...
    inline UpdateEmployeeShrinkRequest& setCustomRoleCodeListShrink(string customRoleCodeListShrink) { DARABONBA_PTR_SET_VALUE(customRoleCodeListShrink_, customRoleCodeListShrink) };
    ...
    inline UpdateEmployeeShrinkRequest& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline UpdateEmployeeShrinkRequest& setGender(string gender) { DARABONBA_PTR_SET_VALUE(gender_, gender) };
    ...
    inline UpdateEmployeeShrinkRequest& setIsAdmin(bool isAdmin) { DARABONBA_PTR_SET_VALUE(isAdmin_, isAdmin) };
    ...
    inline UpdateEmployeeShrinkRequest& setIsBoss(bool isBoss) { DARABONBA_PTR_SET_VALUE(isBoss_, isBoss) };
    ...
    inline UpdateEmployeeShrinkRequest& setIsDeptLeader(bool isDeptLeader) { DARABONBA_PTR_SET_VALUE(isDeptLeader_, isDeptLeader) };
    ...
    inline UpdateEmployeeShrinkRequest& setJobNo(string jobNo) { DARABONBA_PTR_SET_VALUE(jobNo_, jobNo) };
    ...
    inline UpdateEmployeeShrinkRequest& setManagerUserId(string managerUserId) { DARABONBA_PTR_SET_VALUE(managerUserId_, managerUserId) };
    ...
    inline UpdateEmployeeShrinkRequest& setOutDeptIdListShrink(string outDeptIdListShrink) { DARABONBA_PTR_SET_VALUE(outDeptIdListShrink_, outDeptIdListShrink) };
    ...
    inline UpdateEmployeeShrinkRequest& setPhone(string phone) { DARABONBA_PTR_SET_VALUE(phone_, phone) };
    ...
    inline UpdateEmployeeShrinkRequest& setPositionLevel(string positionLevel) { DARABONBA_PTR_SET_VALUE(positionLevel_, positionLevel) };
    ...
    inline UpdateEmployeeShrinkRequest& setRealName(string realName) { DARABONBA_PTR_SET_VALUE(realName_, realName) };
    ...
    inline UpdateEmployeeShrinkRequest& setRealNameEn(string realNameEn) { DARABONBA_PTR_SET_VALUE(realNameEn_, realNameEn) };
    ...
    inline UpdateEmployeeShrinkRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline UpdateEmployeeShrinkRequest& setUserNick(string userNick) { DARABONBA_PTR_SET_VALUE(userNick_, userNick) };
