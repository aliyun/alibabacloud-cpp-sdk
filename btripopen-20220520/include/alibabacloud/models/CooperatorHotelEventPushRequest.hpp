...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->changeOrderStatus_ == nullptr
    ...
    inline string getChangeOrderStatusDesc() const { DARABONBA_PTR_GET_DEFAULT(changeOrderStatusDesc_, "") };
  ...
  protected:
    ...
    shared_ptr<string> changeOrderStatusDesc_ {};
