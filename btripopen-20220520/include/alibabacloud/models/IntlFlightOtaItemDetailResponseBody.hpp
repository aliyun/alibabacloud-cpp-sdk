...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightOtaItemDetailResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightOtaItemDetailResponseBodyModule) };
    inline IntlFlightOtaItemDetailResponseBodyModule module() { DARABONBA_PTR_GET(module_, IntlFlightOtaItemDetailResponseBodyModule) };
    inline IntlFlightOtaItemDetailResponseBody& setModule(const IntlFlightOtaItemDetailResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightOtaItemDetailResponseBody& setModule(IntlFlightOtaItemDetailResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IntlFlightOtaItemDetailResponseBodyModule> module_ = nullptr;
