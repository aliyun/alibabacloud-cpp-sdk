...
namespace Models
{
  ...
  public:
    ...
    inline const HotelRoomInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HotelRoomInfoResponseBody) };
    inline HotelRoomInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, HotelRoomInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HotelRoomInfoResponseBody> body_ {};
  };
