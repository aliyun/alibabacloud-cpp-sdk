...
#ifndef ALIBABACLOUD_MODELS_EXTERNALUSERADDREQUESTCERTREQUESTLIST_HPP_
#define ALIBABACLOUD_MODELS_EXTERNALUSERADDREQUESTCERTREQUESTLIST_HPP_
...
namespace Models
{
  class ExternalUserAddRequestCertRequestList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ExternalUserAddRequestCertRequestList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ExternalUserAddRequestCertRequestList& obj) { 
    ...
    ExternalUserAddRequestCertRequestList() = default ;
    ExternalUserAddRequestCertRequestList(const ExternalUserAddRequestCertRequestList &) = default ;
    ExternalUserAddRequestCertRequestList(ExternalUserAddRequestCertRequestList &&) = default ;
    ExternalUserAddRequestCertRequestList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExternalUserAddRequestCertRequestList() = default ;
    ExternalUserAddRequestCertRequestList& operator=(const ExternalUserAddRequestCertRequestList &) = default ;
    ExternalUserAddRequestCertRequestList& operator=(ExternalUserAddRequestCertRequestList &&) = default ;
    ...
    inline ExternalUserAddRequestCertRequestList& setCertExpiredTime(string certExpiredTime) { DARABONBA_PTR_SET_VALUE(certExpiredTime_, certExpiredTime) };
    ...
    inline ExternalUserAddRequestCertRequestList& setCertNation(string certNation) { DARABONBA_PTR_SET_VALUE(certNation_, certNation) };
    ...
    inline ExternalUserAddRequestCertRequestList& setCertNo(string certNo) { DARABONBA_PTR_SET_VALUE(certNo_, certNo) };
    ...
    inline ExternalUserAddRequestCertRequestList& setCertType(int32_t certType) { DARABONBA_PTR_SET_VALUE(certType_, certType) };
    ...
    inline ExternalUserAddRequestCertRequestList& setNationality(string nationality) { DARABONBA_PTR_SET_VALUE(nationality_, nationality) };
