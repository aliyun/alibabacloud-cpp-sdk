...
namespace Models
{
  ...
  public:
    ...
    inline const TicketChangingCancelResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TicketChangingCancelResponseBodyModule) };
    inline TicketChangingCancelResponseBodyModule module() { DARABONBA_PTR_GET(module_, TicketChangingCancelResponseBodyModule) };
    inline TicketChangingCancelResponseBody& setModule(const TicketChangingCancelResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TicketChangingCancelResponseBody& setModule(TicketChangingCancelResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TicketChangingCancelResponseBodyModule> module_ = nullptr;
