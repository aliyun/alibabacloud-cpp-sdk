...
namespace Models
{
  ...
  public:
    ...
    inline const ElectronicItineraryGetApplyResultResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, ElectronicItineraryGetApplyResultResponseBodyModule) };
    inline ElectronicItineraryGetApplyResultResponseBodyModule module() { DARABONBA_PTR_GET(module_, ElectronicItineraryGetApplyResultResponseBodyModule) };
    inline ElectronicItineraryGetApplyResultResponseBody& setModule(const ElectronicItineraryGetApplyResultResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline ElectronicItineraryGetApplyResultResponseBody& setModule(ElectronicItineraryGetApplyResultResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<ElectronicItineraryGetApplyResultResponseBodyModule> module_ = nullptr;
    // requestId
