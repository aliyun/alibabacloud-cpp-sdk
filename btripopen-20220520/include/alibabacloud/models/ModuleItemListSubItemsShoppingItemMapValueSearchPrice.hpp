...
#ifndef ALIBABACLOUD_MODELS_MODULEITEMLISTSUBITEMSSHOPPINGITEMMAPVALUESEARCHPRICE_HPP_
#define ALIBABACLOUD_MODELS_MODULEITEMLISTSUBITEMSSHOPPINGITEMMAPVALUESEARCHPRICE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleItemListSubItemsShoppingItemMapValueSearchPrice& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleItemListSubItemsShoppingItemMapValueSearchPrice& obj) { 
    ...
    ModuleItemListSubItemsShoppingItemMapValueSearchPrice() = default ;
    ModuleItemListSubItemsShoppingItemMapValueSearchPrice(const ModuleItemListSubItemsShoppingItemMapValueSearchPrice &) = default ;
    ModuleItemListSubItemsShoppingItemMapValueSearchPrice(ModuleItemListSubItemsShoppingItemMapValueSearchPrice &&) = default ;
    ModuleItemListSubItemsShoppingItemMapValueSearchPrice(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleItemListSubItemsShoppingItemMapValueSearchPrice() = default ;
    ModuleItemListSubItemsShoppingItemMapValueSearchPrice& operator=(const ModuleItemListSubItemsShoppingItemMapValueSearchPrice &) = default ;
    ModuleItemListSubItemsShoppingItemMapValueSearchPrice& operator=(ModuleItemListSubItemsShoppingItemMapValueSearchPrice &&) = default ;
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setFloorPrice(int32_t floorPrice) { DARABONBA_PTR_SET_VALUE(floorPrice_, floorPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setTicketPrice(int32_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setSellPrice(int32_t sellPrice) { DARABONBA_PTR_SET_VALUE(sellPrice_, sellPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setOriginalSellPrice(int32_t originalSellPrice) { DARABONBA_PTR_SET_VALUE(originalSellPrice_, originalSellPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setBaseTotalPrice(int32_t baseTotalPrice) { DARABONBA_PTR_SET_VALUE(baseTotalPrice_, baseTotalPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setBeforeControlPrice(int32_t beforeControlPrice) { DARABONBA_PTR_SET_VALUE(beforeControlPrice_, beforeControlPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setTax(int32_t tax) { DARABONBA_PTR_SET_VALUE(tax_, tax) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setSupplyPrice(int32_t supplyPrice) { DARABONBA_PTR_SET_VALUE(supplyPrice_, supplyPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setBasicCabinPrice(int32_t basicCabinPrice) { DARABONBA_PTR_SET_VALUE(basicCabinPrice_, basicCabinPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setBuildPrice(int32_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setOilPrice(int32_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setFirstStandardPrice(int32_t firstStandardPrice) { DARABONBA_PTR_SET_VALUE(firstStandardPrice_, firstStandardPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setBusinessStandardPrice(int32_t businessStandardPrice) { DARABONBA_PTR_SET_VALUE(businessStandardPrice_, businessStandardPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setCommonStandardPrice(int32_t commonStandardPrice) { DARABONBA_PTR_SET_VALUE(commonStandardPrice_, commonStandardPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setInterTicketPrice(int32_t interTicketPrice) { DARABONBA_PTR_SET_VALUE(interTicketPrice_, interTicketPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setSubtractedPrice(int32_t subtractedPrice) { DARABONBA_PTR_SET_VALUE(subtractedPrice_, subtractedPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setOriginCommonPrice(int32_t originCommonPrice) { DARABONBA_PTR_SET_VALUE(originCommonPrice_, originCommonPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setDynamicPromotionPrice(int32_t dynamicPromotionPrice) { DARABONBA_PTR_SET_VALUE(dynamicPromotionPrice_, dynamicPromotionPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setInstallmentNum(int32_t installmentNum) { DARABONBA_PTR_SET_VALUE(installmentNum_, installmentNum) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setInstallmentPrice(double installmentPrice) { DARABONBA_PTR_SET_VALUE(installmentPrice_, installmentPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setCompetitionDynamicPrice(int32_t competitionDynamicPrice) { DARABONBA_PTR_SET_VALUE(competitionDynamicPrice_, competitionDynamicPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setCompetitionPromotionPrice(int32_t competitionPromotionPrice) { DARABONBA_PTR_SET_VALUE(competitionPromotionPrice_, competitionPromotionPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setMinBeforeControlPriceOfNormal(int32_t minBeforeControlPriceOfNormal) { DARABONBA_PTR_SET_VALUE(minBeforeControlPriceOfNormal_, minBeforeControlPriceOfNormal) };
    ...
    inline const Models::ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo & priceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, Models::ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo) };
    inline Models::ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo priceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, Models::ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo) };
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setPriceShowInfo(const Models::ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleItemListSubItemsShoppingItemMapValueSearchPrice& setPriceShowInfo(Models::ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo> priceShowInfo_ = nullptr;
  };
