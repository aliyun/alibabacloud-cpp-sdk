...
namespace Models
{
  ...
  public:
    ...
    inline const HotelOrderInfoQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HotelOrderInfoQueryResponseBody) };
    inline HotelOrderInfoQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, HotelOrderInfoQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HotelOrderInfoQueryResponseBody> body_ {};
  };
