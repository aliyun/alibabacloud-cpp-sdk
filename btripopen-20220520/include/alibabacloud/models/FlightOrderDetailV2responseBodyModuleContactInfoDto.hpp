...
#ifndef ALIBABACLOUD_MODELS_FLIGHTORDERDETAILV2RESPONSEBODYMODULECONTACTINFODTO_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTORDERDETAILV2RESPONSEBODYMODULECONTACTINFODTO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightOrderDetailV2ResponseBodyModuleContactInfoDTO& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightOrderDetailV2ResponseBodyModuleContactInfoDTO& obj) { 
    ...
    FlightOrderDetailV2ResponseBodyModuleContactInfoDTO() = default ;
    FlightOrderDetailV2ResponseBodyModuleContactInfoDTO(const FlightOrderDetailV2ResponseBodyModuleContactInfoDTO &) = default ;
    FlightOrderDetailV2ResponseBodyModuleContactInfoDTO(FlightOrderDetailV2ResponseBodyModuleContactInfoDTO &&) = default ;
    FlightOrderDetailV2ResponseBodyModuleContactInfoDTO(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightOrderDetailV2ResponseBodyModuleContactInfoDTO() = default ;
    FlightOrderDetailV2ResponseBodyModuleContactInfoDTO& operator=(const FlightOrderDetailV2ResponseBodyModuleContactInfoDTO &) = default ;
    FlightOrderDetailV2ResponseBodyModuleContactInfoDTO& operator=(FlightOrderDetailV2ResponseBodyModuleContactInfoDTO &&) = default ;
    ...
    inline FlightOrderDetailV2ResponseBodyModuleContactInfoDTO& setContactEmail(string contactEmail) { DARABONBA_PTR_SET_VALUE(contactEmail_, contactEmail) };
    ...
    inline FlightOrderDetailV2ResponseBodyModuleContactInfoDTO& setContactName(string contactName) { DARABONBA_PTR_SET_VALUE(contactName_, contactName) };
    ...
    inline FlightOrderDetailV2ResponseBodyModuleContactInfoDTO& setContactPhone(string contactPhone) { DARABONBA_PTR_SET_VALUE(contactPhone_, contactPhone) };
    ...
    inline FlightOrderDetailV2ResponseBodyModuleContactInfoDTO& setSendMsgToPassenger(bool sendMsgToPassenger) { DARABONBA_PTR_SET_VALUE(sendMsgToPassenger_, sendMsgToPassenger) };
