...
namespace Models
{
  ...
  public:
    ...
    inline const QueryReimbursementOrderResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, QueryReimbursementOrderResponseBodyModule) };
    inline QueryReimbursementOrderResponseBodyModule module() { DARABONBA_PTR_GET(module_, QueryReimbursementOrderResponseBodyModule) };
    inline QueryReimbursementOrderResponseBody& setModule(const QueryReimbursementOrderResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline QueryReimbursementOrderResponseBody& setModule(QueryReimbursementOrderResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<QueryReimbursementOrderResponseBodyModule> module_ = nullptr;
    // requestId
