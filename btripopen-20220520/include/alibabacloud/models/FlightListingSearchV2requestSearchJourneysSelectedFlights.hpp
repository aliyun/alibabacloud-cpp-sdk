...
#ifndef ALIBABACLOUD_MODELS_FLIGHTLISTINGSEARCHV2REQUESTSEARCHJOURNEYSSELECTEDFLIGHTS_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTLISTINGSEARCHV2REQUESTSEARCHJOURNEYSSELECTEDFLIGHTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightListingSearchV2RequestSearchJourneysSelectedFlights& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightListingSearchV2RequestSearchJourneysSelectedFlights& obj) { 
    ...
    FlightListingSearchV2RequestSearchJourneysSelectedFlights() = default ;
    FlightListingSearchV2RequestSearchJourneysSelectedFlights(const FlightListingSearchV2RequestSearchJourneysSelectedFlights &) = default ;
    FlightListingSearchV2RequestSearchJourneysSelectedFlights(FlightListingSearchV2RequestSearchJourneysSelectedFlights &&) = default ;
    FlightListingSearchV2RequestSearchJourneysSelectedFlights(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightListingSearchV2RequestSearchJourneysSelectedFlights() = default ;
    FlightListingSearchV2RequestSearchJourneysSelectedFlights& operator=(const FlightListingSearchV2RequestSearchJourneysSelectedFlights &) = default ;
    FlightListingSearchV2RequestSearchJourneysSelectedFlights& operator=(FlightListingSearchV2RequestSearchJourneysSelectedFlights &&) = default ;
    ...
    inline FlightListingSearchV2RequestSearchJourneysSelectedFlights& setArrAirportCode(string arrAirportCode) { DARABONBA_PTR_SET_VALUE(arrAirportCode_, arrAirportCode) };
    ...
    inline FlightListingSearchV2RequestSearchJourneysSelectedFlights& setArrCityCode(string arrCityCode) { DARABONBA_PTR_SET_VALUE(arrCityCode_, arrCityCode) };
    ...
    inline FlightListingSearchV2RequestSearchJourneysSelectedFlights& setDepAirportCode(string depAirportCode) { DARABONBA_PTR_SET_VALUE(depAirportCode_, depAirportCode) };
    ...
    inline FlightListingSearchV2RequestSearchJourneysSelectedFlights& setDepCityCode(string depCityCode) { DARABONBA_PTR_SET_VALUE(depCityCode_, depCityCode) };
    ...
    inline FlightListingSearchV2RequestSearchJourneysSelectedFlights& setFlightTime(string flightTime) { DARABONBA_PTR_SET_VALUE(flightTime_, flightTime) };
    ...
    inline FlightListingSearchV2RequestSearchJourneysSelectedFlights& setMarketFlightNo(string marketFlightNo) { DARABONBA_PTR_SET_VALUE(marketFlightNo_, marketFlightNo) };
    ...
    inline FlightListingSearchV2RequestSearchJourneysSelectedFlights& setOperateFlightNo(string operateFlightNo) { DARABONBA_PTR_SET_VALUE(operateFlightNo_, operateFlightNo) };
