...
namespace Models
{
  ...
  public:
    ...
    inline const vector<HotelRoomInfoResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<HotelRoomInfoResponseBodyModule>) };
    inline vector<HotelRoomInfoResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<HotelRoomInfoResponseBodyModule>) };
    inline HotelRoomInfoResponseBody& setModule(const vector<HotelRoomInfoResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelRoomInfoResponseBody& setModule(vector<HotelRoomInfoResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<vector<HotelRoomInfoResponseBodyModule>> module_ = nullptr;
    // requestId
