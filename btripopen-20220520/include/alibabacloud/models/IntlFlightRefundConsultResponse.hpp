...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightRefundConsultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IntlFlightRefundConsultResponseBody) };
    inline IntlFlightRefundConsultResponseBody getBody() { DARABONBA_PTR_GET(body_, IntlFlightRefundConsultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IntlFlightRefundConsultResponseBody> body_ {};
  };
