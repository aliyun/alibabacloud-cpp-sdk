...
namespace Models
{
  ...
  public:
    ...
    inline const FlightModifyListingSearchV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FlightModifyListingSearchV2ResponseBody) };
    inline FlightModifyListingSearchV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, FlightModifyListingSearchV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FlightModifyListingSearchV2ResponseBody> body_ {};
  };
