...
#ifndef ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTBESTPRICEITEMSHOPPINGITEMMAPVALUESEARCHPRICE_HPP_
#define ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTBESTPRICEITEMSHOPPINGITEMMAPVALUESEARCHPRICE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& obj) { 
    ...
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice() = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice(const ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice &) = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice(ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice &&) = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice() = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& operator=(const ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice &) = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& operator=(ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice &&) = default ;
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setFloorPrice(int32_t floorPrice) { DARABONBA_PTR_SET_VALUE(floorPrice_, floorPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setTicketPrice(int32_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setSellPrice(int32_t sellPrice) { DARABONBA_PTR_SET_VALUE(sellPrice_, sellPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setOriginalSellPrice(int32_t originalSellPrice) { DARABONBA_PTR_SET_VALUE(originalSellPrice_, originalSellPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setBaseTotalPrice(int32_t baseTotalPrice) { DARABONBA_PTR_SET_VALUE(baseTotalPrice_, baseTotalPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setBeforeControlPrice(int32_t beforeControlPrice) { DARABONBA_PTR_SET_VALUE(beforeControlPrice_, beforeControlPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setTax(int32_t tax) { DARABONBA_PTR_SET_VALUE(tax_, tax) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setSupplyPrice(int32_t supplyPrice) { DARABONBA_PTR_SET_VALUE(supplyPrice_, supplyPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setBasicCabinPrice(int32_t basicCabinPrice) { DARABONBA_PTR_SET_VALUE(basicCabinPrice_, basicCabinPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setBuildPrice(int32_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setOilPrice(int32_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setFirstStandardPrice(int32_t firstStandardPrice) { DARABONBA_PTR_SET_VALUE(firstStandardPrice_, firstStandardPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setBusinessStandardPrice(int32_t businessStandardPrice) { DARABONBA_PTR_SET_VALUE(businessStandardPrice_, businessStandardPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setCommonStandardPrice(int32_t commonStandardPrice) { DARABONBA_PTR_SET_VALUE(commonStandardPrice_, commonStandardPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setInterTicketPrice(int32_t interTicketPrice) { DARABONBA_PTR_SET_VALUE(interTicketPrice_, interTicketPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setSubtractedPrice(int32_t subtractedPrice) { DARABONBA_PTR_SET_VALUE(subtractedPrice_, subtractedPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setOriginCommonPrice(int32_t originCommonPrice) { DARABONBA_PTR_SET_VALUE(originCommonPrice_, originCommonPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setDynamicPromotionPrice(int32_t dynamicPromotionPrice) { DARABONBA_PTR_SET_VALUE(dynamicPromotionPrice_, dynamicPromotionPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setInstallmentNum(int32_t installmentNum) { DARABONBA_PTR_SET_VALUE(installmentNum_, installmentNum) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setInstallmentPrice(double installmentPrice) { DARABONBA_PTR_SET_VALUE(installmentPrice_, installmentPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setCompetitionDynamicPrice(int32_t competitionDynamicPrice) { DARABONBA_PTR_SET_VALUE(competitionDynamicPrice_, competitionDynamicPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setCompetitionPromotionPrice(int32_t competitionPromotionPrice) { DARABONBA_PTR_SET_VALUE(competitionPromotionPrice_, competitionPromotionPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setMinBeforeControlPriceOfNormal(int32_t minBeforeControlPriceOfNormal) { DARABONBA_PTR_SET_VALUE(minBeforeControlPriceOfNormal_, minBeforeControlPriceOfNormal) };
    ...
    inline const Models::ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPricePriceShowInfo & priceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, Models::ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPricePriceShowInfo) };
    inline Models::ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPricePriceShowInfo priceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, Models::ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPricePriceShowInfo) };
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setPriceShowInfo(const Models::ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPricePriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice& setPriceShowInfo(Models::ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPricePriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPricePriceShowInfo> priceShowInfo_ = nullptr;
  };
