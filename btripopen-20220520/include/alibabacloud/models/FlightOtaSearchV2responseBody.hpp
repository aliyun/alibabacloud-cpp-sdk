...
namespace Models
{
  ...
  public:
    ...
    inline const FlightOtaSearchV2ResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightOtaSearchV2ResponseBodyModule) };
    inline FlightOtaSearchV2ResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightOtaSearchV2ResponseBodyModule) };
    inline FlightOtaSearchV2ResponseBody& setModule(const FlightOtaSearchV2ResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightOtaSearchV2ResponseBody& setModule(FlightOtaSearchV2ResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<FlightOtaSearchV2ResponseBodyModule> module_ = nullptr;
    // requestId
