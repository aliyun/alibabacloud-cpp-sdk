...
namespace Models
{
  ...
  public:
    ...
    inline const TrainNoListSearchResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TrainNoListSearchResponseBodyModule) };
    inline TrainNoListSearchResponseBodyModule module() { DARABONBA_PTR_GET(module_, TrainNoListSearchResponseBodyModule) };
    inline TrainNoListSearchResponseBody& setModule(const TrainNoListSearchResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainNoListSearchResponseBody& setModule(TrainNoListSearchResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<TrainNoListSearchResponseBodyModule> module_ = nullptr;
