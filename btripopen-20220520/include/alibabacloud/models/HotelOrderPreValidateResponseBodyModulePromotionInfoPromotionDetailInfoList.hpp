...
#ifndef ALIBABACLOUD_MODELS_HOTELORDERPREVALIDATERESPONSEBODYMODULEPROMOTIONINFOPROMOTIONDETAILINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_HOTELORDERPREVALIDATERESPONSEBODYMODULEPROMOTIONINFOPROMOTIONDETAILINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList& obj) { 
    ...
    HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList() = default ;
    HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList(const HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList &) = default ;
    HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList(HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList &&) = default ;
    HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList() = default ;
    HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList& operator=(const HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList &) = default ;
    HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList& operator=(HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList &&) = default ;
    ...
    inline HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList& setCheckStatus(bool checkStatus) { DARABONBA_PTR_SET_VALUE(checkStatus_, checkStatus) };
    ...
    inline HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList& setNeedCheck(bool needCheck) { DARABONBA_PTR_SET_VALUE(needCheck_, needCheck) };
    ...
    inline HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList& setPromotionCode(string promotionCode) { DARABONBA_PTR_SET_VALUE(promotionCode_, promotionCode) };
    ...
    inline HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList& setPromotionId(string promotionId) { DARABONBA_PTR_SET_VALUE(promotionId_, promotionId) };
    ...
    inline HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList& setPromotionName(string promotionName) { DARABONBA_PTR_SET_VALUE(promotionName_, promotionName) };
    ...
    inline HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList& setPromotionPrice(int64_t promotionPrice) { DARABONBA_PTR_SET_VALUE(promotionPrice_, promotionPrice) };
    ...
    inline HotelOrderPreValidateResponseBodyModulePromotionInfoPromotionDetailInfoList& setPromotionType(string promotionType) { DARABONBA_PTR_SET_VALUE(promotionType_, promotionType) };
