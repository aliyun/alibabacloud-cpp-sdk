...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applyItineraryListShrink_ == nullptr
    ...
    inline string getApplyItineraryListShrink() const { DARABONBA_PTR_GET_DEFAULT(applyItineraryListShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> applyItineraryListShrink_ {};
