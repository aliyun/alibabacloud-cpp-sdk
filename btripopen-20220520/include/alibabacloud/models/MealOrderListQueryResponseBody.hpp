...
namespace Models
{
  ...
  public:
    ...
    inline const MealOrderListQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, MealOrderListQueryResponseBodyModule) };
    inline MealOrderListQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, MealOrderListQueryResponseBodyModule) };
    inline MealOrderListQueryResponseBody& setModule(const MealOrderListQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline MealOrderListQueryResponseBody& setModule(MealOrderListQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<MealOrderListQueryResponseBodyModule> module_ = nullptr;
