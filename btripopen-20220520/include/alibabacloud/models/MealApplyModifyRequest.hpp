...
#ifndef ALIBABACLOUD_MODELS_MEALAPPLYMODIFYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MEALAPPLYMODIFYREQUEST_HPP_
...
namespace Models
{
  class MealApplyModifyRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const MealApplyModifyRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, MealApplyModifyRequest& obj) { 
    ...
    MealApplyModifyRequest() = default ;
    MealApplyModifyRequest(const MealApplyModifyRequest &) = default ;
    MealApplyModifyRequest(MealApplyModifyRequest &&) = default ;
    MealApplyModifyRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~MealApplyModifyRequest() = default ;
    MealApplyModifyRequest& operator=(const MealApplyModifyRequest &) = default ;
    MealApplyModifyRequest& operator=(MealApplyModifyRequest &&) = default ;
    ...
    inline const MealApplyModifyRequest::ApplyUser & getApplyUser() const { DARABONBA_PTR_GET_CONST(applyUser_, MealApplyModifyRequest::ApplyUser) };
    inline MealApplyModifyRequest::ApplyUser getApplyUser() { DARABONBA_PTR_GET(applyUser_, MealApplyModifyRequest::ApplyUser) };
    inline MealApplyModifyRequest& setApplyUser(const MealApplyModifyRequest::ApplyUser & applyUser) { DARABONBA_PTR_SET_VALUE(applyUser_, applyUser) };
    inline MealApplyModifyRequest& setApplyUser(MealApplyModifyRequest::ApplyUser && applyUser) { DARABONBA_PTR_SET_RVALUE(applyUser_, applyUser) };
    ...
    inline MealApplyModifyRequest& setCostCenterId(int64_t costCenterId) { DARABONBA_PTR_SET_VALUE(costCenterId_, costCenterId) };
    ...
    inline MealApplyModifyRequest& setExtendField(string extendField) { DARABONBA_PTR_SET_VALUE(extendField_, extendField) };
    ...
    inline MealApplyModifyRequest& setInvoiceId(int64_t invoiceId) { DARABONBA_PTR_SET_VALUE(invoiceId_, invoiceId) };
    ...
    inline const vector<MealApplyModifyRequest::ItineraryList> & getItineraryList() const { DARABONBA_PTR_GET_CONST(itineraryList_, vector<MealApplyModifyRequest::ItineraryList>) };
    inline vector<MealApplyModifyRequest::ItineraryList> getItineraryList() { DARABONBA_PTR_GET(itineraryList_, vector<MealApplyModifyRequest::ItineraryList>) };
    inline MealApplyModifyRequest& setItineraryList(const vector<MealApplyModifyRequest::ItineraryList> & itineraryList) { DARABONBA_PTR_SET_VALUE(itineraryList_, itineraryList) };
    inline MealApplyModifyRequest& setItineraryList(vector<MealApplyModifyRequest::ItineraryList> && itineraryList) { DARABONBA_PTR_SET_RVALUE(itineraryList_, itineraryList) };
    ...
    inline MealApplyModifyRequest& setMealAmount(int64_t mealAmount) { DARABONBA_PTR_SET_VALUE(mealAmount_, mealAmount) };
    ...
    inline MealApplyModifyRequest& setMealCause(string mealCause) { DARABONBA_PTR_SET_VALUE(mealCause_, mealCause) };
    ...
    inline MealApplyModifyRequest& setProjectCode(string projectCode) { DARABONBA_PTR_SET_VALUE(projectCode_, projectCode) };
    ...
    inline MealApplyModifyRequest& setProjectTitle(string projectTitle) { DARABONBA_PTR_SET_VALUE(projectTitle_, projectTitle) };
    ...
    inline MealApplyModifyRequest& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline MealApplyModifyRequest& setThirdPartApplyId(string thirdPartApplyId) { DARABONBA_PTR_SET_VALUE(thirdPartApplyId_, thirdPartApplyId) };
    ...
    inline MealApplyModifyRequest& setThirdPartCostCenterId(string thirdPartCostCenterId) { DARABONBA_PTR_SET_VALUE(thirdPartCostCenterId_, thirdPartCostCenterId) };
    ...
    inline MealApplyModifyRequest& setThirdPartInvoiceId(string thirdPartInvoiceId) { DARABONBA_PTR_SET_VALUE(thirdPartInvoiceId_, thirdPartInvoiceId) };


  protected:
    // This parameter is required.
    shared_ptr<MealApplyModifyRequest::ApplyUser> applyUser_ {};
    shared_ptr<int64_t> costCenterId_ {};
    shared_ptr<string> extendField_ {};
    shared_ptr<int64_t> invoiceId_ {};
    shared_ptr<vector<MealApplyModifyRequest::ItineraryList>> itineraryList_ {};
