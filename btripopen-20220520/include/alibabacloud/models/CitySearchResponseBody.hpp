...
namespace Models
{
  ...
  public:
    ...
    inline const CitySearchResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, CitySearchResponseBodyModule) };
    inline CitySearchResponseBodyModule module() { DARABONBA_PTR_GET(module_, CitySearchResponseBodyModule) };
    inline CitySearchResponseBody& setModule(const CitySearchResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline CitySearchResponseBody& setModule(CitySearchResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<CitySearchResponseBodyModule> module_ = nullptr;
