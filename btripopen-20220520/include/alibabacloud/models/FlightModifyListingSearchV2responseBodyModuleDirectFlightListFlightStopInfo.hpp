...
#ifndef ALIBABACLOUD_MODELS_FLIGHTMODIFYLISTINGSEARCHV2RESPONSEBODYMODULEDIRECTFLIGHTLISTFLIGHTSTOPINFO_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTMODIFYLISTINGSEARCHV2RESPONSEBODYMODULEDIRECTFLIGHTLISTFLIGHTSTOPINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo& obj) { 
    ...
    FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo() = default ;
    FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo(const FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo &) = default ;
    FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo(FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo &&) = default ;
    FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo() = default ;
    FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo& operator=(const FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo &) = default ;
    FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo& operator=(FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo &&) = default ;
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo& setStopAirport(string stopAirport) { DARABONBA_PTR_SET_VALUE(stopAirport_, stopAirport) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo& setStopArrTerm(string stopArrTerm) { DARABONBA_PTR_SET_VALUE(stopArrTerm_, stopArrTerm) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo& setStopArrTime(string stopArrTime) { DARABONBA_PTR_SET_VALUE(stopArrTime_, stopArrTime) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo& setStopCityCode(string stopCityCode) { DARABONBA_PTR_SET_VALUE(stopCityCode_, stopCityCode) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo& setStopCityName(string stopCityName) { DARABONBA_PTR_SET_VALUE(stopCityName_, stopCityName) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo& setStopDepTerm(string stopDepTerm) { DARABONBA_PTR_SET_VALUE(stopDepTerm_, stopDepTerm) };
    ...
    inline FlightModifyListingSearchV2ResponseBodyModuleDirectFlightListFlightStopInfo& setStopDepTime(string stopDepTime) { DARABONBA_PTR_SET_VALUE(stopDepTime_, stopDepTime) };
