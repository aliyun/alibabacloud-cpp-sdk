...
#ifndef ALIBABACLOUD_MODELS_MONTHPREBILLGETRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MONTHPREBILLGETRESPONSEBODY_HPP_
...
namespace Models
{
  class MonthPreBillGetResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const MonthPreBillGetResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, MonthPreBillGetResponseBody& obj) { 
    ...
    MonthPreBillGetResponseBody() = default ;
    MonthPreBillGetResponseBody(const MonthPreBillGetResponseBody &) = default ;
    MonthPreBillGetResponseBody(MonthPreBillGetResponseBody &&) = default ;
    MonthPreBillGetResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~MonthPreBillGetResponseBody() = default ;
    MonthPreBillGetResponseBody& operator=(const MonthPreBillGetResponseBody &) = default ;
    MonthPreBillGetResponseBody& operator=(MonthPreBillGetResponseBody &&) = default ;
    ...
    inline MonthPreBillGetResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline MonthPreBillGetResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const vector<MonthPreBillGetResponseBody::Module> & getModule() const { DARABONBA_PTR_GET_CONST(module_, vector<MonthPreBillGetResponseBody::Module>) };
    inline vector<MonthPreBillGetResponseBody::Module> getModule() { DARABONBA_PTR_GET(module_, vector<MonthPreBillGetResponseBody::Module>) };
    inline MonthPreBillGetResponseBody& setModule(const vector<MonthPreBillGetResponseBody::Module> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline MonthPreBillGetResponseBody& setModule(vector<MonthPreBillGetResponseBody::Module> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline MonthPreBillGetResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline MonthPreBillGetResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline MonthPreBillGetResponseBody& setTraceId(string traceId) { DARABONBA_PTR_SET_VALUE(traceId_, traceId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<string> message_ {};
    shared_ptr<vector<MonthPreBillGetResponseBody::Module>> module_ {};
