...
namespace Models
{
  ...
  public:
    ...
    inline const HotelOrderDetailInfoResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelOrderDetailInfoResponseBodyModule) };
    inline HotelOrderDetailInfoResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelOrderDetailInfoResponseBodyModule) };
    inline HotelOrderDetailInfoResponseBody& setModule(const HotelOrderDetailInfoResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelOrderDetailInfoResponseBody& setModule(HotelOrderDetailInfoResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelOrderDetailInfoResponseBodyModule> module_ = nullptr;
