...
namespace Models
{
  ...
  public:
    ...
    inline const InsureOrderDetailResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, InsureOrderDetailResponseBodyModule) };
    inline InsureOrderDetailResponseBodyModule module() { DARABONBA_PTR_GET(module_, InsureOrderDetailResponseBodyModule) };
    inline InsureOrderDetailResponseBody& setModule(const InsureOrderDetailResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline InsureOrderDetailResponseBody& setModule(InsureOrderDetailResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<InsureOrderDetailResponseBodyModule> module_ = nullptr;
