...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightReShopPayResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightReShopPayResponseBodyModule) };
    inline IntlFlightReShopPayResponseBodyModule module() { DARABONBA_PTR_GET(module_, IntlFlightReShopPayResponseBodyModule) };
    inline IntlFlightReShopPayResponseBody& setModule(const IntlFlightReShopPayResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightReShopPayResponseBody& setModule(IntlFlightReShopPayResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IntlFlightReShopPayResponseBodyModule> module_ = nullptr;
