...
namespace Models
{
  ...
  public:
    ...
    inline const InvoiceRuleSaveResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, InvoiceRuleSaveResponseBodyModule) };
    inline InvoiceRuleSaveResponseBodyModule module() { DARABONBA_PTR_GET(module_, InvoiceRuleSaveResponseBodyModule) };
    inline InvoiceRuleSaveResponseBody& setModule(const InvoiceRuleSaveResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline InvoiceRuleSaveResponseBody& setModule(InvoiceRuleSaveResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<InvoiceRuleSaveResponseBodyModule> module_ = nullptr;
