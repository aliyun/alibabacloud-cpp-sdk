...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyInvoiceTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApplyInvoiceTaskResponseBody) };
    inline ApplyInvoiceTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ApplyInvoiceTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApplyInvoiceTaskResponseBody> body_ {};
  };
