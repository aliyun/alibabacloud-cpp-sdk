...
#ifndef ALIBABACLOUD_MODELS_FLIGHTSEARCHLISTRESPONSEBODYMODULEFLIGHTLIST_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTSEARCHLISTRESPONSEBODYMODULEFLIGHTLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightSearchListResponseBodyModuleFlightList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightSearchListResponseBodyModuleFlightList& obj) { 
    ...
    FlightSearchListResponseBodyModuleFlightList() = default ;
    FlightSearchListResponseBodyModuleFlightList(const FlightSearchListResponseBodyModuleFlightList &) = default ;
    FlightSearchListResponseBodyModuleFlightList(FlightSearchListResponseBodyModuleFlightList &&) = default ;
    FlightSearchListResponseBodyModuleFlightList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightSearchListResponseBodyModuleFlightList() = default ;
    FlightSearchListResponseBodyModuleFlightList& operator=(const FlightSearchListResponseBodyModuleFlightList &) = default ;
    FlightSearchListResponseBodyModuleFlightList& operator=(FlightSearchListResponseBodyModuleFlightList &&) = default ;
    ...
    inline const Models::FlightSearchListResponseBodyModuleFlightListAirlineInfo & airlineInfo() const { DARABONBA_PTR_GET_CONST(airlineInfo_, Models::FlightSearchListResponseBodyModuleFlightListAirlineInfo) };
    inline Models::FlightSearchListResponseBodyModuleFlightListAirlineInfo airlineInfo() { DARABONBA_PTR_GET(airlineInfo_, Models::FlightSearchListResponseBodyModuleFlightListAirlineInfo) };
    inline FlightSearchListResponseBodyModuleFlightList& setAirlineInfo(const Models::FlightSearchListResponseBodyModuleFlightListAirlineInfo & airlineInfo) { DARABONBA_PTR_SET_VALUE(airlineInfo_, airlineInfo) };
    inline FlightSearchListResponseBodyModuleFlightList& setAirlineInfo(Models::FlightSearchListResponseBodyModuleFlightListAirlineInfo && airlineInfo) { DARABONBA_PTR_SET_RVALUE(airlineInfo_, airlineInfo) };
    ...
    inline const Models::FlightSearchListResponseBodyModuleFlightListArrAirportInfo & arrAirportInfo() const { DARABONBA_PTR_GET_CONST(arrAirportInfo_, Models::FlightSearchListResponseBodyModuleFlightListArrAirportInfo) };
    inline Models::FlightSearchListResponseBodyModuleFlightListArrAirportInfo arrAirportInfo() { DARABONBA_PTR_GET(arrAirportInfo_, Models::FlightSearchListResponseBodyModuleFlightListArrAirportInfo) };
    inline FlightSearchListResponseBodyModuleFlightList& setArrAirportInfo(const Models::FlightSearchListResponseBodyModuleFlightListArrAirportInfo & arrAirportInfo) { DARABONBA_PTR_SET_VALUE(arrAirportInfo_, arrAirportInfo) };
    inline FlightSearchListResponseBodyModuleFlightList& setArrAirportInfo(Models::FlightSearchListResponseBodyModuleFlightListArrAirportInfo && arrAirportInfo) { DARABONBA_PTR_SET_RVALUE(arrAirportInfo_, arrAirportInfo) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setArrDate(string arrDate) { DARABONBA_PTR_SET_VALUE(arrDate_, arrDate) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setBasicCabinPrice(int32_t basicCabinPrice) { DARABONBA_PTR_SET_VALUE(basicCabinPrice_, basicCabinPrice) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setBuildPrice(int32_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline const vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoList> & cabinInfoList() const { DARABONBA_PTR_GET_CONST(cabinInfoList_, vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoList>) };
    inline vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoList> cabinInfoList() { DARABONBA_PTR_GET(cabinInfoList_, vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoList>) };
    inline FlightSearchListResponseBodyModuleFlightList& setCabinInfoList(const vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoList> & cabinInfoList) { DARABONBA_PTR_SET_VALUE(cabinInfoList_, cabinInfoList) };
    inline FlightSearchListResponseBodyModuleFlightList& setCabinInfoList(vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoList> && cabinInfoList) { DARABONBA_PTR_SET_RVALUE(cabinInfoList_, cabinInfoList) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setCarrierAirline(string carrierAirline) { DARABONBA_PTR_SET_VALUE(carrierAirline_, carrierAirline) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setCarrierNo(string carrierNo) { DARABONBA_PTR_SET_VALUE(carrierNo_, carrierNo) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setClassRule(string classRule) { DARABONBA_PTR_SET_VALUE(classRule_, classRule) };
    ...
    inline const Models::FlightSearchListResponseBodyModuleFlightListDepAirportInfo & depAirportInfo() const { DARABONBA_PTR_GET_CONST(depAirportInfo_, Models::FlightSearchListResponseBodyModuleFlightListDepAirportInfo) };
    inline Models::FlightSearchListResponseBodyModuleFlightListDepAirportInfo depAirportInfo() { DARABONBA_PTR_GET(depAirportInfo_, Models::FlightSearchListResponseBodyModuleFlightListDepAirportInfo) };
    inline FlightSearchListResponseBodyModuleFlightList& setDepAirportInfo(const Models::FlightSearchListResponseBodyModuleFlightListDepAirportInfo & depAirportInfo) { DARABONBA_PTR_SET_VALUE(depAirportInfo_, depAirportInfo) };
    inline FlightSearchListResponseBodyModuleFlightList& setDepAirportInfo(Models::FlightSearchListResponseBodyModuleFlightListDepAirportInfo && depAirportInfo) { DARABONBA_PTR_SET_RVALUE(depAirportInfo_, depAirportInfo) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setDepCityCode(string depCityCode) { DARABONBA_PTR_SET_VALUE(depCityCode_, depCityCode) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setDepDate(string depDate) { DARABONBA_PTR_SET_VALUE(depDate_, depDate) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setDiscount(int32_t discount) { DARABONBA_PTR_SET_VALUE(discount_, discount) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setFlightNo(string flightNo) { DARABONBA_PTR_SET_VALUE(flightNo_, flightNo) };
    ...
    inline const vector<Models::FlightSearchListResponseBodyModuleFlightListFlightRuleList> & flightRuleList() const { DARABONBA_PTR_GET_CONST(flightRuleList_, vector<Models::FlightSearchListResponseBodyModuleFlightListFlightRuleList>) };
    inline vector<Models::FlightSearchListResponseBodyModuleFlightListFlightRuleList> flightRuleList() { DARABONBA_PTR_GET(flightRuleList_, vector<Models::FlightSearchListResponseBodyModuleFlightListFlightRuleList>) };
    inline FlightSearchListResponseBodyModuleFlightList& setFlightRuleList(const vector<Models::FlightSearchListResponseBodyModuleFlightListFlightRuleList> & flightRuleList) { DARABONBA_PTR_SET_VALUE(flightRuleList_, flightRuleList) };
    inline FlightSearchListResponseBodyModuleFlightList& setFlightRuleList(vector<Models::FlightSearchListResponseBodyModuleFlightListFlightRuleList> && flightRuleList) { DARABONBA_PTR_SET_RVALUE(flightRuleList_, flightRuleList) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setFlightRuleListStr(string flightRuleListStr) { DARABONBA_PTR_SET_VALUE(flightRuleListStr_, flightRuleListStr) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setFlightSize(string flightSize) { DARABONBA_PTR_SET_VALUE(flightSize_, flightSize) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setFlightType(string flightType) { DARABONBA_PTR_SET_VALUE(flightType_, flightType) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setInvoiceType(int32_t invoiceType) { DARABONBA_PTR_SET_VALUE(invoiceType_, invoiceType) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setIsProtocol(bool isProtocol) { DARABONBA_PTR_SET_VALUE(isProtocol_, isProtocol) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setIsShare(bool isShare) { DARABONBA_PTR_SET_VALUE(isShare_, isShare) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setIsStop(bool isStop) { DARABONBA_PTR_SET_VALUE(isStop_, isStop) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setIsTransfer(bool isTransfer) { DARABONBA_PTR_SET_VALUE(isTransfer_, isTransfer) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setMealDesc(string mealDesc) { DARABONBA_PTR_SET_VALUE(mealDesc_, mealDesc) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setMemo(string memo) { DARABONBA_PTR_SET_VALUE(memo_, memo) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setOilPrice(int32_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setOtaItemId(string otaItemId) { DARABONBA_PTR_SET_VALUE(otaItemId_, otaItemId) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setPrice(int32_t price) { DARABONBA_PTR_SET_VALUE(price_, price) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setProductType(int64_t productType) { DARABONBA_PTR_SET_VALUE(productType_, productType) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setProductTypeDesc(string productTypeDesc) { DARABONBA_PTR_SET_VALUE(productTypeDesc_, productTypeDesc) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setPromotionPrice(string promotionPrice) { DARABONBA_PTR_SET_VALUE(promotionPrice_, promotionPrice) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setRemainedSeatCount(string remainedSeatCount) { DARABONBA_PTR_SET_VALUE(remainedSeatCount_, remainedSeatCount) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setSecretParams(string secretParams) { DARABONBA_PTR_SET_VALUE(secretParams_, secretParams) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setSegmentNumber(string segmentNumber) { DARABONBA_PTR_SET_VALUE(segmentNumber_, segmentNumber) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setStopArrTime(string stopArrTime) { DARABONBA_PTR_SET_VALUE(stopArrTime_, stopArrTime) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setStopCity(string stopCity) { DARABONBA_PTR_SET_VALUE(stopCity_, stopCity) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setStopDepTime(string stopDepTime) { DARABONBA_PTR_SET_VALUE(stopDepTime_, stopDepTime) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setTicketPrice(int32_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setTotalPrice(string totalPrice) { DARABONBA_PTR_SET_VALUE(totalPrice_, totalPrice) };
    ...
    inline const Models::FlightSearchListResponseBodyModuleFlightListTransferInfo & transferInfo() const { DARABONBA_PTR_GET_CONST(transferInfo_, Models::FlightSearchListResponseBodyModuleFlightListTransferInfo) };
    inline Models::FlightSearchListResponseBodyModuleFlightListTransferInfo transferInfo() { DARABONBA_PTR_GET(transferInfo_, Models::FlightSearchListResponseBodyModuleFlightListTransferInfo) };
    inline FlightSearchListResponseBodyModuleFlightList& setTransferInfo(const Models::FlightSearchListResponseBodyModuleFlightListTransferInfo & transferInfo) { DARABONBA_PTR_SET_VALUE(transferInfo_, transferInfo) };
    inline FlightSearchListResponseBodyModuleFlightList& setTransferInfo(Models::FlightSearchListResponseBodyModuleFlightListTransferInfo && transferInfo) { DARABONBA_PTR_SET_RVALUE(transferInfo_, transferInfo) };
    ...
    inline FlightSearchListResponseBodyModuleFlightList& setTripType(int32_t tripType) { DARABONBA_PTR_SET_VALUE(tripType_, tripType) };


  protected:
    std::shared_ptr<Models::FlightSearchListResponseBodyModuleFlightListAirlineInfo> airlineInfo_ = nullptr;
    std::shared_ptr<Models::FlightSearchListResponseBodyModuleFlightListArrAirportInfo> arrAirportInfo_ = nullptr;
    ...
    std::shared_ptr<vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoList>> cabinInfoList_ = nullptr;
    ...
    std::shared_ptr<Models::FlightSearchListResponseBodyModuleFlightListDepAirportInfo> depAirportInfo_ = nullptr;
    ...
    std::shared_ptr<vector<Models::FlightSearchListResponseBodyModuleFlightListFlightRuleList>> flightRuleList_ = nullptr;
    ...
    std::shared_ptr<Models::FlightSearchListResponseBodyModuleFlightListTransferInfo> transferInfo_ = nullptr;
