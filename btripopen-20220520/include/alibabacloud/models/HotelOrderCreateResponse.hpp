...
namespace Models
{
  ...
  public:
    ...
    inline const HotelOrderCreateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HotelOrderCreateResponseBody) };
    inline HotelOrderCreateResponseBody getBody() { DARABONBA_PTR_GET(body_, HotelOrderCreateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HotelOrderCreateResponseBody> body_ {};
  };
