...
#ifndef ALIBABACLOUD_MODELS_ADDDEPARTMENTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDDEPARTMENTREQUEST_HPP_
...
namespace Models
{
  class AddDepartmentRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AddDepartmentRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddDepartmentRequest& obj) { 
    ...
    AddDepartmentRequest() = default ;
    AddDepartmentRequest(const AddDepartmentRequest &) = default ;
    AddDepartmentRequest(AddDepartmentRequest &&) = default ;
    AddDepartmentRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddDepartmentRequest() = default ;
    AddDepartmentRequest& operator=(const AddDepartmentRequest &) = default ;
    AddDepartmentRequest& operator=(AddDepartmentRequest &&) = default ;
