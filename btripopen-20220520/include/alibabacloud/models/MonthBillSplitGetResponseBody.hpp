...
namespace Models
{
  ...
  public:
    ...
    inline const vector<MonthBillSplitGetResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<MonthBillSplitGetResponseBodyModule>) };
    inline vector<MonthBillSplitGetResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<MonthBillSplitGetResponseBodyModule>) };
    inline MonthBillSplitGetResponseBody& setModule(const vector<MonthBillSplitGetResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline MonthBillSplitGetResponseBody& setModule(vector<MonthBillSplitGetResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<vector<MonthBillSplitGetResponseBodyModule>> module_ = nullptr;
