...
namespace Models
{
  ...
  public:
    ...
    inline const TrainStopoverSearchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TrainStopoverSearchResponseBody) };
    inline TrainStopoverSearchResponseBody getBody() { DARABONBA_PTR_GET(body_, TrainStopoverSearchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TrainStopoverSearchResponseBody> body_ {};
  };
