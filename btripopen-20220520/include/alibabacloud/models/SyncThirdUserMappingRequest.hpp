...
namespace Models
{
  ...
  public:
    ...
    inline string getThirdChannelType() const { DARABONBA_PTR_GET_DEFAULT(thirdChannelType_, "") };
    ...
    inline string getThirdUserId() const { DARABONBA_PTR_GET_DEFAULT(thirdUserId_, "") };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<string> thirdChannelType_ {};
    // This parameter is required.
    shared_ptr<string> thirdUserId_ {};
    // This parameter is required.
