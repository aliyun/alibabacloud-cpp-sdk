...
#ifndef ALIBABACLOUD_MODELS_MODULEORDERITEMLISTREFUNDCHANGERULEOFFERPENALTYINFOMAPVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULEORDERITEMLISTREFUNDCHANGERULEOFFERPENALTYINFOMAPVALUE_HPP_
...
namespace Models
{
  class ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& obj) { 
    ...
    ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue() = default ;
    ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue(const ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue &) = default ;
    ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue(ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue &&) = default ;
    ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue() = default ;
    ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& operator=(const ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue &) = default ;
    ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& operator=(ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue &&) = default ;
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setStruct(bool _struct) { DARABONBA_PTR_SET_VALUE(struct_, _struct) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setCancelFeeInd(bool cancelFeeInd) { DARABONBA_PTR_SET_VALUE(cancelFeeInd_, cancelFeeInd) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setChangeFeeInd(bool changeFeeInd) { DARABONBA_PTR_SET_VALUE(changeFeeInd_, changeFeeInd) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setUpgradeFeeInd(bool upgradeFeeInd) { DARABONBA_PTR_SET_VALUE(upgradeFeeInd_, upgradeFeeInd) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setReissueInd(bool reissueInd) { DARABONBA_PTR_SET_VALUE(reissueInd_, reissueInd) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setPenaltyTypeCode(int32_t penaltyTypeCode) { DARABONBA_PTR_SET_VALUE(penaltyTypeCode_, penaltyTypeCode) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setPenaltyApplyRangeCode(int32_t penaltyApplyRangeCode) { DARABONBA_PTR_SET_VALUE(penaltyApplyRangeCode_, penaltyApplyRangeCode) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setPenaltyChargeTypeCode(int32_t penaltyChargeTypeCode) { DARABONBA_PTR_SET_VALUE(penaltyChargeTypeCode_, penaltyChargeTypeCode) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setFee(double fee) { DARABONBA_PTR_SET_VALUE(fee_, fee) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setCurrency(string currency) { DARABONBA_PTR_SET_VALUE(currency_, currency) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setPenaltyPercent(double penaltyPercent) { DARABONBA_PTR_SET_VALUE(penaltyPercent_, penaltyPercent) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setStartTime(int32_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setEndTime(int32_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setTimeUnitCode(int32_t timeUnitCode) { DARABONBA_PTR_SET_VALUE(timeUnitCode_, timeUnitCode) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setDepTime(string depTime) { DARABONBA_PTR_SET_VALUE(depTime_, depTime) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setSegmentNumber(string segmentNumber) { DARABONBA_PTR_SET_VALUE(segmentNumber_, segmentNumber) };
    ...
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setDescInfos(const map<string, string> & descInfos) { DARABONBA_PTR_SET_VALUE(descInfos_, descInfos) };
    inline ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue& setDescInfos(map<string, string> && descInfos) { DARABONBA_PTR_SET_RVALUE(descInfos_, descInfos) };
