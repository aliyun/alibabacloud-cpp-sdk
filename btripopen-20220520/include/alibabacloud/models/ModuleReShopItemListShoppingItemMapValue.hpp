...
#ifndef ALIBABACLOUD_MODELS_MODULERESHOPITEMLISTSHOPPINGITEMMAPVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULERESHOPITEMLISTSHOPPINGITEMMAPVALUE_HPP_
...
namespace Models
{
  class ModuleReShopItemListShoppingItemMapValue : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModuleReShopItemListShoppingItemMapValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleReShopItemListShoppingItemMapValue& obj) { 
    ...
    ModuleReShopItemListShoppingItemMapValue() = default ;
    ModuleReShopItemListShoppingItemMapValue(const ModuleReShopItemListShoppingItemMapValue &) = default ;
    ModuleReShopItemListShoppingItemMapValue(ModuleReShopItemListShoppingItemMapValue &&) = default ;
    ModuleReShopItemListShoppingItemMapValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleReShopItemListShoppingItemMapValue() = default ;
    ModuleReShopItemListShoppingItemMapValue& operator=(const ModuleReShopItemListShoppingItemMapValue &) = default ;
    ModuleReShopItemListShoppingItemMapValue& operator=(ModuleReShopItemListShoppingItemMapValue &&) = default ;
    ...
    inline const vector<ModuleReShopItemListShoppingItemMapValue::CabinQuantityList> & getCabinQuantityList() const { DARABONBA_PTR_GET_CONST(cabinQuantityList_, vector<ModuleReShopItemListShoppingItemMapValue::CabinQuantityList>) };
    inline vector<ModuleReShopItemListShoppingItemMapValue::CabinQuantityList> getCabinQuantityList() { DARABONBA_PTR_GET(cabinQuantityList_, vector<ModuleReShopItemListShoppingItemMapValue::CabinQuantityList>) };
    inline ModuleReShopItemListShoppingItemMapValue& setCabinQuantityList(const vector<ModuleReShopItemListShoppingItemMapValue::CabinQuantityList> & cabinQuantityList) { DARABONBA_PTR_SET_VALUE(cabinQuantityList_, cabinQuantityList) };
    inline ModuleReShopItemListShoppingItemMapValue& setCabinQuantityList(vector<ModuleReShopItemListShoppingItemMapValue::CabinQuantityList> && cabinQuantityList) { DARABONBA_PTR_SET_RVALUE(cabinQuantityList_, cabinQuantityList) };


    // searchPrice Field Functions 
    bool hasSearchPrice() const { return this->searchPrice_ != nullptr;};
    void deleteSearchPrice() { this->searchPrice_ = nullptr;};
    inline const ModuleReShopItemListShoppingItemMapValue::SearchPrice & getSearchPrice() const { DARABONBA_PTR_GET_CONST(searchPrice_, ModuleReShopItemListShoppingItemMapValue::SearchPrice) };
    inline ModuleReShopItemListShoppingItemMapValue::SearchPrice getSearchPrice() { DARABONBA_PTR_GET(searchPrice_, ModuleReShopItemListShoppingItemMapValue::SearchPrice) };
    inline ModuleReShopItemListShoppingItemMapValue& setSearchPrice(const ModuleReShopItemListShoppingItemMapValue::SearchPrice & searchPrice) { DARABONBA_PTR_SET_VALUE(searchPrice_, searchPrice) };
    inline ModuleReShopItemListShoppingItemMapValue& setSearchPrice(ModuleReShopItemListShoppingItemMapValue::SearchPrice && searchPrice) { DARABONBA_PTR_SET_RVALUE(searchPrice_, searchPrice) };
    ...
    inline const vector<ModuleReShopItemListShoppingItemMapValue::SegmentPriceList> & getSegmentPriceList() const { DARABONBA_PTR_GET_CONST(segmentPriceList_, vector<ModuleReShopItemListShoppingItemMapValue::SegmentPriceList>) };
    inline vector<ModuleReShopItemListShoppingItemMapValue::SegmentPriceList> getSegmentPriceList() { DARABONBA_PTR_GET(segmentPriceList_, vector<ModuleReShopItemListShoppingItemMapValue::SegmentPriceList>) };
    inline ModuleReShopItemListShoppingItemMapValue& setSegmentPriceList(const vector<ModuleReShopItemListShoppingItemMapValue::SegmentPriceList> & segmentPriceList) { DARABONBA_PTR_SET_VALUE(segmentPriceList_, segmentPriceList) };
    inline ModuleReShopItemListShoppingItemMapValue& setSegmentPriceList(vector<ModuleReShopItemListShoppingItemMapValue::SegmentPriceList> && segmentPriceList) { DARABONBA_PTR_SET_RVALUE(segmentPriceList_, segmentPriceList) };
