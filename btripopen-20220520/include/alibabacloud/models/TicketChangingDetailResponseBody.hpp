...
#ifndef ALIBABACLOUD_MODELS_TICKETCHANGINGDETAILRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_TICKETCHANGINGDETAILRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TicketChangingDetailResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TicketChangingDetailResponseBody& obj) { 
    ...
    TicketChangingDetailResponseBody() = default ;
    TicketChangingDetailResponseBody(const TicketChangingDetailResponseBody &) = default ;
    TicketChangingDetailResponseBody(TicketChangingDetailResponseBody &&) = default ;
    TicketChangingDetailResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TicketChangingDetailResponseBody() = default ;
    TicketChangingDetailResponseBody& operator=(const TicketChangingDetailResponseBody &) = default ;
    TicketChangingDetailResponseBody& operator=(TicketChangingDetailResponseBody &&) = default ;
    ...
    public:
      ...
      inline int64_t getSettlePrice() const { DARABONBA_PTR_GET_DEFAULT(settlePrice_, 0L) };
      inline Module& setSettlePrice(int64_t settlePrice) { DARABONBA_PTR_SET_VALUE(settlePrice_, settlePrice) };
      ...
      inline int64_t getTotalChangePrice() const { DARABONBA_PTR_GET_DEFAULT(totalChangePrice_, 0L) };
      inline Module& setTotalChangePrice(int64_t totalChangePrice) { DARABONBA_PTR_SET_VALUE(totalChangePrice_, totalChangePrice) };
      ...
      inline int64_t getTotalUpgradePrice() const { DARABONBA_PTR_GET_DEFAULT(totalUpgradePrice_, 0L) };
      inline Module& setTotalUpgradePrice(int64_t totalUpgradePrice) { DARABONBA_PTR_SET_VALUE(totalUpgradePrice_, totalUpgradePrice) };
    ...
    protected:
      ...
      shared_ptr<int64_t> settlePrice_ {};
      shared_ptr<int32_t> settleType_ {};
      shared_ptr<int32_t> status_ {};
      shared_ptr<int64_t> totalChangePrice_ {};
      shared_ptr<int64_t> totalPrice_ {};
      shared_ptr<int64_t> totalUpgradePrice_ {};
    ...
    inline TicketChangingDetailResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline TicketChangingDetailResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const TicketChangingDetailResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, TicketChangingDetailResponseBody::Module) };
    inline TicketChangingDetailResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, TicketChangingDetailResponseBody::Module) };
    inline TicketChangingDetailResponseBody& setModule(const TicketChangingDetailResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TicketChangingDetailResponseBody& setModule(TicketChangingDetailResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline TicketChangingDetailResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline TicketChangingDetailResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline TicketChangingDetailResponseBody& setTraceId(string traceId) { DARABONBA_PTR_SET_VALUE(traceId_, traceId) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<string> message_ {};
    shared_ptr<TicketChangingDetailResponseBody::Module> module_ {};
