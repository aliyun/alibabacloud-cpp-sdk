...
#ifndef ALIBABACLOUD_MODELS_INSINVOICESCANQUERYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_INSINVOICESCANQUERYRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const InsInvoiceScanQueryResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, InsInvoiceScanQueryResponseBody& obj) { 
    ...
    InsInvoiceScanQueryResponseBody() = default ;
    InsInvoiceScanQueryResponseBody(const InsInvoiceScanQueryResponseBody &) = default ;
    InsInvoiceScanQueryResponseBody(InsInvoiceScanQueryResponseBody &&) = default ;
    InsInvoiceScanQueryResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InsInvoiceScanQueryResponseBody() = default ;
    InsInvoiceScanQueryResponseBody& operator=(const InsInvoiceScanQueryResponseBody &) = default ;
    InsInvoiceScanQueryResponseBody& operator=(InsInvoiceScanQueryResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline string getInsuranceCompany() const { DARABONBA_PTR_GET_DEFAULT(insuranceCompany_, "") };
        inline Items& setInsuranceCompany(string insuranceCompany) { DARABONBA_PTR_SET_VALUE(insuranceCompany_, insuranceCompany) };
        ...
        inline string getInsuranceOrderId() const { DARABONBA_PTR_GET_DEFAULT(insuranceOrderId_, "") };
        inline Items& setInsuranceOrderId(string insuranceOrderId) { DARABONBA_PTR_SET_VALUE(insuranceOrderId_, insuranceOrderId) };
        ...
        inline string getInsuranceType() const { DARABONBA_PTR_GET_DEFAULT(insuranceType_, "") };
        inline Items& setInsuranceType(string insuranceType) { DARABONBA_PTR_SET_VALUE(insuranceType_, insuranceType) };
    ...
    inline InsInvoiceScanQueryResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline InsInvoiceScanQueryResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const InsInvoiceScanQueryResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, InsInvoiceScanQueryResponseBody::Module) };
    inline InsInvoiceScanQueryResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, InsInvoiceScanQueryResponseBody::Module) };
    inline InsInvoiceScanQueryResponseBody& setModule(const InsInvoiceScanQueryResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline InsInvoiceScanQueryResponseBody& setModule(InsInvoiceScanQueryResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline InsInvoiceScanQueryResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline InsInvoiceScanQueryResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline InsInvoiceScanQueryResponseBody& setTraceId(string traceId) { DARABONBA_PTR_SET_VALUE(traceId_, traceId) };
