...
#ifndef ALIBABACLOUD_MODELS_TRAINORDERQUERYRESPONSEBODYMODULEORDERBASEINFO_HPP_
#define ALIBABACLOUD_MODELS_TRAINORDERQUERYRESPONSEBODYMODULEORDERBASEINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TrainOrderQueryResponseBodyModuleOrderBaseInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TrainOrderQueryResponseBodyModuleOrderBaseInfo& obj) { 
    ...
    TrainOrderQueryResponseBodyModuleOrderBaseInfo() = default ;
    TrainOrderQueryResponseBodyModuleOrderBaseInfo(const TrainOrderQueryResponseBodyModuleOrderBaseInfo &) = default ;
    TrainOrderQueryResponseBodyModuleOrderBaseInfo(TrainOrderQueryResponseBodyModuleOrderBaseInfo &&) = default ;
    TrainOrderQueryResponseBodyModuleOrderBaseInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TrainOrderQueryResponseBodyModuleOrderBaseInfo() = default ;
    TrainOrderQueryResponseBodyModuleOrderBaseInfo& operator=(const TrainOrderQueryResponseBodyModuleOrderBaseInfo &) = default ;
    TrainOrderQueryResponseBodyModuleOrderBaseInfo& operator=(TrainOrderQueryResponseBodyModuleOrderBaseInfo &&) = default ;
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setApplyId(string applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setBtripTitle(string btripTitle) { DARABONBA_PTR_SET_VALUE(btripTitle_, btripTitle) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setContactName(string contactName) { DARABONBA_PTR_SET_VALUE(contactName_, contactName) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setCorpId(string corpId) { DARABONBA_PTR_SET_VALUE(corpId_, corpId) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setCorpName(string corpName) { DARABONBA_PTR_SET_VALUE(corpName_, corpName) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setDepartId(string departId) { DARABONBA_PTR_SET_VALUE(departId_, departId) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setDepartName(string departName) { DARABONBA_PTR_SET_VALUE(departName_, departName) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setExceedApplyId(string exceedApplyId) { DARABONBA_PTR_SET_VALUE(exceedApplyId_, exceedApplyId) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setExceedThirdPartApplyId(string exceedThirdPartApplyId) { DARABONBA_PTR_SET_VALUE(exceedThirdPartApplyId_, exceedThirdPartApplyId) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setGmtModify(string gmtModify) { DARABONBA_PTR_SET_VALUE(gmtModify_, gmtModify) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setItineraryId(string itineraryId) { DARABONBA_PTR_SET_VALUE(itineraryId_, itineraryId) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setOrderId(int64_t orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setOrderStatus(int32_t orderStatus) { DARABONBA_PTR_SET_VALUE(orderStatus_, orderStatus) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setThirdpartApplyId(string thirdpartApplyId) { DARABONBA_PTR_SET_VALUE(thirdpartApplyId_, thirdpartApplyId) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setThirdpartCorpId(string thirdpartCorpId) { DARABONBA_PTR_SET_VALUE(thirdpartCorpId_, thirdpartCorpId) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setThirdpartItineraryId(string thirdpartItineraryId) { DARABONBA_PTR_SET_VALUE(thirdpartItineraryId_, thirdpartItineraryId) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setTripType(int32_t tripType) { DARABONBA_PTR_SET_VALUE(tripType_, tripType) };
    ...
    inline TrainOrderQueryResponseBodyModuleOrderBaseInfo& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
