...
#ifndef ALIBABACLOUD_MODELS_TRAINBILLSETTLEMENTQUERYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_TRAINBILLSETTLEMENTQUERYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TrainBillSettlementQueryRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TrainBillSettlementQueryRequest& obj) { 
    ...
    TrainBillSettlementQueryRequest() = default ;
    TrainBillSettlementQueryRequest(const TrainBillSettlementQueryRequest &) = default ;
    TrainBillSettlementQueryRequest(TrainBillSettlementQueryRequest &&) = default ;
    TrainBillSettlementQueryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TrainBillSettlementQueryRequest() = default ;
    TrainBillSettlementQueryRequest& operator=(const TrainBillSettlementQueryRequest &) = default ;
    TrainBillSettlementQueryRequest& operator=(TrainBillSettlementQueryRequest &&) = default ;
    ...
    inline TrainBillSettlementQueryRequest& setApplyId(string applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline TrainBillSettlementQueryRequest& setBillBatch(string billBatch) { DARABONBA_PTR_SET_VALUE(billBatch_, billBatch) };
    ...
    inline TrainBillSettlementQueryRequest& setBillRecordTimeEnd(string billRecordTimeEnd) { DARABONBA_PTR_SET_VALUE(billRecordTimeEnd_, billRecordTimeEnd) };
    ...
    inline TrainBillSettlementQueryRequest& setBillRecordTimeStart(string billRecordTimeStart) { DARABONBA_PTR_SET_VALUE(billRecordTimeStart_, billRecordTimeStart) };
    ...
    inline TrainBillSettlementQueryRequest& setOrderId(int64_t orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline TrainBillSettlementQueryRequest& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline TrainBillSettlementQueryRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline TrainBillSettlementQueryRequest& setPeriodEnd(string periodEnd) { DARABONBA_PTR_SET_VALUE(periodEnd_, periodEnd) };
    ...
    inline TrainBillSettlementQueryRequest& setPeriodStart(string periodStart) { DARABONBA_PTR_SET_VALUE(periodStart_, periodStart) };
    ...
    inline TrainBillSettlementQueryRequest& setScrollId(string scrollId) { DARABONBA_PTR_SET_VALUE(scrollId_, scrollId) };
    ...
    inline TrainBillSettlementQueryRequest& setScrollMod(bool scrollMod) { DARABONBA_PTR_SET_VALUE(scrollMod_, scrollMod) };
