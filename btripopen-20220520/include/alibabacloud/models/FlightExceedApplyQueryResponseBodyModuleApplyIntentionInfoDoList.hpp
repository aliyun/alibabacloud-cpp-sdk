...
#ifndef ALIBABACLOUD_MODELS_FLIGHTEXCEEDAPPLYQUERYRESPONSEBODYMODULEAPPLYINTENTIONINFODOLIST_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTEXCEEDAPPLYQUERYRESPONSEBODYMODULEAPPLYINTENTIONINFODOLIST_HPP_
...
namespace Models
{
  class FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& obj) { 
    ...
    FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList() = default ;
    FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList(const FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList &) = default ;
    FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList(FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList &&) = default ;
    FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList() = default ;
    FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& operator=(const FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList &) = default ;
    FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& operator=(FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList &&) = default ;
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setArrAirportName(string arrAirportName) { DARABONBA_PTR_SET_VALUE(arrAirportName_, arrAirportName) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setArrCity(string arrCity) { DARABONBA_PTR_SET_VALUE(arrCity_, arrCity) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setArrCityName(string arrCityName) { DARABONBA_PTR_SET_VALUE(arrCityName_, arrCityName) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setArrTime(string arrTime) { DARABONBA_PTR_SET_VALUE(arrTime_, arrTime) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setCabinClass(int32_t cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setCabinClassStr(string cabinClassStr) { DARABONBA_PTR_SET_VALUE(cabinClassStr_, cabinClassStr) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setDepAirportName(string depAirportName) { DARABONBA_PTR_SET_VALUE(depAirportName_, depAirportName) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setDepCity(string depCity) { DARABONBA_PTR_SET_VALUE(depCity_, depCity) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setDepCityName(string depCityName) { DARABONBA_PTR_SET_VALUE(depCityName_, depCityName) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setDepTime(string depTime) { DARABONBA_PTR_SET_VALUE(depTime_, depTime) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setDiscount(string discount) { DARABONBA_PTR_SET_VALUE(discount_, discount) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setFlightNo(string flightNo) { DARABONBA_PTR_SET_VALUE(flightNo_, flightNo) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setPrice(int64_t price) { DARABONBA_PTR_SET_VALUE(price_, price) };
    ...
    inline FlightExceedApplyQueryResponseBodyModuleApplyIntentionInfoDoList& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
