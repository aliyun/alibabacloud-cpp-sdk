...
namespace Models
{
  ...
  public:
    ...
    inline const HotelOrderChangeApplyResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelOrderChangeApplyResponseBodyModule) };
    inline HotelOrderChangeApplyResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelOrderChangeApplyResponseBodyModule) };
    inline HotelOrderChangeApplyResponseBody& setModule(const HotelOrderChangeApplyResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelOrderChangeApplyResponseBody& setModule(HotelOrderChangeApplyResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<HotelOrderChangeApplyResponseBodyModule> module_ = nullptr;
