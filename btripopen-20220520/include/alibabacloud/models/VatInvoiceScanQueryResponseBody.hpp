...
namespace Models
{
  ...
  public:
    ...
    inline const VatInvoiceScanQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, VatInvoiceScanQueryResponseBodyModule) };
    inline VatInvoiceScanQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, VatInvoiceScanQueryResponseBodyModule) };
    inline VatInvoiceScanQueryResponseBody& setModule(const VatInvoiceScanQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline VatInvoiceScanQueryResponseBody& setModule(VatInvoiceScanQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<VatInvoiceScanQueryResponseBodyModule> module_ = nullptr;
    // requestId
