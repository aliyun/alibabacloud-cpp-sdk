...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BaseCityInfoSearchResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<BaseCityInfoSearchResponseBodyModule>) };
    inline vector<BaseCityInfoSearchResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<BaseCityInfoSearchResponseBodyModule>) };
    inline BaseCityInfoSearchResponseBody& setModule(const vector<BaseCityInfoSearchResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline BaseCityInfoSearchResponseBody& setModule(vector<BaseCityInfoSearchResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<vector<BaseCityInfoSearchResponseBodyModule>> module_ = nullptr;
