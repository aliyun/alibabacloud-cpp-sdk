...
#ifndef ALIBABACLOUD_MODELS_TICKETCHANGINGDETAILRESPONSEBODYMODULETRAVELERINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_TICKETCHANGINGDETAILRESPONSEBODYMODULETRAVELERINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TicketChangingDetailResponseBodyModuleTravelerInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TicketChangingDetailResponseBodyModuleTravelerInfoList& obj) { 
    ...
    TicketChangingDetailResponseBodyModuleTravelerInfoList() = default ;
    TicketChangingDetailResponseBodyModuleTravelerInfoList(const TicketChangingDetailResponseBodyModuleTravelerInfoList &) = default ;
    TicketChangingDetailResponseBodyModuleTravelerInfoList(TicketChangingDetailResponseBodyModuleTravelerInfoList &&) = default ;
    TicketChangingDetailResponseBodyModuleTravelerInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TicketChangingDetailResponseBodyModuleTravelerInfoList() = default ;
    TicketChangingDetailResponseBodyModuleTravelerInfoList& operator=(const TicketChangingDetailResponseBodyModuleTravelerInfoList &) = default ;
    TicketChangingDetailResponseBodyModuleTravelerInfoList& operator=(TicketChangingDetailResponseBodyModuleTravelerInfoList &&) = default ;
    ...
    inline TicketChangingDetailResponseBodyModuleTravelerInfoList& setBirthDate(string birthDate) { DARABONBA_PTR_SET_VALUE(birthDate_, birthDate) };
    ...
    inline TicketChangingDetailResponseBodyModuleTravelerInfoList& setCertNo(string certNo) { DARABONBA_PTR_SET_VALUE(certNo_, certNo) };
    ...
    inline TicketChangingDetailResponseBodyModuleTravelerInfoList& setCertType(string certType) { DARABONBA_PTR_SET_VALUE(certType_, certType) };
    ...
    inline TicketChangingDetailResponseBodyModuleTravelerInfoList& setOpenTicketStatus(int32_t openTicketStatus) { DARABONBA_PTR_SET_VALUE(openTicketStatus_, openTicketStatus) };
    ...
    inline TicketChangingDetailResponseBodyModuleTravelerInfoList& setPassengerName(string passengerName) { DARABONBA_PTR_SET_VALUE(passengerName_, passengerName) };
    ...
    inline TicketChangingDetailResponseBodyModuleTravelerInfoList& setPassengerType(string passengerType) { DARABONBA_PTR_SET_VALUE(passengerType_, passengerType) };
    ...
    inline TicketChangingDetailResponseBodyModuleTravelerInfoList& setPhone(string phone) { DARABONBA_PTR_SET_VALUE(phone_, phone) };
    ...
    inline TicketChangingDetailResponseBodyModuleTravelerInfoList& setTicketNo(string ticketNo) { DARABONBA_PTR_SET_VALUE(ticketNo_, ticketNo) };
    ...
    inline TicketChangingDetailResponseBodyModuleTravelerInfoList& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
