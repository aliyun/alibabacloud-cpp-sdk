...
#ifndef ALIBABACLOUD_MODELS_APPLYMODIFYREQUESTTRAVELERSTANDARD_HPP_
#define ALIBABACLOUD_MODELS_APPLYMODIFYREQUESTTRAVELERSTANDARD_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ApplyModifyRequestTravelerStandard& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ApplyModifyRequestTravelerStandard& obj) { 
    ...
    ApplyModifyRequestTravelerStandard() = default ;
    ApplyModifyRequestTravelerStandard(const ApplyModifyRequestTravelerStandard &) = default ;
    ApplyModifyRequestTravelerStandard(ApplyModifyRequestTravelerStandard &&) = default ;
    ApplyModifyRequestTravelerStandard(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ApplyModifyRequestTravelerStandard() = default ;
    ApplyModifyRequestTravelerStandard& operator=(const ApplyModifyRequestTravelerStandard &) = default ;
    ApplyModifyRequestTravelerStandard& operator=(ApplyModifyRequestTravelerStandard &&) = default ;
    ...
    virtual bool empty() const override { this->businessDiscount_ != nullptr
        ...
        && this->premiumEconomyDiscount_ != nullptr && this->reserveType_ != nullptr && this->trainRuleCode_ != nullptr && this->trainSeats_ != nullptr && this->userId_ != nullptr; };
    ...
    inline ApplyModifyRequestTravelerStandard& setBusinessDiscount(int32_t businessDiscount) { DARABONBA_PTR_SET_VALUE(businessDiscount_, businessDiscount) };
    ...
    inline const vector<Models::ApplyModifyRequestTravelerStandardCarCitySet> & carCitySet() const { DARABONBA_PTR_GET_CONST(carCitySet_, vector<Models::ApplyModifyRequestTravelerStandardCarCitySet>) };
    inline vector<Models::ApplyModifyRequestTravelerStandardCarCitySet> carCitySet() { DARABONBA_PTR_GET(carCitySet_, vector<Models::ApplyModifyRequestTravelerStandardCarCitySet>) };
    inline ApplyModifyRequestTravelerStandard& setCarCitySet(const vector<Models::ApplyModifyRequestTravelerStandardCarCitySet> & carCitySet) { DARABONBA_PTR_SET_VALUE(carCitySet_, carCitySet) };
    inline ApplyModifyRequestTravelerStandard& setCarCitySet(vector<Models::ApplyModifyRequestTravelerStandardCarCitySet> && carCitySet) { DARABONBA_PTR_SET_RVALUE(carCitySet_, carCitySet) };
    ...
    inline ApplyModifyRequestTravelerStandard& setEconomyDiscount(int32_t economyDiscount) { DARABONBA_PTR_SET_VALUE(economyDiscount_, economyDiscount) };
    ...
    inline ApplyModifyRequestTravelerStandard& setFirstDiscount(int32_t firstDiscount) { DARABONBA_PTR_SET_VALUE(firstDiscount_, firstDiscount) };
    ...
    inline ApplyModifyRequestTravelerStandard& setFlightCabins(string flightCabins) { DARABONBA_PTR_SET_VALUE(flightCabins_, flightCabins) };
    ...
    inline ApplyModifyRequestTravelerStandard& setFlightIntlRuleCode(int64_t flightIntlRuleCode) { DARABONBA_PTR_SET_VALUE(flightIntlRuleCode_, flightIntlRuleCode) };
    ...
    inline ApplyModifyRequestTravelerStandard& setFlightRuleCode(int64_t flightRuleCode) { DARABONBA_PTR_SET_VALUE(flightRuleCode_, flightRuleCode) };
    ...
    inline const vector<Models::ApplyModifyRequestTravelerStandardHotelCitys> & hotelCitys() const { DARABONBA_PTR_GET_CONST(hotelCitys_, vector<Models::ApplyModifyRequestTravelerStandardHotelCitys>) };
    inline vector<Models::ApplyModifyRequestTravelerStandardHotelCitys> hotelCitys() { DARABONBA_PTR_GET(hotelCitys_, vector<Models::ApplyModifyRequestTravelerStandardHotelCitys>) };
    inline ApplyModifyRequestTravelerStandard& setHotelCitys(const vector<Models::ApplyModifyRequestTravelerStandardHotelCitys> & hotelCitys) { DARABONBA_PTR_SET_VALUE(hotelCitys_, hotelCitys) };
    inline ApplyModifyRequestTravelerStandard& setHotelCitys(vector<Models::ApplyModifyRequestTravelerStandardHotelCitys> && hotelCitys) { DARABONBA_PTR_SET_RVALUE(hotelCitys_, hotelCitys) };
    ...
    inline const vector<Models::ApplyModifyRequestTravelerStandardHotelIntlCitys> & hotelIntlCitys() const { DARABONBA_PTR_GET_CONST(hotelIntlCitys_, vector<Models::ApplyModifyRequestTravelerStandardHotelIntlCitys>) };
    inline vector<Models::ApplyModifyRequestTravelerStandardHotelIntlCitys> hotelIntlCitys() { DARABONBA_PTR_GET(hotelIntlCitys_, vector<Models::ApplyModifyRequestTravelerStandardHotelIntlCitys>) };
    inline ApplyModifyRequestTravelerStandard& setHotelIntlCitys(const vector<Models::ApplyModifyRequestTravelerStandardHotelIntlCitys> & hotelIntlCitys) { DARABONBA_PTR_SET_VALUE(hotelIntlCitys_, hotelIntlCitys) };
    inline ApplyModifyRequestTravelerStandard& setHotelIntlCitys(vector<Models::ApplyModifyRequestTravelerStandardHotelIntlCitys> && hotelIntlCitys) { DARABONBA_PTR_SET_RVALUE(hotelIntlCitys_, hotelIntlCitys) };
    ...
    inline ApplyModifyRequestTravelerStandard& setHotelIntlRuleCode(int64_t hotelIntlRuleCode) { DARABONBA_PTR_SET_VALUE(hotelIntlRuleCode_, hotelIntlRuleCode) };
    ...
    inline ApplyModifyRequestTravelerStandard& setHotelRuleCode(int64_t hotelRuleCode) { DARABONBA_PTR_SET_VALUE(hotelRuleCode_, hotelRuleCode) };
    ...
    inline ApplyModifyRequestTravelerStandard& setPremiumEconomyDiscount(int32_t premiumEconomyDiscount) { DARABONBA_PTR_SET_VALUE(premiumEconomyDiscount_, premiumEconomyDiscount) };
    ...
    inline ApplyModifyRequestTravelerStandard& setReserveType(int32_t reserveType) { DARABONBA_PTR_SET_VALUE(reserveType_, reserveType) };
    ...
    inline ApplyModifyRequestTravelerStandard& setTrainRuleCode(int64_t trainRuleCode) { DARABONBA_PTR_SET_VALUE(trainRuleCode_, trainRuleCode) };
    ...
    inline ApplyModifyRequestTravelerStandard& setTrainSeats(string trainSeats) { DARABONBA_PTR_SET_VALUE(trainSeats_, trainSeats) };
    ...
    inline ApplyModifyRequestTravelerStandard& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };


  protected:
    std::shared_ptr<int32_t> businessDiscount_ = nullptr;
    std::shared_ptr<vector<Models::ApplyModifyRequestTravelerStandardCarCitySet>> carCitySet_ = nullptr;
    ...
    std::shared_ptr<vector<Models::ApplyModifyRequestTravelerStandardHotelCitys>> hotelCitys_ = nullptr;
    std::shared_ptr<vector<Models::ApplyModifyRequestTravelerStandardHotelIntlCitys>> hotelIntlCitys_ = nullptr;
