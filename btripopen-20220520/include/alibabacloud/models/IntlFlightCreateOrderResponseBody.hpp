...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightCreateOrderResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightCreateOrderResponseBodyModule) };
    inline IntlFlightCreateOrderResponseBodyModule module() { DARABONBA_PTR_GET(module_, IntlFlightCreateOrderResponseBodyModule) };
    inline IntlFlightCreateOrderResponseBody& setModule(const IntlFlightCreateOrderResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightCreateOrderResponseBody& setModule(IntlFlightCreateOrderResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IntlFlightCreateOrderResponseBodyModule> module_ = nullptr;
