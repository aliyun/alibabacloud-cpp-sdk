...
namespace Models
{
  ...
  public:
    ...
    inline const EstimatedPriceQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EstimatedPriceQueryResponseBody) };
    inline EstimatedPriceQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, EstimatedPriceQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EstimatedPriceQueryResponseBody> body_ {};
  };
