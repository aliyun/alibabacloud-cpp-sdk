...
namespace Models
{
  ...
  public:
    ...
    inline const FlightModifyOrderDetailV2ResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightModifyOrderDetailV2ResponseBodyModule) };
    inline FlightModifyOrderDetailV2ResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightModifyOrderDetailV2ResponseBodyModule) };
    inline FlightModifyOrderDetailV2ResponseBody& setModule(const FlightModifyOrderDetailV2ResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightModifyOrderDetailV2ResponseBody& setModule(FlightModifyOrderDetailV2ResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<FlightModifyOrderDetailV2ResponseBodyModule> module_ = nullptr;
    // requestId
