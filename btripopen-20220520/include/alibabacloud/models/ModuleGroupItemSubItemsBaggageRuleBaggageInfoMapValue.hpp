...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->carryFreepc_ == nullptr
    ...
    inline string getAirline() const { DARABONBA_PTR_GET_DEFAULT(airline_, "") };
    ...
    inline string getStartAirport() const { DARABONBA_PTR_GET_DEFAULT(startAirport_, "") };
    ...
    inline string getEndAirport() const { DARABONBA_PTR_GET_DEFAULT(endAirport_, "") };
  ...
  protected:
    ...
    shared_ptr<string> airline_ {};
    shared_ptr<string> startAirport_ {};
    shared_ptr<string> endAirport_ {};
