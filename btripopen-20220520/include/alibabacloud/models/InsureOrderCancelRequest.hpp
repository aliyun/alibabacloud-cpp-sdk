...
#ifndef ALIBABACLOUD_MODELS_INSUREORDERCANCELREQUEST_HPP_
#define ALIBABACLOUD_MODELS_INSUREORDERCANCELREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const InsureOrderCancelRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, InsureOrderCancelRequest& obj) { 
    ...
    InsureOrderCancelRequest() = default ;
    InsureOrderCancelRequest(const InsureOrderCancelRequest &) = default ;
    InsureOrderCancelRequest(InsureOrderCancelRequest &&) = default ;
    InsureOrderCancelRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InsureOrderCancelRequest() = default ;
    InsureOrderCancelRequest& operator=(const InsureOrderCancelRequest &) = default ;
    InsureOrderCancelRequest& operator=(InsureOrderCancelRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->btripUserId_ != nullptr
        && this->buyerName_ != nullptr && this->isvName_ != nullptr && this->supplierCode_ != nullptr; };
    ...
    inline InsureOrderCancelRequest& setBtripUserId(string btripUserId) { DARABONBA_PTR_SET_VALUE(btripUserId_, btripUserId) };
    ...
    inline InsureOrderCancelRequest& setBuyerName(string buyerName) { DARABONBA_PTR_SET_VALUE(buyerName_, buyerName) };
    ...
    inline InsureOrderCancelRequest& setIsvName(string isvName) { DARABONBA_PTR_SET_VALUE(isvName_, isvName) };
    ...
    inline InsureOrderCancelRequest& setSupplierCode(string supplierCode) { DARABONBA_PTR_SET_VALUE(supplierCode_, supplierCode) };
