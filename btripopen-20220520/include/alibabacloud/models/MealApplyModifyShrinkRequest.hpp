...
#ifndef ALIBABACLOUD_MODELS_MEALAPPLYMODIFYSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MEALAPPLYMODIFYSHRINKREQUEST_HPP_
...
namespace Models
{
  class MealApplyModifyShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const MealApplyModifyShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, MealApplyModifyShrinkRequest& obj) { 
    ...
    MealApplyModifyShrinkRequest() = default ;
    MealApplyModifyShrinkRequest(const MealApplyModifyShrinkRequest &) = default ;
    MealApplyModifyShrinkRequest(MealApplyModifyShrinkRequest &&) = default ;
    MealApplyModifyShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~MealApplyModifyShrinkRequest() = default ;
    MealApplyModifyShrinkRequest& operator=(const MealApplyModifyShrinkRequest &) = default ;
    MealApplyModifyShrinkRequest& operator=(MealApplyModifyShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->applyUserShrink_ == nullptr
        && this->costCenterId_ == nullptr && this->extendField_ == nullptr && this->invoiceId_ == nullptr && this->itineraryListShrink_ == nullptr && this->mealAmount_ == nullptr
    ...
    inline string getApplyUserShrink() const { DARABONBA_PTR_GET_DEFAULT(applyUserShrink_, "") };
    inline MealApplyModifyShrinkRequest& setApplyUserShrink(string applyUserShrink) { DARABONBA_PTR_SET_VALUE(applyUserShrink_, applyUserShrink) };
    ...
    inline MealApplyModifyShrinkRequest& setCostCenterId(int64_t costCenterId) { DARABONBA_PTR_SET_VALUE(costCenterId_, costCenterId) };
    ...
    inline MealApplyModifyShrinkRequest& setExtendField(string extendField) { DARABONBA_PTR_SET_VALUE(extendField_, extendField) };
    ...
    inline MealApplyModifyShrinkRequest& setInvoiceId(int64_t invoiceId) { DARABONBA_PTR_SET_VALUE(invoiceId_, invoiceId) };
    ...
    inline MealApplyModifyShrinkRequest& setItineraryListShrink(string itineraryListShrink) { DARABONBA_PTR_SET_VALUE(itineraryListShrink_, itineraryListShrink) };
    ...
    inline MealApplyModifyShrinkRequest& setMealAmount(int64_t mealAmount) { DARABONBA_PTR_SET_VALUE(mealAmount_, mealAmount) };
    ...
    inline MealApplyModifyShrinkRequest& setMealCause(string mealCause) { DARABONBA_PTR_SET_VALUE(mealCause_, mealCause) };
    ...
    inline MealApplyModifyShrinkRequest& setProjectCode(string projectCode) { DARABONBA_PTR_SET_VALUE(projectCode_, projectCode) };
    ...
    inline MealApplyModifyShrinkRequest& setProjectTitle(string projectTitle) { DARABONBA_PTR_SET_VALUE(projectTitle_, projectTitle) };
    ...
    inline MealApplyModifyShrinkRequest& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline MealApplyModifyShrinkRequest& setThirdPartApplyId(string thirdPartApplyId) { DARABONBA_PTR_SET_VALUE(thirdPartApplyId_, thirdPartApplyId) };
    ...
    inline MealApplyModifyShrinkRequest& setThirdPartCostCenterId(string thirdPartCostCenterId) { DARABONBA_PTR_SET_VALUE(thirdPartCostCenterId_, thirdPartCostCenterId) };
    ...
    inline MealApplyModifyShrinkRequest& setThirdPartInvoiceId(string thirdPartInvoiceId) { DARABONBA_PTR_SET_VALUE(thirdPartInvoiceId_, thirdPartInvoiceId) };


  protected:
    // This parameter is required.
    shared_ptr<string> applyUserShrink_ {};
