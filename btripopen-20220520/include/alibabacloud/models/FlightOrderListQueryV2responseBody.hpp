...
namespace Models
{
  ...
  public:
    ...
    inline const vector<FlightOrderListQueryV2ResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<FlightOrderListQueryV2ResponseBodyModule>) };
    inline vector<FlightOrderListQueryV2ResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<FlightOrderListQueryV2ResponseBodyModule>) };
    inline FlightOrderListQueryV2ResponseBody& setModule(const vector<FlightOrderListQueryV2ResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightOrderListQueryV2ResponseBody& setModule(vector<FlightOrderListQueryV2ResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };


    // pageInfo Field Functions 
    bool hasPageInfo() const { return this->pageInfo_ != nullptr;};
    void deletePageInfo() { this->pageInfo_ = nullptr;};
    inline const FlightOrderListQueryV2ResponseBodyPageInfo & pageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, FlightOrderListQueryV2ResponseBodyPageInfo) };
    inline FlightOrderListQueryV2ResponseBodyPageInfo pageInfo() { DARABONBA_PTR_GET(pageInfo_, FlightOrderListQueryV2ResponseBodyPageInfo) };
    inline FlightOrderListQueryV2ResponseBody& setPageInfo(const FlightOrderListQueryV2ResponseBodyPageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline FlightOrderListQueryV2ResponseBody& setPageInfo(FlightOrderListQueryV2ResponseBodyPageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
  ...
  protected:
    ...
    std::shared_ptr<vector<FlightOrderListQueryV2ResponseBodyModule>> module_ = nullptr;
    std::shared_ptr<FlightOrderListQueryV2ResponseBodyPageInfo> pageInfo_ = nullptr;
