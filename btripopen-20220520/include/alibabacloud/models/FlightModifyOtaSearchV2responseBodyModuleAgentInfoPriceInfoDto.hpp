...
#ifndef ALIBABACLOUD_MODELS_FLIGHTMODIFYOTASEARCHV2RESPONSEBODYMODULEAGENTINFOPRICEINFODTO_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTMODIFYOTASEARCHV2RESPONSEBODYMODULEAGENTINFOPRICEINFODTO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& obj) { 
    ...
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO() = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO(const FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO &) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO(FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO &&) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO() = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& operator=(const FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO &) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& operator=(FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO &&) = default ;
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setAdultPrice(int32_t adultPrice) { DARABONBA_PTR_SET_VALUE(adultPrice_, adultPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setAdultTax(int32_t adultTax) { DARABONBA_PTR_SET_VALUE(adultTax_, adultTax) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setAdultTotalPrice(int32_t adultTotalPrice) { DARABONBA_PTR_SET_VALUE(adultTotalPrice_, adultTotalPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setBeforeControlPrice(int32_t beforeControlPrice) { DARABONBA_PTR_SET_VALUE(beforeControlPrice_, beforeControlPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setChildPrice(int32_t childPrice) { DARABONBA_PTR_SET_VALUE(childPrice_, childPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setChildTax(int32_t childTax) { DARABONBA_PTR_SET_VALUE(childTax_, childTax) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setChildTotalPrice(int32_t childTotalPrice) { DARABONBA_PTR_SET_VALUE(childTotalPrice_, childTotalPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setInfantPrice(int32_t infantPrice) { DARABONBA_PTR_SET_VALUE(infantPrice_, infantPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setInfantTax(int32_t infantTax) { DARABONBA_PTR_SET_VALUE(infantTax_, infantTax) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setInfantTotalPrice(int32_t infantTotalPrice) { DARABONBA_PTR_SET_VALUE(infantTotalPrice_, infantTotalPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setOriginalAdultPrice(int32_t originalAdultPrice) { DARABONBA_PTR_SET_VALUE(originalAdultPrice_, originalAdultPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setOriginalAdultTotalPrice(int32_t originalAdultTotalPrice) { DARABONBA_PTR_SET_VALUE(originalAdultTotalPrice_, originalAdultTotalPrice) };
    ...
    inline const Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO & reShopPriceInfoDTO() const { DARABONBA_PTR_GET_CONST(reShopPriceInfoDTO_, Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO) };
    inline Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO reShopPriceInfoDTO() { DARABONBA_PTR_GET(reShopPriceInfoDTO_, Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO) };
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setReShopPriceInfoDTO(const Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO & reShopPriceInfoDTO) { DARABONBA_PTR_SET_VALUE(reShopPriceInfoDTO_, reShopPriceInfoDTO) };
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTO& setReShopPriceInfoDTO(Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO && reShopPriceInfoDTO) { DARABONBA_PTR_SET_RVALUE(reShopPriceInfoDTO_, reShopPriceInfoDTO) };
  ...
  protected:
    ...
    std::shared_ptr<Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfoPriceInfoDTOReShopPriceInfoDTO> reShopPriceInfoDTO_ = nullptr;
  };
