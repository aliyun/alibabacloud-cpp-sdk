...
#ifndef ALIBABACLOUD_MODELS_IEFLIGHTBILLSETTLEMENTQUERYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_IEFLIGHTBILLSETTLEMENTQUERYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const IeFlightBillSettlementQueryRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IeFlightBillSettlementQueryRequest& obj) { 
    ...
    IeFlightBillSettlementQueryRequest() = default ;
    IeFlightBillSettlementQueryRequest(const IeFlightBillSettlementQueryRequest &) = default ;
    IeFlightBillSettlementQueryRequest(IeFlightBillSettlementQueryRequest &&) = default ;
    IeFlightBillSettlementQueryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IeFlightBillSettlementQueryRequest() = default ;
    IeFlightBillSettlementQueryRequest& operator=(const IeFlightBillSettlementQueryRequest &) = default ;
    IeFlightBillSettlementQueryRequest& operator=(IeFlightBillSettlementQueryRequest &&) = default ;
    ...
    inline IeFlightBillSettlementQueryRequest& setApplyId(string applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline IeFlightBillSettlementQueryRequest& setBillBatch(string billBatch) { DARABONBA_PTR_SET_VALUE(billBatch_, billBatch) };
    ...
    inline IeFlightBillSettlementQueryRequest& setBillRecordTimeEnd(string billRecordTimeEnd) { DARABONBA_PTR_SET_VALUE(billRecordTimeEnd_, billRecordTimeEnd) };
    ...
    inline IeFlightBillSettlementQueryRequest& setBillRecordTimeStart(string billRecordTimeStart) { DARABONBA_PTR_SET_VALUE(billRecordTimeStart_, billRecordTimeStart) };
    ...
    inline IeFlightBillSettlementQueryRequest& setOrderId(int64_t orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline IeFlightBillSettlementQueryRequest& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline IeFlightBillSettlementQueryRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline IeFlightBillSettlementQueryRequest& setPeriodEnd(string periodEnd) { DARABONBA_PTR_SET_VALUE(periodEnd_, periodEnd) };
    ...
    inline IeFlightBillSettlementQueryRequest& setPeriodStart(string periodStart) { DARABONBA_PTR_SET_VALUE(periodStart_, periodStart) };
    ...
    inline IeFlightBillSettlementQueryRequest& setScrollId(string scrollId) { DARABONBA_PTR_SET_VALUE(scrollId_, scrollId) };
    ...
    inline IeFlightBillSettlementQueryRequest& setScrollMod(bool scrollMod) { DARABONBA_PTR_SET_VALUE(scrollMod_, scrollMod) };
