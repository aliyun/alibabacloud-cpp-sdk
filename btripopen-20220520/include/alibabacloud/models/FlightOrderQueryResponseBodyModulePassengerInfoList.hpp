...
#ifndef ALIBABACLOUD_MODELS_FLIGHTORDERQUERYRESPONSEBODYMODULEPASSENGERINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTORDERQUERYRESPONSEBODYMODULEPASSENGERINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightOrderQueryResponseBodyModulePassengerInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightOrderQueryResponseBodyModulePassengerInfoList& obj) { 
    ...
    FlightOrderQueryResponseBodyModulePassengerInfoList() = default ;
    FlightOrderQueryResponseBodyModulePassengerInfoList(const FlightOrderQueryResponseBodyModulePassengerInfoList &) = default ;
    FlightOrderQueryResponseBodyModulePassengerInfoList(FlightOrderQueryResponseBodyModulePassengerInfoList &&) = default ;
    FlightOrderQueryResponseBodyModulePassengerInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightOrderQueryResponseBodyModulePassengerInfoList() = default ;
    FlightOrderQueryResponseBodyModulePassengerInfoList& operator=(const FlightOrderQueryResponseBodyModulePassengerInfoList &) = default ;
    FlightOrderQueryResponseBodyModulePassengerInfoList& operator=(FlightOrderQueryResponseBodyModulePassengerInfoList &&) = default ;
    ...
    inline FlightOrderQueryResponseBodyModulePassengerInfoList& setCostCenterId(int64_t costCenterId) { DARABONBA_PTR_SET_VALUE(costCenterId_, costCenterId) };
    ...
    inline FlightOrderQueryResponseBodyModulePassengerInfoList& setCostCenterName(string costCenterName) { DARABONBA_PTR_SET_VALUE(costCenterName_, costCenterName) };
    ...
    inline FlightOrderQueryResponseBodyModulePassengerInfoList& setCostCenterNumber(string costCenterNumber) { DARABONBA_PTR_SET_VALUE(costCenterNumber_, costCenterNumber) };
    ...
    inline FlightOrderQueryResponseBodyModulePassengerInfoList& setProjectCode(string projectCode) { DARABONBA_PTR_SET_VALUE(projectCode_, projectCode) };
    ...
    inline FlightOrderQueryResponseBodyModulePassengerInfoList& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline FlightOrderQueryResponseBodyModulePassengerInfoList& setProjectTitle(string projectTitle) { DARABONBA_PTR_SET_VALUE(projectTitle_, projectTitle) };
    ...
    inline FlightOrderQueryResponseBodyModulePassengerInfoList& setThirdpartProjectId(string thirdpartProjectId) { DARABONBA_PTR_SET_VALUE(thirdpartProjectId_, thirdpartProjectId) };
    ...
    inline FlightOrderQueryResponseBodyModulePassengerInfoList& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline FlightOrderQueryResponseBodyModulePassengerInfoList& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
    ...
    inline FlightOrderQueryResponseBodyModulePassengerInfoList& setUserType(int32_t userType) { DARABONBA_PTR_SET_VALUE(userType_, userType) };
