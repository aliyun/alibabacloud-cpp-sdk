...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInvoiceEntityResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, DeleteInvoiceEntityResponseBodyModule) };
    inline DeleteInvoiceEntityResponseBodyModule module() { DARABONBA_PTR_GET(module_, DeleteInvoiceEntityResponseBodyModule) };
    inline DeleteInvoiceEntityResponseBody& setModule(const DeleteInvoiceEntityResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline DeleteInvoiceEntityResponseBody& setModule(DeleteInvoiceEntityResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteInvoiceEntityResponseBodyModule> module_ = nullptr;
