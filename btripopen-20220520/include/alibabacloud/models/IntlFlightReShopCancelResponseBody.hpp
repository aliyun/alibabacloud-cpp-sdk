...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightReShopCancelResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightReShopCancelResponseBodyModule) };
    inline IntlFlightReShopCancelResponseBodyModule module() { DARABONBA_PTR_GET(module_, IntlFlightReShopCancelResponseBodyModule) };
    inline IntlFlightReShopCancelResponseBody& setModule(const IntlFlightReShopCancelResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightReShopCancelResponseBody& setModule(IntlFlightReShopCancelResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IntlFlightReShopCancelResponseBodyModule> module_ = nullptr;
