...
namespace Models
{
  ...
  public:
    ...
    inline const FlightOrderDetailV2ResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightOrderDetailV2ResponseBodyModule) };
    inline FlightOrderDetailV2ResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightOrderDetailV2ResponseBodyModule) };
    inline FlightOrderDetailV2ResponseBody& setModule(const FlightOrderDetailV2ResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightOrderDetailV2ResponseBody& setModule(FlightOrderDetailV2ResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<FlightOrderDetailV2ResponseBodyModule> module_ = nullptr;
    // requestId
