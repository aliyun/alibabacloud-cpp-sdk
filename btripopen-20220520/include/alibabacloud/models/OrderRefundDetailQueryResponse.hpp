...
namespace Models
{
  ...
  public:
    ...
    inline const OrderRefundDetailQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OrderRefundDetailQueryResponseBody) };
    inline OrderRefundDetailQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, OrderRefundDetailQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OrderRefundDetailQueryResponseBody> body_ {};
  };
