...
namespace Models
{
  ...
  public:
    ...
    inline const EntitySetResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, EntitySetResponseBodyModule) };
    inline EntitySetResponseBodyModule module() { DARABONBA_PTR_GET(module_, EntitySetResponseBodyModule) };
    inline EntitySetResponseBody& setModule(const EntitySetResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline EntitySetResponseBody& setModule(EntitySetResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<EntitySetResponseBodyModule> module_ = nullptr;
