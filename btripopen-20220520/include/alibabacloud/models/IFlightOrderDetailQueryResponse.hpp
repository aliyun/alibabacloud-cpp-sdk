...
namespace Models
{
  ...
  public:
    ...
    inline const IFlightOrderDetailQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IFlightOrderDetailQueryResponseBody) };
    inline IFlightOrderDetailQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, IFlightOrderDetailQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IFlightOrderDetailQueryResponseBody> body_ {};
  };
