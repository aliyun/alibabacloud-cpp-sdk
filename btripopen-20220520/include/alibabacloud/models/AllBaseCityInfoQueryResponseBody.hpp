...
namespace Models
{
  ...
  public:
    ...
    inline const AllBaseCityInfoQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, AllBaseCityInfoQueryResponseBodyModule) };
    inline AllBaseCityInfoQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, AllBaseCityInfoQueryResponseBodyModule) };
    inline AllBaseCityInfoQueryResponseBody& setModule(const AllBaseCityInfoQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline AllBaseCityInfoQueryResponseBody& setModule(AllBaseCityInfoQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<AllBaseCityInfoQueryResponseBodyModule> module_ = nullptr;
