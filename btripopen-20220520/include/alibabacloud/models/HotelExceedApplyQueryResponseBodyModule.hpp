...
#ifndef ALIBABACLOUD_MODELS_HOTELEXCEEDAPPLYQUERYRESPONSEBODYMODULE_HPP_
#define ALIBABACLOUD_MODELS_HOTELEXCEEDAPPLYQUERYRESPONSEBODYMODULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const HotelExceedApplyQueryResponseBodyModule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, HotelExceedApplyQueryResponseBodyModule& obj) { 
    ...
    HotelExceedApplyQueryResponseBodyModule() = default ;
    HotelExceedApplyQueryResponseBodyModule(const HotelExceedApplyQueryResponseBodyModule &) = default ;
    HotelExceedApplyQueryResponseBodyModule(HotelExceedApplyQueryResponseBodyModule &&) = default ;
    HotelExceedApplyQueryResponseBodyModule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~HotelExceedApplyQueryResponseBodyModule() = default ;
    HotelExceedApplyQueryResponseBodyModule& operator=(const HotelExceedApplyQueryResponseBodyModule &) = default ;
    HotelExceedApplyQueryResponseBodyModule& operator=(HotelExceedApplyQueryResponseBodyModule &&) = default ;
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setApplyId(int64_t applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline const Models::HotelExceedApplyQueryResponseBodyModuleApplyIntentionInfoDo & applyIntentionInfoDo() const { DARABONBA_PTR_GET_CONST(applyIntentionInfoDo_, Models::HotelExceedApplyQueryResponseBodyModuleApplyIntentionInfoDo) };
    inline Models::HotelExceedApplyQueryResponseBodyModuleApplyIntentionInfoDo applyIntentionInfoDo() { DARABONBA_PTR_GET(applyIntentionInfoDo_, Models::HotelExceedApplyQueryResponseBodyModuleApplyIntentionInfoDo) };
    inline HotelExceedApplyQueryResponseBodyModule& setApplyIntentionInfoDo(const Models::HotelExceedApplyQueryResponseBodyModuleApplyIntentionInfoDo & applyIntentionInfoDo) { DARABONBA_PTR_SET_VALUE(applyIntentionInfoDo_, applyIntentionInfoDo) };
    inline HotelExceedApplyQueryResponseBodyModule& setApplyIntentionInfoDo(Models::HotelExceedApplyQueryResponseBodyModuleApplyIntentionInfoDo && applyIntentionInfoDo) { DARABONBA_PTR_SET_RVALUE(applyIntentionInfoDo_, applyIntentionInfoDo) };
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setBtripCause(string btripCause) { DARABONBA_PTR_SET_VALUE(btripCause_, btripCause) };
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setCorpId(string corpId) { DARABONBA_PTR_SET_VALUE(corpId_, corpId) };
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setExceedReason(string exceedReason) { DARABONBA_PTR_SET_VALUE(exceedReason_, exceedReason) };
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setExceedType(int32_t exceedType) { DARABONBA_PTR_SET_VALUE(exceedType_, exceedType) };
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setOriginStandard(string originStandard) { DARABONBA_PTR_SET_VALUE(originStandard_, originStandard) };
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setSubmitTime(string submitTime) { DARABONBA_PTR_SET_VALUE(submitTime_, submitTime) };
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setThirdpartApplyId(string thirdpartApplyId) { DARABONBA_PTR_SET_VALUE(thirdpartApplyId_, thirdpartApplyId) };
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setThirdpartCorpId(string thirdpartCorpId) { DARABONBA_PTR_SET_VALUE(thirdpartCorpId_, thirdpartCorpId) };
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline HotelExceedApplyQueryResponseBodyModule& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };


  protected:
    std::shared_ptr<int64_t> applyId_ = nullptr;
    std::shared_ptr<Models::HotelExceedApplyQueryResponseBodyModuleApplyIntentionInfoDo> applyIntentionInfoDo_ = nullptr;
