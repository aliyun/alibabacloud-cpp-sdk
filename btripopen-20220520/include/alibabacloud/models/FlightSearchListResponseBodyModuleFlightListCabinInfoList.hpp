...
#ifndef ALIBABACLOUD_MODELS_FLIGHTSEARCHLISTRESPONSEBODYMODULEFLIGHTLISTCABININFOLIST_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTSEARCHLISTRESPONSEBODYMODULEFLIGHTLISTCABININFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightSearchListResponseBodyModuleFlightListCabinInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightSearchListResponseBodyModuleFlightListCabinInfoList& obj) { 
    ...
    FlightSearchListResponseBodyModuleFlightListCabinInfoList() = default ;
    FlightSearchListResponseBodyModuleFlightListCabinInfoList(const FlightSearchListResponseBodyModuleFlightListCabinInfoList &) = default ;
    FlightSearchListResponseBodyModuleFlightListCabinInfoList(FlightSearchListResponseBodyModuleFlightListCabinInfoList &&) = default ;
    FlightSearchListResponseBodyModuleFlightListCabinInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightSearchListResponseBodyModuleFlightListCabinInfoList() = default ;
    FlightSearchListResponseBodyModuleFlightListCabinInfoList& operator=(const FlightSearchListResponseBodyModuleFlightListCabinInfoList &) = default ;
    FlightSearchListResponseBodyModuleFlightListCabinInfoList& operator=(FlightSearchListResponseBodyModuleFlightListCabinInfoList &&) = default ;
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setAgentId(int64_t agentId) { DARABONBA_PTR_SET_VALUE(agentId_, agentId) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setBasicCabinPrice(int32_t basicCabinPrice) { DARABONBA_PTR_SET_VALUE(basicCabinPrice_, basicCabinPrice) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setBuildPrice(int32_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setCabinClassName(string cabinClassName) { DARABONBA_PTR_SET_VALUE(cabinClassName_, cabinClassName) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setChildCabin(string childCabin) { DARABONBA_PTR_SET_VALUE(childCabin_, childCabin) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setClassName(string className) { DARABONBA_PTR_SET_VALUE(className_, className) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setClassRule(string classRule) { DARABONBA_PTR_SET_VALUE(classRule_, classRule) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setDiscount(string discount) { DARABONBA_PTR_SET_VALUE(discount_, discount) };
    ...
    inline const vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoListFlightRuleList> & flightRuleList() const { DARABONBA_PTR_GET_CONST(flightRuleList_, vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoListFlightRuleList>) };
    inline vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoListFlightRuleList> flightRuleList() { DARABONBA_PTR_GET(flightRuleList_, vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoListFlightRuleList>) };
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setFlightRuleList(const vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoListFlightRuleList> & flightRuleList) { DARABONBA_PTR_SET_VALUE(flightRuleList_, flightRuleList) };
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setFlightRuleList(vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoListFlightRuleList> && flightRuleList) { DARABONBA_PTR_SET_RVALUE(flightRuleList_, flightRuleList) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setFlightRuleListStr(string flightRuleListStr) { DARABONBA_PTR_SET_VALUE(flightRuleListStr_, flightRuleListStr) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setInvoiceType(int32_t invoiceType) { DARABONBA_PTR_SET_VALUE(invoiceType_, invoiceType) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setIsProtocol(bool isProtocol) { DARABONBA_PTR_SET_VALUE(isProtocol_, isProtocol) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setMemo(string memo) { DARABONBA_PTR_SET_VALUE(memo_, memo) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setOilPrice(int32_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setOrderParams(string orderParams) { DARABONBA_PTR_SET_VALUE(orderParams_, orderParams) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setOtaItemId(string otaItemId) { DARABONBA_PTR_SET_VALUE(otaItemId_, otaItemId) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setPrice(int32_t price) { DARABONBA_PTR_SET_VALUE(price_, price) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setProductType(int64_t productType) { DARABONBA_PTR_SET_VALUE(productType_, productType) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setProductTypeDesc(string productTypeDesc) { DARABONBA_PTR_SET_VALUE(productTypeDesc_, productTypeDesc) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setPromotionPrice(string promotionPrice) { DARABONBA_PTR_SET_VALUE(promotionPrice_, promotionPrice) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setRemainedSeatCount(string remainedSeatCount) { DARABONBA_PTR_SET_VALUE(remainedSeatCount_, remainedSeatCount) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setTicketPrice(int32_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline FlightSearchListResponseBodyModuleFlightListCabinInfoList& setTotalPrice(int32_t totalPrice) { DARABONBA_PTR_SET_VALUE(totalPrice_, totalPrice) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::FlightSearchListResponseBodyModuleFlightListCabinInfoListFlightRuleList>> flightRuleList_ = nullptr;
