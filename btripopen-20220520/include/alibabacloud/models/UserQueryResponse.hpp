...
namespace Models
{
  ...
  public:
    ...
    inline const UserQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UserQueryResponseBody) };
    inline UserQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, UserQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UserQueryResponseBody> body_ {};
  };
