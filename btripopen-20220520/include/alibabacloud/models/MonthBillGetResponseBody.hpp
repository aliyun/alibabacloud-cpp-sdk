...
namespace Models
{
  ...
  public:
    ...
    inline const vector<MonthBillGetResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<MonthBillGetResponseBodyModule>) };
    inline vector<MonthBillGetResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<MonthBillGetResponseBodyModule>) };
    inline MonthBillGetResponseBody& setModule(const vector<MonthBillGetResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline MonthBillGetResponseBody& setModule(vector<MonthBillGetResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<vector<MonthBillGetResponseBodyModule>> module_ = nullptr;
