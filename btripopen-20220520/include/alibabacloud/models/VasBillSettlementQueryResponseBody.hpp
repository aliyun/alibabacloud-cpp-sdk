...
namespace Models
{
  ...
  public:
    ...
    inline const VasBillSettlementQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, VasBillSettlementQueryResponseBodyModule) };
    inline VasBillSettlementQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, VasBillSettlementQueryResponseBodyModule) };
    inline VasBillSettlementQueryResponseBody& setModule(const VasBillSettlementQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline VasBillSettlementQueryResponseBody& setModule(VasBillSettlementQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<VasBillSettlementQueryResponseBodyModule> module_ = nullptr;
