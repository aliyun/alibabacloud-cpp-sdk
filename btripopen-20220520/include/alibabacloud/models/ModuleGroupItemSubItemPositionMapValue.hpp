...
#ifndef ALIBABACLOUD_MODELS_MODULEGROUPITEMSUBITEMPOSITIONMAPVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULEGROUPITEMSUBITEMPOSITIONMAPVALUE_HPP_
...
namespace Models
{
  class ModuleGroupItemSubItemPositionMapValue : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModuleGroupItemSubItemPositionMapValue& obj) { 
      DARABONBA_PTR_TO_JSON(journey_index, journeyIndex_);
      DARABONBA_PTR_TO_JSON(segment_index, segmentIndex_);
    };
    friend void from_json(const Darabonba::Json& j, ModuleGroupItemSubItemPositionMapValue& obj) { 
      DARABONBA_PTR_FROM_JSON(journey_index, journeyIndex_);
      DARABONBA_PTR_FROM_JSON(segment_index, segmentIndex_);
    };
    ModuleGroupItemSubItemPositionMapValue() = default ;
    ModuleGroupItemSubItemPositionMapValue(const ModuleGroupItemSubItemPositionMapValue &) = default ;
    ModuleGroupItemSubItemPositionMapValue(ModuleGroupItemSubItemPositionMapValue &&) = default ;
    ModuleGroupItemSubItemPositionMapValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleGroupItemSubItemPositionMapValue() = default ;
    ModuleGroupItemSubItemPositionMapValue& operator=(const ModuleGroupItemSubItemPositionMapValue &) = default ;
    ModuleGroupItemSubItemPositionMapValue& operator=(ModuleGroupItemSubItemPositionMapValue &&) = default ;
