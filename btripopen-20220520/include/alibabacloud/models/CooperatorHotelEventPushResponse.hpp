...
namespace Models
{
  ...
  public:
    ...
    inline const CooperatorHotelEventPushResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CooperatorHotelEventPushResponseBody) };
    inline CooperatorHotelEventPushResponseBody getBody() { DARABONBA_PTR_GET(body_, CooperatorHotelEventPushResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CooperatorHotelEventPushResponseBody> body_ {};
  };
