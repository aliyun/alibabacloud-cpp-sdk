...
#ifndef ALIBABACLOUD_MODELS_COSTCENTERSAVEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_COSTCENTERSAVEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CostCenterSaveRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CostCenterSaveRequest& obj) { 
    ...
    CostCenterSaveRequest() = default ;
    CostCenterSaveRequest(const CostCenterSaveRequest &) = default ;
    CostCenterSaveRequest(CostCenterSaveRequest &&) = default ;
    CostCenterSaveRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CostCenterSaveRequest() = default ;
    CostCenterSaveRequest& operator=(const CostCenterSaveRequest &) = default ;
    CostCenterSaveRequest& operator=(CostCenterSaveRequest &&) = default ;
    ...
    inline CostCenterSaveRequest& setAlipayNo(string alipayNo) { DARABONBA_PTR_SET_VALUE(alipayNo_, alipayNo) };
    ...
    inline CostCenterSaveRequest& setDisable(int64_t disable) { DARABONBA_PTR_SET_VALUE(disable_, disable) };
    ...
    inline CostCenterSaveRequest& setNumber(string number) { DARABONBA_PTR_SET_VALUE(number_, number) };
    ...
    inline CostCenterSaveRequest& setScope(int64_t scope) { DARABONBA_PTR_SET_VALUE(scope_, scope) };
    ...
    inline CostCenterSaveRequest& setThirdpartId(string thirdpartId) { DARABONBA_PTR_SET_VALUE(thirdpartId_, thirdpartId) };
    ...
    inline CostCenterSaveRequest& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
