...
namespace Models
{
  ...
  public:
    ...
    inline const FlightRefundPreCalV2ResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightRefundPreCalV2ResponseBodyModule) };
    inline FlightRefundPreCalV2ResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightRefundPreCalV2ResponseBodyModule) };
    inline FlightRefundPreCalV2ResponseBody& setModule(const FlightRefundPreCalV2ResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightRefundPreCalV2ResponseBody& setModule(FlightRefundPreCalV2ResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<FlightRefundPreCalV2ResponseBodyModule> module_ = nullptr;
    // requestId
