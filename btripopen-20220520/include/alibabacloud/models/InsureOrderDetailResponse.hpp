...
namespace Models
{
  ...
  public:
    ...
    inline const InsureOrderDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InsureOrderDetailResponseBody) };
    inline InsureOrderDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, InsureOrderDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InsureOrderDetailResponseBody> body_ {};
  };
