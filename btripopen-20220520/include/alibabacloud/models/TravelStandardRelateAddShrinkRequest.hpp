...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addListShrink_ == nullptr
    ...
    inline string getAddListShrink() const { DARABONBA_PTR_GET_DEFAULT(addListShrink_, "") };
  ...
  protected:
    shared_ptr<string> addListShrink_ {};
