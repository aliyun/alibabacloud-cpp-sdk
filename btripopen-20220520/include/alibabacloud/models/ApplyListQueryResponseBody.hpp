...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ApplyListQueryResponseBodyModuleList> & moduleList() const { DARABONBA_PTR_GET_CONST(moduleList_, vector<ApplyListQueryResponseBodyModuleList>) };
    inline vector<ApplyListQueryResponseBodyModuleList> moduleList() { DARABONBA_PTR_GET(moduleList_, vector<ApplyListQueryResponseBodyModuleList>) };
    inline ApplyListQueryResponseBody& setModuleList(const vector<ApplyListQueryResponseBodyModuleList> & moduleList) { DARABONBA_PTR_SET_VALUE(moduleList_, moduleList) };
    inline ApplyListQueryResponseBody& setModuleList(vector<ApplyListQueryResponseBodyModuleList> && moduleList) { DARABONBA_PTR_SET_RVALUE(moduleList_, moduleList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ApplyListQueryResponseBodyModuleList>> moduleList_ = nullptr;
