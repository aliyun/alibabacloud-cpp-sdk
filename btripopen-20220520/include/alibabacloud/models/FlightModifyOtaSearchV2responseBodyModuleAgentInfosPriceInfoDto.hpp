...
#ifndef ALIBABACLOUD_MODELS_FLIGHTMODIFYOTASEARCHV2RESPONSEBODYMODULEAGENTINFOSPRICEINFODTO_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTMODIFYOTASEARCHV2RESPONSEBODYMODULEAGENTINFOSPRICEINFODTO_HPP_
...
namespace Models
{
  class FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& obj) { 
    ...
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO() = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO(const FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO &) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO(FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO &&) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO() = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& operator=(const FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO &) = default ;
    FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& operator=(FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO &&) = default ;
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setAdultPrice(int32_t adultPrice) { DARABONBA_PTR_SET_VALUE(adultPrice_, adultPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setAdultTax(int32_t adultTax) { DARABONBA_PTR_SET_VALUE(adultTax_, adultTax) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setAdultTotalPrice(int32_t adultTotalPrice) { DARABONBA_PTR_SET_VALUE(adultTotalPrice_, adultTotalPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setBeforeControlPrice(int32_t beforeControlPrice) { DARABONBA_PTR_SET_VALUE(beforeControlPrice_, beforeControlPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setChildPrice(int32_t childPrice) { DARABONBA_PTR_SET_VALUE(childPrice_, childPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setChildTax(int32_t childTax) { DARABONBA_PTR_SET_VALUE(childTax_, childTax) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setChildTotalPrice(int32_t childTotalPrice) { DARABONBA_PTR_SET_VALUE(childTotalPrice_, childTotalPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setInfantPrice(int32_t infantPrice) { DARABONBA_PTR_SET_VALUE(infantPrice_, infantPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setInfantTax(int32_t infantTax) { DARABONBA_PTR_SET_VALUE(infantTax_, infantTax) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setInfantTotalPrice(int32_t infantTotalPrice) { DARABONBA_PTR_SET_VALUE(infantTotalPrice_, infantTotalPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setOriginalAdultPrice(int32_t originalAdultPrice) { DARABONBA_PTR_SET_VALUE(originalAdultPrice_, originalAdultPrice) };
    ...
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setOriginalAdultTotalPrice(int32_t originalAdultTotalPrice) { DARABONBA_PTR_SET_VALUE(originalAdultTotalPrice_, originalAdultTotalPrice) };
    ...
    inline const Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTOReShopPriceInfoDTO & reShopPriceInfoDTO() const { DARABONBA_PTR_GET_CONST(reShopPriceInfoDTO_, Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTOReShopPriceInfoDTO) };
    inline Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTOReShopPriceInfoDTO reShopPriceInfoDTO() { DARABONBA_PTR_GET(reShopPriceInfoDTO_, Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTOReShopPriceInfoDTO) };
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setReShopPriceInfoDTO(const Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTOReShopPriceInfoDTO & reShopPriceInfoDTO) { DARABONBA_PTR_SET_VALUE(reShopPriceInfoDTO_, reShopPriceInfoDTO) };
    inline FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTO& setReShopPriceInfoDTO(Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTOReShopPriceInfoDTO && reShopPriceInfoDTO) { DARABONBA_PTR_SET_RVALUE(reShopPriceInfoDTO_, reShopPriceInfoDTO) };
  ...
  protected:
    ...
    std::shared_ptr<Models::FlightModifyOtaSearchV2ResponseBodyModuleAgentInfosPriceInfoDTOReShopPriceInfoDTO> reShopPriceInfoDTO_ = nullptr;
  };
