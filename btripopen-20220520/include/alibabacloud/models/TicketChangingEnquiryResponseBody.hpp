...
namespace Models
{
  ...
  public:
    ...
    inline const TicketChangingEnquiryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TicketChangingEnquiryResponseBodyModule) };
    inline TicketChangingEnquiryResponseBodyModule module() { DARABONBA_PTR_GET(module_, TicketChangingEnquiryResponseBodyModule) };
    inline TicketChangingEnquiryResponseBody& setModule(const TicketChangingEnquiryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TicketChangingEnquiryResponseBody& setModule(TicketChangingEnquiryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TicketChangingEnquiryResponseBodyModule> module_ = nullptr;
