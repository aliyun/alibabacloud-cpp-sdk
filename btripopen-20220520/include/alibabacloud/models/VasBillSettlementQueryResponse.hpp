...
namespace Models
{
  ...
  public:
    ...
    inline const VasBillSettlementQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, VasBillSettlementQueryResponseBody) };
    inline VasBillSettlementQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, VasBillSettlementQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<VasBillSettlementQueryResponseBody> body_ {};
  };
