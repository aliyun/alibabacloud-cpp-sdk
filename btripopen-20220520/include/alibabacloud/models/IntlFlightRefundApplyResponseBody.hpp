...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightRefundApplyResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightRefundApplyResponseBodyModule) };
    inline IntlFlightRefundApplyResponseBodyModule module() { DARABONBA_PTR_GET(module_, IntlFlightRefundApplyResponseBodyModule) };
    inline IntlFlightRefundApplyResponseBody& setModule(const IntlFlightRefundApplyResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightRefundApplyResponseBody& setModule(IntlFlightRefundApplyResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IntlFlightRefundApplyResponseBodyModule> module_ = nullptr;
