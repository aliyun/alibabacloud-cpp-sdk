...
#ifndef ALIBABACLOUD_MODELS_TRAINORDERQUERYV2RESPONSEBODYMODULEPASSENGERINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_TRAINORDERQUERYV2RESPONSEBODYMODULEPASSENGERINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TrainOrderQueryV2ResponseBodyModulePassengerInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TrainOrderQueryV2ResponseBodyModulePassengerInfoList& obj) { 
    ...
    TrainOrderQueryV2ResponseBodyModulePassengerInfoList() = default ;
    TrainOrderQueryV2ResponseBodyModulePassengerInfoList(const TrainOrderQueryV2ResponseBodyModulePassengerInfoList &) = default ;
    TrainOrderQueryV2ResponseBodyModulePassengerInfoList(TrainOrderQueryV2ResponseBodyModulePassengerInfoList &&) = default ;
    TrainOrderQueryV2ResponseBodyModulePassengerInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TrainOrderQueryV2ResponseBodyModulePassengerInfoList() = default ;
    TrainOrderQueryV2ResponseBodyModulePassengerInfoList& operator=(const TrainOrderQueryV2ResponseBodyModulePassengerInfoList &) = default ;
    TrainOrderQueryV2ResponseBodyModulePassengerInfoList& operator=(TrainOrderQueryV2ResponseBodyModulePassengerInfoList &&) = default ;
    ...
    inline TrainOrderQueryV2ResponseBodyModulePassengerInfoList& setCostCenterId(int64_t costCenterId) { DARABONBA_PTR_SET_VALUE(costCenterId_, costCenterId) };
    ...
    inline TrainOrderQueryV2ResponseBodyModulePassengerInfoList& setCostCenterName(string costCenterName) { DARABONBA_PTR_SET_VALUE(costCenterName_, costCenterName) };
    ...
    inline TrainOrderQueryV2ResponseBodyModulePassengerInfoList& setCostCenterNumber(string costCenterNumber) { DARABONBA_PTR_SET_VALUE(costCenterNumber_, costCenterNumber) };
    ...
    inline TrainOrderQueryV2ResponseBodyModulePassengerInfoList& setProjectCode(string projectCode) { DARABONBA_PTR_SET_VALUE(projectCode_, projectCode) };
    ...
    inline TrainOrderQueryV2ResponseBodyModulePassengerInfoList& setProjectId(int64_t projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };
    ...
    inline TrainOrderQueryV2ResponseBodyModulePassengerInfoList& setProjectTitle(string projectTitle) { DARABONBA_PTR_SET_VALUE(projectTitle_, projectTitle) };
    ...
    inline TrainOrderQueryV2ResponseBodyModulePassengerInfoList& setThirdpartCostCenterId(string thirdpartCostCenterId) { DARABONBA_PTR_SET_VALUE(thirdpartCostCenterId_, thirdpartCostCenterId) };
    ...
    inline TrainOrderQueryV2ResponseBodyModulePassengerInfoList& setThirdpartProjectId(string thirdpartProjectId) { DARABONBA_PTR_SET_VALUE(thirdpartProjectId_, thirdpartProjectId) };
    ...
    inline TrainOrderQueryV2ResponseBodyModulePassengerInfoList& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline TrainOrderQueryV2ResponseBodyModulePassengerInfoList& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
    ...
    inline TrainOrderQueryV2ResponseBodyModulePassengerInfoList& setUserType(int32_t userType) { DARABONBA_PTR_SET_VALUE(userType_, userType) };
