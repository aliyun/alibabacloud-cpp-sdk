...
#ifndef ALIBABACLOUD_MODELS_TICKETCHANGINGDETAILREQUEST_HPP_
#define ALIBABACLOUD_MODELS_TICKETCHANGINGDETAILREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TicketChangingDetailRequest& obj) { 
      DARABONBA_PTR_TO_JSON(dis_order_id, disOrderId_);
      DARABONBA_PTR_TO_JSON(dis_sub_order_id, disSubOrderId_);
    };
    friend void from_json(const Darabonba::Json& j, TicketChangingDetailRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(dis_order_id, disOrderId_);
      DARABONBA_PTR_FROM_JSON(dis_sub_order_id, disSubOrderId_);
    };
    TicketChangingDetailRequest() = default ;
    TicketChangingDetailRequest(const TicketChangingDetailRequest &) = default ;
    TicketChangingDetailRequest(TicketChangingDetailRequest &&) = default ;
    TicketChangingDetailRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TicketChangingDetailRequest() = default ;
    TicketChangingDetailRequest& operator=(const TicketChangingDetailRequest &) = default ;
    TicketChangingDetailRequest& operator=(TicketChangingDetailRequest &&) = default ;
