...
#ifndef ALIBABACLOUD_MODELS_FUPOINTBILLSETTLEMENTQUERYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_FUPOINTBILLSETTLEMENTQUERYREQUEST_HPP_
...
namespace Models
{
  class FuPointBillSettlementQueryRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const FuPointBillSettlementQueryRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FuPointBillSettlementQueryRequest& obj) { 
    ...
    FuPointBillSettlementQueryRequest() = default ;
    FuPointBillSettlementQueryRequest(const FuPointBillSettlementQueryRequest &) = default ;
    FuPointBillSettlementQueryRequest(FuPointBillSettlementQueryRequest &&) = default ;
    FuPointBillSettlementQueryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FuPointBillSettlementQueryRequest() = default ;
    FuPointBillSettlementQueryRequest& operator=(const FuPointBillSettlementQueryRequest &) = default ;
    FuPointBillSettlementQueryRequest& operator=(FuPointBillSettlementQueryRequest &&) = default ;
    ...
    inline FuPointBillSettlementQueryRequest& setApplyId(string applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline FuPointBillSettlementQueryRequest& setBillBatch(string billBatch) { DARABONBA_PTR_SET_VALUE(billBatch_, billBatch) };
    ...
    inline FuPointBillSettlementQueryRequest& setBillRecordTimeEnd(string billRecordTimeEnd) { DARABONBA_PTR_SET_VALUE(billRecordTimeEnd_, billRecordTimeEnd) };
    ...
    inline FuPointBillSettlementQueryRequest& setBillRecordTimeStart(string billRecordTimeStart) { DARABONBA_PTR_SET_VALUE(billRecordTimeStart_, billRecordTimeStart) };
    ...
    inline FuPointBillSettlementQueryRequest& setCooperatorId(string cooperatorId) { DARABONBA_PTR_SET_VALUE(cooperatorId_, cooperatorId) };
    ...
    inline FuPointBillSettlementQueryRequest& setOrderId(int64_t orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline FuPointBillSettlementQueryRequest& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline FuPointBillSettlementQueryRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline FuPointBillSettlementQueryRequest& setPeriodEnd(string periodEnd) { DARABONBA_PTR_SET_VALUE(periodEnd_, periodEnd) };
    ...
    inline FuPointBillSettlementQueryRequest& setPeriodStart(string periodStart) { DARABONBA_PTR_SET_VALUE(periodStart_, periodStart) };
    ...
    inline FuPointBillSettlementQueryRequest& setScrollId(string scrollId) { DARABONBA_PTR_SET_VALUE(scrollId_, scrollId) };
    ...
    inline FuPointBillSettlementQueryRequest& setScrollMod(bool scrollMod) { DARABONBA_PTR_SET_VALUE(scrollMod_, scrollMod) };
