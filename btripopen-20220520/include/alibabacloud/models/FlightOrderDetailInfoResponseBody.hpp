...
namespace Models
{
  ...
  public:
    ...
    inline const FlightOrderDetailInfoResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightOrderDetailInfoResponseBodyModule) };
    inline FlightOrderDetailInfoResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightOrderDetailInfoResponseBodyModule) };
    inline FlightOrderDetailInfoResponseBody& setModule(const FlightOrderDetailInfoResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightOrderDetailInfoResponseBody& setModule(FlightOrderDetailInfoResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<FlightOrderDetailInfoResponseBodyModule> module_ = nullptr;
