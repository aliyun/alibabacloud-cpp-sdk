...
#ifndef ALIBABACLOUD_MODELS_TRAINNOINFOSEARCHRESPONSEBODYMODULETRAINSTATIONSEARCHVO_HPP_
#define ALIBABACLOUD_MODELS_TRAINNOINFOSEARCHRESPONSEBODYMODULETRAINSTATIONSEARCHVO_HPP_
...
namespace Models
{
  class TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& obj) { 
    ...
    TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO() = default ;
    TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO(const TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO &) = default ;
    TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO(TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO &&) = default ;
    TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO() = default ;
    TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& operator=(const TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO &) = default ;
    TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& operator=(TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO &&) = default ;
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setArrDayTag(string arrDayTag) { DARABONBA_PTR_SET_VALUE(arrDayTag_, arrDayTag) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setArrStationCode(string arrStationCode) { DARABONBA_PTR_SET_VALUE(arrStationCode_, arrStationCode) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setArrStationName(string arrStationName) { DARABONBA_PTR_SET_VALUE(arrStationName_, arrStationName) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setArrTime(string arrTime) { DARABONBA_PTR_SET_VALUE(arrTime_, arrTime) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setCostTime(string costTime) { DARABONBA_PTR_SET_VALUE(costTime_, costTime) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setDepStationCode(string depStationCode) { DARABONBA_PTR_SET_VALUE(depStationCode_, depStationCode) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setDepStationName(string depStationName) { DARABONBA_PTR_SET_VALUE(depStationName_, depStationName) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setDepTime(string depTime) { DARABONBA_PTR_SET_VALUE(depTime_, depTime) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setIsEndStation(int32_t isEndStation) { DARABONBA_PTR_SET_VALUE(isEndStation_, isEndStation) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setIsStartStation(int32_t isStartStation) { DARABONBA_PTR_SET_VALUE(isStartStation_, isStartStation) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setPrice(string price) { DARABONBA_PTR_SET_VALUE(price_, price) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setSaleFlag(string saleFlag) { DARABONBA_PTR_SET_VALUE(saleFlag_, saleFlag) };
    ...
    inline const vector<Models::TrainNoInfoSearchResponseBodyModuleTrainStationSearchVOSeatInfos> & seatInfos() const { DARABONBA_PTR_GET_CONST(seatInfos_, vector<Models::TrainNoInfoSearchResponseBodyModuleTrainStationSearchVOSeatInfos>) };
    inline vector<Models::TrainNoInfoSearchResponseBodyModuleTrainStationSearchVOSeatInfos> seatInfos() { DARABONBA_PTR_GET(seatInfos_, vector<Models::TrainNoInfoSearchResponseBodyModuleTrainStationSearchVOSeatInfos>) };
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setSeatInfos(const vector<Models::TrainNoInfoSearchResponseBodyModuleTrainStationSearchVOSeatInfos> & seatInfos) { DARABONBA_PTR_SET_VALUE(seatInfos_, seatInfos) };
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setSeatInfos(vector<Models::TrainNoInfoSearchResponseBodyModuleTrainStationSearchVOSeatInfos> && seatInfos) { DARABONBA_PTR_SET_RVALUE(seatInfos_, seatInfos) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setTrainNo(string trainNo) { DARABONBA_PTR_SET_VALUE(trainNo_, trainNo) };
    ...
    inline TrainNoInfoSearchResponseBodyModuleTrainStationSearchVO& setTrainType(string trainType) { DARABONBA_PTR_SET_VALUE(trainType_, trainType) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::TrainNoInfoSearchResponseBodyModuleTrainStationSearchVOSeatInfos>> seatInfos_ = nullptr;
