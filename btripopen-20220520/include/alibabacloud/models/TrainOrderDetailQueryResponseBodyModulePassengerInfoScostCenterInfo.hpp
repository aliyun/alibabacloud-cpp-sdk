...
#ifndef ALIBABACLOUD_MODELS_TRAINORDERDETAILQUERYRESPONSEBODYMODULEPASSENGERINFOSCOSTCENTERINFO_HPP_
#define ALIBABACLOUD_MODELS_TRAINORDERDETAILQUERYRESPONSEBODYMODULEPASSENGERINFOSCOSTCENTERINFO_HPP_
...
namespace Models
{
  class TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& obj) { 
    ...
    TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo() = default ;
    TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo(const TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo &) = default ;
    TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo(TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo &&) = default ;
    TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo() = default ;
    TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& operator=(const TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo &) = default ;
    TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& operator=(TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo &&) = default ;
    ...
    inline TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& setCascadeDeptName(string cascadeDeptName) { DARABONBA_PTR_SET_VALUE(cascadeDeptName_, cascadeDeptName) };
    ...
    inline TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& setCostCenterId(string costCenterId) { DARABONBA_PTR_SET_VALUE(costCenterId_, costCenterId) };
    ...
    inline TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& setCostCenterName(string costCenterName) { DARABONBA_PTR_SET_VALUE(costCenterName_, costCenterName) };
    ...
    inline TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& setCostCenterNo(string costCenterNo) { DARABONBA_PTR_SET_VALUE(costCenterNo_, costCenterNo) };
    ...
    inline TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& setDepartId(string departId) { DARABONBA_PTR_SET_VALUE(departId_, departId) };
    ...
    inline TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& setDepartName(string departName) { DARABONBA_PTR_SET_VALUE(departName_, departName) };
    ...
    inline TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& setInvoiceId(string invoiceId) { DARABONBA_PTR_SET_VALUE(invoiceId_, invoiceId) };
    ...
    inline TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& setInvoiceTitle(string invoiceTitle) { DARABONBA_PTR_SET_VALUE(invoiceTitle_, invoiceTitle) };
    ...
    inline TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& setPassengerId(string passengerId) { DARABONBA_PTR_SET_VALUE(passengerId_, passengerId) };
    ...
    inline TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& setProjectCode(string projectCode) { DARABONBA_PTR_SET_VALUE(projectCode_, projectCode) };
    ...
    inline TrainOrderDetailQueryResponseBodyModulePassengerInfoSCostCenterInfo& setProjectTitle(string projectTitle) { DARABONBA_PTR_SET_VALUE(projectTitle_, projectTitle) };
