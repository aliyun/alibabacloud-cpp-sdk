...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, ApplyQueryResponseBodyModule) };
    inline ApplyQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, ApplyQueryResponseBodyModule) };
    inline ApplyQueryResponseBody& setModule(const ApplyQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline ApplyQueryResponseBody& setModule(ApplyQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<ApplyQueryResponseBodyModule> module_ = nullptr;
