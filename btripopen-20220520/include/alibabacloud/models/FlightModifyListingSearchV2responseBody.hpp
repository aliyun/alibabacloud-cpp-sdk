...
namespace Models
{
  ...
  public:
    ...
    inline const FlightModifyListingSearchV2ResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightModifyListingSearchV2ResponseBodyModule) };
    inline FlightModifyListingSearchV2ResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightModifyListingSearchV2ResponseBodyModule) };
    inline FlightModifyListingSearchV2ResponseBody& setModule(const FlightModifyListingSearchV2ResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightModifyListingSearchV2ResponseBody& setModule(FlightModifyListingSearchV2ResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<FlightModifyListingSearchV2ResponseBodyModule> module_ = nullptr;
    // requestId
