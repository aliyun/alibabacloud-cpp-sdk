...
namespace Models
{
  ...
  public:
    ...
    inline const HotelStaticInfoResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelStaticInfoResponseBodyModule) };
    inline HotelStaticInfoResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelStaticInfoResponseBodyModule) };
    inline HotelStaticInfoResponseBody& setModule(const HotelStaticInfoResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelStaticInfoResponseBody& setModule(HotelStaticInfoResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<HotelStaticInfoResponseBodyModule> module_ = nullptr;
