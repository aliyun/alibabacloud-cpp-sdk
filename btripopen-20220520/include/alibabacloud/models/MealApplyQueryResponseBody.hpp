...
namespace Models
{
  ...
  public:
    ...
    inline const MealApplyQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, MealApplyQueryResponseBodyModule) };
    inline MealApplyQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, MealApplyQueryResponseBodyModule) };
    inline MealApplyQueryResponseBody& setModule(const MealApplyQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline MealApplyQueryResponseBody& setModule(MealApplyQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<MealApplyQueryResponseBodyModule> module_ = nullptr;
