...
namespace Models
{
  ...
  public:
    ...
    inline const HotelOrderInfoQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelOrderInfoQueryResponseBodyModule) };
    inline HotelOrderInfoQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelOrderInfoQueryResponseBodyModule) };
    inline HotelOrderInfoQueryResponseBody& setModule(const HotelOrderInfoQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelOrderInfoQueryResponseBody& setModule(HotelOrderInfoQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelOrderInfoQueryResponseBodyModule> module_ = nullptr;
