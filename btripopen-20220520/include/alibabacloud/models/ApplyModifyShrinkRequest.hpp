...
#ifndef ALIBABACLOUD_MODELS_APPLYMODIFYSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_APPLYMODIFYSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ApplyModifyShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ApplyModifyShrinkRequest& obj) { 
    ...
    ApplyModifyShrinkRequest() = default ;
    ApplyModifyShrinkRequest(const ApplyModifyShrinkRequest &) = default ;
    ApplyModifyShrinkRequest(ApplyModifyShrinkRequest &&) = default ;
    ApplyModifyShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ApplyModifyShrinkRequest() = default ;
    ApplyModifyShrinkRequest& operator=(const ApplyModifyShrinkRequest &) = default ;
    ApplyModifyShrinkRequest& operator=(ApplyModifyShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->budget_ == nullptr
        ...
        && this->hotelBudget_ == nullptr && this->hotelShareShrink_ == nullptr && this->intlFlightBudget_ == nullptr && this->intlHotelBudget_ == nullptr && this->itineraryListShrink_ == nullptr
        && this->itineraryRule_ == nullptr && this->itinerarySetListShrink_ == nullptr && this->limitTraveler_ == nullptr && this->mealBudget_ == nullptr && this->paymentDepartmentId_ == nullptr
        ...
        && this->thirdpartDepartId_ == nullptr && this->togetherBookRule_ == nullptr && this->trainBudget_ == nullptr && this->travelerListShrink_ == nullptr && this->travelerStandardShrink_ == nullptr
    ...
    inline ApplyModifyShrinkRequest& setBudget(int64_t budget) { DARABONBA_PTR_SET_VALUE(budget_, budget) };
    ...
    inline ApplyModifyShrinkRequest& setBudgetMerge(int32_t budgetMerge) { DARABONBA_PTR_SET_VALUE(budgetMerge_, budgetMerge) };
    ...
    inline string getCarRuleShrink() const { DARABONBA_PTR_GET_DEFAULT(carRuleShrink_, "") };
    inline ApplyModifyShrinkRequest& setCarRuleShrink(string carRuleShrink) { DARABONBA_PTR_SET_VALUE(carRuleShrink_, carRuleShrink) };
    ...
    inline ApplyModifyShrinkRequest& setCorpName(string corpName) { DARABONBA_PTR_SET_VALUE(corpName_, corpName) };
    ...
    inline string getDefaultStandardShrink() const { DARABONBA_PTR_GET_DEFAULT(defaultStandardShrink_, "") };
    inline ApplyModifyShrinkRequest& setDefaultStandardShrink(string defaultStandardShrink) { DARABONBA_PTR_SET_VALUE(defaultStandardShrink_, defaultStandardShrink) };
    ...
    inline ApplyModifyShrinkRequest& setDepartId(string departId) { DARABONBA_PTR_SET_VALUE(departId_, departId) };
    ...
    inline ApplyModifyShrinkRequest& setDepartName(string departName) { DARABONBA_PTR_SET_VALUE(departName_, departName) };
    ...
    inline ApplyModifyShrinkRequest& setExtendField(string extendField) { DARABONBA_PTR_SET_VALUE(extendField_, extendField) };
    ...
    inline string getExternalTravelerListShrink() const { DARABONBA_PTR_GET_DEFAULT(externalTravelerListShrink_, "") };
    inline ApplyModifyShrinkRequest& setExternalTravelerListShrink(string externalTravelerListShrink) { DARABONBA_PTR_SET_VALUE(externalTravelerListShrink_, externalTravelerListShrink) };
    ...
    inline string getExternalTravelerStandardShrink() const { DARABONBA_PTR_GET_DEFAULT(externalTravelerStandardShrink_, "") };
    inline ApplyModifyShrinkRequest& setExternalTravelerStandardShrink(string externalTravelerStandardShrink) { DARABONBA_PTR_SET_VALUE(externalTravelerStandardShrink_, externalTravelerStandardShrink) };
    ...
    inline ApplyModifyShrinkRequest& setFlightBudget(int64_t flightBudget) { DARABONBA_PTR_SET_VALUE(flightBudget_, flightBudget) };
    ...
    inline ApplyModifyShrinkRequest& setHotelBudget(int64_t hotelBudget) { DARABONBA_PTR_SET_VALUE(hotelBudget_, hotelBudget) };
    ...
    inline string getHotelShareShrink() const { DARABONBA_PTR_GET_DEFAULT(hotelShareShrink_, "") };
    inline ApplyModifyShrinkRequest& setHotelShareShrink(string hotelShareShrink) { DARABONBA_PTR_SET_VALUE(hotelShareShrink_, hotelShareShrink) };
    ...
    inline ApplyModifyShrinkRequest& setIntlFlightBudget(int64_t intlFlightBudget) { DARABONBA_PTR_SET_VALUE(intlFlightBudget_, intlFlightBudget) };
    ...
    inline ApplyModifyShrinkRequest& setIntlHotelBudget(int64_t intlHotelBudget) { DARABONBA_PTR_SET_VALUE(intlHotelBudget_, intlHotelBudget) };
    ...
    inline ApplyModifyShrinkRequest& setItineraryListShrink(string itineraryListShrink) { DARABONBA_PTR_SET_VALUE(itineraryListShrink_, itineraryListShrink) };
    ...
    inline ApplyModifyShrinkRequest& setItineraryRule(int32_t itineraryRule) { DARABONBA_PTR_SET_VALUE(itineraryRule_, itineraryRule) };
    ...
    inline string getItinerarySetListShrink() const { DARABONBA_PTR_GET_DEFAULT(itinerarySetListShrink_, "") };
    inline ApplyModifyShrinkRequest& setItinerarySetListShrink(string itinerarySetListShrink) { DARABONBA_PTR_SET_VALUE(itinerarySetListShrink_, itinerarySetListShrink) };
    ...
    inline ApplyModifyShrinkRequest& setLimitTraveler(int32_t limitTraveler) { DARABONBA_PTR_SET_VALUE(limitTraveler_, limitTraveler) };
    ...
    inline ApplyModifyShrinkRequest& setMealBudget(int64_t mealBudget) { DARABONBA_PTR_SET_VALUE(mealBudget_, mealBudget) };
    ...
    inline ApplyModifyShrinkRequest& setPaymentDepartmentId(string paymentDepartmentId) { DARABONBA_PTR_SET_VALUE(paymentDepartmentId_, paymentDepartmentId) };
    ...
    inline ApplyModifyShrinkRequest& setPaymentDepartmentName(string paymentDepartmentName) { DARABONBA_PTR_SET_VALUE(paymentDepartmentName_, paymentDepartmentName) };
    ...
    inline ApplyModifyShrinkRequest& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ApplyModifyShrinkRequest& setSubCorpId(string subCorpId) { DARABONBA_PTR_SET_VALUE(subCorpId_, subCorpId) };
    ...
    inline ApplyModifyShrinkRequest& setThirdpartApplyId(string thirdpartApplyId) { DARABONBA_PTR_SET_VALUE(thirdpartApplyId_, thirdpartApplyId) };
    ...
    inline ApplyModifyShrinkRequest& setThirdpartBusinessId(string thirdpartBusinessId) { DARABONBA_PTR_SET_VALUE(thirdpartBusinessId_, thirdpartBusinessId) };
    ...
    inline ApplyModifyShrinkRequest& setThirdpartDepartId(string thirdpartDepartId) { DARABONBA_PTR_SET_VALUE(thirdpartDepartId_, thirdpartDepartId) };
    ...
    inline ApplyModifyShrinkRequest& setTogetherBookRule(int32_t togetherBookRule) { DARABONBA_PTR_SET_VALUE(togetherBookRule_, togetherBookRule) };
    ...
    inline ApplyModifyShrinkRequest& setTrainBudget(int64_t trainBudget) { DARABONBA_PTR_SET_VALUE(trainBudget_, trainBudget) };
    ...
    inline string getTravelerListShrink() const { DARABONBA_PTR_GET_DEFAULT(travelerListShrink_, "") };
    inline ApplyModifyShrinkRequest& setTravelerListShrink(string travelerListShrink) { DARABONBA_PTR_SET_VALUE(travelerListShrink_, travelerListShrink) };
    ...
    inline ApplyModifyShrinkRequest& setTravelerStandardShrink(string travelerStandardShrink) { DARABONBA_PTR_SET_VALUE(travelerStandardShrink_, travelerStandardShrink) };
    ...
    inline ApplyModifyShrinkRequest& setTripCause(string tripCause) { DARABONBA_PTR_SET_VALUE(tripCause_, tripCause) };
    ...
    inline ApplyModifyShrinkRequest& setTripDay(int32_t tripDay) { DARABONBA_PTR_SET_VALUE(tripDay_, tripDay) };
    ...
    inline ApplyModifyShrinkRequest& setTripTitle(string tripTitle) { DARABONBA_PTR_SET_VALUE(tripTitle_, tripTitle) };
    ...
    inline ApplyModifyShrinkRequest& setUnionNo(string unionNo) { DARABONBA_PTR_SET_VALUE(unionNo_, unionNo) };
    ...
    inline ApplyModifyShrinkRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline ApplyModifyShrinkRequest& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
    ...
    inline ApplyModifyShrinkRequest& setVehicleBudget(int64_t vehicleBudget) { DARABONBA_PTR_SET_VALUE(vehicleBudget_, vehicleBudget) };


  protected:
    shared_ptr<int64_t> budget_ {};
    shared_ptr<int32_t> budgetMerge_ {};
    shared_ptr<string> carRuleShrink_ {};
    ...
    shared_ptr<string> hotelShareShrink_ {};
    ...
    shared_ptr<string> itinerarySetListShrink_ {};
    ...
    shared_ptr<string> travelerListShrink_ {};
