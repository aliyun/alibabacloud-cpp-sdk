...
#ifndef ALIBABACLOUD_MODELS_APPLYADDREQUESTEXTERNALTRAVELERLIST_HPP_
#define ALIBABACLOUD_MODELS_APPLYADDREQUESTEXTERNALTRAVELERLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ApplyAddRequestExternalTravelerList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ApplyAddRequestExternalTravelerList& obj) { 
    ...
    ApplyAddRequestExternalTravelerList() = default ;
    ApplyAddRequestExternalTravelerList(const ApplyAddRequestExternalTravelerList &) = default ;
    ApplyAddRequestExternalTravelerList(ApplyAddRequestExternalTravelerList &&) = default ;
    ApplyAddRequestExternalTravelerList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ApplyAddRequestExternalTravelerList() = default ;
    ApplyAddRequestExternalTravelerList& operator=(const ApplyAddRequestExternalTravelerList &) = default ;
    ApplyAddRequestExternalTravelerList& operator=(ApplyAddRequestExternalTravelerList &&) = default ;
    ...
    inline ApplyAddRequestExternalTravelerList& setAttribute(string attribute) { DARABONBA_PTR_SET_VALUE(attribute_, attribute) };
    ...
    inline ApplyAddRequestExternalTravelerList& setCostCenterId(int64_t costCenterId) { DARABONBA_PTR_SET_VALUE(costCenterId_, costCenterId) };
    ...
    inline ApplyAddRequestExternalTravelerList& setExternalUserId(string externalUserId) { DARABONBA_PTR_SET_VALUE(externalUserId_, externalUserId) };
    ...
    inline ApplyAddRequestExternalTravelerList& setInvoiceId(int64_t invoiceId) { DARABONBA_PTR_SET_VALUE(invoiceId_, invoiceId) };
    ...
    inline ApplyAddRequestExternalTravelerList& setPaymentDepartmentId(string paymentDepartmentId) { DARABONBA_PTR_SET_VALUE(paymentDepartmentId_, paymentDepartmentId) };
    ...
    inline ApplyAddRequestExternalTravelerList& setPaymentDepartmentName(string paymentDepartmentName) { DARABONBA_PTR_SET_VALUE(paymentDepartmentName_, paymentDepartmentName) };
    ...
    inline ApplyAddRequestExternalTravelerList& setProjectCode(string projectCode) { DARABONBA_PTR_SET_VALUE(projectCode_, projectCode) };
    ...
    inline ApplyAddRequestExternalTravelerList& setProjectTitle(string projectTitle) { DARABONBA_PTR_SET_VALUE(projectTitle_, projectTitle) };
    ...
    inline ApplyAddRequestExternalTravelerList& setThirdPartInvoiceId(string thirdPartInvoiceId) { DARABONBA_PTR_SET_VALUE(thirdPartInvoiceId_, thirdPartInvoiceId) };
    ...
    inline ApplyAddRequestExternalTravelerList& setThirdpartCostCenterId(string thirdpartCostCenterId) { DARABONBA_PTR_SET_VALUE(thirdpartCostCenterId_, thirdpartCostCenterId) };
    ...
    inline ApplyAddRequestExternalTravelerList& setThirdpartDepartId(string thirdpartDepartId) { DARABONBA_PTR_SET_VALUE(thirdpartDepartId_, thirdpartDepartId) };
    ...
    inline ApplyAddRequestExternalTravelerList& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
    ...
    inline ApplyAddRequestExternalTravelerList& setUserNameEn(string userNameEn) { DARABONBA_PTR_SET_VALUE(userNameEn_, userNameEn) };
