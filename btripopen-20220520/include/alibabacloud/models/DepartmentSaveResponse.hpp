...
namespace Models
{
  ...
  public:
    ...
    inline const DepartmentSaveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DepartmentSaveResponseBody) };
    inline DepartmentSaveResponseBody getBody() { DARABONBA_PTR_GET(body_, DepartmentSaveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DepartmentSaveResponseBody> body_ {};
  };
