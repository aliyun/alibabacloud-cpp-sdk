...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->mostPrice_ == nullptr && this->negotiationCouponFee_ == nullptr && this->offlineStatus_ == nullptr && this->oilFee_ == nullptr && this->orderId_ == nullptr
        ...
        && this->refundReasonCode_ == nullptr && this->refundResult_ == nullptr && this->refundUpgradeCost_ == nullptr && this->remark_ == nullptr && this->repeatRefund_ == nullptr
        && this->sceneId_ == nullptr && this->sceneName_ == nullptr && this->sealPrice_ == nullptr && this->segmentList_ == nullptr && this->serviceFee_ == nullptr
        ...
        && this->sio_ == nullptr && this->status_ == nullptr && this->statusDesc_ == nullptr && this->taxRate_ == nullptr && this->thirdItineraryId_ == nullptr
        && this->ticketId_ == nullptr && this->trade_ == nullptr && this->tradeActionDesc_ == nullptr && this->travelerEmail_ == nullptr && this->travelerId_ == nullptr
        ...
        inline DataList& setAlipayId(string alipayId) { DARABONBA_PTR_SET_VALUE(alipayId_, alipayId) };
        ...
        inline DataList& setBeforeTicketNo(string beforeTicketNo) { DARABONBA_PTR_SET_VALUE(beforeTicketNo_, beforeTicketNo) };
        ...
        inline DataList& setBuildFee(double buildFee) { DARABONBA_PTR_SET_VALUE(buildFee_, buildFee) };
        ...
        inline DataList& setCabinClassCode(string cabinClassCode) { DARABONBA_PTR_SET_VALUE(cabinClassCode_, cabinClassCode) };
        ...
        inline string getChangeReasonCode() const { DARABONBA_PTR_GET_DEFAULT(changeReasonCode_, "") };
        inline DataList& setChangeReasonCode(string changeReasonCode) { DARABONBA_PTR_SET_VALUE(changeReasonCode_, changeReasonCode) };
        ...
        inline DataList& setCorpSettlePrice(double corpSettlePrice) { DARABONBA_PTR_SET_VALUE(corpSettlePrice_, corpSettlePrice) };
        ...
        inline DataList& setFlightTripType(string flightTripType) { DARABONBA_PTR_SET_VALUE(flightTripType_, flightTripType) };
        ...
        inline DataList& setItemType(string itemType) { DARABONBA_PTR_SET_VALUE(itemType_, itemType) };
        ...
        inline DataList& setItineraryNum(string itineraryNum) { DARABONBA_PTR_SET_VALUE(itineraryNum_, itineraryNum) };
        ...
        inline DataList& setItineraryPrice(double itineraryPrice) { DARABONBA_PTR_SET_VALUE(itineraryPrice_, itineraryPrice) };
        ...
        inline string getMileage() const { DARABONBA_PTR_GET_DEFAULT(mileage_, "") };
        inline DataList& setMileage(string mileage) { DARABONBA_PTR_SET_VALUE(mileage_, mileage) };
        ...
        inline string getOfflineStatus() const { DARABONBA_PTR_GET_DEFAULT(offlineStatus_, "") };
        inline DataList& setOfflineStatus(string offlineStatus) { DARABONBA_PTR_SET_VALUE(offlineStatus_, offlineStatus) };
        ...
        inline DataList& setOilFee(double oilFee) { DARABONBA_PTR_SET_VALUE(oilFee_, oilFee) };
        ...
        inline DataList& setPreBookTip(string preBookTip) { DARABONBA_PTR_SET_VALUE(preBookTip_, preBookTip) };
        ...
        inline DataList& setRefundReasonCode(string refundReasonCode) { DARABONBA_PTR_SET_VALUE(refundReasonCode_, refundReasonCode) };
        ...
        inline DataList& setRefundUpgradeCost(double refundUpgradeCost) { DARABONBA_PTR_SET_VALUE(refundUpgradeCost_, refundUpgradeCost) };
        ...
        inline DataList& setUpgradeCost(double upgradeCost) { DARABONBA_PTR_SET_VALUE(upgradeCost_, upgradeCost) };
      ...
      protected:
        ...
        shared_ptr<string> changeReasonCode_ {};
        ...
        shared_ptr<string> offlineStatus_ {};
    ...
    inline const FlightBillSettlementQueryResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, FlightBillSettlementQueryResponseBody::Module) };
    inline FlightBillSettlementQueryResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, FlightBillSettlementQueryResponseBody::Module) };
    inline FlightBillSettlementQueryResponseBody& setModule(const FlightBillSettlementQueryResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightBillSettlementQueryResponseBody& setModule(FlightBillSettlementQueryResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    shared_ptr<FlightBillSettlementQueryResponseBody::Module> module_ {};
