...
#ifndef ALIBABACLOUD_MODELS_FLIGHTMODIFYOTASEARCHV2REQUESTSELECTEDSEGMENTS_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTMODIFYOTASEARCHV2REQUESTSELECTEDSEGMENTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightModifyOtaSearchV2RequestSelectedSegments& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightModifyOtaSearchV2RequestSelectedSegments& obj) { 
    ...
    FlightModifyOtaSearchV2RequestSelectedSegments() = default ;
    FlightModifyOtaSearchV2RequestSelectedSegments(const FlightModifyOtaSearchV2RequestSelectedSegments &) = default ;
    FlightModifyOtaSearchV2RequestSelectedSegments(FlightModifyOtaSearchV2RequestSelectedSegments &&) = default ;
    FlightModifyOtaSearchV2RequestSelectedSegments(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightModifyOtaSearchV2RequestSelectedSegments() = default ;
    FlightModifyOtaSearchV2RequestSelectedSegments& operator=(const FlightModifyOtaSearchV2RequestSelectedSegments &) = default ;
    FlightModifyOtaSearchV2RequestSelectedSegments& operator=(FlightModifyOtaSearchV2RequestSelectedSegments &&) = default ;
    ...
    inline FlightModifyOtaSearchV2RequestSelectedSegments& setArrCityCode(string arrCityCode) { DARABONBA_PTR_SET_VALUE(arrCityCode_, arrCityCode) };
    ...
    inline FlightModifyOtaSearchV2RequestSelectedSegments& setDepCityCode(string depCityCode) { DARABONBA_PTR_SET_VALUE(depCityCode_, depCityCode) };
    ...
    inline FlightModifyOtaSearchV2RequestSelectedSegments& setDepDateTime(string depDateTime) { DARABONBA_PTR_SET_VALUE(depDateTime_, depDateTime) };
    ...
    inline FlightModifyOtaSearchV2RequestSelectedSegments& setJourneySeq(int32_t journeySeq) { DARABONBA_PTR_SET_VALUE(journeySeq_, journeySeq) };
    ...
    inline FlightModifyOtaSearchV2RequestSelectedSegments& setMarketingFlightNo(string marketingFlightNo) { DARABONBA_PTR_SET_VALUE(marketingFlightNo_, marketingFlightNo) };
    ...
    inline FlightModifyOtaSearchV2RequestSelectedSegments& setOperatingFlightNo(string operatingFlightNo) { DARABONBA_PTR_SET_VALUE(operatingFlightNo_, operatingFlightNo) };
    ...
    inline FlightModifyOtaSearchV2RequestSelectedSegments& setSegmentSeq(int32_t segmentSeq) { DARABONBA_PTR_SET_VALUE(segmentSeq_, segmentSeq) };
