...
namespace Models
{
  ...
  public:
    ...
    inline const FlightCreateOrderResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightCreateOrderResponseBodyModule) };
    inline FlightCreateOrderResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightCreateOrderResponseBodyModule) };
    inline FlightCreateOrderResponseBody& setModule(const FlightCreateOrderResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightCreateOrderResponseBody& setModule(FlightCreateOrderResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<FlightCreateOrderResponseBodyModule> module_ = nullptr;
