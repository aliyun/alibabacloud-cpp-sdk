...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applyId_ == nullptr
        && this->billBatch_ == nullptr && this->billRecordTimeEnd_ == nullptr && this->billRecordTimeStart_ == nullptr && this->category_ == nullptr && this->orderId_ == nullptr
    ...
    inline IeHotelBillSettlementQueryRequest& setApplyId(string applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
