...
namespace Models
{
  ...
  public:
    ...
    inline const FlightModifyApplyV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FlightModifyApplyV2ResponseBody) };
    inline FlightModifyApplyV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, FlightModifyApplyV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FlightModifyApplyV2ResponseBody> body_ {};
  };
