...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->outerCorpId_ == nullptr
    ...
    inline string getOuterCorpId() const { DARABONBA_PTR_GET_DEFAULT(outerCorpId_, "") };
    ...
    inline string getOuterCorpName() const { DARABONBA_PTR_GET_DEFAULT(outerCorpName_, "") };
  ...
  protected:
    ...
    shared_ptr<string> outerCorpId_ {};
    // This parameter is required.
    shared_ptr<string> outerCorpName_ {};
    // This parameter is required.
