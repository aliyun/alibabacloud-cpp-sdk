...
namespace Models
{
  ...
  public:
    ...
    inline const vector<TrainStopoverSearchResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<TrainStopoverSearchResponseBodyModule>) };
    inline vector<TrainStopoverSearchResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<TrainStopoverSearchResponseBodyModule>) };
    inline TrainStopoverSearchResponseBody& setModule(const vector<TrainStopoverSearchResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainStopoverSearchResponseBody& setModule(vector<TrainStopoverSearchResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<vector<TrainStopoverSearchResponseBodyModule>> module_ = nullptr;
