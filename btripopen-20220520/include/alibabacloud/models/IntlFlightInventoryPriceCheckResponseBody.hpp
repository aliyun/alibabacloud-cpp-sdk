...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightInventoryPriceCheckResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightInventoryPriceCheckResponseBodyModule) };
    inline IntlFlightInventoryPriceCheckResponseBodyModule module() { DARABONBA_PTR_GET(module_, IntlFlightInventoryPriceCheckResponseBodyModule) };
    inline IntlFlightInventoryPriceCheckResponseBody& setModule(const IntlFlightInventoryPriceCheckResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightInventoryPriceCheckResponseBody& setModule(IntlFlightInventoryPriceCheckResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IntlFlightInventoryPriceCheckResponseBodyModule> module_ = nullptr;
