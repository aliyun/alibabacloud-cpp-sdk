...
#ifndef ALIBABACLOUD_MODELS_EXCEEDAPPLYSYNCREQUEST_HPP_
#define ALIBABACLOUD_MODELS_EXCEEDAPPLYSYNCREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ExceedApplySyncRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ExceedApplySyncRequest& obj) { 
    ...
    ExceedApplySyncRequest() = default ;
    ExceedApplySyncRequest(const ExceedApplySyncRequest &) = default ;
    ExceedApplySyncRequest(ExceedApplySyncRequest &&) = default ;
    ExceedApplySyncRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ExceedApplySyncRequest() = default ;
    ExceedApplySyncRequest& operator=(const ExceedApplySyncRequest &) = default ;
    ExceedApplySyncRequest& operator=(ExceedApplySyncRequest &&) = default ;
