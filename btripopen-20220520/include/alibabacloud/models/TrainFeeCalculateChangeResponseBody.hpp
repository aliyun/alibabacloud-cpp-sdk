...
namespace Models
{
  ...
  public:
    ...
    inline const TrainFeeCalculateChangeResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TrainFeeCalculateChangeResponseBodyModule) };
    inline TrainFeeCalculateChangeResponseBodyModule module() { DARABONBA_PTR_GET(module_, TrainFeeCalculateChangeResponseBodyModule) };
    inline TrainFeeCalculateChangeResponseBody& setModule(const TrainFeeCalculateChangeResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainFeeCalculateChangeResponseBody& setModule(TrainFeeCalculateChangeResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<TrainFeeCalculateChangeResponseBodyModule> module_ = nullptr;
