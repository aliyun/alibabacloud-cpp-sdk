...
namespace Models
{
  ...
  public:
    ...
    inline const TravelStandardQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TravelStandardQueryResponseBody) };
    inline TravelStandardQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, TravelStandardQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TravelStandardQueryResponseBody> body_ {};
  };
