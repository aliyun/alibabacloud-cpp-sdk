...
#ifndef ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTBESTPRICEITEMSHOPPINGITEMMAPVALUECABINQUANTITYVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTBESTPRICEITEMSHOPPINGITEMMAPVALUECABINQUANTITYVALUE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& obj) { 
    ...
    ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue() = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue(const ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue &) = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue(ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue &&) = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue() = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& operator=(const ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue &) = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& operator=(ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue &&) = default ;
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setCabinClassName(string cabinClassName) { DARABONBA_PTR_SET_VALUE(cabinClassName_, cabinClassName) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setCabinClassMemo(string cabinClassMemo) { DARABONBA_PTR_SET_VALUE(cabinClassMemo_, cabinClassMemo) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setSpecification(string specification) { DARABONBA_PTR_SET_VALUE(specification_, specification) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setQuantity(string quantity) { DARABONBA_PTR_SET_VALUE(quantity_, quantity) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setLinkCabins(const vector<string> & linkCabins) { DARABONBA_PTR_SET_VALUE(linkCabins_, linkCabins) };
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setLinkCabins(vector<string> && linkCabins) { DARABONBA_PTR_SET_RVALUE(linkCabins_, linkCabins) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setReshopChangeCabin(bool reshopChangeCabin) { DARABONBA_PTR_SET_VALUE(reshopChangeCabin_, reshopChangeCabin) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setChildCabinType(int32_t childCabinType) { DARABONBA_PTR_SET_VALUE(childCabinType_, childCabinType) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setInfantBasicCabin(string infantBasicCabin) { DARABONBA_PTR_SET_VALUE(infantBasicCabin_, infantBasicCabin) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue& setInnerCabinClass(int32_t innerCabinClass) { DARABONBA_PTR_SET_VALUE(innerCabinClass_, innerCabinClass) };
