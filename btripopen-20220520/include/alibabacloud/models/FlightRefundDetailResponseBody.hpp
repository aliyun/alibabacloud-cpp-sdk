...
namespace Models
{
  ...
  public:
    ...
    inline const FlightRefundDetailResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightRefundDetailResponseBodyModule) };
    inline FlightRefundDetailResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightRefundDetailResponseBodyModule) };
    inline FlightRefundDetailResponseBody& setModule(const FlightRefundDetailResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightRefundDetailResponseBody& setModule(FlightRefundDetailResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<FlightRefundDetailResponseBodyModule> module_ = nullptr;
