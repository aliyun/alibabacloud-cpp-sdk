...
#ifndef ALIBABACLOUD_MODELS_MODULEITEMLISTSUBITEMSSHOPPINGITEMMAPVALUESEGMENTPRICEVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULEITEMLISTSUBITEMSSHOPPINGITEMMAPVALUESEGMENTPRICEVALUE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& obj) { 
    ...
    ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue() = default ;
    ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue(const ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue &) = default ;
    ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue(ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue &&) = default ;
    ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue() = default ;
    ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& operator=(const ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue &) = default ;
    ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& operator=(ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue &&) = default ;
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setFloorPrice(int32_t floorPrice) { DARABONBA_PTR_SET_VALUE(floorPrice_, floorPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setTicketPrice(int32_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setSellPrice(int32_t sellPrice) { DARABONBA_PTR_SET_VALUE(sellPrice_, sellPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setOriginalSellPrice(int32_t originalSellPrice) { DARABONBA_PTR_SET_VALUE(originalSellPrice_, originalSellPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setBaseTotalPrice(int32_t baseTotalPrice) { DARABONBA_PTR_SET_VALUE(baseTotalPrice_, baseTotalPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setBeforeControlPrice(int32_t beforeControlPrice) { DARABONBA_PTR_SET_VALUE(beforeControlPrice_, beforeControlPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setTax(int32_t tax) { DARABONBA_PTR_SET_VALUE(tax_, tax) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setSupplyPrice(int32_t supplyPrice) { DARABONBA_PTR_SET_VALUE(supplyPrice_, supplyPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setBasicCabinPrice(int32_t basicCabinPrice) { DARABONBA_PTR_SET_VALUE(basicCabinPrice_, basicCabinPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setBuildPrice(int32_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setOilPrice(int32_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setFirstStandardPrice(int32_t firstStandardPrice) { DARABONBA_PTR_SET_VALUE(firstStandardPrice_, firstStandardPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setBusinessStandardPrice(int32_t businessStandardPrice) { DARABONBA_PTR_SET_VALUE(businessStandardPrice_, businessStandardPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setCommonStandardPrice(int32_t commonStandardPrice) { DARABONBA_PTR_SET_VALUE(commonStandardPrice_, commonStandardPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setInterTicketPrice(int32_t interTicketPrice) { DARABONBA_PTR_SET_VALUE(interTicketPrice_, interTicketPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setSubtractedPrice(int32_t subtractedPrice) { DARABONBA_PTR_SET_VALUE(subtractedPrice_, subtractedPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setOriginCommonPrice(int32_t originCommonPrice) { DARABONBA_PTR_SET_VALUE(originCommonPrice_, originCommonPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setDynamicPromotionPrice(int32_t dynamicPromotionPrice) { DARABONBA_PTR_SET_VALUE(dynamicPromotionPrice_, dynamicPromotionPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setInstallmentNum(int32_t installmentNum) { DARABONBA_PTR_SET_VALUE(installmentNum_, installmentNum) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setInstallmentPrice(double installmentPrice) { DARABONBA_PTR_SET_VALUE(installmentPrice_, installmentPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setCompetitionDynamicPrice(int32_t competitionDynamicPrice) { DARABONBA_PTR_SET_VALUE(competitionDynamicPrice_, competitionDynamicPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setCompetitionPromotionPrice(int32_t competitionPromotionPrice) { DARABONBA_PTR_SET_VALUE(competitionPromotionPrice_, competitionPromotionPrice) };
    ...
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setMinBeforeControlPriceOfNormal(int32_t minBeforeControlPriceOfNormal) { DARABONBA_PTR_SET_VALUE(minBeforeControlPriceOfNormal_, minBeforeControlPriceOfNormal) };
    ...
    inline const ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo & getPriceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo) };
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo getPriceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo) };
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(const ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    shared_ptr<ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue::PriceShowInfo> priceShowInfo_ {};
  };
