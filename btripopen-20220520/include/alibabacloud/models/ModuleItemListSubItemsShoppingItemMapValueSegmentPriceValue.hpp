...
namespace Models
{
  ...
  public:
    ...
    inline const ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValuePriceShowInfo & priceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValuePriceShowInfo) };
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValuePriceShowInfo priceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValuePriceShowInfo) };
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(const ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValuePriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValuePriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValuePriceShowInfo> priceShowInfo_ = nullptr;
  };
