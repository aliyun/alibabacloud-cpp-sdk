...
#ifndef ALIBABACLOUD_MODELS_INTLFLIGHTRESHOPLISTSEARCHSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_INTLFLIGHTRESHOPLISTSEARCHSHRINKREQUEST_HPP_
...
namespace Models
{
  class IntlFlightReShopListSearchShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IntlFlightReShopListSearchShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IntlFlightReShopListSearchShrinkRequest& obj) { 
    ...
    IntlFlightReShopListSearchShrinkRequest() = default ;
    IntlFlightReShopListSearchShrinkRequest(const IntlFlightReShopListSearchShrinkRequest &) = default ;
    IntlFlightReShopListSearchShrinkRequest(IntlFlightReShopListSearchShrinkRequest &&) = default ;
    IntlFlightReShopListSearchShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IntlFlightReShopListSearchShrinkRequest() = default ;
    IntlFlightReShopListSearchShrinkRequest& operator=(const IntlFlightReShopListSearchShrinkRequest &) = default ;
    IntlFlightReShopListSearchShrinkRequest& operator=(IntlFlightReShopListSearchShrinkRequest &&) = default ;
    ...
    inline IntlFlightReShopListSearchShrinkRequest& setOrderId(string orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline IntlFlightReShopListSearchShrinkRequest& setOutOrderId(string outOrderId) { DARABONBA_PTR_SET_VALUE(outOrderId_, outOrderId) };
    ...
    inline IntlFlightReShopListSearchShrinkRequest& setOutWheelSearch(bool outWheelSearch) { DARABONBA_PTR_SET_VALUE(outWheelSearch_, outWheelSearch) };
    ...
    inline IntlFlightReShopListSearchShrinkRequest& setPassengerJourneyGroupKey(string passengerJourneyGroupKey) { DARABONBA_PTR_SET_VALUE(passengerJourneyGroupKey_, passengerJourneyGroupKey) };
    ...
    inline IntlFlightReShopListSearchShrinkRequest& setReShopReasonCode(string reShopReasonCode) { DARABONBA_PTR_SET_VALUE(reShopReasonCode_, reShopReasonCode) };
    ...
    inline IntlFlightReShopListSearchShrinkRequest& setSearchJourneysShrink(string searchJourneysShrink) { DARABONBA_PTR_SET_VALUE(searchJourneysShrink_, searchJourneysShrink) };
    ...
    inline IntlFlightReShopListSearchShrinkRequest& setSelectedPassengersShrink(string selectedPassengersShrink) { DARABONBA_PTR_SET_VALUE(selectedPassengersShrink_, selectedPassengersShrink) };
    ...
    inline IntlFlightReShopListSearchShrinkRequest& setToken(string token) { DARABONBA_PTR_SET_VALUE(token_, token) };
