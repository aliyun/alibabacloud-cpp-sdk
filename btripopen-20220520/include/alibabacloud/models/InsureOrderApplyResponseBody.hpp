...
namespace Models
{
  ...
  public:
    ...
    inline const InsureOrderApplyResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, InsureOrderApplyResponseBodyModule) };
    inline InsureOrderApplyResponseBodyModule module() { DARABONBA_PTR_GET(module_, InsureOrderApplyResponseBodyModule) };
    inline InsureOrderApplyResponseBody& setModule(const InsureOrderApplyResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline InsureOrderApplyResponseBody& setModule(InsureOrderApplyResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<InsureOrderApplyResponseBodyModule> module_ = nullptr;
