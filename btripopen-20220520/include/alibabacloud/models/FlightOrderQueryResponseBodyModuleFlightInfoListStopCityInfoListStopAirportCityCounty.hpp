...
#ifndef ALIBABACLOUD_MODELS_FLIGHTORDERQUERYRESPONSEBODYMODULEFLIGHTINFOLISTSTOPCITYINFOLISTSTOPAIRPORTCITYCOUNTY_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTORDERQUERYRESPONSEBODYMODULEFLIGHTINFOLISTSTOPCITYINFOLISTSTOPAIRPORTCITYCOUNTY_HPP_
...
namespace Models
{
  class FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& obj) { 
    ...
    FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty() = default ;
    FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty(const FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty &) = default ;
    FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty(FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty &&) = default ;
    FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty() = default ;
    FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& operator=(const FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty &) = default ;
    FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& operator=(FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty &&) = default ;
    ...
    inline FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& setAdcode(string adcode) { DARABONBA_PTR_SET_VALUE(adcode_, adcode) };
    ...
    inline FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& setAirportCityCode(string airportCityCode) { DARABONBA_PTR_SET_VALUE(airportCityCode_, airportCityCode) };
    ...
    inline FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& setAirportCityName(string airportCityName) { DARABONBA_PTR_SET_VALUE(airportCityName_, airportCityName) };
    ...
    inline FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& setAirportCode(string airportCode) { DARABONBA_PTR_SET_VALUE(airportCode_, airportCode) };
    ...
    inline FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& setAirportName(string airportName) { DARABONBA_PTR_SET_VALUE(airportName_, airportName) };
    ...
    inline FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& setAirportParentCityName(string airportParentCityName) { DARABONBA_PTR_SET_VALUE(airportParentCityName_, airportParentCityName) };
    ...
    inline FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& setCountyCityAdcode(string countyCityAdcode) { DARABONBA_PTR_SET_VALUE(countyCityAdcode_, countyCityAdcode) };
    ...
    inline FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& setCountyCityName(string countyCityName) { DARABONBA_PTR_SET_VALUE(countyCityName_, countyCityName) };
    ...
    inline FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& setPrefectureCityAdcode(string prefectureCityAdcode) { DARABONBA_PTR_SET_VALUE(prefectureCityAdcode_, prefectureCityAdcode) };
    ...
    inline FlightOrderQueryResponseBodyModuleFlightInfoListStopCityInfoListStopAirportCityCounty& setPrefectureCityName(string prefectureCityName) { DARABONBA_PTR_SET_VALUE(prefectureCityName_, prefectureCityName) };
