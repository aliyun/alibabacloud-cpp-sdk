...
namespace Models
{
  ...
  public:
    ...
    inline const IeHotelBillSettlementQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IeHotelBillSettlementQueryResponseBody) };
    inline IeHotelBillSettlementQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, IeHotelBillSettlementQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IeHotelBillSettlementQueryResponseBody> body_ {};
  };
