...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->reimbOrderNo_ == nullptr
    ...
    inline string getReimbOrderNo() const { DARABONBA_PTR_GET_DEFAULT(reimbOrderNo_, "") };
  ...
  protected:
    ...
    shared_ptr<string> reimbOrderNo_ {};
