...
#ifndef ALIBABACLOUD_MODELS_HOTELBILLSETTLEMENTQUERYRESPONSEBODYMODULEDATALIST_HPP_
#define ALIBABACLOUD_MODELS_HOTELBILLSETTLEMENTQUERYRESPONSEBODYMODULEDATALIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const HotelBillSettlementQueryResponseBodyModuleDataList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, HotelBillSettlementQueryResponseBodyModuleDataList& obj) { 
    ...
    HotelBillSettlementQueryResponseBodyModuleDataList() = default ;
    HotelBillSettlementQueryResponseBodyModuleDataList(const HotelBillSettlementQueryResponseBodyModuleDataList &) = default ;
    HotelBillSettlementQueryResponseBodyModuleDataList(HotelBillSettlementQueryResponseBodyModuleDataList &&) = default ;
    HotelBillSettlementQueryResponseBodyModuleDataList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~HotelBillSettlementQueryResponseBodyModuleDataList() = default ;
    HotelBillSettlementQueryResponseBodyModuleDataList& operator=(const HotelBillSettlementQueryResponseBodyModuleDataList &) = default ;
    HotelBillSettlementQueryResponseBodyModuleDataList& operator=(HotelBillSettlementQueryResponseBodyModuleDataList &&) = default ;
    ...
    virtual bool empty() const override { this->adjustTime_ != nullptr
        ...
        && this->billRecordTime_ != nullptr && this->billingEntity_ != nullptr && this->bookChannel_ != nullptr && this->bookMode_ != nullptr && this->bookReason_ != nullptr
        && this->bookTime_ != nullptr && this->bookerId_ != nullptr && this->bookerJobNo_ != nullptr && this->bookerName_ != nullptr && this->brandGroup_ != nullptr
        && this->brandName_ != nullptr && this->businessTripResult_ != nullptr && this->cancelOrModifyReason_ != nullptr && this->cancelOrModifyScene_ != nullptr && this->capitalDirection_ != nullptr
        ...
        && this->costCenter_ != nullptr && this->costCenterNumber_ != nullptr && this->costDepartment_ != nullptr && this->customContent_ != nullptr && this->deductibleTax_ != nullptr
        ...
        && this->fees_ != nullptr && this->fines_ != nullptr && this->fuPointFee_ != nullptr && this->hotelName_ != nullptr && this->index_ != nullptr
        && this->insOrderId_ != nullptr && this->insuranceNumber_ != nullptr && this->insurancePrice_ != nullptr && this->insuranceProductName_ != nullptr && this->invoiceTitle_ != nullptr
        && this->isEarlyDeparture_ != nullptr && this->isNegotiation_ != nullptr && this->isShareStr_ != nullptr && this->mappingCompanyCode_ != nullptr && this->nights_ != nullptr
        ...
        && this->settlementTime_ != nullptr && this->settlementType_ != nullptr && this->star_ != nullptr && this->status_ != nullptr && this->statusDesc_ != nullptr
        && this->taxRate_ != nullptr && this->thirdItineraryId_ != nullptr && this->totalNights_ != nullptr && this->tradeActionDesc_ != nullptr && this->travelerId_ != nullptr
        && this->travelerJobNo_ != nullptr && this->travelerMemberType_ != nullptr && this->travelerMemberTypeName_ != nullptr && this->travelerName_ != nullptr && this->unbookedLowestPriceReason_ != nullptr
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setAdjustTime(string adjustTime) { DARABONBA_PTR_SET_VALUE(adjustTime_, adjustTime) };
    ...
    inline double agreementPromotionFee() const { DARABONBA_PTR_GET_DEFAULT(agreementPromotionFee_, 0.0) };
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setAgreementPromotionFee(double agreementPromotionFee) { DARABONBA_PTR_SET_VALUE(agreementPromotionFee_, agreementPromotionFee) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setAlipayTradeNo(string alipayTradeNo) { DARABONBA_PTR_SET_VALUE(alipayTradeNo_, alipayTradeNo) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setApplyArrCityCode(string applyArrCityCode) { DARABONBA_PTR_SET_VALUE(applyArrCityCode_, applyArrCityCode) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setApplyArrCityName(string applyArrCityName) { DARABONBA_PTR_SET_VALUE(applyArrCityName_, applyArrCityName) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setApplyDepCityCode(string applyDepCityCode) { DARABONBA_PTR_SET_VALUE(applyDepCityCode_, applyDepCityCode) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setApplyDepCityName(string applyDepCityName) { DARABONBA_PTR_SET_VALUE(applyDepCityName_, applyDepCityName) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setApplyExtendField(string applyExtendField) { DARABONBA_PTR_SET_VALUE(applyExtendField_, applyExtendField) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setApplyId(string applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline string averageNights() const { DARABONBA_PTR_GET_DEFAULT(averageNights_, "") };
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setAverageNights(string averageNights) { DARABONBA_PTR_SET_VALUE(averageNights_, averageNights) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBaseLocation(string baseLocation) { DARABONBA_PTR_SET_VALUE(baseLocation_, baseLocation) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBillRecordTime(string billRecordTime) { DARABONBA_PTR_SET_VALUE(billRecordTime_, billRecordTime) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBillingEntity(string billingEntity) { DARABONBA_PTR_SET_VALUE(billingEntity_, billingEntity) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBookChannel(string bookChannel) { DARABONBA_PTR_SET_VALUE(bookChannel_, bookChannel) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBookMode(string bookMode) { DARABONBA_PTR_SET_VALUE(bookMode_, bookMode) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBookReason(string bookReason) { DARABONBA_PTR_SET_VALUE(bookReason_, bookReason) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBookTime(string bookTime) { DARABONBA_PTR_SET_VALUE(bookTime_, bookTime) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBookerId(string bookerId) { DARABONBA_PTR_SET_VALUE(bookerId_, bookerId) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBookerJobNo(string bookerJobNo) { DARABONBA_PTR_SET_VALUE(bookerJobNo_, bookerJobNo) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBookerName(string bookerName) { DARABONBA_PTR_SET_VALUE(bookerName_, bookerName) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBrandGroup(string brandGroup) { DARABONBA_PTR_SET_VALUE(brandGroup_, brandGroup) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBrandName(string brandName) { DARABONBA_PTR_SET_VALUE(brandName_, brandName) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setBusinessTripResult(string businessTripResult) { DARABONBA_PTR_SET_VALUE(businessTripResult_, businessTripResult) };
    ...
    inline string cancelOrModifyReason() const { DARABONBA_PTR_GET_DEFAULT(cancelOrModifyReason_, "") };
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCancelOrModifyReason(string cancelOrModifyReason) { DARABONBA_PTR_SET_VALUE(cancelOrModifyReason_, cancelOrModifyReason) };
    ...
    inline string cancelOrModifyScene() const { DARABONBA_PTR_GET_DEFAULT(cancelOrModifyScene_, "") };
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCancelOrModifyScene(string cancelOrModifyScene) { DARABONBA_PTR_SET_VALUE(cancelOrModifyScene_, cancelOrModifyScene) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCapitalDirection(string capitalDirection) { DARABONBA_PTR_SET_VALUE(capitalDirection_, capitalDirection) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCascadeDepartment(string cascadeDepartment) { DARABONBA_PTR_SET_VALUE(cascadeDepartment_, cascadeDepartment) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCategoryDesc(string categoryDesc) { DARABONBA_PTR_SET_VALUE(categoryDesc_, categoryDesc) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCheckInDate(string checkInDate) { DARABONBA_PTR_SET_VALUE(checkInDate_, checkInDate) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCheckoutDate(string checkoutDate) { DARABONBA_PTR_SET_VALUE(checkoutDate_, checkoutDate) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCity(string city) { DARABONBA_PTR_SET_VALUE(city_, city) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCityCode(string cityCode) { DARABONBA_PTR_SET_VALUE(cityCode_, cityCode) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCityCounty(string cityCounty) { DARABONBA_PTR_SET_VALUE(cityCounty_, cityCounty) };
    ...
    inline string cityCountyCode() const { DARABONBA_PTR_GET_DEFAULT(cityCountyCode_, "") };
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCityCountyCode(string cityCountyCode) { DARABONBA_PTR_SET_VALUE(cityCountyCode_, cityCountyCode) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCorpRefundFee(double corpRefundFee) { DARABONBA_PTR_SET_VALUE(corpRefundFee_, corpRefundFee) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCorpTotalFee(double corpTotalFee) { DARABONBA_PTR_SET_VALUE(corpTotalFee_, corpTotalFee) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCostCenter(string costCenter) { DARABONBA_PTR_SET_VALUE(costCenter_, costCenter) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCostCenterNumber(string costCenterNumber) { DARABONBA_PTR_SET_VALUE(costCenterNumber_, costCenterNumber) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCostDepartment(string costDepartment) { DARABONBA_PTR_SET_VALUE(costDepartment_, costDepartment) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setCustomContent(string customContent) { DARABONBA_PTR_SET_VALUE(customContent_, customContent) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setDeductibleTax(double deductibleTax) { DARABONBA_PTR_SET_VALUE(deductibleTax_, deductibleTax) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setDepartment(string department) { DARABONBA_PTR_SET_VALUE(department_, department) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setDepartmentId(string departmentId) { DARABONBA_PTR_SET_VALUE(departmentId_, departmentId) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setExceedReason(string exceedReason) { DARABONBA_PTR_SET_VALUE(exceedReason_, exceedReason) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setFeeType(string feeType) { DARABONBA_PTR_SET_VALUE(feeType_, feeType) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setFeeTypeDesc(string feeTypeDesc) { DARABONBA_PTR_SET_VALUE(feeTypeDesc_, feeTypeDesc) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setFees(double fees) { DARABONBA_PTR_SET_VALUE(fees_, fees) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setFines(double fines) { DARABONBA_PTR_SET_VALUE(fines_, fines) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setFuPointFee(double fuPointFee) { DARABONBA_PTR_SET_VALUE(fuPointFee_, fuPointFee) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setHotelName(string hotelName) { DARABONBA_PTR_SET_VALUE(hotelName_, hotelName) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setIndex(string index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setInsOrderId(string insOrderId) { DARABONBA_PTR_SET_VALUE(insOrderId_, insOrderId) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setInsuranceNumber(string insuranceNumber) { DARABONBA_PTR_SET_VALUE(insuranceNumber_, insuranceNumber) };
    ...
    inline double insurancePrice() const { DARABONBA_PTR_GET_DEFAULT(insurancePrice_, 0.0) };
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setInsurancePrice(double insurancePrice) { DARABONBA_PTR_SET_VALUE(insurancePrice_, insurancePrice) };
    ...
    inline string insuranceProductName() const { DARABONBA_PTR_GET_DEFAULT(insuranceProductName_, "") };
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setInsuranceProductName(string insuranceProductName) { DARABONBA_PTR_SET_VALUE(insuranceProductName_, insuranceProductName) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setInvoiceTitle(string invoiceTitle) { DARABONBA_PTR_SET_VALUE(invoiceTitle_, invoiceTitle) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setIsEarlyDeparture(string isEarlyDeparture) { DARABONBA_PTR_SET_VALUE(isEarlyDeparture_, isEarlyDeparture) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setIsNegotiation(string isNegotiation) { DARABONBA_PTR_SET_VALUE(isNegotiation_, isNegotiation) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setIsShareStr(string isShareStr) { DARABONBA_PTR_SET_VALUE(isShareStr_, isShareStr) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setMappingCompanyCode(string mappingCompanyCode) { DARABONBA_PTR_SET_VALUE(mappingCompanyCode_, mappingCompanyCode) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setNights(int32_t nights) { DARABONBA_PTR_SET_VALUE(nights_, nights) };
    ...
    inline string noAdvanceBookingReason() const { DARABONBA_PTR_GET_DEFAULT(noAdvanceBookingReason_, "") };
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setNoAdvanceBookingReason(string noAdvanceBookingReason) { DARABONBA_PTR_SET_VALUE(noAdvanceBookingReason_, noAdvanceBookingReason) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setOrderId(string orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setOrderPrice(double orderPrice) { DARABONBA_PTR_SET_VALUE(orderPrice_, orderPrice) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setOrderType(string orderType) { DARABONBA_PTR_SET_VALUE(orderType_, orderType) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setOriginalReserveRule(string originalReserveRule) { DARABONBA_PTR_SET_VALUE(originalReserveRule_, originalReserveRule) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setOverApplyId(string overApplyId) { DARABONBA_PTR_SET_VALUE(overApplyId_, overApplyId) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setPaymentDepartmentId(string paymentDepartmentId) { DARABONBA_PTR_SET_VALUE(paymentDepartmentId_, paymentDepartmentId) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setPaymentDepartmentName(string paymentDepartmentName) { DARABONBA_PTR_SET_VALUE(paymentDepartmentName_, paymentDepartmentName) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setPersonRefundFee(double personRefundFee) { DARABONBA_PTR_SET_VALUE(personRefundFee_, personRefundFee) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setPersonSettlePrice(double personSettlePrice) { DARABONBA_PTR_SET_VALUE(personSettlePrice_, personSettlePrice) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setPosition(string position) { DARABONBA_PTR_SET_VALUE(position_, position) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setPositionLevel(string positionLevel) { DARABONBA_PTR_SET_VALUE(positionLevel_, positionLevel) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setPrimaryId(int64_t primaryId) { DARABONBA_PTR_SET_VALUE(primaryId_, primaryId) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setProcessorOaCode(string processorOaCode) { DARABONBA_PTR_SET_VALUE(processorOaCode_, processorOaCode) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setProjectCode(string projectCode) { DARABONBA_PTR_SET_VALUE(projectCode_, projectCode) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setProjectName(string projectName) { DARABONBA_PTR_SET_VALUE(projectName_, projectName) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setPromotionFee(double promotionFee) { DARABONBA_PTR_SET_VALUE(promotionFee_, promotionFee) };
    ...
    inline double recoverMoneyReceiptAmt() const { DARABONBA_PTR_GET_DEFAULT(recoverMoneyReceiptAmt_, 0.0) };
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setRecoverMoneyReceiptAmt(double recoverMoneyReceiptAmt) { DARABONBA_PTR_SET_VALUE(recoverMoneyReceiptAmt_, recoverMoneyReceiptAmt) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline string reserveRule() const { DARABONBA_PTR_GET_DEFAULT(reserveRule_, "") };
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setReserveRule(string reserveRule) { DARABONBA_PTR_SET_VALUE(reserveRule_, reserveRule) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setRoomNo(string roomNo) { DARABONBA_PTR_SET_VALUE(roomNo_, roomNo) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setRoomNumber(int32_t roomNumber) { DARABONBA_PTR_SET_VALUE(roomNumber_, roomNumber) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setRoomPrice(double roomPrice) { DARABONBA_PTR_SET_VALUE(roomPrice_, roomPrice) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setRoomType(string roomType) { DARABONBA_PTR_SET_VALUE(roomType_, roomType) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setSceneName(string sceneName) { DARABONBA_PTR_SET_VALUE(sceneName_, sceneName) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setServiceFee(double serviceFee) { DARABONBA_PTR_SET_VALUE(serviceFee_, serviceFee) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setSettleTypeDesc(string settleTypeDesc) { DARABONBA_PTR_SET_VALUE(settleTypeDesc_, settleTypeDesc) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setSettlementFee(double settlementFee) { DARABONBA_PTR_SET_VALUE(settlementFee_, settlementFee) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setSettlementGrantFee(double settlementGrantFee) { DARABONBA_PTR_SET_VALUE(settlementGrantFee_, settlementGrantFee) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setSettlementTime(string settlementTime) { DARABONBA_PTR_SET_VALUE(settlementTime_, settlementTime) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setSettlementType(string settlementType) { DARABONBA_PTR_SET_VALUE(settlementType_, settlementType) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setStar(string star) { DARABONBA_PTR_SET_VALUE(star_, star) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setStatusDesc(string statusDesc) { DARABONBA_PTR_SET_VALUE(statusDesc_, statusDesc) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setTaxRate(string taxRate) { DARABONBA_PTR_SET_VALUE(taxRate_, taxRate) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setThirdItineraryId(string thirdItineraryId) { DARABONBA_PTR_SET_VALUE(thirdItineraryId_, thirdItineraryId) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setTotalNights(int32_t totalNights) { DARABONBA_PTR_SET_VALUE(totalNights_, totalNights) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setTradeActionDesc(string tradeActionDesc) { DARABONBA_PTR_SET_VALUE(tradeActionDesc_, tradeActionDesc) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setTravelerId(string travelerId) { DARABONBA_PTR_SET_VALUE(travelerId_, travelerId) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setTravelerJobNo(string travelerJobNo) { DARABONBA_PTR_SET_VALUE(travelerJobNo_, travelerJobNo) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setTravelerMemberType(string travelerMemberType) { DARABONBA_PTR_SET_VALUE(travelerMemberType_, travelerMemberType) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setTravelerMemberTypeName(string travelerMemberTypeName) { DARABONBA_PTR_SET_VALUE(travelerMemberTypeName_, travelerMemberTypeName) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setTravelerName(string travelerName) { DARABONBA_PTR_SET_VALUE(travelerName_, travelerName) };
    ...
    inline string unbookedLowestPriceReason() const { DARABONBA_PTR_GET_DEFAULT(unbookedLowestPriceReason_, "") };
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setUnbookedLowestPriceReason(string unbookedLowestPriceReason) { DARABONBA_PTR_SET_VALUE(unbookedLowestPriceReason_, unbookedLowestPriceReason) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setVoucherType(int32_t voucherType) { DARABONBA_PTR_SET_VALUE(voucherType_, voucherType) };
    ...
    inline HotelBillSettlementQueryResponseBodyModuleDataList& setVoucherTypeDesc(string voucherTypeDesc) { DARABONBA_PTR_SET_VALUE(voucherTypeDesc_, voucherTypeDesc) };


  protected:
    std::shared_ptr<string> adjustTime_ = nullptr;
    std::shared_ptr<double> agreementPromotionFee_ = nullptr;
    ...
    std::shared_ptr<string> averageNights_ = nullptr;
    ...
    std::shared_ptr<string> cancelOrModifyReason_ = nullptr;
    std::shared_ptr<string> cancelOrModifyScene_ = nullptr;
    ...
    std::shared_ptr<string> cityCountyCode_ = nullptr;
    ...
    std::shared_ptr<double> insurancePrice_ = nullptr;
    ...
    std::shared_ptr<string> noAdvanceBookingReason_ = nullptr;
    ...
    std::shared_ptr<double> recoverMoneyReceiptAmt_ = nullptr;
    std::shared_ptr<string> remark_ = nullptr;
    std::shared_ptr<string> reserveRule_ = nullptr;
    ...
    std::shared_ptr<string> unbookedLowestPriceReason_ = nullptr;
