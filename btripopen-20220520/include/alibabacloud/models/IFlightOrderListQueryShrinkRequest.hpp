...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applyIdListShrink_ == nullptr
    ...
    inline string getApplyIdListShrink() const { DARABONBA_PTR_GET_DEFAULT(applyIdListShrink_, "") };
    ...
    inline string getBookTypeListShrink() const { DARABONBA_PTR_GET_DEFAULT(bookTypeListShrink_, "") };
    ...
    inline string getThirdPartApplyIdListShrink() const { DARABONBA_PTR_GET_DEFAULT(thirdPartApplyIdListShrink_, "") };
  ...
  protected:
    shared_ptr<string> applyIdListShrink_ {};
    shared_ptr<string> bookTypeListShrink_ {};
    shared_ptr<string> bookerIdShrink_ {};
    shared_ptr<string> endDate_ {};
    shared_ptr<int32_t> pageSize_ {};
    shared_ptr<string> scrollId_ {};
    shared_ptr<string> startDate_ {};
    shared_ptr<string> thirdPartApplyIdListShrink_ {};
  };
