...
#ifndef ALIBABACLOUD_MODELS_CARBILLSETTLEMENTQUERYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CARBILLSETTLEMENTQUERYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    CarBillSettlementQueryRequest() = default ;
    CarBillSettlementQueryRequest(const CarBillSettlementQueryRequest &) = default ;
    CarBillSettlementQueryRequest(CarBillSettlementQueryRequest &&) = default ;
    CarBillSettlementQueryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CarBillSettlementQueryRequest() = default ;
    CarBillSettlementQueryRequest& operator=(const CarBillSettlementQueryRequest &) = default ;
    CarBillSettlementQueryRequest& operator=(CarBillSettlementQueryRequest &&) = default ;
    ...
    inline CarBillSettlementQueryRequest& setBillBatch(string billBatch) { DARABONBA_PTR_SET_VALUE(billBatch_, billBatch) };
    ...
    inline CarBillSettlementQueryRequest& setBillRecordTimeEnd(string billRecordTimeEnd) { DARABONBA_PTR_SET_VALUE(billRecordTimeEnd_, billRecordTimeEnd) };
    ...
    inline CarBillSettlementQueryRequest& setBillRecordTimeStart(string billRecordTimeStart) { DARABONBA_PTR_SET_VALUE(billRecordTimeStart_, billRecordTimeStart) };
    ...
    inline CarBillSettlementQueryRequest& setOrderId(int64_t orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline CarBillSettlementQueryRequest& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline CarBillSettlementQueryRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline CarBillSettlementQueryRequest& setPeriodEnd(string periodEnd) { DARABONBA_PTR_SET_VALUE(periodEnd_, periodEnd) };
    ...
    inline CarBillSettlementQueryRequest& setPeriodStart(string periodStart) { DARABONBA_PTR_SET_VALUE(periodStart_, periodStart) };
    ...
    inline CarBillSettlementQueryRequest& setScrollId(string scrollId) { DARABONBA_PTR_SET_VALUE(scrollId_, scrollId) };
    ...
    inline CarBillSettlementQueryRequest& setScrollMod(bool scrollMod) { DARABONBA_PTR_SET_VALUE(scrollMod_, scrollMod) };
