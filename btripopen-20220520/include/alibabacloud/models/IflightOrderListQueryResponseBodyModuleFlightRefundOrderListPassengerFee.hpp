...
#ifndef ALIBABACLOUD_MODELS_IFLIGHTORDERLISTQUERYRESPONSEBODYMODULEFLIGHTREFUNDORDERLISTPASSENGERFEE_HPP_
#define ALIBABACLOUD_MODELS_IFLIGHTORDERLISTQUERYRESPONSEBODYMODULEFLIGHTREFUNDORDERLISTPASSENGERFEE_HPP_
...
namespace Models
{
  class IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& obj) { 
    ...
    IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee() = default ;
    IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee(const IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee &) = default ;
    IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee(IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee &&) = default ;
    IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee() = default ;
    IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& operator=(const IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee &) = default ;
    IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& operator=(IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee &&) = default ;
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& setNoRefundModifyHandFee(int64_t noRefundModifyHandFee) { DARABONBA_PTR_SET_VALUE(noRefundModifyHandFee_, noRefundModifyHandFee) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& setNoRefundModifyUpgradeFee(int64_t noRefundModifyUpgradeFee) { DARABONBA_PTR_SET_VALUE(noRefundModifyUpgradeFee_, noRefundModifyUpgradeFee) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& setRefundAmount(int64_t refundAmount) { DARABONBA_PTR_SET_VALUE(refundAmount_, refundAmount) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& setRefundHandFee(int64_t refundHandFee) { DARABONBA_PTR_SET_VALUE(refundHandFee_, refundHandFee) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& setRefundModifyAmount(int64_t refundModifyAmount) { DARABONBA_PTR_SET_VALUE(refundModifyAmount_, refundModifyAmount) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& setRefundModifyHandAmount(int64_t refundModifyHandAmount) { DARABONBA_PTR_SET_VALUE(refundModifyHandAmount_, refundModifyHandAmount) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& setRefundModifyUpgradeAmount(int64_t refundModifyUpgradeAmount) { DARABONBA_PTR_SET_VALUE(refundModifyUpgradeAmount_, refundModifyUpgradeAmount) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& setRefundTaxHandFee(int64_t refundTaxHandFee) { DARABONBA_PTR_SET_VALUE(refundTaxHandFee_, refundTaxHandFee) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightRefundOrderListPassengerFee& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
