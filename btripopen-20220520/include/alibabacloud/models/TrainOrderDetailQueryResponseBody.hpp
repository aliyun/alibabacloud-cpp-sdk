...
namespace Models
{
  ...
  public:
    ...
    inline const TrainOrderDetailQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TrainOrderDetailQueryResponseBodyModule) };
    inline TrainOrderDetailQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, TrainOrderDetailQueryResponseBodyModule) };
    inline TrainOrderDetailQueryResponseBody& setModule(const TrainOrderDetailQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainOrderDetailQueryResponseBody& setModule(TrainOrderDetailQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<TrainOrderDetailQueryResponseBodyModule> module_ = nullptr;
