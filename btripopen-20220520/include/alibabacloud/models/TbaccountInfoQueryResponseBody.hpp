...
namespace Models
{
  ...
  public:
    ...
    inline const TBAccountInfoQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TBAccountInfoQueryResponseBodyModule) };
    inline TBAccountInfoQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, TBAccountInfoQueryResponseBodyModule) };
    inline TBAccountInfoQueryResponseBody& setModule(const TBAccountInfoQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TBAccountInfoQueryResponseBody& setModule(TBAccountInfoQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TBAccountInfoQueryResponseBodyModule> module_ = nullptr;
