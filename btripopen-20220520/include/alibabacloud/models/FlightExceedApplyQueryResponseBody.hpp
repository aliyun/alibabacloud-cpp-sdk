...
namespace Models
{
  ...
  public:
    ...
    inline const FlightExceedApplyQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightExceedApplyQueryResponseBodyModule) };
    inline FlightExceedApplyQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightExceedApplyQueryResponseBodyModule) };
    inline FlightExceedApplyQueryResponseBody& setModule(const FlightExceedApplyQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightExceedApplyQueryResponseBody& setModule(FlightExceedApplyQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<FlightExceedApplyQueryResponseBodyModule> module_ = nullptr;
