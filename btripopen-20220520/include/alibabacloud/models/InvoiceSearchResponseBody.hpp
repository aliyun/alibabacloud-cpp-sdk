...
namespace Models
{
  ...
  public:
    ...
    inline const vector<InvoiceSearchResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<InvoiceSearchResponseBodyModule>) };
    inline vector<InvoiceSearchResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<InvoiceSearchResponseBodyModule>) };
    inline InvoiceSearchResponseBody& setModule(const vector<InvoiceSearchResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline InvoiceSearchResponseBody& setModule(vector<InvoiceSearchResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<vector<InvoiceSearchResponseBodyModule>> module_ = nullptr;
