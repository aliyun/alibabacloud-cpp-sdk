...
namespace Models
{
  ...
  public:
    ...
    inline const IeFlightBillSettlementQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, IeFlightBillSettlementQueryResponseBodyModule) };
    inline IeFlightBillSettlementQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, IeFlightBillSettlementQueryResponseBodyModule) };
    inline IeFlightBillSettlementQueryResponseBody& setModule(const IeFlightBillSettlementQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IeFlightBillSettlementQueryResponseBody& setModule(IeFlightBillSettlementQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<IeFlightBillSettlementQueryResponseBodyModule> module_ = nullptr;
