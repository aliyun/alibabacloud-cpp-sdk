...
namespace Models
{
  ...
  public:
    ...
    inline const FlightRefundDetailV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FlightRefundDetailV2ResponseBody) };
    inline FlightRefundDetailV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, FlightRefundDetailV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FlightRefundDetailV2ResponseBody> body_ {};
  };
