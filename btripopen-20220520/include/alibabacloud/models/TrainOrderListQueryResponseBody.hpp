...
namespace Models
{
  ...
  public:
    ...
    inline const vector<TrainOrderListQueryResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<TrainOrderListQueryResponseBodyModule>) };
    inline vector<TrainOrderListQueryResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<TrainOrderListQueryResponseBodyModule>) };
    inline TrainOrderListQueryResponseBody& setModule(const vector<TrainOrderListQueryResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainOrderListQueryResponseBody& setModule(vector<TrainOrderListQueryResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };


    // pageInfo Field Functions 
    bool hasPageInfo() const { return this->pageInfo_ != nullptr;};
    void deletePageInfo() { this->pageInfo_ = nullptr;};
    inline const TrainOrderListQueryResponseBodyPageInfo & pageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, TrainOrderListQueryResponseBodyPageInfo) };
    inline TrainOrderListQueryResponseBodyPageInfo pageInfo() { DARABONBA_PTR_GET(pageInfo_, TrainOrderListQueryResponseBodyPageInfo) };
    inline TrainOrderListQueryResponseBody& setPageInfo(const TrainOrderListQueryResponseBodyPageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline TrainOrderListQueryResponseBody& setPageInfo(TrainOrderListQueryResponseBodyPageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
  ...
  protected:
    ...
    std::shared_ptr<vector<TrainOrderListQueryResponseBodyModule>> module_ = nullptr;
    std::shared_ptr<TrainOrderListQueryResponseBodyPageInfo> pageInfo_ = nullptr;
