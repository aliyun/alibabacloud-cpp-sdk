...
namespace Models
{
  ...
  public:
    ...
    inline const FlightModifyPayV2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FlightModifyPayV2ResponseBody) };
    inline FlightModifyPayV2ResponseBody getBody() { DARABONBA_PTR_GET(body_, FlightModifyPayV2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FlightModifyPayV2ResponseBody> body_ {};
  };
