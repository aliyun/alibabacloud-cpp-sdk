...
namespace Models
{
  ...
  public:
    ...
    inline const CooperatorHotelBillSettlementQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, CooperatorHotelBillSettlementQueryResponseBodyModule) };
    inline CooperatorHotelBillSettlementQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, CooperatorHotelBillSettlementQueryResponseBodyModule) };
    inline CooperatorHotelBillSettlementQueryResponseBody& setModule(const CooperatorHotelBillSettlementQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline CooperatorHotelBillSettlementQueryResponseBody& setModule(CooperatorHotelBillSettlementQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<CooperatorHotelBillSettlementQueryResponseBodyModule> module_ = nullptr;
    // requestId
