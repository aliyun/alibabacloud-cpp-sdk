...
#ifndef ALIBABACLOUD_MODELS_ADDEMPLOYEEREQUESTCERTLIST_HPP_
#define ALIBABACLOUD_MODELS_ADDEMPLOYEEREQUESTCERTLIST_HPP_
...
namespace Models
{
  class AddEmployeeRequestCertList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AddEmployeeRequestCertList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddEmployeeRequestCertList& obj) { 
    ...
    AddEmployeeRequestCertList() = default ;
    AddEmployeeRequestCertList(const AddEmployeeRequestCertList &) = default ;
    AddEmployeeRequestCertList(AddEmployeeRequestCertList &&) = default ;
    AddEmployeeRequestCertList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddEmployeeRequestCertList() = default ;
    AddEmployeeRequestCertList& operator=(const AddEmployeeRequestCertList &) = default ;
    AddEmployeeRequestCertList& operator=(AddEmployeeRequestCertList &&) = default ;
    ...
    inline AddEmployeeRequestCertList& setBirthday(string birthday) { DARABONBA_PTR_SET_VALUE(birthday_, birthday) };
    ...
    inline AddEmployeeRequestCertList& setCertExpiredTime(string certExpiredTime) { DARABONBA_PTR_SET_VALUE(certExpiredTime_, certExpiredTime) };
    ...
    inline AddEmployeeRequestCertList& setCertNation(string certNation) { DARABONBA_PTR_SET_VALUE(certNation_, certNation) };
    ...
    inline AddEmployeeRequestCertList& setCertNo(string certNo) { DARABONBA_PTR_SET_VALUE(certNo_, certNo) };
    ...
    inline AddEmployeeRequestCertList& setCertType(int32_t certType) { DARABONBA_PTR_SET_VALUE(certType_, certType) };
    ...
    inline AddEmployeeRequestCertList& setGender(string gender) { DARABONBA_PTR_SET_VALUE(gender_, gender) };
    ...
    inline AddEmployeeRequestCertList& setNationality(string nationality) { DARABONBA_PTR_SET_VALUE(nationality_, nationality) };
    ...
    inline AddEmployeeRequestCertList& setPhone(string phone) { DARABONBA_PTR_SET_VALUE(phone_, phone) };
    ...
    inline AddEmployeeRequestCertList& setRealName(string realName) { DARABONBA_PTR_SET_VALUE(realName_, realName) };
    ...
    inline AddEmployeeRequestCertList& setRealNameEn(string realNameEn) { DARABONBA_PTR_SET_VALUE(realNameEn_, realNameEn) };
