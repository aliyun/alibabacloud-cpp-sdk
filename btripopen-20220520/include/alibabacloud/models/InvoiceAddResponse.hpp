...
namespace Models
{
  ...
  public:
    ...
    inline const InvoiceAddResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InvoiceAddResponseBody) };
    inline InvoiceAddResponseBody getBody() { DARABONBA_PTR_GET(body_, InvoiceAddResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InvoiceAddResponseBody> body_ {};
  };
