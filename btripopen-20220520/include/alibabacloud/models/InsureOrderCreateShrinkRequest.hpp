...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicantShrink_ == nullptr
    ...
    inline string getApplicantShrink() const { DARABONBA_PTR_GET_DEFAULT(applicantShrink_, "") };
    ...
    inline string getInsPersonAndSegmentListShrink() const { DARABONBA_PTR_GET_DEFAULT(insPersonAndSegmentListShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> applicantShrink_ {};
    shared_ptr<string> btripUserId_ {};
    shared_ptr<string> buyerName_ {};
    // This parameter is required.
    shared_ptr<string> insPersonAndSegmentListShrink_ {};
    // This parameter is required.
