...
#ifndef ALIBABACLOUD_MODELS_MODULEORDERITEMLISTBAGGAGERULEOFFERBAGGAGEINFOMAPVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULEORDERITEMLISTBAGGAGERULEOFFERBAGGAGEINFOMAPVALUE_HPP_
...
namespace Models
{
  class ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& obj) { 
    ...
    ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue() = default ;
    ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue(const ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue &) = default ;
    ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue(ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue &&) = default ;
    ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue() = default ;
    ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& operator=(const ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue &) = default ;
    ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& operator=(ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue &&) = default ;
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setStartCityCode(string startCityCode) { DARABONBA_PTR_SET_VALUE(startCityCode_, startCityCode) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setEndCityCode(string endCityCode) { DARABONBA_PTR_SET_VALUE(endCityCode_, endCityCode) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setCarryFreePc(int32_t carryFreePc) { DARABONBA_PTR_SET_VALUE(carryFreePc_, carryFreePc) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setCarryBagWeight(int32_t carryBagWeight) { DARABONBA_PTR_SET_VALUE(carryBagWeight_, carryBagWeight) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setCarryBagSize(string carryBagSize) { DARABONBA_PTR_SET_VALUE(carryBagSize_, carryBagSize) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setIsAllCarryBagWeight(bool isAllCarryBagWeight) { DARABONBA_PTR_SET_VALUE(isAllCarryBagWeight_, isAllCarryBagWeight) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setTotalPcs(int64_t totalPcs) { DARABONBA_PTR_SET_VALUE(totalPcs_, totalPcs) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setTotalWeight(int64_t totalWeight) { DARABONBA_PTR_SET_VALUE(totalWeight_, totalWeight) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setCarryUnknown(bool carryUnknown) { DARABONBA_PTR_SET_VALUE(carryUnknown_, carryUnknown) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setCarryLength(int32_t carryLength) { DARABONBA_PTR_SET_VALUE(carryLength_, carryLength) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setCarryWidth(int32_t carryWidth) { DARABONBA_PTR_SET_VALUE(carryWidth_, carryWidth) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setCarryHeight(int32_t carryHeight) { DARABONBA_PTR_SET_VALUE(carryHeight_, carryHeight) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setCarrySumOfLengthWidthHeight(int32_t carrySumOfLengthWidthHeight) { DARABONBA_PTR_SET_VALUE(carrySumOfLengthWidthHeight_, carrySumOfLengthWidthHeight) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setFreePcs(int64_t freePcs) { DARABONBA_PTR_SET_VALUE(freePcs_, freePcs) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setBaggageWeight(int64_t baggageWeight) { DARABONBA_PTR_SET_VALUE(baggageWeight_, baggageWeight) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setBaggageUnit(string baggageUnit) { DARABONBA_PTR_SET_VALUE(baggageUnit_, baggageUnit) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setBaggageSize(string baggageSize) { DARABONBA_PTR_SET_VALUE(baggageSize_, baggageSize) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setAllWeight(bool allWeight) { DARABONBA_PTR_SET_VALUE(allWeight_, allWeight) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setLength(int32_t length) { DARABONBA_PTR_SET_VALUE(length_, length) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setWidth(int32_t width) { DARABONBA_PTR_SET_VALUE(width_, width) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setHeight(int32_t height) { DARABONBA_PTR_SET_VALUE(height_, height) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setSumOfLengthWidthHeight(int32_t sumOfLengthWidthHeight) { DARABONBA_PTR_SET_VALUE(sumOfLengthWidthHeight_, sumOfLengthWidthHeight) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setUnknown(bool unknown) { DARABONBA_PTR_SET_VALUE(unknown_, unknown) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setCnDesc(string cnDesc) { DARABONBA_PTR_SET_VALUE(cnDesc_, cnDesc) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setEnDesc(string enDesc) { DARABONBA_PTR_SET_VALUE(enDesc_, enDesc) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setAttribute(string attribute) { DARABONBA_PTR_SET_VALUE(attribute_, attribute) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setBaggagePrice(int32_t baggagePrice) { DARABONBA_PTR_SET_VALUE(baggagePrice_, baggagePrice) };
    ...
    inline ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue& setCarryOnBaggageTips(string carryOnBaggageTips) { DARABONBA_PTR_SET_VALUE(carryOnBaggageTips_, carryOnBaggageTips) };
