...
#ifndef ALIBABACLOUD_MODELS_APPLYADDREQUESTTRAVELERSTANDARD_HPP_
#define ALIBABACLOUD_MODELS_APPLYADDREQUESTTRAVELERSTANDARD_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ApplyAddRequestTravelerStandard& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ApplyAddRequestTravelerStandard& obj) { 
    ...
    ApplyAddRequestTravelerStandard() = default ;
    ApplyAddRequestTravelerStandard(const ApplyAddRequestTravelerStandard &) = default ;
    ApplyAddRequestTravelerStandard(ApplyAddRequestTravelerStandard &&) = default ;
    ApplyAddRequestTravelerStandard(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ApplyAddRequestTravelerStandard() = default ;
    ApplyAddRequestTravelerStandard& operator=(const ApplyAddRequestTravelerStandard &) = default ;
    ApplyAddRequestTravelerStandard& operator=(ApplyAddRequestTravelerStandard &&) = default ;
    ...
    inline ApplyAddRequestTravelerStandard& setBusinessDiscount(int32_t businessDiscount) { DARABONBA_PTR_SET_VALUE(businessDiscount_, businessDiscount) };
    ...
    inline const vector<Models::ApplyAddRequestTravelerStandardCarCitySet> & carCitySet() const { DARABONBA_PTR_GET_CONST(carCitySet_, vector<Models::ApplyAddRequestTravelerStandardCarCitySet>) };
    inline vector<Models::ApplyAddRequestTravelerStandardCarCitySet> carCitySet() { DARABONBA_PTR_GET(carCitySet_, vector<Models::ApplyAddRequestTravelerStandardCarCitySet>) };
    inline ApplyAddRequestTravelerStandard& setCarCitySet(const vector<Models::ApplyAddRequestTravelerStandardCarCitySet> & carCitySet) { DARABONBA_PTR_SET_VALUE(carCitySet_, carCitySet) };
    inline ApplyAddRequestTravelerStandard& setCarCitySet(vector<Models::ApplyAddRequestTravelerStandardCarCitySet> && carCitySet) { DARABONBA_PTR_SET_RVALUE(carCitySet_, carCitySet) };
    ...
    inline ApplyAddRequestTravelerStandard& setEconomyDiscount(int32_t economyDiscount) { DARABONBA_PTR_SET_VALUE(economyDiscount_, economyDiscount) };
    ...
    inline ApplyAddRequestTravelerStandard& setFirstDiscount(int32_t firstDiscount) { DARABONBA_PTR_SET_VALUE(firstDiscount_, firstDiscount) };
    ...
    inline ApplyAddRequestTravelerStandard& setFlightCabins(string flightCabins) { DARABONBA_PTR_SET_VALUE(flightCabins_, flightCabins) };
    ...
    inline ApplyAddRequestTravelerStandard& setFlightIntlRuleCode(int64_t flightIntlRuleCode) { DARABONBA_PTR_SET_VALUE(flightIntlRuleCode_, flightIntlRuleCode) };
    ...
    inline ApplyAddRequestTravelerStandard& setFlightRuleCode(int64_t flightRuleCode) { DARABONBA_PTR_SET_VALUE(flightRuleCode_, flightRuleCode) };
    ...
    inline const vector<Models::ApplyAddRequestTravelerStandardHotelCitys> & hotelCitys() const { DARABONBA_PTR_GET_CONST(hotelCitys_, vector<Models::ApplyAddRequestTravelerStandardHotelCitys>) };
    inline vector<Models::ApplyAddRequestTravelerStandardHotelCitys> hotelCitys() { DARABONBA_PTR_GET(hotelCitys_, vector<Models::ApplyAddRequestTravelerStandardHotelCitys>) };
    inline ApplyAddRequestTravelerStandard& setHotelCitys(const vector<Models::ApplyAddRequestTravelerStandardHotelCitys> & hotelCitys) { DARABONBA_PTR_SET_VALUE(hotelCitys_, hotelCitys) };
    inline ApplyAddRequestTravelerStandard& setHotelCitys(vector<Models::ApplyAddRequestTravelerStandardHotelCitys> && hotelCitys) { DARABONBA_PTR_SET_RVALUE(hotelCitys_, hotelCitys) };
    ...
    inline const vector<Models::ApplyAddRequestTravelerStandardHotelIntlCitys> & hotelIntlCitys() const { DARABONBA_PTR_GET_CONST(hotelIntlCitys_, vector<Models::ApplyAddRequestTravelerStandardHotelIntlCitys>) };
    inline vector<Models::ApplyAddRequestTravelerStandardHotelIntlCitys> hotelIntlCitys() { DARABONBA_PTR_GET(hotelIntlCitys_, vector<Models::ApplyAddRequestTravelerStandardHotelIntlCitys>) };
    inline ApplyAddRequestTravelerStandard& setHotelIntlCitys(const vector<Models::ApplyAddRequestTravelerStandardHotelIntlCitys> & hotelIntlCitys) { DARABONBA_PTR_SET_VALUE(hotelIntlCitys_, hotelIntlCitys) };
    inline ApplyAddRequestTravelerStandard& setHotelIntlCitys(vector<Models::ApplyAddRequestTravelerStandardHotelIntlCitys> && hotelIntlCitys) { DARABONBA_PTR_SET_RVALUE(hotelIntlCitys_, hotelIntlCitys) };
    ...
    inline ApplyAddRequestTravelerStandard& setHotelIntlRuleCode(int64_t hotelIntlRuleCode) { DARABONBA_PTR_SET_VALUE(hotelIntlRuleCode_, hotelIntlRuleCode) };
    ...
    inline ApplyAddRequestTravelerStandard& setHotelRuleCode(int64_t hotelRuleCode) { DARABONBA_PTR_SET_VALUE(hotelRuleCode_, hotelRuleCode) };
    ...
    inline ApplyAddRequestTravelerStandard& setInternationalFlightCabins(string internationalFlightCabins) { DARABONBA_PTR_SET_VALUE(internationalFlightCabins_, internationalFlightCabins) };
    ...
    inline ApplyAddRequestTravelerStandard& setPremiumEconomyDiscount(int32_t premiumEconomyDiscount) { DARABONBA_PTR_SET_VALUE(premiumEconomyDiscount_, premiumEconomyDiscount) };
    ...
    inline ApplyAddRequestTravelerStandard& setReserveType(int32_t reserveType) { DARABONBA_PTR_SET_VALUE(reserveType_, reserveType) };
    ...
    inline ApplyAddRequestTravelerStandard& setTrainRuleCode(int64_t trainRuleCode) { DARABONBA_PTR_SET_VALUE(trainRuleCode_, trainRuleCode) };
    ...
    inline ApplyAddRequestTravelerStandard& setTrainSeats(string trainSeats) { DARABONBA_PTR_SET_VALUE(trainSeats_, trainSeats) };
    ...
    inline ApplyAddRequestTravelerStandard& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };


  protected:
    std::shared_ptr<int32_t> businessDiscount_ = nullptr;
    std::shared_ptr<vector<Models::ApplyAddRequestTravelerStandardCarCitySet>> carCitySet_ = nullptr;
    ...
    std::shared_ptr<vector<Models::ApplyAddRequestTravelerStandardHotelCitys>> hotelCitys_ = nullptr;
    std::shared_ptr<vector<Models::ApplyAddRequestTravelerStandardHotelIntlCitys>> hotelIntlCitys_ = nullptr;
