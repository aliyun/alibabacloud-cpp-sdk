...
#ifndef ALIBABACLOUD_MODELS_IEHOTELBILLSETTLEMENTQUERYRESPONSEBODYMODULEDATALIST_HPP_
#define ALIBABACLOUD_MODELS_IEHOTELBILLSETTLEMENTQUERYRESPONSEBODYMODULEDATALIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const IeHotelBillSettlementQueryResponseBodyModuleDataList& obj) { 
      DARABONBA_PTR_TO_JSON(adjust_time, adjustTime_);
      DARABONBA_PTR_TO_JSON(alipay_trade_no, alipayTradeNo_);
      DARABONBA_PTR_TO_JSON(amount_currency, amountCurrency_);
      ...
      DARABONBA_PTR_TO_JSON(business_expense, businessExpense_);
      ...
      DARABONBA_PTR_TO_JSON(foreign_business_expense, foreignBusinessExpense_);
    ...
    friend void from_json(const Darabonba::Json& j, IeHotelBillSettlementQueryResponseBodyModuleDataList& obj) { 
      DARABONBA_PTR_FROM_JSON(adjust_time, adjustTime_);
      DARABONBA_PTR_FROM_JSON(alipay_trade_no, alipayTradeNo_);
      DARABONBA_PTR_FROM_JSON(amount_currency, amountCurrency_);
      ...
      DARABONBA_PTR_FROM_JSON(business_expense, businessExpense_);
      ...
      DARABONBA_PTR_FROM_JSON(foreign_business_expense, foreignBusinessExpense_);
    ...
    IeHotelBillSettlementQueryResponseBodyModuleDataList() = default ;
    IeHotelBillSettlementQueryResponseBodyModuleDataList(const IeHotelBillSettlementQueryResponseBodyModuleDataList &) = default ;
    IeHotelBillSettlementQueryResponseBodyModuleDataList(IeHotelBillSettlementQueryResponseBodyModuleDataList &&) = default ;
    IeHotelBillSettlementQueryResponseBodyModuleDataList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IeHotelBillSettlementQueryResponseBodyModuleDataList() = default ;
    IeHotelBillSettlementQueryResponseBodyModuleDataList& operator=(const IeHotelBillSettlementQueryResponseBodyModuleDataList &) = default ;
    IeHotelBillSettlementQueryResponseBodyModuleDataList& operator=(IeHotelBillSettlementQueryResponseBodyModuleDataList &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->adjustTime_ != nullptr
        && this->alipayTradeNo_ != nullptr && this->amountCurrency_ != nullptr && this->applyArrCityCode_ != nullptr && this->applyArrCityName_ != nullptr && this->applyDepCityCode_ != nullptr
        ...
        && this->approverName_ != nullptr && this->averageNights_ != nullptr && this->baseLocation_ != nullptr && this->billRecordTime_ != nullptr && this->bookMode_ != nullptr
        ...
        && this->brandGroup_ != nullptr && this->brandName_ != nullptr && this->businessExpense_ != nullptr && this->businessTripResult_ != nullptr && this->capitalDirection_ != nullptr
        ...
        && this->cityCode_ != nullptr && this->corpRefundFee_ != nullptr && this->corpTotalFee_ != nullptr && this->costCenter_ != nullptr && this->costCenterNumber_ != nullptr
        && this->costDepartment_ != nullptr && this->country_ != nullptr && this->countryCode_ != nullptr && this->customContent_ != nullptr && this->deductibleTax_ != nullptr
        && this->department_ != nullptr && this->departmentId_ != nullptr && this->exceedReason_ != nullptr && this->feeType_ != nullptr && this->feeTypeDesc_ != nullptr
        && this->fines_ != nullptr && this->foreignBusinessExpense_ != nullptr && this->foreignersTag_ != nullptr && this->hotelName_ != nullptr && this->hotelStar_ != nullptr
        && this->index_ != nullptr && this->invoiceTitle_ != nullptr && this->isEarlyDeparture_ != nullptr && this->isNegotiation_ != nullptr && this->isShareStr_ != nullptr
        && this->location_ != nullptr && this->mainApplyId_ != nullptr && this->mappingCompanyCode_ != nullptr && this->nights_ != nullptr && this->orderId_ != nullptr
        && this->orderPrice_ != nullptr && this->orderStatusDesc_ != nullptr && this->orderType_ != nullptr && this->originalReserveRule_ != nullptr && this->overApplyId_ != nullptr
        ...
        && this->promotionFee_ != nullptr && this->rate_ != nullptr && this->remark_ != nullptr && this->reserveRule_ != nullptr && this->roomNo_ != nullptr
        && this->roomNumber_ != nullptr && this->roomPrice_ != nullptr && this->roomType_ != nullptr && this->serviceFee_ != nullptr && this->settleTypeDesc_ != nullptr
        ...
        && this->thirdItineraryId_ != nullptr && this->thirdPartBusinessId_ != nullptr && this->thirdpartApplyId_ != nullptr && this->totalNights_ != nullptr && this->tradeActionDesc_ != nullptr
        && this->travelerEmail_ != nullptr && this->travelerId_ != nullptr && this->travelerJobNo_ != nullptr && this->travelerMemberType_ != nullptr && this->travelerName_ != nullptr
        && this->voucherType_ != nullptr && this->voucherTypeDesc_ != nullptr; };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setAdjustTime(string adjustTime) { DARABONBA_PTR_SET_VALUE(adjustTime_, adjustTime) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setAlipayTradeNo(string alipayTradeNo) { DARABONBA_PTR_SET_VALUE(alipayTradeNo_, alipayTradeNo) };


    // amountCurrency Field Functions 
    bool hasAmountCurrency() const { return this->amountCurrency_ != nullptr;};
    void deleteAmountCurrency() { this->amountCurrency_ = nullptr;};
    inline string amountCurrency() const { DARABONBA_PTR_GET_DEFAULT(amountCurrency_, "") };
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setAmountCurrency(string amountCurrency) { DARABONBA_PTR_SET_VALUE(amountCurrency_, amountCurrency) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setApplyArrCityCode(string applyArrCityCode) { DARABONBA_PTR_SET_VALUE(applyArrCityCode_, applyArrCityCode) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setApplyArrCityName(string applyArrCityName) { DARABONBA_PTR_SET_VALUE(applyArrCityName_, applyArrCityName) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setApplyDepCityCode(string applyDepCityCode) { DARABONBA_PTR_SET_VALUE(applyDepCityCode_, applyDepCityCode) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setApplyDepCityName(string applyDepCityName) { DARABONBA_PTR_SET_VALUE(applyDepCityName_, applyDepCityName) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setApplyExtendField(string applyExtendField) { DARABONBA_PTR_SET_VALUE(applyExtendField_, applyExtendField) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setApplyId(string applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setApproverEmail(string approverEmail) { DARABONBA_PTR_SET_VALUE(approverEmail_, approverEmail) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setApproverId(string approverId) { DARABONBA_PTR_SET_VALUE(approverId_, approverId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setApproverName(string approverName) { DARABONBA_PTR_SET_VALUE(approverName_, approverName) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setAverageNights(double averageNights) { DARABONBA_PTR_SET_VALUE(averageNights_, averageNights) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBaseLocation(string baseLocation) { DARABONBA_PTR_SET_VALUE(baseLocation_, baseLocation) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBillRecordTime(string billRecordTime) { DARABONBA_PTR_SET_VALUE(billRecordTime_, billRecordTime) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBookMode(string bookMode) { DARABONBA_PTR_SET_VALUE(bookMode_, bookMode) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBookReason(string bookReason) { DARABONBA_PTR_SET_VALUE(bookReason_, bookReason) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBookTime(string bookTime) { DARABONBA_PTR_SET_VALUE(bookTime_, bookTime) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBookerId(string bookerId) { DARABONBA_PTR_SET_VALUE(bookerId_, bookerId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBookerJobNo(string bookerJobNo) { DARABONBA_PTR_SET_VALUE(bookerJobNo_, bookerJobNo) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBookerName(string bookerName) { DARABONBA_PTR_SET_VALUE(bookerName_, bookerName) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBrandGroup(string brandGroup) { DARABONBA_PTR_SET_VALUE(brandGroup_, brandGroup) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBrandName(string brandName) { DARABONBA_PTR_SET_VALUE(brandName_, brandName) };


    // businessExpense Field Functions 
    bool hasBusinessExpense() const { return this->businessExpense_ != nullptr;};
    void deleteBusinessExpense() { this->businessExpense_ = nullptr;};
    inline int64_t businessExpense() const { DARABONBA_PTR_GET_DEFAULT(businessExpense_, 0L) };
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBusinessExpense(int64_t businessExpense) { DARABONBA_PTR_SET_VALUE(businessExpense_, businessExpense) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setBusinessTripResult(string businessTripResult) { DARABONBA_PTR_SET_VALUE(businessTripResult_, businessTripResult) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCapitalDirection(string capitalDirection) { DARABONBA_PTR_SET_VALUE(capitalDirection_, capitalDirection) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCascadeDepartment(string cascadeDepartment) { DARABONBA_PTR_SET_VALUE(cascadeDepartment_, cascadeDepartment) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCategoryDesc(string categoryDesc) { DARABONBA_PTR_SET_VALUE(categoryDesc_, categoryDesc) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCheckInDate(string checkInDate) { DARABONBA_PTR_SET_VALUE(checkInDate_, checkInDate) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCheckoutDate(string checkoutDate) { DARABONBA_PTR_SET_VALUE(checkoutDate_, checkoutDate) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCity(string city) { DARABONBA_PTR_SET_VALUE(city_, city) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCityCode(string cityCode) { DARABONBA_PTR_SET_VALUE(cityCode_, cityCode) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCorpRefundFee(double corpRefundFee) { DARABONBA_PTR_SET_VALUE(corpRefundFee_, corpRefundFee) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCorpTotalFee(double corpTotalFee) { DARABONBA_PTR_SET_VALUE(corpTotalFee_, corpTotalFee) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCostCenter(string costCenter) { DARABONBA_PTR_SET_VALUE(costCenter_, costCenter) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCostCenterNumber(string costCenterNumber) { DARABONBA_PTR_SET_VALUE(costCenterNumber_, costCenterNumber) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCostDepartment(string costDepartment) { DARABONBA_PTR_SET_VALUE(costDepartment_, costDepartment) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCountry(string country) { DARABONBA_PTR_SET_VALUE(country_, country) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCountryCode(string countryCode) { DARABONBA_PTR_SET_VALUE(countryCode_, countryCode) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setCustomContent(string customContent) { DARABONBA_PTR_SET_VALUE(customContent_, customContent) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setDeductibleTax(double deductibleTax) { DARABONBA_PTR_SET_VALUE(deductibleTax_, deductibleTax) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setDepartment(string department) { DARABONBA_PTR_SET_VALUE(department_, department) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setDepartmentId(string departmentId) { DARABONBA_PTR_SET_VALUE(departmentId_, departmentId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setExceedReason(string exceedReason) { DARABONBA_PTR_SET_VALUE(exceedReason_, exceedReason) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setFeeType(string feeType) { DARABONBA_PTR_SET_VALUE(feeType_, feeType) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setFeeTypeDesc(string feeTypeDesc) { DARABONBA_PTR_SET_VALUE(feeTypeDesc_, feeTypeDesc) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setFines(double fines) { DARABONBA_PTR_SET_VALUE(fines_, fines) };


    // foreignBusinessExpense Field Functions 
    bool hasForeignBusinessExpense() const { return this->foreignBusinessExpense_ != nullptr;};
    void deleteForeignBusinessExpense() { this->foreignBusinessExpense_ = nullptr;};
    inline int64_t foreignBusinessExpense() const { DARABONBA_PTR_GET_DEFAULT(foreignBusinessExpense_, 0L) };
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setForeignBusinessExpense(int64_t foreignBusinessExpense) { DARABONBA_PTR_SET_VALUE(foreignBusinessExpense_, foreignBusinessExpense) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setForeignersTag(string foreignersTag) { DARABONBA_PTR_SET_VALUE(foreignersTag_, foreignersTag) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setHotelName(string hotelName) { DARABONBA_PTR_SET_VALUE(hotelName_, hotelName) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setHotelStar(string hotelStar) { DARABONBA_PTR_SET_VALUE(hotelStar_, hotelStar) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setIndex(string index) { DARABONBA_PTR_SET_VALUE(index_, index) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setInvoiceTitle(string invoiceTitle) { DARABONBA_PTR_SET_VALUE(invoiceTitle_, invoiceTitle) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setIsEarlyDeparture(string isEarlyDeparture) { DARABONBA_PTR_SET_VALUE(isEarlyDeparture_, isEarlyDeparture) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setIsNegotiation(string isNegotiation) { DARABONBA_PTR_SET_VALUE(isNegotiation_, isNegotiation) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setIsShareStr(string isShareStr) { DARABONBA_PTR_SET_VALUE(isShareStr_, isShareStr) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setLocation(string location) { DARABONBA_PTR_SET_VALUE(location_, location) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setMainApplyId(string mainApplyId) { DARABONBA_PTR_SET_VALUE(mainApplyId_, mainApplyId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setMappingCompanyCode(string mappingCompanyCode) { DARABONBA_PTR_SET_VALUE(mappingCompanyCode_, mappingCompanyCode) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setNights(int32_t nights) { DARABONBA_PTR_SET_VALUE(nights_, nights) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setOrderId(string orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setOrderPrice(double orderPrice) { DARABONBA_PTR_SET_VALUE(orderPrice_, orderPrice) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setOrderStatusDesc(string orderStatusDesc) { DARABONBA_PTR_SET_VALUE(orderStatusDesc_, orderStatusDesc) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setOrderType(string orderType) { DARABONBA_PTR_SET_VALUE(orderType_, orderType) };
    ...
    inline string originalReserveRule() const { DARABONBA_PTR_GET_DEFAULT(originalReserveRule_, "") };
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setOriginalReserveRule(string originalReserveRule) { DARABONBA_PTR_SET_VALUE(originalReserveRule_, originalReserveRule) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setOverApplyId(string overApplyId) { DARABONBA_PTR_SET_VALUE(overApplyId_, overApplyId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setPaymentDepartmentId(string paymentDepartmentId) { DARABONBA_PTR_SET_VALUE(paymentDepartmentId_, paymentDepartmentId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setPaymentDepartmentName(string paymentDepartmentName) { DARABONBA_PTR_SET_VALUE(paymentDepartmentName_, paymentDepartmentName) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setPersonRefundFee(double personRefundFee) { DARABONBA_PTR_SET_VALUE(personRefundFee_, personRefundFee) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setPersonSettlePrice(double personSettlePrice) { DARABONBA_PTR_SET_VALUE(personSettlePrice_, personSettlePrice) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setPosition(string position) { DARABONBA_PTR_SET_VALUE(position_, position) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setPositionLevel(string positionLevel) { DARABONBA_PTR_SET_VALUE(positionLevel_, positionLevel) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setPrimaryId(int64_t primaryId) { DARABONBA_PTR_SET_VALUE(primaryId_, primaryId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setProcessorOaCode(string processorOaCode) { DARABONBA_PTR_SET_VALUE(processorOaCode_, processorOaCode) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setProjectCode(string projectCode) { DARABONBA_PTR_SET_VALUE(projectCode_, projectCode) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setProjectName(string projectName) { DARABONBA_PTR_SET_VALUE(projectName_, projectName) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setPromotionFee(double promotionFee) { DARABONBA_PTR_SET_VALUE(promotionFee_, promotionFee) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setRate(string rate) { DARABONBA_PTR_SET_VALUE(rate_, rate) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setReserveRule(int32_t reserveRule) { DARABONBA_PTR_SET_VALUE(reserveRule_, reserveRule) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setRoomNo(string roomNo) { DARABONBA_PTR_SET_VALUE(roomNo_, roomNo) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setRoomNumber(int32_t roomNumber) { DARABONBA_PTR_SET_VALUE(roomNumber_, roomNumber) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setRoomPrice(double roomPrice) { DARABONBA_PTR_SET_VALUE(roomPrice_, roomPrice) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setRoomType(string roomType) { DARABONBA_PTR_SET_VALUE(roomType_, roomType) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setServiceFee(double serviceFee) { DARABONBA_PTR_SET_VALUE(serviceFee_, serviceFee) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setSettleTypeDesc(string settleTypeDesc) { DARABONBA_PTR_SET_VALUE(settleTypeDesc_, settleTypeDesc) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setSettlementFee(double settlementFee) { DARABONBA_PTR_SET_VALUE(settlementFee_, settlementFee) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setSettlementGrantFee(double settlementGrantFee) { DARABONBA_PTR_SET_VALUE(settlementGrantFee_, settlementGrantFee) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setSettlementTime(string settlementTime) { DARABONBA_PTR_SET_VALUE(settlementTime_, settlementTime) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setSettlementType(string settlementType) { DARABONBA_PTR_SET_VALUE(settlementType_, settlementType) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setSio(string sio) { DARABONBA_PTR_SET_VALUE(sio_, sio) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setStatusDesc(string statusDesc) { DARABONBA_PTR_SET_VALUE(statusDesc_, statusDesc) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setSubOrderId(string subOrderId) { DARABONBA_PTR_SET_VALUE(subOrderId_, subOrderId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setTaxRate(string taxRate) { DARABONBA_PTR_SET_VALUE(taxRate_, taxRate) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setThirdInvoiceId(string thirdInvoiceId) { DARABONBA_PTR_SET_VALUE(thirdInvoiceId_, thirdInvoiceId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setThirdItineraryId(string thirdItineraryId) { DARABONBA_PTR_SET_VALUE(thirdItineraryId_, thirdItineraryId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setThirdPartBusinessId(string thirdPartBusinessId) { DARABONBA_PTR_SET_VALUE(thirdPartBusinessId_, thirdPartBusinessId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setThirdpartApplyId(string thirdpartApplyId) { DARABONBA_PTR_SET_VALUE(thirdpartApplyId_, thirdpartApplyId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setTotalNights(int32_t totalNights) { DARABONBA_PTR_SET_VALUE(totalNights_, totalNights) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setTradeActionDesc(string tradeActionDesc) { DARABONBA_PTR_SET_VALUE(tradeActionDesc_, tradeActionDesc) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setTravelerEmail(string travelerEmail) { DARABONBA_PTR_SET_VALUE(travelerEmail_, travelerEmail) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setTravelerId(string travelerId) { DARABONBA_PTR_SET_VALUE(travelerId_, travelerId) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setTravelerJobNo(string travelerJobNo) { DARABONBA_PTR_SET_VALUE(travelerJobNo_, travelerJobNo) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setTravelerMemberType(string travelerMemberType) { DARABONBA_PTR_SET_VALUE(travelerMemberType_, travelerMemberType) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setTravelerName(string travelerName) { DARABONBA_PTR_SET_VALUE(travelerName_, travelerName) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setVoucherType(int32_t voucherType) { DARABONBA_PTR_SET_VALUE(voucherType_, voucherType) };
    ...
    inline IeHotelBillSettlementQueryResponseBodyModuleDataList& setVoucherTypeDesc(string voucherTypeDesc) { DARABONBA_PTR_SET_VALUE(voucherTypeDesc_, voucherTypeDesc) };


  protected:
    std::shared_ptr<string> adjustTime_ = nullptr;
    std::shared_ptr<string> alipayTradeNo_ = nullptr;
    std::shared_ptr<string> amountCurrency_ = nullptr;
    ...
    std::shared_ptr<int64_t> businessExpense_ = nullptr;
    ...
    std::shared_ptr<int64_t> foreignBusinessExpense_ = nullptr;
    ...
    std::shared_ptr<string> originalReserveRule_ = nullptr;
