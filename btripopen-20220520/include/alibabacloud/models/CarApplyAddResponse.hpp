...
namespace Models
{
  ...
  public:
    ...
    inline const CarApplyAddResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CarApplyAddResponseBody) };
    inline CarApplyAddResponseBody getBody() { DARABONBA_PTR_GET(body_, CarApplyAddResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CarApplyAddResponseBody> body_ {};
  };
