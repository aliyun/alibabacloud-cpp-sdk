...
namespace Models
{
  ...
  public:
    ...
    inline const CommonApplySyncResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CommonApplySyncResponseBody) };
    inline CommonApplySyncResponseBody getBody() { DARABONBA_PTR_GET(body_, CommonApplySyncResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CommonApplySyncResponseBody> body_ {};
  };
