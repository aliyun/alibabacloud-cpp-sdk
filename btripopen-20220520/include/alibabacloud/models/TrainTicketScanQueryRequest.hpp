...
#ifndef ALIBABACLOUD_MODELS_TRAINTICKETSCANQUERYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_TRAINTICKETSCANQUERYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    TrainTicketScanQueryRequest() = default ;
    TrainTicketScanQueryRequest(const TrainTicketScanQueryRequest &) = default ;
    TrainTicketScanQueryRequest(TrainTicketScanQueryRequest &&) = default ;
    TrainTicketScanQueryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TrainTicketScanQueryRequest() = default ;
    TrainTicketScanQueryRequest& operator=(const TrainTicketScanQueryRequest &) = default ;
    TrainTicketScanQueryRequest& operator=(TrainTicketScanQueryRequest &&) = default ;
