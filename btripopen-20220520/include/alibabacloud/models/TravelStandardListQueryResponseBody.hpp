...
namespace Models
{
  ...
  public:
    ...
    inline const TravelStandardListQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TravelStandardListQueryResponseBodyModule) };
    inline TravelStandardListQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, TravelStandardListQueryResponseBodyModule) };
    inline TravelStandardListQueryResponseBody& setModule(const TravelStandardListQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TravelStandardListQueryResponseBody& setModule(TravelStandardListQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TravelStandardListQueryResponseBodyModule> module_ = nullptr;
