...
namespace Models
{
  ...
  public:
    ...
    inline const HotelSuggestV2ResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelSuggestV2ResponseBodyModule) };
    inline HotelSuggestV2ResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelSuggestV2ResponseBodyModule) };
    inline HotelSuggestV2ResponseBody& setModule(const HotelSuggestV2ResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelSuggestV2ResponseBody& setModule(HotelSuggestV2ResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelSuggestV2ResponseBodyModule> module_ = nullptr;
