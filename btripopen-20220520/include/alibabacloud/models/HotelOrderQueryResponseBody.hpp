...
namespace Models
{
  ...
  public:
    ...
    inline const HotelOrderQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelOrderQueryResponseBodyModule) };
    inline HotelOrderQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelOrderQueryResponseBodyModule) };
    inline HotelOrderQueryResponseBody& setModule(const HotelOrderQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelOrderQueryResponseBody& setModule(HotelOrderQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module。
    std::shared_ptr<HotelOrderQueryResponseBodyModule> module_ = nullptr;
    // requestId
