...
namespace Models
{
  ...
  public:
    ...
    inline const TrainOrderQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TrainOrderQueryResponseBodyModule) };
    inline TrainOrderQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, TrainOrderQueryResponseBodyModule) };
    inline TrainOrderQueryResponseBody& setModule(const TrainOrderQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainOrderQueryResponseBody& setModule(TrainOrderQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TrainOrderQueryResponseBodyModule> module_ = nullptr;
