...
namespace Models
{
  ...
  public:
    ...
    inline string getPassengerSegmentInfoListShrink() const { DARABONBA_PTR_GET_DEFAULT(passengerSegmentInfoListShrink_, "") };
    ...
    inline string getRefundVoucherInfoShrink() const { DARABONBA_PTR_GET_DEFAULT(refundVoucherInfoShrink_, "") };
