...
namespace Models
{
  ...
  public:
    ...
    inline const IsvRuleSaveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IsvRuleSaveResponseBody) };
    inline IsvRuleSaveResponseBody getBody() { DARABONBA_PTR_GET(body_, IsvRuleSaveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IsvRuleSaveResponseBody> body_ {};
  };
