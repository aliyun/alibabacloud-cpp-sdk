...
#ifndef ALIBABACLOUD_MODELS_INTLFLIGHTOTASEARCHRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_INTLFLIGHTOTASEARCHRESPONSEBODY_HPP_
...
namespace Models
{
  class IntlFlightOtaSearchResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IntlFlightOtaSearchResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IntlFlightOtaSearchResponseBody& obj) { 
    ...
    IntlFlightOtaSearchResponseBody() = default ;
    IntlFlightOtaSearchResponseBody(const IntlFlightOtaSearchResponseBody &) = default ;
    IntlFlightOtaSearchResponseBody(IntlFlightOtaSearchResponseBody &&) = default ;
    IntlFlightOtaSearchResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IntlFlightOtaSearchResponseBody() = default ;
    IntlFlightOtaSearchResponseBody& operator=(const IntlFlightOtaSearchResponseBody &) = default ;
    IntlFlightOtaSearchResponseBody& operator=(IntlFlightOtaSearchResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->structuredRefund_ == nullptr; };
            ...
            inline const map<string, vector<ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue>> & getOfferPenaltyInfoMap() const { DARABONBA_PTR_GET_CONST(offerPenaltyInfoMap_, map<string, vector<ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue>>) };
            inline map<string, vector<ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue>> getOfferPenaltyInfoMap() { DARABONBA_PTR_GET(offerPenaltyInfoMap_, map<string, vector<ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue>>) };
            inline RefundChangeRule& setOfferPenaltyInfoMap(const map<string, vector<ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue>> & offerPenaltyInfoMap) { DARABONBA_PTR_SET_VALUE(offerPenaltyInfoMap_, offerPenaltyInfoMap) };
            inline RefundChangeRule& setOfferPenaltyInfoMap(map<string, vector<ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue>> && offerPenaltyInfoMap) { DARABONBA_PTR_SET_RVALUE(offerPenaltyInfoMap_, offerPenaltyInfoMap) };
          ...
          protected:
            ...
            shared_ptr<map<string, vector<ModuleItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue>>> offerPenaltyInfoMap_ {};
        ...
        && this->offerBaggageInfoMap_ == nullptr && this->structuredBaggage_ == nullptr; };
            ...
            inline const map<string, vector<ModuleItemListSubItemsBaggageRuleOfferBaggageInfoMapValue>> & getOfferBaggageInfoMap() const { DARABONBA_PTR_GET_CONST(offerBaggageInfoMap_, map<string, vector<ModuleItemListSubItemsBaggageRuleOfferBaggageInfoMapValue>>) };
            inline map<string, vector<ModuleItemListSubItemsBaggageRuleOfferBaggageInfoMapValue>> getOfferBaggageInfoMap() { DARABONBA_PTR_GET(offerBaggageInfoMap_, map<string, vector<ModuleItemListSubItemsBaggageRuleOfferBaggageInfoMapValue>>) };
            inline BaggageRule& setOfferBaggageInfoMap(const map<string, vector<ModuleItemListSubItemsBaggageRuleOfferBaggageInfoMapValue>> & offerBaggageInfoMap) { DARABONBA_PTR_SET_VALUE(offerBaggageInfoMap_, offerBaggageInfoMap) };
            inline BaggageRule& setOfferBaggageInfoMap(map<string, vector<ModuleItemListSubItemsBaggageRuleOfferBaggageInfoMapValue>> && offerBaggageInfoMap) { DARABONBA_PTR_SET_RVALUE(offerBaggageInfoMap_, offerBaggageInfoMap) };
          ...
          protected:
            ...
            shared_ptr<map<string, vector<ModuleItemListSubItemsBaggageRuleOfferBaggageInfoMapValue>>> offerBaggageInfoMap_ {};
        ...
        && this->type_ == nullptr; };
          ...
          inline AgreementPriceCodes& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
        ...
        inline const vector<ItemList::AgreementPriceCodes> & getAgreementPriceCodes() const { DARABONBA_PTR_GET_CONST(agreementPriceCodes_, vector<ItemList::AgreementPriceCodes>) };
        inline vector<ItemList::AgreementPriceCodes> getAgreementPriceCodes() { DARABONBA_PTR_GET(agreementPriceCodes_, vector<ItemList::AgreementPriceCodes>) };
        inline ItemList& setAgreementPriceCodes(const vector<ItemList::AgreementPriceCodes> & agreementPriceCodes) { DARABONBA_PTR_SET_VALUE(agreementPriceCodes_, agreementPriceCodes) };
        inline ItemList& setAgreementPriceCodes(vector<ItemList::AgreementPriceCodes> && agreementPriceCodes) { DARABONBA_PTR_SET_RVALUE(agreementPriceCodes_, agreementPriceCodes) };
        ...
        inline ItemList& setItemType(string itemType) { DARABONBA_PTR_SET_VALUE(itemType_, itemType) };
        ...
        inline const vector<ItemList::LabelList> & getLabelList() const { DARABONBA_PTR_GET_CONST(labelList_, vector<ItemList::LabelList>) };
        inline vector<ItemList::LabelList> getLabelList() { DARABONBA_PTR_GET(labelList_, vector<ItemList::LabelList>) };
        inline ItemList& setLabelList(const vector<ItemList::LabelList> & labelList) { DARABONBA_PTR_SET_VALUE(labelList_, labelList) };
        inline ItemList& setLabelList(vector<ItemList::LabelList> && labelList) { DARABONBA_PTR_SET_RVALUE(labelList_, labelList) };
      ...
      protected:
        shared_ptr<vector<ItemList::AgreementPriceCodes>> agreementPriceCodes_ {};
        shared_ptr<string> itemId_ {};
        shared_ptr<string> itemType_ {};
        shared_ptr<vector<ItemList::LabelList>> labelList_ {};
    ...
    void deleteCode() { this->code_ = nullptr;};
    inline string getCode() const { DARABONBA_PTR_GET_DEFAULT(code_, "") };
    inline IntlFlightOtaSearchResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline IntlFlightOtaSearchResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const IntlFlightOtaSearchResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightOtaSearchResponseBody::Module) };
    inline IntlFlightOtaSearchResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, IntlFlightOtaSearchResponseBody::Module) };
    inline IntlFlightOtaSearchResponseBody& setModule(const IntlFlightOtaSearchResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightOtaSearchResponseBody& setModule(IntlFlightOtaSearchResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline IntlFlightOtaSearchResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline IntlFlightOtaSearchResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline IntlFlightOtaSearchResponseBody& setTraceId(string traceId) { DARABONBA_PTR_SET_VALUE(traceId_, traceId) };
