...
namespace Models
{
  ...
  public:
    ...
    inline const InsureOrderRefundResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, InsureOrderRefundResponseBodyModule) };
    inline InsureOrderRefundResponseBodyModule module() { DARABONBA_PTR_GET(module_, InsureOrderRefundResponseBodyModule) };
    inline InsureOrderRefundResponseBody& setModule(const InsureOrderRefundResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline InsureOrderRefundResponseBody& setModule(InsureOrderRefundResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<InsureOrderRefundResponseBodyModule> module_ = nullptr;
