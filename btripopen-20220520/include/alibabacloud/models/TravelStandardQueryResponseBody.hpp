...
namespace Models
{
  ...
  public:
    ...
    inline const TravelStandardQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TravelStandardQueryResponseBodyModule) };
    inline TravelStandardQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, TravelStandardQueryResponseBodyModule) };
    inline TravelStandardQueryResponseBody& setModule(const TravelStandardQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TravelStandardQueryResponseBody& setModule(TravelStandardQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TravelStandardQueryResponseBodyModule> module_ = nullptr;
