...
namespace Models
{
  ...
  public:
    ...
    inline const QueryEmployeeDetailResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, QueryEmployeeDetailResponseBodyModule) };
    inline QueryEmployeeDetailResponseBodyModule module() { DARABONBA_PTR_GET(module_, QueryEmployeeDetailResponseBodyModule) };
    inline QueryEmployeeDetailResponseBody& setModule(const QueryEmployeeDetailResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline QueryEmployeeDetailResponseBody& setModule(QueryEmployeeDetailResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<QueryEmployeeDetailResponseBodyModule> module_ = nullptr;
