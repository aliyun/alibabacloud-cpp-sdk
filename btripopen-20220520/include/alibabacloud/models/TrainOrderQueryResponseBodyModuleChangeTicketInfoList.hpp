...
#ifndef ALIBABACLOUD_MODELS_TRAINORDERQUERYRESPONSEBODYMODULECHANGETICKETINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_TRAINORDERQUERYRESPONSEBODYMODULECHANGETICKETINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const TrainOrderQueryResponseBodyModuleChangeTicketInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TrainOrderQueryResponseBodyModuleChangeTicketInfoList& obj) { 
    ...
    TrainOrderQueryResponseBodyModuleChangeTicketInfoList() = default ;
    TrainOrderQueryResponseBodyModuleChangeTicketInfoList(const TrainOrderQueryResponseBodyModuleChangeTicketInfoList &) = default ;
    TrainOrderQueryResponseBodyModuleChangeTicketInfoList(TrainOrderQueryResponseBodyModuleChangeTicketInfoList &&) = default ;
    TrainOrderQueryResponseBodyModuleChangeTicketInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TrainOrderQueryResponseBodyModuleChangeTicketInfoList() = default ;
    TrainOrderQueryResponseBodyModuleChangeTicketInfoList& operator=(const TrainOrderQueryResponseBodyModuleChangeTicketInfoList &) = default ;
    TrainOrderQueryResponseBodyModuleChangeTicketInfoList& operator=(TrainOrderQueryResponseBodyModuleChangeTicketInfoList &&) = default ;
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setChangeCoachNo(string changeCoachNo) { DARABONBA_PTR_SET_VALUE(changeCoachNo_, changeCoachNo) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setChangeGapFee(double changeGapFee) { DARABONBA_PTR_SET_VALUE(changeGapFee_, changeGapFee) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setChangeHandlingFee(double changeHandlingFee) { DARABONBA_PTR_SET_VALUE(changeHandlingFee_, changeHandlingFee) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setChangeSeatNo(string changeSeatNo) { DARABONBA_PTR_SET_VALUE(changeSeatNo_, changeSeatNo) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setChangeSeatTypeName(string changeSeatTypeName) { DARABONBA_PTR_SET_VALUE(changeSeatTypeName_, changeSeatTypeName) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setChangeServiceFee(double changeServiceFee) { DARABONBA_PTR_SET_VALUE(changeServiceFee_, changeServiceFee) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setChangeTrainNo(string changeTrainNo) { DARABONBA_PTR_SET_VALUE(changeTrainNo_, changeTrainNo) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setChangeTrainTypeName(string changeTrainTypeName) { DARABONBA_PTR_SET_VALUE(changeTrainTypeName_, changeTrainTypeName) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setCheckInTime(string checkInTime) { DARABONBA_PTR_SET_VALUE(checkInTime_, checkInTime) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setCheckOutTime(string checkOutTime) { DARABONBA_PTR_SET_VALUE(checkOutTime_, checkOutTime) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setFromStationName(string fromStationName) { DARABONBA_PTR_SET_VALUE(fromStationName_, fromStationName) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setGmtModify(string gmtModify) { DARABONBA_PTR_SET_VALUE(gmtModify_, gmtModify) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setOriginTicketNo(string originTicketNo) { DARABONBA_PTR_SET_VALUE(originTicketNo_, originTicketNo) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setOutTicketStatus(string outTicketStatus) { DARABONBA_PTR_SET_VALUE(outTicketStatus_, outTicketStatus) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setTicketNo(string ticketNo) { DARABONBA_PTR_SET_VALUE(ticketNo_, ticketNo) };
    ...
    inline TrainOrderQueryResponseBodyModuleChangeTicketInfoList& setToStationName(string toStationName) { DARABONBA_PTR_SET_VALUE(toStationName_, toStationName) };
