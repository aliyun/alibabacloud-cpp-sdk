...
namespace Models
{
  ...
  public:
    ...
    inline const HotelCityCodeListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, HotelCityCodeListResponseBody) };
    inline HotelCityCodeListResponseBody getBody() { DARABONBA_PTR_GET(body_, HotelCityCodeListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<HotelCityCodeListResponseBody> body_ {};
  };
