...
namespace Models
{
  ...
  public:
    ...
    inline const vector<HotelOrderListQueryResponseBodyModule> & module() const { DARABONBA_PTR_GET_CONST(module_, vector<HotelOrderListQueryResponseBodyModule>) };
    inline vector<HotelOrderListQueryResponseBodyModule> module() { DARABONBA_PTR_GET(module_, vector<HotelOrderListQueryResponseBodyModule>) };
    inline HotelOrderListQueryResponseBody& setModule(const vector<HotelOrderListQueryResponseBodyModule> & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelOrderListQueryResponseBody& setModule(vector<HotelOrderListQueryResponseBodyModule> && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };


    // pageInfo Field Functions 
    bool hasPageInfo() const { return this->pageInfo_ != nullptr;};
    void deletePageInfo() { this->pageInfo_ = nullptr;};
    inline const HotelOrderListQueryResponseBodyPageInfo & pageInfo() const { DARABONBA_PTR_GET_CONST(pageInfo_, HotelOrderListQueryResponseBodyPageInfo) };
    inline HotelOrderListQueryResponseBodyPageInfo pageInfo() { DARABONBA_PTR_GET(pageInfo_, HotelOrderListQueryResponseBodyPageInfo) };
    inline HotelOrderListQueryResponseBody& setPageInfo(const HotelOrderListQueryResponseBodyPageInfo & pageInfo) { DARABONBA_PTR_SET_VALUE(pageInfo_, pageInfo) };
    inline HotelOrderListQueryResponseBody& setPageInfo(HotelOrderListQueryResponseBodyPageInfo && pageInfo) { DARABONBA_PTR_SET_RVALUE(pageInfo_, pageInfo) };
  ...
  protected:
    ...
    std::shared_ptr<vector<HotelOrderListQueryResponseBodyModule>> module_ = nullptr;
    std::shared_ptr<HotelOrderListQueryResponseBodyPageInfo> pageInfo_ = nullptr;
