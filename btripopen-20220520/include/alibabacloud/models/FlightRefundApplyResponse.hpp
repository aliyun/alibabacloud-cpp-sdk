...
namespace Models
{
  ...
  public:
    ...
    inline const FlightRefundApplyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FlightRefundApplyResponseBody) };
    inline FlightRefundApplyResponseBody getBody() { DARABONBA_PTR_GET(body_, FlightRefundApplyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FlightRefundApplyResponseBody> body_ {};
  };
