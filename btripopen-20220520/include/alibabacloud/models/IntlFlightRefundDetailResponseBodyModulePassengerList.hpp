...
#ifndef ALIBABACLOUD_MODELS_INTLFLIGHTREFUNDDETAILRESPONSEBODYMODULEPASSENGERLIST_HPP_
#define ALIBABACLOUD_MODELS_INTLFLIGHTREFUNDDETAILRESPONSEBODYMODULEPASSENGERLIST_HPP_
...
namespace Models
{
  class IntlFlightRefundDetailResponseBodyModulePassengerList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IntlFlightRefundDetailResponseBodyModulePassengerList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IntlFlightRefundDetailResponseBodyModulePassengerList& obj) { 
    ...
    IntlFlightRefundDetailResponseBodyModulePassengerList() = default ;
    IntlFlightRefundDetailResponseBodyModulePassengerList(const IntlFlightRefundDetailResponseBodyModulePassengerList &) = default ;
    IntlFlightRefundDetailResponseBodyModulePassengerList(IntlFlightRefundDetailResponseBodyModulePassengerList &&) = default ;
    IntlFlightRefundDetailResponseBodyModulePassengerList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IntlFlightRefundDetailResponseBodyModulePassengerList() = default ;
    IntlFlightRefundDetailResponseBodyModulePassengerList& operator=(const IntlFlightRefundDetailResponseBodyModulePassengerList &) = default ;
    IntlFlightRefundDetailResponseBodyModulePassengerList& operator=(IntlFlightRefundDetailResponseBodyModulePassengerList &&) = default ;
    ...
    inline IntlFlightRefundDetailResponseBodyModulePassengerList& setBirthday(string birthday) { DARABONBA_PTR_SET_VALUE(birthday_, birthday) };
    ...
    inline IntlFlightRefundDetailResponseBodyModulePassengerList& setFullName(string fullName) { DARABONBA_PTR_SET_VALUE(fullName_, fullName) };
    ...
    inline IntlFlightRefundDetailResponseBodyModulePassengerList& setGender(int32_t gender) { DARABONBA_PTR_SET_VALUE(gender_, gender) };
    ...
    inline IntlFlightRefundDetailResponseBodyModulePassengerList& setJobNo(string jobNo) { DARABONBA_PTR_SET_VALUE(jobNo_, jobNo) };
    ...
    inline IntlFlightRefundDetailResponseBodyModulePassengerList& setNationality(string nationality) { DARABONBA_PTR_SET_VALUE(nationality_, nationality) };
    ...
    inline IntlFlightRefundDetailResponseBodyModulePassengerList& setNationalityCode(string nationalityCode) { DARABONBA_PTR_SET_VALUE(nationalityCode_, nationalityCode) };
    ...
    inline IntlFlightRefundDetailResponseBodyModulePassengerList& setPassengerId(int64_t passengerId) { DARABONBA_PTR_SET_VALUE(passengerId_, passengerId) };
    ...
    inline IntlFlightRefundDetailResponseBodyModulePassengerList& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline IntlFlightRefundDetailResponseBodyModulePassengerList& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline IntlFlightRefundDetailResponseBodyModulePassengerList& setUserType(int32_t userType) { DARABONBA_PTR_SET_VALUE(userType_, userType) };
