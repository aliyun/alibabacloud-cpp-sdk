...
#ifndef ALIBABACLOUD_MODELS_FLIGHTBILLSETTLEMENTQUERYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTBILLSETTLEMENTQUERYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightBillSettlementQueryRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightBillSettlementQueryRequest& obj) { 
    ...
    FlightBillSettlementQueryRequest() = default ;
    FlightBillSettlementQueryRequest(const FlightBillSettlementQueryRequest &) = default ;
    FlightBillSettlementQueryRequest(FlightBillSettlementQueryRequest &&) = default ;
    FlightBillSettlementQueryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightBillSettlementQueryRequest() = default ;
    FlightBillSettlementQueryRequest& operator=(const FlightBillSettlementQueryRequest &) = default ;
    FlightBillSettlementQueryRequest& operator=(FlightBillSettlementQueryRequest &&) = default ;
    ...
    inline FlightBillSettlementQueryRequest& setApplyId(string applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline FlightBillSettlementQueryRequest& setBillBatch(string billBatch) { DARABONBA_PTR_SET_VALUE(billBatch_, billBatch) };
    ...
    inline FlightBillSettlementQueryRequest& setBillRecordTimeEnd(string billRecordTimeEnd) { DARABONBA_PTR_SET_VALUE(billRecordTimeEnd_, billRecordTimeEnd) };
    ...
    inline FlightBillSettlementQueryRequest& setBillRecordTimeStart(string billRecordTimeStart) { DARABONBA_PTR_SET_VALUE(billRecordTimeStart_, billRecordTimeStart) };
    ...
    inline FlightBillSettlementQueryRequest& setOrderId(int64_t orderId) { DARABONBA_PTR_SET_VALUE(orderId_, orderId) };
    ...
    inline FlightBillSettlementQueryRequest& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline FlightBillSettlementQueryRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline FlightBillSettlementQueryRequest& setPeriodEnd(string periodEnd) { DARABONBA_PTR_SET_VALUE(periodEnd_, periodEnd) };
    ...
    inline FlightBillSettlementQueryRequest& setPeriodStart(string periodStart) { DARABONBA_PTR_SET_VALUE(periodStart_, periodStart) };
    ...
    inline FlightBillSettlementQueryRequest& setScrollId(string scrollId) { DARABONBA_PTR_SET_VALUE(scrollId_, scrollId) };
    ...
    inline FlightBillSettlementQueryRequest& setScrollMod(bool scrollMod) { DARABONBA_PTR_SET_VALUE(scrollMod_, scrollMod) };
