...
#ifndef ALIBABACLOUD_MODELS_MODULERESHOPITEMLISTSUBITEMSSHOPPINGITEMMAPVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULERESHOPITEMLISTSUBITEMSSHOPPINGITEMMAPVALUE_HPP_
...
namespace Models
{
  class ModuleReShopItemListSubItemsShoppingItemMapValue : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModuleReShopItemListSubItemsShoppingItemMapValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleReShopItemListSubItemsShoppingItemMapValue& obj) { 
    ...
    ModuleReShopItemListSubItemsShoppingItemMapValue() = default ;
    ModuleReShopItemListSubItemsShoppingItemMapValue(const ModuleReShopItemListSubItemsShoppingItemMapValue &) = default ;
    ModuleReShopItemListSubItemsShoppingItemMapValue(ModuleReShopItemListSubItemsShoppingItemMapValue &&) = default ;
    ModuleReShopItemListSubItemsShoppingItemMapValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleReShopItemListSubItemsShoppingItemMapValue() = default ;
    ModuleReShopItemListSubItemsShoppingItemMapValue& operator=(const ModuleReShopItemListSubItemsShoppingItemMapValue &) = default ;
    ModuleReShopItemListSubItemsShoppingItemMapValue& operator=(ModuleReShopItemListSubItemsShoppingItemMapValue &&) = default ;
    ...
    inline const vector<ModuleReShopItemListSubItemsShoppingItemMapValue::CabinQuantityList> & getCabinQuantityList() const { DARABONBA_PTR_GET_CONST(cabinQuantityList_, vector<ModuleReShopItemListSubItemsShoppingItemMapValue::CabinQuantityList>) };
    inline vector<ModuleReShopItemListSubItemsShoppingItemMapValue::CabinQuantityList> getCabinQuantityList() { DARABONBA_PTR_GET(cabinQuantityList_, vector<ModuleReShopItemListSubItemsShoppingItemMapValue::CabinQuantityList>) };
    inline ModuleReShopItemListSubItemsShoppingItemMapValue& setCabinQuantityList(const vector<ModuleReShopItemListSubItemsShoppingItemMapValue::CabinQuantityList> & cabinQuantityList) { DARABONBA_PTR_SET_VALUE(cabinQuantityList_, cabinQuantityList) };
    inline ModuleReShopItemListSubItemsShoppingItemMapValue& setCabinQuantityList(vector<ModuleReShopItemListSubItemsShoppingItemMapValue::CabinQuantityList> && cabinQuantityList) { DARABONBA_PTR_SET_RVALUE(cabinQuantityList_, cabinQuantityList) };


    // searchPrice Field Functions 
    bool hasSearchPrice() const { return this->searchPrice_ != nullptr;};
    void deleteSearchPrice() { this->searchPrice_ = nullptr;};
    inline const ModuleReShopItemListSubItemsShoppingItemMapValue::SearchPrice & getSearchPrice() const { DARABONBA_PTR_GET_CONST(searchPrice_, ModuleReShopItemListSubItemsShoppingItemMapValue::SearchPrice) };
    inline ModuleReShopItemListSubItemsShoppingItemMapValue::SearchPrice getSearchPrice() { DARABONBA_PTR_GET(searchPrice_, ModuleReShopItemListSubItemsShoppingItemMapValue::SearchPrice) };
    inline ModuleReShopItemListSubItemsShoppingItemMapValue& setSearchPrice(const ModuleReShopItemListSubItemsShoppingItemMapValue::SearchPrice & searchPrice) { DARABONBA_PTR_SET_VALUE(searchPrice_, searchPrice) };
    inline ModuleReShopItemListSubItemsShoppingItemMapValue& setSearchPrice(ModuleReShopItemListSubItemsShoppingItemMapValue::SearchPrice && searchPrice) { DARABONBA_PTR_SET_RVALUE(searchPrice_, searchPrice) };
    ...
    inline const vector<ModuleReShopItemListSubItemsShoppingItemMapValue::SegmentPriceList> & getSegmentPriceList() const { DARABONBA_PTR_GET_CONST(segmentPriceList_, vector<ModuleReShopItemListSubItemsShoppingItemMapValue::SegmentPriceList>) };
    inline vector<ModuleReShopItemListSubItemsShoppingItemMapValue::SegmentPriceList> getSegmentPriceList() { DARABONBA_PTR_GET(segmentPriceList_, vector<ModuleReShopItemListSubItemsShoppingItemMapValue::SegmentPriceList>) };
    inline ModuleReShopItemListSubItemsShoppingItemMapValue& setSegmentPriceList(const vector<ModuleReShopItemListSubItemsShoppingItemMapValue::SegmentPriceList> & segmentPriceList) { DARABONBA_PTR_SET_VALUE(segmentPriceList_, segmentPriceList) };
    inline ModuleReShopItemListSubItemsShoppingItemMapValue& setSegmentPriceList(vector<ModuleReShopItemListSubItemsShoppingItemMapValue::SegmentPriceList> && segmentPriceList) { DARABONBA_PTR_SET_RVALUE(segmentPriceList_, segmentPriceList) };


  protected:
    // The remaining cabin inventory for each segment.
    shared_ptr<vector<ModuleReShopItemListSubItemsShoppingItemMapValue::CabinQuantityList>> cabinQuantityList_ {};
    // The rebooking search price.
    shared_ptr<ModuleReShopItemListSubItemsShoppingItemMapValue::SearchPrice> searchPrice_ {};
    ...
    shared_ptr<vector<ModuleReShopItemListSubItemsShoppingItemMapValue::SegmentPriceList>> segmentPriceList_ {};
  };
