...
namespace Models
{
  ...
  public:
    ...
    inline const FlightSearchListResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightSearchListResponseBodyModule) };
    inline FlightSearchListResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightSearchListResponseBodyModule) };
    inline FlightSearchListResponseBody& setModule(const FlightSearchListResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightSearchListResponseBody& setModule(FlightSearchListResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<FlightSearchListResponseBodyModule> module_ = nullptr;
