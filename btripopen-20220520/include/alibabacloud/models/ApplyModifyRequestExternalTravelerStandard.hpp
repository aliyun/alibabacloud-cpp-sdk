...
#ifndef ALIBABACLOUD_MODELS_APPLYMODIFYREQUESTEXTERNALTRAVELERSTANDARD_HPP_
#define ALIBABACLOUD_MODELS_APPLYMODIFYREQUESTEXTERNALTRAVELERSTANDARD_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ApplyModifyRequestExternalTravelerStandard& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ApplyModifyRequestExternalTravelerStandard& obj) { 
    ...
    ApplyModifyRequestExternalTravelerStandard() = default ;
    ApplyModifyRequestExternalTravelerStandard(const ApplyModifyRequestExternalTravelerStandard &) = default ;
    ApplyModifyRequestExternalTravelerStandard(ApplyModifyRequestExternalTravelerStandard &&) = default ;
    ApplyModifyRequestExternalTravelerStandard(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ApplyModifyRequestExternalTravelerStandard() = default ;
    ApplyModifyRequestExternalTravelerStandard& operator=(const ApplyModifyRequestExternalTravelerStandard &) = default ;
    ApplyModifyRequestExternalTravelerStandard& operator=(ApplyModifyRequestExternalTravelerStandard &&) = default ;
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setBusinessDiscount(int32_t businessDiscount) { DARABONBA_PTR_SET_VALUE(businessDiscount_, businessDiscount) };
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setEconomyDiscount(int32_t economyDiscount) { DARABONBA_PTR_SET_VALUE(economyDiscount_, economyDiscount) };
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setFirstDiscount(int32_t firstDiscount) { DARABONBA_PTR_SET_VALUE(firstDiscount_, firstDiscount) };
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setFlightCabins(string flightCabins) { DARABONBA_PTR_SET_VALUE(flightCabins_, flightCabins) };
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setFlightIntlRuleCode(int64_t flightIntlRuleCode) { DARABONBA_PTR_SET_VALUE(flightIntlRuleCode_, flightIntlRuleCode) };
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setFlightRuleCode(int64_t flightRuleCode) { DARABONBA_PTR_SET_VALUE(flightRuleCode_, flightRuleCode) };
    ...
    inline const vector<Models::ApplyModifyRequestExternalTravelerStandardHotelCitys> & hotelCitys() const { DARABONBA_PTR_GET_CONST(hotelCitys_, vector<Models::ApplyModifyRequestExternalTravelerStandardHotelCitys>) };
    inline vector<Models::ApplyModifyRequestExternalTravelerStandardHotelCitys> hotelCitys() { DARABONBA_PTR_GET(hotelCitys_, vector<Models::ApplyModifyRequestExternalTravelerStandardHotelCitys>) };
    inline ApplyModifyRequestExternalTravelerStandard& setHotelCitys(const vector<Models::ApplyModifyRequestExternalTravelerStandardHotelCitys> & hotelCitys) { DARABONBA_PTR_SET_VALUE(hotelCitys_, hotelCitys) };
    inline ApplyModifyRequestExternalTravelerStandard& setHotelCitys(vector<Models::ApplyModifyRequestExternalTravelerStandardHotelCitys> && hotelCitys) { DARABONBA_PTR_SET_RVALUE(hotelCitys_, hotelCitys) };
    ...
    inline const vector<Models::ApplyModifyRequestExternalTravelerStandardHotelIntlCitys> & hotelIntlCitys() const { DARABONBA_PTR_GET_CONST(hotelIntlCitys_, vector<Models::ApplyModifyRequestExternalTravelerStandardHotelIntlCitys>) };
    inline vector<Models::ApplyModifyRequestExternalTravelerStandardHotelIntlCitys> hotelIntlCitys() { DARABONBA_PTR_GET(hotelIntlCitys_, vector<Models::ApplyModifyRequestExternalTravelerStandardHotelIntlCitys>) };
    inline ApplyModifyRequestExternalTravelerStandard& setHotelIntlCitys(const vector<Models::ApplyModifyRequestExternalTravelerStandardHotelIntlCitys> & hotelIntlCitys) { DARABONBA_PTR_SET_VALUE(hotelIntlCitys_, hotelIntlCitys) };
    inline ApplyModifyRequestExternalTravelerStandard& setHotelIntlCitys(vector<Models::ApplyModifyRequestExternalTravelerStandardHotelIntlCitys> && hotelIntlCitys) { DARABONBA_PTR_SET_RVALUE(hotelIntlCitys_, hotelIntlCitys) };
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setHotelIntlRuleCode(int64_t hotelIntlRuleCode) { DARABONBA_PTR_SET_VALUE(hotelIntlRuleCode_, hotelIntlRuleCode) };
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setHotelRuleCode(int64_t hotelRuleCode) { DARABONBA_PTR_SET_VALUE(hotelRuleCode_, hotelRuleCode) };
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setPremiumEconomyDiscount(int32_t premiumEconomyDiscount) { DARABONBA_PTR_SET_VALUE(premiumEconomyDiscount_, premiumEconomyDiscount) };
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setReserveType(int32_t reserveType) { DARABONBA_PTR_SET_VALUE(reserveType_, reserveType) };
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setTrainRuleCode(int64_t trainRuleCode) { DARABONBA_PTR_SET_VALUE(trainRuleCode_, trainRuleCode) };
    ...
    inline ApplyModifyRequestExternalTravelerStandard& setTrainSeats(string trainSeats) { DARABONBA_PTR_SET_VALUE(trainSeats_, trainSeats) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::ApplyModifyRequestExternalTravelerStandardHotelCitys>> hotelCitys_ = nullptr;
    std::shared_ptr<vector<Models::ApplyModifyRequestExternalTravelerStandardHotelIntlCitys>> hotelIntlCitys_ = nullptr;
