...
#ifndef ALIBABACLOUD_MODELS_TRAINNOLISTSEARCHRESPONSEBODYMODULETRAINSTATIONSEARCHVOS_HPP_
#define ALIBABACLOUD_MODELS_TRAINNOLISTSEARCHRESPONSEBODYMODULETRAINSTATIONSEARCHVOS_HPP_
...
namespace Models
{
  class TrainNoListSearchResponseBodyModuleTrainStationSearchVOS : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& obj) { 
    ...
    TrainNoListSearchResponseBodyModuleTrainStationSearchVOS() = default ;
    TrainNoListSearchResponseBodyModuleTrainStationSearchVOS(const TrainNoListSearchResponseBodyModuleTrainStationSearchVOS &) = default ;
    TrainNoListSearchResponseBodyModuleTrainStationSearchVOS(TrainNoListSearchResponseBodyModuleTrainStationSearchVOS &&) = default ;
    TrainNoListSearchResponseBodyModuleTrainStationSearchVOS(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TrainNoListSearchResponseBodyModuleTrainStationSearchVOS() = default ;
    TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& operator=(const TrainNoListSearchResponseBodyModuleTrainStationSearchVOS &) = default ;
    TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& operator=(TrainNoListSearchResponseBodyModuleTrainStationSearchVOS &&) = default ;
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setArrDayTag(string arrDayTag) { DARABONBA_PTR_SET_VALUE(arrDayTag_, arrDayTag) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setArrStationCode(string arrStationCode) { DARABONBA_PTR_SET_VALUE(arrStationCode_, arrStationCode) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setArrStationName(string arrStationName) { DARABONBA_PTR_SET_VALUE(arrStationName_, arrStationName) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setArrTime(string arrTime) { DARABONBA_PTR_SET_VALUE(arrTime_, arrTime) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setCostTime(string costTime) { DARABONBA_PTR_SET_VALUE(costTime_, costTime) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setDepStationCode(string depStationCode) { DARABONBA_PTR_SET_VALUE(depStationCode_, depStationCode) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setDepStationName(string depStationName) { DARABONBA_PTR_SET_VALUE(depStationName_, depStationName) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setDepTime(string depTime) { DARABONBA_PTR_SET_VALUE(depTime_, depTime) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setIsEndStation(int32_t isEndStation) { DARABONBA_PTR_SET_VALUE(isEndStation_, isEndStation) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setIsStartStation(int32_t isStartStation) { DARABONBA_PTR_SET_VALUE(isStartStation_, isStartStation) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setPrice(string price) { DARABONBA_PTR_SET_VALUE(price_, price) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setSaleFlag(string saleFlag) { DARABONBA_PTR_SET_VALUE(saleFlag_, saleFlag) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setSaleFlagMsg(string saleFlagMsg) { DARABONBA_PTR_SET_VALUE(saleFlagMsg_, saleFlagMsg) };
    ...
    inline string seagmentIndex() const { DARABONBA_PTR_GET_DEFAULT(seagmentIndex_, "") };
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setSeagmentIndex(string seagmentIndex) { DARABONBA_PTR_SET_VALUE(seagmentIndex_, seagmentIndex) };
    ...
    inline const vector<Models::TrainNoListSearchResponseBodyModuleTrainStationSearchVOSSeatInfos> & seatInfos() const { DARABONBA_PTR_GET_CONST(seatInfos_, vector<Models::TrainNoListSearchResponseBodyModuleTrainStationSearchVOSSeatInfos>) };
    inline vector<Models::TrainNoListSearchResponseBodyModuleTrainStationSearchVOSSeatInfos> seatInfos() { DARABONBA_PTR_GET(seatInfos_, vector<Models::TrainNoListSearchResponseBodyModuleTrainStationSearchVOSSeatInfos>) };
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setSeatInfos(const vector<Models::TrainNoListSearchResponseBodyModuleTrainStationSearchVOSSeatInfos> & seatInfos) { DARABONBA_PTR_SET_VALUE(seatInfos_, seatInfos) };
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setSeatInfos(vector<Models::TrainNoListSearchResponseBodyModuleTrainStationSearchVOSSeatInfos> && seatInfos) { DARABONBA_PTR_SET_RVALUE(seatInfos_, seatInfos) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setTrainNo(string trainNo) { DARABONBA_PTR_SET_VALUE(trainNo_, trainNo) };
    ...
    inline TrainNoListSearchResponseBodyModuleTrainStationSearchVOS& setTrainType(string trainType) { DARABONBA_PTR_SET_VALUE(trainType_, trainType) };
  ...
  protected:
    ...
    std::shared_ptr<string> seagmentIndex_ = nullptr;
    std::shared_ptr<vector<Models::TrainNoListSearchResponseBodyModuleTrainStationSearchVOSSeatInfos>> seatInfos_ = nullptr;
