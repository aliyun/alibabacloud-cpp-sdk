...
namespace Models
{
  ...
  public:
    ...
    inline const IntlFlightOtaItemDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IntlFlightOtaItemDetailResponseBody) };
    inline IntlFlightOtaItemDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, IntlFlightOtaItemDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IntlFlightOtaItemDetailResponseBody> body_ {};
  };
