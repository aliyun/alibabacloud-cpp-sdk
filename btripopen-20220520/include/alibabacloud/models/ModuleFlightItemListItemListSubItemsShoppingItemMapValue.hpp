...
namespace Models
{
  ...
  public:
    ...
    inline const map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue> & getCabinQuantity() const { DARABONBA_PTR_GET_CONST(cabinQuantity_, map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue>) };
    inline map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue> getCabinQuantity() { DARABONBA_PTR_GET(cabinQuantity_, map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue>) };
    ...
    inline const ModuleFlightItemListItemListSubItemsShoppingItemMapValue::SearchPrice & getSearchPrice() const { DARABONBA_PTR_GET_CONST(searchPrice_, ModuleFlightItemListItemListSubItemsShoppingItemMapValue::SearchPrice) };
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValue::SearchPrice getSearchPrice() { DARABONBA_PTR_GET(searchPrice_, ModuleFlightItemListItemListSubItemsShoppingItemMapValue::SearchPrice) };
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValue& setSearchPrice(const ModuleFlightItemListItemListSubItemsShoppingItemMapValue::SearchPrice & searchPrice) { DARABONBA_PTR_SET_VALUE(searchPrice_, searchPrice) };
    inline ModuleFlightItemListItemListSubItemsShoppingItemMapValue& setSearchPrice(ModuleFlightItemListItemListSubItemsShoppingItemMapValue::SearchPrice && searchPrice) { DARABONBA_PTR_SET_RVALUE(searchPrice_, searchPrice) };
    ...
    inline const map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue> & getSegmentPrice() const { DARABONBA_PTR_GET_CONST(segmentPrice_, map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue>) };
    inline map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue> getSegmentPrice() { DARABONBA_PTR_GET(segmentPrice_, map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue>) };
  ...
  protected:
    ...
    shared_ptr<map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue>> cabinQuantity_ {};
    shared_ptr<ModuleFlightItemListItemListSubItemsShoppingItemMapValue::SearchPrice> searchPrice_ {};
    shared_ptr<map<string, ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue>> segmentPrice_ {};
  };
