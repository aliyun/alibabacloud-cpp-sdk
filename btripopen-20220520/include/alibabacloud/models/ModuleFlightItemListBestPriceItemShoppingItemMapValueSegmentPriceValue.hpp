...
#ifndef ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTBESTPRICEITEMSHOPPINGITEMMAPVALUESEGMENTPRICEVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULEFLIGHTITEMLISTBESTPRICEITEMSHOPPINGITEMMAPVALUESEGMENTPRICEVALUE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& obj) { 
    ...
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue() = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue(const ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue &) = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue(ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue &&) = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue() = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& operator=(const ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue &) = default ;
    ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& operator=(ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue &&) = default ;
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setFloorPrice(int32_t floorPrice) { DARABONBA_PTR_SET_VALUE(floorPrice_, floorPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setTicketPrice(int32_t ticketPrice) { DARABONBA_PTR_SET_VALUE(ticketPrice_, ticketPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setSellPrice(int32_t sellPrice) { DARABONBA_PTR_SET_VALUE(sellPrice_, sellPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setOriginalSellPrice(int32_t originalSellPrice) { DARABONBA_PTR_SET_VALUE(originalSellPrice_, originalSellPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setBaseTotalPrice(int32_t baseTotalPrice) { DARABONBA_PTR_SET_VALUE(baseTotalPrice_, baseTotalPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setBeforeControlPrice(int32_t beforeControlPrice) { DARABONBA_PTR_SET_VALUE(beforeControlPrice_, beforeControlPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setTax(int32_t tax) { DARABONBA_PTR_SET_VALUE(tax_, tax) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setSupplyPrice(int32_t supplyPrice) { DARABONBA_PTR_SET_VALUE(supplyPrice_, supplyPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setBasicCabinPrice(int32_t basicCabinPrice) { DARABONBA_PTR_SET_VALUE(basicCabinPrice_, basicCabinPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setBuildPrice(int32_t buildPrice) { DARABONBA_PTR_SET_VALUE(buildPrice_, buildPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setOilPrice(int32_t oilPrice) { DARABONBA_PTR_SET_VALUE(oilPrice_, oilPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setFirstStandardPrice(int32_t firstStandardPrice) { DARABONBA_PTR_SET_VALUE(firstStandardPrice_, firstStandardPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setBusinessStandardPrice(int32_t businessStandardPrice) { DARABONBA_PTR_SET_VALUE(businessStandardPrice_, businessStandardPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setCommonStandardPrice(int32_t commonStandardPrice) { DARABONBA_PTR_SET_VALUE(commonStandardPrice_, commonStandardPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setInterTicketPrice(int32_t interTicketPrice) { DARABONBA_PTR_SET_VALUE(interTicketPrice_, interTicketPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setSubtractedPrice(int32_t subtractedPrice) { DARABONBA_PTR_SET_VALUE(subtractedPrice_, subtractedPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setOriginCommonPrice(int32_t originCommonPrice) { DARABONBA_PTR_SET_VALUE(originCommonPrice_, originCommonPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setDynamicPromotionPrice(int32_t dynamicPromotionPrice) { DARABONBA_PTR_SET_VALUE(dynamicPromotionPrice_, dynamicPromotionPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setInstallmentNum(int32_t installmentNum) { DARABONBA_PTR_SET_VALUE(installmentNum_, installmentNum) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setInstallmentPrice(double installmentPrice) { DARABONBA_PTR_SET_VALUE(installmentPrice_, installmentPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setCompetitionDynamicPrice(int32_t competitionDynamicPrice) { DARABONBA_PTR_SET_VALUE(competitionDynamicPrice_, competitionDynamicPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setCompetitionPromotionPrice(int32_t competitionPromotionPrice) { DARABONBA_PTR_SET_VALUE(competitionPromotionPrice_, competitionPromotionPrice) };
    ...
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setMinBeforeControlPriceOfNormal(int32_t minBeforeControlPriceOfNormal) { DARABONBA_PTR_SET_VALUE(minBeforeControlPriceOfNormal_, minBeforeControlPriceOfNormal) };
    ...
    inline const ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue::PriceShowInfo & getPriceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue::PriceShowInfo) };
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue::PriceShowInfo getPriceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue::PriceShowInfo) };
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(const ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue::PriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue::PriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    shared_ptr<ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue::PriceShowInfo> priceShowInfo_ {};
  };
