...
namespace Models
{
  ...
  public:
    ...
    inline const ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo & priceShowInfo() const { DARABONBA_PTR_GET_CONST(priceShowInfo_, ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo) };
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo priceShowInfo() { DARABONBA_PTR_GET(priceShowInfo_, ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo) };
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(const ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo & priceShowInfo) { DARABONBA_PTR_SET_VALUE(priceShowInfo_, priceShowInfo) };
    inline ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue& setPriceShowInfo(ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo && priceShowInfo) { DARABONBA_PTR_SET_RVALUE(priceShowInfo_, priceShowInfo) };
  ...
  protected:
    ...
    std::shared_ptr<ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo> priceShowInfo_ = nullptr;
  };
