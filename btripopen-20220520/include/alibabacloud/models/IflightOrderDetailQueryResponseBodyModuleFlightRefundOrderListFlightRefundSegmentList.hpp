...
#ifndef ALIBABACLOUD_MODELS_IFLIGHTORDERDETAILQUERYRESPONSEBODYMODULEFLIGHTREFUNDORDERLISTFLIGHTREFUNDSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_IFLIGHTORDERDETAILQUERYRESPONSEBODYMODULEFLIGHTREFUNDORDERLISTFLIGHTREFUNDSEGMENTLIST_HPP_
...
namespace Models
{
  class IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& obj) { 
    ...
    IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList() = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList(const IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList &) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList(IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList &&) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList() = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& operator=(const IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList &) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& operator=(IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList &&) = default ;
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setAirlineCode(string airlineCode) { DARABONBA_PTR_SET_VALUE(airlineCode_, airlineCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setAirlineName(string airlineName) { DARABONBA_PTR_SET_VALUE(airlineName_, airlineName) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setArrApt(string arrApt) { DARABONBA_PTR_SET_VALUE(arrApt_, arrApt) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setArrAptCode(string arrAptCode) { DARABONBA_PTR_SET_VALUE(arrAptCode_, arrAptCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setArrCity(string arrCity) { DARABONBA_PTR_SET_VALUE(arrCity_, arrCity) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setArrCityCode(string arrCityCode) { DARABONBA_PTR_SET_VALUE(arrCityCode_, arrCityCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setArrTerminal(string arrTerminal) { DARABONBA_PTR_SET_VALUE(arrTerminal_, arrTerminal) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setArrTime(string arrTime) { DARABONBA_PTR_SET_VALUE(arrTime_, arrTime) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setCarrierAirlineCode(string carrierAirlineCode) { DARABONBA_PTR_SET_VALUE(carrierAirlineCode_, carrierAirlineCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setCarrierAirlineName(string carrierAirlineName) { DARABONBA_PTR_SET_VALUE(carrierAirlineName_, carrierAirlineName) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setDepApt(string depApt) { DARABONBA_PTR_SET_VALUE(depApt_, depApt) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setDepAptCode(string depAptCode) { DARABONBA_PTR_SET_VALUE(depAptCode_, depAptCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setDepCity(string depCity) { DARABONBA_PTR_SET_VALUE(depCity_, depCity) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setDepCityCode(string depCityCode) { DARABONBA_PTR_SET_VALUE(depCityCode_, depCityCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setDepTerminal(string depTerminal) { DARABONBA_PTR_SET_VALUE(depTerminal_, depTerminal) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setDepTime(string depTime) { DARABONBA_PTR_SET_VALUE(depTime_, depTime) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setFlightNo(string flightNo) { DARABONBA_PTR_SET_VALUE(flightNo_, flightNo) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setJourneyIndex(int32_t journeyIndex) { DARABONBA_PTR_SET_VALUE(journeyIndex_, journeyIndex) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setSegmentIndex(int32_t segmentIndex) { DARABONBA_PTR_SET_VALUE(segmentIndex_, segmentIndex) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setShare(bool share) { DARABONBA_PTR_SET_VALUE(share_, share) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setStopAptCode(string stopAptCode) { DARABONBA_PTR_SET_VALUE(stopAptCode_, stopAptCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setStopArrTime(string stopArrTime) { DARABONBA_PTR_SET_VALUE(stopArrTime_, stopArrTime) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setStopCity(string stopCity) { DARABONBA_PTR_SET_VALUE(stopCity_, stopCity) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setStopCityCode(string stopCityCode) { DARABONBA_PTR_SET_VALUE(stopCityCode_, stopCityCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList& setStopDepTime(string stopDepTime) { DARABONBA_PTR_SET_VALUE(stopDepTime_, stopDepTime) };
