...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applyIdList_ == nullptr
    ...
    inline const vector<string> & getApplyIdList() const { DARABONBA_PTR_GET_CONST(applyIdList_, vector<string>) };
    inline vector<string> getApplyIdList() { DARABONBA_PTR_GET(applyIdList_, vector<string>) };
    ...
    inline const vector<int32_t> & getBookTypeList() const { DARABONBA_PTR_GET_CONST(bookTypeList_, vector<int32_t>) };
    inline vector<int32_t> getBookTypeList() { DARABONBA_PTR_GET(bookTypeList_, vector<int32_t>) };
    ...
    inline const vector<string> & getThirdPartApplyIdList() const { DARABONBA_PTR_GET_CONST(thirdPartApplyIdList_, vector<string>) };
    inline vector<string> getThirdPartApplyIdList() { DARABONBA_PTR_GET(thirdPartApplyIdList_, vector<string>) };
  ...
  protected:
    shared_ptr<vector<string>> applyIdList_ {};
    shared_ptr<vector<int32_t>> bookTypeList_ {};
    shared_ptr<vector<string>> bookerId_ {};
    shared_ptr<string> endDate_ {};
    shared_ptr<int32_t> pageSize_ {};
    shared_ptr<string> scrollId_ {};
    shared_ptr<string> startDate_ {};
    shared_ptr<vector<string>> thirdPartApplyIdList_ {};
  };
