...
namespace Models
{
  ...
  public:
    ...
    inline const TrainApplyChangeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TrainApplyChangeResponseBody) };
    inline TrainApplyChangeResponseBody getBody() { DARABONBA_PTR_GET(body_, TrainApplyChangeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TrainApplyChangeResponseBody> body_ {};
  };
