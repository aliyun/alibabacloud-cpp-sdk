...
#ifndef ALIBABACLOUD_MODELS_IFLIGHTORDERDETAILQUERYRESPONSEBODYMODULEFLIGHTSALEORDERPASSENGERLIST_HPP_
#define ALIBABACLOUD_MODELS_IFLIGHTORDERDETAILQUERYRESPONSEBODYMODULEFLIGHTSALEORDERPASSENGERLIST_HPP_
...
namespace Models
{
  class IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& obj) { 
    ...
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList() = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList(const IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList &) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList(IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList &&) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList() = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& operator=(const IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList &) = default ;
    IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& operator=(IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList &&) = default ;
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setCostCenterId(string costCenterId) { DARABONBA_PTR_SET_VALUE(costCenterId_, costCenterId) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setCostCenterName(string costCenterName) { DARABONBA_PTR_SET_VALUE(costCenterName_, costCenterName) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setDepartmentId(string departmentId) { DARABONBA_PTR_SET_VALUE(departmentId_, departmentId) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setDepartmentName(string departmentName) { DARABONBA_PTR_SET_VALUE(departmentName_, departmentName) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setInvoiceId(string invoiceId) { DARABONBA_PTR_SET_VALUE(invoiceId_, invoiceId) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setInvoiceTitle(string invoiceTitle) { DARABONBA_PTR_SET_VALUE(invoiceTitle_, invoiceTitle) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setJobNo(string jobNo) { DARABONBA_PTR_SET_VALUE(jobNo_, jobNo) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setPassengerType(int32_t passengerType) { DARABONBA_PTR_SET_VALUE(passengerType_, passengerType) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setProjectCode(string projectCode) { DARABONBA_PTR_SET_VALUE(projectCode_, projectCode) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setProjectTitle(string projectTitle) { DARABONBA_PTR_SET_VALUE(projectTitle_, projectTitle) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
