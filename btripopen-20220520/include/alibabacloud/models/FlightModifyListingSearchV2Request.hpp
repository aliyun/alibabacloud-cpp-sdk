...
namespace Models
{
  ...
  public:
    ...
    inline bool getInterfaceCallerIsSupportRetry() const { DARABONBA_PTR_GET_DEFAULT(interfaceCallerIsSupportRetry_, false) };
    ...
    inline const vector<FlightModifyListingSearchV2Request::PassengerSegmentRelations> & getPassengerSegmentRelations() const { DARABONBA_PTR_GET_CONST(passengerSegmentRelations_, vector<FlightModifyListingSearchV2Request::PassengerSegmentRelations>) };
    inline vector<FlightModifyListingSearchV2Request::PassengerSegmentRelations> getPassengerSegmentRelations() { DARABONBA_PTR_GET(passengerSegmentRelations_, vector<FlightModifyListingSearchV2Request::PassengerSegmentRelations>) };
    inline FlightModifyListingSearchV2Request& setPassengerSegmentRelations(const vector<FlightModifyListingSearchV2Request::PassengerSegmentRelations> & passengerSegmentRelations) { DARABONBA_PTR_SET_VALUE(passengerSegmentRelations_, passengerSegmentRelations) };
    inline FlightModifyListingSearchV2Request& setPassengerSegmentRelations(vector<FlightModifyListingSearchV2Request::PassengerSegmentRelations> && passengerSegmentRelations) { DARABONBA_PTR_SET_RVALUE(passengerSegmentRelations_, passengerSegmentRelations) };
    ...
    inline const vector<FlightModifyListingSearchV2Request::SelectedSegments> & getSelectedSegments() const { DARABONBA_PTR_GET_CONST(selectedSegments_, vector<FlightModifyListingSearchV2Request::SelectedSegments>) };
    inline vector<FlightModifyListingSearchV2Request::SelectedSegments> getSelectedSegments() { DARABONBA_PTR_GET(selectedSegments_, vector<FlightModifyListingSearchV2Request::SelectedSegments>) };
    inline FlightModifyListingSearchV2Request& setSelectedSegments(const vector<FlightModifyListingSearchV2Request::SelectedSegments> & selectedSegments) { DARABONBA_PTR_SET_VALUE(selectedSegments_, selectedSegments) };
    inline FlightModifyListingSearchV2Request& setSelectedSegments(vector<FlightModifyListingSearchV2Request::SelectedSegments> && selectedSegments) { DARABONBA_PTR_SET_RVALUE(selectedSegments_, selectedSegments) };
  ...
  protected:
    ...
    shared_ptr<bool> interfaceCallerIsSupportRetry_ {};
    shared_ptr<string> isvName_ {};
    shared_ptr<int64_t> orderId_ {};
    shared_ptr<string> outOrderId_ {};
    shared_ptr<vector<FlightModifyListingSearchV2Request::PassengerSegmentRelations>> passengerSegmentRelations_ {};
    shared_ptr<int32_t> searchMode_ {};
    shared_ptr<string> searchRetryToken_ {};
    shared_ptr<vector<FlightModifyListingSearchV2Request::SelectedSegments>> selectedSegments_ {};
