...
namespace Models
{
  ...
  public:
    ...
    inline const EntityAddResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, EntityAddResponseBodyModule) };
    inline EntityAddResponseBodyModule module() { DARABONBA_PTR_GET(module_, EntityAddResponseBodyModule) };
    inline EntityAddResponseBody& setModule(const EntityAddResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline EntityAddResponseBody& setModule(EntityAddResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<EntityAddResponseBodyModule> module_ = nullptr;
