...
#ifndef ALIBABACLOUD_MODELS_INSUREORDERCREATEREQUESTAPPLICANT_HPP_
#define ALIBABACLOUD_MODELS_INSUREORDERCREATEREQUESTAPPLICANT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const InsureOrderCreateRequestApplicant& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, InsureOrderCreateRequestApplicant& obj) { 
    ...
    InsureOrderCreateRequestApplicant() = default ;
    InsureOrderCreateRequestApplicant(const InsureOrderCreateRequestApplicant &) = default ;
    InsureOrderCreateRequestApplicant(InsureOrderCreateRequestApplicant &&) = default ;
    InsureOrderCreateRequestApplicant(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InsureOrderCreateRequestApplicant() = default ;
    InsureOrderCreateRequestApplicant& operator=(const InsureOrderCreateRequestApplicant &) = default ;
    InsureOrderCreateRequestApplicant& operator=(InsureOrderCreateRequestApplicant &&) = default ;
    ...
    inline InsureOrderCreateRequestApplicant& setBirthday(string birthday) { DARABONBA_PTR_SET_VALUE(birthday_, birthday) };
    ...
    inline InsureOrderCreateRequestApplicant& setBtripUserId(string btripUserId) { DARABONBA_PTR_SET_VALUE(btripUserId_, btripUserId) };
    ...
    inline InsureOrderCreateRequestApplicant& setCertName(string certName) { DARABONBA_PTR_SET_VALUE(certName_, certName) };
    ...
    inline InsureOrderCreateRequestApplicant& setCertNo(string certNo) { DARABONBA_PTR_SET_VALUE(certNo_, certNo) };
    ...
    inline InsureOrderCreateRequestApplicant& setCertType(string certType) { DARABONBA_PTR_SET_VALUE(certType_, certType) };
    ...
    inline InsureOrderCreateRequestApplicant& setGender(string gender) { DARABONBA_PTR_SET_VALUE(gender_, gender) };
    ...
    inline InsureOrderCreateRequestApplicant& setPhone(string phone) { DARABONBA_PTR_SET_VALUE(phone_, phone) };
