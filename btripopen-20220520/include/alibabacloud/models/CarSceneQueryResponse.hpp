...
namespace Models
{
  ...
  public:
    ...
    inline const CarSceneQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CarSceneQueryResponseBody) };
    inline CarSceneQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, CarSceneQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CarSceneQueryResponseBody> body_ {};
  };
