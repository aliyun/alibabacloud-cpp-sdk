...
#ifndef ALIBABACLOUD_MODELS_MODULEITEMLISTSHOPPINGITEMMAPVALUECABINQUANTITYVALUE_HPP_
#define ALIBABACLOUD_MODELS_MODULEITEMLISTSHOPPINGITEMMAPVALUECABINQUANTITYVALUE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModuleItemListShoppingItemMapValueCabinQuantityValue& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModuleItemListShoppingItemMapValueCabinQuantityValue& obj) { 
    ...
    ModuleItemListShoppingItemMapValueCabinQuantityValue() = default ;
    ModuleItemListShoppingItemMapValueCabinQuantityValue(const ModuleItemListShoppingItemMapValueCabinQuantityValue &) = default ;
    ModuleItemListShoppingItemMapValueCabinQuantityValue(ModuleItemListShoppingItemMapValueCabinQuantityValue &&) = default ;
    ModuleItemListShoppingItemMapValueCabinQuantityValue(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModuleItemListShoppingItemMapValueCabinQuantityValue() = default ;
    ModuleItemListShoppingItemMapValueCabinQuantityValue& operator=(const ModuleItemListShoppingItemMapValueCabinQuantityValue &) = default ;
    ModuleItemListShoppingItemMapValueCabinQuantityValue& operator=(ModuleItemListShoppingItemMapValueCabinQuantityValue &&) = default ;
    ...
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setCabin(string cabin) { DARABONBA_PTR_SET_VALUE(cabin_, cabin) };
    ...
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setCabinClass(string cabinClass) { DARABONBA_PTR_SET_VALUE(cabinClass_, cabinClass) };
    ...
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setCabinClassName(string cabinClassName) { DARABONBA_PTR_SET_VALUE(cabinClassName_, cabinClassName) };
    ...
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setCabinClassMemo(string cabinClassMemo) { DARABONBA_PTR_SET_VALUE(cabinClassMemo_, cabinClassMemo) };
    ...
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setSpecification(string specification) { DARABONBA_PTR_SET_VALUE(specification_, specification) };
    ...
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setQuantity(string quantity) { DARABONBA_PTR_SET_VALUE(quantity_, quantity) };
    ...
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setLinkCabins(const vector<string> & linkCabins) { DARABONBA_PTR_SET_VALUE(linkCabins_, linkCabins) };
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setLinkCabins(vector<string> && linkCabins) { DARABONBA_PTR_SET_RVALUE(linkCabins_, linkCabins) };
    ...
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setReshopChangeCabin(bool reshopChangeCabin) { DARABONBA_PTR_SET_VALUE(reshopChangeCabin_, reshopChangeCabin) };
    ...
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setChildCabinType(int32_t childCabinType) { DARABONBA_PTR_SET_VALUE(childCabinType_, childCabinType) };
    ...
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setInfantBasicCabin(string infantBasicCabin) { DARABONBA_PTR_SET_VALUE(infantBasicCabin_, infantBasicCabin) };
    ...
    inline ModuleItemListShoppingItemMapValueCabinQuantityValue& setInnerCabinClass(int32_t innerCabinClass) { DARABONBA_PTR_SET_VALUE(innerCabinClass_, innerCabinClass) };
