...
namespace Models
{
  ...
  public:
    ...
    inline const HotelBillSettlementQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelBillSettlementQueryResponseBodyModule) };
    inline HotelBillSettlementQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelBillSettlementQueryResponseBodyModule) };
    inline HotelBillSettlementQueryResponseBody& setModule(const HotelBillSettlementQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelBillSettlementQueryResponseBody& setModule(HotelBillSettlementQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelBillSettlementQueryResponseBodyModule> module_ = nullptr;
