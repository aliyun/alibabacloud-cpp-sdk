...
namespace Models
{
  ...
  public:
    ...
    inline const TrainFeeCalculateRefundResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TrainFeeCalculateRefundResponseBodyModule) };
    inline TrainFeeCalculateRefundResponseBodyModule module() { DARABONBA_PTR_GET(module_, TrainFeeCalculateRefundResponseBodyModule) };
    inline TrainFeeCalculateRefundResponseBody& setModule(const TrainFeeCalculateRefundResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TrainFeeCalculateRefundResponseBody& setModule(TrainFeeCalculateRefundResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    // module
    std::shared_ptr<TrainFeeCalculateRefundResponseBodyModule> module_ = nullptr;
