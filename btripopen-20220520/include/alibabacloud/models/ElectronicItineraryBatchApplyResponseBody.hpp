...
namespace Models
{
  ...
  public:
    ...
    inline const ElectronicItineraryBatchApplyResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, ElectronicItineraryBatchApplyResponseBodyModule) };
    inline ElectronicItineraryBatchApplyResponseBodyModule module() { DARABONBA_PTR_GET(module_, ElectronicItineraryBatchApplyResponseBodyModule) };
    inline ElectronicItineraryBatchApplyResponseBody& setModule(const ElectronicItineraryBatchApplyResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline ElectronicItineraryBatchApplyResponseBody& setModule(ElectronicItineraryBatchApplyResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<ElectronicItineraryBatchApplyResponseBodyModule> module_ = nullptr;
    // requestId
