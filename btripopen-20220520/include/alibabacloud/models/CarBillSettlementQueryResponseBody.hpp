...
namespace Models
{
  ...
  public:
    ...
    inline const CarBillSettlementQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, CarBillSettlementQueryResponseBodyModule) };
    inline CarBillSettlementQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, CarBillSettlementQueryResponseBodyModule) };
    inline CarBillSettlementQueryResponseBody& setModule(const CarBillSettlementQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline CarBillSettlementQueryResponseBody& setModule(CarBillSettlementQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<CarBillSettlementQueryResponseBodyModule> module_ = nullptr;
