...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyApproveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApplyApproveResponseBody) };
    inline ApplyApproveResponseBody getBody() { DARABONBA_PTR_GET(body_, ApplyApproveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApplyApproveResponseBody> body_ {};
  };
