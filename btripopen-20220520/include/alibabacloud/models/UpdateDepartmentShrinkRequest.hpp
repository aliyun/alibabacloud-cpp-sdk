...
#ifndef ALIBABACLOUD_MODELS_UPDATEDEPARTMENTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEDEPARTMENTSHRINKREQUEST_HPP_
...
namespace Models
{
  class UpdateDepartmentShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateDepartmentShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateDepartmentShrinkRequest& obj) { 
    ...
    UpdateDepartmentShrinkRequest() = default ;
    UpdateDepartmentShrinkRequest(const UpdateDepartmentShrinkRequest &) = default ;
    UpdateDepartmentShrinkRequest(UpdateDepartmentShrinkRequest &&) = default ;
    UpdateDepartmentShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateDepartmentShrinkRequest() = default ;
    UpdateDepartmentShrinkRequest& operator=(const UpdateDepartmentShrinkRequest &) = default ;
    UpdateDepartmentShrinkRequest& operator=(UpdateDepartmentShrinkRequest &&) = default ;
    ...
    inline UpdateDepartmentShrinkRequest& setDeptName(string deptName) { DARABONBA_PTR_SET_VALUE(deptName_, deptName) };
    ...
    inline UpdateDepartmentShrinkRequest& setManagerEmployeeIdListShrink(string managerEmployeeIdListShrink) { DARABONBA_PTR_SET_VALUE(managerEmployeeIdListShrink_, managerEmployeeIdListShrink) };
    ...
    inline UpdateDepartmentShrinkRequest& setOutDeptId(string outDeptId) { DARABONBA_PTR_SET_VALUE(outDeptId_, outDeptId) };
    ...
    inline UpdateDepartmentShrinkRequest& setOutDeptPid(string outDeptPid) { DARABONBA_PTR_SET_VALUE(outDeptPid_, outDeptPid) };
