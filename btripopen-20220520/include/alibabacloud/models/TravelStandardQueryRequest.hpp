...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getServiceTypeList() const { DARABONBA_PTR_GET_CONST(serviceTypeList_, vector<string>) };
    inline vector<string> getServiceTypeList() { DARABONBA_PTR_GET(serviceTypeList_, vector<string>) };
