...
namespace Models
{
  ...
  public:
    ...
    inline const FlightCancelOrderResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, FlightCancelOrderResponseBodyModule) };
    inline FlightCancelOrderResponseBodyModule module() { DARABONBA_PTR_GET(module_, FlightCancelOrderResponseBodyModule) };
    inline FlightCancelOrderResponseBody& setModule(const FlightCancelOrderResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline FlightCancelOrderResponseBody& setModule(FlightCancelOrderResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<FlightCancelOrderResponseBodyModule> module_ = nullptr;
