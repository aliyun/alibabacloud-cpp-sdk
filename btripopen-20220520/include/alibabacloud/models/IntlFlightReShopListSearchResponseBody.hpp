...
#ifndef ALIBABACLOUD_MODELS_INTLFLIGHTRESHOPLISTSEARCHRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_INTLFLIGHTRESHOPLISTSEARCHRESPONSEBODY_HPP_
#include <darabonba/Core.hpp>
#include <vector>
#include <map>
#include <alibabacloud/models/ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue.hpp>
#include <alibabacloud/models/ModuleReShopItemListBestPriceItemShoppingItemMapValue.hpp>
using namespace std;
...
namespace Models
{
  class IntlFlightReShopListSearchResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IntlFlightReShopListSearchResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IntlFlightReShopListSearchResponseBody& obj) { 
    ...
    IntlFlightReShopListSearchResponseBody() = default ;
    IntlFlightReShopListSearchResponseBody(const IntlFlightReShopListSearchResponseBody &) = default ;
    IntlFlightReShopListSearchResponseBody(IntlFlightReShopListSearchResponseBody &&) = default ;
    IntlFlightReShopListSearchResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IntlFlightReShopListSearchResponseBody() = default ;
    IntlFlightReShopListSearchResponseBody& operator=(const IntlFlightReShopListSearchResponseBody &) = default ;
    IntlFlightReShopListSearchResponseBody& operator=(IntlFlightReShopListSearchResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->segmentIndex_ == nullptr; };
            ...
            virtual bool empty() const override { return this->discountNum_ == nullptr
        && this->segmentKeys_ == nullptr && this->segmentPositionList_ == nullptr && this->shoppingItemMap_ == nullptr && this->uniqKey_ == nullptr; };
            ...
            inline const map<string, ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue> & getShoppingItemMap() const { DARABONBA_PTR_GET_CONST(shoppingItemMap_, map<string, ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue>) };
            inline map<string, ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue> getShoppingItemMap() { DARABONBA_PTR_GET(shoppingItemMap_, map<string, ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue>) };
            inline SubItems& setShoppingItemMap(const map<string, ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue> & shoppingItemMap) { DARABONBA_PTR_SET_VALUE(shoppingItemMap_, shoppingItemMap) };
            inline SubItems& setShoppingItemMap(map<string, ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue> && shoppingItemMap) { DARABONBA_PTR_SET_RVALUE(shoppingItemMap_, shoppingItemMap) };
          ...
          protected:
            ...
            shared_ptr<map<string, ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue>> shoppingItemMap_ {};
            // The unique item ID.
        ...
        && this->itemType_ == nullptr && this->shoppingItemMap_ == nullptr && this->subItems_ == nullptr; };
          ...
          inline BestPriceItem& setItemId(string itemId) { DARABONBA_PTR_SET_VALUE(itemId_, itemId) };
          ...
          bool hasShoppingItemMap() const { return this->shoppingItemMap_ != nullptr;};
          void deleteShoppingItemMap() { this->shoppingItemMap_ = nullptr;};
          inline const map<string, ModuleReShopItemListBestPriceItemShoppingItemMapValue> & getShoppingItemMap() const { DARABONBA_PTR_GET_CONST(shoppingItemMap_, map<string, ModuleReShopItemListBestPriceItemShoppingItemMapValue>) };
          inline map<string, ModuleReShopItemListBestPriceItemShoppingItemMapValue> getShoppingItemMap() { DARABONBA_PTR_GET(shoppingItemMap_, map<string, ModuleReShopItemListBestPriceItemShoppingItemMapValue>) };
          inline BestPriceItem& setShoppingItemMap(const map<string, ModuleReShopItemListBestPriceItemShoppingItemMapValue> & shoppingItemMap) { DARABONBA_PTR_SET_VALUE(shoppingItemMap_, shoppingItemMap) };
          inline BestPriceItem& setShoppingItemMap(map<string, ModuleReShopItemListBestPriceItemShoppingItemMapValue> && shoppingItemMap) { DARABONBA_PTR_SET_RVALUE(shoppingItemMap_, shoppingItemMap) };


          // subItems Field Functions 
          bool hasSubItems() const { return this->subItems_ != nullptr;};
          void deleteSubItems() { this->subItems_ = nullptr;};
          inline const vector<BestPriceItem::SubItems> & getSubItems() const { DARABONBA_PTR_GET_CONST(subItems_, vector<BestPriceItem::SubItems>) };
          inline vector<BestPriceItem::SubItems> getSubItems() { DARABONBA_PTR_GET(subItems_, vector<BestPriceItem::SubItems>) };
          inline BestPriceItem& setSubItems(const vector<BestPriceItem::SubItems> & subItems) { DARABONBA_PTR_SET_VALUE(subItems_, subItems) };
          inline BestPriceItem& setSubItems(vector<BestPriceItem::SubItems> && subItems) { DARABONBA_PTR_SET_RVALUE(subItems_, subItems) };
        ...
        protected:
          ...
          shared_ptr<map<string, ModuleReShopItemListBestPriceItemShoppingItemMapValue>> shoppingItemMap_ {};
          // The sub-items. Combined products may have multiple sub-items.
          shared_ptr<vector<BestPriceItem::SubItems>> subItems_ {};
        };
        ...
        inline const ReShopItemList::BestPriceItem & getBestPriceItem() const { DARABONBA_PTR_GET_CONST(bestPriceItem_, ReShopItemList::BestPriceItem) };
        inline ReShopItemList::BestPriceItem getBestPriceItem() { DARABONBA_PTR_GET(bestPriceItem_, ReShopItemList::BestPriceItem) };
        inline ReShopItemList& setBestPriceItem(const ReShopItemList::BestPriceItem & bestPriceItem) { DARABONBA_PTR_SET_VALUE(bestPriceItem_, bestPriceItem) };
        inline ReShopItemList& setBestPriceItem(ReShopItemList::BestPriceItem && bestPriceItem) { DARABONBA_PTR_SET_RVALUE(bestPriceItem_, bestPriceItem) };
        ...
        inline const vector<ReShopItemList::FlightJourneyInfos> & getFlightJourneyInfos() const { DARABONBA_PTR_GET_CONST(flightJourneyInfos_, vector<ReShopItemList::FlightJourneyInfos>) };
        inline vector<ReShopItemList::FlightJourneyInfos> getFlightJourneyInfos() { DARABONBA_PTR_GET(flightJourneyInfos_, vector<ReShopItemList::FlightJourneyInfos>) };
        inline ReShopItemList& setFlightJourneyInfos(const vector<ReShopItemList::FlightJourneyInfos> & flightJourneyInfos) { DARABONBA_PTR_SET_VALUE(flightJourneyInfos_, flightJourneyInfos) };
        inline ReShopItemList& setFlightJourneyInfos(vector<ReShopItemList::FlightJourneyInfos> && flightJourneyInfos) { DARABONBA_PTR_SET_RVALUE(flightJourneyInfos_, flightJourneyInfos) };


      protected:
        // The lowest price item.
        shared_ptr<ReShopItemList::BestPriceItem> bestPriceItem_ {};
        // The flight journey information.
        shared_ptr<vector<ReShopItemList::FlightJourneyInfos>> flightJourneyInfos_ {};
      };

      virtual bool empty() const override { return this->needContinue_ == nullptr
        && this->nextReqWaitTime_ == nullptr && this->reShopItemList_ == nullptr && this->token_ == nullptr; };
    ...
    inline IntlFlightReShopListSearchResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline IntlFlightReShopListSearchResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };


    // module Field Functions 
    bool hasModule() const { return this->module_ != nullptr;};
    void deleteModule() { this->module_ = nullptr;};
    inline const IntlFlightReShopListSearchResponseBody::Module & getModule() const { DARABONBA_PTR_GET_CONST(module_, IntlFlightReShopListSearchResponseBody::Module) };
    inline IntlFlightReShopListSearchResponseBody::Module getModule() { DARABONBA_PTR_GET(module_, IntlFlightReShopListSearchResponseBody::Module) };
    inline IntlFlightReShopListSearchResponseBody& setModule(const IntlFlightReShopListSearchResponseBody::Module & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline IntlFlightReShopListSearchResponseBody& setModule(IntlFlightReShopListSearchResponseBody::Module && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
    ...
    inline IntlFlightReShopListSearchResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline IntlFlightReShopListSearchResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline IntlFlightReShopListSearchResponseBody& setTraceId(string traceId) { DARABONBA_PTR_SET_VALUE(traceId_, traceId) };
  ...
  protected:
    ...
    // The response data.
    shared_ptr<IntlFlightReShopListSearchResponseBody::Module> module_ {};
