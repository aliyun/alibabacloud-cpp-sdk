...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyAddRequest::CarRule & getCarRule() const { DARABONBA_PTR_GET_CONST(carRule_, ApplyAddRequest::CarRule) };
    inline ApplyAddRequest::CarRule getCarRule() { DARABONBA_PTR_GET(carRule_, ApplyAddRequest::CarRule) };
    inline ApplyAddRequest& setCarRule(const ApplyAddRequest::CarRule & carRule) { DARABONBA_PTR_SET_VALUE(carRule_, carRule) };
    inline ApplyAddRequest& setCarRule(ApplyAddRequest::CarRule && carRule) { DARABONBA_PTR_SET_RVALUE(carRule_, carRule) };
    ...
    inline const ApplyAddRequest::DefaultStandard & getDefaultStandard() const { DARABONBA_PTR_GET_CONST(defaultStandard_, ApplyAddRequest::DefaultStandard) };
    inline ApplyAddRequest::DefaultStandard getDefaultStandard() { DARABONBA_PTR_GET(defaultStandard_, ApplyAddRequest::DefaultStandard) };
    inline ApplyAddRequest& setDefaultStandard(const ApplyAddRequest::DefaultStandard & defaultStandard) { DARABONBA_PTR_SET_VALUE(defaultStandard_, defaultStandard) };
    inline ApplyAddRequest& setDefaultStandard(ApplyAddRequest::DefaultStandard && defaultStandard) { DARABONBA_PTR_SET_RVALUE(defaultStandard_, defaultStandard) };
    ...
    inline const vector<ApplyAddRequest::ExternalTravelerList> & getExternalTravelerList() const { DARABONBA_PTR_GET_CONST(externalTravelerList_, vector<ApplyAddRequest::ExternalTravelerList>) };
    inline vector<ApplyAddRequest::ExternalTravelerList> getExternalTravelerList() { DARABONBA_PTR_GET(externalTravelerList_, vector<ApplyAddRequest::ExternalTravelerList>) };
    inline ApplyAddRequest& setExternalTravelerList(const vector<ApplyAddRequest::ExternalTravelerList> & externalTravelerList) { DARABONBA_PTR_SET_VALUE(externalTravelerList_, externalTravelerList) };
    inline ApplyAddRequest& setExternalTravelerList(vector<ApplyAddRequest::ExternalTravelerList> && externalTravelerList) { DARABONBA_PTR_SET_RVALUE(externalTravelerList_, externalTravelerList) };
    ...
    inline const ApplyAddRequest::ExternalTravelerStandard & getExternalTravelerStandard() const { DARABONBA_PTR_GET_CONST(externalTravelerStandard_, ApplyAddRequest::ExternalTravelerStandard) };
    inline ApplyAddRequest::ExternalTravelerStandard getExternalTravelerStandard() { DARABONBA_PTR_GET(externalTravelerStandard_, ApplyAddRequest::ExternalTravelerStandard) };
    inline ApplyAddRequest& setExternalTravelerStandard(const ApplyAddRequest::ExternalTravelerStandard & externalTravelerStandard) { DARABONBA_PTR_SET_VALUE(externalTravelerStandard_, externalTravelerStandard) };
    inline ApplyAddRequest& setExternalTravelerStandard(ApplyAddRequest::ExternalTravelerStandard && externalTravelerStandard) { DARABONBA_PTR_SET_RVALUE(externalTravelerStandard_, externalTravelerStandard) };
    ...
    inline const ApplyAddRequest::HotelShare & getHotelShare() const { DARABONBA_PTR_GET_CONST(hotelShare_, ApplyAddRequest::HotelShare) };
    inline ApplyAddRequest::HotelShare getHotelShare() { DARABONBA_PTR_GET(hotelShare_, ApplyAddRequest::HotelShare) };
    inline ApplyAddRequest& setHotelShare(const ApplyAddRequest::HotelShare & hotelShare) { DARABONBA_PTR_SET_VALUE(hotelShare_, hotelShare) };
    inline ApplyAddRequest& setHotelShare(ApplyAddRequest::HotelShare && hotelShare) { DARABONBA_PTR_SET_RVALUE(hotelShare_, hotelShare) };
    ...
    inline const vector<ApplyAddRequest::ItineraryList> & getItineraryList() const { DARABONBA_PTR_GET_CONST(itineraryList_, vector<ApplyAddRequest::ItineraryList>) };
    inline vector<ApplyAddRequest::ItineraryList> getItineraryList() { DARABONBA_PTR_GET(itineraryList_, vector<ApplyAddRequest::ItineraryList>) };
    inline ApplyAddRequest& setItineraryList(const vector<ApplyAddRequest::ItineraryList> & itineraryList) { DARABONBA_PTR_SET_VALUE(itineraryList_, itineraryList) };
    inline ApplyAddRequest& setItineraryList(vector<ApplyAddRequest::ItineraryList> && itineraryList) { DARABONBA_PTR_SET_RVALUE(itineraryList_, itineraryList) };
    ...
    inline const vector<ApplyAddRequest::ItinerarySetList> & getItinerarySetList() const { DARABONBA_PTR_GET_CONST(itinerarySetList_, vector<ApplyAddRequest::ItinerarySetList>) };
    inline vector<ApplyAddRequest::ItinerarySetList> getItinerarySetList() { DARABONBA_PTR_GET(itinerarySetList_, vector<ApplyAddRequest::ItinerarySetList>) };
    inline ApplyAddRequest& setItinerarySetList(const vector<ApplyAddRequest::ItinerarySetList> & itinerarySetList) { DARABONBA_PTR_SET_VALUE(itinerarySetList_, itinerarySetList) };
    inline ApplyAddRequest& setItinerarySetList(vector<ApplyAddRequest::ItinerarySetList> && itinerarySetList) { DARABONBA_PTR_SET_RVALUE(itinerarySetList_, itinerarySetList) };
    ...
    inline const vector<ApplyAddRequest::TravelerList> & getTravelerList() const { DARABONBA_PTR_GET_CONST(travelerList_, vector<ApplyAddRequest::TravelerList>) };
    inline vector<ApplyAddRequest::TravelerList> getTravelerList() { DARABONBA_PTR_GET(travelerList_, vector<ApplyAddRequest::TravelerList>) };
    inline ApplyAddRequest& setTravelerList(const vector<ApplyAddRequest::TravelerList> & travelerList) { DARABONBA_PTR_SET_VALUE(travelerList_, travelerList) };
    inline ApplyAddRequest& setTravelerList(vector<ApplyAddRequest::TravelerList> && travelerList) { DARABONBA_PTR_SET_RVALUE(travelerList_, travelerList) };
    ...
    inline const vector<ApplyAddRequest::TravelerStandard> & getTravelerStandard() const { DARABONBA_PTR_GET_CONST(travelerStandard_, vector<ApplyAddRequest::TravelerStandard>) };
    inline vector<ApplyAddRequest::TravelerStandard> getTravelerStandard() { DARABONBA_PTR_GET(travelerStandard_, vector<ApplyAddRequest::TravelerStandard>) };
    inline ApplyAddRequest& setTravelerStandard(const vector<ApplyAddRequest::TravelerStandard> & travelerStandard) { DARABONBA_PTR_SET_VALUE(travelerStandard_, travelerStandard) };
    inline ApplyAddRequest& setTravelerStandard(vector<ApplyAddRequest::TravelerStandard> && travelerStandard) { DARABONBA_PTR_SET_RVALUE(travelerStandard_, travelerStandard) };
  ...
  protected:
    ...
    shared_ptr<ApplyAddRequest::CarRule> carRule_ {};
    ...
    shared_ptr<ApplyAddRequest::HotelShare> hotelShare_ {};
    shared_ptr<string> internationalFlightCabins_ {};
    shared_ptr<int64_t> intlFlightBudget_ {};
    shared_ptr<int64_t> intlHotelBudget_ {};
    shared_ptr<vector<ApplyAddRequest::ItineraryList>> itineraryList_ {};
    shared_ptr<int32_t> itineraryRule_ {};
    shared_ptr<vector<ApplyAddRequest::ItinerarySetList>> itinerarySetList_ {};
    ...
    shared_ptr<vector<ApplyAddRequest::TravelerList>> travelerList_ {};
    shared_ptr<vector<ApplyAddRequest::TravelerStandard>> travelerStandard_ {};
    // This parameter is required.
