...
#ifndef ALIBABACLOUD_MODELS_HOTELORDERDETAILINFORESPONSEBODYMODULEOCCUPANTINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_HOTELORDERDETAILINFORESPONSEBODYMODULEOCCUPANTINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& obj) { 
    ...
    HotelOrderDetailInfoResponseBodyModuleOccupantInfoList() = default ;
    HotelOrderDetailInfoResponseBodyModuleOccupantInfoList(const HotelOrderDetailInfoResponseBodyModuleOccupantInfoList &) = default ;
    HotelOrderDetailInfoResponseBodyModuleOccupantInfoList(HotelOrderDetailInfoResponseBodyModuleOccupantInfoList &&) = default ;
    HotelOrderDetailInfoResponseBodyModuleOccupantInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~HotelOrderDetailInfoResponseBodyModuleOccupantInfoList() = default ;
    HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& operator=(const HotelOrderDetailInfoResponseBodyModuleOccupantInfoList &) = default ;
    HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& operator=(HotelOrderDetailInfoResponseBodyModuleOccupantInfoList &&) = default ;
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setCardNo(string cardNo) { DARABONBA_PTR_SET_VALUE(cardNo_, cardNo) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setCardType(int32_t cardType) { DARABONBA_PTR_SET_VALUE(cardType_, cardType) };
    ...
    inline const vector<Models::HotelOrderDetailInfoResponseBodyModuleOccupantInfoListCostCenterInfoList> & costCenterInfoList() const { DARABONBA_PTR_GET_CONST(costCenterInfoList_, vector<Models::HotelOrderDetailInfoResponseBodyModuleOccupantInfoListCostCenterInfoList>) };
    inline vector<Models::HotelOrderDetailInfoResponseBodyModuleOccupantInfoListCostCenterInfoList> costCenterInfoList() { DARABONBA_PTR_GET(costCenterInfoList_, vector<Models::HotelOrderDetailInfoResponseBodyModuleOccupantInfoListCostCenterInfoList>) };
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setCostCenterInfoList(const vector<Models::HotelOrderDetailInfoResponseBodyModuleOccupantInfoListCostCenterInfoList> & costCenterInfoList) { DARABONBA_PTR_SET_VALUE(costCenterInfoList_, costCenterInfoList) };
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setCostCenterInfoList(vector<Models::HotelOrderDetailInfoResponseBodyModuleOccupantInfoListCostCenterInfoList> && costCenterInfoList) { DARABONBA_PTR_SET_RVALUE(costCenterInfoList_, costCenterInfoList) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setCustomerType(int32_t customerType) { DARABONBA_PTR_SET_VALUE(customerType_, customerType) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setDepartmentId(string departmentId) { DARABONBA_PTR_SET_VALUE(departmentId_, departmentId) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setDepartmentName(string departmentName) { DARABONBA_PTR_SET_VALUE(departmentName_, departmentName) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setEmail(string email) { DARABONBA_PTR_SET_VALUE(email_, email) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setEmployeeType(int32_t employeeType) { DARABONBA_PTR_SET_VALUE(employeeType_, employeeType) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setFirstName(string firstName) { DARABONBA_PTR_SET_VALUE(firstName_, firstName) };


    // isBooker Field Functions 
    bool hasIsBooker() const { return this->isBooker_ != nullptr;};
    void deleteIsBooker() { this->isBooker_ = nullptr;};
    inline bool isBooker() const { DARABONBA_PTR_GET_DEFAULT(isBooker_, false) };
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setIsBooker(bool isBooker) { DARABONBA_PTR_SET_VALUE(isBooker_, isBooker) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setLastName(string lastName) { DARABONBA_PTR_SET_VALUE(lastName_, lastName) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setPhone(string phone) { DARABONBA_PTR_SET_VALUE(phone_, phone) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setRoomNo(int32_t roomNo) { DARABONBA_PTR_SET_VALUE(roomNo_, roomNo) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setSelected(bool selected) { DARABONBA_PTR_SET_VALUE(selected_, selected) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setStaffNo(string staffNo) { DARABONBA_PTR_SET_VALUE(staffNo_, staffNo) };
    ...
    inline HotelOrderDetailInfoResponseBodyModuleOccupantInfoList& setUserType(int32_t userType) { DARABONBA_PTR_SET_VALUE(userType_, userType) };


  protected:
    std::shared_ptr<string> cardNo_ = nullptr;
    std::shared_ptr<int32_t> cardType_ = nullptr;
    std::shared_ptr<vector<Models::HotelOrderDetailInfoResponseBodyModuleOccupantInfoListCostCenterInfoList>> costCenterInfoList_ = nullptr;
    ...
    std::shared_ptr<bool> isBooker_ = nullptr;
