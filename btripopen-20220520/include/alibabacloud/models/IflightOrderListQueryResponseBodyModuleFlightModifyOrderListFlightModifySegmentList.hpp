...
#ifndef ALIBABACLOUD_MODELS_IFLIGHTORDERLISTQUERYRESPONSEBODYMODULEFLIGHTMODIFYORDERLISTFLIGHTMODIFYSEGMENTLIST_HPP_
#define ALIBABACLOUD_MODELS_IFLIGHTORDERLISTQUERYRESPONSEBODYMODULEFLIGHTMODIFYORDERLISTFLIGHTMODIFYSEGMENTLIST_HPP_
...
namespace Models
{
  class IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& obj) { 
    ...
    IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList() = default ;
    IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList(const IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList &) = default ;
    IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList(IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList &&) = default ;
    IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList() = default ;
    IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& operator=(const IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList &) = default ;
    IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& operator=(IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList &&) = default ;
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setAirlineCode(string airlineCode) { DARABONBA_PTR_SET_VALUE(airlineCode_, airlineCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setAirlineName(string airlineName) { DARABONBA_PTR_SET_VALUE(airlineName_, airlineName) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrApt(string arrApt) { DARABONBA_PTR_SET_VALUE(arrApt_, arrApt) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrAptCode(string arrAptCode) { DARABONBA_PTR_SET_VALUE(arrAptCode_, arrAptCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrCity(string arrCity) { DARABONBA_PTR_SET_VALUE(arrCity_, arrCity) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrCityCode(string arrCityCode) { DARABONBA_PTR_SET_VALUE(arrCityCode_, arrCityCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrTerminal(string arrTerminal) { DARABONBA_PTR_SET_VALUE(arrTerminal_, arrTerminal) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setArrTime(string arrTime) { DARABONBA_PTR_SET_VALUE(arrTime_, arrTime) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setCarrierAirlineCode(string carrierAirlineCode) { DARABONBA_PTR_SET_VALUE(carrierAirlineCode_, carrierAirlineCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setCarrierAirlineName(string carrierAirlineName) { DARABONBA_PTR_SET_VALUE(carrierAirlineName_, carrierAirlineName) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepApt(string depApt) { DARABONBA_PTR_SET_VALUE(depApt_, depApt) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepAptCode(string depAptCode) { DARABONBA_PTR_SET_VALUE(depAptCode_, depAptCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepCity(string depCity) { DARABONBA_PTR_SET_VALUE(depCity_, depCity) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepCityCode(string depCityCode) { DARABONBA_PTR_SET_VALUE(depCityCode_, depCityCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepTerminal(string depTerminal) { DARABONBA_PTR_SET_VALUE(depTerminal_, depTerminal) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setDepTime(string depTime) { DARABONBA_PTR_SET_VALUE(depTime_, depTime) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setFlightNo(string flightNo) { DARABONBA_PTR_SET_VALUE(flightNo_, flightNo) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setJourneyIndex(int32_t journeyIndex) { DARABONBA_PTR_SET_VALUE(journeyIndex_, journeyIndex) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setSegmentIndex(int32_t segmentIndex) { DARABONBA_PTR_SET_VALUE(segmentIndex_, segmentIndex) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setShare(bool share) { DARABONBA_PTR_SET_VALUE(share_, share) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setStopAptCode(string stopAptCode) { DARABONBA_PTR_SET_VALUE(stopAptCode_, stopAptCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setStopArrTime(string stopArrTime) { DARABONBA_PTR_SET_VALUE(stopArrTime_, stopArrTime) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setStopCity(string stopCity) { DARABONBA_PTR_SET_VALUE(stopCity_, stopCity) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setStopCityCode(string stopCityCode) { DARABONBA_PTR_SET_VALUE(stopCityCode_, stopCityCode) };
    ...
    inline IFlightOrderListQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList& setStopDepTime(string stopDepTime) { DARABONBA_PTR_SET_VALUE(stopDepTime_, stopDepTime) };
