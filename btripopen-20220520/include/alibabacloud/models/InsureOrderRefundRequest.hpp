...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getPolicyNoList() const { DARABONBA_PTR_GET_CONST(policyNoList_, vector<string>) };
    inline vector<string> getPolicyNoList() { DARABONBA_PTR_GET(policyNoList_, vector<string>) };
    ...
    inline const vector<string> & getSubInsOrderIds() const { DARABONBA_PTR_GET_CONST(subInsOrderIds_, vector<string>) };
    inline vector<string> getSubInsOrderIds() { DARABONBA_PTR_GET(subInsOrderIds_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> policyNoList_ {};
    shared_ptr<vector<string>> subInsOrderIds_ {};
