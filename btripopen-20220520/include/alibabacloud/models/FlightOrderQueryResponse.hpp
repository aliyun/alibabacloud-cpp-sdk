...
namespace Models
{
  ...
  public:
    ...
    inline const FlightOrderQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FlightOrderQueryResponseBody) };
    inline FlightOrderQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, FlightOrderQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FlightOrderQueryResponseBody> body_ {};
  };
