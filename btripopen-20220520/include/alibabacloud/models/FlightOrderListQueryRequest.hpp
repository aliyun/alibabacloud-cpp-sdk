...
#ifndef ALIBABACLOUD_MODELS_FLIGHTORDERLISTQUERYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_FLIGHTORDERLISTQUERYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const FlightOrderListQueryRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FlightOrderListQueryRequest& obj) { 
    ...
    FlightOrderListQueryRequest() = default ;
    FlightOrderListQueryRequest(const FlightOrderListQueryRequest &) = default ;
    FlightOrderListQueryRequest(FlightOrderListQueryRequest &&) = default ;
    FlightOrderListQueryRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FlightOrderListQueryRequest() = default ;
    FlightOrderListQueryRequest& operator=(const FlightOrderListQueryRequest &) = default ;
    FlightOrderListQueryRequest& operator=(FlightOrderListQueryRequest &&) = default ;
    ...
    inline FlightOrderListQueryRequest& setAllApply(bool allApply) { DARABONBA_PTR_SET_VALUE(allApply_, allApply) };
    ...
    inline FlightOrderListQueryRequest& setApplyId(int64_t applyId) { DARABONBA_PTR_SET_VALUE(applyId_, applyId) };
    ...
    inline FlightOrderListQueryRequest& setDepartId(string departId) { DARABONBA_PTR_SET_VALUE(departId_, departId) };
    ...
    inline FlightOrderListQueryRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline FlightOrderListQueryRequest& setPage(int32_t page) { DARABONBA_PTR_SET_VALUE(page_, page) };
    ...
    inline FlightOrderListQueryRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline FlightOrderListQueryRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline FlightOrderListQueryRequest& setThirdpartApplyId(string thirdpartApplyId) { DARABONBA_PTR_SET_VALUE(thirdpartApplyId_, thirdpartApplyId) };
    ...
    inline FlightOrderListQueryRequest& setUpdateEndTime(string updateEndTime) { DARABONBA_PTR_SET_VALUE(updateEndTime_, updateEndTime) };
    ...
    inline FlightOrderListQueryRequest& setUpdateStartTime(string updateStartTime) { DARABONBA_PTR_SET_VALUE(updateStartTime_, updateStartTime) };
    ...
    inline FlightOrderListQueryRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
