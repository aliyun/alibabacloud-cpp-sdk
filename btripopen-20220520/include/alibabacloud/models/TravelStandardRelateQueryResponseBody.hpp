...
namespace Models
{
  ...
  public:
    ...
    inline const TravelStandardRelateQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, TravelStandardRelateQueryResponseBodyModule) };
    inline TravelStandardRelateQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, TravelStandardRelateQueryResponseBodyModule) };
    inline TravelStandardRelateQueryResponseBody& setModule(const TravelStandardRelateQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline TravelStandardRelateQueryResponseBody& setModule(TravelStandardRelateQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<TravelStandardRelateQueryResponseBodyModule> module_ = nullptr;
