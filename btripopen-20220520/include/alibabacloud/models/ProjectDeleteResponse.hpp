...
namespace Models
{
  ...
  public:
    ...
    inline const ProjectDeleteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ProjectDeleteResponseBody) };
    inline ProjectDeleteResponseBody getBody() { DARABONBA_PTR_GET(body_, ProjectDeleteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ProjectDeleteResponseBody> body_ {};
  };
