...
namespace Models
{
  ...
  public:
    ...
    inline const HotelOrderChangeDetailResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelOrderChangeDetailResponseBodyModule) };
    inline HotelOrderChangeDetailResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelOrderChangeDetailResponseBodyModule) };
    inline HotelOrderChangeDetailResponseBody& setModule(const HotelOrderChangeDetailResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelOrderChangeDetailResponseBody& setModule(HotelOrderChangeDetailResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelOrderChangeDetailResponseBodyModule> module_ = nullptr;
