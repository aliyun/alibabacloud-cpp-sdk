...
namespace Models
{
  ...
  public:
    ...
    inline const UserQueryResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, UserQueryResponseBodyModule) };
    inline UserQueryResponseBodyModule module() { DARABONBA_PTR_GET(module_, UserQueryResponseBodyModule) };
    inline UserQueryResponseBody& setModule(const UserQueryResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline UserQueryResponseBody& setModule(UserQueryResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<UserQueryResponseBodyModule> module_ = nullptr;
