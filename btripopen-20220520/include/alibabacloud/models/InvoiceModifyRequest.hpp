...
#ifndef ALIBABACLOUD_MODELS_INVOICEMODIFYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_INVOICEMODIFYREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const InvoiceModifyRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, InvoiceModifyRequest& obj) { 
    ...
    InvoiceModifyRequest() = default ;
    InvoiceModifyRequest(const InvoiceModifyRequest &) = default ;
    InvoiceModifyRequest(InvoiceModifyRequest &&) = default ;
    InvoiceModifyRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~InvoiceModifyRequest() = default ;
    InvoiceModifyRequest& operator=(const InvoiceModifyRequest &) = default ;
    InvoiceModifyRequest& operator=(InvoiceModifyRequest &&) = default ;
    ...
    inline InvoiceModifyRequest& setAddress(string address) { DARABONBA_PTR_SET_VALUE(address_, address) };
    ...
    inline InvoiceModifyRequest& setBankName(string bankName) { DARABONBA_PTR_SET_VALUE(bankName_, bankName) };
    ...
    inline InvoiceModifyRequest& setBankNo(string bankNo) { DARABONBA_PTR_SET_VALUE(bankNo_, bankNo) };
    ...
    inline InvoiceModifyRequest& setMailThirdPartId(string mailThirdPartId) { DARABONBA_PTR_SET_VALUE(mailThirdPartId_, mailThirdPartId) };
    ...
    inline InvoiceModifyRequest& setTaxNo(string taxNo) { DARABONBA_PTR_SET_VALUE(taxNo_, taxNo) };
    ...
    inline InvoiceModifyRequest& setTel(string tel) { DARABONBA_PTR_SET_VALUE(tel_, tel) };
    ...
    inline InvoiceModifyRequest& setThirdPartId(string thirdPartId) { DARABONBA_PTR_SET_VALUE(thirdPartId_, thirdPartId) };
    ...
    inline InvoiceModifyRequest& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline InvoiceModifyRequest& setType(int32_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline InvoiceModifyRequest& setUnitType(int32_t unitType) { DARABONBA_PTR_SET_VALUE(unitType_, unitType) };
