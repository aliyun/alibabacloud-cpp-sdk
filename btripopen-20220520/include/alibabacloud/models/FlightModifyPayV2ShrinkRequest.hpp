...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->extParamsShrink_ == nullptr
    ...
    inline string getExtParamsShrink() const { DARABONBA_PTR_GET_DEFAULT(extParamsShrink_, "") };
  ...
  protected:
    shared_ptr<string> extParamsShrink_ {};
