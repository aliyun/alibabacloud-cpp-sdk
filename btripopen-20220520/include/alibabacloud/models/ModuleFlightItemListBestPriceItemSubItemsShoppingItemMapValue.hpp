...
namespace Models
{
  ...
  public:
    ...
    inline const map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityValue> & getCabinQuantity() const { DARABONBA_PTR_GET_CONST(cabinQuantity_, map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityValue>) };
    inline map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityValue> getCabinQuantity() { DARABONBA_PTR_GET(cabinQuantity_, map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityValue>) };
    ...
    inline const ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue::SearchPrice & getSearchPrice() const { DARABONBA_PTR_GET_CONST(searchPrice_, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue::SearchPrice) };
    inline ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue::SearchPrice getSearchPrice() { DARABONBA_PTR_GET(searchPrice_, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue::SearchPrice) };
    inline ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue& setSearchPrice(const ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue::SearchPrice & searchPrice) { DARABONBA_PTR_SET_VALUE(searchPrice_, searchPrice) };
    inline ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue& setSearchPrice(ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue::SearchPrice && searchPrice) { DARABONBA_PTR_SET_RVALUE(searchPrice_, searchPrice) };
    ...
    inline const map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceValue> & getSegmentPrice() const { DARABONBA_PTR_GET_CONST(segmentPrice_, map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceValue>) };
    inline map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceValue> getSegmentPrice() { DARABONBA_PTR_GET(segmentPrice_, map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceValue>) };
  ...
  protected:
    ...
    shared_ptr<map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityValue>> cabinQuantity_ {};
    shared_ptr<ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue::SearchPrice> searchPrice_ {};
    shared_ptr<map<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceValue>> segmentPrice_ {};
  };
