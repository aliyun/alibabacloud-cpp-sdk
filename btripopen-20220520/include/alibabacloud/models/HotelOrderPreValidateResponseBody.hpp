...
namespace Models
{
  ...
  public:
    ...
    inline const HotelOrderPreValidateResponseBodyModule & module() const { DARABONBA_PTR_GET_CONST(module_, HotelOrderPreValidateResponseBodyModule) };
    inline HotelOrderPreValidateResponseBodyModule module() { DARABONBA_PTR_GET(module_, HotelOrderPreValidateResponseBodyModule) };
    inline HotelOrderPreValidateResponseBody& setModule(const HotelOrderPreValidateResponseBodyModule & module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    inline HotelOrderPreValidateResponseBody& setModule(HotelOrderPreValidateResponseBodyModule && module) { DARABONBA_PTR_SET_RVALUE(module_, module) };
  ...
  protected:
    ...
    std::shared_ptr<HotelOrderPreValidateResponseBodyModule> module_ = nullptr;
    // requestId
