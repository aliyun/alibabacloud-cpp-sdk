...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alertEmailAddress_ == nullptr
        ...
        && return this->scheduleShrink_ == nullptr && return this->tagsShrink_ == nullptr && return this->taskDefinitionJsonShrink_ == nullptr && return this->taskParallelism_ == nullptr && return this->taskRelationJsonShrink_ == nullptr
