...
namespace Models
{
  ...
  public:
    ...
    inline const GetLivyComputeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetLivyComputeResponseBodyData) };
    inline GetLivyComputeResponseBodyData data() { DARABONBA_PTR_GET(data_, GetLivyComputeResponseBodyData) };
    inline GetLivyComputeResponseBody& setData(const GetLivyComputeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetLivyComputeResponseBody& setData(GetLivyComputeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetLivyComputeResponseBodyData> data_ = nullptr;
