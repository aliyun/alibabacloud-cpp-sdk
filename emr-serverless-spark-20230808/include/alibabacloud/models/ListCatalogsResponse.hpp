...
namespace Models
{
  ...
  public:
    ...
    inline const ListCatalogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCatalogsResponseBody) };
    inline ListCatalogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCatalogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCatalogsResponseBody> body_ {};
  };
