...
namespace Models
{
  ...
  public:
    ...
    inline const StopSessionClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopSessionClusterResponseBody) };
    inline StopSessionClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, StopSessionClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopSessionClusterResponseBody> body_ {};
  };
