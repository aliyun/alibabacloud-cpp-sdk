...
namespace Models
{
  ...
  public:
    ...
    inline const GetLivyComputeTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLivyComputeTokenResponseBody) };
    inline GetLivyComputeTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLivyComputeTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLivyComputeTokenResponseBody> body_ {};
  };
