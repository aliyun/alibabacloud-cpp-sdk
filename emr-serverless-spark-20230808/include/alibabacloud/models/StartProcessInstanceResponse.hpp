...
namespace Models
{
  ...
  public:
    ...
    inline const StartProcessInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartProcessInstanceResponseBody) };
    inline StartProcessInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, StartProcessInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartProcessInstanceResponseBody> body_ {};
  };
