...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getCommiter() const { DARABONBA_PTR_GET_DEFAULT(commiter_, 0L) };
    ...
    inline const Task & getItem() const { DARABONBA_PTR_GET_CONST(item_, Task) };
    inline Task getItem() { DARABONBA_PTR_GET(item_, Task) };
  ...
  protected:
    ...
    shared_ptr<int64_t> commiter_ {};
    shared_ptr<string> gmtCreated_ {};
    shared_ptr<Task> item_ {};
