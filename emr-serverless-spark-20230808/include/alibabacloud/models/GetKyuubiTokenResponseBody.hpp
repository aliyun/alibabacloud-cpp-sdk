...
namespace Models
{
  ...
  public:
    ...
    inline const GetKyuubiTokenResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetKyuubiTokenResponseBodyData) };
    inline GetKyuubiTokenResponseBodyData data() { DARABONBA_PTR_GET(data_, GetKyuubiTokenResponseBodyData) };
    inline GetKyuubiTokenResponseBody& setData(const GetKyuubiTokenResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetKyuubiTokenResponseBody& setData(GetKyuubiTokenResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<GetKyuubiTokenResponseBodyData> data_ = nullptr;
