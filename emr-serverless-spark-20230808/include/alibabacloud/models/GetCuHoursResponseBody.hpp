...
namespace Models
{
  ...
  public:
    ...
    inline const GetCuHoursResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCuHoursResponseBodyData) };
    inline GetCuHoursResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCuHoursResponseBodyData) };
    inline GetCuHoursResponseBody& setData(const GetCuHoursResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCuHoursResponseBody& setData(GetCuHoursResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    std::shared_ptr<GetCuHoursResponseBodyData> data_ = nullptr;
    // The request ID.
