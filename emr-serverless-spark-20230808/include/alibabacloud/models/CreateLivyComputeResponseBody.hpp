...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->livyComputeId_ == nullptr; };
      ...
      inline string getLivyComputeId() const { DARABONBA_PTR_GET_DEFAULT(livyComputeId_, "") };
      inline Data& setLivyComputeId(string livyComputeId) { DARABONBA_PTR_SET_VALUE(livyComputeId_, livyComputeId) };
    ...
    inline const CreateLivyComputeResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateLivyComputeResponseBody::Data) };
    inline CreateLivyComputeResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateLivyComputeResponseBody::Data) };
    inline CreateLivyComputeResponseBody& setData(const CreateLivyComputeResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateLivyComputeResponseBody& setData(CreateLivyComputeResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
