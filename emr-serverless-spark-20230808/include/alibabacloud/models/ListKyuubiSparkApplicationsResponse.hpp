...
namespace Models
{
  ...
  public:
    ...
    inline const ListKyuubiSparkApplicationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListKyuubiSparkApplicationsResponseBody) };
    inline ListKyuubiSparkApplicationsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListKyuubiSparkApplicationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListKyuubiSparkApplicationsResponseBody> body_ {};
  };
