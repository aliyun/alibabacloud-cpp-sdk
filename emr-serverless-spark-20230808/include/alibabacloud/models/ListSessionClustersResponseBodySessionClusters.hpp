...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationConfigs_ == nullptr
        ...
        && return this->domainInner_ == nullptr && return this->draftId_ == nullptr && return this->extra_ == nullptr && return this->fusion_ == nullptr && return this->gmtCreate_ == nullptr
        && return this->kind_ == nullptr && return this->name_ == nullptr && return this->publicEndpointEnabled_ == nullptr && return this->queueName_ == nullptr && return this->releaseVersion_ == nullptr
        && return this->sessionClusterId_ == nullptr && return this->startTime_ == nullptr && return this->state_ == nullptr && return this->stateChangeReason_ == nullptr && return this->userId_ == nullptr
        && return this->userName_ == nullptr && return this->webUI_ == nullptr && return this->workspaceId_ == nullptr; };
