...
namespace Models
{
  ...
  public:
    ...
    inline const TerminateSqlStatementResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TerminateSqlStatementResponseBody) };
    inline TerminateSqlStatementResponseBody getBody() { DARABONBA_PTR_GET(body_, TerminateSqlStatementResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TerminateSqlStatementResponseBody> body_ {};
  };
