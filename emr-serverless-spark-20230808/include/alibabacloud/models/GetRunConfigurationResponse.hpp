...
namespace Models
{
  ...
  public:
    ...
    inline const GetRunConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRunConfigurationResponseBody) };
    inline GetRunConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRunConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRunConfigurationResponseBody> body_ {};
  };
