...
namespace Models
{
  ...
  public:
    ...
    inline const GetLivyComputeTokenResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetLivyComputeTokenResponseBody::Data) };
    inline GetLivyComputeTokenResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetLivyComputeTokenResponseBody::Data) };
    inline GetLivyComputeTokenResponseBody& setData(const GetLivyComputeTokenResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetLivyComputeTokenResponseBody& setData(GetLivyComputeTokenResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
