...
namespace Models
{
  ...
  public:
    ...
    inline string getKerberosConfId() const { DARABONBA_PTR_GET_DEFAULT(kerberosConfId_, "") };
    ...
    inline const vector<string> & getKeytabs() const { DARABONBA_PTR_GET_CONST(keytabs_, vector<string>) };
    inline vector<string> getKeytabs() { DARABONBA_PTR_GET(keytabs_, vector<string>) };
    ...
    inline string getKrb5Conf() const { DARABONBA_PTR_GET_DEFAULT(krb5Conf_, "") };
  ...
  protected:
    ...
    shared_ptr<string> kerberosConfId_ {};
    shared_ptr<vector<string>> keytabs_ {};
    shared_ptr<string> krb5Conf_ {};
