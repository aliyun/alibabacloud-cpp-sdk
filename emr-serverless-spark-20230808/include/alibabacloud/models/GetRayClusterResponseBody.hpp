...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetRayClusterResponseBody& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(jobUrlInner, jobUrlInner_);
    ...
    friend void from_json(const Darabonba::Json& j, GetRayClusterResponseBody& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(jobUrlInner, jobUrlInner_);
    ...
    virtual bool empty() const override { return this->clusterId_ == nullptr
        ...
        && this->instances_ == nullptr && this->jobUrl_ == nullptr && this->jobUrlInner_ == nullptr && this->message_ == nullptr && this->modified_ == nullptr
        && this->modifiedTime_ == nullptr && this->modifier_ == nullptr && this->modifierName_ == nullptr && this->name_ == nullptr && this->networkServiceName_ == nullptr
        && this->requestId_ == nullptr && this->startTime_ == nullptr && this->state_ == nullptr && this->submitToken_ == nullptr && this->userId_ == nullptr
    ...
    // jobUrlInner Field Functions 
    bool hasJobUrlInner() const { return this->jobUrlInner_ != nullptr;};
    void deleteJobUrlInner() { this->jobUrlInner_ = nullptr;};
    inline string getJobUrlInner() const { DARABONBA_PTR_GET_DEFAULT(jobUrlInner_, "") };
    inline GetRayClusterResponseBody& setJobUrlInner(string jobUrlInner) { DARABONBA_PTR_SET_VALUE(jobUrlInner_, jobUrlInner) };
    ...
    inline GetRayClusterResponseBody& setVolumeIds(const vector<string> & volumeIds) { DARABONBA_PTR_SET_VALUE(volumeIds_, volumeIds) };
    inline GetRayClusterResponseBody& setVolumeIds(vector<string> && volumeIds) { DARABONBA_PTR_SET_RVALUE(volumeIds_, volumeIds) };
