...
namespace Models
{
  ...
  public:
    ...
    inline bool getIsProd() const { DARABONBA_PTR_GET_DEFAULT(isProd_, false) };
    ...
    inline int64_t getProcessDefinitionCode() const { DARABONBA_PTR_GET_DEFAULT(processDefinitionCode_, 0L) };
    ...
    inline string getRuntimeQueue() const { DARABONBA_PTR_GET_DEFAULT(runtimeQueue_, "") };
