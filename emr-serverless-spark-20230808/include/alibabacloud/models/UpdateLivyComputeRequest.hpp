...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLivyComputeRequest::AutoStartConfiguration & getAutoStartConfiguration() const { DARABONBA_PTR_GET_CONST(autoStartConfiguration_, UpdateLivyComputeRequest::AutoStartConfiguration) };
    inline UpdateLivyComputeRequest::AutoStartConfiguration getAutoStartConfiguration() { DARABONBA_PTR_GET(autoStartConfiguration_, UpdateLivyComputeRequest::AutoStartConfiguration) };
    inline UpdateLivyComputeRequest& setAutoStartConfiguration(const UpdateLivyComputeRequest::AutoStartConfiguration & autoStartConfiguration) { DARABONBA_PTR_SET_VALUE(autoStartConfiguration_, autoStartConfiguration) };
    inline UpdateLivyComputeRequest& setAutoStartConfiguration(UpdateLivyComputeRequest::AutoStartConfiguration && autoStartConfiguration) { DARABONBA_PTR_SET_RVALUE(autoStartConfiguration_, autoStartConfiguration) };
    ...
    inline const UpdateLivyComputeRequest::AutoStopConfiguration & getAutoStopConfiguration() const { DARABONBA_PTR_GET_CONST(autoStopConfiguration_, UpdateLivyComputeRequest::AutoStopConfiguration) };
    inline UpdateLivyComputeRequest::AutoStopConfiguration getAutoStopConfiguration() { DARABONBA_PTR_GET(autoStopConfiguration_, UpdateLivyComputeRequest::AutoStopConfiguration) };
    inline UpdateLivyComputeRequest& setAutoStopConfiguration(const UpdateLivyComputeRequest::AutoStopConfiguration & autoStopConfiguration) { DARABONBA_PTR_SET_VALUE(autoStopConfiguration_, autoStopConfiguration) };
    inline UpdateLivyComputeRequest& setAutoStopConfiguration(UpdateLivyComputeRequest::AutoStopConfiguration && autoStopConfiguration) { DARABONBA_PTR_SET_RVALUE(autoStopConfiguration_, autoStopConfiguration) };
