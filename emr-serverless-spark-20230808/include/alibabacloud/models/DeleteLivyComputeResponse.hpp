...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLivyComputeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLivyComputeResponseBody) };
    inline DeleteLivyComputeResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLivyComputeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLivyComputeResponseBody> body_ {};
  };
