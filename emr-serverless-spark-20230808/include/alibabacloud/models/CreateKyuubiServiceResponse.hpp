...
namespace Models
{
  ...
  public:
    ...
    inline const CreateKyuubiServiceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateKyuubiServiceResponseBody) };
    inline CreateKyuubiServiceResponseBody body() { DARABONBA_PTR_GET(body_, CreateKyuubiServiceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateKyuubiServiceResponseBody> body_ = nullptr;
  };
