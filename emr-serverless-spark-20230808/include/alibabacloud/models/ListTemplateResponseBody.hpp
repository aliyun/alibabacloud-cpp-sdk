...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Template> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<Template>) };
    inline vector<Template> getData() { DARABONBA_PTR_GET(data_, vector<Template>) };
