...
namespace Models
{
  ...
  public:
    ...
    inline const CreateKyuubiServiceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateKyuubiServiceResponseBodyData) };
    inline CreateKyuubiServiceResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateKyuubiServiceResponseBodyData) };
    inline CreateKyuubiServiceResponseBody& setData(const CreateKyuubiServiceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateKyuubiServiceResponseBody& setData(CreateKyuubiServiceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<CreateKyuubiServiceResponseBodyData> data_ = nullptr;
