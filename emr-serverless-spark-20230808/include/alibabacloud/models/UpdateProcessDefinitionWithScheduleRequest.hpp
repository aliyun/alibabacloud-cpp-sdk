...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateProcessDefinitionWithScheduleRequest::GlobalParams> & getGlobalParams() const { DARABONBA_PTR_GET_CONST(globalParams_, vector<UpdateProcessDefinitionWithScheduleRequest::GlobalParams>) };
    inline vector<UpdateProcessDefinitionWithScheduleRequest::GlobalParams> getGlobalParams() { DARABONBA_PTR_GET(globalParams_, vector<UpdateProcessDefinitionWithScheduleRequest::GlobalParams>) };
    inline UpdateProcessDefinitionWithScheduleRequest& setGlobalParams(const vector<UpdateProcessDefinitionWithScheduleRequest::GlobalParams> & globalParams) { DARABONBA_PTR_SET_VALUE(globalParams_, globalParams) };
    inline UpdateProcessDefinitionWithScheduleRequest& setGlobalParams(vector<UpdateProcessDefinitionWithScheduleRequest::GlobalParams> && globalParams) { DARABONBA_PTR_SET_RVALUE(globalParams_, globalParams) };
    ...
    inline const UpdateProcessDefinitionWithScheduleRequest::Schedule & getSchedule() const { DARABONBA_PTR_GET_CONST(schedule_, UpdateProcessDefinitionWithScheduleRequest::Schedule) };
    inline UpdateProcessDefinitionWithScheduleRequest::Schedule getSchedule() { DARABONBA_PTR_GET(schedule_, UpdateProcessDefinitionWithScheduleRequest::Schedule) };
    inline UpdateProcessDefinitionWithScheduleRequest& setSchedule(const UpdateProcessDefinitionWithScheduleRequest::Schedule & schedule) { DARABONBA_PTR_SET_VALUE(schedule_, schedule) };
    inline UpdateProcessDefinitionWithScheduleRequest& setSchedule(UpdateProcessDefinitionWithScheduleRequest::Schedule && schedule) { DARABONBA_PTR_SET_RVALUE(schedule_, schedule) };
    ...
    inline const vector<UpdateProcessDefinitionWithScheduleRequest::TaskDefinitionJson> & getTaskDefinitionJson() const { DARABONBA_PTR_GET_CONST(taskDefinitionJson_, vector<UpdateProcessDefinitionWithScheduleRequest::TaskDefinitionJson>) };
    inline vector<UpdateProcessDefinitionWithScheduleRequest::TaskDefinitionJson> getTaskDefinitionJson() { DARABONBA_PTR_GET(taskDefinitionJson_, vector<UpdateProcessDefinitionWithScheduleRequest::TaskDefinitionJson>) };
    inline UpdateProcessDefinitionWithScheduleRequest& setTaskDefinitionJson(const vector<UpdateProcessDefinitionWithScheduleRequest::TaskDefinitionJson> & taskDefinitionJson) { DARABONBA_PTR_SET_VALUE(taskDefinitionJson_, taskDefinitionJson) };
    inline UpdateProcessDefinitionWithScheduleRequest& setTaskDefinitionJson(vector<UpdateProcessDefinitionWithScheduleRequest::TaskDefinitionJson> && taskDefinitionJson) { DARABONBA_PTR_SET_RVALUE(taskDefinitionJson_, taskDefinitionJson) };
    ...
    inline const vector<UpdateProcessDefinitionWithScheduleRequest::TaskRelationJson> & getTaskRelationJson() const { DARABONBA_PTR_GET_CONST(taskRelationJson_, vector<UpdateProcessDefinitionWithScheduleRequest::TaskRelationJson>) };
    inline vector<UpdateProcessDefinitionWithScheduleRequest::TaskRelationJson> getTaskRelationJson() { DARABONBA_PTR_GET(taskRelationJson_, vector<UpdateProcessDefinitionWithScheduleRequest::TaskRelationJson>) };
    inline UpdateProcessDefinitionWithScheduleRequest& setTaskRelationJson(const vector<UpdateProcessDefinitionWithScheduleRequest::TaskRelationJson> & taskRelationJson) { DARABONBA_PTR_SET_VALUE(taskRelationJson_, taskRelationJson) };
    inline UpdateProcessDefinitionWithScheduleRequest& setTaskRelationJson(vector<UpdateProcessDefinitionWithScheduleRequest::TaskRelationJson> && taskRelationJson) { DARABONBA_PTR_SET_RVALUE(taskRelationJson_, taskRelationJson) };
