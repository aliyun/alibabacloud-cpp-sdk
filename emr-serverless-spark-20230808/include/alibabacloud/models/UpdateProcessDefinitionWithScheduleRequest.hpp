...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alertEmailAddress_ == nullptr
        ...
        && return this->publish_ == nullptr && return this->regionId_ == nullptr && return this->releaseState_ == nullptr && return this->resourceQueue_ == nullptr && return this->retryTimes_ == nullptr
        && return this->runAs_ == nullptr && return this->schedule_ == nullptr && return this->tags_ == nullptr && return this->taskDefinitionJson_ == nullptr && return this->taskParallelism_ == nullptr
        && return this->taskRelationJson_ == nullptr && return this->timeout_ == nullptr; };
