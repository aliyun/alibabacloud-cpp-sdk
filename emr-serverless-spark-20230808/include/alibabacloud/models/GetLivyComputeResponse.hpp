...
namespace Models
{
  ...
  public:
    ...
    inline const GetLivyComputeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLivyComputeResponseBody) };
    inline GetLivyComputeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLivyComputeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLivyComputeResponseBody> body_ {};
  };
