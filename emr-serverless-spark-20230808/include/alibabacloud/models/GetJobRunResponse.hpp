...
namespace Models
{
  ...
  public:
    ...
    inline const GetJobRunResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetJobRunResponseBody) };
    inline GetJobRunResponseBody getBody() { DARABONBA_PTR_GET(body_, GetJobRunResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetJobRunResponseBody> body_ {};
  };
