...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWorkspaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateWorkspaceResponseBody) };
    inline UpdateWorkspaceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateWorkspaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateWorkspaceResponseBody> body_ {};
  };
