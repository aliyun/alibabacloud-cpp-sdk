...
namespace Models
{
  ...
  public:
    ...
    inline const ListKyuubiServicesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListKyuubiServicesResponseBodyData) };
    inline ListKyuubiServicesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListKyuubiServicesResponseBodyData) };
    inline ListKyuubiServicesResponseBody& setData(const ListKyuubiServicesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListKyuubiServicesResponseBody& setData(ListKyuubiServicesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<ListKyuubiServicesResponseBodyData> data_ = nullptr;
