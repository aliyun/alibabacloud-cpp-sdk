...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLivyComputeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLivyComputeResponseBody) };
    inline UpdateLivyComputeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLivyComputeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLivyComputeResponseBody> body_ {};
  };
