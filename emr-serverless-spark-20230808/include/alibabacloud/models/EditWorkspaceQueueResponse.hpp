...
namespace Models
{
  ...
  public:
    ...
    inline const EditWorkspaceQueueResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EditWorkspaceQueueResponseBody) };
    inline EditWorkspaceQueueResponseBody getBody() { DARABONBA_PTR_GET(body_, EditWorkspaceQueueResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EditWorkspaceQueueResponseBody> body_ {};
  };
