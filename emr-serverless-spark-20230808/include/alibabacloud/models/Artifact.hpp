...
namespace Models
{
  ...
  public:
    ...
    inline string getCatagoryBizId() const { DARABONBA_PTR_GET_DEFAULT(catagoryBizId_, "") };
    ...
    inline const Credential & getCredential() const { DARABONBA_PTR_GET_CONST(credential_, Credential) };
    inline Credential getCredential() { DARABONBA_PTR_GET(credential_, Credential) };
    ...
    inline const vector<string> & getFullPath() const { DARABONBA_PTR_GET_CONST(fullPath_, vector<string>) };
    inline vector<string> getFullPath() { DARABONBA_PTR_GET(fullPath_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<string> catagoryBizId_ {};
    // This parameter is required.
    shared_ptr<int64_t> creator_ {};
    shared_ptr<Credential> credential_ {};
    shared_ptr<vector<string>> fullPath_ {};
    // This parameter is required.
