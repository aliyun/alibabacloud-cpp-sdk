...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListJobExecutorsResponseBodyExexutors> & exexutors() const { DARABONBA_PTR_GET_CONST(exexutors_, vector<ListJobExecutorsResponseBodyExexutors>) };
    inline vector<ListJobExecutorsResponseBodyExexutors> exexutors() { DARABONBA_PTR_GET(exexutors_, vector<ListJobExecutorsResponseBodyExexutors>) };
    inline ListJobExecutorsResponseBody& setExexutors(const vector<ListJobExecutorsResponseBodyExexutors> & exexutors) { DARABONBA_PTR_SET_VALUE(exexutors_, exexutors) };
    inline ListJobExecutorsResponseBody& setExexutors(vector<ListJobExecutorsResponseBodyExexutors> && exexutors) { DARABONBA_PTR_SET_RVALUE(exexutors_, exexutors) };
  ...
  protected:
    std::shared_ptr<vector<ListJobExecutorsResponseBodyExexutors>> exexutors_ = nullptr;
