...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutoProvisioningGroupInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAutoProvisioningGroupInstancesResponseBody) };
    inline DescribeAutoProvisioningGroupInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAutoProvisioningGroupInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAutoProvisioningGroupInstancesResponseBody> body_ {};
  };
