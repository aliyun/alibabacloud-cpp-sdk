...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getSettingType() const { DARABONBA_PTR_GET_CONST(settingType_, vector<string>) };
    inline vector<string> getSettingType() { DARABONBA_PTR_GET(settingType_, vector<string>) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<string>> settingType_ {};
  };
