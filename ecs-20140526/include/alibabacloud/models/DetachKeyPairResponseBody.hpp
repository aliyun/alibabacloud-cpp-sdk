...
namespace Models
{
  ...
  public:
    ...
    inline const DetachKeyPairResponseBody::Results & getResults() const { DARABONBA_PTR_GET_CONST(results_, DetachKeyPairResponseBody::Results) };
    inline DetachKeyPairResponseBody::Results getResults() { DARABONBA_PTR_GET(results_, DetachKeyPairResponseBody::Results) };
    inline DetachKeyPairResponseBody& setResults(const DetachKeyPairResponseBody::Results & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline DetachKeyPairResponseBody& setResults(DetachKeyPairResponseBody::Results && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };
