...
#ifndef ALIBABACLOUD_MODELS_AUTHORIZESECURITYGROUPREQUESTPERMISSIONS_HPP_
#define ALIBABACLOUD_MODELS_AUTHORIZESECURITYGROUPREQUESTPERMISSIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AuthorizeSecurityGroupRequestPermissions& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AuthorizeSecurityGroupRequestPermissions& obj) { 
    ...
    AuthorizeSecurityGroupRequestPermissions() = default ;
    AuthorizeSecurityGroupRequestPermissions(const AuthorizeSecurityGroupRequestPermissions &) = default ;
    AuthorizeSecurityGroupRequestPermissions(AuthorizeSecurityGroupRequestPermissions &&) = default ;
    AuthorizeSecurityGroupRequestPermissions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AuthorizeSecurityGroupRequestPermissions() = default ;
    AuthorizeSecurityGroupRequestPermissions& operator=(const AuthorizeSecurityGroupRequestPermissions &) = default ;
    AuthorizeSecurityGroupRequestPermissions& operator=(AuthorizeSecurityGroupRequestPermissions &&) = default ;
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setDestCidrIp(string destCidrIp) { DARABONBA_PTR_SET_VALUE(destCidrIp_, destCidrIp) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setIpProtocol(string ipProtocol) { DARABONBA_PTR_SET_VALUE(ipProtocol_, ipProtocol) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setIpv6DestCidrIp(string ipv6DestCidrIp) { DARABONBA_PTR_SET_VALUE(ipv6DestCidrIp_, ipv6DestCidrIp) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setIpv6SourceCidrIp(string ipv6SourceCidrIp) { DARABONBA_PTR_SET_VALUE(ipv6SourceCidrIp_, ipv6SourceCidrIp) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setNicType(string nicType) { DARABONBA_PTR_SET_VALUE(nicType_, nicType) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setPolicy(string policy) { DARABONBA_PTR_SET_VALUE(policy_, policy) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setPortRange(string portRange) { DARABONBA_PTR_SET_VALUE(portRange_, portRange) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setPortRangeListId(string portRangeListId) { DARABONBA_PTR_SET_VALUE(portRangeListId_, portRangeListId) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setPriority(string priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setSourceCidrIp(string sourceCidrIp) { DARABONBA_PTR_SET_VALUE(sourceCidrIp_, sourceCidrIp) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setSourceGroupId(string sourceGroupId) { DARABONBA_PTR_SET_VALUE(sourceGroupId_, sourceGroupId) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setSourceGroupOwnerAccount(string sourceGroupOwnerAccount) { DARABONBA_PTR_SET_VALUE(sourceGroupOwnerAccount_, sourceGroupOwnerAccount) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setSourceGroupOwnerId(int64_t sourceGroupOwnerId) { DARABONBA_PTR_SET_VALUE(sourceGroupOwnerId_, sourceGroupOwnerId) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setSourcePortRange(string sourcePortRange) { DARABONBA_PTR_SET_VALUE(sourcePortRange_, sourcePortRange) };
    ...
    inline AuthorizeSecurityGroupRequestPermissions& setSourcePrefixListId(string sourcePrefixListId) { DARABONBA_PTR_SET_VALUE(sourcePrefixListId_, sourcePrefixListId) };
