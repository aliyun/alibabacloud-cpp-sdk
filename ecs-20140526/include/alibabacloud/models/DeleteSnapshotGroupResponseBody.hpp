...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSnapshotGroupResponseBody::OperationProgressSet & getOperationProgressSet() const { DARABONBA_PTR_GET_CONST(operationProgressSet_, DeleteSnapshotGroupResponseBody::OperationProgressSet) };
    inline DeleteSnapshotGroupResponseBody::OperationProgressSet getOperationProgressSet() { DARABONBA_PTR_GET(operationProgressSet_, DeleteSnapshotGroupResponseBody::OperationProgressSet) };
    inline DeleteSnapshotGroupResponseBody& setOperationProgressSet(const DeleteSnapshotGroupResponseBody::OperationProgressSet & operationProgressSet) { DARABONBA_PTR_SET_VALUE(operationProgressSet_, operationProgressSet) };
    inline DeleteSnapshotGroupResponseBody& setOperationProgressSet(DeleteSnapshotGroupResponseBody::OperationProgressSet && operationProgressSet) { DARABONBA_PTR_SET_RVALUE(operationProgressSet_, operationProgressSet) };
