...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceAutoReleaseTimeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceAutoReleaseTimeResponseBody) };
    inline ModifyInstanceAutoReleaseTimeResponseBody body() { DARABONBA_PTR_GET(body_, ModifyInstanceAutoReleaseTimeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyInstanceAutoReleaseTimeResponseBody> body_ = nullptr;
  };
