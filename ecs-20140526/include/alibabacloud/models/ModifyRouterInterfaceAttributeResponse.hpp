...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyRouterInterfaceAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyRouterInterfaceAttributeResponseBody) };
    inline ModifyRouterInterfaceAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyRouterInterfaceAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyRouterInterfaceAttributeResponseBody> body_ {};
  };
