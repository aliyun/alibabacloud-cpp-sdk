...
#ifndef ALIBABACLOUD_MODELS_CREATEAUTOPROVISIONINGGROUPSHRINKREQUESTLAUNCHCONFIGURATION_HPP_
#define ALIBABACLOUD_MODELS_CREATEAUTOPROVISIONINGGROUPSHRINKREQUESTLAUNCHCONFIGURATION_HPP_
...
namespace Models
{
  class CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& obj) { 
    ...
    CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration() = default ;
    CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration(const CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration &) = default ;
    CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration(CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration &&) = default ;
    CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration() = default ;
    CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& operator=(const CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration &) = default ;
    CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& operator=(CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration &&) = default ;
    ...
    inline const vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationArn> & arn() const { DARABONBA_PTR_GET_CONST(arn_, vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationArn>) };
    inline vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationArn> arn() { DARABONBA_PTR_GET(arn_, vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationArn>) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setArn(const vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationArn> & arn) { DARABONBA_PTR_SET_VALUE(arn_, arn) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setArn(vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationArn> && arn) { DARABONBA_PTR_SET_RVALUE(arn_, arn) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setAutoReleaseTime(string autoReleaseTime) { DARABONBA_PTR_SET_VALUE(autoReleaseTime_, autoReleaseTime) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setCreditSpecification(string creditSpecification) { DARABONBA_PTR_SET_VALUE(creditSpecification_, creditSpecification) };


    // dataDisk Field Functions 
    bool hasDataDisk() const { return this->dataDisk_ != nullptr;};
    void deleteDataDisk() { this->dataDisk_ = nullptr;};
    inline const vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk> & dataDisk() const { DARABONBA_PTR_GET_CONST(dataDisk_, vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk>) };
    inline vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk> dataDisk() { DARABONBA_PTR_GET(dataDisk_, vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk>) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setDataDisk(const vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk> & dataDisk) { DARABONBA_PTR_SET_VALUE(dataDisk_, dataDisk) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setDataDisk(vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk> && dataDisk) { DARABONBA_PTR_SET_RVALUE(dataDisk_, dataDisk) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setDeploymentSetId(string deploymentSetId) { DARABONBA_PTR_SET_VALUE(deploymentSetId_, deploymentSetId) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setHostName(string hostName) { DARABONBA_PTR_SET_VALUE(hostName_, hostName) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setHostNames(const vector<string> & hostNames) { DARABONBA_PTR_SET_VALUE(hostNames_, hostNames) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setHostNames(vector<string> && hostNames) { DARABONBA_PTR_SET_RVALUE(hostNames_, hostNames) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setImageFamily(string imageFamily) { DARABONBA_PTR_SET_VALUE(imageFamily_, imageFamily) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setImageId(string imageId) { DARABONBA_PTR_SET_VALUE(imageId_, imageId) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setInstanceDescription(string instanceDescription) { DARABONBA_PTR_SET_VALUE(instanceDescription_, instanceDescription) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setInstanceName(string instanceName) { DARABONBA_PTR_SET_VALUE(instanceName_, instanceName) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setInternetChargeType(string internetChargeType) { DARABONBA_PTR_SET_VALUE(internetChargeType_, internetChargeType) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setInternetMaxBandwidthIn(int32_t internetMaxBandwidthIn) { DARABONBA_PTR_SET_VALUE(internetMaxBandwidthIn_, internetMaxBandwidthIn) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setInternetMaxBandwidthOut(int32_t internetMaxBandwidthOut) { DARABONBA_PTR_SET_VALUE(internetMaxBandwidthOut_, internetMaxBandwidthOut) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setIoOptimized(string ioOptimized) { DARABONBA_PTR_SET_VALUE(ioOptimized_, ioOptimized) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setKeyPairName(string keyPairName) { DARABONBA_PTR_SET_VALUE(keyPairName_, keyPairName) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setPassword(string password) { DARABONBA_PTR_SET_VALUE(password_, password) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setPasswordInherit(bool passwordInherit) { DARABONBA_PTR_SET_VALUE(passwordInherit_, passwordInherit) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setRamRoleName(string ramRoleName) { DARABONBA_PTR_SET_VALUE(ramRoleName_, ramRoleName) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSecurityEnhancementStrategy(string securityEnhancementStrategy) { DARABONBA_PTR_SET_VALUE(securityEnhancementStrategy_, securityEnhancementStrategy) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSecurityGroupId(string securityGroupId) { DARABONBA_PTR_SET_VALUE(securityGroupId_, securityGroupId) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSecurityGroupIds(const vector<string> & securityGroupIds) { DARABONBA_PTR_SET_VALUE(securityGroupIds_, securityGroupIds) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSecurityGroupIds(vector<string> && securityGroupIds) { DARABONBA_PTR_SET_RVALUE(securityGroupIds_, securityGroupIds) };


    // systemDisk Field Functions 
    bool hasSystemDisk() const { return this->systemDisk_ != nullptr;};
    void deleteSystemDisk() { this->systemDisk_ = nullptr;};
    inline const Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSystemDisk & systemDisk() const { DARABONBA_PTR_GET_CONST(systemDisk_, Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSystemDisk) };
    inline Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSystemDisk systemDisk() { DARABONBA_PTR_GET(systemDisk_, Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSystemDisk) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSystemDisk(const Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSystemDisk & systemDisk) { DARABONBA_PTR_SET_VALUE(systemDisk_, systemDisk) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSystemDisk(Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSystemDisk && systemDisk) { DARABONBA_PTR_SET_RVALUE(systemDisk_, systemDisk) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSystemDiskCategory(string systemDiskCategory) { DARABONBA_PTR_SET_VALUE(systemDiskCategory_, systemDiskCategory) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSystemDiskDescription(string systemDiskDescription) { DARABONBA_PTR_SET_VALUE(systemDiskDescription_, systemDiskDescription) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSystemDiskName(string systemDiskName) { DARABONBA_PTR_SET_VALUE(systemDiskName_, systemDiskName) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSystemDiskPerformanceLevel(string systemDiskPerformanceLevel) { DARABONBA_PTR_SET_VALUE(systemDiskPerformanceLevel_, systemDiskPerformanceLevel) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSystemDiskSize(int32_t systemDiskSize) { DARABONBA_PTR_SET_VALUE(systemDiskSize_, systemDiskSize) };


    // tag Field Functions 
    bool hasTag() const { return this->tag_ != nullptr;};
    void deleteTag() { this->tag_ = nullptr;};
    inline const vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationTag>) };
    inline vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationTag> tag() { DARABONBA_PTR_GET(tag_, vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationTag>) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setTag(const vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setTag(vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setUserData(string userData) { DARABONBA_PTR_SET_VALUE(userData_, userData) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setAutoRenew(bool autoRenew) { DARABONBA_PTR_SET_VALUE(autoRenew_, autoRenew) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setAutoRenewPeriod(int32_t autoRenewPeriod) { DARABONBA_PTR_SET_VALUE(autoRenewPeriod_, autoRenewPeriod) };
    ...
    inline const Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationCpuOptions & cpuOptions() const { DARABONBA_PTR_GET_CONST(cpuOptions_, Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationCpuOptions) };
    inline Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationCpuOptions cpuOptions() { DARABONBA_PTR_GET(cpuOptions_, Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationCpuOptions) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setCpuOptions(const Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationCpuOptions & cpuOptions) { DARABONBA_PTR_SET_VALUE(cpuOptions_, cpuOptions) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setCpuOptions(Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationCpuOptions && cpuOptions) { DARABONBA_PTR_SET_RVALUE(cpuOptions_, cpuOptions) };
    ...
    inline const Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationImageOptions & imageOptions() const { DARABONBA_PTR_GET_CONST(imageOptions_, Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationImageOptions) };
    inline Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationImageOptions imageOptions() { DARABONBA_PTR_GET(imageOptions_, Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationImageOptions) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setImageOptions(const Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationImageOptions & imageOptions) { DARABONBA_PTR_SET_VALUE(imageOptions_, imageOptions) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setImageOptions(Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationImageOptions && imageOptions) { DARABONBA_PTR_SET_RVALUE(imageOptions_, imageOptions) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setPeriod(int32_t period) { DARABONBA_PTR_SET_VALUE(period_, period) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setPeriodUnit(string periodUnit) { DARABONBA_PTR_SET_VALUE(periodUnit_, periodUnit) };
    ...
    inline const Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSchedulerOptions & schedulerOptions() const { DARABONBA_PTR_GET_CONST(schedulerOptions_, Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSchedulerOptions) };
    inline Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSchedulerOptions schedulerOptions() { DARABONBA_PTR_GET(schedulerOptions_, Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSchedulerOptions) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSchedulerOptions(const Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSchedulerOptions & schedulerOptions) { DARABONBA_PTR_SET_VALUE(schedulerOptions_, schedulerOptions) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSpotDuration(int32_t spotDuration) { DARABONBA_PTR_SET_VALUE(spotDuration_, spotDuration) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration& setSpotInterruptionBehavior(string spotInterruptionBehavior) { DARABONBA_PTR_SET_VALUE(spotInterruptionBehavior_, spotInterruptionBehavior) };


  protected:
    // >  This parameter is in invitational preview and is not publicly available.
    std::shared_ptr<vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationArn>> arn_ = nullptr;
    ...
    std::shared_ptr<vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk>> dataDisk_ = nullptr;
    ...
    std::shared_ptr<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationSystemDisk> systemDisk_ = nullptr;
    ...
    std::shared_ptr<vector<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationTag>> tag_ = nullptr;
    ...
    std::shared_ptr<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationCpuOptions> cpuOptions_ = nullptr;
    // The image options.
    // 
    // When you specify this parameter, take note of the following items:
    // 
    // *   This parameter takes effect only when the AutoProvisioningGroupType parameter is set to instant.
    std::shared_ptr<Models::CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationImageOptions> imageOptions_ = nullptr;
