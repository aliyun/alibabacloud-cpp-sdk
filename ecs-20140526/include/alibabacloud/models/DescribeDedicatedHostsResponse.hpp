...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDedicatedHostsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDedicatedHostsResponseBody) };
    inline DescribeDedicatedHostsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDedicatedHostsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDedicatedHostsResponseBody> body_ {};
  };
