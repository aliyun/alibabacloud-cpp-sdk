...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceMaintenanceAttributesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceMaintenanceAttributesResponseBody) };
    inline DescribeInstanceMaintenanceAttributesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceMaintenanceAttributesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceMaintenanceAttributesResponseBody> body_ {};
  };
