...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePortRangeListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePortRangeListResponseBody) };
    inline DeletePortRangeListResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePortRangeListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePortRangeListResponseBody> body_ {};
  };
