...
namespace Models
{
  ...
  public:
    ...
    inline const JoinResourceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, JoinResourceGroupResponseBody) };
    inline JoinResourceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, JoinResourceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<JoinResourceGroupResponseBody> body_ {};
  };
