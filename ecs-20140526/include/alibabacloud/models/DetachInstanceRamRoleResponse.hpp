...
namespace Models
{
  ...
  public:
    ...
    inline const DetachInstanceRamRoleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachInstanceRamRoleResponseBody) };
    inline DetachInstanceRamRoleResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachInstanceRamRoleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachInstanceRamRoleResponseBody> body_ {};
  };
