...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyVpcAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyVpcAttributeResponseBody) };
    inline ModifyVpcAttributeResponseBody body() { DARABONBA_PTR_GET(body_, ModifyVpcAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyVpcAttributeResponseBody> body_ = nullptr;
  };
