  ...
  public:
    ...
    public:
      ...
      public:
        ...
        virtual bool empty() const override { return this->currency_ == nullptr
        && this->detailInfos_ == nullptr && this->discountPrice_ == nullptr && this->originalPrice_ == nullptr && this->reservedInstanceHourPrice_ == nullptr && this->tradePrice_ == nullptr; };
        // currency Field Functions 
        bool hasCurrency() const { return this->currency_ != nullptr;};
        void deleteCurrency() { this->currency_ = nullptr;};
        inline string getCurrency() const { DARABONBA_PTR_GET_DEFAULT(currency_, "") };
        ...
        inline float getReservedInstanceHourPrice() const { DARABONBA_PTR_GET_DEFAULT(reservedInstanceHourPrice_, 0.0) };
        inline Price& setReservedInstanceHourPrice(float reservedInstanceHourPrice) { DARABONBA_PTR_SET_VALUE(reservedInstanceHourPrice_, reservedInstanceHourPrice) };
