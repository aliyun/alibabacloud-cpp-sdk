...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activationId_ == nullptr
        && return this->instanceName_ == nullptr && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
