...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allocationType_ == nullptr
        && return this->capacity_ == nullptr && return this->name_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->pageNumber_ == nullptr
        ...
        && return this->storageCapacityUnitId_ == nullptr && return this->tag_ == nullptr; };
