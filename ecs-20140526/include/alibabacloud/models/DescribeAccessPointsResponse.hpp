...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccessPointsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccessPointsResponseBody) };
    inline DescribeAccessPointsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAccessPointsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAccessPointsResponseBody> body_ {};
  };
