...
namespace Models
{
  ...
  public:
    ...
    inline const CreateImagePipelineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateImagePipelineResponseBody) };
    inline CreateImagePipelineResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateImagePipelineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateImagePipelineResponseBody> body_ {};
  };
