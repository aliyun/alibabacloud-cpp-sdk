...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteImagePipelineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteImagePipelineResponseBody) };
    inline DeleteImagePipelineResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteImagePipelineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteImagePipelineResponseBody> body_ {};
  };
