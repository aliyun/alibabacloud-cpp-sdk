...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCommandsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCommandsResponseBody) };
    inline DescribeCommandsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCommandsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCommandsResponseBody> body_ {};
  };
