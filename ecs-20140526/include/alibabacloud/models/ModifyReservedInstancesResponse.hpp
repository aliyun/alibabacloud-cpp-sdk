...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyReservedInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyReservedInstancesResponseBody) };
    inline ModifyReservedInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyReservedInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyReservedInstancesResponseBody> body_ {};
  };
