...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDiagnosticMetricSetsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDiagnosticMetricSetsResponseBody) };
    inline DescribeDiagnosticMetricSetsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDiagnosticMetricSetsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDiagnosticMetricSetsResponseBody> body_ = nullptr;
  };
