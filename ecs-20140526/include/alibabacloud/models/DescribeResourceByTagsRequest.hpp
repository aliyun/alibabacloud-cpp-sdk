...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeResourceByTagsRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeResourceByTagsRequest::Tag>) };
    inline vector<DescribeResourceByTagsRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeResourceByTagsRequest::Tag>) };
    inline DescribeResourceByTagsRequest& setTag(const vector<DescribeResourceByTagsRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeResourceByTagsRequest& setTag(vector<DescribeResourceByTagsRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
