...
#ifndef ALIBABACLOUD_MODELS_SENDFILEREQUESTTAG_HPP_
#define ALIBABACLOUD_MODELS_SENDFILEREQUESTTAG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SendFileRequestTag& obj) { 
      DARABONBA_PTR_TO_JSON(Key, key_);
      DARABONBA_PTR_TO_JSON(Value, value_);
    };
    friend void from_json(const Darabonba::Json& j, SendFileRequestTag& obj) { 
      DARABONBA_PTR_FROM_JSON(Key, key_);
      DARABONBA_PTR_FROM_JSON(Value, value_);
    };
    SendFileRequestTag() = default ;
    SendFileRequestTag(const SendFileRequestTag &) = default ;
    SendFileRequestTag(SendFileRequestTag &&) = default ;
    SendFileRequestTag(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SendFileRequestTag() = default ;
    SendFileRequestTag& operator=(const SendFileRequestTag &) = default ;
    SendFileRequestTag& operator=(SendFileRequestTag &&) = default ;
    ...
    inline SendFileRequestTag& setKey(string key) { DARABONBA_PTR_SET_VALUE(key_, key) };
    ...
    inline SendFileRequestTag& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
