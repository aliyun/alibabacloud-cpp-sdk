...
namespace Models
{
  ...
  public:
    ...
    inline const UnassociateEipAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnassociateEipAddressResponseBody) };
    inline UnassociateEipAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, UnassociateEipAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnassociateEipAddressResponseBody> body_ {};
  };
