...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccountAttributesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccountAttributesResponseBody) };
    inline DescribeAccountAttributesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAccountAttributesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAccountAttributesResponseBody> body_ {};
  };
