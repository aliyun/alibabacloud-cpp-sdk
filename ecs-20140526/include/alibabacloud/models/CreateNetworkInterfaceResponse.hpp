...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNetworkInterfaceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateNetworkInterfaceResponseBody) };
    inline CreateNetworkInterfaceResponseBody body() { DARABONBA_PTR_GET(body_, CreateNetworkInterfaceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateNetworkInterfaceResponseBody> body_ = nullptr;
  };
