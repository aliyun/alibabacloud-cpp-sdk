...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEPRICEREQUESTRECURRENCERULES_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEPRICEREQUESTRECURRENCERULES_HPP_
...
namespace Models
{
  class DescribePriceRequestRecurrenceRules : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribePriceRequestRecurrenceRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribePriceRequestRecurrenceRules& obj) { 
    ...
    DescribePriceRequestRecurrenceRules() = default ;
    DescribePriceRequestRecurrenceRules(const DescribePriceRequestRecurrenceRules &) = default ;
    DescribePriceRequestRecurrenceRules(DescribePriceRequestRecurrenceRules &&) = default ;
    DescribePriceRequestRecurrenceRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribePriceRequestRecurrenceRules() = default ;
    DescribePriceRequestRecurrenceRules& operator=(const DescribePriceRequestRecurrenceRules &) = default ;
    DescribePriceRequestRecurrenceRules& operator=(DescribePriceRequestRecurrenceRules &&) = default ;
    ...
    inline DescribePriceRequestRecurrenceRules& setEndHour(int32_t endHour) { DARABONBA_PTR_SET_VALUE(endHour_, endHour) };
    ...
    inline DescribePriceRequestRecurrenceRules& setRecurrenceType(string recurrenceType) { DARABONBA_PTR_SET_VALUE(recurrenceType_, recurrenceType) };
    ...
    inline DescribePriceRequestRecurrenceRules& setRecurrenceValue(string recurrenceValue) { DARABONBA_PTR_SET_VALUE(recurrenceValue_, recurrenceValue) };
    ...
    inline DescribePriceRequestRecurrenceRules& setStartHour(int32_t startHour) { DARABONBA_PTR_SET_VALUE(startHour_, startHour) };
