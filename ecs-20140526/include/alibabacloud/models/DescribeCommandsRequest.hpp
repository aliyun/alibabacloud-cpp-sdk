...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->commandId_ == nullptr
        && return this->contentEncoding_ == nullptr && return this->description_ == nullptr && return this->latest_ == nullptr && return this->maxResults_ == nullptr && return this->name_ == nullptr
        ...
        && return this->provider_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr
        && return this->tag_ == nullptr && return this->type_ == nullptr; };
