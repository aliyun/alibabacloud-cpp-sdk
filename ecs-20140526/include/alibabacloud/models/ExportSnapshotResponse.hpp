...
namespace Models
{
  ...
  public:
    ...
    inline const ExportSnapshotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ExportSnapshotResponseBody) };
    inline ExportSnapshotResponseBody getBody() { DARABONBA_PTR_GET(body_, ExportSnapshotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ExportSnapshotResponseBody> body_ {};
  };
