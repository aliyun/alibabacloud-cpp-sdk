...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceAttachmentAttributesRequestPrivatePoolOptions & privatePoolOptions() const { DARABONBA_PTR_GET_CONST(privatePoolOptions_, ModifyInstanceAttachmentAttributesRequestPrivatePoolOptions) };
    inline ModifyInstanceAttachmentAttributesRequestPrivatePoolOptions privatePoolOptions() { DARABONBA_PTR_GET(privatePoolOptions_, ModifyInstanceAttachmentAttributesRequestPrivatePoolOptions) };
    inline ModifyInstanceAttachmentAttributesRequest& setPrivatePoolOptions(const ModifyInstanceAttachmentAttributesRequestPrivatePoolOptions & privatePoolOptions) { DARABONBA_PTR_SET_VALUE(privatePoolOptions_, privatePoolOptions) };
    inline ModifyInstanceAttachmentAttributesRequest& setPrivatePoolOptions(ModifyInstanceAttachmentAttributesRequestPrivatePoolOptions && privatePoolOptions) { DARABONBA_PTR_SET_RVALUE(privatePoolOptions_, privatePoolOptions) };
  ...
  protected:
    std::shared_ptr<ModifyInstanceAttachmentAttributesRequestPrivatePoolOptions> privatePoolOptions_ = nullptr;
