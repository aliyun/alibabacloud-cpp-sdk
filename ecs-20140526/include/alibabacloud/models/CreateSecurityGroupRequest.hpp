...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateSecurityGroupRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateSecurityGroupRequest::Tag>) };
    inline vector<CreateSecurityGroupRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateSecurityGroupRequest::Tag>) };
    inline CreateSecurityGroupRequest& setTag(const vector<CreateSecurityGroupRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateSecurityGroupRequest& setTag(vector<CreateSecurityGroupRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
