...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRouterInterfaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRouterInterfaceResponseBody) };
    inline CreateRouterInterfaceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRouterInterfaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRouterInterfaceResponseBody> body_ {};
  };
