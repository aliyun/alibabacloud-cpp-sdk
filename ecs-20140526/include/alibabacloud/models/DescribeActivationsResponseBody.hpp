...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->activationList_ != nullptr
    ...
    inline const vector<DescribeActivationsResponseBodyActivationList> & activationList() const { DARABONBA_PTR_GET_CONST(activationList_, vector<DescribeActivationsResponseBodyActivationList>) };
    inline vector<DescribeActivationsResponseBodyActivationList> activationList() { DARABONBA_PTR_GET(activationList_, vector<DescribeActivationsResponseBodyActivationList>) };
    inline DescribeActivationsResponseBody& setActivationList(const vector<DescribeActivationsResponseBodyActivationList> & activationList) { DARABONBA_PTR_SET_VALUE(activationList_, activationList) };
    inline DescribeActivationsResponseBody& setActivationList(vector<DescribeActivationsResponseBodyActivationList> && activationList) { DARABONBA_PTR_SET_RVALUE(activationList_, activationList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeActivationsResponseBodyActivationList>> activationList_ = nullptr;
