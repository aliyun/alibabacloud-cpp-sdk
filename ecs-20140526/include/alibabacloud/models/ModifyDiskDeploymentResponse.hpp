...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDiskDeploymentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDiskDeploymentResponseBody) };
    inline ModifyDiskDeploymentResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDiskDeploymentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDiskDeploymentResponseBody> body_ {};
  };
