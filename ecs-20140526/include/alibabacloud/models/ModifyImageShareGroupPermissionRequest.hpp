...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addGroup_ == nullptr
        && return this->removeGroup_ == nullptr && return this->imageId_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr
    ...
    inline const vector<string> & addGroup() const { DARABONBA_PTR_GET_CONST(addGroup_, vector<string>) };
    inline vector<string> addGroup() { DARABONBA_PTR_GET(addGroup_, vector<string>) };
    ...
    inline const vector<string> & removeGroup() const { DARABONBA_PTR_GET_CONST(removeGroup_, vector<string>) };
    inline vector<string> removeGroup() { DARABONBA_PTR_GET(removeGroup_, vector<string>) };
  ...
  protected:
    std::shared_ptr<vector<string>> addGroup_ = nullptr;
    std::shared_ptr<vector<string>> removeGroup_ = nullptr;
