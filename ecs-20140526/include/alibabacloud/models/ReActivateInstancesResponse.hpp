...
namespace Models
{
  ...
  public:
    ...
    inline const ReActivateInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReActivateInstancesResponseBody) };
    inline ReActivateInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, ReActivateInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReActivateInstancesResponseBody> body_ {};
  };
