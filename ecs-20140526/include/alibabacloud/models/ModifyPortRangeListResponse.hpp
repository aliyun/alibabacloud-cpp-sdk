...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyPortRangeListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyPortRangeListResponseBody) };
    inline ModifyPortRangeListResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyPortRangeListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyPortRangeListResponseBody> body_ {};
  };
