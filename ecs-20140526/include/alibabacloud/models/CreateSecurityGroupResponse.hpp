...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSecurityGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSecurityGroupResponseBody) };
    inline CreateSecurityGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSecurityGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSecurityGroupResponseBody> body_ {};
  };
