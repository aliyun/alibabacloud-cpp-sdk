...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activityId_ == nullptr
        && return this->bandwidth_ == nullptr && return this->clientToken_ == nullptr && return this->ISP_ == nullptr && return this->internetChargeType_ == nullptr && return this->ownerAccount_ == nullptr
