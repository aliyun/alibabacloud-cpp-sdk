...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDiskSpecResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDiskSpecResponseBody) };
    inline ModifyDiskSpecResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDiskSpecResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDiskSpecResponseBody> body_ {};
  };
