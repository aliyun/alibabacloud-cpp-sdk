...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceNetworkOptionsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceNetworkOptionsResponseBody) };
    inline ModifyInstanceNetworkOptionsResponseBody body() { DARABONBA_PTR_GET(body_, ModifyInstanceNetworkOptionsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyInstanceNetworkOptionsResponseBody> body_ = nullptr;
  };
