...
namespace Models
{
  ...
  public:
    ...
    inline const ConvertNatPublicIpToEipResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ConvertNatPublicIpToEipResponseBody) };
    inline ConvertNatPublicIpToEipResponseBody body() { DARABONBA_PTR_GET(body_, ConvertNatPublicIpToEipResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ConvertNatPublicIpToEipResponseBody> body_ = nullptr;
  };
