...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBandwidthLimitationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBandwidthLimitationResponseBody) };
    inline DescribeBandwidthLimitationResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBandwidthLimitationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBandwidthLimitationResponseBody> body_ {};
  };
