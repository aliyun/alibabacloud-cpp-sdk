...
namespace Models
{
  ...
  public:
    ...
    inline string getSupportedInstanceTypeFamily() const { DARABONBA_PTR_GET_DEFAULT(supportedInstanceTypeFamily_, "") };
  ...
  protected:
    ...
    shared_ptr<string> supportedInstanceTypeFamily_ {};
  };
