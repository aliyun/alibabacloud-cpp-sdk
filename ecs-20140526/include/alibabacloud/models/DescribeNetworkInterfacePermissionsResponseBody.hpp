...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->networkInterfacePermissions_ != nullptr
    ...
    inline const DescribeNetworkInterfacePermissionsResponseBodyNetworkInterfacePermissions & networkInterfacePermissions() const { DARABONBA_PTR_GET_CONST(networkInterfacePermissions_, DescribeNetworkInterfacePermissionsResponseBodyNetworkInterfacePermissions) };
    inline DescribeNetworkInterfacePermissionsResponseBodyNetworkInterfacePermissions networkInterfacePermissions() { DARABONBA_PTR_GET(networkInterfacePermissions_, DescribeNetworkInterfacePermissionsResponseBodyNetworkInterfacePermissions) };
    inline DescribeNetworkInterfacePermissionsResponseBody& setNetworkInterfacePermissions(const DescribeNetworkInterfacePermissionsResponseBodyNetworkInterfacePermissions & networkInterfacePermissions) { DARABONBA_PTR_SET_VALUE(networkInterfacePermissions_, networkInterfacePermissions) };
    inline DescribeNetworkInterfacePermissionsResponseBody& setNetworkInterfacePermissions(DescribeNetworkInterfacePermissionsResponseBodyNetworkInterfacePermissions && networkInterfacePermissions) { DARABONBA_PTR_SET_RVALUE(networkInterfacePermissions_, networkInterfacePermissions) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeNetworkInterfacePermissionsResponseBodyNetworkInterfacePermissions> networkInterfacePermissions_ = nullptr;
    // The page number.
