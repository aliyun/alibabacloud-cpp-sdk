...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLaunchTemplateVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLaunchTemplateVersionResponseBody) };
    inline DeleteLaunchTemplateVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLaunchTemplateVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLaunchTemplateVersionResponseBody> body_ {};
  };
