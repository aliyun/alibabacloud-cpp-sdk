...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySnapshotCategoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySnapshotCategoryResponseBody) };
    inline ModifySnapshotCategoryResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySnapshotCategoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySnapshotCategoryResponseBody> body_ {};
  };
