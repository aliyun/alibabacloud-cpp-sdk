...
namespace Models
{
  ...
  public:
    ...
    inline const RenewReservedInstancesResponseBody::ReservedInstanceIdSets & getReservedInstanceIdSets() const { DARABONBA_PTR_GET_CONST(reservedInstanceIdSets_, RenewReservedInstancesResponseBody::ReservedInstanceIdSets) };
    inline RenewReservedInstancesResponseBody::ReservedInstanceIdSets getReservedInstanceIdSets() { DARABONBA_PTR_GET(reservedInstanceIdSets_, RenewReservedInstancesResponseBody::ReservedInstanceIdSets) };
    inline RenewReservedInstancesResponseBody& setReservedInstanceIdSets(const RenewReservedInstancesResponseBody::ReservedInstanceIdSets & reservedInstanceIdSets) { DARABONBA_PTR_SET_VALUE(reservedInstanceIdSets_, reservedInstanceIdSets) };
    inline RenewReservedInstancesResponseBody& setReservedInstanceIdSets(RenewReservedInstancesResponseBody::ReservedInstanceIdSets && reservedInstanceIdSets) { DARABONBA_PTR_SET_RVALUE(reservedInstanceIdSets_, reservedInstanceIdSets) };
  ...
  protected:
    ...
    shared_ptr<RenewReservedInstancesResponseBody::ReservedInstanceIdSets> reservedInstanceIdSets_ {};
  };
