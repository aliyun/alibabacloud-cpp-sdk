...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        ...
        && return this->sourceCidrIp_ == nullptr && return this->sourcePortRange_ == nullptr; };
    ...
    inline const vector<AuthorizeSecurityGroupEgressRequestPermissions> & permissions() const { DARABONBA_PTR_GET_CONST(permissions_, vector<AuthorizeSecurityGroupEgressRequestPermissions>) };
    inline vector<AuthorizeSecurityGroupEgressRequestPermissions> permissions() { DARABONBA_PTR_GET(permissions_, vector<AuthorizeSecurityGroupEgressRequestPermissions>) };
    inline AuthorizeSecurityGroupEgressRequest& setPermissions(const vector<AuthorizeSecurityGroupEgressRequestPermissions> & permissions) { DARABONBA_PTR_SET_VALUE(permissions_, permissions) };
    inline AuthorizeSecurityGroupEgressRequest& setPermissions(vector<AuthorizeSecurityGroupEgressRequestPermissions> && permissions) { DARABONBA_PTR_SET_RVALUE(permissions_, permissions) };
  ...
  protected:
    ...
    std::shared_ptr<vector<AuthorizeSecurityGroupEgressRequestPermissions>> permissions_ = nullptr;
