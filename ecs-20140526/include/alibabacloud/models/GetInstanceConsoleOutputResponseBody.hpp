...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->consoleOutput_ == nullptr
        && return this->instanceId_ == nullptr && return this->lastUpdateTime_ == nullptr && return this->requestId_ == nullptr; };
