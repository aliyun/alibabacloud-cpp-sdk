...
#ifndef ALIBABACLOUD_MODELS_CREATENETWORKINTERFACEREQUESTENHANCEDNETWORK_HPP_
#define ALIBABACLOUD_MODELS_CREATENETWORKINTERFACEREQUESTENHANCEDNETWORK_HPP_
...
namespace Models
{
  class CreateNetworkInterfaceRequestEnhancedNetwork : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateNetworkInterfaceRequestEnhancedNetwork& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateNetworkInterfaceRequestEnhancedNetwork& obj) { 
    ...
    CreateNetworkInterfaceRequestEnhancedNetwork() = default ;
    CreateNetworkInterfaceRequestEnhancedNetwork(const CreateNetworkInterfaceRequestEnhancedNetwork &) = default ;
    CreateNetworkInterfaceRequestEnhancedNetwork(CreateNetworkInterfaceRequestEnhancedNetwork &&) = default ;
    CreateNetworkInterfaceRequestEnhancedNetwork(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateNetworkInterfaceRequestEnhancedNetwork() = default ;
    CreateNetworkInterfaceRequestEnhancedNetwork& operator=(const CreateNetworkInterfaceRequestEnhancedNetwork &) = default ;
    CreateNetworkInterfaceRequestEnhancedNetwork& operator=(CreateNetworkInterfaceRequestEnhancedNetwork &&) = default ;
    ...
    inline CreateNetworkInterfaceRequestEnhancedNetwork& setEnableRss(bool enableRss) { DARABONBA_PTR_SET_VALUE(enableRss_, enableRss) };
    ...
    inline CreateNetworkInterfaceRequestEnhancedNetwork& setEnableSriov(bool enableSriov) { DARABONBA_PTR_SET_VALUE(enableSriov_, enableSriov) };
    ...
    inline CreateNetworkInterfaceRequestEnhancedNetwork& setVirtualFunctionQuantity(int32_t virtualFunctionQuantity) { DARABONBA_PTR_SET_VALUE(virtualFunctionQuantity_, virtualFunctionQuantity) };
    ...
    inline CreateNetworkInterfaceRequestEnhancedNetwork& setVirtualFunctionTotalQueueNumber(int32_t virtualFunctionTotalQueueNumber) { DARABONBA_PTR_SET_VALUE(virtualFunctionTotalQueueNumber_, virtualFunctionTotalQueueNumber) };
