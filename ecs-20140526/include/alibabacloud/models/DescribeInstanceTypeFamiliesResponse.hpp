...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceTypeFamiliesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceTypeFamiliesResponseBody) };
    inline DescribeInstanceTypeFamiliesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceTypeFamiliesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceTypeFamiliesResponseBody> body_ {};
  };
