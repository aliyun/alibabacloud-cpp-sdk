...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLaunchTemplateDefaultVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLaunchTemplateDefaultVersionResponseBody) };
    inline ModifyLaunchTemplateDefaultVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLaunchTemplateDefaultVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLaunchTemplateDefaultVersionResponseBody> body_ {};
  };
