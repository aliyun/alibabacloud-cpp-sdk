...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getAttributeName() const { DARABONBA_PTR_GET_CONST(attributeName_, vector<string>) };
    inline vector<string> getAttributeName() { DARABONBA_PTR_GET(attributeName_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> attributeName_ {};
