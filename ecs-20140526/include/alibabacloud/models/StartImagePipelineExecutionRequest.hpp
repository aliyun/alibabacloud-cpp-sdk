...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && return this->imagePipelineId_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
        && return this->resourceOwnerId_ == nullptr && return this->tag_ == nullptr && return this->templateTag_ == nullptr; };
    ...
    inline const vector<StartImagePipelineExecutionRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<StartImagePipelineExecutionRequestTag>) };
    inline vector<StartImagePipelineExecutionRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<StartImagePipelineExecutionRequestTag>) };
    inline StartImagePipelineExecutionRequest& setTag(const vector<StartImagePipelineExecutionRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline StartImagePipelineExecutionRequest& setTag(vector<StartImagePipelineExecutionRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline const vector<StartImagePipelineExecutionRequestTemplateTag> & templateTag() const { DARABONBA_PTR_GET_CONST(templateTag_, vector<StartImagePipelineExecutionRequestTemplateTag>) };
    inline vector<StartImagePipelineExecutionRequestTemplateTag> templateTag() { DARABONBA_PTR_GET(templateTag_, vector<StartImagePipelineExecutionRequestTemplateTag>) };
    inline StartImagePipelineExecutionRequest& setTemplateTag(const vector<StartImagePipelineExecutionRequestTemplateTag> & templateTag) { DARABONBA_PTR_SET_VALUE(templateTag_, templateTag) };
    inline StartImagePipelineExecutionRequest& setTemplateTag(vector<StartImagePipelineExecutionRequestTemplateTag> && templateTag) { DARABONBA_PTR_SET_RVALUE(templateTag_, templateTag) };
  ...
  protected:
    ...
    // The tags.
    std::shared_ptr<vector<StartImagePipelineExecutionRequestTag>> tag_ = nullptr;
    // >  This parameter is deprecated.
    std::shared_ptr<vector<StartImagePipelineExecutionRequestTemplateTag>> templateTag_ = nullptr;
  };
