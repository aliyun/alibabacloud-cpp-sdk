...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->networkInterfaceId_ == nullptr
        && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->qoS_ == nullptr && return this->regionId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
    ...
    inline const EnableNetworkInterfaceQoSRequestQoS & qoS() const { DARABONBA_PTR_GET_CONST(qoS_, EnableNetworkInterfaceQoSRequestQoS) };
    inline EnableNetworkInterfaceQoSRequestQoS qoS() { DARABONBA_PTR_GET(qoS_, EnableNetworkInterfaceQoSRequestQoS) };
    inline EnableNetworkInterfaceQoSRequest& setQoS(const EnableNetworkInterfaceQoSRequestQoS & qoS) { DARABONBA_PTR_SET_VALUE(qoS_, qoS) };
    inline EnableNetworkInterfaceQoSRequest& setQoS(EnableNetworkInterfaceQoSRequestQoS && qoS) { DARABONBA_PTR_SET_RVALUE(qoS_, qoS) };
  ...
  protected:
    ...
    std::shared_ptr<EnableNetworkInterfaceQoSRequestQoS> qoS_ = nullptr;
    // This parameter is required.
