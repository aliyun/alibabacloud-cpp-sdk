...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveBandwidthPackageIpsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveBandwidthPackageIpsResponseBody) };
    inline RemoveBandwidthPackageIpsResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveBandwidthPackageIpsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveBandwidthPackageIpsResponseBody> body_ {};
  };
