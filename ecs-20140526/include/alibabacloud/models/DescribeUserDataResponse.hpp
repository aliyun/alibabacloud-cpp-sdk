...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserDataResponseBody) };
    inline DescribeUserDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUserDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserDataResponseBody> body_ {};
  };
