...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAutoProvisioningGroupRequest::LaunchConfiguration & getLaunchConfiguration() const { DARABONBA_PTR_GET_CONST(launchConfiguration_, CreateAutoProvisioningGroupRequest::LaunchConfiguration) };
    inline CreateAutoProvisioningGroupRequest::LaunchConfiguration getLaunchConfiguration() { DARABONBA_PTR_GET(launchConfiguration_, CreateAutoProvisioningGroupRequest::LaunchConfiguration) };
    inline CreateAutoProvisioningGroupRequest& setLaunchConfiguration(const CreateAutoProvisioningGroupRequest::LaunchConfiguration & launchConfiguration) { DARABONBA_PTR_SET_VALUE(launchConfiguration_, launchConfiguration) };
    inline CreateAutoProvisioningGroupRequest& setLaunchConfiguration(CreateAutoProvisioningGroupRequest::LaunchConfiguration && launchConfiguration) { DARABONBA_PTR_SET_RVALUE(launchConfiguration_, launchConfiguration) };
    ...
    inline const vector<CreateAutoProvisioningGroupRequest::DataDiskConfig> & getDataDiskConfig() const { DARABONBA_PTR_GET_CONST(dataDiskConfig_, vector<CreateAutoProvisioningGroupRequest::DataDiskConfig>) };
    inline vector<CreateAutoProvisioningGroupRequest::DataDiskConfig> getDataDiskConfig() { DARABONBA_PTR_GET(dataDiskConfig_, vector<CreateAutoProvisioningGroupRequest::DataDiskConfig>) };
    inline CreateAutoProvisioningGroupRequest& setDataDiskConfig(const vector<CreateAutoProvisioningGroupRequest::DataDiskConfig> & dataDiskConfig) { DARABONBA_PTR_SET_VALUE(dataDiskConfig_, dataDiskConfig) };
    inline CreateAutoProvisioningGroupRequest& setDataDiskConfig(vector<CreateAutoProvisioningGroupRequest::DataDiskConfig> && dataDiskConfig) { DARABONBA_PTR_SET_RVALUE(dataDiskConfig_, dataDiskConfig) };
    ...
    inline const vector<CreateAutoProvisioningGroupRequest::LaunchTemplateConfig> & getLaunchTemplateConfig() const { DARABONBA_PTR_GET_CONST(launchTemplateConfig_, vector<CreateAutoProvisioningGroupRequest::LaunchTemplateConfig>) };
    inline vector<CreateAutoProvisioningGroupRequest::LaunchTemplateConfig> getLaunchTemplateConfig() { DARABONBA_PTR_GET(launchTemplateConfig_, vector<CreateAutoProvisioningGroupRequest::LaunchTemplateConfig>) };
    inline CreateAutoProvisioningGroupRequest& setLaunchTemplateConfig(const vector<CreateAutoProvisioningGroupRequest::LaunchTemplateConfig> & launchTemplateConfig) { DARABONBA_PTR_SET_VALUE(launchTemplateConfig_, launchTemplateConfig) };
    inline CreateAutoProvisioningGroupRequest& setLaunchTemplateConfig(vector<CreateAutoProvisioningGroupRequest::LaunchTemplateConfig> && launchTemplateConfig) { DARABONBA_PTR_SET_RVALUE(launchTemplateConfig_, launchTemplateConfig) };
    ...
    inline const CreateAutoProvisioningGroupRequest::PrePaidOptions & getPrePaidOptions() const { DARABONBA_PTR_GET_CONST(prePaidOptions_, CreateAutoProvisioningGroupRequest::PrePaidOptions) };
    inline CreateAutoProvisioningGroupRequest::PrePaidOptions getPrePaidOptions() { DARABONBA_PTR_GET(prePaidOptions_, CreateAutoProvisioningGroupRequest::PrePaidOptions) };
    inline CreateAutoProvisioningGroupRequest& setPrePaidOptions(const CreateAutoProvisioningGroupRequest::PrePaidOptions & prePaidOptions) { DARABONBA_PTR_SET_VALUE(prePaidOptions_, prePaidOptions) };
    inline CreateAutoProvisioningGroupRequest& setPrePaidOptions(CreateAutoProvisioningGroupRequest::PrePaidOptions && prePaidOptions) { DARABONBA_PTR_SET_RVALUE(prePaidOptions_, prePaidOptions) };
    ...
    inline const CreateAutoProvisioningGroupRequest::ResourcePoolOptions & getResourcePoolOptions() const { DARABONBA_PTR_GET_CONST(resourcePoolOptions_, CreateAutoProvisioningGroupRequest::ResourcePoolOptions) };
    inline CreateAutoProvisioningGroupRequest::ResourcePoolOptions getResourcePoolOptions() { DARABONBA_PTR_GET(resourcePoolOptions_, CreateAutoProvisioningGroupRequest::ResourcePoolOptions) };
    inline CreateAutoProvisioningGroupRequest& setResourcePoolOptions(const CreateAutoProvisioningGroupRequest::ResourcePoolOptions & resourcePoolOptions) { DARABONBA_PTR_SET_VALUE(resourcePoolOptions_, resourcePoolOptions) };
    inline CreateAutoProvisioningGroupRequest& setResourcePoolOptions(CreateAutoProvisioningGroupRequest::ResourcePoolOptions && resourcePoolOptions) { DARABONBA_PTR_SET_RVALUE(resourcePoolOptions_, resourcePoolOptions) };
    ...
    inline const vector<CreateAutoProvisioningGroupRequest::SystemDiskConfig> & getSystemDiskConfig() const { DARABONBA_PTR_GET_CONST(systemDiskConfig_, vector<CreateAutoProvisioningGroupRequest::SystemDiskConfig>) };
    inline vector<CreateAutoProvisioningGroupRequest::SystemDiskConfig> getSystemDiskConfig() { DARABONBA_PTR_GET(systemDiskConfig_, vector<CreateAutoProvisioningGroupRequest::SystemDiskConfig>) };
    inline CreateAutoProvisioningGroupRequest& setSystemDiskConfig(const vector<CreateAutoProvisioningGroupRequest::SystemDiskConfig> & systemDiskConfig) { DARABONBA_PTR_SET_VALUE(systemDiskConfig_, systemDiskConfig) };
    inline CreateAutoProvisioningGroupRequest& setSystemDiskConfig(vector<CreateAutoProvisioningGroupRequest::SystemDiskConfig> && systemDiskConfig) { DARABONBA_PTR_SET_RVALUE(systemDiskConfig_, systemDiskConfig) };


    // tag Field Functions 
    bool hasTag() const { return this->tag_ != nullptr;};
    void deleteTag() { this->tag_ = nullptr;};
    inline const vector<CreateAutoProvisioningGroupRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateAutoProvisioningGroupRequest::Tag>) };
    inline vector<CreateAutoProvisioningGroupRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateAutoProvisioningGroupRequest::Tag>) };
    inline CreateAutoProvisioningGroupRequest& setTag(const vector<CreateAutoProvisioningGroupRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateAutoProvisioningGroupRequest& setTag(vector<CreateAutoProvisioningGroupRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    shared_ptr<CreateAutoProvisioningGroupRequest::LaunchConfiguration> launchConfiguration_ {};
    ...
    shared_ptr<vector<CreateAutoProvisioningGroupRequest::DataDiskConfig>> dataDiskConfig_ {};
    ...
    shared_ptr<vector<CreateAutoProvisioningGroupRequest::LaunchTemplateConfig>> launchTemplateConfig_ {};
    ...
    shared_ptr<CreateAutoProvisioningGroupRequest::PrePaidOptions> prePaidOptions_ {};
    ...
    shared_ptr<CreateAutoProvisioningGroupRequest::ResourcePoolOptions> resourcePoolOptions_ {};
    ...
    shared_ptr<vector<CreateAutoProvisioningGroupRequest::SystemDiskConfig>> systemDiskConfig_ {};
    // The tags to add to the auto provisioning group.
    shared_ptr<vector<CreateAutoProvisioningGroupRequest::Tag>> tag_ {};
