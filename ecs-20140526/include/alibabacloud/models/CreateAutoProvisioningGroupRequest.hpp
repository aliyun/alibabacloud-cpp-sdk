...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->launchConfiguration_ != nullptr
        ...
        && this->resourceOwnerAccount_ != nullptr && this->resourceOwnerId_ != nullptr && this->resourcePoolOptions_ != nullptr && this->spotAllocationStrategy_ != nullptr && this->spotInstanceInterruptionBehavior_ != nullptr
