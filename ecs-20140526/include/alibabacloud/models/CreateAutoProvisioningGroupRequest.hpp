...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->launchConfiguration_ == nullptr
        ...
        && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->resourcePoolOptions_ == nullptr && return this->spotAllocationStrategy_ == nullptr && return this->spotInstanceInterruptionBehavior_ == nullptr
