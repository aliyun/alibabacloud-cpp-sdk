...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cidrBlock_ == nullptr
        ...
        && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->vSwitchName_ == nullptr && return this->vpcId_ == nullptr && return this->zoneId_ == nullptr; };
