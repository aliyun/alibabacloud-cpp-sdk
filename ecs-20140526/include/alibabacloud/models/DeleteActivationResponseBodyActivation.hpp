...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activationId_ == nullptr
        && return this->creationTime_ == nullptr && return this->deregisteredCount_ == nullptr && return this->description_ == nullptr && return this->instanceCount_ == nullptr && return this->instanceName_ == nullptr
        && return this->ipAddressRange_ == nullptr && return this->registeredCount_ == nullptr && return this->timeToLiveInHours_ == nullptr; };
