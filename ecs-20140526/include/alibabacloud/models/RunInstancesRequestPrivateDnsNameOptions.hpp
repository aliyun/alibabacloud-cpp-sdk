...
#ifndef ALIBABACLOUD_MODELS_RUNINSTANCESREQUESTPRIVATEDNSNAMEOPTIONS_HPP_
#define ALIBABACLOUD_MODELS_RUNINSTANCESREQUESTPRIVATEDNSNAMEOPTIONS_HPP_
...
namespace Models
{
  class RunInstancesRequestPrivateDnsNameOptions : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const RunInstancesRequestPrivateDnsNameOptions& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RunInstancesRequestPrivateDnsNameOptions& obj) { 
    ...
    RunInstancesRequestPrivateDnsNameOptions() = default ;
    RunInstancesRequestPrivateDnsNameOptions(const RunInstancesRequestPrivateDnsNameOptions &) = default ;
    RunInstancesRequestPrivateDnsNameOptions(RunInstancesRequestPrivateDnsNameOptions &&) = default ;
    RunInstancesRequestPrivateDnsNameOptions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RunInstancesRequestPrivateDnsNameOptions() = default ;
    RunInstancesRequestPrivateDnsNameOptions& operator=(const RunInstancesRequestPrivateDnsNameOptions &) = default ;
    RunInstancesRequestPrivateDnsNameOptions& operator=(RunInstancesRequestPrivateDnsNameOptions &&) = default ;
    ...
    inline RunInstancesRequestPrivateDnsNameOptions& setEnableInstanceIdDnsAAAARecord(bool enableInstanceIdDnsAAAARecord) { DARABONBA_PTR_SET_VALUE(enableInstanceIdDnsAAAARecord_, enableInstanceIdDnsAAAARecord) };
    ...
    inline RunInstancesRequestPrivateDnsNameOptions& setEnableInstanceIdDnsARecord(bool enableInstanceIdDnsARecord) { DARABONBA_PTR_SET_VALUE(enableInstanceIdDnsARecord_, enableInstanceIdDnsARecord) };
    ...
    inline RunInstancesRequestPrivateDnsNameOptions& setEnableIpDnsARecord(bool enableIpDnsARecord) { DARABONBA_PTR_SET_VALUE(enableIpDnsARecord_, enableIpDnsARecord) };
    ...
    inline RunInstancesRequestPrivateDnsNameOptions& setEnableIpDnsPtrRecord(bool enableIpDnsPtrRecord) { DARABONBA_PTR_SET_VALUE(enableIpDnsPtrRecord_, enableIpDnsPtrRecord) };
    ...
    inline RunInstancesRequestPrivateDnsNameOptions& setHostnameType(string hostnameType) { DARABONBA_PTR_SET_VALUE(hostnameType_, hostnameType) };
