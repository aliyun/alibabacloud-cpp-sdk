...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getRemovedIpAddresses() const { DARABONBA_PTR_GET_CONST(removedIpAddresses_, vector<string>) };
    inline vector<string> getRemovedIpAddresses() { DARABONBA_PTR_GET(removedIpAddresses_, vector<string>) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<string>> removedIpAddresses_ {};
