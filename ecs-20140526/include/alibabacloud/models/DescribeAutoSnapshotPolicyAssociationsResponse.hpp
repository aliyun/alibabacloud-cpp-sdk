...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutoSnapshotPolicyAssociationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAutoSnapshotPolicyAssociationsResponseBody) };
    inline DescribeAutoSnapshotPolicyAssociationsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAutoSnapshotPolicyAssociationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAutoSnapshotPolicyAssociationsResponseBody> body_ {};
  };
