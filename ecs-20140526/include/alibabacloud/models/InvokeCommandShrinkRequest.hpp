...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        ...
        && return this->launcher_ == nullptr && return this->ossOutputDelivery_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->parametersShrink_ == nullptr
    ...
    inline const vector<InvokeCommandShrinkRequestResourceTag> & resourceTag() const { DARABONBA_PTR_GET_CONST(resourceTag_, vector<InvokeCommandShrinkRequestResourceTag>) };
    inline vector<InvokeCommandShrinkRequestResourceTag> resourceTag() { DARABONBA_PTR_GET(resourceTag_, vector<InvokeCommandShrinkRequestResourceTag>) };
    inline InvokeCommandShrinkRequest& setResourceTag(const vector<InvokeCommandShrinkRequestResourceTag> & resourceTag) { DARABONBA_PTR_SET_VALUE(resourceTag_, resourceTag) };
    inline InvokeCommandShrinkRequest& setResourceTag(vector<InvokeCommandShrinkRequestResourceTag> && resourceTag) { DARABONBA_PTR_SET_RVALUE(resourceTag_, resourceTag) };


    // tag Field Functions 
    bool hasTag() const { return this->tag_ != nullptr;};
    void deleteTag() { this->tag_ = nullptr;};
    inline const vector<InvokeCommandShrinkRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<InvokeCommandShrinkRequestTag>) };
    inline vector<InvokeCommandShrinkRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<InvokeCommandShrinkRequestTag>) };
    inline InvokeCommandShrinkRequest& setTag(const vector<InvokeCommandShrinkRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline InvokeCommandShrinkRequest& setTag(vector<InvokeCommandShrinkRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    std::shared_ptr<vector<InvokeCommandShrinkRequestResourceTag>> resourceTag_ = nullptr;
    // The tags of the command.
    std::shared_ptr<vector<InvokeCommandShrinkRequestTag>> tag_ = nullptr;
