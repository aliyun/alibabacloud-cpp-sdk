...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCommandsResponseBodyCommands & commands() const { DARABONBA_PTR_GET_CONST(commands_, DescribeCommandsResponseBodyCommands) };
    inline DescribeCommandsResponseBodyCommands commands() { DARABONBA_PTR_GET(commands_, DescribeCommandsResponseBodyCommands) };
    inline DescribeCommandsResponseBody& setCommands(const DescribeCommandsResponseBodyCommands & commands) { DARABONBA_PTR_SET_VALUE(commands_, commands) };
    inline DescribeCommandsResponseBody& setCommands(DescribeCommandsResponseBodyCommands && commands) { DARABONBA_PTR_SET_RVALUE(commands_, commands) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCommandsResponseBodyCommands> commands_ = nullptr;
