...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateKeyPairRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateKeyPairRequest::Tag>) };
    inline vector<CreateKeyPairRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateKeyPairRequest::Tag>) };
    inline CreateKeyPairRequest& setTag(const vector<CreateKeyPairRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateKeyPairRequest& setTag(vector<CreateKeyPairRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<CreateKeyPairRequest::Tag>> tag_ {};
  };
