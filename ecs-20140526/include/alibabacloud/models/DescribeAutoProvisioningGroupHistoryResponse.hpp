...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutoProvisioningGroupHistoryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAutoProvisioningGroupHistoryResponseBody) };
    inline DescribeAutoProvisioningGroupHistoryResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAutoProvisioningGroupHistoryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAutoProvisioningGroupHistoryResponseBody> body_ = nullptr;
  };
