...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRecommendInstanceTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRecommendInstanceTypeResponseBody) };
    inline DescribeRecommendInstanceTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRecommendInstanceTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRecommendInstanceTypeResponseBody> body_ {};
  };
