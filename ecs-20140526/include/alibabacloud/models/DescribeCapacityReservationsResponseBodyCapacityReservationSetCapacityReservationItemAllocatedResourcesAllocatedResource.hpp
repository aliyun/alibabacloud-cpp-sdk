...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->availableAmount_ == nullptr
        && return this->capacityReservationUsages_ == nullptr && return this->instanceType_ == nullptr && return this->totalAmount_ == nullptr && return this->usedAmount_ == nullptr && return this->zoneId_ == nullptr; };
