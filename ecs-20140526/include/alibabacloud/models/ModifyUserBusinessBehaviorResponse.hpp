...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyUserBusinessBehaviorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyUserBusinessBehaviorResponseBody) };
    inline ModifyUserBusinessBehaviorResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyUserBusinessBehaviorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyUserBusinessBehaviorResponseBody> body_ {};
  };
