...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAccessPointsRequest::Filter> & getFilter() const { DARABONBA_PTR_GET_CONST(filter_, vector<DescribeAccessPointsRequest::Filter>) };
    inline vector<DescribeAccessPointsRequest::Filter> getFilter() { DARABONBA_PTR_GET(filter_, vector<DescribeAccessPointsRequest::Filter>) };
    inline DescribeAccessPointsRequest& setFilter(const vector<DescribeAccessPointsRequest::Filter> & filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    inline DescribeAccessPointsRequest& setFilter(vector<DescribeAccessPointsRequest::Filter> && filter) { DARABONBA_PTR_SET_RVALUE(filter_, filter) };
