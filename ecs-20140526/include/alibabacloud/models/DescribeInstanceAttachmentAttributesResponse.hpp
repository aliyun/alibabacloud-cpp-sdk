...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceAttachmentAttributesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceAttachmentAttributesResponseBody) };
    inline DescribeInstanceAttachmentAttributesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceAttachmentAttributesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceAttachmentAttributesResponseBody> body_ {};
  };
