...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClassicLinkInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClassicLinkInstancesResponseBody) };
    inline DescribeClassicLinkInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClassicLinkInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClassicLinkInstancesResponseBody> body_ {};
  };
