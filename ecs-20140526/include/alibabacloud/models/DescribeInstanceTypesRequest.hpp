...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getLocalStorageCategories() const { DARABONBA_PTR_GET_CONST(localStorageCategories_, vector<string>) };
    inline vector<string> getLocalStorageCategories() { DARABONBA_PTR_GET(localStorageCategories_, vector<string>) };
    ...
    inline float getMaximumCpuSpeedFrequency() const { DARABONBA_PTR_GET_DEFAULT(maximumCpuSpeedFrequency_, 0.0) };
    ...
    inline float getMaximumCpuTurboFrequency() const { DARABONBA_PTR_GET_DEFAULT(maximumCpuTurboFrequency_, 0.0) };
    ...
    inline float getMinimumCpuSpeedFrequency() const { DARABONBA_PTR_GET_DEFAULT(minimumCpuSpeedFrequency_, 0.0) };
    ...
    inline float getMinimumCpuTurboFrequency() const { DARABONBA_PTR_GET_DEFAULT(minimumCpuTurboFrequency_, 0.0) };
    ...
    inline int32_t getMinimumDiskQuantity() const { DARABONBA_PTR_GET_DEFAULT(minimumDiskQuantity_, 0) };
    ...
    inline int32_t getMinimumEriQuantity() const { DARABONBA_PTR_GET_DEFAULT(minimumEriQuantity_, 0) };
    ...
    inline int32_t getMinimumInstanceBandwidthRx() const { DARABONBA_PTR_GET_DEFAULT(minimumInstanceBandwidthRx_, 0) };
    ...
    inline int32_t getMinimumInstanceBandwidthTx() const { DARABONBA_PTR_GET_DEFAULT(minimumInstanceBandwidthTx_, 0) };
    ...
    inline int64_t getMinimumInstancePpsRx() const { DARABONBA_PTR_GET_DEFAULT(minimumInstancePpsRx_, 0L) };
    ...
    inline int64_t getMinimumInstancePpsTx() const { DARABONBA_PTR_GET_DEFAULT(minimumInstancePpsTx_, 0L) };
    ...
    inline int32_t getMinimumLocalStorageAmount() const { DARABONBA_PTR_GET_DEFAULT(minimumLocalStorageAmount_, 0) };
    ...
    inline int64_t getMinimumLocalStorageCapacity() const { DARABONBA_PTR_GET_DEFAULT(minimumLocalStorageCapacity_, 0L) };
    ...
    inline int32_t getMinimumPrimaryEniQueueNumber() const { DARABONBA_PTR_GET_DEFAULT(minimumPrimaryEniQueueNumber_, 0) };
    ...
    inline int32_t getMinimumQueuePairNumber() const { DARABONBA_PTR_GET_DEFAULT(minimumQueuePairNumber_, 0) };
    ...
    inline int32_t getMinimumSecondaryEniQueueNumber() const { DARABONBA_PTR_GET_DEFAULT(minimumSecondaryEniQueueNumber_, 0) };
