...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDeploymentSetSupportedInstanceTypeFamilyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDeploymentSetSupportedInstanceTypeFamilyResponseBody) };
    inline DescribeDeploymentSetSupportedInstanceTypeFamilyResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDeploymentSetSupportedInstanceTypeFamilyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDeploymentSetSupportedInstanceTypeFamilyResponseBody> body_ {};
  };
