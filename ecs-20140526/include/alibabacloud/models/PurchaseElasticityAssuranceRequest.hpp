...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->privatePoolOptions_ == nullptr
        && return this->clientToken_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->period_ == nullptr && return this->periodUnit_ == nullptr
