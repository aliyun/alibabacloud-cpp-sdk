...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->hpcClusterIds_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr
    ...
    inline string getHpcClusterIds() const { DARABONBA_PTR_GET_DEFAULT(hpcClusterIds_, "") };
