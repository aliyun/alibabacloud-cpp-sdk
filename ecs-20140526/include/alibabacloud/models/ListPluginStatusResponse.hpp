...
namespace Models
{
  ...
  public:
    ...
    inline const ListPluginStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPluginStatusResponseBody) };
    inline ListPluginStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPluginStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPluginStatusResponseBody> body_ {};
  };
