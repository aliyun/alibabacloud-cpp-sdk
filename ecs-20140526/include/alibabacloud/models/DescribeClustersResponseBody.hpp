...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClustersResponseBodyClusters & clusters() const { DARABONBA_PTR_GET_CONST(clusters_, DescribeClustersResponseBodyClusters) };
    inline DescribeClustersResponseBodyClusters clusters() { DARABONBA_PTR_GET(clusters_, DescribeClustersResponseBodyClusters) };
    inline DescribeClustersResponseBody& setClusters(const DescribeClustersResponseBodyClusters & clusters) { DARABONBA_PTR_SET_VALUE(clusters_, clusters) };
    inline DescribeClustersResponseBody& setClusters(DescribeClustersResponseBodyClusters && clusters) { DARABONBA_PTR_SET_RVALUE(clusters_, clusters) };
  ...
  protected:
    std::shared_ptr<DescribeClustersResponseBodyClusters> clusters_ = nullptr;
