...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AuthorizeSecurityGroupRequestPermissions> & permissions() const { DARABONBA_PTR_GET_CONST(permissions_, vector<AuthorizeSecurityGroupRequestPermissions>) };
    inline vector<AuthorizeSecurityGroupRequestPermissions> permissions() { DARABONBA_PTR_GET(permissions_, vector<AuthorizeSecurityGroupRequestPermissions>) };
    inline AuthorizeSecurityGroupRequest& setPermissions(const vector<AuthorizeSecurityGroupRequestPermissions> & permissions) { DARABONBA_PTR_SET_VALUE(permissions_, permissions) };
    inline AuthorizeSecurityGroupRequest& setPermissions(vector<AuthorizeSecurityGroupRequestPermissions> && permissions) { DARABONBA_PTR_SET_RVALUE(permissions_, permissions) };
  ...
  protected:
    ...
    std::shared_ptr<vector<AuthorizeSecurityGroupRequestPermissions>> permissions_ = nullptr;
