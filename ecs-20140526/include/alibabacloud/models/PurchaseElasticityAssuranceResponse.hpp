...
namespace Models
{
  ...
  public:
    ...
    inline const PurchaseElasticityAssuranceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PurchaseElasticityAssuranceResponseBody) };
    inline PurchaseElasticityAssuranceResponseBody getBody() { DARABONBA_PTR_GET(body_, PurchaseElasticityAssuranceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PurchaseElasticityAssuranceResponseBody> body_ {};
  };
