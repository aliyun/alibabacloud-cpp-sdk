...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ResetDisksRequestDisk> & disk() const { DARABONBA_PTR_GET_CONST(disk_, vector<ResetDisksRequestDisk>) };
    inline vector<ResetDisksRequestDisk> disk() { DARABONBA_PTR_GET(disk_, vector<ResetDisksRequestDisk>) };
    inline ResetDisksRequest& setDisk(const vector<ResetDisksRequestDisk> & disk) { DARABONBA_PTR_SET_VALUE(disk_, disk) };
    inline ResetDisksRequest& setDisk(vector<ResetDisksRequestDisk> && disk) { DARABONBA_PTR_SET_RVALUE(disk_, disk) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ResetDisksRequestDisk>> disk_ = nullptr;
