...
namespace Models
{
  ...
  public:
    ...
    inline const EnableNetworkInterfaceQoSResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableNetworkInterfaceQoSResponseBody) };
    inline EnableNetworkInterfaceQoSResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableNetworkInterfaceQoSResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableNetworkInterfaceQoSResponseBody> body_ {};
  };
