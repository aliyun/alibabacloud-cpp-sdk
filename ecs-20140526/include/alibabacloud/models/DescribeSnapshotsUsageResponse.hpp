...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSnapshotsUsageResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSnapshotsUsageResponseBody) };
    inline DescribeSnapshotsUsageResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSnapshotsUsageResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSnapshotsUsageResponseBody> body_ = nullptr;
  };
