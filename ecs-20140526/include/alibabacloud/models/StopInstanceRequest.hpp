...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->confirmStop_ == nullptr
        && return this->dryRun_ == nullptr && return this->forceStop_ == nullptr && return this->hibernate_ == nullptr && return this->instanceId_ == nullptr && return this->ownerAccount_ == nullptr
        && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->stoppedMode_ == nullptr; };
