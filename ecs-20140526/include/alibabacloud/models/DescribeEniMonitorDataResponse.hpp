...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEniMonitorDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEniMonitorDataResponseBody) };
    inline DescribeEniMonitorDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEniMonitorDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEniMonitorDataResponseBody> body_ {};
  };
