...
namespace Models
{
  ...
  public:
    ...
    inline const EndTerminalSessionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EndTerminalSessionResponseBody) };
    inline EndTerminalSessionResponseBody getBody() { DARABONBA_PTR_GET(body_, EndTerminalSessionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EndTerminalSessionResponseBody> body_ {};
  };
