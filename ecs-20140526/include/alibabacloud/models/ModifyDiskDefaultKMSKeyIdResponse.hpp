...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDiskDefaultKMSKeyIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDiskDefaultKMSKeyIdResponseBody) };
    inline ModifyDiskDefaultKMSKeyIdResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDiskDefaultKMSKeyIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDiskDefaultKMSKeyIdResponseBody> body_ {};
  };
