...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInvocationAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyInvocationAttributeResponseBody) };
    inline ModifyInvocationAttributeResponseBody body() { DARABONBA_PTR_GET(body_, ModifyInvocationAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyInvocationAttributeResponseBody> body_ = nullptr;
  };
