...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->instanceChargeType_ != nullptr
        && this->instanceType_ != nullptr && this->operationType_ != nullptr && this->ownerAccount_ != nullptr && this->ownerId_ != nullptr && this->regionId_ != nullptr
        && this->resourceId_ != nullptr && this->resourceOwnerAccount_ != nullptr && this->resourceOwnerId_ != nullptr && this->spotStrategy_ != nullptr; };
