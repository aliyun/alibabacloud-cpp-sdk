...
#ifndef ALIBABACLOUD_MODELS_DESCRIBENETWORKINTERFACEATTRIBUTERESPONSEBODYCONNECTIONTRACKINGCONFIGURATION_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBENETWORKINTERFACEATTRIBUTERESPONSEBODYCONNECTIONTRACKINGCONFIGURATION_HPP_
...
namespace Models
{
  class DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration& obj) { 
    ...
    DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration() = default ;
    DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration(const DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration &) = default ;
    DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration(DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration &&) = default ;
    DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration() = default ;
    DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration& operator=(const DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration &) = default ;
    DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration& operator=(DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration &&) = default ;
    ...
    inline DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration& setTcpClosedAndTimeWaitTimeout(int32_t tcpClosedAndTimeWaitTimeout) { DARABONBA_PTR_SET_VALUE(tcpClosedAndTimeWaitTimeout_, tcpClosedAndTimeWaitTimeout) };
    ...
    inline DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration& setTcpEstablishedTimeout(int32_t tcpEstablishedTimeout) { DARABONBA_PTR_SET_VALUE(tcpEstablishedTimeout_, tcpEstablishedTimeout) };
    ...
    inline DescribeNetworkInterfaceAttributeResponseBodyConnectionTrackingConfiguration& setUdpTimeout(int32_t udpTimeout) { DARABONBA_PTR_SET_VALUE(udpTimeout_, udpTimeout) };
