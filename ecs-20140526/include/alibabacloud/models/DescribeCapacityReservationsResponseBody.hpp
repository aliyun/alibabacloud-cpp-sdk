...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->capacityReservationSet_ != nullptr
    ...
    inline const DescribeCapacityReservationsResponseBodyCapacityReservationSet & capacityReservationSet() const { DARABONBA_PTR_GET_CONST(capacityReservationSet_, DescribeCapacityReservationsResponseBodyCapacityReservationSet) };
    inline DescribeCapacityReservationsResponseBodyCapacityReservationSet capacityReservationSet() { DARABONBA_PTR_GET(capacityReservationSet_, DescribeCapacityReservationsResponseBodyCapacityReservationSet) };
    inline DescribeCapacityReservationsResponseBody& setCapacityReservationSet(const DescribeCapacityReservationsResponseBodyCapacityReservationSet & capacityReservationSet) { DARABONBA_PTR_SET_VALUE(capacityReservationSet_, capacityReservationSet) };
    inline DescribeCapacityReservationsResponseBody& setCapacityReservationSet(DescribeCapacityReservationsResponseBodyCapacityReservationSet && capacityReservationSet) { DARABONBA_PTR_SET_RVALUE(capacityReservationSet_, capacityReservationSet) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCapacityReservationsResponseBodyCapacityReservationSet> capacityReservationSet_ = nullptr;
