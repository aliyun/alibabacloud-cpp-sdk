...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDedicatedHostAutoReleaseTimeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDedicatedHostAutoReleaseTimeResponseBody) };
    inline ModifyDedicatedHostAutoReleaseTimeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDedicatedHostAutoReleaseTimeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDedicatedHostAutoReleaseTimeResponseBody> body_ {};
  };
