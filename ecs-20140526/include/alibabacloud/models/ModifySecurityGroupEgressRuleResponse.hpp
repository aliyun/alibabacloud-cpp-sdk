...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySecurityGroupEgressRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySecurityGroupEgressRuleResponseBody) };
    inline ModifySecurityGroupEgressRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySecurityGroupEgressRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySecurityGroupEgressRuleResponseBody> body_ {};
  };
