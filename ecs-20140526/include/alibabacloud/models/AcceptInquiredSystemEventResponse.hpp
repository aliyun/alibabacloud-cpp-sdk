...
namespace Models
{
  ...
  public:
    ...
    inline const AcceptInquiredSystemEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AcceptInquiredSystemEventResponseBody) };
    inline AcceptInquiredSystemEventResponseBody getBody() { DARABONBA_PTR_GET(body_, AcceptInquiredSystemEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AcceptInquiredSystemEventResponseBody> body_ {};
  };
