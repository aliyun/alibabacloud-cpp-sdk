...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDedicatedHostAutoRenewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDedicatedHostAutoRenewResponseBody) };
    inline DescribeDedicatedHostAutoRenewResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDedicatedHostAutoRenewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDedicatedHostAutoRenewResponseBody> body_ {};
  };
