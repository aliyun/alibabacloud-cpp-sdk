...
#ifndef ALIBABACLOUD_MODELS_MODIFYINVOCATIONATTRIBUTESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYINVOCATIONATTRIBUTESHRINKREQUEST_HPP_
...
namespace Models
{
  class ModifyInvocationAttributeShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyInvocationAttributeShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyInvocationAttributeShrinkRequest& obj) { 
    ...
    ModifyInvocationAttributeShrinkRequest() = default ;
    ModifyInvocationAttributeShrinkRequest(const ModifyInvocationAttributeShrinkRequest &) = default ;
    ModifyInvocationAttributeShrinkRequest(ModifyInvocationAttributeShrinkRequest &&) = default ;
    ModifyInvocationAttributeShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyInvocationAttributeShrinkRequest() = default ;
    ModifyInvocationAttributeShrinkRequest& operator=(const ModifyInvocationAttributeShrinkRequest &) = default ;
    ModifyInvocationAttributeShrinkRequest& operator=(ModifyInvocationAttributeShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        ...
        && this->invokeId_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->parametersShrink_ == nullptr && this->regionId_ == nullptr
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr; };
    // clientToken Field Functions 
    bool hasClientToken() const { return this->clientToken_ != nullptr;};
    void deleteClientToken() { this->clientToken_ = nullptr;};
    inline string getClientToken() const { DARABONBA_PTR_GET_DEFAULT(clientToken_, "") };
    inline ModifyInvocationAttributeShrinkRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
