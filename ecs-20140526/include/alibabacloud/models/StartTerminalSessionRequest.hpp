...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->commandLine_ == nullptr
        && return this->connectionType_ == nullptr && return this->encryptionOptions_ == nullptr && return this->instanceId_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
    ...
    inline const StartTerminalSessionRequestEncryptionOptions & encryptionOptions() const { DARABONBA_PTR_GET_CONST(encryptionOptions_, StartTerminalSessionRequestEncryptionOptions) };
    inline StartTerminalSessionRequestEncryptionOptions encryptionOptions() { DARABONBA_PTR_GET(encryptionOptions_, StartTerminalSessionRequestEncryptionOptions) };
    inline StartTerminalSessionRequest& setEncryptionOptions(const StartTerminalSessionRequestEncryptionOptions & encryptionOptions) { DARABONBA_PTR_SET_VALUE(encryptionOptions_, encryptionOptions) };
    inline StartTerminalSessionRequest& setEncryptionOptions(StartTerminalSessionRequestEncryptionOptions && encryptionOptions) { DARABONBA_PTR_SET_RVALUE(encryptionOptions_, encryptionOptions) };
  ...
  protected:
    ...
    std::shared_ptr<StartTerminalSessionRequestEncryptionOptions> encryptionOptions_ = nullptr;
    // The instance IDs.
    // 
