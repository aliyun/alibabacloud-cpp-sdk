...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->commandLine_ != nullptr
        && this->connectionType_ != nullptr && this->instanceId_ != nullptr && this->ownerAccount_ != nullptr && this->ownerId_ != nullptr && this->passwordName_ != nullptr
        && this->portNumber_ != nullptr && this->regionId_ != nullptr && this->resourceOwnerAccount_ != nullptr && this->resourceOwnerId_ != nullptr && this->targetServer_ != nullptr
