...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deploymentSetId_ == nullptr
        && return this->deploymentSetName_ == nullptr && return this->description_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr
