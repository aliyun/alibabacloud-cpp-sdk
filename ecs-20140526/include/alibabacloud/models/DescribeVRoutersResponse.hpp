...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVRoutersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVRoutersResponseBody) };
    inline DescribeVRoutersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVRoutersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVRoutersResponseBody> body_ {};
  };
