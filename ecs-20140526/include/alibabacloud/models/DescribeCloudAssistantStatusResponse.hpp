...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudAssistantStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudAssistantStatusResponseBody) };
    inline DescribeCloudAssistantStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCloudAssistantStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudAssistantStatusResponseBody> body_ {};
  };
