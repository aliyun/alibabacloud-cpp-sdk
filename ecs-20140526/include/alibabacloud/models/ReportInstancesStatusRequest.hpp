...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getDevice() const { DARABONBA_PTR_GET_CONST(device_, vector<string>) };
    inline vector<string> getDevice() { DARABONBA_PTR_GET(device_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> device_ {};
