...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutoProvisioningGroupInstancesResponseBodyInstances & instances() const { DARABONBA_PTR_GET_CONST(instances_, DescribeAutoProvisioningGroupInstancesResponseBodyInstances) };
    inline DescribeAutoProvisioningGroupInstancesResponseBodyInstances instances() { DARABONBA_PTR_GET(instances_, DescribeAutoProvisioningGroupInstancesResponseBodyInstances) };
    inline DescribeAutoProvisioningGroupInstancesResponseBody& setInstances(const DescribeAutoProvisioningGroupInstancesResponseBodyInstances & instances) { DARABONBA_PTR_SET_VALUE(instances_, instances) };
    inline DescribeAutoProvisioningGroupInstancesResponseBody& setInstances(DescribeAutoProvisioningGroupInstancesResponseBodyInstances && instances) { DARABONBA_PTR_SET_RVALUE(instances_, instances) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAutoProvisioningGroupInstancesResponseBodyInstances> instances_ = nullptr;
    // The page number.
