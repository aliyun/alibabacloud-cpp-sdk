...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeStorageSetDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeStorageSetDetailsResponseBody) };
    inline DescribeStorageSetDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeStorageSetDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeStorageSetDetailsResponseBody> body_ {};
  };
