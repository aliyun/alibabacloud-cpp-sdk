...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInvocationResultsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInvocationResultsResponseBody) };
    inline DescribeInvocationResultsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInvocationResultsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInvocationResultsResponseBody> body_ {};
  };
