...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDiagnosticMetricSetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDiagnosticMetricSetsResponseBody) };
    inline DeleteDiagnosticMetricSetsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDiagnosticMetricSetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDiagnosticMetricSetsResponseBody> body_ {};
  };
