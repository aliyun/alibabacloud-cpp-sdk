...
namespace Models
{
  ...
  public:
    ...
    inline const RebootInstancesResponseBody::InstanceResponses & getInstanceResponses() const { DARABONBA_PTR_GET_CONST(instanceResponses_, RebootInstancesResponseBody::InstanceResponses) };
    inline RebootInstancesResponseBody::InstanceResponses getInstanceResponses() { DARABONBA_PTR_GET(instanceResponses_, RebootInstancesResponseBody::InstanceResponses) };
    inline RebootInstancesResponseBody& setInstanceResponses(const RebootInstancesResponseBody::InstanceResponses & instanceResponses) { DARABONBA_PTR_SET_VALUE(instanceResponses_, instanceResponses) };
    inline RebootInstancesResponseBody& setInstanceResponses(RebootInstancesResponseBody::InstanceResponses && instanceResponses) { DARABONBA_PTR_SET_RVALUE(instanceResponses_, instanceResponses) };
