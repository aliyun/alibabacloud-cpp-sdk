...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->circuitCode_ == nullptr
        ...
        && this->ownerId_ == nullptr && this->peerGatewayIp_ == nullptr && this->peeringSubnetMask_ == nullptr && this->regionId_ == nullptr && this->resourceOwnerAccount_ == nullptr
        && this->resourceOwnerId_ == nullptr && this->userCidr_ == nullptr && this->vbrId_ == nullptr && this->vlanId_ == nullptr; };
