...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSpotAdviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSpotAdviceResponseBody) };
    inline DescribeSpotAdviceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSpotAdviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSpotAdviceResponseBody> body_ {};
  };
