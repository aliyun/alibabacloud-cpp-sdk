...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHpcClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHpcClusterResponseBody) };
    inline DeleteHpcClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHpcClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHpcClusterResponseBody> body_ {};
  };
