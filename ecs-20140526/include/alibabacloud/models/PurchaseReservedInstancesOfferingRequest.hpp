...
namespace Models
{
  ...
  public:
    ...
    inline const vector<PurchaseReservedInstancesOfferingRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<PurchaseReservedInstancesOfferingRequest::Tag>) };
    inline vector<PurchaseReservedInstancesOfferingRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<PurchaseReservedInstancesOfferingRequest::Tag>) };
    inline PurchaseReservedInstancesOfferingRequest& setTag(const vector<PurchaseReservedInstancesOfferingRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline PurchaseReservedInstancesOfferingRequest& setTag(vector<PurchaseReservedInstancesOfferingRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
