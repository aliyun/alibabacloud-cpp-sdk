...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyReservedInstanceAutoRenewAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyReservedInstanceAutoRenewAttributeResponseBody) };
    inline ModifyReservedInstanceAutoRenewAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyReservedInstanceAutoRenewAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyReservedInstanceAutoRenewAttributeResponseBody> body_ {};
  };
