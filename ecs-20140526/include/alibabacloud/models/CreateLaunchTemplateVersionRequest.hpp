...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->systemDisk_ != nullptr
        ...
        && this->securityEnhancementStrategy_ != nullptr && this->securityGroupId_ != nullptr && this->securityGroupIds_ != nullptr && this->spotDuration_ != nullptr && this->spotPriceLimit_ != nullptr
        && this->spotStrategy_ != nullptr && this->tag_ != nullptr && this->userData_ != nullptr && this->vSwitchId_ != nullptr && this->versionDescription_ != nullptr
