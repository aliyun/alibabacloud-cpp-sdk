...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->affinity_ == nullptr
        && this->clientToken_ == nullptr && this->deploymentSetName_ == nullptr && this->description_ == nullptr && this->domain_ == nullptr && this->granularity_ == nullptr
        && this->groupCount_ == nullptr && this->onUnableToRedeployFailedInstance_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->regionId_ == nullptr
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->strategy_ == nullptr && this->type_ == nullptr; };
    ...
    inline CreateDeploymentSetRequest& setAffinity(int64_t affinity) { DARABONBA_PTR_SET_VALUE(affinity_, affinity) };
