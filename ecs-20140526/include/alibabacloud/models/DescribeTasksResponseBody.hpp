...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->regionId_ == nullptr && return this->requestId_ == nullptr && return this->taskSet_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const DescribeTasksResponseBodyTaskSet & taskSet() const { DARABONBA_PTR_GET_CONST(taskSet_, DescribeTasksResponseBodyTaskSet) };
    inline DescribeTasksResponseBodyTaskSet taskSet() { DARABONBA_PTR_GET(taskSet_, DescribeTasksResponseBodyTaskSet) };
    inline DescribeTasksResponseBody& setTaskSet(const DescribeTasksResponseBodyTaskSet & taskSet) { DARABONBA_PTR_SET_VALUE(taskSet_, taskSet) };
    inline DescribeTasksResponseBody& setTaskSet(DescribeTasksResponseBodyTaskSet && taskSet) { DARABONBA_PTR_SET_RVALUE(taskSet_, taskSet) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeTasksResponseBodyTaskSet> taskSet_ = nullptr;
