...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoRenewEnabled_ == nullptr
        && return this->autoRenewWithEcs_ == nullptr && return this->dedicatedHostId_ == nullptr && return this->duration_ == nullptr && return this->periodUnit_ == nullptr && return this->renewalStatus_ == nullptr; };
