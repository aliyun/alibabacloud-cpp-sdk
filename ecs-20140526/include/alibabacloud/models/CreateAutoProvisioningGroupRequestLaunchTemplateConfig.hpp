...
#ifndef ALIBABACLOUD_MODELS_CREATEAUTOPROVISIONINGGROUPREQUESTLAUNCHTEMPLATECONFIG_HPP_
#define ALIBABACLOUD_MODELS_CREATEAUTOPROVISIONINGGROUPREQUESTLAUNCHTEMPLATECONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAutoProvisioningGroupRequestLaunchTemplateConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateAutoProvisioningGroupRequestLaunchTemplateConfig& obj) { 
    ...
    CreateAutoProvisioningGroupRequestLaunchTemplateConfig() = default ;
    CreateAutoProvisioningGroupRequestLaunchTemplateConfig(const CreateAutoProvisioningGroupRequestLaunchTemplateConfig &) = default ;
    CreateAutoProvisioningGroupRequestLaunchTemplateConfig(CreateAutoProvisioningGroupRequestLaunchTemplateConfig &&) = default ;
    CreateAutoProvisioningGroupRequestLaunchTemplateConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAutoProvisioningGroupRequestLaunchTemplateConfig() = default ;
    CreateAutoProvisioningGroupRequestLaunchTemplateConfig& operator=(const CreateAutoProvisioningGroupRequestLaunchTemplateConfig &) = default ;
    CreateAutoProvisioningGroupRequestLaunchTemplateConfig& operator=(CreateAutoProvisioningGroupRequestLaunchTemplateConfig &&) = default ;
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setArchitectures(const vector<string> & architectures) { DARABONBA_PTR_SET_VALUE(architectures_, architectures) };
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setArchitectures(vector<string> && architectures) { DARABONBA_PTR_SET_RVALUE(architectures_, architectures) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setBurstablePerformance(string burstablePerformance) { DARABONBA_PTR_SET_VALUE(burstablePerformance_, burstablePerformance) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setCores(const vector<int32_t> & cores) { DARABONBA_PTR_SET_VALUE(cores_, cores) };
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setCores(vector<int32_t> && cores) { DARABONBA_PTR_SET_RVALUE(cores_, cores) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setExcludedInstanceTypes(const vector<string> & excludedInstanceTypes) { DARABONBA_PTR_SET_VALUE(excludedInstanceTypes_, excludedInstanceTypes) };
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setExcludedInstanceTypes(vector<string> && excludedInstanceTypes) { DARABONBA_PTR_SET_RVALUE(excludedInstanceTypes_, excludedInstanceTypes) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setImageId(string imageId) { DARABONBA_PTR_SET_VALUE(imageId_, imageId) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setInstanceFamilyLevel(string instanceFamilyLevel) { DARABONBA_PTR_SET_VALUE(instanceFamilyLevel_, instanceFamilyLevel) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setMaxPrice(double maxPrice) { DARABONBA_PTR_SET_VALUE(maxPrice_, maxPrice) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setMaxQuantity(int32_t maxQuantity) { DARABONBA_PTR_SET_VALUE(maxQuantity_, maxQuantity) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setMemories(const vector<float> & memories) { DARABONBA_PTR_SET_VALUE(memories_, memories) };
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setMemories(vector<float> && memories) { DARABONBA_PTR_SET_RVALUE(memories_, memories) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setPriority(int32_t priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setVSwitchId(string vSwitchId) { DARABONBA_PTR_SET_VALUE(vSwitchId_, vSwitchId) };
    ...
    inline CreateAutoProvisioningGroupRequestLaunchTemplateConfig& setWeightedCapacity(double weightedCapacity) { DARABONBA_PTR_SET_VALUE(weightedCapacity_, weightedCapacity) };
