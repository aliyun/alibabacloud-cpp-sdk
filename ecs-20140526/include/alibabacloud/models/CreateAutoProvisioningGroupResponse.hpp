...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAutoProvisioningGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAutoProvisioningGroupResponseBody) };
    inline CreateAutoProvisioningGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAutoProvisioningGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAutoProvisioningGroupResponseBody> body_ {};
  };
