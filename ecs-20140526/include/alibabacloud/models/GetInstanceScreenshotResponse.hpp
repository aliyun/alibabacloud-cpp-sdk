...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceScreenshotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceScreenshotResponseBody) };
    inline GetInstanceScreenshotResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceScreenshotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceScreenshotResponseBody> body_ {};
  };
