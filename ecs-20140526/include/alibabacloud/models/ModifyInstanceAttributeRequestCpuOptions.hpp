...
#ifndef ALIBABACLOUD_MODELS_MODIFYINSTANCEATTRIBUTEREQUESTCPUOPTIONS_HPP_
#define ALIBABACLOUD_MODELS_MODIFYINSTANCEATTRIBUTEREQUESTCPUOPTIONS_HPP_
...
namespace Models
{
  class ModifyInstanceAttributeRequestCpuOptions : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyInstanceAttributeRequestCpuOptions& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyInstanceAttributeRequestCpuOptions& obj) { 
    ...
    ModifyInstanceAttributeRequestCpuOptions() = default ;
    ModifyInstanceAttributeRequestCpuOptions(const ModifyInstanceAttributeRequestCpuOptions &) = default ;
    ModifyInstanceAttributeRequestCpuOptions(ModifyInstanceAttributeRequestCpuOptions &&) = default ;
    ModifyInstanceAttributeRequestCpuOptions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyInstanceAttributeRequestCpuOptions() = default ;
    ModifyInstanceAttributeRequestCpuOptions& operator=(const ModifyInstanceAttributeRequestCpuOptions &) = default ;
    ModifyInstanceAttributeRequestCpuOptions& operator=(ModifyInstanceAttributeRequestCpuOptions &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->core_ == nullptr
        && return this->threadsPerCore_ == nullptr && return this->topologyType_ == nullptr; };
    ...
    inline ModifyInstanceAttributeRequestCpuOptions& setCore(int32_t core) { DARABONBA_PTR_SET_VALUE(core_, core) };
    ...
    inline ModifyInstanceAttributeRequestCpuOptions& setThreadsPerCore(int32_t threadsPerCore) { DARABONBA_PTR_SET_VALUE(threadsPerCore_, threadsPerCore) };
    ...
    inline ModifyInstanceAttributeRequestCpuOptions& setTopologyType(string topologyType) { DARABONBA_PTR_SET_VALUE(topologyType_, topologyType) };
