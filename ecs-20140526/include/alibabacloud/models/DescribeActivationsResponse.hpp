...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeActivationsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeActivationsResponseBody) };
    inline DescribeActivationsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeActivationsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeActivationsResponseBody> body_ = nullptr;
  };
