...
namespace Models
{
  ...
  public:
    ...
    inline const vector<RunCommandRequestResourceTag> & resourceTag() const { DARABONBA_PTR_GET_CONST(resourceTag_, vector<RunCommandRequestResourceTag>) };
    inline vector<RunCommandRequestResourceTag> resourceTag() { DARABONBA_PTR_GET(resourceTag_, vector<RunCommandRequestResourceTag>) };
    inline RunCommandRequest& setResourceTag(const vector<RunCommandRequestResourceTag> & resourceTag) { DARABONBA_PTR_SET_VALUE(resourceTag_, resourceTag) };
    inline RunCommandRequest& setResourceTag(vector<RunCommandRequestResourceTag> && resourceTag) { DARABONBA_PTR_SET_RVALUE(resourceTag_, resourceTag) };


    // tag Field Functions 
    bool hasTag() const { return this->tag_ != nullptr;};
    void deleteTag() { this->tag_ = nullptr;};
    inline const vector<RunCommandRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<RunCommandRequestTag>) };
    inline vector<RunCommandRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<RunCommandRequestTag>) };
    inline RunCommandRequest& setTag(const vector<RunCommandRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline RunCommandRequest& setTag(vector<RunCommandRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    std::shared_ptr<vector<RunCommandRequestResourceTag>> resourceTag_ = nullptr;
    // The tags to add to the command task. You can leave this parameter empty or specify up to 20 tags.
    std::shared_ptr<vector<RunCommandRequestTag>> tag_ = nullptr;
