...
namespace Models
{
  ...
  public:
    ...
    inline const ReportInstancesStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ReportInstancesStatusResponseBody) };
    inline ReportInstancesStatusResponseBody body() { DARABONBA_PTR_GET(body_, ReportInstancesStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ReportInstancesStatusResponseBody> body_ = nullptr;
  };
