...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageComponentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageComponentsResponseBody) };
    inline DescribeImageComponentsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageComponentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageComponentsResponseBody> body_ {};
  };
