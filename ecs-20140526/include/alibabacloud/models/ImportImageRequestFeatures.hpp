...
#ifndef ALIBABACLOUD_MODELS_IMPORTIMAGEREQUESTFEATURES_HPP_
#define ALIBABACLOUD_MODELS_IMPORTIMAGEREQUESTFEATURES_HPP_
...
namespace Models
{
  class ImportImageRequestFeatures : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ImportImageRequestFeatures& obj) { 
      DARABONBA_PTR_TO_JSON(ImdsSupport, imdsSupport_);
      DARABONBA_PTR_TO_JSON(NvmeSupport, nvmeSupport_);
    };
    friend void from_json(const Darabonba::Json& j, ImportImageRequestFeatures& obj) { 
      DARABONBA_PTR_FROM_JSON(ImdsSupport, imdsSupport_);
      DARABONBA_PTR_FROM_JSON(NvmeSupport, nvmeSupport_);
    };
    ImportImageRequestFeatures() = default ;
    ImportImageRequestFeatures(const ImportImageRequestFeatures &) = default ;
    ImportImageRequestFeatures(ImportImageRequestFeatures &&) = default ;
    ImportImageRequestFeatures(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ImportImageRequestFeatures() = default ;
    ImportImageRequestFeatures& operator=(const ImportImageRequestFeatures &) = default ;
    ImportImageRequestFeatures& operator=(ImportImageRequestFeatures &&) = default ;
    ...
    inline ImportImageRequestFeatures& setImdsSupport(string imdsSupport) { DARABONBA_PTR_SET_VALUE(imdsSupport_, imdsSupport) };
    ...
    inline ImportImageRequestFeatures& setNvmeSupport(string nvmeSupport) { DARABONBA_PTR_SET_VALUE(nvmeSupport_, nvmeSupport) };
