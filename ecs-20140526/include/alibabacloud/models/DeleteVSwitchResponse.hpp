...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVSwitchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteVSwitchResponseBody) };
    inline DeleteVSwitchResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteVSwitchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteVSwitchResponseBody> body_ {};
  };
