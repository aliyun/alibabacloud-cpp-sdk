...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->destinationDescription_ == nullptr && this->destinationImageName_ == nullptr && this->destinationRegionId_ == nullptr && this->dryRun_ == nullptr && this->encryptAlgorithm_ == nullptr
        && this->encrypted_ == nullptr && this->imageId_ == nullptr && this->KMSKeyId_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr
    ...
    inline const vector<CopyImageRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CopyImageRequest::Tag>) };
    inline vector<CopyImageRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CopyImageRequest::Tag>) };
    inline CopyImageRequest& setTag(const vector<CopyImageRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CopyImageRequest& setTag(vector<CopyImageRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    // The list of tags.
    shared_ptr<vector<CopyImageRequest::Tag>> tag_ {};
  };
