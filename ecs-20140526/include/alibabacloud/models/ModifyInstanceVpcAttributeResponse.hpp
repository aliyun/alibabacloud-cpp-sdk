...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceVpcAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceVpcAttributeResponseBody) };
    inline ModifyInstanceVpcAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyInstanceVpcAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyInstanceVpcAttributeResponseBody> body_ {};
  };
