...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->copiedSnapshotsRetentionDays_ == nullptr
        && return this->copyEncryptionConfiguration_ == nullptr && return this->enableCrossRegionCopy_ == nullptr && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr
        && return this->targetCopyRegions_ == nullptr && return this->autoSnapshotPolicyId_ == nullptr && return this->autoSnapshotPolicyName_ == nullptr && return this->regionId_ == nullptr && return this->repeatWeekdays_ == nullptr
        && return this->retentionDays_ == nullptr && return this->timePoints_ == nullptr; };
