...
#ifndef ALIBABACLOUD_MODELS_CREATENETWORKINTERFACEREQUESTCONNECTIONTRACKINGCONFIGURATION_HPP_
#define ALIBABACLOUD_MODELS_CREATENETWORKINTERFACEREQUESTCONNECTIONTRACKINGCONFIGURATION_HPP_
...
namespace Models
{
  class CreateNetworkInterfaceRequestConnectionTrackingConfiguration : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateNetworkInterfaceRequestConnectionTrackingConfiguration& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateNetworkInterfaceRequestConnectionTrackingConfiguration& obj) { 
    ...
    CreateNetworkInterfaceRequestConnectionTrackingConfiguration() = default ;
    CreateNetworkInterfaceRequestConnectionTrackingConfiguration(const CreateNetworkInterfaceRequestConnectionTrackingConfiguration &) = default ;
    CreateNetworkInterfaceRequestConnectionTrackingConfiguration(CreateNetworkInterfaceRequestConnectionTrackingConfiguration &&) = default ;
    CreateNetworkInterfaceRequestConnectionTrackingConfiguration(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateNetworkInterfaceRequestConnectionTrackingConfiguration() = default ;
    CreateNetworkInterfaceRequestConnectionTrackingConfiguration& operator=(const CreateNetworkInterfaceRequestConnectionTrackingConfiguration &) = default ;
    CreateNetworkInterfaceRequestConnectionTrackingConfiguration& operator=(CreateNetworkInterfaceRequestConnectionTrackingConfiguration &&) = default ;
    ...
    inline CreateNetworkInterfaceRequestConnectionTrackingConfiguration& setTcpClosedAndTimeWaitTimeout(int32_t tcpClosedAndTimeWaitTimeout) { DARABONBA_PTR_SET_VALUE(tcpClosedAndTimeWaitTimeout_, tcpClosedAndTimeWaitTimeout) };
    ...
    inline CreateNetworkInterfaceRequestConnectionTrackingConfiguration& setTcpEstablishedTimeout(int32_t tcpEstablishedTimeout) { DARABONBA_PTR_SET_VALUE(tcpEstablishedTimeout_, tcpEstablishedTimeout) };
    ...
    inline CreateNetworkInterfaceRequestConnectionTrackingConfiguration& setUdpTimeout(int32_t udpTimeout) { DARABONBA_PTR_SET_VALUE(udpTimeout_, udpTimeout) };
