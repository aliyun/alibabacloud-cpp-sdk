...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessPointId_ == nullptr
        && return this->autoPay_ == nullptr && return this->clientToken_ == nullptr && return this->description_ == nullptr && return this->healthCheckSourceIp_ == nullptr && return this->healthCheckTargetIp_ == nullptr
        && return this->instanceChargeType_ == nullptr && return this->name_ == nullptr && return this->oppositeAccessPointId_ == nullptr && return this->oppositeInterfaceId_ == nullptr && return this->oppositeInterfaceOwnerId_ == nullptr
        && return this->oppositeRegionId_ == nullptr && return this->oppositeRouterId_ == nullptr && return this->oppositeRouterType_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
        && return this->period_ == nullptr && return this->pricingCycle_ == nullptr && return this->regionId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr
        && return this->role_ == nullptr && return this->routerId_ == nullptr && return this->routerType_ == nullptr && return this->spec_ == nullptr && return this->userCidr_ == nullptr; };
