...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getNetworkInterfacePermissionId() const { DARABONBA_PTR_GET_CONST(networkInterfacePermissionId_, vector<string>) };
    inline vector<string> getNetworkInterfacePermissionId() { DARABONBA_PTR_GET(networkInterfacePermissionId_, vector<string>) };
