...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSnapshotMonitorDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSnapshotMonitorDataResponseBody) };
    inline DescribeSnapshotMonitorDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSnapshotMonitorDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSnapshotMonitorDataResponseBody> body_ {};
  };
