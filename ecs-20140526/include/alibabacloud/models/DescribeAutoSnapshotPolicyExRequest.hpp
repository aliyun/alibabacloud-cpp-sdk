...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoSnapshotPolicyId_ == nullptr
        && this->autoSnapshotPolicyName_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr
    ...
    inline const vector<DescribeAutoSnapshotPolicyExRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeAutoSnapshotPolicyExRequest::Tag>) };
    inline vector<DescribeAutoSnapshotPolicyExRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeAutoSnapshotPolicyExRequest::Tag>) };
    inline DescribeAutoSnapshotPolicyExRequest& setTag(const vector<DescribeAutoSnapshotPolicyExRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeAutoSnapshotPolicyExRequest& setTag(vector<DescribeAutoSnapshotPolicyExRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
