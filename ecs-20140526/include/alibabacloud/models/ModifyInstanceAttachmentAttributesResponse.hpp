...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceAttachmentAttributesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceAttachmentAttributesResponseBody) };
    inline ModifyInstanceAttachmentAttributesResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyInstanceAttachmentAttributesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyInstanceAttachmentAttributesResponseBody> body_ {};
  };
