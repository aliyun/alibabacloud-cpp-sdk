...
namespace Models
{
  ...
  public:
    ...
    inline const ResetDiskDefaultKMSKeyIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResetDiskDefaultKMSKeyIdResponseBody) };
    inline ResetDiskDefaultKMSKeyIdResponseBody getBody() { DARABONBA_PTR_GET(body_, ResetDiskDefaultKMSKeyIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResetDiskDefaultKMSKeyIdResponseBody> body_ {};
  };
