...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && return this->disableInstantAccess_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr
        && return this->retentionDays_ == nullptr && return this->snapshotId_ == nullptr && return this->snapshotName_ == nullptr; };
    ...
    inline bool disableInstantAccess() const { DARABONBA_PTR_GET_DEFAULT(disableInstantAccess_, false) };
  ...
  protected:
    ...
    std::shared_ptr<bool> disableInstantAccess_ = nullptr;
