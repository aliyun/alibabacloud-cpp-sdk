...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->limitation_ != nullptr
    ...
    inline DescribeLimitationRequest& setLimitation(string limitation) { DARABONBA_PTR_SET_VALUE(limitation_, limitation) };
    ...
    inline DescribeLimitationRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline DescribeLimitationRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
