...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLaunchTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLaunchTemplateResponseBody) };
    inline CreateLaunchTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLaunchTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLaunchTemplateResponseBody> body_ {};
  };
