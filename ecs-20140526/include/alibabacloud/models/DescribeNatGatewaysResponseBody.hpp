...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNatGatewaysResponseBodyNatGateways & natGateways() const { DARABONBA_PTR_GET_CONST(natGateways_, DescribeNatGatewaysResponseBodyNatGateways) };
    inline DescribeNatGatewaysResponseBodyNatGateways natGateways() { DARABONBA_PTR_GET(natGateways_, DescribeNatGatewaysResponseBodyNatGateways) };
    inline DescribeNatGatewaysResponseBody& setNatGateways(const DescribeNatGatewaysResponseBodyNatGateways & natGateways) { DARABONBA_PTR_SET_VALUE(natGateways_, natGateways) };
    inline DescribeNatGatewaysResponseBody& setNatGateways(DescribeNatGatewaysResponseBodyNatGateways && natGateways) { DARABONBA_PTR_SET_RVALUE(natGateways_, natGateways) };
  ...
  protected:
    std::shared_ptr<DescribeNatGatewaysResponseBodyNatGateways> natGateways_ = nullptr;
