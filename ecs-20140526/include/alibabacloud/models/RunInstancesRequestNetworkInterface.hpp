...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deleteOnRelease_ == nullptr
        && return this->description_ == nullptr && return this->instanceType_ == nullptr && return this->ipv6Address_ == nullptr && return this->ipv6AddressCount_ == nullptr && return this->networkCardIndex_ == nullptr
        && return this->networkInterfaceId_ == nullptr && return this->networkInterfaceName_ == nullptr && return this->networkInterfaceTrafficMode_ == nullptr && return this->primaryIpAddress_ == nullptr && return this->queueNumber_ == nullptr
        && return this->queuePairNumber_ == nullptr && return this->rxQueueSize_ == nullptr && return this->securityGroupId_ == nullptr && return this->securityGroupIds_ == nullptr && return this->sourceDestCheck_ == nullptr
        && return this->txQueueSize_ == nullptr && return this->vSwitchId_ == nullptr; };
