...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteActivationResponseBody::Activation & getActivation() const { DARABONBA_PTR_GET_CONST(activation_, DeleteActivationResponseBody::Activation) };
    inline DeleteActivationResponseBody::Activation getActivation() { DARABONBA_PTR_GET(activation_, DeleteActivationResponseBody::Activation) };
    inline DeleteActivationResponseBody& setActivation(const DeleteActivationResponseBody::Activation & activation) { DARABONBA_PTR_SET_VALUE(activation_, activation) };
    inline DeleteActivationResponseBody& setActivation(DeleteActivationResponseBody::Activation && activation) { DARABONBA_PTR_SET_RVALUE(activation_, activation) };
