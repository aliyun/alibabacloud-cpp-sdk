...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceMaintenanceAttributesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceMaintenanceAttributesResponseBody) };
    inline ModifyInstanceMaintenanceAttributesResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyInstanceMaintenanceAttributesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyInstanceMaintenanceAttributesResponseBody> body_ {};
  };
