...
namespace Models
{
  ...
  public:
    ...
    inline const OpenSnapshotServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenSnapshotServiceResponseBody) };
    inline OpenSnapshotServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenSnapshotServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenSnapshotServiceResponseBody> body_ {};
  };
