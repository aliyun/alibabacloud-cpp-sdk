...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->estimationResource_ == nullptr
        && this->instanceTypeScope_ == nullptr && this->offeringType_ == nullptr && this->period_ == nullptr && this->periodUnit_ == nullptr && this->planType_ == nullptr
    ...
    inline string getEstimationResource() const { DARABONBA_PTR_GET_DEFAULT(estimationResource_, "") };
    ...
    inline string getInstanceTypeScope() const { DARABONBA_PTR_GET_DEFAULT(instanceTypeScope_, "") };
  ...
  protected:
    shared_ptr<string> estimationResource_ {};
    shared_ptr<string> instanceTypeScope_ {};
