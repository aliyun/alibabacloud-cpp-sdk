...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->executionId_ == nullptr
        ...
        && return this->templateTag_ == nullptr; };
    ...
    inline const vector<CancelImagePipelineExecutionRequestTemplateTag> & templateTag() const { DARABONBA_PTR_GET_CONST(templateTag_, vector<CancelImagePipelineExecutionRequestTemplateTag>) };
    inline vector<CancelImagePipelineExecutionRequestTemplateTag> templateTag() { DARABONBA_PTR_GET(templateTag_, vector<CancelImagePipelineExecutionRequestTemplateTag>) };
    inline CancelImagePipelineExecutionRequest& setTemplateTag(const vector<CancelImagePipelineExecutionRequestTemplateTag> & templateTag) { DARABONBA_PTR_SET_VALUE(templateTag_, templateTag) };
    inline CancelImagePipelineExecutionRequest& setTemplateTag(vector<CancelImagePipelineExecutionRequestTemplateTag> && templateTag) { DARABONBA_PTR_SET_RVALUE(templateTag_, templateTag) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CancelImagePipelineExecutionRequestTemplateTag>> templateTag_ = nullptr;
  };
