...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceModificationPriceResponseBody::PriceInfo & getPriceInfo() const { DARABONBA_PTR_GET_CONST(priceInfo_, DescribeInstanceModificationPriceResponseBody::PriceInfo) };
    inline DescribeInstanceModificationPriceResponseBody::PriceInfo getPriceInfo() { DARABONBA_PTR_GET(priceInfo_, DescribeInstanceModificationPriceResponseBody::PriceInfo) };
    inline DescribeInstanceModificationPriceResponseBody& setPriceInfo(const DescribeInstanceModificationPriceResponseBody::PriceInfo & priceInfo) { DARABONBA_PTR_SET_VALUE(priceInfo_, priceInfo) };
    inline DescribeInstanceModificationPriceResponseBody& setPriceInfo(DescribeInstanceModificationPriceResponseBody::PriceInfo && priceInfo) { DARABONBA_PTR_SET_RVALUE(priceInfo_, priceInfo) };
