...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudAssistantSettingsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudAssistantSettingsResponseBody) };
    inline DescribeCloudAssistantSettingsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeCloudAssistantSettingsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCloudAssistantSettingsResponseBody> body_ = nullptr;
  };
