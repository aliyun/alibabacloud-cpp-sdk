...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDedicatedHostAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDedicatedHostAttributeResponseBody) };
    inline ModifyDedicatedHostAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDedicatedHostAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDedicatedHostAttributeResponseBody> body_ {};
  };
