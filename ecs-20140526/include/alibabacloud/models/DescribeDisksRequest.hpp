...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDisksRequest::Filter> & getFilter() const { DARABONBA_PTR_GET_CONST(filter_, vector<DescribeDisksRequest::Filter>) };
    inline vector<DescribeDisksRequest::Filter> getFilter() { DARABONBA_PTR_GET(filter_, vector<DescribeDisksRequest::Filter>) };
    inline DescribeDisksRequest& setFilter(const vector<DescribeDisksRequest::Filter> & filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    inline DescribeDisksRequest& setFilter(vector<DescribeDisksRequest::Filter> && filter) { DARABONBA_PTR_SET_RVALUE(filter_, filter) };
    ...
    inline bool getEnableShared() const { DARABONBA_PTR_GET_DEFAULT(enableShared_, false) };
    ...
    inline const vector<DescribeDisksRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeDisksRequest::Tag>) };
    inline vector<DescribeDisksRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeDisksRequest::Tag>) };
    inline DescribeDisksRequest& setTag(const vector<DescribeDisksRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeDisksRequest& setTag(vector<DescribeDisksRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    shared_ptr<vector<DescribeDisksRequest::Filter>> filter_ {};
    ...
    shared_ptr<vector<DescribeDisksRequest::Tag>> tag_ {};
    // The zone ID.
