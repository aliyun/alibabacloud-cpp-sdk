...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyElasticityAssuranceAutoRenewAttributeRequest::PrivatePoolOptions & getPrivatePoolOptions() const { DARABONBA_PTR_GET_CONST(privatePoolOptions_, ModifyElasticityAssuranceAutoRenewAttributeRequest::PrivatePoolOptions) };
    inline ModifyElasticityAssuranceAutoRenewAttributeRequest::PrivatePoolOptions getPrivatePoolOptions() { DARABONBA_PTR_GET(privatePoolOptions_, ModifyElasticityAssuranceAutoRenewAttributeRequest::PrivatePoolOptions) };
    inline ModifyElasticityAssuranceAutoRenewAttributeRequest& setPrivatePoolOptions(const ModifyElasticityAssuranceAutoRenewAttributeRequest::PrivatePoolOptions & privatePoolOptions) { DARABONBA_PTR_SET_VALUE(privatePoolOptions_, privatePoolOptions) };
    inline ModifyElasticityAssuranceAutoRenewAttributeRequest& setPrivatePoolOptions(ModifyElasticityAssuranceAutoRenewAttributeRequest::PrivatePoolOptions && privatePoolOptions) { DARABONBA_PTR_SET_RVALUE(privatePoolOptions_, privatePoolOptions) };
  ...
  protected:
    shared_ptr<ModifyElasticityAssuranceAutoRenewAttributeRequest::PrivatePoolOptions> privatePoolOptions_ {};
