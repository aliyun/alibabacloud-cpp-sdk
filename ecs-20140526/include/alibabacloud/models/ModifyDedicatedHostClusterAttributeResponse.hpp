...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDedicatedHostClusterAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDedicatedHostClusterAttributeResponseBody) };
    inline ModifyDedicatedHostClusterAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDedicatedHostClusterAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDedicatedHostClusterAttributeResponseBody> body_ {};
  };
