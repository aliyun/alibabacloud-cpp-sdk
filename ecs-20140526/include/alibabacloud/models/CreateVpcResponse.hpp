...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVpcResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVpcResponseBody) };
    inline CreateVpcResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVpcResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVpcResponseBody> body_ {};
  };
