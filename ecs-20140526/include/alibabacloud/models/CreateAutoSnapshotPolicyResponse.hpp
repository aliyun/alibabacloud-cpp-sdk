...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAutoSnapshotPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAutoSnapshotPolicyResponseBody) };
    inline CreateAutoSnapshotPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAutoSnapshotPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAutoSnapshotPolicyResponseBody> body_ {};
  };
