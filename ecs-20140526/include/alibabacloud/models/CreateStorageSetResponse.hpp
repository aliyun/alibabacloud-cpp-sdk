...
namespace Models
{
  ...
  public:
    ...
    inline const CreateStorageSetResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateStorageSetResponseBody) };
    inline CreateStorageSetResponseBody body() { DARABONBA_PTR_GET(body_, CreateStorageSetResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateStorageSetResponseBody> body_ = nullptr;
  };
