...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->architecture_ == nullptr
        && return this->creationTime_ == nullptr && return this->description_ == nullptr && return this->diskDeviceMappings_ == nullptr && return this->imageFamily_ == nullptr && return this->imageId_ == nullptr
        && return this->imageName_ == nullptr && return this->imageOwnerAlias_ == nullptr && return this->imageVersion_ == nullptr && return this->isCopied_ == nullptr && return this->isSelfShared_ == nullptr
        && return this->isSubscribed_ == nullptr && return this->isSupportCloudinit_ == nullptr && return this->isSupportIoOptimized_ == nullptr && return this->OSName_ == nullptr && return this->OSType_ == nullptr
        && return this->platform_ == nullptr && return this->productCode_ == nullptr && return this->progress_ == nullptr && return this->size_ == nullptr && return this->status_ == nullptr
