...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeImageSupportInstanceTypesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeImageSupportInstanceTypesResponseBody) };
    inline DescribeImageSupportInstanceTypesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeImageSupportInstanceTypesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeImageSupportInstanceTypesResponseBody> body_ {};
  };
