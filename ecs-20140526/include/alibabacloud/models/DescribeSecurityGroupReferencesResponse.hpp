...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityGroupReferencesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecurityGroupReferencesResponseBody) };
    inline DescribeSecurityGroupReferencesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSecurityGroupReferencesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSecurityGroupReferencesResponseBody> body_ = nullptr;
  };
