...
namespace Models
{
  ...
  public:
    ...
    inline bool getDetailFlag() const { DARABONBA_PTR_GET_DEFAULT(detailFlag_, false) };
    ...
    inline const vector<int64_t> & getLaunchTemplateVersion() const { DARABONBA_PTR_GET_CONST(launchTemplateVersion_, vector<int64_t>) };
    inline vector<int64_t> getLaunchTemplateVersion() { DARABONBA_PTR_GET(launchTemplateVersion_, vector<int64_t>) };
    ...
    inline int64_t getMinVersion() const { DARABONBA_PTR_GET_DEFAULT(minVersion_, 0L) };
