...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePhysicalConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePhysicalConnectionResponseBody) };
    inline DeletePhysicalConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePhysicalConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePhysicalConnectionResponseBody> body_ {};
  };
