...
#ifndef ALIBABACLOUD_MODELS_CREATEAUTOPROVISIONINGGROUPSHRINKREQUESTLAUNCHCONFIGURATIONDATADISK_HPP_
#define ALIBABACLOUD_MODELS_CREATEAUTOPROVISIONINGGROUPSHRINKREQUESTLAUNCHCONFIGURATIONDATADISK_HPP_
...
namespace Models
{
  class CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& obj) { 
    ...
    CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk() = default ;
    CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk(const CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk &) = default ;
    CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk(CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk &&) = default ;
    CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk() = default ;
    CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& operator=(const CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk &) = default ;
    CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& operator=(CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk &&) = default ;
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setAutoSnapshotPolicyId(string autoSnapshotPolicyId) { DARABONBA_PTR_SET_VALUE(autoSnapshotPolicyId_, autoSnapshotPolicyId) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setBurstingEnabled(bool burstingEnabled) { DARABONBA_PTR_SET_VALUE(burstingEnabled_, burstingEnabled) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setDeleteWithInstance(bool deleteWithInstance) { DARABONBA_PTR_SET_VALUE(deleteWithInstance_, deleteWithInstance) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setDevice(string device) { DARABONBA_PTR_SET_VALUE(device_, device) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setDiskName(string diskName) { DARABONBA_PTR_SET_VALUE(diskName_, diskName) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setEncryptAlgorithm(string encryptAlgorithm) { DARABONBA_PTR_SET_VALUE(encryptAlgorithm_, encryptAlgorithm) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setEncrypted(bool encrypted) { DARABONBA_PTR_SET_VALUE(encrypted_, encrypted) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setKmsKeyId(string kmsKeyId) { DARABONBA_PTR_SET_VALUE(kmsKeyId_, kmsKeyId) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setPerformanceLevel(string performanceLevel) { DARABONBA_PTR_SET_VALUE(performanceLevel_, performanceLevel) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setProvisionedIops(int64_t provisionedIops) { DARABONBA_PTR_SET_VALUE(provisionedIops_, provisionedIops) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setSize(int32_t size) { DARABONBA_PTR_SET_VALUE(size_, size) };
    ...
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfigurationDataDisk& setSnapshotId(string snapshotId) { DARABONBA_PTR_SET_VALUE(snapshotId_, snapshotId) };
