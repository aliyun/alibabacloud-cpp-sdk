...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration & launchConfiguration() const { DARABONBA_PTR_GET_CONST(launchConfiguration_, CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration) };
    inline CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration launchConfiguration() { DARABONBA_PTR_GET(launchConfiguration_, CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration) };
    inline CreateAutoProvisioningGroupShrinkRequest& setLaunchConfiguration(const CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration & launchConfiguration) { DARABONBA_PTR_SET_VALUE(launchConfiguration_, launchConfiguration) };
    inline CreateAutoProvisioningGroupShrinkRequest& setLaunchConfiguration(CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration && launchConfiguration) { DARABONBA_PTR_SET_RVALUE(launchConfiguration_, launchConfiguration) };
    ...
    inline const vector<CreateAutoProvisioningGroupShrinkRequestDataDiskConfig> & dataDiskConfig() const { DARABONBA_PTR_GET_CONST(dataDiskConfig_, vector<CreateAutoProvisioningGroupShrinkRequestDataDiskConfig>) };
    inline vector<CreateAutoProvisioningGroupShrinkRequestDataDiskConfig> dataDiskConfig() { DARABONBA_PTR_GET(dataDiskConfig_, vector<CreateAutoProvisioningGroupShrinkRequestDataDiskConfig>) };
    inline CreateAutoProvisioningGroupShrinkRequest& setDataDiskConfig(const vector<CreateAutoProvisioningGroupShrinkRequestDataDiskConfig> & dataDiskConfig) { DARABONBA_PTR_SET_VALUE(dataDiskConfig_, dataDiskConfig) };
    inline CreateAutoProvisioningGroupShrinkRequest& setDataDiskConfig(vector<CreateAutoProvisioningGroupShrinkRequestDataDiskConfig> && dataDiskConfig) { DARABONBA_PTR_SET_RVALUE(dataDiskConfig_, dataDiskConfig) };
    ...
    inline const vector<CreateAutoProvisioningGroupShrinkRequestLaunchTemplateConfig> & launchTemplateConfig() const { DARABONBA_PTR_GET_CONST(launchTemplateConfig_, vector<CreateAutoProvisioningGroupShrinkRequestLaunchTemplateConfig>) };
    inline vector<CreateAutoProvisioningGroupShrinkRequestLaunchTemplateConfig> launchTemplateConfig() { DARABONBA_PTR_GET(launchTemplateConfig_, vector<CreateAutoProvisioningGroupShrinkRequestLaunchTemplateConfig>) };
    inline CreateAutoProvisioningGroupShrinkRequest& setLaunchTemplateConfig(const vector<CreateAutoProvisioningGroupShrinkRequestLaunchTemplateConfig> & launchTemplateConfig) { DARABONBA_PTR_SET_VALUE(launchTemplateConfig_, launchTemplateConfig) };
    inline CreateAutoProvisioningGroupShrinkRequest& setLaunchTemplateConfig(vector<CreateAutoProvisioningGroupShrinkRequestLaunchTemplateConfig> && launchTemplateConfig) { DARABONBA_PTR_SET_RVALUE(launchTemplateConfig_, launchTemplateConfig) };
    ...
    inline const CreateAutoProvisioningGroupShrinkRequestPrePaidOptions & prePaidOptions() const { DARABONBA_PTR_GET_CONST(prePaidOptions_, CreateAutoProvisioningGroupShrinkRequestPrePaidOptions) };
    inline CreateAutoProvisioningGroupShrinkRequestPrePaidOptions prePaidOptions() { DARABONBA_PTR_GET(prePaidOptions_, CreateAutoProvisioningGroupShrinkRequestPrePaidOptions) };
    inline CreateAutoProvisioningGroupShrinkRequest& setPrePaidOptions(const CreateAutoProvisioningGroupShrinkRequestPrePaidOptions & prePaidOptions) { DARABONBA_PTR_SET_VALUE(prePaidOptions_, prePaidOptions) };
    inline CreateAutoProvisioningGroupShrinkRequest& setPrePaidOptions(CreateAutoProvisioningGroupShrinkRequestPrePaidOptions && prePaidOptions) { DARABONBA_PTR_SET_RVALUE(prePaidOptions_, prePaidOptions) };
    ...
    inline string resourcePoolOptionsShrink() const { DARABONBA_PTR_GET_DEFAULT(resourcePoolOptionsShrink_, "") };
    ...
    inline const vector<CreateAutoProvisioningGroupShrinkRequestSystemDiskConfig> & systemDiskConfig() const { DARABONBA_PTR_GET_CONST(systemDiskConfig_, vector<CreateAutoProvisioningGroupShrinkRequestSystemDiskConfig>) };
    inline vector<CreateAutoProvisioningGroupShrinkRequestSystemDiskConfig> systemDiskConfig() { DARABONBA_PTR_GET(systemDiskConfig_, vector<CreateAutoProvisioningGroupShrinkRequestSystemDiskConfig>) };
    inline CreateAutoProvisioningGroupShrinkRequest& setSystemDiskConfig(const vector<CreateAutoProvisioningGroupShrinkRequestSystemDiskConfig> & systemDiskConfig) { DARABONBA_PTR_SET_VALUE(systemDiskConfig_, systemDiskConfig) };
    inline CreateAutoProvisioningGroupShrinkRequest& setSystemDiskConfig(vector<CreateAutoProvisioningGroupShrinkRequestSystemDiskConfig> && systemDiskConfig) { DARABONBA_PTR_SET_RVALUE(systemDiskConfig_, systemDiskConfig) };


    // tag Field Functions 
    bool hasTag() const { return this->tag_ != nullptr;};
    void deleteTag() { this->tag_ = nullptr;};
    inline const vector<CreateAutoProvisioningGroupShrinkRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateAutoProvisioningGroupShrinkRequestTag>) };
    inline vector<CreateAutoProvisioningGroupShrinkRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<CreateAutoProvisioningGroupShrinkRequestTag>) };
    inline CreateAutoProvisioningGroupShrinkRequest& setTag(const vector<CreateAutoProvisioningGroupShrinkRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateAutoProvisioningGroupShrinkRequest& setTag(vector<CreateAutoProvisioningGroupShrinkRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    std::shared_ptr<CreateAutoProvisioningGroupShrinkRequestLaunchConfiguration> launchConfiguration_ = nullptr;
    ...
    std::shared_ptr<vector<CreateAutoProvisioningGroupShrinkRequestDataDiskConfig>> dataDiskConfig_ = nullptr;
    ...
    std::shared_ptr<vector<CreateAutoProvisioningGroupShrinkRequestLaunchTemplateConfig>> launchTemplateConfig_ = nullptr;
    ...
    std::shared_ptr<CreateAutoProvisioningGroupShrinkRequestPrePaidOptions> prePaidOptions_ = nullptr;
    ...
    std::shared_ptr<string> resourcePoolOptionsShrink_ = nullptr;
    ...
    std::shared_ptr<vector<CreateAutoProvisioningGroupShrinkRequestSystemDiskConfig>> systemDiskConfig_ = nullptr;
    // The tags to add to the auto provisioning group.
    std::shared_ptr<vector<CreateAutoProvisioningGroupShrinkRequestTag>> tag_ = nullptr;
