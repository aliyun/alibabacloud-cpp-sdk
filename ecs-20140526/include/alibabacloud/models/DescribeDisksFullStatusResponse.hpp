...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDisksFullStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDisksFullStatusResponseBody) };
    inline DescribeDisksFullStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDisksFullStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDisksFullStatusResponseBody> body_ {};
  };
