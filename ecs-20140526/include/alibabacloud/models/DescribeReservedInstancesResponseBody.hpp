...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->reservedInstances_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const DescribeReservedInstancesResponseBodyReservedInstances & reservedInstances() const { DARABONBA_PTR_GET_CONST(reservedInstances_, DescribeReservedInstancesResponseBodyReservedInstances) };
    inline DescribeReservedInstancesResponseBodyReservedInstances reservedInstances() { DARABONBA_PTR_GET(reservedInstances_, DescribeReservedInstancesResponseBodyReservedInstances) };
    inline DescribeReservedInstancesResponseBody& setReservedInstances(const DescribeReservedInstancesResponseBodyReservedInstances & reservedInstances) { DARABONBA_PTR_SET_VALUE(reservedInstances_, reservedInstances) };
    inline DescribeReservedInstancesResponseBody& setReservedInstances(DescribeReservedInstancesResponseBodyReservedInstances && reservedInstances) { DARABONBA_PTR_SET_RVALUE(reservedInstances_, reservedInstances) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeReservedInstancesResponseBodyReservedInstances> reservedInstances_ = nullptr;
