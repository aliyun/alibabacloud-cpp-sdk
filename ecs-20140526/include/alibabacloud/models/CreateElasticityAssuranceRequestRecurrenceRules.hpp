...
#ifndef ALIBABACLOUD_MODELS_CREATEELASTICITYASSURANCEREQUESTRECURRENCERULES_HPP_
#define ALIBABACLOUD_MODELS_CREATEELASTICITYASSURANCEREQUESTRECURRENCERULES_HPP_
...
namespace Models
{
  class CreateElasticityAssuranceRequestRecurrenceRules : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateElasticityAssuranceRequestRecurrenceRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateElasticityAssuranceRequestRecurrenceRules& obj) { 
    ...
    CreateElasticityAssuranceRequestRecurrenceRules() = default ;
    CreateElasticityAssuranceRequestRecurrenceRules(const CreateElasticityAssuranceRequestRecurrenceRules &) = default ;
    CreateElasticityAssuranceRequestRecurrenceRules(CreateElasticityAssuranceRequestRecurrenceRules &&) = default ;
    CreateElasticityAssuranceRequestRecurrenceRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateElasticityAssuranceRequestRecurrenceRules() = default ;
    CreateElasticityAssuranceRequestRecurrenceRules& operator=(const CreateElasticityAssuranceRequestRecurrenceRules &) = default ;
    CreateElasticityAssuranceRequestRecurrenceRules& operator=(CreateElasticityAssuranceRequestRecurrenceRules &&) = default ;
    ...
    inline CreateElasticityAssuranceRequestRecurrenceRules& setEndHour(int32_t endHour) { DARABONBA_PTR_SET_VALUE(endHour_, endHour) };
    ...
    inline CreateElasticityAssuranceRequestRecurrenceRules& setRecurrenceType(string recurrenceType) { DARABONBA_PTR_SET_VALUE(recurrenceType_, recurrenceType) };
    ...
    inline CreateElasticityAssuranceRequestRecurrenceRules& setRecurrenceValue(string recurrenceValue) { DARABONBA_PTR_SET_VALUE(recurrenceValue_, recurrenceValue) };
    ...
    inline CreateElasticityAssuranceRequestRecurrenceRules& setStartHour(int32_t startHour) { DARABONBA_PTR_SET_VALUE(startHour_, startHour) };
