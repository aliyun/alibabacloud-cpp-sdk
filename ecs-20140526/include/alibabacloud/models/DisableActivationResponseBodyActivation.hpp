...
#ifndef ALIBABACLOUD_MODELS_DISABLEACTIVATIONRESPONSEBODYACTIVATION_HPP_
#define ALIBABACLOUD_MODELS_DISABLEACTIVATIONRESPONSEBODYACTIVATION_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DisableActivationResponseBodyActivation& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DisableActivationResponseBodyActivation& obj) { 
    ...
    DisableActivationResponseBodyActivation() = default ;
    DisableActivationResponseBodyActivation(const DisableActivationResponseBodyActivation &) = default ;
    DisableActivationResponseBodyActivation(DisableActivationResponseBodyActivation &&) = default ;
    DisableActivationResponseBodyActivation(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DisableActivationResponseBodyActivation() = default ;
    DisableActivationResponseBodyActivation& operator=(const DisableActivationResponseBodyActivation &) = default ;
    DisableActivationResponseBodyActivation& operator=(DisableActivationResponseBodyActivation &&) = default ;
    ...
    virtual bool empty() const override { return this->activationId_ == nullptr
        ...
        && return this->instanceName_ == nullptr && return this->ipAddressRange_ == nullptr && return this->registeredCount_ == nullptr && return this->timeToLiveInHours_ == nullptr; };
    ...
    inline DisableActivationResponseBodyActivation& setActivationId(string activationId) { DARABONBA_PTR_SET_VALUE(activationId_, activationId) };
    ...
    inline DisableActivationResponseBodyActivation& setCreationTime(string creationTime) { DARABONBA_PTR_SET_VALUE(creationTime_, creationTime) };
    ...
    inline DisableActivationResponseBodyActivation& setDeregisteredCount(int32_t deregisteredCount) { DARABONBA_PTR_SET_VALUE(deregisteredCount_, deregisteredCount) };
    ...
    inline DisableActivationResponseBodyActivation& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DisableActivationResponseBodyActivation& setDisabled(bool disabled) { DARABONBA_PTR_SET_VALUE(disabled_, disabled) };
    ...
    inline DisableActivationResponseBodyActivation& setInstanceCount(int32_t instanceCount) { DARABONBA_PTR_SET_VALUE(instanceCount_, instanceCount) };
    ...
    inline DisableActivationResponseBodyActivation& setInstanceName(string instanceName) { DARABONBA_PTR_SET_VALUE(instanceName_, instanceName) };
    ...
    inline DisableActivationResponseBodyActivation& setIpAddressRange(string ipAddressRange) { DARABONBA_PTR_SET_VALUE(ipAddressRange_, ipAddressRange) };
    ...
    inline DisableActivationResponseBodyActivation& setRegisteredCount(int32_t registeredCount) { DARABONBA_PTR_SET_VALUE(registeredCount_, registeredCount) };
    ...
    inline DisableActivationResponseBodyActivation& setTimeToLiveInHours(int64_t timeToLiveInHours) { DARABONBA_PTR_SET_VALUE(timeToLiveInHours_, timeToLiveInHours) };
