...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->closedReason_ == nullptr
        && return this->endTime_ == nullptr && return this->failedDetail_ == nullptr && return this->instanceId_ == nullptr && return this->startTime_ == nullptr && return this->status_ == nullptr; };
