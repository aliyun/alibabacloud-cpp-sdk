...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityGroupAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecurityGroupAttributeResponseBody) };
    inline DescribeSecurityGroupAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSecurityGroupAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSecurityGroupAttributeResponseBody> body_ {};
  };
