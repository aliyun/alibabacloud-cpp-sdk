...
namespace Models
{
  ...
  public:
    ...
    inline const CreateElasticityAssuranceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateElasticityAssuranceResponseBody) };
    inline CreateElasticityAssuranceResponseBody body() { DARABONBA_PTR_GET(body_, CreateElasticityAssuranceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateElasticityAssuranceResponseBody> body_ = nullptr;
  };
