...
namespace Models
{
  ...
  public:
    ...
    inline const Models::CreateAutoProvisioningGroupRequestLaunchConfigurationSecurityOptions & securityOptions() const { DARABONBA_PTR_GET_CONST(securityOptions_, Models::CreateAutoProvisioningGroupRequestLaunchConfigurationSecurityOptions) };
    inline Models::CreateAutoProvisioningGroupRequestLaunchConfigurationSecurityOptions securityOptions() { DARABONBA_PTR_GET(securityOptions_, Models::CreateAutoProvisioningGroupRequestLaunchConfigurationSecurityOptions) };
    inline CreateAutoProvisioningGroupRequestLaunchConfiguration& setSecurityOptions(const Models::CreateAutoProvisioningGroupRequestLaunchConfigurationSecurityOptions & securityOptions) { DARABONBA_PTR_SET_VALUE(securityOptions_, securityOptions) };
    inline CreateAutoProvisioningGroupRequestLaunchConfiguration& setSecurityOptions(Models::CreateAutoProvisioningGroupRequestLaunchConfigurationSecurityOptions && securityOptions) { DARABONBA_PTR_SET_RVALUE(securityOptions_, securityOptions) };
  ...
  protected:
    ...
    std::shared_ptr<Models::CreateAutoProvisioningGroupRequestLaunchConfigurationSecurityOptions> securityOptions_ = nullptr;
