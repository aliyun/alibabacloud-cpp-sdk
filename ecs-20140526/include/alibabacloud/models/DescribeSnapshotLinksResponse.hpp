...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSnapshotLinksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSnapshotLinksResponseBody) };
    inline DescribeSnapshotLinksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSnapshotLinksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSnapshotLinksResponseBody> body_ {};
  };
