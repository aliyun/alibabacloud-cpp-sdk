...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryConvertInstancePriceRequest::NamespaceResourceSpecs> & getNamespaceResourceSpecs() const { DARABONBA_PTR_GET_CONST(namespaceResourceSpecs_, vector<QueryConvertInstancePriceRequest::NamespaceResourceSpecs>) };
    inline vector<QueryConvertInstancePriceRequest::NamespaceResourceSpecs> getNamespaceResourceSpecs() { DARABONBA_PTR_GET(namespaceResourceSpecs_, vector<QueryConvertInstancePriceRequest::NamespaceResourceSpecs>) };
    inline QueryConvertInstancePriceRequest& setNamespaceResourceSpecs(const vector<QueryConvertInstancePriceRequest::NamespaceResourceSpecs> & namespaceResourceSpecs) { DARABONBA_PTR_SET_VALUE(namespaceResourceSpecs_, namespaceResourceSpecs) };
    inline QueryConvertInstancePriceRequest& setNamespaceResourceSpecs(vector<QueryConvertInstancePriceRequest::NamespaceResourceSpecs> && namespaceResourceSpecs) { DARABONBA_PTR_SET_RVALUE(namespaceResourceSpecs_, namespaceResourceSpecs) };
