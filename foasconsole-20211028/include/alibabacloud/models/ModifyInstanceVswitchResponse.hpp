...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyInstanceVswitchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyInstanceVswitchResponseBody) };
    inline ModifyInstanceVswitchResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyInstanceVswitchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyInstanceVswitchResponseBody> body_ {};
  };
