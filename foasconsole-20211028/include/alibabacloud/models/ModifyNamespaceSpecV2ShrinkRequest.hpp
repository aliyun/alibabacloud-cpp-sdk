...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->elasticResourceSpecShrink_ == nullptr
    ...
    inline string getElasticResourceSpecShrink() const { DARABONBA_PTR_GET_DEFAULT(elasticResourceSpecShrink_, "") };
    ...
    inline string getGuaranteedResourceSpecShrink() const { DARABONBA_PTR_GET_DEFAULT(guaranteedResourceSpecShrink_, "") };
  ...
  protected:
    shared_ptr<string> elasticResourceSpecShrink_ {};
    shared_ptr<string> guaranteedResourceSpecShrink_ {};
