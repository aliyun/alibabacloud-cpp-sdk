...
namespace Models
{
  ...
  public:
    ...
    inline const QueryModifyInstancePriceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryModifyInstancePriceResponseBody) };
    inline QueryModifyInstancePriceResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryModifyInstancePriceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryModifyInstancePriceResponseBody> body_ {};
  };
