...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeNamespacesRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<DescribeNamespacesRequest::Tags>) };
    inline vector<DescribeNamespacesRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<DescribeNamespacesRequest::Tags>) };
    inline DescribeNamespacesRequest& setTags(const vector<DescribeNamespacesRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline DescribeNamespacesRequest& setTags(vector<DescribeNamespacesRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
