...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyElasticResourceSpecRequest::ResourceSpec & getResourceSpec() const { DARABONBA_PTR_GET_CONST(resourceSpec_, ModifyElasticResourceSpecRequest::ResourceSpec) };
    inline ModifyElasticResourceSpecRequest::ResourceSpec getResourceSpec() { DARABONBA_PTR_GET(resourceSpec_, ModifyElasticResourceSpecRequest::ResourceSpec) };
    inline ModifyElasticResourceSpecRequest& setResourceSpec(const ModifyElasticResourceSpecRequest::ResourceSpec & resourceSpec) { DARABONBA_PTR_SET_VALUE(resourceSpec_, resourceSpec) };
    inline ModifyElasticResourceSpecRequest& setResourceSpec(ModifyElasticResourceSpecRequest::ResourceSpec && resourceSpec) { DARABONBA_PTR_SET_RVALUE(resourceSpec_, resourceSpec) };
