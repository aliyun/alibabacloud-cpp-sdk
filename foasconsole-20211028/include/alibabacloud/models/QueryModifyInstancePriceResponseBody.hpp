...
namespace Models
{
  ...
  public:
    ...
    inline const QueryModifyInstancePriceResponseBody::PriceInfo & getPriceInfo() const { DARABONBA_PTR_GET_CONST(priceInfo_, QueryModifyInstancePriceResponseBody::PriceInfo) };
    inline QueryModifyInstancePriceResponseBody::PriceInfo getPriceInfo() { DARABONBA_PTR_GET(priceInfo_, QueryModifyInstancePriceResponseBody::PriceInfo) };
    inline QueryModifyInstancePriceResponseBody& setPriceInfo(const QueryModifyInstancePriceResponseBody::PriceInfo & priceInfo) { DARABONBA_PTR_SET_VALUE(priceInfo_, priceInfo) };
    inline QueryModifyInstancePriceResponseBody& setPriceInfo(QueryModifyInstancePriceResponseBody::PriceInfo && priceInfo) { DARABONBA_PTR_SET_RVALUE(priceInfo_, priceInfo) };
  ...
  protected:
    shared_ptr<QueryModifyInstancePriceResponseBody::PriceInfo> priceInfo_ {};
