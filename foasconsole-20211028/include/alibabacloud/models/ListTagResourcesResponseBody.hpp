...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListTagResourcesResponseBody& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(TagReponseId, tagReponseId_);
    ...
    friend void from_json(const Darabonba::Json& j, ListTagResourcesResponseBody& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(TagReponseId, tagReponseId_);
    ...
    virtual bool empty() const override { return this->nextToken_ == nullptr
        && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->tagReponseId_ == nullptr && return this->tagResources_ == nullptr; };
    ...
    // tagReponseId Field Functions 
    bool hasTagReponseId() const { return this->tagReponseId_ != nullptr;};
    void deleteTagReponseId() { this->tagReponseId_ = nullptr;};
    inline string tagReponseId() const { DARABONBA_PTR_GET_DEFAULT(tagReponseId_, "") };
    inline ListTagResourcesResponseBody& setTagReponseId(string tagReponseId) { DARABONBA_PTR_SET_VALUE(tagReponseId_, tagReponseId) };
  ...
  protected:
    ...
    std::shared_ptr<string> tagReponseId_ = nullptr;
