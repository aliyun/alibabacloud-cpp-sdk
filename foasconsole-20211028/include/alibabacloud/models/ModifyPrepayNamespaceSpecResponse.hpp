...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyPrepayNamespaceSpecResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyPrepayNamespaceSpecResponseBody) };
    inline ModifyPrepayNamespaceSpecResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyPrepayNamespaceSpecResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyPrepayNamespaceSpecResponseBody> body_ {};
  };
