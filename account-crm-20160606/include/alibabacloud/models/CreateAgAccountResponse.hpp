...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAgAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAgAccountResponseBody) };
    inline CreateAgAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAgAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAgAccountResponseBody> body_ {};
  };
