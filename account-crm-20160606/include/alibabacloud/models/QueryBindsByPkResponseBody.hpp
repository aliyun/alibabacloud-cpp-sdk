...
#ifndef ALIBABACLOUD_MODELS_QUERYBINDSBYPKRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_QUERYBINDSBYPKRESPONSEBODY_HPP_
...
namespace Models
{
  class QueryBindsByPkResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const QueryBindsByPkResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryBindsByPkResponseBody& obj) { 
    ...
    QueryBindsByPkResponseBody() = default ;
    QueryBindsByPkResponseBody(const QueryBindsByPkResponseBody &) = default ;
    QueryBindsByPkResponseBody(QueryBindsByPkResponseBody &&) = default ;
    QueryBindsByPkResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryBindsByPkResponseBody() = default ;
    QueryBindsByPkResponseBody& operator=(const QueryBindsByPkResponseBody &) = default ;
    QueryBindsByPkResponseBody& operator=(QueryBindsByPkResponseBody &&) = default ;
    ...
    inline QueryBindsByPkResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<QueryBindsByPkResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryBindsByPkResponseBody::Data>) };
    inline vector<QueryBindsByPkResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<QueryBindsByPkResponseBody::Data>) };
    inline QueryBindsByPkResponseBody& setData(const vector<QueryBindsByPkResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryBindsByPkResponseBody& setData(vector<QueryBindsByPkResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline QueryBindsByPkResponseBody& setHttpCode(string httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline QueryBindsByPkResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline QueryBindsByPkResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline QueryBindsByPkResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<vector<QueryBindsByPkResponseBody::Data>> data_ {};
