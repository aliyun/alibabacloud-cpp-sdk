...
#ifndef ALIBABACLOUD_MODELS_MODIFYCONTACTERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYCONTACTERREQUEST_HPP_
...
namespace Models
{
  class ModifyContacterRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyContacterRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyContacterRequest& obj) { 
    ...
    ModifyContacterRequest() = default ;
    ModifyContacterRequest(const ModifyContacterRequest &) = default ;
    ModifyContacterRequest(ModifyContacterRequest &&) = default ;
    ModifyContacterRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyContacterRequest() = default ;
    ModifyContacterRequest& operator=(const ModifyContacterRequest &) = default ;
    ModifyContacterRequest& operator=(ModifyContacterRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->contacterAddress_ == nullptr
        ...
        && this->mobileConfirmed_ == nullptr && this->userId_ == nullptr; };
    ...
    inline ModifyContacterRequest& setContacterAddress(string contacterAddress) { DARABONBA_PTR_SET_VALUE(contacterAddress_, contacterAddress) };
    ...
    inline ModifyContacterRequest& setContacterDingding(string contacterDingding) { DARABONBA_PTR_SET_VALUE(contacterDingding_, contacterDingding) };
    ...
    inline ModifyContacterRequest& setContacterEmail(string contacterEmail) { DARABONBA_PTR_SET_VALUE(contacterEmail_, contacterEmail) };
    ...
    inline ModifyContacterRequest& setContacterId(int64_t contacterId) { DARABONBA_PTR_SET_VALUE(contacterId_, contacterId) };
    ...
    inline ModifyContacterRequest& setContacterMobile(string contacterMobile) { DARABONBA_PTR_SET_VALUE(contacterMobile_, contacterMobile) };
    ...
    inline ModifyContacterRequest& setContacterName(string contacterName) { DARABONBA_PTR_SET_VALUE(contacterName_, contacterName) };
    ...
    inline ModifyContacterRequest& setContacterPosition(string contacterPosition) { DARABONBA_PTR_SET_VALUE(contacterPosition_, contacterPosition) };
    ...
    inline ModifyContacterRequest& setContacterStaffNo(string contacterStaffNo) { DARABONBA_PTR_SET_VALUE(contacterStaffNo_, contacterStaffNo) };
    ...
    inline ModifyContacterRequest& setContacterType(string contacterType) { DARABONBA_PTR_SET_VALUE(contacterType_, contacterType) };
    ...
    inline ModifyContacterRequest& setContacterWangwang(string contacterWangwang) { DARABONBA_PTR_SET_VALUE(contacterWangwang_, contacterWangwang) };
    ...
    inline ModifyContacterRequest& setEmailConfirmed(bool emailConfirmed) { DARABONBA_PTR_SET_VALUE(emailConfirmed_, emailConfirmed) };
    ...
    inline ModifyContacterRequest& setMobileConfirmed(bool mobileConfirmed) { DARABONBA_PTR_SET_VALUE(mobileConfirmed_, mobileConfirmed) };
    ...
    inline ModifyContacterRequest& setUserId(int64_t userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
