...
#ifndef ALIBABACLOUD_MODELS_FINDBIZCATEGORYCONFIGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_FINDBIZCATEGORYCONFIGRESPONSEBODY_HPP_
...
namespace Models
{
  class FindBizCategoryConfigResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const FindBizCategoryConfigResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FindBizCategoryConfigResponseBody& obj) { 
    ...
    FindBizCategoryConfigResponseBody() = default ;
    FindBizCategoryConfigResponseBody(const FindBizCategoryConfigResponseBody &) = default ;
    FindBizCategoryConfigResponseBody(FindBizCategoryConfigResponseBody &&) = default ;
    FindBizCategoryConfigResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FindBizCategoryConfigResponseBody() = default ;
    FindBizCategoryConfigResponseBody& operator=(const FindBizCategoryConfigResponseBody &) = default ;
    FindBizCategoryConfigResponseBody& operator=(FindBizCategoryConfigResponseBody &&) = default ;
    ...
    void deleteCode() { this->code_ = nullptr;};
    inline string getCode() const { DARABONBA_PTR_GET_DEFAULT(code_, "") };
    inline FindBizCategoryConfigResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const FindBizCategoryConfigResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, FindBizCategoryConfigResponseBody::Data) };
    inline FindBizCategoryConfigResponseBody::Data getData() { DARABONBA_PTR_GET(data_, FindBizCategoryConfigResponseBody::Data) };
    inline FindBizCategoryConfigResponseBody& setData(const FindBizCategoryConfigResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline FindBizCategoryConfigResponseBody& setData(FindBizCategoryConfigResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline FindBizCategoryConfigResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline FindBizCategoryConfigResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline FindBizCategoryConfigResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<FindBizCategoryConfigResponseBody::Data> data_ {};
