...
#include <alibabacloud/edas_20160816.hpp>
...
using namespace Alibabacloud_Edas20160816;

Alibabacloud_Edas20160816::Client::Client(const shared_ptr<Alibabacloud_OpenApi::Config>& config) : Alibabacloud_OpenApi::Client(config) {
...
string Alibabacloud_Edas20160816::Client::getEndpoint(shared_ptr<string> productId,
...
EdasRefundResponse Alibabacloud_Edas20160816::Client::edasRefundWithOptions(shared_ptr<EdasRefundRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("EdasRefund"))},
    {"version", boost::any(string("2016-08-16"))},
  ...
  return EdasRefundResponse(callApi(params, req, runtime));
}

EdasRefundResponse Alibabacloud_Edas20160816::Client::edasRefund(shared_ptr<EdasRefundRequest> request) {
