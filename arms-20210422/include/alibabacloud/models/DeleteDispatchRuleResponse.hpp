...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDispatchRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDispatchRuleResponseBody) };
    inline DeleteDispatchRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDispatchRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDispatchRuleResponseBody> body_ {};
  };
