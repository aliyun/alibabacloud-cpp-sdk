...
namespace Models
{
  ...
  public:
    ...
    inline DeleteAlertContactGroupResponseBody& setIsSuccess(bool isSuccess) { DARABONBA_PTR_SET_VALUE(isSuccess_, isSuccess) };
    ...
    inline DeleteAlertContactGroupResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
