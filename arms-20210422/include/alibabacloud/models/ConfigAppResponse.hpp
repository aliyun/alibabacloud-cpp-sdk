...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigAppResponseBody) };
    inline ConfigAppResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigAppResponseBody> body_ {};
  };
