...
namespace Models
{
  ...
  public:
    ...
    inline const ListClusterFromGrafanaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListClusterFromGrafanaResponseBody) };
    inline ListClusterFromGrafanaResponseBody getBody() { DARABONBA_PTR_GET(body_, ListClusterFromGrafanaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListClusterFromGrafanaResponseBody> body_ {};
  };
