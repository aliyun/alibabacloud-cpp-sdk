...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAlertContactResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAlertContactResponseBody) };
    inline DeleteAlertContactResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAlertContactResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAlertContactResponseBody> body_ {};
  };
