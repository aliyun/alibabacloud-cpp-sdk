...
#ifndef ALIBABACLOUD_MODELS_LISTPROMCLUSTERSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTPROMCLUSTERSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPromClustersResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(PromClusterList, promClusterList_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ListPromClustersResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(PromClusterList, promClusterList_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ListPromClustersResponseBody() = default ;
    ListPromClustersResponseBody(const ListPromClustersResponseBody &) = default ;
    ListPromClustersResponseBody(ListPromClustersResponseBody &&) = default ;
    ListPromClustersResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPromClustersResponseBody() = default ;
    ListPromClustersResponseBody& operator=(const ListPromClustersResponseBody &) = default ;
    ListPromClustersResponseBody& operator=(ListPromClustersResponseBody &&) = default ;
    ...
    inline const vector<ListPromClustersResponseBody::PromClusterList> & getPromClusterList() const { DARABONBA_PTR_GET_CONST(promClusterList_, vector<ListPromClustersResponseBody::PromClusterList>) };
    inline vector<ListPromClustersResponseBody::PromClusterList> getPromClusterList() { DARABONBA_PTR_GET(promClusterList_, vector<ListPromClustersResponseBody::PromClusterList>) };
    inline ListPromClustersResponseBody& setPromClusterList(const vector<ListPromClustersResponseBody::PromClusterList> & promClusterList) { DARABONBA_PTR_SET_VALUE(promClusterList_, promClusterList) };
    inline ListPromClustersResponseBody& setPromClusterList(vector<ListPromClustersResponseBody::PromClusterList> && promClusterList) { DARABONBA_PTR_SET_RVALUE(promClusterList_, promClusterList) };
    ...
    inline ListPromClustersResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<vector<ListPromClustersResponseBody::PromClusterList>> promClusterList_ {};
