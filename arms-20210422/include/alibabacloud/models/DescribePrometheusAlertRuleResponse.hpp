...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePrometheusAlertRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePrometheusAlertRuleResponseBody) };
    inline DescribePrometheusAlertRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePrometheusAlertRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePrometheusAlertRuleResponseBody> body_ {};
  };
