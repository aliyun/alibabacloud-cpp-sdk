...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeLogTypeResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeLogTypeResponseBodyData>) };
    inline vector<DescribeLogTypeResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeLogTypeResponseBodyData>) };
    inline DescribeLogTypeResponseBody& setData(const vector<DescribeLogTypeResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeLogTypeResponseBody& setData(vector<DescribeLogTypeResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<DescribeLogTypeResponseBodyData>> data_ = nullptr;
