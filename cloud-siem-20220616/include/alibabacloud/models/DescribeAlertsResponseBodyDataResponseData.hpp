...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEALERTSRESPONSEBODYDATARESPONSEDATA_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEALERTSRESPONSEBODYDATARESPONSEDATA_HPP_
#include <darabonba/Core.hpp>
#include <vector>
#include <alibabacloud/models/DescribeAlertsResponseBodyDataResponseDataAlertInfoList.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeAlertsResponseBodyDataResponseData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeAlertsResponseBodyDataResponseData& obj) { 
    ...
    DescribeAlertsResponseBodyDataResponseData() = default ;
    DescribeAlertsResponseBodyDataResponseData(const DescribeAlertsResponseBodyDataResponseData &) = default ;
    DescribeAlertsResponseBodyDataResponseData(DescribeAlertsResponseBodyDataResponseData &&) = default ;
    DescribeAlertsResponseBodyDataResponseData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeAlertsResponseBodyDataResponseData() = default ;
    DescribeAlertsResponseBodyDataResponseData& operator=(const DescribeAlertsResponseBodyDataResponseData &) = default ;
    DescribeAlertsResponseBodyDataResponseData& operator=(DescribeAlertsResponseBodyDataResponseData &&) = default ;
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertDesc(string alertDesc) { DARABONBA_PTR_SET_VALUE(alertDesc_, alertDesc) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertDescCode(string alertDescCode) { DARABONBA_PTR_SET_VALUE(alertDescCode_, alertDescCode) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertDescEn(string alertDescEn) { DARABONBA_PTR_SET_VALUE(alertDescEn_, alertDescEn) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertDetail(string alertDetail) { DARABONBA_PTR_SET_VALUE(alertDetail_, alertDetail) };
    ...
    inline const vector<Models::DescribeAlertsResponseBodyDataResponseDataAlertInfoList> & alertInfoList() const { DARABONBA_PTR_GET_CONST(alertInfoList_, vector<Models::DescribeAlertsResponseBodyDataResponseDataAlertInfoList>) };
    inline vector<Models::DescribeAlertsResponseBodyDataResponseDataAlertInfoList> alertInfoList() { DARABONBA_PTR_GET(alertInfoList_, vector<Models::DescribeAlertsResponseBodyDataResponseDataAlertInfoList>) };
    inline DescribeAlertsResponseBodyDataResponseData& setAlertInfoList(const vector<Models::DescribeAlertsResponseBodyDataResponseDataAlertInfoList> & alertInfoList) { DARABONBA_PTR_SET_VALUE(alertInfoList_, alertInfoList) };
    inline DescribeAlertsResponseBodyDataResponseData& setAlertInfoList(vector<Models::DescribeAlertsResponseBodyDataResponseDataAlertInfoList> && alertInfoList) { DARABONBA_PTR_SET_RVALUE(alertInfoList_, alertInfoList) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertLevel(string alertLevel) { DARABONBA_PTR_SET_VALUE(alertLevel_, alertLevel) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertName(string alertName) { DARABONBA_PTR_SET_VALUE(alertName_, alertName) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertNameCode(string alertNameCode) { DARABONBA_PTR_SET_VALUE(alertNameCode_, alertNameCode) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertNameEn(string alertNameEn) { DARABONBA_PTR_SET_VALUE(alertNameEn_, alertNameEn) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertSrcProd(string alertSrcProd) { DARABONBA_PTR_SET_VALUE(alertSrcProd_, alertSrcProd) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertSrcProdModule(string alertSrcProdModule) { DARABONBA_PTR_SET_VALUE(alertSrcProdModule_, alertSrcProdModule) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertTitle(string alertTitle) { DARABONBA_PTR_SET_VALUE(alertTitle_, alertTitle) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertTitleEn(string alertTitleEn) { DARABONBA_PTR_SET_VALUE(alertTitleEn_, alertTitleEn) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertType(string alertType) { DARABONBA_PTR_SET_VALUE(alertType_, alertType) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertTypeCode(string alertTypeCode) { DARABONBA_PTR_SET_VALUE(alertTypeCode_, alertTypeCode) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertTypeEn(string alertTypeEn) { DARABONBA_PTR_SET_VALUE(alertTypeEn_, alertTypeEn) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAlertUuid(string alertUuid) { DARABONBA_PTR_SET_VALUE(alertUuid_, alertUuid) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAssetList(string assetList) { DARABONBA_PTR_SET_VALUE(assetList_, assetList) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setAttCk(string attCk) { DARABONBA_PTR_SET_VALUE(attCk_, attCk) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setCloudCode(string cloudCode) { DARABONBA_PTR_SET_VALUE(cloudCode_, cloudCode) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setDetectionRuleId(string detectionRuleId) { DARABONBA_PTR_SET_VALUE(detectionRuleId_, detectionRuleId) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setEntityList(string entityList) { DARABONBA_PTR_SET_VALUE(entityList_, entityList) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setExtendContent(string extendContent) { DARABONBA_PTR_SET_VALUE(extendContent_, extendContent) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setIncidentUuid(string incidentUuid) { DARABONBA_PTR_SET_VALUE(incidentUuid_, incidentUuid) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setIsDefend(string isDefend) { DARABONBA_PTR_SET_VALUE(isDefend_, isDefend) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setLogTime(string logTime) { DARABONBA_PTR_SET_VALUE(logTime_, logTime) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setLogUuid(string logUuid) { DARABONBA_PTR_SET_VALUE(logUuid_, logUuid) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setMainUserId(int64_t mainUserId) { DARABONBA_PTR_SET_VALUE(mainUserId_, mainUserId) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setOccurTime(string occurTime) { DARABONBA_PTR_SET_VALUE(occurTime_, occurTime) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setProductId(string productId) { DARABONBA_PTR_SET_VALUE(productId_, productId) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setSubUserId(int64_t subUserId) { DARABONBA_PTR_SET_VALUE(subUserId_, subUserId) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setSubUserName(string subUserName) { DARABONBA_PTR_SET_VALUE(subUserName_, subUserName) };
    ...
    inline DescribeAlertsResponseBodyDataResponseData& setVendorId(string vendorId) { DARABONBA_PTR_SET_VALUE(vendorId_, vendorId) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::DescribeAlertsResponseBodyDataResponseDataAlertInfoList>> alertInfoList_ = nullptr;
