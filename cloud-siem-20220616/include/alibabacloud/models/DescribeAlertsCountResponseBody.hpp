...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAlertsCountResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeAlertsCountResponseBodyData) };
    inline DescribeAlertsCountResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeAlertsCountResponseBodyData) };
    inline DescribeAlertsCountResponseBody& setData(const DescribeAlertsCountResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAlertsCountResponseBody& setData(DescribeAlertsCountResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeAlertsCountResponseBodyData> data_ = nullptr;
