...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomizeRuleTestResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCustomizeRuleTestResponseBodyData) };
    inline DescribeCustomizeRuleTestResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCustomizeRuleTestResponseBodyData) };
    inline DescribeCustomizeRuleTestResponseBody& setData(const DescribeCustomizeRuleTestResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCustomizeRuleTestResponseBody& setData(DescribeCustomizeRuleTestResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeCustomizeRuleTestResponseBodyData> data_ = nullptr;
