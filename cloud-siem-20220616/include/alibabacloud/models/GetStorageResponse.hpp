...
namespace Models
{
  ...
  public:
    ...
    inline const GetStorageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetStorageResponseBody) };
    inline GetStorageResponseBody getBody() { DARABONBA_PTR_GET(body_, GetStorageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetStorageResponseBody> body_ {};
  };
