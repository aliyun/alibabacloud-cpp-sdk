...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->autoSubmit_ != nullptr
    ...
    inline int32_t autoSubmit() const { DARABONBA_PTR_GET_DEFAULT(autoSubmit_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> autoSubmit_ = nullptr;
