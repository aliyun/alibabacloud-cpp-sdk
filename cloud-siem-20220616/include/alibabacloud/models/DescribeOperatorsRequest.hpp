...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEOPERATORSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEOPERATORSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeOperatorsRequest& obj) { 
      DARABONBA_PTR_TO_JSON(RegionId, regionId_);
      DARABONBA_PTR_TO_JSON(RoleFor, roleFor_);
      DARABONBA_PTR_TO_JSON(RoleType, roleType_);
      DARABONBA_PTR_TO_JSON(SceneType, sceneType_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeOperatorsRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(RegionId, regionId_);
      DARABONBA_PTR_FROM_JSON(RoleFor, roleFor_);
      DARABONBA_PTR_FROM_JSON(RoleType, roleType_);
      DARABONBA_PTR_FROM_JSON(SceneType, sceneType_);
    };
    DescribeOperatorsRequest() = default ;
    DescribeOperatorsRequest(const DescribeOperatorsRequest &) = default ;
    DescribeOperatorsRequest(DescribeOperatorsRequest &&) = default ;
    DescribeOperatorsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeOperatorsRequest() = default ;
    DescribeOperatorsRequest& operator=(const DescribeOperatorsRequest &) = default ;
    DescribeOperatorsRequest& operator=(DescribeOperatorsRequest &&) = default ;
