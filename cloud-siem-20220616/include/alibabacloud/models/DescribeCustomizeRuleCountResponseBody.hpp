...
#include <alibabacloud/models/DescribeCustomizeRuleCountResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomizeRuleCountResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCustomizeRuleCountResponseBodyData) };
    inline DescribeCustomizeRuleCountResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCustomizeRuleCountResponseBodyData) };
    inline DescribeCustomizeRuleCountResponseBody& setData(const DescribeCustomizeRuleCountResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCustomizeRuleCountResponseBody& setData(DescribeCustomizeRuleCountResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeCustomizeRuleCountResponseBodyData> data_ = nullptr;
