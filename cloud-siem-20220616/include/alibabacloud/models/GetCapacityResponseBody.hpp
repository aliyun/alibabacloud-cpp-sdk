...
namespace Models
{
  ...
  public:
    ...
    inline const GetCapacityResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetCapacityResponseBodyData) };
    inline GetCapacityResponseBodyData data() { DARABONBA_PTR_GET(data_, GetCapacityResponseBodyData) };
    inline GetCapacityResponseBody& setData(const GetCapacityResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetCapacityResponseBody& setData(GetCapacityResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetCapacityResponseBodyData> data_ = nullptr;
    // The request ID.
