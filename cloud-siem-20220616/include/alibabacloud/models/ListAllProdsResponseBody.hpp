...
namespace Models
{
  ...
  public:
    ...
    inline const ListAllProdsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAllProdsResponseBodyData) };
    inline ListAllProdsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAllProdsResponseBodyData) };
    inline ListAllProdsResponseBody& setData(const ListAllProdsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAllProdsResponseBody& setData(ListAllProdsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ListAllProdsResponseBodyData> data_ = nullptr;
    // The request ID.
