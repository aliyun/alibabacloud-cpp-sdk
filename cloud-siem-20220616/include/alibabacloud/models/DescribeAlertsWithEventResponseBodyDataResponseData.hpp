...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEALERTSWITHEVENTRESPONSEBODYDATARESPONSEDATA_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEALERTSWITHEVENTRESPONSEBODYDATARESPONSEDATA_HPP_
#include <darabonba/Core.hpp>
#include <vector>
#include <alibabacloud/models/DescribeAlertsWithEventResponseBodyDataResponseDataAlertInfoList.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeAlertsWithEventResponseBodyDataResponseData& obj) { 
    ...
    DescribeAlertsWithEventResponseBodyDataResponseData(DescribeAlertsWithEventResponseBodyDataResponseData &&) = default ;
    DescribeAlertsWithEventResponseBodyDataResponseData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeAlertsWithEventResponseBodyDataResponseData() = default ;
    DescribeAlertsWithEventResponseBodyDataResponseData& operator=(const DescribeAlertsWithEventResponseBodyDataResponseData &) = default ;
    DescribeAlertsWithEventResponseBodyDataResponseData& operator=(DescribeAlertsWithEventResponseBodyDataResponseData &&) = default ;
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertDesc(string alertDesc) { DARABONBA_PTR_SET_VALUE(alertDesc_, alertDesc) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertDescCode(string alertDescCode) { DARABONBA_PTR_SET_VALUE(alertDescCode_, alertDescCode) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertDescEn(string alertDescEn) { DARABONBA_PTR_SET_VALUE(alertDescEn_, alertDescEn) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertDetail(string alertDetail) { DARABONBA_PTR_SET_VALUE(alertDetail_, alertDetail) };
    ...
    inline const vector<Models::DescribeAlertsWithEventResponseBodyDataResponseDataAlertInfoList> & alertInfoList() const { DARABONBA_PTR_GET_CONST(alertInfoList_, vector<Models::DescribeAlertsWithEventResponseBodyDataResponseDataAlertInfoList>) };
    inline vector<Models::DescribeAlertsWithEventResponseBodyDataResponseDataAlertInfoList> alertInfoList() { DARABONBA_PTR_GET(alertInfoList_, vector<Models::DescribeAlertsWithEventResponseBodyDataResponseDataAlertInfoList>) };
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertInfoList(const vector<Models::DescribeAlertsWithEventResponseBodyDataResponseDataAlertInfoList> & alertInfoList) { DARABONBA_PTR_SET_VALUE(alertInfoList_, alertInfoList) };
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertInfoList(vector<Models::DescribeAlertsWithEventResponseBodyDataResponseDataAlertInfoList> && alertInfoList) { DARABONBA_PTR_SET_RVALUE(alertInfoList_, alertInfoList) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertLevel(string alertLevel) { DARABONBA_PTR_SET_VALUE(alertLevel_, alertLevel) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertName(string alertName) { DARABONBA_PTR_SET_VALUE(alertName_, alertName) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertNameCode(string alertNameCode) { DARABONBA_PTR_SET_VALUE(alertNameCode_, alertNameCode) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertNameEn(string alertNameEn) { DARABONBA_PTR_SET_VALUE(alertNameEn_, alertNameEn) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertSrcProd(string alertSrcProd) { DARABONBA_PTR_SET_VALUE(alertSrcProd_, alertSrcProd) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertSrcProdModule(string alertSrcProdModule) { DARABONBA_PTR_SET_VALUE(alertSrcProdModule_, alertSrcProdModule) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertTitle(string alertTitle) { DARABONBA_PTR_SET_VALUE(alertTitle_, alertTitle) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertTitleEn(string alertTitleEn) { DARABONBA_PTR_SET_VALUE(alertTitleEn_, alertTitleEn) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertType(string alertType) { DARABONBA_PTR_SET_VALUE(alertType_, alertType) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertTypeCode(string alertTypeCode) { DARABONBA_PTR_SET_VALUE(alertTypeCode_, alertTypeCode) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertTypeEn(string alertTypeEn) { DARABONBA_PTR_SET_VALUE(alertTypeEn_, alertTypeEn) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAlertUuid(string alertUuid) { DARABONBA_PTR_SET_VALUE(alertUuid_, alertUuid) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAssetList(string assetList) { DARABONBA_PTR_SET_VALUE(assetList_, assetList) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setAttCk(string attCk) { DARABONBA_PTR_SET_VALUE(attCk_, attCk) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setEntityList(string entityList) { DARABONBA_PTR_SET_VALUE(entityList_, entityList) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setExtendContent(string extendContent) { DARABONBA_PTR_SET_VALUE(extendContent_, extendContent) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setIncidentUuid(string incidentUuid) { DARABONBA_PTR_SET_VALUE(incidentUuid_, incidentUuid) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setIsDefend(string isDefend) { DARABONBA_PTR_SET_VALUE(isDefend_, isDefend) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setLogTime(string logTime) { DARABONBA_PTR_SET_VALUE(logTime_, logTime) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setLogUuid(string logUuid) { DARABONBA_PTR_SET_VALUE(logUuid_, logUuid) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setMainUserId(int64_t mainUserId) { DARABONBA_PTR_SET_VALUE(mainUserId_, mainUserId) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline DescribeAlertsWithEventResponseBodyDataResponseData& setSubUserId(int64_t subUserId) { DARABONBA_PTR_SET_VALUE(subUserId_, subUserId) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::DescribeAlertsWithEventResponseBodyDataResponseDataAlertInfoList>> alertInfoList_ = nullptr;
