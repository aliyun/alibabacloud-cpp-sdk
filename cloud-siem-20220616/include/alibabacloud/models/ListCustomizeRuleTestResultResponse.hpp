...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomizeRuleTestResultResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListCustomizeRuleTestResultResponseBody) };
    inline ListCustomizeRuleTestResultResponseBody body() { DARABONBA_PTR_GET(body_, ListCustomizeRuleTestResultResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListCustomizeRuleTestResultResponseBody> body_ = nullptr;
  };
