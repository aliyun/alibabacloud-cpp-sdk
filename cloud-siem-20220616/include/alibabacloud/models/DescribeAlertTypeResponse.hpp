...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAlertTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAlertTypeResponseBody) };
    inline DescribeAlertTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAlertTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAlertTypeResponseBody> body_ {};
  };
