...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeLogFieldsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeLogFieldsResponseBodyData>) };
    inline vector<DescribeLogFieldsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeLogFieldsResponseBodyData>) };
    inline DescribeLogFieldsResponseBody& setData(const vector<DescribeLogFieldsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeLogFieldsResponseBody& setData(vector<DescribeLogFieldsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<DescribeLogFieldsResponseBodyData>> data_ = nullptr;
