...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECLOUDSIEMEVENTSRESPONSEBODYDATARESPONSEDATA_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECLOUDSIEMEVENTSRESPONSEBODYDATARESPONSEDATA_HPP_
#include <darabonba/Core.hpp>
#include <vector>
#include <alibabacloud/models/DescribeCloudSiemEventsResponseBodyDataResponseDataAttckStages.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCloudSiemEventsResponseBodyDataResponseData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeCloudSiemEventsResponseBodyDataResponseData& obj) { 
    ...
    DescribeCloudSiemEventsResponseBodyDataResponseData() = default ;
    DescribeCloudSiemEventsResponseBodyDataResponseData(const DescribeCloudSiemEventsResponseBodyDataResponseData &) = default ;
    DescribeCloudSiemEventsResponseBodyDataResponseData(DescribeCloudSiemEventsResponseBodyDataResponseData &&) = default ;
    DescribeCloudSiemEventsResponseBodyDataResponseData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCloudSiemEventsResponseBodyDataResponseData() = default ;
    DescribeCloudSiemEventsResponseBodyDataResponseData& operator=(const DescribeCloudSiemEventsResponseBodyDataResponseData &) = default ;
    DescribeCloudSiemEventsResponseBodyDataResponseData& operator=(DescribeCloudSiemEventsResponseBodyDataResponseData &&) = default ;
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setAlertNum(int32_t alertNum) { DARABONBA_PTR_SET_VALUE(alertNum_, alertNum) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setAliuid(int64_t aliuid) { DARABONBA_PTR_SET_VALUE(aliuid_, aliuid) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setAssetNum(int32_t assetNum) { DARABONBA_PTR_SET_VALUE(assetNum_, assetNum) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setAttCkLabels(const vector<string> & attCkLabels) { DARABONBA_PTR_SET_VALUE(attCkLabels_, attCkLabels) };
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setAttCkLabels(vector<string> && attCkLabels) { DARABONBA_PTR_SET_RVALUE(attCkLabels_, attCkLabels) };
    ...
    inline const vector<Models::DescribeCloudSiemEventsResponseBodyDataResponseDataAttckStages> & attckStages() const { DARABONBA_PTR_GET_CONST(attckStages_, vector<Models::DescribeCloudSiemEventsResponseBodyDataResponseDataAttckStages>) };
    inline vector<Models::DescribeCloudSiemEventsResponseBodyDataResponseDataAttckStages> attckStages() { DARABONBA_PTR_GET(attckStages_, vector<Models::DescribeCloudSiemEventsResponseBodyDataResponseDataAttckStages>) };
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setAttckStages(const vector<Models::DescribeCloudSiemEventsResponseBodyDataResponseDataAttckStages> & attckStages) { DARABONBA_PTR_SET_VALUE(attckStages_, attckStages) };
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setAttckStages(vector<Models::DescribeCloudSiemEventsResponseBodyDataResponseDataAttckStages> && attckStages) { DARABONBA_PTR_SET_RVALUE(attckStages_, attckStages) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setDataSources(const vector<string> & dataSources) { DARABONBA_PTR_SET_VALUE(dataSources_, dataSources) };
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setDataSources(vector<string> && dataSources) { DARABONBA_PTR_SET_RVALUE(dataSources_, dataSources) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setDescriptionEn(string descriptionEn) { DARABONBA_PTR_SET_VALUE(descriptionEn_, descriptionEn) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setExtContent(string extContent) { DARABONBA_PTR_SET_VALUE(extContent_, extContent) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setIncidentName(string incidentName) { DARABONBA_PTR_SET_VALUE(incidentName_, incidentName) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setIncidentNameEn(string incidentNameEn) { DARABONBA_PTR_SET_VALUE(incidentNameEn_, incidentNameEn) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setIncidentType(string incidentType) { DARABONBA_PTR_SET_VALUE(incidentType_, incidentType) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setIncidentUuid(string incidentUuid) { DARABONBA_PTR_SET_VALUE(incidentUuid_, incidentUuid) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setReferAccount(string referAccount) { DARABONBA_PTR_SET_VALUE(referAccount_, referAccount) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setRuleId(string ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setThreatLevel(string threatLevel) { DARABONBA_PTR_SET_VALUE(threatLevel_, threatLevel) };
    ...
    inline DescribeCloudSiemEventsResponseBodyDataResponseData& setThreatScore(float threatScore) { DARABONBA_PTR_SET_VALUE(threatScore_, threatScore) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::DescribeCloudSiemEventsResponseBodyDataResponseDataAttckStages>> attckStages_ = nullptr;
