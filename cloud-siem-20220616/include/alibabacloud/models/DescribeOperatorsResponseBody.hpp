...
#include <vector>
#include <alibabacloud/models/DescribeOperatorsResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeOperatorsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeOperatorsResponseBodyData>) };
    inline vector<DescribeOperatorsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeOperatorsResponseBodyData>) };
    inline DescribeOperatorsResponseBody& setData(const vector<DescribeOperatorsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeOperatorsResponseBody& setData(vector<DescribeOperatorsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<DescribeOperatorsResponseBodyData>> data_ = nullptr;
