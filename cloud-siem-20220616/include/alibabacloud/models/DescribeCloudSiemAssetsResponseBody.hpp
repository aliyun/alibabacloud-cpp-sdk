...
#include <alibabacloud/models/DescribeCloudSiemAssetsResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudSiemAssetsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCloudSiemAssetsResponseBodyData) };
    inline DescribeCloudSiemAssetsResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCloudSiemAssetsResponseBodyData) };
    inline DescribeCloudSiemAssetsResponseBody& setData(const DescribeCloudSiemAssetsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCloudSiemAssetsResponseBody& setData(DescribeCloudSiemAssetsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeCloudSiemAssetsResponseBodyData> data_ = nullptr;
