...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeWafScopeResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeWafScopeResponseBodyData>) };
    inline vector<DescribeWafScopeResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeWafScopeResponseBodyData>) };
    inline DescribeWafScopeResponseBody& setData(const vector<DescribeWafScopeResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeWafScopeResponseBody& setData(vector<DescribeWafScopeResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<DescribeWafScopeResponseBodyData>> data_ = nullptr;
