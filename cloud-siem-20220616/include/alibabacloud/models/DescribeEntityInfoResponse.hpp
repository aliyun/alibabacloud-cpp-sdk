...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEntityInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEntityInfoResponseBody) };
    inline DescribeEntityInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEntityInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEntityInfoResponseBody> body_ {};
  };
