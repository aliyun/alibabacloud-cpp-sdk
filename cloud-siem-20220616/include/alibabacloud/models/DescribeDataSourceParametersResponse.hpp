...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataSourceParametersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDataSourceParametersResponseBody) };
    inline DescribeDataSourceParametersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDataSourceParametersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDataSourceParametersResponseBody> body_ {};
  };
