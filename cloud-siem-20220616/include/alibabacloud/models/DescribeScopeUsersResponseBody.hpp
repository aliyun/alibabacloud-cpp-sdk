...
#include <vector>
#include <alibabacloud/models/DescribeScopeUsersResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeScopeUsersResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeScopeUsersResponseBodyData>) };
    inline vector<DescribeScopeUsersResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeScopeUsersResponseBodyData>) };
    inline DescribeScopeUsersResponseBody& setData(const vector<DescribeScopeUsersResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeScopeUsersResponseBody& setData(vector<DescribeScopeUsersResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<DescribeScopeUsersResponseBodyData>> data_ = nullptr;
