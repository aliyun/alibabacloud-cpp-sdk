...
namespace Models
{
  ...
  public:
    ...
    inline const ListBindDataSourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListBindDataSourcesResponseBody) };
    inline ListBindDataSourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListBindDataSourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListBindDataSourcesResponseBody> body_ {};
  };
