...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomizeRuleTestResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCustomizeRuleTestResultResponseBodyData) };
    inline ListCustomizeRuleTestResultResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCustomizeRuleTestResultResponseBodyData) };
    inline ListCustomizeRuleTestResultResponseBody& setData(const ListCustomizeRuleTestResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCustomizeRuleTestResultResponseBody& setData(ListCustomizeRuleTestResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListCustomizeRuleTestResultResponseBodyData> data_ = nullptr;
