...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->eventNum_ != nullptr
        && this->highLevelEventNum_ != nullptr && this->infoLevelEventNum_ != nullptr && this->lowLevelEventNum_ != nullptr && this->mediumLevelEventNum_ != nullptr && this->seriousLevelEventNum_ != nullptr
        && this->undealEventNum_ != nullptr; };
    ...
    inline int64_t infoLevelEventNum() const { DARABONBA_PTR_GET_DEFAULT(infoLevelEventNum_, 0L) };
    inline DescribeEventCountByThreatLevelResponseBodyData& setInfoLevelEventNum(int64_t infoLevelEventNum) { DARABONBA_PTR_SET_VALUE(infoLevelEventNum_, infoLevelEventNum) };
    ...
    inline int64_t seriousLevelEventNum() const { DARABONBA_PTR_GET_DEFAULT(seriousLevelEventNum_, 0L) };
    inline DescribeEventCountByThreatLevelResponseBodyData& setSeriousLevelEventNum(int64_t seriousLevelEventNum) { DARABONBA_PTR_SET_VALUE(seriousLevelEventNum_, seriousLevelEventNum) };
