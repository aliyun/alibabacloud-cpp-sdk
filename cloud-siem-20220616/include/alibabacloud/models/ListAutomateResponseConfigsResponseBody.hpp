...
#include <alibabacloud/models/ListAutomateResponseConfigsResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const ListAutomateResponseConfigsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAutomateResponseConfigsResponseBodyData) };
    inline ListAutomateResponseConfigsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAutomateResponseConfigsResponseBodyData) };
    inline ListAutomateResponseConfigsResponseBody& setData(const ListAutomateResponseConfigsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAutomateResponseConfigsResponseBody& setData(ListAutomateResponseConfigsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListAutomateResponseConfigsResponseBodyData> data_ = nullptr;
