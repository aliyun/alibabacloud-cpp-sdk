...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDisposeStrategyPlaybookResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeDisposeStrategyPlaybookResponseBodyData>) };
    inline vector<DescribeDisposeStrategyPlaybookResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeDisposeStrategyPlaybookResponseBodyData>) };
    inline DescribeDisposeStrategyPlaybookResponseBody& setData(const vector<DescribeDisposeStrategyPlaybookResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDisposeStrategyPlaybookResponseBody& setData(vector<DescribeDisposeStrategyPlaybookResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<DescribeDisposeStrategyPlaybookResponseBodyData>> data_ = nullptr;
