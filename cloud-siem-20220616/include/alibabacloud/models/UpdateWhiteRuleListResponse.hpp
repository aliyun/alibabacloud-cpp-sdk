...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWhiteRuleListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateWhiteRuleListResponseBody) };
    inline UpdateWhiteRuleListResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateWhiteRuleListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateWhiteRuleListResponseBody> body_ {};
  };
