...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAlertSourceWithEventResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeAlertSourceWithEventResponseBodyData>) };
    inline vector<DescribeAlertSourceWithEventResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeAlertSourceWithEventResponseBodyData>) };
    inline DescribeAlertSourceWithEventResponseBody& setData(const vector<DescribeAlertSourceWithEventResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAlertSourceWithEventResponseBody& setData(vector<DescribeAlertSourceWithEventResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<DescribeAlertSourceWithEventResponseBodyData>> data_ = nullptr;
