...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAggregateFunctionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAggregateFunctionResponseBody) };
    inline DescribeAggregateFunctionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAggregateFunctionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAggregateFunctionResponseBody> body_ {};
  };
