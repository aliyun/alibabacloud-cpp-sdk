...
#ifndef ALIBABACLOUD_MODELS_MODIFYDATASOURCELOGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYDATASOURCELOGREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyDataSourceLogRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyDataSourceLogRequest& obj) { 
    ...
    ModifyDataSourceLogRequest() = default ;
    ModifyDataSourceLogRequest(const ModifyDataSourceLogRequest &) = default ;
    ModifyDataSourceLogRequest(ModifyDataSourceLogRequest &&) = default ;
    ModifyDataSourceLogRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyDataSourceLogRequest() = default ;
    ModifyDataSourceLogRequest& operator=(const ModifyDataSourceLogRequest &) = default ;
    ModifyDataSourceLogRequest& operator=(ModifyDataSourceLogRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->accountId_ == nullptr
        && this->cloudCode_ == nullptr && this->dataSourceInstanceId_ == nullptr && this->dataSourceInstanceLogs_ == nullptr && this->dataSourceType_ == nullptr && this->logCode_ == nullptr
        && this->logInstanceId_ == nullptr && this->regionId_ == nullptr; };
    // accountId Field Functions 
    bool hasAccountId() const { return this->accountId_ != nullptr;};
    void deleteAccountId() { this->accountId_ = nullptr;};
    inline string getAccountId() const { DARABONBA_PTR_GET_DEFAULT(accountId_, "") };
    inline ModifyDataSourceLogRequest& setAccountId(string accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline ModifyDataSourceLogRequest& setCloudCode(string cloudCode) { DARABONBA_PTR_SET_VALUE(cloudCode_, cloudCode) };
    ...
    inline ModifyDataSourceLogRequest& setDataSourceInstanceId(string dataSourceInstanceId) { DARABONBA_PTR_SET_VALUE(dataSourceInstanceId_, dataSourceInstanceId) };
    ...
    inline ModifyDataSourceLogRequest& setDataSourceInstanceLogs(string dataSourceInstanceLogs) { DARABONBA_PTR_SET_VALUE(dataSourceInstanceLogs_, dataSourceInstanceLogs) };
    ...
    inline ModifyDataSourceLogRequest& setDataSourceType(string dataSourceType) { DARABONBA_PTR_SET_VALUE(dataSourceType_, dataSourceType) };
    ...
    inline ModifyDataSourceLogRequest& setLogCode(string logCode) { DARABONBA_PTR_SET_VALUE(logCode_, logCode) };
    ...
    inline ModifyDataSourceLogRequest& setLogInstanceId(string logInstanceId) { DARABONBA_PTR_SET_VALUE(logInstanceId_, logInstanceId) };
    ...
    inline ModifyDataSourceLogRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
