...
namespace Models
{
  ...
  public:
    ...
    inline const ListRdUsersResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListRdUsersResponseBody) };
    inline ListRdUsersResponseBody body() { DARABONBA_PTR_GET(body_, ListRdUsersResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListRdUsersResponseBody> body_ = nullptr;
  };
