...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDataSourceParametersResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeDataSourceParametersResponseBodyData>) };
    inline vector<DescribeDataSourceParametersResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeDataSourceParametersResponseBodyData>) };
    inline DescribeDataSourceParametersResponseBody& setData(const vector<DescribeDataSourceParametersResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDataSourceParametersResponseBody& setData(vector<DescribeDataSourceParametersResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<vector<DescribeDataSourceParametersResponseBodyData>> data_ = nullptr;
    // The request ID.
