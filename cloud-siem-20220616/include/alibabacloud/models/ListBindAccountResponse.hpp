...
namespace Models
{
  ...
  public:
    ...
    inline const ListBindAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListBindAccountResponseBody) };
    inline ListBindAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, ListBindAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListBindAccountResponseBody> body_ {};
  };
