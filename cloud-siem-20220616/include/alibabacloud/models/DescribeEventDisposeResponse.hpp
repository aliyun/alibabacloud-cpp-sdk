...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventDisposeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEventDisposeResponseBody) };
    inline DescribeEventDisposeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEventDisposeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEventDisposeResponseBody> body_ {};
  };
