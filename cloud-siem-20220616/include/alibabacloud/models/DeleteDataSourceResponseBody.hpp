...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDataSourceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteDataSourceResponseBody::Data) };
    inline DeleteDataSourceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteDataSourceResponseBody::Data) };
    inline DeleteDataSourceResponseBody& setData(const DeleteDataSourceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteDataSourceResponseBody& setData(DeleteDataSourceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
