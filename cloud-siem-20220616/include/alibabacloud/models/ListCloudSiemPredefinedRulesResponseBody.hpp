...
#include <alibabacloud/models/ListCloudSiemPredefinedRulesResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const ListCloudSiemPredefinedRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCloudSiemPredefinedRulesResponseBodyData) };
    inline ListCloudSiemPredefinedRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCloudSiemPredefinedRulesResponseBodyData) };
    inline ListCloudSiemPredefinedRulesResponseBody& setData(const ListCloudSiemPredefinedRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCloudSiemPredefinedRulesResponseBody& setData(ListCloudSiemPredefinedRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListCloudSiemPredefinedRulesResponseBodyData> data_ = nullptr;
