...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEntityInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEntityInfoResponseBodyData) };
    inline DescribeEntityInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEntityInfoResponseBodyData) };
    inline DescribeEntityInfoResponseBody& setData(const DescribeEntityInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEntityInfoResponseBody& setData(DescribeEntityInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeEntityInfoResponseBodyData> data_ = nullptr;
