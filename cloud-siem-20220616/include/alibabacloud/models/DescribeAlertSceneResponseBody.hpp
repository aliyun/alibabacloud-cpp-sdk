...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAlertSceneResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeAlertSceneResponseBody::Data>) };
    inline vector<DescribeAlertSceneResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<DescribeAlertSceneResponseBody::Data>) };
    inline DescribeAlertSceneResponseBody& setData(const vector<DescribeAlertSceneResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAlertSceneResponseBody& setData(vector<DescribeAlertSceneResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
