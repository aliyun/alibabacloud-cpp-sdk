...
#include <vector>
#include <alibabacloud/models/DescribeAlertSourceResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAlertSourceResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeAlertSourceResponseBodyData>) };
    inline vector<DescribeAlertSourceResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeAlertSourceResponseBodyData>) };
    inline DescribeAlertSourceResponseBody& setData(const vector<DescribeAlertSourceResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAlertSourceResponseBody& setData(vector<DescribeAlertSourceResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<DescribeAlertSourceResponseBodyData>> data_ = nullptr;
