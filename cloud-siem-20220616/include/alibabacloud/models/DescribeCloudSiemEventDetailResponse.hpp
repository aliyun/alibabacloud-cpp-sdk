...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudSiemEventDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudSiemEventDetailResponseBody) };
    inline DescribeCloudSiemEventDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCloudSiemEventDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudSiemEventDetailResponseBody> body_ {};
  };
