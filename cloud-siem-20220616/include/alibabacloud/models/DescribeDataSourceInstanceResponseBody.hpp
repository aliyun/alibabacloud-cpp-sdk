...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataSourceInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDataSourceInstanceResponseBodyData) };
    inline DescribeDataSourceInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDataSourceInstanceResponseBodyData) };
    inline DescribeDataSourceInstanceResponseBody& setData(const DescribeDataSourceInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDataSourceInstanceResponseBody& setData(DescribeDataSourceInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeDataSourceInstanceResponseBodyData> data_ = nullptr;
    // The request ID.
