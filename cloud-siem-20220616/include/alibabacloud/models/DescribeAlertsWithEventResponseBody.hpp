...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAlertsWithEventResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeAlertsWithEventResponseBody::Data) };
    inline DescribeAlertsWithEventResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeAlertsWithEventResponseBody::Data) };
    inline DescribeAlertsWithEventResponseBody& setData(const DescribeAlertsWithEventResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAlertsWithEventResponseBody& setData(DescribeAlertsWithEventResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
