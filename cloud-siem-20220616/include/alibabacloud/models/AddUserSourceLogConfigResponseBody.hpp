...
#include <alibabacloud/models/AddUserSourceLogConfigResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const AddUserSourceLogConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddUserSourceLogConfigResponseBodyData) };
    inline AddUserSourceLogConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, AddUserSourceLogConfigResponseBodyData) };
    inline AddUserSourceLogConfigResponseBody& setData(const AddUserSourceLogConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddUserSourceLogConfigResponseBody& setData(AddUserSourceLogConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<AddUserSourceLogConfigResponseBodyData> data_ = nullptr;
    // The request ID.
