...
namespace Models
{
  ...
  public:
    ...
    inline const PostCustomizeRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, PostCustomizeRuleResponseBodyData) };
    inline PostCustomizeRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, PostCustomizeRuleResponseBodyData) };
    inline PostCustomizeRuleResponseBody& setData(const PostCustomizeRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline PostCustomizeRuleResponseBody& setData(PostCustomizeRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<PostCustomizeRuleResponseBodyData> data_ = nullptr;
