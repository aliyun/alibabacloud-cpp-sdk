...
namespace Models
{
  ...
  public:
    ...
    inline string getDisPlayLine() const { DARABONBA_PTR_GET_DEFAULT(disPlayLine_, "") };
    ...
    inline string getSourceLogInfo() const { DARABONBA_PTR_GET_DEFAULT(sourceLogInfo_, "") };
