...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWhiteRuleListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWhiteRuleListResponseBody) };
    inline DeleteWhiteRuleListResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWhiteRuleListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWhiteRuleListResponseBody> body_ {};
  };
