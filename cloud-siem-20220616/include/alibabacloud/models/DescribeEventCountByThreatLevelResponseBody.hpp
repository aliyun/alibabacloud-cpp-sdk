...
#include <alibabacloud/models/DescribeEventCountByThreatLevelResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventCountByThreatLevelResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEventCountByThreatLevelResponseBodyData) };
    inline DescribeEventCountByThreatLevelResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEventCountByThreatLevelResponseBodyData) };
    inline DescribeEventCountByThreatLevelResponseBody& setData(const DescribeEventCountByThreatLevelResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEventCountByThreatLevelResponseBody& setData(DescribeEventCountByThreatLevelResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeEventCountByThreatLevelResponseBodyData> data_ = nullptr;
