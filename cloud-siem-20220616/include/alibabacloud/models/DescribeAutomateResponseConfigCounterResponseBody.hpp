...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutomateResponseConfigCounterResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeAutomateResponseConfigCounterResponseBodyData) };
    inline DescribeAutomateResponseConfigCounterResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeAutomateResponseConfigCounterResponseBodyData) };
    inline DescribeAutomateResponseConfigCounterResponseBody& setData(const DescribeAutomateResponseConfigCounterResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAutomateResponseConfigCounterResponseBody& setData(DescribeAutomateResponseConfigCounterResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeAutomateResponseConfigCounterResponseBodyData> data_ = nullptr;
