...
namespace Models
{
  ...
  public:
    ...
    inline string accounts() const { DARABONBA_PTR_GET_DEFAULT(accounts_, "") };
    ...
    inline string logCodes() const { DARABONBA_PTR_GET_DEFAULT(logCodes_, "") };
  ...
  protected:
    ...
    //     *   0: no
    //     *   1: yes
    std::shared_ptr<string> accounts_ = nullptr;
    ...
    std::shared_ptr<string> logCodes_ = nullptr;
