...
namespace Models
{
  ...
  public:
    ...
    inline string dataSourceInstanceParams() const { DARABONBA_PTR_GET_DEFAULT(dataSourceInstanceParams_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> dataSourceInstanceParams_ = nullptr;
