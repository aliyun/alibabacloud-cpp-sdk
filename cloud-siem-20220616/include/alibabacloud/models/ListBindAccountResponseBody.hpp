...
#include <vector>
#include <alibabacloud/models/ListBindAccountResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListBindAccountResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListBindAccountResponseBodyData>) };
    inline vector<ListBindAccountResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListBindAccountResponseBodyData>) };
    inline ListBindAccountResponseBody& setData(const vector<ListBindAccountResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListBindAccountResponseBody& setData(vector<ListBindAccountResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<vector<ListBindAccountResponseBodyData>> data_ = nullptr;
    // The request ID.
