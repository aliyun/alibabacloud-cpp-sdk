...
namespace Models
{
  ...
  public:
    ...
    inline const ListEntitiesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListEntitiesResponseBody) };
    inline ListEntitiesResponseBody body() { DARABONBA_PTR_GET(body_, ListEntitiesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListEntitiesResponseBody> body_ = nullptr;
  };
