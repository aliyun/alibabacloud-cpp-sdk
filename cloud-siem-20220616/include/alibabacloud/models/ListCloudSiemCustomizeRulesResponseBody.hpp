...
namespace Models
{
  ...
  public:
    ...
    inline const ListCloudSiemCustomizeRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCloudSiemCustomizeRulesResponseBodyData) };
    inline ListCloudSiemCustomizeRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCloudSiemCustomizeRulesResponseBodyData) };
    inline ListCloudSiemCustomizeRulesResponseBody& setData(const ListCloudSiemCustomizeRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCloudSiemCustomizeRulesResponseBody& setData(ListCloudSiemCustomizeRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListCloudSiemCustomizeRulesResponseBodyData> data_ = nullptr;
