...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDataSourceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyDataSourceResponseBody::Data) };
    inline ModifyDataSourceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyDataSourceResponseBody::Data) };
    inline ModifyDataSourceResponseBody& setData(const ModifyDataSourceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyDataSourceResponseBody& setData(ModifyDataSourceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    shared_ptr<ModifyDataSourceResponseBody::Data> data_ {};
    // The request ID.
