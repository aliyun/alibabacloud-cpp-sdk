...
namespace Models
{
  ...
  public:
    ...
    inline const ListAutomateResponseConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAutomateResponseConfigsResponseBody) };
    inline ListAutomateResponseConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAutomateResponseConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAutomateResponseConfigsResponseBody> body_ {};
  };
