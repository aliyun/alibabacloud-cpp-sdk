...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAlertsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAlertsResponseBody) };
    inline DescribeAlertsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAlertsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAlertsResponseBody> body_ {};
  };
