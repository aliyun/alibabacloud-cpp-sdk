...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeProdCountResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeProdCountResponseBodyData) };
    inline DescribeProdCountResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeProdCountResponseBodyData) };
    inline DescribeProdCountResponseBody& setData(const DescribeProdCountResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeProdCountResponseBody& setData(DescribeProdCountResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeProdCountResponseBodyData> data_ = nullptr;
    // The request ID.
