...
#include <alibabacloud/models/ModifyBindAccountResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBindAccountResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ModifyBindAccountResponseBodyData) };
    inline ModifyBindAccountResponseBodyData data() { DARABONBA_PTR_GET(data_, ModifyBindAccountResponseBodyData) };
    inline ModifyBindAccountResponseBody& setData(const ModifyBindAccountResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyBindAccountResponseBody& setData(ModifyBindAccountResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<ModifyBindAccountResponseBodyData> data_ = nullptr;
    // The request ID.
