...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeProdCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeProdCountResponseBody) };
    inline DescribeProdCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeProdCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeProdCountResponseBody> body_ {};
  };
