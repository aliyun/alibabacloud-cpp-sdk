...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudSiemAssetsCounterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudSiemAssetsCounterResponseBody) };
    inline DescribeCloudSiemAssetsCounterResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCloudSiemAssetsCounterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCloudSiemAssetsCounterResponseBody> body_ {};
  };
