...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alertUuid_ == nullptr
        ...
        && this->entityUuidList_ == nullptr && this->groupBy_ == nullptr && this->groupKey_ == nullptr && this->incidentUuid_ == nullptr && this->maxResults_ == nullptr
    ...
    inline ListDisposeStrategyRequest& setAlertUuid(string alertUuid) { DARABONBA_PTR_SET_VALUE(alertUuid_, alertUuid) };
    ...
    inline ListDisposeStrategyRequest& setEntityUuidList(const vector<string> & entityUuidList) { DARABONBA_PTR_SET_VALUE(entityUuidList_, entityUuidList) };
    inline ListDisposeStrategyRequest& setEntityUuidList(vector<string> && entityUuidList) { DARABONBA_PTR_SET_RVALUE(entityUuidList_, entityUuidList) };
    ...
    inline ListDisposeStrategyRequest& setGroupBy(string groupBy) { DARABONBA_PTR_SET_VALUE(groupBy_, groupBy) };
    ...
    inline ListDisposeStrategyRequest& setGroupKey(string groupKey) { DARABONBA_PTR_SET_VALUE(groupKey_, groupKey) };
    ...
    inline ListDisposeStrategyRequest& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListDisposeStrategyRequest& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListDisposeStrategyRequest& setQueryMode(string queryMode) { DARABONBA_PTR_SET_VALUE(queryMode_, queryMode) };
    ...
    inline ListDisposeStrategyRequest& setResponseRuleId(string responseRuleId) { DARABONBA_PTR_SET_VALUE(responseRuleId_, responseRuleId) };
    ...
    inline ListDisposeStrategyRequest& setStrategyId(string strategyId) { DARABONBA_PTR_SET_VALUE(strategyId_, strategyId) };
