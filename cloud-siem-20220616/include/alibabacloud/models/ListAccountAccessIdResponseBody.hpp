...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAccountAccessIdResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAccountAccessIdResponseBodyData>) };
    inline vector<ListAccountAccessIdResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListAccountAccessIdResponseBodyData>) };
    inline ListAccountAccessIdResponseBody& setData(const vector<ListAccountAccessIdResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAccountAccessIdResponseBody& setData(vector<ListAccountAccessIdResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<ListAccountAccessIdResponseBodyData>> data_ = nullptr;
