...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAlertSourceWithEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAlertSourceWithEventResponseBody) };
    inline DescribeAlertSourceWithEventResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAlertSourceWithEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAlertSourceWithEventResponseBody> body_ {};
  };
