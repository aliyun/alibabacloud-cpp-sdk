...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEALERTSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEALERTSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeAlertsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeAlertsResponseBody& obj) { 
    ...
    DescribeAlertsResponseBody() = default ;
    DescribeAlertsResponseBody(const DescribeAlertsResponseBody &) = default ;
    DescribeAlertsResponseBody(DescribeAlertsResponseBody &&) = default ;
    DescribeAlertsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeAlertsResponseBody() = default ;
    DescribeAlertsResponseBody& operator=(const DescribeAlertsResponseBody &) = default ;
    DescribeAlertsResponseBody& operator=(DescribeAlertsResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline ResponseData& setExtendContent(string extendContent) { DARABONBA_PTR_SET_VALUE(extendContent_, extendContent) };
    ...
    inline DescribeAlertsResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const DescribeAlertsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeAlertsResponseBody::Data) };
    inline DescribeAlertsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeAlertsResponseBody::Data) };
    inline DescribeAlertsResponseBody& setData(const DescribeAlertsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAlertsResponseBody& setData(DescribeAlertsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeAlertsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DescribeAlertsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeAlertsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
