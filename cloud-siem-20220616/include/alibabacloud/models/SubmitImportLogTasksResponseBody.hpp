...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitImportLogTasksResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SubmitImportLogTasksResponseBodyData) };
    inline SubmitImportLogTasksResponseBodyData data() { DARABONBA_PTR_GET(data_, SubmitImportLogTasksResponseBodyData) };
    inline SubmitImportLogTasksResponseBody& setData(const SubmitImportLogTasksResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitImportLogTasksResponseBody& setData(SubmitImportLogTasksResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<SubmitImportLogTasksResponseBodyData> data_ = nullptr;
    // The request ID.
