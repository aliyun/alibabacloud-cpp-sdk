...
#include <alibabacloud/models/DescribeEventDisposeResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventDisposeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEventDisposeResponseBodyData) };
    inline DescribeEventDisposeResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEventDisposeResponseBodyData) };
    inline DescribeEventDisposeResponseBody& setData(const DescribeEventDisposeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEventDisposeResponseBody& setData(DescribeEventDisposeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeEventDisposeResponseBodyData> data_ = nullptr;
