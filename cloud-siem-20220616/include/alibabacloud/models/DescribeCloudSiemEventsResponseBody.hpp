  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline ResponseData& setAssetNum(int32_t assetNum) { DARABONBA_PTR_SET_VALUE(assetNum_, assetNum) };
        ...
        inline ResponseData& setAttCkLabels(const vector<string> & attCkLabels) { DARABONBA_PTR_SET_VALUE(attCkLabels_, attCkLabels) };
        inline ResponseData& setAttCkLabels(vector<string> && attCkLabels) { DARABONBA_PTR_SET_RVALUE(attCkLabels_, attCkLabels) };
        ...
        inline const vector<ResponseData::AttckStages> & getAttckStages() const { DARABONBA_PTR_GET_CONST(attckStages_, vector<ResponseData::AttckStages>) };
        inline vector<ResponseData::AttckStages> getAttckStages() { DARABONBA_PTR_GET(attckStages_, vector<ResponseData::AttckStages>) };
        inline ResponseData& setAttckStages(const vector<ResponseData::AttckStages> & attckStages) { DARABONBA_PTR_SET_VALUE(attckStages_, attckStages) };
        inline ResponseData& setAttckStages(vector<ResponseData::AttckStages> && attckStages) { DARABONBA_PTR_SET_RVALUE(attckStages_, attckStages) };
        ...
        inline ResponseData& setDataSources(const vector<string> & dataSources) { DARABONBA_PTR_SET_VALUE(dataSources_, dataSources) };
        inline ResponseData& setDataSources(vector<string> && dataSources) { DARABONBA_PTR_SET_RVALUE(dataSources_, dataSources) };
        ...
        inline ResponseData& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
        ...
        inline ResponseData& setDescriptionEn(string descriptionEn) { DARABONBA_PTR_SET_VALUE(descriptionEn_, descriptionEn) };
        ...
        inline ResponseData& setExtContent(string extContent) { DARABONBA_PTR_SET_VALUE(extContent_, extContent) };
        ...
        inline ResponseData& setIncidentNameEn(string incidentNameEn) { DARABONBA_PTR_SET_VALUE(incidentNameEn_, incidentNameEn) };
        ...
        inline ResponseData& setIncidentType(string incidentType) { DARABONBA_PTR_SET_VALUE(incidentType_, incidentType) };
        ...
        inline ResponseData& setReferAccount(string referAccount) { DARABONBA_PTR_SET_VALUE(referAccount_, referAccount) };
        ...
        inline ResponseData& setRemark(string remark) { DARABONBA_PTR_SET_VALUE(remark_, remark) };
        ...
        inline ResponseData& setRuleId(string ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
        ...
        inline ResponseData& setThreatScore(float threatScore) { DARABONBA_PTR_SET_VALUE(threatScore_, threatScore) };
    ...
    inline const DescribeCloudSiemEventsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeCloudSiemEventsResponseBody::Data) };
    inline DescribeCloudSiemEventsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeCloudSiemEventsResponseBody::Data) };
    inline DescribeCloudSiemEventsResponseBody& setData(const DescribeCloudSiemEventsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCloudSiemEventsResponseBody& setData(DescribeCloudSiemEventsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
