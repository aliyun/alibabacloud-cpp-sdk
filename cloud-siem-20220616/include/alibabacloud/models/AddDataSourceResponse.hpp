...
namespace Models
{
  ...
  public:
    ...
    inline const AddDataSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddDataSourceResponseBody) };
    inline AddDataSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, AddDataSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddDataSourceResponseBody> body_ {};
  };
