...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAlertsWithEntityResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeAlertsWithEntityResponseBodyData) };
    inline DescribeAlertsWithEntityResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeAlertsWithEntityResponseBodyData) };
    inline DescribeAlertsWithEntityResponseBody& setData(const DescribeAlertsWithEntityResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAlertsWithEntityResponseBody& setData(DescribeAlertsWithEntityResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeAlertsWithEntityResponseBodyData> data_ = nullptr;
