...
namespace Models
{
  ...
  public:
    ...
    inline const AddDataSourceLogResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddDataSourceLogResponseBody) };
    inline AddDataSourceLogResponseBody body() { DARABONBA_PTR_GET(body_, AddDataSourceLogResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddDataSourceLogResponseBody> body_ = nullptr;
  };
