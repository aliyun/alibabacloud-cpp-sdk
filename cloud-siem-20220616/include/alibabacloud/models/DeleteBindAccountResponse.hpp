...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBindAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBindAccountResponseBody) };
    inline DeleteBindAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBindAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBindAccountResponseBody> body_ {};
  };
