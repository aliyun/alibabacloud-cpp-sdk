...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserBuyStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserBuyStatusResponseBody) };
    inline DescribeUserBuyStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUserBuyStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserBuyStatusResponseBody> body_ {};
  };
