...
namespace Models
{
  ...
  public:
    ...
    inline const PostCustomizeRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PostCustomizeRuleResponseBody) };
    inline PostCustomizeRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, PostCustomizeRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PostCustomizeRuleResponseBody> body_ {};
  };
