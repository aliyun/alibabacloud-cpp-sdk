...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDisposeStrategyPlaybookResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDisposeStrategyPlaybookResponseBody) };
    inline DescribeDisposeStrategyPlaybookResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDisposeStrategyPlaybookResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDisposeStrategyPlaybookResponseBody> body_ = nullptr;
  };
