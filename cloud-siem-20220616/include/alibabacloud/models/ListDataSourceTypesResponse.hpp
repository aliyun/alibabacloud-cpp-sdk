...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataSourceTypesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListDataSourceTypesResponseBody) };
    inline ListDataSourceTypesResponseBody body() { DARABONBA_PTR_GET(body_, ListDataSourceTypesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListDataSourceTypesResponseBody> body_ = nullptr;
  };
