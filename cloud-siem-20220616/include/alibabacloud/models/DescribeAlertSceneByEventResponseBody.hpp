...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAlertSceneByEventResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeAlertSceneByEventResponseBodyData>) };
    inline vector<DescribeAlertSceneByEventResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeAlertSceneByEventResponseBodyData>) };
    inline DescribeAlertSceneByEventResponseBody& setData(const vector<DescribeAlertSceneByEventResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeAlertSceneByEventResponseBody& setData(vector<DescribeAlertSceneByEventResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<DescribeAlertSceneByEventResponseBodyData>> data_ = nullptr;
