...
namespace Models
{
  ...
  public:
    ...
    inline const ListCloudSiemPredefinedRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCloudSiemPredefinedRulesResponseBody) };
    inline ListCloudSiemPredefinedRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCloudSiemPredefinedRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCloudSiemPredefinedRulesResponseBody> body_ {};
  };
