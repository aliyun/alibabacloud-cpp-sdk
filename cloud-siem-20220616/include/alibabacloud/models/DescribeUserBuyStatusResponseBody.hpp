...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserBuyStatusResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeUserBuyStatusResponseBodyData) };
    inline DescribeUserBuyStatusResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeUserBuyStatusResponseBodyData) };
    inline DescribeUserBuyStatusResponseBody& setData(const DescribeUserBuyStatusResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeUserBuyStatusResponseBody& setData(DescribeUserBuyStatusResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeUserBuyStatusResponseBodyData> data_ = nullptr;
    // The request ID.
