...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDisposeAndPlaybookResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDisposeAndPlaybookResponseBodyData) };
    inline DescribeDisposeAndPlaybookResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDisposeAndPlaybookResponseBodyData) };
    inline DescribeDisposeAndPlaybookResponseBody& setData(const DescribeDisposeAndPlaybookResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDisposeAndPlaybookResponseBody& setData(DescribeDisposeAndPlaybookResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeDisposeAndPlaybookResponseBodyData> data_ = nullptr;
