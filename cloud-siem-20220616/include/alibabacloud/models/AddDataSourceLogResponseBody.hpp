...
namespace Models
{
  ...
  public:
    ...
    inline const AddDataSourceLogResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, AddDataSourceLogResponseBodyData) };
    inline AddDataSourceLogResponseBodyData data() { DARABONBA_PTR_GET(data_, AddDataSourceLogResponseBodyData) };
    inline AddDataSourceLogResponseBody& setData(const AddDataSourceLogResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AddDataSourceLogResponseBody& setData(AddDataSourceLogResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<AddDataSourceLogResponseBodyData> data_ = nullptr;
    // The request ID.
