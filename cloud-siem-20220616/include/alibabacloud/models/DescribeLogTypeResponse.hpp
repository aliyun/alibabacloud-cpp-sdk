...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLogTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLogTypeResponseBody) };
    inline DescribeLogTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLogTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLogTypeResponseBody> body_ {};
  };
