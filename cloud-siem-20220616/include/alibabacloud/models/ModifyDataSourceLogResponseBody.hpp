...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDataSourceLogResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyDataSourceLogResponseBody::Data) };
    inline ModifyDataSourceLogResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyDataSourceLogResponseBody::Data) };
    inline ModifyDataSourceLogResponseBody& setData(const ModifyDataSourceLogResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyDataSourceLogResponseBody& setData(ModifyDataSourceLogResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
