...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->assetId_ != nullptr
    ...
    inline const vector<string> & threadLevel() const { DARABONBA_PTR_GET_CONST(threadLevel_, vector<string>) };
    inline vector<string> threadLevel() { DARABONBA_PTR_GET(threadLevel_, vector<string>) };
  ...
  protected:
    ...
    // *   suspicious: medium
    // *   remind: low
    std::shared_ptr<vector<string>> threadLevel_ = nullptr;
  };
