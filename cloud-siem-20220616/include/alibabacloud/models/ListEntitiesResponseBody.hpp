...
namespace Models
{
  ...
  public:
    ...
    inline const ListEntitiesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListEntitiesResponseBodyData) };
    inline ListEntitiesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListEntitiesResponseBodyData) };
    inline ListEntitiesResponseBody& setData(const ListEntitiesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListEntitiesResponseBody& setData(ListEntitiesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListEntitiesResponseBodyData> data_ = nullptr;
