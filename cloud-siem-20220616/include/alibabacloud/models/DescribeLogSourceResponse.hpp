...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLogSourceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeLogSourceResponseBody) };
    inline DescribeLogSourceResponseBody body() { DARABONBA_PTR_GET(body_, DescribeLogSourceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLogSourceResponseBody> body_ = nullptr;
  };
