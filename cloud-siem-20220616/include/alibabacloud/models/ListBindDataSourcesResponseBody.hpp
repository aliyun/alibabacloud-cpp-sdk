...
#include <vector>
#include <alibabacloud/models/ListBindDataSourcesResponseBodyData.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListBindDataSourcesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListBindDataSourcesResponseBodyData>) };
    inline vector<ListBindDataSourcesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListBindDataSourcesResponseBodyData>) };
    inline ListBindDataSourcesResponseBody& setData(const vector<ListBindDataSourcesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListBindDataSourcesResponseBody& setData(vector<ListBindDataSourcesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<vector<ListBindDataSourcesResponseBodyData>> data_ = nullptr;
    // The request ID.
