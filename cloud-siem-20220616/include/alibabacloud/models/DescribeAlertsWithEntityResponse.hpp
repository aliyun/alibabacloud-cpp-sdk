...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAlertsWithEntityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAlertsWithEntityResponseBody) };
    inline DescribeAlertsWithEntityResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAlertsWithEntityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAlertsWithEntityResponseBody> body_ {};
  };
