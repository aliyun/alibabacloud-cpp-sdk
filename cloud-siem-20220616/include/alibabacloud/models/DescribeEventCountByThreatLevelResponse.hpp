...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventCountByThreatLevelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEventCountByThreatLevelResponseBody) };
    inline DescribeEventCountByThreatLevelResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEventCountByThreatLevelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEventCountByThreatLevelResponseBody> body_ {};
  };
