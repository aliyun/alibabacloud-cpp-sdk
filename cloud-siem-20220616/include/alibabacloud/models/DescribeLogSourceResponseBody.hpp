...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeLogSourceResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeLogSourceResponseBodyData>) };
    inline vector<DescribeLogSourceResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeLogSourceResponseBodyData>) };
    inline DescribeLogSourceResponseBody& setData(const vector<DescribeLogSourceResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeLogSourceResponseBody& setData(vector<DescribeLogSourceResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<vector<DescribeLogSourceResponseBodyData>> data_ = nullptr;
