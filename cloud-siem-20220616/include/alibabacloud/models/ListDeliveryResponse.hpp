...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeliveryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDeliveryResponseBody) };
    inline ListDeliveryResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDeliveryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDeliveryResponseBody> body_ {};
  };
