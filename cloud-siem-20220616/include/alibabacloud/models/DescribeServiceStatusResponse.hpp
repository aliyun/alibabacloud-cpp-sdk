...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeServiceStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeServiceStatusResponseBody) };
    inline DescribeServiceStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeServiceStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeServiceStatusResponseBody> body_ {};
  };
