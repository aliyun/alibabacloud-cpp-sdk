...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudSiemEventDetailResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeCloudSiemEventDetailResponseBodyData) };
    inline DescribeCloudSiemEventDetailResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeCloudSiemEventDetailResponseBodyData) };
    inline DescribeCloudSiemEventDetailResponseBody& setData(const DescribeCloudSiemEventDetailResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeCloudSiemEventDetailResponseBody& setData(DescribeCloudSiemEventDetailResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<DescribeCloudSiemEventDetailResponseBodyData> data_ = nullptr;
