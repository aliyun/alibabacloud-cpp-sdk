...
namespace Models
{
  ...
  public:
    ...
    inline const AddTraficMatchRuleToTrafficMarkingPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddTraficMatchRuleToTrafficMarkingPolicyResponseBody) };
    inline AddTraficMatchRuleToTrafficMarkingPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, AddTraficMatchRuleToTrafficMarkingPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddTraficMatchRuleToTrafficMarkingPolicyResponseBody> body_ {};
  };
