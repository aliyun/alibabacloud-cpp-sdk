...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCenInterRegionBandwidthLimitsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCenInterRegionBandwidthLimitsResponseBody) };
    inline DescribeCenInterRegionBandwidthLimitsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCenInterRegionBandwidthLimitsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCenInterRegionBandwidthLimitsResponseBody> body_ {};
  };
