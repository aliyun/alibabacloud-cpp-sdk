...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessRegionIds_ == nullptr
    ...
    inline const vector<string> & getAccessRegionIds() const { DARABONBA_PTR_GET_CONST(accessRegionIds_, vector<string>) };
    inline vector<string> getAccessRegionIds() { DARABONBA_PTR_GET(accessRegionIds_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> accessRegionIds_ {};
