...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTrafficMarkingPolicyAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTrafficMarkingPolicyAttributeResponseBody) };
    inline UpdateTrafficMarkingPolicyAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTrafficMarkingPolicyAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTrafficMarkingPolicyAttributeResponseBody> body_ {};
  };
