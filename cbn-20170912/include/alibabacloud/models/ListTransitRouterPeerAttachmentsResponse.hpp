...
namespace Models
{
  ...
  public:
    ...
    inline const ListTransitRouterPeerAttachmentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTransitRouterPeerAttachmentsResponseBody) };
    inline ListTransitRouterPeerAttachmentsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTransitRouterPeerAttachmentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTransitRouterPeerAttachmentsResponseBody> body_ {};
  };
