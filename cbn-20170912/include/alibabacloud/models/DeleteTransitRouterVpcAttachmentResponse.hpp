...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTransitRouterVpcAttachmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTransitRouterVpcAttachmentResponseBody) };
    inline DeleteTransitRouterVpcAttachmentResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTransitRouterVpcAttachmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTransitRouterVpcAttachmentResponseBody> body_ {};
  };
