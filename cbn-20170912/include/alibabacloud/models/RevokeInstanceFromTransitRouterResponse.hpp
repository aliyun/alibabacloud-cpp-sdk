...
namespace Models
{
  ...
  public:
    ...
    inline const RevokeInstanceFromTransitRouterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RevokeInstanceFromTransitRouterResponseBody) };
    inline RevokeInstanceFromTransitRouterResponseBody getBody() { DARABONBA_PTR_GET(body_, RevokeInstanceFromTransitRouterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RevokeInstanceFromTransitRouterResponseBody> body_ {};
  };
