...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTransitRouterPeerAttachmentAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTransitRouterPeerAttachmentAttributeResponseBody) };
    inline UpdateTransitRouterPeerAttachmentAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTransitRouterPeerAttachmentAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTransitRouterPeerAttachmentAttributeResponseBody> body_ {};
  };
