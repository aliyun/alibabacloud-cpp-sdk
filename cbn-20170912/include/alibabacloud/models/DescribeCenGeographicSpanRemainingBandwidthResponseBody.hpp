...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->remainingBandwidth_ == nullptr
    ...
    inline int64_t getRemainingBandwidth() const { DARABONBA_PTR_GET_DEFAULT(remainingBandwidth_, 0L) };
