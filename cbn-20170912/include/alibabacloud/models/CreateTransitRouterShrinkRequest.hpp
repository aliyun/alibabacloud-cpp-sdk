...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateTransitRouterShrinkRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateTransitRouterShrinkRequest::Tag>) };
    inline vector<CreateTransitRouterShrinkRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateTransitRouterShrinkRequest::Tag>) };
    inline CreateTransitRouterShrinkRequest& setTag(const vector<CreateTransitRouterShrinkRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateTransitRouterShrinkRequest& setTag(vector<CreateTransitRouterShrinkRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline string getTransitRouterCidrListShrink() const { DARABONBA_PTR_GET_DEFAULT(transitRouterCidrListShrink_, "") };
  ...
  protected:
    ...
    // The tags.
    shared_ptr<vector<CreateTransitRouterShrinkRequest::Tag>> tag_ {};
    // The CIDR blocks to be added to the transit router.
    shared_ptr<string> transitRouterCidrListShrink_ {};
