...
namespace Models
{
  ...
  public:
    ...
    inline const DisableTransitRouterRouteTablePropagationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableTransitRouterRouteTablePropagationResponseBody) };
    inline DisableTransitRouterRouteTablePropagationResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableTransitRouterRouteTablePropagationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableTransitRouterRouteTablePropagationResponseBody> body_ {};
  };
