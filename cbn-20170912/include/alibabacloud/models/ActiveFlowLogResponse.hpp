...
namespace Models
{
  ...
  public:
    ...
    inline const ActiveFlowLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ActiveFlowLogResponseBody) };
    inline ActiveFlowLogResponseBody getBody() { DARABONBA_PTR_GET(body_, ActiveFlowLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ActiveFlowLogResponseBody> body_ {};
  };
