...
namespace Models
{
  ...
  public:
    ...
    inline const UnassociateCenBandwidthPackageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnassociateCenBandwidthPackageResponseBody) };
    inline UnassociateCenBandwidthPackageResponseBody getBody() { DARABONBA_PTR_GET(body_, UnassociateCenBandwidthPackageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnassociateCenBandwidthPackageResponseBody> body_ {};
  };
