...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTransitRouterMulticastDomainRequestOptions & options() const { DARABONBA_PTR_GET_CONST(options_, CreateTransitRouterMulticastDomainRequestOptions) };
    inline CreateTransitRouterMulticastDomainRequestOptions options() { DARABONBA_PTR_GET(options_, CreateTransitRouterMulticastDomainRequestOptions) };
    inline CreateTransitRouterMulticastDomainRequest& setOptions(const CreateTransitRouterMulticastDomainRequestOptions & options) { DARABONBA_PTR_SET_VALUE(options_, options) };
    inline CreateTransitRouterMulticastDomainRequest& setOptions(CreateTransitRouterMulticastDomainRequestOptions && options) { DARABONBA_PTR_SET_RVALUE(options_, options) };
    ...
    inline const vector<CreateTransitRouterMulticastDomainRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateTransitRouterMulticastDomainRequestTag>) };
    inline vector<CreateTransitRouterMulticastDomainRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<CreateTransitRouterMulticastDomainRequestTag>) };
    inline CreateTransitRouterMulticastDomainRequest& setTag(const vector<CreateTransitRouterMulticastDomainRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateTransitRouterMulticastDomainRequest& setTag(vector<CreateTransitRouterMulticastDomainRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    std::shared_ptr<CreateTransitRouterMulticastDomainRequestOptions> options_ = nullptr;
    ...
    std::shared_ptr<vector<CreateTransitRouterMulticastDomainRequestTag>> tag_ = nullptr;
