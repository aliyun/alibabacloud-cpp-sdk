...
namespace Models
{
  ...
  public:
    ...
    inline const DisassociateTransitRouterMulticastDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisassociateTransitRouterMulticastDomainResponseBody) };
    inline DisassociateTransitRouterMulticastDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, DisassociateTransitRouterMulticastDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisassociateTransitRouterMulticastDomainResponseBody> body_ {};
  };
