...
namespace Models
{
  ...
  public:
    ...
    inline string getTransitRouteTableAggregationScopeListShrink() const { DARABONBA_PTR_GET_DEFAULT(transitRouteTableAggregationScopeListShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> transitRouteTableAggregationScopeListShrink_ {};
