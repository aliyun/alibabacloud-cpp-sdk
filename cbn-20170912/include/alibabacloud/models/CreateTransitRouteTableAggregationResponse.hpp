...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTransitRouteTableAggregationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTransitRouteTableAggregationResponseBody) };
    inline CreateTransitRouteTableAggregationResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTransitRouteTableAggregationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTransitRouteTableAggregationResponseBody> body_ {};
  };
