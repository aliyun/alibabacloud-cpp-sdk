...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTransitRouterRouteEntryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTransitRouterRouteEntryResponseBody) };
    inline UpdateTransitRouterRouteEntryResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTransitRouterRouteEntryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTransitRouterRouteEntryResponseBody> body_ {};
  };
