...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTrafficMarkingPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTrafficMarkingPolicyResponseBody) };
    inline DeleteTrafficMarkingPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTrafficMarkingPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTrafficMarkingPolicyResponseBody> body_ {};
  };
