...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTransitRouterVpcAttachmentAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTransitRouterVpcAttachmentAttributeResponseBody) };
    inline UpdateTransitRouterVpcAttachmentAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTransitRouterVpcAttachmentAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTransitRouterVpcAttachmentAttributeResponseBody> body_ {};
  };
