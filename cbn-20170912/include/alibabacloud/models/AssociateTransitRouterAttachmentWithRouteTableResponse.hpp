...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateTransitRouterAttachmentWithRouteTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AssociateTransitRouterAttachmentWithRouteTableResponseBody) };
    inline AssociateTransitRouterAttachmentWithRouteTableResponseBody getBody() { DARABONBA_PTR_GET(body_, AssociateTransitRouterAttachmentWithRouteTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AssociateTransitRouterAttachmentWithRouteTableResponseBody> body_ {};
  };
