...
namespace Models
{
  ...
  public:
    ...
    inline const RefreshTransitRouteTableAggregationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RefreshTransitRouteTableAggregationResponseBody) };
    inline RefreshTransitRouteTableAggregationResponseBody getBody() { DARABONBA_PTR_GET(body_, RefreshTransitRouteTableAggregationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RefreshTransitRouteTableAggregationResponseBody> body_ {};
  };
