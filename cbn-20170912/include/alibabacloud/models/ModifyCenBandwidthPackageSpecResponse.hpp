...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCenBandwidthPackageSpecResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCenBandwidthPackageSpecResponseBody) };
    inline ModifyCenBandwidthPackageSpecResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCenBandwidthPackageSpecResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCenBandwidthPackageSpecResponseBody> body_ {};
  };
