...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCenChildInstanceRouteEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCenChildInstanceRouteEntriesResponseBody) };
    inline DescribeCenChildInstanceRouteEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCenChildInstanceRouteEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCenChildInstanceRouteEntriesResponseBody> body_ {};
  };
