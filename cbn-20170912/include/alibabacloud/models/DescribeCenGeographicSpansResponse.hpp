...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCenGeographicSpansResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCenGeographicSpansResponseBody) };
    inline DescribeCenGeographicSpansResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCenGeographicSpansResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCenGeographicSpansResponseBody> body_ {};
  };
