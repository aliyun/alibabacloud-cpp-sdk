...
namespace Models
{
  ...
  public:
    ...
    inline const SetCenInterRegionBandwidthLimitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetCenInterRegionBandwidthLimitResponseBody) };
    inline SetCenInterRegionBandwidthLimitResponseBody getBody() { DARABONBA_PTR_GET(body_, SetCenInterRegionBandwidthLimitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetCenInterRegionBandwidthLimitResponseBody> body_ {};
  };
