...
namespace Models
{
  ...
  public:
    ...
    inline const ListTransitRouterVpnAttachmentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTransitRouterVpnAttachmentsResponseBody) };
    inline ListTransitRouterVpnAttachmentsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTransitRouterVpnAttachmentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTransitRouterVpnAttachmentsResponseBody> body_ {};
  };
