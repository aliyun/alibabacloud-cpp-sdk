...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyTransitRouterMulticastDomainRequest::Options & getOptions() const { DARABONBA_PTR_GET_CONST(options_, ModifyTransitRouterMulticastDomainRequest::Options) };
    inline ModifyTransitRouterMulticastDomainRequest::Options getOptions() { DARABONBA_PTR_GET(options_, ModifyTransitRouterMulticastDomainRequest::Options) };
    inline ModifyTransitRouterMulticastDomainRequest& setOptions(const ModifyTransitRouterMulticastDomainRequest::Options & options) { DARABONBA_PTR_SET_VALUE(options_, options) };
    inline ModifyTransitRouterMulticastDomainRequest& setOptions(ModifyTransitRouterMulticastDomainRequest::Options && options) { DARABONBA_PTR_SET_RVALUE(options_, options) };
