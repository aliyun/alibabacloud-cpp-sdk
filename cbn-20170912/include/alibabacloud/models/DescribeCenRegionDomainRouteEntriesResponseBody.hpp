...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCenRegionDomainRouteEntriesResponseBodyCenRouteEntries & cenRouteEntries() const { DARABONBA_PTR_GET_CONST(cenRouteEntries_, DescribeCenRegionDomainRouteEntriesResponseBodyCenRouteEntries) };
    inline DescribeCenRegionDomainRouteEntriesResponseBodyCenRouteEntries cenRouteEntries() { DARABONBA_PTR_GET(cenRouteEntries_, DescribeCenRegionDomainRouteEntriesResponseBodyCenRouteEntries) };
    inline DescribeCenRegionDomainRouteEntriesResponseBody& setCenRouteEntries(const DescribeCenRegionDomainRouteEntriesResponseBodyCenRouteEntries & cenRouteEntries) { DARABONBA_PTR_SET_VALUE(cenRouteEntries_, cenRouteEntries) };
    inline DescribeCenRegionDomainRouteEntriesResponseBody& setCenRouteEntries(DescribeCenRegionDomainRouteEntriesResponseBodyCenRouteEntries && cenRouteEntries) { DARABONBA_PTR_SET_RVALUE(cenRouteEntries_, cenRouteEntries) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCenRegionDomainRouteEntriesResponseBodyCenRouteEntries> cenRouteEntries_ = nullptr;
