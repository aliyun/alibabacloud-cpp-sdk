...
namespace Models
{
  ...
  public:
    ...
    inline const ListTransitRouterMulticastDomainVSwitchesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTransitRouterMulticastDomainVSwitchesResponseBody) };
    inline ListTransitRouterMulticastDomainVSwitchesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTransitRouterMulticastDomainVSwitchesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTransitRouterMulticastDomainVSwitchesResponseBody> body_ {};
  };
