...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRouteServicesInCenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRouteServicesInCenResponseBody) };
    inline DescribeRouteServicesInCenResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRouteServicesInCenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRouteServicesInCenResponseBody> body_ {};
  };
