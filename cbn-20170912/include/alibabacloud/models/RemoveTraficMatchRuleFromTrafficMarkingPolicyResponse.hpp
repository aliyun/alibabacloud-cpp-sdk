...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveTraficMatchRuleFromTrafficMarkingPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveTraficMatchRuleFromTrafficMarkingPolicyResponseBody) };
    inline RemoveTraficMatchRuleFromTrafficMarkingPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveTraficMatchRuleFromTrafficMarkingPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveTraficMatchRuleFromTrafficMarkingPolicyResponseBody> body_ {};
  };
