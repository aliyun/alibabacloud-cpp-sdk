...
namespace Models
{
  ...
  public:
    ...
    inline const AttachCenChildInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachCenChildInstanceResponseBody) };
    inline AttachCenChildInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachCenChildInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachCenChildInstanceResponseBody> body_ {};
  };
