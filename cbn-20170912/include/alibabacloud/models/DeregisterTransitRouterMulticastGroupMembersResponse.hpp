...
namespace Models
{
  ...
  public:
    ...
    inline const DeregisterTransitRouterMulticastGroupMembersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeregisterTransitRouterMulticastGroupMembersResponseBody) };
    inline DeregisterTransitRouterMulticastGroupMembersResponseBody getBody() { DARABONBA_PTR_GET(body_, DeregisterTransitRouterMulticastGroupMembersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeregisterTransitRouterMulticastGroupMembersResponseBody> body_ {};
  };
