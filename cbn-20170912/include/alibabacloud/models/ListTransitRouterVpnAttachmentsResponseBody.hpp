...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline TransitRouterAttachments& setVpnId(string vpnId) { DARABONBA_PTR_SET_VALUE(vpnId_, vpnId) };
      ...
      inline TransitRouterAttachments& setVpnOwnerId(int64_t vpnOwnerId) { DARABONBA_PTR_SET_VALUE(vpnOwnerId_, vpnOwnerId) };
      ...
      inline string getVpnRegionId() const { DARABONBA_PTR_GET_DEFAULT(vpnRegionId_, "") };
      inline TransitRouterAttachments& setVpnRegionId(string vpnRegionId) { DARABONBA_PTR_SET_VALUE(vpnRegionId_, vpnRegionId) };


      // zones Field Functions 
      bool hasZones() const { return this->zones_ != nullptr;};
      void deleteZones() { this->zones_ = nullptr;};
      inline const vector<TransitRouterAttachments::Zones> & getZones() const { DARABONBA_PTR_GET_CONST(zones_, vector<TransitRouterAttachments::Zones>) };
      inline vector<TransitRouterAttachments::Zones> getZones() { DARABONBA_PTR_GET(zones_, vector<TransitRouterAttachments::Zones>) };
      inline TransitRouterAttachments& setZones(const vector<TransitRouterAttachments::Zones> & zones) { DARABONBA_PTR_SET_VALUE(zones_, zones) };
      inline TransitRouterAttachments& setZones(vector<TransitRouterAttachments::Zones> && zones) { DARABONBA_PTR_SET_RVALUE(zones_, zones) };
    ...
    inline const vector<ListTransitRouterVpnAttachmentsResponseBody::TransitRouterAttachments> & getTransitRouterAttachments() const { DARABONBA_PTR_GET_CONST(transitRouterAttachments_, vector<ListTransitRouterVpnAttachmentsResponseBody::TransitRouterAttachments>) };
    inline vector<ListTransitRouterVpnAttachmentsResponseBody::TransitRouterAttachments> getTransitRouterAttachments() { DARABONBA_PTR_GET(transitRouterAttachments_, vector<ListTransitRouterVpnAttachmentsResponseBody::TransitRouterAttachments>) };
    inline ListTransitRouterVpnAttachmentsResponseBody& setTransitRouterAttachments(const vector<ListTransitRouterVpnAttachmentsResponseBody::TransitRouterAttachments> & transitRouterAttachments) { DARABONBA_PTR_SET_VALUE(transitRouterAttachments_, transitRouterAttachments) };
    inline ListTransitRouterVpnAttachmentsResponseBody& setTransitRouterAttachments(vector<ListTransitRouterVpnAttachmentsResponseBody::TransitRouterAttachments> && transitRouterAttachments) { DARABONBA_PTR_SET_RVALUE(transitRouterAttachments_, transitRouterAttachments) };
