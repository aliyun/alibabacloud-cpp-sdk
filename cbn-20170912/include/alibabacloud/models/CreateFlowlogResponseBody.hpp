...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->flowLogId_ != nullptr
    ...
    inline CreateFlowlogResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };
