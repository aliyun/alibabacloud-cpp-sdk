...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCenChildInstanceRouteEntryToCenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCenChildInstanceRouteEntryToCenResponseBody) };
    inline CreateCenChildInstanceRouteEntryToCenResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCenChildInstanceRouteEntryToCenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCenChildInstanceRouteEntryToCenResponseBody> body_ {};
  };
