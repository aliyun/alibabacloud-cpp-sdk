...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCenVbrHealthCheckResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCenVbrHealthCheckResponseBody) };
    inline DescribeCenVbrHealthCheckResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCenVbrHealthCheckResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCenVbrHealthCheckResponseBody> body_ {};
  };
