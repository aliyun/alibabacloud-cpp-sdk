...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTransitRouterPrefixListAssociationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTransitRouterPrefixListAssociationResponseBody) };
    inline CreateTransitRouterPrefixListAssociationResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTransitRouterPrefixListAssociationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTransitRouterPrefixListAssociationResponseBody> body_ {};
  };
