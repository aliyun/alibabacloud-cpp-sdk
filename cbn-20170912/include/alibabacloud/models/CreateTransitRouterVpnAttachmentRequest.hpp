...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateTransitRouterVpnAttachmentRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateTransitRouterVpnAttachmentRequestTag>) };
    inline vector<CreateTransitRouterVpnAttachmentRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<CreateTransitRouterVpnAttachmentRequestTag>) };
    inline CreateTransitRouterVpnAttachmentRequest& setTag(const vector<CreateTransitRouterVpnAttachmentRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateTransitRouterVpnAttachmentRequest& setTag(vector<CreateTransitRouterVpnAttachmentRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline const vector<CreateTransitRouterVpnAttachmentRequestZone> & zone() const { DARABONBA_PTR_GET_CONST(zone_, vector<CreateTransitRouterVpnAttachmentRequestZone>) };
    inline vector<CreateTransitRouterVpnAttachmentRequestZone> zone() { DARABONBA_PTR_GET(zone_, vector<CreateTransitRouterVpnAttachmentRequestZone>) };
    inline CreateTransitRouterVpnAttachmentRequest& setZone(const vector<CreateTransitRouterVpnAttachmentRequestZone> & zone) { DARABONBA_PTR_SET_VALUE(zone_, zone) };
    inline CreateTransitRouterVpnAttachmentRequest& setZone(vector<CreateTransitRouterVpnAttachmentRequestZone> && zone) { DARABONBA_PTR_SET_RVALUE(zone_, zone) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CreateTransitRouterVpnAttachmentRequestTag>> tag_ = nullptr;
    ...
    std::shared_ptr<vector<CreateTransitRouterVpnAttachmentRequestZone>> zone_ = nullptr;
  };
