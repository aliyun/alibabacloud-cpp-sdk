...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyFlowLogAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyFlowLogAttributeResponseBody) };
    inline ModifyFlowLogAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyFlowLogAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyFlowLogAttributeResponseBody> body_ {};
  };
