...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCensRequest::Filter> & getFilter() const { DARABONBA_PTR_GET_CONST(filter_, vector<DescribeCensRequest::Filter>) };
    inline vector<DescribeCensRequest::Filter> getFilter() { DARABONBA_PTR_GET(filter_, vector<DescribeCensRequest::Filter>) };
    inline DescribeCensRequest& setFilter(const vector<DescribeCensRequest::Filter> & filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    inline DescribeCensRequest& setFilter(vector<DescribeCensRequest::Filter> && filter) { DARABONBA_PTR_SET_RVALUE(filter_, filter) };
    ...
    inline const vector<DescribeCensRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeCensRequest::Tag>) };
    inline vector<DescribeCensRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeCensRequest::Tag>) };
    inline DescribeCensRequest& setTag(const vector<DescribeCensRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeCensRequest& setTag(vector<DescribeCensRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
