...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFlowlogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeFlowlogsResponseBody) };
    inline DescribeFlowlogsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeFlowlogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeFlowlogsResponseBody> body_ {};
  };
