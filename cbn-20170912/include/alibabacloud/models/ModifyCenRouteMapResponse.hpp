...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCenRouteMapResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCenRouteMapResponseBody) };
    inline ModifyCenRouteMapResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCenRouteMapResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCenRouteMapResponseBody> body_ {};
  };
