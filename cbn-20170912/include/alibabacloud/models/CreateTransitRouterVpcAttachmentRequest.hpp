...
#ifndef ALIBABACLOUD_MODELS_CREATETRANSITROUTERVPCATTACHMENTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATETRANSITROUTERVPCATTACHMENTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTransitRouterVpcAttachmentRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTransitRouterVpcAttachmentRequest& obj) { 
    ...
    CreateTransitRouterVpcAttachmentRequest() = default ;
    CreateTransitRouterVpcAttachmentRequest(const CreateTransitRouterVpcAttachmentRequest &) = default ;
    CreateTransitRouterVpcAttachmentRequest(CreateTransitRouterVpcAttachmentRequest &&) = default ;
    CreateTransitRouterVpcAttachmentRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTransitRouterVpcAttachmentRequest() = default ;
    CreateTransitRouterVpcAttachmentRequest& operator=(const CreateTransitRouterVpcAttachmentRequest &) = default ;
    CreateTransitRouterVpcAttachmentRequest& operator=(CreateTransitRouterVpcAttachmentRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->autoPublishRouteEnabled_ == nullptr
        && this->cenId_ == nullptr && this->chargeType_ == nullptr && this->clientToken_ == nullptr && this->dryRun_ == nullptr && this->options_ == nullptr
        ...
        && this->tag_ == nullptr && this->transitRouterAttachmentDescription_ == nullptr && this->transitRouterAttachmentName_ == nullptr && this->transitRouterId_ == nullptr && this->transitRouterVPCAttachmentOptions_ == nullptr
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setAutoPublishRouteEnabled(bool autoPublishRouteEnabled) { DARABONBA_PTR_SET_VALUE(autoPublishRouteEnabled_, autoPublishRouteEnabled) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setCenId(string cenId) { DARABONBA_PTR_SET_VALUE(cenId_, cenId) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setChargeType(string chargeType) { DARABONBA_PTR_SET_VALUE(chargeType_, chargeType) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setDryRun(bool dryRun) { DARABONBA_PTR_SET_VALUE(dryRun_, dryRun) };


    // options Field Functions 
    bool hasOptions() const { return this->options_ != nullptr;};
    void deleteOptions() { this->options_ = nullptr;};
    inline const CreateTransitRouterVpcAttachmentRequest::Options & getOptions() const { DARABONBA_PTR_GET_CONST(options_, CreateTransitRouterVpcAttachmentRequest::Options) };
    inline CreateTransitRouterVpcAttachmentRequest::Options getOptions() { DARABONBA_PTR_GET(options_, CreateTransitRouterVpcAttachmentRequest::Options) };
    inline CreateTransitRouterVpcAttachmentRequest& setOptions(const CreateTransitRouterVpcAttachmentRequest::Options & options) { DARABONBA_PTR_SET_VALUE(options_, options) };
    inline CreateTransitRouterVpcAttachmentRequest& setOptions(CreateTransitRouterVpcAttachmentRequest::Options && options) { DARABONBA_PTR_SET_RVALUE(options_, options) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };


    // tag Field Functions 
    bool hasTag() const { return this->tag_ != nullptr;};
    void deleteTag() { this->tag_ = nullptr;};
    inline const vector<CreateTransitRouterVpcAttachmentRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateTransitRouterVpcAttachmentRequest::Tag>) };
    inline vector<CreateTransitRouterVpcAttachmentRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateTransitRouterVpcAttachmentRequest::Tag>) };
    inline CreateTransitRouterVpcAttachmentRequest& setTag(const vector<CreateTransitRouterVpcAttachmentRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateTransitRouterVpcAttachmentRequest& setTag(vector<CreateTransitRouterVpcAttachmentRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setTransitRouterAttachmentDescription(string transitRouterAttachmentDescription) { DARABONBA_PTR_SET_VALUE(transitRouterAttachmentDescription_, transitRouterAttachmentDescription) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setTransitRouterAttachmentName(string transitRouterAttachmentName) { DARABONBA_PTR_SET_VALUE(transitRouterAttachmentName_, transitRouterAttachmentName) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setTransitRouterId(string transitRouterId) { DARABONBA_PTR_SET_VALUE(transitRouterId_, transitRouterId) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setTransitRouterVPCAttachmentOptions(const map<string, string> & transitRouterVPCAttachmentOptions) { DARABONBA_PTR_SET_VALUE(transitRouterVPCAttachmentOptions_, transitRouterVPCAttachmentOptions) };
    inline CreateTransitRouterVpcAttachmentRequest& setTransitRouterVPCAttachmentOptions(map<string, string> && transitRouterVPCAttachmentOptions) { DARABONBA_PTR_SET_RVALUE(transitRouterVPCAttachmentOptions_, transitRouterVPCAttachmentOptions) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
    ...
    inline CreateTransitRouterVpcAttachmentRequest& setVpcOwnerId(int64_t vpcOwnerId) { DARABONBA_PTR_SET_VALUE(vpcOwnerId_, vpcOwnerId) };
    ...
    inline const vector<CreateTransitRouterVpcAttachmentRequest::ZoneMappings> & getZoneMappings() const { DARABONBA_PTR_GET_CONST(zoneMappings_, vector<CreateTransitRouterVpcAttachmentRequest::ZoneMappings>) };
    inline vector<CreateTransitRouterVpcAttachmentRequest::ZoneMappings> getZoneMappings() { DARABONBA_PTR_GET(zoneMappings_, vector<CreateTransitRouterVpcAttachmentRequest::ZoneMappings>) };
    inline CreateTransitRouterVpcAttachmentRequest& setZoneMappings(const vector<CreateTransitRouterVpcAttachmentRequest::ZoneMappings> & zoneMappings) { DARABONBA_PTR_SET_VALUE(zoneMappings_, zoneMappings) };
    inline CreateTransitRouterVpcAttachmentRequest& setZoneMappings(vector<CreateTransitRouterVpcAttachmentRequest::ZoneMappings> && zoneMappings) { DARABONBA_PTR_SET_RVALUE(zoneMappings_, zoneMappings) };
