...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListTransitRouterEcrAttachmentsRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<ListTransitRouterEcrAttachmentsRequest::Tag>) };
    inline vector<ListTransitRouterEcrAttachmentsRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<ListTransitRouterEcrAttachmentsRequest::Tag>) };
    inline ListTransitRouterEcrAttachmentsRequest& setTag(const vector<ListTransitRouterEcrAttachmentsRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline ListTransitRouterEcrAttachmentsRequest& setTag(vector<ListTransitRouterEcrAttachmentsRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<ListTransitRouterEcrAttachmentsRequest::Tag>> tag_ {};
