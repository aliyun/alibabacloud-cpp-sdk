...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCensResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCensResponseBody) };
    inline DescribeCensResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCensResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCensResponseBody> body_ {};
  };
