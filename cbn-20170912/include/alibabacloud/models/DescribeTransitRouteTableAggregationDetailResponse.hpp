...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTransitRouteTableAggregationDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTransitRouteTableAggregationDetailResponseBody) };
    inline DescribeTransitRouteTableAggregationDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTransitRouteTableAggregationDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTransitRouteTableAggregationDetailResponseBody> body_ {};
  };
