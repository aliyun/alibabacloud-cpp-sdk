...
#ifndef ALIBABACLOUD_MODELS_CREATETRANSITROUTETABLEAGGREGATIONSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATETRANSITROUTETABLEAGGREGATIONSHRINKREQUEST_HPP_
...
namespace Models
{
  class CreateTransitRouteTableAggregationShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateTransitRouteTableAggregationShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTransitRouteTableAggregationShrinkRequest& obj) { 
    ...
    CreateTransitRouteTableAggregationShrinkRequest() = default ;
    CreateTransitRouteTableAggregationShrinkRequest(const CreateTransitRouteTableAggregationShrinkRequest &) = default ;
    CreateTransitRouteTableAggregationShrinkRequest(CreateTransitRouteTableAggregationShrinkRequest &&) = default ;
    CreateTransitRouteTableAggregationShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTransitRouteTableAggregationShrinkRequest() = default ;
    CreateTransitRouteTableAggregationShrinkRequest& operator=(const CreateTransitRouteTableAggregationShrinkRequest &) = default ;
    CreateTransitRouteTableAggregationShrinkRequest& operator=(CreateTransitRouteTableAggregationShrinkRequest &&) = default ;
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setDryRun(bool dryRun) { DARABONBA_PTR_SET_VALUE(dryRun_, dryRun) };
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setTransitRouteTableAggregationCidr(string transitRouteTableAggregationCidr) { DARABONBA_PTR_SET_VALUE(transitRouteTableAggregationCidr_, transitRouteTableAggregationCidr) };
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setTransitRouteTableAggregationDescription(string transitRouteTableAggregationDescription) { DARABONBA_PTR_SET_VALUE(transitRouteTableAggregationDescription_, transitRouteTableAggregationDescription) };
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setTransitRouteTableAggregationName(string transitRouteTableAggregationName) { DARABONBA_PTR_SET_VALUE(transitRouteTableAggregationName_, transitRouteTableAggregationName) };
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setTransitRouteTableAggregationScope(string transitRouteTableAggregationScope) { DARABONBA_PTR_SET_VALUE(transitRouteTableAggregationScope_, transitRouteTableAggregationScope) };
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setTransitRouteTableAggregationScopeListShrink(string transitRouteTableAggregationScopeListShrink) { DARABONBA_PTR_SET_VALUE(transitRouteTableAggregationScopeListShrink_, transitRouteTableAggregationScopeListShrink) };
    ...
    inline CreateTransitRouteTableAggregationShrinkRequest& setTransitRouteTableId(string transitRouteTableId) { DARABONBA_PTR_SET_VALUE(transitRouteTableId_, transitRouteTableId) };
