...
namespace Models
{
  ...
  public:
    ...
    inline const ListTransitRouterVpcAttachmentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTransitRouterVpcAttachmentsResponseBody) };
    inline ListTransitRouterVpcAttachmentsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTransitRouterVpcAttachmentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTransitRouterVpcAttachmentsResponseBody> body_ {};
  };
