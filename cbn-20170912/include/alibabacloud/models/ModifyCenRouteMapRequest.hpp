...
namespace Models
{
  ...
  public:
    ...
    inline const vector<int32_t> & matchAsns() const { DARABONBA_PTR_GET_CONST(matchAsns_, vector<int32_t>) };
    inline vector<int32_t> matchAsns() { DARABONBA_PTR_GET(matchAsns_, vector<int32_t>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<int32_t>> matchAsns_ = nullptr;
