...
namespace Models
{
  ...
  public:
    ...
    inline const ListTransitRoutersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTransitRoutersResponseBody) };
    inline ListTransitRoutersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTransitRoutersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTransitRoutersResponseBody> body_ {};
  };
