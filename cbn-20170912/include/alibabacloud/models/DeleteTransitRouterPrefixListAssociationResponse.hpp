...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTransitRouterPrefixListAssociationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTransitRouterPrefixListAssociationResponseBody) };
    inline DeleteTransitRouterPrefixListAssociationResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTransitRouterPrefixListAssociationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTransitRouterPrefixListAssociationResponseBody> body_ {};
  };
