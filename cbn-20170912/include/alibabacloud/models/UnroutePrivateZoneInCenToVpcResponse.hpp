...
namespace Models
{
  ...
  public:
    ...
    inline const UnroutePrivateZoneInCenToVpcResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnroutePrivateZoneInCenToVpcResponseBody) };
    inline UnroutePrivateZoneInCenToVpcResponseBody getBody() { DARABONBA_PTR_GET(body_, UnroutePrivateZoneInCenToVpcResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnroutePrivateZoneInCenToVpcResponseBody> body_ {};
  };
