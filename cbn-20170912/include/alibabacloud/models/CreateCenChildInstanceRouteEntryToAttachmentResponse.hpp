...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCenChildInstanceRouteEntryToAttachmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCenChildInstanceRouteEntryToAttachmentResponseBody) };
    inline CreateCenChildInstanceRouteEntryToAttachmentResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCenChildInstanceRouteEntryToAttachmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCenChildInstanceRouteEntryToAttachmentResponseBody> body_ {};
  };
