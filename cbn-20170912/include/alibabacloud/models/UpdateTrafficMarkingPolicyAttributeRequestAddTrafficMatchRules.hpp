...
#ifndef ALIBABACLOUD_MODELS_UPDATETRAFFICMARKINGPOLICYATTRIBUTEREQUESTADDTRAFFICMATCHRULES_HPP_
#define ALIBABACLOUD_MODELS_UPDATETRAFFICMARKINGPOLICYATTRIBUTEREQUESTADDTRAFFICMATCHRULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& obj) { 
    ...
    UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules() = default ;
    UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules(const UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules &) = default ;
    UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules(UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules &&) = default ;
    UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules() = default ;
    UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& operator=(const UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules &) = default ;
    UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& operator=(UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules &&) = default ;
    ...
    inline UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& setAddressFamily(string addressFamily) { DARABONBA_PTR_SET_VALUE(addressFamily_, addressFamily) };
    ...
    inline UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& setDstCidr(string dstCidr) { DARABONBA_PTR_SET_VALUE(dstCidr_, dstCidr) };
    ...
    inline UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& setDstPortRange(const vector<int32_t> & dstPortRange) { DARABONBA_PTR_SET_VALUE(dstPortRange_, dstPortRange) };
    inline UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& setDstPortRange(vector<int32_t> && dstPortRange) { DARABONBA_PTR_SET_RVALUE(dstPortRange_, dstPortRange) };
    ...
    inline UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& setMatchDscp(int32_t matchDscp) { DARABONBA_PTR_SET_VALUE(matchDscp_, matchDscp) };
    ...
    inline UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& setSrcCidr(string srcCidr) { DARABONBA_PTR_SET_VALUE(srcCidr_, srcCidr) };
    ...
    inline UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& setSrcPortRange(const vector<int32_t> & srcPortRange) { DARABONBA_PTR_SET_VALUE(srcPortRange_, srcPortRange) };
    inline UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& setSrcPortRange(vector<int32_t> && srcPortRange) { DARABONBA_PTR_SET_RVALUE(srcPortRange_, srcPortRange) };
    ...
    inline UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& setTrafficMatchRuleDescription(string trafficMatchRuleDescription) { DARABONBA_PTR_SET_VALUE(trafficMatchRuleDescription_, trafficMatchRuleDescription) };
    ...
    inline UpdateTrafficMarkingPolicyAttributeRequestAddTrafficMatchRules& setTrafficMatchRuleName(string trafficMatchRuleName) { DARABONBA_PTR_SET_VALUE(trafficMatchRuleName_, trafficMatchRuleName) };
