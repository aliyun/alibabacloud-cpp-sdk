...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTrafficMarkingPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTrafficMarkingPolicyResponseBody) };
    inline CreateTrafficMarkingPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTrafficMarkingPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTrafficMarkingPolicyResponseBody> body_ {};
  };
