...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->geographicRegionId_ == nullptr
    ...
    inline string getGeographicRegionId() const { DARABONBA_PTR_GET_DEFAULT(geographicRegionId_, "") };
