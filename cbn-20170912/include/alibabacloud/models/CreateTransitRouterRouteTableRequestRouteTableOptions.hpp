...
#ifndef ALIBABACLOUD_MODELS_CREATETRANSITROUTERROUTETABLEREQUESTROUTETABLEOPTIONS_HPP_
#define ALIBABACLOUD_MODELS_CREATETRANSITROUTERROUTETABLEREQUESTROUTETABLEOPTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTransitRouterRouteTableRequestRouteTableOptions& obj) { 
      DARABONBA_PTR_TO_JSON(MultiRegionECMP, multiRegionECMP_);
    };
    friend void from_json(const Darabonba::Json& j, CreateTransitRouterRouteTableRequestRouteTableOptions& obj) { 
      DARABONBA_PTR_FROM_JSON(MultiRegionECMP, multiRegionECMP_);
    };
    CreateTransitRouterRouteTableRequestRouteTableOptions() = default ;
    CreateTransitRouterRouteTableRequestRouteTableOptions(const CreateTransitRouterRouteTableRequestRouteTableOptions &) = default ;
    CreateTransitRouterRouteTableRequestRouteTableOptions(CreateTransitRouterRouteTableRequestRouteTableOptions &&) = default ;
    CreateTransitRouterRouteTableRequestRouteTableOptions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTransitRouterRouteTableRequestRouteTableOptions() = default ;
    CreateTransitRouterRouteTableRequestRouteTableOptions& operator=(const CreateTransitRouterRouteTableRequestRouteTableOptions &) = default ;
    CreateTransitRouterRouteTableRequestRouteTableOptions& operator=(CreateTransitRouterRouteTableRequestRouteTableOptions &&) = default ;
    ...
    inline CreateTransitRouterRouteTableRequestRouteTableOptions& setMultiRegionECMP(string multiRegionECMP) { DARABONBA_PTR_SET_VALUE(multiRegionECMP_, multiRegionECMP) };
