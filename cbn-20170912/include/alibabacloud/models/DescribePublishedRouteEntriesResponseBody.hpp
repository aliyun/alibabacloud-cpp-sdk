...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePublishedRouteEntriesResponseBodyPublishedRouteEntries & publishedRouteEntries() const { DARABONBA_PTR_GET_CONST(publishedRouteEntries_, DescribePublishedRouteEntriesResponseBodyPublishedRouteEntries) };
    inline DescribePublishedRouteEntriesResponseBodyPublishedRouteEntries publishedRouteEntries() { DARABONBA_PTR_GET(publishedRouteEntries_, DescribePublishedRouteEntriesResponseBodyPublishedRouteEntries) };
    inline DescribePublishedRouteEntriesResponseBody& setPublishedRouteEntries(const DescribePublishedRouteEntriesResponseBodyPublishedRouteEntries & publishedRouteEntries) { DARABONBA_PTR_SET_VALUE(publishedRouteEntries_, publishedRouteEntries) };
    inline DescribePublishedRouteEntriesResponseBody& setPublishedRouteEntries(DescribePublishedRouteEntriesResponseBodyPublishedRouteEntries && publishedRouteEntries) { DARABONBA_PTR_SET_RVALUE(publishedRouteEntries_, publishedRouteEntries) };
  ...
  protected:
    ...
    // A list of routes.
    std::shared_ptr<DescribePublishedRouteEntriesResponseBodyPublishedRouteEntries> publishedRouteEntries_ = nullptr;
