...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCenAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCenAttributeResponseBody) };
    inline ModifyCenAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCenAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCenAttributeResponseBody> body_ {};
  };
