...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateTransitRouterPeerAttachmentRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateTransitRouterPeerAttachmentRequest::Tag>) };
    inline vector<CreateTransitRouterPeerAttachmentRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateTransitRouterPeerAttachmentRequest::Tag>) };
    inline CreateTransitRouterPeerAttachmentRequest& setTag(const vector<CreateTransitRouterPeerAttachmentRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateTransitRouterPeerAttachmentRequest& setTag(vector<CreateTransitRouterPeerAttachmentRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
