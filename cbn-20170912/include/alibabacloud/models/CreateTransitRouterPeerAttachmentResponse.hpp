...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTransitRouterPeerAttachmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTransitRouterPeerAttachmentResponseBody) };
    inline CreateTransitRouterPeerAttachmentResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTransitRouterPeerAttachmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTransitRouterPeerAttachmentResponseBody> body_ {};
  };
