...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->arbiterVSwitchId_ == nullptr
        && return this->arbiterZoneId_ == nullptr && return this->archVersion_ == nullptr && return this->autoRenewDuration_ == nullptr && return this->autoRenewal_ == nullptr && return this->capacityStorageSize_ == nullptr
        && return this->cloudStorageSize_ == nullptr && return this->cloudStorageType_ == nullptr && return this->clusterMode_ == nullptr && return this->clusterPattern_ == nullptr && return this->duration_ == nullptr
        && return this->enableCapacityStorage_ == nullptr && return this->engineList_ == nullptr && return this->instanceAlias_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
        && return this->payType_ == nullptr && return this->pricingCycle_ == nullptr && return this->primaryVSwitchId_ == nullptr && return this->primaryZoneId_ == nullptr && return this->regionId_ == nullptr
        && return this->resourceGroupId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->securityToken_ == nullptr && return this->standbyVSwitchId_ == nullptr
        && return this->standbyZoneId_ == nullptr && return this->VPCId_ == nullptr && return this->vSwitchId_ == nullptr && return this->zoneId_ == nullptr; };
