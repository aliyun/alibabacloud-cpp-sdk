...
namespace Models
{
  ...
  public:
    ...
    inline const SwitchLSQLV3MySQLServiceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SwitchLSQLV3MySQLServiceResponseBody) };
    inline SwitchLSQLV3MySQLServiceResponseBody body() { DARABONBA_PTR_GET(body_, SwitchLSQLV3MySQLServiceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SwitchLSQLV3MySQLServiceResponseBody> body_ = nullptr;
  };
