...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLdpsComputeGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLdpsComputeGroupResponseBody) };
    inline UpdateLdpsComputeGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLdpsComputeGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLdpsComputeGroupResponseBody> body_ {};
  };
