...
namespace Models
{
  ...
  public:
    ...
    inline const RenewLindormInstanceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RenewLindormInstanceResponseBody) };
    inline RenewLindormInstanceResponseBody body() { DARABONBA_PTR_GET(body_, RenewLindormInstanceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RenewLindormInstanceResponseBody> body_ = nullptr;
  };
