...
namespace Models
{
  ...
  public:
    ...
    inline const ListAutoScalingRulesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAutoScalingRulesResponseBodyData) };
    inline ListAutoScalingRulesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAutoScalingRulesResponseBodyData) };
    inline ListAutoScalingRulesResponseBody& setData(const ListAutoScalingRulesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAutoScalingRulesResponseBody& setData(ListAutoScalingRulesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListAutoScalingRulesResponseBodyData> data_ = nullptr;
