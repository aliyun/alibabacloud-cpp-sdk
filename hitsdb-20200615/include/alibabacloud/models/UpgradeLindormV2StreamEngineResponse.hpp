...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeLindormV2StreamEngineResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpgradeLindormV2StreamEngineResponseBody) };
    inline UpgradeLindormV2StreamEngineResponseBody getBody() { DARABONBA_PTR_GET(body_, UpgradeLindormV2StreamEngineResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpgradeLindormV2StreamEngineResponseBody> body_ {};
  };
