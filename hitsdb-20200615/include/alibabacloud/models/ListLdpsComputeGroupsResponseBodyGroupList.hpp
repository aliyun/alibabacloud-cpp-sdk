...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->exceptionInfo_ != nullptr
        && this->groupName_ != nullptr && this->isDefault_ != nullptr && this->properties_ != nullptr && this->state_ != nullptr && this->webUI_ != nullptr; };
