...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->configId_ == nullptr
        ...
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->scaleRuleList_ == nullptr && this->scaleType_ == nullptr && this->securityToken_ == nullptr
    ...
    inline const vector<ModifyAutoScalingConfigRequest::ScaleRuleList> & getScaleRuleList() const { DARABONBA_PTR_GET_CONST(scaleRuleList_, vector<ModifyAutoScalingConfigRequest::ScaleRuleList>) };
    inline vector<ModifyAutoScalingConfigRequest::ScaleRuleList> getScaleRuleList() { DARABONBA_PTR_GET(scaleRuleList_, vector<ModifyAutoScalingConfigRequest::ScaleRuleList>) };
    inline ModifyAutoScalingConfigRequest& setScaleRuleList(const vector<ModifyAutoScalingConfigRequest::ScaleRuleList> & scaleRuleList) { DARABONBA_PTR_SET_VALUE(scaleRuleList_, scaleRuleList) };
    inline ModifyAutoScalingConfigRequest& setScaleRuleList(vector<ModifyAutoScalingConfigRequest::ScaleRuleList> && scaleRuleList) { DARABONBA_PTR_SET_RVALUE(scaleRuleList_, scaleRuleList) };
  ...
  protected:
    ...
    shared_ptr<vector<ModifyAutoScalingConfigRequest::ScaleRuleList>> scaleRuleList_ {};
