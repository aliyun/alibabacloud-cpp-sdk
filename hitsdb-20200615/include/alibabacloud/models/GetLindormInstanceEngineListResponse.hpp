...
namespace Models
{
  ...
  public:
    ...
    inline const GetLindormInstanceEngineListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLindormInstanceEngineListResponseBody) };
    inline GetLindormInstanceEngineListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLindormInstanceEngineListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLindormInstanceEngineListResponseBody> body_ {};
  };
