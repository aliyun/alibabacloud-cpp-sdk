...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getClusterStorage() const { DARABONBA_PTR_GET_DEFAULT(clusterStorage_, 0) };
    ...
    inline int32_t getLtsCoreNum() const { DARABONBA_PTR_GET_DEFAULT(ltsCoreNum_, 0) };
    ...
    inline string getLtsCoreSpec() const { DARABONBA_PTR_GET_DEFAULT(ltsCoreSpec_, "") };
  ...
  protected:
    ...
    shared_ptr<int32_t> clusterStorage_ {};
