...
namespace Models
{
  ...
  public:
    ...
    inline const ListAutoScalingConfigsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAutoScalingConfigsResponseBodyData) };
    inline ListAutoScalingConfigsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAutoScalingConfigsResponseBodyData) };
    inline ListAutoScalingConfigsResponseBody& setData(const ListAutoScalingConfigsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAutoScalingConfigsResponseBody& setData(ListAutoScalingConfigsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListAutoScalingConfigsResponseBodyData> data_ = nullptr;
