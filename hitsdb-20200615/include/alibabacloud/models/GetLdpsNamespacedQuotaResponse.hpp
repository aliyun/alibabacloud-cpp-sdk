...
namespace Models
{
  ...
  public:
    ...
    inline const GetLdpsNamespacedQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLdpsNamespacedQuotaResponseBody) };
    inline GetLdpsNamespacedQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLdpsNamespacedQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLdpsNamespacedQuotaResponseBody> body_ {};
  };
