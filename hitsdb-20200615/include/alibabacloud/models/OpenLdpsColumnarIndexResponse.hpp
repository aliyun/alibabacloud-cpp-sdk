...
namespace Models
{
  ...
  public:
    ...
    inline const OpenLdpsColumnarIndexResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenLdpsColumnarIndexResponseBody) };
    inline OpenLdpsColumnarIndexResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenLdpsColumnarIndexResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenLdpsColumnarIndexResponseBody> body_ {};
  };
