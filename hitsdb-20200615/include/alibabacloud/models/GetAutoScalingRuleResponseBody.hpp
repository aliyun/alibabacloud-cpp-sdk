...
namespace Models
{
  ...
  public:
    ...
    inline const GetAutoScalingRuleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAutoScalingRuleResponseBodyData) };
    inline GetAutoScalingRuleResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAutoScalingRuleResponseBodyData) };
    inline GetAutoScalingRuleResponseBody& setData(const GetAutoScalingRuleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAutoScalingRuleResponseBody& setData(GetAutoScalingRuleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAutoScalingRuleResponseBodyData> data_ = nullptr;
