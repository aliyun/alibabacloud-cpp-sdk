...
namespace Models
{
  ...
  public:
    ...
    inline const ReleaseLindormV2InstanceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ReleaseLindormV2InstanceResponseBody) };
    inline ReleaseLindormV2InstanceResponseBody body() { DARABONBA_PTR_GET(body_, ReleaseLindormV2InstanceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ReleaseLindormV2InstanceResponseBody> body_ = nullptr;
  };
