...
#ifndef ALIBABACLOUD_MODELS_GETLINDORMV2INSTANCEDETAILSRESPONSEBODYENGINELISTNODEGROUP_HPP_
#define ALIBABACLOUD_MODELS_GETLINDORMV2INSTANCEDETAILSRESPONSEBODYENGINELISTNODEGROUP_HPP_
...
namespace Models
{
  class GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& obj) { 
    ...
    GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup() = default ;
    GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup(const GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup &) = default ;
    GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup(GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup &&) = default ;
    GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup() = default ;
    GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& operator=(const GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup &) = default ;
    GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& operator=(GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup &&) = default ;
    ...
    inline GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
    ...
    inline GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& setCpuCoreCount(int32_t cpuCoreCount) { DARABONBA_PTR_SET_VALUE(cpuCoreCount_, cpuCoreCount) };
    ...
    inline GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& setEnableAttachLocalDisk(bool enableAttachLocalDisk) { DARABONBA_PTR_SET_VALUE(enableAttachLocalDisk_, enableAttachLocalDisk) };
    ...
    inline GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& setLocalDiskCapacity(int64_t localDiskCapacity) { DARABONBA_PTR_SET_VALUE(localDiskCapacity_, localDiskCapacity) };
    ...
    inline GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& setLocalDiskCategory(string localDiskCategory) { DARABONBA_PTR_SET_VALUE(localDiskCategory_, localDiskCategory) };
    ...
    inline GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& setMemorySizeGiB(int32_t memorySizeGiB) { DARABONBA_PTR_SET_VALUE(memorySizeGiB_, memorySizeGiB) };
    ...
    inline GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& setNodeSpec(string nodeSpec) { DARABONBA_PTR_SET_VALUE(nodeSpec_, nodeSpec) };
    ...
    inline GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& setQuantity(int32_t quantity) { DARABONBA_PTR_SET_VALUE(quantity_, quantity) };
    ...
    inline GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& setResourceGroupName(string resourceGroupName) { DARABONBA_PTR_SET_VALUE(resourceGroupName_, resourceGroupName) };
    ...
    inline GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& setSpecId(string specId) { DARABONBA_PTR_SET_VALUE(specId_, specId) };
    ...
    inline GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
