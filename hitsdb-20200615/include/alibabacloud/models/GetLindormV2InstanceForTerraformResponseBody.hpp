...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetLindormV2InstanceForTerraformResponseBody::EngineList> & getEngineList() const { DARABONBA_PTR_GET_CONST(engineList_, vector<GetLindormV2InstanceForTerraformResponseBody::EngineList>) };
    inline vector<GetLindormV2InstanceForTerraformResponseBody::EngineList> getEngineList() { DARABONBA_PTR_GET(engineList_, vector<GetLindormV2InstanceForTerraformResponseBody::EngineList>) };
    inline GetLindormV2InstanceForTerraformResponseBody& setEngineList(const vector<GetLindormV2InstanceForTerraformResponseBody::EngineList> & engineList) { DARABONBA_PTR_SET_VALUE(engineList_, engineList) };
    inline GetLindormV2InstanceForTerraformResponseBody& setEngineList(vector<GetLindormV2InstanceForTerraformResponseBody::EngineList> && engineList) { DARABONBA_PTR_SET_RVALUE(engineList_, engineList) };
    ...
    inline const GetLindormV2InstanceForTerraformResponseBody::StorageUsage & getStorageUsage() const { DARABONBA_PTR_GET_CONST(storageUsage_, GetLindormV2InstanceForTerraformResponseBody::StorageUsage) };
    inline GetLindormV2InstanceForTerraformResponseBody::StorageUsage getStorageUsage() { DARABONBA_PTR_GET(storageUsage_, GetLindormV2InstanceForTerraformResponseBody::StorageUsage) };
    inline GetLindormV2InstanceForTerraformResponseBody& setStorageUsage(const GetLindormV2InstanceForTerraformResponseBody::StorageUsage & storageUsage) { DARABONBA_PTR_SET_VALUE(storageUsage_, storageUsage) };
    inline GetLindormV2InstanceForTerraformResponseBody& setStorageUsage(GetLindormV2InstanceForTerraformResponseBody::StorageUsage && storageUsage) { DARABONBA_PTR_SET_RVALUE(storageUsage_, storageUsage) };
    ...
    inline const vector<GetLindormV2InstanceForTerraformResponseBody::WhiteIpList> & getWhiteIpList() const { DARABONBA_PTR_GET_CONST(whiteIpList_, vector<GetLindormV2InstanceForTerraformResponseBody::WhiteIpList>) };
    inline vector<GetLindormV2InstanceForTerraformResponseBody::WhiteIpList> getWhiteIpList() { DARABONBA_PTR_GET(whiteIpList_, vector<GetLindormV2InstanceForTerraformResponseBody::WhiteIpList>) };
    inline GetLindormV2InstanceForTerraformResponseBody& setWhiteIpList(const vector<GetLindormV2InstanceForTerraformResponseBody::WhiteIpList> & whiteIpList) { DARABONBA_PTR_SET_VALUE(whiteIpList_, whiteIpList) };
    inline GetLindormV2InstanceForTerraformResponseBody& setWhiteIpList(vector<GetLindormV2InstanceForTerraformResponseBody::WhiteIpList> && whiteIpList) { DARABONBA_PTR_SET_RVALUE(whiteIpList_, whiteIpList) };
  ...
  protected:
    ...
    shared_ptr<vector<GetLindormV2InstanceForTerraformResponseBody::EngineList>> engineList_ {};
    ...
    shared_ptr<GetLindormV2InstanceForTerraformResponseBody::StorageUsage> storageUsage_ {};
    shared_ptr<string> vpcId_ {};
    shared_ptr<string> vswitchId_ {};
    shared_ptr<vector<GetLindormV2InstanceForTerraformResponseBody::WhiteIpList>> whiteIpList_ {};
