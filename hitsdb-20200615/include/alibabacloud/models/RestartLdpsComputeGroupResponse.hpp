...
namespace Models
{
  ...
  public:
    ...
    inline const RestartLdpsComputeGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RestartLdpsComputeGroupResponseBody) };
    inline RestartLdpsComputeGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, RestartLdpsComputeGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RestartLdpsComputeGroupResponseBody> body_ {};
  };
