...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->connectAddressList_ == nullptr
        && return this->enableBackup_ == nullptr && return this->enableCDC_ == nullptr && return this->engine_ == nullptr && return this->isLastVersion_ == nullptr && return this->latestVersion_ == nullptr
        && return this->nodeGroup_ == nullptr && return this->version_ == nullptr; };
