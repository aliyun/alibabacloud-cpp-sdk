...
#ifndef ALIBABACLOUD_MODELS_MODIFYAUTOSCALINGCONFIGREQUESTSCALERULELIST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYAUTOSCALINGCONFIGREQUESTSCALERULELIST_HPP_
...
namespace Models
{
  class ModifyAutoScalingConfigRequestScaleRuleList : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ModifyAutoScalingConfigRequestScaleRuleList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyAutoScalingConfigRequestScaleRuleList& obj) { 
    ...
    ModifyAutoScalingConfigRequestScaleRuleList() = default ;
    ModifyAutoScalingConfigRequestScaleRuleList(const ModifyAutoScalingConfigRequestScaleRuleList &) = default ;
    ModifyAutoScalingConfigRequestScaleRuleList(ModifyAutoScalingConfigRequestScaleRuleList &&) = default ;
    ModifyAutoScalingConfigRequestScaleRuleList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyAutoScalingConfigRequestScaleRuleList() = default ;
    ModifyAutoScalingConfigRequestScaleRuleList& operator=(const ModifyAutoScalingConfigRequestScaleRuleList &) = default ;
    ModifyAutoScalingConfigRequestScaleRuleList& operator=(ModifyAutoScalingConfigRequestScaleRuleList &&) = default ;
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setConfigId(string configId) { DARABONBA_PTR_SET_VALUE(configId_, configId) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setEnabled(bool enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setObservationWindow(int32_t observationWindow) { DARABONBA_PTR_SET_VALUE(observationWindow_, observationWindow) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setOperationType(string operationType) { DARABONBA_PTR_SET_VALUE(operationType_, operationType) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setRuleId(string ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setRuleType(string ruleType) { DARABONBA_PTR_SET_VALUE(ruleType_, ruleType) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setScaleInStep(int32_t scaleInStep) { DARABONBA_PTR_SET_VALUE(scaleInStep_, scaleInStep) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setScaleOutStep(int32_t scaleOutStep) { DARABONBA_PTR_SET_VALUE(scaleOutStep_, scaleOutStep) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setSilenceTime(int32_t silenceTime) { DARABONBA_PTR_SET_VALUE(silenceTime_, silenceTime) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setTargetMetric(string targetMetric) { DARABONBA_PTR_SET_VALUE(targetMetric_, targetMetric) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setTargetNodes(int32_t targetNodes) { DARABONBA_PTR_SET_VALUE(targetNodes_, targetNodes) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setThresholdLower(int32_t thresholdLower) { DARABONBA_PTR_SET_VALUE(thresholdLower_, thresholdLower) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setThresholdUpper(int32_t thresholdUpper) { DARABONBA_PTR_SET_VALUE(thresholdUpper_, thresholdUpper) };
    ...
    inline ModifyAutoScalingConfigRequestScaleRuleList& setTriggerCronExpr(string triggerCronExpr) { DARABONBA_PTR_SET_VALUE(triggerCronExpr_, triggerCronExpr) };
