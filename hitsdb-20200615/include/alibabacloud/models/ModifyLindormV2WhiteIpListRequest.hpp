...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->deleteGroup_ == nullptr
        && return this->groupName_ == nullptr && return this->instanceId_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr
        && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->securityToken_ == nullptr && return this->whiteIpList_ == nullptr; };
    ...
    inline bool deleteGroup() const { DARABONBA_PTR_GET_DEFAULT(deleteGroup_, false) };
  ...
  protected:
    std::shared_ptr<bool> deleteGroup_ = nullptr;
