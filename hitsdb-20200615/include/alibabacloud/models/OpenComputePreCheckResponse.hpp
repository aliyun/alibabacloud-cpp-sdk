...
namespace Models
{
  ...
  public:
    ...
    inline const OpenComputePreCheckResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenComputePreCheckResponseBody) };
    inline OpenComputePreCheckResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenComputePreCheckResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenComputePreCheckResponseBody> body_ {};
  };
