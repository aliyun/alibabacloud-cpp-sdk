...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLindormV2InstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLindormV2InstanceResponseBody) };
    inline UpdateLindormV2InstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLindormV2InstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLindormV2InstanceResponseBody> body_ {};
  };
