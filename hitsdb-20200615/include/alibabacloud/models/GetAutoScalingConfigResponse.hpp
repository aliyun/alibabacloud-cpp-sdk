...
namespace Models
{
  ...
  public:
    ...
    inline const GetAutoScalingConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAutoScalingConfigResponseBody) };
    inline GetAutoScalingConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAutoScalingConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAutoScalingConfigResponseBody> body_ {};
  };
