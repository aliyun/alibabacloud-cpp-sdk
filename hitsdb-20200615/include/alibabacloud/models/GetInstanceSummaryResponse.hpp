...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceSummaryResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceSummaryResponseBody) };
    inline GetInstanceSummaryResponseBody body() { DARABONBA_PTR_GET(body_, GetInstanceSummaryResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetInstanceSummaryResponseBody> body_ = nullptr;
  };
