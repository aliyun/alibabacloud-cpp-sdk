...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLindormV2WhiteIpListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLindormV2WhiteIpListResponseBody) };
    inline UpdateLindormV2WhiteIpListResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLindormV2WhiteIpListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLindormV2WhiteIpListResponseBody> body_ {};
  };
