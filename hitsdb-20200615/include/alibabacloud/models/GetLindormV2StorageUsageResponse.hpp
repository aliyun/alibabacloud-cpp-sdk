...
namespace Models
{
  ...
  public:
    ...
    inline const GetLindormV2StorageUsageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLindormV2StorageUsageResponseBody) };
    inline GetLindormV2StorageUsageResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLindormV2StorageUsageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLindormV2StorageUsageResponseBody> body_ {};
  };
