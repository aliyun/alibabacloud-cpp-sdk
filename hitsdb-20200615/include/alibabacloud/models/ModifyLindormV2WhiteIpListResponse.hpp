...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLindormV2WhiteIpListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLindormV2WhiteIpListResponseBody) };
    inline ModifyLindormV2WhiteIpListResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLindormV2WhiteIpListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLindormV2WhiteIpListResponseBody> body_ {};
  };
