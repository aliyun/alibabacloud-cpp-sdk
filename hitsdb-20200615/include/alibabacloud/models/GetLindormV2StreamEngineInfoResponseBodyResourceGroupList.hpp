...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->jmIpList_ == nullptr
        && return this->quantity_ == nullptr && return this->resourceGroupName_ == nullptr && return this->sgIpList_ == nullptr && return this->spec_ == nullptr && return this->specId_ == nullptr
