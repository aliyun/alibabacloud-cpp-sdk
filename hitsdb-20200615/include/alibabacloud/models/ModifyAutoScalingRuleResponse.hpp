...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAutoScalingRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAutoScalingRuleResponseBody) };
    inline ModifyAutoScalingRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAutoScalingRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAutoScalingRuleResponseBody> body_ {};
  };
