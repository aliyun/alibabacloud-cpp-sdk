...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->aliUid_ != nullptr
        ...
        && this->enableCompute_ != nullptr && this->engineList_ != nullptr && this->expiredMilliseconds_ != nullptr && this->initialRootPassword_ != nullptr && this->instanceAlias_ != nullptr
        && this->instanceId_ != nullptr && this->instanceStatus_ != nullptr && this->instanceType_ != nullptr && this->maintainEndTime_ != nullptr && this->maintainStartTime_ != nullptr
        && this->networkType_ != nullptr && this->payType_ != nullptr && this->primaryVSwitchId_ != nullptr && this->primaryZoneId_ != nullptr && this->regionId_ != nullptr
        && this->requestId_ != nullptr && this->resourceGroupId_ != nullptr && this->serviceType_ != nullptr && this->standbyVSwitchId_ != nullptr && this->standbyZoneId_ != nullptr
        && this->storageUsage_ != nullptr && this->vpcId_ != nullptr && this->vswitchId_ != nullptr && this->whiteIpList_ != nullptr && this->zoneEngineInfoMap_ != nullptr
    ...
    inline const vector<GetLindormV2InstanceResponseBodyEngineList> & engineList() const { DARABONBA_PTR_GET_CONST(engineList_, vector<GetLindormV2InstanceResponseBodyEngineList>) };
    inline vector<GetLindormV2InstanceResponseBodyEngineList> engineList() { DARABONBA_PTR_GET(engineList_, vector<GetLindormV2InstanceResponseBodyEngineList>) };
    inline GetLindormV2InstanceResponseBody& setEngineList(const vector<GetLindormV2InstanceResponseBodyEngineList> & engineList) { DARABONBA_PTR_SET_VALUE(engineList_, engineList) };
    inline GetLindormV2InstanceResponseBody& setEngineList(vector<GetLindormV2InstanceResponseBodyEngineList> && engineList) { DARABONBA_PTR_SET_RVALUE(engineList_, engineList) };
    ...
    inline const GetLindormV2InstanceResponseBodyStorageUsage & storageUsage() const { DARABONBA_PTR_GET_CONST(storageUsage_, GetLindormV2InstanceResponseBodyStorageUsage) };
    inline GetLindormV2InstanceResponseBodyStorageUsage storageUsage() { DARABONBA_PTR_GET(storageUsage_, GetLindormV2InstanceResponseBodyStorageUsage) };
    inline GetLindormV2InstanceResponseBody& setStorageUsage(const GetLindormV2InstanceResponseBodyStorageUsage & storageUsage) { DARABONBA_PTR_SET_VALUE(storageUsage_, storageUsage) };
    inline GetLindormV2InstanceResponseBody& setStorageUsage(GetLindormV2InstanceResponseBodyStorageUsage && storageUsage) { DARABONBA_PTR_SET_RVALUE(storageUsage_, storageUsage) };
    ...
    inline const vector<GetLindormV2InstanceResponseBodyWhiteIpList> & whiteIpList() const { DARABONBA_PTR_GET_CONST(whiteIpList_, vector<GetLindormV2InstanceResponseBodyWhiteIpList>) };
    inline vector<GetLindormV2InstanceResponseBodyWhiteIpList> whiteIpList() { DARABONBA_PTR_GET(whiteIpList_, vector<GetLindormV2InstanceResponseBodyWhiteIpList>) };
    inline GetLindormV2InstanceResponseBody& setWhiteIpList(const vector<GetLindormV2InstanceResponseBodyWhiteIpList> & whiteIpList) { DARABONBA_PTR_SET_VALUE(whiteIpList_, whiteIpList) };
    inline GetLindormV2InstanceResponseBody& setWhiteIpList(vector<GetLindormV2InstanceResponseBodyWhiteIpList> && whiteIpList) { DARABONBA_PTR_SET_RVALUE(whiteIpList_, whiteIpList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetLindormV2InstanceResponseBodyEngineList>> engineList_ = nullptr;
    ...
    std::shared_ptr<GetLindormV2InstanceResponseBodyStorageUsage> storageUsage_ = nullptr;
    std::shared_ptr<string> vpcId_ = nullptr;
    std::shared_ptr<string> vswitchId_ = nullptr;
    std::shared_ptr<vector<GetLindormV2InstanceResponseBodyWhiteIpList>> whiteIpList_ = nullptr;
