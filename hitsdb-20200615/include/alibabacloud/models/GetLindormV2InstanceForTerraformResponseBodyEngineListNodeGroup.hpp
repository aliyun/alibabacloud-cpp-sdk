...
#ifndef ALIBABACLOUD_MODELS_GETLINDORMV2INSTANCEFORTERRAFORMRESPONSEBODYENGINELISTNODEGROUP_HPP_
#define ALIBABACLOUD_MODELS_GETLINDORMV2INSTANCEFORTERRAFORMRESPONSEBODYENGINELISTNODEGROUP_HPP_
...
namespace Models
{
  class GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& obj) { 
    ...
    GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup() = default ;
    GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup(const GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup &) = default ;
    GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup(GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup &&) = default ;
    GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup() = default ;
    GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& operator=(const GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup &) = default ;
    GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& operator=(GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup &&) = default ;
    ...
    inline GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
    ...
    inline GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& setCpuCoreCount(int32_t cpuCoreCount) { DARABONBA_PTR_SET_VALUE(cpuCoreCount_, cpuCoreCount) };
    ...
    inline GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& setEnableAttachLocalDisk(bool enableAttachLocalDisk) { DARABONBA_PTR_SET_VALUE(enableAttachLocalDisk_, enableAttachLocalDisk) };
    ...
    inline GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& setLocalDiskCapacity(int64_t localDiskCapacity) { DARABONBA_PTR_SET_VALUE(localDiskCapacity_, localDiskCapacity) };
    ...
    inline GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& setLocalDiskCategory(string localDiskCategory) { DARABONBA_PTR_SET_VALUE(localDiskCategory_, localDiskCategory) };
    ...
    inline GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& setMemorySizeGiB(int32_t memorySizeGiB) { DARABONBA_PTR_SET_VALUE(memorySizeGiB_, memorySizeGiB) };
    ...
    inline GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& setNodeSpec(string nodeSpec) { DARABONBA_PTR_SET_VALUE(nodeSpec_, nodeSpec) };
    ...
    inline GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& setQuantity(int32_t quantity) { DARABONBA_PTR_SET_VALUE(quantity_, quantity) };
    ...
    inline GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& setResourceGroupName(string resourceGroupName) { DARABONBA_PTR_SET_VALUE(resourceGroupName_, resourceGroupName) };
    ...
    inline GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& setSpecId(string specId) { DARABONBA_PTR_SET_VALUE(specId_, specId) };
    ...
    inline GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
