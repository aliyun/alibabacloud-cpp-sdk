...
namespace Models
{
  ...
  public:
    ...
    inline const ListAutoScalingRecordsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAutoScalingRecordsResponseBodyData) };
    inline ListAutoScalingRecordsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAutoScalingRecordsResponseBodyData) };
    inline ListAutoScalingRecordsResponseBody& setData(const ListAutoScalingRecordsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAutoScalingRecordsResponseBody& setData(ListAutoScalingRecordsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListAutoScalingRecordsResponseBodyData> data_ = nullptr;
