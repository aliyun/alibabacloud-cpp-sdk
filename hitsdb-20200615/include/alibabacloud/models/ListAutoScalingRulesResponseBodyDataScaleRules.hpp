...
#ifndef ALIBABACLOUD_MODELS_LISTAUTOSCALINGRULESRESPONSEBODYDATASCALERULES_HPP_
#define ALIBABACLOUD_MODELS_LISTAUTOSCALINGRULESRESPONSEBODYDATASCALERULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAutoScalingRulesResponseBodyDataScaleRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAutoScalingRulesResponseBodyDataScaleRules& obj) { 
    ...
    ListAutoScalingRulesResponseBodyDataScaleRules() = default ;
    ListAutoScalingRulesResponseBodyDataScaleRules(const ListAutoScalingRulesResponseBodyDataScaleRules &) = default ;
    ListAutoScalingRulesResponseBodyDataScaleRules(ListAutoScalingRulesResponseBodyDataScaleRules &&) = default ;
    ListAutoScalingRulesResponseBodyDataScaleRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAutoScalingRulesResponseBodyDataScaleRules() = default ;
    ListAutoScalingRulesResponseBodyDataScaleRules& operator=(const ListAutoScalingRulesResponseBodyDataScaleRules &) = default ;
    ListAutoScalingRulesResponseBodyDataScaleRules& operator=(ListAutoScalingRulesResponseBodyDataScaleRules &&) = default ;
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setConfigId(string configId) { DARABONBA_PTR_SET_VALUE(configId_, configId) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setEnabled(bool enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setObservationWindow(int32_t observationWindow) { DARABONBA_PTR_SET_VALUE(observationWindow_, observationWindow) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setOperationType(string operationType) { DARABONBA_PTR_SET_VALUE(operationType_, operationType) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setRuleId(string ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setRuleType(string ruleType) { DARABONBA_PTR_SET_VALUE(ruleType_, ruleType) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setScaleInStep(int32_t scaleInStep) { DARABONBA_PTR_SET_VALUE(scaleInStep_, scaleInStep) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setScaleOutStep(int32_t scaleOutStep) { DARABONBA_PTR_SET_VALUE(scaleOutStep_, scaleOutStep) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setSilenceTime(int32_t silenceTime) { DARABONBA_PTR_SET_VALUE(silenceTime_, silenceTime) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setTargetMetric(string targetMetric) { DARABONBA_PTR_SET_VALUE(targetMetric_, targetMetric) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setTargetNodes(int32_t targetNodes) { DARABONBA_PTR_SET_VALUE(targetNodes_, targetNodes) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setThresholdLower(int32_t thresholdLower) { DARABONBA_PTR_SET_VALUE(thresholdLower_, thresholdLower) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setThresholdUpper(int32_t thresholdUpper) { DARABONBA_PTR_SET_VALUE(thresholdUpper_, thresholdUpper) };
    ...
    inline ListAutoScalingRulesResponseBodyDataScaleRules& setTriggerCronExpr(string triggerCronExpr) { DARABONBA_PTR_SET_VALUE(triggerCronExpr_, triggerCronExpr) };
