...
#ifndef ALIBABACLOUD_MODELS_LISTAUTOSCALINGCONFIGSRESPONSEBODYDATASCALECONFIGSSCALERULELIST_HPP_
#define ALIBABACLOUD_MODELS_LISTAUTOSCALINGCONFIGSRESPONSEBODYDATASCALECONFIGSSCALERULELIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& obj) { 
    ...
    ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList() = default ;
    ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList(const ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList &) = default ;
    ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList(ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList &&) = default ;
    ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList() = default ;
    ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& operator=(const ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList &) = default ;
    ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& operator=(ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList &&) = default ;
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setConfigId(string configId) { DARABONBA_PTR_SET_VALUE(configId_, configId) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setEnabled(bool enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setObservationWindow(int32_t observationWindow) { DARABONBA_PTR_SET_VALUE(observationWindow_, observationWindow) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setOperationType(string operationType) { DARABONBA_PTR_SET_VALUE(operationType_, operationType) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setRuleId(string ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setRuleType(string ruleType) { DARABONBA_PTR_SET_VALUE(ruleType_, ruleType) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setScaleInStep(int32_t scaleInStep) { DARABONBA_PTR_SET_VALUE(scaleInStep_, scaleInStep) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setScaleOutStep(int32_t scaleOutStep) { DARABONBA_PTR_SET_VALUE(scaleOutStep_, scaleOutStep) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setSilenceTime(int32_t silenceTime) { DARABONBA_PTR_SET_VALUE(silenceTime_, silenceTime) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setTargetMetric(string targetMetric) { DARABONBA_PTR_SET_VALUE(targetMetric_, targetMetric) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setTargetNodes(int32_t targetNodes) { DARABONBA_PTR_SET_VALUE(targetNodes_, targetNodes) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setThresholdLower(int32_t thresholdLower) { DARABONBA_PTR_SET_VALUE(thresholdLower_, thresholdLower) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setThresholdUpper(int32_t thresholdUpper) { DARABONBA_PTR_SET_VALUE(thresholdUpper_, thresholdUpper) };
    ...
    inline ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList& setTriggerCronExpr(string triggerCronExpr) { DARABONBA_PTR_SET_VALUE(triggerCronExpr_, triggerCronExpr) };
