...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetLindormV2InstanceDetailsResponseBodyEngineList> & engineList() const { DARABONBA_PTR_GET_CONST(engineList_, vector<GetLindormV2InstanceDetailsResponseBodyEngineList>) };
    inline vector<GetLindormV2InstanceDetailsResponseBodyEngineList> engineList() { DARABONBA_PTR_GET(engineList_, vector<GetLindormV2InstanceDetailsResponseBodyEngineList>) };
    inline GetLindormV2InstanceDetailsResponseBody& setEngineList(const vector<GetLindormV2InstanceDetailsResponseBodyEngineList> & engineList) { DARABONBA_PTR_SET_VALUE(engineList_, engineList) };
    inline GetLindormV2InstanceDetailsResponseBody& setEngineList(vector<GetLindormV2InstanceDetailsResponseBodyEngineList> && engineList) { DARABONBA_PTR_SET_RVALUE(engineList_, engineList) };
    ...
    inline const GetLindormV2InstanceDetailsResponseBodyStorageUsage & storageUsage() const { DARABONBA_PTR_GET_CONST(storageUsage_, GetLindormV2InstanceDetailsResponseBodyStorageUsage) };
    inline GetLindormV2InstanceDetailsResponseBodyStorageUsage storageUsage() { DARABONBA_PTR_GET(storageUsage_, GetLindormV2InstanceDetailsResponseBodyStorageUsage) };
    inline GetLindormV2InstanceDetailsResponseBody& setStorageUsage(const GetLindormV2InstanceDetailsResponseBodyStorageUsage & storageUsage) { DARABONBA_PTR_SET_VALUE(storageUsage_, storageUsage) };
    inline GetLindormV2InstanceDetailsResponseBody& setStorageUsage(GetLindormV2InstanceDetailsResponseBodyStorageUsage && storageUsage) { DARABONBA_PTR_SET_RVALUE(storageUsage_, storageUsage) };
    ...
    inline const vector<GetLindormV2InstanceDetailsResponseBodyWhiteIpList> & whiteIpList() const { DARABONBA_PTR_GET_CONST(whiteIpList_, vector<GetLindormV2InstanceDetailsResponseBodyWhiteIpList>) };
    inline vector<GetLindormV2InstanceDetailsResponseBodyWhiteIpList> whiteIpList() { DARABONBA_PTR_GET(whiteIpList_, vector<GetLindormV2InstanceDetailsResponseBodyWhiteIpList>) };
    inline GetLindormV2InstanceDetailsResponseBody& setWhiteIpList(const vector<GetLindormV2InstanceDetailsResponseBodyWhiteIpList> & whiteIpList) { DARABONBA_PTR_SET_VALUE(whiteIpList_, whiteIpList) };
    inline GetLindormV2InstanceDetailsResponseBody& setWhiteIpList(vector<GetLindormV2InstanceDetailsResponseBodyWhiteIpList> && whiteIpList) { DARABONBA_PTR_SET_RVALUE(whiteIpList_, whiteIpList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetLindormV2InstanceDetailsResponseBodyEngineList>> engineList_ = nullptr;
    ...
    std::shared_ptr<GetLindormV2InstanceDetailsResponseBodyStorageUsage> storageUsage_ = nullptr;
    std::shared_ptr<string> vpcId_ = nullptr;
    std::shared_ptr<string> vswitchId_ = nullptr;
    std::shared_ptr<vector<GetLindormV2InstanceDetailsResponseBodyWhiteIpList>> whiteIpList_ = nullptr;
