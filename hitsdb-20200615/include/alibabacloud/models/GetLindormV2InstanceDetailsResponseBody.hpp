...
#ifndef ALIBABACLOUD_MODELS_GETLINDORMV2INSTANCEDETAILSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETLINDORMV2INSTANCEDETAILSRESPONSEBODY_HPP_
...
namespace Models
{
  class GetLindormV2InstanceDetailsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetLindormV2InstanceDetailsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetLindormV2InstanceDetailsResponseBody& obj) { 
    ...
    GetLindormV2InstanceDetailsResponseBody() = default ;
    GetLindormV2InstanceDetailsResponseBody(const GetLindormV2InstanceDetailsResponseBody &) = default ;
    GetLindormV2InstanceDetailsResponseBody(GetLindormV2InstanceDetailsResponseBody &&) = default ;
    GetLindormV2InstanceDetailsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetLindormV2InstanceDetailsResponseBody() = default ;
    GetLindormV2InstanceDetailsResponseBody& operator=(const GetLindormV2InstanceDetailsResponseBody &) = default ;
    GetLindormV2InstanceDetailsResponseBody& operator=(GetLindormV2InstanceDetailsResponseBody &&) = default ;
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setAliUid(int64_t aliUid) { DARABONBA_PTR_SET_VALUE(aliUid_, aliUid) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setArbiterVSwitchId(string arbiterVSwitchId) { DARABONBA_PTR_SET_VALUE(arbiterVSwitchId_, arbiterVSwitchId) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setArbiterZoneId(string arbiterZoneId) { DARABONBA_PTR_SET_VALUE(arbiterZoneId_, arbiterZoneId) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setAutoRenew(bool autoRenew) { DARABONBA_PTR_SET_VALUE(autoRenew_, autoRenew) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setCloudStorageSize(int64_t cloudStorageSize) { DARABONBA_PTR_SET_VALUE(cloudStorageSize_, cloudStorageSize) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setColdStorage(int32_t coldStorage) { DARABONBA_PTR_SET_VALUE(coldStorage_, coldStorage) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setCreateMilliseconds(int64_t createMilliseconds) { DARABONBA_PTR_SET_VALUE(createMilliseconds_, createMilliseconds) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setDeletionProtection(string deletionProtection) { DARABONBA_PTR_SET_VALUE(deletionProtection_, deletionProtection) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setDiskCategory(string diskCategory) { DARABONBA_PTR_SET_VALUE(diskCategory_, diskCategory) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setDiskThreshold(string diskThreshold) { DARABONBA_PTR_SET_VALUE(diskThreshold_, diskThreshold) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setDiskUsage(string diskUsage) { DARABONBA_PTR_SET_VALUE(diskUsage_, diskUsage) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setEnableCompute(bool enableCompute) { DARABONBA_PTR_SET_VALUE(enableCompute_, enableCompute) };


    // enableFs Field Functions 
    bool hasEnableFs() const { return this->enableFs_ != nullptr;};
    void deleteEnableFs() { this->enableFs_ = nullptr;};
    inline string getEnableFs() const { DARABONBA_PTR_GET_DEFAULT(enableFs_, "") };
    inline GetLindormV2InstanceDetailsResponseBody& setEnableFs(string enableFs) { DARABONBA_PTR_SET_VALUE(enableFs_, enableFs) };
    ...
    inline string getEnableStoreTDE() const { DARABONBA_PTR_GET_DEFAULT(enableStoreTDE_, "") };
    inline GetLindormV2InstanceDetailsResponseBody& setEnableStoreTDE(string enableStoreTDE) { DARABONBA_PTR_SET_VALUE(enableStoreTDE_, enableStoreTDE) };
    ...
    inline const vector<GetLindormV2InstanceDetailsResponseBody::EngineList> & getEngineList() const { DARABONBA_PTR_GET_CONST(engineList_, vector<GetLindormV2InstanceDetailsResponseBody::EngineList>) };
    inline vector<GetLindormV2InstanceDetailsResponseBody::EngineList> getEngineList() { DARABONBA_PTR_GET(engineList_, vector<GetLindormV2InstanceDetailsResponseBody::EngineList>) };
    inline GetLindormV2InstanceDetailsResponseBody& setEngineList(const vector<GetLindormV2InstanceDetailsResponseBody::EngineList> & engineList) { DARABONBA_PTR_SET_VALUE(engineList_, engineList) };
    inline GetLindormV2InstanceDetailsResponseBody& setEngineList(vector<GetLindormV2InstanceDetailsResponseBody::EngineList> && engineList) { DARABONBA_PTR_SET_RVALUE(engineList_, engineList) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setExpiredMilliseconds(int64_t expiredMilliseconds) { DARABONBA_PTR_SET_VALUE(expiredMilliseconds_, expiredMilliseconds) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setInitialRootPassword(string initialRootPassword) { DARABONBA_PTR_SET_VALUE(initialRootPassword_, initialRootPassword) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setInstanceAlias(string instanceAlias) { DARABONBA_PTR_SET_VALUE(instanceAlias_, instanceAlias) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setInstanceStatus(string instanceStatus) { DARABONBA_PTR_SET_VALUE(instanceStatus_, instanceStatus) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setMaintainEndTime(string maintainEndTime) { DARABONBA_PTR_SET_VALUE(maintainEndTime_, maintainEndTime) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setMaintainStartTime(string maintainStartTime) { DARABONBA_PTR_SET_VALUE(maintainStartTime_, maintainStartTime) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setNetworkType(string networkType) { DARABONBA_PTR_SET_VALUE(networkType_, networkType) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setPayType(string payType) { DARABONBA_PTR_SET_VALUE(payType_, payType) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setPrimaryVSwitchId(string primaryVSwitchId) { DARABONBA_PTR_SET_VALUE(primaryVSwitchId_, primaryVSwitchId) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setPrimaryZoneId(string primaryZoneId) { DARABONBA_PTR_SET_VALUE(primaryZoneId_, primaryZoneId) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setServiceType(string serviceType) { DARABONBA_PTR_SET_VALUE(serviceType_, serviceType) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setStandbyVSwitchId(string standbyVSwitchId) { DARABONBA_PTR_SET_VALUE(standbyVSwitchId_, standbyVSwitchId) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setStandbyZoneId(string standbyZoneId) { DARABONBA_PTR_SET_VALUE(standbyZoneId_, standbyZoneId) };
    ...
    inline const GetLindormV2InstanceDetailsResponseBody::StorageUsage & getStorageUsage() const { DARABONBA_PTR_GET_CONST(storageUsage_, GetLindormV2InstanceDetailsResponseBody::StorageUsage) };
    inline GetLindormV2InstanceDetailsResponseBody::StorageUsage getStorageUsage() { DARABONBA_PTR_GET(storageUsage_, GetLindormV2InstanceDetailsResponseBody::StorageUsage) };
    inline GetLindormV2InstanceDetailsResponseBody& setStorageUsage(const GetLindormV2InstanceDetailsResponseBody::StorageUsage & storageUsage) { DARABONBA_PTR_SET_VALUE(storageUsage_, storageUsage) };
    inline GetLindormV2InstanceDetailsResponseBody& setStorageUsage(GetLindormV2InstanceDetailsResponseBody::StorageUsage && storageUsage) { DARABONBA_PTR_SET_RVALUE(storageUsage_, storageUsage) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setVswitchId(string vswitchId) { DARABONBA_PTR_SET_VALUE(vswitchId_, vswitchId) };
    ...
    inline const vector<GetLindormV2InstanceDetailsResponseBody::WhiteIpList> & getWhiteIpList() const { DARABONBA_PTR_GET_CONST(whiteIpList_, vector<GetLindormV2InstanceDetailsResponseBody::WhiteIpList>) };
    inline vector<GetLindormV2InstanceDetailsResponseBody::WhiteIpList> getWhiteIpList() { DARABONBA_PTR_GET(whiteIpList_, vector<GetLindormV2InstanceDetailsResponseBody::WhiteIpList>) };
    inline GetLindormV2InstanceDetailsResponseBody& setWhiteIpList(const vector<GetLindormV2InstanceDetailsResponseBody::WhiteIpList> & whiteIpList) { DARABONBA_PTR_SET_VALUE(whiteIpList_, whiteIpList) };
    inline GetLindormV2InstanceDetailsResponseBody& setWhiteIpList(vector<GetLindormV2InstanceDetailsResponseBody::WhiteIpList> && whiteIpList) { DARABONBA_PTR_SET_RVALUE(whiteIpList_, whiteIpList) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setZoneEngineInfoMap(const Darabonba::Json & zoneEngineInfoMap) { DARABONBA_SET_VALUE(zoneEngineInfoMap_, zoneEngineInfoMap) };
    inline GetLindormV2InstanceDetailsResponseBody& setZoneEngineInfoMap(Darabonba::Json && zoneEngineInfoMap) { DARABONBA_SET_RVALUE(zoneEngineInfoMap_, zoneEngineInfoMap) };
    ...
    inline GetLindormV2InstanceDetailsResponseBody& setZoneId(string zoneId) { DARABONBA_PTR_SET_VALUE(zoneId_, zoneId) };
