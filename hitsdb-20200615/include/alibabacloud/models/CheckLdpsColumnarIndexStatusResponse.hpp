...
namespace Models
{
  ...
  public:
    ...
    inline const CheckLdpsColumnarIndexStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckLdpsColumnarIndexStatusResponseBody) };
    inline CheckLdpsColumnarIndexStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckLdpsColumnarIndexStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckLdpsColumnarIndexStatusResponseBody> body_ {};
  };
