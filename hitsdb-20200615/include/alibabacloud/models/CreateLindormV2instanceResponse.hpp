...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLindormV2InstanceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateLindormV2InstanceResponseBody) };
    inline CreateLindormV2InstanceResponseBody body() { DARABONBA_PTR_GET(body_, CreateLindormV2InstanceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateLindormV2InstanceResponseBody> body_ = nullptr;
  };
