...
#ifndef ALIBABACLOUD_MODELS_CHECKCREATELINDORMV2INSTANCEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CHECKCREATELINDORMV2INSTANCEREQUEST_HPP_
...
namespace Models
{
  class CheckCreateLindormV2InstanceRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CheckCreateLindormV2InstanceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CheckCreateLindormV2InstanceRequest& obj) { 
    ...
    CheckCreateLindormV2InstanceRequest() = default ;
    CheckCreateLindormV2InstanceRequest(const CheckCreateLindormV2InstanceRequest &) = default ;
    CheckCreateLindormV2InstanceRequest(CheckCreateLindormV2InstanceRequest &&) = default ;
    CheckCreateLindormV2InstanceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CheckCreateLindormV2InstanceRequest() = default ;
    CheckCreateLindormV2InstanceRequest& operator=(const CheckCreateLindormV2InstanceRequest &) = default ;
    CheckCreateLindormV2InstanceRequest& operator=(CheckCreateLindormV2InstanceRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->arbiterVSwitchId_ == nullptr
        && this->arbiterZoneId_ == nullptr && this->archVersion_ == nullptr && this->cloudStorageSize_ == nullptr && this->cloudStorageType_ == nullptr && this->clusterPattern_ == nullptr
        && this->engineList_ == nullptr && this->instanceAlias_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->primaryVSwitchId_ == nullptr
        && this->primaryZoneId_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr
        && this->securityToken_ == nullptr && this->standbyVSwitchId_ == nullptr && this->standbyZoneId_ == nullptr && this->VPCId_ == nullptr && this->vSwitchId_ == nullptr
    ...
    inline CheckCreateLindormV2InstanceRequest& setArbiterVSwitchId(string arbiterVSwitchId) { DARABONBA_PTR_SET_VALUE(arbiterVSwitchId_, arbiterVSwitchId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setArbiterZoneId(string arbiterZoneId) { DARABONBA_PTR_SET_VALUE(arbiterZoneId_, arbiterZoneId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setArchVersion(string archVersion) { DARABONBA_PTR_SET_VALUE(archVersion_, archVersion) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setCloudStorageSize(int32_t cloudStorageSize) { DARABONBA_PTR_SET_VALUE(cloudStorageSize_, cloudStorageSize) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setCloudStorageType(string cloudStorageType) { DARABONBA_PTR_SET_VALUE(cloudStorageType_, cloudStorageType) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setClusterPattern(string clusterPattern) { DARABONBA_PTR_SET_VALUE(clusterPattern_, clusterPattern) };
    ...
    inline const vector<CheckCreateLindormV2InstanceRequest::EngineList> & getEngineList() const { DARABONBA_PTR_GET_CONST(engineList_, vector<CheckCreateLindormV2InstanceRequest::EngineList>) };
    inline vector<CheckCreateLindormV2InstanceRequest::EngineList> getEngineList() { DARABONBA_PTR_GET(engineList_, vector<CheckCreateLindormV2InstanceRequest::EngineList>) };
    inline CheckCreateLindormV2InstanceRequest& setEngineList(const vector<CheckCreateLindormV2InstanceRequest::EngineList> & engineList) { DARABONBA_PTR_SET_VALUE(engineList_, engineList) };
    inline CheckCreateLindormV2InstanceRequest& setEngineList(vector<CheckCreateLindormV2InstanceRequest::EngineList> && engineList) { DARABONBA_PTR_SET_RVALUE(engineList_, engineList) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setInstanceAlias(string instanceAlias) { DARABONBA_PTR_SET_VALUE(instanceAlias_, instanceAlias) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setPrimaryVSwitchId(string primaryVSwitchId) { DARABONBA_PTR_SET_VALUE(primaryVSwitchId_, primaryVSwitchId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setPrimaryZoneId(string primaryZoneId) { DARABONBA_PTR_SET_VALUE(primaryZoneId_, primaryZoneId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setSecurityToken(string securityToken) { DARABONBA_PTR_SET_VALUE(securityToken_, securityToken) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setStandbyVSwitchId(string standbyVSwitchId) { DARABONBA_PTR_SET_VALUE(standbyVSwitchId_, standbyVSwitchId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setStandbyZoneId(string standbyZoneId) { DARABONBA_PTR_SET_VALUE(standbyZoneId_, standbyZoneId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setVPCId(string VPCId) { DARABONBA_PTR_SET_VALUE(VPCId_, VPCId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setVSwitchId(string vSwitchId) { DARABONBA_PTR_SET_VALUE(vSwitchId_, vSwitchId) };
    ...
    inline CheckCreateLindormV2InstanceRequest& setZoneId(string zoneId) { DARABONBA_PTR_SET_VALUE(zoneId_, zoneId) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<CheckCreateLindormV2InstanceRequest::EngineList>> engineList_ {};
