...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLindormInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLindormInstanceResponseBody) };
    inline CreateLindormInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLindormInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLindormInstanceResponseBody> body_ {};
  };
