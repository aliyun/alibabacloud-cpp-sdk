...
#ifndef ALIBABACLOUD_MODELS_GETAUTOSCALINGRULERESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETAUTOSCALINGRULERESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAutoScalingRuleResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAutoScalingRuleResponseBodyData& obj) { 
    ...
    GetAutoScalingRuleResponseBodyData() = default ;
    GetAutoScalingRuleResponseBodyData(const GetAutoScalingRuleResponseBodyData &) = default ;
    GetAutoScalingRuleResponseBodyData(GetAutoScalingRuleResponseBodyData &&) = default ;
    GetAutoScalingRuleResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAutoScalingRuleResponseBodyData() = default ;
    GetAutoScalingRuleResponseBodyData& operator=(const GetAutoScalingRuleResponseBodyData &) = default ;
    GetAutoScalingRuleResponseBodyData& operator=(GetAutoScalingRuleResponseBodyData &&) = default ;
    ...
    inline GetAutoScalingRuleResponseBodyData& setConfigId(string configId) { DARABONBA_PTR_SET_VALUE(configId_, configId) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setEnabled(bool enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setObservationWindow(int32_t observationWindow) { DARABONBA_PTR_SET_VALUE(observationWindow_, observationWindow) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setOperationType(string operationType) { DARABONBA_PTR_SET_VALUE(operationType_, operationType) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setRuleId(string ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setRuleType(string ruleType) { DARABONBA_PTR_SET_VALUE(ruleType_, ruleType) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setScaleInStep(int32_t scaleInStep) { DARABONBA_PTR_SET_VALUE(scaleInStep_, scaleInStep) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setScaleOutStep(int32_t scaleOutStep) { DARABONBA_PTR_SET_VALUE(scaleOutStep_, scaleOutStep) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setSilenceTime(int32_t silenceTime) { DARABONBA_PTR_SET_VALUE(silenceTime_, silenceTime) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setTargetMetric(string targetMetric) { DARABONBA_PTR_SET_VALUE(targetMetric_, targetMetric) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setTargetNodes(int32_t targetNodes) { DARABONBA_PTR_SET_VALUE(targetNodes_, targetNodes) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setThresholdLower(int32_t thresholdLower) { DARABONBA_PTR_SET_VALUE(thresholdLower_, thresholdLower) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setThresholdUpper(int32_t thresholdUpper) { DARABONBA_PTR_SET_VALUE(thresholdUpper_, thresholdUpper) };
    ...
    inline GetAutoScalingRuleResponseBodyData& setTriggerCronExpr(string triggerCronExpr) { DARABONBA_PTR_SET_VALUE(triggerCronExpr_, triggerCronExpr) };
