...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateCommandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateCommandResponseBody) };
    inline UpdateCommandResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateCommandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateCommandResponseBody> body_ {};
  };
