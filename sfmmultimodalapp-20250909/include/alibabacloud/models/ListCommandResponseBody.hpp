...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListCommandResponseBodyToolInfoList> & toolInfoList() const { DARABONBA_PTR_GET_CONST(toolInfoList_, vector<ListCommandResponseBodyToolInfoList>) };
    inline vector<ListCommandResponseBodyToolInfoList> toolInfoList() { DARABONBA_PTR_GET(toolInfoList_, vector<ListCommandResponseBodyToolInfoList>) };
    inline ListCommandResponseBody& setToolInfoList(const vector<ListCommandResponseBodyToolInfoList> & toolInfoList) { DARABONBA_PTR_SET_VALUE(toolInfoList_, toolInfoList) };
    inline ListCommandResponseBody& setToolInfoList(vector<ListCommandResponseBodyToolInfoList> && toolInfoList) { DARABONBA_PTR_SET_RVALUE(toolInfoList_, toolInfoList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListCommandResponseBodyToolInfoList>> toolInfoList_ = nullptr;
