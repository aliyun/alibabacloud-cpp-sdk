...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMemoryResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, UpdateMemoryResponseBody::Data) };
    inline UpdateMemoryResponseBody::Data getData() { DARABONBA_PTR_GET(data_, UpdateMemoryResponseBody::Data) };
    inline UpdateMemoryResponseBody& setData(const UpdateMemoryResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateMemoryResponseBody& setData(UpdateMemoryResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline UpdateMemoryResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UpdateMemoryResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateMemoryResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<UpdateMemoryResponseBody::Data> data_ {};
