...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMemoryResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteMemoryResponseBody::Data) };
    inline DeleteMemoryResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteMemoryResponseBody::Data) };
    inline DeleteMemoryResponseBody& setData(const DeleteMemoryResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteMemoryResponseBody& setData(DeleteMemoryResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DeleteMemoryResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline DeleteMemoryResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DeleteMemoryResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<DeleteMemoryResponseBody::Data> data_ {};
