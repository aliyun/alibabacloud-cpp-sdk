...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCommandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCommandResponseBody) };
    inline CreateCommandResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCommandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCommandResponseBody> body_ {};
  };
