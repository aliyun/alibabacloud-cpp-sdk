...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMmAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMmAppResponseBody) };
    inline DeleteMmAppResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMmAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMmAppResponseBody> body_ {};
  };
