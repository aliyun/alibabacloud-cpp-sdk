...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMmAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateMmAppResponseBody) };
    inline UpdateMmAppResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateMmAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateMmAppResponseBody> body_ {};
  };
