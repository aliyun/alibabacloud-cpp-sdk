...
namespace Models
{
  ...
  public:
    ...
    inline const ListPublishedMmAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPublishedMmAppResponseBody) };
    inline ListPublishedMmAppResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPublishedMmAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPublishedMmAppResponseBody> body_ {};
  };
