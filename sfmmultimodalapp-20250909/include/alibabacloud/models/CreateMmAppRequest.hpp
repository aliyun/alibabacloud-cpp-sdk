...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMmAppRequest::BindingConfig & getBindingConfig() const { DARABONBA_PTR_GET_CONST(bindingConfig_, CreateMmAppRequest::BindingConfig) };
    inline CreateMmAppRequest::BindingConfig getBindingConfig() { DARABONBA_PTR_GET(bindingConfig_, CreateMmAppRequest::BindingConfig) };
    inline CreateMmAppRequest& setBindingConfig(const CreateMmAppRequest::BindingConfig & bindingConfig) { DARABONBA_PTR_SET_VALUE(bindingConfig_, bindingConfig) };
    inline CreateMmAppRequest& setBindingConfig(CreateMmAppRequest::BindingConfig && bindingConfig) { DARABONBA_PTR_SET_RVALUE(bindingConfig_, bindingConfig) };
    ...
    inline const CreateMmAppRequest::ConversationConfig & getConversationConfig() const { DARABONBA_PTR_GET_CONST(conversationConfig_, CreateMmAppRequest::ConversationConfig) };
    inline CreateMmAppRequest::ConversationConfig getConversationConfig() { DARABONBA_PTR_GET(conversationConfig_, CreateMmAppRequest::ConversationConfig) };
    inline CreateMmAppRequest& setConversationConfig(const CreateMmAppRequest::ConversationConfig & conversationConfig) { DARABONBA_PTR_SET_VALUE(conversationConfig_, conversationConfig) };
    inline CreateMmAppRequest& setConversationConfig(CreateMmAppRequest::ConversationConfig && conversationConfig) { DARABONBA_PTR_SET_RVALUE(conversationConfig_, conversationConfig) };
    ...
    inline const CreateMmAppRequest::ModelConfig & getModelConfig() const { DARABONBA_PTR_GET_CONST(modelConfig_, CreateMmAppRequest::ModelConfig) };
    inline CreateMmAppRequest::ModelConfig getModelConfig() { DARABONBA_PTR_GET(modelConfig_, CreateMmAppRequest::ModelConfig) };
    inline CreateMmAppRequest& setModelConfig(const CreateMmAppRequest::ModelConfig & modelConfig) { DARABONBA_PTR_SET_VALUE(modelConfig_, modelConfig) };
    inline CreateMmAppRequest& setModelConfig(CreateMmAppRequest::ModelConfig && modelConfig) { DARABONBA_PTR_SET_RVALUE(modelConfig_, modelConfig) };
  ...
  protected:
    ...
    shared_ptr<CreateMmAppRequest::BindingConfig> bindingConfig_ {};
    shared_ptr<CreateMmAppRequest::ConversationConfig> conversationConfig_ {};
    shared_ptr<CreateMmAppRequest::ModelConfig> modelConfig_ {};
