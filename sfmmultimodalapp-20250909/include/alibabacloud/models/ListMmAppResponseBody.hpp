...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline string getHistoryLimit() const { DARABONBA_PTR_GET_DEFAULT(historyLimit_, "") };
        inline ModelConfig& setHistoryLimit(string historyLimit) { DARABONBA_PTR_SET_VALUE(historyLimit_, historyLimit) };
      ...
      protected:
        shared_ptr<string> historyLimit_ {};
      ...
      inline const AppInfoList::ConversationConfig & getConversationConfig() const { DARABONBA_PTR_GET_CONST(conversationConfig_, AppInfoList::ConversationConfig) };
      inline AppInfoList::ConversationConfig getConversationConfig() { DARABONBA_PTR_GET(conversationConfig_, AppInfoList::ConversationConfig) };
      inline AppInfoList& setConversationConfig(const AppInfoList::ConversationConfig & conversationConfig) { DARABONBA_PTR_SET_VALUE(conversationConfig_, conversationConfig) };
      inline AppInfoList& setConversationConfig(AppInfoList::ConversationConfig && conversationConfig) { DARABONBA_PTR_SET_RVALUE(conversationConfig_, conversationConfig) };
      ...
      inline AppInfoList& setCreateUserId(string createUserId) { DARABONBA_PTR_SET_VALUE(createUserId_, createUserId) };
      ...
      inline AppInfoList& setCreateUserName(string createUserName) { DARABONBA_PTR_SET_VALUE(createUserName_, createUserName) };
      ...
      inline AppInfoList& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
      ...
      inline AppInfoList& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
      ...
      inline const AppInfoList::ModelConfig & getModelConfig() const { DARABONBA_PTR_GET_CONST(modelConfig_, AppInfoList::ModelConfig) };
      inline AppInfoList::ModelConfig getModelConfig() { DARABONBA_PTR_GET(modelConfig_, AppInfoList::ModelConfig) };
      inline AppInfoList& setModelConfig(const AppInfoList::ModelConfig & modelConfig) { DARABONBA_PTR_SET_VALUE(modelConfig_, modelConfig) };
      inline AppInfoList& setModelConfig(AppInfoList::ModelConfig && modelConfig) { DARABONBA_PTR_SET_RVALUE(modelConfig_, modelConfig) };
      ...
      inline AppInfoList& setModifyUserId(string modifyUserId) { DARABONBA_PTR_SET_VALUE(modifyUserId_, modifyUserId) };
      ...
      inline AppInfoList& setModifyUserName(string modifyUserName) { DARABONBA_PTR_SET_VALUE(modifyUserName_, modifyUserName) };
      ...
      inline AppInfoList& setPrompt(string prompt) { DARABONBA_PTR_SET_VALUE(prompt_, prompt) };
      ...
      inline AppInfoList& setPublishVersion(int64_t publishVersion) { DARABONBA_PTR_SET_VALUE(publishVersion_, publishVersion) };
      ...
      inline AppInfoList& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };


    protected:
      shared_ptr<string> appId_ {};
      shared_ptr<string> appName_ {};
      shared_ptr<AppInfoList::ConversationConfig> conversationConfig_ {};
      shared_ptr<string> createUserId_ {};
      shared_ptr<string> createUserName_ {};
      shared_ptr<string> gmtCreate_ {};
      shared_ptr<string> gmtModified_ {};
      shared_ptr<AppInfoList::ModelConfig> modelConfig_ {};
    ...
    inline const vector<ListMmAppResponseBody::AppInfoList> & getAppInfoList() const { DARABONBA_PTR_GET_CONST(appInfoList_, vector<ListMmAppResponseBody::AppInfoList>) };
    inline vector<ListMmAppResponseBody::AppInfoList> getAppInfoList() { DARABONBA_PTR_GET(appInfoList_, vector<ListMmAppResponseBody::AppInfoList>) };
    inline ListMmAppResponseBody& setAppInfoList(const vector<ListMmAppResponseBody::AppInfoList> & appInfoList) { DARABONBA_PTR_SET_VALUE(appInfoList_, appInfoList) };
    inline ListMmAppResponseBody& setAppInfoList(vector<ListMmAppResponseBody::AppInfoList> && appInfoList) { DARABONBA_PTR_SET_RVALUE(appInfoList_, appInfoList) };
  ...
  protected:
    shared_ptr<vector<ListMmAppResponseBody::AppInfoList>> appInfoList_ {};
