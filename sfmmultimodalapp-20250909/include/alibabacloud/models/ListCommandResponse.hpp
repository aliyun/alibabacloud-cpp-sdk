...
namespace Models
{
  ...
  public:
    ...
    inline const ListCommandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCommandResponseBody) };
    inline ListCommandResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCommandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCommandResponseBody> body_ {};
  };
