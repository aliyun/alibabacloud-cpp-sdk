...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDBCLUSTERPARAMETERSRESPONSEBODYRUNNINGPARAMETERSPARAMETER_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDBCLUSTERPARAMETERSRESPONSEBODYRUNNINGPARAMETERSPARAMETER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDBClusterParametersResponseBodyRunningParametersParameter& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDBClusterParametersResponseBodyRunningParametersParameter& obj) { 
    ...
    DescribeDBClusterParametersResponseBodyRunningParametersParameter() = default ;
    DescribeDBClusterParametersResponseBodyRunningParametersParameter(const DescribeDBClusterParametersResponseBodyRunningParametersParameter &) = default ;
    DescribeDBClusterParametersResponseBodyRunningParametersParameter(DescribeDBClusterParametersResponseBodyRunningParametersParameter &&) = default ;
    DescribeDBClusterParametersResponseBodyRunningParametersParameter(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDBClusterParametersResponseBodyRunningParametersParameter() = default ;
    DescribeDBClusterParametersResponseBodyRunningParametersParameter& operator=(const DescribeDBClusterParametersResponseBodyRunningParametersParameter &) = default ;
    DescribeDBClusterParametersResponseBodyRunningParametersParameter& operator=(DescribeDBClusterParametersResponseBodyRunningParametersParameter &&) = default ;
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setCheckingCode(string checkingCode) { DARABONBA_PTR_SET_VALUE(checkingCode_, checkingCode) };
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setDataType(string dataType) { DARABONBA_PTR_SET_VALUE(dataType_, dataType) };
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setDefaultParameterValue(string defaultParameterValue) { DARABONBA_PTR_SET_VALUE(defaultParameterValue_, defaultParameterValue) };
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setFactor(string factor) { DARABONBA_PTR_SET_VALUE(factor_, factor) };
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setForceRestart(bool forceRestart) { DARABONBA_PTR_SET_VALUE(forceRestart_, forceRestart) };
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setIsModifiable(bool isModifiable) { DARABONBA_PTR_SET_VALUE(isModifiable_, isModifiable) };
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setIsNodeAvailable(string isNodeAvailable) { DARABONBA_PTR_SET_VALUE(isNodeAvailable_, isNodeAvailable) };
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setParamRelyRule(string paramRelyRule) { DARABONBA_PTR_SET_VALUE(paramRelyRule_, paramRelyRule) };
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setParameterDescription(string parameterDescription) { DARABONBA_PTR_SET_VALUE(parameterDescription_, parameterDescription) };
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setParameterName(string parameterName) { DARABONBA_PTR_SET_VALUE(parameterName_, parameterName) };
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setParameterStatus(string parameterStatus) { DARABONBA_PTR_SET_VALUE(parameterStatus_, parameterStatus) };
    ...
    inline DescribeDBClusterParametersResponseBodyRunningParametersParameter& setParameterValue(string parameterValue) { DARABONBA_PTR_SET_VALUE(parameterValue_, parameterValue) };
