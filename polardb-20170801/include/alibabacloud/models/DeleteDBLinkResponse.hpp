...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBLinkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDBLinkResponseBody) };
    inline DeleteDBLinkResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDBLinkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDBLinkResponseBody> body_ {};
  };
