...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && return this->fromTimeService_ == nullptr && return this->isSwitchOverForDisaster_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->plannedEndTime_ == nullptr
        && return this->plannedStartTime_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->VPCId_ == nullptr && return this->vSwitchId_ == nullptr
    ...
    inline string isSwitchOverForDisaster() const { DARABONBA_PTR_GET_DEFAULT(isSwitchOverForDisaster_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> isSwitchOverForDisaster_ = nullptr;
