...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterEndpointsZonalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterEndpointsZonalResponseBody) };
    inline DescribeDBClusterEndpointsZonalResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterEndpointsZonalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterEndpointsZonalResponseBody> body_ {};
  };
