...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMaskingRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMaskingRulesResponseBody) };
    inline DescribeMaskingRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMaskingRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMaskingRulesResponseBody> body_ {};
  };
