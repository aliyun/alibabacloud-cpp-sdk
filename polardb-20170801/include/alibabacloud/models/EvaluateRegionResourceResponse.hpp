...
namespace Models
{
  ...
  public:
    ...
    inline const EvaluateRegionResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EvaluateRegionResourceResponseBody) };
    inline EvaluateRegionResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, EvaluateRegionResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EvaluateRegionResourceResponseBody> body_ {};
  };
