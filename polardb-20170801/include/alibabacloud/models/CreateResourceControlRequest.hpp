...
#ifndef ALIBABACLOUD_MODELS_CREATERESOURCECONTROLREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATERESOURCECONTROLREQUEST_HPP_
...
namespace Models
{
  class CreateResourceControlRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateResourceControlRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateResourceControlRequest& obj) { 
    ...
    CreateResourceControlRequest() = default ;
    CreateResourceControlRequest(const CreateResourceControlRequest &) = default ;
    CreateResourceControlRequest(CreateResourceControlRequest &&) = default ;
    CreateResourceControlRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateResourceControlRequest() = default ;
    CreateResourceControlRequest& operator=(const CreateResourceControlRequest &) = default ;
    CreateResourceControlRequest& operator=(CreateResourceControlRequest &&) = default ;
    ...
    inline CreateResourceControlRequest& setCpuCount(int32_t cpuCount) { DARABONBA_PTR_SET_VALUE(cpuCount_, cpuCount) };
    ...
    inline CreateResourceControlRequest& setDBClusterId(string DBClusterId) { DARABONBA_PTR_SET_VALUE(DBClusterId_, DBClusterId) };
    ...
    inline CreateResourceControlRequest& setMaxCpu(int32_t maxCpu) { DARABONBA_PTR_SET_VALUE(maxCpu_, maxCpu) };
    ...
    inline CreateResourceControlRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline CreateResourceControlRequest& setResourceControlName(string resourceControlName) { DARABONBA_PTR_SET_VALUE(resourceControlName_, resourceControlName) };
