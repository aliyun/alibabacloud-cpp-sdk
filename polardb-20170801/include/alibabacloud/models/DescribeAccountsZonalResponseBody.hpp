...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAccountsZonalResponseBody::Accounts> & getAccounts() const { DARABONBA_PTR_GET_CONST(accounts_, vector<DescribeAccountsZonalResponseBody::Accounts>) };
    inline vector<DescribeAccountsZonalResponseBody::Accounts> getAccounts() { DARABONBA_PTR_GET(accounts_, vector<DescribeAccountsZonalResponseBody::Accounts>) };
    inline DescribeAccountsZonalResponseBody& setAccounts(const vector<DescribeAccountsZonalResponseBody::Accounts> & accounts) { DARABONBA_PTR_SET_VALUE(accounts_, accounts) };
    inline DescribeAccountsZonalResponseBody& setAccounts(vector<DescribeAccountsZonalResponseBody::Accounts> && accounts) { DARABONBA_PTR_SET_RVALUE(accounts_, accounts) };
