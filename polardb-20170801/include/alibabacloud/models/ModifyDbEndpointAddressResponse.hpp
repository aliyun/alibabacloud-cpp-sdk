...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBEndpointAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBEndpointAddressResponseBody) };
    inline ModifyDBEndpointAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBEndpointAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBEndpointAddressResponseBody> body_ {};
  };
