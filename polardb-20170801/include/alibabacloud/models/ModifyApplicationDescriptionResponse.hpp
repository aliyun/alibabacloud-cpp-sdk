...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyApplicationDescriptionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyApplicationDescriptionResponseBody) };
    inline ModifyApplicationDescriptionResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyApplicationDescriptionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyApplicationDescriptionResponseBody> body_ {};
  };
