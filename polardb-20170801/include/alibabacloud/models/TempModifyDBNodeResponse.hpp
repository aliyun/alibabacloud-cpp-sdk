...
namespace Models
{
  ...
  public:
    ...
    inline const TempModifyDBNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TempModifyDBNodeResponseBody) };
    inline TempModifyDBNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, TempModifyDBNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TempModifyDBNodeResponseBody> body_ {};
  };
