...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->compressStorage_ == nullptr
        && return this->DBClusterId_ == nullptr && return this->DBNodeCrashList_ == nullptr && return this->dataSyncMode_ == nullptr && return this->faultInjectionType_ == nullptr && return this->faultSimulateMode_ == nullptr
        && return this->imciAutoIndex_ == nullptr && return this->modifyRowCompression_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
        && return this->resourceOwnerId_ == nullptr && return this->standbyHAMode_ == nullptr && return this->storageAutoScale_ == nullptr && return this->storageUpperBound_ == nullptr && return this->tableMeta_ == nullptr; };
