...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBNodeConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBNodeConfigResponseBody) };
    inline ModifyDBNodeConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBNodeConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBNodeConfigResponseBody> body_ {};
  };
