...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoAddNewNodes_ == nullptr
        && return this->clientToken_ == nullptr && return this->DBClusterId_ == nullptr && return this->DBEndpointDescription_ == nullptr && return this->DBEndpointId_ == nullptr && return this->endpointConfig_ == nullptr
