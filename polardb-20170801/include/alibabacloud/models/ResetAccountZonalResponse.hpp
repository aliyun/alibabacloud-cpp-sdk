...
namespace Models
{
  ...
  public:
    ...
    inline const ResetAccountZonalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResetAccountZonalResponseBody) };
    inline ResetAccountZonalResponseBody getBody() { DARABONBA_PTR_GET(body_, ResetAccountZonalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResetAccountZonalResponseBody> body_ {};
  };
