...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBType_ == nullptr
        && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->parameterGroupId_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr
