...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->fromExecTime_ == nullptr
        ...
        && return this->securityToken_ == nullptr && return this->status_ == nullptr && return this->taskId_ == nullptr && return this->taskType_ == nullptr && return this->toExecTime_ == nullptr
        && return this->toStartTime_ == nullptr; };
