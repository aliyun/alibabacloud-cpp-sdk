...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBNodesClassResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBNodesClassResponseBody) };
    inline ModifyDBNodesClassResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBNodesClassResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBNodesClassResponseBody> body_ {};
  };
