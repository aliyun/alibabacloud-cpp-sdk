...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterParametersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterParametersResponseBody) };
    inline DescribeDBClusterParametersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterParametersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterParametersResponseBody> body_ {};
  };
