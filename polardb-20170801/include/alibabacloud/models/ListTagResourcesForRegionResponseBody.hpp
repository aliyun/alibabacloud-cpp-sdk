...
namespace Models
{
  ...
  public:
    ...
    inline const ListTagResourcesForRegionResponseBody::TagResources & getTagResources() const { DARABONBA_PTR_GET_CONST(tagResources_, ListTagResourcesForRegionResponseBody::TagResources) };
    inline ListTagResourcesForRegionResponseBody::TagResources getTagResources() { DARABONBA_PTR_GET(tagResources_, ListTagResourcesForRegionResponseBody::TagResources) };
    inline ListTagResourcesForRegionResponseBody& setTagResources(const ListTagResourcesForRegionResponseBody::TagResources & tagResources) { DARABONBA_PTR_SET_VALUE(tagResources_, tagResources) };
    inline ListTagResourcesForRegionResponseBody& setTagResources(ListTagResourcesForRegionResponseBody::TagResources && tagResources) { DARABONBA_PTR_SET_RVALUE(tagResources_, tagResources) };
