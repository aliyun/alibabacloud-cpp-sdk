...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBClusterPrimaryZoneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBClusterPrimaryZoneResponseBody) };
    inline ModifyDBClusterPrimaryZoneResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBClusterPrimaryZoneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBClusterPrimaryZoneResponseBody> body_ {};
  };
