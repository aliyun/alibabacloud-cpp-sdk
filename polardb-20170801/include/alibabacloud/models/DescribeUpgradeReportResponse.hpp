...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUpgradeReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUpgradeReportResponseBody) };
    inline DescribeUpgradeReportResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUpgradeReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUpgradeReportResponseBody> body_ {};
  };
