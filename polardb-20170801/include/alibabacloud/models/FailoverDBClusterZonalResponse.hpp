...
namespace Models
{
  ...
  public:
    ...
    inline const FailoverDBClusterZonalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FailoverDBClusterZonalResponseBody) };
    inline FailoverDBClusterZonalResponseBody getBody() { DARABONBA_PTR_GET(body_, FailoverDBClusterZonalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FailoverDBClusterZonalResponseBody> body_ {};
  };
