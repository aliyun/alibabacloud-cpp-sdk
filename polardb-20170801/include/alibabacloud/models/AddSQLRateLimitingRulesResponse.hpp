...
namespace Models
{
  ...
  public:
    ...
    inline const AddSQLRateLimitingRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddSQLRateLimitingRulesResponseBody) };
    inline AddSQLRateLimitingRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, AddSQLRateLimitingRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddSQLRateLimitingRulesResponseBody> body_ {};
  };
