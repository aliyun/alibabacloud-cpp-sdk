...
#ifndef ALIBABACLOUD_MODELS_CREATECRONJOBPOLICYSERVERLESSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATECRONJOBPOLICYSERVERLESSREQUEST_HPP_
...
namespace Models
{
  class CreateCronJobPolicyServerlessRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateCronJobPolicyServerlessRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateCronJobPolicyServerlessRequest& obj) { 
    ...
    CreateCronJobPolicyServerlessRequest() = default ;
    CreateCronJobPolicyServerlessRequest(const CreateCronJobPolicyServerlessRequest &) = default ;
    CreateCronJobPolicyServerlessRequest(CreateCronJobPolicyServerlessRequest &&) = default ;
    CreateCronJobPolicyServerlessRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateCronJobPolicyServerlessRequest() = default ;
    CreateCronJobPolicyServerlessRequest& operator=(const CreateCronJobPolicyServerlessRequest &) = default ;
    CreateCronJobPolicyServerlessRequest& operator=(CreateCronJobPolicyServerlessRequest &&) = default ;
    ...
    inline CreateCronJobPolicyServerlessRequest& setAllowShutDown(string allowShutDown) { DARABONBA_PTR_SET_VALUE(allowShutDown_, allowShutDown) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setCronExpression(string cronExpression) { DARABONBA_PTR_SET_VALUE(cronExpression_, cronExpression) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setDBClusterId(string DBClusterId) { DARABONBA_PTR_SET_VALUE(DBClusterId_, DBClusterId) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setScaleApRoNumMax(string scaleApRoNumMax) { DARABONBA_PTR_SET_VALUE(scaleApRoNumMax_, scaleApRoNumMax) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setScaleApRoNumMin(string scaleApRoNumMin) { DARABONBA_PTR_SET_VALUE(scaleApRoNumMin_, scaleApRoNumMin) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setScaleMax(string scaleMax) { DARABONBA_PTR_SET_VALUE(scaleMax_, scaleMax) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setScaleMin(string scaleMin) { DARABONBA_PTR_SET_VALUE(scaleMin_, scaleMin) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setScaleRoNumMax(string scaleRoNumMax) { DARABONBA_PTR_SET_VALUE(scaleRoNumMax_, scaleRoNumMax) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setScaleRoNumMin(string scaleRoNumMin) { DARABONBA_PTR_SET_VALUE(scaleRoNumMin_, scaleRoNumMin) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setSecondsUntilAutoPause(string secondsUntilAutoPause) { DARABONBA_PTR_SET_VALUE(secondsUntilAutoPause_, secondsUntilAutoPause) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setServerlessRuleCpuEnlargeThreshold(string serverlessRuleCpuEnlargeThreshold) { DARABONBA_PTR_SET_VALUE(serverlessRuleCpuEnlargeThreshold_, serverlessRuleCpuEnlargeThreshold) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setServerlessRuleCpuShrinkThreshold(string serverlessRuleCpuShrinkThreshold) { DARABONBA_PTR_SET_VALUE(serverlessRuleCpuShrinkThreshold_, serverlessRuleCpuShrinkThreshold) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setServerlessRuleMode(string serverlessRuleMode) { DARABONBA_PTR_SET_VALUE(serverlessRuleMode_, serverlessRuleMode) };
    ...
    inline CreateCronJobPolicyServerlessRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
