...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activationCodeId_ == nullptr
        && return this->aliyunOrderId_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr; };
