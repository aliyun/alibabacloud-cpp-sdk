...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountName_ == nullptr
        && return this->DBClusterId_ == nullptr && return this->newAccountPassword_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->passwordType_ == nullptr
    ...
    inline string newAccountPassword() const { DARABONBA_PTR_GET_DEFAULT(newAccountPassword_, "") };
    ...
    inline string passwordType() const { DARABONBA_PTR_GET_DEFAULT(passwordType_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> newAccountPassword_ = nullptr;
    std::shared_ptr<string> ownerAccount_ = nullptr;
    std::shared_ptr<int64_t> ownerId_ = nullptr;
    // The password type.
    std::shared_ptr<string> passwordType_ = nullptr;
