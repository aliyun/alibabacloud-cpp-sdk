...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->frontPort_ == nullptr
        && this->portName_ == nullptr; };
      ...
      inline DnatEntries& setFrontPort(int32_t frontPort) { DARABONBA_PTR_SET_VALUE(frontPort_, frontPort) };
      ...
      inline DnatEntries& setPortName(string portName) { DARABONBA_PTR_SET_VALUE(portName_, portName) };
    ...
    inline CreateApplicationRequest& setAuthProvider(string authProvider) { DARABONBA_PTR_SET_VALUE(authProvider_, authProvider) };
    ...
    inline CreateApplicationRequest& setAuthProviderConfig(string authProviderConfig) { DARABONBA_PTR_SET_VALUE(authProviderConfig_, authProviderConfig) };
    ...
    inline const vector<CreateApplicationRequest::DnatEntries> & getDnatEntries() const { DARABONBA_PTR_GET_CONST(dnatEntries_, vector<CreateApplicationRequest::DnatEntries>) };
    inline vector<CreateApplicationRequest::DnatEntries> getDnatEntries() { DARABONBA_PTR_GET(dnatEntries_, vector<CreateApplicationRequest::DnatEntries>) };
    inline CreateApplicationRequest& setDnatEntries(const vector<CreateApplicationRequest::DnatEntries> & dnatEntries) { DARABONBA_PTR_SET_VALUE(dnatEntries_, dnatEntries) };
    inline CreateApplicationRequest& setDnatEntries(vector<CreateApplicationRequest::DnatEntries> && dnatEntries) { DARABONBA_PTR_SET_RVALUE(dnatEntries_, dnatEntries) };
    ...
    inline CreateApplicationRequest& setDnatIpAddress(string dnatIpAddress) { DARABONBA_PTR_SET_VALUE(dnatIpAddress_, dnatIpAddress) };
    ...
    void deleteSecurityIPArrayName() { this->securityIPArrayName_ = nullptr;};
    inline string getSecurityIPArrayName() const { DARABONBA_PTR_GET_DEFAULT(securityIPArrayName_, "") };
    inline CreateApplicationRequest& setSecurityIPArrayName(string securityIPArrayName) { DARABONBA_PTR_SET_VALUE(securityIPArrayName_, securityIPArrayName) };
    ...
    void deleteSecurityIPList() { this->securityIPList_ = nullptr;};
    inline string getSecurityIPList() const { DARABONBA_PTR_GET_DEFAULT(securityIPList_, "") };
    inline CreateApplicationRequest& setSecurityIPList(string securityIPList) { DARABONBA_PTR_SET_VALUE(securityIPList_, securityIPList) };
    ...
    inline const vector<CreateApplicationRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateApplicationRequest::Tag>) };
    inline vector<CreateApplicationRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateApplicationRequest::Tag>) };
    inline CreateApplicationRequest& setTag(const vector<CreateApplicationRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateApplicationRequest& setTag(vector<CreateApplicationRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline CreateApplicationRequest& setTargetVersion(string targetVersion) { DARABONBA_PTR_SET_VALUE(targetVersion_, targetVersion) };
    ...
    inline CreateApplicationRequest& setVpcNatGatewayId(string vpcNatGatewayId) { DARABONBA_PTR_SET_VALUE(vpcNatGatewayId_, vpcNatGatewayId) };
