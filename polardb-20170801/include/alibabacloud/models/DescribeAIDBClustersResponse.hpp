...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAIDBClustersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAIDBClustersResponseBody) };
    inline DescribeAIDBClustersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAIDBClustersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAIDBClustersResponseBody> body_ {};
  };
