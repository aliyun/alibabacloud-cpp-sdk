...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDBClusterEndpointsResponseBody::Items> & getItems() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeDBClusterEndpointsResponseBody::Items>) };
    inline vector<DescribeDBClusterEndpointsResponseBody::Items> getItems() { DARABONBA_PTR_GET(items_, vector<DescribeDBClusterEndpointsResponseBody::Items>) };
    inline DescribeDBClusterEndpointsResponseBody& setItems(const vector<DescribeDBClusterEndpointsResponseBody::Items> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDBClusterEndpointsResponseBody& setItems(vector<DescribeDBClusterEndpointsResponseBody::Items> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
