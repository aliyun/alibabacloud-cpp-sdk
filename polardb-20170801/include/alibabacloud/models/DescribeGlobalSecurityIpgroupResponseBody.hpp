...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup> & globalSecurityIPGroup() const { DARABONBA_PTR_GET_CONST(globalSecurityIPGroup_, vector<DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup>) };
    inline vector<DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup> globalSecurityIPGroup() { DARABONBA_PTR_GET(globalSecurityIPGroup_, vector<DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup>) };
    inline DescribeGlobalSecurityIPGroupResponseBody& setGlobalSecurityIPGroup(const vector<DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup> & globalSecurityIPGroup) { DARABONBA_PTR_SET_VALUE(globalSecurityIPGroup_, globalSecurityIPGroup) };
    inline DescribeGlobalSecurityIPGroupResponseBody& setGlobalSecurityIPGroup(vector<DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup> && globalSecurityIPGroup) { DARABONBA_PTR_SET_RVALUE(globalSecurityIPGroup_, globalSecurityIPGroup) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup>> globalSecurityIPGroup_ = nullptr;
