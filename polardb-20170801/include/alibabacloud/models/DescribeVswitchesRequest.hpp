...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->dedicatedHostGroupId_ != nullptr
    ...
    inline DescribeVSwitchesRequest& setDedicatedHostGroupId(string dedicatedHostGroupId) { DARABONBA_PTR_SET_VALUE(dedicatedHostGroupId_, dedicatedHostGroupId) };
