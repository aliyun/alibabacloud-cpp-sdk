...
namespace Models
{
  ...
  public:
    ...
    inline const ListOrdersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOrdersResponseBody) };
    inline ListOrdersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOrdersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOrdersResponseBody> body_ {};
  };
