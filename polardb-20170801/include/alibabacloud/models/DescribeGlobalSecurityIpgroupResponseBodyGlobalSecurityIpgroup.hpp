...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEGLOBALSECURITYIPGROUPRESPONSEBODYGLOBALSECURITYIPGROUP_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEGLOBALSECURITYIPGROUPRESPONSEBODYGLOBALSECURITYIPGROUP_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& obj) { 
    ...
    DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup() = default ;
    DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup(const DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup &) = default ;
    DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup(DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup &&) = default ;
    DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup() = default ;
    DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& operator=(const DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup &) = default ;
    DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& operator=(DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup &&) = default ;
    ...
    inline DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setDBInstances(const vector<string> & DBInstances) { DARABONBA_PTR_SET_VALUE(DBInstances_, DBInstances) };
    inline DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setDBInstances(vector<string> && DBInstances) { DARABONBA_PTR_SET_RVALUE(DBInstances_, DBInstances) };
    ...
    inline DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setGIpList(string GIpList) { DARABONBA_PTR_SET_VALUE(GIpList_, GIpList) };
    ...
    inline DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setGlobalIgName(string globalIgName) { DARABONBA_PTR_SET_VALUE(globalIgName_, globalIgName) };
    ...
    inline DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setGlobalSecurityGroupId(string globalSecurityGroupId) { DARABONBA_PTR_SET_VALUE(globalSecurityGroupId_, globalSecurityGroupId) };
    ...
    inline DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
