...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->rolePrivilegeNameList_ == nullptr; };
    ...
    inline string getRolePrivilegeNameList() const { DARABONBA_PTR_GET_DEFAULT(rolePrivilegeNameList_, "") };
  ...
  protected:
    ...
    shared_ptr<string> rolePrivilegeNameList_ {};
  };
