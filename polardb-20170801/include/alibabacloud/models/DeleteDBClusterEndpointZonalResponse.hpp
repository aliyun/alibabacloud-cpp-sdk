...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBClusterEndpointZonalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDBClusterEndpointZonalResponseBody) };
    inline DeleteDBClusterEndpointZonalResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDBClusterEndpointZonalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDBClusterEndpointZonalResponseBody> body_ {};
  };
