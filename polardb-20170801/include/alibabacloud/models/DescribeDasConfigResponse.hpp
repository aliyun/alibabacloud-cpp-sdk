...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDasConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDasConfigResponseBody) };
    inline DescribeDasConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDasConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDasConfigResponseBody> body_ {};
  };
