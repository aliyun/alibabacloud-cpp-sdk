...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeParameterGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeParameterGroupResponseBody) };
    inline DescribeParameterGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeParameterGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeParameterGroupResponseBody> body_ {};
  };
