...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePolarFsQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePolarFsQuotaResponseBody) };
    inline DeletePolarFsQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePolarFsQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePolarFsQuotaResponseBody> body_ {};
  };
