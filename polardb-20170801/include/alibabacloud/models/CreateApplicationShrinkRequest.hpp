...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationType_ == nullptr
        && return this->architecture_ == nullptr && return this->autoRenew_ == nullptr && return this->autoUseCoupon_ == nullptr && return this->componentsShrink_ == nullptr && return this->DBClusterId_ == nullptr
        && return this->description_ == nullptr && return this->dryRun_ == nullptr && return this->endpointsShrink_ == nullptr && return this->payType_ == nullptr && return this->period_ == nullptr
