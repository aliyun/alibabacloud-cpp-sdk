...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DeleteGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> & getGlobalSecurityIPGroup() const { DARABONBA_PTR_GET_CONST(globalSecurityIPGroup_, vector<DeleteGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup>) };
    inline vector<DeleteGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> getGlobalSecurityIPGroup() { DARABONBA_PTR_GET(globalSecurityIPGroup_, vector<DeleteGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup>) };
    inline DeleteGlobalSecurityIPGroupResponseBody& setGlobalSecurityIPGroup(const vector<DeleteGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> & globalSecurityIPGroup) { DARABONBA_PTR_SET_VALUE(globalSecurityIPGroup_, globalSecurityIPGroup) };
    inline DeleteGlobalSecurityIPGroupResponseBody& setGlobalSecurityIPGroup(vector<DeleteGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> && globalSecurityIPGroup) { DARABONBA_PTR_SET_RVALUE(globalSecurityIPGroup_, globalSecurityIPGroup) };
  ...
  protected:
    ...
    shared_ptr<vector<DeleteGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup>> globalSecurityIPGroup_ {};
