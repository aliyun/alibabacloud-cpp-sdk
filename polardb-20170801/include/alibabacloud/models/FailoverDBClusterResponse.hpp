...
namespace Models
{
  ...
  public:
    ...
    inline const FailoverDBClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FailoverDBClusterResponseBody) };
    inline FailoverDBClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, FailoverDBClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FailoverDBClusterResponseBody> body_ {};
  };
