...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccountsZonalResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccountsZonalResponseBody) };
    inline DescribeAccountsZonalResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAccountsZonalResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAccountsZonalResponseBody> body_ = nullptr;
  };
