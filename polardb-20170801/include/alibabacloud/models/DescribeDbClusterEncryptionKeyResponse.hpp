...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterEncryptionKeyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterEncryptionKeyResponseBody) };
    inline DescribeDBClusterEncryptionKeyResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDBClusterEncryptionKeyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBClusterEncryptionKeyResponseBody> body_ = nullptr;
  };
