...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterPerformanceResponseBody::PerformanceKeys & getPerformanceKeys() const { DARABONBA_PTR_GET_CONST(performanceKeys_, DescribeDBClusterPerformanceResponseBody::PerformanceKeys) };
    inline DescribeDBClusterPerformanceResponseBody::PerformanceKeys getPerformanceKeys() { DARABONBA_PTR_GET(performanceKeys_, DescribeDBClusterPerformanceResponseBody::PerformanceKeys) };
    inline DescribeDBClusterPerformanceResponseBody& setPerformanceKeys(const DescribeDBClusterPerformanceResponseBody::PerformanceKeys & performanceKeys) { DARABONBA_PTR_SET_VALUE(performanceKeys_, performanceKeys) };
    inline DescribeDBClusterPerformanceResponseBody& setPerformanceKeys(DescribeDBClusterPerformanceResponseBody::PerformanceKeys && performanceKeys) { DARABONBA_PTR_SET_RVALUE(performanceKeys_, performanceKeys) };
