...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoUseCoupon_ == nullptr
        && return this->clientToken_ == nullptr && return this->cloudProvider_ == nullptr && return this->DBClusterId_ == nullptr && return this->DBNodeTargetClass_ == nullptr && return this->DBNodeType_ == nullptr
        && return this->modifyType_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->plannedEndTime_ == nullptr && return this->plannedFlashingOffTime_ == nullptr
        && return this->plannedStartTime_ == nullptr && return this->promotionCode_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->subCategory_ == nullptr; };
    ...
    inline string DBNodeTargetClass() const { DARABONBA_PTR_GET_DEFAULT(DBNodeTargetClass_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> DBNodeTargetClass_ = nullptr;
