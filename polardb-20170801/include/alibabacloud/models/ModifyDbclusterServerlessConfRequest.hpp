...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->allowShutDown_ != nullptr
        && this->crontabJobId_ != nullptr && this->DBClusterId_ != nullptr && this->fromTimeService_ != nullptr && this->ownerAccount_ != nullptr && this->ownerId_ != nullptr
        && this->plannedEndTime_ != nullptr && this->plannedStartTime_ != nullptr && this->resourceOwnerAccount_ != nullptr && this->resourceOwnerId_ != nullptr && this->scaleApRoNumMax_ != nullptr
        ...
        && this->secondsUntilAutoPause_ != nullptr && this->serverlessRuleCpuEnlargeThreshold_ != nullptr && this->serverlessRuleCpuShrinkThreshold_ != nullptr && this->serverlessRuleMode_ != nullptr && this->taskId_ != nullptr; };
