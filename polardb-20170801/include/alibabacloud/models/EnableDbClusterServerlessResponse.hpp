...
namespace Models
{
  ...
  public:
    ...
    inline const EnableDBClusterServerlessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableDBClusterServerlessResponseBody) };
    inline EnableDBClusterServerlessResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableDBClusterServerlessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableDBClusterServerlessResponseBody> body_ {};
  };
