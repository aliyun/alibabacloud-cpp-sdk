...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aliyunOrderId_ == nullptr
        && return this->macAddress_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr
