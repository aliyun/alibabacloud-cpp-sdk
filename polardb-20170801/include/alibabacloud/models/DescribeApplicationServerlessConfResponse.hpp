...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationServerlessConfResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApplicationServerlessConfResponseBody) };
    inline DescribeApplicationServerlessConfResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApplicationServerlessConfResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApplicationServerlessConfResponseBody> body_ {};
  };
