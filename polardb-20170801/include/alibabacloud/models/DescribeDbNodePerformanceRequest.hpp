...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && return this->DBNodeId_ == nullptr && return this->endTime_ == nullptr && return this->interval_ == nullptr && return this->key_ == nullptr && return this->startTime_ == nullptr
        && return this->type_ == nullptr; };
    // DBClusterId Field Functions 
    bool hasDBClusterId() const { return this->DBClusterId_ != nullptr;};
    void deleteDBClusterId() { this->DBClusterId_ = nullptr;};
    inline string DBClusterId() const { DARABONBA_PTR_GET_DEFAULT(DBClusterId_, "") };
    inline DescribeDBNodePerformanceRequest& setDBClusterId(string DBClusterId) { DARABONBA_PTR_SET_VALUE(DBClusterId_, DBClusterId) };
    ...
    inline DescribeDBNodePerformanceRequest& setDBNodeId(string DBNodeId) { DARABONBA_PTR_SET_VALUE(DBNodeId_, DBNodeId) };
    ...
    inline DescribeDBNodePerformanceRequest& setInterval(string interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline DescribeDBNodePerformanceRequest& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
