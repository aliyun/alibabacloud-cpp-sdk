...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ModifyGlobalSecurityIPGroupRelationResponseBodyGlobalSecurityIPGroupRel> & globalSecurityIPGroupRel() const { DARABONBA_PTR_GET_CONST(globalSecurityIPGroupRel_, vector<ModifyGlobalSecurityIPGroupRelationResponseBodyGlobalSecurityIPGroupRel>) };
    inline vector<ModifyGlobalSecurityIPGroupRelationResponseBodyGlobalSecurityIPGroupRel> globalSecurityIPGroupRel() { DARABONBA_PTR_GET(globalSecurityIPGroupRel_, vector<ModifyGlobalSecurityIPGroupRelationResponseBodyGlobalSecurityIPGroupRel>) };
    inline ModifyGlobalSecurityIPGroupRelationResponseBody& setGlobalSecurityIPGroupRel(const vector<ModifyGlobalSecurityIPGroupRelationResponseBodyGlobalSecurityIPGroupRel> & globalSecurityIPGroupRel) { DARABONBA_PTR_SET_VALUE(globalSecurityIPGroupRel_, globalSecurityIPGroupRel) };
    inline ModifyGlobalSecurityIPGroupRelationResponseBody& setGlobalSecurityIPGroupRel(vector<ModifyGlobalSecurityIPGroupRelationResponseBodyGlobalSecurityIPGroupRel> && globalSecurityIPGroupRel) { DARABONBA_PTR_SET_RVALUE(globalSecurityIPGroupRel_, globalSecurityIPGroupRel) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ModifyGlobalSecurityIPGroupRelationResponseBodyGlobalSecurityIPGroupRel>> globalSecurityIPGroupRel_ = nullptr;
