...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEncryptionDBRolePrivilegeResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEncryptionDBRolePrivilegeResponseBodyData) };
    inline DescribeEncryptionDBRolePrivilegeResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEncryptionDBRolePrivilegeResponseBodyData) };
    inline DescribeEncryptionDBRolePrivilegeResponseBody& setData(const DescribeEncryptionDBRolePrivilegeResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEncryptionDBRolePrivilegeResponseBody& setData(DescribeEncryptionDBRolePrivilegeResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEncryptionDBRolePrivilegeResponseBodyData> data_ = nullptr;
