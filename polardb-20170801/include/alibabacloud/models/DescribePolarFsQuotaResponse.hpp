...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePolarFsQuotaResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribePolarFsQuotaResponseBody) };
    inline DescribePolarFsQuotaResponseBody body() { DARABONBA_PTR_GET(body_, DescribePolarFsQuotaResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePolarFsQuotaResponseBody> body_ = nullptr;
  };
