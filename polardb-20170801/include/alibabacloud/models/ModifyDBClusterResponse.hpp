...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBClusterResponseBody) };
    inline ModifyDBClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBClusterResponseBody> body_ {};
  };
