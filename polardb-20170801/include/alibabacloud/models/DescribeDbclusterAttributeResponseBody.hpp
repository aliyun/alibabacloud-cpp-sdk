...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->aiCreatingTime_ != nullptr
        ...
        && this->restoreDataPoint_ != nullptr && this->restoreType_ != nullptr && this->rowCompression_ != nullptr && this->SQLSize_ != nullptr && this->serverlessType_ != nullptr
