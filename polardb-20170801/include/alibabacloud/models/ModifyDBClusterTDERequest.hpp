...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && this->enableAutomaticRotation_ == nullptr && this->encryptNewTables_ == nullptr && this->encryptionKey_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->roleArn_ == nullptr && this->TDEStatus_ == nullptr; };
    ...
    inline string getEnableAutomaticRotation() const { DARABONBA_PTR_GET_DEFAULT(enableAutomaticRotation_, "") };
