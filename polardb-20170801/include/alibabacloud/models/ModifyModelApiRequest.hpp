...
#ifndef ALIBABACLOUD_MODELS_MODIFYMODELAPIREQUEST_HPP_
#define ALIBABACLOUD_MODELS_MODIFYMODELAPIREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    ModifyModelApiRequest() = default ;
    ModifyModelApiRequest(const ModifyModelApiRequest &) = default ;
    ModifyModelApiRequest(ModifyModelApiRequest &&) = default ;
    ModifyModelApiRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyModelApiRequest() = default ;
    ModifyModelApiRequest& operator=(const ModifyModelApiRequest &) = default ;
    ModifyModelApiRequest& operator=(ModifyModelApiRequest &&) = default ;
    ...
    inline ModifyModelApiRequest& setGwClusterId(string gwClusterId) { DARABONBA_PTR_SET_VALUE(gwClusterId_, gwClusterId) };
    ...
    inline ModifyModelApiRequest& setModelApiId(string modelApiId) { DARABONBA_PTR_SET_VALUE(modelApiId_, modelApiId) };
    ...
    inline ModifyModelApiRequest& setModelCategory(string modelCategory) { DARABONBA_PTR_SET_VALUE(modelCategory_, modelCategory) };
    ...
    inline ModifyModelApiRequest& setPathPrefix(string pathPrefix) { DARABONBA_PTR_SET_VALUE(pathPrefix_, pathPrefix) };
    ...
    inline ModifyModelApiRequest& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline ModifyModelApiRequest& setRecordInput(string recordInput) { DARABONBA_PTR_SET_VALUE(recordInput_, recordInput) };
    ...
    inline ModifyModelApiRequest& setRecordOutput(string recordOutput) { DARABONBA_PTR_SET_VALUE(recordOutput_, recordOutput) };
    ...
    inline ModifyModelApiRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline ModifyModelApiRequest& setRouteRules(string routeRules) { DARABONBA_PTR_SET_VALUE(routeRules_, routeRules) };
