...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeGlobalSecurityIPGroupRelationResponseBody::GlobalSecurityIPGroupRel> & getGlobalSecurityIPGroupRel() const { DARABONBA_PTR_GET_CONST(globalSecurityIPGroupRel_, vector<DescribeGlobalSecurityIPGroupRelationResponseBody::GlobalSecurityIPGroupRel>) };
    inline vector<DescribeGlobalSecurityIPGroupRelationResponseBody::GlobalSecurityIPGroupRel> getGlobalSecurityIPGroupRel() { DARABONBA_PTR_GET(globalSecurityIPGroupRel_, vector<DescribeGlobalSecurityIPGroupRelationResponseBody::GlobalSecurityIPGroupRel>) };
    inline DescribeGlobalSecurityIPGroupRelationResponseBody& setGlobalSecurityIPGroupRel(const vector<DescribeGlobalSecurityIPGroupRelationResponseBody::GlobalSecurityIPGroupRel> & globalSecurityIPGroupRel) { DARABONBA_PTR_SET_VALUE(globalSecurityIPGroupRel_, globalSecurityIPGroupRel) };
    inline DescribeGlobalSecurityIPGroupRelationResponseBody& setGlobalSecurityIPGroupRel(vector<DescribeGlobalSecurityIPGroupRelationResponseBody::GlobalSecurityIPGroupRel> && globalSecurityIPGroupRel) { DARABONBA_PTR_SET_RVALUE(globalSecurityIPGroupRel_, globalSecurityIPGroupRel) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeGlobalSecurityIPGroupRelationResponseBody::GlobalSecurityIPGroupRel>> globalSecurityIPGroupRel_ {};
