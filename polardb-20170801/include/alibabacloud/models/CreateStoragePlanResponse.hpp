...
namespace Models
{
  ...
  public:
    ...
    inline const CreateStoragePlanResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateStoragePlanResponseBody) };
    inline CreateStoragePlanResponseBody body() { DARABONBA_PTR_GET(body_, CreateStoragePlanResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateStoragePlanResponseBody> body_ = nullptr;
  };
