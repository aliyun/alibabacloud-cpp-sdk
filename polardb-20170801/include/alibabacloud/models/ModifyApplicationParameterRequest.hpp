...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationId_ == nullptr
        && this->parameterName_ == nullptr && this->parameterValue_ == nullptr && this->parameters_ == nullptr; };
    ...
    inline const vector<ModifyApplicationParameterRequest::Parameters> & getParameters() const { DARABONBA_PTR_GET_CONST(parameters_, vector<ModifyApplicationParameterRequest::Parameters>) };
    inline vector<ModifyApplicationParameterRequest::Parameters> getParameters() { DARABONBA_PTR_GET(parameters_, vector<ModifyApplicationParameterRequest::Parameters>) };
    inline ModifyApplicationParameterRequest& setParameters(const vector<ModifyApplicationParameterRequest::Parameters> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline ModifyApplicationParameterRequest& setParameters(vector<ModifyApplicationParameterRequest::Parameters> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
  ...
  protected:
    ...
    shared_ptr<string> parameterName_ {};
    shared_ptr<string> parameterValue_ {};
    shared_ptr<vector<ModifyApplicationParameterRequest::Parameters>> parameters_ {};
  };
