...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowCancel_ == nullptr
        && return this->allowChange_ == nullptr && return this->changeLevel_ == nullptr && return this->DBClusterId_ == nullptr && return this->DBType_ == nullptr && return this->ownerAccount_ == nullptr
        ...
        && return this->resourceOwnerId_ == nullptr && return this->securityToken_ == nullptr && return this->status_ == nullptr && return this->taskType_ == nullptr; };
