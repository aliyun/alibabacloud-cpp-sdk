...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteKnowledgeBaseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteKnowledgeBaseResponseBody) };
    inline DeleteKnowledgeBaseResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteKnowledgeBaseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteKnowledgeBaseResponseBody> body_ {};
  };
