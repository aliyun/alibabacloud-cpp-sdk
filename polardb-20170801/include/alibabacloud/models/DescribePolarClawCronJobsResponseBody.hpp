...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEPOLARCLAWCRONJOBSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEPOLARCLAWCRONJOBSRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribePolarClawCronJobsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribePolarClawCronJobsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribePolarClawCronJobsResponseBody& obj) { 
    ...
    DescribePolarClawCronJobsResponseBody() = default ;
    DescribePolarClawCronJobsResponseBody(const DescribePolarClawCronJobsResponseBody &) = default ;
    DescribePolarClawCronJobsResponseBody(DescribePolarClawCronJobsResponseBody &&) = default ;
    DescribePolarClawCronJobsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribePolarClawCronJobsResponseBody() = default ;
    DescribePolarClawCronJobsResponseBody& operator=(const DescribePolarClawCronJobsResponseBody &) = default ;
    DescribePolarClawCronJobsResponseBody& operator=(DescribePolarClawCronJobsResponseBody &&) = default ;
    ...
    public:
      ...
      inline Jobs& setAgentId(string agentId) { DARABONBA_PTR_SET_VALUE(agentId_, agentId) };
      ...
      inline Jobs& setCreatedAtMs(int64_t createdAtMs) { DARABONBA_PTR_SET_VALUE(createdAtMs_, createdAtMs) };
      ...
      inline Jobs& setDeleteAfterRun(bool deleteAfterRun) { DARABONBA_PTR_SET_VALUE(deleteAfterRun_, deleteAfterRun) };


      // delivery Field Functions 
      bool hasDelivery() const { return this->delivery_ != nullptr;};
      void deleteDelivery() { this->delivery_ = nullptr;};
      inline const Jobs::Delivery & getDelivery() const { DARABONBA_PTR_GET_CONST(delivery_, Jobs::Delivery) };
      inline Jobs::Delivery getDelivery() { DARABONBA_PTR_GET(delivery_, Jobs::Delivery) };
      inline Jobs& setDelivery(const Jobs::Delivery & delivery) { DARABONBA_PTR_SET_VALUE(delivery_, delivery) };
      inline Jobs& setDelivery(Jobs::Delivery && delivery) { DARABONBA_PTR_SET_RVALUE(delivery_, delivery) };
      ...
      inline Jobs& setEnabled(bool enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
      ...
      inline const Jobs::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, Jobs::Payload) };
      inline Jobs::Payload getPayload() { DARABONBA_PTR_GET(payload_, Jobs::Payload) };
      inline Jobs& setPayload(const Jobs::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
      inline Jobs& setPayload(Jobs::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };


      // runs Field Functions 
      bool hasRuns() const { return this->runs_ != nullptr;};
      void deleteRuns() { this->runs_ = nullptr;};
      inline const vector<Jobs::Runs> & getRuns() const { DARABONBA_PTR_GET_CONST(runs_, vector<Jobs::Runs>) };
      inline vector<Jobs::Runs> getRuns() { DARABONBA_PTR_GET(runs_, vector<Jobs::Runs>) };
      inline Jobs& setRuns(const vector<Jobs::Runs> & runs) { DARABONBA_PTR_SET_VALUE(runs_, runs) };
      inline Jobs& setRuns(vector<Jobs::Runs> && runs) { DARABONBA_PTR_SET_RVALUE(runs_, runs) };


      // schedule Field Functions 
      bool hasSchedule() const { return this->schedule_ != nullptr;};
      void deleteSchedule() { this->schedule_ = nullptr;};
      inline const Jobs::Schedule & getSchedule() const { DARABONBA_PTR_GET_CONST(schedule_, Jobs::Schedule) };
      inline Jobs::Schedule getSchedule() { DARABONBA_PTR_GET(schedule_, Jobs::Schedule) };
      inline Jobs& setSchedule(const Jobs::Schedule & schedule) { DARABONBA_PTR_SET_VALUE(schedule_, schedule) };
      inline Jobs& setSchedule(Jobs::Schedule && schedule) { DARABONBA_PTR_SET_RVALUE(schedule_, schedule) };
      ...
      inline Jobs& setSessionKey(string sessionKey) { DARABONBA_PTR_SET_VALUE(sessionKey_, sessionKey) };
      ...
      inline Jobs& setSessionTarget(string sessionTarget) { DARABONBA_PTR_SET_VALUE(sessionTarget_, sessionTarget) };


      // state Field Functions 
      bool hasState() const { return this->state_ != nullptr;};
      void deleteState() { this->state_ = nullptr;};
      inline const Jobs::State & getState() const { DARABONBA_PTR_GET_CONST(state_, Jobs::State) };
      inline Jobs::State getState() { DARABONBA_PTR_GET(state_, Jobs::State) };
      inline Jobs& setState(const Jobs::State & state) { DARABONBA_PTR_SET_VALUE(state_, state) };
      inline Jobs& setState(Jobs::State && state) { DARABONBA_PTR_SET_RVALUE(state_, state) };
      ...
      inline Jobs& setUpdatedAtMs(int64_t updatedAtMs) { DARABONBA_PTR_SET_VALUE(updatedAtMs_, updatedAtMs) };
      ...
      inline Jobs& setWakeMode(string wakeMode) { DARABONBA_PTR_SET_VALUE(wakeMode_, wakeMode) };
    ...
    virtual bool empty() const override { return this->applicationId_ == nullptr
        && this->code_ == nullptr && this->jobs_ == nullptr && this->message_ == nullptr && this->requestId_ == nullptr && this->total_ == nullptr; };
    // applicationId Field Functions 
    bool hasApplicationId() const { return this->applicationId_ != nullptr;};
    void deleteApplicationId() { this->applicationId_ = nullptr;};
    inline string getApplicationId() const { DARABONBA_PTR_GET_DEFAULT(applicationId_, "") };
    inline DescribePolarClawCronJobsResponseBody& setApplicationId(string applicationId) { DARABONBA_PTR_SET_VALUE(applicationId_, applicationId) };
    ...
    inline DescribePolarClawCronJobsResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // jobs Field Functions 
    bool hasJobs() const { return this->jobs_ != nullptr;};
    void deleteJobs() { this->jobs_ = nullptr;};
    inline const vector<DescribePolarClawCronJobsResponseBody::Jobs> & getJobs() const { DARABONBA_PTR_GET_CONST(jobs_, vector<DescribePolarClawCronJobsResponseBody::Jobs>) };
    inline vector<DescribePolarClawCronJobsResponseBody::Jobs> getJobs() { DARABONBA_PTR_GET(jobs_, vector<DescribePolarClawCronJobsResponseBody::Jobs>) };
    inline DescribePolarClawCronJobsResponseBody& setJobs(const vector<DescribePolarClawCronJobsResponseBody::Jobs> & jobs) { DARABONBA_PTR_SET_VALUE(jobs_, jobs) };
    inline DescribePolarClawCronJobsResponseBody& setJobs(vector<DescribePolarClawCronJobsResponseBody::Jobs> && jobs) { DARABONBA_PTR_SET_RVALUE(jobs_, jobs) };
    ...
    void deleteMessage() { this->message_ = nullptr;};
    inline string getMessage() const { DARABONBA_PTR_GET_DEFAULT(message_, "") };
    inline DescribePolarClawCronJobsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DescribePolarClawCronJobsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribePolarClawCronJobsResponseBody& setTotal(int32_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
