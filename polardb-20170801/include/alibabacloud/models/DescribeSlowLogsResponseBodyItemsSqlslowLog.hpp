...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->createTime_ != nullptr
        && this->DBName_ != nullptr && this->DBNodeId_ != nullptr && this->maxExecutionTime_ != nullptr && this->maxLockTime_ != nullptr && this->parseMaxRowCount_ != nullptr
        && this->parseTotalRowCounts_ != nullptr && this->returnMaxRowCount_ != nullptr && this->returnTotalRowCounts_ != nullptr && this->SQLHASH_ != nullptr && this->SQLText_ != nullptr
        && this->totalExecutionCounts_ != nullptr && this->totalExecutionTimes_ != nullptr && this->totalLockTimes_ != nullptr; };
