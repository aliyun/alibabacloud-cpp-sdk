...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCronJobPolicyServerlessResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeCronJobPolicyServerlessResponseBodyItems>) };
    inline vector<DescribeCronJobPolicyServerlessResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeCronJobPolicyServerlessResponseBodyItems>) };
    inline DescribeCronJobPolicyServerlessResponseBody& setItems(const vector<DescribeCronJobPolicyServerlessResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeCronJobPolicyServerlessResponseBody& setItems(vector<DescribeCronJobPolicyServerlessResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    std::shared_ptr<vector<DescribeCronJobPolicyServerlessResponseBodyItems>> items_ = nullptr;
