...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourcePackagesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourcePackagesResponseBody) };
    inline DescribeResourcePackagesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeResourcePackagesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeResourcePackagesResponseBody> body_ = nullptr;
  };
