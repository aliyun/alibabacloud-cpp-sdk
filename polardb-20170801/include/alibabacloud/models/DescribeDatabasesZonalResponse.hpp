...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDatabasesZonalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDatabasesZonalResponseBody) };
    inline DescribeDatabasesZonalResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDatabasesZonalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDatabasesZonalResponseBody> body_ {};
  };
