...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLogBackupPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLogBackupPolicyResponseBody) };
    inline DescribeLogBackupPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLogBackupPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLogBackupPolicyResponseBody> body_ {};
  };
