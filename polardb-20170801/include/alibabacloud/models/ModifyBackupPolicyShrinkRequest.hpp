...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->advancedDataPoliciesShrink_ != nullptr
    ...
    inline string advancedDataPoliciesShrink() const { DARABONBA_PTR_GET_DEFAULT(advancedDataPoliciesShrink_, "") };
  ...
  protected:
    std::shared_ptr<string> advancedDataPoliciesShrink_ = nullptr;
