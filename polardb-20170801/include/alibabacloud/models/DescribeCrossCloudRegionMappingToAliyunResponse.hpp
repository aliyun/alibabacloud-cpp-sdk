...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCrossCloudRegionMappingToAliyunResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCrossCloudRegionMappingToAliyunResponseBody) };
    inline DescribeCrossCloudRegionMappingToAliyunResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCrossCloudRegionMappingToAliyunResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCrossCloudRegionMappingToAliyunResponseBody> body_ {};
  };
