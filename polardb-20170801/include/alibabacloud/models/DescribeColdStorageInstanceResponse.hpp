...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeColdStorageInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeColdStorageInstanceResponseBody) };
    inline DescribeColdStorageInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeColdStorageInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeColdStorageInstanceResponseBody> body_ {};
  };
