...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->allowShutDown_ != nullptr
        && this->architecture_ != nullptr && this->autoRenew_ != nullptr && this->backupRetentionPolicyOnClusterDeletion_ != nullptr && this->burstingEnabled_ != nullptr && this->clientToken_ != nullptr
        && this->cloneDataPoint_ != nullptr && this->clusterNetworkType_ != nullptr && this->creationCategory_ != nullptr && this->creationOption_ != nullptr && this->DBClusterDescription_ != nullptr
        ...
        && this->defaultTimeZone_ != nullptr && this->GDNId_ != nullptr && this->hotStandbyCluster_ != nullptr && this->loosePolarLogBin_ != nullptr && this->looseXEngine_ != nullptr
        && this->looseXEngineUseMemoryPct_ != nullptr && this->lowerCaseTableNames_ != nullptr && this->ownerAccount_ != nullptr && this->ownerId_ != nullptr && this->parameterGroupId_ != nullptr
