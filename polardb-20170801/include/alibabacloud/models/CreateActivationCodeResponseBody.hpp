...
#ifndef ALIBABACLOUD_MODELS_CREATEACTIVATIONCODERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEACTIVATIONCODERESPONSEBODY_HPP_
...
namespace Models
{
  class CreateActivationCodeResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateActivationCodeResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateActivationCodeResponseBody& obj) { 
    ...
    CreateActivationCodeResponseBody() = default ;
    CreateActivationCodeResponseBody(const CreateActivationCodeResponseBody &) = default ;
    CreateActivationCodeResponseBody(CreateActivationCodeResponseBody &&) = default ;
    CreateActivationCodeResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateActivationCodeResponseBody() = default ;
    CreateActivationCodeResponseBody& operator=(const CreateActivationCodeResponseBody &) = default ;
    CreateActivationCodeResponseBody& operator=(CreateActivationCodeResponseBody &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->activateAt_ != nullptr
