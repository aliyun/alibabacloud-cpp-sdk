...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClustersWithBackupsResponseBodyItems & items() const { DARABONBA_PTR_GET_CONST(items_, DescribeDBClustersWithBackupsResponseBodyItems) };
    inline DescribeDBClustersWithBackupsResponseBodyItems items() { DARABONBA_PTR_GET(items_, DescribeDBClustersWithBackupsResponseBodyItems) };
    inline DescribeDBClustersWithBackupsResponseBody& setItems(const DescribeDBClustersWithBackupsResponseBodyItems & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDBClustersWithBackupsResponseBody& setItems(DescribeDBClustersWithBackupsResponseBodyItems && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBClustersWithBackupsResponseBodyItems> items_ = nullptr;
