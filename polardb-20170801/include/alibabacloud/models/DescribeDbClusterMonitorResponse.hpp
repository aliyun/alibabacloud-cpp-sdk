...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterMonitorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterMonitorResponseBody) };
    inline DescribeDBClusterMonitorResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterMonitorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterMonitorResponseBody> body_ {};
  };
