...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeGlobalDatabaseNetworksResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeGlobalDatabaseNetworksResponseBodyItems>) };
    inline vector<DescribeGlobalDatabaseNetworksResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeGlobalDatabaseNetworksResponseBodyItems>) };
    inline DescribeGlobalDatabaseNetworksResponseBody& setItems(const vector<DescribeGlobalDatabaseNetworksResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeGlobalDatabaseNetworksResponseBody& setItems(vector<DescribeGlobalDatabaseNetworksResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeGlobalDatabaseNetworksResponseBodyItems>> items_ = nullptr;
    // The page number.
