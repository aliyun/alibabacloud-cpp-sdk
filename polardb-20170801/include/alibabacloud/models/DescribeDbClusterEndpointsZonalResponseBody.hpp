...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDBClusterEndpointsZonalResponseBodyItems> & items() const { DARABONBA_PTR_GET_CONST(items_, vector<DescribeDBClusterEndpointsZonalResponseBodyItems>) };
    inline vector<DescribeDBClusterEndpointsZonalResponseBodyItems> items() { DARABONBA_PTR_GET(items_, vector<DescribeDBClusterEndpointsZonalResponseBodyItems>) };
    inline DescribeDBClusterEndpointsZonalResponseBody& setItems(const vector<DescribeDBClusterEndpointsZonalResponseBodyItems> & items) { DARABONBA_PTR_SET_VALUE(items_, items) };
    inline DescribeDBClusterEndpointsZonalResponseBody& setItems(vector<DescribeDBClusterEndpointsZonalResponseBodyItems> && items) { DARABONBA_PTR_SET_RVALUE(items_, items) };
  ...
  protected:
    std::shared_ptr<vector<DescribeDBClusterEndpointsZonalResponseBodyItems>> items_ = nullptr;
