...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeBackupPolicyResponseBody& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(EnableCrossRegionImmutableBackup, enableCrossRegionImmutableBackup_);
      DARABONBA_PTR_TO_JSON(EnableImmutableBackup, enableImmutableBackup_);
    ...
    friend void from_json(const Darabonba::Json& j, DescribeBackupPolicyResponseBody& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(EnableCrossRegionImmutableBackup, enableCrossRegionImmutableBackup_);
      DARABONBA_PTR_FROM_JSON(EnableImmutableBackup, enableImmutableBackup_);
    ...
    virtual bool empty() const override { return this->advancedDataPolicies_ == nullptr
        ...
        && this->dataLevel2BackupPeriod_ == nullptr && this->dataLevel2BackupRetentionPeriod_ == nullptr && this->enableCrossRegionImmutableBackup_ == nullptr && this->enableImmutableBackup_ == nullptr && this->preferredBackupPeriod_ == nullptr
    ...
    // enableCrossRegionImmutableBackup Field Functions 
    bool hasEnableCrossRegionImmutableBackup() const { return this->enableCrossRegionImmutableBackup_ != nullptr;};
    void deleteEnableCrossRegionImmutableBackup() { this->enableCrossRegionImmutableBackup_ = nullptr;};
    inline bool getEnableCrossRegionImmutableBackup() const { DARABONBA_PTR_GET_DEFAULT(enableCrossRegionImmutableBackup_, false) };
    inline DescribeBackupPolicyResponseBody& setEnableCrossRegionImmutableBackup(bool enableCrossRegionImmutableBackup) { DARABONBA_PTR_SET_VALUE(enableCrossRegionImmutableBackup_, enableCrossRegionImmutableBackup) };


    // enableImmutableBackup Field Functions 
    bool hasEnableImmutableBackup() const { return this->enableImmutableBackup_ != nullptr;};
    void deleteEnableImmutableBackup() { this->enableImmutableBackup_ = nullptr;};
    inline bool getEnableImmutableBackup() const { DARABONBA_PTR_GET_DEFAULT(enableImmutableBackup_, false) };
    inline DescribeBackupPolicyResponseBody& setEnableImmutableBackup(bool enableImmutableBackup) { DARABONBA_PTR_SET_VALUE(enableImmutableBackup_, enableImmutableBackup) };
  ...
  protected:
    ...
    shared_ptr<bool> enableCrossRegionImmutableBackup_ {};
    // Indicates whether immutable backup is enabled.
    shared_ptr<bool> enableImmutableBackup_ {};
