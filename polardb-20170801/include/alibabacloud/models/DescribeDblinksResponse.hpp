...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBLinksResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBLinksResponseBody) };
    inline DescribeDBLinksResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDBLinksResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBLinksResponseBody> body_ = nullptr;
  };
