...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHALogsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeHALogsResponseBody) };
    inline DescribeHALogsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeHALogsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeHALogsResponseBody> body_ = nullptr;
  };
