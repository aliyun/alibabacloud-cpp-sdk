...
namespace Models
{
  ...
  public:
    ...
    inline const CancelPolarFsFileQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelPolarFsFileQuotaResponseBody) };
    inline CancelPolarFsFileQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelPolarFsFileQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelPolarFsFileQuotaResponseBody> body_ {};
  };
