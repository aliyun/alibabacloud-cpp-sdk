...
namespace Models
{
  ...
  public:
    ...
    inline const RestartDBNodeZonalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RestartDBNodeZonalResponseBody) };
    inline RestartDBNodeZonalResponseBody getBody() { DARABONBA_PTR_GET(body_, RestartDBNodeZonalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RestartDBNodeZonalResponseBody> body_ {};
  };
