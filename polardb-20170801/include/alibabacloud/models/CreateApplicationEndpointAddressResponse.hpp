...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApplicationEndpointAddressResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateApplicationEndpointAddressResponseBody) };
    inline CreateApplicationEndpointAddressResponseBody body() { DARABONBA_PTR_GET(body_, CreateApplicationEndpointAddressResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateApplicationEndpointAddressResponseBody> body_ = nullptr;
  };
