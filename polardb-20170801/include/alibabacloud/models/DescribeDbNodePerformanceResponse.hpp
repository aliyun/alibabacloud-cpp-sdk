...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBNodePerformanceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBNodePerformanceResponseBody) };
    inline DescribeDBNodePerformanceResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDBNodePerformanceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBNodePerformanceResponseBody> body_ = nullptr;
  };
