...
namespace Models
{
  ...
  public:
    ...
    inline int32_t cycleType() const { DARABONBA_PTR_GET_DEFAULT(cycleType_, 0) };
    inline DescribeActiveOperationMaintainConfResponseBodyConfig& setCycleType(int32_t cycleType) { DARABONBA_PTR_SET_VALUE(cycleType_, cycleType) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> cycleType_ = nullptr;
