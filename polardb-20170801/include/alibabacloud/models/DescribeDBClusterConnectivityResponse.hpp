...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterConnectivityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterConnectivityResponseBody) };
    inline DescribeDBClusterConnectivityResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterConnectivityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterConnectivityResponseBody> body_ {};
  };
