...
namespace Models
{
  ...
  public:
    ...
    inline const ManuallyStartDBClusterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ManuallyStartDBClusterResponseBody) };
    inline ManuallyStartDBClusterResponseBody getBody() { DARABONBA_PTR_GET(body_, ManuallyStartDBClusterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ManuallyStartDBClusterResponseBody> body_ {};
  };
