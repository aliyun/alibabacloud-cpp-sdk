...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDatabaseZonalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDatabaseZonalResponseBody) };
    inline CreateDatabaseZonalResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDatabaseZonalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDatabaseZonalResponseBody> body_ {};
  };
