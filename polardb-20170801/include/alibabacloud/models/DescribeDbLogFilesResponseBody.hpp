...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceName_ == nullptr
        && return this->DBInstanceType_ == nullptr && return this->haLogItems_ == nullptr && return this->haStatus_ == nullptr && return this->itemsNumbers_ == nullptr && return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->switchListItems_ == nullptr && return this->switchLogItems_ == nullptr && return this->totalRecords_ == nullptr; };
