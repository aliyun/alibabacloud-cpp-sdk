...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->proxyData_ != nullptr
    ...
    inline string proxyData() const { DARABONBA_PTR_GET_DEFAULT(proxyData_, "") };
  ...
  protected:
    std::shared_ptr<string> proxyData_ = nullptr;
