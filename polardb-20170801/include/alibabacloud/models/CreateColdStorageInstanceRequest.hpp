...
namespace Models
{
  ...
  public:
    ...
    inline string getColdStorageInstanceDescription() const { DARABONBA_PTR_GET_DEFAULT(coldStorageInstanceDescription_, "") };
  ...
  protected:
    ...
    shared_ptr<string> coldStorageInstanceDescription_ {};
