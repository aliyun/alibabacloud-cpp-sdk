  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline Backup& setExpectExpireType(string expectExpireType) { DARABONBA_PTR_SET_VALUE(expectExpireType_, expectExpireType) };
    ...
    inline string getTotalLevel2BackupSize() const { DARABONBA_PTR_GET_DEFAULT(totalLevel2BackupSize_, "") };
