...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeActivationCodeDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeActivationCodeDetailsResponseBody) };
    inline DescribeActivationCodeDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeActivationCodeDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeActivationCodeDetailsResponseBody> body_ {};
  };
