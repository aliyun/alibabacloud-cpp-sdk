...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteCrossCloudOpenAPIResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ExecuteCrossCloudOpenAPIResponseBody) };
    inline ExecuteCrossCloudOpenAPIResponseBody body() { DARABONBA_PTR_GET(body_, ExecuteCrossCloudOpenAPIResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ExecuteCrossCloudOpenAPIResponseBody> body_ = nullptr;
  };
