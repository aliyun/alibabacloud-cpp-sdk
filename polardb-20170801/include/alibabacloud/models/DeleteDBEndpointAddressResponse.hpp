...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBEndpointAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDBEndpointAddressResponseBody) };
    inline DeleteDBEndpointAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDBEndpointAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDBEndpointAddressResponseBody> body_ {};
  };
