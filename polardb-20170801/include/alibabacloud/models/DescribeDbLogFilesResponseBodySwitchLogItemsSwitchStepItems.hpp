...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBNodeId_ == nullptr
        && return this->endTime_ == nullptr && return this->isSuccess_ == nullptr && return this->simulatePhase_ == nullptr && return this->startTime_ == nullptr && return this->stepMsg_ == nullptr
        && return this->stepName_ == nullptr && return this->timeCost_ == nullptr; };
