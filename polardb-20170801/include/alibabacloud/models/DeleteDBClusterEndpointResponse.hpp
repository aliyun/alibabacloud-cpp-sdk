...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBClusterEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDBClusterEndpointResponseBody) };
    inline DeleteDBClusterEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDBClusterEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDBClusterEndpointResponseBody> body_ {};
  };
