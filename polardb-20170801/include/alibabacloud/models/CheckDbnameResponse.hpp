...
namespace Models
{
  ...
  public:
    ...
    inline const CheckDBNameResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CheckDBNameResponseBody) };
    inline CheckDBNameResponseBody body() { DARABONBA_PTR_GET(body_, CheckDBNameResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CheckDBNameResponseBody> body_ = nullptr;
  };
