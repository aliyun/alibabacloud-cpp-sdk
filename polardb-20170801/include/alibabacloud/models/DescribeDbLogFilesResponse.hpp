...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBLogFilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBLogFilesResponseBody) };
    inline DescribeDBLogFilesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBLogFilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBLogFilesResponseBody> body_ {};
  };
