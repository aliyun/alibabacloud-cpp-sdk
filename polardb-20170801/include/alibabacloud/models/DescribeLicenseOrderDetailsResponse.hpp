...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLicenseOrderDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLicenseOrderDetailsResponseBody) };
    inline DescribeLicenseOrderDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLicenseOrderDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLicenseOrderDetailsResponseBody> body_ {};
  };
