...
namespace Models
{
  ...
  public:
    ...
    inline string getTargetDBAccount() const { DARABONBA_PTR_GET_DEFAULT(targetDBAccount_, "") };
    ...
    inline string getTargetDBPasswd() const { DARABONBA_PTR_GET_DEFAULT(targetDBPasswd_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> targetDBAccount_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<string> targetDBPasswd_ {};
