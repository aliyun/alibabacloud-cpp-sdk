...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDatabasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDatabasesResponseBody) };
    inline DescribeDatabasesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDatabasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDatabasesResponseBody> body_ {};
  };
