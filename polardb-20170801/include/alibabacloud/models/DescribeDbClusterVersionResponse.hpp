...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBClusterVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBClusterVersionResponseBody) };
    inline DescribeDBClusterVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBClusterVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBClusterVersionResponseBody> body_ {};
  };
