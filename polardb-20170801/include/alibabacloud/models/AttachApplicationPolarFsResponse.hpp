...
namespace Models
{
  ...
  public:
    ...
    inline const AttachApplicationPolarFSResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachApplicationPolarFSResponseBody) };
    inline AttachApplicationPolarFSResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachApplicationPolarFSResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachApplicationPolarFSResponseBody> body_ {};
  };
