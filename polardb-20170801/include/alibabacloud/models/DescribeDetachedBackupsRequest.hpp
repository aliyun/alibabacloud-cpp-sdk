...
namespace Models
{
  ...
  public:
    ...
    inline DescribeDetachedBackupsRequest& setBackupRegion(string backupRegion) { DARABONBA_PTR_SET_VALUE(backupRegion_, backupRegion) };
    ...
    inline DescribeDetachedBackupsRequest& setDBClusterId(string DBClusterId) { DARABONBA_PTR_SET_VALUE(DBClusterId_, DBClusterId) };
    ...
    inline DescribeDetachedBackupsRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline DescribeDetachedBackupsRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline DescribeDetachedBackupsRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
