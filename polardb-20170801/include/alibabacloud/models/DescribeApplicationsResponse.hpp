...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeApplicationsResponseBody) };
    inline DescribeApplicationsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeApplicationsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeApplicationsResponseBody> body_ = nullptr;
  };
