...
#ifndef ALIBABACLOUD_MODELS_MODIFYGLOBALSECURITYIPGROUPRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MODIFYGLOBALSECURITYIPGROUPRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyGlobalSecurityIPGroupResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(GlobalSecurityIPGroup, globalSecurityIPGroup_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyGlobalSecurityIPGroupResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(GlobalSecurityIPGroup, globalSecurityIPGroup_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    ModifyGlobalSecurityIPGroupResponseBody() = default ;
    ModifyGlobalSecurityIPGroupResponseBody(const ModifyGlobalSecurityIPGroupResponseBody &) = default ;
    ModifyGlobalSecurityIPGroupResponseBody(ModifyGlobalSecurityIPGroupResponseBody &&) = default ;
    ModifyGlobalSecurityIPGroupResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyGlobalSecurityIPGroupResponseBody() = default ;
    ModifyGlobalSecurityIPGroupResponseBody& operator=(const ModifyGlobalSecurityIPGroupResponseBody &) = default ;
    ModifyGlobalSecurityIPGroupResponseBody& operator=(ModifyGlobalSecurityIPGroupResponseBody &&) = default ;
    ...
    inline const vector<ModifyGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> & getGlobalSecurityIPGroup() const { DARABONBA_PTR_GET_CONST(globalSecurityIPGroup_, vector<ModifyGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup>) };
    inline vector<ModifyGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> getGlobalSecurityIPGroup() { DARABONBA_PTR_GET(globalSecurityIPGroup_, vector<ModifyGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup>) };
    inline ModifyGlobalSecurityIPGroupResponseBody& setGlobalSecurityIPGroup(const vector<ModifyGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> & globalSecurityIPGroup) { DARABONBA_PTR_SET_VALUE(globalSecurityIPGroup_, globalSecurityIPGroup) };
    inline ModifyGlobalSecurityIPGroupResponseBody& setGlobalSecurityIPGroup(vector<ModifyGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup> && globalSecurityIPGroup) { DARABONBA_PTR_SET_RVALUE(globalSecurityIPGroup_, globalSecurityIPGroup) };
    ...
    inline ModifyGlobalSecurityIPGroupResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the global IP whitelist template.
    shared_ptr<vector<ModifyGlobalSecurityIPGroupResponseBody::GlobalSecurityIPGroup>> globalSecurityIPGroup_ {};
