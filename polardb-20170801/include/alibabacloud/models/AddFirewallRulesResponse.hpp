...
namespace Models
{
  ...
  public:
    ...
    inline const AddFirewallRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddFirewallRulesResponseBody) };
    inline AddFirewallRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, AddFirewallRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddFirewallRulesResponseBody> body_ {};
  };
