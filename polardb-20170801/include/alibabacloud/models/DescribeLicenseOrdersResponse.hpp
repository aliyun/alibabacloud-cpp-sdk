...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLicenseOrdersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLicenseOrdersResponseBody) };
    inline DescribeLicenseOrdersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLicenseOrdersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLicenseOrdersResponseBody> body_ {};
  };
