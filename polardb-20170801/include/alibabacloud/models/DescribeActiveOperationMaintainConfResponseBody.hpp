...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline int32_t getCycleType() const { DARABONBA_PTR_GET_DEFAULT(cycleType_, 0) };
      inline Config& setCycleType(int32_t cycleType) { DARABONBA_PTR_SET_VALUE(cycleType_, cycleType) };
