...
namespace Models
{
  ...
  public:
    ...
    inline const CheckAccountNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckAccountNameResponseBody) };
    inline CheckAccountNameResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckAccountNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckAccountNameResponseBody> body_ {};
  };
