...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMetaListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMetaListResponseBody) };
    inline DescribeMetaListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMetaListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMetaListResponseBody> body_ {};
  };
