...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoAddNewNodes_ == nullptr
        ...
        && return this->nodes_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->polarFsInstanceId_ == nullptr && return this->polarSccTimeoutAction_ == nullptr
        && return this->polarSccWaitTimeout_ == nullptr && return this->readWriteMode_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->sccMode_ == nullptr; };
