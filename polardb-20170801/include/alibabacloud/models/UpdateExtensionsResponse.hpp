...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateExtensionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateExtensionsResponseBody) };
    inline UpdateExtensionsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateExtensionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateExtensionsResponseBody> body_ {};
  };
