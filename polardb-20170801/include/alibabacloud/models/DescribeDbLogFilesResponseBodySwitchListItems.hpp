...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBNodeCrashList_ == nullptr
        && return this->endTime_ == nullptr && return this->eventFinishTime_ == nullptr && return this->eventStartTime_ == nullptr && return this->faultInjectionType_ == nullptr && return this->simulateListId_ == nullptr
        && return this->simulateMode_ == nullptr && return this->simulateStatus_ == nullptr && return this->simulateTaskId_ == nullptr && return this->startTime_ == nullptr && return this->switchLogItems_ == nullptr
        && return this->switchStepItems_ == nullptr; };
