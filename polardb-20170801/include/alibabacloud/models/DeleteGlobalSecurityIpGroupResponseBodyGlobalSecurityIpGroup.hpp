...
#ifndef ALIBABACLOUD_MODELS_DELETEGLOBALSECURITYIPGROUPRESPONSEBODYGLOBALSECURITYIPGROUP_HPP_
#define ALIBABACLOUD_MODELS_DELETEGLOBALSECURITYIPGROUPRESPONSEBODYGLOBALSECURITYIPGROUP_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& obj) { 
    ...
    DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup() = default ;
    DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup(const DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup &) = default ;
    DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup(DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup &&) = default ;
    DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup() = default ;
    DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& operator=(const DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup &) = default ;
    DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& operator=(DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup &&) = default ;
    ...
    inline DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setDBInstances(const vector<string> & DBInstances) { DARABONBA_PTR_SET_VALUE(DBInstances_, DBInstances) };
    inline DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setDBInstances(vector<string> && DBInstances) { DARABONBA_PTR_SET_RVALUE(DBInstances_, DBInstances) };
    ...
    inline DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setGIpList(string GIpList) { DARABONBA_PTR_SET_VALUE(GIpList_, GIpList) };
    ...
    inline DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setGlobalIgName(string globalIgName) { DARABONBA_PTR_SET_VALUE(globalIgName_, globalIgName) };
    ...
    inline DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setGlobalSecurityGroupId(string globalSecurityGroupId) { DARABONBA_PTR_SET_VALUE(globalSecurityGroupId_, globalSecurityGroupId) };
    ...
    inline DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
