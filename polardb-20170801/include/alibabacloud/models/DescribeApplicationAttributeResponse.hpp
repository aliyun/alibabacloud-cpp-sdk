...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApplicationAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApplicationAttributeResponseBody) };
    inline DescribeApplicationAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApplicationAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApplicationAttributeResponseBody> body_ {};
  };
