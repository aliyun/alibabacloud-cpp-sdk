...
#ifndef ALIBABACLOUD_MODELS_CREATEPOLARCLAWCRONJOBREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEPOLARCLAWCRONJOBREQUEST_HPP_
...
namespace Models
{
  class CreatePolarClawCronJobRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreatePolarClawCronJobRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePolarClawCronJobRequest& obj) { 
    ...
    CreatePolarClawCronJobRequest() = default ;
    CreatePolarClawCronJobRequest(const CreatePolarClawCronJobRequest &) = default ;
    CreatePolarClawCronJobRequest(CreatePolarClawCronJobRequest &&) = default ;
    CreatePolarClawCronJobRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePolarClawCronJobRequest() = default ;
    CreatePolarClawCronJobRequest& operator=(const CreatePolarClawCronJobRequest &) = default ;
    CreatePolarClawCronJobRequest& operator=(CreatePolarClawCronJobRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->agentId_ == nullptr
        ...
        && this->failureAlert_ == nullptr && this->name_ == nullptr && this->payload_ == nullptr && this->restart_ == nullptr && this->runImmediately_ == nullptr
    ...
    inline CreatePolarClawCronJobRequest& setAgentId(string agentId) { DARABONBA_PTR_SET_VALUE(agentId_, agentId) };
    ...
    inline CreatePolarClawCronJobRequest& setApplicationId(string applicationId) { DARABONBA_PTR_SET_VALUE(applicationId_, applicationId) };
    ...
    inline CreatePolarClawCronJobRequest& setDeleteAfterRun(bool deleteAfterRun) { DARABONBA_PTR_SET_VALUE(deleteAfterRun_, deleteAfterRun) };


    // delivery Field Functions 
    bool hasDelivery() const { return this->delivery_ != nullptr;};
    void deleteDelivery() { this->delivery_ = nullptr;};
    inline const CreatePolarClawCronJobRequest::Delivery & getDelivery() const { DARABONBA_PTR_GET_CONST(delivery_, CreatePolarClawCronJobRequest::Delivery) };
    inline CreatePolarClawCronJobRequest::Delivery getDelivery() { DARABONBA_PTR_GET(delivery_, CreatePolarClawCronJobRequest::Delivery) };
    inline CreatePolarClawCronJobRequest& setDelivery(const CreatePolarClawCronJobRequest::Delivery & delivery) { DARABONBA_PTR_SET_VALUE(delivery_, delivery) };
    inline CreatePolarClawCronJobRequest& setDelivery(CreatePolarClawCronJobRequest::Delivery && delivery) { DARABONBA_PTR_SET_RVALUE(delivery_, delivery) };
    ...
    inline CreatePolarClawCronJobRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreatePolarClawCronJobRequest& setEnabled(bool enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
    ...
    inline const CreatePolarClawCronJobRequest::FailureAlert & getFailureAlert() const { DARABONBA_PTR_GET_CONST(failureAlert_, CreatePolarClawCronJobRequest::FailureAlert) };
    inline CreatePolarClawCronJobRequest::FailureAlert getFailureAlert() { DARABONBA_PTR_GET(failureAlert_, CreatePolarClawCronJobRequest::FailureAlert) };
    inline CreatePolarClawCronJobRequest& setFailureAlert(const CreatePolarClawCronJobRequest::FailureAlert & failureAlert) { DARABONBA_PTR_SET_VALUE(failureAlert_, failureAlert) };
    inline CreatePolarClawCronJobRequest& setFailureAlert(CreatePolarClawCronJobRequest::FailureAlert && failureAlert) { DARABONBA_PTR_SET_RVALUE(failureAlert_, failureAlert) };
    ...
    inline CreatePolarClawCronJobRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const CreatePolarClawCronJobRequest::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, CreatePolarClawCronJobRequest::Payload) };
    inline CreatePolarClawCronJobRequest::Payload getPayload() { DARABONBA_PTR_GET(payload_, CreatePolarClawCronJobRequest::Payload) };
    inline CreatePolarClawCronJobRequest& setPayload(const CreatePolarClawCronJobRequest::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline CreatePolarClawCronJobRequest& setPayload(CreatePolarClawCronJobRequest::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };
    ...
    inline CreatePolarClawCronJobRequest& setRestart(bool restart) { DARABONBA_PTR_SET_VALUE(restart_, restart) };
    ...
    inline CreatePolarClawCronJobRequest& setRunImmediately(bool runImmediately) { DARABONBA_PTR_SET_VALUE(runImmediately_, runImmediately) };


    // schedule Field Functions 
    bool hasSchedule() const { return this->schedule_ != nullptr;};
    void deleteSchedule() { this->schedule_ = nullptr;};
    inline const CreatePolarClawCronJobRequest::Schedule & getSchedule() const { DARABONBA_PTR_GET_CONST(schedule_, CreatePolarClawCronJobRequest::Schedule) };
    inline CreatePolarClawCronJobRequest::Schedule getSchedule() { DARABONBA_PTR_GET(schedule_, CreatePolarClawCronJobRequest::Schedule) };
    inline CreatePolarClawCronJobRequest& setSchedule(const CreatePolarClawCronJobRequest::Schedule & schedule) { DARABONBA_PTR_SET_VALUE(schedule_, schedule) };
    inline CreatePolarClawCronJobRequest& setSchedule(CreatePolarClawCronJobRequest::Schedule && schedule) { DARABONBA_PTR_SET_RVALUE(schedule_, schedule) };
    ...
    inline CreatePolarClawCronJobRequest& setSessionKey(string sessionKey) { DARABONBA_PTR_SET_VALUE(sessionKey_, sessionKey) };
    ...
    inline CreatePolarClawCronJobRequest& setSessionTarget(string sessionTarget) { DARABONBA_PTR_SET_VALUE(sessionTarget_, sessionTarget) };
    ...
    inline CreatePolarClawCronJobRequest& setWakeMode(string wakeMode) { DARABONBA_PTR_SET_VALUE(wakeMode_, wakeMode) };
