...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->configName_ == nullptr
        && return this->configValue_ == nullptr && return this->DBClusterId_ == nullptr && return this->DBNodeId_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr
