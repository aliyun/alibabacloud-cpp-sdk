...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScheduleTasksResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeScheduleTasksResponseBodyData) };
    inline DescribeScheduleTasksResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeScheduleTasksResponseBodyData) };
    inline DescribeScheduleTasksResponseBody& setData(const DescribeScheduleTasksResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeScheduleTasksResponseBody& setData(DescribeScheduleTasksResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The result data.
    std::shared_ptr<DescribeScheduleTasksResponseBodyData> data_ = nullptr;
