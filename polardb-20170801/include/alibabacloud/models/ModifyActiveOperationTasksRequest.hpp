...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->immediateStart_ == nullptr
        ...
        && return this->securityToken_ == nullptr && return this->switchTime_ == nullptr && return this->taskIds_ == nullptr; };
