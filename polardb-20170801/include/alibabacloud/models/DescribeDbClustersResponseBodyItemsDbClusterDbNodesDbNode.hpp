...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBNodeClass_ == nullptr
        && return this->DBNodeId_ == nullptr && return this->DBNodeRole_ == nullptr && return this->hotReplicaMode_ == nullptr && return this->imciSwitch_ == nullptr && return this->regionId_ == nullptr
        && return this->serverless_ == nullptr && return this->zoneId_ == nullptr; };
