...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceName_ == nullptr
        ...
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->totalRecords_ == nullptr; };
    ...
    inline const vector<DescribeHALogsResponseBodyHaLogItems> & haLogItems() const { DARABONBA_PTR_GET_CONST(haLogItems_, vector<DescribeHALogsResponseBodyHaLogItems>) };
    inline vector<DescribeHALogsResponseBodyHaLogItems> haLogItems() { DARABONBA_PTR_GET(haLogItems_, vector<DescribeHALogsResponseBodyHaLogItems>) };
    inline DescribeHALogsResponseBody& setHaLogItems(const vector<DescribeHALogsResponseBodyHaLogItems> & haLogItems) { DARABONBA_PTR_SET_VALUE(haLogItems_, haLogItems) };
    inline DescribeHALogsResponseBody& setHaLogItems(vector<DescribeHALogsResponseBodyHaLogItems> && haLogItems) { DARABONBA_PTR_SET_RVALUE(haLogItems_, haLogItems) };
  ...
  protected:
    ...
    // The failover logs.
    std::shared_ptr<vector<DescribeHALogsResponseBodyHaLogItems>> haLogItems_ = nullptr;
