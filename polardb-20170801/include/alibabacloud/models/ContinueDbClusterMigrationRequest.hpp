...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBClusterId_ == nullptr
        && return this->forceSwitch_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr
    ...
    inline string forceSwitch() const { DARABONBA_PTR_GET_DEFAULT(forceSwitch_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> forceSwitch_ = nullptr;
