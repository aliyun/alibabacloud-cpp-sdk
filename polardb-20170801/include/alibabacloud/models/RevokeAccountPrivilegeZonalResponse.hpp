...
namespace Models
{
  ...
  public:
    ...
    inline const RevokeAccountPrivilegeZonalResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RevokeAccountPrivilegeZonalResponseBody) };
    inline RevokeAccountPrivilegeZonalResponseBody getBody() { DARABONBA_PTR_GET(body_, RevokeAccountPrivilegeZonalResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RevokeAccountPrivilegeZonalResponseBody> body_ {};
  };
