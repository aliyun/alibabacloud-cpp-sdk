...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAccountLockStateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAccountLockStateResponseBody) };
    inline ModifyAccountLockStateResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAccountLockStateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAccountLockStateResponseBody> body_ {};
  };
