  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline const Applications::Tags & getTags() const { DARABONBA_PTR_GET_CONST(tags_, Applications::Tags) };
        inline Applications::Tags getTags() { DARABONBA_PTR_GET(tags_, Applications::Tags) };
        inline Applications& setTags(const Applications::Tags & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
        inline Applications& setTags(Applications::Tags && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
      ...
      protected:
        ...
        shared_ptr<Applications::Tags> tags_ {};
