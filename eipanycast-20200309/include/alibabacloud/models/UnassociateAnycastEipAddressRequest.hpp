...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->anycastId_ == nullptr
        && return this->bindInstanceId_ == nullptr && return this->bindInstanceRegionId_ == nullptr && return this->bindInstanceType_ == nullptr && return this->clientToken_ == nullptr && return this->dryRun_ == nullptr
