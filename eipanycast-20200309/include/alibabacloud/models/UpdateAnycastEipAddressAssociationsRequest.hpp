...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->anycastId_ != nullptr
        && this->associationMode_ != nullptr && this->bindInstanceId_ != nullptr && this->clientToken_ != nullptr && this->dryRun_ != nullptr && this->popLocationAddList_ != nullptr
        && this->popLocationDeleteList_ != nullptr; };
