...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bindInstanceId_ == nullptr
        && return this->bindInstanceRegionId_ == nullptr && return this->bindInstanceType_ == nullptr && return this->bindTime_ == nullptr; };
