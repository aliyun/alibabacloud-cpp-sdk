...
UpdateMailAddressMsgCallBackUrlResponse Alibabacloud_Dm20151123::Client::updateMailAddressMsgCallBackUrlWithOptions(shared_ptr<UpdateMailAddressMsgCallBackUrlRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("UpdateMailAddressMsgCallBackUrl"))},
    {"version", boost::any(string("2015-11-23"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return UpdateMailAddressMsgCallBackUrlResponse(callApi(params, req, runtime));
}

UpdateMailAddressMsgCallBackUrlResponse Alibabacloud_Dm20151123::Client::updateMailAddressMsgCallBackUrl(shared_ptr<UpdateMailAddressMsgCallBackUrlRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
