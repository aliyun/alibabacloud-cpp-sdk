 ...
 */
BatchSendMailResponse Client::batchSendMailWithOptions(const BatchSendMailRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  tmpReq.validate();
  BatchSendMailShrinkRequest request = BatchSendMailShrinkRequest();
  Utils::Utils::convert(tmpReq, request);
  if (!!tmpReq.hasReceivers()) {
    request.setReceiversShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getReceivers(), "Receivers", "json"));
  }

  if (!!tmpReq.hasTemplateContent()) {
    request.setTemplateContentShrink(Utils::Utils::arrayToStringWithSpecifiedStyle(tmpReq.getTemplateContent(), "TemplateContent", "json"));
  }
  ...
  if (!!request.hasClickTrace()) {
    query["ClickTrace"] = request.getClickTrace();
  }

  if (!!request.hasDomainAuth()) {
    query["DomainAuth"] = request.getDomainAuth();
  }
  ...
  if (!!request.hasReceiversName()) {
    query["ReceiversName"] = request.getReceiversName();
  }

  if (!!request.hasReplyAddress()) {
    query["ReplyAddress"] = request.getReplyAddress();
  }

  if (!!request.hasReplyAddressAlias()) {
    query["ReplyAddressAlias"] = request.getReplyAddressAlias();
  }
  ...
  if (!!request.hasUnSubscribeFilterLevel()) {
    query["UnSubscribeFilterLevel"] = request.getUnSubscribeFilterLevel();
  }

  if (!!request.hasUnSubscribeLinkType()) {
    query["UnSubscribeLinkType"] = request.getUnSubscribeLinkType();
  }

  json body = {};
  if (!!request.hasReceiversShrink()) {
    body["Receivers"] = request.getReceiversShrink();
  }

  if (!!request.hasTemplateContentShrink()) {
    body["TemplateContent"] = request.getTemplateContentShrink();
  }
...
ChangeDomainDkimRecordResponse Client::changeDomainDkimRecordWithOptions(const ChangeDomainDkimRecordRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasDkimRsaLength()) {
    query["DkimRsaLength"] = request.getDkimRsaLength();
  }
...
CheckReplyToMailAddressResponse Client::checkReplyToMailAddressWithOptions(const CheckReplyToMailAddressRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasMailAddressId()) {
    query["MailAddressId"] = request.getMailAddressId();
  }
...
ConfigSetCancelRelationFromAddressResponse Client::configSetCancelRelationFromAddressWithOptions(const ConfigSetCancelRelationFromAddressRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasFromAddress()) {
    query["FromAddress"] = request.getFromAddress();
  }
...
CreateDomainResponse Client::createDomainWithOptions(const CreateDomainRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasDkimSelector()) {
    query["dkimSelector"] = request.getDkimSelector();
  }
...
CreateReceiverResponse Client::createReceiverWithOptions(const CreateReceiverRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasReceiversAlias()) {
    query["ReceiversAlias"] = request.getReceiversAlias();
  }
...
CreateTagResponse Client::createTagWithOptions(const CreateTagRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasTagDescription()) {
    query["TagDescription"] = request.getTagDescription();
  }
...
/**
 * @summary Creates a new mail template in DirectMail.
 *
...
DedicatedIpAutoRenewalResponse Client::dedicatedIpAutoRenewalWithOptions(const DedicatedIpAutoRenewalRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasBuyResourceIds()) {
    query["BuyResourceIds"] = request.getBuyResourceIds();
  }
...
DedicatedIpChangeWarmupTypeResponse Client::dedicatedIpChangeWarmupTypeWithOptions(const DedicatedIpChangeWarmupTypeRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasWarmupType()) {
    query["WarmupType"] = request.getWarmupType();
  }
...
DedicatedIpPoolListResponse Client::dedicatedIpPoolListWithOptions(const DedicatedIpPoolListRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasPoolId()) {
    query["PoolId"] = request.getPoolId();
  }
...
DedicatedIpPoolUpdateResponse Client::dedicatedIpPoolUpdateWithOptions(const DedicatedIpPoolUpdateRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasUpdateResource()) {
    query["UpdateResource"] = request.getUpdateResource();
  }
...
DeleteInvalidAddressResponse Client::deleteInvalidAddressWithOptions(const DeleteInvalidAddressRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasToAddress()) {
    query["ToAddress"] = request.getToAddress();
  }
...
/**
 * @summary Configure the domain name.
 *
...
DescDomainResponse Client::descDomainWithOptions(const DescDomainRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasRequireRealTimeDnsRecords()) {
    query["RequireRealTimeDnsRecords"] = request.getRequireRealTimeDnsRecords();
  }
...
GetDedicatedIpWarmUpDetailResponse Client::getDedicatedIpWarmUpDetailWithOptions(const GetDedicatedIpWarmUpDetailRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasDedicatedIp()) {
    query["DedicatedIp"] = request.getDedicatedIp();
  }

  if (!!request.hasEndDayMark()) {
    query["EndDayMark"] = request.getEndDayMark();
  }

  if (!!request.hasEsp()) {
    query["Esp"] = request.getEsp();
  }

  if (!!request.hasStartDayMark()) {
    query["StartDayMark"] = request.getStartDayMark();
  }
 ...
 */
GetSendifyAutoLoginURLResponse Client::getSendifyAutoLoginURLWithOptions(const Darabonba::RuntimeOptions &runtime) {
  OpenApiRequest req = OpenApiRequest();
  Params params = Params(json({
  ...
  return json(callApi(params, req, runtime)).get<GetSendifyAutoLoginURLResponse>();
}
 ...
 * @return GetSendifyAutoLoginURLResponse
 */
GetSendifyAutoLoginURLResponse Client::getSendifyAutoLoginURL() {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
 ...
 */
GetSendifyInfoResponse Client::getSendifyInfoWithOptions(const Darabonba::RuntimeOptions &runtime) {
  OpenApiRequest req = OpenApiRequest();
  Params params = Params(json({
  ...
  return json(callApi(params, req, runtime)).get<GetSendifyInfoResponse>();
}
 ...
 * @return GetSendifyInfoResponse
 */
GetSendifyInfoResponse Client::getSendifyInfo() {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
...
GetTrackListResponse Client::getTrackListWithOptions(const GetTrackListRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasConfigSetId()) {
    query["ConfigSetId"] = request.getConfigSetId();
  }
  ...
  if (!!request.hasDedicatedIpPoolId()) {
    query["DedicatedIpPoolId"] = request.getDedicatedIpPoolId();
  }
  ...
  if (!!request.hasOffsetCreateTime()) {
    query["OffsetCreateTime"] = request.getOffsetCreateTime();
  }

  if (!!request.hasOffsetCreateTimeDesc()) {
    query["OffsetCreateTimeDesc"] = request.getOffsetCreateTimeDesc();
  }
...
/**
 * @summary Retrieves the status of a file validation task.
 *
...
ListBlockSendingResponse Client::listBlockSendingWithOptions(const ListBlockSendingRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasBlockEmail()) {
    query["BlockEmail"] = request.getBlockEmail();
  }

  if (!!request.hasBlockType()) {
    query["BlockType"] = request.getBlockType();
  }
  ...
  if (!!request.hasSenderEmail()) {
    query["SenderEmail"] = request.getSenderEmail();
  }
...
ListUserSuppressionResponse Client::listUserSuppressionWithOptions(const ListUserSuppressionRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasEndBounceTime()) {
    query["EndBounceTime"] = request.getEndBounceTime();
  }
  ...
  if (!!request.hasStartBounceTime()) {
    query["StartBounceTime"] = request.getStartBounceTime();
  }
...
ListValidateFileResponse Client::listValidateFileWithOptions(const ListValidateFileRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasFileKeyword()) {
    query["FileKeyword"] = request.getFileKeyword();
  }
 ...
 */
OpenSendifyTrialServiceResponse Client::openSendifyTrialServiceWithOptions(const Darabonba::RuntimeOptions &runtime) {
  OpenApiRequest req = OpenApiRequest();
  Params params = Params(json({
  ...
  return json(callApi(params, req, runtime)).get<OpenSendifyTrialServiceResponse>();
}
 ...
 * @return OpenSendifyTrialServiceResponse
 */
OpenSendifyTrialServiceResponse Client::openSendifyTrialService() {
  Darabonba::RuntimeOptions runtime = RuntimeOptions();
...
QueryInvalidAddressResponse Client::queryInvalidAddressWithOptions(const QueryInvalidAddressRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasNextStart()) {
    query["NextStart"] = request.getNextStart();
  }
...
RemoveUserSuppressionResponse Client::removeUserSuppressionWithOptions(const RemoveUserSuppressionRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasSuppressionIds()) {
    query["SuppressionIds"] = request.getSuppressionIds();
  }
...
SaveReceiverDetailResponse Client::saveReceiverDetailWithOptions(const SaveReceiverDetailRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasCustomDetail()) {
    query["CustomDetail"] = request.getCustomDetail();
  }
...
/**
 * @summary Sends a test email using a template.
 *
...
SendTestByTemplateResponse Client::sendTestByTemplateWithOptions(const SendTestByTemplateRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasTemplateParams()) {
    query["TemplateParams"] = request.getTemplateParams();
  }
...
SendValidateFileResponse Client::sendValidateFileWithOptions(const SendValidateFileRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAddressColumn()) {
    query["AddressColumn"] = request.getAddressColumn();
  }
  ...
  if (!!request.hasHasHeaderRow()) {
    query["HasHeaderRow"] = request.getHasHeaderRow();
  }

  if (!!request.hasRemoveDuplicate()) {
    query["RemoveDuplicate"] = request.getRemoveDuplicate();
  }
...
SetSuppressionListLevelResponse Client::setSuppressionListLevelWithOptions(const SetSuppressionListLevelRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasSuppressionListLevel()) {
    query["SuppressionListLevel"] = request.getSuppressionListLevel();
  }
...
SingleSendMailResponse Client::singleSendMailWithOptions(const SingleSendMailRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasBccAddress()) {
    body["BccAddress"] = request.getBccAddress();
  }

  if (!!request.hasClickTrace()) {
    body["ClickTrace"] = request.getClickTrace();
  }

  if (!!request.hasDomainAuth()) {
    body["DomainAuth"] = request.getDomainAuth();
  }

  if (!!request.hasFromAlias()) {
    body["FromAlias"] = request.getFromAlias();
  }
  ...
  if (!!request.hasHtmlBody()) {
    body["HtmlBody"] = request.getHtmlBody();
  }

  if (!!request.hasIpPoolId()) {
    body["IpPoolId"] = request.getIpPoolId();
  }

  if (!!request.hasReplyAddress()) {
    body["ReplyAddress"] = request.getReplyAddress();
  }

  if (!!request.hasReplyAddressAlias()) {
    body["ReplyAddressAlias"] = request.getReplyAddressAlias();
  }

  if (!!request.hasReplyToAddress()) {
    body["ReplyToAddress"] = request.getReplyToAddress();
  }
  ...
  if (!!request.hasTemplateShrink()) {
    body["Template"] = request.getTemplateShrink();
  }

  if (!!request.hasTextBody()) {
    body["TextBody"] = request.getTextBody();
  }

  if (!!request.hasToAddress()) {
    body["ToAddress"] = request.getToAddress();
  }

  if (!!request.hasUnSubscribeFilterLevel()) {
    body["UnSubscribeFilterLevel"] = request.getUnSubscribeFilterLevel();
  }

  if (!!request.hasUnSubscribeLinkType()) {
    body["UnSubscribeLinkType"] = request.getUnSubscribeLinkType();
  }
...
SingleSendMailResponse Client::singleSendMailAdvance(const SingleSendMailAdvanceRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasAttachments()) {
    int32_t i0 = 0;
    for (SingleSendMailAdvanceRequestAttachments item0 : request.getAttachments()) {
      if (!!item0.hasAttachmentUrlObject()) {
        ...
        fileObj = FileField(json({
          {"filename" , authResponseBody.at("ObjectKey")},
          {"content" , item0.getAttachmentUrlObject()},
          {"contentType" , ""}
        }));
        ossHeader = json({
          {"host" , Utils::Utils::getEndpoint(authResponseBody.at("Endpoint"), useAccelerate, _endpointType)},
        ...
        _postOSSObject(authResponseBody.at("Bucket"), ossHeader, runtime);
        SingleSendMailRequestAttachments tmpObj = singleSendMailReq.getAttachments().at(i0);
...
UpdateIpProtectionResponse Client::updateIpProtectionWithOptions(const UpdateIpProtectionRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasIpProtection()) {
    query["IpProtection"] = request.getIpProtection();
  }
...
UpdateUserResponse Client::updateUserWithOptions(const UpdateUserRequest &tmpReq, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasUserShrink()) {
    body["User"] = request.getUserShrink();
  }
...
ValidateEmailResponse Client::validateEmailWithOptions(const ValidateEmailRequest &request, const Darabonba::RuntimeOptions &runtime) {
  ...
  if (!!request.hasCheckGraylist()) {
    query["CheckGraylist"] = request.getCheckGraylist();
  }
