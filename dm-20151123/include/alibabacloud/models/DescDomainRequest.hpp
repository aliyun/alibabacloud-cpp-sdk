...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->domainId_ == nullptr
        && return this->ownerId_ == nullptr && return this->requireRealTimeDnsRecords_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr; };
    ...
    inline bool requireRealTimeDnsRecords() const { DARABONBA_PTR_GET_DEFAULT(requireRealTimeDnsRecords_, false) };
  ...
  protected:
    ...
    std::shared_ptr<bool> requireRealTimeDnsRecords_ = nullptr;
