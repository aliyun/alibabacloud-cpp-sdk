...
#include <alibabacloud/models/SingleSendMailAdvanceRequestTemplate.hpp>
using namespace std;
...
namespace Models
{
  ...
  public:
    ...
    inline const SingleSendMailAdvanceRequestTemplate & _template() const { DARABONBA_PTR_GET_CONST(template_, SingleSendMailAdvanceRequestTemplate) };
    inline SingleSendMailAdvanceRequestTemplate _template() { DARABONBA_PTR_GET(template_, SingleSendMailAdvanceRequestTemplate) };
    inline SingleSendMailAdvanceRequest& setTemplate(const SingleSendMailAdvanceRequestTemplate & _template) { DARABONBA_PTR_SET_VALUE(template_, _template) };
    inline SingleSendMailAdvanceRequest& setTemplate(SingleSendMailAdvanceRequestTemplate && _template) { DARABONBA_PTR_SET_RVALUE(template_, _template) };
  ...
  protected:
    ...
    std::shared_ptr<SingleSendMailAdvanceRequestTemplate> template_ = nullptr;
