...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->mailAddressId_ == nullptr
        && return this->ownerId_ == nullptr && return this->password_ == nullptr && return this->replyAddress_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr; };
