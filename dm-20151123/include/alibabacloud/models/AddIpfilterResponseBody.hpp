...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->ipFilterId_ != nullptr
    ...
    inline string ipFilterId() const { DARABONBA_PTR_GET_DEFAULT(ipFilterId_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> ipFilterId_ = nullptr;
    // Request ID
