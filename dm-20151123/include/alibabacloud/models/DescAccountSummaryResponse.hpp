...
namespace Models
{
  ...
  public:
    ...
    inline const DescAccountSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescAccountSummaryResponseBody) };
    inline DescAccountSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, DescAccountSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescAccountSummaryResponseBody> body_ {};
  };
