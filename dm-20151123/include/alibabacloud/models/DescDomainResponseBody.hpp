...
namespace Models
{
  ...
  public:
    ...
    inline string cnameConfirmStatus() const { DARABONBA_PTR_GET_DEFAULT(cnameConfirmStatus_, "") };
    ...
    inline string cnameRecord() const { DARABONBA_PTR_GET_DEFAULT(cnameRecord_, "") };
    ...
    inline string dkimAuthStatus() const { DARABONBA_PTR_GET_DEFAULT(dkimAuthStatus_, "") };
    ...
    inline string dkimRR() const { DARABONBA_PTR_GET_DEFAULT(dkimRR_, "") };
    ...
    inline int32_t dmarcAuthStatus() const { DARABONBA_PTR_GET_DEFAULT(dmarcAuthStatus_, 0) };
    ...
    inline string dmarcHostRecord() const { DARABONBA_PTR_GET_DEFAULT(dmarcHostRecord_, "") };
    ...
    inline string dmarcRecord() const { DARABONBA_PTR_GET_DEFAULT(dmarcRecord_, "") };
    ...
    inline string dnsDmarc() const { DARABONBA_PTR_GET_DEFAULT(dnsDmarc_, "") };
    ...
    inline string dnsMx() const { DARABONBA_PTR_GET_DEFAULT(dnsMx_, "") };
    ...
    inline string dnsSpf() const { DARABONBA_PTR_GET_DEFAULT(dnsSpf_, "") };
    ...
    inline string dnsTxt() const { DARABONBA_PTR_GET_DEFAULT(dnsTxt_, "") };
    ...
    inline string hostRecord() const { DARABONBA_PTR_GET_DEFAULT(hostRecord_, "") };
    ...
    inline string mxRecord() const { DARABONBA_PTR_GET_DEFAULT(mxRecord_, "") };
    ...
    inline string spfRecord() const { DARABONBA_PTR_GET_DEFAULT(spfRecord_, "") };
    ...
    inline string spfRecordV2() const { DARABONBA_PTR_GET_DEFAULT(spfRecordV2_, "") };
    ...
    inline string tlDomainName() const { DARABONBA_PTR_GET_DEFAULT(tlDomainName_, "") };
    ...
    inline string tracefRecord() const { DARABONBA_PTR_GET_DEFAULT(tracefRecord_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> cnameConfirmStatus_ = nullptr;
    // Custom part of the CNAME host record
    std::shared_ptr<string> cnameRecord_ = nullptr;
    // Creation time
    ...
    std::shared_ptr<string> dkimAuthStatus_ = nullptr;
    ...
    std::shared_ptr<string> dkimRR_ = nullptr;
    ...
    std::shared_ptr<int32_t> dmarcAuthStatus_ = nullptr;
    // DMARC host record value
    std::shared_ptr<string> dmarcHostRecord_ = nullptr;
    // DMARC record value
    std::shared_ptr<string> dmarcRecord_ = nullptr;
    // DMARC record value resolved through the public domain name
    std::shared_ptr<string> dnsDmarc_ = nullptr;
    // MX record value resolved from the public network domain
    std::shared_ptr<string> dnsMx_ = nullptr;
    // SPF record value resolved from the public network domain
    std::shared_ptr<string> dnsSpf_ = nullptr;
    // Ownership record value resolved from the public network domain
    std::shared_ptr<string> dnsTxt_ = nullptr;
    // Domain ID
    ...
    // Host record
    std::shared_ptr<string> hostRecord_ = nullptr;
    ...
    std::shared_ptr<string> mxRecord_ = nullptr;
    // Request ID
    ...
    std::shared_ptr<string> spfRecord_ = nullptr;
    ...
    std::shared_ptr<string> spfRecordV2_ = nullptr;
    // Primary domain
    std::shared_ptr<string> tlDomainName_ = nullptr;
    // CNAME record value provided by the email push console
    std::shared_ptr<string> tracefRecord_ = nullptr;
  };
