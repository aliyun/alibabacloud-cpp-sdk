...
namespace Models
{
  ...
  public:
    ...
    inline const ApproveReplyMailAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApproveReplyMailAddressResponseBody) };
    inline ApproveReplyMailAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, ApproveReplyMailAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApproveReplyMailAddressResponseBody> body_ {};
  };
