...
namespace Models
{
  ...
  public:
    ...
    inline const CheckReplyToMailAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckReplyToMailAddressResponseBody) };
    inline CheckReplyToMailAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckReplyToMailAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckReplyToMailAddressResponseBody> body_ {};
  };
