...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->domainPart_ == nullptr
        && return this->isFreeMail_ == nullptr && return this->localPart_ == nullptr && return this->provider_ == nullptr && return this->requestId_ == nullptr && return this->status_ == nullptr
    ...
    inline string domainPart() const { DARABONBA_PTR_GET_DEFAULT(domainPart_, "") };
    ...
    inline bool isFreeMail() const { DARABONBA_PTR_GET_DEFAULT(isFreeMail_, false) };
    ...
    inline string localPart() const { DARABONBA_PTR_GET_DEFAULT(localPart_, "") };
  ...
  protected:
    std::shared_ptr<string> domainPart_ = nullptr;
    std::shared_ptr<bool> isFreeMail_ = nullptr;
    std::shared_ptr<string> localPart_ = nullptr;
