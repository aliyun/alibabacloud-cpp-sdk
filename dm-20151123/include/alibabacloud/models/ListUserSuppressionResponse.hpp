...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserSuppressionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserSuppressionResponseBody) };
    inline ListUserSuppressionResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserSuppressionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserSuppressionResponseBody> body_ {};
  };
