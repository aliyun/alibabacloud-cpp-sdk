...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigSetRelationFromAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigSetRelationFromAddressResponseBody) };
    inline ConfigSetRelationFromAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigSetRelationFromAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigSetRelationFromAddressResponseBody> body_ {};
  };
