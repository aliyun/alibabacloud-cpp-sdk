...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTemplateByParamResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryTemplateByParamResponseBodyData) };
    inline QueryTemplateByParamResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryTemplateByParamResponseBodyData) };
    inline QueryTemplateByParamResponseBody& setData(const QueryTemplateByParamResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryTemplateByParamResponseBody& setData(QueryTemplateByParamResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryTemplateByParamResponseBodyData> data_ = nullptr;
  };
