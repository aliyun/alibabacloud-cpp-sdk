...
namespace Models
{
  ...
  public:
    ...
    inline const ListValidateFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListValidateFileResponseBody) };
    inline ListValidateFileResponseBody getBody() { DARABONBA_PTR_GET(body_, ListValidateFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListValidateFileResponseBody> body_ {};
  };
