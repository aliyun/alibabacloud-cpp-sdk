...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveUserSuppressionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveUserSuppressionResponseBody) };
    inline RemoveUserSuppressionResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveUserSuppressionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveUserSuppressionResponseBody> body_ {};
  };
