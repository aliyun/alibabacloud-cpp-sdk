...
namespace Models
{
  ...
  public:
    ...
    inline const CheckDisposableResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CheckDisposableResponseBody) };
    inline CheckDisposableResponseBody body() { DARABONBA_PTR_GET(body_, CheckDisposableResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CheckDisposableResponseBody> body_ = nullptr;
  };
