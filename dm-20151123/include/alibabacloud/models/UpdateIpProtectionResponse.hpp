...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateIpProtectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateIpProtectionResponseBody) };
    inline UpdateIpProtectionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateIpProtectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateIpProtectionResponseBody> body_ {};
  };
