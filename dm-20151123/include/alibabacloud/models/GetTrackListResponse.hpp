...
namespace Models
{
  ...
  public:
    ...
    inline const GetTrackListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTrackListResponseBody) };
    inline GetTrackListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTrackListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTrackListResponseBody> body_ {};
  };
