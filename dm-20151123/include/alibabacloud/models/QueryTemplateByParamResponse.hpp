...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTemplateByParamResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryTemplateByParamResponseBody) };
    inline QueryTemplateByParamResponseBody body() { DARABONBA_PTR_GET(body_, QueryTemplateByParamResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryTemplateByParamResponseBody> body_ = nullptr;
  };
