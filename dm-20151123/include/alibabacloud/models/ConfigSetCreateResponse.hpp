...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigSetCreateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigSetCreateResponseBody) };
    inline ConfigSetCreateResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigSetCreateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigSetCreateResponseBody> body_ {};
  };
