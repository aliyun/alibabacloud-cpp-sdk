...
namespace Models
{
  ...
  public:
    ...
    inline const GetIpfilterListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetIpfilterListResponseBody) };
    inline GetIpfilterListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetIpfilterListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetIpfilterListResponseBody> body_ {};
  };
