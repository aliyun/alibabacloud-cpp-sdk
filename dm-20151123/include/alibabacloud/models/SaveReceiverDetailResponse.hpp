...
namespace Models
{
  ...
  public:
    ...
    inline const SaveReceiverDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveReceiverDetailResponseBody) };
    inline SaveReceiverDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveReceiverDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveReceiverDetailResponseBody> body_ {};
  };
