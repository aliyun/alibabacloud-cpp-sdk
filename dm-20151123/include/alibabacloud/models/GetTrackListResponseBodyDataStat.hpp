...
#ifndef ALIBABACLOUD_MODELS_GETTRACKLISTRESPONSEBODYDATASTAT_HPP_
#define ALIBABACLOUD_MODELS_GETTRACKLISTRESPONSEBODYDATASTAT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetTrackListResponseBodyDataStat& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetTrackListResponseBodyDataStat& obj) { 
    ...
    GetTrackListResponseBodyDataStat() = default ;
    GetTrackListResponseBodyDataStat(const GetTrackListResponseBodyDataStat &) = default ;
    GetTrackListResponseBodyDataStat(GetTrackListResponseBodyDataStat &&) = default ;
    GetTrackListResponseBodyDataStat(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetTrackListResponseBodyDataStat() = default ;
    GetTrackListResponseBodyDataStat& operator=(const GetTrackListResponseBodyDataStat &) = default ;
    GetTrackListResponseBodyDataStat& operator=(GetTrackListResponseBodyDataStat &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->createTime_ == nullptr
        && return this->rcptClickCount_ == nullptr && return this->rcptClickRate_ == nullptr && return this->rcptOpenCount_ == nullptr && return this->rcptOpenRate_ == nullptr && return this->rcptUniqueClickCount_ == nullptr
        && return this->rcptUniqueClickRate_ == nullptr && return this->rcptUniqueOpenCount_ == nullptr && return this->rcptUniqueOpenRate_ == nullptr && return this->totalNumber_ == nullptr; };
    // createTime Field Functions 
    bool hasCreateTime() const { return this->createTime_ != nullptr;};
    void deleteCreateTime() { this->createTime_ = nullptr;};
    inline string createTime() const { DARABONBA_PTR_GET_DEFAULT(createTime_, "") };
    inline GetTrackListResponseBodyDataStat& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline GetTrackListResponseBodyDataStat& setRcptClickCount(string rcptClickCount) { DARABONBA_PTR_SET_VALUE(rcptClickCount_, rcptClickCount) };
    ...
    inline GetTrackListResponseBodyDataStat& setRcptClickRate(string rcptClickRate) { DARABONBA_PTR_SET_VALUE(rcptClickRate_, rcptClickRate) };
    ...
    inline GetTrackListResponseBodyDataStat& setRcptOpenCount(string rcptOpenCount) { DARABONBA_PTR_SET_VALUE(rcptOpenCount_, rcptOpenCount) };
    ...
    inline GetTrackListResponseBodyDataStat& setRcptOpenRate(string rcptOpenRate) { DARABONBA_PTR_SET_VALUE(rcptOpenRate_, rcptOpenRate) };
    ...
    inline GetTrackListResponseBodyDataStat& setRcptUniqueClickCount(string rcptUniqueClickCount) { DARABONBA_PTR_SET_VALUE(rcptUniqueClickCount_, rcptUniqueClickCount) };
    ...
    inline GetTrackListResponseBodyDataStat& setRcptUniqueClickRate(string rcptUniqueClickRate) { DARABONBA_PTR_SET_VALUE(rcptUniqueClickRate_, rcptUniqueClickRate) };
    ...
    inline GetTrackListResponseBodyDataStat& setRcptUniqueOpenCount(string rcptUniqueOpenCount) { DARABONBA_PTR_SET_VALUE(rcptUniqueOpenCount_, rcptUniqueOpenCount) };
    ...
    inline GetTrackListResponseBodyDataStat& setRcptUniqueOpenRate(string rcptUniqueOpenRate) { DARABONBA_PTR_SET_VALUE(rcptUniqueOpenRate_, rcptUniqueOpenRate) };
    ...
    inline GetTrackListResponseBodyDataStat& setTotalNumber(string totalNumber) { DARABONBA_PTR_SET_VALUE(totalNumber_, totalNumber) };
