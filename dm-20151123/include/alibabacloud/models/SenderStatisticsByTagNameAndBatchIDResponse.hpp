...
namespace Models
{
  ...
  public:
    ...
    inline const SenderStatisticsByTagNameAndBatchIDResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SenderStatisticsByTagNameAndBatchIDResponseBody) };
    inline SenderStatisticsByTagNameAndBatchIDResponseBody getBody() { DARABONBA_PTR_GET(body_, SenderStatisticsByTagNameAndBatchIDResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SenderStatisticsByTagNameAndBatchIDResponseBody> body_ {};
  };
