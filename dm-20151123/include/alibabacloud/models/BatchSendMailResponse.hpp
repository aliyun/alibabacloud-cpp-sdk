...
namespace Models
{
  ...
  public:
    ...
    inline const BatchSendMailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchSendMailResponseBody) };
    inline BatchSendMailResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchSendMailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchSendMailResponseBody> body_ {};
  };
