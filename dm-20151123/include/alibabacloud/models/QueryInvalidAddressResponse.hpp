...
namespace Models
{
  ...
  public:
    ...
    inline const QueryInvalidAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryInvalidAddressResponseBody) };
    inline QueryInvalidAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryInvalidAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryInvalidAddressResponseBody> body_ {};
  };
