...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUserSuppressionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateUserSuppressionResponseBody) };
    inline CreateUserSuppressionResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateUserSuppressionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateUserSuppressionResponseBody> body_ {};
  };
