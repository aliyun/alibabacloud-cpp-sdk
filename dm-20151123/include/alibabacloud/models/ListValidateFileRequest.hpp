...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->endTime_ == nullptr
        && this->fileKeyword_ == nullptr && this->page_ == nullptr && this->pageSize_ == nullptr && this->startTime_ == nullptr; };
    ...
    inline string getFileKeyword() const { DARABONBA_PTR_GET_DEFAULT(fileKeyword_, "") };
