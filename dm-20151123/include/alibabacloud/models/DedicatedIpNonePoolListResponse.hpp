...
namespace Models
{
  ...
  public:
    ...
    inline const DedicatedIpNonePoolListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DedicatedIpNonePoolListResponseBody) };
    inline DedicatedIpNonePoolListResponseBody body() { DARABONBA_PTR_GET(body_, DedicatedIpNonePoolListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DedicatedIpNonePoolListResponseBody> body_ = nullptr;
  };
