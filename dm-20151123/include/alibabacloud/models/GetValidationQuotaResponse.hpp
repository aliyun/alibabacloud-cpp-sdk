...
namespace Models
{
  ...
  public:
    ...
    inline const GetValidationQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetValidationQuotaResponseBody) };
    inline GetValidationQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetValidationQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetValidationQuotaResponseBody> body_ {};
  };
