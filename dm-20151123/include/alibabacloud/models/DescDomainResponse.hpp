...
namespace Models
{
  ...
  public:
    ...
    inline const DescDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescDomainResponseBody) };
    inline DescDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, DescDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescDomainResponseBody> body_ {};
  };
