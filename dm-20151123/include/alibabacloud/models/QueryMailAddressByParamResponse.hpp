...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMailAddressByParamResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryMailAddressByParamResponseBody) };
    inline QueryMailAddressByParamResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryMailAddressByParamResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryMailAddressByParamResponseBody> body_ {};
  };
