...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDomainByParamResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryDomainByParamResponseBodyData) };
    inline QueryDomainByParamResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryDomainByParamResponseBodyData) };
    inline QueryDomainByParamResponseBody& setData(const QueryDomainByParamResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryDomainByParamResponseBody& setData(QueryDomainByParamResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // List of domains
    std::shared_ptr<QueryDomainByParamResponseBodyData> data_ = nullptr;
  };
