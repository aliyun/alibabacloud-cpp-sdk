...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->isDisposable_ == nullptr
        && this->isFormatValid_ == nullptr && this->isMxValid_ == nullptr && this->isOkToSend_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline string getIsDisposable() const { DARABONBA_PTR_GET_DEFAULT(isDisposable_, "") };
    ...
    inline string getIsFormatValid() const { DARABONBA_PTR_GET_DEFAULT(isFormatValid_, "") };
    ...
    inline string getIsMxValid() const { DARABONBA_PTR_GET_DEFAULT(isMxValid_, "") };
    ...
    inline string getIsOkToSend() const { DARABONBA_PTR_GET_DEFAULT(isOkToSend_, "") };
  ...
  protected:
    shared_ptr<string> isDisposable_ {};
    shared_ptr<string> isFormatValid_ {};
    shared_ptr<string> isMxValid_ {};
    shared_ptr<string> isOkToSend_ {};
