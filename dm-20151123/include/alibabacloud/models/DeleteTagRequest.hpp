...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ownerId_ == nullptr
        && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->tagId_ == nullptr; };
    ...
    inline DeleteTagRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline DeleteTagRequest& setTagId(int32_t tagId) { DARABONBA_PTR_SET_VALUE(tagId_, tagId) };
