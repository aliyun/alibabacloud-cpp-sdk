...
namespace Models
{
  ...
  public:
    ...
    inline const UnblockSendingResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UnblockSendingResponseBody) };
    inline UnblockSendingResponseBody body() { DARABONBA_PTR_GET(body_, UnblockSendingResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UnblockSendingResponseBody> body_ = nullptr;
  };
