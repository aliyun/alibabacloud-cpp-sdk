...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyTagResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyTagResponseBody) };
    inline ModifyTagResponseBody body() { DARABONBA_PTR_GET(body_, ModifyTagResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyTagResponseBody> body_ = nullptr;
  };
