...
namespace Models
{
  ...
  public:
    ...
    inline const DedicatedIpChangeWarmupTypeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DedicatedIpChangeWarmupTypeResponseBody) };
    inline DedicatedIpChangeWarmupTypeResponseBody body() { DARABONBA_PTR_GET(body_, DedicatedIpChangeWarmupTypeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DedicatedIpChangeWarmupTypeResponseBody> body_ = nullptr;
  };
