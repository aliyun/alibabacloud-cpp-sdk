...
namespace Models
{
  ...
  public:
    ...
    inline const SendValidateFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendValidateFileResponseBody) };
    inline SendValidateFileResponseBody getBody() { DARABONBA_PTR_GET(body_, SendValidateFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendValidateFileResponseBody> body_ {};
  };
