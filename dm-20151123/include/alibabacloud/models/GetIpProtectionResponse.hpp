...
namespace Models
{
  ...
  public:
    ...
    inline const GetIpProtectionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetIpProtectionResponseBody) };
    inline GetIpProtectionResponseBody body() { DARABONBA_PTR_GET(body_, GetIpProtectionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetIpProtectionResponseBody> body_ = nullptr;
  };
