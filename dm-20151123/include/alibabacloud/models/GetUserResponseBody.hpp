...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetUserResponseBodyData) };
    inline GetUserResponseBodyData data() { DARABONBA_PTR_GET(data_, GetUserResponseBodyData) };
    inline GetUserResponseBody& setData(const GetUserResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetUserResponseBody& setData(GetUserResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // Returned Content
    std::shared_ptr<GetUserResponseBodyData> data_ = nullptr;
    // Request ID
