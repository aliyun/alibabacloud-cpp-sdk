...
namespace Models
{
  ...
  public:
    ...
    inline const DedicatedIpPoolCreateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DedicatedIpPoolCreateResponseBody) };
    inline DedicatedIpPoolCreateResponseBody getBody() { DARABONBA_PTR_GET(body_, DedicatedIpPoolCreateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DedicatedIpPoolCreateResponseBody> body_ {};
  };
