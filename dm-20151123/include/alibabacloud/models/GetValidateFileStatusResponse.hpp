...
namespace Models
{
  ...
  public:
    ...
    inline const GetValidateFileStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetValidateFileStatusResponseBody) };
    inline GetValidateFileStatusResponseBody body() { DARABONBA_PTR_GET(body_, GetValidateFileStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetValidateFileStatusResponseBody> body_ = nullptr;
  };
