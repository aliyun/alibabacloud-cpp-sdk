...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMailAddressByParamResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryMailAddressByParamResponseBodyData) };
    inline QueryMailAddressByParamResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryMailAddressByParamResponseBodyData) };
    inline QueryMailAddressByParamResponseBody& setData(const QueryMailAddressByParamResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryMailAddressByParamResponseBody& setData(QueryMailAddressByParamResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryMailAddressByParamResponseBodyData> data_ = nullptr;
  };
