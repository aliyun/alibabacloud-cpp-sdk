...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLoadBalancerListenerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLoadBalancerListenerResponseBody) };
    inline DeleteLoadBalancerListenerResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLoadBalancerListenerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLoadBalancerListenerResponseBody> body_ {};
  };
