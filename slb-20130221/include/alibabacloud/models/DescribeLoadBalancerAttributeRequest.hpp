...
namespace Models
{
  ...
  public:
    ...
    inline DescribeLoadBalancerAttributeRequest& setTags(string tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    ...
    inline DescribeLoadBalancerAttributeRequest& setAccessKeyId(string accessKeyId) { DARABONBA_PTR_SET_VALUE(accessKeyId_, accessKeyId) };
