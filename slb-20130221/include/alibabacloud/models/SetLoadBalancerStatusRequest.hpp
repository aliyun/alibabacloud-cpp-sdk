...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->loadBalancerId_ == nullptr
        && this->loadBalancerStatus_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr
    ...
    inline SetLoadBalancerStatusRequest& setTags(string tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    ...
    inline SetLoadBalancerStatusRequest& setAccessKeyId(string accessKeyId) { DARABONBA_PTR_SET_VALUE(accessKeyId_, accessKeyId) };
