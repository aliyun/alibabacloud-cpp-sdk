...
namespace Models
{
  ...
  public:
    ...
    inline RemoveBackendServersRequest& setBackendServers(string backendServers) { DARABONBA_PTR_SET_VALUE(backendServers_, backendServers) };
    ...
    inline RemoveBackendServersRequest& setOwnerAccount(string ownerAccount) { DARABONBA_PTR_SET_VALUE(ownerAccount_, ownerAccount) };
    ...
    inline RemoveBackendServersRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline RemoveBackendServersRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline RemoveBackendServersRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline RemoveBackendServersRequest& setTags(string tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    ...
    inline RemoveBackendServersRequest& setAccessKeyId(string accessKeyId) { DARABONBA_PTR_SET_VALUE(accessKeyId_, accessKeyId) };
