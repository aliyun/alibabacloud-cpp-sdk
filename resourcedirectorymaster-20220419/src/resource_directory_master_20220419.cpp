...
DeleteInvalidCloudAccountRecordResponse Alibabacloud_ResourceDirectoryMaster20220419::Client::deleteInvalidCloudAccountRecordWithOptions(shared_ptr<DeleteInvalidCloudAccountRecordRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
...
DeleteInvalidCloudAccountRecordResponse Alibabacloud_ResourceDirectoryMaster20220419::Client::deleteInvalidCloudAccountRecord(shared_ptr<DeleteInvalidCloudAccountRecordRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
