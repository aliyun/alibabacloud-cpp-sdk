...
public:
  ...
  explicit UpdatePayerForAccountRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit UpdatePayerForAccountResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<UpdatePayerForAccountResponseBody> body{};

  UpdatePayerForAccountResponse() {}

  explicit UpdatePayerForAccountResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        UpdatePayerForAccountResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<UpdatePayerForAccountResponseBody>(model1);
      }
    }
  }
...
public:
  ...
  UpdatePayerForAccountResponse updatePayerForAccountWithOptions(shared_ptr<UpdatePayerForAccountRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  UpdatePayerForAccountResponse updatePayerForAccount(shared_ptr<UpdatePayerForAccountRequest> request);
