...
namespace Models
{
  ...
  public:
    ...
    inline const DeclineHandshakeResponseBody::Handshake & getHandshake() const { DARABONBA_PTR_GET_CONST(handshake_, DeclineHandshakeResponseBody::Handshake) };
    inline DeclineHandshakeResponseBody::Handshake getHandshake() { DARABONBA_PTR_GET(handshake_, DeclineHandshakeResponseBody::Handshake) };
    inline DeclineHandshakeResponseBody& setHandshake(const DeclineHandshakeResponseBody::Handshake & handshake) { DARABONBA_PTR_SET_VALUE(handshake_, handshake) };
    inline DeclineHandshakeResponseBody& setHandshake(DeclineHandshakeResponseBody::Handshake && handshake) { DARABONBA_PTR_SET_RVALUE(handshake_, handshake) };
  ...
  protected:
    ...
    shared_ptr<DeclineHandshakeResponseBody::Handshake> handshake_ {};
