...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->attachmentCount_ == nullptr
        && this->createDate_ == nullptr && this->description_ == nullptr && this->effectScope_ == nullptr && this->policyDocument_ == nullptr && this->policyId_ == nullptr
        && this->policyName_ == nullptr && this->policyType_ == nullptr && this->updateDate_ == nullptr; };
      ...
      inline ControlPolicy& setPolicyDocument(string policyDocument) { DARABONBA_PTR_SET_VALUE(policyDocument_, policyDocument) };
    ...
    inline const GetControlPolicyResponseBody::ControlPolicy & getControlPolicy() const { DARABONBA_PTR_GET_CONST(controlPolicy_, GetControlPolicyResponseBody::ControlPolicy) };
    inline GetControlPolicyResponseBody::ControlPolicy getControlPolicy() { DARABONBA_PTR_GET(controlPolicy_, GetControlPolicyResponseBody::ControlPolicy) };
    inline GetControlPolicyResponseBody& setControlPolicy(const GetControlPolicyResponseBody::ControlPolicy & controlPolicy) { DARABONBA_PTR_SET_VALUE(controlPolicy_, controlPolicy) };
    inline GetControlPolicyResponseBody& setControlPolicy(GetControlPolicyResponseBody::ControlPolicy && controlPolicy) { DARABONBA_PTR_SET_RVALUE(controlPolicy_, controlPolicy) };
  ...
  protected:
    ...
    shared_ptr<GetControlPolicyResponseBody::ControlPolicy> controlPolicy_ {};
