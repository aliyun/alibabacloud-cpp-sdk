...
namespace Models
{
  ...
  public:
    ...
    inline const ListAuthorizedAccountsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAuthorizedAccountsResponseBody) };
    inline ListAuthorizedAccountsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAuthorizedAccountsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAuthorizedAccountsResponseBody> body_ {};
  };
