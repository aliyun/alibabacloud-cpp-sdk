...
namespace Models
{
  ...
  public:
    ...
    inline const ListDelegatedServicesForAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDelegatedServicesForAccountResponseBody) };
    inline ListDelegatedServicesForAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDelegatedServicesForAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDelegatedServicesForAccountResponseBody> body_ {};
  };
