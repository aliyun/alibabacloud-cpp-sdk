...
namespace Models
{
  ...
  public:
    ...
    inline const ListTagValuesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTagValuesResponseBody) };
    inline ListTagValuesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTagValuesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTagValuesResponseBody> body_ {};
  };
