...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAccountResponseBody::Account & getAccount() const { DARABONBA_PTR_GET_CONST(account_, UpdateAccountResponseBody::Account) };
    inline UpdateAccountResponseBody::Account getAccount() { DARABONBA_PTR_GET(account_, UpdateAccountResponseBody::Account) };
    inline UpdateAccountResponseBody& setAccount(const UpdateAccountResponseBody::Account & account) { DARABONBA_PTR_SET_VALUE(account_, account) };
    inline UpdateAccountResponseBody& setAccount(UpdateAccountResponseBody::Account && account) { DARABONBA_PTR_SET_RVALUE(account_, account) };
  ...
  protected:
    ...
    shared_ptr<UpdateAccountResponseBody::Account> account_ {};
