...
namespace Models
{
  ...
  public:
    ...
    inline const ListAuthorizedFoldersResponseBodyFolders & folders() const { DARABONBA_PTR_GET_CONST(folders_, ListAuthorizedFoldersResponseBodyFolders) };
    inline ListAuthorizedFoldersResponseBodyFolders folders() { DARABONBA_PTR_GET(folders_, ListAuthorizedFoldersResponseBodyFolders) };
    inline ListAuthorizedFoldersResponseBody& setFolders(const ListAuthorizedFoldersResponseBodyFolders & folders) { DARABONBA_PTR_SET_VALUE(folders_, folders) };
    inline ListAuthorizedFoldersResponseBody& setFolders(ListAuthorizedFoldersResponseBodyFolders && folders) { DARABONBA_PTR_SET_RVALUE(folders_, folders) };
  ...
  protected:
    // The folders.
    std::shared_ptr<ListAuthorizedFoldersResponseBodyFolders> folders_ = nullptr;
    // The page number.
