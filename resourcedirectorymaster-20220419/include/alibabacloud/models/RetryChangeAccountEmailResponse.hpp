...
namespace Models
{
  ...
  public:
    ...
    inline const RetryChangeAccountEmailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RetryChangeAccountEmailResponseBody) };
    inline RetryChangeAccountEmailResponseBody body() { DARABONBA_PTR_GET(body_, RetryChangeAccountEmailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RetryChangeAccountEmailResponseBody> body_ = nullptr;
  };
