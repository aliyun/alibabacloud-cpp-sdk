...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getInvitedAccountRealName() const { DARABONBA_PTR_GET_DEFAULT(invitedAccountRealName_, "") };
      inline Handshake& setInvitedAccountRealName(string invitedAccountRealName) { DARABONBA_PTR_SET_VALUE(invitedAccountRealName_, invitedAccountRealName) };
      ...
      inline string getMasterAccountRealName() const { DARABONBA_PTR_GET_DEFAULT(masterAccountRealName_, "") };
      inline Handshake& setMasterAccountRealName(string masterAccountRealName) { DARABONBA_PTR_SET_VALUE(masterAccountRealName_, masterAccountRealName) };
    ...
    protected:
      ...
      shared_ptr<string> invitedAccountRealName_ {};
      ...
      // 
      // > This parameter is available only when an invitee calls this operation.
      shared_ptr<string> masterAccountRealName_ {};
    ...
    inline const GetHandshakeResponseBody::Handshake & getHandshake() const { DARABONBA_PTR_GET_CONST(handshake_, GetHandshakeResponseBody::Handshake) };
    inline GetHandshakeResponseBody::Handshake getHandshake() { DARABONBA_PTR_GET(handshake_, GetHandshakeResponseBody::Handshake) };
    inline GetHandshakeResponseBody& setHandshake(const GetHandshakeResponseBody::Handshake & handshake) { DARABONBA_PTR_SET_VALUE(handshake_, handshake) };
    inline GetHandshakeResponseBody& setHandshake(GetHandshakeResponseBody::Handshake && handshake) { DARABONBA_PTR_SET_RVALUE(handshake_, handshake) };
  ...
  protected:
    ...
    shared_ptr<GetHandshakeResponseBody::Handshake> handshake_ {};
