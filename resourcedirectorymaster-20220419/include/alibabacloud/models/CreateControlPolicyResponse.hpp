...
namespace Models
{
  ...
  public:
    ...
    inline const CreateControlPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateControlPolicyResponseBody) };
    inline CreateControlPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateControlPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateControlPolicyResponseBody> body_ {};
  };
