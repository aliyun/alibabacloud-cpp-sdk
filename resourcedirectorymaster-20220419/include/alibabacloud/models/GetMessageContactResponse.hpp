...
namespace Models
{
  ...
  public:
    ...
    inline const GetMessageContactResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetMessageContactResponseBody) };
    inline GetMessageContactResponseBody body() { DARABONBA_PTR_GET(body_, GetMessageContactResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetMessageContactResponseBody> body_ = nullptr;
  };
