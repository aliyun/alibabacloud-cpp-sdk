...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateMessageContactResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateMessageContactResponseBody) };
    inline UpdateMessageContactResponseBody body() { DARABONBA_PTR_GET(body_, UpdateMessageContactResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateMessageContactResponseBody> body_ = nullptr;
  };
