...
namespace Models
{
  ...
  public:
    ...
    inline const AttachControlPolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AttachControlPolicyResponseBody) };
    inline AttachControlPolicyResponseBody body() { DARABONBA_PTR_GET(body_, AttachControlPolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AttachControlPolicyResponseBody> body_ = nullptr;
  };
