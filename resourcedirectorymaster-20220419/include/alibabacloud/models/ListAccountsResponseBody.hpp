...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->joinTime_ == nullptr && this->modifyTime_ == nullptr && this->resourceDirectoryId_ == nullptr && this->resourceDirectoryPath_ == nullptr && this->status_ == nullptr
    ...
    inline const ListAccountsResponseBody::Accounts & getAccounts() const { DARABONBA_PTR_GET_CONST(accounts_, ListAccountsResponseBody::Accounts) };
    inline ListAccountsResponseBody::Accounts getAccounts() { DARABONBA_PTR_GET(accounts_, ListAccountsResponseBody::Accounts) };
    inline ListAccountsResponseBody& setAccounts(const ListAccountsResponseBody::Accounts & accounts) { DARABONBA_PTR_SET_VALUE(accounts_, accounts) };
    inline ListAccountsResponseBody& setAccounts(ListAccountsResponseBody::Accounts && accounts) { DARABONBA_PTR_SET_RVALUE(accounts_, accounts) };
  ...
  protected:
    ...
    shared_ptr<ListAccountsResponseBody::Accounts> accounts_ {};
