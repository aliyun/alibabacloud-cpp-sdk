...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateControlPolicyResponseBody::ControlPolicy & getControlPolicy() const { DARABONBA_PTR_GET_CONST(controlPolicy_, UpdateControlPolicyResponseBody::ControlPolicy) };
    inline UpdateControlPolicyResponseBody::ControlPolicy getControlPolicy() { DARABONBA_PTR_GET(controlPolicy_, UpdateControlPolicyResponseBody::ControlPolicy) };
    inline UpdateControlPolicyResponseBody& setControlPolicy(const UpdateControlPolicyResponseBody::ControlPolicy & controlPolicy) { DARABONBA_PTR_SET_VALUE(controlPolicy_, controlPolicy) };
    inline UpdateControlPolicyResponseBody& setControlPolicy(UpdateControlPolicyResponseBody::ControlPolicy && controlPolicy) { DARABONBA_PTR_SET_RVALUE(controlPolicy_, controlPolicy) };
  ...
  protected:
    ...
    shared_ptr<UpdateControlPolicyResponseBody::ControlPolicy> controlPolicy_ {};
