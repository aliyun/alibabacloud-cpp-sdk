...
namespace Models
{
  ...
  public:
    ...
    inline const ListAccountsForParentResponseBodyAccounts & accounts() const { DARABONBA_PTR_GET_CONST(accounts_, ListAccountsForParentResponseBodyAccounts) };
    inline ListAccountsForParentResponseBodyAccounts accounts() { DARABONBA_PTR_GET(accounts_, ListAccountsForParentResponseBodyAccounts) };
    inline ListAccountsForParentResponseBody& setAccounts(const ListAccountsForParentResponseBodyAccounts & accounts) { DARABONBA_PTR_SET_VALUE(accounts_, accounts) };
    inline ListAccountsForParentResponseBody& setAccounts(ListAccountsForParentResponseBodyAccounts && accounts) { DARABONBA_PTR_SET_RVALUE(accounts_, accounts) };
  ...
  protected:
    ...
    std::shared_ptr<ListAccountsForParentResponseBodyAccounts> accounts_ = nullptr;
