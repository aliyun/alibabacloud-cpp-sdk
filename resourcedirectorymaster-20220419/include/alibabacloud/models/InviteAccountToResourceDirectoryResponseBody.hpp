...
namespace Models
{
  ...
  public:
    ...
    inline const InviteAccountToResourceDirectoryResponseBody::Handshake & getHandshake() const { DARABONBA_PTR_GET_CONST(handshake_, InviteAccountToResourceDirectoryResponseBody::Handshake) };
    inline InviteAccountToResourceDirectoryResponseBody::Handshake getHandshake() { DARABONBA_PTR_GET(handshake_, InviteAccountToResourceDirectoryResponseBody::Handshake) };
    inline InviteAccountToResourceDirectoryResponseBody& setHandshake(const InviteAccountToResourceDirectoryResponseBody::Handshake & handshake) { DARABONBA_PTR_SET_VALUE(handshake_, handshake) };
    inline InviteAccountToResourceDirectoryResponseBody& setHandshake(InviteAccountToResourceDirectoryResponseBody::Handshake && handshake) { DARABONBA_PTR_SET_RVALUE(handshake_, handshake) };
  ...
  protected:
    ...
    shared_ptr<InviteAccountToResourceDirectoryResponseBody::Handshake> handshake_ {};
