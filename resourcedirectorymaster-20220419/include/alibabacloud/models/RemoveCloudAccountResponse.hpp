...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveCloudAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveCloudAccountResponseBody) };
    inline RemoveCloudAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveCloudAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveCloudAccountResponseBody> body_ {};
  };
