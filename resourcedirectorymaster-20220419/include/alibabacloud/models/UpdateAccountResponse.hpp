...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAccountResponseBody) };
    inline UpdateAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAccountResponseBody> body_ {};
  };
