...
namespace Models
{
  ...
  public:
    ...
    inline const GetMessageContactDeletionStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMessageContactDeletionStatusResponseBody) };
    inline GetMessageContactDeletionStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMessageContactDeletionStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMessageContactDeletionStatusResponseBody> body_ {};
  };
