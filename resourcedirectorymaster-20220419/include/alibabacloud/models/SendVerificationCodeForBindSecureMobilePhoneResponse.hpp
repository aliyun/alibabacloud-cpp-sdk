...
namespace Models
{
  ...
  public:
    ...
    inline const SendVerificationCodeForBindSecureMobilePhoneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendVerificationCodeForBindSecureMobilePhoneResponseBody) };
    inline SendVerificationCodeForBindSecureMobilePhoneResponseBody getBody() { DARABONBA_PTR_GET(body_, SendVerificationCodeForBindSecureMobilePhoneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendVerificationCodeForBindSecureMobilePhoneResponseBody> body_ {};
  };
