...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFolderResponseBody::Folder & getFolder() const { DARABONBA_PTR_GET_CONST(folder_, CreateFolderResponseBody::Folder) };
    inline CreateFolderResponseBody::Folder getFolder() { DARABONBA_PTR_GET(folder_, CreateFolderResponseBody::Folder) };
    inline CreateFolderResponseBody& setFolder(const CreateFolderResponseBody::Folder & folder) { DARABONBA_PTR_SET_VALUE(folder_, folder) };
    inline CreateFolderResponseBody& setFolder(CreateFolderResponseBody::Folder && folder) { DARABONBA_PTR_SET_RVALUE(folder_, folder) };
  ...
  protected:
    ...
    shared_ptr<CreateFolderResponseBody::Folder> folder_ {};
