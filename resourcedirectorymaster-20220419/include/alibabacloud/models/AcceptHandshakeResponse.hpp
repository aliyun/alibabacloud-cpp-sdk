...
namespace Models
{
  ...
  public:
    ...
    inline const AcceptHandshakeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AcceptHandshakeResponseBody) };
    inline AcceptHandshakeResponseBody getBody() { DARABONBA_PTR_GET(body_, AcceptHandshakeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AcceptHandshakeResponseBody> body_ {};
  };
