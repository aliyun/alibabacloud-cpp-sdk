...
namespace Models
{
  ...
  public:
    ...
    inline const ListAuthorizedAccountsResponseBodyAccounts & accounts() const { DARABONBA_PTR_GET_CONST(accounts_, ListAuthorizedAccountsResponseBodyAccounts) };
    inline ListAuthorizedAccountsResponseBodyAccounts accounts() { DARABONBA_PTR_GET(accounts_, ListAuthorizedAccountsResponseBodyAccounts) };
    inline ListAuthorizedAccountsResponseBody& setAccounts(const ListAuthorizedAccountsResponseBodyAccounts & accounts) { DARABONBA_PTR_SET_VALUE(accounts_, accounts) };
    inline ListAuthorizedAccountsResponseBody& setAccounts(ListAuthorizedAccountsResponseBodyAccounts && accounts) { DARABONBA_PTR_SET_RVALUE(accounts_, accounts) };
  ...
  protected:
    ...
    std::shared_ptr<ListAuthorizedAccountsResponseBodyAccounts> accounts_ = nullptr;
    // The page number.
