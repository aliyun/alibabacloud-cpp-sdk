...
namespace Models
{
  ...
  public:
    ...
    inline const SendVerificationCodeForEnableRDResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendVerificationCodeForEnableRDResponseBody) };
    inline SendVerificationCodeForEnableRDResponseBody getBody() { DARABONBA_PTR_GET(body_, SendVerificationCodeForEnableRDResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendVerificationCodeForEnableRDResponseBody> body_ {};
  };
