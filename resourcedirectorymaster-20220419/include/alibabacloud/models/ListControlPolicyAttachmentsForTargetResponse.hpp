...
namespace Models
{
  ...
  public:
    ...
    inline const ListControlPolicyAttachmentsForTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListControlPolicyAttachmentsForTargetResponseBody) };
    inline ListControlPolicyAttachmentsForTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, ListControlPolicyAttachmentsForTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListControlPolicyAttachmentsForTargetResponseBody> body_ {};
  };
