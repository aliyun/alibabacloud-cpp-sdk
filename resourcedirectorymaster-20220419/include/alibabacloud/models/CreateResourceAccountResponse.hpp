...
namespace Models
{
  ...
  public:
    ...
    inline const CreateResourceAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateResourceAccountResponseBody) };
    inline CreateResourceAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateResourceAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateResourceAccountResponseBody> body_ {};
  };
