...
namespace Models
{
  ...
  public:
    ...
    inline const DestroyResourceDirectoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DestroyResourceDirectoryResponseBody) };
    inline DestroyResourceDirectoryResponseBody getBody() { DARABONBA_PTR_GET(body_, DestroyResourceDirectoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DestroyResourceDirectoryResponseBody> body_ {};
  };
