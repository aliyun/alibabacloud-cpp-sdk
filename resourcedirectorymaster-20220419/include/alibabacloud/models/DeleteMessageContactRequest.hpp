...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->contactId_ == nullptr
        && this->retainContactInMembers_ == nullptr; };
    ...
    inline bool getRetainContactInMembers() const { DARABONBA_PTR_GET_DEFAULT(retainContactInMembers_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> retainContactInMembers_ {};
  };
