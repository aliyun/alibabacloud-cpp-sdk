...
namespace Models
{
  ...
  public:
    ...
    inline const ListHandshakesForAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListHandshakesForAccountResponseBody) };
    inline ListHandshakesForAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, ListHandshakesForAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListHandshakesForAccountResponseBody> body_ {};
  };
