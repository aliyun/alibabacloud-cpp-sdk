...
namespace Models
{
  ...
  public:
    ...
    inline const SendPhoneVerificationForMessageContactResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendPhoneVerificationForMessageContactResponseBody) };
    inline SendPhoneVerificationForMessageContactResponseBody getBody() { DARABONBA_PTR_GET(body_, SendPhoneVerificationForMessageContactResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendPhoneVerificationForMessageContactResponseBody> body_ {};
  };
