...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->effectScope_ == nullptr && this->policyDocument_ == nullptr && this->policyName_ == nullptr && this->tag_ == nullptr; };
    ...
    inline const vector<CreateControlPolicyRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateControlPolicyRequest::Tag>) };
    inline vector<CreateControlPolicyRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateControlPolicyRequest::Tag>) };
    inline CreateControlPolicyRequest& setTag(const vector<CreateControlPolicyRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateControlPolicyRequest& setTag(vector<CreateControlPolicyRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<vector<CreateControlPolicyRequest::Tag>> tag_ {};
  };
