...
namespace Models
{
  ...
  public:
    ...
    inline const GetFolderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetFolderResponseBody) };
    inline GetFolderResponseBody getBody() { DARABONBA_PTR_GET(body_, GetFolderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetFolderResponseBody> body_ {};
  };
