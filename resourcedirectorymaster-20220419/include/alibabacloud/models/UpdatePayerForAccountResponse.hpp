...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePayerForAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePayerForAccountResponseBody) };
    inline UpdatePayerForAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePayerForAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePayerForAccountResponseBody> body_ {};
  };
