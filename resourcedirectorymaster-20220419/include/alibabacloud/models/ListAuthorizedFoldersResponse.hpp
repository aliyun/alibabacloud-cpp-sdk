...
namespace Models
{
  ...
  public:
    ...
    inline const ListAuthorizedFoldersResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAuthorizedFoldersResponseBody) };
    inline ListAuthorizedFoldersResponseBody body() { DARABONBA_PTR_GET(body_, ListAuthorizedFoldersResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAuthorizedFoldersResponseBody> body_ = nullptr;
  };
