...
namespace Models
{
  ...
  public:
    ...
    inline const ListControlPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListControlPoliciesResponseBody) };
    inline ListControlPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListControlPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListControlPoliciesResponseBody> body_ {};
  };
