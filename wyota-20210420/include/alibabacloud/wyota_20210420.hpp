...
public:
  ...
  explicit UnbindPasswordFreeLoginUserRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit UnbindPasswordFreeLoginUserResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<UnbindPasswordFreeLoginUserResponseBody> body{};

  UnbindPasswordFreeLoginUserResponse() {}

  explicit UnbindPasswordFreeLoginUserResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        UnbindPasswordFreeLoginUserResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<UnbindPasswordFreeLoginUserResponseBody>(model1);
      }
    }
  }
...
public:
  ...
  UnbindPasswordFreeLoginUserResponse unbindPasswordFreeLoginUserWithOptions(shared_ptr<UnbindPasswordFreeLoginUserRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  UnbindPasswordFreeLoginUserResponse unbindPasswordFreeLoginUser(shared_ptr<UnbindPasswordFreeLoginUserRequest> request);
