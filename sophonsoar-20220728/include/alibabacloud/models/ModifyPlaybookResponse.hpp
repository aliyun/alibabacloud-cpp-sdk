...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyPlaybookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyPlaybookResponseBody) };
    inline ModifyPlaybookResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyPlaybookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyPlaybookResponseBody> body_ {};
  };
