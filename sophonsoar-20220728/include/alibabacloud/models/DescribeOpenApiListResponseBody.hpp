...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOpenApiListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeOpenApiListResponseBodyData) };
    inline DescribeOpenApiListResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeOpenApiListResponseBodyData) };
    inline DescribeOpenApiListResponseBody& setData(const DescribeOpenApiListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeOpenApiListResponseBody& setData(DescribeOpenApiListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeOpenApiListResponseBodyData> data_ = nullptr;
    // The request ID.
