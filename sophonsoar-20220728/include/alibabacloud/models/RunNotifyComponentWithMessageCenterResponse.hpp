...
namespace Models
{
  ...
  public:
    ...
    inline const RunNotifyComponentWithMessageCenterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunNotifyComponentWithMessageCenterResponseBody) };
    inline RunNotifyComponentWithMessageCenterResponseBody getBody() { DARABONBA_PTR_GET(body_, RunNotifyComponentWithMessageCenterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunNotifyComponentWithMessageCenterResponseBody> body_ {};
  };
