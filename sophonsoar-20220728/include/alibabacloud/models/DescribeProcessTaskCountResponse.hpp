...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeProcessTaskCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeProcessTaskCountResponseBody) };
    inline DescribeProcessTaskCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeProcessTaskCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeProcessTaskCountResponseBody> body_ {};
  };
