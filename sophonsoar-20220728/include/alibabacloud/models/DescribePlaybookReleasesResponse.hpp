...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePlaybookReleasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePlaybookReleasesResponseBody) };
    inline DescribePlaybookReleasesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePlaybookReleasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePlaybookReleasesResponseBody> body_ {};
  };
