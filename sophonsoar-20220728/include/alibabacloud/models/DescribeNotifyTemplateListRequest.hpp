...
#ifndef ALIBABACLOUD_MODELS_DESCRIBENOTIFYTEMPLATELISTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBENOTIFYTEMPLATELISTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeNotifyTemplateListRequest& obj) { 
      DARABONBA_PTR_TO_JSON(Lang, lang_);
      DARABONBA_PTR_TO_JSON(RoleFor, roleFor_);
      DARABONBA_PTR_TO_JSON(RoleType, roleType_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeNotifyTemplateListRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(Lang, lang_);
      DARABONBA_PTR_FROM_JSON(RoleFor, roleFor_);
      DARABONBA_PTR_FROM_JSON(RoleType, roleType_);
    };
    DescribeNotifyTemplateListRequest() = default ;
    DescribeNotifyTemplateListRequest(const DescribeNotifyTemplateListRequest &) = default ;
    DescribeNotifyTemplateListRequest(DescribeNotifyTemplateListRequest &&) = default ;
    DescribeNotifyTemplateListRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeNotifyTemplateListRequest() = default ;
    DescribeNotifyTemplateListRequest& operator=(const DescribeNotifyTemplateListRequest &) = default ;
    DescribeNotifyTemplateListRequest& operator=(DescribeNotifyTemplateListRequest &&) = default ;
