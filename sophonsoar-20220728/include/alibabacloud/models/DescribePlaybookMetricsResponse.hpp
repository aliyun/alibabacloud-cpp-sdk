...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePlaybookMetricsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePlaybookMetricsResponseBody) };
    inline DescribePlaybookMetricsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePlaybookMetricsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePlaybookMetricsResponseBody> body_ {};
  };
