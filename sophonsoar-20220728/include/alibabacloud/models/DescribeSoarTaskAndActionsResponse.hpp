...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSoarTaskAndActionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSoarTaskAndActionsResponseBody) };
    inline DescribeSoarTaskAndActionsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSoarTaskAndActionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSoarTaskAndActionsResponseBody> body_ {};
  };
