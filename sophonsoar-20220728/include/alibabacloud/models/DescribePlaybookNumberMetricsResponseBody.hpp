...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePlaybookNumberMetricsResponseBodyMetrics & metrics() const { DARABONBA_PTR_GET_CONST(metrics_, DescribePlaybookNumberMetricsResponseBodyMetrics) };
    inline DescribePlaybookNumberMetricsResponseBodyMetrics metrics() { DARABONBA_PTR_GET(metrics_, DescribePlaybookNumberMetricsResponseBodyMetrics) };
    inline DescribePlaybookNumberMetricsResponseBody& setMetrics(const DescribePlaybookNumberMetricsResponseBodyMetrics & metrics) { DARABONBA_PTR_SET_VALUE(metrics_, metrics) };
    inline DescribePlaybookNumberMetricsResponseBody& setMetrics(DescribePlaybookNumberMetricsResponseBodyMetrics && metrics) { DARABONBA_PTR_SET_RVALUE(metrics_, metrics) };
  ...
  protected:
    // The statistics.
    std::shared_ptr<DescribePlaybookNumberMetricsResponseBodyMetrics> metrics_ = nullptr;
    // The request ID.
