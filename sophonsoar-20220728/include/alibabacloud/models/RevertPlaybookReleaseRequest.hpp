...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->isPublish_ == nullptr
        && this->playReleaseId_ == nullptr && this->playbookUuid_ == nullptr; };
    ...
    inline bool getIsPublish() const { DARABONBA_PTR_GET_DEFAULT(isPublish_, false) };
    ...
    inline int32_t getPlayReleaseId() const { DARABONBA_PTR_GET_DEFAULT(playReleaseId_, 0) };
