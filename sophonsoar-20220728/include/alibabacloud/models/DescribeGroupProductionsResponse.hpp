...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGroupProductionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeGroupProductionsResponseBody) };
    inline DescribeGroupProductionsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeGroupProductionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeGroupProductionsResponseBody> body_ {};
  };
