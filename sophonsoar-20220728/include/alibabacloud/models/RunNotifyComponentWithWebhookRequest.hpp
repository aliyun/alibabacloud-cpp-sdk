...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actionName_ == nullptr
        && this->assetId_ == nullptr && this->componentName_ == nullptr && this->content_ == nullptr && this->lang_ == nullptr && this->msgType_ == nullptr
        && this->nodeName_ == nullptr && this->playbookUuid_ == nullptr && this->roleFor_ == nullptr && this->roleType_ == nullptr && this->secret_ == nullptr
