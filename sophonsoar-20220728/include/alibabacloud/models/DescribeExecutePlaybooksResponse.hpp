...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExecutePlaybooksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExecutePlaybooksResponseBody) };
    inline DescribeExecutePlaybooksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExecutePlaybooksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExecutePlaybooksResponseBody> body_ {};
  };
