...
namespace Models
{
  ...
  public:
    ...
    inline const RunPython3ScriptResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunPython3ScriptResponseBody) };
    inline RunPython3ScriptResponseBody getBody() { DARABONBA_PTR_GET(body_, RunPython3ScriptResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunPython3ScriptResponseBody> body_ {};
  };
