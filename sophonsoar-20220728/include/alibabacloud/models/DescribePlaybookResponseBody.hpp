...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePlaybookResponseBodyPlaybook & playbook() const { DARABONBA_PTR_GET_CONST(playbook_, DescribePlaybookResponseBodyPlaybook) };
    inline DescribePlaybookResponseBodyPlaybook playbook() { DARABONBA_PTR_GET(playbook_, DescribePlaybookResponseBodyPlaybook) };
    inline DescribePlaybookResponseBody& setPlaybook(const DescribePlaybookResponseBodyPlaybook & playbook) { DARABONBA_PTR_SET_VALUE(playbook_, playbook) };
    inline DescribePlaybookResponseBody& setPlaybook(DescribePlaybookResponseBodyPlaybook && playbook) { DARABONBA_PTR_SET_RVALUE(playbook_, playbook) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePlaybookResponseBodyPlaybook> playbook_ = nullptr;
    // The request ID.
