...
namespace Models
{
  ...
  public:
    ...
    inline const TriggerSophonPlaybookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TriggerSophonPlaybookResponseBody) };
    inline TriggerSophonPlaybookResponseBody getBody() { DARABONBA_PTR_GET(body_, TriggerSophonPlaybookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TriggerSophonPlaybookResponseBody> body_ {};
  };
