...
namespace Models
{
  ...
  public:
    ...
    inline const VerifyPythonFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, VerifyPythonFileResponseBody) };
    inline VerifyPythonFileResponseBody getBody() { DARABONBA_PTR_GET(body_, VerifyPythonFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<VerifyPythonFileResponseBody> body_ {};
  };
