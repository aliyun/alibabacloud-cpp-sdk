...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePlaybookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePlaybookResponseBody) };
    inline CreatePlaybookResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePlaybookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePlaybookResponseBody> body_ {};
  };
