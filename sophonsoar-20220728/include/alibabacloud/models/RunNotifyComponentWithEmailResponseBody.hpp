...
namespace Models
{
  ...
  public:
    ...
    inline const RunNotifyComponentWithEmailResponseBody::Page & getPage() const { DARABONBA_PTR_GET_CONST(page_, RunNotifyComponentWithEmailResponseBody::Page) };
    inline RunNotifyComponentWithEmailResponseBody::Page getPage() { DARABONBA_PTR_GET(page_, RunNotifyComponentWithEmailResponseBody::Page) };
    inline RunNotifyComponentWithEmailResponseBody& setPage(const RunNotifyComponentWithEmailResponseBody::Page & page) { DARABONBA_PTR_SET_VALUE(page_, page) };
    inline RunNotifyComponentWithEmailResponseBody& setPage(RunNotifyComponentWithEmailResponseBody::Page && page) { DARABONBA_PTR_SET_RVALUE(page_, page) };
