...
namespace Models
{
  ...
  public:
    ...
    inline const CopyPlaybookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CopyPlaybookResponseBody) };
    inline CopyPlaybookResponseBody getBody() { DARABONBA_PTR_GET(body_, CopyPlaybookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CopyPlaybookResponseBody> body_ {};
  };
