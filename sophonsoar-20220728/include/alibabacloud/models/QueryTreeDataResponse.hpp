...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTreeDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryTreeDataResponseBody) };
    inline QueryTreeDataResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryTreeDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryTreeDataResponseBody> body_ {};
  };
