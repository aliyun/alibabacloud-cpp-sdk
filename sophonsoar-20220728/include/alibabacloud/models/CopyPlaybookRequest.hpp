...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->displayName_ == nullptr && this->lang_ == nullptr && this->releaseVersion_ == nullptr && this->roleFor_ == nullptr && this->roleType_ == nullptr
        && this->sourcePlaybookUuid_ == nullptr; };
    ...
    inline string getSourcePlaybookUuid() const { DARABONBA_PTR_GET_DEFAULT(sourcePlaybookUuid_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> sourcePlaybookUuid_ {};
  };
