...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOpenApiInfoResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeOpenApiInfoResponseBodyData) };
    inline DescribeOpenApiInfoResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeOpenApiInfoResponseBodyData) };
    inline DescribeOpenApiInfoResponseBody& setData(const DescribeOpenApiInfoResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeOpenApiInfoResponseBody& setData(DescribeOpenApiInfoResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeOpenApiInfoResponseBodyData> data_ = nullptr;
    // The request ID.
