...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSoarRecordsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSoarRecordsResponseBody) };
    inline DescribeSoarRecordsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSoarRecordsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSoarRecordsResponseBody> body_ {};
  };
