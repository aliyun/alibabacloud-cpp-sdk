...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSophonCommandsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeSophonCommandsResponseBodyData>) };
    inline vector<DescribeSophonCommandsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeSophonCommandsResponseBodyData>) };
    inline DescribeSophonCommandsResponseBody& setData(const vector<DescribeSophonCommandsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSophonCommandsResponseBody& setData(vector<DescribeSophonCommandsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The commands.
    std::shared_ptr<vector<DescribeSophonCommandsResponseBodyData>> data_ = nullptr;
    // The request ID.
