...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeProcessStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeProcessStatisticsResponseBody) };
    inline DescribeProcessStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeProcessStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeProcessStatisticsResponseBody> body_ {};
  };
