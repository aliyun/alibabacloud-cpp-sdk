...
namespace Models
{
  ...
  public:
    ...
    inline const TriggerPlaybookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TriggerPlaybookResponseBody) };
    inline TriggerPlaybookResponseBody getBody() { DARABONBA_PTR_GET(body_, TriggerPlaybookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TriggerPlaybookResponseBody> body_ {};
  };
