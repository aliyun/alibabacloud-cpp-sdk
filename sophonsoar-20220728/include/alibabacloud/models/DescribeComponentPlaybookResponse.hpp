...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeComponentPlaybookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeComponentPlaybookResponseBody) };
    inline DescribeComponentPlaybookResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeComponentPlaybookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeComponentPlaybookResponseBody> body_ {};
  };
