...
class DescribeApiListRequest : public Darabonba::Model {
public:
  shared_ptr<string> lang{};

  DescribeApiListRequest() {}

  explicit DescribeApiListRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribeApiListRequest() = default;
};
class DescribeApiListResponseBodyApiList : public Darabonba::Model {
public:
  shared_ptr<string> docUrl{};
  shared_ptr<string> popCode{};
  shared_ptr<string> productName{};

  DescribeApiListResponseBodyApiList() {}

  explicit DescribeApiListResponseBodyApiList(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribeApiListResponseBodyApiList() = default;
};
class DescribeApiListResponseBody : public Darabonba::Model {
public:
  shared_ptr<vector<DescribeApiListResponseBodyApiList>> apiList{};
  shared_ptr<string> requestId{};

  DescribeApiListResponseBody() {}

  explicit DescribeApiListResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("ApiList") != m.end() && !m["ApiList"].empty()) {
      if (typeid(vector<boost::any>) == m["ApiList"].type()) {
        vector<DescribeApiListResponseBodyApiList> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["ApiList"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            DescribeApiListResponseBodyApiList model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        apiList = make_shared<vector<DescribeApiListResponseBodyApiList>>(expect1);
      }
    }
    if (m.find("RequestId") != m.end() && !m["RequestId"].empty()) {
      requestId = make_shared<string>(boost::any_cast<string>(m["RequestId"]));
  ...
  virtual ~DescribeApiListResponseBody() = default;
};
class DescribeApiListResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<DescribeApiListResponseBody> body{};

  DescribeApiListResponse() {}

  explicit DescribeApiListResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        DescribeApiListResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<DescribeApiListResponseBody>(model1);
      }
    }
  }


  virtual ~DescribeApiListResponse() = default;
};
...
class DescribePopApiVersionListRequest : public Darabonba::Model {
public:
  shared_ptr<string> env{};
  shared_ptr<string> lang{};
  shared_ptr<string> popCode{};
  ...
  explicit DescribePopApiVersionListRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribePopApiVersionListRequest() = default;
};
class DescribePopApiVersionListResponseBodyVersionList : public Darabonba::Model {
public:
  shared_ptr<string> apiName{};
  shared_ptr<string> popCode{};
  shared_ptr<string> version{};

  DescribePopApiVersionListResponseBodyVersionList() {}

  explicit DescribePopApiVersionListResponseBodyVersionList(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~DescribePopApiVersionListResponseBodyVersionList() = default;
};
class DescribePopApiVersionListResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> popCode{};
  shared_ptr<string> requestId{};
  shared_ptr<long> total{};
  shared_ptr<vector<DescribePopApiVersionListResponseBodyVersionList>> versionList{};

  DescribePopApiVersionListResponseBody() {}

  explicit DescribePopApiVersionListResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (versionList) {
      vector<boost::any> temp1;
      for(auto item1:*versionList){
        temp1.push_back(boost::any(item1.toMap()));
      }
      res["VersionList"] = boost::any(temp1);
    }
    return res;
  }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("VersionList") != m.end() && !m["VersionList"].empty()) {
      if (typeid(vector<boost::any>) == m["VersionList"].type()) {
        vector<DescribePopApiVersionListResponseBodyVersionList> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["VersionList"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            DescribePopApiVersionListResponseBodyVersionList model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        versionList = make_shared<vector<DescribePopApiVersionListResponseBodyVersionList>>(expect1);
      }
    }
  }


  virtual ~DescribePopApiVersionListResponseBody() = default;
};
class DescribePopApiVersionListResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<DescribePopApiVersionListResponseBody> body{};

  DescribePopApiVersionListResponse() {}

  explicit DescribePopApiVersionListResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        DescribePopApiVersionListResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<DescribePopApiVersionListResponseBody>(model1);
      }
    }
  }
...
public:
  ...
  DescribeApiListResponse describeApiListWithOptions(shared_ptr<DescribeApiListRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  DescribeApiListResponse describeApiList(shared_ptr<DescribeApiListRequest> request);
