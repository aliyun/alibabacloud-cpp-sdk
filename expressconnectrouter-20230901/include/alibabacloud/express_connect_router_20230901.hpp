...
class GetExpressConnectRouterRequest : public Darabonba::Model {
public:
  shared_ptr<string> clientToken{};
  shared_ptr<bool> dryRun{};
  shared_ptr<string> ecrId{};

  GetExpressConnectRouterRequest() {}

  explicit GetExpressConnectRouterRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~GetExpressConnectRouterRequest() = default;
};
class GetExpressConnectRouterResponseBodyTags : public Darabonba::Model {
public:
  shared_ptr<long> aliUid{};
  shared_ptr<long> category{};
  shared_ptr<long> id{};
  ...
  GetExpressConnectRouterResponseBodyTags() {}

  explicit GetExpressConnectRouterResponseBodyTags(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~GetExpressConnectRouterResponseBodyTags() = default;
};
class GetExpressConnectRouterResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> accessDeniedDetail{};
  shared_ptr<long> alibabaSideAsn{};
  shared_ptr<string> bizStatus{};
  ...
  shared_ptr<string> status{};
  shared_ptr<bool> success{};
  shared_ptr<vector<GetExpressConnectRouterResponseBodyTags>> tags{};

  GetExpressConnectRouterResponseBody() {}

  explicit GetExpressConnectRouterResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("Tags") != m.end() && !m["Tags"].empty()) {
      if (typeid(vector<boost::any>) == m["Tags"].type()) {
        vector<GetExpressConnectRouterResponseBodyTags> expect1;
        for(auto item1:boost::any_cast<vector<boost::any>>(m["Tags"])){
          if (typeid(map<string, boost::any>) == item1.type()) {
            GetExpressConnectRouterResponseBodyTags model2;
            model2.fromMap(boost::any_cast<map<string, boost::any>>(item1));
            expect1.push_back(model2);
          }
        }
        tags = make_shared<vector<GetExpressConnectRouterResponseBodyTags>>(expect1);
      }
    }
  }


  virtual ~GetExpressConnectRouterResponseBody() = default;
};
class GetExpressConnectRouterResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<GetExpressConnectRouterResponseBody> body{};

  GetExpressConnectRouterResponse() {}

  explicit GetExpressConnectRouterResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        GetExpressConnectRouterResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<GetExpressConnectRouterResponseBody>(model1);
      }
    }
  }


  virtual ~GetExpressConnectRouterResponse() = default;
};
...
public:
  ...
  GetExpressConnectRouterResponse getExpressConnectRouterWithOptions(shared_ptr<GetExpressConnectRouterRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  GetExpressConnectRouterResponse getExpressConnectRouter(shared_ptr<GetExpressConnectRouterRequest> request);
