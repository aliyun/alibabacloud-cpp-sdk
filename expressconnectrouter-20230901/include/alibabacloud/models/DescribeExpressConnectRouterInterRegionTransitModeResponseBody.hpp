...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEEXPRESSCONNECTROUTERINTERREGIONTRANSITMODERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeExpressConnectRouterInterRegionTransitModeResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(DynamicCode, dynamicCode_);
      DARABONBA_PTR_TO_JSON(DynamicMessage, dynamicMessage_);
      DARABONBA_PTR_TO_JSON(HttpStatusCode, httpStatusCode_);
      DARABONBA_PTR_TO_JSON(InterRegionTransitModeList, interRegionTransitModeList_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeExpressConnectRouterInterRegionTransitModeResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AccessDeniedDetail, accessDeniedDetail_);
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(DynamicCode, dynamicCode_);
      DARABONBA_PTR_FROM_JSON(DynamicMessage, dynamicMessage_);
      DARABONBA_PTR_FROM_JSON(HttpStatusCode, httpStatusCode_);
      DARABONBA_PTR_FROM_JSON(InterRegionTransitModeList, interRegionTransitModeList_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    DescribeExpressConnectRouterInterRegionTransitModeResponseBody() = default ;
    DescribeExpressConnectRouterInterRegionTransitModeResponseBody(const DescribeExpressConnectRouterInterRegionTransitModeResponseBody &) = default ;
    DescribeExpressConnectRouterInterRegionTransitModeResponseBody(DescribeExpressConnectRouterInterRegionTransitModeResponseBody &&) = default ;
    DescribeExpressConnectRouterInterRegionTransitModeResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeExpressConnectRouterInterRegionTransitModeResponseBody() = default ;
    DescribeExpressConnectRouterInterRegionTransitModeResponseBody& operator=(const DescribeExpressConnectRouterInterRegionTransitModeResponseBody &) = default ;
    DescribeExpressConnectRouterInterRegionTransitModeResponseBody& operator=(DescribeExpressConnectRouterInterRegionTransitModeResponseBody &&) = default ;
