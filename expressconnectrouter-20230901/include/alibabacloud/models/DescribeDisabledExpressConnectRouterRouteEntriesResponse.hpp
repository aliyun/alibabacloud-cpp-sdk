...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDisabledExpressConnectRouterRouteEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDisabledExpressConnectRouterRouteEntriesResponseBody) };
    inline DescribeDisabledExpressConnectRouterRouteEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDisabledExpressConnectRouterRouteEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDisabledExpressConnectRouterRouteEntriesResponseBody> body_ {};
  };
