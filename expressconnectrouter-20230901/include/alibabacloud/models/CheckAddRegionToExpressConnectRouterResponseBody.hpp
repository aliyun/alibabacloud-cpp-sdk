...
namespace Models
{
  ...
  public:
    ...
    inline bool getAnyCrossBorderLink() const { DARABONBA_PTR_GET_DEFAULT(anyCrossBorderLink_, false) };
    ...
    inline bool getAnyInterRegionLink() const { DARABONBA_PTR_GET_DEFAULT(anyInterRegionLink_, false) };
    ...
    inline bool getIsCdtCrossBorderEnabled() const { DARABONBA_PTR_GET_DEFAULT(isCdtCrossBorderEnabled_, false) };
    ...
    inline bool getIsCdtInterRegionEnabled() const { DARABONBA_PTR_GET_DEFAULT(isCdtInterRegionEnabled_, false) };
    ...
    inline bool getIsUserAllowedToCreateCrossBorderLink() const { DARABONBA_PTR_GET_DEFAULT(isUserAllowedToCreateCrossBorderLink_, false) };
