...
namespace Models
{
  ...
  public:
    ...
    inline const RevokeInstanceFromExpressConnectRouterResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RevokeInstanceFromExpressConnectRouterResponseBody) };
    inline RevokeInstanceFromExpressConnectRouterResponseBody getBody() { DARABONBA_PTR_GET(body_, RevokeInstanceFromExpressConnectRouterResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RevokeInstanceFromExpressConnectRouterResponseBody> body_ {};
  };
