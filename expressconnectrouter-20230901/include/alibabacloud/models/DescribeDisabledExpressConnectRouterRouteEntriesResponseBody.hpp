...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessDeniedDetail_ == nullptr
        && return this->code_ == nullptr && return this->disabledRouteEntryList_ == nullptr && return this->dynamicCode_ == nullptr && return this->dynamicMessage_ == nullptr && return this->httpStatusCode_ == nullptr
    ...
    inline const vector<DescribeDisabledExpressConnectRouterRouteEntriesResponseBodyDisabledRouteEntryList> & disabledRouteEntryList() const { DARABONBA_PTR_GET_CONST(disabledRouteEntryList_, vector<DescribeDisabledExpressConnectRouterRouteEntriesResponseBodyDisabledRouteEntryList>) };
    inline vector<DescribeDisabledExpressConnectRouterRouteEntriesResponseBodyDisabledRouteEntryList> disabledRouteEntryList() { DARABONBA_PTR_GET(disabledRouteEntryList_, vector<DescribeDisabledExpressConnectRouterRouteEntriesResponseBodyDisabledRouteEntryList>) };
    inline DescribeDisabledExpressConnectRouterRouteEntriesResponseBody& setDisabledRouteEntryList(const vector<DescribeDisabledExpressConnectRouterRouteEntriesResponseBodyDisabledRouteEntryList> & disabledRouteEntryList) { DARABONBA_PTR_SET_VALUE(disabledRouteEntryList_, disabledRouteEntryList) };
    inline DescribeDisabledExpressConnectRouterRouteEntriesResponseBody& setDisabledRouteEntryList(vector<DescribeDisabledExpressConnectRouterRouteEntriesResponseBodyDisabledRouteEntryList> && disabledRouteEntryList) { DARABONBA_PTR_SET_RVALUE(disabledRouteEntryList_, disabledRouteEntryList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDisabledExpressConnectRouterRouteEntriesResponseBodyDisabledRouteEntryList>> disabledRouteEntryList_ = nullptr;
