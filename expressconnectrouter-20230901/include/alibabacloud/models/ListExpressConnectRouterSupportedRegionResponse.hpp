...
namespace Models
{
  ...
  public:
    ...
    inline const ListExpressConnectRouterSupportedRegionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExpressConnectRouterSupportedRegionResponseBody) };
    inline ListExpressConnectRouterSupportedRegionResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExpressConnectRouterSupportedRegionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExpressConnectRouterSupportedRegionResponseBody> body_ {};
  };
