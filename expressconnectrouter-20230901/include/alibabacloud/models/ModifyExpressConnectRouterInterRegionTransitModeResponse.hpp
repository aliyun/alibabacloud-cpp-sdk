...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyExpressConnectRouterInterRegionTransitModeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyExpressConnectRouterInterRegionTransitModeResponseBody) };
    inline ModifyExpressConnectRouterInterRegionTransitModeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyExpressConnectRouterInterRegionTransitModeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyExpressConnectRouterInterRegionTransitModeResponseBody> body_ {};
  };
