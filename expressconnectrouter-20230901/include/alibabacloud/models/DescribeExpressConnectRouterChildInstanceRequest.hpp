...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->associationId_ == nullptr
        && return this->childInstanceId_ == nullptr && return this->childInstanceRegionId_ == nullptr && return this->childInstanceType_ == nullptr && return this->clientToken_ == nullptr && return this->dryRun_ == nullptr
        && return this->ecrId_ == nullptr && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->version_ == nullptr; };
