...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteExpressConnectRouterAssociationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteExpressConnectRouterAssociationResponseBody) };
    inline DeleteExpressConnectRouterAssociationResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteExpressConnectRouterAssociationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteExpressConnectRouterAssociationResponseBody> body_ {};
  };
