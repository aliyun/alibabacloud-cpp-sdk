...
namespace Models
{
  ...
  public:
    ...
    inline const DeactivateFlowLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeactivateFlowLogResponseBody) };
    inline DeactivateFlowLogResponseBody getBody() { DARABONBA_PTR_GET(body_, DeactivateFlowLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeactivateFlowLogResponseBody> body_ {};
  };
