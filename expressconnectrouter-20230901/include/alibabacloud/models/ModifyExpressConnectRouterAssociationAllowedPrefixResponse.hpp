...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody) };
    inline ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody> body_ {};
  };
