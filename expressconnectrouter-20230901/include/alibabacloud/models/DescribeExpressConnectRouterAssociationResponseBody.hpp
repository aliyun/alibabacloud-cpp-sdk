...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessDeniedDetail_ == nullptr
        && return this->associationList_ == nullptr && return this->code_ == nullptr && return this->dynamicCode_ == nullptr && return this->dynamicMessage_ == nullptr && return this->httpStatusCode_ == nullptr
    ...
    inline const vector<DescribeExpressConnectRouterAssociationResponseBodyAssociationList> & associationList() const { DARABONBA_PTR_GET_CONST(associationList_, vector<DescribeExpressConnectRouterAssociationResponseBodyAssociationList>) };
    inline vector<DescribeExpressConnectRouterAssociationResponseBodyAssociationList> associationList() { DARABONBA_PTR_GET(associationList_, vector<DescribeExpressConnectRouterAssociationResponseBodyAssociationList>) };
    inline DescribeExpressConnectRouterAssociationResponseBody& setAssociationList(const vector<DescribeExpressConnectRouterAssociationResponseBodyAssociationList> & associationList) { DARABONBA_PTR_SET_VALUE(associationList_, associationList) };
    inline DescribeExpressConnectRouterAssociationResponseBody& setAssociationList(vector<DescribeExpressConnectRouterAssociationResponseBodyAssociationList> && associationList) { DARABONBA_PTR_SET_RVALUE(associationList_, associationList) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeExpressConnectRouterAssociationResponseBodyAssociationList>> associationList_ = nullptr;
