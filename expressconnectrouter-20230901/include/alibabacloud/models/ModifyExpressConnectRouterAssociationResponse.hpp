...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyExpressConnectRouterAssociationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyExpressConnectRouterAssociationResponseBody) };
    inline ModifyExpressConnectRouterAssociationResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyExpressConnectRouterAssociationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyExpressConnectRouterAssociationResponseBody> body_ {};
  };
