...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExpressConnectRouterAssociationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExpressConnectRouterAssociationResponseBody) };
    inline DescribeExpressConnectRouterAssociationResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExpressConnectRouterAssociationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExpressConnectRouterAssociationResponseBody> body_ {};
  };
