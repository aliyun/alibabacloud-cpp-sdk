...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && return this->dryRun_ == nullptr && return this->ecrId_ == nullptr && return this->transitModeList_ == nullptr && return this->version_ == nullptr; };
    ...
    inline const vector<ModifyExpressConnectRouterInterRegionTransitModeRequestTransitModeList> & transitModeList() const { DARABONBA_PTR_GET_CONST(transitModeList_, vector<ModifyExpressConnectRouterInterRegionTransitModeRequestTransitModeList>) };
    inline vector<ModifyExpressConnectRouterInterRegionTransitModeRequestTransitModeList> transitModeList() { DARABONBA_PTR_GET(transitModeList_, vector<ModifyExpressConnectRouterInterRegionTransitModeRequestTransitModeList>) };
    inline ModifyExpressConnectRouterInterRegionTransitModeRequest& setTransitModeList(const vector<ModifyExpressConnectRouterInterRegionTransitModeRequestTransitModeList> & transitModeList) { DARABONBA_PTR_SET_VALUE(transitModeList_, transitModeList) };
