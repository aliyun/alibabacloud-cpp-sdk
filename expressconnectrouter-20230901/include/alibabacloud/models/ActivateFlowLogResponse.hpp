...
namespace Models
{
  ...
  public:
    ...
    inline const ActivateFlowLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ActivateFlowLogResponseBody) };
    inline ActivateFlowLogResponseBody getBody() { DARABONBA_PTR_GET(body_, ActivateFlowLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ActivateFlowLogResponseBody> body_ {};
  };
