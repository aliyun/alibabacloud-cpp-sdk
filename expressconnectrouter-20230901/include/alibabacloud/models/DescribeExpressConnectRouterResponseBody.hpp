...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessDeniedDetail_ == nullptr
        && return this->code_ == nullptr && return this->dynamicCode_ == nullptr && return this->dynamicMessage_ == nullptr && return this->ecrList_ == nullptr && return this->httpStatusCode_ == nullptr
    ...
    inline const vector<DescribeExpressConnectRouterResponseBodyEcrList> & ecrList() const { DARABONBA_PTR_GET_CONST(ecrList_, vector<DescribeExpressConnectRouterResponseBodyEcrList>) };
    inline vector<DescribeExpressConnectRouterResponseBodyEcrList> ecrList() { DARABONBA_PTR_GET(ecrList_, vector<DescribeExpressConnectRouterResponseBodyEcrList>) };
    inline DescribeExpressConnectRouterResponseBody& setEcrList(const vector<DescribeExpressConnectRouterResponseBodyEcrList> & ecrList) { DARABONBA_PTR_SET_VALUE(ecrList_, ecrList) };
    inline DescribeExpressConnectRouterResponseBody& setEcrList(vector<DescribeExpressConnectRouterResponseBodyEcrList> && ecrList) { DARABONBA_PTR_SET_RVALUE(ecrList_, ecrList) };
  ...
  protected:
    ...
    // The ECRs.
    std::shared_ptr<vector<DescribeExpressConnectRouterResponseBodyEcrList>> ecrList_ = nullptr;
