...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListProductsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListProductsResponseBodyData>) };
    inline vector<ListProductsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListProductsResponseBodyData>) };
    inline ListProductsResponseBody& setData(const vector<ListProductsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListProductsResponseBody& setData(vector<ListProductsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListProductsResponseBodyData>> data_ = nullptr;
