...
namespace Models
{
  ...
  public:
    ...
    inline GetAttachmentUploadUrlResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const GetAttachmentUploadUrlResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAttachmentUploadUrlResponseBodyData) };
    inline GetAttachmentUploadUrlResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAttachmentUploadUrlResponseBodyData) };
    inline GetAttachmentUploadUrlResponseBody& setData(const GetAttachmentUploadUrlResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAttachmentUploadUrlResponseBody& setData(GetAttachmentUploadUrlResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetAttachmentUploadUrlResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetAttachmentUploadUrlResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    std::shared_ptr<GetAttachmentUploadUrlResponseBodyData> data_ = nullptr;
