...
namespace Models
{
  ...
  public:
    ...
    inline ListCategoriesResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListCategoriesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListCategoriesResponseBodyData>) };
    inline vector<ListCategoriesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListCategoriesResponseBodyData>) };
    inline ListCategoriesResponseBody& setData(const vector<ListCategoriesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCategoriesResponseBody& setData(vector<ListCategoriesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListCategoriesResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListCategoriesResponseBodyData>> data_ = nullptr;
