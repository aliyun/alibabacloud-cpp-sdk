...
namespace Models
{
  ...
  public:
    ...
    inline const ListTicketNotesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListTicketNotesResponseBody) };
    inline ListTicketNotesResponseBody body() { DARABONBA_PTR_GET(body_, ListTicketNotesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListTicketNotesResponseBody> body_ = nullptr;
  };
