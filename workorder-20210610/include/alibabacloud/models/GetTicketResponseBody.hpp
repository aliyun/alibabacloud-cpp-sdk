...
namespace Models
{
  ...
  public:
    ...
    inline const GetTicketResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTicketResponseBodyData) };
    inline GetTicketResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTicketResponseBodyData) };
    inline GetTicketResponseBody& setData(const GetTicketResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTicketResponseBody& setData(GetTicketResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline GetTicketResponseBody& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline GetTicketResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline GetTicketResponseBody& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
  ...
  protected:
    ...
    std::shared_ptr<GetTicketResponseBodyData> data_ = nullptr;
