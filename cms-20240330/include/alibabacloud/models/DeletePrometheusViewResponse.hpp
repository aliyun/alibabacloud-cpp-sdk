...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePrometheusViewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePrometheusViewResponseBody) };
    inline DeletePrometheusViewResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePrometheusViewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePrometheusViewResponseBody> body_ {};
  };
