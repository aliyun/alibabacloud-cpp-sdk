...
#ifndef ALIBABACLOUD_MODELS_CREATEDATAPIPELINERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEDATAPIPELINERESPONSEBODY_HPP_
...
namespace Models
{
  class CreateDataPipelineResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateDataPipelineResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(pipeline, pipeline_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateDataPipelineResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(pipeline, pipeline_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    CreateDataPipelineResponseBody() = default ;
    CreateDataPipelineResponseBody(const CreateDataPipelineResponseBody &) = default ;
    CreateDataPipelineResponseBody(CreateDataPipelineResponseBody &&) = default ;
    CreateDataPipelineResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateDataPipelineResponseBody() = default ;
    CreateDataPipelineResponseBody& operator=(const CreateDataPipelineResponseBody &) = default ;
    CreateDataPipelineResponseBody& operator=(CreateDataPipelineResponseBody &&) = default ;
    ...
    inline const CreateDataPipelineResponseBody::Pipeline & getPipeline() const { DARABONBA_PTR_GET_CONST(pipeline_, CreateDataPipelineResponseBody::Pipeline) };
    inline CreateDataPipelineResponseBody::Pipeline getPipeline() { DARABONBA_PTR_GET(pipeline_, CreateDataPipelineResponseBody::Pipeline) };
    inline CreateDataPipelineResponseBody& setPipeline(const CreateDataPipelineResponseBody::Pipeline & pipeline) { DARABONBA_PTR_SET_VALUE(pipeline_, pipeline) };
    inline CreateDataPipelineResponseBody& setPipeline(CreateDataPipelineResponseBody::Pipeline && pipeline) { DARABONBA_PTR_SET_RVALUE(pipeline_, pipeline) };
    ...
    inline CreateDataPipelineResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The data pipeline.
    shared_ptr<CreateDataPipelineResponseBody::Pipeline> pipeline_ {};
    // The request ID.
