...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alertActionIdsShrink_ == nullptr
        && return this->alertActionName_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->type_ == nullptr; };
    ...
    inline string alertActionIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(alertActionIdsShrink_, "") };
  ...
  protected:
    std::shared_ptr<string> alertActionIdsShrink_ = nullptr;
