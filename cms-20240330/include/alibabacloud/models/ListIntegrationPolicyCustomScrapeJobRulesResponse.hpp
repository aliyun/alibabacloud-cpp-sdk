...
namespace Models
{
  ...
  public:
    ...
    inline const ListIntegrationPolicyCustomScrapeJobRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIntegrationPolicyCustomScrapeJobRulesResponseBody) };
    inline ListIntegrationPolicyCustomScrapeJobRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIntegrationPolicyCustomScrapeJobRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIntegrationPolicyCustomScrapeJobRulesResponseBody> body_ {};
  };
