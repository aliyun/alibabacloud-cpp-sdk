...
#ifndef ALIBABACLOUD_MODELS_PREVIEWDATAPIPELINEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_PREVIEWDATAPIPELINEREQUEST_HPP_
...
namespace Models
{
  class PreviewDataPipelineRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const PreviewDataPipelineRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PreviewDataPipelineRequest& obj) { 
    ...
    PreviewDataPipelineRequest() = default ;
    PreviewDataPipelineRequest(const PreviewDataPipelineRequest &) = default ;
    PreviewDataPipelineRequest(PreviewDataPipelineRequest &&) = default ;
    PreviewDataPipelineRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PreviewDataPipelineRequest() = default ;
    PreviewDataPipelineRequest& operator=(const PreviewDataPipelineRequest &) = default ;
    PreviewDataPipelineRequest& operator=(PreviewDataPipelineRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->fromTime_ == nullptr && this->kind_ == nullptr && this->outputs_ == nullptr && this->pipelineName_ == nullptr && this->processors_ == nullptr
        && this->sinks_ == nullptr && this->source_ == nullptr && this->toTime_ == nullptr; };
    // description Field Functions 
    bool hasDescription() const { return this->description_ != nullptr;};
    void deleteDescription() { this->description_ = nullptr;};
    inline string getDescription() const { DARABONBA_PTR_GET_DEFAULT(description_, "") };
    inline PreviewDataPipelineRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline PreviewDataPipelineRequest& setFromTime(int64_t fromTime) { DARABONBA_PTR_SET_VALUE(fromTime_, fromTime) };
    ...
    inline PreviewDataPipelineRequest& setKind(string kind) { DARABONBA_PTR_SET_VALUE(kind_, kind) };


    // outputs Field Functions 
    bool hasOutputs() const { return this->outputs_ != nullptr;};
    void deleteOutputs() { this->outputs_ = nullptr;};
    inline const vector<PreviewDataPipelineRequest::Outputs> & getOutputs() const { DARABONBA_PTR_GET_CONST(outputs_, vector<PreviewDataPipelineRequest::Outputs>) };
    inline vector<PreviewDataPipelineRequest::Outputs> getOutputs() { DARABONBA_PTR_GET(outputs_, vector<PreviewDataPipelineRequest::Outputs>) };
    inline PreviewDataPipelineRequest& setOutputs(const vector<PreviewDataPipelineRequest::Outputs> & outputs) { DARABONBA_PTR_SET_VALUE(outputs_, outputs) };
    inline PreviewDataPipelineRequest& setOutputs(vector<PreviewDataPipelineRequest::Outputs> && outputs) { DARABONBA_PTR_SET_RVALUE(outputs_, outputs) };
    ...
    inline PreviewDataPipelineRequest& setPipelineName(string pipelineName) { DARABONBA_PTR_SET_VALUE(pipelineName_, pipelineName) };


    // processors Field Functions 
    bool hasProcessors() const { return this->processors_ != nullptr;};
    void deleteProcessors() { this->processors_ = nullptr;};
    inline const vector<PreviewDataPipelineRequest::Processors> & getProcessors() const { DARABONBA_PTR_GET_CONST(processors_, vector<PreviewDataPipelineRequest::Processors>) };
    inline vector<PreviewDataPipelineRequest::Processors> getProcessors() { DARABONBA_PTR_GET(processors_, vector<PreviewDataPipelineRequest::Processors>) };
    inline PreviewDataPipelineRequest& setProcessors(const vector<PreviewDataPipelineRequest::Processors> & processors) { DARABONBA_PTR_SET_VALUE(processors_, processors) };
    inline PreviewDataPipelineRequest& setProcessors(vector<PreviewDataPipelineRequest::Processors> && processors) { DARABONBA_PTR_SET_RVALUE(processors_, processors) };


    // sinks Field Functions 
    bool hasSinks() const { return this->sinks_ != nullptr;};
    void deleteSinks() { this->sinks_ = nullptr;};
    inline const vector<PreviewDataPipelineRequest::Sinks> & getSinks() const { DARABONBA_PTR_GET_CONST(sinks_, vector<PreviewDataPipelineRequest::Sinks>) };
    inline vector<PreviewDataPipelineRequest::Sinks> getSinks() { DARABONBA_PTR_GET(sinks_, vector<PreviewDataPipelineRequest::Sinks>) };
    inline PreviewDataPipelineRequest& setSinks(const vector<PreviewDataPipelineRequest::Sinks> & sinks) { DARABONBA_PTR_SET_VALUE(sinks_, sinks) };
    inline PreviewDataPipelineRequest& setSinks(vector<PreviewDataPipelineRequest::Sinks> && sinks) { DARABONBA_PTR_SET_RVALUE(sinks_, sinks) };


    // source Field Functions 
    bool hasSource() const { return this->source_ != nullptr;};
    void deleteSource() { this->source_ = nullptr;};
    inline const PreviewDataPipelineRequest::Source & getSource() const { DARABONBA_PTR_GET_CONST(source_, PreviewDataPipelineRequest::Source) };
    inline PreviewDataPipelineRequest::Source getSource() { DARABONBA_PTR_GET(source_, PreviewDataPipelineRequest::Source) };
    inline PreviewDataPipelineRequest& setSource(const PreviewDataPipelineRequest::Source & source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    inline PreviewDataPipelineRequest& setSource(PreviewDataPipelineRequest::Source && source) { DARABONBA_PTR_SET_RVALUE(source_, source) };
    ...
    inline PreviewDataPipelineRequest& setToTime(int64_t toTime) { DARABONBA_PTR_SET_VALUE(toTime_, toTime) };
  ...
  protected:
    ...
    // The named outputs.
    shared_ptr<vector<PreviewDataPipelineRequest::Outputs>> outputs_ {};
    // The pipeline name.
    shared_ptr<string> pipelineName_ {};
    // The common processors.
    shared_ptr<vector<PreviewDataPipelineRequest::Processors>> processors_ {};
    // The output destinations.
    shared_ptr<vector<PreviewDataPipelineRequest::Sinks>> sinks_ {};
    // The data source.
    shared_ptr<PreviewDataPipelineRequest::Source> source_ {};
