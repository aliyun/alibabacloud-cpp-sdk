...
namespace Models
{
  ...
  public:
    ...
    inline const GetPrometheusViewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPrometheusViewResponseBody) };
    inline GetPrometheusViewResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPrometheusViewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPrometheusViewResponseBody> body_ {};
  };
