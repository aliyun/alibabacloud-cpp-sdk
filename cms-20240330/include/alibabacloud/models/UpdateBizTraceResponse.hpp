...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateBizTraceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateBizTraceResponseBody) };
    inline UpdateBizTraceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateBizTraceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateBizTraceResponseBody> body_ {};
  };
