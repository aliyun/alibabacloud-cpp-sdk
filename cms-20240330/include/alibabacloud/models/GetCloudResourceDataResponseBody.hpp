...
namespace Models
{
  ...
  public:
    ...
    inline const GetCloudResourceDataResponseBody::ResponseStatus & getResponseStatus() const { DARABONBA_PTR_GET_CONST(responseStatus_, GetCloudResourceDataResponseBody::ResponseStatus) };
    inline GetCloudResourceDataResponseBody::ResponseStatus getResponseStatus() { DARABONBA_PTR_GET(responseStatus_, GetCloudResourceDataResponseBody::ResponseStatus) };
    inline GetCloudResourceDataResponseBody& setResponseStatus(const GetCloudResourceDataResponseBody::ResponseStatus & responseStatus) { DARABONBA_PTR_SET_VALUE(responseStatus_, responseStatus) };
    inline GetCloudResourceDataResponseBody& setResponseStatus(GetCloudResourceDataResponseBody::ResponseStatus && responseStatus) { DARABONBA_PTR_SET_RVALUE(responseStatus_, responseStatus) };
