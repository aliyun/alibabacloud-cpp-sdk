...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->changeType_ == nullptr
        && this->content_ == nullptr && this->incidentUuid_ == nullptr && this->operator_ == nullptr && this->time_ == nullptr && this->timelineUuid_ == nullptr
        && this->title_ == nullptr && this->type_ == nullptr && this->userId_ == nullptr && this->workspace_ == nullptr; };
    ...
    inline string getTimelineUuid() const { DARABONBA_PTR_GET_DEFAULT(timelineUuid_, "") };
