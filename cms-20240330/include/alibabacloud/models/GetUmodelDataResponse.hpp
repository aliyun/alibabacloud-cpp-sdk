...
namespace Models
{
  ...
  public:
    ...
    inline const GetUmodelDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUmodelDataResponseBody) };
    inline GetUmodelDataResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUmodelDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUmodelDataResponseBody> body_ {};
  };
