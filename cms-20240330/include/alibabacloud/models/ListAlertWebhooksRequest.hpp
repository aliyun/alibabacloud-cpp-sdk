...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->name_ == nullptr
        && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->webhookIds_ == nullptr && this->workspace_ == nullptr; };
    ...
    inline ListAlertWebhooksRequest& setWorkspace(string workspace) { DARABONBA_PTR_SET_VALUE(workspace_, workspace) };
