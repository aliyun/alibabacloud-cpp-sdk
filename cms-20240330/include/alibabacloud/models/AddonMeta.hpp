  ...
  public:
    ...
    public:
      ...
      public:
        ...
        class BindEntity : public Darabonba::Model {
        public:
          friend void to_json(Darabonba::Json& j, const BindEntity& obj) { 
          ...
          friend void from_json(const Darabonba::Json& j, BindEntity& obj) { 
          ...
          BindEntity() = default ;
          BindEntity(const BindEntity &) = default ;
          BindEntity(BindEntity &&) = default ;
          BindEntity(const Darabonba::Json & obj) { from_json(obj, *this); };
          virtual ~BindEntity() = default ;
          BindEntity& operator=(const BindEntity &) = default ;
          BindEntity& operator=(BindEntity &&) = default ;
          virtual void validate() const override {
          };
          virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
          virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
          virtual bool empty() const override { return this->entityGroupMode_ == nullptr
        && this->entityType_ == nullptr && this->singleEntityMode_ == nullptr && this->vpcIdFieldKey_ == nullptr; };
          ...
          inline bool getEntityGroupMode() const { DARABONBA_PTR_GET_DEFAULT(entityGroupMode_, false) };
          inline BindEntity& setEntityGroupMode(bool entityGroupMode) { DARABONBA_PTR_SET_VALUE(entityGroupMode_, entityGroupMode) };
          ...
          inline BindEntity& setEntityType(string entityType) { DARABONBA_PTR_SET_VALUE(entityType_, entityType) };
          ...
          inline bool getSingleEntityMode() const { DARABONBA_PTR_GET_DEFAULT(singleEntityMode_, false) };
          inline BindEntity& setSingleEntityMode(bool singleEntityMode) { DARABONBA_PTR_SET_VALUE(singleEntityMode_, singleEntityMode) };
          ...
          inline string getVpcIdFieldKey() const { DARABONBA_PTR_GET_DEFAULT(vpcIdFieldKey_, "") };
          inline BindEntity& setVpcIdFieldKey(string vpcIdFieldKey) { DARABONBA_PTR_SET_VALUE(vpcIdFieldKey_, vpcIdFieldKey) };
        ...
        inline bool getBindDefaultPolicy() const { DARABONBA_PTR_GET_DEFAULT(bindDefaultPolicy_, false) };
        inline Policies& setBindDefaultPolicy(bool bindDefaultPolicy) { DARABONBA_PTR_SET_VALUE(bindDefaultPolicy_, bindDefaultPolicy) };
        ...
        inline const Policies::BindEntity & getBindEntity() const { DARABONBA_PTR_GET_CONST(bindEntity_, Policies::BindEntity) };
        inline Policies::BindEntity getBindEntity() { DARABONBA_PTR_GET(bindEntity_, Policies::BindEntity) };
        inline Policies& setBindEntity(const Policies::BindEntity & bindEntity) { DARABONBA_PTR_SET_VALUE(bindEntity_, bindEntity) };
        inline Policies& setBindEntity(Policies::BindEntity && bindEntity) { DARABONBA_PTR_SET_RVALUE(bindEntity_, bindEntity) };
    ...
    inline const vector<AddonMeta::Dashboards> & getDashboards() const { DARABONBA_PTR_GET_CONST(dashboards_, vector<AddonMeta::Dashboards>) };
    inline vector<AddonMeta::Dashboards> getDashboards() { DARABONBA_PTR_GET(dashboards_, vector<AddonMeta::Dashboards>) };
    inline AddonMeta& setDashboards(const vector<AddonMeta::Dashboards> & dashboards) { DARABONBA_PTR_SET_VALUE(dashboards_, dashboards) };
    inline AddonMeta& setDashboards(vector<AddonMeta::Dashboards> && dashboards) { DARABONBA_PTR_SET_RVALUE(dashboards_, dashboards) };
    ...
    inline const vector<AddonMeta::Environments> & getEnvironments() const { DARABONBA_PTR_GET_CONST(environments_, vector<AddonMeta::Environments>) };
    inline vector<AddonMeta::Environments> getEnvironments() { DARABONBA_PTR_GET(environments_, vector<AddonMeta::Environments>) };
    inline AddonMeta& setEnvironments(const vector<AddonMeta::Environments> & environments) { DARABONBA_PTR_SET_VALUE(environments_, environments) };
    inline AddonMeta& setEnvironments(vector<AddonMeta::Environments> && environments) { DARABONBA_PTR_SET_RVALUE(environments_, environments) };
