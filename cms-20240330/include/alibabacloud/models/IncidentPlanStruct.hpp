...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getCloseExpire() const { DARABONBA_PTR_GET_DEFAULT(closeExpire_, 0L) };
    ...
    inline const vector<IncidentPlanCorporationStruct> & getCorporation() const { DARABONBA_PTR_GET_CONST(corporation_, vector<IncidentPlanCorporationStruct>) };
    inline vector<IncidentPlanCorporationStruct> getCorporation() { DARABONBA_PTR_GET(corporation_, vector<IncidentPlanCorporationStruct>) };
    ...
    inline const vector<IncidentPlanFieldPath> & getGroupBy() const { DARABONBA_PTR_GET_CONST(groupBy_, vector<IncidentPlanFieldPath>) };
    inline vector<IncidentPlanFieldPath> getGroupBy() { DARABONBA_PTR_GET(groupBy_, vector<IncidentPlanFieldPath>) };
    ...
    inline string getIncidentPlanId() const { DARABONBA_PTR_GET_DEFAULT(incidentPlanId_, "") };
    ...
    inline const vector<IncidentPlanFieldPath> & getResourceFiled() const { DARABONBA_PTR_GET_CONST(resourceFiled_, vector<IncidentPlanFieldPath>) };
    inline vector<IncidentPlanFieldPath> getResourceFiled() { DARABONBA_PTR_GET(resourceFiled_, vector<IncidentPlanFieldPath>) };
