...
namespace Models
{
  ...
  public:
    ...
    inline const GetAggTaskGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAggTaskGroupResponseBody) };
    inline GetAggTaskGroupResponseBody body() { DARABONBA_PTR_GET(body_, GetAggTaskGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAggTaskGroupResponseBody> body_ = nullptr;
  };
