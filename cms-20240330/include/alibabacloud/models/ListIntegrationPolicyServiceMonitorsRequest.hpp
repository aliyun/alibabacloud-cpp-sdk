...
namespace Models
{
  ...
  public:
    ...
    inline ListIntegrationPolicyServiceMonitorsRequest& setCollectorReleaseName(string collectorReleaseName) { DARABONBA_PTR_SET_VALUE(collectorReleaseName_, collectorReleaseName) };
