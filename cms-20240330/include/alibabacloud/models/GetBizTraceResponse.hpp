...
namespace Models
{
  ...
  public:
    ...
    inline const GetBizTraceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetBizTraceResponseBody) };
    inline GetBizTraceResponseBody body() { DARABONBA_PTR_GET(body_, GetBizTraceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetBizTraceResponseBody> body_ = nullptr;
  };
