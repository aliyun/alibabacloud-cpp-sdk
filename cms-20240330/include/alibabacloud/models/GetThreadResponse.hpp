...
namespace Models
{
  ...
  public:
    ...
    inline const GetThreadResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetThreadResponseBody) };
    inline GetThreadResponseBody body() { DARABONBA_PTR_GET(body_, GetThreadResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetThreadResponseBody> body_ = nullptr;
  };
