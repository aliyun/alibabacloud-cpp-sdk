...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->contacts_ == nullptr
        && this->customWebhooks_ == nullptr && this->dingWebhooks_ == nullptr && this->fsWebhooks_ == nullptr && this->groups_ == nullptr && this->slackWebhooks_ == nullptr
        && this->wxWebhooks_ == nullptr; };
