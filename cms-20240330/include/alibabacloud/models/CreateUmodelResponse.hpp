...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUmodelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateUmodelResponseBody) };
    inline CreateUmodelResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateUmodelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateUmodelResponseBody> body_ {};
  };
