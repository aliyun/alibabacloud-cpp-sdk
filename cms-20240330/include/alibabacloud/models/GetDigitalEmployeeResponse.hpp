...
namespace Models
{
  ...
  public:
    ...
    inline const GetDigitalEmployeeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDigitalEmployeeResponseBody) };
    inline GetDigitalEmployeeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDigitalEmployeeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDigitalEmployeeResponseBody> body_ {};
  };
