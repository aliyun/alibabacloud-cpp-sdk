...
namespace Models
{
  ...
  public:
    ...
    inline const GetPrometheusUserSettingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPrometheusUserSettingResponseBody) };
    inline GetPrometheusUserSettingResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPrometheusUserSettingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPrometheusUserSettingResponseBody> body_ {};
  };
