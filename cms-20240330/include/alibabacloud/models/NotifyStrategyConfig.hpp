...
#ifndef ALIBABACLOUD_MODELS_NOTIFYSTRATEGYCONFIG_HPP_
#define ALIBABACLOUD_MODELS_NOTIFYSTRATEGYCONFIG_HPP_
...
namespace Models
{
  class NotifyStrategyConfig : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const NotifyStrategyConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, NotifyStrategyConfig& obj) { 
    ...
    NotifyStrategyConfig() = default ;
    NotifyStrategyConfig(const NotifyStrategyConfig &) = default ;
    NotifyStrategyConfig(NotifyStrategyConfig &&) = default ;
    NotifyStrategyConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~NotifyStrategyConfig() = default ;
    NotifyStrategyConfig& operator=(const NotifyStrategyConfig &) = default ;
    NotifyStrategyConfig& operator=(NotifyStrategyConfig &&) = default ;
    ...
    inline const vector<NotifyStrategyConfig::CustomTemplateEntries> & getCustomTemplateEntries() const { DARABONBA_PTR_GET_CONST(customTemplateEntries_, vector<NotifyStrategyConfig::CustomTemplateEntries>) };
    inline vector<NotifyStrategyConfig::CustomTemplateEntries> getCustomTemplateEntries() { DARABONBA_PTR_GET(customTemplateEntries_, vector<NotifyStrategyConfig::CustomTemplateEntries>) };
    inline NotifyStrategyConfig& setCustomTemplateEntries(const vector<NotifyStrategyConfig::CustomTemplateEntries> & customTemplateEntries) { DARABONBA_PTR_SET_VALUE(customTemplateEntries_, customTemplateEntries) };
    inline NotifyStrategyConfig& setCustomTemplateEntries(vector<NotifyStrategyConfig::CustomTemplateEntries> && customTemplateEntries) { DARABONBA_PTR_SET_RVALUE(customTemplateEntries_, customTemplateEntries) };
    ...
    inline NotifyStrategyConfig& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline const NotifyStrategyConfig::GroupingSetting & getGroupingSetting() const { DARABONBA_PTR_GET_CONST(groupingSetting_, NotifyStrategyConfig::GroupingSetting) };
    inline NotifyStrategyConfig::GroupingSetting getGroupingSetting() { DARABONBA_PTR_GET(groupingSetting_, NotifyStrategyConfig::GroupingSetting) };
    inline NotifyStrategyConfig& setGroupingSetting(const NotifyStrategyConfig::GroupingSetting & groupingSetting) { DARABONBA_PTR_SET_VALUE(groupingSetting_, groupingSetting) };
    inline NotifyStrategyConfig& setGroupingSetting(NotifyStrategyConfig::GroupingSetting && groupingSetting) { DARABONBA_PTR_SET_RVALUE(groupingSetting_, groupingSetting) };
    ...
    inline NotifyStrategyConfig& setIgnoreRestoredNotification(bool ignoreRestoredNotification) { DARABONBA_PTR_SET_VALUE(ignoreRestoredNotification_, ignoreRestoredNotification) };


    // routes Field Functions 
    bool hasRoutes() const { return this->routes_ != nullptr;};
    void deleteRoutes() { this->routes_ = nullptr;};
    inline const vector<NotifyStrategyConfig::Routes> & getRoutes() const { DARABONBA_PTR_GET_CONST(routes_, vector<NotifyStrategyConfig::Routes>) };
    inline vector<NotifyStrategyConfig::Routes> getRoutes() { DARABONBA_PTR_GET(routes_, vector<NotifyStrategyConfig::Routes>) };
    inline NotifyStrategyConfig& setRoutes(const vector<NotifyStrategyConfig::Routes> & routes) { DARABONBA_PTR_SET_VALUE(routes_, routes) };
    inline NotifyStrategyConfig& setRoutes(vector<NotifyStrategyConfig::Routes> && routes) { DARABONBA_PTR_SET_RVALUE(routes_, routes) };


  protected:
    // The list of custom notification templates.
    shared_ptr<vector<NotifyStrategyConfig::CustomTemplateEntries>> customTemplateEntries_ {};
    // The description of the notification policy.
    shared_ptr<string> description_ {};
    // The noise reduction settings.
    // 
    // This parameter is required.
    shared_ptr<NotifyStrategyConfig::GroupingSetting> groupingSetting_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<NotifyStrategyConfig::Routes>> routes_ {};
  };
