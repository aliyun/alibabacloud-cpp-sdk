...
namespace Models
{
  ...
  public:
    ...
    inline const UpsertUmodelDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpsertUmodelDataResponseBody) };
    inline UpsertUmodelDataResponseBody getBody() { DARABONBA_PTR_GET(body_, UpsertUmodelDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpsertUmodelDataResponseBody> body_ {};
  };
