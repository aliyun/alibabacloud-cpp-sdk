...
namespace Models
{
  ...
  public:
    ...
    inline const GetCmsServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCmsServiceResponseBody) };
    inline GetCmsServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCmsServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCmsServiceResponseBody> body_ {};
  };
