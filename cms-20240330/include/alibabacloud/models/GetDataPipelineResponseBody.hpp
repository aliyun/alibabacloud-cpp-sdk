...
#ifndef ALIBABACLOUD_MODELS_GETDATAPIPELINERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETDATAPIPELINERESPONSEBODY_HPP_
...
namespace Models
{
  class GetDataPipelineResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetDataPipelineResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(pipeline, pipeline_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetDataPipelineResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(pipeline, pipeline_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    GetDataPipelineResponseBody() = default ;
    GetDataPipelineResponseBody(const GetDataPipelineResponseBody &) = default ;
    GetDataPipelineResponseBody(GetDataPipelineResponseBody &&) = default ;
    GetDataPipelineResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDataPipelineResponseBody() = default ;
    GetDataPipelineResponseBody& operator=(const GetDataPipelineResponseBody &) = default ;
    GetDataPipelineResponseBody& operator=(GetDataPipelineResponseBody &&) = default ;
    ...
    public:
      ...
      inline const vector<Pipeline::Outputs> & getOutputs() const { DARABONBA_PTR_GET_CONST(outputs_, vector<Pipeline::Outputs>) };
      inline vector<Pipeline::Outputs> getOutputs() { DARABONBA_PTR_GET(outputs_, vector<Pipeline::Outputs>) };
      inline Pipeline& setOutputs(const vector<Pipeline::Outputs> & outputs) { DARABONBA_PTR_SET_VALUE(outputs_, outputs) };
      inline Pipeline& setOutputs(vector<Pipeline::Outputs> && outputs) { DARABONBA_PTR_SET_RVALUE(outputs_, outputs) };
      ...
      inline Pipeline& setPipelineName(string pipelineName) { DARABONBA_PTR_SET_VALUE(pipelineName_, pipelineName) };


      // processors Field Functions 
      bool hasProcessors() const { return this->processors_ != nullptr;};
      void deleteProcessors() { this->processors_ = nullptr;};
      inline const vector<Pipeline::Processors> & getProcessors() const { DARABONBA_PTR_GET_CONST(processors_, vector<Pipeline::Processors>) };
      inline vector<Pipeline::Processors> getProcessors() { DARABONBA_PTR_GET(processors_, vector<Pipeline::Processors>) };
      inline Pipeline& setProcessors(const vector<Pipeline::Processors> & processors) { DARABONBA_PTR_SET_VALUE(processors_, processors) };
      inline Pipeline& setProcessors(vector<Pipeline::Processors> && processors) { DARABONBA_PTR_SET_RVALUE(processors_, processors) };
      ...
      inline Pipeline& setSignalType(string signalType) { DARABONBA_PTR_SET_VALUE(signalType_, signalType) };


      // sinks Field Functions 
      bool hasSinks() const { return this->sinks_ != nullptr;};
      void deleteSinks() { this->sinks_ = nullptr;};
      inline const vector<Pipeline::Sinks> & getSinks() const { DARABONBA_PTR_GET_CONST(sinks_, vector<Pipeline::Sinks>) };
      inline vector<Pipeline::Sinks> getSinks() { DARABONBA_PTR_GET(sinks_, vector<Pipeline::Sinks>) };
      inline Pipeline& setSinks(const vector<Pipeline::Sinks> & sinks) { DARABONBA_PTR_SET_VALUE(sinks_, sinks) };
      inline Pipeline& setSinks(vector<Pipeline::Sinks> && sinks) { DARABONBA_PTR_SET_RVALUE(sinks_, sinks) };


      // source Field Functions 
      bool hasSource() const { return this->source_ != nullptr;};
      void deleteSource() { this->source_ = nullptr;};
      inline const Pipeline::Source & getSource() const { DARABONBA_PTR_GET_CONST(source_, Pipeline::Source) };
      inline Pipeline::Source getSource() { DARABONBA_PTR_GET(source_, Pipeline::Source) };
      inline Pipeline& setSource(const Pipeline::Source & source) { DARABONBA_PTR_SET_VALUE(source_, source) };
      inline Pipeline& setSource(Pipeline::Source && source) { DARABONBA_PTR_SET_RVALUE(source_, source) };
      ...
      inline Pipeline& setStatusMessage(string statusMessage) { DARABONBA_PTR_SET_VALUE(statusMessage_, statusMessage) };
      ...
      inline Pipeline& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
      ...
      inline Pipeline& setVersion(int64_t version) { DARABONBA_PTR_SET_VALUE(version_, version) };
    ...
    protected:
      ...
      // 
      // This parameter is required.
      shared_ptr<vector<Pipeline::Outputs>> outputs_ {};
      // The pipeline name.
      // 
      // This parameter is required.
      ...
      // 
      // This parameter is required.
      shared_ptr<vector<Pipeline::Processors>> processors_ {};
      // The signal type.
      // 
      // This parameter is required.
      ...
      // 
      // This parameter is required.
      shared_ptr<vector<Pipeline::Sinks>> sinks_ {};
      // The data source.
      // 
      // This parameter is required.
      shared_ptr<Pipeline::Source> source_ {};
      // The running status.
      // 
      // This parameter is required.
    ...
    inline const GetDataPipelineResponseBody::Pipeline & getPipeline() const { DARABONBA_PTR_GET_CONST(pipeline_, GetDataPipelineResponseBody::Pipeline) };
    inline GetDataPipelineResponseBody::Pipeline getPipeline() { DARABONBA_PTR_GET(pipeline_, GetDataPipelineResponseBody::Pipeline) };
    inline GetDataPipelineResponseBody& setPipeline(const GetDataPipelineResponseBody::Pipeline & pipeline) { DARABONBA_PTR_SET_VALUE(pipeline_, pipeline) };
    inline GetDataPipelineResponseBody& setPipeline(GetDataPipelineResponseBody::Pipeline && pipeline) { DARABONBA_PTR_SET_RVALUE(pipeline_, pipeline) };
    ...
    inline GetDataPipelineResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The data pipeline.
    shared_ptr<GetDataPipelineResponseBody::Pipeline> pipeline_ {};
    // The request ID.
