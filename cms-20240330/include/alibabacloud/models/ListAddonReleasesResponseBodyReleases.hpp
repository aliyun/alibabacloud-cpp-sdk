...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->addonName_ == nullptr
        && return this->alertRuleCount_ == nullptr && return this->apiVersion_ == nullptr && return this->conditions_ == nullptr && return this->config_ == nullptr && return this->createTime_ == nullptr
        && return this->dashboardCount_ == nullptr && return this->entityRules_ == nullptr && return this->envType_ == nullptr && return this->environmentId_ == nullptr && return this->exporterCount_ == nullptr
        && return this->haveConfig_ == nullptr && return this->installUserId_ == nullptr && return this->language_ == nullptr && return this->managed_ == nullptr && return this->nextVersion_ == nullptr
        && return this->parentAddonReleaseId_ == nullptr && return this->policyId_ == nullptr && return this->regionId_ == nullptr && return this->releaseId_ == nullptr && return this->releaseName_ == nullptr
        && return this->scene_ == nullptr && return this->status_ == nullptr && return this->subAddonRelease_ == nullptr && return this->updateTime_ == nullptr && return this->userId_ == nullptr
        && return this->version_ == nullptr && return this->workspace_ == nullptr; };
