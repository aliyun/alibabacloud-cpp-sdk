...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBizTraceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBizTraceResponseBody) };
    inline CreateBizTraceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBizTraceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBizTraceResponseBody> body_ {};
  };
