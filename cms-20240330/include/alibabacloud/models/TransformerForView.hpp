...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actions_ == nullptr
        && return this->createTime_ == nullptr && return this->description_ == nullptr && return this->enable_ == nullptr && return this->filterSetting_ == nullptr && return this->quitAfterMatch_ == nullptr
        && return this->sortId_ == nullptr && return this->transformerId_ == nullptr && return this->transformerName_ == nullptr && return this->updateTime_ == nullptr && return this->userId_ == nullptr
