...
namespace Models
{
  ...
  public:
    ...
    inline const ListBizTracesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListBizTracesResponseBody) };
    inline ListBizTracesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListBizTracesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListBizTracesResponseBody> body_ {};
  };
