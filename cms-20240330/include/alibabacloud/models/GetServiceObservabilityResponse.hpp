...
namespace Models
{
  ...
  public:
    ...
    inline const GetServiceObservabilityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetServiceObservabilityResponseBody) };
    inline GetServiceObservabilityResponseBody getBody() { DARABONBA_PTR_GET(body_, GetServiceObservabilityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetServiceObservabilityResponseBody> body_ {};
  };
