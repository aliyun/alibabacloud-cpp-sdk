...
#ifndef ALIBABACLOUD_MODELS_THRESHOLDLIST_HPP_
#define ALIBABACLOUD_MODELS_THRESHOLDLIST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    inline ThresholdList& setThreshold(float threshold) { DARABONBA_PTR_SET_VALUE(threshold_, threshold) };
