...
#ifndef ALIBABACLOUD_MODELS_LISTINTEGRATIONPOLICYADDONSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTINTEGRATIONPOLICYADDONSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListIntegrationPolicyAddonsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListIntegrationPolicyAddonsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(addons, addons_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
      DARABONBA_PTR_TO_JSON(total, total_);
    };
    friend void from_json(const Darabonba::Json& j, ListIntegrationPolicyAddonsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(addons, addons_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
      DARABONBA_PTR_FROM_JSON(total, total_);
    };
    ListIntegrationPolicyAddonsResponseBody() = default ;
    ListIntegrationPolicyAddonsResponseBody(const ListIntegrationPolicyAddonsResponseBody &) = default ;
    ListIntegrationPolicyAddonsResponseBody(ListIntegrationPolicyAddonsResponseBody &&) = default ;
    ListIntegrationPolicyAddonsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListIntegrationPolicyAddonsResponseBody() = default ;
    ListIntegrationPolicyAddonsResponseBody& operator=(const ListIntegrationPolicyAddonsResponseBody &) = default ;
    ListIntegrationPolicyAddonsResponseBody& operator=(ListIntegrationPolicyAddonsResponseBody &&) = default ;
    ...
    public:
      ...
      inline Addons& setWeight(int32_t weight) { DARABONBA_PTR_SET_VALUE(weight_, weight) };
    ...
    inline const vector<ListIntegrationPolicyAddonsResponseBody::Addons> & getAddons() const { DARABONBA_PTR_GET_CONST(addons_, vector<ListIntegrationPolicyAddonsResponseBody::Addons>) };
    inline vector<ListIntegrationPolicyAddonsResponseBody::Addons> getAddons() { DARABONBA_PTR_GET(addons_, vector<ListIntegrationPolicyAddonsResponseBody::Addons>) };
    inline ListIntegrationPolicyAddonsResponseBody& setAddons(const vector<ListIntegrationPolicyAddonsResponseBody::Addons> & addons) { DARABONBA_PTR_SET_VALUE(addons_, addons) };
    inline ListIntegrationPolicyAddonsResponseBody& setAddons(vector<ListIntegrationPolicyAddonsResponseBody::Addons> && addons) { DARABONBA_PTR_SET_RVALUE(addons_, addons) };
    ...
    inline ListIntegrationPolicyAddonsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListIntegrationPolicyAddonsResponseBody& setTotal(int64_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
