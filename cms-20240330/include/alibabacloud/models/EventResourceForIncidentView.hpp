...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->domain_ == nullptr
        && return this->entityId_ == nullptr && return this->entityType_ == nullptr && return this->probs_ == nullptr && return this->tags_ == nullptr; };
    ...
    inline string probs() const { DARABONBA_PTR_GET_DEFAULT(probs_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> probs_ = nullptr;
