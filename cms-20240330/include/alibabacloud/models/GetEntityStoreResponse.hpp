...
namespace Models
{
  ...
  public:
    ...
    inline const GetEntityStoreResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEntityStoreResponseBody) };
    inline GetEntityStoreResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEntityStoreResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEntityStoreResponseBody> body_ {};
  };
