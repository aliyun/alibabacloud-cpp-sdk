...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteThreadResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteThreadResponseBody) };
    inline DeleteThreadResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteThreadResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteThreadResponseBody> body_ {};
  };
