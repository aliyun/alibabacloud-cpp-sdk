...
namespace Models
{
  ...
  public:
    ...
    inline const ListIntegrationPolicyCollectorsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListIntegrationPolicyCollectorsResponseBody) };
    inline ListIntegrationPolicyCollectorsResponseBody body() { DARABONBA_PTR_GET(body_, ListIntegrationPolicyCollectorsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListIntegrationPolicyCollectorsResponseBody> body_ = nullptr;
  };
