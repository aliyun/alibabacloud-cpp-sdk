...
namespace Models
{
  ...
  public:
    ...
    inline const vector<int32_t> & dayOfWeek() const { DARABONBA_PTR_GET_CONST(dayOfWeek_, vector<int32_t>) };
    inline vector<int32_t> dayOfWeek() { DARABONBA_PTR_GET(dayOfWeek_, vector<int32_t>) };
    ...
    inline string gmtOffset() const { DARABONBA_PTR_GET_DEFAULT(gmtOffset_, "") };
  ...
  protected:
    std::shared_ptr<vector<int32_t>> dayOfWeek_ = nullptr;
    std::shared_ptr<string> endTime_ = nullptr;
    std::shared_ptr<string> gmtOffset_ = nullptr;
