...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->attributes_ != nullptr
        && this->createTime_ != nullptr && this->description_ != nullptr && this->displayName_ != nullptr && this->pid_ != nullptr && this->serviceId_ != nullptr
        && this->serviceName_ != nullptr && this->serviceStatus_ != nullptr && this->serviceType_ != nullptr && this->workspace_ != nullptr; };
