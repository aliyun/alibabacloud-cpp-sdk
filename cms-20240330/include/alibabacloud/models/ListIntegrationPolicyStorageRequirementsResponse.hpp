...
namespace Models
{
  ...
  public:
    ...
    inline const ListIntegrationPolicyStorageRequirementsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIntegrationPolicyStorageRequirementsResponseBody) };
    inline ListIntegrationPolicyStorageRequirementsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIntegrationPolicyStorageRequirementsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIntegrationPolicyStorageRequirementsResponseBody> body_ {};
  };
