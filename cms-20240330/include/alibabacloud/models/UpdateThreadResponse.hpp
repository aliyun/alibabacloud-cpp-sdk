...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateThreadResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateThreadResponseBody) };
    inline UpdateThreadResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateThreadResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateThreadResponseBody> body_ {};
  };
