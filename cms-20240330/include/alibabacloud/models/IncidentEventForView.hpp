...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoRecoverTime_ == nullptr
        && this->content_ == nullptr && this->count_ == nullptr && this->dimension_ == nullptr && this->eventResource_ == nullptr && this->groupBy_ == nullptr
        && this->incidentEventUuid_ == nullptr && this->incidentUuid_ == nullptr && this->labels_ == nullptr && this->lastTime_ == nullptr && this->recoverTime_ == nullptr
        && this->searchIndex_ == nullptr && this->severity_ == nullptr && this->severityCountMap_ == nullptr && this->state_ == nullptr && this->textIndex_ == nullptr
        && this->time_ == nullptr && this->title_ == nullptr && this->userId_ == nullptr && this->workspace_ == nullptr; };
    ...
    inline int64_t getAutoRecoverTime() const { DARABONBA_PTR_GET_DEFAULT(autoRecoverTime_, 0L) };
    ...
    inline const CmsEventForView & getContent() const { DARABONBA_PTR_GET_CONST(content_, CmsEventForView) };
    inline CmsEventForView getContent() { DARABONBA_PTR_GET(content_, CmsEventForView) };
    ...
    inline     const Darabonba::Json & getDimension() const { DARABONBA_GET(dimension_) };
    Darabonba::Json & getDimension() { DARABONBA_GET(dimension_) };
    ...
    inline const EventResourceForIncidentView & getEventResource() const { DARABONBA_PTR_GET_CONST(eventResource_, EventResourceForIncidentView) };
    inline EventResourceForIncidentView getEventResource() { DARABONBA_PTR_GET(eventResource_, EventResourceForIncidentView) };
    ...
    inline     const Darabonba::Json & getGroupBy() const { DARABONBA_GET(groupBy_) };
    Darabonba::Json & getGroupBy() { DARABONBA_GET(groupBy_) };
    ...
    inline string getIncidentEventUuid() const { DARABONBA_PTR_GET_DEFAULT(incidentEventUuid_, "") };
    ...
    inline const vector<string> & getSearchIndex() const { DARABONBA_PTR_GET_CONST(searchIndex_, vector<string>) };
    inline vector<string> getSearchIndex() { DARABONBA_PTR_GET(searchIndex_, vector<string>) };
    ...
    inline     const Darabonba::Json & getSeverityCountMap() const { DARABONBA_GET(severityCountMap_) };
    Darabonba::Json & getSeverityCountMap() { DARABONBA_GET(severityCountMap_) };
    ...
    inline string getTextIndex() const { DARABONBA_PTR_GET_DEFAULT(textIndex_, "") };
