...
#ifndef ALIBABACLOUD_MODELS_PAGINATION_HPP_
#define ALIBABACLOUD_MODELS_PAGINATION_HPP_
...
namespace Models
{
  ...
  public:
    ...
    inline Pagination& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
