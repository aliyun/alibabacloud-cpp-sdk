...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAggTaskGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateAggTaskGroupResponseBody) };
    inline UpdateAggTaskGroupResponseBody body() { DARABONBA_PTR_GET(body_, UpdateAggTaskGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateAggTaskGroupResponseBody> body_ = nullptr;
  };
