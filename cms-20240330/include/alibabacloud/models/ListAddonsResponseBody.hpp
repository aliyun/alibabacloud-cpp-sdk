...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Addons& setCategories(const vector<string> & categories) { DARABONBA_PTR_SET_VALUE(categories_, categories) };
      inline Addons& setCategories(vector<string> && categories) { DARABONBA_PTR_SET_RVALUE(categories_, categories) };
      ...
      inline const vector<Addons::Dashboards> & getDashboards() const { DARABONBA_PTR_GET_CONST(dashboards_, vector<Addons::Dashboards>) };
      inline vector<Addons::Dashboards> getDashboards() { DARABONBA_PTR_GET(dashboards_, vector<Addons::Dashboards>) };
      inline Addons& setDashboards(const vector<Addons::Dashboards> & dashboards) { DARABONBA_PTR_SET_VALUE(dashboards_, dashboards) };
      inline Addons& setDashboards(vector<Addons::Dashboards> && dashboards) { DARABONBA_PTR_SET_RVALUE(dashboards_, dashboards) };
      ...
      inline const vector<Addons::Environments> & getEnvironments() const { DARABONBA_PTR_GET_CONST(environments_, vector<Addons::Environments>) };
      inline vector<Addons::Environments> getEnvironments() { DARABONBA_PTR_GET(environments_, vector<Addons::Environments>) };
      inline Addons& setEnvironments(const vector<Addons::Environments> & environments) { DARABONBA_PTR_SET_VALUE(environments_, environments) };
      inline Addons& setEnvironments(vector<Addons::Environments> && environments) { DARABONBA_PTR_SET_RVALUE(environments_, environments) };
      ...
      inline Addons& setKeywords(const vector<string> & keywords) { DARABONBA_PTR_SET_VALUE(keywords_, keywords) };
      inline Addons& setKeywords(vector<string> && keywords) { DARABONBA_PTR_SET_RVALUE(keywords_, keywords) };
      ...
      inline Addons& setLanguage(string language) { DARABONBA_PTR_SET_VALUE(language_, language) };
      ...
      inline Addons& setLatestReleaseCreateTime(string latestReleaseCreateTime) { DARABONBA_PTR_SET_VALUE(latestReleaseCreateTime_, latestReleaseCreateTime) };
      ...
      inline Addons& setOnce(bool once) { DARABONBA_PTR_SET_VALUE(once_, once) };
      ...
      inline Addons& setScene(string scene) { DARABONBA_PTR_SET_VALUE(scene_, scene) };
      ...
      inline Addons& setWeight(string weight) { DARABONBA_PTR_SET_VALUE(weight_, weight) };
