...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateAggTaskGroupRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<UpdateAggTaskGroupRequest::Tags>) };
    inline vector<UpdateAggTaskGroupRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<UpdateAggTaskGroupRequest::Tags>) };
    inline UpdateAggTaskGroupRequest& setTags(const vector<UpdateAggTaskGroupRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline UpdateAggTaskGroupRequest& setTags(vector<UpdateAggTaskGroupRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
