...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->config_ == nullptr
        && this->release_ == nullptr && this->requestId_ == nullptr; };
    // config Field Functions 
    bool hasConfig() const { return this->config_ != nullptr;};
    void deleteConfig() { this->config_ = nullptr;};
    inline string getConfig() const { DARABONBA_PTR_GET_DEFAULT(config_, "") };
    ...
    inline const GetAddonReleaseResponseBody::Release & getRelease() const { DARABONBA_PTR_GET_CONST(release_, GetAddonReleaseResponseBody::Release) };
    inline GetAddonReleaseResponseBody::Release getRelease() { DARABONBA_PTR_GET(release_, GetAddonReleaseResponseBody::Release) };
    inline GetAddonReleaseResponseBody& setRelease(const GetAddonReleaseResponseBody::Release & release) { DARABONBA_PTR_SET_VALUE(release_, release) };
    inline GetAddonReleaseResponseBody& setRelease(GetAddonReleaseResponseBody::Release && release) { DARABONBA_PTR_SET_RVALUE(release_, release) };
