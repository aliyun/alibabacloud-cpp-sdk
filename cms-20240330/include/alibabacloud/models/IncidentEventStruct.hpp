...
namespace Models
{
  ...
  public:
    ...
    inline const map<string, string> & getGroupBy() const { DARABONBA_PTR_GET_CONST(groupBy_, map<string, string>) };
    inline map<string, string> getGroupBy() { DARABONBA_PTR_GET(groupBy_, map<string, string>) };
    ...
    inline string getIncidentEventId() const { DARABONBA_PTR_GET_DEFAULT(incidentEventId_, "") };
    ...
    inline const map<string, string> & getResource() const { DARABONBA_PTR_GET_CONST(resource_, map<string, string>) };
    inline map<string, string> getResource() { DARABONBA_PTR_GET(resource_, map<string, string>) };
