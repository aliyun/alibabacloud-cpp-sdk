...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->config_ == nullptr
        && this->contextType_ == nullptr && this->dataset_ == nullptr && this->description_ == nullptr; };
    ...
    inline const UpdateContextStoreRequest::Dataset & getDataset() const { DARABONBA_PTR_GET_CONST(dataset_, UpdateContextStoreRequest::Dataset) };
    inline UpdateContextStoreRequest::Dataset getDataset() { DARABONBA_PTR_GET(dataset_, UpdateContextStoreRequest::Dataset) };
    inline UpdateContextStoreRequest& setDataset(const UpdateContextStoreRequest::Dataset & dataset) { DARABONBA_PTR_SET_VALUE(dataset_, dataset) };
    inline UpdateContextStoreRequest& setDataset(UpdateContextStoreRequest::Dataset && dataset) { DARABONBA_PTR_SET_RVALUE(dataset_, dataset) };
