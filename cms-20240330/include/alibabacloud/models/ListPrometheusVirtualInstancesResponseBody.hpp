...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListPrometheusVirtualInstancesResponseBodyInstances> & instances() const { DARABONBA_PTR_GET_CONST(instances_, vector<ListPrometheusVirtualInstancesResponseBodyInstances>) };
    inline vector<ListPrometheusVirtualInstancesResponseBodyInstances> instances() { DARABONBA_PTR_GET(instances_, vector<ListPrometheusVirtualInstancesResponseBodyInstances>) };
    inline ListPrometheusVirtualInstancesResponseBody& setInstances(const vector<ListPrometheusVirtualInstancesResponseBodyInstances> & instances) { DARABONBA_PTR_SET_VALUE(instances_, instances) };
    inline ListPrometheusVirtualInstancesResponseBody& setInstances(vector<ListPrometheusVirtualInstancesResponseBodyInstances> && instances) { DARABONBA_PTR_SET_RVALUE(instances_, instances) };
