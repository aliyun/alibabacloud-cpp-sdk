...
namespace Models
{
  ...
  public:
    ...
    inline ListIntegrationPolicyPodMonitorsRequest& setCollectorReleaseName(string collectorReleaseName) { DARABONBA_PTR_SET_VALUE(collectorReleaseName_, collectorReleaseName) };
