...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePrometheusUserSettingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePrometheusUserSettingResponseBody) };
    inline UpdatePrometheusUserSettingResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePrometheusUserSettingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePrometheusUserSettingResponseBody> body_ {};
  };
