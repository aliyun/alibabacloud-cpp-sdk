...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePrometheusViewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePrometheusViewResponseBody) };
    inline UpdatePrometheusViewResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePrometheusViewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePrometheusViewResponseBody> body_ {};
  };
