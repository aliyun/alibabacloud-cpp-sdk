...
namespace Models
{
  ...
  public:
    ...
    inline string getAlertEventIntegrationPolicyId() const { DARABONBA_PTR_GET_DEFAULT(alertEventIntegrationPolicyId_, "") };
    ...
    inline string getAlertEventIntegrationPolicyName() const { DARABONBA_PTR_GET_DEFAULT(alertEventIntegrationPolicyName_, "") };
    ...
    inline string getIntegrationSetting() const { DARABONBA_PTR_GET_DEFAULT(integrationSetting_, "") };
    ...
    inline const vector<TransformAction> & getTransformerSetting() const { DARABONBA_PTR_GET_CONST(transformerSetting_, vector<TransformAction>) };
    inline vector<TransformAction> getTransformerSetting() { DARABONBA_PTR_GET(transformerSetting_, vector<TransformAction>) };
