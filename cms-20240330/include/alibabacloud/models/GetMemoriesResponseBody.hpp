...
#ifndef ALIBABACLOUD_MODELS_GETMEMORIESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETMEMORIESRESPONSEBODY_HPP_
...
namespace Models
{
  class GetMemoriesResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetMemoriesResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(relations, relations_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
      DARABONBA_PTR_TO_JSON(results, results_);
    };
    friend void from_json(const Darabonba::Json& j, GetMemoriesResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(relations, relations_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
      DARABONBA_PTR_FROM_JSON(results, results_);
    };
    GetMemoriesResponseBody() = default ;
    GetMemoriesResponseBody(const GetMemoriesResponseBody &) = default ;
    GetMemoriesResponseBody(GetMemoriesResponseBody &&) = default ;
    GetMemoriesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetMemoriesResponseBody() = default ;
    GetMemoriesResponseBody& operator=(const GetMemoriesResponseBody &) = default ;
    GetMemoriesResponseBody& operator=(GetMemoriesResponseBody &&) = default ;
    ...
    inline const vector<GetMemoriesResponseBody::Relations> & getRelations() const { DARABONBA_PTR_GET_CONST(relations_, vector<GetMemoriesResponseBody::Relations>) };
    inline vector<GetMemoriesResponseBody::Relations> getRelations() { DARABONBA_PTR_GET(relations_, vector<GetMemoriesResponseBody::Relations>) };
    inline GetMemoriesResponseBody& setRelations(const vector<GetMemoriesResponseBody::Relations> & relations) { DARABONBA_PTR_SET_VALUE(relations_, relations) };
    inline GetMemoriesResponseBody& setRelations(vector<GetMemoriesResponseBody::Relations> && relations) { DARABONBA_PTR_SET_RVALUE(relations_, relations) };
    ...
    inline GetMemoriesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // results Field Functions 
    bool hasResults() const { return this->results_ != nullptr;};
    void deleteResults() { this->results_ = nullptr;};
    inline const vector<GetMemoriesResponseBody::Results> & getResults() const { DARABONBA_PTR_GET_CONST(results_, vector<GetMemoriesResponseBody::Results>) };
    inline vector<GetMemoriesResponseBody::Results> getResults() { DARABONBA_PTR_GET(results_, vector<GetMemoriesResponseBody::Results>) };
    inline GetMemoriesResponseBody& setResults(const vector<GetMemoriesResponseBody::Results> & results) { DARABONBA_PTR_SET_VALUE(results_, results) };
    inline GetMemoriesResponseBody& setResults(vector<GetMemoriesResponseBody::Results> && results) { DARABONBA_PTR_SET_RVALUE(results_, results) };


  protected:
    // Relations
    shared_ptr<vector<GetMemoriesResponseBody::Relations>> relations_ {};
    // Request ID.
    shared_ptr<string> requestId_ {};
    // Return value
    shared_ptr<vector<GetMemoriesResponseBody::Results>> results_ {};
  };
