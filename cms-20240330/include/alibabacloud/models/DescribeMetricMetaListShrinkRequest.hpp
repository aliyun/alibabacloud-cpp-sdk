...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aliyunLang_ == nullptr
        && this->category_ == nullptr && this->keywords_ == nullptr && this->labelsShrink_ == nullptr && this->metaFormat_ == nullptr && this->metricName_ == nullptr
    ...
    inline DescribeMetricMetaListShrinkRequest& setAliyunLang(string aliyunLang) { DARABONBA_PTR_SET_VALUE(aliyunLang_, aliyunLang) };
    ...
    inline DescribeMetricMetaListShrinkRequest& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
