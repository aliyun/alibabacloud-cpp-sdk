...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDigitalEmployeeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDigitalEmployeeResponseBody) };
    inline DeleteDigitalEmployeeResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDigitalEmployeeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDigitalEmployeeResponseBody> body_ {};
  };
