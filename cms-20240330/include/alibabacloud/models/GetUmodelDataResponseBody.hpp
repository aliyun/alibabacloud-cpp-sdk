...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Errors& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    virtual bool empty() const override { return this->errors_ == nullptr
        && this->links_ == nullptr && this->nodes_ == nullptr && this->requestId_ == nullptr && this->totalLinksCount_ == nullptr && this->totalNodesCount_ == nullptr; };
    // errors Field Functions 
    bool hasErrors() const { return this->errors_ != nullptr;};
    void deleteErrors() { this->errors_ = nullptr;};
    inline const vector<GetUmodelDataResponseBody::Errors> & getErrors() const { DARABONBA_PTR_GET_CONST(errors_, vector<GetUmodelDataResponseBody::Errors>) };
    inline vector<GetUmodelDataResponseBody::Errors> getErrors() { DARABONBA_PTR_GET(errors_, vector<GetUmodelDataResponseBody::Errors>) };
    inline GetUmodelDataResponseBody& setErrors(const vector<GetUmodelDataResponseBody::Errors> & errors) { DARABONBA_PTR_SET_VALUE(errors_, errors) };
    inline GetUmodelDataResponseBody& setErrors(vector<GetUmodelDataResponseBody::Errors> && errors) { DARABONBA_PTR_SET_RVALUE(errors_, errors) };


    // links Field Functions 
    bool hasLinks() const { return this->links_ != nullptr;};
    void deleteLinks() { this->links_ = nullptr;};
    inline const vector<Darabonba::Json> & getLinks() const { DARABONBA_PTR_GET_CONST(links_, vector<Darabonba::Json>) };
    inline vector<Darabonba::Json> getLinks() { DARABONBA_PTR_GET(links_, vector<Darabonba::Json>) };
    ...
    inline const vector<Darabonba::Json> & getNodes() const { DARABONBA_PTR_GET_CONST(nodes_, vector<Darabonba::Json>) };
    inline vector<Darabonba::Json> getNodes() { DARABONBA_PTR_GET(nodes_, vector<Darabonba::Json>) };
    ...
    inline int32_t getTotalLinksCount() const { DARABONBA_PTR_GET_DEFAULT(totalLinksCount_, 0) };
    ...
    inline int32_t getTotalNodesCount() const { DARABONBA_PTR_GET_DEFAULT(totalNodesCount_, 0) };
