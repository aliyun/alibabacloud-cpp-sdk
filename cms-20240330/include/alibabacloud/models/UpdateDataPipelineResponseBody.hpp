...
#ifndef ALIBABACLOUD_MODELS_UPDATEDATAPIPELINERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATEDATAPIPELINERESPONSEBODY_HPP_
...
namespace Models
{
  class UpdateDataPipelineResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateDataPipelineResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(pipeline, pipeline_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateDataPipelineResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(pipeline, pipeline_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    UpdateDataPipelineResponseBody() = default ;
    UpdateDataPipelineResponseBody(const UpdateDataPipelineResponseBody &) = default ;
    UpdateDataPipelineResponseBody(UpdateDataPipelineResponseBody &&) = default ;
    UpdateDataPipelineResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateDataPipelineResponseBody() = default ;
    UpdateDataPipelineResponseBody& operator=(const UpdateDataPipelineResponseBody &) = default ;
    UpdateDataPipelineResponseBody& operator=(UpdateDataPipelineResponseBody &&) = default ;
    ...
    inline const UpdateDataPipelineResponseBody::Pipeline & getPipeline() const { DARABONBA_PTR_GET_CONST(pipeline_, UpdateDataPipelineResponseBody::Pipeline) };
    inline UpdateDataPipelineResponseBody::Pipeline getPipeline() { DARABONBA_PTR_GET(pipeline_, UpdateDataPipelineResponseBody::Pipeline) };
    inline UpdateDataPipelineResponseBody& setPipeline(const UpdateDataPipelineResponseBody::Pipeline & pipeline) { DARABONBA_PTR_SET_VALUE(pipeline_, pipeline) };
    inline UpdateDataPipelineResponseBody& setPipeline(UpdateDataPipelineResponseBody::Pipeline && pipeline) { DARABONBA_PTR_SET_RVALUE(pipeline_, pipeline) };
    ...
    inline UpdateDataPipelineResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The data pipeline.
    shared_ptr<UpdateDataPipelineResponseBody::Pipeline> pipeline_ {};
    // The request ID.
