...
namespace Models
{
  ...
  public:
    ...
    inline Filter& setDisplayName(const DisplayNameFilter & displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    inline Filter& setDisplayName(DisplayNameFilter && displayName) { DARABONBA_PTR_SET_RVALUE(displayName_, displayName) };
    ...
    inline Filter& setEnabled(const EnabledFilter & enabled) { DARABONBA_PTR_SET_VALUE(enabled_, enabled) };
    inline Filter& setEnabled(EnabledFilter && enabled) { DARABONBA_PTR_SET_RVALUE(enabled_, enabled) };
    ...
    inline Filter& setLabels(const LabelsFilter & labels) { DARABONBA_PTR_SET_VALUE(labels_, labels) };
    inline Filter& setLabels(LabelsFilter && labels) { DARABONBA_PTR_SET_RVALUE(labels_, labels) };
    ...
    inline Filter& setStatus(const StatusFilter & status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    inline Filter& setStatus(StatusFilter && status) { DARABONBA_PTR_SET_RVALUE(status_, status) };
    ...
    inline Filter& setUuid(const UuidFilter & uuid) { DARABONBA_PTR_SET_VALUE(uuid_, uuid) };
    inline Filter& setUuid(UuidFilter && uuid) { DARABONBA_PTR_SET_RVALUE(uuid_, uuid) };
