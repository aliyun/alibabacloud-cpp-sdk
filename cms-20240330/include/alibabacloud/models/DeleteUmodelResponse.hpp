...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteUmodelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteUmodelResponseBody) };
    inline DeleteUmodelResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteUmodelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteUmodelResponseBody> body_ {};
  };
