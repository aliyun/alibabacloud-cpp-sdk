...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePrometheusVirtualInstanceResponseBodyInstance & instance() const { DARABONBA_PTR_GET_CONST(instance_, CreatePrometheusVirtualInstanceResponseBodyInstance) };
    inline CreatePrometheusVirtualInstanceResponseBodyInstance instance() { DARABONBA_PTR_GET(instance_, CreatePrometheusVirtualInstanceResponseBodyInstance) };
    inline CreatePrometheusVirtualInstanceResponseBody& setInstance(const CreatePrometheusVirtualInstanceResponseBodyInstance & instance) { DARABONBA_PTR_SET_VALUE(instance_, instance) };
    inline CreatePrometheusVirtualInstanceResponseBody& setInstance(CreatePrometheusVirtualInstanceResponseBodyInstance && instance) { DARABONBA_PTR_SET_RVALUE(instance_, instance) };
