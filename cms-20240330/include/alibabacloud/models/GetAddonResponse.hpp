...
namespace Models
{
  ...
  public:
    ...
    inline const GetAddonResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAddonResponseBody) };
    inline GetAddonResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAddonResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAddonResponseBody> body_ {};
  };
