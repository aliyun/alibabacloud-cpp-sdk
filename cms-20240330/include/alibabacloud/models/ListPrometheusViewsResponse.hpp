...
namespace Models
{
  ...
  public:
    ...
    inline const ListPrometheusViewsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPrometheusViewsResponseBody) };
    inline ListPrometheusViewsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPrometheusViewsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPrometheusViewsResponseBody> body_ {};
  };
