...
namespace Models
{
  ...
  public:
    ...
    inline const GetIntegrationPolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetIntegrationPolicyResponseBody) };
    inline GetIntegrationPolicyResponseBody body() { DARABONBA_PTR_GET(body_, GetIntegrationPolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetIntegrationPolicyResponseBody> body_ = nullptr;
  };
