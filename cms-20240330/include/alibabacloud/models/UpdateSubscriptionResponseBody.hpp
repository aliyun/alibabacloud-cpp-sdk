...
namespace Models
{
  ...
  public:
    ...
    inline UpdateSubscriptionResponseBody& setSubscriptionId(string subscriptionId) { DARABONBA_PTR_SET_VALUE(subscriptionId_, subscriptionId) };
