...
namespace Models
{
  ...
  public:
    ...
    inline ListTagResourcesRequest& setTag(const vector<Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline ListTagResourcesRequest& setTag(vector<Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
