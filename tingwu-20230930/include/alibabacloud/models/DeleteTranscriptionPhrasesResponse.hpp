...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTranscriptionPhrasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTranscriptionPhrasesResponseBody) };
    inline DeleteTranscriptionPhrasesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTranscriptionPhrasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTranscriptionPhrasesResponseBody> body_ {};
  };
