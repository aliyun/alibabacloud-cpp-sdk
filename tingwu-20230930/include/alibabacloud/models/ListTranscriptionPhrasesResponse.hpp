...
namespace Models
{
  ...
  public:
    ...
    inline const ListTranscriptionPhrasesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTranscriptionPhrasesResponseBody) };
    inline ListTranscriptionPhrasesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTranscriptionPhrasesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTranscriptionPhrasesResponseBody> body_ {};
  };
