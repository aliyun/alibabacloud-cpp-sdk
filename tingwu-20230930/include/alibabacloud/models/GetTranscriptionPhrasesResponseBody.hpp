...
namespace Models
{
  ...
  public:
    ...
    inline const GetTranscriptionPhrasesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetTranscriptionPhrasesResponseBodyData) };
    inline GetTranscriptionPhrasesResponseBodyData data() { DARABONBA_PTR_GET(data_, GetTranscriptionPhrasesResponseBodyData) };
    inline GetTranscriptionPhrasesResponseBody& setData(const GetTranscriptionPhrasesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetTranscriptionPhrasesResponseBody& setData(GetTranscriptionPhrasesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetTranscriptionPhrasesResponseBodyData> data_ = nullptr;
