...
namespace Models
{
  ...
  public:
    ...
    inline const ListTranscriptionPhrasesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListTranscriptionPhrasesResponseBodyData) };
    inline ListTranscriptionPhrasesResponseBodyData data() { DARABONBA_PTR_GET(data_, ListTranscriptionPhrasesResponseBodyData) };
    inline ListTranscriptionPhrasesResponseBody& setData(const ListTranscriptionPhrasesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListTranscriptionPhrasesResponseBody& setData(ListTranscriptionPhrasesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListTranscriptionPhrasesResponseBodyData> data_ = nullptr;
