...
namespace Models
{
  ...
  public:
    ...
    inline const GetTaskInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTaskInfoResponseBody) };
    inline GetTaskInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTaskInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTaskInfoResponseBody> body_ {};
  };
