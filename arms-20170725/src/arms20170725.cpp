...
#include <alibabacloud/arms20170725.hpp>
...
using namespace Alibabacloud_ARMS20170725;

Alibabacloud_ARMS20170725::Client::Client(const shared_ptr<Alibabacloud_OpenApi::Config>& config) : Alibabacloud_OpenApi::Client(config) {
...
string Alibabacloud_ARMS20170725::Client::getEndpoint(shared_ptr<string> productId,
...
ARMSQueryDataSetResponse Alibabacloud_ARMS20170725::Client::aRMSQueryDataSetWithOptions(shared_ptr<ARMSQueryDataSetRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
...
ARMSQueryDataSetResponse Alibabacloud_ARMS20170725::Client::aRMSQueryDataSet(shared_ptr<ARMSQueryDataSetRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
  return aRMSQueryDataSetWithOptions(request, runtime);
}

WhereInDimQueryResponse Alibabacloud_ARMS20170725::Client::whereInDimQueryWithOptions(shared_ptr<WhereInDimQueryRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<long>(request->datasetId)) {
    query->insert(pair<string, long>("DatasetId", *request->datasetId));
...
WhereInDimQueryResponse Alibabacloud_ARMS20170725::Client::whereInDimQuery(shared_ptr<WhereInDimQueryRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
