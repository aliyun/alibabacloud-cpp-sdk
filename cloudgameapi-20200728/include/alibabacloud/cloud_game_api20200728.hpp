...
public:
  ...
  shared_ptr<long> quotaSlots{};
  shared_ptr<string> reginName{};
  shared_ptr<long> usedSlots{};
  shared_ptr<long> userLevel{};
  ...
  map<string, boost::any> toMap() override {
    ...
    if (quotaSlots) {
      res["QuotaSlots"] = boost::any(*quotaSlots);
    }
    if (reginName) {
      res["ReginName"] = boost::any(*reginName);
    }
    if (usedSlots) {
      res["UsedSlots"] = boost::any(*usedSlots);
    }
    if (userLevel) {
      res["UserLevel"] = boost::any(*userLevel);
    }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("QuotaSlots") != m.end() && !m["QuotaSlots"].empty()) {
      quotaSlots = make_shared<long>(boost::any_cast<long>(m["QuotaSlots"]));
    }
    if (m.find("ReginName") != m.end() && !m["ReginName"].empty()) {
      reginName = make_shared<string>(boost::any_cast<string>(m["ReginName"]));
    }
    if (m.find("UsedSlots") != m.end() && !m["UsedSlots"].empty()) {
      usedSlots = make_shared<long>(boost::any_cast<long>(m["UsedSlots"]));
    }
    if (m.find("UserLevel") != m.end() && !m["UserLevel"].empty()) {
      userLevel = make_shared<long>(boost::any_cast<long>(m["UserLevel"]));
    }
...
public:
  shared_ptr<long> availableTotal{};
  shared_ptr<string> gameId{};
  shared_ptr<vector<GetGameStockResponseBodyInstanceStockList>> instanceStockList{};
  shared_ptr<string> message{};
  shared_ptr<long> quotaTotal{};
  shared_ptr<string> requestId{};
  shared_ptr<long> usedTotal{};
  ...
  map<string, boost::any> toMap() override {
    map<string, boost::any> res;
    if (availableTotal) {
      res["AvailableTotal"] = boost::any(*availableTotal);
    }
    if (gameId) {
      res["GameId"] = boost::any(*gameId);
    }
    ...
    if (quotaTotal) {
      res["QuotaTotal"] = boost::any(*quotaTotal);
    }
    if (requestId) {
      res["RequestId"] = boost::any(*requestId);
    }
    if (usedTotal) {
      res["UsedTotal"] = boost::any(*usedTotal);
    }
    return res;
  }

  void fromMap(map<string, boost::any> m) override {
    if (m.find("AvailableTotal") != m.end() && !m["AvailableTotal"].empty()) {
      availableTotal = make_shared<long>(boost::any_cast<long>(m["AvailableTotal"]));
    }
    if (m.find("GameId") != m.end() && !m["GameId"].empty()) {
      gameId = make_shared<string>(boost::any_cast<string>(m["GameId"]));
    }
    ...
    if (m.find("QuotaTotal") != m.end() && !m["QuotaTotal"].empty()) {
      quotaTotal = make_shared<long>(boost::any_cast<long>(m["QuotaTotal"]));
    }
    if (m.find("RequestId") != m.end() && !m["RequestId"].empty()) {
      requestId = make_shared<string>(boost::any_cast<string>(m["RequestId"]));
    }
    if (m.find("UsedTotal") != m.end() && !m["UsedTotal"].empty()) {
      usedTotal = make_shared<long>(boost::any_cast<long>(m["UsedTotal"]));
    }
  }
...
class GetQueuingSizeRequest : public Darabonba::Model {
public:
  shared_ptr<string> gameId{};
  shared_ptr<string> projectId{};
  shared_ptr<long> userLevel{};

  GetQueuingSizeRequest() {}

  explicit GetQueuingSizeRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~GetQueuingSizeRequest() = default;
};
class GetQueuingSizeResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> message{};
  shared_ptr<string> requestId{};
  shared_ptr<long> size{};

  GetQueuingSizeResponseBody() {}

  explicit GetQueuingSizeResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~GetQueuingSizeResponseBody() = default;
};
class GetQueuingSizeResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<GetQueuingSizeResponseBody> body{};

  GetQueuingSizeResponse() {}

  explicit GetQueuingSizeResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        GetQueuingSizeResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<GetQueuingSizeResponseBody>(model1);
      }
    }
  }


  virtual ~GetQueuingSizeResponse() = default;
};
...
class QuerySessionStatusRequest : public Darabonba::Model {
public:
  shared_ptr<string> accessKey{};
  shared_ptr<string> gameSession{};

  QuerySessionStatusRequest() {}

  explicit QuerySessionStatusRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~QuerySessionStatusRequest() = default;
};
class QuerySessionStatusResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> accountId{};
  shared_ptr<string> code{};
  shared_ptr<long> dispatchTime{};
  shared_ptr<string> gameId{};
  shared_ptr<string> gameSession{};
  shared_ptr<string> message{};
  shared_ptr<long> playTime{};
  shared_ptr<string> projectId{};
  shared_ptr<string> regionId{};
  shared_ptr<string> requestId{};
  shared_ptr<string> status{};
  ...
  QuerySessionStatusResponseBody() {}

  explicit QuerySessionStatusResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (dispatchTime) {
      res["DispatchTime"] = boost::any(*dispatchTime);
    }
    if (gameId) {
      res["GameId"] = boost::any(*gameId);
    }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("DispatchTime") != m.end() && !m["DispatchTime"].empty()) {
      dispatchTime = make_shared<long>(boost::any_cast<long>(m["DispatchTime"]));
    }
    if (m.find("GameId") != m.end() && !m["GameId"].empty()) {
      gameId = make_shared<string>(boost::any_cast<string>(m["GameId"]));
    }
    ...
    if (m.find("PlayTime") != m.end() && !m["PlayTime"].empty()) {
      playTime = make_shared<long>(boost::any_cast<long>(m["PlayTime"]));
    }
    if (m.find("ProjectId") != m.end() && !m["ProjectId"].empty()) {
      projectId = make_shared<string>(boost::any_cast<string>(m["ProjectId"]));
    }
  ...
  virtual ~QuerySessionStatusResponseBody() = default;
};
class QuerySessionStatusResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<QuerySessionStatusResponseBody> body{};

  QuerySessionStatusResponse() {}

  explicit QuerySessionStatusResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        QuerySessionStatusResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<QuerySessionStatusResponseBody>(model1);
      }
    }
  }


  virtual ~QuerySessionStatusResponse() = default;
};
...
public:
  ...
  StartGameLiveRequest() {}

  explicit StartGameLiveRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  StartGameLiveResponseBody() {}

  explicit StartGameLiveResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~StartGameLiveResponseBody() = default;
};
class StartGameLiveResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<StartGameLiveResponseBody> body{};

  StartGameLiveResponse() {}

  explicit StartGameLiveResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        StartGameLiveResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<StartGameLiveResponseBody>(model1);
      }
    }
  }


  virtual ~StartGameLiveResponse() = default;
};
class StopGameLiveRequest : public Darabonba::Model {
public:
  shared_ptr<string> gameSession{};

  StopGameLiveRequest() {}

  explicit StopGameLiveRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~StopGameLiveRequest() = default;
};
class StopGameLiveResponseBody : public Darabonba::Model {
public:
  shared_ptr<bool> data{};
  shared_ptr<string> requestId{};

  StopGameLiveResponseBody() {}

  explicit StopGameLiveResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~StopGameLiveResponseBody() = default;
};
class StopGameLiveResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<StopGameLiveResponseBody> body{};

  StopGameLiveResponse() {}

  explicit StopGameLiveResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        StopGameLiveResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<StopGameLiveResponseBody>(model1);
      }
    }
  }


  virtual ~StopGameLiveResponse() = default;
};
...
public:
  ...
  GetQueuingSizeResponse getQueuingSizeWithOptions(shared_ptr<GetQueuingSizeRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  GetQueuingSizeResponse getQueuingSize(shared_ptr<GetQueuingSizeRequest> request);
  ...
  QuerySessionStatusResponse querySessionStatusWithOptions(shared_ptr<QuerySessionStatusRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  QuerySessionStatusResponse querySessionStatus(shared_ptr<QuerySessionStatusRequest> request);
