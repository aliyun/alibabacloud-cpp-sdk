...
#ifndef ALIBABACLOUD_MODELS_DESCRIBESERVICEMESHADDITIONALSTATUSRESPONSEBODYCLUSTERSTATUSPILOTLOADBALANCERSTATUS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBESERVICEMESHADDITIONALSTATUSRESPONSEBODYCLUSTERSTATUSPILOTLOADBALANCERSTATUS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus& obj) { 
    ...
    DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus() = default ;
    DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus(const DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus &) = default ;
    DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus(DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus &&) = default ;
    DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus() = default ;
    DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus& operator=(const DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus &) = default ;
    DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus& operator=(DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus &&) = default ;
    ...
    inline DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus& setLocked(bool locked) { DARABONBA_PTR_SET_VALUE(locked_, locked) };
    ...
    inline DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus& setPayType(string payType) { DARABONBA_PTR_SET_VALUE(payType_, payType) };
    ...
    inline DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus& setReused(bool reused) { DARABONBA_PTR_SET_VALUE(reused_, reused) };
    ...
    inline DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus& setSLBBackEndServerNumStatus(string SLBBackEndServerNumStatus) { DARABONBA_PTR_SET_VALUE(SLBBackEndServerNumStatus_, SLBBackEndServerNumStatus) };
    ...
    inline DescribeServiceMeshAdditionalStatusResponseBodyClusterStatusPilotLoadBalancerStatus& setSLBExistStatus(string SLBExistStatus) { DARABONBA_PTR_SET_VALUE(SLBExistStatus_, SLBExistStatus) };
