...
#ifndef ALIBABACLOUD_MODELS_CREATEWAYPOINTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEWAYPOINTREQUEST_HPP_
...
namespace Models
{
  class CreateWaypointRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateWaypointRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateWaypointRequest& obj) { 
    ...
    CreateWaypointRequest() = default ;
    CreateWaypointRequest(const CreateWaypointRequest &) = default ;
    CreateWaypointRequest(CreateWaypointRequest &&) = default ;
    CreateWaypointRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateWaypointRequest() = default ;
    CreateWaypointRequest& operator=(const CreateWaypointRequest &) = default ;
    CreateWaypointRequest& operator=(CreateWaypointRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->clusterId_ == nullptr
        ...
        && return this->limitCPU_ == nullptr && return this->limitMemory_ == nullptr && return this->namespace_ == nullptr && return this->preferECI_ == nullptr && return this->replicas_ == nullptr
        && return this->requestCPU_ == nullptr && return this->requestMemory_ == nullptr && return this->serviceAccount_ == nullptr && return this->serviceMeshId_ == nullptr; };
    // clusterId Field Functions 
    bool hasClusterId() const { return this->clusterId_ != nullptr;};
    void deleteClusterId() { this->clusterId_ = nullptr;};
    inline string clusterId() const { DARABONBA_PTR_GET_DEFAULT(clusterId_, "") };
    inline CreateWaypointRequest& setClusterId(string clusterId) { DARABONBA_PTR_SET_VALUE(clusterId_, clusterId) };
    ...
    inline CreateWaypointRequest& setHPAEnabled(bool HPAEnabled) { DARABONBA_PTR_SET_VALUE(HPAEnabled_, HPAEnabled) };
    ...
    inline CreateWaypointRequest& setHPAMaxReplicas(int32_t HPAMaxReplicas) { DARABONBA_PTR_SET_VALUE(HPAMaxReplicas_, HPAMaxReplicas) };
    ...
    inline CreateWaypointRequest& setHPAMinReplicas(int32_t HPAMinReplicas) { DARABONBA_PTR_SET_VALUE(HPAMinReplicas_, HPAMinReplicas) };
    ...
    inline CreateWaypointRequest& setHPATargetCPU(int32_t HPATargetCPU) { DARABONBA_PTR_SET_VALUE(HPATargetCPU_, HPATargetCPU) };
    ...
    inline CreateWaypointRequest& setHPATargetMemory(int32_t HPATargetMemory) { DARABONBA_PTR_SET_VALUE(HPATargetMemory_, HPATargetMemory) };
    ...
    inline CreateWaypointRequest& setLimitCPU(string limitCPU) { DARABONBA_PTR_SET_VALUE(limitCPU_, limitCPU) };
    ...
    inline CreateWaypointRequest& setLimitMemory(string limitMemory) { DARABONBA_PTR_SET_VALUE(limitMemory_, limitMemory) };
    ...
    inline CreateWaypointRequest& setNamespace(string _namespace) { DARABONBA_PTR_SET_VALUE(namespace_, _namespace) };
    ...
    inline CreateWaypointRequest& setPreferECI(bool preferECI) { DARABONBA_PTR_SET_VALUE(preferECI_, preferECI) };
    ...
    inline CreateWaypointRequest& setReplicas(int32_t replicas) { DARABONBA_PTR_SET_VALUE(replicas_, replicas) };
    ...
    inline CreateWaypointRequest& setRequestCPU(string requestCPU) { DARABONBA_PTR_SET_VALUE(requestCPU_, requestCPU) };
    ...
    inline CreateWaypointRequest& setRequestMemory(string requestMemory) { DARABONBA_PTR_SET_VALUE(requestMemory_, requestMemory) };
    ...
    inline CreateWaypointRequest& setServiceAccount(string serviceAccount) { DARABONBA_PTR_SET_VALUE(serviceAccount_, serviceAccount) };
    ...
    inline CreateWaypointRequest& setServiceMeshId(string serviceMeshId) { DARABONBA_PTR_SET_VALUE(serviceMeshId_, serviceMeshId) };
