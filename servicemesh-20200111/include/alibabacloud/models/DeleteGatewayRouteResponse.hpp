...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGatewayRouteResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteGatewayRouteResponseBody) };
    inline DeleteGatewayRouteResponseBody body() { DARABONBA_PTR_GET(body_, DeleteGatewayRouteResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteGatewayRouteResponseBody> body_ = nullptr;
  };
