...
#ifndef ALIBABACLOUD_MODELS_UPDATENAMESPACESCOPESIDECARCONFIGSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATENAMESPACESCOPESIDECARCONFIGSHRINKREQUEST_HPP_
...
namespace Models
{
  class UpdateNamespaceScopeSidecarConfigShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateNamespaceScopeSidecarConfigShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(ScaledSidecarResource, scaledSidecarResourceShrink_);
    ...
    friend void from_json(const Darabonba::Json& j, UpdateNamespaceScopeSidecarConfigShrinkRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(ScaledSidecarResource, scaledSidecarResourceShrink_);
    ...
    UpdateNamespaceScopeSidecarConfigShrinkRequest() = default ;
    UpdateNamespaceScopeSidecarConfigShrinkRequest(const UpdateNamespaceScopeSidecarConfigShrinkRequest &) = default ;
    UpdateNamespaceScopeSidecarConfigShrinkRequest(UpdateNamespaceScopeSidecarConfigShrinkRequest &&) = default ;
    UpdateNamespaceScopeSidecarConfigShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateNamespaceScopeSidecarConfigShrinkRequest() = default ;
    UpdateNamespaceScopeSidecarConfigShrinkRequest& operator=(const UpdateNamespaceScopeSidecarConfigShrinkRequest &) = default ;
    UpdateNamespaceScopeSidecarConfigShrinkRequest& operator=(UpdateNamespaceScopeSidecarConfigShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->concurrency_ == nullptr
        ...
        && return this->SMCEnabled_ == nullptr && return this->scaledSidecarResourceShrink_ == nullptr && return this->serviceMeshId_ == nullptr && return this->sidecarProxyAckSloCPUResourceLimit_ == nullptr && return this->sidecarProxyAckSloCPUResourceRequest_ == nullptr
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setConcurrency(int32_t concurrency) { DARABONBA_PTR_SET_VALUE(concurrency_, concurrency) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setEnableCoreDump(bool enableCoreDump) { DARABONBA_PTR_SET_VALUE(enableCoreDump_, enableCoreDump) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setExcludeIPRanges(string excludeIPRanges) { DARABONBA_PTR_SET_VALUE(excludeIPRanges_, excludeIPRanges) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setExcludeInboundPorts(string excludeInboundPorts) { DARABONBA_PTR_SET_VALUE(excludeInboundPorts_, excludeInboundPorts) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setExcludeOutboundPorts(string excludeOutboundPorts) { DARABONBA_PTR_SET_VALUE(excludeOutboundPorts_, excludeOutboundPorts) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setHoldApplicationUntilProxyStarts(bool holdApplicationUntilProxyStarts) { DARABONBA_PTR_SET_VALUE(holdApplicationUntilProxyStarts_, holdApplicationUntilProxyStarts) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setIncludeIPRanges(string includeIPRanges) { DARABONBA_PTR_SET_VALUE(includeIPRanges_, includeIPRanges) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setIncludeInboundPorts(string includeInboundPorts) { DARABONBA_PTR_SET_VALUE(includeInboundPorts_, includeInboundPorts) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setIncludeOutboundPorts(string includeOutboundPorts) { DARABONBA_PTR_SET_VALUE(includeOutboundPorts_, includeOutboundPorts) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setInterceptionMode(string interceptionMode) { DARABONBA_PTR_SET_VALUE(interceptionMode_, interceptionMode) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setIstioDNSProxyEnabled(bool istioDNSProxyEnabled) { DARABONBA_PTR_SET_VALUE(istioDNSProxyEnabled_, istioDNSProxyEnabled) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setLifecycle(string lifecycle) { DARABONBA_PTR_SET_VALUE(lifecycle_, lifecycle) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setLogLevel(string logLevel) { DARABONBA_PTR_SET_VALUE(logLevel_, logLevel) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setNamespace(string _namespace) { DARABONBA_PTR_SET_VALUE(namespace_, _namespace) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setPostStart(string postStart) { DARABONBA_PTR_SET_VALUE(postStart_, postStart) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setPreStop(string preStop) { DARABONBA_PTR_SET_VALUE(preStop_, preStop) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setPrivileged(bool privileged) { DARABONBA_PTR_SET_VALUE(privileged_, privileged) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setProxyInitAckSloCPUResourceLimit(string proxyInitAckSloCPUResourceLimit) { DARABONBA_PTR_SET_VALUE(proxyInitAckSloCPUResourceLimit_, proxyInitAckSloCPUResourceLimit) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setProxyInitAckSloCPUResourceRequest(string proxyInitAckSloCPUResourceRequest) { DARABONBA_PTR_SET_VALUE(proxyInitAckSloCPUResourceRequest_, proxyInitAckSloCPUResourceRequest) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setProxyInitAckSloMemoryResourceLimit(string proxyInitAckSloMemoryResourceLimit) { DARABONBA_PTR_SET_VALUE(proxyInitAckSloMemoryResourceLimit_, proxyInitAckSloMemoryResourceLimit) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setProxyInitAckSloMemoryResourceRequest(string proxyInitAckSloMemoryResourceRequest) { DARABONBA_PTR_SET_VALUE(proxyInitAckSloMemoryResourceRequest_, proxyInitAckSloMemoryResourceRequest) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setProxyInitCPUResourceLimit(string proxyInitCPUResourceLimit) { DARABONBA_PTR_SET_VALUE(proxyInitCPUResourceLimit_, proxyInitCPUResourceLimit) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setProxyInitCPUResourceRequest(string proxyInitCPUResourceRequest) { DARABONBA_PTR_SET_VALUE(proxyInitCPUResourceRequest_, proxyInitCPUResourceRequest) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setProxyInitMemoryResourceLimit(string proxyInitMemoryResourceLimit) { DARABONBA_PTR_SET_VALUE(proxyInitMemoryResourceLimit_, proxyInitMemoryResourceLimit) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setProxyInitMemoryResourceRequest(string proxyInitMemoryResourceRequest) { DARABONBA_PTR_SET_VALUE(proxyInitMemoryResourceRequest_, proxyInitMemoryResourceRequest) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setProxyMetadata(string proxyMetadata) { DARABONBA_PTR_SET_VALUE(proxyMetadata_, proxyMetadata) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setProxyStatsMatcher(string proxyStatsMatcher) { DARABONBA_PTR_SET_VALUE(proxyStatsMatcher_, proxyStatsMatcher) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setReadinessFailureThreshold(int32_t readinessFailureThreshold) { DARABONBA_PTR_SET_VALUE(readinessFailureThreshold_, readinessFailureThreshold) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setReadinessInitialDelaySeconds(int32_t readinessInitialDelaySeconds) { DARABONBA_PTR_SET_VALUE(readinessInitialDelaySeconds_, readinessInitialDelaySeconds) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setReadinessPeriodSeconds(int32_t readinessPeriodSeconds) { DARABONBA_PTR_SET_VALUE(readinessPeriodSeconds_, readinessPeriodSeconds) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setRuntimeValues(string runtimeValues) { DARABONBA_PTR_SET_VALUE(runtimeValues_, runtimeValues) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setSMCEnabled(bool SMCEnabled) { DARABONBA_PTR_SET_VALUE(SMCEnabled_, SMCEnabled) };


    // scaledSidecarResourceShrink Field Functions 
    bool hasScaledSidecarResourceShrink() const { return this->scaledSidecarResourceShrink_ != nullptr;};
    void deleteScaledSidecarResourceShrink() { this->scaledSidecarResourceShrink_ = nullptr;};
    inline string scaledSidecarResourceShrink() const { DARABONBA_PTR_GET_DEFAULT(scaledSidecarResourceShrink_, "") };
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setScaledSidecarResourceShrink(string scaledSidecarResourceShrink) { DARABONBA_PTR_SET_VALUE(scaledSidecarResourceShrink_, scaledSidecarResourceShrink) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setServiceMeshId(string serviceMeshId) { DARABONBA_PTR_SET_VALUE(serviceMeshId_, serviceMeshId) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setSidecarProxyAckSloCPUResourceLimit(string sidecarProxyAckSloCPUResourceLimit) { DARABONBA_PTR_SET_VALUE(sidecarProxyAckSloCPUResourceLimit_, sidecarProxyAckSloCPUResourceLimit) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setSidecarProxyAckSloCPUResourceRequest(string sidecarProxyAckSloCPUResourceRequest) { DARABONBA_PTR_SET_VALUE(sidecarProxyAckSloCPUResourceRequest_, sidecarProxyAckSloCPUResourceRequest) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setSidecarProxyAckSloMemoryResourceLimit(string sidecarProxyAckSloMemoryResourceLimit) { DARABONBA_PTR_SET_VALUE(sidecarProxyAckSloMemoryResourceLimit_, sidecarProxyAckSloMemoryResourceLimit) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setSidecarProxyAckSloMemoryResourceRequest(string sidecarProxyAckSloMemoryResourceRequest) { DARABONBA_PTR_SET_VALUE(sidecarProxyAckSloMemoryResourceRequest_, sidecarProxyAckSloMemoryResourceRequest) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setSidecarProxyCPUResourceLimit(string sidecarProxyCPUResourceLimit) { DARABONBA_PTR_SET_VALUE(sidecarProxyCPUResourceLimit_, sidecarProxyCPUResourceLimit) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setSidecarProxyCPUResourceRequest(string sidecarProxyCPUResourceRequest) { DARABONBA_PTR_SET_VALUE(sidecarProxyCPUResourceRequest_, sidecarProxyCPUResourceRequest) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setSidecarProxyMemoryResourceLimit(string sidecarProxyMemoryResourceLimit) { DARABONBA_PTR_SET_VALUE(sidecarProxyMemoryResourceLimit_, sidecarProxyMemoryResourceLimit) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setSidecarProxyMemoryResourceRequest(string sidecarProxyMemoryResourceRequest) { DARABONBA_PTR_SET_VALUE(sidecarProxyMemoryResourceRequest_, sidecarProxyMemoryResourceRequest) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setTerminationDrainDuration(string terminationDrainDuration) { DARABONBA_PTR_SET_VALUE(terminationDrainDuration_, terminationDrainDuration) };
    ...
    inline UpdateNamespaceScopeSidecarConfigShrinkRequest& setTracing(string tracing) { DARABONBA_PTR_SET_VALUE(tracing_, tracing) };
  ...
  protected:
    ...
    std::shared_ptr<string> scaledSidecarResourceShrink_ = nullptr;
