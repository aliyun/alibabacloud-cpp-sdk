...
#ifndef ALIBABACLOUD_MODELS_UPDATESWIMLANEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATESWIMLANEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateSwimLaneRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateSwimLaneRequest& obj) { 
    ...
    UpdateSwimLaneRequest() = default ;
    UpdateSwimLaneRequest(const UpdateSwimLaneRequest &) = default ;
    UpdateSwimLaneRequest(UpdateSwimLaneRequest &&) = default ;
    UpdateSwimLaneRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateSwimLaneRequest() = default ;
    UpdateSwimLaneRequest& operator=(const UpdateSwimLaneRequest &) = default ;
    UpdateSwimLaneRequest& operator=(UpdateSwimLaneRequest &&) = default ;
    ...
    inline UpdateSwimLaneRequest& setGroupName(string groupName) { DARABONBA_PTR_SET_VALUE(groupName_, groupName) };
    ...
    inline UpdateSwimLaneRequest& setLabelSelectorKey(string labelSelectorKey) { DARABONBA_PTR_SET_VALUE(labelSelectorKey_, labelSelectorKey) };
    ...
    inline UpdateSwimLaneRequest& setLabelSelectorValue(string labelSelectorValue) { DARABONBA_PTR_SET_VALUE(labelSelectorValue_, labelSelectorValue) };
    ...
    inline UpdateSwimLaneRequest& setServiceMeshId(string serviceMeshId) { DARABONBA_PTR_SET_VALUE(serviceMeshId_, serviceMeshId) };
    ...
    inline UpdateSwimLaneRequest& setServicesList(string servicesList) { DARABONBA_PTR_SET_VALUE(servicesList_, servicesList) };
    ...
    inline UpdateSwimLaneRequest& setSwimLaneName(string swimLaneName) { DARABONBA_PTR_SET_VALUE(swimLaneName_, swimLaneName) };
