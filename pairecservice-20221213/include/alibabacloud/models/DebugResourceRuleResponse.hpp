...
namespace Models
{
  ...
  public:
    ...
    inline const DebugResourceRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DebugResourceRuleResponseBody) };
    inline DebugResourceRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DebugResourceRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DebugResourceRuleResponseBody> body_ {};
  };
