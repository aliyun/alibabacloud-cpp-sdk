...
#ifndef ALIBABACLOUD_MODELS_GETSAMPLECONSISTENCYJOBRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETSAMPLECONSISTENCYJOBRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSampleConsistencyJobResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSampleConsistencyJobResponseBody& obj) { 
    ...
    GetSampleConsistencyJobResponseBody() = default ;
    GetSampleConsistencyJobResponseBody(const GetSampleConsistencyJobResponseBody &) = default ;
    GetSampleConsistencyJobResponseBody(GetSampleConsistencyJobResponseBody &&) = default ;
    GetSampleConsistencyJobResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSampleConsistencyJobResponseBody() = default ;
    GetSampleConsistencyJobResponseBody& operator=(const GetSampleConsistencyJobResponseBody &) = default ;
    GetSampleConsistencyJobResponseBody& operator=(GetSampleConsistencyJobResponseBody &&) = default ;
    ...
    virtual bool empty() const override { return this->config_ == nullptr
        ...
        && this->partitionFieldFormat_ == nullptr && this->requestId_ == nullptr && this->requestIdField_ == nullptr && this->sampleConsistencyJobId_ == nullptr && this->sampleRate_ == nullptr
        && this->sampleTableName_ == nullptr && this->sceneId_ == nullptr && this->sceneName_ == nullptr && this->startTime_ == nullptr && this->status_ == nullptr
        && this->userIdField_ == nullptr; };
    // config Field Functions 
    bool hasConfig() const { return this->config_ != nullptr;};
    void deleteConfig() { this->config_ = nullptr;};
    inline string getConfig() const { DARABONBA_PTR_GET_DEFAULT(config_, "") };
    inline GetSampleConsistencyJobResponseBody& setConfig(string config) { DARABONBA_PTR_SET_VALUE(config_, config) };
    ...
    inline GetSampleConsistencyJobResponseBody& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline GetSampleConsistencyJobResponseBody& setEasModelServiceName(string easModelServiceName) { DARABONBA_PTR_SET_VALUE(easModelServiceName_, easModelServiceName) };
    ...
    inline GetSampleConsistencyJobResponseBody& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline GetSampleConsistencyJobResponseBody& setFeatureSaveResourceId(string featureSaveResourceId) { DARABONBA_PTR_SET_VALUE(featureSaveResourceId_, featureSaveResourceId) };
    ...
    inline GetSampleConsistencyJobResponseBody& setGmtCreateTime(string gmtCreateTime) { DARABONBA_PTR_SET_VALUE(gmtCreateTime_, gmtCreateTime) };
    ...
    inline GetSampleConsistencyJobResponseBody& setGmtModifiedTime(string gmtModifiedTime) { DARABONBA_PTR_SET_VALUE(gmtModifiedTime_, gmtModifiedTime) };
    ...
    inline GetSampleConsistencyJobResponseBody& setItemIdField(string itemIdField) { DARABONBA_PTR_SET_VALUE(itemIdField_, itemIdField) };
    ...
    inline GetSampleConsistencyJobResponseBody& setLogs(string logs) { DARABONBA_PTR_SET_VALUE(logs_, logs) };
    ...
    inline GetSampleConsistencyJobResponseBody& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetSampleConsistencyJobResponseBody& setPartitionField(string partitionField) { DARABONBA_PTR_SET_VALUE(partitionField_, partitionField) };
    ...
    inline GetSampleConsistencyJobResponseBody& setPartitionFieldFormat(string partitionFieldFormat) { DARABONBA_PTR_SET_VALUE(partitionFieldFormat_, partitionFieldFormat) };
    ...
    inline GetSampleConsistencyJobResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetSampleConsistencyJobResponseBody& setRequestIdField(string requestIdField) { DARABONBA_PTR_SET_VALUE(requestIdField_, requestIdField) };
    ...
    inline GetSampleConsistencyJobResponseBody& setSampleConsistencyJobId(string sampleConsistencyJobId) { DARABONBA_PTR_SET_VALUE(sampleConsistencyJobId_, sampleConsistencyJobId) };
    ...
    inline GetSampleConsistencyJobResponseBody& setSampleRate(string sampleRate) { DARABONBA_PTR_SET_VALUE(sampleRate_, sampleRate) };
    ...
    inline GetSampleConsistencyJobResponseBody& setSampleTableName(string sampleTableName) { DARABONBA_PTR_SET_VALUE(sampleTableName_, sampleTableName) };
    ...
    inline GetSampleConsistencyJobResponseBody& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
    ...
    inline GetSampleConsistencyJobResponseBody& setSceneName(string sceneName) { DARABONBA_PTR_SET_VALUE(sceneName_, sceneName) };
    ...
    inline GetSampleConsistencyJobResponseBody& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline GetSampleConsistencyJobResponseBody& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetSampleConsistencyJobResponseBody& setUserIdField(string userIdField) { DARABONBA_PTR_SET_VALUE(userIdField_, userIdField) };
