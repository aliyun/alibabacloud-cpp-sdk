...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->logId_ != nullptr
    ...
    inline string ossAddress() const { DARABONBA_PTR_GET_DEFAULT(ossAddress_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> ossAddress_ = nullptr;
