...
namespace Models
{
  ...
  public:
    ...
    inline const ListSubCrowdsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListSubCrowdsResponseBody) };
    inline ListSubCrowdsResponseBody body() { DARABONBA_PTR_GET(body_, ListSubCrowdsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListSubCrowdsResponseBody> body_ = nullptr;
  };
