...
namespace Models
{
  ...
  public:
    ...
    inline const GetTrafficControlTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTrafficControlTargetResponseBody) };
    inline GetTrafficControlTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTrafficControlTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTrafficControlTargetResponseBody> body_ {};
  };
