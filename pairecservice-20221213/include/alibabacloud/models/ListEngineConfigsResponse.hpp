...
namespace Models
{
  ...
  public:
    ...
    inline const ListEngineConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListEngineConfigsResponseBody) };
    inline ListEngineConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListEngineConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListEngineConfigsResponseBody> body_ {};
  };
