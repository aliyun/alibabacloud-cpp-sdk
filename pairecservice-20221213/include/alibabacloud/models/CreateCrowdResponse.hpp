...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCrowdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCrowdResponseBody) };
    inline CreateCrowdResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCrowdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCrowdResponseBody> body_ {};
  };
