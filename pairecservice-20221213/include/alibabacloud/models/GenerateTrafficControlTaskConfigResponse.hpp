...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateTrafficControlTaskConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateTrafficControlTaskConfigResponseBody) };
    inline GenerateTrafficControlTaskConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateTrafficControlTaskConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateTrafficControlTaskConfigResponseBody> body_ {};
  };
