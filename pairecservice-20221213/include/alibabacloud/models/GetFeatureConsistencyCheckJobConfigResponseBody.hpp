...
#ifndef ALIBABACLOUD_MODELS_GETFEATURECONSISTENCYCHECKJOBCONFIGRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETFEATURECONSISTENCYCHECKJOBCONFIGRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetFeatureConsistencyCheckJobConfigResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetFeatureConsistencyCheckJobConfigResponseBody& obj) { 
    ...
    GetFeatureConsistencyCheckJobConfigResponseBody() = default ;
    GetFeatureConsistencyCheckJobConfigResponseBody(const GetFeatureConsistencyCheckJobConfigResponseBody &) = default ;
    GetFeatureConsistencyCheckJobConfigResponseBody(GetFeatureConsistencyCheckJobConfigResponseBody &&) = default ;
    GetFeatureConsistencyCheckJobConfigResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetFeatureConsistencyCheckJobConfigResponseBody() = default ;
    GetFeatureConsistencyCheckJobConfigResponseBody& operator=(const GetFeatureConsistencyCheckJobConfigResponseBody &) = default ;
    GetFeatureConsistencyCheckJobConfigResponseBody& operator=(GetFeatureConsistencyCheckJobConfigResponseBody &&) = default ;
    ...
    virtual bool empty() const override { this->compareFeature_ != nullptr
        ...
        && this->featureLandingResourceId_ != nullptr && this->featureLandingResourceUri_ != nullptr && this->featurePriority_ != nullptr && this->featureStoreItemId_ != nullptr && this->featureStoreModelId_ != nullptr
        && this->featureStoreProjectId_ != nullptr && this->featureStoreProjectName_ != nullptr && this->featureStoreSeqFeatureView_ != nullptr && this->featureStoreUserId_ != nullptr && this->fgJarVersion_ != nullptr
        && this->fgJsonFileName_ != nullptr && this->generateZip_ != nullptr && this->gmtCreateTime_ != nullptr && this->gmtModifiedTime_ != nullptr && this->itemIdField_ != nullptr
        && this->itemTable_ != nullptr && this->itemTablePartitionField_ != nullptr && this->itemTablePartitionFieldFormat_ != nullptr && this->latestJobGmtSamplingEndTime_ != nullptr && this->latestJobGmtSamplingStartTime_ != nullptr
        && this->latestJobId_ != nullptr && this->name_ != nullptr && this->ossBucket_ != nullptr && this->ossResourceId_ != nullptr && this->predictWorkerCount_ != nullptr
        && this->predictWorkerCpu_ != nullptr && this->predictWorkerMemory_ != nullptr && this->requestId_ != nullptr && this->resourceConfig_ != nullptr && this->sampleRate_ != nullptr
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setCompareFeature(bool compareFeature) { DARABONBA_PTR_SET_VALUE(compareFeature_, compareFeature) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setDatasetId(string datasetId) { DARABONBA_PTR_SET_VALUE(datasetId_, datasetId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setDatasetMountPath(string datasetMountPath) { DARABONBA_PTR_SET_VALUE(datasetMountPath_, datasetMountPath) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setDatasetName(string datasetName) { DARABONBA_PTR_SET_VALUE(datasetName_, datasetName) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setDatasetType(string datasetType) { DARABONBA_PTR_SET_VALUE(datasetType_, datasetType) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setDatasetUri(string datasetUri) { DARABONBA_PTR_SET_VALUE(datasetUri_, datasetUri) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setDefaultRoute(string defaultRoute) { DARABONBA_PTR_SET_VALUE(defaultRoute_, defaultRoute) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setEasServiceName(string easServiceName) { DARABONBA_PTR_SET_VALUE(easServiceName_, easServiceName) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setEasyRecPackagePath(string easyRecPackagePath) { DARABONBA_PTR_SET_VALUE(easyRecPackagePath_, easyRecPackagePath) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setEasyRecVersion(string easyRecVersion) { DARABONBA_PTR_SET_VALUE(easyRecVersion_, easyRecVersion) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFeatureDisplayExclude(string featureDisplayExclude) { DARABONBA_PTR_SET_VALUE(featureDisplayExclude_, featureDisplayExclude) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFeatureLandingResourceId(string featureLandingResourceId) { DARABONBA_PTR_SET_VALUE(featureLandingResourceId_, featureLandingResourceId) };
    ...
    inline string featureLandingResourceUri() const { DARABONBA_PTR_GET_DEFAULT(featureLandingResourceUri_, "") };
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFeatureLandingResourceUri(string featureLandingResourceUri) { DARABONBA_PTR_SET_VALUE(featureLandingResourceUri_, featureLandingResourceUri) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFeaturePriority(string featurePriority) { DARABONBA_PTR_SET_VALUE(featurePriority_, featurePriority) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFeatureStoreItemId(string featureStoreItemId) { DARABONBA_PTR_SET_VALUE(featureStoreItemId_, featureStoreItemId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFeatureStoreModelId(string featureStoreModelId) { DARABONBA_PTR_SET_VALUE(featureStoreModelId_, featureStoreModelId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFeatureStoreProjectId(string featureStoreProjectId) { DARABONBA_PTR_SET_VALUE(featureStoreProjectId_, featureStoreProjectId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFeatureStoreProjectName(string featureStoreProjectName) { DARABONBA_PTR_SET_VALUE(featureStoreProjectName_, featureStoreProjectName) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFeatureStoreSeqFeatureView(string featureStoreSeqFeatureView) { DARABONBA_PTR_SET_VALUE(featureStoreSeqFeatureView_, featureStoreSeqFeatureView) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFeatureStoreUserId(string featureStoreUserId) { DARABONBA_PTR_SET_VALUE(featureStoreUserId_, featureStoreUserId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFgJarVersion(string fgJarVersion) { DARABONBA_PTR_SET_VALUE(fgJarVersion_, fgJarVersion) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setFgJsonFileName(string fgJsonFileName) { DARABONBA_PTR_SET_VALUE(fgJsonFileName_, fgJsonFileName) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setGenerateZip(bool generateZip) { DARABONBA_PTR_SET_VALUE(generateZip_, generateZip) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setGmtCreateTime(string gmtCreateTime) { DARABONBA_PTR_SET_VALUE(gmtCreateTime_, gmtCreateTime) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setGmtModifiedTime(string gmtModifiedTime) { DARABONBA_PTR_SET_VALUE(gmtModifiedTime_, gmtModifiedTime) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setItemIdField(string itemIdField) { DARABONBA_PTR_SET_VALUE(itemIdField_, itemIdField) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setItemTable(string itemTable) { DARABONBA_PTR_SET_VALUE(itemTable_, itemTable) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setItemTablePartitionField(string itemTablePartitionField) { DARABONBA_PTR_SET_VALUE(itemTablePartitionField_, itemTablePartitionField) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setItemTablePartitionFieldFormat(string itemTablePartitionFieldFormat) { DARABONBA_PTR_SET_VALUE(itemTablePartitionFieldFormat_, itemTablePartitionFieldFormat) };
    ...
    inline string latestJobGmtSamplingEndTime() const { DARABONBA_PTR_GET_DEFAULT(latestJobGmtSamplingEndTime_, "") };
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setLatestJobGmtSamplingEndTime(string latestJobGmtSamplingEndTime) { DARABONBA_PTR_SET_VALUE(latestJobGmtSamplingEndTime_, latestJobGmtSamplingEndTime) };
    ...
    inline string latestJobGmtSamplingStartTime() const { DARABONBA_PTR_GET_DEFAULT(latestJobGmtSamplingStartTime_, "") };
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setLatestJobGmtSamplingStartTime(string latestJobGmtSamplingStartTime) { DARABONBA_PTR_SET_VALUE(latestJobGmtSamplingStartTime_, latestJobGmtSamplingStartTime) };
    ...
    inline string latestJobId() const { DARABONBA_PTR_GET_DEFAULT(latestJobId_, "") };
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setLatestJobId(string latestJobId) { DARABONBA_PTR_SET_VALUE(latestJobId_, latestJobId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setOssBucket(string ossBucket) { DARABONBA_PTR_SET_VALUE(ossBucket_, ossBucket) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setOssResourceId(string ossResourceId) { DARABONBA_PTR_SET_VALUE(ossResourceId_, ossResourceId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setPredictWorkerCount(int32_t predictWorkerCount) { DARABONBA_PTR_SET_VALUE(predictWorkerCount_, predictWorkerCount) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setPredictWorkerCpu(int32_t predictWorkerCpu) { DARABONBA_PTR_SET_VALUE(predictWorkerCpu_, predictWorkerCpu) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setPredictWorkerMemory(int32_t predictWorkerMemory) { DARABONBA_PTR_SET_VALUE(predictWorkerMemory_, predictWorkerMemory) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setResourceConfig(string resourceConfig) { DARABONBA_PTR_SET_VALUE(resourceConfig_, resourceConfig) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setSampleRate(string sampleRate) { DARABONBA_PTR_SET_VALUE(sampleRate_, sampleRate) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setSceneName(string sceneName) { DARABONBA_PTR_SET_VALUE(sceneName_, sceneName) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setSecurityGroupId(string securityGroupId) { DARABONBA_PTR_SET_VALUE(securityGroupId_, securityGroupId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setServiceId(string serviceId) { DARABONBA_PTR_SET_VALUE(serviceId_, serviceId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setServiceName(string serviceName) { DARABONBA_PTR_SET_VALUE(serviceName_, serviceName) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setSwitchId(string switchId) { DARABONBA_PTR_SET_VALUE(switchId_, switchId) };
    ...
    inline bool useFeatureStore() const { DARABONBA_PTR_GET_DEFAULT(useFeatureStore_, false) };
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setUseFeatureStore(bool useFeatureStore) { DARABONBA_PTR_SET_VALUE(useFeatureStore_, useFeatureStore) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setUserIdField(string userIdField) { DARABONBA_PTR_SET_VALUE(userIdField_, userIdField) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setUserTable(string userTable) { DARABONBA_PTR_SET_VALUE(userTable_, userTable) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setUserTablePartitionField(string userTablePartitionField) { DARABONBA_PTR_SET_VALUE(userTablePartitionField_, userTablePartitionField) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setUserTablePartitionFieldFormat(string userTablePartitionFieldFormat) { DARABONBA_PTR_SET_VALUE(userTablePartitionFieldFormat_, userTablePartitionFieldFormat) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setWorkflowName(string workflowName) { DARABONBA_PTR_SET_VALUE(workflowName_, workflowName) };
    ...
    inline GetFeatureConsistencyCheckJobConfigResponseBody& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
  ...
  protected:
    ...
    std::shared_ptr<string> featureLandingResourceUri_ = nullptr;
    ...
    std::shared_ptr<string> latestJobGmtSamplingEndTime_ = nullptr;
    std::shared_ptr<string> latestJobGmtSamplingStartTime_ = nullptr;
    std::shared_ptr<string> latestJobId_ = nullptr;
    ...
    std::shared_ptr<bool> useFeatureStore_ = nullptr;
