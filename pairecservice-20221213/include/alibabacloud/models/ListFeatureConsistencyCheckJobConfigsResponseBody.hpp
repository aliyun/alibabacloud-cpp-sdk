...
namespace Models
{
  ...
  public:
    ...
    class FeatureConsistencyCheckConfigs : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const FeatureConsistencyCheckConfigs& obj) { 
        ...
        DARABONBA_PTR_TO_JSON(FeatureLandingResourceUri, featureLandingResourceUri_);
        ...
        DARABONBA_PTR_TO_JSON(LatestJobGmtSamplingEndTime, latestJobGmtSamplingEndTime_);
        DARABONBA_PTR_TO_JSON(LatestJobGmtSamplingStartTime, latestJobGmtSamplingStartTime_);
        DARABONBA_PTR_TO_JSON(LatestJobId, latestJobId_);
      ...
      friend void from_json(const Darabonba::Json& j, FeatureConsistencyCheckConfigs& obj) { 
        ...
        DARABONBA_PTR_FROM_JSON(FeatureLandingResourceUri, featureLandingResourceUri_);
        ...
        DARABONBA_PTR_FROM_JSON(LatestJobGmtSamplingEndTime, latestJobGmtSamplingEndTime_);
        DARABONBA_PTR_FROM_JSON(LatestJobGmtSamplingStartTime, latestJobGmtSamplingStartTime_);
        DARABONBA_PTR_FROM_JSON(LatestJobId, latestJobId_);
      ...
      FeatureConsistencyCheckConfigs() = default ;
      FeatureConsistencyCheckConfigs(const FeatureConsistencyCheckConfigs &) = default ;
      FeatureConsistencyCheckConfigs(FeatureConsistencyCheckConfigs &&) = default ;
      FeatureConsistencyCheckConfigs(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~FeatureConsistencyCheckConfigs() = default ;
      FeatureConsistencyCheckConfigs& operator=(const FeatureConsistencyCheckConfigs &) = default ;
      FeatureConsistencyCheckConfigs& operator=(FeatureConsistencyCheckConfigs &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->compareFeature_ == nullptr
        ...
        && this->defaultRoute_ == nullptr && this->easServiceName_ == nullptr && this->easyRecPackagePath_ == nullptr && this->easyRecVersion_ == nullptr && this->featureConsistencyCheckJobConfigId_ == nullptr
        && this->featureDisplayExclude_ == nullptr && this->featureLandingResourceId_ == nullptr && this->featureLandingResourceUri_ == nullptr && this->featurePriority_ == nullptr && this->featureStoreItemId_ == nullptr
        && this->featureStoreModelId_ == nullptr && this->featureStoreProjectId_ == nullptr && this->featureStoreProjectName_ == nullptr && this->featureStoreSeqFeatureView_ == nullptr && this->featureStoreUserId_ == nullptr
        && this->fgJarVersion_ == nullptr && this->fgJsonFileName_ == nullptr && this->generateZip_ == nullptr && this->gmtCreateTime_ == nullptr && this->gmtModifiedTime_ == nullptr
        && this->itemIdField_ == nullptr && this->itemTable_ == nullptr && this->itemTablePartitionField_ == nullptr && this->itemTablePartitionFieldFormat_ == nullptr && this->latestJobGmtSamplingEndTime_ == nullptr
        && this->latestJobGmtSamplingStartTime_ == nullptr && this->latestJobId_ == nullptr && this->name_ == nullptr && this->ossBucket_ == nullptr && this->ossResourceId_ == nullptr
        && this->predictWorkerCount_ == nullptr && this->predictWorkerCpu_ == nullptr && this->predictWorkerMemory_ == nullptr && this->resourceConfig_ == nullptr && this->sampleRate_ == nullptr
        && this->sceneId_ == nullptr && this->sceneName_ == nullptr && this->securityGroupId_ == nullptr && this->serviceId_ == nullptr && this->serviceName_ == nullptr
        && this->status_ == nullptr && this->switchId_ == nullptr && this->useFeatureStore_ == nullptr && this->userIdField_ == nullptr && this->userTable_ == nullptr
      ...
      inline FeatureConsistencyCheckConfigs& setCompareFeature(bool compareFeature) { DARABONBA_PTR_SET_VALUE(compareFeature_, compareFeature) };
      ...
      inline FeatureConsistencyCheckConfigs& setDatasetId(string datasetId) { DARABONBA_PTR_SET_VALUE(datasetId_, datasetId) };
      ...
      inline FeatureConsistencyCheckConfigs& setDatasetMountPath(string datasetMountPath) { DARABONBA_PTR_SET_VALUE(datasetMountPath_, datasetMountPath) };
      ...
      inline FeatureConsistencyCheckConfigs& setDatasetName(string datasetName) { DARABONBA_PTR_SET_VALUE(datasetName_, datasetName) };
      ...
      inline FeatureConsistencyCheckConfigs& setDatasetType(string datasetType) { DARABONBA_PTR_SET_VALUE(datasetType_, datasetType) };
      ...
      inline FeatureConsistencyCheckConfigs& setDatasetUri(string datasetUri) { DARABONBA_PTR_SET_VALUE(datasetUri_, datasetUri) };
      ...
      inline FeatureConsistencyCheckConfigs& setDefaultRoute(string defaultRoute) { DARABONBA_PTR_SET_VALUE(defaultRoute_, defaultRoute) };
      ...
      inline FeatureConsistencyCheckConfigs& setEasServiceName(string easServiceName) { DARABONBA_PTR_SET_VALUE(easServiceName_, easServiceName) };
      ...
      inline FeatureConsistencyCheckConfigs& setEasyRecPackagePath(string easyRecPackagePath) { DARABONBA_PTR_SET_VALUE(easyRecPackagePath_, easyRecPackagePath) };
      ...
      inline FeatureConsistencyCheckConfigs& setEasyRecVersion(string easyRecVersion) { DARABONBA_PTR_SET_VALUE(easyRecVersion_, easyRecVersion) };
      ...
      inline FeatureConsistencyCheckConfigs& setFeatureConsistencyCheckJobConfigId(string featureConsistencyCheckJobConfigId) { DARABONBA_PTR_SET_VALUE(featureConsistencyCheckJobConfigId_, featureConsistencyCheckJobConfigId) };
      ...
      inline FeatureConsistencyCheckConfigs& setFeatureDisplayExclude(string featureDisplayExclude) { DARABONBA_PTR_SET_VALUE(featureDisplayExclude_, featureDisplayExclude) };
      ...
      inline FeatureConsistencyCheckConfigs& setFeatureLandingResourceId(string featureLandingResourceId) { DARABONBA_PTR_SET_VALUE(featureLandingResourceId_, featureLandingResourceId) };


      // featureLandingResourceUri Field Functions 
      bool hasFeatureLandingResourceUri() const { return this->featureLandingResourceUri_ != nullptr;};
      void deleteFeatureLandingResourceUri() { this->featureLandingResourceUri_ = nullptr;};
      inline string getFeatureLandingResourceUri() const { DARABONBA_PTR_GET_DEFAULT(featureLandingResourceUri_, "") };
      inline FeatureConsistencyCheckConfigs& setFeatureLandingResourceUri(string featureLandingResourceUri) { DARABONBA_PTR_SET_VALUE(featureLandingResourceUri_, featureLandingResourceUri) };
      ...
      inline FeatureConsistencyCheckConfigs& setFeaturePriority(string featurePriority) { DARABONBA_PTR_SET_VALUE(featurePriority_, featurePriority) };
      ...
      inline FeatureConsistencyCheckConfigs& setFeatureStoreItemId(string featureStoreItemId) { DARABONBA_PTR_SET_VALUE(featureStoreItemId_, featureStoreItemId) };
      ...
      inline FeatureConsistencyCheckConfigs& setFeatureStoreModelId(string featureStoreModelId) { DARABONBA_PTR_SET_VALUE(featureStoreModelId_, featureStoreModelId) };
      ...
      inline FeatureConsistencyCheckConfigs& setFeatureStoreProjectId(string featureStoreProjectId) { DARABONBA_PTR_SET_VALUE(featureStoreProjectId_, featureStoreProjectId) };
      ...
      inline FeatureConsistencyCheckConfigs& setFeatureStoreProjectName(string featureStoreProjectName) { DARABONBA_PTR_SET_VALUE(featureStoreProjectName_, featureStoreProjectName) };
      ...
      inline FeatureConsistencyCheckConfigs& setFeatureStoreSeqFeatureView(string featureStoreSeqFeatureView) { DARABONBA_PTR_SET_VALUE(featureStoreSeqFeatureView_, featureStoreSeqFeatureView) };
      ...
      inline FeatureConsistencyCheckConfigs& setFeatureStoreUserId(string featureStoreUserId) { DARABONBA_PTR_SET_VALUE(featureStoreUserId_, featureStoreUserId) };
      ...
      inline FeatureConsistencyCheckConfigs& setFgJarVersion(string fgJarVersion) { DARABONBA_PTR_SET_VALUE(fgJarVersion_, fgJarVersion) };
      ...
      inline FeatureConsistencyCheckConfigs& setFgJsonFileName(string fgJsonFileName) { DARABONBA_PTR_SET_VALUE(fgJsonFileName_, fgJsonFileName) };
      ...
      inline FeatureConsistencyCheckConfigs& setGenerateZip(bool generateZip) { DARABONBA_PTR_SET_VALUE(generateZip_, generateZip) };
      ...
      inline FeatureConsistencyCheckConfigs& setGmtCreateTime(string gmtCreateTime) { DARABONBA_PTR_SET_VALUE(gmtCreateTime_, gmtCreateTime) };
      ...
      inline FeatureConsistencyCheckConfigs& setGmtModifiedTime(string gmtModifiedTime) { DARABONBA_PTR_SET_VALUE(gmtModifiedTime_, gmtModifiedTime) };
      ...
      inline FeatureConsistencyCheckConfigs& setItemIdField(string itemIdField) { DARABONBA_PTR_SET_VALUE(itemIdField_, itemIdField) };
      ...
      inline FeatureConsistencyCheckConfigs& setItemTable(string itemTable) { DARABONBA_PTR_SET_VALUE(itemTable_, itemTable) };
      ...
      inline FeatureConsistencyCheckConfigs& setItemTablePartitionField(string itemTablePartitionField) { DARABONBA_PTR_SET_VALUE(itemTablePartitionField_, itemTablePartitionField) };
      ...
      inline FeatureConsistencyCheckConfigs& setItemTablePartitionFieldFormat(string itemTablePartitionFieldFormat) { DARABONBA_PTR_SET_VALUE(itemTablePartitionFieldFormat_, itemTablePartitionFieldFormat) };


      // latestJobGmtSamplingEndTime Field Functions 
      bool hasLatestJobGmtSamplingEndTime() const { return this->latestJobGmtSamplingEndTime_ != nullptr;};
      void deleteLatestJobGmtSamplingEndTime() { this->latestJobGmtSamplingEndTime_ = nullptr;};
      inline string getLatestJobGmtSamplingEndTime() const { DARABONBA_PTR_GET_DEFAULT(latestJobGmtSamplingEndTime_, "") };
      inline FeatureConsistencyCheckConfigs& setLatestJobGmtSamplingEndTime(string latestJobGmtSamplingEndTime) { DARABONBA_PTR_SET_VALUE(latestJobGmtSamplingEndTime_, latestJobGmtSamplingEndTime) };


      // latestJobGmtSamplingStartTime Field Functions 
      bool hasLatestJobGmtSamplingStartTime() const { return this->latestJobGmtSamplingStartTime_ != nullptr;};
      void deleteLatestJobGmtSamplingStartTime() { this->latestJobGmtSamplingStartTime_ = nullptr;};
      inline string getLatestJobGmtSamplingStartTime() const { DARABONBA_PTR_GET_DEFAULT(latestJobGmtSamplingStartTime_, "") };
      inline FeatureConsistencyCheckConfigs& setLatestJobGmtSamplingStartTime(string latestJobGmtSamplingStartTime) { DARABONBA_PTR_SET_VALUE(latestJobGmtSamplingStartTime_, latestJobGmtSamplingStartTime) };


      // latestJobId Field Functions 
      bool hasLatestJobId() const { return this->latestJobId_ != nullptr;};
      void deleteLatestJobId() { this->latestJobId_ = nullptr;};
      inline string getLatestJobId() const { DARABONBA_PTR_GET_DEFAULT(latestJobId_, "") };
      inline FeatureConsistencyCheckConfigs& setLatestJobId(string latestJobId) { DARABONBA_PTR_SET_VALUE(latestJobId_, latestJobId) };
      ...
      inline FeatureConsistencyCheckConfigs& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
      ...
      inline FeatureConsistencyCheckConfigs& setOssBucket(string ossBucket) { DARABONBA_PTR_SET_VALUE(ossBucket_, ossBucket) };
      ...
      inline FeatureConsistencyCheckConfigs& setOssResourceId(string ossResourceId) { DARABONBA_PTR_SET_VALUE(ossResourceId_, ossResourceId) };
      ...
      inline FeatureConsistencyCheckConfigs& setPredictWorkerCount(int32_t predictWorkerCount) { DARABONBA_PTR_SET_VALUE(predictWorkerCount_, predictWorkerCount) };
      ...
      inline FeatureConsistencyCheckConfigs& setPredictWorkerCpu(int32_t predictWorkerCpu) { DARABONBA_PTR_SET_VALUE(predictWorkerCpu_, predictWorkerCpu) };
      ...
      inline FeatureConsistencyCheckConfigs& setPredictWorkerMemory(int32_t predictWorkerMemory) { DARABONBA_PTR_SET_VALUE(predictWorkerMemory_, predictWorkerMemory) };
      ...
      inline FeatureConsistencyCheckConfigs& setResourceConfig(string resourceConfig) { DARABONBA_PTR_SET_VALUE(resourceConfig_, resourceConfig) };
      ...
      inline FeatureConsistencyCheckConfigs& setSampleRate(string sampleRate) { DARABONBA_PTR_SET_VALUE(sampleRate_, sampleRate) };
      ...
      inline FeatureConsistencyCheckConfigs& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
      ...
      inline FeatureConsistencyCheckConfigs& setSceneName(string sceneName) { DARABONBA_PTR_SET_VALUE(sceneName_, sceneName) };
      ...
      inline FeatureConsistencyCheckConfigs& setSecurityGroupId(string securityGroupId) { DARABONBA_PTR_SET_VALUE(securityGroupId_, securityGroupId) };
      ...
      inline FeatureConsistencyCheckConfigs& setServiceId(string serviceId) { DARABONBA_PTR_SET_VALUE(serviceId_, serviceId) };
      ...
      inline FeatureConsistencyCheckConfigs& setServiceName(string serviceName) { DARABONBA_PTR_SET_VALUE(serviceName_, serviceName) };
      ...
      inline FeatureConsistencyCheckConfigs& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
      ...
      inline FeatureConsistencyCheckConfigs& setSwitchId(string switchId) { DARABONBA_PTR_SET_VALUE(switchId_, switchId) };
      ...
      inline string getUseFeatureStore() const { DARABONBA_PTR_GET_DEFAULT(useFeatureStore_, "") };
      inline FeatureConsistencyCheckConfigs& setUseFeatureStore(string useFeatureStore) { DARABONBA_PTR_SET_VALUE(useFeatureStore_, useFeatureStore) };
      ...
      inline FeatureConsistencyCheckConfigs& setUserIdField(string userIdField) { DARABONBA_PTR_SET_VALUE(userIdField_, userIdField) };
      ...
      inline FeatureConsistencyCheckConfigs& setUserTable(string userTable) { DARABONBA_PTR_SET_VALUE(userTable_, userTable) };
      ...
      inline FeatureConsistencyCheckConfigs& setUserTablePartitionField(string userTablePartitionField) { DARABONBA_PTR_SET_VALUE(userTablePartitionField_, userTablePartitionField) };
      ...
      inline FeatureConsistencyCheckConfigs& setUserTablePartitionFieldFormat(string userTablePartitionFieldFormat) { DARABONBA_PTR_SET_VALUE(userTablePartitionFieldFormat_, userTablePartitionFieldFormat) };
      ...
      inline FeatureConsistencyCheckConfigs& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
      ...
      inline FeatureConsistencyCheckConfigs& setWorkflowName(string workflowName) { DARABONBA_PTR_SET_VALUE(workflowName_, workflowName) };
      ...
      inline FeatureConsistencyCheckConfigs& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
    ...
    virtual bool empty() const override { return this->featureConsistencyCheckConfigs_ == nullptr
    ...
    inline const vector<ListFeatureConsistencyCheckJobConfigsResponseBody::FeatureConsistencyCheckConfigs> & getFeatureConsistencyCheckConfigs() const { DARABONBA_PTR_GET_CONST(featureConsistencyCheckConfigs_, vector<ListFeatureConsistencyCheckJobConfigsResponseBody::FeatureConsistencyCheckConfigs>) };
    inline vector<ListFeatureConsistencyCheckJobConfigsResponseBody::FeatureConsistencyCheckConfigs> getFeatureConsistencyCheckConfigs() { DARABONBA_PTR_GET(featureConsistencyCheckConfigs_, vector<ListFeatureConsistencyCheckJobConfigsResponseBody::FeatureConsistencyCheckConfigs>) };
    inline ListFeatureConsistencyCheckJobConfigsResponseBody& setFeatureConsistencyCheckConfigs(const vector<ListFeatureConsistencyCheckJobConfigsResponseBody::FeatureConsistencyCheckConfigs> & featureConsistencyCheckConfigs) { DARABONBA_PTR_SET_VALUE(featureConsistencyCheckConfigs_, featureConsistencyCheckConfigs) };
    inline ListFeatureConsistencyCheckJobConfigsResponseBody& setFeatureConsistencyCheckConfigs(vector<ListFeatureConsistencyCheckJobConfigsResponseBody::FeatureConsistencyCheckConfigs> && featureConsistencyCheckConfigs) { DARABONBA_PTR_SET_RVALUE(featureConsistencyCheckConfigs_, featureConsistencyCheckConfigs) };
