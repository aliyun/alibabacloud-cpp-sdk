...
#ifndef ALIBABACLOUD_MODELS_CREATEABMETRICREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEABMETRICREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateABMetricRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateABMetricRequest& obj) { 
    ...
    CreateABMetricRequest() = default ;
    CreateABMetricRequest(const CreateABMetricRequest &) = default ;
    CreateABMetricRequest(CreateABMetricRequest &&) = default ;
    CreateABMetricRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateABMetricRequest() = default ;
    CreateABMetricRequest& operator=(const CreateABMetricRequest &) = default ;
    CreateABMetricRequest& operator=(CreateABMetricRequest &&) = default ;
    ...
    inline CreateABMetricRequest& setAggregationByUser(bool aggregationByUser) { DARABONBA_PTR_SET_VALUE(aggregationByUser_, aggregationByUser) };
    ...
    inline CreateABMetricRequest& setDefinition(string definition) { DARABONBA_PTR_SET_VALUE(definition_, definition) };
    ...
    inline CreateABMetricRequest& setDenominator(string denominator) { DARABONBA_PTR_SET_VALUE(denominator_, denominator) };
    ...
    inline CreateABMetricRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreateABMetricRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline CreateABMetricRequest& setIsBinomialDistribution(bool isBinomialDistribution) { DARABONBA_PTR_SET_VALUE(isBinomialDistribution_, isBinomialDistribution) };
    ...
    inline CreateABMetricRequest& setLeftMetricId(string leftMetricId) { DARABONBA_PTR_SET_VALUE(leftMetricId_, leftMetricId) };
    ...
    inline CreateABMetricRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateABMetricRequest& setNeedSignificance(bool needSignificance) { DARABONBA_PTR_SET_VALUE(needSignificance_, needSignificance) };
    ...
    inline CreateABMetricRequest& setNumerator(string numerator) { DARABONBA_PTR_SET_VALUE(numerator_, numerator) };
    ...
    inline CreateABMetricRequest& setOperator(string _operator) { DARABONBA_PTR_SET_VALUE(operator_, _operator) };
    ...
    inline CreateABMetricRequest& setRealtime(bool realtime) { DARABONBA_PTR_SET_VALUE(realtime_, realtime) };
    ...
    inline CreateABMetricRequest& setResultResourceId(string resultResourceId) { DARABONBA_PTR_SET_VALUE(resultResourceId_, resultResourceId) };
    ...
    inline CreateABMetricRequest& setRightMetricId(string rightMetricId) { DARABONBA_PTR_SET_VALUE(rightMetricId_, rightMetricId) };
    ...
    inline CreateABMetricRequest& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
    ...
    inline CreateABMetricRequest& setStatisticsCycle(int32_t statisticsCycle) { DARABONBA_PTR_SET_VALUE(statisticsCycle_, statisticsCycle) };
    ...
    inline CreateABMetricRequest& setTableMetaId(string tableMetaId) { DARABONBA_PTR_SET_VALUE(tableMetaId_, tableMetaId) };
    ...
    inline CreateABMetricRequest& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
