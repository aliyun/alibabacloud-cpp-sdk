...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceResourceTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceResourceTableResponseBody) };
    inline GetInstanceResourceTableResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceResourceTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceResourceTableResponseBody> body_ {};
  };
