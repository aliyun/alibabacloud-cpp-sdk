...
#ifndef ALIBABACLOUD_MODELS_UPDATETRAFFICCONTROLTARGETREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATETRAFFICCONTROLTARGETREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateTrafficControlTargetRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateTrafficControlTargetRequest& obj) { 
    ...
    UpdateTrafficControlTargetRequest() = default ;
    UpdateTrafficControlTargetRequest(const UpdateTrafficControlTargetRequest &) = default ;
    UpdateTrafficControlTargetRequest(UpdateTrafficControlTargetRequest &&) = default ;
    UpdateTrafficControlTargetRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateTrafficControlTargetRequest() = default ;
    UpdateTrafficControlTargetRequest& operator=(const UpdateTrafficControlTargetRequest &) = default ;
    UpdateTrafficControlTargetRequest& operator=(UpdateTrafficControlTargetRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->endTime_ == nullptr
        ...
        && this->toleranceValue_ == nullptr && this->value_ == nullptr && this->newParam3_ == nullptr; };
    // endTime Field Functions 
    bool hasEndTime() const { return this->endTime_ != nullptr;};
    void deleteEndTime() { this->endTime_ = nullptr;};
    inline string getEndTime() const { DARABONBA_PTR_GET_DEFAULT(endTime_, "") };
    inline UpdateTrafficControlTargetRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline UpdateTrafficControlTargetRequest& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };
    ...
    inline UpdateTrafficControlTargetRequest& setItemConditionArray(string itemConditionArray) { DARABONBA_PTR_SET_VALUE(itemConditionArray_, itemConditionArray) };
    ...
    inline UpdateTrafficControlTargetRequest& setItemConditionExpress(string itemConditionExpress) { DARABONBA_PTR_SET_VALUE(itemConditionExpress_, itemConditionExpress) };
    ...
    inline UpdateTrafficControlTargetRequest& setItemConditionType(string itemConditionType) { DARABONBA_PTR_SET_VALUE(itemConditionType_, itemConditionType) };
    ...
    inline UpdateTrafficControlTargetRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline UpdateTrafficControlTargetRequest& setNewProductRegulation(bool newProductRegulation) { DARABONBA_PTR_SET_VALUE(newProductRegulation_, newProductRegulation) };
    ...
    inline UpdateTrafficControlTargetRequest& setRecallName(string recallName) { DARABONBA_PTR_SET_VALUE(recallName_, recallName) };
    ...
    inline UpdateTrafficControlTargetRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline UpdateTrafficControlTargetRequest& setStatisPeriod(string statisPeriod) { DARABONBA_PTR_SET_VALUE(statisPeriod_, statisPeriod) };
    ...
    inline UpdateTrafficControlTargetRequest& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline UpdateTrafficControlTargetRequest& setToleranceValue(int64_t toleranceValue) { DARABONBA_PTR_SET_VALUE(toleranceValue_, toleranceValue) };
    ...
    inline UpdateTrafficControlTargetRequest& setValue(float value) { DARABONBA_PTR_SET_VALUE(value_, value) };
    ...
    inline UpdateTrafficControlTargetRequest& setNewParam3(string newParam3) { DARABONBA_PTR_SET_VALUE(newParam3_, newParam3) };
