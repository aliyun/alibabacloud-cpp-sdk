...
namespace Models
{
  ...
  public:
    ...
    inline const CreateParamResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateParamResponseBody) };
    inline CreateParamResponseBody body() { DARABONBA_PTR_GET(body_, CreateParamResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateParamResponseBody> body_ = nullptr;
  };
