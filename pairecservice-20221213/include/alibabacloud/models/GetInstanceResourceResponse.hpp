...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceResourceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceResourceResponseBody) };
    inline GetInstanceResourceResponseBody body() { DARABONBA_PTR_GET(body_, GetInstanceResourceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetInstanceResourceResponseBody> body_ = nullptr;
  };
