...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSubCrowdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSubCrowdResponseBody) };
    inline DeleteSubCrowdResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSubCrowdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSubCrowdResponseBody> body_ {};
  };
