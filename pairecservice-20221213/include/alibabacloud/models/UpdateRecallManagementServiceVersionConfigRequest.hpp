...
#ifndef ALIBABACLOUD_MODELS_UPDATERECALLMANAGEMENTSERVICEVERSIONCONFIGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATERECALLMANAGEMENTSERVICEVERSIONCONFIGREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    ...
    UpdateRecallManagementServiceVersionConfigRequest() = default ;
    UpdateRecallManagementServiceVersionConfigRequest(const UpdateRecallManagementServiceVersionConfigRequest &) = default ;
    UpdateRecallManagementServiceVersionConfigRequest(UpdateRecallManagementServiceVersionConfigRequest &&) = default ;
    UpdateRecallManagementServiceVersionConfigRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateRecallManagementServiceVersionConfigRequest() = default ;
    UpdateRecallManagementServiceVersionConfigRequest& operator=(const UpdateRecallManagementServiceVersionConfigRequest &) = default ;
    UpdateRecallManagementServiceVersionConfigRequest& operator=(UpdateRecallManagementServiceVersionConfigRequest &&) = default ;
    ...
    inline UpdateRecallManagementServiceVersionConfigRequest& setConfigType(string configType) { DARABONBA_PTR_SET_VALUE(configType_, configType) };
    ...
    inline UpdateRecallManagementServiceVersionConfigRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline const UpdateRecallManagementServiceVersionConfigRequest::MergeConfig & getMergeConfig() const { DARABONBA_PTR_GET_CONST(mergeConfig_, UpdateRecallManagementServiceVersionConfigRequest::MergeConfig) };
    inline UpdateRecallManagementServiceVersionConfigRequest::MergeConfig getMergeConfig() { DARABONBA_PTR_GET(mergeConfig_, UpdateRecallManagementServiceVersionConfigRequest::MergeConfig) };
    inline UpdateRecallManagementServiceVersionConfigRequest& setMergeConfig(const UpdateRecallManagementServiceVersionConfigRequest::MergeConfig & mergeConfig) { DARABONBA_PTR_SET_VALUE(mergeConfig_, mergeConfig) };
    inline UpdateRecallManagementServiceVersionConfigRequest& setMergeConfig(UpdateRecallManagementServiceVersionConfigRequest::MergeConfig && mergeConfig) { DARABONBA_PTR_SET_RVALUE(mergeConfig_, mergeConfig) };
    ...
    inline const UpdateRecallManagementServiceVersionConfigRequest::RecallConfig & getRecallConfig() const { DARABONBA_PTR_GET_CONST(recallConfig_, UpdateRecallManagementServiceVersionConfigRequest::RecallConfig) };
    inline UpdateRecallManagementServiceVersionConfigRequest::RecallConfig getRecallConfig() { DARABONBA_PTR_GET(recallConfig_, UpdateRecallManagementServiceVersionConfigRequest::RecallConfig) };
    inline UpdateRecallManagementServiceVersionConfigRequest& setRecallConfig(const UpdateRecallManagementServiceVersionConfigRequest::RecallConfig & recallConfig) { DARABONBA_PTR_SET_VALUE(recallConfig_, recallConfig) };
    inline UpdateRecallManagementServiceVersionConfigRequest& setRecallConfig(UpdateRecallManagementServiceVersionConfigRequest::RecallConfig && recallConfig) { DARABONBA_PTR_SET_RVALUE(recallConfig_, recallConfig) };
