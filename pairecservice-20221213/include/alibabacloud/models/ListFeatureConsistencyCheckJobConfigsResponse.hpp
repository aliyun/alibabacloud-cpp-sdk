...
namespace Models
{
  ...
  public:
    ...
    inline const ListFeatureConsistencyCheckJobConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFeatureConsistencyCheckJobConfigsResponseBody) };
    inline ListFeatureConsistencyCheckJobConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFeatureConsistencyCheckJobConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFeatureConsistencyCheckJobConfigsResponseBody> body_ {};
  };
