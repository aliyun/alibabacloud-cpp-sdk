...
#ifndef ALIBABACLOUD_MODELS_CREATERECALLMANAGEMENTSERVICEVERSIONCONFIGREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATERECALLMANAGEMENTSERVICEVERSIONCONFIGREQUEST_HPP_
...
namespace Models
{
  class CreateRecallManagementServiceVersionConfigRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateRecallManagementServiceVersionConfigRequest& obj) { 
      DARABONBA_PTR_TO_JSON(ConfigType, configType_);
      DARABONBA_PTR_TO_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_TO_JSON(MergeConfig, mergeConfig_);
      DARABONBA_PTR_TO_JSON(RecallConfig, recallConfig_);
    };
    friend void from_json(const Darabonba::Json& j, CreateRecallManagementServiceVersionConfigRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(ConfigType, configType_);
      DARABONBA_PTR_FROM_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_FROM_JSON(MergeConfig, mergeConfig_);
      DARABONBA_PTR_FROM_JSON(RecallConfig, recallConfig_);
    };
    CreateRecallManagementServiceVersionConfigRequest() = default ;
    CreateRecallManagementServiceVersionConfigRequest(const CreateRecallManagementServiceVersionConfigRequest &) = default ;
    CreateRecallManagementServiceVersionConfigRequest(CreateRecallManagementServiceVersionConfigRequest &&) = default ;
    CreateRecallManagementServiceVersionConfigRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateRecallManagementServiceVersionConfigRequest() = default ;
    CreateRecallManagementServiceVersionConfigRequest& operator=(const CreateRecallManagementServiceVersionConfigRequest &) = default ;
    CreateRecallManagementServiceVersionConfigRequest& operator=(CreateRecallManagementServiceVersionConfigRequest &&) = default ;
    ...
    inline CreateRecallManagementServiceVersionConfigRequest& setConfigType(string configType) { DARABONBA_PTR_SET_VALUE(configType_, configType) };
    ...
    inline CreateRecallManagementServiceVersionConfigRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline const CreateRecallManagementServiceVersionConfigRequest::MergeConfig & getMergeConfig() const { DARABONBA_PTR_GET_CONST(mergeConfig_, CreateRecallManagementServiceVersionConfigRequest::MergeConfig) };
    inline CreateRecallManagementServiceVersionConfigRequest::MergeConfig getMergeConfig() { DARABONBA_PTR_GET(mergeConfig_, CreateRecallManagementServiceVersionConfigRequest::MergeConfig) };
    inline CreateRecallManagementServiceVersionConfigRequest& setMergeConfig(const CreateRecallManagementServiceVersionConfigRequest::MergeConfig & mergeConfig) { DARABONBA_PTR_SET_VALUE(mergeConfig_, mergeConfig) };
    inline CreateRecallManagementServiceVersionConfigRequest& setMergeConfig(CreateRecallManagementServiceVersionConfigRequest::MergeConfig && mergeConfig) { DARABONBA_PTR_SET_RVALUE(mergeConfig_, mergeConfig) };
    ...
    inline const CreateRecallManagementServiceVersionConfigRequest::RecallConfig & getRecallConfig() const { DARABONBA_PTR_GET_CONST(recallConfig_, CreateRecallManagementServiceVersionConfigRequest::RecallConfig) };
    inline CreateRecallManagementServiceVersionConfigRequest::RecallConfig getRecallConfig() { DARABONBA_PTR_GET(recallConfig_, CreateRecallManagementServiceVersionConfigRequest::RecallConfig) };
    inline CreateRecallManagementServiceVersionConfigRequest& setRecallConfig(const CreateRecallManagementServiceVersionConfigRequest::RecallConfig & recallConfig) { DARABONBA_PTR_SET_VALUE(recallConfig_, recallConfig) };
    inline CreateRecallManagementServiceVersionConfigRequest& setRecallConfig(CreateRecallManagementServiceVersionConfigRequest::RecallConfig && recallConfig) { DARABONBA_PTR_SET_RVALUE(recallConfig_, recallConfig) };


  protected:
    shared_ptr<string> configType_ {};
    shared_ptr<string> instanceId_ {};
    shared_ptr<CreateRecallManagementServiceVersionConfigRequest::MergeConfig> mergeConfig_ {};
    shared_ptr<CreateRecallManagementServiceVersionConfigRequest::RecallConfig> recallConfig_ {};
  };
