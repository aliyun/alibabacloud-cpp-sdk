...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateABMetricGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateABMetricGroupResponseBody) };
    inline UpdateABMetricGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateABMetricGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateABMetricGroupResponseBody> body_ {};
  };
