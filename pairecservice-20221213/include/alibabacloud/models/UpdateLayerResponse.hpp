...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLayerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLayerResponseBody) };
    inline UpdateLayerResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLayerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLayerResponseBody> body_ {};
  };
