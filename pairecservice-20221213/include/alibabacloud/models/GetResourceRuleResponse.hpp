...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetResourceRuleResponseBody) };
    inline GetResourceRuleResponseBody body() { DARABONBA_PTR_GET(body_, GetResourceRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetResourceRuleResponseBody> body_ = nullptr;
  };
