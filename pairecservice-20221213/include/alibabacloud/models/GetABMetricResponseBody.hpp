...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aggregationByUser_ == nullptr
        && this->definition_ == nullptr && this->denominator_ == nullptr && this->description_ == nullptr && this->isBinomialDistribution_ == nullptr && this->leftMetricId_ == nullptr
        && this->name_ == nullptr && this->needSignificance_ == nullptr && this->numerator_ == nullptr && this->operator_ == nullptr && this->realtime_ == nullptr
    ...
    inline GetABMetricResponseBody& setAggregationByUser(bool aggregationByUser) { DARABONBA_PTR_SET_VALUE(aggregationByUser_, aggregationByUser) };
    ...
    inline GetABMetricResponseBody& setDenominator(string denominator) { DARABONBA_PTR_SET_VALUE(denominator_, denominator) };
    ...
    inline GetABMetricResponseBody& setIsBinomialDistribution(bool isBinomialDistribution) { DARABONBA_PTR_SET_VALUE(isBinomialDistribution_, isBinomialDistribution) };
    ...
    inline GetABMetricResponseBody& setNeedSignificance(bool needSignificance) { DARABONBA_PTR_SET_VALUE(needSignificance_, needSignificance) };
    ...
    inline GetABMetricResponseBody& setNumerator(string numerator) { DARABONBA_PTR_SET_VALUE(numerator_, numerator) };
