...
namespace Models
{
  ...
  public:
    ...
    inline const GetTrafficControlTargetResponseBodySplitParts & splitParts() const { DARABONBA_PTR_GET_CONST(splitParts_, GetTrafficControlTargetResponseBodySplitParts) };
    inline GetTrafficControlTargetResponseBodySplitParts splitParts() { DARABONBA_PTR_GET(splitParts_, GetTrafficControlTargetResponseBodySplitParts) };
    inline GetTrafficControlTargetResponseBody& setSplitParts(const GetTrafficControlTargetResponseBodySplitParts & splitParts) { DARABONBA_PTR_SET_VALUE(splitParts_, splitParts) };
    inline GetTrafficControlTargetResponseBody& setSplitParts(GetTrafficControlTargetResponseBodySplitParts && splitParts) { DARABONBA_PTR_SET_RVALUE(splitParts_, splitParts) };
  ...
  protected:
    ...
    std::shared_ptr<GetTrafficControlTargetResponseBodySplitParts> splitParts_ = nullptr;
