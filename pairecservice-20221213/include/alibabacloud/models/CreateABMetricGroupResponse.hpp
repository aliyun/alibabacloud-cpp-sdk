...
namespace Models
{
  ...
  public:
    ...
    inline const CreateABMetricGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateABMetricGroupResponseBody) };
    inline CreateABMetricGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateABMetricGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateABMetricGroupResponseBody> body_ {};
  };
