...
namespace Models
{
  ...
  public:
    ...
    inline const GetSceneResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetSceneResponseBody) };
    inline GetSceneResponseBody body() { DARABONBA_PTR_GET(body_, GetSceneResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetSceneResponseBody> body_ = nullptr;
  };
