...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteResourceRuleItemResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteResourceRuleItemResponseBody) };
    inline DeleteResourceRuleItemResponseBody body() { DARABONBA_PTR_GET(body_, DeleteResourceRuleItemResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteResourceRuleItemResponseBody> body_ = nullptr;
  };
