...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLaboratoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLaboratoryResponseBody) };
    inline DeleteLaboratoryResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLaboratoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLaboratoryResponseBody> body_ {};
  };
