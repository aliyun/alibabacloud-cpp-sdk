...
namespace Models
{
  ...
  public:
    ...
    inline const GetSubCrowdResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetSubCrowdResponseBody) };
    inline GetSubCrowdResponseBody body() { DARABONBA_PTR_GET(body_, GetSubCrowdResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetSubCrowdResponseBody> body_ = nullptr;
  };
