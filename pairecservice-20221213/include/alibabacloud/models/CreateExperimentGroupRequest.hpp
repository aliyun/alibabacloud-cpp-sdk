...
#ifndef ALIBABACLOUD_MODELS_CREATEEXPERIMENTGROUPREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEEXPERIMENTGROUPREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateExperimentGroupRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateExperimentGroupRequest& obj) { 
    ...
    CreateExperimentGroupRequest() = default ;
    CreateExperimentGroupRequest(const CreateExperimentGroupRequest &) = default ;
    CreateExperimentGroupRequest(CreateExperimentGroupRequest &&) = default ;
    CreateExperimentGroupRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateExperimentGroupRequest() = default ;
    CreateExperimentGroupRequest& operator=(const CreateExperimentGroupRequest &) = default ;
    CreateExperimentGroupRequest& operator=(CreateExperimentGroupRequest &&) = default ;
    ...
    virtual bool empty() const override { this->config_ != nullptr
        ...
        && this->name_ != nullptr && this->needAA_ != nullptr && this->randomFlow_ != nullptr && this->reservedBuckets_ != nullptr; };
    // config Field Functions 
    bool hasConfig() const { return this->config_ != nullptr;};
    void deleteConfig() { this->config_ = nullptr;};
    inline string config() const { DARABONBA_PTR_GET_DEFAULT(config_, "") };
    inline CreateExperimentGroupRequest& setConfig(string config) { DARABONBA_PTR_SET_VALUE(config_, config) };
    ...
    inline CreateExperimentGroupRequest& setCrowdId(string crowdId) { DARABONBA_PTR_SET_VALUE(crowdId_, crowdId) };
    ...
    inline CreateExperimentGroupRequest& setCrowdTargetType(string crowdTargetType) { DARABONBA_PTR_SET_VALUE(crowdTargetType_, crowdTargetType) };
    ...
    inline CreateExperimentGroupRequest& setDebugCrowdId(string debugCrowdId) { DARABONBA_PTR_SET_VALUE(debugCrowdId_, debugCrowdId) };
    ...
    inline CreateExperimentGroupRequest& setDebugUsers(string debugUsers) { DARABONBA_PTR_SET_VALUE(debugUsers_, debugUsers) };
    ...
    inline CreateExperimentGroupRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreateExperimentGroupRequest& setDistributionTimeDuration(int32_t distributionTimeDuration) { DARABONBA_PTR_SET_VALUE(distributionTimeDuration_, distributionTimeDuration) };
    ...
    inline CreateExperimentGroupRequest& setDistributionType(string distributionType) { DARABONBA_PTR_SET_VALUE(distributionType_, distributionType) };
    ...
    inline CreateExperimentGroupRequest& setFilter(string filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    ...
    inline CreateExperimentGroupRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline CreateExperimentGroupRequest& setLayerId(string layerId) { DARABONBA_PTR_SET_VALUE(layerId_, layerId) };
    ...
    inline CreateExperimentGroupRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateExperimentGroupRequest& setNeedAA(bool needAA) { DARABONBA_PTR_SET_VALUE(needAA_, needAA) };
    ...
    inline CreateExperimentGroupRequest& setRandomFlow(int64_t randomFlow) { DARABONBA_PTR_SET_VALUE(randomFlow_, randomFlow) };
    ...
    inline CreateExperimentGroupRequest& setReservedBuckets(string reservedBuckets) { DARABONBA_PTR_SET_VALUE(reservedBuckets_, reservedBuckets) };
