...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTrafficControlTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTrafficControlTaskResponseBody) };
    inline CreateTrafficControlTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTrafficControlTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTrafficControlTaskResponseBody> body_ {};
  };
