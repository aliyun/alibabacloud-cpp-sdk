...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCrowdResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteCrowdResponseBody) };
    inline DeleteCrowdResponseBody body() { DARABONBA_PTR_GET(body_, DeleteCrowdResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteCrowdResponseBody> body_ = nullptr;
  };
