...
namespace Models
{
  ...
  public:
    ...
    inline const CloneTrafficControlTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CloneTrafficControlTaskResponseBody) };
    inline CloneTrafficControlTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CloneTrafficControlTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CloneTrafficControlTaskResponseBody> body_ {};
  };
