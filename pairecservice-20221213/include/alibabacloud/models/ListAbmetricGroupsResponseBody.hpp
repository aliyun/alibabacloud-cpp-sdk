...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->ABMetricGroups_ != nullptr
    ...
    inline const vector<ListABMetricGroupsResponseBodyABMetricGroups> & ABMetricGroups() const { DARABONBA_PTR_GET_CONST(ABMetricGroups_, vector<ListABMetricGroupsResponseBodyABMetricGroups>) };
    inline vector<ListABMetricGroupsResponseBodyABMetricGroups> ABMetricGroups() { DARABONBA_PTR_GET(ABMetricGroups_, vector<ListABMetricGroupsResponseBodyABMetricGroups>) };
    inline ListABMetricGroupsResponseBody& setABMetricGroups(const vector<ListABMetricGroupsResponseBodyABMetricGroups> & ABMetricGroups) { DARABONBA_PTR_SET_VALUE(ABMetricGroups_, ABMetricGroups) };
    inline ListABMetricGroupsResponseBody& setABMetricGroups(vector<ListABMetricGroupsResponseBodyABMetricGroups> && ABMetricGroups) { DARABONBA_PTR_SET_RVALUE(ABMetricGroups_, ABMetricGroups) };
  ...
  protected:
    std::shared_ptr<vector<ListABMetricGroupsResponseBodyABMetricGroups>> ABMetricGroups_ = nullptr;
