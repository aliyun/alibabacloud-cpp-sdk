...
namespace Models
{
  ...
  public:
    ...
    inline const CloneEngineConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CloneEngineConfigResponseBody) };
    inline CloneEngineConfigResponseBody body() { DARABONBA_PTR_GET(body_, CloneEngineConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CloneEngineConfigResponseBody> body_ = nullptr;
  };
