...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceResourcesResponseBody) };
    inline ListInstanceResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstanceResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstanceResourcesResponseBody> body_ {};
  };
