...
namespace Models
{
  ...
  public:
    ...
    inline const ListCalculationJobsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListCalculationJobsResponseBody) };
    inline ListCalculationJobsResponseBody body() { DARABONBA_PTR_GET(body_, ListCalculationJobsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListCalculationJobsResponseBody> body_ = nullptr;
  };
