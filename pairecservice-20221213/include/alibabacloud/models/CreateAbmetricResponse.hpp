...
namespace Models
{
  ...
  public:
    ...
    inline const CreateABMetricResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateABMetricResponseBody) };
    inline CreateABMetricResponseBody body() { DARABONBA_PTR_GET(body_, CreateABMetricResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateABMetricResponseBody> body_ = nullptr;
  };
