...
namespace Models
{
  ...
  public:
    ...
    inline const GetExperimentGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetExperimentGroupResponseBody) };
    inline GetExperimentGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetExperimentGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetExperimentGroupResponseBody> body_ {};
  };
