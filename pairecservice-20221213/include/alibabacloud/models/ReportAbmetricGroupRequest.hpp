...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->baseExperimentId_ != nullptr
    ...
    inline string baseExperimentId() const { DARABONBA_PTR_GET_DEFAULT(baseExperimentId_, "") };
    ...
    inline string dimensionFields() const { DARABONBA_PTR_GET_DEFAULT(dimensionFields_, "") };
    ...
    inline string experimentIds() const { DARABONBA_PTR_GET_DEFAULT(experimentIds_, "") };
    ...
    inline string timeStatisticsMethod() const { DARABONBA_PTR_GET_DEFAULT(timeStatisticsMethod_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> baseExperimentId_ = nullptr;
    std::shared_ptr<string> dimensionFields_ = nullptr;
    std::shared_ptr<string> endDate_ = nullptr;
    std::shared_ptr<string> experimentGroupId_ = nullptr;
    // This parameter is required.
    std::shared_ptr<string> experimentIds_ = nullptr;
    // This parameter is required.
    ...
    std::shared_ptr<string> timeStatisticsMethod_ = nullptr;
  };
