...
namespace Models
{
  ...
  public:
    ...
    inline const ReleaseTrafficControlTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ReleaseTrafficControlTaskResponseBody) };
    inline ReleaseTrafficControlTaskResponseBody body() { DARABONBA_PTR_GET(body_, ReleaseTrafficControlTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ReleaseTrafficControlTaskResponseBody> body_ = nullptr;
  };
