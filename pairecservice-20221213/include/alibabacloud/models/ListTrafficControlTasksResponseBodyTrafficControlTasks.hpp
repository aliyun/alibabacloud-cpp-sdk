...
#ifndef ALIBABACLOUD_MODELS_LISTTRAFFICCONTROLTASKSRESPONSEBODYTRAFFICCONTROLTASKS_HPP_
#define ALIBABACLOUD_MODELS_LISTTRAFFICCONTROLTASKSRESPONSEBODYTRAFFICCONTROLTASKS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListTrafficControlTasksResponseBodyTrafficControlTasks& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListTrafficControlTasksResponseBodyTrafficControlTasks& obj) { 
    ...
    ListTrafficControlTasksResponseBodyTrafficControlTasks() = default ;
    ListTrafficControlTasksResponseBodyTrafficControlTasks(const ListTrafficControlTasksResponseBodyTrafficControlTasks &) = default ;
    ListTrafficControlTasksResponseBodyTrafficControlTasks(ListTrafficControlTasksResponseBodyTrafficControlTasks &&) = default ;
    ListTrafficControlTasksResponseBodyTrafficControlTasks(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListTrafficControlTasksResponseBodyTrafficControlTasks() = default ;
    ListTrafficControlTasksResponseBodyTrafficControlTasks& operator=(const ListTrafficControlTasksResponseBodyTrafficControlTasks &) = default ;
    ListTrafficControlTasksResponseBodyTrafficControlTasks& operator=(ListTrafficControlTasksResponseBodyTrafficControlTasks &&) = default ;
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setBehaviorTableMetaId(string behaviorTableMetaId) { DARABONBA_PTR_SET_VALUE(behaviorTableMetaId_, behaviorTableMetaId) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setControlGranularity(string controlGranularity) { DARABONBA_PTR_SET_VALUE(controlGranularity_, controlGranularity) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setControlLogic(string controlLogic) { DARABONBA_PTR_SET_VALUE(controlLogic_, controlLogic) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setControlType(string controlType) { DARABONBA_PTR_SET_VALUE(controlType_, controlType) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline const vector<int32_t> & effectiveSceneNames() const { DARABONBA_PTR_GET_CONST(effectiveSceneNames_, vector<int32_t>) };
    inline vector<int32_t> effectiveSceneNames() { DARABONBA_PTR_GET(effectiveSceneNames_, vector<int32_t>) };
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setEffectiveSceneNames(const vector<int32_t> & effectiveSceneNames) { DARABONBA_PTR_SET_VALUE(effectiveSceneNames_, effectiveSceneNames) };
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setEffectiveSceneNames(vector<int32_t> && effectiveSceneNames) { DARABONBA_PTR_SET_RVALUE(effectiveSceneNames_, effectiveSceneNames) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setEverPublished(bool everPublished) { DARABONBA_PTR_SET_VALUE(everPublished_, everPublished) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setExecutionTime(string executionTime) { DARABONBA_PTR_SET_VALUE(executionTime_, executionTime) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setFlinkResourceId(string flinkResourceId) { DARABONBA_PTR_SET_VALUE(flinkResourceId_, flinkResourceId) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setFlinkResourceName(string flinkResourceName) { DARABONBA_PTR_SET_VALUE(flinkResourceName_, flinkResourceName) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setGmtCreateTime(string gmtCreateTime) { DARABONBA_PTR_SET_VALUE(gmtCreateTime_, gmtCreateTime) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setGmtModifiedTime(string gmtModifiedTime) { DARABONBA_PTR_SET_VALUE(gmtModifiedTime_, gmtModifiedTime) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setItemConditionArray(string itemConditionArray) { DARABONBA_PTR_SET_VALUE(itemConditionArray_, itemConditionArray) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setItemConditionExpress(string itemConditionExpress) { DARABONBA_PTR_SET_VALUE(itemConditionExpress_, itemConditionExpress) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setItemConditionType(string itemConditionType) { DARABONBA_PTR_SET_VALUE(itemConditionType_, itemConditionType) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setItemTableMetaId(string itemTableMetaId) { DARABONBA_PTR_SET_VALUE(itemTableMetaId_, itemTableMetaId) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setPreExperimentIds(string preExperimentIds) { DARABONBA_PTR_SET_VALUE(preExperimentIds_, preExperimentIds) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setPrepubStatus(string prepubStatus) { DARABONBA_PTR_SET_VALUE(prepubStatus_, prepubStatus) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setProdExperimentIds(string prodExperimentIds) { DARABONBA_PTR_SET_VALUE(prodExperimentIds_, prodExperimentIds) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setProductStatus(string productStatus) { DARABONBA_PTR_SET_VALUE(productStatus_, productStatus) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setSceneName(string sceneName) { DARABONBA_PTR_SET_VALUE(sceneName_, sceneName) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setServiceIds(const vector<string> & serviceIds) { DARABONBA_PTR_SET_VALUE(serviceIds_, serviceIds) };
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setServiceIds(vector<string> && serviceIds) { DARABONBA_PTR_SET_RVALUE(serviceIds_, serviceIds) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline string statisBahaviorConditionExpress() const { DARABONBA_PTR_GET_DEFAULT(statisBahaviorConditionExpress_, "") };
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setStatisBahaviorConditionExpress(string statisBahaviorConditionExpress) { DARABONBA_PTR_SET_VALUE(statisBahaviorConditionExpress_, statisBahaviorConditionExpress) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setStatisBehaviorConditionArray(string statisBehaviorConditionArray) { DARABONBA_PTR_SET_VALUE(statisBehaviorConditionArray_, statisBehaviorConditionArray) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setStatisBehaviorConditionType(string statisBehaviorConditionType) { DARABONBA_PTR_SET_VALUE(statisBehaviorConditionType_, statisBehaviorConditionType) };
    ...
    inline const vector<Models::ListTrafficControlTasksResponseBodyTrafficControlTasksTrafficControlTargets> & trafficControlTargets() const { DARABONBA_PTR_GET_CONST(trafficControlTargets_, vector<Models::ListTrafficControlTasksResponseBodyTrafficControlTasksTrafficControlTargets>) };
    inline vector<Models::ListTrafficControlTasksResponseBodyTrafficControlTasksTrafficControlTargets> trafficControlTargets() { DARABONBA_PTR_GET(trafficControlTargets_, vector<Models::ListTrafficControlTasksResponseBodyTrafficControlTasksTrafficControlTargets>) };
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setTrafficControlTargets(const vector<Models::ListTrafficControlTasksResponseBodyTrafficControlTasksTrafficControlTargets> & trafficControlTargets) { DARABONBA_PTR_SET_VALUE(trafficControlTargets_, trafficControlTargets) };
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setTrafficControlTargets(vector<Models::ListTrafficControlTasksResponseBodyTrafficControlTasksTrafficControlTargets> && trafficControlTargets) { DARABONBA_PTR_SET_RVALUE(trafficControlTargets_, trafficControlTargets) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setTrafficControlTaskId(string trafficControlTaskId) { DARABONBA_PTR_SET_VALUE(trafficControlTaskId_, trafficControlTaskId) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setUserConditionArray(string userConditionArray) { DARABONBA_PTR_SET_VALUE(userConditionArray_, userConditionArray) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setUserConditionExpress(string userConditionExpress) { DARABONBA_PTR_SET_VALUE(userConditionExpress_, userConditionExpress) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setUserConditionType(string userConditionType) { DARABONBA_PTR_SET_VALUE(userConditionType_, userConditionType) };
    ...
    inline ListTrafficControlTasksResponseBodyTrafficControlTasks& setUserTableMetaId(string userTableMetaId) { DARABONBA_PTR_SET_VALUE(userTableMetaId_, userTableMetaId) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::ListTrafficControlTasksResponseBodyTrafficControlTasksTrafficControlTargets>> trafficControlTargets_ = nullptr;
