...
#ifndef ALIBABACLOUD_MODELS_LISTEXPERIMENTGROUPSRESPONSEBODYEXPERIMENTGROUPS_HPP_
#define ALIBABACLOUD_MODELS_LISTEXPERIMENTGROUPSRESPONSEBODYEXPERIMENTGROUPS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListExperimentGroupsResponseBodyExperimentGroups& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListExperimentGroupsResponseBodyExperimentGroups& obj) { 
    ...
    ListExperimentGroupsResponseBodyExperimentGroups() = default ;
    ListExperimentGroupsResponseBodyExperimentGroups(const ListExperimentGroupsResponseBodyExperimentGroups &) = default ;
    ListExperimentGroupsResponseBodyExperimentGroups(ListExperimentGroupsResponseBodyExperimentGroups &&) = default ;
    ListExperimentGroupsResponseBodyExperimentGroups(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListExperimentGroupsResponseBodyExperimentGroups() = default ;
    ListExperimentGroupsResponseBodyExperimentGroups& operator=(const ListExperimentGroupsResponseBodyExperimentGroups &) = default ;
    ListExperimentGroupsResponseBodyExperimentGroups& operator=(ListExperimentGroupsResponseBodyExperimentGroups &&) = default ;
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setConfig(string config) { DARABONBA_PTR_SET_VALUE(config_, config) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setCrowdId(string crowdId) { DARABONBA_PTR_SET_VALUE(crowdId_, crowdId) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setCrowdTargetType(string crowdTargetType) { DARABONBA_PTR_SET_VALUE(crowdTargetType_, crowdTargetType) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setDebugCrowdId(string debugCrowdId) { DARABONBA_PTR_SET_VALUE(debugCrowdId_, debugCrowdId) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setDebugUsers(string debugUsers) { DARABONBA_PTR_SET_VALUE(debugUsers_, debugUsers) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setDistributionTimeDuration(int32_t distributionTimeDuration) { DARABONBA_PTR_SET_VALUE(distributionTimeDuration_, distributionTimeDuration) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setDistributionType(string distributionType) { DARABONBA_PTR_SET_VALUE(distributionType_, distributionType) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setExperimentGroupId(string experimentGroupId) { DARABONBA_PTR_SET_VALUE(experimentGroupId_, experimentGroupId) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setFilter(string filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    ...
    inline string holdingBuckets() const { DARABONBA_PTR_GET_DEFAULT(holdingBuckets_, "") };
    inline ListExperimentGroupsResponseBodyExperimentGroups& setHoldingBuckets(string holdingBuckets) { DARABONBA_PTR_SET_VALUE(holdingBuckets_, holdingBuckets) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setLaboratoryId(string laboratoryId) { DARABONBA_PTR_SET_VALUE(laboratoryId_, laboratoryId) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setLayerId(string layerId) { DARABONBA_PTR_SET_VALUE(layerId_, layerId) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setNeedAA(bool needAA) { DARABONBA_PTR_SET_VALUE(needAA_, needAA) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setOwner(string owner) { DARABONBA_PTR_SET_VALUE(owner_, owner) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setRandomFlow(int64_t randomFlow) { DARABONBA_PTR_SET_VALUE(randomFlow_, randomFlow) };
    ...
    inline string reservedBuckets() const { DARABONBA_PTR_GET_DEFAULT(reservedBuckets_, "") };
    inline ListExperimentGroupsResponseBodyExperimentGroups& setReservedBuckets(string reservedBuckets) { DARABONBA_PTR_SET_VALUE(reservedBuckets_, reservedBuckets) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
    ...
    inline ListExperimentGroupsResponseBodyExperimentGroups& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
  ...
  protected:
    ...
    std::shared_ptr<string> holdingBuckets_ = nullptr;
    ...
    std::shared_ptr<string> reservedBuckets_ = nullptr;
