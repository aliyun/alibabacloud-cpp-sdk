...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentValues_ == nullptr
    ...
    inline     const Darabonba::Json & getCurrentValues() const { DARABONBA_GET(currentValues_) };
    Darabonba::Json & getCurrentValues() { DARABONBA_GET(currentValues_) };
    ...
    inline     const Darabonba::Json & getOutputValues() const { DARABONBA_GET(outputValues_) };
    Darabonba::Json & getOutputValues() { DARABONBA_GET(outputValues_) };
  ...
  protected:
    Darabonba::Json currentValues_ {};
    Darabonba::Json outputValues_ {};
