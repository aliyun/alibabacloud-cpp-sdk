...
namespace Models
{
  ...
  public:
    ...
    inline const GetABMetricGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetABMetricGroupResponseBody) };
    inline GetABMetricGroupResponseBody body() { DARABONBA_PTR_GET(body_, GetABMetricGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetABMetricGroupResponseBody> body_ = nullptr;
  };
