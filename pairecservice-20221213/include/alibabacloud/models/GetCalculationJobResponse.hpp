...
namespace Models
{
  ...
  public:
    ...
    inline const GetCalculationJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetCalculationJobResponseBody) };
    inline GetCalculationJobResponseBody body() { DARABONBA_PTR_GET(body_, GetCalculationJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetCalculationJobResponseBody> body_ = nullptr;
  };
