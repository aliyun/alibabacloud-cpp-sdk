...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSampleConsistencyJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteSampleConsistencyJobResponseBody) };
    inline DeleteSampleConsistencyJobResponseBody body() { DARABONBA_PTR_GET(body_, DeleteSampleConsistencyJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteSampleConsistencyJobResponseBody> body_ = nullptr;
  };
