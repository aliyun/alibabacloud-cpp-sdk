...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyEngineConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApplyEngineConfigResponseBody) };
    inline ApplyEngineConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ApplyEngineConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApplyEngineConfigResponseBody> body_ {};
  };
