...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetResourceRuleResponseBody::RuleItems> & getRuleItems() const { DARABONBA_PTR_GET_CONST(ruleItems_, vector<GetResourceRuleResponseBody::RuleItems>) };
    inline vector<GetResourceRuleResponseBody::RuleItems> getRuleItems() { DARABONBA_PTR_GET(ruleItems_, vector<GetResourceRuleResponseBody::RuleItems>) };
    inline GetResourceRuleResponseBody& setRuleItems(const vector<GetResourceRuleResponseBody::RuleItems> & ruleItems) { DARABONBA_PTR_SET_VALUE(ruleItems_, ruleItems) };
    inline GetResourceRuleResponseBody& setRuleItems(vector<GetResourceRuleResponseBody::RuleItems> && ruleItems) { DARABONBA_PTR_SET_RVALUE(ruleItems_, ruleItems) };
  ...
  protected:
    ...
    shared_ptr<vector<GetResourceRuleResponseBody::RuleItems>> ruleItems_ {};
  };
