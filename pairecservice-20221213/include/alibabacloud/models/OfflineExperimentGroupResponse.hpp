...
namespace Models
{
  ...
  public:
    ...
    inline const OfflineExperimentGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OfflineExperimentGroupResponseBody) };
    inline OfflineExperimentGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, OfflineExperimentGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OfflineExperimentGroupResponseBody> body_ {};
  };
