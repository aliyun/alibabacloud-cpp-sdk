...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFeatureConsistencyCheckJobConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateFeatureConsistencyCheckJobConfigResponseBody) };
    inline CreateFeatureConsistencyCheckJobConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateFeatureConsistencyCheckJobConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateFeatureConsistencyCheckJobConfigResponseBody> body_ {};
  };
