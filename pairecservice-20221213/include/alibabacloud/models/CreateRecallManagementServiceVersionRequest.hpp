...
#ifndef ALIBABACLOUD_MODELS_CREATERECALLMANAGEMENTSERVICEVERSIONREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATERECALLMANAGEMENTSERVICEVERSIONREQUEST_HPP_
...
namespace Models
{
  class CreateRecallManagementServiceVersionRequest : public Darabonba::Model {
  public:
    ...
    CreateRecallManagementServiceVersionRequest(const CreateRecallManagementServiceVersionRequest &) = default ;
    CreateRecallManagementServiceVersionRequest(CreateRecallManagementServiceVersionRequest &&) = default ;
    CreateRecallManagementServiceVersionRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateRecallManagementServiceVersionRequest() = default ;
    CreateRecallManagementServiceVersionRequest& operator=(const CreateRecallManagementServiceVersionRequest &) = default ;
    CreateRecallManagementServiceVersionRequest& operator=(CreateRecallManagementServiceVersionRequest &&) = default ;
    ...
    public:
      ...
      public:
        ...
        inline RecallConfigs& setSortFields(string sortFields) { DARABONBA_PTR_SET_VALUE(sortFields_, sortFields) };
    ...
    inline const CreateRecallManagementServiceVersionRequest::Configs & getConfigs() const { DARABONBA_PTR_GET_CONST(configs_, CreateRecallManagementServiceVersionRequest::Configs) };
    ...
    bool hasSourceRecallManagementServiceVersionId() const { return this->sourceRecallManagementServiceVersionId_ != nullptr;};
    void deleteSourceRecallManagementServiceVersionId() { this->sourceRecallManagementServiceVersionId_ = nullptr;};
    inline string getSourceRecallManagementServiceVersionId() const { DARABONBA_PTR_GET_DEFAULT(sourceRecallManagementServiceVersionId_, "") };
    inline CreateRecallManagementServiceVersionRequest& setSourceRecallManagementServiceVersionId(string sourceRecallManagementServiceVersionId) { DARABONBA_PTR_SET_VALUE(sourceRecallManagementServiceVersionId_, sourceRecallManagementServiceVersionId) };
