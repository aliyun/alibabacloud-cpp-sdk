...
#ifndef ALIBABACLOUD_MODELS_LISTLABORATORIESRESPONSEBODYLABORATORIES_HPP_
#define ALIBABACLOUD_MODELS_LISTLABORATORIESRESPONSEBODYLABORATORIES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListLaboratoriesResponseBodyLaboratories& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListLaboratoriesResponseBodyLaboratories& obj) { 
    ...
    ListLaboratoriesResponseBodyLaboratories() = default ;
    ListLaboratoriesResponseBodyLaboratories(const ListLaboratoriesResponseBodyLaboratories &) = default ;
    ListLaboratoriesResponseBodyLaboratories(ListLaboratoriesResponseBodyLaboratories &&) = default ;
    ListLaboratoriesResponseBodyLaboratories(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListLaboratoriesResponseBodyLaboratories() = default ;
    ListLaboratoriesResponseBodyLaboratories& operator=(const ListLaboratoriesResponseBodyLaboratories &) = default ;
    ListLaboratoriesResponseBodyLaboratories& operator=(ListLaboratoriesResponseBodyLaboratories &&) = default ;
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setBucketCount(int32_t bucketCount) { DARABONBA_PTR_SET_VALUE(bucketCount_, bucketCount) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setBucketType(string bucketType) { DARABONBA_PTR_SET_VALUE(bucketType_, bucketType) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setBuckets(string buckets) { DARABONBA_PTR_SET_VALUE(buckets_, buckets) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setCrowdId(string crowdId) { DARABONBA_PTR_SET_VALUE(crowdId_, crowdId) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setDebugCrowdId(string debugCrowdId) { DARABONBA_PTR_SET_VALUE(debugCrowdId_, debugCrowdId) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setDebugUsers(string debugUsers) { DARABONBA_PTR_SET_VALUE(debugUsers_, debugUsers) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setEnvironment(string environment) { DARABONBA_PTR_SET_VALUE(environment_, environment) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setFilter(string filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setLaboratoryId(string laboratoryId) { DARABONBA_PTR_SET_VALUE(laboratoryId_, laboratoryId) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListLaboratoriesResponseBodyLaboratories& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
