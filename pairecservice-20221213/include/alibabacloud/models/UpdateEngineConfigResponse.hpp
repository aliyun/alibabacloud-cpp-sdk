...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEngineConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEngineConfigResponseBody) };
    inline UpdateEngineConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEngineConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEngineConfigResponseBody> body_ {};
  };
