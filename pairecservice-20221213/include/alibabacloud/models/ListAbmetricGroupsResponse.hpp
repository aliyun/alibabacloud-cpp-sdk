...
namespace Models
{
  ...
  public:
    ...
    inline const ListABMetricGroupsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListABMetricGroupsResponseBody) };
    inline ListABMetricGroupsResponseBody body() { DARABONBA_PTR_GET(body_, ListABMetricGroupsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListABMetricGroupsResponseBody> body_ = nullptr;
  };
