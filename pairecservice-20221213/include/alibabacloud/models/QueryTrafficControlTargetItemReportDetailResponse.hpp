...
namespace Models
{
  ...
  public:
    ...
    inline const QueryTrafficControlTargetItemReportDetailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryTrafficControlTargetItemReportDetailResponseBody) };
    inline QueryTrafficControlTargetItemReportDetailResponseBody body() { DARABONBA_PTR_GET(body_, QueryTrafficControlTargetItemReportDetailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryTrafficControlTargetItemReportDetailResponseBody> body_ = nullptr;
  };
