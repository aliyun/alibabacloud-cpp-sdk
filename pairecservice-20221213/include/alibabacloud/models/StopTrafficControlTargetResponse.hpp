...
namespace Models
{
  ...
  public:
    ...
    inline const StopTrafficControlTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopTrafficControlTargetResponseBody) };
    inline StopTrafficControlTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, StopTrafficControlTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopTrafficControlTargetResponseBody> body_ {};
  };
