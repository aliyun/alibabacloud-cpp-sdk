...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->paramId_ == nullptr
        && this->requestId_ == nullptr; };
    // paramId Field Functions 
    bool hasParamId() const { return this->paramId_ != nullptr;};
    void deleteParamId() { this->paramId_ = nullptr;};
    inline int64_t getParamId() const { DARABONBA_PTR_GET_DEFAULT(paramId_, 0L) };
