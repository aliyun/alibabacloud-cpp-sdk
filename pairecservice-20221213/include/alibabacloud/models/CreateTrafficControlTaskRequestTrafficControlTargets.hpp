...
#ifndef ALIBABACLOUD_MODELS_CREATETRAFFICCONTROLTASKREQUESTTRAFFICCONTROLTARGETS_HPP_
#define ALIBABACLOUD_MODELS_CREATETRAFFICCONTROLTASKREQUESTTRAFFICCONTROLTARGETS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTrafficControlTaskRequestTrafficControlTargets& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTrafficControlTaskRequestTrafficControlTargets& obj) { 
    ...
    CreateTrafficControlTaskRequestTrafficControlTargets() = default ;
    CreateTrafficControlTaskRequestTrafficControlTargets(const CreateTrafficControlTaskRequestTrafficControlTargets &) = default ;
    CreateTrafficControlTaskRequestTrafficControlTargets(CreateTrafficControlTaskRequestTrafficControlTargets &&) = default ;
    CreateTrafficControlTaskRequestTrafficControlTargets(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTrafficControlTaskRequestTrafficControlTargets() = default ;
    CreateTrafficControlTaskRequestTrafficControlTargets& operator=(const CreateTrafficControlTaskRequestTrafficControlTargets &) = default ;
    CreateTrafficControlTaskRequestTrafficControlTargets& operator=(CreateTrafficControlTaskRequestTrafficControlTargets &&) = default ;
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setEvent(string event) { DARABONBA_PTR_SET_VALUE(event_, event) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setItemConditionArray(string itemConditionArray) { DARABONBA_PTR_SET_VALUE(itemConditionArray_, itemConditionArray) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setItemConditionExpress(string itemConditionExpress) { DARABONBA_PTR_SET_VALUE(itemConditionExpress_, itemConditionExpress) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setItemConditionType(string itemConditionType) { DARABONBA_PTR_SET_VALUE(itemConditionType_, itemConditionType) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setNewProductRegulation(bool newProductRegulation) { DARABONBA_PTR_SET_VALUE(newProductRegulation_, newProductRegulation) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setRecallName(string recallName) { DARABONBA_PTR_SET_VALUE(recallName_, recallName) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setStatisPeriod(string statisPeriod) { DARABONBA_PTR_SET_VALUE(statisPeriod_, statisPeriod) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setToleranceValue(int64_t toleranceValue) { DARABONBA_PTR_SET_VALUE(toleranceValue_, toleranceValue) };
    ...
    inline CreateTrafficControlTaskRequestTrafficControlTargets& setValue(float value) { DARABONBA_PTR_SET_VALUE(value_, value) };
