...
#ifndef ALIBABACLOUD_MODELS_CREATETABLEMETAREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATETABLEMETAREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTableMetaRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTableMetaRequest& obj) { 
    ...
    CreateTableMetaRequest() = default ;
    CreateTableMetaRequest(const CreateTableMetaRequest &) = default ;
    CreateTableMetaRequest(CreateTableMetaRequest &&) = default ;
    CreateTableMetaRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTableMetaRequest() = default ;
    CreateTableMetaRequest& operator=(const CreateTableMetaRequest &) = default ;
    CreateTableMetaRequest& operator=(CreateTableMetaRequest &&) = default ;
    ...
    inline CreateTableMetaRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };


    // fields Field Functions 
    bool hasFields() const { return this->fields_ != nullptr;};
    void deleteFields() { this->fields_ = nullptr;};
    inline const vector<CreateTableMetaRequest::Fields> & getFields() const { DARABONBA_PTR_GET_CONST(fields_, vector<CreateTableMetaRequest::Fields>) };
    inline vector<CreateTableMetaRequest::Fields> getFields() { DARABONBA_PTR_GET(fields_, vector<CreateTableMetaRequest::Fields>) };
    inline CreateTableMetaRequest& setFields(const vector<CreateTableMetaRequest::Fields> & fields) { DARABONBA_PTR_SET_VALUE(fields_, fields) };
    inline CreateTableMetaRequest& setFields(vector<CreateTableMetaRequest::Fields> && fields) { DARABONBA_PTR_SET_RVALUE(fields_, fields) };
    ...
    inline CreateTableMetaRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline CreateTableMetaRequest& setModule(string module) { DARABONBA_PTR_SET_VALUE(module_, module) };
    ...
    void deleteName() { this->name_ = nullptr;};
    inline string getName() const { DARABONBA_PTR_GET_DEFAULT(name_, "") };
    inline CreateTableMetaRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateTableMetaRequest& setResourceId(string resourceId) { DARABONBA_PTR_SET_VALUE(resourceId_, resourceId) };
    ...
    inline CreateTableMetaRequest& setTableName(string tableName) { DARABONBA_PTR_SET_VALUE(tableName_, tableName) };
  ...
  protected:
    ...
    // This parameter is required.
    shared_ptr<vector<CreateTableMetaRequest::Fields>> fields_ {};
    // This parameter is required.
