...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTrafficControlTaskTrafficResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTrafficControlTaskTrafficResponseBody) };
    inline UpdateTrafficControlTaskTrafficResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTrafficControlTaskTrafficResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTrafficControlTaskTrafficResponseBody> body_ {};
  };
