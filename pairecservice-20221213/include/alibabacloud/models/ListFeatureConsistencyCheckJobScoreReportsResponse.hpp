...
namespace Models
{
  ...
  public:
    ...
    inline const ListFeatureConsistencyCheckJobScoreReportsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFeatureConsistencyCheckJobScoreReportsResponseBody) };
    inline ListFeatureConsistencyCheckJobScoreReportsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFeatureConsistencyCheckJobScoreReportsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFeatureConsistencyCheckJobScoreReportsResponseBody> body_ {};
  };
