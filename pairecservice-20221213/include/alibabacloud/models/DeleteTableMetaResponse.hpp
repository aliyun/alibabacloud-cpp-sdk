...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTableMetaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTableMetaResponseBody) };
    inline DeleteTableMetaResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTableMetaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTableMetaResponseBody> body_ {};
  };
