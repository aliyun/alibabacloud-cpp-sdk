...
#ifndef ALIBABACLOUD_MODELS_UPDATETRAFFICCONTROLTASKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATETRAFFICCONTROLTASKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateTrafficControlTaskRequest& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(StatisBaeaviorConditionArray, statisBaeaviorConditionArray_);
    ...
    friend void from_json(const Darabonba::Json& j, UpdateTrafficControlTaskRequest& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(StatisBaeaviorConditionArray, statisBaeaviorConditionArray_);
    ...
    UpdateTrafficControlTaskRequest() = default ;
    UpdateTrafficControlTaskRequest(const UpdateTrafficControlTaskRequest &) = default ;
    UpdateTrafficControlTaskRequest(UpdateTrafficControlTaskRequest &&) = default ;
    UpdateTrafficControlTaskRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateTrafficControlTaskRequest() = default ;
    UpdateTrafficControlTaskRequest& operator=(const UpdateTrafficControlTaskRequest &) = default ;
    UpdateTrafficControlTaskRequest& operator=(UpdateTrafficControlTaskRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->behaviorTableMetaId_ == nullptr
        ...
        && this->statisBaeaviorConditionArray_ == nullptr && this->statisBehaviorConditionArray_ == nullptr && this->statisBehaviorConditionExpress_ == nullptr && this->statisBehaviorConditionType_ == nullptr && this->trafficControlTargets_ == nullptr
    ...
    inline UpdateTrafficControlTaskRequest& setBehaviorTableMetaId(string behaviorTableMetaId) { DARABONBA_PTR_SET_VALUE(behaviorTableMetaId_, behaviorTableMetaId) };
    ...
    inline UpdateTrafficControlTaskRequest& setControlGranularity(string controlGranularity) { DARABONBA_PTR_SET_VALUE(controlGranularity_, controlGranularity) };
    ...
    inline UpdateTrafficControlTaskRequest& setControlLogic(string controlLogic) { DARABONBA_PTR_SET_VALUE(controlLogic_, controlLogic) };
    ...
    inline UpdateTrafficControlTaskRequest& setControlType(string controlType) { DARABONBA_PTR_SET_VALUE(controlType_, controlType) };
    ...
    inline UpdateTrafficControlTaskRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline UpdateTrafficControlTaskRequest& setEffectiveSceneIds(const vector<int32_t> & effectiveSceneIds) { DARABONBA_PTR_SET_VALUE(effectiveSceneIds_, effectiveSceneIds) };
    inline UpdateTrafficControlTaskRequest& setEffectiveSceneIds(vector<int32_t> && effectiveSceneIds) { DARABONBA_PTR_SET_RVALUE(effectiveSceneIds_, effectiveSceneIds) };
    ...
    void deleteEndTime() { this->endTime_ = nullptr;};
    inline string getEndTime() const { DARABONBA_PTR_GET_DEFAULT(endTime_, "") };
    inline UpdateTrafficControlTaskRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline UpdateTrafficControlTaskRequest& setExecutionTime(string executionTime) { DARABONBA_PTR_SET_VALUE(executionTime_, executionTime) };
    ...
    inline UpdateTrafficControlTaskRequest& setFlinkResourceId(string flinkResourceId) { DARABONBA_PTR_SET_VALUE(flinkResourceId_, flinkResourceId) };
    ...
    inline UpdateTrafficControlTaskRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    void deleteItemConditionArray() { this->itemConditionArray_ = nullptr;};
    inline string getItemConditionArray() const { DARABONBA_PTR_GET_DEFAULT(itemConditionArray_, "") };
    inline UpdateTrafficControlTaskRequest& setItemConditionArray(string itemConditionArray) { DARABONBA_PTR_SET_VALUE(itemConditionArray_, itemConditionArray) };
    ...
    void deleteItemConditionExpress() { this->itemConditionExpress_ = nullptr;};
    inline string getItemConditionExpress() const { DARABONBA_PTR_GET_DEFAULT(itemConditionExpress_, "") };
    inline UpdateTrafficControlTaskRequest& setItemConditionExpress(string itemConditionExpress) { DARABONBA_PTR_SET_VALUE(itemConditionExpress_, itemConditionExpress) };
    ...
    void deleteItemConditionType() { this->itemConditionType_ = nullptr;};
    inline string getItemConditionType() const { DARABONBA_PTR_GET_DEFAULT(itemConditionType_, "") };
    inline UpdateTrafficControlTaskRequest& setItemConditionType(string itemConditionType) { DARABONBA_PTR_SET_VALUE(itemConditionType_, itemConditionType) };
    ...
    inline UpdateTrafficControlTaskRequest& setItemTableMetaId(string itemTableMetaId) { DARABONBA_PTR_SET_VALUE(itemTableMetaId_, itemTableMetaId) };
    ...
    void deleteName() { this->name_ = nullptr;};
    inline string getName() const { DARABONBA_PTR_GET_DEFAULT(name_, "") };
    inline UpdateTrafficControlTaskRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline UpdateTrafficControlTaskRequest& setPreExperimentIds(string preExperimentIds) { DARABONBA_PTR_SET_VALUE(preExperimentIds_, preExperimentIds) };
    ...
    inline UpdateTrafficControlTaskRequest& setProdExperimentIds(string prodExperimentIds) { DARABONBA_PTR_SET_VALUE(prodExperimentIds_, prodExperimentIds) };
    ...
    inline UpdateTrafficControlTaskRequest& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
    ...
    inline UpdateTrafficControlTaskRequest& setServiceId(string serviceId) { DARABONBA_PTR_SET_VALUE(serviceId_, serviceId) };
    ...
    inline UpdateTrafficControlTaskRequest& setServiceIds(const vector<int32_t> & serviceIds) { DARABONBA_PTR_SET_VALUE(serviceIds_, serviceIds) };
    inline UpdateTrafficControlTaskRequest& setServiceIds(vector<int32_t> && serviceIds) { DARABONBA_PTR_SET_RVALUE(serviceIds_, serviceIds) };
    ...
    void deleteStartTime() { this->startTime_ = nullptr;};
    inline string getStartTime() const { DARABONBA_PTR_GET_DEFAULT(startTime_, "") };
    inline UpdateTrafficControlTaskRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };


    // statisBaeaviorConditionArray Field Functions 
    bool hasStatisBaeaviorConditionArray() const { return this->statisBaeaviorConditionArray_ != nullptr;};
    void deleteStatisBaeaviorConditionArray() { this->statisBaeaviorConditionArray_ = nullptr;};
    inline string getStatisBaeaviorConditionArray() const { DARABONBA_PTR_GET_DEFAULT(statisBaeaviorConditionArray_, "") };
    inline UpdateTrafficControlTaskRequest& setStatisBaeaviorConditionArray(string statisBaeaviorConditionArray) { DARABONBA_PTR_SET_VALUE(statisBaeaviorConditionArray_, statisBaeaviorConditionArray) };
    ...
    inline UpdateTrafficControlTaskRequest& setStatisBehaviorConditionArray(string statisBehaviorConditionArray) { DARABONBA_PTR_SET_VALUE(statisBehaviorConditionArray_, statisBehaviorConditionArray) };
    ...
    inline UpdateTrafficControlTaskRequest& setStatisBehaviorConditionExpress(string statisBehaviorConditionExpress) { DARABONBA_PTR_SET_VALUE(statisBehaviorConditionExpress_, statisBehaviorConditionExpress) };
    ...
    inline UpdateTrafficControlTaskRequest& setStatisBehaviorConditionType(string statisBehaviorConditionType) { DARABONBA_PTR_SET_VALUE(statisBehaviorConditionType_, statisBehaviorConditionType) };
    ...
    inline const vector<UpdateTrafficControlTaskRequest::TrafficControlTargets> & getTrafficControlTargets() const { DARABONBA_PTR_GET_CONST(trafficControlTargets_, vector<UpdateTrafficControlTaskRequest::TrafficControlTargets>) };
    inline vector<UpdateTrafficControlTaskRequest::TrafficControlTargets> getTrafficControlTargets() { DARABONBA_PTR_GET(trafficControlTargets_, vector<UpdateTrafficControlTaskRequest::TrafficControlTargets>) };
    inline UpdateTrafficControlTaskRequest& setTrafficControlTargets(const vector<UpdateTrafficControlTaskRequest::TrafficControlTargets> & trafficControlTargets) { DARABONBA_PTR_SET_VALUE(trafficControlTargets_, trafficControlTargets) };
    inline UpdateTrafficControlTaskRequest& setTrafficControlTargets(vector<UpdateTrafficControlTaskRequest::TrafficControlTargets> && trafficControlTargets) { DARABONBA_PTR_SET_RVALUE(trafficControlTargets_, trafficControlTargets) };
    ...
    inline UpdateTrafficControlTaskRequest& setUserConditionArray(string userConditionArray) { DARABONBA_PTR_SET_VALUE(userConditionArray_, userConditionArray) };
    ...
    inline UpdateTrafficControlTaskRequest& setUserConditionExpress(string userConditionExpress) { DARABONBA_PTR_SET_VALUE(userConditionExpress_, userConditionExpress) };
    ...
    inline UpdateTrafficControlTaskRequest& setUserConditionType(string userConditionType) { DARABONBA_PTR_SET_VALUE(userConditionType_, userConditionType) };
    ...
    inline UpdateTrafficControlTaskRequest& setUserTableMetaId(string userTableMetaId) { DARABONBA_PTR_SET_VALUE(userTableMetaId_, userTableMetaId) };
