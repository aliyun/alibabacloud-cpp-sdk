...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->behaviorTableMetaId_ != nullptr
        ...
        && this->statisBaeaviorConditionArray_ != nullptr && this->statisBehaviorConditionExpress_ != nullptr && this->statisBehaviorConditionType_ != nullptr && this->trafficControlTargets_ != nullptr && this->userConditionArray_ != nullptr
    ...
    inline string statisBaeaviorConditionArray() const { DARABONBA_PTR_GET_DEFAULT(statisBaeaviorConditionArray_, "") };
    ...
    inline const vector<UpdateTrafficControlTaskRequestTrafficControlTargets> & trafficControlTargets() const { DARABONBA_PTR_GET_CONST(trafficControlTargets_, vector<UpdateTrafficControlTaskRequestTrafficControlTargets>) };
    inline vector<UpdateTrafficControlTaskRequestTrafficControlTargets> trafficControlTargets() { DARABONBA_PTR_GET(trafficControlTargets_, vector<UpdateTrafficControlTaskRequestTrafficControlTargets>) };
    inline UpdateTrafficControlTaskRequest& setTrafficControlTargets(const vector<UpdateTrafficControlTaskRequestTrafficControlTargets> & trafficControlTargets) { DARABONBA_PTR_SET_VALUE(trafficControlTargets_, trafficControlTargets) };
    inline UpdateTrafficControlTaskRequest& setTrafficControlTargets(vector<UpdateTrafficControlTaskRequestTrafficControlTargets> && trafficControlTargets) { DARABONBA_PTR_SET_RVALUE(trafficControlTargets_, trafficControlTargets) };
  ...
  protected:
    ...
    std::shared_ptr<string> statisBaeaviorConditionArray_ = nullptr;
    std::shared_ptr<string> statisBehaviorConditionExpress_ = nullptr;
    std::shared_ptr<string> statisBehaviorConditionType_ = nullptr;
    std::shared_ptr<vector<UpdateTrafficControlTaskRequestTrafficControlTargets>> trafficControlTargets_ = nullptr;
