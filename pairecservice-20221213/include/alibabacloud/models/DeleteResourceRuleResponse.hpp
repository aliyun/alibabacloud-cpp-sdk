...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteResourceRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteResourceRuleResponseBody) };
    inline DeleteResourceRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteResourceRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteResourceRuleResponseBody> body_ {};
  };
