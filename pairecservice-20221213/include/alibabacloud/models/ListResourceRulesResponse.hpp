...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceRulesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListResourceRulesResponseBody) };
    inline ListResourceRulesResponseBody body() { DARABONBA_PTR_GET(body_, ListResourceRulesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListResourceRulesResponseBody> body_ = nullptr;
  };
