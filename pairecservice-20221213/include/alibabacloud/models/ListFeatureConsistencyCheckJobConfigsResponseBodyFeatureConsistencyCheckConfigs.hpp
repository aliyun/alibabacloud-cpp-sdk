...
#ifndef ALIBABACLOUD_MODELS_LISTFEATURECONSISTENCYCHECKJOBCONFIGSRESPONSEBODYFEATURECONSISTENCYCHECKCONFIGS_HPP_
#define ALIBABACLOUD_MODELS_LISTFEATURECONSISTENCYCHECKJOBCONFIGSRESPONSEBODYFEATURECONSISTENCYCHECKCONFIGS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& obj) { 
    ...
    ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs() = default ;
    ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs(const ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs &) = default ;
    ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs(ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs &&) = default ;
    ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs() = default ;
    ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& operator=(const ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs &) = default ;
    ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& operator=(ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs &&) = default ;
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setCompareFeature(bool compareFeature) { DARABONBA_PTR_SET_VALUE(compareFeature_, compareFeature) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setDatasetId(string datasetId) { DARABONBA_PTR_SET_VALUE(datasetId_, datasetId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setDatasetMountPath(string datasetMountPath) { DARABONBA_PTR_SET_VALUE(datasetMountPath_, datasetMountPath) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setDatasetName(string datasetName) { DARABONBA_PTR_SET_VALUE(datasetName_, datasetName) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setDatasetType(string datasetType) { DARABONBA_PTR_SET_VALUE(datasetType_, datasetType) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setDatasetUri(string datasetUri) { DARABONBA_PTR_SET_VALUE(datasetUri_, datasetUri) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setDefaultRoute(string defaultRoute) { DARABONBA_PTR_SET_VALUE(defaultRoute_, defaultRoute) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setEasServiceName(string easServiceName) { DARABONBA_PTR_SET_VALUE(easServiceName_, easServiceName) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setEasyRecPackagePath(string easyRecPackagePath) { DARABONBA_PTR_SET_VALUE(easyRecPackagePath_, easyRecPackagePath) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setEasyRecVersion(string easyRecVersion) { DARABONBA_PTR_SET_VALUE(easyRecVersion_, easyRecVersion) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFeatureConsistencyCheckJobConfigId(string featureConsistencyCheckJobConfigId) { DARABONBA_PTR_SET_VALUE(featureConsistencyCheckJobConfigId_, featureConsistencyCheckJobConfigId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFeatureDisplayExclude(string featureDisplayExclude) { DARABONBA_PTR_SET_VALUE(featureDisplayExclude_, featureDisplayExclude) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFeatureLandingResourceId(string featureLandingResourceId) { DARABONBA_PTR_SET_VALUE(featureLandingResourceId_, featureLandingResourceId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFeatureLandingResourceUri(string featureLandingResourceUri) { DARABONBA_PTR_SET_VALUE(featureLandingResourceUri_, featureLandingResourceUri) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFeaturePriority(string featurePriority) { DARABONBA_PTR_SET_VALUE(featurePriority_, featurePriority) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFeatureStoreItemId(string featureStoreItemId) { DARABONBA_PTR_SET_VALUE(featureStoreItemId_, featureStoreItemId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFeatureStoreModelId(string featureStoreModelId) { DARABONBA_PTR_SET_VALUE(featureStoreModelId_, featureStoreModelId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFeatureStoreProjectId(string featureStoreProjectId) { DARABONBA_PTR_SET_VALUE(featureStoreProjectId_, featureStoreProjectId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFeatureStoreProjectName(string featureStoreProjectName) { DARABONBA_PTR_SET_VALUE(featureStoreProjectName_, featureStoreProjectName) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFeatureStoreSeqFeatureView(string featureStoreSeqFeatureView) { DARABONBA_PTR_SET_VALUE(featureStoreSeqFeatureView_, featureStoreSeqFeatureView) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFeatureStoreUserId(string featureStoreUserId) { DARABONBA_PTR_SET_VALUE(featureStoreUserId_, featureStoreUserId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFgJarVersion(string fgJarVersion) { DARABONBA_PTR_SET_VALUE(fgJarVersion_, fgJarVersion) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setFgJsonFileName(string fgJsonFileName) { DARABONBA_PTR_SET_VALUE(fgJsonFileName_, fgJsonFileName) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setGenerateZip(bool generateZip) { DARABONBA_PTR_SET_VALUE(generateZip_, generateZip) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setGmtCreateTime(string gmtCreateTime) { DARABONBA_PTR_SET_VALUE(gmtCreateTime_, gmtCreateTime) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setGmtModifiedTime(string gmtModifiedTime) { DARABONBA_PTR_SET_VALUE(gmtModifiedTime_, gmtModifiedTime) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setItemIdField(string itemIdField) { DARABONBA_PTR_SET_VALUE(itemIdField_, itemIdField) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setItemTable(string itemTable) { DARABONBA_PTR_SET_VALUE(itemTable_, itemTable) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setItemTablePartitionField(string itemTablePartitionField) { DARABONBA_PTR_SET_VALUE(itemTablePartitionField_, itemTablePartitionField) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setItemTablePartitionFieldFormat(string itemTablePartitionFieldFormat) { DARABONBA_PTR_SET_VALUE(itemTablePartitionFieldFormat_, itemTablePartitionFieldFormat) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setLatestJobGmtSamplingEndTime(string latestJobGmtSamplingEndTime) { DARABONBA_PTR_SET_VALUE(latestJobGmtSamplingEndTime_, latestJobGmtSamplingEndTime) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setLatestJobGmtSamplingStartTime(string latestJobGmtSamplingStartTime) { DARABONBA_PTR_SET_VALUE(latestJobGmtSamplingStartTime_, latestJobGmtSamplingStartTime) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setLatestJobId(string latestJobId) { DARABONBA_PTR_SET_VALUE(latestJobId_, latestJobId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setOssBucket(string ossBucket) { DARABONBA_PTR_SET_VALUE(ossBucket_, ossBucket) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setOssResourceId(string ossResourceId) { DARABONBA_PTR_SET_VALUE(ossResourceId_, ossResourceId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setPredictWorkerCount(int32_t predictWorkerCount) { DARABONBA_PTR_SET_VALUE(predictWorkerCount_, predictWorkerCount) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setPredictWorkerCpu(int32_t predictWorkerCpu) { DARABONBA_PTR_SET_VALUE(predictWorkerCpu_, predictWorkerCpu) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setPredictWorkerMemory(int32_t predictWorkerMemory) { DARABONBA_PTR_SET_VALUE(predictWorkerMemory_, predictWorkerMemory) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setResourceConfig(string resourceConfig) { DARABONBA_PTR_SET_VALUE(resourceConfig_, resourceConfig) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setSampleRate(string sampleRate) { DARABONBA_PTR_SET_VALUE(sampleRate_, sampleRate) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setSceneName(string sceneName) { DARABONBA_PTR_SET_VALUE(sceneName_, sceneName) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setSecurityGroupId(string securityGroupId) { DARABONBA_PTR_SET_VALUE(securityGroupId_, securityGroupId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setServiceId(string serviceId) { DARABONBA_PTR_SET_VALUE(serviceId_, serviceId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setServiceName(string serviceName) { DARABONBA_PTR_SET_VALUE(serviceName_, serviceName) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setSwitchId(string switchId) { DARABONBA_PTR_SET_VALUE(switchId_, switchId) };
    ...
    inline string useFeatureStore() const { DARABONBA_PTR_GET_DEFAULT(useFeatureStore_, "") };
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setUseFeatureStore(string useFeatureStore) { DARABONBA_PTR_SET_VALUE(useFeatureStore_, useFeatureStore) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setUserIdField(string userIdField) { DARABONBA_PTR_SET_VALUE(userIdField_, userIdField) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setUserTable(string userTable) { DARABONBA_PTR_SET_VALUE(userTable_, userTable) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setUserTablePartitionField(string userTablePartitionField) { DARABONBA_PTR_SET_VALUE(userTablePartitionField_, userTablePartitionField) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setUserTablePartitionFieldFormat(string userTablePartitionFieldFormat) { DARABONBA_PTR_SET_VALUE(userTablePartitionFieldFormat_, userTablePartitionFieldFormat) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setWorkflowName(string workflowName) { DARABONBA_PTR_SET_VALUE(workflowName_, workflowName) };
    ...
    inline ListFeatureConsistencyCheckJobConfigsResponseBodyFeatureConsistencyCheckConfigs& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
  ...
  protected:
    ...
    std::shared_ptr<string> useFeatureStore_ = nullptr;
