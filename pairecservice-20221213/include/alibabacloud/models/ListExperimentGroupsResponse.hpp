...
namespace Models
{
  ...
  public:
    ...
    inline const ListExperimentGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExperimentGroupsResponseBody) };
    inline ListExperimentGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExperimentGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExperimentGroupsResponseBody> body_ {};
  };
