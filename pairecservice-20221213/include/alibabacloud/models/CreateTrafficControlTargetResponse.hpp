...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTrafficControlTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTrafficControlTargetResponseBody) };
    inline CreateTrafficControlTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTrafficControlTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTrafficControlTargetResponseBody> body_ {};
  };
