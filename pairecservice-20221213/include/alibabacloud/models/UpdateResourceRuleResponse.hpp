...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateResourceRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateResourceRuleResponseBody) };
    inline UpdateResourceRuleResponseBody body() { DARABONBA_PTR_GET(body_, UpdateResourceRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateResourceRuleResponseBody> body_ = nullptr;
  };
