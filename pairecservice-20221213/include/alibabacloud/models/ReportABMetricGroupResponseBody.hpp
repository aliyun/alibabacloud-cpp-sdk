...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->experimentReport_ == nullptr
    ...
    inline const map<string, ExperimentReportValue> & getExperimentReport() const { DARABONBA_PTR_GET_CONST(experimentReport_, map<string, ExperimentReportValue>) };
    inline map<string, ExperimentReportValue> getExperimentReport() { DARABONBA_PTR_GET(experimentReport_, map<string, ExperimentReportValue>) };
    ...
    inline const vector<string> & getGroupDimension() const { DARABONBA_PTR_GET_CONST(groupDimension_, vector<string>) };
    inline vector<string> getGroupDimension() { DARABONBA_PTR_GET(groupDimension_, vector<string>) };
