...
namespace Models
{
  ...
  public:
    ...
    inline const OfflineLaboratoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OfflineLaboratoryResponseBody) };
    inline OfflineLaboratoryResponseBody getBody() { DARABONBA_PTR_GET(body_, OfflineLaboratoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OfflineLaboratoryResponseBody> body_ {};
  };
