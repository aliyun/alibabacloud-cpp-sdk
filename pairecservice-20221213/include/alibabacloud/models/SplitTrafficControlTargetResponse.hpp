...
namespace Models
{
  ...
  public:
    ...
    inline const SplitTrafficControlTargetResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SplitTrafficControlTargetResponseBody) };
    inline SplitTrafficControlTargetResponseBody body() { DARABONBA_PTR_GET(body_, SplitTrafficControlTargetResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SplitTrafficControlTargetResponseBody> body_ = nullptr;
  };
