...
namespace Models
{
  ...
  public:
    ...
    class SampleConsistencyJobs : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const SampleConsistencyJobs& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, SampleConsistencyJobs& obj) { 
      ...
      SampleConsistencyJobs() = default ;
      SampleConsistencyJobs(const SampleConsistencyJobs &) = default ;
      SampleConsistencyJobs(SampleConsistencyJobs &&) = default ;
      SampleConsistencyJobs(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~SampleConsistencyJobs() = default ;
      SampleConsistencyJobs& operator=(const SampleConsistencyJobs &) = default ;
      SampleConsistencyJobs& operator=(SampleConsistencyJobs &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline SampleConsistencyJobs& setConfig(string config) { DARABONBA_PTR_SET_VALUE(config_, config) };
      ...
      inline SampleConsistencyJobs& setDuration(string duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
      ...
      inline SampleConsistencyJobs& setEasModelServiceName(string easModelServiceName) { DARABONBA_PTR_SET_VALUE(easModelServiceName_, easModelServiceName) };
      ...
      inline SampleConsistencyJobs& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
      ...
      inline SampleConsistencyJobs& setFeatureSaveResourceId(string featureSaveResourceId) { DARABONBA_PTR_SET_VALUE(featureSaveResourceId_, featureSaveResourceId) };
      ...
      inline SampleConsistencyJobs& setGmtCreateTime(string gmtCreateTime) { DARABONBA_PTR_SET_VALUE(gmtCreateTime_, gmtCreateTime) };
      ...
      inline SampleConsistencyJobs& setGmtModifiedTime(string gmtModifiedTime) { DARABONBA_PTR_SET_VALUE(gmtModifiedTime_, gmtModifiedTime) };
      ...
      inline SampleConsistencyJobs& setItemIdField(string itemIdField) { DARABONBA_PTR_SET_VALUE(itemIdField_, itemIdField) };


      // logs Field Functions 
      bool hasLogs() const { return this->logs_ != nullptr;};
      void deleteLogs() { this->logs_ = nullptr;};
      inline string getLogs() const { DARABONBA_PTR_GET_DEFAULT(logs_, "") };
      inline SampleConsistencyJobs& setLogs(string logs) { DARABONBA_PTR_SET_VALUE(logs_, logs) };
      ...
      inline SampleConsistencyJobs& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
      ...
      inline SampleConsistencyJobs& setPartitionField(string partitionField) { DARABONBA_PTR_SET_VALUE(partitionField_, partitionField) };
      ...
      inline SampleConsistencyJobs& setPartitionFieldFormat(string partitionFieldFormat) { DARABONBA_PTR_SET_VALUE(partitionFieldFormat_, partitionFieldFormat) };
      ...
      inline SampleConsistencyJobs& setRequestIdField(string requestIdField) { DARABONBA_PTR_SET_VALUE(requestIdField_, requestIdField) };
      ...
      inline SampleConsistencyJobs& setSampleConsistencyJobId(string sampleConsistencyJobId) { DARABONBA_PTR_SET_VALUE(sampleConsistencyJobId_, sampleConsistencyJobId) };
      ...
      inline SampleConsistencyJobs& setSampleRate(string sampleRate) { DARABONBA_PTR_SET_VALUE(sampleRate_, sampleRate) };
      ...
      inline SampleConsistencyJobs& setSampleTableName(string sampleTableName) { DARABONBA_PTR_SET_VALUE(sampleTableName_, sampleTableName) };
      ...
      inline SampleConsistencyJobs& setSceneId(string sceneId) { DARABONBA_PTR_SET_VALUE(sceneId_, sceneId) };
      ...
      inline SampleConsistencyJobs& setSceneName(string sceneName) { DARABONBA_PTR_SET_VALUE(sceneName_, sceneName) };
      ...
      inline SampleConsistencyJobs& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
      ...
      inline SampleConsistencyJobs& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
      ...
      inline SampleConsistencyJobs& setUserIdField(string userIdField) { DARABONBA_PTR_SET_VALUE(userIdField_, userIdField) };
    ...
    inline const vector<ListSampleConsistencyJobsResponseBody::SampleConsistencyJobs> & getSampleConsistencyJobs() const { DARABONBA_PTR_GET_CONST(sampleConsistencyJobs_, vector<ListSampleConsistencyJobsResponseBody::SampleConsistencyJobs>) };
    inline vector<ListSampleConsistencyJobsResponseBody::SampleConsistencyJobs> getSampleConsistencyJobs() { DARABONBA_PTR_GET(sampleConsistencyJobs_, vector<ListSampleConsistencyJobsResponseBody::SampleConsistencyJobs>) };
    inline ListSampleConsistencyJobsResponseBody& setSampleConsistencyJobs(const vector<ListSampleConsistencyJobsResponseBody::SampleConsistencyJobs> & sampleConsistencyJobs) { DARABONBA_PTR_SET_VALUE(sampleConsistencyJobs_, sampleConsistencyJobs) };
    inline ListSampleConsistencyJobsResponseBody& setSampleConsistencyJobs(vector<ListSampleConsistencyJobsResponseBody::SampleConsistencyJobs> && sampleConsistencyJobs) { DARABONBA_PTR_SET_RVALUE(sampleConsistencyJobs_, sampleConsistencyJobs) };
  ...
  protected:
    ...
    shared_ptr<vector<ListSampleConsistencyJobsResponseBody::SampleConsistencyJobs>> sampleConsistencyJobs_ {};
