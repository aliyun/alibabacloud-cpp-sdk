...
namespace Models
{
  ...
  public:
    ...
    inline const ListCrowdUsersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCrowdUsersResponseBody) };
    inline ListCrowdUsersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCrowdUsersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCrowdUsersResponseBody> body_ {};
  };
