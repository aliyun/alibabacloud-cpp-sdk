...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceDataSourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstanceDataSourcesResponseBody) };
    inline DescribeDBInstanceDataSourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBInstanceDataSourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBInstanceDataSourcesResponseBody> body_ {};
  };
