...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->connectionPrefix_ == nullptr
        && return this->DBInstanceId_ == nullptr && return this->DBInstanceNetType_ == nullptr && return this->regionId_ == nullptr; };
