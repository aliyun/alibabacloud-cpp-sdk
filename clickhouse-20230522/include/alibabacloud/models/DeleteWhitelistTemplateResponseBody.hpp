...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWhitelistTemplateResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DeleteWhitelistTemplateResponseBody::Data) };
    inline DeleteWhitelistTemplateResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DeleteWhitelistTemplateResponseBody::Data) };
    inline DeleteWhitelistTemplateResponseBody& setData(const DeleteWhitelistTemplateResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteWhitelistTemplateResponseBody& setData(DeleteWhitelistTemplateResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    shared_ptr<DeleteWhitelistTemplateResponseBody::Data> data_ {};
