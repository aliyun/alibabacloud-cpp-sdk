...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEndpointsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeEndpointsResponseBodyData) };
    inline DescribeEndpointsResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeEndpointsResponseBodyData) };
    inline DescribeEndpointsResponseBody& setData(const DescribeEndpointsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeEndpointsResponseBody& setData(DescribeEndpointsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned result.
    std::shared_ptr<DescribeEndpointsResponseBodyData> data_ = nullptr;
    // The request ID.
