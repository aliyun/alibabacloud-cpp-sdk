...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->backupSetId_ != nullptr
        ...
        && this->multiZoneShrink_ != nullptr && this->nodeCount_ != nullptr && this->nodeScaleMax_ != nullptr && this->nodeScaleMin_ != nullptr && this->regionId_ != nullptr
    ...
    inline CreateDBInstanceShrinkRequest& setStorageQuota(string storageQuota) { DARABONBA_PTR_SET_VALUE(storageQuota_, storageQuota) };
