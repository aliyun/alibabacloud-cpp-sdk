...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstancesResponseBody) };
    inline DescribeDBInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDBInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDBInstancesResponseBody> body_ {};
  };
