...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->DBInstanceId_ == nullptr
        && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->product_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline DescribeAccountsRequest& setProduct(string product) { DARABONBA_PTR_SET_VALUE(product_, product) };
    ...
    inline DescribeAccountsRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
