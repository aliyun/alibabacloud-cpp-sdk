...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->computingGroupId_ == nullptr
        && this->DBInstanceId_ == nullptr && this->nodeCount_ == nullptr && this->nodeScaleMax_ == nullptr && this->nodeScaleMin_ == nullptr && this->regionId_ == nullptr
        && this->scaleMax_ == nullptr && this->scaleMin_ == nullptr && this->storageQuota_ == nullptr && this->storageType_ == nullptr; };
