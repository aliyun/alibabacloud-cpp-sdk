...
namespace Models
{
  ...
  public:
    ...
    inline const StopDBInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, StopDBInstanceResponseBodyData) };
    inline StopDBInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, StopDBInstanceResponseBodyData) };
    inline StopDBInstanceResponseBody& setData(const StopDBInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StopDBInstanceResponseBody& setData(StopDBInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<StopDBInstanceResponseBodyData> data_ = nullptr;
    // The request ID.
