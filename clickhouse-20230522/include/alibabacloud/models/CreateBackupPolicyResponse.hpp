...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBackupPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBackupPolicyResponseBody) };
    inline CreateBackupPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBackupPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBackupPolicyResponseBody> body_ {};
  };
