...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->computingGroupId_ == nullptr
        && this->connectionString_ == nullptr && this->connectionStringPrefix_ == nullptr && this->DBInstanceId_ == nullptr && this->DBInstanceNetType_ == nullptr && this->disablePorts_ == nullptr
    ...
    inline string getDisablePorts() const { DARABONBA_PTR_GET_DEFAULT(disablePorts_, "") };
