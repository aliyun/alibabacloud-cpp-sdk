...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAccountDescriptionResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyAccountDescriptionResponseBody::Data) };
    inline ModifyAccountDescriptionResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyAccountDescriptionResponseBody::Data) };
    inline ModifyAccountDescriptionResponseBody& setData(const ModifyAccountDescriptionResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyAccountDescriptionResponseBody& setData(ModifyAccountDescriptionResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned data.
    shared_ptr<ModifyAccountDescriptionResponseBody::Data> data_ {};
    // The request ID.
