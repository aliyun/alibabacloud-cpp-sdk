...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeleteDBInstanceResponseBodyData) };
    inline DeleteDBInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, DeleteDBInstanceResponseBodyData) };
    inline DeleteDBInstanceResponseBody& setData(const DeleteDBInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteDBInstanceResponseBody& setData(DeleteDBInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DeleteDBInstanceResponseBodyData> data_ = nullptr;
    // The request ID.
