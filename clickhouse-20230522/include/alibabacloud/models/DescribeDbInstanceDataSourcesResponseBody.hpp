...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceDataSourcesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDBInstanceDataSourcesResponseBodyData) };
    inline DescribeDBInstanceDataSourcesResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDBInstanceDataSourcesResponseBodyData) };
    inline DescribeDBInstanceDataSourcesResponseBody& setData(const DescribeDBInstanceDataSourcesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDBInstanceDataSourcesResponseBody& setData(DescribeDBInstanceDataSourcesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned result.
    std::shared_ptr<DescribeDBInstanceDataSourcesResponseBodyData> data_ = nullptr;
    // The request ID.
