...
namespace Models
{
  ...
  public:
    ...
    inline const RestartDBInstanceResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RestartDBInstanceResponseBodyData) };
    inline RestartDBInstanceResponseBodyData data() { DARABONBA_PTR_GET(data_, RestartDBInstanceResponseBodyData) };
    inline RestartDBInstanceResponseBody& setData(const RestartDBInstanceResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RestartDBInstanceResponseBody& setData(RestartDBInstanceResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<RestartDBInstanceResponseBodyData> data_ = nullptr;
    // The request ID.
