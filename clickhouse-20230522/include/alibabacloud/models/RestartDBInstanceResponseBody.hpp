...
namespace Models
{
  ...
  public:
    ...
    inline const RestartDBInstanceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, RestartDBInstanceResponseBody::Data) };
    inline RestartDBInstanceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, RestartDBInstanceResponseBody::Data) };
    inline RestartDBInstanceResponseBody& setData(const RestartDBInstanceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RestartDBInstanceResponseBody& setData(RestartDBInstanceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    shared_ptr<RestartDBInstanceResponseBody::Data> data_ {};
    // The request ID.
