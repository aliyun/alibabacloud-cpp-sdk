...
namespace Models
{
  ...
  public:
    ...
    inline const StartDBInstanceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, StartDBInstanceResponseBody::Data) };
    inline StartDBInstanceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, StartDBInstanceResponseBody::Data) };
    inline StartDBInstanceResponseBody& setData(const StartDBInstanceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StartDBInstanceResponseBody& setData(StartDBInstanceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    shared_ptr<StartDBInstanceResponseBody::Data> data_ {};
    // The request ID.
