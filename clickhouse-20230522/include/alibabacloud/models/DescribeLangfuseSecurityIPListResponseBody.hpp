...
#ifndef ALIBABACLOUD_MODELS_DESCRIBELANGFUSESECURITYIPLISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBELANGFUSESECURITYIPLISTRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeLangfuseSecurityIPListResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeLangfuseSecurityIPListResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeLangfuseSecurityIPListResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeLangfuseSecurityIPListResponseBody() = default ;
    DescribeLangfuseSecurityIPListResponseBody(const DescribeLangfuseSecurityIPListResponseBody &) = default ;
    DescribeLangfuseSecurityIPListResponseBody(DescribeLangfuseSecurityIPListResponseBody &&) = default ;
    DescribeLangfuseSecurityIPListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeLangfuseSecurityIPListResponseBody() = default ;
    DescribeLangfuseSecurityIPListResponseBody& operator=(const DescribeLangfuseSecurityIPListResponseBody &) = default ;
    DescribeLangfuseSecurityIPListResponseBody& operator=(DescribeLangfuseSecurityIPListResponseBody &&) = default ;
    ...
    inline const DescribeLangfuseSecurityIPListResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeLangfuseSecurityIPListResponseBody::Data) };
    inline DescribeLangfuseSecurityIPListResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeLangfuseSecurityIPListResponseBody::Data) };
    inline DescribeLangfuseSecurityIPListResponseBody& setData(const DescribeLangfuseSecurityIPListResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeLangfuseSecurityIPListResponseBody& setData(DescribeLangfuseSecurityIPListResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeLangfuseSecurityIPListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The returned result.
    shared_ptr<DescribeLangfuseSecurityIPListResponseBody::Data> data_ {};
    // Id of the request
