...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDBInstanceResponseBody) };
    inline DeleteDBInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDBInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDBInstanceResponseBody> body_ {};
  };
