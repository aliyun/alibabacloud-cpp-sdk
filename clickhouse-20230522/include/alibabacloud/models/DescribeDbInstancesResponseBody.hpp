...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstancesResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDBInstancesResponseBodyData) };
    inline DescribeDBInstancesResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDBInstancesResponseBodyData) };
    inline DescribeDBInstancesResponseBody& setData(const DescribeDBInstancesResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDBInstancesResponseBody& setData(DescribeDBInstancesResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned result.
    std::shared_ptr<DescribeDBInstancesResponseBodyData> data_ = nullptr;
    // The request ID.
