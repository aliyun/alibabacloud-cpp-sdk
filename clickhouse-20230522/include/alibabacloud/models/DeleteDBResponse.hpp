...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDBResponseBody) };
    inline DeleteDBResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDBResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDBResponseBody> body_ {};
  };
