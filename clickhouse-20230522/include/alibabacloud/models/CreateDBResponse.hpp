...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDBResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDBResponseBody) };
    inline CreateDBResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDBResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDBResponseBody> body_ {};
  };
