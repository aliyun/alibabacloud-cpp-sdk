...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->attributeType_ != nullptr
        && this->attributeValue_ != nullptr && this->DBInstanceId_ != nullptr && this->product_ != nullptr && this->regionId_ != nullptr; };
