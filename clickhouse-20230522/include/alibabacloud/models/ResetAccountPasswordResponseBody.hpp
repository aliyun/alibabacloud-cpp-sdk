...
namespace Models
{
  ...
  public:
    ...
    inline const ResetAccountPasswordResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ResetAccountPasswordResponseBody::Data) };
    inline ResetAccountPasswordResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ResetAccountPasswordResponseBody::Data) };
    inline ResetAccountPasswordResponseBody& setData(const ResetAccountPasswordResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ResetAccountPasswordResponseBody& setData(ResetAccountPasswordResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The result returned.
    shared_ptr<ResetAccountPasswordResponseBody::Data> data_ {};
    // The request ID.
