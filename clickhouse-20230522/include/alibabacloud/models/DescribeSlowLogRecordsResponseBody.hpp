...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSlowLogRecordsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSlowLogRecordsResponseBodyData) };
    inline DescribeSlowLogRecordsResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSlowLogRecordsResponseBodyData) };
    inline DescribeSlowLogRecordsResponseBody& setData(const DescribeSlowLogRecordsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSlowLogRecordsResponseBody& setData(DescribeSlowLogRecordsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeSlowLogRecordsResponseBodyData> data_ = nullptr;
    // The request ID.
