  ...
  public:
    ...
    public:
      ...
      public:
        ...
        inline ResultSet& setMemoryUsage(int64_t memoryUsage) { DARABONBA_PTR_SET_VALUE(memoryUsage_, memoryUsage) };
        ...
        inline ResultSet& setReadBytes(int64_t readBytes) { DARABONBA_PTR_SET_VALUE(readBytes_, readBytes) };


        // readRows Field Functions 
        bool hasReadRows() const { return this->readRows_ != nullptr;};
        void deleteReadRows() { this->readRows_ = nullptr;};
        inline int64_t getReadRows() const { DARABONBA_PTR_GET_DEFAULT(readRows_, 0L) };
        inline ResultSet& setReadRows(int64_t readRows) { DARABONBA_PTR_SET_VALUE(readRows_, readRows) };
        ...
        inline int64_t getResultBytes() const { DARABONBA_PTR_GET_DEFAULT(resultBytes_, 0L) };
        inline ResultSet& setResultBytes(int64_t resultBytes) { DARABONBA_PTR_SET_VALUE(resultBytes_, resultBytes) };
