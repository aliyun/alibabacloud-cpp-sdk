...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAccountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAccountResponseBody) };
    inline DeleteAccountResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAccountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAccountResponseBody> body_ {};
  };
