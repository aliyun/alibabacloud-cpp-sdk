...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDBResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DeleteDBResponseBodyData) };
    inline DeleteDBResponseBodyData data() { DARABONBA_PTR_GET(data_, DeleteDBResponseBodyData) };
    inline DeleteDBResponseBody& setData(const DeleteDBResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DeleteDBResponseBody& setData(DeleteDBResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DeleteDBResponseBodyData> data_ = nullptr;
    // The request ID.
