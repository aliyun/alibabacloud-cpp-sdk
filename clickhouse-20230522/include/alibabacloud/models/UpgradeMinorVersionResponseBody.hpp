...
namespace Models
{
  ...
  public:
    ...
    inline const UpgradeMinorVersionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpgradeMinorVersionResponseBodyData) };
    inline UpgradeMinorVersionResponseBodyData data() { DARABONBA_PTR_GET(data_, UpgradeMinorVersionResponseBodyData) };
    inline UpgradeMinorVersionResponseBody& setData(const UpgradeMinorVersionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpgradeMinorVersionResponseBody& setData(UpgradeMinorVersionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The returned result.
    std::shared_ptr<UpgradeMinorVersionResponseBodyData> data_ = nullptr;
    // The request ID.
