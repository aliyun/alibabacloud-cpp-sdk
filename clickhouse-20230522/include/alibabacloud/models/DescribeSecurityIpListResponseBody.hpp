...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityIPListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSecurityIPListResponseBodyData) };
    inline DescribeSecurityIPListResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSecurityIPListResponseBodyData) };
    inline DescribeSecurityIPListResponseBody& setData(const DescribeSecurityIPListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSecurityIPListResponseBody& setData(DescribeSecurityIPListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<DescribeSecurityIPListResponseBodyData> data_ = nullptr;
    // The request ID.
