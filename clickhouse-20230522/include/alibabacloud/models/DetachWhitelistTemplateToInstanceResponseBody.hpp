...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      class DetachSuccessedList : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const DetachSuccessedList& obj) { 
          DARABONBA_PTR_TO_JSON(DBInstanceId, DBInstanceId_);
          DARABONBA_PTR_TO_JSON(Templates, templates_);
        };
        friend void from_json(const Darabonba::Json& j, DetachSuccessedList& obj) { 
          DARABONBA_PTR_FROM_JSON(DBInstanceId, DBInstanceId_);
          DARABONBA_PTR_FROM_JSON(Templates, templates_);
        };
        DetachSuccessedList() = default ;
        DetachSuccessedList(const DetachSuccessedList &) = default ;
        DetachSuccessedList(DetachSuccessedList &&) = default ;
        DetachSuccessedList(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~DetachSuccessedList() = default ;
        DetachSuccessedList& operator=(const DetachSuccessedList &) = default ;
        DetachSuccessedList& operator=(DetachSuccessedList &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        void deleteDBInstanceId() { this->DBInstanceId_ = nullptr;};
        inline string getDBInstanceId() const { DARABONBA_PTR_GET_DEFAULT(DBInstanceId_, "") };
        inline DetachSuccessedList& setDBInstanceId(string DBInstanceId) { DARABONBA_PTR_SET_VALUE(DBInstanceId_, DBInstanceId) };


        // templates Field Functions 
        bool hasTemplates() const { return this->templates_ != nullptr;};
        void deleteTemplates() { this->templates_ = nullptr;};
        inline const vector<DetachSuccessedList::Templates> & getTemplates() const { DARABONBA_PTR_GET_CONST(templates_, vector<DetachSuccessedList::Templates>) };
        inline vector<DetachSuccessedList::Templates> getTemplates() { DARABONBA_PTR_GET(templates_, vector<DetachSuccessedList::Templates>) };
        inline DetachSuccessedList& setTemplates(const vector<DetachSuccessedList::Templates> & templates) { DARABONBA_PTR_SET_VALUE(templates_, templates) };
        inline DetachSuccessedList& setTemplates(vector<DetachSuccessedList::Templates> && templates) { DARABONBA_PTR_SET_RVALUE(templates_, templates) };
      ...
      class DetachFailList : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const DetachFailList& obj) { 
          DARABONBA_PTR_TO_JSON(DBInstanceId, DBInstanceId_);
          DARABONBA_PTR_TO_JSON(Reason, reason_);
        };
        friend void from_json(const Darabonba::Json& j, DetachFailList& obj) { 
          DARABONBA_PTR_FROM_JSON(DBInstanceId, DBInstanceId_);
          DARABONBA_PTR_FROM_JSON(Reason, reason_);
        };
        DetachFailList() = default ;
        DetachFailList(const DetachFailList &) = default ;
        DetachFailList(DetachFailList &&) = default ;
        DetachFailList(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~DetachFailList() = default ;
        DetachFailList& operator=(const DetachFailList &) = default ;
        DetachFailList& operator=(DetachFailList &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        void deleteDBInstanceId() { this->DBInstanceId_ = nullptr;};
        inline string getDBInstanceId() const { DARABONBA_PTR_GET_DEFAULT(DBInstanceId_, "") };
        inline DetachFailList& setDBInstanceId(string DBInstanceId) { DARABONBA_PTR_SET_VALUE(DBInstanceId_, DBInstanceId) };
        ...
        inline DetachFailList& setReason(string reason) { DARABONBA_PTR_SET_VALUE(reason_, reason) };
      ...
      virtual bool empty() const override { return this->detachFailList_ == nullptr
        && this->detachSuccessedList_ == nullptr && this->status_ == nullptr; };
      ...
      inline const vector<Data::DetachFailList> & getDetachFailList() const { DARABONBA_PTR_GET_CONST(detachFailList_, vector<Data::DetachFailList>) };
      inline vector<Data::DetachFailList> getDetachFailList() { DARABONBA_PTR_GET(detachFailList_, vector<Data::DetachFailList>) };
      inline Data& setDetachFailList(const vector<Data::DetachFailList> & detachFailList) { DARABONBA_PTR_SET_VALUE(detachFailList_, detachFailList) };
      inline Data& setDetachFailList(vector<Data::DetachFailList> && detachFailList) { DARABONBA_PTR_SET_RVALUE(detachFailList_, detachFailList) };
      ...
      inline const vector<Data::DetachSuccessedList> & getDetachSuccessedList() const { DARABONBA_PTR_GET_CONST(detachSuccessedList_, vector<Data::DetachSuccessedList>) };
      inline vector<Data::DetachSuccessedList> getDetachSuccessedList() { DARABONBA_PTR_GET(detachSuccessedList_, vector<Data::DetachSuccessedList>) };
      inline Data& setDetachSuccessedList(const vector<Data::DetachSuccessedList> & detachSuccessedList) { DARABONBA_PTR_SET_VALUE(detachSuccessedList_, detachSuccessedList) };
      inline Data& setDetachSuccessedList(vector<Data::DetachSuccessedList> && detachSuccessedList) { DARABONBA_PTR_SET_RVALUE(detachSuccessedList_, detachSuccessedList) };
    ...
    inline const DetachWhitelistTemplateToInstanceResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DetachWhitelistTemplateToInstanceResponseBody::Data) };
    inline DetachWhitelistTemplateToInstanceResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DetachWhitelistTemplateToInstanceResponseBody::Data) };
    inline DetachWhitelistTemplateToInstanceResponseBody& setData(const DetachWhitelistTemplateToInstanceResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DetachWhitelistTemplateToInstanceResponseBody& setData(DetachWhitelistTemplateToInstanceResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
