...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAccountAuthorityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAccountAuthorityResponseBody) };
    inline DescribeAccountAuthorityResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAccountAuthorityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAccountAuthorityResponseBody> body_ {};
  };
