...
namespace Models
{
  ...
  public:
    ...
    inline const KillProcessResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, KillProcessResponseBodyData) };
    inline KillProcessResponseBodyData data() { DARABONBA_PTR_GET(data_, KillProcessResponseBodyData) };
    inline KillProcessResponseBody& setData(const KillProcessResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline KillProcessResponseBody& setData(KillProcessResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The data returned.
    std::shared_ptr<KillProcessResponseBodyData> data_ = nullptr;
    // The request ID.
