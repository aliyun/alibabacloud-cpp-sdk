...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceConfigResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeDBInstanceConfigResponseBodyData) };
    inline DescribeDBInstanceConfigResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeDBInstanceConfigResponseBodyData) };
    inline DescribeDBInstanceConfigResponseBody& setData(const DescribeDBInstanceConfigResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDBInstanceConfigResponseBody& setData(DescribeDBInstanceConfigResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribeDBInstanceConfigResponseBodyData> data_ = nullptr;
    // Id of the request
