...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstanceClassResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBInstanceClassResponseBody) };
    inline ModifyDBInstanceClassResponseBody body() { DARABONBA_PTR_GET(body_, ModifyDBInstanceClassResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyDBInstanceClassResponseBody> body_ = nullptr;
  };
