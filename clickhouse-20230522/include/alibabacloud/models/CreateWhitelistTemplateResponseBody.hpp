...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWhitelistTemplateResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateWhitelistTemplateResponseBody::Data) };
    inline CreateWhitelistTemplateResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateWhitelistTemplateResponseBody::Data) };
    inline CreateWhitelistTemplateResponseBody& setData(const CreateWhitelistTemplateResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateWhitelistTemplateResponseBody& setData(CreateWhitelistTemplateResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
