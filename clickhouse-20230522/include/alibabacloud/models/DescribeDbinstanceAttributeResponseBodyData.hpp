...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->aliUid_ != nullptr
        && this->bid_ != nullptr && this->category_ != nullptr && this->chargeType_ != nullptr && this->createTime_ != nullptr && this->DBInstanceId_ != nullptr
        && this->deletionProtection_ != nullptr && this->deploySchema_ != nullptr && this->description_ != nullptr && this->disabledPorts_ != nullptr && this->engine_ != nullptr
        && this->engineMinorVersion_ != nullptr && this->engineVersion_ != nullptr && this->expireTime_ != nullptr && this->latestEngineMinorVersion_ != nullptr && this->lockMode_ != nullptr
        && this->lockReason_ != nullptr && this->maintainEndTime_ != nullptr && this->maintainStartTime_ != nullptr && this->multiZones_ != nullptr && this->nodeCount_ != nullptr
        && this->nodeScaleMax_ != nullptr && this->nodeScaleMin_ != nullptr && this->nodes_ != nullptr && this->objectStoreSize_ != nullptr && this->regionId_ != nullptr
        && this->resourceGroupId_ != nullptr && this->scaleMax_ != nullptr && this->scaleMin_ != nullptr && this->status_ != nullptr && this->storageQuota_ != nullptr
        && this->storageSize_ != nullptr && this->storageType_ != nullptr && this->tags_ != nullptr && this->vSwitchId_ != nullptr && this->vpcId_ != nullptr
