...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDBInstanceConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDBInstanceConfigResponseBody) };
    inline DescribeDBInstanceConfigResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDBInstanceConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDBInstanceConfigResponseBody> body_ = nullptr;
  };
