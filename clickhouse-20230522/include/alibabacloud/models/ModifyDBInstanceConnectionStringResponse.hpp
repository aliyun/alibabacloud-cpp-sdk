...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDBInstanceConnectionStringResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDBInstanceConnectionStringResponseBody) };
    inline ModifyDBInstanceConnectionStringResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDBInstanceConnectionStringResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDBInstanceConnectionStringResponseBody> body_ {};
  };
