...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAccountAuthorityResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyAccountAuthorityResponseBody::Data) };
    inline ModifyAccountAuthorityResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyAccountAuthorityResponseBody::Data) };
    inline ModifyAccountAuthorityResponseBody& setData(const ModifyAccountAuthorityResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyAccountAuthorityResponseBody& setData(ModifyAccountAuthorityResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The result returned.
    shared_ptr<ModifyAccountAuthorityResponseBody::Data> data_ {};
    // The request ID.
