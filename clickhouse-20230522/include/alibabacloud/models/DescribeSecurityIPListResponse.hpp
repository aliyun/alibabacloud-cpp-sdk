...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityIPListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecurityIPListResponseBody) };
    inline DescribeSecurityIPListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSecurityIPListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSecurityIPListResponseBody> body_ {};
  };
