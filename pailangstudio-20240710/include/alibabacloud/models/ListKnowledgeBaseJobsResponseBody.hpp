...
namespace Models
{
  ...
  public:
    ...
    inline const vector<KnowledgeBaseJob> & getKnowledgeBaseJobs() const { DARABONBA_PTR_GET_CONST(knowledgeBaseJobs_, vector<KnowledgeBaseJob>) };
    inline vector<KnowledgeBaseJob> getKnowledgeBaseJobs() { DARABONBA_PTR_GET(knowledgeBaseJobs_, vector<KnowledgeBaseJob>) };
