...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessibility_ == nullptr
        ...
        && this->knowledgeBaseJobId_ == nullptr && this->knowledgeBaseJobResult_ == nullptr && this->maxRunningTimeInSeconds_ == nullptr && this->pipelineRunInfo_ == nullptr && this->resourceId_ == nullptr
        && this->status_ == nullptr && this->userVpc_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline const vector<KnowledgeBaseJob::EcsSpecs> & getEcsSpecs() const { DARABONBA_PTR_GET_CONST(ecsSpecs_, vector<KnowledgeBaseJob::EcsSpecs>) };
    inline vector<KnowledgeBaseJob::EcsSpecs> getEcsSpecs() { DARABONBA_PTR_GET(ecsSpecs_, vector<KnowledgeBaseJob::EcsSpecs>) };
    inline KnowledgeBaseJob& setEcsSpecs(const vector<KnowledgeBaseJob::EcsSpecs> & ecsSpecs) { DARABONBA_PTR_SET_VALUE(ecsSpecs_, ecsSpecs) };
    inline KnowledgeBaseJob& setEcsSpecs(vector<KnowledgeBaseJob::EcsSpecs> && ecsSpecs) { DARABONBA_PTR_SET_RVALUE(ecsSpecs_, ecsSpecs) };
    ...
    inline const KnowledgeBaseJob::EmbeddingConfig & getEmbeddingConfig() const { DARABONBA_PTR_GET_CONST(embeddingConfig_, KnowledgeBaseJob::EmbeddingConfig) };
    inline KnowledgeBaseJob::EmbeddingConfig getEmbeddingConfig() { DARABONBA_PTR_GET(embeddingConfig_, KnowledgeBaseJob::EmbeddingConfig) };
    inline KnowledgeBaseJob& setEmbeddingConfig(const KnowledgeBaseJob::EmbeddingConfig & embeddingConfig) { DARABONBA_PTR_SET_VALUE(embeddingConfig_, embeddingConfig) };
    inline KnowledgeBaseJob& setEmbeddingConfig(KnowledgeBaseJob::EmbeddingConfig && embeddingConfig) { DARABONBA_PTR_SET_RVALUE(embeddingConfig_, embeddingConfig) };
    ...
    inline const KnowledgeBaseJob::KnowledgeBaseJobResult & getKnowledgeBaseJobResult() const { DARABONBA_PTR_GET_CONST(knowledgeBaseJobResult_, KnowledgeBaseJob::KnowledgeBaseJobResult) };
    inline KnowledgeBaseJob::KnowledgeBaseJobResult getKnowledgeBaseJobResult() { DARABONBA_PTR_GET(knowledgeBaseJobResult_, KnowledgeBaseJob::KnowledgeBaseJobResult) };
    inline KnowledgeBaseJob& setKnowledgeBaseJobResult(const KnowledgeBaseJob::KnowledgeBaseJobResult & knowledgeBaseJobResult) { DARABONBA_PTR_SET_VALUE(knowledgeBaseJobResult_, knowledgeBaseJobResult) };
    inline KnowledgeBaseJob& setKnowledgeBaseJobResult(KnowledgeBaseJob::KnowledgeBaseJobResult && knowledgeBaseJobResult) { DARABONBA_PTR_SET_RVALUE(knowledgeBaseJobResult_, knowledgeBaseJobResult) };
    ...
    inline const KnowledgeBaseJob::PipelineRunInfo & getPipelineRunInfo() const { DARABONBA_PTR_GET_CONST(pipelineRunInfo_, KnowledgeBaseJob::PipelineRunInfo) };
    inline KnowledgeBaseJob::PipelineRunInfo getPipelineRunInfo() { DARABONBA_PTR_GET(pipelineRunInfo_, KnowledgeBaseJob::PipelineRunInfo) };
    inline KnowledgeBaseJob& setPipelineRunInfo(const KnowledgeBaseJob::PipelineRunInfo & pipelineRunInfo) { DARABONBA_PTR_SET_VALUE(pipelineRunInfo_, pipelineRunInfo) };
    inline KnowledgeBaseJob& setPipelineRunInfo(KnowledgeBaseJob::PipelineRunInfo && pipelineRunInfo) { DARABONBA_PTR_SET_RVALUE(pipelineRunInfo_, pipelineRunInfo) };
    ...
    inline const KnowledgeBaseJob::UserVpc & getUserVpc() const { DARABONBA_PTR_GET_CONST(userVpc_, KnowledgeBaseJob::UserVpc) };
    inline KnowledgeBaseJob::UserVpc getUserVpc() { DARABONBA_PTR_GET(userVpc_, KnowledgeBaseJob::UserVpc) };
    inline KnowledgeBaseJob& setUserVpc(const KnowledgeBaseJob::UserVpc & userVpc) { DARABONBA_PTR_SET_VALUE(userVpc_, userVpc) };
    inline KnowledgeBaseJob& setUserVpc(KnowledgeBaseJob::UserVpc && userVpc) { DARABONBA_PTR_SET_RVALUE(userVpc_, userVpc) };
  ...
  protected:
    ...
    shared_ptr<vector<KnowledgeBaseJob::EcsSpecs>> ecsSpecs_ {};
    shared_ptr<KnowledgeBaseJob::EmbeddingConfig> embeddingConfig_ {};
    ...
    shared_ptr<KnowledgeBaseJob::KnowledgeBaseJobResult> knowledgeBaseJobResult_ {};
    shared_ptr<int32_t> maxRunningTimeInSeconds_ {};
    shared_ptr<KnowledgeBaseJob::PipelineRunInfo> pipelineRunInfo_ {};
    shared_ptr<string> resourceId_ {};
    shared_ptr<string> status_ {};
    shared_ptr<KnowledgeBaseJob::UserVpc> userVpc_ {};
