...
#ifndef ALIBABACLOUD_MODELS_RUNTIMEECSSPEC_HPP_
#define ALIBABACLOUD_MODELS_RUNTIMEECSSPEC_HPP_
...
namespace Models
{
  class RuntimeEcsSpec : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const RuntimeEcsSpec& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RuntimeEcsSpec& obj) { 
    ...
    RuntimeEcsSpec() = default ;
    RuntimeEcsSpec(const RuntimeEcsSpec &) = default ;
    RuntimeEcsSpec(RuntimeEcsSpec &&) = default ;
    RuntimeEcsSpec(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RuntimeEcsSpec() = default ;
    RuntimeEcsSpec& operator=(const RuntimeEcsSpec &) = default ;
    RuntimeEcsSpec& operator=(RuntimeEcsSpec &&) = default ;
    ...
    inline RuntimeEcsSpec& setCPU(int32_t CPU) { DARABONBA_PTR_SET_VALUE(CPU_, CPU) };
    ...
    inline RuntimeEcsSpec& setExtraEphemeralStorage(int32_t extraEphemeralStorage) { DARABONBA_PTR_SET_VALUE(extraEphemeralStorage_, extraEphemeralStorage) };
    ...
    inline RuntimeEcsSpec& setGPU(int32_t GPU) { DARABONBA_PTR_SET_VALUE(GPU_, GPU) };
    ...
    inline RuntimeEcsSpec& setGPUCorePercentage(int32_t GPUCorePercentage) { DARABONBA_PTR_SET_VALUE(GPUCorePercentage_, GPUCorePercentage) };
    ...
    inline RuntimeEcsSpec& setGPUMemory(int32_t GPUMemory) { DARABONBA_PTR_SET_VALUE(GPUMemory_, GPUMemory) };
    ...
    inline RuntimeEcsSpec& setGPUType(string GPUType) { DARABONBA_PTR_SET_VALUE(GPUType_, GPUType) };
    ...
    inline RuntimeEcsSpec& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline RuntimeEcsSpec& setMemory(int32_t memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
    ...
    inline RuntimeEcsSpec& setPodCount(int32_t podCount) { DARABONBA_PTR_SET_VALUE(podCount_, podCount) };
    ...
    inline RuntimeEcsSpec& setQuotaId(string quotaId) { DARABONBA_PTR_SET_VALUE(quotaId_, quotaId) };
    ...
    inline RuntimeEcsSpec& setQuotaType(string quotaType) { DARABONBA_PTR_SET_VALUE(quotaType_, quotaType) };
    ...
    inline RuntimeEcsSpec& setSharedMemory(int32_t sharedMemory) { DARABONBA_PTR_SET_VALUE(sharedMemory_, sharedMemory) };
