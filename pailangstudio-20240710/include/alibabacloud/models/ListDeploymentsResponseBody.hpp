...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Deployment> & getDeployments() const { DARABONBA_PTR_GET_CONST(deployments_, vector<Deployment>) };
    inline vector<Deployment> getDeployments() { DARABONBA_PTR_GET(deployments_, vector<Deployment>) };
    inline ListDeploymentsResponseBody& setDeployments(const vector<Deployment> & deployments) { DARABONBA_PTR_SET_VALUE(deployments_, deployments) };
    inline ListDeploymentsResponseBody& setDeployments(vector<Deployment> && deployments) { DARABONBA_PTR_SET_RVALUE(deployments_, deployments) };
    ...
    inline ListDeploymentsResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListDeploymentsResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListDeploymentsResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
