...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline int32_t getMaxModelLength() const { DARABONBA_PTR_GET_DEFAULT(maxModelLength_, 0) };
      inline Models& setMaxModelLength(int32_t maxModelLength) { DARABONBA_PTR_SET_VALUE(maxModelLength_, maxModelLength) };
    ...
    protected:
      ...
      // 最大上下文长度
      shared_ptr<int32_t> maxModelLength_ {};
      // 模型名
    ...
    virtual bool empty() const override { return this->accessibility_ == nullptr
        ...
        && this->customType_ == nullptr && this->description_ == nullptr && this->gmtCreateTime_ == nullptr && this->gmtModifiedTime_ == nullptr && this->models_ == nullptr
    ...
    inline Connection& setCustomType(string customType) { DARABONBA_PTR_SET_VALUE(customType_, customType) };
