...
#ifndef ALIBABACLOUD_MODELS_CREATERUNTIMEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATERUNTIMEREQUEST_HPP_
...
namespace Models
{
  class CreateRuntimeRequest : public Darabonba::Model {
  public:
    ...
    CreateRuntimeRequest(const CreateRuntimeRequest &) = default ;
    CreateRuntimeRequest(CreateRuntimeRequest &&) = default ;
    CreateRuntimeRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateRuntimeRequest() = default ;
    CreateRuntimeRequest& operator=(const CreateRuntimeRequest &) = default ;
    CreateRuntimeRequest& operator=(CreateRuntimeRequest &&) = default ;
    ...
    inline const CreateRuntimeRequest::CredentialConfig & getCredentialConfig() const { DARABONBA_PTR_GET_CONST(credentialConfig_, CreateRuntimeRequest::CredentialConfig) };
    inline CreateRuntimeRequest::CredentialConfig getCredentialConfig() { DARABONBA_PTR_GET(credentialConfig_, CreateRuntimeRequest::CredentialConfig) };
    inline CreateRuntimeRequest& setCredentialConfig(const CreateRuntimeRequest::CredentialConfig & credentialConfig) { DARABONBA_PTR_SET_VALUE(credentialConfig_, credentialConfig) };
    inline CreateRuntimeRequest& setCredentialConfig(CreateRuntimeRequest::CredentialConfig && credentialConfig) { DARABONBA_PTR_SET_RVALUE(credentialConfig_, credentialConfig) };
    ...
    inline const vector<CreateRuntimeRequest::DataSources> & getDataSources() const { DARABONBA_PTR_GET_CONST(dataSources_, vector<CreateRuntimeRequest::DataSources>) };
    inline vector<CreateRuntimeRequest::DataSources> getDataSources() { DARABONBA_PTR_GET(dataSources_, vector<CreateRuntimeRequest::DataSources>) };
    inline CreateRuntimeRequest& setDataSources(const vector<CreateRuntimeRequest::DataSources> & dataSources) { DARABONBA_PTR_SET_VALUE(dataSources_, dataSources) };
    inline CreateRuntimeRequest& setDataSources(vector<CreateRuntimeRequest::DataSources> && dataSources) { DARABONBA_PTR_SET_RVALUE(dataSources_, dataSources) };


    // ecsSpec Field Functions 
    bool hasEcsSpec() const { return this->ecsSpec_ != nullptr;};
    void deleteEcsSpec() { this->ecsSpec_ = nullptr;};
    inline const CreateRuntimeRequest::EcsSpec & getEcsSpec() const { DARABONBA_PTR_GET_CONST(ecsSpec_, CreateRuntimeRequest::EcsSpec) };
    inline CreateRuntimeRequest::EcsSpec getEcsSpec() { DARABONBA_PTR_GET(ecsSpec_, CreateRuntimeRequest::EcsSpec) };
    inline CreateRuntimeRequest& setEcsSpec(const CreateRuntimeRequest::EcsSpec & ecsSpec) { DARABONBA_PTR_SET_VALUE(ecsSpec_, ecsSpec) };
    inline CreateRuntimeRequest& setEcsSpec(CreateRuntimeRequest::EcsSpec && ecsSpec) { DARABONBA_PTR_SET_RVALUE(ecsSpec_, ecsSpec) };


    // envs Field Functions 
    bool hasEnvs() const { return this->envs_ != nullptr;};
    void deleteEnvs() { this->envs_ = nullptr;};
    inline const vector<CreateRuntimeRequest::Envs> & getEnvs() const { DARABONBA_PTR_GET_CONST(envs_, vector<CreateRuntimeRequest::Envs>) };
    inline vector<CreateRuntimeRequest::Envs> getEnvs() { DARABONBA_PTR_GET(envs_, vector<CreateRuntimeRequest::Envs>) };
    inline CreateRuntimeRequest& setEnvs(const vector<CreateRuntimeRequest::Envs> & envs) { DARABONBA_PTR_SET_VALUE(envs_, envs) };
    inline CreateRuntimeRequest& setEnvs(vector<CreateRuntimeRequest::Envs> && envs) { DARABONBA_PTR_SET_RVALUE(envs_, envs) };


    // labels Field Functions 
    bool hasLabels() const { return this->labels_ != nullptr;};
    void deleteLabels() { this->labels_ = nullptr;};
    inline const vector<CreateRuntimeRequest::Labels> & getLabels() const { DARABONBA_PTR_GET_CONST(labels_, vector<CreateRuntimeRequest::Labels>) };
    inline vector<CreateRuntimeRequest::Labels> getLabels() { DARABONBA_PTR_GET(labels_, vector<CreateRuntimeRequest::Labels>) };
    inline CreateRuntimeRequest& setLabels(const vector<CreateRuntimeRequest::Labels> & labels) { DARABONBA_PTR_SET_VALUE(labels_, labels) };
    inline CreateRuntimeRequest& setLabels(vector<CreateRuntimeRequest::Labels> && labels) { DARABONBA_PTR_SET_RVALUE(labels_, labels) };
    ...
    inline CreateRuntimeRequest& setResourceId(string resourceId) { DARABONBA_PTR_SET_VALUE(resourceId_, resourceId) };
    ...
    inline CreateRuntimeRequest& setRunTimeout(int32_t runTimeout) { DARABONBA_PTR_SET_VALUE(runTimeout_, runTimeout) };
    ...
    inline CreateRuntimeRequest& setRuntimeName(string runtimeName) { DARABONBA_PTR_SET_VALUE(runtimeName_, runtimeName) };
    ...
    inline CreateRuntimeRequest& setRuntimeType(string runtimeType) { DARABONBA_PTR_SET_VALUE(runtimeType_, runtimeType) };


    // userVpc Field Functions 
    bool hasUserVpc() const { return this->userVpc_ != nullptr;};
    void deleteUserVpc() { this->userVpc_ = nullptr;};
    inline const CreateRuntimeRequest::UserVpc & getUserVpc() const { DARABONBA_PTR_GET_CONST(userVpc_, CreateRuntimeRequest::UserVpc) };
    inline CreateRuntimeRequest::UserVpc getUserVpc() { DARABONBA_PTR_GET(userVpc_, CreateRuntimeRequest::UserVpc) };
    inline CreateRuntimeRequest& setUserVpc(const CreateRuntimeRequest::UserVpc & userVpc) { DARABONBA_PTR_SET_VALUE(userVpc_, userVpc) };
    inline CreateRuntimeRequest& setUserVpc(CreateRuntimeRequest::UserVpc && userVpc) { DARABONBA_PTR_SET_RVALUE(userVpc_, userVpc) };
    ...
    inline CreateRuntimeRequest& setWorkDir(string workDir) { DARABONBA_PTR_SET_VALUE(workDir_, workDir) };
    ...
    inline CreateRuntimeRequest& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
