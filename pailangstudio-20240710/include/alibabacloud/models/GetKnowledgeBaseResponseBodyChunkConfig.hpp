...
#ifndef ALIBABACLOUD_MODELS_GETKNOWLEDGEBASERESPONSEBODYCHUNKCONFIG_HPP_
#define ALIBABACLOUD_MODELS_GETKNOWLEDGEBASERESPONSEBODYCHUNKCONFIG_HPP_
...
namespace Models
{
  class GetKnowledgeBaseResponseBodyChunkConfig : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetKnowledgeBaseResponseBodyChunkConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetKnowledgeBaseResponseBodyChunkConfig& obj) { 
    ...
    GetKnowledgeBaseResponseBodyChunkConfig() = default ;
    GetKnowledgeBaseResponseBodyChunkConfig(const GetKnowledgeBaseResponseBodyChunkConfig &) = default ;
    GetKnowledgeBaseResponseBodyChunkConfig(GetKnowledgeBaseResponseBodyChunkConfig &&) = default ;
    GetKnowledgeBaseResponseBodyChunkConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetKnowledgeBaseResponseBodyChunkConfig() = default ;
    GetKnowledgeBaseResponseBodyChunkConfig& operator=(const GetKnowledgeBaseResponseBodyChunkConfig &) = default ;
    GetKnowledgeBaseResponseBodyChunkConfig& operator=(GetKnowledgeBaseResponseBodyChunkConfig &&) = default ;
    ...
    inline GetKnowledgeBaseResponseBodyChunkConfig& setChunkDuration(int32_t chunkDuration) { DARABONBA_PTR_SET_VALUE(chunkDuration_, chunkDuration) };
    ...
    inline GetKnowledgeBaseResponseBodyChunkConfig& setChunkOverlap(int32_t chunkOverlap) { DARABONBA_PTR_SET_VALUE(chunkOverlap_, chunkOverlap) };
    ...
    inline GetKnowledgeBaseResponseBodyChunkConfig& setChunkSize(int32_t chunkSize) { DARABONBA_PTR_SET_VALUE(chunkSize_, chunkSize) };
    ...
    inline GetKnowledgeBaseResponseBodyChunkConfig& setChunkStrategy(string chunkStrategy) { DARABONBA_PTR_SET_VALUE(chunkStrategy_, chunkStrategy) };
