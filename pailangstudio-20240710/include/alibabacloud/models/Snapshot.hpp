...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessibility_ == nullptr
        && return this->creationType_ == nullptr && return this->creator_ == nullptr && return this->description_ == nullptr && return this->gmtCreateTime_ == nullptr && return this->gmtModifiedTime_ == nullptr
        && return this->snapshotId_ == nullptr && return this->snapshotName_ == nullptr && return this->snapshotResourceId_ == nullptr && return this->snapshotResourceType_ == nullptr && return this->snapshotStoragePath_ == nullptr
        && return this->snapshotUrl_ == nullptr && return this->workDir_ == nullptr && return this->workspaceId_ == nullptr; };
    ...
    inline string snapshotResourceId() const { DARABONBA_PTR_GET_DEFAULT(snapshotResourceId_, "") };
    ...
    inline string snapshotResourceType() const { DARABONBA_PTR_GET_DEFAULT(snapshotResourceType_, "") };
    ...
    inline string snapshotStoragePath() const { DARABONBA_PTR_GET_DEFAULT(snapshotStoragePath_, "") };
    ...
    inline string snapshotUrl() const { DARABONBA_PTR_GET_DEFAULT(snapshotUrl_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> snapshotResourceId_ = nullptr;
    std::shared_ptr<string> snapshotResourceType_ = nullptr;
    std::shared_ptr<string> snapshotStoragePath_ = nullptr;
    std::shared_ptr<string> snapshotUrl_ = nullptr;
