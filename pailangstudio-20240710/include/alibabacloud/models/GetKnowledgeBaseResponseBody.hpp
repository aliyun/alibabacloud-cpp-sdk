...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessibility_ == nullptr
        ...
        && this->requestId_ == nullptr && this->runtimeId_ == nullptr && this->vectorDBConfig_ == nullptr && this->versionName_ == nullptr && this->workspaceId_ == nullptr; };
    ...
    inline const GetKnowledgeBaseResponseBody::AutoUpdateConfig & getAutoUpdateConfig() const { DARABONBA_PTR_GET_CONST(autoUpdateConfig_, GetKnowledgeBaseResponseBody::AutoUpdateConfig) };
    inline GetKnowledgeBaseResponseBody::AutoUpdateConfig getAutoUpdateConfig() { DARABONBA_PTR_GET(autoUpdateConfig_, GetKnowledgeBaseResponseBody::AutoUpdateConfig) };
    inline GetKnowledgeBaseResponseBody& setAutoUpdateConfig(const GetKnowledgeBaseResponseBody::AutoUpdateConfig & autoUpdateConfig) { DARABONBA_PTR_SET_VALUE(autoUpdateConfig_, autoUpdateConfig) };
    inline GetKnowledgeBaseResponseBody& setAutoUpdateConfig(GetKnowledgeBaseResponseBody::AutoUpdateConfig && autoUpdateConfig) { DARABONBA_PTR_SET_RVALUE(autoUpdateConfig_, autoUpdateConfig) };
    ...
    inline const GetKnowledgeBaseResponseBody::ChunkConfig & getChunkConfig() const { DARABONBA_PTR_GET_CONST(chunkConfig_, GetKnowledgeBaseResponseBody::ChunkConfig) };
    inline GetKnowledgeBaseResponseBody::ChunkConfig getChunkConfig() { DARABONBA_PTR_GET(chunkConfig_, GetKnowledgeBaseResponseBody::ChunkConfig) };
    inline GetKnowledgeBaseResponseBody& setChunkConfig(const GetKnowledgeBaseResponseBody::ChunkConfig & chunkConfig) { DARABONBA_PTR_SET_VALUE(chunkConfig_, chunkConfig) };
    inline GetKnowledgeBaseResponseBody& setChunkConfig(GetKnowledgeBaseResponseBody::ChunkConfig && chunkConfig) { DARABONBA_PTR_SET_RVALUE(chunkConfig_, chunkConfig) };
    ...
    inline const vector<GetKnowledgeBaseResponseBody::DataSources> & getDataSources() const { DARABONBA_PTR_GET_CONST(dataSources_, vector<GetKnowledgeBaseResponseBody::DataSources>) };
    inline vector<GetKnowledgeBaseResponseBody::DataSources> getDataSources() { DARABONBA_PTR_GET(dataSources_, vector<GetKnowledgeBaseResponseBody::DataSources>) };
    inline GetKnowledgeBaseResponseBody& setDataSources(const vector<GetKnowledgeBaseResponseBody::DataSources> & dataSources) { DARABONBA_PTR_SET_VALUE(dataSources_, dataSources) };
    inline GetKnowledgeBaseResponseBody& setDataSources(vector<GetKnowledgeBaseResponseBody::DataSources> && dataSources) { DARABONBA_PTR_SET_RVALUE(dataSources_, dataSources) };
    ...
    bool hasEmbeddingConfig() const { return this->embeddingConfig_ != nullptr;};
    void deleteEmbeddingConfig() { this->embeddingConfig_ = nullptr;};
    inline const GetKnowledgeBaseResponseBody::EmbeddingConfig & getEmbeddingConfig() const { DARABONBA_PTR_GET_CONST(embeddingConfig_, GetKnowledgeBaseResponseBody::EmbeddingConfig) };
    inline GetKnowledgeBaseResponseBody::EmbeddingConfig getEmbeddingConfig() { DARABONBA_PTR_GET(embeddingConfig_, GetKnowledgeBaseResponseBody::EmbeddingConfig) };
    inline GetKnowledgeBaseResponseBody& setEmbeddingConfig(const GetKnowledgeBaseResponseBody::EmbeddingConfig & embeddingConfig) { DARABONBA_PTR_SET_VALUE(embeddingConfig_, embeddingConfig) };
    inline GetKnowledgeBaseResponseBody& setEmbeddingConfig(GetKnowledgeBaseResponseBody::EmbeddingConfig && embeddingConfig) { DARABONBA_PTR_SET_RVALUE(embeddingConfig_, embeddingConfig) };
    ...
    inline const GetKnowledgeBaseResponseBody::IndexColumnConfig & getIndexColumnConfig() const { DARABONBA_PTR_GET_CONST(indexColumnConfig_, GetKnowledgeBaseResponseBody::IndexColumnConfig) };
    inline GetKnowledgeBaseResponseBody::IndexColumnConfig getIndexColumnConfig() { DARABONBA_PTR_GET(indexColumnConfig_, GetKnowledgeBaseResponseBody::IndexColumnConfig) };
    inline GetKnowledgeBaseResponseBody& setIndexColumnConfig(const GetKnowledgeBaseResponseBody::IndexColumnConfig & indexColumnConfig) { DARABONBA_PTR_SET_VALUE(indexColumnConfig_, indexColumnConfig) };
    inline GetKnowledgeBaseResponseBody& setIndexColumnConfig(GetKnowledgeBaseResponseBody::IndexColumnConfig && indexColumnConfig) { DARABONBA_PTR_SET_RVALUE(indexColumnConfig_, indexColumnConfig) };
    ...
    inline const GetKnowledgeBaseResponseBody::MetaDataConfig & getMetaDataConfig() const { DARABONBA_PTR_GET_CONST(metaDataConfig_, GetKnowledgeBaseResponseBody::MetaDataConfig) };
    inline GetKnowledgeBaseResponseBody::MetaDataConfig getMetaDataConfig() { DARABONBA_PTR_GET(metaDataConfig_, GetKnowledgeBaseResponseBody::MetaDataConfig) };
    inline GetKnowledgeBaseResponseBody& setMetaDataConfig(const GetKnowledgeBaseResponseBody::MetaDataConfig & metaDataConfig) { DARABONBA_PTR_SET_VALUE(metaDataConfig_, metaDataConfig) };
    inline GetKnowledgeBaseResponseBody& setMetaDataConfig(GetKnowledgeBaseResponseBody::MetaDataConfig && metaDataConfig) { DARABONBA_PTR_SET_RVALUE(metaDataConfig_, metaDataConfig) };
    ...
    inline const GetKnowledgeBaseResponseBody::VectorDBConfig & getVectorDBConfig() const { DARABONBA_PTR_GET_CONST(vectorDBConfig_, GetKnowledgeBaseResponseBody::VectorDBConfig) };
    inline GetKnowledgeBaseResponseBody::VectorDBConfig getVectorDBConfig() { DARABONBA_PTR_GET(vectorDBConfig_, GetKnowledgeBaseResponseBody::VectorDBConfig) };
    inline GetKnowledgeBaseResponseBody& setVectorDBConfig(const GetKnowledgeBaseResponseBody::VectorDBConfig & vectorDBConfig) { DARABONBA_PTR_SET_VALUE(vectorDBConfig_, vectorDBConfig) };
    inline GetKnowledgeBaseResponseBody& setVectorDBConfig(GetKnowledgeBaseResponseBody::VectorDBConfig && vectorDBConfig) { DARABONBA_PTR_SET_RVALUE(vectorDBConfig_, vectorDBConfig) };
