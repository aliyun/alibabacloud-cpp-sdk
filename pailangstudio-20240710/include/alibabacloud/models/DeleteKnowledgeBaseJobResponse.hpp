...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteKnowledgeBaseJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteKnowledgeBaseJobResponseBody) };
    inline DeleteKnowledgeBaseJobResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteKnowledgeBaseJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteKnowledgeBaseJobResponseBody> body_ {};
  };
