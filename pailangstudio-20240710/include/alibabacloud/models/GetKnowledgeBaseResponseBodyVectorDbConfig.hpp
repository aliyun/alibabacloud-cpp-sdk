...
#ifndef ALIBABACLOUD_MODELS_GETKNOWLEDGEBASERESPONSEBODYVECTORDBCONFIG_HPP_
#define ALIBABACLOUD_MODELS_GETKNOWLEDGEBASERESPONSEBODYVECTORDBCONFIG_HPP_
...
namespace Models
{
  class GetKnowledgeBaseResponseBodyVectorDBConfig : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetKnowledgeBaseResponseBodyVectorDBConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetKnowledgeBaseResponseBodyVectorDBConfig& obj) { 
    ...
    GetKnowledgeBaseResponseBodyVectorDBConfig() = default ;
    GetKnowledgeBaseResponseBodyVectorDBConfig(const GetKnowledgeBaseResponseBodyVectorDBConfig &) = default ;
    GetKnowledgeBaseResponseBodyVectorDBConfig(GetKnowledgeBaseResponseBodyVectorDBConfig &&) = default ;
    GetKnowledgeBaseResponseBodyVectorDBConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetKnowledgeBaseResponseBodyVectorDBConfig() = default ;
    GetKnowledgeBaseResponseBodyVectorDBConfig& operator=(const GetKnowledgeBaseResponseBodyVectorDBConfig &) = default ;
    GetKnowledgeBaseResponseBodyVectorDBConfig& operator=(GetKnowledgeBaseResponseBodyVectorDBConfig &&) = default ;
    ...
    inline GetKnowledgeBaseResponseBodyVectorDBConfig& setCollectionName(string collectionName) { DARABONBA_PTR_SET_VALUE(collectionName_, collectionName) };
    ...
    inline GetKnowledgeBaseResponseBodyVectorDBConfig& setConnectionId(string connectionId) { DARABONBA_PTR_SET_VALUE(connectionId_, connectionId) };
    ...
    inline GetKnowledgeBaseResponseBodyVectorDBConfig& setConnectionName(string connectionName) { DARABONBA_PTR_SET_VALUE(connectionName_, connectionName) };
    ...
    inline GetKnowledgeBaseResponseBodyVectorDBConfig& setVectorDBType(string vectorDBType) { DARABONBA_PTR_SET_VALUE(vectorDBType_, vectorDBType) };
