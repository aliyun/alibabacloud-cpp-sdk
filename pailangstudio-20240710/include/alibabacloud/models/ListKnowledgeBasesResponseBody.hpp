...
namespace Models
{
  ...
  public:
    ...
    inline const vector<KnowledgeBase> & getKnowledgeBases() const { DARABONBA_PTR_GET_CONST(knowledgeBases_, vector<KnowledgeBase>) };
    inline vector<KnowledgeBase> getKnowledgeBases() { DARABONBA_PTR_GET(knowledgeBases_, vector<KnowledgeBase>) };
