...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AutoUpdateConfigEcsSpecs> & ecsSpecs() const { DARABONBA_PTR_GET_CONST(ecsSpecs_, vector<AutoUpdateConfigEcsSpecs>) };
    inline vector<AutoUpdateConfigEcsSpecs> ecsSpecs() { DARABONBA_PTR_GET(ecsSpecs_, vector<AutoUpdateConfigEcsSpecs>) };
    inline AutoUpdateConfig& setEcsSpecs(const vector<AutoUpdateConfigEcsSpecs> & ecsSpecs) { DARABONBA_PTR_SET_VALUE(ecsSpecs_, ecsSpecs) };
    inline AutoUpdateConfig& setEcsSpecs(vector<AutoUpdateConfigEcsSpecs> && ecsSpecs) { DARABONBA_PTR_SET_RVALUE(ecsSpecs_, ecsSpecs) };
    ...
    inline const AutoUpdateConfigEmbeddingConfig & embeddingConfig() const { DARABONBA_PTR_GET_CONST(embeddingConfig_, AutoUpdateConfigEmbeddingConfig) };
    inline AutoUpdateConfigEmbeddingConfig embeddingConfig() { DARABONBA_PTR_GET(embeddingConfig_, AutoUpdateConfigEmbeddingConfig) };
    inline AutoUpdateConfig& setEmbeddingConfig(const AutoUpdateConfigEmbeddingConfig & embeddingConfig) { DARABONBA_PTR_SET_VALUE(embeddingConfig_, embeddingConfig) };
    inline AutoUpdateConfig& setEmbeddingConfig(AutoUpdateConfigEmbeddingConfig && embeddingConfig) { DARABONBA_PTR_SET_RVALUE(embeddingConfig_, embeddingConfig) };
  ...
  protected:
    // 运行资源配置
    std::shared_ptr<vector<AutoUpdateConfigEcsSpecs>> ecsSpecs_ = nullptr;
    // Embedding配置
    std::shared_ptr<AutoUpdateConfigEmbeddingConfig> embeddingConfig_ = nullptr;
    // 任务最大运行时间
