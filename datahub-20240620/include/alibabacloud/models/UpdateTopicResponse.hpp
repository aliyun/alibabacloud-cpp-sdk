...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTopicResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTopicResponseBody) };
    inline UpdateTopicResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTopicResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTopicResponseBody> body_ {};
  };
