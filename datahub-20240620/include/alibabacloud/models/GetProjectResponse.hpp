...
namespace Models
{
  ...
  public:
    ...
    inline const GetProjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetProjectResponseBody) };
    inline GetProjectResponseBody getBody() { DARABONBA_PTR_GET(body_, GetProjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetProjectResponseBody> body_ {};
  };
