  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->comment_ == nullptr
        && this->createTime_ == nullptr && this->creator_ == nullptr && this->groupName_ == nullptr && this->projectName_ == nullptr && this->topicList_ == nullptr
      ...
      inline List& setTopicList(const vector<string> & topicList) { DARABONBA_PTR_SET_VALUE(topicList_, topicList) };
      inline List& setTopicList(vector<string> && topicList) { DARABONBA_PTR_SET_RVALUE(topicList_, topicList) };
    ...
    inline ListGroupsResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
