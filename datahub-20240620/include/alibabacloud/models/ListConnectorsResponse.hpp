...
namespace Models
{
  ...
  public:
    ...
    inline const ListConnectorsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListConnectorsResponseBody) };
    inline ListConnectorsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListConnectorsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListConnectorsResponseBody> body_ {};
  };
