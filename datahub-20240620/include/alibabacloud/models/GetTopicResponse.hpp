...
namespace Models
{
  ...
  public:
    ...
    inline const GetTopicResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTopicResponseBody) };
    inline GetTopicResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTopicResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTopicResponseBody> body_ {};
  };
