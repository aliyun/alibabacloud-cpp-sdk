...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeProductsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeProductsResponseBody) };
    inline DescribeProductsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeProductsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeProductsResponseBody> body_ {};
  };
