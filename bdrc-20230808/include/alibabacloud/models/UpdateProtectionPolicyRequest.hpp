...
#ifndef ALIBABACLOUD_MODELS_UPDATEPROTECTIONPOLICYREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEPROTECTIONPOLICYREQUEST_HPP_
...
namespace Models
{
  class UpdateProtectionPolicyRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateProtectionPolicyRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateProtectionPolicyRequest& obj) { 
    ...
    UpdateProtectionPolicyRequest() = default ;
    UpdateProtectionPolicyRequest(const UpdateProtectionPolicyRequest &) = default ;
    UpdateProtectionPolicyRequest(UpdateProtectionPolicyRequest &&) = default ;
    UpdateProtectionPolicyRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateProtectionPolicyRequest() = default ;
    UpdateProtectionPolicyRequest& operator=(const UpdateProtectionPolicyRequest &) = default ;
    UpdateProtectionPolicyRequest& operator=(UpdateProtectionPolicyRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->boundResourceCategoryIds_ == nullptr
        && this->clientToken_ == nullptr && this->protectionPolicyName_ == nullptr && this->subProtectionPolicies_ == nullptr; };
    ...
    inline UpdateProtectionPolicyRequest& setBoundResourceCategoryIds(const vector<string> & boundResourceCategoryIds) { DARABONBA_PTR_SET_VALUE(boundResourceCategoryIds_, boundResourceCategoryIds) };
    inline UpdateProtectionPolicyRequest& setBoundResourceCategoryIds(vector<string> && boundResourceCategoryIds) { DARABONBA_PTR_SET_RVALUE(boundResourceCategoryIds_, boundResourceCategoryIds) };
    ...
    inline UpdateProtectionPolicyRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline UpdateProtectionPolicyRequest& setProtectionPolicyName(string protectionPolicyName) { DARABONBA_PTR_SET_VALUE(protectionPolicyName_, protectionPolicyName) };
    ...
    inline const vector<UpdateProtectionPolicyRequest::SubProtectionPolicies> & getSubProtectionPolicies() const { DARABONBA_PTR_GET_CONST(subProtectionPolicies_, vector<UpdateProtectionPolicyRequest::SubProtectionPolicies>) };
    inline vector<UpdateProtectionPolicyRequest::SubProtectionPolicies> getSubProtectionPolicies() { DARABONBA_PTR_GET(subProtectionPolicies_, vector<UpdateProtectionPolicyRequest::SubProtectionPolicies>) };
    inline UpdateProtectionPolicyRequest& setSubProtectionPolicies(const vector<UpdateProtectionPolicyRequest::SubProtectionPolicies> & subProtectionPolicies) { DARABONBA_PTR_SET_VALUE(subProtectionPolicies_, subProtectionPolicies) };
    inline UpdateProtectionPolicyRequest& setSubProtectionPolicies(vector<UpdateProtectionPolicyRequest::SubProtectionPolicies> && subProtectionPolicies) { DARABONBA_PTR_SET_RVALUE(subProtectionPolicies_, subProtectionPolicies) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateProtectionPolicyRequest::SubProtectionPolicies>> subProtectionPolicies_ {};
  };
