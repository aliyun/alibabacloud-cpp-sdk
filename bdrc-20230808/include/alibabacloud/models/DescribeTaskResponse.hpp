...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTaskResponseBody) };
    inline DescribeTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTaskResponseBody> body_ {};
  };
