...
#ifndef ALIBABACLOUD_MODELS_DESCRIBERESOURCESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBERESOURCESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeResourcesResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeResourcesResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribeResourcesResponseBody() = default ;
    DescribeResourcesResponseBody(const DescribeResourcesResponseBody &) = default ;
    DescribeResourcesResponseBody(DescribeResourcesResponseBody &&) = default ;
    DescribeResourcesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeResourcesResponseBody() = default ;
    DescribeResourcesResponseBody& operator=(const DescribeResourcesResponseBody &) = default ;
    DescribeResourcesResponseBody& operator=(DescribeResourcesResponseBody &&) = default ;
    ...
    inline const DescribeResourcesResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DescribeResourcesResponseBody::Data) };
    inline DescribeResourcesResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DescribeResourcesResponseBody::Data) };
    inline DescribeResourcesResponseBody& setData(const DescribeResourcesResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeResourcesResponseBody& setData(DescribeResourcesResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeResourcesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The response data.
    shared_ptr<DescribeResourcesResponseBody::Data> data_ {};
    // The request ID.
