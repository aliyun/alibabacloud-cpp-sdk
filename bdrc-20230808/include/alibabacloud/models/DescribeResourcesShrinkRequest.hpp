...
#ifndef ALIBABACLOUD_MODELS_DESCRIBERESOURCESSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBERESOURCESSHRINKREQUEST_HPP_
...
namespace Models
{
  class DescribeResourcesShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeResourcesShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeResourcesShrinkRequest& obj) { 
    ...
    DescribeResourcesShrinkRequest() = default ;
    DescribeResourcesShrinkRequest(const DescribeResourcesShrinkRequest &) = default ;
    DescribeResourcesShrinkRequest(DescribeResourcesShrinkRequest &&) = default ;
    DescribeResourcesShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeResourcesShrinkRequest() = default ;
    DescribeResourcesShrinkRequest& operator=(const DescribeResourcesShrinkRequest &) = default ;
    DescribeResourcesShrinkRequest& operator=(DescribeResourcesShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->dataRedundancyType_ == nullptr
        ...
        && this->resourceId_ == nullptr && this->resourceOwnerIdsShrink_ == nullptr && this->resourceRegionId_ == nullptr && this->resourceType_ == nullptr && this->sortBy_ == nullptr
    ...
    inline DescribeResourcesShrinkRequest& setDataRedundancyType(string dataRedundancyType) { DARABONBA_PTR_SET_VALUE(dataRedundancyType_, dataRedundancyType) };
    ...
    inline DescribeResourcesShrinkRequest& setFailedRuleTemplate(string failedRuleTemplate) { DARABONBA_PTR_SET_VALUE(failedRuleTemplate_, failedRuleTemplate) };
    ...
    inline DescribeResourcesShrinkRequest& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline DescribeResourcesShrinkRequest& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline DescribeResourcesShrinkRequest& setResourceArn(string resourceArn) { DARABONBA_PTR_SET_VALUE(resourceArn_, resourceArn) };
    ...
    inline DescribeResourcesShrinkRequest& setResourceCategoryId(string resourceCategoryId) { DARABONBA_PTR_SET_VALUE(resourceCategoryId_, resourceCategoryId) };
    ...
    inline DescribeResourcesShrinkRequest& setResourceId(string resourceId) { DARABONBA_PTR_SET_VALUE(resourceId_, resourceId) };
    ...
    inline DescribeResourcesShrinkRequest& setResourceOwnerIdsShrink(string resourceOwnerIdsShrink) { DARABONBA_PTR_SET_VALUE(resourceOwnerIdsShrink_, resourceOwnerIdsShrink) };
    ...
    inline DescribeResourcesShrinkRequest& setResourceRegionId(string resourceRegionId) { DARABONBA_PTR_SET_VALUE(resourceRegionId_, resourceRegionId) };
    ...
    inline DescribeResourcesShrinkRequest& setResourceType(string resourceType) { DARABONBA_PTR_SET_VALUE(resourceType_, resourceType) };
    ...
    inline DescribeResourcesShrinkRequest& setSortBy(string sortBy) { DARABONBA_PTR_SET_VALUE(sortBy_, sortBy) };
    ...
    inline DescribeResourcesShrinkRequest& setSortOrder(string sortOrder) { DARABONBA_PTR_SET_VALUE(sortOrder_, sortOrder) };
    ...
    inline DescribeResourcesShrinkRequest& setStorageClass(string storageClass) { DARABONBA_PTR_SET_VALUE(storageClass_, storageClass) };
