...
namespace Models
{
  ...
  public:
    ...
    inline const EnableInternalAuthenticationSourceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, EnableInternalAuthenticationSourceResponseBody) };
    inline EnableInternalAuthenticationSourceResponseBody body() { DARABONBA_PTR_GET(body_, EnableInternalAuthenticationSourceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<EnableInternalAuthenticationSourceResponseBody> body_ = nullptr;
  };
