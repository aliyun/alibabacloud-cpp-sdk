...
namespace Models
{
  ...
  public:
    ...
    inline const DisableCustomPrivacyPolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DisableCustomPrivacyPolicyResponseBody) };
    inline DisableCustomPrivacyPolicyResponseBody body() { DARABONBA_PTR_GET(body_, DisableCustomPrivacyPolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DisableCustomPrivacyPolicyResponseBody> body_ = nullptr;
  };
