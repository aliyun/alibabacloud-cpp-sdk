...
namespace Models
{
  ...
  public:
    ...
    inline const GetApplicationAdvancedConfigResponseBodyApplicationAdvancedConfig & applicationAdvancedConfig() const { DARABONBA_PTR_GET_CONST(applicationAdvancedConfig_, GetApplicationAdvancedConfigResponseBodyApplicationAdvancedConfig) };
    inline GetApplicationAdvancedConfigResponseBodyApplicationAdvancedConfig applicationAdvancedConfig() { DARABONBA_PTR_GET(applicationAdvancedConfig_, GetApplicationAdvancedConfigResponseBodyApplicationAdvancedConfig) };
    inline GetApplicationAdvancedConfigResponseBody& setApplicationAdvancedConfig(const GetApplicationAdvancedConfigResponseBodyApplicationAdvancedConfig & applicationAdvancedConfig) { DARABONBA_PTR_SET_VALUE(applicationAdvancedConfig_, applicationAdvancedConfig) };
    inline GetApplicationAdvancedConfigResponseBody& setApplicationAdvancedConfig(GetApplicationAdvancedConfigResponseBodyApplicationAdvancedConfig && applicationAdvancedConfig) { DARABONBA_PTR_SET_RVALUE(applicationAdvancedConfig_, applicationAdvancedConfig) };
  ...
  protected:
    std::shared_ptr<GetApplicationAdvancedConfigResponseBodyApplicationAdvancedConfig> applicationAdvancedConfig_ = nullptr;
