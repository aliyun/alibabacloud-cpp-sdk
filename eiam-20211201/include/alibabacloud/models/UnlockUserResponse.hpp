...
namespace Models
{
  ...
  public:
    ...
    inline const UnlockUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnlockUserResponseBody) };
    inline UnlockUserResponseBody getBody() { DARABONBA_PTR_GET(body_, UnlockUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnlockUserResponseBody> body_ {};
  };
