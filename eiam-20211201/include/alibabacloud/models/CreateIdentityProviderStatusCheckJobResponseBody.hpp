...
namespace Models
{
  ...
  public:
    ...
    inline string identityProviderStatusCheckJobId() const { DARABONBA_PTR_GET_DEFAULT(identityProviderStatusCheckJobId_, "") };
  ...
  protected:
    std::shared_ptr<string> identityProviderStatusCheckJobId_ = nullptr;
