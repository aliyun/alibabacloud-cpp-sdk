...
namespace Models
{
  ...
  public:
    ...
    inline const RunSynchronizationJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunSynchronizationJobResponseBody) };
    inline RunSynchronizationJobResponseBody getBody() { DARABONBA_PTR_GET(body_, RunSynchronizationJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunSynchronizationJobResponseBody> body_ {};
  };
