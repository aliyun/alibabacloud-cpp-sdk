...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateGroupResponseBody) };
    inline CreateGroupResponseBody body() { DARABONBA_PTR_GET(body_, CreateGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateGroupResponseBody> body_ = nullptr;
  };
