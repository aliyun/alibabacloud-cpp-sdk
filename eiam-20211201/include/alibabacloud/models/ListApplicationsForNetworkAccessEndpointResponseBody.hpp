...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListApplicationsForNetworkAccessEndpointResponseBodyApplicationsForNetworkAccessEndpoint> & applicationsForNetworkAccessEndpoint() const { DARABONBA_PTR_GET_CONST(applicationsForNetworkAccessEndpoint_, vector<ListApplicationsForNetworkAccessEndpointResponseBodyApplicationsForNetworkAccessEndpoint>) };
    inline vector<ListApplicationsForNetworkAccessEndpointResponseBodyApplicationsForNetworkAccessEndpoint> applicationsForNetworkAccessEndpoint() { DARABONBA_PTR_GET(applicationsForNetworkAccessEndpoint_, vector<ListApplicationsForNetworkAccessEndpointResponseBodyApplicationsForNetworkAccessEndpoint>) };
    inline ListApplicationsForNetworkAccessEndpointResponseBody& setApplicationsForNetworkAccessEndpoint(const vector<ListApplicationsForNetworkAccessEndpointResponseBodyApplicationsForNetworkAccessEndpoint> & applicationsForNetworkAccessEndpoint) { DARABONBA_PTR_SET_VALUE(applicationsForNetworkAccessEndpoint_, applicationsForNetworkAccessEndpoint) };
    inline ListApplicationsForNetworkAccessEndpointResponseBody& setApplicationsForNetworkAccessEndpoint(vector<ListApplicationsForNetworkAccessEndpointResponseBodyApplicationsForNetworkAccessEndpoint> && applicationsForNetworkAccessEndpoint) { DARABONBA_PTR_SET_RVALUE(applicationsForNetworkAccessEndpoint_, applicationsForNetworkAccessEndpoint) };
  ...
  protected:
    std::shared_ptr<vector<ListApplicationsForNetworkAccessEndpointResponseBodyApplicationsForNetworkAccessEndpoint>> applicationsForNetworkAccessEndpoint_ = nullptr;
