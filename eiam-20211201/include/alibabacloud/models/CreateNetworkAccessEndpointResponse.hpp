...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNetworkAccessEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateNetworkAccessEndpointResponseBody) };
    inline CreateNetworkAccessEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateNetworkAccessEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateNetworkAccessEndpointResponseBody> body_ {};
  };
