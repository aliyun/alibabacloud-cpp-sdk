...
namespace Models
{
  ...
  public:
    ...
    inline const ObtainApplicationTokenResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ObtainApplicationTokenResponseBody) };
    inline ObtainApplicationTokenResponseBody body() { DARABONBA_PTR_GET(body_, ObtainApplicationTokenResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ObtainApplicationTokenResponseBody> body_ = nullptr;
  };
