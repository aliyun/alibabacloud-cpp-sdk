...
namespace Models
{
  ...
  public:
    ...
    inline const ListApplicationClientSecretsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApplicationClientSecretsResponseBody) };
    inline ListApplicationClientSecretsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApplicationClientSecretsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApplicationClientSecretsResponseBody> body_ {};
  };
