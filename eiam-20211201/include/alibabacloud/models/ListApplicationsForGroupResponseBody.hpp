...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListApplicationsForGroupResponseBodyApplications> & applications() const { DARABONBA_PTR_GET_CONST(applications_, vector<ListApplicationsForGroupResponseBodyApplications>) };
    inline vector<ListApplicationsForGroupResponseBodyApplications> applications() { DARABONBA_PTR_GET(applications_, vector<ListApplicationsForGroupResponseBodyApplications>) };
    inline ListApplicationsForGroupResponseBody& setApplications(const vector<ListApplicationsForGroupResponseBodyApplications> & applications) { DARABONBA_PTR_SET_VALUE(applications_, applications) };
    inline ListApplicationsForGroupResponseBody& setApplications(vector<ListApplicationsForGroupResponseBodyApplications> && applications) { DARABONBA_PTR_SET_RVALUE(applications_, applications) };
  ...
  protected:
    std::shared_ptr<vector<ListApplicationsForGroupResponseBodyApplications>> applications_ = nullptr;
