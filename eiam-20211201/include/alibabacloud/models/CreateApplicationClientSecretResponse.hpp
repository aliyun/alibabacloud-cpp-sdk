...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApplicationClientSecretResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateApplicationClientSecretResponseBody) };
    inline CreateApplicationClientSecretResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateApplicationClientSecretResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateApplicationClientSecretResponseBody> body_ {};
  };
