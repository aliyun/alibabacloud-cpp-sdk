...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListConditionalAccessPoliciesForUserResponseBody::ConditionalAccessPolicies> & getConditionalAccessPolicies() const { DARABONBA_PTR_GET_CONST(conditionalAccessPolicies_, vector<ListConditionalAccessPoliciesForUserResponseBody::ConditionalAccessPolicies>) };
    inline vector<ListConditionalAccessPoliciesForUserResponseBody::ConditionalAccessPolicies> getConditionalAccessPolicies() { DARABONBA_PTR_GET(conditionalAccessPolicies_, vector<ListConditionalAccessPoliciesForUserResponseBody::ConditionalAccessPolicies>) };
    inline ListConditionalAccessPoliciesForUserResponseBody& setConditionalAccessPolicies(const vector<ListConditionalAccessPoliciesForUserResponseBody::ConditionalAccessPolicies> & conditionalAccessPolicies) { DARABONBA_PTR_SET_VALUE(conditionalAccessPolicies_, conditionalAccessPolicies) };
    inline ListConditionalAccessPoliciesForUserResponseBody& setConditionalAccessPolicies(vector<ListConditionalAccessPoliciesForUserResponseBody::ConditionalAccessPolicies> && conditionalAccessPolicies) { DARABONBA_PTR_SET_RVALUE(conditionalAccessPolicies_, conditionalAccessPolicies) };
  ...
  protected:
    shared_ptr<vector<ListConditionalAccessPoliciesForUserResponseBody::ConditionalAccessPolicies>> conditionalAccessPolicies_ {};
