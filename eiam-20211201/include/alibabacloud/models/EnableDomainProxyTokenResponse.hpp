...
namespace Models
{
  ...
  public:
    ...
    inline const EnableDomainProxyTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableDomainProxyTokenResponseBody) };
    inline EnableDomainProxyTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableDomainProxyTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableDomainProxyTokenResponseBody> body_ {};
  };
