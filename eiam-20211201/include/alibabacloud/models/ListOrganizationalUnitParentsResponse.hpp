...
namespace Models
{
  ...
  public:
    ...
    inline const ListOrganizationalUnitParentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOrganizationalUnitParentsResponseBody) };
    inline ListOrganizationalUnitParentsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOrganizationalUnitParentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOrganizationalUnitParentsResponseBody> body_ {};
  };
