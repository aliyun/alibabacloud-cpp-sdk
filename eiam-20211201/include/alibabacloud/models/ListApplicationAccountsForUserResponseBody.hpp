...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListApplicationAccountsForUserResponseBodyApplicationAccounts> & applicationAccounts() const { DARABONBA_PTR_GET_CONST(applicationAccounts_, vector<ListApplicationAccountsForUserResponseBodyApplicationAccounts>) };
    inline vector<ListApplicationAccountsForUserResponseBodyApplicationAccounts> applicationAccounts() { DARABONBA_PTR_GET(applicationAccounts_, vector<ListApplicationAccountsForUserResponseBodyApplicationAccounts>) };
    inline ListApplicationAccountsForUserResponseBody& setApplicationAccounts(const vector<ListApplicationAccountsForUserResponseBodyApplicationAccounts> & applicationAccounts) { DARABONBA_PTR_SET_VALUE(applicationAccounts_, applicationAccounts) };
    inline ListApplicationAccountsForUserResponseBody& setApplicationAccounts(vector<ListApplicationAccountsForUserResponseBodyApplicationAccounts> && applicationAccounts) { DARABONBA_PTR_SET_RVALUE(applicationAccounts_, applicationAccounts) };
  ...
  protected:
    std::shared_ptr<vector<ListApplicationAccountsForUserResponseBodyApplicationAccounts>> applicationAccounts_ = nullptr;
