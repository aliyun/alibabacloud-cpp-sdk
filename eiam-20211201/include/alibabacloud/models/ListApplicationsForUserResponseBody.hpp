...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListApplicationsForUserResponseBodyApplications> & applications() const { DARABONBA_PTR_GET_CONST(applications_, vector<ListApplicationsForUserResponseBodyApplications>) };
    inline vector<ListApplicationsForUserResponseBodyApplications> applications() { DARABONBA_PTR_GET(applications_, vector<ListApplicationsForUserResponseBodyApplications>) };
    inline ListApplicationsForUserResponseBody& setApplications(const vector<ListApplicationsForUserResponseBodyApplications> & applications) { DARABONBA_PTR_SET_VALUE(applications_, applications) };
    inline ListApplicationsForUserResponseBody& setApplications(vector<ListApplicationsForUserResponseBodyApplications> && applications) { DARABONBA_PTR_SET_RVALUE(applications_, applications) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListApplicationsForUserResponseBodyApplications>> applications_ = nullptr;
