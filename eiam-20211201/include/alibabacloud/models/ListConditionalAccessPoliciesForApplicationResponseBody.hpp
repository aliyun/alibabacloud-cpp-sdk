...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListConditionalAccessPoliciesForApplicationResponseBody::ConditionalAccessPolicies> & getConditionalAccessPolicies() const { DARABONBA_PTR_GET_CONST(conditionalAccessPolicies_, vector<ListConditionalAccessPoliciesForApplicationResponseBody::ConditionalAccessPolicies>) };
    inline vector<ListConditionalAccessPoliciesForApplicationResponseBody::ConditionalAccessPolicies> getConditionalAccessPolicies() { DARABONBA_PTR_GET(conditionalAccessPolicies_, vector<ListConditionalAccessPoliciesForApplicationResponseBody::ConditionalAccessPolicies>) };
    inline ListConditionalAccessPoliciesForApplicationResponseBody& setConditionalAccessPolicies(const vector<ListConditionalAccessPoliciesForApplicationResponseBody::ConditionalAccessPolicies> & conditionalAccessPolicies) { DARABONBA_PTR_SET_VALUE(conditionalAccessPolicies_, conditionalAccessPolicies) };
    inline ListConditionalAccessPoliciesForApplicationResponseBody& setConditionalAccessPolicies(vector<ListConditionalAccessPoliciesForApplicationResponseBody::ConditionalAccessPolicies> && conditionalAccessPolicies) { DARABONBA_PTR_SET_RVALUE(conditionalAccessPolicies_, conditionalAccessPolicies) };
