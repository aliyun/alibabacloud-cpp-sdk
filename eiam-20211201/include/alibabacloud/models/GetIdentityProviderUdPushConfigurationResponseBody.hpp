...
#ifndef ALIBABACLOUD_MODELS_GETIDENTITYPROVIDERUDPUSHCONFIGURATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETIDENTITYPROVIDERUDPUSHCONFIGURATIONRESPONSEBODY_HPP_
...
namespace Models
{
  class GetIdentityProviderUdPushConfigurationResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetIdentityProviderUdPushConfigurationResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(UdPushConfiguration, udPushConfiguration_);
    };
    friend void from_json(const Darabonba::Json& j, GetIdentityProviderUdPushConfigurationResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(UdPushConfiguration, udPushConfiguration_);
    };
    GetIdentityProviderUdPushConfigurationResponseBody() = default ;
    GetIdentityProviderUdPushConfigurationResponseBody(const GetIdentityProviderUdPushConfigurationResponseBody &) = default ;
    GetIdentityProviderUdPushConfigurationResponseBody(GetIdentityProviderUdPushConfigurationResponseBody &&) = default ;
    GetIdentityProviderUdPushConfigurationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetIdentityProviderUdPushConfigurationResponseBody() = default ;
    GetIdentityProviderUdPushConfigurationResponseBody& operator=(const GetIdentityProviderUdPushConfigurationResponseBody &) = default ;
    GetIdentityProviderUdPushConfigurationResponseBody& operator=(GetIdentityProviderUdPushConfigurationResponseBody &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    class UdPushConfiguration : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const UdPushConfiguration& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, UdPushConfiguration& obj) { 
      ...
      UdPushConfiguration() = default ;
      UdPushConfiguration(const UdPushConfiguration &) = default ;
      UdPushConfiguration(UdPushConfiguration &&) = default ;
      UdPushConfiguration(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~UdPushConfiguration() = default ;
      UdPushConfiguration& operator=(const UdPushConfiguration &) = default ;
      UdPushConfiguration& operator=(UdPushConfiguration &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      public:
        ...
        inline const vector<string> & getPeriodicSyncTimes() const { DARABONBA_PTR_GET_CONST(periodicSyncTimes_, vector<string>) };
        inline vector<string> getPeriodicSyncTimes() { DARABONBA_PTR_GET(periodicSyncTimes_, vector<string>) };
        inline PeriodicSyncConfig& setPeriodicSyncTimes(const vector<string> & periodicSyncTimes) { DARABONBA_PTR_SET_VALUE(periodicSyncTimes_, periodicSyncTimes) };
        inline PeriodicSyncConfig& setPeriodicSyncTimes(vector<string> && periodicSyncTimes) { DARABONBA_PTR_SET_RVALUE(periodicSyncTimes_, periodicSyncTimes) };
      ...
      inline UdPushConfiguration& setIdentityProviderId(string identityProviderId) { DARABONBA_PTR_SET_VALUE(identityProviderId_, identityProviderId) };
      ...
      inline UdPushConfiguration& setIncrementalCallbackStatus(string incrementalCallbackStatus) { DARABONBA_PTR_SET_VALUE(incrementalCallbackStatus_, incrementalCallbackStatus) };
      ...
      inline UdPushConfiguration& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
      ...
      inline const UdPushConfiguration::LdapUdPushConfig & getLdapUdPushConfig() const { DARABONBA_PTR_GET_CONST(ldapUdPushConfig_, UdPushConfiguration::LdapUdPushConfig) };
      inline UdPushConfiguration::LdapUdPushConfig getLdapUdPushConfig() { DARABONBA_PTR_GET(ldapUdPushConfig_, UdPushConfiguration::LdapUdPushConfig) };
      inline UdPushConfiguration& setLdapUdPushConfig(const UdPushConfiguration::LdapUdPushConfig & ldapUdPushConfig) { DARABONBA_PTR_SET_VALUE(ldapUdPushConfig_, ldapUdPushConfig) };
      inline UdPushConfiguration& setLdapUdPushConfig(UdPushConfiguration::LdapUdPushConfig && ldapUdPushConfig) { DARABONBA_PTR_SET_RVALUE(ldapUdPushConfig_, ldapUdPushConfig) };
      ...
      inline const UdPushConfiguration::PeriodicSyncConfig & getPeriodicSyncConfig() const { DARABONBA_PTR_GET_CONST(periodicSyncConfig_, UdPushConfiguration::PeriodicSyncConfig) };
      inline UdPushConfiguration::PeriodicSyncConfig getPeriodicSyncConfig() { DARABONBA_PTR_GET(periodicSyncConfig_, UdPushConfiguration::PeriodicSyncConfig) };
      inline UdPushConfiguration& setPeriodicSyncConfig(const UdPushConfiguration::PeriodicSyncConfig & periodicSyncConfig) { DARABONBA_PTR_SET_VALUE(periodicSyncConfig_, periodicSyncConfig) };
      inline UdPushConfiguration& setPeriodicSyncConfig(UdPushConfiguration::PeriodicSyncConfig && periodicSyncConfig) { DARABONBA_PTR_SET_RVALUE(periodicSyncConfig_, periodicSyncConfig) };
      ...
      inline UdPushConfiguration& setPeriodicSyncStatus(string periodicSyncStatus) { DARABONBA_PTR_SET_VALUE(periodicSyncStatus_, periodicSyncStatus) };
      ...
      inline const vector<UdPushConfiguration::UdSyncScopeConfigs> & getUdSyncScopeConfigs() const { DARABONBA_PTR_GET_CONST(udSyncScopeConfigs_, vector<UdPushConfiguration::UdSyncScopeConfigs>) };
      inline vector<UdPushConfiguration::UdSyncScopeConfigs> getUdSyncScopeConfigs() { DARABONBA_PTR_GET(udSyncScopeConfigs_, vector<UdPushConfiguration::UdSyncScopeConfigs>) };
      inline UdPushConfiguration& setUdSyncScopeConfigs(const vector<UdPushConfiguration::UdSyncScopeConfigs> & udSyncScopeConfigs) { DARABONBA_PTR_SET_VALUE(udSyncScopeConfigs_, udSyncScopeConfigs) };
      inline UdPushConfiguration& setUdSyncScopeConfigs(vector<UdPushConfiguration::UdSyncScopeConfigs> && udSyncScopeConfigs) { DARABONBA_PTR_SET_RVALUE(udSyncScopeConfigs_, udSyncScopeConfigs) };
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && this->udPushConfiguration_ == nullptr; };
    // requestId Field Functions 
    bool hasRequestId() const { return this->requestId_ != nullptr;};
    void deleteRequestId() { this->requestId_ = nullptr;};
    inline string getRequestId() const { DARABONBA_PTR_GET_DEFAULT(requestId_, "") };
    inline GetIdentityProviderUdPushConfigurationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // udPushConfiguration Field Functions 
    bool hasUdPushConfiguration() const { return this->udPushConfiguration_ != nullptr;};
    void deleteUdPushConfiguration() { this->udPushConfiguration_ = nullptr;};
    inline const GetIdentityProviderUdPushConfigurationResponseBody::UdPushConfiguration & getUdPushConfiguration() const { DARABONBA_PTR_GET_CONST(udPushConfiguration_, GetIdentityProviderUdPushConfigurationResponseBody::UdPushConfiguration) };
    inline GetIdentityProviderUdPushConfigurationResponseBody::UdPushConfiguration getUdPushConfiguration() { DARABONBA_PTR_GET(udPushConfiguration_, GetIdentityProviderUdPushConfigurationResponseBody::UdPushConfiguration) };
    inline GetIdentityProviderUdPushConfigurationResponseBody& setUdPushConfiguration(const GetIdentityProviderUdPushConfigurationResponseBody::UdPushConfiguration & udPushConfiguration) { DARABONBA_PTR_SET_VALUE(udPushConfiguration_, udPushConfiguration) };
    inline GetIdentityProviderUdPushConfigurationResponseBody& setUdPushConfiguration(GetIdentityProviderUdPushConfigurationResponseBody::UdPushConfiguration && udPushConfiguration) { DARABONBA_PTR_SET_RVALUE(udPushConfiguration_, udPushConfiguration) };
