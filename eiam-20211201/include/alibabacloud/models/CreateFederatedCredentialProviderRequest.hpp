  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->audiences_ == nullptr
        && this->issuer_ == nullptr && this->jwksSource_ == nullptr && this->jwksUri_ == nullptr && this->staticJwks_ == nullptr && this->trustCondition_ == nullptr; };
    ...
    inline const CreateFederatedCredentialProviderRequest::OidcProviderConfig & getOidcProviderConfig() const { DARABONBA_PTR_GET_CONST(oidcProviderConfig_, CreateFederatedCredentialProviderRequest::OidcProviderConfig) };
    inline CreateFederatedCredentialProviderRequest::OidcProviderConfig getOidcProviderConfig() { DARABONBA_PTR_GET(oidcProviderConfig_, CreateFederatedCredentialProviderRequest::OidcProviderConfig) };
    inline CreateFederatedCredentialProviderRequest& setOidcProviderConfig(const CreateFederatedCredentialProviderRequest::OidcProviderConfig & oidcProviderConfig) { DARABONBA_PTR_SET_VALUE(oidcProviderConfig_, oidcProviderConfig) };
    inline CreateFederatedCredentialProviderRequest& setOidcProviderConfig(CreateFederatedCredentialProviderRequest::OidcProviderConfig && oidcProviderConfig) { DARABONBA_PTR_SET_RVALUE(oidcProviderConfig_, oidcProviderConfig) };
    ...
    inline const CreateFederatedCredentialProviderRequest::Pkcs7ProviderConfig & getPkcs7ProviderConfig() const { DARABONBA_PTR_GET_CONST(pkcs7ProviderConfig_, CreateFederatedCredentialProviderRequest::Pkcs7ProviderConfig) };
    inline CreateFederatedCredentialProviderRequest::Pkcs7ProviderConfig getPkcs7ProviderConfig() { DARABONBA_PTR_GET(pkcs7ProviderConfig_, CreateFederatedCredentialProviderRequest::Pkcs7ProviderConfig) };
    inline CreateFederatedCredentialProviderRequest& setPkcs7ProviderConfig(const CreateFederatedCredentialProviderRequest::Pkcs7ProviderConfig & pkcs7ProviderConfig) { DARABONBA_PTR_SET_VALUE(pkcs7ProviderConfig_, pkcs7ProviderConfig) };
    inline CreateFederatedCredentialProviderRequest& setPkcs7ProviderConfig(CreateFederatedCredentialProviderRequest::Pkcs7ProviderConfig && pkcs7ProviderConfig) { DARABONBA_PTR_SET_RVALUE(pkcs7ProviderConfig_, pkcs7ProviderConfig) };
    ...
    inline const CreateFederatedCredentialProviderRequest::PrivateCaProviderConfig & getPrivateCaProviderConfig() const { DARABONBA_PTR_GET_CONST(privateCaProviderConfig_, CreateFederatedCredentialProviderRequest::PrivateCaProviderConfig) };
    inline CreateFederatedCredentialProviderRequest::PrivateCaProviderConfig getPrivateCaProviderConfig() { DARABONBA_PTR_GET(privateCaProviderConfig_, CreateFederatedCredentialProviderRequest::PrivateCaProviderConfig) };
    inline CreateFederatedCredentialProviderRequest& setPrivateCaProviderConfig(const CreateFederatedCredentialProviderRequest::PrivateCaProviderConfig & privateCaProviderConfig) { DARABONBA_PTR_SET_VALUE(privateCaProviderConfig_, privateCaProviderConfig) };
    inline CreateFederatedCredentialProviderRequest& setPrivateCaProviderConfig(CreateFederatedCredentialProviderRequest::PrivateCaProviderConfig && privateCaProviderConfig) { DARABONBA_PTR_SET_RVALUE(privateCaProviderConfig_, privateCaProviderConfig) };
