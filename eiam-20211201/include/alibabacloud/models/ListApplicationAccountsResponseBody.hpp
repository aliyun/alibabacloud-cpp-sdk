...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListApplicationAccountsResponseBody::ApplicationAccounts> & getApplicationAccounts() const { DARABONBA_PTR_GET_CONST(applicationAccounts_, vector<ListApplicationAccountsResponseBody::ApplicationAccounts>) };
    inline vector<ListApplicationAccountsResponseBody::ApplicationAccounts> getApplicationAccounts() { DARABONBA_PTR_GET(applicationAccounts_, vector<ListApplicationAccountsResponseBody::ApplicationAccounts>) };
    inline ListApplicationAccountsResponseBody& setApplicationAccounts(const vector<ListApplicationAccountsResponseBody::ApplicationAccounts> & applicationAccounts) { DARABONBA_PTR_SET_VALUE(applicationAccounts_, applicationAccounts) };
    inline ListApplicationAccountsResponseBody& setApplicationAccounts(vector<ListApplicationAccountsResponseBody::ApplicationAccounts> && applicationAccounts) { DARABONBA_PTR_SET_RVALUE(applicationAccounts_, applicationAccounts) };
