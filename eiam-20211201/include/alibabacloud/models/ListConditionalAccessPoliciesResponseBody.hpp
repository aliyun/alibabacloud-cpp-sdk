...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListConditionalAccessPoliciesResponseBody::ConditionalAccessPolicies> & getConditionalAccessPolicies() const { DARABONBA_PTR_GET_CONST(conditionalAccessPolicies_, vector<ListConditionalAccessPoliciesResponseBody::ConditionalAccessPolicies>) };
    inline vector<ListConditionalAccessPoliciesResponseBody::ConditionalAccessPolicies> getConditionalAccessPolicies() { DARABONBA_PTR_GET(conditionalAccessPolicies_, vector<ListConditionalAccessPoliciesResponseBody::ConditionalAccessPolicies>) };
    inline ListConditionalAccessPoliciesResponseBody& setConditionalAccessPolicies(const vector<ListConditionalAccessPoliciesResponseBody::ConditionalAccessPolicies> & conditionalAccessPolicies) { DARABONBA_PTR_SET_VALUE(conditionalAccessPolicies_, conditionalAccessPolicies) };
    inline ListConditionalAccessPoliciesResponseBody& setConditionalAccessPolicies(vector<ListConditionalAccessPoliciesResponseBody::ConditionalAccessPolicies> && conditionalAccessPolicies) { DARABONBA_PTR_SET_RVALUE(conditionalAccessPolicies_, conditionalAccessPolicies) };
  ...
  protected:
    ...
    shared_ptr<vector<ListConditionalAccessPoliciesResponseBody::ConditionalAccessPolicies>> conditionalAccessPolicies_ {};
