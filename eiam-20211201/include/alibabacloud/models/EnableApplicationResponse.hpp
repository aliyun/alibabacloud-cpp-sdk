...
namespace Models
{
  ...
  public:
    ...
    inline const EnableApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableApplicationResponseBody) };
    inline EnableApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableApplicationResponseBody> body_ {};
  };
