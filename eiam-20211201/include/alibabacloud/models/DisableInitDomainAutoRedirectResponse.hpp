...
namespace Models
{
  ...
  public:
    ...
    inline const DisableInitDomainAutoRedirectResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DisableInitDomainAutoRedirectResponseBody) };
    inline DisableInitDomainAutoRedirectResponseBody body() { DARABONBA_PTR_GET(body_, DisableInitDomainAutoRedirectResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DisableInitDomainAutoRedirectResponseBody> body_ = nullptr;
  };
