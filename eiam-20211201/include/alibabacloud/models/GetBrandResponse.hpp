...
namespace Models
{
  ...
  public:
    ...
    inline const GetBrandResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetBrandResponseBody) };
    inline GetBrandResponseBody body() { DARABONBA_PTR_GET(body_, GetBrandResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetBrandResponseBody> body_ = nullptr;
  };
