...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFederatedCredentialProviderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateFederatedCredentialProviderResponseBody) };
    inline UpdateFederatedCredentialProviderResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateFederatedCredentialProviderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateFederatedCredentialProviderResponseBody> body_ {};
  };
