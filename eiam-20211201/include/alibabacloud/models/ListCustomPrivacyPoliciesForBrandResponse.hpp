...
namespace Models
{
  ...
  public:
    ...
    inline const ListCustomPrivacyPoliciesForBrandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCustomPrivacyPoliciesForBrandResponseBody) };
    inline ListCustomPrivacyPoliciesForBrandResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCustomPrivacyPoliciesForBrandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCustomPrivacyPoliciesForBrandResponseBody> body_ {};
  };
