...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const FederatedCredentialProviders::CloudIdPProviderConfig & getCloudIdPProviderConfig() const { DARABONBA_PTR_GET_CONST(cloudIdPProviderConfig_, FederatedCredentialProviders::CloudIdPProviderConfig) };
      inline FederatedCredentialProviders::CloudIdPProviderConfig getCloudIdPProviderConfig() { DARABONBA_PTR_GET(cloudIdPProviderConfig_, FederatedCredentialProviders::CloudIdPProviderConfig) };
      inline FederatedCredentialProviders& setCloudIdPProviderConfig(const FederatedCredentialProviders::CloudIdPProviderConfig & cloudIdPProviderConfig) { DARABONBA_PTR_SET_VALUE(cloudIdPProviderConfig_, cloudIdPProviderConfig) };
      inline FederatedCredentialProviders& setCloudIdPProviderConfig(FederatedCredentialProviders::CloudIdPProviderConfig && cloudIdPProviderConfig) { DARABONBA_PTR_SET_RVALUE(cloudIdPProviderConfig_, cloudIdPProviderConfig) };
