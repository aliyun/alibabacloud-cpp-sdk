...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceResponseBody) };
    inline GetInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetInstanceResponseBody> body_ {};
  };
