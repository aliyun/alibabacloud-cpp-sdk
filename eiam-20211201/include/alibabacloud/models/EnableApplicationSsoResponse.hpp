...
namespace Models
{
  ...
  public:
    ...
    inline const EnableApplicationSsoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, EnableApplicationSsoResponseBody) };
    inline EnableApplicationSsoResponseBody body() { DARABONBA_PTR_GET(body_, EnableApplicationSsoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<EnableApplicationSsoResponseBody> body_ = nullptr;
  };
