...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListCustomPrivacyPoliciesResponseBodyCustomPrivacyPolicies> & customPrivacyPolicies() const { DARABONBA_PTR_GET_CONST(customPrivacyPolicies_, vector<ListCustomPrivacyPoliciesResponseBodyCustomPrivacyPolicies>) };
    inline vector<ListCustomPrivacyPoliciesResponseBodyCustomPrivacyPolicies> customPrivacyPolicies() { DARABONBA_PTR_GET(customPrivacyPolicies_, vector<ListCustomPrivacyPoliciesResponseBodyCustomPrivacyPolicies>) };
    inline ListCustomPrivacyPoliciesResponseBody& setCustomPrivacyPolicies(const vector<ListCustomPrivacyPoliciesResponseBodyCustomPrivacyPolicies> & customPrivacyPolicies) { DARABONBA_PTR_SET_VALUE(customPrivacyPolicies_, customPrivacyPolicies) };
    inline ListCustomPrivacyPoliciesResponseBody& setCustomPrivacyPolicies(vector<ListCustomPrivacyPoliciesResponseBodyCustomPrivacyPolicies> && customPrivacyPolicies) { DARABONBA_PTR_SET_RVALUE(customPrivacyPolicies_, customPrivacyPolicies) };
  ...
  protected:
    std::shared_ptr<vector<ListCustomPrivacyPoliciesResponseBodyCustomPrivacyPolicies>> customPrivacyPolicies_ = nullptr;
    // 分页查询时每页行数。
