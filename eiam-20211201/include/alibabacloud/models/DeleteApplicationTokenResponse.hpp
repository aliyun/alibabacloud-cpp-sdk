...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteApplicationTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteApplicationTokenResponseBody) };
    inline DeleteApplicationTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteApplicationTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteApplicationTokenResponseBody> body_ {};
  };
