...
namespace Models
{
  ...
  public:
    ...
    inline const EnableIdentityProviderAuthnResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableIdentityProviderAuthnResponseBody) };
    inline EnableIdentityProviderAuthnResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableIdentityProviderAuthnResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableIdentityProviderAuthnResponseBody> body_ {};
  };
