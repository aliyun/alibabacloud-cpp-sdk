...
namespace Models
{
  ...
  public:
    ...
    inline DisableUserRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline DisableUserRequest& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
