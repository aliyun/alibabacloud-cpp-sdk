...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteNetworkZoneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteNetworkZoneResponseBody) };
    inline DeleteNetworkZoneResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteNetworkZoneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteNetworkZoneResponseBody> body_ {};
  };
