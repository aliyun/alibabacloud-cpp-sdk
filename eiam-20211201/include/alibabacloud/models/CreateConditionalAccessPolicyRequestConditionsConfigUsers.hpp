...
#ifndef ALIBABACLOUD_MODELS_CREATECONDITIONALACCESSPOLICYREQUESTCONDITIONSCONFIGUSERS_HPP_
#define ALIBABACLOUD_MODELS_CREATECONDITIONALACCESSPOLICYREQUESTCONDITIONSCONFIGUSERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateConditionalAccessPolicyRequestConditionsConfigUsers& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateConditionalAccessPolicyRequestConditionsConfigUsers& obj) { 
    ...
    CreateConditionalAccessPolicyRequestConditionsConfigUsers() = default ;
    CreateConditionalAccessPolicyRequestConditionsConfigUsers(const CreateConditionalAccessPolicyRequestConditionsConfigUsers &) = default ;
    CreateConditionalAccessPolicyRequestConditionsConfigUsers(CreateConditionalAccessPolicyRequestConditionsConfigUsers &&) = default ;
    CreateConditionalAccessPolicyRequestConditionsConfigUsers(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateConditionalAccessPolicyRequestConditionsConfigUsers() = default ;
    CreateConditionalAccessPolicyRequestConditionsConfigUsers& operator=(const CreateConditionalAccessPolicyRequestConditionsConfigUsers &) = default ;
    CreateConditionalAccessPolicyRequestConditionsConfigUsers& operator=(CreateConditionalAccessPolicyRequestConditionsConfigUsers &&) = default ;
    ...
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setExcludeGroups(const vector<string> & excludeGroups) { DARABONBA_PTR_SET_VALUE(excludeGroups_, excludeGroups) };
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setExcludeGroups(vector<string> && excludeGroups) { DARABONBA_PTR_SET_RVALUE(excludeGroups_, excludeGroups) };
    ...
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setExcludeOrganizationalUnits(const vector<string> & excludeOrganizationalUnits) { DARABONBA_PTR_SET_VALUE(excludeOrganizationalUnits_, excludeOrganizationalUnits) };
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setExcludeOrganizationalUnits(vector<string> && excludeOrganizationalUnits) { DARABONBA_PTR_SET_RVALUE(excludeOrganizationalUnits_, excludeOrganizationalUnits) };
    ...
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setExcludeUsers(const vector<string> & excludeUsers) { DARABONBA_PTR_SET_VALUE(excludeUsers_, excludeUsers) };
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setExcludeUsers(vector<string> && excludeUsers) { DARABONBA_PTR_SET_RVALUE(excludeUsers_, excludeUsers) };
    ...
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setIncludeGroups(const vector<string> & includeGroups) { DARABONBA_PTR_SET_VALUE(includeGroups_, includeGroups) };
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setIncludeGroups(vector<string> && includeGroups) { DARABONBA_PTR_SET_RVALUE(includeGroups_, includeGroups) };
    ...
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setIncludeOrganizationalUnits(const vector<string> & includeOrganizationalUnits) { DARABONBA_PTR_SET_VALUE(includeOrganizationalUnits_, includeOrganizationalUnits) };
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setIncludeOrganizationalUnits(vector<string> && includeOrganizationalUnits) { DARABONBA_PTR_SET_RVALUE(includeOrganizationalUnits_, includeOrganizationalUnits) };
    ...
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setIncludeUsers(const vector<string> & includeUsers) { DARABONBA_PTR_SET_VALUE(includeUsers_, includeUsers) };
    inline CreateConditionalAccessPolicyRequestConditionsConfigUsers& setIncludeUsers(vector<string> && includeUsers) { DARABONBA_PTR_SET_RVALUE(includeUsers_, includeUsers) };
