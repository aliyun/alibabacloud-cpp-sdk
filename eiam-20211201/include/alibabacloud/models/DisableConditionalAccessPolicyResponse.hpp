...
namespace Models
{
  ...
  public:
    ...
    inline const DisableConditionalAccessPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableConditionalAccessPolicyResponseBody) };
    inline DisableConditionalAccessPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableConditionalAccessPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableConditionalAccessPolicyResponseBody> body_ {};
  };
