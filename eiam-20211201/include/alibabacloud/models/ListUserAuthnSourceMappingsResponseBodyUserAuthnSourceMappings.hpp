...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->authnSourceType_ == nullptr
        && return this->createTime_ == nullptr && return this->externalData_ == nullptr && return this->identityProviderId_ == nullptr && return this->instanceId_ == nullptr && return this->updateTime_ == nullptr
        && return this->userExternalId_ == nullptr && return this->userId_ == nullptr; };
    ...
    inline string externalData() const { DARABONBA_PTR_GET_DEFAULT(externalData_, "") };
    inline ListUserAuthnSourceMappingsResponseBodyUserAuthnSourceMappings& setExternalData(string externalData) { DARABONBA_PTR_SET_VALUE(externalData_, externalData) };
  ...
  protected:
    ...
    std::shared_ptr<string> externalData_ = nullptr;
    // 来源Idp Id
