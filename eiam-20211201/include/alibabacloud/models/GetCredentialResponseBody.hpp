...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Credential& setCredentialExternalId(string credentialExternalId) { DARABONBA_PTR_SET_VALUE(credentialExternalId_, credentialExternalId) };
    ...
    inline const GetCredentialResponseBody::Credential & getCredential() const { DARABONBA_PTR_GET_CONST(credential_, GetCredentialResponseBody::Credential) };
    inline GetCredentialResponseBody::Credential getCredential() { DARABONBA_PTR_GET(credential_, GetCredentialResponseBody::Credential) };
    inline GetCredentialResponseBody& setCredential(const GetCredentialResponseBody::Credential & credential) { DARABONBA_PTR_SET_VALUE(credential_, credential) };
    inline GetCredentialResponseBody& setCredential(GetCredentialResponseBody::Credential && credential) { DARABONBA_PTR_SET_RVALUE(credential_, credential) };
