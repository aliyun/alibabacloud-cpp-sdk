...
namespace Models
{
  ...
  public:
    ...
    inline const ListConditionalAccessPoliciesForApplicationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListConditionalAccessPoliciesForApplicationResponseBody) };
    inline ListConditionalAccessPoliciesForApplicationResponseBody body() { DARABONBA_PTR_GET(body_, ListConditionalAccessPoliciesForApplicationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListConditionalAccessPoliciesForApplicationResponseBody> body_ = nullptr;
  };
