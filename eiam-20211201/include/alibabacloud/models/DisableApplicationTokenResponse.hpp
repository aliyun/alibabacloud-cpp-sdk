...
namespace Models
{
  ...
  public:
    ...
    inline const DisableApplicationTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableApplicationTokenResponseBody) };
    inline DisableApplicationTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableApplicationTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableApplicationTokenResponseBody> body_ {};
  };
