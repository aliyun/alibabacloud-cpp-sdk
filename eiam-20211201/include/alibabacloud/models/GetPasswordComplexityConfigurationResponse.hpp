...
namespace Models
{
  ...
  public:
    ...
    inline const GetPasswordComplexityConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPasswordComplexityConfigurationResponseBody) };
    inline GetPasswordComplexityConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPasswordComplexityConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPasswordComplexityConfigurationResponseBody> body_ {};
  };
