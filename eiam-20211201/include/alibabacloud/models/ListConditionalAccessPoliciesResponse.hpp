...
namespace Models
{
  ...
  public:
    ...
    inline const ListConditionalAccessPoliciesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListConditionalAccessPoliciesResponseBody) };
    inline ListConditionalAccessPoliciesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListConditionalAccessPoliciesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListConditionalAccessPoliciesResponseBody> body_ {};
  };
