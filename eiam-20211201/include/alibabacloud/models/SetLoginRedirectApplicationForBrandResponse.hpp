...
namespace Models
{
  ...
  public:
    ...
    inline const SetLoginRedirectApplicationForBrandResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetLoginRedirectApplicationForBrandResponseBody) };
    inline SetLoginRedirectApplicationForBrandResponseBody body() { DARABONBA_PTR_GET(body_, SetLoginRedirectApplicationForBrandResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetLoginRedirectApplicationForBrandResponseBody> body_ = nullptr;
  };
