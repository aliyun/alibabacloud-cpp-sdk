...
namespace Models
{
  ...
  public:
    ...
    inline const GetDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDomainResponseBody) };
    inline GetDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDomainResponseBody> body_ {};
  };
