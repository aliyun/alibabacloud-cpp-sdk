...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateInstanceDescriptionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateInstanceDescriptionResponseBody) };
    inline UpdateInstanceDescriptionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateInstanceDescriptionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateInstanceDescriptionResponseBody> body_ {};
  };
