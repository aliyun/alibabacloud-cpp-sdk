...
#ifndef ALIBABACLOUD_MODELS_UPDATEAPPLICATIONTOKENEXPIRATIONTIMEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEAPPLICATIONTOKENEXPIRATIONTIMEREQUEST_HPP_
...
namespace Models
{
  class UpdateApplicationTokenExpirationTimeRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateApplicationTokenExpirationTimeRequest& obj) { 
      DARABONBA_PTR_TO_JSON(ApplicationId, applicationId_);
      DARABONBA_PTR_TO_JSON(ApplicationTokenId, applicationTokenId_);
      DARABONBA_PTR_TO_JSON(ExpirationTime, expirationTime_);
      DARABONBA_PTR_TO_JSON(InstanceId, instanceId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateApplicationTokenExpirationTimeRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(ApplicationId, applicationId_);
      DARABONBA_PTR_FROM_JSON(ApplicationTokenId, applicationTokenId_);
      DARABONBA_PTR_FROM_JSON(ExpirationTime, expirationTime_);
      DARABONBA_PTR_FROM_JSON(InstanceId, instanceId_);
    };
    UpdateApplicationTokenExpirationTimeRequest() = default ;
    UpdateApplicationTokenExpirationTimeRequest(const UpdateApplicationTokenExpirationTimeRequest &) = default ;
    UpdateApplicationTokenExpirationTimeRequest(UpdateApplicationTokenExpirationTimeRequest &&) = default ;
    UpdateApplicationTokenExpirationTimeRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateApplicationTokenExpirationTimeRequest() = default ;
    UpdateApplicationTokenExpirationTimeRequest& operator=(const UpdateApplicationTokenExpirationTimeRequest &) = default ;
    UpdateApplicationTokenExpirationTimeRequest& operator=(UpdateApplicationTokenExpirationTimeRequest &&) = default ;
