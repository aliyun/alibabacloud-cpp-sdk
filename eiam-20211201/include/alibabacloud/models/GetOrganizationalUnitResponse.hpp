...
namespace Models
{
  ...
  public:
    ...
    inline const GetOrganizationalUnitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOrganizationalUnitResponseBody) };
    inline GetOrganizationalUnitResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOrganizationalUnitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOrganizationalUnitResponseBody> body_ {};
  };
