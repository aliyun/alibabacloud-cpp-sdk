...
namespace Models
{
  ...
  public:
    ...
    inline const ListNetworkAccessEndpointsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNetworkAccessEndpointsResponseBody) };
    inline ListNetworkAccessEndpointsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNetworkAccessEndpointsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNetworkAccessEndpointsResponseBody> body_ {};
  };
