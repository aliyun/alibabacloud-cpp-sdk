...
namespace Models
{
  ...
  public:
    ...
    inline AuthorizeApplicationToOrganizationalUnitsRequest& setApplicationRoleId(string applicationRoleId) { DARABONBA_PTR_SET_VALUE(applicationRoleId_, applicationRoleId) };
