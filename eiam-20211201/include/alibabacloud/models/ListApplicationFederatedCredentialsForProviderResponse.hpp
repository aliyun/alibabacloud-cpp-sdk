...
namespace Models
{
  ...
  public:
    ...
    inline const ListApplicationFederatedCredentialsForProviderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApplicationFederatedCredentialsForProviderResponseBody) };
    inline ListApplicationFederatedCredentialsForProviderResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApplicationFederatedCredentialsForProviderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApplicationFederatedCredentialsForProviderResponseBody> body_ {};
  };
