...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBrandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBrandResponseBody) };
    inline CreateBrandResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBrandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBrandResponseBody> body_ {};
  };
