...
namespace Models
{
  ...
  public:
    ...
    inline const AuthorizeApplicationToOrganizationalUnitsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AuthorizeApplicationToOrganizationalUnitsResponseBody) };
    inline AuthorizeApplicationToOrganizationalUnitsResponseBody body() { DARABONBA_PTR_GET(body_, AuthorizeApplicationToOrganizationalUnitsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AuthorizeApplicationToOrganizationalUnitsResponseBody> body_ = nullptr;
  };
