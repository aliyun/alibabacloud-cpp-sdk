...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->networkAccessEndpoint_ != nullptr
    ...
    inline const GetNetworkAccessEndpointResponseBodyNetworkAccessEndpoint & networkAccessEndpoint() const { DARABONBA_PTR_GET_CONST(networkAccessEndpoint_, GetNetworkAccessEndpointResponseBodyNetworkAccessEndpoint) };
    inline GetNetworkAccessEndpointResponseBodyNetworkAccessEndpoint networkAccessEndpoint() { DARABONBA_PTR_GET(networkAccessEndpoint_, GetNetworkAccessEndpointResponseBodyNetworkAccessEndpoint) };
    inline GetNetworkAccessEndpointResponseBody& setNetworkAccessEndpoint(const GetNetworkAccessEndpointResponseBodyNetworkAccessEndpoint & networkAccessEndpoint) { DARABONBA_PTR_SET_VALUE(networkAccessEndpoint_, networkAccessEndpoint) };
    inline GetNetworkAccessEndpointResponseBody& setNetworkAccessEndpoint(GetNetworkAccessEndpointResponseBodyNetworkAccessEndpoint && networkAccessEndpoint) { DARABONBA_PTR_SET_RVALUE(networkAccessEndpoint_, networkAccessEndpoint) };
  ...
  protected:
    ...
    std::shared_ptr<GetNetworkAccessEndpointResponseBodyNetworkAccessEndpoint> networkAccessEndpoint_ = nullptr;
