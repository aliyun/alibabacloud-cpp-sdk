...
namespace Models
{
  ...
  public:
    ...
    inline const ListIdentityProvidersForNetworkAccessEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIdentityProvidersForNetworkAccessEndpointResponseBody) };
    inline ListIdentityProvidersForNetworkAccessEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIdentityProvidersForNetworkAccessEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIdentityProvidersForNetworkAccessEndpointResponseBody> body_ {};
  };
