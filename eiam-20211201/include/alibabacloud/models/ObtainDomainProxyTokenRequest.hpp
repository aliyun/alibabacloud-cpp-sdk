...
#ifndef ALIBABACLOUD_MODELS_OBTAINDOMAINPROXYTOKENREQUEST_HPP_
#define ALIBABACLOUD_MODELS_OBTAINDOMAINPROXYTOKENREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ObtainDomainProxyTokenRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DomainId, domainId_);
      DARABONBA_PTR_TO_JSON(DomainProxyTokenId, domainProxyTokenId_);
      DARABONBA_PTR_TO_JSON(InstanceId, instanceId_);
    };
    friend void from_json(const Darabonba::Json& j, ObtainDomainProxyTokenRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DomainId, domainId_);
      DARABONBA_PTR_FROM_JSON(DomainProxyTokenId, domainProxyTokenId_);
      DARABONBA_PTR_FROM_JSON(InstanceId, instanceId_);
    };
    ObtainDomainProxyTokenRequest() = default ;
    ObtainDomainProxyTokenRequest(const ObtainDomainProxyTokenRequest &) = default ;
    ObtainDomainProxyTokenRequest(ObtainDomainProxyTokenRequest &&) = default ;
    ObtainDomainProxyTokenRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ObtainDomainProxyTokenRequest() = default ;
    ObtainDomainProxyTokenRequest& operator=(const ObtainDomainProxyTokenRequest &) = default ;
    ObtainDomainProxyTokenRequest& operator=(ObtainDomainProxyTokenRequest &&) = default ;
