...
namespace Models
{
  ...
  public:
    ...
    inline const GetIdentityProviderUdPullConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetIdentityProviderUdPullConfigurationResponseBody) };
    inline GetIdentityProviderUdPullConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, GetIdentityProviderUdPullConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetIdentityProviderUdPullConfigurationResponseBody> body_ {};
  };
