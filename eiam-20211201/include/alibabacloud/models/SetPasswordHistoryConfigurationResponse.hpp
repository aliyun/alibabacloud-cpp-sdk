...
namespace Models
{
  ...
  public:
    ...
    inline const SetPasswordHistoryConfigurationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetPasswordHistoryConfigurationResponseBody) };
    inline SetPasswordHistoryConfigurationResponseBody body() { DARABONBA_PTR_GET(body_, SetPasswordHistoryConfigurationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetPasswordHistoryConfigurationResponseBody> body_ = nullptr;
  };
