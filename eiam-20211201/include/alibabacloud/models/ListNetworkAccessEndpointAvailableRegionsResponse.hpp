...
namespace Models
{
  ...
  public:
    ...
    inline const ListNetworkAccessEndpointAvailableRegionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNetworkAccessEndpointAvailableRegionsResponseBody) };
    inline ListNetworkAccessEndpointAvailableRegionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNetworkAccessEndpointAvailableRegionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNetworkAccessEndpointAvailableRegionsResponseBody> body_ {};
  };
