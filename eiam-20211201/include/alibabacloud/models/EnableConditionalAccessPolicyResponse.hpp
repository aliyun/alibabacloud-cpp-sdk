...
namespace Models
{
  ...
  public:
    ...
    inline const EnableConditionalAccessPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableConditionalAccessPolicyResponseBody) };
    inline EnableConditionalAccessPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableConditionalAccessPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableConditionalAccessPolicyResponseBody> body_ {};
  };
