...
namespace Models
{
  ...
  public:
    ...
    inline const CreateIdentityProviderStatusCheckJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateIdentityProviderStatusCheckJobResponseBody) };
    inline CreateIdentityProviderStatusCheckJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateIdentityProviderStatusCheckJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateIdentityProviderStatusCheckJobResponseBody> body_ {};
  };
