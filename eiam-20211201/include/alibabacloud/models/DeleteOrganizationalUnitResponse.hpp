...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteOrganizationalUnitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteOrganizationalUnitResponseBody) };
    inline DeleteOrganizationalUnitResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteOrganizationalUnitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteOrganizationalUnitResponseBody> body_ {};
  };
