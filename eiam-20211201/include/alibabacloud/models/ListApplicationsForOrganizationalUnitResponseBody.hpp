...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListApplicationsForOrganizationalUnitResponseBodyApplications> & applications() const { DARABONBA_PTR_GET_CONST(applications_, vector<ListApplicationsForOrganizationalUnitResponseBodyApplications>) };
    inline vector<ListApplicationsForOrganizationalUnitResponseBodyApplications> applications() { DARABONBA_PTR_GET(applications_, vector<ListApplicationsForOrganizationalUnitResponseBodyApplications>) };
    inline ListApplicationsForOrganizationalUnitResponseBody& setApplications(const vector<ListApplicationsForOrganizationalUnitResponseBodyApplications> & applications) { DARABONBA_PTR_SET_VALUE(applications_, applications) };
    inline ListApplicationsForOrganizationalUnitResponseBody& setApplications(vector<ListApplicationsForOrganizationalUnitResponseBodyApplications> && applications) { DARABONBA_PTR_SET_RVALUE(applications_, applications) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListApplicationsForOrganizationalUnitResponseBodyApplications>> applications_ = nullptr;
