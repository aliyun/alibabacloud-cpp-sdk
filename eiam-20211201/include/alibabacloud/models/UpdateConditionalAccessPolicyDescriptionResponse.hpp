...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateConditionalAccessPolicyDescriptionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateConditionalAccessPolicyDescriptionResponseBody) };
    inline UpdateConditionalAccessPolicyDescriptionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateConditionalAccessPolicyDescriptionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateConditionalAccessPolicyDescriptionResponseBody> body_ {};
  };
