...
namespace Models
{
  ...
  public:
    ...
    inline const SetApplicationProvisioningUserPrimaryOrganizationalUnitResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetApplicationProvisioningUserPrimaryOrganizationalUnitResponseBody) };
    inline SetApplicationProvisioningUserPrimaryOrganizationalUnitResponseBody body() { DARABONBA_PTR_GET(body_, SetApplicationProvisioningUserPrimaryOrganizationalUnitResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetApplicationProvisioningUserPrimaryOrganizationalUnitResponseBody> body_ = nullptr;
  };
