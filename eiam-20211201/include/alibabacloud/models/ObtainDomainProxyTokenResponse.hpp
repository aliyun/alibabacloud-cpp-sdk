...
namespace Models
{
  ...
  public:
    ...
    inline const ObtainDomainProxyTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ObtainDomainProxyTokenResponseBody) };
    inline ObtainDomainProxyTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, ObtainDomainProxyTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ObtainDomainProxyTokenResponseBody> body_ {};
  };
