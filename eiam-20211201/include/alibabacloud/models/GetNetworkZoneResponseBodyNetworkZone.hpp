...
#ifndef ALIBABACLOUD_MODELS_GETNETWORKZONERESPONSEBODYNETWORKZONE_HPP_
#define ALIBABACLOUD_MODELS_GETNETWORKZONERESPONSEBODYNETWORKZONE_HPP_
...
namespace Models
{
  class GetNetworkZoneResponseBodyNetworkZone : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetNetworkZoneResponseBodyNetworkZone& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetNetworkZoneResponseBodyNetworkZone& obj) { 
    ...
    GetNetworkZoneResponseBodyNetworkZone() = default ;
    GetNetworkZoneResponseBodyNetworkZone(const GetNetworkZoneResponseBodyNetworkZone &) = default ;
    GetNetworkZoneResponseBodyNetworkZone(GetNetworkZoneResponseBodyNetworkZone &&) = default ;
    GetNetworkZoneResponseBodyNetworkZone(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetNetworkZoneResponseBodyNetworkZone() = default ;
    GetNetworkZoneResponseBodyNetworkZone& operator=(const GetNetworkZoneResponseBodyNetworkZone &) = default ;
    GetNetworkZoneResponseBodyNetworkZone& operator=(GetNetworkZoneResponseBodyNetworkZone &&) = default ;
    ...
    inline GetNetworkZoneResponseBodyNetworkZone& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline GetNetworkZoneResponseBodyNetworkZone& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetNetworkZoneResponseBodyNetworkZone& setIpv4Cidrs(const vector<string> & ipv4Cidrs) { DARABONBA_PTR_SET_VALUE(ipv4Cidrs_, ipv4Cidrs) };
    inline GetNetworkZoneResponseBodyNetworkZone& setIpv4Cidrs(vector<string> && ipv4Cidrs) { DARABONBA_PTR_SET_RVALUE(ipv4Cidrs_, ipv4Cidrs) };
    ...
    inline GetNetworkZoneResponseBodyNetworkZone& setIpv6Cidrs(const vector<string> & ipv6Cidrs) { DARABONBA_PTR_SET_VALUE(ipv6Cidrs_, ipv6Cidrs) };
    inline GetNetworkZoneResponseBodyNetworkZone& setIpv6Cidrs(vector<string> && ipv6Cidrs) { DARABONBA_PTR_SET_RVALUE(ipv6Cidrs_, ipv6Cidrs) };
    ...
    inline GetNetworkZoneResponseBodyNetworkZone& setNetworkZoneId(string networkZoneId) { DARABONBA_PTR_SET_VALUE(networkZoneId_, networkZoneId) };
    ...
    inline GetNetworkZoneResponseBodyNetworkZone& setNetworkZoneName(string networkZoneName) { DARABONBA_PTR_SET_VALUE(networkZoneName_, networkZoneName) };
    ...
    inline GetNetworkZoneResponseBodyNetworkZone& setNetworkZoneType(string networkZoneType) { DARABONBA_PTR_SET_VALUE(networkZoneType_, networkZoneType) };
    ...
    inline GetNetworkZoneResponseBodyNetworkZone& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
