...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteUsersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteUsersResponseBody) };
    inline DeleteUsersResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteUsersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteUsersResponseBody> body_ {};
  };
