...
namespace Models
{
  ...
  public:
    ...
    inline const GetLoginRedirectApplicationForBrandResponseBodyBrandLoginRedirectApplication & brandLoginRedirectApplication() const { DARABONBA_PTR_GET_CONST(brandLoginRedirectApplication_, GetLoginRedirectApplicationForBrandResponseBodyBrandLoginRedirectApplication) };
    inline GetLoginRedirectApplicationForBrandResponseBodyBrandLoginRedirectApplication brandLoginRedirectApplication() { DARABONBA_PTR_GET(brandLoginRedirectApplication_, GetLoginRedirectApplicationForBrandResponseBodyBrandLoginRedirectApplication) };
    inline GetLoginRedirectApplicationForBrandResponseBody& setBrandLoginRedirectApplication(const GetLoginRedirectApplicationForBrandResponseBodyBrandLoginRedirectApplication & brandLoginRedirectApplication) { DARABONBA_PTR_SET_VALUE(brandLoginRedirectApplication_, brandLoginRedirectApplication) };
    inline GetLoginRedirectApplicationForBrandResponseBody& setBrandLoginRedirectApplication(GetLoginRedirectApplicationForBrandResponseBodyBrandLoginRedirectApplication && brandLoginRedirectApplication) { DARABONBA_PTR_SET_RVALUE(brandLoginRedirectApplication_, brandLoginRedirectApplication) };
  ...
  protected:
    std::shared_ptr<GetLoginRedirectApplicationForBrandResponseBodyBrandLoginRedirectApplication> brandLoginRedirectApplication_ = nullptr;
