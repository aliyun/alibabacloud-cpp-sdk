...
#ifndef ALIBABACLOUD_MODELS_LISTAUTHORIZATIONRULESFORAPPLICATIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTAUTHORIZATIONRULESFORAPPLICATIONRESPONSEBODY_HPP_
...
namespace Models
{
  class ListAuthorizationRulesForApplicationResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListAuthorizationRulesForApplicationResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAuthorizationRulesForApplicationResponseBody& obj) { 
    ...
    ListAuthorizationRulesForApplicationResponseBody() = default ;
    ListAuthorizationRulesForApplicationResponseBody(const ListAuthorizationRulesForApplicationResponseBody &) = default ;
    ListAuthorizationRulesForApplicationResponseBody(ListAuthorizationRulesForApplicationResponseBody &&) = default ;
    ListAuthorizationRulesForApplicationResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAuthorizationRulesForApplicationResponseBody() = default ;
    ListAuthorizationRulesForApplicationResponseBody& operator=(const ListAuthorizationRulesForApplicationResponseBody &) = default ;
    ListAuthorizationRulesForApplicationResponseBody& operator=(ListAuthorizationRulesForApplicationResponseBody &&) = default ;
    ...
    inline const vector<ListAuthorizationRulesForApplicationResponseBody::AuthorizationRules> & getAuthorizationRules() const { DARABONBA_PTR_GET_CONST(authorizationRules_, vector<ListAuthorizationRulesForApplicationResponseBody::AuthorizationRules>) };
    inline vector<ListAuthorizationRulesForApplicationResponseBody::AuthorizationRules> getAuthorizationRules() { DARABONBA_PTR_GET(authorizationRules_, vector<ListAuthorizationRulesForApplicationResponseBody::AuthorizationRules>) };
    inline ListAuthorizationRulesForApplicationResponseBody& setAuthorizationRules(const vector<ListAuthorizationRulesForApplicationResponseBody::AuthorizationRules> & authorizationRules) { DARABONBA_PTR_SET_VALUE(authorizationRules_, authorizationRules) };
    inline ListAuthorizationRulesForApplicationResponseBody& setAuthorizationRules(vector<ListAuthorizationRulesForApplicationResponseBody::AuthorizationRules> && authorizationRules) { DARABONBA_PTR_SET_RVALUE(authorizationRules_, authorizationRules) };
    ...
    inline ListAuthorizationRulesForApplicationResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListAuthorizationRulesForApplicationResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListAuthorizationRulesForApplicationResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListAuthorizationRulesForApplicationResponseBody& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };


  protected:
    shared_ptr<vector<ListAuthorizationRulesForApplicationResponseBody::AuthorizationRules>> authorizationRules_ {};
    // 分页查询时每页行数。
