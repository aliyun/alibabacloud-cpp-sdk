...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateNetworkAccessEndpointNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateNetworkAccessEndpointNameResponseBody) };
    inline UpdateNetworkAccessEndpointNameResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateNetworkAccessEndpointNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateNetworkAccessEndpointNameResponseBody> body_ {};
  };
