...
namespace Models
{
  ...
  public:
    ...
    inline const EnableInitDomainAutoRedirectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableInitDomainAutoRedirectResponseBody) };
    inline EnableInitDomainAutoRedirectResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableInitDomainAutoRedirectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableInitDomainAutoRedirectResponseBody> body_ {};
  };
