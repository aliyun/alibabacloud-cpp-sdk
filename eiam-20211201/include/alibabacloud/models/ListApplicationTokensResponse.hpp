...
namespace Models
{
  ...
  public:
    ...
    inline const ListApplicationTokensResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApplicationTokensResponseBody) };
    inline ListApplicationTokensResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApplicationTokensResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApplicationTokensResponseBody> body_ {};
  };
