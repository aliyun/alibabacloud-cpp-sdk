...
namespace Models
{
  ...
  public:
    ...
    inline const ListBrandsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListBrandsResponseBody) };
    inline ListBrandsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListBrandsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListBrandsResponseBody> body_ {};
  };
