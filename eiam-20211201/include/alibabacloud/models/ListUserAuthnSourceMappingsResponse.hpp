...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserAuthnSourceMappingsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListUserAuthnSourceMappingsResponseBody) };
    inline ListUserAuthnSourceMappingsResponseBody body() { DARABONBA_PTR_GET(body_, ListUserAuthnSourceMappingsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListUserAuthnSourceMappingsResponseBody> body_ = nullptr;
  };
