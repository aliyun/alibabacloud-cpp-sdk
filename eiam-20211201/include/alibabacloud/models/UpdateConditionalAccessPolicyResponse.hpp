...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateConditionalAccessPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateConditionalAccessPolicyResponseBody) };
    inline UpdateConditionalAccessPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateConditionalAccessPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateConditionalAccessPolicyResponseBody> body_ {};
  };
