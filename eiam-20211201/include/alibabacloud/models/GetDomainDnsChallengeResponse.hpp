...
namespace Models
{
  ...
  public:
    ...
    inline const GetDomainDnsChallengeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetDomainDnsChallengeResponseBody) };
    inline GetDomainDnsChallengeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetDomainDnsChallengeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetDomainDnsChallengeResponseBody> body_ {};
  };
