...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationFederatedCredentialId_ == nullptr
        && return this->applicationId_ == nullptr && return this->attributeMappings_ == nullptr && return this->instanceId_ == nullptr && return this->verificationCondition_ == nullptr; };
    ...
    inline const vector<UpdateApplicationFederatedCredentialRequestAttributeMappings> & attributeMappings() const { DARABONBA_PTR_GET_CONST(attributeMappings_, vector<UpdateApplicationFederatedCredentialRequestAttributeMappings>) };
    inline vector<UpdateApplicationFederatedCredentialRequestAttributeMappings> attributeMappings() { DARABONBA_PTR_GET(attributeMappings_, vector<UpdateApplicationFederatedCredentialRequestAttributeMappings>) };
    inline UpdateApplicationFederatedCredentialRequest& setAttributeMappings(const vector<UpdateApplicationFederatedCredentialRequestAttributeMappings> & attributeMappings) { DARABONBA_PTR_SET_VALUE(attributeMappings_, attributeMappings) };
    inline UpdateApplicationFederatedCredentialRequest& setAttributeMappings(vector<UpdateApplicationFederatedCredentialRequestAttributeMappings> && attributeMappings) { DARABONBA_PTR_SET_RVALUE(attributeMappings_, attributeMappings) };
  ...
  protected:
    ...
    // 属性映射
    std::shared_ptr<vector<UpdateApplicationFederatedCredentialRequestAttributeMappings>> attributeMappings_ = nullptr;
    // IDaaS EIAM实例的ID。
    // 
    // This parameter is required.
