...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->applicationFederatedCredentialId_ == nullptr
        && this->applicationId_ == nullptr && this->attributeMappings_ == nullptr && this->instanceId_ == nullptr && this->oidcVerificationConfig_ == nullptr && this->pkcs7VerificationConfig_ == nullptr
        && this->verificationCondition_ == nullptr; };
    ...
    inline const UpdateApplicationFederatedCredentialRequest::OidcVerificationConfig & getOidcVerificationConfig() const { DARABONBA_PTR_GET_CONST(oidcVerificationConfig_, UpdateApplicationFederatedCredentialRequest::OidcVerificationConfig) };
    inline UpdateApplicationFederatedCredentialRequest::OidcVerificationConfig getOidcVerificationConfig() { DARABONBA_PTR_GET(oidcVerificationConfig_, UpdateApplicationFederatedCredentialRequest::OidcVerificationConfig) };
    inline UpdateApplicationFederatedCredentialRequest& setOidcVerificationConfig(const UpdateApplicationFederatedCredentialRequest::OidcVerificationConfig & oidcVerificationConfig) { DARABONBA_PTR_SET_VALUE(oidcVerificationConfig_, oidcVerificationConfig) };
    inline UpdateApplicationFederatedCredentialRequest& setOidcVerificationConfig(UpdateApplicationFederatedCredentialRequest::OidcVerificationConfig && oidcVerificationConfig) { DARABONBA_PTR_SET_RVALUE(oidcVerificationConfig_, oidcVerificationConfig) };
    ...
    inline const UpdateApplicationFederatedCredentialRequest::Pkcs7VerificationConfig & getPkcs7VerificationConfig() const { DARABONBA_PTR_GET_CONST(pkcs7VerificationConfig_, UpdateApplicationFederatedCredentialRequest::Pkcs7VerificationConfig) };
    inline UpdateApplicationFederatedCredentialRequest::Pkcs7VerificationConfig getPkcs7VerificationConfig() { DARABONBA_PTR_GET(pkcs7VerificationConfig_, UpdateApplicationFederatedCredentialRequest::Pkcs7VerificationConfig) };
    inline UpdateApplicationFederatedCredentialRequest& setPkcs7VerificationConfig(const UpdateApplicationFederatedCredentialRequest::Pkcs7VerificationConfig & pkcs7VerificationConfig) { DARABONBA_PTR_SET_VALUE(pkcs7VerificationConfig_, pkcs7VerificationConfig) };
    inline UpdateApplicationFederatedCredentialRequest& setPkcs7VerificationConfig(UpdateApplicationFederatedCredentialRequest::Pkcs7VerificationConfig && pkcs7VerificationConfig) { DARABONBA_PTR_SET_RVALUE(pkcs7VerificationConfig_, pkcs7VerificationConfig) };
  ...
  protected:
    ...
    shared_ptr<UpdateApplicationFederatedCredentialRequest::OidcVerificationConfig> oidcVerificationConfig_ {};
    // The PKCS#7 structured configuration (structured mode + pkcs7 type).
    shared_ptr<UpdateApplicationFederatedCredentialRequest::Pkcs7VerificationConfig> pkcs7VerificationConfig_ {};
