...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Credentials& setCredentialExternalId(string credentialExternalId) { DARABONBA_PTR_SET_VALUE(credentialExternalId_, credentialExternalId) };
      ...
      inline Credentials& setCredentialSharingScope(string credentialSharingScope) { DARABONBA_PTR_SET_VALUE(credentialSharingScope_, credentialSharingScope) };
      ...
      inline Credentials& setExclusiveUserId(string exclusiveUserId) { DARABONBA_PTR_SET_VALUE(exclusiveUserId_, exclusiveUserId) };
