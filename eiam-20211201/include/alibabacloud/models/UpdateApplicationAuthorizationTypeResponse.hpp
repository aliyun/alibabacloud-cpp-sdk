...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateApplicationAuthorizationTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateApplicationAuthorizationTypeResponseBody) };
    inline UpdateApplicationAuthorizationTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateApplicationAuthorizationTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateApplicationAuthorizationTypeResponseBody> body_ {};
  };
