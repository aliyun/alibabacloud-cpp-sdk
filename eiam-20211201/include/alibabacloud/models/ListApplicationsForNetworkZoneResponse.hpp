...
namespace Models
{
  ...
  public:
    ...
    inline const ListApplicationsForNetworkZoneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApplicationsForNetworkZoneResponseBody) };
    inline ListApplicationsForNetworkZoneResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApplicationsForNetworkZoneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApplicationsForNetworkZoneResponseBody> body_ {};
  };
