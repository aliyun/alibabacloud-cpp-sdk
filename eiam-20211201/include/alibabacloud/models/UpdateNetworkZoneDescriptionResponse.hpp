...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateNetworkZoneDescriptionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateNetworkZoneDescriptionResponseBody) };
    inline UpdateNetworkZoneDescriptionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateNetworkZoneDescriptionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateNetworkZoneDescriptionResponseBody> body_ {};
  };
