...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOrganizationalUnitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateOrganizationalUnitResponseBody) };
    inline CreateOrganizationalUnitResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateOrganizationalUnitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateOrganizationalUnitResponseBody> body_ {};
  };
