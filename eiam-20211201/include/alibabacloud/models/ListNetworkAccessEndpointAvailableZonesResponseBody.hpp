...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListNetworkAccessEndpointAvailableZonesResponseBodyZones> & zones() const { DARABONBA_PTR_GET_CONST(zones_, vector<ListNetworkAccessEndpointAvailableZonesResponseBodyZones>) };
    inline vector<ListNetworkAccessEndpointAvailableZonesResponseBodyZones> zones() { DARABONBA_PTR_GET(zones_, vector<ListNetworkAccessEndpointAvailableZonesResponseBodyZones>) };
    inline ListNetworkAccessEndpointAvailableZonesResponseBody& setZones(const vector<ListNetworkAccessEndpointAvailableZonesResponseBodyZones> & zones) { DARABONBA_PTR_SET_VALUE(zones_, zones) };
    inline ListNetworkAccessEndpointAvailableZonesResponseBody& setZones(vector<ListNetworkAccessEndpointAvailableZonesResponseBodyZones> && zones) { DARABONBA_PTR_SET_RVALUE(zones_, zones) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<ListNetworkAccessEndpointAvailableZonesResponseBodyZones>> zones_ = nullptr;
  };
