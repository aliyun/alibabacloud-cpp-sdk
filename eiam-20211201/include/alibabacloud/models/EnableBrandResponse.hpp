...
namespace Models
{
  ...
  public:
    ...
    inline const EnableBrandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableBrandResponseBody) };
    inline EnableBrandResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableBrandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableBrandResponseBody> body_ {};
  };
