...
namespace Models
{
  ...
  public:
    ...
    inline const ListApplicationsForNetworkAccessEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApplicationsForNetworkAccessEndpointResponseBody) };
    inline ListApplicationsForNetworkAccessEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApplicationsForNetworkAccessEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApplicationsForNetworkAccessEndpointResponseBody> body_ {};
  };
