...
namespace Models
{
  ...
  public:
    ...
    inline const BindUserAuthnSourceMappingResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, BindUserAuthnSourceMappingResponseBody) };
    inline BindUserAuthnSourceMappingResponseBody body() { DARABONBA_PTR_GET(body_, BindUserAuthnSourceMappingResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<BindUserAuthnSourceMappingResponseBody> body_ = nullptr;
  };
