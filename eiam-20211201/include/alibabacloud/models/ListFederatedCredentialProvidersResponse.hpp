...
namespace Models
{
  ...
  public:
    ...
    inline const ListFederatedCredentialProvidersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFederatedCredentialProvidersResponseBody) };
    inline ListFederatedCredentialProvidersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFederatedCredentialProvidersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFederatedCredentialProvidersResponseBody> body_ {};
  };
