...
namespace Models
{
  ...
  public:
    ...
    inline const GetGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetGroupResponseBody) };
    inline GetGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetGroupResponseBody> body_ {};
  };
