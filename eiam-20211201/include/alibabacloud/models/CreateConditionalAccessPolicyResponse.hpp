...
namespace Models
{
  ...
  public:
    ...
    inline const CreateConditionalAccessPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateConditionalAccessPolicyResponseBody) };
    inline CreateConditionalAccessPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateConditionalAccessPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateConditionalAccessPolicyResponseBody> body_ {};
  };
