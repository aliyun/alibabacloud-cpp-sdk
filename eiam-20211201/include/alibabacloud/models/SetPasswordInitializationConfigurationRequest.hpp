...
#ifndef ALIBABACLOUD_MODELS_SETPASSWORDINITIALIZATIONCONFIGURATIONREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SETPASSWORDINITIALIZATIONCONFIGURATIONREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SetPasswordInitializationConfigurationRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SetPasswordInitializationConfigurationRequest& obj) { 
    ...
    SetPasswordInitializationConfigurationRequest() = default ;
    SetPasswordInitializationConfigurationRequest(const SetPasswordInitializationConfigurationRequest &) = default ;
    SetPasswordInitializationConfigurationRequest(SetPasswordInitializationConfigurationRequest &&) = default ;
    SetPasswordInitializationConfigurationRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SetPasswordInitializationConfigurationRequest() = default ;
    SetPasswordInitializationConfigurationRequest& operator=(const SetPasswordInitializationConfigurationRequest &) = default ;
    SetPasswordInitializationConfigurationRequest& operator=(SetPasswordInitializationConfigurationRequest &&) = default ;
