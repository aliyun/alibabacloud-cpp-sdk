...
#ifndef ALIBABACLOUD_MODELS_UPDATEMCPSERVICEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEMCPSERVICEREQUEST_HPP_
...
namespace Models
{
  class UpdateMcpServiceRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UpdateMcpServiceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateMcpServiceRequest& obj) { 
    ...
    UpdateMcpServiceRequest() = default ;
    UpdateMcpServiceRequest(const UpdateMcpServiceRequest &) = default ;
    UpdateMcpServiceRequest(UpdateMcpServiceRequest &&) = default ;
    UpdateMcpServiceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateMcpServiceRequest() = default ;
    UpdateMcpServiceRequest& operator=(const UpdateMcpServiceRequest &) = default ;
    UpdateMcpServiceRequest& operator=(UpdateMcpServiceRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->connection_ == nullptr
        && this->description_ == nullptr && this->displayName_ == nullptr && this->enable_ == nullptr && this->network_ == nullptr && this->tools_ == nullptr; };
    ...
    inline const UpdateMcpServiceRequest::Connection & getConnection() const { DARABONBA_PTR_GET_CONST(connection_, UpdateMcpServiceRequest::Connection) };
    inline UpdateMcpServiceRequest::Connection getConnection() { DARABONBA_PTR_GET(connection_, UpdateMcpServiceRequest::Connection) };
    inline UpdateMcpServiceRequest& setConnection(const UpdateMcpServiceRequest::Connection & connection) { DARABONBA_PTR_SET_VALUE(connection_, connection) };
    inline UpdateMcpServiceRequest& setConnection(UpdateMcpServiceRequest::Connection && connection) { DARABONBA_PTR_SET_RVALUE(connection_, connection) };
    ...
    void deleteDescription() { this->description_ = nullptr;};
    inline string getDescription() const { DARABONBA_PTR_GET_DEFAULT(description_, "") };
    inline UpdateMcpServiceRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    void deleteDisplayName() { this->displayName_ = nullptr;};
    inline string getDisplayName() const { DARABONBA_PTR_GET_DEFAULT(displayName_, "") };
    inline UpdateMcpServiceRequest& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    void deleteEnable() { this->enable_ = nullptr;};
    inline bool getEnable() const { DARABONBA_PTR_GET_DEFAULT(enable_, false) };
    inline UpdateMcpServiceRequest& setEnable(bool enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };


    // network Field Functions 
    bool hasNetwork() const { return this->network_ != nullptr;};
    void deleteNetwork() { this->network_ = nullptr;};
    inline const UpdateMcpServiceRequest::Network & getNetwork() const { DARABONBA_PTR_GET_CONST(network_, UpdateMcpServiceRequest::Network) };
    inline UpdateMcpServiceRequest::Network getNetwork() { DARABONBA_PTR_GET(network_, UpdateMcpServiceRequest::Network) };
    inline UpdateMcpServiceRequest& setNetwork(const UpdateMcpServiceRequest::Network & network) { DARABONBA_PTR_SET_VALUE(network_, network) };
    inline UpdateMcpServiceRequest& setNetwork(UpdateMcpServiceRequest::Network && network) { DARABONBA_PTR_SET_RVALUE(network_, network) };


    // tools Field Functions 
    bool hasTools() const { return this->tools_ != nullptr;};
    void deleteTools() { this->tools_ = nullptr;};
    inline const vector<UpdateMcpServiceRequest::Tools> & getTools() const { DARABONBA_PTR_GET_CONST(tools_, vector<UpdateMcpServiceRequest::Tools>) };
    inline vector<UpdateMcpServiceRequest::Tools> getTools() { DARABONBA_PTR_GET(tools_, vector<UpdateMcpServiceRequest::Tools>) };
    inline UpdateMcpServiceRequest& setTools(const vector<UpdateMcpServiceRequest::Tools> & tools) { DARABONBA_PTR_SET_VALUE(tools_, tools) };
    inline UpdateMcpServiceRequest& setTools(vector<UpdateMcpServiceRequest::Tools> && tools) { DARABONBA_PTR_SET_RVALUE(tools_, tools) };


  protected:
    // This parameter is required.
    shared_ptr<UpdateMcpServiceRequest::Connection> connection_ {};
    shared_ptr<string> description_ {};
    shared_ptr<string> displayName_ {};
    // This parameter is required.
    shared_ptr<bool> enable_ {};
    // This parameter is required.
    shared_ptr<UpdateMcpServiceRequest::Network> network_ {};
    // This parameter is required.
    shared_ptr<vector<UpdateMcpServiceRequest::Tools>> tools_ {};
  };
