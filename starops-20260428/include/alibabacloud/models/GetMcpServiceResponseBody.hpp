...
#ifndef ALIBABACLOUD_MODELS_GETMCPSERVICERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETMCPSERVICERESPONSEBODY_HPP_
...
namespace Models
{
  class GetMcpServiceResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const GetMcpServiceResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(mcpService, mcpService_);
      DARABONBA_PTR_TO_JSON(regionId, regionId_);
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetMcpServiceResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(mcpService, mcpService_);
      DARABONBA_PTR_FROM_JSON(regionId, regionId_);
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
    };
    GetMcpServiceResponseBody() = default ;
    GetMcpServiceResponseBody(const GetMcpServiceResponseBody &) = default ;
    GetMcpServiceResponseBody(GetMcpServiceResponseBody &&) = default ;
    GetMcpServiceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetMcpServiceResponseBody() = default ;
    GetMcpServiceResponseBody& operator=(const GetMcpServiceResponseBody &) = default ;
    GetMcpServiceResponseBody& operator=(GetMcpServiceResponseBody &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    class McpService : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const McpService& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, McpService& obj) { 
      ...
      McpService() = default ;
      McpService(const McpService &) = default ;
      McpService(McpService &&) = default ;
      McpService(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~McpService() = default ;
      McpService& operator=(const McpService &) = default ;
      McpService& operator=(McpService &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      inline const McpService::Connection & getConnection() const { DARABONBA_PTR_GET_CONST(connection_, McpService::Connection) };
      inline McpService::Connection getConnection() { DARABONBA_PTR_GET(connection_, McpService::Connection) };
      inline McpService& setConnection(const McpService::Connection & connection) { DARABONBA_PTR_SET_VALUE(connection_, connection) };
      inline McpService& setConnection(McpService::Connection && connection) { DARABONBA_PTR_SET_RVALUE(connection_, connection) };
      ...
      void deleteDescription() { this->description_ = nullptr;};
      inline string getDescription() const { DARABONBA_PTR_GET_DEFAULT(description_, "") };
      inline McpService& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
      ...
      void deleteDisplayName() { this->displayName_ = nullptr;};
      inline string getDisplayName() const { DARABONBA_PTR_GET_DEFAULT(displayName_, "") };
      inline McpService& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
      ...
      void deleteEnable() { this->enable_ = nullptr;};
      inline bool getEnable() const { DARABONBA_PTR_GET_DEFAULT(enable_, false) };
      inline McpService& setEnable(bool enable) { DARABONBA_PTR_SET_VALUE(enable_, enable) };
      ...
      inline McpService& setMcpServiceName(string mcpServiceName) { DARABONBA_PTR_SET_VALUE(mcpServiceName_, mcpServiceName) };


      // network Field Functions 
      bool hasNetwork() const { return this->network_ != nullptr;};
      void deleteNetwork() { this->network_ = nullptr;};
      inline const McpService::Network & getNetwork() const { DARABONBA_PTR_GET_CONST(network_, McpService::Network) };
      inline McpService::Network getNetwork() { DARABONBA_PTR_GET(network_, McpService::Network) };
      inline McpService& setNetwork(const McpService::Network & network) { DARABONBA_PTR_SET_VALUE(network_, network) };
      inline McpService& setNetwork(McpService::Network && network) { DARABONBA_PTR_SET_RVALUE(network_, network) };


      // tools Field Functions 
      bool hasTools() const { return this->tools_ != nullptr;};
      void deleteTools() { this->tools_ = nullptr;};
      inline const vector<McpService::Tools> & getTools() const { DARABONBA_PTR_GET_CONST(tools_, vector<McpService::Tools>) };
      inline vector<McpService::Tools> getTools() { DARABONBA_PTR_GET(tools_, vector<McpService::Tools>) };
      inline McpService& setTools(const vector<McpService::Tools> & tools) { DARABONBA_PTR_SET_VALUE(tools_, tools) };
      inline McpService& setTools(vector<McpService::Tools> && tools) { DARABONBA_PTR_SET_RVALUE(tools_, tools) };
    ...
    virtual bool empty() const override { return this->mcpService_ == nullptr
        && this->regionId_ == nullptr && this->requestId_ == nullptr; };
    // mcpService Field Functions 
    bool hasMcpService() const { return this->mcpService_ != nullptr;};
    void deleteMcpService() { this->mcpService_ = nullptr;};
    inline const GetMcpServiceResponseBody::McpService & getMcpService() const { DARABONBA_PTR_GET_CONST(mcpService_, GetMcpServiceResponseBody::McpService) };
    inline GetMcpServiceResponseBody::McpService getMcpService() { DARABONBA_PTR_GET(mcpService_, GetMcpServiceResponseBody::McpService) };
    inline GetMcpServiceResponseBody& setMcpService(const GetMcpServiceResponseBody::McpService & mcpService) { DARABONBA_PTR_SET_VALUE(mcpService_, mcpService) };
    inline GetMcpServiceResponseBody& setMcpService(GetMcpServiceResponseBody::McpService && mcpService) { DARABONBA_PTR_SET_RVALUE(mcpService_, mcpService) };
    ...
    inline GetMcpServiceResponseBody& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline GetMcpServiceResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
