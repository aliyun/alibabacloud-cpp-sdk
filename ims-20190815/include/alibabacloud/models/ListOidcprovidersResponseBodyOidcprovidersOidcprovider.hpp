...
#ifndef ALIBABACLOUD_MODELS_LISTOIDCPROVIDERSRESPONSEBODYOIDCPROVIDERSOIDCPROVIDER_HPP_
#define ALIBABACLOUD_MODELS_LISTOIDCPROVIDERSRESPONSEBODYOIDCPROVIDERSOIDCPROVIDER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& obj) { 
    ...
    ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider() = default ;
    ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider(const ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider &) = default ;
    ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider(ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider &&) = default ;
    ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider() = default ;
    ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& operator=(const ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider &) = default ;
    ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& operator=(ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider &&) = default ;
    ...
    inline ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& setArn(string arn) { DARABONBA_PTR_SET_VALUE(arn_, arn) };
    ...
    inline ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& setClientIds(string clientIds) { DARABONBA_PTR_SET_VALUE(clientIds_, clientIds) };
    ...
    inline ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& setCreateDate(string createDate) { DARABONBA_PTR_SET_VALUE(createDate_, createDate) };
    ...
    inline ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& setFingerprints(string fingerprints) { DARABONBA_PTR_SET_VALUE(fingerprints_, fingerprints) };
    ...
    inline ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& setIssuanceLimitTime(int64_t issuanceLimitTime) { DARABONBA_PTR_SET_VALUE(issuanceLimitTime_, issuanceLimitTime) };
    ...
    inline ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& setIssuerUrl(string issuerUrl) { DARABONBA_PTR_SET_VALUE(issuerUrl_, issuerUrl) };
    ...
    inline ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& setOIDCProviderName(string OIDCProviderName) { DARABONBA_PTR_SET_VALUE(OIDCProviderName_, OIDCProviderName) };
    ...
    inline ListOIDCProvidersResponseBodyOIDCProvidersOIDCProvider& setUpdateDate(string updateDate) { DARABONBA_PTR_SET_VALUE(updateDate_, updateDate) };
