...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateOIDCProviderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateOIDCProviderResponseBody) };
    inline UpdateOIDCProviderResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateOIDCProviderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateOIDCProviderResponseBody> body_ {};
  };
