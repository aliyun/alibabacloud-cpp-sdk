...
namespace Models
{
  ...
  public:
    ...
    inline const ListUsersInRecycleBinResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUsersInRecycleBinResponseBody) };
    inline ListUsersInRecycleBinResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUsersInRecycleBinResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUsersInRecycleBinResponseBody> body_ {};
  };
