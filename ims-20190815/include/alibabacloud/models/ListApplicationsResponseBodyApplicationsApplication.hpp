...
namespace Models
{
  ...
  public:
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setAccessTokenValidity(int32_t accessTokenValidity) { DARABONBA_PTR_SET_VALUE(accessTokenValidity_, accessTokenValidity) };
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setAccountId(string accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setAppId(string appId) { DARABONBA_PTR_SET_VALUE(appId_, appId) };
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setAppType(string appType) { DARABONBA_PTR_SET_VALUE(appType_, appType) };
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setCreateDate(string createDate) { DARABONBA_PTR_SET_VALUE(createDate_, createDate) };
    ...
    inline const Models::ListApplicationsResponseBodyApplicationsApplicationDelegatedScope & delegatedScope() const { DARABONBA_PTR_GET_CONST(delegatedScope_, Models::ListApplicationsResponseBodyApplicationsApplicationDelegatedScope) };
    inline Models::ListApplicationsResponseBodyApplicationsApplicationDelegatedScope delegatedScope() { DARABONBA_PTR_GET(delegatedScope_, Models::ListApplicationsResponseBodyApplicationsApplicationDelegatedScope) };
    inline ListApplicationsResponseBodyApplicationsApplication& setDelegatedScope(const Models::ListApplicationsResponseBodyApplicationsApplicationDelegatedScope & delegatedScope) { DARABONBA_PTR_SET_VALUE(delegatedScope_, delegatedScope) };
    inline ListApplicationsResponseBodyApplicationsApplication& setDelegatedScope(Models::ListApplicationsResponseBodyApplicationsApplicationDelegatedScope && delegatedScope) { DARABONBA_PTR_SET_RVALUE(delegatedScope_, delegatedScope) };
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setIsMultiTenant(bool isMultiTenant) { DARABONBA_PTR_SET_VALUE(isMultiTenant_, isMultiTenant) };
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setProtocolVersion(string protocolVersion) { DARABONBA_PTR_SET_VALUE(protocolVersion_, protocolVersion) };
    ...
    inline const Models::ListApplicationsResponseBodyApplicationsApplicationRedirectUris & redirectUris() const { DARABONBA_PTR_GET_CONST(redirectUris_, Models::ListApplicationsResponseBodyApplicationsApplicationRedirectUris) };
    inline Models::ListApplicationsResponseBodyApplicationsApplicationRedirectUris redirectUris() { DARABONBA_PTR_GET(redirectUris_, Models::ListApplicationsResponseBodyApplicationsApplicationRedirectUris) };
    inline ListApplicationsResponseBodyApplicationsApplication& setRedirectUris(const Models::ListApplicationsResponseBodyApplicationsApplicationRedirectUris & redirectUris) { DARABONBA_PTR_SET_VALUE(redirectUris_, redirectUris) };
    inline ListApplicationsResponseBodyApplicationsApplication& setRedirectUris(Models::ListApplicationsResponseBodyApplicationsApplicationRedirectUris && redirectUris) { DARABONBA_PTR_SET_RVALUE(redirectUris_, redirectUris) };
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setRefreshTokenValidity(int32_t refreshTokenValidity) { DARABONBA_PTR_SET_VALUE(refreshTokenValidity_, refreshTokenValidity) };
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setSecretRequired(bool secretRequired) { DARABONBA_PTR_SET_VALUE(secretRequired_, secretRequired) };
    ...
    inline ListApplicationsResponseBodyApplicationsApplication& setUpdateDate(string updateDate) { DARABONBA_PTR_SET_VALUE(updateDate_, updateDate) };
  ...
  protected:
    ...
    std::shared_ptr<Models::ListApplicationsResponseBodyApplicationsApplicationDelegatedScope> delegatedScope_ = nullptr;
    ...
    // The callback URLs.
    std::shared_ptr<Models::ListApplicationsResponseBodyApplicationsApplicationRedirectUris> redirectUris_ = nullptr;
