...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAppSecretResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAppSecretResponseBody) };
    inline CreateAppSecretResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAppSecretResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAppSecretResponseBody> body_ {};
  };
