...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->allowUserToChangePassword_ != nullptr
        ...
        && this->loginNetworkMasks_ != nullptr && this->loginSessionDuration_ != nullptr && this->MFAOperationForLogin_ != nullptr && this->operationForRiskLogin_ != nullptr && this->verificationTypes_ != nullptr; };
