...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserSsoSettingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserSsoSettingsResponseBody) };
    inline GetUserSsoSettingsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserSsoSettingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserSsoSettingsResponseBody> body_ {};
  };
