...
namespace Models
{
  ...
  public:
    ...
    inline const ListApplicationProvisionInfosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApplicationProvisionInfosResponseBody) };
    inline ListApplicationProvisionInfosResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApplicationProvisionInfosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApplicationProvisionInfosResponseBody> body_ {};
  };
