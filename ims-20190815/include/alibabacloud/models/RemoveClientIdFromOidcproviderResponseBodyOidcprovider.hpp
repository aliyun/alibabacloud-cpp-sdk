...
#ifndef ALIBABACLOUD_MODELS_REMOVECLIENTIDFROMOIDCPROVIDERRESPONSEBODYOIDCPROVIDER_HPP_
#define ALIBABACLOUD_MODELS_REMOVECLIENTIDFROMOIDCPROVIDERRESPONSEBODYOIDCPROVIDER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& obj) { 
    ...
    RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider() = default ;
    RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider(const RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider &) = default ;
    RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider(RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider &&) = default ;
    RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider() = default ;
    RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& operator=(const RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider &) = default ;
    RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& operator=(RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider &&) = default ;
    ...
    inline RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& setArn(string arn) { DARABONBA_PTR_SET_VALUE(arn_, arn) };
    ...
    inline RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& setClientIds(string clientIds) { DARABONBA_PTR_SET_VALUE(clientIds_, clientIds) };
    ...
    inline RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& setCreateDate(string createDate) { DARABONBA_PTR_SET_VALUE(createDate_, createDate) };
    ...
    inline RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& setFingerprints(string fingerprints) { DARABONBA_PTR_SET_VALUE(fingerprints_, fingerprints) };
    ...
    inline RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& setIssuanceLimitTime(int64_t issuanceLimitTime) { DARABONBA_PTR_SET_VALUE(issuanceLimitTime_, issuanceLimitTime) };
    ...
    inline RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& setIssuerUrl(string issuerUrl) { DARABONBA_PTR_SET_VALUE(issuerUrl_, issuerUrl) };
    ...
    inline RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& setOIDCProviderName(string OIDCProviderName) { DARABONBA_PTR_SET_VALUE(OIDCProviderName_, OIDCProviderName) };
    ...
    inline RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider& setUpdateDate(string updateDate) { DARABONBA_PTR_SET_VALUE(updateDate_, updateDate) };
