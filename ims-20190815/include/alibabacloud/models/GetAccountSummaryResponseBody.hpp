...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccountSummaryResponseBodySummaryMap & summaryMap() const { DARABONBA_PTR_GET_CONST(summaryMap_, GetAccountSummaryResponseBodySummaryMap) };
    inline GetAccountSummaryResponseBodySummaryMap summaryMap() { DARABONBA_PTR_GET(summaryMap_, GetAccountSummaryResponseBodySummaryMap) };
    inline GetAccountSummaryResponseBody& setSummaryMap(const GetAccountSummaryResponseBodySummaryMap & summaryMap) { DARABONBA_PTR_SET_VALUE(summaryMap_, summaryMap) };
    inline GetAccountSummaryResponseBody& setSummaryMap(GetAccountSummaryResponseBodySummaryMap && summaryMap) { DARABONBA_PTR_SET_RVALUE(summaryMap_, summaryMap) };
  ...
  protected:
    ...
    std::shared_ptr<GetAccountSummaryResponseBodySummaryMap> summaryMap_ = nullptr;
  };
