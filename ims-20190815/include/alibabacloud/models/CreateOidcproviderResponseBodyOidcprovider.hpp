...
#ifndef ALIBABACLOUD_MODELS_CREATEOIDCPROVIDERRESPONSEBODYOIDCPROVIDER_HPP_
#define ALIBABACLOUD_MODELS_CREATEOIDCPROVIDERRESPONSEBODYOIDCPROVIDER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateOIDCProviderResponseBodyOIDCProvider& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateOIDCProviderResponseBodyOIDCProvider& obj) { 
    ...
    CreateOIDCProviderResponseBodyOIDCProvider() = default ;
    CreateOIDCProviderResponseBodyOIDCProvider(const CreateOIDCProviderResponseBodyOIDCProvider &) = default ;
    CreateOIDCProviderResponseBodyOIDCProvider(CreateOIDCProviderResponseBodyOIDCProvider &&) = default ;
    CreateOIDCProviderResponseBodyOIDCProvider(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateOIDCProviderResponseBodyOIDCProvider() = default ;
    CreateOIDCProviderResponseBodyOIDCProvider& operator=(const CreateOIDCProviderResponseBodyOIDCProvider &) = default ;
    CreateOIDCProviderResponseBodyOIDCProvider& operator=(CreateOIDCProviderResponseBodyOIDCProvider &&) = default ;
    ...
    inline CreateOIDCProviderResponseBodyOIDCProvider& setArn(string arn) { DARABONBA_PTR_SET_VALUE(arn_, arn) };
    ...
    inline CreateOIDCProviderResponseBodyOIDCProvider& setClientIds(string clientIds) { DARABONBA_PTR_SET_VALUE(clientIds_, clientIds) };
    ...
    inline CreateOIDCProviderResponseBodyOIDCProvider& setCreateDate(string createDate) { DARABONBA_PTR_SET_VALUE(createDate_, createDate) };
    ...
    inline CreateOIDCProviderResponseBodyOIDCProvider& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreateOIDCProviderResponseBodyOIDCProvider& setFingerprints(string fingerprints) { DARABONBA_PTR_SET_VALUE(fingerprints_, fingerprints) };
    ...
    inline CreateOIDCProviderResponseBodyOIDCProvider& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline CreateOIDCProviderResponseBodyOIDCProvider& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline CreateOIDCProviderResponseBodyOIDCProvider& setIssuanceLimitTime(int64_t issuanceLimitTime) { DARABONBA_PTR_SET_VALUE(issuanceLimitTime_, issuanceLimitTime) };
    ...
    inline CreateOIDCProviderResponseBodyOIDCProvider& setIssuerUrl(string issuerUrl) { DARABONBA_PTR_SET_VALUE(issuerUrl_, issuerUrl) };
    ...
    inline CreateOIDCProviderResponseBodyOIDCProvider& setOIDCProviderName(string OIDCProviderName) { DARABONBA_PTR_SET_VALUE(OIDCProviderName_, OIDCProviderName) };
    ...
    inline CreateOIDCProviderResponseBodyOIDCProvider& setUpdateDate(string updateDate) { DARABONBA_PTR_SET_VALUE(updateDate_, updateDate) };
