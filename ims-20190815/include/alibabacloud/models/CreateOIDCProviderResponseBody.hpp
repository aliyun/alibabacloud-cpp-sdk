...
namespace Models
{
  ...
  public:
    ...
    inline const CreateOIDCProviderResponseBody::OIDCProvider & getOIDCProvider() const { DARABONBA_PTR_GET_CONST(OIDCProvider_, CreateOIDCProviderResponseBody::OIDCProvider) };
    inline CreateOIDCProviderResponseBody::OIDCProvider getOIDCProvider() { DARABONBA_PTR_GET(OIDCProvider_, CreateOIDCProviderResponseBody::OIDCProvider) };
    inline CreateOIDCProviderResponseBody& setOIDCProvider(const CreateOIDCProviderResponseBody::OIDCProvider & oIDCProvider) { DARABONBA_PTR_SET_VALUE(OIDCProvider_, oIDCProvider) };
    inline CreateOIDCProviderResponseBody& setOIDCProvider(CreateOIDCProviderResponseBody::OIDCProvider && oIDCProvider) { DARABONBA_PTR_SET_RVALUE(OIDCProvider_, oIDCProvider) };
  ...
  protected:
    ...
    shared_ptr<CreateOIDCProviderResponseBody::OIDCProvider> OIDCProvider_ {};
    // The request ID.
