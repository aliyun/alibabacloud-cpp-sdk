...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSAMLProviderResponseBody::SAMLProvider & getSAMLProvider() const { DARABONBA_PTR_GET_CONST(SAMLProvider_, UpdateSAMLProviderResponseBody::SAMLProvider) };
    inline UpdateSAMLProviderResponseBody::SAMLProvider getSAMLProvider() { DARABONBA_PTR_GET(SAMLProvider_, UpdateSAMLProviderResponseBody::SAMLProvider) };
    inline UpdateSAMLProviderResponseBody& setSAMLProvider(const UpdateSAMLProviderResponseBody::SAMLProvider & sAMLProvider) { DARABONBA_PTR_SET_VALUE(SAMLProvider_, sAMLProvider) };
    inline UpdateSAMLProviderResponseBody& setSAMLProvider(UpdateSAMLProviderResponseBody::SAMLProvider && sAMLProvider) { DARABONBA_PTR_SET_RVALUE(SAMLProvider_, sAMLProvider) };
