...
namespace Models
{
  ...
  public:
    ...
    inline const GetOIDCProviderResponseBody::OIDCProvider & getOIDCProvider() const { DARABONBA_PTR_GET_CONST(OIDCProvider_, GetOIDCProviderResponseBody::OIDCProvider) };
    inline GetOIDCProviderResponseBody::OIDCProvider getOIDCProvider() { DARABONBA_PTR_GET(OIDCProvider_, GetOIDCProviderResponseBody::OIDCProvider) };
    inline GetOIDCProviderResponseBody& setOIDCProvider(const GetOIDCProviderResponseBody::OIDCProvider & oIDCProvider) { DARABONBA_PTR_SET_VALUE(OIDCProvider_, oIDCProvider) };
    inline GetOIDCProviderResponseBody& setOIDCProvider(GetOIDCProviderResponseBody::OIDCProvider && oIDCProvider) { DARABONBA_PTR_SET_RVALUE(OIDCProvider_, oIDCProvider) };
  ...
  protected:
    ...
    shared_ptr<GetOIDCProviderResponseBody::OIDCProvider> OIDCProvider_ {};
    // The request ID.
