...
namespace Models
{
  ...
  public:
    ...
    inline const GetVerificationInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVerificationInfoResponseBody) };
    inline GetVerificationInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVerificationInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVerificationInfoResponseBody> body_ {};
  };
