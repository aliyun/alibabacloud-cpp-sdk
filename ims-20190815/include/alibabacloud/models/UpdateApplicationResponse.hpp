...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateApplicationResponseBody) };
    inline UpdateApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateApplicationResponseBody> body_ {};
  };
