...
namespace Models
{
  ...
  public:
    ...
    inline UpdateApplicationResponseBodyApplication& setAccessTokenValidity(int32_t accessTokenValidity) { DARABONBA_PTR_SET_VALUE(accessTokenValidity_, accessTokenValidity) };
    ...
    inline UpdateApplicationResponseBodyApplication& setAccountId(string accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline UpdateApplicationResponseBodyApplication& setAppId(string appId) { DARABONBA_PTR_SET_VALUE(appId_, appId) };
    ...
    inline UpdateApplicationResponseBodyApplication& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline UpdateApplicationResponseBodyApplication& setAppType(string appType) { DARABONBA_PTR_SET_VALUE(appType_, appType) };
    ...
    inline UpdateApplicationResponseBodyApplication& setCreateDate(string createDate) { DARABONBA_PTR_SET_VALUE(createDate_, createDate) };
    ...
    inline const Models::UpdateApplicationResponseBodyApplicationDelegatedScope & delegatedScope() const { DARABONBA_PTR_GET_CONST(delegatedScope_, Models::UpdateApplicationResponseBodyApplicationDelegatedScope) };
    inline Models::UpdateApplicationResponseBodyApplicationDelegatedScope delegatedScope() { DARABONBA_PTR_GET(delegatedScope_, Models::UpdateApplicationResponseBodyApplicationDelegatedScope) };
    inline UpdateApplicationResponseBodyApplication& setDelegatedScope(const Models::UpdateApplicationResponseBodyApplicationDelegatedScope & delegatedScope) { DARABONBA_PTR_SET_VALUE(delegatedScope_, delegatedScope) };
    inline UpdateApplicationResponseBodyApplication& setDelegatedScope(Models::UpdateApplicationResponseBodyApplicationDelegatedScope && delegatedScope) { DARABONBA_PTR_SET_RVALUE(delegatedScope_, delegatedScope) };
    ...
    inline UpdateApplicationResponseBodyApplication& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline UpdateApplicationResponseBodyApplication& setIsMultiTenant(bool isMultiTenant) { DARABONBA_PTR_SET_VALUE(isMultiTenant_, isMultiTenant) };
    ...
    inline UpdateApplicationResponseBodyApplication& setProtocolVersion(string protocolVersion) { DARABONBA_PTR_SET_VALUE(protocolVersion_, protocolVersion) };
    ...
    inline const Models::UpdateApplicationResponseBodyApplicationRedirectUris & redirectUris() const { DARABONBA_PTR_GET_CONST(redirectUris_, Models::UpdateApplicationResponseBodyApplicationRedirectUris) };
    inline Models::UpdateApplicationResponseBodyApplicationRedirectUris redirectUris() { DARABONBA_PTR_GET(redirectUris_, Models::UpdateApplicationResponseBodyApplicationRedirectUris) };
    inline UpdateApplicationResponseBodyApplication& setRedirectUris(const Models::UpdateApplicationResponseBodyApplicationRedirectUris & redirectUris) { DARABONBA_PTR_SET_VALUE(redirectUris_, redirectUris) };
    inline UpdateApplicationResponseBodyApplication& setRedirectUris(Models::UpdateApplicationResponseBodyApplicationRedirectUris && redirectUris) { DARABONBA_PTR_SET_RVALUE(redirectUris_, redirectUris) };
    ...
    inline UpdateApplicationResponseBodyApplication& setRefreshTokenValidity(int32_t refreshTokenValidity) { DARABONBA_PTR_SET_VALUE(refreshTokenValidity_, refreshTokenValidity) };
    ...
    inline UpdateApplicationResponseBodyApplication& setSecretRequired(bool secretRequired) { DARABONBA_PTR_SET_VALUE(secretRequired_, secretRequired) };
    ...
    inline UpdateApplicationResponseBodyApplication& setUpdateDate(string updateDate) { DARABONBA_PTR_SET_VALUE(updateDate_, updateDate) };
  ...
  protected:
    ...
    std::shared_ptr<Models::UpdateApplicationResponseBodyApplicationDelegatedScope> delegatedScope_ = nullptr;
    ...
    // The callback URLs.
    std::shared_ptr<Models::UpdateApplicationResponseBodyApplicationRedirectUris> redirectUris_ = nullptr;
