...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserBasicInfosResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserBasicInfosResponseBody) };
    inline ListUserBasicInfosResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserBasicInfosResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserBasicInfosResponseBody> body_ {};
  };
