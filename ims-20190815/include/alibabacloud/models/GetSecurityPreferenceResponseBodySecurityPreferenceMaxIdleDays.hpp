...
#ifndef ALIBABACLOUD_MODELS_GETSECURITYPREFERENCERESPONSEBODYSECURITYPREFERENCEMAXIDLEDAYS_HPP_
#define ALIBABACLOUD_MODELS_GETSECURITYPREFERENCERESPONSEBODYSECURITYPREFERENCEMAXIDLEDAYS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays& obj) { 
    ...
    GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays() = default ;
    GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays(const GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays &) = default ;
    GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays(GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays &&) = default ;
    GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays() = default ;
    GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays& operator=(const GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays &) = default ;
    GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays& operator=(GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays &&) = default ;
    ...
    inline GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays& setMaxIdleDaysForAccessKeys(int32_t maxIdleDaysForAccessKeys) { DARABONBA_PTR_SET_VALUE(maxIdleDaysForAccessKeys_, maxIdleDaysForAccessKeys) };
    ...
    inline GetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays& setMaxIdleDaysForUsers(int32_t maxIdleDaysForUsers) { DARABONBA_PTR_SET_VALUE(maxIdleDaysForUsers_, maxIdleDaysForUsers) };
