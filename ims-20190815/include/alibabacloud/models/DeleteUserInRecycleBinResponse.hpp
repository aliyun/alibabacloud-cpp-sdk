...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteUserInRecycleBinResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteUserInRecycleBinResponseBody) };
    inline DeleteUserInRecycleBinResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteUserInRecycleBinResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteUserInRecycleBinResponseBody> body_ {};
  };
