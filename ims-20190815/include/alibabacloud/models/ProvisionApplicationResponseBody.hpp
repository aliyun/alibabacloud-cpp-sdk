...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline ApplicationProvisionInfo& setAppPrincipalName(string appPrincipalName) { DARABONBA_PTR_SET_VALUE(appPrincipalName_, appPrincipalName) };
      ...
      inline ApplicationProvisionInfo& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
    ...
    inline const ProvisionApplicationResponseBody::ApplicationProvisionInfo & getApplicationProvisionInfo() const { DARABONBA_PTR_GET_CONST(applicationProvisionInfo_, ProvisionApplicationResponseBody::ApplicationProvisionInfo) };
    inline ProvisionApplicationResponseBody::ApplicationProvisionInfo getApplicationProvisionInfo() { DARABONBA_PTR_GET(applicationProvisionInfo_, ProvisionApplicationResponseBody::ApplicationProvisionInfo) };
    inline ProvisionApplicationResponseBody& setApplicationProvisionInfo(const ProvisionApplicationResponseBody::ApplicationProvisionInfo & applicationProvisionInfo) { DARABONBA_PTR_SET_VALUE(applicationProvisionInfo_, applicationProvisionInfo) };
    inline ProvisionApplicationResponseBody& setApplicationProvisionInfo(ProvisionApplicationResponseBody::ApplicationProvisionInfo && applicationProvisionInfo) { DARABONBA_PTR_SET_RVALUE(applicationProvisionInfo_, applicationProvisionInfo) };
