...
namespace Models
{
  ...
  public:
    ...
    inline const ListOIDCProvidersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOIDCProvidersResponseBody) };
    inline ListOIDCProvidersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOIDCProvidersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOIDCProvidersResponseBody> body_ {};
  };
