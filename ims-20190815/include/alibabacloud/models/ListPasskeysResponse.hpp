...
namespace Models
{
  ...
  public:
    ...
    inline const ListPasskeysResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListPasskeysResponseBody) };
    inline ListPasskeysResponseBody body() { DARABONBA_PTR_GET(body_, ListPasskeysResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListPasskeysResponseBody> body_ = nullptr;
  };
