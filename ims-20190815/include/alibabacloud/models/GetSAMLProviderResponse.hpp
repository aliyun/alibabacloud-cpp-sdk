...
namespace Models
{
  ...
  public:
    ...
    inline const GetSAMLProviderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSAMLProviderResponseBody) };
    inline GetSAMLProviderResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSAMLProviderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSAMLProviderResponseBody> body_ {};
  };
