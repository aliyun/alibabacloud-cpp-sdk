...
#ifndef ALIBABACLOUD_MODELS_SETPASSWORDPOLICYRESPONSEBODYPASSWORDPOLICY_HPP_
#define ALIBABACLOUD_MODELS_SETPASSWORDPOLICYRESPONSEBODYPASSWORDPOLICY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SetPasswordPolicyResponseBodyPasswordPolicy& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SetPasswordPolicyResponseBodyPasswordPolicy& obj) { 
    ...
    SetPasswordPolicyResponseBodyPasswordPolicy() = default ;
    SetPasswordPolicyResponseBodyPasswordPolicy(const SetPasswordPolicyResponseBodyPasswordPolicy &) = default ;
    SetPasswordPolicyResponseBodyPasswordPolicy(SetPasswordPolicyResponseBodyPasswordPolicy &&) = default ;
    SetPasswordPolicyResponseBodyPasswordPolicy(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SetPasswordPolicyResponseBodyPasswordPolicy() = default ;
    SetPasswordPolicyResponseBodyPasswordPolicy& operator=(const SetPasswordPolicyResponseBodyPasswordPolicy &) = default ;
    SetPasswordPolicyResponseBodyPasswordPolicy& operator=(SetPasswordPolicyResponseBodyPasswordPolicy &&) = default ;
    ...
    inline SetPasswordPolicyResponseBodyPasswordPolicy& setHardExpire(bool hardExpire) { DARABONBA_PTR_SET_VALUE(hardExpire_, hardExpire) };
    ...
    inline SetPasswordPolicyResponseBodyPasswordPolicy& setMaxLoginAttemps(int32_t maxLoginAttemps) { DARABONBA_PTR_SET_VALUE(maxLoginAttemps_, maxLoginAttemps) };
    ...
    inline SetPasswordPolicyResponseBodyPasswordPolicy& setMaxPasswordAge(int32_t maxPasswordAge) { DARABONBA_PTR_SET_VALUE(maxPasswordAge_, maxPasswordAge) };
    ...
    inline SetPasswordPolicyResponseBodyPasswordPolicy& setMinimumPasswordDifferentCharacter(int32_t minimumPasswordDifferentCharacter) { DARABONBA_PTR_SET_VALUE(minimumPasswordDifferentCharacter_, minimumPasswordDifferentCharacter) };
    ...
    inline SetPasswordPolicyResponseBodyPasswordPolicy& setMinimumPasswordLength(int32_t minimumPasswordLength) { DARABONBA_PTR_SET_VALUE(minimumPasswordLength_, minimumPasswordLength) };
    ...
    inline SetPasswordPolicyResponseBodyPasswordPolicy& setPasswordNotContainUserName(bool passwordNotContainUserName) { DARABONBA_PTR_SET_VALUE(passwordNotContainUserName_, passwordNotContainUserName) };
    ...
    inline SetPasswordPolicyResponseBodyPasswordPolicy& setPasswordReusePrevention(int32_t passwordReusePrevention) { DARABONBA_PTR_SET_VALUE(passwordReusePrevention_, passwordReusePrevention) };
    ...
    inline SetPasswordPolicyResponseBodyPasswordPolicy& setRequireLowercaseCharacters(bool requireLowercaseCharacters) { DARABONBA_PTR_SET_VALUE(requireLowercaseCharacters_, requireLowercaseCharacters) };
    ...
    inline SetPasswordPolicyResponseBodyPasswordPolicy& setRequireNumbers(bool requireNumbers) { DARABONBA_PTR_SET_VALUE(requireNumbers_, requireNumbers) };
    ...
    inline SetPasswordPolicyResponseBodyPasswordPolicy& setRequireSymbols(bool requireSymbols) { DARABONBA_PTR_SET_VALUE(requireSymbols_, requireSymbols) };
    ...
    inline SetPasswordPolicyResponseBodyPasswordPolicy& setRequireUppercaseCharacters(bool requireUppercaseCharacters) { DARABONBA_PTR_SET_VALUE(requireUppercaseCharacters_, requireUppercaseCharacters) };
