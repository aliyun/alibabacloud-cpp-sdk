...
namespace Models
{
  ...
  public:
    ...
    inline const GetExternalApplicationResponseBody::ExternalApplication & getExternalApplication() const { DARABONBA_PTR_GET_CONST(externalApplication_, GetExternalApplicationResponseBody::ExternalApplication) };
    inline GetExternalApplicationResponseBody::ExternalApplication getExternalApplication() { DARABONBA_PTR_GET(externalApplication_, GetExternalApplicationResponseBody::ExternalApplication) };
    inline GetExternalApplicationResponseBody& setExternalApplication(const GetExternalApplicationResponseBody::ExternalApplication & externalApplication) { DARABONBA_PTR_SET_VALUE(externalApplication_, externalApplication) };
    inline GetExternalApplicationResponseBody& setExternalApplication(GetExternalApplicationResponseBody::ExternalApplication && externalApplication) { DARABONBA_PTR_SET_RVALUE(externalApplication_, externalApplication) };
  ...
  protected:
    ...
    shared_ptr<GetExternalApplicationResponseBody::ExternalApplication> externalApplication_ {};
    // The request ID.
