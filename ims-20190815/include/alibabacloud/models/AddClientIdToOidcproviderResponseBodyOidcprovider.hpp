...
#ifndef ALIBABACLOUD_MODELS_ADDCLIENTIDTOOIDCPROVIDERRESPONSEBODYOIDCPROVIDER_HPP_
#define ALIBABACLOUD_MODELS_ADDCLIENTIDTOOIDCPROVIDERRESPONSEBODYOIDCPROVIDER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddClientIdToOIDCProviderResponseBodyOIDCProvider& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddClientIdToOIDCProviderResponseBodyOIDCProvider& obj) { 
    ...
    AddClientIdToOIDCProviderResponseBodyOIDCProvider() = default ;
    AddClientIdToOIDCProviderResponseBodyOIDCProvider(const AddClientIdToOIDCProviderResponseBodyOIDCProvider &) = default ;
    AddClientIdToOIDCProviderResponseBodyOIDCProvider(AddClientIdToOIDCProviderResponseBodyOIDCProvider &&) = default ;
    AddClientIdToOIDCProviderResponseBodyOIDCProvider(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddClientIdToOIDCProviderResponseBodyOIDCProvider() = default ;
    AddClientIdToOIDCProviderResponseBodyOIDCProvider& operator=(const AddClientIdToOIDCProviderResponseBodyOIDCProvider &) = default ;
    AddClientIdToOIDCProviderResponseBodyOIDCProvider& operator=(AddClientIdToOIDCProviderResponseBodyOIDCProvider &&) = default ;
    ...
    inline AddClientIdToOIDCProviderResponseBodyOIDCProvider& setArn(string arn) { DARABONBA_PTR_SET_VALUE(arn_, arn) };
    ...
    inline AddClientIdToOIDCProviderResponseBodyOIDCProvider& setClientIds(string clientIds) { DARABONBA_PTR_SET_VALUE(clientIds_, clientIds) };
    ...
    inline AddClientIdToOIDCProviderResponseBodyOIDCProvider& setCreateDate(string createDate) { DARABONBA_PTR_SET_VALUE(createDate_, createDate) };
    ...
    inline AddClientIdToOIDCProviderResponseBodyOIDCProvider& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline AddClientIdToOIDCProviderResponseBodyOIDCProvider& setFingerprints(string fingerprints) { DARABONBA_PTR_SET_VALUE(fingerprints_, fingerprints) };
    ...
    inline AddClientIdToOIDCProviderResponseBodyOIDCProvider& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline AddClientIdToOIDCProviderResponseBodyOIDCProvider& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline AddClientIdToOIDCProviderResponseBodyOIDCProvider& setIssuanceLimitTime(int64_t issuanceLimitTime) { DARABONBA_PTR_SET_VALUE(issuanceLimitTime_, issuanceLimitTime) };
    ...
    inline AddClientIdToOIDCProviderResponseBodyOIDCProvider& setIssuerUrl(string issuerUrl) { DARABONBA_PTR_SET_VALUE(issuerUrl_, issuerUrl) };
    ...
    inline AddClientIdToOIDCProviderResponseBodyOIDCProvider& setOIDCProviderName(string OIDCProviderName) { DARABONBA_PTR_SET_VALUE(OIDCProviderName_, OIDCProviderName) };
    ...
    inline AddClientIdToOIDCProviderResponseBodyOIDCProvider& setUpdateDate(string updateDate) { DARABONBA_PTR_SET_VALUE(updateDate_, updateDate) };
