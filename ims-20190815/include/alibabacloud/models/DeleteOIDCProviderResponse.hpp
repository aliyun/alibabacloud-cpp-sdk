...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteOIDCProviderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteOIDCProviderResponseBody) };
    inline DeleteOIDCProviderResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteOIDCProviderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteOIDCProviderResponseBody> body_ {};
  };
