...
namespace Models
{
  ...
  public:
    ...
    inline const ListPredefinedScopesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListPredefinedScopesResponseBody) };
    inline ListPredefinedScopesResponseBody body() { DARABONBA_PTR_GET(body_, ListPredefinedScopesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListPredefinedScopesResponseBody> body_ = nullptr;
  };
