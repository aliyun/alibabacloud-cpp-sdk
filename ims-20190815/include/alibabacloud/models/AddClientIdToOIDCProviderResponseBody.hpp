...
namespace Models
{
  ...
  public:
    ...
    inline const AddClientIdToOIDCProviderResponseBody::OIDCProvider & getOIDCProvider() const { DARABONBA_PTR_GET_CONST(OIDCProvider_, AddClientIdToOIDCProviderResponseBody::OIDCProvider) };
    inline AddClientIdToOIDCProviderResponseBody::OIDCProvider getOIDCProvider() { DARABONBA_PTR_GET(OIDCProvider_, AddClientIdToOIDCProviderResponseBody::OIDCProvider) };
    inline AddClientIdToOIDCProviderResponseBody& setOIDCProvider(const AddClientIdToOIDCProviderResponseBody::OIDCProvider & oIDCProvider) { DARABONBA_PTR_SET_VALUE(OIDCProvider_, oIDCProvider) };
    inline AddClientIdToOIDCProviderResponseBody& setOIDCProvider(AddClientIdToOIDCProviderResponseBody::OIDCProvider && oIDCProvider) { DARABONBA_PTR_SET_RVALUE(OIDCProvider_, oIDCProvider) };
  ...
  protected:
    ...
    shared_ptr<AddClientIdToOIDCProviderResponseBody::OIDCProvider> OIDCProvider_ {};
    // The request ID.
