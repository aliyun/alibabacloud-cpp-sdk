...
namespace Models
{
  ...
  public:
    ...
    inline const ListApplicationsResponseBodyApplications & applications() const { DARABONBA_PTR_GET_CONST(applications_, ListApplicationsResponseBodyApplications) };
    inline ListApplicationsResponseBodyApplications applications() { DARABONBA_PTR_GET(applications_, ListApplicationsResponseBodyApplications) };
    inline ListApplicationsResponseBody& setApplications(const ListApplicationsResponseBodyApplications & applications) { DARABONBA_PTR_SET_VALUE(applications_, applications) };
    inline ListApplicationsResponseBody& setApplications(ListApplicationsResponseBodyApplications && applications) { DARABONBA_PTR_SET_RVALUE(applications_, applications) };
  ...
  protected:
    ...
    std::shared_ptr<ListApplicationsResponseBodyApplications> applications_ = nullptr;
