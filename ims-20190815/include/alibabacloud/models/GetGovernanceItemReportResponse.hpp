...
namespace Models
{
  ...
  public:
    ...
    inline const GetGovernanceItemReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetGovernanceItemReportResponseBody) };
    inline GetGovernanceItemReportResponseBody getBody() { DARABONBA_PTR_GET(body_, GetGovernanceItemReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetGovernanceItemReportResponseBody> body_ {};
  };
