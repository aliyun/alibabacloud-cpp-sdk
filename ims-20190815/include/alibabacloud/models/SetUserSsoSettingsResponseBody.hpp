...
namespace Models
{
  ...
  public:
    ...
    inline const SetUserSsoSettingsResponseBody::UserSsoSettings & getUserSsoSettings() const { DARABONBA_PTR_GET_CONST(userSsoSettings_, SetUserSsoSettingsResponseBody::UserSsoSettings) };
    inline SetUserSsoSettingsResponseBody::UserSsoSettings getUserSsoSettings() { DARABONBA_PTR_GET(userSsoSettings_, SetUserSsoSettingsResponseBody::UserSsoSettings) };
    inline SetUserSsoSettingsResponseBody& setUserSsoSettings(const SetUserSsoSettingsResponseBody::UserSsoSettings & userSsoSettings) { DARABONBA_PTR_SET_VALUE(userSsoSettings_, userSsoSettings) };
    inline SetUserSsoSettingsResponseBody& setUserSsoSettings(SetUserSsoSettingsResponseBody::UserSsoSettings && userSsoSettings) { DARABONBA_PTR_SET_RVALUE(userSsoSettings_, userSsoSettings) };
