...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccessKeyInfoInRecycleBinResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAccessKeyInfoInRecycleBinResponseBody) };
    inline GetAccessKeyInfoInRecycleBinResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAccessKeyInfoInRecycleBinResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAccessKeyInfoInRecycleBinResponseBody> body_ {};
  };
