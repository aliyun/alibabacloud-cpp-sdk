...
namespace Models
{
  ...
  public:
    ...
    inline const SetPasswordPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetPasswordPolicyResponseBody) };
    inline SetPasswordPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, SetPasswordPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetPasswordPolicyResponseBody> body_ {};
  };
