...
namespace Models
{
  ...
  public:
    ...
    inline const GetAppSecretResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAppSecretResponseBody) };
    inline GetAppSecretResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAppSecretResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAppSecretResponseBody> body_ {};
  };
