...
namespace Models
{
  ...
  public:
    ...
    inline string getGeneratedTime() const { DARABONBA_PTR_GET_DEFAULT(generatedTime_, "") };
    ...
    inline string getIsTruncated() const { DARABONBA_PTR_GET_DEFAULT(isTruncated_, "") };
