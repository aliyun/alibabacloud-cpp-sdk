...
namespace Models
{
  ...
  public:
    ...
    inline const AddClientIdToOIDCProviderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddClientIdToOIDCProviderResponseBody) };
    inline AddClientIdToOIDCProviderResponseBody getBody() { DARABONBA_PTR_GET(body_, AddClientIdToOIDCProviderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddClientIdToOIDCProviderResponseBody> body_ {};
  };
