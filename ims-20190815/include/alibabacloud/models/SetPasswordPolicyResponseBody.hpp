...
namespace Models
{
  ...
  public:
    ...
    inline const SetPasswordPolicyResponseBodyPasswordPolicy & passwordPolicy() const { DARABONBA_PTR_GET_CONST(passwordPolicy_, SetPasswordPolicyResponseBodyPasswordPolicy) };
    inline SetPasswordPolicyResponseBodyPasswordPolicy passwordPolicy() { DARABONBA_PTR_GET(passwordPolicy_, SetPasswordPolicyResponseBodyPasswordPolicy) };
    inline SetPasswordPolicyResponseBody& setPasswordPolicy(const SetPasswordPolicyResponseBodyPasswordPolicy & passwordPolicy) { DARABONBA_PTR_SET_VALUE(passwordPolicy_, passwordPolicy) };
    inline SetPasswordPolicyResponseBody& setPasswordPolicy(SetPasswordPolicyResponseBodyPasswordPolicy && passwordPolicy) { DARABONBA_PTR_SET_RVALUE(passwordPolicy_, passwordPolicy) };
  ...
  protected:
    ...
    std::shared_ptr<SetPasswordPolicyResponseBodyPasswordPolicy> passwordPolicy_ = nullptr;
    // The request ID.
