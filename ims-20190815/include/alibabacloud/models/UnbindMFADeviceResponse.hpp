...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindMFADeviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnbindMFADeviceResponseBody) };
    inline UnbindMFADeviceResponseBody getBody() { DARABONBA_PTR_GET(body_, UnbindMFADeviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnbindMFADeviceResponseBody> body_ {};
  };
