...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePasskeyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeletePasskeyResponseBody) };
    inline DeletePasskeyResponseBody body() { DARABONBA_PTR_GET(body_, DeletePasskeyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeletePasskeyResponseBody> body_ = nullptr;
  };
