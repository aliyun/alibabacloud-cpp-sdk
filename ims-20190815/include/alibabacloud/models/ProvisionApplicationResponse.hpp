...
namespace Models
{
  ...
  public:
    ...
    inline const ProvisionApplicationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ProvisionApplicationResponseBody) };
    inline ProvisionApplicationResponseBody getBody() { DARABONBA_PTR_GET(body_, ProvisionApplicationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ProvisionApplicationResponseBody> body_ {};
  };
