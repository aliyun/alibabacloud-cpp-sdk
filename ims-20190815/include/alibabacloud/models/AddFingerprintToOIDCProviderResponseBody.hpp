...
namespace Models
{
  ...
  public:
    ...
    inline const AddFingerprintToOIDCProviderResponseBody::OIDCProvider & getOIDCProvider() const { DARABONBA_PTR_GET_CONST(OIDCProvider_, AddFingerprintToOIDCProviderResponseBody::OIDCProvider) };
    inline AddFingerprintToOIDCProviderResponseBody::OIDCProvider getOIDCProvider() { DARABONBA_PTR_GET(OIDCProvider_, AddFingerprintToOIDCProviderResponseBody::OIDCProvider) };
    inline AddFingerprintToOIDCProviderResponseBody& setOIDCProvider(const AddFingerprintToOIDCProviderResponseBody::OIDCProvider & oIDCProvider) { DARABONBA_PTR_SET_VALUE(OIDCProvider_, oIDCProvider) };
    inline AddFingerprintToOIDCProviderResponseBody& setOIDCProvider(AddFingerprintToOIDCProviderResponseBody::OIDCProvider && oIDCProvider) { DARABONBA_PTR_SET_RVALUE(OIDCProvider_, oIDCProvider) };
