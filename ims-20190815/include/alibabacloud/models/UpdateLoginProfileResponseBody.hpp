  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->autoDisableLoginStatus_ == nullptr
        && this->MFABindRequired_ == nullptr && this->passwordResetRequired_ == nullptr && this->passwordStatus_ == nullptr && this->status_ == nullptr && this->updateDate_ == nullptr
    ...
    inline const UpdateLoginProfileResponseBody::LoginProfile & getLoginProfile() const { DARABONBA_PTR_GET_CONST(loginProfile_, UpdateLoginProfileResponseBody::LoginProfile) };
    inline UpdateLoginProfileResponseBody::LoginProfile getLoginProfile() { DARABONBA_PTR_GET(loginProfile_, UpdateLoginProfileResponseBody::LoginProfile) };
    inline UpdateLoginProfileResponseBody& setLoginProfile(const UpdateLoginProfileResponseBody::LoginProfile & loginProfile) { DARABONBA_PTR_SET_VALUE(loginProfile_, loginProfile) };
    inline UpdateLoginProfileResponseBody& setLoginProfile(UpdateLoginProfileResponseBody::LoginProfile && loginProfile) { DARABONBA_PTR_SET_RVALUE(loginProfile_, loginProfile) };
