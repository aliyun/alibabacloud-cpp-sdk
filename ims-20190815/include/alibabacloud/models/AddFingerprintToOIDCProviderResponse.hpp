...
namespace Models
{
  ...
  public:
    ...
    inline const AddFingerprintToOIDCProviderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddFingerprintToOIDCProviderResponseBody) };
    inline AddFingerprintToOIDCProviderResponseBody getBody() { DARABONBA_PTR_GET(body_, AddFingerprintToOIDCProviderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddFingerprintToOIDCProviderResponseBody> body_ {};
  };
