...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateOIDCProviderResponseBody::OIDCProvider & getOIDCProvider() const { DARABONBA_PTR_GET_CONST(OIDCProvider_, UpdateOIDCProviderResponseBody::OIDCProvider) };
    inline UpdateOIDCProviderResponseBody::OIDCProvider getOIDCProvider() { DARABONBA_PTR_GET(OIDCProvider_, UpdateOIDCProviderResponseBody::OIDCProvider) };
    inline UpdateOIDCProviderResponseBody& setOIDCProvider(const UpdateOIDCProviderResponseBody::OIDCProvider & oIDCProvider) { DARABONBA_PTR_SET_VALUE(OIDCProvider_, oIDCProvider) };
    inline UpdateOIDCProviderResponseBody& setOIDCProvider(UpdateOIDCProviderResponseBody::OIDCProvider && oIDCProvider) { DARABONBA_PTR_SET_RVALUE(OIDCProvider_, oIDCProvider) };
  ...
  protected:
    ...
    shared_ptr<UpdateOIDCProviderResponseBody::OIDCProvider> OIDCProvider_ {};
    // The request ID.
