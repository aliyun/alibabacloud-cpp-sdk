...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveFingerprintFromOIDCProviderResponseBody::OIDCProvider & getOIDCProvider() const { DARABONBA_PTR_GET_CONST(OIDCProvider_, RemoveFingerprintFromOIDCProviderResponseBody::OIDCProvider) };
    inline RemoveFingerprintFromOIDCProviderResponseBody::OIDCProvider getOIDCProvider() { DARABONBA_PTR_GET(OIDCProvider_, RemoveFingerprintFromOIDCProviderResponseBody::OIDCProvider) };
    inline RemoveFingerprintFromOIDCProviderResponseBody& setOIDCProvider(const RemoveFingerprintFromOIDCProviderResponseBody::OIDCProvider & oIDCProvider) { DARABONBA_PTR_SET_VALUE(OIDCProvider_, oIDCProvider) };
    inline RemoveFingerprintFromOIDCProviderResponseBody& setOIDCProvider(RemoveFingerprintFromOIDCProviderResponseBody::OIDCProvider && oIDCProvider) { DARABONBA_PTR_SET_RVALUE(OIDCProvider_, oIDCProvider) };
  ...
  protected:
    ...
    shared_ptr<RemoveFingerprintFromOIDCProviderResponseBody::OIDCProvider> OIDCProvider_ {};
    // The request ID.
