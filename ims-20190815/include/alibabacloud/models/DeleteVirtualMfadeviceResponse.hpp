...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVirtualMFADeviceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteVirtualMFADeviceResponseBody) };
    inline DeleteVirtualMFADeviceResponseBody body() { DARABONBA_PTR_GET(body_, DeleteVirtualMFADeviceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteVirtualMFADeviceResponseBody> body_ = nullptr;
  };
