...
#ifndef ALIBABACLOUD_MODELS_GETOIDCPROVIDERRESPONSEBODYOIDCPROVIDER_HPP_
#define ALIBABACLOUD_MODELS_GETOIDCPROVIDERRESPONSEBODYOIDCPROVIDER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetOIDCProviderResponseBodyOIDCProvider& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetOIDCProviderResponseBodyOIDCProvider& obj) { 
    ...
    GetOIDCProviderResponseBodyOIDCProvider() = default ;
    GetOIDCProviderResponseBodyOIDCProvider(const GetOIDCProviderResponseBodyOIDCProvider &) = default ;
    GetOIDCProviderResponseBodyOIDCProvider(GetOIDCProviderResponseBodyOIDCProvider &&) = default ;
    GetOIDCProviderResponseBodyOIDCProvider(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetOIDCProviderResponseBodyOIDCProvider() = default ;
    GetOIDCProviderResponseBodyOIDCProvider& operator=(const GetOIDCProviderResponseBodyOIDCProvider &) = default ;
    GetOIDCProviderResponseBodyOIDCProvider& operator=(GetOIDCProviderResponseBodyOIDCProvider &&) = default ;
    ...
    inline GetOIDCProviderResponseBodyOIDCProvider& setArn(string arn) { DARABONBA_PTR_SET_VALUE(arn_, arn) };
    ...
    inline GetOIDCProviderResponseBodyOIDCProvider& setClientIds(string clientIds) { DARABONBA_PTR_SET_VALUE(clientIds_, clientIds) };
    ...
    inline GetOIDCProviderResponseBodyOIDCProvider& setCreateDate(string createDate) { DARABONBA_PTR_SET_VALUE(createDate_, createDate) };
    ...
    inline GetOIDCProviderResponseBodyOIDCProvider& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline GetOIDCProviderResponseBodyOIDCProvider& setFingerprints(string fingerprints) { DARABONBA_PTR_SET_VALUE(fingerprints_, fingerprints) };
    ...
    inline GetOIDCProviderResponseBodyOIDCProvider& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline GetOIDCProviderResponseBodyOIDCProvider& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline GetOIDCProviderResponseBodyOIDCProvider& setIssuanceLimitTime(int64_t issuanceLimitTime) { DARABONBA_PTR_SET_VALUE(issuanceLimitTime_, issuanceLimitTime) };
    ...
    inline GetOIDCProviderResponseBodyOIDCProvider& setIssuerUrl(string issuerUrl) { DARABONBA_PTR_SET_VALUE(issuerUrl_, issuerUrl) };
    ...
    inline GetOIDCProviderResponseBodyOIDCProvider& setOIDCProviderName(string OIDCProviderName) { DARABONBA_PTR_SET_VALUE(OIDCProviderName_, OIDCProviderName) };
    ...
    inline GetOIDCProviderResponseBodyOIDCProvider& setUpdateDate(string updateDate) { DARABONBA_PTR_SET_VALUE(updateDate_, updateDate) };
