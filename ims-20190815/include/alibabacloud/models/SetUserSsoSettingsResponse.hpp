...
namespace Models
{
  ...
  public:
    ...
    inline const SetUserSsoSettingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetUserSsoSettingsResponseBody) };
    inline SetUserSsoSettingsResponseBody getBody() { DARABONBA_PTR_GET(body_, SetUserSsoSettingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetUserSsoSettingsResponseBody> body_ {};
  };
