...
#ifndef ALIBABACLOUD_MODELS_GETAPPSECRETRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETAPPSECRETRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAppSecretResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(AppSecret, appSecret_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, GetAppSecretResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(AppSecret, appSecret_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    GetAppSecretResponseBody() = default ;
    GetAppSecretResponseBody(const GetAppSecretResponseBody &) = default ;
    GetAppSecretResponseBody(GetAppSecretResponseBody &&) = default ;
    GetAppSecretResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAppSecretResponseBody() = default ;
    GetAppSecretResponseBody& operator=(const GetAppSecretResponseBody &) = default ;
    GetAppSecretResponseBody& operator=(GetAppSecretResponseBody &&) = default ;
    ...
    inline const GetAppSecretResponseBody::AppSecret & getAppSecret() const { DARABONBA_PTR_GET_CONST(appSecret_, GetAppSecretResponseBody::AppSecret) };
    inline GetAppSecretResponseBody::AppSecret getAppSecret() { DARABONBA_PTR_GET(appSecret_, GetAppSecretResponseBody::AppSecret) };
    inline GetAppSecretResponseBody& setAppSecret(const GetAppSecretResponseBody::AppSecret & appSecret) { DARABONBA_PTR_SET_VALUE(appSecret_, appSecret) };
    inline GetAppSecretResponseBody& setAppSecret(GetAppSecretResponseBody::AppSecret && appSecret) { DARABONBA_PTR_SET_RVALUE(appSecret_, appSecret) };
    ...
    inline GetAppSecretResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    // The details of the application secret.
    shared_ptr<GetAppSecretResponseBody::AppSecret> appSecret_ {};
    // The request ID.
