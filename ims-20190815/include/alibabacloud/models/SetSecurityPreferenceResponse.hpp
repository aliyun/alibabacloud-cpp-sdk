...
namespace Models
{
  ...
  public:
    ...
    inline const SetSecurityPreferenceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetSecurityPreferenceResponseBody) };
    inline SetSecurityPreferenceResponseBody body() { DARABONBA_PTR_GET(body_, SetSecurityPreferenceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetSecurityPreferenceResponseBody> body_ = nullptr;
  };
