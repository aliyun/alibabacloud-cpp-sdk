...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateGovernanceReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateGovernanceReportResponseBody) };
    inline GenerateGovernanceReportResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateGovernanceReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateGovernanceReportResponseBody> body_ {};
  };
