...
namespace Models
{
  ...
  public:
    ...
    inline CreateApplicationResponseBodyApplication& setAccessTokenValidity(int32_t accessTokenValidity) { DARABONBA_PTR_SET_VALUE(accessTokenValidity_, accessTokenValidity) };
    ...
    inline CreateApplicationResponseBodyApplication& setAccountId(string accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline CreateApplicationResponseBodyApplication& setAppId(string appId) { DARABONBA_PTR_SET_VALUE(appId_, appId) };
    ...
    inline CreateApplicationResponseBodyApplication& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline CreateApplicationResponseBodyApplication& setAppType(string appType) { DARABONBA_PTR_SET_VALUE(appType_, appType) };
    ...
    inline const Models::CreateApplicationResponseBodyApplicationDelegatedScope & delegatedScope() const { DARABONBA_PTR_GET_CONST(delegatedScope_, Models::CreateApplicationResponseBodyApplicationDelegatedScope) };
    inline Models::CreateApplicationResponseBodyApplicationDelegatedScope delegatedScope() { DARABONBA_PTR_GET(delegatedScope_, Models::CreateApplicationResponseBodyApplicationDelegatedScope) };
    inline CreateApplicationResponseBodyApplication& setDelegatedScope(const Models::CreateApplicationResponseBodyApplicationDelegatedScope & delegatedScope) { DARABONBA_PTR_SET_VALUE(delegatedScope_, delegatedScope) };
    inline CreateApplicationResponseBodyApplication& setDelegatedScope(Models::CreateApplicationResponseBodyApplicationDelegatedScope && delegatedScope) { DARABONBA_PTR_SET_RVALUE(delegatedScope_, delegatedScope) };
    ...
    inline CreateApplicationResponseBodyApplication& setDisplayName(string displayName) { DARABONBA_PTR_SET_VALUE(displayName_, displayName) };
    ...
    inline CreateApplicationResponseBodyApplication& setIsMultiTenant(bool isMultiTenant) { DARABONBA_PTR_SET_VALUE(isMultiTenant_, isMultiTenant) };
    ...
    inline CreateApplicationResponseBodyApplication& setProtocolVersion(string protocolVersion) { DARABONBA_PTR_SET_VALUE(protocolVersion_, protocolVersion) };
    ...
    inline const Models::CreateApplicationResponseBodyApplicationRedirectUris & redirectUris() const { DARABONBA_PTR_GET_CONST(redirectUris_, Models::CreateApplicationResponseBodyApplicationRedirectUris) };
    inline Models::CreateApplicationResponseBodyApplicationRedirectUris redirectUris() { DARABONBA_PTR_GET(redirectUris_, Models::CreateApplicationResponseBodyApplicationRedirectUris) };
    inline CreateApplicationResponseBodyApplication& setRedirectUris(const Models::CreateApplicationResponseBodyApplicationRedirectUris & redirectUris) { DARABONBA_PTR_SET_VALUE(redirectUris_, redirectUris) };
    inline CreateApplicationResponseBodyApplication& setRedirectUris(Models::CreateApplicationResponseBodyApplicationRedirectUris && redirectUris) { DARABONBA_PTR_SET_RVALUE(redirectUris_, redirectUris) };
    ...
    inline CreateApplicationResponseBodyApplication& setRefreshTokenValidity(int32_t refreshTokenValidity) { DARABONBA_PTR_SET_VALUE(refreshTokenValidity_, refreshTokenValidity) };
    ...
    inline CreateApplicationResponseBodyApplication& setSecretRequired(bool secretRequired) { DARABONBA_PTR_SET_VALUE(secretRequired_, secretRequired) };
  ...
  protected:
    ...
    std::shared_ptr<Models::CreateApplicationResponseBodyApplicationDelegatedScope> delegatedScope_ = nullptr;
    ...
    // The callback URLs.
    std::shared_ptr<Models::CreateApplicationResponseBodyApplicationRedirectUris> redirectUris_ = nullptr;
