...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveFingerprintFromOIDCProviderResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RemoveFingerprintFromOIDCProviderResponseBody) };
    inline RemoveFingerprintFromOIDCProviderResponseBody body() { DARABONBA_PTR_GET(body_, RemoveFingerprintFromOIDCProviderResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RemoveFingerprintFromOIDCProviderResponseBody> body_ = nullptr;
  };
