...
namespace Models
{
  ...
  public:
    ...
    inline const GetAccountSecurityPracticeReportResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAccountSecurityPracticeReportResponseBody) };
    inline GetAccountSecurityPracticeReportResponseBody body() { DARABONBA_PTR_GET(body_, GetAccountSecurityPracticeReportResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAccountSecurityPracticeReportResponseBody> body_ = nullptr;
  };
