...
namespace Models
{
  ...
  public:
    ...
    inline const SetVerificationInfoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetVerificationInfoResponseBody) };
    inline SetVerificationInfoResponseBody body() { DARABONBA_PTR_GET(body_, SetVerificationInfoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetVerificationInfoResponseBody> body_ = nullptr;
  };
