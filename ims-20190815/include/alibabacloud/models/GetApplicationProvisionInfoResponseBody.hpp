...
namespace Models
{
  ...
  public:
    ...
    inline const GetApplicationProvisionInfoResponseBody::ApplicationProvisionInfo & getApplicationProvisionInfo() const { DARABONBA_PTR_GET_CONST(applicationProvisionInfo_, GetApplicationProvisionInfoResponseBody::ApplicationProvisionInfo) };
    inline GetApplicationProvisionInfoResponseBody::ApplicationProvisionInfo getApplicationProvisionInfo() { DARABONBA_PTR_GET(applicationProvisionInfo_, GetApplicationProvisionInfoResponseBody::ApplicationProvisionInfo) };
    inline GetApplicationProvisionInfoResponseBody& setApplicationProvisionInfo(const GetApplicationProvisionInfoResponseBody::ApplicationProvisionInfo & applicationProvisionInfo) { DARABONBA_PTR_SET_VALUE(applicationProvisionInfo_, applicationProvisionInfo) };
    inline GetApplicationProvisionInfoResponseBody& setApplicationProvisionInfo(GetApplicationProvisionInfoResponseBody::ApplicationProvisionInfo && applicationProvisionInfo) { DARABONBA_PTR_SET_RVALUE(applicationProvisionInfo_, applicationProvisionInfo) };
