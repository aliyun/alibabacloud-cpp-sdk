...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSAMLProviderResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteSAMLProviderResponseBody) };
    inline DeleteSAMLProviderResponseBody body() { DARABONBA_PTR_GET(body_, DeleteSAMLProviderResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteSAMLProviderResponseBody> body_ = nullptr;
  };
