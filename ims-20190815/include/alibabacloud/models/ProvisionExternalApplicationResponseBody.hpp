...
namespace Models
{
  ...
  public:
    ...
    inline const ProvisionExternalApplicationResponseBody::ExternalApplication & getExternalApplication() const { DARABONBA_PTR_GET_CONST(externalApplication_, ProvisionExternalApplicationResponseBody::ExternalApplication) };
    inline ProvisionExternalApplicationResponseBody::ExternalApplication getExternalApplication() { DARABONBA_PTR_GET(externalApplication_, ProvisionExternalApplicationResponseBody::ExternalApplication) };
    inline ProvisionExternalApplicationResponseBody& setExternalApplication(const ProvisionExternalApplicationResponseBody::ExternalApplication & externalApplication) { DARABONBA_PTR_SET_VALUE(externalApplication_, externalApplication) };
    inline ProvisionExternalApplicationResponseBody& setExternalApplication(ProvisionExternalApplicationResponseBody::ExternalApplication && externalApplication) { DARABONBA_PTR_SET_RVALUE(externalApplication_, externalApplication) };
