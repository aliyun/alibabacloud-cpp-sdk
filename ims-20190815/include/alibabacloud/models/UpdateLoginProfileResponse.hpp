...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLoginProfileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLoginProfileResponseBody) };
    inline UpdateLoginProfileResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLoginProfileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLoginProfileResponseBody> body_ {};
  };
