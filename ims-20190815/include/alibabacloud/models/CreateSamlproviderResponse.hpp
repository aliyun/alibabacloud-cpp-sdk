...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSAMLProviderResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateSAMLProviderResponseBody) };
    inline CreateSAMLProviderResponseBody body() { DARABONBA_PTR_GET(body_, CreateSAMLProviderResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateSAMLProviderResponseBody> body_ = nullptr;
  };
