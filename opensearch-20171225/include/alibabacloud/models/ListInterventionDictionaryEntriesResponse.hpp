...
namespace Models
{
  ...
  public:
    ...
    inline const ListInterventionDictionaryEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInterventionDictionaryEntriesResponseBody) };
    inline ListInterventionDictionaryEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInterventionDictionaryEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInterventionDictionaryEntriesResponseBody> body_ {};
  };
