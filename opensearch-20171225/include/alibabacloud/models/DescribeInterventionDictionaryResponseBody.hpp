...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInterventionDictionaryResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, DescribeInterventionDictionaryResponseBody::Result) };
    inline DescribeInterventionDictionaryResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, DescribeInterventionDictionaryResponseBody::Result) };
    inline DescribeInterventionDictionaryResponseBody& setResult(const DescribeInterventionDictionaryResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeInterventionDictionaryResponseBody& setResult(DescribeInterventionDictionaryResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
