...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UntagResourcesResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(tequestId, tequestId_);
    };
    friend void from_json(const Darabonba::Json& j, UntagResourcesResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(tequestId, tequestId_);
    };
    ...
    virtual bool empty() const override { return this->tequestId_ == nullptr; };
