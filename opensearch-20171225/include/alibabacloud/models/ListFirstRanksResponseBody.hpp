...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListFirstRanksResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListFirstRanksResponseBodyResult>) };
    inline vector<ListFirstRanksResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListFirstRanksResponseBodyResult>) };
    inline ListFirstRanksResponseBody& setResult(const vector<ListFirstRanksResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListFirstRanksResponseBody& setResult(vector<ListFirstRanksResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListFirstRanksResponseBodyResult>> result_ = nullptr;
  };
