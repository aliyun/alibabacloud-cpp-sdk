...
namespace Models
{
  ...
  public:
    ...
    inline const ListInterventionDictionaryNerResultsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInterventionDictionaryNerResultsResponseBody) };
    inline ListInterventionDictionaryNerResultsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInterventionDictionaryNerResultsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInterventionDictionaryNerResultsResponseBody> body_ {};
  };
