...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEQUERYPROCESSORRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEQUERYPROCESSORRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeQueryProcessorResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
      DARABONBA_PTR_TO_JSON(result, result_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeQueryProcessorResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
      DARABONBA_PTR_FROM_JSON(result, result_);
    };
    DescribeQueryProcessorResponseBody() = default ;
    DescribeQueryProcessorResponseBody(const DescribeQueryProcessorResponseBody &) = default ;
    DescribeQueryProcessorResponseBody(DescribeQueryProcessorResponseBody &&) = default ;
    DescribeQueryProcessorResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeQueryProcessorResponseBody() = default ;
    DescribeQueryProcessorResponseBody& operator=(const DescribeQueryProcessorResponseBody &) = default ;
    DescribeQueryProcessorResponseBody& operator=(DescribeQueryProcessorResponseBody &&) = default ;
    ...
    inline DescribeQueryProcessorResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const DescribeQueryProcessorResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, DescribeQueryProcessorResponseBody::Result) };
    inline DescribeQueryProcessorResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, DescribeQueryProcessorResponseBody::Result) };
    inline DescribeQueryProcessorResponseBody& setResult(const DescribeQueryProcessorResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeQueryProcessorResponseBody& setResult(DescribeQueryProcessorResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<DescribeQueryProcessorResponseBody::Result> result_ {};
  };
