...
#ifndef ALIBABACLOUD_MODELS_LISTAPPGROUPSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAppGroupsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
      DARABONBA_PTR_TO_JSON(result, result_);
      DARABONBA_PTR_TO_JSON(totalCount, totalCount_);
    };
    friend void from_json(const Darabonba::Json& j, ListAppGroupsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
      DARABONBA_PTR_FROM_JSON(result, result_);
      DARABONBA_PTR_FROM_JSON(totalCount, totalCount_);
    };
    ListAppGroupsResponseBody() = default ;
    ListAppGroupsResponseBody(const ListAppGroupsResponseBody &) = default ;
    ListAppGroupsResponseBody(ListAppGroupsResponseBody &&) = default ;
    ListAppGroupsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAppGroupsResponseBody() = default ;
    ListAppGroupsResponseBody& operator=(const ListAppGroupsResponseBody &) = default ;
    ListAppGroupsResponseBody& operator=(ListAppGroupsResponseBody &&) = default ;
