...
namespace Models
{
  ...
  public:
    ...
    inline const GetSearchStrategyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSearchStrategyResponseBody) };
    inline GetSearchStrategyResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSearchStrategyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSearchStrategyResponseBody> body_ {};
  };
