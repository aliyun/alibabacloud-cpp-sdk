...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataSourceTableFieldsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataSourceTableFieldsResponseBody) };
    inline ListDataSourceTableFieldsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataSourceTableFieldsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataSourceTableFieldsResponseBody> body_ {};
  };
