  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->chargeType_ == nullptr
        ...
        && this->engineType_ == nullptr && this->expireOn_ == nullptr && this->hasPendingQuotaReviewTask_ == nullptr && this->id_ == nullptr && this->instanceId_ == nullptr
        && this->lockMode_ == nullptr && this->name_ == nullptr && this->produced_ == nullptr && this->projectId_ == nullptr && this->quota_ == nullptr
        && this->resourceGroupId_ == nullptr && this->status_ == nullptr && this->switchedTime_ == nullptr && this->type_ == nullptr && this->updated_ == nullptr; };
    ...
    inline const ModifyAppGroupQuotaResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, ModifyAppGroupQuotaResponseBody::Result) };
    inline ModifyAppGroupQuotaResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, ModifyAppGroupQuotaResponseBody::Result) };
    inline ModifyAppGroupQuotaResponseBody& setResult(const ModifyAppGroupQuotaResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ModifyAppGroupQuotaResponseBody& setResult(ModifyAppGroupQuotaResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
