...
namespace Models
{
  ...
  public:
    ...
    inline const DisableSlowQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableSlowQueryResponseBody) };
    inline DisableSlowQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableSlowQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableSlowQueryResponseBody> body_ {};
  };
