...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->analyzer_ == nullptr
        && this->analyzerType_ == nullptr && this->analyzerGeneration_ == nullptr && this->fields_ == nullptr && this->label_ == nullptr; };
    ...
    inline string getAnalyzerGeneration() const { DARABONBA_PTR_GET_DEFAULT(analyzerGeneration_, "") };
  ...
  protected:
    ...
    shared_ptr<string> analyzerGeneration_ {};
