...
namespace Models
{
  ...
  public:
    ...
    inline const ReplaceAppGroupCommodityCodeResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ReplaceAppGroupCommodityCodeResponseBodyResult) };
    inline ReplaceAppGroupCommodityCodeResponseBodyResult result() { DARABONBA_PTR_GET(result_, ReplaceAppGroupCommodityCodeResponseBodyResult) };
    inline ReplaceAppGroupCommodityCodeResponseBody& setResult(const ReplaceAppGroupCommodityCodeResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ReplaceAppGroupCommodityCodeResponseBody& setResult(ReplaceAppGroupCommodityCodeResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<ReplaceAppGroupCommodityCodeResponseBodyResult> result_ = nullptr;
  };
