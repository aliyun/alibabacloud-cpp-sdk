...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetScriptFileNamesResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<GetScriptFileNamesResponseBodyResult>) };
    inline vector<GetScriptFileNamesResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<GetScriptFileNamesResponseBodyResult>) };
    inline GetScriptFileNamesResponseBody& setResult(const vector<GetScriptFileNamesResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetScriptFileNamesResponseBody& setResult(vector<GetScriptFileNamesResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetScriptFileNamesResponseBodyResult>> result_ = nullptr;
  };
