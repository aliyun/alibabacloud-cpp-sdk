...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFirstRankResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CreateFirstRankResponseBodyResult) };
    inline CreateFirstRankResponseBodyResult result() { DARABONBA_PTR_GET(result_, CreateFirstRankResponseBodyResult) };
    inline CreateFirstRankResponseBody& setResult(const CreateFirstRankResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreateFirstRankResponseBody& setResult(CreateFirstRankResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<CreateFirstRankResponseBodyResult> result_ = nullptr;
  };
