...
#ifndef ALIBABACLOUD_MODELS_MODIFYSECONDRANKRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_MODIFYSECONDRANKRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifySecondRankResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifySecondRankResponseBodyResult& obj) { 
    ...
    ModifySecondRankResponseBodyResult() = default ;
    ModifySecondRankResponseBodyResult(const ModifySecondRankResponseBodyResult &) = default ;
    ModifySecondRankResponseBodyResult(ModifySecondRankResponseBodyResult &&) = default ;
    ModifySecondRankResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifySecondRankResponseBodyResult() = default ;
    ModifySecondRankResponseBodyResult& operator=(const ModifySecondRankResponseBodyResult &) = default ;
    ModifySecondRankResponseBodyResult& operator=(ModifySecondRankResponseBodyResult &&) = default ;
    ...
    inline ModifySecondRankResponseBodyResult& setActive(bool active) { DARABONBA_PTR_SET_VALUE(active_, active) };
    ...
    inline ModifySecondRankResponseBodyResult& setCreated(int32_t created) { DARABONBA_PTR_SET_VALUE(created_, created) };
    ...
    inline ModifySecondRankResponseBodyResult& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ModifySecondRankResponseBodyResult& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ModifySecondRankResponseBodyResult& setIsDefault(string isDefault) { DARABONBA_PTR_SET_VALUE(isDefault_, isDefault) };
    ...
    inline ModifySecondRankResponseBodyResult& setIsSys(string isSys) { DARABONBA_PTR_SET_VALUE(isSys_, isSys) };
    ...
    inline ModifySecondRankResponseBodyResult& setMeta(string meta) { DARABONBA_PTR_SET_VALUE(meta_, meta) };
    ...
    inline ModifySecondRankResponseBodyResult& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ModifySecondRankResponseBodyResult& setUpdated(int32_t updated) { DARABONBA_PTR_SET_VALUE(updated_, updated) };
