...
namespace Models
{
  ...
  public:
    ...
    inline const GetFunctionResourceResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, GetFunctionResourceResponseBody::Result) };
    inline GetFunctionResourceResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, GetFunctionResourceResponseBody::Result) };
    inline GetFunctionResourceResponseBody& setResult(const GetFunctionResourceResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetFunctionResourceResponseBody& setResult(GetFunctionResourceResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
