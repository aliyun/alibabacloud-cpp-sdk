...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListQueryProcessorsResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListQueryProcessorsResponseBody::Result>) };
    inline vector<ListQueryProcessorsResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListQueryProcessorsResponseBody::Result>) };
    inline ListQueryProcessorsResponseBody& setResult(const vector<ListQueryProcessorsResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListQueryProcessorsResponseBody& setResult(vector<ListQueryProcessorsResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
