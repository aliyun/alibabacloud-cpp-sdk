...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListFunctionTasksResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListFunctionTasksResponseBody::Result>) };
    inline vector<ListFunctionTasksResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListFunctionTasksResponseBody::Result>) };
    inline ListFunctionTasksResponseBody& setResult(const vector<ListFunctionTasksResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListFunctionTasksResponseBody& setResult(vector<ListFunctionTasksResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    shared_ptr<vector<ListFunctionTasksResponseBody::Result>> result_ {};
