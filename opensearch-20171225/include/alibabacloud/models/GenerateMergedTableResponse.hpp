...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateMergedTableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateMergedTableResponseBody) };
    inline GenerateMergedTableResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateMergedTableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateMergedTableResponseBody> body_ {};
  };
