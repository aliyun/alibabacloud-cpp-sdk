...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEFIRSTRANKRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEFIRSTRANKRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeFirstRankResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
      DARABONBA_PTR_TO_JSON(result, result_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeFirstRankResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
      DARABONBA_PTR_FROM_JSON(result, result_);
    };
    DescribeFirstRankResponseBody() = default ;
    DescribeFirstRankResponseBody(const DescribeFirstRankResponseBody &) = default ;
    DescribeFirstRankResponseBody(DescribeFirstRankResponseBody &&) = default ;
    DescribeFirstRankResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeFirstRankResponseBody() = default ;
    DescribeFirstRankResponseBody& operator=(const DescribeFirstRankResponseBody &) = default ;
    DescribeFirstRankResponseBody& operator=(DescribeFirstRankResponseBody &&) = default ;
    ...
    inline DescribeFirstRankResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const DescribeFirstRankResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, DescribeFirstRankResponseBody::Result) };
    inline DescribeFirstRankResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, DescribeFirstRankResponseBody::Result) };
    inline DescribeFirstRankResponseBody& setResult(const DescribeFirstRankResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeFirstRankResponseBody& setResult(DescribeFirstRankResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<DescribeFirstRankResponseBody::Result> result_ {};
  };
