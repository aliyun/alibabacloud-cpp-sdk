...
namespace Models
{
  ...
  public:
    ...
    inline CreateScheduledTaskResponseBody& setResult(const Darabonba::Json & result) { DARABONBA_SET_VALUE(result_, result) };
    inline CreateScheduledTaskResponseBody& setResult(Darabonba::Json & result) { DARABONBA_SET_RVALUE(result_, result) };
