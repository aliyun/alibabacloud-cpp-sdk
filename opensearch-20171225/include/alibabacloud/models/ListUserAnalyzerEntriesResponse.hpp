...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserAnalyzerEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserAnalyzerEntriesResponseBody) };
    inline ListUserAnalyzerEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserAnalyzerEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserAnalyzerEntriesResponseBody> body_ {};
  };
