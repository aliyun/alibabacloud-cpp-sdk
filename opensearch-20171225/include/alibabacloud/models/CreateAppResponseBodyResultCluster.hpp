...
#ifndef ALIBABACLOUD_MODELS_CREATEAPPRESPONSEBODYRESULTCLUSTER_HPP_
#define ALIBABACLOUD_MODELS_CREATEAPPRESPONSEBODYRESULTCLUSTER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAppResponseBodyResultCluster& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateAppResponseBodyResultCluster& obj) { 
    ...
    CreateAppResponseBodyResultCluster() = default ;
    CreateAppResponseBodyResultCluster(const CreateAppResponseBodyResultCluster &) = default ;
    CreateAppResponseBodyResultCluster(CreateAppResponseBodyResultCluster &&) = default ;
    CreateAppResponseBodyResultCluster(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAppResponseBodyResultCluster() = default ;
    CreateAppResponseBodyResultCluster& operator=(const CreateAppResponseBodyResultCluster &) = default ;
    CreateAppResponseBodyResultCluster& operator=(CreateAppResponseBodyResultCluster &&) = default ;
    ...
    inline CreateAppResponseBodyResultCluster& setChunkModels(const vector<Darabonba::Json> & chunkModels) { DARABONBA_PTR_SET_VALUE(chunkModels_, chunkModels) };
    inline CreateAppResponseBodyResultCluster& setChunkModels(vector<Darabonba::Json> && chunkModels) { DARABONBA_PTR_SET_RVALUE(chunkModels_, chunkModels) };
    ...
    inline CreateAppResponseBodyResultCluster& setGraphRag(const Darabonba::Json & graphRag) { DARABONBA_SET_VALUE(graphRag_, graphRag) };
    inline CreateAppResponseBodyResultCluster& setGraphRag(Darabonba::Json & graphRag) { DARABONBA_SET_RVALUE(graphRag_, graphRag) };
    ...
    inline CreateAppResponseBodyResultCluster& setImageContentRecognizerModels(const vector<Darabonba::Json> & imageContentRecognizerModels) { DARABONBA_PTR_SET_VALUE(imageContentRecognizerModels_, imageContentRecognizerModels) };
    inline CreateAppResponseBodyResultCluster& setImageContentRecognizerModels(vector<Darabonba::Json> && imageContentRecognizerModels) { DARABONBA_PTR_SET_RVALUE(imageContentRecognizerModels_, imageContentRecognizerModels) };
    ...
    inline CreateAppResponseBodyResultCluster& setMaxQueryClauseLength(int32_t maxQueryClauseLength) { DARABONBA_PTR_SET_VALUE(maxQueryClauseLength_, maxQueryClauseLength) };
    ...
    inline CreateAppResponseBodyResultCluster& setMaxTimeoutMS(int32_t maxTimeoutMS) { DARABONBA_PTR_SET_VALUE(maxTimeoutMS_, maxTimeoutMS) };
    ...
    inline CreateAppResponseBodyResultCluster& setTextEmbeddingModel(string textEmbeddingModel) { DARABONBA_PTR_SET_VALUE(textEmbeddingModel_, textEmbeddingModel) };
    ...
    inline CreateAppResponseBodyResultCluster& setTextSparseEmbeddingModel(string textSparseEmbeddingModel) { DARABONBA_PTR_SET_VALUE(textSparseEmbeddingModel_, textSparseEmbeddingModel) };
    ...
    inline CreateAppResponseBodyResultCluster& setVectorIndexConfigs(const vector<Darabonba::Json> & vectorIndexConfigs) { DARABONBA_PTR_SET_VALUE(vectorIndexConfigs_, vectorIndexConfigs) };
    inline CreateAppResponseBodyResultCluster& setVectorIndexConfigs(vector<Darabonba::Json> && vectorIndexConfigs) { DARABONBA_PTR_SET_RVALUE(vectorIndexConfigs_, vectorIndexConfigs) };
