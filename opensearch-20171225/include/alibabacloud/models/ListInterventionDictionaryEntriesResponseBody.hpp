...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListInterventionDictionaryEntriesResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListInterventionDictionaryEntriesResponseBodyResult>) };
    inline vector<ListInterventionDictionaryEntriesResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListInterventionDictionaryEntriesResponseBodyResult>) };
    inline ListInterventionDictionaryEntriesResponseBody& setResult(const vector<ListInterventionDictionaryEntriesResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListInterventionDictionaryEntriesResponseBody& setResult(vector<ListInterventionDictionaryEntriesResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListInterventionDictionaryEntriesResponseBodyResult>> result_ = nullptr;
