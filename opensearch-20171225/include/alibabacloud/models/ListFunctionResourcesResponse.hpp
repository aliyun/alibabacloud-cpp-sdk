...
namespace Models
{
  ...
  public:
    ...
    inline const ListFunctionResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFunctionResourcesResponseBody) };
    inline ListFunctionResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFunctionResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFunctionResourcesResponseBody> body_ {};
  };
