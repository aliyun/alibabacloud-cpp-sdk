...
#ifndef ALIBABACLOUD_MODELS_LISTABTESTEXPERIMENTSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTABTESTEXPERIMENTSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListABTestExperimentsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
      DARABONBA_PTR_TO_JSON(result, result_);
    };
    friend void from_json(const Darabonba::Json& j, ListABTestExperimentsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
      DARABONBA_PTR_FROM_JSON(result, result_);
    };
    ListABTestExperimentsResponseBody() = default ;
    ListABTestExperimentsResponseBody(const ListABTestExperimentsResponseBody &) = default ;
    ListABTestExperimentsResponseBody(ListABTestExperimentsResponseBody &&) = default ;
    ListABTestExperimentsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListABTestExperimentsResponseBody() = default ;
    ListABTestExperimentsResponseBody& operator=(const ListABTestExperimentsResponseBody &) = default ;
    ListABTestExperimentsResponseBody& operator=(ListABTestExperimentsResponseBody &&) = default ;
    ...
    inline ListABTestExperimentsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const vector<ListABTestExperimentsResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListABTestExperimentsResponseBody::Result>) };
    inline vector<ListABTestExperimentsResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListABTestExperimentsResponseBody::Result>) };
    inline ListABTestExperimentsResponseBody& setResult(const vector<ListABTestExperimentsResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListABTestExperimentsResponseBody& setResult(vector<ListABTestExperimentsResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<vector<ListABTestExperimentsResponseBody::Result>> result_ {};
  };
