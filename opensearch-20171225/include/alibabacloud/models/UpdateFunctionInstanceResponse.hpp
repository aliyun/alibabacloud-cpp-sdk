...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFunctionInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateFunctionInstanceResponseBody) };
    inline UpdateFunctionInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateFunctionInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateFunctionInstanceResponseBody> body_ {};
  };
