...
#ifndef ALIBABACLOUD_MODELS_APPCLUSTER_HPP_
#define ALIBABACLOUD_MODELS_APPCLUSTER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AppCluster& obj) { 
      DARABONBA_PTR_TO_JSON(maxQueryClauseLength, maxQueryClauseLength_);
      DARABONBA_PTR_TO_JSON(maxTimeoutMS, maxTimeoutMS_);
    };
    friend void from_json(const Darabonba::Json& j, AppCluster& obj) { 
      DARABONBA_PTR_FROM_JSON(maxQueryClauseLength, maxQueryClauseLength_);
      DARABONBA_PTR_FROM_JSON(maxTimeoutMS, maxTimeoutMS_);
    };
    AppCluster() = default ;
    AppCluster(const AppCluster &) = default ;
    AppCluster(AppCluster &&) = default ;
    AppCluster(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AppCluster() = default ;
    AppCluster& operator=(const AppCluster &) = default ;
    AppCluster& operator=(AppCluster &&) = default ;
    ...
    inline AppCluster& setMaxQueryClauseLength(int32_t maxQueryClauseLength) { DARABONBA_PTR_SET_VALUE(maxQueryClauseLength_, maxQueryClauseLength) };
    ...
    inline AppCluster& setMaxTimeoutMS(int32_t maxTimeoutMS) { DARABONBA_PTR_SET_VALUE(maxTimeoutMS_, maxTimeoutMS) };
