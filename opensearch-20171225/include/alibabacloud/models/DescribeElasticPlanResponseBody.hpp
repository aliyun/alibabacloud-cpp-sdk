...
namespace Models
{
  ...
  public:
    ...
    inline DescribeElasticPlanResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DescribeElasticPlanResponseBody& setHttpCode(int64_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline DescribeElasticPlanResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline const DescribeElasticPlanResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, DescribeElasticPlanResponseBody::Result) };
    inline DescribeElasticPlanResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, DescribeElasticPlanResponseBody::Result) };
    inline DescribeElasticPlanResponseBody& setResult(const DescribeElasticPlanResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeElasticPlanResponseBody& setResult(DescribeElasticPlanResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<DescribeElasticPlanResponseBody::Result> result_ {};
  };
