...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDataCollectionsResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListDataCollectionsResponseBodyResult>) };
    inline vector<ListDataCollectionsResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListDataCollectionsResponseBodyResult>) };
    inline ListDataCollectionsResponseBody& setResult(const vector<ListDataCollectionsResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListDataCollectionsResponseBody& setResult(vector<ListDataCollectionsResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDataCollectionsResponseBodyResult>> result_ = nullptr;
