...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeQueryProcessorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeQueryProcessorResponseBody) };
    inline DescribeQueryProcessorResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeQueryProcessorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeQueryProcessorResponseBody> body_ {};
  };
