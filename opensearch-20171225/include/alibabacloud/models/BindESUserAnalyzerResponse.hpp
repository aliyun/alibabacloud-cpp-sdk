...
namespace Models
{
  ...
  public:
    ...
    inline const BindESUserAnalyzerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BindESUserAnalyzerResponseBody) };
    inline BindESUserAnalyzerResponseBody getBody() { DARABONBA_PTR_GET(body_, BindESUserAnalyzerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BindESUserAnalyzerResponseBody> body_ {};
  };
