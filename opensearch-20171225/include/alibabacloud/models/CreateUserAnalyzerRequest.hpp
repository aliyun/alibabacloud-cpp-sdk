...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->business_ == nullptr
        && this->businessAppGroupId_ == nullptr && this->businessType_ == nullptr && this->name_ == nullptr && this->type_ == nullptr && this->dryRun_ == nullptr; };
    ...
    inline string getBusinessAppGroupId() const { DARABONBA_PTR_GET_DEFAULT(businessAppGroupId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> businessAppGroupId_ {};
