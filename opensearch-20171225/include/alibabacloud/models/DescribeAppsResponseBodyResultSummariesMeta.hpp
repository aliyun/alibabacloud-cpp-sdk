...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAPPSRESPONSEBODYRESULTSUMMARIESMETA_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEAPPSRESPONSEBODYRESULTSUMMARIESMETA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeAppsResponseBodyResultSummariesMeta& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeAppsResponseBodyResultSummariesMeta& obj) { 
    ...
    DescribeAppsResponseBodyResultSummariesMeta() = default ;
    DescribeAppsResponseBodyResultSummariesMeta(const DescribeAppsResponseBodyResultSummariesMeta &) = default ;
    DescribeAppsResponseBodyResultSummariesMeta(DescribeAppsResponseBodyResultSummariesMeta &&) = default ;
    DescribeAppsResponseBodyResultSummariesMeta(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeAppsResponseBodyResultSummariesMeta() = default ;
    DescribeAppsResponseBodyResultSummariesMeta& operator=(const DescribeAppsResponseBodyResultSummariesMeta &) = default ;
    DescribeAppsResponseBodyResultSummariesMeta& operator=(DescribeAppsResponseBodyResultSummariesMeta &&) = default ;
    ...
    inline DescribeAppsResponseBodyResultSummariesMeta& setElement(string element) { DARABONBA_PTR_SET_VALUE(element_, element) };
    ...
    inline DescribeAppsResponseBodyResultSummariesMeta& setEllipsis(string ellipsis) { DARABONBA_PTR_SET_VALUE(ellipsis_, ellipsis) };
    ...
    inline DescribeAppsResponseBodyResultSummariesMeta& setField(string field) { DARABONBA_PTR_SET_VALUE(field_, field) };
    ...
    inline DescribeAppsResponseBodyResultSummariesMeta& setLen(int32_t len) { DARABONBA_PTR_SET_VALUE(len_, len) };
    ...
    inline DescribeAppsResponseBodyResultSummariesMeta& setSnippet(string snippet) { DARABONBA_PTR_SET_VALUE(snippet_, snippet) };
