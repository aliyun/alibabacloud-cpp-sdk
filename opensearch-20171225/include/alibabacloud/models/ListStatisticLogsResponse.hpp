...
namespace Models
{
  ...
  public:
    ...
    inline const ListStatisticLogsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListStatisticLogsResponseBody) };
    inline ListStatisticLogsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListStatisticLogsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListStatisticLogsResponseBody> body_ {};
  };
