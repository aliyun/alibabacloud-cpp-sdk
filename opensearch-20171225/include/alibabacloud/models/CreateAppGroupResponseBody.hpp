...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->chargeType_ == nullptr
        ...
        && this->quota_ == nullptr && this->status_ == nullptr && this->switchedTime_ == nullptr && this->type_ == nullptr && this->updated_ == nullptr; };
    ...
    inline const CreateAppGroupResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, CreateAppGroupResponseBody::Result) };
    inline CreateAppGroupResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, CreateAppGroupResponseBody::Result) };
    inline CreateAppGroupResponseBody& setResult(const CreateAppGroupResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreateAppGroupResponseBody& setResult(CreateAppGroupResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // None
    shared_ptr<CreateAppGroupResponseBody::Result> result_ {};
  };
