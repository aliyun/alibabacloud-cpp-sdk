...
namespace Models
{
  ...
  public:
    ...
    inline const ListQueryProcessorNersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListQueryProcessorNersResponseBody) };
    inline ListQueryProcessorNersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListQueryProcessorNersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListQueryProcessorNersResponseBody> body_ {};
  };
