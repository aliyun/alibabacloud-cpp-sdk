...
namespace Models
{
  ...
  public:
    ...
    inline const ListSlowQueryCategoriesResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListSlowQueryCategoriesResponseBodyResult) };
    inline ListSlowQueryCategoriesResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListSlowQueryCategoriesResponseBodyResult) };
    inline ListSlowQueryCategoriesResponseBody& setResult(const ListSlowQueryCategoriesResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListSlowQueryCategoriesResponseBody& setResult(ListSlowQueryCategoriesResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListSlowQueryCategoriesResponseBodyResult> result_ = nullptr;
  };
