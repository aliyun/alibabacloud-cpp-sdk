...
namespace Models
{
  ...
  public:
    ...
    inline ModifyScheduledTaskResponseBody& setResult(const Darabonba::Json & result) { DARABONBA_SET_VALUE(result_, result) };
    inline ModifyScheduledTaskResponseBody& setResult(Darabonba::Json & result) { DARABONBA_SET_RVALUE(result_, result) };
