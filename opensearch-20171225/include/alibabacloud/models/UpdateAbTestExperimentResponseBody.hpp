...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateABTestExperimentResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, UpdateABTestExperimentResponseBodyResult) };
    inline UpdateABTestExperimentResponseBodyResult result() { DARABONBA_PTR_GET(result_, UpdateABTestExperimentResponseBodyResult) };
    inline UpdateABTestExperimentResponseBody& setResult(const UpdateABTestExperimentResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateABTestExperimentResponseBody& setResult(UpdateABTestExperimentResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateABTestExperimentResponseBodyResult> result_ = nullptr;
  };
