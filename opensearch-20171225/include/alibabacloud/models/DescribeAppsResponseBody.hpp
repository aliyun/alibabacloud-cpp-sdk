...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAppsResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<DescribeAppsResponseBody::Result>) };
    inline vector<DescribeAppsResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<DescribeAppsResponseBody::Result>) };
    inline DescribeAppsResponseBody& setResult(const vector<DescribeAppsResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeAppsResponseBody& setResult(vector<DescribeAppsResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeAppsResponseBody::Result>> result_ {};
  };
