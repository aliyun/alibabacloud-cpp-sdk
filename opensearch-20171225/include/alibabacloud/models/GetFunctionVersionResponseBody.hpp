...
namespace Models
{
  ...
  public:
    ...
    inline const GetFunctionVersionResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, GetFunctionVersionResponseBody::Result) };
    inline GetFunctionVersionResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, GetFunctionVersionResponseBody::Result) };
    inline GetFunctionVersionResponseBody& setResult(const GetFunctionVersionResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetFunctionVersionResponseBody& setResult(GetFunctionVersionResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
