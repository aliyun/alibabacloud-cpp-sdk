...
#ifndef ALIBABACLOUD_MODELS_MODIFYELASTICPLANRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MODIFYELASTICPLANRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyElasticPlanResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyElasticPlanResponseBody& obj) { 
    ...
    ModifyElasticPlanResponseBody() = default ;
    ModifyElasticPlanResponseBody(const ModifyElasticPlanResponseBody &) = default ;
    ModifyElasticPlanResponseBody(ModifyElasticPlanResponseBody &&) = default ;
    ModifyElasticPlanResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyElasticPlanResponseBody() = default ;
    ModifyElasticPlanResponseBody& operator=(const ModifyElasticPlanResponseBody &) = default ;
    ModifyElasticPlanResponseBody& operator=(ModifyElasticPlanResponseBody &&) = default ;
    ...
    inline ModifyElasticPlanResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ModifyElasticPlanResponseBody& setHttpCode(int64_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline ModifyElasticPlanResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ModifyElasticPlanResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const ModifyElasticPlanResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, ModifyElasticPlanResponseBody::Result) };
    inline ModifyElasticPlanResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, ModifyElasticPlanResponseBody::Result) };
    inline ModifyElasticPlanResponseBody& setResult(const ModifyElasticPlanResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ModifyElasticPlanResponseBody& setResult(ModifyElasticPlanResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<ModifyElasticPlanResponseBody::Result> result_ {};
  };
