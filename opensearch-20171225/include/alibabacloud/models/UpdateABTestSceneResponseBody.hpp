...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateABTestSceneResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, UpdateABTestSceneResponseBody::Result) };
    inline UpdateABTestSceneResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, UpdateABTestSceneResponseBody::Result) };
    inline UpdateABTestSceneResponseBody& setResult(const UpdateABTestSceneResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateABTestSceneResponseBody& setResult(UpdateABTestSceneResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
