...
namespace Models
{
  ...
  public:
    ...
    inline const GetSortScriptResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetSortScriptResponseBodyResult) };
    inline GetSortScriptResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetSortScriptResponseBodyResult) };
    inline GetSortScriptResponseBody& setResult(const GetSortScriptResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetSortScriptResponseBody& setResult(GetSortScriptResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetSortScriptResponseBodyResult> result_ = nullptr;
  };
