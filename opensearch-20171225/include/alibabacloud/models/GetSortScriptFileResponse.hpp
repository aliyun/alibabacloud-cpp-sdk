...
namespace Models
{
  ...
  public:
    ...
    inline const GetSortScriptFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetSortScriptFileResponseBody) };
    inline GetSortScriptFileResponseBody getBody() { DARABONBA_PTR_GET(body_, GetSortScriptFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetSortScriptFileResponseBody> body_ {};
  };
