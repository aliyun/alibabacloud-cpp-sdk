...
namespace Models
{
  ...
  public:
    ...
    inline const ListFunctionTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFunctionTasksResponseBody) };
    inline ListFunctionTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFunctionTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFunctionTasksResponseBody> body_ {};
  };
