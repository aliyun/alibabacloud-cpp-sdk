...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateABTestSceneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateABTestSceneResponseBody) };
    inline UpdateABTestSceneResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateABTestSceneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateABTestSceneResponseBody> body_ {};
  };
