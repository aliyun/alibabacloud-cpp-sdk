...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAppGroupResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, DescribeAppGroupResponseBody::Result) };
    inline DescribeAppGroupResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, DescribeAppGroupResponseBody::Result) };
    inline DescribeAppGroupResponseBody& setResult(const DescribeAppGroupResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeAppGroupResponseBody& setResult(DescribeAppGroupResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<DescribeAppGroupResponseBody::Result> result_ {};
  };
