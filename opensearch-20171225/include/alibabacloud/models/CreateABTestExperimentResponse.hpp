...
namespace Models
{
  ...
  public:
    ...
    inline const CreateABTestExperimentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateABTestExperimentResponseBody) };
    inline CreateABTestExperimentResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateABTestExperimentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateABTestExperimentResponseBody> body_ {};
  };
