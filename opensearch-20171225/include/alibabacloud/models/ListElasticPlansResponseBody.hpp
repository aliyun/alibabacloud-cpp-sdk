...
#ifndef ALIBABACLOUD_MODELS_LISTELASTICPLANSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTELASTICPLANSRESPONSEBODY_HPP_
...
namespace Models
{
  class ListElasticPlansResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListElasticPlansResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListElasticPlansResponseBody& obj) { 
    ...
    ListElasticPlansResponseBody() = default ;
    ListElasticPlansResponseBody(const ListElasticPlansResponseBody &) = default ;
    ListElasticPlansResponseBody(ListElasticPlansResponseBody &&) = default ;
    ListElasticPlansResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListElasticPlansResponseBody() = default ;
    ListElasticPlansResponseBody& operator=(const ListElasticPlansResponseBody &) = default ;
    ListElasticPlansResponseBody& operator=(ListElasticPlansResponseBody &&) = default ;
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && this->httpCode_ == nullptr && this->maxResults_ == nullptr && this->message_ == nullptr && this->nextToken_ == nullptr && this->requestId_ == nullptr
        && this->result_ == nullptr && this->totalCount_ == nullptr; };
    // code Field Functions 
    bool hasCode() const { return this->code_ != nullptr;};
    void deleteCode() { this->code_ = nullptr;};
    inline string getCode() const { DARABONBA_PTR_GET_DEFAULT(code_, "") };
    inline ListElasticPlansResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ListElasticPlansResponseBody& setHttpCode(int64_t httpCode) { DARABONBA_PTR_SET_VALUE(httpCode_, httpCode) };
    ...
    inline ListElasticPlansResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListElasticPlansResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListElasticPlansResponseBody& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline ListElasticPlansResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const vector<ListElasticPlansResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListElasticPlansResponseBody::Result>) };
    inline vector<ListElasticPlansResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListElasticPlansResponseBody::Result>) };
    inline ListElasticPlansResponseBody& setResult(const vector<ListElasticPlansResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListElasticPlansResponseBody& setResult(vector<ListElasticPlansResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline ListElasticPlansResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
  ...
  protected:
    ...
    shared_ptr<vector<ListElasticPlansResponseBody::Result>> result_ {};
