...
namespace Models
{
  ...
  public:
    ...
    inline const GetFunctionTaskResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetFunctionTaskResponseBodyResult) };
    inline GetFunctionTaskResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetFunctionTaskResponseBodyResult) };
    inline GetFunctionTaskResponseBody& setResult(const GetFunctionTaskResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetFunctionTaskResponseBody& setResult(GetFunctionTaskResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetFunctionTaskResponseBodyResult> result_ = nullptr;
