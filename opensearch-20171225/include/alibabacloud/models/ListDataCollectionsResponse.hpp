...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataCollectionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataCollectionsResponseBody) };
    inline ListDataCollectionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataCollectionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataCollectionsResponseBody> body_ {};
  };
