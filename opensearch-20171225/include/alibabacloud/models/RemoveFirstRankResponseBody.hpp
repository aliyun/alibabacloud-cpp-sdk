...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveFirstRankResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, RemoveFirstRankResponseBodyResult) };
    inline RemoveFirstRankResponseBodyResult result() { DARABONBA_PTR_GET(result_, RemoveFirstRankResponseBodyResult) };
    inline RemoveFirstRankResponseBody& setResult(const RemoveFirstRankResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline RemoveFirstRankResponseBody& setResult(RemoveFirstRankResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<RemoveFirstRankResponseBodyResult> result_ = nullptr;
  };
