...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeABTestSceneResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeABTestSceneResponseBodyResult) };
    inline DescribeABTestSceneResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeABTestSceneResponseBodyResult) };
    inline DescribeABTestSceneResponseBody& setResult(const DescribeABTestSceneResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeABTestSceneResponseBody& setResult(DescribeABTestSceneResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeABTestSceneResponseBodyResult> result_ = nullptr;
  };
