...
namespace Models
{
  ...
  public:
    ...
    inline const RenewAppGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RenewAppGroupResponseBody) };
    inline RenewAppGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, RenewAppGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RenewAppGroupResponseBody> body_ {};
  };
