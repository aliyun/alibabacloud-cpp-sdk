...
namespace Models
{
  ...
  public:
    ...
    inline const ListProceedingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListProceedingsResponseBody) };
    inline ListProceedingsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListProceedingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListProceedingsResponseBody> body_ {};
  };
