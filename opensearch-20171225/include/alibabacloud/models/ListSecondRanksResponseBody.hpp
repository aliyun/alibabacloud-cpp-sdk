...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSecondRanksResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListSecondRanksResponseBody::Result>) };
    inline vector<ListSecondRanksResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListSecondRanksResponseBody::Result>) };
    inline ListSecondRanksResponseBody& setResult(const vector<ListSecondRanksResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListSecondRanksResponseBody& setResult(vector<ListSecondRanksResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
