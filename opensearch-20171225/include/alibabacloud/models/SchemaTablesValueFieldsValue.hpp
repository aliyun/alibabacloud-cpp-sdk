...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->name_ == nullptr
        && this->primaryKey_ == nullptr && this->type_ == nullptr && this->joinWith_ == nullptr && this->label_ == nullptr; };
    ...
    inline const vector<string> & getJoinWith() const { DARABONBA_PTR_GET_CONST(joinWith_, vector<string>) };
    inline vector<string> getJoinWith() { DARABONBA_PTR_GET(joinWith_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> joinWith_ {};
