...
namespace Models
{
  ...
  public:
    ...
    inline const CreateUserAnalyzerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateUserAnalyzerResponseBody) };
    inline CreateUserAnalyzerResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateUserAnalyzerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateUserAnalyzerResponseBody> body_ {};
  };
