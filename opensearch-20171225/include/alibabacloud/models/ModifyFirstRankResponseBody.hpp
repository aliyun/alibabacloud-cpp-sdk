...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyFirstRankResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, ModifyFirstRankResponseBody::Result) };
    inline ModifyFirstRankResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, ModifyFirstRankResponseBody::Result) };
    inline ModifyFirstRankResponseBody& setResult(const ModifyFirstRankResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ModifyFirstRankResponseBody& setResult(ModifyFirstRankResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
