...
namespace Models
{
  ...
  public:
    ...
    inline const ListQueryProcessorAnalyzerResultsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListQueryProcessorAnalyzerResultsResponseBody) };
    inline ListQueryProcessorAnalyzerResultsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListQueryProcessorAnalyzerResultsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListQueryProcessorAnalyzerResultsResponseBody> body_ {};
  };
