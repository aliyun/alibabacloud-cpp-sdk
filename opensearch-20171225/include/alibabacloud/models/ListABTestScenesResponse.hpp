...
namespace Models
{
  ...
  public:
    ...
    inline const ListABTestScenesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListABTestScenesResponseBody) };
    inline ListABTestScenesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListABTestScenesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListABTestScenesResponseBody> body_ {};
  };
