...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateDataSourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ValidateDataSourcesResponseBody) };
    inline ValidateDataSourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ValidateDataSourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ValidateDataSourcesResponseBody> body_ {};
  };
