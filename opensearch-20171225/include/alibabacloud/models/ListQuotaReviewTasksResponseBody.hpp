...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListQuotaReviewTasksResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListQuotaReviewTasksResponseBodyResult>) };
    inline vector<ListQuotaReviewTasksResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListQuotaReviewTasksResponseBodyResult>) };
    inline ListQuotaReviewTasksResponseBody& setResult(const vector<ListQuotaReviewTasksResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListQuotaReviewTasksResponseBody& setResult(vector<ListQuotaReviewTasksResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListQuotaReviewTasksResponseBodyResult>> result_ = nullptr;
