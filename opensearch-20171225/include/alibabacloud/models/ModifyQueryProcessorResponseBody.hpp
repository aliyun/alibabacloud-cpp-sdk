...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyQueryProcessorResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ModifyQueryProcessorResponseBodyResult) };
    inline ModifyQueryProcessorResponseBodyResult result() { DARABONBA_PTR_GET(result_, ModifyQueryProcessorResponseBodyResult) };
    inline ModifyQueryProcessorResponseBody& setResult(const ModifyQueryProcessorResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ModifyQueryProcessorResponseBody& setResult(ModifyQueryProcessorResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyQueryProcessorResponseBodyResult> result_ = nullptr;
  };
