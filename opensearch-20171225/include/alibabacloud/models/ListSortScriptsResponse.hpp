...
namespace Models
{
  ...
  public:
    ...
    inline const ListSortScriptsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSortScriptsResponseBody) };
    inline ListSortScriptsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSortScriptsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSortScriptsResponseBody> body_ {};
  };
