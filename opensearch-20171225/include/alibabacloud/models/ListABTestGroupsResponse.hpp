...
namespace Models
{
  ...
  public:
    ...
    inline const ListABTestGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListABTestGroupsResponseBody) };
    inline ListABTestGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListABTestGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListABTestGroupsResponseBody> body_ {};
  };
