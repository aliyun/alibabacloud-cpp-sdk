...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListUserAnalyzersResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListUserAnalyzersResponseBodyResult>) };
    inline vector<ListUserAnalyzersResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListUserAnalyzersResponseBodyResult>) };
    inline ListUserAnalyzersResponseBody& setResult(const vector<ListUserAnalyzersResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListUserAnalyzersResponseBody& setResult(vector<ListUserAnalyzersResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListUserAnalyzersResponseBodyResult>> result_ = nullptr;
    // The total number.
