...
#ifndef ALIBABACLOUD_MODELS_MODIFYSECONDRANKRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MODIFYSECONDRANKRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifySecondRankResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(requestId, requestId_);
      DARABONBA_PTR_TO_JSON(result, result_);
    };
    friend void from_json(const Darabonba::Json& j, ModifySecondRankResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(requestId, requestId_);
      DARABONBA_PTR_FROM_JSON(result, result_);
    };
    ModifySecondRankResponseBody() = default ;
    ModifySecondRankResponseBody(const ModifySecondRankResponseBody &) = default ;
    ModifySecondRankResponseBody(ModifySecondRankResponseBody &&) = default ;
    ModifySecondRankResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifySecondRankResponseBody() = default ;
    ModifySecondRankResponseBody& operator=(const ModifySecondRankResponseBody &) = default ;
    ModifySecondRankResponseBody& operator=(ModifySecondRankResponseBody &&) = default ;
    ...
    inline ModifySecondRankResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const ModifySecondRankResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, ModifySecondRankResponseBody::Result) };
    inline ModifySecondRankResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, ModifySecondRankResponseBody::Result) };
    inline ModifySecondRankResponseBody& setResult(const ModifySecondRankResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ModifySecondRankResponseBody& setResult(ModifySecondRankResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<ModifySecondRankResponseBody::Result> result_ {};
  };
