...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAPPRESPONSEBODYRESULTSUMMARIESMETA_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEAPPRESPONSEBODYRESULTSUMMARIESMETA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeAppResponseBodyResultSummariesMeta& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeAppResponseBodyResultSummariesMeta& obj) { 
    ...
    DescribeAppResponseBodyResultSummariesMeta() = default ;
    DescribeAppResponseBodyResultSummariesMeta(const DescribeAppResponseBodyResultSummariesMeta &) = default ;
    DescribeAppResponseBodyResultSummariesMeta(DescribeAppResponseBodyResultSummariesMeta &&) = default ;
    DescribeAppResponseBodyResultSummariesMeta(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeAppResponseBodyResultSummariesMeta() = default ;
    DescribeAppResponseBodyResultSummariesMeta& operator=(const DescribeAppResponseBodyResultSummariesMeta &) = default ;
    DescribeAppResponseBodyResultSummariesMeta& operator=(DescribeAppResponseBodyResultSummariesMeta &&) = default ;
    ...
    inline DescribeAppResponseBodyResultSummariesMeta& setElement(string element) { DARABONBA_PTR_SET_VALUE(element_, element) };
    ...
    inline DescribeAppResponseBodyResultSummariesMeta& setEllipsis(string ellipsis) { DARABONBA_PTR_SET_VALUE(ellipsis_, ellipsis) };
    ...
    inline DescribeAppResponseBodyResultSummariesMeta& setField(string field) { DARABONBA_PTR_SET_VALUE(field_, field) };
    ...
    inline DescribeAppResponseBodyResultSummariesMeta& setLen(int32_t len) { DARABONBA_PTR_SET_VALUE(len_, len) };
    ...
    inline DescribeAppResponseBodyResultSummariesMeta& setSnippet(string snippet) { DARABONBA_PTR_SET_VALUE(snippet_, snippet) };
