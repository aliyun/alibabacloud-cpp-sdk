...
namespace Models
{
  ...
  public:
    ...
    inline const StartSlowQueryAnalyzerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartSlowQueryAnalyzerResponseBody) };
    inline StartSlowQueryAnalyzerResponseBody getBody() { DARABONBA_PTR_GET(body_, StartSlowQueryAnalyzerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartSlowQueryAnalyzerResponseBody> body_ {};
  };
