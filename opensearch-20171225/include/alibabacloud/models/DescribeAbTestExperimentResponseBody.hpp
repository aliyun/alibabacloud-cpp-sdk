...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeABTestExperimentResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeABTestExperimentResponseBodyResult) };
    inline DescribeABTestExperimentResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeABTestExperimentResponseBodyResult) };
    inline DescribeABTestExperimentResponseBody& setResult(const DescribeABTestExperimentResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeABTestExperimentResponseBody& setResult(DescribeABTestExperimentResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeABTestExperimentResponseBodyResult> result_ = nullptr;
  };
