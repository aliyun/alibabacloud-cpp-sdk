...
#ifndef ALIBABACLOUD_MODELS_CREATEAPPREQUESTSUMMARIESMETA_HPP_
#define ALIBABACLOUD_MODELS_CREATEAPPREQUESTSUMMARIESMETA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAppRequestSummariesMeta& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateAppRequestSummariesMeta& obj) { 
    ...
    CreateAppRequestSummariesMeta() = default ;
    CreateAppRequestSummariesMeta(const CreateAppRequestSummariesMeta &) = default ;
    CreateAppRequestSummariesMeta(CreateAppRequestSummariesMeta &&) = default ;
    CreateAppRequestSummariesMeta(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAppRequestSummariesMeta() = default ;
    CreateAppRequestSummariesMeta& operator=(const CreateAppRequestSummariesMeta &) = default ;
    CreateAppRequestSummariesMeta& operator=(CreateAppRequestSummariesMeta &&) = default ;
    ...
    inline CreateAppRequestSummariesMeta& setElement(string element) { DARABONBA_PTR_SET_VALUE(element_, element) };
    ...
    inline CreateAppRequestSummariesMeta& setEllipsis(string ellipsis) { DARABONBA_PTR_SET_VALUE(ellipsis_, ellipsis) };
    ...
    inline CreateAppRequestSummariesMeta& setField(string field) { DARABONBA_PTR_SET_VALUE(field_, field) };
    ...
    inline CreateAppRequestSummariesMeta& setLen(int32_t len) { DARABONBA_PTR_SET_VALUE(len_, len) };
    ...
    inline CreateAppRequestSummariesMeta& setSnippet(string snippet) { DARABONBA_PTR_SET_VALUE(snippet_, snippet) };
