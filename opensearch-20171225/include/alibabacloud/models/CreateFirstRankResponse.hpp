...
namespace Models
{
  ...
  public:
    ...
    inline const CreateFirstRankResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateFirstRankResponseBody) };
    inline CreateFirstRankResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateFirstRankResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateFirstRankResponseBody> body_ {};
  };
