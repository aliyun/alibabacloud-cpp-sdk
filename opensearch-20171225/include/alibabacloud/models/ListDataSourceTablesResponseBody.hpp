...
namespace Models
{
  ...
  public:
    ...
    inline ListDataSourceTablesResponseBody& setResult(const vector<string> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListDataSourceTablesResponseBody& setResult(vector<string> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
