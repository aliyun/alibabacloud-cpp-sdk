...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDATACOLLCTIONRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDATACOLLCTIONRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDataCollctionResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDataCollctionResponseBodyResult& obj) { 
    ...
    DescribeDataCollctionResponseBodyResult() = default ;
    DescribeDataCollctionResponseBodyResult(const DescribeDataCollctionResponseBodyResult &) = default ;
    DescribeDataCollctionResponseBodyResult(DescribeDataCollctionResponseBodyResult &&) = default ;
    DescribeDataCollctionResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDataCollctionResponseBodyResult() = default ;
    DescribeDataCollctionResponseBodyResult& operator=(const DescribeDataCollctionResponseBodyResult &) = default ;
    DescribeDataCollctionResponseBodyResult& operator=(DescribeDataCollctionResponseBodyResult &&) = default ;
    ...
    inline DescribeDataCollctionResponseBodyResult& setCreated(int32_t created) { DARABONBA_PTR_SET_VALUE(created_, created) };
    ...
    inline DescribeDataCollctionResponseBodyResult& setDataCollectionType(string dataCollectionType) { DARABONBA_PTR_SET_VALUE(dataCollectionType_, dataCollectionType) };
    ...
    inline DescribeDataCollctionResponseBodyResult& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DescribeDataCollctionResponseBodyResult& setIndustryName(string industryName) { DARABONBA_PTR_SET_VALUE(industryName_, industryName) };
    ...
    inline DescribeDataCollctionResponseBodyResult& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline DescribeDataCollctionResponseBodyResult& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline DescribeDataCollctionResponseBodyResult& setSundialId(string sundialId) { DARABONBA_PTR_SET_VALUE(sundialId_, sundialId) };
    ...
    inline DescribeDataCollctionResponseBodyResult& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeDataCollctionResponseBodyResult& setUpdated(int32_t updated) { DARABONBA_PTR_SET_VALUE(updated_, updated) };
