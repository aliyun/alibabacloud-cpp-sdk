...
#ifndef ALIBABACLOUD_MODELS_CREATEAPPGROUPRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_CREATEAPPGROUPRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAppGroupResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateAppGroupResponseBodyResult& obj) { 
    ...
    CreateAppGroupResponseBodyResult() = default ;
    CreateAppGroupResponseBodyResult(const CreateAppGroupResponseBodyResult &) = default ;
    CreateAppGroupResponseBodyResult(CreateAppGroupResponseBodyResult &&) = default ;
    CreateAppGroupResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAppGroupResponseBodyResult() = default ;
    CreateAppGroupResponseBodyResult& operator=(const CreateAppGroupResponseBodyResult &) = default ;
    CreateAppGroupResponseBodyResult& operator=(CreateAppGroupResponseBodyResult &&) = default ;
    ...
    virtual bool empty() const override { return this->chargeType_ == nullptr
        ...
        && return this->quota_ == nullptr && return this->status_ == nullptr && return this->switchedTime_ == nullptr && return this->type_ == nullptr && return this->updated_ == nullptr; };
    // chargeType Field Functions 
    bool hasChargeType() const { return this->chargeType_ != nullptr;};
    void deleteChargeType() { this->chargeType_ = nullptr;};
    inline string chargeType() const { DARABONBA_PTR_GET_DEFAULT(chargeType_, "") };
    inline CreateAppGroupResponseBodyResult& setChargeType(string chargeType) { DARABONBA_PTR_SET_VALUE(chargeType_, chargeType) };
    ...
    inline CreateAppGroupResponseBodyResult& setChargingWay(int32_t chargingWay) { DARABONBA_PTR_SET_VALUE(chargingWay_, chargingWay) };
    ...
    inline CreateAppGroupResponseBodyResult& setCommodityCode(string commodityCode) { DARABONBA_PTR_SET_VALUE(commodityCode_, commodityCode) };
    ...
    inline CreateAppGroupResponseBodyResult& setCreated(int32_t created) { DARABONBA_PTR_SET_VALUE(created_, created) };
    ...
    inline CreateAppGroupResponseBodyResult& setCurrentVersion(string currentVersion) { DARABONBA_PTR_SET_VALUE(currentVersion_, currentVersion) };
    ...
    inline CreateAppGroupResponseBodyResult& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreateAppGroupResponseBodyResult& setDomain(string domain) { DARABONBA_PTR_SET_VALUE(domain_, domain) };
    ...
    inline CreateAppGroupResponseBodyResult& setEngineType(string engineType) { DARABONBA_PTR_SET_VALUE(engineType_, engineType) };
    ...
    inline CreateAppGroupResponseBodyResult& setExpireOn(string expireOn) { DARABONBA_PTR_SET_VALUE(expireOn_, expireOn) };
    ...
    inline CreateAppGroupResponseBodyResult& setHasPendingQuotaReviewTask(int32_t hasPendingQuotaReviewTask) { DARABONBA_PTR_SET_VALUE(hasPendingQuotaReviewTask_, hasPendingQuotaReviewTask) };
    ...
    inline CreateAppGroupResponseBodyResult& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline CreateAppGroupResponseBodyResult& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline CreateAppGroupResponseBodyResult& setLockMode(string lockMode) { DARABONBA_PTR_SET_VALUE(lockMode_, lockMode) };
    ...
    inline CreateAppGroupResponseBodyResult& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateAppGroupResponseBodyResult& setProduced(int32_t produced) { DARABONBA_PTR_SET_VALUE(produced_, produced) };
    ...
    inline CreateAppGroupResponseBodyResult& setProjectId(string projectId) { DARABONBA_PTR_SET_VALUE(projectId_, projectId) };


    // quota Field Functions 
    bool hasQuota() const { return this->quota_ != nullptr;};
    void deleteQuota() { this->quota_ = nullptr;};
    inline const Models::CreateAppGroupResponseBodyResultQuota & quota() const { DARABONBA_PTR_GET_CONST(quota_, Models::CreateAppGroupResponseBodyResultQuota) };
    inline Models::CreateAppGroupResponseBodyResultQuota quota() { DARABONBA_PTR_GET(quota_, Models::CreateAppGroupResponseBodyResultQuota) };
    inline CreateAppGroupResponseBodyResult& setQuota(const Models::CreateAppGroupResponseBodyResultQuota & quota) { DARABONBA_PTR_SET_VALUE(quota_, quota) };
    inline CreateAppGroupResponseBodyResult& setQuota(Models::CreateAppGroupResponseBodyResultQuota && quota) { DARABONBA_PTR_SET_RVALUE(quota_, quota) };
    ...
    inline CreateAppGroupResponseBodyResult& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline CreateAppGroupResponseBodyResult& setSwitchedTime(int32_t switchedTime) { DARABONBA_PTR_SET_VALUE(switchedTime_, switchedTime) };
    ...
    inline CreateAppGroupResponseBodyResult& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline CreateAppGroupResponseBodyResult& setUpdated(int32_t updated) { DARABONBA_PTR_SET_VALUE(updated_, updated) };
  ...
  protected:
    ...
    std::shared_ptr<Models::CreateAppGroupResponseBodyResultQuota> quota_ = nullptr;
