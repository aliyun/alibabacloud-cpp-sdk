...
#ifndef ALIBABACLOUD_MODELS_SUMMARYMETA_HPP_
#define ALIBABACLOUD_MODELS_SUMMARYMETA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SummaryMeta& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SummaryMeta& obj) { 
    ...
    SummaryMeta() = default ;
    SummaryMeta(const SummaryMeta &) = default ;
    SummaryMeta(SummaryMeta &&) = default ;
    SummaryMeta(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SummaryMeta() = default ;
    SummaryMeta& operator=(const SummaryMeta &) = default ;
    SummaryMeta& operator=(SummaryMeta &&) = default ;
    ...
    inline SummaryMeta& setElement(string element) { DARABONBA_PTR_SET_VALUE(element_, element) };
    ...
    inline SummaryMeta& setEllipsis(string ellipsis) { DARABONBA_PTR_SET_VALUE(ellipsis_, ellipsis) };
    ...
    inline SummaryMeta& setField(string field) { DARABONBA_PTR_SET_VALUE(field_, field) };
    ...
    inline SummaryMeta& setLen(int32_t len) { DARABONBA_PTR_SET_VALUE(len_, len) };
    ...
    inline SummaryMeta& setSnippet(string snippet) { DARABONBA_PTR_SET_VALUE(snippet_, snippet) };
