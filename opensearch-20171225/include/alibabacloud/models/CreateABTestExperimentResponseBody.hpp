...
namespace Models
{
  ...
  public:
    ...
    inline const CreateABTestExperimentResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, CreateABTestExperimentResponseBody::Result) };
    inline CreateABTestExperimentResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, CreateABTestExperimentResponseBody::Result) };
    inline CreateABTestExperimentResponseBody& setResult(const CreateABTestExperimentResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreateABTestExperimentResponseBody& setResult(CreateABTestExperimentResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<CreateABTestExperimentResponseBody::Result> result_ {};
  };
