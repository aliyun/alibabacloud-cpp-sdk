...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListABTestScenesResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListABTestScenesResponseBody::Result>) };
    inline vector<ListABTestScenesResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListABTestScenesResponseBody::Result>) };
    inline ListABTestScenesResponseBody& setResult(const vector<ListABTestScenesResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListABTestScenesResponseBody& setResult(vector<ListABTestScenesResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<vector<ListABTestScenesResponseBody::Result>> result_ {};
  };
