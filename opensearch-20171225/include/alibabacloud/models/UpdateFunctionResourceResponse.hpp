...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFunctionResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateFunctionResourceResponseBody) };
    inline UpdateFunctionResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateFunctionResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateFunctionResourceResponseBody> body_ {};
  };
