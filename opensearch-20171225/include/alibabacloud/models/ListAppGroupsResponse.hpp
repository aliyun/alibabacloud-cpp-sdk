...
namespace Models
{
  ...
  public:
    ...
    inline const ListAppGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAppGroupsResponseBody) };
    inline ListAppGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAppGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAppGroupsResponseBody> body_ {};
  };
