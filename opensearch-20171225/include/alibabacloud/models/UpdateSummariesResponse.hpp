...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSummariesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSummariesResponseBody) };
    inline UpdateSummariesResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateSummariesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateSummariesResponseBody> body_ {};
  };
