...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListFunctionInstancesResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListFunctionInstancesResponseBodyResult>) };
    inline vector<ListFunctionInstancesResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListFunctionInstancesResponseBodyResult>) };
    inline ListFunctionInstancesResponseBody& setResult(const vector<ListFunctionInstancesResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListFunctionInstancesResponseBody& setResult(vector<ListFunctionInstancesResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListFunctionInstancesResponseBodyResult>> result_ = nullptr;
