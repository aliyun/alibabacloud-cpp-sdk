...
namespace Models
{
  ...
  public:
    ...
    inline const ListSlowQueryQueriesResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListSlowQueryQueriesResponseBodyResult) };
    inline ListSlowQueryQueriesResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListSlowQueryQueriesResponseBodyResult) };
    inline ListSlowQueryQueriesResponseBody& setResult(const ListSlowQueryQueriesResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListSlowQueryQueriesResponseBody& setResult(ListSlowQueryQueriesResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The return result.
    std::shared_ptr<ListSlowQueryQueriesResponseBodyResult> result_ = nullptr;
  };
