...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDataCollctionResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, DescribeDataCollctionResponseBody::Result) };
    inline DescribeDataCollctionResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, DescribeDataCollctionResponseBody::Result) };
    inline DescribeDataCollctionResponseBody& setResult(const DescribeDataCollctionResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeDataCollctionResponseBody& setResult(DescribeDataCollctionResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
