...
public:
  ...
  CreateModelResponse createModel(shared_ptr<string> appGroupIdentity, shared_ptr<CreateModelRequest> request);
  CreateModelResponse createModelWithOptions(shared_ptr<string> appGroupIdentity,
