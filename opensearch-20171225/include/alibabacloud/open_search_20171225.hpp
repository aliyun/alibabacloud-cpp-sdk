...
public:
  ...
  ListModelsResponse listModelsWithOptions(shared_ptr<string> appGroupIdentity,
                                           ...
                                           shared_ptr<map<string, string>> headers,
                                           shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  ListProceedingsResponse listProceedings(shared_ptr<string> appGroupIdentity);
  ListProceedingsResponse listProceedingsWithOptions(shared_ptr<string> appGroupIdentity, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  ...
  RenewAppGroupResponse renewAppGroup(shared_ptr<string> appGroupIdentity);
  RenewAppGroupResponse renewAppGroupWithOptions(shared_ptr<string> appGroupIdentity, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
