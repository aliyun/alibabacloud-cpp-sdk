...
namespace Models
{
  ...
  public:
    ...
    inline CreateTemplateRequest& setBody(const TemplateDTO & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CreateTemplateRequest& setBody(TemplateDTO && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
