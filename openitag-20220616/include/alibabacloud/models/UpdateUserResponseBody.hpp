...
namespace Models
{
  ...
  public:
    ...
    inline UpdateUserResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UpdateUserResponseBody& setDetails(string details) { DARABONBA_PTR_SET_VALUE(details_, details) };
    ...
    inline UpdateUserResponseBody& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
