...
namespace Models
{
  ...
  public:
    ...
    inline GetTaskResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetTaskResponseBody& setDetails(string details) { DARABONBA_PTR_SET_VALUE(details_, details) };
    ...
    inline const TaskDetail & getTask() const { DARABONBA_PTR_GET_CONST(task_, TaskDetail) };
    inline TaskDetail getTask() { DARABONBA_PTR_GET(task_, TaskDetail) };
    inline GetTaskResponseBody& setTask(const TaskDetail & task) { DARABONBA_PTR_SET_VALUE(task_, task) };
    inline GetTaskResponseBody& setTask(TaskDetail && task) { DARABONBA_PTR_SET_RVALUE(task_, task) };
