...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && this->details_ == nullptr && this->errorCode_ == nullptr && this->job_ == nullptr && this->message_ == nullptr && this->requestId_ == nullptr
        && this->success_ == nullptr; };
    // code Field Functions 
    bool hasCode() const { return this->code_ != nullptr;};
    void deleteCode() { this->code_ = nullptr;};
    inline int32_t getCode() const { DARABONBA_PTR_GET_DEFAULT(code_, 0) };
    inline GetJobResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetJobResponseBody& setDetails(string details) { DARABONBA_PTR_SET_VALUE(details_, details) };
    ...
    inline GetJobResponseBody& setErrorCode(string errorCode) { DARABONBA_PTR_SET_VALUE(errorCode_, errorCode) };


    // job Field Functions 
    bool hasJob() const { return this->job_ != nullptr;};
    void deleteJob() { this->job_ = nullptr;};
    inline const Job & getJob() const { DARABONBA_PTR_GET_CONST(job_, Job) };
    inline Job getJob() { DARABONBA_PTR_GET(job_, Job) };
    inline GetJobResponseBody& setJob(const Job & job) { DARABONBA_PTR_SET_VALUE(job_, job) };
    inline GetJobResponseBody& setJob(Job && job) { DARABONBA_PTR_SET_RVALUE(job_, job) };
    ...
    inline GetJobResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetJobResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
