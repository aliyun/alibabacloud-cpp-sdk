...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTaskDetail & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTaskDetail) };
    inline CreateTaskDetail getBody() { DARABONBA_PTR_GET(body_, CreateTaskDetail) };
    inline CreateTaskRequest& setBody(const CreateTaskDetail & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline CreateTaskRequest& setBody(CreateTaskDetail && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
  ...
  protected:
    ...
    shared_ptr<CreateTaskDetail> body_ {};
  };
