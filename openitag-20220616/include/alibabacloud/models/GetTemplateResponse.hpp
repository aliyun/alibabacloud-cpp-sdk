...
namespace Models
{
  ...
  public:
    ...
    inline const GetTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTemplateResponseBody) };
    inline GetTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTemplateResponseBody> body_ {};
  };
