...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTemplateResponseBody) };
    inline DeleteTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTemplateResponseBody> body_ {};
  };
