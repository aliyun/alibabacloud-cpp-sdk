...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && this->details_ == nullptr && this->errorCode_ == nullptr && this->jobs_ == nullptr && this->message_ == nullptr && this->pageNumber_ == nullptr
    ...
    inline ListJobsResponseBody& setDetails(string details) { DARABONBA_PTR_SET_VALUE(details_, details) };
    ...
    inline const vector<Job> & getJobs() const { DARABONBA_PTR_GET_CONST(jobs_, vector<Job>) };
    inline vector<Job> getJobs() { DARABONBA_PTR_GET(jobs_, vector<Job>) };
    inline ListJobsResponseBody& setJobs(const vector<Job> & jobs) { DARABONBA_PTR_SET_VALUE(jobs_, jobs) };
    inline ListJobsResponseBody& setJobs(vector<Job> && jobs) { DARABONBA_PTR_SET_RVALUE(jobs_, jobs) };
    ...
    inline ListJobsResponseBody& setTotalPage(int32_t totalPage) { DARABONBA_PTR_SET_VALUE(totalPage_, totalPage) };
