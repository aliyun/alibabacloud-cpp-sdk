...
#ifndef ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONSHRINKREQUESTINSTANCETYPEOVERRIDES_HPP_
#define ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONSHRINKREQUESTINSTANCETYPEOVERRIDES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides& obj) { 
      DARABONBA_PTR_TO_JSON(InstanceType, instanceType_);
      DARABONBA_PTR_TO_JSON(WeightedCapacity, weightedCapacity_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides& obj) { 
      DARABONBA_PTR_FROM_JSON(InstanceType, instanceType_);
      DARABONBA_PTR_FROM_JSON(WeightedCapacity, weightedCapacity_);
    };
    ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides() = default ;
    ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides(const ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides &) = default ;
    ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides(ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides &&) = default ;
    ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides() = default ;
    ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides& operator=(const ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides &) = default ;
    ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides& operator=(ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides &&) = default ;
    ...
    inline ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides& setWeightedCapacity(int32_t weightedCapacity) { DARABONBA_PTR_SET_VALUE(weightedCapacity_, weightedCapacity) };
