...
namespace Models
{
  ...
  public:
    ...
    inline const EnterStandbyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnterStandbyResponseBody) };
    inline EnterStandbyResponseBody getBody() { DARABONBA_PTR_GET(body_, EnterStandbyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnterStandbyResponseBody> body_ {};
  };
