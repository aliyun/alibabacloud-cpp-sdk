...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instanceRefreshTaskIds_ == nullptr
    ...
    inline const vector<string> & getInstanceRefreshTaskIds() const { DARABONBA_PTR_GET_CONST(instanceRefreshTaskIds_, vector<string>) };
    inline vector<string> getInstanceRefreshTaskIds() { DARABONBA_PTR_GET(instanceRefreshTaskIds_, vector<string>) };
