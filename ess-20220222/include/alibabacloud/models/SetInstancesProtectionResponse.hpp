...
namespace Models
{
  ...
  public:
    ...
    inline const SetInstancesProtectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetInstancesProtectionResponseBody) };
    inline SetInstancesProtectionResponseBody getBody() { DARABONBA_PTR_GET(body_, SetInstancesProtectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetInstancesProtectionResponseBody> body_ {};
  };
