...
namespace Models
{
  ...
  public:
    ...
    inline const AttachInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachInstancesResponseBody) };
    inline AttachInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachInstancesResponseBody> body_ {};
  };
