...
namespace Models
{
  ...
  public:
    ...
    inline const CreateScalingGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateScalingGroupResponseBody) };
    inline CreateScalingGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateScalingGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateScalingGroupResponseBody> body_ {};
  };
