...
#ifndef ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONSHRINKREQUESTPRIVATEPOOLOPTIONS_HPP_
#define ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONSHRINKREQUESTPRIVATEPOOLOPTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyScalingConfigurationShrinkRequestPrivatePoolOptions& obj) { 
      DARABONBA_PTR_TO_JSON(Id, id_);
      DARABONBA_PTR_TO_JSON(MatchCriteria, matchCriteria_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyScalingConfigurationShrinkRequestPrivatePoolOptions& obj) { 
      DARABONBA_PTR_FROM_JSON(Id, id_);
      DARABONBA_PTR_FROM_JSON(MatchCriteria, matchCriteria_);
    };
    ModifyScalingConfigurationShrinkRequestPrivatePoolOptions() = default ;
    ModifyScalingConfigurationShrinkRequestPrivatePoolOptions(const ModifyScalingConfigurationShrinkRequestPrivatePoolOptions &) = default ;
    ModifyScalingConfigurationShrinkRequestPrivatePoolOptions(ModifyScalingConfigurationShrinkRequestPrivatePoolOptions &&) = default ;
    ModifyScalingConfigurationShrinkRequestPrivatePoolOptions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyScalingConfigurationShrinkRequestPrivatePoolOptions() = default ;
    ModifyScalingConfigurationShrinkRequestPrivatePoolOptions& operator=(const ModifyScalingConfigurationShrinkRequestPrivatePoolOptions &) = default ;
    ModifyScalingConfigurationShrinkRequestPrivatePoolOptions& operator=(ModifyScalingConfigurationShrinkRequestPrivatePoolOptions &&) = default ;
    ...
    inline ModifyScalingConfigurationShrinkRequestPrivatePoolOptions& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline ModifyScalingConfigurationShrinkRequestPrivatePoolOptions& setMatchCriteria(string matchCriteria) { DARABONBA_PTR_SET_VALUE(matchCriteria_, matchCriteria) };
