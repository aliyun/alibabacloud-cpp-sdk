...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instanceRefreshTaskId_ == nullptr
        ...
        && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->scalingActivityIds_ == nullptr && return this->scalingGroupId_ == nullptr && return this->statusCode_ == nullptr; };
    ...
    inline const vector<string> & scalingActivityIds() const { DARABONBA_PTR_GET_CONST(scalingActivityIds_, vector<string>) };
    inline vector<string> scalingActivityIds() { DARABONBA_PTR_GET(scalingActivityIds_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> scalingActivityIds_ = nullptr;
