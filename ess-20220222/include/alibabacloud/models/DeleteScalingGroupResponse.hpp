...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteScalingGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteScalingGroupResponseBody) };
    inline DeleteScalingGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteScalingGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteScalingGroupResponseBody> body_ {};
  };
