...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->async_ == nullptr
        && return this->clientToken_ == nullptr && return this->instanceIds_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
