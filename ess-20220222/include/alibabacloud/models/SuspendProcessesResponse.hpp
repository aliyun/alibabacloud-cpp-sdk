...
namespace Models
{
  ...
  public:
    ...
    inline const SuspendProcessesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SuspendProcessesResponseBody) };
    inline SuspendProcessesResponseBody getBody() { DARABONBA_PTR_GET(body_, SuspendProcessesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SuspendProcessesResponseBody> body_ {};
  };
