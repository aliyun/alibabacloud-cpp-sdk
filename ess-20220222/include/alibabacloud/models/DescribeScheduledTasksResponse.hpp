...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScheduledTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeScheduledTasksResponseBody) };
    inline DescribeScheduledTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeScheduledTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeScheduledTasksResponseBody> body_ {};
  };
