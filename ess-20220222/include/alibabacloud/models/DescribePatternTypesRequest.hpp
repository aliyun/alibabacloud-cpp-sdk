...
namespace Models
{
  ...
  public:
    ...
    inline const vector<int32_t> & getCoresList() const { DARABONBA_PTR_GET_CONST(coresList_, vector<int32_t>) };
    inline vector<int32_t> getCoresList() { DARABONBA_PTR_GET(coresList_, vector<int32_t>) };
    ...
    inline const vector<string> & getExcludedInstanceType() const { DARABONBA_PTR_GET_CONST(excludedInstanceType_, vector<string>) };
    inline vector<string> getExcludedInstanceType() { DARABONBA_PTR_GET(excludedInstanceType_, vector<string>) };
    ...
    inline const vector<float> & getMemoryList() const { DARABONBA_PTR_GET_CONST(memoryList_, vector<float>) };
    inline vector<float> getMemoryList() { DARABONBA_PTR_GET(memoryList_, vector<float>) };
  ...
  protected:
    ...
    shared_ptr<vector<int32_t>> coresList_ {};
    ...
    shared_ptr<vector<string>> excludedInstanceType_ {};
    // The GPU models.
    ...
    shared_ptr<vector<float>> memoryList_ {};
