...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceCreateAndDeleteStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceCreateAndDeleteStatisticsResponseBody) };
    inline DescribeInstanceCreateAndDeleteStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceCreateAndDeleteStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceCreateAndDeleteStatisticsResponseBody> body_ {};
  };
