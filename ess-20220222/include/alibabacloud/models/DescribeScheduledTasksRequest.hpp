...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & scheduledActions() const { DARABONBA_PTR_GET_CONST(scheduledActions_, vector<string>) };
    inline vector<string> scheduledActions() { DARABONBA_PTR_GET(scheduledActions_, vector<string>) };
    ...
    inline const vector<string> & scheduledTaskIds() const { DARABONBA_PTR_GET_CONST(scheduledTaskIds_, vector<string>) };
    inline vector<string> scheduledTaskIds() { DARABONBA_PTR_GET(scheduledTaskIds_, vector<string>) };
    ...
    inline const vector<string> & scheduledTaskNames() const { DARABONBA_PTR_GET_CONST(scheduledTaskNames_, vector<string>) };
    inline vector<string> scheduledTaskNames() { DARABONBA_PTR_GET(scheduledTaskNames_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> scheduledActions_ = nullptr;
    // The IDs of the scheduled tasks that you want to query.
    std::shared_ptr<vector<string>> scheduledTaskIds_ = nullptr;
    // The names of the scheduled tasks that you want to query.
    std::shared_ptr<vector<string>> scheduledTaskNames_ = nullptr;
