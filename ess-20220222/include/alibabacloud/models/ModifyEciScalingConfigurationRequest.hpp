...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->acrRegistryInfos_ != nullptr
        ...
        && this->ntpServers_ != nullptr && this->ownerId_ != nullptr && this->ramRoleName_ != nullptr && this->resourceGroupId_ != nullptr && this->resourceOwnerAccount_ != nullptr
        && this->restartPolicy_ != nullptr && this->scalingConfigurationId_ != nullptr && this->scalingConfigurationName_ != nullptr && this->securityContextSysCtls_ != nullptr && this->securityGroupId_ != nullptr
        && this->spotPriceLimit_ != nullptr && this->spotStrategy_ != nullptr && this->tags_ != nullptr && this->terminationGracePeriodSeconds_ != nullptr && this->volumes_ != nullptr; };
