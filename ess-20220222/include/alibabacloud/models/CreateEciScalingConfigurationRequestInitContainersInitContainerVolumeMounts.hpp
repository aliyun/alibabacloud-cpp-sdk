...
#ifndef ALIBABACLOUD_MODELS_CREATEECISCALINGCONFIGURATIONREQUESTINITCONTAINERSINITCONTAINERVOLUMEMOUNTS_HPP_
#define ALIBABACLOUD_MODELS_CREATEECISCALINGCONFIGURATIONREQUESTINITCONTAINERSINITCONTAINERVOLUMEMOUNTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts& obj) { 
    ...
    CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts() = default ;
    CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts(const CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts &) = default ;
    CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts(CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts &&) = default ;
    CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts() = default ;
    CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts& operator=(const CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts &) = default ;
    CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts& operator=(CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts &&) = default ;
    ...
    inline CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts& setMountPath(string mountPath) { DARABONBA_PTR_SET_VALUE(mountPath_, mountPath) };
    ...
    inline CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts& setMountPropagation(string mountPropagation) { DARABONBA_PTR_SET_VALUE(mountPropagation_, mountPropagation) };
    ...
    inline CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts& setReadOnly(bool readOnly) { DARABONBA_PTR_SET_VALUE(readOnly_, readOnly) };
    ...
    inline CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts& setSubPath(string subPath) { DARABONBA_PTR_SET_VALUE(subPath_, subPath) };
