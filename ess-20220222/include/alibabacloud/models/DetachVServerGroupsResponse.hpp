...
namespace Models
{
  ...
  public:
    ...
    inline const DetachVServerGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachVServerGroupsResponseBody) };
    inline DetachVServerGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachVServerGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachVServerGroupsResponseBody> body_ {};
  };
