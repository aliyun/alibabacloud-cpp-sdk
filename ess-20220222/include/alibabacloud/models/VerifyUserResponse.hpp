...
namespace Models
{
  ...
  public:
    ...
    inline const VerifyUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, VerifyUserResponseBody) };
    inline VerifyUserResponseBody getBody() { DARABONBA_PTR_GET(body_, VerifyUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<VerifyUserResponseBody> body_ {};
  };
