...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->onlyCheck_ == nullptr
        && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->uid_ == nullptr; };
