...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyLifecycleHookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyLifecycleHookResponseBody) };
    inline ModifyLifecycleHookResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyLifecycleHookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyLifecycleHookResponseBody> body_ {};
  };
