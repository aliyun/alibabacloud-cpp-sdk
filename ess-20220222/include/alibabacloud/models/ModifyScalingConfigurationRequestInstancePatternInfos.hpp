...
#ifndef ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONREQUESTINSTANCEPATTERNINFOS_HPP_
#define ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONREQUESTINSTANCEPATTERNINFOS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyScalingConfigurationRequestInstancePatternInfos& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyScalingConfigurationRequestInstancePatternInfos& obj) { 
    ...
    ModifyScalingConfigurationRequestInstancePatternInfos() = default ;
    ModifyScalingConfigurationRequestInstancePatternInfos(const ModifyScalingConfigurationRequestInstancePatternInfos &) = default ;
    ModifyScalingConfigurationRequestInstancePatternInfos(ModifyScalingConfigurationRequestInstancePatternInfos &&) = default ;
    ModifyScalingConfigurationRequestInstancePatternInfos(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyScalingConfigurationRequestInstancePatternInfos() = default ;
    ModifyScalingConfigurationRequestInstancePatternInfos& operator=(const ModifyScalingConfigurationRequestInstancePatternInfos &) = default ;
    ModifyScalingConfigurationRequestInstancePatternInfos& operator=(ModifyScalingConfigurationRequestInstancePatternInfos &&) = default ;
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setArchitectures(const vector<string> & architectures) { DARABONBA_PTR_SET_VALUE(architectures_, architectures) };
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setArchitectures(vector<string> && architectures) { DARABONBA_PTR_SET_RVALUE(architectures_, architectures) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setBurstablePerformance(string burstablePerformance) { DARABONBA_PTR_SET_VALUE(burstablePerformance_, burstablePerformance) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setCores(int32_t cores) { DARABONBA_PTR_SET_VALUE(cores_, cores) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setCpuArchitectures(const vector<string> & cpuArchitectures) { DARABONBA_PTR_SET_VALUE(cpuArchitectures_, cpuArchitectures) };
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setCpuArchitectures(vector<string> && cpuArchitectures) { DARABONBA_PTR_SET_RVALUE(cpuArchitectures_, cpuArchitectures) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setExcludedInstanceTypes(const vector<string> & excludedInstanceTypes) { DARABONBA_PTR_SET_VALUE(excludedInstanceTypes_, excludedInstanceTypes) };
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setExcludedInstanceTypes(vector<string> && excludedInstanceTypes) { DARABONBA_PTR_SET_RVALUE(excludedInstanceTypes_, excludedInstanceTypes) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setGpuSpecs(const vector<string> & gpuSpecs) { DARABONBA_PTR_SET_VALUE(gpuSpecs_, gpuSpecs) };
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setGpuSpecs(vector<string> && gpuSpecs) { DARABONBA_PTR_SET_RVALUE(gpuSpecs_, gpuSpecs) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setInstanceCategories(const vector<string> & instanceCategories) { DARABONBA_PTR_SET_VALUE(instanceCategories_, instanceCategories) };
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setInstanceCategories(vector<string> && instanceCategories) { DARABONBA_PTR_SET_RVALUE(instanceCategories_, instanceCategories) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setInstanceFamilyLevel(string instanceFamilyLevel) { DARABONBA_PTR_SET_VALUE(instanceFamilyLevel_, instanceFamilyLevel) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setInstanceTypeFamilies(const vector<string> & instanceTypeFamilies) { DARABONBA_PTR_SET_VALUE(instanceTypeFamilies_, instanceTypeFamilies) };
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setInstanceTypeFamilies(vector<string> && instanceTypeFamilies) { DARABONBA_PTR_SET_RVALUE(instanceTypeFamilies_, instanceTypeFamilies) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMaxPrice(float maxPrice) { DARABONBA_PTR_SET_VALUE(maxPrice_, maxPrice) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMaximumCpuCoreCount(int32_t maximumCpuCoreCount) { DARABONBA_PTR_SET_VALUE(maximumCpuCoreCount_, maximumCpuCoreCount) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMaximumGpuAmount(int32_t maximumGpuAmount) { DARABONBA_PTR_SET_VALUE(maximumGpuAmount_, maximumGpuAmount) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMaximumMemorySize(float maximumMemorySize) { DARABONBA_PTR_SET_VALUE(maximumMemorySize_, maximumMemorySize) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMemory(float memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMinimumBaselineCredit(int32_t minimumBaselineCredit) { DARABONBA_PTR_SET_VALUE(minimumBaselineCredit_, minimumBaselineCredit) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMinimumCpuCoreCount(int32_t minimumCpuCoreCount) { DARABONBA_PTR_SET_VALUE(minimumCpuCoreCount_, minimumCpuCoreCount) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMinimumEniIpv6AddressQuantity(int32_t minimumEniIpv6AddressQuantity) { DARABONBA_PTR_SET_VALUE(minimumEniIpv6AddressQuantity_, minimumEniIpv6AddressQuantity) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMinimumEniPrivateIpAddressQuantity(int32_t minimumEniPrivateIpAddressQuantity) { DARABONBA_PTR_SET_VALUE(minimumEniPrivateIpAddressQuantity_, minimumEniPrivateIpAddressQuantity) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMinimumEniQuantity(int32_t minimumEniQuantity) { DARABONBA_PTR_SET_VALUE(minimumEniQuantity_, minimumEniQuantity) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMinimumGpuAmount(int32_t minimumGpuAmount) { DARABONBA_PTR_SET_VALUE(minimumGpuAmount_, minimumGpuAmount) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMinimumInitialCredit(int32_t minimumInitialCredit) { DARABONBA_PTR_SET_VALUE(minimumInitialCredit_, minimumInitialCredit) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setMinimumMemorySize(float minimumMemorySize) { DARABONBA_PTR_SET_VALUE(minimumMemorySize_, minimumMemorySize) };
    ...
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setPhysicalProcessorModels(const vector<string> & physicalProcessorModels) { DARABONBA_PTR_SET_VALUE(physicalProcessorModels_, physicalProcessorModels) };
    inline ModifyScalingConfigurationRequestInstancePatternInfos& setPhysicalProcessorModels(vector<string> && physicalProcessorModels) { DARABONBA_PTR_SET_RVALUE(physicalProcessorModels_, physicalProcessorModels) };
