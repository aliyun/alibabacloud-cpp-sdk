...
#ifndef ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONSHRINKREQUESTDATADISKS_HPP_
#define ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONSHRINKREQUESTDATADISKS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyScalingConfigurationShrinkRequestDataDisks& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyScalingConfigurationShrinkRequestDataDisks& obj) { 
    ...
    ModifyScalingConfigurationShrinkRequestDataDisks() = default ;
    ModifyScalingConfigurationShrinkRequestDataDisks(const ModifyScalingConfigurationShrinkRequestDataDisks &) = default ;
    ModifyScalingConfigurationShrinkRequestDataDisks(ModifyScalingConfigurationShrinkRequestDataDisks &&) = default ;
    ModifyScalingConfigurationShrinkRequestDataDisks(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyScalingConfigurationShrinkRequestDataDisks() = default ;
    ModifyScalingConfigurationShrinkRequestDataDisks& operator=(const ModifyScalingConfigurationShrinkRequestDataDisks &) = default ;
    ModifyScalingConfigurationShrinkRequestDataDisks& operator=(ModifyScalingConfigurationShrinkRequestDataDisks &&) = default ;
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setAutoSnapshotPolicyId(string autoSnapshotPolicyId) { DARABONBA_PTR_SET_VALUE(autoSnapshotPolicyId_, autoSnapshotPolicyId) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setBurstingEnabled(bool burstingEnabled) { DARABONBA_PTR_SET_VALUE(burstingEnabled_, burstingEnabled) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setCategories(const vector<string> & categories) { DARABONBA_PTR_SET_VALUE(categories_, categories) };
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setCategories(vector<string> && categories) { DARABONBA_PTR_SET_RVALUE(categories_, categories) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setDeleteWithInstance(bool deleteWithInstance) { DARABONBA_PTR_SET_VALUE(deleteWithInstance_, deleteWithInstance) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setDevice(string device) { DARABONBA_PTR_SET_VALUE(device_, device) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setDiskName(string diskName) { DARABONBA_PTR_SET_VALUE(diskName_, diskName) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setEncrypted(string encrypted) { DARABONBA_PTR_SET_VALUE(encrypted_, encrypted) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setKMSKeyId(string KMSKeyId) { DARABONBA_PTR_SET_VALUE(KMSKeyId_, KMSKeyId) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setPerformanceLevel(string performanceLevel) { DARABONBA_PTR_SET_VALUE(performanceLevel_, performanceLevel) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setProvisionedIops(int64_t provisionedIops) { DARABONBA_PTR_SET_VALUE(provisionedIops_, provisionedIops) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setSize(int32_t size) { DARABONBA_PTR_SET_VALUE(size_, size) };
    ...
    inline ModifyScalingConfigurationShrinkRequestDataDisks& setSnapshotId(string snapshotId) { DARABONBA_PTR_SET_VALUE(snapshotId_, snapshotId) };
