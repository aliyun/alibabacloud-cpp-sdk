...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScalingActivitiesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeScalingActivitiesResponseBody) };
    inline DescribeScalingActivitiesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeScalingActivitiesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeScalingActivitiesResponseBody> body_ {};
  };
