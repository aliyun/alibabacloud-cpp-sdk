...
namespace Models
{
  ...
  public:
    ...
    inline const SetGroupDeletionProtectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetGroupDeletionProtectionResponseBody) };
    inline SetGroupDeletionProtectionResponseBody getBody() { DARABONBA_PTR_GET(body_, SetGroupDeletionProtectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetGroupDeletionProtectionResponseBody> body_ {};
  };
