...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->defaultResult_ == nullptr
        && return this->heartbeatTimeout_ == nullptr && return this->lifecycleHookName_ == nullptr && return this->lifecycleTransition_ == nullptr && return this->notificationArn_ == nullptr && return this->notificationMetadata_ == nullptr; };
