...
#ifndef ALIBABACLOUD_MODELS_CREATESCALINGCONFIGURATIONSHRINKREQUESTINSTANCEPATTERNINFOS_HPP_
#define ALIBABACLOUD_MODELS_CREATESCALINGCONFIGURATIONSHRINKREQUESTINSTANCEPATTERNINFOS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateScalingConfigurationShrinkRequestInstancePatternInfos& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateScalingConfigurationShrinkRequestInstancePatternInfos& obj) { 
    ...
    CreateScalingConfigurationShrinkRequestInstancePatternInfos() = default ;
    CreateScalingConfigurationShrinkRequestInstancePatternInfos(const CreateScalingConfigurationShrinkRequestInstancePatternInfos &) = default ;
    CreateScalingConfigurationShrinkRequestInstancePatternInfos(CreateScalingConfigurationShrinkRequestInstancePatternInfos &&) = default ;
    CreateScalingConfigurationShrinkRequestInstancePatternInfos(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateScalingConfigurationShrinkRequestInstancePatternInfos() = default ;
    CreateScalingConfigurationShrinkRequestInstancePatternInfos& operator=(const CreateScalingConfigurationShrinkRequestInstancePatternInfos &) = default ;
    CreateScalingConfigurationShrinkRequestInstancePatternInfos& operator=(CreateScalingConfigurationShrinkRequestInstancePatternInfos &&) = default ;
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setArchitectures(const vector<string> & architectures) { DARABONBA_PTR_SET_VALUE(architectures_, architectures) };
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setArchitectures(vector<string> && architectures) { DARABONBA_PTR_SET_RVALUE(architectures_, architectures) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setBurstablePerformance(string burstablePerformance) { DARABONBA_PTR_SET_VALUE(burstablePerformance_, burstablePerformance) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setCores(int32_t cores) { DARABONBA_PTR_SET_VALUE(cores_, cores) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setCpuArchitectures(const vector<string> & cpuArchitectures) { DARABONBA_PTR_SET_VALUE(cpuArchitectures_, cpuArchitectures) };
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setCpuArchitectures(vector<string> && cpuArchitectures) { DARABONBA_PTR_SET_RVALUE(cpuArchitectures_, cpuArchitectures) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setExcludedInstanceTypes(const vector<string> & excludedInstanceTypes) { DARABONBA_PTR_SET_VALUE(excludedInstanceTypes_, excludedInstanceTypes) };
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setExcludedInstanceTypes(vector<string> && excludedInstanceTypes) { DARABONBA_PTR_SET_RVALUE(excludedInstanceTypes_, excludedInstanceTypes) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setGpuSpecs(const vector<string> & gpuSpecs) { DARABONBA_PTR_SET_VALUE(gpuSpecs_, gpuSpecs) };
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setGpuSpecs(vector<string> && gpuSpecs) { DARABONBA_PTR_SET_RVALUE(gpuSpecs_, gpuSpecs) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setInstanceCategories(const vector<string> & instanceCategories) { DARABONBA_PTR_SET_VALUE(instanceCategories_, instanceCategories) };
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setInstanceCategories(vector<string> && instanceCategories) { DARABONBA_PTR_SET_RVALUE(instanceCategories_, instanceCategories) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setInstanceFamilyLevel(string instanceFamilyLevel) { DARABONBA_PTR_SET_VALUE(instanceFamilyLevel_, instanceFamilyLevel) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setInstanceTypeFamilies(const vector<string> & instanceTypeFamilies) { DARABONBA_PTR_SET_VALUE(instanceTypeFamilies_, instanceTypeFamilies) };
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setInstanceTypeFamilies(vector<string> && instanceTypeFamilies) { DARABONBA_PTR_SET_RVALUE(instanceTypeFamilies_, instanceTypeFamilies) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMaxPrice(float maxPrice) { DARABONBA_PTR_SET_VALUE(maxPrice_, maxPrice) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMaximumCpuCoreCount(int32_t maximumCpuCoreCount) { DARABONBA_PTR_SET_VALUE(maximumCpuCoreCount_, maximumCpuCoreCount) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMaximumGpuAmount(int32_t maximumGpuAmount) { DARABONBA_PTR_SET_VALUE(maximumGpuAmount_, maximumGpuAmount) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMaximumMemorySize(float maximumMemorySize) { DARABONBA_PTR_SET_VALUE(maximumMemorySize_, maximumMemorySize) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMemory(float memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMinimumBaselineCredit(int32_t minimumBaselineCredit) { DARABONBA_PTR_SET_VALUE(minimumBaselineCredit_, minimumBaselineCredit) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMinimumCpuCoreCount(int32_t minimumCpuCoreCount) { DARABONBA_PTR_SET_VALUE(minimumCpuCoreCount_, minimumCpuCoreCount) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMinimumEniIpv6AddressQuantity(int32_t minimumEniIpv6AddressQuantity) { DARABONBA_PTR_SET_VALUE(minimumEniIpv6AddressQuantity_, minimumEniIpv6AddressQuantity) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMinimumEniPrivateIpAddressQuantity(int32_t minimumEniPrivateIpAddressQuantity) { DARABONBA_PTR_SET_VALUE(minimumEniPrivateIpAddressQuantity_, minimumEniPrivateIpAddressQuantity) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMinimumEniQuantity(int32_t minimumEniQuantity) { DARABONBA_PTR_SET_VALUE(minimumEniQuantity_, minimumEniQuantity) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMinimumGpuAmount(int32_t minimumGpuAmount) { DARABONBA_PTR_SET_VALUE(minimumGpuAmount_, minimumGpuAmount) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMinimumInitialCredit(int32_t minimumInitialCredit) { DARABONBA_PTR_SET_VALUE(minimumInitialCredit_, minimumInitialCredit) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setMinimumMemorySize(float minimumMemorySize) { DARABONBA_PTR_SET_VALUE(minimumMemorySize_, minimumMemorySize) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setPhysicalProcessorModels(const vector<string> & physicalProcessorModels) { DARABONBA_PTR_SET_VALUE(physicalProcessorModels_, physicalProcessorModels) };
    inline CreateScalingConfigurationShrinkRequestInstancePatternInfos& setPhysicalProcessorModels(vector<string> && physicalProcessorModels) { DARABONBA_PTR_SET_RVALUE(physicalProcessorModels_, physicalProcessorModels) };
