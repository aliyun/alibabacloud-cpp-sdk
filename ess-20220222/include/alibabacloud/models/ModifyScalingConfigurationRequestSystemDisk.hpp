...
#ifndef ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONREQUESTSYSTEMDISK_HPP_
#define ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONREQUESTSYSTEMDISK_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyScalingConfigurationRequestSystemDisk& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyScalingConfigurationRequestSystemDisk& obj) { 
    ...
    ModifyScalingConfigurationRequestSystemDisk() = default ;
    ModifyScalingConfigurationRequestSystemDisk(const ModifyScalingConfigurationRequestSystemDisk &) = default ;
    ModifyScalingConfigurationRequestSystemDisk(ModifyScalingConfigurationRequestSystemDisk &&) = default ;
    ModifyScalingConfigurationRequestSystemDisk(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyScalingConfigurationRequestSystemDisk() = default ;
    ModifyScalingConfigurationRequestSystemDisk& operator=(const ModifyScalingConfigurationRequestSystemDisk &) = default ;
    ModifyScalingConfigurationRequestSystemDisk& operator=(ModifyScalingConfigurationRequestSystemDisk &&) = default ;
    ...
    inline ModifyScalingConfigurationRequestSystemDisk& setAutoSnapshotPolicyId(string autoSnapshotPolicyId) { DARABONBA_PTR_SET_VALUE(autoSnapshotPolicyId_, autoSnapshotPolicyId) };
    ...
    inline ModifyScalingConfigurationRequestSystemDisk& setBurstingEnabled(bool burstingEnabled) { DARABONBA_PTR_SET_VALUE(burstingEnabled_, burstingEnabled) };
    ...
    inline ModifyScalingConfigurationRequestSystemDisk& setCategory(string category) { DARABONBA_PTR_SET_VALUE(category_, category) };
    ...
    inline ModifyScalingConfigurationRequestSystemDisk& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ModifyScalingConfigurationRequestSystemDisk& setDiskName(string diskName) { DARABONBA_PTR_SET_VALUE(diskName_, diskName) };
    ...
    inline ModifyScalingConfigurationRequestSystemDisk& setEncryptAlgorithm(string encryptAlgorithm) { DARABONBA_PTR_SET_VALUE(encryptAlgorithm_, encryptAlgorithm) };
    ...
    inline ModifyScalingConfigurationRequestSystemDisk& setEncrypted(bool encrypted) { DARABONBA_PTR_SET_VALUE(encrypted_, encrypted) };
    ...
    inline ModifyScalingConfigurationRequestSystemDisk& setKMSKeyId(string KMSKeyId) { DARABONBA_PTR_SET_VALUE(KMSKeyId_, KMSKeyId) };
    ...
    inline ModifyScalingConfigurationRequestSystemDisk& setPerformanceLevel(string performanceLevel) { DARABONBA_PTR_SET_VALUE(performanceLevel_, performanceLevel) };
    ...
    inline ModifyScalingConfigurationRequestSystemDisk& setProvisionedIops(int64_t provisionedIops) { DARABONBA_PTR_SET_VALUE(provisionedIops_, provisionedIops) };
    ...
    inline ModifyScalingConfigurationRequestSystemDisk& setSize(int32_t size) { DARABONBA_PTR_SET_VALUE(size_, size) };
