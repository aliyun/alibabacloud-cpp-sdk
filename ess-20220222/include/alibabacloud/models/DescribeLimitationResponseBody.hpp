...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getMaxNumberOfAlbServerGroup() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfAlbServerGroup_, 0) };
    ...
    inline int32_t getMaxNumberOfDBInstances() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfDBInstances_, 0) };
    ...
    inline int32_t getMaxNumberOfLifecycleHooks() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfLifecycleHooks_, 0) };
    ...
    inline int32_t getMaxNumberOfLoadBalancers() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfLoadBalancers_, 0) };
    ...
    inline int32_t getMaxNumberOfMaxSize() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfMaxSize_, 0) };
    ...
    inline int32_t getMaxNumberOfMinSize() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfMinSize_, 0) };
    ...
    inline int32_t getMaxNumberOfNlbServerGroup() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfNlbServerGroup_, 0) };
    ...
    inline int32_t getMaxNumberOfNotificationConfigurations() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfNotificationConfigurations_, 0) };
    ...
    inline int32_t getMaxNumberOfScalingConfigurations() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfScalingConfigurations_, 0) };
    ...
    inline int32_t getMaxNumberOfScalingGroups() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfScalingGroups_, 0) };
    ...
    inline int32_t getMaxNumberOfScalingInstances() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfScalingInstances_, 0) };
    ...
    inline int32_t getMaxNumberOfScalingRules() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfScalingRules_, 0) };
    ...
    inline int32_t getMaxNumberOfScheduledTasks() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfScheduledTasks_, 0) };
    ...
    inline int32_t getMaxNumberOfVServerGroups() const { DARABONBA_PTR_GET_DEFAULT(maxNumberOfVServerGroups_, 0) };
  ...
  protected:
    ...
    // 
    // >  To view the quota or request a quota increase, go to [Quota Center](https://quotas.console.aliyun.com/products/ess/quotas).
    shared_ptr<int32_t> maxNumberOfLoadBalancers_ {};
    // The maximum number of instances that can be contained in a scaling group.
    // 
    // >  To view the quota or request a quota increase, go to [Quota Center](https://quotas.console.aliyun.com/products/ess/quotas).
    shared_ptr<int32_t> maxNumberOfMaxSize_ {};
