...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->imageOptions_ == nullptr
        ...
        && return this->resourceOwnerAccount_ == nullptr && return this->resourcePoolOptions_ == nullptr && return this->scalingConfigurationName_ == nullptr && return this->scalingGroupId_ == nullptr && return this->schedulerOptionsShrink_ == nullptr
