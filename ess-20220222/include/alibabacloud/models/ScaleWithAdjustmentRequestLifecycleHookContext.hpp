...
namespace Models
{
  ...
  public:
    ...
    inline ScaleWithAdjustmentRequestLifecycleHookContext& setLifecycleHookResult(string lifecycleHookResult) { DARABONBA_PTR_SET_VALUE(lifecycleHookResult_, lifecycleHookResult) };
