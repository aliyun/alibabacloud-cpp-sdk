...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alarmTaskId_ == nullptr
        && return this->alarmTaskName_ == nullptr && return this->comparisonOperator_ == nullptr && return this->dimensions_ == nullptr && return this->evaluationCount_ == nullptr && return this->metricName_ == nullptr
        && return this->metricType_ == nullptr && return this->period_ == nullptr && return this->statistics_ == nullptr && return this->threshold_ == nullptr; };
