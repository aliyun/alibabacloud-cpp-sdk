...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAlarmResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAlarmResponseBody) };
    inline ModifyAlarmResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAlarmResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAlarmResponseBody> body_ {};
  };
