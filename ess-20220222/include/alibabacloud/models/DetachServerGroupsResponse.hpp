...
namespace Models
{
  ...
  public:
    ...
    inline const DetachServerGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachServerGroupsResponseBody) };
    inline DetachServerGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachServerGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachServerGroupsResponseBody> body_ {};
  };
