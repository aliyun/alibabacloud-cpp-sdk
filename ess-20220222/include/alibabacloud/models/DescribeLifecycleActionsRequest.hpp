...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->lifecycleActionStatus_ != nullptr
        && this->maxResults_ != nullptr && this->nextToken_ != nullptr && this->ownerId_ != nullptr && this->regionId_ != nullptr && this->resourceOwnerAccount_ != nullptr
