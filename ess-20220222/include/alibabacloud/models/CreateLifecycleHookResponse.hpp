...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLifecycleHookResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLifecycleHookResponseBody) };
    inline CreateLifecycleHookResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLifecycleHookResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLifecycleHookResponseBody> body_ {};
  };
