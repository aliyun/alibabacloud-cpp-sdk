...
#ifndef ALIBABACLOUD_MODELS_CREATESCALINGCONFIGURATIONSHRINKREQUESTPRIVATEPOOLOPTIONS_HPP_
#define ALIBABACLOUD_MODELS_CREATESCALINGCONFIGURATIONSHRINKREQUESTPRIVATEPOOLOPTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateScalingConfigurationShrinkRequestPrivatePoolOptions& obj) { 
      DARABONBA_PTR_TO_JSON(Id, id_);
      DARABONBA_PTR_TO_JSON(MatchCriteria, matchCriteria_);
    };
    friend void from_json(const Darabonba::Json& j, CreateScalingConfigurationShrinkRequestPrivatePoolOptions& obj) { 
      DARABONBA_PTR_FROM_JSON(Id, id_);
      DARABONBA_PTR_FROM_JSON(MatchCriteria, matchCriteria_);
    };
    CreateScalingConfigurationShrinkRequestPrivatePoolOptions() = default ;
    CreateScalingConfigurationShrinkRequestPrivatePoolOptions(const CreateScalingConfigurationShrinkRequestPrivatePoolOptions &) = default ;
    CreateScalingConfigurationShrinkRequestPrivatePoolOptions(CreateScalingConfigurationShrinkRequestPrivatePoolOptions &&) = default ;
    CreateScalingConfigurationShrinkRequestPrivatePoolOptions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateScalingConfigurationShrinkRequestPrivatePoolOptions() = default ;
    CreateScalingConfigurationShrinkRequestPrivatePoolOptions& operator=(const CreateScalingConfigurationShrinkRequestPrivatePoolOptions &) = default ;
    CreateScalingConfigurationShrinkRequestPrivatePoolOptions& operator=(CreateScalingConfigurationShrinkRequestPrivatePoolOptions &&) = default ;
    ...
    inline CreateScalingConfigurationShrinkRequestPrivatePoolOptions& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline CreateScalingConfigurationShrinkRequestPrivatePoolOptions& setMatchCriteria(string matchCriteria) { DARABONBA_PTR_SET_VALUE(matchCriteria_, matchCriteria) };
