...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNotificationConfigurationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateNotificationConfigurationResponseBody) };
    inline CreateNotificationConfigurationResponseBody body() { DARABONBA_PTR_GET(body_, CreateNotificationConfigurationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateNotificationConfigurationResponseBody> body_ = nullptr;
  };
