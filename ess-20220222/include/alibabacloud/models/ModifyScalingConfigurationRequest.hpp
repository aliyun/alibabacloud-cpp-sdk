...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->imageOptions_ == nullptr
        ...
        && return this->resourcePoolOptions_ == nullptr && return this->scalingConfigurationId_ == nullptr && return this->scalingConfigurationName_ == nullptr && return this->schedulerOptions_ == nullptr && return this->securityGroupId_ == nullptr
    ...
    inline const ModifyScalingConfigurationRequestImageOptions & imageOptions() const { DARABONBA_PTR_GET_CONST(imageOptions_, ModifyScalingConfigurationRequestImageOptions) };
    inline ModifyScalingConfigurationRequestImageOptions imageOptions() { DARABONBA_PTR_GET(imageOptions_, ModifyScalingConfigurationRequestImageOptions) };
    inline ModifyScalingConfigurationRequest& setImageOptions(const ModifyScalingConfigurationRequestImageOptions & imageOptions) { DARABONBA_PTR_SET_VALUE(imageOptions_, imageOptions) };
    inline ModifyScalingConfigurationRequest& setImageOptions(ModifyScalingConfigurationRequestImageOptions && imageOptions) { DARABONBA_PTR_SET_RVALUE(imageOptions_, imageOptions) };


    // privatePoolOptions Field Functions 
    bool hasPrivatePoolOptions() const { return this->privatePoolOptions_ != nullptr;};
    void deletePrivatePoolOptions() { this->privatePoolOptions_ = nullptr;};
    inline const ModifyScalingConfigurationRequestPrivatePoolOptions & privatePoolOptions() const { DARABONBA_PTR_GET_CONST(privatePoolOptions_, ModifyScalingConfigurationRequestPrivatePoolOptions) };
    inline ModifyScalingConfigurationRequestPrivatePoolOptions privatePoolOptions() { DARABONBA_PTR_GET(privatePoolOptions_, ModifyScalingConfigurationRequestPrivatePoolOptions) };
    inline ModifyScalingConfigurationRequest& setPrivatePoolOptions(const ModifyScalingConfigurationRequestPrivatePoolOptions & privatePoolOptions) { DARABONBA_PTR_SET_VALUE(privatePoolOptions_, privatePoolOptions) };
    inline ModifyScalingConfigurationRequest& setPrivatePoolOptions(ModifyScalingConfigurationRequestPrivatePoolOptions && privatePoolOptions) { DARABONBA_PTR_SET_RVALUE(privatePoolOptions_, privatePoolOptions) };


    // systemDisk Field Functions 
    bool hasSystemDisk() const { return this->systemDisk_ != nullptr;};
    void deleteSystemDisk() { this->systemDisk_ = nullptr;};
    inline const ModifyScalingConfigurationRequestSystemDisk & systemDisk() const { DARABONBA_PTR_GET_CONST(systemDisk_, ModifyScalingConfigurationRequestSystemDisk) };
    inline ModifyScalingConfigurationRequestSystemDisk systemDisk() { DARABONBA_PTR_GET(systemDisk_, ModifyScalingConfigurationRequestSystemDisk) };
    inline ModifyScalingConfigurationRequest& setSystemDisk(const ModifyScalingConfigurationRequestSystemDisk & systemDisk) { DARABONBA_PTR_SET_VALUE(systemDisk_, systemDisk) };
    inline ModifyScalingConfigurationRequest& setSystemDisk(ModifyScalingConfigurationRequestSystemDisk && systemDisk) { DARABONBA_PTR_SET_RVALUE(systemDisk_, systemDisk) };
    ...
    inline const vector<ModifyScalingConfigurationRequestCustomPriorities> & customPriorities() const { DARABONBA_PTR_GET_CONST(customPriorities_, vector<ModifyScalingConfigurationRequestCustomPriorities>) };
    inline vector<ModifyScalingConfigurationRequestCustomPriorities> customPriorities() { DARABONBA_PTR_GET(customPriorities_, vector<ModifyScalingConfigurationRequestCustomPriorities>) };
    inline ModifyScalingConfigurationRequest& setCustomPriorities(const vector<ModifyScalingConfigurationRequestCustomPriorities> & customPriorities) { DARABONBA_PTR_SET_VALUE(customPriorities_, customPriorities) };
    inline ModifyScalingConfigurationRequest& setCustomPriorities(vector<ModifyScalingConfigurationRequestCustomPriorities> && customPriorities) { DARABONBA_PTR_SET_RVALUE(customPriorities_, customPriorities) };
    ...
    inline const vector<ModifyScalingConfigurationRequestDataDisks> & dataDisks() const { DARABONBA_PTR_GET_CONST(dataDisks_, vector<ModifyScalingConfigurationRequestDataDisks>) };
    inline vector<ModifyScalingConfigurationRequestDataDisks> dataDisks() { DARABONBA_PTR_GET(dataDisks_, vector<ModifyScalingConfigurationRequestDataDisks>) };
    inline ModifyScalingConfigurationRequest& setDataDisks(const vector<ModifyScalingConfigurationRequestDataDisks> & dataDisks) { DARABONBA_PTR_SET_VALUE(dataDisks_, dataDisks) };
    inline ModifyScalingConfigurationRequest& setDataDisks(vector<ModifyScalingConfigurationRequestDataDisks> && dataDisks) { DARABONBA_PTR_SET_RVALUE(dataDisks_, dataDisks) };
    ...
    inline const vector<ModifyScalingConfigurationRequestInstancePatternInfos> & instancePatternInfos() const { DARABONBA_PTR_GET_CONST(instancePatternInfos_, vector<ModifyScalingConfigurationRequestInstancePatternInfos>) };
    inline vector<ModifyScalingConfigurationRequestInstancePatternInfos> instancePatternInfos() { DARABONBA_PTR_GET(instancePatternInfos_, vector<ModifyScalingConfigurationRequestInstancePatternInfos>) };
    inline ModifyScalingConfigurationRequest& setInstancePatternInfos(const vector<ModifyScalingConfigurationRequestInstancePatternInfos> & instancePatternInfos) { DARABONBA_PTR_SET_VALUE(instancePatternInfos_, instancePatternInfos) };
    inline ModifyScalingConfigurationRequest& setInstancePatternInfos(vector<ModifyScalingConfigurationRequestInstancePatternInfos> && instancePatternInfos) { DARABONBA_PTR_SET_RVALUE(instancePatternInfos_, instancePatternInfos) };
    ...
    inline const vector<ModifyScalingConfigurationRequestInstanceTypeOverrides> & instanceTypeOverrides() const { DARABONBA_PTR_GET_CONST(instanceTypeOverrides_, vector<ModifyScalingConfigurationRequestInstanceTypeOverrides>) };
    inline vector<ModifyScalingConfigurationRequestInstanceTypeOverrides> instanceTypeOverrides() { DARABONBA_PTR_GET(instanceTypeOverrides_, vector<ModifyScalingConfigurationRequestInstanceTypeOverrides>) };
    inline ModifyScalingConfigurationRequest& setInstanceTypeOverrides(const vector<ModifyScalingConfigurationRequestInstanceTypeOverrides> & instanceTypeOverrides) { DARABONBA_PTR_SET_VALUE(instanceTypeOverrides_, instanceTypeOverrides) };
    inline ModifyScalingConfigurationRequest& setInstanceTypeOverrides(vector<ModifyScalingConfigurationRequestInstanceTypeOverrides> && instanceTypeOverrides) { DARABONBA_PTR_SET_RVALUE(instanceTypeOverrides_, instanceTypeOverrides) };
    ...
    inline const vector<ModifyScalingConfigurationRequestNetworkInterfaces> & networkInterfaces() const { DARABONBA_PTR_GET_CONST(networkInterfaces_, vector<ModifyScalingConfigurationRequestNetworkInterfaces>) };
    inline vector<ModifyScalingConfigurationRequestNetworkInterfaces> networkInterfaces() { DARABONBA_PTR_GET(networkInterfaces_, vector<ModifyScalingConfigurationRequestNetworkInterfaces>) };
    inline ModifyScalingConfigurationRequest& setNetworkInterfaces(const vector<ModifyScalingConfigurationRequestNetworkInterfaces> & networkInterfaces) { DARABONBA_PTR_SET_VALUE(networkInterfaces_, networkInterfaces) };
    inline ModifyScalingConfigurationRequest& setNetworkInterfaces(vector<ModifyScalingConfigurationRequestNetworkInterfaces> && networkInterfaces) { DARABONBA_PTR_SET_RVALUE(networkInterfaces_, networkInterfaces) };
    ...
    inline const ModifyScalingConfigurationRequestResourcePoolOptions & resourcePoolOptions() const { DARABONBA_PTR_GET_CONST(resourcePoolOptions_, ModifyScalingConfigurationRequestResourcePoolOptions) };
    inline ModifyScalingConfigurationRequestResourcePoolOptions resourcePoolOptions() { DARABONBA_PTR_GET(resourcePoolOptions_, ModifyScalingConfigurationRequestResourcePoolOptions) };
    inline ModifyScalingConfigurationRequest& setResourcePoolOptions(const ModifyScalingConfigurationRequestResourcePoolOptions & resourcePoolOptions) { DARABONBA_PTR_SET_VALUE(resourcePoolOptions_, resourcePoolOptions) };
    inline ModifyScalingConfigurationRequest& setResourcePoolOptions(ModifyScalingConfigurationRequestResourcePoolOptions && resourcePoolOptions) { DARABONBA_PTR_SET_RVALUE(resourcePoolOptions_, resourcePoolOptions) };
    ...
    inline const ModifyScalingConfigurationRequestSecurityOptions & securityOptions() const { DARABONBA_PTR_GET_CONST(securityOptions_, ModifyScalingConfigurationRequestSecurityOptions) };
    inline ModifyScalingConfigurationRequestSecurityOptions securityOptions() { DARABONBA_PTR_GET(securityOptions_, ModifyScalingConfigurationRequestSecurityOptions) };
    inline ModifyScalingConfigurationRequest& setSecurityOptions(const ModifyScalingConfigurationRequestSecurityOptions & securityOptions) { DARABONBA_PTR_SET_VALUE(securityOptions_, securityOptions) };
    inline ModifyScalingConfigurationRequest& setSecurityOptions(ModifyScalingConfigurationRequestSecurityOptions && securityOptions) { DARABONBA_PTR_SET_RVALUE(securityOptions_, securityOptions) };
    ...
    inline const vector<ModifyScalingConfigurationRequestSpotPriceLimits> & spotPriceLimits() const { DARABONBA_PTR_GET_CONST(spotPriceLimits_, vector<ModifyScalingConfigurationRequestSpotPriceLimits>) };
    inline vector<ModifyScalingConfigurationRequestSpotPriceLimits> spotPriceLimits() { DARABONBA_PTR_GET(spotPriceLimits_, vector<ModifyScalingConfigurationRequestSpotPriceLimits>) };
    inline ModifyScalingConfigurationRequest& setSpotPriceLimits(const vector<ModifyScalingConfigurationRequestSpotPriceLimits> & spotPriceLimits) { DARABONBA_PTR_SET_VALUE(spotPriceLimits_, spotPriceLimits) };
    inline ModifyScalingConfigurationRequest& setSpotPriceLimits(vector<ModifyScalingConfigurationRequestSpotPriceLimits> && spotPriceLimits) { DARABONBA_PTR_SET_RVALUE(spotPriceLimits_, spotPriceLimits) };
  ...
  protected:
    std::shared_ptr<ModifyScalingConfigurationRequestImageOptions> imageOptions_ = nullptr;
    std::shared_ptr<ModifyScalingConfigurationRequestPrivatePoolOptions> privatePoolOptions_ = nullptr;
    std::shared_ptr<ModifyScalingConfigurationRequestSystemDisk> systemDisk_ = nullptr;
    ...
    std::shared_ptr<vector<ModifyScalingConfigurationRequestCustomPriorities>> customPriorities_ = nullptr;
    // The data disks.
    std::shared_ptr<vector<ModifyScalingConfigurationRequestDataDisks>> dataDisks_ = nullptr;
    ...
    std::shared_ptr<vector<ModifyScalingConfigurationRequestInstancePatternInfos>> instancePatternInfos_ = nullptr;
    // The instance types.
    std::shared_ptr<vector<ModifyScalingConfigurationRequestInstanceTypeOverrides>> instanceTypeOverrides_ = nullptr;
    ...
    // The ENIs.
    std::shared_ptr<vector<ModifyScalingConfigurationRequestNetworkInterfaces>> networkInterfaces_ = nullptr;
    ...
    std::shared_ptr<ModifyScalingConfigurationRequestResourcePoolOptions> resourcePoolOptions_ = nullptr;
    ...
    std::shared_ptr<ModifyScalingConfigurationRequestSecurityOptions> securityOptions_ = nullptr;
    ...
    std::shared_ptr<vector<ModifyScalingConfigurationRequestSpotPriceLimits>> spotPriceLimits_ = nullptr;
