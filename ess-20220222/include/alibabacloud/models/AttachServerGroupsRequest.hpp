...
namespace Models
{
  ...
  public:
    ...
    inline const vector<AttachServerGroupsRequest::ServerGroups> & getServerGroups() const { DARABONBA_PTR_GET_CONST(serverGroups_, vector<AttachServerGroupsRequest::ServerGroups>) };
    inline vector<AttachServerGroupsRequest::ServerGroups> getServerGroups() { DARABONBA_PTR_GET(serverGroups_, vector<AttachServerGroupsRequest::ServerGroups>) };
    inline AttachServerGroupsRequest& setServerGroups(const vector<AttachServerGroupsRequest::ServerGroups> & serverGroups) { DARABONBA_PTR_SET_VALUE(serverGroups_, serverGroups) };
    inline AttachServerGroupsRequest& setServerGroups(vector<AttachServerGroupsRequest::ServerGroups> && serverGroups) { DARABONBA_PTR_SET_RVALUE(serverGroups_, serverGroups) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<AttachServerGroupsRequest::ServerGroups>> serverGroups_ {};
  };
