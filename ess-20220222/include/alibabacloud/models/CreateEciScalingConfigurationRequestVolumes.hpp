...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->diskVolume_ == nullptr
        && return this->emptyDirVolume_ == nullptr && return this->flexVolume_ == nullptr && return this->hostPathVolume_ == nullptr && return this->NFSVolume_ == nullptr && return this->configFileVolumeConfigFileToPaths_ == nullptr
