...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->defaultResult_ == nullptr
        ...
        && return this->notificationArn_ == nullptr && return this->notificationMetadata_ == nullptr && return this->ownerAccount_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr
