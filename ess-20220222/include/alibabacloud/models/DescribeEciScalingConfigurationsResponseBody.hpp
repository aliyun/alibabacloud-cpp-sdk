...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEECISCALINGCONFIGURATIONSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEECISCALINGCONFIGURATIONSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeEciScalingConfigurationsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeEciScalingConfigurationsResponseBody& obj) { 
    ...
    DescribeEciScalingConfigurationsResponseBody() = default ;
    DescribeEciScalingConfigurationsResponseBody(const DescribeEciScalingConfigurationsResponseBody &) = default ;
    DescribeEciScalingConfigurationsResponseBody(DescribeEciScalingConfigurationsResponseBody &&) = default ;
    DescribeEciScalingConfigurationsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeEciScalingConfigurationsResponseBody() = default ;
    DescribeEciScalingConfigurationsResponseBody& operator=(const DescribeEciScalingConfigurationsResponseBody &) = default ;
    DescribeEciScalingConfigurationsResponseBody& operator=(DescribeEciScalingConfigurationsResponseBody &&) = default ;
    ...
    public:
      ...
      inline const vector<ScalingConfigurations::AcrRegistryInfos> & getAcrRegistryInfos() const { DARABONBA_PTR_GET_CONST(acrRegistryInfos_, vector<ScalingConfigurations::AcrRegistryInfos>) };
      inline vector<ScalingConfigurations::AcrRegistryInfos> getAcrRegistryInfos() { DARABONBA_PTR_GET(acrRegistryInfos_, vector<ScalingConfigurations::AcrRegistryInfos>) };
      inline ScalingConfigurations& setAcrRegistryInfos(const vector<ScalingConfigurations::AcrRegistryInfos> & acrRegistryInfos) { DARABONBA_PTR_SET_VALUE(acrRegistryInfos_, acrRegistryInfos) };
      inline ScalingConfigurations& setAcrRegistryInfos(vector<ScalingConfigurations::AcrRegistryInfos> && acrRegistryInfos) { DARABONBA_PTR_SET_RVALUE(acrRegistryInfos_, acrRegistryInfos) };
      ...
      inline ScalingConfigurations& setActiveDeadlineSeconds(int32_t activeDeadlineSeconds) { DARABONBA_PTR_SET_VALUE(activeDeadlineSeconds_, activeDeadlineSeconds) };
      ...
      inline ScalingConfigurations& setAutoCreateEip(bool autoCreateEip) { DARABONBA_PTR_SET_VALUE(autoCreateEip_, autoCreateEip) };
      ...
      inline ScalingConfigurations& setAutoMatchImageCache(bool autoMatchImageCache) { DARABONBA_PTR_SET_VALUE(autoMatchImageCache_, autoMatchImageCache) };
      ...
      inline ScalingConfigurations& setContainerGroupName(string containerGroupName) { DARABONBA_PTR_SET_VALUE(containerGroupName_, containerGroupName) };
      ...
      inline const vector<ScalingConfigurations::Containers> & getContainers() const { DARABONBA_PTR_GET_CONST(containers_, vector<ScalingConfigurations::Containers>) };
      inline vector<ScalingConfigurations::Containers> getContainers() { DARABONBA_PTR_GET(containers_, vector<ScalingConfigurations::Containers>) };
      inline ScalingConfigurations& setContainers(const vector<ScalingConfigurations::Containers> & containers) { DARABONBA_PTR_SET_VALUE(containers_, containers) };
      inline ScalingConfigurations& setContainers(vector<ScalingConfigurations::Containers> && containers) { DARABONBA_PTR_SET_RVALUE(containers_, containers) };
      ...
      inline ScalingConfigurations& setCostOptimization(bool costOptimization) { DARABONBA_PTR_SET_VALUE(costOptimization_, costOptimization) };
      ...
      void deleteCpu() { this->cpu_ = nullptr;};
      inline float getCpu() const { DARABONBA_PTR_GET_DEFAULT(cpu_, 0.0) };
      inline ScalingConfigurations& setCpu(float cpu) { DARABONBA_PTR_SET_VALUE(cpu_, cpu) };
      ...
      inline ScalingConfigurations& setCpuOptionsCore(int32_t cpuOptionsCore) { DARABONBA_PTR_SET_VALUE(cpuOptionsCore_, cpuOptionsCore) };
      ...
      inline ScalingConfigurations& setCpuOptionsThreadsPerCore(int32_t cpuOptionsThreadsPerCore) { DARABONBA_PTR_SET_VALUE(cpuOptionsThreadsPerCore_, cpuOptionsThreadsPerCore) };
      ...
      inline ScalingConfigurations& setDataCacheBucket(string dataCacheBucket) { DARABONBA_PTR_SET_VALUE(dataCacheBucket_, dataCacheBucket) };
      ...
      inline ScalingConfigurations& setDataCacheBurstingEnabled(bool dataCacheBurstingEnabled) { DARABONBA_PTR_SET_VALUE(dataCacheBurstingEnabled_, dataCacheBurstingEnabled) };
      ...
      inline ScalingConfigurations& setDataCachePL(string dataCachePL) { DARABONBA_PTR_SET_VALUE(dataCachePL_, dataCachePL) };
      ...
      inline ScalingConfigurations& setDataCacheProvisionedIops(int32_t dataCacheProvisionedIops) { DARABONBA_PTR_SET_VALUE(dataCacheProvisionedIops_, dataCacheProvisionedIops) };
      ...
      inline ScalingConfigurations& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
      ...
      inline ScalingConfigurations& setDnsConfigNameServers(const vector<string> & dnsConfigNameServers) { DARABONBA_PTR_SET_VALUE(dnsConfigNameServers_, dnsConfigNameServers) };
      inline ScalingConfigurations& setDnsConfigNameServers(vector<string> && dnsConfigNameServers) { DARABONBA_PTR_SET_RVALUE(dnsConfigNameServers_, dnsConfigNameServers) };
      ...
      inline const vector<ScalingConfigurations::DnsConfigOptions> & getDnsConfigOptions() const { DARABONBA_PTR_GET_CONST(dnsConfigOptions_, vector<ScalingConfigurations::DnsConfigOptions>) };
      inline vector<ScalingConfigurations::DnsConfigOptions> getDnsConfigOptions() { DARABONBA_PTR_GET(dnsConfigOptions_, vector<ScalingConfigurations::DnsConfigOptions>) };
      inline ScalingConfigurations& setDnsConfigOptions(const vector<ScalingConfigurations::DnsConfigOptions> & dnsConfigOptions) { DARABONBA_PTR_SET_VALUE(dnsConfigOptions_, dnsConfigOptions) };
      inline ScalingConfigurations& setDnsConfigOptions(vector<ScalingConfigurations::DnsConfigOptions> && dnsConfigOptions) { DARABONBA_PTR_SET_RVALUE(dnsConfigOptions_, dnsConfigOptions) };
      ...
      inline ScalingConfigurations& setDnsConfigSearches(const vector<string> & dnsConfigSearches) { DARABONBA_PTR_SET_VALUE(dnsConfigSearches_, dnsConfigSearches) };
      inline ScalingConfigurations& setDnsConfigSearches(vector<string> && dnsConfigSearches) { DARABONBA_PTR_SET_RVALUE(dnsConfigSearches_, dnsConfigSearches) };
      ...
      inline ScalingConfigurations& setDnsPolicy(string dnsPolicy) { DARABONBA_PTR_SET_VALUE(dnsPolicy_, dnsPolicy) };
      ...
      inline ScalingConfigurations& setEgressBandwidth(int64_t egressBandwidth) { DARABONBA_PTR_SET_VALUE(egressBandwidth_, egressBandwidth) };
      ...
      inline ScalingConfigurations& setEipBandwidth(int32_t eipBandwidth) { DARABONBA_PTR_SET_VALUE(eipBandwidth_, eipBandwidth) };
      ...
      inline ScalingConfigurations& setEphemeralStorage(int32_t ephemeralStorage) { DARABONBA_PTR_SET_VALUE(ephemeralStorage_, ephemeralStorage) };
      ...
      inline ScalingConfigurations& setGpuDriverVersion(string gpuDriverVersion) { DARABONBA_PTR_SET_VALUE(gpuDriverVersion_, gpuDriverVersion) };
      ...
      inline const vector<ScalingConfigurations::HostAliases> & getHostAliases() const { DARABONBA_PTR_GET_CONST(hostAliases_, vector<ScalingConfigurations::HostAliases>) };
      inline vector<ScalingConfigurations::HostAliases> getHostAliases() { DARABONBA_PTR_GET(hostAliases_, vector<ScalingConfigurations::HostAliases>) };
      inline ScalingConfigurations& setHostAliases(const vector<ScalingConfigurations::HostAliases> & hostAliases) { DARABONBA_PTR_SET_VALUE(hostAliases_, hostAliases) };
      inline ScalingConfigurations& setHostAliases(vector<ScalingConfigurations::HostAliases> && hostAliases) { DARABONBA_PTR_SET_RVALUE(hostAliases_, hostAliases) };
      ...
      inline const vector<ScalingConfigurations::ImageRegistryCredentials> & getImageRegistryCredentials() const { DARABONBA_PTR_GET_CONST(imageRegistryCredentials_, vector<ScalingConfigurations::ImageRegistryCredentials>) };
      inline vector<ScalingConfigurations::ImageRegistryCredentials> getImageRegistryCredentials() { DARABONBA_PTR_GET(imageRegistryCredentials_, vector<ScalingConfigurations::ImageRegistryCredentials>) };
      inline ScalingConfigurations& setImageRegistryCredentials(const vector<ScalingConfigurations::ImageRegistryCredentials> & imageRegistryCredentials) { DARABONBA_PTR_SET_VALUE(imageRegistryCredentials_, imageRegistryCredentials) };
      inline ScalingConfigurations& setImageRegistryCredentials(vector<ScalingConfigurations::ImageRegistryCredentials> && imageRegistryCredentials) { DARABONBA_PTR_SET_RVALUE(imageRegistryCredentials_, imageRegistryCredentials) };
      ...
      inline ScalingConfigurations& setImageSnapshotId(string imageSnapshotId) { DARABONBA_PTR_SET_VALUE(imageSnapshotId_, imageSnapshotId) };
      ...
      inline ScalingConfigurations& setIngressBandwidth(int64_t ingressBandwidth) { DARABONBA_PTR_SET_VALUE(ingressBandwidth_, ingressBandwidth) };
      ...
      inline const vector<ScalingConfigurations::InitContainers> & getInitContainers() const { DARABONBA_PTR_GET_CONST(initContainers_, vector<ScalingConfigurations::InitContainers>) };
      inline vector<ScalingConfigurations::InitContainers> getInitContainers() { DARABONBA_PTR_GET(initContainers_, vector<ScalingConfigurations::InitContainers>) };
      inline ScalingConfigurations& setInitContainers(const vector<ScalingConfigurations::InitContainers> & initContainers) { DARABONBA_PTR_SET_VALUE(initContainers_, initContainers) };
      inline ScalingConfigurations& setInitContainers(vector<ScalingConfigurations::InitContainers> && initContainers) { DARABONBA_PTR_SET_RVALUE(initContainers_, initContainers) };
      ...
      inline ScalingConfigurations& setInstanceFamilyLevel(string instanceFamilyLevel) { DARABONBA_PTR_SET_VALUE(instanceFamilyLevel_, instanceFamilyLevel) };
      ...
      void deleteMemory() { this->memory_ = nullptr;};
      inline float getMemory() const { DARABONBA_PTR_GET_DEFAULT(memory_, 0.0) };
      inline ScalingConfigurations& setMemory(float memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
      ...
      inline ScalingConfigurations& setNtpServers(const vector<string> & ntpServers) { DARABONBA_PTR_SET_VALUE(ntpServers_, ntpServers) };
      inline ScalingConfigurations& setNtpServers(vector<string> && ntpServers) { DARABONBA_PTR_SET_RVALUE(ntpServers_, ntpServers) };
      ...
      void deleteRegionId() { this->regionId_ = nullptr;};
      inline string getRegionId() const { DARABONBA_PTR_GET_DEFAULT(regionId_, "") };
      inline ScalingConfigurations& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
      ...
      inline ScalingConfigurations& setRestartPolicy(string restartPolicy) { DARABONBA_PTR_SET_VALUE(restartPolicy_, restartPolicy) };
      ...
      inline const vector<ScalingConfigurations::SecurityContextSysCtls> & getSecurityContextSysCtls() const { DARABONBA_PTR_GET_CONST(securityContextSysCtls_, vector<ScalingConfigurations::SecurityContextSysCtls>) };
      inline vector<ScalingConfigurations::SecurityContextSysCtls> getSecurityContextSysCtls() { DARABONBA_PTR_GET(securityContextSysCtls_, vector<ScalingConfigurations::SecurityContextSysCtls>) };
      inline ScalingConfigurations& setSecurityContextSysCtls(const vector<ScalingConfigurations::SecurityContextSysCtls> & securityContextSysCtls) { DARABONBA_PTR_SET_VALUE(securityContextSysCtls_, securityContextSysCtls) };
      inline ScalingConfigurations& setSecurityContextSysCtls(vector<ScalingConfigurations::SecurityContextSysCtls> && securityContextSysCtls) { DARABONBA_PTR_SET_RVALUE(securityContextSysCtls_, securityContextSysCtls) };
      ...
      inline ScalingConfigurations& setSlsEnable(bool slsEnable) { DARABONBA_PTR_SET_VALUE(slsEnable_, slsEnable) };
      ...
      inline ScalingConfigurations& setSpotPriceLimit(float spotPriceLimit) { DARABONBA_PTR_SET_VALUE(spotPriceLimit_, spotPriceLimit) };
      ...
      inline ScalingConfigurations& setTerminationGracePeriodSeconds(int32_t terminationGracePeriodSeconds) { DARABONBA_PTR_SET_VALUE(terminationGracePeriodSeconds_, terminationGracePeriodSeconds) };


      // volumes Field Functions 
      bool hasVolumes() const { return this->volumes_ != nullptr;};
      void deleteVolumes() { this->volumes_ = nullptr;};
      inline const vector<ScalingConfigurations::Volumes> & getVolumes() const { DARABONBA_PTR_GET_CONST(volumes_, vector<ScalingConfigurations::Volumes>) };
      inline vector<ScalingConfigurations::Volumes> getVolumes() { DARABONBA_PTR_GET(volumes_, vector<ScalingConfigurations::Volumes>) };
      inline ScalingConfigurations& setVolumes(const vector<ScalingConfigurations::Volumes> & volumes) { DARABONBA_PTR_SET_VALUE(volumes_, volumes) };
      inline ScalingConfigurations& setVolumes(vector<ScalingConfigurations::Volumes> && volumes) { DARABONBA_PTR_SET_RVALUE(volumes_, volumes) };


    protected:
      // The Container Registry Enterprise Edition instances.
      shared_ptr<vector<ScalingConfigurations::AcrRegistryInfos>> acrRegistryInfos_ {};
      ...
      shared_ptr<vector<ScalingConfigurations::Containers>> containers_ {};
      ...
      shared_ptr<vector<ScalingConfigurations::DnsConfigOptions>> dnsConfigOptions_ {};
      ...
      shared_ptr<vector<ScalingConfigurations::HostAliases>> hostAliases_ {};
      // The hostname series.
      shared_ptr<string> hostName_ {};
      // The information about the image repository.
      shared_ptr<vector<ScalingConfigurations::ImageRegistryCredentials>> imageRegistryCredentials_ {};
      ...
      // The init containers.
      shared_ptr<vector<ScalingConfigurations::InitContainers>> initContainers_ {};
      ...
      shared_ptr<vector<ScalingConfigurations::SecurityContextSysCtls>> securityContextSysCtls_ {};
      ...
      // The volumes.
      shared_ptr<vector<ScalingConfigurations::Volumes>> volumes_ {};
    };
    ...
    inline DescribeEciScalingConfigurationsResponseBody& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline DescribeEciScalingConfigurationsResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline DescribeEciScalingConfigurationsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline const vector<DescribeEciScalingConfigurationsResponseBody::ScalingConfigurations> & getScalingConfigurations() const { DARABONBA_PTR_GET_CONST(scalingConfigurations_, vector<DescribeEciScalingConfigurationsResponseBody::ScalingConfigurations>) };
    inline vector<DescribeEciScalingConfigurationsResponseBody::ScalingConfigurations> getScalingConfigurations() { DARABONBA_PTR_GET(scalingConfigurations_, vector<DescribeEciScalingConfigurationsResponseBody::ScalingConfigurations>) };
    inline DescribeEciScalingConfigurationsResponseBody& setScalingConfigurations(const vector<DescribeEciScalingConfigurationsResponseBody::ScalingConfigurations> & scalingConfigurations) { DARABONBA_PTR_SET_VALUE(scalingConfigurations_, scalingConfigurations) };
    inline DescribeEciScalingConfigurationsResponseBody& setScalingConfigurations(vector<DescribeEciScalingConfigurationsResponseBody::ScalingConfigurations> && scalingConfigurations) { DARABONBA_PTR_SET_RVALUE(scalingConfigurations_, scalingConfigurations) };
    ...
    inline DescribeEciScalingConfigurationsResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeEciScalingConfigurationsResponseBody::ScalingConfigurations>> scalingConfigurations_ {};
