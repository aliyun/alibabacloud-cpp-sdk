...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->lifecycleHookId_ != nullptr
        && this->lifecycleHookName_ != nullptr && this->ownerAccount_ != nullptr && this->ownerId_ != nullptr && this->regionId_ != nullptr && this->resourceOwnerAccount_ != nullptr
