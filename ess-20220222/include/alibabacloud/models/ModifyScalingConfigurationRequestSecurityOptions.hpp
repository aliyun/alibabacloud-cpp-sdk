...
#ifndef ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONREQUESTSECURITYOPTIONS_HPP_
#define ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONREQUESTSECURITYOPTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyScalingConfigurationRequestSecurityOptions& obj) { 
      DARABONBA_PTR_TO_JSON(ConfidentialComputingMode, confidentialComputingMode_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyScalingConfigurationRequestSecurityOptions& obj) { 
      DARABONBA_PTR_FROM_JSON(ConfidentialComputingMode, confidentialComputingMode_);
    };
    ModifyScalingConfigurationRequestSecurityOptions() = default ;
    ModifyScalingConfigurationRequestSecurityOptions(const ModifyScalingConfigurationRequestSecurityOptions &) = default ;
    ModifyScalingConfigurationRequestSecurityOptions(ModifyScalingConfigurationRequestSecurityOptions &&) = default ;
    ModifyScalingConfigurationRequestSecurityOptions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyScalingConfigurationRequestSecurityOptions() = default ;
    ModifyScalingConfigurationRequestSecurityOptions& operator=(const ModifyScalingConfigurationRequestSecurityOptions &) = default ;
    ModifyScalingConfigurationRequestSecurityOptions& operator=(ModifyScalingConfigurationRequestSecurityOptions &&) = default ;
    ...
    inline ModifyScalingConfigurationRequestSecurityOptions& setConfidentialComputingMode(string confidentialComputingMode) { DARABONBA_PTR_SET_VALUE(confidentialComputingMode_, confidentialComputingMode) };
