...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->breachThreshold_ == nullptr
        && this->clientToken_ == nullptr && this->metricValue_ == nullptr && this->ownerAccount_ == nullptr && this->ownerId_ == nullptr && this->regionId_ == nullptr
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->scalingRuleAri_ == nullptr; };
    ...
    inline float getBreachThreshold() const { DARABONBA_PTR_GET_DEFAULT(breachThreshold_, 0.0) };
    ...
    inline float getMetricValue() const { DARABONBA_PTR_GET_DEFAULT(metricValue_, 0.0) };
  ...
  protected:
    ...
    shared_ptr<float> breachThreshold_ {};
