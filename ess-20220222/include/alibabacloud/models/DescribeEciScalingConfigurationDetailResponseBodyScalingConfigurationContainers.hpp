...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEECISCALINGCONFIGURATIONDETAILRESPONSEBODYSCALINGCONFIGURATIONCONTAINERS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEECISCALINGCONFIGURATIONDETAILRESPONSEBODYSCALINGCONFIGURATIONCONTAINERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& obj) { 
    ...
    DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers() = default ;
    DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers(const DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers &) = default ;
    DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers(DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers &&) = default ;
    DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers() = default ;
    DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& operator=(const DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers &) = default ;
    DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& operator=(DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers &&) = default ;
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setArgs(const vector<string> & args) { DARABONBA_PTR_SET_VALUE(args_, args) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setArgs(vector<string> && args) { DARABONBA_PTR_SET_RVALUE(args_, args) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setCommands(const vector<string> & commands) { DARABONBA_PTR_SET_VALUE(commands_, commands) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setCommands(vector<string> && commands) { DARABONBA_PTR_SET_RVALUE(commands_, commands) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setCpu(float cpu) { DARABONBA_PTR_SET_VALUE(cpu_, cpu) };
    ...
    inline const vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersEnvironmentVars> & environmentVars() const { DARABONBA_PTR_GET_CONST(environmentVars_, vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersEnvironmentVars>) };
    inline vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersEnvironmentVars> environmentVars() { DARABONBA_PTR_GET(environmentVars_, vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersEnvironmentVars>) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setEnvironmentVars(const vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersEnvironmentVars> & environmentVars) { DARABONBA_PTR_SET_VALUE(environmentVars_, environmentVars) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setEnvironmentVars(vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersEnvironmentVars> && environmentVars) { DARABONBA_PTR_SET_RVALUE(environmentVars_, environmentVars) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setGpu(int32_t gpu) { DARABONBA_PTR_SET_VALUE(gpu_, gpu) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setImage(string image) { DARABONBA_PTR_SET_VALUE(image_, image) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setImagePullPolicy(string imagePullPolicy) { DARABONBA_PTR_SET_VALUE(imagePullPolicy_, imagePullPolicy) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePostStartHandlerExecs(const vector<string> & lifecyclePostStartHandlerExecs) { DARABONBA_PTR_SET_VALUE(lifecyclePostStartHandlerExecs_, lifecyclePostStartHandlerExecs) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePostStartHandlerExecs(vector<string> && lifecyclePostStartHandlerExecs) { DARABONBA_PTR_SET_RVALUE(lifecyclePostStartHandlerExecs_, lifecyclePostStartHandlerExecs) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePostStartHandlerHttpGetHost(string lifecyclePostStartHandlerHttpGetHost) { DARABONBA_PTR_SET_VALUE(lifecyclePostStartHandlerHttpGetHost_, lifecyclePostStartHandlerHttpGetHost) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePostStartHandlerHttpGetPath(string lifecyclePostStartHandlerHttpGetPath) { DARABONBA_PTR_SET_VALUE(lifecyclePostStartHandlerHttpGetPath_, lifecyclePostStartHandlerHttpGetPath) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePostStartHandlerHttpGetPort(int32_t lifecyclePostStartHandlerHttpGetPort) { DARABONBA_PTR_SET_VALUE(lifecyclePostStartHandlerHttpGetPort_, lifecyclePostStartHandlerHttpGetPort) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePostStartHandlerHttpGetScheme(string lifecyclePostStartHandlerHttpGetScheme) { DARABONBA_PTR_SET_VALUE(lifecyclePostStartHandlerHttpGetScheme_, lifecyclePostStartHandlerHttpGetScheme) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePostStartHandlerTcpSocketHost(string lifecyclePostStartHandlerTcpSocketHost) { DARABONBA_PTR_SET_VALUE(lifecyclePostStartHandlerTcpSocketHost_, lifecyclePostStartHandlerTcpSocketHost) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePostStartHandlerTcpSocketPort(int32_t lifecyclePostStartHandlerTcpSocketPort) { DARABONBA_PTR_SET_VALUE(lifecyclePostStartHandlerTcpSocketPort_, lifecyclePostStartHandlerTcpSocketPort) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePreStopHandlerExecs(const vector<string> & lifecyclePreStopHandlerExecs) { DARABONBA_PTR_SET_VALUE(lifecyclePreStopHandlerExecs_, lifecyclePreStopHandlerExecs) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePreStopHandlerExecs(vector<string> && lifecyclePreStopHandlerExecs) { DARABONBA_PTR_SET_RVALUE(lifecyclePreStopHandlerExecs_, lifecyclePreStopHandlerExecs) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePreStopHandlerHttpGetHost(string lifecyclePreStopHandlerHttpGetHost) { DARABONBA_PTR_SET_VALUE(lifecyclePreStopHandlerHttpGetHost_, lifecyclePreStopHandlerHttpGetHost) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePreStopHandlerHttpGetPath(string lifecyclePreStopHandlerHttpGetPath) { DARABONBA_PTR_SET_VALUE(lifecyclePreStopHandlerHttpGetPath_, lifecyclePreStopHandlerHttpGetPath) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePreStopHandlerHttpGetPort(int32_t lifecyclePreStopHandlerHttpGetPort) { DARABONBA_PTR_SET_VALUE(lifecyclePreStopHandlerHttpGetPort_, lifecyclePreStopHandlerHttpGetPort) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePreStopHandlerHttpGetScheme(string lifecyclePreStopHandlerHttpGetScheme) { DARABONBA_PTR_SET_VALUE(lifecyclePreStopHandlerHttpGetScheme_, lifecyclePreStopHandlerHttpGetScheme) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePreStopHandlerTcpSocketHost(string lifecyclePreStopHandlerTcpSocketHost) { DARABONBA_PTR_SET_VALUE(lifecyclePreStopHandlerTcpSocketHost_, lifecyclePreStopHandlerTcpSocketHost) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLifecyclePreStopHandlerTcpSocketPort(int32_t lifecyclePreStopHandlerTcpSocketPort) { DARABONBA_PTR_SET_VALUE(lifecyclePreStopHandlerTcpSocketPort_, lifecyclePreStopHandlerTcpSocketPort) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLivenessProbeExecCommands(const vector<string> & livenessProbeExecCommands) { DARABONBA_PTR_SET_VALUE(livenessProbeExecCommands_, livenessProbeExecCommands) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLivenessProbeExecCommands(vector<string> && livenessProbeExecCommands) { DARABONBA_PTR_SET_RVALUE(livenessProbeExecCommands_, livenessProbeExecCommands) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLivenessProbeFailureThreshold(int32_t livenessProbeFailureThreshold) { DARABONBA_PTR_SET_VALUE(livenessProbeFailureThreshold_, livenessProbeFailureThreshold) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLivenessProbeHttpGetPath(string livenessProbeHttpGetPath) { DARABONBA_PTR_SET_VALUE(livenessProbeHttpGetPath_, livenessProbeHttpGetPath) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLivenessProbeHttpGetPort(int32_t livenessProbeHttpGetPort) { DARABONBA_PTR_SET_VALUE(livenessProbeHttpGetPort_, livenessProbeHttpGetPort) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLivenessProbeHttpGetScheme(string livenessProbeHttpGetScheme) { DARABONBA_PTR_SET_VALUE(livenessProbeHttpGetScheme_, livenessProbeHttpGetScheme) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLivenessProbeInitialDelaySeconds(int32_t livenessProbeInitialDelaySeconds) { DARABONBA_PTR_SET_VALUE(livenessProbeInitialDelaySeconds_, livenessProbeInitialDelaySeconds) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLivenessProbePeriodSeconds(int32_t livenessProbePeriodSeconds) { DARABONBA_PTR_SET_VALUE(livenessProbePeriodSeconds_, livenessProbePeriodSeconds) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLivenessProbeSuccessThreshold(int32_t livenessProbeSuccessThreshold) { DARABONBA_PTR_SET_VALUE(livenessProbeSuccessThreshold_, livenessProbeSuccessThreshold) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLivenessProbeTcpSocketPort(int32_t livenessProbeTcpSocketPort) { DARABONBA_PTR_SET_VALUE(livenessProbeTcpSocketPort_, livenessProbeTcpSocketPort) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setLivenessProbeTimeoutSeconds(int32_t livenessProbeTimeoutSeconds) { DARABONBA_PTR_SET_VALUE(livenessProbeTimeoutSeconds_, livenessProbeTimeoutSeconds) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setMemory(float memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };


    // ports Field Functions 
    bool hasPorts() const { return this->ports_ != nullptr;};
    void deletePorts() { this->ports_ = nullptr;};
    inline const vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersPorts> & ports() const { DARABONBA_PTR_GET_CONST(ports_, vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersPorts>) };
    inline vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersPorts> ports() { DARABONBA_PTR_GET(ports_, vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersPorts>) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setPorts(const vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersPorts> & ports) { DARABONBA_PTR_SET_VALUE(ports_, ports) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setPorts(vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersPorts> && ports) { DARABONBA_PTR_SET_RVALUE(ports_, ports) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setReadinessProbeExecCommands(const vector<string> & readinessProbeExecCommands) { DARABONBA_PTR_SET_VALUE(readinessProbeExecCommands_, readinessProbeExecCommands) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setReadinessProbeExecCommands(vector<string> && readinessProbeExecCommands) { DARABONBA_PTR_SET_RVALUE(readinessProbeExecCommands_, readinessProbeExecCommands) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setReadinessProbeFailureThreshold(int32_t readinessProbeFailureThreshold) { DARABONBA_PTR_SET_VALUE(readinessProbeFailureThreshold_, readinessProbeFailureThreshold) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setReadinessProbeHttpGetPath(string readinessProbeHttpGetPath) { DARABONBA_PTR_SET_VALUE(readinessProbeHttpGetPath_, readinessProbeHttpGetPath) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setReadinessProbeHttpGetPort(int32_t readinessProbeHttpGetPort) { DARABONBA_PTR_SET_VALUE(readinessProbeHttpGetPort_, readinessProbeHttpGetPort) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setReadinessProbeHttpGetScheme(string readinessProbeHttpGetScheme) { DARABONBA_PTR_SET_VALUE(readinessProbeHttpGetScheme_, readinessProbeHttpGetScheme) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setReadinessProbeInitialDelaySeconds(int32_t readinessProbeInitialDelaySeconds) { DARABONBA_PTR_SET_VALUE(readinessProbeInitialDelaySeconds_, readinessProbeInitialDelaySeconds) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setReadinessProbePeriodSeconds(int32_t readinessProbePeriodSeconds) { DARABONBA_PTR_SET_VALUE(readinessProbePeriodSeconds_, readinessProbePeriodSeconds) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setReadinessProbeSuccessThreshold(int32_t readinessProbeSuccessThreshold) { DARABONBA_PTR_SET_VALUE(readinessProbeSuccessThreshold_, readinessProbeSuccessThreshold) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setReadinessProbeTcpSocketPort(int32_t readinessProbeTcpSocketPort) { DARABONBA_PTR_SET_VALUE(readinessProbeTcpSocketPort_, readinessProbeTcpSocketPort) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setReadinessProbeTimeoutSeconds(int32_t readinessProbeTimeoutSeconds) { DARABONBA_PTR_SET_VALUE(readinessProbeTimeoutSeconds_, readinessProbeTimeoutSeconds) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setSecurityContextCapabilityAdds(const vector<string> & securityContextCapabilityAdds) { DARABONBA_PTR_SET_VALUE(securityContextCapabilityAdds_, securityContextCapabilityAdds) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setSecurityContextCapabilityAdds(vector<string> && securityContextCapabilityAdds) { DARABONBA_PTR_SET_RVALUE(securityContextCapabilityAdds_, securityContextCapabilityAdds) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setSecurityContextReadOnlyRootFilesystem(bool securityContextReadOnlyRootFilesystem) { DARABONBA_PTR_SET_VALUE(securityContextReadOnlyRootFilesystem_, securityContextReadOnlyRootFilesystem) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setSecurityContextRunAsUser(int64_t securityContextRunAsUser) { DARABONBA_PTR_SET_VALUE(securityContextRunAsUser_, securityContextRunAsUser) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setStdin(bool stdin) { DARABONBA_PTR_SET_VALUE(stdin_, stdin) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setStdinOnce(bool stdinOnce) { DARABONBA_PTR_SET_VALUE(stdinOnce_, stdinOnce) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setTty(bool tty) { DARABONBA_PTR_SET_VALUE(tty_, tty) };
    ...
    inline const vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersVolumeMounts> & volumeMounts() const { DARABONBA_PTR_GET_CONST(volumeMounts_, vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersVolumeMounts>) };
    inline vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersVolumeMounts> volumeMounts() { DARABONBA_PTR_GET(volumeMounts_, vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersVolumeMounts>) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setVolumeMounts(const vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersVolumeMounts> & volumeMounts) { DARABONBA_PTR_SET_VALUE(volumeMounts_, volumeMounts) };
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setVolumeMounts(vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersVolumeMounts> && volumeMounts) { DARABONBA_PTR_SET_RVALUE(volumeMounts_, volumeMounts) };
    ...
    inline DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainers& setWorkingDir(string workingDir) { DARABONBA_PTR_SET_VALUE(workingDir_, workingDir) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersEnvironmentVars>> environmentVars_ = nullptr;
    // The number of GPUs.
    ...
    std::shared_ptr<vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersPorts>> ports_ = nullptr;
    ...
    std::shared_ptr<vector<Models::DescribeEciScalingConfigurationDetailResponseBodyScalingConfigurationContainersVolumeMounts>> volumeMounts_ = nullptr;
