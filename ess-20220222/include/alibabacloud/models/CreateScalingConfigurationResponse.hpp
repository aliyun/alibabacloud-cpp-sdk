...
namespace Models
{
  ...
  public:
    ...
    inline const CreateScalingConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateScalingConfigurationResponseBody) };
    inline CreateScalingConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateScalingConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateScalingConfigurationResponseBody> body_ {};
  };
