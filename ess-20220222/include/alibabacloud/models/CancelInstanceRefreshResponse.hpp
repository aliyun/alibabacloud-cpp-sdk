...
namespace Models
{
  ...
  public:
    ...
    inline const CancelInstanceRefreshResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CancelInstanceRefreshResponseBody) };
    inline CancelInstanceRefreshResponseBody body() { DARABONBA_PTR_GET(body_, CancelInstanceRefreshResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CancelInstanceRefreshResponseBody> body_ = nullptr;
  };
