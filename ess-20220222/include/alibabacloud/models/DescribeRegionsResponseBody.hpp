...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->classicUnavailable_ == nullptr
      ...
      inline bool getClassicUnavailable() const { DARABONBA_PTR_GET_DEFAULT(classicUnavailable_, false) };
      inline Regions& setClassicUnavailable(bool classicUnavailable) { DARABONBA_PTR_SET_VALUE(classicUnavailable_, classicUnavailable) };
      ...
      inline bool getVpcUnavailable() const { DARABONBA_PTR_GET_DEFAULT(vpcUnavailable_, false) };
      inline Regions& setVpcUnavailable(bool vpcUnavailable) { DARABONBA_PTR_SET_VALUE(vpcUnavailable_, vpcUnavailable) };
    ...
    protected:
      ...
      // *   true
      // *   false
      shared_ptr<bool> classicUnavailable_ {};
      // The region name.
      ...
      // *   true
      // *   false
      shared_ptr<bool> vpcUnavailable_ {};
    };
