...
#ifndef ALIBABACLOUD_MODELS_CREATESCALINGCONFIGURATIONSHRINKREQUESTRESOURCEPOOLOPTIONS_HPP_
#define ALIBABACLOUD_MODELS_CREATESCALINGCONFIGURATIONSHRINKREQUESTRESOURCEPOOLOPTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateScalingConfigurationShrinkRequestResourcePoolOptions& obj) { 
      DARABONBA_PTR_TO_JSON(PrivatePoolIds, privatePoolIds_);
      DARABONBA_PTR_TO_JSON(Strategy, strategy_);
    };
    friend void from_json(const Darabonba::Json& j, CreateScalingConfigurationShrinkRequestResourcePoolOptions& obj) { 
      DARABONBA_PTR_FROM_JSON(PrivatePoolIds, privatePoolIds_);
      DARABONBA_PTR_FROM_JSON(Strategy, strategy_);
    };
    CreateScalingConfigurationShrinkRequestResourcePoolOptions() = default ;
    CreateScalingConfigurationShrinkRequestResourcePoolOptions(const CreateScalingConfigurationShrinkRequestResourcePoolOptions &) = default ;
    CreateScalingConfigurationShrinkRequestResourcePoolOptions(CreateScalingConfigurationShrinkRequestResourcePoolOptions &&) = default ;
    CreateScalingConfigurationShrinkRequestResourcePoolOptions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateScalingConfigurationShrinkRequestResourcePoolOptions() = default ;
    CreateScalingConfigurationShrinkRequestResourcePoolOptions& operator=(const CreateScalingConfigurationShrinkRequestResourcePoolOptions &) = default ;
    CreateScalingConfigurationShrinkRequestResourcePoolOptions& operator=(CreateScalingConfigurationShrinkRequestResourcePoolOptions &&) = default ;
    ...
    inline CreateScalingConfigurationShrinkRequestResourcePoolOptions& setPrivatePoolIds(const vector<string> & privatePoolIds) { DARABONBA_PTR_SET_VALUE(privatePoolIds_, privatePoolIds) };
    inline CreateScalingConfigurationShrinkRequestResourcePoolOptions& setPrivatePoolIds(vector<string> && privatePoolIds) { DARABONBA_PTR_SET_RVALUE(privatePoolIds_, privatePoolIds) };
    ...
    inline CreateScalingConfigurationShrinkRequestResourcePoolOptions& setStrategy(string strategy) { DARABONBA_PTR_SET_VALUE(strategy_, strategy) };
