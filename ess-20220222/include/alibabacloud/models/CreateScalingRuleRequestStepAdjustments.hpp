...
#ifndef ALIBABACLOUD_MODELS_CREATESCALINGRULEREQUESTSTEPADJUSTMENTS_HPP_
#define ALIBABACLOUD_MODELS_CREATESCALINGRULEREQUESTSTEPADJUSTMENTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateScalingRuleRequestStepAdjustments& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateScalingRuleRequestStepAdjustments& obj) { 
    ...
    CreateScalingRuleRequestStepAdjustments() = default ;
    CreateScalingRuleRequestStepAdjustments(const CreateScalingRuleRequestStepAdjustments &) = default ;
    CreateScalingRuleRequestStepAdjustments(CreateScalingRuleRequestStepAdjustments &&) = default ;
    CreateScalingRuleRequestStepAdjustments(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateScalingRuleRequestStepAdjustments() = default ;
    CreateScalingRuleRequestStepAdjustments& operator=(const CreateScalingRuleRequestStepAdjustments &) = default ;
    CreateScalingRuleRequestStepAdjustments& operator=(CreateScalingRuleRequestStepAdjustments &&) = default ;
    ...
    inline CreateScalingRuleRequestStepAdjustments& setMetricIntervalLowerBound(float metricIntervalLowerBound) { DARABONBA_PTR_SET_VALUE(metricIntervalLowerBound_, metricIntervalLowerBound) };
    ...
    inline CreateScalingRuleRequestStepAdjustments& setMetricIntervalUpperBound(float metricIntervalUpperBound) { DARABONBA_PTR_SET_VALUE(metricIntervalUpperBound_, metricIntervalUpperBound) };
    ...
    inline CreateScalingRuleRequestStepAdjustments& setScalingAdjustment(int32_t scalingAdjustment) { DARABONBA_PTR_SET_VALUE(scalingAdjustment_, scalingAdjustment) };
