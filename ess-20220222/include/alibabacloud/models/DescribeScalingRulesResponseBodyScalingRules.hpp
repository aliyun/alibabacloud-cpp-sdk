...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adjustmentType_ == nullptr
        && return this->adjustmentValue_ == nullptr && return this->alarmDimensions_ == nullptr && return this->alarms_ == nullptr && return this->cooldown_ == nullptr && return this->disableScaleIn_ == nullptr
        && return this->estimatedInstanceWarmup_ == nullptr && return this->hybridMetrics_ == nullptr && return this->hybridMonitorNamespace_ == nullptr && return this->initialMaxSize_ == nullptr && return this->maxSize_ == nullptr
        && return this->metricName_ == nullptr && return this->metricType_ == nullptr && return this->minAdjustmentMagnitude_ == nullptr && return this->minSize_ == nullptr && return this->predictiveScalingMode_ == nullptr
        && return this->predictiveTaskBufferTime_ == nullptr && return this->predictiveValueBehavior_ == nullptr && return this->predictiveValueBuffer_ == nullptr && return this->scaleInEvaluationCount_ == nullptr && return this->scaleOutEvaluationCount_ == nullptr
        && return this->scalingGroupId_ == nullptr && return this->scalingRuleAri_ == nullptr && return this->scalingRuleId_ == nullptr && return this->scalingRuleName_ == nullptr && return this->scalingRuleType_ == nullptr
