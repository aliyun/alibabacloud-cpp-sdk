...
namespace Models
{
  ...
  public:
    ...
    inline const RebalanceInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RebalanceInstancesResponseBody) };
    inline RebalanceInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, RebalanceInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RebalanceInstancesResponseBody> body_ {};
  };
