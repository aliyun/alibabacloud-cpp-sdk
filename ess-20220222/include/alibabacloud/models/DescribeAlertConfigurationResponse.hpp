...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAlertConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAlertConfigurationResponseBody) };
    inline DescribeAlertConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAlertConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAlertConfigurationResponseBody> body_ {};
  };
