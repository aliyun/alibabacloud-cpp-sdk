...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteScalingConfigurationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteScalingConfigurationResponseBody) };
    inline DeleteScalingConfigurationResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteScalingConfigurationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteScalingConfigurationResponseBody> body_ {};
  };
