...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->DBInstances_ == nullptr && this->forceDetach_ == nullptr && this->ownerId_ == nullptr && this->regionId_ == nullptr && this->removeSecurityGroup_ == nullptr
    ...
    inline bool getRemoveSecurityGroup() const { DARABONBA_PTR_GET_DEFAULT(removeSecurityGroup_, false) };
  ...
  protected:
    ...
    // 
    // Default value: false.
    shared_ptr<bool> removeSecurityGroup_ {};
