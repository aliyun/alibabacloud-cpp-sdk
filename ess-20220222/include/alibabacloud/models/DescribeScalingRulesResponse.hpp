...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScalingRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeScalingRulesResponseBody) };
    inline DescribeScalingRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeScalingRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeScalingRulesResponseBody> body_ {};
  };
