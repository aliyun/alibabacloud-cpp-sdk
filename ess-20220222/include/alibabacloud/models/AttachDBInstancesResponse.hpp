...
namespace Models
{
  ...
  public:
    ...
    inline const AttachDBInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachDBInstancesResponseBody) };
    inline AttachDBInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachDBInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachDBInstancesResponseBody> body_ {};
  };
