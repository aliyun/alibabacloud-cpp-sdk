...
#ifndef ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONSHRINKREQUESTRESOURCEPOOLOPTIONS_HPP_
#define ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONSHRINKREQUESTRESOURCEPOOLOPTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyScalingConfigurationShrinkRequestResourcePoolOptions& obj) { 
      DARABONBA_PTR_TO_JSON(PrivatePoolIds, privatePoolIds_);
      DARABONBA_PTR_TO_JSON(Strategy, strategy_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyScalingConfigurationShrinkRequestResourcePoolOptions& obj) { 
      DARABONBA_PTR_FROM_JSON(PrivatePoolIds, privatePoolIds_);
      DARABONBA_PTR_FROM_JSON(Strategy, strategy_);
    };
    ModifyScalingConfigurationShrinkRequestResourcePoolOptions() = default ;
    ModifyScalingConfigurationShrinkRequestResourcePoolOptions(const ModifyScalingConfigurationShrinkRequestResourcePoolOptions &) = default ;
    ModifyScalingConfigurationShrinkRequestResourcePoolOptions(ModifyScalingConfigurationShrinkRequestResourcePoolOptions &&) = default ;
    ModifyScalingConfigurationShrinkRequestResourcePoolOptions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyScalingConfigurationShrinkRequestResourcePoolOptions() = default ;
    ModifyScalingConfigurationShrinkRequestResourcePoolOptions& operator=(const ModifyScalingConfigurationShrinkRequestResourcePoolOptions &) = default ;
    ModifyScalingConfigurationShrinkRequestResourcePoolOptions& operator=(ModifyScalingConfigurationShrinkRequestResourcePoolOptions &&) = default ;
    ...
    inline ModifyScalingConfigurationShrinkRequestResourcePoolOptions& setPrivatePoolIds(const vector<string> & privatePoolIds) { DARABONBA_PTR_SET_VALUE(privatePoolIds_, privatePoolIds) };
    inline ModifyScalingConfigurationShrinkRequestResourcePoolOptions& setPrivatePoolIds(vector<string> && privatePoolIds) { DARABONBA_PTR_SET_RVALUE(privatePoolIds_, privatePoolIds) };
    ...
    inline ModifyScalingConfigurationShrinkRequestResourcePoolOptions& setStrategy(string strategy) { DARABONBA_PTR_SET_VALUE(strategy_, strategy) };
