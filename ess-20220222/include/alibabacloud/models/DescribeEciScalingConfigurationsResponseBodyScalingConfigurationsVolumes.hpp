...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEECISCALINGCONFIGURATIONSRESPONSEBODYSCALINGCONFIGURATIONSVOLUMES_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEECISCALINGCONFIGURATIONSRESPONSEBODYSCALINGCONFIGURATIONSVOLUMES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& obj) { 
    ...
    DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes() = default ;
    DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes(const DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes &) = default ;
    DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes(DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes &&) = default ;
    DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes() = default ;
    DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& operator=(const DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes &) = default ;
    DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& operator=(DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes &&) = default ;
    ...
    inline const vector<Models::DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumesConfigFileVolumeConfigFileToPaths> & configFileVolumeConfigFileToPaths() const { DARABONBA_PTR_GET_CONST(configFileVolumeConfigFileToPaths_, vector<Models::DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumesConfigFileVolumeConfigFileToPaths>) };
    inline vector<Models::DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumesConfigFileVolumeConfigFileToPaths> configFileVolumeConfigFileToPaths() { DARABONBA_PTR_GET(configFileVolumeConfigFileToPaths_, vector<Models::DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumesConfigFileVolumeConfigFileToPaths>) };
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setConfigFileVolumeConfigFileToPaths(const vector<Models::DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumesConfigFileVolumeConfigFileToPaths> & configFileVolumeConfigFileToPaths) { DARABONBA_PTR_SET_VALUE(configFileVolumeConfigFileToPaths_, configFileVolumeConfigFileToPaths) };
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setConfigFileVolumeConfigFileToPaths(vector<Models::DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumesConfigFileVolumeConfigFileToPaths> && configFileVolumeConfigFileToPaths) { DARABONBA_PTR_SET_RVALUE(configFileVolumeConfigFileToPaths_, configFileVolumeConfigFileToPaths) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setConfigFileVolumeDefaultMode(int32_t configFileVolumeDefaultMode) { DARABONBA_PTR_SET_VALUE(configFileVolumeDefaultMode_, configFileVolumeDefaultMode) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setDiskVolumeDiskId(string diskVolumeDiskId) { DARABONBA_PTR_SET_VALUE(diskVolumeDiskId_, diskVolumeDiskId) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setDiskVolumeDiskSize(int32_t diskVolumeDiskSize) { DARABONBA_PTR_SET_VALUE(diskVolumeDiskSize_, diskVolumeDiskSize) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setDiskVolumeFsType(string diskVolumeFsType) { DARABONBA_PTR_SET_VALUE(diskVolumeFsType_, diskVolumeFsType) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setEmptyDirVolumeMedium(string emptyDirVolumeMedium) { DARABONBA_PTR_SET_VALUE(emptyDirVolumeMedium_, emptyDirVolumeMedium) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setEmptyDirVolumeSizeLimit(string emptyDirVolumeSizeLimit) { DARABONBA_PTR_SET_VALUE(emptyDirVolumeSizeLimit_, emptyDirVolumeSizeLimit) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setFlexVolumeDriver(string flexVolumeDriver) { DARABONBA_PTR_SET_VALUE(flexVolumeDriver_, flexVolumeDriver) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setFlexVolumeFsType(string flexVolumeFsType) { DARABONBA_PTR_SET_VALUE(flexVolumeFsType_, flexVolumeFsType) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setFlexVolumeOptions(string flexVolumeOptions) { DARABONBA_PTR_SET_VALUE(flexVolumeOptions_, flexVolumeOptions) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setHostPathVolumePath(string hostPathVolumePath) { DARABONBA_PTR_SET_VALUE(hostPathVolumePath_, hostPathVolumePath) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setHostPathVolumeType(string hostPathVolumeType) { DARABONBA_PTR_SET_VALUE(hostPathVolumeType_, hostPathVolumeType) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setNFSVolumePath(string NFSVolumePath) { DARABONBA_PTR_SET_VALUE(NFSVolumePath_, NFSVolumePath) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setNFSVolumeReadOnly(bool NFSVolumeReadOnly) { DARABONBA_PTR_SET_VALUE(NFSVolumeReadOnly_, NFSVolumeReadOnly) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setNFSVolumeServer(string NFSVolumeServer) { DARABONBA_PTR_SET_VALUE(NFSVolumeServer_, NFSVolumeServer) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumes& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };


  protected:
    // The paths to configuration files.
    std::shared_ptr<vector<Models::DescribeEciScalingConfigurationsResponseBodyScalingConfigurationsVolumesConfigFileVolumeConfigFileToPaths>> configFileVolumeConfigFileToPaths_ = nullptr;
