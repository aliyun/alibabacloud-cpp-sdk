...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->entrusted_ == nullptr
        && return this->instanceId_ == nullptr && return this->instanceIds_ == nullptr && return this->ownerId_ == nullptr && return this->regionId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
