...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adjustmentType_ == nullptr
        ...
        && return this->predictiveTaskBufferTime_ == nullptr && return this->predictiveValueBehavior_ == nullptr && return this->predictiveValueBuffer_ == nullptr && return this->regionId_ == nullptr && return this->resourceOwnerAccount_ == nullptr
        && return this->scaleInEvaluationCount_ == nullptr && return this->scaleOutEvaluationCount_ == nullptr && return this->scalingGroupId_ == nullptr && return this->scalingRuleName_ == nullptr && return this->scalingRuleType_ == nullptr
        && return this->stepAdjustments_ == nullptr && return this->targetValue_ == nullptr; };
