...
namespace Models
{
  ...
  public:
    ...
    inline const AttachServerGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachServerGroupsResponseBody) };
    inline AttachServerGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachServerGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachServerGroupsResponseBody> body_ {};
  };
