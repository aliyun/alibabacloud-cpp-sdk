...
#ifndef ALIBABACLOUD_MODELS_CREATESCALINGCONFIGURATIONSHRINKREQUESTINSTANCETYPEOVERRIDES_HPP_
#define ALIBABACLOUD_MODELS_CREATESCALINGCONFIGURATIONSHRINKREQUESTINSTANCETYPEOVERRIDES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateScalingConfigurationShrinkRequestInstanceTypeOverrides& obj) { 
      DARABONBA_PTR_TO_JSON(InstanceType, instanceType_);
      DARABONBA_PTR_TO_JSON(WeightedCapacity, weightedCapacity_);
    };
    friend void from_json(const Darabonba::Json& j, CreateScalingConfigurationShrinkRequestInstanceTypeOverrides& obj) { 
      DARABONBA_PTR_FROM_JSON(InstanceType, instanceType_);
      DARABONBA_PTR_FROM_JSON(WeightedCapacity, weightedCapacity_);
    };
    CreateScalingConfigurationShrinkRequestInstanceTypeOverrides() = default ;
    CreateScalingConfigurationShrinkRequestInstanceTypeOverrides(const CreateScalingConfigurationShrinkRequestInstanceTypeOverrides &) = default ;
    CreateScalingConfigurationShrinkRequestInstanceTypeOverrides(CreateScalingConfigurationShrinkRequestInstanceTypeOverrides &&) = default ;
    CreateScalingConfigurationShrinkRequestInstanceTypeOverrides(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateScalingConfigurationShrinkRequestInstanceTypeOverrides() = default ;
    CreateScalingConfigurationShrinkRequestInstanceTypeOverrides& operator=(const CreateScalingConfigurationShrinkRequestInstanceTypeOverrides &) = default ;
    CreateScalingConfigurationShrinkRequestInstanceTypeOverrides& operator=(CreateScalingConfigurationShrinkRequestInstanceTypeOverrides &&) = default ;
    ...
    inline CreateScalingConfigurationShrinkRequestInstanceTypeOverrides& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline CreateScalingConfigurationShrinkRequestInstanceTypeOverrides& setWeightedCapacity(int32_t weightedCapacity) { DARABONBA_PTR_SET_VALUE(weightedCapacity_, weightedCapacity) };
