...
#ifndef ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONREQUESTRESOURCEPOOLOPTIONS_HPP_
#define ALIBABACLOUD_MODELS_MODIFYSCALINGCONFIGURATIONREQUESTRESOURCEPOOLOPTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyScalingConfigurationRequestResourcePoolOptions& obj) { 
      DARABONBA_PTR_TO_JSON(PrivatePoolIds, privatePoolIds_);
      DARABONBA_PTR_TO_JSON(Strategy, strategy_);
    };
    friend void from_json(const Darabonba::Json& j, ModifyScalingConfigurationRequestResourcePoolOptions& obj) { 
      DARABONBA_PTR_FROM_JSON(PrivatePoolIds, privatePoolIds_);
      DARABONBA_PTR_FROM_JSON(Strategy, strategy_);
    };
    ModifyScalingConfigurationRequestResourcePoolOptions() = default ;
    ModifyScalingConfigurationRequestResourcePoolOptions(const ModifyScalingConfigurationRequestResourcePoolOptions &) = default ;
    ModifyScalingConfigurationRequestResourcePoolOptions(ModifyScalingConfigurationRequestResourcePoolOptions &&) = default ;
    ModifyScalingConfigurationRequestResourcePoolOptions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyScalingConfigurationRequestResourcePoolOptions() = default ;
    ModifyScalingConfigurationRequestResourcePoolOptions& operator=(const ModifyScalingConfigurationRequestResourcePoolOptions &) = default ;
    ModifyScalingConfigurationRequestResourcePoolOptions& operator=(ModifyScalingConfigurationRequestResourcePoolOptions &&) = default ;
    ...
    inline ModifyScalingConfigurationRequestResourcePoolOptions& setPrivatePoolIds(const vector<string> & privatePoolIds) { DARABONBA_PTR_SET_VALUE(privatePoolIds_, privatePoolIds) };
    inline ModifyScalingConfigurationRequestResourcePoolOptions& setPrivatePoolIds(vector<string> && privatePoolIds) { DARABONBA_PTR_SET_RVALUE(privatePoolIds_, privatePoolIds) };
    ...
    inline ModifyScalingConfigurationRequestResourcePoolOptions& setStrategy(string strategy) { DARABONBA_PTR_SET_VALUE(strategy_, strategy) };
