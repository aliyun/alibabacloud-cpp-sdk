...
namespace Models
{
  ...
  public:
    ...
    inline const EnableScalingGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, EnableScalingGroupResponseBody) };
    inline EnableScalingGroupResponseBody body() { DARABONBA_PTR_GET(body_, EnableScalingGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<EnableScalingGroupResponseBody> body_ = nullptr;
  };
