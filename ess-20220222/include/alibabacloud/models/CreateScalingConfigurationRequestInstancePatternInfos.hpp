...
#ifndef ALIBABACLOUD_MODELS_CREATESCALINGCONFIGURATIONREQUESTINSTANCEPATTERNINFOS_HPP_
#define ALIBABACLOUD_MODELS_CREATESCALINGCONFIGURATIONREQUESTINSTANCEPATTERNINFOS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateScalingConfigurationRequestInstancePatternInfos& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateScalingConfigurationRequestInstancePatternInfos& obj) { 
    ...
    CreateScalingConfigurationRequestInstancePatternInfos() = default ;
    CreateScalingConfigurationRequestInstancePatternInfos(const CreateScalingConfigurationRequestInstancePatternInfos &) = default ;
    CreateScalingConfigurationRequestInstancePatternInfos(CreateScalingConfigurationRequestInstancePatternInfos &&) = default ;
    CreateScalingConfigurationRequestInstancePatternInfos(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateScalingConfigurationRequestInstancePatternInfos() = default ;
    CreateScalingConfigurationRequestInstancePatternInfos& operator=(const CreateScalingConfigurationRequestInstancePatternInfos &) = default ;
    CreateScalingConfigurationRequestInstancePatternInfos& operator=(CreateScalingConfigurationRequestInstancePatternInfos &&) = default ;
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setArchitectures(const vector<string> & architectures) { DARABONBA_PTR_SET_VALUE(architectures_, architectures) };
    inline CreateScalingConfigurationRequestInstancePatternInfos& setArchitectures(vector<string> && architectures) { DARABONBA_PTR_SET_RVALUE(architectures_, architectures) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setBurstablePerformance(string burstablePerformance) { DARABONBA_PTR_SET_VALUE(burstablePerformance_, burstablePerformance) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setCores(int32_t cores) { DARABONBA_PTR_SET_VALUE(cores_, cores) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setCpuArchitectures(const vector<string> & cpuArchitectures) { DARABONBA_PTR_SET_VALUE(cpuArchitectures_, cpuArchitectures) };
    inline CreateScalingConfigurationRequestInstancePatternInfos& setCpuArchitectures(vector<string> && cpuArchitectures) { DARABONBA_PTR_SET_RVALUE(cpuArchitectures_, cpuArchitectures) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setExcludedInstanceTypes(const vector<string> & excludedInstanceTypes) { DARABONBA_PTR_SET_VALUE(excludedInstanceTypes_, excludedInstanceTypes) };
    inline CreateScalingConfigurationRequestInstancePatternInfos& setExcludedInstanceTypes(vector<string> && excludedInstanceTypes) { DARABONBA_PTR_SET_RVALUE(excludedInstanceTypes_, excludedInstanceTypes) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setGpuSpecs(const vector<string> & gpuSpecs) { DARABONBA_PTR_SET_VALUE(gpuSpecs_, gpuSpecs) };
    inline CreateScalingConfigurationRequestInstancePatternInfos& setGpuSpecs(vector<string> && gpuSpecs) { DARABONBA_PTR_SET_RVALUE(gpuSpecs_, gpuSpecs) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setInstanceCategories(const vector<string> & instanceCategories) { DARABONBA_PTR_SET_VALUE(instanceCategories_, instanceCategories) };
    inline CreateScalingConfigurationRequestInstancePatternInfos& setInstanceCategories(vector<string> && instanceCategories) { DARABONBA_PTR_SET_RVALUE(instanceCategories_, instanceCategories) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setInstanceFamilyLevel(string instanceFamilyLevel) { DARABONBA_PTR_SET_VALUE(instanceFamilyLevel_, instanceFamilyLevel) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setInstanceTypeFamilies(const vector<string> & instanceTypeFamilies) { DARABONBA_PTR_SET_VALUE(instanceTypeFamilies_, instanceTypeFamilies) };
    inline CreateScalingConfigurationRequestInstancePatternInfos& setInstanceTypeFamilies(vector<string> && instanceTypeFamilies) { DARABONBA_PTR_SET_RVALUE(instanceTypeFamilies_, instanceTypeFamilies) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMaxPrice(float maxPrice) { DARABONBA_PTR_SET_VALUE(maxPrice_, maxPrice) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMaximumCpuCoreCount(int32_t maximumCpuCoreCount) { DARABONBA_PTR_SET_VALUE(maximumCpuCoreCount_, maximumCpuCoreCount) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMaximumGpuAmount(int32_t maximumGpuAmount) { DARABONBA_PTR_SET_VALUE(maximumGpuAmount_, maximumGpuAmount) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMaximumMemorySize(float maximumMemorySize) { DARABONBA_PTR_SET_VALUE(maximumMemorySize_, maximumMemorySize) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMemory(float memory) { DARABONBA_PTR_SET_VALUE(memory_, memory) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMinimumBaselineCredit(int32_t minimumBaselineCredit) { DARABONBA_PTR_SET_VALUE(minimumBaselineCredit_, minimumBaselineCredit) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMinimumCpuCoreCount(int32_t minimumCpuCoreCount) { DARABONBA_PTR_SET_VALUE(minimumCpuCoreCount_, minimumCpuCoreCount) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMinimumEniIpv6AddressQuantity(int32_t minimumEniIpv6AddressQuantity) { DARABONBA_PTR_SET_VALUE(minimumEniIpv6AddressQuantity_, minimumEniIpv6AddressQuantity) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMinimumEniPrivateIpAddressQuantity(int32_t minimumEniPrivateIpAddressQuantity) { DARABONBA_PTR_SET_VALUE(minimumEniPrivateIpAddressQuantity_, minimumEniPrivateIpAddressQuantity) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMinimumEniQuantity(int32_t minimumEniQuantity) { DARABONBA_PTR_SET_VALUE(minimumEniQuantity_, minimumEniQuantity) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMinimumGpuAmount(int32_t minimumGpuAmount) { DARABONBA_PTR_SET_VALUE(minimumGpuAmount_, minimumGpuAmount) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMinimumInitialCredit(int32_t minimumInitialCredit) { DARABONBA_PTR_SET_VALUE(minimumInitialCredit_, minimumInitialCredit) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setMinimumMemorySize(float minimumMemorySize) { DARABONBA_PTR_SET_VALUE(minimumMemorySize_, minimumMemorySize) };
    ...
    inline CreateScalingConfigurationRequestInstancePatternInfos& setPhysicalProcessorModels(const vector<string> & physicalProcessorModels) { DARABONBA_PTR_SET_VALUE(physicalProcessorModels_, physicalProcessorModels) };
    inline CreateScalingConfigurationRequestInstancePatternInfos& setPhysicalProcessorModels(vector<string> && physicalProcessorModels) { DARABONBA_PTR_SET_RVALUE(physicalProcessorModels_, physicalProcessorModels) };
