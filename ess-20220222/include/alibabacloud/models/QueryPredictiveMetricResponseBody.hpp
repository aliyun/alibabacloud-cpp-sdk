...
namespace Models
{
  ...
  public:
    ...
    inline const QueryPredictiveMetricResponseBodyPredictiveMetrics & predictiveMetrics() const { DARABONBA_PTR_GET_CONST(predictiveMetrics_, QueryPredictiveMetricResponseBodyPredictiveMetrics) };
    inline QueryPredictiveMetricResponseBodyPredictiveMetrics predictiveMetrics() { DARABONBA_PTR_GET(predictiveMetrics_, QueryPredictiveMetricResponseBodyPredictiveMetrics) };
    inline QueryPredictiveMetricResponseBody& setPredictiveMetrics(const QueryPredictiveMetricResponseBodyPredictiveMetrics & predictiveMetrics) { DARABONBA_PTR_SET_VALUE(predictiveMetrics_, predictiveMetrics) };
    inline QueryPredictiveMetricResponseBody& setPredictiveMetrics(QueryPredictiveMetricResponseBodyPredictiveMetrics && predictiveMetrics) { DARABONBA_PTR_SET_RVALUE(predictiveMetrics_, predictiveMetrics) };
  ...
  protected:
    std::shared_ptr<QueryPredictiveMetricResponseBodyPredictiveMetrics> predictiveMetrics_ = nullptr;
