...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->acrRegistryInfos_ == nullptr
        && return this->activeDeadlineSeconds_ == nullptr && return this->autoCreateEip_ == nullptr && return this->autoMatchImageCache_ == nullptr && return this->computeCategory_ == nullptr && return this->containerGroupName_ == nullptr
        && return this->containers_ == nullptr && return this->costOptimization_ == nullptr && return this->cpu_ == nullptr && return this->cpuOptionsCore_ == nullptr && return this->cpuOptionsThreadsPerCore_ == nullptr
        && return this->creationTime_ == nullptr && return this->dataCacheBucket_ == nullptr && return this->dataCacheBurstingEnabled_ == nullptr && return this->dataCachePL_ == nullptr && return this->dataCacheProvisionedIops_ == nullptr
        && return this->description_ == nullptr && return this->dnsConfigNameServers_ == nullptr && return this->dnsConfigOptions_ == nullptr && return this->dnsConfigSearches_ == nullptr && return this->dnsPolicy_ == nullptr
        && return this->egressBandwidth_ == nullptr && return this->eipBandwidth_ == nullptr && return this->eipCommonBandwidthPackage_ == nullptr && return this->eipISP_ == nullptr && return this->eipPublicIpAddressPoolId_ == nullptr
        && return this->ephemeralStorage_ == nullptr && return this->hostAliases_ == nullptr && return this->hostName_ == nullptr && return this->imageRegistryCredentials_ == nullptr && return this->imageSnapshotId_ == nullptr
        && return this->ingressBandwidth_ == nullptr && return this->initContainers_ == nullptr && return this->instanceFamilyLevel_ == nullptr && return this->instanceTypes_ == nullptr && return this->ipv6AddressCount_ == nullptr
        && return this->lifecycleState_ == nullptr && return this->loadBalancerWeight_ == nullptr && return this->memory_ == nullptr && return this->ntpServers_ == nullptr && return this->ramRoleName_ == nullptr
        && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->restartPolicy_ == nullptr && return this->scalingConfigurationId_ == nullptr && return this->scalingConfigurationName_ == nullptr
        && return this->scalingGroupId_ == nullptr && return this->securityContextSysCtls_ == nullptr && return this->securityGroupId_ == nullptr && return this->slsEnable_ == nullptr && return this->spotPriceLimit_ == nullptr
