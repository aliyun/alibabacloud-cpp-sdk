...
namespace Models
{
  ...
  public:
    ...
    inline const SuspendInstanceRefreshResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SuspendInstanceRefreshResponseBody) };
    inline SuspendInstanceRefreshResponseBody getBody() { DARABONBA_PTR_GET(body_, SuspendInstanceRefreshResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SuspendInstanceRefreshResponseBody> body_ {};
  };
