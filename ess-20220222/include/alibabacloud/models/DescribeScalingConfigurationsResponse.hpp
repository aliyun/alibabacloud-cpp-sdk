...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScalingConfigurationsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeScalingConfigurationsResponseBody) };
    inline DescribeScalingConfigurationsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeScalingConfigurationsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeScalingConfigurationsResponseBody> body_ {};
  };
