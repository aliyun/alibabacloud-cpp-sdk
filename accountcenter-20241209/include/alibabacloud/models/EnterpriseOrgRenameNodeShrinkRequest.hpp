...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISEORGRENAMENODESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISEORGRENAMENODESHRINKREQUEST_HPP_
...
namespace Models
{
  class EnterpriseOrgRenameNodeShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseOrgRenameNodeShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseOrgRenameNodeShrinkRequest& obj) { 
    ...
    EnterpriseOrgRenameNodeShrinkRequest() = default ;
    EnterpriseOrgRenameNodeShrinkRequest(const EnterpriseOrgRenameNodeShrinkRequest &) = default ;
    EnterpriseOrgRenameNodeShrinkRequest(EnterpriseOrgRenameNodeShrinkRequest &&) = default ;
    EnterpriseOrgRenameNodeShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseOrgRenameNodeShrinkRequest() = default ;
    EnterpriseOrgRenameNodeShrinkRequest& operator=(const EnterpriseOrgRenameNodeShrinkRequest &) = default ;
    EnterpriseOrgRenameNodeShrinkRequest& operator=(EnterpriseOrgRenameNodeShrinkRequest &&) = default ;
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setExtShrink(string extShrink) { DARABONBA_PTR_SET_VALUE(extShrink_, extShrink) };
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setIsOpenApi(bool isOpenApi) { DARABONBA_PTR_SET_VALUE(isOpenApi_, isOpenApi) };
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setNodeId(string nodeId) { DARABONBA_PTR_SET_VALUE(nodeId_, nodeId) };
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setNodeName(string nodeName) { DARABONBA_PTR_SET_VALUE(nodeName_, nodeName) };
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setNodeType(string nodeType) { DARABONBA_PTR_SET_VALUE(nodeType_, nodeType) };
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setOrientedEcId(string orientedEcId) { DARABONBA_PTR_SET_VALUE(orientedEcId_, orientedEcId) };
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setOrientedLeId(string orientedLeId) { DARABONBA_PTR_SET_VALUE(orientedLeId_, orientedLeId) };
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setOrientedNbId(string orientedNbId) { DARABONBA_PTR_SET_VALUE(orientedNbId_, orientedNbId) };
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setShowCompleteInfo(bool showCompleteInfo) { DARABONBA_PTR_SET_VALUE(showCompleteInfo_, showCompleteInfo) };
    ...
    inline EnterpriseOrgRenameNodeShrinkRequest& setTreeId(int64_t treeId) { DARABONBA_PTR_SET_VALUE(treeId_, treeId) };
