...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISECONTACTADDREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISECONTACTADDREQUEST_HPP_
...
namespace Models
{
  class EnterpriseContactAddRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseContactAddRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseContactAddRequest& obj) { 
    ...
    EnterpriseContactAddRequest() = default ;
    EnterpriseContactAddRequest(const EnterpriseContactAddRequest &) = default ;
    EnterpriseContactAddRequest(EnterpriseContactAddRequest &&) = default ;
    EnterpriseContactAddRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseContactAddRequest() = default ;
    EnterpriseContactAddRequest& operator=(const EnterpriseContactAddRequest &) = default ;
    EnterpriseContactAddRequest& operator=(EnterpriseContactAddRequest &&) = default ;
    ...
    inline EnterpriseContactAddRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline EnterpriseContactAddRequest& setAsyncEmailVerify(bool asyncEmailVerify) { DARABONBA_PTR_SET_VALUE(asyncEmailVerify_, asyncEmailVerify) };
    ...
    inline EnterpriseContactAddRequest& setAsyncMobileVerify(bool asyncMobileVerify) { DARABONBA_PTR_SET_VALUE(asyncMobileVerify_, asyncMobileVerify) };
    ...
    inline EnterpriseContactAddRequest& setContactEmail(string contactEmail) { DARABONBA_PTR_SET_VALUE(contactEmail_, contactEmail) };
    ...
    inline EnterpriseContactAddRequest& setContactMobile(string contactMobile) { DARABONBA_PTR_SET_VALUE(contactMobile_, contactMobile) };
    ...
    inline EnterpriseContactAddRequest& setContactName(string contactName) { DARABONBA_PTR_SET_VALUE(contactName_, contactName) };
    ...
    inline EnterpriseContactAddRequest& setContactPosition(string contactPosition) { DARABONBA_PTR_SET_VALUE(contactPosition_, contactPosition) };
    ...
    inline EnterpriseContactAddRequest& setEmailCode(string emailCode) { DARABONBA_PTR_SET_VALUE(emailCode_, emailCode) };
    ...
    inline EnterpriseContactAddRequest& setMobileCode(string mobileCode) { DARABONBA_PTR_SET_VALUE(mobileCode_, mobileCode) };
    ...
    inline EnterpriseContactAddRequest& setOrientedEcId(string orientedEcId) { DARABONBA_PTR_SET_VALUE(orientedEcId_, orientedEcId) };
    ...
    inline EnterpriseContactAddRequest& setOrientedLeId(string orientedLeId) { DARABONBA_PTR_SET_VALUE(orientedLeId_, orientedLeId) };
    ...
    inline EnterpriseContactAddRequest& setOrientedNbId(string orientedNbId) { DARABONBA_PTR_SET_VALUE(orientedNbId_, orientedNbId) };
    ...
    inline EnterpriseContactAddRequest& setSharedContact(bool sharedContact) { DARABONBA_PTR_SET_VALUE(sharedContact_, sharedContact) };
