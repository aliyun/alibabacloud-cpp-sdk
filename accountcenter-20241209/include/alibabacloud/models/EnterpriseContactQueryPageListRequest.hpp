...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISECONTACTQUERYPAGELISTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISECONTACTQUERYPAGELISTREQUEST_HPP_
...
namespace Models
{
  class EnterpriseContactQueryPageListRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseContactQueryPageListRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseContactQueryPageListRequest& obj) { 
    ...
    EnterpriseContactQueryPageListRequest() = default ;
    EnterpriseContactQueryPageListRequest(const EnterpriseContactQueryPageListRequest &) = default ;
    EnterpriseContactQueryPageListRequest(EnterpriseContactQueryPageListRequest &&) = default ;
    EnterpriseContactQueryPageListRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseContactQueryPageListRequest() = default ;
    EnterpriseContactQueryPageListRequest& operator=(const EnterpriseContactQueryPageListRequest &) = default ;
    EnterpriseContactQueryPageListRequest& operator=(EnterpriseContactQueryPageListRequest &&) = default ;
    ...
    inline EnterpriseContactQueryPageListRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline EnterpriseContactQueryPageListRequest& setOrientedEcId(string orientedEcId) { DARABONBA_PTR_SET_VALUE(orientedEcId_, orientedEcId) };
    ...
    inline EnterpriseContactQueryPageListRequest& setOrientedLeId(string orientedLeId) { DARABONBA_PTR_SET_VALUE(orientedLeId_, orientedLeId) };
    ...
    inline EnterpriseContactQueryPageListRequest& setOrientedNbId(string orientedNbId) { DARABONBA_PTR_SET_VALUE(orientedNbId_, orientedNbId) };
    ...
    inline EnterpriseContactQueryPageListRequest& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline EnterpriseContactQueryPageListRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline EnterpriseContactQueryPageListRequest& setPrivateContact(bool privateContact) { DARABONBA_PTR_SET_VALUE(privateContact_, privateContact) };
    ...
    inline EnterpriseContactQueryPageListRequest& setQuery(string query) { DARABONBA_PTR_SET_VALUE(query_, query) };
    ...
    inline EnterpriseContactQueryPageListRequest& setSharedContact(bool sharedContact) { DARABONBA_PTR_SET_VALUE(sharedContact_, sharedContact) };
    ...
    inline EnterpriseContactQueryPageListRequest& setShowCompleteInfo(bool showCompleteInfo) { DARABONBA_PTR_SET_VALUE(showCompleteInfo_, showCompleteInfo) };
