...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISEORGCREATENODEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISEORGCREATENODEREQUEST_HPP_
...
namespace Models
{
  class EnterpriseOrgCreateNodeRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseOrgCreateNodeRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseOrgCreateNodeRequest& obj) { 
    ...
    EnterpriseOrgCreateNodeRequest() = default ;
    EnterpriseOrgCreateNodeRequest(const EnterpriseOrgCreateNodeRequest &) = default ;
    EnterpriseOrgCreateNodeRequest(EnterpriseOrgCreateNodeRequest &&) = default ;
    EnterpriseOrgCreateNodeRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseOrgCreateNodeRequest() = default ;
    EnterpriseOrgCreateNodeRequest& operator=(const EnterpriseOrgCreateNodeRequest &) = default ;
    EnterpriseOrgCreateNodeRequest& operator=(EnterpriseOrgCreateNodeRequest &&) = default ;
    ...
    inline EnterpriseOrgCreateNodeRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setBizName(string bizName) { DARABONBA_PTR_SET_VALUE(bizName_, bizName) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setExt(const Darabonba::Json & ext) { DARABONBA_SET_VALUE(ext_, ext) };
    inline EnterpriseOrgCreateNodeRequest& setExt(Darabonba::Json && ext) { DARABONBA_SET_RVALUE(ext_, ext) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setIsOpenApi(bool isOpenApi) { DARABONBA_PTR_SET_VALUE(isOpenApi_, isOpenApi) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setNodeId(string nodeId) { DARABONBA_PTR_SET_VALUE(nodeId_, nodeId) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setNodeName(string nodeName) { DARABONBA_PTR_SET_VALUE(nodeName_, nodeName) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setNodeType(string nodeType) { DARABONBA_PTR_SET_VALUE(nodeType_, nodeType) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setOrientedEcId(string orientedEcId) { DARABONBA_PTR_SET_VALUE(orientedEcId_, orientedEcId) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setOrientedLeId(string orientedLeId) { DARABONBA_PTR_SET_VALUE(orientedLeId_, orientedLeId) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setOrientedNbId(string orientedNbId) { DARABONBA_PTR_SET_VALUE(orientedNbId_, orientedNbId) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setParentNodeId(string parentNodeId) { DARABONBA_PTR_SET_VALUE(parentNodeId_, parentNodeId) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setParentNodeType(string parentNodeType) { DARABONBA_PTR_SET_VALUE(parentNodeType_, parentNodeType) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setShowCompleteInfo(bool showCompleteInfo) { DARABONBA_PTR_SET_VALUE(showCompleteInfo_, showCompleteInfo) };
    ...
    inline EnterpriseOrgCreateNodeRequest& setTreeId(int64_t treeId) { DARABONBA_PTR_SET_VALUE(treeId_, treeId) };
