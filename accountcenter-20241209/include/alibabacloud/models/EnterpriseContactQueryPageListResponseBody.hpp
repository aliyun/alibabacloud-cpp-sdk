...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISECONTACTQUERYPAGELISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISECONTACTQUERYPAGELISTRESPONSEBODY_HPP_
...
namespace Models
{
  class EnterpriseContactQueryPageListResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseContactQueryPageListResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseContactQueryPageListResponseBody& obj) { 
    ...
    EnterpriseContactQueryPageListResponseBody() = default ;
    EnterpriseContactQueryPageListResponseBody(const EnterpriseContactQueryPageListResponseBody &) = default ;
    EnterpriseContactQueryPageListResponseBody(EnterpriseContactQueryPageListResponseBody &&) = default ;
    EnterpriseContactQueryPageListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseContactQueryPageListResponseBody() = default ;
    EnterpriseContactQueryPageListResponseBody& operator=(const EnterpriseContactQueryPageListResponseBody &) = default ;
    EnterpriseContactQueryPageListResponseBody& operator=(EnterpriseContactQueryPageListResponseBody &&) = default ;
    ...
    inline EnterpriseContactQueryPageListResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<EnterpriseContactQueryPageListResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<EnterpriseContactQueryPageListResponseBody::Data>) };
    inline vector<EnterpriseContactQueryPageListResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<EnterpriseContactQueryPageListResponseBody::Data>) };
    inline EnterpriseContactQueryPageListResponseBody& setData(const vector<EnterpriseContactQueryPageListResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline EnterpriseContactQueryPageListResponseBody& setData(vector<EnterpriseContactQueryPageListResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline EnterpriseContactQueryPageListResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline EnterpriseContactQueryPageListResponseBody& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline EnterpriseContactQueryPageListResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline EnterpriseContactQueryPageListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline EnterpriseContactQueryPageListResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline EnterpriseContactQueryPageListResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
    ...
    inline EnterpriseContactQueryPageListResponseBody& setTotalPage(int32_t totalPage) { DARABONBA_PTR_SET_VALUE(totalPage_, totalPage) };
