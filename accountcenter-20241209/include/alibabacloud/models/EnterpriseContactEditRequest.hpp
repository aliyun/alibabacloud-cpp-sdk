...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISECONTACTEDITREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISECONTACTEDITREQUEST_HPP_
...
namespace Models
{
  class EnterpriseContactEditRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseContactEditRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseContactEditRequest& obj) { 
    ...
    EnterpriseContactEditRequest() = default ;
    EnterpriseContactEditRequest(const EnterpriseContactEditRequest &) = default ;
    EnterpriseContactEditRequest(EnterpriseContactEditRequest &&) = default ;
    EnterpriseContactEditRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseContactEditRequest() = default ;
    EnterpriseContactEditRequest& operator=(const EnterpriseContactEditRequest &) = default ;
    EnterpriseContactEditRequest& operator=(EnterpriseContactEditRequest &&) = default ;
    ...
    inline EnterpriseContactEditRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline EnterpriseContactEditRequest& setAsyncEmailVerify(bool asyncEmailVerify) { DARABONBA_PTR_SET_VALUE(asyncEmailVerify_, asyncEmailVerify) };
    ...
    inline EnterpriseContactEditRequest& setAsyncMobileVerify(bool asyncMobileVerify) { DARABONBA_PTR_SET_VALUE(asyncMobileVerify_, asyncMobileVerify) };
    ...
    inline EnterpriseContactEditRequest& setContactEmail(string contactEmail) { DARABONBA_PTR_SET_VALUE(contactEmail_, contactEmail) };
    ...
    inline EnterpriseContactEditRequest& setContactId(int64_t contactId) { DARABONBA_PTR_SET_VALUE(contactId_, contactId) };
    ...
    inline EnterpriseContactEditRequest& setContactMobile(string contactMobile) { DARABONBA_PTR_SET_VALUE(contactMobile_, contactMobile) };
    ...
    inline EnterpriseContactEditRequest& setContactName(string contactName) { DARABONBA_PTR_SET_VALUE(contactName_, contactName) };
    ...
    inline EnterpriseContactEditRequest& setContactPosition(string contactPosition) { DARABONBA_PTR_SET_VALUE(contactPosition_, contactPosition) };
    ...
    inline EnterpriseContactEditRequest& setEmailCode(string emailCode) { DARABONBA_PTR_SET_VALUE(emailCode_, emailCode) };
    ...
    inline EnterpriseContactEditRequest& setMobileCode(string mobileCode) { DARABONBA_PTR_SET_VALUE(mobileCode_, mobileCode) };
    ...
    inline EnterpriseContactEditRequest& setOrientedEcId(string orientedEcId) { DARABONBA_PTR_SET_VALUE(orientedEcId_, orientedEcId) };
    ...
    inline EnterpriseContactEditRequest& setOrientedLeId(string orientedLeId) { DARABONBA_PTR_SET_VALUE(orientedLeId_, orientedLeId) };
    ...
    inline EnterpriseContactEditRequest& setOrientedNbId(string orientedNbId) { DARABONBA_PTR_SET_VALUE(orientedNbId_, orientedNbId) };
    ...
    inline EnterpriseContactEditRequest& setSharedContact(bool sharedContact) { DARABONBA_PTR_SET_VALUE(sharedContact_, sharedContact) };
