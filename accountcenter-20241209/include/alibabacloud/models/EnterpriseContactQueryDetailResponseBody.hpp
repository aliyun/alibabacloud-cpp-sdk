...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISECONTACTQUERYDETAILRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISECONTACTQUERYDETAILRESPONSEBODY_HPP_
...
namespace Models
{
  class EnterpriseContactQueryDetailResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseContactQueryDetailResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseContactQueryDetailResponseBody& obj) { 
    ...
    EnterpriseContactQueryDetailResponseBody() = default ;
    EnterpriseContactQueryDetailResponseBody(const EnterpriseContactQueryDetailResponseBody &) = default ;
    EnterpriseContactQueryDetailResponseBody(EnterpriseContactQueryDetailResponseBody &&) = default ;
    EnterpriseContactQueryDetailResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseContactQueryDetailResponseBody() = default ;
    EnterpriseContactQueryDetailResponseBody& operator=(const EnterpriseContactQueryDetailResponseBody &) = default ;
    EnterpriseContactQueryDetailResponseBody& operator=(EnterpriseContactQueryDetailResponseBody &&) = default ;
    ...
    inline EnterpriseContactQueryDetailResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const EnterpriseContactQueryDetailResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, EnterpriseContactQueryDetailResponseBody::Data) };
    inline EnterpriseContactQueryDetailResponseBody::Data getData() { DARABONBA_PTR_GET(data_, EnterpriseContactQueryDetailResponseBody::Data) };
    inline EnterpriseContactQueryDetailResponseBody& setData(const EnterpriseContactQueryDetailResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline EnterpriseContactQueryDetailResponseBody& setData(EnterpriseContactQueryDetailResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline EnterpriseContactQueryDetailResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline EnterpriseContactQueryDetailResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline EnterpriseContactQueryDetailResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
