...
#ifndef ALIBABACLOUD_MODELS_ACCOUNTCONTACTADDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ACCOUNTCONTACTADDRESPONSEBODY_HPP_
...
namespace Models
{
  class AccountContactAddResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AccountContactAddResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AccountContactAddResponseBody& obj) { 
    ...
    AccountContactAddResponseBody() = default ;
    AccountContactAddResponseBody(const AccountContactAddResponseBody &) = default ;
    AccountContactAddResponseBody(AccountContactAddResponseBody &&) = default ;
    AccountContactAddResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AccountContactAddResponseBody() = default ;
    AccountContactAddResponseBody& operator=(const AccountContactAddResponseBody &) = default ;
    AccountContactAddResponseBody& operator=(AccountContactAddResponseBody &&) = default ;
    ...
    inline AccountContactAddResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const AccountContactAddResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, AccountContactAddResponseBody::Data) };
    inline AccountContactAddResponseBody::Data getData() { DARABONBA_PTR_GET(data_, AccountContactAddResponseBody::Data) };
    inline AccountContactAddResponseBody& setData(const AccountContactAddResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AccountContactAddResponseBody& setData(AccountContactAddResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline AccountContactAddResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline AccountContactAddResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline AccountContactAddResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<AccountContactAddResponseBody::Data> data_ {};
