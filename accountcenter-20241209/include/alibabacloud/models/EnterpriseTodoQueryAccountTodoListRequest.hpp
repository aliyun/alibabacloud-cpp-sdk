...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISETODOQUERYACCOUNTTODOLISTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISETODOQUERYACCOUNTTODOLISTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseTodoQueryAccountTodoListRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseTodoQueryAccountTodoListRequest& obj) { 
    ...
    EnterpriseTodoQueryAccountTodoListRequest() = default ;
    EnterpriseTodoQueryAccountTodoListRequest(const EnterpriseTodoQueryAccountTodoListRequest &) = default ;
    EnterpriseTodoQueryAccountTodoListRequest(EnterpriseTodoQueryAccountTodoListRequest &&) = default ;
    EnterpriseTodoQueryAccountTodoListRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseTodoQueryAccountTodoListRequest() = default ;
    EnterpriseTodoQueryAccountTodoListRequest& operator=(const EnterpriseTodoQueryAccountTodoListRequest &) = default ;
    EnterpriseTodoQueryAccountTodoListRequest& operator=(EnterpriseTodoQueryAccountTodoListRequest &&) = default ;
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setOperatePk(string operatePk) { DARABONBA_PTR_SET_VALUE(operatePk_, operatePk) };
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setOrientedEcId(string orientedEcId) { DARABONBA_PTR_SET_VALUE(orientedEcId_, orientedEcId) };
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setOrientedLeId(string orientedLeId) { DARABONBA_PTR_SET_VALUE(orientedLeId_, orientedLeId) };
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setOrientedNbId(string orientedNbId) { DARABONBA_PTR_SET_VALUE(orientedNbId_, orientedNbId) };
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setPage(int32_t page) { DARABONBA_PTR_SET_VALUE(page_, page) };
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setShowCompleteInfo(bool showCompleteInfo) { DARABONBA_PTR_SET_VALUE(showCompleteInfo_, showCompleteInfo) };
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline EnterpriseTodoQueryAccountTodoListRequest& setTodoType(string todoType) { DARABONBA_PTR_SET_VALUE(todoType_, todoType) };
