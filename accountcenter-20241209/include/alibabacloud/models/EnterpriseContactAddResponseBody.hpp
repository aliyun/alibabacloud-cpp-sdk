...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISECONTACTADDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISECONTACTADDRESPONSEBODY_HPP_
...
namespace Models
{
  class EnterpriseContactAddResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseContactAddResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseContactAddResponseBody& obj) { 
    ...
    EnterpriseContactAddResponseBody() = default ;
    EnterpriseContactAddResponseBody(const EnterpriseContactAddResponseBody &) = default ;
    EnterpriseContactAddResponseBody(EnterpriseContactAddResponseBody &&) = default ;
    EnterpriseContactAddResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseContactAddResponseBody() = default ;
    EnterpriseContactAddResponseBody& operator=(const EnterpriseContactAddResponseBody &) = default ;
    EnterpriseContactAddResponseBody& operator=(EnterpriseContactAddResponseBody &&) = default ;
    ...
    inline EnterpriseContactAddResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const EnterpriseContactAddResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, EnterpriseContactAddResponseBody::Data) };
    inline EnterpriseContactAddResponseBody::Data getData() { DARABONBA_PTR_GET(data_, EnterpriseContactAddResponseBody::Data) };
    inline EnterpriseContactAddResponseBody& setData(const EnterpriseContactAddResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline EnterpriseContactAddResponseBody& setData(EnterpriseContactAddResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline EnterpriseContactAddResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline EnterpriseContactAddResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline EnterpriseContactAddResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<EnterpriseContactAddResponseBody::Data> data_ {};
