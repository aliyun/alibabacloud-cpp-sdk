...
#ifndef ALIBABACLOUD_MODELS_ACCOUNTCONTACTEDITRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_ACCOUNTCONTACTEDITRESPONSEBODY_HPP_
...
namespace Models
{
  class AccountContactEditResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const AccountContactEditResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AccountContactEditResponseBody& obj) { 
    ...
    AccountContactEditResponseBody() = default ;
    AccountContactEditResponseBody(const AccountContactEditResponseBody &) = default ;
    AccountContactEditResponseBody(AccountContactEditResponseBody &&) = default ;
    AccountContactEditResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AccountContactEditResponseBody() = default ;
    AccountContactEditResponseBody& operator=(const AccountContactEditResponseBody &) = default ;
    AccountContactEditResponseBody& operator=(AccountContactEditResponseBody &&) = default ;
    ...
    inline AccountContactEditResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const AccountContactEditResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, AccountContactEditResponseBody::Data) };
    inline AccountContactEditResponseBody::Data getData() { DARABONBA_PTR_GET(data_, AccountContactEditResponseBody::Data) };
    inline AccountContactEditResponseBody& setData(const AccountContactEditResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline AccountContactEditResponseBody& setData(AccountContactEditResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline AccountContactEditResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline AccountContactEditResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline AccountContactEditResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
