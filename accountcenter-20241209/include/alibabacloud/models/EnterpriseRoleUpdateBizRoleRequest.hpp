...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISEROLEUPDATEBIZROLEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISEROLEUPDATEBIZROLEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseRoleUpdateBizRoleRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseRoleUpdateBizRoleRequest& obj) { 
    ...
    EnterpriseRoleUpdateBizRoleRequest() = default ;
    EnterpriseRoleUpdateBizRoleRequest(const EnterpriseRoleUpdateBizRoleRequest &) = default ;
    EnterpriseRoleUpdateBizRoleRequest(EnterpriseRoleUpdateBizRoleRequest &&) = default ;
    EnterpriseRoleUpdateBizRoleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseRoleUpdateBizRoleRequest() = default ;
    EnterpriseRoleUpdateBizRoleRequest& operator=(const EnterpriseRoleUpdateBizRoleRequest &) = default ;
    EnterpriseRoleUpdateBizRoleRequest& operator=(EnterpriseRoleUpdateBizRoleRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->bizPermissionCodeListJson_ == nullptr
        && this->bizRoleCode_ == nullptr && this->bizRoleDesc_ == nullptr && this->bizRoleName_ == nullptr && this->encryptTicket_ == nullptr && this->orientedEcId_ == nullptr
        && this->orientedLeId_ == nullptr && this->orientedNbId_ == nullptr; };
    ...
    inline EnterpriseRoleUpdateBizRoleRequest& setBizPermissionCodeListJson(string bizPermissionCodeListJson) { DARABONBA_PTR_SET_VALUE(bizPermissionCodeListJson_, bizPermissionCodeListJson) };
    ...
    inline EnterpriseRoleUpdateBizRoleRequest& setBizRoleCode(string bizRoleCode) { DARABONBA_PTR_SET_VALUE(bizRoleCode_, bizRoleCode) };
    ...
    inline EnterpriseRoleUpdateBizRoleRequest& setBizRoleDesc(string bizRoleDesc) { DARABONBA_PTR_SET_VALUE(bizRoleDesc_, bizRoleDesc) };
    ...
    inline EnterpriseRoleUpdateBizRoleRequest& setBizRoleName(string bizRoleName) { DARABONBA_PTR_SET_VALUE(bizRoleName_, bizRoleName) };
    ...
    inline EnterpriseRoleUpdateBizRoleRequest& setEncryptTicket(string encryptTicket) { DARABONBA_PTR_SET_VALUE(encryptTicket_, encryptTicket) };
    ...
    inline EnterpriseRoleUpdateBizRoleRequest& setOrientedEcId(string orientedEcId) { DARABONBA_PTR_SET_VALUE(orientedEcId_, orientedEcId) };
    ...
    inline EnterpriseRoleUpdateBizRoleRequest& setOrientedLeId(string orientedLeId) { DARABONBA_PTR_SET_VALUE(orientedLeId_, orientedLeId) };
    ...
    inline EnterpriseRoleUpdateBizRoleRequest& setOrientedNbId(string orientedNbId) { DARABONBA_PTR_SET_VALUE(orientedNbId_, orientedNbId) };
