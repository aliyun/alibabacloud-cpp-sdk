...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISEACCOUNTQUERYACCOUNTGRANTEDROLESREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISEACCOUNTQUERYACCOUNTGRANTEDROLESREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseAccountQueryAccountGrantedRolesRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseAccountQueryAccountGrantedRolesRequest& obj) { 
    ...
    EnterpriseAccountQueryAccountGrantedRolesRequest() = default ;
    EnterpriseAccountQueryAccountGrantedRolesRequest(const EnterpriseAccountQueryAccountGrantedRolesRequest &) = default ;
    EnterpriseAccountQueryAccountGrantedRolesRequest(EnterpriseAccountQueryAccountGrantedRolesRequest &&) = default ;
    EnterpriseAccountQueryAccountGrantedRolesRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseAccountQueryAccountGrantedRolesRequest() = default ;
    EnterpriseAccountQueryAccountGrantedRolesRequest& operator=(const EnterpriseAccountQueryAccountGrantedRolesRequest &) = default ;
    EnterpriseAccountQueryAccountGrantedRolesRequest& operator=(EnterpriseAccountQueryAccountGrantedRolesRequest &&) = default ;
    ...
    inline EnterpriseAccountQueryAccountGrantedRolesRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline EnterpriseAccountQueryAccountGrantedRolesRequest& setIsOpenApi(bool isOpenApi) { DARABONBA_PTR_SET_VALUE(isOpenApi_, isOpenApi) };
    ...
    inline EnterpriseAccountQueryAccountGrantedRolesRequest& setOrientedEcId(string orientedEcId) { DARABONBA_PTR_SET_VALUE(orientedEcId_, orientedEcId) };
    ...
    inline EnterpriseAccountQueryAccountGrantedRolesRequest& setOrientedLeId(string orientedLeId) { DARABONBA_PTR_SET_VALUE(orientedLeId_, orientedLeId) };
    ...
    inline EnterpriseAccountQueryAccountGrantedRolesRequest& setOrientedNbId(string orientedNbId) { DARABONBA_PTR_SET_VALUE(orientedNbId_, orientedNbId) };
    ...
    inline EnterpriseAccountQueryAccountGrantedRolesRequest& setPk(string pk) { DARABONBA_PTR_SET_VALUE(pk_, pk) };
    ...
    inline EnterpriseAccountQueryAccountGrantedRolesRequest& setShowCompleteInfo(bool showCompleteInfo) { DARABONBA_PTR_SET_VALUE(showCompleteInfo_, showCompleteInfo) };
