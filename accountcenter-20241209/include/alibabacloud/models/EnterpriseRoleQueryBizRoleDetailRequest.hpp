...
#ifndef ALIBABACLOUD_MODELS_ENTERPRISEROLEQUERYBIZROLEDETAILREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ENTERPRISEROLEQUERYBIZROLEDETAILREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const EnterpriseRoleQueryBizRoleDetailRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, EnterpriseRoleQueryBizRoleDetailRequest& obj) { 
    ...
    EnterpriseRoleQueryBizRoleDetailRequest() = default ;
    EnterpriseRoleQueryBizRoleDetailRequest(const EnterpriseRoleQueryBizRoleDetailRequest &) = default ;
    EnterpriseRoleQueryBizRoleDetailRequest(EnterpriseRoleQueryBizRoleDetailRequest &&) = default ;
    EnterpriseRoleQueryBizRoleDetailRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~EnterpriseRoleQueryBizRoleDetailRequest() = default ;
    EnterpriseRoleQueryBizRoleDetailRequest& operator=(const EnterpriseRoleQueryBizRoleDetailRequest &) = default ;
    EnterpriseRoleQueryBizRoleDetailRequest& operator=(EnterpriseRoleQueryBizRoleDetailRequest &&) = default ;
    ...
    inline EnterpriseRoleQueryBizRoleDetailRequest& setBizRoleCode(string bizRoleCode) { DARABONBA_PTR_SET_VALUE(bizRoleCode_, bizRoleCode) };
    ...
    inline EnterpriseRoleQueryBizRoleDetailRequest& setEncryptTicket(string encryptTicket) { DARABONBA_PTR_SET_VALUE(encryptTicket_, encryptTicket) };
    ...
    inline EnterpriseRoleQueryBizRoleDetailRequest& setOrientedEcId(string orientedEcId) { DARABONBA_PTR_SET_VALUE(orientedEcId_, orientedEcId) };
    ...
    inline EnterpriseRoleQueryBizRoleDetailRequest& setOrientedLeId(string orientedLeId) { DARABONBA_PTR_SET_VALUE(orientedLeId_, orientedLeId) };
    ...
    inline EnterpriseRoleQueryBizRoleDetailRequest& setOrientedNbId(string orientedNbId) { DARABONBA_PTR_SET_VALUE(orientedNbId_, orientedNbId) };
