...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeThreatEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeThreatEventResponseBody) };
    inline DescribeThreatEventResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeThreatEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeThreatEventResponseBody> body_ {};
  };
