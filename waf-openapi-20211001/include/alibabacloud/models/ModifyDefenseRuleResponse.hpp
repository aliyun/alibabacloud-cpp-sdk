...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDefenseRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDefenseRuleResponseBody) };
    inline ModifyDefenseRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDefenseRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDefenseRuleResponseBody> body_ {};
  };
