...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDefenseResourceTemplatesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDefenseResourceTemplatesResponseBody) };
    inline DescribeDefenseResourceTemplatesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDefenseResourceTemplatesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDefenseResourceTemplatesResponseBody> body_ = nullptr;
  };
