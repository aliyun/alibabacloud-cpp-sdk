...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDomainRequest::Listen & getListen() const { DARABONBA_PTR_GET_CONST(listen_, ModifyDomainRequest::Listen) };
    inline ModifyDomainRequest::Listen getListen() { DARABONBA_PTR_GET(listen_, ModifyDomainRequest::Listen) };
    inline ModifyDomainRequest& setListen(const ModifyDomainRequest::Listen & listen) { DARABONBA_PTR_SET_VALUE(listen_, listen) };
    inline ModifyDomainRequest& setListen(ModifyDomainRequest::Listen && listen) { DARABONBA_PTR_SET_RVALUE(listen_, listen) };


    // redirect Field Functions 
    bool hasRedirect() const { return this->redirect_ != nullptr;};
    void deleteRedirect() { this->redirect_ = nullptr;};
    inline const ModifyDomainRequest::Redirect & getRedirect() const { DARABONBA_PTR_GET_CONST(redirect_, ModifyDomainRequest::Redirect) };
    inline ModifyDomainRequest::Redirect getRedirect() { DARABONBA_PTR_GET(redirect_, ModifyDomainRequest::Redirect) };
    inline ModifyDomainRequest& setRedirect(const ModifyDomainRequest::Redirect & redirect) { DARABONBA_PTR_SET_VALUE(redirect_, redirect) };
    inline ModifyDomainRequest& setRedirect(ModifyDomainRequest::Redirect && redirect) { DARABONBA_PTR_SET_RVALUE(redirect_, redirect) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<ModifyDomainRequest::Listen> listen_ {};
    // The forwarding configurations.
    // 
    // This parameter is required.
    shared_ptr<ModifyDomainRequest::Redirect> redirect_ {};
