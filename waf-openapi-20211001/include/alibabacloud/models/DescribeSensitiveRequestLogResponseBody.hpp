...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSensitiveRequestLogResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeSensitiveRequestLogResponseBodyData>) };
    inline vector<DescribeSensitiveRequestLogResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeSensitiveRequestLogResponseBodyData>) };
    inline DescribeSensitiveRequestLogResponseBody& setData(const vector<DescribeSensitiveRequestLogResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSensitiveRequestLogResponseBody& setData(vector<DescribeSensitiveRequestLogResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The access logs.
    std::shared_ptr<vector<DescribeSensitiveRequestLogResponseBodyData>> data_ = nullptr;
    // The request ID.
