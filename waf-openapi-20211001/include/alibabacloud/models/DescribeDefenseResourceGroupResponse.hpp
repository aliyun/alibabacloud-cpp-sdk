...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDefenseResourceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDefenseResourceGroupResponseBody) };
    inline DescribeDefenseResourceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDefenseResourceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDefenseResourceGroupResponseBody> body_ {};
  };
