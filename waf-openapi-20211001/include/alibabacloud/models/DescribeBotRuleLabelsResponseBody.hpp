...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->maxResults_ == nullptr
        && return this->nextToken_ == nullptr && return this->requestId_ == nullptr && return this->ruleLabels_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const vector<DescribeBotRuleLabelsResponseBodyRuleLabels> & ruleLabels() const { DARABONBA_PTR_GET_CONST(ruleLabels_, vector<DescribeBotRuleLabelsResponseBodyRuleLabels>) };
    inline vector<DescribeBotRuleLabelsResponseBodyRuleLabels> ruleLabels() { DARABONBA_PTR_GET(ruleLabels_, vector<DescribeBotRuleLabelsResponseBodyRuleLabels>) };
    inline DescribeBotRuleLabelsResponseBody& setRuleLabels(const vector<DescribeBotRuleLabelsResponseBodyRuleLabels> & ruleLabels) { DARABONBA_PTR_SET_VALUE(ruleLabels_, ruleLabels) };
    inline DescribeBotRuleLabelsResponseBody& setRuleLabels(vector<DescribeBotRuleLabelsResponseBodyRuleLabels> && ruleLabels) { DARABONBA_PTR_SET_RVALUE(ruleLabels_, ruleLabels) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeBotRuleLabelsResponseBodyRuleLabels>> ruleLabels_ = nullptr;
