...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserAbnormalTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserAbnormalTypeResponseBody) };
    inline DescribeUserAbnormalTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUserAbnormalTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserAbnormalTypeResponseBody> body_ {};
  };
