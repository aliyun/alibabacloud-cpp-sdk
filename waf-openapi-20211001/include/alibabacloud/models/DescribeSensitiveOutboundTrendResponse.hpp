...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSensitiveOutboundTrendResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSensitiveOutboundTrendResponseBody) };
    inline DescribeSensitiveOutboundTrendResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSensitiveOutboundTrendResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSensitiveOutboundTrendResponseBody> body_ {};
  };
