...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getLogKeyList() const { DARABONBA_PTR_GET_CONST(logKeyList_, vector<string>) };
    inline vector<string> getLogKeyList() { DARABONBA_PTR_GET(logKeyList_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> logKeyList_ {};
