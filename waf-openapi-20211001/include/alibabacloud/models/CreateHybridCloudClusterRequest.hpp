...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessMode_ == nullptr
        && return this->accessRegion_ == nullptr && return this->clusterName_ == nullptr && return this->httpPorts_ == nullptr && return this->httpsPorts_ == nullptr && return this->instanceId_ == nullptr
        && return this->logFieldsNotReturned_ == nullptr && return this->protectionServerCount_ == nullptr && return this->proxyStatus_ == nullptr && return this->proxyType_ == nullptr && return this->regionId_ == nullptr
        && return this->remark_ == nullptr && return this->resourceManagerResourceGroupId_ == nullptr && return this->ruleConfig_ == nullptr && return this->ruleStatus_ == nullptr && return this->ruleType_ == nullptr; };
