...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceResponseBody) };
    inline DescribeInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceResponseBody> body_ {};
  };
