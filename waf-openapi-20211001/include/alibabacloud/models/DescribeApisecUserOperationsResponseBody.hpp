...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeApisecUserOperationsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeApisecUserOperationsResponseBodyData>) };
    inline vector<DescribeApisecUserOperationsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeApisecUserOperationsResponseBodyData>) };
    inline DescribeApisecUserOperationsResponseBody& setData(const vector<DescribeApisecUserOperationsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApisecUserOperationsResponseBody& setData(vector<DescribeApisecUserOperationsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeApisecUserOperationsResponseBodyData>> data_ = nullptr;
    // The request ID.
