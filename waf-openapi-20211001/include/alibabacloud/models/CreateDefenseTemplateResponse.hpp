...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDefenseTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDefenseTemplateResponseBody) };
    inline CreateDefenseTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDefenseTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDefenseTemplateResponseBody> body_ {};
  };
