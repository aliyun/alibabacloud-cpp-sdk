...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceLogStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceLogStatusResponseBody) };
    inline DescribeResourceLogStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourceLogStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourceLogStatusResponseBody> body_ {};
  };
