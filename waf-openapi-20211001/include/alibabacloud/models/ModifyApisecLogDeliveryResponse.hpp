...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyApisecLogDeliveryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyApisecLogDeliveryResponseBody) };
    inline ModifyApisecLogDeliveryResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyApisecLogDeliveryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyApisecLogDeliveryResponseBody> body_ {};
  };
