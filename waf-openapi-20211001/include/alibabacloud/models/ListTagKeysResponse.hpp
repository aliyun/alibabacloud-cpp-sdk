...
namespace Models
{
  ...
  public:
    ...
    inline const ListTagKeysResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListTagKeysResponseBody) };
    inline ListTagKeysResponseBody getBody() { DARABONBA_PTR_GET(body_, ListTagKeysResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListTagKeysResponseBody> body_ {};
  };
