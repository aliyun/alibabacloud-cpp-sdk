...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeApisecSuggestionsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeApisecSuggestionsResponseBodyData>) };
    inline vector<DescribeApisecSuggestionsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeApisecSuggestionsResponseBodyData>) };
    inline DescribeApisecSuggestionsResponseBody& setData(const vector<DescribeApisecSuggestionsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApisecSuggestionsResponseBody& setData(vector<DescribeApisecSuggestionsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeApisecSuggestionsResponseBodyData>> data_ = nullptr;
    // The request ID.
