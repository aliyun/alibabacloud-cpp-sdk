...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getBindAssets() const { DARABONBA_PTR_GET_CONST(bindAssets_, vector<string>) };
    inline vector<string> getBindAssets() { DARABONBA_PTR_GET(bindAssets_, vector<string>) };
    ...
    inline const vector<string> & getBindResourceGroups() const { DARABONBA_PTR_GET_CONST(bindResourceGroups_, vector<string>) };
    inline vector<string> getBindResourceGroups() { DARABONBA_PTR_GET(bindResourceGroups_, vector<string>) };
    ...
    inline const vector<string> & getBindResources() const { DARABONBA_PTR_GET_CONST(bindResources_, vector<string>) };
    ...
    inline const vector<string> & getUnbindAssets() const { DARABONBA_PTR_GET_CONST(unbindAssets_, vector<string>) };
    inline vector<string> getUnbindAssets() { DARABONBA_PTR_GET(unbindAssets_, vector<string>) };
