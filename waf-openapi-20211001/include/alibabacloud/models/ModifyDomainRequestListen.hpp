...
#ifndef ALIBABACLOUD_MODELS_MODIFYDOMAINREQUESTLISTEN_HPP_
#define ALIBABACLOUD_MODELS_MODIFYDOMAINREQUESTLISTEN_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyDomainRequestListen& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyDomainRequestListen& obj) { 
    ...
    ModifyDomainRequestListen() = default ;
    ModifyDomainRequestListen(const ModifyDomainRequestListen &) = default ;
    ModifyDomainRequestListen(ModifyDomainRequestListen &&) = default ;
    ModifyDomainRequestListen(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyDomainRequestListen() = default ;
    ModifyDomainRequestListen& operator=(const ModifyDomainRequestListen &) = default ;
    ModifyDomainRequestListen& operator=(ModifyDomainRequestListen &&) = default ;
    ...
    inline ModifyDomainRequestListen& setCertId(string certId) { DARABONBA_PTR_SET_VALUE(certId_, certId) };
    ...
    inline ModifyDomainRequestListen& setCipherSuite(int32_t cipherSuite) { DARABONBA_PTR_SET_VALUE(cipherSuite_, cipherSuite) };
    ...
    inline ModifyDomainRequestListen& setCustomCiphers(const vector<string> & customCiphers) { DARABONBA_PTR_SET_VALUE(customCiphers_, customCiphers) };
    inline ModifyDomainRequestListen& setCustomCiphers(vector<string> && customCiphers) { DARABONBA_PTR_SET_RVALUE(customCiphers_, customCiphers) };
    ...
    inline ModifyDomainRequestListen& setEnableTLSv3(bool enableTLSv3) { DARABONBA_PTR_SET_VALUE(enableTLSv3_, enableTLSv3) };
    ...
    inline ModifyDomainRequestListen& setExclusiveIp(bool exclusiveIp) { DARABONBA_PTR_SET_VALUE(exclusiveIp_, exclusiveIp) };
    ...
    inline ModifyDomainRequestListen& setFocusHttps(bool focusHttps) { DARABONBA_PTR_SET_VALUE(focusHttps_, focusHttps) };
    ...
    inline ModifyDomainRequestListen& setHttp2Enabled(bool http2Enabled) { DARABONBA_PTR_SET_VALUE(http2Enabled_, http2Enabled) };
    ...
    inline ModifyDomainRequestListen& setHttpPorts(const vector<int32_t> & httpPorts) { DARABONBA_PTR_SET_VALUE(httpPorts_, httpPorts) };
    inline ModifyDomainRequestListen& setHttpPorts(vector<int32_t> && httpPorts) { DARABONBA_PTR_SET_RVALUE(httpPorts_, httpPorts) };
    ...
    inline ModifyDomainRequestListen& setHttpsPorts(const vector<int32_t> & httpsPorts) { DARABONBA_PTR_SET_VALUE(httpsPorts_, httpsPorts) };
    inline ModifyDomainRequestListen& setHttpsPorts(vector<int32_t> && httpsPorts) { DARABONBA_PTR_SET_RVALUE(httpsPorts_, httpsPorts) };
    ...
    inline ModifyDomainRequestListen& setIPv6Enabled(bool IPv6Enabled) { DARABONBA_PTR_SET_VALUE(IPv6Enabled_, IPv6Enabled) };
    ...
    inline ModifyDomainRequestListen& setProtectionResource(string protectionResource) { DARABONBA_PTR_SET_VALUE(protectionResource_, protectionResource) };
    ...
    inline ModifyDomainRequestListen& setSM2AccessOnly(bool SM2AccessOnly) { DARABONBA_PTR_SET_VALUE(SM2AccessOnly_, SM2AccessOnly) };
    ...
    inline ModifyDomainRequestListen& setSM2CertId(string SM2CertId) { DARABONBA_PTR_SET_VALUE(SM2CertId_, SM2CertId) };
    ...
    inline ModifyDomainRequestListen& setSM2Enabled(bool SM2Enabled) { DARABONBA_PTR_SET_VALUE(SM2Enabled_, SM2Enabled) };
    ...
    inline ModifyDomainRequestListen& setTLSVersion(string TLSVersion) { DARABONBA_PTR_SET_VALUE(TLSVersion_, TLSVersion) };
    ...
    inline ModifyDomainRequestListen& setXffHeaderMode(int32_t xffHeaderMode) { DARABONBA_PTR_SET_VALUE(xffHeaderMode_, xffHeaderMode) };
    ...
    inline ModifyDomainRequestListen& setXffHeaders(const vector<string> & xffHeaders) { DARABONBA_PTR_SET_VALUE(xffHeaders_, xffHeaders) };
    inline ModifyDomainRequestListen& setXffHeaders(vector<string> && xffHeaders) { DARABONBA_PTR_SET_RVALUE(xffHeaders_, xffHeaders) };
