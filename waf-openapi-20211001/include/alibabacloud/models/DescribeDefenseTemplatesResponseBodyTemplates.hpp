...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDEFENSETEMPLATESRESPONSEBODYTEMPLATES_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDEFENSETEMPLATESRESPONSEBODYTEMPLATES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDefenseTemplatesResponseBodyTemplates& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDefenseTemplatesResponseBodyTemplates& obj) { 
    ...
    DescribeDefenseTemplatesResponseBodyTemplates() = default ;
    DescribeDefenseTemplatesResponseBodyTemplates(const DescribeDefenseTemplatesResponseBodyTemplates &) = default ;
    DescribeDefenseTemplatesResponseBodyTemplates(DescribeDefenseTemplatesResponseBodyTemplates &&) = default ;
    DescribeDefenseTemplatesResponseBodyTemplates(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDefenseTemplatesResponseBodyTemplates() = default ;
    DescribeDefenseTemplatesResponseBodyTemplates& operator=(const DescribeDefenseTemplatesResponseBodyTemplates &) = default ;
    DescribeDefenseTemplatesResponseBodyTemplates& operator=(DescribeDefenseTemplatesResponseBodyTemplates &&) = default ;
    ...
    inline DescribeDefenseTemplatesResponseBodyTemplates& setDefenseScene(string defenseScene) { DARABONBA_PTR_SET_VALUE(defenseScene_, defenseScene) };
    ...
    inline DescribeDefenseTemplatesResponseBodyTemplates& setDefenseSubScene(string defenseSubScene) { DARABONBA_PTR_SET_VALUE(defenseSubScene_, defenseSubScene) };
    ...
    inline DescribeDefenseTemplatesResponseBodyTemplates& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeDefenseTemplatesResponseBodyTemplates& setGmtModified(int64_t gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline DescribeDefenseTemplatesResponseBodyTemplates& setTemplateId(int64_t templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
    ...
    inline DescribeDefenseTemplatesResponseBodyTemplates& setTemplateName(string templateName) { DARABONBA_PTR_SET_VALUE(templateName_, templateName) };
    ...
    inline DescribeDefenseTemplatesResponseBodyTemplates& setTemplateOrigin(string templateOrigin) { DARABONBA_PTR_SET_VALUE(templateOrigin_, templateOrigin) };
    ...
    inline DescribeDefenseTemplatesResponseBodyTemplates& setTemplateStatus(int32_t templateStatus) { DARABONBA_PTR_SET_VALUE(templateStatus_, templateStatus) };
    ...
    inline DescribeDefenseTemplatesResponseBodyTemplates& setTemplateType(string templateType) { DARABONBA_PTR_SET_VALUE(templateType_, templateType) };
