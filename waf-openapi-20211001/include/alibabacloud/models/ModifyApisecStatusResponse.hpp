...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyApisecStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyApisecStatusResponseBody) };
    inline ModifyApisecStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyApisecStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyApisecStatusResponseBody> body_ {};
  };
