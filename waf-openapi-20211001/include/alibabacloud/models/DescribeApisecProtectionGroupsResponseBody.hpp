...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEAPISECPROTECTIONGROUPSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEAPISECPROTECTIONGROUPSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeApisecProtectionGroupsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(TotalCount, totalCount_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeApisecProtectionGroupsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(TotalCount, totalCount_);
    };
    DescribeApisecProtectionGroupsResponseBody() = default ;
    DescribeApisecProtectionGroupsResponseBody(const DescribeApisecProtectionGroupsResponseBody &) = default ;
    DescribeApisecProtectionGroupsResponseBody(DescribeApisecProtectionGroupsResponseBody &&) = default ;
    DescribeApisecProtectionGroupsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeApisecProtectionGroupsResponseBody() = default ;
    DescribeApisecProtectionGroupsResponseBody& operator=(const DescribeApisecProtectionGroupsResponseBody &) = default ;
    DescribeApisecProtectionGroupsResponseBody& operator=(DescribeApisecProtectionGroupsResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->apisecStatus_ == nullptr
        && this->reportStatus_ == nullptr && this->resourceGroup_ == nullptr && this->traceStatus_ == nullptr; };
      ...
      inline Data& setResourceGroup(string resourceGroup) { DARABONBA_PTR_SET_VALUE(resourceGroup_, resourceGroup) };
    ...
    inline const vector<DescribeApisecProtectionGroupsResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeApisecProtectionGroupsResponseBody::Data>) };
    inline vector<DescribeApisecProtectionGroupsResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<DescribeApisecProtectionGroupsResponseBody::Data>) };
    inline DescribeApisecProtectionGroupsResponseBody& setData(const vector<DescribeApisecProtectionGroupsResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApisecProtectionGroupsResponseBody& setData(vector<DescribeApisecProtectionGroupsResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribeApisecProtectionGroupsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeApisecProtectionGroupsResponseBody& setTotalCount(int64_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
