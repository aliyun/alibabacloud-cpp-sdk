...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyHybridCloudGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyHybridCloudGroupResponseBody) };
    inline ModifyHybridCloudGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyHybridCloudGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyHybridCloudGroupResponseBody> body_ {};
  };
