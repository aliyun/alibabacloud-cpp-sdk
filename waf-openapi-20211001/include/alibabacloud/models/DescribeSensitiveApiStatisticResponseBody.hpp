...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSensitiveApiStatisticResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeSensitiveApiStatisticResponseBodyData>) };
    inline vector<DescribeSensitiveApiStatisticResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeSensitiveApiStatisticResponseBodyData>) };
    inline DescribeSensitiveApiStatisticResponseBody& setData(const vector<DescribeSensitiveApiStatisticResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSensitiveApiStatisticResponseBody& setData(vector<DescribeSensitiveApiStatisticResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The statistics.
    std::shared_ptr<vector<DescribeSensitiveApiStatisticResponseBodyData>> data_ = nullptr;
    // The request ID.
