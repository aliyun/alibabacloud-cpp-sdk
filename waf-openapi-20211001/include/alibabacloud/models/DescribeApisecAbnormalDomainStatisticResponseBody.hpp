...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeApisecAbnormalDomainStatisticResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeApisecAbnormalDomainStatisticResponseBody::Data>) };
    inline vector<DescribeApisecAbnormalDomainStatisticResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<DescribeApisecAbnormalDomainStatisticResponseBody::Data>) };
    inline DescribeApisecAbnormalDomainStatisticResponseBody& setData(const vector<DescribeApisecAbnormalDomainStatisticResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApisecAbnormalDomainStatisticResponseBody& setData(vector<DescribeApisecAbnormalDomainStatisticResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
