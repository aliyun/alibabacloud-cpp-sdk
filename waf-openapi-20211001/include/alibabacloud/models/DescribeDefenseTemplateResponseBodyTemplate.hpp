...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDEFENSETEMPLATERESPONSEBODYTEMPLATE_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDEFENSETEMPLATERESPONSEBODYTEMPLATE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDefenseTemplateResponseBodyTemplate& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDefenseTemplateResponseBodyTemplate& obj) { 
    ...
    DescribeDefenseTemplateResponseBodyTemplate() = default ;
    DescribeDefenseTemplateResponseBodyTemplate(const DescribeDefenseTemplateResponseBodyTemplate &) = default ;
    DescribeDefenseTemplateResponseBodyTemplate(DescribeDefenseTemplateResponseBodyTemplate &&) = default ;
    DescribeDefenseTemplateResponseBodyTemplate(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDefenseTemplateResponseBodyTemplate() = default ;
    DescribeDefenseTemplateResponseBodyTemplate& operator=(const DescribeDefenseTemplateResponseBodyTemplate &) = default ;
    DescribeDefenseTemplateResponseBodyTemplate& operator=(DescribeDefenseTemplateResponseBodyTemplate &&) = default ;
    ...
    inline DescribeDefenseTemplateResponseBodyTemplate& setDefenseScene(string defenseScene) { DARABONBA_PTR_SET_VALUE(defenseScene_, defenseScene) };
    ...
    inline DescribeDefenseTemplateResponseBodyTemplate& setDefenseSubScene(string defenseSubScene) { DARABONBA_PTR_SET_VALUE(defenseSubScene_, defenseSubScene) };
    ...
    inline DescribeDefenseTemplateResponseBodyTemplate& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeDefenseTemplateResponseBodyTemplate& setGmtModified(int64_t gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline DescribeDefenseTemplateResponseBodyTemplate& setTemplateId(int64_t templateId) { DARABONBA_PTR_SET_VALUE(templateId_, templateId) };
    ...
    inline DescribeDefenseTemplateResponseBodyTemplate& setTemplateName(string templateName) { DARABONBA_PTR_SET_VALUE(templateName_, templateName) };
    ...
    inline DescribeDefenseTemplateResponseBodyTemplate& setTemplateOrigin(string templateOrigin) { DARABONBA_PTR_SET_VALUE(templateOrigin_, templateOrigin) };
    ...
    inline DescribeDefenseTemplateResponseBodyTemplate& setTemplateStatus(int32_t templateStatus) { DARABONBA_PTR_SET_VALUE(templateStatus_, templateStatus) };
    ...
    inline DescribeDefenseTemplateResponseBodyTemplate& setTemplateType(string templateType) { DARABONBA_PTR_SET_VALUE(templateType_, templateType) };
