...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cloudResourceId_ == nullptr
        && return this->instanceId_ == nullptr && return this->listen_ == nullptr && return this->redirect_ == nullptr && return this->regionId_ == nullptr && return this->resourceManagerResourceGroupId_ == nullptr; };
