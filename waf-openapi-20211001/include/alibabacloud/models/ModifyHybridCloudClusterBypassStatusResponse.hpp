...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyHybridCloudClusterBypassStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyHybridCloudClusterBypassStatusResponseBody) };
    inline ModifyHybridCloudClusterBypassStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyHybridCloudClusterBypassStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyHybridCloudClusterBypassStatusResponseBody> body_ {};
  };
