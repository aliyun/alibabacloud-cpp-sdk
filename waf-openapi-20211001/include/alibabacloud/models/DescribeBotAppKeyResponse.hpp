...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBotAppKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBotAppKeyResponseBody) };
    inline DescribeBotAppKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBotAppKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBotAppKeyResponseBody> body_ {};
  };
