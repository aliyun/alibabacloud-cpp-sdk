...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->rules_ == nullptr && return this->totalCount_ == nullptr; };
    ...
    inline const vector<DescribeDefenseRulesResponseBodyRules> & rules() const { DARABONBA_PTR_GET_CONST(rules_, vector<DescribeDefenseRulesResponseBodyRules>) };
    inline vector<DescribeDefenseRulesResponseBodyRules> rules() { DARABONBA_PTR_GET(rules_, vector<DescribeDefenseRulesResponseBodyRules>) };
    inline DescribeDefenseRulesResponseBody& setRules(const vector<DescribeDefenseRulesResponseBodyRules> & rules) { DARABONBA_PTR_SET_VALUE(rules_, rules) };
    inline DescribeDefenseRulesResponseBody& setRules(vector<DescribeDefenseRulesResponseBodyRules> && rules) { DARABONBA_PTR_SET_RVALUE(rules_, rules) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDefenseRulesResponseBodyRules>> rules_ = nullptr;
