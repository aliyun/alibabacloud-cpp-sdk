...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRuleGroupsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeRuleGroupsResponseBody) };
    inline DescribeRuleGroupsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeRuleGroupsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRuleGroupsResponseBody> body_ = nullptr;
  };
