...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFreeUserEventCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeFreeUserEventCountResponseBody) };
    inline DescribeFreeUserEventCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeFreeUserEventCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeFreeUserEventCountResponseBody> body_ {};
  };
