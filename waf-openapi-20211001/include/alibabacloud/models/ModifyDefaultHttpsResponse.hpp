...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDefaultHttpsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDefaultHttpsResponseBody) };
    inline ModifyDefaultHttpsResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDefaultHttpsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDefaultHttpsResponseBody> body_ {};
  };
