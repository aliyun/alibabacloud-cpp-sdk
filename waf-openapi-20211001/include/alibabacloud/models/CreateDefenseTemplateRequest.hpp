...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->defenseScene_ == nullptr
        && return this->description_ == nullptr && return this->instanceId_ == nullptr && return this->regionId_ == nullptr && return this->resourceManagerResourceGroupId_ == nullptr && return this->templateName_ == nullptr
        && return this->templateOrigin_ == nullptr && return this->templateStatus_ == nullptr && return this->templateType_ == nullptr && return this->unbindResourceGroups_ == nullptr && return this->unbindResources_ == nullptr; };
