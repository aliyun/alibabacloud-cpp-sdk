...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDefenseResourceTemplatesResponseBody::Templates> & getTemplates() const { DARABONBA_PTR_GET_CONST(templates_, vector<DescribeDefenseResourceTemplatesResponseBody::Templates>) };
    inline vector<DescribeDefenseResourceTemplatesResponseBody::Templates> getTemplates() { DARABONBA_PTR_GET(templates_, vector<DescribeDefenseResourceTemplatesResponseBody::Templates>) };
    inline DescribeDefenseResourceTemplatesResponseBody& setTemplates(const vector<DescribeDefenseResourceTemplatesResponseBody::Templates> & templates) { DARABONBA_PTR_SET_VALUE(templates_, templates) };
    inline DescribeDefenseResourceTemplatesResponseBody& setTemplates(vector<DescribeDefenseResourceTemplatesResponseBody::Templates> && templates) { DARABONBA_PTR_SET_RVALUE(templates_, templates) };
  ...
  protected:
    ...
    shared_ptr<vector<DescribeDefenseResourceTemplatesResponseBody::Templates>> templates_ {};
  };
