...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->certId_ == nullptr
        ...
        && return this->SM2AccessOnly_ == nullptr && return this->SM2CertId_ == nullptr && return this->SM2Enabled_ == nullptr && return this->TLSVersion_ == nullptr && return this->xffHeaderMode_ == nullptr
        && return this->xffHeaders_ == nullptr; };
