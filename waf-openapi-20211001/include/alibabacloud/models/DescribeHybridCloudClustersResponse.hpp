...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHybridCloudClustersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHybridCloudClustersResponseBody) };
    inline DescribeHybridCloudClustersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHybridCloudClustersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHybridCloudClustersResponseBody> body_ {};
  };
