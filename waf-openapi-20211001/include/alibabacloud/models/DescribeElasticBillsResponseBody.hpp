  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->credit_ == nullptr
        && this->cu_ == nullptr && this->endTime_ == nullptr && this->functionCredit_ == nullptr && this->functionCu_ == nullptr && this->startTime_ == nullptr
        && this->trafficCredit_ == nullptr && this->trafficCu_ == nullptr; };
      ...
      inline Bills& setCredit(double credit) { DARABONBA_PTR_SET_VALUE(credit_, credit) };
      ...
      inline Bills& setFunctionCredit(double functionCredit) { DARABONBA_PTR_SET_VALUE(functionCredit_, functionCredit) };
      ...
      inline Bills& setTrafficCredit(double trafficCredit) { DARABONBA_PTR_SET_VALUE(trafficCredit_, trafficCredit) };
