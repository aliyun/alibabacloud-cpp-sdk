...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCustomBaseRuleCompileResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCustomBaseRuleCompileResultResponseBody) };
    inline DescribeCustomBaseRuleCompileResultResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCustomBaseRuleCompileResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCustomBaseRuleCompileResultResponseBody> body_ {};
  };
