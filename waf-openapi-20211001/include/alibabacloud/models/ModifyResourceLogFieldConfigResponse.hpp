...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyResourceLogFieldConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyResourceLogFieldConfigResponseBody) };
    inline ModifyResourceLogFieldConfigResponseBody body() { DARABONBA_PTR_GET(body_, ModifyResourceLogFieldConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyResourceLogFieldConfigResponseBody> body_ = nullptr;
  };
