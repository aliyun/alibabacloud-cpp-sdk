...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSensitiveRequestLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSensitiveRequestLogResponseBody) };
    inline DescribeSensitiveRequestLogResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSensitiveRequestLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSensitiveRequestLogResponseBody> body_ {};
  };
