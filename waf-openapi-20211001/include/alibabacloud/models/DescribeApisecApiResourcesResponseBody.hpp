...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeApisecApiResourcesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeApisecApiResourcesResponseBodyData>) };
    inline vector<DescribeApisecApiResourcesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeApisecApiResourcesResponseBodyData>) };
    inline DescribeApisecApiResourcesResponseBody& setData(const vector<DescribeApisecApiResourcesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApisecApiResourcesResponseBody& setData(vector<DescribeApisecApiResourcesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The API assets.
    std::shared_ptr<vector<DescribeApisecApiResourcesResponseBodyData>> data_ = nullptr;
    // The request ID.
