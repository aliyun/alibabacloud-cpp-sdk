...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->punishedDomains_ == nullptr
    ...
    inline const vector<string> & getPunishedDomains() const { DARABONBA_PTR_GET_CONST(punishedDomains_, vector<string>) };
    inline vector<string> getPunishedDomains() { DARABONBA_PTR_GET(punishedDomains_, vector<string>) };
