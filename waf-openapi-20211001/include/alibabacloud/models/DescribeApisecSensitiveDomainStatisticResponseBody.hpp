...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeApisecSensitiveDomainStatisticResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeApisecSensitiveDomainStatisticResponseBodyData>) };
    inline vector<DescribeApisecSensitiveDomainStatisticResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeApisecSensitiveDomainStatisticResponseBodyData>) };
    inline DescribeApisecSensitiveDomainStatisticResponseBody& setData(const vector<DescribeApisecSensitiveDomainStatisticResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApisecSensitiveDomainStatisticResponseBody& setData(vector<DescribeApisecSensitiveDomainStatisticResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeApisecSensitiveDomainStatisticResponseBodyData>> data_ = nullptr;
    // The request ID.
