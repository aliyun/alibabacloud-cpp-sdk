...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->cloudResources_ != nullptr
    ...
    inline const vector<DescribeCloudResourcesResponseBodyCloudResources> & cloudResources() const { DARABONBA_PTR_GET_CONST(cloudResources_, vector<DescribeCloudResourcesResponseBodyCloudResources>) };
    inline vector<DescribeCloudResourcesResponseBodyCloudResources> cloudResources() { DARABONBA_PTR_GET(cloudResources_, vector<DescribeCloudResourcesResponseBodyCloudResources>) };
    inline DescribeCloudResourcesResponseBody& setCloudResources(const vector<DescribeCloudResourcesResponseBodyCloudResources> & cloudResources) { DARABONBA_PTR_SET_VALUE(cloudResources_, cloudResources) };
    inline DescribeCloudResourcesResponseBody& setCloudResources(vector<DescribeCloudResourcesResponseBodyCloudResources> && cloudResources) { DARABONBA_PTR_SET_RVALUE(cloudResources_, cloudResources) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeCloudResourcesResponseBodyCloudResources>> cloudResources_ = nullptr;
    // The request ID.
