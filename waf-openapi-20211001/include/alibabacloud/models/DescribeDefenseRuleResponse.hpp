...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDefenseRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDefenseRuleResponseBody) };
    inline DescribeDefenseRuleResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDefenseRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDefenseRuleResponseBody> body_ = nullptr;
  };
