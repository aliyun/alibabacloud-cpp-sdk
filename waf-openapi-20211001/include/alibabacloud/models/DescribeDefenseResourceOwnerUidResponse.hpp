...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDefenseResourceOwnerUidResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDefenseResourceOwnerUidResponseBody) };
    inline DescribeDefenseResourceOwnerUidResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDefenseResourceOwnerUidResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDefenseResourceOwnerUidResponseBody> body_ {};
  };
