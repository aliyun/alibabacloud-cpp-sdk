...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyResourceLogStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyResourceLogStatusResponseBody) };
    inline ModifyResourceLogStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyResourceLogStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyResourceLogStatusResponseBody> body_ {};
  };
