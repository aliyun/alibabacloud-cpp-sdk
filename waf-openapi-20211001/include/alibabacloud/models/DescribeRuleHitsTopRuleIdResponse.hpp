...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRuleHitsTopRuleIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRuleHitsTopRuleIdResponseBody) };
    inline DescribeRuleHitsTopRuleIdResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRuleHitsTopRuleIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRuleHitsTopRuleIdResponseBody> body_ {};
  };
