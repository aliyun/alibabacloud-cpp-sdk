...
#ifndef ALIBABACLOUD_MODELS_ADDADDRESSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDADDRESSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddAddressRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AddressList, addressList_);
      DARABONBA_PTR_TO_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_TO_JSON(ResourceManagerResourceGroupId, resourceManagerResourceGroupId_);
      DARABONBA_PTR_TO_JSON(RuleId, ruleId_);
    };
    friend void from_json(const Darabonba::Json& j, AddAddressRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AddressList, addressList_);
      DARABONBA_PTR_FROM_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_FROM_JSON(ResourceManagerResourceGroupId, resourceManagerResourceGroupId_);
      DARABONBA_PTR_FROM_JSON(RuleId, ruleId_);
    };
    AddAddressRequest() = default ;
    AddAddressRequest(const AddAddressRequest &) = default ;
    AddAddressRequest(AddAddressRequest &&) = default ;
    AddAddressRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddAddressRequest() = default ;
    AddAddressRequest& operator=(const AddAddressRequest &) = default ;
    AddAddressRequest& operator=(AddAddressRequest &&) = default ;
