...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeApisecAbnormalsResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeApisecAbnormalsResponseBodyData>) };
    inline vector<DescribeApisecAbnormalsResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeApisecAbnormalsResponseBodyData>) };
    inline DescribeApisecAbnormalsResponseBody& setData(const vector<DescribeApisecAbnormalsResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApisecAbnormalsResponseBody& setData(vector<DescribeApisecAbnormalsResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    // The risks.
    std::shared_ptr<vector<DescribeApisecAbnormalsResponseBodyData>> data_ = nullptr;
    // The request ID.
