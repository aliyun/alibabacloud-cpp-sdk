...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHybridCloudUnsupportPortsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHybridCloudUnsupportPortsResponseBody) };
    inline DescribeHybridCloudUnsupportPortsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHybridCloudUnsupportPortsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHybridCloudUnsupportPortsResponseBody> body_ {};
  };
