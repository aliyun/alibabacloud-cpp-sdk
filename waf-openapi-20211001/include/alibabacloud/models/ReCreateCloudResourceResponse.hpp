...
namespace Models
{
  ...
  public:
    ...
    inline const ReCreateCloudResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ReCreateCloudResourceResponseBody) };
    inline ReCreateCloudResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, ReCreateCloudResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ReCreateCloudResourceResponseBody> body_ {};
  };
