...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAbnormalCloudResourcesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAbnormalCloudResourcesResponseBody) };
    inline DescribeAbnormalCloudResourcesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAbnormalCloudResourcesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAbnormalCloudResourcesResponseBody> body_ = nullptr;
  };
