...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWafSourceIpSegmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWafSourceIpSegmentResponseBody) };
    inline DescribeWafSourceIpSegmentResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWafSourceIpSegmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWafSourceIpSegmentResponseBody> body_ {};
  };
