...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHybridCloudClusterRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHybridCloudClusterRuleResponseBody) };
    inline CreateHybridCloudClusterRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHybridCloudClusterRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHybridCloudClusterRuleResponseBody> body_ {};
  };
