...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceLogDeliveryStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceLogDeliveryStatusResponseBody) };
    inline DescribeResourceLogDeliveryStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourceLogDeliveryStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourceLogDeliveryStatusResponseBody> body_ {};
  };
