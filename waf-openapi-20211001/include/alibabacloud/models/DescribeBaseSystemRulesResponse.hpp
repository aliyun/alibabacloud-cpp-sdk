...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBaseSystemRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBaseSystemRulesResponseBody) };
    inline DescribeBaseSystemRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBaseSystemRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBaseSystemRulesResponseBody> body_ {};
  };
