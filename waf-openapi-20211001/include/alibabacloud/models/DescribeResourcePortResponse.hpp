...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourcePortResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourcePortResponseBody) };
    inline DescribeResourcePortResponseBody body() { DARABONBA_PTR_GET(body_, DescribeResourcePortResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeResourcePortResponseBody> body_ = nullptr;
  };
