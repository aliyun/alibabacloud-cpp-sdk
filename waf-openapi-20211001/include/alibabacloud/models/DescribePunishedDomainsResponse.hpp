...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePunishedDomainsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePunishedDomainsResponseBody) };
    inline DescribePunishedDomainsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePunishedDomainsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePunishedDomainsResponseBody> body_ {};
  };
