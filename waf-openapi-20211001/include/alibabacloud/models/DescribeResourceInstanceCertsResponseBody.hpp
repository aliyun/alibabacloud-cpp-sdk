...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeResourceInstanceCertsResponseBodyCerts> & certs() const { DARABONBA_PTR_GET_CONST(certs_, vector<DescribeResourceInstanceCertsResponseBodyCerts>) };
    inline vector<DescribeResourceInstanceCertsResponseBodyCerts> certs() { DARABONBA_PTR_GET(certs_, vector<DescribeResourceInstanceCertsResponseBodyCerts>) };
    inline DescribeResourceInstanceCertsResponseBody& setCerts(const vector<DescribeResourceInstanceCertsResponseBodyCerts> & certs) { DARABONBA_PTR_SET_VALUE(certs_, certs) };
    inline DescribeResourceInstanceCertsResponseBody& setCerts(vector<DescribeResourceInstanceCertsResponseBodyCerts> && certs) { DARABONBA_PTR_SET_RVALUE(certs_, certs) };
  ...
  protected:
    // The certificates.
    std::shared_ptr<vector<DescribeResourceInstanceCertsResponseBodyCerts>> certs_ = nullptr;
    // The request ID.
