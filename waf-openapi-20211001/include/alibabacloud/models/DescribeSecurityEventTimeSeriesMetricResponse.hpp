...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSecurityEventTimeSeriesMetricResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSecurityEventTimeSeriesMetricResponseBody) };
    inline DescribeSecurityEventTimeSeriesMetricResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSecurityEventTimeSeriesMetricResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSecurityEventTimeSeriesMetricResponseBody> body_ {};
  };
