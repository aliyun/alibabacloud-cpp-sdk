...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDefenseTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDefenseTemplateResponseBody) };
    inline DeleteDefenseTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDefenseTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDefenseTemplateResponseBody> body_ {};
  };
