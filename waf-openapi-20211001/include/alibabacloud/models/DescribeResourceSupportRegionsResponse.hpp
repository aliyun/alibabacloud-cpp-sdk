...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceSupportRegionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceSupportRegionsResponseBody) };
    inline DescribeResourceSupportRegionsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourceSupportRegionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourceSupportRegionsResponseBody> body_ {};
  };
