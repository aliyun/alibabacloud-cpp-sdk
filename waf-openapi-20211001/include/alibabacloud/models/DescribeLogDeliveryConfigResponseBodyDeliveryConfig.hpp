...
#ifndef ALIBABACLOUD_MODELS_DESCRIBELOGDELIVERYCONFIGRESPONSEBODYDELIVERYCONFIG_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBELOGDELIVERYCONFIGRESPONSEBODYDELIVERYCONFIG_HPP_
...
namespace Models
{
  class DescribeLogDeliveryConfigResponseBodyDeliveryConfig : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeLogDeliveryConfigResponseBodyDeliveryConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeLogDeliveryConfigResponseBodyDeliveryConfig& obj) { 
    ...
    DescribeLogDeliveryConfigResponseBodyDeliveryConfig() = default ;
    DescribeLogDeliveryConfigResponseBodyDeliveryConfig(const DescribeLogDeliveryConfigResponseBodyDeliveryConfig &) = default ;
    DescribeLogDeliveryConfigResponseBodyDeliveryConfig(DescribeLogDeliveryConfigResponseBodyDeliveryConfig &&) = default ;
    DescribeLogDeliveryConfigResponseBodyDeliveryConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeLogDeliveryConfigResponseBodyDeliveryConfig() = default ;
    DescribeLogDeliveryConfigResponseBodyDeliveryConfig& operator=(const DescribeLogDeliveryConfigResponseBodyDeliveryConfig &) = default ;
    DescribeLogDeliveryConfigResponseBodyDeliveryConfig& operator=(DescribeLogDeliveryConfigResponseBodyDeliveryConfig &&) = default ;
    ...
    inline DescribeLogDeliveryConfigResponseBodyDeliveryConfig& setDeliveryDetail(string deliveryDetail) { DARABONBA_PTR_SET_VALUE(deliveryDetail_, deliveryDetail) };
    ...
    inline DescribeLogDeliveryConfigResponseBodyDeliveryConfig& setDeliveryName(string deliveryName) { DARABONBA_PTR_SET_VALUE(deliveryName_, deliveryName) };
    ...
    inline DescribeLogDeliveryConfigResponseBodyDeliveryConfig& setDeliveryType(string deliveryType) { DARABONBA_PTR_SET_VALUE(deliveryType_, deliveryType) };
