...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainDNSRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainDNSRecordResponseBody) };
    inline DescribeDomainDNSRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainDNSRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainDNSRecordResponseBody> body_ {};
  };
