...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApisecStatisticsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeApisecStatisticsResponseBodyData) };
    inline DescribeApisecStatisticsResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeApisecStatisticsResponseBodyData) };
    inline DescribeApisecStatisticsResponseBody& setData(const DescribeApisecStatisticsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeApisecStatisticsResponseBody& setData(DescribeApisecStatisticsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeApisecStatisticsResponseBodyData> data_ = nullptr;
    // The request ID.
