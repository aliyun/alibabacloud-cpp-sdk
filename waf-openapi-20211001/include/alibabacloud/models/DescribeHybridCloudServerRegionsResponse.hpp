...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHybridCloudServerRegionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHybridCloudServerRegionsResponseBody) };
    inline DescribeHybridCloudServerRegionsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHybridCloudServerRegionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHybridCloudServerRegionsResponseBody> body_ {};
  };
