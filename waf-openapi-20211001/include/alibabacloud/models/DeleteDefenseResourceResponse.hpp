...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDefenseResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDefenseResourceResponseBody) };
    inline DeleteDefenseResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDefenseResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDefenseResourceResponseBody> body_ {};
  };
