...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appliedType_ == nullptr
        && return this->certId_ == nullptr && return this->certName_ == nullptr && return this->commonName_ == nullptr && return this->domain_ == nullptr && return this->expireTime_ == nullptr
        && return this->productCertId_ == nullptr && return this->productCertName_ == nullptr && return this->reasonCode_ == nullptr; };
