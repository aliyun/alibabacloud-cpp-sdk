...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApisecProtectionResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApisecProtectionResourcesResponseBody) };
    inline DescribeApisecProtectionResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApisecProtectionResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApisecProtectionResourcesResponseBody> body_ {};
  };
