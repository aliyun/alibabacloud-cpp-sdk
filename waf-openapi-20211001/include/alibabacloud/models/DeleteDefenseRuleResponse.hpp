...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDefenseRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDefenseRuleResponseBody) };
    inline DeleteDefenseRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDefenseRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDefenseRuleResponseBody> body_ {};
  };
