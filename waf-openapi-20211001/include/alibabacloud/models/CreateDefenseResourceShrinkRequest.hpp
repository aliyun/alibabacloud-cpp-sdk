...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateDefenseResourceShrinkRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateDefenseResourceShrinkRequest::Tag>) };
    inline vector<CreateDefenseResourceShrinkRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateDefenseResourceShrinkRequest::Tag>) };
    inline CreateDefenseResourceShrinkRequest& setTag(const vector<CreateDefenseResourceShrinkRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateDefenseResourceShrinkRequest& setTag(vector<CreateDefenseResourceShrinkRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
