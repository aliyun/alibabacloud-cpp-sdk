...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSensitiveOutboundTrendResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeSensitiveOutboundTrendResponseBodyData>) };
    inline vector<DescribeSensitiveOutboundTrendResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeSensitiveOutboundTrendResponseBodyData>) };
    inline DescribeSensitiveOutboundTrendResponseBody& setData(const vector<DescribeSensitiveOutboundTrendResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSensitiveOutboundTrendResponseBody& setData(vector<DescribeSensitiveOutboundTrendResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeSensitiveOutboundTrendResponseBodyData>> data_ = nullptr;
    // The request ID.
