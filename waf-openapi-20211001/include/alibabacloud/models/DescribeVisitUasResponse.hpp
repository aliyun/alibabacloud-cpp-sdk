...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVisitUasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVisitUasResponseBody) };
    inline DescribeVisitUasResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVisitUasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVisitUasResponseBody> body_ {};
  };
