...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApisecAssetTrendResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeApisecAssetTrendResponseBody) };
    inline DescribeApisecAssetTrendResponseBody body() { DARABONBA_PTR_GET(body_, DescribeApisecAssetTrendResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeApisecAssetTrendResponseBody> body_ = nullptr;
  };
