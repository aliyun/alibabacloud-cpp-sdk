...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCloudResourcesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeCloudResourcesResponseBody) };
    inline DescribeCloudResourcesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeCloudResourcesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCloudResourcesResponseBody> body_ = nullptr;
  };
