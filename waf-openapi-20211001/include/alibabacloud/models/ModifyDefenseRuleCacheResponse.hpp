...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDefenseRuleCacheResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDefenseRuleCacheResponseBody) };
    inline ModifyDefenseRuleCacheResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDefenseRuleCacheResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDefenseRuleCacheResponseBody> body_ {};
  };
