...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApiExportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateApiExportResponseBody) };
    inline CreateApiExportResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateApiExportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateApiExportResponseBody> body_ {};
  };
