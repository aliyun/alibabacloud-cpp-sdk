...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCnameCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCnameCountResponseBody) };
    inline DescribeCnameCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCnameCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCnameCountResponseBody> body_ {};
  };
