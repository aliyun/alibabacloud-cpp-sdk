...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDefenseResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDefenseResourceResponseBody) };
    inline DescribeDefenseResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDefenseResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDefenseResourceResponseBody> body_ {};
  };
