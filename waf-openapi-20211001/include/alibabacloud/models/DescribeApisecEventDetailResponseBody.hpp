...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attackCnt_ == nullptr
        && this->attackerList_ == nullptr && this->detailValue_ == nullptr && this->endTs_ == nullptr && this->eventId_ == nullptr && this->eventLevel_ == nullptr
        && this->eventScope_ == nullptr && this->eventTag_ == nullptr && this->note_ == nullptr && this->origin_ == nullptr && this->requestId_ == nullptr
        && this->startTs_ == nullptr && this->userStatus_ == nullptr; };
    ...
    inline string getAttackCnt() const { DARABONBA_PTR_GET_DEFAULT(attackCnt_, "") };
    ...
    inline string getDetailValue() const { DARABONBA_PTR_GET_DEFAULT(detailValue_, "") };
