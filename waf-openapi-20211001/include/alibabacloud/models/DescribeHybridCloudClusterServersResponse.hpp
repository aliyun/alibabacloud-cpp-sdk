...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHybridCloudClusterServersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHybridCloudClusterServersResponseBody) };
    inline DescribeHybridCloudClusterServersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHybridCloudClusterServersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHybridCloudClusterServersResponseBody> body_ {};
  };
