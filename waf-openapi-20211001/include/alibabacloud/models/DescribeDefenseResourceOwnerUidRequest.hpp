...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instanceId_ == nullptr
        && return this->regionId_ == nullptr && return this->resourceManagerResourceGroupId_ == nullptr && return this->resourceNames_ == nullptr; };
    ...
    inline string resourceNames() const { DARABONBA_PTR_GET_DEFAULT(resourceNames_, "") };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<string> resourceNames_ = nullptr;
  };
