...
#ifndef ALIBABACLOUD_MODELS_CREATECLOUDRESOURCEREQUESTREDIRECT_HPP_
#define ALIBABACLOUD_MODELS_CREATECLOUDRESOURCEREQUESTREDIRECT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateCloudResourceRequestRedirect& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateCloudResourceRequestRedirect& obj) { 
    ...
    CreateCloudResourceRequestRedirect() = default ;
    CreateCloudResourceRequestRedirect(const CreateCloudResourceRequestRedirect &) = default ;
    CreateCloudResourceRequestRedirect(CreateCloudResourceRequestRedirect &&) = default ;
    CreateCloudResourceRequestRedirect(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateCloudResourceRequestRedirect() = default ;
    CreateCloudResourceRequestRedirect& operator=(const CreateCloudResourceRequestRedirect &) = default ;
    CreateCloudResourceRequestRedirect& operator=(CreateCloudResourceRequestRedirect &&) = default ;
    ...
    inline CreateCloudResourceRequestRedirect& setKeepalive(bool keepalive) { DARABONBA_PTR_SET_VALUE(keepalive_, keepalive) };
    ...
    inline CreateCloudResourceRequestRedirect& setKeepaliveRequests(int32_t keepaliveRequests) { DARABONBA_PTR_SET_VALUE(keepaliveRequests_, keepaliveRequests) };
    ...
    inline CreateCloudResourceRequestRedirect& setReadTimeout(int32_t readTimeout) { DARABONBA_PTR_SET_VALUE(readTimeout_, readTimeout) };
    ...
    inline const vector<Models::CreateCloudResourceRequestRedirectRequestHeaders> & requestHeaders() const { DARABONBA_PTR_GET_CONST(requestHeaders_, vector<Models::CreateCloudResourceRequestRedirectRequestHeaders>) };
    inline vector<Models::CreateCloudResourceRequestRedirectRequestHeaders> requestHeaders() { DARABONBA_PTR_GET(requestHeaders_, vector<Models::CreateCloudResourceRequestRedirectRequestHeaders>) };
    inline CreateCloudResourceRequestRedirect& setRequestHeaders(const vector<Models::CreateCloudResourceRequestRedirectRequestHeaders> & requestHeaders) { DARABONBA_PTR_SET_VALUE(requestHeaders_, requestHeaders) };
    inline CreateCloudResourceRequestRedirect& setRequestHeaders(vector<Models::CreateCloudResourceRequestRedirectRequestHeaders> && requestHeaders) { DARABONBA_PTR_SET_RVALUE(requestHeaders_, requestHeaders) };
    ...
    inline CreateCloudResourceRequestRedirect& setWriteTimeout(int32_t writeTimeout) { DARABONBA_PTR_SET_VALUE(writeTimeout_, writeTimeout) };
    ...
    inline CreateCloudResourceRequestRedirect& setXffHeaderMode(int32_t xffHeaderMode) { DARABONBA_PTR_SET_VALUE(xffHeaderMode_, xffHeaderMode) };
    ...
    inline CreateCloudResourceRequestRedirect& setXffHeaders(const vector<string> & xffHeaders) { DARABONBA_PTR_SET_VALUE(xffHeaders_, xffHeaders) };
    inline CreateCloudResourceRequestRedirect& setXffHeaders(vector<string> && xffHeaders) { DARABONBA_PTR_SET_RVALUE(xffHeaders_, xffHeaders) };
    ...
    inline CreateCloudResourceRequestRedirect& setXffProto(bool xffProto) { DARABONBA_PTR_SET_VALUE(xffProto_, xffProto) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::CreateCloudResourceRequestRedirectRequestHeaders>> requestHeaders_ = nullptr;
