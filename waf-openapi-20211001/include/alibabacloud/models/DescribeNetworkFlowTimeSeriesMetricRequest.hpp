...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNetworkFlowTimeSeriesMetricRequest::Filter & getFilter() const { DARABONBA_PTR_GET_CONST(filter_, DescribeNetworkFlowTimeSeriesMetricRequest::Filter) };
    inline DescribeNetworkFlowTimeSeriesMetricRequest::Filter getFilter() { DARABONBA_PTR_GET(filter_, DescribeNetworkFlowTimeSeriesMetricRequest::Filter) };
    inline DescribeNetworkFlowTimeSeriesMetricRequest& setFilter(const DescribeNetworkFlowTimeSeriesMetricRequest::Filter & filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    inline DescribeNetworkFlowTimeSeriesMetricRequest& setFilter(DescribeNetworkFlowTimeSeriesMetricRequest::Filter && filter) { DARABONBA_PTR_SET_RVALUE(filter_, filter) };
