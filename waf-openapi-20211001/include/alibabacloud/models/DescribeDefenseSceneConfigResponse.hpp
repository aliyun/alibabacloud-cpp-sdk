...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDefenseSceneConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDefenseSceneConfigResponseBody) };
    inline DescribeDefenseSceneConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDefenseSceneConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDefenseSceneConfigResponseBody> body_ {};
  };
