...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyApisecLogDeliveryStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyApisecLogDeliveryStatusResponseBody) };
    inline ModifyApisecLogDeliveryStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyApisecLogDeliveryStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyApisecLogDeliveryStatusResponseBody> body_ {};
  };
