...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceInstanceCertsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceInstanceCertsResponseBody) };
    inline DescribeResourceInstanceCertsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourceInstanceCertsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourceInstanceCertsResponseBody> body_ {};
  };
