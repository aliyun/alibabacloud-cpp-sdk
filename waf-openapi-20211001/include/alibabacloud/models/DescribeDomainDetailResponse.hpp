...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainDetailResponseBody) };
    inline DescribeDomainDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainDetailResponseBody> body_ {};
  };
