...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDefenseResourceGroupNamesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDefenseResourceGroupNamesResponseBody) };
    inline DescribeDefenseResourceGroupNamesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDefenseResourceGroupNamesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDefenseResourceGroupNamesResponseBody> body_ {};
  };
