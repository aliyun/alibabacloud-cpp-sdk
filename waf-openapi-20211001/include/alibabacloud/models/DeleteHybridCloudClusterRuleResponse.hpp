...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHybridCloudClusterRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHybridCloudClusterRuleResponseBody) };
    inline DeleteHybridCloudClusterRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHybridCloudClusterRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHybridCloudClusterRuleResponseBody> body_ {};
  };
