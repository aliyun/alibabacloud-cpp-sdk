...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTemplateResourceCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTemplateResourceCountResponseBody) };
    inline DescribeTemplateResourceCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTemplateResourceCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTemplateResourceCountResponseBody> body_ {};
  };
