...
namespace Models
{
  ...
  public:
    ...
    inline const ClearAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ClearAddressResponseBody) };
    inline ClearAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, ClearAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ClearAddressResponseBody> body_ {};
  };
