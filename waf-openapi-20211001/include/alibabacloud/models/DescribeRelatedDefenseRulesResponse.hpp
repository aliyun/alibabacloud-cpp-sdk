...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRelatedDefenseRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRelatedDefenseRulesResponseBody) };
    inline DescribeRelatedDefenseRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRelatedDefenseRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRelatedDefenseRulesResponseBody> body_ {};
  };
