...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->groupNameLike_ == nullptr
        && this->groupNames_ == nullptr && this->instanceId_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->regionId_ == nullptr
    ...
    inline string getGroupNames() const { DARABONBA_PTR_GET_DEFAULT(groupNames_, "") };
