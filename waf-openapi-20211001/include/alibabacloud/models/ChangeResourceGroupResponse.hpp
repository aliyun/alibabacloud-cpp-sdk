...
namespace Models
{
  ...
  public:
    ...
    inline const ChangeResourceGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ChangeResourceGroupResponseBody) };
    inline ChangeResourceGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ChangeResourceGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ChangeResourceGroupResponseBody> body_ {};
  };
