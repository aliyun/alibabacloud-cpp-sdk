...
DescribeInstanceStatsInfoResponse Alibabacloud_CGCS20211111::Client::describeInstanceStatsInfoWithOptions(shared_ptr<DescribeInstanceStatsInfoRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("DescribeInstanceStatsInfo"))},
    {"version", boost::any(string("2021-11-11"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
  ...
  return DescribeInstanceStatsInfoResponse(callApi(params, req, runtime));
}

DescribeInstanceStatsInfoResponse Alibabacloud_CGCS20211111::Client::describeInstanceStatsInfo(shared_ptr<DescribeInstanceStatsInfoRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
