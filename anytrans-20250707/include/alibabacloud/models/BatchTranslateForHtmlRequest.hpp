...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->config_ == nullptr
        && this->domainHint_ == nullptr && this->examples_ == nullptr && this->langDetect_ == nullptr && this->sensitives_ == nullptr && this->terminologies_ == nullptr
    ...
    inline const BatchTranslateForHtmlRequest::Ext & getExt() const { DARABONBA_PTR_GET_CONST(ext_, BatchTranslateForHtmlRequest::Ext) };
    inline BatchTranslateForHtmlRequest::Ext getExt() { DARABONBA_PTR_GET(ext_, BatchTranslateForHtmlRequest::Ext) };
    inline BatchTranslateForHtmlRequest& setExt(const BatchTranslateForHtmlRequest::Ext & ext) { DARABONBA_PTR_SET_VALUE(ext_, ext) };
    inline BatchTranslateForHtmlRequest& setExt(BatchTranslateForHtmlRequest::Ext && ext) { DARABONBA_PTR_SET_RVALUE(ext_, ext) };
  ...
  protected:
    ...
    shared_ptr<BatchTranslateForHtmlRequest::Ext> ext_ {};
