  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->config_ == nullptr
        && this->domainHint_ == nullptr && this->examples_ == nullptr && this->langDetect_ == nullptr && this->paramMap_ == nullptr && this->sensitives_ == nullptr
        && this->terminologies_ == nullptr && this->textTransform_ == nullptr; };
    ...
    inline const BatchTranslateRequest::Ext & getExt() const { DARABONBA_PTR_GET_CONST(ext_, BatchTranslateRequest::Ext) };
    inline BatchTranslateRequest::Ext getExt() { DARABONBA_PTR_GET(ext_, BatchTranslateRequest::Ext) };
    inline BatchTranslateRequest& setExt(const BatchTranslateRequest::Ext & ext) { DARABONBA_PTR_SET_VALUE(ext_, ext) };
    inline BatchTranslateRequest& setExt(BatchTranslateRequest::Ext && ext) { DARABONBA_PTR_SET_RVALUE(ext_, ext) };
