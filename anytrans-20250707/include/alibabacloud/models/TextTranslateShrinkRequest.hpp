...
namespace Models
{
  ...
  public:
    ...
    inline TextTranslateShrinkRequest& setExtShrink(string extShrink) { DARABONBA_PTR_SET_VALUE(extShrink_, extShrink) };
    ...
    inline TextTranslateShrinkRequest& setFormat(string format) { DARABONBA_PTR_SET_VALUE(format_, format) };
    ...
    inline TextTranslateShrinkRequest& setScene(string scene) { DARABONBA_PTR_SET_VALUE(scene_, scene) };
    ...
    inline TextTranslateShrinkRequest& setText(string text) { DARABONBA_PTR_SET_VALUE(text_, text) };
    ...
    inline TextTranslateShrinkRequest& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
