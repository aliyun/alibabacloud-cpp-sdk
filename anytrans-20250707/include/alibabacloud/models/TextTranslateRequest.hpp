...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline Ext& setAgent(string agent) { DARABONBA_PTR_SET_VALUE(agent_, agent) };
      ...
      inline Ext& setPrefix(string prefix) { DARABONBA_PTR_SET_VALUE(prefix_, prefix) };
    ...
    inline const TextTranslateRequest::Ext & getExt() const { DARABONBA_PTR_GET_CONST(ext_, TextTranslateRequest::Ext) };
    inline TextTranslateRequest::Ext getExt() { DARABONBA_PTR_GET(ext_, TextTranslateRequest::Ext) };
    inline TextTranslateRequest& setExt(const TextTranslateRequest::Ext & ext) { DARABONBA_PTR_SET_VALUE(ext_, ext) };
    inline TextTranslateRequest& setExt(TextTranslateRequest::Ext && ext) { DARABONBA_PTR_SET_RVALUE(ext_, ext) };
    ...
    inline TextTranslateRequest& setFormat(string format) { DARABONBA_PTR_SET_VALUE(format_, format) };
    ...
    inline TextTranslateRequest& setScene(string scene) { DARABONBA_PTR_SET_VALUE(scene_, scene) };
    ...
    inline TextTranslateRequest& setText(string text) { DARABONBA_PTR_SET_VALUE(text_, text) };
    ...
    inline TextTranslateRequest& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
