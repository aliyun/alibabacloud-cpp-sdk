...
namespace Models
{
  ...
  public:
    ...
    inline const TextTranslateRequestExt & ext() const { DARABONBA_PTR_GET_CONST(ext_, TextTranslateRequestExt) };
    inline TextTranslateRequestExt ext() { DARABONBA_PTR_GET(ext_, TextTranslateRequestExt) };
    inline TextTranslateRequest& setExt(const TextTranslateRequestExt & ext) { DARABONBA_PTR_SET_VALUE(ext_, ext) };
    inline TextTranslateRequest& setExt(TextTranslateRequestExt && ext) { DARABONBA_PTR_SET_RVALUE(ext_, ext) };
  ...
  protected:
    std::shared_ptr<TextTranslateRequestExt> ext_ = nullptr;
