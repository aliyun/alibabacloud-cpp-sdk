...
namespace Models
{
  ...
  public:
    ...
    inline const GetLongTextTranslateTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetLongTextTranslateTaskResponseBody) };
    inline GetLongTextTranslateTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, GetLongTextTranslateTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetLongTextTranslateTaskResponseBody> body_ {};
  };
