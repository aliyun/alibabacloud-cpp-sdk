...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitImageTranslateTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SubmitImageTranslateTaskResponseBody) };
    inline SubmitImageTranslateTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, SubmitImageTranslateTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SubmitImageTranslateTaskResponseBody> body_ {};
  };
