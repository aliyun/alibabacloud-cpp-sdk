...
namespace Models
{
  ...
  public:
    ...
    inline const TermEditResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, TermEditResponseBodyData) };
    inline TermEditResponseBodyData data() { DARABONBA_PTR_GET(data_, TermEditResponseBodyData) };
    inline TermEditResponseBody& setData(const TermEditResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TermEditResponseBody& setData(TermEditResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<TermEditResponseBodyData> data_ = nullptr;
