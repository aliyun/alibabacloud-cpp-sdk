...
namespace Models
{
  ...
  public:
    ...
    inline const TermQueryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TermQueryResponseBody) };
    inline TermQueryResponseBody getBody() { DARABONBA_PTR_GET(body_, TermQueryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TermQueryResponseBody> body_ {};
  };
