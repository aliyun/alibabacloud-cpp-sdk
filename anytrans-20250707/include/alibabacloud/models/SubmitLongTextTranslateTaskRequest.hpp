...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitLongTextTranslateTaskRequest::Ext & getExt() const { DARABONBA_PTR_GET_CONST(ext_, SubmitLongTextTranslateTaskRequest::Ext) };
    inline SubmitLongTextTranslateTaskRequest::Ext getExt() { DARABONBA_PTR_GET(ext_, SubmitLongTextTranslateTaskRequest::Ext) };
    inline SubmitLongTextTranslateTaskRequest& setExt(const SubmitLongTextTranslateTaskRequest::Ext & ext) { DARABONBA_PTR_SET_VALUE(ext_, ext) };
    inline SubmitLongTextTranslateTaskRequest& setExt(SubmitLongTextTranslateTaskRequest::Ext && ext) { DARABONBA_PTR_SET_RVALUE(ext_, ext) };
