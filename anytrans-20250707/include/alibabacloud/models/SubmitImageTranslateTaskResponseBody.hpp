...
namespace Models
{
  ...
  public:
    ...
    inline const SubmitImageTranslateTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, SubmitImageTranslateTaskResponseBody::Data) };
    inline SubmitImageTranslateTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, SubmitImageTranslateTaskResponseBody::Data) };
    inline SubmitImageTranslateTaskResponseBody& setData(const SubmitImageTranslateTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SubmitImageTranslateTaskResponseBody& setData(SubmitImageTranslateTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
