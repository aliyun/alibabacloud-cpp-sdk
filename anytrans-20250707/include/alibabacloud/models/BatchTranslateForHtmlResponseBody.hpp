...
namespace Models
{
  ...
  public:
    ...
    inline const BatchTranslateForHtmlResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, BatchTranslateForHtmlResponseBodyData) };
    inline BatchTranslateForHtmlResponseBodyData data() { DARABONBA_PTR_GET(data_, BatchTranslateForHtmlResponseBodyData) };
    inline BatchTranslateForHtmlResponseBody& setData(const BatchTranslateForHtmlResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BatchTranslateForHtmlResponseBody& setData(BatchTranslateForHtmlResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<BatchTranslateForHtmlResponseBodyData> data_ = nullptr;
