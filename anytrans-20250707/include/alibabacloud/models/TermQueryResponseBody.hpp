...
#ifndef ALIBABACLOUD_MODELS_TERMQUERYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_TERMQUERYRESPONSEBODY_HPP_
...
namespace Models
{
  class TermQueryResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const TermQueryResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TermQueryResponseBody& obj) { 
    ...
    TermQueryResponseBody() = default ;
    TermQueryResponseBody(const TermQueryResponseBody &) = default ;
    TermQueryResponseBody(TermQueryResponseBody &&) = default ;
    TermQueryResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TermQueryResponseBody() = default ;
    TermQueryResponseBody& operator=(const TermQueryResponseBody &) = default ;
    TermQueryResponseBody& operator=(TermQueryResponseBody &&) = default ;
    ...
    inline TermQueryResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const TermQueryResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, TermQueryResponseBody::Data) };
    inline TermQueryResponseBody::Data getData() { DARABONBA_PTR_GET(data_, TermQueryResponseBody::Data) };
    inline TermQueryResponseBody& setData(const TermQueryResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline TermQueryResponseBody& setData(TermQueryResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline TermQueryResponseBody& setHttpStatusCode(string httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline TermQueryResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline TermQueryResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline TermQueryResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<TermQueryResponseBody::Data> data_ {};
