...
namespace Models
{
  ...
  public:
    ...
    inline const GetHtmlTranslateTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetHtmlTranslateTaskResponseBody::Data) };
    inline GetHtmlTranslateTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetHtmlTranslateTaskResponseBody::Data) };
    inline GetHtmlTranslateTaskResponseBody& setData(const GetHtmlTranslateTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetHtmlTranslateTaskResponseBody& setData(GetHtmlTranslateTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
