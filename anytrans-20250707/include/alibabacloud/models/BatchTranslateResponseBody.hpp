...
namespace Models
{
  ...
  public:
    ...
    inline const BatchTranslateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, BatchTranslateResponseBodyData) };
    inline BatchTranslateResponseBodyData data() { DARABONBA_PTR_GET(data_, BatchTranslateResponseBodyData) };
    inline BatchTranslateResponseBody& setData(const BatchTranslateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BatchTranslateResponseBody& setData(BatchTranslateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<BatchTranslateResponseBodyData> data_ = nullptr;
