  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->domainHint_ == nullptr
        && this->examples_ == nullptr && this->paramMap_ == nullptr && this->sensitives_ == nullptr && this->terminologies_ == nullptr && this->textTransform_ == nullptr
        && this->trackingData_ == nullptr; };
    ...
    inline const SubmitImageTranslateTaskRequest::Ext & getExt() const { DARABONBA_PTR_GET_CONST(ext_, SubmitImageTranslateTaskRequest::Ext) };
    inline SubmitImageTranslateTaskRequest::Ext getExt() { DARABONBA_PTR_GET(ext_, SubmitImageTranslateTaskRequest::Ext) };
    inline SubmitImageTranslateTaskRequest& setExt(const SubmitImageTranslateTaskRequest::Ext & ext) { DARABONBA_PTR_SET_VALUE(ext_, ext) };
    inline SubmitImageTranslateTaskRequest& setExt(SubmitImageTranslateTaskRequest::Ext && ext) { DARABONBA_PTR_SET_RVALUE(ext_, ext) };
    ...
    inline const vector<string> & getTargetLanguage() const { DARABONBA_PTR_GET_CONST(targetLanguage_, vector<string>) };
    inline vector<string> getTargetLanguage() { DARABONBA_PTR_GET(targetLanguage_, vector<string>) };
