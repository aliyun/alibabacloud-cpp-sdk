...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appName_ == nullptr
        && return this->clusterId_ == nullptr && return this->jobIds_ == nullptr; };
    // appName Field Functions 
    bool hasAppName() const { return this->appName_ != nullptr;};
    void deleteAppName() { this->appName_ = nullptr;};
    inline string appName() const { DARABONBA_PTR_GET_DEFAULT(appName_, "") };
    inline DeleteJobsRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline DeleteJobsRequest& setClusterId(string clusterId) { DARABONBA_PTR_SET_VALUE(clusterId_, clusterId) };
    ...
    inline DeleteJobsRequest& setJobIds(const vector<int64_t> & jobIds) { DARABONBA_PTR_SET_VALUE(jobIds_, jobIds) };
    inline DeleteJobsRequest& setJobIds(vector<int64_t> && jobIds) { DARABONBA_PTR_SET_RVALUE(jobIds_, jobIds) };
