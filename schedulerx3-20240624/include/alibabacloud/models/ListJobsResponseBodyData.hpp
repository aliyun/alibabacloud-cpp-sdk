...
namespace Models
{
  ...
  public:
    ...
    inline ListJobsResponseBodyData& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline const vector<Models::ListJobsResponseBodyDataRecords> & records() const { DARABONBA_PTR_GET_CONST(records_, vector<Models::ListJobsResponseBodyDataRecords>) };
    inline vector<Models::ListJobsResponseBodyDataRecords> records() { DARABONBA_PTR_GET(records_, vector<Models::ListJobsResponseBodyDataRecords>) };
    inline ListJobsResponseBodyData& setRecords(const vector<Models::ListJobsResponseBodyDataRecords> & records) { DARABONBA_PTR_SET_VALUE(records_, records) };
    inline ListJobsResponseBodyData& setRecords(vector<Models::ListJobsResponseBodyDataRecords> && records) { DARABONBA_PTR_SET_RVALUE(records_, records) };
    ...
    inline ListJobsResponseBodyData& setTotal(int32_t total) { DARABONBA_PTR_SET_VALUE(total_, total) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<vector<Models::ListJobsResponseBodyDataRecords>> records_ = nullptr;
