...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorkflowResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetWorkflowResponseBodyData) };
    inline GetWorkflowResponseBodyData data() { DARABONBA_PTR_GET(data_, GetWorkflowResponseBodyData) };
    inline GetWorkflowResponseBody& setData(const GetWorkflowResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetWorkflowResponseBody& setData(GetWorkflowResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<GetWorkflowResponseBodyData> data_ = nullptr;
