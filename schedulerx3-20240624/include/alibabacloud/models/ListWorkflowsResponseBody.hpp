...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkflowsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListWorkflowsResponseBodyData) };
    inline ListWorkflowsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListWorkflowsResponseBodyData) };
    inline ListWorkflowsResponseBody& setData(const ListWorkflowsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListWorkflowsResponseBody& setData(ListWorkflowsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListWorkflowsResponseBodyData> data_ = nullptr;
