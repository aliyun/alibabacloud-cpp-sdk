...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDesigateInfoResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetDesigateInfoResponseBody& obj) { 
    ...
    GetDesigateInfoResponseBody() = default ;
    GetDesigateInfoResponseBody(const GetDesigateInfoResponseBody &) = default ;
    GetDesigateInfoResponseBody(GetDesigateInfoResponseBody &&) = default ;
    GetDesigateInfoResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDesigateInfoResponseBody() = default ;
    GetDesigateInfoResponseBody& operator=(const GetDesigateInfoResponseBody &) = default ;
    GetDesigateInfoResponseBody& operator=(GetDesigateInfoResponseBody &&) = default ;
