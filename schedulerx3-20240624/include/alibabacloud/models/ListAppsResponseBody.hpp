...
namespace Models
{
  ...
  public:
    ...
    inline const ListAppsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAppsResponseBodyData) };
    inline ListAppsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAppsResponseBodyData) };
    inline ListAppsResponseBody& setData(const ListAppsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAppsResponseBody& setData(ListAppsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<ListAppsResponseBodyData> data_ = nullptr;
