...
namespace Models
{
  ...
  public:
    ...
    inline UpdateDatasourceResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UpdateDatasourceResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
