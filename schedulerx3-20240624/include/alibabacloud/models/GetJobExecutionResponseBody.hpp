...
namespace Models
{
  ...
  public:
    ...
    inline const GetJobExecutionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetJobExecutionResponseBodyData) };
    inline GetJobExecutionResponseBodyData data() { DARABONBA_PTR_GET(data_, GetJobExecutionResponseBodyData) };
    inline GetJobExecutionResponseBody& setData(const GetJobExecutionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetJobExecutionResponseBody& setData(GetJobExecutionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<GetJobExecutionResponseBodyData> data_ = nullptr;
