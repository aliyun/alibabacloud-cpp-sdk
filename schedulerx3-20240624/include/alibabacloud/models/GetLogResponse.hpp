...
namespace Models
{
  ...
  public:
    ...
    inline const GetLogResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetLogResponseBody) };
    inline GetLogResponseBody body() { DARABONBA_PTR_GET(body_, GetLogResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetLogResponseBody> body_ = nullptr;
  };
