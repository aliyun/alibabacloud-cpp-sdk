...
namespace Models
{
  ...
  public:
    ...
    inline UpdateJobRequestNoticeConfig& setEndEarly(int32_t endEarly) { DARABONBA_PTR_SET_VALUE(endEarly_, endEarly) };
    ...
    inline UpdateJobRequestNoticeConfig& setEndEarlyEnable(bool endEarlyEnable) { DARABONBA_PTR_SET_VALUE(endEarlyEnable_, endEarlyEnable) };
