...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateExecutorsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateExecutorsResponseBody) };
    inline UpdateExecutorsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateExecutorsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateExecutorsResponseBody> body_ {};
  };
