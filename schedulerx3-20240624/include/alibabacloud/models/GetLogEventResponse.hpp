...
namespace Models
{
  ...
  public:
    ...
    inline const GetLogEventResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetLogEventResponseBody) };
    inline GetLogEventResponseBody body() { DARABONBA_PTR_GET(body_, GetLogEventResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetLogEventResponseBody> body_ = nullptr;
  };
