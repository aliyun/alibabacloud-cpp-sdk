...
namespace Models
{
  ...
  public:
    ...
    inline const OperateRerunJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperateRerunJobResponseBody) };
    inline OperateRerunJobResponseBody getBody() { DARABONBA_PTR_GET(body_, OperateRerunJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperateRerunJobResponseBody> body_ {};
  };
