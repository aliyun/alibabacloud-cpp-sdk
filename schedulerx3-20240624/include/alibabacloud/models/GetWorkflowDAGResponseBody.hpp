...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorkflowDAGResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetWorkflowDAGResponseBody::Data) };
    inline GetWorkflowDAGResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetWorkflowDAGResponseBody::Data) };
    inline GetWorkflowDAGResponseBody& setData(const GetWorkflowDAGResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetWorkflowDAGResponseBody& setData(GetWorkflowDAGResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
