...
namespace Models
{
  ...
  public:
    ...
    inline const CreateClusterResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreateClusterResponseBodyData) };
    inline CreateClusterResponseBodyData data() { DARABONBA_PTR_GET(data_, CreateClusterResponseBodyData) };
    inline CreateClusterResponseBody& setData(const CreateClusterResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateClusterResponseBody& setData(CreateClusterResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<CreateClusterResponseBodyData> data_ = nullptr;
