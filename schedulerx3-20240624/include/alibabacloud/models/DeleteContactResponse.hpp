...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteContactResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteContactResponseBody) };
    inline DeleteContactResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteContactResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteContactResponseBody> body_ {};
  };
