...
#ifndef ALIBABACLOUD_MODELS_GETJOBEXECUTIONRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETJOBEXECUTIONRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetJobExecutionResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetJobExecutionResponseBodyData& obj) { 
    ...
    GetJobExecutionResponseBodyData() = default ;
    GetJobExecutionResponseBodyData(const GetJobExecutionResponseBodyData &) = default ;
    GetJobExecutionResponseBodyData(GetJobExecutionResponseBodyData &&) = default ;
    GetJobExecutionResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetJobExecutionResponseBodyData() = default ;
    GetJobExecutionResponseBodyData& operator=(const GetJobExecutionResponseBodyData &) = default ;
    GetJobExecutionResponseBodyData& operator=(GetJobExecutionResponseBodyData &&) = default ;
    ...
    inline GetJobExecutionResponseBodyData& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline GetJobExecutionResponseBodyData& setAttempt(int32_t attempt) { DARABONBA_PTR_SET_VALUE(attempt_, attempt) };
    ...
    inline GetJobExecutionResponseBodyData& setDataTime(string dataTime) { DARABONBA_PTR_SET_VALUE(dataTime_, dataTime) };
    ...
    inline GetJobExecutionResponseBodyData& setDuration(int64_t duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline GetJobExecutionResponseBodyData& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline GetJobExecutionResponseBodyData& setExecutor(string executor) { DARABONBA_PTR_SET_VALUE(executor_, executor) };
    ...
    inline GetJobExecutionResponseBodyData& setJobExecutionId(string jobExecutionId) { DARABONBA_PTR_SET_VALUE(jobExecutionId_, jobExecutionId) };
    ...
    inline GetJobExecutionResponseBodyData& setJobId(int64_t jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    ...
    inline GetJobExecutionResponseBodyData& setJobName(string jobName) { DARABONBA_PTR_SET_VALUE(jobName_, jobName) };
    ...
    inline GetJobExecutionResponseBodyData& setJobType(string jobType) { DARABONBA_PTR_SET_VALUE(jobType_, jobType) };
    ...
    inline GetJobExecutionResponseBodyData& setParameters(string parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    ...
    inline GetJobExecutionResponseBodyData& setResult(string result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    ...
    inline GetJobExecutionResponseBodyData& setRouteStrategy(int32_t routeStrategy) { DARABONBA_PTR_SET_VALUE(routeStrategy_, routeStrategy) };
    ...
    inline GetJobExecutionResponseBodyData& setScheduleTime(string scheduleTime) { DARABONBA_PTR_SET_VALUE(scheduleTime_, scheduleTime) };
    ...
    inline GetJobExecutionResponseBodyData& setServerIp(string serverIp) { DARABONBA_PTR_SET_VALUE(serverIp_, serverIp) };
    ...
    inline GetJobExecutionResponseBodyData& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline GetJobExecutionResponseBodyData& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetJobExecutionResponseBodyData& setTimeType(int32_t timeType) { DARABONBA_PTR_SET_VALUE(timeType_, timeType) };
    ...
    inline GetJobExecutionResponseBodyData& setTriggerType(int32_t triggerType) { DARABONBA_PTR_SET_VALUE(triggerType_, triggerType) };
