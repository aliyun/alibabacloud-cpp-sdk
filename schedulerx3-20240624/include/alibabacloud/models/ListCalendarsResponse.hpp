...
namespace Models
{
  ...
  public:
    ...
    inline const ListCalendarsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCalendarsResponseBody) };
    inline ListCalendarsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCalendarsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCalendarsResponseBody> body_ {};
  };
