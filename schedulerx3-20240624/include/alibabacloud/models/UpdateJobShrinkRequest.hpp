...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->appName_ != nullptr
        && this->attemptInterval_ != nullptr && this->calendar_ != nullptr && this->childJobId_ != nullptr && this->clusterId_ != nullptr && this->description_ != nullptr
        && this->executorBlockStrategy_ != nullptr && this->jobHandler_ != nullptr && this->jobId_ != nullptr && this->maxAttempt_ != nullptr && this->maxConcurrency_ != nullptr
        && this->name_ != nullptr && this->noticeConfigShrink_ != nullptr && this->noticeContactsShrink_ != nullptr && this->parameters_ != nullptr && this->priority_ != nullptr
        && this->routeStrategy_ != nullptr && this->script_ != nullptr && this->startTime_ != nullptr && this->timeExpression_ != nullptr && this->timeType_ != nullptr
        && this->timezone_ != nullptr && this->weight_ != nullptr; };
