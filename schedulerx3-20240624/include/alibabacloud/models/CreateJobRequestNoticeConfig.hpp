...
#ifndef ALIBABACLOUD_MODELS_CREATEJOBREQUESTNOTICECONFIG_HPP_
#define ALIBABACLOUD_MODELS_CREATEJOBREQUESTNOTICECONFIG_HPP_
...
namespace Models
{
  ...
  public:
    ...
    CreateJobRequestNoticeConfig() = default ;
    CreateJobRequestNoticeConfig(const CreateJobRequestNoticeConfig &) = default ;
    CreateJobRequestNoticeConfig(CreateJobRequestNoticeConfig &&) = default ;
    CreateJobRequestNoticeConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateJobRequestNoticeConfig() = default ;
    CreateJobRequestNoticeConfig& operator=(const CreateJobRequestNoticeConfig &) = default ;
    CreateJobRequestNoticeConfig& operator=(CreateJobRequestNoticeConfig &&) = default ;
    ...
    inline CreateJobRequestNoticeConfig& setFailEnable(bool failEnable) { DARABONBA_PTR_SET_VALUE(failEnable_, failEnable) };
    ...
    inline CreateJobRequestNoticeConfig& setFailLimitTimes(int32_t failLimitTimes) { DARABONBA_PTR_SET_VALUE(failLimitTimes_, failLimitTimes) };
    ...
    inline CreateJobRequestNoticeConfig& setMissWorkerEnable(bool missWorkerEnable) { DARABONBA_PTR_SET_VALUE(missWorkerEnable_, missWorkerEnable) };
    ...
    inline CreateJobRequestNoticeConfig& setSendChannel(string sendChannel) { DARABONBA_PTR_SET_VALUE(sendChannel_, sendChannel) };
    ...
    inline CreateJobRequestNoticeConfig& setSuccessNotice(bool successNotice) { DARABONBA_PTR_SET_VALUE(successNotice_, successNotice) };
    ...
    inline CreateJobRequestNoticeConfig& setTimeout(int64_t timeout) { DARABONBA_PTR_SET_VALUE(timeout_, timeout) };
    ...
    inline CreateJobRequestNoticeConfig& setTimeoutEnable(bool timeoutEnable) { DARABONBA_PTR_SET_VALUE(timeoutEnable_, timeoutEnable) };
    ...
    inline CreateJobRequestNoticeConfig& setTimeoutKillEnable(bool timeoutKillEnable) { DARABONBA_PTR_SET_VALUE(timeoutKillEnable_, timeoutKillEnable) };
