...
namespace Models
{
  ...
  public:
    ...
    inline const GetLogEventResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetLogEventResponseBodyData) };
    inline GetLogEventResponseBodyData data() { DARABONBA_PTR_GET(data_, GetLogEventResponseBodyData) };
    inline GetLogEventResponseBody& setData(const GetLogEventResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetLogEventResponseBody& setData(GetLogEventResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<GetLogEventResponseBodyData> data_ = nullptr;
