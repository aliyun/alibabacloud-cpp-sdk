...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorkflowDAGPreviewResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetWorkflowDAGPreviewResponseBodyData) };
    inline GetWorkflowDAGPreviewResponseBodyData data() { DARABONBA_PTR_GET(data_, GetWorkflowDAGPreviewResponseBodyData) };
    inline GetWorkflowDAGPreviewResponseBody& setData(const GetWorkflowDAGPreviewResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetWorkflowDAGPreviewResponseBody& setData(GetWorkflowDAGPreviewResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetWorkflowDAGPreviewResponseBodyData> data_ = nullptr;
