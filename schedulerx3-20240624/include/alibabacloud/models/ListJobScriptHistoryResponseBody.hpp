...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->data_ == nullptr && return this->maxResults_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ListJobScriptHistoryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListJobScriptHistoryResponseBodyData) };
    inline ListJobScriptHistoryResponseBodyData data() { DARABONBA_PTR_GET(data_, ListJobScriptHistoryResponseBodyData) };
    inline ListJobScriptHistoryResponseBody& setData(const ListJobScriptHistoryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListJobScriptHistoryResponseBody& setData(ListJobScriptHistoryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListJobScriptHistoryResponseBody& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
