...
namespace Models
{
  ...
  public:
    ...
    inline CreateContactResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateContactResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateContactResponseBody::Data) };
    inline CreateContactResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateContactResponseBody::Data) };
    inline CreateContactResponseBody& setData(const CreateContactResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateContactResponseBody& setData(CreateContactResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateContactResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateContactResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<int32_t> code_ {};
    shared_ptr<CreateContactResponseBody::Data> data_ {};
