...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWorkflowDAGVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateWorkflowDAGVersionResponseBody) };
    inline UpdateWorkflowDAGVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateWorkflowDAGVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateWorkflowDAGVersionResponseBody> body_ {};
  };
