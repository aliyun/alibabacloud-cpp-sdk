...
namespace Models
{
  ...
  public:
    ...
    inline const OperateMarkSuccessWorkflowExecutionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperateMarkSuccessWorkflowExecutionResponseBody) };
    inline OperateMarkSuccessWorkflowExecutionResponseBody getBody() { DARABONBA_PTR_GET(body_, OperateMarkSuccessWorkflowExecutionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperateMarkSuccessWorkflowExecutionResponseBody> body_ {};
  };
