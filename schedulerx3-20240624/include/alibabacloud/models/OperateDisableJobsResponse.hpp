...
namespace Models
{
  ...
  public:
    ...
    inline const OperateDisableJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperateDisableJobsResponseBody) };
    inline OperateDisableJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, OperateDisableJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperateDisableJobsResponseBody> body_ {};
  };
