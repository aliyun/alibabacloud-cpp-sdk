...
namespace Models
{
  ...
  public:
    ...
    inline const ImportWorkflowsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImportWorkflowsResponseBody) };
    inline ImportWorkflowsResponseBody getBody() { DARABONBA_PTR_GET(body_, ImportWorkflowsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImportWorkflowsResponseBody> body_ {};
  };
