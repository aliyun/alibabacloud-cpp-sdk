...
namespace Models
{
  ...
  public:
    ...
    inline const GetExecutorConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetExecutorConfigResponseBody) };
    inline GetExecutorConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetExecutorConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetExecutorConfigResponseBody> body_ {};
  };
