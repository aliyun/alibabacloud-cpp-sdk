...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWorkflowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWorkflowResponseBody) };
    inline DeleteWorkflowResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWorkflowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWorkflowResponseBody> body_ {};
  };
