...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListK8sResourceResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListK8sResourceResponseBodyData>) };
    inline vector<ListK8sResourceResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListK8sResourceResponseBodyData>) };
    inline ListK8sResourceResponseBody& setData(const vector<ListK8sResourceResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListK8sResourceResponseBody& setData(vector<ListK8sResourceResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<vector<ListK8sResourceResponseBodyData>> data_ = nullptr;
