...
namespace Models
{
  ...
  public:
    ...
    inline const ListWorkflowExecutionsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListWorkflowExecutionsResponseBodyData) };
    inline ListWorkflowExecutionsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListWorkflowExecutionsResponseBodyData) };
    inline ListWorkflowExecutionsResponseBody& setData(const ListWorkflowExecutionsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListWorkflowExecutionsResponseBody& setData(ListWorkflowExecutionsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<ListWorkflowExecutionsResponseBodyData> data_ = nullptr;
