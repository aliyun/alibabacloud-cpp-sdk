...
namespace Models
{
  ...
  public:
    ...
    inline const ListAlarmEventResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAlarmEventResponseBodyData) };
    inline ListAlarmEventResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAlarmEventResponseBodyData) };
    inline ListAlarmEventResponseBody& setData(const ListAlarmEventResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAlarmEventResponseBody& setData(ListAlarmEventResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<ListAlarmEventResponseBodyData> data_ = nullptr;
