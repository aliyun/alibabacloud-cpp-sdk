...
namespace Models
{
  ...
  public:
    ...
    inline const GetClusterResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetClusterResponseBodyData) };
    inline GetClusterResponseBodyData data() { DARABONBA_PTR_GET(data_, GetClusterResponseBodyData) };
    inline GetClusterResponseBody& setData(const GetClusterResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetClusterResponseBody& setData(GetClusterResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<GetClusterResponseBodyData> data_ = nullptr;
