...
namespace Models
{
  ...
  public:
    ...
    inline const ListScheduleEventResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListScheduleEventResponseBody::Data) };
    inline ListScheduleEventResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListScheduleEventResponseBody::Data) };
    inline ListScheduleEventResponseBody& setData(const ListScheduleEventResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListScheduleEventResponseBody& setData(ListScheduleEventResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
