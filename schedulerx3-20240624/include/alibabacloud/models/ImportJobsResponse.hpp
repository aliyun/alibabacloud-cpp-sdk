...
namespace Models
{
  ...
  public:
    ...
    inline const ImportJobsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImportJobsResponseBody) };
    inline ImportJobsResponseBody getBody() { DARABONBA_PTR_GET(body_, ImportJobsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImportJobsResponseBody> body_ {};
  };
