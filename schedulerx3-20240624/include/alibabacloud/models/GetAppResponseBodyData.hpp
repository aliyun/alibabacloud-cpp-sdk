...
#ifndef ALIBABACLOUD_MODELS_GETAPPRESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_GETAPPRESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAppResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAppResponseBodyData& obj) { 
    ...
    GetAppResponseBodyData() = default ;
    GetAppResponseBodyData(const GetAppResponseBodyData &) = default ;
    GetAppResponseBodyData(GetAppResponseBodyData &&) = default ;
    GetAppResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAppResponseBodyData() = default ;
    GetAppResponseBodyData& operator=(const GetAppResponseBodyData &) = default ;
    GetAppResponseBodyData& operator=(GetAppResponseBodyData &&) = default ;
    ...
    inline GetAppResponseBodyData& setAccessToken(string accessToken) { DARABONBA_PTR_SET_VALUE(accessToken_, accessToken) };
    ...
    inline GetAppResponseBodyData& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline GetAppResponseBodyData& setAppType(int32_t appType) { DARABONBA_PTR_SET_VALUE(appType_, appType) };
    ...
    inline GetAppResponseBodyData& setCreator(string creator) { DARABONBA_PTR_SET_VALUE(creator_, creator) };
    ...
    inline GetAppResponseBodyData& setEnableLog(bool enableLog) { DARABONBA_PTR_SET_VALUE(enableLog_, enableLog) };
    ...
    inline GetAppResponseBodyData& setExecutorNum(int64_t executorNum) { DARABONBA_PTR_SET_VALUE(executorNum_, executorNum) };
    ...
    inline GetAppResponseBodyData& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline GetAppResponseBodyData& setJobNum(int32_t jobNum) { DARABONBA_PTR_SET_VALUE(jobNum_, jobNum) };
    ...
    inline GetAppResponseBodyData& setLabelRouteStrategy(int32_t labelRouteStrategy) { DARABONBA_PTR_SET_VALUE(labelRouteStrategy_, labelRouteStrategy) };
    ...
    inline GetAppResponseBodyData& setLeader(string leader) { DARABONBA_PTR_SET_VALUE(leader_, leader) };
    ...
    inline GetAppResponseBodyData& setMaxConcurrency(int32_t maxConcurrency) { DARABONBA_PTR_SET_VALUE(maxConcurrency_, maxConcurrency) };
    ...
    inline GetAppResponseBodyData& setMaxJobs(int32_t maxJobs) { DARABONBA_PTR_SET_VALUE(maxJobs_, maxJobs) };
    ...
    inline GetAppResponseBodyData& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline GetAppResponseBodyData& setUpdater(string updater) { DARABONBA_PTR_SET_VALUE(updater_, updater) };
