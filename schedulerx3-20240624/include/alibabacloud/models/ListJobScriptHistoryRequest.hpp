...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appName_ == nullptr
        && this->clusterId_ == nullptr && this->jobId_ == nullptr && this->maxResults_ == nullptr && this->nextToken_ == nullptr; };
    // appName Field Functions 
    bool hasAppName() const { return this->appName_ != nullptr;};
    void deleteAppName() { this->appName_ = nullptr;};
    inline string getAppName() const { DARABONBA_PTR_GET_DEFAULT(appName_, "") };
    inline ListJobScriptHistoryRequest& setAppName(string appName) { DARABONBA_PTR_SET_VALUE(appName_, appName) };
    ...
    inline ListJobScriptHistoryRequest& setClusterId(string clusterId) { DARABONBA_PTR_SET_VALUE(clusterId_, clusterId) };
    ...
    inline ListJobScriptHistoryRequest& setMaxResults(int32_t maxResults) { DARABONBA_PTR_SET_VALUE(maxResults_, maxResults) };
    ...
    inline ListJobScriptHistoryRequest& setNextToken(string nextToken) { DARABONBA_PTR_SET_VALUE(nextToken_, nextToken) };
