...
namespace Models
{
  ...
  public:
    ...
    inline const ListJobExecutionsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListJobExecutionsResponseBodyData) };
    inline ListJobExecutionsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListJobExecutionsResponseBodyData) };
    inline ListJobExecutionsResponseBody& setData(const ListJobExecutionsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListJobExecutionsResponseBody& setData(ListJobExecutionsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<ListJobExecutionsResponseBodyData> data_ = nullptr;
