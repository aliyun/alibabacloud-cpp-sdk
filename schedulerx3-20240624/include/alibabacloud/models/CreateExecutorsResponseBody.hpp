...
#ifndef ALIBABACLOUD_MODELS_CREATEEXECUTORSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEEXECUTORSRESPONSEBODY_HPP_
...
namespace Models
{
  class CreateExecutorsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateExecutorsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateExecutorsResponseBody& obj) { 
    ...
    CreateExecutorsResponseBody() = default ;
    CreateExecutorsResponseBody(const CreateExecutorsResponseBody &) = default ;
    CreateExecutorsResponseBody(CreateExecutorsResponseBody &&) = default ;
    CreateExecutorsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateExecutorsResponseBody() = default ;
    CreateExecutorsResponseBody& operator=(const CreateExecutorsResponseBody &) = default ;
    CreateExecutorsResponseBody& operator=(CreateExecutorsResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->appGroupId_ == nullptr
        && this->appType_ == nullptr && this->failedService_ == nullptr && this->workerId_ == nullptr && this->workerType_ == nullptr && this->workers_ == nullptr; };
    ...
    inline CreateExecutorsResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateExecutorsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateExecutorsResponseBody::Data) };
    inline CreateExecutorsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateExecutorsResponseBody::Data) };
    inline CreateExecutorsResponseBody& setData(const CreateExecutorsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateExecutorsResponseBody& setData(CreateExecutorsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateExecutorsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateExecutorsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateExecutorsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
