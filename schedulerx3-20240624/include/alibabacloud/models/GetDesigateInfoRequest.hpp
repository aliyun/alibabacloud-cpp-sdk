...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appGroupId_ == nullptr
        && this->appName_ == nullptr && this->clusterId_ == nullptr && this->jobId_ == nullptr; };
    ...
    inline GetDesigateInfoRequest& setAppGroupId(int64_t appGroupId) { DARABONBA_PTR_SET_VALUE(appGroupId_, appGroupId) };
