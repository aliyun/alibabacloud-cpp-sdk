...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline string getDump() const { DARABONBA_PTR_GET_DEFAULT(dump_, "") };
      inline Data& setDump(string dump) { DARABONBA_PTR_SET_VALUE(dump_, dump) };
    ...
    inline const GetJobExecutionThreadDumpResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetJobExecutionThreadDumpResponseBody::Data) };
    inline GetJobExecutionThreadDumpResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetJobExecutionThreadDumpResponseBody::Data) };
    inline GetJobExecutionThreadDumpResponseBody& setData(const GetJobExecutionThreadDumpResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetJobExecutionThreadDumpResponseBody& setData(GetJobExecutionThreadDumpResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
