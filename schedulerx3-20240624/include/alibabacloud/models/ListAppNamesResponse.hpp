...
namespace Models
{
  ...
  public:
    ...
    inline const ListAppNamesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAppNamesResponseBody) };
    inline ListAppNamesResponseBody body() { DARABONBA_PTR_GET(body_, ListAppNamesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAppNamesResponseBody> body_ = nullptr;
  };
