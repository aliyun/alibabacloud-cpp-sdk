...
namespace Models
{
  ...
  public:
    ...
    inline const OperateDisableWorkflowsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, OperateDisableWorkflowsResponseBody) };
    inline OperateDisableWorkflowsResponseBody body() { DARABONBA_PTR_GET(body_, OperateDisableWorkflowsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<OperateDisableWorkflowsResponseBody> body_ = nullptr;
  };
