...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->appName_ == nullptr
        && return this->clusterId_ == nullptr && return this->exportJobType_ == nullptr && return this->jobIdsShrink_ == nullptr; };
    ...
    inline int32_t exportJobType() const { DARABONBA_PTR_GET_DEFAULT(exportJobType_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> exportJobType_ = nullptr;
    // -
