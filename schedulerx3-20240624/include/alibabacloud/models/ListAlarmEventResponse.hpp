...
namespace Models
{
  ...
  public:
    ...
    inline const ListAlarmEventResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAlarmEventResponseBody) };
    inline ListAlarmEventResponseBody body() { DARABONBA_PTR_GET(body_, ListAlarmEventResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAlarmEventResponseBody> body_ = nullptr;
  };
