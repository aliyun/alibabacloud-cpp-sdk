...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->appName_ != nullptr
        && this->clusterId_ != nullptr && this->endTime_ != nullptr && this->event_ != nullptr && this->jobExecutionId_ != nullptr && this->jobName_ != nullptr
        && this->keyword_ != nullptr && this->pageNum_ != nullptr && this->pageSize_ != nullptr && this->reverse_ != nullptr && this->startTime_ != nullptr; };
    ...
    inline int64_t jobExecutionId() const { DARABONBA_PTR_GET_DEFAULT(jobExecutionId_, 0L) };
