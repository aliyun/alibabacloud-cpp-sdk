...
namespace Models
{
  ...
  public:
    ...
    inline const ListCalendarsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListCalendarsResponseBodyData) };
    inline ListCalendarsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListCalendarsResponseBodyData) };
    inline ListCalendarsResponseBody& setData(const ListCalendarsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListCalendarsResponseBody& setData(ListCalendarsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<ListCalendarsResponseBodyData> data_ = nullptr;
