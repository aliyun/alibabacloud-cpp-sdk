...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateExecutorsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateExecutorsResponseBodyData) };
    inline UpdateExecutorsResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateExecutorsResponseBodyData) };
    inline UpdateExecutorsResponseBody& setData(const UpdateExecutorsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateExecutorsResponseBody& setData(UpdateExecutorsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<UpdateExecutorsResponseBodyData> data_ = nullptr;
