...
namespace Models
{
  ...
  public:
    ...
    inline const OperateSkipJobExecutionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, OperateSkipJobExecutionResponseBody) };
    inline OperateSkipJobExecutionResponseBody body() { DARABONBA_PTR_GET(body_, OperateSkipJobExecutionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<OperateSkipJobExecutionResponseBody> body_ = nullptr;
  };
