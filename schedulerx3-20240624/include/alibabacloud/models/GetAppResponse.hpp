...
namespace Models
{
  ...
  public:
    ...
    inline const GetAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAppResponseBody) };
    inline GetAppResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAppResponseBody> body_ {};
  };
