...
namespace Models
{
  ...
  public:
    ...
    inline const GetJobExecutionProgressResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetJobExecutionProgressResponseBodyData) };
    inline GetJobExecutionProgressResponseBodyData data() { DARABONBA_PTR_GET(data_, GetJobExecutionProgressResponseBodyData) };
    inline GetJobExecutionProgressResponseBody& setData(const GetJobExecutionProgressResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetJobExecutionProgressResponseBody& setData(GetJobExecutionProgressResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<GetJobExecutionProgressResponseBodyData> data_ = nullptr;
