...
namespace Models
{
  ...
  public:
    ...
    inline UpdateAppResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UpdateAppResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateAppResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
