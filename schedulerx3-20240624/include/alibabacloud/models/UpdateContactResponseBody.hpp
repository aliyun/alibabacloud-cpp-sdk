...
namespace Models
{
  ...
  public:
    ...
    inline UpdateContactResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UpdateContactResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UpdateContactResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
