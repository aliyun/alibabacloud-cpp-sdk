...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatasourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDatasourcesResponseBody) };
    inline ListDatasourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDatasourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDatasourcesResponseBody> body_ {};
  };
