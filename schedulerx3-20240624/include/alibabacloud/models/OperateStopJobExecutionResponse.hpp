...
namespace Models
{
  ...
  public:
    ...
    inline const OperateStopJobExecutionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OperateStopJobExecutionResponseBody) };
    inline OperateStopJobExecutionResponseBody getBody() { DARABONBA_PTR_GET(body_, OperateStopJobExecutionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OperateStopJobExecutionResponseBody> body_ {};
  };
