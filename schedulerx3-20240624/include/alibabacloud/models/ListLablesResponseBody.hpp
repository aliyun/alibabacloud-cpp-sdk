...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListLablesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListLablesResponseBodyData>) };
    inline vector<ListLablesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListLablesResponseBodyData>) };
    inline ListLablesResponseBody& setData(const vector<ListLablesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListLablesResponseBody& setData(vector<ListLablesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // -
    std::shared_ptr<vector<ListLablesResponseBodyData>> data_ = nullptr;
