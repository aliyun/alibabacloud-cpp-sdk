...
namespace Models
{
  ...
  public:
    ...
    inline const ListRegionZoneResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListRegionZoneResponseBody) };
    inline ListRegionZoneResponseBody body() { DARABONBA_PTR_GET(body_, ListRegionZoneResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListRegionZoneResponseBody> body_ = nullptr;
  };
