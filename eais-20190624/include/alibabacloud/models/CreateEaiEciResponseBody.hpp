...
#ifndef ALIBABACLOUD_MODELS_CREATEEAIECIRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEEAIECIRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateEaiEciResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateEaiEciResponseBody& obj) { 
    ...
    CreateEaiEciResponseBody() = default ;
    CreateEaiEciResponseBody(const CreateEaiEciResponseBody &) = default ;
    CreateEaiEciResponseBody(CreateEaiEciResponseBody &&) = default ;
    CreateEaiEciResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateEaiEciResponseBody() = default ;
    CreateEaiEciResponseBody& operator=(const CreateEaiEciResponseBody &) = default ;
    CreateEaiEciResponseBody& operator=(CreateEaiEciResponseBody &&) = default ;
    ...
    inline CreateEaiEciResponseBody& setClientInstanceId(string clientInstanceId) { DARABONBA_PTR_SET_VALUE(clientInstanceId_, clientInstanceId) };
    ...
    inline CreateEaiEciResponseBody& setElasticAcceleratedInstanceId(string elasticAcceleratedInstanceId) { DARABONBA_PTR_SET_VALUE(elasticAcceleratedInstanceId_, elasticAcceleratedInstanceId) };
    ...
    inline CreateEaiEciResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
