...
namespace Models
{
  ...
  public:
    ...
    inline const GetContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetContentResponseBody) };
    inline GetContentResponseBody getBody() { DARABONBA_PTR_GET(body_, GetContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetContentResponseBody> body_ {};
  };
