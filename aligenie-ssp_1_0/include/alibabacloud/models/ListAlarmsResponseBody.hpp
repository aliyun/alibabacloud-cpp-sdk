...
namespace Models
{
  ...
  public:
    ...
    inline const ListAlarmsResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListAlarmsResponseBodyResult) };
    inline ListAlarmsResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListAlarmsResponseBodyResult) };
    inline ListAlarmsResponseBody& setResult(const ListAlarmsResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListAlarmsResponseBody& setResult(ListAlarmsResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ListAlarmsResponseBodyResult> result_ = nullptr;
  };
