...
#ifndef ALIBABACLOUD_MODELS_GETCURRENTPLAYINGLISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETCURRENTPLAYINGLISTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetCurrentPlayingListResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetCurrentPlayingListResponseBody& obj) { 
    ...
    GetCurrentPlayingListResponseBody() = default ;
    GetCurrentPlayingListResponseBody(const GetCurrentPlayingListResponseBody &) = default ;
    GetCurrentPlayingListResponseBody(GetCurrentPlayingListResponseBody &&) = default ;
    GetCurrentPlayingListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetCurrentPlayingListResponseBody() = default ;
    GetCurrentPlayingListResponseBody& operator=(const GetCurrentPlayingListResponseBody &) = default ;
    GetCurrentPlayingListResponseBody& operator=(GetCurrentPlayingListResponseBody &&) = default ;
    ...
    inline GetCurrentPlayingListResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetCurrentPlayingListResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetCurrentPlayingListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const vector<GetCurrentPlayingListResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<GetCurrentPlayingListResponseBody::Result>) };
    inline vector<GetCurrentPlayingListResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<GetCurrentPlayingListResponseBody::Result>) };
    inline GetCurrentPlayingListResponseBody& setResult(const vector<GetCurrentPlayingListResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetCurrentPlayingListResponseBody& setResult(vector<GetCurrentPlayingListResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline GetCurrentPlayingListResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<vector<GetCurrentPlayingListResponseBody::Result>> result_ {};
