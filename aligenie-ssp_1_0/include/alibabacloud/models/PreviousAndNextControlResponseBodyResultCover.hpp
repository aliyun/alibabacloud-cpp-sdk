...
#ifndef ALIBABACLOUD_MODELS_PREVIOUSANDNEXTCONTROLRESPONSEBODYRESULTCOVER_HPP_
#define ALIBABACLOUD_MODELS_PREVIOUSANDNEXTCONTROLRESPONSEBODYRESULTCOVER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PreviousAndNextControlResponseBodyResultCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PreviousAndNextControlResponseBodyResultCover& obj) { 
    ...
    PreviousAndNextControlResponseBodyResultCover() = default ;
    PreviousAndNextControlResponseBodyResultCover(const PreviousAndNextControlResponseBodyResultCover &) = default ;
    PreviousAndNextControlResponseBodyResultCover(PreviousAndNextControlResponseBodyResultCover &&) = default ;
    PreviousAndNextControlResponseBodyResultCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PreviousAndNextControlResponseBodyResultCover() = default ;
    PreviousAndNextControlResponseBodyResultCover& operator=(const PreviousAndNextControlResponseBodyResultCover &) = default ;
    PreviousAndNextControlResponseBodyResultCover& operator=(PreviousAndNextControlResponseBodyResultCover &&) = default ;
    ...
    inline PreviousAndNextControlResponseBodyResultCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline PreviousAndNextControlResponseBodyResultCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline PreviousAndNextControlResponseBodyResultCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline PreviousAndNextControlResponseBodyResultCover& setMediam(string mediam) { DARABONBA_PTR_SET_VALUE(mediam_, mediam) };
    ...
    inline PreviousAndNextControlResponseBodyResultCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline PreviousAndNextControlResponseBodyResultCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
