...
namespace Models
{
  ...
  public:
    ...
    inline const IndexControlPlayingListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, IndexControlPlayingListResponseBody) };
    inline IndexControlPlayingListResponseBody getBody() { DARABONBA_PTR_GET(body_, IndexControlPlayingListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<IndexControlPlayingListResponseBody> body_ {};
  };
