...
namespace Models
{
  ...
  public:
    ...
    inline const GetAlbumDetailByIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAlbumDetailByIdResponseBody) };
    inline GetAlbumDetailByIdResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAlbumDetailByIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAlbumDetailByIdResponseBody> body_ {};
  };
