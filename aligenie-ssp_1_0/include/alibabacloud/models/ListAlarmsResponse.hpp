...
namespace Models
{
  ...
  public:
    ...
    inline const ListAlarmsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAlarmsResponseBody) };
    inline ListAlarmsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAlarmsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAlarmsResponseBody> body_ {};
  };
