...
namespace Models
{
  ...
  public:
    ...
    inline const AuthLoginWithTaobaoUserInfoResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, AuthLoginWithTaobaoUserInfoResponseBodyResult) };
    inline AuthLoginWithTaobaoUserInfoResponseBodyResult result() { DARABONBA_PTR_GET(result_, AuthLoginWithTaobaoUserInfoResponseBodyResult) };
    inline AuthLoginWithTaobaoUserInfoResponseBody& setResult(const AuthLoginWithTaobaoUserInfoResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline AuthLoginWithTaobaoUserInfoResponseBody& setResult(AuthLoginWithTaobaoUserInfoResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<AuthLoginWithTaobaoUserInfoResponseBodyResult> result_ = nullptr;
