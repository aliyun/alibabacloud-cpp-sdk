...
namespace Models
{
  ...
  public:
    ...
    inline const SearchContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SearchContentResponseBody) };
    inline SearchContentResponseBody getBody() { DARABONBA_PTR_GET(body_, SearchContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SearchContentResponseBody> body_ {};
  };
