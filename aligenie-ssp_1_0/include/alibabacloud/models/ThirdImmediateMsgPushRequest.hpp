...
namespace Models
{
  ...
  public:
    ...
    inline string getChangeDetail() const { DARABONBA_PTR_GET_DEFAULT(changeDetail_, "") };
    ...
    inline string getPsgIds() const { DARABONBA_PTR_GET_DEFAULT(psgIds_, "") };
    ...
    inline string getTrafficChangeType() const { DARABONBA_PTR_GET_DEFAULT(trafficChangeType_, "") };
    ...
    inline string getTrafficChangeTypeDesc() const { DARABONBA_PTR_GET_DEFAULT(trafficChangeTypeDesc_, "") };
    ...
    inline string getTrafficJourneyIds() const { DARABONBA_PTR_GET_DEFAULT(trafficJourneyIds_, "") };
    ...
    inline string getTrafficSubOrderIds() const { DARABONBA_PTR_GET_DEFAULT(trafficSubOrderIds_, "") };
  ...
  protected:
    ...
    shared_ptr<string> changeDetail_ {};
    // Order ID
    shared_ptr<string> orderId_ {};
    // Passenger IDs to change
    shared_ptr<string> psgIds_ {};
    // Request source
    shared_ptr<string> source_ {};
    // change type (TRAIN_ISSUED, FLIGHT_CHANGED)
    shared_ptr<string> trafficChangeType_ {};
    // change type description (ticket issued, rebooked)
    shared_ptr<string> trafficChangeTypeDesc_ {};
    // Journey IDs to change
    shared_ptr<string> trafficJourneyIds_ {};
    // sub-order ID of the changed train request
    shared_ptr<string> trafficSubOrderIds_ {};
    // user ID
