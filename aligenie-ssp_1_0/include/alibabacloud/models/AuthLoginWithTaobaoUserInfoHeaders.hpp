...
#ifndef ALIBABACLOUD_MODELS_AUTHLOGINWITHTAOBAOUSERINFOHEADERS_HPP_
#define ALIBABACLOUD_MODELS_AUTHLOGINWITHTAOBAOUSERINFOHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AuthLoginWithTaobaoUserInfoHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AuthLoginWithTaobaoUserInfoHeaders& obj) { 
    ...
    AuthLoginWithTaobaoUserInfoHeaders() = default ;
    AuthLoginWithTaobaoUserInfoHeaders(const AuthLoginWithTaobaoUserInfoHeaders &) = default ;
    AuthLoginWithTaobaoUserInfoHeaders(AuthLoginWithTaobaoUserInfoHeaders &&) = default ;
    AuthLoginWithTaobaoUserInfoHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AuthLoginWithTaobaoUserInfoHeaders() = default ;
    AuthLoginWithTaobaoUserInfoHeaders& operator=(const AuthLoginWithTaobaoUserInfoHeaders &) = default ;
    AuthLoginWithTaobaoUserInfoHeaders& operator=(AuthLoginWithTaobaoUserInfoHeaders &&) = default ;
