...
#ifndef ALIBABACLOUD_MODELS_LISTPLAYHISTORYRESPONSEBODYRESULTAUTHORSCOVER_HPP_
#define ALIBABACLOUD_MODELS_LISTPLAYHISTORYRESPONSEBODYRESULTAUTHORSCOVER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPlayHistoryResponseBodyResultAuthorsCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListPlayHistoryResponseBodyResultAuthorsCover& obj) { 
    ...
    ListPlayHistoryResponseBodyResultAuthorsCover() = default ;
    ListPlayHistoryResponseBodyResultAuthorsCover(const ListPlayHistoryResponseBodyResultAuthorsCover &) = default ;
    ListPlayHistoryResponseBodyResultAuthorsCover(ListPlayHistoryResponseBodyResultAuthorsCover &&) = default ;
    ListPlayHistoryResponseBodyResultAuthorsCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPlayHistoryResponseBodyResultAuthorsCover() = default ;
    ListPlayHistoryResponseBodyResultAuthorsCover& operator=(const ListPlayHistoryResponseBodyResultAuthorsCover &) = default ;
    ListPlayHistoryResponseBodyResultAuthorsCover& operator=(ListPlayHistoryResponseBodyResultAuthorsCover &&) = default ;
    ...
    inline ListPlayHistoryResponseBodyResultAuthorsCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline ListPlayHistoryResponseBodyResultAuthorsCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline ListPlayHistoryResponseBodyResultAuthorsCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline ListPlayHistoryResponseBodyResultAuthorsCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline ListPlayHistoryResponseBodyResultAuthorsCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
