...
#ifndef ALIBABACLOUD_MODELS_CREATESCHEDULETASKSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATESCHEDULETASKSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateScheduleTaskShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateScheduleTaskShrinkRequest& obj) { 
    ...
    CreateScheduleTaskShrinkRequest() = default ;
    CreateScheduleTaskShrinkRequest(const CreateScheduleTaskShrinkRequest &) = default ;
    CreateScheduleTaskShrinkRequest(CreateScheduleTaskShrinkRequest &&) = default ;
    CreateScheduleTaskShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateScheduleTaskShrinkRequest() = default ;
    CreateScheduleTaskShrinkRequest& operator=(const CreateScheduleTaskShrinkRequest &) = default ;
    CreateScheduleTaskShrinkRequest& operator=(CreateScheduleTaskShrinkRequest &&) = default ;
    ...
    inline CreateScheduleTaskShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline CreateScheduleTaskShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline CreateScheduleTaskShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
