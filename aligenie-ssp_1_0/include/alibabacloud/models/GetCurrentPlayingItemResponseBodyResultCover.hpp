...
#ifndef ALIBABACLOUD_MODELS_GETCURRENTPLAYINGITEMRESPONSEBODYRESULTCOVER_HPP_
#define ALIBABACLOUD_MODELS_GETCURRENTPLAYINGITEMRESPONSEBODYRESULTCOVER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetCurrentPlayingItemResponseBodyResultCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetCurrentPlayingItemResponseBodyResultCover& obj) { 
    ...
    GetCurrentPlayingItemResponseBodyResultCover() = default ;
    GetCurrentPlayingItemResponseBodyResultCover(const GetCurrentPlayingItemResponseBodyResultCover &) = default ;
    GetCurrentPlayingItemResponseBodyResultCover(GetCurrentPlayingItemResponseBodyResultCover &&) = default ;
    GetCurrentPlayingItemResponseBodyResultCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetCurrentPlayingItemResponseBodyResultCover() = default ;
    GetCurrentPlayingItemResponseBodyResultCover& operator=(const GetCurrentPlayingItemResponseBodyResultCover &) = default ;
    GetCurrentPlayingItemResponseBodyResultCover& operator=(GetCurrentPlayingItemResponseBodyResultCover &&) = default ;
    ...
    inline GetCurrentPlayingItemResponseBodyResultCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline GetCurrentPlayingItemResponseBodyResultCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline GetCurrentPlayingItemResponseBodyResultCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline GetCurrentPlayingItemResponseBodyResultCover& setMediam(string mediam) { DARABONBA_PTR_SET_VALUE(mediam_, mediam) };
    ...
    inline GetCurrentPlayingItemResponseBodyResultCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline GetCurrentPlayingItemResponseBodyResultCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
