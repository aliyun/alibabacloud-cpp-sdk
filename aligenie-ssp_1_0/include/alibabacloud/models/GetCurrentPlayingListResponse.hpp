...
namespace Models
{
  ...
  public:
    ...
    inline const GetCurrentPlayingListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCurrentPlayingListResponseBody) };
    inline GetCurrentPlayingListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCurrentPlayingListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCurrentPlayingListResponseBody> body_ {};
  };
