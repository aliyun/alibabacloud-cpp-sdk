...
namespace Models
{
  ...
  public:
    ...
    inline const GetDeviceStatusInfoResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetDeviceStatusInfoResponseBodyResult) };
    inline GetDeviceStatusInfoResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetDeviceStatusInfoResponseBodyResult) };
    inline GetDeviceStatusInfoResponseBody& setResult(const GetDeviceStatusInfoResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetDeviceStatusInfoResponseBody& setResult(GetDeviceStatusInfoResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetDeviceStatusInfoResponseBodyResult> result_ = nullptr;
  };
