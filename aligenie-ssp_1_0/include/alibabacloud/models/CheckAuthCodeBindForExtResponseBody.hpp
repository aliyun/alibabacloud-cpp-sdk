...
namespace Models
{
  ...
  public:
    ...
    inline const CheckAuthCodeBindForExtResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CheckAuthCodeBindForExtResponseBodyResult) };
    inline CheckAuthCodeBindForExtResponseBodyResult result() { DARABONBA_PTR_GET(result_, CheckAuthCodeBindForExtResponseBodyResult) };
    inline CheckAuthCodeBindForExtResponseBody& setResult(const CheckAuthCodeBindForExtResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CheckAuthCodeBindForExtResponseBody& setResult(CheckAuthCodeBindForExtResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<CheckAuthCodeBindForExtResponseBodyResult> result_ = nullptr;
  };
