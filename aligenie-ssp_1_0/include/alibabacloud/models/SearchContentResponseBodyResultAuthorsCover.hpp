...
#ifndef ALIBABACLOUD_MODELS_SEARCHCONTENTRESPONSEBODYRESULTAUTHORSCOVER_HPP_
#define ALIBABACLOUD_MODELS_SEARCHCONTENTRESPONSEBODYRESULTAUTHORSCOVER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchContentResponseBodyResultAuthorsCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SearchContentResponseBodyResultAuthorsCover& obj) { 
    ...
    SearchContentResponseBodyResultAuthorsCover() = default ;
    SearchContentResponseBodyResultAuthorsCover(const SearchContentResponseBodyResultAuthorsCover &) = default ;
    SearchContentResponseBodyResultAuthorsCover(SearchContentResponseBodyResultAuthorsCover &&) = default ;
    SearchContentResponseBodyResultAuthorsCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchContentResponseBodyResultAuthorsCover() = default ;
    SearchContentResponseBodyResultAuthorsCover& operator=(const SearchContentResponseBodyResultAuthorsCover &) = default ;
    SearchContentResponseBodyResultAuthorsCover& operator=(SearchContentResponseBodyResultAuthorsCover &&) = default ;
    ...
    inline SearchContentResponseBodyResultAuthorsCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline SearchContentResponseBodyResultAuthorsCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline SearchContentResponseBodyResultAuthorsCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline SearchContentResponseBodyResultAuthorsCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline SearchContentResponseBodyResultAuthorsCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
