...
namespace Models
{
  ...
  public:
    ...
    inline const SetDeviceSettingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetDeviceSettingResponseBody) };
    inline SetDeviceSettingResponseBody getBody() { DARABONBA_PTR_GET(body_, SetDeviceSettingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetDeviceSettingResponseBody> body_ {};
  };
