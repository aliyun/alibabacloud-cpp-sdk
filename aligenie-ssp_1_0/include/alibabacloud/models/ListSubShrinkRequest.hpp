...
#ifndef ALIBABACLOUD_MODELS_LISTSUBSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTSUBSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListSubShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListSubShrinkRequest& obj) { 
    ...
    ListSubShrinkRequest() = default ;
    ListSubShrinkRequest(const ListSubShrinkRequest &) = default ;
    ListSubShrinkRequest(ListSubShrinkRequest &&) = default ;
    ListSubShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListSubShrinkRequest() = default ;
    ListSubShrinkRequest& operator=(const ListSubShrinkRequest &) = default ;
    ListSubShrinkRequest& operator=(ListSubShrinkRequest &&) = default ;
