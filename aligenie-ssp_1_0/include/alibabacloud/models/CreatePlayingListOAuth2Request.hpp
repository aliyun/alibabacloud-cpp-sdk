...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePlayingListOAuth2Request::DeviceInfo & getDeviceInfo() const { DARABONBA_PTR_GET_CONST(deviceInfo_, CreatePlayingListOAuth2Request::DeviceInfo) };
    inline CreatePlayingListOAuth2Request::DeviceInfo getDeviceInfo() { DARABONBA_PTR_GET(deviceInfo_, CreatePlayingListOAuth2Request::DeviceInfo) };
    inline CreatePlayingListOAuth2Request& setDeviceInfo(const CreatePlayingListOAuth2Request::DeviceInfo & deviceInfo) { DARABONBA_PTR_SET_VALUE(deviceInfo_, deviceInfo) };
    inline CreatePlayingListOAuth2Request& setDeviceInfo(CreatePlayingListOAuth2Request::DeviceInfo && deviceInfo) { DARABONBA_PTR_SET_RVALUE(deviceInfo_, deviceInfo) };
    ...
    inline const CreatePlayingListOAuth2Request::OpenCreatePlayingListRequest & getOpenCreatePlayingListRequest() const { DARABONBA_PTR_GET_CONST(openCreatePlayingListRequest_, CreatePlayingListOAuth2Request::OpenCreatePlayingListRequest) };
    inline CreatePlayingListOAuth2Request::OpenCreatePlayingListRequest getOpenCreatePlayingListRequest() { DARABONBA_PTR_GET(openCreatePlayingListRequest_, CreatePlayingListOAuth2Request::OpenCreatePlayingListRequest) };
    inline CreatePlayingListOAuth2Request& setOpenCreatePlayingListRequest(const CreatePlayingListOAuth2Request::OpenCreatePlayingListRequest & openCreatePlayingListRequest) { DARABONBA_PTR_SET_VALUE(openCreatePlayingListRequest_, openCreatePlayingListRequest) };
    inline CreatePlayingListOAuth2Request& setOpenCreatePlayingListRequest(CreatePlayingListOAuth2Request::OpenCreatePlayingListRequest && openCreatePlayingListRequest) { DARABONBA_PTR_SET_RVALUE(openCreatePlayingListRequest_, openCreatePlayingListRequest) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<CreatePlayingListOAuth2Request::DeviceInfo> deviceInfo_ {};
    // Business parameters
    // 
    // This parameter is required.
    shared_ptr<CreatePlayingListOAuth2Request::OpenCreatePlayingListRequest> openCreatePlayingListRequest_ {};
  };
