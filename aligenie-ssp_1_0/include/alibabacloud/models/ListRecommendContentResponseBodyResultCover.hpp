...
#ifndef ALIBABACLOUD_MODELS_LISTRECOMMENDCONTENTRESPONSEBODYRESULTCOVER_HPP_
#define ALIBABACLOUD_MODELS_LISTRECOMMENDCONTENTRESPONSEBODYRESULTCOVER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListRecommendContentResponseBodyResultCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListRecommendContentResponseBodyResultCover& obj) { 
    ...
    ListRecommendContentResponseBodyResultCover() = default ;
    ListRecommendContentResponseBodyResultCover(const ListRecommendContentResponseBodyResultCover &) = default ;
    ListRecommendContentResponseBodyResultCover(ListRecommendContentResponseBodyResultCover &&) = default ;
    ListRecommendContentResponseBodyResultCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListRecommendContentResponseBodyResultCover() = default ;
    ListRecommendContentResponseBodyResultCover& operator=(const ListRecommendContentResponseBodyResultCover &) = default ;
    ListRecommendContentResponseBodyResultCover& operator=(ListRecommendContentResponseBodyResultCover &&) = default ;
    ...
    inline ListRecommendContentResponseBodyResultCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline ListRecommendContentResponseBodyResultCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline ListRecommendContentResponseBodyResultCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline ListRecommendContentResponseBodyResultCover& setMediam(string mediam) { DARABONBA_PTR_SET_VALUE(mediam_, mediam) };
    ...
    inline ListRecommendContentResponseBodyResultCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline ListRecommendContentResponseBodyResultCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
