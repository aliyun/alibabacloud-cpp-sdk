...
#ifndef ALIBABACLOUD_MODELS_INDEXCONTROLPLAYINGLISTRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_INDEXCONTROLPLAYINGLISTRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const IndexControlPlayingListResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IndexControlPlayingListResponseBodyResult& obj) { 
    ...
    IndexControlPlayingListResponseBodyResult() = default ;
    IndexControlPlayingListResponseBodyResult(const IndexControlPlayingListResponseBodyResult &) = default ;
    IndexControlPlayingListResponseBodyResult(IndexControlPlayingListResponseBodyResult &&) = default ;
    IndexControlPlayingListResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IndexControlPlayingListResponseBodyResult() = default ;
    IndexControlPlayingListResponseBodyResult& operator=(const IndexControlPlayingListResponseBodyResult &) = default ;
    IndexControlPlayingListResponseBodyResult& operator=(IndexControlPlayingListResponseBodyResult &&) = default ;
    ...
    inline IndexControlPlayingListResponseBodyResult& setAlbumName(string albumName) { DARABONBA_PTR_SET_VALUE(albumName_, albumName) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setAlbumRawId(string albumRawId) { DARABONBA_PTR_SET_VALUE(albumRawId_, albumRawId) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setAudioLength(int32_t audioLength) { DARABONBA_PTR_SET_VALUE(audioLength_, audioLength) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setCopyright(int32_t copyright) { DARABONBA_PTR_SET_VALUE(copyright_, copyright) };


    // cover Field Functions 
    bool hasCover() const { return this->cover_ != nullptr;};
    void deleteCover() { this->cover_ = nullptr;};
    inline const Models::IndexControlPlayingListResponseBodyResultCover & cover() const { DARABONBA_PTR_GET_CONST(cover_, Models::IndexControlPlayingListResponseBodyResultCover) };
    inline Models::IndexControlPlayingListResponseBodyResultCover cover() { DARABONBA_PTR_GET(cover_, Models::IndexControlPlayingListResponseBodyResultCover) };
    inline IndexControlPlayingListResponseBodyResult& setCover(const Models::IndexControlPlayingListResponseBodyResultCover & cover) { DARABONBA_PTR_SET_VALUE(cover_, cover) };
    inline IndexControlPlayingListResponseBodyResult& setCover(Models::IndexControlPlayingListResponseBodyResultCover && cover) { DARABONBA_PTR_SET_RVALUE(cover_, cover) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setDefaultPlayOrder(int32_t defaultPlayOrder) { DARABONBA_PTR_SET_VALUE(defaultPlayOrder_, defaultPlayOrder) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setItemUrl(string itemUrl) { DARABONBA_PTR_SET_VALUE(itemUrl_, itemUrl) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setLiked(bool liked) { DARABONBA_PTR_SET_VALUE(liked_, liked) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setLyricUrl(string lyricUrl) { DARABONBA_PTR_SET_VALUE(lyricUrl_, lyricUrl) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setPlayMode(string playMode) { DARABONBA_PTR_SET_VALUE(playMode_, playMode) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setPos(int32_t pos) { DARABONBA_PTR_SET_VALUE(pos_, pos) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setProgress(int32_t progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setRawId(string rawId) { DARABONBA_PTR_SET_VALUE(rawId_, rawId) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setSinger(string singer) { DARABONBA_PTR_SET_VALUE(singer_, singer) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline IndexControlPlayingListResponseBodyResult& setValid(string valid) { DARABONBA_PTR_SET_VALUE(valid_, valid) };
  ...
  protected:
    ...
    std::shared_ptr<Models::IndexControlPlayingListResponseBodyResultCover> cover_ = nullptr;
