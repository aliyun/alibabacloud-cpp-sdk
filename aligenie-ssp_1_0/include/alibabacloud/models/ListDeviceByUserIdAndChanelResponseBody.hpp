...
#ifndef ALIBABACLOUD_MODELS_LISTDEVICEBYUSERIDANDCHANELRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTDEVICEBYUSERIDANDCHANELRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListDeviceByUserIdAndChanelResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Result, result_);
    };
    friend void from_json(const Darabonba::Json& j, ListDeviceByUserIdAndChanelResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Result, result_);
    };
    ListDeviceByUserIdAndChanelResponseBody() = default ;
    ListDeviceByUserIdAndChanelResponseBody(const ListDeviceByUserIdAndChanelResponseBody &) = default ;
    ListDeviceByUserIdAndChanelResponseBody(ListDeviceByUserIdAndChanelResponseBody &&) = default ;
    ListDeviceByUserIdAndChanelResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListDeviceByUserIdAndChanelResponseBody() = default ;
    ListDeviceByUserIdAndChanelResponseBody& operator=(const ListDeviceByUserIdAndChanelResponseBody &) = default ;
    ListDeviceByUserIdAndChanelResponseBody& operator=(ListDeviceByUserIdAndChanelResponseBody &&) = default ;
    ...
    inline ListDeviceByUserIdAndChanelResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ListDeviceByUserIdAndChanelResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListDeviceByUserIdAndChanelResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const vector<ListDeviceByUserIdAndChanelResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListDeviceByUserIdAndChanelResponseBody::Result>) };
    inline vector<ListDeviceByUserIdAndChanelResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListDeviceByUserIdAndChanelResponseBody::Result>) };
    inline ListDeviceByUserIdAndChanelResponseBody& setResult(const vector<ListDeviceByUserIdAndChanelResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListDeviceByUserIdAndChanelResponseBody& setResult(vector<ListDeviceByUserIdAndChanelResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // List of information
    shared_ptr<vector<ListDeviceByUserIdAndChanelResponseBody::Result>> result_ {};
  };
