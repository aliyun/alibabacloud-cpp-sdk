...
#ifndef ALIBABACLOUD_MODELS_LISTCATECONTENTRESPONSEBODYRESULTOPENDATAITEMLISTAUTHORSCOVER_HPP_
#define ALIBABACLOUD_MODELS_LISTCATECONTENTRESPONSEBODYRESULTOPENDATAITEMLISTAUTHORSCOVER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListCateContentResponseBodyResultOpenDataItemListAuthorsCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListCateContentResponseBodyResultOpenDataItemListAuthorsCover& obj) { 
    ...
    ListCateContentResponseBodyResultOpenDataItemListAuthorsCover() = default ;
    ListCateContentResponseBodyResultOpenDataItemListAuthorsCover(const ListCateContentResponseBodyResultOpenDataItemListAuthorsCover &) = default ;
    ListCateContentResponseBodyResultOpenDataItemListAuthorsCover(ListCateContentResponseBodyResultOpenDataItemListAuthorsCover &&) = default ;
    ListCateContentResponseBodyResultOpenDataItemListAuthorsCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListCateContentResponseBodyResultOpenDataItemListAuthorsCover() = default ;
    ListCateContentResponseBodyResultOpenDataItemListAuthorsCover& operator=(const ListCateContentResponseBodyResultOpenDataItemListAuthorsCover &) = default ;
    ListCateContentResponseBodyResultOpenDataItemListAuthorsCover& operator=(ListCateContentResponseBodyResultOpenDataItemListAuthorsCover &&) = default ;
    ...
    inline ListCateContentResponseBodyResultOpenDataItemListAuthorsCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline ListCateContentResponseBodyResultOpenDataItemListAuthorsCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline ListCateContentResponseBodyResultOpenDataItemListAuthorsCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline ListCateContentResponseBodyResultOpenDataItemListAuthorsCover& setMediam(string mediam) { DARABONBA_PTR_SET_VALUE(mediam_, mediam) };
    ...
    inline ListCateContentResponseBodyResultOpenDataItemListAuthorsCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline ListCateContentResponseBodyResultOpenDataItemListAuthorsCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
