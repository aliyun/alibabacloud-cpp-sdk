...
#ifndef ALIBABACLOUD_MODELS_GETCURRENTPLAYINGITEMRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETCURRENTPLAYINGITEMRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetCurrentPlayingItemResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetCurrentPlayingItemResponseBody& obj) { 
    ...
    GetCurrentPlayingItemResponseBody() = default ;
    GetCurrentPlayingItemResponseBody(const GetCurrentPlayingItemResponseBody &) = default ;
    GetCurrentPlayingItemResponseBody(GetCurrentPlayingItemResponseBody &&) = default ;
    GetCurrentPlayingItemResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetCurrentPlayingItemResponseBody() = default ;
    GetCurrentPlayingItemResponseBody& operator=(const GetCurrentPlayingItemResponseBody &) = default ;
    GetCurrentPlayingItemResponseBody& operator=(GetCurrentPlayingItemResponseBody &&) = default ;
    ...
    public:
      ...
      inline string getLiked() const { DARABONBA_PTR_GET_DEFAULT(liked_, "") };
      inline Result& setLiked(string liked) { DARABONBA_PTR_SET_VALUE(liked_, liked) };
    ...
    inline GetCurrentPlayingItemResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetCurrentPlayingItemResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetCurrentPlayingItemResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const GetCurrentPlayingItemResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, GetCurrentPlayingItemResponseBody::Result) };
    inline GetCurrentPlayingItemResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, GetCurrentPlayingItemResponseBody::Result) };
    inline GetCurrentPlayingItemResponseBody& setResult(const GetCurrentPlayingItemResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetCurrentPlayingItemResponseBody& setResult(GetCurrentPlayingItemResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline GetCurrentPlayingItemResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    // Return code of the invocation
    shared_ptr<int32_t> code_ {};
    // Additional information. A common scenario is providing a brief description for failed invocations to help the caller identify the issue.
    shared_ptr<string> message_ {};
    // Request ID
    shared_ptr<string> requestId_ {};
    // Actual return result of the service
    shared_ptr<GetCurrentPlayingItemResponseBody::Result> result_ {};
    // Indicates whether the invocation succeeded. true indicates success, and false indicates failure. When the invocation fails, check the Message field for details.
