...
#ifndef ALIBABACLOUD_MODELS_SEARCHCONTENTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SEARCHCONTENTSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchContentShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SearchContentShrinkRequest& obj) { 
    ...
    SearchContentShrinkRequest() = default ;
    SearchContentShrinkRequest(const SearchContentShrinkRequest &) = default ;
    SearchContentShrinkRequest(SearchContentShrinkRequest &&) = default ;
    SearchContentShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchContentShrinkRequest() = default ;
    SearchContentShrinkRequest& operator=(const SearchContentShrinkRequest &) = default ;
    SearchContentShrinkRequest& operator=(SearchContentShrinkRequest &&) = default ;
    ...
    inline SearchContentShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline SearchContentShrinkRequest& setRequestShrink(string requestShrink) { DARABONBA_PTR_SET_VALUE(requestShrink_, requestShrink) };
    ...
    inline SearchContentShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
