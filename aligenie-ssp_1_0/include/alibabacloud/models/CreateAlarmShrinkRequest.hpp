...
#ifndef ALIBABACLOUD_MODELS_CREATEALARMSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEALARMSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAlarmShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateAlarmShrinkRequest& obj) { 
    ...
    CreateAlarmShrinkRequest() = default ;
    CreateAlarmShrinkRequest(const CreateAlarmShrinkRequest &) = default ;
    CreateAlarmShrinkRequest(CreateAlarmShrinkRequest &&) = default ;
    CreateAlarmShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAlarmShrinkRequest() = default ;
    CreateAlarmShrinkRequest& operator=(const CreateAlarmShrinkRequest &) = default ;
    CreateAlarmShrinkRequest& operator=(CreateAlarmShrinkRequest &&) = default ;
    ...
    inline CreateAlarmShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline CreateAlarmShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline CreateAlarmShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
