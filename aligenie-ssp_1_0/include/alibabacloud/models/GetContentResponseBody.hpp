...
#ifndef ALIBABACLOUD_MODELS_GETCONTENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETCONTENTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetContentResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Result, result_);
    };
    friend void from_json(const Darabonba::Json& j, GetContentResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Result, result_);
    };
    GetContentResponseBody() = default ;
    GetContentResponseBody(const GetContentResponseBody &) = default ;
    GetContentResponseBody(GetContentResponseBody &&) = default ;
    GetContentResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetContentResponseBody() = default ;
    GetContentResponseBody& operator=(const GetContentResponseBody &) = default ;
    GetContentResponseBody& operator=(GetContentResponseBody &&) = default ;
    ...
    inline GetContentResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetContentResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetContentResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const GetContentResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, GetContentResponseBody::Result) };
    inline GetContentResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, GetContentResponseBody::Result) };
    inline GetContentResponseBody& setResult(const GetContentResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetContentResponseBody& setResult(GetContentResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return Result
    shared_ptr<GetContentResponseBody::Result> result_ {};
  };
