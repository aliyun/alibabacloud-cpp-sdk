...
namespace Models
{
  ...
  public:
    ...
    inline string getOpenProgressControlRequestShrink() const { DARABONBA_PTR_GET_DEFAULT(openProgressControlRequestShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> openProgressControlRequestShrink_ {};
