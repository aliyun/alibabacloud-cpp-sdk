...
namespace Models
{
  ...
  public:
    ...
    inline string getOpenQueryPlayListRequestShrink() const { DARABONBA_PTR_GET_DEFAULT(openQueryPlayListRequestShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> openQueryPlayListRequestShrink_ {};
