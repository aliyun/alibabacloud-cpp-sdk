...
namespace Models
{
  ...
  public:
    ...
    inline const AuthLoginWithThirdUserInfoResponseBodyDataObj & dataObj() const { DARABONBA_PTR_GET_CONST(dataObj_, AuthLoginWithThirdUserInfoResponseBodyDataObj) };
    inline AuthLoginWithThirdUserInfoResponseBodyDataObj dataObj() { DARABONBA_PTR_GET(dataObj_, AuthLoginWithThirdUserInfoResponseBodyDataObj) };
    inline AuthLoginWithThirdUserInfoResponseBody& setDataObj(const AuthLoginWithThirdUserInfoResponseBodyDataObj & dataObj) { DARABONBA_PTR_SET_VALUE(dataObj_, dataObj) };
    inline AuthLoginWithThirdUserInfoResponseBody& setDataObj(AuthLoginWithThirdUserInfoResponseBodyDataObj && dataObj) { DARABONBA_PTR_SET_RVALUE(dataObj_, dataObj) };
    ...
    inline const AuthLoginWithThirdUserInfoResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, AuthLoginWithThirdUserInfoResponseBodyResult) };
    inline AuthLoginWithThirdUserInfoResponseBodyResult result() { DARABONBA_PTR_GET(result_, AuthLoginWithThirdUserInfoResponseBodyResult) };
    inline AuthLoginWithThirdUserInfoResponseBody& setResult(const AuthLoginWithThirdUserInfoResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline AuthLoginWithThirdUserInfoResponseBody& setResult(AuthLoginWithThirdUserInfoResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<AuthLoginWithThirdUserInfoResponseBodyDataObj> dataObj_ = nullptr;
    std::shared_ptr<string> message_ = nullptr;
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<AuthLoginWithThirdUserInfoResponseBodyResult> result_ = nullptr;
