...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListAlbumIsAddedResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListAlbumIsAddedResponseBodyResult>) };
    inline vector<ListAlbumIsAddedResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListAlbumIsAddedResponseBodyResult>) };
    inline ListAlbumIsAddedResponseBody& setResult(const vector<ListAlbumIsAddedResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListAlbumIsAddedResponseBody& setResult(vector<ListAlbumIsAddedResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListAlbumIsAddedResponseBodyResult>> result_ = nullptr;
  };
