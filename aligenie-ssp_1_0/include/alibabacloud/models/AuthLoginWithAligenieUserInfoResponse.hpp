...
namespace Models
{
  ...
  public:
    ...
    inline const AuthLoginWithAligenieUserInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AuthLoginWithAligenieUserInfoResponseBody) };
    inline AuthLoginWithAligenieUserInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, AuthLoginWithAligenieUserInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AuthLoginWithAligenieUserInfoResponseBody> body_ {};
  };
