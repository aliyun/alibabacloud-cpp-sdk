...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAlarmRequest::DeviceInfo & getDeviceInfo() const { DARABONBA_PTR_GET_CONST(deviceInfo_, UpdateAlarmRequest::DeviceInfo) };
    inline UpdateAlarmRequest::DeviceInfo getDeviceInfo() { DARABONBA_PTR_GET(deviceInfo_, UpdateAlarmRequest::DeviceInfo) };
    inline UpdateAlarmRequest& setDeviceInfo(const UpdateAlarmRequest::DeviceInfo & deviceInfo) { DARABONBA_PTR_SET_VALUE(deviceInfo_, deviceInfo) };
    inline UpdateAlarmRequest& setDeviceInfo(UpdateAlarmRequest::DeviceInfo && deviceInfo) { DARABONBA_PTR_SET_RVALUE(deviceInfo_, deviceInfo) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const UpdateAlarmRequest::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, UpdateAlarmRequest::Payload) };
    inline UpdateAlarmRequest::Payload getPayload() { DARABONBA_PTR_GET(payload_, UpdateAlarmRequest::Payload) };
    inline UpdateAlarmRequest& setPayload(const UpdateAlarmRequest::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline UpdateAlarmRequest& setPayload(UpdateAlarmRequest::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };


    // userInfo Field Functions 
    bool hasUserInfo() const { return this->userInfo_ != nullptr;};
    void deleteUserInfo() { this->userInfo_ = nullptr;};
    inline const UpdateAlarmRequest::UserInfo & getUserInfo() const { DARABONBA_PTR_GET_CONST(userInfo_, UpdateAlarmRequest::UserInfo) };
    inline UpdateAlarmRequest::UserInfo getUserInfo() { DARABONBA_PTR_GET(userInfo_, UpdateAlarmRequest::UserInfo) };
    inline UpdateAlarmRequest& setUserInfo(const UpdateAlarmRequest::UserInfo & userInfo) { DARABONBA_PTR_SET_VALUE(userInfo_, userInfo) };
    inline UpdateAlarmRequest& setUserInfo(UpdateAlarmRequest::UserInfo && userInfo) { DARABONBA_PTR_SET_RVALUE(userInfo_, userInfo) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<UpdateAlarmRequest::DeviceInfo> deviceInfo_ {};
    // Input parameters for the service request
    // 
    // This parameter is required.
    shared_ptr<UpdateAlarmRequest::Payload> payload_ {};
    // User Identifier Information
    // 
    // This parameter is required.
    shared_ptr<UpdateAlarmRequest::UserInfo> userInfo_ {};
  };
