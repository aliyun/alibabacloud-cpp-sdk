...
namespace Models
{
  ...
  public:
    ...
    inline string getQuerySubscriptionAlbumRequestShrink() const { DARABONBA_PTR_GET_DEFAULT(querySubscriptionAlbumRequestShrink_, "") };
  ...
  protected:
    ...
    // request
    shared_ptr<string> querySubscriptionAlbumRequestShrink_ {};
    // User information
