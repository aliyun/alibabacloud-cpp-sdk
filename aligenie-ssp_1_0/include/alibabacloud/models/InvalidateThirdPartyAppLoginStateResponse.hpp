...
namespace Models
{
  ...
  public:
    ...
    inline const InvalidateThirdPartyAppLoginStateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InvalidateThirdPartyAppLoginStateResponseBody) };
    inline InvalidateThirdPartyAppLoginStateResponseBody getBody() { DARABONBA_PTR_GET(body_, InvalidateThirdPartyAppLoginStateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InvalidateThirdPartyAppLoginStateResponseBody> body_ {};
  };
