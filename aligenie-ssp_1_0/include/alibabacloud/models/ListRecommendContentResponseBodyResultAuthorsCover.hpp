...
#ifndef ALIBABACLOUD_MODELS_LISTRECOMMENDCONTENTRESPONSEBODYRESULTAUTHORSCOVER_HPP_
#define ALIBABACLOUD_MODELS_LISTRECOMMENDCONTENTRESPONSEBODYRESULTAUTHORSCOVER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListRecommendContentResponseBodyResultAuthorsCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListRecommendContentResponseBodyResultAuthorsCover& obj) { 
    ...
    ListRecommendContentResponseBodyResultAuthorsCover() = default ;
    ListRecommendContentResponseBodyResultAuthorsCover(const ListRecommendContentResponseBodyResultAuthorsCover &) = default ;
    ListRecommendContentResponseBodyResultAuthorsCover(ListRecommendContentResponseBodyResultAuthorsCover &&) = default ;
    ListRecommendContentResponseBodyResultAuthorsCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListRecommendContentResponseBodyResultAuthorsCover() = default ;
    ListRecommendContentResponseBodyResultAuthorsCover& operator=(const ListRecommendContentResponseBodyResultAuthorsCover &) = default ;
    ListRecommendContentResponseBodyResultAuthorsCover& operator=(ListRecommendContentResponseBodyResultAuthorsCover &&) = default ;
    ...
    inline ListRecommendContentResponseBodyResultAuthorsCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline ListRecommendContentResponseBodyResultAuthorsCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline ListRecommendContentResponseBodyResultAuthorsCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline ListRecommendContentResponseBodyResultAuthorsCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline ListRecommendContentResponseBodyResultAuthorsCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
