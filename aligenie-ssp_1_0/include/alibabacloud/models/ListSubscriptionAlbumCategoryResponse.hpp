...
namespace Models
{
  ...
  public:
    ...
    inline const ListSubscriptionAlbumCategoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSubscriptionAlbumCategoryResponseBody) };
    inline ListSubscriptionAlbumCategoryResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSubscriptionAlbumCategoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSubscriptionAlbumCategoryResponseBody> body_ {};
  };
