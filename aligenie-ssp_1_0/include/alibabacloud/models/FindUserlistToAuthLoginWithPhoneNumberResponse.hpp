...
namespace Models
{
  ...
  public:
    ...
    inline const FindUserlistToAuthLoginWithPhoneNumberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, FindUserlistToAuthLoginWithPhoneNumberResponseBody) };
    inline FindUserlistToAuthLoginWithPhoneNumberResponseBody getBody() { DARABONBA_PTR_GET(body_, FindUserlistToAuthLoginWithPhoneNumberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<FindUserlistToAuthLoginWithPhoneNumberResponseBody> body_ {};
  };
