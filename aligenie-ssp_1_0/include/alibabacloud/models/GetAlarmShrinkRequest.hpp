...
#ifndef ALIBABACLOUD_MODELS_GETALARMSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETALARMSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAlarmShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAlarmShrinkRequest& obj) { 
    ...
    GetAlarmShrinkRequest() = default ;
    GetAlarmShrinkRequest(const GetAlarmShrinkRequest &) = default ;
    GetAlarmShrinkRequest(GetAlarmShrinkRequest &&) = default ;
    GetAlarmShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAlarmShrinkRequest() = default ;
    GetAlarmShrinkRequest& operator=(const GetAlarmShrinkRequest &) = default ;
    GetAlarmShrinkRequest& operator=(GetAlarmShrinkRequest &&) = default ;
    ...
    inline GetAlarmShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline GetAlarmShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline GetAlarmShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
