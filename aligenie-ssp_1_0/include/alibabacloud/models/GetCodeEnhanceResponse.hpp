...
namespace Models
{
  ...
  public:
    ...
    inline const GetCodeEnhanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCodeEnhanceResponseBody) };
    inline GetCodeEnhanceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCodeEnhanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCodeEnhanceResponseBody> body_ {};
  };
