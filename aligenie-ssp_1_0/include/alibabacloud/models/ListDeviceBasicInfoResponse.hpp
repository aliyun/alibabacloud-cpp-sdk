...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeviceBasicInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDeviceBasicInfoResponseBody) };
    inline ListDeviceBasicInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDeviceBasicInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDeviceBasicInfoResponseBody> body_ {};
  };
