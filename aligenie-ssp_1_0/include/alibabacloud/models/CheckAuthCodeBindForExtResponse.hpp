...
namespace Models
{
  ...
  public:
    ...
    inline const CheckAuthCodeBindForExtResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckAuthCodeBindForExtResponseBody) };
    inline CheckAuthCodeBindForExtResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckAuthCodeBindForExtResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckAuthCodeBindForExtResponseBody> body_ {};
  };
