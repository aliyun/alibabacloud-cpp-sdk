...
#ifndef ALIBABACLOUD_MODELS_CREATEPLAYINGLISTRESPONSEBODYRESULTCOVER_HPP_
#define ALIBABACLOUD_MODELS_CREATEPLAYINGLISTRESPONSEBODYRESULTCOVER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePlayingListResponseBodyResultCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePlayingListResponseBodyResultCover& obj) { 
    ...
    CreatePlayingListResponseBodyResultCover() = default ;
    CreatePlayingListResponseBodyResultCover(const CreatePlayingListResponseBodyResultCover &) = default ;
    CreatePlayingListResponseBodyResultCover(CreatePlayingListResponseBodyResultCover &&) = default ;
    CreatePlayingListResponseBodyResultCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePlayingListResponseBodyResultCover() = default ;
    CreatePlayingListResponseBodyResultCover& operator=(const CreatePlayingListResponseBodyResultCover &) = default ;
    CreatePlayingListResponseBodyResultCover& operator=(CreatePlayingListResponseBodyResultCover &&) = default ;
    ...
    inline CreatePlayingListResponseBodyResultCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline CreatePlayingListResponseBodyResultCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline CreatePlayingListResponseBodyResultCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline CreatePlayingListResponseBodyResultCover& setMediam(string mediam) { DARABONBA_PTR_SET_VALUE(mediam_, mediam) };
    ...
    inline CreatePlayingListResponseBodyResultCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline CreatePlayingListResponseBodyResultCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
