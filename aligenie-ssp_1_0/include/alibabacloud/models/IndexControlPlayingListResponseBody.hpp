...
#ifndef ALIBABACLOUD_MODELS_INDEXCONTROLPLAYINGLISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_INDEXCONTROLPLAYINGLISTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const IndexControlPlayingListResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, IndexControlPlayingListResponseBody& obj) { 
    ...
    IndexControlPlayingListResponseBody() = default ;
    IndexControlPlayingListResponseBody(const IndexControlPlayingListResponseBody &) = default ;
    IndexControlPlayingListResponseBody(IndexControlPlayingListResponseBody &&) = default ;
    IndexControlPlayingListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~IndexControlPlayingListResponseBody() = default ;
    IndexControlPlayingListResponseBody& operator=(const IndexControlPlayingListResponseBody &) = default ;
    IndexControlPlayingListResponseBody& operator=(IndexControlPlayingListResponseBody &&) = default ;
    ...
    inline IndexControlPlayingListResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline IndexControlPlayingListResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline IndexControlPlayingListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const IndexControlPlayingListResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, IndexControlPlayingListResponseBody::Result) };
    inline IndexControlPlayingListResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, IndexControlPlayingListResponseBody::Result) };
    inline IndexControlPlayingListResponseBody& setResult(const IndexControlPlayingListResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline IndexControlPlayingListResponseBody& setResult(IndexControlPlayingListResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline IndexControlPlayingListResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<IndexControlPlayingListResponseBody::Result> result_ {};
