...
#ifndef ALIBABACLOUD_MODELS_CREATEPLAYINGLISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEPLAYINGLISTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePlayingListResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePlayingListResponseBody& obj) { 
    ...
    CreatePlayingListResponseBody() = default ;
    CreatePlayingListResponseBody(const CreatePlayingListResponseBody &) = default ;
    CreatePlayingListResponseBody(CreatePlayingListResponseBody &&) = default ;
    CreatePlayingListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePlayingListResponseBody() = default ;
    CreatePlayingListResponseBody& operator=(const CreatePlayingListResponseBody &) = default ;
    CreatePlayingListResponseBody& operator=(CreatePlayingListResponseBody &&) = default ;
    ...
    inline CreatePlayingListResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreatePlayingListResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreatePlayingListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const CreatePlayingListResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, CreatePlayingListResponseBody::Result) };
    inline CreatePlayingListResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, CreatePlayingListResponseBody::Result) };
    inline CreatePlayingListResponseBody& setResult(const CreatePlayingListResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreatePlayingListResponseBody& setResult(CreatePlayingListResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline CreatePlayingListResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<CreatePlayingListResponseBody::Result> result_ {};
