...
#ifndef ALIBABACLOUD_MODELS_UPDATEALARMREQUESTPAYLOADSCHEDULEINFOONCE_HPP_
#define ALIBABACLOUD_MODELS_UPDATEALARMREQUESTPAYLOADSCHEDULEINFOONCE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAlarmRequestPayloadScheduleInfoOnce& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateAlarmRequestPayloadScheduleInfoOnce& obj) { 
    ...
    UpdateAlarmRequestPayloadScheduleInfoOnce() = default ;
    UpdateAlarmRequestPayloadScheduleInfoOnce(const UpdateAlarmRequestPayloadScheduleInfoOnce &) = default ;
    UpdateAlarmRequestPayloadScheduleInfoOnce(UpdateAlarmRequestPayloadScheduleInfoOnce &&) = default ;
    UpdateAlarmRequestPayloadScheduleInfoOnce(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAlarmRequestPayloadScheduleInfoOnce() = default ;
    UpdateAlarmRequestPayloadScheduleInfoOnce& operator=(const UpdateAlarmRequestPayloadScheduleInfoOnce &) = default ;
    UpdateAlarmRequestPayloadScheduleInfoOnce& operator=(UpdateAlarmRequestPayloadScheduleInfoOnce &&) = default ;
    ...
    inline UpdateAlarmRequestPayloadScheduleInfoOnce& setDay(int32_t day) { DARABONBA_PTR_SET_VALUE(day_, day) };
    ...
    inline UpdateAlarmRequestPayloadScheduleInfoOnce& setHour(int32_t hour) { DARABONBA_PTR_SET_VALUE(hour_, hour) };
    ...
    inline UpdateAlarmRequestPayloadScheduleInfoOnce& setMinute(int32_t minute) { DARABONBA_PTR_SET_VALUE(minute_, minute) };
    ...
    inline UpdateAlarmRequestPayloadScheduleInfoOnce& setMonth(int32_t month) { DARABONBA_PTR_SET_VALUE(month_, month) };
    ...
    inline UpdateAlarmRequestPayloadScheduleInfoOnce& setYear(int32_t year) { DARABONBA_PTR_SET_VALUE(year_, year) };
