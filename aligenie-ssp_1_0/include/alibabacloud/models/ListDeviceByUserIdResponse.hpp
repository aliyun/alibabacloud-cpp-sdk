...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeviceByUserIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDeviceByUserIdResponseBody) };
    inline ListDeviceByUserIdResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDeviceByUserIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDeviceByUserIdResponseBody> body_ {};
  };
