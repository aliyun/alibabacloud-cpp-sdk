...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserByDeviceIdResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetUserByDeviceIdResponseBodyResult) };
    inline GetUserByDeviceIdResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetUserByDeviceIdResponseBodyResult) };
    inline GetUserByDeviceIdResponseBody& setResult(const GetUserByDeviceIdResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetUserByDeviceIdResponseBody& setResult(GetUserByDeviceIdResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetUserByDeviceIdResponseBodyResult> result_ = nullptr;
  };
