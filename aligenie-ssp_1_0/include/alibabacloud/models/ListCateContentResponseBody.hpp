...
namespace Models
{
  ...
  public:
    ...
    inline const ListCateContentResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListCateContentResponseBodyResult) };
    inline ListCateContentResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListCateContentResponseBodyResult) };
    inline ListCateContentResponseBody& setResult(const ListCateContentResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListCateContentResponseBody& setResult(ListCateContentResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ListCateContentResponseBodyResult> result_ = nullptr;
  };
