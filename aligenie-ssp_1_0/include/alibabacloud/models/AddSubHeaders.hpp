...
#ifndef ALIBABACLOUD_MODELS_ADDSUBHEADERS_HPP_
#define ALIBABACLOUD_MODELS_ADDSUBHEADERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddSubHeaders& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AddSubHeaders& obj) { 
    ...
    AddSubHeaders() = default ;
    AddSubHeaders(const AddSubHeaders &) = default ;
    AddSubHeaders(AddSubHeaders &&) = default ;
    AddSubHeaders(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddSubHeaders() = default ;
    AddSubHeaders& operator=(const AddSubHeaders &) = default ;
    AddSubHeaders& operator=(AddSubHeaders &&) = default ;
    ...
    inline AddSubHeaders& setCommonHeaders(const map<string, string> & commonHeaders) { DARABONBA_PTR_SET_VALUE(commonHeaders_, commonHeaders) };
    inline AddSubHeaders& setCommonHeaders(map<string, string> && commonHeaders) { DARABONBA_PTR_SET_RVALUE(commonHeaders_, commonHeaders) };
    ...
    inline AddSubHeaders& setXAcsAligenieAccessToken(string xAcsAligenieAccessToken) { DARABONBA_PTR_SET_VALUE(xAcsAligenieAccessToken_, xAcsAligenieAccessToken) };
    ...
    inline AddSubHeaders& setAuthorization(string authorization) { DARABONBA_PTR_SET_VALUE(authorization_, authorization) };
