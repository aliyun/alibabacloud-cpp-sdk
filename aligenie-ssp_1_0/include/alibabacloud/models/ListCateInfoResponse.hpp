...
namespace Models
{
  ...
  public:
    ...
    inline const ListCateInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCateInfoResponseBody) };
    inline ListCateInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCateInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCateInfoResponseBody> body_ {};
  };
