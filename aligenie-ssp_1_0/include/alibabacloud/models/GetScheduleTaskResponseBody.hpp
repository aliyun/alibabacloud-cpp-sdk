...
namespace Models
{
  ...
  public:
    ...
    inline const GetScheduleTaskResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetScheduleTaskResponseBodyResult) };
    inline GetScheduleTaskResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetScheduleTaskResponseBodyResult) };
    inline GetScheduleTaskResponseBody& setResult(const GetScheduleTaskResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetScheduleTaskResponseBody& setResult(GetScheduleTaskResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetScheduleTaskResponseBodyResult> result_ = nullptr;
  };
