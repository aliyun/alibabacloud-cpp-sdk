...
namespace Models
{
  ...
  public:
    ...
    inline const ListAlarmsRequest::DeviceInfo & getDeviceInfo() const { DARABONBA_PTR_GET_CONST(deviceInfo_, ListAlarmsRequest::DeviceInfo) };
    inline ListAlarmsRequest::DeviceInfo getDeviceInfo() { DARABONBA_PTR_GET(deviceInfo_, ListAlarmsRequest::DeviceInfo) };
    inline ListAlarmsRequest& setDeviceInfo(const ListAlarmsRequest::DeviceInfo & deviceInfo) { DARABONBA_PTR_SET_VALUE(deviceInfo_, deviceInfo) };
    inline ListAlarmsRequest& setDeviceInfo(ListAlarmsRequest::DeviceInfo && deviceInfo) { DARABONBA_PTR_SET_RVALUE(deviceInfo_, deviceInfo) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const ListAlarmsRequest::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, ListAlarmsRequest::Payload) };
    inline ListAlarmsRequest::Payload getPayload() { DARABONBA_PTR_GET(payload_, ListAlarmsRequest::Payload) };
    inline ListAlarmsRequest& setPayload(const ListAlarmsRequest::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline ListAlarmsRequest& setPayload(ListAlarmsRequest::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };


    // userInfo Field Functions 
    bool hasUserInfo() const { return this->userInfo_ != nullptr;};
    void deleteUserInfo() { this->userInfo_ = nullptr;};
    inline const ListAlarmsRequest::UserInfo & getUserInfo() const { DARABONBA_PTR_GET_CONST(userInfo_, ListAlarmsRequest::UserInfo) };
    inline ListAlarmsRequest::UserInfo getUserInfo() { DARABONBA_PTR_GET(userInfo_, ListAlarmsRequest::UserInfo) };
    inline ListAlarmsRequest& setUserInfo(const ListAlarmsRequest::UserInfo & userInfo) { DARABONBA_PTR_SET_VALUE(userInfo_, userInfo) };
    inline ListAlarmsRequest& setUserInfo(ListAlarmsRequest::UserInfo && userInfo) { DARABONBA_PTR_SET_RVALUE(userInfo_, userInfo) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<ListAlarmsRequest::DeviceInfo> deviceInfo_ {};
    // Input parameters for the service request
    // 
    // This parameter is required.
    shared_ptr<ListAlarmsRequest::Payload> payload_ {};
    // User identifier information
    // 
    // This parameter is required.
    shared_ptr<ListAlarmsRequest::UserInfo> userInfo_ {};
  };
