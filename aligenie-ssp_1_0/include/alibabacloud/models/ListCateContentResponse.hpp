...
namespace Models
{
  ...
  public:
    ...
    inline const ListCateContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCateContentResponseBody) };
    inline ListCateContentResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCateContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCateContentResponseBody> body_ {};
  };
