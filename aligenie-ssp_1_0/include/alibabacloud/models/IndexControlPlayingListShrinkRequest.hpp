...
namespace Models
{
  ...
  public:
    ...
    inline string getOpenIndexControlRequestShrink() const { DARABONBA_PTR_GET_DEFAULT(openIndexControlRequestShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> openIndexControlRequestShrink_ {};
