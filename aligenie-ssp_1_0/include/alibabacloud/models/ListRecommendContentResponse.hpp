...
namespace Models
{
  ...
  public:
    ...
    inline const ListRecommendContentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRecommendContentResponseBody) };
    inline ListRecommendContentResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRecommendContentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRecommendContentResponseBody> body_ {};
  };
