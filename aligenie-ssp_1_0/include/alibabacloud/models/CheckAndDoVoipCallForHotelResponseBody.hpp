...
namespace Models
{
  ...
  public:
    ...
    inline const CheckAndDoVoipCallForHotelResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CheckAndDoVoipCallForHotelResponseBodyResult) };
    inline CheckAndDoVoipCallForHotelResponseBodyResult result() { DARABONBA_PTR_GET(result_, CheckAndDoVoipCallForHotelResponseBodyResult) };
    inline CheckAndDoVoipCallForHotelResponseBody& setResult(const CheckAndDoVoipCallForHotelResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CheckAndDoVoipCallForHotelResponseBody& setResult(CheckAndDoVoipCallForHotelResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<CheckAndDoVoipCallForHotelResponseBodyResult> result_ = nullptr;
  };
