...
#ifndef ALIBABACLOUD_MODELS_LISTPLAYHISTORYRESPONSEBODYRESULTCOVER_HPP_
#define ALIBABACLOUD_MODELS_LISTPLAYHISTORYRESPONSEBODYRESULTCOVER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListPlayHistoryResponseBodyResultCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListPlayHistoryResponseBodyResultCover& obj) { 
    ...
    ListPlayHistoryResponseBodyResultCover() = default ;
    ListPlayHistoryResponseBodyResultCover(const ListPlayHistoryResponseBodyResultCover &) = default ;
    ListPlayHistoryResponseBodyResultCover(ListPlayHistoryResponseBodyResultCover &&) = default ;
    ListPlayHistoryResponseBodyResultCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListPlayHistoryResponseBodyResultCover() = default ;
    ListPlayHistoryResponseBodyResultCover& operator=(const ListPlayHistoryResponseBodyResultCover &) = default ;
    ListPlayHistoryResponseBodyResultCover& operator=(ListPlayHistoryResponseBodyResultCover &&) = default ;
    ...
    inline ListPlayHistoryResponseBodyResultCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline ListPlayHistoryResponseBodyResultCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline ListPlayHistoryResponseBodyResultCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline ListPlayHistoryResponseBodyResultCover& setMediam(string mediam) { DARABONBA_PTR_SET_VALUE(mediam_, mediam) };
    ...
    inline ListPlayHistoryResponseBodyResultCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline ListPlayHistoryResponseBodyResultCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
