...
namespace Models
{
  ...
  public:
    ...
    inline const ListMusicResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListMusicResponseBodyResult) };
    inline ListMusicResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListMusicResponseBodyResult) };
    inline ListMusicResponseBody& setResult(const ListMusicResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListMusicResponseBody& setResult(ListMusicResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ListMusicResponseBodyResult> result_ = nullptr;
  };
