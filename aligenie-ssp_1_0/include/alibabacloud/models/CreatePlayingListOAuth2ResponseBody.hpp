...
#ifndef ALIBABACLOUD_MODELS_CREATEPLAYINGLISTOAUTH2RESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEPLAYINGLISTOAUTH2RESPONSEBODY_HPP_
...
namespace Models
{
  class CreatePlayingListOAuth2ResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreatePlayingListOAuth2ResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePlayingListOAuth2ResponseBody& obj) { 
    ...
    CreatePlayingListOAuth2ResponseBody() = default ;
    CreatePlayingListOAuth2ResponseBody(const CreatePlayingListOAuth2ResponseBody &) = default ;
    CreatePlayingListOAuth2ResponseBody(CreatePlayingListOAuth2ResponseBody &&) = default ;
    CreatePlayingListOAuth2ResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePlayingListOAuth2ResponseBody() = default ;
    CreatePlayingListOAuth2ResponseBody& operator=(const CreatePlayingListOAuth2ResponseBody &) = default ;
    CreatePlayingListOAuth2ResponseBody& operator=(CreatePlayingListOAuth2ResponseBody &&) = default ;
    ...
    inline CreatePlayingListOAuth2ResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreatePlayingListOAuth2ResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreatePlayingListOAuth2ResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const CreatePlayingListOAuth2ResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, CreatePlayingListOAuth2ResponseBody::Result) };
    inline CreatePlayingListOAuth2ResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, CreatePlayingListOAuth2ResponseBody::Result) };
    inline CreatePlayingListOAuth2ResponseBody& setResult(const CreatePlayingListOAuth2ResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CreatePlayingListOAuth2ResponseBody& setResult(CreatePlayingListOAuth2ResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline CreatePlayingListOAuth2ResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<CreatePlayingListOAuth2ResponseBody::Result> result_ {};
