...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListRecommendContentResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListRecommendContentResponseBody::Result>) };
    inline vector<ListRecommendContentResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListRecommendContentResponseBody::Result>) };
    inline ListRecommendContentResponseBody& setResult(const vector<ListRecommendContentResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListRecommendContentResponseBody& setResult(vector<ListRecommendContentResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return Result
    shared_ptr<vector<ListRecommendContentResponseBody::Result>> result_ {};
  };
