...
namespace Models
{
  ...
  public:
    ...
    inline const ScanCodeBindResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ScanCodeBindResponseBody) };
    inline ScanCodeBindResponseBody getBody() { DARABONBA_PTR_GET(body_, ScanCodeBindResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ScanCodeBindResponseBody> body_ {};
  };
