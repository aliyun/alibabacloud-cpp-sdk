...
namespace Models
{
  ...
  public:
    ...
    inline CreateAlarmResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreateAlarmResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateAlarmResponseBody& setResult(int64_t result) { DARABONBA_PTR_SET_VALUE(result_, result) };
