...
#ifndef ALIBABACLOUD_MODELS_UNBINDDEVICESHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UNBINDDEVICESHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UnbindDeviceShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DeviceInfo, deviceInfoShrink_);
      DARABONBA_PTR_TO_JSON(UserInfo, userInfoShrink_);
    };
    friend void from_json(const Darabonba::Json& j, UnbindDeviceShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DeviceInfo, deviceInfoShrink_);
      DARABONBA_PTR_FROM_JSON(UserInfo, userInfoShrink_);
    };
    UnbindDeviceShrinkRequest() = default ;
    UnbindDeviceShrinkRequest(const UnbindDeviceShrinkRequest &) = default ;
    UnbindDeviceShrinkRequest(UnbindDeviceShrinkRequest &&) = default ;
    UnbindDeviceShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UnbindDeviceShrinkRequest() = default ;
    UnbindDeviceShrinkRequest& operator=(const UnbindDeviceShrinkRequest &) = default ;
    UnbindDeviceShrinkRequest& operator=(UnbindDeviceShrinkRequest &&) = default ;
    ...
    inline UnbindDeviceShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline UnbindDeviceShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
