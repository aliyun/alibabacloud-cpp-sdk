...
#ifndef ALIBABACLOUD_MODELS_UPDATEALARMSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEALARMSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateAlarmShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateAlarmShrinkRequest& obj) { 
    ...
    UpdateAlarmShrinkRequest() = default ;
    UpdateAlarmShrinkRequest(const UpdateAlarmShrinkRequest &) = default ;
    UpdateAlarmShrinkRequest(UpdateAlarmShrinkRequest &&) = default ;
    UpdateAlarmShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateAlarmShrinkRequest() = default ;
    UpdateAlarmShrinkRequest& operator=(const UpdateAlarmShrinkRequest &) = default ;
    UpdateAlarmShrinkRequest& operator=(UpdateAlarmShrinkRequest &&) = default ;
    ...
    inline UpdateAlarmShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline UpdateAlarmShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline UpdateAlarmShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
