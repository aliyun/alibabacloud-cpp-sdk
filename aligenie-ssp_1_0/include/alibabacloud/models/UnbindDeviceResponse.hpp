...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindDeviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnbindDeviceResponseBody) };
    inline UnbindDeviceResponseBody getBody() { DARABONBA_PTR_GET(body_, UnbindDeviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnbindDeviceResponseBody> body_ {};
  };
