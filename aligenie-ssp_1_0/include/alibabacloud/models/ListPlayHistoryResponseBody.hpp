...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListPlayHistoryResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListPlayHistoryResponseBodyResult>) };
    inline vector<ListPlayHistoryResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListPlayHistoryResponseBodyResult>) };
    inline ListPlayHistoryResponseBody& setResult(const vector<ListPlayHistoryResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListPlayHistoryResponseBody& setResult(vector<ListPlayHistoryResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListPlayHistoryResponseBodyResult>> result_ = nullptr;
    // Id of the request
