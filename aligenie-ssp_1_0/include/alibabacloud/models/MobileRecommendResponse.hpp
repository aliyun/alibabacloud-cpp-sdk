...
namespace Models
{
  ...
  public:
    ...
    inline const MobileRecommendResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MobileRecommendResponseBody) };
    inline MobileRecommendResponseBody getBody() { DARABONBA_PTR_GET(body_, MobileRecommendResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MobileRecommendResponseBody> body_ {};
  };
