...
#ifndef ALIBABACLOUD_MODELS_CREATEALARMREQUESTPAYLOADSCHEDULEINFOONCE_HPP_
#define ALIBABACLOUD_MODELS_CREATEALARMREQUESTPAYLOADSCHEDULEINFOONCE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAlarmRequestPayloadScheduleInfoOnce& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateAlarmRequestPayloadScheduleInfoOnce& obj) { 
    ...
    CreateAlarmRequestPayloadScheduleInfoOnce() = default ;
    CreateAlarmRequestPayloadScheduleInfoOnce(const CreateAlarmRequestPayloadScheduleInfoOnce &) = default ;
    CreateAlarmRequestPayloadScheduleInfoOnce(CreateAlarmRequestPayloadScheduleInfoOnce &&) = default ;
    CreateAlarmRequestPayloadScheduleInfoOnce(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAlarmRequestPayloadScheduleInfoOnce() = default ;
    CreateAlarmRequestPayloadScheduleInfoOnce& operator=(const CreateAlarmRequestPayloadScheduleInfoOnce &) = default ;
    CreateAlarmRequestPayloadScheduleInfoOnce& operator=(CreateAlarmRequestPayloadScheduleInfoOnce &&) = default ;
    ...
    inline CreateAlarmRequestPayloadScheduleInfoOnce& setDay(int32_t day) { DARABONBA_PTR_SET_VALUE(day_, day) };
    ...
    inline CreateAlarmRequestPayloadScheduleInfoOnce& setHour(int32_t hour) { DARABONBA_PTR_SET_VALUE(hour_, hour) };
    ...
    inline CreateAlarmRequestPayloadScheduleInfoOnce& setMinute(int32_t minute) { DARABONBA_PTR_SET_VALUE(minute_, minute) };
    ...
    inline CreateAlarmRequestPayloadScheduleInfoOnce& setMonth(int32_t month) { DARABONBA_PTR_SET_VALUE(month_, month) };
    ...
    inline CreateAlarmRequestPayloadScheduleInfoOnce& setYear(int32_t year) { DARABONBA_PTR_SET_VALUE(year_, year) };
