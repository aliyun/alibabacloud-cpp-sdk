...
#ifndef ALIBABACLOUD_MODELS_GETCONTENTRESPONSEBODYRESULTCOVER_HPP_
#define ALIBABACLOUD_MODELS_GETCONTENTRESPONSEBODYRESULTCOVER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetContentResponseBodyResultCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetContentResponseBodyResultCover& obj) { 
    ...
    GetContentResponseBodyResultCover() = default ;
    GetContentResponseBodyResultCover(const GetContentResponseBodyResultCover &) = default ;
    GetContentResponseBodyResultCover(GetContentResponseBodyResultCover &&) = default ;
    GetContentResponseBodyResultCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetContentResponseBodyResultCover() = default ;
    GetContentResponseBodyResultCover& operator=(const GetContentResponseBodyResultCover &) = default ;
    GetContentResponseBodyResultCover& operator=(GetContentResponseBodyResultCover &&) = default ;
    ...
    inline GetContentResponseBodyResultCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline GetContentResponseBodyResultCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline GetContentResponseBodyResultCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline GetContentResponseBodyResultCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline GetContentResponseBodyResultCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
