...
namespace Models
{
  ...
  public:
    ...
    inline const QueryUserDeviceListByTmeUserIdResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, QueryUserDeviceListByTmeUserIdResponseBodyResult) };
    inline QueryUserDeviceListByTmeUserIdResponseBodyResult result() { DARABONBA_PTR_GET(result_, QueryUserDeviceListByTmeUserIdResponseBodyResult) };
    inline QueryUserDeviceListByTmeUserIdResponseBody& setResult(const QueryUserDeviceListByTmeUserIdResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryUserDeviceListByTmeUserIdResponseBody& setResult(QueryUserDeviceListByTmeUserIdResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<QueryUserDeviceListByTmeUserIdResponseBodyResult> result_ = nullptr;
