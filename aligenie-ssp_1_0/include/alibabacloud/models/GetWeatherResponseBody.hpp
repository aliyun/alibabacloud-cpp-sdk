...
namespace Models
{
  ...
  public:
    ...
    inline const GetWeatherResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetWeatherResponseBodyResult) };
    inline GetWeatherResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetWeatherResponseBodyResult) };
    inline GetWeatherResponseBody& setResult(const GetWeatherResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetWeatherResponseBody& setResult(GetWeatherResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetWeatherResponseBodyResult> result_ = nullptr;
  };
