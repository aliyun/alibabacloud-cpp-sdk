...
namespace Models
{
  ...
  public:
    ...
    inline const DeviceControlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeviceControlResponseBody) };
    inline DeviceControlResponseBody getBody() { DARABONBA_PTR_GET(body_, DeviceControlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeviceControlResponseBody> body_ {};
  };
