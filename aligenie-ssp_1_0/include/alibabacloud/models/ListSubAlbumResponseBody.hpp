...
namespace Models
{
  ...
  public:
    ...
    inline const ListSubAlbumResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListSubAlbumResponseBodyResult) };
    inline ListSubAlbumResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListSubAlbumResponseBodyResult) };
    inline ListSubAlbumResponseBody& setResult(const ListSubAlbumResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListSubAlbumResponseBody& setResult(ListSubAlbumResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ListSubAlbumResponseBodyResult> result_ = nullptr;
  };
