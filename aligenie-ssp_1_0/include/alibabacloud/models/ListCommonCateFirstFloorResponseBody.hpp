...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListCommonCateFirstFloorResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListCommonCateFirstFloorResponseBody::Result>) };
    inline vector<ListCommonCateFirstFloorResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListCommonCateFirstFloorResponseBody::Result>) };
    inline ListCommonCateFirstFloorResponseBody& setResult(const vector<ListCommonCateFirstFloorResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListCommonCateFirstFloorResponseBody& setResult(vector<ListCommonCateFirstFloorResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return Result
    shared_ptr<vector<ListCommonCateFirstFloorResponseBody::Result>> result_ {};
  };
