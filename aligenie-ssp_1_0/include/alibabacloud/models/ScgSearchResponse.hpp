...
namespace Models
{
  ...
  public:
    ...
    inline const ScgSearchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ScgSearchResponseBody) };
    inline ScgSearchResponseBody getBody() { DARABONBA_PTR_GET(body_, ScgSearchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ScgSearchResponseBody> body_ {};
  };
