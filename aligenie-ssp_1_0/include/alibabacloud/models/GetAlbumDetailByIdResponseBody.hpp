...
namespace Models
{
  ...
  public:
    ...
    inline const GetAlbumDetailByIdResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetAlbumDetailByIdResponseBodyResult) };
    inline GetAlbumDetailByIdResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetAlbumDetailByIdResponseBodyResult) };
    inline GetAlbumDetailByIdResponseBody& setResult(const GetAlbumDetailByIdResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetAlbumDetailByIdResponseBody& setResult(GetAlbumDetailByIdResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetAlbumDetailByIdResponseBodyResult> result_ = nullptr;
  };
