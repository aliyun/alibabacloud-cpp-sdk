...
namespace Models
{
  ...
  public:
    ...
    inline const AuthLoginWithAligenieUserInfoGeneratedByPhoneNumberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AuthLoginWithAligenieUserInfoGeneratedByPhoneNumberResponseBody) };
    inline AuthLoginWithAligenieUserInfoGeneratedByPhoneNumberResponseBody getBody() { DARABONBA_PTR_GET(body_, AuthLoginWithAligenieUserInfoGeneratedByPhoneNumberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AuthLoginWithAligenieUserInfoGeneratedByPhoneNumberResponseBody> body_ {};
  };
