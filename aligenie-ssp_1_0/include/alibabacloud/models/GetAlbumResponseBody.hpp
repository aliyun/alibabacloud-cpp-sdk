...
#ifndef ALIBABACLOUD_MODELS_GETALBUMRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_GETALBUMRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAlbumResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Result, result_);
    };
    friend void from_json(const Darabonba::Json& j, GetAlbumResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Result, result_);
    };
    GetAlbumResponseBody() = default ;
    GetAlbumResponseBody(const GetAlbumResponseBody &) = default ;
    GetAlbumResponseBody(GetAlbumResponseBody &&) = default ;
    GetAlbumResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAlbumResponseBody() = default ;
    GetAlbumResponseBody& operator=(const GetAlbumResponseBody &) = default ;
    GetAlbumResponseBody& operator=(GetAlbumResponseBody &&) = default ;
    ...
    public:
      ...
      inline Result& setFinished(string finished) { DARABONBA_PTR_SET_VALUE(finished_, finished) };
      ...
      inline Result& setTotalEpisode(int32_t totalEpisode) { DARABONBA_PTR_SET_VALUE(totalEpisode_, totalEpisode) };
    ...
    inline GetAlbumResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetAlbumResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const GetAlbumResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, GetAlbumResponseBody::Result) };
    inline GetAlbumResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, GetAlbumResponseBody::Result) };
    inline GetAlbumResponseBody& setResult(const GetAlbumResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetAlbumResponseBody& setResult(GetAlbumResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return Result
    shared_ptr<GetAlbumResponseBody::Result> result_ {};
  };
