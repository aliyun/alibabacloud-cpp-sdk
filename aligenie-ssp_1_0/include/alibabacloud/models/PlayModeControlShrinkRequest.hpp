...
namespace Models
{
  ...
  public:
    ...
    inline string getOpenPlayModeControlRequestShrink() const { DARABONBA_PTR_GET_DEFAULT(openPlayModeControlRequestShrink_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> openPlayModeControlRequestShrink_ {};
