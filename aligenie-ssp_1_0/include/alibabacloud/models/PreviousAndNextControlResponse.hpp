...
namespace Models
{
  ...
  public:
    ...
    inline const PreviousAndNextControlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PreviousAndNextControlResponseBody) };
    inline PreviousAndNextControlResponseBody getBody() { DARABONBA_PTR_GET(body_, PreviousAndNextControlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PreviousAndNextControlResponseBody> body_ {};
  };
