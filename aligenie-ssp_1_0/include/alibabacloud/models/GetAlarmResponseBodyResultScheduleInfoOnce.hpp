...
#ifndef ALIBABACLOUD_MODELS_GETALARMRESPONSEBODYRESULTSCHEDULEINFOONCE_HPP_
#define ALIBABACLOUD_MODELS_GETALARMRESPONSEBODYRESULTSCHEDULEINFOONCE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAlarmResponseBodyResultScheduleInfoOnce& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAlarmResponseBodyResultScheduleInfoOnce& obj) { 
    ...
    GetAlarmResponseBodyResultScheduleInfoOnce() = default ;
    GetAlarmResponseBodyResultScheduleInfoOnce(const GetAlarmResponseBodyResultScheduleInfoOnce &) = default ;
    GetAlarmResponseBodyResultScheduleInfoOnce(GetAlarmResponseBodyResultScheduleInfoOnce &&) = default ;
    GetAlarmResponseBodyResultScheduleInfoOnce(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAlarmResponseBodyResultScheduleInfoOnce() = default ;
    GetAlarmResponseBodyResultScheduleInfoOnce& operator=(const GetAlarmResponseBodyResultScheduleInfoOnce &) = default ;
    GetAlarmResponseBodyResultScheduleInfoOnce& operator=(GetAlarmResponseBodyResultScheduleInfoOnce &&) = default ;
    ...
    inline GetAlarmResponseBodyResultScheduleInfoOnce& setDay(int32_t day) { DARABONBA_PTR_SET_VALUE(day_, day) };
    ...
    inline GetAlarmResponseBodyResultScheduleInfoOnce& setHour(int32_t hour) { DARABONBA_PTR_SET_VALUE(hour_, hour) };
    ...
    inline GetAlarmResponseBodyResultScheduleInfoOnce& setMinute(int32_t minute) { DARABONBA_PTR_SET_VALUE(minute_, minute) };
    ...
    inline GetAlarmResponseBodyResultScheduleInfoOnce& setMonth(int32_t month) { DARABONBA_PTR_SET_VALUE(month_, month) };
    ...
    inline GetAlarmResponseBodyResultScheduleInfoOnce& setYear(int32_t year) { DARABONBA_PTR_SET_VALUE(year_, year) };
