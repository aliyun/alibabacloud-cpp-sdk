...
#ifndef ALIBABACLOUD_MODELS_LISTALARMSRESPONSEBODYRESULTMODELSCHEDULEINFOONCE_HPP_
#define ALIBABACLOUD_MODELS_LISTALARMSRESPONSEBODYRESULTMODELSCHEDULEINFOONCE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAlarmsResponseBodyResultModelScheduleInfoOnce& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAlarmsResponseBodyResultModelScheduleInfoOnce& obj) { 
    ...
    ListAlarmsResponseBodyResultModelScheduleInfoOnce() = default ;
    ListAlarmsResponseBodyResultModelScheduleInfoOnce(const ListAlarmsResponseBodyResultModelScheduleInfoOnce &) = default ;
    ListAlarmsResponseBodyResultModelScheduleInfoOnce(ListAlarmsResponseBodyResultModelScheduleInfoOnce &&) = default ;
    ListAlarmsResponseBodyResultModelScheduleInfoOnce(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAlarmsResponseBodyResultModelScheduleInfoOnce() = default ;
    ListAlarmsResponseBodyResultModelScheduleInfoOnce& operator=(const ListAlarmsResponseBodyResultModelScheduleInfoOnce &) = default ;
    ListAlarmsResponseBodyResultModelScheduleInfoOnce& operator=(ListAlarmsResponseBodyResultModelScheduleInfoOnce &&) = default ;
    ...
    inline ListAlarmsResponseBodyResultModelScheduleInfoOnce& setDay(int32_t day) { DARABONBA_PTR_SET_VALUE(day_, day) };
    ...
    inline ListAlarmsResponseBodyResultModelScheduleInfoOnce& setHour(int32_t hour) { DARABONBA_PTR_SET_VALUE(hour_, hour) };
    ...
    inline ListAlarmsResponseBodyResultModelScheduleInfoOnce& setMinute(int32_t minute) { DARABONBA_PTR_SET_VALUE(minute_, minute) };
    ...
    inline ListAlarmsResponseBodyResultModelScheduleInfoOnce& setMonth(int32_t month) { DARABONBA_PTR_SET_VALUE(month_, month) };
    ...
    inline ListAlarmsResponseBodyResultModelScheduleInfoOnce& setYear(int32_t year) { DARABONBA_PTR_SET_VALUE(year_, year) };
