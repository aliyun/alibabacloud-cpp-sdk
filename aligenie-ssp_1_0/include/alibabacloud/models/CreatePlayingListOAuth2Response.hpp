...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePlayingListOAuth2ResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePlayingListOAuth2ResponseBody) };
    inline CreatePlayingListOAuth2ResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePlayingListOAuth2ResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePlayingListOAuth2ResponseBody> body_ {};
  };
