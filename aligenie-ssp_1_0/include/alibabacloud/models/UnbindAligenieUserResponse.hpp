...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindAligenieUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnbindAligenieUserResponseBody) };
    inline UnbindAligenieUserResponseBody getBody() { DARABONBA_PTR_GET(body_, UnbindAligenieUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnbindAligenieUserResponseBody> body_ {};
  };
