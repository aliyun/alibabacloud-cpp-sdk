...
#ifndef ALIBABACLOUD_MODELS_SEARCHCONTENTRESPONSEBODYRESULTCOVER_HPP_
#define ALIBABACLOUD_MODELS_SEARCHCONTENTRESPONSEBODYRESULTCOVER_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchContentResponseBodyResultCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SearchContentResponseBodyResultCover& obj) { 
    ...
    SearchContentResponseBodyResultCover() = default ;
    SearchContentResponseBodyResultCover(const SearchContentResponseBodyResultCover &) = default ;
    SearchContentResponseBodyResultCover(SearchContentResponseBodyResultCover &&) = default ;
    SearchContentResponseBodyResultCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchContentResponseBodyResultCover() = default ;
    SearchContentResponseBodyResultCover& operator=(const SearchContentResponseBodyResultCover &) = default ;
    SearchContentResponseBodyResultCover& operator=(SearchContentResponseBodyResultCover &&) = default ;
    ...
    inline SearchContentResponseBodyResultCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline SearchContentResponseBodyResultCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline SearchContentResponseBodyResultCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline SearchContentResponseBodyResultCover& setMediam(string mediam) { DARABONBA_PTR_SET_VALUE(mediam_, mediam) };
    ...
    inline SearchContentResponseBodyResultCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline SearchContentResponseBodyResultCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
