...
#ifndef ALIBABACLOUD_MODELS_CREATEPLAYINGLISTRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_CREATEPLAYINGLISTRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePlayingListResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePlayingListResponseBodyResult& obj) { 
    ...
    CreatePlayingListResponseBodyResult() = default ;
    CreatePlayingListResponseBodyResult(const CreatePlayingListResponseBodyResult &) = default ;
    CreatePlayingListResponseBodyResult(CreatePlayingListResponseBodyResult &&) = default ;
    CreatePlayingListResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePlayingListResponseBodyResult() = default ;
    CreatePlayingListResponseBodyResult& operator=(const CreatePlayingListResponseBodyResult &) = default ;
    CreatePlayingListResponseBodyResult& operator=(CreatePlayingListResponseBodyResult &&) = default ;
    ...
    inline CreatePlayingListResponseBodyResult& setAlbumName(string albumName) { DARABONBA_PTR_SET_VALUE(albumName_, albumName) };
    ...
    inline CreatePlayingListResponseBodyResult& setAlbumRawId(string albumRawId) { DARABONBA_PTR_SET_VALUE(albumRawId_, albumRawId) };
    ...
    inline CreatePlayingListResponseBodyResult& setAudioLength(int32_t audioLength) { DARABONBA_PTR_SET_VALUE(audioLength_, audioLength) };
    ...
    inline CreatePlayingListResponseBodyResult& setCopyright(int32_t copyright) { DARABONBA_PTR_SET_VALUE(copyright_, copyright) };


    // cover Field Functions 
    bool hasCover() const { return this->cover_ != nullptr;};
    void deleteCover() { this->cover_ = nullptr;};
    inline const Models::CreatePlayingListResponseBodyResultCover & cover() const { DARABONBA_PTR_GET_CONST(cover_, Models::CreatePlayingListResponseBodyResultCover) };
    inline Models::CreatePlayingListResponseBodyResultCover cover() { DARABONBA_PTR_GET(cover_, Models::CreatePlayingListResponseBodyResultCover) };
    inline CreatePlayingListResponseBodyResult& setCover(const Models::CreatePlayingListResponseBodyResultCover & cover) { DARABONBA_PTR_SET_VALUE(cover_, cover) };
    inline CreatePlayingListResponseBodyResult& setCover(Models::CreatePlayingListResponseBodyResultCover && cover) { DARABONBA_PTR_SET_RVALUE(cover_, cover) };
    ...
    inline CreatePlayingListResponseBodyResult& setDefaultPlayOrder(int32_t defaultPlayOrder) { DARABONBA_PTR_SET_VALUE(defaultPlayOrder_, defaultPlayOrder) };
    ...
    inline CreatePlayingListResponseBodyResult& setItemUrl(string itemUrl) { DARABONBA_PTR_SET_VALUE(itemUrl_, itemUrl) };
    ...
    inline CreatePlayingListResponseBodyResult& setLiked(bool liked) { DARABONBA_PTR_SET_VALUE(liked_, liked) };
    ...
    inline CreatePlayingListResponseBodyResult& setLyricUrl(string lyricUrl) { DARABONBA_PTR_SET_VALUE(lyricUrl_, lyricUrl) };
    ...
    inline CreatePlayingListResponseBodyResult& setPlayMode(string playMode) { DARABONBA_PTR_SET_VALUE(playMode_, playMode) };
    ...
    inline CreatePlayingListResponseBodyResult& setPos(int32_t pos) { DARABONBA_PTR_SET_VALUE(pos_, pos) };
    ...
    inline CreatePlayingListResponseBodyResult& setProgress(int32_t progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
    ...
    inline CreatePlayingListResponseBodyResult& setRawId(string rawId) { DARABONBA_PTR_SET_VALUE(rawId_, rawId) };
    ...
    inline CreatePlayingListResponseBodyResult& setSinger(string singer) { DARABONBA_PTR_SET_VALUE(singer_, singer) };
    ...
    inline CreatePlayingListResponseBodyResult& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline CreatePlayingListResponseBodyResult& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline CreatePlayingListResponseBodyResult& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline CreatePlayingListResponseBodyResult& setValid(string valid) { DARABONBA_PTR_SET_VALUE(valid_, valid) };
  ...
  protected:
    ...
    std::shared_ptr<Models::CreatePlayingListResponseBodyResultCover> cover_ = nullptr;
