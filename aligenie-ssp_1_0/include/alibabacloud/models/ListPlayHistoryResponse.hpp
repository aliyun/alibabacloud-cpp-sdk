...
namespace Models
{
  ...
  public:
    ...
    inline const ListPlayHistoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPlayHistoryResponseBody) };
    inline ListPlayHistoryResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPlayHistoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPlayHistoryResponseBody> body_ {};
  };
