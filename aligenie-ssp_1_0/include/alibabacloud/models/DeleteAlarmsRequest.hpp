...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      virtual bool empty() const override { return this->alarmIds_ == nullptr; };
      // alarmIds Field Functions 
      bool hasAlarmIds() const { return this->alarmIds_ != nullptr;};
      void deleteAlarmIds() { this->alarmIds_ = nullptr;};
      inline const vector<int64_t> & getAlarmIds() const { DARABONBA_PTR_GET_CONST(alarmIds_, vector<int64_t>) };
      inline vector<int64_t> getAlarmIds() { DARABONBA_PTR_GET(alarmIds_, vector<int64_t>) };
      inline Payload& setAlarmIds(const vector<int64_t> & alarmIds) { DARABONBA_PTR_SET_VALUE(alarmIds_, alarmIds) };
      inline Payload& setAlarmIds(vector<int64_t> && alarmIds) { DARABONBA_PTR_SET_RVALUE(alarmIds_, alarmIds) };
    ...
    protected:
      ...
      // 
      // This parameter is required.
      shared_ptr<vector<int64_t>> alarmIds_ {};
    };
    ...
    inline const DeleteAlarmsRequest::DeviceInfo & getDeviceInfo() const { DARABONBA_PTR_GET_CONST(deviceInfo_, DeleteAlarmsRequest::DeviceInfo) };
    inline DeleteAlarmsRequest::DeviceInfo getDeviceInfo() { DARABONBA_PTR_GET(deviceInfo_, DeleteAlarmsRequest::DeviceInfo) };
    inline DeleteAlarmsRequest& setDeviceInfo(const DeleteAlarmsRequest::DeviceInfo & deviceInfo) { DARABONBA_PTR_SET_VALUE(deviceInfo_, deviceInfo) };
    inline DeleteAlarmsRequest& setDeviceInfo(DeleteAlarmsRequest::DeviceInfo && deviceInfo) { DARABONBA_PTR_SET_RVALUE(deviceInfo_, deviceInfo) };


    // payload Field Functions 
    bool hasPayload() const { return this->payload_ != nullptr;};
    void deletePayload() { this->payload_ = nullptr;};
    inline const DeleteAlarmsRequest::Payload & getPayload() const { DARABONBA_PTR_GET_CONST(payload_, DeleteAlarmsRequest::Payload) };
    inline DeleteAlarmsRequest::Payload getPayload() { DARABONBA_PTR_GET(payload_, DeleteAlarmsRequest::Payload) };
    inline DeleteAlarmsRequest& setPayload(const DeleteAlarmsRequest::Payload & payload) { DARABONBA_PTR_SET_VALUE(payload_, payload) };
    inline DeleteAlarmsRequest& setPayload(DeleteAlarmsRequest::Payload && payload) { DARABONBA_PTR_SET_RVALUE(payload_, payload) };


    // userInfo Field Functions 
    bool hasUserInfo() const { return this->userInfo_ != nullptr;};
    void deleteUserInfo() { this->userInfo_ = nullptr;};
    inline const DeleteAlarmsRequest::UserInfo & getUserInfo() const { DARABONBA_PTR_GET_CONST(userInfo_, DeleteAlarmsRequest::UserInfo) };
    inline DeleteAlarmsRequest::UserInfo getUserInfo() { DARABONBA_PTR_GET(userInfo_, DeleteAlarmsRequest::UserInfo) };
    inline DeleteAlarmsRequest& setUserInfo(const DeleteAlarmsRequest::UserInfo & userInfo) { DARABONBA_PTR_SET_VALUE(userInfo_, userInfo) };
    inline DeleteAlarmsRequest& setUserInfo(DeleteAlarmsRequest::UserInfo && userInfo) { DARABONBA_PTR_SET_RVALUE(userInfo_, userInfo) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<DeleteAlarmsRequest::DeviceInfo> deviceInfo_ {};
    // Input parameters for the service request
    // 
    // This parameter is required.
    shared_ptr<DeleteAlarmsRequest::Payload> payload_ {};
    // User Identifier information
    // 
    // This parameter is required.
    shared_ptr<DeleteAlarmsRequest::UserInfo> userInfo_ {};
  };
