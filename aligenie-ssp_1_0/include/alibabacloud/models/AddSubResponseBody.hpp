...
namespace Models
{
  ...
  public:
    ...
    inline const AddSubResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, AddSubResponseBodyResult) };
    inline AddSubResponseBodyResult result() { DARABONBA_PTR_GET(result_, AddSubResponseBodyResult) };
    inline AddSubResponseBody& setResult(const AddSubResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline AddSubResponseBody& setResult(AddSubResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<AddSubResponseBodyResult> result_ = nullptr;
  };
