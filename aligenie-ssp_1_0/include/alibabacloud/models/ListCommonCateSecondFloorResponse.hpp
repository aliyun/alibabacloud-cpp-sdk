...
namespace Models
{
  ...
  public:
    ...
    inline const ListCommonCateSecondFloorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCommonCateSecondFloorResponseBody) };
    inline ListCommonCateSecondFloorResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCommonCateSecondFloorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCommonCateSecondFloorResponseBody> body_ {};
  };
