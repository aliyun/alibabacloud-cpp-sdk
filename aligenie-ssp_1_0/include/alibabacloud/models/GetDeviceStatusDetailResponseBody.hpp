...
namespace Models
{
  ...
  public:
    ...
    inline const GetDeviceStatusDetailResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetDeviceStatusDetailResponseBodyResult) };
    inline GetDeviceStatusDetailResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetDeviceStatusDetailResponseBodyResult) };
    inline GetDeviceStatusDetailResponseBody& setResult(const GetDeviceStatusDetailResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetDeviceStatusDetailResponseBody& setResult(GetDeviceStatusDetailResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetDeviceStatusDetailResponseBodyResult> result_ = nullptr;
  };
