...
#ifndef ALIBABACLOUD_MODELS_PREVIOUSANDNEXTCONTROLRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_PREVIOUSANDNEXTCONTROLRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PreviousAndNextControlResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PreviousAndNextControlResponseBodyResult& obj) { 
    ...
    PreviousAndNextControlResponseBodyResult() = default ;
    PreviousAndNextControlResponseBodyResult(const PreviousAndNextControlResponseBodyResult &) = default ;
    PreviousAndNextControlResponseBodyResult(PreviousAndNextControlResponseBodyResult &&) = default ;
    PreviousAndNextControlResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PreviousAndNextControlResponseBodyResult() = default ;
    PreviousAndNextControlResponseBodyResult& operator=(const PreviousAndNextControlResponseBodyResult &) = default ;
    PreviousAndNextControlResponseBodyResult& operator=(PreviousAndNextControlResponseBodyResult &&) = default ;
    ...
    inline PreviousAndNextControlResponseBodyResult& setAlbumName(string albumName) { DARABONBA_PTR_SET_VALUE(albumName_, albumName) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setAlbumRawId(string albumRawId) { DARABONBA_PTR_SET_VALUE(albumRawId_, albumRawId) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setAudioLength(int32_t audioLength) { DARABONBA_PTR_SET_VALUE(audioLength_, audioLength) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setCopyright(int32_t copyright) { DARABONBA_PTR_SET_VALUE(copyright_, copyright) };


    // cover Field Functions 
    bool hasCover() const { return this->cover_ != nullptr;};
    void deleteCover() { this->cover_ = nullptr;};
    inline const Models::PreviousAndNextControlResponseBodyResultCover & cover() const { DARABONBA_PTR_GET_CONST(cover_, Models::PreviousAndNextControlResponseBodyResultCover) };
    inline Models::PreviousAndNextControlResponseBodyResultCover cover() { DARABONBA_PTR_GET(cover_, Models::PreviousAndNextControlResponseBodyResultCover) };
    inline PreviousAndNextControlResponseBodyResult& setCover(const Models::PreviousAndNextControlResponseBodyResultCover & cover) { DARABONBA_PTR_SET_VALUE(cover_, cover) };
    inline PreviousAndNextControlResponseBodyResult& setCover(Models::PreviousAndNextControlResponseBodyResultCover && cover) { DARABONBA_PTR_SET_RVALUE(cover_, cover) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setDefaultPlayOrder(int32_t defaultPlayOrder) { DARABONBA_PTR_SET_VALUE(defaultPlayOrder_, defaultPlayOrder) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setItemUrl(string itemUrl) { DARABONBA_PTR_SET_VALUE(itemUrl_, itemUrl) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setLiked(bool liked) { DARABONBA_PTR_SET_VALUE(liked_, liked) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setLyricUrl(string lyricUrl) { DARABONBA_PTR_SET_VALUE(lyricUrl_, lyricUrl) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setPlayMode(string playMode) { DARABONBA_PTR_SET_VALUE(playMode_, playMode) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setPos(int32_t pos) { DARABONBA_PTR_SET_VALUE(pos_, pos) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setProgress(int32_t progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setRawId(string rawId) { DARABONBA_PTR_SET_VALUE(rawId_, rawId) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setSinger(string singer) { DARABONBA_PTR_SET_VALUE(singer_, singer) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline PreviousAndNextControlResponseBodyResult& setValid(string valid) { DARABONBA_PTR_SET_VALUE(valid_, valid) };
  ...
  protected:
    ...
    std::shared_ptr<Models::PreviousAndNextControlResponseBodyResultCover> cover_ = nullptr;
