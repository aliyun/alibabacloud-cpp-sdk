...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePlayingListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePlayingListResponseBody) };
    inline CreatePlayingListResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePlayingListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePlayingListResponseBody> body_ {};
  };
