...
#ifndef ALIBABACLOUD_MODELS_GETCURRENTPLAYINGLISTRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_GETCURRENTPLAYINGLISTRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetCurrentPlayingListResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetCurrentPlayingListResponseBodyResult& obj) { 
    ...
    GetCurrentPlayingListResponseBodyResult() = default ;
    GetCurrentPlayingListResponseBodyResult(const GetCurrentPlayingListResponseBodyResult &) = default ;
    GetCurrentPlayingListResponseBodyResult(GetCurrentPlayingListResponseBodyResult &&) = default ;
    GetCurrentPlayingListResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetCurrentPlayingListResponseBodyResult() = default ;
    GetCurrentPlayingListResponseBodyResult& operator=(const GetCurrentPlayingListResponseBodyResult &) = default ;
    GetCurrentPlayingListResponseBodyResult& operator=(GetCurrentPlayingListResponseBodyResult &&) = default ;
    ...
    inline GetCurrentPlayingListResponseBodyResult& setAlbumName(string albumName) { DARABONBA_PTR_SET_VALUE(albumName_, albumName) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setAlbumRawId(string albumRawId) { DARABONBA_PTR_SET_VALUE(albumRawId_, albumRawId) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setAudioLength(int32_t audioLength) { DARABONBA_PTR_SET_VALUE(audioLength_, audioLength) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setCopyright(int32_t copyright) { DARABONBA_PTR_SET_VALUE(copyright_, copyright) };


    // cover Field Functions 
    bool hasCover() const { return this->cover_ != nullptr;};
    void deleteCover() { this->cover_ = nullptr;};
    inline const Models::GetCurrentPlayingListResponseBodyResultCover & cover() const { DARABONBA_PTR_GET_CONST(cover_, Models::GetCurrentPlayingListResponseBodyResultCover) };
    inline Models::GetCurrentPlayingListResponseBodyResultCover cover() { DARABONBA_PTR_GET(cover_, Models::GetCurrentPlayingListResponseBodyResultCover) };
    inline GetCurrentPlayingListResponseBodyResult& setCover(const Models::GetCurrentPlayingListResponseBodyResultCover & cover) { DARABONBA_PTR_SET_VALUE(cover_, cover) };
    inline GetCurrentPlayingListResponseBodyResult& setCover(Models::GetCurrentPlayingListResponseBodyResultCover && cover) { DARABONBA_PTR_SET_RVALUE(cover_, cover) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setDefaultPlayOrder(int32_t defaultPlayOrder) { DARABONBA_PTR_SET_VALUE(defaultPlayOrder_, defaultPlayOrder) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setItemUrl(string itemUrl) { DARABONBA_PTR_SET_VALUE(itemUrl_, itemUrl) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setLiked(bool liked) { DARABONBA_PTR_SET_VALUE(liked_, liked) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setLyricUrl(string lyricUrl) { DARABONBA_PTR_SET_VALUE(lyricUrl_, lyricUrl) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setPlayMode(string playMode) { DARABONBA_PTR_SET_VALUE(playMode_, playMode) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setPos(int32_t pos) { DARABONBA_PTR_SET_VALUE(pos_, pos) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setProgress(int32_t progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setRawId(string rawId) { DARABONBA_PTR_SET_VALUE(rawId_, rawId) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setSinger(string singer) { DARABONBA_PTR_SET_VALUE(singer_, singer) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline GetCurrentPlayingListResponseBodyResult& setValid(string valid) { DARABONBA_PTR_SET_VALUE(valid_, valid) };
  ...
  protected:
    ...
    std::shared_ptr<Models::GetCurrentPlayingListResponseBodyResultCover> cover_ = nullptr;
