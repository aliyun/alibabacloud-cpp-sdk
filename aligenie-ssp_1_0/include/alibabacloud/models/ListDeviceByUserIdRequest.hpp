...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeviceByUserIdRequest::UserInfo & getUserInfo() const { DARABONBA_PTR_GET_CONST(userInfo_, ListDeviceByUserIdRequest::UserInfo) };
    inline ListDeviceByUserIdRequest::UserInfo getUserInfo() { DARABONBA_PTR_GET(userInfo_, ListDeviceByUserIdRequest::UserInfo) };
    inline ListDeviceByUserIdRequest& setUserInfo(const ListDeviceByUserIdRequest::UserInfo & userInfo) { DARABONBA_PTR_SET_VALUE(userInfo_, userInfo) };
    inline ListDeviceByUserIdRequest& setUserInfo(ListDeviceByUserIdRequest::UserInfo && userInfo) { DARABONBA_PTR_SET_RVALUE(userInfo_, userInfo) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<ListDeviceByUserIdRequest::UserInfo> userInfo_ {};
  };
