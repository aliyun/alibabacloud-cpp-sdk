...
#ifndef ALIBABACLOUD_MODELS_CREATEPLAYINGLISTOAUTH2RESPONSEBODYRESULTCOVER_HPP_
#define ALIBABACLOUD_MODELS_CREATEPLAYINGLISTOAUTH2RESPONSEBODYRESULTCOVER_HPP_
...
namespace Models
{
  class CreatePlayingListOAuth2ResponseBodyResultCover : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreatePlayingListOAuth2ResponseBodyResultCover& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePlayingListOAuth2ResponseBodyResultCover& obj) { 
    ...
    CreatePlayingListOAuth2ResponseBodyResultCover() = default ;
    CreatePlayingListOAuth2ResponseBodyResultCover(const CreatePlayingListOAuth2ResponseBodyResultCover &) = default ;
    CreatePlayingListOAuth2ResponseBodyResultCover(CreatePlayingListOAuth2ResponseBodyResultCover &&) = default ;
    CreatePlayingListOAuth2ResponseBodyResultCover(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePlayingListOAuth2ResponseBodyResultCover() = default ;
    CreatePlayingListOAuth2ResponseBodyResultCover& operator=(const CreatePlayingListOAuth2ResponseBodyResultCover &) = default ;
    CreatePlayingListOAuth2ResponseBodyResultCover& operator=(CreatePlayingListOAuth2ResponseBodyResultCover &&) = default ;
    ...
    inline CreatePlayingListOAuth2ResponseBodyResultCover& setCanResize(bool canResize) { DARABONBA_PTR_SET_VALUE(canResize_, canResize) };
    ...
    inline CreatePlayingListOAuth2ResponseBodyResultCover& setImg(string img) { DARABONBA_PTR_SET_VALUE(img_, img) };
    ...
    inline CreatePlayingListOAuth2ResponseBodyResultCover& setLarge(string large) { DARABONBA_PTR_SET_VALUE(large_, large) };
    ...
    inline CreatePlayingListOAuth2ResponseBodyResultCover& setMediam(string mediam) { DARABONBA_PTR_SET_VALUE(mediam_, mediam) };
    ...
    inline CreatePlayingListOAuth2ResponseBodyResultCover& setMedium(string medium) { DARABONBA_PTR_SET_VALUE(medium_, medium) };
    ...
    inline CreatePlayingListOAuth2ResponseBodyResultCover& setSmall(string small) { DARABONBA_PTR_SET_VALUE(small_, small) };
