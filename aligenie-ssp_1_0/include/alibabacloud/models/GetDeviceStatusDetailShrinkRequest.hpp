...
#ifndef ALIBABACLOUD_MODELS_GETDEVICESTATUSDETAILSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETDEVICESTATUSDETAILSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetDeviceStatusDetailShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(DeviceInfo, deviceInfoShrink_);
      DARABONBA_PTR_TO_JSON(Keys, keysShrink_);
    };
    friend void from_json(const Darabonba::Json& j, GetDeviceStatusDetailShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(DeviceInfo, deviceInfoShrink_);
      DARABONBA_PTR_FROM_JSON(Keys, keysShrink_);
    };
    GetDeviceStatusDetailShrinkRequest() = default ;
    GetDeviceStatusDetailShrinkRequest(const GetDeviceStatusDetailShrinkRequest &) = default ;
    GetDeviceStatusDetailShrinkRequest(GetDeviceStatusDetailShrinkRequest &&) = default ;
    GetDeviceStatusDetailShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetDeviceStatusDetailShrinkRequest() = default ;
    GetDeviceStatusDetailShrinkRequest& operator=(const GetDeviceStatusDetailShrinkRequest &) = default ;
    GetDeviceStatusDetailShrinkRequest& operator=(GetDeviceStatusDetailShrinkRequest &&) = default ;
