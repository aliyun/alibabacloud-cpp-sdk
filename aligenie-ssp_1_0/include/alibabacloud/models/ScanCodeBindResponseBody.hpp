...
namespace Models
{
  ...
  public:
    ...
    inline const ScanCodeBindResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ScanCodeBindResponseBodyResult) };
    inline ScanCodeBindResponseBodyResult result() { DARABONBA_PTR_GET(result_, ScanCodeBindResponseBodyResult) };
    inline ScanCodeBindResponseBody& setResult(const ScanCodeBindResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ScanCodeBindResponseBody& setResult(ScanCodeBindResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ScanCodeBindResponseBodyResult> result_ = nullptr;
  };
