...
#ifndef ALIBABACLOUD_MODELS_LISTRECOMMENDCONTENTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTRECOMMENDCONTENTSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListRecommendContentShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListRecommendContentShrinkRequest& obj) { 
    ...
    ListRecommendContentShrinkRequest() = default ;
    ListRecommendContentShrinkRequest(const ListRecommendContentShrinkRequest &) = default ;
    ListRecommendContentShrinkRequest(ListRecommendContentShrinkRequest &&) = default ;
    ListRecommendContentShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListRecommendContentShrinkRequest() = default ;
    ListRecommendContentShrinkRequest& operator=(const ListRecommendContentShrinkRequest &) = default ;
    ListRecommendContentShrinkRequest& operator=(ListRecommendContentShrinkRequest &&) = default ;
    ...
    inline ListRecommendContentShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline ListRecommendContentShrinkRequest& setRequestShrink(string requestShrink) { DARABONBA_PTR_SET_VALUE(requestShrink_, requestShrink) };
    ...
    inline ListRecommendContentShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
