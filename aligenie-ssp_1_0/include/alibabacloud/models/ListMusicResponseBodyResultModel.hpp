...
#ifndef ALIBABACLOUD_MODELS_LISTMUSICRESPONSEBODYRESULTMODEL_HPP_
#define ALIBABACLOUD_MODELS_LISTMUSICRESPONSEBODYRESULTMODEL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListMusicResponseBodyResultModel& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListMusicResponseBodyResultModel& obj) { 
    ...
    ListMusicResponseBodyResultModel() = default ;
    ListMusicResponseBodyResultModel(const ListMusicResponseBodyResultModel &) = default ;
    ListMusicResponseBodyResultModel(ListMusicResponseBodyResultModel &&) = default ;
    ListMusicResponseBodyResultModel(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListMusicResponseBodyResultModel() = default ;
    ListMusicResponseBodyResultModel& operator=(const ListMusicResponseBodyResultModel &) = default ;
    ListMusicResponseBodyResultModel& operator=(ListMusicResponseBodyResultModel &&) = default ;
    ...
    inline ListMusicResponseBodyResultModel& setMusicId(int64_t musicId) { DARABONBA_PTR_SET_VALUE(musicId_, musicId) };
    ...
    inline ListMusicResponseBodyResultModel& setMusicName(string musicName) { DARABONBA_PTR_SET_VALUE(musicName_, musicName) };
    ...
    inline ListMusicResponseBodyResultModel& setMusicType(int64_t musicType) { DARABONBA_PTR_SET_VALUE(musicType_, musicType) };
    ...
    inline ListMusicResponseBodyResultModel& setMusicTypeName(string musicTypeName) { DARABONBA_PTR_SET_VALUE(musicTypeName_, musicTypeName) };
    ...
    inline ListMusicResponseBodyResultModel& setMusicUrl(string musicUrl) { DARABONBA_PTR_SET_VALUE(musicUrl_, musicUrl) };
