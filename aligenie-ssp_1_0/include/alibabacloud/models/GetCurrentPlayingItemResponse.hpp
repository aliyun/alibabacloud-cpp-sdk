...
namespace Models
{
  ...
  public:
    ...
    inline const GetCurrentPlayingItemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCurrentPlayingItemResponseBody) };
    inline GetCurrentPlayingItemResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCurrentPlayingItemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCurrentPlayingItemResponseBody> body_ {};
  };
