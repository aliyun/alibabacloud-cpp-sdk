...
namespace Models
{
  ...
  public:
    ...
    inline const AuthLoginWithThirdUserInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AuthLoginWithThirdUserInfoResponseBody) };
    inline AuthLoginWithThirdUserInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, AuthLoginWithThirdUserInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AuthLoginWithThirdUserInfoResponseBody> body_ {};
  };
