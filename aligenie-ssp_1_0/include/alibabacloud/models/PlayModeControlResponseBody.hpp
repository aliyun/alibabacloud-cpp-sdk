...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PlayModeControlResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PlayModeControlResponseBody& obj) { 
    ...
    PlayModeControlResponseBody() = default ;
    PlayModeControlResponseBody(const PlayModeControlResponseBody &) = default ;
    PlayModeControlResponseBody(PlayModeControlResponseBody &&) = default ;
    PlayModeControlResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PlayModeControlResponseBody() = default ;
    PlayModeControlResponseBody& operator=(const PlayModeControlResponseBody &) = default ;
    PlayModeControlResponseBody& operator=(PlayModeControlResponseBody &&) = default ;
