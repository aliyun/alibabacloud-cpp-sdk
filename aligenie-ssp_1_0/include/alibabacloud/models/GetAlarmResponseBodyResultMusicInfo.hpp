...
#ifndef ALIBABACLOUD_MODELS_GETALARMRESPONSEBODYRESULTMUSICINFO_HPP_
#define ALIBABACLOUD_MODELS_GETALARMRESPONSEBODYRESULTMUSICINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAlarmResponseBodyResultMusicInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAlarmResponseBodyResultMusicInfo& obj) { 
    ...
    GetAlarmResponseBodyResultMusicInfo() = default ;
    GetAlarmResponseBodyResultMusicInfo(const GetAlarmResponseBodyResultMusicInfo &) = default ;
    GetAlarmResponseBodyResultMusicInfo(GetAlarmResponseBodyResultMusicInfo &&) = default ;
    GetAlarmResponseBodyResultMusicInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAlarmResponseBodyResultMusicInfo() = default ;
    GetAlarmResponseBodyResultMusicInfo& operator=(const GetAlarmResponseBodyResultMusicInfo &) = default ;
    GetAlarmResponseBodyResultMusicInfo& operator=(GetAlarmResponseBodyResultMusicInfo &&) = default ;
    ...
    inline GetAlarmResponseBodyResultMusicInfo& setMusicId(int64_t musicId) { DARABONBA_PTR_SET_VALUE(musicId_, musicId) };
    ...
    inline GetAlarmResponseBodyResultMusicInfo& setMusicName(string musicName) { DARABONBA_PTR_SET_VALUE(musicName_, musicName) };
    ...
    inline GetAlarmResponseBodyResultMusicInfo& setMusicType(int64_t musicType) { DARABONBA_PTR_SET_VALUE(musicType_, musicType) };
    ...
    inline GetAlarmResponseBodyResultMusicInfo& setMusicTypeName(string musicTypeName) { DARABONBA_PTR_SET_VALUE(musicTypeName_, musicTypeName) };
    ...
    inline GetAlarmResponseBodyResultMusicInfo& setMusicUrl(string musicUrl) { DARABONBA_PTR_SET_VALUE(musicUrl_, musicUrl) };
