...
namespace Models
{
  ...
  public:
    ...
    inline const GetAlarmResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetAlarmResponseBodyResult) };
    inline GetAlarmResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetAlarmResponseBodyResult) };
    inline GetAlarmResponseBody& setResult(const GetAlarmResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetAlarmResponseBody& setResult(GetAlarmResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetAlarmResponseBodyResult> result_ = nullptr;
  };
