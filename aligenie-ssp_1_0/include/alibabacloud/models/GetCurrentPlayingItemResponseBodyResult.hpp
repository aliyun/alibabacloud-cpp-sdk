...
#ifndef ALIBABACLOUD_MODELS_GETCURRENTPLAYINGITEMRESPONSEBODYRESULT_HPP_
#define ALIBABACLOUD_MODELS_GETCURRENTPLAYINGITEMRESPONSEBODYRESULT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetCurrentPlayingItemResponseBodyResult& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetCurrentPlayingItemResponseBodyResult& obj) { 
    ...
    GetCurrentPlayingItemResponseBodyResult() = default ;
    GetCurrentPlayingItemResponseBodyResult(const GetCurrentPlayingItemResponseBodyResult &) = default ;
    GetCurrentPlayingItemResponseBodyResult(GetCurrentPlayingItemResponseBodyResult &&) = default ;
    GetCurrentPlayingItemResponseBodyResult(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetCurrentPlayingItemResponseBodyResult() = default ;
    GetCurrentPlayingItemResponseBodyResult& operator=(const GetCurrentPlayingItemResponseBodyResult &) = default ;
    GetCurrentPlayingItemResponseBodyResult& operator=(GetCurrentPlayingItemResponseBodyResult &&) = default ;
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setAlbumName(string albumName) { DARABONBA_PTR_SET_VALUE(albumName_, albumName) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setAlbumRawId(string albumRawId) { DARABONBA_PTR_SET_VALUE(albumRawId_, albumRawId) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setAudioLength(int32_t audioLength) { DARABONBA_PTR_SET_VALUE(audioLength_, audioLength) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setCopyright(int32_t copyright) { DARABONBA_PTR_SET_VALUE(copyright_, copyright) };


    // cover Field Functions 
    bool hasCover() const { return this->cover_ != nullptr;};
    void deleteCover() { this->cover_ = nullptr;};
    inline const Models::GetCurrentPlayingItemResponseBodyResultCover & cover() const { DARABONBA_PTR_GET_CONST(cover_, Models::GetCurrentPlayingItemResponseBodyResultCover) };
    inline Models::GetCurrentPlayingItemResponseBodyResultCover cover() { DARABONBA_PTR_GET(cover_, Models::GetCurrentPlayingItemResponseBodyResultCover) };
    inline GetCurrentPlayingItemResponseBodyResult& setCover(const Models::GetCurrentPlayingItemResponseBodyResultCover & cover) { DARABONBA_PTR_SET_VALUE(cover_, cover) };
    inline GetCurrentPlayingItemResponseBodyResult& setCover(Models::GetCurrentPlayingItemResponseBodyResultCover && cover) { DARABONBA_PTR_SET_RVALUE(cover_, cover) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setDefaultPlayOrder(int32_t defaultPlayOrder) { DARABONBA_PTR_SET_VALUE(defaultPlayOrder_, defaultPlayOrder) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setItemUrl(string itemUrl) { DARABONBA_PTR_SET_VALUE(itemUrl_, itemUrl) };


    // liked Field Functions 
    bool hasLiked() const { return this->liked_ != nullptr;};
    void deleteLiked() { this->liked_ = nullptr;};
    inline string liked() const { DARABONBA_PTR_GET_DEFAULT(liked_, "") };
    inline GetCurrentPlayingItemResponseBodyResult& setLiked(string liked) { DARABONBA_PTR_SET_VALUE(liked_, liked) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setLyricUrl(string lyricUrl) { DARABONBA_PTR_SET_VALUE(lyricUrl_, lyricUrl) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setPlayMode(string playMode) { DARABONBA_PTR_SET_VALUE(playMode_, playMode) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setPos(int32_t pos) { DARABONBA_PTR_SET_VALUE(pos_, pos) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setProgress(int32_t progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setRawId(string rawId) { DARABONBA_PTR_SET_VALUE(rawId_, rawId) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setSinger(string singer) { DARABONBA_PTR_SET_VALUE(singer_, singer) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setSource(string source) { DARABONBA_PTR_SET_VALUE(source_, source) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline GetCurrentPlayingItemResponseBodyResult& setValid(string valid) { DARABONBA_PTR_SET_VALUE(valid_, valid) };
  ...
  protected:
    ...
    std::shared_ptr<Models::GetCurrentPlayingItemResponseBodyResultCover> cover_ = nullptr;
    std::shared_ptr<int32_t> defaultPlayOrder_ = nullptr;
    std::shared_ptr<string> itemUrl_ = nullptr;
    std::shared_ptr<string> liked_ = nullptr;
