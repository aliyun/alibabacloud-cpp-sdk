...
namespace Models
{
  ...
  public:
    ...
    inline const EcologyOpennessAuthenticateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EcologyOpennessAuthenticateResponseBody) };
    inline EcologyOpennessAuthenticateResponseBody getBody() { DARABONBA_PTR_GET(body_, EcologyOpennessAuthenticateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EcologyOpennessAuthenticateResponseBody> body_ {};
  };
