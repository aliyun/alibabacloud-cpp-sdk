...
namespace Models
{
  ...
  public:
    ...
    inline const GetDeviceIdByIdentityResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetDeviceIdByIdentityResponseBodyResult) };
    inline GetDeviceIdByIdentityResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetDeviceIdByIdentityResponseBodyResult) };
    inline GetDeviceIdByIdentityResponseBody& setResult(const GetDeviceIdByIdentityResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetDeviceIdByIdentityResponseBody& setResult(GetDeviceIdByIdentityResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetDeviceIdByIdentityResponseBodyResult> result_ = nullptr;
  };
