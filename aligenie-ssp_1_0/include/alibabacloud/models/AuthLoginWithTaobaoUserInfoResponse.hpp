...
namespace Models
{
  ...
  public:
    ...
    inline const AuthLoginWithTaobaoUserInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AuthLoginWithTaobaoUserInfoResponseBody) };
    inline AuthLoginWithTaobaoUserInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, AuthLoginWithTaobaoUserInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AuthLoginWithTaobaoUserInfoResponseBody> body_ {};
  };
