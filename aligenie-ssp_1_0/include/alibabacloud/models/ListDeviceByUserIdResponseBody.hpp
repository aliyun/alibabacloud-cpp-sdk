...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDeviceByUserIdResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListDeviceByUserIdResponseBody::Result>) };
    inline vector<ListDeviceByUserIdResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListDeviceByUserIdResponseBody::Result>) };
    inline ListDeviceByUserIdResponseBody& setResult(const vector<ListDeviceByUserIdResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListDeviceByUserIdResponseBody& setResult(vector<ListDeviceByUserIdResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<vector<ListDeviceByUserIdResponseBody::Result>> result_ {};
  };
