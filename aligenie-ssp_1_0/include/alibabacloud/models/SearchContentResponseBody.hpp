...
#ifndef ALIBABACLOUD_MODELS_SEARCHCONTENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SEARCHCONTENTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchContentResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Code, code_);
      DARABONBA_PTR_TO_JSON(Message, message_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Result, result_);
    };
    friend void from_json(const Darabonba::Json& j, SearchContentResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Code, code_);
      DARABONBA_PTR_FROM_JSON(Message, message_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Result, result_);
    };
    SearchContentResponseBody() = default ;
    SearchContentResponseBody(const SearchContentResponseBody &) = default ;
    SearchContentResponseBody(SearchContentResponseBody &&) = default ;
    SearchContentResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchContentResponseBody() = default ;
    SearchContentResponseBody& operator=(const SearchContentResponseBody &) = default ;
    SearchContentResponseBody& operator=(SearchContentResponseBody &&) = default ;
    ...
    public:
      ...
      inline Result& setDuration(int64_t duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
      ...
      inline Result& setLyric(string lyric) { DARABONBA_PTR_SET_VALUE(lyric_, lyric) };
      ...
      inline Result& setOrderIndex(string orderIndex) { DARABONBA_PTR_SET_VALUE(orderIndex_, orderIndex) };
      ...
      inline Result& setStyles(const vector<string> & styles) { DARABONBA_PTR_SET_VALUE(styles_, styles) };
      inline Result& setStyles(vector<string> && styles) { DARABONBA_PTR_SET_RVALUE(styles_, styles) };
    ...
    inline SearchContentResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline SearchContentResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline SearchContentResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const vector<SearchContentResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<SearchContentResponseBody::Result>) };
    inline vector<SearchContentResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<SearchContentResponseBody::Result>) };
    inline SearchContentResponseBody& setResult(const vector<SearchContentResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline SearchContentResponseBody& setResult(vector<SearchContentResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // return information
    shared_ptr<vector<SearchContentResponseBody::Result>> result_ {};
  };
