...
namespace Models
{
  ...
  public:
    ...
    inline const GetDeviceStatusInfoRequest::DeviceInfo & getDeviceInfo() const { DARABONBA_PTR_GET_CONST(deviceInfo_, GetDeviceStatusInfoRequest::DeviceInfo) };
    inline GetDeviceStatusInfoRequest::DeviceInfo getDeviceInfo() { DARABONBA_PTR_GET(deviceInfo_, GetDeviceStatusInfoRequest::DeviceInfo) };
    inline GetDeviceStatusInfoRequest& setDeviceInfo(const GetDeviceStatusInfoRequest::DeviceInfo & deviceInfo) { DARABONBA_PTR_SET_VALUE(deviceInfo_, deviceInfo) };
    inline GetDeviceStatusInfoRequest& setDeviceInfo(GetDeviceStatusInfoRequest::DeviceInfo && deviceInfo) { DARABONBA_PTR_SET_RVALUE(deviceInfo_, deviceInfo) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<GetDeviceStatusInfoRequest::DeviceInfo> deviceInfo_ {};
  };
