...
namespace Models
{
  ...
  public:
    ...
    inline const ThirdImmediateMsgPushResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ThirdImmediateMsgPushResponseBody) };
    inline ThirdImmediateMsgPushResponseBody getBody() { DARABONBA_PTR_GET(body_, ThirdImmediateMsgPushResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ThirdImmediateMsgPushResponseBody> body_ {};
  };
