...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryMusicTypeResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<QueryMusicTypeResponseBodyResult>) };
    inline vector<QueryMusicTypeResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<QueryMusicTypeResponseBodyResult>) };
    inline QueryMusicTypeResponseBody& setResult(const vector<QueryMusicTypeResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryMusicTypeResponseBody& setResult(vector<QueryMusicTypeResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryMusicTypeResponseBodyResult>> result_ = nullptr;
  };
