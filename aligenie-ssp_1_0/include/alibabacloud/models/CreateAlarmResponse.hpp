...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAlarmResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAlarmResponseBody) };
    inline CreateAlarmResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAlarmResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAlarmResponseBody> body_ {};
  };
