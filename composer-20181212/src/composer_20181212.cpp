...
CreateFlowResponse Alibabacloud_Composer20181212::Client::createFlowWithOptions(shared_ptr<CreateFlowRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (!Darabonba_Util::Client::isUnset<string>(request->flowDescription)) {
    body->insert(pair<string, string>("FlowDescription", *request->flowDescription));
  }
  if (!Darabonba_Util::Client::isUnset<string>(request->flowName)) {
    body->insert(pair<string, string>("FlowName", *request->flowName));
  }
  if (!Darabonba_Util::Client::isUnset<string>(request->flowSource)) {
    body->insert(pair<string, string>("FlowSource", *request->flowSource));
  }
...
DisableFlowResponse Alibabacloud_Composer20181212::Client::disableFlowWithOptions(shared_ptr<DisableFlowRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("DisableFlow"))},
    {"version", boost::any(string("2018-12-12"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return DisableFlowResponse(callApi(params, req, runtime));
}
...
EnableFlowResponse Alibabacloud_Composer20181212::Client::enableFlowWithOptions(shared_ptr<EnableFlowRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("EnableFlow"))},
    {"version", boost::any(string("2018-12-12"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return EnableFlowResponse(callApi(params, req, runtime));
}
...
GroupInvokeFlowResponse Alibabacloud_Composer20181212::Client::groupInvokeFlowWithOptions(shared_ptr<GroupInvokeFlowRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (!Darabonba_Util::Client::isUnset<long>(request->totalCount)) {
    body->insert(pair<string, long>("TotalCount", *request->totalCount));
  }
  shared_ptr<Alibabacloud_OpenApi::OpenApiRequest> req = make_shared<Alibabacloud_OpenApi::OpenApiRequest>(map<string, boost::any>({
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("GroupInvokeFlow"))},
    {"version", boost::any(string("2018-12-12"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return GroupInvokeFlowResponse(callApi(params, req, runtime));
}
...
InvokeFlowResponse Alibabacloud_Composer20181212::Client::invokeFlowWithOptions(shared_ptr<InvokeFlowRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("InvokeFlow"))},
    {"version", boost::any(string("2018-12-12"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return InvokeFlowResponse(callApi(params, req, runtime));
}
