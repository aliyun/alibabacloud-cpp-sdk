...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVpcEndpointServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteVpcEndpointServiceResponseBody) };
    inline DeleteVpcEndpointServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteVpcEndpointServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteVpcEndpointServiceResponseBody> body_ {};
  };
