...
namespace Models
{
  ...
  public:
    ...
    inline const AttachSecurityGroupToVpcEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachSecurityGroupToVpcEndpointResponseBody) };
    inline AttachSecurityGroupToVpcEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachSecurityGroupToVpcEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachSecurityGroupToVpcEndpointResponseBody> body_ {};
  };
