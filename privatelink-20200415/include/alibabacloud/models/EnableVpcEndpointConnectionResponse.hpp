...
namespace Models
{
  ...
  public:
    ...
    inline const EnableVpcEndpointConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableVpcEndpointConnectionResponseBody) };
    inline EnableVpcEndpointConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableVpcEndpointConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableVpcEndpointConnectionResponseBody> body_ {};
  };
