...
namespace Models
{
  ...
  public:
    ...
    inline const ListVpcEndpointServiceResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVpcEndpointServiceResourcesResponseBody) };
    inline ListVpcEndpointServiceResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVpcEndpointServiceResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVpcEndpointServiceResourcesResponseBody> body_ {};
  };
