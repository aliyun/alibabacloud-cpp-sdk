...
namespace Models
{
  ...
  public:
    ...
    inline const ListVpcEndpointSecurityGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVpcEndpointSecurityGroupsResponseBody) };
    inline ListVpcEndpointSecurityGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVpcEndpointSecurityGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVpcEndpointSecurityGroupsResponseBody> body_ {};
  };
