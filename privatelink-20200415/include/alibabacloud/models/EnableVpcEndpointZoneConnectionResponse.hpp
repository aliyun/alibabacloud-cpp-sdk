...
namespace Models
{
  ...
  public:
    ...
    inline const EnableVpcEndpointZoneConnectionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableVpcEndpointZoneConnectionResponseBody) };
    inline EnableVpcEndpointZoneConnectionResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableVpcEndpointZoneConnectionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableVpcEndpointZoneConnectionResponseBody> body_ {};
  };
