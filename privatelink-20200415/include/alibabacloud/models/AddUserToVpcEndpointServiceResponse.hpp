...
namespace Models
{
  ...
  public:
    ...
    inline const AddUserToVpcEndpointServiceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddUserToVpcEndpointServiceResponseBody) };
    inline AddUserToVpcEndpointServiceResponseBody body() { DARABONBA_PTR_GET(body_, AddUserToVpcEndpointServiceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddUserToVpcEndpointServiceResponseBody> body_ = nullptr;
  };
