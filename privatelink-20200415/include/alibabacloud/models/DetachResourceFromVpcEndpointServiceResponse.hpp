...
namespace Models
{
  ...
  public:
    ...
    inline const DetachResourceFromVpcEndpointServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachResourceFromVpcEndpointServiceResponseBody) };
    inline DetachResourceFromVpcEndpointServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachResourceFromVpcEndpointServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachResourceFromVpcEndpointServiceResponseBody> body_ {};
  };
