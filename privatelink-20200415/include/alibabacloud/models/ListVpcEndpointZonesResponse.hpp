...
namespace Models
{
  ...
  public:
    ...
    inline const ListVpcEndpointZonesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListVpcEndpointZonesResponseBody) };
    inline ListVpcEndpointZonesResponseBody body() { DARABONBA_PTR_GET(body_, ListVpcEndpointZonesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListVpcEndpointZonesResponseBody> body_ = nullptr;
  };
