...
namespace Models
{
  ...
  public:
    ...
    inline const ListVpcEndpointServiceUsersResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListVpcEndpointServiceUsersResponseBody) };
    inline ListVpcEndpointServiceUsersResponseBody body() { DARABONBA_PTR_GET(body_, ListVpcEndpointServiceUsersResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListVpcEndpointServiceUsersResponseBody> body_ = nullptr;
  };
