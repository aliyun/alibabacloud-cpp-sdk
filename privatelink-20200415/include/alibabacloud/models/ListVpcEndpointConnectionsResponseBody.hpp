...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListVpcEndpointConnectionsResponseBodyConnections> & connections() const { DARABONBA_PTR_GET_CONST(connections_, vector<ListVpcEndpointConnectionsResponseBodyConnections>) };
    inline vector<ListVpcEndpointConnectionsResponseBodyConnections> connections() { DARABONBA_PTR_GET(connections_, vector<ListVpcEndpointConnectionsResponseBodyConnections>) };
    inline ListVpcEndpointConnectionsResponseBody& setConnections(const vector<ListVpcEndpointConnectionsResponseBodyConnections> & connections) { DARABONBA_PTR_SET_VALUE(connections_, connections) };
    inline ListVpcEndpointConnectionsResponseBody& setConnections(vector<ListVpcEndpointConnectionsResponseBodyConnections> && connections) { DARABONBA_PTR_SET_RVALUE(connections_, connections) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListVpcEndpointConnectionsResponseBodyConnections>> connections_ = nullptr;
