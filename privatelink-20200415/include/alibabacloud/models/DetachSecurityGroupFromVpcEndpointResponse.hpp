...
namespace Models
{
  ...
  public:
    ...
    inline const DetachSecurityGroupFromVpcEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachSecurityGroupFromVpcEndpointResponseBody) };
    inline DetachSecurityGroupFromVpcEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachSecurityGroupFromVpcEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachSecurityGroupFromVpcEndpointResponseBody> body_ {};
  };
