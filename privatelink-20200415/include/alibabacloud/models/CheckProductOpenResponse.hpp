...
namespace Models
{
  ...
  public:
    ...
    inline const CheckProductOpenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckProductOpenResponseBody) };
    inline CheckProductOpenResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckProductOpenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckProductOpenResponseBody> body_ {};
  };
