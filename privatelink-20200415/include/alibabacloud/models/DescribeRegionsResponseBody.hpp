  ...
  public:
    ...
    public:
      ...
      public:
        ...
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        class ServiceResourceTypes : public Darabonba::Model {
        public:
          friend void to_json(Darabonba::Json& j, const ServiceResourceTypes& obj) { 
            DARABONBA_PTR_TO_JSON(ServiceResourceType, serviceResourceType_);
          };
          friend void from_json(const Darabonba::Json& j, ServiceResourceTypes& obj) { 
            DARABONBA_PTR_FROM_JSON(ServiceResourceType, serviceResourceType_);
          };
          ServiceResourceTypes() = default ;
          ServiceResourceTypes(const ServiceResourceTypes &) = default ;
          ServiceResourceTypes(ServiceResourceTypes &&) = default ;
          ServiceResourceTypes(const Darabonba::Json & obj) { from_json(obj, *this); };
          virtual ~ServiceResourceTypes() = default ;
          ServiceResourceTypes& operator=(const ServiceResourceTypes &) = default ;
          ServiceResourceTypes& operator=(ServiceResourceTypes &&) = default ;
          virtual void validate() const override {
          };
          virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
          virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
          ...
          inline const vector<string> & getServiceResourceType() const { DARABONBA_PTR_GET_CONST(serviceResourceType_, vector<string>) };
          inline vector<string> getServiceResourceType() { DARABONBA_PTR_GET(serviceResourceType_, vector<string>) };
          inline ServiceResourceTypes& setServiceResourceType(const vector<string> & serviceResourceType) { DARABONBA_PTR_SET_VALUE(serviceResourceType_, serviceResourceType) };
          inline ServiceResourceTypes& setServiceResourceType(vector<string> && serviceResourceType) { DARABONBA_PTR_SET_RVALUE(serviceResourceType_, serviceResourceType) };


        protected:
          shared_ptr<vector<string>> serviceResourceType_ {};
        };

        virtual bool empty() const override { return this->localName_ == nullptr
        && this->regionEndpoint_ == nullptr && this->regionId_ == nullptr && this->serviceResourceTypes_ == nullptr; };
        ...
        inline const Region::ServiceResourceTypes & getServiceResourceTypes() const { DARABONBA_PTR_GET_CONST(serviceResourceTypes_, Region::ServiceResourceTypes) };
        inline Region::ServiceResourceTypes getServiceResourceTypes() { DARABONBA_PTR_GET(serviceResourceTypes_, Region::ServiceResourceTypes) };
        inline Region& setServiceResourceTypes(const Region::ServiceResourceTypes & serviceResourceTypes) { DARABONBA_PTR_SET_VALUE(serviceResourceTypes_, serviceResourceTypes) };
        inline Region& setServiceResourceTypes(Region::ServiceResourceTypes && serviceResourceTypes) { DARABONBA_PTR_SET_RVALUE(serviceResourceTypes_, serviceResourceTypes) };
