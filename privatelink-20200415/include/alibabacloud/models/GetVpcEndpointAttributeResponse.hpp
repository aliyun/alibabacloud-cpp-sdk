...
namespace Models
{
  ...
  public:
    ...
    inline const GetVpcEndpointAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetVpcEndpointAttributeResponseBody) };
    inline GetVpcEndpointAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetVpcEndpointAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetVpcEndpointAttributeResponseBody> body_ {};
  };
