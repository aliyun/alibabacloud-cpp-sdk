...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVpcEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteVpcEndpointResponseBody) };
    inline DeleteVpcEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteVpcEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteVpcEndpointResponseBody> body_ {};
  };
