...
namespace Models
{
  ...
  public:
    ...
    inline const OpenPrivateLinkServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenPrivateLinkServiceResponseBody) };
    inline OpenPrivateLinkServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenPrivateLinkServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenPrivateLinkServiceResponseBody> body_ {};
  };
