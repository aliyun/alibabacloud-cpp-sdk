  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->addressIpVersion_ == nullptr
        ...
        && this->resourceOwner_ == nullptr && this->serviceId_ == nullptr && this->serviceName_ == nullptr && this->serviceRegionId_ == nullptr && this->tags_ == nullptr
        && this->vpcId_ == nullptr && this->zoneAffinityEnabled_ == nullptr; };
      ...
      inline Endpoints& setProtectedEnabled(bool protectedEnabled) { DARABONBA_PTR_SET_VALUE(protectedEnabled_, protectedEnabled) };
