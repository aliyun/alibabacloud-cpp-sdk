...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && this->dryRun_ == nullptr && this->endpointId_ == nullptr && this->regionId_ == nullptr && this->resourceAllocateMode_ == nullptr && this->resourceId_ == nullptr
        && this->resourceReplaceMode_ == nullptr && this->resourceType_ == nullptr && this->serviceId_ == nullptr && this->zoneId_ == nullptr; };
    ...
    inline string getResourceAllocateMode() const { DARABONBA_PTR_GET_DEFAULT(resourceAllocateMode_, "") };
    ...
    inline string getResourceReplaceMode() const { DARABONBA_PTR_GET_DEFAULT(resourceReplaceMode_, "") };
  ...
  protected:
    ...
    shared_ptr<string> resourceAllocateMode_ {};
    ...
    shared_ptr<string> resourceReplaceMode_ {};
