...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateVpcEndpointZoneConnectionResourceAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateVpcEndpointZoneConnectionResourceAttributeResponseBody) };
    inline UpdateVpcEndpointZoneConnectionResourceAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateVpcEndpointZoneConnectionResourceAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateVpcEndpointZoneConnectionResourceAttributeResponseBody> body_ {};
  };
