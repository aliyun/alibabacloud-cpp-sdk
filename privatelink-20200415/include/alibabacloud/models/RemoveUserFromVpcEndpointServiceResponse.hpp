...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveUserFromVpcEndpointServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveUserFromVpcEndpointServiceResponseBody) };
    inline RemoveUserFromVpcEndpointServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveUserFromVpcEndpointServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveUserFromVpcEndpointServiceResponseBody> body_ {};
  };
