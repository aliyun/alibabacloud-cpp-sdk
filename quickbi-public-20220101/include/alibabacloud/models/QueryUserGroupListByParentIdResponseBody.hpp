...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryUserGroupListByParentIdResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<QueryUserGroupListByParentIdResponseBodyResult>) };
    inline vector<QueryUserGroupListByParentIdResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<QueryUserGroupListByParentIdResponseBodyResult>) };
    inline QueryUserGroupListByParentIdResponseBody& setResult(const vector<QueryUserGroupListByParentIdResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryUserGroupListByParentIdResponseBody& setResult(vector<QueryUserGroupListByParentIdResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryUserGroupListByParentIdResponseBodyResult>> result_ = nullptr;
