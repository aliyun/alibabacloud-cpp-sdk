...
namespace Models
{
  ...
  public:
    ...
    inline const QueryUserInfoByUserIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryUserInfoByUserIdResponseBody) };
    inline QueryUserInfoByUserIdResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryUserInfoByUserIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryUserInfoByUserIdResponseBody> body_ {};
  };
