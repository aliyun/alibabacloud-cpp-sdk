...
namespace Models
{
  ...
  public:
    ...
    inline const CheckOrganizationMemberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckOrganizationMemberResponseBody) };
    inline CheckOrganizationMemberResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckOrganizationMemberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckOrganizationMemberResponseBody> body_ {};
  };
