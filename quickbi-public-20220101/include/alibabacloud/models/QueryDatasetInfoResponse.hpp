...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDatasetInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryDatasetInfoResponseBody) };
    inline QueryDatasetInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryDatasetInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryDatasetInfoResponseBody> body_ {};
  };
