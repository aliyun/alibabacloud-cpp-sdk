...
namespace Models
{
  ...
  public:
    ...
    inline const ListApiDatasourceResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListApiDatasourceResponseBodyResult) };
    inline ListApiDatasourceResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListApiDatasourceResponseBodyResult) };
    inline ListApiDatasourceResponseBody& setResult(const ListApiDatasourceResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListApiDatasourceResponseBody& setResult(ListApiDatasourceResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ListApiDatasourceResponseBodyResult> result_ = nullptr;
