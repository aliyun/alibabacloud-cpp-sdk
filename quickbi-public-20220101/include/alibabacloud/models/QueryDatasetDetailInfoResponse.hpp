...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDatasetDetailInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryDatasetDetailInfoResponseBody) };
    inline QueryDatasetDetailInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryDatasetDetailInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryDatasetDetailInfoResponseBody> body_ {};
  };
