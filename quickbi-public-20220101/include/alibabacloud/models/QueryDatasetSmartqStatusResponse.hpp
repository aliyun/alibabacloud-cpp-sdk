...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDatasetSmartqStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryDatasetSmartqStatusResponseBody) };
    inline QueryDatasetSmartqStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryDatasetSmartqStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryDatasetSmartqStatusResponseBody> body_ {};
  };
