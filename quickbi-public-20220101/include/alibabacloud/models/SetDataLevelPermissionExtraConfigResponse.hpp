...
namespace Models
{
  ...
  public:
    ...
    inline const SetDataLevelPermissionExtraConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetDataLevelPermissionExtraConfigResponseBody) };
    inline SetDataLevelPermissionExtraConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, SetDataLevelPermissionExtraConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetDataLevelPermissionExtraConfigResponseBody> body_ {};
  };
