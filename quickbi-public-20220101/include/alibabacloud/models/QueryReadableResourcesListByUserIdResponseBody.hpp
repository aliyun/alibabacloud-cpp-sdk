...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryReadableResourcesListByUserIdResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<QueryReadableResourcesListByUserIdResponseBody::Result>) };
    inline vector<QueryReadableResourcesListByUserIdResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<QueryReadableResourcesListByUserIdResponseBody::Result>) };
    inline QueryReadableResourcesListByUserIdResponseBody& setResult(const vector<QueryReadableResourcesListByUserIdResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryReadableResourcesListByUserIdResponseBody& setResult(vector<QueryReadableResourcesListByUserIdResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<vector<QueryReadableResourcesListByUserIdResponseBody::Result>> result_ {};
