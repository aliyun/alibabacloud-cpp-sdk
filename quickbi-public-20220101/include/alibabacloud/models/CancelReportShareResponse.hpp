...
namespace Models
{
  ...
  public:
    ...
    inline const CancelReportShareResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelReportShareResponseBody) };
    inline CancelReportShareResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelReportShareResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelReportShareResponseBody> body_ {};
  };
