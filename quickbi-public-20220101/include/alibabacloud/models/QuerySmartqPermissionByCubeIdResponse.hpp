...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySmartqPermissionByCubeIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QuerySmartqPermissionByCubeIdResponseBody) };
    inline QuerySmartqPermissionByCubeIdResponseBody getBody() { DARABONBA_PTR_GET(body_, QuerySmartqPermissionByCubeIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QuerySmartqPermissionByCubeIdResponseBody> body_ {};
  };
