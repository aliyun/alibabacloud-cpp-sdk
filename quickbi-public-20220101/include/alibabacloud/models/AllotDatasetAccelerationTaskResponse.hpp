...
namespace Models
{
  ...
  public:
    ...
    inline const AllotDatasetAccelerationTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AllotDatasetAccelerationTaskResponseBody) };
    inline AllotDatasetAccelerationTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, AllotDatasetAccelerationTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AllotDatasetAccelerationTaskResponseBody> body_ {};
  };
