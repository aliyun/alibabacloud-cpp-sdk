...
namespace Models
{
  ...
  public:
    ...
    inline const BatchAddFeishuUsersResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, BatchAddFeishuUsersResponseBodyResult) };
    inline BatchAddFeishuUsersResponseBodyResult result() { DARABONBA_PTR_GET(result_, BatchAddFeishuUsersResponseBodyResult) };
    inline BatchAddFeishuUsersResponseBody& setResult(const BatchAddFeishuUsersResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline BatchAddFeishuUsersResponseBody& setResult(BatchAddFeishuUsersResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<BatchAddFeishuUsersResponseBodyResult> result_ = nullptr;
