...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDashboardNl2sqlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryDashboardNl2sqlResponseBody) };
    inline QueryDashboardNl2sqlResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryDashboardNl2sqlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryDashboardNl2sqlResponseBody> body_ {};
  };
