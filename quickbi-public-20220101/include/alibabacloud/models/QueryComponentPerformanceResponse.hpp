...
namespace Models
{
  ...
  public:
    ...
    inline const QueryComponentPerformanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryComponentPerformanceResponseBody) };
    inline QueryComponentPerformanceResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryComponentPerformanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryComponentPerformanceResponseBody> body_ {};
  };
