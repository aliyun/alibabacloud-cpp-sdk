...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryCubePerformanceResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<QueryCubePerformanceResponseBody::Result>) };
    inline vector<QueryCubePerformanceResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<QueryCubePerformanceResponseBody::Result>) };
    inline QueryCubePerformanceResponseBody& setResult(const vector<QueryCubePerformanceResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryCubePerformanceResponseBody& setResult(vector<QueryCubePerformanceResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<vector<QueryCubePerformanceResponseBody::Result>> result_ {};
