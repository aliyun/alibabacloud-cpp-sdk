...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetMailTaskStatusResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<GetMailTaskStatusResponseBodyResult>) };
    inline vector<GetMailTaskStatusResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<GetMailTaskStatusResponseBodyResult>) };
    inline GetMailTaskStatusResponseBody& setResult(const vector<GetMailTaskStatusResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetMailTaskStatusResponseBody& setResult(vector<GetMailTaskStatusResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // Return result.
    std::shared_ptr<vector<GetMailTaskStatusResponseBodyResult>> result_ = nullptr;
