...
namespace Models
{
  ...
  public:
    ...
    inline CreateUserGroupResponseBody& setResult(string result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    ...
    inline CreateUserGroupResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
