...
#ifndef ALIBABACLOUD_MODELS_QUERYCUBEOPTIMIZATIONRESPONSEBODYRESULTCUBEPERFORMANCEDIAGNOSEMODEL_HPP_
#define ALIBABACLOUD_MODELS_QUERYCUBEOPTIMIZATIONRESPONSEBODYRESULTCUBEPERFORMANCEDIAGNOSEMODEL_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& obj) { 
    ...
    QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel() = default ;
    QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel(const QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel &) = default ;
    QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel(QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel &&) = default ;
    QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel() = default ;
    QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& operator=(const QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel &) = default ;
    QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& operator=(QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel &&) = default ;
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setCacheCostTimeAvg(double cacheCostTimeAvg) { DARABONBA_PTR_SET_VALUE(cacheCostTimeAvg_, cacheCostTimeAvg) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setCacheQueryCount(int32_t cacheQueryCount) { DARABONBA_PTR_SET_VALUE(cacheQueryCount_, cacheQueryCount) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setCostTimeAvg(double costTimeAvg) { DARABONBA_PTR_SET_VALUE(costTimeAvg_, costTimeAvg) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setCubeId(string cubeId) { DARABONBA_PTR_SET_VALUE(cubeId_, cubeId) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setCubeName(string cubeName) { DARABONBA_PTR_SET_VALUE(cubeName_, cubeName) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setQueryCount(int32_t queryCount) { DARABONBA_PTR_SET_VALUE(queryCount_, queryCount) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setQueryCountAvg(double queryCountAvg) { DARABONBA_PTR_SET_VALUE(queryCountAvg_, queryCountAvg) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setQueryOverFivePercentNum(double queryOverFivePercentNum) { DARABONBA_PTR_SET_VALUE(queryOverFivePercentNum_, queryOverFivePercentNum) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setQueryOverFiveSecPercent(string queryOverFiveSecPercent) { DARABONBA_PTR_SET_VALUE(queryOverFiveSecPercent_, queryOverFiveSecPercent) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setQueryOverTenSecPercent(string queryOverTenSecPercent) { DARABONBA_PTR_SET_VALUE(queryOverTenSecPercent_, queryOverTenSecPercent) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setQueryOverTenSecPercentNum(double queryOverTenSecPercentNum) { DARABONBA_PTR_SET_VALUE(queryOverTenSecPercentNum_, queryOverTenSecPercentNum) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setQueryTimeoutCount(int32_t queryTimeoutCount) { DARABONBA_PTR_SET_VALUE(queryTimeoutCount_, queryTimeoutCount) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setQueryTimeoutCountPercent(double queryTimeoutCountPercent) { DARABONBA_PTR_SET_VALUE(queryTimeoutCountPercent_, queryTimeoutCountPercent) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setQuickIndexCostTimeAvg(double quickIndexCostTimeAvg) { DARABONBA_PTR_SET_VALUE(quickIndexCostTimeAvg_, quickIndexCostTimeAvg) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setQuickIndexQueryCount(int32_t quickIndexQueryCount) { DARABONBA_PTR_SET_VALUE(quickIndexQueryCount_, quickIndexQueryCount) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setRepeatQueryPercent(string repeatQueryPercent) { DARABONBA_PTR_SET_VALUE(repeatQueryPercent_, repeatQueryPercent) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setRepeatQueryPercentNum(double repeatQueryPercentNum) { DARABONBA_PTR_SET_VALUE(repeatQueryPercentNum_, repeatQueryPercentNum) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setRepeatSqlQueryCount(int32_t repeatSqlQueryCount) { DARABONBA_PTR_SET_VALUE(repeatSqlQueryCount_, repeatSqlQueryCount) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setRepeatSqlQueryPercent(string repeatSqlQueryPercent) { DARABONBA_PTR_SET_VALUE(repeatSqlQueryPercent_, repeatSqlQueryPercent) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
    ...
    inline QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel& setWorkspaceName(string workspaceName) { DARABONBA_PTR_SET_VALUE(workspaceName_, workspaceName) };
