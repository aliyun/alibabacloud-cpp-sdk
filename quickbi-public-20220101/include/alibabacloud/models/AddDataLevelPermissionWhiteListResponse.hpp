...
namespace Models
{
  ...
  public:
    ...
    inline const AddDataLevelPermissionWhiteListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AddDataLevelPermissionWhiteListResponseBody) };
    inline AddDataLevelPermissionWhiteListResponseBody body() { DARABONBA_PTR_GET(body_, AddDataLevelPermissionWhiteListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AddDataLevelPermissionWhiteListResponseBody> body_ = nullptr;
  };
