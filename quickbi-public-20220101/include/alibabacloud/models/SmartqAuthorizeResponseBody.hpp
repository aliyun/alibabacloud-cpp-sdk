...
namespace Models
{
  ...
  public:
    ...
    inline const vector<SmartqAuthorizeResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<SmartqAuthorizeResponseBodyResult>) };
    inline vector<SmartqAuthorizeResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<SmartqAuthorizeResponseBodyResult>) };
    inline SmartqAuthorizeResponseBody& setResult(const vector<SmartqAuthorizeResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline SmartqAuthorizeResponseBody& setResult(vector<SmartqAuthorizeResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<SmartqAuthorizeResponseBodyResult>> result_ = nullptr;
