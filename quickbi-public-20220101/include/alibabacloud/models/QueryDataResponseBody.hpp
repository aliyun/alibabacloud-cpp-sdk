...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDataResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, QueryDataResponseBodyResult) };
    inline QueryDataResponseBodyResult result() { DARABONBA_PTR_GET(result_, QueryDataResponseBodyResult) };
    inline QueryDataResponseBody& setResult(const QueryDataResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryDataResponseBody& setResult(QueryDataResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<QueryDataResponseBodyResult> result_ = nullptr;
