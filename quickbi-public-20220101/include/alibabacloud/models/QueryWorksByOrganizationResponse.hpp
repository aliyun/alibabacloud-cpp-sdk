...
namespace Models
{
  ...
  public:
    ...
    inline const QueryWorksByOrganizationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryWorksByOrganizationResponseBody) };
    inline QueryWorksByOrganizationResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryWorksByOrganizationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryWorksByOrganizationResponseBody> body_ {};
  };
