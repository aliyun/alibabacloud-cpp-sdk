...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListPortalMenuAuthorizationResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListPortalMenuAuthorizationResponseBodyResult>) };
    inline vector<ListPortalMenuAuthorizationResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListPortalMenuAuthorizationResponseBodyResult>) };
    inline ListPortalMenuAuthorizationResponseBody& setResult(const vector<ListPortalMenuAuthorizationResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListPortalMenuAuthorizationResponseBody& setResult(vector<ListPortalMenuAuthorizationResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListPortalMenuAuthorizationResponseBodyResult>> result_ = nullptr;
