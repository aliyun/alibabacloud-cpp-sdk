...
namespace Models
{
  ...
  public:
    ...
    inline const DataInterpretationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DataInterpretationResponseBody) };
    inline DataInterpretationResponseBody getBody() { DARABONBA_PTR_GET(body_, DataInterpretationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DataInterpretationResponseBody> body_ {};
  };
