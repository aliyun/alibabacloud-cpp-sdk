...
namespace Models
{
  ...
  public:
    ...
    inline const AuthorizeMenuResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AuthorizeMenuResponseBody) };
    inline AuthorizeMenuResponseBody getBody() { DARABONBA_PTR_GET(body_, AuthorizeMenuResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AuthorizeMenuResponseBody> body_ {};
  };
