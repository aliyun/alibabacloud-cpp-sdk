...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryCopilotEmbedConfigResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<QueryCopilotEmbedConfigResponseBodyResult>) };
    inline vector<QueryCopilotEmbedConfigResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<QueryCopilotEmbedConfigResponseBodyResult>) };
    inline QueryCopilotEmbedConfigResponseBody& setResult(const vector<QueryCopilotEmbedConfigResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryCopilotEmbedConfigResponseBody& setResult(vector<QueryCopilotEmbedConfigResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryCopilotEmbedConfigResponseBodyResult>> result_ = nullptr;
