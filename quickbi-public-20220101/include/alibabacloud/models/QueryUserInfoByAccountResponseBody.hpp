...
namespace Models
{
  ...
  public:
    ...
    inline const QueryUserInfoByAccountResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, QueryUserInfoByAccountResponseBodyResult) };
    inline QueryUserInfoByAccountResponseBodyResult result() { DARABONBA_PTR_GET(result_, QueryUserInfoByAccountResponseBodyResult) };
    inline QueryUserInfoByAccountResponseBody& setResult(const QueryUserInfoByAccountResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryUserInfoByAccountResponseBody& setResult(QueryUserInfoByAccountResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<QueryUserInfoByAccountResponseBodyResult> result_ = nullptr;
