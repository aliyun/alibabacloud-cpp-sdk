...
namespace Models
{
  ...
  public:
    ...
    inline const QueryUserGroupListByParentIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryUserGroupListByParentIdResponseBody) };
    inline QueryUserGroupListByParentIdResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryUserGroupListByParentIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryUserGroupListByParentIdResponseBody> body_ {};
  };
