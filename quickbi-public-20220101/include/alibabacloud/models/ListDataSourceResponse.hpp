...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataSourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataSourceResponseBody) };
    inline ListDataSourceResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataSourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataSourceResponseBody> body_ {};
  };
