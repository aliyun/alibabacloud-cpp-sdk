...
namespace Models
{
  ...
  public:
    ...
    inline const QueryLastAccelerationEngineJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryLastAccelerationEngineJobResponseBody) };
    inline QueryLastAccelerationEngineJobResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryLastAccelerationEngineJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryLastAccelerationEngineJobResponseBody> body_ {};
  };
