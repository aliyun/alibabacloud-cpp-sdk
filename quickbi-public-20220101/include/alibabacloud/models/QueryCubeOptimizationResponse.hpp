...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCubeOptimizationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryCubeOptimizationResponseBody) };
    inline QueryCubeOptimizationResponseBody body() { DARABONBA_PTR_GET(body_, QueryCubeOptimizationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryCubeOptimizationResponseBody> body_ = nullptr;
  };
