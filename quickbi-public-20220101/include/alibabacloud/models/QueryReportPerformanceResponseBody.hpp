...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryReportPerformanceResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<QueryReportPerformanceResponseBodyResult>) };
    inline vector<QueryReportPerformanceResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<QueryReportPerformanceResponseBodyResult>) };
    inline QueryReportPerformanceResponseBody& setResult(const vector<QueryReportPerformanceResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryReportPerformanceResponseBody& setResult(vector<QueryReportPerformanceResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryReportPerformanceResponseBodyResult>> result_ = nullptr;
