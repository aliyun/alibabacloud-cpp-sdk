...
namespace Models
{
  ...
  public:
    ...
    inline const ListDataLevelPermissionWhiteListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDataLevelPermissionWhiteListResponseBody) };
    inline ListDataLevelPermissionWhiteListResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDataLevelPermissionWhiteListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDataLevelPermissionWhiteListResponseBody> body_ {};
  };
