...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cubeIds_ == nullptr
        && return this->expireDay_ == nullptr && return this->llmCubeThemes_ == nullptr && return this->llmCubes_ == nullptr && return this->operationType_ == nullptr && return this->userIds_ == nullptr; };
    // cubeIds Field Functions 
    bool hasCubeIds() const { return this->cubeIds_ != nullptr;};
    void deleteCubeIds() { this->cubeIds_ = nullptr;};
    inline string cubeIds() const { DARABONBA_PTR_GET_DEFAULT(cubeIds_, "") };
    ...
    inline string expireDay() const { DARABONBA_PTR_GET_DEFAULT(expireDay_, "") };
    ...
    inline string llmCubeThemes() const { DARABONBA_PTR_GET_DEFAULT(llmCubeThemes_, "") };
    ...
    inline string llmCubes() const { DARABONBA_PTR_GET_DEFAULT(llmCubes_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> cubeIds_ = nullptr;
    // Expiration time, with a default of seven days.
    // Format: 2099-12-31
    std::shared_ptr<string> expireDay_ = nullptr;
    // Array of analysis theme IDs, separated by English commas.
    std::shared_ptr<string> llmCubeThemes_ = nullptr;
    // Array of Q&A resource IDs, separated by English commas.
    std::shared_ptr<string> llmCubes_ = nullptr;
