...
namespace Models
{
  ...
  public:
    ...
    inline const QueryOrganizationWorkspaceListResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, QueryOrganizationWorkspaceListResponseBodyResult) };
    inline QueryOrganizationWorkspaceListResponseBodyResult result() { DARABONBA_PTR_GET(result_, QueryOrganizationWorkspaceListResponseBodyResult) };
    inline QueryOrganizationWorkspaceListResponseBody& setResult(const QueryOrganizationWorkspaceListResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryOrganizationWorkspaceListResponseBody& setResult(QueryOrganizationWorkspaceListResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<QueryOrganizationWorkspaceListResponseBodyResult> result_ = nullptr;
