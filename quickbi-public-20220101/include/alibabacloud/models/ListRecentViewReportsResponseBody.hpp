...
namespace Models
{
  ...
  public:
    ...
    inline const ListRecentViewReportsResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListRecentViewReportsResponseBodyResult) };
    inline ListRecentViewReportsResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListRecentViewReportsResponseBodyResult) };
    inline ListRecentViewReportsResponseBody& setResult(const ListRecentViewReportsResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListRecentViewReportsResponseBody& setResult(ListRecentViewReportsResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ListRecentViewReportsResponseBodyResult> result_ = nullptr;
