...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDashboardNl2sqlStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyDashboardNl2sqlStatusResponseBody) };
    inline ModifyDashboardNl2sqlStatusResponseBody body() { DARABONBA_PTR_GET(body_, ModifyDashboardNl2sqlStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyDashboardNl2sqlStatusResponseBody> body_ = nullptr;
  };
