...
namespace Models
{
  ...
  public:
    ...
    inline const QueryEmbeddedInfoResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, QueryEmbeddedInfoResponseBodyResult) };
    inline QueryEmbeddedInfoResponseBodyResult result() { DARABONBA_PTR_GET(result_, QueryEmbeddedInfoResponseBodyResult) };
    inline QueryEmbeddedInfoResponseBody& setResult(const QueryEmbeddedInfoResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryEmbeddedInfoResponseBody& setResult(QueryEmbeddedInfoResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<QueryEmbeddedInfoResponseBodyResult> result_ = nullptr;
