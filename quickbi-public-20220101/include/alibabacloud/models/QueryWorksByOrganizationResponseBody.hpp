...
namespace Models
{
  ...
  public:
    ...
    inline const QueryWorksByOrganizationResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, QueryWorksByOrganizationResponseBodyResult) };
    inline QueryWorksByOrganizationResponseBodyResult result() { DARABONBA_PTR_GET(result_, QueryWorksByOrganizationResponseBodyResult) };
    inline QueryWorksByOrganizationResponseBody& setResult(const QueryWorksByOrganizationResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryWorksByOrganizationResponseBody& setResult(QueryWorksByOrganizationResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<QueryWorksByOrganizationResponseBodyResult> result_ = nullptr;
