...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListOrganizationRolesResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListOrganizationRolesResponseBody::Result>) };
    inline vector<ListOrganizationRolesResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListOrganizationRolesResponseBody::Result>) };
    inline ListOrganizationRolesResponseBody& setResult(const vector<ListOrganizationRolesResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListOrganizationRolesResponseBody& setResult(vector<ListOrganizationRolesResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<vector<ListOrganizationRolesResponseBody::Result>> result_ {};
