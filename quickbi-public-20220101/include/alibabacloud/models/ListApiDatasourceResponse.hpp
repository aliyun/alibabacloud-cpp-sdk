...
namespace Models
{
  ...
  public:
    ...
    inline const ListApiDatasourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApiDatasourceResponseBody) };
    inline ListApiDatasourceResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApiDatasourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApiDatasourceResponseBody> body_ {};
  };
