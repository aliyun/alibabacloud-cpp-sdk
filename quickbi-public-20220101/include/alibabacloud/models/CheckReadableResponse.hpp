...
namespace Models
{
  ...
  public:
    ...
    inline const CheckReadableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckReadableResponseBody) };
    inline CheckReadableResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckReadableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckReadableResponseBody> body_ {};
  };
