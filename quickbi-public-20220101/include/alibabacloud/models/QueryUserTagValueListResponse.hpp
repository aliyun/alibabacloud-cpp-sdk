...
namespace Models
{
  ...
  public:
    ...
    inline const QueryUserTagValueListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryUserTagValueListResponseBody) };
    inline QueryUserTagValueListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryUserTagValueListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryUserTagValueListResponseBody> body_ {};
  };
