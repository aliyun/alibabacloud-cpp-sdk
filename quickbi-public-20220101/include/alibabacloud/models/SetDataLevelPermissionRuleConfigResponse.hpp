...
namespace Models
{
  ...
  public:
    ...
    inline const SetDataLevelPermissionRuleConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetDataLevelPermissionRuleConfigResponseBody) };
    inline SetDataLevelPermissionRuleConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, SetDataLevelPermissionRuleConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetDataLevelPermissionRuleConfigResponseBody> body_ {};
  };
