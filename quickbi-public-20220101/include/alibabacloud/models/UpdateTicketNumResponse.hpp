...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateTicketNumResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateTicketNumResponseBody) };
    inline UpdateTicketNumResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateTicketNumResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateTicketNumResponseBody> body_ {};
  };
