...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->favoriteDate_ == nullptr && this->gmtCreate_ == nullptr && this->gmtModified_ == nullptr && this->hasEditAuth_ == nullptr && this->hasViewAuth_ == nullptr
        && this->name_ == nullptr && this->ownerName_ == nullptr && this->ownerNum_ == nullptr && this->publishStatus_ == nullptr && this->treeId_ == nullptr
        && this->type_ == nullptr && this->workspaceId_ == nullptr && this->workspaceName_ == nullptr; };
        ...
        inline string getFavoriteDate() const { DARABONBA_PTR_GET_DEFAULT(favoriteDate_, "") };
        inline Data& setFavoriteDate(string favoriteDate) { DARABONBA_PTR_SET_VALUE(favoriteDate_, favoriteDate) };
      ...
      protected:
        ...
        shared_ptr<string> favoriteDate_ {};
    ...
    inline const ListFavoriteReportsResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, ListFavoriteReportsResponseBody::Result) };
    inline ListFavoriteReportsResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, ListFavoriteReportsResponseBody::Result) };
    inline ListFavoriteReportsResponseBody& setResult(const ListFavoriteReportsResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListFavoriteReportsResponseBody& setResult(ListFavoriteReportsResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<ListFavoriteReportsResponseBody::Result> result_ {};
