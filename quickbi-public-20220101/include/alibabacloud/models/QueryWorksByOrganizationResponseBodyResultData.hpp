...
#ifndef ALIBABACLOUD_MODELS_QUERYWORKSBYORGANIZATIONRESPONSEBODYRESULTDATA_HPP_
#define ALIBABACLOUD_MODELS_QUERYWORKSBYORGANIZATIONRESPONSEBODYRESULTDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const QueryWorksByOrganizationResponseBodyResultData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, QueryWorksByOrganizationResponseBodyResultData& obj) { 
    ...
    QueryWorksByOrganizationResponseBodyResultData() = default ;
    QueryWorksByOrganizationResponseBodyResultData(const QueryWorksByOrganizationResponseBodyResultData &) = default ;
    QueryWorksByOrganizationResponseBodyResultData(QueryWorksByOrganizationResponseBodyResultData &&) = default ;
    QueryWorksByOrganizationResponseBodyResultData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~QueryWorksByOrganizationResponseBodyResultData() = default ;
    QueryWorksByOrganizationResponseBodyResultData& operator=(const QueryWorksByOrganizationResponseBodyResultData &) = default ;
    QueryWorksByOrganizationResponseBodyResultData& operator=(QueryWorksByOrganizationResponseBodyResultData &&) = default ;
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setAuth3rdFlag(int32_t auth3rdFlag) { DARABONBA_PTR_SET_VALUE(auth3rdFlag_, auth3rdFlag) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };


    // directory Field Functions 
    bool hasDirectory() const { return this->directory_ != nullptr;};
    void deleteDirectory() { this->directory_ = nullptr;};
    inline const Models::QueryWorksByOrganizationResponseBodyResultDataDirectory & directory() const { DARABONBA_PTR_GET_CONST(directory_, Models::QueryWorksByOrganizationResponseBodyResultDataDirectory) };
    inline Models::QueryWorksByOrganizationResponseBodyResultDataDirectory directory() { DARABONBA_PTR_GET(directory_, Models::QueryWorksByOrganizationResponseBodyResultDataDirectory) };
    inline QueryWorksByOrganizationResponseBodyResultData& setDirectory(const Models::QueryWorksByOrganizationResponseBodyResultDataDirectory & directory) { DARABONBA_PTR_SET_VALUE(directory_, directory) };
    inline QueryWorksByOrganizationResponseBodyResultData& setDirectory(Models::QueryWorksByOrganizationResponseBodyResultDataDirectory && directory) { DARABONBA_PTR_SET_RVALUE(directory_, directory) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setGmtCreate(string gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setGmtModify(string gmtModify) { DARABONBA_PTR_SET_VALUE(gmtModify_, gmtModify) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setModifyName(string modifyName) { DARABONBA_PTR_SET_VALUE(modifyName_, modifyName) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setOwnerId(string ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setOwnerName(string ownerName) { DARABONBA_PTR_SET_VALUE(ownerName_, ownerName) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setPublicFlag(bool publicFlag) { DARABONBA_PTR_SET_VALUE(publicFlag_, publicFlag) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setPublicInvalidTime(int64_t publicInvalidTime) { DARABONBA_PTR_SET_VALUE(publicInvalidTime_, publicInvalidTime) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setSecurityLevel(string securityLevel) { DARABONBA_PTR_SET_VALUE(securityLevel_, securityLevel) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setStatus(int32_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setWorkName(string workName) { DARABONBA_PTR_SET_VALUE(workName_, workName) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setWorkType(string workType) { DARABONBA_PTR_SET_VALUE(workType_, workType) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setWorksId(string worksId) { DARABONBA_PTR_SET_VALUE(worksId_, worksId) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
    ...
    inline QueryWorksByOrganizationResponseBodyResultData& setWorkspaceName(string workspaceName) { DARABONBA_PTR_SET_VALUE(workspaceName_, workspaceName) };
  ...
  protected:
    ...
    std::shared_ptr<Models::QueryWorksByOrganizationResponseBodyResultDataDirectory> directory_ = nullptr;
