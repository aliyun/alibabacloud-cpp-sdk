...
namespace Models
{
  ...
  public:
    ...
    inline const QueryUserInfoByAccountResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryUserInfoByAccountResponseBody) };
    inline QueryUserInfoByAccountResponseBody body() { DARABONBA_PTR_GET(body_, QueryUserInfoByAccountResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryUserInfoByAccountResponseBody> body_ = nullptr;
  };
