...
namespace Models
{
  ...
  public:
    ...
    inline const QueryDataServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryDataServiceResponseBody) };
    inline QueryDataServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryDataServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryDataServiceResponseBody> body_ {};
  };
