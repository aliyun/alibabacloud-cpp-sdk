...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySmartqPermissionByCubeIdResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, QuerySmartqPermissionByCubeIdResponseBodyResult) };
    inline QuerySmartqPermissionByCubeIdResponseBodyResult result() { DARABONBA_PTR_GET(result_, QuerySmartqPermissionByCubeIdResponseBodyResult) };
    inline QuerySmartqPermissionByCubeIdResponseBody& setResult(const QuerySmartqPermissionByCubeIdResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QuerySmartqPermissionByCubeIdResponseBody& setResult(QuerySmartqPermissionByCubeIdResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<QuerySmartqPermissionByCubeIdResponseBodyResult> result_ = nullptr;
