...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryComponentPerformanceResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<QueryComponentPerformanceResponseBody::Result>) };
    inline vector<QueryComponentPerformanceResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<QueryComponentPerformanceResponseBody::Result>) };
    inline QueryComponentPerformanceResponseBody& setResult(const vector<QueryComponentPerformanceResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryComponentPerformanceResponseBody& setResult(vector<QueryComponentPerformanceResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The result returned.
    shared_ptr<vector<QueryComponentPerformanceResponseBody::Result>> result_ {};
