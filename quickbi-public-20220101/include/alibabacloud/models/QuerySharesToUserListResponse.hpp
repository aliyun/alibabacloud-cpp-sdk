...
namespace Models
{
  ...
  public:
    ...
    inline const QuerySharesToUserListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QuerySharesToUserListResponseBody) };
    inline QuerySharesToUserListResponseBody getBody() { DARABONBA_PTR_GET(body_, QuerySharesToUserListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QuerySharesToUserListResponseBody> body_ {};
  };
