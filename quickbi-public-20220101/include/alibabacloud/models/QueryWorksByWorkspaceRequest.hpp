...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNum_ == nullptr
        && return this->pageSize_ == nullptr && return this->status_ == nullptr && return this->thirdPartAuthFlag_ == nullptr && return this->worksType_ == nullptr && return this->workspaceId_ == nullptr; };
