...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->roleId_ == nullptr && this->roleName_ == nullptr; };
          ...
          inline Role& setRoleCode(string roleCode) { DARABONBA_PTR_SET_VALUE(roleCode_, roleCode) };
          ...
          inline Role& setRoleId(int64_t roleId) { DARABONBA_PTR_SET_VALUE(roleId_, roleId) };
        ...
        inline const Data::Role & getRole() const { DARABONBA_PTR_GET_CONST(role_, Data::Role) };
        inline Data::Role getRole() { DARABONBA_PTR_GET(role_, Data::Role) };
        inline Data& setRole(const Data::Role & role) { DARABONBA_PTR_SET_VALUE(role_, role) };
        inline Data& setRole(Data::Role && role) { DARABONBA_PTR_SET_RVALUE(role_, role) };
    ...
    inline const QueryWorkspaceUserListResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, QueryWorkspaceUserListResponseBody::Result) };
    inline QueryWorkspaceUserListResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, QueryWorkspaceUserListResponseBody::Result) };
    inline QueryWorkspaceUserListResponseBody& setResult(const QueryWorkspaceUserListResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryWorkspaceUserListResponseBody& setResult(QueryWorkspaceUserListResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<QueryWorkspaceUserListResponseBody::Result> result_ {};
