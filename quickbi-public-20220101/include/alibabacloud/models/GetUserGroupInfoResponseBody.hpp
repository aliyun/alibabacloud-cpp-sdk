...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetUserGroupInfoResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<GetUserGroupInfoResponseBodyResult>) };
    inline vector<GetUserGroupInfoResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<GetUserGroupInfoResponseBodyResult>) };
    inline GetUserGroupInfoResponseBody& setResult(const vector<GetUserGroupInfoResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetUserGroupInfoResponseBody& setResult(vector<GetUserGroupInfoResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<GetUserGroupInfoResponseBodyResult>> result_ = nullptr;
