...
namespace Models
{
  ...
  public:
    ...
    inline const QueryWorksBloodRelationshipResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryWorksBloodRelationshipResponseBody) };
    inline QueryWorksBloodRelationshipResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryWorksBloodRelationshipResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryWorksBloodRelationshipResponseBody> body_ {};
  };
