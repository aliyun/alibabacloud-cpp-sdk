...
namespace Models
{
  ...
  public:
    ...
    inline const ResultCallbackResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ResultCallbackResponseBody) };
    inline ResultCallbackResponseBody body() { DARABONBA_PTR_GET(body_, ResultCallbackResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ResultCallbackResponseBody> body_ = nullptr;
  };
