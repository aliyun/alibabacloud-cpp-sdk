...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteUserTagMetaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteUserTagMetaResponseBody) };
    inline DeleteUserTagMetaResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteUserTagMetaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteUserTagMetaResponseBody> body_ {};
  };
