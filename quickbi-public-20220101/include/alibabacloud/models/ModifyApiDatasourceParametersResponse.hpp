...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyApiDatasourceParametersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyApiDatasourceParametersResponseBody) };
    inline ModifyApiDatasourceParametersResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyApiDatasourceParametersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyApiDatasourceParametersResponseBody> body_ {};
  };
