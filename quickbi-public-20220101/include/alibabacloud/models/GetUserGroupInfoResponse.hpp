...
namespace Models
{
  ...
  public:
    ...
    inline const GetUserGroupInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetUserGroupInfoResponseBody) };
    inline GetUserGroupInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetUserGroupInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetUserGroupInfoResponseBody> body_ {};
  };
