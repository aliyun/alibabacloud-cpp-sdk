...
#ifndef ALIBABACLOUD_MODELS_UPDATEWORKSPACEUSERSROLEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEWORKSPACEUSERSROLEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateWorkspaceUsersRoleRequest& obj) { 
      DARABONBA_PTR_TO_JSON(RoleId, roleId_);
      DARABONBA_PTR_TO_JSON(UserIds, userIds_);
      DARABONBA_PTR_TO_JSON(WorkspaceId, workspaceId_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateWorkspaceUsersRoleRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(RoleId, roleId_);
      DARABONBA_PTR_FROM_JSON(UserIds, userIds_);
      DARABONBA_PTR_FROM_JSON(WorkspaceId, workspaceId_);
    };
    UpdateWorkspaceUsersRoleRequest() = default ;
    UpdateWorkspaceUsersRoleRequest(const UpdateWorkspaceUsersRoleRequest &) = default ;
    UpdateWorkspaceUsersRoleRequest(UpdateWorkspaceUsersRoleRequest &&) = default ;
    UpdateWorkspaceUsersRoleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateWorkspaceUsersRoleRequest() = default ;
    UpdateWorkspaceUsersRoleRequest& operator=(const UpdateWorkspaceUsersRoleRequest &) = default ;
    UpdateWorkspaceUsersRoleRequest& operator=(UpdateWorkspaceUsersRoleRequest &&) = default ;
