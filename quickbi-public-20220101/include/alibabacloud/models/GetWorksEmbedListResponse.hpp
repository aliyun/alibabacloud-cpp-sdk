...
namespace Models
{
  ...
  public:
    ...
    inline const GetWorksEmbedListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetWorksEmbedListResponseBody) };
    inline GetWorksEmbedListResponseBody getBody() { DARABONBA_PTR_GET(body_, GetWorksEmbedListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetWorksEmbedListResponseBody> body_ {};
  };
