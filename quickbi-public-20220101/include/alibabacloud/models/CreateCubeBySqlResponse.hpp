...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCubeBySqlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCubeBySqlResponseBody) };
    inline CreateCubeBySqlResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCubeBySqlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCubeBySqlResponseBody> body_ {};
  };
