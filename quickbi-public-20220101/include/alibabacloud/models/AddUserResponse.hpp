...
namespace Models
{
  ...
  public:
    ...
    inline const AddUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddUserResponseBody) };
    inline AddUserResponseBody getBody() { DARABONBA_PTR_GET(body_, AddUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddUserResponseBody> body_ {};
  };
