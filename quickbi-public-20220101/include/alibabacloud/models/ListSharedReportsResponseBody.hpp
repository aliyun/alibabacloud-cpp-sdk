...
namespace Models
{
  ...
  public:
    ...
    inline const ListSharedReportsResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListSharedReportsResponseBodyResult) };
    inline ListSharedReportsResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListSharedReportsResponseBodyResult) };
    inline ListSharedReportsResponseBody& setResult(const ListSharedReportsResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListSharedReportsResponseBody& setResult(ListSharedReportsResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ListSharedReportsResponseBodyResult> result_ = nullptr;
