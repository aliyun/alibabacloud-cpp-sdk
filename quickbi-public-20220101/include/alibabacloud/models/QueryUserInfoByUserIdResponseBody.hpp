...
namespace Models
{
  ...
  public:
    ...
    inline const QueryUserInfoByUserIdResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, QueryUserInfoByUserIdResponseBody::Result) };
    inline QueryUserInfoByUserIdResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, QueryUserInfoByUserIdResponseBody::Result) };
    inline QueryUserInfoByUserIdResponseBody& setResult(const QueryUserInfoByUserIdResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryUserInfoByUserIdResponseBody& setResult(QueryUserInfoByUserIdResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
