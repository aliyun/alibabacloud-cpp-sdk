...
namespace Models
{
  ...
  public:
    ...
    inline const QueryWorksByWorkspaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryWorksByWorkspaceResponseBody) };
    inline QueryWorksByWorkspaceResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryWorksByWorkspaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryWorksByWorkspaceResponseBody> body_ {};
  };
