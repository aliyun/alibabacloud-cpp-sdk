...
namespace Models
{
  ...
  public:
    ...
    inline const QueryLlmCubeWithThemeListByUserIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryLlmCubeWithThemeListByUserIdResponseBody) };
    inline QueryLlmCubeWithThemeListByUserIdResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryLlmCubeWithThemeListByUserIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryLlmCubeWithThemeListByUserIdResponseBody> body_ {};
  };
