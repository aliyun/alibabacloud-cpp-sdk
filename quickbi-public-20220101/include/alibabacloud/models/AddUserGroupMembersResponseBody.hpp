...
namespace Models
{
  ...
  public:
    ...
    inline AddUserGroupMembersResponseBody& setResult(bool result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    ...
    inline AddUserGroupMembersResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
