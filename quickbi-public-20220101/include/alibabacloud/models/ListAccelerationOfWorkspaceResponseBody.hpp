...
namespace Models
{
  ...
  public:
    ...
    inline const ListAccelerationOfWorkspaceResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListAccelerationOfWorkspaceResponseBodyResult) };
    inline ListAccelerationOfWorkspaceResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListAccelerationOfWorkspaceResponseBodyResult) };
    inline ListAccelerationOfWorkspaceResponseBody& setResult(const ListAccelerationOfWorkspaceResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListAccelerationOfWorkspaceResponseBody& setResult(ListAccelerationOfWorkspaceResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ListAccelerationOfWorkspaceResponseBodyResult> result_ = nullptr;
