...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTicket4CopilotResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTicket4CopilotResponseBody) };
    inline CreateTicket4CopilotResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTicket4CopilotResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTicket4CopilotResponseBody> body_ {};
  };
