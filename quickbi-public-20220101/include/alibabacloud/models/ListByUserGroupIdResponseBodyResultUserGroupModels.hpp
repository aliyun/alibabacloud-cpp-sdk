...
#ifndef ALIBABACLOUD_MODELS_LISTBYUSERGROUPIDRESPONSEBODYRESULTUSERGROUPMODELS_HPP_
#define ALIBABACLOUD_MODELS_LISTBYUSERGROUPIDRESPONSEBODYRESULTUSERGROUPMODELS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListByUserGroupIdResponseBodyResultUserGroupModels& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListByUserGroupIdResponseBodyResultUserGroupModels& obj) { 
    ...
    ListByUserGroupIdResponseBodyResultUserGroupModels() = default ;
    ListByUserGroupIdResponseBodyResultUserGroupModels(const ListByUserGroupIdResponseBodyResultUserGroupModels &) = default ;
    ListByUserGroupIdResponseBodyResultUserGroupModels(ListByUserGroupIdResponseBodyResultUserGroupModels &&) = default ;
    ListByUserGroupIdResponseBodyResultUserGroupModels(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListByUserGroupIdResponseBodyResultUserGroupModels() = default ;
    ListByUserGroupIdResponseBodyResultUserGroupModels& operator=(const ListByUserGroupIdResponseBodyResultUserGroupModels &) = default ;
    ListByUserGroupIdResponseBodyResultUserGroupModels& operator=(ListByUserGroupIdResponseBodyResultUserGroupModels &&) = default ;
    ...
    inline ListByUserGroupIdResponseBodyResultUserGroupModels& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListByUserGroupIdResponseBodyResultUserGroupModels& setCreateUser(string createUser) { DARABONBA_PTR_SET_VALUE(createUser_, createUser) };
    ...
    inline ListByUserGroupIdResponseBodyResultUserGroupModels& setIdentifiedPath(string identifiedPath) { DARABONBA_PTR_SET_VALUE(identifiedPath_, identifiedPath) };
    ...
    inline ListByUserGroupIdResponseBodyResultUserGroupModels& setModifiedTime(string modifiedTime) { DARABONBA_PTR_SET_VALUE(modifiedTime_, modifiedTime) };
    ...
    inline ListByUserGroupIdResponseBodyResultUserGroupModels& setModifyUser(string modifyUser) { DARABONBA_PTR_SET_VALUE(modifyUser_, modifyUser) };
    ...
    inline ListByUserGroupIdResponseBodyResultUserGroupModels& setParentUsergroupId(string parentUsergroupId) { DARABONBA_PTR_SET_VALUE(parentUsergroupId_, parentUsergroupId) };
    ...
    inline ListByUserGroupIdResponseBodyResultUserGroupModels& setUsergroupDesc(string usergroupDesc) { DARABONBA_PTR_SET_VALUE(usergroupDesc_, usergroupDesc) };
    ...
    inline ListByUserGroupIdResponseBodyResultUserGroupModels& setUsergroupId(string usergroupId) { DARABONBA_PTR_SET_VALUE(usergroupId_, usergroupId) };
    ...
    inline ListByUserGroupIdResponseBodyResultUserGroupModels& setUsergroupName(string usergroupName) { DARABONBA_PTR_SET_VALUE(usergroupName_, usergroupName) };
