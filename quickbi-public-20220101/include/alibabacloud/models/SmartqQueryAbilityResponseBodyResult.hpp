...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->chartType_ != nullptr
        && this->conclusionText_ != nullptr && this->logicSql_ != nullptr && this->metaType_ != nullptr && this->values_ != nullptr; };
