...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListCollectionsResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListCollectionsResponseBodyResult>) };
    inline vector<ListCollectionsResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListCollectionsResponseBodyResult>) };
    inline ListCollectionsResponseBody& setResult(const vector<ListCollectionsResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListCollectionsResponseBody& setResult(vector<ListCollectionsResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
