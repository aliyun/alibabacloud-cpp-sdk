...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryWorksBloodRelationshipResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<QueryWorksBloodRelationshipResponseBodyResult>) };
    inline vector<QueryWorksBloodRelationshipResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<QueryWorksBloodRelationshipResponseBodyResult>) };
    inline QueryWorksBloodRelationshipResponseBody& setResult(const vector<QueryWorksBloodRelationshipResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryWorksBloodRelationshipResponseBody& setResult(vector<QueryWorksBloodRelationshipResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryWorksBloodRelationshipResponseBodyResult>> result_ = nullptr;
