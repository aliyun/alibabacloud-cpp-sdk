...
namespace Models
{
  ...
  public:
    ...
    inline const ListFavoriteReportsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListFavoriteReportsResponseBody) };
    inline ListFavoriteReportsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListFavoriteReportsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListFavoriteReportsResponseBody> body_ {};
  };
