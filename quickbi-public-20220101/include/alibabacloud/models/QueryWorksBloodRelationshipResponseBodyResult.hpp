...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->componentId_ == nullptr
        && return this->componentName_ == nullptr && return this->componentType_ == nullptr && return this->componentTypeCnName_ == nullptr && return this->componentTypeName_ == nullptr && return this->datasetId_ == nullptr
        && return this->queryParams_ == nullptr; };
