...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aggregator_ == nullptr
        && return this->column_ == nullptr && return this->dataType_ == nullptr && return this->granularity_ == nullptr && return this->label_ == nullptr && return this->originalColumn_ == nullptr
