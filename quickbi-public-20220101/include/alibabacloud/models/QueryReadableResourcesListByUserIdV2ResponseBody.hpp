...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryReadableResourcesListByUserIdV2ResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<QueryReadableResourcesListByUserIdV2ResponseBody::Result>) };
    inline vector<QueryReadableResourcesListByUserIdV2ResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<QueryReadableResourcesListByUserIdV2ResponseBody::Result>) };
    inline QueryReadableResourcesListByUserIdV2ResponseBody& setResult(const vector<QueryReadableResourcesListByUserIdV2ResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryReadableResourcesListByUserIdV2ResponseBody& setResult(vector<QueryReadableResourcesListByUserIdV2ResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<vector<QueryReadableResourcesListByUserIdV2ResponseBody::Result>> result_ {};
