...
namespace Models
{
  ...
  public:
    ...
    inline const SmartqAuthorizeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SmartqAuthorizeResponseBody) };
    inline SmartqAuthorizeResponseBody getBody() { DARABONBA_PTR_GET(body_, SmartqAuthorizeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SmartqAuthorizeResponseBody> body_ {};
  };
