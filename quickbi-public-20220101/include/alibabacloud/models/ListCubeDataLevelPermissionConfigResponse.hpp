...
namespace Models
{
  ...
  public:
    ...
    inline const ListCubeDataLevelPermissionConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListCubeDataLevelPermissionConfigResponseBody) };
    inline ListCubeDataLevelPermissionConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ListCubeDataLevelPermissionConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListCubeDataLevelPermissionConfigResponseBody> body_ {};
  };
