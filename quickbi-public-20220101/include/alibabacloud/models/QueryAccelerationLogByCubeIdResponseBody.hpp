...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAccelerationLogByCubeIdResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, QueryAccelerationLogByCubeIdResponseBodyResult) };
    inline QueryAccelerationLogByCubeIdResponseBodyResult result() { DARABONBA_PTR_GET(result_, QueryAccelerationLogByCubeIdResponseBodyResult) };
    inline QueryAccelerationLogByCubeIdResponseBody& setResult(const QueryAccelerationLogByCubeIdResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryAccelerationLogByCubeIdResponseBody& setResult(QueryAccelerationLogByCubeIdResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<QueryAccelerationLogByCubeIdResponseBodyResult> result_ = nullptr;
