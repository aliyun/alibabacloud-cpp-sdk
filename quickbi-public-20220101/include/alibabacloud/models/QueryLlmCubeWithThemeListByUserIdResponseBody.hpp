...
namespace Models
{
  ...
  public:
    ...
    inline const QueryLlmCubeWithThemeListByUserIdResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, QueryLlmCubeWithThemeListByUserIdResponseBodyResult) };
    inline QueryLlmCubeWithThemeListByUserIdResponseBodyResult result() { DARABONBA_PTR_GET(result_, QueryLlmCubeWithThemeListByUserIdResponseBodyResult) };
    inline QueryLlmCubeWithThemeListByUserIdResponseBody& setResult(const QueryLlmCubeWithThemeListByUserIdResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryLlmCubeWithThemeListByUserIdResponseBody& setResult(QueryLlmCubeWithThemeListByUserIdResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<QueryLlmCubeWithThemeListByUserIdResponseBodyResult> result_ = nullptr;
