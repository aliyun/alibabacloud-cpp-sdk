...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDataSourceResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListDataSourceResponseBodyResult>) };
    inline vector<ListDataSourceResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListDataSourceResponseBodyResult>) };
    inline ListDataSourceResponseBody& setResult(const vector<ListDataSourceResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListDataSourceResponseBody& setResult(vector<ListDataSourceResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDataSourceResponseBodyResult>> result_ = nullptr;
