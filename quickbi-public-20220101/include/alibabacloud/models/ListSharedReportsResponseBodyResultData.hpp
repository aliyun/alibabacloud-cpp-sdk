...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->favorite_ == nullptr
        && return this->gmtCreate_ == nullptr && return this->gmtModified_ == nullptr && return this->hasEditAuth_ == nullptr && return this->hasViewAuth_ == nullptr && return this->name_ == nullptr
        && return this->ownerName_ == nullptr && return this->ownerNum_ == nullptr && return this->publishStatus_ == nullptr && return this->treeId_ == nullptr && return this->type_ == nullptr
