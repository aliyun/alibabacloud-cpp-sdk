...
namespace Models
{
  ...
  public:
    ...
    inline const QueryWorksByWorkspaceResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, QueryWorksByWorkspaceResponseBody::Result) };
    inline QueryWorksByWorkspaceResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, QueryWorksByWorkspaceResponseBody::Result) };
    inline QueryWorksByWorkspaceResponseBody& setResult(const QueryWorksByWorkspaceResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QueryWorksByWorkspaceResponseBody& setResult(QueryWorksByWorkspaceResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    shared_ptr<QueryWorksByWorkspaceResponseBody::Result> result_ {};
