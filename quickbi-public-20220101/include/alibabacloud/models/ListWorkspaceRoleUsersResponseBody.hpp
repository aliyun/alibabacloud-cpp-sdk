...
#ifndef ALIBABACLOUD_MODELS_LISTWORKSPACEROLEUSERSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTWORKSPACEROLEUSERSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListWorkspaceRoleUsersResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Result, result_);
      DARABONBA_PTR_TO_JSON(Success, success_);
    };
    friend void from_json(const Darabonba::Json& j, ListWorkspaceRoleUsersResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Result, result_);
      DARABONBA_PTR_FROM_JSON(Success, success_);
    };
    ListWorkspaceRoleUsersResponseBody() = default ;
    ListWorkspaceRoleUsersResponseBody(const ListWorkspaceRoleUsersResponseBody &) = default ;
    ListWorkspaceRoleUsersResponseBody(ListWorkspaceRoleUsersResponseBody &&) = default ;
    ListWorkspaceRoleUsersResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListWorkspaceRoleUsersResponseBody() = default ;
    ListWorkspaceRoleUsersResponseBody& operator=(const ListWorkspaceRoleUsersResponseBody &) = default ;
    ListWorkspaceRoleUsersResponseBody& operator=(ListWorkspaceRoleUsersResponseBody &&) = default ;
    ...
    inline ListWorkspaceRoleUsersResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const ListWorkspaceRoleUsersResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, ListWorkspaceRoleUsersResponseBody::Result) };
    inline ListWorkspaceRoleUsersResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, ListWorkspaceRoleUsersResponseBody::Result) };
    inline ListWorkspaceRoleUsersResponseBody& setResult(const ListWorkspaceRoleUsersResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListWorkspaceRoleUsersResponseBody& setResult(ListWorkspaceRoleUsersResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
    ...
    inline ListWorkspaceRoleUsersResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    shared_ptr<ListWorkspaceRoleUsersResponseBody::Result> result_ {};
