...
namespace Models
{
  ...
  public:
    ...
    inline const DataSetBloodResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DataSetBloodResponseBody) };
    inline DataSetBloodResponseBody body() { DARABONBA_PTR_GET(body_, DataSetBloodResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DataSetBloodResponseBody> body_ = nullptr;
  };
