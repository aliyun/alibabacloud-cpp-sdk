...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getOffsetDay() const { DARABONBA_PTR_GET_DEFAULT(offsetDay_, 0) };
    ...
    inline string getTreeType() const { DARABONBA_PTR_GET_DEFAULT(treeType_, "") };
