...
namespace Models
{
  ...
  public:
    ...
    inline const AddShareReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddShareReportResponseBody) };
    inline AddShareReportResponseBody getBody() { DARABONBA_PTR_GET(body_, AddShareReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddShareReportResponseBody> body_ {};
  };
