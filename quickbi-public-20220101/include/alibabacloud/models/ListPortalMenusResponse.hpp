...
namespace Models
{
  ...
  public:
    ...
    inline const ListPortalMenusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListPortalMenusResponseBody) };
    inline ListPortalMenusResponseBody body() { DARABONBA_PTR_GET(body_, ListPortalMenusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListPortalMenusResponseBody> body_ = nullptr;
  };
