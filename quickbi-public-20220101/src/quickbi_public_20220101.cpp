...
QueryEmbeddedStausResponse Alibabacloud_Quickbi-public20220101::Client::queryEmbeddedStausWithOptions(shared_ptr<QueryEmbeddedStausRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->worksId)) {
    query->insert(pair<string, string>("WorksId", *request->worksId));
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("QueryEmbeddedStaus"))},
    {"version", boost::any(string("2022-01-01"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return QueryEmbeddedStausResponse(callApi(params, req, runtime));
}

QueryEmbeddedStausResponse Alibabacloud_Quickbi-public20220101::Client::queryEmbeddedStaus(shared_ptr<QueryEmbeddedStausRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
