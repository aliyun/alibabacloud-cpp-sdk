...
#ifndef ALIBABACLOUD_MODELS_CLINKDESCRIBECLIENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CLINKDESCRIBECLIENTRESPONSEBODY_HPP_
...
namespace Models
{
  class ClinkDescribeClientResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ClinkDescribeClientResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ClinkDescribeClientResponseBody& obj) { 
    ...
    ClinkDescribeClientResponseBody() = default ;
    ClinkDescribeClientResponseBody(const ClinkDescribeClientResponseBody &) = default ;
    ClinkDescribeClientResponseBody(ClinkDescribeClientResponseBody &&) = default ;
    ClinkDescribeClientResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ClinkDescribeClientResponseBody() = default ;
    ClinkDescribeClientResponseBody& operator=(const ClinkDescribeClientResponseBody &) = default ;
    ClinkDescribeClientResponseBody& operator=(ClinkDescribeClientResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        friend void to_json(Darabonba::Json& j, const Client& obj) { 
          ...
          DARABONBA_PTR_TO_JSON(AutoInvestigation, autoInvestigation_);
          ...
          DARABONBA_PTR_TO_JSON(ReserveTel, reserveTel_);
        ...
        friend void from_json(const Darabonba::Json& j, Client& obj) { 
          ...
          DARABONBA_PTR_FROM_JSON(AutoInvestigation, autoInvestigation_);
          ...
          DARABONBA_PTR_FROM_JSON(ReserveTel, reserveTel_);
        ...
        && this->penalty_ == nullptr && this->qno_ == nullptr; };
          ...
          inline Queues& setPenalty(int64_t penalty) { DARABONBA_PTR_SET_VALUE(penalty_, penalty) };
        ...
        && this->areaCode_ == nullptr && this->autoInvestigation_ == nullptr && this->bindTel_ == nullptr && this->clid_ == nullptr && this->clidArea_ == nullptr
        ...
        && this->crmId_ == nullptr && this->hiddenTel_ == nullptr && this->ibWrapupTime_ == nullptr && this->ibWrapupType_ == nullptr && this->name_ == nullptr
        && this->obHangupSms_ == nullptr && this->pauseLogin_ == nullptr && this->permission_ == nullptr && this->qnos_ == nullptr && this->queues_ == nullptr
        && this->recurrentselectionType_ == nullptr && this->recurrentselectionValue_ == nullptr && this->reserveTel_ == nullptr && this->role_ == nullptr && this->serveArea_ == nullptr
        && this->status_ == nullptr && this->telType_ == nullptr && this->type_ == nullptr && this->wrapupTime_ == nullptr; };
        ...
        // autoInvestigation Field Functions 
        bool hasAutoInvestigation() const { return this->autoInvestigation_ != nullptr;};
        void deleteAutoInvestigation() { this->autoInvestigation_ = nullptr;};
        inline int64_t getAutoInvestigation() const { DARABONBA_PTR_GET_DEFAULT(autoInvestigation_, 0L) };
        inline Client& setAutoInvestigation(int64_t autoInvestigation) { DARABONBA_PTR_SET_VALUE(autoInvestigation_, autoInvestigation) };
        ...
        inline Client& setBindTel(string bindTel) { DARABONBA_PTR_SET_VALUE(bindTel_, bindTel) };
        ...
        inline Client& setCno(string cno) { DARABONBA_PTR_SET_VALUE(cno_, cno) };
        ...
        inline Client& setCrmId(string crmId) { DARABONBA_PTR_SET_VALUE(crmId_, crmId) };
        ...
        inline string getHiddenTel() const { DARABONBA_PTR_GET_DEFAULT(hiddenTel_, "") };
        inline Client& setHiddenTel(string hiddenTel) { DARABONBA_PTR_SET_VALUE(hiddenTel_, hiddenTel) };
        ...
        inline Client& setIbWrapupTime(int64_t ibWrapupTime) { DARABONBA_PTR_SET_VALUE(ibWrapupTime_, ibWrapupTime) };
        ...
        inline Client& setIbWrapupType(int64_t ibWrapupType) { DARABONBA_PTR_SET_VALUE(ibWrapupType_, ibWrapupType) };
        ...
        inline Client& setObHangupSms(int64_t obHangupSms) { DARABONBA_PTR_SET_VALUE(obHangupSms_, obHangupSms) };
        ...
        inline Client& setPauseLogin(int64_t pauseLogin) { DARABONBA_PTR_SET_VALUE(pauseLogin_, pauseLogin) };
        ...
        inline const vector<Client::Queues> & getQueues() const { DARABONBA_PTR_GET_CONST(queues_, vector<Client::Queues>) };
        inline vector<Client::Queues> getQueues() { DARABONBA_PTR_GET(queues_, vector<Client::Queues>) };
        inline Client& setQueues(const vector<Client::Queues> & queues) { DARABONBA_PTR_SET_VALUE(queues_, queues) };
        inline Client& setQueues(vector<Client::Queues> && queues) { DARABONBA_PTR_SET_RVALUE(queues_, queues) };
        ...
        // reserveTel Field Functions 
        bool hasReserveTel() const { return this->reserveTel_ != nullptr;};
        void deleteReserveTel() { this->reserveTel_ = nullptr;};
        inline string getReserveTel() const { DARABONBA_PTR_GET_DEFAULT(reserveTel_, "") };
        inline Client& setReserveTel(string reserveTel) { DARABONBA_PTR_SET_VALUE(reserveTel_, reserveTel) };
        ...
        inline Client& setServeArea(const vector<string> & serveArea) { DARABONBA_PTR_SET_VALUE(serveArea_, serveArea) };
        inline Client& setServeArea(vector<string> && serveArea) { DARABONBA_PTR_SET_RVALUE(serveArea_, serveArea) };
        ...
        inline Client& setStatus(int64_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
        ...
        inline Client& setTelType(int64_t telType) { DARABONBA_PTR_SET_VALUE(telType_, telType) };
      ...
      protected:
        ...
        shared_ptr<int64_t> autoInvestigation_ {};
        // 座席绑定电话
        ...
        // 座席所属队列详情
        shared_ptr<vector<Client::Queues>> queues_ {};
    ...
    inline ClinkDescribeClientResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ClinkDescribeClientResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ClinkDescribeClientResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ClinkDescribeClientResponseBody::Data) };
    inline ClinkDescribeClientResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ClinkDescribeClientResponseBody::Data) };
    inline ClinkDescribeClientResponseBody& setData(const ClinkDescribeClientResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ClinkDescribeClientResponseBody& setData(ClinkDescribeClientResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ClinkDescribeClientResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ClinkDescribeClientResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> accessDeniedDetail_ {};
    shared_ptr<string> code_ {};
    shared_ptr<ClinkDescribeClientResponseBody::Data> data_ {};
