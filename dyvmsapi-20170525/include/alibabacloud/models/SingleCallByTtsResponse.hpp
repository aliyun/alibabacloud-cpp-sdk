...
namespace Models
{
  ...
  public:
    ...
    inline const SingleCallByTtsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SingleCallByTtsResponseBody) };
    inline SingleCallByTtsResponseBody getBody() { DARABONBA_PTR_GET(body_, SingleCallByTtsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SingleCallByTtsResponseBody> body_ {};
  };
