...
namespace Models
{
  ...
  public:
    ...
    inline const ListHotlineTransferRegisterFileResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListHotlineTransferRegisterFileResponseBodyData) };
    inline ListHotlineTransferRegisterFileResponseBodyData data() { DARABONBA_PTR_GET(data_, ListHotlineTransferRegisterFileResponseBodyData) };
    inline ListHotlineTransferRegisterFileResponseBody& setData(const ListHotlineTransferRegisterFileResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListHotlineTransferRegisterFileResponseBody& setData(ListHotlineTransferRegisterFileResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListHotlineTransferRegisterFileResponseBodyData> data_ = nullptr;
