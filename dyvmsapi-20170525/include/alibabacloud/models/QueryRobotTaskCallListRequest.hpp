...
namespace Models
{
  ...
  public:
    ...
    inline string getDialogCountFrom() const { DARABONBA_PTR_GET_DEFAULT(dialogCountFrom_, "") };
    ...
    inline string getDialogCountTo() const { DARABONBA_PTR_GET_DEFAULT(dialogCountTo_, "") };
    ...
    inline string getDurationFrom() const { DARABONBA_PTR_GET_DEFAULT(durationFrom_, "") };
    ...
    inline string getDurationTo() const { DARABONBA_PTR_GET_DEFAULT(durationTo_, "") };
  ...
  protected:
    ...
    shared_ptr<string> dialogCountFrom_ {};
    // The maximum number of conversation rounds in the call.
    shared_ptr<string> dialogCountTo_ {};
    // The minimum call duration.
    shared_ptr<string> durationFrom_ {};
    // The maximum call duration.
    shared_ptr<string> durationTo_ {};
