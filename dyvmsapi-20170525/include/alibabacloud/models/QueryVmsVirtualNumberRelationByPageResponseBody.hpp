...
namespace Models
{
  ...
  public:
    ...
    inline const QueryVmsVirtualNumberRelationByPageResponseBodyModel & model() const { DARABONBA_PTR_GET_CONST(model_, QueryVmsVirtualNumberRelationByPageResponseBodyModel) };
    inline QueryVmsVirtualNumberRelationByPageResponseBodyModel model() { DARABONBA_PTR_GET(model_, QueryVmsVirtualNumberRelationByPageResponseBodyModel) };
    inline QueryVmsVirtualNumberRelationByPageResponseBody& setModel(const QueryVmsVirtualNumberRelationByPageResponseBodyModel & model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    inline QueryVmsVirtualNumberRelationByPageResponseBody& setModel(QueryVmsVirtualNumberRelationByPageResponseBodyModel && model) { DARABONBA_PTR_SET_RVALUE(model_, model) };
  ...
  protected:
    ...
    std::shared_ptr<QueryVmsVirtualNumberRelationByPageResponseBodyModel> model_ = nullptr;
