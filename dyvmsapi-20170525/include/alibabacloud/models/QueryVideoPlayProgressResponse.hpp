...
namespace Models
{
  ...
  public:
    ...
    inline const QueryVideoPlayProgressResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, QueryVideoPlayProgressResponseBody) };
    inline QueryVideoPlayProgressResponseBody body() { DARABONBA_PTR_GET(body_, QueryVideoPlayProgressResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<QueryVideoPlayProgressResponseBody> body_ = nullptr;
  };
