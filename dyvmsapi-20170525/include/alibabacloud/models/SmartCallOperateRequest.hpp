...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callId_ == nullptr
        && return this->command_ == nullptr && return this->ownerId_ == nullptr && return this->param_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr; };
