...
namespace Models
{
  ...
  public:
    ...
    inline const QueryCallInTransferRecordResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryCallInTransferRecordResponseBodyData) };
    inline QueryCallInTransferRecordResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryCallInTransferRecordResponseBodyData) };
    inline QueryCallInTransferRecordResponseBody& setData(const QueryCallInTransferRecordResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryCallInTransferRecordResponseBody& setData(QueryCallInTransferRecordResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryCallInTransferRecordResponseBodyData> data_ = nullptr;
