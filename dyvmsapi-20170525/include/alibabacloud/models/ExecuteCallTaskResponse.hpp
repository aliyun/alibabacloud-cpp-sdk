...
namespace Models
{
  ...
  public:
    ...
    inline const ExecuteCallTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ExecuteCallTaskResponseBody) };
    inline ExecuteCallTaskResponseBody body() { DARABONBA_PTR_GET(body_, ExecuteCallTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ExecuteCallTaskResponseBody> body_ = nullptr;
  };
