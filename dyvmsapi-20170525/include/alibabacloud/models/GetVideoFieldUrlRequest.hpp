...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->ownerId_ == nullptr
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->videoFile_ == nullptr; };
    ...
    inline string getVideoFile() const { DARABONBA_PTR_GET_DEFAULT(videoFile_, "") };
