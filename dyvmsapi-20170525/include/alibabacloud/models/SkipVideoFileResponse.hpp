...
namespace Models
{
  ...
  public:
    ...
    inline const SkipVideoFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SkipVideoFileResponseBody) };
    inline SkipVideoFileResponseBody getBody() { DARABONBA_PTR_GET(body_, SkipVideoFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SkipVideoFileResponseBody> body_ {};
  };
