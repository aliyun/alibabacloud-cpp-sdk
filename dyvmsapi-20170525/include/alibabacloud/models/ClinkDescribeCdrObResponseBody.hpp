...
#ifndef ALIBABACLOUD_MODELS_CLINKDESCRIBECDROBRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CLINKDESCRIBECDROBRESPONSEBODY_HPP_
...
namespace Models
{
  class ClinkDescribeCdrObResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ClinkDescribeCdrObResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ClinkDescribeCdrObResponseBody& obj) { 
    ...
    ClinkDescribeCdrObResponseBody() = default ;
    ClinkDescribeCdrObResponseBody(const ClinkDescribeCdrObResponseBody &) = default ;
    ClinkDescribeCdrObResponseBody(ClinkDescribeCdrObResponseBody &&) = default ;
    ClinkDescribeCdrObResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ClinkDescribeCdrObResponseBody() = default ;
    ClinkDescribeCdrObResponseBody& operator=(const ClinkDescribeCdrObResponseBody &) = default ;
    ClinkDescribeCdrObResponseBody& operator=(ClinkDescribeCdrObResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        friend void to_json(Darabonba::Json& j, const CdrOb& obj) { 
          ...
          DARABONBA_ANY_TO_JSON(Investigation, investigation_);
        ...
        friend void from_json(const Darabonba::Json& j, CdrOb& obj) { 
          ...
          DARABONBA_ANY_FROM_JSON(Investigation, investigation_);
        ...
        && this->cno_ == nullptr && this->customerCity_ == nullptr && this->customerNumber_ == nullptr && this->customerNumberEncrypt_ == nullptr && this->customerProvince_ == nullptr
        && this->customerRingingTime_ == nullptr && this->endReason_ == nullptr && this->endTime_ == nullptr && this->evaluation_ == nullptr && this->hotline_ == nullptr
        && this->investigation_ == nullptr && this->ivrName_ == nullptr && this->mark_ == nullptr && this->markData_ == nullptr && this->recordFile_ == nullptr
        && this->sipCause_ == nullptr && this->startTime_ == nullptr && this->status_ == nullptr && this->statusCode_ == nullptr && this->tagNames_ == nullptr
        && this->tags_ == nullptr && this->totalDuration_ == nullptr && this->uniqueId_ == nullptr && this->xnumber_ == nullptr; };
        ...
        inline CdrOb& setCustomerRingingTime(int64_t customerRingingTime) { DARABONBA_PTR_SET_VALUE(customerRingingTime_, customerRingingTime) };
        ...
        inline CdrOb& setEndReason(string endReason) { DARABONBA_PTR_SET_VALUE(endReason_, endReason) };
        ...
        inline CdrOb& setEvaluation(int64_t evaluation) { DARABONBA_PTR_SET_VALUE(evaluation_, evaluation) };
        ...
        inline CdrOb& setHotline(string hotline) { DARABONBA_PTR_SET_VALUE(hotline_, hotline) };
        ...
        inline         const Darabonba::Json & getInvestigation() const { DARABONBA_GET(investigation_) };
        Darabonba::Json & getInvestigation() { DARABONBA_GET(investigation_) };
        inline CdrOb& setInvestigation(const Darabonba::Json & investigation) { DARABONBA_SET_VALUE(investigation_, investigation) };
        inline CdrOb& setInvestigation(Darabonba::Json && investigation) { DARABONBA_SET_RVALUE(investigation_, investigation) };
        ...
        inline CdrOb& setIvrName(string ivrName) { DARABONBA_PTR_SET_VALUE(ivrName_, ivrName) };
        ...
        inline CdrOb& setMark(int64_t mark) { DARABONBA_PTR_SET_VALUE(mark_, mark) };
        ...
        inline CdrOb& setSipCause(string sipCause) { DARABONBA_PTR_SET_VALUE(sipCause_, sipCause) };
        ...
        inline CdrOb& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
        ...
        inline CdrOb& setStatusCode(string statusCode) { DARABONBA_PTR_SET_VALUE(statusCode_, statusCode) };
        ...
        inline CdrOb& setTags(const vector<string> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
        inline CdrOb& setTags(vector<string> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
        ...
        inline CdrOb& setUniqueId(string uniqueId) { DARABONBA_PTR_SET_VALUE(uniqueId_, uniqueId) };
      ...
      inline const Data::CdrOb & getCdrOb() const { DARABONBA_PTR_GET_CONST(cdrOb_, Data::CdrOb) };
      inline Data::CdrOb getCdrOb() { DARABONBA_PTR_GET(cdrOb_, Data::CdrOb) };
      inline Data& setCdrOb(const Data::CdrOb & cdrOb) { DARABONBA_PTR_SET_VALUE(cdrOb_, cdrOb) };
      inline Data& setCdrOb(Data::CdrOb && cdrOb) { DARABONBA_PTR_SET_RVALUE(cdrOb_, cdrOb) };
    ...
    inline ClinkDescribeCdrObResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ClinkDescribeCdrObResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ClinkDescribeCdrObResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ClinkDescribeCdrObResponseBody::Data) };
    inline ClinkDescribeCdrObResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ClinkDescribeCdrObResponseBody::Data) };
    inline ClinkDescribeCdrObResponseBody& setData(const ClinkDescribeCdrObResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ClinkDescribeCdrObResponseBody& setData(ClinkDescribeCdrObResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ClinkDescribeCdrObResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ClinkDescribeCdrObResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> accessDeniedDetail_ {};
    shared_ptr<string> code_ {};
    shared_ptr<ClinkDescribeCdrObResponseBody::Data> data_ {};
