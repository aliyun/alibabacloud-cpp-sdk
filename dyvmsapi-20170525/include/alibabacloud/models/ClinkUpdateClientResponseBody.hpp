...
#ifndef ALIBABACLOUD_MODELS_CLINKUPDATECLIENTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CLINKUPDATECLIENTRESPONSEBODY_HPP_
...
namespace Models
{
  class ClinkUpdateClientResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ClinkUpdateClientResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ClinkUpdateClientResponseBody& obj) { 
    ...
    ClinkUpdateClientResponseBody() = default ;
    ClinkUpdateClientResponseBody(const ClinkUpdateClientResponseBody &) = default ;
    ClinkUpdateClientResponseBody(ClinkUpdateClientResponseBody &&) = default ;
    ClinkUpdateClientResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ClinkUpdateClientResponseBody() = default ;
    ClinkUpdateClientResponseBody& operator=(const ClinkUpdateClientResponseBody &) = default ;
    ClinkUpdateClientResponseBody& operator=(ClinkUpdateClientResponseBody &&) = default ;
    ...
    inline ClinkUpdateClientResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ClinkUpdateClientResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ClinkUpdateClientResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ClinkUpdateClientResponseBody::Data) };
    inline ClinkUpdateClientResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ClinkUpdateClientResponseBody::Data) };
    inline ClinkUpdateClientResponseBody& setData(const ClinkUpdateClientResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ClinkUpdateClientResponseBody& setData(ClinkUpdateClientResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ClinkUpdateClientResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ClinkUpdateClientResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> accessDeniedDetail_ {};
    shared_ptr<string> code_ {};
    shared_ptr<ClinkUpdateClientResponseBody::Data> data_ {};
