...
#ifndef ALIBABACLOUD_MODELS_CLINKCREATEQUEUEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CLINKCREATEQUEUEREQUEST_HPP_
...
namespace Models
{
  class ClinkCreateQueueRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ClinkCreateQueueRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ClinkCreateQueueRequest& obj) { 
    ...
    ClinkCreateQueueRequest() = default ;
    ClinkCreateQueueRequest(const ClinkCreateQueueRequest &) = default ;
    ClinkCreateQueueRequest(ClinkCreateQueueRequest &&) = default ;
    ClinkCreateQueueRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ClinkCreateQueueRequest() = default ;
    ClinkCreateQueueRequest& operator=(const ClinkCreateQueueRequest &) = default ;
    ClinkCreateQueueRequest& operator=(ClinkCreateQueueRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->chatLocation_ == nullptr
        ...
        && this->name_ == nullptr && this->ownerId_ == nullptr && this->qno_ == nullptr && this->queueMembers_ == nullptr && this->queueTimeout_ == nullptr
    ...
    inline ClinkCreateQueueRequest& setChatLocation(int64_t chatLocation) { DARABONBA_PTR_SET_VALUE(chatLocation_, chatLocation) };
    ...
    inline ClinkCreateQueueRequest& setChatMaxWait(int64_t chatMaxWait) { DARABONBA_PTR_SET_VALUE(chatMaxWait_, chatMaxWait) };
    ...
    inline ClinkCreateQueueRequest& setChatStrategy(int64_t chatStrategy) { DARABONBA_PTR_SET_VALUE(chatStrategy_, chatStrategy) };
    ...
    inline ClinkCreateQueueRequest& setEnterpriseId(int64_t enterpriseId) { DARABONBA_PTR_SET_VALUE(enterpriseId_, enterpriseId) };
    ...
    inline ClinkCreateQueueRequest& setIbAllowed(int64_t ibAllowed) { DARABONBA_PTR_SET_VALUE(ibAllowed_, ibAllowed) };
    ...
    inline ClinkCreateQueueRequest& setJoinEmpty(int64_t joinEmpty) { DARABONBA_PTR_SET_VALUE(joinEmpty_, joinEmpty) };
    ...
    inline ClinkCreateQueueRequest& setMaxPauseClientFlag(int64_t maxPauseClientFlag) { DARABONBA_PTR_SET_VALUE(maxPauseClientFlag_, maxPauseClientFlag) };
    ...
    inline ClinkCreateQueueRequest& setMaxPauseClientType(int64_t maxPauseClientType) { DARABONBA_PTR_SET_VALUE(maxPauseClientType_, maxPauseClientType) };
    ...
    inline ClinkCreateQueueRequest& setMaxPauseClientValue(int64_t maxPauseClientValue) { DARABONBA_PTR_SET_VALUE(maxPauseClientValue_, maxPauseClientValue) };
    ...
    inline ClinkCreateQueueRequest& setMaxWait(int64_t maxWait) { DARABONBA_PTR_SET_VALUE(maxWait_, maxWait) };
    ...
    inline ClinkCreateQueueRequest& setMemberTimeout(int64_t memberTimeout) { DARABONBA_PTR_SET_VALUE(memberTimeout_, memberTimeout) };
    ...
    inline ClinkCreateQueueRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ClinkCreateQueueRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ClinkCreateQueueRequest& setQno(string qno) { DARABONBA_PTR_SET_VALUE(qno_, qno) };
    ...
    inline const vector<ClinkCreateQueueRequest::QueueMembers> & getQueueMembers() const { DARABONBA_PTR_GET_CONST(queueMembers_, vector<ClinkCreateQueueRequest::QueueMembers>) };
    inline vector<ClinkCreateQueueRequest::QueueMembers> getQueueMembers() { DARABONBA_PTR_GET(queueMembers_, vector<ClinkCreateQueueRequest::QueueMembers>) };
    inline ClinkCreateQueueRequest& setQueueMembers(const vector<ClinkCreateQueueRequest::QueueMembers> & queueMembers) { DARABONBA_PTR_SET_VALUE(queueMembers_, queueMembers) };
    inline ClinkCreateQueueRequest& setQueueMembers(vector<ClinkCreateQueueRequest::QueueMembers> && queueMembers) { DARABONBA_PTR_SET_RVALUE(queueMembers_, queueMembers) };
    ...
    inline ClinkCreateQueueRequest& setQueueTimeout(int64_t queueTimeout) { DARABONBA_PTR_SET_VALUE(queueTimeout_, queueTimeout) };
    ...
    inline ClinkCreateQueueRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline ClinkCreateQueueRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline ClinkCreateQueueRequest& setSayCno(int64_t sayCno) { DARABONBA_PTR_SET_VALUE(sayCno_, sayCno) };
    ...
    inline ClinkCreateQueueRequest& setServiceLevel(int64_t serviceLevel) { DARABONBA_PTR_SET_VALUE(serviceLevel_, serviceLevel) };
    ...
    inline ClinkCreateQueueRequest& setStrategy(int64_t strategy) { DARABONBA_PTR_SET_VALUE(strategy_, strategy) };
    ...
    inline ClinkCreateQueueRequest& setVipSupport(int64_t vipSupport) { DARABONBA_PTR_SET_VALUE(vipSupport_, vipSupport) };
    ...
    inline ClinkCreateQueueRequest& setWeight(int64_t weight) { DARABONBA_PTR_SET_VALUE(weight_, weight) };
    ...
    inline ClinkCreateQueueRequest& setWrapupTime(int64_t wrapupTime) { DARABONBA_PTR_SET_VALUE(wrapupTime_, wrapupTime) };
  ...
  protected:
    ...
    shared_ptr<vector<ClinkCreateQueueRequest::QueueMembers>> queueMembers_ {};
