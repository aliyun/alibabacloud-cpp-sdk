...
#ifndef ALIBABACLOUD_MODELS_CLOUDQUERYWEBCALLCDRRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CLOUDQUERYWEBCALLCDRRESPONSEBODY_HPP_
...
namespace Models
{
  class CloudQueryWebcallCdrResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CloudQueryWebcallCdrResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CloudQueryWebcallCdrResponseBody& obj) { 
    ...
    CloudQueryWebcallCdrResponseBody() = default ;
    CloudQueryWebcallCdrResponseBody(const CloudQueryWebcallCdrResponseBody &) = default ;
    CloudQueryWebcallCdrResponseBody(CloudQueryWebcallCdrResponseBody &&) = default ;
    CloudQueryWebcallCdrResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CloudQueryWebcallCdrResponseBody() = default ;
    CloudQueryWebcallCdrResponseBody& operator=(const CloudQueryWebcallCdrResponseBody &) = default ;
    CloudQueryWebcallCdrResponseBody& operator=(CloudQueryWebcallCdrResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->taskId_ == nullptr && this->totalDuration_ == nullptr && this->trunkGroupKey_ == nullptr && this->uniqueId_ == nullptr && this->waitDuration_ == nullptr; };
    ...
    inline CloudQueryWebcallCdrResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline CloudQueryWebcallCdrResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CloudQueryWebcallCdrResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CloudQueryWebcallCdrResponseBody::Data) };
    inline CloudQueryWebcallCdrResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CloudQueryWebcallCdrResponseBody::Data) };
    inline CloudQueryWebcallCdrResponseBody& setData(const CloudQueryWebcallCdrResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CloudQueryWebcallCdrResponseBody& setData(CloudQueryWebcallCdrResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CloudQueryWebcallCdrResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CloudQueryWebcallCdrResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> accessDeniedDetail_ {};
    shared_ptr<string> code_ {};
    shared_ptr<CloudQueryWebcallCdrResponseBody::Data> data_ {};
