...
#ifndef ALIBABACLOUD_MODELS_CLOUDQUERYTASKRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CLOUDQUERYTASKRESPONSEBODY_HPP_
...
namespace Models
{
  class CloudQueryTaskResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CloudQueryTaskResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CloudQueryTaskResponseBody& obj) { 
    ...
    CloudQueryTaskResponseBody() = default ;
    CloudQueryTaskResponseBody(const CloudQueryTaskResponseBody &) = default ;
    CloudQueryTaskResponseBody(CloudQueryTaskResponseBody &&) = default ;
    CloudQueryTaskResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CloudQueryTaskResponseBody() = default ;
    CloudQueryTaskResponseBody& operator=(const CloudQueryTaskResponseBody &) = default ;
    CloudQueryTaskResponseBody& operator=(CloudQueryTaskResponseBody &&) = default ;
    ...
    public:
      friend void to_json(Darabonba::Json& j, const Data& obj) { 
        DARABONBA_PTR_TO_JSON(TaskProperties, taskProperties_);
      };
      friend void from_json(const Darabonba::Json& j, Data& obj) { 
        DARABONBA_PTR_FROM_JSON(TaskProperties, taskProperties_);
      };
      Data() = default ;
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      class TaskProperties : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const TaskProperties& obj) { 
          ...
          DARABONBA_PTR_TO_JSON(StatusTriggerType, statusTriggerType_);
        ...
        friend void from_json(const Darabonba::Json& j, TaskProperties& obj) { 
          ...
          DARABONBA_PTR_FROM_JSON(StatusTriggerType, statusTriggerType_);
        ...
        TaskProperties(const TaskProperties &) = default ;
        TaskProperties(TaskProperties &&) = default ;
        TaskProperties(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~TaskProperties() = default ;
        TaskProperties& operator=(const TaskProperties &) = default ;
        TaskProperties& operator=(TaskProperties &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        virtual bool empty() const override { return this->agentGroup_ == nullptr
        && this->agentTimeout_ == nullptr && this->answerRate_ == nullptr && this->autoComplete_ == nullptr && this->autoStart_ == nullptr && this->autoStartDay_ == nullptr
        && this->autoStartTime_ == nullptr && this->autoStop_ == nullptr && this->autoStopDay_ == nullptr && this->autoStopTime_ == nullptr && this->autoTaskType_ == nullptr
        && this->autoTriggerTimeStrategy_ == nullptr && this->callGroupType_ == nullptr && this->callLimitStrategy_ == nullptr && this->callPriorityStrategy_ == nullptr && this->callRouteStrategy_ == nullptr
        && this->callStrategy_ == nullptr && this->callVariables_ == nullptr && this->clidProperty_ == nullptr && this->cnos_ == nullptr && this->concurrency_ == nullptr
        && this->createTime_ == nullptr && this->customerClidType_ == nullptr && this->customerClidWeight_ == nullptr && this->customerClidWeightFlag_ == nullptr && this->customerClids_ == nullptr
        && this->customerClidsCategory_ == nullptr && this->customerMoh_ == nullptr && this->customerTimeout_ == nullptr && this->customerVoice_ == nullptr && this->description_ == nullptr
        && this->enterpriseId_ == nullptr && this->forceEndFlag_ == nullptr && this->id_ == nullptr && this->isRewarm_ == nullptr && this->ivrId_ == nullptr
        && this->maxWaitTime_ == nullptr && this->minAvailableAgentCount_ == nullptr && this->name_ == nullptr && this->overCallLimitCnos_ == nullptr && this->overTime_ == nullptr
        && this->pauseDuration_ == nullptr && this->pauseTime_ == nullptr && this->predictAdjust_ == nullptr && this->quotiety_ == nullptr && this->retryStrategy_ == nullptr
        && this->retryStrategyOnlyToday_ == nullptr && this->retryStrategyTimeType_ == nullptr && this->startTime_ == nullptr && this->status_ == nullptr && this->statusDescription_ == nullptr
        && this->statusTriggerType_ == nullptr && this->timeStrategy_ == nullptr && this->type_ == nullptr && this->userFields_ == nullptr && this->warmUpDuration_ == nullptr
        ...
        inline TaskProperties& setAgentGroup(string agentGroup) { DARABONBA_PTR_SET_VALUE(agentGroup_, agentGroup) };
        ...
        inline TaskProperties& setAgentTimeout(int64_t agentTimeout) { DARABONBA_PTR_SET_VALUE(agentTimeout_, agentTimeout) };
        ...
        inline TaskProperties& setAnswerRate(int64_t answerRate) { DARABONBA_PTR_SET_VALUE(answerRate_, answerRate) };
        ...
        inline TaskProperties& setAutoComplete(int64_t autoComplete) { DARABONBA_PTR_SET_VALUE(autoComplete_, autoComplete) };
        ...
        inline TaskProperties& setAutoStart(int64_t autoStart) { DARABONBA_PTR_SET_VALUE(autoStart_, autoStart) };
        ...
        inline TaskProperties& setAutoStartDay(string autoStartDay) { DARABONBA_PTR_SET_VALUE(autoStartDay_, autoStartDay) };
        ...
        inline TaskProperties& setAutoStartTime(string autoStartTime) { DARABONBA_PTR_SET_VALUE(autoStartTime_, autoStartTime) };
        ...
        inline TaskProperties& setAutoStop(int64_t autoStop) { DARABONBA_PTR_SET_VALUE(autoStop_, autoStop) };
        ...
        inline TaskProperties& setAutoStopDay(string autoStopDay) { DARABONBA_PTR_SET_VALUE(autoStopDay_, autoStopDay) };
        ...
        inline TaskProperties& setAutoStopTime(string autoStopTime) { DARABONBA_PTR_SET_VALUE(autoStopTime_, autoStopTime) };
        ...
        inline TaskProperties& setAutoTaskType(int64_t autoTaskType) { DARABONBA_PTR_SET_VALUE(autoTaskType_, autoTaskType) };
        ...
        inline TaskProperties& setAutoTriggerTimeStrategy(string autoTriggerTimeStrategy) { DARABONBA_PTR_SET_VALUE(autoTriggerTimeStrategy_, autoTriggerTimeStrategy) };
        ...
        inline TaskProperties& setCallGroupType(int64_t callGroupType) { DARABONBA_PTR_SET_VALUE(callGroupType_, callGroupType) };
        ...
        inline TaskProperties& setCallLimitStrategy(string callLimitStrategy) { DARABONBA_PTR_SET_VALUE(callLimitStrategy_, callLimitStrategy) };
        ...
        inline TaskProperties& setCallPriorityStrategy(string callPriorityStrategy) { DARABONBA_PTR_SET_VALUE(callPriorityStrategy_, callPriorityStrategy) };
        ...
        inline TaskProperties& setCallRouteStrategy(int64_t callRouteStrategy) { DARABONBA_PTR_SET_VALUE(callRouteStrategy_, callRouteStrategy) };
        ...
        inline int64_t getCallStrategy() const { DARABONBA_PTR_GET_DEFAULT(callStrategy_, 0L) };
        inline TaskProperties& setCallStrategy(int64_t callStrategy) { DARABONBA_PTR_SET_VALUE(callStrategy_, callStrategy) };
        ...
        inline TaskProperties& setCallVariables(string callVariables) { DARABONBA_PTR_SET_VALUE(callVariables_, callVariables) };
        ...
        inline TaskProperties& setClidProperty(string clidProperty) { DARABONBA_PTR_SET_VALUE(clidProperty_, clidProperty) };
        ...
        inline TaskProperties& setCnos(string cnos) { DARABONBA_PTR_SET_VALUE(cnos_, cnos) };
        ...
        inline TaskProperties& setConcurrency(int64_t concurrency) { DARABONBA_PTR_SET_VALUE(concurrency_, concurrency) };
        ...
        inline TaskProperties& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
        ...
        inline TaskProperties& setCustomerClidType(int64_t customerClidType) { DARABONBA_PTR_SET_VALUE(customerClidType_, customerClidType) };
        ...
        inline TaskProperties& setCustomerClidWeight(string customerClidWeight) { DARABONBA_PTR_SET_VALUE(customerClidWeight_, customerClidWeight) };
        ...
        inline TaskProperties& setCustomerClidWeightFlag(int64_t customerClidWeightFlag) { DARABONBA_PTR_SET_VALUE(customerClidWeightFlag_, customerClidWeightFlag) };
        ...
        inline TaskProperties& setCustomerClids(string customerClids) { DARABONBA_PTR_SET_VALUE(customerClids_, customerClids) };
        ...
        inline TaskProperties& setCustomerClidsCategory(int64_t customerClidsCategory) { DARABONBA_PTR_SET_VALUE(customerClidsCategory_, customerClidsCategory) };
        ...
        inline TaskProperties& setCustomerMoh(string customerMoh) { DARABONBA_PTR_SET_VALUE(customerMoh_, customerMoh) };
        ...
        inline TaskProperties& setCustomerTimeout(int64_t customerTimeout) { DARABONBA_PTR_SET_VALUE(customerTimeout_, customerTimeout) };
        ...
        inline TaskProperties& setCustomerVoice(string customerVoice) { DARABONBA_PTR_SET_VALUE(customerVoice_, customerVoice) };
        ...
        inline TaskProperties& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
        ...
        inline TaskProperties& setEnterpriseId(string enterpriseId) { DARABONBA_PTR_SET_VALUE(enterpriseId_, enterpriseId) };
        ...
        inline TaskProperties& setForceEndFlag(int64_t forceEndFlag) { DARABONBA_PTR_SET_VALUE(forceEndFlag_, forceEndFlag) };
        ...
        inline TaskProperties& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
        ...
        inline TaskProperties& setIsRewarm(int64_t isRewarm) { DARABONBA_PTR_SET_VALUE(isRewarm_, isRewarm) };
        ...
        inline TaskProperties& setIvrId(int64_t ivrId) { DARABONBA_PTR_SET_VALUE(ivrId_, ivrId) };
        ...
        inline TaskProperties& setMaxWaitTime(int64_t maxWaitTime) { DARABONBA_PTR_SET_VALUE(maxWaitTime_, maxWaitTime) };
        ...
        inline TaskProperties& setMinAvailableAgentCount(int64_t minAvailableAgentCount) { DARABONBA_PTR_SET_VALUE(minAvailableAgentCount_, minAvailableAgentCount) };
        ...
        inline TaskProperties& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
        ...
        inline TaskProperties& setOverCallLimitCnos(string overCallLimitCnos) { DARABONBA_PTR_SET_VALUE(overCallLimitCnos_, overCallLimitCnos) };
        ...
        inline TaskProperties& setOverTime(string overTime) { DARABONBA_PTR_SET_VALUE(overTime_, overTime) };
        ...
        inline TaskProperties& setPauseDuration(int64_t pauseDuration) { DARABONBA_PTR_SET_VALUE(pauseDuration_, pauseDuration) };
        ...
        inline TaskProperties& setPauseTime(string pauseTime) { DARABONBA_PTR_SET_VALUE(pauseTime_, pauseTime) };
        ...
        inline TaskProperties& setPredictAdjust(int64_t predictAdjust) { DARABONBA_PTR_SET_VALUE(predictAdjust_, predictAdjust) };
        ...
        inline TaskProperties& setQuotiety(double quotiety) { DARABONBA_PTR_SET_VALUE(quotiety_, quotiety) };
        ...
        inline TaskProperties& setRetryStrategy(string retryStrategy) { DARABONBA_PTR_SET_VALUE(retryStrategy_, retryStrategy) };
        ...
        inline TaskProperties& setRetryStrategyOnlyToday(int64_t retryStrategyOnlyToday) { DARABONBA_PTR_SET_VALUE(retryStrategyOnlyToday_, retryStrategyOnlyToday) };
        ...
        inline TaskProperties& setRetryStrategyTimeType(int64_t retryStrategyTimeType) { DARABONBA_PTR_SET_VALUE(retryStrategyTimeType_, retryStrategyTimeType) };
        ...
        inline TaskProperties& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
        ...
        inline TaskProperties& setStatus(int64_t status) { DARABONBA_PTR_SET_VALUE(status_, status) };
        ...
        inline TaskProperties& setStatusDescription(string statusDescription) { DARABONBA_PTR_SET_VALUE(statusDescription_, statusDescription) };


        // statusTriggerType Field Functions 
        bool hasStatusTriggerType() const { return this->statusTriggerType_ != nullptr;};
        void deleteStatusTriggerType() { this->statusTriggerType_ = nullptr;};
        inline int64_t getStatusTriggerType() const { DARABONBA_PTR_GET_DEFAULT(statusTriggerType_, 0L) };
        inline TaskProperties& setStatusTriggerType(int64_t statusTriggerType) { DARABONBA_PTR_SET_VALUE(statusTriggerType_, statusTriggerType) };
        ...
        inline TaskProperties& setTimeStrategy(string timeStrategy) { DARABONBA_PTR_SET_VALUE(timeStrategy_, timeStrategy) };
        ...
        inline TaskProperties& setType(int64_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
        ...
        inline TaskProperties& setUserFields(string userFields) { DARABONBA_PTR_SET_VALUE(userFields_, userFields) };
        ...
        inline TaskProperties& setWarmUpDuration(int64_t warmUpDuration) { DARABONBA_PTR_SET_VALUE(warmUpDuration_, warmUpDuration) };
        ...
        inline TaskProperties& setWrapup(int64_t wrapup) { DARABONBA_PTR_SET_VALUE(wrapup_, wrapup) };
      ...
      protected:
        ...
        shared_ptr<int64_t> callStrategy_ {};
        // 座席通道变量
        ...
        shared_ptr<int64_t> statusTriggerType_ {};
      ...
      virtual bool empty() const override { return this->taskProperties_ == nullptr; };
      // taskProperties Field Functions 
      bool hasTaskProperties() const { return this->taskProperties_ != nullptr;};
      void deleteTaskProperties() { this->taskProperties_ = nullptr;};
      inline const vector<Data::TaskProperties> & getTaskProperties() const { DARABONBA_PTR_GET_CONST(taskProperties_, vector<Data::TaskProperties>) };
      inline vector<Data::TaskProperties> getTaskProperties() { DARABONBA_PTR_GET(taskProperties_, vector<Data::TaskProperties>) };
      inline Data& setTaskProperties(const vector<Data::TaskProperties> & taskProperties) { DARABONBA_PTR_SET_VALUE(taskProperties_, taskProperties) };
      inline Data& setTaskProperties(vector<Data::TaskProperties> && taskProperties) { DARABONBA_PTR_SET_RVALUE(taskProperties_, taskProperties) };


    protected:
      shared_ptr<vector<Data::TaskProperties>> taskProperties_ {};
    };
    ...
    inline CloudQueryTaskResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline CloudQueryTaskResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CloudQueryTaskResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CloudQueryTaskResponseBody::Data) };
    inline CloudQueryTaskResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CloudQueryTaskResponseBody::Data) };
    inline CloudQueryTaskResponseBody& setData(const CloudQueryTaskResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CloudQueryTaskResponseBody& setData(CloudQueryTaskResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CloudQueryTaskResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CloudQueryTaskResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> accessDeniedDetail_ {};
    shared_ptr<string> code_ {};
    shared_ptr<CloudQueryTaskResponseBody::Data> data_ {};
