...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessType_ == nullptr
        && this->ownerId_ == nullptr && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->voiceCodes_ == nullptr; };
    ...
    inline string getVoiceCodes() const { DARABONBA_PTR_GET_DEFAULT(voiceCodes_, "") };
