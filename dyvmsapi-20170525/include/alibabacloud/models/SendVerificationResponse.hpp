...
namespace Models
{
  ...
  public:
    ...
    inline const SendVerificationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendVerificationResponseBody) };
    inline SendVerificationResponseBody getBody() { DARABONBA_PTR_GET(body_, SendVerificationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendVerificationResponseBody> body_ {};
  };
