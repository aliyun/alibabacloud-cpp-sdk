...
namespace Models
{
  ...
  public:
    ...
    inline const ListCallTaskDetailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListCallTaskDetailResponseBody) };
    inline ListCallTaskDetailResponseBody body() { DARABONBA_PTR_GET(body_, ListCallTaskDetailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListCallTaskDetailResponseBody> body_ = nullptr;
  };
