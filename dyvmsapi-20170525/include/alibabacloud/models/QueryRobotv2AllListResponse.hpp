...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRobotv2AllListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryRobotv2AllListResponseBody) };
    inline QueryRobotv2AllListResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryRobotv2AllListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryRobotv2AllListResponseBody> body_ {};
  };
