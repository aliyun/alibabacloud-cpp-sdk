...
#ifndef ALIBABACLOUD_MODELS_CLINKCREATECLIENTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CLINKCREATECLIENTREQUEST_HPP_
...
namespace Models
{
  class ClinkCreateClientRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ClinkCreateClientRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ClinkCreateClientRequest& obj) { 
    ...
    ClinkCreateClientRequest() = default ;
    ClinkCreateClientRequest(const ClinkCreateClientRequest &) = default ;
    ClinkCreateClientRequest(ClinkCreateClientRequest &&) = default ;
    ClinkCreateClientRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ClinkCreateClientRequest() = default ;
    ClinkCreateClientRequest& operator=(const ClinkCreateClientRequest &) = default ;
    ClinkCreateClientRequest& operator=(ClinkCreateClientRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->active_ == nullptr
        ...
        && this->pauseLogin_ == nullptr && this->permission_ == nullptr && this->qnos_ == nullptr && this->recurrentselectionType_ == nullptr && this->recurrentselectionValue_ == nullptr
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->role_ == nullptr && this->serveArea_ == nullptr && this->type_ == nullptr
    ...
    inline ClinkCreateClientRequest& setActive(int64_t active) { DARABONBA_PTR_SET_VALUE(active_, active) };
    ...
    inline ClinkCreateClientRequest& setAreaCode(string areaCode) { DARABONBA_PTR_SET_VALUE(areaCode_, areaCode) };
    ...
    void deleteAssignType() { this->assignType_ = nullptr;};
    inline int64_t getAssignType() const { DARABONBA_PTR_GET_DEFAULT(assignType_, 0L) };
    inline ClinkCreateClientRequest& setAssignType(int64_t assignType) { DARABONBA_PTR_SET_VALUE(assignType_, assignType) };
    ...
    inline ClinkCreateClientRequest& setClid(const vector<string> & clid) { DARABONBA_PTR_SET_VALUE(clid_, clid) };
    inline ClinkCreateClientRequest& setClid(vector<string> && clid) { DARABONBA_PTR_SET_RVALUE(clid_, clid) };


    // clidArea Field Functions 
    bool hasClidArea() const { return this->clidArea_ != nullptr;};
    void deleteClidArea() { this->clidArea_ = nullptr;};
    inline const vector<ClinkCreateClientRequest::ClidArea> & getClidArea() const { DARABONBA_PTR_GET_CONST(clidArea_, vector<ClinkCreateClientRequest::ClidArea>) };
    inline vector<ClinkCreateClientRequest::ClidArea> getClidArea() { DARABONBA_PTR_GET(clidArea_, vector<ClinkCreateClientRequest::ClidArea>) };
    inline ClinkCreateClientRequest& setClidArea(const vector<ClinkCreateClientRequest::ClidArea> & clidArea) { DARABONBA_PTR_SET_VALUE(clidArea_, clidArea) };
    inline ClinkCreateClientRequest& setClidArea(vector<ClinkCreateClientRequest::ClidArea> && clidArea) { DARABONBA_PTR_SET_RVALUE(clidArea_, clidArea) };
    ...
    inline ClinkCreateClientRequest& setClidDefault(const vector<string> & clidDefault) { DARABONBA_PTR_SET_VALUE(clidDefault_, clidDefault) };
    inline ClinkCreateClientRequest& setClidDefault(vector<string> && clidDefault) { DARABONBA_PTR_SET_RVALUE(clidDefault_, clidDefault) };
    ...
    inline ClinkCreateClientRequest& setClidRule(int64_t clidRule) { DARABONBA_PTR_SET_VALUE(clidRule_, clidRule) };
    ...
    inline ClinkCreateClientRequest& setClidType(int64_t clidType) { DARABONBA_PTR_SET_VALUE(clidType_, clidType) };
    ...
    inline ClinkCreateClientRequest& setCloudNumberEnabled(int64_t cloudNumberEnabled) { DARABONBA_PTR_SET_VALUE(cloudNumberEnabled_, cloudNumberEnabled) };
    ...
    inline ClinkCreateClientRequest& setCloudNumberModes(const vector<int64_t> & cloudNumberModes) { DARABONBA_PTR_SET_VALUE(cloudNumberModes_, cloudNumberModes) };
    inline ClinkCreateClientRequest& setCloudNumberModes(vector<int64_t> && cloudNumberModes) { DARABONBA_PTR_SET_RVALUE(cloudNumberModes_, cloudNumberModes) };
    ...
    inline ClinkCreateClientRequest& setCno(int64_t cno) { DARABONBA_PTR_SET_VALUE(cno_, cno) };
    ...
    inline ClinkCreateClientRequest& setCrmId(int64_t crmId) { DARABONBA_PTR_SET_VALUE(crmId_, crmId) };
    ...
    inline ClinkCreateClientRequest& setDynamicTelGroupIdDefault(int64_t dynamicTelGroupIdDefault) { DARABONBA_PTR_SET_VALUE(dynamicTelGroupIdDefault_, dynamicTelGroupIdDefault) };
    ...
    void deleteDynamicTelGroupName() { this->dynamicTelGroupName_ = nullptr;};
    inline string getDynamicTelGroupName() const { DARABONBA_PTR_GET_DEFAULT(dynamicTelGroupName_, "") };
    inline ClinkCreateClientRequest& setDynamicTelGroupName(string dynamicTelGroupName) { DARABONBA_PTR_SET_VALUE(dynamicTelGroupName_, dynamicTelGroupName) };
    ...
    inline ClinkCreateClientRequest& setEnterpriseId(int64_t enterpriseId) { DARABONBA_PTR_SET_VALUE(enterpriseId_, enterpriseId) };
    ...
    inline ClinkCreateClientRequest& setHiddenTel(int64_t hiddenTel) { DARABONBA_PTR_SET_VALUE(hiddenTel_, hiddenTel) };
    ...
    inline ClinkCreateClientRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ClinkCreateClientRequest& setObClidDefaultType(int64_t obClidDefaultType) { DARABONBA_PTR_SET_VALUE(obClidDefaultType_, obClidDefaultType) };
    ...
    inline ClinkCreateClientRequest& setObHangupSms(int64_t obHangupSms) { DARABONBA_PTR_SET_VALUE(obHangupSms_, obHangupSms) };
    ...
    inline ClinkCreateClientRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ClinkCreateClientRequest& setPassword(string password) { DARABONBA_PTR_SET_VALUE(password_, password) };
    ...
    inline ClinkCreateClientRequest& setPauseLogin(int64_t pauseLogin) { DARABONBA_PTR_SET_VALUE(pauseLogin_, pauseLogin) };
    ...
    inline const ClinkCreateClientRequest::Permission & getPermission() const { DARABONBA_PTR_GET_CONST(permission_, ClinkCreateClientRequest::Permission) };
    inline ClinkCreateClientRequest::Permission getPermission() { DARABONBA_PTR_GET(permission_, ClinkCreateClientRequest::Permission) };
    inline ClinkCreateClientRequest& setPermission(const ClinkCreateClientRequest::Permission & permission) { DARABONBA_PTR_SET_VALUE(permission_, permission) };
    inline ClinkCreateClientRequest& setPermission(ClinkCreateClientRequest::Permission && permission) { DARABONBA_PTR_SET_RVALUE(permission_, permission) };
    ...
    inline ClinkCreateClientRequest& setQnos(const vector<string> & qnos) { DARABONBA_PTR_SET_VALUE(qnos_, qnos) };
    inline ClinkCreateClientRequest& setQnos(vector<string> && qnos) { DARABONBA_PTR_SET_RVALUE(qnos_, qnos) };
    ...
    inline ClinkCreateClientRequest& setRecurrentselectionType(int64_t recurrentselectionType) { DARABONBA_PTR_SET_VALUE(recurrentselectionType_, recurrentselectionType) };
    ...
    inline ClinkCreateClientRequest& setRecurrentselectionValue(int64_t recurrentselectionValue) { DARABONBA_PTR_SET_VALUE(recurrentselectionValue_, recurrentselectionValue) };
    ...
    inline ClinkCreateClientRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline ClinkCreateClientRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline ClinkCreateClientRequest& setRole(int64_t role) { DARABONBA_PTR_SET_VALUE(role_, role) };
    ...
    inline ClinkCreateClientRequest& setServeArea(const vector<string> & serveArea) { DARABONBA_PTR_SET_VALUE(serveArea_, serveArea) };
    inline ClinkCreateClientRequest& setServeArea(vector<string> && serveArea) { DARABONBA_PTR_SET_RVALUE(serveArea_, serveArea) };
    ...
    inline ClinkCreateClientRequest& setType(int64_t type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline ClinkCreateClientRequest& setWechatMiniProgramRtc(int64_t wechatMiniProgramRtc) { DARABONBA_PTR_SET_VALUE(wechatMiniProgramRtc_, wechatMiniProgramRtc) };
    ...
    inline ClinkCreateClientRequest& setWrapupTime(int64_t wrapupTime) { DARABONBA_PTR_SET_VALUE(wrapupTime_, wrapupTime) };
  ...
  protected:
    ...
    shared_ptr<vector<ClinkCreateClientRequest::ClidArea>> clidArea_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<ClinkCreateClientRequest::Permission> permission_ {};
    // 所属队列号集合
