...
namespace Models
{
  ...
  public:
    ...
    inline const BatchRobotSmartCallResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, BatchRobotSmartCallResponseBody) };
    inline BatchRobotSmartCallResponseBody body() { DARABONBA_PTR_GET(body_, BatchRobotSmartCallResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<BatchRobotSmartCallResponseBody> body_ = nullptr;
  };
