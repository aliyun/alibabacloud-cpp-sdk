...
#ifndef ALIBABACLOUD_MODELS_CLINKLISTCDRIBSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CLINKLISTCDRIBSRESPONSEBODY_HPP_
...
namespace Models
{
  class ClinkListCdrIbsResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ClinkListCdrIbsResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ClinkListCdrIbsResponseBody& obj) { 
    ...
    ClinkListCdrIbsResponseBody() = default ;
    ClinkListCdrIbsResponseBody(const ClinkListCdrIbsResponseBody &) = default ;
    ClinkListCdrIbsResponseBody(ClinkListCdrIbsResponseBody &&) = default ;
    ClinkListCdrIbsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ClinkListCdrIbsResponseBody() = default ;
    ClinkListCdrIbsResponseBody& operator=(const ClinkListCdrIbsResponseBody &) = default ;
    ClinkListCdrIbsResponseBody& operator=(ClinkListCdrIbsResponseBody &&) = default ;
    ...
    public:
      friend void to_json(Darabonba::Json& j, const Data& obj) { 
        DARABONBA_PTR_TO_JSON(CdrIbs, cdrIbs_);
      ...
      friend void from_json(const Darabonba::Json& j, Data& obj) { 
        DARABONBA_PTR_FROM_JSON(CdrIbs, cdrIbs_);
      ...
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      class CdrIbs : public Darabonba::Model {
      public:
        friend void to_json(Darabonba::Json& j, const CdrIbs& obj) { 
        ...
        friend void from_json(const Darabonba::Json& j, CdrIbs& obj) { 
        ...
        CdrIbs() = default ;
        CdrIbs(const CdrIbs &) = default ;
        CdrIbs(CdrIbs &&) = default ;
        CdrIbs(const Darabonba::Json & obj) { from_json(obj, *this); };
        virtual ~CdrIbs() = default ;
        CdrIbs& operator=(const CdrIbs &) = default ;
        CdrIbs& operator=(CdrIbs &&) = default ;
        virtual void validate() const override {
        };
        virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
        virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
        ...
        && this->firstJoinQueueTime_ == nullptr && this->hotline_ == nullptr && this->hotlineName_ == nullptr && this->ibRingingDuration_ == nullptr && this->ibWaitDuration_ == nullptr
        && this->ivrName_ == nullptr && this->joinQueueTime_ == nullptr && this->leaveQueueTime_ == nullptr && this->mark_ == nullptr && this->markData_ == nullptr
        && this->qname_ == nullptr && this->qno_ == nullptr && this->queueAnswerInTime_ == nullptr && this->recordFile_ == nullptr && this->sayVoiceDuration_ == nullptr
        && this->sipCause_ == nullptr && this->startTime_ == nullptr && this->status_ == nullptr && this->statusCode_ == nullptr && this->tagNames_ == nullptr
        && this->tags_ == nullptr && this->totalDuration_ == nullptr && this->uniqueId_ == nullptr; };
        ...
        inline CdrIbs& setBridgeDuration(int64_t bridgeDuration) { DARABONBA_PTR_SET_VALUE(bridgeDuration_, bridgeDuration) };
        ...
        inline CdrIbs& setBridgeTime(int64_t bridgeTime) { DARABONBA_PTR_SET_VALUE(bridgeTime_, bridgeTime) };
        ...
        inline CdrIbs& setCallId(string callId) { DARABONBA_PTR_SET_VALUE(callId_, callId) };
        ...
        inline CdrIbs& setCallType(string callType) { DARABONBA_PTR_SET_VALUE(callType_, callType) };
        ...
        inline CdrIbs& setClientName(string clientName) { DARABONBA_PTR_SET_VALUE(clientName_, clientName) };
        ...
        inline CdrIbs& setClientNumber(string clientNumber) { DARABONBA_PTR_SET_VALUE(clientNumber_, clientNumber) };
        ...
        inline CdrIbs& setClientOffhookTime(int64_t clientOffhookTime) { DARABONBA_PTR_SET_VALUE(clientOffhookTime_, clientOffhookTime) };
        ...
        inline CdrIbs& setClientRingingTime(int64_t clientRingingTime) { DARABONBA_PTR_SET_VALUE(clientRingingTime_, clientRingingTime) };
        ...
        inline CdrIbs& setCno(string cno) { DARABONBA_PTR_SET_VALUE(cno_, cno) };
        ...
        inline CdrIbs& setCustomerCity(string customerCity) { DARABONBA_PTR_SET_VALUE(customerCity_, customerCity) };
        ...
        inline CdrIbs& setCustomerNumber(string customerNumber) { DARABONBA_PTR_SET_VALUE(customerNumber_, customerNumber) };
        ...
        inline CdrIbs& setCustomerNumberEncrypt(string customerNumberEncrypt) { DARABONBA_PTR_SET_VALUE(customerNumberEncrypt_, customerNumberEncrypt) };
        ...
        inline CdrIbs& setCustomerProvince(string customerProvince) { DARABONBA_PTR_SET_VALUE(customerProvince_, customerProvince) };
        ...
        inline CdrIbs& setEndReason(string endReason) { DARABONBA_PTR_SET_VALUE(endReason_, endReason) };
        ...
        inline CdrIbs& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
        ...
        inline CdrIbs& setEvaluation(int64_t evaluation) { DARABONBA_PTR_SET_VALUE(evaluation_, evaluation) };
        ...
        inline CdrIbs& setFirstJoinQueueTime(int64_t firstJoinQueueTime) { DARABONBA_PTR_SET_VALUE(firstJoinQueueTime_, firstJoinQueueTime) };
        ...
        inline CdrIbs& setHotline(string hotline) { DARABONBA_PTR_SET_VALUE(hotline_, hotline) };
        ...
        inline CdrIbs& setHotlineName(string hotlineName) { DARABONBA_PTR_SET_VALUE(hotlineName_, hotlineName) };
        ...
        inline CdrIbs& setIbRingingDuration(int64_t ibRingingDuration) { DARABONBA_PTR_SET_VALUE(ibRingingDuration_, ibRingingDuration) };
        ...
        inline CdrIbs& setIbWaitDuration(int64_t ibWaitDuration) { DARABONBA_PTR_SET_VALUE(ibWaitDuration_, ibWaitDuration) };
        ...
        inline CdrIbs& setIvrName(string ivrName) { DARABONBA_PTR_SET_VALUE(ivrName_, ivrName) };
        ...
        inline CdrIbs& setJoinQueueTime(int64_t joinQueueTime) { DARABONBA_PTR_SET_VALUE(joinQueueTime_, joinQueueTime) };
        ...
        inline CdrIbs& setLeaveQueueTime(int64_t leaveQueueTime) { DARABONBA_PTR_SET_VALUE(leaveQueueTime_, leaveQueueTime) };
        ...
        inline CdrIbs& setMark(int64_t mark) { DARABONBA_PTR_SET_VALUE(mark_, mark) };
        ...
        inline CdrIbs& setMarkData(string markData) { DARABONBA_PTR_SET_VALUE(markData_, markData) };
        ...
        inline CdrIbs& setQname(string qname) { DARABONBA_PTR_SET_VALUE(qname_, qname) };
        ...
        inline CdrIbs& setQno(string qno) { DARABONBA_PTR_SET_VALUE(qno_, qno) };
        ...
        inline CdrIbs& setQueueAnswerInTime(int64_t queueAnswerInTime) { DARABONBA_PTR_SET_VALUE(queueAnswerInTime_, queueAnswerInTime) };
        ...
        inline CdrIbs& setRecordFile(string recordFile) { DARABONBA_PTR_SET_VALUE(recordFile_, recordFile) };
        ...
        inline CdrIbs& setSayVoiceDuration(int64_t sayVoiceDuration) { DARABONBA_PTR_SET_VALUE(sayVoiceDuration_, sayVoiceDuration) };
        ...
        inline CdrIbs& setSipCause(string sipCause) { DARABONBA_PTR_SET_VALUE(sipCause_, sipCause) };
        ...
        inline CdrIbs& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
        ...
        inline CdrIbs& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
        ...
        inline CdrIbs& setStatusCode(string statusCode) { DARABONBA_PTR_SET_VALUE(statusCode_, statusCode) };
        ...
        inline CdrIbs& setTagNames(const vector<string> & tagNames) { DARABONBA_PTR_SET_VALUE(tagNames_, tagNames) };
        inline CdrIbs& setTagNames(vector<string> && tagNames) { DARABONBA_PTR_SET_RVALUE(tagNames_, tagNames) };
        ...
        inline CdrIbs& setTags(const vector<string> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
        inline CdrIbs& setTags(vector<string> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
        ...
        inline CdrIbs& setTotalDuration(int64_t totalDuration) { DARABONBA_PTR_SET_VALUE(totalDuration_, totalDuration) };
        ...
        inline CdrIbs& setUniqueId(string uniqueId) { DARABONBA_PTR_SET_VALUE(uniqueId_, uniqueId) };
      ...
      virtual bool empty() const override { return this->cdrIbs_ == nullptr
        && this->clinkRequestId_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr && this->totalCount_ == nullptr; };
      // cdrIbs Field Functions 
      bool hasCdrIbs() const { return this->cdrIbs_ != nullptr;};
      void deleteCdrIbs() { this->cdrIbs_ = nullptr;};
      inline const vector<Data::CdrIbs> & getCdrIbs() const { DARABONBA_PTR_GET_CONST(cdrIbs_, vector<Data::CdrIbs>) };
      inline vector<Data::CdrIbs> getCdrIbs() { DARABONBA_PTR_GET(cdrIbs_, vector<Data::CdrIbs>) };
      inline Data& setCdrIbs(const vector<Data::CdrIbs> & cdrIbs) { DARABONBA_PTR_SET_VALUE(cdrIbs_, cdrIbs) };
      inline Data& setCdrIbs(vector<Data::CdrIbs> && cdrIbs) { DARABONBA_PTR_SET_RVALUE(cdrIbs_, cdrIbs) };
    ...
    protected:
      // [呼入通话记录列表] #呼入通话记录列表
      shared_ptr<vector<Data::CdrIbs>> cdrIbs_ {};
      // 请求 id
    ...
    inline ClinkListCdrIbsResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ClinkListCdrIbsResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ClinkListCdrIbsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ClinkListCdrIbsResponseBody::Data) };
    inline ClinkListCdrIbsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ClinkListCdrIbsResponseBody::Data) };
    inline ClinkListCdrIbsResponseBody& setData(const ClinkListCdrIbsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ClinkListCdrIbsResponseBody& setData(ClinkListCdrIbsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ClinkListCdrIbsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ClinkListCdrIbsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


  protected:
    shared_ptr<string> accessDeniedDetail_ {};
    shared_ptr<string> code_ {};
    shared_ptr<ClinkListCdrIbsResponseBody::Data> data_ {};
