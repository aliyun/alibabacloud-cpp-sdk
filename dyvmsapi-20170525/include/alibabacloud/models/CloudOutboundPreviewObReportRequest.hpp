...
#ifndef ALIBABACLOUD_MODELS_CLOUDOUTBOUNDPREVIEWOBREPORTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CLOUDOUTBOUNDPREVIEWOBREPORTREQUEST_HPP_
...
namespace Models
{
  class CloudOutboundPreviewObReportRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CloudOutboundPreviewObReportRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CloudOutboundPreviewObReportRequest& obj) { 
    ...
    CloudOutboundPreviewObReportRequest() = default ;
    CloudOutboundPreviewObReportRequest(const CloudOutboundPreviewObReportRequest &) = default ;
    CloudOutboundPreviewObReportRequest(CloudOutboundPreviewObReportRequest &&) = default ;
    CloudOutboundPreviewObReportRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CloudOutboundPreviewObReportRequest() = default ;
    CloudOutboundPreviewObReportRequest& operator=(const CloudOutboundPreviewObReportRequest &) = default ;
    CloudOutboundPreviewObReportRequest& operator=(CloudOutboundPreviewObReportRequest &&) = default ;
    ...
    inline CloudOutboundPreviewObReportRequest& setCnos(string cnos) { DARABONBA_PTR_SET_VALUE(cnos_, cnos) };
    ...
    inline CloudOutboundPreviewObReportRequest& setEndHour(int64_t endHour) { DARABONBA_PTR_SET_VALUE(endHour_, endHour) };
    ...
    inline CloudOutboundPreviewObReportRequest& setEndTime(string endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline CloudOutboundPreviewObReportRequest& setEnterpriseId(int64_t enterpriseId) { DARABONBA_PTR_SET_VALUE(enterpriseId_, enterpriseId) };
    ...
    inline CloudOutboundPreviewObReportRequest& setLimit(int64_t limit) { DARABONBA_PTR_SET_VALUE(limit_, limit) };
    ...
    inline CloudOutboundPreviewObReportRequest& setStart(int64_t start) { DARABONBA_PTR_SET_VALUE(start_, start) };
    ...
    inline CloudOutboundPreviewObReportRequest& setStartHour(int64_t startHour) { DARABONBA_PTR_SET_VALUE(startHour_, startHour) };
    ...
    inline CloudOutboundPreviewObReportRequest& setStartTime(string startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline CloudOutboundPreviewObReportRequest& setStatisticMethod(int64_t statisticMethod) { DARABONBA_PTR_SET_VALUE(statisticMethod_, statisticMethod) };
    ...
    inline CloudOutboundPreviewObReportRequest& setTimeRangeType(int64_t timeRangeType) { DARABONBA_PTR_SET_VALUE(timeRangeType_, timeRangeType) };
