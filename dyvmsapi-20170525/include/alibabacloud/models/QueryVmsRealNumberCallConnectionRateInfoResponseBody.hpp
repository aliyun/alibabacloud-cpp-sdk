...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessDeniedDetail_ == nullptr
        && return this->code_ == nullptr && return this->message_ == nullptr && return this->model_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const QueryVmsRealNumberCallConnectionRateInfoResponseBodyModel & model() const { DARABONBA_PTR_GET_CONST(model_, QueryVmsRealNumberCallConnectionRateInfoResponseBodyModel) };
    inline QueryVmsRealNumberCallConnectionRateInfoResponseBodyModel model() { DARABONBA_PTR_GET(model_, QueryVmsRealNumberCallConnectionRateInfoResponseBodyModel) };
    inline QueryVmsRealNumberCallConnectionRateInfoResponseBody& setModel(const QueryVmsRealNumberCallConnectionRateInfoResponseBodyModel & model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    inline QueryVmsRealNumberCallConnectionRateInfoResponseBody& setModel(QueryVmsRealNumberCallConnectionRateInfoResponseBodyModel && model) { DARABONBA_PTR_SET_RVALUE(model_, model) };
  ...
  protected:
    ...
    std::shared_ptr<QueryVmsRealNumberCallConnectionRateInfoResponseBodyModel> model_ = nullptr;
