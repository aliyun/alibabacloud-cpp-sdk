...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->calledNumber_ == nullptr
        && return this->id_ == nullptr && return this->ownerId_ == nullptr && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->ttsParam_ == nullptr
        && return this->ttsParamHead_ == nullptr; };
