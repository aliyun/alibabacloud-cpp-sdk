...
namespace Models
{
  ...
  public:
    ...
    inline const QueryRobotTaskCallDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, QueryRobotTaskCallDetailResponseBody) };
    inline QueryRobotTaskCallDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, QueryRobotTaskCallDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<QueryRobotTaskCallDetailResponseBody> body_ {};
  };
