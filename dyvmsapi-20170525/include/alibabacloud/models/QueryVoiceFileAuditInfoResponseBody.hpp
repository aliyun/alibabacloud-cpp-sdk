...
namespace Models
{
  ...
  public:
    ...
    inline const vector<QueryVoiceFileAuditInfoResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<QueryVoiceFileAuditInfoResponseBodyData>) };
    inline vector<QueryVoiceFileAuditInfoResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<QueryVoiceFileAuditInfoResponseBodyData>) };
    inline QueryVoiceFileAuditInfoResponseBody& setData(const vector<QueryVoiceFileAuditInfoResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryVoiceFileAuditInfoResponseBody& setData(vector<QueryVoiceFileAuditInfoResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryVoiceFileAuditInfoResponseBodyData>> data_ = nullptr;
