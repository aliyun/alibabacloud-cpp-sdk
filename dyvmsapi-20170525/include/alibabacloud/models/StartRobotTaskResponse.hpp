...
namespace Models
{
  ...
  public:
    ...
    inline const StartRobotTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartRobotTaskResponseBody) };
    inline StartRobotTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, StartRobotTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartRobotTaskResponseBody> body_ {};
  };
