...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->calledNumber_ == nullptr
        ...
        && this->resourceOwnerId_ == nullptr && this->speed_ == nullptr && this->ttsCode_ == nullptr && this->ttsParam_ == nullptr && this->volume_ == nullptr; };
    ...
    inline string getTtsCode() const { DARABONBA_PTR_GET_DEFAULT(ttsCode_, "") };
