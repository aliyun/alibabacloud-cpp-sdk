...
#ifndef ALIBABACLOUD_MODELS_CLINKUPDATECLIENTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CLINKUPDATECLIENTSHRINKREQUEST_HPP_
...
namespace Models
{
  class ClinkUpdateClientShrinkRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ClinkUpdateClientShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ClinkUpdateClientShrinkRequest& obj) { 
    ...
    ClinkUpdateClientShrinkRequest() = default ;
    ClinkUpdateClientShrinkRequest(const ClinkUpdateClientShrinkRequest &) = default ;
    ClinkUpdateClientShrinkRequest(ClinkUpdateClientShrinkRequest &&) = default ;
    ClinkUpdateClientShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ClinkUpdateClientShrinkRequest() = default ;
    ClinkUpdateClientShrinkRequest& operator=(const ClinkUpdateClientShrinkRequest &) = default ;
    ClinkUpdateClientShrinkRequest& operator=(ClinkUpdateClientShrinkRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->active_ == nullptr
        ...
        && this->ownerId_ == nullptr && this->password_ == nullptr && this->pauseLogin_ == nullptr && this->permissionShrink_ == nullptr && this->qnosShrink_ == nullptr
        ...
        && this->serveAreaShrink_ == nullptr && this->wechatMiniProgramRtc_ == nullptr && this->wrapupTime_ == nullptr; };
    // active Field Functions 
    bool hasActive() const { return this->active_ != nullptr;};
    void deleteActive() { this->active_ = nullptr;};
    inline int64_t getActive() const { DARABONBA_PTR_GET_DEFAULT(active_, 0L) };
    inline ClinkUpdateClientShrinkRequest& setActive(int64_t active) { DARABONBA_PTR_SET_VALUE(active_, active) };
    ...
    inline ClinkUpdateClientShrinkRequest& setAreaCode(string areaCode) { DARABONBA_PTR_SET_VALUE(areaCode_, areaCode) };
    ...
    inline ClinkUpdateClientShrinkRequest& setAssignType(int64_t assignType) { DARABONBA_PTR_SET_VALUE(assignType_, assignType) };
    ...
    inline ClinkUpdateClientShrinkRequest& setClidShrink(string clidShrink) { DARABONBA_PTR_SET_VALUE(clidShrink_, clidShrink) };
    ...
    inline ClinkUpdateClientShrinkRequest& setClidAreaShrink(string clidAreaShrink) { DARABONBA_PTR_SET_VALUE(clidAreaShrink_, clidAreaShrink) };
    ...
    inline ClinkUpdateClientShrinkRequest& setClidDefaultShrink(string clidDefaultShrink) { DARABONBA_PTR_SET_VALUE(clidDefaultShrink_, clidDefaultShrink) };
    ...
    inline ClinkUpdateClientShrinkRequest& setClidRule(int64_t clidRule) { DARABONBA_PTR_SET_VALUE(clidRule_, clidRule) };
    ...
    inline ClinkUpdateClientShrinkRequest& setClidType(int64_t clidType) { DARABONBA_PTR_SET_VALUE(clidType_, clidType) };
    ...
    inline ClinkUpdateClientShrinkRequest& setCloudNumberEnabled(int64_t cloudNumberEnabled) { DARABONBA_PTR_SET_VALUE(cloudNumberEnabled_, cloudNumberEnabled) };
    ...
    inline ClinkUpdateClientShrinkRequest& setCloudNumberModesShrink(string cloudNumberModesShrink) { DARABONBA_PTR_SET_VALUE(cloudNumberModesShrink_, cloudNumberModesShrink) };
    ...
    inline ClinkUpdateClientShrinkRequest& setCno(int64_t cno) { DARABONBA_PTR_SET_VALUE(cno_, cno) };
    ...
    inline ClinkUpdateClientShrinkRequest& setCrmId(int64_t crmId) { DARABONBA_PTR_SET_VALUE(crmId_, crmId) };
    ...
    inline ClinkUpdateClientShrinkRequest& setDynamicTelGroupIdDefault(int64_t dynamicTelGroupIdDefault) { DARABONBA_PTR_SET_VALUE(dynamicTelGroupIdDefault_, dynamicTelGroupIdDefault) };
    ...
    inline ClinkUpdateClientShrinkRequest& setDynamicTelGroupName(string dynamicTelGroupName) { DARABONBA_PTR_SET_VALUE(dynamicTelGroupName_, dynamicTelGroupName) };
    ...
    inline ClinkUpdateClientShrinkRequest& setEnterpriseId(int64_t enterpriseId) { DARABONBA_PTR_SET_VALUE(enterpriseId_, enterpriseId) };
    ...
    inline ClinkUpdateClientShrinkRequest& setHiddenTel(int64_t hiddenTel) { DARABONBA_PTR_SET_VALUE(hiddenTel_, hiddenTel) };
    ...
    inline ClinkUpdateClientShrinkRequest& setIbWrapupTime(int64_t ibWrapupTime) { DARABONBA_PTR_SET_VALUE(ibWrapupTime_, ibWrapupTime) };
    ...
    inline ClinkUpdateClientShrinkRequest& setIbWrapupType(int64_t ibWrapupType) { DARABONBA_PTR_SET_VALUE(ibWrapupType_, ibWrapupType) };
    ...
    inline ClinkUpdateClientShrinkRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ClinkUpdateClientShrinkRequest& setObClidDefaultType(int64_t obClidDefaultType) { DARABONBA_PTR_SET_VALUE(obClidDefaultType_, obClidDefaultType) };
    ...
    inline ClinkUpdateClientShrinkRequest& setObHangupSms(int64_t obHangupSms) { DARABONBA_PTR_SET_VALUE(obHangupSms_, obHangupSms) };
    ...
    inline ClinkUpdateClientShrinkRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline ClinkUpdateClientShrinkRequest& setPassword(string password) { DARABONBA_PTR_SET_VALUE(password_, password) };
    ...
    inline ClinkUpdateClientShrinkRequest& setPauseLogin(int64_t pauseLogin) { DARABONBA_PTR_SET_VALUE(pauseLogin_, pauseLogin) };
    ...
    inline ClinkUpdateClientShrinkRequest& setPermissionShrink(string permissionShrink) { DARABONBA_PTR_SET_VALUE(permissionShrink_, permissionShrink) };
    ...
    inline ClinkUpdateClientShrinkRequest& setQnosShrink(string qnosShrink) { DARABONBA_PTR_SET_VALUE(qnosShrink_, qnosShrink) };
    ...
    inline ClinkUpdateClientShrinkRequest& setRecurrentselectionType(int64_t recurrentselectionType) { DARABONBA_PTR_SET_VALUE(recurrentselectionType_, recurrentselectionType) };
    ...
    inline ClinkUpdateClientShrinkRequest& setRecurrentselectionValue(int64_t recurrentselectionValue) { DARABONBA_PTR_SET_VALUE(recurrentselectionValue_, recurrentselectionValue) };
    ...
    inline ClinkUpdateClientShrinkRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline ClinkUpdateClientShrinkRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline ClinkUpdateClientShrinkRequest& setRole(int64_t role) { DARABONBA_PTR_SET_VALUE(role_, role) };
    ...
    inline ClinkUpdateClientShrinkRequest& setServeAreaShrink(string serveAreaShrink) { DARABONBA_PTR_SET_VALUE(serveAreaShrink_, serveAreaShrink) };
    ...
    inline ClinkUpdateClientShrinkRequest& setWechatMiniProgramRtc(int64_t wechatMiniProgramRtc) { DARABONBA_PTR_SET_VALUE(wechatMiniProgramRtc_, wechatMiniProgramRtc) };
    ...
    inline ClinkUpdateClientShrinkRequest& setWrapupTime(int64_t wrapupTime) { DARABONBA_PTR_SET_VALUE(wrapupTime_, wrapupTime) };
