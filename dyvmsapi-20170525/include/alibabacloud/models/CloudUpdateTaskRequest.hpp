...
#ifndef ALIBABACLOUD_MODELS_CLOUDUPDATETASKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CLOUDUPDATETASKREQUEST_HPP_
...
namespace Models
{
  class CloudUpdateTaskRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CloudUpdateTaskRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CloudUpdateTaskRequest& obj) { 
    ...
    CloudUpdateTaskRequest() = default ;
    CloudUpdateTaskRequest(const CloudUpdateTaskRequest &) = default ;
    CloudUpdateTaskRequest(CloudUpdateTaskRequest &&) = default ;
    CloudUpdateTaskRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CloudUpdateTaskRequest() = default ;
    CloudUpdateTaskRequest& operator=(const CloudUpdateTaskRequest &) = default ;
    CloudUpdateTaskRequest& operator=(CloudUpdateTaskRequest &&) = default ;
    ...
    virtual bool empty() const override { return this->agentGroup_ == nullptr
        ...
        && this->autoTriggerTimeStrategy_ == nullptr && this->callLimitStrategy_ == nullptr && this->callPriorityStrategy_ == nullptr && this->callRouteStrategy_ == nullptr && this->callStrategy_ == nullptr
        && this->callVariables_ == nullptr && this->clidProperty_ == nullptr && this->cnos_ == nullptr && this->concurrency_ == nullptr && this->customerClidType_ == nullptr
        && this->customerClidWeight_ == nullptr && this->customerClidWeightFlag_ == nullptr && this->customerClids_ == nullptr && this->customerClidsCategory_ == nullptr && this->customerClidsGroup_ == nullptr
        && this->customerMoh_ == nullptr && this->customerTimeout_ == nullptr && this->customerVoice_ == nullptr && this->description_ == nullptr && this->enterpriseId_ == nullptr
        && this->forceEndFlag_ == nullptr && this->isRewarm_ == nullptr && this->ivrId_ == nullptr && this->ivrName_ == nullptr && this->maxWaitTime_ == nullptr
        && this->minAvailableAgentCount_ == nullptr && this->name_ == nullptr && this->ownerId_ == nullptr && this->predictAdjust_ == nullptr && this->quotiety_ == nullptr
        && this->resourceOwnerAccount_ == nullptr && this->resourceOwnerId_ == nullptr && this->retryStrategy_ == nullptr && this->retryStrategyOnlyToday_ == nullptr && this->retryStrategyTimeType_ == nullptr
        && this->taskId_ == nullptr && this->timeStrategy_ == nullptr && this->userFields_ == nullptr && this->warmUpDuration_ == nullptr && this->wrapup_ == nullptr; };
    ...
    inline CloudUpdateTaskRequest& setAgentGroup(string agentGroup) { DARABONBA_PTR_SET_VALUE(agentGroup_, agentGroup) };
    ...
    inline CloudUpdateTaskRequest& setAgentTimeout(int64_t agentTimeout) { DARABONBA_PTR_SET_VALUE(agentTimeout_, agentTimeout) };
    ...
    inline CloudUpdateTaskRequest& setAnswerRate(int64_t answerRate) { DARABONBA_PTR_SET_VALUE(answerRate_, answerRate) };
    ...
    inline CloudUpdateTaskRequest& setAutoComplete(int64_t autoComplete) { DARABONBA_PTR_SET_VALUE(autoComplete_, autoComplete) };
    ...
    inline CloudUpdateTaskRequest& setAutoStart(int64_t autoStart) { DARABONBA_PTR_SET_VALUE(autoStart_, autoStart) };
    ...
    inline CloudUpdateTaskRequest& setAutoStartDay(string autoStartDay) { DARABONBA_PTR_SET_VALUE(autoStartDay_, autoStartDay) };
    ...
    inline CloudUpdateTaskRequest& setAutoStartTime(string autoStartTime) { DARABONBA_PTR_SET_VALUE(autoStartTime_, autoStartTime) };
    ...
    inline CloudUpdateTaskRequest& setAutoStop(int64_t autoStop) { DARABONBA_PTR_SET_VALUE(autoStop_, autoStop) };
    ...
    inline CloudUpdateTaskRequest& setAutoStopDay(string autoStopDay) { DARABONBA_PTR_SET_VALUE(autoStopDay_, autoStopDay) };
    ...
    inline CloudUpdateTaskRequest& setAutoStopTime(string autoStopTime) { DARABONBA_PTR_SET_VALUE(autoStopTime_, autoStopTime) };
    ...
    inline CloudUpdateTaskRequest& setAutoTaskType(int64_t autoTaskType) { DARABONBA_PTR_SET_VALUE(autoTaskType_, autoTaskType) };
    ...
    inline CloudUpdateTaskRequest& setAutoTriggerTimeStrategy(string autoTriggerTimeStrategy) { DARABONBA_PTR_SET_VALUE(autoTriggerTimeStrategy_, autoTriggerTimeStrategy) };
    ...
    inline CloudUpdateTaskRequest& setCallLimitStrategy(string callLimitStrategy) { DARABONBA_PTR_SET_VALUE(callLimitStrategy_, callLimitStrategy) };
    ...
    inline CloudUpdateTaskRequest& setCallPriorityStrategy(string callPriorityStrategy) { DARABONBA_PTR_SET_VALUE(callPriorityStrategy_, callPriorityStrategy) };
    ...
    inline CloudUpdateTaskRequest& setCallRouteStrategy(int64_t callRouteStrategy) { DARABONBA_PTR_SET_VALUE(callRouteStrategy_, callRouteStrategy) };
    ...
    inline CloudUpdateTaskRequest& setCallStrategy(string callStrategy) { DARABONBA_PTR_SET_VALUE(callStrategy_, callStrategy) };
    ...
    inline CloudUpdateTaskRequest& setCallVariables(string callVariables) { DARABONBA_PTR_SET_VALUE(callVariables_, callVariables) };
    ...
    inline CloudUpdateTaskRequest& setClidProperty(string clidProperty) { DARABONBA_PTR_SET_VALUE(clidProperty_, clidProperty) };
    ...
    inline CloudUpdateTaskRequest& setCnos(string cnos) { DARABONBA_PTR_SET_VALUE(cnos_, cnos) };
    ...
    inline CloudUpdateTaskRequest& setConcurrency(int64_t concurrency) { DARABONBA_PTR_SET_VALUE(concurrency_, concurrency) };
    ...
    inline CloudUpdateTaskRequest& setCustomerClidType(int64_t customerClidType) { DARABONBA_PTR_SET_VALUE(customerClidType_, customerClidType) };
    ...
    inline CloudUpdateTaskRequest& setCustomerClidWeight(string customerClidWeight) { DARABONBA_PTR_SET_VALUE(customerClidWeight_, customerClidWeight) };
    ...
    inline CloudUpdateTaskRequest& setCustomerClidWeightFlag(int64_t customerClidWeightFlag) { DARABONBA_PTR_SET_VALUE(customerClidWeightFlag_, customerClidWeightFlag) };
    ...
    inline CloudUpdateTaskRequest& setCustomerClids(string customerClids) { DARABONBA_PTR_SET_VALUE(customerClids_, customerClids) };
    ...
    inline CloudUpdateTaskRequest& setCustomerClidsCategory(int64_t customerClidsCategory) { DARABONBA_PTR_SET_VALUE(customerClidsCategory_, customerClidsCategory) };
    ...
    inline CloudUpdateTaskRequest& setCustomerClidsGroup(string customerClidsGroup) { DARABONBA_PTR_SET_VALUE(customerClidsGroup_, customerClidsGroup) };
    ...
    inline CloudUpdateTaskRequest& setCustomerMoh(string customerMoh) { DARABONBA_PTR_SET_VALUE(customerMoh_, customerMoh) };
    ...
    inline CloudUpdateTaskRequest& setCustomerTimeout(int64_t customerTimeout) { DARABONBA_PTR_SET_VALUE(customerTimeout_, customerTimeout) };
    ...
    inline CloudUpdateTaskRequest& setCustomerVoice(string customerVoice) { DARABONBA_PTR_SET_VALUE(customerVoice_, customerVoice) };
    ...
    inline CloudUpdateTaskRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CloudUpdateTaskRequest& setEnterpriseId(int64_t enterpriseId) { DARABONBA_PTR_SET_VALUE(enterpriseId_, enterpriseId) };
    ...
    inline CloudUpdateTaskRequest& setForceEndFlag(int64_t forceEndFlag) { DARABONBA_PTR_SET_VALUE(forceEndFlag_, forceEndFlag) };
    ...
    inline CloudUpdateTaskRequest& setIsRewarm(int64_t isRewarm) { DARABONBA_PTR_SET_VALUE(isRewarm_, isRewarm) };
    ...
    inline CloudUpdateTaskRequest& setIvrId(int64_t ivrId) { DARABONBA_PTR_SET_VALUE(ivrId_, ivrId) };
    ...
    inline CloudUpdateTaskRequest& setIvrName(string ivrName) { DARABONBA_PTR_SET_VALUE(ivrName_, ivrName) };
    ...
    inline CloudUpdateTaskRequest& setMaxWaitTime(int64_t maxWaitTime) { DARABONBA_PTR_SET_VALUE(maxWaitTime_, maxWaitTime) };
    ...
    inline CloudUpdateTaskRequest& setMinAvailableAgentCount(int64_t minAvailableAgentCount) { DARABONBA_PTR_SET_VALUE(minAvailableAgentCount_, minAvailableAgentCount) };
    ...
    inline CloudUpdateTaskRequest& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline CloudUpdateTaskRequest& setOwnerId(int64_t ownerId) { DARABONBA_PTR_SET_VALUE(ownerId_, ownerId) };
    ...
    inline CloudUpdateTaskRequest& setPredictAdjust(int64_t predictAdjust) { DARABONBA_PTR_SET_VALUE(predictAdjust_, predictAdjust) };
    ...
    inline CloudUpdateTaskRequest& setQuotiety(double quotiety) { DARABONBA_PTR_SET_VALUE(quotiety_, quotiety) };
    ...
    inline CloudUpdateTaskRequest& setResourceOwnerAccount(string resourceOwnerAccount) { DARABONBA_PTR_SET_VALUE(resourceOwnerAccount_, resourceOwnerAccount) };
    ...
    inline CloudUpdateTaskRequest& setResourceOwnerId(int64_t resourceOwnerId) { DARABONBA_PTR_SET_VALUE(resourceOwnerId_, resourceOwnerId) };
    ...
    inline CloudUpdateTaskRequest& setRetryStrategy(string retryStrategy) { DARABONBA_PTR_SET_VALUE(retryStrategy_, retryStrategy) };
    ...
    inline CloudUpdateTaskRequest& setRetryStrategyOnlyToday(int64_t retryStrategyOnlyToday) { DARABONBA_PTR_SET_VALUE(retryStrategyOnlyToday_, retryStrategyOnlyToday) };
    ...
    inline CloudUpdateTaskRequest& setRetryStrategyTimeType(int64_t retryStrategyTimeType) { DARABONBA_PTR_SET_VALUE(retryStrategyTimeType_, retryStrategyTimeType) };
    ...
    inline CloudUpdateTaskRequest& setTaskId(string taskId) { DARABONBA_PTR_SET_VALUE(taskId_, taskId) };
    ...
    inline CloudUpdateTaskRequest& setTimeStrategy(string timeStrategy) { DARABONBA_PTR_SET_VALUE(timeStrategy_, timeStrategy) };
    ...
    inline CloudUpdateTaskRequest& setUserFields(string userFields) { DARABONBA_PTR_SET_VALUE(userFields_, userFields) };
    ...
    inline CloudUpdateTaskRequest& setWarmUpDuration(int64_t warmUpDuration) { DARABONBA_PTR_SET_VALUE(warmUpDuration_, warmUpDuration) };
    ...
    inline CloudUpdateTaskRequest& setWrapup(int64_t wrapup) { DARABONBA_PTR_SET_VALUE(wrapup_, wrapup) };
