...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountIds_ == nullptr
        && return this->beginTime_ == nullptr && return this->cloudIp_ == nullptr && return this->cloudIpList_ == nullptr && return this->cloudIsp_ == nullptr && return this->cloudPort_ == nullptr
        && return this->direction_ == nullptr && return this->endTime_ == nullptr && return this->instanceId_ == nullptr && return this->instanceList_ == nullptr && return this->orderBy_ == nullptr
    ...
    inline const vector<string> & cloudIpList() const { DARABONBA_PTR_GET_CONST(cloudIpList_, vector<string>) };
    inline vector<string> cloudIpList() { DARABONBA_PTR_GET(cloudIpList_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> cloudIpList_ = nullptr;
