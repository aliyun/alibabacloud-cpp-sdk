...
#ifndef ALIBABACLOUD_MODELS_GETVBRFLOWTOPNSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETVBRFLOWTOPNSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetVbrFlowTopNShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetVbrFlowTopNShrinkRequest& obj) { 
    ...
    GetVbrFlowTopNShrinkRequest() = default ;
    GetVbrFlowTopNShrinkRequest(const GetVbrFlowTopNShrinkRequest &) = default ;
    GetVbrFlowTopNShrinkRequest(GetVbrFlowTopNShrinkRequest &&) = default ;
    GetVbrFlowTopNShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetVbrFlowTopNShrinkRequest() = default ;
    GetVbrFlowTopNShrinkRequest& operator=(const GetVbrFlowTopNShrinkRequest &) = default ;
    GetVbrFlowTopNShrinkRequest& operator=(GetVbrFlowTopNShrinkRequest &&) = default ;
    ...
    inline GetVbrFlowTopNShrinkRequest& setAccountIdsShrink(string accountIdsShrink) { DARABONBA_PTR_SET_VALUE(accountIdsShrink_, accountIdsShrink) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setAttachmentId(string attachmentId) { DARABONBA_PTR_SET_VALUE(attachmentId_, attachmentId) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setBeginTime(int64_t beginTime) { DARABONBA_PTR_SET_VALUE(beginTime_, beginTime) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setCenId(string cenId) { DARABONBA_PTR_SET_VALUE(cenId_, cenId) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setCloudIp(string cloudIp) { DARABONBA_PTR_SET_VALUE(cloudIp_, cloudIp) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setCloudPort(string cloudPort) { DARABONBA_PTR_SET_VALUE(cloudPort_, cloudPort) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setDirection(string direction) { DARABONBA_PTR_SET_VALUE(direction_, direction) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setGroupBy(string groupBy) { DARABONBA_PTR_SET_VALUE(groupBy_, groupBy) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setOrderBy(string orderBy) { DARABONBA_PTR_SET_VALUE(orderBy_, orderBy) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setOtherIp(string otherIp) { DARABONBA_PTR_SET_VALUE(otherIp_, otherIp) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setOtherPort(string otherPort) { DARABONBA_PTR_SET_VALUE(otherPort_, otherPort) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setSort(string sort) { DARABONBA_PTR_SET_VALUE(sort_, sort) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setTopN(int32_t topN) { DARABONBA_PTR_SET_VALUE(topN_, topN) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setUseMultiAccount(bool useMultiAccount) { DARABONBA_PTR_SET_VALUE(useMultiAccount_, useMultiAccount) };
    ...
    inline GetVbrFlowTopNShrinkRequest& setVirtualBorderRouterId(string virtualBorderRouterId) { DARABONBA_PTR_SET_VALUE(virtualBorderRouterId_, virtualBorderRouterId) };
