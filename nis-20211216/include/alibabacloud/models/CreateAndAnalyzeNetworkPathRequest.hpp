...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->protocol_ == nullptr
        && this->regionId_ == nullptr && this->sourceId_ == nullptr && this->sourceIpAddress_ == nullptr && this->sourcePort_ == nullptr && this->sourceType_ == nullptr
        && this->targetId_ == nullptr && this->targetIpAddress_ == nullptr && this->targetPort_ == nullptr && this->targetType_ == nullptr; };
