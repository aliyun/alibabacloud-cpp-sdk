...
namespace Models
{
  ...
  public:
    ...
    inline const GetVbrFlowTopNResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetVbrFlowTopNResponseBody) };
    inline GetVbrFlowTopNResponseBody body() { DARABONBA_PTR_GET(body_, GetVbrFlowTopNResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetVbrFlowTopNResponseBody> body_ = nullptr;
  };
