...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aliUid_ == nullptr
        && this->createTime_ == nullptr && this->networkPathId_ == nullptr && this->networkPathParameter_ == nullptr && this->networkReachableAnalysisId_ == nullptr && this->networkReachableAnalysisResult_ == nullptr
        && this->networkReachableAnalysisStatus_ == nullptr && this->reachable_ == nullptr && this->requestId_ == nullptr; };
    ...
    inline string getNetworkPathParameter() const { DARABONBA_PTR_GET_DEFAULT(networkPathParameter_, "") };
    ...
    inline string getNetworkReachableAnalysisResult() const { DARABONBA_PTR_GET_DEFAULT(networkReachableAnalysisResult_, "") };
    ...
    inline string getNetworkReachableAnalysisStatus() const { DARABONBA_PTR_GET_DEFAULT(networkReachableAnalysisStatus_, "") };
    ...
    inline bool getReachable() const { DARABONBA_PTR_GET_DEFAULT(reachable_, false) };
  ...
  protected:
    ...
    shared_ptr<string> networkPathParameter_ {};
