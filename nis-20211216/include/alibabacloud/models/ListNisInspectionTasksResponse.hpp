...
namespace Models
{
  ...
  public:
    ...
    inline const ListNisInspectionTasksResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListNisInspectionTasksResponseBody) };
    inline ListNisInspectionTasksResponseBody body() { DARABONBA_PTR_GET(body_, ListNisInspectionTasksResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListNisInspectionTasksResponseBody> body_ = nullptr;
  };
