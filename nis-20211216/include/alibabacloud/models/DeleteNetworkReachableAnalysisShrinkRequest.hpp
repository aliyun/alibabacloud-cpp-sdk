...
namespace Models
{
  ...
  public:
    ...
    inline string getNetworkReachableAnalysisIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(networkReachableAnalysisIdsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> networkReachableAnalysisIdsShrink_ {};
