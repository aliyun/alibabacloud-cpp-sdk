...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteNisInspectionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteNisInspectionTaskResponseBody) };
    inline DeleteNisInspectionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteNisInspectionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteNisInspectionTaskResponseBody> body_ {};
  };
