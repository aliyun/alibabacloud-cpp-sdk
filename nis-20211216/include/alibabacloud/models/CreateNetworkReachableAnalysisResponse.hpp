...
namespace Models
{
  ...
  public:
    ...
    inline const CreateNetworkReachableAnalysisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateNetworkReachableAnalysisResponseBody) };
    inline CreateNetworkReachableAnalysisResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateNetworkReachableAnalysisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateNetworkReachableAnalysisResponseBody> body_ {};
  };
