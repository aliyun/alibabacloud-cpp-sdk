...
namespace Models
{
  ...
  public:
    ...
    inline const ListNisInspectionResourceTypeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListNisInspectionResourceTypeResponseBody) };
    inline ListNisInspectionResourceTypeResponseBody body() { DARABONBA_PTR_GET(body_, ListNisInspectionResourceTypeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListNisInspectionResourceTypeResponseBody> body_ = nullptr;
  };
