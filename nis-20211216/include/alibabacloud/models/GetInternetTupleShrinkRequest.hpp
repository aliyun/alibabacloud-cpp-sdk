...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountIds_ == nullptr
        && this->beginTime_ == nullptr && this->cloudIp_ == nullptr && this->cloudIpListShrink_ == nullptr && this->cloudIsp_ == nullptr && this->cloudPort_ == nullptr
        && this->direction_ == nullptr && this->endTime_ == nullptr && this->instanceId_ == nullptr && this->instanceListShrink_ == nullptr && this->orderBy_ == nullptr
    ...
    inline string getCloudIpListShrink() const { DARABONBA_PTR_GET_DEFAULT(cloudIpListShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> cloudIpListShrink_ {};
