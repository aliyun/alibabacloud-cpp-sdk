...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAndAnalyzeNetworkPathResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAndAnalyzeNetworkPathResponseBody) };
    inline CreateAndAnalyzeNetworkPathResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAndAnalyzeNetworkPathResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAndAnalyzeNetworkPathResponseBody> body_ {};
  };
