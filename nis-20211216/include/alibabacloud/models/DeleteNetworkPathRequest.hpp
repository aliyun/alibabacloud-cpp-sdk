...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & networkPathIds() const { DARABONBA_PTR_GET_CONST(networkPathIds_, vector<string>) };
    inline vector<string> networkPathIds() { DARABONBA_PTR_GET(networkPathIds_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> networkPathIds_ = nullptr;
