...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNisInspectionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeNisInspectionTaskResponseBody) };
    inline DescribeNisInspectionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeNisInspectionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeNisInspectionTaskResponseBody> body_ {};
  };
