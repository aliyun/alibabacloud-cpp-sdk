...
namespace Models
{
  ...
  public:
    ...
    inline const StartNisInspectionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartNisInspectionTaskResponseBody) };
    inline StartNisInspectionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, StartNisInspectionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartNisInspectionTaskResponseBody> body_ {};
  };
