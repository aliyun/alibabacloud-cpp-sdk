...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->endTime_ == nullptr
        && this->inspectionProject_ == nullptr && this->inspectionReportId_ == nullptr && this->inspectionTaskId_ == nullptr && this->inspectionTaskName_ == nullptr && this->requestId_ == nullptr
    ...
    inline string getInspectionTaskName() const { DARABONBA_PTR_GET_DEFAULT(inspectionTaskName_, "") };
