...
namespace Models
{
  ...
  public:
    ...
    inline const GetNatTopNResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetNatTopNResponseBody) };
    inline GetNatTopNResponseBody body() { DARABONBA_PTR_GET(body_, GetNatTopNResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetNatTopNResponseBody> body_ = nullptr;
  };
