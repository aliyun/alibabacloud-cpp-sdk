...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->categoryCode_ == nullptr
        && return this->inspectionReportId_ == nullptr && return this->language_ == nullptr && return this->maxResults_ == nullptr && return this->nextToken_ == nullptr && return this->resourceTypeShrink_ == nullptr
        && return this->riskLevelShrink_ == nullptr; };
    ...
    inline string resourceTypeShrink() const { DARABONBA_PTR_GET_DEFAULT(resourceTypeShrink_, "") };
    ...
    inline string riskLevelShrink() const { DARABONBA_PTR_GET_DEFAULT(riskLevelShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> resourceTypeShrink_ = nullptr;
    std::shared_ptr<string> riskLevelShrink_ = nullptr;
  };
