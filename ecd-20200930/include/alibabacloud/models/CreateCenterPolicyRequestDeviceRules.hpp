...
#ifndef ALIBABACLOUD_MODELS_CREATECENTERPOLICYREQUESTDEVICERULES_HPP_
#define ALIBABACLOUD_MODELS_CREATECENTERPOLICYREQUESTDEVICERULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateCenterPolicyRequestDeviceRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateCenterPolicyRequestDeviceRules& obj) { 
    ...
    CreateCenterPolicyRequestDeviceRules() = default ;
    CreateCenterPolicyRequestDeviceRules(const CreateCenterPolicyRequestDeviceRules &) = default ;
    CreateCenterPolicyRequestDeviceRules(CreateCenterPolicyRequestDeviceRules &&) = default ;
    CreateCenterPolicyRequestDeviceRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateCenterPolicyRequestDeviceRules() = default ;
    CreateCenterPolicyRequestDeviceRules& operator=(const CreateCenterPolicyRequestDeviceRules &) = default ;
    CreateCenterPolicyRequestDeviceRules& operator=(CreateCenterPolicyRequestDeviceRules &&) = default ;
    ...
    inline CreateCenterPolicyRequestDeviceRules& setDeviceName(string deviceName) { DARABONBA_PTR_SET_VALUE(deviceName_, deviceName) };
    ...
    inline CreateCenterPolicyRequestDeviceRules& setDevicePid(string devicePid) { DARABONBA_PTR_SET_VALUE(devicePid_, devicePid) };
    ...
    inline CreateCenterPolicyRequestDeviceRules& setDeviceType(string deviceType) { DARABONBA_PTR_SET_VALUE(deviceType_, deviceType) };
    ...
    inline CreateCenterPolicyRequestDeviceRules& setDeviceVid(string deviceVid) { DARABONBA_PTR_SET_VALUE(deviceVid_, deviceVid) };
    ...
    inline CreateCenterPolicyRequestDeviceRules& setOptCommand(string optCommand) { DARABONBA_PTR_SET_VALUE(optCommand_, optCommand) };
    ...
    inline CreateCenterPolicyRequestDeviceRules& setPlatforms(string platforms) { DARABONBA_PTR_SET_VALUE(platforms_, platforms) };
    ...
    inline CreateCenterPolicyRequestDeviceRules& setRedirectType(string redirectType) { DARABONBA_PTR_SET_VALUE(redirectType_, redirectType) };
