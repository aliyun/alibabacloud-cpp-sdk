...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSubnetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSubnetResponseBody) };
    inline CreateSubnetResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSubnetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSubnetResponseBody> body_ {};
  };
