...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyNASDefaultMountTargetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyNASDefaultMountTargetResponseBody) };
    inline ModifyNASDefaultMountTargetResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyNASDefaultMountTargetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyNASDefaultMountTargetResponseBody> body_ {};
  };
