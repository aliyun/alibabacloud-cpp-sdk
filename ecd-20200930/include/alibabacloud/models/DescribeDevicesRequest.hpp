...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->adDomain_ != nullptr
        && this->clientType_ != nullptr && this->deviceId_ != nullptr && this->directoryId_ != nullptr && this->endUserId_ != nullptr && this->pageNumber_ != nullptr
        && this->pageSize_ != nullptr && this->region_ != nullptr && this->userType_ != nullptr; };
