...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRAMDirectoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRAMDirectoryResponseBody) };
    inline CreateRAMDirectoryResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRAMDirectoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRAMDirectoryResponseBody> body_ {};
  };
