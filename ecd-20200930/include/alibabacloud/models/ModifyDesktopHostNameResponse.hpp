...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDesktopHostNameResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDesktopHostNameResponseBody) };
    inline ModifyDesktopHostNameResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDesktopHostNameResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDesktopHostNameResponseBody> body_ {};
  };
