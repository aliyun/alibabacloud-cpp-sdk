...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDesktopGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDesktopGroupsResponseBody) };
    inline DescribeDesktopGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDesktopGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDesktopGroupsResponseBody> body_ {};
  };
