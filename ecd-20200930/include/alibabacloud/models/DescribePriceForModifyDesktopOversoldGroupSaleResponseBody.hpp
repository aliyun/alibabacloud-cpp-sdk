...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePriceForModifyDesktopOversoldGroupSaleResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribePriceForModifyDesktopOversoldGroupSaleResponseBodyData) };
    inline DescribePriceForModifyDesktopOversoldGroupSaleResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribePriceForModifyDesktopOversoldGroupSaleResponseBodyData) };
    inline DescribePriceForModifyDesktopOversoldGroupSaleResponseBody& setData(const DescribePriceForModifyDesktopOversoldGroupSaleResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribePriceForModifyDesktopOversoldGroupSaleResponseBody& setData(DescribePriceForModifyDesktopOversoldGroupSaleResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribePriceForModifyDesktopOversoldGroupSaleResponseBodyData> data_ = nullptr;
