...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getDataSnapshotIds() const { DARABONBA_PTR_GET_CONST(dataSnapshotIds_, vector<string>) };
    inline vector<string> getDataSnapshotIds() { DARABONBA_PTR_GET(dataSnapshotIds_, vector<string>) };
    ...
    inline string getImageResourceType() const { DARABONBA_PTR_GET_DEFAULT(imageResourceType_, "") };
