...
#ifndef ALIBABACLOUD_MODELS_MODIFYPOLICYGROUPREQUESTAUTHORIZESECURITYPOLICYRULE_HPP_
#define ALIBABACLOUD_MODELS_MODIFYPOLICYGROUPREQUESTAUTHORIZESECURITYPOLICYRULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule& obj) { 
    ...
    ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule() = default ;
    ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule(const ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule &) = default ;
    ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule(ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule &&) = default ;
    ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule() = default ;
    ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule& operator=(const ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule &) = default ;
    ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule& operator=(ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule &&) = default ;
    ...
    inline ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule& setCidrIp(string cidrIp) { DARABONBA_PTR_SET_VALUE(cidrIp_, cidrIp) };
    ...
    inline ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule& setIpProtocol(string ipProtocol) { DARABONBA_PTR_SET_VALUE(ipProtocol_, ipProtocol) };
    ...
    inline ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule& setPolicy(string policy) { DARABONBA_PTR_SET_VALUE(policy_, policy) };
    ...
    inline ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule& setPortRange(string portRange) { DARABONBA_PTR_SET_VALUE(portRange_, portRange) };
    ...
    inline ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule& setPriority(string priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
