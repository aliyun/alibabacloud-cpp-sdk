...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyOfficeSiteDnsInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyOfficeSiteDnsInfoResponseBody) };
    inline ModifyOfficeSiteDnsInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyOfficeSiteDnsInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyOfficeSiteDnsInfoResponseBody> body_ {};
  };
