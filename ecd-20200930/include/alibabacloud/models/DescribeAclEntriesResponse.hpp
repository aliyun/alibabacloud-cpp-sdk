...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAclEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAclEntriesResponseBody) };
    inline DescribeAclEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAclEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAclEntriesResponseBody> body_ {};
  };
