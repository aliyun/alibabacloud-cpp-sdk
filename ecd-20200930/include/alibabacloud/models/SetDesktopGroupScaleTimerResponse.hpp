...
namespace Models
{
  ...
  public:
    ...
    inline const SetDesktopGroupScaleTimerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetDesktopGroupScaleTimerResponseBody) };
    inline SetDesktopGroupScaleTimerResponseBody getBody() { DARABONBA_PTR_GET(body_, SetDesktopGroupScaleTimerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetDesktopGroupScaleTimerResponseBody> body_ {};
  };
