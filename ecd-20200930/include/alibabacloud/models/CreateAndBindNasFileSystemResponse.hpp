...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAndBindNasFileSystemResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAndBindNasFileSystemResponseBody) };
    inline CreateAndBindNasFileSystemResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAndBindNasFileSystemResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAndBindNasFileSystemResponseBody> body_ {};
  };
