...
namespace Models
{
  ...
  public:
    ...
    inline const StartDesktopsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartDesktopsResponseBody) };
    inline StartDesktopsResponseBody getBody() { DARABONBA_PTR_GET(body_, StartDesktopsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartDesktopsResponseBody> body_ {};
  };
