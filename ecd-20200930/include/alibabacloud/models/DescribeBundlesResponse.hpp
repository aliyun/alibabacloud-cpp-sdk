...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBundlesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBundlesResponseBody) };
    inline DescribeBundlesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBundlesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBundlesResponseBody> body_ {};
  };
