...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCenterPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCenterPolicyResponseBody) };
    inline CreateCenterPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCenterPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCenterPolicyResponseBody> body_ {};
  };
