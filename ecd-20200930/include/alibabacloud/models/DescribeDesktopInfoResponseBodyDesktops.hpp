...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->connectionStatus_ == nullptr
        && return this->currentAppVersion_ == nullptr && return this->desktopGroupId_ == nullptr && return this->desktopId_ == nullptr && return this->desktopStatus_ == nullptr && return this->managementFlag_ == nullptr
        && return this->newAppSize_ == nullptr && return this->newAppVersion_ == nullptr && return this->releaseNote_ == nullptr && return this->startTime_ == nullptr; };
