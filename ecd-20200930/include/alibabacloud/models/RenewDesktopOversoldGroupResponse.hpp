...
namespace Models
{
  ...
  public:
    ...
    inline const RenewDesktopOversoldGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RenewDesktopOversoldGroupResponseBody) };
    inline RenewDesktopOversoldGroupResponseBody body() { DARABONBA_PTR_GET(body_, RenewDesktopOversoldGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<RenewDesktopOversoldGroupResponseBody> body_ = nullptr;
  };
