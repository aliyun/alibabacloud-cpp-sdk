...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCdsFileShareLinkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCdsFileShareLinkResponseBody) };
    inline CreateCdsFileShareLinkResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCdsFileShareLinkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCdsFileShareLinkResponseBody> body_ {};
  };
