...
#ifndef ALIBABACLOUD_MODELS_CREATEDESKTOPSREQUESTBUNDLEMODELS_HPP_
#define ALIBABACLOUD_MODELS_CREATEDESKTOPSREQUESTBUNDLEMODELS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateDesktopsRequestBundleModels& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateDesktopsRequestBundleModels& obj) { 
    ...
    CreateDesktopsRequestBundleModels() = default ;
    CreateDesktopsRequestBundleModels(const CreateDesktopsRequestBundleModels &) = default ;
    CreateDesktopsRequestBundleModels(CreateDesktopsRequestBundleModels &&) = default ;
    CreateDesktopsRequestBundleModels(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateDesktopsRequestBundleModels() = default ;
    CreateDesktopsRequestBundleModels& operator=(const CreateDesktopsRequestBundleModels &) = default ;
    CreateDesktopsRequestBundleModels& operator=(CreateDesktopsRequestBundleModels &&) = default ;
    ...
    inline CreateDesktopsRequestBundleModels& setAmount(int32_t amount) { DARABONBA_PTR_SET_VALUE(amount_, amount) };
    ...
    inline CreateDesktopsRequestBundleModels& setBundleId(string bundleId) { DARABONBA_PTR_SET_VALUE(bundleId_, bundleId) };
    ...
    inline CreateDesktopsRequestBundleModels& setDesktopName(string desktopName) { DARABONBA_PTR_SET_VALUE(desktopName_, desktopName) };
    ...
    inline CreateDesktopsRequestBundleModels& setEndUserIds(const vector<string> & endUserIds) { DARABONBA_PTR_SET_VALUE(endUserIds_, endUserIds) };
    inline CreateDesktopsRequestBundleModels& setEndUserIds(vector<string> && endUserIds) { DARABONBA_PTR_SET_RVALUE(endUserIds_, endUserIds) };
    ...
    inline CreateDesktopsRequestBundleModels& setHostname(string hostname) { DARABONBA_PTR_SET_VALUE(hostname_, hostname) };
    ...
    inline CreateDesktopsRequestBundleModels& setVolumeEncryptionEnabled(bool volumeEncryptionEnabled) { DARABONBA_PTR_SET_VALUE(volumeEncryptionEnabled_, volumeEncryptionEnabled) };
    ...
    inline CreateDesktopsRequestBundleModels& setVolumeEncryptionKey(string volumeEncryptionKey) { DARABONBA_PTR_SET_VALUE(volumeEncryptionKey_, volumeEncryptionKey) };
