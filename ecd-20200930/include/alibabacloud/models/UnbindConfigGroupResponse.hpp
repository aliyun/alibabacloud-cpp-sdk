...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindConfigGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnbindConfigGroupResponseBody) };
    inline UnbindConfigGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, UnbindConfigGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnbindConfigGroupResponseBody> body_ {};
  };
