...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstalledAppsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListInstalledAppsResponseBody) };
    inline ListInstalledAppsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListInstalledAppsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListInstalledAppsResponseBody> body_ {};
  };
