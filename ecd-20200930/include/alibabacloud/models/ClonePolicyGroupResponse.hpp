...
namespace Models
{
  ...
  public:
    ...
    inline const ClonePolicyGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ClonePolicyGroupResponseBody) };
    inline ClonePolicyGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ClonePolicyGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ClonePolicyGroupResponseBody> body_ {};
  };
