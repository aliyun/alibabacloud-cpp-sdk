...
namespace Models
{
  ...
  public:
    ...
    inline const ExportDesktopListInfoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ExportDesktopListInfoResponseBody) };
    inline ExportDesktopListInfoResponseBody body() { DARABONBA_PTR_GET(body_, ExportDesktopListInfoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ExportDesktopListInfoResponseBody> body_ = nullptr;
  };
