...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getConnectDurationFrom() const { DARABONBA_PTR_GET_DEFAULT(connectDurationFrom_, 0L) };
    ...
    inline int64_t getConnectDurationTo() const { DARABONBA_PTR_GET_DEFAULT(connectDurationTo_, 0L) };
    ...
    inline int64_t getConnectEndTimeFrom() const { DARABONBA_PTR_GET_DEFAULT(connectEndTimeFrom_, 0L) };
    ...
    inline int64_t getConnectEndTimeTo() const { DARABONBA_PTR_GET_DEFAULT(connectEndTimeTo_, 0L) };
    ...
    inline int64_t getConnectStartTimeFrom() const { DARABONBA_PTR_GET_DEFAULT(connectStartTimeFrom_, 0L) };
    ...
    inline int64_t getConnectStartTimeTo() const { DARABONBA_PTR_GET_DEFAULT(connectStartTimeTo_, 0L) };
