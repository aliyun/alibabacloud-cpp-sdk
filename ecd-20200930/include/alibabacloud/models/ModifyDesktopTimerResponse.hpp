...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDesktopTimerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDesktopTimerResponseBody) };
    inline ModifyDesktopTimerResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDesktopTimerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDesktopTimerResponseBody> body_ {};
  };
