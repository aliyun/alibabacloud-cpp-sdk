...
namespace Models
{
  ...
  public:
    ...
    inline bool getNeedSignedUrl() const { DARABONBA_PTR_GET_DEFAULT(needSignedUrl_, false) };
    ...
    inline int32_t getSignedUrlExpireMinutes() const { DARABONBA_PTR_GET_DEFAULT(signedUrlExpireMinutes_, 0) };
    ...
    inline string getStandardEndTime() const { DARABONBA_PTR_GET_DEFAULT(standardEndTime_, "") };
