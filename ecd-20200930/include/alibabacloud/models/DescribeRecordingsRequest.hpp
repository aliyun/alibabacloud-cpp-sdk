...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->desktopId_ == nullptr
        && return this->endTime_ == nullptr && return this->maxResults_ == nullptr && return this->needSignedUrl_ == nullptr && return this->nextToken_ == nullptr && return this->policyGroupId_ == nullptr
        && return this->regionId_ == nullptr && return this->signedUrlExpireMinutes_ == nullptr && return this->standardEndTime_ == nullptr && return this->standardStartTime_ == nullptr && return this->startTime_ == nullptr; };
