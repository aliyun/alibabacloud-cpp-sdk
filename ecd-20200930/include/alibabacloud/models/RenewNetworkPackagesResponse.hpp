...
namespace Models
{
  ...
  public:
    ...
    inline const RenewNetworkPackagesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RenewNetworkPackagesResponseBody) };
    inline RenewNetworkPackagesResponseBody getBody() { DARABONBA_PTR_GET(body_, RenewNetworkPackagesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RenewNetworkPackagesResponseBody> body_ {};
  };
