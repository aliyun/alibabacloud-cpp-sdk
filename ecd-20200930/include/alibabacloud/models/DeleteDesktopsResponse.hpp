...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDesktopsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDesktopsResponseBody) };
    inline DeleteDesktopsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDesktopsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDesktopsResponseBody> body_ {};
  };
