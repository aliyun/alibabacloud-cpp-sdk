...
#ifndef ALIBABACLOUD_MODELS_MODIFYPOLICYGROUPREQUESTDEVICERULES_HPP_
#define ALIBABACLOUD_MODELS_MODIFYPOLICYGROUPREQUESTDEVICERULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyPolicyGroupRequestDeviceRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyPolicyGroupRequestDeviceRules& obj) { 
    ...
    ModifyPolicyGroupRequestDeviceRules() = default ;
    ModifyPolicyGroupRequestDeviceRules(const ModifyPolicyGroupRequestDeviceRules &) = default ;
    ModifyPolicyGroupRequestDeviceRules(ModifyPolicyGroupRequestDeviceRules &&) = default ;
    ModifyPolicyGroupRequestDeviceRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyPolicyGroupRequestDeviceRules() = default ;
    ModifyPolicyGroupRequestDeviceRules& operator=(const ModifyPolicyGroupRequestDeviceRules &) = default ;
    ModifyPolicyGroupRequestDeviceRules& operator=(ModifyPolicyGroupRequestDeviceRules &&) = default ;
    ...
    inline ModifyPolicyGroupRequestDeviceRules& setDeviceName(string deviceName) { DARABONBA_PTR_SET_VALUE(deviceName_, deviceName) };
    ...
    inline ModifyPolicyGroupRequestDeviceRules& setDevicePid(string devicePid) { DARABONBA_PTR_SET_VALUE(devicePid_, devicePid) };
    ...
    inline ModifyPolicyGroupRequestDeviceRules& setDeviceType(string deviceType) { DARABONBA_PTR_SET_VALUE(deviceType_, deviceType) };
    ...
    inline ModifyPolicyGroupRequestDeviceRules& setDeviceVid(string deviceVid) { DARABONBA_PTR_SET_VALUE(deviceVid_, deviceVid) };
    ...
    inline ModifyPolicyGroupRequestDeviceRules& setOptCommand(string optCommand) { DARABONBA_PTR_SET_VALUE(optCommand_, optCommand) };
    ...
    inline ModifyPolicyGroupRequestDeviceRules& setPlatforms(string platforms) { DARABONBA_PTR_SET_VALUE(platforms_, platforms) };
    ...
    inline ModifyPolicyGroupRequestDeviceRules& setRedirectType(string redirectType) { DARABONBA_PTR_SET_VALUE(redirectType_, redirectType) };
