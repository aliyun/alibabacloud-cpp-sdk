...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeClientEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeClientEventsResponseBody) };
    inline DescribeClientEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeClientEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeClientEventsResponseBody> body_ {};
  };
