...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->amount_ == nullptr
        ...
        && this->purchaseOptions_ == nullptr && this->qosRuleId_ == nullptr && this->regionId_ == nullptr && this->resellerOwnerUid_ == nullptr && this->reservePoolId_ == nullptr
    ...
    inline CreateDesktopsRequest& setOuPath(string ouPath) { DARABONBA_PTR_SET_VALUE(ouPath_, ouPath) };
    ...
    inline CreateDesktopsRequest& setReservePoolId(string reservePoolId) { DARABONBA_PTR_SET_VALUE(reservePoolId_, reservePoolId) };
    ...
    inline CreateDesktopsRequest& setSubPayType(string subPayType) { DARABONBA_PTR_SET_VALUE(subPayType_, subPayType) };
