...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->eipAffinity_ == nullptr
        && return this->natGatewayId_ == nullptr && return this->snatEntryId_ == nullptr && return this->snatEntryName_ == nullptr && return this->snatIp_ == nullptr && return this->snatTableId_ == nullptr
        && return this->sourceCIDR_ == nullptr && return this->sourceVSwitchId_ == nullptr && return this->status_ == nullptr; };
