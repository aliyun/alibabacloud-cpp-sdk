...
namespace Models
{
  ...
  public:
    ...
    inline bool enableSecurityCheck() const { DARABONBA_PTR_GET_DEFAULT(enableSecurityCheck_, false) };
    ...
    inline string ossObjectPath() const { DARABONBA_PTR_GET_DEFAULT(ossObjectPath_, "") };
  ...
  protected:
    ...
    std::shared_ptr<bool> enableSecurityCheck_ = nullptr;
    ...
    // 
    // This parameter is required.
    std::shared_ptr<string> ossObjectPath_ = nullptr;
    // The protocol type.
    // 
    // Valid values:
    // 
