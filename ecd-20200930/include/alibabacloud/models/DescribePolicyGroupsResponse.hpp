...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePolicyGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePolicyGroupsResponseBody) };
    inline DescribePolicyGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePolicyGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePolicyGroupsResponseBody> body_ {};
  };
