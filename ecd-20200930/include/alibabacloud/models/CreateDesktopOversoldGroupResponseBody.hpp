...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDesktopOversoldGroupResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateDesktopOversoldGroupResponseBody::Data) };
    inline CreateDesktopOversoldGroupResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateDesktopOversoldGroupResponseBody::Data) };
    inline CreateDesktopOversoldGroupResponseBody& setData(const CreateDesktopOversoldGroupResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateDesktopOversoldGroupResponseBody& setData(CreateDesktopOversoldGroupResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    shared_ptr<CreateDesktopOversoldGroupResponseBody::Data> data_ {};
