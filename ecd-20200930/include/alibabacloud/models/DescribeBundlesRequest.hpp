...
namespace Models
{
  ...
  public:
    ...
    inline bool getCheckStock() const { DARABONBA_PTR_GET_DEFAULT(checkStock_, false) };
    ...
    inline bool getFromDesktopGroup() const { DARABONBA_PTR_GET_DEFAULT(fromDesktopGroup_, false) };
    ...
    inline bool getSelectedBundle() const { DARABONBA_PTR_GET_DEFAULT(selectedBundle_, false) };
    ...
    inline bool getSupportMultiSession() const { DARABONBA_PTR_GET_DEFAULT(supportMultiSession_, false) };
