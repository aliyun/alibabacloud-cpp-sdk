...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCloudDriveUsersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCloudDriveUsersResponseBody) };
    inline DeleteCloudDriveUsersResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCloudDriveUsersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCloudDriveUsersResponseBody> body_ {};
  };
