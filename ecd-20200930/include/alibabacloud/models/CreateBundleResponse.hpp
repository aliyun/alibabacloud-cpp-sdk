...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBundleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBundleResponseBody) };
    inline CreateBundleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBundleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBundleResponseBody> body_ {};
  };
