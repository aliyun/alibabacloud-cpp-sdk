...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFotaTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateFotaTaskResponseBody) };
    inline UpdateFotaTaskResponseBody body() { DARABONBA_PTR_GET(body_, UpdateFotaTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateFotaTaskResponseBody> body_ = nullptr;
  };
