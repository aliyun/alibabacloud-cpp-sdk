...
namespace Models
{
  ...
  public:
    ...
    inline const CreateCloudDriveUsersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateCloudDriveUsersResponseBody) };
    inline CreateCloudDriveUsersResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateCloudDriveUsersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateCloudDriveUsersResponseBody> body_ {};
  };
