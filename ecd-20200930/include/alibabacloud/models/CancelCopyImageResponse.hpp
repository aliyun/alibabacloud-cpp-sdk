...
namespace Models
{
  ...
  public:
    ...
    inline const CancelCopyImageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelCopyImageResponseBody) };
    inline CancelCopyImageResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelCopyImageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelCopyImageResponseBody> body_ {};
  };
