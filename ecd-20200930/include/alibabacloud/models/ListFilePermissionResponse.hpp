...
namespace Models
{
  ...
  public:
    ...
    inline const ListFilePermissionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListFilePermissionResponseBody) };
    inline ListFilePermissionResponseBody body() { DARABONBA_PTR_GET(body_, ListFilePermissionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListFilePermissionResponseBody> body_ = nullptr;
  };
