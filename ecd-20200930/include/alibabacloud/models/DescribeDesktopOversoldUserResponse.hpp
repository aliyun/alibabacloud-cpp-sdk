...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDesktopOversoldUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDesktopOversoldUserResponseBody) };
    inline DescribeDesktopOversoldUserResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDesktopOversoldUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDesktopOversoldUserResponseBody> body_ {};
  };
