...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->connectionStatus_ == nullptr
        && return this->desktopId_ == nullptr && return this->desktopName_ == nullptr && return this->desktopStatus_ == nullptr && return this->diskType_ == nullptr && return this->endUserId_ == nullptr
        && return this->endUserIds_ == nullptr && return this->endUserName_ == nullptr && return this->endUserNames_ == nullptr && return this->expiredTime_ == nullptr && return this->fotaVersion_ == nullptr
        && return this->gpuDriverVersion_ == nullptr && return this->imageId_ == nullptr && return this->imageName_ == nullptr && return this->managementFlag_ == nullptr && return this->managementFlags_ == nullptr
        && return this->memberEniIp_ == nullptr && return this->osType_ == nullptr && return this->primaryEniIp_ == nullptr && return this->protocolType_ == nullptr && return this->resetTime_ == nullptr
