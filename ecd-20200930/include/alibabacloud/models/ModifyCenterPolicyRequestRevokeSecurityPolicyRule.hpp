...
#ifndef ALIBABACLOUD_MODELS_MODIFYCENTERPOLICYREQUESTREVOKESECURITYPOLICYRULE_HPP_
#define ALIBABACLOUD_MODELS_MODIFYCENTERPOLICYREQUESTREVOKESECURITYPOLICYRULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyCenterPolicyRequestRevokeSecurityPolicyRule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyCenterPolicyRequestRevokeSecurityPolicyRule& obj) { 
    ...
    ModifyCenterPolicyRequestRevokeSecurityPolicyRule() = default ;
    ModifyCenterPolicyRequestRevokeSecurityPolicyRule(const ModifyCenterPolicyRequestRevokeSecurityPolicyRule &) = default ;
    ModifyCenterPolicyRequestRevokeSecurityPolicyRule(ModifyCenterPolicyRequestRevokeSecurityPolicyRule &&) = default ;
    ModifyCenterPolicyRequestRevokeSecurityPolicyRule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyCenterPolicyRequestRevokeSecurityPolicyRule() = default ;
    ModifyCenterPolicyRequestRevokeSecurityPolicyRule& operator=(const ModifyCenterPolicyRequestRevokeSecurityPolicyRule &) = default ;
    ModifyCenterPolicyRequestRevokeSecurityPolicyRule& operator=(ModifyCenterPolicyRequestRevokeSecurityPolicyRule &&) = default ;
    ...
    inline ModifyCenterPolicyRequestRevokeSecurityPolicyRule& setCidrIp(string cidrIp) { DARABONBA_PTR_SET_VALUE(cidrIp_, cidrIp) };
    ...
    inline ModifyCenterPolicyRequestRevokeSecurityPolicyRule& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ModifyCenterPolicyRequestRevokeSecurityPolicyRule& setIpProtocol(string ipProtocol) { DARABONBA_PTR_SET_VALUE(ipProtocol_, ipProtocol) };
    ...
    inline ModifyCenterPolicyRequestRevokeSecurityPolicyRule& setPolicy(string policy) { DARABONBA_PTR_SET_VALUE(policy_, policy) };
    ...
    inline ModifyCenterPolicyRequestRevokeSecurityPolicyRule& setPortRange(string portRange) { DARABONBA_PTR_SET_VALUE(portRange_, portRange) };
    ...
    inline ModifyCenterPolicyRequestRevokeSecurityPolicyRule& setPriority(string priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline ModifyCenterPolicyRequestRevokeSecurityPolicyRule& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
