...
#ifndef ALIBABACLOUD_MODELS_MODIFYPOLICYGROUPREQUESTUSBSUPPLYREDIRECTRULE_HPP_
#define ALIBABACLOUD_MODELS_MODIFYPOLICYGROUPREQUESTUSBSUPPLYREDIRECTRULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyPolicyGroupRequestUsbSupplyRedirectRule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyPolicyGroupRequestUsbSupplyRedirectRule& obj) { 
    ...
    ModifyPolicyGroupRequestUsbSupplyRedirectRule() = default ;
    ModifyPolicyGroupRequestUsbSupplyRedirectRule(const ModifyPolicyGroupRequestUsbSupplyRedirectRule &) = default ;
    ModifyPolicyGroupRequestUsbSupplyRedirectRule(ModifyPolicyGroupRequestUsbSupplyRedirectRule &&) = default ;
    ModifyPolicyGroupRequestUsbSupplyRedirectRule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyPolicyGroupRequestUsbSupplyRedirectRule() = default ;
    ModifyPolicyGroupRequestUsbSupplyRedirectRule& operator=(const ModifyPolicyGroupRequestUsbSupplyRedirectRule &) = default ;
    ModifyPolicyGroupRequestUsbSupplyRedirectRule& operator=(ModifyPolicyGroupRequestUsbSupplyRedirectRule &&) = default ;
    ...
    inline ModifyPolicyGroupRequestUsbSupplyRedirectRule& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ModifyPolicyGroupRequestUsbSupplyRedirectRule& setDeviceClass(string deviceClass) { DARABONBA_PTR_SET_VALUE(deviceClass_, deviceClass) };
    ...
    inline ModifyPolicyGroupRequestUsbSupplyRedirectRule& setDeviceSubclass(string deviceSubclass) { DARABONBA_PTR_SET_VALUE(deviceSubclass_, deviceSubclass) };
    ...
    inline ModifyPolicyGroupRequestUsbSupplyRedirectRule& setProductId(string productId) { DARABONBA_PTR_SET_VALUE(productId_, productId) };
    ...
    inline ModifyPolicyGroupRequestUsbSupplyRedirectRule& setUsbRedirectType(int64_t usbRedirectType) { DARABONBA_PTR_SET_VALUE(usbRedirectType_, usbRedirectType) };
    ...
    inline ModifyPolicyGroupRequestUsbSupplyRedirectRule& setUsbRuleType(int64_t usbRuleType) { DARABONBA_PTR_SET_VALUE(usbRuleType_, usbRuleType) };
    ...
    inline ModifyPolicyGroupRequestUsbSupplyRedirectRule& setVendorId(string vendorId) { DARABONBA_PTR_SET_VALUE(vendorId_, vendorId) };
