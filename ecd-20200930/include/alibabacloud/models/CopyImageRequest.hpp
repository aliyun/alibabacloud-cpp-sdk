...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->destinationDescription_ == nullptr
        && this->destinationImageName_ == nullptr && this->destinationRegionId_ == nullptr && this->imageId_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline string getDestinationDescription() const { DARABONBA_PTR_GET_DEFAULT(destinationDescription_, "") };
    ...
    inline string getDestinationImageName() const { DARABONBA_PTR_GET_DEFAULT(destinationImageName_, "") };
