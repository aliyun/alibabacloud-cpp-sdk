...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAclEntriesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyAclEntriesResponseBody) };
    inline ModifyAclEntriesResponseBody body() { DARABONBA_PTR_GET(body_, ModifyAclEntriesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyAclEntriesResponseBody> body_ = nullptr;
  };
