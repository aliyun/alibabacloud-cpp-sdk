...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyCoordinationForMonitoringResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApplyCoordinationForMonitoringResponseBody) };
    inline ApplyCoordinationForMonitoringResponseBody getBody() { DARABONBA_PTR_GET(body_, ApplyCoordinationForMonitoringResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApplyCoordinationForMonitoringResponseBody> body_ {};
  };
