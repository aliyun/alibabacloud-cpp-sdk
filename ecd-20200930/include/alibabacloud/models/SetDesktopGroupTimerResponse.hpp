...
namespace Models
{
  ...
  public:
    ...
    inline const SetDesktopGroupTimerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetDesktopGroupTimerResponseBody) };
    inline SetDesktopGroupTimerResponseBody body() { DARABONBA_PTR_GET(body_, SetDesktopGroupTimerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetDesktopGroupTimerResponseBody> body_ = nullptr;
  };
