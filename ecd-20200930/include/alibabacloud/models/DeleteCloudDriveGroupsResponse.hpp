...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteCloudDriveGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteCloudDriveGroupsResponseBody) };
    inline DeleteCloudDriveGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteCloudDriveGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteCloudDriveGroupsResponseBody> body_ {};
  };
