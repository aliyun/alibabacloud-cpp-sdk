...
namespace Models
{
  ...
  public:
    ...
    inline const ListOfficeSiteUsersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOfficeSiteUsersResponseBody) };
    inline ListOfficeSiteUsersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOfficeSiteUsersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOfficeSiteUsersResponseBody> body_ {};
  };
