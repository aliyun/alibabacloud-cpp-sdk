...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adHostname_ == nullptr
        && this->backupDCHostname_ == nullptr && this->backupDns_ == nullptr && this->dnsAddress_ == nullptr && this->domainName_ == nullptr && this->domainPassword_ == nullptr
        && this->domainUserName_ == nullptr && this->mfaEnabled_ == nullptr && this->OUName_ == nullptr && this->officeSiteId_ == nullptr && this->officeSiteName_ == nullptr
        && this->regionId_ == nullptr && this->subDomainDnsAddress_ == nullptr && this->subDomainName_ == nullptr; };
