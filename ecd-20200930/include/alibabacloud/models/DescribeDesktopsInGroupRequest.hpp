...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getCustomEndTimePeriod() const { DARABONBA_PTR_GET_DEFAULT(customEndTimePeriod_, 0L) };
    ...
    inline int64_t getCustomStartTimePeriod() const { DARABONBA_PTR_GET_DEFAULT(customStartTimePeriod_, 0L) };
    ...
    inline bool getIgnoreDeleted() const { DARABONBA_PTR_GET_DEFAULT(ignoreDeleted_, false) };
