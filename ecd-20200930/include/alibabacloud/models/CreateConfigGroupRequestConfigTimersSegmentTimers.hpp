...
#ifndef ALIBABACLOUD_MODELS_CREATECONFIGGROUPREQUESTCONFIGTIMERSSEGMENTTIMERS_HPP_
#define ALIBABACLOUD_MODELS_CREATECONFIGGROUPREQUESTCONFIGTIMERSSEGMENTTIMERS_HPP_
...
namespace Models
{
  ...
  public:
    ...
    CreateConfigGroupRequestConfigTimersSegmentTimers() = default ;
    CreateConfigGroupRequestConfigTimersSegmentTimers(const CreateConfigGroupRequestConfigTimersSegmentTimers &) = default ;
    CreateConfigGroupRequestConfigTimersSegmentTimers(CreateConfigGroupRequestConfigTimersSegmentTimers &&) = default ;
    CreateConfigGroupRequestConfigTimersSegmentTimers(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateConfigGroupRequestConfigTimersSegmentTimers() = default ;
    CreateConfigGroupRequestConfigTimersSegmentTimers& operator=(const CreateConfigGroupRequestConfigTimersSegmentTimers &) = default ;
    CreateConfigGroupRequestConfigTimersSegmentTimers& operator=(CreateConfigGroupRequestConfigTimersSegmentTimers &&) = default ;
    ...
    inline CreateConfigGroupRequestConfigTimersSegmentTimers& setEndCronExpression(string endCronExpression) { DARABONBA_PTR_SET_VALUE(endCronExpression_, endCronExpression) };
    ...
    inline CreateConfigGroupRequestConfigTimersSegmentTimers& setNotificationTime(int32_t notificationTime) { DARABONBA_PTR_SET_VALUE(notificationTime_, notificationTime) };
    ...
    inline CreateConfigGroupRequestConfigTimersSegmentTimers& setOperationType(string operationType) { DARABONBA_PTR_SET_VALUE(operationType_, operationType) };
    ...
    inline CreateConfigGroupRequestConfigTimersSegmentTimers& setProcessWhitelist(const vector<string> & processWhitelist) { DARABONBA_PTR_SET_VALUE(processWhitelist_, processWhitelist) };
    inline CreateConfigGroupRequestConfigTimersSegmentTimers& setProcessWhitelist(vector<string> && processWhitelist) { DARABONBA_PTR_SET_RVALUE(processWhitelist_, processWhitelist) };
    ...
    inline CreateConfigGroupRequestConfigTimersSegmentTimers& setResetType(string resetType) { DARABONBA_PTR_SET_VALUE(resetType_, resetType) };
    ...
    inline CreateConfigGroupRequestConfigTimersSegmentTimers& setStartCronExpression(string startCronExpression) { DARABONBA_PTR_SET_VALUE(startCronExpression_, startCronExpression) };
    ...
    inline CreateConfigGroupRequestConfigTimersSegmentTimers& setTimerOrder(int32_t timerOrder) { DARABONBA_PTR_SET_VALUE(timerOrder_, timerOrder) };
    ...
    inline CreateConfigGroupRequestConfigTimersSegmentTimers& setTimezone(string timezone) { DARABONBA_PTR_SET_VALUE(timezone_, timezone) };
    ...
    inline CreateConfigGroupRequestConfigTimersSegmentTimers& setTriggerType(string triggerType) { DARABONBA_PTR_SET_VALUE(triggerType_, triggerType) };
