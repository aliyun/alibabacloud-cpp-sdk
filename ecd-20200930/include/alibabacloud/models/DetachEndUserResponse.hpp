...
namespace Models
{
  ...
  public:
    ...
    inline const DetachEndUserResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachEndUserResponseBody) };
    inline DetachEndUserResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachEndUserResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachEndUserResponseBody> body_ {};
  };
