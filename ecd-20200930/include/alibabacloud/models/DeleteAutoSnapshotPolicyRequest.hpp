...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getPolicyId() const { DARABONBA_PTR_GET_CONST(policyId_, vector<string>) };
    inline vector<string> getPolicyId() { DARABONBA_PTR_GET(policyId_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> policyId_ {};
