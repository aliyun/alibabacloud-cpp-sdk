...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECENTERPOLICYLISTRESPONSEBODYDESCRIBEPOLICYGROUPSDEVICERULES_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECENTERPOLICYLISTRESPONSEBODYDESCRIBEPOLICYGROUPSDEVICERULES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules& obj) { 
    ...
    DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules() = default ;
    DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules(const DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules &) = default ;
    DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules(DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules &&) = default ;
    DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules() = default ;
    DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules& operator=(const DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules &) = default ;
    DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules& operator=(DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules &&) = default ;
    ...
    inline DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules& setDeviceName(string deviceName) { DARABONBA_PTR_SET_VALUE(deviceName_, deviceName) };
    ...
    inline DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules& setDevicePid(string devicePid) { DARABONBA_PTR_SET_VALUE(devicePid_, devicePid) };
    ...
    inline DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules& setDeviceType(string deviceType) { DARABONBA_PTR_SET_VALUE(deviceType_, deviceType) };
    ...
    inline DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules& setDeviceVid(string deviceVid) { DARABONBA_PTR_SET_VALUE(deviceVid_, deviceVid) };
    ...
    inline DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules& setOptCommand(string optCommand) { DARABONBA_PTR_SET_VALUE(optCommand_, optCommand) };
    ...
    inline DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules& setPlatforms(string platforms) { DARABONBA_PTR_SET_VALUE(platforms_, platforms) };
    ...
    inline DescribeCenterPolicyListResponseBodyDescribePolicyGroupsDeviceRules& setRedirectType(string redirectType) { DARABONBA_PTR_SET_VALUE(redirectType_, redirectType) };
