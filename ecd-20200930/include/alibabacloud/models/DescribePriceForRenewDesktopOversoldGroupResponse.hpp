...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePriceForRenewDesktopOversoldGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePriceForRenewDesktopOversoldGroupResponseBody) };
    inline DescribePriceForRenewDesktopOversoldGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePriceForRenewDesktopOversoldGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePriceForRenewDesktopOversoldGroupResponseBody> body_ {};
  };
