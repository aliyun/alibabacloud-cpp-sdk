...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDesktopsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDesktopsResponseBody) };
    inline CreateDesktopsResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDesktopsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDesktopsResponseBody> body_ {};
  };
