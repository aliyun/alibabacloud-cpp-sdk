...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDesktopsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDesktopsResponseBody) };
    inline DescribeDesktopsResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDesktopsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDesktopsResponseBody> body_ = nullptr;
  };
