...
namespace Models
{
  ...
  public:
    ...
    inline const ListOfficeSiteOverviewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListOfficeSiteOverviewResponseBody) };
    inline ListOfficeSiteOverviewResponseBody getBody() { DARABONBA_PTR_GET(body_, ListOfficeSiteOverviewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListOfficeSiteOverviewResponseBody> body_ {};
  };
