...
namespace Models
{
  ...
  public:
    ...
    inline const SetDesktopGroupTimerStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SetDesktopGroupTimerStatusResponseBody) };
    inline SetDesktopGroupTimerStatusResponseBody body() { DARABONBA_PTR_GET(body_, SetDesktopGroupTimerStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SetDesktopGroupTimerStatusResponseBody> body_ = nullptr;
  };
