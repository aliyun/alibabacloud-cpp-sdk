...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEPRICEFORMODIFYDESKTOPOVERSOLDGROUPSALEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEPRICEFORMODIFYDESKTOPOVERSOLDGROUPSALEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribePriceForModifyDesktopOversoldGroupSaleRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribePriceForModifyDesktopOversoldGroupSaleRequest& obj) { 
    ...
    DescribePriceForModifyDesktopOversoldGroupSaleRequest() = default ;
    DescribePriceForModifyDesktopOversoldGroupSaleRequest(const DescribePriceForModifyDesktopOversoldGroupSaleRequest &) = default ;
    DescribePriceForModifyDesktopOversoldGroupSaleRequest(DescribePriceForModifyDesktopOversoldGroupSaleRequest &&) = default ;
    DescribePriceForModifyDesktopOversoldGroupSaleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribePriceForModifyDesktopOversoldGroupSaleRequest() = default ;
    DescribePriceForModifyDesktopOversoldGroupSaleRequest& operator=(const DescribePriceForModifyDesktopOversoldGroupSaleRequest &) = default ;
    DescribePriceForModifyDesktopOversoldGroupSaleRequest& operator=(DescribePriceForModifyDesktopOversoldGroupSaleRequest &&) = default ;
