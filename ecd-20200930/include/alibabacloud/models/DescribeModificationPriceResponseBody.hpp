...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeModificationPriceResponseBody::PriceInfo & getPriceInfo() const { DARABONBA_PTR_GET_CONST(priceInfo_, DescribeModificationPriceResponseBody::PriceInfo) };
    inline DescribeModificationPriceResponseBody::PriceInfo getPriceInfo() { DARABONBA_PTR_GET(priceInfo_, DescribeModificationPriceResponseBody::PriceInfo) };
    inline DescribeModificationPriceResponseBody& setPriceInfo(const DescribeModificationPriceResponseBody::PriceInfo & priceInfo) { DARABONBA_PTR_SET_VALUE(priceInfo_, priceInfo) };
    inline DescribeModificationPriceResponseBody& setPriceInfo(DescribeModificationPriceResponseBody::PriceInfo && priceInfo) { DARABONBA_PTR_SET_RVALUE(priceInfo_, priceInfo) };
  ...
  protected:
    // The price details.
    shared_ptr<DescribeModificationPriceResponseBody::PriceInfo> priceInfo_ {};
    // The request ID.
