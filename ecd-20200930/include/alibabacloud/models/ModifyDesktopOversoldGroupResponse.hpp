...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDesktopOversoldGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyDesktopOversoldGroupResponseBody) };
    inline ModifyDesktopOversoldGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyDesktopOversoldGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyDesktopOversoldGroupResponseBody> body_ {};
  };
