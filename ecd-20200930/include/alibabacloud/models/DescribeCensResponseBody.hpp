...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCensResponseBodyCens> & cens() const { DARABONBA_PTR_GET_CONST(cens_, vector<DescribeCensResponseBodyCens>) };
    inline vector<DescribeCensResponseBodyCens> cens() { DARABONBA_PTR_GET(cens_, vector<DescribeCensResponseBodyCens>) };
    inline DescribeCensResponseBody& setCens(const vector<DescribeCensResponseBodyCens> & cens) { DARABONBA_PTR_SET_VALUE(cens_, cens) };
    inline DescribeCensResponseBody& setCens(vector<DescribeCensResponseBodyCens> && cens) { DARABONBA_PTR_SET_RVALUE(cens_, cens) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeCensResponseBodyCens>> cens_ = nullptr;
    // The page number.
