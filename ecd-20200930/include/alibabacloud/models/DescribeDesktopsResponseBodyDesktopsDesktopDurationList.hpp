...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDESKTOPSRESPONSEBODYDESKTOPSDESKTOPDURATIONLIST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDESKTOPSRESPONSEBODYDESKTOPSDESKTOPDURATIONLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDesktopsResponseBodyDesktopsDesktopDurationList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDesktopsResponseBodyDesktopsDesktopDurationList& obj) { 
    ...
    DescribeDesktopsResponseBodyDesktopsDesktopDurationList() = default ;
    DescribeDesktopsResponseBodyDesktopsDesktopDurationList(const DescribeDesktopsResponseBodyDesktopsDesktopDurationList &) = default ;
    DescribeDesktopsResponseBodyDesktopsDesktopDurationList(DescribeDesktopsResponseBodyDesktopsDesktopDurationList &&) = default ;
    DescribeDesktopsResponseBodyDesktopsDesktopDurationList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDesktopsResponseBodyDesktopsDesktopDurationList() = default ;
    DescribeDesktopsResponseBodyDesktopsDesktopDurationList& operator=(const DescribeDesktopsResponseBodyDesktopsDesktopDurationList &) = default ;
    DescribeDesktopsResponseBodyDesktopsDesktopDurationList& operator=(DescribeDesktopsResponseBodyDesktopsDesktopDurationList &&) = default ;
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setOrderInstanceId(string orderInstanceId) { DARABONBA_PTR_SET_VALUE(orderInstanceId_, orderInstanceId) };
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setPackageCreationTime(string packageCreationTime) { DARABONBA_PTR_SET_VALUE(packageCreationTime_, packageCreationTime) };
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setPackageExpiredTime(string packageExpiredTime) { DARABONBA_PTR_SET_VALUE(packageExpiredTime_, packageExpiredTime) };
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setPackageId(string packageId) { DARABONBA_PTR_SET_VALUE(packageId_, packageId) };
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setPackageStatus(string packageStatus) { DARABONBA_PTR_SET_VALUE(packageStatus_, packageStatus) };
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setPackageType(string packageType) { DARABONBA_PTR_SET_VALUE(packageType_, packageType) };
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setPackageUsedUpStrategy(string packageUsedUpStrategy) { DARABONBA_PTR_SET_VALUE(packageUsedUpStrategy_, packageUsedUpStrategy) };
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setPeriodEndTime(string periodEndTime) { DARABONBA_PTR_SET_VALUE(periodEndTime_, periodEndTime) };
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setPeriodStartTime(string periodStartTime) { DARABONBA_PTR_SET_VALUE(periodStartTime_, periodStartTime) };
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setPostPaidLimitFee(float postPaidLimitFee) { DARABONBA_PTR_SET_VALUE(postPaidLimitFee_, postPaidLimitFee) };
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setTotalDuration(int64_t totalDuration) { DARABONBA_PTR_SET_VALUE(totalDuration_, totalDuration) };
    ...
    inline DescribeDesktopsResponseBodyDesktopsDesktopDurationList& setUsedDuration(int64_t usedDuration) { DARABONBA_PTR_SET_VALUE(usedDuration_, usedDuration) };
