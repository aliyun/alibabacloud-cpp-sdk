...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->amount_ != nullptr
        ...
        && this->chargeType_ != nullptr && this->desktopAttachmentShrink_ != nullptr && this->desktopMemberIp_ != nullptr && this->desktopName_ != nullptr && this->desktopNameSuffix_ != nullptr
    ...
    inline const vector<CreateDesktopsShrinkRequestBundleModels> & bundleModels() const { DARABONBA_PTR_GET_CONST(bundleModels_, vector<CreateDesktopsShrinkRequestBundleModels>) };
    inline vector<CreateDesktopsShrinkRequestBundleModels> bundleModels() { DARABONBA_PTR_GET(bundleModels_, vector<CreateDesktopsShrinkRequestBundleModels>) };
    inline CreateDesktopsShrinkRequest& setBundleModels(const vector<CreateDesktopsShrinkRequestBundleModels> & bundleModels) { DARABONBA_PTR_SET_VALUE(bundleModels_, bundleModels) };
    inline CreateDesktopsShrinkRequest& setBundleModels(vector<CreateDesktopsShrinkRequestBundleModels> && bundleModels) { DARABONBA_PTR_SET_RVALUE(bundleModels_, bundleModels) };
    ...
    inline string desktopAttachmentShrink() const { DARABONBA_PTR_GET_DEFAULT(desktopAttachmentShrink_, "") };
    ...
    inline const vector<CreateDesktopsShrinkRequestDesktopTimers> & desktopTimers() const { DARABONBA_PTR_GET_CONST(desktopTimers_, vector<CreateDesktopsShrinkRequestDesktopTimers>) };
    inline vector<CreateDesktopsShrinkRequestDesktopTimers> desktopTimers() { DARABONBA_PTR_GET(desktopTimers_, vector<CreateDesktopsShrinkRequestDesktopTimers>) };
    inline CreateDesktopsShrinkRequest& setDesktopTimers(const vector<CreateDesktopsShrinkRequestDesktopTimers> & desktopTimers) { DARABONBA_PTR_SET_VALUE(desktopTimers_, desktopTimers) };
    inline CreateDesktopsShrinkRequest& setDesktopTimers(vector<CreateDesktopsShrinkRequestDesktopTimers> && desktopTimers) { DARABONBA_PTR_SET_RVALUE(desktopTimers_, desktopTimers) };
    ...
    inline const CreateDesktopsShrinkRequestMonthDesktopSetting & monthDesktopSetting() const { DARABONBA_PTR_GET_CONST(monthDesktopSetting_, CreateDesktopsShrinkRequestMonthDesktopSetting) };
    inline CreateDesktopsShrinkRequestMonthDesktopSetting monthDesktopSetting() { DARABONBA_PTR_GET(monthDesktopSetting_, CreateDesktopsShrinkRequestMonthDesktopSetting) };
    inline CreateDesktopsShrinkRequest& setMonthDesktopSetting(const CreateDesktopsShrinkRequestMonthDesktopSetting & monthDesktopSetting) { DARABONBA_PTR_SET_VALUE(monthDesktopSetting_, monthDesktopSetting) };
    inline CreateDesktopsShrinkRequest& setMonthDesktopSetting(CreateDesktopsShrinkRequestMonthDesktopSetting && monthDesktopSetting) { DARABONBA_PTR_SET_RVALUE(monthDesktopSetting_, monthDesktopSetting) };
    ...
    inline const vector<CreateDesktopsShrinkRequestTag> & tag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateDesktopsShrinkRequestTag>) };
    inline vector<CreateDesktopsShrinkRequestTag> tag() { DARABONBA_PTR_GET(tag_, vector<CreateDesktopsShrinkRequestTag>) };
    inline CreateDesktopsShrinkRequest& setTag(const vector<CreateDesktopsShrinkRequestTag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateDesktopsShrinkRequest& setTag(vector<CreateDesktopsShrinkRequestTag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
    ...
    inline const vector<CreateDesktopsShrinkRequestUserCommands> & userCommands() const { DARABONBA_PTR_GET_CONST(userCommands_, vector<CreateDesktopsShrinkRequestUserCommands>) };
    inline vector<CreateDesktopsShrinkRequestUserCommands> userCommands() { DARABONBA_PTR_GET(userCommands_, vector<CreateDesktopsShrinkRequestUserCommands>) };
    inline CreateDesktopsShrinkRequest& setUserCommands(const vector<CreateDesktopsShrinkRequestUserCommands> & userCommands) { DARABONBA_PTR_SET_VALUE(userCommands_, userCommands) };
    inline CreateDesktopsShrinkRequest& setUserCommands(vector<CreateDesktopsShrinkRequestUserCommands> && userCommands) { DARABONBA_PTR_SET_RVALUE(userCommands_, userCommands) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CreateDesktopsShrinkRequestBundleModels>> bundleModels_ = nullptr;
    ...
    std::shared_ptr<string> desktopAttachmentShrink_ = nullptr;
    ...
    std::shared_ptr<vector<CreateDesktopsShrinkRequestDesktopTimers>> desktopTimers_ = nullptr;
    ...
    // > This parameter is not publicly available.
    std::shared_ptr<CreateDesktopsShrinkRequestMonthDesktopSetting> monthDesktopSetting_ = nullptr;
    ...
    std::shared_ptr<vector<CreateDesktopsShrinkRequestUserCommands>> userCommands_ = nullptr;
    // >  This parameter is not publicly available.
