...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEduRoomResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteEduRoomResponseBody) };
    inline DeleteEduRoomResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteEduRoomResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteEduRoomResponseBody> body_ {};
  };
