...
namespace Models
{
  ...
  public:
    ...
    inline DescribePriceResponseBodyPriceInfoRules& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribePriceResponseBodyPriceInfoRules& setRuleId(int64_t ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
