...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePriceForRenewDesktopOversoldGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribePriceForRenewDesktopOversoldGroupResponseBodyData) };
    inline DescribePriceForRenewDesktopOversoldGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribePriceForRenewDesktopOversoldGroupResponseBodyData) };
    inline DescribePriceForRenewDesktopOversoldGroupResponseBody& setData(const DescribePriceForRenewDesktopOversoldGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribePriceForRenewDesktopOversoldGroupResponseBody& setData(DescribePriceForRenewDesktopOversoldGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<DescribePriceForRenewDesktopOversoldGroupResponseBodyData> data_ = nullptr;
