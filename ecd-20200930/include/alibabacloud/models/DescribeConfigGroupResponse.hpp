...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeConfigGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeConfigGroupResponseBody) };
    inline DescribeConfigGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeConfigGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeConfigGroupResponseBody> body_ {};
  };
