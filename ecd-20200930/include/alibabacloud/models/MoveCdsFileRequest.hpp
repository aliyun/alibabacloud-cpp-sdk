...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cdsId_ == nullptr
        && return this->conflictPolicy_ == nullptr && return this->endUserId_ == nullptr && return this->fileId_ == nullptr && return this->groupId_ == nullptr && return this->parentFolderId_ == nullptr
