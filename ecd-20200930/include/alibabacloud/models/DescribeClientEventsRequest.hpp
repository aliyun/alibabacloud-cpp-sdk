...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->desktopId_ == nullptr
        && return this->desktopIp_ == nullptr && return this->desktopName_ == nullptr && return this->directoryId_ == nullptr && return this->endTime_ == nullptr && return this->endUserId_ == nullptr
        && return this->eventType_ == nullptr && return this->eventTypes_ == nullptr && return this->fillHardwareInfo_ == nullptr && return this->language_ == nullptr && return this->maxResults_ == nullptr
        && return this->nextToken_ == nullptr && return this->officeSiteId_ == nullptr && return this->officeSiteName_ == nullptr && return this->regionId_ == nullptr && return this->startTime_ == nullptr; };
