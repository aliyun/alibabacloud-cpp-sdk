...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessChannel_ == nullptr
        && this->externalPolicyGroupIds_ == nullptr && this->maxResults_ == nullptr && this->nextToken_ == nullptr && this->pageNumber_ == nullptr && this->pageSize_ == nullptr
        && this->policyGroupId_ == nullptr && this->regionId_ == nullptr && this->scope_ == nullptr; };
    ...
    inline const vector<string> & getExternalPolicyGroupIds() const { DARABONBA_PTR_GET_CONST(externalPolicyGroupIds_, vector<string>) };
    inline vector<string> getExternalPolicyGroupIds() { DARABONBA_PTR_GET(externalPolicyGroupIds_, vector<string>) };
