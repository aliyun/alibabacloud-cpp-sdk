...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEcdReportTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEcdReportTasksResponseBody) };
    inline DescribeEcdReportTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEcdReportTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEcdReportTasksResponseBody> body_ {};
  };
