...
namespace Models
{
  ...
  public:
    ...
    inline DescribeRenewalPriceResponseBodyPriceInfoRules& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeRenewalPriceResponseBodyPriceInfoRules& setRuleId(int64_t ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
