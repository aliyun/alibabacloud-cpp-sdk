...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFlowStatisticResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeFlowStatisticResponseBody) };
    inline DescribeFlowStatisticResponseBody body() { DARABONBA_PTR_GET(body_, DescribeFlowStatisticResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeFlowStatisticResponseBody> body_ = nullptr;
  };
