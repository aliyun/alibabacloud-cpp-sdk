...
namespace Models
{
  ...
  public:
    ...
    inline string getFotaStatus() const { DARABONBA_PTR_GET_DEFAULT(fotaStatus_, "") };
    ...
    inline const vector<string> & getTaskUid() const { DARABONBA_PTR_GET_CONST(taskUid_, vector<string>) };
    inline vector<string> getTaskUid() { DARABONBA_PTR_GET(taskUid_, vector<string>) };
