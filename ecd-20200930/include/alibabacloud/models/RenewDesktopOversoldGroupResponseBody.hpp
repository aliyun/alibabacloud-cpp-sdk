...
namespace Models
{
  ...
  public:
    ...
    inline const RenewDesktopOversoldGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, RenewDesktopOversoldGroupResponseBodyData) };
    inline RenewDesktopOversoldGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, RenewDesktopOversoldGroupResponseBodyData) };
    inline RenewDesktopOversoldGroupResponseBody& setData(const RenewDesktopOversoldGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline RenewDesktopOversoldGroupResponseBody& setData(RenewDesktopOversoldGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    std::shared_ptr<RenewDesktopOversoldGroupResponseBodyData> data_ = nullptr;
