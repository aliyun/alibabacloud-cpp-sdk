...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currency_ == nullptr
        && return this->discountPrice_ == nullptr && return this->orderLines_ == nullptr && return this->originalPrice_ == nullptr && return this->promotions_ == nullptr && return this->spPrice_ == nullptr
