...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCenterPolicyListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCenterPolicyListResponseBody) };
    inline DescribeCenterPolicyListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCenterPolicyListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCenterPolicyListResponseBody> body_ {};
  };
