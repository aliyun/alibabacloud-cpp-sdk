...
namespace Models
{
  ...
  public:
    ...
    inline const SetDirectorySsoStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetDirectorySsoStatusResponseBody) };
    inline SetDirectorySsoStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, SetDirectorySsoStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetDirectorySsoStatusResponseBody> body_ {};
  };
