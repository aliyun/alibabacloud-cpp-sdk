...
#ifndef ALIBABACLOUD_MODELS_CREATEPOLICYGROUPREQUESTAUTHORIZESECURITYPOLICYRULE_HPP_
#define ALIBABACLOUD_MODELS_CREATEPOLICYGROUPREQUESTAUTHORIZESECURITYPOLICYRULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePolicyGroupRequestAuthorizeSecurityPolicyRule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePolicyGroupRequestAuthorizeSecurityPolicyRule& obj) { 
    ...
    CreatePolicyGroupRequestAuthorizeSecurityPolicyRule() = default ;
    CreatePolicyGroupRequestAuthorizeSecurityPolicyRule(const CreatePolicyGroupRequestAuthorizeSecurityPolicyRule &) = default ;
    CreatePolicyGroupRequestAuthorizeSecurityPolicyRule(CreatePolicyGroupRequestAuthorizeSecurityPolicyRule &&) = default ;
    CreatePolicyGroupRequestAuthorizeSecurityPolicyRule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePolicyGroupRequestAuthorizeSecurityPolicyRule() = default ;
    CreatePolicyGroupRequestAuthorizeSecurityPolicyRule& operator=(const CreatePolicyGroupRequestAuthorizeSecurityPolicyRule &) = default ;
    CreatePolicyGroupRequestAuthorizeSecurityPolicyRule& operator=(CreatePolicyGroupRequestAuthorizeSecurityPolicyRule &&) = default ;
    ...
    inline CreatePolicyGroupRequestAuthorizeSecurityPolicyRule& setCidrIp(string cidrIp) { DARABONBA_PTR_SET_VALUE(cidrIp_, cidrIp) };
    ...
    inline CreatePolicyGroupRequestAuthorizeSecurityPolicyRule& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline CreatePolicyGroupRequestAuthorizeSecurityPolicyRule& setIpProtocol(string ipProtocol) { DARABONBA_PTR_SET_VALUE(ipProtocol_, ipProtocol) };
    ...
    inline CreatePolicyGroupRequestAuthorizeSecurityPolicyRule& setPolicy(string policy) { DARABONBA_PTR_SET_VALUE(policy_, policy) };
    ...
    inline CreatePolicyGroupRequestAuthorizeSecurityPolicyRule& setPortRange(string portRange) { DARABONBA_PTR_SET_VALUE(portRange_, portRange) };
    ...
    inline CreatePolicyGroupRequestAuthorizeSecurityPolicyRule& setPriority(string priority) { DARABONBA_PTR_SET_VALUE(priority_, priority) };
    ...
    inline CreatePolicyGroupRequestAuthorizeSecurityPolicyRule& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
