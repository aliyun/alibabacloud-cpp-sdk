...
namespace Models
{
  ...
  public:
    ...
    inline const ResetDesktopsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ResetDesktopsResponseBody) };
    inline ResetDesktopsResponseBody getBody() { DARABONBA_PTR_GET(body_, ResetDesktopsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ResetDesktopsResponseBody> body_ {};
  };
