...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->message_ == nullptr && return this->moveCdsFileModel_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const MoveCdsFileResponseBodyMoveCdsFileModel & moveCdsFileModel() const { DARABONBA_PTR_GET_CONST(moveCdsFileModel_, MoveCdsFileResponseBodyMoveCdsFileModel) };
    inline MoveCdsFileResponseBodyMoveCdsFileModel moveCdsFileModel() { DARABONBA_PTR_GET(moveCdsFileModel_, MoveCdsFileResponseBodyMoveCdsFileModel) };
    inline MoveCdsFileResponseBody& setMoveCdsFileModel(const MoveCdsFileResponseBodyMoveCdsFileModel & moveCdsFileModel) { DARABONBA_PTR_SET_VALUE(moveCdsFileModel_, moveCdsFileModel) };
    inline MoveCdsFileResponseBody& setMoveCdsFileModel(MoveCdsFileResponseBodyMoveCdsFileModel && moveCdsFileModel) { DARABONBA_PTR_SET_RVALUE(moveCdsFileModel_, moveCdsFileModel) };
  ...
  protected:
    ...
    std::shared_ptr<MoveCdsFileResponseBodyMoveCdsFileModel> moveCdsFileModel_ = nullptr;
