...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->academicProxy_ == nullptr
        ...
        && this->mobileWuyingKeeper_ == nullptr && this->mobileWyAssistant_ == nullptr && this->modelLibrary_ == nullptr && this->multiScreen_ == nullptr && this->name_ == nullptr
        && this->netRedirect_ == nullptr && this->netRedirectRule_ == nullptr && this->noOperationDisconnect_ == nullptr && this->noOperationDisconnectTime_ == nullptr && this->policyGroupId_ == nullptr
        && this->portProxy_ == nullptr && this->printerAlert_ == nullptr && this->printerAlertContent_ == nullptr && this->printerAlertTitle_ == nullptr && this->printerRedirect_ == nullptr
        && this->qualityEnhancement_ == nullptr && this->recordEventDuration_ == nullptr && this->recordEventFileExts_ == nullptr && this->recordEventFilePaths_ == nullptr && this->recordEventLevels_ == nullptr
        && this->recordEventRegisters_ == nullptr && this->recordEvents_ == nullptr && this->recording_ == nullptr && this->recordingAudio_ == nullptr && this->recordingDuration_ == nullptr
        ...
        && this->recordingUserNotifyMessage_ == nullptr && this->regionId_ == nullptr && this->remoteCoordinate_ == nullptr && this->resetDesktop_ == nullptr && this->resolutionDpi_ == nullptr
        && this->resolutionHeight_ == nullptr && this->resolutionModel_ == nullptr && this->resolutionWidth_ == nullptr && this->resourceType_ == nullptr && this->revokeAccessPolicyRule_ == nullptr
        && this->revokeSecurityPolicyRule_ == nullptr && this->safeMenu_ == nullptr && this->scope_ == nullptr && this->scopeValue_ == nullptr && this->screenDisplayMode_ == nullptr
        ...
        && this->taskbar_ == nullptr && this->threeScreen_ == nullptr && this->usbRedirect_ == nullptr && this->usbSupplyRedirectRule_ == nullptr && this->useTime_ == nullptr
        ...
        && this->watermarkType_ == nullptr && this->wuyingKeeper_ == nullptr && this->wyAssistant_ == nullptr; };
    ...
    inline ModifyCenterPolicyRequest& setAdminKeyboardOnFullScreen(string adminKeyboardOnFullScreen) { DARABONBA_PTR_SET_VALUE(adminKeyboardOnFullScreen_, adminKeyboardOnFullScreen) };
    ...
    inline ModifyCenterPolicyRequest& setAdminKeyboardOnWindows(string adminKeyboardOnWindows) { DARABONBA_PTR_SET_VALUE(adminKeyboardOnWindows_, adminKeyboardOnWindows) };
    ...
    inline const vector<ModifyCenterPolicyRequest::AuthorizeAccessPolicyRule> & getAuthorizeAccessPolicyRule() const { DARABONBA_PTR_GET_CONST(authorizeAccessPolicyRule_, vector<ModifyCenterPolicyRequest::AuthorizeAccessPolicyRule>) };
    inline vector<ModifyCenterPolicyRequest::AuthorizeAccessPolicyRule> getAuthorizeAccessPolicyRule() { DARABONBA_PTR_GET(authorizeAccessPolicyRule_, vector<ModifyCenterPolicyRequest::AuthorizeAccessPolicyRule>) };
    inline ModifyCenterPolicyRequest& setAuthorizeAccessPolicyRule(const vector<ModifyCenterPolicyRequest::AuthorizeAccessPolicyRule> & authorizeAccessPolicyRule) { DARABONBA_PTR_SET_VALUE(authorizeAccessPolicyRule_, authorizeAccessPolicyRule) };
    inline ModifyCenterPolicyRequest& setAuthorizeAccessPolicyRule(vector<ModifyCenterPolicyRequest::AuthorizeAccessPolicyRule> && authorizeAccessPolicyRule) { DARABONBA_PTR_SET_RVALUE(authorizeAccessPolicyRule_, authorizeAccessPolicyRule) };
    ...
    inline const vector<ModifyCenterPolicyRequest::AuthorizeSecurityPolicyRule> & getAuthorizeSecurityPolicyRule() const { DARABONBA_PTR_GET_CONST(authorizeSecurityPolicyRule_, vector<ModifyCenterPolicyRequest::AuthorizeSecurityPolicyRule>) };
    inline vector<ModifyCenterPolicyRequest::AuthorizeSecurityPolicyRule> getAuthorizeSecurityPolicyRule() { DARABONBA_PTR_GET(authorizeSecurityPolicyRule_, vector<ModifyCenterPolicyRequest::AuthorizeSecurityPolicyRule>) };
    inline ModifyCenterPolicyRequest& setAuthorizeSecurityPolicyRule(const vector<ModifyCenterPolicyRequest::AuthorizeSecurityPolicyRule> & authorizeSecurityPolicyRule) { DARABONBA_PTR_SET_VALUE(authorizeSecurityPolicyRule_, authorizeSecurityPolicyRule) };
    inline ModifyCenterPolicyRequest& setAuthorizeSecurityPolicyRule(vector<ModifyCenterPolicyRequest::AuthorizeSecurityPolicyRule> && authorizeSecurityPolicyRule) { DARABONBA_PTR_SET_RVALUE(authorizeSecurityPolicyRule_, authorizeSecurityPolicyRule) };
    ...
    inline ModifyCenterPolicyRequest& setClientCreateSnapshot(string clientCreateSnapshot) { DARABONBA_PTR_SET_VALUE(clientCreateSnapshot_, clientCreateSnapshot) };


    // clientType Field Functions 
    bool hasClientType() const { return this->clientType_ != nullptr;};
    void deleteClientType() { this->clientType_ = nullptr;};
    inline const vector<ModifyCenterPolicyRequest::ClientType> & getClientType() const { DARABONBA_PTR_GET_CONST(clientType_, vector<ModifyCenterPolicyRequest::ClientType>) };
    inline vector<ModifyCenterPolicyRequest::ClientType> getClientType() { DARABONBA_PTR_GET(clientType_, vector<ModifyCenterPolicyRequest::ClientType>) };
    inline ModifyCenterPolicyRequest& setClientType(const vector<ModifyCenterPolicyRequest::ClientType> & clientType) { DARABONBA_PTR_SET_VALUE(clientType_, clientType) };
    inline ModifyCenterPolicyRequest& setClientType(vector<ModifyCenterPolicyRequest::ClientType> && clientType) { DARABONBA_PTR_SET_RVALUE(clientType_, clientType) };
    ...
    inline const vector<ModifyCenterPolicyRequest::ClipboardGraineds> & getClipboardGraineds() const { DARABONBA_PTR_GET_CONST(clipboardGraineds_, vector<ModifyCenterPolicyRequest::ClipboardGraineds>) };
    inline vector<ModifyCenterPolicyRequest::ClipboardGraineds> getClipboardGraineds() { DARABONBA_PTR_GET(clipboardGraineds_, vector<ModifyCenterPolicyRequest::ClipboardGraineds>) };
    inline ModifyCenterPolicyRequest& setClipboardGraineds(const vector<ModifyCenterPolicyRequest::ClipboardGraineds> & clipboardGraineds) { DARABONBA_PTR_SET_VALUE(clipboardGraineds_, clipboardGraineds) };
    inline ModifyCenterPolicyRequest& setClipboardGraineds(vector<ModifyCenterPolicyRequest::ClipboardGraineds> && clipboardGraineds) { DARABONBA_PTR_SET_RVALUE(clipboardGraineds_, clipboardGraineds) };
    ...
    void deleteDescription() { this->description_ = nullptr;};
    inline string getDescription() const { DARABONBA_PTR_GET_DEFAULT(description_, "") };
    inline ModifyCenterPolicyRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline const vector<ModifyCenterPolicyRequest::DeviceRedirects> & getDeviceRedirects() const { DARABONBA_PTR_GET_CONST(deviceRedirects_, vector<ModifyCenterPolicyRequest::DeviceRedirects>) };
    inline vector<ModifyCenterPolicyRequest::DeviceRedirects> getDeviceRedirects() { DARABONBA_PTR_GET(deviceRedirects_, vector<ModifyCenterPolicyRequest::DeviceRedirects>) };
    inline ModifyCenterPolicyRequest& setDeviceRedirects(const vector<ModifyCenterPolicyRequest::DeviceRedirects> & deviceRedirects) { DARABONBA_PTR_SET_VALUE(deviceRedirects_, deviceRedirects) };
    inline ModifyCenterPolicyRequest& setDeviceRedirects(vector<ModifyCenterPolicyRequest::DeviceRedirects> && deviceRedirects) { DARABONBA_PTR_SET_RVALUE(deviceRedirects_, deviceRedirects) };
    ...
    inline const vector<ModifyCenterPolicyRequest::DeviceRules> & getDeviceRules() const { DARABONBA_PTR_GET_CONST(deviceRules_, vector<ModifyCenterPolicyRequest::DeviceRules>) };
    inline vector<ModifyCenterPolicyRequest::DeviceRules> getDeviceRules() { DARABONBA_PTR_GET(deviceRules_, vector<ModifyCenterPolicyRequest::DeviceRules>) };
    inline ModifyCenterPolicyRequest& setDeviceRules(const vector<ModifyCenterPolicyRequest::DeviceRules> & deviceRules) { DARABONBA_PTR_SET_VALUE(deviceRules_, deviceRules) };
    inline ModifyCenterPolicyRequest& setDeviceRules(vector<ModifyCenterPolicyRequest::DeviceRules> && deviceRules) { DARABONBA_PTR_SET_RVALUE(deviceRules_, deviceRules) };
    ...
    inline const vector<ModifyCenterPolicyRequest::DomainResolveRule> & getDomainResolveRule() const { DARABONBA_PTR_GET_CONST(domainResolveRule_, vector<ModifyCenterPolicyRequest::DomainResolveRule>) };
    inline vector<ModifyCenterPolicyRequest::DomainResolveRule> getDomainResolveRule() { DARABONBA_PTR_GET(domainResolveRule_, vector<ModifyCenterPolicyRequest::DomainResolveRule>) };
    inline ModifyCenterPolicyRequest& setDomainResolveRule(const vector<ModifyCenterPolicyRequest::DomainResolveRule> & domainResolveRule) { DARABONBA_PTR_SET_VALUE(domainResolveRule_, domainResolveRule) };
    inline ModifyCenterPolicyRequest& setDomainResolveRule(vector<ModifyCenterPolicyRequest::DomainResolveRule> && domainResolveRule) { DARABONBA_PTR_SET_RVALUE(domainResolveRule_, domainResolveRule) };
    ...
    inline ModifyCenterPolicyRequest& setExternalDrive(string externalDrive) { DARABONBA_PTR_SET_VALUE(externalDrive_, externalDrive) };
    ...
    inline string getFileTransferInSize() const { DARABONBA_PTR_GET_DEFAULT(fileTransferInSize_, "") };
    inline ModifyCenterPolicyRequest& setFileTransferInSize(string fileTransferInSize) { DARABONBA_PTR_SET_VALUE(fileTransferInSize_, fileTransferInSize) };
    ...
    inline ModifyCenterPolicyRequest& setFileTransferInUnit(string fileTransferInUnit) { DARABONBA_PTR_SET_VALUE(fileTransferInUnit_, fileTransferInUnit) };
    ...
    inline string getFileTransferOutSize() const { DARABONBA_PTR_GET_DEFAULT(fileTransferOutSize_, "") };
    inline ModifyCenterPolicyRequest& setFileTransferOutSize(string fileTransferOutSize) { DARABONBA_PTR_SET_VALUE(fileTransferOutSize_, fileTransferOutSize) };
    ...
    inline ModifyCenterPolicyRequest& setFileTransferOutUnit(string fileTransferOutUnit) { DARABONBA_PTR_SET_VALUE(fileTransferOutUnit_, fileTransferOutUnit) };
    ...
    inline ModifyCenterPolicyRequest& setFileTransferSizeLimit(string fileTransferSizeLimit) { DARABONBA_PTR_SET_VALUE(fileTransferSizeLimit_, fileTransferSizeLimit) };
    ...
    inline ModifyCenterPolicyRequest& setHoverConfigMsg(string hoverConfigMsg) { DARABONBA_PTR_SET_VALUE(hoverConfigMsg_, hoverConfigMsg) };
    ...
    inline ModifyCenterPolicyRequest& setMultiScreen(string multiScreen) { DARABONBA_PTR_SET_VALUE(multiScreen_, multiScreen) };
    ...
    inline const vector<ModifyCenterPolicyRequest::NetRedirectRule> & getNetRedirectRule() const { DARABONBA_PTR_GET_CONST(netRedirectRule_, vector<ModifyCenterPolicyRequest::NetRedirectRule>) };
    inline vector<ModifyCenterPolicyRequest::NetRedirectRule> getNetRedirectRule() { DARABONBA_PTR_GET(netRedirectRule_, vector<ModifyCenterPolicyRequest::NetRedirectRule>) };
    inline ModifyCenterPolicyRequest& setNetRedirectRule(const vector<ModifyCenterPolicyRequest::NetRedirectRule> & netRedirectRule) { DARABONBA_PTR_SET_VALUE(netRedirectRule_, netRedirectRule) };
    inline ModifyCenterPolicyRequest& setNetRedirectRule(vector<ModifyCenterPolicyRequest::NetRedirectRule> && netRedirectRule) { DARABONBA_PTR_SET_RVALUE(netRedirectRule_, netRedirectRule) };
    ...
    inline ModifyCenterPolicyRequest& setPrinterAlert(string printerAlert) { DARABONBA_PTR_SET_VALUE(printerAlert_, printerAlert) };
    ...
    inline ModifyCenterPolicyRequest& setPrinterAlertContent(string printerAlertContent) { DARABONBA_PTR_SET_VALUE(printerAlertContent_, printerAlertContent) };
    ...
    inline ModifyCenterPolicyRequest& setPrinterAlertTitle(string printerAlertTitle) { DARABONBA_PTR_SET_VALUE(printerAlertTitle_, printerAlertTitle) };
    ...
    inline const vector<ModifyCenterPolicyRequest::RecordEventLevels> & getRecordEventLevels() const { DARABONBA_PTR_GET_CONST(recordEventLevels_, vector<ModifyCenterPolicyRequest::RecordEventLevels>) };
    inline vector<ModifyCenterPolicyRequest::RecordEventLevels> getRecordEventLevels() { DARABONBA_PTR_GET(recordEventLevels_, vector<ModifyCenterPolicyRequest::RecordEventLevels>) };
    inline ModifyCenterPolicyRequest& setRecordEventLevels(const vector<ModifyCenterPolicyRequest::RecordEventLevels> & recordEventLevels) { DARABONBA_PTR_SET_VALUE(recordEventLevels_, recordEventLevels) };
    inline ModifyCenterPolicyRequest& setRecordEventLevels(vector<ModifyCenterPolicyRequest::RecordEventLevels> && recordEventLevels) { DARABONBA_PTR_SET_RVALUE(recordEventLevels_, recordEventLevels) };
    ...
    inline ModifyCenterPolicyRequest& setResolutionDpi(int32_t resolutionDpi) { DARABONBA_PTR_SET_VALUE(resolutionDpi_, resolutionDpi) };
    ...
    inline const vector<ModifyCenterPolicyRequest::RevokeAccessPolicyRule> & getRevokeAccessPolicyRule() const { DARABONBA_PTR_GET_CONST(revokeAccessPolicyRule_, vector<ModifyCenterPolicyRequest::RevokeAccessPolicyRule>) };
    inline vector<ModifyCenterPolicyRequest::RevokeAccessPolicyRule> getRevokeAccessPolicyRule() { DARABONBA_PTR_GET(revokeAccessPolicyRule_, vector<ModifyCenterPolicyRequest::RevokeAccessPolicyRule>) };
    inline ModifyCenterPolicyRequest& setRevokeAccessPolicyRule(const vector<ModifyCenterPolicyRequest::RevokeAccessPolicyRule> & revokeAccessPolicyRule) { DARABONBA_PTR_SET_VALUE(revokeAccessPolicyRule_, revokeAccessPolicyRule) };
    inline ModifyCenterPolicyRequest& setRevokeAccessPolicyRule(vector<ModifyCenterPolicyRequest::RevokeAccessPolicyRule> && revokeAccessPolicyRule) { DARABONBA_PTR_SET_RVALUE(revokeAccessPolicyRule_, revokeAccessPolicyRule) };
    ...
    inline const vector<ModifyCenterPolicyRequest::RevokeSecurityPolicyRule> & getRevokeSecurityPolicyRule() const { DARABONBA_PTR_GET_CONST(revokeSecurityPolicyRule_, vector<ModifyCenterPolicyRequest::RevokeSecurityPolicyRule>) };
    inline vector<ModifyCenterPolicyRequest::RevokeSecurityPolicyRule> getRevokeSecurityPolicyRule() { DARABONBA_PTR_GET(revokeSecurityPolicyRule_, vector<ModifyCenterPolicyRequest::RevokeSecurityPolicyRule>) };
    inline ModifyCenterPolicyRequest& setRevokeSecurityPolicyRule(const vector<ModifyCenterPolicyRequest::RevokeSecurityPolicyRule> & revokeSecurityPolicyRule) { DARABONBA_PTR_SET_VALUE(revokeSecurityPolicyRule_, revokeSecurityPolicyRule) };
    inline ModifyCenterPolicyRequest& setRevokeSecurityPolicyRule(vector<ModifyCenterPolicyRequest::RevokeSecurityPolicyRule> && revokeSecurityPolicyRule) { DARABONBA_PTR_SET_RVALUE(revokeSecurityPolicyRule_, revokeSecurityPolicyRule) };
    ...
    inline ModifyCenterPolicyRequest& setThreeScreen(string threeScreen) { DARABONBA_PTR_SET_VALUE(threeScreen_, threeScreen) };
    ...
    inline const vector<ModifyCenterPolicyRequest::UsbSupplyRedirectRule> & getUsbSupplyRedirectRule() const { DARABONBA_PTR_GET_CONST(usbSupplyRedirectRule_, vector<ModifyCenterPolicyRequest::UsbSupplyRedirectRule>) };
    inline vector<ModifyCenterPolicyRequest::UsbSupplyRedirectRule> getUsbSupplyRedirectRule() { DARABONBA_PTR_GET(usbSupplyRedirectRule_, vector<ModifyCenterPolicyRequest::UsbSupplyRedirectRule>) };
    inline ModifyCenterPolicyRequest& setUsbSupplyRedirectRule(const vector<ModifyCenterPolicyRequest::UsbSupplyRedirectRule> & usbSupplyRedirectRule) { DARABONBA_PTR_SET_VALUE(usbSupplyRedirectRule_, usbSupplyRedirectRule) };
    inline ModifyCenterPolicyRequest& setUsbSupplyRedirectRule(vector<ModifyCenterPolicyRequest::UsbSupplyRedirectRule> && usbSupplyRedirectRule) { DARABONBA_PTR_SET_RVALUE(usbSupplyRedirectRule_, usbSupplyRedirectRule) };
    ...
    inline ModifyCenterPolicyRequest& setWatermarkShadow(string watermarkShadow) { DARABONBA_PTR_SET_VALUE(watermarkShadow_, watermarkShadow) };
  ...
  protected:
    ...
    shared_ptr<vector<ModifyCenterPolicyRequest::AuthorizeAccessPolicyRule>> authorizeAccessPolicyRule_ {};
    // The list of security group control rules to add.
    shared_ptr<vector<ModifyCenterPolicyRequest::AuthorizeSecurityPolicyRule>> authorizeSecurityPolicyRule_ {};
    ...
    shared_ptr<vector<ModifyCenterPolicyRequest::ClientType>> clientType_ {};
    // The clipboard permission.
    shared_ptr<string> clipboard_ {};
    // The fine-grained clipboard control configurations.
    shared_ptr<vector<ModifyCenterPolicyRequest::ClipboardGraineds>> clipboardGraineds_ {};
    ...
    shared_ptr<vector<ModifyCenterPolicyRequest::DeviceRedirects>> deviceRedirects_ {};
    // The list of custom peripheral rules.
    shared_ptr<vector<ModifyCenterPolicyRequest::DeviceRules>> deviceRules_ {};
    ...
    shared_ptr<vector<ModifyCenterPolicyRequest::DomainResolveRule>> domainResolveRule_ {};
    ...
    // > This feature is in invitational preview and is not publicly available.
    // >
    shared_ptr<vector<ModifyCenterPolicyRequest::NetRedirectRule>> netRedirectRule_ {};
    ...
    shared_ptr<vector<ModifyCenterPolicyRequest::RecordEventLevels>> recordEventLevels_ {};
    ...
    shared_ptr<vector<ModifyCenterPolicyRequest::RevokeAccessPolicyRule>> revokeAccessPolicyRule_ {};
    // The list of security group rules to delete.
    shared_ptr<vector<ModifyCenterPolicyRequest::RevokeSecurityPolicyRule>> revokeSecurityPolicyRule_ {};
    ...
    shared_ptr<vector<ModifyCenterPolicyRequest::UsbSupplyRedirectRule>> usbSupplyRedirectRule_ {};
