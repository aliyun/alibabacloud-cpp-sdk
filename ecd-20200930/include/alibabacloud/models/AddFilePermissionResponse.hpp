...
namespace Models
{
  ...
  public:
    ...
    inline const AddFilePermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddFilePermissionResponseBody) };
    inline AddFilePermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, AddFilePermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddFilePermissionResponseBody> body_ {};
  };
