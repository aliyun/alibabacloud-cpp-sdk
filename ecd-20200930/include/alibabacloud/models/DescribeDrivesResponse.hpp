...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDrivesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDrivesResponseBody) };
    inline DescribeDrivesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDrivesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDrivesResponseBody> body_ {};
  };
