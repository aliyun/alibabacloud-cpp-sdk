...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bindCount_ == nullptr
        && return this->bindCountMap_ == nullptr && return this->configTimers_ == nullptr && return this->description_ == nullptr && return this->groupId_ == nullptr && return this->name_ == nullptr
        && return this->productType_ == nullptr && return this->status_ == nullptr && return this->type_ == nullptr; };
