...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->bindCount_ == nullptr
        && return this->bindCountMap_ == nullptr && return this->configTimers_ == nullptr && return this->description_ == nullptr && return this->groupId_ == nullptr && return this->innerTimerDesc_ == nullptr
        && return this->innerTimerName_ == nullptr && return this->isBind_ == nullptr && return this->isUpdate_ == nullptr && return this->name_ == nullptr && return this->productType_ == nullptr
    ...
    inline DescribeTimerGroupResponseBodyData& setInnerTimerDesc(string innerTimerDesc) { DARABONBA_PTR_SET_VALUE(innerTimerDesc_, innerTimerDesc) };
    ...
    inline DescribeTimerGroupResponseBodyData& setInnerTimerName(string innerTimerName) { DARABONBA_PTR_SET_VALUE(innerTimerName_, innerTimerName) };
    ...
    inline DescribeTimerGroupResponseBodyData& setIsBind(bool isBind) { DARABONBA_PTR_SET_VALUE(isBind_, isBind) };
    ...
    inline DescribeTimerGroupResponseBodyData& setIsUpdate(bool isUpdate) { DARABONBA_PTR_SET_VALUE(isUpdate_, isUpdate) };
