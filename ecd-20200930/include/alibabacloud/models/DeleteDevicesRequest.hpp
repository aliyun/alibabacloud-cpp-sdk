...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientType_ == nullptr
        && this->deviceIds_ == nullptr && this->force_ == nullptr && this->regionId_ == nullptr; };
    ...
    inline int32_t getForce() const { DARABONBA_PTR_GET_DEFAULT(force_, 0) };
