...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDesktopOversoldGroupSaleResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ModifyDesktopOversoldGroupSaleResponseBody::Data) };
    inline ModifyDesktopOversoldGroupSaleResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ModifyDesktopOversoldGroupSaleResponseBody::Data) };
    inline ModifyDesktopOversoldGroupSaleResponseBody& setData(const ModifyDesktopOversoldGroupSaleResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyDesktopOversoldGroupSaleResponseBody& setData(ModifyDesktopOversoldGroupSaleResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    shared_ptr<ModifyDesktopOversoldGroupSaleResponseBody::Data> data_ {};
