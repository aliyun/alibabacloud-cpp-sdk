...
namespace Models
{
  ...
  public:
    ...
    inline const CreateADConnectorOfficeSiteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateADConnectorOfficeSiteResponseBody) };
    inline CreateADConnectorOfficeSiteResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateADConnectorOfficeSiteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateADConnectorOfficeSiteResponseBody> body_ {};
  };
