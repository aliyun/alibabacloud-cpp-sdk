...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTemplatesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTemplatesResponseBody) };
    inline DeleteTemplatesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTemplatesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTemplatesResponseBody> body_ {};
  };
