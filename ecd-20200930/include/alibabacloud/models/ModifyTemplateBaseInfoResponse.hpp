...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyTemplateBaseInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyTemplateBaseInfoResponseBody) };
    inline ModifyTemplateBaseInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyTemplateBaseInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyTemplateBaseInfoResponseBody> body_ {};
  };
