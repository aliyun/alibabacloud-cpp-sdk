...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->eduRoomId_ == nullptr
    ...
    inline string getEduRoomId() const { DARABONBA_PTR_GET_DEFAULT(eduRoomId_, "") };
