...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDesktopOversoldUserResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeDesktopOversoldUserResponseBodyData>) };
    inline vector<DescribeDesktopOversoldUserResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeDesktopOversoldUserResponseBodyData>) };
    inline DescribeDesktopOversoldUserResponseBody& setData(const vector<DescribeDesktopOversoldUserResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeDesktopOversoldUserResponseBody& setData(vector<DescribeDesktopOversoldUserResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<DescribeDesktopOversoldUserResponseBodyData>> data_ = nullptr;
