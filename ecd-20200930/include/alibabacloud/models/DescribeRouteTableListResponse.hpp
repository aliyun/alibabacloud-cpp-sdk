...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRouteTableListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRouteTableListResponseBody) };
    inline DescribeRouteTableListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRouteTableListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRouteTableListResponseBody> body_ {};
  };
