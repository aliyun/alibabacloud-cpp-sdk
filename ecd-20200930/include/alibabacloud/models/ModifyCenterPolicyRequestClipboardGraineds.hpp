...
namespace Models
{
  ...
  public:
    ...
    inline ModifyCenterPolicyRequestClipboardGraineds& setClipboardSizeUnit(string clipboardSizeUnit) { DARABONBA_PTR_SET_VALUE(clipboardSizeUnit_, clipboardSizeUnit) };
