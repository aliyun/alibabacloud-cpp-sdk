...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeFlowMetricResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeFlowMetricResponseBody) };
    inline DescribeFlowMetricResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeFlowMetricResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeFlowMetricResponseBody> body_ {};
  };
