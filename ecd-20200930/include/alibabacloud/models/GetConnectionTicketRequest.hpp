...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->commandContent_ == nullptr
        && return this->desktopId_ == nullptr && return this->endUserId_ == nullptr && return this->ownerId_ == nullptr && return this->password_ == nullptr && return this->regionId_ == nullptr
        && return this->resourceOwnerAccount_ == nullptr && return this->resourceOwnerId_ == nullptr && return this->taskId_ == nullptr && return this->uuid_ == nullptr; };
