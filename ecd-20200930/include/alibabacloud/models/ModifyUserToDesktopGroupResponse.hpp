...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyUserToDesktopGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyUserToDesktopGroupResponseBody) };
    inline ModifyUserToDesktopGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyUserToDesktopGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyUserToDesktopGroupResponseBody> body_ {};
  };
