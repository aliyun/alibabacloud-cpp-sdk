...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreatePolicyGroupRequest::AuthorizeAccessPolicyRule> & getAuthorizeAccessPolicyRule() const { DARABONBA_PTR_GET_CONST(authorizeAccessPolicyRule_, vector<CreatePolicyGroupRequest::AuthorizeAccessPolicyRule>) };
    inline vector<CreatePolicyGroupRequest::AuthorizeAccessPolicyRule> getAuthorizeAccessPolicyRule() { DARABONBA_PTR_GET(authorizeAccessPolicyRule_, vector<CreatePolicyGroupRequest::AuthorizeAccessPolicyRule>) };
    inline CreatePolicyGroupRequest& setAuthorizeAccessPolicyRule(const vector<CreatePolicyGroupRequest::AuthorizeAccessPolicyRule> & authorizeAccessPolicyRule) { DARABONBA_PTR_SET_VALUE(authorizeAccessPolicyRule_, authorizeAccessPolicyRule) };
    inline CreatePolicyGroupRequest& setAuthorizeAccessPolicyRule(vector<CreatePolicyGroupRequest::AuthorizeAccessPolicyRule> && authorizeAccessPolicyRule) { DARABONBA_PTR_SET_RVALUE(authorizeAccessPolicyRule_, authorizeAccessPolicyRule) };
    ...
    inline const vector<CreatePolicyGroupRequest::AuthorizeSecurityPolicyRule> & getAuthorizeSecurityPolicyRule() const { DARABONBA_PTR_GET_CONST(authorizeSecurityPolicyRule_, vector<CreatePolicyGroupRequest::AuthorizeSecurityPolicyRule>) };
    inline vector<CreatePolicyGroupRequest::AuthorizeSecurityPolicyRule> getAuthorizeSecurityPolicyRule() { DARABONBA_PTR_GET(authorizeSecurityPolicyRule_, vector<CreatePolicyGroupRequest::AuthorizeSecurityPolicyRule>) };
    inline CreatePolicyGroupRequest& setAuthorizeSecurityPolicyRule(const vector<CreatePolicyGroupRequest::AuthorizeSecurityPolicyRule> & authorizeSecurityPolicyRule) { DARABONBA_PTR_SET_VALUE(authorizeSecurityPolicyRule_, authorizeSecurityPolicyRule) };
    inline CreatePolicyGroupRequest& setAuthorizeSecurityPolicyRule(vector<CreatePolicyGroupRequest::AuthorizeSecurityPolicyRule> && authorizeSecurityPolicyRule) { DARABONBA_PTR_SET_RVALUE(authorizeSecurityPolicyRule_, authorizeSecurityPolicyRule) };
    ...
    bool hasClientType() const { return this->clientType_ != nullptr;};
    void deleteClientType() { this->clientType_ = nullptr;};
    inline const vector<CreatePolicyGroupRequest::ClientType> & getClientType() const { DARABONBA_PTR_GET_CONST(clientType_, vector<CreatePolicyGroupRequest::ClientType>) };
    inline vector<CreatePolicyGroupRequest::ClientType> getClientType() { DARABONBA_PTR_GET(clientType_, vector<CreatePolicyGroupRequest::ClientType>) };
    inline CreatePolicyGroupRequest& setClientType(const vector<CreatePolicyGroupRequest::ClientType> & clientType) { DARABONBA_PTR_SET_VALUE(clientType_, clientType) };
    inline CreatePolicyGroupRequest& setClientType(vector<CreatePolicyGroupRequest::ClientType> && clientType) { DARABONBA_PTR_SET_RVALUE(clientType_, clientType) };
    ...
    inline const vector<CreatePolicyGroupRequest::DeviceRedirects> & getDeviceRedirects() const { DARABONBA_PTR_GET_CONST(deviceRedirects_, vector<CreatePolicyGroupRequest::DeviceRedirects>) };
    inline vector<CreatePolicyGroupRequest::DeviceRedirects> getDeviceRedirects() { DARABONBA_PTR_GET(deviceRedirects_, vector<CreatePolicyGroupRequest::DeviceRedirects>) };
    inline CreatePolicyGroupRequest& setDeviceRedirects(const vector<CreatePolicyGroupRequest::DeviceRedirects> & deviceRedirects) { DARABONBA_PTR_SET_VALUE(deviceRedirects_, deviceRedirects) };
    inline CreatePolicyGroupRequest& setDeviceRedirects(vector<CreatePolicyGroupRequest::DeviceRedirects> && deviceRedirects) { DARABONBA_PTR_SET_RVALUE(deviceRedirects_, deviceRedirects) };
    ...
    inline const vector<CreatePolicyGroupRequest::DeviceRules> & getDeviceRules() const { DARABONBA_PTR_GET_CONST(deviceRules_, vector<CreatePolicyGroupRequest::DeviceRules>) };
    inline vector<CreatePolicyGroupRequest::DeviceRules> getDeviceRules() { DARABONBA_PTR_GET(deviceRules_, vector<CreatePolicyGroupRequest::DeviceRules>) };
    inline CreatePolicyGroupRequest& setDeviceRules(const vector<CreatePolicyGroupRequest::DeviceRules> & deviceRules) { DARABONBA_PTR_SET_VALUE(deviceRules_, deviceRules) };
    inline CreatePolicyGroupRequest& setDeviceRules(vector<CreatePolicyGroupRequest::DeviceRules> && deviceRules) { DARABONBA_PTR_SET_RVALUE(deviceRules_, deviceRules) };
    ...
    inline const vector<CreatePolicyGroupRequest::DomainResolveRule> & getDomainResolveRule() const { DARABONBA_PTR_GET_CONST(domainResolveRule_, vector<CreatePolicyGroupRequest::DomainResolveRule>) };
    inline vector<CreatePolicyGroupRequest::DomainResolveRule> getDomainResolveRule() { DARABONBA_PTR_GET(domainResolveRule_, vector<CreatePolicyGroupRequest::DomainResolveRule>) };
    inline CreatePolicyGroupRequest& setDomainResolveRule(const vector<CreatePolicyGroupRequest::DomainResolveRule> & domainResolveRule) { DARABONBA_PTR_SET_VALUE(domainResolveRule_, domainResolveRule) };
    inline CreatePolicyGroupRequest& setDomainResolveRule(vector<CreatePolicyGroupRequest::DomainResolveRule> && domainResolveRule) { DARABONBA_PTR_SET_RVALUE(domainResolveRule_, domainResolveRule) };
    ...
    inline const vector<CreatePolicyGroupRequest::UsbSupplyRedirectRule> & getUsbSupplyRedirectRule() const { DARABONBA_PTR_GET_CONST(usbSupplyRedirectRule_, vector<CreatePolicyGroupRequest::UsbSupplyRedirectRule>) };
    inline vector<CreatePolicyGroupRequest::UsbSupplyRedirectRule> getUsbSupplyRedirectRule() { DARABONBA_PTR_GET(usbSupplyRedirectRule_, vector<CreatePolicyGroupRequest::UsbSupplyRedirectRule>) };
    inline CreatePolicyGroupRequest& setUsbSupplyRedirectRule(const vector<CreatePolicyGroupRequest::UsbSupplyRedirectRule> & usbSupplyRedirectRule) { DARABONBA_PTR_SET_VALUE(usbSupplyRedirectRule_, usbSupplyRedirectRule) };
    inline CreatePolicyGroupRequest& setUsbSupplyRedirectRule(vector<CreatePolicyGroupRequest::UsbSupplyRedirectRule> && usbSupplyRedirectRule) { DARABONBA_PTR_SET_RVALUE(usbSupplyRedirectRule_, usbSupplyRedirectRule) };
  ...
  protected:
    ...
    shared_ptr<vector<CreatePolicyGroupRequest::AuthorizeAccessPolicyRule>> authorizeAccessPolicyRule_ {};
    // The security group rules.
    shared_ptr<vector<CreatePolicyGroupRequest::AuthorizeSecurityPolicyRule>> authorizeSecurityPolicyRule_ {};
    ...
    shared_ptr<vector<CreatePolicyGroupRequest::ClientType>> clientType_ {};
    ...
    shared_ptr<vector<CreatePolicyGroupRequest::DeviceRedirects>> deviceRedirects_ {};
    // The custom peripheral rules.
    shared_ptr<vector<CreatePolicyGroupRequest::DeviceRules>> deviceRules_ {};
    ...
    shared_ptr<vector<CreatePolicyGroupRequest::DomainResolveRule>> domainResolveRule_ {};
    ...
    shared_ptr<vector<CreatePolicyGroupRequest::UsbSupplyRedirectRule>> usbSupplyRedirectRule_ {};
