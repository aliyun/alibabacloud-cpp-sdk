...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->academicProxy_ == nullptr
        ...
        && return this->netRedirect_ == nullptr && return this->netRedirectRule_ == nullptr && return this->noOperationDisconnect_ == nullptr && return this->noOperationDisconnectTime_ == nullptr && return this->portProxy_ == nullptr
        && return this->printerRedirect_ == nullptr && return this->qualityEnhancement_ == nullptr && return this->recordEventDuration_ == nullptr && return this->recordEventFileExts_ == nullptr && return this->recordEventFilePaths_ == nullptr
        && return this->recordEventLevels_ == nullptr && return this->recordEventRegisters_ == nullptr && return this->recordEvents_ == nullptr && return this->recording_ == nullptr && return this->recordingAudio_ == nullptr
        && return this->recordingDuration_ == nullptr && return this->recordingEndTime_ == nullptr && return this->recordingExpires_ == nullptr && return this->recordingFps_ == nullptr && return this->recordingStartTime_ == nullptr
        && return this->recordingUserNotify_ == nullptr && return this->recordingUserNotifyMessage_ == nullptr && return this->regionId_ == nullptr && return this->remoteCoordinate_ == nullptr && return this->resetDesktop_ == nullptr
        && return this->resolutionHeight_ == nullptr && return this->resolutionModel_ == nullptr && return this->resolutionWidth_ == nullptr && return this->resourceType_ == nullptr && return this->safeMenu_ == nullptr
        ...
        && return this->watermarkShadow_ == nullptr && return this->watermarkTransparencyValue_ == nullptr && return this->watermarkType_ == nullptr && return this->wuyingKeeper_ == nullptr && return this->wyAssistant_ == nullptr; };
    ...
    inline const vector<CreateCenterPolicyRequestAuthorizeAccessPolicyRule> & authorizeAccessPolicyRule() const { DARABONBA_PTR_GET_CONST(authorizeAccessPolicyRule_, vector<CreateCenterPolicyRequestAuthorizeAccessPolicyRule>) };
    inline vector<CreateCenterPolicyRequestAuthorizeAccessPolicyRule> authorizeAccessPolicyRule() { DARABONBA_PTR_GET(authorizeAccessPolicyRule_, vector<CreateCenterPolicyRequestAuthorizeAccessPolicyRule>) };
    inline CreateCenterPolicyRequest& setAuthorizeAccessPolicyRule(const vector<CreateCenterPolicyRequestAuthorizeAccessPolicyRule> & authorizeAccessPolicyRule) { DARABONBA_PTR_SET_VALUE(authorizeAccessPolicyRule_, authorizeAccessPolicyRule) };
    inline CreateCenterPolicyRequest& setAuthorizeAccessPolicyRule(vector<CreateCenterPolicyRequestAuthorizeAccessPolicyRule> && authorizeAccessPolicyRule) { DARABONBA_PTR_SET_RVALUE(authorizeAccessPolicyRule_, authorizeAccessPolicyRule) };
    ...
    inline const vector<CreateCenterPolicyRequestAuthorizeSecurityPolicyRule> & authorizeSecurityPolicyRule() const { DARABONBA_PTR_GET_CONST(authorizeSecurityPolicyRule_, vector<CreateCenterPolicyRequestAuthorizeSecurityPolicyRule>) };
    ...
    inline const vector<CreateCenterPolicyRequestClientType> & clientType() const { DARABONBA_PTR_GET_CONST(clientType_, vector<CreateCenterPolicyRequestClientType>) };
    inline vector<CreateCenterPolicyRequestClientType> clientType() { DARABONBA_PTR_GET(clientType_, vector<CreateCenterPolicyRequestClientType>) };
    inline CreateCenterPolicyRequest& setClientType(const vector<CreateCenterPolicyRequestClientType> & clientType) { DARABONBA_PTR_SET_VALUE(clientType_, clientType) };
    inline CreateCenterPolicyRequest& setClientType(vector<CreateCenterPolicyRequestClientType> && clientType) { DARABONBA_PTR_SET_RVALUE(clientType_, clientType) };
    ...
    inline const vector<CreateCenterPolicyRequestDeviceRedirects> & deviceRedirects() const { DARABONBA_PTR_GET_CONST(deviceRedirects_, vector<CreateCenterPolicyRequestDeviceRedirects>) };
    inline vector<CreateCenterPolicyRequestDeviceRedirects> deviceRedirects() { DARABONBA_PTR_GET(deviceRedirects_, vector<CreateCenterPolicyRequestDeviceRedirects>) };
    inline CreateCenterPolicyRequest& setDeviceRedirects(const vector<CreateCenterPolicyRequestDeviceRedirects> & deviceRedirects) { DARABONBA_PTR_SET_VALUE(deviceRedirects_, deviceRedirects) };
    inline CreateCenterPolicyRequest& setDeviceRedirects(vector<CreateCenterPolicyRequestDeviceRedirects> && deviceRedirects) { DARABONBA_PTR_SET_RVALUE(deviceRedirects_, deviceRedirects) };
    ...
    inline const vector<CreateCenterPolicyRequestDeviceRules> & deviceRules() const { DARABONBA_PTR_GET_CONST(deviceRules_, vector<CreateCenterPolicyRequestDeviceRules>) };
    inline vector<CreateCenterPolicyRequestDeviceRules> deviceRules() { DARABONBA_PTR_GET(deviceRules_, vector<CreateCenterPolicyRequestDeviceRules>) };
    inline CreateCenterPolicyRequest& setDeviceRules(const vector<CreateCenterPolicyRequestDeviceRules> & deviceRules) { DARABONBA_PTR_SET_VALUE(deviceRules_, deviceRules) };
    inline CreateCenterPolicyRequest& setDeviceRules(vector<CreateCenterPolicyRequestDeviceRules> && deviceRules) { DARABONBA_PTR_SET_RVALUE(deviceRules_, deviceRules) };
    ...
    inline const vector<CreateCenterPolicyRequestDomainResolveRule> & domainResolveRule() const { DARABONBA_PTR_GET_CONST(domainResolveRule_, vector<CreateCenterPolicyRequestDomainResolveRule>) };
    inline vector<CreateCenterPolicyRequestDomainResolveRule> domainResolveRule() { DARABONBA_PTR_GET(domainResolveRule_, vector<CreateCenterPolicyRequestDomainResolveRule>) };
    inline CreateCenterPolicyRequest& setDomainResolveRule(const vector<CreateCenterPolicyRequestDomainResolveRule> & domainResolveRule) { DARABONBA_PTR_SET_VALUE(domainResolveRule_, domainResolveRule) };
    inline CreateCenterPolicyRequest& setDomainResolveRule(vector<CreateCenterPolicyRequestDomainResolveRule> && domainResolveRule) { DARABONBA_PTR_SET_RVALUE(domainResolveRule_, domainResolveRule) };
    ...
    inline const vector<CreateCenterPolicyRequestNetRedirectRule> & netRedirectRule() const { DARABONBA_PTR_GET_CONST(netRedirectRule_, vector<CreateCenterPolicyRequestNetRedirectRule>) };
    inline vector<CreateCenterPolicyRequestNetRedirectRule> netRedirectRule() { DARABONBA_PTR_GET(netRedirectRule_, vector<CreateCenterPolicyRequestNetRedirectRule>) };
    inline CreateCenterPolicyRequest& setNetRedirectRule(const vector<CreateCenterPolicyRequestNetRedirectRule> & netRedirectRule) { DARABONBA_PTR_SET_VALUE(netRedirectRule_, netRedirectRule) };
    inline CreateCenterPolicyRequest& setNetRedirectRule(vector<CreateCenterPolicyRequestNetRedirectRule> && netRedirectRule) { DARABONBA_PTR_SET_RVALUE(netRedirectRule_, netRedirectRule) };
    ...
    inline const vector<CreateCenterPolicyRequestUsbSupplyRedirectRule> & usbSupplyRedirectRule() const { DARABONBA_PTR_GET_CONST(usbSupplyRedirectRule_, vector<CreateCenterPolicyRequestUsbSupplyRedirectRule>) };
    inline vector<CreateCenterPolicyRequestUsbSupplyRedirectRule> usbSupplyRedirectRule() { DARABONBA_PTR_GET(usbSupplyRedirectRule_, vector<CreateCenterPolicyRequestUsbSupplyRedirectRule>) };
    inline CreateCenterPolicyRequest& setUsbSupplyRedirectRule(const vector<CreateCenterPolicyRequestUsbSupplyRedirectRule> & usbSupplyRedirectRule) { DARABONBA_PTR_SET_VALUE(usbSupplyRedirectRule_, usbSupplyRedirectRule) };
    inline CreateCenterPolicyRequest& setUsbSupplyRedirectRule(vector<CreateCenterPolicyRequestUsbSupplyRedirectRule> && usbSupplyRedirectRule) { DARABONBA_PTR_SET_RVALUE(usbSupplyRedirectRule_, usbSupplyRedirectRule) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CreateCenterPolicyRequestDeviceRedirects>> deviceRedirects_ = nullptr;
    // The custom peripheral rules.
    std::shared_ptr<vector<CreateCenterPolicyRequestDeviceRules>> deviceRules_ = nullptr;
    ...
    std::shared_ptr<vector<CreateCenterPolicyRequestDomainResolveRule>> domainResolveRule_ = nullptr;
    ...
    // 
    // >  This parameter is in private preview and only available to specific users.
    std::shared_ptr<vector<CreateCenterPolicyRequestNetRedirectRule>> netRedirectRule_ = nullptr;
    ...
    std::shared_ptr<vector<CreateCenterPolicyRequestUsbSupplyRedirectRule>> usbSupplyRedirectRule_ = nullptr;
