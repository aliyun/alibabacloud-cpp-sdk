...
namespace Models
{
  ...
  public:
    ...
    inline const MoveCdsFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, MoveCdsFileResponseBody) };
    inline MoveCdsFileResponseBody getBody() { DARABONBA_PTR_GET(body_, MoveCdsFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<MoveCdsFileResponseBody> body_ {};
  };
