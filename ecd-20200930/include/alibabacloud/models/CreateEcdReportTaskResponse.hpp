...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEcdReportTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateEcdReportTaskResponseBody) };
    inline CreateEcdReportTaskResponseBody body() { DARABONBA_PTR_GET(body_, CreateEcdReportTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateEcdReportTaskResponseBody> body_ = nullptr;
  };
