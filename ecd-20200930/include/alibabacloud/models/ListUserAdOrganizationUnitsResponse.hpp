...
namespace Models
{
  ...
  public:
    ...
    inline const ListUserAdOrganizationUnitsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListUserAdOrganizationUnitsResponseBody) };
    inline ListUserAdOrganizationUnitsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListUserAdOrganizationUnitsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListUserAdOrganizationUnitsResponseBody> body_ {};
  };
