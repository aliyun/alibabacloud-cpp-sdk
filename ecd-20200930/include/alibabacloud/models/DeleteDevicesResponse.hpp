...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDevicesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteDevicesResponseBody) };
    inline DeleteDevicesResponseBody body() { DARABONBA_PTR_GET(body_, DeleteDevicesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteDevicesResponseBody> body_ = nullptr;
  };
