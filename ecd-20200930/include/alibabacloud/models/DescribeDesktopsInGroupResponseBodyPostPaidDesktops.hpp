...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDESKTOPSINGROUPRESPONSEBODYPOSTPAIDDESKTOPS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDESKTOPSINGROUPRESPONSEBODYPOSTPAIDDESKTOPS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDesktopsInGroupResponseBodyPostPaidDesktops& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDesktopsInGroupResponseBodyPostPaidDesktops& obj) { 
    ...
    DescribeDesktopsInGroupResponseBodyPostPaidDesktops() = default ;
    DescribeDesktopsInGroupResponseBodyPostPaidDesktops(const DescribeDesktopsInGroupResponseBodyPostPaidDesktops &) = default ;
    DescribeDesktopsInGroupResponseBodyPostPaidDesktops(DescribeDesktopsInGroupResponseBodyPostPaidDesktops &&) = default ;
    DescribeDesktopsInGroupResponseBodyPostPaidDesktops(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDesktopsInGroupResponseBodyPostPaidDesktops() = default ;
    DescribeDesktopsInGroupResponseBodyPostPaidDesktops& operator=(const DescribeDesktopsInGroupResponseBodyPostPaidDesktops &) = default ;
    DescribeDesktopsInGroupResponseBodyPostPaidDesktops& operator=(DescribeDesktopsInGroupResponseBodyPostPaidDesktops &&) = default ;
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setConnectionStatus(string connectionStatus) { DARABONBA_PTR_SET_VALUE(connectionStatus_, connectionStatus) };
    ...
    inline string createDuration() const { DARABONBA_PTR_GET_DEFAULT(createDuration_, "") };
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setCreateDuration(string createDuration) { DARABONBA_PTR_SET_VALUE(createDuration_, createDuration) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setDesktopId(string desktopId) { DARABONBA_PTR_SET_VALUE(desktopId_, desktopId) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setDesktopName(string desktopName) { DARABONBA_PTR_SET_VALUE(desktopName_, desktopName) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setDesktopStatus(string desktopStatus) { DARABONBA_PTR_SET_VALUE(desktopStatus_, desktopStatus) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setDiskType(string diskType) { DARABONBA_PTR_SET_VALUE(diskType_, diskType) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setEndUserId(string endUserId) { DARABONBA_PTR_SET_VALUE(endUserId_, endUserId) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setEndUserIds(const vector<string> & endUserIds) { DARABONBA_PTR_SET_VALUE(endUserIds_, endUserIds) };
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setEndUserIds(vector<string> && endUserIds) { DARABONBA_PTR_SET_RVALUE(endUserIds_, endUserIds) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setEndUserName(string endUserName) { DARABONBA_PTR_SET_VALUE(endUserName_, endUserName) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setEndUserNames(const vector<string> & endUserNames) { DARABONBA_PTR_SET_VALUE(endUserNames_, endUserNames) };
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setEndUserNames(vector<string> && endUserNames) { DARABONBA_PTR_SET_RVALUE(endUserNames_, endUserNames) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setFotaVersion(string fotaVersion) { DARABONBA_PTR_SET_VALUE(fotaVersion_, fotaVersion) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setGpuDriverVersion(string gpuDriverVersion) { DARABONBA_PTR_SET_VALUE(gpuDriverVersion_, gpuDriverVersion) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setImageId(string imageId) { DARABONBA_PTR_SET_VALUE(imageId_, imageId) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setImageName(string imageName) { DARABONBA_PTR_SET_VALUE(imageName_, imageName) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setManagementFlag(string managementFlag) { DARABONBA_PTR_SET_VALUE(managementFlag_, managementFlag) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setManagementFlags(const vector<string> & managementFlags) { DARABONBA_PTR_SET_VALUE(managementFlags_, managementFlags) };
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setManagementFlags(vector<string> && managementFlags) { DARABONBA_PTR_SET_RVALUE(managementFlags_, managementFlags) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setMemberEniIp(string memberEniIp) { DARABONBA_PTR_SET_VALUE(memberEniIp_, memberEniIp) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setOsType(string osType) { DARABONBA_PTR_SET_VALUE(osType_, osType) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setPrimaryEniIp(string primaryEniIp) { DARABONBA_PTR_SET_VALUE(primaryEniIp_, primaryEniIp) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setProtocolType(string protocolType) { DARABONBA_PTR_SET_VALUE(protocolType_, protocolType) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setReleaseTime(string releaseTime) { DARABONBA_PTR_SET_VALUE(releaseTime_, releaseTime) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setResetTime(string resetTime) { DARABONBA_PTR_SET_VALUE(resetTime_, resetTime) };
    ...
    inline DescribeDesktopsInGroupResponseBodyPostPaidDesktops& setSystemDiskSize(int32_t systemDiskSize) { DARABONBA_PTR_SET_VALUE(systemDiskSize_, systemDiskSize) };
  ...
  protected:
    ...
    std::shared_ptr<string> createDuration_ = nullptr;
