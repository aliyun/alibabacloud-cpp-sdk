...
namespace Models
{
  ...
  public:
    ...
    inline const RunCommandResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunCommandResponseBody) };
    inline RunCommandResponseBody getBody() { DARABONBA_PTR_GET(body_, RunCommandResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunCommandResponseBody> body_ {};
  };
