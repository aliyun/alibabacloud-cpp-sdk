...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePolicyGroupsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePolicyGroupsResponseBody) };
    inline DeletePolicyGroupsResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePolicyGroupsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePolicyGroupsResponseBody> body_ {};
  };
