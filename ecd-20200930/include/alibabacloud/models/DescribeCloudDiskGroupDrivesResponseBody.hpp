...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCloudDiskGroupDrivesResponseBody::CloudDriveGroups> & getCloudDriveGroups() const { DARABONBA_PTR_GET_CONST(cloudDriveGroups_, vector<DescribeCloudDiskGroupDrivesResponseBody::CloudDriveGroups>) };
    inline vector<DescribeCloudDiskGroupDrivesResponseBody::CloudDriveGroups> getCloudDriveGroups() { DARABONBA_PTR_GET(cloudDriveGroups_, vector<DescribeCloudDiskGroupDrivesResponseBody::CloudDriveGroups>) };
    inline DescribeCloudDiskGroupDrivesResponseBody& setCloudDriveGroups(const vector<DescribeCloudDiskGroupDrivesResponseBody::CloudDriveGroups> & cloudDriveGroups) { DARABONBA_PTR_SET_VALUE(cloudDriveGroups_, cloudDriveGroups) };
    inline DescribeCloudDiskGroupDrivesResponseBody& setCloudDriveGroups(vector<DescribeCloudDiskGroupDrivesResponseBody::CloudDriveGroups> && cloudDriveGroups) { DARABONBA_PTR_SET_RVALUE(cloudDriveGroups_, cloudDriveGroups) };
