...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->cdsId_ == nullptr
        && return this->downloadEndUserIds_ == nullptr && return this->downloadUploadEndUserIds_ == nullptr && return this->noDownloadNoUploadEndUserIds_ == nullptr && return this->regionId_ == nullptr; };
    ...
    inline const vector<string> & downloadEndUserIds() const { DARABONBA_PTR_GET_CONST(downloadEndUserIds_, vector<string>) };
    inline vector<string> downloadEndUserIds() { DARABONBA_PTR_GET(downloadEndUserIds_, vector<string>) };
    ...
    inline const vector<string> & downloadUploadEndUserIds() const { DARABONBA_PTR_GET_CONST(downloadUploadEndUserIds_, vector<string>) };
    inline vector<string> downloadUploadEndUserIds() { DARABONBA_PTR_GET(downloadUploadEndUserIds_, vector<string>) };
    ...
    inline const vector<string> & noDownloadNoUploadEndUserIds() const { DARABONBA_PTR_GET_CONST(noDownloadNoUploadEndUserIds_, vector<string>) };
    inline vector<string> noDownloadNoUploadEndUserIds() { DARABONBA_PTR_GET(noDownloadNoUploadEndUserIds_, vector<string>) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> downloadEndUserIds_ = nullptr;
    // The IDs of the users who have the upload and download permissions.
    std::shared_ptr<vector<string>> downloadUploadEndUserIds_ = nullptr;
    std::shared_ptr<vector<string>> noDownloadNoUploadEndUserIds_ = nullptr;
    // The region ID.
    // 
    // This parameter is required.
