...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyCustomizedListHeadersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyCustomizedListHeadersResponseBody) };
    inline ModifyCustomizedListHeadersResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyCustomizedListHeadersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyCustomizedListHeadersResponseBody> body_ {};
  };
