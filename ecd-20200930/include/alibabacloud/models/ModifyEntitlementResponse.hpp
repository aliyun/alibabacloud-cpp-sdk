...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyEntitlementResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyEntitlementResponseBody) };
    inline ModifyEntitlementResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyEntitlementResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyEntitlementResponseBody> body_ {};
  };
