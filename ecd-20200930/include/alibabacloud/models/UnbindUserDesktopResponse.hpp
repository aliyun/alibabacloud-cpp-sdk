...
namespace Models
{
  ...
  public:
    ...
    inline const UnbindUserDesktopResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UnbindUserDesktopResponseBody) };
    inline UnbindUserDesktopResponseBody body() { DARABONBA_PTR_GET(body_, UnbindUserDesktopResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UnbindUserDesktopResponseBody> body_ = nullptr;
  };
