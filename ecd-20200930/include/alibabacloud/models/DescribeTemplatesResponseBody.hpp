...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeTemplatesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribeTemplatesResponseBodyData>) };
    inline vector<DescribeTemplatesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<DescribeTemplatesResponseBodyData>) };
    inline DescribeTemplatesResponseBody& setData(const vector<DescribeTemplatesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeTemplatesResponseBody& setData(vector<DescribeTemplatesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
