...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ModifyTemplateRequest::DataDiskList> & getDataDiskList() const { DARABONBA_PTR_GET_CONST(dataDiskList_, vector<ModifyTemplateRequest::DataDiskList>) };
    inline vector<ModifyTemplateRequest::DataDiskList> getDataDiskList() { DARABONBA_PTR_GET(dataDiskList_, vector<ModifyTemplateRequest::DataDiskList>) };
    inline ModifyTemplateRequest& setDataDiskList(const vector<ModifyTemplateRequest::DataDiskList> & dataDiskList) { DARABONBA_PTR_SET_VALUE(dataDiskList_, dataDiskList) };
    inline ModifyTemplateRequest& setDataDiskList(vector<ModifyTemplateRequest::DataDiskList> && dataDiskList) { DARABONBA_PTR_SET_RVALUE(dataDiskList_, dataDiskList) };
    ...
    inline const vector<ModifyTemplateRequest::RegionConfigList> & getRegionConfigList() const { DARABONBA_PTR_GET_CONST(regionConfigList_, vector<ModifyTemplateRequest::RegionConfigList>) };
    inline vector<ModifyTemplateRequest::RegionConfigList> getRegionConfigList() { DARABONBA_PTR_GET(regionConfigList_, vector<ModifyTemplateRequest::RegionConfigList>) };
    inline ModifyTemplateRequest& setRegionConfigList(const vector<ModifyTemplateRequest::RegionConfigList> & regionConfigList) { DARABONBA_PTR_SET_VALUE(regionConfigList_, regionConfigList) };
    inline ModifyTemplateRequest& setRegionConfigList(vector<ModifyTemplateRequest::RegionConfigList> && regionConfigList) { DARABONBA_PTR_SET_RVALUE(regionConfigList_, regionConfigList) };
    ...
    inline const vector<ModifyTemplateRequest::ResourceTagList> & getResourceTagList() const { DARABONBA_PTR_GET_CONST(resourceTagList_, vector<ModifyTemplateRequest::ResourceTagList>) };
    inline vector<ModifyTemplateRequest::ResourceTagList> getResourceTagList() { DARABONBA_PTR_GET(resourceTagList_, vector<ModifyTemplateRequest::ResourceTagList>) };
    inline ModifyTemplateRequest& setResourceTagList(const vector<ModifyTemplateRequest::ResourceTagList> & resourceTagList) { DARABONBA_PTR_SET_VALUE(resourceTagList_, resourceTagList) };
    inline ModifyTemplateRequest& setResourceTagList(vector<ModifyTemplateRequest::ResourceTagList> && resourceTagList) { DARABONBA_PTR_SET_RVALUE(resourceTagList_, resourceTagList) };
    ...
    inline const vector<ModifyTemplateRequest::SiteConfigList> & getSiteConfigList() const { DARABONBA_PTR_GET_CONST(siteConfigList_, vector<ModifyTemplateRequest::SiteConfigList>) };
    inline vector<ModifyTemplateRequest::SiteConfigList> getSiteConfigList() { DARABONBA_PTR_GET(siteConfigList_, vector<ModifyTemplateRequest::SiteConfigList>) };
    inline ModifyTemplateRequest& setSiteConfigList(const vector<ModifyTemplateRequest::SiteConfigList> & siteConfigList) { DARABONBA_PTR_SET_VALUE(siteConfigList_, siteConfigList) };
    inline ModifyTemplateRequest& setSiteConfigList(vector<ModifyTemplateRequest::SiteConfigList> && siteConfigList) { DARABONBA_PTR_SET_RVALUE(siteConfigList_, siteConfigList) };
