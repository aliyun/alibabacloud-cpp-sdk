...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigADConnectorTrustResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigADConnectorTrustResponseBody) };
    inline ConfigADConnectorTrustResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigADConnectorTrustResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigADConnectorTrustResponseBody> body_ {};
  };
