...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->adDomain_ == nullptr
        && return this->clientType_ == nullptr && return this->deviceId_ == nullptr && return this->directoryId_ == nullptr && return this->endUserId_ == nullptr && return this->regionId_ == nullptr
