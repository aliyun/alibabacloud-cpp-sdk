...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ModifyResourceCenterPolicyResponseBodyModifyResults> & modifyResults() const { DARABONBA_PTR_GET_CONST(modifyResults_, vector<ModifyResourceCenterPolicyResponseBodyModifyResults>) };
    inline vector<ModifyResourceCenterPolicyResponseBodyModifyResults> modifyResults() { DARABONBA_PTR_GET(modifyResults_, vector<ModifyResourceCenterPolicyResponseBodyModifyResults>) };
    inline ModifyResourceCenterPolicyResponseBody& setModifyResults(const vector<ModifyResourceCenterPolicyResponseBodyModifyResults> & modifyResults) { DARABONBA_PTR_SET_VALUE(modifyResults_, modifyResults) };
    inline ModifyResourceCenterPolicyResponseBody& setModifyResults(vector<ModifyResourceCenterPolicyResponseBodyModifyResults> && modifyResults) { DARABONBA_PTR_SET_RVALUE(modifyResults_, modifyResults) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ModifyResourceCenterPolicyResponseBodyModifyResults>> modifyResults_ = nullptr;
    // The request ID.
