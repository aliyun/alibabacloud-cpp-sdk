...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDirectoriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDirectoriesResponseBody) };
    inline DeleteDirectoriesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDirectoriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDirectoriesResponseBody> body_ {};
  };
