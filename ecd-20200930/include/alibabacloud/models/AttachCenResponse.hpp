...
namespace Models
{
  ...
  public:
    ...
    inline const AttachCenResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, AttachCenResponseBody) };
    inline AttachCenResponseBody body() { DARABONBA_PTR_GET(body_, AttachCenResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<AttachCenResponseBody> body_ = nullptr;
  };
