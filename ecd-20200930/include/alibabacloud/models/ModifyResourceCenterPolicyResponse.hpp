...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyResourceCenterPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyResourceCenterPolicyResponseBody) };
    inline ModifyResourceCenterPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyResourceCenterPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyResourceCenterPolicyResponseBody> body_ {};
  };
