...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyCoordinatePrivilegeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApplyCoordinatePrivilegeResponseBody) };
    inline ApplyCoordinatePrivilegeResponseBody getBody() { DARABONBA_PTR_GET(body_, ApplyCoordinatePrivilegeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApplyCoordinatePrivilegeResponseBody> body_ {};
  };
