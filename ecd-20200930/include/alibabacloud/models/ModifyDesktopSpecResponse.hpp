...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyDesktopSpecResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyDesktopSpecResponseBody) };
    inline ModifyDesktopSpecResponseBody body() { DARABONBA_PTR_GET(body_, ModifyDesktopSpecResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyDesktopSpecResponseBody> body_ = nullptr;
  };
