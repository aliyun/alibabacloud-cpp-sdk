...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currency_ == nullptr
        && return this->discountPrice_ == nullptr && return this->orderLines_ == nullptr && return this->originalPrice_ == nullptr && return this->promotions_ == nullptr && return this->tradePrice_ == nullptr; };
    ...
    inline DescribeRenewalPriceResponseBodyPriceInfoPrice& setOrderLines(const map<string, string> & orderLines) { DARABONBA_PTR_SET_VALUE(orderLines_, orderLines) };
    inline DescribeRenewalPriceResponseBodyPriceInfoPrice& setOrderLines(map<string, string> && orderLines) { DARABONBA_PTR_SET_RVALUE(orderLines_, orderLines) };
    ...
    inline const vector<Models::DescribeRenewalPriceResponseBodyPriceInfoPricePromotions> & promotions() const { DARABONBA_PTR_GET_CONST(promotions_, vector<Models::DescribeRenewalPriceResponseBodyPriceInfoPricePromotions>) };
    inline vector<Models::DescribeRenewalPriceResponseBodyPriceInfoPricePromotions> promotions() { DARABONBA_PTR_GET(promotions_, vector<Models::DescribeRenewalPriceResponseBodyPriceInfoPricePromotions>) };
    inline DescribeRenewalPriceResponseBodyPriceInfoPrice& setPromotions(const vector<Models::DescribeRenewalPriceResponseBodyPriceInfoPricePromotions> & promotions) { DARABONBA_PTR_SET_VALUE(promotions_, promotions) };
    inline DescribeRenewalPriceResponseBodyPriceInfoPrice& setPromotions(vector<Models::DescribeRenewalPriceResponseBodyPriceInfoPricePromotions> && promotions) { DARABONBA_PTR_SET_RVALUE(promotions_, promotions) };
  ...
  protected:
    ...
    // The promotions.
    std::shared_ptr<vector<Models::DescribeRenewalPriceResponseBodyPriceInfoPricePromotions>> promotions_ = nullptr;
