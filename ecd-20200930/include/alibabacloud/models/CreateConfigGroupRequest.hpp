...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->configTimers_ == nullptr
        && this->description_ == nullptr && this->name_ == nullptr && this->productType_ == nullptr && this->regionId_ == nullptr && this->type_ == nullptr; };
    ...
    inline const vector<CreateConfigGroupRequest::ConfigTimers> & getConfigTimers() const { DARABONBA_PTR_GET_CONST(configTimers_, vector<CreateConfigGroupRequest::ConfigTimers>) };
    inline vector<CreateConfigGroupRequest::ConfigTimers> getConfigTimers() { DARABONBA_PTR_GET(configTimers_, vector<CreateConfigGroupRequest::ConfigTimers>) };
    inline CreateConfigGroupRequest& setConfigTimers(const vector<CreateConfigGroupRequest::ConfigTimers> & configTimers) { DARABONBA_PTR_SET_VALUE(configTimers_, configTimers) };
    inline CreateConfigGroupRequest& setConfigTimers(vector<CreateConfigGroupRequest::ConfigTimers> && configTimers) { DARABONBA_PTR_SET_RVALUE(configTimers_, configTimers) };
