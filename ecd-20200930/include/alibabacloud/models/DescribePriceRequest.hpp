...
namespace Models
{
  ...
  public:
    ...
    inline int32_t getGroupDesktopCount() const { DARABONBA_PTR_GET_DEFAULT(groupDesktopCount_, 0) };
    ...
    inline string getRootDiskCategory() const { DARABONBA_PTR_GET_DEFAULT(rootDiskCategory_, "") };
    ...
    inline string getUserDiskCategory() const { DARABONBA_PTR_GET_DEFAULT(userDiskCategory_, "") };
  ...
  protected:
    ...
    shared_ptr<int32_t> groupDesktopCount_ {};
    ...
    shared_ptr<string> rootDiskCategory_ {};
    ...
    shared_ptr<string> userDiskCategory_ {};
