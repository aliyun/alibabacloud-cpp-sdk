...
namespace Models
{
  ...
  public:
    ...
    inline const CompleteCdsFileResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CompleteCdsFileResponseBody) };
    inline CompleteCdsFileResponseBody body() { DARABONBA_PTR_GET(body_, CompleteCdsFileResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CompleteCdsFileResponseBody> body_ = nullptr;
  };
