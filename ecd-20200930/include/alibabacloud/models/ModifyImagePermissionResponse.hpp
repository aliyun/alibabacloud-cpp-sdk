...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyImagePermissionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyImagePermissionResponseBody) };
    inline ModifyImagePermissionResponseBody body() { DARABONBA_PTR_GET(body_, ModifyImagePermissionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyImagePermissionResponseBody> body_ = nullptr;
  };
