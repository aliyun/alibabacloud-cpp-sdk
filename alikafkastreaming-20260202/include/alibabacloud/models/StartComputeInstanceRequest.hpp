...
namespace Models
{
  ...
  public:
    ...
    inline StartComputeInstanceRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline StartComputeInstanceRequest& setSelectedZones(string selectedZones) { DARABONBA_PTR_SET_VALUE(selectedZones_, selectedZones) };
    ...
    inline StartComputeInstanceRequest& setServiceVersion(string serviceVersion) { DARABONBA_PTR_SET_VALUE(serviceVersion_, serviceVersion) };
