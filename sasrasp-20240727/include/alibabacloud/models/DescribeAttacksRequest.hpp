...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentType_ == nullptr
        && return this->applicationId_ == nullptr && return this->attackHostId_ == nullptr && return this->attackType_ == nullptr && return this->attackUrl_ == nullptr && return this->endTimestamp_ == nullptr
        && return this->handlerType_ == nullptr && return this->hostname_ == nullptr && return this->ip_ == nullptr && return this->lang_ == nullptr && return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->pid_ == nullptr && return this->raspType_ == nullptr && return this->region_ == nullptr && return this->remote_ == nullptr
        && return this->severity_ == nullptr && return this->startTimestamp_ == nullptr && return this->unionId_ == nullptr; };
    ...
    inline string attackHostId() const { DARABONBA_PTR_GET_DEFAULT(attackHostId_, "") };
    ...
    inline string attackUrl() const { DARABONBA_PTR_GET_DEFAULT(attackUrl_, "") };
    ...
    inline string raspType() const { DARABONBA_PTR_GET_DEFAULT(raspType_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> attackHostId_ = nullptr;
    std::shared_ptr<string> attackType_ = nullptr;
    std::shared_ptr<string> attackUrl_ = nullptr;
    ...
    std::shared_ptr<string> raspType_ = nullptr;
