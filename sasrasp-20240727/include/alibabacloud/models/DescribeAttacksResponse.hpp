...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAttacksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAttacksResponseBody) };
    inline DescribeAttacksResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAttacksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAttacksResponseBody> body_ {};
  };
