...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->blockHighCount_ == nullptr
        && return this->blockLowCount_ == nullptr && return this->blockMediumCount_ == nullptr && return this->monitorHighCount_ == nullptr && return this->monitorLowCount_ == nullptr && return this->monitorMediumCount_ == nullptr
        && return this->requestId_ == nullptr && return this->totalRequestCount_ == nullptr; };
    ...
    inline int64_t blockHighCount() const { DARABONBA_PTR_GET_DEFAULT(blockHighCount_, 0L) };
    ...
    inline int64_t blockLowCount() const { DARABONBA_PTR_GET_DEFAULT(blockLowCount_, 0L) };
    ...
    inline int64_t blockMediumCount() const { DARABONBA_PTR_GET_DEFAULT(blockMediumCount_, 0L) };
    ...
    inline int64_t monitorHighCount() const { DARABONBA_PTR_GET_DEFAULT(monitorHighCount_, 0L) };
    ...
    inline int64_t monitorLowCount() const { DARABONBA_PTR_GET_DEFAULT(monitorLowCount_, 0L) };
    ...
    inline int64_t monitorMediumCount() const { DARABONBA_PTR_GET_DEFAULT(monitorMediumCount_, 0L) };
  ...
  protected:
    std::shared_ptr<int64_t> blockHighCount_ = nullptr;
    std::shared_ptr<int64_t> blockLowCount_ = nullptr;
    std::shared_ptr<int64_t> blockMediumCount_ = nullptr;
    std::shared_ptr<int64_t> monitorHighCount_ = nullptr;
    std::shared_ptr<int64_t> monitorLowCount_ = nullptr;
    std::shared_ptr<int64_t> monitorMediumCount_ = nullptr;
