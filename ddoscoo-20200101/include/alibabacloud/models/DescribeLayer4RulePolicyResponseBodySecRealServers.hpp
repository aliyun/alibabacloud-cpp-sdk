...
#ifndef ALIBABACLOUD_MODELS_DESCRIBELAYER4RULEPOLICYRESPONSEBODYSECREALSERVERS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBELAYER4RULEPOLICYRESPONSEBODYSECREALSERVERS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeLayer4RulePolicyResponseBodySecRealServers& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeLayer4RulePolicyResponseBodySecRealServers& obj) { 
    ...
    DescribeLayer4RulePolicyResponseBodySecRealServers() = default ;
    DescribeLayer4RulePolicyResponseBodySecRealServers(const DescribeLayer4RulePolicyResponseBodySecRealServers &) = default ;
    DescribeLayer4RulePolicyResponseBodySecRealServers(DescribeLayer4RulePolicyResponseBodySecRealServers &&) = default ;
    DescribeLayer4RulePolicyResponseBodySecRealServers(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeLayer4RulePolicyResponseBodySecRealServers() = default ;
    DescribeLayer4RulePolicyResponseBodySecRealServers& operator=(const DescribeLayer4RulePolicyResponseBodySecRealServers &) = default ;
    DescribeLayer4RulePolicyResponseBodySecRealServers& operator=(DescribeLayer4RulePolicyResponseBodySecRealServers &&) = default ;
    ...
    inline DescribeLayer4RulePolicyResponseBodySecRealServers& setCurrentIndex(int32_t currentIndex) { DARABONBA_PTR_SET_VALUE(currentIndex_, currentIndex) };
    ...
    inline DescribeLayer4RulePolicyResponseBodySecRealServers& setEip(string eip) { DARABONBA_PTR_SET_VALUE(eip_, eip) };
    ...
    inline DescribeLayer4RulePolicyResponseBodySecRealServers& setFrontendPort(int32_t frontendPort) { DARABONBA_PTR_SET_VALUE(frontendPort_, frontendPort) };
    ...
    inline DescribeLayer4RulePolicyResponseBodySecRealServers& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline DescribeLayer4RulePolicyResponseBodySecRealServers& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline DescribeLayer4RulePolicyResponseBodySecRealServers& setRealServer(string realServer) { DARABONBA_PTR_SET_VALUE(realServer_, realServer) };
