...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->domain_ == nullptr
        && this->endTime_ == nullptr && this->limit_ == nullptr && this->queryType_ == nullptr && this->region_ == nullptr && this->startTime_ == nullptr; };
    ...
    inline DescribeDomainTopHttpMethodRequest& setQueryType(string queryType) { DARABONBA_PTR_SET_VALUE(queryType_, queryType) };
