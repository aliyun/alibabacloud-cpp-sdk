...
namespace Models
{
  ...
  public:
    ...
    inline const AddAutoCcBlacklistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddAutoCcBlacklistResponseBody) };
    inline AddAutoCcBlacklistResponseBody getBody() { DARABONBA_PTR_GET(body_, AddAutoCcBlacklistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddAutoCcBlacklistResponseBody> body_ {};
  };
