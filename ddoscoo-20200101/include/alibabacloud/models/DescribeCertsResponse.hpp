...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCertsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCertsResponseBody) };
    inline DescribeCertsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCertsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCertsResponseBody> body_ {};
  };
