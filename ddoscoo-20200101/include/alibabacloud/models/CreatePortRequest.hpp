...
#ifndef ALIBABACLOUD_MODELS_CREATEPORTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEPORTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePortRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePortRequest& obj) { 
    ...
    CreatePortRequest(const CreatePortRequest &) = default ;
    CreatePortRequest(CreatePortRequest &&) = default ;
    CreatePortRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePortRequest() = default ;
    CreatePortRequest& operator=(const CreatePortRequest &) = default ;
    CreatePortRequest& operator=(CreatePortRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->backendPort_ == nullptr
        && return this->frontendPort_ == nullptr && return this->frontendProtocol_ == nullptr && return this->instanceId_ == nullptr && return this->proxyEnable_ == nullptr && return this->realServers_ == nullptr; };
    ...
    inline CreatePortRequest& setBackendPort(string backendPort) { DARABONBA_PTR_SET_VALUE(backendPort_, backendPort) };
    ...
    inline CreatePortRequest& setFrontendPort(string frontendPort) { DARABONBA_PTR_SET_VALUE(frontendPort_, frontendPort) };
    ...
    inline CreatePortRequest& setFrontendProtocol(string frontendProtocol) { DARABONBA_PTR_SET_VALUE(frontendProtocol_, frontendProtocol) };
    ...
    inline CreatePortRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline CreatePortRequest& setProxyEnable(int64_t proxyEnable) { DARABONBA_PTR_SET_VALUE(proxyEnable_, proxyEnable) };
    ...
    inline CreatePortRequest& setRealServers(const vector<string> & realServers) { DARABONBA_PTR_SET_VALUE(realServers_, realServers) };
    inline CreatePortRequest& setRealServers(vector<string> && realServers) { DARABONBA_PTR_SET_RVALUE(realServers_, realServers) };
