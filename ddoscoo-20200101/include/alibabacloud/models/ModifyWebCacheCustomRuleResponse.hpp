...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyWebCacheCustomRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyWebCacheCustomRuleResponseBody) };
    inline ModifyWebCacheCustomRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyWebCacheCustomRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyWebCacheCustomRuleResponseBody> body_ {};
  };
