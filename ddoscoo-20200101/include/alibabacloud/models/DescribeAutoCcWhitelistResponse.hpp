...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutoCcWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAutoCcWhitelistResponseBody) };
    inline DescribeAutoCcWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAutoCcWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAutoCcWhitelistResponseBody> body_ {};
  };
