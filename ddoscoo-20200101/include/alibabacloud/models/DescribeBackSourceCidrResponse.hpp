...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBackSourceCidrResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeBackSourceCidrResponseBody) };
    inline DescribeBackSourceCidrResponseBody body() { DARABONBA_PTR_GET(body_, DescribeBackSourceCidrResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeBackSourceCidrResponseBody> body_ = nullptr;
  };
