...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSystemLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSystemLogResponseBody) };
    inline DescribeSystemLogResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSystemLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSystemLogResponseBody> body_ {};
  };
