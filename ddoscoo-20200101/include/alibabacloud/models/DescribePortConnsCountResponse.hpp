...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePortConnsCountResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribePortConnsCountResponseBody) };
    inline DescribePortConnsCountResponseBody body() { DARABONBA_PTR_GET(body_, DescribePortConnsCountResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePortConnsCountResponseBody> body_ = nullptr;
  };
