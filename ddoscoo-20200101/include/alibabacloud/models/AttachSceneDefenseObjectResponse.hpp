...
namespace Models
{
  ...
  public:
    ...
    inline const AttachSceneDefenseObjectResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachSceneDefenseObjectResponseBody) };
    inline AttachSceneDefenseObjectResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachSceneDefenseObjectResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachSceneDefenseObjectResponseBody> body_ {};
  };
