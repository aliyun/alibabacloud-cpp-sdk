...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSlsOpenStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSlsOpenStatusResponseBody) };
    inline DescribeSlsOpenStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSlsOpenStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSlsOpenStatusResponseBody> body_ {};
  };
