...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSceneDefensePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSceneDefensePolicyResponseBody) };
    inline CreateSceneDefensePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSceneDefensePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSceneDefensePolicyResponseBody> body_ {};
  };
