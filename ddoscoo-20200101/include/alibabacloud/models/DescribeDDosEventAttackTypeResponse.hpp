...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDDosEventAttackTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDDosEventAttackTypeResponseBody) };
    inline DescribeDDosEventAttackTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDDosEventAttackTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDDosEventAttackTypeResponseBody> body_ {};
  };
