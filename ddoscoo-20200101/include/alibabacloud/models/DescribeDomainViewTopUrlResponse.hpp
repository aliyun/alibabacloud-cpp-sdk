...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainViewTopUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainViewTopUrlResponseBody) };
    inline DescribeDomainViewTopUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainViewTopUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainViewTopUrlResponseBody> body_ {};
  };
