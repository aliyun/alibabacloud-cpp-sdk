...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainTopUserAgentResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainTopUserAgentResponseBody) };
    inline DescribeDomainTopUserAgentResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDomainTopUserAgentResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDomainTopUserAgentResponseBody> body_ = nullptr;
  };
