...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWebCCRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWebCCRuleResponseBody) };
    inline DeleteWebCCRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWebCCRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWebCCRuleResponseBody> body_ {};
  };
