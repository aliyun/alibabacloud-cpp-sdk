...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainStatusCodeCountResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainStatusCodeCountResponseBody) };
    inline DescribeDomainStatusCodeCountResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDomainStatusCodeCountResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDomainStatusCodeCountResponseBody> body_ = nullptr;
  };
