...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWebCacheCustomRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteWebCacheCustomRuleResponseBody) };
    inline DeleteWebCacheCustomRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteWebCacheCustomRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteWebCacheCustomRuleResponseBody> body_ {};
  };
