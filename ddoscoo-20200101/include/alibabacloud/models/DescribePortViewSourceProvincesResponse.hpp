...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePortViewSourceProvincesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribePortViewSourceProvincesResponseBody) };
    inline DescribePortViewSourceProvincesResponseBody body() { DARABONBA_PTR_GET(body_, DescribePortViewSourceProvincesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePortViewSourceProvincesResponseBody> body_ = nullptr;
  };
