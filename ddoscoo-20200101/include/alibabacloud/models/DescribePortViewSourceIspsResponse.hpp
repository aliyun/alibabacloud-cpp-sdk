...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePortViewSourceIspsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribePortViewSourceIspsResponseBody) };
    inline DescribePortViewSourceIspsResponseBody body() { DARABONBA_PTR_GET(body_, DescribePortViewSourceIspsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribePortViewSourceIspsResponseBody> body_ = nullptr;
  };
