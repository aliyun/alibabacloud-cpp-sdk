...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyWebAIProtectSwitchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyWebAIProtectSwitchResponseBody) };
    inline ModifyWebAIProtectSwitchResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyWebAIProtectSwitchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyWebAIProtectSwitchResponseBody> body_ {};
  };
