...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainViewTopCostTimeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainViewTopCostTimeResponseBody) };
    inline DescribeDomainViewTopCostTimeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainViewTopCostTimeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainViewTopCostTimeResponseBody> body_ {};
  };
