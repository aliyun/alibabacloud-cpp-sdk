...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBlackholeStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyBlackholeStatusResponseBody) };
    inline ModifyBlackholeStatusResponseBody body() { DARABONBA_PTR_GET(body_, ModifyBlackholeStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyBlackholeStatusResponseBody> body_ = nullptr;
  };
