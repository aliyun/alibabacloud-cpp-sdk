...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyQpsModeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyQpsModeResponseBody) };
    inline ModifyQpsModeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyQpsModeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyQpsModeResponseBody> body_ {};
  };
