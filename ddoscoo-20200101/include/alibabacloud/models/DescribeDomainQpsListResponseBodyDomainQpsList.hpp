...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->attackQps_ == nullptr
        && return this->cacheHits_ == nullptr && return this->index_ == nullptr && return this->maxAttackQps_ == nullptr && return this->maxNormalQps_ == nullptr && return this->maxQps_ == nullptr
        && return this->time_ == nullptr && return this->totalCount_ == nullptr && return this->totalQps_ == nullptr; };
