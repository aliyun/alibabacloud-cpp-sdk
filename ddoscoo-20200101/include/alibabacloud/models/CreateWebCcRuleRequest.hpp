...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->act_ == nullptr
        && return this->count_ == nullptr && return this->domain_ == nullptr && return this->interval_ == nullptr && return this->mode_ == nullptr && return this->name_ == nullptr
        && return this->resourceGroupId_ == nullptr && return this->ttl_ == nullptr && return this->uri_ == nullptr; };
    // act Field Functions 
