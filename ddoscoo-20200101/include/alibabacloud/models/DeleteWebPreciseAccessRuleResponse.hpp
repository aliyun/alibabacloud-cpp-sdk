...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteWebPreciseAccessRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteWebPreciseAccessRuleResponseBody) };
    inline DeleteWebPreciseAccessRuleResponseBody body() { DARABONBA_PTR_GET(body_, DeleteWebPreciseAccessRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteWebPreciseAccessRuleResponseBody> body_ = nullptr;
  };
