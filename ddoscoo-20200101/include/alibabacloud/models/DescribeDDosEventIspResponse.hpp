...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDDosEventIspResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDDosEventIspResponseBody) };
    inline DescribeDDosEventIspResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDDosEventIspResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDDosEventIspResponseBody> body_ {};
  };
