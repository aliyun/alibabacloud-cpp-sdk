...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigL7RsPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigL7RsPolicyResponseBody) };
    inline ConfigL7RsPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigL7RsPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigL7RsPolicyResponseBody> body_ {};
  };
