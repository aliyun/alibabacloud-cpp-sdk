...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebAccessModeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWebAccessModeResponseBody) };
    inline DescribeWebAccessModeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWebAccessModeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWebAccessModeResponseBody> body_ {};
  };
