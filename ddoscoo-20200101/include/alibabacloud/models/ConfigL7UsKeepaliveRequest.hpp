...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->domain_ == nullptr
        && return this->downstreamKeepalive_ == nullptr && return this->upstreamKeepalive_ == nullptr; };
    ...
    inline string upstreamKeepalive() const { DARABONBA_PTR_GET_DEFAULT(upstreamKeepalive_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> upstreamKeepalive_ = nullptr;
  };
