...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeInstanceStatisticsResponseBody) };
    inline DescribeInstanceStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeInstanceStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeInstanceStatisticsResponseBody> body_ {};
  };
