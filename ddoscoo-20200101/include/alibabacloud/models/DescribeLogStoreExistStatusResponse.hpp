...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLogStoreExistStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLogStoreExistStatusResponseBody) };
    inline DescribeLogStoreExistStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLogStoreExistStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLogStoreExistStatusResponseBody> body_ {};
  };
