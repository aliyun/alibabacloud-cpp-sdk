...
namespace Models
{
  ...
  public:
    ...
    inline const DisableWebCCRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableWebCCRuleResponseBody) };
    inline DisableWebCCRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableWebCCRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableWebCCRuleResponseBody> body_ {};
  };
