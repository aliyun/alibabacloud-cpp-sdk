...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBlockStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyBlockStatusResponseBody) };
    inline ModifyBlockStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyBlockStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyBlockStatusResponseBody> body_ {};
  };
