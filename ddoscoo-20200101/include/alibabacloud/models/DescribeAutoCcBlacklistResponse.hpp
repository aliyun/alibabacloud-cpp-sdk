...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAutoCcBlacklistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAutoCcBlacklistResponseBody) };
    inline DescribeAutoCcBlacklistResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAutoCcBlacklistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAutoCcBlacklistResponseBody> body_ {};
  };
