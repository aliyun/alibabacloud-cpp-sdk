...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyWebPreciseAccessRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyWebPreciseAccessRuleResponseBody) };
    inline ModifyWebPreciseAccessRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyWebPreciseAccessRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyWebPreciseAccessRuleResponseBody> body_ {};
  };
