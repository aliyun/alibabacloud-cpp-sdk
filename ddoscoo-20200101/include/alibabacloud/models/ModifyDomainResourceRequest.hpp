...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ModifyDomainResourceRequest::ProxyTypes> & getProxyTypes() const { DARABONBA_PTR_GET_CONST(proxyTypes_, vector<ModifyDomainResourceRequest::ProxyTypes>) };
    inline vector<ModifyDomainResourceRequest::ProxyTypes> getProxyTypes() { DARABONBA_PTR_GET(proxyTypes_, vector<ModifyDomainResourceRequest::ProxyTypes>) };
    inline ModifyDomainResourceRequest& setProxyTypes(const vector<ModifyDomainResourceRequest::ProxyTypes> & proxyTypes) { DARABONBA_PTR_SET_VALUE(proxyTypes_, proxyTypes) };
    inline ModifyDomainResourceRequest& setProxyTypes(vector<ModifyDomainResourceRequest::ProxyTypes> && proxyTypes) { DARABONBA_PTR_SET_RVALUE(proxyTypes_, proxyTypes) };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<ModifyDomainResourceRequest::ProxyTypes>> proxyTypes_ {};
