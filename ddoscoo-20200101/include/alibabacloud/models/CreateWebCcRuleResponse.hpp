...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWebCCRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateWebCCRuleResponseBody) };
    inline CreateWebCCRuleResponseBody body() { DARABONBA_PTR_GET(body_, CreateWebCCRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateWebCCRuleResponseBody> body_ = nullptr;
  };
