...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getExpireEndTime() const { DARABONBA_PTR_GET_DEFAULT(expireEndTime_, 0L) };
    ...
    inline int64_t getExpireStartTime() const { DARABONBA_PTR_GET_DEFAULT(expireStartTime_, 0L) };
  ...
  protected:
    ...
    shared_ptr<int64_t> expireEndTime_ {};
    ...
    shared_ptr<int64_t> expireStartTime_ {};
