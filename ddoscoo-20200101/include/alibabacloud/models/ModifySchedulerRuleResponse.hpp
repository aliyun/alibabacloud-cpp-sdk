...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySchedulerRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySchedulerRuleResponseBody) };
    inline ModifySchedulerRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySchedulerRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySchedulerRuleResponseBody> body_ {};
  };
