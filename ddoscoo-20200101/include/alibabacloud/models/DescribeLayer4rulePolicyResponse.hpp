...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLayer4RulePolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeLayer4RulePolicyResponseBody) };
    inline DescribeLayer4RulePolicyResponseBody body() { DARABONBA_PTR_GET(body_, DescribeLayer4RulePolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLayer4RulePolicyResponseBody> body_ = nullptr;
  };
