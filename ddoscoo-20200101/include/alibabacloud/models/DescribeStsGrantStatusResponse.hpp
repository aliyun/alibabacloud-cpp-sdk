...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeStsGrantStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeStsGrantStatusResponseBody) };
    inline DescribeStsGrantStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeStsGrantStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeStsGrantStatusResponseBody> body_ {};
  };
