...
namespace Models
{
  ...
  public:
    ...
    inline const EmptyAutoCcWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EmptyAutoCcWhitelistResponseBody) };
    inline EmptyAutoCcWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, EmptyAutoCcWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EmptyAutoCcWhitelistResponseBody> body_ {};
  };
