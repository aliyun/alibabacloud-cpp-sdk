...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePortResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePortResponseBody) };
    inline DescribePortResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePortResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePortResponseBody> body_ {};
  };
