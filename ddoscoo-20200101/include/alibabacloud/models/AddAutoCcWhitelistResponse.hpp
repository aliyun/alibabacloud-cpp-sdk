...
namespace Models
{
  ...
  public:
    ...
    inline const AddAutoCcWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddAutoCcWhitelistResponseBody) };
    inline AddAutoCcWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, AddAutoCcWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddAutoCcWhitelistResponseBody> body_ {};
  };
