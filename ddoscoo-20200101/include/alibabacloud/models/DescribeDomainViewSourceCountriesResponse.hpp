...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainViewSourceCountriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainViewSourceCountriesResponseBody) };
    inline DescribeDomainViewSourceCountriesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainViewSourceCountriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainViewSourceCountriesResponseBody> body_ {};
  };
