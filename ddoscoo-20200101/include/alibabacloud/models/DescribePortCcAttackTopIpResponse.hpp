...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePortCcAttackTopIPResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePortCcAttackTopIPResponseBody) };
    inline DescribePortCcAttackTopIPResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePortCcAttackTopIPResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePortCcAttackTopIPResponseBody> body_ {};
  };
