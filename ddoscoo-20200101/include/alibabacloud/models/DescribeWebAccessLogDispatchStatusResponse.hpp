...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebAccessLogDispatchStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWebAccessLogDispatchStatusResponseBody) };
    inline DescribeWebAccessLogDispatchStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWebAccessLogDispatchStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWebAccessLogDispatchStatusResponseBody> body_ {};
  };
