...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigNetworkRegionBlockResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigNetworkRegionBlockResponseBody) };
    inline ConfigNetworkRegionBlockResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigNetworkRegionBlockResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigNetworkRegionBlockResponseBody> body_ {};
  };
