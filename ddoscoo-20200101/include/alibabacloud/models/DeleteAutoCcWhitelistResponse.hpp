...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAutoCcWhitelistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAutoCcWhitelistResponseBody) };
    inline DeleteAutoCcWhitelistResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAutoCcWhitelistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAutoCcWhitelistResponseBody> body_ {};
  };
