...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyFullLogTtlResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyFullLogTtlResponseBody) };
    inline ModifyFullLogTtlResponseBody body() { DARABONBA_PTR_GET(body_, ModifyFullLogTtlResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyFullLogTtlResponseBody> body_ = nullptr;
  };
