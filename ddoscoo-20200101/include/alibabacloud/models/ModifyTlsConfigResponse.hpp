...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyTlsConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyTlsConfigResponseBody) };
    inline ModifyTlsConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyTlsConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyTlsConfigResponseBody> body_ {};
  };
