...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainSecurityProfileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainSecurityProfileResponseBody) };
    inline DescribeDomainSecurityProfileResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainSecurityProfileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainSecurityProfileResponseBody> body_ {};
  };
