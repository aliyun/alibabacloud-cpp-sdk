...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAutoCcBlacklistResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAutoCcBlacklistResponseBody) };
    inline DeleteAutoCcBlacklistResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAutoCcBlacklistResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAutoCcBlacklistResponseBody> body_ {};
  };
