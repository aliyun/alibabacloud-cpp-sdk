...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigLayer4RulePolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigLayer4RulePolicyResponseBody) };
    inline ConfigLayer4RulePolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigLayer4RulePolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigLayer4RulePolicyResponseBody> body_ {};
  };
