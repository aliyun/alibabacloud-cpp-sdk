...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebCacheConfigsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWebCacheConfigsResponseBody) };
    inline DescribeWebCacheConfigsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWebCacheConfigsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWebCacheConfigsResponseBody> body_ {};
  };
