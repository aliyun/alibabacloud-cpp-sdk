...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainH2FingerprintResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainH2FingerprintResponseBody) };
    inline DescribeDomainH2FingerprintResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainH2FingerprintResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainH2FingerprintResponseBody> body_ {};
  };
