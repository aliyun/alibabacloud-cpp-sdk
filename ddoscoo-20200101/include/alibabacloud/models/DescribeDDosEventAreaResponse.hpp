...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDDosEventAreaResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeDDosEventAreaResponseBody) };
    inline DescribeDDosEventAreaResponseBody body() { DARABONBA_PTR_GET(body_, DescribeDDosEventAreaResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeDDosEventAreaResponseBody> body_ = nullptr;
  };
