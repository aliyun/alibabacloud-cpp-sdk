...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeL7UsKeepaliveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeL7UsKeepaliveResponseBody) };
    inline DescribeL7UsKeepaliveResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeL7UsKeepaliveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeL7UsKeepaliveResponseBody> body_ {};
  };
