...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyElasticBandWidthResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyElasticBandWidthResponseBody) };
    inline ModifyElasticBandWidthResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyElasticBandWidthResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyElasticBandWidthResponseBody> body_ {};
  };
