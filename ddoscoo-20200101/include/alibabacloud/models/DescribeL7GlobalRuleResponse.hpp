...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeL7GlobalRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeL7GlobalRuleResponseBody) };
    inline DescribeL7GlobalRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeL7GlobalRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeL7GlobalRuleResponseBody> body_ {};
  };
