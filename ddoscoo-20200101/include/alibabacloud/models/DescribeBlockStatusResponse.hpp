...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBlockStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeBlockStatusResponseBody) };
    inline DescribeBlockStatusResponseBody body() { DARABONBA_PTR_GET(body_, DescribeBlockStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeBlockStatusResponseBody> body_ = nullptr;
  };
