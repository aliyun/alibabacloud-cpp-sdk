...
namespace Models
{
  ...
  public:
    ...
    inline const EnableWebCCRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableWebCCRuleResponseBody) };
    inline EnableWebCCRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableWebCCRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableWebCCRuleResponseBody> body_ {};
  };
