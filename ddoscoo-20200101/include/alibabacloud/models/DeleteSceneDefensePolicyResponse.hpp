...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSceneDefensePolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteSceneDefensePolicyResponseBody) };
    inline DeleteSceneDefensePolicyResponseBody body() { DARABONBA_PTR_GET(body_, DeleteSceneDefensePolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteSceneDefensePolicyResponseBody> body_ = nullptr;
  };
