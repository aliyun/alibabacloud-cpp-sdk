...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePortAttackMaxFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePortAttackMaxFlowResponseBody) };
    inline DescribePortAttackMaxFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePortAttackMaxFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePortAttackMaxFlowResponseBody> body_ {};
  };
