...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigNetworkRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigNetworkRulesResponseBody) };
    inline ConfigNetworkRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigNetworkRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigNetworkRulesResponseBody> body_ {};
  };
