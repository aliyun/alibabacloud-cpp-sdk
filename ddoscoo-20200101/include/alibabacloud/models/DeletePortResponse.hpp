...
namespace Models
{
  ...
  public:
    ...
    inline const DeletePortResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeletePortResponseBody) };
    inline DeletePortResponseBody getBody() { DARABONBA_PTR_GET(body_, DeletePortResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeletePortResponseBody> body_ {};
  };
