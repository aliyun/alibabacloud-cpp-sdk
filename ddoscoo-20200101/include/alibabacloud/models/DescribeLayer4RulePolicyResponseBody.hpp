...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->backendPort_ == nullptr
        && return this->bakMode_ == nullptr && return this->currentIndex_ == nullptr && return this->forwardProtocol_ == nullptr && return this->frontendPort_ == nullptr && return this->instanceId_ == nullptr
        && return this->priRealServers_ == nullptr && return this->requestId_ == nullptr && return this->secRealServers_ == nullptr; };
