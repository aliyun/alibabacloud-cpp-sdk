...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->connectTimeout_ == nullptr
        && return this->failTimeout_ == nullptr && return this->maxFails_ == nullptr && return this->mode_ == nullptr && return this->readTimeout_ == nullptr && return this->sendTimeout_ == nullptr
