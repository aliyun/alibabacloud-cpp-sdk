...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigL7UsKeepaliveResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigL7UsKeepaliveResponseBody) };
    inline ConfigL7UsKeepaliveResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigL7UsKeepaliveResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigL7UsKeepaliveResponseBody> body_ {};
  };
