...
namespace Models
{
  ...
  public:
    ...
    inline DescribeDDosEventMaxRequest& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline DescribeDDosEventMaxRequest& setIp(string ip) { DARABONBA_PTR_SET_VALUE(ip_, ip) };
    ...
    inline DescribeDDosEventMaxRequest& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
