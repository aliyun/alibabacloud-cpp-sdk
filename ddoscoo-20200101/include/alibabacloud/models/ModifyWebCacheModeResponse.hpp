...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyWebCacheModeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyWebCacheModeResponseBody) };
    inline ModifyWebCacheModeResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyWebCacheModeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyWebCacheModeResponseBody> body_ {};
  };
