...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOpEntitiesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeOpEntitiesResponseBody) };
    inline DescribeOpEntitiesResponseBody body() { DARABONBA_PTR_GET(body_, DescribeOpEntitiesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeOpEntitiesResponseBody> body_ = nullptr;
  };
