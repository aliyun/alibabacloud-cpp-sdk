...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDomainResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDomainResourceResponseBody) };
    inline DeleteDomainResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDomainResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDomainResourceResponseBody> body_ {};
  };
