...
namespace Models
{
  ...
  public:
    ...
    inline const CreateWebRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateWebRuleResponseBody) };
    inline CreateWebRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateWebRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateWebRuleResponseBody> body_ {};
  };
