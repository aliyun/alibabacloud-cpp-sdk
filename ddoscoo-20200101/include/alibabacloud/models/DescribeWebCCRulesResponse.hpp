...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebCCRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeWebCCRulesResponseBody) };
    inline DescribeWebCCRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeWebCCRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeWebCCRulesResponseBody> body_ {};
  };
