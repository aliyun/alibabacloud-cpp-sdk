...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyHttp2EnableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyHttp2EnableResponseBody) };
    inline ModifyHttp2EnableResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyHttp2EnableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyHttp2EnableResponseBody> body_ {};
  };
