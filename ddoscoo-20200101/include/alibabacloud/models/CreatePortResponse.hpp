...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePortResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePortResponseBody) };
    inline CreatePortResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePortResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePortResponseBody> body_ {};
  };
