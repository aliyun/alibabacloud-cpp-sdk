...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeWebAccessLogStatusResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeWebAccessLogStatusResponseBody) };
    inline DescribeWebAccessLogStatusResponseBody body() { DARABONBA_PTR_GET(body_, DescribeWebAccessLogStatusResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeWebAccessLogStatusResponseBody> body_ = nullptr;
  };
