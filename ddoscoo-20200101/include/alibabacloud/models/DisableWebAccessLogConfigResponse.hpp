...
namespace Models
{
  ...
  public:
    ...
    inline const DisableWebAccessLogConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DisableWebAccessLogConfigResponseBody) };
    inline DisableWebAccessLogConfigResponseBody body() { DARABONBA_PTR_GET(body_, DisableWebAccessLogConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DisableWebAccessLogConfigResponseBody> body_ = nullptr;
  };
