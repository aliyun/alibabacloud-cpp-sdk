...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainTopHttpMethodResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainTopHttpMethodResponseBody) };
    inline DescribeDomainTopHttpMethodResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainTopHttpMethodResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainTopHttpMethodResponseBody> body_ {};
  };
