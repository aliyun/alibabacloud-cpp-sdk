...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigLayer4RuleBakModeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigLayer4RuleBakModeResponseBody) };
    inline ConfigLayer4RuleBakModeResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigLayer4RuleBakModeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigLayer4RuleBakModeResponseBody> body_ {};
  };
