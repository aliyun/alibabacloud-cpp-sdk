...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDomainOverviewResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDomainOverviewResponseBody) };
    inline DescribeDomainOverviewResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDomainOverviewResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDomainOverviewResponseBody> body_ {};
  };
