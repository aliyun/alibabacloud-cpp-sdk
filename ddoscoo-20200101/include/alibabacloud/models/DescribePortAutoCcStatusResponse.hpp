...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePortAutoCcStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePortAutoCcStatusResponseBody) };
    inline DescribePortAutoCcStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePortAutoCcStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePortAutoCcStatusResponseBody> body_ {};
  };
