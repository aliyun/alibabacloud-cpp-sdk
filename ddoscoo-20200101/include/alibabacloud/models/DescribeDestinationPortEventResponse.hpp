...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDestinationPortEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDestinationPortEventResponseBody) };
    inline DescribeDestinationPortEventResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDestinationPortEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDestinationPortEventResponseBody> body_ {};
  };
