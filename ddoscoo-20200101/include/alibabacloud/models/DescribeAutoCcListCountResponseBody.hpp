...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->blackCount_ == nullptr
        && this->requestId_ == nullptr && this->whiteCount_ == nullptr; };
    ...
    inline int32_t getBlackCount() const { DARABONBA_PTR_GET_DEFAULT(blackCount_, 0) };
  ...
  protected:
    ...
    shared_ptr<int32_t> blackCount_ {};
