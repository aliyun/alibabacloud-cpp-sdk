...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCnameReusesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeCnameReusesResponseBody) };
    inline DescribeCnameReusesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeCnameReusesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeCnameReusesResponseBody> body_ {};
  };
