...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePortFlowListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePortFlowListResponseBody) };
    inline DescribePortFlowListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePortFlowListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePortFlowListResponseBody> body_ {};
  };
