...
namespace Models
{
  ...
  public:
    ...
    inline const DisableWebCCResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableWebCCResponseBody) };
    inline DisableWebCCResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableWebCCResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableWebCCResponseBody> body_ {};
  };
