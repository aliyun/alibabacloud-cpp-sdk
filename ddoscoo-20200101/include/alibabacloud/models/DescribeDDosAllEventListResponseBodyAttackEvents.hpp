...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->area_ == nullptr
        && return this->endTime_ == nullptr && return this->eventType_ == nullptr && return this->ip_ == nullptr && return this->mbps_ == nullptr && return this->port_ == nullptr
        && return this->pps_ == nullptr && return this->startTime_ == nullptr; };
