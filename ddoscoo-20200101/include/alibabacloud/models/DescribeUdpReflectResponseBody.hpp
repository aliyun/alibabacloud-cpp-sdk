...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getUdpSports() const { DARABONBA_PTR_GET_CONST(udpSports_, vector<string>) };
    inline vector<string> getUdpSports() { DARABONBA_PTR_GET(udpSports_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> udpSports_ {};
  };
