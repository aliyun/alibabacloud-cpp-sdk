...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyHeadersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyHeadersResponseBody) };
    inline ModifyHeadersResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyHeadersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyHeadersResponseBody> body_ {};
  };
