...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyElasticBizQpsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyElasticBizQpsResponseBody) };
    inline ModifyElasticBizQpsResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyElasticBizQpsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyElasticBizQpsResponseBody> body_ {};
  };
