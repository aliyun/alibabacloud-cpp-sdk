...
namespace Models
{
  ...
  public:
    ...
    inline const EnableWebCCResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableWebCCResponseBody) };
    inline EnableWebCCResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableWebCCResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableWebCCResponseBody> body_ {};
  };
