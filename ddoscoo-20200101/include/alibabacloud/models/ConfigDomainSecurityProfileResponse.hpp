...
namespace Models
{
  ...
  public:
    ...
    inline const ConfigDomainSecurityProfileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ConfigDomainSecurityProfileResponseBody) };
    inline ConfigDomainSecurityProfileResponseBody getBody() { DARABONBA_PTR_GET(body_, ConfigDomainSecurityProfileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ConfigDomainSecurityProfileResponseBody> body_ {};
  };
