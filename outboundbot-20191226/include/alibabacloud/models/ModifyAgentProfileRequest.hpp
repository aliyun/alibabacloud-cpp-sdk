...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->agentProfileId_ == nullptr
        && this->apiPluginJson_ == nullptr && this->description_ == nullptr && this->faqCategoryIds_ == nullptr && this->instanceId_ == nullptr && this->instructionJson_ == nullptr
    ...
    inline const vector<int64_t> & getFaqCategoryIds() const { DARABONBA_PTR_GET_CONST(faqCategoryIds_, vector<int64_t>) };
    inline vector<int64_t> getFaqCategoryIds() { DARABONBA_PTR_GET(faqCategoryIds_, vector<int64_t>) };
  ...
  protected:
    ...
    shared_ptr<vector<int64_t>> faqCategoryIds_ {};
    // This parameter is required.
