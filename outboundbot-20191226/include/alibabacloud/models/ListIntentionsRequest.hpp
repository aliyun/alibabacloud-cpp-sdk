...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->annotationMissionDataSourceType_ == nullptr
        && return this->botId_ == nullptr && return this->environment_ == nullptr && return this->instanceId_ == nullptr && return this->intentId_ == nullptr && return this->pageIndex_ == nullptr
        && return this->pageSize_ == nullptr && return this->scriptId_ == nullptr && return this->userNick_ == nullptr; };
