...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAgentProfileResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateAgentProfileResponseBody) };
    inline CreateAgentProfileResponseBody body() { DARABONBA_PTR_GET(body_, CreateAgentProfileResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateAgentProfileResponseBody> body_ = nullptr;
  };
