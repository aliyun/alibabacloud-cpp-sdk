...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->annotationMissionId_ == nullptr
        && this->annotationMissionSessionId_ == nullptr && this->environment_ == nullptr && this->includeStatusListJsonString_ == nullptr && this->pageIndex_ == nullptr && this->pageSize_ == nullptr; };
    ...
    inline int32_t getEnvironment() const { DARABONBA_PTR_GET_DEFAULT(environment_, 0) };
    ...
    inline string getIncludeStatusListJsonString() const { DARABONBA_PTR_GET_DEFAULT(includeStatusListJsonString_, "") };
