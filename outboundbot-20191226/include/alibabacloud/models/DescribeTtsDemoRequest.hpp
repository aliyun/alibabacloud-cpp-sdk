...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessKey_ == nullptr
        && return this->aliCustomizedVoice_ == nullptr && return this->appKey_ == nullptr && return this->engine_ == nullptr && return this->instanceId_ == nullptr && return this->nlsServiceType_ == nullptr
        && return this->pitchRate_ == nullptr && return this->scriptId_ == nullptr && return this->secretKey_ == nullptr && return this->speechRate_ == nullptr && return this->text_ == nullptr
    ...
    inline string aliCustomizedVoice() const { DARABONBA_PTR_GET_DEFAULT(aliCustomizedVoice_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> aliCustomizedVoice_ = nullptr;
