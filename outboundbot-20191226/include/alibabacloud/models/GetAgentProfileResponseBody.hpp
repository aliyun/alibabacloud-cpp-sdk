...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentProfileResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetAgentProfileResponseBody::Data) };
    inline GetAgentProfileResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetAgentProfileResponseBody::Data) };
    inline GetAgentProfileResponseBody& setData(const GetAgentProfileResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAgentProfileResponseBody& setData(GetAgentProfileResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
