...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEBEEBOTINTENTRESPONSEBODYINTENT_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEBEEBOTINTENTRESPONSEBODYINTENT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeBeebotIntentResponseBodyIntent& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeBeebotIntentResponseBodyIntent& obj) { 
    ...
    DescribeBeebotIntentResponseBodyIntent() = default ;
    DescribeBeebotIntentResponseBodyIntent(const DescribeBeebotIntentResponseBodyIntent &) = default ;
    DescribeBeebotIntentResponseBodyIntent(DescribeBeebotIntentResponseBodyIntent &&) = default ;
    DescribeBeebotIntentResponseBodyIntent(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeBeebotIntentResponseBodyIntent() = default ;
    DescribeBeebotIntentResponseBodyIntent& operator=(const DescribeBeebotIntentResponseBodyIntent &) = default ;
    DescribeBeebotIntentResponseBodyIntent& operator=(DescribeBeebotIntentResponseBodyIntent &&) = default ;
    ...
    inline DescribeBeebotIntentResponseBodyIntent& setAliasName(string aliasName) { DARABONBA_PTR_SET_VALUE(aliasName_, aliasName) };
    ...
    inline DescribeBeebotIntentResponseBodyIntent& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline DescribeBeebotIntentResponseBodyIntent& setCreateUserId(string createUserId) { DARABONBA_PTR_SET_VALUE(createUserId_, createUserId) };
    ...
    inline DescribeBeebotIntentResponseBodyIntent& setCreateUserName(string createUserName) { DARABONBA_PTR_SET_VALUE(createUserName_, createUserName) };
    ...
    inline DescribeBeebotIntentResponseBodyIntent& setIntentId(int64_t intentId) { DARABONBA_PTR_SET_VALUE(intentId_, intentId) };
    ...
    inline DescribeBeebotIntentResponseBodyIntent& setIntentName(string intentName) { DARABONBA_PTR_SET_VALUE(intentName_, intentName) };
    ...
    inline DescribeBeebotIntentResponseBodyIntent& setModifyTime(string modifyTime) { DARABONBA_PTR_SET_VALUE(modifyTime_, modifyTime) };
    ...
    inline DescribeBeebotIntentResponseBodyIntent& setModifyUserId(string modifyUserId) { DARABONBA_PTR_SET_VALUE(modifyUserId_, modifyUserId) };
    ...
    inline DescribeBeebotIntentResponseBodyIntent& setModifyUserName(string modifyUserName) { DARABONBA_PTR_SET_VALUE(modifyUserName_, modifyUserName) };
