...
#ifndef ALIBABACLOUD_MODELS_LISTANNOTATIONMISSIONSESSIONRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTANNOTATIONMISSIONSESSIONRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAnnotationMissionSessionResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAnnotationMissionSessionResponseBody& obj) { 
    ...
    ListAnnotationMissionSessionResponseBody() = default ;
    ListAnnotationMissionSessionResponseBody(const ListAnnotationMissionSessionResponseBody &) = default ;
    ListAnnotationMissionSessionResponseBody(ListAnnotationMissionSessionResponseBody &&) = default ;
    ListAnnotationMissionSessionResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAnnotationMissionSessionResponseBody() = default ;
    ListAnnotationMissionSessionResponseBody& operator=(const ListAnnotationMissionSessionResponseBody &) = default ;
    ListAnnotationMissionSessionResponseBody& operator=(ListAnnotationMissionSessionResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->annotationMissionId_ == nullptr && this->annotationMissionSessionId_ == nullptr && this->annotationStatus_ == nullptr && this->createTime_ == nullptr && this->debugConversation_ == nullptr
        && this->instanceId_ == nullptr && this->jobGroupId_ == nullptr && this->jobId_ == nullptr && this->modifiedTime_ == nullptr && this->scriptId_ == nullptr
        && this->sessionId_ == nullptr && this->version_ == nullptr; };
        ...
        inline bool getDebugConversation() const { DARABONBA_PTR_GET_DEFAULT(debugConversation_, false) };
        inline AnnotationMissionSessionList& setDebugConversation(bool debugConversation) { DARABONBA_PTR_SET_VALUE(debugConversation_, debugConversation) };
        ...
        inline AnnotationMissionSessionList& setVersion(int32_t version) { DARABONBA_PTR_SET_VALUE(version_, version) };
      ...
      virtual bool empty() const override { return this->annotationMissionId_ == nullptr
        && this->annotationMissionSessionList_ == nullptr && this->message_ == nullptr && this->success_ == nullptr && this->totalCount_ == nullptr; };
      // annotationMissionId Field Functions 
      bool hasAnnotationMissionId() const { return this->annotationMissionId_ != nullptr;};
      void deleteAnnotationMissionId() { this->annotationMissionId_ = nullptr;};
      inline string getAnnotationMissionId() const { DARABONBA_PTR_GET_DEFAULT(annotationMissionId_, "") };
      ...
      inline const vector<Data::AnnotationMissionSessionList> & getAnnotationMissionSessionList() const { DARABONBA_PTR_GET_CONST(annotationMissionSessionList_, vector<Data::AnnotationMissionSessionList>) };
      inline vector<Data::AnnotationMissionSessionList> getAnnotationMissionSessionList() { DARABONBA_PTR_GET(annotationMissionSessionList_, vector<Data::AnnotationMissionSessionList>) };
      inline Data& setAnnotationMissionSessionList(const vector<Data::AnnotationMissionSessionList> & annotationMissionSessionList) { DARABONBA_PTR_SET_VALUE(annotationMissionSessionList_, annotationMissionSessionList) };
      inline Data& setAnnotationMissionSessionList(vector<Data::AnnotationMissionSessionList> && annotationMissionSessionList) { DARABONBA_PTR_SET_RVALUE(annotationMissionSessionList_, annotationMissionSessionList) };
    ...
    inline ListAnnotationMissionSessionResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const ListAnnotationMissionSessionResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, ListAnnotationMissionSessionResponseBody::Data) };
    inline ListAnnotationMissionSessionResponseBody::Data getData() { DARABONBA_PTR_GET(data_, ListAnnotationMissionSessionResponseBody::Data) };
    inline ListAnnotationMissionSessionResponseBody& setData(const ListAnnotationMissionSessionResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAnnotationMissionSessionResponseBody& setData(ListAnnotationMissionSessionResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListAnnotationMissionSessionResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    void deleteMessage() { this->message_ = nullptr;};
    inline string getMessage() const { DARABONBA_PTR_GET_DEFAULT(message_, "") };
    inline ListAnnotationMissionSessionResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListAnnotationMissionSessionResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    void deleteSuccess() { this->success_ = nullptr;};
    inline bool getSuccess() const { DARABONBA_PTR_GET_DEFAULT(success_, false) };
    inline ListAnnotationMissionSessionResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
