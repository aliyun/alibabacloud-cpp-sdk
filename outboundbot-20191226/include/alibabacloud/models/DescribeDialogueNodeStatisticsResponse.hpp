...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDialogueNodeStatisticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDialogueNodeStatisticsResponseBody) };
    inline DescribeDialogueNodeStatisticsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDialogueNodeStatisticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDialogueNodeStatisticsResponseBody> body_ {};
  };
