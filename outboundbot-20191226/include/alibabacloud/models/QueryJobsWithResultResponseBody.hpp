...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->jobs_ == nullptr && return this->labels_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr
        && return this->success_ == nullptr && return this->variableNames_ == nullptr; };
    ...
    inline const QueryJobsWithResultResponseBodyJobs & jobs() const { DARABONBA_PTR_GET_CONST(jobs_, QueryJobsWithResultResponseBodyJobs) };
    inline QueryJobsWithResultResponseBodyJobs jobs() { DARABONBA_PTR_GET(jobs_, QueryJobsWithResultResponseBodyJobs) };
    inline QueryJobsWithResultResponseBody& setJobs(const QueryJobsWithResultResponseBodyJobs & jobs) { DARABONBA_PTR_SET_VALUE(jobs_, jobs) };
    inline QueryJobsWithResultResponseBody& setJobs(QueryJobsWithResultResponseBodyJobs && jobs) { DARABONBA_PTR_SET_RVALUE(jobs_, jobs) };


    // labels Field Functions 
    bool hasLabels() const { return this->labels_ != nullptr;};
    void deleteLabels() { this->labels_ = nullptr;};
    inline const vector<QueryJobsWithResultResponseBodyLabels> & labels() const { DARABONBA_PTR_GET_CONST(labels_, vector<QueryJobsWithResultResponseBodyLabels>) };
    inline vector<QueryJobsWithResultResponseBodyLabels> labels() { DARABONBA_PTR_GET(labels_, vector<QueryJobsWithResultResponseBodyLabels>) };
    inline QueryJobsWithResultResponseBody& setLabels(const vector<QueryJobsWithResultResponseBodyLabels> & labels) { DARABONBA_PTR_SET_VALUE(labels_, labels) };
    inline QueryJobsWithResultResponseBody& setLabels(vector<QueryJobsWithResultResponseBodyLabels> && labels) { DARABONBA_PTR_SET_RVALUE(labels_, labels) };
  ...
  protected:
    ...
    std::shared_ptr<QueryJobsWithResultResponseBodyJobs> jobs_ = nullptr;
    std::shared_ptr<vector<QueryJobsWithResultResponseBodyLabels>> labels_ = nullptr;
