  ...
  public:
    ...
    public:
      ...
      public:
        ...
        && this->status_ == nullptr && this->statusName_ == nullptr && this->tagHits_ == nullptr && this->taskEndReason_ == nullptr && this->voiceName_ == nullptr; };
          ...
          inline LatestTask& setVoiceName(string voiceName) { DARABONBA_PTR_SET_VALUE(voiceName_, voiceName) };
