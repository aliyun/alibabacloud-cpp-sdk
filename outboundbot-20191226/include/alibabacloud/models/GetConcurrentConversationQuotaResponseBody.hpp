...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->maxConcurrent_ == nullptr && return this->message_ == nullptr && return this->remainingConcurrent_ == nullptr && return this->requestId_ == nullptr
    ...
    inline int32_t maxConcurrent() const { DARABONBA_PTR_GET_DEFAULT(maxConcurrent_, 0) };
    ...
    inline int32_t remainingConcurrent() const { DARABONBA_PTR_GET_DEFAULT(remainingConcurrent_, 0) };
  ...
  protected:
    ...
    // maxConcurrent
    std::shared_ptr<int32_t> maxConcurrent_ = nullptr;
    std::shared_ptr<string> message_ = nullptr;
    std::shared_ptr<int32_t> remainingConcurrent_ = nullptr;
