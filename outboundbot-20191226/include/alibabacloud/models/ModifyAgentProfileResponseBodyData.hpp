...
#ifndef ALIBABACLOUD_MODELS_MODIFYAGENTPROFILERESPONSEBODYDATA_HPP_
#define ALIBABACLOUD_MODELS_MODIFYAGENTPROFILERESPONSEBODYDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyAgentProfileResponseBodyData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyAgentProfileResponseBodyData& obj) { 
    ...
    ModifyAgentProfileResponseBodyData() = default ;
    ModifyAgentProfileResponseBodyData(const ModifyAgentProfileResponseBodyData &) = default ;
    ModifyAgentProfileResponseBodyData(ModifyAgentProfileResponseBodyData &&) = default ;
    ModifyAgentProfileResponseBodyData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyAgentProfileResponseBodyData() = default ;
    ModifyAgentProfileResponseBodyData& operator=(const ModifyAgentProfileResponseBodyData &) = default ;
    ModifyAgentProfileResponseBodyData& operator=(ModifyAgentProfileResponseBodyData &&) = default ;
    ...
    inline ModifyAgentProfileResponseBodyData& setAgentProfileId(string agentProfileId) { DARABONBA_PTR_SET_VALUE(agentProfileId_, agentProfileId) };
    ...
    inline ModifyAgentProfileResponseBodyData& setAgentProfileTemplateId(string agentProfileTemplateId) { DARABONBA_PTR_SET_VALUE(agentProfileTemplateId_, agentProfileTemplateId) };
    ...
    inline ModifyAgentProfileResponseBodyData& setAgentType(string agentType) { DARABONBA_PTR_SET_VALUE(agentType_, agentType) };
    ...
    inline ModifyAgentProfileResponseBodyData& setApiPluginJson(string apiPluginJson) { DARABONBA_PTR_SET_VALUE(apiPluginJson_, apiPluginJson) };
    ...
    inline ModifyAgentProfileResponseBodyData& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ModifyAgentProfileResponseBodyData& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline ModifyAgentProfileResponseBodyData& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ModifyAgentProfileResponseBodyData& setInstructionJson(string instructionJson) { DARABONBA_PTR_SET_VALUE(instructionJson_, instructionJson) };
    ...
    inline ModifyAgentProfileResponseBodyData& setLabelsJson(string labelsJson) { DARABONBA_PTR_SET_VALUE(labelsJson_, labelsJson) };
    ...
    inline ModifyAgentProfileResponseBodyData& setModel(string model) { DARABONBA_PTR_SET_VALUE(model_, model) };
    ...
    inline ModifyAgentProfileResponseBodyData& setModelConfig(string modelConfig) { DARABONBA_PTR_SET_VALUE(modelConfig_, modelConfig) };
    ...
    inline ModifyAgentProfileResponseBodyData& setNluConfigJson(string nluConfigJson) { DARABONBA_PTR_SET_VALUE(nluConfigJson_, nluConfigJson) };
    ...
    inline ModifyAgentProfileResponseBodyData& setPrompt(string prompt) { DARABONBA_PTR_SET_VALUE(prompt_, prompt) };
    ...
    inline ModifyAgentProfileResponseBodyData& setPromptJson(string promptJson) { DARABONBA_PTR_SET_VALUE(promptJson_, promptJson) };
    ...
    inline ModifyAgentProfileResponseBodyData& setScenario(string scenario) { DARABONBA_PTR_SET_VALUE(scenario_, scenario) };
    ...
    inline ModifyAgentProfileResponseBodyData& setScriptId(string scriptId) { DARABONBA_PTR_SET_VALUE(scriptId_, scriptId) };
    ...
    inline ModifyAgentProfileResponseBodyData& setSystem(bool system) { DARABONBA_PTR_SET_VALUE(system_, system) };
    ...
    inline ModifyAgentProfileResponseBodyData& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline ModifyAgentProfileResponseBodyData& setVariablesJson(string variablesJson) { DARABONBA_PTR_SET_VALUE(variablesJson_, variablesJson) };
