...
namespace Models
{
  ...
  public:
    ...
    inline const CreateInstanceResponseBody::Instance & getInstance() const { DARABONBA_PTR_GET_CONST(instance_, CreateInstanceResponseBody::Instance) };
    inline CreateInstanceResponseBody::Instance getInstance() { DARABONBA_PTR_GET(instance_, CreateInstanceResponseBody::Instance) };
    inline CreateInstanceResponseBody& setInstance(const CreateInstanceResponseBody::Instance & instance) { DARABONBA_PTR_SET_VALUE(instance_, instance) };
    inline CreateInstanceResponseBody& setInstance(CreateInstanceResponseBody::Instance && instance) { DARABONBA_PTR_SET_RVALUE(instance_, instance) };
