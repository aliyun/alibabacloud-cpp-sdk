...
namespace Models
{
  ...
  public:
    ...
    inline const CreateInstanceResponseBodyInstance & instance() const { DARABONBA_PTR_GET_CONST(instance_, CreateInstanceResponseBodyInstance) };
    inline CreateInstanceResponseBodyInstance instance() { DARABONBA_PTR_GET(instance_, CreateInstanceResponseBodyInstance) };
    inline CreateInstanceResponseBody& setInstance(const CreateInstanceResponseBodyInstance & instance) { DARABONBA_PTR_SET_VALUE(instance_, instance) };
    inline CreateInstanceResponseBody& setInstance(CreateInstanceResponseBodyInstance && instance) { DARABONBA_PTR_SET_RVALUE(instance_, instance) };
  ...
  protected:
    ...
    std::shared_ptr<CreateInstanceResponseBodyInstance> instance_ = nullptr;
