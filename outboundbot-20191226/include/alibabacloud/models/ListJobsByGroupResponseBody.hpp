...
#ifndef ALIBABACLOUD_MODELS_LISTJOBSBYGROUPRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTJOBSBYGROUPRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListJobsByGroupResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListJobsByGroupResponseBody& obj) { 
    ...
    ListJobsByGroupResponseBody() = default ;
    ListJobsByGroupResponseBody(const ListJobsByGroupResponseBody &) = default ;
    ListJobsByGroupResponseBody(ListJobsByGroupResponseBody &&) = default ;
    ListJobsByGroupResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListJobsByGroupResponseBody() = default ;
    ListJobsByGroupResponseBody& operator=(const ListJobsByGroupResponseBody &) = default ;
    ListJobsByGroupResponseBody& operator=(ListJobsByGroupResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->content_ == nullptr && this->conversationDetailId_ == nullptr && this->jobGroupId_ == nullptr && this->jobId_ == nullptr && this->summaryId_ == nullptr
        && this->summaryName_ == nullptr && this->taskId_ == nullptr; };
          ...
          inline Summary& setJobGroupId(string jobGroupId) { DARABONBA_PTR_SET_VALUE(jobGroupId_, jobGroupId) };
        ...
        && this->summary_ == nullptr && this->systemPriority_ == nullptr; };
        ...
        inline List& setSystemPriority(int32_t systemPriority) { DARABONBA_PTR_SET_VALUE(systemPriority_, systemPriority) };
    ...
    inline ListJobsByGroupResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ListJobsByGroupResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };


    // jobs Field Functions 
    bool hasJobs() const { return this->jobs_ != nullptr;};
    void deleteJobs() { this->jobs_ = nullptr;};
    inline const ListJobsByGroupResponseBody::Jobs & getJobs() const { DARABONBA_PTR_GET_CONST(jobs_, ListJobsByGroupResponseBody::Jobs) };
    inline ListJobsByGroupResponseBody::Jobs getJobs() { DARABONBA_PTR_GET(jobs_, ListJobsByGroupResponseBody::Jobs) };
    inline ListJobsByGroupResponseBody& setJobs(const ListJobsByGroupResponseBody::Jobs & jobs) { DARABONBA_PTR_SET_VALUE(jobs_, jobs) };
    inline ListJobsByGroupResponseBody& setJobs(ListJobsByGroupResponseBody::Jobs && jobs) { DARABONBA_PTR_SET_RVALUE(jobs_, jobs) };
    ...
    inline ListJobsByGroupResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListJobsByGroupResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListJobsByGroupResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
