...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->feedback_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const DialogueResponseBodyFeedback & feedback() const { DARABONBA_PTR_GET_CONST(feedback_, DialogueResponseBodyFeedback) };
    inline DialogueResponseBodyFeedback feedback() { DARABONBA_PTR_GET(feedback_, DialogueResponseBodyFeedback) };
    inline DialogueResponseBody& setFeedback(const DialogueResponseBodyFeedback & feedback) { DARABONBA_PTR_SET_VALUE(feedback_, feedback) };
    inline DialogueResponseBody& setFeedback(DialogueResponseBodyFeedback && feedback) { DARABONBA_PTR_SET_RVALUE(feedback_, feedback) };
  ...
  protected:
    ...
    std::shared_ptr<DialogueResponseBodyFeedback> feedback_ = nullptr;
