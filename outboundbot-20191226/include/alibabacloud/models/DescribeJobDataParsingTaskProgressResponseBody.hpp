...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->progress_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const DescribeJobDataParsingTaskProgressResponseBodyProgress & progress() const { DARABONBA_PTR_GET_CONST(progress_, DescribeJobDataParsingTaskProgressResponseBodyProgress) };
    inline DescribeJobDataParsingTaskProgressResponseBodyProgress progress() { DARABONBA_PTR_GET(progress_, DescribeJobDataParsingTaskProgressResponseBodyProgress) };
    inline DescribeJobDataParsingTaskProgressResponseBody& setProgress(const DescribeJobDataParsingTaskProgressResponseBodyProgress & progress) { DARABONBA_PTR_SET_VALUE(progress_, progress) };
    inline DescribeJobDataParsingTaskProgressResponseBody& setProgress(DescribeJobDataParsingTaskProgressResponseBodyProgress && progress) { DARABONBA_PTR_SET_RVALUE(progress_, progress) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeJobDataParsingTaskProgressResponseBodyProgress> progress_ = nullptr;
