...
namespace Models
{
  ...
  public:
    ...
    inline const GetAnnotationMissionSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAnnotationMissionSummaryResponseBody) };
    inline GetAnnotationMissionSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAnnotationMissionSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAnnotationMissionSummaryResponseBody> body_ {};
  };
