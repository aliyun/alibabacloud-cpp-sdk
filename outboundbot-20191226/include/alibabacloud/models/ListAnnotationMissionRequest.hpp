...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->annotationMissionId_ == nullptr
        && this->annotationMissionName_ == nullptr && this->annotationStatusListFilter_ == nullptr && this->annotationStatusListStringFilter_ == nullptr && this->createTimeEndFilter_ == nullptr && this->createTimeStartFilter_ == nullptr
        && this->instanceId_ == nullptr && this->pageIndex_ == nullptr && this->pageSize_ == nullptr; };
    ...
    inline const vector<int32_t> & getAnnotationStatusListFilter() const { DARABONBA_PTR_GET_CONST(annotationStatusListFilter_, vector<int32_t>) };
    inline vector<int32_t> getAnnotationStatusListFilter() { DARABONBA_PTR_GET(annotationStatusListFilter_, vector<int32_t>) };
    ...
    inline string getAnnotationStatusListStringFilter() const { DARABONBA_PTR_GET_DEFAULT(annotationStatusListStringFilter_, "") };
    ...
    inline int64_t getCreateTimeEndFilter() const { DARABONBA_PTR_GET_DEFAULT(createTimeEndFilter_, 0L) };
    ...
    inline int64_t getCreateTimeStartFilter() const { DARABONBA_PTR_GET_DEFAULT(createTimeStartFilter_, 0L) };
