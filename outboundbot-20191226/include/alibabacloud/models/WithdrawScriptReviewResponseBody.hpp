...
namespace Models
{
  ...
  public:
    ...
    inline const WithdrawScriptReviewResponseBodyScript & script() const { DARABONBA_PTR_GET_CONST(script_, WithdrawScriptReviewResponseBodyScript) };
    inline WithdrawScriptReviewResponseBodyScript script() { DARABONBA_PTR_GET(script_, WithdrawScriptReviewResponseBodyScript) };
    inline WithdrawScriptReviewResponseBody& setScript(const WithdrawScriptReviewResponseBodyScript & script) { DARABONBA_PTR_SET_VALUE(script_, script) };
    inline WithdrawScriptReviewResponseBody& setScript(WithdrawScriptReviewResponseBodyScript && script) { DARABONBA_PTR_SET_RVALUE(script_, script) };
  ...
  protected:
    ...
    std::shared_ptr<WithdrawScriptReviewResponseBodyScript> script_ = nullptr;
