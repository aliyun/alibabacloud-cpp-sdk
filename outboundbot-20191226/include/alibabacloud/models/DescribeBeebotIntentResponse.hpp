...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeBeebotIntentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeBeebotIntentResponseBody) };
    inline DescribeBeebotIntentResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeBeebotIntentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeBeebotIntentResponseBody> body_ {};
  };
