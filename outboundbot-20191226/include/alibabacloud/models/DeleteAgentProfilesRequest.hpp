...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & agentProfileIds() const { DARABONBA_PTR_GET_CONST(agentProfileIds_, vector<string>) };
    inline vector<string> agentProfileIds() { DARABONBA_PTR_GET(agentProfileIds_, vector<string>) };
  ...
  protected:
    std::shared_ptr<vector<string>> agentProfileIds_ = nullptr;
