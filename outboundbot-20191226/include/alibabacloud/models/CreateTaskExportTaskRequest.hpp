...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actualTimeGte_ == nullptr
        ...
        && this->hasAnswered_ == nullptr && this->hasHangUpByRejection_ == nullptr && this->hasReachedEndOfFlow_ == nullptr && this->instanceId_ == nullptr && this->jobGroupId_ == nullptr
        && this->jobGroupNameQuery_ == nullptr && this->jobId_ == nullptr && this->jobStatusStringList_ == nullptr && this->otherId_ == nullptr && this->pageIndex_ == nullptr
        && this->pageSize_ == nullptr && this->recordingDurationGte_ == nullptr && this->recordingDurationLte_ == nullptr && this->scriptNameQuery_ == nullptr && this->sortBy_ == nullptr
        && this->sortOrder_ == nullptr && this->taskCreateTimeGte_ == nullptr && this->taskCreateTimeLte_ == nullptr && this->taskId_ == nullptr && this->taskStatusStringList_ == nullptr
        && this->userIdMatch_ == nullptr; };
