...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->jobGroups_ == nullptr && return this->message_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr
        && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->timeout_ == nullptr && return this->totalCount_ == nullptr && return this->vaild_ == nullptr; };
    ...
    inline const vector<ListJobGroupsAsyncResponseBodyJobGroups> & jobGroups() const { DARABONBA_PTR_GET_CONST(jobGroups_, vector<ListJobGroupsAsyncResponseBodyJobGroups>) };
    inline vector<ListJobGroupsAsyncResponseBodyJobGroups> jobGroups() { DARABONBA_PTR_GET(jobGroups_, vector<ListJobGroupsAsyncResponseBodyJobGroups>) };
    inline ListJobGroupsAsyncResponseBody& setJobGroups(const vector<ListJobGroupsAsyncResponseBodyJobGroups> & jobGroups) { DARABONBA_PTR_SET_VALUE(jobGroups_, jobGroups) };
    inline ListJobGroupsAsyncResponseBody& setJobGroups(vector<ListJobGroupsAsyncResponseBodyJobGroups> && jobGroups) { DARABONBA_PTR_SET_RVALUE(jobGroups_, jobGroups) };
    ...
    inline bool vaild() const { DARABONBA_PTR_GET_DEFAULT(vaild_, false) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListJobGroupsAsyncResponseBodyJobGroups>> jobGroups_ = nullptr;
    ...
    std::shared_ptr<bool> vaild_ = nullptr;
  };
