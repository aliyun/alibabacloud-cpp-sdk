...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBatchJobsResponseBodyJobGroup & jobGroup() const { DARABONBA_PTR_GET_CONST(jobGroup_, ModifyBatchJobsResponseBodyJobGroup) };
    inline ModifyBatchJobsResponseBodyJobGroup jobGroup() { DARABONBA_PTR_GET(jobGroup_, ModifyBatchJobsResponseBodyJobGroup) };
    inline ModifyBatchJobsResponseBody& setJobGroup(const ModifyBatchJobsResponseBodyJobGroup & jobGroup) { DARABONBA_PTR_SET_VALUE(jobGroup_, jobGroup) };
    inline ModifyBatchJobsResponseBody& setJobGroup(ModifyBatchJobsResponseBodyJobGroup && jobGroup) { DARABONBA_PTR_SET_RVALUE(jobGroup_, jobGroup) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyBatchJobsResponseBodyJobGroup> jobGroup_ = nullptr;
