...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentProfileTemplateResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAgentProfileTemplateResponseBody) };
    inline GetAgentProfileTemplateResponseBody body() { DARABONBA_PTR_GET(body_, GetAgentProfileTemplateResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAgentProfileTemplateResponseBody> body_ = nullptr;
  };
