...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentProfileResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAgentProfileResponseBody) };
    inline GetAgentProfileResponseBody body() { DARABONBA_PTR_GET(body_, GetAgentProfileResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAgentProfileResponseBody> body_ = nullptr;
  };
