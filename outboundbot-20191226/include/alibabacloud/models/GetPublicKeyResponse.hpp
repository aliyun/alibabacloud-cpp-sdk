...
namespace Models
{
  ...
  public:
    ...
    inline const GetPublicKeyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetPublicKeyResponseBody) };
    inline GetPublicKeyResponseBody getBody() { DARABONBA_PTR_GET(body_, GetPublicKeyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetPublicKeyResponseBody> body_ {};
  };
