...
namespace Models
{
  ...
  public:
    ...
    inline const GetAsrServerInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAsrServerInfoResponseBody) };
    inline GetAsrServerInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAsrServerInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAsrServerInfoResponseBody> body_ {};
  };
