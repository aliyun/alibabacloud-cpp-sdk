...
namespace Models
{
  ...
  public:
    ...
    inline GetPublicKeyResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetPublicKeyResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    ...
    inline GetPublicKeyResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline GetPublicKeyResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetPublicKeyResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
