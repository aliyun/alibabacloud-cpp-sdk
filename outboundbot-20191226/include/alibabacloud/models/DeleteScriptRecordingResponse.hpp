...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteScriptRecordingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteScriptRecordingResponseBody) };
    inline DeleteScriptRecordingResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteScriptRecordingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteScriptRecordingResponseBody> body_ {};
  };
