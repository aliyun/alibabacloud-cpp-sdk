...
namespace Models
{
  ...
  public:
    ...
    inline const ListGlobalQuestionsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListGlobalQuestionsResponseBody) };
    inline ListGlobalQuestionsResponseBody body() { DARABONBA_PTR_GET(body_, ListGlobalQuestionsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListGlobalQuestionsResponseBody> body_ = nullptr;
  };
