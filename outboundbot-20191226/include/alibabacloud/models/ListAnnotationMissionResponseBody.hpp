...
namespace Models
{
  ...
  public:
    ...
    inline const ListAnnotationMissionResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAnnotationMissionResponseBodyData) };
    inline ListAnnotationMissionResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAnnotationMissionResponseBodyData) };
    inline ListAnnotationMissionResponseBody& setData(const ListAnnotationMissionResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAnnotationMissionResponseBody& setData(ListAnnotationMissionResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListAnnotationMissionResponseBodyData> data_ = nullptr;
