...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->downloadTasks_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ListDownloadTasksResponseBodyDownloadTasks & downloadTasks() const { DARABONBA_PTR_GET_CONST(downloadTasks_, ListDownloadTasksResponseBodyDownloadTasks) };
    inline ListDownloadTasksResponseBodyDownloadTasks downloadTasks() { DARABONBA_PTR_GET(downloadTasks_, ListDownloadTasksResponseBodyDownloadTasks) };
    inline ListDownloadTasksResponseBody& setDownloadTasks(const ListDownloadTasksResponseBodyDownloadTasks & downloadTasks) { DARABONBA_PTR_SET_VALUE(downloadTasks_, downloadTasks) };
    inline ListDownloadTasksResponseBody& setDownloadTasks(ListDownloadTasksResponseBodyDownloadTasks && downloadTasks) { DARABONBA_PTR_SET_RVALUE(downloadTasks_, downloadTasks) };
  ...
  protected:
    ...
    std::shared_ptr<ListDownloadTasksResponseBodyDownloadTasks> downloadTasks_ = nullptr;
