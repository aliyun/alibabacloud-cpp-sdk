...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->executingInfo_ == nullptr && return this->groupId_ == nullptr && return this->httpStatusCode_ == nullptr && return this->instanceId_ == nullptr && return this->message_ == nullptr
    ...
    inline const DescribeGroupExecutingInfoResponseBodyExecutingInfo & executingInfo() const { DARABONBA_PTR_GET_CONST(executingInfo_, DescribeGroupExecutingInfoResponseBodyExecutingInfo) };
    inline DescribeGroupExecutingInfoResponseBodyExecutingInfo executingInfo() { DARABONBA_PTR_GET(executingInfo_, DescribeGroupExecutingInfoResponseBodyExecutingInfo) };
    inline DescribeGroupExecutingInfoResponseBody& setExecutingInfo(const DescribeGroupExecutingInfoResponseBodyExecutingInfo & executingInfo) { DARABONBA_PTR_SET_VALUE(executingInfo_, executingInfo) };
    inline DescribeGroupExecutingInfoResponseBody& setExecutingInfo(DescribeGroupExecutingInfoResponseBodyExecutingInfo && executingInfo) { DARABONBA_PTR_SET_RVALUE(executingInfo_, executingInfo) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeGroupExecutingInfoResponseBodyExecutingInfo> executingInfo_ = nullptr;
