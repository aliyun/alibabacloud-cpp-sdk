...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateUploadUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateUploadUrlResponseBody) };
    inline GenerateUploadUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateUploadUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateUploadUrlResponseBody> body_ {};
  };
