...
#ifndef ALIBABACLOUD_MODELS_LISTAGENTPROFILESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTAGENTPROFILESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAgentProfilesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAgentProfilesResponseBody& obj) { 
    ...
    ListAgentProfilesResponseBody() = default ;
    ListAgentProfilesResponseBody(const ListAgentProfilesResponseBody &) = default ;
    ListAgentProfilesResponseBody(ListAgentProfilesResponseBody &&) = default ;
    ListAgentProfilesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAgentProfilesResponseBody() = default ;
    ListAgentProfilesResponseBody& operator=(const ListAgentProfilesResponseBody &) = default ;
    ListAgentProfilesResponseBody& operator=(ListAgentProfilesResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->agentProfileId_ == nullptr
        && this->agentProfileTemplateId_ == nullptr && this->agentType_ == nullptr && this->createTime_ == nullptr && this->description_ == nullptr && this->instanceId_ == nullptr
        && this->instructionJson_ == nullptr && this->labelsJson_ == nullptr && this->model_ == nullptr && this->modelConfig_ == nullptr && this->prompt_ == nullptr
        && this->promptJson_ == nullptr && this->scenario_ == nullptr && this->scriptId_ == nullptr && this->system_ == nullptr && this->updateTime_ == nullptr
        && this->variablesJson_ == nullptr; };
    ...
    inline ListAgentProfilesResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const vector<ListAgentProfilesResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<ListAgentProfilesResponseBody::Data>) };
    inline vector<ListAgentProfilesResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<ListAgentProfilesResponseBody::Data>) };
    inline ListAgentProfilesResponseBody& setData(const vector<ListAgentProfilesResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAgentProfilesResponseBody& setData(vector<ListAgentProfilesResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline ListAgentProfilesResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline ListAgentProfilesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListAgentProfilesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListAgentProfilesResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
