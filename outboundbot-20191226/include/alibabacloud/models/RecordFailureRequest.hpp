...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actualTime_ == nullptr
        && return this->callId_ == nullptr && return this->calledNumber_ == nullptr && return this->callingNumber_ == nullptr && return this->dispositionCode_ == nullptr && return this->exceptionCodes_ == nullptr
        && return this->instanceId_ == nullptr && return this->taskId_ == nullptr; };
    ...
    inline string dispositionCode() const { DARABONBA_PTR_GET_DEFAULT(dispositionCode_, "") };
  ...
  protected:
    ...
    // This parameter is required.
    std::shared_ptr<string> dispositionCode_ = nullptr;
