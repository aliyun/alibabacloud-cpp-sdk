...
namespace Models
{
  ...
  public:
    ...
    inline const GetVersionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetVersionResponseBody) };
    inline GetVersionResponseBody body() { DARABONBA_PTR_GET(body_, GetVersionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetVersionResponseBody> body_ = nullptr;
  };
