...
namespace Models
{
  ...
  public:
    ...
    inline const GetAnnotationMissionSummaryResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAnnotationMissionSummaryResponseBodyData) };
    inline GetAnnotationMissionSummaryResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAnnotationMissionSummaryResponseBodyData) };
    inline GetAnnotationMissionSummaryResponseBody& setData(const GetAnnotationMissionSummaryResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAnnotationMissionSummaryResponseBody& setData(GetAnnotationMissionSummaryResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAnnotationMissionSummaryResponseBodyData> data_ = nullptr;
