...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDsReportsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDsReportsResponseBody) };
    inline DescribeDsReportsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDsReportsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDsReportsResponseBody> body_ {};
  };
