...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->scriptVoiceConfigs_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ListScriptVoiceConfigsResponseBodyScriptVoiceConfigs & scriptVoiceConfigs() const { DARABONBA_PTR_GET_CONST(scriptVoiceConfigs_, ListScriptVoiceConfigsResponseBodyScriptVoiceConfigs) };
    inline ListScriptVoiceConfigsResponseBodyScriptVoiceConfigs scriptVoiceConfigs() { DARABONBA_PTR_GET(scriptVoiceConfigs_, ListScriptVoiceConfigsResponseBodyScriptVoiceConfigs) };
    inline ListScriptVoiceConfigsResponseBody& setScriptVoiceConfigs(const ListScriptVoiceConfigsResponseBodyScriptVoiceConfigs & scriptVoiceConfigs) { DARABONBA_PTR_SET_VALUE(scriptVoiceConfigs_, scriptVoiceConfigs) };
    inline ListScriptVoiceConfigsResponseBody& setScriptVoiceConfigs(ListScriptVoiceConfigsResponseBodyScriptVoiceConfigs && scriptVoiceConfigs) { DARABONBA_PTR_SET_RVALUE(scriptVoiceConfigs_, scriptVoiceConfigs) };
  ...
  protected:
    ...
    std::shared_ptr<ListScriptVoiceConfigsResponseBodyScriptVoiceConfigs> scriptVoiceConfigs_ = nullptr;
