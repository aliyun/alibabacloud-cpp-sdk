...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->contactWhitelistList_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const GetContactWhiteListResponseBodyContactWhitelistList & contactWhitelistList() const { DARABONBA_PTR_GET_CONST(contactWhitelistList_, GetContactWhiteListResponseBodyContactWhitelistList) };
    inline GetContactWhiteListResponseBodyContactWhitelistList contactWhitelistList() { DARABONBA_PTR_GET(contactWhitelistList_, GetContactWhiteListResponseBodyContactWhitelistList) };
    inline GetContactWhiteListResponseBody& setContactWhitelistList(const GetContactWhiteListResponseBodyContactWhitelistList & contactWhitelistList) { DARABONBA_PTR_SET_VALUE(contactWhitelistList_, contactWhitelistList) };
    inline GetContactWhiteListResponseBody& setContactWhitelistList(GetContactWhiteListResponseBodyContactWhitelistList && contactWhitelistList) { DARABONBA_PTR_SET_RVALUE(contactWhitelistList_, contactWhitelistList) };
  ...
  protected:
    ...
    std::shared_ptr<GetContactWhiteListResponseBodyContactWhitelistList> contactWhitelistList_ = nullptr;
