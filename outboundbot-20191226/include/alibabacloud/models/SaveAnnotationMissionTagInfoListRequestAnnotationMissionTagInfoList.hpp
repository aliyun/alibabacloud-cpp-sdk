...
#ifndef ALIBABACLOUD_MODELS_SAVEANNOTATIONMISSIONTAGINFOLISTREQUESTANNOTATIONMISSIONTAGINFOLIST_HPP_
#define ALIBABACLOUD_MODELS_SAVEANNOTATIONMISSIONTAGINFOLISTREQUESTANNOTATIONMISSIONTAGINFOLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList& obj) { 
    ...
    SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList() = default ;
    SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList(const SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList &) = default ;
    SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList(SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList &&) = default ;
    SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList() = default ;
    SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList& operator=(const SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList &) = default ;
    SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList& operator=(SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList &&) = default ;
    ...
    inline SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList& setAnnotationMissionTagInfoDescription(string annotationMissionTagInfoDescription) { DARABONBA_PTR_SET_VALUE(annotationMissionTagInfoDescription_, annotationMissionTagInfoDescription) };
    ...
    inline SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList& setAnnotationMissionTagInfoId(string annotationMissionTagInfoId) { DARABONBA_PTR_SET_VALUE(annotationMissionTagInfoId_, annotationMissionTagInfoId) };
    ...
    inline SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList& setAnnotationMissionTagInfoName(string annotationMissionTagInfoName) { DARABONBA_PTR_SET_VALUE(annotationMissionTagInfoName_, annotationMissionTagInfoName) };
    ...
    inline SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList& setDelete(bool _delete) { DARABONBA_PTR_SET_VALUE(delete_, _delete) };
    ...
    inline SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline SaveAnnotationMissionTagInfoListRequestAnnotationMissionTagInfoList& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
