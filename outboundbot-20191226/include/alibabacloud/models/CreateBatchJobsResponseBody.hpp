...
#ifndef ALIBABACLOUD_MODELS_CREATEBATCHJOBSRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEBATCHJOBSRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateBatchJobsResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(BatchJob, batchJob_);
    ...
    friend void from_json(const Darabonba::Json& j, CreateBatchJobsResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(BatchJob, batchJob_);
    ...
    CreateBatchJobsResponseBody() = default ;
    CreateBatchJobsResponseBody(const CreateBatchJobsResponseBody &) = default ;
    CreateBatchJobsResponseBody(CreateBatchJobsResponseBody &&) = default ;
    CreateBatchJobsResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateBatchJobsResponseBody() = default ;
    CreateBatchJobsResponseBody& operator=(const CreateBatchJobsResponseBody &) = default ;
    CreateBatchJobsResponseBody& operator=(CreateBatchJobsResponseBody &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    class BatchJob : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const BatchJob& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, BatchJob& obj) { 
      ...
      BatchJob() = default ;
      BatchJob(const BatchJob &) = default ;
      BatchJob(BatchJob &&) = default ;
      BatchJob(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~BatchJob() = default ;
      BatchJob& operator=(const BatchJob &) = default ;
      BatchJob& operator=(BatchJob &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      virtual bool empty() const override { return this->batchJobId_ == nullptr
        && this->callingNumbers_ == nullptr && this->creationTime_ == nullptr && this->jobFilePath_ == nullptr && this->jobGroupDescription_ == nullptr && this->jobGroupName_ == nullptr
      ...
      inline string getBatchJobId() const { DARABONBA_PTR_GET_DEFAULT(batchJobId_, "") };
      inline BatchJob& setBatchJobId(string batchJobId) { DARABONBA_PTR_SET_VALUE(batchJobId_, batchJobId) };
      ...
      inline BatchJob& setCallingNumbers(const vector<string> & callingNumbers) { DARABONBA_PTR_SET_VALUE(callingNumbers_, callingNumbers) };
      inline BatchJob& setCallingNumbers(vector<string> && callingNumbers) { DARABONBA_PTR_SET_RVALUE(callingNumbers_, callingNumbers) };
      ...
      inline BatchJob& setCreationTime(int64_t creationTime) { DARABONBA_PTR_SET_VALUE(creationTime_, creationTime) };
      ...
      inline BatchJob& setJobFilePath(string jobFilePath) { DARABONBA_PTR_SET_VALUE(jobFilePath_, jobFilePath) };
      ...
      inline BatchJob& setJobGroupDescription(string jobGroupDescription) { DARABONBA_PTR_SET_VALUE(jobGroupDescription_, jobGroupDescription) };
      ...
      inline BatchJob& setJobGroupName(string jobGroupName) { DARABONBA_PTR_SET_VALUE(jobGroupName_, jobGroupName) };
      ...
      inline BatchJob& setScenarioId(string scenarioId) { DARABONBA_PTR_SET_VALUE(scenarioId_, scenarioId) };


      // strategy Field Functions 
      bool hasStrategy() const { return this->strategy_ != nullptr;};
      void deleteStrategy() { this->strategy_ = nullptr;};
      inline const BatchJob::Strategy & getStrategy() const { DARABONBA_PTR_GET_CONST(strategy_, BatchJob::Strategy) };
      inline BatchJob::Strategy getStrategy() { DARABONBA_PTR_GET(strategy_, BatchJob::Strategy) };
      inline BatchJob& setStrategy(const BatchJob::Strategy & strategy) { DARABONBA_PTR_SET_VALUE(strategy_, strategy) };
      inline BatchJob& setStrategy(BatchJob::Strategy && strategy) { DARABONBA_PTR_SET_RVALUE(strategy_, strategy) };
    ...
    virtual bool empty() const override { return this->batchJob_ == nullptr
        && this->code_ == nullptr && this->httpStatusCode_ == nullptr && this->message_ == nullptr && this->requestId_ == nullptr && this->success_ == nullptr; };
    // batchJob Field Functions 
    bool hasBatchJob() const { return this->batchJob_ != nullptr;};
    void deleteBatchJob() { this->batchJob_ = nullptr;};
    inline const CreateBatchJobsResponseBody::BatchJob & getBatchJob() const { DARABONBA_PTR_GET_CONST(batchJob_, CreateBatchJobsResponseBody::BatchJob) };
    inline CreateBatchJobsResponseBody::BatchJob getBatchJob() { DARABONBA_PTR_GET(batchJob_, CreateBatchJobsResponseBody::BatchJob) };
    inline CreateBatchJobsResponseBody& setBatchJob(const CreateBatchJobsResponseBody::BatchJob & batchJob) { DARABONBA_PTR_SET_VALUE(batchJob_, batchJob) };
    inline CreateBatchJobsResponseBody& setBatchJob(CreateBatchJobsResponseBody::BatchJob && batchJob) { DARABONBA_PTR_SET_RVALUE(batchJob_, batchJob) };
    ...
    inline CreateBatchJobsResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreateBatchJobsResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateBatchJobsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateBatchJobsResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateBatchJobsResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
