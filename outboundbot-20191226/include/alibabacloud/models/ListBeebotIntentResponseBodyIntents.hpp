...
#ifndef ALIBABACLOUD_MODELS_LISTBEEBOTINTENTRESPONSEBODYINTENTS_HPP_
#define ALIBABACLOUD_MODELS_LISTBEEBOTINTENTRESPONSEBODYINTENTS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListBeebotIntentResponseBodyIntents& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListBeebotIntentResponseBodyIntents& obj) { 
    ...
    ListBeebotIntentResponseBodyIntents() = default ;
    ListBeebotIntentResponseBodyIntents(const ListBeebotIntentResponseBodyIntents &) = default ;
    ListBeebotIntentResponseBodyIntents(ListBeebotIntentResponseBodyIntents &&) = default ;
    ListBeebotIntentResponseBodyIntents(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListBeebotIntentResponseBodyIntents() = default ;
    ListBeebotIntentResponseBodyIntents& operator=(const ListBeebotIntentResponseBodyIntents &) = default ;
    ListBeebotIntentResponseBodyIntents& operator=(ListBeebotIntentResponseBodyIntents &&) = default ;
    ...
    inline ListBeebotIntentResponseBodyIntents& setAliasName(string aliasName) { DARABONBA_PTR_SET_VALUE(aliasName_, aliasName) };
    ...
    inline ListBeebotIntentResponseBodyIntents& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListBeebotIntentResponseBodyIntents& setCreateUserId(string createUserId) { DARABONBA_PTR_SET_VALUE(createUserId_, createUserId) };
    ...
    inline ListBeebotIntentResponseBodyIntents& setCreateUserName(string createUserName) { DARABONBA_PTR_SET_VALUE(createUserName_, createUserName) };
    ...
    inline ListBeebotIntentResponseBodyIntents& setIntentId(int64_t intentId) { DARABONBA_PTR_SET_VALUE(intentId_, intentId) };
    ...
    inline ListBeebotIntentResponseBodyIntents& setIntentName(string intentName) { DARABONBA_PTR_SET_VALUE(intentName_, intentName) };
    ...
    inline ListBeebotIntentResponseBodyIntents& setModifyTime(string modifyTime) { DARABONBA_PTR_SET_VALUE(modifyTime_, modifyTime) };
    ...
    inline ListBeebotIntentResponseBodyIntents& setModifyUserId(string modifyUserId) { DARABONBA_PTR_SET_VALUE(modifyUserId_, modifyUserId) };
    ...
    inline ListBeebotIntentResponseBodyIntents& setModifyUserName(string modifyUserName) { DARABONBA_PTR_SET_VALUE(modifyUserName_, modifyUserName) };
