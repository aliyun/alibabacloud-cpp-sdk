...
namespace Models
{
  ...
  public:
    ...
    inline const DownloadScriptRecordingResponseBodyDownloadParams & downloadParams() const { DARABONBA_PTR_GET_CONST(downloadParams_, DownloadScriptRecordingResponseBodyDownloadParams) };
    inline DownloadScriptRecordingResponseBodyDownloadParams downloadParams() { DARABONBA_PTR_GET(downloadParams_, DownloadScriptRecordingResponseBodyDownloadParams) };
    inline DownloadScriptRecordingResponseBody& setDownloadParams(const DownloadScriptRecordingResponseBodyDownloadParams & downloadParams) { DARABONBA_PTR_SET_VALUE(downloadParams_, downloadParams) };
    inline DownloadScriptRecordingResponseBody& setDownloadParams(DownloadScriptRecordingResponseBodyDownloadParams && downloadParams) { DARABONBA_PTR_SET_RVALUE(downloadParams_, downloadParams) };
  ...
  protected:
    ...
    std::shared_ptr<DownloadScriptRecordingResponseBodyDownloadParams> downloadParams_ = nullptr;
