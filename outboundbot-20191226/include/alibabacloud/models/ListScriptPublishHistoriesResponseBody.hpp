...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->scriptPublishHistories_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ListScriptPublishHistoriesResponseBodyScriptPublishHistories & scriptPublishHistories() const { DARABONBA_PTR_GET_CONST(scriptPublishHistories_, ListScriptPublishHistoriesResponseBodyScriptPublishHistories) };
    inline ListScriptPublishHistoriesResponseBodyScriptPublishHistories scriptPublishHistories() { DARABONBA_PTR_GET(scriptPublishHistories_, ListScriptPublishHistoriesResponseBodyScriptPublishHistories) };
    inline ListScriptPublishHistoriesResponseBody& setScriptPublishHistories(const ListScriptPublishHistoriesResponseBodyScriptPublishHistories & scriptPublishHistories) { DARABONBA_PTR_SET_VALUE(scriptPublishHistories_, scriptPublishHistories) };
    inline ListScriptPublishHistoriesResponseBody& setScriptPublishHistories(ListScriptPublishHistoriesResponseBodyScriptPublishHistories && scriptPublishHistories) { DARABONBA_PTR_SET_RVALUE(scriptPublishHistories_, scriptPublishHistories) };
  ...
  protected:
    ...
    std::shared_ptr<ListScriptPublishHistoriesResponseBodyScriptPublishHistories> scriptPublishHistories_ = nullptr;
