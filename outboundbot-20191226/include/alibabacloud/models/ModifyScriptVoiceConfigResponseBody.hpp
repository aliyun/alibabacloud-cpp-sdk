...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyScriptVoiceConfigResponseBody::ScriptVoiceConfig & getScriptVoiceConfig() const { DARABONBA_PTR_GET_CONST(scriptVoiceConfig_, ModifyScriptVoiceConfigResponseBody::ScriptVoiceConfig) };
    inline ModifyScriptVoiceConfigResponseBody::ScriptVoiceConfig getScriptVoiceConfig() { DARABONBA_PTR_GET(scriptVoiceConfig_, ModifyScriptVoiceConfigResponseBody::ScriptVoiceConfig) };
    inline ModifyScriptVoiceConfigResponseBody& setScriptVoiceConfig(const ModifyScriptVoiceConfigResponseBody::ScriptVoiceConfig & scriptVoiceConfig) { DARABONBA_PTR_SET_VALUE(scriptVoiceConfig_, scriptVoiceConfig) };
    inline ModifyScriptVoiceConfigResponseBody& setScriptVoiceConfig(ModifyScriptVoiceConfigResponseBody::ScriptVoiceConfig && scriptVoiceConfig) { DARABONBA_PTR_SET_RVALUE(scriptVoiceConfig_, scriptVoiceConfig) };
