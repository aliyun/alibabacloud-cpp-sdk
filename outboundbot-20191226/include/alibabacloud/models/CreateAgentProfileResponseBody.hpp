...
#ifndef ALIBABACLOUD_MODELS_CREATEAGENTPROFILERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEAGENTPROFILERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAgentProfileResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateAgentProfileResponseBody& obj) { 
    ...
    CreateAgentProfileResponseBody() = default ;
    CreateAgentProfileResponseBody(const CreateAgentProfileResponseBody &) = default ;
    CreateAgentProfileResponseBody(CreateAgentProfileResponseBody &&) = default ;
    CreateAgentProfileResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAgentProfileResponseBody() = default ;
    CreateAgentProfileResponseBody& operator=(const CreateAgentProfileResponseBody &) = default ;
    CreateAgentProfileResponseBody& operator=(CreateAgentProfileResponseBody &&) = default ;
    ...
    inline CreateAgentProfileResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateAgentProfileResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateAgentProfileResponseBody::Data) };
    inline CreateAgentProfileResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateAgentProfileResponseBody::Data) };
    inline CreateAgentProfileResponseBody& setData(const CreateAgentProfileResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateAgentProfileResponseBody& setData(CreateAgentProfileResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateAgentProfileResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateAgentProfileResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateAgentProfileResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateAgentProfileResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
