...
namespace Models
{
  ...
  public:
    ...
    inline const ListAllTenantBindNumberBindingResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListAllTenantBindNumberBindingResponseBodyData) };
    inline ListAllTenantBindNumberBindingResponseBodyData data() { DARABONBA_PTR_GET(data_, ListAllTenantBindNumberBindingResponseBodyData) };
    inline ListAllTenantBindNumberBindingResponseBody& setData(const ListAllTenantBindNumberBindingResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListAllTenantBindNumberBindingResponseBody& setData(ListAllTenantBindNumberBindingResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListAllTenantBindNumberBindingResponseBodyData> data_ = nullptr;
