...
#ifndef ALIBABACLOUD_MODELS_LISTANNOTATIONMISSIONSESSIONRESPONSEBODYDATAANNOTATIONMISSIONSESSIONLISTANNOTATIONMISSIONCHATLIST_HPP_
#define ALIBABACLOUD_MODELS_LISTANNOTATIONMISSIONSESSIONRESPONSEBODYDATAANNOTATIONMISSIONSESSIONLISTANNOTATIONMISSIONCHATLIST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& obj) { 
    ...
    ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList() = default ;
    ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList(const ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList &) = default ;
    ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList(ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList &&) = default ;
    ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList() = default ;
    ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& operator=(const ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList &) = default ;
    ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& operator=(ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList &&) = default ;
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnnotationAsrResult(string annotationAsrResult) { DARABONBA_PTR_SET_VALUE(annotationAsrResult_, annotationAsrResult) };
    ...
    inline const vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatCustomizationDataInfoList> & annotationMissionChatCustomizationDataInfoList() const { DARABONBA_PTR_GET_CONST(annotationMissionChatCustomizationDataInfoList_, vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatCustomizationDataInfoList>) };
    inline vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatCustomizationDataInfoList> annotationMissionChatCustomizationDataInfoList() { DARABONBA_PTR_GET(annotationMissionChatCustomizationDataInfoList_, vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatCustomizationDataInfoList>) };
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnnotationMissionChatCustomizationDataInfoList(const vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatCustomizationDataInfoList> & annotationMissionChatCustomizationDataInfoList) { DARABONBA_PTR_SET_VALUE(annotationMissionChatCustomizationDataInfoList_, annotationMissionChatCustomizationDataInfoList) };
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnnotationMissionChatCustomizationDataInfoList(vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatCustomizationDataInfoList> && annotationMissionChatCustomizationDataInfoList) { DARABONBA_PTR_SET_RVALUE(annotationMissionChatCustomizationDataInfoList_, annotationMissionChatCustomizationDataInfoList) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnnotationMissionChatId(string annotationMissionChatId) { DARABONBA_PTR_SET_VALUE(annotationMissionChatId_, annotationMissionChatId) };
    ...
    inline const vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatIntentUserSayInfoList> & annotationMissionChatIntentUserSayInfoList() const { DARABONBA_PTR_GET_CONST(annotationMissionChatIntentUserSayInfoList_, vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatIntentUserSayInfoList>) };
    inline vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatIntentUserSayInfoList> annotationMissionChatIntentUserSayInfoList() { DARABONBA_PTR_GET(annotationMissionChatIntentUserSayInfoList_, vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatIntentUserSayInfoList>) };
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnnotationMissionChatIntentUserSayInfoList(const vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatIntentUserSayInfoList> & annotationMissionChatIntentUserSayInfoList) { DARABONBA_PTR_SET_VALUE(annotationMissionChatIntentUserSayInfoList_, annotationMissionChatIntentUserSayInfoList) };
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnnotationMissionChatIntentUserSayInfoList(vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatIntentUserSayInfoList> && annotationMissionChatIntentUserSayInfoList) { DARABONBA_PTR_SET_RVALUE(annotationMissionChatIntentUserSayInfoList_, annotationMissionChatIntentUserSayInfoList) };
    ...
    inline const vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatTagInfoList> & annotationMissionChatTagInfoList() const { DARABONBA_PTR_GET_CONST(annotationMissionChatTagInfoList_, vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatTagInfoList>) };
    inline vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatTagInfoList> annotationMissionChatTagInfoList() { DARABONBA_PTR_GET(annotationMissionChatTagInfoList_, vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatTagInfoList>) };
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnnotationMissionChatTagInfoList(const vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatTagInfoList> & annotationMissionChatTagInfoList) { DARABONBA_PTR_SET_VALUE(annotationMissionChatTagInfoList_, annotationMissionChatTagInfoList) };
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnnotationMissionChatTagInfoList(vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatTagInfoList> && annotationMissionChatTagInfoList) { DARABONBA_PTR_SET_RVALUE(annotationMissionChatTagInfoList_, annotationMissionChatTagInfoList) };
    ...
    inline const vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatVocabularyInfoList> & annotationMissionChatVocabularyInfoList() const { DARABONBA_PTR_GET_CONST(annotationMissionChatVocabularyInfoList_, vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatVocabularyInfoList>) };
    inline vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatVocabularyInfoList> annotationMissionChatVocabularyInfoList() { DARABONBA_PTR_GET(annotationMissionChatVocabularyInfoList_, vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatVocabularyInfoList>) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnnotationMissionId(string annotationMissionId) { DARABONBA_PTR_SET_VALUE(annotationMissionId_, annotationMissionId) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnnotationMissionSessionId(string annotationMissionSessionId) { DARABONBA_PTR_SET_VALUE(annotationMissionSessionId_, annotationMissionSessionId) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnnotationStatus(int32_t annotationStatus) { DARABONBA_PTR_SET_VALUE(annotationStatus_, annotationStatus) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAnswer(string answer) { DARABONBA_PTR_SET_VALUE(answer_, answer) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setAsrAnnotationStatus(int32_t asrAnnotationStatus) { DARABONBA_PTR_SET_VALUE(asrAnnotationStatus_, asrAnnotationStatus) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setIntentAnnotationStatus(int32_t intentAnnotationStatus) { DARABONBA_PTR_SET_VALUE(intentAnnotationStatus_, intentAnnotationStatus) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setModifiedTime(int64_t modifiedTime) { DARABONBA_PTR_SET_VALUE(modifiedTime_, modifiedTime) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setOccurTime(int64_t occurTime) { DARABONBA_PTR_SET_VALUE(occurTime_, occurTime) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setOriginalAsrResult(string originalAsrResult) { DARABONBA_PTR_SET_VALUE(originalAsrResult_, originalAsrResult) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setSequenceId(string sequenceId) { DARABONBA_PTR_SET_VALUE(sequenceId_, sequenceId) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setSubStatus(int32_t subStatus) { DARABONBA_PTR_SET_VALUE(subStatus_, subStatus) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setTagAnnotationStatus(int32_t tagAnnotationStatus) { DARABONBA_PTR_SET_VALUE(tagAnnotationStatus_, tagAnnotationStatus) };
    ...
    inline ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatList& setTranslationError(int32_t translationError) { DARABONBA_PTR_SET_VALUE(translationError_, translationError) };


  protected:
    std::shared_ptr<string> annotationAsrResult_ = nullptr;
    std::shared_ptr<vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatCustomizationDataInfoList>> annotationMissionChatCustomizationDataInfoList_ = nullptr;
    // chat id
    std::shared_ptr<string> annotationMissionChatId_ = nullptr;
    std::shared_ptr<vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatIntentUserSayInfoList>> annotationMissionChatIntentUserSayInfoList_ = nullptr;
    std::shared_ptr<vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatTagInfoList>> annotationMissionChatTagInfoList_ = nullptr;
    std::shared_ptr<vector<Models::ListAnnotationMissionSessionResponseBodyDataAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatVocabularyInfoList>> annotationMissionChatVocabularyInfoList_ = nullptr;
