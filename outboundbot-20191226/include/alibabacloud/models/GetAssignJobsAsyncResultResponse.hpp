...
namespace Models
{
  ...
  public:
    ...
    inline const GetAssignJobsAsyncResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAssignJobsAsyncResultResponseBody) };
    inline GetAssignJobsAsyncResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAssignJobsAsyncResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAssignJobsAsyncResultResponseBody> body_ {};
  };
