...
namespace Models
{
  ...
  public:
    ...
    inline const GetBaseStrategyPeriodResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetBaseStrategyPeriodResponseBody) };
    inline GetBaseStrategyPeriodResponseBody body() { DARABONBA_PTR_GET(body_, GetBaseStrategyPeriodResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetBaseStrategyPeriodResponseBody> body_ = nullptr;
  };
