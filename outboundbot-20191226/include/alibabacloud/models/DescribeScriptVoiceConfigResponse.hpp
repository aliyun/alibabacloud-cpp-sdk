...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScriptVoiceConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeScriptVoiceConfigResponseBody) };
    inline DescribeScriptVoiceConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeScriptVoiceConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeScriptVoiceConfigResponseBody> body_ {};
  };
