...
#ifndef ALIBABACLOUD_MODELS_MODIFYJOBGROUPRESPONSEBODYJOBGROUPRECALLSTRATEGY_HPP_
#define ALIBABACLOUD_MODELS_MODIFYJOBGROUPRESPONSEBODYJOBGROUPRECALLSTRATEGY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyJobGroupResponseBodyJobGroupRecallStrategy& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyJobGroupResponseBodyJobGroupRecallStrategy& obj) { 
    ...
    ModifyJobGroupResponseBodyJobGroupRecallStrategy() = default ;
    ModifyJobGroupResponseBodyJobGroupRecallStrategy(const ModifyJobGroupResponseBodyJobGroupRecallStrategy &) = default ;
    ModifyJobGroupResponseBodyJobGroupRecallStrategy(ModifyJobGroupResponseBodyJobGroupRecallStrategy &&) = default ;
    ModifyJobGroupResponseBodyJobGroupRecallStrategy(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyJobGroupResponseBodyJobGroupRecallStrategy() = default ;
    ModifyJobGroupResponseBodyJobGroupRecallStrategy& operator=(const ModifyJobGroupResponseBodyJobGroupRecallStrategy &) = default ;
    ModifyJobGroupResponseBodyJobGroupRecallStrategy& operator=(ModifyJobGroupResponseBodyJobGroupRecallStrategy &&) = default ;
    ...
    inline ModifyJobGroupResponseBodyJobGroupRecallStrategy& setEmptyNumberIgnore(bool emptyNumberIgnore) { DARABONBA_PTR_SET_VALUE(emptyNumberIgnore_, emptyNumberIgnore) };
    ...
    inline ModifyJobGroupResponseBodyJobGroupRecallStrategy& setInArrearsIgnore(bool inArrearsIgnore) { DARABONBA_PTR_SET_VALUE(inArrearsIgnore_, inArrearsIgnore) };
    ...
    inline ModifyJobGroupResponseBodyJobGroupRecallStrategy& setOutOfServiceIgnore(bool outOfServiceIgnore) { DARABONBA_PTR_SET_VALUE(outOfServiceIgnore_, outOfServiceIgnore) };
