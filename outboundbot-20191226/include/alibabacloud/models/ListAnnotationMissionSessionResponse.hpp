...
namespace Models
{
  ...
  public:
    ...
    inline const ListAnnotationMissionSessionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAnnotationMissionSessionResponseBody) };
    inline ListAnnotationMissionSessionResponseBody body() { DARABONBA_PTR_GET(body_, ListAnnotationMissionSessionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAnnotationMissionSessionResponseBody> body_ = nullptr;
  };
