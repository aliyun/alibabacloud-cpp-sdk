...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->scriptWaveforms_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<QueryScriptWaveformsResponseBodyScriptWaveforms> & scriptWaveforms() const { DARABONBA_PTR_GET_CONST(scriptWaveforms_, vector<QueryScriptWaveformsResponseBodyScriptWaveforms>) };
    inline vector<QueryScriptWaveformsResponseBodyScriptWaveforms> scriptWaveforms() { DARABONBA_PTR_GET(scriptWaveforms_, vector<QueryScriptWaveformsResponseBodyScriptWaveforms>) };
    inline QueryScriptWaveformsResponseBody& setScriptWaveforms(const vector<QueryScriptWaveformsResponseBodyScriptWaveforms> & scriptWaveforms) { DARABONBA_PTR_SET_VALUE(scriptWaveforms_, scriptWaveforms) };
    inline QueryScriptWaveformsResponseBody& setScriptWaveforms(vector<QueryScriptWaveformsResponseBodyScriptWaveforms> && scriptWaveforms) { DARABONBA_PTR_SET_RVALUE(scriptWaveforms_, scriptWaveforms) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QueryScriptWaveformsResponseBodyScriptWaveforms>> scriptWaveforms_ = nullptr;
