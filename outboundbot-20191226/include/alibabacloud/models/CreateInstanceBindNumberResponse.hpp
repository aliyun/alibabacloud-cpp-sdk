...
namespace Models
{
  ...
  public:
    ...
    inline const CreateInstanceBindNumberResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateInstanceBindNumberResponseBody) };
    inline CreateInstanceBindNumberResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateInstanceBindNumberResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateInstanceBindNumberResponseBody> body_ {};
  };
