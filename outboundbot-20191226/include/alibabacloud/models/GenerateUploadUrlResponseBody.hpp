...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateUploadUrlResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GenerateUploadUrlResponseBodyData) };
    inline GenerateUploadUrlResponseBodyData data() { DARABONBA_PTR_GET(data_, GenerateUploadUrlResponseBodyData) };
    inline GenerateUploadUrlResponseBody& setData(const GenerateUploadUrlResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GenerateUploadUrlResponseBody& setData(GenerateUploadUrlResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GenerateUploadUrlResponseBodyData> data_ = nullptr;
