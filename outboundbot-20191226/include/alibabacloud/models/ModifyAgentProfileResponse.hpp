...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAgentProfileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyAgentProfileResponseBody) };
    inline ModifyAgentProfileResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyAgentProfileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyAgentProfileResponseBody> body_ {};
  };
