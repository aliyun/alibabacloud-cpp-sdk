...
namespace Models
{
  ...
  public:
    ...
    inline const ListJobGroupsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListJobGroupsResponseBody) };
    inline ListJobGroupsResponseBody body() { DARABONBA_PTR_GET(body_, ListJobGroupsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListJobGroupsResponseBody> body_ = nullptr;
  };
