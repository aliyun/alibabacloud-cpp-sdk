...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListApiPluginsResponseBodyApiPlugins> & apiPlugins() const { DARABONBA_PTR_GET_CONST(apiPlugins_, vector<ListApiPluginsResponseBodyApiPlugins>) };
    inline vector<ListApiPluginsResponseBodyApiPlugins> apiPlugins() { DARABONBA_PTR_GET(apiPlugins_, vector<ListApiPluginsResponseBodyApiPlugins>) };
    inline ListApiPluginsResponseBody& setApiPlugins(const vector<ListApiPluginsResponseBodyApiPlugins> & apiPlugins) { DARABONBA_PTR_SET_VALUE(apiPlugins_, apiPlugins) };
    inline ListApiPluginsResponseBody& setApiPlugins(vector<ListApiPluginsResponseBodyApiPlugins> && apiPlugins) { DARABONBA_PTR_SET_RVALUE(apiPlugins_, apiPlugins) };
  ...
  protected:
    std::shared_ptr<vector<ListApiPluginsResponseBodyApiPlugins>> apiPlugins_ = nullptr;
