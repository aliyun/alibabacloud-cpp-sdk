...
namespace Models
{
  ...
  public:
    ...
    inline const CreateJobGroupResponseBodyJobGroup & jobGroup() const { DARABONBA_PTR_GET_CONST(jobGroup_, CreateJobGroupResponseBodyJobGroup) };
    inline CreateJobGroupResponseBodyJobGroup jobGroup() { DARABONBA_PTR_GET(jobGroup_, CreateJobGroupResponseBodyJobGroup) };
    inline CreateJobGroupResponseBody& setJobGroup(const CreateJobGroupResponseBodyJobGroup & jobGroup) { DARABONBA_PTR_SET_VALUE(jobGroup_, jobGroup) };
    inline CreateJobGroupResponseBody& setJobGroup(CreateJobGroupResponseBodyJobGroup && jobGroup) { DARABONBA_PTR_SET_RVALUE(jobGroup_, jobGroup) };
  ...
  protected:
    ...
    std::shared_ptr<CreateJobGroupResponseBodyJobGroup> jobGroup_ = nullptr;
