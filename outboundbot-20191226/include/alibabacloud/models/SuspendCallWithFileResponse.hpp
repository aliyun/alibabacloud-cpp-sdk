...
namespace Models
{
  ...
  public:
    ...
    inline const SuspendCallWithFileResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SuspendCallWithFileResponseBody) };
    inline SuspendCallWithFileResponseBody getBody() { DARABONBA_PTR_GET(body_, SuspendCallWithFileResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SuspendCallWithFileResponseBody> body_ {};
  };
