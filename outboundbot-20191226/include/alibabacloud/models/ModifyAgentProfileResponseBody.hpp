...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyAgentProfileResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ModifyAgentProfileResponseBodyData) };
    inline ModifyAgentProfileResponseBodyData data() { DARABONBA_PTR_GET(data_, ModifyAgentProfileResponseBodyData) };
    inline ModifyAgentProfileResponseBody& setData(const ModifyAgentProfileResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ModifyAgentProfileResponseBody& setData(ModifyAgentProfileResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyAgentProfileResponseBodyData> data_ = nullptr;
