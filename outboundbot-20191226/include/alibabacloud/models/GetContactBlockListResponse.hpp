...
namespace Models
{
  ...
  public:
    ...
    inline const GetContactBlockListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetContactBlockListResponseBody) };
    inline GetContactBlockListResponseBody body() { DARABONBA_PTR_GET(body_, GetContactBlockListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetContactBlockListResponseBody> body_ = nullptr;
  };
