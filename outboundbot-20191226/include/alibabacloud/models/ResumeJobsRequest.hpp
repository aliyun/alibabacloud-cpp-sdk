...
#ifndef ALIBABACLOUD_MODELS_RESUMEJOBSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_RESUMEJOBSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ResumeJobsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ResumeJobsRequest& obj) { 
    ...
    ResumeJobsRequest() = default ;
    ResumeJobsRequest(const ResumeJobsRequest &) = default ;
    ResumeJobsRequest(ResumeJobsRequest &&) = default ;
    ResumeJobsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ResumeJobsRequest() = default ;
    ResumeJobsRequest& operator=(const ResumeJobsRequest &) = default ;
    ResumeJobsRequest& operator=(ResumeJobsRequest &&) = default ;
    ...
    inline ResumeJobsRequest& setAll(bool all) { DARABONBA_PTR_SET_VALUE(all_, all) };
    ...
    inline ResumeJobsRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ResumeJobsRequest& setJobGroupId(string jobGroupId) { DARABONBA_PTR_SET_VALUE(jobGroupId_, jobGroupId) };
    ...
    inline ResumeJobsRequest& setJobId(const vector<string> & jobId) { DARABONBA_PTR_SET_VALUE(jobId_, jobId) };
    inline ResumeJobsRequest& setJobId(vector<string> && jobId) { DARABONBA_PTR_SET_RVALUE(jobId_, jobId) };
    ...
    inline ResumeJobsRequest& setJobReferenceId(const vector<string> & jobReferenceId) { DARABONBA_PTR_SET_VALUE(jobReferenceId_, jobReferenceId) };
    inline ResumeJobsRequest& setJobReferenceId(vector<string> && jobReferenceId) { DARABONBA_PTR_SET_RVALUE(jobReferenceId_, jobReferenceId) };
    ...
    inline ResumeJobsRequest& setScenarioId(string scenarioId) { DARABONBA_PTR_SET_VALUE(scenarioId_, scenarioId) };
