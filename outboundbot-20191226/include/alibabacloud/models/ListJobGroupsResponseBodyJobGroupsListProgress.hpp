...
#ifndef ALIBABACLOUD_MODELS_LISTJOBGROUPSRESPONSEBODYJOBGROUPSLISTPROGRESS_HPP_
#define ALIBABACLOUD_MODELS_LISTJOBGROUPSRESPONSEBODYJOBGROUPSLISTPROGRESS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListJobGroupsResponseBodyJobGroupsListProgress& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListJobGroupsResponseBodyJobGroupsListProgress& obj) { 
    ...
    ListJobGroupsResponseBodyJobGroupsListProgress() = default ;
    ListJobGroupsResponseBodyJobGroupsListProgress(const ListJobGroupsResponseBodyJobGroupsListProgress &) = default ;
    ListJobGroupsResponseBodyJobGroupsListProgress(ListJobGroupsResponseBodyJobGroupsListProgress &&) = default ;
    ListJobGroupsResponseBodyJobGroupsListProgress(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListJobGroupsResponseBodyJobGroupsListProgress() = default ;
    ListJobGroupsResponseBodyJobGroupsListProgress& operator=(const ListJobGroupsResponseBodyJobGroupsListProgress &) = default ;
    ListJobGroupsResponseBodyJobGroupsListProgress& operator=(ListJobGroupsResponseBodyJobGroupsListProgress &&) = default ;
    ...
    inline ListJobGroupsResponseBodyJobGroupsListProgress& setCancelledNum(int32_t cancelledNum) { DARABONBA_PTR_SET_VALUE(cancelledNum_, cancelledNum) };
    ...
    inline ListJobGroupsResponseBodyJobGroupsListProgress& setDuration(int32_t duration) { DARABONBA_PTR_SET_VALUE(duration_, duration) };
    ...
    inline ListJobGroupsResponseBodyJobGroupsListProgress& setExecutingNum(int32_t executingNum) { DARABONBA_PTR_SET_VALUE(executingNum_, executingNum) };
    ...
    inline ListJobGroupsResponseBodyJobGroupsListProgress& setFailedNum(int32_t failedNum) { DARABONBA_PTR_SET_VALUE(failedNum_, failedNum) };
    ...
    inline ListJobGroupsResponseBodyJobGroupsListProgress& setPausedNum(int32_t pausedNum) { DARABONBA_PTR_SET_VALUE(pausedNum_, pausedNum) };
    ...
    inline ListJobGroupsResponseBodyJobGroupsListProgress& setScheduling(int32_t scheduling) { DARABONBA_PTR_SET_VALUE(scheduling_, scheduling) };
    ...
    inline ListJobGroupsResponseBodyJobGroupsListProgress& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ListJobGroupsResponseBodyJobGroupsListProgress& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListJobGroupsResponseBodyJobGroupsListProgress& setTotalCompleted(int32_t totalCompleted) { DARABONBA_PTR_SET_VALUE(totalCompleted_, totalCompleted) };
    ...
    inline ListJobGroupsResponseBodyJobGroupsListProgress& setTotalJobs(int32_t totalJobs) { DARABONBA_PTR_SET_VALUE(totalJobs_, totalJobs) };
    ...
    inline ListJobGroupsResponseBodyJobGroupsListProgress& setTotalNotAnswered(int32_t totalNotAnswered) { DARABONBA_PTR_SET_VALUE(totalNotAnswered_, totalNotAnswered) };
