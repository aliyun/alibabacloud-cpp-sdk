  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->debugStatus_ == nullptr
        && this->industry_ == nullptr && this->isDebugDrafted_ == nullptr && this->isDrafted_ == nullptr && this->nluAccessType_ == nullptr && this->nluEngine_ == nullptr
      ...
      inline Script& setNluAccessType(string nluAccessType) { DARABONBA_PTR_SET_VALUE(nluAccessType_, nluAccessType) };
    ...
    inline const CreateScriptResponseBody::Script & getScript() const { DARABONBA_PTR_GET_CONST(script_, CreateScriptResponseBody::Script) };
    inline CreateScriptResponseBody::Script getScript() { DARABONBA_PTR_GET(script_, CreateScriptResponseBody::Script) };
    inline CreateScriptResponseBody& setScript(const CreateScriptResponseBody::Script & script) { DARABONBA_PTR_SET_VALUE(script_, script) };
    inline CreateScriptResponseBody& setScript(CreateScriptResponseBody::Script && script) { DARABONBA_PTR_SET_RVALUE(script_, script) };
