...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->intent_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const DescribeIntentResponseBodyIntent & intent() const { DARABONBA_PTR_GET_CONST(intent_, DescribeIntentResponseBodyIntent) };
    inline DescribeIntentResponseBodyIntent intent() { DARABONBA_PTR_GET(intent_, DescribeIntentResponseBodyIntent) };
    inline DescribeIntentResponseBody& setIntent(const DescribeIntentResponseBodyIntent & intent) { DARABONBA_PTR_SET_VALUE(intent_, intent) };
    inline DescribeIntentResponseBody& setIntent(DescribeIntentResponseBodyIntent && intent) { DARABONBA_PTR_SET_RVALUE(intent_, intent) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeIntentResponseBodyIntent> intent_ = nullptr;
