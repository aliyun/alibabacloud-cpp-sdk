...
namespace Models
{
  ...
  public:
    ...
    inline const SaveAnnotationMissionSessionListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, SaveAnnotationMissionSessionListResponseBodyData) };
    inline SaveAnnotationMissionSessionListResponseBodyData data() { DARABONBA_PTR_GET(data_, SaveAnnotationMissionSessionListResponseBodyData) };
    inline SaveAnnotationMissionSessionListResponseBody& setData(const SaveAnnotationMissionSessionListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline SaveAnnotationMissionSessionListResponseBody& setData(SaveAnnotationMissionSessionListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<SaveAnnotationMissionSessionListResponseBodyData> data_ = nullptr;
