...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->scriptVoiceConfig_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const DescribeScriptVoiceConfigResponseBodyScriptVoiceConfig & scriptVoiceConfig() const { DARABONBA_PTR_GET_CONST(scriptVoiceConfig_, DescribeScriptVoiceConfigResponseBodyScriptVoiceConfig) };
    inline DescribeScriptVoiceConfigResponseBodyScriptVoiceConfig scriptVoiceConfig() { DARABONBA_PTR_GET(scriptVoiceConfig_, DescribeScriptVoiceConfigResponseBodyScriptVoiceConfig) };
    inline DescribeScriptVoiceConfigResponseBody& setScriptVoiceConfig(const DescribeScriptVoiceConfigResponseBodyScriptVoiceConfig & scriptVoiceConfig) { DARABONBA_PTR_SET_VALUE(scriptVoiceConfig_, scriptVoiceConfig) };
    inline DescribeScriptVoiceConfigResponseBody& setScriptVoiceConfig(DescribeScriptVoiceConfigResponseBodyScriptVoiceConfig && scriptVoiceConfig) { DARABONBA_PTR_SET_RVALUE(scriptVoiceConfig_, scriptVoiceConfig) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeScriptVoiceConfigResponseBodyScriptVoiceConfig> scriptVoiceConfig_ = nullptr;
