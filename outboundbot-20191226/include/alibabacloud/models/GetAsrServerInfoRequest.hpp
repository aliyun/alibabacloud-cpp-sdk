...
#ifndef ALIBABACLOUD_MODELS_GETASRSERVERINFOREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETASRSERVERINFOREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAsrServerInfoRequest& obj) { 
      DARABONBA_PTR_TO_JSON(EntryId, entryId_);
      DARABONBA_PTR_TO_JSON(StrategyLevel, strategyLevel_);
    };
    friend void from_json(const Darabonba::Json& j, GetAsrServerInfoRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(EntryId, entryId_);
      DARABONBA_PTR_FROM_JSON(StrategyLevel, strategyLevel_);
    };
    GetAsrServerInfoRequest() = default ;
    GetAsrServerInfoRequest(const GetAsrServerInfoRequest &) = default ;
    GetAsrServerInfoRequest(GetAsrServerInfoRequest &&) = default ;
    GetAsrServerInfoRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAsrServerInfoRequest() = default ;
    GetAsrServerInfoRequest& operator=(const GetAsrServerInfoRequest &) = default ;
    GetAsrServerInfoRequest& operator=(GetAsrServerInfoRequest &&) = default ;
    ...
    inline GetAsrServerInfoRequest& setEntryId(string entryId) { DARABONBA_PTR_SET_VALUE(entryId_, entryId) };
    ...
    inline GetAsrServerInfoRequest& setStrategyLevel(int32_t strategyLevel) { DARABONBA_PTR_SET_VALUE(strategyLevel_, strategyLevel) };
