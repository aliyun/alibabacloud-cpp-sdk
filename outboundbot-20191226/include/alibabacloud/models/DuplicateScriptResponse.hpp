...
namespace Models
{
  ...
  public:
    ...
    inline const DuplicateScriptResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DuplicateScriptResponseBody) };
    inline DuplicateScriptResponseBody getBody() { DARABONBA_PTR_GET(body_, DuplicateScriptResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DuplicateScriptResponseBody> body_ {};
  };
