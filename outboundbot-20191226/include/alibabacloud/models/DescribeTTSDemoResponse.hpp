...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTTSDemoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTTSDemoResponseBody) };
    inline DescribeTTSDemoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTTSDemoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTTSDemoResponseBody> body_ {};
  };
