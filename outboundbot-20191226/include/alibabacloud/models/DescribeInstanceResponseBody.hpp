...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceResponseBodyInstance & instance() const { DARABONBA_PTR_GET_CONST(instance_, DescribeInstanceResponseBodyInstance) };
    inline DescribeInstanceResponseBodyInstance instance() { DARABONBA_PTR_GET(instance_, DescribeInstanceResponseBodyInstance) };
    inline DescribeInstanceResponseBody& setInstance(const DescribeInstanceResponseBodyInstance & instance) { DARABONBA_PTR_SET_VALUE(instance_, instance) };
    inline DescribeInstanceResponseBody& setInstance(DescribeInstanceResponseBodyInstance && instance) { DARABONBA_PTR_SET_RVALUE(instance_, instance) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeInstanceResponseBodyInstance> instance_ = nullptr;
