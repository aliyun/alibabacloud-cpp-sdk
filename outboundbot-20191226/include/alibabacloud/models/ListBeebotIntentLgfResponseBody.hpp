...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->beebotRequestId_ == nullptr
        && return this->code_ == nullptr && return this->httpStatusCode_ == nullptr && return this->lgfs_ == nullptr && return this->message_ == nullptr && return this->pageNumber_ == nullptr
    ...
    inline const vector<ListBeebotIntentLgfResponseBodyLgfs> & lgfs() const { DARABONBA_PTR_GET_CONST(lgfs_, vector<ListBeebotIntentLgfResponseBodyLgfs>) };
    inline vector<ListBeebotIntentLgfResponseBodyLgfs> lgfs() { DARABONBA_PTR_GET(lgfs_, vector<ListBeebotIntentLgfResponseBodyLgfs>) };
    inline ListBeebotIntentLgfResponseBody& setLgfs(const vector<ListBeebotIntentLgfResponseBodyLgfs> & lgfs) { DARABONBA_PTR_SET_VALUE(lgfs_, lgfs) };
    inline ListBeebotIntentLgfResponseBody& setLgfs(vector<ListBeebotIntentLgfResponseBodyLgfs> && lgfs) { DARABONBA_PTR_SET_RVALUE(lgfs_, lgfs) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListBeebotIntentLgfResponseBodyLgfs>> lgfs_ = nullptr;
