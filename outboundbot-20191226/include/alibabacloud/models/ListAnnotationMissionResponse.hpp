...
namespace Models
{
  ...
  public:
    ...
    inline const ListAnnotationMissionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAnnotationMissionResponseBody) };
    inline ListAnnotationMissionResponseBody body() { DARABONBA_PTR_GET(body_, ListAnnotationMissionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAnnotationMissionResponseBody> body_ = nullptr;
  };
