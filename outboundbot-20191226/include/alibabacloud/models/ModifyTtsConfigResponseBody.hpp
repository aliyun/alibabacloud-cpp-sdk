...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyTTSConfigResponseBodyTTSConfig & TTSConfig() const { DARABONBA_PTR_GET_CONST(TTSConfig_, ModifyTTSConfigResponseBodyTTSConfig) };
    inline ModifyTTSConfigResponseBodyTTSConfig TTSConfig() { DARABONBA_PTR_GET(TTSConfig_, ModifyTTSConfigResponseBodyTTSConfig) };
    inline ModifyTTSConfigResponseBody& setTTSConfig(const ModifyTTSConfigResponseBodyTTSConfig & TTSConfig) { DARABONBA_PTR_SET_VALUE(TTSConfig_, TTSConfig) };
    inline ModifyTTSConfigResponseBody& setTTSConfig(ModifyTTSConfigResponseBodyTTSConfig && TTSConfig) { DARABONBA_PTR_SET_RVALUE(TTSConfig_, TTSConfig) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyTTSConfigResponseBodyTTSConfig> TTSConfig_ = nullptr;
  };
