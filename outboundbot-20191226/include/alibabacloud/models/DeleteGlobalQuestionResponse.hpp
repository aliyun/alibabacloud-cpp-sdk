...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGlobalQuestionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteGlobalQuestionResponseBody) };
    inline DeleteGlobalQuestionResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteGlobalQuestionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteGlobalQuestionResponseBody> body_ {};
  };
