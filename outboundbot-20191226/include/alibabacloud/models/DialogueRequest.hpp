...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actionKey_ == nullptr
        && return this->actionParams_ == nullptr && return this->callId_ == nullptr && return this->callType_ == nullptr && return this->calledNumber_ == nullptr && return this->callingNumber_ == nullptr
        && return this->instanceId_ == nullptr && return this->scenarioId_ == nullptr && return this->scriptId_ == nullptr && return this->taskId_ == nullptr && return this->utterance_ == nullptr; };
