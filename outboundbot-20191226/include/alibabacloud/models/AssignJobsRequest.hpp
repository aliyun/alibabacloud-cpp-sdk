...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->callingNumber_ == nullptr
        && return this->instanceId_ == nullptr && return this->isAsynchrony_ == nullptr && return this->jobDataParsingTaskId_ == nullptr && return this->jobGroupId_ == nullptr && return this->jobsJson_ == nullptr
        && return this->rosterType_ == nullptr && return this->strategyJson_ == nullptr; };
    ...
    inline bool isAsynchrony() const { DARABONBA_PTR_GET_DEFAULT(isAsynchrony_, false) };
    ...
    inline string rosterType() const { DARABONBA_PTR_GET_DEFAULT(rosterType_, "") };
  ...
  protected:
    ...
    std::shared_ptr<bool> isAsynchrony_ = nullptr;
    ...
    std::shared_ptr<string> rosterType_ = nullptr;
