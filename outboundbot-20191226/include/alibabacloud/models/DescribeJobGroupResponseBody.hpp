...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeJobGroupResponseBodyJobGroup & jobGroup() const { DARABONBA_PTR_GET_CONST(jobGroup_, DescribeJobGroupResponseBodyJobGroup) };
    inline DescribeJobGroupResponseBodyJobGroup jobGroup() { DARABONBA_PTR_GET(jobGroup_, DescribeJobGroupResponseBodyJobGroup) };
    inline DescribeJobGroupResponseBody& setJobGroup(const DescribeJobGroupResponseBodyJobGroup & jobGroup) { DARABONBA_PTR_SET_VALUE(jobGroup_, jobGroup) };
    inline DescribeJobGroupResponseBody& setJobGroup(DescribeJobGroupResponseBodyJobGroup && jobGroup) { DARABONBA_PTR_SET_RVALUE(jobGroup_, jobGroup) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeJobGroupResponseBodyJobGroup> jobGroup_ = nullptr;
