...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->beebotRequestId_ == nullptr
        && return this->code_ == nullptr && return this->httpStatusCode_ == nullptr && return this->intent_ == nullptr && return this->intentId_ == nullptr && return this->message_ == nullptr
    ...
    inline const DescribeBeebotIntentResponseBodyIntent & intent() const { DARABONBA_PTR_GET_CONST(intent_, DescribeBeebotIntentResponseBodyIntent) };
    inline DescribeBeebotIntentResponseBodyIntent intent() { DARABONBA_PTR_GET(intent_, DescribeBeebotIntentResponseBodyIntent) };
    inline DescribeBeebotIntentResponseBody& setIntent(const DescribeBeebotIntentResponseBodyIntent & intent) { DARABONBA_PTR_SET_VALUE(intent_, intent) };
    inline DescribeBeebotIntentResponseBody& setIntent(DescribeBeebotIntentResponseBodyIntent && intent) { DARABONBA_PTR_SET_RVALUE(intent_, intent) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeBeebotIntentResponseBodyIntent> intent_ = nullptr;
