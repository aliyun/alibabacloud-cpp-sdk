...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBeebotIntentResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateBeebotIntentResponseBody) };
    inline CreateBeebotIntentResponseBody body() { DARABONBA_PTR_GET(body_, CreateBeebotIntentResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateBeebotIntentResponseBody> body_ = nullptr;
  };
