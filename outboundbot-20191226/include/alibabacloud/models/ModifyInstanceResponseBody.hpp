  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->creationTime_ == nullptr
        ...
        && this->maxConcurrentConversation_ == nullptr && this->ownerName_ == nullptr; };
    ...
    inline const ModifyInstanceResponseBody::Instance & getInstance() const { DARABONBA_PTR_GET_CONST(instance_, ModifyInstanceResponseBody::Instance) };
    inline ModifyInstanceResponseBody::Instance getInstance() { DARABONBA_PTR_GET(instance_, ModifyInstanceResponseBody::Instance) };
    inline ModifyInstanceResponseBody& setInstance(const ModifyInstanceResponseBody::Instance & instance) { DARABONBA_PTR_SET_VALUE(instance_, instance) };
    inline ModifyInstanceResponseBody& setInstance(ModifyInstanceResponseBody::Instance && instance) { DARABONBA_PTR_SET_RVALUE(instance_, instance) };
