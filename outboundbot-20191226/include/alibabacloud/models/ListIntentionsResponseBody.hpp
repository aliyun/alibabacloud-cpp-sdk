...
namespace Models
{
  ...
  public:
    ...
    inline const ListIntentionsResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ListIntentionsResponseBodyData) };
    inline ListIntentionsResponseBodyData data() { DARABONBA_PTR_GET(data_, ListIntentionsResponseBodyData) };
    inline ListIntentionsResponseBody& setData(const ListIntentionsResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListIntentionsResponseBody& setData(ListIntentionsResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ListIntentionsResponseBodyData> data_ = nullptr;
