...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->task_ == nullptr; };
    ...
    inline const GetTaskByUuidResponseBodyTask & task() const { DARABONBA_PTR_GET_CONST(task_, GetTaskByUuidResponseBodyTask) };
    inline GetTaskByUuidResponseBodyTask task() { DARABONBA_PTR_GET(task_, GetTaskByUuidResponseBodyTask) };
    inline GetTaskByUuidResponseBody& setTask(const GetTaskByUuidResponseBodyTask & task) { DARABONBA_PTR_SET_VALUE(task_, task) };
    inline GetTaskByUuidResponseBody& setTask(GetTaskByUuidResponseBodyTask && task) { DARABONBA_PTR_SET_RVALUE(task_, task) };
  ...
  protected:
    ...
    std::shared_ptr<GetTaskByUuidResponseBodyTask> task_ = nullptr;
  };
