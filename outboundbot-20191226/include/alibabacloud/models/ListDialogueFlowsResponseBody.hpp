...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->dialogueFlows_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const vector<ListDialogueFlowsResponseBodyDialogueFlows> & dialogueFlows() const { DARABONBA_PTR_GET_CONST(dialogueFlows_, vector<ListDialogueFlowsResponseBodyDialogueFlows>) };
    inline vector<ListDialogueFlowsResponseBodyDialogueFlows> dialogueFlows() { DARABONBA_PTR_GET(dialogueFlows_, vector<ListDialogueFlowsResponseBodyDialogueFlows>) };
    inline ListDialogueFlowsResponseBody& setDialogueFlows(const vector<ListDialogueFlowsResponseBodyDialogueFlows> & dialogueFlows) { DARABONBA_PTR_SET_VALUE(dialogueFlows_, dialogueFlows) };
    inline ListDialogueFlowsResponseBody& setDialogueFlows(vector<ListDialogueFlowsResponseBodyDialogueFlows> && dialogueFlows) { DARABONBA_PTR_SET_RVALUE(dialogueFlows_, dialogueFlows) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDialogueFlowsResponseBodyDialogueFlows>> dialogueFlows_ = nullptr;
