...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyGlobalQuestionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyGlobalQuestionResponseBody) };
    inline ModifyGlobalQuestionResponseBody body() { DARABONBA_PTR_GET(body_, ModifyGlobalQuestionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyGlobalQuestionResponseBody> body_ = nullptr;
  };
