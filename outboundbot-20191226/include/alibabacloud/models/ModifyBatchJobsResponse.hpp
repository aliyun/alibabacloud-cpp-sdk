...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBatchJobsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ModifyBatchJobsResponseBody) };
    inline ModifyBatchJobsResponseBody body() { DARABONBA_PTR_GET(body_, ModifyBatchJobsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ModifyBatchJobsResponseBody> body_ = nullptr;
  };
