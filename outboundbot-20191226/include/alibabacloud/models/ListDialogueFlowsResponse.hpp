...
namespace Models
{
  ...
  public:
    ...
    inline const ListDialogueFlowsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDialogueFlowsResponseBody) };
    inline ListDialogueFlowsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDialogueFlowsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDialogueFlowsResponseBody> body_ {};
  };
