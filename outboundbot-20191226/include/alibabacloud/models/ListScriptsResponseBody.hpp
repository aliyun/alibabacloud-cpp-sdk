...
namespace Models
{
  ...
  public:
    ...
    inline const ListScriptsResponseBodyScripts & scripts() const { DARABONBA_PTR_GET_CONST(scripts_, ListScriptsResponseBodyScripts) };
    inline ListScriptsResponseBodyScripts scripts() { DARABONBA_PTR_GET(scripts_, ListScriptsResponseBodyScripts) };
    inline ListScriptsResponseBody& setScripts(const ListScriptsResponseBodyScripts & scripts) { DARABONBA_PTR_SET_VALUE(scripts_, scripts) };
    inline ListScriptsResponseBody& setScripts(ListScriptsResponseBodyScripts && scripts) { DARABONBA_PTR_SET_RVALUE(scripts_, scripts) };
  ...
  protected:
    ...
    std::shared_ptr<ListScriptsResponseBodyScripts> scripts_ = nullptr;
