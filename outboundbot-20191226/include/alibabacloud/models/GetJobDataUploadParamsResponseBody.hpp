...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->uploadParams_ == nullptr; };
    ...
    inline const GetJobDataUploadParamsResponseBodyUploadParams & uploadParams() const { DARABONBA_PTR_GET_CONST(uploadParams_, GetJobDataUploadParamsResponseBodyUploadParams) };
    inline GetJobDataUploadParamsResponseBodyUploadParams uploadParams() { DARABONBA_PTR_GET(uploadParams_, GetJobDataUploadParamsResponseBodyUploadParams) };
    inline GetJobDataUploadParamsResponseBody& setUploadParams(const GetJobDataUploadParamsResponseBodyUploadParams & uploadParams) { DARABONBA_PTR_SET_VALUE(uploadParams_, uploadParams) };
    inline GetJobDataUploadParamsResponseBody& setUploadParams(GetJobDataUploadParamsResponseBodyUploadParams && uploadParams) { DARABONBA_PTR_SET_RVALUE(uploadParams_, uploadParams) };
  ...
  protected:
    ...
    std::shared_ptr<GetJobDataUploadParamsResponseBodyUploadParams> uploadParams_ = nullptr;
  };
