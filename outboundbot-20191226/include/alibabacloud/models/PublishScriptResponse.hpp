...
namespace Models
{
  ...
  public:
    ...
    inline const PublishScriptResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PublishScriptResponseBody) };
    inline PublishScriptResponseBody getBody() { DARABONBA_PTR_GET(body_, PublishScriptResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PublishScriptResponseBody> body_ {};
  };
