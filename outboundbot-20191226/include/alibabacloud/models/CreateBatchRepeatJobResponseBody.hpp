...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBatchRepeatJobResponseBodyJobGroup & jobGroup() const { DARABONBA_PTR_GET_CONST(jobGroup_, CreateBatchRepeatJobResponseBodyJobGroup) };
    inline CreateBatchRepeatJobResponseBodyJobGroup jobGroup() { DARABONBA_PTR_GET(jobGroup_, CreateBatchRepeatJobResponseBodyJobGroup) };
    inline CreateBatchRepeatJobResponseBody& setJobGroup(const CreateBatchRepeatJobResponseBodyJobGroup & jobGroup) { DARABONBA_PTR_SET_VALUE(jobGroup_, jobGroup) };
    inline CreateBatchRepeatJobResponseBody& setJobGroup(CreateBatchRepeatJobResponseBodyJobGroup && jobGroup) { DARABONBA_PTR_SET_RVALUE(jobGroup_, jobGroup) };
  ...
  protected:
    ...
    std::shared_ptr<CreateBatchRepeatJobResponseBodyJobGroup> jobGroup_ = nullptr;
