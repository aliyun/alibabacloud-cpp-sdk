...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline DownloadParams& setVoiceSliceRecordingListJson(string voiceSliceRecordingListJson) { DARABONBA_PTR_SET_VALUE(voiceSliceRecordingListJson_, voiceSliceRecordingListJson) };
    ...
    inline const DownloadRecordingResponseBody::DownloadParams & getDownloadParams() const { DARABONBA_PTR_GET_CONST(downloadParams_, DownloadRecordingResponseBody::DownloadParams) };
    inline DownloadRecordingResponseBody::DownloadParams getDownloadParams() { DARABONBA_PTR_GET(downloadParams_, DownloadRecordingResponseBody::DownloadParams) };
    inline DownloadRecordingResponseBody& setDownloadParams(const DownloadRecordingResponseBody::DownloadParams & downloadParams) { DARABONBA_PTR_SET_VALUE(downloadParams_, downloadParams) };
    inline DownloadRecordingResponseBody& setDownloadParams(DownloadRecordingResponseBody::DownloadParams && downloadParams) { DARABONBA_PTR_SET_RVALUE(downloadParams_, downloadParams) };
