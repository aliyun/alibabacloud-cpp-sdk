...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->globalQuestion_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const DescribeGlobalQuestionResponseBodyGlobalQuestion & globalQuestion() const { DARABONBA_PTR_GET_CONST(globalQuestion_, DescribeGlobalQuestionResponseBodyGlobalQuestion) };
    inline DescribeGlobalQuestionResponseBodyGlobalQuestion globalQuestion() { DARABONBA_PTR_GET(globalQuestion_, DescribeGlobalQuestionResponseBodyGlobalQuestion) };
    inline DescribeGlobalQuestionResponseBody& setGlobalQuestion(const DescribeGlobalQuestionResponseBodyGlobalQuestion & globalQuestion) { DARABONBA_PTR_SET_VALUE(globalQuestion_, globalQuestion) };
    inline DescribeGlobalQuestionResponseBody& setGlobalQuestion(DescribeGlobalQuestionResponseBodyGlobalQuestion && globalQuestion) { DARABONBA_PTR_SET_RVALUE(globalQuestion_, globalQuestion) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeGlobalQuestionResponseBodyGlobalQuestion> globalQuestion_ = nullptr;
