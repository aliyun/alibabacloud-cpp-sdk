...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->instanceId_ == nullptr
        && this->scriptId_ == nullptr && this->userSayDefinition_ == nullptr && this->userSayId_ == nullptr; };
    ...
    inline const ModifyBeebotIntentUserSayRequest::UserSayDefinition & getUserSayDefinition() const { DARABONBA_PTR_GET_CONST(userSayDefinition_, ModifyBeebotIntentUserSayRequest::UserSayDefinition) };
    inline ModifyBeebotIntentUserSayRequest::UserSayDefinition getUserSayDefinition() { DARABONBA_PTR_GET(userSayDefinition_, ModifyBeebotIntentUserSayRequest::UserSayDefinition) };
    inline ModifyBeebotIntentUserSayRequest& setUserSayDefinition(const ModifyBeebotIntentUserSayRequest::UserSayDefinition & userSayDefinition) { DARABONBA_PTR_SET_VALUE(userSayDefinition_, userSayDefinition) };
    inline ModifyBeebotIntentUserSayRequest& setUserSayDefinition(ModifyBeebotIntentUserSayRequest::UserSayDefinition && userSayDefinition) { DARABONBA_PTR_SET_RVALUE(userSayDefinition_, userSayDefinition) };
