...
#ifndef ALIBABACLOUD_MODELS_CREATEANNOTATIONMISSIONSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEANNOTATIONMISSIONSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateAnnotationMissionShrinkRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AgentId, agentId_);
      DARABONBA_PTR_TO_JSON(AgentKey, agentKey_);
      DARABONBA_PTR_TO_JSON(AnnotationMissionDataSourceType, annotationMissionDataSourceType_);
      DARABONBA_PTR_TO_JSON(AnnotationMissionDebugDataSourceList, annotationMissionDebugDataSourceListShrink_);
    ...
    friend void from_json(const Darabonba::Json& j, CreateAnnotationMissionShrinkRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AgentId, agentId_);
      DARABONBA_PTR_FROM_JSON(AgentKey, agentKey_);
      DARABONBA_PTR_FROM_JSON(AnnotationMissionDataSourceType, annotationMissionDataSourceType_);
      DARABONBA_PTR_FROM_JSON(AnnotationMissionDebugDataSourceList, annotationMissionDebugDataSourceListShrink_);
    ...
    CreateAnnotationMissionShrinkRequest() = default ;
    CreateAnnotationMissionShrinkRequest(const CreateAnnotationMissionShrinkRequest &) = default ;
    CreateAnnotationMissionShrinkRequest(CreateAnnotationMissionShrinkRequest &&) = default ;
    CreateAnnotationMissionShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateAnnotationMissionShrinkRequest() = default ;
    CreateAnnotationMissionShrinkRequest& operator=(const CreateAnnotationMissionShrinkRequest &) = default ;
    CreateAnnotationMissionShrinkRequest& operator=(CreateAnnotationMissionShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->agentId_ == nullptr
        && return this->agentKey_ == nullptr && return this->annotationMissionDataSourceType_ == nullptr && return this->annotationMissionDebugDataSourceListShrink_ == nullptr && return this->annotationMissionDebugDataSourceListJsonString_ == nullptr && return this->annotationMissionName_ == nullptr
    ...
    inline CreateAnnotationMissionShrinkRequest& setAgentId(string agentId) { DARABONBA_PTR_SET_VALUE(agentId_, agentId) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setAgentKey(string agentKey) { DARABONBA_PTR_SET_VALUE(agentKey_, agentKey) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setAnnotationMissionDataSourceType(int32_t annotationMissionDataSourceType) { DARABONBA_PTR_SET_VALUE(annotationMissionDataSourceType_, annotationMissionDataSourceType) };


    // annotationMissionDebugDataSourceListShrink Field Functions 
    bool hasAnnotationMissionDebugDataSourceListShrink() const { return this->annotationMissionDebugDataSourceListShrink_ != nullptr;};
    void deleteAnnotationMissionDebugDataSourceListShrink() { this->annotationMissionDebugDataSourceListShrink_ = nullptr;};
    inline string annotationMissionDebugDataSourceListShrink() const { DARABONBA_PTR_GET_DEFAULT(annotationMissionDebugDataSourceListShrink_, "") };
    inline CreateAnnotationMissionShrinkRequest& setAnnotationMissionDebugDataSourceListShrink(string annotationMissionDebugDataSourceListShrink) { DARABONBA_PTR_SET_VALUE(annotationMissionDebugDataSourceListShrink_, annotationMissionDebugDataSourceListShrink) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setAnnotationMissionDebugDataSourceListJsonString(string annotationMissionDebugDataSourceListJsonString) { DARABONBA_PTR_SET_VALUE(annotationMissionDebugDataSourceListJsonString_, annotationMissionDebugDataSourceListJsonString) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setAnnotationMissionName(string annotationMissionName) { DARABONBA_PTR_SET_VALUE(annotationMissionName_, annotationMissionName) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setChatbotId(string chatbotId) { DARABONBA_PTR_SET_VALUE(chatbotId_, chatbotId) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setConversationTimeEndFilter(int64_t conversationTimeEndFilter) { DARABONBA_PTR_SET_VALUE(conversationTimeEndFilter_, conversationTimeEndFilter) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setConversationTimeStartFilter(int64_t conversationTimeStartFilter) { DARABONBA_PTR_SET_VALUE(conversationTimeStartFilter_, conversationTimeStartFilter) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setExcludeOtherSession(bool excludeOtherSession) { DARABONBA_PTR_SET_VALUE(excludeOtherSession_, excludeOtherSession) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setFinished(bool finished) { DARABONBA_PTR_SET_VALUE(finished_, finished) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setSamplingCount(int32_t samplingCount) { DARABONBA_PTR_SET_VALUE(samplingCount_, samplingCount) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setSamplingRate(int32_t samplingRate) { DARABONBA_PTR_SET_VALUE(samplingRate_, samplingRate) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setSamplingType(int32_t samplingType) { DARABONBA_PTR_SET_VALUE(samplingType_, samplingType) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setScriptId(string scriptId) { DARABONBA_PTR_SET_VALUE(scriptId_, scriptId) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setSessionEndReasonFilterList(const vector<int32_t> & sessionEndReasonFilterList) { DARABONBA_PTR_SET_VALUE(sessionEndReasonFilterList_, sessionEndReasonFilterList) };
    inline CreateAnnotationMissionShrinkRequest& setSessionEndReasonFilterList(vector<int32_t> && sessionEndReasonFilterList) { DARABONBA_PTR_SET_RVALUE(sessionEndReasonFilterList_, sessionEndReasonFilterList) };
    ...
    inline CreateAnnotationMissionShrinkRequest& setSessionEndReasonFilterListJsonString(string sessionEndReasonFilterListJsonString) { DARABONBA_PTR_SET_VALUE(sessionEndReasonFilterListJsonString_, sessionEndReasonFilterListJsonString) };
  ...
  protected:
    ...
    std::shared_ptr<string> annotationMissionDebugDataSourceListShrink_ = nullptr;
