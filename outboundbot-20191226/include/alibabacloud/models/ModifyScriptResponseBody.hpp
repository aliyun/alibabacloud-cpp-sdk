...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyScriptResponseBody::Script & getScript() const { DARABONBA_PTR_GET_CONST(script_, ModifyScriptResponseBody::Script) };
    inline ModifyScriptResponseBody::Script getScript() { DARABONBA_PTR_GET(script_, ModifyScriptResponseBody::Script) };
    inline ModifyScriptResponseBody& setScript(const ModifyScriptResponseBody::Script & script) { DARABONBA_PTR_SET_VALUE(script_, script) };
    inline ModifyScriptResponseBody& setScript(ModifyScriptResponseBody::Script && script) { DARABONBA_PTR_SET_RVALUE(script_, script) };
