...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->outboundCallNumbers_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const ListOutboundCallNumbersResponseBodyOutboundCallNumbers & outboundCallNumbers() const { DARABONBA_PTR_GET_CONST(outboundCallNumbers_, ListOutboundCallNumbersResponseBodyOutboundCallNumbers) };
    inline ListOutboundCallNumbersResponseBodyOutboundCallNumbers outboundCallNumbers() { DARABONBA_PTR_GET(outboundCallNumbers_, ListOutboundCallNumbersResponseBodyOutboundCallNumbers) };
    inline ListOutboundCallNumbersResponseBody& setOutboundCallNumbers(const ListOutboundCallNumbersResponseBodyOutboundCallNumbers & outboundCallNumbers) { DARABONBA_PTR_SET_VALUE(outboundCallNumbers_, outboundCallNumbers) };
    inline ListOutboundCallNumbersResponseBody& setOutboundCallNumbers(ListOutboundCallNumbersResponseBodyOutboundCallNumbers && outboundCallNumbers) { DARABONBA_PTR_SET_RVALUE(outboundCallNumbers_, outboundCallNumbers) };
  ...
  protected:
    ...
    std::shared_ptr<ListOutboundCallNumbersResponseBodyOutboundCallNumbers> outboundCallNumbers_ = nullptr;
