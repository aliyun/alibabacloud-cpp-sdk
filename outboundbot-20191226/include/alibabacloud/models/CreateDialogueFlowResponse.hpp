...
namespace Models
{
  ...
  public:
    ...
    inline const CreateDialogueFlowResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateDialogueFlowResponseBody) };
    inline CreateDialogueFlowResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateDialogueFlowResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateDialogueFlowResponseBody> body_ {};
  };
