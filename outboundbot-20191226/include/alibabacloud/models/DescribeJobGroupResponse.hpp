...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeJobGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeJobGroupResponseBody) };
    inline DescribeJobGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeJobGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeJobGroupResponseBody> body_ {};
  };
