...
namespace Models
{
  ...
  public:
    ...
    inline const GetRealtimeConcurrencyReportResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRealtimeConcurrencyReportResponseBody) };
    inline GetRealtimeConcurrencyReportResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRealtimeConcurrencyReportResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRealtimeConcurrencyReportResponseBody> body_ {};
  };
