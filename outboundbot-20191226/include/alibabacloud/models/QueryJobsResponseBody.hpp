...
namespace Models
{
  ...
  public:
    ...
    inline const QueryJobsResponseBodyJobs & jobs() const { DARABONBA_PTR_GET_CONST(jobs_, QueryJobsResponseBodyJobs) };
    inline QueryJobsResponseBodyJobs jobs() { DARABONBA_PTR_GET(jobs_, QueryJobsResponseBodyJobs) };
    inline QueryJobsResponseBody& setJobs(const QueryJobsResponseBodyJobs & jobs) { DARABONBA_PTR_SET_VALUE(jobs_, jobs) };
    inline QueryJobsResponseBody& setJobs(QueryJobsResponseBodyJobs && jobs) { DARABONBA_PTR_SET_RVALUE(jobs_, jobs) };
  ...
  protected:
    ...
    std::shared_ptr<QueryJobsResponseBodyJobs> jobs_ = nullptr;
