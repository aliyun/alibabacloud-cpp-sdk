...
namespace Models
{
  ...
  public:
    ...
    inline const GetAgentProfileTemplateResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetAgentProfileTemplateResponseBodyData) };
    inline GetAgentProfileTemplateResponseBodyData data() { DARABONBA_PTR_GET(data_, GetAgentProfileTemplateResponseBodyData) };
    inline GetAgentProfileTemplateResponseBody& setData(const GetAgentProfileTemplateResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAgentProfileTemplateResponseBody& setData(GetAgentProfileTemplateResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetAgentProfileTemplateResponseBodyData> data_ = nullptr;
