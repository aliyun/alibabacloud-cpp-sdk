...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->scripts_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const QueryScriptsByStatusResponseBodyScripts & scripts() const { DARABONBA_PTR_GET_CONST(scripts_, QueryScriptsByStatusResponseBodyScripts) };
    inline QueryScriptsByStatusResponseBodyScripts scripts() { DARABONBA_PTR_GET(scripts_, QueryScriptsByStatusResponseBodyScripts) };
    inline QueryScriptsByStatusResponseBody& setScripts(const QueryScriptsByStatusResponseBodyScripts & scripts) { DARABONBA_PTR_SET_VALUE(scripts_, scripts) };
    inline QueryScriptsByStatusResponseBody& setScripts(QueryScriptsByStatusResponseBodyScripts && scripts) { DARABONBA_PTR_SET_RVALUE(scripts_, scripts) };
  ...
  protected:
    ...
    std::shared_ptr<QueryScriptsByStatusResponseBodyScripts> scripts_ = nullptr;
