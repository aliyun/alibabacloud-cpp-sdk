...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteJobGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteJobGroupResponseBody) };
    inline DeleteJobGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteJobGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteJobGroupResponseBody> body_ {};
  };
