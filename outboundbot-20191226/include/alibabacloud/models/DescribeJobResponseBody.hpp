...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->httpStatusCode_ == nullptr && return this->job_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const DescribeJobResponseBodyJob & job() const { DARABONBA_PTR_GET_CONST(job_, DescribeJobResponseBodyJob) };
    inline DescribeJobResponseBodyJob job() { DARABONBA_PTR_GET(job_, DescribeJobResponseBodyJob) };
    inline DescribeJobResponseBody& setJob(const DescribeJobResponseBodyJob & job) { DARABONBA_PTR_SET_VALUE(job_, job) };
    inline DescribeJobResponseBody& setJob(DescribeJobResponseBodyJob && job) { DARABONBA_PTR_SET_RVALUE(job_, job) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeJobResponseBodyJob> job_ = nullptr;
