...
#ifndef ALIBABACLOUD_MODELS_MODIFYJOBGROUPRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_MODIFYJOBGROUPRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyJobGroupResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyJobGroupResponseBody& obj) { 
    ...
    ModifyJobGroupResponseBody() = default ;
    ModifyJobGroupResponseBody(const ModifyJobGroupResponseBody &) = default ;
    ModifyJobGroupResponseBody(ModifyJobGroupResponseBody &&) = default ;
    ModifyJobGroupResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyJobGroupResponseBody() = default ;
    ModifyJobGroupResponseBody& operator=(const ModifyJobGroupResponseBody &) = default ;
    ModifyJobGroupResponseBody& operator=(ModifyJobGroupResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->callingNumbers_ == nullptr
        ...
        && this->priority_ == nullptr && this->recallStrategy_ == nullptr && this->ringingDuration_ == nullptr && this->scenarioId_ == nullptr && this->scriptName_ == nullptr
      ...
      inline JobGroup& setFlashSmsExtras(string flashSmsExtras) { DARABONBA_PTR_SET_VALUE(flashSmsExtras_, flashSmsExtras) };
    ...
    inline ModifyJobGroupResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ModifyJobGroupResponseBody& setHttpStatusCode(int32_t httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };


    // jobGroup Field Functions 
    bool hasJobGroup() const { return this->jobGroup_ != nullptr;};
    void deleteJobGroup() { this->jobGroup_ = nullptr;};
    inline const ModifyJobGroupResponseBody::JobGroup & getJobGroup() const { DARABONBA_PTR_GET_CONST(jobGroup_, ModifyJobGroupResponseBody::JobGroup) };
    inline ModifyJobGroupResponseBody::JobGroup getJobGroup() { DARABONBA_PTR_GET(jobGroup_, ModifyJobGroupResponseBody::JobGroup) };
    inline ModifyJobGroupResponseBody& setJobGroup(const ModifyJobGroupResponseBody::JobGroup & jobGroup) { DARABONBA_PTR_SET_VALUE(jobGroup_, jobGroup) };
    inline ModifyJobGroupResponseBody& setJobGroup(ModifyJobGroupResponseBody::JobGroup && jobGroup) { DARABONBA_PTR_SET_RVALUE(jobGroup_, jobGroup) };
    ...
    inline ModifyJobGroupResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ModifyJobGroupResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ModifyJobGroupResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
