...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTTSConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTTSConfigResponseBody) };
    inline DescribeTTSConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTTSConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTTSConfigResponseBody> body_ {};
  };
