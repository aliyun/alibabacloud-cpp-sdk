...
namespace Models
{
  ...
  public:
    ...
    inline const DownloadRecordingResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DownloadRecordingResponseBody) };
    inline DownloadRecordingResponseBody body() { DARABONBA_PTR_GET(body_, DownloadRecordingResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DownloadRecordingResponseBody> body_ = nullptr;
  };
