...
namespace Models
{
  ...
  public:
    ...
    inline const ListIntentionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIntentionsResponseBody) };
    inline ListIntentionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIntentionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIntentionsResponseBody> body_ {};
  };
