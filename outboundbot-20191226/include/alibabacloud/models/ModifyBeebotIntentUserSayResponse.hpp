...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyBeebotIntentUserSayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyBeebotIntentUserSayResponseBody) };
    inline ModifyBeebotIntentUserSayResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyBeebotIntentUserSayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyBeebotIntentUserSayResponseBody> body_ {};
  };
