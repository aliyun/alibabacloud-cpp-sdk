...
#ifndef ALIBABACLOUD_MODELS_MODIFYBATCHJOBSRESPONSEBODYJOBGROUPSTRATEGY_HPP_
#define ALIBABACLOUD_MODELS_MODIFYBATCHJOBSRESPONSEBODYJOBGROUPSTRATEGY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyBatchJobsResponseBodyJobGroupStrategy& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyBatchJobsResponseBodyJobGroupStrategy& obj) { 
    ...
    ModifyBatchJobsResponseBodyJobGroupStrategy() = default ;
    ModifyBatchJobsResponseBodyJobGroupStrategy(const ModifyBatchJobsResponseBodyJobGroupStrategy &) = default ;
    ModifyBatchJobsResponseBodyJobGroupStrategy(ModifyBatchJobsResponseBodyJobGroupStrategy &&) = default ;
    ModifyBatchJobsResponseBodyJobGroupStrategy(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyBatchJobsResponseBodyJobGroupStrategy() = default ;
    ModifyBatchJobsResponseBodyJobGroupStrategy& operator=(const ModifyBatchJobsResponseBodyJobGroupStrategy &) = default ;
    ModifyBatchJobsResponseBodyJobGroupStrategy& operator=(ModifyBatchJobsResponseBodyJobGroupStrategy &&) = default ;
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setCustomized(string customized) { DARABONBA_PTR_SET_VALUE(customized_, customized) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setFollowUpStrategy(string followUpStrategy) { DARABONBA_PTR_SET_VALUE(followUpStrategy_, followUpStrategy) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setIsTemplate(bool isTemplate) { DARABONBA_PTR_SET_VALUE(isTemplate_, isTemplate) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setMaxAttemptsPerDay(int32_t maxAttemptsPerDay) { DARABONBA_PTR_SET_VALUE(maxAttemptsPerDay_, maxAttemptsPerDay) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setMinAttemptInterval(int32_t minAttemptInterval) { DARABONBA_PTR_SET_VALUE(minAttemptInterval_, minAttemptInterval) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setRepeatBy(string repeatBy) { DARABONBA_PTR_SET_VALUE(repeatBy_, repeatBy) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setRepeatDays(const vector<string> & repeatDays) { DARABONBA_PTR_SET_VALUE(repeatDays_, repeatDays) };
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setRepeatDays(vector<string> && repeatDays) { DARABONBA_PTR_SET_RVALUE(repeatDays_, repeatDays) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setRoutingStrategy(string routingStrategy) { DARABONBA_PTR_SET_VALUE(routingStrategy_, routingStrategy) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setStrategyDescription(string strategyDescription) { DARABONBA_PTR_SET_VALUE(strategyDescription_, strategyDescription) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setStrategyId(string strategyId) { DARABONBA_PTR_SET_VALUE(strategyId_, strategyId) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setStrategyName(string strategyName) { DARABONBA_PTR_SET_VALUE(strategyName_, strategyName) };
    ...
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline const vector<Models::ModifyBatchJobsResponseBodyJobGroupStrategyWorkingTime> & workingTime() const { DARABONBA_PTR_GET_CONST(workingTime_, vector<Models::ModifyBatchJobsResponseBodyJobGroupStrategyWorkingTime>) };
    inline vector<Models::ModifyBatchJobsResponseBodyJobGroupStrategyWorkingTime> workingTime() { DARABONBA_PTR_GET(workingTime_, vector<Models::ModifyBatchJobsResponseBodyJobGroupStrategyWorkingTime>) };
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setWorkingTime(const vector<Models::ModifyBatchJobsResponseBodyJobGroupStrategyWorkingTime> & workingTime) { DARABONBA_PTR_SET_VALUE(workingTime_, workingTime) };
    inline ModifyBatchJobsResponseBodyJobGroupStrategy& setWorkingTime(vector<Models::ModifyBatchJobsResponseBodyJobGroupStrategyWorkingTime> && workingTime) { DARABONBA_PTR_SET_RVALUE(workingTime_, workingTime) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::ModifyBatchJobsResponseBodyJobGroupStrategyWorkingTime>> workingTime_ = nullptr;
  };
