...
namespace Models
{
  ...
  public:
    ...
    inline const SaveAnnotationMissionTagInfoListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SaveAnnotationMissionTagInfoListResponseBody) };
    inline SaveAnnotationMissionTagInfoListResponseBody body() { DARABONBA_PTR_GET(body_, SaveAnnotationMissionTagInfoListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<SaveAnnotationMissionTagInfoListResponseBody> body_ = nullptr;
  };
