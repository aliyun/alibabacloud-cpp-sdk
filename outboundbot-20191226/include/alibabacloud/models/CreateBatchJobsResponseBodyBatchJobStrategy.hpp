...
#ifndef ALIBABACLOUD_MODELS_CREATEBATCHJOBSRESPONSEBODYBATCHJOBSTRATEGY_HPP_
#define ALIBABACLOUD_MODELS_CREATEBATCHJOBSRESPONSEBODYBATCHJOBSTRATEGY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateBatchJobsResponseBodyBatchJobStrategy& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateBatchJobsResponseBodyBatchJobStrategy& obj) { 
    ...
    CreateBatchJobsResponseBodyBatchJobStrategy() = default ;
    CreateBatchJobsResponseBodyBatchJobStrategy(const CreateBatchJobsResponseBodyBatchJobStrategy &) = default ;
    CreateBatchJobsResponseBodyBatchJobStrategy(CreateBatchJobsResponseBodyBatchJobStrategy &&) = default ;
    CreateBatchJobsResponseBodyBatchJobStrategy(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateBatchJobsResponseBodyBatchJobStrategy() = default ;
    CreateBatchJobsResponseBodyBatchJobStrategy& operator=(const CreateBatchJobsResponseBodyBatchJobStrategy &) = default ;
    CreateBatchJobsResponseBodyBatchJobStrategy& operator=(CreateBatchJobsResponseBodyBatchJobStrategy &&) = default ;
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setCustomized(string customized) { DARABONBA_PTR_SET_VALUE(customized_, customized) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setFollowUpStrategy(string followUpStrategy) { DARABONBA_PTR_SET_VALUE(followUpStrategy_, followUpStrategy) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setIsTemplate(bool isTemplate) { DARABONBA_PTR_SET_VALUE(isTemplate_, isTemplate) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setMaxAttemptsPerDay(int32_t maxAttemptsPerDay) { DARABONBA_PTR_SET_VALUE(maxAttemptsPerDay_, maxAttemptsPerDay) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setMinAttemptInterval(int32_t minAttemptInterval) { DARABONBA_PTR_SET_VALUE(minAttemptInterval_, minAttemptInterval) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setRepeatBy(string repeatBy) { DARABONBA_PTR_SET_VALUE(repeatBy_, repeatBy) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setRepeatDays(const vector<string> & repeatDays) { DARABONBA_PTR_SET_VALUE(repeatDays_, repeatDays) };
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setRepeatDays(vector<string> && repeatDays) { DARABONBA_PTR_SET_RVALUE(repeatDays_, repeatDays) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setRoutingStrategy(string routingStrategy) { DARABONBA_PTR_SET_VALUE(routingStrategy_, routingStrategy) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setStrategyDescription(string strategyDescription) { DARABONBA_PTR_SET_VALUE(strategyDescription_, strategyDescription) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setStrategyId(string strategyId) { DARABONBA_PTR_SET_VALUE(strategyId_, strategyId) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setStrategyName(string strategyName) { DARABONBA_PTR_SET_VALUE(strategyName_, strategyName) };
    ...
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline const vector<Models::CreateBatchJobsResponseBodyBatchJobStrategyWorkingTime> & workingTime() const { DARABONBA_PTR_GET_CONST(workingTime_, vector<Models::CreateBatchJobsResponseBodyBatchJobStrategyWorkingTime>) };
    inline vector<Models::CreateBatchJobsResponseBodyBatchJobStrategyWorkingTime> workingTime() { DARABONBA_PTR_GET(workingTime_, vector<Models::CreateBatchJobsResponseBodyBatchJobStrategyWorkingTime>) };
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setWorkingTime(const vector<Models::CreateBatchJobsResponseBodyBatchJobStrategyWorkingTime> & workingTime) { DARABONBA_PTR_SET_VALUE(workingTime_, workingTime) };
    inline CreateBatchJobsResponseBodyBatchJobStrategy& setWorkingTime(vector<Models::CreateBatchJobsResponseBodyBatchJobStrategyWorkingTime> && workingTime) { DARABONBA_PTR_SET_RVALUE(workingTime_, workingTime) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::CreateBatchJobsResponseBodyBatchJobStrategyWorkingTime>> workingTime_ = nullptr;
  };
