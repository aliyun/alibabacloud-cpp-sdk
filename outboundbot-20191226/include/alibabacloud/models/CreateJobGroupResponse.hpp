...
namespace Models
{
  ...
  public:
    ...
    inline const CreateJobGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateJobGroupResponseBody) };
    inline CreateJobGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateJobGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateJobGroupResponseBody> body_ {};
  };
