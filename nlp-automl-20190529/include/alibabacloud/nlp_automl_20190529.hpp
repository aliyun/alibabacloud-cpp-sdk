...
#ifndef ALIBABACLOUD_NLP-AUTOML20190529_H_
#define ALIBABACLOUD_NLP-AUTOML20190529_H_
...
namespace Alibabacloud_Nlp-automl20190529 {
...
public:
  ...
  PredictModelResponse predictModelWithOptions(shared_ptr<PredictModelRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
