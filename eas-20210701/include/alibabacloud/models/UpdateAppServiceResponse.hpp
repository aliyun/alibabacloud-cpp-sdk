...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAppServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAppServiceResponseBody) };
    inline UpdateAppServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAppServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAppServiceResponseBody> body_ {};
  };
