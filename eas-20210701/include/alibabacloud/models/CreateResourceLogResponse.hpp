...
namespace Models
{
  ...
  public:
    ...
    inline const CreateResourceLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateResourceLogResponseBody) };
    inline CreateResourceLogResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateResourceLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateResourceLogResponseBody> body_ {};
  };
