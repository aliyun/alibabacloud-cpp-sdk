...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeServiceEndpointsResponseBody::Endpoints> & getEndpoints() const { DARABONBA_PTR_GET_CONST(endpoints_, vector<DescribeServiceEndpointsResponseBody::Endpoints>) };
    inline vector<DescribeServiceEndpointsResponseBody::Endpoints> getEndpoints() { DARABONBA_PTR_GET(endpoints_, vector<DescribeServiceEndpointsResponseBody::Endpoints>) };
    inline DescribeServiceEndpointsResponseBody& setEndpoints(const vector<DescribeServiceEndpointsResponseBody::Endpoints> & endpoints) { DARABONBA_PTR_SET_VALUE(endpoints_, endpoints) };
    inline DescribeServiceEndpointsResponseBody& setEndpoints(vector<DescribeServiceEndpointsResponseBody::Endpoints> && endpoints) { DARABONBA_PTR_SET_RVALUE(endpoints_, endpoints) };
