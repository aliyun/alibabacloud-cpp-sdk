...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateServiceMirrorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateServiceMirrorResponseBody) };
    inline UpdateServiceMirrorResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateServiceMirrorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateServiceMirrorResponseBody> body_ {};
  };
