...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->chargeType_ != nullptr
        ...
        && this->internetEnabled_ != nullptr && this->intranetDomain_ != nullptr && this->intranetEnabled_ != nullptr && this->isDefault_ != nullptr && this->replicas_ != nullptr
        && this->SSLRedirectionEnabled_ != nullptr && this->status_ != nullptr && this->updateTime_ != nullptr; };
    ...
    inline ListGatewayResponseBodyGateways& setIntranetEnabled(bool intranetEnabled) { DARABONBA_PTR_SET_VALUE(intranetEnabled_, intranetEnabled) };
