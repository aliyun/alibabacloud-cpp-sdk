...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateServiceAutoScalerRequest::Behavior & getBehavior() const { DARABONBA_PTR_GET_CONST(behavior_, UpdateServiceAutoScalerRequest::Behavior) };
    inline UpdateServiceAutoScalerRequest::Behavior getBehavior() { DARABONBA_PTR_GET(behavior_, UpdateServiceAutoScalerRequest::Behavior) };
    inline UpdateServiceAutoScalerRequest& setBehavior(const UpdateServiceAutoScalerRequest::Behavior & behavior) { DARABONBA_PTR_SET_VALUE(behavior_, behavior) };
    inline UpdateServiceAutoScalerRequest& setBehavior(UpdateServiceAutoScalerRequest::Behavior && behavior) { DARABONBA_PTR_SET_RVALUE(behavior_, behavior) };
    ...
    inline const vector<UpdateServiceAutoScalerRequest::ScaleStrategies> & getScaleStrategies() const { DARABONBA_PTR_GET_CONST(scaleStrategies_, vector<UpdateServiceAutoScalerRequest::ScaleStrategies>) };
    inline vector<UpdateServiceAutoScalerRequest::ScaleStrategies> getScaleStrategies() { DARABONBA_PTR_GET(scaleStrategies_, vector<UpdateServiceAutoScalerRequest::ScaleStrategies>) };
    inline UpdateServiceAutoScalerRequest& setScaleStrategies(const vector<UpdateServiceAutoScalerRequest::ScaleStrategies> & scaleStrategies) { DARABONBA_PTR_SET_VALUE(scaleStrategies_, scaleStrategies) };
    inline UpdateServiceAutoScalerRequest& setScaleStrategies(vector<UpdateServiceAutoScalerRequest::ScaleStrategies> && scaleStrategies) { DARABONBA_PTR_SET_RVALUE(scaleStrategies_, scaleStrategies) };


  protected:
    // The Autoscaler operation.
    shared_ptr<UpdateServiceAutoScalerRequest::Behavior> behavior_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<UpdateServiceAutoScalerRequest::ScaleStrategies>> scaleStrategies_ {};
  };
