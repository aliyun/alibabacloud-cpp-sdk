...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeServiceMirrorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeServiceMirrorResponseBody) };
    inline DescribeServiceMirrorResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeServiceMirrorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeServiceMirrorResponseBody> body_ {};
  };
