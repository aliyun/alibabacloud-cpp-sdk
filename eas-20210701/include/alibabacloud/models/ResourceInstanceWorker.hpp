...
namespace Models
{
  ...
  public:
    ...
    inline int32_t gpuLimit() const { DARABONBA_PTR_GET_DEFAULT(gpuLimit_, 0) };
    ...
    inline int32_t gpuRequest() const { DARABONBA_PTR_GET_DEFAULT(gpuRequest_, 0) };
    ...
    inline int32_t memoryRquest() const { DARABONBA_PTR_GET_DEFAULT(memoryRquest_, 0) };
  ...
  protected:
    ...
    std::shared_ptr<int32_t> gpuLimit_ = nullptr;
    std::shared_ptr<int32_t> gpuRequest_ = nullptr;
    std::shared_ptr<int32_t> memoryLimit_ = nullptr;
    std::shared_ptr<int32_t> memoryRquest_ = nullptr;
