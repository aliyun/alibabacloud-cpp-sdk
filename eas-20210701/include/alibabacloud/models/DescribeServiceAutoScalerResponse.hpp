...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeServiceAutoScalerResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeServiceAutoScalerResponseBody) };
    inline DescribeServiceAutoScalerResponseBody body() { DARABONBA_PTR_GET(body_, DescribeServiceAutoScalerResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeServiceAutoScalerResponseBody> body_ = nullptr;
  };
