...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateServiceVersionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateServiceVersionResponseBody) };
    inline UpdateServiceVersionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateServiceVersionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateServiceVersionResponseBody> body_ {};
  };
