...
namespace Models
{
  ...
  public:
    ...
    inline const ListVirtualResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVirtualResourceResponseBody) };
    inline ListVirtualResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVirtualResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVirtualResourceResponseBody> body_ {};
  };
