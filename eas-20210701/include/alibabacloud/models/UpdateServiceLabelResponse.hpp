...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateServiceLabelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateServiceLabelResponseBody) };
    inline UpdateServiceLabelResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateServiceLabelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateServiceLabelResponseBody> body_ {};
  };
