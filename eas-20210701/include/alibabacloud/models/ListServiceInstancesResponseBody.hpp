...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Instance> & instances() const { DARABONBA_PTR_GET_CONST(instances_, vector<Instance>) };
    inline vector<Instance> instances() { DARABONBA_PTR_GET(instances_, vector<Instance>) };
    inline ListServiceInstancesResponseBody& setInstances(const vector<Instance> & instances) { DARABONBA_PTR_SET_VALUE(instances_, instances) };
    inline ListServiceInstancesResponseBody& setInstances(vector<Instance> && instances) { DARABONBA_PTR_SET_RVALUE(instances_, instances) };
    ...
    inline ListServiceInstancesResponseBody& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListServiceInstancesResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
  ...
  protected:
    // The instances.
    std::shared_ptr<vector<Instance>> instances_ = nullptr;
    // The page number.
