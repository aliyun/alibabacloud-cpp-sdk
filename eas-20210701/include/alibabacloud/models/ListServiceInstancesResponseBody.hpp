...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Instance> & getInstances() const { DARABONBA_PTR_GET_CONST(instances_, vector<Instance>) };
    inline vector<Instance> getInstances() { DARABONBA_PTR_GET(instances_, vector<Instance>) };
  ...
  protected:
    // The instances.
    shared_ptr<vector<Instance>> instances_ {};
    // The page number.
