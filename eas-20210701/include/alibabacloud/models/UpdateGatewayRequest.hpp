...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->enableInternet_ == nullptr
        && return this->enableIntranet_ == nullptr && return this->enableSSLRedirection_ == nullptr && return this->instanceType_ == nullptr && return this->isDefault_ == nullptr && return this->name_ == nullptr
        && return this->replicas_ == nullptr && return this->vSwitchIds_ == nullptr && return this->vpcId_ == nullptr; };
