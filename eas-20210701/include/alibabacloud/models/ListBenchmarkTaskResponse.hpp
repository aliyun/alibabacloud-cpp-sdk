...
namespace Models
{
  ...
  public:
    ...
    inline const ListBenchmarkTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListBenchmarkTaskResponseBody) };
    inline ListBenchmarkTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ListBenchmarkTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListBenchmarkTaskResponseBody> body_ {};
  };
