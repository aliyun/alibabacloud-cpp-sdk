...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeServiceEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeServiceEventResponseBody) };
    inline DescribeServiceEventResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeServiceEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeServiceEventResponseBody> body_ {};
  };
