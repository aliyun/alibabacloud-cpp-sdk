...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteBenchmarkTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteBenchmarkTaskResponseBody) };
    inline DeleteBenchmarkTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteBenchmarkTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteBenchmarkTaskResponseBody> body_ {};
  };
