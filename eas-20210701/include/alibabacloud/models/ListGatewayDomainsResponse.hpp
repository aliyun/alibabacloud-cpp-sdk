...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayDomainsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListGatewayDomainsResponseBody) };
    inline ListGatewayDomainsResponseBody body() { DARABONBA_PTR_GET(body_, ListGatewayDomainsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListGatewayDomainsResponseBody> body_ = nullptr;
  };
