...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGatewayIntranetLinkedVpcResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateGatewayIntranetLinkedVpcResponseBody) };
    inline CreateGatewayIntranetLinkedVpcResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateGatewayIntranetLinkedVpcResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateGatewayIntranetLinkedVpcResponseBody> body_ {};
  };
