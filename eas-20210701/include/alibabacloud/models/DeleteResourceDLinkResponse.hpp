...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteResourceDLinkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteResourceDLinkResponseBody) };
    inline DeleteResourceDLinkResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteResourceDLinkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteResourceDLinkResponseBody> body_ {};
  };
