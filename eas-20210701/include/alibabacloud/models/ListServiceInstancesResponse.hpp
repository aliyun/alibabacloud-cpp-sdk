...
namespace Models
{
  ...
  public:
    ...
    inline const ListServiceInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListServiceInstancesResponseBody) };
    inline ListServiceInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListServiceInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListServiceInstancesResponseBody> body_ {};
  };
