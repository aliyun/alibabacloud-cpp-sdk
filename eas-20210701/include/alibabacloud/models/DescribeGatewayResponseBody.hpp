...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->chargeType_ == nullptr
        ...
        && this->isDefault_ == nullptr && this->labels_ == nullptr && this->replicas_ == nullptr && this->requestId_ == nullptr && this->SSLRedirectionEnabled_ == nullptr
    ...
    inline const vector<DescribeGatewayResponseBody::Labels> & getLabels() const { DARABONBA_PTR_GET_CONST(labels_, vector<DescribeGatewayResponseBody::Labels>) };
    inline vector<DescribeGatewayResponseBody::Labels> getLabels() { DARABONBA_PTR_GET(labels_, vector<DescribeGatewayResponseBody::Labels>) };
    inline DescribeGatewayResponseBody& setLabels(const vector<DescribeGatewayResponseBody::Labels> & labels) { DARABONBA_PTR_SET_VALUE(labels_, labels) };
    inline DescribeGatewayResponseBody& setLabels(vector<DescribeGatewayResponseBody::Labels> && labels) { DARABONBA_PTR_SET_RVALUE(labels_, labels) };
