...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVirtualResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVirtualResourceResponseBody) };
    inline CreateVirtualResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVirtualResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVirtualResourceResponseBody> body_ {};
  };
