...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateResourceDLinkResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateResourceDLinkResponseBody) };
    inline UpdateResourceDLinkResponseBody body() { DARABONBA_PTR_GET(body_, UpdateResourceDLinkResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateResourceDLinkResponseBody> body_ = nullptr;
  };
