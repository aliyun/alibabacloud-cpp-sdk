...
namespace Models
{
  ...
  public:
    ...
    inline const vector<Group> & getGroups() const { DARABONBA_PTR_GET_CONST(groups_, vector<Group>) };
    inline vector<Group> getGroups() { DARABONBA_PTR_GET(groups_, vector<Group>) };
