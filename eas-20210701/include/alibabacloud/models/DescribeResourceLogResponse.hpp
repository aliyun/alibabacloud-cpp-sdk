...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceLogResponseBody) };
    inline DescribeResourceLogResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourceLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourceLogResponseBody> body_ {};
  };
