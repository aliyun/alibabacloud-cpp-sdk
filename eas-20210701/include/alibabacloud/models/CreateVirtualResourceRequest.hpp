...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateVirtualResourceRequest::Resources> & getResources() const { DARABONBA_PTR_GET_CONST(resources_, vector<CreateVirtualResourceRequest::Resources>) };
    inline vector<CreateVirtualResourceRequest::Resources> getResources() { DARABONBA_PTR_GET(resources_, vector<CreateVirtualResourceRequest::Resources>) };
    inline CreateVirtualResourceRequest& setResources(const vector<CreateVirtualResourceRequest::Resources> & resources) { DARABONBA_PTR_SET_VALUE(resources_, resources) };
    inline CreateVirtualResourceRequest& setResources(vector<CreateVirtualResourceRequest::Resources> && resources) { DARABONBA_PTR_SET_RVALUE(resources_, resources) };
  ...
  protected:
    ...
    shared_ptr<vector<CreateVirtualResourceRequest::Resources>> resources_ {};
