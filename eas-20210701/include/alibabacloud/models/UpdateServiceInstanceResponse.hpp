...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateServiceInstanceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateServiceInstanceResponseBody) };
    inline UpdateServiceInstanceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateServiceInstanceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateServiceInstanceResponseBody> body_ {};
  };
