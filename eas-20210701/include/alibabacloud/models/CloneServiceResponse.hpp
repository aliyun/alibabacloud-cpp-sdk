...
namespace Models
{
  ...
  public:
    ...
    inline const CloneServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CloneServiceResponseBody) };
    inline CloneServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, CloneServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CloneServiceResponseBody> body_ {};
  };
