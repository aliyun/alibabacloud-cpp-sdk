...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteServiceCronScalerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteServiceCronScalerResponseBody) };
    inline DeleteServiceCronScalerResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteServiceCronScalerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteServiceCronScalerResponseBody> body_ {};
  };
