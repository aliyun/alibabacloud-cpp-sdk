...
namespace Models
{
  ...
  public:
    ...
    inline const CreateServiceCronScalerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateServiceCronScalerResponseBody) };
    inline CreateServiceCronScalerResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateServiceCronScalerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateServiceCronScalerResponseBody> body_ {};
  };
