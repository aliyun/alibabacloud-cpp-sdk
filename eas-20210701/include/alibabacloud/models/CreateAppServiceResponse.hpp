...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAppServiceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAppServiceResponseBody) };
    inline CreateAppServiceResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAppServiceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAppServiceResponseBody> body_ {};
  };
