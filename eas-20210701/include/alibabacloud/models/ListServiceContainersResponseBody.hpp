...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->containers_ == nullptr
        && this->requestId_ == nullptr && this->serviceName_ == nullptr; };
    ...
    inline const vector<ContainerInfo> & getContainers() const { DARABONBA_PTR_GET_CONST(containers_, vector<ContainerInfo>) };
    inline vector<ContainerInfo> getContainers() { DARABONBA_PTR_GET(containers_, vector<ContainerInfo>) };
  ...
  protected:
    ...
    shared_ptr<vector<ContainerInfo>> containers_ {};
    // The request ID.
