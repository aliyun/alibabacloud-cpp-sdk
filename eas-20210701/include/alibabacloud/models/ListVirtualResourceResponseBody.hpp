...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->requestId_ == nullptr && return this->totalCount_ == nullptr && return this->virtualResources_ == nullptr; };
    ...
    inline const vector<ListVirtualResourceResponseBodyVirtualResources> & virtualResources() const { DARABONBA_PTR_GET_CONST(virtualResources_, vector<ListVirtualResourceResponseBodyVirtualResources>) };
    inline vector<ListVirtualResourceResponseBodyVirtualResources> virtualResources() { DARABONBA_PTR_GET(virtualResources_, vector<ListVirtualResourceResponseBodyVirtualResources>) };
    inline ListVirtualResourceResponseBody& setVirtualResources(const vector<ListVirtualResourceResponseBodyVirtualResources> & virtualResources) { DARABONBA_PTR_SET_VALUE(virtualResources_, virtualResources) };
    inline ListVirtualResourceResponseBody& setVirtualResources(vector<ListVirtualResourceResponseBodyVirtualResources> && virtualResources) { DARABONBA_PTR_SET_RVALUE(virtualResources_, virtualResources) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListVirtualResourceResponseBodyVirtualResources>> virtualResources_ = nullptr;
  };
