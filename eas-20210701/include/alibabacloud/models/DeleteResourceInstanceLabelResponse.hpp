...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteResourceInstanceLabelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteResourceInstanceLabelResponseBody) };
    inline DeleteResourceInstanceLabelResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteResourceInstanceLabelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteResourceInstanceLabelResponseBody> body_ {};
  };
