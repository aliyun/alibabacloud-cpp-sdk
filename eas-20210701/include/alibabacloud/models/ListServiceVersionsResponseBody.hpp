...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListServiceVersionsResponseBodyVersions> & versions() const { DARABONBA_PTR_GET_CONST(versions_, vector<ListServiceVersionsResponseBodyVersions>) };
    inline vector<ListServiceVersionsResponseBodyVersions> versions() { DARABONBA_PTR_GET(versions_, vector<ListServiceVersionsResponseBodyVersions>) };
    inline ListServiceVersionsResponseBody& setVersions(const vector<ListServiceVersionsResponseBodyVersions> & versions) { DARABONBA_PTR_SET_VALUE(versions_, versions) };
    inline ListServiceVersionsResponseBody& setVersions(vector<ListServiceVersionsResponseBodyVersions> && versions) { DARABONBA_PTR_SET_RVALUE(versions_, versions) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListServiceVersionsResponseBodyVersions>> versions_ = nullptr;
  };
