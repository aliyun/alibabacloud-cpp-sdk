...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteGatewayIntranetLinkedVpcResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteGatewayIntranetLinkedVpcResponseBody) };
    inline DeleteGatewayIntranetLinkedVpcResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteGatewayIntranetLinkedVpcResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteGatewayIntranetLinkedVpcResponseBody> body_ {};
  };
