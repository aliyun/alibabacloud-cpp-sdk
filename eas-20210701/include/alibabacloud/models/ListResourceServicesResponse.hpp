...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceServicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListResourceServicesResponseBody) };
    inline ListResourceServicesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListResourceServicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListResourceServicesResponseBody> body_ {};
  };
