...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeServiceLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeServiceLogResponseBody) };
    inline DescribeServiceLogResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeServiceLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeServiceLogResponseBody> body_ {};
  };
