...
namespace Models
{
  ...
  public:
    ...
    inline const CreateServiceMirrorResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreateServiceMirrorResponseBody) };
    inline CreateServiceMirrorResponseBody body() { DARABONBA_PTR_GET(body_, CreateServiceMirrorResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreateServiceMirrorResponseBody> body_ = nullptr;
  };
