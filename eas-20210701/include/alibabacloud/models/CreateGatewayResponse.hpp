...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGatewayResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateGatewayResponseBody) };
    inline CreateGatewayResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateGatewayResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateGatewayResponseBody> body_ {};
  };
