...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGroupEndpointsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeGroupEndpointsResponseBody) };
    inline DescribeGroupEndpointsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeGroupEndpointsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeGroupEndpointsResponseBody> body_ {};
  };
