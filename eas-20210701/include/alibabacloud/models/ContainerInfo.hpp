...
namespace Models
{
  ...
  public:
    ...
    inline string currentReaon() const { DARABONBA_PTR_GET_DEFAULT(currentReaon_, "") };
    ...
    inline string currentTimestamp() const { DARABONBA_PTR_GET_DEFAULT(currentTimestamp_, "") };
    ...
    inline string lastReason() const { DARABONBA_PTR_GET_DEFAULT(lastReason_, "") };
    ...
    inline string lastStatus() const { DARABONBA_PTR_GET_DEFAULT(lastStatus_, "") };
  ...
  protected:
    std::shared_ptr<string> currentReaon_ = nullptr;
    std::shared_ptr<string> currentStatus_ = nullptr;
    std::shared_ptr<string> currentTimestamp_ = nullptr;
    std::shared_ptr<string> image_ = nullptr;
    std::shared_ptr<string> lastReason_ = nullptr;
    std::shared_ptr<string> lastStatus_ = nullptr;
