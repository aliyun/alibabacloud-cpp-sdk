...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ResourceInstanceWorker> & getPods() const { DARABONBA_PTR_GET_CONST(pods_, vector<ResourceInstanceWorker>) };
    inline vector<ResourceInstanceWorker> getPods() { DARABONBA_PTR_GET(pods_, vector<ResourceInstanceWorker>) };
  ...
  protected:
    ...
    // The workers.
    shared_ptr<vector<ResourceInstanceWorker>> pods_ {};
    // The request ID.
