...
namespace Models
{
  ...
  public:
    ...
    inline const DetachGatewayDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachGatewayDomainResponseBody) };
    inline DetachGatewayDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachGatewayDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachGatewayDomainResponseBody> body_ {};
  };
