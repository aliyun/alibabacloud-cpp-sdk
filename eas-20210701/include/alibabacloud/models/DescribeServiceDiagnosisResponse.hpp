...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeServiceDiagnosisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeServiceDiagnosisResponseBody) };
    inline DescribeServiceDiagnosisResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeServiceDiagnosisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeServiceDiagnosisResponseBody> body_ {};
  };
