...
namespace Models
{
  ...
  public:
    ...
    inline const StartBenchmarkTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StartBenchmarkTaskResponseBody) };
    inline StartBenchmarkTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, StartBenchmarkTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StartBenchmarkTaskResponseBody> body_ {};
  };
