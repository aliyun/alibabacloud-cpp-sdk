...
namespace Models
{
  ...
  public:
    ...
    inline ListServicesResponseBody& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline ListServicesResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline const vector<Service> & getServices() const { DARABONBA_PTR_GET_CONST(services_, vector<Service>) };
    inline vector<Service> getServices() { DARABONBA_PTR_GET(services_, vector<Service>) };
    inline ListServicesResponseBody& setServices(const vector<Service> & services) { DARABONBA_PTR_SET_VALUE(services_, services) };
    inline ListServicesResponseBody& setServices(vector<Service> && services) { DARABONBA_PTR_SET_RVALUE(services_, services) };
  ...
  protected:
    ...
    // The services.
    shared_ptr<vector<Service>> services_ {};
