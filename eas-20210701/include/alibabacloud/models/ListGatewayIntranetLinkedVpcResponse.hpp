...
namespace Models
{
  ...
  public:
    ...
    inline const ListGatewayIntranetLinkedVpcResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListGatewayIntranetLinkedVpcResponseBody) };
    inline ListGatewayIntranetLinkedVpcResponseBody getBody() { DARABONBA_PTR_GET(body_, ListGatewayIntranetLinkedVpcResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListGatewayIntranetLinkedVpcResponseBody> body_ {};
  };
