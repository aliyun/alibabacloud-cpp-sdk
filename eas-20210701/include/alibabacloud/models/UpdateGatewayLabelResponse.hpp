...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateGatewayLabelResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateGatewayLabelResponseBody) };
    inline UpdateGatewayLabelResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateGatewayLabelResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateGatewayLabelResponseBody> body_ {};
  };
