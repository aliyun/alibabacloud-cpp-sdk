...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeResourceResponseBody) };
    inline DescribeResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeResourceResponseBody> body_ {};
  };
