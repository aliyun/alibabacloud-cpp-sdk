...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAclPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAclPolicyResponseBody) };
    inline DeleteAclPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAclPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAclPolicyResponseBody> body_ {};
  };
