...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBenchmarkTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBenchmarkTaskResponseBody) };
    inline CreateBenchmarkTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBenchmarkTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBenchmarkTaskResponseBody> body_ {};
  };
