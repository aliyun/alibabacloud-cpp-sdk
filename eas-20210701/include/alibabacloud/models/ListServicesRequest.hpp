...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessibility_ == nullptr
        ...
        && this->groupName_ == nullptr && this->includeNoWorkspace_ == nullptr && this->label_ == nullptr && this->order_ == nullptr && this->pageNumber_ == nullptr
    ...
    inline ListServicesRequest& setAccessibility(string accessibility) { DARABONBA_PTR_SET_VALUE(accessibility_, accessibility) };
    ...
    inline ListServicesRequest& setAutoscalerEnabled(bool autoscalerEnabled) { DARABONBA_PTR_SET_VALUE(autoscalerEnabled_, autoscalerEnabled) };
    ...
    inline ListServicesRequest& setCallerUid(string callerUid) { DARABONBA_PTR_SET_VALUE(callerUid_, callerUid) };
    ...
    inline ListServicesRequest& setCronscalerEnabled(bool cronscalerEnabled) { DARABONBA_PTR_SET_VALUE(cronscalerEnabled_, cronscalerEnabled) };
    ...
    inline ListServicesRequest& setFilter(string filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    ...
    inline ListServicesRequest& setGateway(string gateway) { DARABONBA_PTR_SET_VALUE(gateway_, gateway) };
    ...
    inline ListServicesRequest& setGroupName(string groupName) { DARABONBA_PTR_SET_VALUE(groupName_, groupName) };
    ...
    inline ListServicesRequest& setIncludeNoWorkspace(bool includeNoWorkspace) { DARABONBA_PTR_SET_VALUE(includeNoWorkspace_, includeNoWorkspace) };
    ...
    inline ListServicesRequest& setLabel(const map<string, string> & label) { DARABONBA_PTR_SET_VALUE(label_, label) };
    inline ListServicesRequest& setLabel(map<string, string> && label) { DARABONBA_PTR_SET_RVALUE(label_, label) };
    ...
    inline ListServicesRequest& setOrder(string order) { DARABONBA_PTR_SET_VALUE(order_, order) };
    ...
    inline ListServicesRequest& setParentServiceUid(string parentServiceUid) { DARABONBA_PTR_SET_VALUE(parentServiceUid_, parentServiceUid) };
    ...
    inline ListServicesRequest& setQuotaId(string quotaId) { DARABONBA_PTR_SET_VALUE(quotaId_, quotaId) };
    ...
    inline ListServicesRequest& setResourceAliasName(string resourceAliasName) { DARABONBA_PTR_SET_VALUE(resourceAliasName_, resourceAliasName) };
    ...
    inline ListServicesRequest& setResourceBurstable(bool resourceBurstable) { DARABONBA_PTR_SET_VALUE(resourceBurstable_, resourceBurstable) };
    ...
    inline ListServicesRequest& setResourceId(string resourceId) { DARABONBA_PTR_SET_VALUE(resourceId_, resourceId) };
    ...
    inline ListServicesRequest& setResourceName(string resourceName) { DARABONBA_PTR_SET_VALUE(resourceName_, resourceName) };
    ...
    inline ListServicesRequest& setResourceType(string resourceType) { DARABONBA_PTR_SET_VALUE(resourceType_, resourceType) };
    ...
    inline ListServicesRequest& setRole(string role) { DARABONBA_PTR_SET_VALUE(role_, role) };
    ...
    inline ListServicesRequest& setServiceStatus(string serviceStatus) { DARABONBA_PTR_SET_VALUE(serviceStatus_, serviceStatus) };
    ...
    inline ListServicesRequest& setServiceUid(string serviceUid) { DARABONBA_PTR_SET_VALUE(serviceUid_, serviceUid) };
    ...
    inline ListServicesRequest& setSort(string sort) { DARABONBA_PTR_SET_VALUE(sort_, sort) };
    ...
    inline ListServicesRequest& setTrafficState(string trafficState) { DARABONBA_PTR_SET_VALUE(trafficState_, trafficState) };
    ...
    inline ListServicesRequest& setWorkspaceId(string workspaceId) { DARABONBA_PTR_SET_VALUE(workspaceId_, workspaceId) };
