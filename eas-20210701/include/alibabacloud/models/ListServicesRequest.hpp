...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoscalerEnabled_ == nullptr
        ...
        && return this->label_ == nullptr && return this->order_ == nullptr && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->parentServiceUid_ == nullptr
