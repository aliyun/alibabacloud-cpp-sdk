...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGatewayIntranetLinkedVpcPeerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateGatewayIntranetLinkedVpcPeerResponseBody) };
    inline CreateGatewayIntranetLinkedVpcPeerResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateGatewayIntranetLinkedVpcPeerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateGatewayIntranetLinkedVpcPeerResponseBody> body_ {};
  };
