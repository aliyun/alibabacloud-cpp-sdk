...
namespace Models
{
  ...
  public:
    ...
    inline const AttachGatewayDomainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AttachGatewayDomainResponseBody) };
    inline AttachGatewayDomainResponseBody getBody() { DARABONBA_PTR_GET(body_, AttachGatewayDomainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AttachGatewayDomainResponseBody> body_ {};
  };
