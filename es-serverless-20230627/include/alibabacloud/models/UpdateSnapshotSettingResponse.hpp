...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSnapshotSettingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSnapshotSettingResponseBody) };
    inline UpdateSnapshotSettingResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateSnapshotSettingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateSnapshotSettingResponseBody> body_ {};
  };
