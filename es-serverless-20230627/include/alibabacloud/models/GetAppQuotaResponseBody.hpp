...
namespace Models
{
  ...
  public:
    ...
    inline const GetAppQuotaResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetAppQuotaResponseBodyResult) };
    inline GetAppQuotaResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetAppQuotaResponseBodyResult) };
    inline GetAppQuotaResponseBody& setResult(const GetAppQuotaResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetAppQuotaResponseBody& setResult(GetAppQuotaResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<GetAppQuotaResponseBodyResult> result_ = nullptr;
  };
