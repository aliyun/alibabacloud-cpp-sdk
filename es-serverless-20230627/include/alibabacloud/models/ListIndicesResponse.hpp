...
namespace Models
{
  ...
  public:
    ...
    inline const ListIndicesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListIndicesResponseBody) };
    inline ListIndicesResponseBody body() { DARABONBA_PTR_GET(body_, ListIndicesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListIndicesResponseBody> body_ = nullptr;
  };
