...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDictsResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListDictsResponseBodyResult>) };
    inline vector<ListDictsResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListDictsResponseBodyResult>) };
    inline ListDictsResponseBody& setResult(const vector<ListDictsResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListDictsResponseBody& setResult(vector<ListDictsResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListDictsResponseBodyResult>> result_ = nullptr;
