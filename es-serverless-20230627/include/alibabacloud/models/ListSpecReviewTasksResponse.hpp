...
namespace Models
{
  ...
  public:
    ...
    inline const ListSpecReviewTasksResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListSpecReviewTasksResponseBody) };
    inline ListSpecReviewTasksResponseBody getBody() { DARABONBA_PTR_GET(body_, ListSpecReviewTasksResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListSpecReviewTasksResponseBody> body_ {};
  };
