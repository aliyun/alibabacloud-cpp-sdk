...
namespace Models
{
  ...
  public:
    ...
    inline const GetMonitorDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetMonitorDataResponseBody) };
    inline GetMonitorDataResponseBody getBody() { DARABONBA_PTR_GET(body_, GetMonitorDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetMonitorDataResponseBody> body_ {};
  };
