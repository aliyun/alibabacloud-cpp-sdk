...
namespace Models
{
  ...
  public:
    ...
    inline const GetAppQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetAppQuotaResponseBody) };
    inline GetAppQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, GetAppQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetAppQuotaResponseBody> body_ {};
  };
