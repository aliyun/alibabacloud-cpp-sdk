...
namespace Models
{
  ...
  public:
    ...
    inline const CreateEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateEndpointResponseBody) };
    inline CreateEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateEndpointResponseBody> body_ {};
  };
