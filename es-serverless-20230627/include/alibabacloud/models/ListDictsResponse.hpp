...
namespace Models
{
  ...
  public:
    ...
    inline const ListDictsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListDictsResponseBody) };
    inline ListDictsResponseBody body() { DARABONBA_PTR_GET(body_, ListDictsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListDictsResponseBody> body_ = nullptr;
  };
