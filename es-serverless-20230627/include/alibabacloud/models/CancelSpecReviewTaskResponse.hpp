...
namespace Models
{
  ...
  public:
    ...
    inline const CancelSpecReviewTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelSpecReviewTaskResponseBody) };
    inline CancelSpecReviewTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelSpecReviewTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelSpecReviewTaskResponseBody> body_ {};
  };
