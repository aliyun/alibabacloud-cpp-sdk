...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListEndpointsResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListEndpointsResponseBodyResult>) };
    inline vector<ListEndpointsResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListEndpointsResponseBodyResult>) };
    inline ListEndpointsResponseBody& setResult(const vector<ListEndpointsResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListEndpointsResponseBody& setResult(vector<ListEndpointsResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListEndpointsResponseBodyResult>> result_ = nullptr;
