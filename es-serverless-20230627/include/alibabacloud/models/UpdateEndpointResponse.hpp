...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEndpointResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEndpointResponseBody) };
    inline UpdateEndpointResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEndpointResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEndpointResponseBody> body_ {};
  };
