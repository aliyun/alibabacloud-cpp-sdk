...
namespace Models
{
  ...
  public:
    ...
    inline const GetSpecReviewTaskResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetSpecReviewTaskResponseBodyResult) };
    inline GetSpecReviewTaskResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetSpecReviewTaskResponseBodyResult) };
    inline GetSpecReviewTaskResponseBody& setResult(const GetSpecReviewTaskResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetSpecReviewTaskResponseBody& setResult(GetSpecReviewTaskResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<GetSpecReviewTaskResponseBodyResult> result_ = nullptr;
  };
