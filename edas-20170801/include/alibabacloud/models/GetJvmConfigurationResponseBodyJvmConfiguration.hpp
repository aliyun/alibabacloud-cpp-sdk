...
#ifndef ALIBABACLOUD_MODELS_GETJVMCONFIGURATIONRESPONSEBODYJVMCONFIGURATION_HPP_
#define ALIBABACLOUD_MODELS_GETJVMCONFIGURATIONRESPONSEBODYJVMCONFIGURATION_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetJvmConfigurationResponseBodyJvmConfiguration& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetJvmConfigurationResponseBodyJvmConfiguration& obj) { 
    ...
    GetJvmConfigurationResponseBodyJvmConfiguration() = default ;
    GetJvmConfigurationResponseBodyJvmConfiguration(const GetJvmConfigurationResponseBodyJvmConfiguration &) = default ;
    GetJvmConfigurationResponseBodyJvmConfiguration(GetJvmConfigurationResponseBodyJvmConfiguration &&) = default ;
    GetJvmConfigurationResponseBodyJvmConfiguration(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetJvmConfigurationResponseBodyJvmConfiguration() = default ;
    GetJvmConfigurationResponseBodyJvmConfiguration& operator=(const GetJvmConfigurationResponseBodyJvmConfiguration &) = default ;
    GetJvmConfigurationResponseBodyJvmConfiguration& operator=(GetJvmConfigurationResponseBodyJvmConfiguration &&) = default ;
    ...
    inline GetJvmConfigurationResponseBodyJvmConfiguration& setMaxHeapSize(int32_t maxHeapSize) { DARABONBA_PTR_SET_VALUE(maxHeapSize_, maxHeapSize) };
    ...
    inline GetJvmConfigurationResponseBodyJvmConfiguration& setMaxPermSize(int32_t maxPermSize) { DARABONBA_PTR_SET_VALUE(maxPermSize_, maxPermSize) };
    ...
    inline GetJvmConfigurationResponseBodyJvmConfiguration& setMinHeapSize(int32_t minHeapSize) { DARABONBA_PTR_SET_VALUE(minHeapSize_, minHeapSize) };
    ...
    inline GetJvmConfigurationResponseBodyJvmConfiguration& setOptions(string options) { DARABONBA_PTR_SET_VALUE(options_, options) };
