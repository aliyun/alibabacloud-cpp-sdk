...
namespace Models
{
  ...
  public:
    ...
    inline const ListApplicationResponseBodyApplicationList & applicationList() const { DARABONBA_PTR_GET_CONST(applicationList_, ListApplicationResponseBodyApplicationList) };
    inline ListApplicationResponseBodyApplicationList applicationList() { DARABONBA_PTR_GET(applicationList_, ListApplicationResponseBodyApplicationList) };
    inline ListApplicationResponseBody& setApplicationList(const ListApplicationResponseBodyApplicationList & applicationList) { DARABONBA_PTR_SET_VALUE(applicationList_, applicationList) };
    inline ListApplicationResponseBody& setApplicationList(ListApplicationResponseBodyApplicationList && applicationList) { DARABONBA_PTR_SET_RVALUE(applicationList_, applicationList) };
  ...
  protected:
    ...
    std::shared_ptr<ListApplicationResponseBodyApplicationList> applicationList_ = nullptr;
