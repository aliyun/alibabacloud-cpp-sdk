...
namespace Models
{
  ...
  public:
    ...
    inline const InsertSwimmingLaneResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, InsertSwimmingLaneResponseBodyData) };
    inline InsertSwimmingLaneResponseBodyData data() { DARABONBA_PTR_GET(data_, InsertSwimmingLaneResponseBodyData) };
    inline InsertSwimmingLaneResponseBody& setData(const InsertSwimmingLaneResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline InsertSwimmingLaneResponseBody& setData(InsertSwimmingLaneResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<InsertSwimmingLaneResponseBodyData> data_ = nullptr;
