...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->javaStartUpConfig_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const GetJavaStartUpConfigResponseBodyJavaStartUpConfig & javaStartUpConfig() const { DARABONBA_PTR_GET_CONST(javaStartUpConfig_, GetJavaStartUpConfigResponseBodyJavaStartUpConfig) };
    inline GetJavaStartUpConfigResponseBodyJavaStartUpConfig javaStartUpConfig() { DARABONBA_PTR_GET(javaStartUpConfig_, GetJavaStartUpConfigResponseBodyJavaStartUpConfig) };
    inline GetJavaStartUpConfigResponseBody& setJavaStartUpConfig(const GetJavaStartUpConfigResponseBodyJavaStartUpConfig & javaStartUpConfig) { DARABONBA_PTR_SET_VALUE(javaStartUpConfig_, javaStartUpConfig) };
    inline GetJavaStartUpConfigResponseBody& setJavaStartUpConfig(GetJavaStartUpConfigResponseBodyJavaStartUpConfig && javaStartUpConfig) { DARABONBA_PTR_SET_RVALUE(javaStartUpConfig_, javaStartUpConfig) };
  ...
  protected:
    ...
    std::shared_ptr<GetJavaStartUpConfigResponseBodyJavaStartUpConfig> javaStartUpConfig_ = nullptr;
