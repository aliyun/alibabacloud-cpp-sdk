...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->jvmConfiguration_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const GetJvmConfigurationResponseBodyJvmConfiguration & jvmConfiguration() const { DARABONBA_PTR_GET_CONST(jvmConfiguration_, GetJvmConfigurationResponseBodyJvmConfiguration) };
    inline GetJvmConfigurationResponseBodyJvmConfiguration jvmConfiguration() { DARABONBA_PTR_GET(jvmConfiguration_, GetJvmConfigurationResponseBodyJvmConfiguration) };
    inline GetJvmConfigurationResponseBody& setJvmConfiguration(const GetJvmConfigurationResponseBodyJvmConfiguration & jvmConfiguration) { DARABONBA_PTR_SET_VALUE(jvmConfiguration_, jvmConfiguration) };
    inline GetJvmConfigurationResponseBody& setJvmConfiguration(GetJvmConfigurationResponseBodyJvmConfiguration && jvmConfiguration) { DARABONBA_PTR_SET_RVALUE(jvmConfiguration_, jvmConfiguration) };
  ...
  protected:
    ...
    std::shared_ptr<GetJvmConfigurationResponseBodyJvmConfiguration> jvmConfiguration_ = nullptr;
