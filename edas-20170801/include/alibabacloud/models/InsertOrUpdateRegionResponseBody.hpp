...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->userDefineRegionEntity_ == nullptr; };
    ...
    inline const InsertOrUpdateRegionResponseBodyUserDefineRegionEntity & userDefineRegionEntity() const { DARABONBA_PTR_GET_CONST(userDefineRegionEntity_, InsertOrUpdateRegionResponseBodyUserDefineRegionEntity) };
    inline InsertOrUpdateRegionResponseBodyUserDefineRegionEntity userDefineRegionEntity() { DARABONBA_PTR_GET(userDefineRegionEntity_, InsertOrUpdateRegionResponseBodyUserDefineRegionEntity) };
    inline InsertOrUpdateRegionResponseBody& setUserDefineRegionEntity(const InsertOrUpdateRegionResponseBodyUserDefineRegionEntity & userDefineRegionEntity) { DARABONBA_PTR_SET_VALUE(userDefineRegionEntity_, userDefineRegionEntity) };
    inline InsertOrUpdateRegionResponseBody& setUserDefineRegionEntity(InsertOrUpdateRegionResponseBodyUserDefineRegionEntity && userDefineRegionEntity) { DARABONBA_PTR_SET_RVALUE(userDefineRegionEntity_, userDefineRegionEntity) };
  ...
  protected:
    ...
    std::shared_ptr<InsertOrUpdateRegionResponseBodyUserDefineRegionEntity> userDefineRegionEntity_ = nullptr;
  };
