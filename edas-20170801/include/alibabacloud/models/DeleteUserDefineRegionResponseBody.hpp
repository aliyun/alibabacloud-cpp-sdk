...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->message_ == nullptr && return this->regionDefine_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const DeleteUserDefineRegionResponseBodyRegionDefine & regionDefine() const { DARABONBA_PTR_GET_CONST(regionDefine_, DeleteUserDefineRegionResponseBodyRegionDefine) };
    inline DeleteUserDefineRegionResponseBodyRegionDefine regionDefine() { DARABONBA_PTR_GET(regionDefine_, DeleteUserDefineRegionResponseBodyRegionDefine) };
    inline DeleteUserDefineRegionResponseBody& setRegionDefine(const DeleteUserDefineRegionResponseBodyRegionDefine & regionDefine) { DARABONBA_PTR_SET_VALUE(regionDefine_, regionDefine) };
    inline DeleteUserDefineRegionResponseBody& setRegionDefine(DeleteUserDefineRegionResponseBodyRegionDefine && regionDefine) { DARABONBA_PTR_SET_RVALUE(regionDefine_, regionDefine) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteUserDefineRegionResponseBodyRegionDefine> regionDefine_ = nullptr;
