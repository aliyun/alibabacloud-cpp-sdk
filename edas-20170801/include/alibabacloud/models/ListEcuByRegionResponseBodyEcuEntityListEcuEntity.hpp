...
#ifndef ALIBABACLOUD_MODELS_LISTECUBYREGIONRESPONSEBODYECUENTITYLISTECUENTITY_HPP_
#define ALIBABACLOUD_MODELS_LISTECUBYREGIONRESPONSEBODYECUENTITYLISTECUENTITY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListEcuByRegionResponseBodyEcuEntityListEcuEntity& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListEcuByRegionResponseBodyEcuEntityListEcuEntity& obj) { 
    ...
    ListEcuByRegionResponseBodyEcuEntityListEcuEntity() = default ;
    ListEcuByRegionResponseBodyEcuEntityListEcuEntity(const ListEcuByRegionResponseBodyEcuEntityListEcuEntity &) = default ;
    ListEcuByRegionResponseBodyEcuEntityListEcuEntity(ListEcuByRegionResponseBodyEcuEntityListEcuEntity &&) = default ;
    ListEcuByRegionResponseBodyEcuEntityListEcuEntity(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListEcuByRegionResponseBodyEcuEntityListEcuEntity() = default ;
    ListEcuByRegionResponseBodyEcuEntityListEcuEntity& operator=(const ListEcuByRegionResponseBodyEcuEntityListEcuEntity &) = default ;
    ListEcuByRegionResponseBodyEcuEntityListEcuEntity& operator=(ListEcuByRegionResponseBodyEcuEntityListEcuEntity &&) = default ;
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setAvailableCpu(int32_t availableCpu) { DARABONBA_PTR_SET_VALUE(availableCpu_, availableCpu) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setAvailableMem(int32_t availableMem) { DARABONBA_PTR_SET_VALUE(availableMem_, availableMem) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setCpu(int32_t cpu) { DARABONBA_PTR_SET_VALUE(cpu_, cpu) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setDockerEnv(bool dockerEnv) { DARABONBA_PTR_SET_VALUE(dockerEnv_, dockerEnv) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setEcuId(string ecuId) { DARABONBA_PTR_SET_VALUE(ecuId_, ecuId) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setHeartbeatTime(int64_t heartbeatTime) { DARABONBA_PTR_SET_VALUE(heartbeatTime_, heartbeatTime) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setIpAddr(string ipAddr) { DARABONBA_PTR_SET_VALUE(ipAddr_, ipAddr) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setMem(int32_t mem) { DARABONBA_PTR_SET_VALUE(mem_, mem) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setOnline(bool online) { DARABONBA_PTR_SET_VALUE(online_, online) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setUpdateTime(int64_t updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setUserId(string userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
    ...
    inline ListEcuByRegionResponseBodyEcuEntityListEcuEntity& setZoneId(string zoneId) { DARABONBA_PTR_SET_VALUE(zoneId_, zoneId) };
