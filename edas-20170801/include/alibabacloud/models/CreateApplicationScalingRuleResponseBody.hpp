...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApplicationScalingRuleResponseBodyAppScalingRule & appScalingRule() const { DARABONBA_PTR_GET_CONST(appScalingRule_, CreateApplicationScalingRuleResponseBodyAppScalingRule) };
    inline CreateApplicationScalingRuleResponseBodyAppScalingRule appScalingRule() { DARABONBA_PTR_GET(appScalingRule_, CreateApplicationScalingRuleResponseBodyAppScalingRule) };
    inline CreateApplicationScalingRuleResponseBody& setAppScalingRule(const CreateApplicationScalingRuleResponseBodyAppScalingRule & appScalingRule) { DARABONBA_PTR_SET_VALUE(appScalingRule_, appScalingRule) };
    inline CreateApplicationScalingRuleResponseBody& setAppScalingRule(CreateApplicationScalingRuleResponseBodyAppScalingRule && appScalingRule) { DARABONBA_PTR_SET_RVALUE(appScalingRule_, appScalingRule) };
    ...
    inline CreateApplicationScalingRuleResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
  ...
  protected:
    ...
    std::shared_ptr<CreateApplicationScalingRuleResponseBodyAppScalingRule> appScalingRule_ = nullptr;
