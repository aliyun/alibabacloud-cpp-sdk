...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->ecsEntityList_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const ListEcsNotInClusterResponseBodyEcsEntityList & ecsEntityList() const { DARABONBA_PTR_GET_CONST(ecsEntityList_, ListEcsNotInClusterResponseBodyEcsEntityList) };
    inline ListEcsNotInClusterResponseBodyEcsEntityList ecsEntityList() { DARABONBA_PTR_GET(ecsEntityList_, ListEcsNotInClusterResponseBodyEcsEntityList) };
    inline ListEcsNotInClusterResponseBody& setEcsEntityList(const ListEcsNotInClusterResponseBodyEcsEntityList & ecsEntityList) { DARABONBA_PTR_SET_VALUE(ecsEntityList_, ecsEntityList) };
    inline ListEcsNotInClusterResponseBody& setEcsEntityList(ListEcsNotInClusterResponseBodyEcsEntityList && ecsEntityList) { DARABONBA_PTR_SET_RVALUE(ecsEntityList_, ecsEntityList) };
  ...
  protected:
    ...
    std::shared_ptr<ListEcsNotInClusterResponseBodyEcsEntityList> ecsEntityList_ = nullptr;
