...
namespace Models
{
  ...
  public:
    ...
    inline const GetK8sClusterResponseBodyClusterPage & clusterPage() const { DARABONBA_PTR_GET_CONST(clusterPage_, GetK8sClusterResponseBodyClusterPage) };
    inline GetK8sClusterResponseBodyClusterPage clusterPage() { DARABONBA_PTR_GET(clusterPage_, GetK8sClusterResponseBodyClusterPage) };
    inline GetK8sClusterResponseBody& setClusterPage(const GetK8sClusterResponseBodyClusterPage & clusterPage) { DARABONBA_PTR_SET_VALUE(clusterPage_, clusterPage) };
    inline GetK8sClusterResponseBody& setClusterPage(GetK8sClusterResponseBodyClusterPage && clusterPage) { DARABONBA_PTR_SET_RVALUE(clusterPage_, clusterPage) };
  ...
  protected:
    ...
    std::shared_ptr<GetK8sClusterResponseBodyClusterPage> clusterPage_ = nullptr;
