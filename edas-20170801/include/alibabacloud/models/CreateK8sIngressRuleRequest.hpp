...
#ifndef ALIBABACLOUD_MODELS_CREATEK8SINGRESSRULEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEK8SINGRESSRULEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateK8sIngressRuleRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateK8sIngressRuleRequest& obj) { 
    ...
    CreateK8sIngressRuleRequest() = default ;
    CreateK8sIngressRuleRequest(const CreateK8sIngressRuleRequest &) = default ;
    CreateK8sIngressRuleRequest(CreateK8sIngressRuleRequest &&) = default ;
    CreateK8sIngressRuleRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateK8sIngressRuleRequest() = default ;
    CreateK8sIngressRuleRequest& operator=(const CreateK8sIngressRuleRequest &) = default ;
    CreateK8sIngressRuleRequest& operator=(CreateK8sIngressRuleRequest &&) = default ;
