...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLocalitySettingResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeLocalitySettingResponseBodyData) };
    inline DescribeLocalitySettingResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeLocalitySettingResponseBodyData) };
    inline DescribeLocalitySettingResponseBody& setData(const DescribeLocalitySettingResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeLocalitySettingResponseBody& setData(DescribeLocalitySettingResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLocalitySettingResponseBodyData> data_ = nullptr;
