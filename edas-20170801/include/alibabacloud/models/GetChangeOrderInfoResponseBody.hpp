...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->changeOrderInfo_ == nullptr; };
    ...
    inline const GetChangeOrderInfoResponseBodyChangeOrderInfo & changeOrderInfo() const { DARABONBA_PTR_GET_CONST(changeOrderInfo_, GetChangeOrderInfoResponseBodyChangeOrderInfo) };
    inline GetChangeOrderInfoResponseBodyChangeOrderInfo changeOrderInfo() { DARABONBA_PTR_GET(changeOrderInfo_, GetChangeOrderInfoResponseBodyChangeOrderInfo) };
    inline GetChangeOrderInfoResponseBody& setChangeOrderInfo(const GetChangeOrderInfoResponseBodyChangeOrderInfo & changeOrderInfo) { DARABONBA_PTR_SET_VALUE(changeOrderInfo_, changeOrderInfo) };
    inline GetChangeOrderInfoResponseBody& setChangeOrderInfo(GetChangeOrderInfoResponseBodyChangeOrderInfo && changeOrderInfo) { DARABONBA_PTR_SET_RVALUE(changeOrderInfo_, changeOrderInfo) };
  ...
  protected:
    ...
    std::shared_ptr<GetChangeOrderInfoResponseBodyChangeOrderInfo> changeOrderInfo_ = nullptr;
  };
