...
namespace Models
{
  ...
  public:
    ...
    inline const InsertClusterResponseBodyCluster & cluster() const { DARABONBA_PTR_GET_CONST(cluster_, InsertClusterResponseBodyCluster) };
    inline InsertClusterResponseBodyCluster cluster() { DARABONBA_PTR_GET(cluster_, InsertClusterResponseBodyCluster) };
    inline InsertClusterResponseBody& setCluster(const InsertClusterResponseBodyCluster & cluster) { DARABONBA_PTR_SET_VALUE(cluster_, cluster) };
    inline InsertClusterResponseBody& setCluster(InsertClusterResponseBodyCluster && cluster) { DARABONBA_PTR_SET_RVALUE(cluster_, cluster) };
  ...
  protected:
    ...
    std::shared_ptr<InsertClusterResponseBodyCluster> cluster_ = nullptr;
