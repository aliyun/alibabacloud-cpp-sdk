...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSwimmingLaneGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, UpdateSwimmingLaneGroupResponseBodyData) };
    inline UpdateSwimmingLaneGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, UpdateSwimmingLaneGroupResponseBodyData) };
    inline UpdateSwimmingLaneGroupResponseBody& setData(const UpdateSwimmingLaneGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline UpdateSwimmingLaneGroupResponseBody& setData(UpdateSwimmingLaneGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateSwimmingLaneGroupResponseBodyData> data_ = nullptr;
