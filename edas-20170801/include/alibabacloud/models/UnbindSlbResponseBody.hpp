...
namespace Models
{
  ...
  public:
    ...
    inline UnbindSlbResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UnbindSlbResponseBody& setData(string data) { DARABONBA_PTR_SET_VALUE(data_, data) };
