...
namespace Models
{
  ...
  public:
    ...
    inline const GetK8sApplicationResponseBodyApplcation & applcation() const { DARABONBA_PTR_GET_CONST(applcation_, GetK8sApplicationResponseBodyApplcation) };
    inline GetK8sApplicationResponseBodyApplcation applcation() { DARABONBA_PTR_GET(applcation_, GetK8sApplicationResponseBodyApplcation) };
    inline GetK8sApplicationResponseBody& setApplcation(const GetK8sApplicationResponseBodyApplcation & applcation) { DARABONBA_PTR_SET_VALUE(applcation_, applcation) };
    inline GetK8sApplicationResponseBody& setApplcation(GetK8sApplicationResponseBodyApplcation && applcation) { DARABONBA_PTR_SET_RVALUE(applcation_, applcation) };
  ...
  protected:
    ...
    std::shared_ptr<GetK8sApplicationResponseBodyApplcation> applcation_ = nullptr;
