...
namespace Models
{
  ...
  public:
    ...
    inline const GetK8sAppPrecheckResultResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetK8sAppPrecheckResultResponseBodyData) };
    inline GetK8sAppPrecheckResultResponseBodyData data() { DARABONBA_PTR_GET(data_, GetK8sAppPrecheckResultResponseBodyData) };
    inline GetK8sAppPrecheckResultResponseBody& setData(const GetK8sAppPrecheckResultResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetK8sAppPrecheckResultResponseBody& setData(GetK8sAppPrecheckResultResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetK8sAppPrecheckResultResponseBodyData> data_ = nullptr;
