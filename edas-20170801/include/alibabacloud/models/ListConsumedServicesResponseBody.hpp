...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->consumedServicesList_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const ListConsumedServicesResponseBodyConsumedServicesList & consumedServicesList() const { DARABONBA_PTR_GET_CONST(consumedServicesList_, ListConsumedServicesResponseBodyConsumedServicesList) };
    inline ListConsumedServicesResponseBodyConsumedServicesList consumedServicesList() { DARABONBA_PTR_GET(consumedServicesList_, ListConsumedServicesResponseBodyConsumedServicesList) };
    inline ListConsumedServicesResponseBody& setConsumedServicesList(const ListConsumedServicesResponseBodyConsumedServicesList & consumedServicesList) { DARABONBA_PTR_SET_VALUE(consumedServicesList_, consumedServicesList) };
    inline ListConsumedServicesResponseBody& setConsumedServicesList(ListConsumedServicesResponseBodyConsumedServicesList && consumedServicesList) { DARABONBA_PTR_SET_RVALUE(consumedServicesList_, consumedServicesList) };
  ...
  protected:
    ...
    std::shared_ptr<ListConsumedServicesResponseBodyConsumedServicesList> consumedServicesList_ = nullptr;
