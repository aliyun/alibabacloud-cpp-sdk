...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMigrateEcuListResponseBodyEcuEntityList & ecuEntityList() const { DARABONBA_PTR_GET_CONST(ecuEntityList_, QueryMigrateEcuListResponseBodyEcuEntityList) };
    inline QueryMigrateEcuListResponseBodyEcuEntityList ecuEntityList() { DARABONBA_PTR_GET(ecuEntityList_, QueryMigrateEcuListResponseBodyEcuEntityList) };
    inline QueryMigrateEcuListResponseBody& setEcuEntityList(const QueryMigrateEcuListResponseBodyEcuEntityList & ecuEntityList) { DARABONBA_PTR_SET_VALUE(ecuEntityList_, ecuEntityList) };
    inline QueryMigrateEcuListResponseBody& setEcuEntityList(QueryMigrateEcuListResponseBodyEcuEntityList && ecuEntityList) { DARABONBA_PTR_SET_RVALUE(ecuEntityList_, ecuEntityList) };
  ...
  protected:
    ...
    std::shared_ptr<QueryMigrateEcuListResponseBodyEcuEntityList> ecuEntityList_ = nullptr;
