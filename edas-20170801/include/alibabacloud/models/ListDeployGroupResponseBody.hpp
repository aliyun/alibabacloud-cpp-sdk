...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->deployGroupList_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const ListDeployGroupResponseBodyDeployGroupList & deployGroupList() const { DARABONBA_PTR_GET_CONST(deployGroupList_, ListDeployGroupResponseBodyDeployGroupList) };
    inline ListDeployGroupResponseBodyDeployGroupList deployGroupList() { DARABONBA_PTR_GET(deployGroupList_, ListDeployGroupResponseBodyDeployGroupList) };
    inline ListDeployGroupResponseBody& setDeployGroupList(const ListDeployGroupResponseBodyDeployGroupList & deployGroupList) { DARABONBA_PTR_SET_VALUE(deployGroupList_, deployGroupList) };
    inline ListDeployGroupResponseBody& setDeployGroupList(ListDeployGroupResponseBodyDeployGroupList && deployGroupList) { DARABONBA_PTR_SET_RVALUE(deployGroupList_, deployGroupList) };
  ...
  protected:
    ...
    std::shared_ptr<ListDeployGroupResponseBodyDeployGroupList> deployGroupList_ = nullptr;
