...
namespace Models
{
  ...
  public:
    ...
    inline const InsertApplicationResponseBodyApplicationInfo & applicationInfo() const { DARABONBA_PTR_GET_CONST(applicationInfo_, InsertApplicationResponseBodyApplicationInfo) };
    inline InsertApplicationResponseBodyApplicationInfo applicationInfo() { DARABONBA_PTR_GET(applicationInfo_, InsertApplicationResponseBodyApplicationInfo) };
    inline InsertApplicationResponseBody& setApplicationInfo(const InsertApplicationResponseBodyApplicationInfo & applicationInfo) { DARABONBA_PTR_SET_VALUE(applicationInfo_, applicationInfo) };
    inline InsertApplicationResponseBody& setApplicationInfo(InsertApplicationResponseBodyApplicationInfo && applicationInfo) { DARABONBA_PTR_SET_RVALUE(applicationInfo_, applicationInfo) };
  ...
  protected:
    ...
    std::shared_ptr<InsertApplicationResponseBodyApplicationInfo> applicationInfo_ = nullptr;
