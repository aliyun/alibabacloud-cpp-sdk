...
namespace Models
{
  ...
  public:
    ...
    inline const GetServiceProvidersPageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetServiceProvidersPageResponseBodyData) };
    inline GetServiceProvidersPageResponseBodyData data() { DARABONBA_PTR_GET(data_, GetServiceProvidersPageResponseBodyData) };
    inline GetServiceProvidersPageResponseBody& setData(const GetServiceProvidersPageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetServiceProvidersPageResponseBody& setData(GetServiceProvidersPageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The data structure.
    std::shared_ptr<GetServiceProvidersPageResponseBodyData> data_ = nullptr;
