...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->result_ == nullptr && return this->totalSize_ == nullptr; };
    ...
    inline const vector<QuerySlsLogStoreListResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<QuerySlsLogStoreListResponseBodyResult>) };
    inline vector<QuerySlsLogStoreListResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<QuerySlsLogStoreListResponseBodyResult>) };
    inline QuerySlsLogStoreListResponseBody& setResult(const vector<QuerySlsLogStoreListResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline QuerySlsLogStoreListResponseBody& setResult(vector<QuerySlsLogStoreListResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<QuerySlsLogStoreListResponseBodyResult>> result_ = nullptr;
