...
#ifndef ALIBABACLOUD_MODELS_ADDLOGPATHREQUEST_HPP_
#define ALIBABACLOUD_MODELS_ADDLOGPATHREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AddLogPathRequest& obj) { 
      DARABONBA_PTR_TO_JSON(AppId, appId_);
      DARABONBA_PTR_TO_JSON(Path, path_);
    };
    friend void from_json(const Darabonba::Json& j, AddLogPathRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(AppId, appId_);
      DARABONBA_PTR_FROM_JSON(Path, path_);
    };
    AddLogPathRequest() = default ;
    AddLogPathRequest(const AddLogPathRequest &) = default ;
    AddLogPathRequest(AddLogPathRequest &&) = default ;
    AddLogPathRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AddLogPathRequest() = default ;
    AddLogPathRequest& operator=(const AddLogPathRequest &) = default ;
    AddLogPathRequest& operator=(AddLogPathRequest &&) = default ;
