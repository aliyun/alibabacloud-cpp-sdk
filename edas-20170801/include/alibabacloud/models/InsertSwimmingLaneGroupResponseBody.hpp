...
namespace Models
{
  ...
  public:
    ...
    inline const InsertSwimmingLaneGroupResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, InsertSwimmingLaneGroupResponseBodyData) };
    inline InsertSwimmingLaneGroupResponseBodyData data() { DARABONBA_PTR_GET(data_, InsertSwimmingLaneGroupResponseBodyData) };
    inline InsertSwimmingLaneGroupResponseBody& setData(const InsertSwimmingLaneGroupResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline InsertSwimmingLaneGroupResponseBody& setData(InsertSwimmingLaneGroupResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<InsertSwimmingLaneGroupResponseBodyData> data_ = nullptr;
