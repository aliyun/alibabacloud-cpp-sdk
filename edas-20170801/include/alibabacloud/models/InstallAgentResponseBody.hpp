...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->executionResultList_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const InstallAgentResponseBodyExecutionResultList & executionResultList() const { DARABONBA_PTR_GET_CONST(executionResultList_, InstallAgentResponseBodyExecutionResultList) };
    inline InstallAgentResponseBodyExecutionResultList executionResultList() { DARABONBA_PTR_GET(executionResultList_, InstallAgentResponseBodyExecutionResultList) };
    inline InstallAgentResponseBody& setExecutionResultList(const InstallAgentResponseBodyExecutionResultList & executionResultList) { DARABONBA_PTR_SET_VALUE(executionResultList_, executionResultList) };
    inline InstallAgentResponseBody& setExecutionResultList(InstallAgentResponseBodyExecutionResultList && executionResultList) { DARABONBA_PTR_SET_RVALUE(executionResultList_, executionResultList) };
  ...
  protected:
    ...
    std::shared_ptr<InstallAgentResponseBodyExecutionResultList> executionResultList_ = nullptr;
