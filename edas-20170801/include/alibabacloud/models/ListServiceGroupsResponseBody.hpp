...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->serviceGroupsList_ == nullptr; };
    ...
    inline const ListServiceGroupsResponseBodyServiceGroupsList & serviceGroupsList() const { DARABONBA_PTR_GET_CONST(serviceGroupsList_, ListServiceGroupsResponseBodyServiceGroupsList) };
    inline ListServiceGroupsResponseBodyServiceGroupsList serviceGroupsList() { DARABONBA_PTR_GET(serviceGroupsList_, ListServiceGroupsResponseBodyServiceGroupsList) };
    inline ListServiceGroupsResponseBody& setServiceGroupsList(const ListServiceGroupsResponseBodyServiceGroupsList & serviceGroupsList) { DARABONBA_PTR_SET_VALUE(serviceGroupsList_, serviceGroupsList) };
    inline ListServiceGroupsResponseBody& setServiceGroupsList(ListServiceGroupsResponseBodyServiceGroupsList && serviceGroupsList) { DARABONBA_PTR_SET_RVALUE(serviceGroupsList_, serviceGroupsList) };
  ...
  protected:
    ...
    std::shared_ptr<ListServiceGroupsResponseBodyServiceGroupsList> serviceGroupsList_ = nullptr;
  };
