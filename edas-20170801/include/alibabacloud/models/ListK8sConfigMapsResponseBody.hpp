...
namespace Models
{
  ...
  public:
    ...
    inline const ListK8sConfigMapsResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListK8sConfigMapsResponseBodyResult) };
    inline ListK8sConfigMapsResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListK8sConfigMapsResponseBodyResult) };
    inline ListK8sConfigMapsResponseBody& setResult(const ListK8sConfigMapsResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListK8sConfigMapsResponseBody& setResult(ListK8sConfigMapsResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<ListK8sConfigMapsResponseBodyResult> result_ = nullptr;
  };
