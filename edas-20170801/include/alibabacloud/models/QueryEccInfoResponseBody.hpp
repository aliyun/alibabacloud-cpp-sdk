...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->eccInfo_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr; };
    ...
    inline const QueryEccInfoResponseBodyEccInfo & eccInfo() const { DARABONBA_PTR_GET_CONST(eccInfo_, QueryEccInfoResponseBodyEccInfo) };
    inline QueryEccInfoResponseBodyEccInfo eccInfo() { DARABONBA_PTR_GET(eccInfo_, QueryEccInfoResponseBodyEccInfo) };
    inline QueryEccInfoResponseBody& setEccInfo(const QueryEccInfoResponseBodyEccInfo & eccInfo) { DARABONBA_PTR_SET_VALUE(eccInfo_, eccInfo) };
    inline QueryEccInfoResponseBody& setEccInfo(QueryEccInfoResponseBodyEccInfo && eccInfo) { DARABONBA_PTR_SET_RVALUE(eccInfo_, eccInfo) };
  ...
  protected:
    ...
    std::shared_ptr<QueryEccInfoResponseBodyEccInfo> eccInfo_ = nullptr;
