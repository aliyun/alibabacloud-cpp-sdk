...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->webContainerConfig_ == nullptr; };
    ...
    inline const GetWebContainerConfigResponseBodyWebContainerConfig & webContainerConfig() const { DARABONBA_PTR_GET_CONST(webContainerConfig_, GetWebContainerConfigResponseBodyWebContainerConfig) };
    inline GetWebContainerConfigResponseBodyWebContainerConfig webContainerConfig() { DARABONBA_PTR_GET(webContainerConfig_, GetWebContainerConfigResponseBodyWebContainerConfig) };
    inline GetWebContainerConfigResponseBody& setWebContainerConfig(const GetWebContainerConfigResponseBodyWebContainerConfig & webContainerConfig) { DARABONBA_PTR_SET_VALUE(webContainerConfig_, webContainerConfig) };
    inline GetWebContainerConfigResponseBody& setWebContainerConfig(GetWebContainerConfigResponseBodyWebContainerConfig && webContainerConfig) { DARABONBA_PTR_SET_RVALUE(webContainerConfig_, webContainerConfig) };
  ...
  protected:
    ...
    std::shared_ptr<GetWebContainerConfigResponseBodyWebContainerConfig> webContainerConfig_ = nullptr;
  };
