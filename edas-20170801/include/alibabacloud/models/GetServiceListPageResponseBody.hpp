...
namespace Models
{
  ...
  public:
    ...
    inline const GetServiceListPageResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetServiceListPageResponseBodyData) };
    inline GetServiceListPageResponseBodyData data() { DARABONBA_PTR_GET(data_, GetServiceListPageResponseBodyData) };
    inline GetServiceListPageResponseBody& setData(const GetServiceListPageResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetServiceListPageResponseBody& setData(GetServiceListPageResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<GetServiceListPageResponseBodyData> data_ = nullptr;
