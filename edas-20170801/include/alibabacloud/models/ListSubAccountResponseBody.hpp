...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->subAccountList_ == nullptr; };
    ...
    inline const ListSubAccountResponseBodySubAccountList & subAccountList() const { DARABONBA_PTR_GET_CONST(subAccountList_, ListSubAccountResponseBodySubAccountList) };
    inline ListSubAccountResponseBodySubAccountList subAccountList() { DARABONBA_PTR_GET(subAccountList_, ListSubAccountResponseBodySubAccountList) };
    inline ListSubAccountResponseBody& setSubAccountList(const ListSubAccountResponseBodySubAccountList & subAccountList) { DARABONBA_PTR_SET_VALUE(subAccountList_, subAccountList) };
    inline ListSubAccountResponseBody& setSubAccountList(ListSubAccountResponseBodySubAccountList && subAccountList) { DARABONBA_PTR_SET_RVALUE(subAccountList_, subAccountList) };
  ...
  protected:
    ...
    // The RAM users.
    std::shared_ptr<ListSubAccountResponseBodySubAccountList> subAccountList_ = nullptr;
  };
