...
namespace Models
{
  ...
  public:
    ...
    inline const ListConvertableEcuResponseBodyInstanceList & instanceList() const { DARABONBA_PTR_GET_CONST(instanceList_, ListConvertableEcuResponseBodyInstanceList) };
    inline ListConvertableEcuResponseBodyInstanceList instanceList() { DARABONBA_PTR_GET(instanceList_, ListConvertableEcuResponseBodyInstanceList) };
    inline ListConvertableEcuResponseBody& setInstanceList(const ListConvertableEcuResponseBodyInstanceList & instanceList) { DARABONBA_PTR_SET_VALUE(instanceList_, instanceList) };
    inline ListConvertableEcuResponseBody& setInstanceList(ListConvertableEcuResponseBodyInstanceList && instanceList) { DARABONBA_PTR_SET_RVALUE(instanceList_, instanceList) };
  ...
  protected:
    ...
    std::shared_ptr<ListConvertableEcuResponseBodyInstanceList> instanceList_ = nullptr;
