...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSwimmingLaneResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListSwimmingLaneResponseBodyData>) };
    inline vector<ListSwimmingLaneResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListSwimmingLaneResponseBodyData>) };
    inline ListSwimmingLaneResponseBody& setData(const vector<ListSwimmingLaneResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListSwimmingLaneResponseBody& setData(vector<ListSwimmingLaneResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListSwimmingLaneResponseBodyData>> data_ = nullptr;
