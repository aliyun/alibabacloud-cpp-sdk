...
namespace Models
{
  ...
  public:
    ...
    inline const StartK8sAppPrecheckResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, StartK8sAppPrecheckResponseBodyData) };
    inline StartK8sAppPrecheckResponseBodyData data() { DARABONBA_PTR_GET(data_, StartK8sAppPrecheckResponseBodyData) };
    inline StartK8sAppPrecheckResponseBody& setData(const StartK8sAppPrecheckResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline StartK8sAppPrecheckResponseBody& setData(StartK8sAppPrecheckResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<StartK8sAppPrecheckResponseBodyData> data_ = nullptr;
