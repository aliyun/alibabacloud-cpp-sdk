...
class OpenApiInvokeRequest : public Darabonba::Model {
public:
  ...
  explicit OpenApiInvokeRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~OpenApiInvokeRequest() = default;
};
class OpenApiInvokeResponseBody : public Darabonba::Model {
public:
  shared_ptr<string> code{};
  ...
  OpenApiInvokeResponseBody() {}

  explicit OpenApiInvokeResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  virtual ~OpenApiInvokeResponseBody() = default;
};
class OpenApiInvokeResponse : public Darabonba::Model {
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<OpenApiInvokeResponseBody> body{};

  OpenApiInvokeResponse() {}

  explicit OpenApiInvokeResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        OpenApiInvokeResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<OpenApiInvokeResponseBody>(model1);
      }
    }
  }


  virtual ~OpenApiInvokeResponse() = default;
};
...
public:
  ...
  OpenApiInvokeResponse openApiInvokeWithOptions(shared_ptr<OpenApiInvokeRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  OpenApiInvokeResponse openApiInvoke(shared_ptr<OpenApiInvokeRequest> request);
