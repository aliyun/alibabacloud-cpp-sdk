...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePowerForecastJobResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CreatePowerForecastJobResponseBody) };
    inline CreatePowerForecastJobResponseBody body() { DARABONBA_PTR_GET(body_, CreatePowerForecastJobResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CreatePowerForecastJobResponseBody> body_ = nullptr;
  };
