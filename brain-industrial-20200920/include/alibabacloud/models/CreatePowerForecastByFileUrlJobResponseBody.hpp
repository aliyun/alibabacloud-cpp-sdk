...
#ifndef ALIBABACLOUD_MODELS_CREATEPOWERFORECASTBYFILEURLJOBRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEPOWERFORECASTBYFILEURLJOBRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePowerForecastByFileUrlJobResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePowerForecastByFileUrlJobResponseBody& obj) { 
    ...
    CreatePowerForecastByFileUrlJobResponseBody() = default ;
    CreatePowerForecastByFileUrlJobResponseBody(const CreatePowerForecastByFileUrlJobResponseBody &) = default ;
    CreatePowerForecastByFileUrlJobResponseBody(CreatePowerForecastByFileUrlJobResponseBody &&) = default ;
    CreatePowerForecastByFileUrlJobResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePowerForecastByFileUrlJobResponseBody() = default ;
    CreatePowerForecastByFileUrlJobResponseBody& operator=(const CreatePowerForecastByFileUrlJobResponseBody &) = default ;
    CreatePowerForecastByFileUrlJobResponseBody& operator=(CreatePowerForecastByFileUrlJobResponseBody &&) = default ;
    ...
    inline CreatePowerForecastByFileUrlJobResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreatePowerForecastByFileUrlJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreatePowerForecastByFileUrlJobResponseBody::Data) };
    inline CreatePowerForecastByFileUrlJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreatePowerForecastByFileUrlJobResponseBody::Data) };
    inline CreatePowerForecastByFileUrlJobResponseBody& setData(const CreatePowerForecastByFileUrlJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreatePowerForecastByFileUrlJobResponseBody& setData(CreatePowerForecastByFileUrlJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreatePowerForecastByFileUrlJobResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreatePowerForecastByFileUrlJobResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreatePowerForecastByFileUrlJobResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<CreatePowerForecastByFileUrlJobResponseBody::Data> data_ {};
