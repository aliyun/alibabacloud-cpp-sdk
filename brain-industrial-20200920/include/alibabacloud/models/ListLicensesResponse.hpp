...
namespace Models
{
  ...
  public:
    ...
    inline const ListLicensesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListLicensesResponseBody) };
    inline ListLicensesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListLicensesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListLicensesResponseBody> body_ {};
  };
