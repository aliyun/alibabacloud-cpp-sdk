...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessDeniedDetail_ == nullptr
        && return this->code_ == nullptr && return this->data_ == nullptr && return this->httpStatusCode_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr
    ...
    inline const vector<ListUserResourcesResponseBodyData> & data() const { DARABONBA_PTR_GET_CONST(data_, vector<ListUserResourcesResponseBodyData>) };
    inline vector<ListUserResourcesResponseBodyData> data() { DARABONBA_PTR_GET(data_, vector<ListUserResourcesResponseBodyData>) };
    inline ListUserResourcesResponseBody& setData(const vector<ListUserResourcesResponseBodyData> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ListUserResourcesResponseBody& setData(vector<ListUserResourcesResponseBodyData> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListUserResourcesResponseBodyData>> data_ = nullptr;
