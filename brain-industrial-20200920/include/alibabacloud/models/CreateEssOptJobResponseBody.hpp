...
#ifndef ALIBABACLOUD_MODELS_CREATEESSOPTJOBRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEESSOPTJOBRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateEssOptJobResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateEssOptJobResponseBody& obj) { 
    ...
    CreateEssOptJobResponseBody() = default ;
    CreateEssOptJobResponseBody(const CreateEssOptJobResponseBody &) = default ;
    CreateEssOptJobResponseBody(CreateEssOptJobResponseBody &&) = default ;
    CreateEssOptJobResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateEssOptJobResponseBody() = default ;
    CreateEssOptJobResponseBody& operator=(const CreateEssOptJobResponseBody &) = default ;
    CreateEssOptJobResponseBody& operator=(CreateEssOptJobResponseBody &&) = default ;
    ...
    inline CreateEssOptJobResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateEssOptJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateEssOptJobResponseBody::Data) };
    inline CreateEssOptJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateEssOptJobResponseBody::Data) };
    inline CreateEssOptJobResponseBody& setData(const CreateEssOptJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateEssOptJobResponseBody& setData(CreateEssOptJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateEssOptJobResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateEssOptJobResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateEssOptJobResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<CreateEssOptJobResponseBody::Data> data_ {};
