...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->businessKey_ != nullptr
        && this->deviceType_ != nullptr && this->duration_ != nullptr && this->freq_ != nullptr && this->historyData_ != nullptr && this->location_ != nullptr
        && this->modelVersion_ != nullptr && this->runDate_ != nullptr && this->systemType_ != nullptr && this->timeZone_ != nullptr; };
    ...
    inline const vector<CreatePowerForecastJobRequestHistoryData> & historyData() const { DARABONBA_PTR_GET_CONST(historyData_, vector<CreatePowerForecastJobRequestHistoryData>) };
    inline vector<CreatePowerForecastJobRequestHistoryData> historyData() { DARABONBA_PTR_GET(historyData_, vector<CreatePowerForecastJobRequestHistoryData>) };
    inline CreatePowerForecastJobRequest& setHistoryData(const vector<CreatePowerForecastJobRequestHistoryData> & historyData) { DARABONBA_PTR_SET_VALUE(historyData_, historyData) };
    inline CreatePowerForecastJobRequest& setHistoryData(vector<CreatePowerForecastJobRequestHistoryData> && historyData) { DARABONBA_PTR_SET_RVALUE(historyData_, historyData) };


    // location Field Functions 
    bool hasLocation() const { return this->location_ != nullptr;};
    void deleteLocation() { this->location_ = nullptr;};
    inline const CreatePowerForecastJobRequestLocation & location() const { DARABONBA_PTR_GET_CONST(location_, CreatePowerForecastJobRequestLocation) };
    inline CreatePowerForecastJobRequestLocation location() { DARABONBA_PTR_GET(location_, CreatePowerForecastJobRequestLocation) };
    inline CreatePowerForecastJobRequest& setLocation(const CreatePowerForecastJobRequestLocation & location) { DARABONBA_PTR_SET_VALUE(location_, location) };
    inline CreatePowerForecastJobRequest& setLocation(CreatePowerForecastJobRequestLocation && location) { DARABONBA_PTR_SET_RVALUE(location_, location) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CreatePowerForecastJobRequestHistoryData>> historyData_ = nullptr;
    std::shared_ptr<CreatePowerForecastJobRequestLocation> location_ = nullptr;
