...
#ifndef ALIBABACLOUD_MODELS_CREATELOADFORECASTJOBRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATELOADFORECASTJOBRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateLoadForecastJobResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLoadForecastJobResponseBody& obj) { 
    ...
    CreateLoadForecastJobResponseBody() = default ;
    CreateLoadForecastJobResponseBody(const CreateLoadForecastJobResponseBody &) = default ;
    CreateLoadForecastJobResponseBody(CreateLoadForecastJobResponseBody &&) = default ;
    CreateLoadForecastJobResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLoadForecastJobResponseBody() = default ;
    CreateLoadForecastJobResponseBody& operator=(const CreateLoadForecastJobResponseBody &) = default ;
    CreateLoadForecastJobResponseBody& operator=(CreateLoadForecastJobResponseBody &&) = default ;
    ...
    inline CreateLoadForecastJobResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateLoadForecastJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateLoadForecastJobResponseBody::Data) };
    inline CreateLoadForecastJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateLoadForecastJobResponseBody::Data) };
    inline CreateLoadForecastJobResponseBody& setData(const CreateLoadForecastJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateLoadForecastJobResponseBody& setData(CreateLoadForecastJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateLoadForecastJobResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateLoadForecastJobResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateLoadForecastJobResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<CreateLoadForecastJobResponseBody::Data> data_ {};
