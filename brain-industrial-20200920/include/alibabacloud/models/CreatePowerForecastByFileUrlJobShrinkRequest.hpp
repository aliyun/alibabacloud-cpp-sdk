...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessKey_ == nullptr
        ...
        && return this->historyUrl_ == nullptr && return this->locationShrink_ == nullptr && return this->modelVersion_ == nullptr && return this->runDate_ == nullptr && return this->systemType_ == nullptr
