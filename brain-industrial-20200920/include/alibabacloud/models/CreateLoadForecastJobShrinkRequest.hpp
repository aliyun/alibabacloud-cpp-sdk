...
#ifndef ALIBABACLOUD_MODELS_CREATELOADFORECASTJOBSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATELOADFORECASTJOBSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateLoadForecastJobShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLoadForecastJobShrinkRequest& obj) { 
    ...
    CreateLoadForecastJobShrinkRequest() = default ;
    CreateLoadForecastJobShrinkRequest(const CreateLoadForecastJobShrinkRequest &) = default ;
    CreateLoadForecastJobShrinkRequest(CreateLoadForecastJobShrinkRequest &&) = default ;
    CreateLoadForecastJobShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLoadForecastJobShrinkRequest() = default ;
    CreateLoadForecastJobShrinkRequest& operator=(const CreateLoadForecastJobShrinkRequest &) = default ;
    CreateLoadForecastJobShrinkRequest& operator=(CreateLoadForecastJobShrinkRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { this->businessKey_ != nullptr
        && this->deviceType_ != nullptr && this->duration_ != nullptr && this->freq_ != nullptr && this->historyDataShrink_ != nullptr && this->modelVersion_ != nullptr
