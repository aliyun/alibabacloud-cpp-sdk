...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePowerForecastJobResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, CreatePowerForecastJobResponseBodyData) };
    inline CreatePowerForecastJobResponseBodyData data() { DARABONBA_PTR_GET(data_, CreatePowerForecastJobResponseBodyData) };
    inline CreatePowerForecastJobResponseBody& setData(const CreatePowerForecastJobResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreatePowerForecastJobResponseBody& setData(CreatePowerForecastJobResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<CreatePowerForecastJobResponseBodyData> data_ = nullptr;
