...
namespace Models
{
  ...
  public:
    ...
    inline const GetLicenseResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, GetLicenseResponseBodyData) };
    inline GetLicenseResponseBodyData data() { DARABONBA_PTR_GET(data_, GetLicenseResponseBodyData) };
    inline GetLicenseResponseBody& setData(const GetLicenseResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetLicenseResponseBody& setData(GetLicenseResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<GetLicenseResponseBodyData> data_ = nullptr;
