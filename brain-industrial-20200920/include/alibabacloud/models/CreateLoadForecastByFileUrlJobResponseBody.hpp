...
#ifndef ALIBABACLOUD_MODELS_CREATELOADFORECASTBYFILEURLJOBRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATELOADFORECASTBYFILEURLJOBRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateLoadForecastByFileUrlJobResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateLoadForecastByFileUrlJobResponseBody& obj) { 
    ...
    CreateLoadForecastByFileUrlJobResponseBody() = default ;
    CreateLoadForecastByFileUrlJobResponseBody(const CreateLoadForecastByFileUrlJobResponseBody &) = default ;
    CreateLoadForecastByFileUrlJobResponseBody(CreateLoadForecastByFileUrlJobResponseBody &&) = default ;
    CreateLoadForecastByFileUrlJobResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateLoadForecastByFileUrlJobResponseBody() = default ;
    CreateLoadForecastByFileUrlJobResponseBody& operator=(const CreateLoadForecastByFileUrlJobResponseBody &) = default ;
    CreateLoadForecastByFileUrlJobResponseBody& operator=(CreateLoadForecastByFileUrlJobResponseBody &&) = default ;
    ...
    inline CreateLoadForecastByFileUrlJobResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // data Field Functions 
    bool hasData() const { return this->data_ != nullptr;};
    void deleteData() { this->data_ = nullptr;};
    inline const CreateLoadForecastByFileUrlJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, CreateLoadForecastByFileUrlJobResponseBody::Data) };
    inline CreateLoadForecastByFileUrlJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, CreateLoadForecastByFileUrlJobResponseBody::Data) };
    inline CreateLoadForecastByFileUrlJobResponseBody& setData(const CreateLoadForecastByFileUrlJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline CreateLoadForecastByFileUrlJobResponseBody& setData(CreateLoadForecastByFileUrlJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline CreateLoadForecastByFileUrlJobResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateLoadForecastByFileUrlJobResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline CreateLoadForecastByFileUrlJobResponseBody& setSuccess(string success) { DARABONBA_PTR_SET_VALUE(success_, success) };


  protected:
    shared_ptr<string> code_ {};
    shared_ptr<CreateLoadForecastByFileUrlJobResponseBody::Data> data_ {};
