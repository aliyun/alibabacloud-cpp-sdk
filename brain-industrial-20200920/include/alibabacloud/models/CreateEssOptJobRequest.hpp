...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessKey_ == nullptr
        && return this->duration_ == nullptr && return this->elecPrice_ == nullptr && return this->freq_ == nullptr && return this->genPrice_ == nullptr && return this->location_ == nullptr
        && return this->modelVersion_ == nullptr && return this->runDate_ == nullptr && return this->systemData_ == nullptr && return this->timeZone_ == nullptr && return this->topoType_ == nullptr; };
