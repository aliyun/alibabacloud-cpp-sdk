...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePowerForecastByFileUrlJobResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePowerForecastByFileUrlJobResponseBody) };
    inline CreatePowerForecastByFileUrlJobResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePowerForecastByFileUrlJobResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePowerForecastByFileUrlJobResponseBody> body_ {};
  };
