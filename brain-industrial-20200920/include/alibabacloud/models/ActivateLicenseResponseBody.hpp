...
namespace Models
{
  ...
  public:
    ...
    inline const ActivateLicenseResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, ActivateLicenseResponseBodyData) };
    inline ActivateLicenseResponseBodyData data() { DARABONBA_PTR_GET(data_, ActivateLicenseResponseBodyData) };
    inline ActivateLicenseResponseBody& setData(const ActivateLicenseResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline ActivateLicenseResponseBody& setData(ActivateLicenseResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<ActivateLicenseResponseBodyData> data_ = nullptr;
