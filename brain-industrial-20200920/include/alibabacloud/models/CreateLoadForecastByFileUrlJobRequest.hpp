...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessKey_ == nullptr
        ...
        && return this->historyUrl_ == nullptr && return this->modelVersion_ == nullptr && return this->runDate_ == nullptr && return this->systemType_ == nullptr && return this->timeColumn_ == nullptr
        && return this->timeZone_ == nullptr && return this->valueColumn_ == nullptr; };
    ...
    inline CreateLoadForecastByFileUrlJobRequest& setDataMode(string dataMode) { DARABONBA_PTR_SET_VALUE(dataMode_, dataMode) };
    ...
    inline CreateLoadForecastByFileUrlJobRequest& setForecastHorizon(string forecastHorizon) { DARABONBA_PTR_SET_VALUE(forecastHorizon_, forecastHorizon) };
