...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->businessKey_ == nullptr
        ...
        && this->historyUrl_ == nullptr && this->modelVersion_ == nullptr && this->runDate_ == nullptr && this->systemType_ == nullptr && this->timeColumn_ == nullptr
        && this->timeZone_ == nullptr && this->valueColumn_ == nullptr; };
