...
#ifndef ALIBABACLOUD_MODELS_CREATEPOWERFORECASTJOBREQUESTLOCATION_HPP_
#define ALIBABACLOUD_MODELS_CREATEPOWERFORECASTJOBREQUESTLOCATION_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreatePowerForecastJobRequestLocation& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreatePowerForecastJobRequestLocation& obj) { 
    ...
    CreatePowerForecastJobRequestLocation() = default ;
    CreatePowerForecastJobRequestLocation(const CreatePowerForecastJobRequestLocation &) = default ;
    CreatePowerForecastJobRequestLocation(CreatePowerForecastJobRequestLocation &&) = default ;
    CreatePowerForecastJobRequestLocation(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreatePowerForecastJobRequestLocation() = default ;
    CreatePowerForecastJobRequestLocation& operator=(const CreatePowerForecastJobRequestLocation &) = default ;
    CreatePowerForecastJobRequestLocation& operator=(CreatePowerForecastJobRequestLocation &&) = default ;
    ...
    inline CreatePowerForecastJobRequestLocation& setAltitude(double altitude) { DARABONBA_PTR_SET_VALUE(altitude_, altitude) };
    ...
    inline CreatePowerForecastJobRequestLocation& setLatitude(double latitude) { DARABONBA_PTR_SET_VALUE(latitude_, latitude) };
    ...
    inline CreatePowerForecastJobRequestLocation& setLongitude(double longitude) { DARABONBA_PTR_SET_VALUE(longitude_, longitude) };
