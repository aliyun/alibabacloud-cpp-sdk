...
namespace Models
{
  ...
  public:
    ...
    inline const GetAivppAlgoJobResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, GetAivppAlgoJobResponseBody::Data) };
    inline GetAivppAlgoJobResponseBody::Data getData() { DARABONBA_PTR_GET(data_, GetAivppAlgoJobResponseBody::Data) };
    inline GetAivppAlgoJobResponseBody& setData(const GetAivppAlgoJobResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline GetAivppAlgoJobResponseBody& setData(GetAivppAlgoJobResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<GetAivppAlgoJobResponseBody::Data> data_ {};
