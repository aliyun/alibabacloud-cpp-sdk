...
namespace Models
{
  ...
  public:
    ...
    inline const GetOwnRequestLogResponseBody::LogInfo & getLogInfo() const { DARABONBA_PTR_GET_CONST(logInfo_, GetOwnRequestLogResponseBody::LogInfo) };
    inline GetOwnRequestLogResponseBody::LogInfo getLogInfo() { DARABONBA_PTR_GET(logInfo_, GetOwnRequestLogResponseBody::LogInfo) };
    inline GetOwnRequestLogResponseBody& setLogInfo(const GetOwnRequestLogResponseBody::LogInfo & logInfo) { DARABONBA_PTR_SET_VALUE(logInfo_, logInfo) };
    inline GetOwnRequestLogResponseBody& setLogInfo(GetOwnRequestLogResponseBody::LogInfo && logInfo) { DARABONBA_PTR_SET_RVALUE(logInfo_, logInfo) };
  ...
  protected:
    ...
    shared_ptr<GetOwnRequestLogResponseBody::LogInfo> logInfo_ {};
