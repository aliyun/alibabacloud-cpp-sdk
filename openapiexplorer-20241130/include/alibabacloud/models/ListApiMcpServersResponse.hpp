...
namespace Models
{
  ...
  public:
    ...
    inline const ListApiMcpServersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApiMcpServersResponseBody) };
    inline ListApiMcpServersResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApiMcpServersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApiMcpServersResponseBody> body_ {};
  };
