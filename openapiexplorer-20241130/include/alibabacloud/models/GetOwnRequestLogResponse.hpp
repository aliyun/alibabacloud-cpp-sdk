...
namespace Models
{
  ...
  public:
    ...
    inline const GetOwnRequestLogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetOwnRequestLogResponseBody) };
    inline GetOwnRequestLogResponseBody getBody() { DARABONBA_PTR_GET(body_, GetOwnRequestLogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetOwnRequestLogResponseBody> body_ {};
  };
