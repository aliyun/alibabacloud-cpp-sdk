...
namespace Models
{
  ...
  public:
    ...
    inline const CreateApiMcpServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateApiMcpServerResponseBody) };
    inline CreateApiMcpServerResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateApiMcpServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateApiMcpServerResponseBody> body_ {};
  };
