...
namespace Models
{
  ...
  public:
    ...
    class ApiMcpServers : public Darabonba::Model {
    public:
      friend void to_json(Darabonba::Json& j, const ApiMcpServers& obj) { 
      ...
      friend void from_json(const Darabonba::Json& j, ApiMcpServers& obj) { 
      ...
      ApiMcpServers() = default ;
      ApiMcpServers(const ApiMcpServers &) = default ;
      ApiMcpServers(ApiMcpServers &&) = default ;
      ApiMcpServers(const Darabonba::Json & obj) { from_json(obj, *this); };
      virtual ~ApiMcpServers() = default ;
      ApiMcpServers& operator=(const ApiMcpServers &) = default ;
      ApiMcpServers& operator=(ApiMcpServers &&) = default ;
      virtual void validate() const override {
      };
      virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
      virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
      ...
      virtual bool empty() const override { return this->additionalApiDescriptions_ == nullptr
        && this->apis_ == nullptr && this->assumeRoleExtraPolicy_ == nullptr && this->assumeRoleName_ == nullptr && this->createTime_ == nullptr && this->description_ == nullptr
        && this->enableAssumeRole_ == nullptr && this->enableCustomVpcWhitelist_ == nullptr && this->id_ == nullptr && this->instructions_ == nullptr && this->language_ == nullptr
        && this->name_ == nullptr && this->oauthClientId_ == nullptr && this->prompts_ == nullptr && this->publicAccess_ == nullptr && this->sourceType_ == nullptr
        && this->systemMcpServerInfo_ == nullptr && this->systemTools_ == nullptr && this->terraformTools_ == nullptr && this->updateTime_ == nullptr && this->urls_ == nullptr
      ...
      inline const vector<ApiMcpServers::AdditionalApiDescriptions> & getAdditionalApiDescriptions() const { DARABONBA_PTR_GET_CONST(additionalApiDescriptions_, vector<ApiMcpServers::AdditionalApiDescriptions>) };
      inline vector<ApiMcpServers::AdditionalApiDescriptions> getAdditionalApiDescriptions() { DARABONBA_PTR_GET(additionalApiDescriptions_, vector<ApiMcpServers::AdditionalApiDescriptions>) };
      inline ApiMcpServers& setAdditionalApiDescriptions(const vector<ApiMcpServers::AdditionalApiDescriptions> & additionalApiDescriptions) { DARABONBA_PTR_SET_VALUE(additionalApiDescriptions_, additionalApiDescriptions) };
      inline ApiMcpServers& setAdditionalApiDescriptions(vector<ApiMcpServers::AdditionalApiDescriptions> && additionalApiDescriptions) { DARABONBA_PTR_SET_RVALUE(additionalApiDescriptions_, additionalApiDescriptions) };


      // apis Field Functions 
      bool hasApis() const { return this->apis_ != nullptr;};
      void deleteApis() { this->apis_ = nullptr;};
      inline const vector<ApiMcpServers::Apis> & getApis() const { DARABONBA_PTR_GET_CONST(apis_, vector<ApiMcpServers::Apis>) };
      inline vector<ApiMcpServers::Apis> getApis() { DARABONBA_PTR_GET(apis_, vector<ApiMcpServers::Apis>) };
      inline ApiMcpServers& setApis(const vector<ApiMcpServers::Apis> & apis) { DARABONBA_PTR_SET_VALUE(apis_, apis) };
      inline ApiMcpServers& setApis(vector<ApiMcpServers::Apis> && apis) { DARABONBA_PTR_SET_RVALUE(apis_, apis) };
      ...
      inline ApiMcpServers& setAssumeRoleExtraPolicy(string assumeRoleExtraPolicy) { DARABONBA_PTR_SET_VALUE(assumeRoleExtraPolicy_, assumeRoleExtraPolicy) };
      ...
      inline ApiMcpServers& setAssumeRoleName(string assumeRoleName) { DARABONBA_PTR_SET_VALUE(assumeRoleName_, assumeRoleName) };
      ...
      inline ApiMcpServers& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
      ...
      void deleteDescription() { this->description_ = nullptr;};
      inline string getDescription() const { DARABONBA_PTR_GET_DEFAULT(description_, "") };
      inline ApiMcpServers& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
      ...
      inline ApiMcpServers& setEnableAssumeRole(bool enableAssumeRole) { DARABONBA_PTR_SET_VALUE(enableAssumeRole_, enableAssumeRole) };
      ...
      inline ApiMcpServers& setEnableCustomVpcWhitelist(bool enableCustomVpcWhitelist) { DARABONBA_PTR_SET_VALUE(enableCustomVpcWhitelist_, enableCustomVpcWhitelist) };
      ...
      inline ApiMcpServers& setId(string id) { DARABONBA_PTR_SET_VALUE(id_, id) };
      ...
      inline ApiMcpServers& setInstructions(string instructions) { DARABONBA_PTR_SET_VALUE(instructions_, instructions) };
      ...
      inline ApiMcpServers& setLanguage(string language) { DARABONBA_PTR_SET_VALUE(language_, language) };
      ...
      void deleteName() { this->name_ = nullptr;};
      inline string getName() const { DARABONBA_PTR_GET_DEFAULT(name_, "") };
      inline ApiMcpServers& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
      ...
      inline ApiMcpServers& setOauthClientId(string oauthClientId) { DARABONBA_PTR_SET_VALUE(oauthClientId_, oauthClientId) };


      // prompts Field Functions 
      bool hasPrompts() const { return this->prompts_ != nullptr;};
      void deletePrompts() { this->prompts_ = nullptr;};
      inline const vector<ApiMcpServers::Prompts> & getPrompts() const { DARABONBA_PTR_GET_CONST(prompts_, vector<ApiMcpServers::Prompts>) };
      inline vector<ApiMcpServers::Prompts> getPrompts() { DARABONBA_PTR_GET(prompts_, vector<ApiMcpServers::Prompts>) };
      inline ApiMcpServers& setPrompts(const vector<ApiMcpServers::Prompts> & prompts) { DARABONBA_PTR_SET_VALUE(prompts_, prompts) };
      inline ApiMcpServers& setPrompts(vector<ApiMcpServers::Prompts> && prompts) { DARABONBA_PTR_SET_RVALUE(prompts_, prompts) };
      ...
      inline ApiMcpServers& setPublicAccess(string publicAccess) { DARABONBA_PTR_SET_VALUE(publicAccess_, publicAccess) };
      ...
      inline ApiMcpServers& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
      ...
      inline const ApiMcpServers::SystemMcpServerInfo & getSystemMcpServerInfo() const { DARABONBA_PTR_GET_CONST(systemMcpServerInfo_, ApiMcpServers::SystemMcpServerInfo) };
      inline ApiMcpServers::SystemMcpServerInfo getSystemMcpServerInfo() { DARABONBA_PTR_GET(systemMcpServerInfo_, ApiMcpServers::SystemMcpServerInfo) };
      inline ApiMcpServers& setSystemMcpServerInfo(const ApiMcpServers::SystemMcpServerInfo & systemMcpServerInfo) { DARABONBA_PTR_SET_VALUE(systemMcpServerInfo_, systemMcpServerInfo) };
      inline ApiMcpServers& setSystemMcpServerInfo(ApiMcpServers::SystemMcpServerInfo && systemMcpServerInfo) { DARABONBA_PTR_SET_RVALUE(systemMcpServerInfo_, systemMcpServerInfo) };
      ...
      inline ApiMcpServers& setSystemTools(const vector<string> & systemTools) { DARABONBA_PTR_SET_VALUE(systemTools_, systemTools) };
      inline ApiMcpServers& setSystemTools(vector<string> && systemTools) { DARABONBA_PTR_SET_RVALUE(systemTools_, systemTools) };
      ...
      inline const vector<ApiMcpServers::TerraformTools> & getTerraformTools() const { DARABONBA_PTR_GET_CONST(terraformTools_, vector<ApiMcpServers::TerraformTools>) };
      inline vector<ApiMcpServers::TerraformTools> getTerraformTools() { DARABONBA_PTR_GET(terraformTools_, vector<ApiMcpServers::TerraformTools>) };
      inline ApiMcpServers& setTerraformTools(const vector<ApiMcpServers::TerraformTools> & terraformTools) { DARABONBA_PTR_SET_VALUE(terraformTools_, terraformTools) };
      inline ApiMcpServers& setTerraformTools(vector<ApiMcpServers::TerraformTools> && terraformTools) { DARABONBA_PTR_SET_RVALUE(terraformTools_, terraformTools) };
      ...
      inline ApiMcpServers& setUpdateTime(string updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };


      // urls Field Functions 
      bool hasUrls() const { return this->urls_ != nullptr;};
      void deleteUrls() { this->urls_ = nullptr;};
      inline const ApiMcpServers::Urls & getUrls() const { DARABONBA_PTR_GET_CONST(urls_, ApiMcpServers::Urls) };
      inline ApiMcpServers::Urls getUrls() { DARABONBA_PTR_GET(urls_, ApiMcpServers::Urls) };
      inline ApiMcpServers& setUrls(const ApiMcpServers::Urls & urls) { DARABONBA_PTR_SET_VALUE(urls_, urls) };
      inline ApiMcpServers& setUrls(ApiMcpServers::Urls && urls) { DARABONBA_PTR_SET_RVALUE(urls_, urls) };
      ...
      inline ApiMcpServers& setVpcWhitelists(const vector<string> & vpcWhitelists) { DARABONBA_PTR_SET_VALUE(vpcWhitelists_, vpcWhitelists) };
      inline ApiMcpServers& setVpcWhitelists(vector<string> && vpcWhitelists) { DARABONBA_PTR_SET_RVALUE(vpcWhitelists_, vpcWhitelists) };
    ...
    inline const vector<ListApiMcpServersResponseBody::ApiMcpServers> & getApiMcpServers() const { DARABONBA_PTR_GET_CONST(apiMcpServers_, vector<ListApiMcpServersResponseBody::ApiMcpServers>) };
    inline vector<ListApiMcpServersResponseBody::ApiMcpServers> getApiMcpServers() { DARABONBA_PTR_GET(apiMcpServers_, vector<ListApiMcpServersResponseBody::ApiMcpServers>) };
    inline ListApiMcpServersResponseBody& setApiMcpServers(const vector<ListApiMcpServersResponseBody::ApiMcpServers> & apiMcpServers) { DARABONBA_PTR_SET_VALUE(apiMcpServers_, apiMcpServers) };
    inline ListApiMcpServersResponseBody& setApiMcpServers(vector<ListApiMcpServersResponseBody::ApiMcpServers> && apiMcpServers) { DARABONBA_PTR_SET_RVALUE(apiMcpServers_, apiMcpServers) };
