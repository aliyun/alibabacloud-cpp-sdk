...
namespace Models
{
  ...
  public:
    ...
    inline const GetApiMcpServerResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetApiMcpServerResponseBody) };
    inline GetApiMcpServerResponseBody getBody() { DARABONBA_PTR_GET(body_, GetApiMcpServerResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetApiMcpServerResponseBody> body_ {};
  };
