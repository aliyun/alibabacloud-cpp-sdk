...
namespace Models
{
  ...
  public:
    ...
    inline ListApiMcpServersResponseBodyApiMcpServersUrls& setVpcMcp(string vpcMcp) { DARABONBA_PTR_SET_VALUE(vpcMcp_, vpcMcp) };
    ...
    inline ListApiMcpServersResponseBodyApiMcpServersUrls& setVpcSse(string vpcSse) { DARABONBA_PTR_SET_VALUE(vpcSse_, vpcSse) };
