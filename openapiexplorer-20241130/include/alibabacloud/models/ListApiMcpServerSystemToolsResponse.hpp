...
namespace Models
{
  ...
  public:
    ...
    inline const ListApiMcpServerSystemToolsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListApiMcpServerSystemToolsResponseBody) };
    inline ListApiMcpServerSystemToolsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListApiMcpServerSystemToolsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListApiMcpServerSystemToolsResponseBody> body_ {};
  };
