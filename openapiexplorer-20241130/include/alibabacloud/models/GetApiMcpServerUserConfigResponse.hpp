...
namespace Models
{
  ...
  public:
    ...
    inline const GetApiMcpServerUserConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetApiMcpServerUserConfigResponseBody) };
    inline GetApiMcpServerUserConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, GetApiMcpServerUserConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetApiMcpServerUserConfigResponseBody> body_ {};
  };
