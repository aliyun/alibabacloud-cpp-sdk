...
namespace Models
{
  ...
  public:
    ...
    inline const ApiMcpServerValidateHclResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ApiMcpServerValidateHclResponseBody) };
    inline ApiMcpServerValidateHclResponseBody getBody() { DARABONBA_PTR_GET(body_, ApiMcpServerValidateHclResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ApiMcpServerValidateHclResponseBody> body_ {};
  };
