...
namespace Models
{
  ...
  public:
    ...
    inline GetApiMcpServerResponseBodyUrls& setVpcMcp(string vpcMcp) { DARABONBA_PTR_SET_VALUE(vpcMcp_, vpcMcp) };
    ...
    inline GetApiMcpServerResponseBodyUrls& setVpcSse(string vpcSse) { DARABONBA_PTR_SET_VALUE(vpcSse_, vpcSse) };
