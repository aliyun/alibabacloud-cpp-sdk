...
#ifndef ALIBABACLOUD_MODELS_GETOWNREQUESTLOGRESPONSEBODYLOGINFOAUTHENTICATIONINFO_HPP_
#define ALIBABACLOUD_MODELS_GETOWNREQUESTLOGRESPONSEBODYLOGINFOAUTHENTICATIONINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo& obj) { 
    ...
    GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo() = default ;
    GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo(const GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo &) = default ;
    GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo(GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo &&) = default ;
    GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo() = default ;
    GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo& operator=(const GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo &) = default ;
    GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo& operator=(GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo &&) = default ;
    ...
    inline GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo& setAuthenticationType(string authenticationType) { DARABONBA_PTR_SET_VALUE(authenticationType_, authenticationType) };
    ...
    inline GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo& setSignatureMethod(string signatureMethod) { DARABONBA_PTR_SET_VALUE(signatureMethod_, signatureMethod) };
    ...
    inline GetOwnRequestLogResponseBodyLogInfoAuthenticationInfo& setSignatureVersion(string signatureVersion) { DARABONBA_PTR_SET_VALUE(signatureVersion_, signatureVersion) };
