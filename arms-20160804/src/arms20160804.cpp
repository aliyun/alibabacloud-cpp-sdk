...
#include <alibabacloud/arms20160804.hpp>
...
using namespace Alibabacloud_ARMS20160804;

Alibabacloud_ARMS20160804::Client::Client(const shared_ptr<Alibabacloud_OpenApi::Config>& config) : Alibabacloud_OpenApi::Client(config) {
...
string Alibabacloud_ARMS20160804::Client::getEndpoint(shared_ptr<string> productId,
...
ArmsQueryDataSetResponse Alibabacloud_ARMS20160804::Client::armsQueryDataSetWithOptions(shared_ptr<ArmsQueryDataSetRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    ...
    {"version", boost::any(string("2016-08-04"))},
...
ArmsQueryDataSetResponse Alibabacloud_ARMS20160804::Client::armsQueryDataSet(shared_ptr<ArmsQueryDataSetRequest> request) {
