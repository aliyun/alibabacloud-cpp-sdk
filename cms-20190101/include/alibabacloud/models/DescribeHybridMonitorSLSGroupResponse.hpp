...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHybridMonitorSLSGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHybridMonitorSLSGroupResponseBody) };
    inline DescribeHybridMonitorSLSGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHybridMonitorSLSGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHybridMonitorSLSGroupResponseBody> body_ {};
  };
