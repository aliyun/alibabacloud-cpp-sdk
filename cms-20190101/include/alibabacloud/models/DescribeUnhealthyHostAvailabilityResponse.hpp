...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUnhealthyHostAvailabilityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUnhealthyHostAvailabilityResponseBody) };
    inline DescribeUnhealthyHostAvailabilityResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUnhealthyHostAvailabilityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUnhealthyHostAvailabilityResponseBody> body_ {};
  };
