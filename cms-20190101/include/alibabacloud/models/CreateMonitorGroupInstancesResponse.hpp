...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMonitorGroupInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMonitorGroupInstancesResponseBody) };
    inline CreateMonitorGroupInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMonitorGroupInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMonitorGroupInstancesResponseBody> body_ {};
  };
