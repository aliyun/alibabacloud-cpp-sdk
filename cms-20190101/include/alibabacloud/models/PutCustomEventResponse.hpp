...
namespace Models
{
  ...
  public:
    ...
    inline const PutCustomEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutCustomEventResponseBody) };
    inline PutCustomEventResponseBody getBody() { DARABONBA_PTR_GET(body_, PutCustomEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PutCustomEventResponseBody> body_ {};
  };
