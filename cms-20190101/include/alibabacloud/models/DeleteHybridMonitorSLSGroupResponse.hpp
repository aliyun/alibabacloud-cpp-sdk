...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteHybridMonitorSLSGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteHybridMonitorSLSGroupResponseBody) };
    inline DeleteHybridMonitorSLSGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteHybridMonitorSLSGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteHybridMonitorSLSGroupResponseBody> body_ {};
  };
