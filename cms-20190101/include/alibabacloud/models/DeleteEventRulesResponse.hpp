...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEventRulesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteEventRulesResponseBody) };
    inline DeleteEventRulesResponseBody body() { DARABONBA_PTR_GET(body_, DeleteEventRulesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteEventRulesResponseBody> body_ = nullptr;
  };
