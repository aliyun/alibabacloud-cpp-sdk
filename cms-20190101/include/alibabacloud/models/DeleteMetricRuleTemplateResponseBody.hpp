...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMetricRuleTemplateResponseBodyResource & resource() const { DARABONBA_PTR_GET_CONST(resource_, DeleteMetricRuleTemplateResponseBodyResource) };
    inline DeleteMetricRuleTemplateResponseBodyResource resource() { DARABONBA_PTR_GET(resource_, DeleteMetricRuleTemplateResponseBodyResource) };
    inline DeleteMetricRuleTemplateResponseBody& setResource(const DeleteMetricRuleTemplateResponseBodyResource & resource) { DARABONBA_PTR_SET_VALUE(resource_, resource) };
    inline DeleteMetricRuleTemplateResponseBody& setResource(DeleteMetricRuleTemplateResponseBodyResource && resource) { DARABONBA_PTR_SET_RVALUE(resource_, resource) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteMetricRuleTemplateResponseBodyResource> resource_ = nullptr;
