...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->escalations_ == nullptr
        && return this->compositeExpressionShrink_ == nullptr && return this->contactGroups_ == nullptr && return this->effectiveInterval_ == nullptr && return this->emailSubject_ == nullptr && return this->interval_ == nullptr
        ...
        && return this->period_ == nullptr && return this->prometheusShrink_ == nullptr && return this->resources_ == nullptr && return this->ruleId_ == nullptr && return this->ruleName_ == nullptr
