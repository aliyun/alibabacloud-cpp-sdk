...
#ifndef ALIBABACLOUD_MODELS_CREATEMONITORAGENTPROCESSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEMONITORAGENTPROCESSREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateMonitorAgentProcessRequest& obj) { 
      DARABONBA_PTR_TO_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_TO_JSON(ProcessName, processName_);
      DARABONBA_PTR_TO_JSON(ProcessUser, processUser_);
      DARABONBA_PTR_TO_JSON(RegionId, regionId_);
    };
    friend void from_json(const Darabonba::Json& j, CreateMonitorAgentProcessRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(InstanceId, instanceId_);
      DARABONBA_PTR_FROM_JSON(ProcessName, processName_);
      DARABONBA_PTR_FROM_JSON(ProcessUser, processUser_);
      DARABONBA_PTR_FROM_JSON(RegionId, regionId_);
    };
    CreateMonitorAgentProcessRequest() = default ;
    CreateMonitorAgentProcessRequest(const CreateMonitorAgentProcessRequest &) = default ;
    CreateMonitorAgentProcessRequest(CreateMonitorAgentProcessRequest &&) = default ;
    CreateMonitorAgentProcessRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateMonitorAgentProcessRequest() = default ;
    CreateMonitorAgentProcessRequest& operator=(const CreateMonitorAgentProcessRequest &) = default ;
    CreateMonitorAgentProcessRequest& operator=(CreateMonitorAgentProcessRequest &&) = default ;
