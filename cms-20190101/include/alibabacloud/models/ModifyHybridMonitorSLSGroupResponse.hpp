...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyHybridMonitorSLSGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyHybridMonitorSLSGroupResponseBody) };
    inline ModifyHybridMonitorSLSGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyHybridMonitorSLSGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyHybridMonitorSLSGroupResponseBody> body_ {};
  };
