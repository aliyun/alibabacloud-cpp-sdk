...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGroupMonitoringAgentProcessResponseBodyResource & resource() const { DARABONBA_PTR_GET_CONST(resource_, CreateGroupMonitoringAgentProcessResponseBodyResource) };
    inline CreateGroupMonitoringAgentProcessResponseBodyResource resource() { DARABONBA_PTR_GET(resource_, CreateGroupMonitoringAgentProcessResponseBodyResource) };
    inline CreateGroupMonitoringAgentProcessResponseBody& setResource(const CreateGroupMonitoringAgentProcessResponseBodyResource & resource) { DARABONBA_PTR_SET_VALUE(resource_, resource) };
    inline CreateGroupMonitoringAgentProcessResponseBody& setResource(CreateGroupMonitoringAgentProcessResponseBodyResource && resource) { DARABONBA_PTR_SET_RVALUE(resource_, resource) };
  ...
  protected:
    ...
    std::shared_ptr<CreateGroupMonitoringAgentProcessResponseBodyResource> resource_ = nullptr;
