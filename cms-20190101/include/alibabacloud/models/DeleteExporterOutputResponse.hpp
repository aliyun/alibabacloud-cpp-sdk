...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteExporterOutputResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteExporterOutputResponseBody) };
    inline DeleteExporterOutputResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteExporterOutputResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteExporterOutputResponseBody> body_ {};
  };
