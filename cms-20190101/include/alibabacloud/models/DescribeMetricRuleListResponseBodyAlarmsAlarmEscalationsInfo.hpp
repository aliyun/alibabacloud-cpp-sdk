...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEMETRICRULELISTRESPONSEBODYALARMSALARMESCALATIONSINFO_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEMETRICRULELISTRESPONSEBODYALARMSALARMESCALATIONSINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo& obj) { 
    ...
    DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo() = default ;
    DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo(const DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo &) = default ;
    DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo(DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo &&) = default ;
    DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo() = default ;
    DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo& operator=(const DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo &) = default ;
    DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo& operator=(DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo &&) = default ;
    ...
    inline DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo& setComparisonOperator(string comparisonOperator) { DARABONBA_PTR_SET_VALUE(comparisonOperator_, comparisonOperator) };
    ...
    inline DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo& setPreCondition(string preCondition) { DARABONBA_PTR_SET_VALUE(preCondition_, preCondition) };
    ...
    inline DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo& setStatistics(string statistics) { DARABONBA_PTR_SET_VALUE(statistics_, statistics) };
    ...
    inline DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo& setThreshold(string threshold) { DARABONBA_PTR_SET_VALUE(threshold_, threshold) };
    ...
    inline DescribeMetricRuleListResponseBodyAlarmsAlarmEscalationsInfo& setTimes(int32_t times) { DARABONBA_PTR_SET_VALUE(times_, times) };
