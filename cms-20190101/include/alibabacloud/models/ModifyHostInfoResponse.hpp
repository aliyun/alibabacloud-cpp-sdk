...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyHostInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyHostInfoResponseBody) };
    inline ModifyHostInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyHostInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyHostInfoResponseBody> body_ {};
  };
