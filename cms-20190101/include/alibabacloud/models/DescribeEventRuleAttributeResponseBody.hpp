...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventRuleAttributeResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeEventRuleAttributeResponseBodyResult) };
    inline DescribeEventRuleAttributeResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeEventRuleAttributeResponseBodyResult) };
    inline DescribeEventRuleAttributeResponseBody& setResult(const DescribeEventRuleAttributeResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeEventRuleAttributeResponseBody& setResult(DescribeEventRuleAttributeResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEventRuleAttributeResponseBodyResult> result_ = nullptr;
