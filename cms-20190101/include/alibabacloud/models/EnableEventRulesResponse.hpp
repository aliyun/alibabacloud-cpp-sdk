...
namespace Models
{
  ...
  public:
    ...
    inline const EnableEventRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableEventRulesResponseBody) };
    inline EnableEventRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableEventRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableEventRulesResponseBody> body_ {};
  };
