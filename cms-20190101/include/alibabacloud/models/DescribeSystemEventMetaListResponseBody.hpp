...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSystemEventMetaListResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSystemEventMetaListResponseBodyData) };
    inline DescribeSystemEventMetaListResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSystemEventMetaListResponseBodyData) };
    inline DescribeSystemEventMetaListResponseBody& setData(const DescribeSystemEventMetaListResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSystemEventMetaListResponseBody& setData(DescribeSystemEventMetaListResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSystemEventMetaListResponseBodyData> data_ = nullptr;
