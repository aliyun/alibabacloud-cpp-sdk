...
namespace Models
{
  ...
  public:
    ...
    inline const PutResourceMetricRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutResourceMetricRulesResponseBody) };
    inline PutResourceMetricRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, PutResourceMetricRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PutResourceMetricRulesResponseBody> body_ {};
  };
