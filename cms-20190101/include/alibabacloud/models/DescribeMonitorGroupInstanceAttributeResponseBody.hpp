...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMonitorGroupInstanceAttributeResponseBodyResources & resources() const { DARABONBA_PTR_GET_CONST(resources_, DescribeMonitorGroupInstanceAttributeResponseBodyResources) };
    inline DescribeMonitorGroupInstanceAttributeResponseBodyResources resources() { DARABONBA_PTR_GET(resources_, DescribeMonitorGroupInstanceAttributeResponseBodyResources) };
    inline DescribeMonitorGroupInstanceAttributeResponseBody& setResources(const DescribeMonitorGroupInstanceAttributeResponseBodyResources & resources) { DARABONBA_PTR_SET_VALUE(resources_, resources) };
    inline DescribeMonitorGroupInstanceAttributeResponseBody& setResources(DescribeMonitorGroupInstanceAttributeResponseBodyResources && resources) { DARABONBA_PTR_SET_RVALUE(resources_, resources) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeMonitorGroupInstanceAttributeResponseBodyResources> resources_ = nullptr;
