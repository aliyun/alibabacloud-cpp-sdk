...
namespace Models
{
  ...
  public:
    ...
    inline bool getIdcProbe() const { DARABONBA_PTR_GET_DEFAULT(idcProbe_, false) };
    ...
    inline bool getLmProbe() const { DARABONBA_PTR_GET_DEFAULT(lmProbe_, false) };
    ...
    inline bool getMbProbe() const { DARABONBA_PTR_GET_DEFAULT(mbProbe_, false) };
