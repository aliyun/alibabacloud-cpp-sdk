...
namespace Models
{
  ...
  public:
    ...
    inline bool getIncludeTemplateHistory() const { DARABONBA_PTR_GET_DEFAULT(includeTemplateHistory_, false) };
    ...
    inline bool getSelectContactGroups() const { DARABONBA_PTR_GET_DEFAULT(selectContactGroups_, false) };
    ...
    inline const vector<DescribeMonitorGroupsRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<DescribeMonitorGroupsRequest::Tag>) };
    inline vector<DescribeMonitorGroupsRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<DescribeMonitorGroupsRequest::Tag>) };
    inline DescribeMonitorGroupsRequest& setTag(const vector<DescribeMonitorGroupsRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline DescribeMonitorGroupsRequest& setTag(vector<DescribeMonitorGroupsRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
