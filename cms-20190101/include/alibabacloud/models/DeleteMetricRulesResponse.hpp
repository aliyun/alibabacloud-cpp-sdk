...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMetricRulesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteMetricRulesResponseBody) };
    inline DeleteMetricRulesResponseBody body() { DARABONBA_PTR_GET(body_, DeleteMetricRulesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteMetricRulesResponseBody> body_ = nullptr;
  };
