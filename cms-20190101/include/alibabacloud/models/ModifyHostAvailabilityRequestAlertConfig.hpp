...
#ifndef ALIBABACLOUD_MODELS_MODIFYHOSTAVAILABILITYREQUESTALERTCONFIG_HPP_
#define ALIBABACLOUD_MODELS_MODIFYHOSTAVAILABILITYREQUESTALERTCONFIG_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ModifyHostAvailabilityRequestAlertConfig& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ModifyHostAvailabilityRequestAlertConfig& obj) { 
    ...
    ModifyHostAvailabilityRequestAlertConfig() = default ;
    ModifyHostAvailabilityRequestAlertConfig(const ModifyHostAvailabilityRequestAlertConfig &) = default ;
    ModifyHostAvailabilityRequestAlertConfig(ModifyHostAvailabilityRequestAlertConfig &&) = default ;
    ModifyHostAvailabilityRequestAlertConfig(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ModifyHostAvailabilityRequestAlertConfig() = default ;
    ModifyHostAvailabilityRequestAlertConfig& operator=(const ModifyHostAvailabilityRequestAlertConfig &) = default ;
    ModifyHostAvailabilityRequestAlertConfig& operator=(ModifyHostAvailabilityRequestAlertConfig &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->endTime_ == nullptr
        && return this->notifyType_ == nullptr && return this->silenceTime_ == nullptr && return this->startTime_ == nullptr && return this->webHook_ == nullptr; };
    // endTime Field Functions 
    bool hasEndTime() const { return this->endTime_ != nullptr;};
    void deleteEndTime() { this->endTime_ = nullptr;};
    inline int32_t endTime() const { DARABONBA_PTR_GET_DEFAULT(endTime_, 0) };
    inline ModifyHostAvailabilityRequestAlertConfig& setEndTime(int32_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ModifyHostAvailabilityRequestAlertConfig& setNotifyType(int32_t notifyType) { DARABONBA_PTR_SET_VALUE(notifyType_, notifyType) };
    ...
    inline ModifyHostAvailabilityRequestAlertConfig& setSilenceTime(int32_t silenceTime) { DARABONBA_PTR_SET_VALUE(silenceTime_, silenceTime) };
    ...
    inline ModifyHostAvailabilityRequestAlertConfig& setStartTime(int32_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ModifyHostAvailabilityRequestAlertConfig& setWebHook(string webHook) { DARABONBA_PTR_SET_VALUE(webHook_, webHook) };
