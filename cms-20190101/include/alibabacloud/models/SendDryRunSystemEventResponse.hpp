...
namespace Models
{
  ...
  public:
    ...
    inline const SendDryRunSystemEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendDryRunSystemEventResponseBody) };
    inline SendDryRunSystemEventResponseBody getBody() { DARABONBA_PTR_GET(body_, SendDryRunSystemEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendDryRunSystemEventResponseBody> body_ {};
  };
