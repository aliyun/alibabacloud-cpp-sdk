...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEALERTLOGCOUNTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEALERTLOGCOUNTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeAlertLogCountRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeAlertLogCountRequest& obj) { 
    ...
    DescribeAlertLogCountRequest() = default ;
    DescribeAlertLogCountRequest(const DescribeAlertLogCountRequest &) = default ;
    DescribeAlertLogCountRequest(DescribeAlertLogCountRequest &&) = default ;
    DescribeAlertLogCountRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeAlertLogCountRequest() = default ;
    DescribeAlertLogCountRequest& operator=(const DescribeAlertLogCountRequest &) = default ;
    DescribeAlertLogCountRequest& operator=(DescribeAlertLogCountRequest &&) = default ;
    ...
    inline DescribeAlertLogCountRequest& setContactGroup(string contactGroup) { DARABONBA_PTR_SET_VALUE(contactGroup_, contactGroup) };
    ...
    inline DescribeAlertLogCountRequest& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline DescribeAlertLogCountRequest& setEventType(string eventType) { DARABONBA_PTR_SET_VALUE(eventType_, eventType) };
    ...
    inline DescribeAlertLogCountRequest& setGroupBy(string groupBy) { DARABONBA_PTR_SET_VALUE(groupBy_, groupBy) };
    ...
    inline DescribeAlertLogCountRequest& setGroupId(string groupId) { DARABONBA_PTR_SET_VALUE(groupId_, groupId) };
    ...
    inline DescribeAlertLogCountRequest& setLastMin(string lastMin) { DARABONBA_PTR_SET_VALUE(lastMin_, lastMin) };
    ...
    inline DescribeAlertLogCountRequest& setLevel(string level) { DARABONBA_PTR_SET_VALUE(level_, level) };
    ...
    inline DescribeAlertLogCountRequest& setMetricName(string metricName) { DARABONBA_PTR_SET_VALUE(metricName_, metricName) };
    ...
    inline DescribeAlertLogCountRequest& setNamespace(string _namespace) { DARABONBA_PTR_SET_VALUE(namespace_, _namespace) };
    ...
    inline DescribeAlertLogCountRequest& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline DescribeAlertLogCountRequest& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline DescribeAlertLogCountRequest& setProduct(string product) { DARABONBA_PTR_SET_VALUE(product_, product) };
    ...
    inline DescribeAlertLogCountRequest& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline DescribeAlertLogCountRequest& setRuleId(string ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
    ...
    inline DescribeAlertLogCountRequest& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline DescribeAlertLogCountRequest& setSearchKey(string searchKey) { DARABONBA_PTR_SET_VALUE(searchKey_, searchKey) };
    ...
    inline DescribeAlertLogCountRequest& setSendStatus(string sendStatus) { DARABONBA_PTR_SET_VALUE(sendStatus_, sendStatus) };
    ...
    inline DescribeAlertLogCountRequest& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline DescribeAlertLogCountRequest& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
