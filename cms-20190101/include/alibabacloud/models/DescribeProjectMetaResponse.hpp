...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeProjectMetaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeProjectMetaResponseBody) };
    inline DescribeProjectMetaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeProjectMetaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeProjectMetaResponseBody> body_ {};
  };
