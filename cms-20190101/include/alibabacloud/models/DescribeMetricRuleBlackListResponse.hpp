...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMetricRuleBlackListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMetricRuleBlackListResponseBody) };
    inline DescribeMetricRuleBlackListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMetricRuleBlackListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMetricRuleBlackListResponseBody> body_ {};
  };
