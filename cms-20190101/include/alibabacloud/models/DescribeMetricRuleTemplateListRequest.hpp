...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->history_ == nullptr
        && return this->keyword_ == nullptr && return this->name_ == nullptr && return this->order_ == nullptr && return this->orderBy_ == nullptr && return this->pageNumber_ == nullptr
        && return this->pageSize_ == nullptr && return this->regionId_ == nullptr && return this->templateId_ == nullptr; };
