...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->contactGroupList_ == nullptr
        && return this->enableInstallAgent_ == nullptr && return this->enableSubscribeEvent_ == nullptr && return this->matchExpress_ == nullptr && return this->matchExpressFilterRelation_ == nullptr && return this->regionId_ == nullptr
        && return this->tagKey_ == nullptr && return this->tagRegionId_ == nullptr && return this->templateIdList_ == nullptr; };
