...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTagKeyListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTagKeyListResponseBody) };
    inline DescribeTagKeyListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTagKeyListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTagKeyListResponseBody> body_ {};
  };
