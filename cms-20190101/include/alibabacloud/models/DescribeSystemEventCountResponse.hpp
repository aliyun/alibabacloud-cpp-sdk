...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSystemEventCountResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSystemEventCountResponseBody) };
    inline DescribeSystemEventCountResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSystemEventCountResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSystemEventCountResponseBody> body_ {};
  };
