...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLogMonitorListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeLogMonitorListResponseBody) };
    inline DescribeLogMonitorListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeLogMonitorListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeLogMonitorListResponseBody> body_ {};
  };
