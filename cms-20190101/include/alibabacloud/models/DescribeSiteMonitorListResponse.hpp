...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSiteMonitorListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSiteMonitorListResponseBody) };
    inline DescribeSiteMonitorListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSiteMonitorListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSiteMonitorListResponseBody> body_ {};
  };
