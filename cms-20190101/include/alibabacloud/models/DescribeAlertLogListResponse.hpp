...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAlertLogListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAlertLogListResponseBody) };
    inline DescribeAlertLogListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAlertLogListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAlertLogListResponseBody> body_ {};
  };
