...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDynamicTagGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDynamicTagGroupResponseBody) };
    inline DeleteDynamicTagGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDynamicTagGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDynamicTagGroupResponseBody> body_ {};
  };
