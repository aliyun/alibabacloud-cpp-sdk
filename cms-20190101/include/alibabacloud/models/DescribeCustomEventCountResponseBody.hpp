...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->customEventCounts_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
    ...
    inline const DescribeCustomEventCountResponseBodyCustomEventCounts & customEventCounts() const { DARABONBA_PTR_GET_CONST(customEventCounts_, DescribeCustomEventCountResponseBodyCustomEventCounts) };
    inline DescribeCustomEventCountResponseBodyCustomEventCounts customEventCounts() { DARABONBA_PTR_GET(customEventCounts_, DescribeCustomEventCountResponseBodyCustomEventCounts) };
    inline DescribeCustomEventCountResponseBody& setCustomEventCounts(const DescribeCustomEventCountResponseBodyCustomEventCounts & customEventCounts) { DARABONBA_PTR_SET_VALUE(customEventCounts_, customEventCounts) };
    inline DescribeCustomEventCountResponseBody& setCustomEventCounts(DescribeCustomEventCountResponseBodyCustomEventCounts && customEventCounts) { DARABONBA_PTR_SET_RVALUE(customEventCounts_, customEventCounts) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeCustomEventCountResponseBodyCustomEventCounts> customEventCounts_ = nullptr;
