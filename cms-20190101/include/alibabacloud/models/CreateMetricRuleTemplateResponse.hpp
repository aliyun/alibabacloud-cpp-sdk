...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMetricRuleTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMetricRuleTemplateResponseBody) };
    inline CreateMetricRuleTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMetricRuleTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMetricRuleTemplateResponseBody> body_ {};
  };
