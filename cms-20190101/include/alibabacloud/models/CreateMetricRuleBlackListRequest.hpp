...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->category_ == nullptr
        && this->effectiveTime_ == nullptr && this->enableEndTime_ == nullptr && this->enableStartTime_ == nullptr && this->instances_ == nullptr && this->metrics_ == nullptr
        && this->name_ == nullptr && this->namespace_ == nullptr && this->regionId_ == nullptr && this->scopeType_ == nullptr && this->scopeValue_ == nullptr; };
    ...
    inline const vector<CreateMetricRuleBlackListRequest::Metrics> & getMetrics() const { DARABONBA_PTR_GET_CONST(metrics_, vector<CreateMetricRuleBlackListRequest::Metrics>) };
    inline vector<CreateMetricRuleBlackListRequest::Metrics> getMetrics() { DARABONBA_PTR_GET(metrics_, vector<CreateMetricRuleBlackListRequest::Metrics>) };
    inline CreateMetricRuleBlackListRequest& setMetrics(const vector<CreateMetricRuleBlackListRequest::Metrics> & metrics) { DARABONBA_PTR_SET_VALUE(metrics_, metrics) };
    inline CreateMetricRuleBlackListRequest& setMetrics(vector<CreateMetricRuleBlackListRequest::Metrics> && metrics) { DARABONBA_PTR_SET_RVALUE(metrics_, metrics) };
