...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSiteMonitorQuotaResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSiteMonitorQuotaResponseBody) };
    inline DescribeSiteMonitorQuotaResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSiteMonitorQuotaResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSiteMonitorQuotaResponseBody> body_ {};
  };
