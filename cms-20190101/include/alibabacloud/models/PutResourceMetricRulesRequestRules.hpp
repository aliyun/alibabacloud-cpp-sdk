...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->escalations_ == nullptr
        && return this->contactGroups_ == nullptr && return this->effectiveInterval_ == nullptr && return this->emailSubject_ == nullptr && return this->interval_ == nullptr && return this->labels_ == nullptr
        && return this->metricName_ == nullptr && return this->namespace_ == nullptr && return this->noDataPolicy_ == nullptr && return this->noEffectiveInterval_ == nullptr && return this->period_ == nullptr
