...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeContactListByContactGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeContactListByContactGroupResponseBody) };
    inline DescribeContactListByContactGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeContactListByContactGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeContactListByContactGroupResponseBody> body_ {};
  };
