...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoInstall_ == nullptr
        && return this->code_ == nullptr && return this->enableInstallAgentNewECS_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr; };
