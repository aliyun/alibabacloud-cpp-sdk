...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyHybridMonitorTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyHybridMonitorTaskResponseBody) };
    inline ModifyHybridMonitorTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyHybridMonitorTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyHybridMonitorTaskResponseBody> body_ {};
  };
