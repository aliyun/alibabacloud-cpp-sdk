...
namespace Models
{
  ...
  public:
    ...
    inline const EnableMetricRuleBlackListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableMetricRuleBlackListResponseBody) };
    inline EnableMetricRuleBlackListResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableMetricRuleBlackListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableMetricRuleBlackListResponseBody> body_ {};
  };
