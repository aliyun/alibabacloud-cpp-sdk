...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMetricRuleTemplateAttributeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeMetricRuleTemplateAttributeResponseBody) };
    inline DescribeMetricRuleTemplateAttributeResponseBody body() { DARABONBA_PTR_GET(body_, DescribeMetricRuleTemplateAttributeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeMetricRuleTemplateAttributeResponseBody> body_ = nullptr;
  };
