...
namespace Models
{
  ...
  public:
    ...
    inline const ApplyMetricRuleTemplateResponseBodyResource & resource() const { DARABONBA_PTR_GET_CONST(resource_, ApplyMetricRuleTemplateResponseBodyResource) };
    inline ApplyMetricRuleTemplateResponseBodyResource resource() { DARABONBA_PTR_GET(resource_, ApplyMetricRuleTemplateResponseBodyResource) };
    inline ApplyMetricRuleTemplateResponseBody& setResource(const ApplyMetricRuleTemplateResponseBodyResource & resource) { DARABONBA_PTR_SET_VALUE(resource_, resource) };
    inline ApplyMetricRuleTemplateResponseBody& setResource(ApplyMetricRuleTemplateResponseBodyResource && resource) { DARABONBA_PTR_SET_RVALUE(resource_, resource) };
  ...
  protected:
    ...
    std::shared_ptr<ApplyMetricRuleTemplateResponseBodyResource> resource_ = nullptr;
