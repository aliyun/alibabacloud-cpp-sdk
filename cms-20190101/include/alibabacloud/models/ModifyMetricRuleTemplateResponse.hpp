...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyMetricRuleTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyMetricRuleTemplateResponseBody) };
    inline ModifyMetricRuleTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyMetricRuleTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyMetricRuleTemplateResponseBody> body_ {};
  };
