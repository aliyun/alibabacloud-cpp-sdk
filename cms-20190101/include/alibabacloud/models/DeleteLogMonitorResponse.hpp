...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteLogMonitorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteLogMonitorResponseBody) };
    inline DeleteLogMonitorResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteLogMonitorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteLogMonitorResponseBody> body_ {};
  };
