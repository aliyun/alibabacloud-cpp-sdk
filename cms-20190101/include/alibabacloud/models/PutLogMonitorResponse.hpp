...
namespace Models
{
  ...
  public:
    ...
    inline const PutLogMonitorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutLogMonitorResponseBody) };
    inline PutLogMonitorResponseBody getBody() { DARABONBA_PTR_GET(body_, PutLogMonitorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PutLogMonitorResponseBody> body_ {};
  };
