...
namespace Models
{
  ...
  public:
    ...
    inline const ModifySiteMonitorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifySiteMonitorResponseBody) };
    inline ModifySiteMonitorResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifySiteMonitorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifySiteMonitorResponseBody> body_ {};
  };
