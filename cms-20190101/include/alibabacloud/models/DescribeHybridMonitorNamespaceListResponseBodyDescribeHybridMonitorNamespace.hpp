...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aliyunProductMetricList_ == nullptr
        && return this->createTime_ == nullptr && return this->description_ == nullptr && return this->detail_ == nullptr && return this->id_ == nullptr && return this->isDelete_ == nullptr
        && return this->modifyTime_ == nullptr && return this->namespace_ == nullptr && return this->namespaceType_ == nullptr && return this->notAliyunTaskNumber_ == nullptr; };
