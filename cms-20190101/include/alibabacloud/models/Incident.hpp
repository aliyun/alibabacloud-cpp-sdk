...
namespace Models
{
  ...
  public:
    ...
    inline     const Darabonba::Json & getGroupingData() const { DARABONBA_GET(groupingData_) };
    Darabonba::Json & getGroupingData() { DARABONBA_GET(groupingData_) };
    ...
    inline string getGroupingId() const { DARABONBA_PTR_GET_DEFAULT(groupingId_, "") };
    ...
    inline string getGroupingKey() const { DARABONBA_PTR_GET_DEFAULT(groupingKey_, "") };
    ...
    inline string getIncidentStatus() const { DARABONBA_PTR_GET_DEFAULT(incidentStatus_, "") };
  ...
  protected:
    ...
    Darabonba::Json groupingData_ {};
    shared_ptr<string> groupingId_ {};
    shared_ptr<string> groupingKey_ {};
    shared_ptr<string> incidentId_ {};
    shared_ptr<string> incidentStatus_ {};
