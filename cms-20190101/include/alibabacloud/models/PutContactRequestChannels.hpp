...
#ifndef ALIBABACLOUD_MODELS_PUTCONTACTREQUESTCHANNELS_HPP_
#define ALIBABACLOUD_MODELS_PUTCONTACTREQUESTCHANNELS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PutContactRequestChannels& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PutContactRequestChannels& obj) { 
    ...
    PutContactRequestChannels() = default ;
    PutContactRequestChannels(const PutContactRequestChannels &) = default ;
    PutContactRequestChannels(PutContactRequestChannels &&) = default ;
    PutContactRequestChannels(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PutContactRequestChannels() = default ;
    PutContactRequestChannels& operator=(const PutContactRequestChannels &) = default ;
    PutContactRequestChannels& operator=(PutContactRequestChannels &&) = default ;
    ...
    inline PutContactRequestChannels& setAliIM(string aliIM) { DARABONBA_PTR_SET_VALUE(aliIM_, aliIM) };
    ...
    inline PutContactRequestChannels& setDingWebHook(string dingWebHook) { DARABONBA_PTR_SET_VALUE(dingWebHook_, dingWebHook) };
    ...
    inline PutContactRequestChannels& setMail(string mail) { DARABONBA_PTR_SET_VALUE(mail_, mail) };
    ...
    inline PutContactRequestChannels& setSMS(string SMS) { DARABONBA_PTR_SET_VALUE(SMS_, SMS) };
