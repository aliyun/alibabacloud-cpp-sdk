...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMonitoringConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMonitoringConfigResponseBody) };
    inline DescribeMonitoringConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMonitoringConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMonitoringConfigResponseBody> body_ {};
  };
