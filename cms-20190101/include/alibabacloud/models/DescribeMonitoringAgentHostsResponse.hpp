...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMonitoringAgentHostsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMonitoringAgentHostsResponseBody) };
    inline DescribeMonitoringAgentHostsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMonitoringAgentHostsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMonitoringAgentHostsResponseBody> body_ {};
  };
