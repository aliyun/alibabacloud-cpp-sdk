...
namespace Models
{
  ...
  public:
    ...
    inline const PutExporterOutputResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutExporterOutputResponseBody) };
    inline PutExporterOutputResponseBody getBody() { DARABONBA_PTR_GET(body_, PutExporterOutputResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PutExporterOutputResponseBody> body_ {};
  };
