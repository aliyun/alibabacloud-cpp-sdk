...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->contacts_ == nullptr && return this->message_ == nullptr && return this->requestId_ == nullptr && return this->success_ == nullptr && return this->total_ == nullptr; };
    ...
    inline const DescribeContactListResponseBodyContacts & contacts() const { DARABONBA_PTR_GET_CONST(contacts_, DescribeContactListResponseBodyContacts) };
    inline DescribeContactListResponseBodyContacts contacts() { DARABONBA_PTR_GET(contacts_, DescribeContactListResponseBodyContacts) };
    inline DescribeContactListResponseBody& setContacts(const DescribeContactListResponseBodyContacts & contacts) { DARABONBA_PTR_SET_VALUE(contacts_, contacts) };
    inline DescribeContactListResponseBody& setContacts(DescribeContactListResponseBodyContacts && contacts) { DARABONBA_PTR_SET_RVALUE(contacts_, contacts) };
  ...
  protected:
    ...
    // The alert contacts.
    std::shared_ptr<DescribeContactListResponseBodyContacts> contacts_ = nullptr;
