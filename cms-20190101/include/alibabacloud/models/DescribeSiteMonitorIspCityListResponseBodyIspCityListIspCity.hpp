...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->area_en_ == nullptr
        && return this->area_zh_cN_ == nullptr && return this->city_ == nullptr && return this->cityName_en_ == nullptr && return this->cityName_zh_cN_ == nullptr && return this->country_ == nullptr
        && return this->country_en_ == nullptr && return this->country_zh_cN_ == nullptr && return this->IPPool_ == nullptr && return this->IPV4ProbeCount_ == nullptr && return this->IPV6ProbeCount_ == nullptr
        && return this->isp_ == nullptr && return this->ispName_en_ == nullptr && return this->ispName_zh_cN_ == nullptr && return this->region_ == nullptr && return this->region_en_ == nullptr
        && return this->region_zh_cN_ == nullptr; };
