...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->includeAlert_ != nullptr
    ...
    inline bool includeAlert() const { DARABONBA_PTR_GET_DEFAULT(includeAlert_, false) };
  ...
  protected:
    ...
    std::shared_ptr<bool> includeAlert_ = nullptr;
