...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSiteMonitorQuotaResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, DescribeSiteMonitorQuotaResponseBodyData) };
    inline DescribeSiteMonitorQuotaResponseBodyData data() { DARABONBA_PTR_GET(data_, DescribeSiteMonitorQuotaResponseBodyData) };
    inline DescribeSiteMonitorQuotaResponseBody& setData(const DescribeSiteMonitorQuotaResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribeSiteMonitorQuotaResponseBody& setData(DescribeSiteMonitorQuotaResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    // The quota.
    std::shared_ptr<DescribeSiteMonitorQuotaResponseBodyData> data_ = nullptr;
