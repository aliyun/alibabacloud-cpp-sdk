...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->endTime_ == nullptr
        && return this->matchersShrink_ == nullptr && return this->metric_ == nullptr && return this->namespace_ == nullptr && return this->period_ == nullptr && return this->startTime_ == nullptr; };
    ...
    inline string matchersShrink() const { DARABONBA_PTR_GET_DEFAULT(matchersShrink_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> matchersShrink_ = nullptr;
