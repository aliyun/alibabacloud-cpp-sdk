...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aggregates_ == nullptr
        && return this->groupId_ == nullptr && return this->groupbys_ == nullptr && return this->logId_ == nullptr && return this->metricExpress_ == nullptr && return this->metricName_ == nullptr
        && return this->regionId_ == nullptr && return this->slsLogstore_ == nullptr && return this->slsProject_ == nullptr && return this->slsRegionId_ == nullptr && return this->tumblingwindows_ == nullptr
        && return this->unit_ == nullptr && return this->valueFilter_ == nullptr && return this->valueFilterRelation_ == nullptr; };
