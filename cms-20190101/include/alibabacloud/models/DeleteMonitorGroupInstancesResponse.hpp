...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMonitorGroupInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMonitorGroupInstancesResponseBody) };
    inline DeleteMonitorGroupInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMonitorGroupInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMonitorGroupInstancesResponseBody> body_ {};
  };
