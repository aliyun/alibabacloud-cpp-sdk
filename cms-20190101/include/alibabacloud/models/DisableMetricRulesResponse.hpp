...
namespace Models
{
  ...
  public:
    ...
    inline const DisableMetricRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableMetricRulesResponseBody) };
    inline DisableMetricRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableMetricRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableMetricRulesResponseBody> body_ {};
  };
