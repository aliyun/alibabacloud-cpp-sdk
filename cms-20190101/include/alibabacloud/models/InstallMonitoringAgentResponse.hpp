...
namespace Models
{
  ...
  public:
    ...
    inline const InstallMonitoringAgentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InstallMonitoringAgentResponseBody) };
    inline InstallMonitoringAgentResponseBody getBody() { DARABONBA_PTR_GET(body_, InstallMonitoringAgentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InstallMonitoringAgentResponseBody> body_ {};
  };
