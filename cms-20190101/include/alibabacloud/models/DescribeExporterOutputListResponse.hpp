...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExporterOutputListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeExporterOutputListResponseBody) };
    inline DescribeExporterOutputListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeExporterOutputListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeExporterOutputListResponseBody> body_ = nullptr;
  };
