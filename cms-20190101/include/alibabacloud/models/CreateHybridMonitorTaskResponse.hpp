...
namespace Models
{
  ...
  public:
    ...
    inline const CreateHybridMonitorTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateHybridMonitorTaskResponseBody) };
    inline CreateHybridMonitorTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateHybridMonitorTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateHybridMonitorTaskResponseBody> body_ {};
  };
