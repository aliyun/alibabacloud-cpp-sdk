...
namespace Models
{
  ...
  public:
    ...
    inline const PutContactGroupResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, PutContactGroupResponseBody) };
    inline PutContactGroupResponseBody body() { DARABONBA_PTR_GET(body_, PutContactGroupResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<PutContactGroupResponseBody> body_ = nullptr;
  };
