...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->contactGroupName_ == nullptr
        && this->contactNames_ == nullptr && this->describe_ == nullptr && this->enableSubscribed_ == nullptr; };
    ...
    inline const vector<string> & getContactNames() const { DARABONBA_PTR_GET_CONST(contactNames_, vector<string>) };
    inline vector<string> getContactNames() { DARABONBA_PTR_GET(contactNames_, vector<string>) };
