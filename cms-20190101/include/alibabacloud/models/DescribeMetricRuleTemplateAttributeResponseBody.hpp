...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMetricRuleTemplateAttributeResponseBodyResource & resource() const { DARABONBA_PTR_GET_CONST(resource_, DescribeMetricRuleTemplateAttributeResponseBodyResource) };
    inline DescribeMetricRuleTemplateAttributeResponseBodyResource resource() { DARABONBA_PTR_GET(resource_, DescribeMetricRuleTemplateAttributeResponseBodyResource) };
    inline DescribeMetricRuleTemplateAttributeResponseBody& setResource(const DescribeMetricRuleTemplateAttributeResponseBodyResource & resource) { DARABONBA_PTR_SET_VALUE(resource_, resource) };
    inline DescribeMetricRuleTemplateAttributeResponseBody& setResource(DescribeMetricRuleTemplateAttributeResponseBodyResource && resource) { DARABONBA_PTR_SET_RVALUE(resource_, resource) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeMetricRuleTemplateAttributeResponseBodyResource> resource_ = nullptr;
