...
namespace Models
{
  ...
  public:
    ...
    inline const DisableHostAvailabilityResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableHostAvailabilityResponseBody) };
    inline DisableHostAvailabilityResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableHostAvailabilityResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableHostAvailabilityResponseBody> body_ {};
  };
