...
namespace Models
{
  ...
  public:
    ...
    inline const PutEventRuleTargetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutEventRuleTargetsResponseBody) };
    inline PutEventRuleTargetsResponseBody getBody() { DARABONBA_PTR_GET(body_, PutEventRuleTargetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PutEventRuleTargetsResponseBody> body_ {};
  };
