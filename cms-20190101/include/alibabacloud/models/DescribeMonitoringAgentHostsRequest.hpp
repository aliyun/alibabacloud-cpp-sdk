...
namespace Models
{
  ...
  public:
    ...
    inline bool aliyunHost() const { DARABONBA_PTR_GET_DEFAULT(aliyunHost_, false) };
    ...
    inline string serialNumbers() const { DARABONBA_PTR_GET_DEFAULT(serialNumbers_, "") };
    ...
    inline string sysomStatus() const { DARABONBA_PTR_GET_DEFAULT(sysomStatus_, "") };
  ...
  protected:
    ...
    std::shared_ptr<bool> aliyunHost_ = nullptr;
    ...
    std::shared_ptr<string> serialNumbers_ = nullptr;
    ...
    std::shared_ptr<string> sysomStatus_ = nullptr;
  };
