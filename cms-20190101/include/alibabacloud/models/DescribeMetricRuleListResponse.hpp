...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMetricRuleListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeMetricRuleListResponseBody) };
    inline DescribeMetricRuleListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeMetricRuleListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeMetricRuleListResponseBody> body_ = nullptr;
  };
