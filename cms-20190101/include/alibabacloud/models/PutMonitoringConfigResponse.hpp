...
namespace Models
{
  ...
  public:
    ...
    inline const PutMonitoringConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutMonitoringConfigResponseBody) };
    inline PutMonitoringConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, PutMonitoringConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PutMonitoringConfigResponseBody> body_ {};
  };
