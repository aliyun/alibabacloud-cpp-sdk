...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHybridMonitorNamespaceListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHybridMonitorNamespaceListResponseBody) };
    inline DescribeHybridMonitorNamespaceListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHybridMonitorNamespaceListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHybridMonitorNamespaceListResponseBody> body_ {};
  };
