...
namespace Models
{
  ...
  public:
    ...
    inline const DisableEventRulesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DisableEventRulesResponseBody) };
    inline DisableEventRulesResponseBody getBody() { DARABONBA_PTR_GET(body_, DisableEventRulesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DisableEventRulesResponseBody> body_ {};
  };
