...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAlertLogHistogramResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAlertLogHistogramResponseBody) };
    inline DescribeAlertLogHistogramResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAlertLogHistogramResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAlertLogHistogramResponseBody> body_ = nullptr;
  };
