...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMonitorGroupInstanceAttributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMonitorGroupInstanceAttributeResponseBody) };
    inline DescribeMonitorGroupInstanceAttributeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMonitorGroupInstanceAttributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMonitorGroupInstanceAttributeResponseBody> body_ {};
  };
