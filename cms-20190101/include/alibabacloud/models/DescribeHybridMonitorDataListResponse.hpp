...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHybridMonitorDataListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeHybridMonitorDataListResponseBody) };
    inline DescribeHybridMonitorDataListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeHybridMonitorDataListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeHybridMonitorDataListResponseBody> body_ {};
  };
