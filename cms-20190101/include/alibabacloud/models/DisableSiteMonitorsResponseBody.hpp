...
namespace Models
{
  ...
  public:
    ...
    inline const DisableSiteMonitorsResponseBody::Data & getData() const { DARABONBA_PTR_GET_CONST(data_, DisableSiteMonitorsResponseBody::Data) };
    inline DisableSiteMonitorsResponseBody::Data getData() { DARABONBA_PTR_GET(data_, DisableSiteMonitorsResponseBody::Data) };
    inline DisableSiteMonitorsResponseBody& setData(const DisableSiteMonitorsResponseBody::Data & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DisableSiteMonitorsResponseBody& setData(DisableSiteMonitorsResponseBody::Data && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
