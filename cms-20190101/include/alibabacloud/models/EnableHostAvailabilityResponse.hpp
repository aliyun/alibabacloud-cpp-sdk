...
namespace Models
{
  ...
  public:
    ...
    inline const EnableHostAvailabilityResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, EnableHostAvailabilityResponseBody) };
    inline EnableHostAvailabilityResponseBody body() { DARABONBA_PTR_GET(body_, EnableHostAvailabilityResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<EnableHostAvailabilityResponseBody> body_ = nullptr;
  };
