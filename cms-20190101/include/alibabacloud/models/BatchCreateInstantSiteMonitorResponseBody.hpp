...
namespace Models
{
  ...
  public:
    ...
    inline const vector<BatchCreateInstantSiteMonitorResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<BatchCreateInstantSiteMonitorResponseBody::Data>) };
    inline vector<BatchCreateInstantSiteMonitorResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<BatchCreateInstantSiteMonitorResponseBody::Data>) };
    inline BatchCreateInstantSiteMonitorResponseBody& setData(const vector<BatchCreateInstantSiteMonitorResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline BatchCreateInstantSiteMonitorResponseBody& setData(vector<BatchCreateInstantSiteMonitorResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    shared_ptr<vector<BatchCreateInstantSiteMonitorResponseBody::Data>> data_ {};
