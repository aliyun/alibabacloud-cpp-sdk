...
namespace Models
{
  ...
  public:
    ...
    inline const EnableSiteMonitorsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableSiteMonitorsResponseBody) };
    inline EnableSiteMonitorsResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableSiteMonitorsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableSiteMonitorsResponseBody> body_ {};
  };
