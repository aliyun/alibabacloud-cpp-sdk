...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMonitorGroupDynamicRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMonitorGroupDynamicRuleResponseBody) };
    inline DeleteMonitorGroupDynamicRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMonitorGroupDynamicRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMonitorGroupDynamicRuleResponseBody> body_ {};
  };
