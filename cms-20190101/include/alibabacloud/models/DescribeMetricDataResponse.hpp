...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMetricDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeMetricDataResponseBody) };
    inline DescribeMetricDataResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeMetricDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeMetricDataResponseBody> body_ {};
  };
