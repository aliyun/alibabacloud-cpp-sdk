...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->alertConfig_ == nullptr
        && return this->groupId_ == nullptr && return this->id_ == nullptr && return this->matchExpress_ == nullptr && return this->matchExpressFilterRelation_ == nullptr && return this->processName_ == nullptr; };
