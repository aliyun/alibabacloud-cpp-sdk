...
namespace Models
{
  ...
  public:
    ...
    inline const CreateGroupMonitoringAgentProcessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateGroupMonitoringAgentProcessResponseBody) };
    inline CreateGroupMonitoringAgentProcessResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateGroupMonitoringAgentProcessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateGroupMonitoringAgentProcessResponseBody> body_ {};
  };
