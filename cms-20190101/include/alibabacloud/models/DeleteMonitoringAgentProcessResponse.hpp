...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteMonitoringAgentProcessResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteMonitoringAgentProcessResponseBody) };
    inline DeleteMonitoringAgentProcessResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteMonitoringAgentProcessResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteMonitoringAgentProcessResponseBody> body_ {};
  };
