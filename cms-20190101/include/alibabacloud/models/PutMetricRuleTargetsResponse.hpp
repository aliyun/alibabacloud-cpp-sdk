...
namespace Models
{
  ...
  public:
    ...
    inline const PutMetricRuleTargetsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PutMetricRuleTargetsResponseBody) };
    inline PutMetricRuleTargetsResponseBody getBody() { DARABONBA_PTR_GET(body_, PutMetricRuleTargetsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PutMetricRuleTargetsResponseBody> body_ {};
  };
