...
namespace Models
{
  ...
  public:
    ...
    inline const CreateMonitorGroupByResourceGroupIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateMonitorGroupByResourceGroupIdResponseBody) };
    inline CreateMonitorGroupByResourceGroupIdResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateMonitorGroupByResourceGroupIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateMonitorGroupByResourceGroupIdResponseBody> body_ {};
  };
