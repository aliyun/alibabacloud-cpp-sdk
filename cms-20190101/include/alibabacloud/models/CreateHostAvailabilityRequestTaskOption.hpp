...
#ifndef ALIBABACLOUD_MODELS_CREATEHOSTAVAILABILITYREQUESTTASKOPTION_HPP_
#define ALIBABACLOUD_MODELS_CREATEHOSTAVAILABILITYREQUESTTASKOPTION_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateHostAvailabilityRequestTaskOption& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateHostAvailabilityRequestTaskOption& obj) { 
    ...
    CreateHostAvailabilityRequestTaskOption() = default ;
    CreateHostAvailabilityRequestTaskOption(const CreateHostAvailabilityRequestTaskOption &) = default ;
    CreateHostAvailabilityRequestTaskOption(CreateHostAvailabilityRequestTaskOption &&) = default ;
    CreateHostAvailabilityRequestTaskOption(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateHostAvailabilityRequestTaskOption() = default ;
    CreateHostAvailabilityRequestTaskOption& operator=(const CreateHostAvailabilityRequestTaskOption &) = default ;
    CreateHostAvailabilityRequestTaskOption& operator=(CreateHostAvailabilityRequestTaskOption &&) = default ;
    ...
    inline CreateHostAvailabilityRequestTaskOption& setHttpHeader(string httpHeader) { DARABONBA_PTR_SET_VALUE(httpHeader_, httpHeader) };
    ...
    inline CreateHostAvailabilityRequestTaskOption& setHttpMethod(string httpMethod) { DARABONBA_PTR_SET_VALUE(httpMethod_, httpMethod) };
    ...
    inline CreateHostAvailabilityRequestTaskOption& setHttpNegative(bool httpNegative) { DARABONBA_PTR_SET_VALUE(httpNegative_, httpNegative) };
    ...
    inline CreateHostAvailabilityRequestTaskOption& setHttpPostContent(string httpPostContent) { DARABONBA_PTR_SET_VALUE(httpPostContent_, httpPostContent) };
    ...
    inline CreateHostAvailabilityRequestTaskOption& setHttpResponseCharset(string httpResponseCharset) { DARABONBA_PTR_SET_VALUE(httpResponseCharset_, httpResponseCharset) };
    ...
    inline CreateHostAvailabilityRequestTaskOption& setHttpResponseMatchContent(string httpResponseMatchContent) { DARABONBA_PTR_SET_VALUE(httpResponseMatchContent_, httpResponseMatchContent) };
    ...
    inline CreateHostAvailabilityRequestTaskOption& setHttpURI(string httpURI) { DARABONBA_PTR_SET_VALUE(httpURI_, httpURI) };
    ...
    inline CreateHostAvailabilityRequestTaskOption& setInterval(int32_t interval) { DARABONBA_PTR_SET_VALUE(interval_, interval) };
    ...
    inline CreateHostAvailabilityRequestTaskOption& setTelnetOrPingHost(string telnetOrPingHost) { DARABONBA_PTR_SET_VALUE(telnetOrPingHost_, telnetOrPingHost) };
