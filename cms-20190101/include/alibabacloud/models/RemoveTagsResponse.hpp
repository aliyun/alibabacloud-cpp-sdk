...
namespace Models
{
  ...
  public:
    ...
    inline const RemoveTagsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RemoveTagsResponseBody) };
    inline RemoveTagsResponseBody getBody() { DARABONBA_PTR_GET(body_, RemoveTagsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RemoveTagsResponseBody> body_ {};
  };
