...
namespace DlfNext20250310
{
  class Client : public AlibabaCloud::OpenApi::Client {
    public:
       ...
       */
      Models::UpdateVpcConfigResponse updateVpcConfigWithOptions(const Models::UpdateVpcConfigRequest &request, const map<string, string> &headers, const Darabonba::RuntimeOptions &runtime);
       ...
       * @return UpdateVpcConfigResponse
       */
      Models::UpdateVpcConfigResponse updateVpcConfig(const Models::UpdateVpcConfigRequest &request);
