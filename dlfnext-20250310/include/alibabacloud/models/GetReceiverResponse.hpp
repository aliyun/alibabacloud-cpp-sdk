...
namespace Models
{
  ...
  public:
    ...
    inline const Receiver & body() const { DARABONBA_PTR_GET_CONST(body_, Receiver) };
    inline Receiver body() { DARABONBA_PTR_GET(body_, Receiver) };
  ...
  protected:
    ...
    std::shared_ptr<Receiver> body_ = nullptr;
  };
