...
namespace Models
{
  ...
  public:
    ...
    inline const AlterDatabaseResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AlterDatabaseResponseBody) };
    inline AlterDatabaseResponseBody getBody() { DARABONBA_PTR_GET(body_, AlterDatabaseResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AlterDatabaseResponseBody> body_ {};
  };
