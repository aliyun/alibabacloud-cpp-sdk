...
namespace Models
{
  ...
  public:
    ...
    inline const ListIcebergNamespaceDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIcebergNamespaceDetailsResponseBody) };
    inline ListIcebergNamespaceDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIcebergNamespaceDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIcebergNamespaceDetailsResponseBody> body_ {};
  };
