...
namespace Models
{
  ...
  public:
    ...
    inline const TableSummary & getBody() const { DARABONBA_PTR_GET_CONST(body_, TableSummary) };
    inline TableSummary getBody() { DARABONBA_PTR_GET(body_, TableSummary) };
