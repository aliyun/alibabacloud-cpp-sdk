...
namespace Models
{
  ...
  public:
    ...
    inline const BatchGrantPermissionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchGrantPermissionsResponseBody) };
    inline BatchGrantPermissionsResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchGrantPermissionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchGrantPermissionsResponseBody> body_ {};
  };
