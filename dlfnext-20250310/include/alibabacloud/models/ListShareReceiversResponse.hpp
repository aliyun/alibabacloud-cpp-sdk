...
namespace Models
{
  ...
  public:
    ...
    inline const ListShareReceiversResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListShareReceiversResponseBody) };
    inline ListShareReceiversResponseBody getBody() { DARABONBA_PTR_GET(body_, ListShareReceiversResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListShareReceiversResponseBody> body_ {};
  };
