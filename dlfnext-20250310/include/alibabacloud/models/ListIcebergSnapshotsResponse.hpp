...
namespace Models
{
  ...
  public:
    ...
    inline const ListIcebergSnapshotsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListIcebergSnapshotsResponseBody) };
    inline ListIcebergSnapshotsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListIcebergSnapshotsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListIcebergSnapshotsResponseBody> body_ {};
  };
