...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->currentValue_ == nullptr
        && return this->lastDayValue_ == nullptr && return this->lastMonthValue_ == nullptr; };
    ...
    inline int64_t lastDayValue() const { DARABONBA_PTR_GET_DEFAULT(lastDayValue_, 0L) };
    ...
    inline int64_t lastMonthValue() const { DARABONBA_PTR_GET_DEFAULT(lastMonthValue_, 0L) };
  ...
  protected:
    ...
    // daily addition
    std::shared_ptr<int64_t> lastDayValue_ = nullptr;
    // monthly addition
    std::shared_ptr<int64_t> lastMonthValue_ = nullptr;
  };
