...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->comment_ == nullptr
        && this->createdAt_ == nullptr && this->createdBy_ == nullptr && this->enableWrite_ == nullptr && this->owner_ == nullptr && this->providerTenantId_ == nullptr
    ...
    inline bool getEnableWrite() const { DARABONBA_PTR_GET_DEFAULT(enableWrite_, false) };
    inline Share& setEnableWrite(bool enableWrite) { DARABONBA_PTR_SET_VALUE(enableWrite_, enableWrite) };
    ...
    inline int64_t getProviderTenantId() const { DARABONBA_PTR_GET_DEFAULT(providerTenantId_, 0L) };
