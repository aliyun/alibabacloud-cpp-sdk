...
namespace Models
{
  ...
  public:
    ...
    inline const TableCompaction & getBody() const { DARABONBA_PTR_GET_CONST(body_, TableCompaction) };
    inline TableCompaction getBody() { DARABONBA_PTR_GET(body_, TableCompaction) };
  ...
  protected:
    ...
    shared_ptr<TableCompaction> body_ {};
  };
