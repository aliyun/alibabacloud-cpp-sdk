...
namespace Models
{
  ...
  public:
    ...
    inline const Table & body() const { DARABONBA_PTR_GET_CONST(body_, Table) };
    inline Table body() { DARABONBA_PTR_GET(body_, Table) };
    inline GetTableResponse& setBody(const Table & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline GetTableResponse& setBody(Table && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<Table> body_ = nullptr;
  };
