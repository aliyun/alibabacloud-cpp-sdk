...
namespace Models
{
  ...
  public:
    ...
    inline const ListShareResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListShareResourcesResponseBody) };
    inline ListShareResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListShareResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListShareResourcesResponseBody> body_ {};
  };
