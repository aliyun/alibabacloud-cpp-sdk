...
namespace Models
{
  ...
  public:
    ...
    inline const DatabaseSummary & getBody() const { DARABONBA_PTR_GET_CONST(body_, DatabaseSummary) };
    inline DatabaseSummary getBody() { DARABONBA_PTR_GET(body_, DatabaseSummary) };
  ...
  protected:
    ...
    shared_ptr<DatabaseSummary> body_ {};
  };
