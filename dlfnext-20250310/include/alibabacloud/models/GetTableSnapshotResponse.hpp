...
namespace Models
{
  ...
  public:
    ...
    inline const TableSnapshot & getBody() const { DARABONBA_PTR_GET_CONST(body_, TableSnapshot) };
    inline TableSnapshot getBody() { DARABONBA_PTR_GET(body_, TableSnapshot) };
  ...
  protected:
    ...
    shared_ptr<TableSnapshot> body_ {};
  };
