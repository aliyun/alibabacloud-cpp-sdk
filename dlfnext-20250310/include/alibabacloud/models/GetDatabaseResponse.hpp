...
namespace Models
{
  ...
  public:
    ...
    inline const Database & getBody() const { DARABONBA_PTR_GET_CONST(body_, Database) };
    inline Database getBody() { DARABONBA_PTR_GET(body_, Database) };
