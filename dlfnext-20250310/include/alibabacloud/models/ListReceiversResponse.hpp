...
namespace Models
{
  ...
  public:
    ...
    inline const ListReceiversResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListReceiversResponseBody) };
    inline ListReceiversResponseBody getBody() { DARABONBA_PTR_GET(body_, ListReceiversResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListReceiversResponseBody> body_ {};
  };
