...
namespace Models
{
  ...
  public:
    ...
    inline int32_t catalogSizeLimit() const { DARABONBA_PTR_GET_DEFAULT(catalogSizeLimit_, 0) };
    ...
    inline int32_t receiverSizeLimit() const { DARABONBA_PTR_GET_DEFAULT(receiverSizeLimit_, 0) };
    ...
    inline int32_t shareResourceSizeLimit() const { DARABONBA_PTR_GET_DEFAULT(shareResourceSizeLimit_, 0) };
    ...
    inline int32_t shareSizeLimit() const { DARABONBA_PTR_GET_DEFAULT(shareSizeLimit_, 0) };
    inline ShareOptions& setShareSizeLimit(int32_t shareSizeLimit) { DARABONBA_PTR_SET_VALUE(shareSizeLimit_, shareSizeLimit) };


  protected:
    std::shared_ptr<int32_t> catalogSizeLimit_ = nullptr;
    std::shared_ptr<int32_t> receiverSizeLimit_ = nullptr;
    std::shared_ptr<int32_t> shareResourceSizeLimit_ = nullptr;
    std::shared_ptr<int32_t> shareSizeLimit_ = nullptr;
  };
