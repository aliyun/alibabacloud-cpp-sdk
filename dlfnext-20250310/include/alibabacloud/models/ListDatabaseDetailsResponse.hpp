...
namespace Models
{
  ...
  public:
    ...
    inline const ListDatabaseDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDatabaseDetailsResponseBody) };
    inline ListDatabaseDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDatabaseDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDatabaseDetailsResponseBody> body_ {};
  };
