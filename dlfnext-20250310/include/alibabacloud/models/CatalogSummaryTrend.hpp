...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DateSummary> & getApiVisitCount() const { DARABONBA_PTR_GET_CONST(apiVisitCount_, vector<DateSummary>) };
    inline vector<DateSummary> getApiVisitCount() { DARABONBA_PTR_GET(apiVisitCount_, vector<DateSummary>) };
    ...
    inline const vector<DateSummary> & getFileAccessCount() const { DARABONBA_PTR_GET_CONST(fileAccessCount_, vector<DateSummary>) };
    inline vector<DateSummary> getFileAccessCount() { DARABONBA_PTR_GET(fileAccessCount_, vector<DateSummary>) };
    ...
    inline const vector<DateSummary> & getThroughput() const { DARABONBA_PTR_GET_CONST(throughput_, vector<DateSummary>) };
    inline vector<DateSummary> getThroughput() { DARABONBA_PTR_GET(throughput_, vector<DateSummary>) };
    ...
    inline const vector<DateSummary> & getTotalFileCount() const { DARABONBA_PTR_GET_CONST(totalFileCount_, vector<DateSummary>) };
    inline vector<DateSummary> getTotalFileCount() { DARABONBA_PTR_GET(totalFileCount_, vector<DateSummary>) };
    ...
    inline const vector<DateSummary> & getTotalFileSizeInBytes() const { DARABONBA_PTR_GET_CONST(totalFileSizeInBytes_, vector<DateSummary>) };
    inline vector<DateSummary> getTotalFileSizeInBytes() { DARABONBA_PTR_GET(totalFileSizeInBytes_, vector<DateSummary>) };
    ...
    inline const vector<DateSummary> & getTotalMetaCount() const { DARABONBA_PTR_GET_CONST(totalMetaCount_, vector<DateSummary>) };
    inline vector<DateSummary> getTotalMetaCount() { DARABONBA_PTR_GET(totalMetaCount_, vector<DateSummary>) };
