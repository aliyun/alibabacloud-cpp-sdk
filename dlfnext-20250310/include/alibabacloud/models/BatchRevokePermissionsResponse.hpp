...
namespace Models
{
  ...
  public:
    ...
    inline const BatchRevokePermissionsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, BatchRevokePermissionsResponseBody) };
    inline BatchRevokePermissionsResponseBody body() { DARABONBA_PTR_GET(body_, BatchRevokePermissionsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<BatchRevokePermissionsResponseBody> body_ = nullptr;
  };
