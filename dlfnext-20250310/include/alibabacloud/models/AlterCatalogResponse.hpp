...
namespace Models
{
  ...
  public:
    ...
    inline const AlterCatalogResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AlterCatalogResponseBody) };
    inline AlterCatalogResponseBody getBody() { DARABONBA_PTR_GET(body_, AlterCatalogResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AlterCatalogResponseBody> body_ {};
  };
