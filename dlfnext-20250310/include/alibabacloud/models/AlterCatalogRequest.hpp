...
namespace Models
{
  ...
  public:
    ...
    inline const map<string, string> & getUpdates() const { DARABONBA_PTR_GET_CONST(updates_, map<string, string>) };
    inline map<string, string> getUpdates() { DARABONBA_PTR_GET(updates_, map<string, string>) };
