...
namespace Models
{
  ...
  public:
    ...
    inline GetCatalogResponse& setBody(const Catalog & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline GetCatalogResponse& setBody(Catalog && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
