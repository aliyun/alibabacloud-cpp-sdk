...
namespace Models
{
  ...
  public:
    ...
    inline const ListPartitionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListPartitionsResponseBody) };
    inline ListPartitionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListPartitionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListPartitionsResponseBody> body_ {};
  };
