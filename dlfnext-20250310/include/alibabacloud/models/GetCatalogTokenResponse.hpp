...
namespace Models
{
  ...
  public:
    ...
    inline const GetCatalogTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetCatalogTokenResponseBody) };
    inline GetCatalogTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, GetCatalogTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetCatalogTokenResponseBody> body_ {};
  };
