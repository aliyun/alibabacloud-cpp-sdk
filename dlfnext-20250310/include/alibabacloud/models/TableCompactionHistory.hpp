...
namespace Models
{
  ...
  public:
    ...
    inline int64_t getAfterFilesCount() const { DARABONBA_PTR_GET_DEFAULT(afterFilesCount_, 0L) };
    ...
    inline int64_t getAfterFilesSize() const { DARABONBA_PTR_GET_DEFAULT(afterFilesSize_, 0L) };
    ...
    inline int64_t getBeforeFilesCount() const { DARABONBA_PTR_GET_DEFAULT(beforeFilesCount_, 0L) };
    ...
    inline int64_t getBeforeFilesLastCreationTime() const { DARABONBA_PTR_GET_DEFAULT(beforeFilesLastCreationTime_, 0L) };
    ...
    inline int64_t getBeforeFilesSize() const { DARABONBA_PTR_GET_DEFAULT(beforeFilesSize_, 0L) };
