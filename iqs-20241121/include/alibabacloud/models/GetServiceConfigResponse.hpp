...
namespace Models
{
  ...
  public:
    ...
    inline GetServiceConfigResponse& setBody(const ServiceConfigResult & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline GetServiceConfigResponse& setBody(ServiceConfigResult && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
