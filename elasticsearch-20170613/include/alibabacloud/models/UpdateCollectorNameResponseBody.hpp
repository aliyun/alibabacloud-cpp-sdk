...
#ifndef ALIBABACLOUD_MODELS_UPDATECOLLECTORNAMERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATECOLLECTORNAMERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateCollectorNameResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Result, result_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateCollectorNameResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Result, result_);
    };
    UpdateCollectorNameResponseBody() = default ;
    UpdateCollectorNameResponseBody(const UpdateCollectorNameResponseBody &) = default ;
    UpdateCollectorNameResponseBody(UpdateCollectorNameResponseBody &&) = default ;
    UpdateCollectorNameResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateCollectorNameResponseBody() = default ;
    UpdateCollectorNameResponseBody& operator=(const UpdateCollectorNameResponseBody &) = default ;
    UpdateCollectorNameResponseBody& operator=(UpdateCollectorNameResponseBody &&) = default ;
    ...
    inline UpdateCollectorNameResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const UpdateCollectorNameResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, UpdateCollectorNameResponseBody::Result) };
    inline UpdateCollectorNameResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, UpdateCollectorNameResponseBody::Result) };
    inline UpdateCollectorNameResponseBody& setResult(const UpdateCollectorNameResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateCollectorNameResponseBody& setResult(UpdateCollectorNameResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    shared_ptr<UpdateCollectorNameResponseBody::Result> result_ {};
  };
