...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePrivateNetworkWhiteIpsResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, UpdatePrivateNetworkWhiteIpsResponseBodyResult) };
    inline UpdatePrivateNetworkWhiteIpsResponseBodyResult result() { DARABONBA_PTR_GET(result_, UpdatePrivateNetworkWhiteIpsResponseBodyResult) };
    inline UpdatePrivateNetworkWhiteIpsResponseBody& setResult(const UpdatePrivateNetworkWhiteIpsResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdatePrivateNetworkWhiteIpsResponseBody& setResult(UpdatePrivateNetworkWhiteIpsResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<UpdatePrivateNetworkWhiteIpsResponseBodyResult> result_ = nullptr;
  };
