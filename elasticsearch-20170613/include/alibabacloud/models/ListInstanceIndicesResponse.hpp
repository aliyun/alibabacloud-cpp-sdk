...
namespace Models
{
  ...
  public:
    ...
    inline const ListInstanceIndicesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListInstanceIndicesResponseBody) };
    inline ListInstanceIndicesResponseBody body() { DARABONBA_PTR_GET(body_, ListInstanceIndicesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListInstanceIndicesResponseBody> body_ = nullptr;
  };
