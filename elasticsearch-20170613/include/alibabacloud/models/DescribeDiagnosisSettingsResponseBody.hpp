...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDiagnosisSettingsResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeDiagnosisSettingsResponseBodyResult) };
    inline DescribeDiagnosisSettingsResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeDiagnosisSettingsResponseBodyResult) };
    inline DescribeDiagnosisSettingsResponseBody& setResult(const DescribeDiagnosisSettingsResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeDiagnosisSettingsResponseBody& setResult(DescribeDiagnosisSettingsResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The return results.
    std::shared_ptr<DescribeDiagnosisSettingsResponseBodyResult> result_ = nullptr;
  };
