...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeConnectableClustersResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<DescribeConnectableClustersResponseBodyResult>) };
    inline vector<DescribeConnectableClustersResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<DescribeConnectableClustersResponseBodyResult>) };
    inline DescribeConnectableClustersResponseBody& setResult(const vector<DescribeConnectableClustersResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeConnectableClustersResponseBody& setResult(vector<DescribeConnectableClustersResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<DescribeConnectableClustersResponseBodyResult>> result_ = nullptr;
  };
