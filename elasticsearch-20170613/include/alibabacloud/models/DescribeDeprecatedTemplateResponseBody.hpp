...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDeprecatedTemplateResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, DescribeDeprecatedTemplateResponseBody::Result) };
    inline DescribeDeprecatedTemplateResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, DescribeDeprecatedTemplateResponseBody::Result) };
    inline DescribeDeprecatedTemplateResponseBody& setResult(const DescribeDeprecatedTemplateResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeDeprecatedTemplateResponseBody& setResult(DescribeDeprecatedTemplateResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
