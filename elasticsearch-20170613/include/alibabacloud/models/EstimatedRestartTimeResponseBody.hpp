...
namespace Models
{
  ...
  public:
    ...
    inline const EstimatedRestartTimeResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, EstimatedRestartTimeResponseBodyResult) };
    inline EstimatedRestartTimeResponseBodyResult result() { DARABONBA_PTR_GET(result_, EstimatedRestartTimeResponseBodyResult) };
    inline EstimatedRestartTimeResponseBody& setResult(const EstimatedRestartTimeResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline EstimatedRestartTimeResponseBody& setResult(EstimatedRestartTimeResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<EstimatedRestartTimeResponseBodyResult> result_ = nullptr;
  };
