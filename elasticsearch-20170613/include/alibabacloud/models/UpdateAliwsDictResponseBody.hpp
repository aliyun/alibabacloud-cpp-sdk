...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateAliwsDictResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<UpdateAliwsDictResponseBodyResult>) };
    inline vector<UpdateAliwsDictResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<UpdateAliwsDictResponseBodyResult>) };
    inline UpdateAliwsDictResponseBody& setResult(const vector<UpdateAliwsDictResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateAliwsDictResponseBody& setResult(vector<UpdateAliwsDictResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<vector<UpdateAliwsDictResponseBodyResult>> result_ = nullptr;
  };
