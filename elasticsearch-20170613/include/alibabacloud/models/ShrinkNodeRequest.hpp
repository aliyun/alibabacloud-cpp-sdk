...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ShrinkNodeRequest::Body> & getBody() const { DARABONBA_PTR_GET_CONST(body_, vector<ShrinkNodeRequest::Body>) };
    inline vector<ShrinkNodeRequest::Body> getBody() { DARABONBA_PTR_GET(body_, vector<ShrinkNodeRequest::Body>) };
    inline ShrinkNodeRequest& setBody(const vector<ShrinkNodeRequest::Body> & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ShrinkNodeRequest& setBody(vector<ShrinkNodeRequest::Body> && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };
  ...
  protected:
    shared_ptr<vector<ShrinkNodeRequest::Body>> body_ {};
