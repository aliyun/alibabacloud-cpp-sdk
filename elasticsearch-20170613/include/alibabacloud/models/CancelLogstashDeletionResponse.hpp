...
namespace Models
{
  ...
  public:
    ...
    inline const CancelLogstashDeletionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelLogstashDeletionResponseBody) };
    inline CancelLogstashDeletionResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelLogstashDeletionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelLogstashDeletionResponseBody> body_ {};
  };
