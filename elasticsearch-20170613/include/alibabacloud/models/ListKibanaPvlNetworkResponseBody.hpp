...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListKibanaPvlNetworkResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListKibanaPvlNetworkResponseBodyResult>) };
    inline vector<ListKibanaPvlNetworkResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListKibanaPvlNetworkResponseBodyResult>) };
    inline ListKibanaPvlNetworkResponseBody& setResult(const vector<ListKibanaPvlNetworkResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListKibanaPvlNetworkResponseBody& setResult(vector<ListKibanaPvlNetworkResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    // request id
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<ListKibanaPvlNetworkResponseBodyResult>> result_ = nullptr;
  };
