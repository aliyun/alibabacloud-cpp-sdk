...
namespace Models
{
  ...
  public:
    ...
    inline const InterruptElasticsearchTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, InterruptElasticsearchTaskResponseBody) };
    inline InterruptElasticsearchTaskResponseBody body() { DARABONBA_PTR_GET(body_, InterruptElasticsearchTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<InterruptElasticsearchTaskResponseBody> body_ = nullptr;
  };
