...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeInstanceResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeInstanceResponseBodyResult) };
    inline DescribeInstanceResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeInstanceResponseBodyResult) };
    inline DescribeInstanceResponseBody& setResult(const DescribeInstanceResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeInstanceResponseBody& setResult(DescribeInstanceResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<DescribeInstanceResponseBodyResult> result_ = nullptr;
  };
