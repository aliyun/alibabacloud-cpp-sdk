...
namespace Models
{
  ...
  public:
    ...
    inline const ListDictInformationResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, ListDictInformationResponseBodyResult) };
    inline ListDictInformationResponseBodyResult result() { DARABONBA_PTR_GET(result_, ListDictInformationResponseBodyResult) };
    inline ListDictInformationResponseBody& setResult(const ListDictInformationResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListDictInformationResponseBody& setResult(ListDictInformationResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<ListDictInformationResponseBodyResult> result_ = nullptr;
  };
