...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeLogstashResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeLogstashResponseBodyResult) };
    inline DescribeLogstashResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeLogstashResponseBodyResult) };
    inline DescribeLogstashResponseBody& setResult(const DescribeLogstashResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeLogstashResponseBody& setResult(DescribeLogstashResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeLogstashResponseBodyResult> result_ = nullptr;
  };
