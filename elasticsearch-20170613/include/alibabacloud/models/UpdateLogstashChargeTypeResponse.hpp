...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLogstashChargeTypeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateLogstashChargeTypeResponseBody) };
    inline UpdateLogstashChargeTypeResponseBody body() { DARABONBA_PTR_GET(body_, UpdateLogstashChargeTypeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateLogstashChargeTypeResponseBody> body_ = nullptr;
  };
