...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateComponentIndexRequest::Template & getTemplate() const { DARABONBA_PTR_GET_CONST(template_, UpdateComponentIndexRequest::Template) };
    inline UpdateComponentIndexRequest::Template getTemplate() { DARABONBA_PTR_GET(template_, UpdateComponentIndexRequest::Template) };
    inline UpdateComponentIndexRequest& setTemplate(const UpdateComponentIndexRequest::Template & _template) { DARABONBA_PTR_SET_VALUE(template_, _template) };
    inline UpdateComponentIndexRequest& setTemplate(UpdateComponentIndexRequest::Template && _template) { DARABONBA_PTR_SET_RVALUE(template_, _template) };
