...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListSnapshotReposByInstanceIdResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListSnapshotReposByInstanceIdResponseBodyResult>) };
    inline vector<ListSnapshotReposByInstanceIdResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListSnapshotReposByInstanceIdResponseBodyResult>) };
    inline ListSnapshotReposByInstanceIdResponseBody& setResult(const vector<ListSnapshotReposByInstanceIdResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListSnapshotReposByInstanceIdResponseBody& setResult(vector<ListSnapshotReposByInstanceIdResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The return results.
    std::shared_ptr<vector<ListSnapshotReposByInstanceIdResponseBodyResult>> result_ = nullptr;
  };
