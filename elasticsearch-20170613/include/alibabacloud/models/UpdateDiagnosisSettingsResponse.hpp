...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDiagnosisSettingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDiagnosisSettingsResponseBody) };
    inline UpdateDiagnosisSettingsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDiagnosisSettingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDiagnosisSettingsResponseBody> body_ {};
  };
