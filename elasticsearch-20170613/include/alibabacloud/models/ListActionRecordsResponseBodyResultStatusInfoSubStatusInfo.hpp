...
#ifndef ALIBABACLOUD_MODELS_LISTACTIONRECORDSRESPONSEBODYRESULTSTATUSINFOSUBSTATUSINFO_HPP_
#define ALIBABACLOUD_MODELS_LISTACTIONRECORDSRESPONSEBODYRESULTSTATUSINFOSUBSTATUSINFO_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& obj) { 
    ...
    ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo() = default ;
    ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo(const ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo &) = default ;
    ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo(ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo &&) = default ;
    ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo() = default ;
    ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& operator=(const ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo &) = default ;
    ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& operator=(ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo &&) = default ;
    ...
    inline ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& setCompleteNodeCount(int32_t completeNodeCount) { DARABONBA_PTR_SET_VALUE(completeNodeCount_, completeNodeCount) };
    ...
    inline ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& setEndTime(int64_t endTime) { DARABONBA_PTR_SET_VALUE(endTime_, endTime) };
    ...
    inline ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& setException(string exception) { DARABONBA_PTR_SET_VALUE(exception_, exception) };
    ...
    inline ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& setLatencyMills(int64_t latencyMills) { DARABONBA_PTR_SET_VALUE(latencyMills_, latencyMills) };
    ...
    inline ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& setNodeCount(int32_t nodeCount) { DARABONBA_PTR_SET_VALUE(nodeCount_, nodeCount) };
    ...
    inline ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& setProcess(string process) { DARABONBA_PTR_SET_VALUE(process_, process) };
    ...
    inline ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& setStartTime(int64_t startTime) { DARABONBA_PTR_SET_VALUE(startTime_, startTime) };
    ...
    inline ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& setStateType(string stateType) { DARABONBA_PTR_SET_VALUE(stateType_, stateType) };
    ...
    inline ListActionRecordsResponseBodyResultStatusInfoSubStatusInfo& setSubState(string subState) { DARABONBA_PTR_SET_VALUE(subState_, subState) };
