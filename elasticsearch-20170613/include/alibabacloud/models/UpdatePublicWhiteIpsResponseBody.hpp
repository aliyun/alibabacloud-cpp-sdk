...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePublicWhiteIpsResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, UpdatePublicWhiteIpsResponseBodyResult) };
    inline UpdatePublicWhiteIpsResponseBodyResult result() { DARABONBA_PTR_GET(result_, UpdatePublicWhiteIpsResponseBodyResult) };
    inline UpdatePublicWhiteIpsResponseBody& setResult(const UpdatePublicWhiteIpsResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdatePublicWhiteIpsResponseBody& setResult(UpdatePublicWhiteIpsResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<UpdatePublicWhiteIpsResponseBodyResult> result_ = nullptr;
  };
