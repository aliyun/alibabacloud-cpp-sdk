...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateConnectionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ValidateConnectionResponseBody) };
    inline ValidateConnectionResponseBody body() { DARABONBA_PTR_GET(body_, ValidateConnectionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ValidateConnectionResponseBody> body_ = nullptr;
  };
