...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAdvancedSettingResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateAdvancedSettingResponseBody) };
    inline UpdateAdvancedSettingResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateAdvancedSettingResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateAdvancedSettingResponseBody> body_ {};
  };
