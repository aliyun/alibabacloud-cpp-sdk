...
namespace Models
{
  ...
  public:
    ...
    inline ListVpcEndpointsRequest& setPage(int32_t page) { DARABONBA_PTR_SET_VALUE(page_, page) };
    ...
    inline ListVpcEndpointsRequest& setSize(int32_t size) { DARABONBA_PTR_SET_VALUE(size_, size) };
