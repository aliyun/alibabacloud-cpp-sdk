...
namespace Models
{
  ...
  public:
    ...
    inline const ListExtendfilesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListExtendfilesResponseBody) };
    inline ListExtendfilesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListExtendfilesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListExtendfilesResponseBody> body_ {};
  };
