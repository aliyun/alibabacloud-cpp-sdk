...
namespace Models
{
  ...
  public:
    ...
    inline const ListLogstashPluginsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListLogstashPluginsResponseBody) };
    inline ListLogstashPluginsResponseBody body() { DARABONBA_PTR_GET(body_, ListLogstashPluginsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListLogstashPluginsResponseBody> body_ = nullptr;
  };
