...
namespace Models
{
  ...
  public:
    ...
    inline const Elasticsearch::AdvancedSetting & getAdvancedSetting() const { DARABONBA_PTR_GET_CONST(advancedSetting_, Elasticsearch::AdvancedSetting) };
    inline Elasticsearch::AdvancedSetting getAdvancedSetting() { DARABONBA_PTR_GET(advancedSetting_, Elasticsearch::AdvancedSetting) };
    inline Elasticsearch& setAdvancedSetting(const Elasticsearch::AdvancedSetting & advancedSetting) { DARABONBA_PTR_SET_VALUE(advancedSetting_, advancedSetting) };
    inline Elasticsearch& setAdvancedSetting(Elasticsearch::AdvancedSetting && advancedSetting) { DARABONBA_PTR_SET_RVALUE(advancedSetting_, advancedSetting) };
    ...
    inline const vector<DictInfo> & getAliwsDicts() const { DARABONBA_PTR_GET_CONST(aliwsDicts_, vector<DictInfo>) };
    inline vector<DictInfo> getAliwsDicts() { DARABONBA_PTR_GET(aliwsDicts_, vector<DictInfo>) };
    ...
    inline const vector<DictInfo> & getDictList() const { DARABONBA_PTR_GET_CONST(dictList_, vector<DictInfo>) };
    inline vector<DictInfo> getDictList() { DARABONBA_PTR_GET(dictList_, vector<DictInfo>) };
    ...
    inline bool getHaveElasticDataNode() const { DARABONBA_PTR_GET_DEFAULT(haveElasticDataNode_, false) };
    ...
    inline const vector<DictInfo> & getIkHotDicts() const { DARABONBA_PTR_GET_CONST(ikHotDicts_, vector<DictInfo>) };
    inline vector<DictInfo> getIkHotDicts() { DARABONBA_PTR_GET(ikHotDicts_, vector<DictInfo>) };
    ...
    inline int64_t getKibanaPort() const { DARABONBA_PTR_GET_DEFAULT(kibanaPort_, 0L) };
    ...
    inline int64_t getKibanaPrivatePort() const { DARABONBA_PTR_GET_DEFAULT(kibanaPrivatePort_, 0L) };
    ...
    inline string getKibanaProtocol() const { DARABONBA_PTR_GET_DEFAULT(kibanaProtocol_, "") };
    ...
    inline int64_t getPublicPort() const { DARABONBA_PTR_GET_DEFAULT(publicPort_, 0L) };
    ...
    inline const ReadWritePolicy & getReadWritePolicy() const { DARABONBA_PTR_GET_CONST(readWritePolicy_, ReadWritePolicy) };
    inline ReadWritePolicy getReadWritePolicy() { DARABONBA_PTR_GET(readWritePolicy_, ReadWritePolicy) };
    ...
    inline const vector<DictInfo> & getSynonymsDicts() const { DARABONBA_PTR_GET_CONST(synonymsDicts_, vector<DictInfo>) };
    inline vector<DictInfo> getSynonymsDicts() { DARABONBA_PTR_GET(synonymsDicts_, vector<DictInfo>) };
    ...
    inline const vector<ZoneInfo> & getZoneInfos() const { DARABONBA_PTR_GET_CONST(zoneInfos_, vector<ZoneInfo>) };
    inline vector<ZoneInfo> getZoneInfos() { DARABONBA_PTR_GET(zoneInfos_, vector<ZoneInfo>) };
