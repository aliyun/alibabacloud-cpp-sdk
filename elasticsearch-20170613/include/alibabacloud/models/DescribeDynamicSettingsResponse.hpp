...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDynamicSettingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDynamicSettingsResponseBody) };
    inline DescribeDynamicSettingsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDynamicSettingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDynamicSettingsResponseBody> body_ {};
  };
