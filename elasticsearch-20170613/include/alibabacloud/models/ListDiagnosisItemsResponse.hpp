...
namespace Models
{
  ...
  public:
    ...
    inline const ListDiagnosisItemsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDiagnosisItemsResponseBody) };
    inline ListDiagnosisItemsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDiagnosisItemsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDiagnosisItemsResponseBody> body_ {};
  };
