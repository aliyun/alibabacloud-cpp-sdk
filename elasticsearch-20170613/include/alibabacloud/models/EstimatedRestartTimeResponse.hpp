...
namespace Models
{
  ...
  public:
    ...
    inline const EstimatedRestartTimeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EstimatedRestartTimeResponseBody) };
    inline EstimatedRestartTimeResponseBody getBody() { DARABONBA_PTR_GET(body_, EstimatedRestartTimeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EstimatedRestartTimeResponseBody> body_ {};
  };
