...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeTemplatesResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<DescribeTemplatesResponseBodyResult>) };
    inline vector<DescribeTemplatesResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<DescribeTemplatesResponseBodyResult>) };
    inline DescribeTemplatesResponseBody& setResult(const vector<DescribeTemplatesResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeTemplatesResponseBody& setResult(vector<DescribeTemplatesResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<DescribeTemplatesResponseBodyResult>> result_ = nullptr;
  };
