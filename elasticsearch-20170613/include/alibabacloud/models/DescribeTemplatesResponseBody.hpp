...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeTemplatesResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<DescribeTemplatesResponseBody::Result>) };
    inline vector<DescribeTemplatesResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<DescribeTemplatesResponseBody::Result>) };
    inline DescribeTemplatesResponseBody& setResult(const vector<DescribeTemplatesResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeTemplatesResponseBody& setResult(vector<DescribeTemplatesResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
