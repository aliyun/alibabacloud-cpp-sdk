...
namespace Models
{
  ...
  public:
    ...
    inline const GetElastictaskResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetElastictaskResponseBodyResult) };
    inline GetElastictaskResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetElastictaskResponseBodyResult) };
    inline GetElastictaskResponseBody& setResult(const GetElastictaskResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetElastictaskResponseBody& setResult(GetElastictaskResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<GetElastictaskResponseBodyResult> result_ = nullptr;
  };
