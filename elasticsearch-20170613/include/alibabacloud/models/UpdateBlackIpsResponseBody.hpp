...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateBlackIpsResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, UpdateBlackIpsResponseBodyResult) };
    inline UpdateBlackIpsResponseBodyResult result() { DARABONBA_PTR_GET(result_, UpdateBlackIpsResponseBodyResult) };
    inline UpdateBlackIpsResponseBody& setResult(const UpdateBlackIpsResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateBlackIpsResponseBody& setResult(UpdateBlackIpsResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<UpdateBlackIpsResponseBodyResult> result_ = nullptr;
  };
