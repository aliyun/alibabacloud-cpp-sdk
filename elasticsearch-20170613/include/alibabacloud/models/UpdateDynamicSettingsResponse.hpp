...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDynamicSettingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateDynamicSettingsResponseBody) };
    inline UpdateDynamicSettingsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateDynamicSettingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateDynamicSettingsResponseBody> body_ {};
  };
