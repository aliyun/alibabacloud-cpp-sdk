...
namespace Models
{
  ...
  public:
    ...
    inline const ListAckNamespacesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAckNamespacesResponseBody) };
    inline ListAckNamespacesResponseBody body() { DARABONBA_PTR_GET(body_, ListAckNamespacesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAckNamespacesResponseBody> body_ = nullptr;
  };
