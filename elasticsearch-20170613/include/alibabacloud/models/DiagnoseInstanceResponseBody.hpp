...
namespace Models
{
  ...
  public:
    ...
    inline const DiagnoseInstanceResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DiagnoseInstanceResponseBodyResult) };
    inline DiagnoseInstanceResponseBodyResult result() { DARABONBA_PTR_GET(result_, DiagnoseInstanceResponseBodyResult) };
    inline DiagnoseInstanceResponseBody& setResult(const DiagnoseInstanceResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DiagnoseInstanceResponseBody& setResult(DiagnoseInstanceResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<DiagnoseInstanceResponseBodyResult> result_ = nullptr;
  };
