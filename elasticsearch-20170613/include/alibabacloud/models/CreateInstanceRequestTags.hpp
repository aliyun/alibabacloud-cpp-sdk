...
namespace Models
{
  ...
  public:
    ...
    inline CreateInstanceRequestTags& setTagKey(string tagKey) { DARABONBA_PTR_SET_VALUE(tagKey_, tagKey) };
    ...
    inline CreateInstanceRequestTags& setTagValue(string tagValue) { DARABONBA_PTR_SET_VALUE(tagValue_, tagValue) };
