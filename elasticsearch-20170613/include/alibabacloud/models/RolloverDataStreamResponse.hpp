...
namespace Models
{
  ...
  public:
    ...
    inline const RolloverDataStreamResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RolloverDataStreamResponseBody) };
    inline RolloverDataStreamResponseBody getBody() { DARABONBA_PTR_GET(body_, RolloverDataStreamResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RolloverDataStreamResponseBody> body_ {};
  };
