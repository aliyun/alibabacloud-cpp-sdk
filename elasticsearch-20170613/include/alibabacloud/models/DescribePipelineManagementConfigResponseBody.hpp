...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePipelineManagementConfigResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribePipelineManagementConfigResponseBodyResult) };
    inline DescribePipelineManagementConfigResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribePipelineManagementConfigResponseBodyResult) };
    inline DescribePipelineManagementConfigResponseBody& setResult(const DescribePipelineManagementConfigResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribePipelineManagementConfigResponseBody& setResult(DescribePipelineManagementConfigResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<DescribePipelineManagementConfigResponseBodyResult> result_ = nullptr;
  };
