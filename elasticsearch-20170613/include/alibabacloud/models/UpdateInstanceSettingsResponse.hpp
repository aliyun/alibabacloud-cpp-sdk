...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateInstanceSettingsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateInstanceSettingsResponseBody) };
    inline UpdateInstanceSettingsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateInstanceSettingsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateInstanceSettingsResponseBody> body_ {};
  };
