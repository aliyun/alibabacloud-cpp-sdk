...
namespace Models
{
  ...
  public:
    ...
    inline const EnableKibanaPvlNetworkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, EnableKibanaPvlNetworkResponseBody) };
    inline EnableKibanaPvlNetworkResponseBody getBody() { DARABONBA_PTR_GET(body_, EnableKibanaPvlNetworkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<EnableKibanaPvlNetworkResponseBody> body_ {};
  };
