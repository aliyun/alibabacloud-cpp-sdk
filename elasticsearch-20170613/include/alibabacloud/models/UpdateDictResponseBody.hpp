...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateDictResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<UpdateDictResponseBodyResult>) };
    inline vector<UpdateDictResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<UpdateDictResponseBodyResult>) };
    inline UpdateDictResponseBody& setResult(const vector<UpdateDictResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateDictResponseBody& setResult(vector<UpdateDictResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<vector<UpdateDictResponseBodyResult>> result_ = nullptr;
  };
