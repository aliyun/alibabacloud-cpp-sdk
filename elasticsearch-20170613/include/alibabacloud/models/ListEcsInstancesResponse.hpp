...
namespace Models
{
  ...
  public:
    ...
    inline const ListEcsInstancesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListEcsInstancesResponseBody) };
    inline ListEcsInstancesResponseBody body() { DARABONBA_PTR_GET(body_, ListEcsInstancesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListEcsInstancesResponseBody> body_ = nullptr;
  };
