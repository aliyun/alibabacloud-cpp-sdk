...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLogstashDescriptionResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, UpdateLogstashDescriptionResponseBody::Result) };
    inline UpdateLogstashDescriptionResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, UpdateLogstashDescriptionResponseBody::Result) };
    inline UpdateLogstashDescriptionResponseBody& setResult(const UpdateLogstashDescriptionResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateLogstashDescriptionResponseBody& setResult(UpdateLogstashDescriptionResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
