...
#ifndef ALIBABACLOUD_MODELS_DESCRIBECOLLECTORRESPONSEBODYRESULTEXTENDCONFIGS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBECOLLECTORRESPONSEBODYRESULTEXTENDCONFIGS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeCollectorResponseBodyResultExtendConfigs& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeCollectorResponseBodyResultExtendConfigs& obj) { 
    ...
    DescribeCollectorResponseBodyResultExtendConfigs() = default ;
    DescribeCollectorResponseBodyResultExtendConfigs(const DescribeCollectorResponseBodyResultExtendConfigs &) = default ;
    DescribeCollectorResponseBodyResultExtendConfigs(DescribeCollectorResponseBodyResultExtendConfigs &&) = default ;
    DescribeCollectorResponseBodyResultExtendConfigs(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeCollectorResponseBodyResultExtendConfigs() = default ;
    DescribeCollectorResponseBodyResultExtendConfigs& operator=(const DescribeCollectorResponseBodyResultExtendConfigs &) = default ;
    DescribeCollectorResponseBodyResultExtendConfigs& operator=(DescribeCollectorResponseBodyResultExtendConfigs &&) = default ;
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setConfigType(string configType) { DARABONBA_PTR_SET_VALUE(configType_, configType) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setEnableMonitoring(bool enableMonitoring) { DARABONBA_PTR_SET_VALUE(enableMonitoring_, enableMonitoring) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setGroupId(string groupId) { DARABONBA_PTR_SET_VALUE(groupId_, groupId) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setHost(string host) { DARABONBA_PTR_SET_VALUE(host_, host) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setHosts(const vector<string> & hosts) { DARABONBA_PTR_SET_VALUE(hosts_, hosts) };
    inline DescribeCollectorResponseBodyResultExtendConfigs& setHosts(vector<string> && hosts) { DARABONBA_PTR_SET_RVALUE(hosts_, hosts) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setKibanaHost(string kibanaHost) { DARABONBA_PTR_SET_VALUE(kibanaHost_, kibanaHost) };


    // machines Field Functions 
    bool hasMachines() const { return this->machines_ != nullptr;};
    void deleteMachines() { this->machines_ = nullptr;};
    inline const vector<Models::DescribeCollectorResponseBodyResultExtendConfigsMachines> & machines() const { DARABONBA_PTR_GET_CONST(machines_, vector<Models::DescribeCollectorResponseBodyResultExtendConfigsMachines>) };
    inline vector<Models::DescribeCollectorResponseBodyResultExtendConfigsMachines> machines() { DARABONBA_PTR_GET(machines_, vector<Models::DescribeCollectorResponseBodyResultExtendConfigsMachines>) };
    inline DescribeCollectorResponseBodyResultExtendConfigs& setMachines(const vector<Models::DescribeCollectorResponseBodyResultExtendConfigsMachines> & machines) { DARABONBA_PTR_SET_VALUE(machines_, machines) };
    inline DescribeCollectorResponseBodyResultExtendConfigs& setMachines(vector<Models::DescribeCollectorResponseBodyResultExtendConfigsMachines> && machines) { DARABONBA_PTR_SET_RVALUE(machines_, machines) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setSuccessPodsCount(string successPodsCount) { DARABONBA_PTR_SET_VALUE(successPodsCount_, successPodsCount) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setTotalPodsCount(string totalPodsCount) { DARABONBA_PTR_SET_VALUE(totalPodsCount_, totalPodsCount) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline DescribeCollectorResponseBodyResultExtendConfigs& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::DescribeCollectorResponseBodyResultExtendConfigsMachines>> machines_ = nullptr;
