...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateExtendfilesResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<UpdateExtendfilesResponseBodyResult>) };
    inline vector<UpdateExtendfilesResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<UpdateExtendfilesResponseBodyResult>) };
    inline UpdateExtendfilesResponseBody& setResult(const vector<UpdateExtendfilesResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateExtendfilesResponseBody& setResult(vector<UpdateExtendfilesResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<vector<UpdateExtendfilesResponseBodyResult>> result_ = nullptr;
  };
