...
namespace Models
{
  ...
  public:
    ...
    inline const ListDiagnoseIndicesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDiagnoseIndicesResponseBody) };
    inline ListDiagnoseIndicesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDiagnoseIndicesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDiagnoseIndicesResponseBody> body_ {};
  };
