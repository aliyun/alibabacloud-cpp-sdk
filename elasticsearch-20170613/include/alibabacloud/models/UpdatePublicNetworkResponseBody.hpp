...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePublicNetworkResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, UpdatePublicNetworkResponseBodyResult) };
    inline UpdatePublicNetworkResponseBodyResult result() { DARABONBA_PTR_GET(result_, UpdatePublicNetworkResponseBodyResult) };
    inline UpdatePublicNetworkResponseBody& setResult(const UpdatePublicNetworkResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdatePublicNetworkResponseBody& setResult(UpdatePublicNetworkResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The return results.
    std::shared_ptr<UpdatePublicNetworkResponseBodyResult> result_ = nullptr;
  };
