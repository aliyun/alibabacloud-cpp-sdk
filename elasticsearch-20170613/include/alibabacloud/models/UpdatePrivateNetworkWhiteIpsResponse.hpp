...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePrivateNetworkWhiteIpsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePrivateNetworkWhiteIpsResponseBody) };
    inline UpdatePrivateNetworkWhiteIpsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePrivateNetworkWhiteIpsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePrivateNetworkWhiteIpsResponseBody> body_ {};
  };
