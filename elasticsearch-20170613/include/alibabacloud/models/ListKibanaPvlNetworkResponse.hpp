...
namespace Models
{
  ...
  public:
    ...
    inline const ListKibanaPvlNetworkResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListKibanaPvlNetworkResponseBody) };
    inline ListKibanaPvlNetworkResponseBody getBody() { DARABONBA_PTR_GET(body_, ListKibanaPvlNetworkResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListKibanaPvlNetworkResponseBody> body_ {};
  };
