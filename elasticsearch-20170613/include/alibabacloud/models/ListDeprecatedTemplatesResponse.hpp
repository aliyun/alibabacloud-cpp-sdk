...
namespace Models
{
  ...
  public:
    ...
    inline const ListDeprecatedTemplatesResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListDeprecatedTemplatesResponseBody) };
    inline ListDeprecatedTemplatesResponseBody body() { DARABONBA_PTR_GET(body_, ListDeprecatedTemplatesResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListDeprecatedTemplatesResponseBody> body_ = nullptr;
  };
