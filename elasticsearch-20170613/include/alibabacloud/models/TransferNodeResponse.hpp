...
namespace Models
{
  ...
  public:
    ...
    inline const TransferNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, TransferNodeResponseBody) };
    inline TransferNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, TransferNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<TransferNodeResponseBody> body_ {};
  };
