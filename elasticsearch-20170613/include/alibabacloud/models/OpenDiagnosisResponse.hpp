...
namespace Models
{
  ...
  public:
    ...
    inline const OpenDiagnosisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenDiagnosisResponseBody) };
    inline OpenDiagnosisResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenDiagnosisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenDiagnosisResponseBody> body_ {};
  };
