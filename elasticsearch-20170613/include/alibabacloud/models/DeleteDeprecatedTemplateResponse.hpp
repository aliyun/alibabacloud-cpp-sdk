...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteDeprecatedTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteDeprecatedTemplateResponseBody) };
    inline DeleteDeprecatedTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteDeprecatedTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteDeprecatedTemplateResponseBody> body_ {};
  };
