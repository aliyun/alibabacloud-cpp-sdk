...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeILMPolicyResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeILMPolicyResponseBodyResult) };
    inline DescribeILMPolicyResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeILMPolicyResponseBodyResult) };
    inline DescribeILMPolicyResponseBody& setResult(const DescribeILMPolicyResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeILMPolicyResponseBody& setResult(DescribeILMPolicyResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<DescribeILMPolicyResponseBodyResult> result_ = nullptr;
  };
