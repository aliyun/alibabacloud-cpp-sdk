...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListLogstashLogResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListLogstashLogResponseBodyResult>) };
    inline vector<ListLogstashLogResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListLogstashLogResponseBodyResult>) };
    inline ListLogstashLogResponseBody& setResult(const vector<ListLogstashLogResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListLogstashLogResponseBody& setResult(vector<ListLogstashLogResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListLogstashLogResponseBodyResult>> result_ = nullptr;
  };
