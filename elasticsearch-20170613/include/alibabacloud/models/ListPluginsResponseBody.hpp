...
namespace Models
{
  ...
  public:
    ...
    inline const ListPluginsResponseBody::Headers & getHeaders() const { DARABONBA_PTR_GET_CONST(headers_, ListPluginsResponseBody::Headers) };
    inline ListPluginsResponseBody::Headers getHeaders() { DARABONBA_PTR_GET(headers_, ListPluginsResponseBody::Headers) };
    inline ListPluginsResponseBody& setHeaders(const ListPluginsResponseBody::Headers & headers) { DARABONBA_PTR_SET_VALUE(headers_, headers) };
    inline ListPluginsResponseBody& setHeaders(ListPluginsResponseBody::Headers && headers) { DARABONBA_PTR_SET_RVALUE(headers_, headers) };
    ...
    inline const vector<ListPluginsResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListPluginsResponseBody::Result>) };
    inline vector<ListPluginsResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListPluginsResponseBody::Result>) };
    inline ListPluginsResponseBody& setResult(const vector<ListPluginsResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListPluginsResponseBody& setResult(vector<ListPluginsResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
