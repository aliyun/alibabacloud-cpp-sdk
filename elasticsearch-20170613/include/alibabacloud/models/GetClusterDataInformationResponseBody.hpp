...
namespace Models
{
  ...
  public:
    ...
    inline const GetClusterDataInformationResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetClusterDataInformationResponseBodyResult) };
    inline GetClusterDataInformationResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetClusterDataInformationResponseBodyResult) };
    inline GetClusterDataInformationResponseBody& setResult(const GetClusterDataInformationResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetClusterDataInformationResponseBody& setResult(GetClusterDataInformationResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The return results.
    std::shared_ptr<GetClusterDataInformationResponseBodyResult> result_ = nullptr;
  };
