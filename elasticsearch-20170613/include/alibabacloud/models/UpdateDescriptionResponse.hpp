...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDescriptionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateDescriptionResponseBody) };
    inline UpdateDescriptionResponseBody body() { DARABONBA_PTR_GET(body_, UpdateDescriptionResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateDescriptionResponseBody> body_ = nullptr;
  };
