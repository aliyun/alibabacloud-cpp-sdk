...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateInstanceChargeTypeResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateInstanceChargeTypeResponseBody) };
    inline UpdateInstanceChargeTypeResponseBody body() { DARABONBA_PTR_GET(body_, UpdateInstanceChargeTypeResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateInstanceChargeTypeResponseBody> body_ = nullptr;
  };
