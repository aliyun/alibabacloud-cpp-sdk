...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateDictResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateDictResponseBody) };
    inline UpdateDictResponseBody body() { DARABONBA_PTR_GET(body_, UpdateDictResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateDictResponseBody> body_ = nullptr;
  };
