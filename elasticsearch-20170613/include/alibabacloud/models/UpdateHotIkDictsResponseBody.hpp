...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateHotIkDictsResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<UpdateHotIkDictsResponseBody::Result>) };
    inline vector<UpdateHotIkDictsResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<UpdateHotIkDictsResponseBody::Result>) };
    inline UpdateHotIkDictsResponseBody& setResult(const vector<UpdateHotIkDictsResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateHotIkDictsResponseBody& setResult(vector<UpdateHotIkDictsResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    shared_ptr<vector<UpdateHotIkDictsResponseBody::Result>> result_ {};
  };
