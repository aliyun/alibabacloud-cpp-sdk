...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeCollectorResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, DescribeCollectorResponseBody::Result) };
    inline DescribeCollectorResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, DescribeCollectorResponseBody::Result) };
    inline DescribeCollectorResponseBody& setResult(const DescribeCollectorResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeCollectorResponseBody& setResult(DescribeCollectorResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    shared_ptr<DescribeCollectorResponseBody::Result> result_ {};
  };
