...
namespace Models
{
  ...
  public:
    ...
    inline const EstimatedLogstashRestartTimeResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, EstimatedLogstashRestartTimeResponseBodyResult) };
    inline EstimatedLogstashRestartTimeResponseBodyResult result() { DARABONBA_PTR_GET(result_, EstimatedLogstashRestartTimeResponseBodyResult) };
    inline EstimatedLogstashRestartTimeResponseBody& setResult(const EstimatedLogstashRestartTimeResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline EstimatedLogstashRestartTimeResponseBody& setResult(EstimatedLogstashRestartTimeResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<EstimatedLogstashRestartTimeResponseBodyResult> result_ = nullptr;
  };
