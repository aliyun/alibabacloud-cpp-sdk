...
namespace Models
{
  ...
  public:
    ...
    inline const ShrinkNodeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ShrinkNodeResponseBody) };
    inline ShrinkNodeResponseBody getBody() { DARABONBA_PTR_GET(body_, ShrinkNodeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ShrinkNodeResponseBody> body_ {};
  };
