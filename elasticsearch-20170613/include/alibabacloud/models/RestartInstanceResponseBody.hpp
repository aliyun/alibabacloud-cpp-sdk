...
namespace Models
{
  ...
  public:
    ...
    inline const RestartInstanceResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, RestartInstanceResponseBodyResult) };
    inline RestartInstanceResponseBodyResult result() { DARABONBA_PTR_GET(result_, RestartInstanceResponseBodyResult) };
    inline RestartInstanceResponseBody& setResult(const RestartInstanceResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline RestartInstanceResponseBody& setResult(RestartInstanceResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The return results.
    std::shared_ptr<RestartInstanceResponseBodyResult> result_ = nullptr;
  };
