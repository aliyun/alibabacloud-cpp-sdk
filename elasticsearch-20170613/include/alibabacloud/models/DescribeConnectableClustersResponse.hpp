...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeConnectableClustersResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeConnectableClustersResponseBody) };
    inline DescribeConnectableClustersResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeConnectableClustersResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeConnectableClustersResponseBody> body_ {};
  };
