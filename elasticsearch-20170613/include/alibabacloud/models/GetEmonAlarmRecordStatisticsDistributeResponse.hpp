...
namespace Models
{
  ...
  public:
    ...
    inline const GetEmonAlarmRecordStatisticsDistributeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEmonAlarmRecordStatisticsDistributeResponseBody) };
    inline GetEmonAlarmRecordStatisticsDistributeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEmonAlarmRecordStatisticsDistributeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEmonAlarmRecordStatisticsDistributeResponseBody> body_ {};
  };
