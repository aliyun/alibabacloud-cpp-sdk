...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeComponentIndexResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeComponentIndexResponseBody) };
    inline DescribeComponentIndexResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeComponentIndexResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeComponentIndexResponseBody> body_ {};
  };
