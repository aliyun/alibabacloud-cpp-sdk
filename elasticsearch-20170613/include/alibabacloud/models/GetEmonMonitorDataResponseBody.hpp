...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetEmonMonitorDataResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<GetEmonMonitorDataResponseBody::Result>) };
    inline vector<GetEmonMonitorDataResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<GetEmonMonitorDataResponseBody::Result>) };
    inline GetEmonMonitorDataResponseBody& setResult(const vector<GetEmonMonitorDataResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetEmonMonitorDataResponseBody& setResult(vector<GetEmonMonitorDataResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
