...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateBlackIpsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateBlackIpsResponseBody) };
    inline UpdateBlackIpsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateBlackIpsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateBlackIpsResponseBody> body_ {};
  };
