...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIndexTemplateResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, DescribeIndexTemplateResponseBody::Result) };
    inline DescribeIndexTemplateResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, DescribeIndexTemplateResponseBody::Result) };
    inline DescribeIndexTemplateResponseBody& setResult(const DescribeIndexTemplateResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeIndexTemplateResponseBody& setResult(DescribeIndexTemplateResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
