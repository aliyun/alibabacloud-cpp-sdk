...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateExtendConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateExtendConfigResponseBody) };
    inline UpdateExtendConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateExtendConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateExtendConfigResponseBody> body_ {};
  };
