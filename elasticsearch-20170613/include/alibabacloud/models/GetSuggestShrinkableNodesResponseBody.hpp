...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetSuggestShrinkableNodesResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<GetSuggestShrinkableNodesResponseBodyResult>) };
    inline vector<GetSuggestShrinkableNodesResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<GetSuggestShrinkableNodesResponseBodyResult>) };
    inline GetSuggestShrinkableNodesResponseBody& setResult(const vector<GetSuggestShrinkableNodesResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetSuggestShrinkableNodesResponseBody& setResult(vector<GetSuggestShrinkableNodesResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The return results.
    std::shared_ptr<vector<GetSuggestShrinkableNodesResponseBodyResult>> result_ = nullptr;
  };
