...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLogstashDescriptionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLogstashDescriptionResponseBody) };
    inline UpdateLogstashDescriptionResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLogstashDescriptionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLogstashDescriptionResponseBody> body_ {};
  };
