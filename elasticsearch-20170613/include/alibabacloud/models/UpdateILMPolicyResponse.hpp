...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateILMPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateILMPolicyResponseBody) };
    inline UpdateILMPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateILMPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateILMPolicyResponseBody> body_ {};
  };
