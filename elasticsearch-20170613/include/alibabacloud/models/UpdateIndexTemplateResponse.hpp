...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateIndexTemplateResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateIndexTemplateResponseBody) };
    inline UpdateIndexTemplateResponseBody body() { DARABONBA_PTR_GET(body_, UpdateIndexTemplateResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateIndexTemplateResponseBody> body_ = nullptr;
  };
