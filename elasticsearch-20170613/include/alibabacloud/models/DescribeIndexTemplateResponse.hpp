...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeIndexTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeIndexTemplateResponseBody) };
    inline DescribeIndexTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeIndexTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeIndexTemplateResponseBody> body_ {};
  };
