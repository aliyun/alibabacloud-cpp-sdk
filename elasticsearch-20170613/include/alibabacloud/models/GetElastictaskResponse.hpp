...
namespace Models
{
  ...
  public:
    ...
    inline const GetElastictaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetElastictaskResponseBody) };
    inline GetElastictaskResponseBody body() { DARABONBA_PTR_GET(body_, GetElastictaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetElastictaskResponseBody> body_ = nullptr;
  };
