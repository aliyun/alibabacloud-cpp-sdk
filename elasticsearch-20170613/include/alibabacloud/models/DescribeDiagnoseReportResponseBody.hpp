...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDiagnoseReportResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeDiagnoseReportResponseBodyResult) };
    inline DescribeDiagnoseReportResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeDiagnoseReportResponseBodyResult) };
    inline DescribeDiagnoseReportResponseBody& setResult(const DescribeDiagnoseReportResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeDiagnoseReportResponseBody& setResult(DescribeDiagnoseReportResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<DescribeDiagnoseReportResponseBodyResult> result_ = nullptr;
  };
