...
namespace Models
{
  ...
  public:
    ...
    inline const ListDiagnoseReportIdsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListDiagnoseReportIdsResponseBody) };
    inline ListDiagnoseReportIdsResponseBody body() { DARABONBA_PTR_GET(body_, ListDiagnoseReportIdsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListDiagnoseReportIdsResponseBody> body_ = nullptr;
  };
