...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListShardRecoveriesResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListShardRecoveriesResponseBodyResult>) };
    inline vector<ListShardRecoveriesResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListShardRecoveriesResponseBodyResult>) };
    inline ListShardRecoveriesResponseBody& setResult(const vector<ListShardRecoveriesResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListShardRecoveriesResponseBody& setResult(vector<ListShardRecoveriesResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<vector<ListShardRecoveriesResponseBodyResult>> result_ = nullptr;
  };
