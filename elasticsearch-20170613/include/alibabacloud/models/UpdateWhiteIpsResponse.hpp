...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateWhiteIpsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateWhiteIpsResponseBody) };
    inline UpdateWhiteIpsResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateWhiteIpsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateWhiteIpsResponseBody> body_ {};
  };
