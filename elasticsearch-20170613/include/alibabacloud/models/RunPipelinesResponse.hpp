...
namespace Models
{
  ...
  public:
    ...
    inline const RunPipelinesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RunPipelinesResponseBody) };
    inline RunPipelinesResponseBody getBody() { DARABONBA_PTR_GET(body_, RunPipelinesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RunPipelinesResponseBody> body_ {};
  };
