...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListILMPoliciesResponseBody::Result> & getResult() const { DARABONBA_PTR_GET_CONST(result_, vector<ListILMPoliciesResponseBody::Result>) };
    inline vector<ListILMPoliciesResponseBody::Result> getResult() { DARABONBA_PTR_GET(result_, vector<ListILMPoliciesResponseBody::Result>) };
    inline ListILMPoliciesResponseBody& setResult(const vector<ListILMPoliciesResponseBody::Result> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListILMPoliciesResponseBody& setResult(vector<ListILMPoliciesResponseBody::Result> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    shared_ptr<string> requestId_ {};
    shared_ptr<vector<ListILMPoliciesResponseBody::Result>> result_ {};
  };
