...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListPipelineIdsResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListPipelineIdsResponseBodyResult>) };
    inline vector<ListPipelineIdsResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListPipelineIdsResponseBodyResult>) };
    inline ListPipelineIdsResponseBody& setResult(const vector<ListPipelineIdsResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListPipelineIdsResponseBody& setResult(vector<ListPipelineIdsResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<ListPipelineIdsResponseBodyResult>> result_ = nullptr;
  };
