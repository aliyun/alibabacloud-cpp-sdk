...
namespace Models
{
  ...
  public:
    ...
    inline const UpdatePipelineManagementConfigResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdatePipelineManagementConfigResponseBody) };
    inline UpdatePipelineManagementConfigResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdatePipelineManagementConfigResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdatePipelineManagementConfigResponseBody> body_ {};
  };
