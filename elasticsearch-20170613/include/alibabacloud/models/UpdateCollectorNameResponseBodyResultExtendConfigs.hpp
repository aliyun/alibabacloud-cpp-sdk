...
#ifndef ALIBABACLOUD_MODELS_UPDATECOLLECTORNAMERESPONSEBODYRESULTEXTENDCONFIGS_HPP_
#define ALIBABACLOUD_MODELS_UPDATECOLLECTORNAMERESPONSEBODYRESULTEXTENDCONFIGS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateCollectorNameResponseBodyResultExtendConfigs& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateCollectorNameResponseBodyResultExtendConfigs& obj) { 
    ...
    UpdateCollectorNameResponseBodyResultExtendConfigs() = default ;
    UpdateCollectorNameResponseBodyResultExtendConfigs(const UpdateCollectorNameResponseBodyResultExtendConfigs &) = default ;
    UpdateCollectorNameResponseBodyResultExtendConfigs(UpdateCollectorNameResponseBodyResultExtendConfigs &&) = default ;
    UpdateCollectorNameResponseBodyResultExtendConfigs(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateCollectorNameResponseBodyResultExtendConfigs() = default ;
    UpdateCollectorNameResponseBodyResultExtendConfigs& operator=(const UpdateCollectorNameResponseBodyResultExtendConfigs &) = default ;
    UpdateCollectorNameResponseBodyResultExtendConfigs& operator=(UpdateCollectorNameResponseBodyResultExtendConfigs &&) = default ;
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setConfigType(string configType) { DARABONBA_PTR_SET_VALUE(configType_, configType) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setEnableMonitoring(bool enableMonitoring) { DARABONBA_PTR_SET_VALUE(enableMonitoring_, enableMonitoring) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setGroupId(string groupId) { DARABONBA_PTR_SET_VALUE(groupId_, groupId) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setHost(string host) { DARABONBA_PTR_SET_VALUE(host_, host) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setHosts(const vector<string> & hosts) { DARABONBA_PTR_SET_VALUE(hosts_, hosts) };
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setHosts(vector<string> && hosts) { DARABONBA_PTR_SET_RVALUE(hosts_, hosts) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setKibanaHost(string kibanaHost) { DARABONBA_PTR_SET_VALUE(kibanaHost_, kibanaHost) };


    // machines Field Functions 
    bool hasMachines() const { return this->machines_ != nullptr;};
    void deleteMachines() { this->machines_ = nullptr;};
    inline const vector<Models::UpdateCollectorNameResponseBodyResultExtendConfigsMachines> & machines() const { DARABONBA_PTR_GET_CONST(machines_, vector<Models::UpdateCollectorNameResponseBodyResultExtendConfigsMachines>) };
    inline vector<Models::UpdateCollectorNameResponseBodyResultExtendConfigsMachines> machines() { DARABONBA_PTR_GET(machines_, vector<Models::UpdateCollectorNameResponseBodyResultExtendConfigsMachines>) };
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setMachines(const vector<Models::UpdateCollectorNameResponseBodyResultExtendConfigsMachines> & machines) { DARABONBA_PTR_SET_VALUE(machines_, machines) };
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setMachines(vector<Models::UpdateCollectorNameResponseBodyResultExtendConfigsMachines> && machines) { DARABONBA_PTR_SET_RVALUE(machines_, machines) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setProtocol(string protocol) { DARABONBA_PTR_SET_VALUE(protocol_, protocol) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setSuccessPodsCount(string successPodsCount) { DARABONBA_PTR_SET_VALUE(successPodsCount_, successPodsCount) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setTotalPodsCount(string totalPodsCount) { DARABONBA_PTR_SET_VALUE(totalPodsCount_, totalPodsCount) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline UpdateCollectorNameResponseBodyResultExtendConfigs& setUserName(string userName) { DARABONBA_PTR_SET_VALUE(userName_, userName) };
  ...
  protected:
    ...
    std::shared_ptr<vector<Models::UpdateCollectorNameResponseBodyResultExtendConfigsMachines>> machines_ = nullptr;
