...
namespace Models
{
  ...
  public:
    ...
    inline const GetEmonGrafanaDashboardsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetEmonGrafanaDashboardsResponseBody) };
    inline GetEmonGrafanaDashboardsResponseBody getBody() { DARABONBA_PTR_GET(body_, GetEmonGrafanaDashboardsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetEmonGrafanaDashboardsResponseBody> body_ {};
  };
