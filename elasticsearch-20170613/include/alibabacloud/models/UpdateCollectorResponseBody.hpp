...
#ifndef ALIBABACLOUD_MODELS_UPDATECOLLECTORRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPDATECOLLECTORRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateCollectorResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(Result, result_);
    };
    friend void from_json(const Darabonba::Json& j, UpdateCollectorResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(Result, result_);
    };
    UpdateCollectorResponseBody() = default ;
    UpdateCollectorResponseBody(const UpdateCollectorResponseBody &) = default ;
    UpdateCollectorResponseBody(UpdateCollectorResponseBody &&) = default ;
    UpdateCollectorResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateCollectorResponseBody() = default ;
    UpdateCollectorResponseBody& operator=(const UpdateCollectorResponseBody &) = default ;
    UpdateCollectorResponseBody& operator=(UpdateCollectorResponseBody &&) = default ;
    ...
    inline UpdateCollectorResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // result Field Functions 
    bool hasResult() const { return this->result_ != nullptr;};
    void deleteResult() { this->result_ = nullptr;};
    inline const UpdateCollectorResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, UpdateCollectorResponseBody::Result) };
    inline UpdateCollectorResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, UpdateCollectorResponseBody::Result) };
    inline UpdateCollectorResponseBody& setResult(const UpdateCollectorResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateCollectorResponseBody& setResult(UpdateCollectorResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    shared_ptr<UpdateCollectorResponseBody::Result> result_ {};
  };
