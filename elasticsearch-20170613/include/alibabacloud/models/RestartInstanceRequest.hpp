...
namespace Models
{
  ...
  public:
    ...
    inline RestartInstanceRequest& setBody(string body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    ...
    inline RestartInstanceRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
    ...
    inline RestartInstanceRequest& setForce(bool force) { DARABONBA_PTR_SET_VALUE(force_, force) };
