...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDiagnosisItemsResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListDiagnosisItemsResponseBodyResult>) };
    inline vector<ListDiagnosisItemsResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListDiagnosisItemsResponseBodyResult>) };
    inline ListDiagnosisItemsResponseBody& setResult(const vector<ListDiagnosisItemsResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListDiagnosisItemsResponseBody& setResult(vector<ListDiagnosisItemsResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<ListDiagnosisItemsResponseBodyResult>> result_ = nullptr;
  };
