...
namespace Models
{
  ...
  public:
    ...
    inline const InstallAckOperatorResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InstallAckOperatorResponseBody) };
    inline InstallAckOperatorResponseBody getBody() { DARABONBA_PTR_GET(body_, InstallAckOperatorResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InstallAckOperatorResponseBody> body_ {};
  };
