...
namespace Models
{
  ...
  public:
    ...
    inline const InstallLogstashSystemPluginResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, InstallLogstashSystemPluginResponseBody) };
    inline InstallLogstashSystemPluginResponseBody getBody() { DARABONBA_PTR_GET(body_, InstallLogstashSystemPluginResponseBody) };
  ...
  protected:
    ...
    shared_ptr<InstallLogstashSystemPluginResponseBody> body_ {};
  };
