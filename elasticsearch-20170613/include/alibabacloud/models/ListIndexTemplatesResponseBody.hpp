...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListIndexTemplatesResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListIndexTemplatesResponseBodyResult>) };
    inline vector<ListIndexTemplatesResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListIndexTemplatesResponseBodyResult>) };
    inline ListIndexTemplatesResponseBody& setResult(const vector<ListIndexTemplatesResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListIndexTemplatesResponseBody& setResult(vector<ListIndexTemplatesResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<vector<ListIndexTemplatesResponseBodyResult>> result_ = nullptr;
  };
