...
namespace Models
{
  ...
  public:
    ...
    inline const ListAvailableEsInstanceIdsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAvailableEsInstanceIdsResponseBody) };
    inline ListAvailableEsInstanceIdsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAvailableEsInstanceIdsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAvailableEsInstanceIdsResponseBody> body_ {};
  };
