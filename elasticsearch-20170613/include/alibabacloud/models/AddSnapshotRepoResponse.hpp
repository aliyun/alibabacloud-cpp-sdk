...
namespace Models
{
  ...
  public:
    ...
    inline const AddSnapshotRepoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, AddSnapshotRepoResponseBody) };
    inline AddSnapshotRepoResponseBody getBody() { DARABONBA_PTR_GET(body_, AddSnapshotRepoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<AddSnapshotRepoResponseBody> body_ {};
  };
