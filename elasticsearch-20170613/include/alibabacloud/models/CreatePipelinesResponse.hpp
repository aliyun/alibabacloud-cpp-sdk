...
namespace Models
{
  ...
  public:
    ...
    inline const CreatePipelinesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreatePipelinesResponseBody) };
    inline CreatePipelinesResponseBody getBody() { DARABONBA_PTR_GET(body_, CreatePipelinesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreatePipelinesResponseBody> body_ {};
  };
