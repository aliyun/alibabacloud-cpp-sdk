...
namespace Models
{
  ...
  public:
    ...
    inline const CreateLogstashResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateLogstashResponseBody) };
    inline CreateLogstashResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateLogstashResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateLogstashResponseBody> body_ {};
  };
