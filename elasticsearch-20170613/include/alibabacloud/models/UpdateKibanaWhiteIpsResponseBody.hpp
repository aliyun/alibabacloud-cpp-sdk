...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateKibanaWhiteIpsResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, UpdateKibanaWhiteIpsResponseBodyResult) };
    inline UpdateKibanaWhiteIpsResponseBodyResult result() { DARABONBA_PTR_GET(result_, UpdateKibanaWhiteIpsResponseBodyResult) };
    inline UpdateKibanaWhiteIpsResponseBody& setResult(const UpdateKibanaWhiteIpsResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpdateKibanaWhiteIpsResponseBody& setResult(UpdateKibanaWhiteIpsResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateKibanaWhiteIpsResponseBodyResult> result_ = nullptr;
  };
