...
namespace Models
{
  ...
  public:
    ...
    inline const CapacityPlanResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, CapacityPlanResponseBodyResult) };
    inline CapacityPlanResponseBodyResult result() { DARABONBA_PTR_GET(result_, CapacityPlanResponseBodyResult) };
    inline CapacityPlanResponseBody& setResult(const CapacityPlanResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline CapacityPlanResponseBody& setResult(CapacityPlanResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<CapacityPlanResponseBodyResult> result_ = nullptr;
  };
