...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpgradeEngineVersionResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<UpgradeEngineVersionResponseBodyResult>) };
    inline vector<UpgradeEngineVersionResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<UpgradeEngineVersionResponseBodyResult>) };
    inline UpgradeEngineVersionResponseBody& setResult(const vector<UpgradeEngineVersionResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline UpgradeEngineVersionResponseBody& setResult(vector<UpgradeEngineVersionResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<UpgradeEngineVersionResponseBodyResult>> result_ = nullptr;
  };
