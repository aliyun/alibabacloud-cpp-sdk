...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteILMPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteILMPolicyResponseBody) };
    inline DeleteILMPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteILMPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteILMPolicyResponseBody> body_ {};
  };
