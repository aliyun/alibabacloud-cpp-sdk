...
namespace Models
{
  ...
  public:
    ...
    inline const ListAlternativeSnapshotReposResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListAlternativeSnapshotReposResponseBody) };
    inline ListAlternativeSnapshotReposResponseBody body() { DARABONBA_PTR_GET(body_, ListAlternativeSnapshotReposResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListAlternativeSnapshotReposResponseBody> body_ = nullptr;
  };
