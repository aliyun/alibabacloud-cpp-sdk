...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeComponentIndexResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeComponentIndexResponseBodyResult) };
    inline DescribeComponentIndexResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeComponentIndexResponseBodyResult) };
    inline DescribeComponentIndexResponseBody& setResult(const DescribeComponentIndexResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeComponentIndexResponseBody& setResult(DescribeComponentIndexResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };


  protected:
    std::shared_ptr<string> requestId_ = nullptr;
    std::shared_ptr<DescribeComponentIndexResponseBodyResult> result_ = nullptr;
  };
