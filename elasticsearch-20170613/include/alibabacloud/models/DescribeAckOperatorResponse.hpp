...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAckOperatorResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAckOperatorResponseBody) };
    inline DescribeAckOperatorResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAckOperatorResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAckOperatorResponseBody> body_ = nullptr;
  };
