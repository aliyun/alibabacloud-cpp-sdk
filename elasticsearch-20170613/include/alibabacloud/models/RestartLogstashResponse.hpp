...
namespace Models
{
  ...
  public:
    ...
    inline const RestartLogstashResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RestartLogstashResponseBody) };
    inline RestartLogstashResponseBody getBody() { DARABONBA_PTR_GET(body_, RestartLogstashResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RestartLogstashResponseBody> body_ {};
  };
