...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAdminPasswordResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateAdminPasswordResponseBody) };
    inline UpdateAdminPasswordResponseBody body() { DARABONBA_PTR_GET(body_, UpdateAdminPasswordResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateAdminPasswordResponseBody> body_ = nullptr;
  };
