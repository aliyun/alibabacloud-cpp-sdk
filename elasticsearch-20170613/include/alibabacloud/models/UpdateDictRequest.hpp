...
namespace Models
{
  ...
  public:
    ...
    inline UpdateDictRequest& setBody(string body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    ...
    inline UpdateDictRequest& setClientToken(string clientToken) { DARABONBA_PTR_SET_VALUE(clientToken_, clientToken) };
