...
namespace Models
{
  ...
  public:
    ...
    inline const GetEmonAlarmRecordStatisticsDistributeResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, GetEmonAlarmRecordStatisticsDistributeResponseBodyResult) };
    inline GetEmonAlarmRecordStatisticsDistributeResponseBodyResult result() { DARABONBA_PTR_GET(result_, GetEmonAlarmRecordStatisticsDistributeResponseBodyResult) };
    inline GetEmonAlarmRecordStatisticsDistributeResponseBody& setResult(const GetEmonAlarmRecordStatisticsDistributeResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline GetEmonAlarmRecordStatisticsDistributeResponseBody& setResult(GetEmonAlarmRecordStatisticsDistributeResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<GetEmonAlarmRecordStatisticsDistributeResponseBodyResult> result_ = nullptr;
