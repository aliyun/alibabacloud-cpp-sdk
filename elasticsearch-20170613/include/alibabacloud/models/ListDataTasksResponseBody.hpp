...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListDataTasksResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListDataTasksResponseBodyResult>) };
    inline vector<ListDataTasksResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListDataTasksResponseBodyResult>) };
    inline ListDataTasksResponseBody& setResult(const vector<ListDataTasksResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListDataTasksResponseBody& setResult(vector<ListDataTasksResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The return results.
    std::shared_ptr<vector<ListDataTasksResponseBodyResult>> result_ = nullptr;
  };
