...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListVpcEndpointsResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListVpcEndpointsResponseBodyResult>) };
    inline vector<ListVpcEndpointsResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListVpcEndpointsResponseBodyResult>) };
    inline ListVpcEndpointsResponseBody& setResult(const vector<ListVpcEndpointsResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListVpcEndpointsResponseBody& setResult(vector<ListVpcEndpointsResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    std::shared_ptr<vector<ListVpcEndpointsResponseBodyResult>> result_ = nullptr;
  };
