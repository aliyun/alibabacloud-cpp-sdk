...
namespace Models
{
  ...
  public:
    ...
    inline const OpenHttpsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, OpenHttpsResponseBody) };
    inline OpenHttpsResponseBody getBody() { DARABONBA_PTR_GET(body_, OpenHttpsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<OpenHttpsResponseBody> body_ {};
  };
