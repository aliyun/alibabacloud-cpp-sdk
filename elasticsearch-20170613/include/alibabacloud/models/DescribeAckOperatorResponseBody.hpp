...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAckOperatorResponseBodyResult & result() const { DARABONBA_PTR_GET_CONST(result_, DescribeAckOperatorResponseBodyResult) };
    inline DescribeAckOperatorResponseBodyResult result() { DARABONBA_PTR_GET(result_, DescribeAckOperatorResponseBodyResult) };
    inline DescribeAckOperatorResponseBody& setResult(const DescribeAckOperatorResponseBodyResult & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline DescribeAckOperatorResponseBody& setResult(DescribeAckOperatorResponseBodyResult && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The returned result.
    std::shared_ptr<DescribeAckOperatorResponseBodyResult> result_ = nullptr;
  };
