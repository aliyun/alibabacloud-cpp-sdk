...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyElastictaskResponseBody::Result & getResult() const { DARABONBA_PTR_GET_CONST(result_, ModifyElastictaskResponseBody::Result) };
    inline ModifyElastictaskResponseBody::Result getResult() { DARABONBA_PTR_GET(result_, ModifyElastictaskResponseBody::Result) };
    inline ModifyElastictaskResponseBody& setResult(const ModifyElastictaskResponseBody::Result & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ModifyElastictaskResponseBody& setResult(ModifyElastictaskResponseBody::Result && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
