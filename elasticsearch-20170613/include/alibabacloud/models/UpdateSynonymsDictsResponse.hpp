...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSynonymsDictsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateSynonymsDictsResponseBody) };
    inline UpdateSynonymsDictsResponseBody body() { DARABONBA_PTR_GET(body_, UpdateSynonymsDictsResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateSynonymsDictsResponseBody> body_ = nullptr;
  };
