...
StartApmResponse Alibabacloud_Elasticsearch20170613::Client::startApmWithOptions(shared_ptr<string> instanceId, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  return StartApmResponse(doROARequest(make_shared<string>("StartApm"), make_shared<string>("2017-06-13"), make_shared<string>("HTTPS"), make_shared<string>("POST"), make_shared<string>("AK"), make_shared<string>(string("/openapi/apm/") + string(*instanceId) + string("/start")), make_shared<string>("json"), req, runtime));
}
...
StopApmResponse Alibabacloud_Elasticsearch20170613::Client::stopApmWithOptions(shared_ptr<string> instanceId, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  return StopApmResponse(doROARequest(make_shared<string>("StopApm"), make_shared<string>("2017-06-13"), make_shared<string>("HTTPS"), make_shared<string>("POST"), make_shared<string>("AK"), make_shared<string>(string("/openapi/apm/") + string(*instanceId) + string("/stop")), make_shared<string>("json"), req, runtime));
}
...
RpcListInstanceResponse Alibabacloud_Elasticsearch20170613::Client::rpcListInstance(shared_ptr<RpcListInstanceRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
  shared_ptr<map<string, string>> headers = make_shared<map<string, string>>(map<string, string>());
  return rpcListInstanceWithOptions(request, headers, runtime);
}

RpcListInstanceResponse Alibabacloud_Elasticsearch20170613::Client::rpcListInstanceWithOptions(shared_ptr<RpcListInstanceRequest> request, shared_ptr<map<string, string>> headers, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->esVersion)) {
    (*query)["esVersion"] = *request->esVersion;
  ...
  return RpcListInstanceResponse(doROARequest(make_shared<string>("RpcListInstance"), make_shared<string>("2017-06-13"), make_shared<string>("HTTPS"), make_shared<string>("POST"), make_shared<string>("AK"), make_shared<string>(string("/openapi/instances/rpc")), make_shared<string>("json"), req, runtime));
}
...
UpdateDescriptionResponse Alibabacloud_Elasticsearch20170613::Client::updateDescriptionWithOptions(shared_ptr<string> InstanceId,
  ...
  return UpdateDescriptionResponse(doROARequestWithForm(make_shared<string>("UpdateDescription"), make_shared<string>("2017-06-13"), make_shared<string>("HTTPS"), make_shared<string>("POST"), make_shared<string>("AK"), make_shared<string>(string("/openapi/instances/") + string(*InstanceId) + string("/description")), make_shared<string>("json"), req, runtime));
}
