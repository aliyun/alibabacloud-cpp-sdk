...
#ifndef ALIBABACLOUD_MODELS_UPDATEREMINDERSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_UPDATEREMINDERSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateReminderShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateReminderShrinkRequest& obj) { 
    ...
    UpdateReminderShrinkRequest() = default ;
    UpdateReminderShrinkRequest(const UpdateReminderShrinkRequest &) = default ;
    UpdateReminderShrinkRequest(UpdateReminderShrinkRequest &&) = default ;
    UpdateReminderShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateReminderShrinkRequest() = default ;
    UpdateReminderShrinkRequest& operator=(const UpdateReminderShrinkRequest &) = default ;
    UpdateReminderShrinkRequest& operator=(UpdateReminderShrinkRequest &&) = default ;
    ...
    inline UpdateReminderShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline UpdateReminderShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline UpdateReminderShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
