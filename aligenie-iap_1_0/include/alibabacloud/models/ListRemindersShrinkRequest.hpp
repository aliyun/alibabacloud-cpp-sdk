...
#ifndef ALIBABACLOUD_MODELS_LISTREMINDERSSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_LISTREMINDERSSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListRemindersShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListRemindersShrinkRequest& obj) { 
    ...
    ListRemindersShrinkRequest() = default ;
    ListRemindersShrinkRequest(const ListRemindersShrinkRequest &) = default ;
    ListRemindersShrinkRequest(ListRemindersShrinkRequest &&) = default ;
    ListRemindersShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListRemindersShrinkRequest() = default ;
    ListRemindersShrinkRequest& operator=(const ListRemindersShrinkRequest &) = default ;
    ListRemindersShrinkRequest& operator=(ListRemindersShrinkRequest &&) = default ;
    ...
    inline ListRemindersShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline ListRemindersShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline ListRemindersShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
