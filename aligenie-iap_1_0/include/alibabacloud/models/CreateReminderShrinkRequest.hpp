...
#ifndef ALIBABACLOUD_MODELS_CREATEREMINDERSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_CREATEREMINDERSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateReminderShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateReminderShrinkRequest& obj) { 
    ...
    CreateReminderShrinkRequest() = default ;
    CreateReminderShrinkRequest(const CreateReminderShrinkRequest &) = default ;
    CreateReminderShrinkRequest(CreateReminderShrinkRequest &&) = default ;
    CreateReminderShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateReminderShrinkRequest() = default ;
    CreateReminderShrinkRequest& operator=(const CreateReminderShrinkRequest &) = default ;
    CreateReminderShrinkRequest& operator=(CreateReminderShrinkRequest &&) = default ;
    ...
    inline CreateReminderShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline CreateReminderShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline CreateReminderShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
