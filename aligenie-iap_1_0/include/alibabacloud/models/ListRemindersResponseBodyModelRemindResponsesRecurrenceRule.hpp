...
#ifndef ALIBABACLOUD_MODELS_LISTREMINDERSRESPONSEBODYMODELREMINDRESPONSESRECURRENCERULE_HPP_
#define ALIBABACLOUD_MODELS_LISTREMINDERSRESPONSEBODYMODELREMINDRESPONSESRECURRENCERULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& obj) { 
    ...
    ListRemindersResponseBodyModelRemindResponsesRecurrenceRule() = default ;
    ListRemindersResponseBodyModelRemindResponsesRecurrenceRule(const ListRemindersResponseBodyModelRemindResponsesRecurrenceRule &) = default ;
    ListRemindersResponseBodyModelRemindResponsesRecurrenceRule(ListRemindersResponseBodyModelRemindResponsesRecurrenceRule &&) = default ;
    ListRemindersResponseBodyModelRemindResponsesRecurrenceRule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListRemindersResponseBodyModelRemindResponsesRecurrenceRule() = default ;
    ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& operator=(const ListRemindersResponseBodyModelRemindResponsesRecurrenceRule &) = default ;
    ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& operator=(ListRemindersResponseBodyModelRemindResponsesRecurrenceRule &&) = default ;
    ...
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setDay(int32_t day) { DARABONBA_PTR_SET_VALUE(day_, day) };
    ...
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setDaysOfMonth(const vector<int32_t> & daysOfMonth) { DARABONBA_PTR_SET_VALUE(daysOfMonth_, daysOfMonth) };
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setDaysOfMonth(vector<int32_t> && daysOfMonth) { DARABONBA_PTR_SET_RVALUE(daysOfMonth_, daysOfMonth) };
    ...
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setDaysOfWeek(const vector<int32_t> & daysOfWeek) { DARABONBA_PTR_SET_VALUE(daysOfWeek_, daysOfWeek) };
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setDaysOfWeek(vector<int32_t> && daysOfWeek) { DARABONBA_PTR_SET_RVALUE(daysOfWeek_, daysOfWeek) };
    ...
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setEndDateTime(string endDateTime) { DARABONBA_PTR_SET_VALUE(endDateTime_, endDateTime) };
    ...
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setFreq(string freq) { DARABONBA_PTR_SET_VALUE(freq_, freq) };
    ...
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setHour(int32_t hour) { DARABONBA_PTR_SET_VALUE(hour_, hour) };
    ...
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setMinute(int32_t minute) { DARABONBA_PTR_SET_VALUE(minute_, minute) };
    ...
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setMonth(int32_t month) { DARABONBA_PTR_SET_VALUE(month_, month) };
    ...
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setSecond(int32_t second) { DARABONBA_PTR_SET_VALUE(second_, second) };
    ...
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setStartDateTime(string startDateTime) { DARABONBA_PTR_SET_VALUE(startDateTime_, startDateTime) };
    ...
    inline ListRemindersResponseBodyModelRemindResponsesRecurrenceRule& setYear(int32_t year) { DARABONBA_PTR_SET_VALUE(year_, year) };
