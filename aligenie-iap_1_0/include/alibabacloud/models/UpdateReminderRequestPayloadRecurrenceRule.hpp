...
#ifndef ALIBABACLOUD_MODELS_UPDATEREMINDERREQUESTPAYLOADRECURRENCERULE_HPP_
#define ALIBABACLOUD_MODELS_UPDATEREMINDERREQUESTPAYLOADRECURRENCERULE_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const UpdateReminderRequestPayloadRecurrenceRule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UpdateReminderRequestPayloadRecurrenceRule& obj) { 
    ...
    UpdateReminderRequestPayloadRecurrenceRule() = default ;
    UpdateReminderRequestPayloadRecurrenceRule(const UpdateReminderRequestPayloadRecurrenceRule &) = default ;
    UpdateReminderRequestPayloadRecurrenceRule(UpdateReminderRequestPayloadRecurrenceRule &&) = default ;
    UpdateReminderRequestPayloadRecurrenceRule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UpdateReminderRequestPayloadRecurrenceRule() = default ;
    UpdateReminderRequestPayloadRecurrenceRule& operator=(const UpdateReminderRequestPayloadRecurrenceRule &) = default ;
    UpdateReminderRequestPayloadRecurrenceRule& operator=(UpdateReminderRequestPayloadRecurrenceRule &&) = default ;
    ...
    inline UpdateReminderRequestPayloadRecurrenceRule& setDay(int32_t day) { DARABONBA_PTR_SET_VALUE(day_, day) };
    ...
    inline UpdateReminderRequestPayloadRecurrenceRule& setDaysOfMonth(const vector<int32_t> & daysOfMonth) { DARABONBA_PTR_SET_VALUE(daysOfMonth_, daysOfMonth) };
    inline UpdateReminderRequestPayloadRecurrenceRule& setDaysOfMonth(vector<int32_t> && daysOfMonth) { DARABONBA_PTR_SET_RVALUE(daysOfMonth_, daysOfMonth) };
    ...
    inline UpdateReminderRequestPayloadRecurrenceRule& setDaysOfWeek(const vector<int32_t> & daysOfWeek) { DARABONBA_PTR_SET_VALUE(daysOfWeek_, daysOfWeek) };
    inline UpdateReminderRequestPayloadRecurrenceRule& setDaysOfWeek(vector<int32_t> && daysOfWeek) { DARABONBA_PTR_SET_RVALUE(daysOfWeek_, daysOfWeek) };
    ...
    inline UpdateReminderRequestPayloadRecurrenceRule& setEndDateTime(int64_t endDateTime) { DARABONBA_PTR_SET_VALUE(endDateTime_, endDateTime) };
    ...
    inline UpdateReminderRequestPayloadRecurrenceRule& setFreq(string freq) { DARABONBA_PTR_SET_VALUE(freq_, freq) };
    ...
    inline UpdateReminderRequestPayloadRecurrenceRule& setHour(int32_t hour) { DARABONBA_PTR_SET_VALUE(hour_, hour) };
    ...
    inline UpdateReminderRequestPayloadRecurrenceRule& setMinute(int32_t minute) { DARABONBA_PTR_SET_VALUE(minute_, minute) };
    ...
    inline UpdateReminderRequestPayloadRecurrenceRule& setMonth(int32_t month) { DARABONBA_PTR_SET_VALUE(month_, month) };
    ...
    inline UpdateReminderRequestPayloadRecurrenceRule& setSecond(int32_t second) { DARABONBA_PTR_SET_VALUE(second_, second) };
    ...
    inline UpdateReminderRequestPayloadRecurrenceRule& setStartDateTime(int64_t startDateTime) { DARABONBA_PTR_SET_VALUE(startDateTime_, startDateTime) };
    ...
    inline UpdateReminderRequestPayloadRecurrenceRule& setYear(int32_t year) { DARABONBA_PTR_SET_VALUE(year_, year) };
