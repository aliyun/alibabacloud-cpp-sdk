...
#ifndef ALIBABACLOUD_MODELS_VIDEOAPPREPORTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_VIDEOAPPREPORTSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const VideoAppReportShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, VideoAppReportShrinkRequest& obj) { 
    ...
    VideoAppReportShrinkRequest() = default ;
    VideoAppReportShrinkRequest(const VideoAppReportShrinkRequest &) = default ;
    VideoAppReportShrinkRequest(VideoAppReportShrinkRequest &&) = default ;
    VideoAppReportShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~VideoAppReportShrinkRequest() = default ;
    VideoAppReportShrinkRequest& operator=(const VideoAppReportShrinkRequest &) = default ;
    VideoAppReportShrinkRequest& operator=(VideoAppReportShrinkRequest &&) = default ;
    ...
    inline VideoAppReportShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline VideoAppReportShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline VideoAppReportShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
