...
#ifndef ALIBABACLOUD_MODELS_APPUSETIMEREPORTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_APPUSETIMEREPORTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AppUseTimeReportResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RetCode, retCode_);
      DARABONBA_PTR_TO_JSON(RetMsg, retMsg_);
      DARABONBA_PTR_TO_JSON(RetValue, retValue_);
    };
    friend void from_json(const Darabonba::Json& j, AppUseTimeReportResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RetCode, retCode_);
      DARABONBA_PTR_FROM_JSON(RetMsg, retMsg_);
      DARABONBA_PTR_FROM_JSON(RetValue, retValue_);
    };
    AppUseTimeReportResponseBody() = default ;
    AppUseTimeReportResponseBody(const AppUseTimeReportResponseBody &) = default ;
    AppUseTimeReportResponseBody(AppUseTimeReportResponseBody &&) = default ;
    AppUseTimeReportResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AppUseTimeReportResponseBody() = default ;
    AppUseTimeReportResponseBody& operator=(const AppUseTimeReportResponseBody &) = default ;
    AppUseTimeReportResponseBody& operator=(AppUseTimeReportResponseBody &&) = default ;
    ...
    inline AppUseTimeReportResponseBody& setRetCode(int32_t retCode) { DARABONBA_PTR_SET_VALUE(retCode_, retCode) };
    ...
    inline AppUseTimeReportResponseBody& setRetMsg(string retMsg) { DARABONBA_PTR_SET_VALUE(retMsg_, retMsg) };
    ...
    inline AppUseTimeReportResponseBody& setRetValue(bool retValue) { DARABONBA_PTR_SET_VALUE(retValue_, retValue) };
