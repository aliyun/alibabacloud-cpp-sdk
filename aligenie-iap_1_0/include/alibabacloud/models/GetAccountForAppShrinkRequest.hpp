...
#ifndef ALIBABACLOUD_MODELS_GETACCOUNTFORAPPSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETACCOUNTFORAPPSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetAccountForAppShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetAccountForAppShrinkRequest& obj) { 
    ...
    GetAccountForAppShrinkRequest() = default ;
    GetAccountForAppShrinkRequest(const GetAccountForAppShrinkRequest &) = default ;
    GetAccountForAppShrinkRequest(GetAccountForAppShrinkRequest &&) = default ;
    GetAccountForAppShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetAccountForAppShrinkRequest() = default ;
    GetAccountForAppShrinkRequest& operator=(const GetAccountForAppShrinkRequest &) = default ;
    GetAccountForAppShrinkRequest& operator=(GetAccountForAppShrinkRequest &&) = default ;
    ...
    inline GetAccountForAppShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline GetAccountForAppShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline GetAccountForAppShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
