...
#ifndef ALIBABACLOUD_MODELS_GETBUSAPPCONFIGSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_GETBUSAPPCONFIGSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetBusAppConfigShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetBusAppConfigShrinkRequest& obj) { 
    ...
    GetBusAppConfigShrinkRequest() = default ;
    GetBusAppConfigShrinkRequest(const GetBusAppConfigShrinkRequest &) = default ;
    GetBusAppConfigShrinkRequest(GetBusAppConfigShrinkRequest &&) = default ;
    GetBusAppConfigShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetBusAppConfigShrinkRequest() = default ;
    GetBusAppConfigShrinkRequest& operator=(const GetBusAppConfigShrinkRequest &) = default ;
    GetBusAppConfigShrinkRequest& operator=(GetBusAppConfigShrinkRequest &&) = default ;
    ...
    inline GetBusAppConfigShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline GetBusAppConfigShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline GetBusAppConfigShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
