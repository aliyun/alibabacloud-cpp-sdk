...
#ifndef ALIBABACLOUD_MODELS_DELETEREMINDERSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETEREMINDERSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteReminderShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeleteReminderShrinkRequest& obj) { 
    ...
    DeleteReminderShrinkRequest() = default ;
    DeleteReminderShrinkRequest(const DeleteReminderShrinkRequest &) = default ;
    DeleteReminderShrinkRequest(DeleteReminderShrinkRequest &&) = default ;
    DeleteReminderShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteReminderShrinkRequest() = default ;
    DeleteReminderShrinkRequest& operator=(const DeleteReminderShrinkRequest &) = default ;
    DeleteReminderShrinkRequest& operator=(DeleteReminderShrinkRequest &&) = default ;
    ...
    inline DeleteReminderShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline DeleteReminderShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline DeleteReminderShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
