...
#ifndef ALIBABACLOUD_MODELS_PULLCASHIERSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_PULLCASHIERSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const PullCashierShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PullCashierShrinkRequest& obj) { 
    ...
    PullCashierShrinkRequest() = default ;
    PullCashierShrinkRequest(const PullCashierShrinkRequest &) = default ;
    PullCashierShrinkRequest(PullCashierShrinkRequest &&) = default ;
    PullCashierShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PullCashierShrinkRequest() = default ;
    PullCashierShrinkRequest& operator=(const PullCashierShrinkRequest &) = default ;
    PullCashierShrinkRequest& operator=(PullCashierShrinkRequest &&) = default ;
    ...
    inline PullCashierShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline PullCashierShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline PullCashierShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
