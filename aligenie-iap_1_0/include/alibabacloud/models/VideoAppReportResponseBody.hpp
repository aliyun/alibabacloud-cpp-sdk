...
#ifndef ALIBABACLOUD_MODELS_VIDEOAPPREPORTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_VIDEOAPPREPORTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const VideoAppReportResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RetCode, retCode_);
      DARABONBA_PTR_TO_JSON(RetMsg, retMsg_);
      DARABONBA_PTR_TO_JSON(RetValue, retValue_);
    };
    friend void from_json(const Darabonba::Json& j, VideoAppReportResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RetCode, retCode_);
      DARABONBA_PTR_FROM_JSON(RetMsg, retMsg_);
      DARABONBA_PTR_FROM_JSON(RetValue, retValue_);
    };
    VideoAppReportResponseBody() = default ;
    VideoAppReportResponseBody(const VideoAppReportResponseBody &) = default ;
    VideoAppReportResponseBody(VideoAppReportResponseBody &&) = default ;
    VideoAppReportResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~VideoAppReportResponseBody() = default ;
    VideoAppReportResponseBody& operator=(const VideoAppReportResponseBody &) = default ;
    VideoAppReportResponseBody& operator=(VideoAppReportResponseBody &&) = default ;
    ...
    inline VideoAppReportResponseBody& setRetCode(int32_t retCode) { DARABONBA_PTR_SET_VALUE(retCode_, retCode) };
    ...
    inline VideoAppReportResponseBody& setRetMsg(string retMsg) { DARABONBA_PTR_SET_VALUE(retMsg_, retMsg) };
    ...
    inline VideoAppReportResponseBody& setRetValue(bool retValue) { DARABONBA_PTR_SET_VALUE(retValue_, retValue) };
