...
#ifndef ALIBABACLOUD_MODELS_APPUSETIMEREPORTSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_APPUSETIMEREPORTSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const AppUseTimeReportShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, AppUseTimeReportShrinkRequest& obj) { 
    ...
    AppUseTimeReportShrinkRequest() = default ;
    AppUseTimeReportShrinkRequest(const AppUseTimeReportShrinkRequest &) = default ;
    AppUseTimeReportShrinkRequest(AppUseTimeReportShrinkRequest &&) = default ;
    AppUseTimeReportShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~AppUseTimeReportShrinkRequest() = default ;
    AppUseTimeReportShrinkRequest& operator=(const AppUseTimeReportShrinkRequest &) = default ;
    AppUseTimeReportShrinkRequest& operator=(AppUseTimeReportShrinkRequest &&) = default ;
    ...
    inline AppUseTimeReportShrinkRequest& setDeviceInfoShrink(string deviceInfoShrink) { DARABONBA_PTR_SET_VALUE(deviceInfoShrink_, deviceInfoShrink) };
    ...
    inline AppUseTimeReportShrinkRequest& setPayloadShrink(string payloadShrink) { DARABONBA_PTR_SET_VALUE(payloadShrink_, payloadShrink) };
    ...
    inline AppUseTimeReportShrinkRequest& setUserInfoShrink(string userInfoShrink) { DARABONBA_PTR_SET_VALUE(userInfoShrink_, userInfoShrink) };
