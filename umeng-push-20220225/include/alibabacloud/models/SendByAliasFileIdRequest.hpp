...
#ifndef ALIBABACLOUD_MODELS_SENDBYALIASFILEIDREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SENDBYALIASFILEIDREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SendByAliasFileIdRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SendByAliasFileIdRequest& obj) { 
    ...
    SendByAliasFileIdRequest() = default ;
    SendByAliasFileIdRequest(const SendByAliasFileIdRequest &) = default ;
    SendByAliasFileIdRequest(SendByAliasFileIdRequest &&) = default ;
    SendByAliasFileIdRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SendByAliasFileIdRequest() = default ;
    SendByAliasFileIdRequest& operator=(const SendByAliasFileIdRequest &) = default ;
    SendByAliasFileIdRequest& operator=(SendByAliasFileIdRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->aliasType_ == nullptr
        && this->androidPayload_ == nullptr && this->androidShortPayload_ == nullptr && this->channelProperties_ == nullptr && this->description_ == nullptr && this->fileId_ == nullptr
        && this->harmonyPayload_ == nullptr && this->iosPayload_ == nullptr && this->policy_ == nullptr && this->productionMode_ == nullptr && this->receiptType_ == nullptr
    ...
    inline SendByAliasFileIdRequest& setAliasType(string aliasType) { DARABONBA_PTR_SET_VALUE(aliasType_, aliasType) };
    ...
    inline SendByAliasFileIdRequest& setAndroidPayload(const AndroidPayload & androidPayload) { DARABONBA_PTR_SET_VALUE(androidPayload_, androidPayload) };
    inline SendByAliasFileIdRequest& setAndroidPayload(AndroidPayload && androidPayload) { DARABONBA_PTR_SET_RVALUE(androidPayload_, androidPayload) };
    ...
    inline SendByAliasFileIdRequest& setAndroidShortPayload(const AndroidShortPayload & androidShortPayload) { DARABONBA_PTR_SET_VALUE(androidShortPayload_, androidShortPayload) };
    inline SendByAliasFileIdRequest& setAndroidShortPayload(AndroidShortPayload && androidShortPayload) { DARABONBA_PTR_SET_RVALUE(androidShortPayload_, androidShortPayload) };
    ...
    inline SendByAliasFileIdRequest& setChannelProperties(const ChannelProperties & channelProperties) { DARABONBA_PTR_SET_VALUE(channelProperties_, channelProperties) };
    inline SendByAliasFileIdRequest& setChannelProperties(ChannelProperties && channelProperties) { DARABONBA_PTR_SET_RVALUE(channelProperties_, channelProperties) };
    ...
    inline SendByAliasFileIdRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline SendByAliasFileIdRequest& setFileId(string fileId) { DARABONBA_PTR_SET_VALUE(fileId_, fileId) };
    ...
    inline SendByAliasFileIdRequest& setHarmonyPayload(const HarmonyPayload & harmonyPayload) { DARABONBA_PTR_SET_VALUE(harmonyPayload_, harmonyPayload) };
    inline SendByAliasFileIdRequest& setHarmonyPayload(HarmonyPayload && harmonyPayload) { DARABONBA_PTR_SET_RVALUE(harmonyPayload_, harmonyPayload) };
    ...
    inline SendByAliasFileIdRequest& setIosPayload(const IosPayload & iosPayload) { DARABONBA_PTR_SET_VALUE(iosPayload_, iosPayload) };
    inline SendByAliasFileIdRequest& setIosPayload(IosPayload && iosPayload) { DARABONBA_PTR_SET_RVALUE(iosPayload_, iosPayload) };
    ...
    inline SendByAliasFileIdRequest& setPolicy(const Policy & policy) { DARABONBA_PTR_SET_VALUE(policy_, policy) };
    inline SendByAliasFileIdRequest& setPolicy(Policy && policy) { DARABONBA_PTR_SET_RVALUE(policy_, policy) };
    ...
    inline SendByAliasFileIdRequest& setProductionMode(bool productionMode) { DARABONBA_PTR_SET_VALUE(productionMode_, productionMode) };
    ...
    inline SendByAliasFileIdRequest& setReceiptType(int32_t receiptType) { DARABONBA_PTR_SET_VALUE(receiptType_, receiptType) };
    ...
    inline SendByAliasFileIdRequest& setReceiptUrl(string receiptUrl) { DARABONBA_PTR_SET_VALUE(receiptUrl_, receiptUrl) };
    ...
    inline SendByAliasFileIdRequest& setThirdPartyId(string thirdPartyId) { DARABONBA_PTR_SET_VALUE(thirdPartyId_, thirdPartyId) };
    ...
    inline SendByAliasFileIdRequest& setCallbackParams(string callbackParams) { DARABONBA_PTR_SET_VALUE(callbackParams_, callbackParams) };
