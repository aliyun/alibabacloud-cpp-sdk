...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->aliasType_ == nullptr
        && return this->androidPayload_ == nullptr && return this->androidShortPayload_ == nullptr && return this->channelProperties_ == nullptr && return this->description_ == nullptr && return this->fileId_ == nullptr
