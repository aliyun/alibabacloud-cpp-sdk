...
namespace Models
{
  ...
  public:
    ...
    inline const QueryMsgStatResponseBodyData & data() const { DARABONBA_PTR_GET_CONST(data_, QueryMsgStatResponseBodyData) };
    inline QueryMsgStatResponseBodyData data() { DARABONBA_PTR_GET(data_, QueryMsgStatResponseBodyData) };
    inline QueryMsgStatResponseBody& setData(const QueryMsgStatResponseBodyData & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline QueryMsgStatResponseBody& setData(QueryMsgStatResponseBodyData && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
  ...
  protected:
    ...
    std::shared_ptr<QueryMsgStatResponseBodyData> data_ = nullptr;
