...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->activity_ == nullptr
        && this->addBadge_ == nullptr && this->afterOpen_ == nullptr && this->builderId_ == nullptr && this->custom_ == nullptr && this->expandImage_ == nullptr
        && this->icon_ == nullptr && this->img_ == nullptr && this->playLights_ == nullptr && this->playSound_ == nullptr && this->playVibrate_ == nullptr
        && this->rePop_ == nullptr && this->setBadge_ == nullptr && this->sound_ == nullptr && this->text_ == nullptr && this->title_ == nullptr
        && this->url_ == nullptr; };
    // activity Field Functions 
    bool hasActivity() const { return this->activity_ != nullptr;};
    void deleteActivity() { this->activity_ = nullptr;};
    inline string getActivity() const { DARABONBA_PTR_GET_DEFAULT(activity_, "") };
    ...
    inline int64_t getBuilderId() const { DARABONBA_PTR_GET_DEFAULT(builderId_, 0L) };
    ...
    inline bool getPlayLights() const { DARABONBA_PTR_GET_DEFAULT(playLights_, false) };
    ...
    inline bool getPlaySound() const { DARABONBA_PTR_GET_DEFAULT(playSound_, false) };
    ...
    inline bool getPlayVibrate() const { DARABONBA_PTR_GET_DEFAULT(playVibrate_, false) };
    ...
    inline int32_t getRePop() const { DARABONBA_PTR_GET_DEFAULT(rePop_, 0) };
    ...
    inline int32_t getSetBadge() const { DARABONBA_PTR_GET_DEFAULT(setBadge_, 0) };
  ...
  protected:
    shared_ptr<string> activity_ {};
    shared_ptr<int32_t> addBadge_ {};
    shared_ptr<string> afterOpen_ {};
    shared_ptr<int64_t> builderId_ {};
    shared_ptr<string> custom_ {};
    shared_ptr<string> expandImage_ {};
    shared_ptr<string> icon_ {};
    shared_ptr<string> img_ {};
    shared_ptr<bool> playLights_ {};
    shared_ptr<bool> playSound_ {};
    shared_ptr<bool> playVibrate_ {};
    shared_ptr<int32_t> rePop_ {};
    shared_ptr<int32_t> setBadge_ {};
