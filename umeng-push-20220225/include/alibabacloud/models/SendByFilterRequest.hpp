...
#ifndef ALIBABACLOUD_MODELS_SENDBYFILTERREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SENDBYFILTERREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SendByFilterRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SendByFilterRequest& obj) { 
    ...
    SendByFilterRequest() = default ;
    SendByFilterRequest(const SendByFilterRequest &) = default ;
    SendByFilterRequest(SendByFilterRequest &&) = default ;
    SendByFilterRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SendByFilterRequest() = default ;
    SendByFilterRequest& operator=(const SendByFilterRequest &) = default ;
    SendByFilterRequest& operator=(SendByFilterRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->androidPayload_ == nullptr
        && return this->androidShortPayload_ == nullptr && return this->channelProperties_ == nullptr && return this->description_ == nullptr && return this->filter_ == nullptr && return this->harmonyPayload_ == nullptr
    ...
    inline SendByFilterRequest& setAndroidPayload(const AndroidPayload & androidPayload) { DARABONBA_PTR_SET_VALUE(androidPayload_, androidPayload) };
    inline SendByFilterRequest& setAndroidPayload(AndroidPayload && androidPayload) { DARABONBA_PTR_SET_RVALUE(androidPayload_, androidPayload) };
    ...
    inline SendByFilterRequest& setAndroidShortPayload(const AndroidShortPayload & androidShortPayload) { DARABONBA_PTR_SET_VALUE(androidShortPayload_, androidShortPayload) };
    inline SendByFilterRequest& setAndroidShortPayload(AndroidShortPayload && androidShortPayload) { DARABONBA_PTR_SET_RVALUE(androidShortPayload_, androidShortPayload) };
    ...
    inline SendByFilterRequest& setChannelProperties(const ChannelProperties & channelProperties) { DARABONBA_PTR_SET_VALUE(channelProperties_, channelProperties) };
    inline SendByFilterRequest& setChannelProperties(ChannelProperties && channelProperties) { DARABONBA_PTR_SET_RVALUE(channelProperties_, channelProperties) };
    ...
    inline SendByFilterRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline SendByFilterRequest& setFilter(string filter) { DARABONBA_PTR_SET_VALUE(filter_, filter) };
    ...
    inline SendByFilterRequest& setHarmonyPayload(const HarmonyPayload & harmonyPayload) { DARABONBA_PTR_SET_VALUE(harmonyPayload_, harmonyPayload) };
    inline SendByFilterRequest& setHarmonyPayload(HarmonyPayload && harmonyPayload) { DARABONBA_PTR_SET_RVALUE(harmonyPayload_, harmonyPayload) };
    ...
    inline SendByFilterRequest& setIosPayload(const IosPayload & iosPayload) { DARABONBA_PTR_SET_VALUE(iosPayload_, iosPayload) };
    inline SendByFilterRequest& setIosPayload(IosPayload && iosPayload) { DARABONBA_PTR_SET_RVALUE(iosPayload_, iosPayload) };
    ...
    inline SendByFilterRequest& setPolicy(const Policy & policy) { DARABONBA_PTR_SET_VALUE(policy_, policy) };
    inline SendByFilterRequest& setPolicy(Policy && policy) { DARABONBA_PTR_SET_RVALUE(policy_, policy) };
    ...
    inline SendByFilterRequest& setProductionMode(bool productionMode) { DARABONBA_PTR_SET_VALUE(productionMode_, productionMode) };
    ...
    inline SendByFilterRequest& setReceiptType(int32_t receiptType) { DARABONBA_PTR_SET_VALUE(receiptType_, receiptType) };
    ...
    inline SendByFilterRequest& setReceiptUrl(string receiptUrl) { DARABONBA_PTR_SET_VALUE(receiptUrl_, receiptUrl) };
    ...
    inline SendByFilterRequest& setThirdPartyId(string thirdPartyId) { DARABONBA_PTR_SET_VALUE(thirdPartyId_, thirdPartyId) };
    ...
    inline SendByFilterRequest& setCallbackParams(string callbackParams) { DARABONBA_PTR_SET_VALUE(callbackParams_, callbackParams) };
