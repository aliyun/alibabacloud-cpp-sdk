...
#ifndef ALIBABACLOUD_MODELS_SENDBYDEVICEREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SENDBYDEVICEREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SendByDeviceRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SendByDeviceRequest& obj) { 
    ...
    SendByDeviceRequest() = default ;
    SendByDeviceRequest(const SendByDeviceRequest &) = default ;
    SendByDeviceRequest(SendByDeviceRequest &&) = default ;
    SendByDeviceRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SendByDeviceRequest() = default ;
    SendByDeviceRequest& operator=(const SendByDeviceRequest &) = default ;
    SendByDeviceRequest& operator=(SendByDeviceRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->androidPayload_ == nullptr
        && return this->androidShortPayload_ == nullptr && return this->channelProperties_ == nullptr && return this->description_ == nullptr && return this->deviceTokens_ == nullptr && return this->harmonyPayload_ == nullptr
    ...
    inline SendByDeviceRequest& setAndroidPayload(const AndroidPayload & androidPayload) { DARABONBA_PTR_SET_VALUE(androidPayload_, androidPayload) };
    inline SendByDeviceRequest& setAndroidPayload(AndroidPayload && androidPayload) { DARABONBA_PTR_SET_RVALUE(androidPayload_, androidPayload) };
    ...
    inline SendByDeviceRequest& setAndroidShortPayload(const AndroidShortPayload & androidShortPayload) { DARABONBA_PTR_SET_VALUE(androidShortPayload_, androidShortPayload) };
    inline SendByDeviceRequest& setAndroidShortPayload(AndroidShortPayload && androidShortPayload) { DARABONBA_PTR_SET_RVALUE(androidShortPayload_, androidShortPayload) };
    ...
    inline SendByDeviceRequest& setChannelProperties(const ChannelProperties & channelProperties) { DARABONBA_PTR_SET_VALUE(channelProperties_, channelProperties) };
    inline SendByDeviceRequest& setChannelProperties(ChannelProperties && channelProperties) { DARABONBA_PTR_SET_RVALUE(channelProperties_, channelProperties) };
    ...
    inline SendByDeviceRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline SendByDeviceRequest& setDeviceTokens(string deviceTokens) { DARABONBA_PTR_SET_VALUE(deviceTokens_, deviceTokens) };
    ...
    inline SendByDeviceRequest& setHarmonyPayload(const HarmonyPayload & harmonyPayload) { DARABONBA_PTR_SET_VALUE(harmonyPayload_, harmonyPayload) };
    inline SendByDeviceRequest& setHarmonyPayload(HarmonyPayload && harmonyPayload) { DARABONBA_PTR_SET_RVALUE(harmonyPayload_, harmonyPayload) };
    ...
    inline SendByDeviceRequest& setIosPayload(const IosPayload & iosPayload) { DARABONBA_PTR_SET_VALUE(iosPayload_, iosPayload) };
    inline SendByDeviceRequest& setIosPayload(IosPayload && iosPayload) { DARABONBA_PTR_SET_RVALUE(iosPayload_, iosPayload) };
    ...
    inline SendByDeviceRequest& setPolicy(const Policy & policy) { DARABONBA_PTR_SET_VALUE(policy_, policy) };
    inline SendByDeviceRequest& setPolicy(Policy && policy) { DARABONBA_PTR_SET_RVALUE(policy_, policy) };
    ...
    inline SendByDeviceRequest& setProductionMode(bool productionMode) { DARABONBA_PTR_SET_VALUE(productionMode_, productionMode) };
    ...
    inline SendByDeviceRequest& setReceiptType(int32_t receiptType) { DARABONBA_PTR_SET_VALUE(receiptType_, receiptType) };
    ...
    inline SendByDeviceRequest& setReceiptUrl(string receiptUrl) { DARABONBA_PTR_SET_VALUE(receiptUrl_, receiptUrl) };
    ...
    inline SendByDeviceRequest& setThirdPartyId(string thirdPartyId) { DARABONBA_PTR_SET_VALUE(thirdPartyId_, thirdPartyId) };
    ...
    inline SendByDeviceRequest& setCallbackParams(string callbackParams) { DARABONBA_PTR_SET_VALUE(callbackParams_, callbackParams) };
