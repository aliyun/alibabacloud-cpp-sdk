...
#ifndef ALIBABACLOUD_MODELS_SENDBYAPPREQUEST_HPP_
#define ALIBABACLOUD_MODELS_SENDBYAPPREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SendByAppRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SendByAppRequest& obj) { 
    ...
    SendByAppRequest() = default ;
    SendByAppRequest(const SendByAppRequest &) = default ;
    SendByAppRequest(SendByAppRequest &&) = default ;
    SendByAppRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SendByAppRequest() = default ;
    SendByAppRequest& operator=(const SendByAppRequest &) = default ;
    SendByAppRequest& operator=(SendByAppRequest &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->androidPayload_ == nullptr
        && return this->androidShortPayload_ == nullptr && return this->channelProperties_ == nullptr && return this->description_ == nullptr && return this->harmonyPayload_ == nullptr && return this->iosPayload_ == nullptr
        && return this->policy_ == nullptr && return this->productionMode_ == nullptr && return this->receiptType_ == nullptr && return this->receiptUrl_ == nullptr && return this->thirdPartyId_ == nullptr
    ...
    inline SendByAppRequest& setAndroidPayload(const AndroidPayload & androidPayload) { DARABONBA_PTR_SET_VALUE(androidPayload_, androidPayload) };
    inline SendByAppRequest& setAndroidPayload(AndroidPayload && androidPayload) { DARABONBA_PTR_SET_RVALUE(androidPayload_, androidPayload) };
    ...
    inline SendByAppRequest& setAndroidShortPayload(const AndroidShortPayload & androidShortPayload) { DARABONBA_PTR_SET_VALUE(androidShortPayload_, androidShortPayload) };
    inline SendByAppRequest& setAndroidShortPayload(AndroidShortPayload && androidShortPayload) { DARABONBA_PTR_SET_RVALUE(androidShortPayload_, androidShortPayload) };
    ...
    inline SendByAppRequest& setChannelProperties(const ChannelProperties & channelProperties) { DARABONBA_PTR_SET_VALUE(channelProperties_, channelProperties) };
    inline SendByAppRequest& setChannelProperties(ChannelProperties && channelProperties) { DARABONBA_PTR_SET_RVALUE(channelProperties_, channelProperties) };
    ...
    inline SendByAppRequest& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline SendByAppRequest& setHarmonyPayload(const HarmonyPayload & harmonyPayload) { DARABONBA_PTR_SET_VALUE(harmonyPayload_, harmonyPayload) };
    inline SendByAppRequest& setHarmonyPayload(HarmonyPayload && harmonyPayload) { DARABONBA_PTR_SET_RVALUE(harmonyPayload_, harmonyPayload) };
    ...
    inline SendByAppRequest& setIosPayload(const IosPayload & iosPayload) { DARABONBA_PTR_SET_VALUE(iosPayload_, iosPayload) };
    inline SendByAppRequest& setIosPayload(IosPayload && iosPayload) { DARABONBA_PTR_SET_RVALUE(iosPayload_, iosPayload) };
    ...
    inline SendByAppRequest& setPolicy(const Policy & policy) { DARABONBA_PTR_SET_VALUE(policy_, policy) };
    inline SendByAppRequest& setPolicy(Policy && policy) { DARABONBA_PTR_SET_RVALUE(policy_, policy) };
    ...
    inline SendByAppRequest& setProductionMode(bool productionMode) { DARABONBA_PTR_SET_VALUE(productionMode_, productionMode) };
    ...
    inline SendByAppRequest& setReceiptType(int32_t receiptType) { DARABONBA_PTR_SET_VALUE(receiptType_, receiptType) };
    ...
    inline SendByAppRequest& setReceiptUrl(string receiptUrl) { DARABONBA_PTR_SET_VALUE(receiptUrl_, receiptUrl) };
    ...
    inline SendByAppRequest& setThirdPartyId(string thirdPartyId) { DARABONBA_PTR_SET_VALUE(thirdPartyId_, thirdPartyId) };
    ...
    inline SendByAppRequest& setCallbackParams(string callbackParams) { DARABONBA_PTR_SET_VALUE(callbackParams_, callbackParams) };
