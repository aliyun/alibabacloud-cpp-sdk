...
namespace Models
{
  ...
  public:
    ...
    inline const UploadDeviceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UploadDeviceResponseBody) };
    inline UploadDeviceResponseBody getBody() { DARABONBA_PTR_GET(body_, UploadDeviceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UploadDeviceResponseBody> body_ {};
  };
