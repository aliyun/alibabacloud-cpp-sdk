...
namespace Models
{
  ...
  public:
    ...
    inline const SendByAliasResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendByAliasResponseBody) };
    inline SendByAliasResponseBody getBody() { DARABONBA_PTR_GET(body_, SendByAliasResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendByAliasResponseBody> body_ {};
  };
