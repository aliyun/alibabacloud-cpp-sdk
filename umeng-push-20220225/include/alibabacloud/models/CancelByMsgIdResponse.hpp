...
namespace Models
{
  ...
  public:
    ...
    inline const CancelByMsgIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelByMsgIdResponseBody) };
    inline CancelByMsgIdResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelByMsgIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelByMsgIdResponseBody> body_ {};
  };
