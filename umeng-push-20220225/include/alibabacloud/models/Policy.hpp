...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->channelStrategy_ == nullptr
        && this->expireTime_ == nullptr && this->outerBizNo_ == nullptr && this->speed_ == nullptr && this->startTime_ == nullptr; };
    ...
    inline const map<string, string> & getChannelStrategy() const { DARABONBA_PTR_GET_CONST(channelStrategy_, map<string, string>) };
    inline map<string, string> getChannelStrategy() { DARABONBA_PTR_GET(channelStrategy_, map<string, string>) };
    ...
    inline string getOuterBizNo() const { DARABONBA_PTR_GET_DEFAULT(outerBizNo_, "") };
  ...
  protected:
    shared_ptr<map<string, string>> channelStrategy_ {};
    shared_ptr<string> expireTime_ {};
    shared_ptr<string> outerBizNo_ {};
