...
namespace Models
{
  ...
  public:
    ...
    inline const SendByDeviceFileIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendByDeviceFileIdResponseBody) };
    inline SendByDeviceFileIdResponseBody getBody() { DARABONBA_PTR_GET(body_, SendByDeviceFileIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendByDeviceFileIdResponseBody> body_ {};
  };
