...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->setBadge_ == nullptr
        && this->addBadge_ == nullptr && this->bigBody_ == nullptr && this->bigTitle_ == nullptr && this->expandImage_ == nullptr && this->img_ == nullptr
        && this->sound_ == nullptr && this->text_ == nullptr && this->title_ == nullptr; };
    // setBadge Field Functions 
    bool hasSetBadge() const { return this->setBadge_ != nullptr;};
    void deleteSetBadge() { this->setBadge_ = nullptr;};
    inline int64_t getSetBadge() const { DARABONBA_PTR_GET_DEFAULT(setBadge_, 0L) };
    ...
    inline int64_t getAddBadge() const { DARABONBA_PTR_GET_DEFAULT(addBadge_, 0L) };
    ...
    inline string getBigTitle() const { DARABONBA_PTR_GET_DEFAULT(bigTitle_, "") };
    ...
    inline string getExpandImage() const { DARABONBA_PTR_GET_DEFAULT(expandImage_, "") };
  ...
  protected:
    shared_ptr<int64_t> setBadge_ {};
    shared_ptr<int64_t> addBadge_ {};
    shared_ptr<string> bigBody_ {};
    shared_ptr<string> bigTitle_ {};
    shared_ptr<string> expandImage_ {};
