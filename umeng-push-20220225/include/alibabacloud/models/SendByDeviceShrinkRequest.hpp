...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->androidPayloadShrink_ == nullptr
        && this->androidShortPayloadShrink_ == nullptr && this->channelPropertiesShrink_ == nullptr && this->description_ == nullptr && this->deviceTokens_ == nullptr && this->harmonyPayloadShrink_ == nullptr
