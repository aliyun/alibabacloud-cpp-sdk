...
namespace Models
{
  ...
  public:
    ...
    inline const SendByAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SendByAppResponseBody) };
    inline SendByAppResponseBody getBody() { DARABONBA_PTR_GET(body_, SendByAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SendByAppResponseBody> body_ {};
  };
