...
namespace Models
{
  ...
  public:
    ...
    inline const ImportStacksToStackGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ImportStacksToStackGroupResponseBody) };
    inline ImportStacksToStackGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, ImportStacksToStackGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ImportStacksToStackGroupResponseBody> body_ {};
  };
