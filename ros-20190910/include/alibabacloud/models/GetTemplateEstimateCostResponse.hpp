...
namespace Models
{
  ...
  public:
    ...
    inline const GetTemplateEstimateCostResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTemplateEstimateCostResponseBody) };
    inline GetTemplateEstimateCostResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTemplateEstimateCostResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTemplateEstimateCostResponseBody> body_ {};
  };
