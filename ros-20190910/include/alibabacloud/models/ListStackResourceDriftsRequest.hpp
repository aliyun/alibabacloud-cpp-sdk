...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getResourceDriftStatus() const { DARABONBA_PTR_GET_CONST(resourceDriftStatus_, vector<string>) };
    inline vector<string> getResourceDriftStatus() { DARABONBA_PTR_GET(resourceDriftStatus_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> resourceDriftStatus_ {};
    // The ID of the stack.
    // 
    // This parameter is required.
