...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetServiceProvisionsResponseBodyServiceProvisions& obj) { 
      ...
      DARABONBA_PTR_TO_JSON(DependentServiceNames, dependentServiceNames_);
    ...
    friend void from_json(const Darabonba::Json& j, GetServiceProvisionsResponseBodyServiceProvisions& obj) { 
      ...
      DARABONBA_PTR_FROM_JSON(DependentServiceNames, dependentServiceNames_);
    ...
    // dependentServiceNames Field Functions 
    bool hasDependentServiceNames() const { return this->dependentServiceNames_ != nullptr;};
    void deleteDependentServiceNames() { this->dependentServiceNames_ = nullptr;};
    inline const vector<string> & dependentServiceNames() const { DARABONBA_PTR_GET_CONST(dependentServiceNames_, vector<string>) };
    inline vector<string> dependentServiceNames() { DARABONBA_PTR_GET(dependentServiceNames_, vector<string>) };
    inline GetServiceProvisionsResponseBodyServiceProvisions& setDependentServiceNames(const vector<string> & dependentServiceNames) { DARABONBA_PTR_SET_VALUE(dependentServiceNames_, dependentServiceNames) };
    inline GetServiceProvisionsResponseBodyServiceProvisions& setDependentServiceNames(vector<string> && dependentServiceNames) { DARABONBA_PTR_SET_RVALUE(dependentServiceNames_, dependentServiceNames) };
  ...
  protected:
    ...
    std::shared_ptr<vector<string>> dependentServiceNames_ = nullptr;
