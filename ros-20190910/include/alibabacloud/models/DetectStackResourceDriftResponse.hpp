...
namespace Models
{
  ...
  public:
    ...
    inline const DetectStackResourceDriftResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetectStackResourceDriftResponseBody) };
    inline DetectStackResourceDriftResponseBody getBody() { DARABONBA_PTR_GET(body_, DetectStackResourceDriftResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetectStackResourceDriftResponseBody> body_ {};
  };
