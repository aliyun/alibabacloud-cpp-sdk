...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountIdsShrink_ == nullptr
        && return this->clientToken_ == nullptr && return this->deploymentOptions_ == nullptr && return this->deploymentTargetsShrink_ == nullptr && return this->disableRollback_ == nullptr && return this->operationDescription_ == nullptr
        && return this->operationPreferencesShrink_ == nullptr && return this->parameterOverrides_ == nullptr && return this->regionId_ == nullptr && return this->regionIdsShrink_ == nullptr && return this->stackGroupName_ == nullptr
