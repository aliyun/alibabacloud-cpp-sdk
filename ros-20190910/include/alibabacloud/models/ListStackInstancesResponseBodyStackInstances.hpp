...
#ifndef ALIBABACLOUD_MODELS_LISTSTACKINSTANCESRESPONSEBODYSTACKINSTANCES_HPP_
#define ALIBABACLOUD_MODELS_LISTSTACKINSTANCESRESPONSEBODYSTACKINSTANCES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListStackInstancesResponseBodyStackInstances& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListStackInstancesResponseBodyStackInstances& obj) { 
    ...
    ListStackInstancesResponseBodyStackInstances() = default ;
    ListStackInstancesResponseBodyStackInstances(const ListStackInstancesResponseBodyStackInstances &) = default ;
    ListStackInstancesResponseBodyStackInstances(ListStackInstancesResponseBodyStackInstances &&) = default ;
    ListStackInstancesResponseBodyStackInstances(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListStackInstancesResponseBodyStackInstances() = default ;
    ListStackInstancesResponseBodyStackInstances& operator=(const ListStackInstancesResponseBodyStackInstances &) = default ;
    ListStackInstancesResponseBodyStackInstances& operator=(ListStackInstancesResponseBodyStackInstances &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->accountId_ == nullptr
        && return this->driftDetectionTime_ == nullptr && return this->rdFolderId_ == nullptr && return this->regionId_ == nullptr && return this->stackDriftStatus_ == nullptr && return this->stackGroupId_ == nullptr
        && return this->stackGroupName_ == nullptr && return this->stackId_ == nullptr && return this->status_ == nullptr && return this->statusReason_ == nullptr; };
    // accountId Field Functions 
    bool hasAccountId() const { return this->accountId_ != nullptr;};
    void deleteAccountId() { this->accountId_ = nullptr;};
    inline string accountId() const { DARABONBA_PTR_GET_DEFAULT(accountId_, "") };
    inline ListStackInstancesResponseBodyStackInstances& setAccountId(string accountId) { DARABONBA_PTR_SET_VALUE(accountId_, accountId) };
    ...
    inline ListStackInstancesResponseBodyStackInstances& setDriftDetectionTime(string driftDetectionTime) { DARABONBA_PTR_SET_VALUE(driftDetectionTime_, driftDetectionTime) };
    ...
    inline ListStackInstancesResponseBodyStackInstances& setRdFolderId(string rdFolderId) { DARABONBA_PTR_SET_VALUE(rdFolderId_, rdFolderId) };
    ...
    inline ListStackInstancesResponseBodyStackInstances& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline ListStackInstancesResponseBodyStackInstances& setStackDriftStatus(string stackDriftStatus) { DARABONBA_PTR_SET_VALUE(stackDriftStatus_, stackDriftStatus) };
    ...
    inline ListStackInstancesResponseBodyStackInstances& setStackGroupId(string stackGroupId) { DARABONBA_PTR_SET_VALUE(stackGroupId_, stackGroupId) };
    ...
    inline ListStackInstancesResponseBodyStackInstances& setStackGroupName(string stackGroupName) { DARABONBA_PTR_SET_VALUE(stackGroupName_, stackGroupName) };
    ...
    inline ListStackInstancesResponseBodyStackInstances& setStackId(string stackId) { DARABONBA_PTR_SET_VALUE(stackId_, stackId) };
    ...
    inline ListStackInstancesResponseBodyStackInstances& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListStackInstancesResponseBodyStackInstances& setStatusReason(string statusReason) { DARABONBA_PTR_SET_VALUE(statusReason_, statusReason) };
