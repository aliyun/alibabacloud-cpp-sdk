...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteStackInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteStackInstancesResponseBody) };
    inline DeleteStackInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteStackInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteStackInstancesResponseBody> body_ {};
  };
