...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<string> & getDependentServiceNames() const { DARABONBA_PTR_GET_CONST(dependentServiceNames_, vector<string>) };
      inline vector<string> getDependentServiceNames() { DARABONBA_PTR_GET(dependentServiceNames_, vector<string>) };
      inline ServiceProvisions& setDependentServiceNames(const vector<string> & dependentServiceNames) { DARABONBA_PTR_SET_VALUE(dependentServiceNames_, dependentServiceNames) };
      inline ServiceProvisions& setDependentServiceNames(vector<string> && dependentServiceNames) { DARABONBA_PTR_SET_RVALUE(dependentServiceNames_, dependentServiceNames) };
    ...
    protected:
      ...
      shared_ptr<vector<string>> dependentServiceNames_ {};
