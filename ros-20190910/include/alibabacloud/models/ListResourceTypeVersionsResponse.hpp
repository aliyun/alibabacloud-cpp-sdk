...
namespace Models
{
  ...
  public:
    ...
    inline const ListResourceTypeVersionsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListResourceTypeVersionsResponseBody) };
    inline ListResourceTypeVersionsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListResourceTypeVersionsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListResourceTypeVersionsResponseBody> body_ {};
  };
