...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getResourceDirectoryFolderIds() const { DARABONBA_PTR_GET_CONST(resourceDirectoryFolderIds_, vector<string>) };
    inline vector<string> getResourceDirectoryFolderIds() { DARABONBA_PTR_GET(resourceDirectoryFolderIds_, vector<string>) };
    ...
    inline const vector<string> & getStackArns() const { DARABONBA_PTR_GET_CONST(stackArns_, vector<string>) };
    inline vector<string> getStackArns() { DARABONBA_PTR_GET(stackArns_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> resourceDirectoryFolderIds_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<vector<string>> stackArns_ {};
