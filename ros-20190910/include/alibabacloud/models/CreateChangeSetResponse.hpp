...
namespace Models
{
  ...
  public:
    ...
    inline const CreateChangeSetResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateChangeSetResponseBody) };
    inline CreateChangeSetResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateChangeSetResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateChangeSetResponseBody> body_ {};
  };
