...
namespace Models
{
  ...
  public:
    ...
    inline const vector<CreateTemplateRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<CreateTemplateRequest::Tags>) };
    inline vector<CreateTemplateRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<CreateTemplateRequest::Tags>) };
    inline CreateTemplateRequest& setTags(const vector<CreateTemplateRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline CreateTemplateRequest& setTags(vector<CreateTemplateRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
    ...
    inline const vector<string> & getValidationOptions() const { DARABONBA_PTR_GET_CONST(validationOptions_, vector<string>) };
    inline vector<string> getValidationOptions() { DARABONBA_PTR_GET(validationOptions_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<CreateTemplateRequest::Tags>> tags_ {};
    ...
    shared_ptr<vector<string>> validationOptions_ {};
  };
