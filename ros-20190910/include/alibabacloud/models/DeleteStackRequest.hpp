...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getDeleteOptions() const { DARABONBA_PTR_GET_CONST(deleteOptions_, vector<string>) };
    inline vector<string> getDeleteOptions() { DARABONBA_PTR_GET(deleteOptions_, vector<string>) };
  ...
  protected:
    ...
    shared_ptr<vector<string>> deleteOptions_ {};
