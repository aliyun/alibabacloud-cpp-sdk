...
namespace Models
{
  ...
  public:
    ...
    inline string getIncludePermission() const { DARABONBA_PTR_GET_DEFAULT(includePermission_, "") };
    ...
    inline string getTemplateStage() const { DARABONBA_PTR_GET_DEFAULT(templateStage_, "") };
  ...
  protected:
    ...
    shared_ptr<string> includePermission_ {};
    ...
    shared_ptr<string> templateStage_ {};
