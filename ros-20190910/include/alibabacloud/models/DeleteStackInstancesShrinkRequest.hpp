...
#ifndef ALIBABACLOUD_MODELS_DELETESTACKINSTANCESSHRINKREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETESTACKINSTANCESSHRINKREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteStackInstancesShrinkRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeleteStackInstancesShrinkRequest& obj) { 
    ...
    DeleteStackInstancesShrinkRequest() = default ;
    DeleteStackInstancesShrinkRequest(const DeleteStackInstancesShrinkRequest &) = default ;
    DeleteStackInstancesShrinkRequest(DeleteStackInstancesShrinkRequest &&) = default ;
    DeleteStackInstancesShrinkRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteStackInstancesShrinkRequest() = default ;
    DeleteStackInstancesShrinkRequest& operator=(const DeleteStackInstancesShrinkRequest &) = default ;
    DeleteStackInstancesShrinkRequest& operator=(DeleteStackInstancesShrinkRequest &&) = default ;
