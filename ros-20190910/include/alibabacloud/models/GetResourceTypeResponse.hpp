...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResourceTypeResponseBody) };
    inline GetResourceTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResourceTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResourceTypeResponseBody> body_ {};
  };
