...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->clientToken_ == nullptr
        && return this->description_ == nullptr && return this->executionMode_ == nullptr && return this->logicalIdStrategy_ == nullptr && return this->preferenceParametersShrink_ == nullptr && return this->regionId_ == nullptr
        && return this->resourceGroupId_ == nullptr && return this->sourceResourceGroupShrink_ == nullptr && return this->sourceResourcesShrink_ == nullptr && return this->sourceTagShrink_ == nullptr && return this->templateScratchId_ == nullptr; };
