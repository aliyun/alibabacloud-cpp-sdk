...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListStackGroupsRequest::Tags> & getTags() const { DARABONBA_PTR_GET_CONST(tags_, vector<ListStackGroupsRequest::Tags>) };
    inline vector<ListStackGroupsRequest::Tags> getTags() { DARABONBA_PTR_GET(tags_, vector<ListStackGroupsRequest::Tags>) };
    inline ListStackGroupsRequest& setTags(const vector<ListStackGroupsRequest::Tags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline ListStackGroupsRequest& setTags(vector<ListStackGroupsRequest::Tags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    shared_ptr<vector<ListStackGroupsRequest::Tags>> tags_ {};
  };
