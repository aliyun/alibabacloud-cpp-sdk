...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->allowedStackOperations_ == nullptr
    ...
    inline const vector<string> & getAllowedStackOperations() const { DARABONBA_PTR_GET_CONST(allowedStackOperations_, vector<string>) };
    inline vector<string> getAllowedStackOperations() { DARABONBA_PTR_GET(allowedStackOperations_, vector<string>) };
    ...
    inline string getCancelType() const { DARABONBA_PTR_GET_DEFAULT(cancelType_, "") };
  ...
  protected:
    ...
    shared_ptr<vector<string>> allowedStackOperations_ {};
