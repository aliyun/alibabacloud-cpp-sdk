...
namespace Models
{
  ...
  public:
    ...
    inline const CreateTemplateScratchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateTemplateScratchResponseBody) };
    inline CreateTemplateScratchResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateTemplateScratchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateTemplateScratchResponseBody> body_ {};
  };
