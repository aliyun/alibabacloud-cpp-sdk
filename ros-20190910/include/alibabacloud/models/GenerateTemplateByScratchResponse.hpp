...
namespace Models
{
  ...
  public:
    ...
    inline const GenerateTemplateByScratchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GenerateTemplateByScratchResponseBody) };
    inline GenerateTemplateByScratchResponseBody getBody() { DARABONBA_PTR_GET(body_, GenerateTemplateByScratchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GenerateTemplateByScratchResponseBody> body_ {};
  };
