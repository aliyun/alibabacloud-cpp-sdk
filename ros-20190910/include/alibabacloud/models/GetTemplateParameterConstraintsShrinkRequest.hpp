...
namespace Models
{
  ...
  public:
    ...
    inline const vector<GetTemplateParameterConstraintsShrinkRequest::Parameters> & getParameters() const { DARABONBA_PTR_GET_CONST(parameters_, vector<GetTemplateParameterConstraintsShrinkRequest::Parameters>) };
    inline vector<GetTemplateParameterConstraintsShrinkRequest::Parameters> getParameters() { DARABONBA_PTR_GET(parameters_, vector<GetTemplateParameterConstraintsShrinkRequest::Parameters>) };
    inline GetTemplateParameterConstraintsShrinkRequest& setParameters(const vector<GetTemplateParameterConstraintsShrinkRequest::Parameters> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline GetTemplateParameterConstraintsShrinkRequest& setParameters(vector<GetTemplateParameterConstraintsShrinkRequest::Parameters> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
    ...
    inline string getParametersKeyFilterShrink() const { DARABONBA_PTR_GET_DEFAULT(parametersKeyFilterShrink_, "") };
    ...
    inline string getParametersOrderShrink() const { DARABONBA_PTR_GET_DEFAULT(parametersOrderShrink_, "") };
  ...
  protected:
    ...
    // The name of parameter N in the template.
    shared_ptr<vector<GetTemplateParameterConstraintsShrinkRequest::Parameters>> parameters_ {};
    // The parameters whose values you want to query.
    shared_ptr<string> parametersKeyFilterShrink_ {};
    ...
    shared_ptr<string> parametersOrderShrink_ {};
