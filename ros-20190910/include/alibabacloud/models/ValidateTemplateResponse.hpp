...
namespace Models
{
  ...
  public:
    ...
    inline const ValidateTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ValidateTemplateResponseBody) };
    inline ValidateTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, ValidateTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ValidateTemplateResponseBody> body_ {};
  };
