...
namespace Models
{
  ...
  public:
    ...
    inline string getDriftDetectionStatusReason() const { DARABONBA_PTR_GET_DEFAULT(driftDetectionStatusReason_, "") };
    ...
    inline int32_t getDriftedStackResourceCount() const { DARABONBA_PTR_GET_DEFAULT(driftedStackResourceCount_, 0) };
  ...
  protected:
    ...
    shared_ptr<string> driftDetectionStatusReason_ {};
    ...
    shared_ptr<int32_t> driftedStackResourceCount_ {};
