...
namespace Models
{
  ...
  public:
    ...
    inline const ListStackResourceDriftsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListStackResourceDriftsResponseBody) };
    inline ListStackResourceDriftsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListStackResourceDriftsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListStackResourceDriftsResponseBody> body_ {};
  };
