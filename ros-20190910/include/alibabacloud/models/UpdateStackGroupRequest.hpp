...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountIds_ == nullptr
        && return this->administrationRoleName_ == nullptr && return this->autoDeployment_ == nullptr && return this->capabilities_ == nullptr && return this->clientToken_ == nullptr && return this->deploymentOptions_ == nullptr
        && return this->deploymentTargets_ == nullptr && return this->description_ == nullptr && return this->executionRoleName_ == nullptr && return this->operationDescription_ == nullptr && return this->operationPreferences_ == nullptr
        && return this->parameters_ == nullptr && return this->permissionModel_ == nullptr && return this->regionId_ == nullptr && return this->regionIds_ == nullptr && return this->stackGroupName_ == nullptr
    ...
    inline const UpdateStackGroupRequestAutoDeployment & autoDeployment() const { DARABONBA_PTR_GET_CONST(autoDeployment_, UpdateStackGroupRequestAutoDeployment) };
    inline UpdateStackGroupRequestAutoDeployment autoDeployment() { DARABONBA_PTR_GET(autoDeployment_, UpdateStackGroupRequestAutoDeployment) };
    inline UpdateStackGroupRequest& setAutoDeployment(const UpdateStackGroupRequestAutoDeployment & autoDeployment) { DARABONBA_PTR_SET_VALUE(autoDeployment_, autoDeployment) };
    inline UpdateStackGroupRequest& setAutoDeployment(UpdateStackGroupRequestAutoDeployment && autoDeployment) { DARABONBA_PTR_SET_RVALUE(autoDeployment_, autoDeployment) };
    ...
    inline const UpdateStackGroupRequestDeploymentTargets & deploymentTargets() const { DARABONBA_PTR_GET_CONST(deploymentTargets_, UpdateStackGroupRequestDeploymentTargets) };
    inline UpdateStackGroupRequestDeploymentTargets deploymentTargets() { DARABONBA_PTR_GET(deploymentTargets_, UpdateStackGroupRequestDeploymentTargets) };
    inline UpdateStackGroupRequest& setDeploymentTargets(const UpdateStackGroupRequestDeploymentTargets & deploymentTargets) { DARABONBA_PTR_SET_VALUE(deploymentTargets_, deploymentTargets) };
    inline UpdateStackGroupRequest& setDeploymentTargets(UpdateStackGroupRequestDeploymentTargets && deploymentTargets) { DARABONBA_PTR_SET_RVALUE(deploymentTargets_, deploymentTargets) };
    ...
    inline const vector<UpdateStackGroupRequestParameters> & parameters() const { DARABONBA_PTR_GET_CONST(parameters_, vector<UpdateStackGroupRequestParameters>) };
    inline vector<UpdateStackGroupRequestParameters> parameters() { DARABONBA_PTR_GET(parameters_, vector<UpdateStackGroupRequestParameters>) };
    inline UpdateStackGroupRequest& setParameters(const vector<UpdateStackGroupRequestParameters> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline UpdateStackGroupRequest& setParameters(vector<UpdateStackGroupRequestParameters> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateStackGroupRequestAutoDeployment> autoDeployment_ = nullptr;
    ...
    std::shared_ptr<UpdateStackGroupRequestDeploymentTargets> deploymentTargets_ = nullptr;
    ...
    std::shared_ptr<vector<UpdateStackGroupRequestParameters>> parameters_ = nullptr;
