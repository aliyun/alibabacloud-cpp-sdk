...
namespace Models
{
  ...
  public:
    ...
    inline const ListDiagnosticsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListDiagnosticsResponseBody) };
    inline ListDiagnosticsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListDiagnosticsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListDiagnosticsResponseBody> body_ {};
  };
