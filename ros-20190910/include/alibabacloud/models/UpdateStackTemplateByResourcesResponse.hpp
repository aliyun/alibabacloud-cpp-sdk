...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateStackTemplateByResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateStackTemplateByResourcesResponseBody) };
    inline UpdateStackTemplateByResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateStackTemplateByResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateStackTemplateByResourcesResponseBody> body_ {};
  };
