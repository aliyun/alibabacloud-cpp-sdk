...
namespace Models
{
  ...
  public:
    ...
    inline bool getEnablePreConfig() const { DARABONBA_PTR_GET_DEFAULT(enablePreConfig_, false) };
    ...
    inline const vector<PreviewStackRequest::Parameters> & getParameters() const { DARABONBA_PTR_GET_CONST(parameters_, vector<PreviewStackRequest::Parameters>) };
    inline vector<PreviewStackRequest::Parameters> getParameters() { DARABONBA_PTR_GET(parameters_, vector<PreviewStackRequest::Parameters>) };
    inline PreviewStackRequest& setParameters(const vector<PreviewStackRequest::Parameters> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline PreviewStackRequest& setParameters(vector<PreviewStackRequest::Parameters> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
  ...
  protected:
    ...
    // *   true
    // *   false (default)
    shared_ptr<bool> enablePreConfig_ {};
    ...
    shared_ptr<vector<PreviewStackRequest::Parameters>> parameters_ {};
