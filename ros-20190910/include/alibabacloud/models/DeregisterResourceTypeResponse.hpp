...
namespace Models
{
  ...
  public:
    ...
    inline const DeregisterResourceTypeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeregisterResourceTypeResponseBody) };
    inline DeregisterResourceTypeResponseBody getBody() { DARABONBA_PTR_GET(body_, DeregisterResourceTypeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeregisterResourceTypeResponseBody> body_ {};
  };
