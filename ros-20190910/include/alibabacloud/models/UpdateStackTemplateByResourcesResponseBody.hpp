...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->newTemplateBody_ == nullptr
    ...
    inline string getNewTemplateBody() const { DARABONBA_PTR_GET_DEFAULT(newTemplateBody_, "") };
    ...
    inline string getOldTemplateBody() const { DARABONBA_PTR_GET_DEFAULT(oldTemplateBody_, "") };
  ...
  protected:
    ...
    shared_ptr<string> newTemplateBody_ {};
    // The template content before correction.
    shared_ptr<string> oldTemplateBody_ {};
