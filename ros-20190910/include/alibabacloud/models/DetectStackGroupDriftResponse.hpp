...
namespace Models
{
  ...
  public:
    ...
    inline const DetectStackGroupDriftResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetectStackGroupDriftResponseBody) };
    inline DetectStackGroupDriftResponseBody getBody() { DARABONBA_PTR_GET(body_, DetectStackGroupDriftResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetectStackGroupDriftResponseBody> body_ {};
  };
