...
namespace Models
{
  ...
  public:
    ...
    inline const GetStackGroupResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetStackGroupResponseBody) };
    inline GetStackGroupResponseBody getBody() { DARABONBA_PTR_GET(body_, GetStackGroupResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetStackGroupResponseBody> body_ {};
  };
