...
namespace Models
{
  ...
  public:
    ...
    inline const GetStackResourceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetStackResourceResponseBody) };
    inline GetStackResourceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetStackResourceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetStackResourceResponseBody> body_ {};
  };
