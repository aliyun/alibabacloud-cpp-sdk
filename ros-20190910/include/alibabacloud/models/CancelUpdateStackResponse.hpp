...
namespace Models
{
  ...
  public:
    ...
    inline const CancelUpdateStackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelUpdateStackResponseBody) };
    inline CancelUpdateStackResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelUpdateStackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelUpdateStackResponseBody> body_ {};
  };
