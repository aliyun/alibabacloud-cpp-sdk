...
namespace Models
{
  ...
  public:
    ...
    inline const vector<string> & getUpdateInfoOptions() const { DARABONBA_PTR_GET_CONST(updateInfoOptions_, vector<string>) };
    inline vector<string> getUpdateInfoOptions() { DARABONBA_PTR_GET(updateInfoOptions_, vector<string>) };
    ...
    inline string getValidationOption() const { DARABONBA_PTR_GET_DEFAULT(validationOption_, "") };
  ...
  protected:
    ...
    shared_ptr<vector<string>> updateInfoOptions_ {};
    ...
    shared_ptr<string> validationOption_ {};
  };
