...
namespace Models
{
  ...
  public:
    ...
    inline const GetTemplateSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetTemplateSummaryResponseBody) };
    inline GetTemplateSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetTemplateSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetTemplateSummaryResponseBody> body_ {};
  };
