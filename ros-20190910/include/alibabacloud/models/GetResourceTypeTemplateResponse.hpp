...
namespace Models
{
  ...
  public:
    ...
    inline const GetResourceTypeTemplateResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetResourceTypeTemplateResponseBody) };
    inline GetResourceTypeTemplateResponseBody getBody() { DARABONBA_PTR_GET(body_, GetResourceTypeTemplateResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetResourceTypeTemplateResponseBody> body_ {};
  };
