...
namespace Models
{
  ...
  public:
    ...
    inline const ListStackGroupOperationResultsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListStackGroupOperationResultsResponseBody) };
    inline ListStackGroupOperationResultsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListStackGroupOperationResultsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListStackGroupOperationResultsResponseBody> body_ {};
  };
