...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->administrationRoleName_ == nullptr
        && return this->autoDeploymentShrink_ == nullptr && return this->capabilities_ == nullptr && return this->clientToken_ == nullptr && return this->description_ == nullptr && return this->executionRoleName_ == nullptr
        && return this->parameters_ == nullptr && return this->permissionModel_ == nullptr && return this->regionId_ == nullptr && return this->resourceGroupId_ == nullptr && return this->stackArn_ == nullptr
        && return this->stackGroupName_ == nullptr && return this->tags_ == nullptr && return this->templateBody_ == nullptr && return this->templateId_ == nullptr && return this->templateURL_ == nullptr
    ...
    inline const vector<CreateStackGroupShrinkRequestParameters> & parameters() const { DARABONBA_PTR_GET_CONST(parameters_, vector<CreateStackGroupShrinkRequestParameters>) };
    inline vector<CreateStackGroupShrinkRequestParameters> parameters() { DARABONBA_PTR_GET(parameters_, vector<CreateStackGroupShrinkRequestParameters>) };
    inline CreateStackGroupShrinkRequest& setParameters(const vector<CreateStackGroupShrinkRequestParameters> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline CreateStackGroupShrinkRequest& setParameters(vector<CreateStackGroupShrinkRequestParameters> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
    ...
    inline const vector<CreateStackGroupShrinkRequestTags> & tags() const { DARABONBA_PTR_GET_CONST(tags_, vector<CreateStackGroupShrinkRequestTags>) };
    inline vector<CreateStackGroupShrinkRequestTags> tags() { DARABONBA_PTR_GET(tags_, vector<CreateStackGroupShrinkRequestTags>) };
    inline CreateStackGroupShrinkRequest& setTags(const vector<CreateStackGroupShrinkRequestTags> & tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
    inline CreateStackGroupShrinkRequest& setTags(vector<CreateStackGroupShrinkRequestTags> && tags) { DARABONBA_PTR_SET_RVALUE(tags_, tags) };
  ...
  protected:
    ...
    std::shared_ptr<vector<CreateStackGroupShrinkRequestParameters>> parameters_ = nullptr;
    ...
    std::shared_ptr<vector<CreateStackGroupShrinkRequestTags>> tags_ = nullptr;
