...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->driftDetectionId_ == nullptr
    ...
    inline string getDriftDetectionId() const { DARABONBA_PTR_GET_DEFAULT(driftDetectionId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> driftDetectionId_ {};
