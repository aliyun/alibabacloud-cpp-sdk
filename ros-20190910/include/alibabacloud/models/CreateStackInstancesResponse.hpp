...
namespace Models
{
  ...
  public:
    ...
    inline const CreateStackInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateStackInstancesResponseBody) };
    inline CreateStackInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateStackInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateStackInstancesResponseBody> body_ {};
  };
