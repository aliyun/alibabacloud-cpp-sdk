...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->actualProperties_ == nullptr
        && return this->driftDetectionTime_ == nullptr && return this->expectedProperties_ == nullptr && return this->logicalResourceId_ == nullptr && return this->moduleInfo_ == nullptr && return this->physicalResourceId_ == nullptr
        && return this->propertyDifferences_ == nullptr && return this->resourceDriftStatus_ == nullptr && return this->resourceType_ == nullptr && return this->stackId_ == nullptr; };
