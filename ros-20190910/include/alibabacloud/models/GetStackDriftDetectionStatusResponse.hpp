...
namespace Models
{
  ...
  public:
    ...
    inline const GetStackDriftDetectionStatusResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetStackDriftDetectionStatusResponseBody) };
    inline GetStackDriftDetectionStatusResponseBody getBody() { DARABONBA_PTR_GET(body_, GetStackDriftDetectionStatusResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetStackDriftDetectionStatusResponseBody> body_ {};
  };
