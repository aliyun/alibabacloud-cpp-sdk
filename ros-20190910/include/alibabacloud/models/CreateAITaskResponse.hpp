...
namespace Models
{
  ...
  public:
    ...
    inline const CreateAITaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateAITaskResponseBody) };
    inline CreateAITaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateAITaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateAITaskResponseBody> body_ {};
  };
