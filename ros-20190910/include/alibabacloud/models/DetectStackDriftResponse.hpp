...
namespace Models
{
  ...
  public:
    ...
    inline const DetectStackDriftResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetectStackDriftResponseBody) };
    inline DetectStackDriftResponseBody getBody() { DARABONBA_PTR_GET(body_, DetectStackDriftResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetectStackDriftResponseBody> body_ {};
  };
