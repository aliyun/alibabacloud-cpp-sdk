...
namespace Models
{
  ...
  public:
    ...
    inline string getStackInstanceAccountId() const { DARABONBA_PTR_GET_DEFAULT(stackInstanceAccountId_, "") };
    ...
    inline string getStackInstanceRegionId() const { DARABONBA_PTR_GET_DEFAULT(stackInstanceRegionId_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> stackInstanceAccountId_ {};
    // The region ID of the stack.
    // 
    // This parameter is required.
    shared_ptr<string> stackInstanceRegionId_ {};
  };
