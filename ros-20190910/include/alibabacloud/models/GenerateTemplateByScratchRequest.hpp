...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->provisionRegionId_ == nullptr
    ...
    inline string getProvisionRegionId() const { DARABONBA_PTR_GET_DEFAULT(provisionRegionId_, "") };
  ...
  protected:
    ...
    shared_ptr<string> provisionRegionId_ {};
