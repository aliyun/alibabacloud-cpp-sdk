...
namespace Models
{
  ...
  public:
    ...
    inline const ListStackEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListStackEventsResponseBody) };
    inline ListStackEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListStackEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListStackEventsResponseBody> body_ {};
  };
