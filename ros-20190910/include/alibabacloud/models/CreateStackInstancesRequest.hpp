...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accountIds_ == nullptr
        && return this->clientToken_ == nullptr && return this->deploymentOptions_ == nullptr && return this->deploymentTargets_ == nullptr && return this->disableRollback_ == nullptr && return this->operationDescription_ == nullptr
        && return this->operationPreferences_ == nullptr && return this->parameterOverrides_ == nullptr && return this->regionId_ == nullptr && return this->regionIds_ == nullptr && return this->stackGroupName_ == nullptr
