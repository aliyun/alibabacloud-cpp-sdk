...
namespace Models
{
  ...
  public:
    ...
    inline const ListAITaskEventsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListAITaskEventsResponseBody) };
    inline ListAITaskEventsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListAITaskEventsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListAITaskEventsResponseBody> body_ {};
  };
