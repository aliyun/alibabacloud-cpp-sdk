...
#ifndef ALIBABACLOUD_MODELS_DELETESTACKINSTANCESREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteStackInstancesRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeleteStackInstancesRequest& obj) { 
    ...
    DeleteStackInstancesRequest() = default ;
    DeleteStackInstancesRequest(const DeleteStackInstancesRequest &) = default ;
    DeleteStackInstancesRequest(DeleteStackInstancesRequest &&) = default ;
    DeleteStackInstancesRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteStackInstancesRequest() = default ;
    DeleteStackInstancesRequest& operator=(const DeleteStackInstancesRequest &) = default ;
    DeleteStackInstancesRequest& operator=(DeleteStackInstancesRequest &&) = default ;
