...
namespace Models
{
  ...
  public:
    ...
    inline const SetTemplatePermissionResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SetTemplatePermissionResponseBody) };
    inline SetTemplatePermissionResponseBody getBody() { DARABONBA_PTR_GET(body_, SetTemplatePermissionResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SetTemplatePermissionResponseBody> body_ {};
  };
