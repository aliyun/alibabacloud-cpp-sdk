...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->entityType_ == nullptr
        && return this->pageNumber_ == nullptr && return this->pageSize_ == nullptr && return this->registrationId_ == nullptr && return this->resourceType_ == nullptr && return this->status_ == nullptr; };
