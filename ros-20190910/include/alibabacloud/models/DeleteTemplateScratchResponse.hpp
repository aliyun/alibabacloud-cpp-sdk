...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteTemplateScratchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteTemplateScratchResponseBody) };
    inline DeleteTemplateScratchResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteTemplateScratchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteTemplateScratchResponseBody> body_ {};
  };
