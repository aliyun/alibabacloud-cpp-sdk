...
namespace Models
{
  ...
  public:
    ...
    inline const ListStackInstancesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListStackInstancesResponseBody) };
    inline ListStackInstancesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListStackInstancesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListStackInstancesResponseBody> body_ {};
  };
