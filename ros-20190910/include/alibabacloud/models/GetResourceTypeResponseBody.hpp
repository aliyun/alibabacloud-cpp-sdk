...
namespace Models
{
  ...
  public:
    ...
    inline bool getSupportDriftDetection() const { DARABONBA_PTR_GET_DEFAULT(supportDriftDetection_, false) };
    ...
    inline bool getSupportScratchDetection() const { DARABONBA_PTR_GET_DEFAULT(supportScratchDetection_, false) };
  ...
  protected:
    ...
    shared_ptr<bool> supportDriftDetection_ {};
    // The entity type. Valid values:
    // 
    ...
    shared_ptr<bool> supportScratchDetection_ {};
