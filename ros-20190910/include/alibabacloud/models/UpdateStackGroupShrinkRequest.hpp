...
namespace Models
{
  ...
  public:
    ...
    inline const vector<UpdateStackGroupShrinkRequest::Parameters> & getParameters() const { DARABONBA_PTR_GET_CONST(parameters_, vector<UpdateStackGroupShrinkRequest::Parameters>) };
    inline vector<UpdateStackGroupShrinkRequest::Parameters> getParameters() { DARABONBA_PTR_GET(parameters_, vector<UpdateStackGroupShrinkRequest::Parameters>) };
    inline UpdateStackGroupShrinkRequest& setParameters(const vector<UpdateStackGroupShrinkRequest::Parameters> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline UpdateStackGroupShrinkRequest& setParameters(vector<UpdateStackGroupShrinkRequest::Parameters> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
  ...
  protected:
    ...
    shared_ptr<vector<UpdateStackGroupShrinkRequest::Parameters>> parameters_ {};
