...
namespace Models
{
  ...
  public:
    ...
    inline string getResourceDirectoryFolderIdsShrink() const { DARABONBA_PTR_GET_DEFAULT(resourceDirectoryFolderIdsShrink_, "") };
    ...
    inline string getStackArnsShrink() const { DARABONBA_PTR_GET_DEFAULT(stackArnsShrink_, "") };
  ...
  protected:
    ...
    shared_ptr<string> resourceDirectoryFolderIdsShrink_ {};
    ...
    // 
    // This parameter is required.
    shared_ptr<string> stackArnsShrink_ {};
