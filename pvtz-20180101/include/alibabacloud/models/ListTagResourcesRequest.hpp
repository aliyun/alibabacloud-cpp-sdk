...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        && this->nextToken_ == nullptr && this->resourceId_ == nullptr && this->resourceType_ == nullptr && this->size_ == nullptr && this->tag_ == nullptr; };
    // lang Field Functions 
    bool hasLang() const { return this->lang_ != nullptr;};
    void deleteLang() { this->lang_ = nullptr;};
    inline string getLang() const { DARABONBA_PTR_GET_DEFAULT(lang_, "") };
    inline ListTagResourcesRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
