...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEPVTZSTATISTICSHISTORYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEPVTZSTATISTICSHISTORYRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribePvtzStatisticsHistoryResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribePvtzStatisticsHistoryResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(Data, data_);
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribePvtzStatisticsHistoryResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(Data, data_);
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
    };
    DescribePvtzStatisticsHistoryResponseBody() = default ;
    DescribePvtzStatisticsHistoryResponseBody(const DescribePvtzStatisticsHistoryResponseBody &) = default ;
    DescribePvtzStatisticsHistoryResponseBody(DescribePvtzStatisticsHistoryResponseBody &&) = default ;
    DescribePvtzStatisticsHistoryResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribePvtzStatisticsHistoryResponseBody() = default ;
    DescribePvtzStatisticsHistoryResponseBody& operator=(const DescribePvtzStatisticsHistoryResponseBody &) = default ;
    DescribePvtzStatisticsHistoryResponseBody& operator=(DescribePvtzStatisticsHistoryResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->count_ == nullptr
        && this->domainName_ == nullptr && this->failCount_ == nullptr && this->protocol_ == nullptr && this->qtype_ == nullptr && this->ratio_ == nullptr
        && this->successCount_ == nullptr && this->timestamp_ == nullptr && this->zoneName_ == nullptr; };
    ...
    inline const vector<DescribePvtzStatisticsHistoryResponseBody::Data> & getData() const { DARABONBA_PTR_GET_CONST(data_, vector<DescribePvtzStatisticsHistoryResponseBody::Data>) };
    inline vector<DescribePvtzStatisticsHistoryResponseBody::Data> getData() { DARABONBA_PTR_GET(data_, vector<DescribePvtzStatisticsHistoryResponseBody::Data>) };
    inline DescribePvtzStatisticsHistoryResponseBody& setData(const vector<DescribePvtzStatisticsHistoryResponseBody::Data> & data) { DARABONBA_PTR_SET_VALUE(data_, data) };
    inline DescribePvtzStatisticsHistoryResponseBody& setData(vector<DescribePvtzStatisticsHistoryResponseBody::Data> && data) { DARABONBA_PTR_SET_RVALUE(data_, data) };
    ...
    inline DescribePvtzStatisticsHistoryResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
