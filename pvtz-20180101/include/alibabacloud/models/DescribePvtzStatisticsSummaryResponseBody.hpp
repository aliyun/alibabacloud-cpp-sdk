...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEPVTZSTATISTICSSUMMARYRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEPVTZSTATISTICSSUMMARYRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribePvtzStatisticsSummaryResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribePvtzStatisticsSummaryResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribePvtzStatisticsSummaryResponseBody& obj) { 
    ...
    DescribePvtzStatisticsSummaryResponseBody() = default ;
    DescribePvtzStatisticsSummaryResponseBody(const DescribePvtzStatisticsSummaryResponseBody &) = default ;
    DescribePvtzStatisticsSummaryResponseBody(DescribePvtzStatisticsSummaryResponseBody &&) = default ;
    DescribePvtzStatisticsSummaryResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribePvtzStatisticsSummaryResponseBody() = default ;
    DescribePvtzStatisticsSummaryResponseBody& operator=(const DescribePvtzStatisticsSummaryResponseBody &) = default ;
    DescribePvtzStatisticsSummaryResponseBody& operator=(DescribePvtzStatisticsSummaryResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->aggrTimestamp_ == nullptr
        && this->count_ == nullptr && this->domainName_ == nullptr && this->fluctuationValue_ == nullptr && this->latency_ == nullptr && this->line_ == nullptr
        && this->module_ == nullptr && this->previousCount_ == nullptr && this->protocol_ == nullptr && this->qtype_ == nullptr && this->ratio_ == nullptr
        && this->rcode_ == nullptr && this->sourceIp_ == nullptr && this->sourceIsp_ == nullptr && this->sourceRegion_ == nullptr && this->vpcId_ == nullptr
      ...
      inline PageData& setLatency(int64_t latency) { DARABONBA_PTR_SET_VALUE(latency_, latency) };
      ...
      inline PageData& setModule(string module) { DARABONBA_PTR_SET_VALUE(module_, module) };
      ...
      inline PageData& setVpcId(string vpcId) { DARABONBA_PTR_SET_VALUE(vpcId_, vpcId) };
      ...
      inline PageData& setZoneId(string zoneId) { DARABONBA_PTR_SET_VALUE(zoneId_, zoneId) };
    ...
    inline DescribePvtzStatisticsSummaryResponseBody& setCurPage(int32_t curPage) { DARABONBA_PTR_SET_VALUE(curPage_, curPage) };


    // pageData Field Functions 
    bool hasPageData() const { return this->pageData_ != nullptr;};
    void deletePageData() { this->pageData_ = nullptr;};
    inline const vector<DescribePvtzStatisticsSummaryResponseBody::PageData> & getPageData() const { DARABONBA_PTR_GET_CONST(pageData_, vector<DescribePvtzStatisticsSummaryResponseBody::PageData>) };
    inline vector<DescribePvtzStatisticsSummaryResponseBody::PageData> getPageData() { DARABONBA_PTR_GET(pageData_, vector<DescribePvtzStatisticsSummaryResponseBody::PageData>) };
    inline DescribePvtzStatisticsSummaryResponseBody& setPageData(const vector<DescribePvtzStatisticsSummaryResponseBody::PageData> & pageData) { DARABONBA_PTR_SET_VALUE(pageData_, pageData) };
    inline DescribePvtzStatisticsSummaryResponseBody& setPageData(vector<DescribePvtzStatisticsSummaryResponseBody::PageData> && pageData) { DARABONBA_PTR_SET_RVALUE(pageData_, pageData) };
    ...
    inline DescribePvtzStatisticsSummaryResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline DescribePvtzStatisticsSummaryResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribePvtzStatisticsSummaryResponseBody& setTotalPage(int32_t totalPage) { DARABONBA_PTR_SET_VALUE(totalPage_, totalPage) };
    ...
    inline DescribePvtzStatisticsSummaryResponseBody& setTotalSize(int32_t totalSize) { DARABONBA_PTR_SET_VALUE(totalSize_, totalSize) };
