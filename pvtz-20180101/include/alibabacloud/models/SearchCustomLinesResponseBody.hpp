...
#ifndef ALIBABACLOUD_MODELS_SEARCHCUSTOMLINESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_SEARCHCUSTOMLINESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const SearchCustomLinesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, SearchCustomLinesResponseBody& obj) { 
    ...
    SearchCustomLinesResponseBody() = default ;
    SearchCustomLinesResponseBody(const SearchCustomLinesResponseBody &) = default ;
    SearchCustomLinesResponseBody(SearchCustomLinesResponseBody &&) = default ;
    SearchCustomLinesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~SearchCustomLinesResponseBody() = default ;
    SearchCustomLinesResponseBody& operator=(const SearchCustomLinesResponseBody &) = default ;
    SearchCustomLinesResponseBody& operator=(SearchCustomLinesResponseBody &&) = default ;
    ...
    inline const SearchCustomLinesResponseBody::CustomLines & getCustomLines() const { DARABONBA_PTR_GET_CONST(customLines_, SearchCustomLinesResponseBody::CustomLines) };
    inline SearchCustomLinesResponseBody::CustomLines getCustomLines() { DARABONBA_PTR_GET(customLines_, SearchCustomLinesResponseBody::CustomLines) };
    inline SearchCustomLinesResponseBody& setCustomLines(const SearchCustomLinesResponseBody::CustomLines & customLines) { DARABONBA_PTR_SET_VALUE(customLines_, customLines) };
    inline SearchCustomLinesResponseBody& setCustomLines(SearchCustomLinesResponseBody::CustomLines && customLines) { DARABONBA_PTR_SET_RVALUE(customLines_, customLines) };
    ...
    inline SearchCustomLinesResponseBody& setPageNumber(int32_t pageNumber) { DARABONBA_PTR_SET_VALUE(pageNumber_, pageNumber) };
    ...
    inline SearchCustomLinesResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline SearchCustomLinesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline SearchCustomLinesResponseBody& setTotalItems(int32_t totalItems) { DARABONBA_PTR_SET_VALUE(totalItems_, totalItems) };
    ...
    inline SearchCustomLinesResponseBody& setTotalPages(int32_t totalPages) { DARABONBA_PTR_SET_VALUE(totalPages_, totalPages) };


  protected:
    // The custom lines.
    shared_ptr<SearchCustomLinesResponseBody::CustomLines> customLines_ {};
