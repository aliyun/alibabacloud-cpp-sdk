...
public:
  ...
  explicit DescribeUserServiceStatusRequest(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit DescribeUserServiceStatusResponseBody(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<long> statusCode{};
  shared_ptr<DescribeUserServiceStatusResponseBody> body{};

  DescribeUserServiceStatusResponse() {}

  explicit DescribeUserServiceStatusResponse(const std::map<string, boost::any> &config) : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      if (typeid(map<string, boost::any>) == m["body"].type()) {
        DescribeUserServiceStatusResponseBody model1;
        model1.fromMap(boost::any_cast<map<string, boost::any>>(m["body"]));
        body = make_shared<DescribeUserServiceStatusResponseBody>(model1);
      }
    }
  }
...
public:
  ...
  DescribeUserServiceStatusResponse describeUserServiceStatusWithOptions(shared_ptr<DescribeUserServiceStatusRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime);
  DescribeUserServiceStatusResponse describeUserServiceStatus(shared_ptr<DescribeUserServiceStatusRequest> request);
