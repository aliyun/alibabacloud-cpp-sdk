...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateFunctionResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateFunctionResponseBody) };
    inline UpdateFunctionResponseBody body() { DARABONBA_PTR_GET(body_, UpdateFunctionResponseBody) };
    inline UpdateFunctionResponse& setBody(const UpdateFunctionResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateFunctionResponse& setBody(UpdateFunctionResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<UpdateFunctionResponseBody> body_ = nullptr;
  };
