...
#ifndef ALIBABACLOUD_MODELS_PARTITIONINPUT_HPP_
#define ALIBABACLOUD_MODELS_PARTITIONINPUT_HPP_
...
namespace Models
{
  class PartitionInput : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const PartitionInput& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, PartitionInput& obj) { 
    ...
    PartitionInput() = default ;
    PartitionInput(const PartitionInput &) = default ;
    PartitionInput(PartitionInput &&) = default ;
    PartitionInput(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~PartitionInput() = default ;
    PartitionInput& operator=(const PartitionInput &) = default ;
    PartitionInput& operator=(PartitionInput &&) = default ;
    ...
    inline PartitionInput& setCreateTime(int32_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline PartitionInput& setDatabaseName(string databaseName) { DARABONBA_PTR_SET_VALUE(databaseName_, databaseName) };
    ...
    inline PartitionInput& setLastAccessTime(int32_t lastAccessTime) { DARABONBA_PTR_SET_VALUE(lastAccessTime_, lastAccessTime) };
    ...
    inline PartitionInput& setLastAnalyzedTime(int32_t lastAnalyzedTime) { DARABONBA_PTR_SET_VALUE(lastAnalyzedTime_, lastAnalyzedTime) };
    ...
    inline PartitionInput& setParameters(const map<string, string> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline PartitionInput& setParameters(map<string, string> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
    ...
    inline PartitionInput& setPrivileges(const PrincipalPrivilegeSet & privileges) { DARABONBA_PTR_SET_VALUE(privileges_, privileges) };
    inline PartitionInput& setPrivileges(PrincipalPrivilegeSet && privileges) { DARABONBA_PTR_SET_RVALUE(privileges_, privileges) };
    ...
    inline PartitionInput& setSd(const StorageDescriptor & sd) { DARABONBA_PTR_SET_VALUE(sd_, sd) };
    inline PartitionInput& setSd(StorageDescriptor && sd) { DARABONBA_PTR_SET_RVALUE(sd_, sd) };
    ...
    inline PartitionInput& setTableName(string tableName) { DARABONBA_PTR_SET_VALUE(tableName_, tableName) };
    ...
    inline PartitionInput& setValues(const vector<string> & values) { DARABONBA_PTR_SET_VALUE(values_, values) };
    inline PartitionInput& setValues(vector<string> && values) { DARABONBA_PTR_SET_RVALUE(values_, values) };
