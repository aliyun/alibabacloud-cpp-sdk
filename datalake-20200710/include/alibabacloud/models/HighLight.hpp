...
#ifndef ALIBABACLOUD_MODELS_HIGHLIGHT_HPP_
#define ALIBABACLOUD_MODELS_HIGHLIGHT_HPP_
...
namespace Models
{
  ...
  public:
    ...
    inline HighLight& setKey(string key) { DARABONBA_PTR_SET_VALUE(key_, key) };
    ...
    inline HighLight& setValue(string value) { DARABONBA_PTR_SET_VALUE(value_, value) };
