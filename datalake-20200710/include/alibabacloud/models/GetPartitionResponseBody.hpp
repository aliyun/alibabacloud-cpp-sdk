...
namespace Models
{
  ...
  public:
    ...
    inline GetPartitionResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline GetPartitionResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
