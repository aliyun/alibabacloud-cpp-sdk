...
namespace Models
{
  ...
  public:
    ...
    inline const RevokeRoleFromUsersResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, RevokeRoleFromUsersResponseBody) };
    inline RevokeRoleFromUsersResponseBody body() { DARABONBA_PTR_GET(body_, RevokeRoleFromUsersResponseBody) };
    inline RevokeRoleFromUsersResponse& setBody(const RevokeRoleFromUsersResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline RevokeRoleFromUsersResponse& setBody(RevokeRoleFromUsersResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<RevokeRoleFromUsersResponseBody> body_ = nullptr;
  };
