...
namespace Models
{
  ...
  public:
    ...
    inline const ListFunctionsResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListFunctionsResponseBody) };
    inline ListFunctionsResponseBody body() { DARABONBA_PTR_GET(body_, ListFunctionsResponseBody) };
    inline ListFunctionsResponse& setBody(const ListFunctionsResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline ListFunctionsResponse& setBody(ListFunctionsResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<ListFunctionsResponseBody> body_ = nullptr;
  };
