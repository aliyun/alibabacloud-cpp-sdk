...
#ifndef ALIBABACLOUD_MODELS_TABLEEXTENDED_HPP_
#define ALIBABACLOUD_MODELS_TABLEEXTENDED_HPP_
...
namespace Models
{
  class TableExtended : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const TableExtended& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TableExtended& obj) { 
    ...
    TableExtended() = default ;
    TableExtended(const TableExtended &) = default ;
    TableExtended(TableExtended &&) = default ;
    TableExtended(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TableExtended() = default ;
    TableExtended& operator=(const TableExtended &) = default ;
    TableExtended& operator=(TableExtended &&) = default ;
    ...
    virtual bool empty() const override { return this->cascade_ == nullptr
        ...
        && return this->retention_ == nullptr && return this->rewriteEnabled_ == nullptr && return this->sd_ == nullptr && return this->tableFormat_ == nullptr && return this->tableName_ == nullptr
        && return this->tableType_ == nullptr && return this->temporary_ == nullptr && return this->updateTime_ == nullptr && return this->viewExpandedText_ == nullptr && return this->viewOriginalText_ == nullptr; };
    ...
    inline TableExtended& setCascade(bool cascade) { DARABONBA_PTR_SET_VALUE(cascade_, cascade) };
    ...
    inline TableExtended& setCreateTime(int32_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline TableExtended& setCreatedBy(string createdBy) { DARABONBA_PTR_SET_VALUE(createdBy_, createdBy) };
    ...
    inline TableExtended& setDatabaseName(string databaseName) { DARABONBA_PTR_SET_VALUE(databaseName_, databaseName) };
    ...
    inline TableExtended& setLastAccessTime(int32_t lastAccessTime) { DARABONBA_PTR_SET_VALUE(lastAccessTime_, lastAccessTime) };
    ...
    inline TableExtended& setLastAnalyzedTime(int32_t lastAnalyzedTime) { DARABONBA_PTR_SET_VALUE(lastAnalyzedTime_, lastAnalyzedTime) };
    ...
    inline TableExtended& setOwner(string owner) { DARABONBA_PTR_SET_VALUE(owner_, owner) };
    ...
    inline TableExtended& setOwnerType(string ownerType) { DARABONBA_PTR_SET_VALUE(ownerType_, ownerType) };
    ...
    inline TableExtended& setParameters(const map<string, string> & parameters) { DARABONBA_PTR_SET_VALUE(parameters_, parameters) };
    inline TableExtended& setParameters(map<string, string> && parameters) { DARABONBA_PTR_SET_RVALUE(parameters_, parameters) };
    ...
    inline TableExtended& setPartitionKeys(const vector<FieldSchema> & partitionKeys) { DARABONBA_PTR_SET_VALUE(partitionKeys_, partitionKeys) };
    inline TableExtended& setPartitionKeys(vector<FieldSchema> && partitionKeys) { DARABONBA_PTR_SET_RVALUE(partitionKeys_, partitionKeys) };
    ...
    inline const TableExtendedPrivileges & privileges() const { DARABONBA_PTR_GET_CONST(privileges_, TableExtendedPrivileges) };
    inline TableExtendedPrivileges privileges() { DARABONBA_PTR_GET(privileges_, TableExtendedPrivileges) };
    inline TableExtended& setPrivileges(const TableExtendedPrivileges & privileges) { DARABONBA_PTR_SET_VALUE(privileges_, privileges) };
    inline TableExtended& setPrivileges(TableExtendedPrivileges && privileges) { DARABONBA_PTR_SET_RVALUE(privileges_, privileges) };
    ...
    inline TableExtended& setRetention(int32_t retention) { DARABONBA_PTR_SET_VALUE(retention_, retention) };
    ...
    inline TableExtended& setRewriteEnabled(bool rewriteEnabled) { DARABONBA_PTR_SET_VALUE(rewriteEnabled_, rewriteEnabled) };


    // sd Field Functions 
    bool hasSd() const { return this->sd_ != nullptr;};
    void deleteSd() { this->sd_ = nullptr;};
    inline const TableExtendedSd & sd() const { DARABONBA_PTR_GET_CONST(sd_, TableExtendedSd) };
    inline TableExtendedSd sd() { DARABONBA_PTR_GET(sd_, TableExtendedSd) };
    inline TableExtended& setSd(const TableExtendedSd & sd) { DARABONBA_PTR_SET_VALUE(sd_, sd) };
    inline TableExtended& setSd(TableExtendedSd && sd) { DARABONBA_PTR_SET_RVALUE(sd_, sd) };
    ...
    inline TableExtended& setTableFormat(string tableFormat) { DARABONBA_PTR_SET_VALUE(tableFormat_, tableFormat) };
    ...
    inline TableExtended& setTableName(string tableName) { DARABONBA_PTR_SET_VALUE(tableName_, tableName) };
    ...
    inline TableExtended& setTableType(string tableType) { DARABONBA_PTR_SET_VALUE(tableType_, tableType) };
    ...
    inline TableExtended& setTemporary(bool temporary) { DARABONBA_PTR_SET_VALUE(temporary_, temporary) };
    ...
    inline TableExtended& setUpdateTime(int32_t updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
    ...
    inline TableExtended& setViewExpandedText(string viewExpandedText) { DARABONBA_PTR_SET_VALUE(viewExpandedText_, viewExpandedText) };
    ...
    inline TableExtended& setViewOriginalText(string viewOriginalText) { DARABONBA_PTR_SET_VALUE(viewOriginalText_, viewOriginalText) };
  ...
  protected:
    ...
    std::shared_ptr<TableExtendedPrivileges> privileges_ = nullptr;
    std::shared_ptr<int32_t> retention_ = nullptr;
    std::shared_ptr<bool> rewriteEnabled_ = nullptr;
    std::shared_ptr<TableExtendedSd> sd_ = nullptr;
