...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->catalogId_ == nullptr
        && return this->databaseName_ == nullptr && return this->functionInput_ == nullptr; };
    // catalogId Field Functions 
    bool hasCatalogId() const { return this->catalogId_ != nullptr;};
    void deleteCatalogId() { this->catalogId_ = nullptr;};
    inline string catalogId() const { DARABONBA_PTR_GET_DEFAULT(catalogId_, "") };
    inline CreateFunctionRequest& setCatalogId(string catalogId) { DARABONBA_PTR_SET_VALUE(catalogId_, catalogId) };
    ...
    inline CreateFunctionRequest& setDatabaseName(string databaseName) { DARABONBA_PTR_SET_VALUE(databaseName_, databaseName) };
    ...
    inline CreateFunctionRequest& setFunctionInput(const FunctionInput & functionInput) { DARABONBA_PTR_SET_VALUE(functionInput_, functionInput) };
    inline CreateFunctionRequest& setFunctionInput(FunctionInput && functionInput) { DARABONBA_PTR_SET_RVALUE(functionInput_, functionInput) };
  ...
  protected:
    ...
    // The details about the function definition.
