...
namespace Models
{
  ...
  public:
    ...
    inline CreateCatalogRequest& setCatalogInput(const CatalogInput & catalogInput) { DARABONBA_PTR_SET_VALUE(catalogInput_, catalogInput) };
    inline CreateCatalogRequest& setCatalogInput(CatalogInput && catalogInput) { DARABONBA_PTR_SET_RVALUE(catalogInput_, catalogInput) };
