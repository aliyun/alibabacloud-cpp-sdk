...
#ifndef ALIBABACLOUD_MODELS_TABLEEXTENDEDSDSKEWEDINFO_HPP_
#define ALIBABACLOUD_MODELS_TABLEEXTENDEDSDSKEWEDINFO_HPP_
...
namespace Models
{
  class TableExtendedSdSkewedInfo : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const TableExtendedSdSkewedInfo& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, TableExtendedSdSkewedInfo& obj) { 
    ...
    TableExtendedSdSkewedInfo() = default ;
    TableExtendedSdSkewedInfo(const TableExtendedSdSkewedInfo &) = default ;
    TableExtendedSdSkewedInfo(TableExtendedSdSkewedInfo &&) = default ;
    TableExtendedSdSkewedInfo(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~TableExtendedSdSkewedInfo() = default ;
    TableExtendedSdSkewedInfo& operator=(const TableExtendedSdSkewedInfo &) = default ;
    TableExtendedSdSkewedInfo& operator=(TableExtendedSdSkewedInfo &&) = default ;
    ...
    inline TableExtendedSdSkewedInfo& setSkewedColNames(const vector<string> & skewedColNames) { DARABONBA_PTR_SET_VALUE(skewedColNames_, skewedColNames) };
    inline TableExtendedSdSkewedInfo& setSkewedColNames(vector<string> && skewedColNames) { DARABONBA_PTR_SET_RVALUE(skewedColNames_, skewedColNames) };
    ...
    inline TableExtendedSdSkewedInfo& setSkewedColValueLocationMaps(const map<string, string> & skewedColValueLocationMaps) { DARABONBA_PTR_SET_VALUE(skewedColValueLocationMaps_, skewedColValueLocationMaps) };
    inline TableExtendedSdSkewedInfo& setSkewedColValueLocationMaps(map<string, string> && skewedColValueLocationMaps) { DARABONBA_PTR_SET_RVALUE(skewedColValueLocationMaps_, skewedColValueLocationMaps) };
    ...
    inline TableExtendedSdSkewedInfo& setSkewedColValues(const vector<vector<string>> & skewedColValues) { DARABONBA_PTR_SET_VALUE(skewedColValues_, skewedColValues) };
    inline TableExtendedSdSkewedInfo& setSkewedColValues(vector<vector<string>> && skewedColValues) { DARABONBA_PTR_SET_RVALUE(skewedColValues_, skewedColValues) };
