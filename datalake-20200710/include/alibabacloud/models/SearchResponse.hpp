...
namespace Models
{
  ...
  public:
    ...
    inline SearchResponse& setStatusCode(int32_t statusCode) { DARABONBA_PTR_SET_VALUE(statusCode_, statusCode) };


    // body Field Functions 
    bool hasBody() const { return this->body_ != nullptr;};
    void deleteBody() { this->body_ = nullptr;};
    inline const SearchResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, SearchResponseBody) };
    inline SearchResponseBody body() { DARABONBA_PTR_GET(body_, SearchResponseBody) };
    inline SearchResponse& setBody(const SearchResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline SearchResponse& setBody(SearchResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<SearchResponseBody> body_ = nullptr;
  };
