...
namespace Models
{
  ...
  public:
    ...
    inline GrantRoleToUsersRequest& setRoleName(string roleName) { DARABONBA_PTR_SET_VALUE(roleName_, roleName) };
    ...
    inline GrantRoleToUsersRequest& setUsers(const vector<Principal> & users) { DARABONBA_PTR_SET_VALUE(users_, users) };
    inline GrantRoleToUsersRequest& setUsers(vector<Principal> && users) { DARABONBA_PTR_SET_RVALUE(users_, users) };
