...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRoleUsersResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateRoleUsersResponseBody) };
    inline UpdateRoleUsersResponseBody body() { DARABONBA_PTR_GET(body_, UpdateRoleUsersResponseBody) };
    inline UpdateRoleUsersResponse& setBody(const UpdateRoleUsersResponseBody & body) { DARABONBA_PTR_SET_VALUE(body_, body) };
    inline UpdateRoleUsersResponse& setBody(UpdateRoleUsersResponseBody && body) { DARABONBA_PTR_SET_RVALUE(body_, body) };


  protected:
    std::shared_ptr<map<string, string>> headers_ = nullptr;
    std::shared_ptr<int32_t> statusCode_ = nullptr;
    std::shared_ptr<UpdateRoleUsersResponseBody> body_ = nullptr;
  };
