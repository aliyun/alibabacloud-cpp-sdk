...
namespace Models
{
  ...
  public:
    ...
    inline ListPartitionsResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ListPartitionsResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListPartitionsResponseBody& setPartitionSpecs(const vector<PartitionSpec> & partitionSpecs) { DARABONBA_PTR_SET_VALUE(partitionSpecs_, partitionSpecs) };
    inline ListPartitionsResponseBody& setPartitionSpecs(vector<PartitionSpec> && partitionSpecs) { DARABONBA_PTR_SET_RVALUE(partitionSpecs_, partitionSpecs) };
