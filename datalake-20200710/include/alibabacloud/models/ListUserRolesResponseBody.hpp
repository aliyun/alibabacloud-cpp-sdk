...
namespace Models
{
  ...
  public:
    ...
    inline ListUserRolesResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ListUserRolesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListUserRolesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline ListUserRolesResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
    ...
    inline ListUserRolesResponseBody& setUserRoles(const vector<UserRole> & userRoles) { DARABONBA_PTR_SET_VALUE(userRoles_, userRoles) };
    inline ListUserRolesResponseBody& setUserRoles(vector<UserRole> && userRoles) { DARABONBA_PTR_SET_RVALUE(userRoles_, userRoles) };
