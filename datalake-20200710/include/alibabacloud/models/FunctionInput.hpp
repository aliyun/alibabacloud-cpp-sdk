...
#ifndef ALIBABACLOUD_MODELS_FUNCTIONINPUT_HPP_
#define ALIBABACLOUD_MODELS_FUNCTIONINPUT_HPP_
...
namespace Models
{
  class FunctionInput : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const FunctionInput& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, FunctionInput& obj) { 
    ...
    FunctionInput(const FunctionInput &) = default ;
    FunctionInput(FunctionInput &&) = default ;
    FunctionInput(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~FunctionInput() = default ;
    FunctionInput& operator=(const FunctionInput &) = default ;
    FunctionInput& operator=(FunctionInput &&) = default ;
    virtual void validate() const override {
    };
    virtual void fromMap(const Darabonba::Json &obj) override { from_json(obj, *this); validate(); };
    virtual Darabonba::Json toMap() const override { Darabonba::Json obj; to_json(obj, *this); return obj; };
    virtual bool empty() const override { return this->className_ == nullptr
        && return this->createTime_ == nullptr && return this->functionName_ == nullptr && return this->functionType_ == nullptr && return this->ownerName_ == nullptr && return this->ownerType_ == nullptr
        && return this->resourceUri_ == nullptr; };
    ...
    inline FunctionInput& setClassName(string className) { DARABONBA_PTR_SET_VALUE(className_, className) };
    ...
    inline FunctionInput& setCreateTime(int32_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline FunctionInput& setFunctionName(string functionName) { DARABONBA_PTR_SET_VALUE(functionName_, functionName) };
    ...
    inline FunctionInput& setFunctionType(string functionType) { DARABONBA_PTR_SET_VALUE(functionType_, functionType) };
    ...
    inline FunctionInput& setOwnerName(string ownerName) { DARABONBA_PTR_SET_VALUE(ownerName_, ownerName) };
    ...
    inline FunctionInput& setOwnerType(string ownerType) { DARABONBA_PTR_SET_VALUE(ownerType_, ownerType) };
    ...
    inline FunctionInput& setResourceUri(const vector<ResourceUri> & resourceUri) { DARABONBA_PTR_SET_VALUE(resourceUri_, resourceUri) };
    inline FunctionInput& setResourceUri(vector<ResourceUri> && resourceUri) { DARABONBA_PTR_SET_RVALUE(resourceUri_, resourceUri) };
