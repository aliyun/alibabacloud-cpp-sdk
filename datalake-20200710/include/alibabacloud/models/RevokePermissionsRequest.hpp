...
#ifndef ALIBABACLOUD_MODELS_REVOKEPERMISSIONSREQUEST_HPP_
#define ALIBABACLOUD_MODELS_REVOKEPERMISSIONSREQUEST_HPP_
...
namespace Models
{
  class RevokePermissionsRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const RevokePermissionsRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RevokePermissionsRequest& obj) { 
    ...
    RevokePermissionsRequest() = default ;
    RevokePermissionsRequest(const RevokePermissionsRequest &) = default ;
    RevokePermissionsRequest(RevokePermissionsRequest &&) = default ;
    RevokePermissionsRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RevokePermissionsRequest() = default ;
    RevokePermissionsRequest& operator=(const RevokePermissionsRequest &) = default ;
    RevokePermissionsRequest& operator=(RevokePermissionsRequest &&) = default ;
    ...
    inline RevokePermissionsRequest& setAccesses(const vector<string> & accesses) { DARABONBA_PTR_SET_VALUE(accesses_, accesses) };
    inline RevokePermissionsRequest& setAccesses(vector<string> && accesses) { DARABONBA_PTR_SET_RVALUE(accesses_, accesses) };
    ...
    inline RevokePermissionsRequest& setCatalogId(string catalogId) { DARABONBA_PTR_SET_VALUE(catalogId_, catalogId) };
    ...
    inline RevokePermissionsRequest& setDelegateAccesses(const vector<string> & delegateAccesses) { DARABONBA_PTR_SET_VALUE(delegateAccesses_, delegateAccesses) };
    inline RevokePermissionsRequest& setDelegateAccesses(vector<string> && delegateAccesses) { DARABONBA_PTR_SET_RVALUE(delegateAccesses_, delegateAccesses) };
    ...
    inline RevokePermissionsRequest& setMetaResource(const MetaResource & metaResource) { DARABONBA_PTR_SET_VALUE(metaResource_, metaResource) };
    inline RevokePermissionsRequest& setMetaResource(MetaResource && metaResource) { DARABONBA_PTR_SET_RVALUE(metaResource_, metaResource) };
    ...
    inline RevokePermissionsRequest& setPrincipal(const Principal & principal) { DARABONBA_PTR_SET_VALUE(principal_, principal) };
    inline RevokePermissionsRequest& setPrincipal(Principal && principal) { DARABONBA_PTR_SET_RVALUE(principal_, principal) };
    ...
    inline RevokePermissionsRequest& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };


  protected:
    // The access permissions that need to be revoked.
    // 
    // This parameter is required.
    std::shared_ptr<vector<string>> accesses_ = nullptr;
    // The catalog ID.
    std::shared_ptr<string> catalogId_ = nullptr;
    // The grantable access permissions that need to be revoked. This parameter is unavailable.
    std::shared_ptr<vector<string>> delegateAccesses_ = nullptr;
    // The metadata resource for which permissions need to be revoked.
    // 
    // This parameter is required.
    std::shared_ptr<MetaResource> metaResource_ = nullptr;
    // The user or role whose permissions need to be revoked. Formats:
    // 
    ...
    // The permission revocation type. Only Hive is supported.
    // 
    // This parameter is required.
