...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->namespaceId_ == nullptr
        && this->scope_ == nullptr && this->skillName_ == nullptr; };
    // namespaceId Field Functions 
    bool hasNamespaceId() const { return this->namespaceId_ != nullptr;};
    void deleteNamespaceId() { this->namespaceId_ = nullptr;};
    inline string getNamespaceId() const { DARABONBA_PTR_GET_DEFAULT(namespaceId_, "") };
    inline UpdateSkillScopeRequest& setNamespaceId(string namespaceId) { DARABONBA_PTR_SET_VALUE(namespaceId_, namespaceId) };
    ...
    inline UpdateSkillScopeRequest& setScope(string scope) { DARABONBA_PTR_SET_VALUE(scope_, scope) };
    ...
    inline UpdateSkillScopeRequest& setSkillName(string skillName) { DARABONBA_PTR_SET_VALUE(skillName_, skillName) };
