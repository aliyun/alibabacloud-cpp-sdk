...
namespace Models
{
  ...
  public:
    ...
    inline PublishSkillVersionRequest& setNamespaceId(string namespaceId) { DARABONBA_PTR_SET_VALUE(namespaceId_, namespaceId) };
    ...
    inline PublishSkillVersionRequest& setSkillName(string skillName) { DARABONBA_PTR_SET_VALUE(skillName_, skillName) };
    ...
    inline PublishSkillVersionRequest& setSkillVersion(string skillVersion) { DARABONBA_PTR_SET_VALUE(skillVersion_, skillVersion) };
    ...
    inline PublishSkillVersionRequest& setUpdateLatestLabel(bool updateLatestLabel) { DARABONBA_PTR_SET_VALUE(updateLatestLabel_, updateLatestLabel) };
