...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->description_ == nullptr
        && this->name_ == nullptr && this->scanPolicy_ == nullptr && this->tags_ == nullptr; };
    ...
    inline CreateNamespaceRequest& setScanPolicy(string scanPolicy) { DARABONBA_PTR_SET_VALUE(scanPolicy_, scanPolicy) };
    ...
    inline CreateNamespaceRequest& setTags(string tags) { DARABONBA_PTR_SET_VALUE(tags_, tags) };
