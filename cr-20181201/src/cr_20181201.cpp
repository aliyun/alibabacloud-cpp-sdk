...
GetRepoTagLayersResponse Alibabacloud_Cr20181201::Client::getRepoTagLayersWithOptions(shared_ptr<GetRepoTagLayersRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->digest)) {
    query->insert(pair<string, string>("Digest", *request->digest));
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("GetRepoTagLayers"))},
    {"version", boost::any(string("2018-12-01"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return GetRepoTagLayersResponse(callApi(params, req, runtime));
}

GetRepoTagLayersResponse Alibabacloud_Cr20181201::Client::getRepoTagLayers(shared_ptr<GetRepoTagLayersRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
  return getRepoTagLayersWithOptions(request, runtime);
}

GetRepoTagManifestResponse Alibabacloud_Cr20181201::Client::getRepoTagManifestWithOptions(shared_ptr<GetRepoTagManifestRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> query = make_shared<map<string, boost::any>>(map<string, boost::any>());
  if (!Darabonba_Util::Client::isUnset<string>(request->instanceId)) {
    query->insert(pair<string, string>("InstanceId", *request->instanceId));
  ...
  if (!Darabonba_Util::Client::isUnset<long>(request->schemaVersion)) {
    query->insert(pair<string, long>("SchemaVersion", *request->schemaVersion));
  }
  if (!Darabonba_Util::Client::isUnset<string>(request->tag)) {
    query->insert(pair<string, string>("Tag", *request->tag));
  }
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("GetRepoTagManifest"))},
    {"version", boost::any(string("2018-12-01"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return GetRepoTagManifestResponse(callApi(params, req, runtime));
}

GetRepoTagManifestResponse Alibabacloud_Cr20181201::Client::getRepoTagManifest(shared_ptr<GetRepoTagManifestRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
