...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateRepoSourceCodeRepoResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateRepoSourceCodeRepoResponseBody) };
    inline UpdateRepoSourceCodeRepoResponseBody body() { DARABONBA_PTR_GET(body_, UpdateRepoSourceCodeRepoResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateRepoSourceCodeRepoResponseBody> body_ = nullptr;
  };
