...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      virtual bool empty() const override { return this->createTime_ == nullptr
        && this->instanceId_ == nullptr && this->modifiedTime_ == nullptr && this->repoId_ == nullptr && this->repoName_ == nullptr && this->repoNamespaceName_ == nullptr
        && this->repoStatus_ == nullptr && this->repoType_ == nullptr && this->resourceGroupId_ == nullptr && this->summary_ == nullptr; };
    ...
    inline const vector<ListChartRepositoryResponseBody::Repositories> & getRepositories() const { DARABONBA_PTR_GET_CONST(repositories_, vector<ListChartRepositoryResponseBody::Repositories>) };
    inline vector<ListChartRepositoryResponseBody::Repositories> getRepositories() { DARABONBA_PTR_GET(repositories_, vector<ListChartRepositoryResponseBody::Repositories>) };
    inline ListChartRepositoryResponseBody& setRepositories(const vector<ListChartRepositoryResponseBody::Repositories> & repositories) { DARABONBA_PTR_SET_VALUE(repositories_, repositories) };
    inline ListChartRepositoryResponseBody& setRepositories(vector<ListChartRepositoryResponseBody::Repositories> && repositories) { DARABONBA_PTR_SET_RVALUE(repositories_, repositories) };
  ...
  protected:
    ...
    shared_ptr<vector<ListChartRepositoryResponseBody::Repositories>> repositories_ {};
