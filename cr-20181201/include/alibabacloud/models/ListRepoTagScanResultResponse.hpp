...
namespace Models
{
  ...
  public:
    ...
    inline const ListRepoTagScanResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRepoTagScanResultResponseBody) };
    inline ListRepoTagScanResultResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRepoTagScanResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRepoTagScanResultResponseBody> body_ {};
  };
