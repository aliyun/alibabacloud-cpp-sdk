...
namespace Models
{
  ...
  public:
    ...
    inline const GetStorageDomainRoutingRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetStorageDomainRoutingRuleResponseBody) };
    inline GetStorageDomainRoutingRuleResponseBody body() { DARABONBA_PTR_GET(body_, GetStorageDomainRoutingRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetStorageDomainRoutingRuleResponseBody> body_ = nullptr;
  };
