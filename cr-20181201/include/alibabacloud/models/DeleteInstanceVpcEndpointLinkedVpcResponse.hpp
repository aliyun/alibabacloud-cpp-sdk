...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInstanceVpcEndpointLinkedVpcResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteInstanceVpcEndpointLinkedVpcResponseBody) };
    inline DeleteInstanceVpcEndpointLinkedVpcResponseBody body() { DARABONBA_PTR_GET(body_, DeleteInstanceVpcEndpointLinkedVpcResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteInstanceVpcEndpointLinkedVpcResponseBody> body_ = nullptr;
  };
