...
namespace Models
{
  ...
  public:
    ...
    inline const ListNamespaceResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListNamespaceResponseBody) };
    inline ListNamespaceResponseBody body() { DARABONBA_PTR_GET(body_, ListNamespaceResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListNamespaceResponseBody> body_ = nullptr;
  };
