...
namespace Models
{
  ...
  public:
    ...
    inline const GetArtifactSubscriptionTaskResultResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetArtifactSubscriptionTaskResultResponseBody) };
    inline GetArtifactSubscriptionTaskResultResponseBody getBody() { DARABONBA_PTR_GET(body_, GetArtifactSubscriptionTaskResultResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetArtifactSubscriptionTaskResultResponseBody> body_ {};
  };
