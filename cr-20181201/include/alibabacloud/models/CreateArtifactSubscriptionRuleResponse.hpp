...
namespace Models
{
  ...
  public:
    ...
    inline const CreateArtifactSubscriptionRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateArtifactSubscriptionRuleResponseBody) };
    inline CreateArtifactSubscriptionRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateArtifactSubscriptionRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateArtifactSubscriptionRuleResponseBody> body_ {};
  };
