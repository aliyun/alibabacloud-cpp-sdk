...
#ifndef ALIBABACLOUD_MODELS_LISTSCANRULERESPONSEBODYSCANRULES_HPP_
#define ALIBABACLOUD_MODELS_LISTSCANRULERESPONSEBODYSCANRULES_HPP_
...
namespace Models
{
  class ListScanRuleResponseBodyScanRules : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const ListScanRuleResponseBodyScanRules& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListScanRuleResponseBodyScanRules& obj) { 
    ...
    ListScanRuleResponseBodyScanRules() = default ;
    ListScanRuleResponseBodyScanRules(const ListScanRuleResponseBodyScanRules &) = default ;
    ListScanRuleResponseBodyScanRules(ListScanRuleResponseBodyScanRules &&) = default ;
    ListScanRuleResponseBodyScanRules(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListScanRuleResponseBodyScanRules() = default ;
    ListScanRuleResponseBodyScanRules& operator=(const ListScanRuleResponseBodyScanRules &) = default ;
    ListScanRuleResponseBodyScanRules& operator=(ListScanRuleResponseBodyScanRules &&) = default ;
    ...
    virtual bool empty() const override { return this->createTime_ == nullptr
        ...
        && return this->scanScope_ == nullptr && return this->scanType_ == nullptr && return this->triggerType_ == nullptr && return this->updateTime_ == nullptr; };
    // createTime Field Functions 
    bool hasCreateTime() const { return this->createTime_ != nullptr;};
    void deleteCreateTime() { this->createTime_ = nullptr;};
    inline int64_t createTime() const { DARABONBA_PTR_GET_DEFAULT(createTime_, 0L) };
    inline ListScanRuleResponseBodyScanRules& setCreateTime(int64_t createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline ListScanRuleResponseBodyScanRules& setNamespaces(const vector<string> & namespaces) { DARABONBA_PTR_SET_VALUE(namespaces_, namespaces) };
    inline ListScanRuleResponseBodyScanRules& setNamespaces(vector<string> && namespaces) { DARABONBA_PTR_SET_RVALUE(namespaces_, namespaces) };
    ...
    inline ListScanRuleResponseBodyScanRules& setRepoNames(const vector<string> & repoNames) { DARABONBA_PTR_SET_VALUE(repoNames_, repoNames) };
    inline ListScanRuleResponseBodyScanRules& setRepoNames(vector<string> && repoNames) { DARABONBA_PTR_SET_RVALUE(repoNames_, repoNames) };
    ...
    inline ListScanRuleResponseBodyScanRules& setRepoTagFilterPattern(string repoTagFilterPattern) { DARABONBA_PTR_SET_VALUE(repoTagFilterPattern_, repoTagFilterPattern) };
    ...
    inline ListScanRuleResponseBodyScanRules& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline ListScanRuleResponseBodyScanRules& setScanRuleId(string scanRuleId) { DARABONBA_PTR_SET_VALUE(scanRuleId_, scanRuleId) };
    ...
    inline ListScanRuleResponseBodyScanRules& setScanScope(string scanScope) { DARABONBA_PTR_SET_VALUE(scanScope_, scanScope) };
    ...
    inline ListScanRuleResponseBodyScanRules& setScanType(string scanType) { DARABONBA_PTR_SET_VALUE(scanType_, scanType) };
    ...
    inline ListScanRuleResponseBodyScanRules& setTriggerType(string triggerType) { DARABONBA_PTR_SET_VALUE(triggerType_, triggerType) };
    ...
    inline ListScanRuleResponseBodyScanRules& setUpdateTime(int64_t updateTime) { DARABONBA_PTR_SET_VALUE(updateTime_, updateTime) };
