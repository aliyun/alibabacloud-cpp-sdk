...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteScanRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteScanRuleResponseBody) };
    inline DeleteScanRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteScanRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteScanRuleResponseBody> body_ {};
  };
