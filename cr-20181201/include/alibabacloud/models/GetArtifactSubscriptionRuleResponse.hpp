...
namespace Models
{
  ...
  public:
    ...
    inline const GetArtifactSubscriptionRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetArtifactSubscriptionRuleResponseBody) };
    inline GetArtifactSubscriptionRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetArtifactSubscriptionRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetArtifactSubscriptionRuleResponseBody> body_ {};
  };
