...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRepoTagResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRepoTagResponseBody) };
    inline CreateRepoTagResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRepoTagResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRepoTagResponseBody> body_ {};
  };
