...
namespace Models
{
  ...
  public:
    ...
    inline const CancelRepoSyncTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelRepoSyncTaskResponseBody) };
    inline CancelRepoSyncTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelRepoSyncTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelRepoSyncTaskResponseBody> body_ {};
  };
