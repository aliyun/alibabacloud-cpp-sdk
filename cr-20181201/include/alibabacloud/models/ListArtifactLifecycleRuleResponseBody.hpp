...
#ifndef ALIBABACLOUD_MODELS_LISTARTIFACTLIFECYCLERULERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTARTIFACTLIFECYCLERULERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListArtifactLifecycleRuleResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListArtifactLifecycleRuleResponseBody& obj) { 
    ...
    ListArtifactLifecycleRuleResponseBody() = default ;
    ListArtifactLifecycleRuleResponseBody(const ListArtifactLifecycleRuleResponseBody &) = default ;
    ListArtifactLifecycleRuleResponseBody(ListArtifactLifecycleRuleResponseBody &&) = default ;
    ListArtifactLifecycleRuleResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListArtifactLifecycleRuleResponseBody() = default ;
    ListArtifactLifecycleRuleResponseBody& operator=(const ListArtifactLifecycleRuleResponseBody &) = default ;
    ListArtifactLifecycleRuleResponseBody& operator=(ListArtifactLifecycleRuleResponseBody &&) = default ;
    ...
    public:
      ...
      inline Rules& setAuto(bool _auto) { DARABONBA_PTR_SET_VALUE(auto_, _auto) };
      ...
      inline Rules& setNextTime(int64_t nextTime) { DARABONBA_PTR_SET_VALUE(nextTime_, nextTime) };


      // policies Field Functions 
      bool hasPolicies() const { return this->policies_ != nullptr;};
      void deletePolicies() { this->policies_ = nullptr;};
      inline const vector<Rules::Policies> & getPolicies() const { DARABONBA_PTR_GET_CONST(policies_, vector<Rules::Policies>) };
      inline vector<Rules::Policies> getPolicies() { DARABONBA_PTR_GET(policies_, vector<Rules::Policies>) };
      inline Rules& setPolicies(const vector<Rules::Policies> & policies) { DARABONBA_PTR_SET_VALUE(policies_, policies) };
      inline Rules& setPolicies(vector<Rules::Policies> && policies) { DARABONBA_PTR_SET_RVALUE(policies_, policies) };
      ...
      inline Rules& setRetentionTagCount(int64_t retentionTagCount) { DARABONBA_PTR_SET_VALUE(retentionTagCount_, retentionTagCount) };
      ...
      inline Rules& setScheduleTime(string scheduleTime) { DARABONBA_PTR_SET_VALUE(scheduleTime_, scheduleTime) };
      ...
      inline Rules& setScope(string scope) { DARABONBA_PTR_SET_VALUE(scope_, scope) };
    ...
    inline ListArtifactLifecycleRuleResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline ListArtifactLifecycleRuleResponseBody& setIsSuccess(bool isSuccess) { DARABONBA_PTR_SET_VALUE(isSuccess_, isSuccess) };
    ...
    inline ListArtifactLifecycleRuleResponseBody& setPageNo(int32_t pageNo) { DARABONBA_PTR_SET_VALUE(pageNo_, pageNo) };
    ...
    inline ListArtifactLifecycleRuleResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };
    ...
    inline ListArtifactLifecycleRuleResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // rules Field Functions 
    bool hasRules() const { return this->rules_ != nullptr;};
    void deleteRules() { this->rules_ = nullptr;};
    inline const vector<ListArtifactLifecycleRuleResponseBody::Rules> & getRules() const { DARABONBA_PTR_GET_CONST(rules_, vector<ListArtifactLifecycleRuleResponseBody::Rules>) };
    inline vector<ListArtifactLifecycleRuleResponseBody::Rules> getRules() { DARABONBA_PTR_GET(rules_, vector<ListArtifactLifecycleRuleResponseBody::Rules>) };
    inline ListArtifactLifecycleRuleResponseBody& setRules(const vector<ListArtifactLifecycleRuleResponseBody::Rules> & rules) { DARABONBA_PTR_SET_VALUE(rules_, rules) };
    inline ListArtifactLifecycleRuleResponseBody& setRules(vector<ListArtifactLifecycleRuleResponseBody::Rules> && rules) { DARABONBA_PTR_SET_RVALUE(rules_, rules) };
    ...
    inline ListArtifactLifecycleRuleResponseBody& setTotalCount(int32_t totalCount) { DARABONBA_PTR_SET_VALUE(totalCount_, totalCount) };
