...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateScanRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateScanRuleResponseBody) };
    inline UpdateScanRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateScanRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateScanRuleResponseBody> body_ {};
  };
