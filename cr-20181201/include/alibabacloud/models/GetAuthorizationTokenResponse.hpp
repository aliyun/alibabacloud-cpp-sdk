...
namespace Models
{
  ...
  public:
    ...
    inline const GetAuthorizationTokenResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetAuthorizationTokenResponseBody) };
    inline GetAuthorizationTokenResponseBody body() { DARABONBA_PTR_GET(body_, GetAuthorizationTokenResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetAuthorizationTokenResponseBody> body_ = nullptr;
  };
