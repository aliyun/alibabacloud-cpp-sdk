...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateChainResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateChainResponseBody) };
    inline UpdateChainResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateChainResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateChainResponseBody> body_ {};
  };
