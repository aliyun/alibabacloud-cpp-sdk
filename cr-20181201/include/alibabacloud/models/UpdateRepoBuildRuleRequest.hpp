...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->buildArgs_ == nullptr
        && return this->buildRuleId_ == nullptr && return this->dockerfileLocation_ == nullptr && return this->dockerfileName_ == nullptr && return this->imageTag_ == nullptr && return this->instanceId_ == nullptr
        && return this->platforms_ == nullptr && return this->pushName_ == nullptr && return this->pushType_ == nullptr && return this->repoId_ == nullptr; };
