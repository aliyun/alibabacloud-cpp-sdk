...
namespace Models
{
  ...
  public:
    ...
    inline const GetRepoBuildRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRepoBuildRecordResponseBody) };
    inline GetRepoBuildRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRepoBuildRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRepoBuildRecordResponseBody> body_ {};
  };
