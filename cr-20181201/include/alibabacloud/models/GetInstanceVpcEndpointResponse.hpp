...
namespace Models
{
  ...
  public:
    ...
    inline const GetInstanceVpcEndpointResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, GetInstanceVpcEndpointResponseBody) };
    inline GetInstanceVpcEndpointResponseBody body() { DARABONBA_PTR_GET(body_, GetInstanceVpcEndpointResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<GetInstanceVpcEndpointResponseBody> body_ = nullptr;
  };
