...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateArtifactLifecycleRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateArtifactLifecycleRuleResponseBody) };
    inline UpdateArtifactLifecycleRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateArtifactLifecycleRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateArtifactLifecycleRuleResponseBody> body_ {};
  };
