...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteChartNamespaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteChartNamespaceResponseBody) };
    inline DeleteChartNamespaceResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteChartNamespaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteChartNamespaceResponseBody> body_ {};
  };
