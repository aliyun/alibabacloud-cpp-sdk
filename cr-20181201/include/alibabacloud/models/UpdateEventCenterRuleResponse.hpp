...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateEventCenterRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateEventCenterRuleResponseBody) };
    inline UpdateEventCenterRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateEventCenterRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateEventCenterRuleResponseBody> body_ {};
  };
