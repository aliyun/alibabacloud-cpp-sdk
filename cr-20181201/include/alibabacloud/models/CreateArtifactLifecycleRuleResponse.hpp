...
namespace Models
{
  ...
  public:
    ...
    inline const CreateArtifactLifecycleRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateArtifactLifecycleRuleResponseBody) };
    inline CreateArtifactLifecycleRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateArtifactLifecycleRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateArtifactLifecycleRuleResponseBody> body_ {};
  };
