...
namespace Models
{
  ...
  public:
    ...
    inline const GetRepoTagScanSummaryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetRepoTagScanSummaryResponseBody) };
    inline GetRepoTagScanSummaryResponseBody getBody() { DARABONBA_PTR_GET(body_, GetRepoTagScanSummaryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetRepoTagScanSummaryResponseBody> body_ {};
  };
