...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRepoSourceCodeRepoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRepoSourceCodeRepoResponseBody) };
    inline CreateRepoSourceCodeRepoResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRepoSourceCodeRepoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRepoSourceCodeRepoResponseBody> body_ {};
  };
