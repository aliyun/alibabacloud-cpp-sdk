...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->buildArgs_ == nullptr
        && this->dockerfileLocation_ == nullptr && this->dockerfileName_ == nullptr && this->imageTag_ == nullptr && this->instanceId_ == nullptr && this->platforms_ == nullptr
        && this->pushName_ == nullptr && this->pushType_ == nullptr && this->repoId_ == nullptr; };
