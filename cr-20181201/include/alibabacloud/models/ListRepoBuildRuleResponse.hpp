...
namespace Models
{
  ...
  public:
    ...
    inline const ListRepoBuildRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListRepoBuildRuleResponseBody) };
    inline ListRepoBuildRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, ListRepoBuildRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListRepoBuildRuleResponseBody> body_ {};
  };
