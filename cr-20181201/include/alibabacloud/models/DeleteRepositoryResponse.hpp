...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteRepositoryResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteRepositoryResponseBody) };
    inline DeleteRepositoryResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteRepositoryResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteRepositoryResponseBody> body_ {};
  };
