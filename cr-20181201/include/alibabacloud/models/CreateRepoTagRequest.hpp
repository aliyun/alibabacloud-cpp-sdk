...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->fromTag_ == nullptr
    ...
    inline string getFromTag() const { DARABONBA_PTR_GET_DEFAULT(fromTag_, "") };
    ...
    inline string getToTag() const { DARABONBA_PTR_GET_DEFAULT(toTag_, "") };
