...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRepoSyncTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRepoSyncTaskResponseBody) };
    inline CreateRepoSyncTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRepoSyncTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRepoSyncTaskResponseBody> body_ {};
  };
