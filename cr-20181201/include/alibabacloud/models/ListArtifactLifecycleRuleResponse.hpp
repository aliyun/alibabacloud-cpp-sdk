...
namespace Models
{
  ...
  public:
    ...
    inline const ListArtifactLifecycleRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListArtifactLifecycleRuleResponseBody) };
    inline ListArtifactLifecycleRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, ListArtifactLifecycleRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListArtifactLifecycleRuleResponseBody> body_ {};
  };
