...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRepoSyncRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRepoSyncRuleResponseBody) };
    inline CreateRepoSyncRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRepoSyncRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRepoSyncRuleResponseBody> body_ {};
  };
