...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteInstanceEndpointAclPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteInstanceEndpointAclPolicyResponseBody) };
    inline DeleteInstanceEndpointAclPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteInstanceEndpointAclPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteInstanceEndpointAclPolicyResponseBody> body_ {};
  };
