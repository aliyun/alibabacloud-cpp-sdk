...
namespace Models
{
  ...
  public:
    ...
    inline const GetArtifactLifecycleRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetArtifactLifecycleRuleResponseBody) };
    inline GetArtifactLifecycleRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, GetArtifactLifecycleRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetArtifactLifecycleRuleResponseBody> body_ {};
  };
