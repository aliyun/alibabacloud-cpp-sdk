...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->code_ == nullptr
        && return this->images_ == nullptr && return this->isSuccess_ == nullptr && return this->pageNo_ == nullptr && return this->pageSize_ == nullptr && return this->requestId_ == nullptr
    ...
    inline const vector<ListRepoTagResponseBodyImages> & images() const { DARABONBA_PTR_GET_CONST(images_, vector<ListRepoTagResponseBodyImages>) };
    inline vector<ListRepoTagResponseBodyImages> images() { DARABONBA_PTR_GET(images_, vector<ListRepoTagResponseBodyImages>) };
    inline ListRepoTagResponseBody& setImages(const vector<ListRepoTagResponseBodyImages> & images) { DARABONBA_PTR_SET_VALUE(images_, images) };
    inline ListRepoTagResponseBody& setImages(vector<ListRepoTagResponseBodyImages> && images) { DARABONBA_PTR_SET_RVALUE(images_, images) };
  ...
  protected:
    ...
    // The images.
    std::shared_ptr<vector<ListRepoTagResponseBodyImages>> images_ = nullptr;
