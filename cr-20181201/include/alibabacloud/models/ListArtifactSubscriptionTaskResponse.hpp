...
namespace Models
{
  ...
  public:
    ...
    inline const ListArtifactSubscriptionTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListArtifactSubscriptionTaskResponseBody) };
    inline ListArtifactSubscriptionTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, ListArtifactSubscriptionTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListArtifactSubscriptionTaskResponseBody> body_ {};
  };
