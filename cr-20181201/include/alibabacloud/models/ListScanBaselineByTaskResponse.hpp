...
namespace Models
{
  ...
  public:
    ...
    inline const ListScanBaselineByTaskResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListScanBaselineByTaskResponseBody) };
    inline ListScanBaselineByTaskResponseBody body() { DARABONBA_PTR_GET(body_, ListScanBaselineByTaskResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListScanBaselineByTaskResponseBody> body_ = nullptr;
  };
