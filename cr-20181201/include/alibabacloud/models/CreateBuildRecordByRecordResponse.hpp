...
namespace Models
{
  ...
  public:
    ...
    inline const CreateBuildRecordByRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateBuildRecordByRecordResponseBody) };
    inline CreateBuildRecordByRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateBuildRecordByRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateBuildRecordByRecordResponseBody> body_ {};
  };
