...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accelerate_ == nullptr
        ...
        && return this->ruleId_ == nullptr && return this->sourceNamespaceName_ == nullptr && return this->sourceProvider_ == nullptr && return this->sourceRepoName_ == nullptr && return this->tagCount_ == nullptr
