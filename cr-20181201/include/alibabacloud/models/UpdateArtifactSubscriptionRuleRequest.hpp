...
namespace Models
{
  ...
  public:
    ...
    inline string getAccelerate() const { DARABONBA_PTR_GET_DEFAULT(accelerate_, "") };
    ...
    inline string getOverride() const { DARABONBA_PTR_GET_DEFAULT(override_, "") };
