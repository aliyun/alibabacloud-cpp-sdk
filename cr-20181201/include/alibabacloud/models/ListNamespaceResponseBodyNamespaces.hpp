...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoCreateRepo_ == nullptr
        && return this->defaultRepoConfiguration_ == nullptr && return this->defaultRepoType_ == nullptr && return this->instanceId_ == nullptr && return this->namespaceId_ == nullptr && return this->namespaceName_ == nullptr
        && return this->namespaceStatus_ == nullptr && return this->resourceGroupId_ == nullptr; };
