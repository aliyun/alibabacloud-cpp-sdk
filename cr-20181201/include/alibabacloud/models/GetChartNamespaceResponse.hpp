...
namespace Models
{
  ...
  public:
    ...
    inline const GetChartNamespaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetChartNamespaceResponseBody) };
    inline GetChartNamespaceResponseBody getBody() { DARABONBA_PTR_GET(body_, GetChartNamespaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetChartNamespaceResponseBody> body_ {};
  };
