...
namespace Models
{
  ...
  public:
    ...
    inline const CancelRepoBuildRecordResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CancelRepoBuildRecordResponseBody) };
    inline CancelRepoBuildRecordResponseBody getBody() { DARABONBA_PTR_GET(body_, CancelRepoBuildRecordResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CancelRepoBuildRecordResponseBody> body_ {};
  };
