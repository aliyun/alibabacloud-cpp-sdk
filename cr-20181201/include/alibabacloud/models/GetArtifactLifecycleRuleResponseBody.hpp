...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->auto_ == nullptr
        && return this->code_ == nullptr && return this->createTime_ == nullptr && return this->enableDeleteTag_ == nullptr && return this->instanceId_ == nullptr && return this->isSuccess_ == nullptr
        && return this->modifiedTime_ == nullptr && return this->namespaceName_ == nullptr && return this->nextTime_ == nullptr && return this->policies_ == nullptr && return this->repoName_ == nullptr
        && return this->requestId_ == nullptr && return this->retentionTagCount_ == nullptr && return this->ruleId_ == nullptr && return this->scheduleTime_ == nullptr && return this->scope_ == nullptr
        && return this->tagRegexp_ == nullptr; };
