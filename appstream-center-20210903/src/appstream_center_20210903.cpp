...
ListLFUAppResponse Alibabacloud_Appstream-center20210903::Client::listLFUAppWithOptions(shared_ptr<ListLFUAppRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  Darabonba_Util::Client::validateModel(request);
  shared_ptr<map<string, boost::any>> body = make_shared<map<string, boost::any>>(map<string, boost::any>());
  ...
  if (!Darabonba_Util::Client::isUnset<string>(request->extendsAccessToken)) {
    body->insert(pair<string, string>("ExtendsAccessToken", *request->extendsAccessToken));
  }
  ...
  shared_ptr<Alibabacloud_OpenApi::Params> params = make_shared<Alibabacloud_OpenApi::Params>(map<string, boost::any>({
    {"action", boost::any(string("ListLFUApp"))},
    {"version", boost::any(string("2021-09-03"))},
    {"protocol", boost::any(string("HTTPS"))},
    {"pathname", boost::any(string("/"))},
    {"method", boost::any(string("POST"))},
  ...
  return ListLFUAppResponse(callApi(params, req, runtime));
}

ListLFUAppResponse Alibabacloud_Appstream-center20210903::Client::listLFUApp(shared_ptr<ListLFUAppRequest> request) {
  shared_ptr<Darabonba_Util::RuntimeOptions> runtime = make_shared<Darabonba_Util::RuntimeOptions>();
