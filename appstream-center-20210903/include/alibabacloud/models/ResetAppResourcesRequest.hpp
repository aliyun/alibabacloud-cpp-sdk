...
#ifndef ALIBABACLOUD_MODELS_RESETAPPRESOURCESREQUEST_HPP_
#define ALIBABACLOUD_MODELS_RESETAPPRESOURCESREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ResetAppResourcesRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ResetAppResourcesRequest& obj) { 
    ...
    ResetAppResourcesRequest() = default ;
    ResetAppResourcesRequest(const ResetAppResourcesRequest &) = default ;
    ResetAppResourcesRequest(ResetAppResourcesRequest &&) = default ;
    ResetAppResourcesRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ResetAppResourcesRequest() = default ;
    ResetAppResourcesRequest& operator=(const ResetAppResourcesRequest &) = default ;
    ResetAppResourcesRequest& operator=(ResetAppResourcesRequest &&) = default ;
    ...
    inline ResetAppResourcesRequest& setAppInstanceGroupId(string appInstanceGroupId) { DARABONBA_PTR_SET_VALUE(appInstanceGroupId_, appInstanceGroupId) };
    ...
    inline ResetAppResourcesRequest& setBizRegionId(string bizRegionId) { DARABONBA_PTR_SET_VALUE(bizRegionId_, bizRegionId) };
    ...
    inline ResetAppResourcesRequest& setClientId(string clientId) { DARABONBA_PTR_SET_VALUE(clientId_, clientId) };
    ...
    inline ResetAppResourcesRequest& setClientIp(string clientIp) { DARABONBA_PTR_SET_VALUE(clientIp_, clientIp) };
    ...
    inline ResetAppResourcesRequest& setClientOS(string clientOS) { DARABONBA_PTR_SET_VALUE(clientOS_, clientOS) };
    ...
    inline ResetAppResourcesRequest& setClientVersion(string clientVersion) { DARABONBA_PTR_SET_VALUE(clientVersion_, clientVersion) };
    ...
    inline ResetAppResourcesRequest& setEndUserId(string endUserId) { DARABONBA_PTR_SET_VALUE(endUserId_, endUserId) };
    ...
    inline ResetAppResourcesRequest& setLoginRegionId(string loginRegionId) { DARABONBA_PTR_SET_VALUE(loginRegionId_, loginRegionId) };
    ...
    inline ResetAppResourcesRequest& setLoginToken(string loginToken) { DARABONBA_PTR_SET_VALUE(loginToken_, loginToken) };
    ...
    inline ResetAppResourcesRequest& setProductType(string productType) { DARABONBA_PTR_SET_VALUE(productType_, productType) };
    ...
    inline ResetAppResourcesRequest& setResourceIds(const vector<string> & resourceIds) { DARABONBA_PTR_SET_VALUE(resourceIds_, resourceIds) };
    inline ResetAppResourcesRequest& setResourceIds(vector<string> && resourceIds) { DARABONBA_PTR_SET_RVALUE(resourceIds_, resourceIds) };
    ...
    inline ResetAppResourcesRequest& setSessionId(string sessionId) { DARABONBA_PTR_SET_VALUE(sessionId_, sessionId) };
    ...
    inline ResetAppResourcesRequest& setUuid(string uuid) { DARABONBA_PTR_SET_VALUE(uuid_, uuid) };
