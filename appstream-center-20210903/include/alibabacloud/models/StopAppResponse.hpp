...
namespace Models
{
  ...
  public:
    ...
    inline const StopAppResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, StopAppResponseBody) };
    inline StopAppResponseBody getBody() { DARABONBA_PTR_GET(body_, StopAppResponseBody) };
  ...
  protected:
    ...
    shared_ptr<StopAppResponseBody> body_ {};
  };
