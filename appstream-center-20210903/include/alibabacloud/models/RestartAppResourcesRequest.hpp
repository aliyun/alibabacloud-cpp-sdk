...
#ifndef ALIBABACLOUD_MODELS_RESTARTAPPRESOURCESREQUEST_HPP_
#define ALIBABACLOUD_MODELS_RESTARTAPPRESOURCESREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const RestartAppResourcesRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, RestartAppResourcesRequest& obj) { 
    ...
    RestartAppResourcesRequest() = default ;
    RestartAppResourcesRequest(const RestartAppResourcesRequest &) = default ;
    RestartAppResourcesRequest(RestartAppResourcesRequest &&) = default ;
    RestartAppResourcesRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~RestartAppResourcesRequest() = default ;
    RestartAppResourcesRequest& operator=(const RestartAppResourcesRequest &) = default ;
    RestartAppResourcesRequest& operator=(RestartAppResourcesRequest &&) = default ;
    ...
    inline RestartAppResourcesRequest& setAppInstanceGroupId(string appInstanceGroupId) { DARABONBA_PTR_SET_VALUE(appInstanceGroupId_, appInstanceGroupId) };
    ...
    inline RestartAppResourcesRequest& setBizRegionId(string bizRegionId) { DARABONBA_PTR_SET_VALUE(bizRegionId_, bizRegionId) };
    ...
    inline RestartAppResourcesRequest& setClientId(string clientId) { DARABONBA_PTR_SET_VALUE(clientId_, clientId) };
    ...
    inline RestartAppResourcesRequest& setClientIp(string clientIp) { DARABONBA_PTR_SET_VALUE(clientIp_, clientIp) };
    ...
    inline RestartAppResourcesRequest& setClientOS(string clientOS) { DARABONBA_PTR_SET_VALUE(clientOS_, clientOS) };
    ...
    inline RestartAppResourcesRequest& setClientVersion(string clientVersion) { DARABONBA_PTR_SET_VALUE(clientVersion_, clientVersion) };
    ...
    inline RestartAppResourcesRequest& setEndUserId(string endUserId) { DARABONBA_PTR_SET_VALUE(endUserId_, endUserId) };
    ...
    inline RestartAppResourcesRequest& setLoginRegionId(string loginRegionId) { DARABONBA_PTR_SET_VALUE(loginRegionId_, loginRegionId) };
    ...
    inline RestartAppResourcesRequest& setLoginToken(string loginToken) { DARABONBA_PTR_SET_VALUE(loginToken_, loginToken) };
    ...
    inline RestartAppResourcesRequest& setProductType(string productType) { DARABONBA_PTR_SET_VALUE(productType_, productType) };
    ...
    inline RestartAppResourcesRequest& setResourceIds(const vector<string> & resourceIds) { DARABONBA_PTR_SET_VALUE(resourceIds_, resourceIds) };
    inline RestartAppResourcesRequest& setResourceIds(vector<string> && resourceIds) { DARABONBA_PTR_SET_RVALUE(resourceIds_, resourceIds) };
    ...
    inline RestartAppResourcesRequest& setSessionId(string sessionId) { DARABONBA_PTR_SET_VALUE(sessionId_, sessionId) };
    ...
    inline RestartAppResourcesRequest& setUuid(string uuid) { DARABONBA_PTR_SET_VALUE(uuid_, uuid) };
