...
namespace Models
{
  ...
  public:
    ...
    inline const RestartAppResourcesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RestartAppResourcesResponseBody) };
    inline RestartAppResourcesResponseBody getBody() { DARABONBA_PTR_GET(body_, RestartAppResourcesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RestartAppResourcesResponseBody> body_ {};
  };
