...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeMonitorTaskLimitResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeMonitorTaskLimitResponseBody) };
    inline DescribeMonitorTaskLimitResponseBody body() { DARABONBA_PTR_GET(body_, DescribeMonitorTaskLimitResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeMonitorTaskLimitResponseBody> body_ = nullptr;
  };
