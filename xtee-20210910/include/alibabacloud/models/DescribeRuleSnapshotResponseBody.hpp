...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRuleSnapshotResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeRuleSnapshotResponseBodyResultObject) };
    inline DescribeRuleSnapshotResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeRuleSnapshotResponseBodyResultObject) };
    inline DescribeRuleSnapshotResponseBody& setResultObject(const DescribeRuleSnapshotResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeRuleSnapshotResponseBody& setResultObject(DescribeRuleSnapshotResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<DescribeRuleSnapshotResponseBodyResultObject> resultObject_ = nullptr;
  };
