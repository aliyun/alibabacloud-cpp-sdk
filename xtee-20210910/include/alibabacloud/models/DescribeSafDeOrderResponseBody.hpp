...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSafDeOrderResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeSafDeOrderResponseBodyResultObject) };
    inline DescribeSafDeOrderResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeSafDeOrderResponseBodyResultObject) };
    inline DescribeSafDeOrderResponseBody& setResultObject(const DescribeSafDeOrderResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSafDeOrderResponseBody& setResultObject(DescribeSafDeOrderResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<DescribeSafDeOrderResponseBodyResultObject> resultObject_ = nullptr;
  };
