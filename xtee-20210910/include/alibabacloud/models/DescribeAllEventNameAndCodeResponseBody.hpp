...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAllEventNameAndCodeResponseBody::ResultObject> & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeAllEventNameAndCodeResponseBody::ResultObject>) };
    inline vector<DescribeAllEventNameAndCodeResponseBody::ResultObject> getResultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeAllEventNameAndCodeResponseBody::ResultObject>) };
    inline DescribeAllEventNameAndCodeResponseBody& setResultObject(const vector<DescribeAllEventNameAndCodeResponseBody::ResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeAllEventNameAndCodeResponseBody& setResultObject(vector<DescribeAllEventNameAndCodeResponseBody::ResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
