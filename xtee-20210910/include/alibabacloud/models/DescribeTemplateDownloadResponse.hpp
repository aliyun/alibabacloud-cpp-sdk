...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTemplateDownloadResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTemplateDownloadResponseBody) };
    inline DescribeTemplateDownloadResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTemplateDownloadResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTemplateDownloadResponseBody> body_ {};
  };
