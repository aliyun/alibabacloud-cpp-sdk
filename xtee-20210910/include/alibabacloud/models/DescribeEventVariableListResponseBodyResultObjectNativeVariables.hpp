...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEEVENTVARIABLELISTRESPONSEBODYRESULTOBJECTNATIVEVARIABLES_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEEVENTVARIABLELISTRESPONSEBODYRESULTOBJECTNATIVEVARIABLES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeEventVariableListResponseBodyResultObjectNativeVariables& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeEventVariableListResponseBodyResultObjectNativeVariables& obj) { 
    ...
    DescribeEventVariableListResponseBodyResultObjectNativeVariables() = default ;
    DescribeEventVariableListResponseBodyResultObjectNativeVariables(const DescribeEventVariableListResponseBodyResultObjectNativeVariables &) = default ;
    DescribeEventVariableListResponseBodyResultObjectNativeVariables(DescribeEventVariableListResponseBodyResultObjectNativeVariables &&) = default ;
    DescribeEventVariableListResponseBodyResultObjectNativeVariables(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeEventVariableListResponseBodyResultObjectNativeVariables() = default ;
    DescribeEventVariableListResponseBodyResultObjectNativeVariables& operator=(const DescribeEventVariableListResponseBodyResultObjectNativeVariables &) = default ;
    DescribeEventVariableListResponseBodyResultObjectNativeVariables& operator=(DescribeEventVariableListResponseBodyResultObjectNativeVariables &&) = default ;
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setDataDisplay(string dataDisplay) { DARABONBA_PTR_SET_VALUE(dataDisplay_, dataDisplay) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setDefineId(string defineId) { DARABONBA_PTR_SET_VALUE(defineId_, defineId) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setDisplayType(string displayType) { DARABONBA_PTR_SET_VALUE(displayType_, displayType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setExpressionTitle(string expressionTitle) { DARABONBA_PTR_SET_VALUE(expressionTitle_, expressionTitle) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setFavoriteFlag(bool favoriteFlag) { DARABONBA_PTR_SET_VALUE(favoriteFlag_, favoriteFlag) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setFieldDetail(string fieldDetail) { DARABONBA_PTR_SET_VALUE(fieldDetail_, fieldDetail) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setFieldRank(int32_t fieldRank) { DARABONBA_PTR_SET_VALUE(fieldRank_, fieldRank) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setFieldSource(string fieldSource) { DARABONBA_PTR_SET_VALUE(fieldSource_, fieldSource) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setFieldType(string fieldType) { DARABONBA_PTR_SET_VALUE(fieldType_, fieldType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setInputFieldType(string inputFieldType) { DARABONBA_PTR_SET_VALUE(inputFieldType_, inputFieldType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setInputRequired(string inputRequired) { DARABONBA_PTR_SET_VALUE(inputRequired_, inputRequired) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setInputs(string inputs) { DARABONBA_PTR_SET_VALUE(inputs_, inputs) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setOutlier(string outlier) { DARABONBA_PTR_SET_VALUE(outlier_, outlier) };
    ...
    inline const Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesOutputThreshold & outputThreshold() const { DARABONBA_PTR_GET_CONST(outputThreshold_, Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesOutputThreshold) };
    inline Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesOutputThreshold outputThreshold() { DARABONBA_PTR_GET(outputThreshold_, Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesOutputThreshold) };
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setOutputThreshold(const Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesOutputThreshold & outputThreshold) { DARABONBA_PTR_SET_VALUE(outputThreshold_, outputThreshold) };
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setOutputThreshold(Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesOutputThreshold && outputThreshold) { DARABONBA_PTR_SET_RVALUE(outputThreshold_, outputThreshold) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setParentName(string parentName) { DARABONBA_PTR_SET_VALUE(parentName_, parentName) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline const Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesVariableVelocity & variableVelocity() const { DARABONBA_PTR_GET_CONST(variableVelocity_, Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesVariableVelocity) };
    inline Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesVariableVelocity variableVelocity() { DARABONBA_PTR_GET(variableVelocity_, Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesVariableVelocity) };
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setVariableVelocity(const Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesVariableVelocity & variableVelocity) { DARABONBA_PTR_SET_VALUE(variableVelocity_, variableVelocity) };
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setVariableVelocity(Models::DescribeEventVariableListResponseBodyResultObjectNativeVariablesVariableVelocity && variableVelocity) { DARABONBA_PTR_SET_RVALUE(variableVelocity_, variableVelocity) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setXLabel(string xLabel) { DARABONBA_PTR_SET_VALUE(xLabel_, xLabel) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariables& setYLabel(string yLabel) { DARABONBA_PTR_SET_VALUE(yLabel_, yLabel) };
