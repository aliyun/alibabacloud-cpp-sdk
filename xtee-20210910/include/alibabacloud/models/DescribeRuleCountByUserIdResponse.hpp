...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRuleCountByUserIdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRuleCountByUserIdResponseBody) };
    inline DescribeRuleCountByUserIdResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRuleCountByUserIdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRuleCountByUserIdResponseBody> body_ {};
  };
