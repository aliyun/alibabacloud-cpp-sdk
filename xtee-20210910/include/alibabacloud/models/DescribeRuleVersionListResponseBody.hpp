...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeRuleVersionListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeRuleVersionListResponseBodyResultObject>) };
    inline vector<DescribeRuleVersionListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeRuleVersionListResponseBodyResultObject>) };
    inline DescribeRuleVersionListResponseBody& setResultObject(const vector<DescribeRuleVersionListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeRuleVersionListResponseBody& setResultObject(vector<DescribeRuleVersionListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeRuleVersionListResponseBodyResultObject>> resultObject_ = nullptr;
