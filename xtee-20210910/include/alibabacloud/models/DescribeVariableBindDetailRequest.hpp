...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVARIABLEBINDDETAILREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVARIABLEBINDDETAILREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVariableBindDetailRequest& obj) { 
      DARABONBA_PTR_TO_JSON(Lang, lang_);
      DARABONBA_PTR_TO_JSON(defineId, defineId_);
      DARABONBA_PTR_TO_JSON(id, id_);
      DARABONBA_PTR_TO_JSON(regId, regId_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeVariableBindDetailRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(Lang, lang_);
      DARABONBA_PTR_FROM_JSON(defineId, defineId_);
      DARABONBA_PTR_FROM_JSON(id, id_);
      DARABONBA_PTR_FROM_JSON(regId, regId_);
    };
    DescribeVariableBindDetailRequest() = default ;
    DescribeVariableBindDetailRequest(const DescribeVariableBindDetailRequest &) = default ;
    DescribeVariableBindDetailRequest(DescribeVariableBindDetailRequest &&) = default ;
    DescribeVariableBindDetailRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVariableBindDetailRequest() = default ;
    DescribeVariableBindDetailRequest& operator=(const DescribeVariableBindDetailRequest &) = default ;
    DescribeVariableBindDetailRequest& operator=(DescribeVariableBindDetailRequest &&) = default ;
