...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApisResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApisResponseBody) };
    inline DescribeApisResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApisResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApisResponseBody> body_ {};
  };
