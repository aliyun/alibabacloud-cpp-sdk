...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEEVENTVARIABLELISTRESPONSEBODYRESULTOBJECTSELFVARIABLES_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEEVENTVARIABLELISTRESPONSEBODYRESULTOBJECTSELFVARIABLES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeEventVariableListResponseBodyResultObjectSelfVariables& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeEventVariableListResponseBodyResultObjectSelfVariables& obj) { 
    ...
    DescribeEventVariableListResponseBodyResultObjectSelfVariables() = default ;
    DescribeEventVariableListResponseBodyResultObjectSelfVariables(const DescribeEventVariableListResponseBodyResultObjectSelfVariables &) = default ;
    DescribeEventVariableListResponseBodyResultObjectSelfVariables(DescribeEventVariableListResponseBodyResultObjectSelfVariables &&) = default ;
    DescribeEventVariableListResponseBodyResultObjectSelfVariables(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeEventVariableListResponseBodyResultObjectSelfVariables() = default ;
    DescribeEventVariableListResponseBodyResultObjectSelfVariables& operator=(const DescribeEventVariableListResponseBodyResultObjectSelfVariables &) = default ;
    DescribeEventVariableListResponseBodyResultObjectSelfVariables& operator=(DescribeEventVariableListResponseBodyResultObjectSelfVariables &&) = default ;
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setDataDisplay(string dataDisplay) { DARABONBA_PTR_SET_VALUE(dataDisplay_, dataDisplay) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setDefineId(string defineId) { DARABONBA_PTR_SET_VALUE(defineId_, defineId) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setDisplayType(string displayType) { DARABONBA_PTR_SET_VALUE(displayType_, displayType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setExpressionTitle(string expressionTitle) { DARABONBA_PTR_SET_VALUE(expressionTitle_, expressionTitle) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setFavoriteFlag(bool favoriteFlag) { DARABONBA_PTR_SET_VALUE(favoriteFlag_, favoriteFlag) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setFieldDetail(string fieldDetail) { DARABONBA_PTR_SET_VALUE(fieldDetail_, fieldDetail) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setFieldRank(int32_t fieldRank) { DARABONBA_PTR_SET_VALUE(fieldRank_, fieldRank) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setFieldSource(string fieldSource) { DARABONBA_PTR_SET_VALUE(fieldSource_, fieldSource) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setFieldType(string fieldType) { DARABONBA_PTR_SET_VALUE(fieldType_, fieldType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setInputFieldType(string inputFieldType) { DARABONBA_PTR_SET_VALUE(inputFieldType_, inputFieldType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setInputRequired(string inputRequired) { DARABONBA_PTR_SET_VALUE(inputRequired_, inputRequired) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setInputs(string inputs) { DARABONBA_PTR_SET_VALUE(inputs_, inputs) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setOutlier(string outlier) { DARABONBA_PTR_SET_VALUE(outlier_, outlier) };
    ...
    inline const Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesOutputThreshold & outputThreshold() const { DARABONBA_PTR_GET_CONST(outputThreshold_, Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesOutputThreshold) };
    inline Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesOutputThreshold outputThreshold() { DARABONBA_PTR_GET(outputThreshold_, Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesOutputThreshold) };
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setOutputThreshold(const Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesOutputThreshold & outputThreshold) { DARABONBA_PTR_SET_VALUE(outputThreshold_, outputThreshold) };
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setOutputThreshold(Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesOutputThreshold && outputThreshold) { DARABONBA_PTR_SET_RVALUE(outputThreshold_, outputThreshold) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setParentName(string parentName) { DARABONBA_PTR_SET_VALUE(parentName_, parentName) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline const Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesVariableVelocity & variableVelocity() const { DARABONBA_PTR_GET_CONST(variableVelocity_, Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesVariableVelocity) };
    inline Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesVariableVelocity variableVelocity() { DARABONBA_PTR_GET(variableVelocity_, Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesVariableVelocity) };
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setVariableVelocity(const Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesVariableVelocity & variableVelocity) { DARABONBA_PTR_SET_VALUE(variableVelocity_, variableVelocity) };
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setVariableVelocity(Models::DescribeEventVariableListResponseBodyResultObjectSelfVariablesVariableVelocity && variableVelocity) { DARABONBA_PTR_SET_RVALUE(variableVelocity_, variableVelocity) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setXLabel(string xLabel) { DARABONBA_PTR_SET_VALUE(xLabel_, xLabel) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectSelfVariables& setYLabel(string yLabel) { DARABONBA_PTR_SET_VALUE(yLabel_, yLabel) };
