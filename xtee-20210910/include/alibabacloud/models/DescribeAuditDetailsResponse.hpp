...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAuditDetailsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAuditDetailsResponseBody) };
    inline DescribeAuditDetailsResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAuditDetailsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAuditDetailsResponseBody> body_ {};
  };
