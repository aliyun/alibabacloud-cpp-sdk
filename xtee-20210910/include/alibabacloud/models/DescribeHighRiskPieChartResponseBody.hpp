...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHighRiskPieChartResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeHighRiskPieChartResponseBodyResultObject) };
    inline DescribeHighRiskPieChartResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeHighRiskPieChartResponseBodyResultObject) };
    inline DescribeHighRiskPieChartResponseBody& setResultObject(const DescribeHighRiskPieChartResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeHighRiskPieChartResponseBody& setResultObject(DescribeHighRiskPieChartResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<DescribeHighRiskPieChartResponseBodyResultObject> resultObject_ = nullptr;
