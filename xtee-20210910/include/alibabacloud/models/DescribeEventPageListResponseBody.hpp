...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeEventPageListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeEventPageListResponseBodyResultObject>) };
    inline vector<DescribeEventPageListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeEventPageListResponseBodyResultObject>) };
    inline DescribeEventPageListResponseBody& setResultObject(const vector<DescribeEventPageListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeEventPageListResponseBody& setResultObject(vector<DescribeEventPageListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeEventPageListResponseBodyResultObject>> resultObject_ = nullptr;
