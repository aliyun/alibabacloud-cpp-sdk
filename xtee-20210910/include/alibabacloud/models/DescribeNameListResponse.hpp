...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNameListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeNameListResponseBody) };
    inline DescribeNameListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeNameListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeNameListResponseBody> body_ {};
  };
