...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAuthSceneListResponseBody::ResultObject> & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeAuthSceneListResponseBody::ResultObject>) };
    inline vector<DescribeAuthSceneListResponseBody::ResultObject> getResultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeAuthSceneListResponseBody::ResultObject>) };
    inline DescribeAuthSceneListResponseBody& setResultObject(const vector<DescribeAuthSceneListResponseBody::ResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeAuthSceneListResponseBody& setResultObject(vector<DescribeAuthSceneListResponseBody::ResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
