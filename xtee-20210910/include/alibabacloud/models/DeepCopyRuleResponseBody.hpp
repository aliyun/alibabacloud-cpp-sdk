...
namespace Models
{
  ...
  public:
    ...
    inline const DeepCopyRuleResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DeepCopyRuleResponseBodyResultObject) };
    inline DeepCopyRuleResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DeepCopyRuleResponseBodyResultObject) };
    inline DeepCopyRuleResponseBody& setResultObject(const DeepCopyRuleResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DeepCopyRuleResponseBody& setResultObject(DeepCopyRuleResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<DeepCopyRuleResponseBodyResultObject> resultObject_ = nullptr;
  };
