...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSampleSceneListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSampleSceneListResponseBody) };
    inline DescribeSampleSceneListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSampleSceneListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSampleSceneListResponseBody> body_ {};
  };
