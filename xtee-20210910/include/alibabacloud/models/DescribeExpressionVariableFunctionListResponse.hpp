...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExpressionVariableFunctionListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExpressionVariableFunctionListResponseBody) };
    inline DescribeExpressionVariableFunctionListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExpressionVariableFunctionListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExpressionVariableFunctionListResponseBody> body_ {};
  };
