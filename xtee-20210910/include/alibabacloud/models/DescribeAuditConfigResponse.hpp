...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAuditConfigResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAuditConfigResponseBody) };
    inline DescribeAuditConfigResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAuditConfigResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAuditConfigResponseBody> body_ = nullptr;
  };
