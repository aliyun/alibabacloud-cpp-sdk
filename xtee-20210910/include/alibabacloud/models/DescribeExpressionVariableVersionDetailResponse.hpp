...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExpressionVariableVersionDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExpressionVariableVersionDetailResponseBody) };
    inline DescribeExpressionVariableVersionDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExpressionVariableVersionDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExpressionVariableVersionDetailResponseBody> body_ {};
  };
