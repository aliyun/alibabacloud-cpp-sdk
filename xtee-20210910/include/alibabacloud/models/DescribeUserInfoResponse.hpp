...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeUserInfoResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeUserInfoResponseBody) };
    inline DescribeUserInfoResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeUserInfoResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeUserInfoResponseBody> body_ {};
  };
