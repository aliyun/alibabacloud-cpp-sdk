...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVARIABLESCENELISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVARIABLESCENELISTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVariableSceneListResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeVariableSceneListResponseBody& obj) { 
    ...
    DescribeVariableSceneListResponseBody() = default ;
    DescribeVariableSceneListResponseBody(const DescribeVariableSceneListResponseBody &) = default ;
    DescribeVariableSceneListResponseBody(DescribeVariableSceneListResponseBody &&) = default ;
    DescribeVariableSceneListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVariableSceneListResponseBody() = default ;
    DescribeVariableSceneListResponseBody& operator=(const DescribeVariableSceneListResponseBody &) = default ;
    DescribeVariableSceneListResponseBody& operator=(DescribeVariableSceneListResponseBody &&) = default ;
    ...
    inline DescribeVariableSceneListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeVariableSceneListResponseBody& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline DescribeVariableSceneListResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };


    // resultObject Field Functions 
    bool hasResultObject() const { return this->resultObject_ != nullptr;};
    void deleteResultObject() { this->resultObject_ = nullptr;};
    inline const vector<DescribeVariableSceneListResponseBody::ResultObject> & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeVariableSceneListResponseBody::ResultObject>) };
    inline vector<DescribeVariableSceneListResponseBody::ResultObject> getResultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeVariableSceneListResponseBody::ResultObject>) };
    inline DescribeVariableSceneListResponseBody& setResultObject(const vector<DescribeVariableSceneListResponseBody::ResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeVariableSceneListResponseBody& setResultObject(vector<DescribeVariableSceneListResponseBody::ResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
    ...
    inline DescribeVariableSceneListResponseBody& setTotalItem(int32_t totalItem) { DARABONBA_PTR_SET_VALUE(totalItem_, totalItem) };
    ...
    inline DescribeVariableSceneListResponseBody& setTotalPage(int32_t totalPage) { DARABONBA_PTR_SET_VALUE(totalPage_, totalPage) };
  ...
  protected:
    ...
    // Returned object.
    shared_ptr<vector<DescribeVariableSceneListResponseBody::ResultObject>> resultObject_ {};
