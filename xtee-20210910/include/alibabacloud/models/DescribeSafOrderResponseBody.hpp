...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSafOrderResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeSafOrderResponseBodyResultObject) };
    inline DescribeSafOrderResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeSafOrderResponseBodyResultObject) };
    inline DescribeSafOrderResponseBody& setResultObject(const DescribeSafOrderResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSafOrderResponseBody& setResultObject(DescribeSafOrderResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object.
    std::shared_ptr<DescribeSafOrderResponseBodyResultObject> resultObject_ = nullptr;
  };
