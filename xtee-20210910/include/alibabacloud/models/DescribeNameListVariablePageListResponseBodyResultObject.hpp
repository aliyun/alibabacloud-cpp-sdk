...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->capacity_ == nullptr
        && return this->description_ == nullptr && return this->gmtCreate_ == nullptr && return this->gmtModified_ == nullptr && return this->id_ == nullptr && return this->leftCapacity_ == nullptr
        && return this->name_ == nullptr && return this->nameListType_ == nullptr && return this->refObjId_ == nullptr && return this->refObjType_ == nullptr && return this->sourceType_ == nullptr
