...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApiLimitResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeApiLimitResponseBody) };
    inline DescribeApiLimitResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeApiLimitResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeApiLimitResponseBody> body_ {};
  };
