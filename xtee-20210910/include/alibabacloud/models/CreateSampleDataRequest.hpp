...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->lang_ != nullptr
        && this->description_ != nullptr && this->encryptType_ != nullptr && this->name_ != nullptr && this->regId_ != nullptr && this->riskValue_ != nullptr
        && this->scene_ != nullptr && this->storePath_ != nullptr && this->storeType_ != nullptr; };
