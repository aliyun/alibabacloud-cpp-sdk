...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTagsRatioLineChartResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeTagsRatioLineChartResponseBody::ResultObject) };
    inline DescribeTagsRatioLineChartResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, DescribeTagsRatioLineChartResponseBody::ResultObject) };
    inline DescribeTagsRatioLineChartResponseBody& setResultObject(const DescribeTagsRatioLineChartResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeTagsRatioLineChartResponseBody& setResultObject(DescribeTagsRatioLineChartResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    shared_ptr<DescribeTagsRatioLineChartResponseBody::ResultObject> resultObject_ {};
  };
