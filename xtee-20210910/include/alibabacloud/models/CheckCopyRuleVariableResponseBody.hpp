...
namespace Models
{
  ...
  public:
    ...
    inline const CheckCopyRuleVariableResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, CheckCopyRuleVariableResponseBodyResultObject) };
    inline CheckCopyRuleVariableResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, CheckCopyRuleVariableResponseBodyResultObject) };
    inline CheckCopyRuleVariableResponseBody& setResultObject(const CheckCopyRuleVariableResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline CheckCopyRuleVariableResponseBody& setResultObject(CheckCopyRuleVariableResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<CheckCopyRuleVariableResponseBodyResultObject> resultObject_ = nullptr;
  };
