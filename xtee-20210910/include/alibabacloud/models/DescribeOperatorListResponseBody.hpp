...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeOperatorListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeOperatorListResponseBodyResultObject>) };
    inline vector<DescribeOperatorListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeOperatorListResponseBodyResultObject>) };
    inline DescribeOperatorListResponseBody& setResultObject(const vector<DescribeOperatorListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeOperatorListResponseBody& setResultObject(vector<DescribeOperatorListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeOperatorListResponseBodyResultObject>> resultObject_ = nullptr;
  };
