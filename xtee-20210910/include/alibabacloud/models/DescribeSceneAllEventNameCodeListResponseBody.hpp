...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSceneAllEventNameCodeListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeSceneAllEventNameCodeListResponseBodyResultObject>) };
    inline vector<DescribeSceneAllEventNameCodeListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeSceneAllEventNameCodeListResponseBodyResultObject>) };
    inline DescribeSceneAllEventNameCodeListResponseBody& setResultObject(const vector<DescribeSceneAllEventNameCodeListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSceneAllEventNameCodeListResponseBody& setResultObject(vector<DescribeSceneAllEventNameCodeListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeSceneAllEventNameCodeListResponseBodyResultObject>> resultObject_ = nullptr;
