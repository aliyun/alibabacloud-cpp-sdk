...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->dataVersion_ != nullptr
        && this->description_ != nullptr && this->gmtModified_ != nullptr && this->id_ != nullptr && this->name_ != nullptr && this->status_ != nullptr
        && this->title_ != nullptr; };
