...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeGroupPageResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeGroupPageResponseBodyResultObject>) };
    inline vector<DescribeGroupPageResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeGroupPageResponseBodyResultObject>) };
    inline DescribeGroupPageResponseBody& setResultObject(const vector<DescribeGroupPageResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeGroupPageResponseBody& setResultObject(vector<DescribeGroupPageResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object.
    std::shared_ptr<vector<DescribeGroupPageResponseBodyResultObject>> resultObject_ = nullptr;
