...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSampleBatchOssPolicyResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSampleBatchOssPolicyResponseBody) };
    inline DescribeSampleBatchOssPolicyResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSampleBatchOssPolicyResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSampleBatchOssPolicyResponseBody> body_ {};
  };
