...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEEVENTVARIABLELISTRESPONSEBODYRESULTOBJECTNATIVEVARIABLEFUNCTIONS_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEEVENTVARIABLELISTRESPONSEBODYRESULTOBJECTNATIVEVARIABLEFUNCTIONS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& obj) { 
    ...
    DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions() = default ;
    DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions(const DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions &) = default ;
    DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions(DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions &&) = default ;
    DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions() = default ;
    DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& operator=(const DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions &) = default ;
    DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& operator=(DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions &&) = default ;
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setDataDisplay(string dataDisplay) { DARABONBA_PTR_SET_VALUE(dataDisplay_, dataDisplay) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setDefineId(string defineId) { DARABONBA_PTR_SET_VALUE(defineId_, defineId) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setDisplayType(string displayType) { DARABONBA_PTR_SET_VALUE(displayType_, displayType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setExpressionTitle(string expressionTitle) { DARABONBA_PTR_SET_VALUE(expressionTitle_, expressionTitle) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setFavoriteFlag(bool favoriteFlag) { DARABONBA_PTR_SET_VALUE(favoriteFlag_, favoriteFlag) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setFieldDetail(string fieldDetail) { DARABONBA_PTR_SET_VALUE(fieldDetail_, fieldDetail) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setFieldRank(int32_t fieldRank) { DARABONBA_PTR_SET_VALUE(fieldRank_, fieldRank) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setFieldSource(string fieldSource) { DARABONBA_PTR_SET_VALUE(fieldSource_, fieldSource) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setFieldType(string fieldType) { DARABONBA_PTR_SET_VALUE(fieldType_, fieldType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setInputFieldType(string inputFieldType) { DARABONBA_PTR_SET_VALUE(inputFieldType_, inputFieldType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setInputRequired(string inputRequired) { DARABONBA_PTR_SET_VALUE(inputRequired_, inputRequired) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setInputs(string inputs) { DARABONBA_PTR_SET_VALUE(inputs_, inputs) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setOutlier(string outlier) { DARABONBA_PTR_SET_VALUE(outlier_, outlier) };
    ...
    inline const Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsOutputThreshold & outputThreshold() const { DARABONBA_PTR_GET_CONST(outputThreshold_, Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsOutputThreshold) };
    inline Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsOutputThreshold outputThreshold() { DARABONBA_PTR_GET(outputThreshold_, Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsOutputThreshold) };
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setOutputThreshold(const Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsOutputThreshold & outputThreshold) { DARABONBA_PTR_SET_VALUE(outputThreshold_, outputThreshold) };
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setOutputThreshold(Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsOutputThreshold && outputThreshold) { DARABONBA_PTR_SET_RVALUE(outputThreshold_, outputThreshold) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setParentName(string parentName) { DARABONBA_PTR_SET_VALUE(parentName_, parentName) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline const Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsVariableVelocity & variableVelocity() const { DARABONBA_PTR_GET_CONST(variableVelocity_, Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsVariableVelocity) };
    inline Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsVariableVelocity variableVelocity() { DARABONBA_PTR_GET(variableVelocity_, Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsVariableVelocity) };
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setVariableVelocity(const Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsVariableVelocity & variableVelocity) { DARABONBA_PTR_SET_VALUE(variableVelocity_, variableVelocity) };
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setVariableVelocity(Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsVariableVelocity && variableVelocity) { DARABONBA_PTR_SET_RVALUE(variableVelocity_, variableVelocity) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setXLabel(string xLabel) { DARABONBA_PTR_SET_VALUE(xLabel_, xLabel) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctions& setYLabel(string yLabel) { DARABONBA_PTR_SET_VALUE(yLabel_, yLabel) };
  ...
  protected:
    ...
    std::shared_ptr<Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsOutputThreshold> outputThreshold_ = nullptr;
    ...
    std::shared_ptr<Models::DescribeEventVariableListResponseBodyResultObjectNativeVariableFunctionsVariableVelocity> variableVelocity_ = nullptr;
