...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHitRuleFluctuationResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeHitRuleFluctuationResponseBody) };
    inline DescribeHitRuleFluctuationResponseBody body() { DARABONBA_PTR_GET(body_, DescribeHitRuleFluctuationResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeHitRuleFluctuationResponseBody> body_ = nullptr;
  };
