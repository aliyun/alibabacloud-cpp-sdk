...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRiskTagsLineChartResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeRiskTagsLineChartResponseBodyResultObject) };
    inline DescribeRiskTagsLineChartResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeRiskTagsLineChartResponseBodyResultObject) };
    inline DescribeRiskTagsLineChartResponseBody& setResultObject(const DescribeRiskTagsLineChartResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeRiskTagsLineChartResponseBody& setResultObject(DescribeRiskTagsLineChartResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRiskTagsLineChartResponseBodyResultObject> resultObject_ = nullptr;
