...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSafOrderResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSafOrderResponseBody) };
    inline DescribeSafOrderResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSafOrderResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSafOrderResponseBody> body_ {};
  };
