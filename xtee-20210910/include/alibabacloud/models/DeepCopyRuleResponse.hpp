...
namespace Models
{
  ...
  public:
    ...
    inline const DeepCopyRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeepCopyRuleResponseBody) };
    inline DeepCopyRuleResponseBody body() { DARABONBA_PTR_GET(body_, DeepCopyRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeepCopyRuleResponseBody> body_ = nullptr;
  };
