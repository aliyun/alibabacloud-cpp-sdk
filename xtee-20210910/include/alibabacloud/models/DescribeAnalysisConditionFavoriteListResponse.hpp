...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAnalysisConditionFavoriteListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAnalysisConditionFavoriteListResponseBody) };
    inline DescribeAnalysisConditionFavoriteListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAnalysisConditionFavoriteListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAnalysisConditionFavoriteListResponseBody> body_ {};
  };
