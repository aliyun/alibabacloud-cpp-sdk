...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeApiLimitResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeApiLimitResponseBodyResultObject) };
    inline DescribeApiLimitResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeApiLimitResponseBodyResultObject) };
    inline DescribeApiLimitResponseBody& setResultObject(const DescribeApiLimitResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeApiLimitResponseBody& setResultObject(DescribeApiLimitResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<DescribeApiLimitResponseBodyResultObject> resultObject_ = nullptr;
  };
