...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAvgExecuteCostReportResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeAvgExecuteCostReportResponseBodyResultObject>) };
    inline vector<DescribeAvgExecuteCostReportResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeAvgExecuteCostReportResponseBodyResultObject>) };
    inline DescribeAvgExecuteCostReportResponseBody& setResultObject(const vector<DescribeAvgExecuteCostReportResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeAvgExecuteCostReportResponseBody& setResultObject(vector<DescribeAvgExecuteCostReportResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeAvgExecuteCostReportResponseBodyResultObject>> resultObject_ = nullptr;
