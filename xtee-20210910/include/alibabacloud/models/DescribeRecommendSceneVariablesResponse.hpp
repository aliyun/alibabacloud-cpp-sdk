...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRecommendSceneVariablesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRecommendSceneVariablesResponseBody) };
    inline DescribeRecommendSceneVariablesResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRecommendSceneVariablesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRecommendSceneVariablesResponseBody> body_ {};
  };
