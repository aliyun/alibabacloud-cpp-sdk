...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTagsNumLineChartResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeTagsNumLineChartResponseBody::ResultObject) };
    inline DescribeTagsNumLineChartResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, DescribeTagsNumLineChartResponseBody::ResultObject) };
    inline DescribeTagsNumLineChartResponseBody& setResultObject(const DescribeTagsNumLineChartResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeTagsNumLineChartResponseBody& setResultObject(DescribeTagsNumLineChartResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
