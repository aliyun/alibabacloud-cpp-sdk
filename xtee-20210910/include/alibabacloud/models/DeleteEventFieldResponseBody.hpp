...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->requestId_ == nullptr
        && return this->resuleObject_ == nullptr; };
    ...
    inline bool resuleObject() const { DARABONBA_PTR_GET_DEFAULT(resuleObject_, false) };
  ...
  protected:
    ...
    // Result object
    std::shared_ptr<bool> resuleObject_ = nullptr;
  };
