...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDecisionResultTrendResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDecisionResultTrendResponseBody) };
    inline DescribeDecisionResultTrendResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDecisionResultTrendResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDecisionResultTrendResponseBody> body_ {};
  };
