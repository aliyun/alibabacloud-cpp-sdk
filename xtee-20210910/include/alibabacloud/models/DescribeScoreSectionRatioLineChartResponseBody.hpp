...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScoreSectionRatioLineChartResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeScoreSectionRatioLineChartResponseBody::ResultObject) };
    inline DescribeScoreSectionRatioLineChartResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, DescribeScoreSectionRatioLineChartResponseBody::ResultObject) };
    inline DescribeScoreSectionRatioLineChartResponseBody& setResultObject(const DescribeScoreSectionRatioLineChartResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeScoreSectionRatioLineChartResponseBody& setResultObject(DescribeScoreSectionRatioLineChartResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
