...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeFieldPageResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeFieldPageResponseBodyResultObject>) };
    inline vector<DescribeFieldPageResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeFieldPageResponseBodyResultObject>) };
    inline DescribeFieldPageResponseBody& setResultObject(const vector<DescribeFieldPageResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeFieldPageResponseBody& setResultObject(vector<DescribeFieldPageResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeFieldPageResponseBodyResultObject>> resultObject_ = nullptr;
