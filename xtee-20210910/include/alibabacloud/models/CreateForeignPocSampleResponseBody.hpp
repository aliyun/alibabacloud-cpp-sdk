...
#ifndef ALIBABACLOUD_MODELS_CREATEFOREIGNPOCSAMPLERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_CREATEFOREIGNPOCSAMPLERESPONSEBODY_HPP_
...
namespace Models
{
  class CreateForeignPocSampleResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CreateForeignPocSampleResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateForeignPocSampleResponseBody& obj) { 
    ...
    CreateForeignPocSampleResponseBody() = default ;
    CreateForeignPocSampleResponseBody(const CreateForeignPocSampleResponseBody &) = default ;
    CreateForeignPocSampleResponseBody(CreateForeignPocSampleResponseBody &&) = default ;
    CreateForeignPocSampleResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateForeignPocSampleResponseBody() = default ;
    CreateForeignPocSampleResponseBody& operator=(const CreateForeignPocSampleResponseBody &) = default ;
    CreateForeignPocSampleResponseBody& operator=(CreateForeignPocSampleResponseBody &&) = default ;
    ...
    inline CreateForeignPocSampleResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline CreateForeignPocSampleResponseBody& setHttpStatusCode(string httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline CreateForeignPocSampleResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline CreateForeignPocSampleResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // resultObject Field Functions 
    bool hasResultObject() const { return this->resultObject_ != nullptr;};
    void deleteResultObject() { this->resultObject_ = nullptr;};
    inline const CreateForeignPocSampleResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, CreateForeignPocSampleResponseBody::ResultObject) };
    inline CreateForeignPocSampleResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, CreateForeignPocSampleResponseBody::ResultObject) };
    inline CreateForeignPocSampleResponseBody& setResultObject(const CreateForeignPocSampleResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline CreateForeignPocSampleResponseBody& setResultObject(CreateForeignPocSampleResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    shared_ptr<CreateForeignPocSampleResponseBody::ResultObject> resultObject_ {};
  };
