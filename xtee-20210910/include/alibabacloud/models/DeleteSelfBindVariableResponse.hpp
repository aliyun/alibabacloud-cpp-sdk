...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSelfBindVariableResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DeleteSelfBindVariableResponseBody) };
    inline DeleteSelfBindVariableResponseBody body() { DARABONBA_PTR_GET(body_, DeleteSelfBindVariableResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DeleteSelfBindVariableResponseBody> body_ = nullptr;
  };
