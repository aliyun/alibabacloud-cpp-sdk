...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSelectItemResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeSelectItemResponseBody) };
    inline DescribeSelectItemResponseBody body() { DARABONBA_PTR_GET(body_, DescribeSelectItemResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeSelectItemResponseBody> body_ = nullptr;
  };
