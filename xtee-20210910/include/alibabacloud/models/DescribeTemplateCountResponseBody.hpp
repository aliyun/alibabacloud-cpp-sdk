...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTemplateCountResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeTemplateCountResponseBodyResultObject) };
    inline DescribeTemplateCountResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeTemplateCountResponseBodyResultObject) };
    inline DescribeTemplateCountResponseBody& setResultObject(const DescribeTemplateCountResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeTemplateCountResponseBody& setResultObject(DescribeTemplateCountResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<DescribeTemplateCountResponseBodyResultObject> resultObject_ = nullptr;
  };
