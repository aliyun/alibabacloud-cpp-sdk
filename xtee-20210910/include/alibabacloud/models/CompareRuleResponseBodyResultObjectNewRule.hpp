...
#ifndef ALIBABACLOUD_MODELS_COMPARERULERESPONSEBODYRESULTOBJECTNEWRULE_HPP_
#define ALIBABACLOUD_MODELS_COMPARERULERESPONSEBODYRESULTOBJECTNEWRULE_HPP_
...
namespace Models
{
  class CompareRuleResponseBodyResultObjectNewRule : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const CompareRuleResponseBodyResultObjectNewRule& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CompareRuleResponseBodyResultObjectNewRule& obj) { 
    ...
    CompareRuleResponseBodyResultObjectNewRule() = default ;
    CompareRuleResponseBodyResultObjectNewRule(const CompareRuleResponseBodyResultObjectNewRule &) = default ;
    CompareRuleResponseBodyResultObjectNewRule(CompareRuleResponseBodyResultObjectNewRule &&) = default ;
    CompareRuleResponseBodyResultObjectNewRule(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CompareRuleResponseBodyResultObjectNewRule() = default ;
    CompareRuleResponseBodyResultObjectNewRule& operator=(const CompareRuleResponseBodyResultObjectNewRule &) = default ;
    CompareRuleResponseBodyResultObjectNewRule& operator=(CompareRuleResponseBodyResultObjectNewRule &&) = default ;
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setAuditId(int64_t auditId) { DARABONBA_PTR_SET_VALUE(auditId_, auditId) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setAuthType(string authType) { DARABONBA_PTR_SET_VALUE(authType_, authType) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setConsoleRuleId(int64_t consoleRuleId) { DARABONBA_PTR_SET_VALUE(consoleRuleId_, consoleRuleId) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setCreateType(string createType) { DARABONBA_PTR_SET_VALUE(createType_, createType) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setEventCode(string eventCode) { DARABONBA_PTR_SET_VALUE(eventCode_, eventCode) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setEventName(string eventName) { DARABONBA_PTR_SET_VALUE(eventName_, eventName) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setGmtCreate(int64_t gmtCreate) { DARABONBA_PTR_SET_VALUE(gmtCreate_, gmtCreate) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setGmtModified(int64_t gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setLogicExpression(string logicExpression) { DARABONBA_PTR_SET_VALUE(logicExpression_, logicExpression) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setMainEventCode(string mainEventCode) { DARABONBA_PTR_SET_VALUE(mainEventCode_, mainEventCode) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setMemo(string memo) { DARABONBA_PTR_SET_VALUE(memo_, memo) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setRuleActionMap(const Darabonba::Json & ruleActionMap) { DARABONBA_SET_VALUE(ruleActionMap_, ruleActionMap) };
    inline CompareRuleResponseBodyResultObjectNewRule& setRuleActionMap(Darabonba::Json & ruleActionMap) { DARABONBA_SET_RVALUE(ruleActionMap_, ruleActionMap) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setRuleActions(string ruleActions) { DARABONBA_PTR_SET_VALUE(ruleActions_, ruleActions) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setRuleAuthType(string ruleAuthType) { DARABONBA_PTR_SET_VALUE(ruleAuthType_, ruleAuthType) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setRuleBody(string ruleBody) { DARABONBA_PTR_SET_VALUE(ruleBody_, ruleBody) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setRuleExpressions(string ruleExpressions) { DARABONBA_PTR_SET_VALUE(ruleExpressions_, ruleExpressions) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setRuleId(string ruleId) { DARABONBA_PTR_SET_VALUE(ruleId_, ruleId) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setRuleName(string ruleName) { DARABONBA_PTR_SET_VALUE(ruleName_, ruleName) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setRuleStatus(string ruleStatus) { DARABONBA_PTR_SET_VALUE(ruleStatus_, ruleStatus) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setRuleType(string ruleType) { DARABONBA_PTR_SET_VALUE(ruleType_, ruleType) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setRuleVersionId(int64_t ruleVersionId) { DARABONBA_PTR_SET_VALUE(ruleVersionId_, ruleVersionId) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setUserId(int64_t userId) { DARABONBA_PTR_SET_VALUE(userId_, userId) };
    ...
    inline CompareRuleResponseBodyResultObjectNewRule& setVersion(int64_t version) { DARABONBA_PTR_SET_VALUE(version_, version) };
