...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeListPocResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeListPocResponseBody) };
    inline DescribeListPocResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeListPocResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeListPocResponseBody> body_ {};
  };
