...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVARIABLELISTRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVARIABLELISTRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVariableListResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeVariableListResponseBody& obj) { 
    ...
    DescribeVariableListResponseBody() = default ;
    DescribeVariableListResponseBody(const DescribeVariableListResponseBody &) = default ;
    DescribeVariableListResponseBody(DescribeVariableListResponseBody &&) = default ;
    DescribeVariableListResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVariableListResponseBody() = default ;
    DescribeVariableListResponseBody& operator=(const DescribeVariableListResponseBody &) = default ;
    DescribeVariableListResponseBody& operator=(DescribeVariableListResponseBody &&) = default ;
    ...
    public:
      ...
      inline ResultObject& setDefineId(string defineId) { DARABONBA_PTR_SET_VALUE(defineId_, defineId) };
      ...
      inline ResultObject& setExtendInfo(const Darabonba::Json & extendInfo) { DARABONBA_SET_VALUE(extendInfo_, extendInfo) };
      inline ResultObject& setExtendInfo(Darabonba::Json && extendInfo) { DARABONBA_SET_RVALUE(extendInfo_, extendInfo) };
      ...
      inline string getOutputsType() const { DARABONBA_PTR_GET_DEFAULT(outputsType_, "") };
      inline ResultObject& setOutputsType(string outputsType) { DARABONBA_PTR_SET_VALUE(outputsType_, outputsType) };
      ...
      inline string getRefObjName() const { DARABONBA_PTR_GET_DEFAULT(refObjName_, "") };
      inline ResultObject& setRefObjName(string refObjName) { DARABONBA_PTR_SET_VALUE(refObjName_, refObjName) };
    ...
    inline DescribeVariableListResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
    ...
    inline DescribeVariableListResponseBody& setCurrentPage(int32_t currentPage) { DARABONBA_PTR_SET_VALUE(currentPage_, currentPage) };
    ...
    inline DescribeVariableListResponseBody& setPageSize(int32_t pageSize) { DARABONBA_PTR_SET_VALUE(pageSize_, pageSize) };


    // resultObject Field Functions 
    bool hasResultObject() const { return this->resultObject_ != nullptr;};
    void deleteResultObject() { this->resultObject_ = nullptr;};
    inline const vector<DescribeVariableListResponseBody::ResultObject> & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeVariableListResponseBody::ResultObject>) };
    inline vector<DescribeVariableListResponseBody::ResultObject> getResultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeVariableListResponseBody::ResultObject>) };
    inline DescribeVariableListResponseBody& setResultObject(const vector<DescribeVariableListResponseBody::ResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeVariableListResponseBody& setResultObject(vector<DescribeVariableListResponseBody::ResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
    ...
    inline DescribeVariableListResponseBody& setTotalItem(int32_t totalItem) { DARABONBA_PTR_SET_VALUE(totalItem_, totalItem) };
    ...
    inline DescribeVariableListResponseBody& setTotalPage(int32_t totalPage) { DARABONBA_PTR_SET_VALUE(totalPage_, totalPage) };
