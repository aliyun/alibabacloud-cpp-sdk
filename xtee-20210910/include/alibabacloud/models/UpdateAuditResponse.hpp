...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateAuditResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, UpdateAuditResponseBody) };
    inline UpdateAuditResponseBody body() { DARABONBA_PTR_GET(body_, UpdateAuditResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateAuditResponseBody> body_ = nullptr;
  };
