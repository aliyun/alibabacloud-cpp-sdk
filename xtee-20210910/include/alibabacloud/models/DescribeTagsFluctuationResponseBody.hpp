...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeTagsFluctuationResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeTagsFluctuationResponseBodyResultObject>) };
    inline vector<DescribeTagsFluctuationResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeTagsFluctuationResponseBodyResultObject>) };
    inline DescribeTagsFluctuationResponseBody& setResultObject(const vector<DescribeTagsFluctuationResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeTagsFluctuationResponseBody& setResultObject(vector<DescribeTagsFluctuationResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeTagsFluctuationResponseBodyResultObject>> resultObject_ = nullptr;
