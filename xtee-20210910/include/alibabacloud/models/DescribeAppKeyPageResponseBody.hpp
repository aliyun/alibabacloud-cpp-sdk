...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAppKeyPageResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeAppKeyPageResponseBodyResultObject>) };
    inline vector<DescribeAppKeyPageResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeAppKeyPageResponseBodyResultObject>) };
    inline DescribeAppKeyPageResponseBody& setResultObject(const vector<DescribeAppKeyPageResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeAppKeyPageResponseBody& setResultObject(vector<DescribeAppKeyPageResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object.
    std::shared_ptr<vector<DescribeAppKeyPageResponseBodyResultObject>> resultObject_ = nullptr;
