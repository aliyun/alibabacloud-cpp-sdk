...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventLogPageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeEventLogPageResponseBody) };
    inline DescribeEventLogPageResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeEventLogPageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeEventLogPageResponseBody> body_ {};
  };
