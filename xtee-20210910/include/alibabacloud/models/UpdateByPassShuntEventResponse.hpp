...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateByPassShuntEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateByPassShuntEventResponseBody) };
    inline UpdateByPassShuntEventResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateByPassShuntEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateByPassShuntEventResponseBody> body_ {};
  };
