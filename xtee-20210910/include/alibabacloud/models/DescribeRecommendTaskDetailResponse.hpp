...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRecommendTaskDetailResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRecommendTaskDetailResponseBody) };
    inline DescribeRecommendTaskDetailResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRecommendTaskDetailResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRecommendTaskDetailResponseBody> body_ {};
  };
