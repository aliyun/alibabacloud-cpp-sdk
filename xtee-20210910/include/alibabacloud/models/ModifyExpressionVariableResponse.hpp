...
namespace Models
{
  ...
  public:
    ...
    inline const ModifyExpressionVariableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ModifyExpressionVariableResponseBody) };
    inline ModifyExpressionVariableResponseBody getBody() { DARABONBA_PTR_GET(body_, ModifyExpressionVariableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ModifyExpressionVariableResponseBody> body_ {};
  };
