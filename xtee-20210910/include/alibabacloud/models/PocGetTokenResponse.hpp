...
namespace Models
{
  ...
  public:
    ...
    inline const PocGetTokenResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PocGetTokenResponseBody) };
    inline PocGetTokenResponseBody getBody() { DARABONBA_PTR_GET(body_, PocGetTokenResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PocGetTokenResponseBody> body_ {};
  };
