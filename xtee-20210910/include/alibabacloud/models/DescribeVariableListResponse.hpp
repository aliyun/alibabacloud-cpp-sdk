...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVariableListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVariableListResponseBody) };
    inline DescribeVariableListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVariableListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVariableListResponseBody> body_ {};
  };
