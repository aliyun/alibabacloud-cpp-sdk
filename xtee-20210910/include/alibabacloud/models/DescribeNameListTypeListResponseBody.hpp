...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeNameListTypeListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeNameListTypeListResponseBodyResultObject>) };
    inline vector<DescribeNameListTypeListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeNameListTypeListResponseBodyResultObject>) };
    inline DescribeNameListTypeListResponseBody& setResultObject(const vector<DescribeNameListTypeListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeNameListTypeListResponseBody& setResultObject(vector<DescribeNameListTypeListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeNameListTypeListResponseBodyResultObject>> resultObject_ = nullptr;
  };
