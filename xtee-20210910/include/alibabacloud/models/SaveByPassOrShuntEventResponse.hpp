...
namespace Models
{
  ...
  public:
    ...
    inline const SaveByPassOrShuntEventResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, SaveByPassOrShuntEventResponseBody) };
    inline SaveByPassOrShuntEventResponseBody getBody() { DARABONBA_PTR_GET(body_, SaveByPassOrShuntEventResponseBody) };
  ...
  protected:
    ...
    shared_ptr<SaveByPassOrShuntEventResponseBody> body_ {};
  };
