...
namespace Models
{
  ...
  public:
    ...
    inline const CreateRecommendTaskResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateRecommendTaskResponseBody) };
    inline CreateRecommendTaskResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateRecommendTaskResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateRecommendTaskResponseBody> body_ {};
  };
