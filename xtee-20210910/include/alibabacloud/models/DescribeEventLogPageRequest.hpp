...
namespace Models
{
  ...
  public:
    ...
    inline string getAccountIdPRP() const { DARABONBA_PTR_GET_DEFAULT(accountIdPRP_, "") };
    ...
    inline string getCondition1AL() const { DARABONBA_PTR_GET_DEFAULT(condition1AL_, "") };
    ...
    inline string getCondition2AL() const { DARABONBA_PTR_GET_DEFAULT(condition2AL_, "") };
    ...
    inline string getCondition3AL() const { DARABONBA_PTR_GET_DEFAULT(condition3AL_, "") };
    ...
    inline string getDeviceTypeLRP() const { DARABONBA_PTR_GET_DEFAULT(deviceTypeLRP_, "") };
    ...
    inline string getEmailPRP() const { DARABONBA_PTR_GET_DEFAULT(emailPRP_, "") };
    ...
    inline string getFailReasonLRP() const { DARABONBA_PTR_GET_DEFAULT(failReasonLRP_, "") };
    ...
    inline string getIpPRP() const { DARABONBA_PTR_GET_DEFAULT(ipPRP_, "") };
    ...
    inline string getLoginResultARP() const { DARABONBA_PTR_GET_DEFAULT(loginResultARP_, "") };
    ...
    inline string getLoginTypeLRP() const { DARABONBA_PTR_GET_DEFAULT(loginTypeLRP_, "") };
    ...
    inline string getMacPRP() const { DARABONBA_PTR_GET_DEFAULT(macPRP_, "") };
    ...
    inline string getMobilePRP() const { DARABONBA_PTR_GET_DEFAULT(mobilePRP_, "") };
    ...
    inline string getNickNamePRP() const { DARABONBA_PTR_GET_DEFAULT(nickNamePRP_, "") };
    ...
    inline string getOperateSourceLRP() const { DARABONBA_PTR_GET_DEFAULT(operateSourceLRP_, "") };
    ...
    inline string getReferPRP() const { DARABONBA_PTR_GET_DEFAULT(referPRP_, "") };
    ...
    inline string getRegisterIpPRP() const { DARABONBA_PTR_GET_DEFAULT(registerIpPRP_, "") };
    ...
    inline string getReqIdPBS() const { DARABONBA_PTR_GET_DEFAULT(reqIdPBS_, "") };
    ...
    inline int32_t getScoreEBS() const { DARABONBA_PTR_GET_DEFAULT(scoreEBS_, 0) };
    ...
    inline int32_t getScoreSBS() const { DARABONBA_PTR_GET_DEFAULT(scoreSBS_, 0) };
    ...
    inline string getServiceABS() const { DARABONBA_PTR_GET_DEFAULT(serviceABS_, "") };
    ...
    inline string getTagsLBS() const { DARABONBA_PTR_GET_DEFAULT(tagsLBS_, "") };
    ...
    inline string getUmidPDI() const { DARABONBA_PTR_GET_DEFAULT(umidPDI_, "") };
    ...
    inline string getUserAgentPRP() const { DARABONBA_PTR_GET_DEFAULT(userAgentPRP_, "") };
    ...
    inline string getUserNameTypeLRP() const { DARABONBA_PTR_GET_DEFAULT(userNameTypeLRP_, "") };
