...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSafConsoleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSafConsoleResponseBody) };
    inline DescribeSafConsoleResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSafConsoleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSafConsoleResponseBody> body_ {};
  };
