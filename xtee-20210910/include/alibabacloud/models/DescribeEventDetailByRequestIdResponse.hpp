...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventDetailByRequestIdResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeEventDetailByRequestIdResponseBody) };
    inline DescribeEventDetailByRequestIdResponseBody body() { DARABONBA_PTR_GET(body_, DescribeEventDetailByRequestIdResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEventDetailByRequestIdResponseBody> body_ = nullptr;
  };
