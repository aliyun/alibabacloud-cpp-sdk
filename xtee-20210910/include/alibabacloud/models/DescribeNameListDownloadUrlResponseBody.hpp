...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNameListDownloadUrlResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeNameListDownloadUrlResponseBodyResultObject) };
    inline DescribeNameListDownloadUrlResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeNameListDownloadUrlResponseBodyResultObject) };
    inline DescribeNameListDownloadUrlResponseBody& setResultObject(const DescribeNameListDownloadUrlResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeNameListDownloadUrlResponseBody& setResultObject(DescribeNameListDownloadUrlResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<DescribeNameListDownloadUrlResponseBodyResultObject> resultObject_ = nullptr;
  };
