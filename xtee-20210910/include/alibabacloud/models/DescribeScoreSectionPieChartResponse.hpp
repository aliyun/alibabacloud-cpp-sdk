...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScoreSectionPieChartResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeScoreSectionPieChartResponseBody) };
    inline DescribeScoreSectionPieChartResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeScoreSectionPieChartResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeScoreSectionPieChartResponseBody> body_ {};
  };
