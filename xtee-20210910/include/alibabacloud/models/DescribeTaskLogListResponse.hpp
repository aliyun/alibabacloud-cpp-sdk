...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTaskLogListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTaskLogListResponseBody) };
    inline DescribeTaskLogListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTaskLogListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTaskLogListResponseBody> body_ {};
  };
