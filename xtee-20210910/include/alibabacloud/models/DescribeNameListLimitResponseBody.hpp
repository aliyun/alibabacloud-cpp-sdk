...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNameListLimitResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeNameListLimitResponseBodyResultObject) };
    inline DescribeNameListLimitResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeNameListLimitResponseBodyResultObject) };
    inline DescribeNameListLimitResponseBody& setResultObject(const DescribeNameListLimitResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeNameListLimitResponseBody& setResultObject(DescribeNameListLimitResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<DescribeNameListLimitResponseBodyResultObject> resultObject_ = nullptr;
  };
