...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSceneRulePageListResponseBody::ResultObject> & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeSceneRulePageListResponseBody::ResultObject>) };
    inline vector<DescribeSceneRulePageListResponseBody::ResultObject> getResultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeSceneRulePageListResponseBody::ResultObject>) };
    inline DescribeSceneRulePageListResponseBody& setResultObject(const vector<DescribeSceneRulePageListResponseBody::ResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSceneRulePageListResponseBody& setResultObject(vector<DescribeSceneRulePageListResponseBody::ResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
