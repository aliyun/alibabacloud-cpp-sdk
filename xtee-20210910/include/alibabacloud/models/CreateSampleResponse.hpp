...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSampleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSampleResponseBody) };
    inline CreateSampleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSampleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSampleResponseBody> body_ {};
  };
