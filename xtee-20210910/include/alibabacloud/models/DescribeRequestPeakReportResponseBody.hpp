...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeRequestPeakReportResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeRequestPeakReportResponseBodyResultObject>) };
    inline vector<DescribeRequestPeakReportResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeRequestPeakReportResponseBodyResultObject>) };
    inline DescribeRequestPeakReportResponseBody& setResultObject(const vector<DescribeRequestPeakReportResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeRequestPeakReportResponseBody& setResultObject(vector<DescribeRequestPeakReportResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeRequestPeakReportResponseBodyResultObject>> resultObject_ = nullptr;
