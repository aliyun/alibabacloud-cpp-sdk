...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeHitRuleFluctuationResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeHitRuleFluctuationResponseBodyResultObject>) };
    inline vector<DescribeHitRuleFluctuationResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeHitRuleFluctuationResponseBodyResultObject>) };
    inline DescribeHitRuleFluctuationResponseBody& setResultObject(const vector<DescribeHitRuleFluctuationResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeHitRuleFluctuationResponseBody& setResultObject(vector<DescribeHitRuleFluctuationResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeHitRuleFluctuationResponseBodyResultObject>> resultObject_ = nullptr;
