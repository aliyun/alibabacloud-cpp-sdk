...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribePocTaskListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribePocTaskListResponseBodyResultObject>) };
    inline vector<DescribePocTaskListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribePocTaskListResponseBodyResultObject>) };
    inline DescribePocTaskListResponseBody& setResultObject(const vector<DescribePocTaskListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribePocTaskListResponseBody& setResultObject(vector<DescribePocTaskListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object.
    std::shared_ptr<vector<DescribePocTaskListResponseBodyResultObject>> resultObject_ = nullptr;
