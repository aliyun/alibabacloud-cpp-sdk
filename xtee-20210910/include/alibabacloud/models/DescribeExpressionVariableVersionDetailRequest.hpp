...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEEXPRESSIONVARIABLEVERSIONDETAILREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEEXPRESSIONVARIABLEVERSIONDETAILREQUEST_HPP_
...
namespace Models
{
  class DescribeExpressionVariableVersionDetailRequest : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeExpressionVariableVersionDetailRequest& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeExpressionVariableVersionDetailRequest& obj) { 
    ...
    DescribeExpressionVariableVersionDetailRequest() = default ;
    DescribeExpressionVariableVersionDetailRequest(const DescribeExpressionVariableVersionDetailRequest &) = default ;
    DescribeExpressionVariableVersionDetailRequest(DescribeExpressionVariableVersionDetailRequest &&) = default ;
    DescribeExpressionVariableVersionDetailRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeExpressionVariableVersionDetailRequest() = default ;
    DescribeExpressionVariableVersionDetailRequest& operator=(const DescribeExpressionVariableVersionDetailRequest &) = default ;
    DescribeExpressionVariableVersionDetailRequest& operator=(DescribeExpressionVariableVersionDetailRequest &&) = default ;
