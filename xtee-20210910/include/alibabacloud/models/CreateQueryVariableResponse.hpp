...
namespace Models
{
  ...
  public:
    ...
    inline const CreateQueryVariableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateQueryVariableResponseBody) };
    inline CreateQueryVariableResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateQueryVariableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateQueryVariableResponseBody> body_ {};
  };
