...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSampleDataPageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSampleDataPageResponseBody) };
    inline DescribeSampleDataPageResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSampleDataPageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSampleDataPageResponseBody> body_ {};
  };
