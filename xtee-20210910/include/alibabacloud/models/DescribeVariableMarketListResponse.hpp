...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVariableMarketListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeVariableMarketListResponseBody) };
    inline DescribeVariableMarketListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeVariableMarketListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeVariableMarketListResponseBody> body_ = nullptr;
  };
