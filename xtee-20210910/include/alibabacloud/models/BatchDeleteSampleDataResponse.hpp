...
namespace Models
{
  ...
  public:
    ...
    inline const BatchDeleteSampleDataResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, BatchDeleteSampleDataResponseBody) };
    inline BatchDeleteSampleDataResponseBody getBody() { DARABONBA_PTR_GET(body_, BatchDeleteSampleDataResponseBody) };
  ...
  protected:
    ...
    shared_ptr<BatchDeleteSampleDataResponseBody> body_ {};
  };
