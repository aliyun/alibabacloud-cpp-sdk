...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeNameListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeNameListResponseBodyResultObject>) };
    inline vector<DescribeNameListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeNameListResponseBodyResultObject>) };
    inline DescribeNameListResponseBody& setResultObject(const vector<DescribeNameListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeNameListResponseBody& setResultObject(vector<DescribeNameListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object.
    std::shared_ptr<vector<DescribeNameListResponseBodyResultObject>> resultObject_ = nullptr;
