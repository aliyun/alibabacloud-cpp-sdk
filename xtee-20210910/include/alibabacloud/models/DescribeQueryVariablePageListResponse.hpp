...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeQueryVariablePageListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeQueryVariablePageListResponseBody) };
    inline DescribeQueryVariablePageListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeQueryVariablePageListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeQueryVariablePageListResponseBody> body_ {};
  };
