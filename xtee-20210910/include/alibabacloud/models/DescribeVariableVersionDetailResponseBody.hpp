...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEVARIABLEVERSIONDETAILRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEVARIABLEVERSIONDETAILRESPONSEBODY_HPP_
...
namespace Models
{
  class DescribeVariableVersionDetailResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const DescribeVariableVersionDetailResponseBody& obj) { 
      DARABONBA_PTR_TO_JSON(RequestId, requestId_);
      DARABONBA_PTR_TO_JSON(resultObject, resultObject_);
    };
    friend void from_json(const Darabonba::Json& j, DescribeVariableVersionDetailResponseBody& obj) { 
      DARABONBA_PTR_FROM_JSON(RequestId, requestId_);
      DARABONBA_PTR_FROM_JSON(resultObject, resultObject_);
    };
    DescribeVariableVersionDetailResponseBody() = default ;
    DescribeVariableVersionDetailResponseBody(const DescribeVariableVersionDetailResponseBody &) = default ;
    DescribeVariableVersionDetailResponseBody(DescribeVariableVersionDetailResponseBody &&) = default ;
    DescribeVariableVersionDetailResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeVariableVersionDetailResponseBody() = default ;
    DescribeVariableVersionDetailResponseBody& operator=(const DescribeVariableVersionDetailResponseBody &) = default ;
    DescribeVariableVersionDetailResponseBody& operator=(DescribeVariableVersionDetailResponseBody &&) = default ;
    ...
    public:
      ...
      virtual bool empty() const override { return this->condition_ == nullptr
        && this->dataVersion_ == nullptr && this->description_ == nullptr && this->eventCodes_ == nullptr && this->global_ == nullptr && this->historyValueType_ == nullptr
        && this->id_ == nullptr && this->object_ == nullptr && this->status_ == nullptr && this->subject_ == nullptr && this->timeType_ == nullptr
        && this->title_ == nullptr && this->topN_ == nullptr && this->twCount_ == nullptr && this->velocityFC_ == nullptr && this->velocityTW_ == nullptr; };
      ...
      inline bool getGlobal() const { DARABONBA_PTR_GET_DEFAULT(global_, false) };
      inline ResultObject& setGlobal(bool global) { DARABONBA_PTR_SET_VALUE(global_, global) };
      ...
      inline ResultObject& setTopN(int64_t topN) { DARABONBA_PTR_SET_VALUE(topN_, topN) };


      // twCount Field Functions 
      bool hasTwCount() const { return this->twCount_ != nullptr;};
      void deleteTwCount() { this->twCount_ = nullptr;};
      inline int64_t getTwCount() const { DARABONBA_PTR_GET_DEFAULT(twCount_, 0L) };
      inline ResultObject& setTwCount(int64_t twCount) { DARABONBA_PTR_SET_VALUE(twCount_, twCount) };
    ...
    inline DescribeVariableVersionDetailResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // resultObject Field Functions 
    bool hasResultObject() const { return this->resultObject_ != nullptr;};
    void deleteResultObject() { this->resultObject_ = nullptr;};
    inline const DescribeVariableVersionDetailResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeVariableVersionDetailResponseBody::ResultObject) };
    inline DescribeVariableVersionDetailResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, DescribeVariableVersionDetailResponseBody::ResultObject) };
    inline DescribeVariableVersionDetailResponseBody& setResultObject(const DescribeVariableVersionDetailResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeVariableVersionDetailResponseBody& setResultObject(DescribeVariableVersionDetailResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object.
    shared_ptr<DescribeVariableVersionDetailResponseBody::ResultObject> resultObject_ {};
  };
