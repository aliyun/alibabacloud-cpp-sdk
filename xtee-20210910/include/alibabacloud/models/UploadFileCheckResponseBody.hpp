...
namespace Models
{
  ...
  public:
    ...
    inline const UploadFileCheckResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, UploadFileCheckResponseBodyResultObject) };
    inline UploadFileCheckResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, UploadFileCheckResponseBodyResultObject) };
    inline UploadFileCheckResponseBody& setResultObject(const UploadFileCheckResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline UploadFileCheckResponseBody& setResultObject(UploadFileCheckResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<UploadFileCheckResponseBodyResultObject> resultObject_ = nullptr;
  };
