...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSceneEventPageListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSceneEventPageListResponseBody) };
    inline DescribeSceneEventPageListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSceneEventPageListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSceneEventPageListResponseBody> body_ {};
  };
