...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRuleHitResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeRuleHitResponseBody) };
    inline DescribeRuleHitResponseBody body() { DARABONBA_PTR_GET(body_, DescribeRuleHitResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRuleHitResponseBody> body_ = nullptr;
  };
