...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeDecisionResultFluctuationResponseBody::ResultObject> & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeDecisionResultFluctuationResponseBody::ResultObject>) };
    inline vector<DescribeDecisionResultFluctuationResponseBody::ResultObject> getResultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeDecisionResultFluctuationResponseBody::ResultObject>) };
    inline DescribeDecisionResultFluctuationResponseBody& setResultObject(const vector<DescribeDecisionResultFluctuationResponseBody::ResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeDecisionResultFluctuationResponseBody& setResultObject(vector<DescribeDecisionResultFluctuationResponseBody::ResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
