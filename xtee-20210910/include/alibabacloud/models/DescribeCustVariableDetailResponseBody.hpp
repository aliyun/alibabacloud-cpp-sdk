...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeCustVariableDetailResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeCustVariableDetailResponseBodyResultObject>) };
    inline vector<DescribeCustVariableDetailResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeCustVariableDetailResponseBodyResultObject>) };
    inline DescribeCustVariableDetailResponseBody& setResultObject(const vector<DescribeCustVariableDetailResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeCustVariableDetailResponseBody& setResultObject(vector<DescribeCustVariableDetailResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeCustVariableDetailResponseBodyResultObject>> resultObject_ = nullptr;
  };
