...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventResultListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeEventResultListResponseBody) };
    inline DescribeEventResultListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeEventResultListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEventResultListResponseBody> body_ = nullptr;
  };
