...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeMarkPageResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeMarkPageResponseBodyResultObject>) };
    inline vector<DescribeMarkPageResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeMarkPageResponseBodyResultObject>) };
    inline DescribeMarkPageResponseBody& setResultObject(const vector<DescribeMarkPageResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeMarkPageResponseBody& setResultObject(vector<DescribeMarkPageResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object.
    std::shared_ptr<vector<DescribeMarkPageResponseBodyResultObject>> resultObject_ = nullptr;
