...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteSampleBatchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteSampleBatchResponseBody) };
    inline DeleteSampleBatchResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteSampleBatchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteSampleBatchResponseBody> body_ {};
  };
