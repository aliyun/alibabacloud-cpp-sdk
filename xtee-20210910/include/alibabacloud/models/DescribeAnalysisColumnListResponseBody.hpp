...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAnalysisColumnListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeAnalysisColumnListResponseBodyResultObject>) };
    inline vector<DescribeAnalysisColumnListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeAnalysisColumnListResponseBodyResultObject>) };
    inline DescribeAnalysisColumnListResponseBody& setResultObject(const vector<DescribeAnalysisColumnListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeAnalysisColumnListResponseBody& setResultObject(vector<DescribeAnalysisColumnListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeAnalysisColumnListResponseBodyResultObject>> resultObject_ = nullptr;
  };
