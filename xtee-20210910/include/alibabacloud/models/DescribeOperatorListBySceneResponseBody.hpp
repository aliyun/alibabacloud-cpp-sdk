...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeOperatorListBySceneResponseBody::ResultObject> & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeOperatorListBySceneResponseBody::ResultObject>) };
    inline vector<DescribeOperatorListBySceneResponseBody::ResultObject> getResultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeOperatorListBySceneResponseBody::ResultObject>) };
    inline DescribeOperatorListBySceneResponseBody& setResultObject(const vector<DescribeOperatorListBySceneResponseBody::ResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeOperatorListBySceneResponseBody& setResultObject(vector<DescribeOperatorListBySceneResponseBody::ResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
