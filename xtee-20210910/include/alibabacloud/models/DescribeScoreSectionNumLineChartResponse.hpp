...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeScoreSectionNumLineChartResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeScoreSectionNumLineChartResponseBody) };
    inline DescribeScoreSectionNumLineChartResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeScoreSectionNumLineChartResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeScoreSectionNumLineChartResponseBody> body_ {};
  };
