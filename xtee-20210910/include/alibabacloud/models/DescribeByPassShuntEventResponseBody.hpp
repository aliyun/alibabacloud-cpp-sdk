...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeByPassShuntEventResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeByPassShuntEventResponseBodyResultObject) };
    inline DescribeByPassShuntEventResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeByPassShuntEventResponseBodyResultObject) };
    inline DescribeByPassShuntEventResponseBody& setResultObject(const DescribeByPassShuntEventResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeByPassShuntEventResponseBody& setResultObject(DescribeByPassShuntEventResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<DescribeByPassShuntEventResponseBodyResultObject> resultObject_ = nullptr;
