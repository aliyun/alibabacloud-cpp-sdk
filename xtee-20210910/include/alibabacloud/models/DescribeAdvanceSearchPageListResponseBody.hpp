...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAdvanceSearchPageListResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeAdvanceSearchPageListResponseBody::ResultObject) };
    inline DescribeAdvanceSearchPageListResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, DescribeAdvanceSearchPageListResponseBody::ResultObject) };
    inline DescribeAdvanceSearchPageListResponseBody& setResultObject(const DescribeAdvanceSearchPageListResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeAdvanceSearchPageListResponseBody& setResultObject(DescribeAdvanceSearchPageListResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    shared_ptr<DescribeAdvanceSearchPageListResponseBody::ResultObject> resultObject_ {};
  };
