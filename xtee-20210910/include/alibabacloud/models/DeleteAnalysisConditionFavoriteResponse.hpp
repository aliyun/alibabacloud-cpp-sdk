...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteAnalysisConditionFavoriteResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteAnalysisConditionFavoriteResponseBody) };
    inline DeleteAnalysisConditionFavoriteResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteAnalysisConditionFavoriteResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteAnalysisConditionFavoriteResponseBody> body_ {};
  };
