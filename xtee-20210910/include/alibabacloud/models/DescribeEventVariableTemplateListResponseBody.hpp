...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeEventVariableTemplateListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeEventVariableTemplateListResponseBodyResultObject>) };
    inline vector<DescribeEventVariableTemplateListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeEventVariableTemplateListResponseBodyResultObject>) };
    inline DescribeEventVariableTemplateListResponseBody& setResultObject(const vector<DescribeEventVariableTemplateListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeEventVariableTemplateListResponseBody& setResultObject(vector<DescribeEventVariableTemplateListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeEventVariableTemplateListResponseBodyResultObject>> resultObject_ = nullptr;
  };
