...
namespace Models
{
  ...
  public:
    ...
    inline const PocGetDownloadUrlResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PocGetDownloadUrlResponseBody) };
    inline PocGetDownloadUrlResponseBody getBody() { DARABONBA_PTR_GET(body_, PocGetDownloadUrlResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PocGetDownloadUrlResponseBody> body_ {};
  };
