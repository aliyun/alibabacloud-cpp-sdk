...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRuleBarChartResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeRuleBarChartResponseBodyResultObject) };
    inline DescribeRuleBarChartResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeRuleBarChartResponseBodyResultObject) };
    inline DescribeRuleBarChartResponseBody& setResultObject(const DescribeRuleBarChartResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeRuleBarChartResponseBody& setResultObject(DescribeRuleBarChartResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<DescribeRuleBarChartResponseBodyResultObject> resultObject_ = nullptr;
