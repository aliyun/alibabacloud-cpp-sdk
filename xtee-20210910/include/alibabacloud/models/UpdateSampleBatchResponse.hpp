...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateSampleBatchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateSampleBatchResponseBody) };
    inline UpdateSampleBatchResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateSampleBatchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateSampleBatchResponseBody> body_ {};
  };
