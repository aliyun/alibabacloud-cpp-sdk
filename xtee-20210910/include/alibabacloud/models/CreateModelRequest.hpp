...
namespace Models
{
  ...
  public:
    ...
    inline string getCounts() const { DARABONBA_PTR_GET_DEFAULT(counts_, "") };
    ...
    inline string getParameterNum() const { DARABONBA_PTR_GET_DEFAULT(parameterNum_, "") };
  ...
  protected:
    ...
    // 
    // This parameter is required.
    shared_ptr<string> parameterNum_ {};
    // Region code
