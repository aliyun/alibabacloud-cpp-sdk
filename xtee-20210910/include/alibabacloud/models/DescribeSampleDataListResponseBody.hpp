...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSampleDataListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeSampleDataListResponseBodyResultObject>) };
    inline vector<DescribeSampleDataListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeSampleDataListResponseBodyResultObject>) };
    inline DescribeSampleDataListResponseBody& setResultObject(const vector<DescribeSampleDataListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSampleDataListResponseBody& setResultObject(vector<DescribeSampleDataListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeSampleDataListResponseBodyResultObject>> resultObject_ = nullptr;
