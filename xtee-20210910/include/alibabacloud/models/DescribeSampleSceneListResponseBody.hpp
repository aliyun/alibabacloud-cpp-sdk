...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSampleSceneListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeSampleSceneListResponseBodyResultObject>) };
    inline vector<DescribeSampleSceneListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeSampleSceneListResponseBodyResultObject>) };
    inline DescribeSampleSceneListResponseBody& setResultObject(const vector<DescribeSampleSceneListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSampleSceneListResponseBody& setResultObject(vector<DescribeSampleSceneListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object.
    std::shared_ptr<vector<DescribeSampleSceneListResponseBodyResultObject>> resultObject_ = nullptr;
