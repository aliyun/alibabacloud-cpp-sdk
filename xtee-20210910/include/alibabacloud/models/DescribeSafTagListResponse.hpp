...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSafTagListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSafTagListResponseBody) };
    inline DescribeSafTagListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSafTagListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSafTagListResponseBody> body_ {};
  };
