...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventLogDetailResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeEventLogDetailResponseBody) };
    inline DescribeEventLogDetailResponseBody body() { DARABONBA_PTR_GET(body_, DescribeEventLogDetailResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEventLogDetailResponseBody> body_ = nullptr;
  };
