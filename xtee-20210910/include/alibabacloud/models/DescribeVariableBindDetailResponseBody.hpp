...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVariableBindDetailResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeVariableBindDetailResponseBodyResultObject) };
    inline DescribeVariableBindDetailResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeVariableBindDetailResponseBodyResultObject) };
    inline DescribeVariableBindDetailResponseBody& setResultObject(const DescribeVariableBindDetailResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeVariableBindDetailResponseBody& setResultObject(DescribeVariableBindDetailResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<DescribeVariableBindDetailResponseBodyResultObject> resultObject_ = nullptr;
  };
