...
namespace Models
{
  ...
  public:
    ...
    inline const QueryAuthRuleDetailByRuleIdResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, QueryAuthRuleDetailByRuleIdResponseBodyResultObject) };
    inline QueryAuthRuleDetailByRuleIdResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, QueryAuthRuleDetailByRuleIdResponseBodyResultObject) };
    inline QueryAuthRuleDetailByRuleIdResponseBody& setResultObject(const QueryAuthRuleDetailByRuleIdResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline QueryAuthRuleDetailByRuleIdResponseBody& setResultObject(QueryAuthRuleDetailByRuleIdResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<QueryAuthRuleDetailByRuleIdResponseBodyResultObject> resultObject_ = nullptr;
  };
