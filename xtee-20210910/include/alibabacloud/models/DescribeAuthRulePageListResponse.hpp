...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAuthRulePageListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAuthRulePageListResponseBody) };
    inline DescribeAuthRulePageListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAuthRulePageListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAuthRulePageListResponseBody> body_ {};
  };
