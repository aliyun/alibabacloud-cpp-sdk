...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeExpressionVariableFunctionListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeExpressionVariableFunctionListResponseBodyResultObject>) };
    inline vector<DescribeExpressionVariableFunctionListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeExpressionVariableFunctionListResponseBodyResultObject>) };
    inline DescribeExpressionVariableFunctionListResponseBody& setResultObject(const vector<DescribeExpressionVariableFunctionListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeExpressionVariableFunctionListResponseBody& setResultObject(vector<DescribeExpressionVariableFunctionListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeExpressionVariableFunctionListResponseBodyResultObject>> resultObject_ = nullptr;
  };
