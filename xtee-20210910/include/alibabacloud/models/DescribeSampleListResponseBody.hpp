...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSampleListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeSampleListResponseBodyResultObject>) };
    inline vector<DescribeSampleListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeSampleListResponseBodyResultObject>) };
    inline DescribeSampleListResponseBody& setResultObject(const vector<DescribeSampleListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSampleListResponseBody& setResultObject(vector<DescribeSampleListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeSampleListResponseBodyResultObject>> resultObject_ = nullptr;
    // Total count.
