...
namespace Models
{
  ...
  public:
    ...
    inline DescribeAllDataSourceRequest& setLang(string lang) { DARABONBA_PTR_SET_VALUE(lang_, lang) };
    ...
    inline DescribeAllDataSourceRequest& setRegId(string regId) { DARABONBA_PTR_SET_VALUE(regId_, regId) };
