...
namespace Models
{
  ...
  public:
    ...
    inline const CompareRuleResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, CompareRuleResponseBody) };
    inline CompareRuleResponseBody body() { DARABONBA_PTR_GET(body_, CompareRuleResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<CompareRuleResponseBody> body_ = nullptr;
  };
