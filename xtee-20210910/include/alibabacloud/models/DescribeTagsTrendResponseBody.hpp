...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTagsTrendResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeTagsTrendResponseBody::ResultObject) };
    inline DescribeTagsTrendResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, DescribeTagsTrendResponseBody::ResultObject) };
    inline DescribeTagsTrendResponseBody& setResultObject(const DescribeTagsTrendResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeTagsTrendResponseBody& setResultObject(DescribeTagsTrendResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
