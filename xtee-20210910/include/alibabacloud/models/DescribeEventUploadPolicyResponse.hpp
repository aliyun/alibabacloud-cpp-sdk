...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventUploadPolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeEventUploadPolicyResponseBody) };
    inline DescribeEventUploadPolicyResponseBody body() { DARABONBA_PTR_GET(body_, DescribeEventUploadPolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeEventUploadPolicyResponseBody> body_ = nullptr;
  };
