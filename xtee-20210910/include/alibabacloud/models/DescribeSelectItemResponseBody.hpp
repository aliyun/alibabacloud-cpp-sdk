...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSelectItemResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeSelectItemResponseBodyResultObject) };
    inline DescribeSelectItemResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeSelectItemResponseBodyResultObject) };
    inline DescribeSelectItemResponseBody& setResultObject(const DescribeSelectItemResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSelectItemResponseBody& setResultObject(DescribeSelectItemResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<DescribeSelectItemResponseBodyResultObject> resultObject_ = nullptr;
  };
