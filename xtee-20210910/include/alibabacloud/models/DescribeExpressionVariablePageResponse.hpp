...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExpressionVariablePageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExpressionVariablePageResponseBody) };
    inline DescribeExpressionVariablePageResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExpressionVariablePageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExpressionVariablePageResponseBody> body_ {};
  };
