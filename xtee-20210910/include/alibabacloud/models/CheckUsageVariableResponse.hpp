...
namespace Models
{
  ...
  public:
    ...
    inline const CheckUsageVariableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CheckUsageVariableResponseBody) };
    inline CheckUsageVariableResponseBody getBody() { DARABONBA_PTR_GET(body_, CheckUsageVariableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CheckUsageVariableResponseBody> body_ {};
  };
