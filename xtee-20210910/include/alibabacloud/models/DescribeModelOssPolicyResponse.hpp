...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeModelOssPolicyResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeModelOssPolicyResponseBody) };
    inline DescribeModelOssPolicyResponseBody body() { DARABONBA_PTR_GET(body_, DescribeModelOssPolicyResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeModelOssPolicyResponseBody> body_ = nullptr;
  };
