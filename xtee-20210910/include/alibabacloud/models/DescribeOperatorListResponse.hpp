...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeOperatorListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeOperatorListResponseBody) };
    inline DescribeOperatorListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeOperatorListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeOperatorListResponseBody> body_ {};
  };
