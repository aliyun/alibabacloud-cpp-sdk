...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTagsBarChartResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeTagsBarChartResponseBody::ResultObject) };
    inline DescribeTagsBarChartResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, DescribeTagsBarChartResponseBody::ResultObject) };
    inline DescribeTagsBarChartResponseBody& setResultObject(const DescribeTagsBarChartResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeTagsBarChartResponseBody& setResultObject(DescribeTagsBarChartResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
