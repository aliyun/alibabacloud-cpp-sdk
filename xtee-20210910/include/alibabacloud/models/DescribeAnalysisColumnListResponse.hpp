...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAnalysisColumnListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAnalysisColumnListResponseBody) };
    inline DescribeAnalysisColumnListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAnalysisColumnListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAnalysisColumnListResponseBody> body_ {};
  };
