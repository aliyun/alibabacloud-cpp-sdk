...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSampleResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, CreateSampleResponseBodyResultObject) };
    inline CreateSampleResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, CreateSampleResponseBodyResultObject) };
    inline CreateSampleResponseBody& setResultObject(const CreateSampleResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline CreateSampleResponseBody& setResultObject(CreateSampleResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<CreateSampleResponseBodyResultObject> resultObject_ = nullptr;
  };
