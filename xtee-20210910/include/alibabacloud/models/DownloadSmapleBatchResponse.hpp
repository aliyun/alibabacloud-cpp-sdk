...
namespace Models
{
  ...
  public:
    ...
    inline const DownloadSmapleBatchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DownloadSmapleBatchResponseBody) };
    inline DownloadSmapleBatchResponseBody getBody() { DARABONBA_PTR_GET(body_, DownloadSmapleBatchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DownloadSmapleBatchResponseBody> body_ {};
  };
