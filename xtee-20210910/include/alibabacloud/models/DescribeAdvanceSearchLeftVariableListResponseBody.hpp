...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeAdvanceSearchLeftVariableListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeAdvanceSearchLeftVariableListResponseBodyResultObject>) };
    inline vector<DescribeAdvanceSearchLeftVariableListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeAdvanceSearchLeftVariableListResponseBodyResultObject>) };
    inline DescribeAdvanceSearchLeftVariableListResponseBody& setResultObject(const vector<DescribeAdvanceSearchLeftVariableListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeAdvanceSearchLeftVariableListResponseBody& setResultObject(vector<DescribeAdvanceSearchLeftVariableListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeAdvanceSearchLeftVariableListResponseBodyResultObject>> resultObject_ = nullptr;
  };
