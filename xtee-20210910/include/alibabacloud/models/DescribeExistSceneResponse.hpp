...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExistSceneResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeExistSceneResponseBody) };
    inline DescribeExistSceneResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeExistSceneResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeExistSceneResponseBody> body_ {};
  };
