...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        ...
        && this->regId_ == nullptr && this->rulesStr_ == nullptr && this->runTask_ == nullptr && this->startTime_ == nullptr && this->taskName_ == nullptr; };
    ...
    inline bool getRunTask() const { DARABONBA_PTR_GET_DEFAULT(runTask_, false) };
