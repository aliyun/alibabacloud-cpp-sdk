...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->authType_ != nullptr
        ...
        && this->gmtCreate_ != nullptr && this->gmtModified_ != nullptr && this->id_ != nullptr && this->mainRuleId_ != nullptr && this->priority_ != nullptr
        && this->ruleAuthType_ != nullptr && this->ruleId_ != nullptr && this->ruleMemo_ != nullptr && this->ruleName_ != nullptr && this->ruleStatus_ != nullptr
        && this->ruleType_ != nullptr && this->ruleVersionId_ != nullptr && this->templateId_ != nullptr && this->version_ != nullptr; };
