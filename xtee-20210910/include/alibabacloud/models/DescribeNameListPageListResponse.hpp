...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeNameListPageListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeNameListPageListResponseBody) };
    inline DescribeNameListPageListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeNameListPageListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeNameListPageListResponseBody> body_ {};
  };
