...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeExpressionVariablePageResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeExpressionVariablePageResponseBodyResultObject>) };
    inline vector<DescribeExpressionVariablePageResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeExpressionVariablePageResponseBodyResultObject>) };
    inline DescribeExpressionVariablePageResponseBody& setResultObject(const vector<DescribeExpressionVariablePageResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeExpressionVariablePageResponseBody& setResultObject(vector<DescribeExpressionVariablePageResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
