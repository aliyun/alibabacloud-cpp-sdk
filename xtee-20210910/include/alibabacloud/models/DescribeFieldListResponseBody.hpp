...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeFieldListResponseBody::ResultObject> & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeFieldListResponseBody::ResultObject>) };
    inline vector<DescribeFieldListResponseBody::ResultObject> getResultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeFieldListResponseBody::ResultObject>) };
    inline DescribeFieldListResponseBody& setResultObject(const vector<DescribeFieldListResponseBody::ResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeFieldListResponseBody& setResultObject(vector<DescribeFieldListResponseBody::ResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
