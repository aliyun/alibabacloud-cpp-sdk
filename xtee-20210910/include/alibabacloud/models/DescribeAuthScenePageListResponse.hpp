...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAuthScenePageListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeAuthScenePageListResponseBody) };
    inline DescribeAuthScenePageListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeAuthScenePageListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeAuthScenePageListResponseBody> body_ = nullptr;
  };
