...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        && this->currentPage_ == nullptr && this->endDate_ == nullptr && this->exactProductCode_ == nullptr && this->pageSize_ == nullptr && this->regId_ == nullptr
    ...
    inline string getExactProductCode() const { DARABONBA_PTR_GET_DEFAULT(exactProductCode_, "") };
