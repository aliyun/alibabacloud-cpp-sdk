...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeEventResultBarChartResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeEventResultBarChartResponseBodyResultObject) };
    inline DescribeEventResultBarChartResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeEventResultBarChartResponseBodyResultObject) };
    inline DescribeEventResultBarChartResponseBody& setResultObject(const DescribeEventResultBarChartResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeEventResultBarChartResponseBody& setResultObject(DescribeEventResultBarChartResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<DescribeEventResultBarChartResponseBodyResultObject> resultObject_ = nullptr;
