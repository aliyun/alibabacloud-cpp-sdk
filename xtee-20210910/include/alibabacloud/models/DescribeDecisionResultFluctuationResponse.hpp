...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeDecisionResultFluctuationResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeDecisionResultFluctuationResponseBody) };
    inline DescribeDecisionResultFluctuationResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeDecisionResultFluctuationResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeDecisionResultFluctuationResponseBody> body_ {};
  };
