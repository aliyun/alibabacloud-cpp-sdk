...
namespace Models
{
  ...
  public:
    ...
    inline const PermissionCheckResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, PermissionCheckResponseBody) };
    inline PermissionCheckResponseBody getBody() { DARABONBA_PTR_GET(body_, PermissionCheckResponseBody) };
  ...
  protected:
    ...
    shared_ptr<PermissionCheckResponseBody> body_ {};
  };
