...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRecommendTaskPageListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeRecommendTaskPageListResponseBody) };
    inline DescribeRecommendTaskPageListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeRecommendTaskPageListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeRecommendTaskPageListResponseBody> body_ {};
  };
