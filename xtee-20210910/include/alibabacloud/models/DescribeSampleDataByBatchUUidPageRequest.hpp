...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->lang_ == nullptr
        && this->batchUuid_ == nullptr && this->currentPage_ == nullptr && this->dataValue_ == nullptr && this->pageSize_ == nullptr && this->regId_ == nullptr
        && this->updateBeginTime_ == nullptr && this->updateEndTime_ == nullptr; };
    ...
    inline int64_t getUpdateBeginTime() const { DARABONBA_PTR_GET_DEFAULT(updateBeginTime_, 0L) };
