...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTagsTrendResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTagsTrendResponseBody) };
    inline DescribeTagsTrendResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTagsTrendResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTagsTrendResponseBody> body_ {};
  };
