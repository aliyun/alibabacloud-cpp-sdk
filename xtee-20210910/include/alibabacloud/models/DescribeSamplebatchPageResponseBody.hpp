...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSamplebatchPageResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeSamplebatchPageResponseBodyResultObject>) };
    inline vector<DescribeSamplebatchPageResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeSamplebatchPageResponseBodyResultObject>) };
    inline DescribeSamplebatchPageResponseBody& setResultObject(const vector<DescribeSamplebatchPageResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSamplebatchPageResponseBody& setResultObject(vector<DescribeSamplebatchPageResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeSamplebatchPageResponseBodyResultObject>> resultObject_ = nullptr;
