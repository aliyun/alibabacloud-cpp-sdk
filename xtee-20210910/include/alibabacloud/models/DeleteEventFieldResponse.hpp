...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteEventFieldResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteEventFieldResponseBody) };
    inline DeleteEventFieldResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteEventFieldResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteEventFieldResponseBody> body_ {};
  };
