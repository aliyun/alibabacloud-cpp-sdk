...
#ifndef ALIBABACLOUD_MODELS_UPLOADSAMPLEFILERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_UPLOADSAMPLEFILERESPONSEBODY_HPP_
...
namespace Models
{
  class UploadSampleFileResponseBody : public Darabonba::Model {
  public:
    friend void to_json(Darabonba::Json& j, const UploadSampleFileResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, UploadSampleFileResponseBody& obj) { 
    ...
    UploadSampleFileResponseBody() = default ;
    UploadSampleFileResponseBody(const UploadSampleFileResponseBody &) = default ;
    UploadSampleFileResponseBody(UploadSampleFileResponseBody &&) = default ;
    UploadSampleFileResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~UploadSampleFileResponseBody() = default ;
    UploadSampleFileResponseBody& operator=(const UploadSampleFileResponseBody &) = default ;
    UploadSampleFileResponseBody& operator=(UploadSampleFileResponseBody &&) = default ;
    ...
    inline UploadSampleFileResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline UploadSampleFileResponseBody& setHttpStatusCode(string httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline UploadSampleFileResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline UploadSampleFileResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // resultObject Field Functions 
    bool hasResultObject() const { return this->resultObject_ != nullptr;};
    void deleteResultObject() { this->resultObject_ = nullptr;};
    inline const UploadSampleFileResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, UploadSampleFileResponseBody::ResultObject) };
    inline UploadSampleFileResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, UploadSampleFileResponseBody::ResultObject) };
    inline UploadSampleFileResponseBody& setResultObject(const UploadSampleFileResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline UploadSampleFileResponseBody& setResultObject(UploadSampleFileResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
