...
namespace Models
{
  ...
  public:
    ...
    inline const CreateSampleBatchResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateSampleBatchResponseBody) };
    inline CreateSampleBatchResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateSampleBatchResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateSampleBatchResponseBody> body_ {};
  };
