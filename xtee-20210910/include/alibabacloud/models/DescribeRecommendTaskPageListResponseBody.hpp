...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeRecommendTaskPageListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeRecommendTaskPageListResponseBodyResultObject>) };
    inline vector<DescribeRecommendTaskPageListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeRecommendTaskPageListResponseBodyResultObject>) };
    inline DescribeRecommendTaskPageListResponseBody& setResultObject(const vector<DescribeRecommendTaskPageListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeRecommendTaskPageListResponseBody& setResultObject(vector<DescribeRecommendTaskPageListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeRecommendTaskPageListResponseBodyResultObject>> resultObject_ = nullptr;
