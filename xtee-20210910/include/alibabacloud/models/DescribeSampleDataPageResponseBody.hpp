...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSampleDataPageResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeSampleDataPageResponseBodyResultObject>) };
    inline vector<DescribeSampleDataPageResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeSampleDataPageResponseBodyResultObject>) };
    inline DescribeSampleDataPageResponseBody& setResultObject(const vector<DescribeSampleDataPageResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSampleDataPageResponseBody& setResultObject(vector<DescribeSampleDataPageResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeSampleDataPageResponseBodyResultObject>> resultObject_ = nullptr;
