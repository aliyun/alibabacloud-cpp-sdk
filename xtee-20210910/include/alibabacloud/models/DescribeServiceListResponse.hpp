...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeServiceListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeServiceListResponseBody) };
    inline DescribeServiceListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeServiceListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeServiceListResponseBody> body_ {};
  };
