...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeGroupConditionListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeGroupConditionListResponseBodyResultObject>) };
    inline vector<DescribeGroupConditionListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeGroupConditionListResponseBodyResultObject>) };
    inline DescribeGroupConditionListResponseBody& setResultObject(const vector<DescribeGroupConditionListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeGroupConditionListResponseBody& setResultObject(vector<DescribeGroupConditionListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeGroupConditionListResponseBodyResultObject>> resultObject_ = nullptr;
  };
