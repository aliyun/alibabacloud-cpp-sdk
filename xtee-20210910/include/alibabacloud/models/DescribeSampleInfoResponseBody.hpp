...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSampleInfoResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeSampleInfoResponseBodyResultObject) };
    inline DescribeSampleInfoResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeSampleInfoResponseBodyResultObject) };
    inline DescribeSampleInfoResponseBody& setResultObject(const DescribeSampleInfoResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSampleInfoResponseBody& setResultObject(DescribeSampleInfoResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<DescribeSampleInfoResponseBodyResultObject> resultObject_ = nullptr;
  };
