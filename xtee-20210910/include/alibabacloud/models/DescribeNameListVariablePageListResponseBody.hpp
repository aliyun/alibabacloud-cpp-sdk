...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeNameListVariablePageListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeNameListVariablePageListResponseBodyResultObject>) };
    inline vector<DescribeNameListVariablePageListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeNameListVariablePageListResponseBodyResultObject>) };
    inline DescribeNameListVariablePageListResponseBody& setResultObject(const vector<DescribeNameListVariablePageListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeNameListVariablePageListResponseBody& setResultObject(vector<DescribeNameListVariablePageListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeNameListVariablePageListResponseBodyResultObject>> resultObject_ = nullptr;
