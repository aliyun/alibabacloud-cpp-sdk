...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEDECISIONRESULTTRENDRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEDECISIONRESULTTRENDRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeDecisionResultTrendResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeDecisionResultTrendResponseBody& obj) { 
    ...
    DescribeDecisionResultTrendResponseBody() = default ;
    DescribeDecisionResultTrendResponseBody(const DescribeDecisionResultTrendResponseBody &) = default ;
    DescribeDecisionResultTrendResponseBody(DescribeDecisionResultTrendResponseBody &&) = default ;
    DescribeDecisionResultTrendResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeDecisionResultTrendResponseBody() = default ;
    DescribeDecisionResultTrendResponseBody& operator=(const DescribeDecisionResultTrendResponseBody &) = default ;
    DescribeDecisionResultTrendResponseBody& operator=(DescribeDecisionResultTrendResponseBody &&) = default ;
    ...
    inline DescribeDecisionResultTrendResponseBody& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DescribeDecisionResultTrendResponseBody& setHttpStatusCode(string httpStatusCode) { DARABONBA_PTR_SET_VALUE(httpStatusCode_, httpStatusCode) };
    ...
    inline DescribeDecisionResultTrendResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline DescribeDecisionResultTrendResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };


    // resultObject Field Functions 
    bool hasResultObject() const { return this->resultObject_ != nullptr;};
    void deleteResultObject() { this->resultObject_ = nullptr;};
    inline const DescribeDecisionResultTrendResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeDecisionResultTrendResponseBody::ResultObject) };
    inline DescribeDecisionResultTrendResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, DescribeDecisionResultTrendResponseBody::ResultObject) };
    inline DescribeDecisionResultTrendResponseBody& setResultObject(const DescribeDecisionResultTrendResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeDecisionResultTrendResponseBody& setResultObject(DescribeDecisionResultTrendResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
    ...
    inline DescribeDecisionResultTrendResponseBody& setSuccess(bool success) { DARABONBA_PTR_SET_VALUE(success_, success) };
  ...
  protected:
    ...
    // Returned object
    shared_ptr<DescribeDecisionResultTrendResponseBody::ResultObject> resultObject_ {};
