...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAllRootVariableResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAllRootVariableResponseBody) };
    inline DescribeAllRootVariableResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAllRootVariableResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAllRootVariableResponseBody> body_ {};
  };
