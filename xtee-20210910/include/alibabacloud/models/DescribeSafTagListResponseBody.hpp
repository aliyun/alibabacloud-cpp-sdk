...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeSafTagListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeSafTagListResponseBodyResultObject>) };
    inline vector<DescribeSafTagListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeSafTagListResponseBodyResultObject>) };
    inline DescribeSafTagListResponseBody& setResultObject(const vector<DescribeSafTagListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeSafTagListResponseBody& setResultObject(vector<DescribeSafTagListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object.
    std::shared_ptr<vector<DescribeSafTagListResponseBodyResultObject>> resultObject_ = nullptr;
