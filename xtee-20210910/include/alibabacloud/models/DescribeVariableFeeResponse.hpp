...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeVariableFeeResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeVariableFeeResponseBody) };
    inline DescribeVariableFeeResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeVariableFeeResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeVariableFeeResponseBody> body_ {};
  };
