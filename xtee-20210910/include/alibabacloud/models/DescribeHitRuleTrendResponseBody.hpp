...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeHitRuleTrendResponseBody::ResultObject & getResultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeHitRuleTrendResponseBody::ResultObject) };
    inline DescribeHitRuleTrendResponseBody::ResultObject getResultObject() { DARABONBA_PTR_GET(resultObject_, DescribeHitRuleTrendResponseBody::ResultObject) };
    inline DescribeHitRuleTrendResponseBody& setResultObject(const DescribeHitRuleTrendResponseBody::ResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeHitRuleTrendResponseBody& setResultObject(DescribeHitRuleTrendResponseBody::ResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
