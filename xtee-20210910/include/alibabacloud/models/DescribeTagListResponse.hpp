...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeTagListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeTagListResponseBody) };
    inline DescribeTagListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeTagListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeTagListResponseBody> body_ {};
  };
