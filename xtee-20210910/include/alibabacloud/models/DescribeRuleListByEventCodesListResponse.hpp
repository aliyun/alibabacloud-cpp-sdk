...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeRuleListByEventCodesListResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, DescribeRuleListByEventCodesListResponseBody) };
    inline DescribeRuleListByEventCodesListResponseBody body() { DARABONBA_PTR_GET(body_, DescribeRuleListByEventCodesListResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<DescribeRuleListByEventCodesListResponseBody> body_ = nullptr;
  };
