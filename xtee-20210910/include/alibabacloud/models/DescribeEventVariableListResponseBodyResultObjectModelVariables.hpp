...
#ifndef ALIBABACLOUD_MODELS_DESCRIBEEVENTVARIABLELISTRESPONSEBODYRESULTOBJECTMODELVARIABLES_HPP_
#define ALIBABACLOUD_MODELS_DESCRIBEEVENTVARIABLELISTRESPONSEBODYRESULTOBJECTMODELVARIABLES_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DescribeEventVariableListResponseBodyResultObjectModelVariables& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DescribeEventVariableListResponseBodyResultObjectModelVariables& obj) { 
    ...
    DescribeEventVariableListResponseBodyResultObjectModelVariables() = default ;
    DescribeEventVariableListResponseBodyResultObjectModelVariables(const DescribeEventVariableListResponseBodyResultObjectModelVariables &) = default ;
    DescribeEventVariableListResponseBodyResultObjectModelVariables(DescribeEventVariableListResponseBodyResultObjectModelVariables &&) = default ;
    DescribeEventVariableListResponseBodyResultObjectModelVariables(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DescribeEventVariableListResponseBodyResultObjectModelVariables() = default ;
    DescribeEventVariableListResponseBodyResultObjectModelVariables& operator=(const DescribeEventVariableListResponseBodyResultObjectModelVariables &) = default ;
    DescribeEventVariableListResponseBodyResultObjectModelVariables& operator=(DescribeEventVariableListResponseBodyResultObjectModelVariables &&) = default ;
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setCode(string code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setDataDisplay(string dataDisplay) { DARABONBA_PTR_SET_VALUE(dataDisplay_, dataDisplay) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setDefineId(string defineId) { DARABONBA_PTR_SET_VALUE(defineId_, defineId) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setDescription(string description) { DARABONBA_PTR_SET_VALUE(description_, description) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setDisplayType(string displayType) { DARABONBA_PTR_SET_VALUE(displayType_, displayType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setExpressionTitle(string expressionTitle) { DARABONBA_PTR_SET_VALUE(expressionTitle_, expressionTitle) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setFavoriteFlag(bool favoriteFlag) { DARABONBA_PTR_SET_VALUE(favoriteFlag_, favoriteFlag) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setFieldDetail(string fieldDetail) { DARABONBA_PTR_SET_VALUE(fieldDetail_, fieldDetail) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setFieldRank(int32_t fieldRank) { DARABONBA_PTR_SET_VALUE(fieldRank_, fieldRank) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setFieldSource(string fieldSource) { DARABONBA_PTR_SET_VALUE(fieldSource_, fieldSource) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setFieldType(string fieldType) { DARABONBA_PTR_SET_VALUE(fieldType_, fieldType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setId(int64_t id) { DARABONBA_PTR_SET_VALUE(id_, id) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setInputFieldType(string inputFieldType) { DARABONBA_PTR_SET_VALUE(inputFieldType_, inputFieldType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setInputRequired(string inputRequired) { DARABONBA_PTR_SET_VALUE(inputRequired_, inputRequired) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setInputs(string inputs) { DARABONBA_PTR_SET_VALUE(inputs_, inputs) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setName(string name) { DARABONBA_PTR_SET_VALUE(name_, name) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setOutlier(string outlier) { DARABONBA_PTR_SET_VALUE(outlier_, outlier) };
    ...
    inline const Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesOutputThreshold & outputThreshold() const { DARABONBA_PTR_GET_CONST(outputThreshold_, Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesOutputThreshold) };
    inline Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesOutputThreshold outputThreshold() { DARABONBA_PTR_GET(outputThreshold_, Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesOutputThreshold) };
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setOutputThreshold(const Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesOutputThreshold & outputThreshold) { DARABONBA_PTR_SET_VALUE(outputThreshold_, outputThreshold) };
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setOutputThreshold(Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesOutputThreshold && outputThreshold) { DARABONBA_PTR_SET_RVALUE(outputThreshold_, outputThreshold) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setParentName(string parentName) { DARABONBA_PTR_SET_VALUE(parentName_, parentName) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setSourceType(string sourceType) { DARABONBA_PTR_SET_VALUE(sourceType_, sourceType) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setTitle(string title) { DARABONBA_PTR_SET_VALUE(title_, title) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setType(string type) { DARABONBA_PTR_SET_VALUE(type_, type) };
    ...
    inline const Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesVariableVelocity & variableVelocity() const { DARABONBA_PTR_GET_CONST(variableVelocity_, Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesVariableVelocity) };
    inline Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesVariableVelocity variableVelocity() { DARABONBA_PTR_GET(variableVelocity_, Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesVariableVelocity) };
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setVariableVelocity(const Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesVariableVelocity & variableVelocity) { DARABONBA_PTR_SET_VALUE(variableVelocity_, variableVelocity) };
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setVariableVelocity(Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesVariableVelocity && variableVelocity) { DARABONBA_PTR_SET_RVALUE(variableVelocity_, variableVelocity) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setXLabel(string xLabel) { DARABONBA_PTR_SET_VALUE(xLabel_, xLabel) };
    ...
    inline DescribeEventVariableListResponseBodyResultObjectModelVariables& setYLabel(string yLabel) { DARABONBA_PTR_SET_VALUE(yLabel_, yLabel) };
  ...
  protected:
    ...
    std::shared_ptr<Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesOutputThreshold> outputThreshold_ = nullptr;
    ...
    std::shared_ptr<Models::DescribeEventVariableListResponseBodyResultObjectModelVariablesVariableVelocity> variableVelocity_ = nullptr;
