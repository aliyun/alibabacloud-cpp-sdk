...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeAnalysisColumnFieldListResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeAnalysisColumnFieldListResponseBody) };
    inline DescribeAnalysisColumnFieldListResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeAnalysisColumnFieldListResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeAnalysisColumnFieldListResponseBody> body_ {};
  };
