...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeOperationLogPageListResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeOperationLogPageListResponseBodyResultObject>) };
    inline vector<DescribeOperationLogPageListResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeOperationLogPageListResponseBodyResultObject>) };
    inline DescribeOperationLogPageListResponseBody& setResultObject(const vector<DescribeOperationLogPageListResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeOperationLogPageListResponseBody& setResultObject(vector<DescribeOperationLogPageListResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object
    std::shared_ptr<vector<DescribeOperationLogPageListResponseBodyResultObject>> resultObject_ = nullptr;
