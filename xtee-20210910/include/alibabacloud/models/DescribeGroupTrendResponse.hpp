...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeGroupTrendResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeGroupTrendResponseBody) };
    inline DescribeGroupTrendResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeGroupTrendResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeGroupTrendResponseBody> body_ {};
  };
