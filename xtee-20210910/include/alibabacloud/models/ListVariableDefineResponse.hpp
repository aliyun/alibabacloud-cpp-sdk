...
namespace Models
{
  ...
  public:
    ...
    inline const ListVariableDefineResponseBody & body() const { DARABONBA_PTR_GET_CONST(body_, ListVariableDefineResponseBody) };
    inline ListVariableDefineResponseBody body() { DARABONBA_PTR_GET(body_, ListVariableDefineResponseBody) };
  ...
  protected:
    ...
    std::shared_ptr<ListVariableDefineResponseBody> body_ = nullptr;
  };
