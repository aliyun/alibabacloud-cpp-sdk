...
namespace Models
{
  ...
  public:
    ...
    inline const vector<DescribeOperatorListByTypeResponseBodyResultObject> & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, vector<DescribeOperatorListByTypeResponseBodyResultObject>) };
    inline vector<DescribeOperatorListByTypeResponseBodyResultObject> resultObject() { DARABONBA_PTR_GET(resultObject_, vector<DescribeOperatorListByTypeResponseBodyResultObject>) };
    inline DescribeOperatorListByTypeResponseBody& setResultObject(const vector<DescribeOperatorListByTypeResponseBodyResultObject> & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeOperatorListByTypeResponseBody& setResultObject(vector<DescribeOperatorListByTypeResponseBodyResultObject> && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Return object
    std::shared_ptr<vector<DescribeOperatorListByTypeResponseBodyResultObject>> resultObject_ = nullptr;
  };
