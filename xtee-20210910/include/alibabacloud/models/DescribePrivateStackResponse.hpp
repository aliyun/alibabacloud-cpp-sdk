...
namespace Models
{
  ...
  public:
    ...
    inline const DescribePrivateStackResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribePrivateStackResponseBody) };
    inline DescribePrivateStackResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribePrivateStackResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribePrivateStackResponseBody> body_ {};
  };
