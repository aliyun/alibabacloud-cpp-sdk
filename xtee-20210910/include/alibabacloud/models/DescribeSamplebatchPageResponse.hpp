...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSamplebatchPageResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DescribeSamplebatchPageResponseBody) };
    inline DescribeSamplebatchPageResponseBody getBody() { DARABONBA_PTR_GET(body_, DescribeSamplebatchPageResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DescribeSamplebatchPageResponseBody> body_ {};
  };
