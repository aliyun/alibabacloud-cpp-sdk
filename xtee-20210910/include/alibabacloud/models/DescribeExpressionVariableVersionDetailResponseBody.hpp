...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeExpressionVariableVersionDetailResponseBodyResultObject & resultObject() const { DARABONBA_PTR_GET_CONST(resultObject_, DescribeExpressionVariableVersionDetailResponseBodyResultObject) };
    inline DescribeExpressionVariableVersionDetailResponseBodyResultObject resultObject() { DARABONBA_PTR_GET(resultObject_, DescribeExpressionVariableVersionDetailResponseBodyResultObject) };
    inline DescribeExpressionVariableVersionDetailResponseBody& setResultObject(const DescribeExpressionVariableVersionDetailResponseBodyResultObject & resultObject) { DARABONBA_PTR_SET_VALUE(resultObject_, resultObject) };
    inline DescribeExpressionVariableVersionDetailResponseBody& setResultObject(DescribeExpressionVariableVersionDetailResponseBodyResultObject && resultObject) { DARABONBA_PTR_SET_RVALUE(resultObject_, resultObject) };
  ...
  protected:
    ...
    // Returned object.
    std::shared_ptr<DescribeExpressionVariableVersionDetailResponseBodyResultObject> resultObject_ = nullptr;
  };
