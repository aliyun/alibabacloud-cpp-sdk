...
#ifndef ALIBABACLOUD_MODELS_LISTERROUTEENTRIESRESPONSEBODYCONTENTDATA_HPP_
#define ALIBABACLOUD_MODELS_LISTERROUTEENTRIESRESPONSEBODYCONTENTDATA_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListErRouteEntriesResponseBodyContentData& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListErRouteEntriesResponseBodyContentData& obj) { 
    ...
    ListErRouteEntriesResponseBodyContentData() = default ;
    ListErRouteEntriesResponseBodyContentData(const ListErRouteEntriesResponseBodyContentData &) = default ;
    ListErRouteEntriesResponseBodyContentData(ListErRouteEntriesResponseBodyContentData &&) = default ;
    ListErRouteEntriesResponseBodyContentData(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListErRouteEntriesResponseBodyContentData() = default ;
    ListErRouteEntriesResponseBodyContentData& operator=(const ListErRouteEntriesResponseBodyContentData &) = default ;
    ListErRouteEntriesResponseBodyContentData& operator=(ListErRouteEntriesResponseBodyContentData &&) = default ;
    ...
    inline ListErRouteEntriesResponseBodyContentData& setDestinationCidrBlock(string destinationCidrBlock) { DARABONBA_PTR_SET_VALUE(destinationCidrBlock_, destinationCidrBlock) };
    ...
    inline ListErRouteEntriesResponseBodyContentData& setErId(string erId) { DARABONBA_PTR_SET_VALUE(erId_, erId) };
    ...
    inline ListErRouteEntriesResponseBodyContentData& setErRouteEntryId(string erRouteEntryId) { DARABONBA_PTR_SET_VALUE(erRouteEntryId_, erRouteEntryId) };
    ...
    inline ListErRouteEntriesResponseBodyContentData& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline ListErRouteEntriesResponseBodyContentData& setNextHopId(string nextHopId) { DARABONBA_PTR_SET_VALUE(nextHopId_, nextHopId) };
    ...
    inline ListErRouteEntriesResponseBodyContentData& setNextHopType(string nextHopType) { DARABONBA_PTR_SET_VALUE(nextHopType_, nextHopType) };
    ...
    inline ListErRouteEntriesResponseBodyContentData& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline ListErRouteEntriesResponseBodyContentData& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline ListErRouteEntriesResponseBodyContentData& setResourceTenantId(string resourceTenantId) { DARABONBA_PTR_SET_VALUE(resourceTenantId_, resourceTenantId) };
    ...
    inline ListErRouteEntriesResponseBodyContentData& setRouteType(string routeType) { DARABONBA_PTR_SET_VALUE(routeType_, routeType) };
    ...
    inline ListErRouteEntriesResponseBodyContentData& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline ListErRouteEntriesResponseBodyContentData& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
