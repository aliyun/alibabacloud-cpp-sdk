...
namespace Models
{
  ...
  public:
    ...
    inline const GetVpdGrantRuleResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetVpdGrantRuleResponseBodyContent) };
    inline GetVpdGrantRuleResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetVpdGrantRuleResponseBodyContent) };
    inline GetVpdGrantRuleResponseBody& setContent(const GetVpdGrantRuleResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetVpdGrantRuleResponseBody& setContent(GetVpdGrantRuleResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<GetVpdGrantRuleResponseBodyContent> content_ = nullptr;
