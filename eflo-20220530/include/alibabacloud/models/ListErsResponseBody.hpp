...
namespace Models
{
  ...
  public:
    ...
    inline const ListErsResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListErsResponseBodyContent) };
    inline ListErsResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListErsResponseBodyContent) };
    inline ListErsResponseBody& setContent(const ListErsResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListErsResponseBody& setContent(ListErsResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<ListErsResponseBodyContent> content_ = nullptr;
