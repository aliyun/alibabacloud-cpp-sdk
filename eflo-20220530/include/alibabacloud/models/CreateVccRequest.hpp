...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->accessCouldService_ == nullptr
        && this->bandwidth_ == nullptr && this->bgpAsn_ == nullptr && this->bgpCidr_ == nullptr && this->cenId_ == nullptr && this->cenOwnerId_ == nullptr
        && this->connectionType_ == nullptr && this->description_ == nullptr && this->regionId_ == nullptr && this->resourceGroupId_ == nullptr && this->tag_ == nullptr
        && this->vSwitchId_ == nullptr && this->vccId_ == nullptr && this->vccName_ == nullptr && this->vpcId_ == nullptr && this->vpdId_ == nullptr
    ...
    inline bool getAccessCouldService() const { DARABONBA_PTR_GET_DEFAULT(accessCouldService_, false) };
    ...
    inline int64_t getBgpAsn() const { DARABONBA_PTR_GET_DEFAULT(bgpAsn_, 0L) };
    ...
    inline const vector<CreateVccRequest::Tag> & getTag() const { DARABONBA_PTR_GET_CONST(tag_, vector<CreateVccRequest::Tag>) };
    inline vector<CreateVccRequest::Tag> getTag() { DARABONBA_PTR_GET(tag_, vector<CreateVccRequest::Tag>) };
    inline CreateVccRequest& setTag(const vector<CreateVccRequest::Tag> & tag) { DARABONBA_PTR_SET_VALUE(tag_, tag) };
    inline CreateVccRequest& setTag(vector<CreateVccRequest::Tag> && tag) { DARABONBA_PTR_SET_RVALUE(tag_, tag) };
  ...
  protected:
    ...
    shared_ptr<bool> accessCouldService_ {};
    ...
    shared_ptr<vector<CreateVccRequest::Tag>> tag_ {};
