...
namespace Models
{
  ...
  public:
    ...
    inline const InitializeVccResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, InitializeVccResponseBodyContent) };
    inline InitializeVccResponseBodyContent content() { DARABONBA_PTR_GET(content_, InitializeVccResponseBodyContent) };
    inline InitializeVccResponseBody& setContent(const InitializeVccResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline InitializeVccResponseBody& setContent(InitializeVccResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<InitializeVccResponseBodyContent> content_ = nullptr;
