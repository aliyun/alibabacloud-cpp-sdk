...
namespace Models
{
  ...
  public:
    ...
    inline const ListVccsResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListVccsResponseBodyContent) };
    inline ListVccsResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListVccsResponseBodyContent) };
    inline ListVccsResponseBody& setContent(const ListVccsResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListVccsResponseBody& setContent(ListVccsResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<ListVccsResponseBodyContent> content_ = nullptr;
