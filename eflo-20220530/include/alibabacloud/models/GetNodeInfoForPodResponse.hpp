...
namespace Models
{
  ...
  public:
    ...
    inline const GetNodeInfoForPodResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetNodeInfoForPodResponseBody) };
    inline GetNodeInfoForPodResponseBody getBody() { DARABONBA_PTR_GET(body_, GetNodeInfoForPodResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetNodeInfoForPodResponseBody> body_ {};
  };
