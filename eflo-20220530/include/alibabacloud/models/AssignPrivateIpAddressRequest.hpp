...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->assignMac_ == nullptr
        && this->clientToken_ == nullptr && this->description_ == nullptr && this->networkInterfaceId_ == nullptr && this->privateIpAddress_ == nullptr && this->regionId_ == nullptr
        && this->skipConfig_ == nullptr && this->subnetId_ == nullptr; };
    ...
    inline bool getAssignMac() const { DARABONBA_PTR_GET_DEFAULT(assignMac_, false) };
    ...
    inline bool getSkipConfig() const { DARABONBA_PTR_GET_DEFAULT(skipConfig_, false) };
