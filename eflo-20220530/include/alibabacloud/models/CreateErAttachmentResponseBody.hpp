...
namespace Models
{
  ...
  public:
    ...
    inline const CreateErAttachmentResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, CreateErAttachmentResponseBodyContent) };
    inline CreateErAttachmentResponseBodyContent content() { DARABONBA_PTR_GET(content_, CreateErAttachmentResponseBodyContent) };
    inline CreateErAttachmentResponseBody& setContent(const CreateErAttachmentResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline CreateErAttachmentResponseBody& setContent(CreateErAttachmentResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<CreateErAttachmentResponseBodyContent> content_ = nullptr;
