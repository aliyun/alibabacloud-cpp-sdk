...
namespace Models
{
  ...
  public:
    ...
    inline const ListErAttachmentsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListErAttachmentsResponseBody) };
    inline ListErAttachmentsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListErAttachmentsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListErAttachmentsResponseBody> body_ {};
  };
