...
namespace Models
{
  ...
  public:
    ...
    inline const AssociateVpdCidrBlockResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, AssociateVpdCidrBlockResponseBodyContent) };
    inline AssociateVpdCidrBlockResponseBodyContent content() { DARABONBA_PTR_GET(content_, AssociateVpdCidrBlockResponseBodyContent) };
    inline AssociateVpdCidrBlockResponseBody& setContent(const AssociateVpdCidrBlockResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline AssociateVpdCidrBlockResponseBody& setContent(AssociateVpdCidrBlockResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<AssociateVpdCidrBlockResponseBodyContent> content_ = nullptr;
