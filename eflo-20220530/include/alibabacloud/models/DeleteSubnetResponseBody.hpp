...
namespace Models
{
  ...
  public:
    ...
    inline DeleteSubnetResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline DeleteSubnetResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };
    ...
    inline DeleteSubnetResponseBody& setContent(const Darabonba::Json & content) { DARABONBA_SET_VALUE(content_, content) };
    inline DeleteSubnetResponseBody& setContent(Darabonba::Json & content) { DARABONBA_SET_RVALUE(content_, content) };
    ...
    inline DeleteSubnetResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
