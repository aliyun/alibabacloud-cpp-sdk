...
namespace Models
{
  ...
  public:
    ...
    inline const UnAssignPrivateIpAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UnAssignPrivateIpAddressResponseBody) };
    inline UnAssignPrivateIpAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, UnAssignPrivateIpAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UnAssignPrivateIpAddressResponseBody> body_ {};
  };
