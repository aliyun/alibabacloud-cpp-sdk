...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVpdResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVpdResponseBody) };
    inline CreateVpdResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVpdResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVpdResponseBody> body_ {};
  };
