...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVccRouteEntryResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, CreateVccRouteEntryResponseBodyContent) };
    inline CreateVccRouteEntryResponseBodyContent content() { DARABONBA_PTR_GET(content_, CreateVccRouteEntryResponseBodyContent) };
    inline CreateVccRouteEntryResponseBody& setContent(const CreateVccRouteEntryResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline CreateVccRouteEntryResponseBody& setContent(CreateVccRouteEntryResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<CreateVccRouteEntryResponseBodyContent> content_ = nullptr;
