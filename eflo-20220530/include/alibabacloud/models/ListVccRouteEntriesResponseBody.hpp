...
#ifndef ALIBABACLOUD_MODELS_LISTVCCROUTEENTRIESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTVCCROUTEENTRIESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListVccRouteEntriesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListVccRouteEntriesResponseBody& obj) { 
    ...
    ListVccRouteEntriesResponseBody() = default ;
    ListVccRouteEntriesResponseBody(const ListVccRouteEntriesResponseBody &) = default ;
    ListVccRouteEntriesResponseBody(ListVccRouteEntriesResponseBody &&) = default ;
    ListVccRouteEntriesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListVccRouteEntriesResponseBody() = default ;
    ListVccRouteEntriesResponseBody& operator=(const ListVccRouteEntriesResponseBody &) = default ;
    ListVccRouteEntriesResponseBody& operator=(ListVccRouteEntriesResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->resourceGroupId_ == nullptr && this->resourceTenantId_ == nullptr && this->routeType_ == nullptr && this->status_ == nullptr && this->tenantId_ == nullptr
        ...
        inline Data& setVccRouteEntryId(string vccRouteEntryId) { DARABONBA_PTR_SET_VALUE(vccRouteEntryId_, vccRouteEntryId) };
    ...
    inline ListVccRouteEntriesResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ListVccRouteEntriesResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // content Field Functions 
    bool hasContent() const { return this->content_ != nullptr;};
    void deleteContent() { this->content_ = nullptr;};
    inline const ListVccRouteEntriesResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, ListVccRouteEntriesResponseBody::Content) };
    inline ListVccRouteEntriesResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, ListVccRouteEntriesResponseBody::Content) };
    inline ListVccRouteEntriesResponseBody& setContent(const ListVccRouteEntriesResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListVccRouteEntriesResponseBody& setContent(ListVccRouteEntriesResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
    ...
    void deleteMessage() { this->message_ = nullptr;};
    inline string getMessage() const { DARABONBA_PTR_GET_DEFAULT(message_, "") };
    inline ListVccRouteEntriesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListVccRouteEntriesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
  ...
  protected:
    ...
    shared_ptr<ListVccRouteEntriesResponseBody::Content> content_ {};
