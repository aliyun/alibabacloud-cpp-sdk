...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { return this->autoReceiveAllRoute_ == nullptr
        && this->erAttachmentName_ == nullptr && this->erId_ == nullptr && this->instanceId_ == nullptr && this->instanceType_ == nullptr && this->regionId_ == nullptr
        && this->resourceTenantId_ == nullptr; };
