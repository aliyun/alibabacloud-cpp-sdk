...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVccResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, CreateVccResponseBodyContent) };
    inline CreateVccResponseBodyContent content() { DARABONBA_PTR_GET(content_, CreateVccResponseBodyContent) };
    inline CreateVccResponseBody& setContent(const CreateVccResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline CreateVccResponseBody& setContent(CreateVccResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<CreateVccResponseBodyContent> content_ = nullptr;
