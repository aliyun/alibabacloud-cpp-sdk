...
namespace Models
{
  ...
  public:
    ...
    inline const GetVccGrantRuleResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, GetVccGrantRuleResponseBody::Content) };
    inline GetVccGrantRuleResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, GetVccGrantRuleResponseBody::Content) };
    inline GetVccGrantRuleResponseBody& setContent(const GetVccGrantRuleResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetVccGrantRuleResponseBody& setContent(GetVccGrantRuleResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The returned data.
    shared_ptr<GetVccGrantRuleResponseBody::Content> content_ {};
