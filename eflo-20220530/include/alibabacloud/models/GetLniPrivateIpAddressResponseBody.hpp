...
namespace Models
{
  ...
  public:
    ...
    inline const GetLniPrivateIpAddressResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetLniPrivateIpAddressResponseBodyContent) };
    inline GetLniPrivateIpAddressResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetLniPrivateIpAddressResponseBodyContent) };
    inline GetLniPrivateIpAddressResponseBody& setContent(const GetLniPrivateIpAddressResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetLniPrivateIpAddressResponseBody& setContent(GetLniPrivateIpAddressResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<GetLniPrivateIpAddressResponseBodyContent> content_ = nullptr;
