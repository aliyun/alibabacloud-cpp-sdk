...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteElasticNetworkInterfaceResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeleteElasticNetworkInterfaceResponseBody& obj) { 
    ...
    DeleteElasticNetworkInterfaceResponseBody() = default ;
    DeleteElasticNetworkInterfaceResponseBody(const DeleteElasticNetworkInterfaceResponseBody &) = default ;
    DeleteElasticNetworkInterfaceResponseBody(DeleteElasticNetworkInterfaceResponseBody &&) = default ;
    DeleteElasticNetworkInterfaceResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteElasticNetworkInterfaceResponseBody() = default ;
    DeleteElasticNetworkInterfaceResponseBody& operator=(const DeleteElasticNetworkInterfaceResponseBody &) = default ;
    DeleteElasticNetworkInterfaceResponseBody& operator=(DeleteElasticNetworkInterfaceResponseBody &&) = default ;
