...
namespace Models
{
  ...
  public:
    ...
    inline const ListVpdsResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListVpdsResponseBodyContent) };
    inline ListVpdsResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListVpdsResponseBodyContent) };
    inline ListVpdsResponseBody& setContent(const ListVpdsResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListVpdsResponseBody& setContent(ListVpdsResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<ListVpdsResponseBodyContent> content_ = nullptr;
