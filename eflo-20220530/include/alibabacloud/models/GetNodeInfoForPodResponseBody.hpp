...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetNodeInfoForPodResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetNodeInfoForPodResponseBody& obj) { 
    ...
    GetNodeInfoForPodResponseBody() = default ;
    GetNodeInfoForPodResponseBody(const GetNodeInfoForPodResponseBody &) = default ;
    GetNodeInfoForPodResponseBody(GetNodeInfoForPodResponseBody &&) = default ;
    GetNodeInfoForPodResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetNodeInfoForPodResponseBody() = default ;
    GetNodeInfoForPodResponseBody& operator=(const GetNodeInfoForPodResponseBody &) = default ;
    GetNodeInfoForPodResponseBody& operator=(GetNodeInfoForPodResponseBody &&) = default ;
