...
namespace Models
{
  ...
  public:
    ...
    inline const ListErRouteMapsResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListErRouteMapsResponseBodyContent) };
    inline ListErRouteMapsResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListErRouteMapsResponseBodyContent) };
    inline ListErRouteMapsResponseBody& setContent(const ListErRouteMapsResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListErRouteMapsResponseBody& setContent(ListErRouteMapsResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<ListErRouteMapsResponseBodyContent> content_ = nullptr;
