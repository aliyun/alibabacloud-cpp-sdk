...
namespace Models
{
  ...
  public:
    ...
    inline const GetErAttachmentResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetErAttachmentResponseBodyContent) };
    inline GetErAttachmentResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetErAttachmentResponseBodyContent) };
    inline GetErAttachmentResponseBody& setContent(const GetErAttachmentResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetErAttachmentResponseBody& setContent(GetErAttachmentResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<GetErAttachmentResponseBodyContent> content_ = nullptr;
