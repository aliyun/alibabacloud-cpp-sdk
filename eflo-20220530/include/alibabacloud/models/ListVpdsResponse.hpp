...
namespace Models
{
  ...
  public:
    ...
    inline const ListVpdsResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListVpdsResponseBody) };
    inline ListVpdsResponseBody getBody() { DARABONBA_PTR_GET(body_, ListVpdsResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListVpdsResponseBody> body_ {};
  };
