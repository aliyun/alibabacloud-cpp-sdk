...
namespace Models
{
  ...
  public:
    ...
    inline const GetLeniPrivateIpAddressResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetLeniPrivateIpAddressResponseBodyContent) };
    inline GetLeniPrivateIpAddressResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetLeniPrivateIpAddressResponseBodyContent) };
    inline GetLeniPrivateIpAddressResponseBody& setContent(const GetLeniPrivateIpAddressResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetLeniPrivateIpAddressResponseBody& setContent(GetLeniPrivateIpAddressResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<GetLeniPrivateIpAddressResponseBodyContent> content_ = nullptr;
    // The message.
