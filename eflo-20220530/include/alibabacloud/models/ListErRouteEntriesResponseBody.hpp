...
namespace Models
{
  ...
  public:
    ...
    inline const ListErRouteEntriesResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListErRouteEntriesResponseBodyContent) };
    inline ListErRouteEntriesResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListErRouteEntriesResponseBodyContent) };
    inline ListErRouteEntriesResponseBody& setContent(const ListErRouteEntriesResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListErRouteEntriesResponseBody& setContent(ListErRouteEntriesResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<ListErRouteEntriesResponseBodyContent> content_ = nullptr;
