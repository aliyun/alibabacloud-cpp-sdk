...
namespace Models
{
  ...
  public:
    ...
    inline const ListNetworkInterfacesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListNetworkInterfacesResponseBody) };
    inline ListNetworkInterfacesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListNetworkInterfacesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListNetworkInterfacesResponseBody> body_ {};
  };
