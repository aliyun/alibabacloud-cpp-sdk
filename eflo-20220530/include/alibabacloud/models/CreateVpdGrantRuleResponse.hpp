...
namespace Models
{
  ...
  public:
    ...
    inline const CreateVpdGrantRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, CreateVpdGrantRuleResponseBody) };
    inline CreateVpdGrantRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, CreateVpdGrantRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<CreateVpdGrantRuleResponseBody> body_ {};
  };
