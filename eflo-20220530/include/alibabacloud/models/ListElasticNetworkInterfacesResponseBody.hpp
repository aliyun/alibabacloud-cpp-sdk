...
namespace Models
{
  ...
  public:
    ...
    inline const ListElasticNetworkInterfacesResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListElasticNetworkInterfacesResponseBodyContent) };
    inline ListElasticNetworkInterfacesResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListElasticNetworkInterfacesResponseBodyContent) };
    inline ListElasticNetworkInterfacesResponseBody& setContent(const ListElasticNetworkInterfacesResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListElasticNetworkInterfacesResponseBody& setContent(ListElasticNetworkInterfacesResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<ListElasticNetworkInterfacesResponseBodyContent> content_ = nullptr;
    // The return message.
