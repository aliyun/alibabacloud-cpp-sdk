...
namespace Models
{
  ...
  public:
    ...
    inline const CreateElasticNetworkInterfaceResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, CreateElasticNetworkInterfaceResponseBodyContent) };
    inline CreateElasticNetworkInterfaceResponseBodyContent content() { DARABONBA_PTR_GET(content_, CreateElasticNetworkInterfaceResponseBodyContent) };
    inline CreateElasticNetworkInterfaceResponseBody& setContent(const CreateElasticNetworkInterfaceResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline CreateElasticNetworkInterfaceResponseBody& setContent(CreateElasticNetworkInterfaceResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<CreateElasticNetworkInterfaceResponseBodyContent> content_ = nullptr;
