...
#ifndef ALIBABACLOUD_MODELS_LISTVPDROUTEENTRIESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTVPDROUTEENTRIESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListVpdRouteEntriesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListVpdRouteEntriesResponseBody& obj) { 
    ...
    ListVpdRouteEntriesResponseBody() = default ;
    ListVpdRouteEntriesResponseBody(const ListVpdRouteEntriesResponseBody &) = default ;
    ListVpdRouteEntriesResponseBody(ListVpdRouteEntriesResponseBody &&) = default ;
    ListVpdRouteEntriesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListVpdRouteEntriesResponseBody() = default ;
    ListVpdRouteEntriesResponseBody& operator=(const ListVpdRouteEntriesResponseBody &) = default ;
    ListVpdRouteEntriesResponseBody& operator=(ListVpdRouteEntriesResponseBody &&) = default ;
    ...
    public:
      ...
      public:
        ...
        && this->resourceTenantId_ == nullptr && this->routeType_ == nullptr && this->status_ == nullptr && this->tenantId_ == nullptr && this->vpdId_ == nullptr
        && this->vpdRouteEntryId_ == nullptr; };
        ...
        inline Data& setVpdRouteEntryId(string vpdRouteEntryId) { DARABONBA_PTR_SET_VALUE(vpdRouteEntryId_, vpdRouteEntryId) };
    ...
    inline ListVpdRouteEntriesResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ListVpdRouteEntriesResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // content Field Functions 
    bool hasContent() const { return this->content_ != nullptr;};
    void deleteContent() { this->content_ = nullptr;};
    inline const ListVpdRouteEntriesResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, ListVpdRouteEntriesResponseBody::Content) };
    inline ListVpdRouteEntriesResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, ListVpdRouteEntriesResponseBody::Content) };
    inline ListVpdRouteEntriesResponseBody& setContent(const ListVpdRouteEntriesResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListVpdRouteEntriesResponseBody& setContent(ListVpdRouteEntriesResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
    ...
    inline ListVpdRouteEntriesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListVpdRouteEntriesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
  ...
  protected:
    ...
    shared_ptr<ListVpdRouteEntriesResponseBody::Content> content_ {};
