...
namespace Models
{
  ...
  public:
    ...
    inline const ListVccGrantRulesResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListVccGrantRulesResponseBodyContent) };
    inline ListVccGrantRulesResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListVccGrantRulesResponseBodyContent) };
    inline ListVccGrantRulesResponseBody& setContent(const ListVccGrantRulesResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListVccGrantRulesResponseBody& setContent(ListVccGrantRulesResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<ListVccGrantRulesResponseBodyContent> content_ = nullptr;
