...
namespace Models
{
  ...
  public:
    ...
    inline const GetErAttachmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetErAttachmentResponseBody) };
    inline GetErAttachmentResponseBody getBody() { DARABONBA_PTR_GET(body_, GetErAttachmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetErAttachmentResponseBody> body_ {};
  };
