...
#ifndef ALIBABACLOUD_MODELS_DELETEERATTACHMENTREQUEST_HPP_
#define ALIBABACLOUD_MODELS_DELETEERATTACHMENTREQUEST_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteErAttachmentRequest& obj) { 
      DARABONBA_PTR_TO_JSON(ErAttachmentId, erAttachmentId_);
      DARABONBA_PTR_TO_JSON(ErId, erId_);
      DARABONBA_PTR_TO_JSON(RegionId, regionId_);
    };
    friend void from_json(const Darabonba::Json& j, DeleteErAttachmentRequest& obj) { 
      DARABONBA_PTR_FROM_JSON(ErAttachmentId, erAttachmentId_);
      DARABONBA_PTR_FROM_JSON(ErId, erId_);
      DARABONBA_PTR_FROM_JSON(RegionId, regionId_);
    };
    DeleteErAttachmentRequest() = default ;
    DeleteErAttachmentRequest(const DeleteErAttachmentRequest &) = default ;
    DeleteErAttachmentRequest(DeleteErAttachmentRequest &&) = default ;
    DeleteErAttachmentRequest(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteErAttachmentRequest() = default ;
    DeleteErAttachmentRequest& operator=(const DeleteErAttachmentRequest &) = default ;
    DeleteErAttachmentRequest& operator=(DeleteErAttachmentRequest &&) = default ;
