...
namespace Models
{
  ...
  public:
    ...
    inline const GetErResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetErResponseBodyContent) };
    inline GetErResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetErResponseBodyContent) };
    inline GetErResponseBody& setContent(const GetErResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetErResponseBody& setContent(GetErResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<GetErResponseBodyContent> content_ = nullptr;
