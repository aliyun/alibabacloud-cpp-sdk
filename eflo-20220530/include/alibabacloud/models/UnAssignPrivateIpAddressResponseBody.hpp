...
namespace Models
{
  ...
  public:
    ...
    inline const UnAssignPrivateIpAddressResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, UnAssignPrivateIpAddressResponseBodyContent) };
    inline UnAssignPrivateIpAddressResponseBodyContent content() { DARABONBA_PTR_GET(content_, UnAssignPrivateIpAddressResponseBodyContent) };
    inline UnAssignPrivateIpAddressResponseBody& setContent(const UnAssignPrivateIpAddressResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline UnAssignPrivateIpAddressResponseBody& setContent(UnAssignPrivateIpAddressResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<UnAssignPrivateIpAddressResponseBodyContent> content_ = nullptr;
