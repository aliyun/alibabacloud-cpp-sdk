...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteErAttachmentResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteErAttachmentResponseBody) };
    inline DeleteErAttachmentResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteErAttachmentResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteErAttachmentResponseBody> body_ {};
  };
