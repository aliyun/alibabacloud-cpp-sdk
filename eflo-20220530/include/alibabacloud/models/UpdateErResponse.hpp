...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateErResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateErResponseBody) };
    inline UpdateErResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateErResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateErResponseBody> body_ {};
  };
