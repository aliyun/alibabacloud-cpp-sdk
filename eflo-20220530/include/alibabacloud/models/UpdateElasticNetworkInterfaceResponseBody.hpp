...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateElasticNetworkInterfaceResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, UpdateElasticNetworkInterfaceResponseBodyContent) };
    inline UpdateElasticNetworkInterfaceResponseBodyContent content() { DARABONBA_PTR_GET(content_, UpdateElasticNetworkInterfaceResponseBodyContent) };
    inline UpdateElasticNetworkInterfaceResponseBody& setContent(const UpdateElasticNetworkInterfaceResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline UpdateElasticNetworkInterfaceResponseBody& setContent(UpdateElasticNetworkInterfaceResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<UpdateElasticNetworkInterfaceResponseBodyContent> content_ = nullptr;
    // The return message.
