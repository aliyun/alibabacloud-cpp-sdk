...
namespace Models
{
  ...
  public:
    ...
    inline const ListLeniPrivateIpAddressesResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListLeniPrivateIpAddressesResponseBodyContent) };
    inline ListLeniPrivateIpAddressesResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListLeniPrivateIpAddressesResponseBodyContent) };
    inline ListLeniPrivateIpAddressesResponseBody& setContent(const ListLeniPrivateIpAddressesResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListLeniPrivateIpAddressesResponseBody& setContent(ListLeniPrivateIpAddressesResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<ListLeniPrivateIpAddressesResponseBodyContent> content_ = nullptr;
