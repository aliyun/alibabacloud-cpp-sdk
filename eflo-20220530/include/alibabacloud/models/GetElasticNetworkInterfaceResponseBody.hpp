...
namespace Models
{
  ...
  public:
    ...
    inline const GetElasticNetworkInterfaceResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetElasticNetworkInterfaceResponseBodyContent) };
    inline GetElasticNetworkInterfaceResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetElasticNetworkInterfaceResponseBodyContent) };
    inline GetElasticNetworkInterfaceResponseBody& setContent(const GetElasticNetworkInterfaceResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetElasticNetworkInterfaceResponseBody& setContent(GetElasticNetworkInterfaceResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<GetElasticNetworkInterfaceResponseBodyContent> content_ = nullptr;
    // The return message.
