...
namespace Models
{
  ...
  public:
    ...
    inline const DescribeSlrResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, DescribeSlrResponseBodyContent) };
    inline DescribeSlrResponseBodyContent content() { DARABONBA_PTR_GET(content_, DescribeSlrResponseBodyContent) };
    inline DescribeSlrResponseBody& setContent(const DescribeSlrResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline DescribeSlrResponseBody& setContent(DescribeSlrResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<DescribeSlrResponseBodyContent> content_ = nullptr;
