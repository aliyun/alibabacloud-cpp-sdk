...
namespace Models
{
  ...
  public:
    ...
    inline const GetErRouteMapResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, GetErRouteMapResponseBody) };
    inline GetErRouteMapResponseBody getBody() { DARABONBA_PTR_GET(body_, GetErRouteMapResponseBody) };
  ...
  protected:
    ...
    shared_ptr<GetErRouteMapResponseBody> body_ {};
  };
