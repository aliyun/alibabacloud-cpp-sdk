...
namespace Models
{
  ...
  public:
    ...
    inline const ListNetworkInterfacesResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListNetworkInterfacesResponseBodyContent) };
    inline ListNetworkInterfacesResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListNetworkInterfacesResponseBodyContent) };
    inline ListNetworkInterfacesResponseBody& setContent(const ListNetworkInterfacesResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListNetworkInterfacesResponseBody& setContent(ListNetworkInterfacesResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<ListNetworkInterfacesResponseBodyContent> content_ = nullptr;
