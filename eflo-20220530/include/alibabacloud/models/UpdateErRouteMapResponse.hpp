...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateErRouteMapResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateErRouteMapResponseBody) };
    inline UpdateErRouteMapResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateErRouteMapResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateErRouteMapResponseBody> body_ {};
  };
