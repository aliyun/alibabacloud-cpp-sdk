...
namespace Models
{
  ...
  public:
    ...
    inline const DetachElasticNetworkInterfaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DetachElasticNetworkInterfaceResponseBody) };
    inline DetachElasticNetworkInterfaceResponseBody getBody() { DARABONBA_PTR_GET(body_, DetachElasticNetworkInterfaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DetachElasticNetworkInterfaceResponseBody> body_ {};
  };
