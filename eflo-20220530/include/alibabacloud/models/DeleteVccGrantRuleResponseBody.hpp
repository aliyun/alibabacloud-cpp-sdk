...
#ifndef ALIBABACLOUD_MODELS_DELETEVCCGRANTRULERESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_DELETEVCCGRANTRULERESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const DeleteVccGrantRuleResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, DeleteVccGrantRuleResponseBody& obj) { 
    ...
    DeleteVccGrantRuleResponseBody() = default ;
    DeleteVccGrantRuleResponseBody(const DeleteVccGrantRuleResponseBody &) = default ;
    DeleteVccGrantRuleResponseBody(DeleteVccGrantRuleResponseBody &&) = default ;
    DeleteVccGrantRuleResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~DeleteVccGrantRuleResponseBody() = default ;
    DeleteVccGrantRuleResponseBody& operator=(const DeleteVccGrantRuleResponseBody &) = default ;
    DeleteVccGrantRuleResponseBody& operator=(DeleteVccGrantRuleResponseBody &&) = default ;
