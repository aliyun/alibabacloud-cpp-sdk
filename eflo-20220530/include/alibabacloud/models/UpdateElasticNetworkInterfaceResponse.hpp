...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateElasticNetworkInterfaceResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateElasticNetworkInterfaceResponseBody) };
    inline UpdateElasticNetworkInterfaceResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateElasticNetworkInterfaceResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateElasticNetworkInterfaceResponseBody> body_ {};
  };
