...
#ifndef ALIBABACLOUD_MODELS_GETERATTACHMENTRESPONSEBODYCONTENT_HPP_
#define ALIBABACLOUD_MODELS_GETERATTACHMENTRESPONSEBODYCONTENT_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const GetErAttachmentResponseBodyContent& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, GetErAttachmentResponseBodyContent& obj) { 
    ...
    GetErAttachmentResponseBodyContent() = default ;
    GetErAttachmentResponseBodyContent(const GetErAttachmentResponseBodyContent &) = default ;
    GetErAttachmentResponseBodyContent(GetErAttachmentResponseBodyContent &&) = default ;
    GetErAttachmentResponseBodyContent(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~GetErAttachmentResponseBodyContent() = default ;
    GetErAttachmentResponseBodyContent& operator=(const GetErAttachmentResponseBodyContent &) = default ;
    GetErAttachmentResponseBodyContent& operator=(GetErAttachmentResponseBodyContent &&) = default ;
    ...
    inline GetErAttachmentResponseBodyContent& setAcross(bool across) { DARABONBA_PTR_SET_VALUE(across_, across) };
    ...
    inline GetErAttachmentResponseBodyContent& setAutoReceiveAllRoute(bool autoReceiveAllRoute) { DARABONBA_PTR_SET_VALUE(autoReceiveAllRoute_, autoReceiveAllRoute) };
    ...
    inline GetErAttachmentResponseBodyContent& setCreateTime(string createTime) { DARABONBA_PTR_SET_VALUE(createTime_, createTime) };
    ...
    inline GetErAttachmentResponseBodyContent& setErAttachmentId(string erAttachmentId) { DARABONBA_PTR_SET_VALUE(erAttachmentId_, erAttachmentId) };
    ...
    inline GetErAttachmentResponseBodyContent& setErAttachmentName(string erAttachmentName) { DARABONBA_PTR_SET_VALUE(erAttachmentName_, erAttachmentName) };
    ...
    inline GetErAttachmentResponseBodyContent& setErId(string erId) { DARABONBA_PTR_SET_VALUE(erId_, erId) };
    ...
    inline GetErAttachmentResponseBodyContent& setGmtModified(string gmtModified) { DARABONBA_PTR_SET_VALUE(gmtModified_, gmtModified) };
    ...
    inline GetErAttachmentResponseBodyContent& setInstanceId(string instanceId) { DARABONBA_PTR_SET_VALUE(instanceId_, instanceId) };
    ...
    inline GetErAttachmentResponseBodyContent& setInstanceName(string instanceName) { DARABONBA_PTR_SET_VALUE(instanceName_, instanceName) };
    ...
    inline GetErAttachmentResponseBodyContent& setInstanceType(string instanceType) { DARABONBA_PTR_SET_VALUE(instanceType_, instanceType) };
    ...
    inline GetErAttachmentResponseBodyContent& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline GetErAttachmentResponseBodyContent& setRegionId(string regionId) { DARABONBA_PTR_SET_VALUE(regionId_, regionId) };
    ...
    inline GetErAttachmentResponseBodyContent& setResourceGroupId(string resourceGroupId) { DARABONBA_PTR_SET_VALUE(resourceGroupId_, resourceGroupId) };
    ...
    inline GetErAttachmentResponseBodyContent& setResourceTenantId(string resourceTenantId) { DARABONBA_PTR_SET_VALUE(resourceTenantId_, resourceTenantId) };
    ...
    inline GetErAttachmentResponseBodyContent& setStatus(string status) { DARABONBA_PTR_SET_VALUE(status_, status) };
    ...
    inline GetErAttachmentResponseBodyContent& setTenantId(string tenantId) { DARABONBA_PTR_SET_VALUE(tenantId_, tenantId) };
