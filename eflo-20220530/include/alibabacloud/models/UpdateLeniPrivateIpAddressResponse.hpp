...
namespace Models
{
  ...
  public:
    ...
    inline const UpdateLeniPrivateIpAddressResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, UpdateLeniPrivateIpAddressResponseBody) };
    inline UpdateLeniPrivateIpAddressResponseBody getBody() { DARABONBA_PTR_GET(body_, UpdateLeniPrivateIpAddressResponseBody) };
  ...
  protected:
    ...
    shared_ptr<UpdateLeniPrivateIpAddressResponseBody> body_ {};
  };
