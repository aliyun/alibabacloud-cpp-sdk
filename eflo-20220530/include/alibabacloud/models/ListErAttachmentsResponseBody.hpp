...
namespace Models
{
  ...
  public:
    ...
    inline const ListErAttachmentsResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListErAttachmentsResponseBodyContent) };
    inline ListErAttachmentsResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListErAttachmentsResponseBodyContent) };
    inline ListErAttachmentsResponseBody& setContent(const ListErAttachmentsResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListErAttachmentsResponseBody& setContent(ListErAttachmentsResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The data returned.
    std::shared_ptr<ListErAttachmentsResponseBodyContent> content_ = nullptr;
