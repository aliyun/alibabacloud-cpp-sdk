...
namespace Models
{
  ...
  public:
    ...
    inline const ListErRouteEntriesResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, ListErRouteEntriesResponseBody) };
    inline ListErRouteEntriesResponseBody getBody() { DARABONBA_PTR_GET(body_, ListErRouteEntriesResponseBody) };
  ...
  protected:
    ...
    shared_ptr<ListErRouteEntriesResponseBody> body_ {};
  };
