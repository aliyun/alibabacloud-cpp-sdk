...
namespace Models
{
  ...
  public:
    ...
    inline const GetSubnetResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, GetSubnetResponseBodyContent) };
    inline GetSubnetResponseBodyContent content() { DARABONBA_PTR_GET(content_, GetSubnetResponseBodyContent) };
    inline GetSubnetResponseBody& setContent(const GetSubnetResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline GetSubnetResponseBody& setContent(GetSubnetResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<GetSubnetResponseBodyContent> content_ = nullptr;
