...
#ifndef ALIBABACLOUD_MODELS_LISTVPDGRANTRULESRESPONSEBODY_HPP_
#define ALIBABACLOUD_MODELS_LISTVPDGRANTRULESRESPONSEBODY_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ListVpdGrantRulesResponseBody& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, ListVpdGrantRulesResponseBody& obj) { 
    ...
    ListVpdGrantRulesResponseBody() = default ;
    ListVpdGrantRulesResponseBody(const ListVpdGrantRulesResponseBody &) = default ;
    ListVpdGrantRulesResponseBody(ListVpdGrantRulesResponseBody &&) = default ;
    ListVpdGrantRulesResponseBody(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~ListVpdGrantRulesResponseBody() = default ;
    ListVpdGrantRulesResponseBody& operator=(const ListVpdGrantRulesResponseBody &) = default ;
    ListVpdGrantRulesResponseBody& operator=(ListVpdGrantRulesResponseBody &&) = default ;
    ...
    inline ListVpdGrantRulesResponseBody& setAccessDeniedDetail(string accessDeniedDetail) { DARABONBA_PTR_SET_VALUE(accessDeniedDetail_, accessDeniedDetail) };
    ...
    inline ListVpdGrantRulesResponseBody& setCode(int32_t code) { DARABONBA_PTR_SET_VALUE(code_, code) };


    // content Field Functions 
    bool hasContent() const { return this->content_ != nullptr;};
    void deleteContent() { this->content_ = nullptr;};
    inline const ListVpdGrantRulesResponseBody::Content & getContent() const { DARABONBA_PTR_GET_CONST(content_, ListVpdGrantRulesResponseBody::Content) };
    inline ListVpdGrantRulesResponseBody::Content getContent() { DARABONBA_PTR_GET(content_, ListVpdGrantRulesResponseBody::Content) };
    inline ListVpdGrantRulesResponseBody& setContent(const ListVpdGrantRulesResponseBody::Content & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListVpdGrantRulesResponseBody& setContent(ListVpdGrantRulesResponseBody::Content && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
    ...
    inline ListVpdGrantRulesResponseBody& setMessage(string message) { DARABONBA_PTR_SET_VALUE(message_, message) };
    ...
    inline ListVpdGrantRulesResponseBody& setRequestId(string requestId) { DARABONBA_PTR_SET_VALUE(requestId_, requestId) };
  ...
  protected:
    ...
    shared_ptr<ListVpdGrantRulesResponseBody::Content> content_ {};
