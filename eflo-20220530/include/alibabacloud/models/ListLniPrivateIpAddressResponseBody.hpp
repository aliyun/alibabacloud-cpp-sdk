...
namespace Models
{
  ...
  public:
    ...
    inline const ListLniPrivateIpAddressResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListLniPrivateIpAddressResponseBodyContent) };
    inline ListLniPrivateIpAddressResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListLniPrivateIpAddressResponseBodyContent) };
    inline ListLniPrivateIpAddressResponseBody& setContent(const ListLniPrivateIpAddressResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListLniPrivateIpAddressResponseBody& setContent(ListLniPrivateIpAddressResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<ListLniPrivateIpAddressResponseBodyContent> content_ = nullptr;
