...
namespace Models
{
  ...
  public:
    ...
    inline const UnAssociateVpdCidrBlockResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, UnAssociateVpdCidrBlockResponseBodyContent) };
    inline UnAssociateVpdCidrBlockResponseBodyContent content() { DARABONBA_PTR_GET(content_, UnAssociateVpdCidrBlockResponseBodyContent) };
    inline UnAssociateVpdCidrBlockResponseBody& setContent(const UnAssociateVpdCidrBlockResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline UnAssociateVpdCidrBlockResponseBody& setContent(UnAssociateVpdCidrBlockResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The response data.
    std::shared_ptr<UnAssociateVpdCidrBlockResponseBodyContent> content_ = nullptr;
