...
namespace Models
{
  ...
  public:
    ...
    inline const ListVccFlowInfosResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, ListVccFlowInfosResponseBodyContent) };
    inline ListVccFlowInfosResponseBodyContent content() { DARABONBA_PTR_GET(content_, ListVccFlowInfosResponseBodyContent) };
    inline ListVccFlowInfosResponseBody& setContent(const ListVccFlowInfosResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline ListVccFlowInfosResponseBody& setContent(ListVccFlowInfosResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    // The returned data.
    std::shared_ptr<ListVccFlowInfosResponseBodyContent> content_ = nullptr;
    // Response
