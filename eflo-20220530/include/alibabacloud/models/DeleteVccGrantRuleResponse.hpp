...
namespace Models
{
  ...
  public:
    ...
    inline const DeleteVccGrantRuleResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, DeleteVccGrantRuleResponseBody) };
    inline DeleteVccGrantRuleResponseBody getBody() { DARABONBA_PTR_GET(body_, DeleteVccGrantRuleResponseBody) };
  ...
  protected:
    ...
    shared_ptr<DeleteVccGrantRuleResponseBody> body_ {};
  };
