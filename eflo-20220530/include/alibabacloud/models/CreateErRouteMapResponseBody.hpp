...
namespace Models
{
  ...
  public:
    ...
    inline const CreateErRouteMapResponseBodyContent & content() const { DARABONBA_PTR_GET_CONST(content_, CreateErRouteMapResponseBodyContent) };
    inline CreateErRouteMapResponseBodyContent content() { DARABONBA_PTR_GET(content_, CreateErRouteMapResponseBodyContent) };
    inline CreateErRouteMapResponseBody& setContent(const CreateErRouteMapResponseBodyContent & content) { DARABONBA_PTR_SET_VALUE(content_, content) };
    inline CreateErRouteMapResponseBody& setContent(CreateErRouteMapResponseBodyContent && content) { DARABONBA_PTR_SET_RVALUE(content_, content) };
  ...
  protected:
    ...
    std::shared_ptr<CreateErRouteMapResponseBodyContent> content_ = nullptr;
