...
namespace Models
{
  ...
  public:
    ...
    inline const RefundVccResponseBody & getBody() const { DARABONBA_PTR_GET_CONST(body_, RefundVccResponseBody) };
    inline RefundVccResponseBody getBody() { DARABONBA_PTR_GET(body_, RefundVccResponseBody) };
  ...
  protected:
    ...
    shared_ptr<RefundVccResponseBody> body_ {};
  };
